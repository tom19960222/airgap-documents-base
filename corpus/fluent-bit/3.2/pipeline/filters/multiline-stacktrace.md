...
version: "3.2"
title: "Multiline"
source_url: https://github.com/fluent/fluent-bit-docs/blob/36106a0740d3f62f05d0e9e69b2c0e21dfa9de21/pipeline/filters/multiline-stacktrace.md
...
>
> When buffering is enabled, the filter does not immediately emit messages it receives. It uses the in_emitter plugin, same as the [Rewrite Tag Filter](pipeline/filters/rewrite-tag.md) <!-- unresolved-source-link: target=pipeline/filters/rewrite-tag.md -->, and emits messages once they are fully concatenated, or a timeout is reached.
