...
version: "3.2"
title: "OpenTelemetry Envelope"
source_url: https://github.com/fluent/fluent-bit-docs/blob/36106a0740d3f62f05d0e9e69b2c0e21dfa9de21/pipeline/processors/opentelemetry-envelope.md
...
While OpenTelemetry Envelope enrich your logs with the Schema, you might be interested into take a step further and use the [Content Modifier](content-modifier.md) processor to modify the content of your logs. Here is a quick example that will allow you to add some resource and scope attributes to your logs:
...
For more details about further processing, read the [Content Modifier](content-modifier.md) processor documentation.
