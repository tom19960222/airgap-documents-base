...
source_url: https://github.com/fluent/fluent-bit-docs/blob/36106a0740d3f62f05d0e9e69b2c0e21dfa9de21/administration/configuring-fluent-bit/yaml/service-section.md
...
| `hot_reload` | Enables hot [reloading](../../hot_reload.md) <!-- unresolved-source-link: target=../../hot_reload.md --> of configuration with SIGHUP. | `on` |
...
Below is a simple configuration example that defines a `service` section with [hot reloading](../../hot_reload.md) <!-- unresolved-source-link: target=../../hot_reload.md --> enabled and a pipeline with a `random` input and `stdout` output:
