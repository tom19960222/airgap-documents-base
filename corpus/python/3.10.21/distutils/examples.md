...
collection: python
version: "3.10.21"
title: "6. Distutils Examples"
source_url: https://docs.python.org/3.10/distutils/examples.html
...
[docutils](http://docutils.sourceforge.net) is installed you can check if the syntax is fine with the
...
The [`distutils.core.setup()`](apiref.md#distutils.core.setup "distutils.core.setup") function provides a command-line interface
...
[`distutils.core.setup()`](apiref.md#distutils.core.setup "distutils.core.setup") function. Although, when a source or binary
