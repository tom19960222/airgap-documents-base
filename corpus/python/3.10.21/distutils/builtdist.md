...
collection: python
version: "3.10.21"
title: "5. Creating Built Distributions"
source_url: https://docs.python.org/3.10/distutils/builtdist.html
...
`Distutils-1.0.plat.zip`—again, this archive would be unpacked
...
4. requires either external **zip** utility or [`zipfile`](../library/zipfile.md#module-zipfile "zipfile: Read and write ZIP-format archive files.") module (part
...
configuration file, `setup.cfg`—see section [Writing the Setup Configuration File](configfile.md#setup-config). If
...
1. create a `.spec` file, which describes the package (analogous to the
...
3. create the “binary” RPM (which may or may not contain binary code, depending
...
:   This function can be used to retrieve special folder locations on Windows like
    ...
    *csidl_string* must be one of the following strings:
    ...
    If the folder cannot be retrieved, [`OSError`](../library/exceptions.md#OSError "OSError") is raised.
