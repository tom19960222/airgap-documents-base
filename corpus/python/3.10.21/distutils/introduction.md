...
collection: python
version: "3.10.21"
title: "1. An Introduction to Distutils"
source_url: https://docs.python.org/3.10/distutils/introduction.html
...
[Installing Python Modules (Legacy version)](https://docs.python.org/3.10/install/index.html#install-index) chapter.
...
- it’s recommended that you supply a little more metadata, in particular your
  name, email address and a URL for the project (see section [Writing the Setup Script](setupscript.md#setup-script)
  for an example)
...
For Windows, open a command prompt window (Start ‣
...
:   a module written in Python and contained in a single `.py` file (and
    possibly associated `.pyc` files). Sometimes referred to as a
    “pure module.”
