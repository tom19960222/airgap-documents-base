...
collection: python
version: "3.10.21"
title: "2. Writing the Setup Script"
source_url: https://docs.python.org/3.10/distutils/setupscript.html
fetched_at: 2026-09-17T15:15:41+00:00
---
...
[A Simple Example](introduction.md#distutils-simple-example) above, the setup script consists mainly of a call to
...
distribution presented in section [A Simple Example](introduction.md#distutils-simple-example): more metadata, and the
...
meta-data, see section [Additional meta-data](setupscript.md#meta-data).
...
you, for example, use standard Python functions such as [`glob.glob()`](../library/glob.md#glob.glob "glob.glob") or
[`os.listdir()`](../library/os.md#os.listdir "os.listdir") to specify files, you should be careful to write portable
...
default correspondence is the most obvious one, i.e. package [`distutils`](../library/distutils.md#module-distutils "distutils: Support for building and installing Python modules into an existing Python installation.") is
...
section [A Simple Example](introduction.md#distutils-simple-example); here is a slightly more involved example:
...
[`Extension`](apiref.md#distutils.core.Extension "distutils.core.Extension") instances, each of which describes a
...
The `Extension` class can be imported from [`distutils.core`](apiref.md#module-distutils.core "distutils.core: The core Distutils functionality") along
...
The first argument to the [`Extension`](apiref.md#distutils.core.Extension "distutils.core.Extension") constructor is
...
The second argument to the [`Extension`](apiref.md#distutils.core.Extension "distutils.core.Extension") constructor is
a list of source
...
Three optional arguments to [`Extension`](apiref.md#distutils.core.Extension "distutils.core.Extension") will help if
...
[`distutils.sysconfig`](apiref.md#module-distutils.sysconfig "distutils.sysconfig: Low-level access to configuration information of the Python interpreter.") module:
...
[`distutils.core.setup()`](apiref.md#distutils.core.setup "distutils.core.setup") function.
...
Changed in version 3.1: All the scripts will also be added to the `MANIFEST` file if no template is
provided. See [Specifying the files to distribute](sourcedist.md#manifest).
...
file if no template is provided. See [Specifying the files to distribute](sourcedist.md#manifest).
...
3. Either the author or the maintainer must be identified. If maintainer is
   provided, distutils lists it as the author in `PKG-INFO`.
4. The `long_description` field is used by PyPI when you publish a package,
...
7. The valid classifiers are listed on
   [PyPI](https://pypi.org/classifiers).
8. To preserve backward compatibility, this field also accepts a string. If
...
Changed in version 3.7: [`setup`](apiref.md#distutils.core.setup "distutils.core.setup") now warns when `classifiers`, `keywords`
