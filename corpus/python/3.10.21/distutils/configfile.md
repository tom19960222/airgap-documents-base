...
collection: python
version: "3.10.21"
title: "3. Writing the Setup Configuration File"
source_url: https://docs.python.org/3.10/distutils/configfile.html
...
script—which, ideally, would be opaque to installers [1](configfile.md#id2)—and the command-line to
...
> **See also:**
>
> [Syntax of config files](https://docs.python.org/3.10/install/index.html#inst-config-syntax) in “Installing Python Modules”
