...
source_url: https://docs.python.org/3.10/library/telnetlib.html
fetched_at: 2026-09-17T15:15:26+00:00
---
# `telnetlib` — Telnet client

**Source code:** [Lib/telnetlib.py](https://github.com/python/cpython/tree/3.10/Lib/telnetlib.py)

Deprecated since version 3.11: The [`telnetlib`](telnetlib.md#module-telnetlib "telnetlib: Telnet client class. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#telnetlib) for details and alternatives).
...
:   [`Telnet`](telnetlib.md#telnetlib.Telnet "telnetlib.Telnet") represents a connection to a Telnet server. The instance is
    ...
    *timeout* parameter specifies a timeout in seconds for blocking operations
    ...
    [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. When the `with` block ends, the
