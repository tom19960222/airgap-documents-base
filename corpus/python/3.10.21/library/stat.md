...
source_url: https://docs.python.org/3.10/library/stat.html
fetched_at: 2026-09-17T15:13:46+00:00
---
# `stat` — Interpreting [`stat()`](os.md#os.stat "os.stat") results

**Source code:** [Lib/stat.py](https://github.com/python/cpython/tree/3.10/Lib/stat.py)

---

The [`stat`](stat.md#module-stat "stat: Utilities for interpreting the results of os.stat(), os.lstat() and os.fstat().") module defines constants and functions for interpreting the
results of [`os.stat()`](os.md#os.stat "os.stat"), [`os.fstat()`](os.md#os.fstat "os.fstat") and [`os.lstat()`](os.md#os.lstat "os.lstat") (if they
...
that isn’t handled by [`os.path`](os.path.md#module-os.path "os.path: Operations on pathnames."), like the tests for block and character
devices.
...
:   Convert a file’s mode to a string of the form ‘-rwxrwxrwx’.
    ...
    Changed in version 3.4: The function supports [`S_IFDOOR`](stat.md#stat.S_IFDOOR "stat.S_IFDOOR"), [`S_IFPORT`](stat.md#stat.S_IFPORT "stat.S_IFPORT") and
    [`S_IFWHT`](stat.md#stat.S_IFWHT "stat.S_IFWHT").
...
bytes waiting to be read at the time of the call to [`os.stat()`](os.md#os.stat "os.stat"),
[`os.fstat()`](os.md#os.fstat "os.fstat"), or [`os.lstat()`](os.md#os.lstat "os.lstat"); this can sometimes be useful, especially
...
The variables below define the flags used in the [`ST_MODE`](stat.md#stat.ST_MODE "stat.ST_MODE") field.
...
> **Note:**
>
> [`S_IFDOOR`](stat.md#stat.S_IFDOOR "stat.S_IFDOOR"), [`S_IFPORT`](stat.md#stat.S_IFPORT "stat.S_IFPORT") or [`S_IFWHT`](stat.md#stat.S_IFWHT "stat.S_IFWHT") are defined as
...
:   Set-group-ID bit. This bit has several special uses. For a directory
    ...
    created there will also get the [`S_ISGID`](stat.md#stat.S_ISGID "stat.S_ISGID") bit set. For a
    file that does not have the group execution bit ([`S_IXGRP`](stat.md#stat.S_IXGRP "stat.S_IXGRP"))
...
testing bits in the `st_file_attributes` member returned by [`os.stat()`](os.md#os.stat "os.stat").
