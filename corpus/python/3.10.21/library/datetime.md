...
source_url: https://docs.python.org/3.10/library/datetime.html
fetched_at: 2026-09-17T15:13:32+00:00
---
# `datetime` — Basic date and time types

**Source code:** [Lib/datetime.py](https://github.com/python/cpython/tree/3.10/Lib/datetime.py)

---

The [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module supplies classes for manipulating dates and times.
...
interpretation. [1](datetime.md#id5)
...
supplied by the [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module. The [`timezone`](datetime.md#datetime.timezone "datetime.timezone") class can
...
The [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module exports the following constants:
...
:   A duration expressing the difference between two [`date`](datetime.md#datetime.date "datetime.date"), [`time`](datetime.md#datetime.time "datetime.time"),
    or [`datetime`](datetime.md#datetime.datetime "datetime.datetime") instances to microsecond resolution.
...
- Objects of these types are immutable.
- Objects of these types are [hashable](https://docs.python.org/3.10/glossary.html#term-hashable), meaning that they can be used as
  dictionary keys.
...
| `-t1` | equivalent to [`timedelta`](datetime.md#datetime.timedelta "datetime.timedelta")(-*t1.days*, -*t1.seconds*, -*t1.microseconds*), and to *t1*\* -1. (1)(4) |
...
3. Division by 0 raises [`ZeroDivisionError`](exceptions.md#ZeroDivisionError "ZeroDivisionError").
...
Comparisons of [`timedelta`](datetime.md#datetime.timedelta "datetime.timedelta") objects are supported, with some caveats.

The comparisons `==` or `!=` *always* return a [`bool`](functions.md#bool "bool"), no matter
...
For all other comparisons (such as `<` and `>`), when a [`timedelta`](datetime.md#datetime.timedelta "datetime.timedelta")
object is compared to an object of a different type, [`TypeError`](exceptions.md#TypeError "TypeError")
is raised:
...
called day number 2, and so on. [2](datetime.md#id6)
...
:   Return a [`date`](datetime.md#datetime.date "datetime.date") corresponding to a *date_string* given in the format
    `YYYY-MM-DD`:
    ...
    This is the inverse of [`date.isoformat()`](datetime.md#datetime.date.isoformat "datetime.date.isoformat"). It only supports the format
    `YYYY-MM-DD`.
...
4. In other words, `date1 < date2` if and only if `date1.toordinal() <
   date2.toordinal()`. Date comparison raises [`TypeError`](exceptions.md#TypeError "TypeError") if
   the other comparand isn’t also a [`date`](datetime.md#datetime.date "datetime.date") object. However,
   `NotImplemented` is returned instead if the other comparand has a
   `timetuple()` attribute. This hook gives other kinds of date objects a
   chance at implementing mixed-type comparison. If not, when a [`date`](datetime.md#datetime.date "datetime.date")
   object is compared to an object of a different type, [`TypeError`](exceptions.md#TypeError "TypeError") is raised
   unless the comparison is `==` or `!=`. The latter cases return
   [`False`](constants.md#False "False") or [`True`](constants.md#True "True"), respectively.
...
`date.isocalendar()`
:   Return a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) object with three components: `year`,
    `week` and `weekday`.

    The ISO calendar is a widely used variant of the Gregorian calendar. [3](datetime.md#id7)
    ...
    Changed in version 3.9: Result changed from a tuple to a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple).
...
:   Return a string representing the date in ISO 8601 format, `YYYY-MM-DD`:
    ...
    This is the inverse of [`date.fromisoformat()`](datetime.md#datetime.date.fromisoformat "datetime.date.fromisoformat").
...
:   Return a string representing the date, controlled by an explicit format string.
    ...
    [strftime() and strptime() Behavior](datetime.md#strftime-strptime-behavior).
...
:   Same as [`date.strftime()`](datetime.md#datetime.date.strftime "datetime.date.strftime"). This makes it possible to specify a format
    ...
    literals](https://docs.python.org/3.10/reference/lexical_analysis.html#f-strings) and when using [`str.format()`](stdtypes.md#str.format "str.format"). For a
    complete list of formatting directives, see
    [strftime() and strptime() Behavior](datetime.md#strftime-strptime-behavior).
...
:   Return the current local datetime, with [`tzinfo`](datetime.md#datetime.datetime.tzinfo "datetime.datetime.tzinfo") `None`.
...
:   Return the [`datetime`](datetime.md#datetime.datetime "datetime.datetime") corresponding to the proleptic Gregorian ordinal,
    where January 1 of year 1 has ordinal 1. [`ValueError`](exceptions.md#ValueError "ValueError") is raised unless `1
...
:   Return a new [`datetime`](datetime.md#datetime.datetime "datetime.datetime") object whose date components are equal to the
    ...
    [`datetime`](datetime.md#datetime.datetime "datetime.datetime") object, its time components and [`tzinfo`](datetime.md#datetime.datetime.tzinfo "datetime.datetime.tzinfo") attributes
    are ignored.

    Changed in version 3.6: Added the *tzinfo* argument.

`classmethod datetime.fromisoformat(date_string)`
:   Return a [`datetime`](datetime.md#datetime.datetime "datetime.datetime") corresponding to a *date_string* in one of the
    formats emitted by [`date.isoformat()`](datetime.md#datetime.date.isoformat "datetime.date.isoformat") and [`datetime.isoformat()`](datetime.md#datetime.datetime.isoformat "datetime.datetime.isoformat").
    ...
    > as the inverse operation of [`datetime.isoformat()`](datetime.md#datetime.datetime.isoformat "datetime.datetime.isoformat"). A more full-featured
...
| `datetime1 < datetime2` | Compares [`datetime`](datetime.md#datetime.datetime "datetime.datetime") to [`datetime`](datetime.md#datetime.datetime "datetime.datetime"). (4) |
...
4. *datetime1* is considered less than *datetime2* when *datetime1* precedes
   *datetime2* in time.
   ...
   If one comparand is naive and the other is aware, [`TypeError`](exceptions.md#TypeError "TypeError")
   is raised if an order comparison is attempted. For equality
   comparisons, naive instances are never equal to aware instances.

   If both comparands are aware, and have the same [`tzinfo`](datetime.md#datetime.datetime.tzinfo "datetime.datetime.tzinfo") attribute, the
   common [`tzinfo`](datetime.md#datetime.datetime.tzinfo "datetime.datetime.tzinfo") attribute is ignored and the base datetimes are
   compared. If both comparands are aware and have different [`tzinfo`](datetime.md#datetime.datetime.tzinfo "datetime.datetime.tzinfo")
   ...
   > object addresses, datetime comparison normally raises [`TypeError`](exceptions.md#TypeError "TypeError") if the
   > other comparand isn’t also a [`datetime`](datetime.md#datetime.datetime "datetime.datetime") object. However,
   > `NotImplemented` is returned instead if the other comparand has a
   > `timetuple()` attribute. This hook gives other kinds of date objects a
   > chance at implementing mixed-type comparison. If not, when a [`datetime`](datetime.md#datetime.datetime "datetime.datetime")
   > object is compared to an object of a different type, [`TypeError`](exceptions.md#TypeError "TypeError") is raised
   > unless the comparison is `==` or `!=`. The latter cases return
   > [`False`](constants.md#False "False") or [`True`](constants.md#True "True"), respectively.
...
:   Return POSIX timestamp corresponding to the [`datetime`](datetime.md#datetime.datetime "datetime.datetime")
    ...
    platforms, this method may raise [`OverflowError`](exceptions.md#OverflowError "OverflowError") for times far
...
:   Return a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) with three components: `year`, `week`
...
A [`time`](time.md#module-time "time: Time access and conversions.") object represents a (local) time of day, independent of any particular
...
:   All arguments are optional. *tzinfo* may be `None`, or an instance of a
    ...
    default to `0` except *tzinfo*, which defaults to [`None`](constants.md#None "None").
...
[`time`](datetime.md#datetime.time "datetime.time") objects support comparison of [`time`](datetime.md#datetime.time "datetime.time") to [`time`](datetime.md#datetime.time "datetime.time"),
where *a* is considered less
than *b* when *a* precedes *b* in time. If one comparand is naive and the other
is aware, [`TypeError`](exceptions.md#TypeError "TypeError") is raised if an order comparison is attempted. For equality
comparisons, naive instances are never equal to aware instances.

If both comparands are aware, and have
the same [`tzinfo`](datetime.md#datetime.time.tzinfo "datetime.time.tzinfo") attribute, the common [`tzinfo`](datetime.md#datetime.time.tzinfo "datetime.time.tzinfo") attribute is
ignored and the base times are compared. If both comparands are aware and
have different [`tzinfo`](datetime.md#datetime.time.tzinfo "datetime.time.tzinfo") attributes, the comparands are first adjusted by
subtracting their UTC offsets (obtained from `self.utcoffset()`). In order
to stop mixed-type comparisons from falling back to the default comparison by
object address, when a [`time`](datetime.md#datetime.time "datetime.time") object is compared to an object of a
different type, [`TypeError`](exceptions.md#TypeError "TypeError") is raised unless the comparison is `==` or
`!=`. The latter cases return [`False`](constants.md#False "False") or [`True`](constants.md#True "True"), respectively.
...
:   Return a [`time`](datetime.md#datetime.time "datetime.time") corresponding to a *time_string* in one of the
    formats emitted by [`time.isoformat()`](datetime.md#datetime.time.isoformat "datetime.time.isoformat"). Specifically, this function supports
    ...
    > intended as the inverse operation of [`time.isoformat()`](datetime.md#datetime.time.isoformat "datetime.time.isoformat").
...
:   Return a [`time`](datetime.md#datetime.time "datetime.time") with the same value, except for those attributes given
    new values by whichever keyword arguments are specified. Note that
    `tzinfo=None` can be specified to create a naive [`time`](datetime.md#datetime.time "datetime.time") from an
    aware [`time`](datetime.md#datetime.time "datetime.time"), without conversion of the time data.
...
:   Same as [`time.strftime()`](datetime.md#datetime.time.strftime "datetime.time.strftime"). This makes it possible to specify a format string
    for a [`time`](datetime.md#datetime.time "datetime.time") object in [formatted string
    literals](https://docs.python.org/3.10/reference/lexical_analysis.html#f-strings) and when using [`str.format()`](stdtypes.md#str.format "str.format"). For a
    complete list of formatting directives, see
    [strftime() and strptime() Behavior](datetime.md#strftime-strptime-behavior).
...
:   This is an abstract base class, meaning that this class should not be
    ...
    [`datetime`](datetime.md#datetime.datetime "datetime.datetime") methods you use. The [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module provides
    ...
    [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") objects. If in doubt, simply implement all of them.
...
:   Return the daylight saving time (DST) adjustment, as a [`timedelta`](datetime.md#datetime.timedelta "datetime.timedelta")
    ...
    attribute’s [`dst()`](datetime.md#datetime.tzinfo.dst "datetime.tzinfo.dst") method to determine how the `tm_isdst` flag
    ...
    [`tzinfo.fromutc()`](datetime.md#datetime.tzinfo.fromutc "datetime.tzinfo.fromutc") to work correctly with `astimezone()` regardless.
...
:   Return the time zone name corresponding to the [`datetime`](datetime.md#datetime.datetime "datetime.datetime") object *dt*, as
    a string. Nothing about string names is defined by the [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module,
...
In the following [`tzinfo_examples.py`](https://docs.python.org/3.10/_downloads/6b45dc135219d1404be49d606589a11d/tzinfo_examples.py) file there are some examples of
...
> > :   The [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module has a basic [`timezone`](datetime.md#datetime.timezone "datetime.timezone") class (for
...
will be pulled from the default value. [4](datetime.md#id8)
...
be used, as [`time`](time.md#module-time "time: Time access and conversions.") objects have no such values. If they’re used anyway,
...
1. Because the format depends on the current locale, care should be taken when
   ...
   any one of `eucJP`, `SJIS`, or `utf-8`; use [`locale.getlocale()`](locale.md#locale.getlocale "locale.getlocale")
...
4. Unlike the [`time`](time.md#module-time "time: Time access and conversions.") module, the [`datetime`](datetime.md#module-datetime "datetime: Basic date and time types.") module does not support
   leap seconds.
