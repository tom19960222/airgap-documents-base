...
source_url: https://docs.python.org/3.10/library/curses.html
fetched_at: 2026-09-17T15:14:04+00:00
---
# `curses` — Terminal handling for character-cell displays

**Source code:** [Lib/curses](https://github.com/python/cpython/tree/3.10/Lib/curses)
...
> [`locale.setlocale()`](locale.md#locale.setlocale "locale.setlocale") in the application and encode Unicode strings
...
> ```
>
> Then use *code* as the encoding for [`str.encode()`](stdtypes.md#str.encode "str.encode") calls.
...
>
> [Curses Programming with Python](https://docs.python.org/3.10/howto/curses.html#curses-howto)
> :   Tutorial material on using curses with Python, by Andrew Kuchling and Eric
>     Raymond.
>
> The [Tools/demo/](https://github.com/python/cpython/tree/3.10/Tools/demo/) directory in the Python source distribution contains
...
`curses.getmouse()`
:   After [`getch()`](curses.md#curses.window.getch "curses.window.getch") returns `KEY_MOUSE` to signal a mouse event, this
...
:   Encoding used to encode method arguments (Unicode strings and characters).
    ...
    is created, for example with [`window.subwin()`](curses.md#curses.window.subwin "curses.window.subwin"). By default, the locale
    encoding is used (see [`locale.getpreferredencoding()`](locale.md#locale.getpreferredencoding "locale.getpreferredencoding")).
