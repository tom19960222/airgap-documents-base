...
source_url: https://docs.python.org/3.10/library/mailcap.html
fetched_at: 2026-09-17T15:15:21+00:00
---
# `mailcap` — Mailcap file handling

**Source code:** [Lib/mailcap.py](https://github.com/python/cpython/tree/3.10/Lib/mailcap.py)

Deprecated since version 3.11: The [`mailcap`](mailcap.md#module-mailcap "mailcap: Mailcap file handling. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#mailcap) for details).
...
:   Return a 2-tuple; the first element is a string containing the command line to
    ...
    *plist* can be a list containing named parameters; the default value is simply
    ...
    Changed in version 3.10.8: To prevent security issues with shell metacharacters (symbols that have
