...
source_url: https://docs.python.org/3.10/library/sched.html
fetched_at: 2026-09-17T15:14:10+00:00
---
# `sched` — Event scheduler

**Source code:** [Lib/sched.py](https://github.com/python/cpython/tree/3.10/Lib/sched.py)
...
:   The [`scheduler`](sched.md#sched.scheduler "sched.scheduler") class defines a generic interface to scheduling events.
    ...
    Changed in version 3.3: [`scheduler`](sched.md#sched.scheduler "sched.scheduler") class can be safely used in multi-threaded
    environments.
...
:   Schedule a new event. The *time* argument should be a numeric type compatible
    ...
    *kwargs* is a dictionary holding the keyword arguments for *action*.
    ...
    (see [`cancel()`](sched.md#sched.scheduler.cancel "sched.scheduler.cancel")).
...
:   Run all scheduled events. This method will wait (using the `delayfunc()`
    ...
    to [`run()`](sched.md#sched.scheduler.run "sched.scheduler.run").
...
:   Read-only attribute returning a list of upcoming events in the order they
    will be run. Each event is shown as a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) with the
