...
source_url: https://docs.python.org/3.10/library/audioop.html
fetched_at: 2026-09-17T15:15:19+00:00
---
# `audioop` — Manipulate raw audio data

Deprecated since version 3.11: The [`audioop`](audioop.md#module-audioop "audioop: Manipulate raw audio data. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#audioop) for details).
...
or 32 bits wide, stored in [bytes-like objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object). All scalar items are
integers, unless specified otherwise.

Changed in version 3.4: Support for 24-bit samples was added.
All functions now accept any [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object).
