...
source_url: https://docs.python.org/3.10/library/xml.dom.html
fetched_at: 2026-09-17T15:14:22+00:00
---
# `xml.dom` — The Document Object Model API

**Source code:** [Lib/xml/dom/__init__.py](https://github.com/python/cpython/tree/3.10/Lib/xml/dom/__init__.py)
...
[`__len__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__len__ "object.__len__") and
[`__getitem__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__getitem__ "object.__getitem__"); this allows iteration over the `NodeList` in
[`for`](https://docs.python.org/3.10/reference/compound_stmts.html#for) statements and proper support for the [`len()`](functions.md#len "len") built-in
function.

If a DOM implementation supports modification of the document, the
`NodeList` implementation must also support the
[`__setitem__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__setitem__ "object.__setitem__") and [`__delitem__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__delitem__ "object.__delitem__") methods.
