...
source_url: https://docs.python.org/3.10/library/os.html
fetched_at: 2026-09-17T15:13:59+00:00
---
# `os` — Miscellaneous operating system interfaces

**Source code:** [Lib/os.py](https://github.com/python/cpython/tree/3.10/Lib/os.py)
...
uses the [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler) to perform this
...
The [file system encoding](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler) must
...
See also the [locale encoding](https://docs.python.org/3.10/glossary.html#term-locale-encoding).

## Python UTF-8 Mode

New in version 3.7: See [**PEP 540**](https://www.python.org/dev/peps/pep-0540) for more details.

The Python UTF-8 Mode ignores the [locale encoding](https://docs.python.org/3.10/glossary.html#term-locale-encoding) and forces the usage
of the UTF-8 encoding:

- Use UTF-8 as the [filesystem encoding](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler).
...
[`PYTHONIOENCODING`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONIOENCODING) (just as they can be in the default locale-aware
mode).
...
It can be enabled or disabled using the [`-X utf8`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-X) command line
option and the [`PYTHONUTF8`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONUTF8) environment variable.

If the [`PYTHONUTF8`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONUTF8) environment variable is not set at all, then the
...
[`PYTHONCOERCECLOCALE`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONCOERCECLOCALE)), and locale coercion is either disabled or
...
See also the [UTF-8 mode on Windows](https://docs.python.org/3.10/using/windows.html#win-utf8-mode)
and the [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler).
...
`os.environ`
:   A [mapping](https://docs.python.org/3.10/glossary.html#term-mapping) object where keys and values are strings that represent
    ...
    Changed in version 3.9: Updated to support [**PEP 584**](https://www.python.org/dev/peps/pep-0584)’s merge (`|`) and update (`|=`) operators.

`os.environb`
:   Bytes version of [`environ`](os.md#os.environ "os.environ"): a [mapping](https://docs.python.org/3.10/glossary.html#term-mapping) object where both keys
...
:   Encode [path-like](https://docs.python.org/3.10/glossary.html#term-path-like-object) *filename* to the
    [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler); return [`bytes`](stdtypes.md#bytes "bytes")
    unchanged.
...
:   Decode the [path-like](https://docs.python.org/3.10/glossary.html#term-path-like-object) *filename* from the
    [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler); return [`str`](stdtypes.md#str "str")
    unchanged.
...
`class os.PathLike`
:   An [abstract base class](https://docs.python.org/3.10/glossary.html#term-abstract-base-class) for objects representing a file system path,
...
:   Return the value of the environment variable *key* as a string if it exists, or
    *default* if it doesn’t. *key* is a string. Note that
    ...
    [Availability](intro.md#availability): most flavors of Unix, Windows.
...
:   Return the value of the environment variable *key* as bytes if it exists, or
    *default* if it doesn’t. *key* must be bytes. Note that
    ...
    [Availability](intro.md#availability): most flavors of Unix.
...
:   Returns information identifying the current operating system.
    ...
    [Availability](intro.md#availability): recent flavors of Unix.
...
These functions create new [file objects](https://docs.python.org/3.10/glossary.html#term-file-object). (See also
...
associated with a [file object](https://docs.python.org/3.10/glossary.html#term-file-object) when required. Note that using the file
...
:   Copy *count* bytes from file descriptor *src*, starting from offset
    *offset_src*, to file descriptor *dst*, starting from offset *offset_dst*.
    ...
    [Availability](intro.md#availability): Linux kernel >= 4.5 or glibc >= 2.27.
...
:   Force write of file with filedescriptor *fd* to disk. On Unix, this calls the
    ...
    If you’re starting with a buffered Python [file object](https://docs.python.org/3.10/glossary.html#term-file-object) *f*, first do
...
:   Set the current position of file descriptor *fd* to position *pos*, modified
    by *how*: [`SEEK_SET`](os.md#os.SEEK_SET "os.SEEK_SET") or `0` to set the position relative to the
    beginning of the file; [`SEEK_CUR`](os.md#os.SEEK_CUR "os.SEEK_CUR") or `1` to set it relative to the
    current position; [`SEEK_END`](os.md#os.SEEK_END "os.SEEK_END") or `2` to set it relative to the end of
...
`os.SEEK_END`
:   Parameters to the [`lseek()`](os.md#os.lseek "os.lseek") function. Their values are 0, 1, and 2,
    respectively.
...
:   Open the file *path* and set various flags according to *flags* and possibly
    ...
    > built-in function [`open()`](functions.md#open "open"), which returns a [file object](https://docs.python.org/3.10/glossary.html#term-file-object) with
...
:   Open a new pseudo-terminal pair. Return a pair of file descriptors
    ...
    [Availability](intro.md#availability): some flavors of Unix.
...
:   Read from a file descriptor *fd* at a position of *offset* into mutable
    [bytes-like objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) *buffers*, leaving the file
    ...
    [Availability](intro.md#availability): Linux 2.6.30 and newer, FreeBSD 6.0 and newer,
...
:   Do not wait for data which is not immediately available. If this flag is
    ...
    [Availability](intro.md#availability): Linux 4.14 and newer.
...
:   High priority read/write. Allows block-based filesystems to use polling
    ...
    [Availability](intro.md#availability): Linux 4.6 and newer.
...
:   Write the *buffers* contents to file descriptor *fd* at a offset *offset*,
    ...
    [bytes-like objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object). Buffers are processed in
...
:   Provide a per-write equivalent of the [`O_DSYNC`](os.md#os.O_DSYNC "os.O_DSYNC") [`os.open()`](os.md#os.open "os.open") flag.
    ...
    [Availability](intro.md#availability): Linux 4.7 and newer.
...
:   Provide a per-write equivalent of the [`O_APPEND`](os.md#os.O_APPEND "os.O_APPEND") [`os.open()`](os.md#os.open "os.open")
    ...
    *offset* argument does not affect the write operation; the data is always
    ...
    [Availability](intro.md#availability): Linux 4.16 and newer.
...
:   Transfer *count* bytes from file descriptor *src*, starting from offset
    ...
    *offset_dst*. The offset associated to the file descriptor that refers to a
    ...
    [Availability](intro.md#availability): Linux kernel >= 2.6.17 and glibc >= 2.5
...
:   Read from a file descriptor *fd* into a number of mutable [bytes-like
    objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) *buffers*. Transfer data into each buffer until
...
:   Write the contents of *buffers* to file descriptor *fd*. *buffers* must be
    a sequence of [bytes-like objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object). Buffers are
...
:   Use the real uid/gid to test for access to *path*. Note that most operations
    ...
    *effective_ids* may not be supported on your platform; you can check whether
    ...
    > and opening the file to manipulate it. It’s preferable to use [EAFP](https://docs.python.org/3.10/glossary.html#term-EAFP)
...
:   Change the owner and group id of *path* to the numeric *uid* and *gid*. To
    ...
    Changed in version 3.6: Supports a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Return a bytestring representing the current working directory.
    ...
    code page: see [**PEP 529**](https://www.python.org/dev/peps/pep-0529) for the rationale. The function is no longer
...
:   Create a hard link pointing to *src* named *dst*.
    ...
    Changed in version 3.6: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) for *src* and *dst*.
...
:   Return a list containing the names of the entries in the directory given by
    ...
    *path* may be a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object). If *path* is of type `bytes`
...
:   Create a directory named *path* with numeric mode *mode*.
    ...
    Changed in version 3.10.15: Windows now handles a *mode* of `0o700`.
...
:   Recursive directory creation function. Like [`mkdir()`](os.md#os.mkdir "os.mkdir"), but makes all
    ...
    If *exist_ok* is `False` (the default), an [`FileExistsError`](exceptions.md#FileExistsError "FileExistsError") is
...
:   Return a string representing the path to which the symbolic link points. The
    ...
    Changed in version 3.6: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) on Unix.

    Changed in version 3.8: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) and a bytes object on Windows.
...
:   Recursive directory or file renaming function. Works like [`rename()`](os.md#os.rename "os.rename"), except
    ...
    Changed in version 3.6: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) for *old* and *new*.
...
:   Remove (delete) the directory *path*. If the directory does not exist or is
    not empty, an [`FileNotFoundError`](exceptions.md#FileNotFoundError "FileNotFoundError") or an [`OSError`](exceptions.md#OSError "OSError") is raised
...
:   Return an iterator of [`os.DirEntry`](os.md#os.DirEntry "os.DirEntry") objects corresponding to the
    ...
    *path* may be a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object). If *path* is of type `bytes`
    ...
    The [`scandir()`](os.md#os.scandir "os.scandir") iterator supports the [context manager](https://docs.python.org/3.10/glossary.html#term-context-manager) protocol
    ...
    :   Close the iterator and free acquired resources.
        ...
        is advisable to call it explicitly or use the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
        statement.
    ...
    New in version 3.6: Added support for the [context manager](https://docs.python.org/3.10/glossary.html#term-context-manager) protocol and the
    ...
    The function accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Object yielded by [`scandir()`](os.md#os.scandir "os.scandir") to expose the file path and other file
    ...
    To be directly usable as a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object), `os.DirEntry`
...
:   Object whose attributes correspond roughly to the members of the
    ...
    > [`st_mtime`](os.md#os.stat_result.st_mtime "os.stat_result.st_mtime"), and [`st_ctime`](os.md#os.stat_result.st_ctime "os.stat_result.st_ctime") attributes depend on the operating
    > system and the file system. For example, on Windows systems using the FAT
    > or FAT32 file systems, [`st_mtime`](os.md#os.stat_result.st_mtime "os.stat_result.st_mtime") has 2-second resolution, and
    > [`st_atime`](os.md#os.stat_result.st_atime "os.stat_result.st_atime") has only 1-day resolution. See your operating system
    ...
    > and [`st_ctime_ns`](os.md#os.stat_result.st_ctime_ns "os.stat_result.st_ctime_ns") are always expressed in nanoseconds, many
    > systems do not provide nanosecond precision. On systems that do
    > provide nanosecond precision, the floating-point object used to
    > store [`st_atime`](os.md#os.stat_result.st_atime "os.stat_result.st_atime"), [`st_mtime`](os.md#os.stat_result.st_mtime "os.stat_result.st_mtime"), and [`st_ctime`](os.md#os.stat_result.st_ctime "os.stat_result.st_ctime")
    > cannot preserve all of it, and as such will be slightly inexact.
    > If you need the exact timestamps you should always use
    > [`st_atime_ns`](os.md#os.stat_result.st_atime_ns "os.stat_result.st_atime_ns"), [`st_mtime_ns`](os.md#os.stat_result.st_mtime_ns "os.stat_result.st_mtime_ns"), and [`st_ctime_ns`](os.md#os.stat_result.st_ctime_ns "os.stat_result.st_ctime_ns").
    ...
    `st_reparse_tag`
    :   When [`st_file_attributes`](os.md#os.stat_result.st_file_attributes "os.stat_result.st_file_attributes") has the `FILE_ATTRIBUTE_REPARSE_POINT`
        set, this field contains the tag identifying the type of reparse point.
        See the `IO_REPARSE_TAG_*` constants in the [`stat`](stat.md#module-stat "stat: Utilities for interpreting the results of os.stat(), os.lstat() and os.fstat().") module.
    ...
    New in version 3.3: Added the [`st_atime_ns`](os.md#os.stat_result.st_atime_ns "os.stat_result.st_atime_ns"), [`st_mtime_ns`](os.md#os.stat_result.st_mtime_ns "os.stat_result.st_mtime_ns"), and
    [`st_ctime_ns`](os.md#os.stat_result.st_ctime_ns "os.stat_result.st_ctime_ns") members.

    New in version 3.5: Added the [`st_file_attributes`](os.md#os.stat_result.st_file_attributes "os.stat_result.st_file_attributes") member on Windows.
    ...
    New in version 3.7: Added the [`st_fstype`](os.md#os.stat_result.st_fstype "os.stat_result.st_fstype") member to Solaris/derivatives.

    New in version 3.8: Added the [`st_reparse_tag`](os.md#os.stat_result.st_reparse_tag "os.stat_result.st_reparse_tag") member on Windows.
...
:   Generate the file names in a directory tree by walking the tree
    ...
    *dirpath* directory during generating the lists, whether a name for that
    ...
    (perhaps using [`del`](https://docs.python.org/3.10/reference/simple_stmts.html#del) or slice assignment), and [`walk()`](os.md#os.walk "os.walk") will only
...
:   Create an anonymous file and return a file descriptor that refers to it.
    *flags* must be one of the `os.MFD_*` constants available on the system
    ...
    [Availability](intro.md#availability): Linux 3.17 or newer with glibc 2.27 or newer.
...
:   These flags can be passed to [`memfd_create()`](os.md#os.memfd_create "os.memfd_create").
    ...
    [Availability](intro.md#availability): Linux 3.17 or newer with glibc 2.27 or newer. The
...
:   Create and return an event file descriptor. The file descriptors supports
    ...
    *flags* can be constructed from [`EFD_CLOEXEC`](os.md#os.EFD_CLOEXEC "os.EFD_CLOEXEC"),
    ...
    [Availability](intro.md#availability): Linux 2.6.27 or newer with glibc 2.8 or newer.
...
:   Read value from an [`eventfd()`](os.md#os.eventfd "os.eventfd") file descriptor and return a 64 bit
    ...
    [Availability](intro.md#availability): See [`eventfd()`](os.md#os.eventfd "os.eventfd")
...
`os.EFD_SEMAPHORE`
:   Provide semaphore-like semantics for reads from a [`eventfd()`](os.md#os.eventfd "os.eventfd") file
    descriptor. On read the internal counter is decremented by one.

    [Availability](intro.md#availability): Linux 2.6.30 or newer with glibc 2.8 or newer.
...
:   Return the value of the extended filesystem attribute *attribute* for
    *path*. *attribute* can be bytes or str (directly or indirectly through the
    ...
    Changed in version 3.6: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) for *path* and *attribute*.
...
:   Removes the extended filesystem attribute *attribute* from *path*.
    *attribute* should be bytes or str (directly or indirectly through the
    ...
    with the [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler).
...
:   Set the extended filesystem attribute *attribute* on *path* to *value*.
    *attribute* must be a bytes or str with no embedded NULs (directly or
    ...
    it is encoded with the [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler). *flags* may be
...
:   Add a path to the DLL search path.
    ...
    or using it in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement.
    ...
    [porting notes](https://docs.python.org/3.10/whatsnew/3.8.html#bpo-36085-whatsnew) for information on
    updating libraries.
...
:   Fork a child process. Return `0` in the child and the child’s process id in the
    ...
    > **Warning:**
    >
    > See [`ssl`](ssl.md#module-ssl "ssl: TLS/SSL wrapper for socket objects") for applications that use the SSL module with fork().
...
:   Send signal *sig* to the process *pid*. Constants for the specific signals
    ...
    will be set to *sig*. The Windows version of [`kill()`](os.md#os.kill "os.kill") additionally takes
...
:   Wraps the `posix_spawnp()` C library API for use from Python.
    ...
    [Availability](intro.md#availability): See [`posix_spawn()`](os.md#os.posix_spawn "os.posix_spawn") documentation.
...
:   Register callables to be executed when a new child process is forked
    ...
    call those functions, unless it explicitly calls [`PyOS_BeforeFork()`](https://docs.python.org/3.10/c-api/sys.html#c.PyOS_BeforeFork "PyOS_BeforeFork"),
    [`PyOS_AfterFork_Parent()`](https://docs.python.org/3.10/c-api/sys.html#c.PyOS_AfterFork_Parent "PyOS_AfterFork_Parent") and [`PyOS_AfterFork_Child()`](https://docs.python.org/3.10/c-api/sys.html#c.PyOS_AfterFork_Child "PyOS_AfterFork_Child").
...
:   Execute the program *path* in a new process.
    ...
    [Availability](intro.md#availability): Unix, Windows. [`spawnlp()`](os.md#os.spawnlp "os.spawnlp"), [`spawnlpe()`](os.md#os.spawnlpe "os.spawnlpe"), [`spawnvp()`](os.md#os.spawnvp "os.spawnvp")
...
:   Returns the current global process times.
    ...
    *[times(2)](https://manpages.debian.org/times(2))* and [times(3)](https://www.freebsd.org/cgi/man.cgi?time(3)) manual page on Unix or [the GetProcessTimes MSDN](https://docs.microsoft.com/windows/win32/api/processthreadsapi/nf-processthreadsapi-getprocesstimes)
...
:   Wait for completion of a child process, and return a tuple containing its pid
    ...
    > **See also:**
    >
    > [`waitpid()`](os.md#os.waitpid "os.waitpid") can be used to wait for the completion of a specific
    > child process and has more options.

`os.waitid(idtype, id, options)`
:   Wait for the completion of one or more child processes.
    *idtype* can be [`P_PID`](os.md#os.P_PID "os.P_PID"), [`P_PGID`](os.md#os.P_PGID "os.P_PGID"), [`P_ALL`](os.md#os.P_ALL "os.P_ALL"), or
    [`P_PIDFD`](os.md#os.P_PIDFD "os.P_PIDFD") on Linux.
    *id* specifies the pid to wait on.
    *options* is constructed from the ORing of one or more of [`WEXITED`](os.md#os.WEXITED "os.WEXITED"),
    [`WSTOPPED`](os.md#os.WSTOPPED "os.WSTOPPED") or [`WCONTINUED`](os.md#os.WCONTINUED "os.WCONTINUED") and additionally may be ORed with
    [`WNOHANG`](os.md#os.WNOHANG "os.WNOHANG") or [`WNOWAIT`](os.md#os.WNOWAIT "os.WNOWAIT"). The return value is an object
    representing the data contained in the `siginfo_t` structure, namely:
    `si_pid`, `si_uid`, `si_signo`, `si_status`,
    `si_code` or `None` if [`WNOHANG`](os.md#os.WNOHANG "os.WNOHANG") is specified and there are no
...
`os.WNOWAIT`
:   Flags that can be used in *options* in [`waitid()`](os.md#os.waitid "os.waitid") that specify what
...
:   The details of this function differ on Unix and Windows.
    ...
    An [`OSError`](exceptions.md#OSError "OSError") is raised with the value of errno when the syscall
    returns -1.
...
:   Similar to [`waitpid()`](os.md#os.waitpid "os.waitpid"), except no process id argument is given and a
    ...
    [`resource`](resource.md#module-resource "resource: An interface to provide resource usage information on the current process. (Unix)").[`getrusage()`](resource.md#resource.getrusage "resource.getrusage") for details on resource usage
    information. The option argument is the same as that provided to
    [`waitpid()`](os.md#os.waitpid "os.waitpid") and [`wait4()`](os.md#os.wait4 "os.wait4").
...
:   Similar to [`waitpid()`](os.md#os.waitpid "os.waitpid"), except a 3-element tuple, containing the child’s
    ...
    Refer to [`resource`](resource.md#module-resource "resource: An interface to provide resource usage information on the current process. (Unix)").[`getrusage()`](resource.md#resource.getrusage "resource.getrusage") for details on
    resource usage information. The arguments to [`wait4()`](os.md#os.wait4 "os.wait4") are the same
    as those provided to [`waitpid()`](os.md#os.waitpid "os.waitpid").
...
`os.WNOHANG`
:   The option for [`waitpid()`](os.md#os.waitpid "os.waitpid") to return immediately if no child process status
...
:   This option causes child processes to be reported if they have been continued
    ...
    [Availability](intro.md#availability): some Unix systems.
...
:   Get up to *size* random bytes. The function can return less bytes than
    ...
    [Availability](intro.md#availability): Linux 3.17 and newer.
...
:   Return a bytestring of *size* random bytes suitable for cryptographic use.
    ...
    (128 bits of entropy are collected by the kernel). See the [**PEP 524**](https://www.python.org/dev/peps/pep-0524) for
