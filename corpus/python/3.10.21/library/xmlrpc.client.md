...
source_url: https://docs.python.org/3.10/library/xmlrpc.client.html
fetched_at: 2026-09-17T15:14:34+00:00
---
# `xmlrpc.client` — XML-RPC client access

**Source code:** [Lib/xmlrpc/client.py](https://github.com/python/cpython/tree/3.10/Lib/xmlrpc/client.py)
...
be [`ssl.SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") and configures the SSL settings of the underlying
HTTPS connection.
...
| `struct` | [`dict`](stdtypes.md#dict "dict"). Keys must be strings, values may be any conformable type. Objects of user-defined classes can be passed in; only their [`__dict__`](stdtypes.md#object.__dict__ "object.__dict__") attribute is transmitted. |
...
Changed in version 3.5: Instances of [`ServerProxy`](xmlrpc.client.md#xmlrpc.client.ServerProxy "xmlrpc.client.ServerProxy") support the [context manager](https://docs.python.org/3.10/glossary.html#term-context-manager) protocol
...
:   Create an object used to boxcar method calls. *server* is the eventual target of
    ...
    is a [generator](https://docs.python.org/3.10/glossary.html#term-generator); iterating over this generator yields the individual
    results.
