...
source_url: https://docs.python.org/3.10/library/hashlib.html
fetched_at: 2026-09-17T15:13:57+00:00
---
# `hashlib` — Secure hashes and message digests

**Source code:** [Lib/hashlib.py](https://github.com/python/cpython/tree/3.10/Lib/hashlib.py)
...
objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) (normally [`bytes`](stdtypes.md#bytes "bytes")) using the `update()` method.
...
> **Note:**
>
> For better multithreading performance, the Python [GIL](https://docs.python.org/3.10/glossary.html#term-GIL) is released for
...
`sha512()`, [`blake2b()`](hashlib.md#hashlib.blake2b "hashlib.blake2b"), and [`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s").
...
New in version 3.6: [`blake2b()`](hashlib.md#hashlib.blake2b "hashlib.blake2b") and [`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s") were added.
...
:   Is a generic constructor that takes the string *name* of the desired
    ...
    library may offer. The named constructors are much faster than [`new()`](hashlib.md#hashlib.new "hashlib.new")
    and should be preferred.

Using [`new()`](hashlib.md#hashlib.new "hashlib.new") with an algorithm provided by OpenSSL:
...
`hash.update(data)`
:   Update the hash object with the [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object).
...
:   The function provides PKCS#5 password-based key derivation function 2. It
    ...
    *dklen* is the length of the derived key. If *dklen* is `None` then the
    ...
    > Python implementation uses an inline version of [`hmac`](hmac.md#module-hmac "hmac: Keyed-Hashing for Message Authentication (HMAC) implementation"). It is about
...
:   The function provides scrypt password-based key derivation function as
    ...
    *password* and *salt* must be [bytes-like objects](https://docs.python.org/3.10/glossary.html#term-bytes-like-object). Applications and libraries should limit *password*
...
[BLAKE2](https://blake2.net) is a cryptographic hash function defined in [**RFC 7693**](https://datatracker.ietf.org/doc/html/rfc7693.html) that comes in two
flavors:
...
- *data*: initial chunk of data to hash, which must be
  [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object). It can be passed only as positional argument.
...
See section 2.10 in [BLAKE2 specification](https://blake2.net/blake2_20130129.pdf) for comprehensive review of tree
hashing.
...
[`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s")), then update it with the data by calling `update()` on the
...
> by the signer.
>
> ([NIST SP-800-106 “Randomized Hashing for Digital Signatures”](https://csrc.nist.gov/publications/detail/sp/800-106/final))
...
> passwords. See [BLAKE2 FAQ](https://blake2.net/#qa) for more
> information.
...
[BLAKE2](https://blake2.net) was designed by *Jean-Philippe Aumasson*, *Samuel Neves*, *Zooko
Wilcox-O’Hearn*, and *Christian Winnerlein* based on [SHA-3](https://en.wikipedia.org/wiki/NIST_hash_function_competition) finalist [BLAKE](https://131002.net/blake/)
