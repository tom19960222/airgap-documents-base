...
source_url: https://docs.python.org/3.10/library/termios.html
...
`sys.stdin.fileno()`, or a [file object](https://docs.python.org/3.10/glossary.html#term-file-object), such as `sys.stdin` itself.
...
technique using a separate [`tcgetattr()`](termios.md#termios.tcgetattr "termios.tcgetattr") call and a [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try) …
[`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) statement to ensure that the old tty attributes are restored
