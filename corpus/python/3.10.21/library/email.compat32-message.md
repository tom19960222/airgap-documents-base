...
source_url: https://docs.python.org/3.10/library/email.compat32-message.html
fetched_at: 2026-09-17T15:15:37+00:00
---
...
:   If *policy* is specified (it must be an instance of a [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages")
    ...
    :   Return the value of the named header field. This is identical to
        [`__getitem__()`](email.compat32-message.md#email.message.Message.__getitem__ "email.message.Message.__getitem__") except that optional *failobj* is returned if the
