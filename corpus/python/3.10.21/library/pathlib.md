...
source_url: https://docs.python.org/3.10/library/pathlib.html
fetched_at: 2026-09-17T15:13:44+00:00
---
# `pathlib` — Object-oriented filesystem paths

New in version 3.4.

**Source code:** [Lib/pathlib.py](https://github.com/python/cpython/tree/3.10/Lib/pathlib.py)
...
:   A generic class that represents the system’s path flavour (instantiating
    ...
    path segment, an object implementing the [`os.PathLike`](os.md#os.PathLike "os.PathLike") interface
...
Paths are immutable and [hashable](https://docs.python.org/3.10/glossary.html#term-hashable). Paths of a same flavour are comparable
...
:   An immutable sequence providing access to the logical ancestors of
    ...
    Changed in version 3.10: The parents sequence now supports [slices](https://docs.python.org/3.10/glossary.html#term-slice) and negative index values.
...
:   Compute a version of this path relative to the path represented by
    *other*. If it’s impossible, ValueError is raised:
    ...
    NOTE: This function is part of [`PurePath`](pathlib.md#pathlib.PurePath "pathlib.PurePath") and works with strings. It does not check or access the underlying file structure.
...
methods. Many of these methods can raise an [`OSError`](exceptions.md#OSError "OSError") if a system
...
:   Return a [`os.stat_result`](os.md#os.stat_result "os.stat_result") object containing information about this path, like [`os.stat()`](os.md#os.stat "os.stat").
...
:   Whether the path points to an existing file or directory:
    ...
    > **Note:**
    >
    > If the path points to a symlink, [`exists()`](pathlib.md#pathlib.Path.exists "pathlib.Path.exists") returns whether the
...
:   Create a new directory at this given path. If *mode* is given, it is
    ...
    *mode* into account (mimicking the POSIX `mkdir -p` command).
    ...
    If *exist_ok* is true, [`FileExistsError`](exceptions.md#FileExistsError "FileExistsError") exceptions will be
...
`Path.rglob(pattern)`
:   This is like calling [`Path.glob()`](pathlib.md#pathlib.Path.glob "pathlib.Path.glob") with “`**/`” added in front of the
...
:   Make *target* a hard link to this path.
    ...
    > (target, link) is the reverse of [`Path.symlink_to()`](pathlib.md#pathlib.Path.symlink_to "pathlib.Path.symlink_to") and
    > [`Path.hardlink_to()`](pathlib.md#pathlib.Path.hardlink_to "pathlib.Path.hardlink_to"), but matches that of [`os.link()`](os.md#os.link "os.link").

    New in version 3.8.

    Deprecated since version 3.10: This method is deprecated in favor of [`Path.hardlink_to()`](pathlib.md#pathlib.Path.hardlink_to "pathlib.Path.hardlink_to"), as the
    argument order of [`Path.link_to()`](pathlib.md#pathlib.Path.link_to "pathlib.Path.link_to") does not match that of
    [`Path.symlink_to()`](pathlib.md#pathlib.Path.symlink_to "pathlib.Path.symlink_to").
...
> include [`os.path.abspath()`](os.path.md#os.path.abspath "os.path.abspath") and [`Path.resolve()`](pathlib.md#pathlib.Path.resolve "pathlib.Path.resolve"),
> [`os.path.relpath()`](os.path.md#os.path.relpath "os.path.relpath") and [`PurePath.relative_to()`](pathlib.md#pathlib.PurePath.relative_to "pathlib.PurePath.relative_to").
...
| --- | --- |
| [`os.path.abspath()`](os.path.md#os.path.abspath "os.path.abspath") | [`Path.resolve()`](pathlib.md#pathlib.Path.resolve "pathlib.Path.resolve") [1](pathlib.md#id5) |
| [`os.chmod()`](os.md#os.chmod "os.chmod") | [`Path.chmod()`](pathlib.md#pathlib.Path.chmod "pathlib.Path.chmod") |
| [`os.mkdir()`](os.md#os.mkdir "os.mkdir") | [`Path.mkdir()`](pathlib.md#pathlib.Path.mkdir "pathlib.Path.mkdir") |
| [`os.makedirs()`](os.md#os.makedirs "os.makedirs") | [`Path.mkdir()`](pathlib.md#pathlib.Path.mkdir "pathlib.Path.mkdir") |
...
| [`os.path.expanduser()`](os.path.md#os.path.expanduser "os.path.expanduser") | [`Path.expanduser()`](pathlib.md#pathlib.Path.expanduser "pathlib.Path.expanduser") and [`Path.home()`](pathlib.md#pathlib.Path.home "pathlib.Path.home") |
...
| [`os.path.relpath()`](os.path.md#os.path.relpath "os.path.relpath") | [`PurePath.relative_to()`](pathlib.md#pathlib.PurePath.relative_to "pathlib.PurePath.relative_to") [2](pathlib.md#id6) |
| [`os.stat()`](os.md#os.stat "os.stat") | [`Path.stat()`](pathlib.md#pathlib.Path.stat "pathlib.Path.stat"), [`Path.owner()`](pathlib.md#pathlib.Path.owner "pathlib.Path.owner"), [`Path.group()`](pathlib.md#pathlib.Path.group "pathlib.Path.group") |
...
| [`os.path.splitext()`](os.path.md#os.path.splitext "os.path.splitext") | [`PurePath.stem`](pathlib.md#pathlib.PurePath.stem "pathlib.PurePath.stem") and [`PurePath.suffix`](pathlib.md#pathlib.PurePath.suffix "pathlib.PurePath.suffix") |

Footnotes

[1](pathlib.md#id3)
:   [`os.path.abspath()`](os.path.md#os.path.abspath "os.path.abspath") does not resolve symbolic links while [`Path.resolve()`](pathlib.md#pathlib.Path.resolve "pathlib.Path.resolve") does.

[2](pathlib.md#id4)
:   [`PurePath.relative_to()`](pathlib.md#pathlib.PurePath.relative_to "pathlib.PurePath.relative_to") requires `self` to be the subpath of the argument, but [`os.path.relpath()`](os.path.md#os.path.relpath "os.path.relpath") does not.
