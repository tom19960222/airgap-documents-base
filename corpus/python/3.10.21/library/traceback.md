...
source_url: https://docs.python.org/3.10/library/traceback.html
fetched_at: 2026-09-17T15:15:00+00:00
---
# `traceback` — Print or retrieve a stack traceback

**Source code:** [Lib/traceback.py](https://github.com/python/cpython/tree/3.10/Lib/traceback.py)
...
the [`sys.last_traceback`](sys.md#sys.last_traceback "sys.last_traceback") variable and returned as the third item from
...
:   This is a shorthand for `print_exception(sys.last_type, sys.last_value,
    ...
    [`sys.last_type`](sys.md#sys.last_type "sys.last_type")).
...
:   Format the exception part of a traceback using an exception value such as
    ...
    for [`SyntaxError`](exceptions.md#SyntaxError "SyntaxError") exceptions, it contains several lines that (when
...
[`TracebackException`](traceback.md#traceback.TracebackException "traceback.TracebackException") objects are created from actual exceptions to
...
:   Capture an exception for later rendering. *limit*, *lookup_lines* and
    *capture_locals* are as for the [`StackSummary`](traceback.md#traceback.StackSummary "traceback.StackSummary") class.
    ...
    If *compact* is true, only data that is required by [`TracebackException`](traceback.md#traceback.TracebackException "traceback.TracebackException")’s
    ...
    `__cause__`
    :   A [`TracebackException`](traceback.md#traceback.TracebackException "traceback.TracebackException") of the original `__cause__`.

    `__context__`
    :   A [`TracebackException`](traceback.md#traceback.TracebackException "traceback.TracebackException") of the original `__context__`.
    ...
    :   Format the exception part of the traceback.
        ...
        [`SyntaxError`](exceptions.md#SyntaxError "SyntaxError") exceptions, it emits several lines that (when
...
[`StackSummary`](traceback.md#traceback.StackSummary "traceback.StackSummary") objects represent a call stack ready for formatting.

`class traceback.StackSummary`
:   `classmethod extract(frame_gen, *, limit=None, lookup_lines=True, capture_locals=False)`
    :   Construct a [`StackSummary`](traceback.md#traceback.StackSummary "traceback.StackSummary") object from a frame generator (such as
        ...
        creating the [`StackSummary`](traceback.md#traceback.StackSummary "traceback.StackSummary") cheaper (which may be valuable if it
        may not actually get formatted). If *capture_locals* is `True` the
        local variables in each [`FrameSummary`](traceback.md#traceback.FrameSummary "traceback.FrameSummary") are captured as object
        representations.

    `classmethod from_list(a_list)`
    :   Construct a [`StackSummary`](traceback.md#traceback.StackSummary "traceback.StackSummary") object from a supplied list of
...
[`FrameSummary`](traceback.md#traceback.FrameSummary "traceback.FrameSummary") objects represent a single frame in a traceback.

`class traceback.FrameSummary(filename, lineno, name, lookup_line=True, locals=None, line=None)`
:   Represent a single frame in the traceback or stack that is being formatted
    or printed. It may optionally have a stringified version of the frames
    locals included in it. If *lookup_line* is `False`, the source code is not
    looked up until the [`FrameSummary`](traceback.md#traceback.FrameSummary "traceback.FrameSummary") has the `line`
