...
source_url: https://docs.python.org/3.10/library/asyncio-task.html
...
- [Running an asyncio Program](asyncio-task.md#running-an-asyncio-program)
...
- [Generator-based Coroutines](asyncio-task.md#generator-based-coroutines)

## Coroutines

**Source code:** [Lib/asyncio/coroutines.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/coroutines.py)

---

[Coroutines](https://docs.python.org/3.10/glossary.html#term-coroutine) declared with the async/await syntax is the
...
- The [`asyncio.run()`](asyncio-task.md#asyncio.run "asyncio.run") function to run the top-level
...
in an [`await`](https://docs.python.org/3.10/reference/expressions.html#await) expression. Many asyncio APIs are designed to
accept awaitables.
...
>
> - a *coroutine function*: an [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def) function;
> - a *coroutine object*: an object returned by calling a
>   *coroutine function*.

asyncio also supports legacy [generator-based](asyncio-task.md#asyncio-generator-based-coro) coroutines.
...
:   Execute the [coroutine](https://docs.python.org/3.10/glossary.html#term-coroutine) *coro* and return the result.
    ...
    > [Lib/asyncio/runners.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/runners.py).

## Creating Tasks

**Source code:** [Lib/asyncio/tasks.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/tasks.py)
...
:   Block for *delay* seconds.
    ...
    Deprecated since version 3.8, removed in version 3.10: The `loop` parameter. This function has been implicitly getting the
    current running loop since 3.7. See
    [What’s New in 3.10’s Removed section](https://docs.python.org/3.10/whatsnew/3.10.html#whatsnew310-removed)
...
:   Wait for the *aw* [awaitable](asyncio-task.md#asyncio-awaitables)
    ...
    *timeout* can either be `None` or a float or int number of seconds
    ...
    [`asyncio.TimeoutError`](asyncio-exceptions.md#asyncio.TimeoutError "asyncio.TimeoutError").
    ...
    [`asyncio.TimeoutError`](asyncio-exceptions.md#asyncio.TimeoutError "asyncio.TimeoutError") immediately.
...
:   Run [awaitable objects](asyncio-task.md#asyncio-awaitables) in the *aws*
    ...
    *timeout* (a float or int), if specified, can be used to control
    ...
    Note that this function does not raise [`asyncio.TimeoutError`](asyncio-exceptions.md#asyncio.TimeoutError "asyncio.TimeoutError").
    ...
    *return_when* indicates when this function should return. It must
    ...
    [confusing behavior](asyncio-task.md#asyncio-example-wait-coroutine).
    ...
    Deprecated since version 3.8, will be removed in version 3.11: Passing coroutine objects to `wait()` directly is
    deprecated.
...
:   Run [awaitable objects](asyncio-task.md#asyncio-awaitables) in the *aws*
    ...
    Raises [`asyncio.TimeoutError`](asyncio-exceptions.md#asyncio.TimeoutError "asyncio.TimeoutError") if the timeout occurs before
...
:   Asynchronously run function *func* in a separate thread.
    ...
    > **Note:**
    >
    > Due to the [GIL](https://docs.python.org/3.10/glossary.html#term-GIL), `asyncio.to_thread()` can typically only be used
...
:   A [`Future-like`](asyncio-future.md#asyncio.Future "asyncio.Future") object that runs a Python
    ...
    Tasks support the [`contextvars`](contextvars.md#module-contextvars "contextvars: Context Variables") module. When a Task
    ...
    :   Request the Task to be cancelled.
        ...
        request by suppressing the exception with a [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try) …
        … `except CancelledError` … [`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) block.
    ...
    :   Return the result of the Task.
        ...
        a [`InvalidStateError`](asyncio-exceptions.md#asyncio.InvalidStateError "asyncio.InvalidStateError") exception.
...
[`@asyncio.coroutine`](asyncio-task.md#asyncio.coroutine "asyncio.coroutine"), although this is not
enforced.
...
:   Decorator to mark generator-based coroutines.
    ...
    This decorator should not be used for [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def)
    coroutines.
...
:   Return `True` if *obj* is a [coroutine object](asyncio-task.md#coroutine).

    This method is different from [`inspect.iscoroutine()`](inspect.md#inspect.iscoroutine "inspect.iscoroutine") because
    it returns `True` for generator-based coroutines.

`asyncio.iscoroutinefunction(func)`
:   Return `True` if *func* is a [coroutine function](asyncio-task.md#coroutine).

    This method is different from [`inspect.iscoroutinefunction()`](inspect.md#inspect.iscoroutinefunction "inspect.iscoroutinefunction")
    because it returns `True` for generator-based coroutine functions
    decorated with [`@coroutine`](asyncio-task.md#asyncio.coroutine "asyncio.coroutine").
