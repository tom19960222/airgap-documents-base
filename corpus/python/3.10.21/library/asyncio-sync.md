...
source_url: https://docs.python.org/3.10/library/asyncio-sync.html
fetched_at: 2026-09-17T15:15:29+00:00
---
# Synchronization Primitives

**Source code:** [Lib/asyncio/locks.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/locks.py)
...
:   Implements a mutex lock for asyncio tasks. Not thread-safe.
    ...
    The preferred way to use a Lock is an [`async with`](https://docs.python.org/3.10/reference/compound_stmts.html#async-with)
    statement:
...
:   A Condition object. Not thread-safe.
    ...
    The preferred way to use a Condition is an [`async with`](https://docs.python.org/3.10/reference/compound_stmts.html#async-with)
    statement:
...
:   A Semaphore object. Not thread-safe.
    ...
    The preferred way to use a Semaphore is an [`async with`](https://docs.python.org/3.10/reference/compound_stmts.html#async-with)
    statement:
...
[`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement (`with await lock`, `with (yield from
