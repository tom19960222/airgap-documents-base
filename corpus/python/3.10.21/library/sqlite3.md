...
source_url: https://docs.python.org/3.10/library/sqlite3.html
fetched_at: 2026-09-17T15:13:51+00:00
---
# `sqlite3` — DB-API 2.0 interface for SQLite databases

**Source code:** [Lib/sqlite3/](https://github.com/python/cpython/tree/3.10/Lib/sqlite3/)
...
compliant with the DB-API 2.0 specification described by [**PEP 249**](https://www.python.org/dev/peps/pep-0249), and
...
>
> [**PEP 249**](https://www.python.org/dev/peps/pep-0249) - Database API Specification 2.0
...
Always use placeholders instead of [string formatting](https://docs.python.org/3.10/tutorial/inputoutput.html#tut-formatting)
...
:   Open a connection to an SQLite database.
    ...
    Parameters
    :   - **database** ([path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object)) – The path to the database file to be opened.
        ...
        - **detect_types** ([*int*](functions.md#int "int")) – Control whether and how data types not
          ...
          even when the *detect_types* parameter is set; [`str`](stdtypes.md#str "str") will be
          returned instead.
          By default (`0`), type detection is disabled.
        - **isolation_level** (*str | None*) – The [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") of the connection,
          ...
          See [Transaction control](sqlite3.md#sqlite3-controlling-transactions) for more.
    ...
    Changed in version 3.7: *database* can now also be a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object), not only a string.
...
:   Integer constant required by the DB-API, stating the level of thread safety
    the `sqlite3` module supports. Currently hard-coded to `1`, meaning
    *“Threads may share the module, but not connections.”* However, this may not
    ...
    Note that the [SQLITE_THREADSAFE levels](https://sqlite.org/compile.html#threadsafe) do not match the DB-API 2.0
    `threadsafety` levels.
...
:   Each open SQLite database is represented by a `Connection` object,
    ...
    :   Create and return a [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") object.
        ...
        supplied, this must be a callable returning an instance of [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor")
        or its subclasses.
    ...
    :   Create or remove a user-defined SQL function.
        ...
        :   - **name** ([*str*](stdtypes.md#str "str")) – The name of the SQL function.
            ...
            - **func** ([callback](https://docs.python.org/3.10/glossary.html#term-callback) | None) – A callable that is called when the SQL function is invoked.
    ...
    :   Create or remove a user-defined SQL aggregate function.
        ...
        :   - **name** ([*str*](stdtypes.md#str "str")) – The name of the SQL aggregate function.
            - **n_arg** ([*int*](functions.md#int "int")) – The number of arguments the SQL aggregate function can accept.
              If `-1`, it may take any number of arguments.
            - **aggregate_class** ([class](https://docs.python.org/3.10/glossary.html#term-class) | None) –
    ...
    :   Register callable *authorizer_callback* to be invoked for each attempt to
        ...
        one of [`SQLITE_OK`](sqlite3.md#sqlite3.SQLITE_OK "sqlite3.SQLITE_OK"), [`SQLITE_DENY`](sqlite3.md#sqlite3.SQLITE_DENY "sqlite3.SQLITE_DENY"), or [`SQLITE_IGNORE`](sqlite3.md#sqlite3.SQLITE_IGNORE "sqlite3.SQLITE_IGNORE")
    ...
    :   Register callable *progress_handler* to be invoked for every *n*
        ...
        currently executing query and cause it to raise an [`OperationalError`](sqlite3.md#sqlite3.OperationalError "sqlite3.OperationalError")
        exception.
    ...
    :   Enable the SQLite engine to load SQLite extensions from shared libraries
        ...
        > you must pass the [`--enable-loadable-sqlite-extensions`](https://docs.python.org/3.10/using/configure.html#cmdoption-enable-loadable-sqlite-extensions) option
        > to **configure**.
    ...
    `iterdump()`
    :   Return an [iterator](https://docs.python.org/3.10/glossary.html#term-iterator) to dump the database as SQL source code.
    ...
    :   Create a backup of an SQLite database.
        ...
        :   - **target** ([*Connection*](sqlite3.md#sqlite3.Connection "sqlite3.Connection")) – The database connection to save the backup to.
            - **pages** ([*int*](functions.md#int "int")) – The number of pages to copy at a time.
              ...
              Defaults to `-1`.
            - **progress** ([callback](https://docs.python.org/3.10/glossary.html#term-callback) | None) – If set to a callable, it is invoked with three integer arguments for
    ...
    `isolation_level`
    :   This attribute controls the [transaction handling](sqlite3.md#sqlite3-controlling-transactions) performed by `sqlite3`.
        ...
        implicit [transaction management](sqlite3.md#sqlite3-controlling-transactions) is performed.
    ...
    `text_factory`
    :   A callable that accepts a [`bytes`](stdtypes.md#bytes "bytes") parameter and returns a text
...
>
> Cursor objects are [iterators](https://docs.python.org/3.10/glossary.html#term-iterator),
...
:   A [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") instance has the following attributes and methods.
    ...
    :   Execute SQL a single SQL statement,
        ...
        :   - **sql** ([*str*](stdtypes.md#str "str")) – A single SQL statement.
            - **parameters** ([`dict`](stdtypes.md#dict "dict") | [sequence](https://docs.python.org/3.10/glossary.html#term-sequence)) – Python values to bind to placeholders in *sql*.
        ...
        Raises
        :   [**Warning**](sqlite3.md#sqlite3.Warning "sqlite3.Warning") – If *sql* contains more than one SQL statement.

        If [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") is not `None`,
    ...
    :   For every item in *parameters*,
        ...
        :   - **sql** ([*str*](stdtypes.md#str "str")) – A single SQL DML statement.
            - **parameters** ([iterable](https://docs.python.org/3.10/glossary.html#term-iterable)) – An iterable of parameters to bind with
              the placeholders in *sql*.
              See [How to use placeholders to bind values in SQL queries](sqlite3.md#sqlite3-placeholders).

        Raises
        :   - [**ProgrammingError**](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") – If *sql* is not a DML statment.
            - [**Warning**](sqlite3.md#sqlite3.Warning "sqlite3.Warning") – If *sql* contains more than one SQL statement.
    ...
    :   Control how a row fetched from this `Cursor` is represented.
        ...
        or a [callable](https://docs.python.org/3.10/glossary.html#term-callable) that accepts two arguments,
...
:   A `Row` instance serves as a highly optimized
    ...
    and [mapping](https://docs.python.org/3.10/glossary.html#term-mapping) access by column name and index.
...
:   The PrepareProtocol type’s single purpose is to act as a [**PEP 246**](https://www.python.org/dev/peps/pep-0246) style
...
The exception hierarchy is defined by the DB-API 2.0 ([**PEP 249**](https://www.python.org/dev/peps/pep-0249)).

`exception sqlite3.Warning`
:   This exception is raised by `sqlite3` if an SQL query is not a
    [`string`](stdtypes.md#str "str"), or if multiple statements are passed to
    [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") or [`executemany()`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany").
    `Warning` is a subclass of [`Exception`](exceptions.md#Exception "Exception").

`exception sqlite3.Error`
:   The base class of the other exceptions in this module.
    Use this to catch all errors with one single [`except`](https://docs.python.org/3.10/reference/compound_stmts.html#except) statement.
...
:   Exception raised for `sqlite3` API programming errors,
    for example trying to operate on a closed [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection"),
    or trying to execute non-DML statements with [`executemany()`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany").
...
[`datetime.date`](datetime.md#datetime.date "datetime.date") and under the name “timestamp” for
[`datetime.datetime`](datetime.md#datetime.datetime "datetime.datetime").
...
[sequence](https://docs.python.org/3.10/glossary.html#term-sequence) whose length must match the number of placeholders,
...
> **Note:**
>
> [**PEP 249**](https://www.python.org/dev/peps/pep-0249) numeric placeholders are *not* supported.
...
the context manager.
If the body of the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement finishes without exceptions,
...
The following row factory returns a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple):
