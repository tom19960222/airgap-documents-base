...
source_url: https://docs.python.org/3.10/library/audit_events.html
fetched_at: 2026-09-17T15:14:50+00:00
---
# Audit events table

This table contains all events raised by [`sys.audit()`](sys.md#sys.audit "sys.audit") or
[`PySys_Audit()`](https://docs.python.org/3.10/c-api/sys.html#c.PySys_Audit "PySys_Audit") calls throughout the CPython runtime and the
standard library. These calls were added in 3.8.0 or later (see [**PEP 578**](https://www.python.org/dev/peps/pep-0578)).

See [`sys.addaudithook()`](sys.md#sys.addaudithook "sys.addaudithook") and [`PySys_AddAuditHook()`](https://docs.python.org/3.10/c-api/sys.html#c.PySys_AddAuditHook "PySys_AddAuditHook") for
...
| cpython.PyInterpreterState_Clear |  | [[1]](https://docs.python.org/3.10/c-api/init.html#c.PyInterpreterState_Clear) |
| cpython.PyInterpreterState_New |  | [[1]](https://docs.python.org/3.10/c-api/init.html#c.PyInterpreterState_New) |
| cpython._PySys_ClearAuditHooks |  | [[1]](https://docs.python.org/3.10/c-api/init.html#c.Py_FinalizeEx) |
| cpython.run_command | `command` | [[1]](https://docs.python.org/3.10/using/cmdline.html#cmdoption-c) |
| cpython.run_file | `filename` | [[1]](https://docs.python.org/3.10/using/cmdline.html#audit_event_cpython_run_file_0) |
| cpython.run_interactivehook | `hook` | [[1]](sys.md#sys.__interactivehook__) |
| cpython.run_module | `module-name` | [[1]](https://docs.python.org/3.10/using/cmdline.html#cmdoption-m) |
| cpython.run_startup | `filename` | [[1]](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONSTARTUP) |
| cpython.run_stdin |  | [[1]](asyncio.md#audit_event_cpython_run_stdin_0)[[2]](https://docs.python.org/3.10/using/cmdline.html#audit_event_cpython_run_stdin_1)[[3]](https://docs.python.org/3.10/using/cmdline.html#audit_event_cpython_run_stdin_2) |
...
| ctypes.seh_exception | `code` | [[1]](ctypes.md#foreign-functions) |
| ctypes.set_errno | `errno` | [[1]](ctypes.md#ctypes.set_errno) |
| ctypes.set_last_error | `error` | [[1]](ctypes.md#ctypes.set_last_error) |
| ctypes.string_at | `address`, `size` | [[1]](ctypes.md#ctypes.string_at) |
| ctypes.wstring_at | `address`, `size` | [[1]](ctypes.md#ctypes.wstring_at) |
...
| import | `module`, `filename`, `sys.path`, `sys.meta_path`, `sys.path_hooks` | [[1]](https://docs.python.org/3.10/reference/simple_stmts.html#import) |
...
| object.__delattr__ | `obj`, `name` | [[1]](https://docs.python.org/3.10/reference/datamodel.html#object.__delattr__) |
| object.__getattr__ | `obj`, `name` | [[1]](https://docs.python.org/3.10/reference/datamodel.html#object.__getattribute__) |
| object.__setattr__ | `obj`, `name`, `value` | [[1]](https://docs.python.org/3.10/reference/datamodel.html#object.__setattr__) |
| open | `file`, `mode`, `flags` | [[1]](functions.md#open)[[2]](io.md#io.open)[[3]](os.md#os.open) |
...
| setopencodehook |  | [[1]](https://docs.python.org/3.10/c-api/file.html#c.PyFile_SetOpenCodeHook) |
...
| shutil.rmtree | `path` | [[1]](shutil.md#shutil.rmtree) |
...
| sys._getframe |  | [[1]](sys.md#sys._getframe) |
| sys.addaudithook |  | [[1]](https://docs.python.org/3.10/c-api/sys.html#c.PySys_AddAuditHook)[[2]](sys.md#sys.addaudithook) |
