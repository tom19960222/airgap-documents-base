...
source_url: https://docs.python.org/3.10/library/pprint.html
fetched_at: 2026-09-17T15:13:37+00:00
---
# `pprint` — Data pretty printer

**Source code:** [Lib/pprint.py](https://github.com/python/cpython/tree/3.10/Lib/pprint.py)
...
Construct [`PrettyPrinter`](pprint.md#pprint.PrettyPrinter "pprint.PrettyPrinter") objects explicitly if you need to adjust the
width constraint.
...
The [`pprint`](pprint.md#module-pprint "pprint: Data pretty printer.") module defines one class:

`class pprint.PrettyPrinter(indent=1, width=80, depth=None, stream=None, *, compact=False, sort_dicts=True, underscore_numbers=False)`
:   Construct a [`PrettyPrinter`](pprint.md#pprint.PrettyPrinter "pprint.PrettyPrinter") instance. This constructor understands
    several keyword parameters.

    *stream* (default `sys.stdout`) is a [file-like object](https://docs.python.org/3.10/glossary.html#term-file-like-object) to
    which the output will be written by calling its `write()` method.
...
The [`pprint`](pprint.md#module-pprint "pprint: Data pretty printer.") module also provides several shortcut functions:

`pprint.pformat(object, indent=1, width=80, depth=None, *, compact=False, sort_dicts=True, underscore_numbers=False)`
:   Return the formatted representation of *object* as a string. *indent*,
    *width*, *depth*, *compact*, *sort_dicts* and *underscore_numbers* will be passed to the
    [`PrettyPrinter`](pprint.md#pprint.PrettyPrinter "pprint.PrettyPrinter") constructor as formatting parameters.
...
:   Prints the formatted representation of *object* followed by a newline.
    ...
    *args* and *kwargs* will be passed to [`pprint()`](pprint.md#module-pprint "pprint: Data pretty printer.") as formatting
    parameters.
...
:   Prints the formatted representation of *object* on *stream*, followed by a
    ...
    in the interactive interpreter instead of the [`print()`](functions.md#print "print") function for
    inspecting values (you can even reassign `print = pprint.pprint` for use
    within a scope). *indent*, *width*, *depth*, *compact*, *sort_dicts* and *underscore_numbers* will
    be passed to the [`PrettyPrinter`](pprint.md#pprint.PrettyPrinter "pprint.PrettyPrinter") constructor as formatting parameters.
...
To demonstrate several uses of the [`pprint()`](pprint.md#module-pprint "pprint: Data pretty printer.") function and its parameters,
...
In its basic form, [`pprint()`](pprint.md#module-pprint "pprint: Data pretty printer.") shows the whole object:
