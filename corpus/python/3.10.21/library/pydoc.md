...
source_url: https://docs.python.org/3.10/library/pydoc.html
fetched_at: 2026-09-17T15:14:45+00:00
---
# `pydoc` — Documentation generator and online help system

**Source code:** [Lib/pydoc.py](https://github.com/python/cpython/tree/3.10/Lib/pydoc.py)

---

The [`pydoc`](pydoc.md#module-pydoc "pydoc: Documentation generator and online help system.") module automatically generates documentation from Python
...
[`pydoc`](pydoc.md#module-pydoc "pydoc: Documentation generator and online help system.") tries to obtain a description from the block of comment lines just
above the definition of the class, function or method in the source file, or at
the top of the module (see [`inspect.getcomments()`](inspect.md#inspect.getcomments "inspect.getcomments")).

The built-in function [`help()`](functions.md#help "help") invokes the online help system in the
interactive interpreter, which uses [`pydoc`](pydoc.md#module-pydoc "pydoc: Documentation generator and online help system.") to generate its documentation
...
at a shell prompt will display documentation on the [`sys`](sys.md#module-sys "sys: Access system-specific parameters and functions.") module, in a
...
> **Note:**
>
> In order to find objects and their documentation, [`pydoc`](pydoc.md#module-pydoc "pydoc: Documentation generator and online help system.") imports the
...
Changed in version 3.4: [`pydoc`](pydoc.md#module-pydoc "pydoc: Documentation generator and online help system.") now uses [`inspect.signature()`](inspect.md#inspect.signature "inspect.signature") rather than
[`inspect.getfullargspec()`](inspect.md#inspect.getfullargspec "inspect.getfullargspec") to extract signature information from
callables.
