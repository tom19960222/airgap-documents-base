...
source_url: https://docs.python.org/3.10/library/difflib.html
fetched_at: 2026-09-17T15:13:27+00:00
---
# `difflib` — Helpers for computing deltas

**Source code:** [Lib/difflib.py](https://github.com/python/cpython/tree/3.10/Lib/difflib.py)
...
:   This is a flexible class for comparing pairs of sequences of any type, so long
    as the sequence elements are [hashable](https://docs.python.org/3.10/glossary.html#term-hashable). The basic algorithm predates, and is a
...
:   Compare *a* and *b* (lists of strings); return a delta (a [generator](https://docs.python.org/3.10/glossary.html#term-generator)
...
:   Compare *a* and *b* (lists of strings); return a [`Differ`](difflib.md#difflib.Differ "difflib.Differ")-style
    delta (a [generator](https://docs.python.org/3.10/glossary.html#term-generator) generating the delta lines).
...
:   Optional argument *isjunk* must be `None` (the default) or a one-argument
    ...
    empty strings. The elements of both sequences must be [hashable](https://docs.python.org/3.10/glossary.html#term-hashable).
    ...
    :   Find longest matching block in `a[alo:ahi]` and `b[blo:bhi]`.
        ...
        This method returns a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) `Match(a, b, size)`.
    ...
    :   Return a [generator](https://docs.python.org/3.10/glossary.html#term-generator) of groups with up to *n* lines of context.
...
>   work.
> - [Simple version control recipe](https://code.activestate.com/recipes/576729/) for a small application
