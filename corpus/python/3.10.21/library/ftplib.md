...
source_url: https://docs.python.org/3.10/library/ftplib.html
fetched_at: 2026-09-17T15:14:30+00:00
---
# `ftplib` — FTP protocol client

**Source code:** [Lib/ftplib.py](https://github.com/python/cpython/tree/3.10/Lib/ftplib.py)
...
:   Return a new instance of the [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") class. When *host* is given, the
    ...
    *acct* default to the empty string when not given). The optional *timeout*
    ...
    The [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") class supports the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, e.g.:
    ...
    Changed in version 3.2: Support for the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement was added.
...
:   A [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") subclass which adds TLS support to FTP as described in
    [**RFC 4217**](https://datatracker.ietf.org/doc/html/rfc4217.html).
    Connect as usual to port 21 implicitly securing the FTP control connection
    before authenticating. Securing the data connection requires the user to
    explicitly ask for it by calling the [`prot_p()`](ftplib.md#ftplib.FTP_TLS.prot_p "ftplib.FTP_TLS.prot_p") method. *context*
    is a [`ssl.SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") object which allows bundling SSL configuration
    options, certificates and private keys into a single (potentially
    long-lived) structure. Please read [Security considerations](ssl.md#ssl-security) for best practices.
...
:   Send a simple command string to the server and handle the response. Return
    ...
    200–299) is received. Raise [`error_reply`](ftplib.md#ftplib.error_reply "ftplib.error_reply") otherwise.
...
:   Retrieve a file in binary transfer mode. *cmd* should be an appropriate
    ...
    [`transfercmd()`](ftplib.md#ftplib.FTP.transfercmd "ftplib.FTP.transfercmd") method.
...
:   Store a file in binary transfer mode. *cmd* should be an appropriate
    `STOR` command: `"STOR filename"`. *fp* is a [file object](https://docs.python.org/3.10/glossary.html#term-file-object)
    ...
    *rest* means the same thing as in the [`transfercmd()`](ftplib.md#ftplib.FTP.transfercmd "ftplib.FTP.transfercmd") method.
...
:   Store a file in line mode. *cmd* should be an appropriate
    ...
    [file object](https://docs.python.org/3.10/glossary.html#term-file-object) *fp* (opened in binary mode) using its [`readline()`](io.md#io.IOBase.readline "io.IOBase.readline")
...
[`FTP_TLS`](ftplib.md#ftplib.FTP_TLS "ftplib.FTP_TLS") class inherits from [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP"), defining these additional objects:
