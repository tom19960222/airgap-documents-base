...
source_url: https://docs.python.org/3.10/library/ossaudiodev.html
fetched_at: 2026-09-17T15:15:24+00:00
---
# `ossaudiodev` — Access to OSS-compatible audio devices

Deprecated since version 3.11: The [`ossaudiodev`](ossaudiodev.md#module-ossaudiodev "ossaudiodev: Access to OSS-compatible audio devices. (deprecated) (Linux, FreeBSD)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#ossaudiodev) for details).
...
Changed in version 3.3: Operations in this module now raise [`OSError`](exceptions.md#OSError "OSError") where [`IOError`](exceptions.md#IOError "IOError")
was raised.
...
:   This exception is raised on certain errors. The argument is a string describing
    ...
    (If [`ossaudiodev`](ossaudiodev.md#module-ossaudiodev "ossaudiodev: Access to OSS-compatible audio devices. (deprecated) (Linux, FreeBSD)") receives an error from a system call such as
    `open()`, `write()`, or `ioctl()`, it raises [`OSError`](exceptions.md#OSError "OSError").
    Errors detected directly by [`ossaudiodev`](ossaudiodev.md#module-ossaudiodev "ossaudiodev: Access to OSS-compatible audio devices. (deprecated) (Linux, FreeBSD)") result in [`OSSAudioError`](ossaudiodev.md#ossaudiodev.OSSAudioError "ossaudiodev.OSSAudioError").)
...
:   Write a [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) *data* to the audio device and return the
    ...
    data may not be written—see [`writeall()`](ossaudiodev.md#ossaudiodev.oss_audio_device.writeall "ossaudiodev.oss_audio_device.writeall").
...
:   Write a [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) *data* to the audio device: waits until
    ...
    [`write()`](ossaudiodev.md#ossaudiodev.oss_audio_device.write "ossaudiodev.oss_audio_device.write"); [`writeall()`](ossaudiodev.md#ossaudiodev.oss_audio_device.writeall "ossaudiodev.oss_audio_device.writeall") is only useful in non-blocking mode. Has
...
be used in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement.
...
:   Set the key audio sampling parameters—sample format, number of channels, and
    ...
    [`speed()`](ossaudiodev.md#ossaudiodev.oss_audio_device.speed "ossaudiodev.oss_audio_device.speed") methods. If *strict* is true, [`setparameters()`](ossaudiodev.md#ossaudiodev.oss_audio_device.setparameters "ossaudiodev.oss_audio_device.setparameters") checks to
    see if each parameter was actually set to the requested value, and raises
    [`OSSAudioError`](ossaudiodev.md#ossaudiodev.OSSAudioError "ossaudiodev.OSSAudioError") if not. Returns a tuple (*format*, *nchannels*,
    *samplerate*) indicating the parameter values that were actually set by the
    device driver (i.e., the same as the return values of [`setfmt()`](ossaudiodev.md#ossaudiodev.oss_audio_device.setfmt "ossaudiodev.oss_audio_device.setfmt"),
    [`channels()`](ossaudiodev.md#ossaudiodev.oss_audio_device.channels "ossaudiodev.oss_audio_device.channels"), and [`speed()`](ossaudiodev.md#ossaudiodev.oss_audio_device.speed "ossaudiodev.oss_audio_device.speed")).
...
:   Returns a bitmask indicating stereo mixer controls. If a bit is set, the
    ...
    [`controls()`](ossaudiodev.md#ossaudiodev.oss_mixer_device.controls "ossaudiodev.oss_mixer_device.controls") to determine which).
