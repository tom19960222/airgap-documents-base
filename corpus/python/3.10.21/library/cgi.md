...
source_url: https://docs.python.org/3.10/library/cgi.html
fetched_at: 2026-09-17T15:15:19+00:00
---
# `cgi` — Common Gateway Interface support

**Source code:** [Lib/cgi.py](https://github.com/python/cpython/tree/3.10/Lib/cgi.py)

Deprecated since version 3.11: The [`cgi`](cgi.md#module-cgi "cgi: Helpers for running Python scripts via the Common Gateway Interface. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#cgi) for details and alternatives).
...
It allows membership testing with the [`in`](https://docs.python.org/3.10/reference/expressions.html#in) operator, and also supports
...
`FieldStorage` objects also support being used in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
...
search path ([`PYTHONPATH`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONPATH)) to be set to anything interesting.
