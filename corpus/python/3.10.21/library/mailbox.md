...
source_url: https://docs.python.org/3.10/library/mailbox.html
fetched_at: 2026-09-17T15:14:17+00:00
---
# `mailbox` — Manipulate mailboxes in various formats

**Source code:** [Lib/mailbox.py](https://github.com/python/cpython/tree/3.10/Lib/mailbox.py)

---

This module defines two classes, [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") and [`Message`](mailbox.md#mailbox.Message "mailbox.Message"), for
accessing and manipulating on-disk mailboxes and the messages they contain.
[`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") offers a dictionary-like mapping from keys to messages.
[`Message`](mailbox.md#mailbox.Message "mailbox.Message") extends the [`email.message`](email.message.md#module-email.message "email.message: The base class representing email messages.") module’s
[`Message`](email.compat32-message.md#email.message.Message "email.message.Message") class with format-specific state and behavior.
Supported mailbox formats are Maildir, mbox, MH, Babyl, and MMDF.

> **See also:**
>
> Module [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.")
...
:   A mailbox, which may be inspected and modified.
    ...
    The [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") class defines an interface and is not intended to be
    instantiated. Instead, format-specific subclasses should inherit from
    [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") and your code should instantiate a particular subclass.

    The [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") interface is dictionary-like, with small keys
    corresponding to messages. Keys are issued by the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance
    with which they will be used and are only meaningful to that [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox")
    instance. A key continues to identify a message even if the corresponding
    message is modified, such as by replacing it with another message.

    Messages may be added to a [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance using the set-like
    method [`add()`](mailbox.md#mailbox.Mailbox.add "mailbox.Mailbox.add") and removed using a `del` statement or the set-like
    methods [`remove()`](mailbox.md#mailbox.Mailbox.remove "mailbox.Mailbox.remove") and [`discard()`](mailbox.md#mailbox.Mailbox.discard "mailbox.Mailbox.discard").

    [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") interface semantics differ from dictionary semantics in some
    noteworthy ways. Each time a message is requested, a new representation
    (typically a [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instance) is generated based upon the current
    state of the mailbox. Similarly, when a message is added to a
    [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance, the provided message representation’s contents are
    copied. In neither case is a reference to the message representation kept by
    the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance.

    The default [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") iterator iterates over message representations,
    ...
    [`KeyError`](exceptions.md#KeyError "KeyError") exception if the corresponding message is subsequently
    removed.
    ...
    > calling the [`lock()`](mailbox.md#mailbox.Mailbox.lock "mailbox.Mailbox.lock") and [`unlock()`](mailbox.md#mailbox.Mailbox.unlock "mailbox.Mailbox.unlock") methods *before* reading any
    > messages in the file or making any changes by adding or deleting a
    > message. Failing to lock the mailbox runs the risk of losing messages or
    > corrupting the entire mailbox.

    [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instances have the following methods:

    `add(message)`
    :   Add *message* to the mailbox and return the key that has been assigned to
        it.

        Parameter *message* may be a [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instance, an
        [`email.message.Message`](email.compat32-message.md#email.message.Message "email.message.Message") instance, a string, a byte string, or a
        file-like object (which should be open in binary mode). If *message* is
        an instance of the
        appropriate format-specific [`Message`](mailbox.md#mailbox.Message "mailbox.Message") subclass (e.g., if it’s an
        [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instance and this is an [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") instance), its
    ...
    :   Delete the message corresponding to *key* from the mailbox.
        ...
        method was called as [`remove()`](mailbox.md#mailbox.Mailbox.remove "mailbox.Mailbox.remove") or [`__delitem__()`](mailbox.md#mailbox.Mailbox.__delitem__ "mailbox.Mailbox.__delitem__") but no
        exception is raised if the method was called as [`discard()`](mailbox.md#mailbox.Mailbox.discard "mailbox.Mailbox.discard"). The
    ...
    :   Replace the message corresponding to *key* with *message*. Raise a
        ...
        As with [`add()`](mailbox.md#mailbox.Mailbox.add "mailbox.Mailbox.add"), parameter *message* may be a [`Message`](mailbox.md#mailbox.Message "mailbox.Message")
        instance, an [`email.message.Message`](email.compat32-message.md#email.message.Message "email.message.Message") instance, a string, a byte
        string, or a file-like object (which should be open in binary mode). If
        *message* is an
        instance of the appropriate format-specific [`Message`](mailbox.md#mailbox.Message "mailbox.Message") subclass
        (e.g., if it’s an [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instance and this is an
        [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") instance), its format-specific information is
    ...
    `keys()`
    :   Return an iterator over all keys if called as [`iterkeys()`](mailbox.md#mailbox.Mailbox.iterkeys "mailbox.Mailbox.iterkeys") or return a
        list of keys if called as [`keys()`](mailbox.md#mailbox.Mailbox.keys "mailbox.Mailbox.keys").
    ...
    :   Return an iterator over representations of all messages if called as
        [`itervalues()`](mailbox.md#mailbox.Mailbox.itervalues "mailbox.Mailbox.itervalues") or [`__iter__()`](mailbox.md#mailbox.Mailbox.__iter__ "mailbox.Mailbox.__iter__") or return a list of such
        representations if called as [`values()`](mailbox.md#mailbox.Mailbox.values "mailbox.Mailbox.values"). The messages are represented
        as instances of the appropriate format-specific [`Message`](mailbox.md#mailbox.Message "mailbox.Message") subclass
        unless a custom message factory was specified when the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox")
    ...
    :   Return an iterator over (*key*, *message*) pairs, where *key* is a key and
        *message* is a message representation, if called as [`iteritems()`](mailbox.md#mailbox.Mailbox.iteritems "mailbox.Mailbox.iteritems") or
        return a list of such pairs if called as [`items()`](mailbox.md#mailbox.Mailbox.items "mailbox.Mailbox.items"). The messages are
        ...
        when the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance was initialized.
    ...
    :   Return a representation of the message corresponding to *key*. If no such
        ...
        called as [`__getitem__()`](mailbox.md#mailbox.Mailbox.__getitem__ "mailbox.Mailbox.__getitem__"). The message is represented as an instance
        of the appropriate format-specific [`Message`](mailbox.md#mailbox.Message "mailbox.Message") subclass unless a
        custom message factory was specified when the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance
        was initialized.
    ...
    :   Return a file-like representation of the message corresponding to *key*,
        ...
        context management protocol: you can use a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement to
        automatically close it.

        > **Note:**
        >
        > Unlike other representations of messages, file-like representations are
        > not necessarily independent of the [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance that
    ...
    :   Parameter *arg* should be a *key*-to-*message* mapping or an iterable of
        ...
        *message* as if by using [`__setitem__()`](mailbox.md#mailbox.Mailbox.__setitem__ "mailbox.Mailbox.__setitem__"). As with [`__setitem__()`](mailbox.md#mailbox.Mailbox.__setitem__ "mailbox.Mailbox.__setitem__"),
        each *key* must already correspond to a message in the mailbox or else a
        [`KeyError`](exceptions.md#KeyError "KeyError") exception will be raised, so in general it is incorrect
        for *arg* to be a [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance.
    ...
    :   Write any pending changes to the filesystem. For some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox")
        subclasses, changes are always written immediately and [`flush()`](mailbox.md#mailbox.Mailbox.flush "mailbox.Mailbox.flush") does
    ...
    :   Flush the mailbox, unlock it if necessary, and close any open files. For
        some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") subclasses, this method does nothing.
...
:   A subclass of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") for mailboxes in Maildir format. Parameter
    *factory* is a callable object that accepts a file-like message representation
    ...
    If *factory* is `None`, [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") is used as the default message
    ...
    [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir") without the leading `'.'`. Each folder is itself a Maildir
    ...
    [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir") instances have all of the methods of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") in
    ...
    `get_folder(folder)`
    :   Return a [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir") instance representing the folder whose name is
    ...
    `add_folder(folder)`
    :   Create a folder whose name is *folder* and return a [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir")
    ...
    Some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") methods implemented by [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir") deserve special
    remarks:
    ...
    `close()`
    :   [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir") instances do not keep any open files and the underlying
...
:   A subclass of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") for mailboxes in mbox format. Parameter *factory*
    ...
    *factory* is `None`, [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") is used as the default message
    representation. If *create* is `True`, the mailbox is created if it does not
    exist.
    ...
    the original. In the interest of compatibility, [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") implements the
    ...
    Some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") methods implemented by [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") deserve special
    remarks:

    `get_file(key)`
    :   Using the file after calling `flush()` or `close()` on the
        [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") instance may yield unpredictable results or raise an
        exception.
...
:   A subclass of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") for mailboxes in MH format. Parameter *factory*
    is a callable object that accepts a file-like message representation (which
    behaves as if opened in binary mode) and returns a custom representation. If
    *factory* is `None`, [`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") is used as the default message
    representation. If *create* is `True`, the mailbox is created if it does not
    exist.
    ...
    The [`MH`](mailbox.md#mailbox.MH "mailbox.MH") class manipulates MH mailboxes, but it does not attempt to
    ...
    [`MH`](mailbox.md#mailbox.MH "mailbox.MH") instances have all of the methods of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") in addition
    to the following:
    ...
    `get_folder(folder)`
    :   Return an [`MH`](mailbox.md#mailbox.MH "mailbox.MH") instance representing the folder whose name is
        *folder*. A [`NoSuchMailboxError`](mailbox.md#mailbox.NoSuchMailboxError "mailbox.NoSuchMailboxError") exception is raised if the folder
        does not exist.

    `add_folder(folder)`
    :   Create a folder whose name is *folder* and return an [`MH`](mailbox.md#mailbox.MH "mailbox.MH") instance
        representing it.
    ...
    Some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") methods implemented by [`MH`](mailbox.md#mailbox.MH "mailbox.MH") deserve special
    remarks:
    ...
    `close()`
    :   [`MH`](mailbox.md#mailbox.MH "mailbox.MH") instances do not keep any open files, so this method is
...
:   A subclass of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") for mailboxes in Babyl format. Parameter
    *factory* is a callable object that accepts a file-like message representation
    (which behaves as if opened in binary mode) and returns a custom representation.
    If *factory* is `None`, [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") is used as the default message
    representation. If *create* is `True`, the mailbox is created if it does not
    exist.
    ...
    *labels*, or short strings that record extra information about the
    ...
    [`Babyl`](mailbox.md#mailbox.Babyl "mailbox.Babyl") instances have all of the methods of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") in
    addition to the following:
    ...
    Some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") methods implemented by [`Babyl`](mailbox.md#mailbox.Babyl "mailbox.Babyl") deserve special
    remarks:
...
:   A subclass of [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") for mailboxes in MMDF format. Parameter *factory*
    is a callable object that accepts a file-like message representation (which
    behaves as if opened in binary mode) and returns a custom representation. If
    *factory* is `None`, [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") is used as the default message
    representation. If *create* is `True`, the mailbox is created if it does not
    exist.
    ...
    Some [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") methods implemented by [`MMDF`](mailbox.md#mailbox.MMDF "mailbox.MMDF") deserve special
    remarks:

    `get_file(key)`
    :   Using the file after calling `flush()` or `close()` on the
        [`MMDF`](mailbox.md#mailbox.MMDF "mailbox.MMDF") instance may yield unpredictable results or raise an
        exception.
...
:   A subclass of the [`email.message`](email.message.md#module-email.message "email.message: The base class representing email messages.") module’s
    [`Message`](email.compat32-message.md#email.message.Message "email.message.Message"). Subclasses of [`mailbox.Message`](mailbox.md#mailbox.Message "mailbox.Message") add
    mailbox-format-specific state and behavior.

    If *message* is omitted, the new instance is created in a default, empty state.
    If *message* is an [`email.message.Message`](email.compat32-message.md#email.message.Message "email.message.Message") instance, its contents are
    copied; furthermore, any format-specific information is converted insofar as
    possible if *message* is a [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instance. If *message* is a string,
    a byte string,
    or a file, it should contain an [**RFC 2822**](https://datatracker.ietf.org/doc/html/rfc2822.html)-compliant message, which is read
    ...
    There is no requirement that [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instances be used to represent
    messages retrieved using [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instances. In some situations, the
    time and memory required to generate [`Message`](mailbox.md#mailbox.Message "mailbox.Message") representations might
    not be acceptable. For such situations, [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instances also
    offer string and file-like representations, and a custom message factory may
    be specified when a [`Mailbox`](mailbox.md#mailbox.Mailbox "mailbox.Mailbox") instance is initialized.
...
:   A message with Maildir-specific behaviors. Parameter *message* has the same
    ...
    [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instances offer the following methods:
...
When a [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance is created based upon an
[`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") or [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance, the *Status*
and *X-Status* headers are omitted and the following conversions
take place:

| Resulting state | [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") or [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") state |
| --- | --- |
...
When a [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance is created based upon an
[`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instance, the following conversions take place:

| Resulting state | [`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") state |
| --- | --- |
...
When a [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance is created based upon a
[`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") instance, the following conversions take place:

| Resulting state | [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") state |
| --- | --- |
...
:   A message with mbox-specific behaviors. Parameter *message* has the same meaning
    ...
    *Status* and *X-Status* headers.
    ...
    [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instances offer the following methods:
    ...
    :   Set the “From ” line to *from_*, which should be specified without a
        ...
        *time_* is specified, it should be a [`time.struct_time`](time.md#time.struct_time "time.struct_time") instance, a
...
When an [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instance is created based upon a
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance, a “From ” line is generated based upon the
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance’s delivery date, and the following conversions
take place:

| Resulting state | [`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") state |
| --- | --- |
| R flag | S flag |
...
When an [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instance is created based upon an
[`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instance, the following conversions take place:
...
When a [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instance is created based upon an [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage")
instance, the “From ” line is copied and all flags directly correspond:

| Resulting state | [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") state |
| --- | --- |
| R flag | R flag |
| O flag | O flag |
| D flag | D flag |
...
:   A message with MH-specific behaviors. Parameter *message* has the same meaning
    ...
    **nmh**) use sequences in much the same way flags are used with other
    ...
    [`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instances offer the following methods:
...
When an [`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instance is created based upon a
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance, the following conversions take place:
...
When an [`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instance is created based upon an
[`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") or [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance, the *Status*
and *X-Status* headers are omitted and the following conversions
take place:
...
:   A message with Babyl-specific behaviors. Parameter *message* has the same
    ...
    By default, Rmail displays only visible headers. The [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage")
    class, though, uses the original headers because they are more
    complete. Visible headers may be accessed explicitly if desired.

    [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") instances offer the following methods:
    ...
    `get_visible()`
    :   Return an [`Message`](mailbox.md#mailbox.Message "mailbox.Message") instance whose headers are the message’s
    ...
    `update_visible()`
    :   When a [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") instance’s original headers are modified, the
...
When a [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") instance is created based upon a
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance, the following conversions take place:
...
When a [`BabylMessage`](mailbox.md#mailbox.BabylMessage "mailbox.BabylMessage") instance is created based upon an
[`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") or [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance, the *Status*
and *X-Status* headers are omitted and the following conversions
take place:
...
:   A message with MMDF-specific behaviors. Parameter *message* has the same meaning
    ...
    [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instances offer the following methods, which are
...
When an [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance is created based upon a
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance, a “From ” line is generated based upon the
[`MaildirMessage`](mailbox.md#mailbox.MaildirMessage "mailbox.MaildirMessage") instance’s delivery date, and the following conversions
take place:
...
When an [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance is created based upon an
[`MHMessage`](mailbox.md#mailbox.MHMessage "mailbox.MHMessage") instance, the following conversions take place:
...
When an [`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage") instance is created based upon an
[`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") instance, the “From ” line is copied and all flags directly
correspond:

| Resulting state | [`mboxMessage`](mailbox.md#mailbox.mboxMessage "mailbox.mboxMessage") state |
| --- | --- |
| R flag | R flag |
| O flag | O flag |
| D flag | D flag |
...
The following exception classes are defined in the [`mailbox`](mailbox.md#module-mailbox "mailbox: Manipulate mailboxes in various formats") module:
