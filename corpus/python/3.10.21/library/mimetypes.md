...
source_url: https://docs.python.org/3.10/library/mimetypes.html
fetched_at: 2026-09-17T15:14:17+00:00
---
# `mimetypes` — Map filenames to MIME types

**Source code:** [Lib/mimetypes.py](https://github.com/python/cpython/tree/3.10/Lib/mimetypes.py)

---

The [`mimetypes`](mimetypes.md#module-mimetypes "mimetypes: Mapping of filename extensions to MIME types.") module converts between a filename or URL and the MIME type
...
:   Guess the type of a file based on its filename, path or URL, given by *url*.
    URL can be a string or a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
    ...
    *strict* is `False`, some additional non-standard but commonly used MIME types
    ...
    Changed in version 3.8: Added support for url being a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Guess the extensions for a file based on its MIME type, given by *type*. The
    ...
    type *type* by [`guess_type()`](mimetypes.md#mimetypes.guess_type "mimetypes.guess_type").
...
:   Guess the extension for a file based on its MIME type, given by *type*. The
    ...
    [`guess_type()`](mimetypes.md#mimetypes.guess_type "mimetypes.guess_type"). If no extension can be guessed for *type*, `None` is
    returned.
...
:   Initialize the internal data structures. If given, *files* must be a sequence
    ...
    [`knownfiles`](mimetypes.md#mimetypes.knownfiles "mimetypes.knownfiles") takes precedence over those named before it. Calling
    [`init()`](mimetypes.md#mimetypes.init "mimetypes.init") repeatedly is allowed.
...
The [`MimeTypes`](mimetypes.md#mimetypes.MimeTypes "mimetypes.MimeTypes") class may be useful for applications which may want more
...
:   This class represents a MIME-types database. By default, it provides access to
    ...
    `mime.types`-style files into the database using the [`read()`](mimetypes.md#mimetypes.MimeTypes.read "mimetypes.MimeTypes.read") or
    [`readfp()`](mimetypes.md#mimetypes.MimeTypes.readfp "mimetypes.MimeTypes.readfp") methods. The mapping dictionaries may also be cleared before
