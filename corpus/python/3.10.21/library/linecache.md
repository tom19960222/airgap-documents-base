...
source_url: https://docs.python.org/3.10/library/linecache.html
fetched_at: 2026-09-17T15:13:48+00:00
---
# `linecache` — Random access to text lines

**Source code:** [Lib/linecache.py](https://github.com/python/cpython/tree/3.10/Lib/linecache.py)

---

The [`linecache`](linecache.md#module-linecache "linecache: Provides random access to individual lines from text files.") module allows one to get any line from a Python source file, while
attempting to optimize internally, using a cache, the common case where many
lines are read from a single file. This is used by the [`traceback`](traceback.md#module-traceback "traceback: Print or retrieve a stack traceback.") module
to retrieve source lines for inclusion in the formatted traceback.

The [`tokenize.open()`](tokenize.md#tokenize.open "tokenize.open") function is used to open files. This
function uses [`tokenize.detect_encoding()`](tokenize.md#tokenize.detect_encoding "tokenize.detect_encoding") to get the encoding of the
...
:   Get line *lineno* from file named *filename*. This function will never raise an
    ...
    for a [**PEP 302**](https://www.python.org/dev/peps/pep-0302) `__loader__` in *module_globals*.
