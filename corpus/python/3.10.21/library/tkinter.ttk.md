...
source_url: https://docs.python.org/3.10/library/tkinter.ttk.html
fetched_at: 2026-09-17T15:14:43+00:00
---
# `tkinter.ttk` — Tk themed widgets

**Source code:** [Lib/tkinter/ttk.py](https://github.com/python/cpython/tree/3.10/Lib/tkinter/ttk.py)

---

The [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") module provides access to the Tk themed widget set,
...
The basic idea for [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") is to separate, to the extent possible,
...
That code causes several [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") widgets (`Button`,
...
`Radiobutton`, `Scale`, `Scrollbar`, and [`Spinbox`](tkinter.ttk.md#tkinter.ttk.Spinbox "tkinter.ttk.Spinbox").
The other six are new: [`Combobox`](tkinter.ttk.md#tkinter.ttk.Combobox "tkinter.ttk.Combobox"), [`Notebook`](tkinter.ttk.md#tkinter.ttk.Notebook "tkinter.ttk.Notebook"),
[`Progressbar`](tkinter.ttk.md#tkinter.ttk.Progressbar "tkinter.ttk.Progressbar"), `Separator`, `Sizegrip` and
[`Treeview`](tkinter.ttk.md#tkinter.ttk.Treeview "tkinter.ttk.Treeview"). And all them are subclasses of [`Widget`](tkinter.ttk.md#tkinter.ttk.Widget "tkinter.ttk.Widget").
...
For more information about [TtkStyling](tkinter.ttk.md#ttkstyling), see the [`Style`](tkinter.ttk.md#tkinter.ttk.Style "tkinter.ttk.Style") class
documentation.
...
> | image | Specifies an image to display. This is a list of 1 or more elements. The first element is the default image name. The rest of the list if a sequence of statespec/value pairs as defined by [`Style.map()`](tkinter.ttk.md#tkinter.ttk.Style.map "tkinter.ttk.Style.map"), specifying different images to use when the widget is in a particular state or a combination of states. All images in the list should have the same size. |
...
> | Option | Description |
> | --- | --- |
> | state | May be set to “normal” or “disabled” to control the “disabled” state bit. This is a write-only option: setting it changes the widget state, but the [`Widget.state()`](tkinter.ttk.md#tkinter.ttk.Widget.state "tkinter.ttk.Widget.state") method does not affect this option. |
...
Besides the methods inherited from [`Widget`](tkinter.ttk.md#tkinter.ttk.Widget "tkinter.ttk.Widget"): `Widget.cget()`,
`Widget.configure()`, [`Widget.identify()`](tkinter.ttk.md#tkinter.ttk.Widget.identify "tkinter.ttk.Widget.identify"), [`Widget.instate()`](tkinter.ttk.md#tkinter.ttk.Widget.instate "tkinter.ttk.Widget.instate")
and [`Widget.state()`](tkinter.ttk.md#tkinter.ttk.Widget.state "tkinter.ttk.Widget.state"), and the following inherited from `Entry`:
...
> | image | Specifies an image to display in the tab. See the option image described in [`Widget`](tkinter.ttk.md#tkinter.ttk.Widget "tkinter.ttk.Widget"). |
> | compound | Specifies how to display the image relative to the text, in the case both options text and image are present. See [Label Options](tkinter.ttk.md#label-options) for legal values. |
> | underline | Specifies the index (0-based) of a character to underline in the text string. The underlined character is used for mnemonic activation if [`Notebook.enable_traversal()`](tkinter.ttk.md#tkinter.ttk.Notebook.enable_traversal "tkinter.ttk.Notebook.enable_traversal") is called. |
...
- The literal string “end”, which returns the number of tabs (only valid for
  [`Notebook.index()`](tkinter.ttk.md#tkinter.ttk.Notebook.index "tkinter.ttk.Notebook.index"))
...
widget option columns. See [Column Identifiers](tkinter.ttk.md#column-identifiers).
...
the options described in [Scrollable Widget Options](tkinter.ttk.md#scrollable-widget-options) and the methods
[`Treeview.xview()`](tkinter.ttk.md#tkinter.ttk.Treeview.xview "tkinter.ttk.Treeview.xview") and [`Treeview.yview()`](tkinter.ttk.md#tkinter.ttk.Treeview.yview "tkinter.ttk.Treeview.yview").
...
The [`Treeview.focus()`](tkinter.ttk.md#tkinter.ttk.Treeview.focus "tkinter.ttk.Treeview.focus") and [`Treeview.selection()`](tkinter.ttk.md#tkinter.ttk.Treeview.selection "tkinter.ttk.Treeview.selection") methods can be used
...
:   `bbox(item, column=None)`
    ...
    :   Creates a new item and returns the item identifier of the newly created
        ...
        *parent* is the item ID of the parent item, or the empty string to create
        ...
        See [Item Options](tkinter.ttk.md#item-options) for the list of available points.
...
:   This class is used to manipulate the style database.
    ...
    :   Define the widget layout for given *style*. If *layoutspec* is omitted,
        ...
        *layoutspec*, if specified, is expected to be a list or some other
        ...
        format described in [Layouts](tkinter.ttk.md#layouts).
    ...
    :   Create a new element in the current theme, of the given *etype* which is
        ...
        [`element_create()`](tkinter.ttk.md#tkinter.ttk.Style.element_create "tkinter.ttk.Style.element_create") will clone an existing
    ...
    :   Temporarily sets the current theme to *themename*, apply specified
        *settings* and then restore the previous theme.
        ...
        [`Style.configure()`](tkinter.ttk.md#tkinter.ttk.Style.configure "tkinter.ttk.Style.configure"), [`Style.map()`](tkinter.ttk.md#tkinter.ttk.Style.map "tkinter.ttk.Style.map"), [`Style.layout()`](tkinter.ttk.md#tkinter.ttk.Style.layout "tkinter.ttk.Style.layout") and
        [`Style.element_create()`](tkinter.ttk.md#tkinter.ttk.Style.element_create "tkinter.ttk.Style.element_create") respectively.
...
>       a single element for the purposes of [`Widget.identify()`](tkinter.ttk.md#tkinter.ttk.Widget.identify "tkinter.ttk.Widget.identify") et al. It’s
>       used for things like scrollbar thumbs with grips.
> - children: [sublayout… ]
>   :   Specifies a list of elements to place inside the element. Each
>       element is a tuple (or other sequence type) where the first item is
>       the layout name, and the other is a [Layout](tkinter.ttk.md#layouts).
