...
source_url: https://docs.python.org/3.10/library/venv.html
fetched_at: 2026-09-17T15:14:55+00:00
---
# `venv` — Creation of virtual environments

New in version 3.3.

**Source code:** [Lib/venv/](https://github.com/python/cpython/tree/3.10/Lib/venv/)

---

The `venv` module supports creating lightweight “virtual environments”,
each with their own independent set of Python packages installed in
their [`site`](site.md#module-site "site: Module responsible for site-specific configuration.") directories.
...
See [**PEP 405**](https://www.python.org/dev/peps/pep-0405) for more background on Python virtual environments.
...
Creation of [virtual environments](venv.md#venv-def) is done by executing the
command `venv`:
...
[deprecated in Python 3.6](https://docs.python.org/3.10/whatsnew/3.6.html#whatsnew36-venv).
...
your [Python installation](https://docs.python.org/3.10/using/windows.html#using-on-windows):
...
Unless the `--without-pip` option is given, [`ensurepip`](ensurepip.md#module-ensurepip "ensurepip: Bootstrapping the \"pip\" installer into an existing Python installation or virtual environment.") will be
...
[`sys.prefix`](sys.md#sys.prefix "sys.prefix") and [`sys.exec_prefix`](sys.md#sys.exec_prefix "sys.exec_prefix")
point to the directories of the virtual environment,
whereas [`sys.base_prefix`](sys.md#sys.base_prefix "sys.base_prefix") and [`sys.base_exec_prefix`](sys.md#sys.base_exec_prefix "sys.base_exec_prefix")
...
New in version 3.8: PowerShell activation scripts installed under POSIX for PowerShell Core
support.
...
you have the [Python Launcher for Windows](https://docs.python.org/3.10/using/windows.html#launcher) installed. Thus, double-clicking an installed
...
:   The [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") class accepts the following keyword arguments on
    ...
    - `with_pip` – a Boolean value which, if true, ensures pip is
      installed in the virtual environment. This uses [`ensurepip`](ensurepip.md#module-ensurepip "ensurepip: Bootstrapping the \"pip\" installer into an existing Python installation or virtual environment.") with
    ...
    provided [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") class as a base class.
    ...
    :   Create a virtual environment by specifying the target directory
        ...
        The `create` method of the [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") class illustrates the
        ...
        Each of the methods [`ensure_directories()`](venv.md#venv.EnvBuilder.ensure_directories "venv.EnvBuilder.ensure_directories"),
    ...
    :   Creates the environment directory and all necessary subdirectories that
        ...
        methods. If the [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") is created with the arg
        `clear=True`, contents of the environment directory will be cleared
        and then all necessary subdirectories will be recreated.

        The returned context object is a [`types.SimpleNamespace`](types.md#types.SimpleNamespace "types.SimpleNamespace") with the
        following attributes:

        - `env_dir` - The location of the virtual environment. Used for
          `__VENV_DIR__` in activation scripts (see [`install_scripts()`](venv.md#venv.EnvBuilder.install_scripts "venv.EnvBuilder.install_scripts")).
        - `env_name` - The name of the virtual environment. Used for
          `__VENV_NAME__` in activation scripts (see [`install_scripts()`](venv.md#venv.EnvBuilder.install_scripts "venv.EnvBuilder.install_scripts")).
        - `prompt` - The prompt to be used by the activation scripts. Used for
          `__VENV_PROMPT__` in activation scripts (see [`install_scripts()`](venv.md#venv.EnvBuilder.install_scripts "venv.EnvBuilder.install_scripts")).
        ...
        - `bin_name` - The name of the script path relative to the virtual
          ...
          scripts (see [`install_scripts()`](venv.md#venv.EnvBuilder.install_scripts "venv.EnvBuilder.install_scripts")).
        - `env_exe` - The name of the Python interpreter in the virtual
          environment. Used for `__VENV_PYTHON__` in activation scripts
          (see [`install_scripts()`](venv.md#venv.EnvBuilder.install_scripts "venv.EnvBuilder.install_scripts")).
    ...
    copying the actual binaries. In 3.7.2 only [`setup_python()`](venv.md#venv.EnvBuilder.setup_python "venv.EnvBuilder.setup_python") does
    nothing unless running from a build in the source tree.

    Changed in version 3.7.3: Windows copies the redirector scripts as part of [`setup_python()`](venv.md#venv.EnvBuilder.setup_python "venv.EnvBuilder.setup_python")
    instead of [`setup_scripts()`](venv.md#venv.EnvBuilder.setup_scripts "venv.EnvBuilder.setup_scripts"). This was not the case in 3.7.2.
    When using symlinks, the original executables will be linked.

    In addition, [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") provides this utility method that can be
    ...
    :   *path* is the path to a directory that should contain subdirectories
        ...
        directory corresponding to [`os.name`](os.md#os.name "os.name") are copied after some text
...
The following script shows how to extend [`EnvBuilder`](venv.md#venv.EnvBuilder "venv.EnvBuilder") by implementing a
