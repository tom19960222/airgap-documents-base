...
collection: python
version: "3.10.21"
title: "aifc — Read and write AIFF and AIFC files"
source_url: https://docs.python.org/3.10/library/aifc.html
fetched_at: 2026-09-17T15:15:17+00:00
---
# `aifc` — Read and write AIFF and AIFC files

**Source code:** [Lib/aifc.py](https://github.com/python/cpython/tree/3.10/Lib/aifc.py)

Deprecated since version 3.11: The [`aifc`](aifc.md#module-aifc "aifc: Read and write audio files in AIFF or AIFC format. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#aifc) for details).
...
:   Open an AIFF or AIFF-C file and return an object instance with methods that are
    ...
    [file object](https://docs.python.org/3.10/glossary.html#term-file-object). *mode* must be `'r'` or `'rb'` when the file must be
    ...
    The [`open()`](aifc.md#aifc.open "aifc.open") function may be used in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. When
    the `with` block completes, the [`close()`](aifc.md#aifc.aifc.close "aifc.aifc.close") method is called.
...
Objects returned by [`open()`](aifc.md#aifc.open "aifc.open") when a file is opened for writing have all the
...
:   Write data to the output file. This method can only be called after the audio
    ...
    Changed in version 3.4: Any [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) is now accepted.
