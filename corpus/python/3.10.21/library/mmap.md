...
source_url: https://docs.python.org/3.10/library/mmap.html
...
[file objects](https://docs.python.org/3.10/glossary.html#term-file-object). You can use mmap objects in most places
...
:   **(Unix version)** Maps *length* bytes from the file specified by the file
    ...
    *offset* may be specified as a non-negative integer offset. mmap references
    ...
    [`mmap`](mmap.md#mmap.mmap "mmap.mmap") can also be used as a context manager in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
    statement:
...
`mmap.MAP_POPULATE`
:   These are the various flags that can be passed to [`mmap.mmap()`](mmap.md#mmap.mmap "mmap.mmap"). Note that some options might not be present on some systems.
