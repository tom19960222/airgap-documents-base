...
collection: python
version: "3.10.21"
title: "sunau — Read and write Sun AU files"
source_url: https://docs.python.org/3.10/library/sunau.html
fetched_at: 2026-09-17T15:15:26+00:00
---
# `sunau` — Read and write Sun AU files

**Source code:** [Lib/sunau.py](https://github.com/python/cpython/tree/3.10/Lib/sunau.py)

Deprecated since version 3.11: The [`sunau`](sunau.md#module-sunau "sunau: Provide an interface to the Sun AU sound format. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#sunau) for details).

---

The [`sunau`](sunau.md#module-sunau "sunau: Provide an interface to the Sun AU sound format. (deprecated)") module provides a convenient interface to the Sun AU sound
format. Note that this module is interface-compatible with the modules
[`aifc`](aifc.md#module-aifc "aifc: Read and write audio files in AIFF or AIFC format. (deprecated)") and [`wave`](wave.md#module-wave "wave: Provide an interface to the WAV sound format.").
