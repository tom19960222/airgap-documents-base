...
source_url: https://docs.python.org/3.10/library/asyncio-llapi-index.html
...
- [Using asyncio.get_event_loop() and loop.run_forever()](asyncio-eventloop.md#asyncio-example-lowlevel-helloworld).
...
| `callback` [`process_exited()`](asyncio-protocol.md#asyncio.SubprocessProtocol.process_exited "asyncio.SubprocessProtocol.process_exited") | Called when the child process has exited. |
