...
source_url: https://docs.python.org/3.10/library/ipaddress.html
fetched_at: 2026-09-17T15:14:35+00:00
---
# `ipaddress` — IPv4/IPv6 manipulation library

**Source code:** [Lib/ipaddress.py](https://github.com/python/cpython/tree/3.10/Lib/ipaddress.py)

---

[`ipaddress`](ipaddress.md#module-ipaddress "ipaddress: IPv4/IPv6 manipulation library.") provides the capabilities to create, manipulate and
...
[An introduction to the ipaddress module](https://docs.python.org/3.10/howto/ipaddress.html#ipaddress-howto).
...
:   Return an [`IPv4Address`](ipaddress.md#ipaddress.IPv4Address "ipaddress.IPv4Address") or [`IPv6Address`](ipaddress.md#ipaddress.IPv6Address "ipaddress.IPv6Address") object depending on
    ...
    A [`ValueError`](exceptions.md#ValueError "ValueError") is raised if *address* does not represent a valid IPv4
    or IPv6 address.
...
:   Return an [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network") or [`IPv6Network`](ipaddress.md#ipaddress.IPv6Network "ipaddress.IPv6Network") object depending on
    ...
    is passed to [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network") or [`IPv6Network`](ipaddress.md#ipaddress.IPv6Network "ipaddress.IPv6Network") constructor. A
    [`ValueError`](exceptions.md#ValueError "ValueError") is raised if *address* does not represent a valid IPv4 or
...
The [`IPv4Address`](ipaddress.md#ipaddress.IPv4Address "ipaddress.IPv4Address") and [`IPv6Address`](ipaddress.md#ipaddress.IPv6Address "ipaddress.IPv6Address") objects share a lot of common
attributes. Some attributes that are only meaningful for IPv6 addresses are
also implemented by [`IPv4Address`](ipaddress.md#ipaddress.IPv4Address "ipaddress.IPv4Address") objects, in order to make it easier to
write code that handles both IP versions correctly. Address objects are
[hashable](https://docs.python.org/3.10/glossary.html#term-hashable), so they can be used as keys in dictionaries.
...
:   Construct an IPv4 address. An [`AddressValueError`](ipaddress.md#ipaddress.AddressValueError "ipaddress.AddressValueError") is raised if
    *address* is not a valid IPv4 address.
    ...
    3. An integer packed into a [`bytes`](stdtypes.md#bytes "bytes") object of length 4 (most
    ...
    Changed in version 3.10: Leading zeros are no longer tolerated and are treated as an error.
    IPv4 address strings are now parsed as strict as glibc
    [`inet_pton()`](socket.md#socket.inet_pton "socket.inet_pton").

    Changed in version 3.9.5: The above change was also included in Python 3.9 starting with
    version 3.9.5.

    Changed in version 3.8.12: The above change was also included in Python 3.8 starting with
    version 3.8.12.
    ...
    :   `True` if the address is defined as not globally reachable by
        ...
        - For IPv4-mapped IPv6-addresses the `is_private` value is determined by the
          ...
          (see [`IPv6Address.ipv4_mapped`](ipaddress.md#ipaddress.IPv6Address.ipv4_mapped "ipaddress.IPv6Address.ipv4_mapped")):

          ```python3
          address.is_private == address.ipv4_mapped.is_private
          ```

        `is_private` has value opposite to [`is_global`](ipaddress.md#ipaddress.IPv4Address.is_global "ipaddress.IPv4Address.is_global"), except for the shared address space
        (`100.64.0.0/10` range) where they are both `False`.

        Changed in version 3.10.15: Fixed some false positives and false negatives.
    ...
    :   `True` if the address is defined as globally reachable by
        ...
        `is_global` has value opposite to [`is_private`](ipaddress.md#ipaddress.IPv4Address.is_private "ipaddress.IPv4Address.is_private"), except for the shared address space
        (`100.64.0.0/10` range) where they are both `False`.

        New in version 3.4.

        Changed in version 3.10.15: Fixed some false positives and false negatives, see [`is_private`](ipaddress.md#ipaddress.IPv4Address.is_private "ipaddress.IPv4Address.is_private") for details.
...
:   Returns a string representation of the IP address, controlled by
    ...
    *fmt* can be one of the following: `'s'`, the default option,
    equivalent to [`str()`](stdtypes.md#str "str"), `'b'` for a zero-padded binary string,
...
:   Construct an IPv6 address. An [`AddressValueError`](ipaddress.md#ipaddress.AddressValueError "ipaddress.AddressValueError") is raised if
    *address* is not a valid IPv6 address.
    ...
    3. An integer packed into a [`bytes`](stdtypes.md#bytes "bytes") object of length 16, big-endian.
...
the [`str()`](stdtypes.md#str "str") and [`int()`](functions.md#int "int") builtin functions:
...
The [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network") and [`IPv6Network`](ipaddress.md#ipaddress.IPv6Network "ipaddress.IPv6Network") objects provide a mechanism
...
All of these are common between [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network") and [`IPv6Network`](ipaddress.md#ipaddress.IPv6Network "ipaddress.IPv6Network"),
so to avoid duplication they are only documented for [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network").
Network objects are [hashable](https://docs.python.org/3.10/glossary.html#term-hashable), so they can be used as keys in
dictionaries.
...
:   Construct an IPv4 network definition. *address* can be one of the following:
    ...
    2. An integer that fits into 32 bits. This is equivalent to a
       ...
       the mask being `/32`.
    3. An integer packed into a [`bytes`](stdtypes.md#bytes "bytes") object of length 4, big-endian.
    ...
    An [`AddressValueError`](ipaddress.md#ipaddress.AddressValueError "ipaddress.AddressValueError") is raised if *address* is not a valid IPv4
    address. A [`NetmaskValueError`](ipaddress.md#ipaddress.NetmaskValueError "ipaddress.NetmaskValueError") is raised if the mask is not valid for
    an IPv4 address.

    If *strict* is `True` and host bits are set in the supplied address,
    then [`ValueError`](exceptions.md#ValueError "ValueError") is raised. Otherwise, the host bits are masked out
    to determine the appropriate network address.

    Unless stated otherwise, all network methods accepting other network/address
    objects will raise [`TypeError`](exceptions.md#TypeError "TypeError") if the argument’s IP version is
...
:   Construct an IPv6 network definition. *address* can be one of the following:
    ...
    An [`AddressValueError`](ipaddress.md#ipaddress.AddressValueError "ipaddress.AddressValueError") is raised if *address* is not a valid IPv6
    address. A [`NetmaskValueError`](ipaddress.md#ipaddress.NetmaskValueError "ipaddress.NetmaskValueError") is raised if the mask is not valid for
    an IPv6 address.
...
(for usable hosts, use the [`hosts()`](ipaddress.md#ipaddress.IPv4Network.hosts "ipaddress.IPv4Network.hosts") method). An
example:
...
Interface objects are [hashable](https://docs.python.org/3.10/glossary.html#term-hashable), so they can be used as keys in
dictionaries.
...
:   Construct an IPv4 interface. The meaning of *address* is as in the
    ...
    [`IPv4Interface`](ipaddress.md#ipaddress.IPv4Interface "ipaddress.IPv4Interface") is a subclass of [`IPv4Address`](ipaddress.md#ipaddress.IPv4Address "ipaddress.IPv4Address"), so it inherits
...
:   Construct an IPv6 interface. The meaning of *address* is as in the
    ...
    [`IPv6Interface`](ipaddress.md#ipaddress.IPv6Interface "ipaddress.IPv6Interface") is a subclass of [`IPv6Address`](ipaddress.md#ipaddress.IPv6Address "ipaddress.IPv6Address"), so it inherits
    all the attributes from that class. In addition, the following attributes
    are available:
...
:   Return an iterator of the summarized network range given the first and last
    ...
    or [`IPv6Address`](ipaddress.md#ipaddress.IPv6Address "ipaddress.IPv6Address") in the range. A [`TypeError`](exceptions.md#TypeError "TypeError") is raised if
    *first* or *last* are not IP addresses or are not of the same version. A
    [`ValueError`](exceptions.md#ValueError "ValueError") is raised if *last* is not greater than *first* or if
...
:   Return an iterator of the collapsed [`IPv4Network`](ipaddress.md#ipaddress.IPv4Network "ipaddress.IPv4Network") or
    [`IPv6Network`](ipaddress.md#ipaddress.IPv6Network "ipaddress.IPv6Network") objects. *addresses* is an iterator of
...
:   Return a key suitable for sorting between networks and addresses. Address
    ...
    have [`ipaddress`](ipaddress.md#module-ipaddress "ipaddress: IPv4/IPv6 manipulation library.") sort these anyway. If you need to do this, you can use
    this function as the *key* argument to [`sorted()`](functions.md#sorted "sorted").
