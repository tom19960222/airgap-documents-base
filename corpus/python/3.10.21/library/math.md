...
source_url: https://docs.python.org/3.10/library/math.html
...
same name from the [`cmath`](cmath.md#module-cmath "cmath: Mathematical functions for complex numbers.") module if you require support for complex
...
:   Return the ceiling of *x*, the smallest integer greater than or equal to *x*.
    If *x* is not a float, delegates to [`x.__ceil__`](https://docs.python.org/3.10/reference/datamodel.html#object.__ceil__ "object.__ceil__"),
...
:   Return the number of ways to choose *k* items from *n* items without repetition
    ...
    Raises [`TypeError`](exceptions.md#TypeError "TypeError") if either of the arguments are not integers.
    Raises [`ValueError`](exceptions.md#ValueError "ValueError") if either of the arguments are negative.
...
`math.factorial(x)`
:   Return *x* factorial as an integer. Raises [`ValueError`](exceptions.md#ValueError "ValueError") if *x* is not integral or
    is negative.
...
:   Return the floor of *x*, the largest integer less than or equal to *x*. If
    *x* is not a float, delegates to [`x.__floor__`](https://docs.python.org/3.10/reference/datamodel.html#object.__floor__ "object.__floor__"), which
...
:   Return an accurate floating point sum of values in the iterable. Avoids
    ...
    recipes for accurate floating point summation](https://code.activestate.com/recipes/393090/).
...
:   Return `True` if the values *a* and *b* are close to each other and
    ...
    *abs_tol* is the minimum absolute tolerance – useful for comparisons near
    ...
    > **See also:**
    >
    > [**PEP 485**](https://www.python.org/dev/peps/pep-0485) – A function for testing approximate equality
...
:   Return the next floating-point value after *x* towards *y*.
    ...
    See also [`math.ulp()`](math.md#math.ulp "math.ulp").
...
:   Return the IEEE 754-style remainder of *x* with respect to *y*. For
    ...
    *x* for any finite *x*, and `remainder(x, 0)` and
    `remainder(math.inf, x)` raise [`ValueError`](exceptions.md#ValueError "ValueError") for any non-NaN *x*.
...
:   Return *x* with the fractional part
    ...
    for negative *x*. If *x* is not a float, delegates to [`x.__trunc__`](https://docs.python.org/3.10/reference/datamodel.html#object.__trunc__ "object.__trunc__"), which should return an [`Integral`](numbers.md#numbers.Integral "numbers.Integral") value.
...
:   Return the value of the least significant bit of the float *x*:
    ...
    - If *x* is equal to zero, return the smallest positive
      ...
      *normalized* float, [`sys.float_info.min`](sys.md#sys.float_info "sys.float_info")).
    ...
    See also [`math.nextafter()`](math.md#math.nextafter "math.nextafter") and [`sys.float_info.epsilon`](sys.md#sys.float_info "sys.float_info").

    New in version 3.9.

Note that [`frexp()`](math.md#math.frexp "math.frexp") and [`modf()`](math.md#math.modf "math.modf") have a different call/return pattern
than their C equivalents: they take a single argument and return a pair of
values, rather than returning their second return value through an ‘output
parameter’ (there is no such thing in Python).

For the [`ceil()`](math.md#math.ceil "math.ceil"), [`floor()`](math.md#math.floor "math.floor"), and [`modf()`](math.md#math.modf "math.modf") functions, note that *all*
...
:   Return `x` raised to the power `y`. Exceptional cases follow
    ...
    is undefined, and raises [`ValueError`](exceptions.md#ValueError "ValueError").

    Unlike the built-in `**` operator, [`math.pow()`](math.md#math.pow "math.pow") converts both
    its arguments to type [`float`](functions.md#float "float"). Use `**` or the built-in
    [`pow()`](functions.md#pow "pow") function for computing exact integer powers.
...
:   Return the [error function](https://en.wikipedia.org/wiki/Error_function) at
    *x*.
    ...
    The [`erf()`](math.md#math.erf "math.erf") function can be used to compute traditional statistical
    functions such as the [cumulative standard normal distribution](https://en.wikipedia.org/wiki/Normal_distribution#Cumulative_distribution_functions):
...
:   The mathematical constant *τ* = 6.283185…, to available precision.
    ...
    Wrong](https://www.youtube.com/watch?v=jG7vhMMXagQ), and start celebrating
...
:   A floating-point “not a number” (NaN) value. Equivalent to the output of
    ...
    whether a number is a NaN, use the [`isnan()`](math.md#math.isnan "math.isnan") function to test
...
**CPython implementation detail:** The [`math`](math.md#module-math "math: Mathematical functions (sin() etc.).") module consists mostly of thin wrappers around the platform C
math library functions. Behavior in exceptional cases follows Annex F of
the C99 standard where appropriate. The current implementation will raise
[`ValueError`](exceptions.md#ValueError "ValueError") for invalid operations like `sqrt(-1.0)` or `log(0.0)`
(where C99 Annex F recommends signaling invalid operation or divide-by-zero),
and [`OverflowError`](exceptions.md#OverflowError "OverflowError") for results that overflow (for example,
...
> **See also:**
>
> Module [`cmath`](cmath.md#module-cmath "cmath: Mathematical functions for complex numbers.")
