...
source_url: https://docs.python.org/3.10/library/selectors.html
...
**Source code:** [Lib/selectors.py](https://github.com/python/cpython/tree/3.10/Lib/selectors.py)
...
`fileno()` method, or a raw file descriptor. See [file object](https://docs.python.org/3.10/glossary.html#term-file-object).
...
:   A [`BaseSelector`](selectors.md#selectors.BaseSelector "selectors.BaseSelector") is used to wait for I/O event readiness on multiple
    ...
    [context manager](https://docs.python.org/3.10/glossary.html#term-context-manager) protocol.
    ...
    :   Wait until some registered file objects become ready, or the timeout
        ...
        *events* is a bitmask of events ready on this file object.
        ...
        [**PEP 475**](https://www.python.org/dev/peps/pep-0475) for the rationale), instead of returning an empty list
