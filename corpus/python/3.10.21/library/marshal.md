...
source_url: https://docs.python.org/3.10/library/marshal.html
...
:   Write the value on the open file. The value must be a supported type. The
    file must be a writeable [binary file](https://docs.python.org/3.10/glossary.html#term-binary-file).
...
:   Read one value from the open file and return it. If no valid value is read
    ...
    file must be a readable [binary file](https://docs.python.org/3.10/glossary.html#term-binary-file).
...
`marshal.loads(bytes)`
:   Convert the [bytes-like object](https://docs.python.org/3.10/glossary.html#term-bytes-like-object) to a value. If no valid value is found, raise
