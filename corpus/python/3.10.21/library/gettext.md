...
source_url: https://docs.python.org/3.10/library/gettext.html
fetched_at: 2026-09-17T15:14:37+00:00
---
# `gettext` — Multilingual internationalization services

**Source code:** [Lib/gettext.py](https://github.com/python/cpython/tree/3.10/Lib/gettext.py)

---

The [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module provides internationalization (I18N) and localization
...
The [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module defines the following API, which is very similar to
...
:   Bind the *domain* to *codeset*, changing the encoding of byte strings
    returned by the [`lgettext()`](gettext.md#gettext.lgettext "gettext.lgettext"), [`ldgettext()`](gettext.md#gettext.ldgettext "gettext.ldgettext"), [`lngettext()`](gettext.md#gettext.lngettext "gettext.lngettext")
    and [`ldngettext()`](gettext.md#gettext.ldngettext "gettext.ldngettext") functions.
...
:   Equivalent to the corresponding functions without the `l` prefix
    ([`gettext()`](gettext.md#gettext.gettext "gettext.gettext"), [`dgettext()`](gettext.md#gettext.dgettext "gettext.dgettext"), [`ngettext()`](gettext.md#gettext.ngettext "gettext.ngettext") and [`dngettext()`](gettext.md#gettext.dngettext "gettext.dngettext")),
    but the translation is returned as a byte string encoded in the preferred
    system encoding if no other encoding was explicitly set with
    [`bind_textdomain_codeset()`](gettext.md#gettext.bind_textdomain_codeset "gettext.bind_textdomain_codeset").
...
The class-based API of the [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module gives you more flexibility and
...
a [`GNUTranslations`](gettext.md#gettext.GNUTranslations "gettext.GNUTranslations") class which implements the parsing of GNU `.mo` format
...
:   This function implements the standard `.mo` file search algorithm. It
    ...
    *localedir* is as in [`bindtextdomain()`](gettext.md#gettext.bindtextdomain "gettext.bindtextdomain"). Optional *languages* is a list of
    ...
    [2](gettext.md#id4) If *languages* is not given, then the following environment variables are
    ...
    *languages* variable. The environment variables should contain a colon separated
    ...
    [`find()`](gettext.md#gettext.find "gettext.find") then expands and normalizes the languages, and then iterates
    through them, searching for an existing file built of these components:

    `localedir/language/LC_MESSAGES/domain.mo`

    The first such file name that exists is returned by [`find()`](gettext.md#gettext.find "gettext.find"). If no such
...
:   Return a `*Translations` instance based on the *domain*, *localedir*,
    ...
    provided, otherwise [`GNUTranslations`](gettext.md#gettext.GNUTranslations "gettext.GNUTranslations"). The class’s constructor must
    take a single [file object](https://docs.python.org/3.10/glossary.html#term-file-object) argument. If provided, *codeset* will change
    the charset used to encode translated strings in the
    [`lgettext()`](gettext.md#gettext.NullTranslations.lgettext "gettext.NullTranslations.lgettext") and [`lngettext()`](gettext.md#gettext.NullTranslations.lngettext "gettext.NullTranslations.lngettext")
    methods.

    If multiple files are found, later files are used as fallbacks for earlier ones.
    To allow setting the fallback, [`copy.copy()`](copy.md#copy.copy "copy.copy") is used to clone each
    translation object from the cache; the actual instance data is still shared with
    the cache.

    If no `.mo` file is found, this function raises [`OSError`](exceptions.md#OSError "OSError") if
    *fallback* is false (which is the default), and returns a
    [`NullTranslations`](gettext.md#gettext.NullTranslations "gettext.NullTranslations") instance if *fallback* is true.
...
:   This installs the function `_()` in Python’s builtins namespace, based on
    *domain*, *localedir*, and *codeset* which are passed to the function
    [`translation()`](gettext.md#gettext.translation "gettext.translation").

    For the *names* parameter, please see the description of the translation
    object’s [`install()`](gettext.md#gettext.NullTranslations.install "gettext.NullTranslations.install") method.
...
by all translation classes is [`NullTranslations`](gettext.md#gettext.NullTranslations "gettext.NullTranslations"); this provides the basic
interface you can use to write your own specialized translation classes. Here
are the methods of `NullTranslations`:

`class gettext.NullTranslations(fp=None)`
:   Takes an optional [file object](https://docs.python.org/3.10/glossary.html#term-file-object) *fp*, which is ignored by the base class.
    ...
    :   Equivalent to [`gettext()`](gettext.md#gettext.NullTranslations.gettext "gettext.NullTranslations.gettext") and [`ngettext()`](gettext.md#gettext.NullTranslations.ngettext "gettext.NullTranslations.ngettext"), but the translation
        is returned as a byte string encoded in the preferred system encoding
        if no encoding was explicitly set with [`set_output_charset()`](gettext.md#gettext.NullTranslations.set_output_charset "gettext.NullTranslations.set_output_charset").
        Overridden in derived classes.

        > **Warning:**
        >
        > These methods should be avoided in Python 3. See the warning for the
        > [`lgettext()`](gettext.md#gettext.lgettext "gettext.lgettext") function.
    ...
    `output_charset()`
    :   Return the encoding used to return translated messages in [`lgettext()`](gettext.md#gettext.NullTranslations.lgettext "gettext.NullTranslations.lgettext")
        and [`lngettext()`](gettext.md#gettext.NullTranslations.lngettext "gettext.NullTranslations.lngettext").
...
The [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module provides one additional class derived from
[`NullTranslations`](gettext.md#gettext.NullTranslations "gettext.NullTranslations"): [`GNUTranslations`](gettext.md#gettext.GNUTranslations "gettext.GNUTranslations"). This class overrides
`_parse()` to enable reading GNU **gettext** format `.mo` files
in both big-endian and little-endian format.

[`GNUTranslations`](gettext.md#gettext.GNUTranslations "gettext.GNUTranslations") parses optional metadata out of the translation
...
:   The following methods are overridden from the base class implementation:
    ...
    :   Do a plural-forms lookup of a message id. *singular* is used as the message id
        ...
        the request is forwarded to the fallback’s [`ngettext()`](gettext.md#gettext.NullTranslations.ngettext "gettext.NullTranslations.ngettext")
    ...
    :   Look up the *context* and *message* id in the catalog and return the
        ...
        [`pgettext()`](gettext.md#gettext.pgettext "gettext.pgettext") method. Otherwise, the *message* id is returned.
    ...
    :   Do a plural-forms lookup of a message id. *singular* is used as the
        ...
        [`npgettext()`](gettext.md#gettext.npgettext "gettext.npgettext") method. Otherwise, when *n* is 1 *singular* is
    ...
    `lngettext(singular, plural, n)`
    :   Equivalent to [`gettext()`](gettext.md#gettext.GNUTranslations.gettext "gettext.GNUTranslations.gettext") and [`ngettext()`](gettext.md#gettext.GNUTranslations.ngettext "gettext.GNUTranslations.ngettext"), but the translation
        is returned as a byte string encoded in the preferred system encoding
        if no encoding was explicitly set with
        [`set_output_charset()`](gettext.md#gettext.NullTranslations.set_output_charset "gettext.NullTranslations.set_output_charset").
...
GNOME uses a version of the [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module by James Henstridge, but this
...
alias for the [`translation()`](gettext.md#gettext.translation "gettext.translation") function described above.
...
4. use the [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module so that message strings are properly translated
...
[`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module for the actual translation processing at
run-time.

How you use the [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module in your code depends on whether you are
...
[`install()`](gettext.md#gettext.install "gettext.install") function:
...
of `_()` in the built-in namespace (until the [`del`](https://docs.python.org/3.10/reference/simple_stmts.html#del) command). Take
...
:   The default locale directory is system dependent; for example, on RedHat Linux
    ...
    The [`gettext`](gettext.md#module-gettext "gettext: Multilingual internationalization services.") module does not try to support these system dependent
    defaults; instead its default is `sys.base_prefix/share/locale` (see
    [`sys.base_prefix`](sys.md#sys.base_prefix "sys.base_prefix")). For this reason, it is always best to call
    [`bindtextdomain()`](gettext.md#gettext.bindtextdomain "gettext.bindtextdomain") with an explicit absolute path at the start of your
    application.

[2](gettext.md#id2)
:   See the footnote for [`bindtextdomain()`](gettext.md#gettext.bindtextdomain "gettext.bindtextdomain") above.
