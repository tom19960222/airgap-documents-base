...
source_url: https://docs.python.org/3.10/library/cmath.html
...
`cmath.sqrt(x)`
:   Return the square root of *x*. This has the same branch cut as [`log()`](cmath.md#cmath.log "cmath.log").
...
`cmath.asin(x)`
:   Return the arc sine of *x*. This has the same branch cuts as [`acos()`](cmath.md#cmath.acos "cmath.acos").
