...
source_url: https://docs.python.org/3.10/library/poplib.html
fetched_at: 2026-09-17T15:14:30+00:00
---
# `poplib` — POP3 protocol client

**Source code:** [Lib/poplib.py](https://github.com/python/cpython/tree/3.10/Lib/poplib.py)
...
An [`POP3`](poplib.md#poplib.POP3 "poplib.POP3") instance has the following methods:
