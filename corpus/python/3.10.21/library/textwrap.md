...
source_url: https://docs.python.org/3.10/library/textwrap.html
fetched_at: 2026-09-17T15:13:28+00:00
---
# `textwrap` — Text wrapping and filling

**Source code:** [Lib/textwrap.py](https://github.com/python/cpython/tree/3.10/Lib/textwrap.py)
...
:   The [`TextWrapper`](textwrap.md#textwrap.TextWrapper "textwrap.TextWrapper") constructor accepts a number of optional keyword
    ...
    You can re-use the same [`TextWrapper`](textwrap.md#textwrap.TextWrapper "textwrap.TextWrapper") object many times, and you can
