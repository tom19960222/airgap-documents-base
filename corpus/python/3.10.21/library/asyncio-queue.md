...
version: "3.10.21"
title: "Queues"
source_url: https://docs.python.org/3.10/library/asyncio-queue.html
fetched_at: 2026-09-17T15:15:29+00:00
---
# Queues

**Source code:** [Lib/asyncio/queues.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/queues.py)
...
:   A first in, first out (FIFO) queue.
    ...
    :   Indicate that a formerly enqueued task is complete.
        ...
        fetch a task, a subsequent call to [`task_done()`](asyncio-queue.md#asyncio.Queue.task_done "asyncio.Queue.task_done") tells the
