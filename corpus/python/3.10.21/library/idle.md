...
version: "3.10.21"
title: "IDLE"
source_url: https://docs.python.org/3.10/library/idle.html
fetched_at: 2026-09-17T15:14:44+00:00
---
# IDLE

**Source code:** [Lib/idlelib/](https://github.com/python/cpython/tree/3.10/Lib/idlelib/)
...
- coded in 100% pure Python, using the [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") GUI toolkit
...
:   Open a scrollable list allowing selection of existing names. See
    [Completions](idle.md#completions) in the Editing and navigation section below.
...
:   After an unclosed parenthesis for a function, open a small window with
    function parameter hints. See [Calltips](idle.md#calltips) in the
...
Run Module
:   Do [Check Module](idle.md#check-module). If no error, restart the shell to clean the
...
Run… Customized
:   Same as [Run Module](idle.md#run-module), but run the module with customized
    settings. *Command Line Arguments* extend [`sys.argv`](sys.md#sys.argv "sys.argv") as if passed
...
:   Open a configuration dialog and change preferences for the following:
    ...
    [Setting preferences](idle.md#preferences) under Help and preferences.
...
:   Open a pane at the top of the edit window which shows the block context
    ...
    [Code Context](idle.md#code-context) in the Editing and Navigation section
    below.
...
:   Open a column to the left of the edit window which shows the number
    ...
    preferences (see [Setting preferences](idle.md#preferences)).
...
the General tab. See the [Help sources](idle.md#help-sources) subsection below
...
[Format menu](idle.md#format-menu).
...
For filenames in the root directory, type [`os.sep`](os.md#os.sep "os.sep") or
[`os.altsep`](os.md#os.altsep "os.altsep") immediately after an opening quote. (On Windows,
...
[`SyntaxError`](exceptions.md#SyntaxError "SyntaxError") when multiple statements are compiled as if they were one.
...
IDLE also highlights the [soft keywords](https://docs.python.org/3.10/reference/lexical_analysis.html#soft-keywords) [`match`](https://docs.python.org/3.10/reference/compound_stmts.html#match),
[`case`](https://docs.python.org/3.10/reference/compound_stmts.html#match), and [`_`](https://docs.python.org/3.10/reference/compound_stmts.html#wildcard-patterns) in
...
the environment variables `IDLESTARTUP` or [`PYTHONSTARTUP`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONSTARTUP).
...
and [`str.join()`](stdtypes.md#str.join "str.join") can help combine fields and lines.
...
sense that feature changes can be backported (see [**PEP 434**](https://www.python.org/dev/peps/pep-0434)).
