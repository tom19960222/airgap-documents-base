...
source_url: https://docs.python.org/3.10/library/inspect.html
fetched_at: 2026-09-17T15:15:01+00:00
---
# `inspect` — Inspect live objects

**Source code:** [Lib/inspect.py](https://github.com/python/cpython/tree/3.10/Lib/inspect.py)

---

The [`inspect`](inspect.md#module-inspect "inspect: Extract information and source code from live objects.") module provides several useful functions to help get
...
The [`getmembers()`](inspect.md#inspect.getmembers "inspect.getmembers") function retrieves the members of an object such as a
class or module. The functions whose names begin with “is” are mainly
provided as convenient choices for the second argument to [`getmembers()`](inspect.md#inspect.getmembers "inspect.getmembers").
...
|  | __qualname__ | qualified name |
|  | __code__ | code object containing compiled function [bytecode](https://docs.python.org/3.10/glossary.html#term-bytecode) |
...
|  | co_flags | bitmap of `CO_*` flags, read more [here](inspect.md#inspect-module-co-flags) |
...
|  | cr_code | code |
|  | cr_origin | where coroutine was created, or `None`. See [`sys.set_coroutine_origin_tracking_depth()`](sys.md#sys.set_coroutine_origin_tracking_depth "sys.set_coroutine_origin_tracking_depth") |
...
:   Return all the members of an object in a list of `(name, value)`
    ...
    > **Note:**
    >
    > [`getmembers()`](inspect.md#inspect.getmembers "inspect.getmembers") will only return class attributes defined in the
...
:   Return `True` if the object is a Python function, which includes functions
    created by a [lambda](https://docs.python.org/3.10/glossary.html#term-lambda) expression.
...
:   Return `True` if the object is a [coroutine function](https://docs.python.org/3.10/glossary.html#term-coroutine-function)
    (a function defined with an [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def) syntax).

    New in version 3.5.

    Changed in version 3.8: Functions wrapped in [`functools.partial()`](functools.md#functools.partial "functools.partial") now return `True` if the
    wrapped function is a [coroutine function](https://docs.python.org/3.10/glossary.html#term-coroutine-function).

`inspect.iscoroutine(object)`
:   Return `True` if the object is a [coroutine](https://docs.python.org/3.10/glossary.html#term-coroutine) created by an
    [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def) function.

    New in version 3.5.

`inspect.isawaitable(object)`
:   Return `True` if the object can be used in [`await`](https://docs.python.org/3.10/reference/expressions.html#await) expression.
...
:   Return `True` if the object is an [asynchronous generator](https://docs.python.org/3.10/glossary.html#term-asynchronous-generator) function,
    for example:
    ...
    Changed in version 3.8: Functions wrapped in [`functools.partial()`](functools.md#functools.partial "functools.partial") now return `True` if the
    wrapped function is a [asynchronous generator](https://docs.python.org/3.10/glossary.html#term-asynchronous-generator) function.

`inspect.isasyncgen(object)`
:   Return `True` if the object is an [asynchronous generator iterator](https://docs.python.org/3.10/glossary.html#term-asynchronous-generator-iterator)
    created by an [asynchronous generator](https://docs.python.org/3.10/glossary.html#term-asynchronous-generator) function.
...
:   Return `True` if the object is a method descriptor, but not if
    ...
    has a [`__get__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__get__ "object.__get__") method but not a [`__set__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__set__ "object.__set__")
    method, but beyond that the set of attributes varies. A
    [`__name__`](stdtypes.md#definition.__name__ "definition.__name__") attribute is usually
    sensible, and `__doc__` often is.

    Methods implemented via descriptors that also pass one of the other tests
    return `False` from the [`ismethoddescriptor()`](inspect.md#inspect.ismethoddescriptor "inspect.ismethoddescriptor") test, simply because the
    other tests promise more – you can, e.g., count on having the
    `__func__` attribute (etc) when an object passes [`ismethod()`](inspect.md#inspect.ismethod "inspect.ismethod").

`inspect.isdatadescriptor(object)`
:   Return `True` if the object is a data descriptor.

    Data descriptors have a [`__set__`](https://docs.python.org/3.10/reference/datamodel.html#object.__set__ "object.__set__") or a [`__delete__`](https://docs.python.org/3.10/reference/datamodel.html#object.__delete__ "object.__delete__") method.
    Examples are properties (defined in Python), getsets, and members. The
    latter two are defined in C and there are more specific tests available for
    those types, which is robust across Python implementations. Typically, data
    descriptors will also have [`__name__`](stdtypes.md#definition.__name__ "definition.__name__") and `__doc__` attributes
...
:   Return `True` if the object is a getset descriptor.
    ...
    **CPython implementation detail:** getsets are attributes defined in extension modules via
    [`PyGetSetDef`](https://docs.python.org/3.10/c-api/structures.html#c.PyGetSetDef "PyGetSetDef") structures. For Python implementations without such
...
:   Return `True` if the object is a member descriptor.
    ...
    **CPython implementation detail:** Member descriptors are attributes defined in extension modules via
    [`PyMemberDef`](https://docs.python.org/3.10/c-api/structures.html#c.PyMemberDef "PyMemberDef") structures. For Python implementations without such
    types, this method will always return `False`.
...
:   Return a list of source lines and starting line number for an object. The
    ...
    line of code was found. An [`OSError`](exceptions.md#OSError "OSError") is raised if the source code cannot
    be retrieved.
    A [`TypeError`](exceptions.md#TypeError "TypeError") is raised if the object is a built-in module, class, or
    function.
...
return annotation. To retrieve a Signature object, use the [`signature()`](inspect.md#inspect.signature "inspect.signature")
function.
...
:   Return a [`Signature`](inspect.md#inspect.Signature "inspect.Signature") object for the given `callable`:
    ...
    [`functools.partial()`](functools.md#functools.partial "functools.partial") objects.

    For objects defined in modules using stringized annotations
    (`from __future__ import annotations`), [`signature()`](inspect.md#inspect.signature "inspect.signature") will
    attempt to automatically un-stringize the annotations using
    [`inspect.get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations"). The
    `global`, `locals`, and `eval_str` parameters are passed
    into [`inspect.get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations") when resolving the
    annotations; see the documentation for [`inspect.get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations")
    for instructions on how to use these parameters.

    Raises [`ValueError`](exceptions.md#ValueError "ValueError") if no signature can be provided, and
    [`TypeError`](exceptions.md#TypeError "TypeError") if that type of object is not supported. Also,
...
:   A Signature object represents the call signature of a function and its return
    ...
    [`Parameter`](inspect.md#inspect.Parameter "inspect.Parameter") object in its [`parameters`](inspect.md#inspect.Signature.parameters "inspect.Signature.parameters") collection.

    The optional *parameters* argument is a sequence of [`Parameter`](inspect.md#inspect.Parameter "inspect.Parameter")
    ...
    Signature objects are *immutable*. Use [`Signature.replace()`](inspect.md#inspect.Signature.replace "inspect.Signature.replace") to make a
    modified copy.

    Changed in version 3.5: Signature objects are picklable and [hashable](https://docs.python.org/3.10/glossary.html#term-hashable).
    ...
    :   Create a new Signature instance based on the instance replace was invoked
        ...
        [`Signature.empty`](inspect.md#inspect.Signature.empty "inspect.Signature.empty").
    ...
    :   Return a [`Signature`](inspect.md#inspect.Signature "inspect.Signature") (or its subclass) object for a given callable
        ...
        This method simplifies subclassing of [`Signature`](inspect.md#inspect.Signature "inspect.Signature"):
...
:   Parameter objects are *immutable*. Instead of modifying a Parameter object,
    ...
    Changed in version 3.5: Parameter objects are picklable and [hashable](https://docs.python.org/3.10/glossary.html#term-hashable).
    ...
    :   Create a new Parameter instance based on the instance replaced was invoked
        on. To override a [`Parameter`](inspect.md#inspect.Parameter "inspect.Parameter") attribute, pass the corresponding
        argument. To remove a default value or/and an annotation from a
        Parameter, pass [`Parameter.empty`](inspect.md#inspect.Parameter.empty "inspect.Parameter.empty").
...
:   Result of a [`Signature.bind()`](inspect.md#inspect.Signature.bind "inspect.Signature.bind") or [`Signature.bind_partial()`](inspect.md#inspect.Signature.bind_partial "inspect.Signature.bind_partial") call.
    ...
    :   A mutable mapping of parameters’ names to arguments’ values.
        ...
        Should be used in conjunction with [`Signature.parameters`](inspect.md#inspect.Signature.parameters "inspect.Signature.parameters") for any
        argument processing purposes.

        > **Note:**
        >
        > Arguments for which [`Signature.bind()`](inspect.md#inspect.Signature.bind "inspect.Signature.bind") or
        > [`Signature.bind_partial()`](inspect.md#inspect.Signature.bind_partial "inspect.Signature.bind_partial") relied on a default value are skipped.
        > However, if needed, use [`BoundArguments.apply_defaults()`](inspect.md#inspect.BoundArguments.apply_defaults "inspect.BoundArguments.apply_defaults") to add
        > them.
    ...
    The [`args`](inspect.md#inspect.BoundArguments.args "inspect.BoundArguments.args") and [`kwargs`](inspect.md#inspect.BoundArguments.kwargs "inspect.BoundArguments.kwargs") properties can be used to invoke
    functions:
...
> **See also:**
>
> [**PEP 362**](https://www.python.org/dev/peps/pep-0362) - Function Signature Object.
...
:   Get the names and default values of a Python function’s parameters. A
    [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) `ArgSpec(args, varargs, keywords, defaults)` is
    ...
    *n* elements listed in *args*.
    ...
    Deprecated since version 3.0: Use [`getfullargspec()`](inspect.md#inspect.getfullargspec "inspect.getfullargspec") for an updated API that is usually a drop-in
    replacement, but also correctly handles function annotations and
    keyword-only parameters.

    Alternatively, use [`signature()`](inspect.md#inspect.signature "inspect.signature") and
    [Signature Object](inspect.md#inspect-signature-object), which provide a
    more structured introspection API for callables.

`inspect.getfullargspec(func)`
:   Get the names and default values of a Python function’s parameters. A
    [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) is returned:
    ...
    *annotations* is a dictionary mapping parameter names to annotations.
    ...
    Note that [`signature()`](inspect.md#inspect.signature "inspect.signature") and
    [Signature Object](inspect.md#inspect-signature-object) provide the recommended
    ...
    Changed in version 3.4: This function is now based on [`signature()`](inspect.md#inspect.signature "inspect.signature"), but still ignores
    `__wrapped__` attributes and includes the already bound first
    parameter in the signature output for bound methods.

    Changed in version 3.6: This method was previously documented as deprecated in favour of
    [`signature()`](inspect.md#inspect.signature "inspect.signature") in Python 3.5, but that decision has been reversed
    in order to restore a clearly supported standard interface for
    single-source Python 2/3 code migrating away from the legacy
    [`getargspec()`](inspect.md#inspect.getargspec "inspect.getargspec") API.
...
:   Get information about arguments passed into a particular frame. A
    [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) `ArgInfo(args, varargs, keywords, locals)` is
...
:   Format a pretty argument spec from the values returned by
    [`getfullargspec()`](inspect.md#inspect.getfullargspec "inspect.getfullargspec").
    ...
    Deprecated since version 3.5: Use [`signature()`](inspect.md#inspect.signature "inspect.signature") and
    [Signature Object](inspect.md#inspect-signature-object), which provide a
...
:   Get the mapping of external name references in a Python function or
    ...
    [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) `ClosureVars(nonlocals, globals, builtins, unbound)`
    ...
    [`TypeError`](exceptions.md#TypeError "TypeError") is raised if *func* is not a Python function or method.
...
:   Get the object wrapped by *func*. It follows the chain of `__wrapped__`
    ...
    *stop* is an optional callback accepting an object in the wrapper chain
    ...
    [`signature()`](inspect.md#inspect.signature "inspect.signature") uses this to stop unwrapping if any object in the
    chain has a `__signature__` attribute defined.

    [`ValueError`](exceptions.md#ValueError "ValueError") is raised if a cycle is encountered.
...
:   Compute the annotations dict for an object.
    ...
    Passing in an object of any other type raises [`TypeError`](exceptions.md#TypeError "TypeError").
    ...
    - If `eval_str` is true, values of type `str` will
      be un-stringized using [`eval()`](functions.md#eval "eval"). This is intended
    ...
    with the result of calling [`eval()`](functions.md#eval "eval") on those values:

    - If eval_str is true, [`eval()`](functions.md#eval "eval") is called on values of type `str`.
      (Note that `get_annotations` doesn’t catch exceptions; if [`eval()`](functions.md#eval "eval")
      raises an exception, it will unwind the stack past the `get_annotations`
      call.)
    - If eval_str is false (the default), values of type `str` are unchanged.

    `globals` and `locals` are passed in to [`eval()`](functions.md#eval "eval"); see the documentation
    for [`eval()`](functions.md#eval "eval") for more information. If `globals` or `locals`
    ...
    annotations dict of any object. See [Annotations Best Practices](https://docs.python.org/3.10/howto/annotations.html#annotations-howto) for
...
[named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple)
...
> [`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) clause. This is also important if the cycle detector was
> disabled when Python was compiled or using [`gc.disable()`](gc.md#gc.disable "gc.disable"). For example:
>
> ```python3
...
> [`frame.clear()`](https://docs.python.org/3.10/reference/datamodel.html#frame.clear "frame.clear") method.
...
:   Get information about a frame or traceback object. A [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple)
...
:   Get a list of frame records for a frame and all outer frames. These frames
    ...
    Changed in version 3.5: A list of [named tuples](https://docs.python.org/3.10/glossary.html#term-named-tuple)
    `FrameInfo(frame, filename, lineno, function, code_context, index)`
    is returned.
...
Both [`getattr()`](functions.md#getattr "getattr") and [`hasattr()`](functions.md#hasattr "hasattr") can trigger code execution when
...
:   Retrieve attributes without triggering dynamic lookup via the
    ...
    If the instance [`__dict__`](stdtypes.md#object.__dict__ "object.__dict__") is shadowed by another member (for
    example a property) then this function will be unable to find instance
    members.

    New in version 3.2.

[`getattr_static()`](inspect.md#inspect.getattr_static "inspect.getattr_static") does not resolve descriptors, for example slot descriptors or
...
:   Get current state of a coroutine object. The function is intended to be
    used with coroutine objects created by [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def) functions, but
...
:   Get the mapping of live local variables in *generator* to their current
    ...
    If *generator* is a [generator](https://docs.python.org/3.10/glossary.html#term-generator) with no currently associated frame,
    then an empty dictionary is returned. [`TypeError`](exceptions.md#TypeError "TypeError") is raised if
...
:   This function is analogous to [`getgeneratorlocals()`](inspect.md#inspect.getgeneratorlocals "inspect.getgeneratorlocals"), but
    works for coroutine objects created by [`async def`](https://docs.python.org/3.10/reference/compound_stmts.html#async-def) functions.
...
:   The flag is set when the code object is a coroutine function.
    ...
    See [**PEP 492**](https://www.python.org/dev/peps/pep-0492) for more details.
...
:   The flag is set when the code object is an asynchronous generator
    ...
    asynchronous generator object. See [**PEP 525**](https://www.python.org/dev/peps/pep-0525) for more details.
...
> It’s recommended to use public APIs from the [`inspect`](inspect.md#module-inspect "inspect: Extract information and source code from live objects.") module
> for any introspection needs.

## Command Line Interface

The [`inspect`](inspect.md#module-inspect "inspect: Extract information and source code from live objects.") module also provides a basic introspection capability
