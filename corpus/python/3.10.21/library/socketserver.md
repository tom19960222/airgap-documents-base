...
source_url: https://docs.python.org/3.10/library/socketserver.html
fetched_at: 2026-09-17T15:14:32+00:00
---
# `socketserver` — A framework for network servers

**Source code:** [Lib/socketserver.py](https://github.com/python/cpython/tree/3.10/Lib/socketserver.py)
...
the server in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. Then call the
...
[`asyncore`](asyncore.md#module-asyncore "asyncore: A base class for developing asynchronous socket handling services. (deprecated)") for another way to manage this.
...
:   This is the superclass of all Server objects in the module. It defines the
    ...
    :   The family of protocols to which the server’s socket belongs.
        Common examples are [`socket.AF_INET`](socket.md#socket.AF_INET "socket.AF_INET") and [`socket.AF_UNIX`](socket.md#socket.AF_UNIX "socket.AF_UNIX").
    ...
    Changed in version 3.6: Support for the [context manager](https://docs.python.org/3.10/glossary.html#term-context-manager) protocol was added. Exiting the
...
:   These [`BaseRequestHandler`](socketserver.md#socketserver.BaseRequestHandler "socketserver.BaseRequestHandler") subclasses override the
    ...
    to the client.
    The `rfile` attributes support the [`io.BufferedIOBase`](io.md#io.BufferedIOBase "io.BufferedIOBase") readable interface,
    and `wfile` attributes support the `io.BufferedIOBase` writable interface.
