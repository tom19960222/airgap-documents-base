...
version: "3.10.21"
title: "Policies"
source_url: https://docs.python.org/3.10/library/asyncio-policy.html
...
:   The default asyncio policy. Uses [`SelectorEventLoop`](asyncio-eventloop.md#asyncio.SelectorEventLoop "asyncio.SelectorEventLoop")
    ...
    > **Note:**
    >
    > In Python versions 3.10.9, 3.11.1 and 3.12 the [`get_event_loop()`](asyncio-eventloop.md#asyncio.get_event_loop "asyncio.get_event_loop")
    > method of the default asyncio policy emits a [`DeprecationWarning`](exceptions.md#DeprecationWarning "DeprecationWarning")
