...
source_url: https://docs.python.org/3.10/library/unittest.html
fetched_at: 2026-09-17T15:14:47+00:00
---
# `unittest` — Unit testing framework

**Source code:** [Lib/unittest/__init__.py](https://github.com/python/cpython/tree/3.10/Lib/unittest/__init__.py)
...
> [Buildbot](https://buildbot.net/), [Jenkins](https://jenkins.io/)
> or [Travis-CI](https://travis-ci.com), or [AppVeyor](https://www.appveyor.com/).
...
[`assert`](https://docs.python.org/3.10/reference/simple_stmts.html#assert) statement so the test runner can accumulate all test results
...
discovery, all of the test files must be [modules](https://docs.python.org/3.10/tutorial/modules.html#tut-modules) or
[packages](https://docs.python.org/3.10/tutorial/modules.html#tut-packages) (including [namespace packages](https://docs.python.org/3.10/glossary.html#term-namespace-package)) importable from the top-level directory of
the project (this means that their filenames must be valid [identifiers](https://docs.python.org/3.10/reference/lexical_analysis.html#identifiers)).
...
the [load_tests protocol](unittest.md#load-tests-protocol).

Changed in version 3.4: Test discovery supports [namespace packages](https://docs.python.org/3.10/glossary.html#term-namespace-package)
...
methods provided by the [`TestCase`](unittest.md#unittest.TestCase "unittest.TestCase") base class. If the test fails, an
...
Skipping a test is simply a matter of using the [`skip()`](unittest.md#unittest.skip "unittest.skip") [decorator](https://docs.python.org/3.10/glossary.html#term-decorator)
...
:   Instances of the [`TestCase`](unittest.md#unittest.TestCase "unittest.TestCase") class represent the logical test units
    ...
    *methodName*. This makes it easier to experiment with [`TestCase`](unittest.md#unittest.TestCase "unittest.TestCase")
    ...
    :   Test that a *regex* search matches (or does not match) *text*. In case
        ...
        New in version 3.2: [`assertNotRegex()`](unittest.md#unittest.TestCase.assertNotRegex "unittest.TestCase.assertNotRegex").

        New in version 3.5: The name `assertNotRegexpMatches` is a deprecated alias
        for [`assertNotRegex()`](unittest.md#unittest.TestCase.assertNotRegex "unittest.TestCase.assertNotRegex").
...
For historical reasons, some of the [`TestCase`](unittest.md#unittest.TestCase "unittest.TestCase") methods had one or more
aliases that are now deprecated. The following table lists the correct names
along with their deprecated aliases:

> | Method Name | Deprecated alias | Deprecated alias |
> | --- | --- | --- |
> | [`assertEqual()`](unittest.md#unittest.TestCase.assertEqual "unittest.TestCase.assertEqual") | failUnlessEqual | assertEquals |
> | [`assertNotEqual()`](unittest.md#unittest.TestCase.assertNotEqual "unittest.TestCase.assertNotEqual") | failIfEqual | assertNotEquals |
> | [`assertTrue()`](unittest.md#unittest.TestCase.assertTrue "unittest.TestCase.assertTrue") | failUnless | assert_ |
> | [`assertFalse()`](unittest.md#unittest.TestCase.assertFalse "unittest.TestCase.assertFalse") | failIf |  |
> | [`assertRaises()`](unittest.md#unittest.TestCase.assertRaises "unittest.TestCase.assertRaises") | failUnlessRaises |  |
> | [`assertAlmostEqual()`](unittest.md#unittest.TestCase.assertAlmostEqual "unittest.TestCase.assertAlmostEqual") | failUnlessAlmostEqual | assertAlmostEquals |
> | [`assertNotAlmostEqual()`](unittest.md#unittest.TestCase.assertNotAlmostEqual "unittest.TestCase.assertNotAlmostEqual") | failIfAlmostEqual | assertNotAlmostEquals |
> | [`assertRegex()`](unittest.md#unittest.TestCase.assertRegex "unittest.TestCase.assertRegex") |  | assertRegexpMatches |
> | [`assertNotRegex()`](unittest.md#unittest.TestCase.assertNotRegex "unittest.TestCase.assertNotRegex") |  | assertNotRegexpMatches |
> | [`assertRaisesRegex()`](unittest.md#unittest.TestCase.assertRaisesRegex "unittest.TestCase.assertRaisesRegex") |  | assertRaisesRegexp |
>
...
> [`assertRegex()`](unittest.md#unittest.TestCase.assertRegex "unittest.TestCase.assertRegex") and [`assertRaisesRegex()`](unittest.md#unittest.TestCase.assertRaisesRegex "unittest.TestCase.assertRaisesRegex").
>
> Deprecated since version 3.5: The `assertNotRegexpMatches` name is deprecated in favor of [`assertNotRegex()`](unittest.md#unittest.TestCase.assertNotRegex "unittest.TestCase.assertNotRegex").
...
:   This class represents an aggregation of individual test cases and test suites.
    ...
    :   Tests grouped by a [`TestSuite`](unittest.md#unittest.TestSuite "unittest.TestSuite") are always accessed by iteration.
        Subclasses can lazily provide tests by overriding [`__iter__()`](unittest.md#unittest.TestSuite.__iter__ "unittest.TestSuite.__iter__"). Note
        ...
        than through iteration, so overriding [`__iter__()`](unittest.md#unittest.TestSuite.__iter__ "unittest.TestSuite.__iter__") wasn’t sufficient
        for providing tests.
...
:   The [`TestLoader`](unittest.md#unittest.TestLoader "unittest.TestLoader") class is used to create test suites from classes and
    ...
    :   Return a suite of all test cases contained in the given module. This
        ...
        This is the [load_tests protocol](unittest.md#load-tests-protocol). The *pattern* argument is passed as
    ...
    :   Find all the test modules by recursing into subdirectories from the
        ...
        *start_dir* can be a dotted module name as well as a directory.
        ...
        Changed in version 3.4: *start_dir* can be a [namespace packages](https://docs.python.org/3.10/glossary.html#term-namespace-package).
...
:   A concrete implementation of [`TestResult`](unittest.md#unittest.TestResult "unittest.TestResult") used by the
    [`TextTestRunner`](unittest.md#unittest.TextTestRunner "unittest.TextTestRunner").
...
:   A basic test runner implementation that outputs results to a stream. If *stream*
    ...
    [`ImportWarning`](exceptions.md#ImportWarning "ImportWarning") even if they are [ignored by default](warnings.md#warning-ignored). Deprecation warnings caused by [deprecated unittest
    methods](unittest.md#deprecated-aliases) are also special-cased and, when the warning
    filters are `'default'` or `'always'`, they will appear only once
    per-module, in order to avoid too many warning messages. This behavior can
    be overridden using Python’s `-Wd` or `-Wa` options
    (see [Warning control](https://docs.python.org/3.10/using/cmdline.html#using-on-warnings)) and leaving
    *warnings* to `None`.
...
:   A command-line program that loads a set of tests from *module* and runs them;
    ...
    (see [Warning control](https://docs.python.org/3.10/using/cmdline.html#using-on-warnings)),
