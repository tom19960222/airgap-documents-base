...
source_url: https://docs.python.org/3.10/library/tkinter.html
fetched_at: 2026-09-17T15:14:40+00:00
---
# `tkinter` — Python interface to Tcl/Tk

**Source code:** [Lib/tkinter/__init__.py](https://github.com/python/cpython/tree/3.10/Lib/tkinter/__init__.py)

---

The [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") package (“Tk interface”) is the standard Python interface to
the Tcl/Tk GUI toolkit. Both Tk and [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") are available on most Unix
platforms, including macOS, as well as on Windows systems.

Running `python -m tkinter` from the command line should open a window
demonstrating a simple Tk interface, letting you know that [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") is
...
:   Tcl is a dynamic interpreted programming language, just like Python. Though
    ...
    (see [Threading model](tkinter.md#threading-model) for details).
...
:   Tk is a [Tcl package](https://wiki.tcl-lang.org/37432) implemented in C
    ...
    [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") object embeds its own Tcl interpreter instance with Tk loaded into
...
:   Themed Tk (Ttk) is a newer family of Tk widgets that provide a much better
    ...
    bindings are provided in a separate module, [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set").
...
the [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") module first assembles a Tcl/Tk command string. It passes that
...
main [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") module, as well as the [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set") module, which provides
...
:   Construct a toplevel Tk widget, which is usually the main window of an
    ...
    The [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") class is typically instantiated using all default values.
    ...
    *useTk*
    :   If `True`, initialize the Tk subsystem. The [`tkinter.Tcl()`](tkinter.md#tkinter.Tcl "tkinter.Tcl")
    ...
    *use*
    ...
    [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") reads and interprets profile files, named
    `.className.tcl` and `.baseName.tcl`, into the Tcl
    interpreter and calls [`exec()`](functions.md#exec "exec") on the contents of
    ...
    :   The widget object that contains this widget. For [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk"), the
        ...
        *master* and *parent* are similar and sometimes used interchangeably
        ...
        string of the widget name whereas [`master`](tkinter.md#tkinter.Tk.master "tkinter.Tk.master") returns the object.
...
:   The [`Tcl()`](tkinter.md#tkinter.Tcl "tkinter.Tcl") function is a factory function which creates an object much like
    ...
    created by the [`Tcl()`](tkinter.md#tkinter.Tcl "tkinter.Tcl") object can have a Toplevel window created (and the Tk
    subsystem initialized) by calling its `loadtk()` method.

The modules that provide Tk support include:

[`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces")
:   Main Tkinter module.
...
:   Themed widget set introduced in Tk 8.5, providing modern alternatives
    for many of the classic widgets in the main [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") module.

Additional modules:

`_tkinter`
:   A binary module that contains the low-level interface to Tcl/Tk.
    It is automatically imported by the main [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") module,
...
:   Python’s Integrated Development and Learning Environment (IDLE). Based
    on [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces").
...
:   Symbolic constants that can be used in place of strings when passing
    ...
    main [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") module.

[`tkinter.dnd`](tkinter.dnd.md#module-tkinter.dnd "tkinter.dnd: Tkinter drag-and-drop interface (Tk)")
:   (experimental) Drag-and-drop support for [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces"). This will
    become deprecated when it is replaced with the Tk DND.

[`tkinter.tix`](tkinter.tix.md#module-tkinter.tix "tkinter.tix: Tk Extension Widgets for Tkinter")
:   (deprecated) An older third-party Tcl/Tk package that adds several new
    widgets. Better alternatives for most can be found in [`tkinter.ttk`](tkinter.ttk.md#module-tkinter.ttk "tkinter.ttk: Tk themed widget set").
...
After the imports, the next line creates an instance of the [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") class,
...
commands in the Tcl interpreter attached to your applicaton’s [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk")
instance.
...
interactive Python shell or with [`print()`](functions.md#print "print"), can help you identify what
you need.
...
standard [`dir()`](functions.md#dir "dir") function. If you try it, you’ll see there are over 200
...
Python and Tcl/Tk have very different threading models, which [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces")
...
Each [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") object created by [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") contains a Tcl interpreter.
It also keeps track of which thread created that interpreter. Calls to
[`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") can be made from any Python thread. Internally, if a call comes
from a thread other than the one that created the [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") object, an event
...
[`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") calls made from threads other than the one running the Tcl
interpreter will fail.

A number of special cases exist:

> - Tcl/Tk libraries can be built so they are not thread-aware. In this case,
>   [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") calls the library from the originating Python thread, even
...
> - While [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") allows you to create more than one instance of a [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk")
...
>   more than one instance of [`Tk`](tkinter.md#tkinter.Tk "tkinter.Tk") at a time. Otherwise, it’s best to create
...
> - There are a few select [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") functions that presently work only when
...
Unfortunately, in the current implementation of [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") it is not
possible to hand over an arbitrary Python variable to a widget through a
`variable` or `textvariable` option. The only kinds of variables for which
this works are variables that are subclassed from a class called Variable,
defined in [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces").
...
placement, icon bitmaps, and the like. In [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces"), these commands have
...
:   Entry widgets have options that refer to character positions in the text being
    displayed. You can use these [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") functions to access these special
...
want to use the [`BufferedIOBase`](io.md#io.BufferedIOBase "io.BufferedIOBase") or [`TextIOBase`](io.md#io.TextIOBase "io.TextIOBase")
[`read()`](io.md#io.BufferedIOBase.read "io.BufferedIOBase.read") or [`readline()`](io.md#io.IOBase.readline "io.IOBase.readline") methods,
since these will insist on reading a predefined number of bytes.
For sockets, the [`recv()`](socket.md#socket.socket.recv "socket.socket.recv") or
