...
source_url: https://docs.python.org/3.10/library/contextlib.html
fetched_at: 2026-09-17T15:14:59+00:00
---
# `contextlib` — Utilities for `with`-statement contexts

**Source code:** [Lib/contextlib.py](https://github.com/python/cpython/tree/3.10/Lib/contextlib.py)

---

This module provides utilities for common tasks involving the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
statement. For more information see also [Context Manager Types](stdtypes.md#typecontextmanager) and
[With Statement Context Managers](https://docs.python.org/3.10/reference/datamodel.html#context-managers).
...
:   An [abstract base class](https://docs.python.org/3.10/glossary.html#term-abstract-base-class) for classes that implement
    [`object.__enter__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__enter__ "object.__enter__") and [`object.__exit__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__exit__ "object.__exit__"). A default
    implementation for [`object.__enter__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__enter__ "object.__enter__") is provided which returns
    `self` while [`object.__exit__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__exit__ "object.__exit__") is an abstract method which by default
...
:   An [abstract base class](https://docs.python.org/3.10/glossary.html#term-abstract-base-class) for classes that implement
    [`object.__aenter__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__aenter__ "object.__aenter__") and [`object.__aexit__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__aexit__ "object.__aexit__"). A default
    implementation for [`object.__aenter__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__aenter__ "object.__aenter__") is provided which returns
    `self` while [`object.__aexit__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__aexit__ "object.__aexit__") is an abstract method which by default
    returns `None`. See also the definition of
    [Asynchronous Context Managers](https://docs.python.org/3.10/reference/datamodel.html#async-context-managers).

    New in version 3.7.

`@contextlib.contextmanager`
:   This function is a [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) that can be used to define a factory
    function for [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement context managers, without needing to
    ...
    The function being decorated must return a [generator](https://docs.python.org/3.10/glossary.html#term-generator)-iterator when
    called. This iterator must yield exactly one value, which will be bound to
    the targets in the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement’s `as` clause, if any.

    At the point where the generator yields, the block nested in the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
    statement is executed. The generator is then resumed after the block is exited.
    If an unhandled exception occurs in the block, it is reraised inside the
    generator at the point where the yield occurred. Thus, you can use a
    [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try)…[`except`](https://docs.python.org/3.10/reference/compound_stmts.html#except)…[`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) statement to trap
    ...
    it creates can be used as decorators as well as in [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statements.
...
:   > Similar to [`contextmanager()`](contextlib.md#contextlib.contextmanager "contextlib.contextmanager"), but creates an
    > [asynchronous context manager](https://docs.python.org/3.10/reference/datamodel.html#async-context-managers).
    >
    > This function is a [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) that can be used to define a factory
    > function for [`async with`](https://docs.python.org/3.10/reference/compound_stmts.html#async-with) statement asynchronous context managers,
    > without needing to create a class or separate `__aenter__()` and
    > `__aexit__()` methods. It must be applied to an [asynchronous
    > generator](https://docs.python.org/3.10/glossary.html#term-asynchronous-generator) function.
    >
    > A simple example:
    >
    > ```python3
    ...
    > either as decorators or with [`async with`](https://docs.python.org/3.10/reference/compound_stmts.html#async-with) statements:
    >
    > ```python3
    > import time
    > from contextlib import asynccontextmanager
...
:   Return a context manager that closes *thing* upon completion of the block. This
    ...
    `page.close()` will be called when the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) block is exited.
...
:   Return an async context manager that calls the `aclose()` method of *thing*
    ...
    generators when they happen to exit early by [`break`](https://docs.python.org/3.10/reference/simple_stmts.html#break) or an
...
:   Return a context manager that returns *enter_result* from `__enter__`, but
    ...
    Changed in version 3.10: [asynchronous context manager](https://docs.python.org/3.10/glossary.html#term-asynchronous-context-manager) support was added.
...
:   A base class that enables a context manager to also be used as a decorator.
    ...
    > underlying context manager must support use in multiple [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
...
:   A context manager that is designed to make it easy to programmatically
    ...
    The `__enter__()` method returns the [`ExitStack`](contextlib.md#contextlib.ExitStack "contextlib.ExitStack") instance, and
    performs no additional operations.

    Each instance maintains a stack of registered callbacks that are called in
    reverse order when the instance is closed (either explicitly or implicitly
    at the end of a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement). Note that callbacks are *not*
    ...
    registration, this ends up behaving as if multiple nested [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
    ...
    :   Enters a new context manager and adds its `__exit__()` method to
        ...
        would if used directly as part of a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement.
    ...
    :   Transfers the callback stack to a fresh [`ExitStack`](contextlib.md#contextlib.ExitStack "contextlib.ExitStack") instance
        ...
        explicitly or implicitly at the end of a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement).
...
:   An [asynchronous context manager](https://docs.python.org/3.10/reference/datamodel.html#async-context-managers), similar
    ...
    The `close()` method is not implemented, [`aclose()`](contextlib.md#contextlib.AsyncExitStack.aclose "contextlib.AsyncExitStack.aclose") must be used
    instead.
...
cleanup operations in a single [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. The variability
...
As shown, [`ExitStack`](contextlib.md#contextlib.ExitStack "contextlib.ExitStack") also makes it quite easy to use [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
...
the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement body or the context manager’s `__exit__`
...
[`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try)/[`except`](https://docs.python.org/3.10/reference/compound_stmts.html#except)/[`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) statements, but not
...
> :   The specification, background, and examples for the Python [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
>     statement.

## Single use, reusable and reentrant context managers

Most context managers are written in a way that means they can only be
used effectively in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement once. These single use
context managers must be created afresh each time they’re used -
attempting to use them a second time will trigger an exception or
otherwise not work correctly.

This common limitation means that it is generally advisable to create
context managers directly in the header of the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement
where they are used (as shown in all of the usage examples above).

Files are an example of effectively single use context managers, since
the first [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement will close the file, preventing any
...
managers can not only be used in multiple [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statements,
...
[`suppress()`](contextlib.md#contextlib.suppress "contextlib.suppress") and [`redirect_stdout()`](contextlib.md#contextlib.redirect_stdout "contextlib.redirect_stdout"). Here’s a very simple example of
reentrant use:
