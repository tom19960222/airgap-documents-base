...
source_url: https://docs.python.org/3.10/library/platform.html
fetched_at: 2026-09-17T15:14:05+00:00
---
...
:   Fairly portable uname interface. Returns a [`namedtuple()`](collections.md#collections.namedtuple "collections.namedtuple")
    ...
    Note that this adds a sixth attribute ([`processor`](platform.md#platform.processor "platform.processor")) not present
    in the [`os.uname()`](os.md#os.uname "os.uname") result. Also, the attribute names are different
    for the first two attributes; [`os.uname()`](os.md#os.uname "os.uname") names them
