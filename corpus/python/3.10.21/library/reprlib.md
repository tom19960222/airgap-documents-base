...
source_url: https://docs.python.org/3.10/library/reprlib.html
fetched_at: 2026-09-17T15:13:37+00:00
---
# `reprlib` — Alternate [`repr()`](functions.md#repr "repr") implementation

**Source code:** [Lib/reprlib.py](https://github.com/python/cpython/tree/3.10/Lib/reprlib.py)

---

The [`reprlib`](reprlib.md#module-reprlib "reprlib: Alternate repr() implementation with size limits.") module provides a means for producing object representations
