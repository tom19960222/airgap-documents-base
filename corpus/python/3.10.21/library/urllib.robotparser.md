...
source_url: https://docs.python.org/3.10/library/urllib.robotparser.html
fetched_at: 2026-09-17T15:14:28+00:00
---
# `urllib.robotparser` — Parser for robots.txt

**Source code:** [Lib/urllib/robotparser.py](https://github.com/python/cpython/tree/3.10/Lib/urllib/robotparser.py)
...
:   This class provides methods to read, parse and answer questions about the
    ...
    :   Returns the contents of the `Request-rate` parameter from
        `robots.txt` as a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple) `RequestRate(requests, seconds)`.
