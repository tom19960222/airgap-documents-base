...
source_url: https://docs.python.org/3.10/library/xdrlib.html
fetched_at: 2026-09-17T15:15:27+00:00
---
# `xdrlib` — Encode and decode XDR data

**Source code:** [Lib/xdrlib.py](https://github.com/python/cpython/tree/3.10/Lib/xdrlib.py)

Deprecated since version 3.11: The [`xdrlib`](xdrlib.md#module-xdrlib "xdrlib: Encoders and decoders for the External Data Representation (XDR). (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#xdrlib) for details).
