...
source_url: https://docs.python.org/3.10/library/struct.html
fetched_at: 2026-09-17T15:13:30+00:00
---
# `struct` — Interpret bytes as packed binary data

**Source code:** [Lib/struct.py](https://github.com/python/cpython/tree/3.10/Lib/struct.py)
...
argument. This refers to objects that implement the [Buffer Protocol](https://docs.python.org/3.10/c-api/buffer.html#bufferobjects) and
...
as defined in [IETF RFC 1700](https://tools.ietf.org/html/rfc1700).
...
:   Return a new Struct object which writes and reads binary data according to
    ...
    > [`Struct`](struct.md#struct.Struct "struct.Struct") and the module-level functions are cached, so programs
    > that use only a few format strings needn’t worry about reusing a single
    > [`Struct`](struct.md#struct.Struct "struct.Struct") instance.
