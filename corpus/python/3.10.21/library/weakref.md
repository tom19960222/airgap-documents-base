...
source_url: https://docs.python.org/3.10/library/weakref.html
fetched_at: 2026-09-17T15:13:35+00:00
---
# `weakref` — Weak references

**Source code:** [Lib/weakref.py](https://github.com/python/cpython/tree/3.10/Lib/weakref.py)
...
[garbage collection](https://docs.python.org/3.10/glossary.html#term-garbage-collection) is free to destroy the referent and reuse its memory
...
frozensets, some [file objects](https://docs.python.org/3.10/glossary.html#term-file-object), [generators](https://docs.python.org/3.10/glossary.html#term-generator),
...
[Weak Reference Support](https://docs.python.org/3.10/extending/newtypes.html#weakref-support).
...
See [__slots__ documentation](https://docs.python.org/3.10/reference/datamodel.html#slots) for details.
...
:   Return a weak reference to *object*. The original object can be retrieved by
    ...
    Weak references are [hashable](https://docs.python.org/3.10/glossary.html#term-hashable) if the *object* is hashable. They will
...
:   Return a proxy to *object* which uses a weak reference. This supports use of
    ...
    callable. Proxy objects are not [hashable](https://docs.python.org/3.10/glossary.html#term-hashable) regardless of the referent; this
...
:   Mapping class that references values weakly. Entries in the dictionary will be
    ...
    Changed in version 3.9: Added support for `|` and `|=` operators, as specified in [**PEP 584**](https://www.python.org/dev/peps/pep-0584).
...
same issues as the `keyrefs()` method of [`WeakKeyDictionary`](weakref.md#weakref.WeakKeyDictionary "weakref.WeakKeyDictionary")
objects.
...
:   Return a callable finalizer object which will be called when *obj*
    ...
    the [interpreter shutdown](https://docs.python.org/3.10/glossary.html#term-interpreter-shutdown) when module globals are liable to have
...
> **See also:**
>
> [**PEP 205**](https://www.python.org/dev/peps/pep-0205) - Weak References
...
no longer forced to [`None`](constants.md#None "None") during [interpreter shutdown](https://docs.python.org/3.10/glossary.html#term-interpreter-shutdown).
