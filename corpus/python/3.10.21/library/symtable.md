...
source_url: https://docs.python.org/3.10/library/symtable.html
fetched_at: 2026-09-17T15:15:07+00:00
---
# `symtable` — Access to the compiler’s symbol tables

**Source code:** [Lib/symtable.py](https://github.com/python/cpython/tree/3.10/Lib/symtable.py)
...
:   A namespace of a class. This class inherits [`SymbolTable`](symtable.md#symtable.SymbolTable "symtable.SymbolTable").
...
:   An entry in a [`SymbolTable`](symtable.md#symtable.SymbolTable "symtable.SymbolTable") corresponding to an identifier in the
    ...
    :   Return the namespace bound to this name. If more than one namespace is
        bound, [`ValueError`](exceptions.md#ValueError "ValueError") is raised.
