...
source_url: https://docs.python.org/3.10/library/multiprocessing.shared_memory.html
fetched_at: 2026-09-17T15:14:08+00:00
---
# `multiprocessing.shared_memory` — Shared memory for direct access across processes

**Source code:** [Lib/multiprocessing/shared_memory.py](https://github.com/python/cpython/tree/3.10/Lib/multiprocessing/shared_memory.py)
...
:   A subclass of [`BaseManager`](multiprocessing.md#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") which can be
    ...
    [`SharedMemoryManager`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager "multiprocessing.managers.SharedMemoryManager") instance causes a new process to be started.
    ...
    [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager.SharedMemory "multiprocessing.managers.SharedMemoryManager.SharedMemory") objects managed by that process and then
    ...
    Refer to [`multiprocessing.managers.BaseManager`](multiprocessing.md#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") for a description
...
`SharedMemoryManager` objects via the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement to
...
When using a `SharedMemoryManager` in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, the
shared memory blocks created using that manager are all released when the
[`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement’s code block finishes execution.
...
:   Provides a mutable list-like object where all values stored within are
    ...
    and do not support the dynamic creation of new [`ShareableList`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.ShareableList "multiprocessing.shared_memory.ShareableList")
    ...
    *name* is the unique name for the requested shared memory, as described
    ...
    `index(value)`
    :   Returns first index position of `value`. Raises [`ValueError`](exceptions.md#ValueError "ValueError") if
