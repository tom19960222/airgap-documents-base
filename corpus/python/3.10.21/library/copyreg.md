...
source_url: https://docs.python.org/3.10/library/copyreg.html
fetched_at: 2026-09-17T15:13:50+00:00
---
# `copyreg` — Register [`pickle`](pickle.md#module-pickle "pickle: Convert Python objects to streams of bytes and back.") support functions

**Source code:** [Lib/copyreg.py](https://github.com/python/cpython/tree/3.10/Lib/copyreg.py)
...
:   Declares that *function* should be used as a “reduction” function for objects
    ...
    containing two or three elements. See the [`dispatch_table`](pickle.md#pickle.Pickler.dispatch_table "pickle.Pickler.dispatch_table")
