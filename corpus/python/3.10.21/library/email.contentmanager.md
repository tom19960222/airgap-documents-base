...
source_url: https://docs.python.org/3.10/library/email.contentmanager.html
fetched_at: 2026-09-17T15:15:36+00:00
---
# `email.contentmanager`: Managing MIME Content

**Source code:** [Lib/email/contentmanager.py](https://github.com/python/cpython/tree/3.10/Lib/email/contentmanager.py)

---

New in version 3.6: [1](email.contentmanager.md#id2)
...
:   Base class for content managers. Provides the standard registry mechanisms
    ...
    :   If the `maintype` is `multipart`, raise a [`TypeError`](exceptions.md#TypeError "TypeError"); otherwise
        ...
        *msg*, possibly making other changes to *msg* as well, such as adding
        ...
        the types in the [MRO](https://docs.python.org/3.10/glossary.html#term-MRO) (`typ.__mro__`). Finally, if no other key
...
:   Originally added in 3.4 as a [provisional module](https://docs.python.org/3.10/glossary.html#term-provisional-package)
