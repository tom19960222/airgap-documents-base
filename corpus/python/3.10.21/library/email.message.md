...
source_url: https://docs.python.org/3.10/library/email.message.html
fetched_at: 2026-09-17T15:15:34+00:00
---
# `email.message`: Representing an email message

**Source code:** [Lib/email/message.py](https://github.com/python/cpython/tree/3.10/Lib/email/message.py)

---

New in version 3.6: [1](email.message.md#id2)
...
:   If *policy* is specified use the rules it specifies to update and serialize
    ...
    :   Return the entire message flattened as a string. When optional
        *unixfrom* is true, the envelope header is included in the returned
        ...
        `max_line_length` of the policy. The
    ...
    :   Return the value of the named header field. This is identical to
        [`__getitem__()`](email.message.md#email.message.EmailMessage.__getitem__ "email.message.EmailMessage.__getitem__") except that optional *failobj* is returned if the
...
:   Originally added in 3.4 as a [provisional module](https://docs.python.org/3.10/glossary.html#term-provisional-package). Docs for legacy message class moved to
