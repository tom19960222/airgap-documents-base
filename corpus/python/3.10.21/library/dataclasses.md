...
source_url: https://docs.python.org/3.10/library/dataclasses.html
fetched_at: 2026-09-17T15:14:58+00:00
---
# `dataclasses` — Data Classes

**Source code:** [Lib/dataclasses.py](https://github.com/python/cpython/tree/3.10/Lib/dataclasses.py)

---

This module provides a decorator and functions for automatically
adding generated [special method](https://docs.python.org/3.10/glossary.html#term-special-method)s such as `__init__()` and
`__repr__()` to user-defined classes. It was originally described
in [**PEP 557**](https://www.python.org/dev/peps/pep-0557).

The member variables to use in these generated methods are defined
using [**PEP 526**](https://www.python.org/dev/peps/pep-0526) type annotations. For example, this code:
...
:   This function is a [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) that is used to add generated
    [special method](https://docs.python.org/3.10/glossary.html#term-special-method)s to classes, as described below.

    The [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") decorator examines the class to find
    `field`s. A `field` is defined as a class variable that has a
    [type annotation](https://docs.python.org/3.10/glossary.html#term-variable-annotation). With two
    exceptions described below, nothing in [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass")
    examines the type specified in the variable annotation.

    The order of the fields in all of the generated methods is the
    order in which they appear in the class definition.

    The [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") decorator will add various “dunder” methods to
    ...
    If [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") is used just as a simple decorator with no parameters,
    it acts as if it has the default values documented in this
    signature. That is, these three uses of [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") are
    equivalent:
    ...
    The parameters to [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") are:
    ...
    - `unsafe_hash`: If `False` (the default), a `__hash__()` method
      ...
      the `eq` and `frozen` flags in the [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") decorator.

      By default, [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") will not implicitly add a `__hash__()`
      ...
      then [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") *may* add an implicit `__hash__()` method.
      Although not recommended, you can force [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") to create a
      ...
      If `eq` and `frozen` are both true, by default [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") will
    ...
    - `kw_only`: If true (the default value is `False`), then all
      ...
      with a keyword when `__init__()` is called. There is no
      effect on any other aspect of dataclasses. See the
      [parameter](https://docs.python.org/3.10/glossary.html#term-parameter) glossary entry for details. Also see the
...
:   For common and simple use cases, no other functionality is
    ...
    with a call to the provided [`field()`](dataclasses.md#dataclasses.field "dataclasses.field") function. For example:
    ...
    The parameters to [`field()`](dataclasses.md#dataclasses.field "dataclasses.field") are:

    - `default`: If provided, this will be the default value for this
      field. This is needed because the [`field()`](dataclasses.md#dataclasses.field "dataclasses.field") call itself
    ...
    - `kw_only`: If true, this field will be marked as keyword-only.
      This is used when the generated `__init__()` method’s
      parameters are computed.

    > New in version 3.10.

    If the default value of a field is specified by a call to
    [`field()`](dataclasses.md#dataclasses.field "dataclasses.field"), then the class attribute for this field will be
...
:   [`Field`](dataclasses.md#dataclasses.Field "dataclasses.Field") objects describe each defined field. These objects
    are created internally, and are returned by the [`fields()`](dataclasses.md#dataclasses.fields "dataclasses.fields")
    module-level method (see below). Users should never instantiate a
    [`Field`](dataclasses.md#dataclasses.Field "dataclasses.Field") object directly. Its documented attributes are:
...
:   Converts the dataclass `obj` to a dict (by using the
    ...
    Example of using [`asdict()`](dataclasses.md#dataclasses.asdict "dataclasses.asdict") on nested dataclasses:
    ...
    [`asdict()`](dataclasses.md#dataclasses.asdict "dataclasses.asdict") raises [`TypeError`](exceptions.md#TypeError "TypeError") if `obj` is not a dataclass
    instance.
...
:   Converts the dataclass `obj` to a tuple (by using the
    ...
    [`astuple()`](dataclasses.md#dataclasses.astuple "dataclasses.astuple") raises [`TypeError`](exceptions.md#TypeError "TypeError") if `obj` is not a dataclass
    instance.
...
:   Creates a new dataclass with name `cls_name`, fields as defined
    ...
    they do in [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass").
...
:   Creates a new object of the same type as `obj`, replacing
    ...
    Class, raises [`TypeError`](exceptions.md#TypeError "TypeError"). If values in `changes` do not
    specify fields, raises [`TypeError`](exceptions.md#TypeError "TypeError").
    ...
    specified on the call to [`replace()`](dataclasses.md#dataclasses.replace "dataclasses.replace") so that they can be passed to
    ...
    [`replace()`](dataclasses.md#dataclasses.replace "dataclasses.replace"). They are not copied from the source object, but
...
:   A sentinel value used as a type annotation. Any fields after a
    pseudo-field with the type of [`KW_ONLY`](dataclasses.md#dataclasses.KW_ONLY "dataclasses.KW_ONLY") are marked as
    keyword-only fields. Note that a pseudo-field of type
    [`KW_ONLY`](dataclasses.md#dataclasses.KW_ONLY "dataclasses.KW_ONLY") is otherwise completely ignored. This includes the
    name of such a field. By convention, a name of `_` is used for a
    [`KW_ONLY`](dataclasses.md#dataclasses.KW_ONLY "dataclasses.KW_ONLY") field. Keyword-only fields signify
    `__init__()` parameters that must be specified as keywords when
    ...
    field whose type is [`KW_ONLY`](dataclasses.md#dataclasses.KW_ONLY "dataclasses.KW_ONLY").
...
The `__init__()` method generated by [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") does not call base
...
in [**PEP 526**](https://www.python.org/dev/peps/pep-0526). It does this by checking if the type of the field is
...
must use [`object.__setattr__()`](https://docs.python.org/3.10/reference/datamodel.html#object.__setattr__ "object.__setattr__").
...
> [`dataclass()`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") decorator will raise a [`TypeError`](exceptions.md#TypeError "TypeError") if it
...
Fields that are assigned [descriptor objects](https://docs.python.org/3.10/reference/datamodel.html#descriptors) as their
