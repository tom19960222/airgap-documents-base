...
source_url: https://docs.python.org/3.10/library/email.generator.html
fetched_at: 2026-09-17T15:15:35+00:00
---
# `email.generator`: Generating MIME documents

**Source code:** [Lib/email/generator.py](https://github.com/python/cpython/tree/3.10/Lib/email/generator.py)
...
:   Return a [`BytesGenerator`](email.generator.md#email.generator.BytesGenerator "email.generator.BytesGenerator") object that will write any message provided
    ...
    to the [`write()`](email.generator.md#email.generator.BytesGenerator.write "email.generator.BytesGenerator.write") method, to the [file-like object](https://docs.python.org/3.10/glossary.html#term-file-like-object) *outfp*.
...
:   Return a [`Generator`](email.generator.md#email.generator.Generator "email.generator.Generator") object that will write any message provided
    ...
    method, to the [file-like object](https://docs.python.org/3.10/glossary.html#term-file-like-object) *outfp*. *outfp* must support a
...
:   This statement assumes that you use the appropriate setting for
    ...
    `refold_source` must be `none`, which is
