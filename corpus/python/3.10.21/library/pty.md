...
source_url: https://docs.python.org/3.10/library/pty.html
fetched_at: 2026-09-17T15:15:15+00:00
---
# `pty` — Pseudo-terminal utilities

**Source code:** [Lib/pty.py](https://github.com/python/cpython/tree/3.10/Lib/pty.py)
...
:   Spawn a process, and connect its controlling terminal with the current
    ...
    *master_read* signals EOF the same behavior results (on linux at least).
    ...
    `waitstatus_to_exitcode()` can be used to convert the exit status into
    an exit code.
