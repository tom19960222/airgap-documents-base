...
source_url: https://docs.python.org/3.10/library/os.path.html
fetched_at: 2026-09-17T15:13:45+00:00
---
# `os.path` — Common pathname manipulations

**Source code:** [Lib/posixpath.py](https://github.com/python/cpython/tree/3.10/Lib/posixpath.py) (for POSIX) and
[Lib/ntpath.py](https://github.com/python/cpython/tree/3.10/Lib/ntpath.py) (for Windows).
...
:   Return the longest common sub-path of each pathname in the sequence
    *paths*. Raise [`ValueError`](exceptions.md#ValueError "ValueError") if *paths* contain both absolute
    ...
    Changed in version 3.6: Accepts a sequence of [path-like objects](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Join one or more path segments intelligently. The return value is the
    ...
    Changed in version 3.6: Accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) for *path* and *paths*.
...
:   Return the canonical path of the specified filename, eliminating any symbolic
    ...
    Changed in version 3.10.18: The [`ALLOW_MISSING`](os.path.md#os.path.ALLOW_MISSING "os.path.ALLOW_MISSING") value for the *strict* parameter
    was added.
