...
version: "3.10.21"
title: "Futures"
source_url: https://docs.python.org/3.10/library/asyncio-future.html
fetched_at: 2026-09-17T15:15:31+00:00
---
# Futures

**Source code:** [Lib/asyncio/futures.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/futures.py),
[Lib/asyncio/base_futures.py](https://github.com/python/cpython/tree/3.10/Lib/asyncio/base_futures.py)
...
:   Return:
    ...
    Changed in version 3.5.1: The function accepts any [awaitable](https://docs.python.org/3.10/glossary.html#term-awaitable) object.
...
:   A Future represents an eventual result of an asynchronous
    ...
    Future is an [awaitable](https://docs.python.org/3.10/glossary.html#term-awaitable) object. Coroutines can await on
    ...
    :   Mark the Future as *done* and set its result.
        ...
        Raises a [`InvalidStateError`](asyncio-exceptions.md#asyncio.InvalidStateError "asyncio.InvalidStateError") error if the Future is
        already *done*.
    ...
    :   Add a callback to be run when the Future is *done*.
        ...
        See [**PEP 567**](https://www.python.org/dev/peps/pep-0567) for more details.
...
>   but `concurrent.futures.cancel()` does not.
