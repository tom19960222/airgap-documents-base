...
source_url: https://docs.python.org/3.10/library/email.utils.html
fetched_at: 2026-09-17T15:15:39+00:00
---
# `email.utils`: Miscellaneous utilities

**Source code:** [Lib/email/utils.py](https://github.com/python/cpython/tree/3.10/Lib/email/utils.py)
...
:   The inverse of [`parseaddr()`](email.utils.md#email.utils.parseaddr "email.utils.parseaddr"), this takes a 2-tuple of the form `(realname,
    ...
    *Cc* header. If the first element of *pair* is false, then the
    ...
    characters. Can be an instance of [`str`](stdtypes.md#str "str") or a
    [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset"). Defaults to `utf-8`.
...
:   Attempts to parse a date according to the rules in [**RFC 2822**](https://datatracker.ietf.org/doc/html/rfc2822.html). however, some
    ...
    the date, [`parsedate()`](email.utils.md#email.utils.parsedate "email.utils.parsedate") returns a 9-tuple that can be passed directly to
...
:   Performs the same function as [`parsedate()`](email.utils.md#email.utils.parsedate "email.utils.parsedate"), but returns either `None` or
    ...
    (which is the official term for Greenwich Mean Time) [1](email.utils.md#id2). If the input string
...
:   The inverse of [`format_datetime()`](email.utils.md#email.utils.format_datetime "email.utils.format_datetime"). Performs the same function as
    ...
    corresponding a [`timezone`](datetime.md#datetime.timezone "datetime.timezone") [`tzinfo`](datetime.md#datetime.tzinfo "datetime.tzinfo").
...
:   Returns a date string as per [**RFC 2822**](https://datatracker.ietf.org/doc/html/rfc2822.html), e.g.:
    ...
    [`time.gmtime()`](time.md#time.gmtime "time.gmtime") and [`time.localtime()`](time.md#time.localtime "time.localtime"), otherwise the current time is
    used.
...
:   When a header parameter is encoded in [**RFC 2231**](https://datatracker.ietf.org/doc/html/rfc2231.html) format,
    ...
    language, and value. [`collapse_rfc2231_value()`](email.utils.md#email.utils.collapse_rfc2231_value "email.utils.collapse_rfc2231_value") turns this into a unicode
    string. Optional *errors* is passed to the *errors* argument of [`str`](stdtypes.md#str "str")’s
    [`encode()`](stdtypes.md#str.encode "str.encode") method; it defaults to `'replace'`. Optional
...
[1](email.utils.md#id1)
:   Note that the sign of the timezone offset is the opposite of the sign of the
    `time.timezone` variable for the same timezone; the latter variable follows
    the POSIX standard while this module follows [**RFC 2822**](https://datatracker.ietf.org/doc/html/rfc2822.html).
