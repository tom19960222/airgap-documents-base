...
source_url: https://docs.python.org/3.10/library/exceptions.html
fetched_at: 2026-09-17T15:13:26+00:00
---
# Built-in Exceptions

In Python, all exceptions must be instances of a class that derives from
[`BaseException`](exceptions.md#BaseException "BaseException"). In a [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try) statement with an [`except`](https://docs.python.org/3.10/reference/compound_stmts.html#except)
...
[User-defined Exceptions](https://docs.python.org/3.10/tutorial/errors.html#tut-userexceptions).
...
exception. An exception may be handled when an [`except`](https://docs.python.org/3.10/reference/compound_stmts.html#except) or
[`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) clause, or a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, is used.

This implicit exception context can be
supplemented with an explicit cause by using `from` with
[`raise`](https://docs.python.org/3.10/reference/simple_stmts.html#raise):

```python3
raise new_exc from original_exc
```

The expression following [`from`](https://docs.python.org/3.10/reference/simple_stmts.html#raise) must be an exception or `None`. It
...
[Objects/exceptions.c](https://github.com/python/cpython/tree/3.10/Objects/exceptions.c). Some have custom memory layouts
...
:   The base class for all built-in exceptions. It is not meant to be directly
    ...
    :   This method sets *tb* as the new traceback for the exception and returns
        ...
        chaining features of [**PEP 3134**](https://www.python.org/dev/peps/pep-3134) became available. The following example
...
:   Raised when a [buffer](https://docs.python.org/3.10/c-api/buffer.html#bufferobjects) related operation cannot be
    performed.
...
:   Raised when an [`assert`](https://docs.python.org/3.10/reference/simple_stmts.html#assert) statement fails.

`exception AttributeError`
:   Raised when an attribute reference (see [Attribute references](https://docs.python.org/3.10/reference/expressions.html#attribute-references)) or
...
:   Raised when a [generator](https://docs.python.org/3.10/glossary.html#term-generator) or [coroutine](https://docs.python.org/3.10/glossary.html#term-coroutine) is closed;
    see [`generator.close()`](https://docs.python.org/3.10/reference/expressions.html#generator.close "generator.close") and [`coroutine.close()`](https://docs.python.org/3.10/reference/datamodel.html#coroutine.close "coroutine.close"). It
...
:   Raised when the [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) statement has troubles trying to
...
:   A subclass of [`ImportError`](exceptions.md#ImportError "ImportError") which is raised by [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import)
...
:   This exception is derived from [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError"). In user defined base
    ...
    > [`NotImplemented`](constants.md#NotImplemented "NotImplemented") for details on when to use it.
...
:   This exception is raised when a system function returns a system-related
    ...
    [filesystem encoding and error handler](https://docs.python.org/3.10/glossary.html#term-filesystem-encoding-and-error-handler). Also, the *filename2*
...
:   This exception is derived from [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError"). It is raised when the
    ...
    New in version 3.5: Previously, a plain [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") was raised.
...
:   Raised by built-in function [`next()`](functions.md#next "next") and an [iterator](https://docs.python.org/3.10/glossary.html#term-iterator)'s
    ...
    When a [generator](https://docs.python.org/3.10/glossary.html#term-generator) or [coroutine](https://docs.python.org/3.10/glossary.html#term-coroutine) function
    ...
    `from __future__ import generator_stop`, see [**PEP 479**](https://www.python.org/dev/peps/pep-0479).

    Changed in version 3.7: Enable [**PEP 479**](https://www.python.org/dev/peps/pep-0479) for all code by default: a [`StopIteration`](exceptions.md#StopIteration "StopIteration")
...
:   Must be raised by `__anext__()` method of an
    [asynchronous iterator](https://docs.python.org/3.10/glossary.html#term-asynchronous-iterator) object to stop the iteration.

    New in version 3.5.

`exception SyntaxError(message, details)`
:   Raised when the parser encounters a syntax error. This may occur in an
    [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) statement, in a call to the built-in functions
...
:   This exception is raised by the [`sys.exit()`](sys.md#sys.exit "sys.exit") function. It inherits from
    ...
    handlers ([`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) clauses of [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try) statements) can be
...
:   Raised when a system call is interrupted by an incoming signal.
    ...
    signal, except if the signal handler raises an exception (see [**PEP 475**](https://www.python.org/dev/peps/pep-0475)
...
:   Raised when trying to run an operation without the adequate access
    ...
    Corresponds to `errno` [`EACCES`](errno.md#errno.EACCES "errno.EACCES") and [`EPERM`](errno.md#errno.EPERM "errno.EPERM").
...
New in version 3.3: All the above [`OSError`](exceptions.md#OSError "OSError") subclasses were added.

> **See also:**
>
> [**PEP 3151**](https://www.python.org/dev/peps/pep-3151) - Reworking the OS and IO exception hierarchy
...
:   Base class for warnings about deprecated features when those warnings are
    ...
    ([**PEP 565**](https://www.python.org/dev/peps/pep-0565)). Enabling the [Python Development Mode](devmode.md#devmode) shows
    this warning.
