...
source_url: https://docs.python.org/3.10/library/filesys.html
...
>     lower level than Python [file objects](https://docs.python.org/3.10/glossary.html#term-file-object).
>
