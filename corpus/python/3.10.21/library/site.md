...
source_url: https://docs.python.org/3.10/library/site.html
fetched_at: 2026-09-17T15:15:02+00:00
---
# `site` — Site-specific configuration hook

**Source code:** [Lib/site.py](https://github.com/python/cpython/tree/3.10/Lib/site.py)

---

**This module is automatically imported during initialization.** The automatic
import can be suppressed using the interpreter’s [`-S`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-S) option.

Importing this module will append site-specific paths to the module search path
and add a few builtins, unless [`-S`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-S) was used. In that case, this module
can be safely imported with no automatic modifications to the module search path
or additions to the builtins. To explicitly trigger the usual site-specific
additions, call the [`site.main()`](site.md#site.main "site.main") function.

Changed in version 3.3: Importing the module used to trigger paths manipulation even when using
[`-S`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-S).
...
exception, and the exception’s `name` attribute equals to `'sitecustomize'`,
...
disabled by [`-s`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-s). If this import fails with an [`ImportError`](exceptions.md#ImportError "ImportError") or
its subclass exception, and the exception’s `name` attribute equals to
...
[interactive mode](https://docs.python.org/3.10/tutorial/interpreter.html#tut-interactive) and without the [`-S`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-S) option.
...
[`PYTHONSTARTUP`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONSTARTUP) file.
...
:   Flag showing the status of the user site-packages directory. `True` means
    ...
    was disabled by user request (with [`-s`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-s) or
    [`PYTHONNOUSERSITE`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONNOUSERSITE)). `None` means it was disabled for security
...
:   Path to the base directory for the user site-packages. Can be `None` if
    ...
    etc. for the [user installation scheme](https://docs.python.org/3.10/install/index.html#inst-alt-install-user).
    See also [`PYTHONUSERBASE`](https://docs.python.org/3.10/using/cmdline.html#envvar-PYTHONUSERBASE).

`site.main()`
:   Adds all the standard site-specific directories to the module search
    path. This function is called automatically when this module is imported,
    unless the Python interpreter was started with the [`-S`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-S) flag.
...
> **See also:**
>
> [**PEP 370**](https://www.python.org/dev/peps/pep-0370) – Per user site-packages directory
