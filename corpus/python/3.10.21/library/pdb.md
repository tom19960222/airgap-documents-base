...
source_url: https://docs.python.org/3.10/library/pdb.html
fetched_at: 2026-09-17T15:14:51+00:00
---
# `pdb` — The Python Debugger

**Source code:** [Lib/pdb.py](https://github.com/python/cpython/tree/3.10/Lib/pdb.py)

---

The module [`pdb`](pdb.md#module-pdb "pdb: The Python debugger for interactive interpreters.") defines an interactive source code debugger for Python
programs. It supports setting (conditional) breakpoints and single stepping at
the source line level, inspection of stack frames, source code listing, and
evaluation of arbitrary Python code in the context of any stack frame. It also
supports post-mortem debugging and can be called under program control.

The debugger is extensible – it is actually defined as the class [`Pdb`](pdb.md#pdb.Pdb "pdb.Pdb").
This is currently undocumented but easily understood by reading the source. The
extension interface uses the modules [`bdb`](bdb.md#module-bdb "bdb: Debugger framework.") and [`cmd`](cmd.md#module-cmd "cmd: Build line-oriented command interpreters.").
...
>     or on a user signal.
>
> Module [`traceback`](traceback.md#module-traceback "traceback: Print or retrieve a stack traceback.")
...
Changed in version 3.3: Tab-completion via the [`readline`](readline.md#module-readline "readline: GNU readline support for Python. (Unix)") module is available for commands and
...
in a `.pdbrc` file, see [Debugger Commands](pdb.md#debugger-commands).

New in version 3.7: `pdb.py` now accepts a `-m` option that execute modules similar to the way
...
running without the debugger using the [`continue`](pdb.md#pdbcommand-continue) command.

New in version 3.7: The built-in [`breakpoint()`](functions.md#breakpoint "breakpoint"), when called with defaults, can be used
...
:   Execute the *statement* (given as a string or a code object) under debugger
    ...
    statement using [`step`](pdb.md#pdbcommand-step) or [`next`](pdb.md#pdbcommand-next) (all these commands are
...
The `run*` functions and [`set_trace()`](pdb.md#pdb.set_trace "pdb.set_trace") are aliases for instantiating the
...
:   [`Pdb`](pdb.md#pdb.Pdb "pdb.Pdb") is the debugger class.
    ...
    underlying [`cmd.Cmd`](cmd.md#cmd.Cmd "cmd.Cmd") class; see the description there.

    The *skip* argument, if given, must be an iterable of glob-style module name
    patterns. The debugger will not step into frames that originate in a module
    that matches one of these patterns. [1](pdb.md#id3)

    By default, Pdb sets a handler for the SIGINT signal (which is sent when the
    user presses `Ctrl-C` on the console) when you give a [`continue`](pdb.md#pdbcommand-continue) command.
...
command was a [`list`](pdb.md#pdbcommand-list) command, the next 11 lines are listed.
...
The debugger supports [aliases](pdb.md#debugger-aliases). Aliases can have
...
[`continue`](pdb.md#pdbcommand-continue) or [`next`](pdb.md#pdbcommand-next). Previously, these commands had no
effect.
...
:   With a *lineno* argument, set a break there in the current file. With a
    *function* argument, set a break at the first executable statement within
    ...
    yet). The file is searched on [`sys.path`](sys.md#sys.path "sys.path"). Note that each breakpoint
...
:   Specify a list of commands for breakpoint number *bpnumber*. The commands
    ...
    the [`continue`](pdb.md#pdbcommand-continue) command, or [`step`](pdb.md#pdbcommand-step),
    or any other command that resumes execution.

    Specifying any command resuming execution
    (currently [`continue`](pdb.md#pdbcommand-continue), [`step`](pdb.md#pdbcommand-step), [`next`](pdb.md#pdbcommand-next),
    [`return`](pdb.md#pdbcommand-return), [`jump`](pdb.md#pdbcommand-jump), [`quit`](pdb.md#pdbcommand-quit) and their abbreviations)
...
:   Set the next line that will be executed. Only available in the bottom-most
    ...
    possible to jump into the middle of a [`for`](https://docs.python.org/3.10/reference/compound_stmts.html#for) loop or out of a
    [`finally`](https://docs.python.org/3.10/reference/compound_stmts.html#finally) clause.
...
:   Execute the (one-line) *statement* in the context of the current stack frame.
    ...
    assignment command with a [`global`](https://docs.python.org/3.10/reference/simple_stmts.html#global) statement on the same line,
    e.g.:
