...
source_url: https://docs.python.org/3.10/library/sysconfig.html
...
**Source code:** [Lib/sysconfig.py](https://github.com/python/cpython/tree/3.10/Lib/sysconfig.py)
...
third-party C extensions compiled using [`distutils`](distutils.md#module-distutils "distutils: Support for building and installing Python modules into an existing Python installation.").
...
Every new component that is installed using [`distutils`](distutils.md#module-distutils "distutils: Support for building and installing Python modules into an existing Python installation.") or a
...
[`sysconfig`](sysconfig.md#module-sysconfig "sysconfig: Python's configuration information") provides some functions to determine these paths.
...
:   Return the default scheme name for the current platform.
    ...
    New in version 3.10: This function was previously named `_get_default_scheme()` and
...
:   Return an installation path corresponding to the path *name*, from the
    ...
    *name* has to be a value from the list returned by [`get_path_names()`](sysconfig.md#sysconfig.get_path_names "sysconfig.get_path_names").
    ...
    the dictionary return by [`get_config_vars()`](sysconfig.md#sysconfig.get_config_vars "sysconfig.get_config_vars").
