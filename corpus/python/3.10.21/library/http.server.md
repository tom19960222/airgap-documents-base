...
source_url: https://docs.python.org/3.10/library/http.server.html
fetched_at: 2026-09-17T15:14:32+00:00
---
# `http.server` — HTTP servers

**Source code:** [Lib/http/server.py](https://github.com/python/cpython/tree/3.10/Lib/http/server.py)
...
:   This class serves files from the directory *directory* and below,
    ...
    Changed in version 3.9: The *directory* parameter accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
    ...
    :   The request is mapped to a local file by interpreting the request as a
        ...
        in [Lib/http/server.py](https://github.com/python/cpython/tree/3.10/Lib/http/server.py).
...
[`http.server`](http.server.md#module-http.server "http.server: HTTP server and request handlers.") can also be invoked directly using the [`-m`](https://docs.python.org/3.10/using/cmdline.html#cmdoption-m)
