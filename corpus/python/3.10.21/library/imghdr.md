...
source_url: https://docs.python.org/3.10/library/imghdr.html
fetched_at: 2026-09-17T15:15:21+00:00
---
# `imghdr` — Determine the type of an image

**Source code:** [Lib/imghdr.py](https://github.com/python/cpython/tree/3.10/Lib/imghdr.py)

Deprecated since version 3.11: The [`imghdr`](imghdr.md#module-imghdr "imghdr: Determine the type of image contained in a file or byte stream. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#imghdr) for details and alternatives).
