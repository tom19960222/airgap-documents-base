...
source_url: https://docs.python.org/3.10/library/resource.html
...
Resources usage can be limited using the [`setrlimit()`](resource.md#resource.setrlimit "resource.setrlimit") function described
...
:   Sets new limits of consumption of *resource*. The *limits* argument must be a
    ...
    Raises [`ValueError`](exceptions.md#ValueError "ValueError") if an invalid resource is specified, if the new soft
    limit exceeds the hard limit, or if a process tries to raise its hard limit.
    Specifying a limit of [`RLIM_INFINITY`](resource.md#resource.RLIM_INFINITY "resource.RLIM_INFINITY") when the hard or
    system limit for that resource is not unlimited will result in a
    [`ValueError`](exceptions.md#ValueError "ValueError"). A process with the effective UID of super-user can
    request any valid limit value, including unlimited, but [`ValueError`](exceptions.md#ValueError "ValueError")
    will still be raised if the requested limit exceeds the system imposed
    limit.

    `setrlimit` may also raise [`error`](resource.md#resource.error "resource.error") if the underlying system call
    fails.

    VxWorks only supports setting [`RLIMIT_NOFILE`](resource.md#resource.RLIMIT_NOFILE "resource.RLIMIT_NOFILE").
...
:   Combines [`setrlimit()`](resource.md#resource.setrlimit "resource.setrlimit") and [`getrlimit()`](resource.md#resource.getrlimit "resource.getrlimit") in one function and
    ...
    *limits* have the same meaning as in [`setrlimit()`](resource.md#resource.setrlimit "resource.setrlimit"), except that
    *limits* is optional.
    ...
    Raises [`ProcessLookupError`](exceptions.md#ProcessLookupError "ProcessLookupError") when *pid* can’t be found and
    [`PermissionError`](exceptions.md#PermissionError "PermissionError") when the user doesn’t have `CAP_SYS_RESOURCE` for
    the process.

    Raises an [auditing event](sys.md#auditing) `resource.prlimit` with arguments `pid`, `resource`, `limits`.

    [Availability](intro.md#availability): Linux 2.6.36 or later with glibc 2.13 or later.

    New in version 3.4.

These symbols define resources whose consumption can be controlled using the
[`setrlimit()`](resource.md#resource.setrlimit "resource.setrlimit") and [`getrlimit()`](resource.md#resource.getrlimit "resource.getrlimit") functions described below. The values of
...
:   The number of bytes that can be allocated for POSIX message queues.
    ...
    [Availability](intro.md#availability): Linux 2.6.8 or later.
...
:   The ceiling for the process’s nice level (calculated as 20 - rlim_cur).
    ...
    [Availability](intro.md#availability): Linux 2.6.12 or later.
...
:   The time limit (in microseconds) on CPU time that a process can spend
    ...
    [Availability](intro.md#availability): Linux 2.6.25 or later.
...
:   The maximum size (in bytes) of socket buffer usage for this user.
    ...
    [Availability](intro.md#availability): FreeBSD 9 or later.
...
:   The maximum size (in bytes) of the swap space that may be reserved or
    ...
    Please see
    [tuning(7)](https://www.freebsd.org/cgi/man.cgi?query=tuning&sektion=7)
...
:   The maximum number of kqueues this user id is allowed to create.
    ...
    [Availability](intro.md#availability): FreeBSD 11 or later.
