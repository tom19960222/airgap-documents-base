...
source_url: https://docs.python.org/3.10/library/email.html
fetched_at: 2026-09-17T15:14:16+00:00
---
# `email` — An email and MIME handling package

**Source code:** [Lib/email/__init__.py](https://github.com/python/cpython/tree/3.10/Lib/email/__init__.py)
...
>
> Module [`smtpd`](smtpd.md#module-smtpd "smtpd: A SMTP server implementation in Python. (deprecated)")
