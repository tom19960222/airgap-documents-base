...
source_url: https://docs.python.org/3.10/library/tempfile.html
fetched_at: 2026-09-17T15:13:47+00:00
---
# `tempfile` — Generate temporary files and directories

**Source code:** [Lib/tempfile.py](https://github.com/python/cpython/tree/3.10/Lib/tempfile.py)
...
context managers. [`mkstemp()`](tempfile.md#tempfile.mkstemp "tempfile.mkstemp") and
...
:   Return a [file-like object](https://docs.python.org/3.10/glossary.html#term-file-like-object) that can be used as a temporary storage area.
...
:   This function operates exactly as [`TemporaryFile()`](tempfile.md#tempfile.TemporaryFile "tempfile.TemporaryFile") does, except that
    ...
    be used in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, just like a normal file.
...
:   This class operates exactly as [`TemporaryFile()`](tempfile.md#tempfile.TemporaryFile "tempfile.TemporaryFile") does, except that
    ...
    file-like object can be used in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, just like
    a normal file.
...
:   This class securely creates a temporary directory using the same rules as [`mkdtemp()`](tempfile.md#tempfile.mkdtemp "tempfile.mkdtemp").
    ...
    the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement, if there is one.
...
:   Creates a temporary file in the most secure manner possible. There are
    ...
    *suffix* and *prefix* now accept and default to `None` to cause
    ...
    Changed in version 3.6: The *dir* parameter now accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   When set to a value other than `None`, this variable defines the
    ...
    [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
