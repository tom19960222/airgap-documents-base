...
source_url: https://docs.python.org/3.10/library/email.charset.html
fetched_at: 2026-09-17T15:15:38+00:00
---
# `email.charset`: Representing character sets

**Source code:** [Lib/email/charset.py](https://github.com/python/cpython/tree/3.10/Lib/email/charset.py)
...
This module provides a class [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset") for representing character sets
and character set conversions in email messages, as well as a character set
registry and several convenience methods for manipulating this registry.
Instances of [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset") are used in several other modules within the
[`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.") package.
...
:   Map character sets to their email properties.
    ...
    *input_charset* is `euc-jp`, then headers will be encoded with base64, bodies
    ...
    :   Returns *input_charset* as a string coerced to lower
        case. `__repr__()` is an alias for [`__str__()`](email.charset.md#email.charset.Charset.__str__ "email.charset.Charset.__str__").
...
:   Add character properties to the global registry.
    ...
    *header_enc*. The default is `None` for no encoding.
    ...
    module’s character set-to-codec mapping; use [`add_codec()`](email.charset.md#email.charset.add_codec "email.charset.add_codec") to add codecs the
    module does not know about. See the [`codecs`](codecs.md#module-codecs "codecs: Encode and decode data and streams.") module’s documentation for
    more information.
...
:   Add a codec that map characters in the given character set to and from Unicode.
    ...
    *charset* is the canonical name of a character set. *codecname* is the name of a
    Python codec, as appropriate for the second argument to the [`str`](stdtypes.md#str "str")’s
    [`encode()`](stdtypes.md#str.encode "str.encode") method.
