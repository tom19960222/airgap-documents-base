...
source_url: https://docs.python.org/3.10/library/cgitb.html
fetched_at: 2026-09-17T15:15:19+00:00
---
# `cgitb` — Traceback manager for CGI scripts

**Source code:** [Lib/cgitb.py](https://github.com/python/cpython/tree/3.10/Lib/cgitb.py)

Deprecated since version 3.11: The [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#cgitb) for details).
