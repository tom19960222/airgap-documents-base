...
source_url: https://docs.python.org/3.10/library/uu.html
fetched_at: 2026-09-17T15:15:26+00:00
---
# `uu` — Encode and decode uuencode files

**Source code:** [Lib/uu.py](https://github.com/python/cpython/tree/3.10/Lib/uu.py)

Deprecated since version 3.11: The [`uu`](uu.md#module-uu "uu: Encode and decode files in uuencode format. (deprecated)") module is deprecated
(see [**PEP 594**](https://www.python.org/dev/peps/pep-0594#uu-and-the-uu-encoding) for details).
