...
source_url: https://docs.python.org/3.10/library/asyncio.html
...
- create and manage [event loops](asyncio-eventloop.md#asyncio-event-loop), which
  provide asynchronous APIs for [`networking`](asyncio-eventloop.md#asyncio.loop.create_server "asyncio.loop.create_server"),
  running [`subprocesses`](asyncio-eventloop.md#asyncio.loop.subprocess_exec "asyncio.loop.subprocess_exec"),
  handling [`OS signals`](asyncio-eventloop.md#asyncio.loop.add_signal_handler "asyncio.loop.add_signal_handler"), etc;
...
Changed in version 3.10.15: (also 3.9.20, and 3.8.20)
Emits audit events.
...
> **Note:**
>
> The source code for asyncio can be found in [Lib/asyncio/](https://github.com/python/cpython/tree/3.10/Lib/asyncio/).
