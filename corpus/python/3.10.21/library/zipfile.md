...
source_url: https://docs.python.org/3.10/library/zipfile.html
fetched_at: 2026-09-17T15:13:54+00:00
---
# `zipfile` — Work with ZIP archives

**Source code:** [Lib/zipfile.py](https://github.com/python/cpython/tree/3.10/Lib/zipfile.py)
...
:   Open a ZIP file, where *file* can be a path to a file (a string), a
    file-like object or a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
    ...
    *compression* is the ZIP compression method to use when writing the archive,
    ...
    [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. In the example, *myzip* is closed after the
    ...
    New in version 3.2: Added the ability to use [`ZipFile`](zipfile.md#zipfile.ZipFile "zipfile.ZipFile") as a context manager.
    ...
    Changed in version 3.6.2: The *file* parameter accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Access a member of the archive as a binary file-like object. *name*
    ...
    compressed text files in [universal newlines](https://docs.python.org/3.10/glossary.html#term-universal-newlines) mode.
...
:   Extract a member from the archive to the current working directory; *member*
    ...
    *pwd* is the password used for encrypted files as a [`bytes`](stdtypes.md#bytes "bytes") object.
    ...
    Changed in version 3.6.2: The *path* parameter accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Invoke [`ZipFile.open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open") on the current path.
    ...
    Changed in version 3.10.10: The `encoding` parameter can be supplied as a positional argument
...
:   New in version 3.2: The *optimize* parameter.
    ...
    :   Search for files `*.py` and add the corresponding file to the
        ...
        *filterfunc* to exclude them:
        ...
        Changed in version 3.6.2: The *pathname* parameter accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
...
:   Construct a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance for a file on the filesystem, in
    ...
    *filename* should be the path to a file or directory on the filesystem.
    ...
    Changed in version 3.6.2: The *filename* parameter accepts a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object).
