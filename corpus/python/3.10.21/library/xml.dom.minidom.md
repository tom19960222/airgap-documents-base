...
source_url: https://docs.python.org/3.10/library/xml.dom.minidom.html
fetched_at: 2026-09-17T15:14:22+00:00
---
# `xml.dom.minidom` — Minimal DOM implementation

**Source code:** [Lib/xml/dom/minidom.py](https://github.com/python/cpython/tree/3.10/Lib/xml/dom/minidom.py)
...
:   Break internal references within the DOM so that it will be garbage collected on
    ...
    You can avoid calling this method explicitly by using the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with)
...
- Operations are used as methods. Since the DOM uses only [`in`](https://docs.python.org/3.10/reference/expressions.html#in)
