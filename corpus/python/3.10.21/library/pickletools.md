...
source_url: https://docs.python.org/3.10/library/pickletools.html
fetched_at: 2026-09-17T15:15:11+00:00
---
# `pickletools` — Tools for pickle developers

**Source code:** [Lib/pickletools.py](https://github.com/python/cpython/tree/3.10/Lib/pickletools.py)

---

This module contains various constants relating to the intimate details of the
[`pickle`](pickle.md#module-pickle "pickle: Convert Python objects to streams of bytes and back.") module, some lengthy comments about the implementation, and a
few useful functions for analyzing pickled data. The contents of this module
are useful for Python core developers who are working on the [`pickle`](pickle.md#module-pickle "pickle: Convert Python objects to streams of bytes and back.");
ordinary users of the [`pickle`](pickle.md#module-pickle "pickle: Convert Python objects to streams of bytes and back.") module probably won’t find the
[`pickletools`](pickletools.md#module-pickletools "pickletools: Contains extensive comments about the pickle protocols and pickle-machine opcodes, as well as some useful functions.") module relevant.
...
:   Provides an [iterator](https://docs.python.org/3.10/glossary.html#term-iterator) over all of the opcodes in a pickle, returning a
