...
source_url: https://docs.python.org/3.10/library/importlib.html
fetched_at: 2026-09-17T15:15:05+00:00
---
# `importlib` — The implementation of `import`

New in version 3.1.

**Source code:** [Lib/importlib/__init__.py](https://github.com/python/cpython/tree/3.10/Lib/importlib/__init__.py)

---

## Introduction

The purpose of the [`importlib`](importlib.md#module-importlib "importlib: The implementation of the import machinery.") package is two-fold. One is to provide the
implementation of the [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) statement (and thus, by extension, the
...
Two, the components to implement [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) are exposed in this
package, making it easier for users to create their own custom objects (known
generically as an [importer](https://docs.python.org/3.10/glossary.html#term-importer)) to participate in the import process.

> **See also:**
>
> [The import statement](https://docs.python.org/3.10/reference/simple_stmts.html#import)
> :   The language reference for the [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) statement.
>
...
> :   The [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) statement is syntactic sugar for this function.
>
...
:   Find the loader for a module, optionally within the specified *path*. If the
    module is in [`sys.modules`](sys.md#sys.modules "sys.modules"), then `sys.modules[name].__loader__` is
    returned (unless the loader would be `None` or is not set, in which case
    [`ValueError`](exceptions.md#ValueError "ValueError") is raised). Otherwise a search using [`sys.meta_path`](sys.md#sys.meta_path "sys.meta_path")
    ...
    Changed in version 3.4: If `__loader__` is not set, raise [`ValueError`](exceptions.md#ValueError "ValueError"), just like when the
    attribute is set to `None`.

    Deprecated since version 3.4: Use [`importlib.util.find_spec()`](importlib.md#importlib.util.find_spec "importlib.util.find_spec") instead.
...
:   Reload a previously imported *module*. The argument must be a module object,
    ...
    - Python module’s code is recompiled and the module-level code re-executed,
      ...
      dictionary by reusing the [loader](https://docs.python.org/3.10/glossary.html#term-loader) which originally loaded the
    ...
    maintains a global table or cache of objects — with a [`try`](https://docs.python.org/3.10/reference/compound_stmts.html#try)
    ...
    [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import) …, calling [`reload()`](importlib.md#importlib.reload "importlib.reload") for the other module does not
...
**Source code:** [Lib/importlib/abc.py](https://github.com/python/cpython/tree/3.10/Lib/importlib/abc.py)
...
used by [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import). Some subclasses of the core abstract base classes
...
:   An abstract base class representing a [finder](https://docs.python.org/3.10/glossary.html#term-finder).

    Deprecated since version 3.3: Use [`MetaPathFinder`](importlib.md#importlib.abc.MetaPathFinder "importlib.abc.MetaPathFinder") or [`PathEntryFinder`](importlib.md#importlib.abc.PathEntryFinder "importlib.abc.PathEntryFinder") instead.

    `abstractmethod find_module(fullname, path=None)`
    :   An abstract method for finding a [loader](https://docs.python.org/3.10/glossary.html#term-loader) for the specified
        module. Originally specified in [**PEP 302**](https://www.python.org/dev/peps/pep-0302), this method was meant
        for use in [`sys.meta_path`](sys.md#sys.meta_path "sys.meta_path") and in the path-based import subsystem.
        ...
        Deprecated since version 3.10: Implement [`MetaPathFinder.find_spec()`](importlib.md#importlib.abc.MetaPathFinder.find_spec "importlib.abc.MetaPathFinder.find_spec") or
        [`PathEntryFinder.find_spec()`](importlib.md#importlib.abc.PathEntryFinder.find_spec "importlib.abc.PathEntryFinder.find_spec") instead.

`class importlib.abc.MetaPathFinder`
:   An abstract base class representing a [meta path finder](https://docs.python.org/3.10/glossary.html#term-meta-path-finder).

    New in version 3.3.

    Changed in version 3.10: No longer a subclass of [`Finder`](importlib.md#importlib.abc.Finder "importlib.abc.Finder").

    `find_spec(fullname, path, target=None)`
    :   An abstract method for finding a [spec](https://docs.python.org/3.10/glossary.html#term-module-spec) for
        the specified module. If this is a top-level import, *path* will
        be `None`. Otherwise, this is a search for a subpackage or
        module and *path* will be the value of [`__path__`](https://docs.python.org/3.10/reference/import.html#path__ "__path__") from the
    ...
    :   A legacy method for finding a [loader](https://docs.python.org/3.10/glossary.html#term-loader) for the specified
        module. If this is a top-level import, *path* will be `None`.
        Otherwise, this is a search for a subpackage or module and *path*
        will be the value of [`__path__`](https://docs.python.org/3.10/reference/import.html#path__ "__path__") from the parent
        package. If a loader cannot be found, `None` is returned.

        If [`find_spec()`](importlib.md#importlib.abc.MetaPathFinder.find_spec "importlib.abc.MetaPathFinder.find_spec") is defined, backwards-compatible functionality is
        provided.

        Changed in version 3.4: Returns `None` when called instead of raising
        [`NotImplementedError`](exceptions.md#NotImplementedError "NotImplementedError"). Can use [`find_spec()`](importlib.md#importlib.abc.MetaPathFinder.find_spec "importlib.abc.MetaPathFinder.find_spec") to provide
        functionality.

        Deprecated since version 3.4: Use [`find_spec()`](importlib.md#importlib.abc.MetaPathFinder.find_spec "importlib.abc.MetaPathFinder.find_spec") instead.
...
:   An abstract base class representing a [path entry finder](https://docs.python.org/3.10/glossary.html#term-path-entry-finder). Though
    ...
    :   An abstract method for finding a [spec](https://docs.python.org/3.10/glossary.html#term-module-spec) for
        ...
        within the [path entry](https://docs.python.org/3.10/glossary.html#term-path-entry) to which it is assigned. If a spec
    ...
    :   A legacy method for finding a [loader](https://docs.python.org/3.10/glossary.html#term-loader) for the specified
        ...
        If [`find_spec()`](importlib.md#importlib.abc.PathEntryFinder.find_spec "importlib.abc.PathEntryFinder.find_spec") is defined then backwards-compatible functionality is
        provided.

        Changed in version 3.4: Returns `(None, [])` instead of raising [`NotImplementedError`](exceptions.md#NotImplementedError "NotImplementedError").
        Uses [`find_spec()`](importlib.md#importlib.abc.PathEntryFinder.find_spec "importlib.abc.PathEntryFinder.find_spec") when available to provide functionality.

        Deprecated since version 3.4: Use [`find_spec()`](importlib.md#importlib.abc.PathEntryFinder.find_spec "importlib.abc.PathEntryFinder.find_spec") instead.

    `find_module(fullname)`
    :   A concrete implementation of [`Finder.find_module()`](importlib.md#importlib.abc.Finder.find_module "importlib.abc.Finder.find_module") which is
...
:   An abstract base class for a [loader](https://docs.python.org/3.10/glossary.html#term-loader).
    See [**PEP 302**](https://www.python.org/dev/peps/pep-0302) for the exact definition for a loader.

    Loaders that wish to support resource reading should implement a
    `get_resource_reader(fullname)` method as specified by
    [`importlib.abc.ResourceReader`](importlib.md#importlib.abc.ResourceReader "importlib.abc.ResourceReader").
    ...
    :   A legacy method for loading a module. If the module cannot be
        ...
        alone (see [`importlib.util.module_for_loader()`](importlib.md#importlib.util.module_for_loader "importlib.util.module_for_loader")).

        The loader should set several attributes on the module.
        (Note that some of these attributes can change when a module is
        reloaded):

        - [`__name__`](https://docs.python.org/3.10/reference/import.html#name__ "__name__")
          :   The name of the module.
        - [`__file__`](https://docs.python.org/3.10/reference/import.html#file__ "__file__")
          :   The path to where the module data is stored (not set for built-in
              modules).
        - [`__cached__`](https://docs.python.org/3.10/reference/import.html#cached__ "__cached__")
          :   The path to where a compiled version of the module is/should be
              stored (not set when the attribute would be inappropriate).
        - [`__path__`](https://docs.python.org/3.10/reference/import.html#path__ "__path__")
          :   A list of strings specifying the search path within a
              package. This attribute is not set on modules.
        - [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__")
          :   The fully qualified name of the package under which the module was
              ...
              For packages, it is the same as [`__name__`](https://docs.python.org/3.10/reference/import.html#name__ "__name__"). The
              [`importlib.util.module_for_loader()`](importlib.md#importlib.util.module_for_loader "importlib.util.module_for_loader") decorator can handle the
              details for [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__").
        - [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__")
        ...
        Deprecated since version 3.4: The recommended API for loading a module is [`exec_module()`](importlib.md#importlib.abc.Loader.exec_module "importlib.abc.Loader.exec_module")
        (and [`create_module()`](importlib.md#importlib.abc.Loader.create_module "importlib.abc.Loader.create_module")). Loaders should implement
...
:   *Superseded by TraversableResources*
    ...
    An [abstract base class](https://docs.python.org/3.10/glossary.html#term-abstract-base-class) to provide the ability to read
    *resources*.
    ...
    expected to be a [path-like object](https://docs.python.org/3.10/glossary.html#term-path-like-object) which represents
    ...
    :   Returns an opened, [file-like object](https://docs.python.org/3.10/glossary.html#term-file-like-object) for binary reading
        of the *resource*.
    ...
    :   Returns an [iterable](https://docs.python.org/3.10/glossary.html#term-iterable) of strings over the contents of
...
:   An abstract base class for a [loader](https://docs.python.org/3.10/glossary.html#term-loader) which implements the optional
    [**PEP 302**](https://www.python.org/dev/peps/pep-0302) protocol for loading arbitrary resources from the storage
    back-end.

    Deprecated since version 3.7: This ABC is deprecated in favour of supporting resource loading
    through [`importlib.abc.ResourceReader`](importlib.md#importlib.abc.ResourceReader "importlib.abc.ResourceReader").
    ...
    :   An abstract method to return the bytes for the data located at *path*.
        ...
        [`__file__`](https://docs.python.org/3.10/reference/import.html#file__ "__file__") attribute or an item from a package’s [`__path__`](https://docs.python.org/3.10/reference/import.html#path__ "__path__").
...
:   An abstract base class for a [loader](https://docs.python.org/3.10/glossary.html#term-loader) which implements the optional
    [**PEP 302**](https://www.python.org/dev/peps/pep-0302) protocol for loaders that inspect modules.
    ...
    :   An abstract method to return the source of a module. It is returned as
        a text string using [universal newlines](https://docs.python.org/3.10/glossary.html#term-universal-newlines), translating all
    ...
    :   An optional method to return a true value if the module is a package, a
        ...
        [loader](https://docs.python.org/3.10/glossary.html#term-loader) cannot find the module.
    ...
    :   Implementation of [`Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module").
        ...
        Deprecated since version 3.4: use [`exec_module()`](importlib.md#importlib.abc.InspectLoader.exec_module "importlib.abc.InspectLoader.exec_module") instead.
...
:   An abstract base class which inherits from [`InspectLoader`](importlib.md#importlib.abc.InspectLoader "importlib.abc.InspectLoader") that,
    ...
    represents an optional [**PEP 302**](https://www.python.org/dev/peps/pep-0302) protocol.

    `abstractmethod get_filename(fullname)`
    :   An abstract method that is to return the value of [`__file__`](https://docs.python.org/3.10/reference/import.html#file__ "__file__") for
        the specified module. If no path is available, [`ImportError`](exceptions.md#ImportError "ImportError") is
        raised.
...
:   An abstract base class which inherits from [`ResourceLoader`](importlib.md#importlib.abc.ResourceLoader "importlib.abc.ResourceLoader") and
    ...
    :   Calls super’s `load_module()`.
        ...
        Deprecated since version 3.4: Use [`Loader.exec_module()`](importlib.md#importlib.abc.Loader.exec_module "importlib.abc.Loader.exec_module") instead.
...
:   An abstract base class for implementing source (and optionally bytecode)
    ...
    :   Concrete implementation of [`Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module").
        ...
        Deprecated since version 3.4: Use [`exec_module()`](importlib.md#importlib.abc.SourceLoader.exec_module "importlib.abc.SourceLoader.exec_module") instead.
...
:   An object with a subset of [`pathlib.Path`](pathlib.md#pathlib.Path "pathlib.Path") methods suitable for
    ...
    [`importlib.resources.as_file()`](importlib.md#importlib.resources.as_file "importlib.resources.as_file").
...
**Source code:** [Lib/importlib/resources.py](https://github.com/python/cpython/tree/3.10/Lib/importlib/resources.py)
...
> Resource Access](http://setuptools.readthedocs.io/en/latest/pkg_resources.html#basic-resource-access)
> without the performance overhead of that package. This makes reading
> resources included in packages easier, with more stable and consistent
> semantics.
>
> The standalone backport of this module provides more information
> on [using importlib.resources](http://importlib-resources.readthedocs.io/en/latest/using.html) and
> [migrating from pkg_resources to importlib.resources](http://importlib-resources.readthedocs.io/en/latest/migration.html).
...
:   Returns an [`importlib.abc.Traversable`](importlib.md#importlib.abc.Traversable "importlib.abc.Traversable") object
...
:   Given a [`importlib.abc.Traversable`](importlib.md#importlib.abc.Traversable "importlib.abc.Traversable") object representing
    a file, typically from [`importlib.resources.files()`](importlib.md#importlib.resources.files "importlib.resources.files"), return
    a context manager for use in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement.
...
:   Return the path to the *resource* as an actual file system path. This
    function returns a context manager for use in a [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement.
    The context manager provides a [`pathlib.Path`](pathlib.md#pathlib.Path "pathlib.Path") object.
...
**Source code:** [Lib/importlib/machinery.py](https://github.com/python/cpython/tree/3.10/Lib/importlib/machinery.py)

---

This module contains the various objects that help [`import`](https://docs.python.org/3.10/reference/simple_stmts.html#import)
...
:   An [importer](https://docs.python.org/3.10/glossary.html#term-importer) for built-in modules. All known built-in modules are
    ...
    Changed in version 3.5: As part of [**PEP 489**](https://www.python.org/dev/peps/pep-0489), the builtin importer now implements
    `Loader.create_module()` and `Loader.exec_module()`

`class importlib.machinery.FrozenImporter`
:   An [importer](https://docs.python.org/3.10/glossary.html#term-importer) for frozen modules. This class implements the
    [`importlib.abc.MetaPathFinder`](importlib.md#importlib.abc.MetaPathFinder "importlib.abc.MetaPathFinder") and
    [`importlib.abc.InspectLoader`](importlib.md#importlib.abc.InspectLoader "importlib.abc.InspectLoader") ABCs.
...
:   [Finder](https://docs.python.org/3.10/glossary.html#term-finder) for modules declared in the Windows registry. This class
...
:   A [Finder](https://docs.python.org/3.10/glossary.html#term-finder) for [`sys.path`](sys.md#sys.path "sys.path") and package `__path__` attributes.
    ...
    :   Class method that attempts to find a [spec](https://docs.python.org/3.10/glossary.html#term-module-spec)
        ...
        is found then it is used as the [path entry finder](https://docs.python.org/3.10/glossary.html#term-path-entry-finder) to look
    ...
    :   A legacy wrapper around [`find_spec()`](importlib.md#importlib.machinery.PathFinder.find_spec "importlib.machinery.PathFinder.find_spec").

        Deprecated since version 3.4: Use [`find_spec()`](importlib.md#importlib.machinery.PathFinder.find_spec "importlib.machinery.PathFinder.find_spec") instead.
...
:   A concrete implementation of [`importlib.abc.PathEntryFinder`](importlib.md#importlib.abc.PathEntryFinder "importlib.abc.PathEntryFinder") which
    ...
    `find_loader(fullname)`
    :   Attempt to find the loader to handle *fullname* within [`path`](importlib.md#importlib.machinery.FileFinder.path "importlib.machinery.FileFinder.path").

        Deprecated since version 3.10: Use [`find_spec()`](importlib.md#importlib.machinery.FileFinder.find_spec "importlib.machinery.FileFinder.find_spec") instead.
...
:   A concrete implementation of [`importlib.abc.SourceLoader`](importlib.md#importlib.abc.SourceLoader "importlib.abc.SourceLoader") by
    ...
    :   Concrete implementation of [`importlib.abc.Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module") where
        ...
        Deprecated since version 3.6: Use [`importlib.abc.Loader.exec_module()`](importlib.md#importlib.abc.Loader.exec_module "importlib.abc.Loader.exec_module") instead.
...
:   A concrete implementation of [`importlib.abc.ExecutionLoader`](importlib.md#importlib.abc.ExecutionLoader "importlib.abc.ExecutionLoader") for
    ...
    :   Creates the module object from the given specification in accordance
        with [**PEP 489**](https://www.python.org/dev/peps/pep-0489).

        New in version 3.5.

    `exec_module(module)`
    :   Initializes the given module object in accordance with [**PEP 489**](https://www.python.org/dev/peps/pep-0489).
...
:   A specification for a module’s import-system-related state. This is
    ...
    The [Loader](https://docs.python.org/3.10/glossary.html#term-loader) that should be used when loading
    the module. [Finders](https://docs.python.org/3.10/glossary.html#term-finder) should always set this.
    ...
    For packages, it is the same as [`__name__`](https://docs.python.org/3.10/reference/import.html#name__ "__name__").
...
**Source code:** [Lib/importlib/util.py](https://github.com/python/cpython/tree/3.10/Lib/importlib/util.py)

---

This module contains the various objects that help in the construction of
an [importer](https://docs.python.org/3.10/glossary.html#term-importer).
...
:   Return the [**PEP 3147**](https://www.python.org/dev/peps/pep-3147)/[**PEP 488**](https://www.python.org/dev/peps/pep-0488) path to the byte-compiled file associated
...
:   Given the *path* to a [**PEP 3147**](https://www.python.org/dev/peps/pep-3147) file name, return the associated source code
    ...
    to [**PEP 3147**](https://www.python.org/dev/peps/pep-3147) or [**PEP 488**](https://www.python.org/dev/peps/pep-0488) format, a [`ValueError`](exceptions.md#ValueError "ValueError") is raised. If
...
:   Resolve a relative module name to an absolute one.
    ...
    **package** is a false value (e.g. `None` or the empty string).
    [`ImportError`](exceptions.md#ImportError "ImportError") is also raised a relative name would escape its containing
...
:   Find the [spec](https://docs.python.org/3.10/glossary.html#term-module-spec) for a module, optionally relative to
    ...
    **package** is in fact not a package (i.e. lacks a [`__path__`](https://docs.python.org/3.10/reference/import.html#path__ "__path__")
    attribute).
...
:   A [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) for [`importlib.abc.Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module")
    ...
    as expected for a [loader](https://docs.python.org/3.10/glossary.html#term-loader). If the module is not found in
    [`sys.modules`](sys.md#sys.modules "sys.modules") then a new one is constructed. Regardless of where the
    module came from, [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__") set to **self** and [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__")
    is set based on what [`importlib.abc.InspectLoader.is_package()`](importlib.md#importlib.abc.InspectLoader.is_package "importlib.abc.InspectLoader.is_package") returns
    (if available). These attributes are set unconditionally to support
    reloading.

    If an exception is raised by the decorated method and a module was added to
    [`sys.modules`](sys.md#sys.modules "sys.modules"), then the module will be removed to prevent a partially
    initialized module from being in left in [`sys.modules`](sys.md#sys.modules "sys.modules"). If the module
    was already in [`sys.modules`](sys.md#sys.modules "sys.modules") then it is left alone.

    Changed in version 3.3: [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__") and [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__") are automatically set
    (when possible).

    Changed in version 3.4: Set [`__name__`](https://docs.python.org/3.10/reference/import.html#name__ "__name__"), [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__") [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__")
...
:   A [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) for [`importlib.abc.Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module")
    to set the [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__")
    ...
    the wrapped method (i.e. `self`) is what [`__loader__`](https://docs.python.org/3.10/reference/import.html#loader__ "__loader__") should be set
    to.
...
:   A [decorator](https://docs.python.org/3.10/glossary.html#term-decorator) for [`importlib.abc.Loader.load_module()`](importlib.md#importlib.abc.Loader.load_module "importlib.abc.Loader.load_module") to set the
    [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__") attribute on the returned module. If [`__package__`](https://docs.python.org/3.10/reference/import.html#package__ "__package__")
...
:   A factory function for creating a [`ModuleSpec`](importlib.md#importlib.machinery.ModuleSpec "importlib.machinery.ModuleSpec")
    ...
    for ModuleSpec. The function uses available [loader](https://docs.python.org/3.10/glossary.html#term-loader) APIs, such as
...
:   A class which postpones the execution of the loader of a module until the
    ...
    using [slots](https://docs.python.org/3.10/glossary.html#term-__slots__). Finally, modules which substitute the object
...
[importer](https://docs.python.org/3.10/glossary.html#term-importer). This means managing both the [finder](https://docs.python.org/3.10/glossary.html#term-finder) and [loader](https://docs.python.org/3.10/glossary.html#term-loader)
side of things. For finders there are two flavours to choose from depending on
your needs: a [meta path finder](https://docs.python.org/3.10/glossary.html#term-meta-path-finder) or a [path entry finder](https://docs.python.org/3.10/glossary.html#term-path-entry-finder). The
former is what you would put on [`sys.meta_path`](sys.md#sys.meta_path "sys.meta_path") while the latter is what
you create using a [path entry hook](https://docs.python.org/3.10/glossary.html#term-path-entry-hook) on [`sys.path_hooks`](sys.md#sys.path_hooks "sys.path_hooks") which works
...
[`importlib.import_module()`](importlib.md#importlib.import_module "importlib.import_module") (Python 3.4 and newer for the importlib usage,
