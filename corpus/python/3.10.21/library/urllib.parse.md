...
source_url: https://docs.python.org/3.10/library/urllib.parse.html
fetched_at: 2026-09-17T15:14:27+00:00
---
# `urllib.parse` — Parse URLs into components

**Source code:** [Lib/urllib/parse.py](https://github.com/python/cpython/tree/3.10/Lib/urllib/parse.py)
...
:   Parse a URL into six components, returning a 6-item [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple). This
    ...
    The return value is a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple), which means that its items can
...
:   This is similar to [`urlparse()`](urllib.parse.md#urllib.parse.urlparse "urllib.parse.urlparse"), but does not split the params from the URL.
    ...
    The return value is a [named tuple](https://docs.python.org/3.10/glossary.html#term-named-tuple), its items can be accessed by index
    ...
    Changed in version 3.10.12: Leading WHATWG C0 control and space characters are stripped from the URL.
