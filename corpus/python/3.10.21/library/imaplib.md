...
source_url: https://docs.python.org/3.10/library/imaplib.html
fetched_at: 2026-09-17T15:14:30+00:00
---
# `imaplib` — IMAP4 protocol client

**Source code:** [Lib/imaplib.py](https://github.com/python/cpython/tree/3.10/Lib/imaplib.py)

---

This module defines three classes, [`IMAP4`](imaplib.md#imaplib.IMAP4 "imaplib.IMAP4"), [`IMAP4_SSL`](imaplib.md#imaplib.IMAP4_SSL "imaplib.IMAP4_SSL") and
[`IMAP4_stream`](imaplib.md#imaplib.IMAP4_stream "imaplib.IMAP4_stream"), which encapsulate a connection to an IMAP4 server and
...
:   This class implements the actual IMAP4 protocol. The connection is created and
    ...
    *port* is omitted, the standard IMAP4 port (143) is used. The optional *timeout*
    ...
    The [`IMAP4`](imaplib.md#imaplib.IMAP4 "imaplib.IMAP4") class supports the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. When used
    ...
    Changed in version 3.5: Support for the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement was added.
...
:   This is a subclass derived from [`IMAP4`](imaplib.md#imaplib.IMAP4 "imaplib.IMAP4") that connects over an SSL
    ...
    *ssl_context* is a [`ssl.SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") object which allows bundling
    ...
    *keyfile* and *certfile* are a legacy alternative to *ssl_context* - they
    ...
    mutually exclusive with *ssl_context*, a [`ValueError`](exceptions.md#ValueError "ValueError") is raised
...
:   Convert *date_time* to an IMAP4 `INTERNALDATE` representation.
    ...
    returned by [`time.time()`](time.md#time.time "time.time")), a 9-tuple representing local time
    an instance of [`time.struct_time`](time.md#time.struct_time "time.struct_time") (as returned by
    [`time.localtime()`](time.md#time.localtime "time.localtime")), an aware instance of
    [`datetime.datetime`](datetime.md#datetime.datetime "datetime.datetime"), or a double-quoted string. In the last
...
:   Enable *capability* (see [**RFC 5161**](https://datatracker.ietf.org/doc/html/rfc5161.html)). Most capabilities do not need to be
    ...
    New in version 3.5: The [`enable()`](imaplib.md#imaplib.IMAP4.enable "imaplib.IMAP4.enable") method itself, and [**RFC 6855**](https://datatracker.ietf.org/doc/html/rfc6855.html) support.
...
:   Opens socket to *port* at *host*. The optional *timeout* parameter
    ...
    it will raise a [`ValueError`](exceptions.md#ValueError "ValueError") to reject creating a non-blocking socket.
    This method is implicitly called by the [`IMAP4`](imaplib.md#imaplib.IMAP4 "imaplib.IMAP4") constructor.
    The connection objects established by this method will be used in
    the [`IMAP4.read()`](imaplib.md#imaplib.IMAP4.read "imaplib.IMAP4.read"), [`IMAP4.readline()`](imaplib.md#imaplib.IMAP4.readline "imaplib.IMAP4.readline"), [`IMAP4.send()`](imaplib.md#imaplib.IMAP4.send "imaplib.IMAP4.send"),
    and [`IMAP4.shutdown()`](imaplib.md#imaplib.IMAP4.shutdown "imaplib.IMAP4.shutdown") methods. You may override this method.
...
:   Search mailbox for matching messages. *charset* may be `None`, in which case
    ...
    the `UTF8=ACCEPT` capability was enabled using the [`enable()`](imaplib.md#imaplib.IMAP4.enable "imaplib.IMAP4.enable")
    command.
