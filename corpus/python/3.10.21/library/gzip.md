...
source_url: https://docs.python.org/3.10/library/gzip.html
fetched_at: 2026-09-17T15:13:53+00:00
---
# `gzip` — Support for **gzip** files

**Source code:** [Lib/gzip.py](https://github.com/python/cpython/tree/3.10/Lib/gzip.py)
...
ordinary [file object](https://docs.python.org/3.10/glossary.html#term-file-object).
...
:   An exception raised for invalid gzip files. It inherits [`OSError`](exceptions.md#OSError "OSError").
...
:   Constructor for the [`GzipFile`](gzip.md#gzip.GzipFile "gzip.GzipFile") class, which simulates most of the
    methods of a [file object](https://docs.python.org/3.10/glossary.html#term-file-object), with the exception of the `truncate()`
    ...
    *fileobj*, since you might wish to append more material after the compressed
    ...
    including iteration and the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement. Only the
    ...
    Changed in version 3.1: Support for the [`with`](https://docs.python.org/3.10/reference/compound_stmts.html#with) statement was added, along with the
...
:   Compress the *data*, returning a [`bytes`](stdtypes.md#bytes "bytes") object containing
    ...
    the [`GzipFile`](gzip.md#gzip.GzipFile "gzip.GzipFile") constructor above.
