...
source_url: https://docs.python.org/3.12/library/random.html
...
:   Return a randomly selected element from `range(start, stop, step)`.
    ...
    The positional argument pattern matches the [`range()`](stdtypes.md#range "range") function.
...
:   Return a *k* sized list of elements chosen from the *population* with replacement.
    ...
    [`choice()`](random.md#random.choice "random.choice"). The algorithm used by [`choices()`](random.md#random.choices "random.choices") uses floating-point
...
:   Return a *k* length list of unique elements chosen from the population
    ...
    Members of the population need not be [hashable](https://docs.python.org/3.12/glossary.html#term-hashable) or unique. If the population
...
- If a new seeding method is added, then a backward compatible seeder will be
  offered.
- The generator’s [`random()`](random.md#random.Random.random "random.Random.random") method will continue to produce the same
...
from the combinatoric iterators in the [`itertools`](itertools.md#module-itertools "itertools: Functions creating iterators for efficient looping.") module:
