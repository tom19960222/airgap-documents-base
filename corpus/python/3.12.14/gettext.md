...
source_url: https://docs.python.org/3.12/library/gettext.html
fetched_at: 2026-09-17T15:34:18+00:00
---
# `gettext` — Multilingual internationalization services

**Source code:** [Lib/gettext.py](https://github.com/python/cpython/tree/3.12/Lib/gettext.py)
...
:   Return a `*Translations` instance based on the *domain*, *localedir*,
    ...
    take a single [file object](https://docs.python.org/3.12/glossary.html#term-file-object) argument.
...
it in `_('...')` — that is, a call to the function [`_`](gettext.md#module-gettext "gettext: Multilingual internationalization services."). For example:
...
of `_()` in the built-in namespace (until the [`del`](https://docs.python.org/3.12/reference/simple_stmts.html#del) command). Take
