...
source_url: https://docs.python.org/3.12/library/zoneinfo.html
fetched_at: 2026-09-17T15:32:23+00:00
---
...
flag --with-tzpath`](https://docs.python.org/3.12/using/configure.html#cmdoption-with-tzpath)), which should be a string delimited by
...
:   Constructs a `ZoneInfo` object from a file-like object returning bytes
    ...
    [`__str__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__str__ "object.__str__") and [`__repr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__repr__ "object.__repr__").
...
:   Sets or resets the time zone search path ([`TZPATH`](zoneinfo.md#zoneinfo.TZPATH "zoneinfo.TZPATH")) for the module.
    ...
    The `to` parameter must be a [sequence](https://docs.python.org/3.12/glossary.html#term-sequence) of strings or
