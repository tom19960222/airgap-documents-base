...
source_url: https://docs.python.org/3.12/library/tkinter.html
fetched_at: 2026-09-17T15:34:25+00:00
---
# `tkinter` — Python interface to Tcl/Tk

**Source code:** [Lib/tkinter/__init__.py](https://github.com/python/cpython/tree/3.12/Lib/tkinter/__init__.py)
...
threaded. See the source code for the [`_tkinter`](tkinter.md#module-_tkinter "_tkinter: A binary module that contains the low-level interface to Tcl/Tk.") module
...
Tcl command string to an internal [`_tkinter`](tkinter.md#module-_tkinter "_tkinter: A binary module that contains the low-level interface to Tcl/Tk.") binary module, which then
...
[`_tkinter`](tkinter.md#module-_tkinter "_tkinter: A binary module that contains the low-level interface to Tcl/Tk.")
...
Each `Tk` object created by [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") contains a Tcl interpreter.
...
- While [`tkinter`](tkinter.md#module-tkinter "tkinter: Interface to Tcl/Tk for graphical user interfaces") allows you to create more than one instance of a `Tk`
