...
source_url: https://docs.python.org/3.12/library/hashlib.html
fetched_at: 2026-09-17T15:33:08+00:00
---
...
SHA224, SHA256, SHA384, SHA512, (defined in [the FIPS 180-4 standard](https://csrc.nist.gov/pubs/fips/180-4/upd1/final)),
the SHA-3 series (defined in [the FIPS 202 standard](https://csrc.nist.gov/pubs/fips/202/final)) as well as RSA’s MD5
algorithm (defined in internet [**RFC 1321**](https://datatracker.ietf.org/doc/html/rfc1321.html)). The terms “secure hash” and
...
> the [`zlib`](zlib.md#module-zlib "zlib: Low-level interface to compression and decompression routines compatible with gzip.") module.

## Hash algorithms

There is one constructor method named for each type of *hash*. All return
a hash object with the same simple interface. For example: use [`sha256()`](hashlib.md#hashlib.sha256 "hashlib.sha256")
to create a SHA-256 hash object. You can now feed this object with
[bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) (normally [`bytes`](stdtypes.md#bytes "bytes")) using
the [`update`](hashlib.md#hashlib.hash.update "hashlib.hash.update") method. At any point you can ask it for the
*digest* of the concatenation of the data fed to it so far using the
[`digest()`](hashlib.md#hashlib.hash.digest "hashlib.hash.digest") or [`hexdigest()`](hashlib.md#hashlib.hash.hexdigest "hashlib.hash.hexdigest") methods.

To allow multithreading, the Python [GIL](https://docs.python.org/3.12/glossary.html#term-GIL) is released while computing a
hash supplied more than 2047 bytes of data at once in its constructor or
[`.update`](hashlib.md#hashlib.hash.update "hashlib.hash.update") method.

Constructors for hash algorithms that are always present in this module are
[`sha1()`](hashlib.md#hashlib.sha1 "hashlib.sha1"), [`sha224()`](hashlib.md#hashlib.sha224 "hashlib.sha224"), [`sha256()`](hashlib.md#hashlib.sha256 "hashlib.sha256"), [`sha384()`](hashlib.md#hashlib.sha384 "hashlib.sha384"), [`sha512()`](hashlib.md#hashlib.sha512 "hashlib.sha512"),
[`sha3_224()`](hashlib.md#hashlib.sha3_224 "hashlib.sha3_224"), [`sha3_256()`](hashlib.md#hashlib.sha3_256 "hashlib.sha3_256"), [`sha3_384()`](hashlib.md#hashlib.sha3_384 "hashlib.sha3_384"), [`sha3_512()`](hashlib.md#hashlib.sha3_512 "hashlib.sha3_512"),
[`shake_128()`](hashlib.md#hashlib.shake_128 "hashlib.shake_128"), [`shake_256()`](hashlib.md#hashlib.shake_256 "hashlib.shake_256"), [`blake2b()`](hashlib.md#hashlib.blake2b "hashlib.blake2b"), and [`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s").
[`md5()`](hashlib.md#hashlib.md5 "hashlib.md5") is normally available as well, though it may be missing or blocked
if you are using a rare “FIPS compliant” build of Python.
These correspond to [`algorithms_guaranteed`](hashlib.md#hashlib.algorithms_guaranteed "hashlib.algorithms_guaranteed").

Additional algorithms may also be available if your Python distribution’s
[`hashlib`](hashlib.md#module-hashlib "hashlib: Secure hash and message digest algorithms.") was linked against a build of OpenSSL that provides others.
Others *are not guaranteed available* on all installations and will only be
accessible by name via [`new()`](hashlib.md#hashlib.new "hashlib.new"). See [`algorithms_available`](hashlib.md#hashlib.algorithms_available "hashlib.algorithms_available").
...
> [hashlib-seealso](hashlib.md#hashlib-seealso) section at the end of this document.

Added in version 3.6: SHA3 (Keccak) and SHAKE constructors [`sha3_224()`](hashlib.md#hashlib.sha3_224 "hashlib.sha3_224"), [`sha3_256()`](hashlib.md#hashlib.sha3_256 "hashlib.sha3_256"),
[`sha3_384()`](hashlib.md#hashlib.sha3_384 "hashlib.sha3_384"), [`sha3_512()`](hashlib.md#hashlib.sha3_512 "hashlib.sha3_512"), [`shake_128()`](hashlib.md#hashlib.shake_128 "hashlib.shake_128"), [`shake_256()`](hashlib.md#hashlib.shake_256 "hashlib.shake_256")
were added.
[`blake2b()`](hashlib.md#hashlib.blake2b "hashlib.blake2b") and [`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s") were added.
...
Using [`new()`](hashlib.md#hashlib.new "hashlib.new") with an algorithm name:
...
:   Return a digest object that has been updated with contents of file object.
    ...
    *fileobj* must be a file-like object opened for reading in binary mode.
    It accepts file objects from builtin [`open()`](functions.md#open "open"), [`BytesIO`](io.md#io.BytesIO "io.BytesIO")
    instances, SocketIO objects from [`socket.socket.makefile()`](socket.md#socket.socket.makefile "socket.socket.makefile"), and
    similar. The function may bypass Python’s I/O and use the file descriptor
    from [`fileno()`](io.md#io.IOBase.fileno "io.IOBase.fileno") directly. *fileobj* must be assumed to be
...
:   The function provides PKCS#5 password-based key derivation function 2. It
    ...
    a proper source, e.g. [`os.urandom()`](os.md#os.urandom "os.urandom").
...
:   The function provides scrypt password-based key derivation function as
    ...
    *password* and *salt* must be [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object). Applications and libraries should limit *password*
    to a sensible length (e.g. 1024). *salt* should be about 16 or more
    bytes from a proper source, e.g. [`os.urandom()`](os.md#os.urandom "os.urandom").
...
[`hashlib`](hashlib.md#module-hashlib "hashlib: Secure hash and message digest algorithms.") objects.
...
- *data*: initial chunk of data to hash, which must be
  [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object). It can be passed only as positional argument.
...
These sizes are available as module [constants](hashlib.md#constants) described below.
...
calling the appropriate constructor function ([`blake2b()`](hashlib.md#hashlib.blake2b "hashlib.blake2b") or
[`blake2s()`](hashlib.md#hashlib.blake2s "hashlib.blake2s")), then update it with the data by calling [`update()`](hashlib.md#hashlib.hash.update "hashlib.hash.update") on the
object, and, finally, get the digest out of the object by calling
[`digest()`](hashlib.md#hashlib.hash.digest "hashlib.hash.digest") (or [`hexdigest()`](hashlib.md#hashlib.hash.hexdigest "hashlib.hash.hexdigest") for hex-encoded string).
...
You can call [`hash.update()`](hashlib.md#hashlib.hash.update "hashlib.hash.update") as many times as you need to iteratively
update the hash:
...
in HMAC construction with [`hmac`](hmac.md#module-hmac "hmac: Keyed-Hashing for Message Authentication (HMAC) implementation") module:
...
> **See also:**
>
> Module [`hmac`](hmac.md#module-hmac "hmac: Keyed-Hashing for Message Authentication (HMAC) implementation")
