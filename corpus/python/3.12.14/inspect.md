...
source_url: https://docs.python.org/3.12/library/inspect.html
fetched_at: 2026-09-17T15:35:05+00:00
---
...
attributes (see [Import-related attributes on module objects](https://docs.python.org/3.12/reference/datamodel.html#import-mod-attrs) for module attributes):
...
|  | __type_params__ | A tuple containing the [type parameters](https://docs.python.org/3.12/reference/compound_stmts.html#type-params) of a generic class |
...
|  | __qualname__ | qualified name |
|  | __code__ | code object containing compiled function [bytecode](https://docs.python.org/3.12/glossary.html#term-bytecode) |
...
|  | __type_params__ | A tuple containing the [type parameters](https://docs.python.org/3.12/reference/compound_stmts.html#type-params) of a generic function |
...
:   Return all the members of an object in a list of `(name, value)`
    ...
    > **Note:**
    >
    > [`getmembers_static()`](inspect.md#inspect.getmembers_static "inspect.getmembers_static") may not be able to retrieve all members
...
:   Return `True` if the object is a [coroutine function](https://docs.python.org/3.12/glossary.html#term-coroutine-function) (a function
    ...
    [`markcoroutinefunction()`](inspect.md#inspect.markcoroutinefunction "inspect.markcoroutinefunction").

    Added in version 3.5.

    Changed in version 3.8: Functions wrapped in [`functools.partial()`](functools.md#functools.partial "functools.partial") now return `True` if the
    wrapped function is a [coroutine function](https://docs.python.org/3.12/glossary.html#term-coroutine-function).
...
:   Decorator to mark a callable as a [coroutine function](https://docs.python.org/3.12/glossary.html#term-coroutine-function) if it would not
    ...
    This may be of use for sync functions that return a [coroutine](https://docs.python.org/3.12/glossary.html#term-coroutine), if
    the function is passed to an API that requires [`iscoroutinefunction()`](inspect.md#inspect.iscoroutinefunction "inspect.iscoroutinefunction").

    When possible, using an [`async def`](https://docs.python.org/3.12/reference/compound_stmts.html#async-def) function is preferred. Also
    acceptable is calling the function and testing the return with
    [`iscoroutine()`](inspect.md#inspect.iscoroutine "inspect.iscoroutine").
...
:   Return `True` if the type of object is a [`MethodWrapperType`](types.md#types.MethodWrapperType "types.MethodWrapperType").
    ...
    [`__eq__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__eq__ "object.__eq__") and [`__repr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__repr__ "object.__repr__").
...
:   Return `True` if the object is a method descriptor, but not if
    ...
    has a [`__get__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__get__ "object.__get__") method but not a [`__set__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__set__ "object.__set__")
    method, but beyond that the set of attributes varies. A
    [`__name__`](stdtypes.md#definition.__name__ "definition.__name__") attribute is usually
    sensible, and [`__doc__`](stdtypes.md#definition.__doc__ "definition.__doc__") often is.
...
:   Return `True` if the object is a member descriptor.
    ...
    **CPython implementation detail:** Member descriptors are attributes defined in extension modules via
    [`PyMemberDef`](https://docs.python.org/3.12/c-api/structures.html#c.PyMemberDef "PyMemberDef") structures. For Python implementations without such
    types, this method will always return `False`.
...
The [`Signature`](inspect.md#inspect.Signature "inspect.Signature") object represents the call signature of a callable object
...
:   Return a [`Signature`](inspect.md#inspect.Signature "inspect.Signature") object for the given *callable*:
    ...
    [`get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations"). The
    *globals*, *locals*, and *eval_str* parameters are passed
    into [`get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations") when resolving the
    annotations; see the documentation for [`get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations")
    ...
    the `eval()` call(s) to un-stringize the annotations in [`get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations")
...
:   A `Signature` object represents the call signature of a function
    ...
    :   Return a [`Signature`](inspect.md#inspect.Signature "inspect.Signature") (or its subclass) object for a given callable
        *obj*.
        ...
        Its behavior is otherwise identical to that of [`signature()`](inspect.md#inspect.signature "inspect.signature").
...
:   `Parameter` objects are *immutable*.
    ...
    Changed in version 3.4: In Python 3.3 [`Parameter`](inspect.md#inspect.Parameter "inspect.Parameter") objects were allowed to have `name` set
...
:   Compute the annotations dict for an object.
    ...
    - If `obj` is a callable, `globals` defaults to
      [`obj.__globals__`](https://docs.python.org/3.12/reference/datamodel.html#function.__globals__ "function.__globals__"),
      although if `obj` is a wrapped function (using
      [`functools.update_wrapper()`](functools.md#functools.update_wrapper "functools.update_wrapper")) it is first unwrapped.

    Calling `get_annotations` is best practice for accessing the
    annotations dict of any object. See [Annotations Best Practices](https://docs.python.org/3.12/howto/annotations.html#annotations-howto) for
...
[`FrameInfo`](inspect.md#inspect.FrameInfo "inspect.FrameInfo") objects. For backwards compatibility these objects allow
...
:   `frame`
    ...
    Changed in version 3.5: Return a [named tuple](https://docs.python.org/3.12/glossary.html#term-named-tuple) instead of a [`tuple`](stdtypes.md#tuple "tuple").
...
> [`finally`](https://docs.python.org/3.12/reference/compound_stmts.html#finally) clause. This is also important if the cycle detector was
...
> [`frame.clear()`](https://docs.python.org/3.12/reference/datamodel.html#frame.clear "frame.clear") method.
...
:   Get a list of [`FrameInfo`](inspect.md#inspect.FrameInfo "inspect.FrameInfo") objects for a frame and all outer frames.
    ...
    Changed in version 3.5: A list of [named tuples](https://docs.python.org/3.12/glossary.html#term-named-tuple)
...
properties, will be invoked and [`__getattr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattr__ "object.__getattr__") and
[`__getattribute__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattribute__ "object.__getattribute__")
may be called.
...
:   Retrieve attributes without triggering dynamic lookup via the
    ...
    If the instance [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#object.__dict__ "object.__dict__") is shadowed by another member (for
...
:   Get the mapping of live local variables in *generator* to their current
    ...
    If *generator* is a [generator](https://docs.python.org/3.12/glossary.html#term-generator) with no currently associated frame,
