...
source_url: https://docs.python.org/3.12/library/nis.html
fetched_at: 2026-09-17T15:35:40+00:00
---
# `nis` — Interface to Sun’s NIS (Yellow Pages)

Deprecated since version 3.11, will be removed in version 3.13: The [`nis`](nis.md#module-nis "nis: Interface to Sun's NIS (Yellow Pages) library. (deprecated) (Unix)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#nis) for details).
