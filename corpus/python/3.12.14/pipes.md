...
source_url: https://docs.python.org/3.12/library/pipes.html
fetched_at: 2026-09-17T15:35:43+00:00
---
# `pipes` — Interface to shell pipelines

**Source code:** [Lib/pipes.py](https://github.com/python/cpython/tree/3.12/Lib/pipes.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`pipes`](pipes.md#module-pipes "pipes: A Python interface to Unix shell pipelines. (deprecated) (Unix)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#pipes) for details).
