...
source_url: https://docs.python.org/3.12/library/xml.dom.html
fetched_at: 2026-09-17T15:33:53+00:00
---
# `xml.dom` — The Document Object Model API

**Source code:** [Lib/xml/dom/__init__.py](https://github.com/python/cpython/tree/3.12/Lib/xml/dom/__init__.py)
...
function [`getDOMImplementation()`](xml.dom.md#xml.dom.getDOMImplementation "xml.dom.getDOMImplementation"). DOM Level 3 adds a Load/Store
...
[Conformance](xml.dom.md#dom-conformance) for a detailed discussion of mapping requirements.
...
> :   The W3C recommendation for the DOM supported by [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.").
>
...
:   Return a suitable DOM implementation. The *name* is either well-known, the
    ...
    [`ImportError`](exceptions.md#ImportError "ImportError"). The features list must be a sequence of `(feature,
...
In addition, [`xml.dom`](xml.dom.md#module-xml.dom "xml.dom: Document Object Model API for Python.") contains a base `Node` class and the DOM
...
| --- | --- | --- |
| `DOMImplementation` | [DOMImplementation Objects](xml.dom.md#dom-implementation-objects) | Interface to the underlying implementation. |
| `Node` | [Node Objects](xml.dom.md#dom-node-objects) | Base interface for most objects in a document. |
| `NodeList` | [NodeList Objects](xml.dom.md#dom-nodelist-objects) | Interface for a sequence of nodes. |
| `DocumentType` | [DocumentType Objects](xml.dom.md#dom-documenttype-objects) | Information about the declarations needed to process a document. |
| `Document` | [Document Objects](xml.dom.md#dom-document-objects) | Object which represents an entire document. |
| `Element` | [Element Objects](xml.dom.md#dom-element-objects) | Element nodes in the document hierarchy. |
| `Attr` | [Attr Objects](xml.dom.md#dom-attr-objects) | Attribute value nodes on element nodes. |
| `Comment` | [Comment Objects](xml.dom.md#dom-comment-objects) | Representation of comments in the source document. |
| `Text` | [Text and CDATASection Objects](xml.dom.md#dom-text-objects) | Nodes containing textual content from the document. |
| `ProcessingInstruction` | [ProcessingInstruction Objects](xml.dom.md#dom-pi-objects) | Processing instruction representation. |
...
:   Return a new `Document` object (the root of the DOM), with a child
    ...
    *doctype* must be a `DocumentType` object created by
    [`createDocumentType()`](xml.dom.md#xml.dom.DOMImplementation.createDocumentType "xml.dom.DOMImplementation.createDocumentType"), or `None`. In the Python DOM API, the first two
...
[`__len__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__len__ "object.__len__") and
[`__getitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getitem__ "object.__getitem__"); this allows iteration over the `NodeList` in
[`for`](https://docs.python.org/3.12/reference/compound_stmts.html#for) statements and proper support for the [`len()`](functions.md#len "len") built-in
function.

If a DOM implementation supports modification of the document, the
`NodeList` implementation must also support the
[`__setitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__setitem__ "object.__setitem__") and [`__delitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__delitem__ "object.__delitem__") methods.
...
The DOM Level 2 recommendation defines a single exception, [`DOMException`](xml.dom.md#xml.dom.DOMException "xml.dom.DOMException"),
and a number of constants that allow applications to determine what sort of
error occurred. [`DOMException`](xml.dom.md#xml.dom.DOMException "xml.dom.DOMException") instances carry a [`code`](code.md#module-code "code: Facilities to implement read-eval-print loops.") attribute
...
| Constant | Exception |
| --- | --- |
| `DOMSTRING_SIZE_ERR` | [`DomstringSizeErr`](xml.dom.md#xml.dom.DomstringSizeErr "xml.dom.DomstringSizeErr") |
| `HIERARCHY_REQUEST_ERR` | [`HierarchyRequestErr`](xml.dom.md#xml.dom.HierarchyRequestErr "xml.dom.HierarchyRequestErr") |
| `INDEX_SIZE_ERR` | [`IndexSizeErr`](xml.dom.md#xml.dom.IndexSizeErr "xml.dom.IndexSizeErr") |
| `INUSE_ATTRIBUTE_ERR` | [`InuseAttributeErr`](xml.dom.md#xml.dom.InuseAttributeErr "xml.dom.InuseAttributeErr") |
| `INVALID_ACCESS_ERR` | [`InvalidAccessErr`](xml.dom.md#xml.dom.InvalidAccessErr "xml.dom.InvalidAccessErr") |
| `INVALID_CHARACTER_ERR` | [`InvalidCharacterErr`](xml.dom.md#xml.dom.InvalidCharacterErr "xml.dom.InvalidCharacterErr") |
| `INVALID_MODIFICATION_ERR` | [`InvalidModificationErr`](xml.dom.md#xml.dom.InvalidModificationErr "xml.dom.InvalidModificationErr") |
| `INVALID_STATE_ERR` | [`InvalidStateErr`](xml.dom.md#xml.dom.InvalidStateErr "xml.dom.InvalidStateErr") |
| `NAMESPACE_ERR` | [`NamespaceErr`](xml.dom.md#xml.dom.NamespaceErr "xml.dom.NamespaceErr") |
| `NOT_FOUND_ERR` | [`NotFoundErr`](xml.dom.md#xml.dom.NotFoundErr "xml.dom.NotFoundErr") |
| `NOT_SUPPORTED_ERR` | [`NotSupportedErr`](xml.dom.md#xml.dom.NotSupportedErr "xml.dom.NotSupportedErr") |
| `NO_DATA_ALLOWED_ERR` | [`NoDataAllowedErr`](xml.dom.md#xml.dom.NoDataAllowedErr "xml.dom.NoDataAllowedErr") |
| `NO_MODIFICATION_ALLOWED_ERR` | [`NoModificationAllowedErr`](xml.dom.md#xml.dom.NoModificationAllowedErr "xml.dom.NoModificationAllowedErr") |
| `SYNTAX_ERR` | [`SyntaxErr`](xml.dom.md#xml.dom.SyntaxErr "xml.dom.SyntaxErr") |
| `WRONG_DOCUMENT_ERR` | [`WrongDocumentErr`](xml.dom.md#xml.dom.WrongDocumentErr "xml.dom.WrongDocumentErr") |
