...
source_url: https://docs.python.org/3.12/library/re.html
fetched_at: 2026-09-17T15:32:13+00:00
---
...
usage of the backslash in string literals now generate a [`SyntaxWarning`](exceptions.md#SyntaxWarning "SyntaxWarning")
...
information and a gentler presentation, consult the [Regular Expression HOWTO](https://docs.python.org/3.12/howto/regex.html#regex-howto).
...
:   Used to indicate a set of characters. In a set:
    ...
    - Character classes such as `\w` or `\S` (defined below) are also accepted
      inside a set, although the characters they match depend on the [flags](re.md#flags) used.
...
:   (One or more letters from the set
    ...
    - [`re.A`](re.md#re.A "re.A") (ASCII-only matching)
    - [`re.I`](re.md#re.I "re.I") (ignore case)
    - [`re.L`](re.md#re.L "re.L") (locale dependent)
    - [`re.M`](re.md#re.M "re.M") (multi-line)
    - [`re.S`](re.md#re.S "re.S") (dot matches all)
    - [`re.U`](re.md#re.U "re.U") (Unicode matching)
    - [`re.X`](re.md#re.X "re.X") (verbose)
    ...
    [`re.compile()`](re.md#re.compile "re.compile") function.
...
:   Similar to regular parentheses, but the substring matched by the group is
    ...
    Python identifiers, and in [`bytes`](stdtypes.md#bytes "bytes") patterns they can only contain
    ...
    Changed in version 3.12: In [`bytes`](stdtypes.md#bytes "bytes") patterns, group *name* can only contain bytes
...
:   Will try to match with `yes-pattern` if the group with given *id* or
    *name* exists, and with `no-pattern` if it doesn’t. `no-pattern` is
    ...
    In [`bytes`](stdtypes.md#bytes "bytes") patterns, group *name* can only contain bytes
    in the ASCII range (`b'\x00'`-`b'\x7f'`).
...
:   Matches the empty string, but only at the beginning or end of a word.
    ...
    but this can be changed by using the [`ASCII`](re.md#re.ASCII "re.ASCII") flag.
    Word boundaries are determined by the current locale
    if the [`LOCALE`](re.md#re.LOCALE "re.LOCALE") flag is used.
...
:   Matches the empty string,
    ...
    although this can be changed by using the [`ASCII`](re.md#re.ASCII "re.ASCII") flag.
    Word boundaries are determined by the current locale
    if the [`LOCALE`](re.md#re.LOCALE "re.LOCALE") flag is used.
...
:   For Unicode (str) patterns:
    :   Matches any Unicode decimal digit
        ...
        Matches `[0-9]` if the [`ASCII`](re.md#re.ASCII "re.ASCII") flag is used.
...
`\s`
:   For Unicode (str) patterns:
    :   Matches Unicode whitespace characters (as defined by [`str.isspace()`](stdtypes.md#str.isspace "str.isspace")).
        This includes `[ \t\n\r\f\v]`, and also many other characters, for example the
        non-breaking spaces mandated by typography rules in many languages.

        Matches `[ \t\n\r\f\v]` if the [`ASCII`](re.md#re.ASCII "re.ASCII") flag is used.
...
:   For Unicode (str) patterns:
    :   Matches Unicode word characters;
        ...
        (as defined by [`str.isalnum()`](stdtypes.md#str.isalnum "str.isalnum")),
        as well as the underscore (`_`).

        Matches `[a-zA-Z0-9_]` if the [`ASCII`](re.md#re.ASCII "re.ASCII") flag is used.
...
:   Matches any character which is not a word character.
    ...
    for which [`str.isalnum()`](stdtypes.md#str.isalnum "str.isalnum") returns `False`.
...
Most of the [escape sequences](https://docs.python.org/3.12/reference/lexical_analysis.html#escape-sequences) supported by Python
...
:   Make `\w`, `\W`, `\b`, `\B`, `\d`, `\D`, `\s` and `\S`
    ...
    > **Note:**
    >
    > The [`U`](re.md#re.U "re.U") flag still exists for backward compatibility,
...
:   Perform case-insensitive matching;
    ...
    also works unless the [`ASCII`](re.md#re.ASCII "re.ASCII") flag
    is used to disable non-ASCII matches.
    The current locale does not change the effect of this flag
    unless the [`LOCALE`](re.md#re.LOCALE "re.LOCALE") flag is also used.
...
:   Make `\w`, `\W`, `\b`, `\B` and case-insensitive matching
    ...
    Changed in version 3.6: [`LOCALE`](re.md#re.LOCALE "re.LOCALE") can be used only with bytes patterns
    and is not compatible with [`ASCII`](re.md#re.ASCII "re.ASCII").

    Changed in version 3.7: Compiled regular expression objects with the [`LOCALE`](re.md#re.LOCALE "re.LOCALE") flag
...
:   Return the string obtained by replacing the leftmost non-overlapping occurrences
    ...
    *pattern*. The function takes a single [`Match`](re.md#re.Match "re.Match") argument, and returns
    ...
    The pattern may be a string or a [`Pattern`](re.md#re.Pattern "re.Pattern").
...
text, [`finditer()`](re.md#re.finditer "re.finditer") is useful as it provides [`Match`](re.md#re.Match "re.Match") objects
...
[`finditer()`](re.md#re.finditer "re.finditer") in the following manner:
