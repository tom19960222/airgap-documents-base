...
source_url: https://docs.python.org/3.12/library/telnetlib.html
fetched_at: 2026-09-17T15:35:46+00:00
---
# `telnetlib` — Telnet client

**Source code:** [Lib/telnetlib.py](https://github.com/python/cpython/tree/3.12/Lib/telnetlib.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`telnetlib`](telnetlib.md#module-telnetlib "telnetlib: Telnet client class. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#telnetlib) for details and alternatives).

---

The [`telnetlib`](telnetlib.md#module-telnetlib "telnetlib: Telnet client class. (deprecated)") module provides a [`Telnet`](telnetlib.md#telnetlib.Telnet "telnetlib.Telnet") class that implements the
Telnet protocol. See [**RFC 854**](https://datatracker.ietf.org/doc/html/rfc854.html) for details about the protocol. In addition, it
...
:   [`Telnet`](telnetlib.md#telnetlib.Telnet "telnetlib.Telnet") represents a connection to a Telnet server. The instance is
    ...
    *timeout* parameter specifies a timeout in seconds for blocking operations
    ...
    [`EOFError`](exceptions.md#EOFError "EOFError") when the end of the connection is read, because they can return
    an empty string for other reasons. See the individual descriptions below.

    A [`Telnet`](telnetlib.md#telnetlib.Telnet "telnetlib.Telnet") object is a context manager and can be used in a
    [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. When the `with` block ends, the
    [`close()`](telnetlib.md#telnetlib.Telnet.close "telnetlib.Telnet.close") method is called:
...
:   Write a byte string to the socket, doubling any IAC characters. This can
    ...
    Raises an [auditing event](sys.md#auditing) `telnetlib.Telnet.write` with arguments `self`, `buffer`.
...
:   Read until one from a list of a regular expressions matches.
    ...
    ([regex objects](re.md#re-objects)) or uncompiled (byte strings). The
    ...
    If end of file is found and no bytes were read, raise [`EOFError`](exceptions.md#EOFError "EOFError").
