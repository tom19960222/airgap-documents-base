...
source_url: https://docs.python.org/3.12/library/configparser.html
fetched_at: 2026-09-17T15:33:04+00:00
---
...
This module provides the [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser") class which implements a basic
...
> **See also:**
>
> Module [`tomllib`](tomllib.md#module-tomllib "tomllib: Parse TOML files.")
...
>
> Module [`shlex`](shlex.md#module-shlex "shlex: Simple lexical analysis for Unix shell-like languages.")
> :   Support for creating Unix shell-like mini-languages which can also
>     be used for application configuration files.
>
> Module [`json`](json.md#module-json "json: Encode and decode the JSON format.")
...
The structure of INI files is described [in the following section](configparser.md#supported-ini-file-structure). Essentially, the file
consists of sections, each of which contains keys with values.
[`configparser`](configparser.md#module-configparser "configparser: Configuration file parser.") classes can read and write such files. Let’s start by
...
There are differences, [outlined later](configparser.md#mapping-protocol-access), but
...
sections [[1]](configparser.md#id15). Note also that keys in sections are
case-insensitive and stored in lowercase [[1]](configparser.md#id15).

It is possible to read several configurations into a single
[`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser"), where the most recently added configuration has the
...
This behaviour is equivalent to a [`ConfigParser.read()`](configparser.md#configparser.ConfigParser.read "configparser.ConfigParser.read") call with several
...
provide [`getboolean()`](configparser.md#configparser.ConfigParser.getboolean "configparser.ConfigParser.getboolean"). This method is case-insensitive and
recognizes Boolean values from `'yes'`/`'no'`, `'on'`/`'off'`,
`'true'`/`'false'` and `'1'`/`'0'` [[1]](configparser.md#id15). For example:
...
Apart from [`getboolean()`](configparser.md#configparser.ConfigParser.getboolean "configparser.ConfigParser.getboolean"), config parsers also
provide equivalent [`getint()`](configparser.md#configparser.ConfigParser.getint "configparser.ConfigParser.getint") and
[`getfloat()`](configparser.md#configparser.ConfigParser.getfloat "configparser.ConfigParser.getfloat") methods. You can register your own
converters and customize the provided ones. [[1]](configparser.md#id15)

## Fallback Values

As with a dictionary, you can use a section’s [`get()`](configparser.md#configparser.ConfigParser.get "configparser.ConfigParser.get") method to
...
One more thing to be aware of is that the parser-level [`get()`](configparser.md#configparser.ConfigParser.get "configparser.ConfigParser.get") method
...
[`getint()`](configparser.md#configparser.ConfigParser.getint "configparser.ConfigParser.getint"), [`getfloat()`](configparser.md#configparser.ConfigParser.getfloat "configparser.ConfigParser.getfloat") and
[`getboolean()`](configparser.md#configparser.ConfigParser.getboolean "configparser.ConfigParser.getboolean") methods, for example:
...
default [[1]](configparser.md#id15)). By default, section names are case sensitive but keys are not
[[1]](configparser.md#id15). Leading and trailing whitespace is removed from keys and values.
Values can be omitted if the parser is configured to allow it [[1]](configparser.md#id15),
...
To change this, see [`ConfigParser.SECTCRE`](configparser.md#configparser.ConfigParser.SECTCRE "configparser.ConfigParser.SECTCRE").

Configuration files may include comments, prefixed by specific
characters (`#` and `;` by default [[1]](configparser.md#id15)). Comments may appear on
their own on an otherwise empty line, possibly indented. [[1]](configparser.md#id15)
...
On top of the core functionality, [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser") supports
...
:   The default implementation used by [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser"). It enables
    ...
    In the example above, [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser") with *interpolation* set to
...
custom objects as if they were dictionaries. In case of [`configparser`](configparser.md#module-configparser "configparser: Configuration file parser."),
...
[`configparser`](configparser.md#module-configparser "configparser: Configuration file parser.") objects behave as close to actual dictionaries as possible.
The mapping interface is complete and adheres to the
[`MutableMapping`](collections.abc.md#collections.abc.MutableMapping "collections.abc.MutableMapping") ABC.
However, there are a few differences that should be taken into account:

- By default, all keys in sections are accessible in a case-insensitive manner
  [[1]](configparser.md#id15). E.g. `for option in parser["section"]` yields only `optionxform`’ed
...
- All sections include `DEFAULTSECT` values as well which means that
  ...
  causes a [`KeyError`](exceptions.md#KeyError "KeyError").
- `DEFAULTSECT` cannot be removed from the parser:

  - trying to delete it raises [`ValueError`](exceptions.md#ValueError "ValueError"),
...
[`configparser`](configparser.md#module-configparser "configparser: Configuration file parser.") goes a long way to provide support for the largest sensible
...
- *defaults*, default value: `None`
  ...
  [`read_dict()`](configparser.md#configparser.ConfigParser.read_dict "configparser.ConfigParser.read_dict") before you read the actual file.
- *dict_type*, default value: [`dict`](stdtypes.md#dict "dict")
...
- *allow_no_value*, default value: `False`
  ...
  which otherwise conform to the syntax supported by [`configparser`](configparser.md#module-configparser "configparser: Configuration file parser."). The
...
- *delimiters*, default value: `('=', ':')`
  ...
  [`ConfigParser.write()`](configparser.md#configparser.ConfigParser.write "configparser.ConfigParser.write").
...
- *inline_comment_prefixes*, default value: `None`
  ...
  Changed in version 3.2: In previous versions of [`configparser`](configparser.md#module-configparser "configparser: Configuration file parser.") behaviour matched
...
- *strict*, default value: `True`
  ...
  duplicates while reading from a single source (using [`read_file()`](configparser.md#configparser.ConfigParser.read_file "configparser.ConfigParser.read_file"),
  [`read_string()`](configparser.md#configparser.ConfigParser.read_string "configparser.ConfigParser.read_string") or [`read_dict()`](configparser.md#configparser.ConfigParser.read_dict "configparser.ConfigParser.read_dict")). It is recommended to use strict
...
- *interpolation*, default value: `configparser.BasicInterpolation`
  ...
  [dedicated documentation section](configparser.md#interpolation-of-values).
  [`RawConfigParser`](configparser.md#configparser.RawConfigParser "configparser.RawConfigParser") has a default value of `None`.
- *converters*, default value: not set

  Config parsers provide option value getters that perform type conversion. By
  default [`getint()`](configparser.md#configparser.ConfigParser.getint "configparser.ConfigParser.getint"), [`getfloat()`](configparser.md#configparser.ConfigParser.getfloat "configparser.ConfigParser.getfloat"), and
  [`getboolean()`](configparser.md#configparser.ConfigParser.getboolean "configparser.ConfigParser.getboolean") are implemented. Should other getters be
...
Mainly because of backwards compatibility concerns, [`configparser`](configparser.md#module-configparser "configparser: Configuration file parser.")
...
To get interpolation, use [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser"):
...
:   The main configuration parser. When *defaults* is given, it is initialized
    ...
    string or dictionary), raising [`DuplicateSectionError`](configparser.md#configparser.DuplicateSectionError "configparser.DuplicateSectionError") or
    [`DuplicateOptionError`](configparser.md#configparser.DuplicateOptionError "configparser.DuplicateOptionError"). When *empty_lines_in_values* is `False`
    ...
    [`optionxform()`](configparser.md#configparser.ConfigParser.optionxform "configparser.ConfigParser.optionxform") method just like any other option name reference. For
    example, using the default implementation of [`optionxform()`](configparser.md#configparser.ConfigParser.optionxform "configparser.ConfigParser.optionxform") (which
    ...
    Changed in version 3.1: The default *dict_type* is [`collections.OrderedDict`](collections.md#collections.OrderedDict "collections.OrderedDict").
    ...
    *empty_lines_in_values*, *default_section* and *interpolation* were
    ...
    Changed in version 3.7: The *defaults* argument is read with [`read_dict()`](configparser.md#configparser.ConfigParser.read_dict "configparser.ConfigParser.read_dict"),
    ...
    :   Add a section named *section* to the instance. If a section by the given
        ...
        *default section* name is passed, [`ValueError`](exceptions.md#ValueError "ValueError") is raised. The name
        of the section must be a string; if not, [`TypeError`](exceptions.md#TypeError "TypeError") is raised.
    ...
    :   Attempt to read and parse an iterable of filenames, returning a list of
        ...
        If *filenames* is a string, a [`bytes`](stdtypes.md#bytes "bytes") object or a
        [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object), it is treated as
        ...
        If none of the named files exist, the [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser")
        instance will contain an empty dataset. An application which requires
        initial values to be loaded from a file should load the required file or
        files using [`read_file()`](configparser.md#configparser.ConfigParser.read_file "configparser.ConfigParser.read_file") before calling [`read()`](configparser.md#configparser.ConfigParser.read "configparser.ConfigParser.read") for any
        optional files:
        ...
        Previously, all files were read using the default encoding for [`open()`](functions.md#open "open").

        Changed in version 3.6.1: The *filenames* parameter accepts a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object).
    ...
    :   When *section* is not given, return a list of *section_name*,
        *section_proxy* pairs, including DEFAULTSECT.
        ...
        [`get()`](configparser.md#configparser.ConfigParser.get "configparser.ConfigParser.get") method.
...
:   Legacy variant of the [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser"). It has interpolation
    ...
    > **Note:**
    >
    > Consider using [`ConfigParser`](configparser.md#configparser.ConfigParser "configparser.ConfigParser") instead which checks types of
...
[1]
([1](configparser.md#id1),[2](configparser.md#id2),[3](configparser.md#id3),[4](configparser.md#id4),[5](configparser.md#id5),[6](configparser.md#id6),[7](configparser.md#id7),[8](configparser.md#id8),[9](configparser.md#id9),[10](configparser.md#id10),[11](configparser.md#id11))

Config parsers allow for heavy customization. If you are interested in
changing the behaviour outlined by the footnote reference, consult the
[Customizing Parser Behaviour](configparser.md#customizing-parser-behaviour) section.
