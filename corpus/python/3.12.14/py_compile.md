...
source_url: https://docs.python.org/3.12/library/py_compile.html
fetched_at: 2026-09-17T15:35:22+00:00
---
# `py_compile` — Compile Python source files

**Source code:** [Lib/py_compile.py](https://github.com/python/cpython/tree/3.12/Lib/py_compile.py)
...
:   An enumeration of possible methods the interpreter can use to determine
    ...
    [Cached bytecode invalidation](https://docs.python.org/3.12/reference/import.html#pyc-invalidation) for more information on how Python invalidates
