...
collection: python
version: "3.12.14"
title: "email.message.Message : Representing an email message using the compat32 API"
source_url: https://docs.python.org/3.12/library/email.compat32-message.html
fetched_at: 2026-09-17T15:36:07+00:00
---
# `email.message.Message`: Representing an email message using the [`compat32`](email.policy.md#email.policy.compat32 "email.policy.compat32") API

The [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") class is very similar to the
[`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") class, without the methods added by that
...
[`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") class, are not recommended unless you are
dealing with legacy code.

The philosophy and structure of the two classes is otherwise the same.

This document describes the behavior under the default (for [`Message`](email.compat32-message.md#email.message.Message "email.message.Message"))
policy [`Compat32`](email.policy.md#email.policy.Compat32 "email.policy.Compat32"). If you are going to use another policy,
you should be using the [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") class instead.
...
The conceptual model provided by a [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") object is that of an
...
The [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") pseudo-dictionary is indexed by the header names, which
...
[`Message`](email.compat32-message.md#email.message.Message "email.message.Message") objects, for MIME container documents (e.g.
...
:   If *policy* is specified (it must be an instance of a [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages")
    ...
    :   Return the entire message flattened as a string. When optional *unixfrom*
        ...
        *maxheaderlen* defaults to `0`, so if you want a different value you
        ...
        Flattening the message may trigger changes to the [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") if
        ...
        [`Generator`](email.generator.md#email.generator.Generator "email.generator.Generator") instance and use its
        [`flatten()`](email.generator.md#email.generator.Generator.flatten "email.generator.Generator.flatten") method directly. For example:
        ...
        “unknown character” code points. (See also [`as_bytes()`](email.compat32-message.md#email.message.Message.as_bytes "email.message.Message.as_bytes") and
        [`BytesGenerator`](email.generator.md#email.generator.BytesGenerator "email.generator.BytesGenerator").)
    ...
    :   Return the entire message flattened as a bytes object. When optional
        *unixfrom* is true, the envelope header is included in the returned
        ...
        not do the mangling of lines that begin with `From` that is
        required by the Unix mbox format. For more flexibility, instantiate a
        [`BytesGenerator`](email.generator.md#email.generator.BytesGenerator "email.generator.BytesGenerator") instance and use its
        [`flatten()`](email.generator.md#email.generator.BytesGenerator.flatten "email.generator.BytesGenerator.flatten") method directly.
        For example:
    ...
    :   Return `True` if the message’s payload is a list of
        ...
        [`is_multipart()`](email.compat32-message.md#email.message.Message.is_multipart "email.message.Message.is_multipart") returning `True` does not necessarily mean that
    ...
    :   Add the given *payload* to the current payload, which must be `None` or
        ...
        [`set_payload()`](email.compat32-message.md#email.message.Message.set_payload "email.message.Message.set_payload") instead.
    ...
    :   Return the current payload, which will be a list of
        ...
        With optional argument *i*, [`get_payload()`](email.compat32-message.md#email.message.Message.get_payload "email.message.Message.get_payload") will return the *i*-th
        element of the payload, counting from zero, if [`is_multipart()`](email.compat32-message.md#email.message.Message.is_multipart "email.message.Message.is_multipart") is
        `True`. An [`IndexError`](exceptions.md#IndexError "IndexError") will be raised if *i* is less than 0 or
        greater than or equal to the number of items in the payload. If the
        payload is a string (i.e. [`is_multipart()`](email.compat32-message.md#email.message.Message.is_multipart "email.message.Message.is_multipart") is `False`) and *i* is
        given, a [`TypeError`](exceptions.md#TypeError "TypeError") is raised.
        ...
        defect property ([`InvalidBase64PaddingDefect`](email.errors.md#email.errors.InvalidBase64PaddingDefect "email.errors.InvalidBase64PaddingDefect") or
        [`InvalidBase64CharactersDefect`](email.errors.md#email.errors.InvalidBase64CharactersDefect "email.errors.InvalidBase64CharactersDefect"), respectively).
    ...
    :   Set the character set of the payload to *charset*, which can either be a
        ...
        be converted to a [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset") instance. If *charset*
        is `None`, the `charset` parameter will be removed from the
        *Content-Type* header (the message will not be otherwise
        modified). Anything else will generate a [`TypeError`](exceptions.md#TypeError "TypeError").
        ...
        *Content-Transfer-Encoding* header, then the payload will be
        ...
        [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset"), and a header with the appropriate value
    ...
    :   Return the [`Charset`](email.charset.md#email.charset.Charset "email.charset.Charset") instance associated with the
        ...
        This is a legacy method. On the
        `EmailMessage` class it always returns
        `None`.
    ...
    order to the keys returned by [`keys()`](email.compat32-message.md#email.message.Message.keys "email.message.Message.keys"), but in a [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") object,
    ...
    :   Return the message’s content type. The returned string is coerced to
        ...
        *Content-Type* header in the message the default type as given
        by [`get_default_type()`](email.compat32-message.md#email.message.Message.get_default_type "email.message.Message.get_default_type") will be returned. Since according to
        [**RFC 2045**](https://datatracker.ietf.org/doc/html/rfc2045.html), messages always have a default type, [`get_content_type()`](email.compat32-message.md#email.message.Message.get_content_type "email.message.Message.get_content_type")
    ...
    :   Return the message’s *Content-Type* parameters, as a list.
        ...
        described in [`get_param()`](email.compat32-message.md#email.message.Message.get_param "email.message.Message.get_param") and is unquoted if optional *unquote* is
        `True` (the default).
    ...
    :   Return the value of the *Content-Type* header’s parameter
        ...
        *Content-Type*.
        ...
        [`email.utils.collapse_rfc2231_value()`](email.utils.md#email.utils.collapse_rfc2231_value "email.utils.collapse_rfc2231_value"), passing in the return value
        from [`get_param()`](email.compat32-message.md#email.message.Message.get_param "email.message.Message.get_param"). This will return a suitably decoded Unicode
    ...
    :   Set the `boundary` parameter of the *Content-Type* header to
        ...
        *Content-Type* header and adding a new one with the new
        boundary via [`add_header()`](email.compat32-message.md#email.message.Message.add_header "email.message.Message.add_header"), because [`set_boundary()`](email.compat32-message.md#email.message.Message.set_boundary "email.message.Message.set_boundary") preserves
    ...
    :   The [`walk()`](email.compat32-message.md#email.message.Message.walk "email.message.Message.walk") method is an all-purpose generator which can be used to
        ...
        [`is_multipart()`](email.compat32-message.md#email.message.Message.is_multipart "email.message.Message.is_multipart") returns `True`, even though
    ...
    :   The format of a MIME document allows for some text between the blank line
        ...
        documents. When the [`Parser`](email.parser.md#email.parser.Parser "email.parser.Parser") discovers some text
        after the headers but before the first boundary string, it assigns this
        text to the message’s *preamble* attribute. When the
        [`Generator`](email.generator.md#email.generator.Generator "email.generator.Generator") is writing out the plain text
        representation of a MIME message, and it finds the
        message has a *preamble* attribute, it will write this text in the area
        between the headers and the first boundary. See [`email.parser`](email.parser.md#module-email.parser "email.parser: Parse flat text email messages to produce a message object structure.") and
        [`email.generator`](email.generator.md#module-email.generator "email.generator: Generate flat text email messages from a message structure.") for details.
