...
source_url: https://docs.python.org/3.12/library/smtplib.html
fetched_at: 2026-09-17T15:34:08+00:00
---
...
:   An [`SMTP`](smtplib.md#smtplib.SMTP "smtplib.SMTP") instance encapsulates an SMTP connection. It has methods
    ...
    *timeout* parameter specifies a timeout in seconds for blocking operations
    ...
    The [`SMTP`](smtplib.md#smtplib.SMTP "smtplib.SMTP") class supports the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. When used
    ...
    Changed in version 3.3: Support for the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement was added.
...
:   This is a convenience method for calling [`sendmail()`](smtplib.md#smtplib.SMTP.sendmail "smtplib.SMTP.sendmail") with the message
    ...
    *Bcc* or *Resent-Bcc* headers that may appear
    ...
    an [`SMTPNotSupportedError`](smtplib.md#smtplib.SMTPNotSupportedError "smtplib.SMTPNotSupportedError") is raised. Otherwise the `Message` is
