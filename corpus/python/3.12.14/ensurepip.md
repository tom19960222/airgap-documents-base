...
source_url: https://docs.python.org/3.12/library/ensurepip.html
fetched_at: 2026-09-17T15:34:50+00:00
---
# `ensurepip` — Bootstrapping the `pip` installer

Added in version 3.4.

**Source code:** [Lib/ensurepip](https://github.com/python/cpython/tree/3.12/Lib/ensurepip)

---

The [`ensurepip`](ensurepip.md#module-ensurepip "ensurepip: Bootstrapping the \"pip\" installer into an existing Python installation or virtual environment.") package provides support for bootstrapping the `pip`
...
> **See also:**
>
> [Installing Python Modules](https://docs.python.org/3.12/installing/index.html#installing-index)
...
:   Bootstraps `pip` into the current or designated environment.
    ...
    *verbosity* controls the level of output to [`sys.stdout`](sys.md#sys.stdout "sys.stdout") from the
