...
source_url: https://docs.python.org/3.12/library/locale.html
fetched_at: 2026-09-17T15:34:19+00:00
---
...
:   Return some locale-specific information as a string. This function is not
    ...
    :   Get the name of the n-th day of the week.
        ...
        > **Note:**
        >
        > This follows the US convention of [`DAY_1`](locale.md#locale.DAY_1 "locale.DAY_1") being Sunday, not the
...
:   Return the [locale encoding](https://docs.python.org/3.12/glossary.html#term-locale-encoding) used for text data, according to user
    ...
    return `'utf-8'`, the [locale encoding](https://docs.python.org/3.12/glossary.html#term-locale-encoding) and the *do_setlocale*
    argument are ignored.

    The [Python preinitialization](https://docs.python.org/3.12/c-api/init_config.html#c-preinit) configures the LC_CTYPE
    locale. See also the [filesystem encoding and error handler](https://docs.python.org/3.12/glossary.html#term-filesystem-encoding-and-error-handler).
...
:   Get the current [locale encoding](https://docs.python.org/3.12/glossary.html#term-locale-encoding):
    ...
    - On Unix, return the encoding of the current [`LC_CTYPE`](locale.md#locale.LC_CTYPE "locale.LC_CTYPE") locale.
    ...
    [`getpreferredencoding(False)`](locale.md#locale.getpreferredencoding "locale.getpreferredencoding") except this
...
[`format_string()`](locale.md#locale.format_string "locale.format_string"), [`str()`](locale.md#locale.str "locale.str").
...
[`dgettext()`](locale.md#locale.dgettext "locale.dgettext"), [`dcgettext()`](locale.md#locale.dcgettext "locale.dcgettext"), [`textdomain()`](locale.md#locale.textdomain "locale.textdomain"), [`bindtextdomain()`](locale.md#locale.bindtextdomain "locale.bindtextdomain"),
and [`bind_textdomain_codeset()`](locale.md#locale.bind_textdomain_codeset "locale.bind_textdomain_codeset"). These are similar to the same functions in
