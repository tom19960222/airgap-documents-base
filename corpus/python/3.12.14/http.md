...
source_url: https://docs.python.org/3.12/library/http.html
fetched_at: 2026-09-17T15:34:04+00:00
---
# `http` — HTTP modules

**Source code:** [Lib/http/__init__.py](https://github.com/python/cpython/tree/3.12/Lib/http/__init__.py)
...
available in [`http.HTTPStatus`](http.md#http.HTTPStatus "http.HTTPStatus") are:
...
| --- | --- | --- |
| `is_informational` | `100 <= status <= 199` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 6 |
| `is_success` | `200 <= status <= 299` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 6 |
| `is_redirection` | `300 <= status <= 399` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 6 |
| `is_client_error` | `400 <= status <= 499` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 6 |
| `is_server_error` | `500 <= status <= 599` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 6 |
...
available in [`http.HTTPMethod`](http.md#http.HTTPMethod "http.HTTPMethod") are:

| Method | Enum Name | Details |
| --- | --- | --- |
| `GET` | `GET` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.1 |
| `HEAD` | `HEAD` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.2 |
| `POST` | `POST` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.3 |
| `PUT` | `PUT` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.4 |
| `DELETE` | `DELETE` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.5 |
| `CONNECT` | `CONNECT` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.6 |
| `OPTIONS` | `OPTIONS` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.7 |
| `TRACE` | `TRACE` | HTTP/1.1 [**RFC 7231**](https://datatracker.ietf.org/doc/html/rfc7231.html), Section 4.3.8 |
