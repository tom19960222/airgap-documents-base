...
source_url: https://docs.python.org/3.12/library/doctest.html
...
There is also a command line shortcut for running [`testmod()`](doctest.md#doctest.testmod "doctest.testmod"), see section
[Command-line Usage](doctest.md#doctest-cli).
...
There is also a command line shortcut for running [`testfile()`](doctest.md#doctest.testfile "doctest.testfile"), see section
[Command-line Usage](doctest.md#doctest-cli).
...
The [`doctest`](doctest.md#module-doctest "doctest: Test pieces of code within docstrings.") module can be invoked as a script from the command line:
...
:   Detailed report of all examples tried is printed to standard output,
    ...
    [`testmod()`](doctest.md#doctest.testmod "doctest.testmod") on it. Note that this may not work correctly if the
    ...
    that it must be run with [`testfile()`](doctest.md#doctest.testfile "doctest.testfile") instead:
...
[bitwise ORed](https://docs.python.org/3.12/reference/expressions.html#bitwise) together and passed to various functions.
...
:   All arguments except *filename* are optional, and should be specified in keyword
    ...
    *extraglobs* have a common key, the associated value in *extraglobs* appears in
    ...
    [bitwise OR](https://docs.python.org/3.12/reference/expressions.html#bitwise) of option flags.
...
:   All arguments are optional, and all except for *m* should be specified in
    ...
    [`doctest.master.summarize`](doctest.md#doctest.DocTestRunner.summarize "doctest.DocTestRunner.summarize") in
...
:   Convert doctest tests from one or more text files to a
    ...
    fails, then the synthesized unit test fails, and a [`failureException`](doctest.md#doctest.failureException "doctest.failureException")
...
:   Convert doctest tests for a module to a [`unittest.TestSuite`](unittest.md#unittest.TestSuite "unittest.TestSuite").
    ...
    synthesized unit test fails, and a [`failureException`](doctest.md#doctest.failureException "doctest.failureException") exception is raised
...
:   Set the [`doctest`](doctest.md#module-doctest "doctest: Test pieces of code within docstrings.") reporting flags to use.
    ...
    typical and expected case), `doctest`’s [`unittest`](unittest.md#module-unittest "unittest: Unit testing framework for Python.") reporting flags are
    [bitwise ORed](https://docs.python.org/3.12/reference/expressions.html#bitwise) into the option flags, and the option flags
...
- [`Example`](doctest.md#doctest.Example "doctest.Example"): A single Python [statement](https://docs.python.org/3.12/glossary.html#term-statement), paired with its expected
  output.
...
:   A single interactive example, consisting of a Python statement and its expected
    ...
    :   A dictionary mapping from option flags to `True` or `False`, which is used
        ...
        [`DocTestRunner`](doctest.md#doctest.DocTestRunner "doctest.DocTestRunner")’s [optionflags](doctest.md#doctest-options)).
...
:   A processing class used to execute and verify the interactive examples in a
    ...
    function can be passed to [`run()`](doctest.md#doctest.DocTestRunner.run "doctest.DocTestRunner.run"); this function will be called
