...
source_url: https://docs.python.org/3.12/library/unicodedata.html
...
this database is compiled from the [UCD version 15.0.0](https://www.unicode.org/Public/15.0.0/ucd).
