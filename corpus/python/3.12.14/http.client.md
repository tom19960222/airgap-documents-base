...
source_url: https://docs.python.org/3.12/library/http.client.html
fetched_at: 2026-09-17T15:34:05+00:00
---
...
:   Parse the headers from a file pointer *fp* representing a HTTP
    ...
    This function returns an instance of [`http.client.HTTPMessage`](http.client.md#http.client.HTTPMessage "http.client.HTTPMessage")
...
:   A subclass of [`ConnectionResetError`](exceptions.md#ConnectionResetError "ConnectionResetError") and [`BadStatusLine`](http.client.md#http.client.BadStatusLine "http.client.BadStatusLine"). Raised
    ...
    Added in version 3.5: Previously, [`BadStatusLine`](http.client.md#http.client.BadStatusLine "http.client.BadStatusLine")`('')` was raised.
...
:   This will send a request to the server using the HTTP request
    ...
    finished. It may be a [`str`](stdtypes.md#str "str"), a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object), an
    open [file object](https://docs.python.org/3.12/glossary.html#term-file-object), or an iterable of [`bytes`](stdtypes.md#bytes "bytes"). If *body*
    ...
    object](https://docs.python.org/3.12/glossary.html#term-file-object), the contents of the file is sent; this file object should
    ...
    *body* is a string or a bytes-like object that is not also a
    [file](https://docs.python.org/3.12/glossary.html#term-file-object), the Content-Length header is
...
:   Send a blank line to the server, signalling the end of the headers. The
    ...
    *message_body*. If *message_body* implements the [buffer interface](https://docs.python.org/3.12/c-api/buffer.html#bufferobjects) the encoding will result in a single chunk.
    ...
    [file object](https://docs.python.org/3.12/glossary.html#term-file-object), each call to `.read()` will result in a chunk.
