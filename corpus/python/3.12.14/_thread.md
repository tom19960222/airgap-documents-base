...
source_url: https://docs.python.org/3.12/library/_thread.html
...
[`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement, e.g.:
...
- Interrupts always go to the main thread (the [`KeyboardInterrupt`](exceptions.md#KeyboardInterrupt "KeyboardInterrupt")
...
- It is platform-dependent whether the [`acquire()`](threading.md#threading.Lock.acquire "threading.Lock.acquire") method
  on a lock can be interrupted (so that the [`KeyboardInterrupt`](exceptions.md#KeyboardInterrupt "KeyboardInterrupt") exception
...
- When the main thread exits, it is system defined whether the other threads
  ...
  [`try`](https://docs.python.org/3.12/reference/compound_stmts.html#try) … [`finally`](https://docs.python.org/3.12/reference/compound_stmts.html#finally) clauses or executing object
  destructors.
