...
source_url: https://docs.python.org/3.12/library/msilib.html
fetched_at: 2026-09-17T15:35:39+00:00
---
# `msilib` — Read and write Microsoft Installer files

**Source code:** [Lib/msilib/__init__.py](https://github.com/python/cpython/tree/3.12/Lib/msilib/__init__.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`msilib`](msilib.md#module-msilib "msilib: Creation of Microsoft Installer files, and CAB files. (deprecated) (Windows)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#msilib) for details).
