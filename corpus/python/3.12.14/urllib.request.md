...
source_url: https://docs.python.org/3.12/library/urllib.request.html
fetched_at: 2026-09-17T15:34:01+00:00
---
# `urllib.request` — Extensible library for opening URLs

**Source code:** [Lib/urllib/request.py](https://github.com/python/cpython/tree/3.12/Lib/urllib/request.py)

---

The [`urllib.request`](urllib.request.md#module-urllib.request "urllib.request: Extensible library for opening URLs.") module defines functions and classes which help in
...
> [`os.fork()`](os.md#os.fork "os.fork") because the [`getproxies()`](urllib.request.md#urllib.request.getproxies "urllib.request.getproxies") implementation for
...
:   Open *url*, which can be either a string containing a valid, properly
    ...
    *data* must be an object specifying additional data to be sent to the
    server, or `None` if no such data is needed. See [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request")
    for details.
    ...
    If *context* is specified, it must be a [`ssl.SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") instance
    describing the various SSL options. See [`HTTPSConnection`](http.client.md#http.client.HTTPSConnection "http.client.HTTPSConnection")
    for more details.
    ...
    be found in [`ssl.SSLContext.load_verify_locations()`](ssl.md#ssl.SSLContext.load_verify_locations "ssl.SSLContext.load_verify_locations").

    The *cadefault* parameter is ignored.

    This function always returns an object which can work as a
    [context manager](https://docs.python.org/3.12/glossary.html#term-context-manager) and has the properties *url*, *headers*, and *status*.
    See [`urllib.response.addinfourl`](urllib.request.md#urllib.response.addinfourl "urllib.response.addinfourl") for more detail on these properties.

    For HTTP and HTTPS URLs, this function returns a
    [`http.client.HTTPResponse`](http.client.md#http.client.HTTPResponse "http.client.HTTPResponse") object slightly modified. In addition
    to the three new methods above, the msg attribute contains the
    same information as the [`reason`](http.client.md#http.client.HTTPResponse.reason "http.client.HTTPResponse.reason")
    ...
    [`HTTPResponse`](http.client.md#http.client.HTTPResponse "http.client.HTTPResponse").

    For FTP, file, and data URLs and requests explicitly handled by legacy
    [`URLopener`](urllib.request.md#urllib.request.URLopener "urllib.request.URLopener") and [`FancyURLopener`](urllib.request.md#urllib.request.FancyURLopener "urllib.request.FancyURLopener") classes, this function
    returns a [`urllib.response.addinfourl`](urllib.request.md#urllib.response.addinfourl "urllib.response.addinfourl") object.

    Raises [`URLError`](urllib.error.md#urllib.error.URLError "urllib.error.URLError") on protocol errors.

    Note that `None` may be returned if no handler handles the request (though
    the default installed global [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector") uses
    [`UnknownHandler`](urllib.request.md#urllib.request.UnknownHandler "urllib.request.UnknownHandler") to ensure this never happens).

    In addition, if proxy settings are detected (for example, when a `*_proxy`
    environment variable like `http_proxy` is set),
    [`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler") is default installed and makes sure the requests are
    handled through the proxy.

    The legacy `urllib.urlopen` function from Python 2.6 and earlier has been
    discontinued; [`urllib.request.urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen") corresponds to the old
    ...
    [`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler") objects.
    ...
    [`ssl.HAS_SNI`](ssl.md#ssl.HAS_SNI "ssl.HAS_SNI") is true).
    ...
    *data* can be an iterable object.
    ...
    ALPN protocols with [`set_alpn_protocols()`](ssl.md#ssl.SSLContext.set_alpn_protocols "ssl.SSLContext.set_alpn_protocols").

    Deprecated since version 3.6: *cafile*, *capath* and *cadefault* are deprecated in favor of *context*.
    Please use [`ssl.SSLContext.load_cert_chain()`](ssl.md#ssl.SSLContext.load_cert_chain "ssl.SSLContext.load_cert_chain") instead, or let
...
:   Install an [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector") instance as the default global opener.
    ...
    [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen"). The code does not check for a real
...
:   Return an [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector") instance, which chains the handlers in the
    ...
    instances of them or subclasses of them: [`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler") (if proxy
    settings are detected), [`UnknownHandler`](urllib.request.md#urllib.request.UnknownHandler "urllib.request.UnknownHandler"), [`HTTPHandler`](urllib.request.md#urllib.request.HTTPHandler "urllib.request.HTTPHandler"),
    [`HTTPDefaultErrorHandler`](urllib.request.md#urllib.request.HTTPDefaultErrorHandler "urllib.request.HTTPDefaultErrorHandler"), [`HTTPRedirectHandler`](urllib.request.md#urllib.request.HTTPRedirectHandler "urllib.request.HTTPRedirectHandler"),
    [`FTPHandler`](urllib.request.md#urllib.request.FTPHandler "urllib.request.FTPHandler"), [`FileHandler`](urllib.request.md#urllib.request.FileHandler "urllib.request.FileHandler"), [`HTTPErrorProcessor`](urllib.request.md#urllib.request.HTTPErrorProcessor "urllib.request.HTTPErrorProcessor").

    If the Python installation has SSL support (i.e., if the [`ssl`](ssl.md#module-ssl "ssl: TLS/SSL wrapper for socket objects") module
    can be imported), [`HTTPSHandler`](urllib.request.md#urllib.request.HTTPSHandler "urllib.request.HTTPSHandler") will also be added.
...
:   This class is an abstraction of a URL request.
    ...
    *data* must be an object specifying additional data to send to the
    ...
    has been provided, [`HTTPHandler`](urllib.request.md#urllib.request.HTTPHandler "urllib.request.HTTPHandler") will set these headers according
    ...
    [`urllib.parse.urlencode()`](urllib.parse.md#urllib.parse.urlencode "urllib.parse.urlencode") function takes a mapping or sequence
    ...
    *headers* should be a dictionary, and will be treated as if
    [`add_header()`](urllib.request.md#urllib.request.Request.add_header "urllib.request.Request.add_header") was called with each key and value as arguments.
    ...
    [`urllib`](urllib.md#module-urllib "urllib")’s default user agent string is
    ...
    *method* should be a string that indicates the HTTP request method that
    ...
    [`method`](urllib.request.md#urllib.request.Request.method "urllib.request.Request.method") attribute and is used by [`get_method()`](urllib.request.md#urllib.request.Request.get_method "urllib.request.Request.get_method").
    The default is `'GET'` if *data* is `None` or `'POST'` otherwise.
    Subclasses may indicate a different default method by setting the
    [`method`](urllib.request.md#urllib.request.Request.method "urllib.request.Request.method") attribute in the class itself.
    ...
    Changed in version 3.3: [`Request.method`](urllib.request.md#urllib.request.Request.method "urllib.request.Request.method") argument is added to the Request class.

    Changed in version 3.4: Default [`Request.method`](urllib.request.md#urllib.request.Request.method "urllib.request.Request.method") may be indicated at the class level.
...
:   This is a mixin class that helps with HTTP authentication, both to the remote
    ...
    [HTTPPasswordMgrWithPriorAuth Objects](urllib.request.md#http-password-mgr-with-prior-auth)), then the handler will use the
...
:   Handle authentication with the remote host. *password_mgr*, if given, should
    ...
    [`ValueError`](exceptions.md#ValueError "ValueError") when presented with an authentication scheme other than
    Digest or Basic.
...
The following methods describe [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request")’s public interface,
...
:   The HTTP request method to use. By default its value is [`None`](constants.md#None "None"),
    ...
    computation in [`get_method()`](urllib.request.md#urllib.request.Request.get_method "urllib.request.Request.get_method")) either by providing a default
    value by setting it at the class level in a [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") subclass, or by
    passing a value in to the [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") constructor via the *method*
    argument.
...
:   *handler* should be an instance of [`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler"). The following methods
    ...
    - `<protocol>_open()` — signal that the handler knows how to open *protocol*
      ...
      See [`BaseHandler.<protocol>_open()`](urllib.request.md#protocol-open) for more information.
    - `http_error_<type>()` — signal that the handler knows how to handle HTTP
      errors with HTTP error code *type*.

      See [`BaseHandler.http_error_<nnn>()`](urllib.request.md#http-error-nnn) for more information.
    ...
    - `<protocol>_request()` — signal that the handler knows how to pre-process
      *protocol* requests.
      ...
      See [`BaseHandler.<protocol>_request()`](urllib.request.md#protocol-request) for more information.
...
:   Open the given *url* (which can be a request object or a string), optionally
    ...
    method on the currently installed global [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector")). The
...
:   Handle an error of the given protocol. This will call the registered error
    ...
    Return values and exceptions raised are the same as those of [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen").
...
2. Handlers with a method named like `<protocol>_open()` are called to handle
   the request. This stage ends when a handler either returns a non-[`None`](constants.md#None "None")
   value (ie. a response), or raises an exception (usually
   [`URLError`](urllib.error.md#urllib.error.URLError "urllib.error.URLError")). Exceptions are allowed to propagate.

   In fact, the above algorithm is first tried for methods named
   [`default_open()`](urllib.request.md#urllib.request.BaseHandler.default_open "urllib.request.BaseHandler.default_open"). If all such methods return [`None`](constants.md#None "None"), the algorithm
   is repeated for methods named like `<protocol>_open()`. If all such methods
   return [`None`](constants.md#None "None"), the algorithm is repeated for methods named
   [`unknown_open()`](urllib.request.md#urllib.request.BaseHandler.unknown_open "urllib.request.BaseHandler.unknown_open").

   Note that the implementation of these methods may involve calls of the parent
   [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector") instance’s [`open()`](urllib.request.md#urllib.request.OpenerDirector.open "urllib.request.OpenerDirector.open") and
   [`error()`](urllib.request.md#urllib.request.OpenerDirector.error "urllib.request.OpenerDirector.error") methods.
3. Every handler with a method named like `<protocol>_response()` has that
   method called to post-process the response.

## BaseHandler Objects

[`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler") objects provide a couple of methods that are directly
...
[`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler").
...
:   This method is *not* defined in [`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler"), but subclasses should
    ...
    [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector"). It should return a file-like object as described in
    the return value of the [`open()`](urllib.request.md#urllib.request.OpenerDirector.open "urllib.request.OpenerDirector.open") method of [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector"), or `None`.
    It should raise [`URLError`](urllib.error.md#urllib.error.URLError "urllib.error.URLError"), unless a truly exceptional
    thing happens (for example, [`MemoryError`](exceptions.md#MemoryError "MemoryError") should not be mapped to
    [`URLError`](urllib.error.md#urllib.error.URLError "urllib.error.URLError")).
...
:   This method is *not* defined in [`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler"), but subclasses should
    ...
    This method, if implemented, will be called by the [`parent`](urllib.request.md#urllib.request.BaseHandler.parent "urllib.request.BaseHandler.parent")
...
:   This method is *not* defined in [`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler"), but subclasses should
    ...
    *req* will be a [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") object, *fp* will be a file-like object with
...
:   This method is *not* defined in [`BaseHandler`](urllib.request.md#urllib.request.BaseHandler "urllib.request.BaseHandler"), but subclasses should
    ...
    This method, if defined, will be called by the parent [`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector").
    *req* will be a [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") object. *response* will be an object
    implementing the same interface as the return value of [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen"). The
...
> is the case, [`HTTPError`](urllib.error.md#urllib.error.HTTPError "urllib.error.HTTPError") is raised. See [**RFC 2616**](https://datatracker.ietf.org/doc/html/rfc2616.html) for
> details of the precise meanings of the various redirection codes.
>
> An [`HTTPError`](urllib.error.md#urllib.error.HTTPError "urllib.error.HTTPError") exception raised as a security consideration if the
...
:   Return a [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") or `None` in response to a redirect. This is called
    ...
    return a new [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") to allow `http_error_30*()` to perform the
    redirect to *newurl*. Otherwise, raise [`HTTPError`](urllib.error.md#urllib.error.HTTPError "urllib.error.HTTPError") if
...
:   Get user/password for given realm and URI, if any. This method will return
    ...
    For [`HTTPPasswordMgrWithDefaultRealm`](urllib.request.md#urllib.request.HTTPPasswordMgrWithDefaultRealm "urllib.request.HTTPPasswordMgrWithDefaultRealm") objects, the realm `None` will be
...
:   Handle an authentication request by getting a user/password pair, and re-trying
    ...
    authenticate for, *req* should be the (failed) [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") object, and
...
:   Open the file locally, if there is no host name, or the host name is
    ...
    hostname is given, a [`URLError`](urllib.error.md#urllib.error.URLError "urllib.error.URLError") is raised.
...
:   Read a data URL. This kind of URL contains the content encoded in the URL
    ...
    implementation will raise a [`ValueError`](exceptions.md#ValueError "ValueError") in that case.
...
:   Process HTTP error responses.
    ...
    `http_error_<type>()` handler methods, via [`OpenerDirector.error()`](urllib.request.md#urllib.request.OpenerDirector.error "urllib.request.OpenerDirector.error").
...
[HOWTO Fetch Internet Resources Using The urllib Package](https://docs.python.org/3.12/howto/urllib2.html#urllib-howto).
...
[context manager](https://docs.python.org/3.12/glossary.html#term-context-manager) approach:
...
Here is an example of doing a `PUT` request using [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request"):
...
[`build_opener()`](urllib.request.md#urllib.request.build_opener "urllib.request.build_opener") provides many handlers by default, including a
[`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler"). By default, [`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler") uses the environment
variables named `<scheme>_proxy`, where `<scheme>` is the URL scheme
involved. For example, the `http_proxy` environment variable is read to
obtain the HTTP proxy’s URL.

This example replaces the default [`ProxyHandler`](urllib.request.md#urllib.request.ProxyHandler "urllib.request.ProxyHandler") with one that uses
programmatically supplied proxy URLs, and adds proxy authorization support with
[`ProxyBasicAuthHandler`](urllib.request.md#urllib.request.ProxyBasicAuthHandler "urllib.request.ProxyBasicAuthHandler").
...
Use the *headers* argument to the [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") constructor, or:
...
[`OpenerDirector`](urllib.request.md#urllib.request.OpenerDirector "urllib.request.OpenerDirector") automatically adds a *User-Agent* header to
every [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request"). To change this:
...
are added when the [`Request`](urllib.request.md#urllib.request.Request "urllib.request.Request") is passed to [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen") (or
[`OpenerDirector.open()`](urllib.request.md#urllib.request.OpenerDirector.open "urllib.request.OpenerDirector.open")).
...
:   Copy a network object denoted by a URL to a local file. If the URL
    ...
    the `info()` method of the object returned by [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen") returned (for
    a remote object). Exceptions are the same as for [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen").
    ...
    *application/x-www-form-urlencoded* format; see the
    ...
    [`urlretrieve()`](urllib.request.md#urllib.request.urlretrieve "urllib.request.urlretrieve") will raise [`ContentTooShortError`](urllib.error.md#urllib.error.ContentTooShortError "urllib.error.ContentTooShortError") when it detects that
...
:   Deprecated since version 3.3.
    ...
    you probably want to use [`FancyURLopener`](urllib.request.md#urllib.request.FancyURLopener "urllib.request.FancyURLopener").

    By default, the [`URLopener`](urllib.request.md#urllib.request.URLopener "urllib.request.URLopener") class sends a *User-Agent* header
    of `urllib/VVV`, where *VVV* is the [`urllib`](urllib.md#module-urllib "urllib") version number.
    Applications can define their own *User-Agent* header by subclassing
    [`URLopener`](urllib.request.md#urllib.request.URLopener "urllib.request.URLopener") or [`FancyURLopener`](urllib.request.md#urllib.request.FancyURLopener "urllib.request.FancyURLopener") and setting the class attribute
    [`version`](urllib.request.md#urllib.request.URLopener.version "urllib.request.URLopener.version") to an appropriate string value in the subclass definition.

    The optional *proxies* parameter should be a dictionary mapping scheme names to
    proxy URLs, where an empty dictionary turns proxies off completely. Its default
    value is `None`, in which case environmental proxy settings will be used if
    present, as discussed in the definition of [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen"), above.
    ...
    *key_file* and *cert_file* are supported to provide an SSL key and certificate;
    ...
    :   Retrieves the contents of *url* and places it in *filename*. The return value
        ...
        *filename* is not given, the filename is the output of [`tempfile.mktemp()`](tempfile.md#tempfile.mktemp "tempfile.mktemp")
...
:   Deprecated since version 3.3.
    ...
    For all other response codes, the method [`http_error_default()`](urllib.request.md#urllib.request.BaseHandler.http_error_default "urllib.request.BaseHandler.http_error_default") is called
    which you can override in subclasses to handle the error appropriately.

    > **Note:**
    >
    > According to the letter of [**RFC 2616**](https://datatracker.ietf.org/doc/html/rfc2616.html), 301 and 302 responses to POST requests
    > must not be automatically redirected without confirmation by the user. In
    > reality, browsers do allow automatic redirection of these responses, changing
    > the POST to a GET, and [`urllib`](urllib.md#module-urllib "urllib") reproduces this behaviour.

    The parameters to the constructor are the same as those for [`URLopener`](urllib.request.md#urllib.request.URLopener "urllib.request.URLopener").

    > **Note:**
    >
    > When performing basic authentication, a [`FancyURLopener`](urllib.request.md#urllib.request.FancyURLopener "urllib.request.FancyURLopener") instance calls
    > its [`prompt_user_passwd()`](urllib.request.md#urllib.request.FancyURLopener.prompt_user_passwd "urllib.request.FancyURLopener.prompt_user_passwd") method. The default implementation asks the
...
- The caching feature of [`urlretrieve()`](urllib.request.md#urllib.request.urlretrieve "urllib.request.urlretrieve") has been disabled until someone
  finds the time to hack proper processing of Expiration time headers.
- There should be a function to query whether a particular URL is in the cache.
- For backward compatibility, if a URL appears to point to a local file but the
  file can’t be opened, the URL is re-interpreted using the FTP protocol. This
  can sometimes cause confusing error messages.
- The [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen") and [`urlretrieve()`](urllib.request.md#urllib.request.urlretrieve "urllib.request.urlretrieve") functions can cause arbitrarily
  long delays while waiting for a network connection to be set up. This means
  that it is difficult to build an interactive web client using these functions
  without using threads.
- The data returned by [`urlopen()`](urllib.request.md#urllib.request.urlopen "urllib.request.urlopen") or [`urlretrieve()`](urllib.request.md#urllib.request.urlretrieve "urllib.request.urlretrieve") is the raw data
  ...
  [`html.parser`](html.parser.md#module-html.parser "html.parser: A simple parser that can handle HTML and XHTML.") to parse it.
- The code handling the FTP protocol cannot differentiate between a file and a
  ...
  using the [`ftplib`](ftplib.md#module-ftplib "ftplib: FTP protocol client (requires sockets).") module, subclassing [`FancyURLopener`](urllib.request.md#urllib.request.FancyURLopener "urllib.request.FancyURLopener"), or changing
  *_urlopener* to meet your needs.

# `urllib.response` — Response classes used by urllib

The [`urllib.response`](urllib.request.md#module-urllib.response "urllib.response: Response classes used by urllib.") module defines functions and classes which define a
