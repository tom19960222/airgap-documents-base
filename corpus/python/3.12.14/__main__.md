...
source_url: https://docs.python.org/3.12/library/__main__.html
fetched_at: 2026-09-17T15:34:56+00:00
---
...
[Modules](https://docs.python.org/3.12/tutorial/modules.html#tut-modules) for an introduction.
...
- the Python module or package passed to the Python interpreter with the
  [`-m`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-m) argument:
...
- Python code read by the Python interpreter from standard input:
  ...
  ...
  ```
- Python code passed to the Python interpreter with the [`-c`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-c) argument:
...
> the tutorial section [Modules](https://docs.python.org/3.12/tutorial/modules.html#tut-modules).
...
If you are not familiar with Python packages, see section [Packages](https://docs.python.org/3.12/tutorial/modules.html#tut-packages)
...
directly from the command line using the [`-m`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-m) flag. For example:
...
package. For more details, see [Intra-package References](https://docs.python.org/3.12/tutorial/modules.html#intra-package-references) in the
[Modules](https://docs.python.org/3.12/tutorial/modules.html#tut-modules) section of the tutorial.
...
>
> See [`runpy`](runpy.md#module-runpy "runpy: Locate and run Python modules without importing them first.") for more details on the [`-m`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-m) flag to the
...
([namespace](https://docs.python.org/3.12/glossary.html#term-namespace)) by importing the `__main__` module. This doesn’t import
...
See [Special considerations for __main__](https://docs.python.org/3.12/reference/import.html#import-dunder-main) in the
