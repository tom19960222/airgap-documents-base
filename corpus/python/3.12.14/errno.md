...
source_url: https://docs.python.org/3.12/library/errno.html
...
To translate a numeric error code to an error message, use [`os.strerror()`](os.md#os.strerror "os.strerror").
