...
source_url: https://docs.python.org/3.12/library/pdb.html
fetched_at: 2026-09-17T15:34:46+00:00
---
# `pdb` — The Python Debugger

**Source code:** [Lib/pdb.py](https://github.com/python/cpython/tree/3.12/Lib/pdb.py)
...
Changed in version 3.7: The built-in [`breakpoint()`](functions.md#breakpoint "breakpoint"), when called with defaults, can be used
...
You can also invoke [`pdb`](pdb.md#module-pdb "pdb: The Python debugger for interactive interpreters.") from the command line to debug other scripts. For
example:
...
:   Execute the (one-line) *statement* in the context of the current stack frame.
    ...
    [`global`](https://docs.python.org/3.12/reference/simple_stmts.html#global) statement on the same line, e.g.:
