...
source_url: https://docs.python.org/3.12/library/email.header.html
fetched_at: 2026-09-17T15:36:08+00:00
---
# `email.header`: Internationalized headers

**Source code:** [Lib/email/header.py](https://github.com/python/cpython/tree/3.12/Lib/email/header.py)
