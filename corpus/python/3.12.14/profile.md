...
source_url: https://docs.python.org/3.12/library/profile.html
fetched_at: 2026-09-17T15:34:47+00:00
---
...
:   Specifies that a module is being profiled instead of a script.
    ...
    Added in version 3.8: Added the `-m` option to [`profile`](profile.md#module-profile "profile: Python source profiler.").
...
:   This class constructor creates an instance of a “statistics object” from a
    *filename* (or list of filenames) or from a `Profile` instance. Output
    ...
    :   This method returns an instance of StatsProfile, which contains a mapping
        ...
        Added in version 3.9: Added the following dataclasses: StatsProfile, FunctionProfile.
