...
source_url: https://docs.python.org/3.12/library/email.headerregistry.html
...
Added in version 3.6: [[1]](email.headerregistry.md#id2)
...
:   This is the factory used by [`EmailPolicy`](email.policy.md#email.policy.EmailPolicy "email.policy.EmailPolicy") by default.
    ...
    class’s [`__bases__`](https://docs.python.org/3.12/reference/datamodel.html#type.__bases__ "type.__bases__") list.
...
Originally added in 3.3 as a [provisional module](https://docs.python.org/3.12/glossary.html#term-provisional-package)
