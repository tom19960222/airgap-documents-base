...
source_url: https://docs.python.org/3.12/library/difflib.html
...
:   This is a flexible class for comparing pairs of sequences of any type, so long
    ...
    **Timing:** The basic Ratcliff-Obershelp algorithm is cubic time in the worst
    case and quadratic time in the expected case. [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher") is
    quadratic time for the worst case and has expected-case behavior dependent in a
    complicated way on how many elements the sequences have in common; best case
    time is linear.

    **Automatic junk heuristic:** [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher") supports a heuristic that
    ...
    the `autojunk` argument to `False` when creating the [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher").
...
:   This is a class for comparing sequences of lines of text, and producing
    ...
    Each line of a [`Differ`](difflib.md#difflib.Differ "difflib.Differ") delta begins with a two-letter code:
...
:   This class can be used to create an HTML table (or a complete HTML file
    ...
    :   Initializes instance of [`HtmlDiff`](difflib.md#difflib.HtmlDiff "difflib.HtmlDiff").
        ...
        *linejunk* and *charjunk* are optional keyword arguments passed into [`ndiff()`](difflib.md#difflib.ndiff "difflib.ndiff")
        (used by [`HtmlDiff`](difflib.md#difflib.HtmlDiff "difflib.HtmlDiff") to generate the side by side HTML differences). See
        [`ndiff()`](difflib.md#difflib.ndiff "difflib.ndiff") documentation for argument default values and descriptions.
...
:   Compare *a* and *b* (lists of strings); return a delta (a [generator](https://docs.python.org/3.12/glossary.html#term-generator)
    ...
    [`io.IOBase.readlines()`](io.md#io.IOBase.readlines "io.IOBase.readlines") result in diffs that are suitable for use with
    [`io.IOBase.writelines()`](io.md#io.IOBase.writelines "io.IOBase.writelines") since both the inputs and outputs have trailing
    newlines.
...
:   Compare *a* and *b* (lists of strings); return a [`Differ`](difflib.md#difflib.Differ "difflib.Differ")-style
    ...
    *linejunk*: A function that accepts a single string argument, and returns
    ...
    is also a module-level function [`IS_LINE_JUNK()`](difflib.md#difflib.IS_LINE_JUNK "difflib.IS_LINE_JUNK"), which filters out lines
    without visible characters, except for at most one pound character (`'#'`)
    – however the underlying [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher") class does a dynamic
    ...
    *charjunk*: A function that accepts a character (a string of length 1), and
    ...
    function [`IS_CHARACTER_JUNK()`](difflib.md#difflib.IS_CHARACTER_JUNK "difflib.IS_CHARACTER_JUNK"), which filters out whitespace characters (a
...
:   Compare *a* and *b* (lists of bytes objects) using *dfunc*; yield a
    ...
    *dfunc* must be a callable, typically either [`unified_diff()`](difflib.md#difflib.unified_diff "difflib.unified_diff") or
    [`context_diff()`](difflib.md#difflib.context_diff "difflib.context_diff").
...
>     was published in [Dr. Dobb’s Journal](https://www.drdobbs.com/) in July, 1988.
...
:   Optional argument *isjunk* must be `None` (the default) or a one-argument
    ...
    empty strings. The elements of both sequences must be [hashable](https://docs.python.org/3.12/glossary.html#term-hashable).
    ...
    with [`set_seqs()`](difflib.md#difflib.SequenceMatcher.set_seqs "difflib.SequenceMatcher.set_seqs") or [`set_seq2()`](difflib.md#difflib.SequenceMatcher.set_seq2 "difflib.SequenceMatcher.set_seq2").
    ...
    :   Find longest matching block in `a[alo:ahi]` and `b[blo:bhi]`.
        ...
        This method returns a [named tuple](https://docs.python.org/3.12/glossary.html#term-named-tuple) `Match(a, b, size)`.
    ...
    :   Return a measure of the sequences’ similarity as a float in the range [0,
        ...
        This is expensive to compute if [`get_matching_blocks()`](difflib.md#difflib.SequenceMatcher.get_matching_blocks "difflib.SequenceMatcher.get_matching_blocks") or
        [`get_opcodes()`](difflib.md#difflib.SequenceMatcher.get_opcodes "difflib.SequenceMatcher.get_opcodes") hasn’t already been called, in which case you may want
        to try [`quick_ratio()`](difflib.md#difflib.SequenceMatcher.quick_ratio "difflib.SequenceMatcher.quick_ratio") or [`real_quick_ratio()`](difflib.md#difflib.SequenceMatcher.real_quick_ratio "difflib.SequenceMatcher.real_quick_ratio") first to get an
        upper bound.

        > **Note:**
        >
        > Caution: The result of a [`ratio()`](difflib.md#difflib.SequenceMatcher.ratio "difflib.SequenceMatcher.ratio") call may depend on the order of
...
[`quick_ratio()`](difflib.md#difflib.SequenceMatcher.quick_ratio "difflib.SequenceMatcher.quick_ratio") and [`real_quick_ratio()`](difflib.md#difflib.SequenceMatcher.real_quick_ratio "difflib.SequenceMatcher.real_quick_ratio")
are always at least as large as [`ratio()`](difflib.md#difflib.SequenceMatcher.ratio "difflib.SequenceMatcher.ratio"):
...
[`ratio()`](difflib.md#difflib.SequenceMatcher.ratio "difflib.SequenceMatcher.ratio") returns a float in [0, 1], measuring the similarity of the
sequences. As a rule of thumb, a [`ratio()`](difflib.md#difflib.SequenceMatcher.ratio "difflib.SequenceMatcher.ratio") value over 0.6 means the
...
[`get_matching_blocks()`](difflib.md#difflib.SequenceMatcher.get_matching_blocks "difflib.SequenceMatcher.get_matching_blocks") is handy:
...
Note that the last tuple returned by [`get_matching_blocks()`](difflib.md#difflib.SequenceMatcher.get_matching_blocks "difflib.SequenceMatcher.get_matching_blocks")
is always a dummy, `(len(a), len(b), 0)`, and this is the only case in which the last
tuple element (number of elements matched) is `0`.

If you want to know how to change the first sequence into the second, use
[`get_opcodes()`](difflib.md#difflib.SequenceMatcher.get_opcodes "difflib.SequenceMatcher.get_opcodes"):
...
> **See also:**
>
> - The [`get_close_matches()`](difflib.md#difflib.get_close_matches "difflib.get_close_matches") function in this module which shows how
>   simple code building on [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher") can be used to do useful
>   work.
> - [Simple version control recipe](https://code.activestate.com/recipes/576729-simple-version-control/) for a small application
>   built with [`SequenceMatcher`](difflib.md#difflib.SequenceMatcher "difflib.SequenceMatcher").

## Differ Objects

Note that [`Differ`](difflib.md#difflib.Differ "difflib.Differ")-generated deltas make no claim to be **minimal**
...
:   Optional keyword parameters *linejunk* and *charjunk* are for filter functions
    ...
    *charjunk*: A function that accepts a single character argument (a string of
    ...
    [`find_longest_match()`](difflib.md#difflib.SequenceMatcher.find_longest_match "difflib.SequenceMatcher.find_longest_match") method’s *isjunk*
    ...
    :   Compare two sequences of lines, and generate the delta (a sequence of lines).
        ...
        [`readlines()`](io.md#io.IOBase.readlines "io.IOBase.readlines") method of file-like objects. The delta
        generated also consists of newline-terminated strings, ready to be
        printed as-is via the [`writelines()`](io.md#io.IOBase.writelines "io.IOBase.writelines") method of a
        file-like object.
...
obtained from the [`readlines()`](io.md#io.IOBase.readlines "io.IOBase.readlines") method of file-like objects):
...
Note that when instantiating a [`Differ`](difflib.md#difflib.Differ "difflib.Differ") object we may pass functions to
filter out line and character “junk.” See the [`Differ()`](difflib.md#difflib.Differ "difflib.Differ") constructor for
details.
...
This example shows how to use [`difflib.ndiff()`](difflib.md#difflib.ndiff "difflib.ndiff").
