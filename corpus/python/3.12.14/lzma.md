...
source_url: https://docs.python.org/3.12/library/lzma.html
fetched_at: 2026-09-17T15:33:01+00:00
---
# `lzma` — Compression using the LZMA algorithm

Added in version 3.3.

**Source code:** [Lib/lzma.py](https://github.com/python/cpython/tree/3.12/Lib/lzma.py)
...
:   Open an LZMA-compressed file in binary or text mode, returning a [file
    ...
    [`str`](stdtypes.md#str "str"), [`bytes`](stdtypes.md#bytes "bytes") or [path-like](https://docs.python.org/3.12/glossary.html#term-path-like-object) object), in
...
:   Open an LZMA-compressed file in binary mode.
    ...
    [`bytes`](stdtypes.md#bytes "bytes") or [path-like](https://docs.python.org/3.12/glossary.html#term-path-like-object) object). When wrapping an
