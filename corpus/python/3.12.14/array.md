...
source_url: https://docs.python.org/3.12/library/array.html
...
:   A new array whose items are restricted by *typecode*, and initialized
    ...
    If given a [`bytes`](stdtypes.md#bytes "bytes") or [`bytearray`](stdtypes.md#bytearray "bytearray") object, the initializer
    is passed to the new array’s [`frombytes()`](array.md#array.array.frombytes "array.array.frombytes") method;
    if given a Unicode string, the initializer is passed to the
    [`fromunicode()`](array.md#array.array.fromunicode "array.array.fromunicode") method;
    otherwise, the initializer’s iterator is passed to the [`extend()`](array.md#array.array.extend "array.array.extend") method
    ...
    and may be used wherever [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) are supported.
