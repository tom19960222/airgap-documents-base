...
source_url: https://docs.python.org/3.12/library/statistics.html
fetched_at: 2026-09-17T15:32:39+00:00
---
...
| [`fmean()`](statistics.md#statistics.fmean "statistics.fmean") | Fast, floating-point arithmetic mean, with optional weighting. |
...
| [`median_grouped()`](statistics.md#statistics.median_grouped "statistics.median_grouped") | Median (50th percentile) of grouped data. |
...
| [`correlation()`](statistics.md#statistics.correlation "statistics.correlation") | Pearson and Spearman’s correlation coefficients. |
...
:   Convert *data* to floats and compute the arithmetic mean.
    ...
    a [`ValueError`](exceptions.md#ValueError "ValueError") will be raised.
...
:   Estimates the median for numeric data that has been [grouped or binned](https://en.wikipedia.org/wiki/Data_binning) around the midpoints
    ...
    The regular [`median()`](statistics.md#statistics.median "statistics.median") function would assume that everyone in the
    tricenarian age group was exactly 35 years old. A more tenable
    assumption is that the 484 members of that age group are evenly
    distributed between 30 and 40. For that, we use
    [`median_grouped()`](statistics.md#statistics.median_grouped "statistics.median_grouped"):
...
:   Return the single most common data point from discrete or nominal *data*.
    ...
    Only hashable inputs are supported. To handle type [`set`](stdtypes.md#set "set"),
    consider casting to [`frozenset`](stdtypes.md#frozenset "frozenset"). To handle type [`list`](stdtypes.md#list "list"),
    consider casting to [`tuple`](stdtypes.md#tuple "tuple"). For mixed or nested inputs, consider
...
:   Return the slope and intercept of [simple linear regression](https://en.wikipedia.org/wiki/Simple_linear_regression)
    ...
    Continuing the example from [`correlation()`](statistics.md#statistics.correlation "statistics.correlation"), we look to see
...
:   Returns a new *NormalDist* object where *mu* represents the [arithmetic
    ...
    :   Makes a normal distribution instance with *mu* and *sigma* parameters
        ...
        The *data* can be any [iterable](https://docs.python.org/3.12/glossary.html#term-iterable) and should consist of values
...
normal distribution, triangular distribution, or uniform distribution](https://en.wikipedia.org/wiki/Kernel_(statistics)#Kernel_functions_in_common_use).
...
[Resample](https://en.wikipedia.org/wiki/Resampling_(statistics))
