...
source_url: https://docs.python.org/3.12/library/pyexpat.html
fetched_at: 2026-09-17T15:33:57+00:00
---
...
The [`xml.parsers.expat`](pyexpat.md#module-xml.parsers.expat "xml.parsers.expat: An interface to the Expat non-validating XML parser.") module is a Python interface to the Expat
...
:   The exception raised when Expat reports an error. See section
    [ExpatError Exceptions](pyexpat.md#expaterror-objects) for more information on interpreting Expat errors.

*exception* xml.parsers.expat.error
:   Alias for [`ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError").

xml.parsers.expat.XMLParserType
:   The type of the return values from the [`ParserCreate()`](pyexpat.md#xml.parsers.expat.ParserCreate "xml.parsers.expat.ParserCreate") function.

The [`xml.parsers.expat`](pyexpat.md#module-xml.parsers.expat "xml.parsers.expat: An interface to the Expat non-validating XML parser.") module contains two functions:
...
:   Creates and returns a new `xmlparser` object. *encoding*, if specified,
    ...
    *encoding* [[1]](pyexpat.md#id3) is given it will override the implicit or explicit encoding of the
    document.
    ...
    parsers are created by [`parser.ExternalEntityParserCreate`](pyexpat.md#xml.parsers.expat.xmlparser.ExternalEntityParserCreate "xml.parsers.expat.xmlparser.ExternalEntityParserCreate").
    ...
    [`ValueError`](exceptions.md#ValueError "ValueError") will be raised if the string has an illegal length (`None`
...
:   Sets the base to be used for resolving relative URIs in system identifiers in
    ...
    [`ExternalEntityRefHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.ExternalEntityRefHandler "xml.parsers.expat.xmlparser.ExternalEntityRefHandler"), [`NotationDeclHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.NotationDeclHandler "xml.parsers.expat.xmlparser.NotationDeclHandler"), and
    [`UnparsedEntityDeclHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.UnparsedEntityDeclHandler "xml.parsers.expat.xmlparser.UnparsedEntityDeclHandler") functions.

xmlparser.GetBase()
:   Returns a string containing the base set by a previous call to [`SetBase()`](pyexpat.md#xml.parsers.expat.xmlparser.SetBase "xml.parsers.expat.xmlparser.SetBase"),
    or `None` if [`SetBase()`](pyexpat.md#xml.parsers.expat.xmlparser.SetBase "xml.parsers.expat.xmlparser.SetBase") hasn’t been called.
...
:   Create a “child” parser which can be used to parse an external parsed entity
    ...
    should be the string passed to the [`ExternalEntityRefHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.ExternalEntityRefHandler "xml.parsers.expat.xmlparser.ExternalEntityRefHandler") handler
    function, described below. The child parser is created with the
    [`ordered_attributes`](pyexpat.md#xml.parsers.expat.xmlparser.ordered_attributes "xml.parsers.expat.xmlparser.ordered_attributes") and [`specified_attributes`](pyexpat.md#xml.parsers.expat.xmlparser.specified_attributes "xml.parsers.expat.xmlparser.specified_attributes") set to the values of
    this parser.
...
:   Calling this with a true value for *flag* (the default) will cause Expat to call
    the [`ExternalEntityRefHandler`](pyexpat.md#xml.parsers.expat.xmlparser.ExternalEntityRefHandler "xml.parsers.expat.xmlparser.ExternalEntityRefHandler") with [`None`](constants.md#None "None") for all arguments to
    allow an alternate DTD to be loaded. If the document does not contain a
    document type declaration, the [`ExternalEntityRefHandler`](pyexpat.md#xml.parsers.expat.xmlparser.ExternalEntityRefHandler "xml.parsers.expat.xmlparser.ExternalEntityRefHandler") will still be
    called, but the [`StartDoctypeDeclHandler`](pyexpat.md#xml.parsers.expat.xmlparser.StartDoctypeDeclHandler "xml.parsers.expat.xmlparser.StartDoctypeDeclHandler") and
    [`EndDoctypeDeclHandler`](pyexpat.md#xml.parsers.expat.xmlparser.EndDoctypeDeclHandler "xml.parsers.expat.xmlparser.EndDoctypeDeclHandler") will not be called.

    Passing a false value for *flag* will cancel a previous call that passed a true
    value, but otherwise has no effect.

    This method can only be called before the [`Parse()`](pyexpat.md#xml.parsers.expat.xmlparser.Parse "xml.parsers.expat.xmlparser.Parse") or [`ParseFile()`](pyexpat.md#xml.parsers.expat.xmlparser.ParseFile "xml.parsers.expat.xmlparser.ParseFile")
    methods are called; calling it after either of those have been called causes
    [`ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError") to be raised with the [`code`](code.md#module-code "code: Facilities to implement read-eval-print loops.") attribute set to
...
:   > **Warning:**
    ...
    Note that [`SetReparseDeferralEnabled()`](pyexpat.md#xml.parsers.expat.xmlparser.SetReparseDeferralEnabled "xml.parsers.expat.xmlparser.SetReparseDeferralEnabled") has been backported to some
    prior releases of CPython as a security fix. Check for availability of
    [`SetReparseDeferralEnabled()`](pyexpat.md#xml.parsers.expat.xmlparser.SetReparseDeferralEnabled "xml.parsers.expat.xmlparser.SetReparseDeferralEnabled") using [`hasattr()`](functions.md#hasattr "hasattr") if used in code
...
:   Sets the number of output bytes needed to activate protection against
    ...
    An [`ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError") is raised if this method is called on a
    [non-root](pyexpat.md#xmlparser-non-root) parser.
    The corresponding [`lineno`](pyexpat.md#xml.parsers.expat.ExpatError.lineno "xml.parsers.expat.ExpatError.lineno") and [`offset`](pyexpat.md#xml.parsers.expat.ExpatError.offset "xml.parsers.expat.ExpatError.offset")
...
:   Sets the maximum tolerated amplification factor for protection against
    ...
    The *max_factor* value must be a non-NaN [`float`](functions.md#float "float") value greater than
    ...
    An [`ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError") is raised if this method is called on a
    [non-root](pyexpat.md#xmlparser-non-root) parser or if *max_factor* is outside the valid range.
    The corresponding [`lineno`](pyexpat.md#xml.parsers.expat.ExpatError.lineno "xml.parsers.expat.ExpatError.lineno") and [`offset`](pyexpat.md#xml.parsers.expat.ExpatError.offset "xml.parsers.expat.ExpatError.offset")
    should not be used as they may have no special meaning.
    ...
    > that can be adjusted by [`SetBillionLaughsAttackProtectionActivationThreshold()`](pyexpat.md#xml.parsers.expat.xmlparser.SetBillionLaughsAttackProtectionActivationThreshold "xml.parsers.expat.xmlparser.SetBillionLaughsAttackProtectionActivationThreshold")
    > is exceeded.
...
:   Sets the maximum amplification factor between direct input and bytes
    ...
    >
    > The maximum amplification factor is only considered if the threshold
    > that can be adjusted by [`SetAllocTrackerActivationThreshold()`](pyexpat.md#xml.parsers.expat.xmlparser.SetAllocTrackerActivationThreshold "xml.parsers.expat.xmlparser.SetAllocTrackerActivationThreshold")
    > is exceeded.
...
:   The size of the buffer used when [`buffer_text`](pyexpat.md#xml.parsers.expat.xmlparser.buffer_text "xml.parsers.expat.xmlparser.buffer_text") is true.
...
:   Setting this to true causes the `xmlparser` object to buffer textual
    ...
    [`CharacterDataHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.CharacterDataHandler "xml.parsers.expat.xmlparser.CharacterDataHandler") callback whenever possible. This can improve
...
:   If [`buffer_text`](pyexpat.md#xml.parsers.expat.xmlparser.buffer_text "xml.parsers.expat.xmlparser.buffer_text") is enabled, the number of bytes stored in the buffer.
    These bytes represent UTF-8 encoded text. This attribute has no meaningful
    interpretation when [`buffer_text`](pyexpat.md#xml.parsers.expat.xmlparser.buffer_text "xml.parsers.expat.xmlparser.buffer_text") is false.
...
[`xml.parsers.expat.ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError") exception.
...
:   Numeric code specifying the problem. This value can be passed to the
    [`ErrorString()`](pyexpat.md#xml.parsers.expat.ErrorString "xml.parsers.expat.ErrorString") function, or compared to one of the constants defined in the
    `errors` object.
...
:   Called for the start of every element. *name* is a string containing the
    ...
    [`ordered_attributes`](pyexpat.md#xml.parsers.expat.xmlparser.ordered_attributes "xml.parsers.expat.xmlparser.ordered_attributes") is true, this is a list (see
    [`ordered_attributes`](pyexpat.md#xml.parsers.expat.xmlparser.ordered_attributes "xml.parsers.expat.xmlparser.ordered_attributes") for a full description). Otherwise it’s a
...
:   Called for character data. This will be called for normal character data, CDATA
    ...
    these cases can use the [`StartCdataSectionHandler`](pyexpat.md#xml.parsers.expat.xmlparser.StartCdataSectionHandler "xml.parsers.expat.xmlparser.StartCdataSectionHandler"),
    [`EndCdataSectionHandler`](pyexpat.md#xml.parsers.expat.xmlparser.EndCdataSectionHandler "xml.parsers.expat.xmlparser.EndCdataSectionHandler"), and [`ElementDeclHandler`](pyexpat.md#xml.parsers.expat.xmlparser.ElementDeclHandler "xml.parsers.expat.xmlparser.ElementDeclHandler") callbacks to
    ...
    [`CharacterDataHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.CharacterDataHandler "xml.parsers.expat.xmlparser.CharacterDataHandler"). Set the [`buffer_text`](pyexpat.md#xml.parsers.expat.xmlparser.buffer_text "xml.parsers.expat.xmlparser.buffer_text") instance attribute
...
:   Called for unparsed (NDATA) entity declarations. This is only present for
    ...
    [`EntityDeclHandler`](pyexpat.md#xml.parsers.expat.xmlparser.EntityDeclHandler "xml.parsers.expat.xmlparser.EntityDeclHandler") instead. (The underlying function in the Expat
...
:   Called when an element contains a namespace declaration. Namespace declarations
    are processed before the [`StartElementHandler`](pyexpat.md#xml.parsers.expat.xmlparser.StartElementHandler "xml.parsers.expat.xmlparser.StartElementHandler") is called for the element
...
:   Called when the closing tag is reached for an element that contained a
    ...
    [`StartNamespaceDeclHandler`](pyexpat.md#xml.parsers.expat.xmlparser.StartNamespaceDeclHandler "xml.parsers.expat.xmlparser.StartNamespaceDeclHandler") was called to indicate the start of each
    namespace declaration’s scope. Calls to this handler are made after the
    corresponding [`EndElementHandler`](pyexpat.md#xml.parsers.expat.xmlparser.EndElementHandler "xml.parsers.expat.xmlparser.EndElementHandler") for the end of the element.
...
:   Called at the start of a CDATA section. This and [`EndCdataSectionHandler`](pyexpat.md#xml.parsers.expat.xmlparser.EndCdataSectionHandler "xml.parsers.expat.xmlparser.EndCdataSectionHandler")
...
:   This is the same as the [`DefaultHandler()`](pyexpat.md#xml.parsers.expat.xmlparser.DefaultHandler "xml.parsers.expat.xmlparser.DefaultHandler"), but doesn’t inhibit expansion
...
:   Called for references to external entities. *base* is the current base, as set
    by a previous call to [`SetBase()`](pyexpat.md#xml.parsers.expat.xmlparser.SetBase "xml.parsers.expat.xmlparser.SetBase"). The public and system identifiers,
    *systemId* and *publicId*, are strings if given; if the public identifier is not
    ...
    [`DefaultHandler`](pyexpat.md#xml.parsers.expat.xmlparser.DefaultHandler "xml.parsers.expat.xmlparser.DefaultHandler") callback, if provided.

## ExpatError Exceptions

[`ExpatError`](pyexpat.md#xml.parsers.expat.ExpatError "xml.parsers.expat.ExpatError") exceptions have a number of interesting attributes:

ExpatError.code
:   Expat’s internal error number for the specific error. The
    [`errors.messages`](pyexpat.md#xml.parsers.expat.errors.messages "xml.parsers.expat.errors.messages") dictionary maps
    ...
    The [`errors`](pyexpat.md#module-xml.parsers.expat.errors "xml.parsers.expat.errors") module also provides error message
    constants and a dictionary [`codes`](pyexpat.md#xml.parsers.expat.errors.codes "xml.parsers.expat.errors.codes") mapping
...
[`xml.parsers.expat.model`](pyexpat.md#module-xml.parsers.expat.model "xml.parsers.expat.model") module. These constants can be collected in two
...
The following constants are provided in the [`xml.parsers.expat.errors`](pyexpat.md#module-xml.parsers.expat.errors "xml.parsers.expat.errors")
...
[`code`](code.md#module-code "code: Facilities to implement read-eval-print loops.") attribute with
...
:   An operation was requested that requires DTD support to be compiled in, but
    ...
    standard build of the [`xml.parsers.expat`](pyexpat.md#module-xml.parsers.expat "xml.parsers.expat: An interface to the Expat non-validating XML parser.") module.
