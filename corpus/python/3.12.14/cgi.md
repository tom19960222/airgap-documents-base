...
source_url: https://docs.python.org/3.12/library/cgi.html
fetched_at: 2026-09-17T15:35:36+00:00
---
# `cgi` — Common Gateway Interface support

**Source code:** [Lib/cgi.py](https://github.com/python/cpython/tree/3.12/Lib/cgi.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`cgi`](cgi.md#module-cgi "cgi: Helpers for running Python scripts via the Common Gateway Interface. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#cgi) for details and alternatives).

The `FieldStorage` class can typically be replaced with
[`urllib.parse.parse_qsl()`](urllib.parse.md#urllib.parse.parse_qsl "urllib.parse.parse_qsl") for `GET` and `HEAD` requests,
and the [`email.message`](email.message.md#module-email.message "email.message: The base class representing email messages.") module or
[multipart](https://pypi.org/project/multipart/) for `POST` and `PUT`.
Most [utility functions](cgi.md#functions-in-cgi-module) have replacements.
...
[`ValueError`](exceptions.md#ValueError "ValueError") being raised during parsing. The default value of this
...
produced by [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") provide information that can save you a lot of time in
...
It allows membership testing with the [`in`](https://docs.python.org/3.12/reference/expressions.html#in) operator, and also supports
the standard dictionary method [`keys()`](stdtypes.md#dict.keys "dict.keys") and the built-in function
[`len()`](functions.md#len "len"). Form fields containing empty strings are ignored and do not appear
...
same name), use the [`getlist()`](cgi.md#cgi.FieldStorage.getlist "cgi.FieldStorage.getlist") method, which always returns
...
(the [`read()`](io.md#io.RawIOBase.read "io.RawIOBase.read") and [`readline()`](io.md#io.IOBase.readline "io.IOBase.readline") methods will
return bytes):
...
`FieldStorage` objects also support being used in a [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with)
...
instead of a string. Calling the [`upper()`](stdtypes.md#str.upper "str.upper") method on a list is not valid
(since lists do not have a method of this name) and results in an
[`AttributeError`](exceptions.md#AttributeError "AttributeError") exception.
...
:   This method always returns only one value associated with form field *name*.
    ...
    may vary from browser to browser and should not be counted on. [[1]](cgi.md#id3) If no such
...
:   Parse a query in the environment or from a file (the file defaults to
    ...
    Deprecated since version 3.11, will be removed in version 3.13: This function, like the rest of the [`cgi`](cgi.md#module-cgi "cgi: Helpers for running Python scripts via the Common Gateway Interface. (deprecated)") module, is deprecated.
    It can be replaced by calling [`urllib.parse.parse_qs()`](urllib.parse.md#urllib.parse.parse_qs "urllib.parse.parse_qs") directly
...
:   Parse input of type *multipart/form-data* (for file uploads).
    ...
    Returns a dictionary just like [`urllib.parse.parse_qs()`](urllib.parse.md#urllib.parse.parse_qs "urllib.parse.parse_qs"): keys are the
    ...
    Deprecated since version 3.11, will be removed in version 3.13: This function, like the rest of the [`cgi`](cgi.md#module-cgi "cgi: Helpers for running Python scripts via the Common Gateway Interface. (deprecated)") module, is deprecated.
    It can be replaced with the functionality in the [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.") package
    (e.g. [`email.message.EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage")/[`email.message.Message`](email.compat32-message.md#email.message.Message "email.message.Message"))
...
:   Parse a MIME header (such as *Content-Type*) into a main value and a
    ...
    For example, with [`email.message.EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage"):
...
[`os.system()`](os.md#os.system "os.system"), [`os.popen()`](os.md#os.popen "os.popen") or other functions with similar
...
search path ([`PYTHONPATH`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONPATH)) to be set to anything interesting.
...
The next step could be to call the [`cgi`](cgi.md#module-cgi "cgi: Helpers for running Python scripts via the Common Gateway Interface. (deprecated)") module’s [`test()`](test.md#module-test "test: Regression tests package containing the testing suite for Python.") function
...
you can easily send tracebacks to the web browser using the [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") module.
...
If you suspect that there may be a problem in importing the [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") module,
