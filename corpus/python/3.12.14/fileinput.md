...
source_url: https://docs.python.org/3.12/library/fileinput.html
fetched_at: 2026-09-17T15:32:46+00:00
---
...
:   Create an instance of the [`FileInput`](fileinput.md#fileinput.FileInput "fileinput.FileInput") class. The instance will be used
    ...
    [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. In this example, *input* is closed after the
...
:   Class [`FileInput`](fileinput.md#fileinput.FileInput "fileinput.FileInput") is the implementation; its methods [`filename()`](fileinput.md#fileinput.filename "fileinput.filename"),
    ...
    functions of the same name in the module. In addition it is [iterable](https://docs.python.org/3.12/glossary.html#term-iterable)
    and has a [`readline()`](io.md#io.TextIOBase.readline "io.TextIOBase.readline") method which returns the next
    input line. The sequence must be accessed in strictly sequential order;
    random access and [`readline()`](io.md#io.TextIOBase.readline "io.TextIOBase.readline") cannot be mixed.
