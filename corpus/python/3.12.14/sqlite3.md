...
source_url: https://docs.python.org/3.12/library/sqlite3.html
fetched_at: 2026-09-17T15:32:57+00:00
---
...
- [Tutorial](sqlite3.md#sqlite3-tutorial) teaches how to use the `sqlite3` module.
- [Reference](sqlite3.md#sqlite3-reference) describes the classes and functions this module
  defines.
- [How-to guides](sqlite3.md#sqlite3-howtos) details how to handle specific tasks.
- [Explanation](sqlite3.md#sqlite3-explanation) provides in-depth background on
  transaction control.
...
Call [`sqlite3.connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect") to create a connection to
...
The returned [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") object `con`
represents the connection to the on-disk database.

In order to execute SQL statements and fetch results from SQL queries,
we will need to use a database cursor.
Call [`con.cursor()`](sqlite3.md#sqlite3.Connection.cursor "sqlite3.Connection.cursor") to create the [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor"):
...
by calling [`cur.execute(...)`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute"):
...
Execute that query by calling [`cur.execute(...)`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute"),
assign the result to `res`,
and call [`res.fetchone()`](sqlite3.md#sqlite3.Cursor.fetchone "sqlite3.Cursor.fetchone") to fetch the resulting row:
...
as the query returns a [`tuple`](stdtypes.md#tuple "tuple") containing the table’s name.
...
once again by calling [`cur.execute(...)`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute"):
...
(see [Transaction control](sqlite3.md#sqlite3-controlling-transactions) for details).
Call [`con.commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit") on the connection object
...
Use the now-familiar [`cur.execute(...)`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") to
assign the result to `res`,
and call [`res.fetchall()`](sqlite3.md#sqlite3.Cursor.fetchall "sqlite3.Cursor.fetchall") to return all resulting rows:
...
The result is a [`list`](stdtypes.md#list "list") of two `tuple`s, one per row,
each containing that row’s `score` value.

Now, insert three more rows by calling
[`cur.executemany(...)`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany"):
...
Always use placeholders instead of [string formatting](https://docs.python.org/3.12/tutorial/inputoutput.html#tut-formatting)
to bind Python values to SQL statements,
to avoid [SQL injection attacks](https://en.wikipedia.org/wiki/SQL_injection)
(see [How to use placeholders to bind values in SQL queries](sqlite3.md#sqlite3-placeholders) for more details).
...
Each row is a two-item [`tuple`](stdtypes.md#tuple "tuple") of `(year, title)`,
matching the columns selected in the query.

Finally, verify that the database has been written to disk
by calling [`con.close()`](sqlite3.md#sqlite3.Connection.close "sqlite3.Connection.close")
...
> **See also:**
>
> - [How-to guides](sqlite3.md#sqlite3-howtos) for further reading:
>
>   - [How to use placeholders to bind values in SQL queries](sqlite3.md#sqlite3-placeholders)
>   - [How to adapt custom Python types to SQLite values](sqlite3.md#sqlite3-adapters)
>   - [How to convert SQLite values to custom Python types](sqlite3.md#sqlite3-converters)
>   - [How to use the connection context manager](sqlite3.md#sqlite3-connection-context-manager)
>   - [How to create and use row factories](sqlite3.md#sqlite3-howto-row-factory)
> - [Explanation](sqlite3.md#sqlite3-explanation) for in-depth background on transaction control.
...
:   Open a connection to an SQLite database.
    ...
    Parameters:
    :   - **database** ([path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object)) – The path to the database file to be opened.
          ...
          to it.
        - **timeout** ([*float*](functions.md#float "float")) – How many seconds the connection should wait before raising
          an [`OperationalError`](sqlite3.md#sqlite3.OperationalError "sqlite3.OperationalError") when a table is locked.
        ...
        - **detect_types** ([*int*](functions.md#int "int")) – Control whether and how data types not
          [natively supported by SQLite](sqlite3.md#sqlite3-types)
          are looked up to be converted to Python types,
          using the converters registered with [`register_converter()`](sqlite3.md#sqlite3.register_converter "sqlite3.register_converter").
          Set it to any combination (using `|`, bitwise or) of
          [`PARSE_DECLTYPES`](sqlite3.md#sqlite3.PARSE_DECLTYPES "sqlite3.PARSE_DECLTYPES") and [`PARSE_COLNAMES`](sqlite3.md#sqlite3.PARSE_COLNAMES "sqlite3.PARSE_COLNAMES")
          to enable this.
          Column names takes precedence over declared types if both flags are set.
          By default (`0`), type detection is disabled.
        - **isolation_level** ([*str*](stdtypes.md#str "str") *|* *None*) – Control legacy transaction handling behaviour.
          See [`Connection.isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") and
          [Transaction control via the isolation_level attribute](sqlite3.md#sqlite3-transaction-control-isolation-level) for more information.
          Can be `"DEFERRED"` (default), `"EXCLUSIVE"` or `"IMMEDIATE"`;
          or `None` to disable opening transactions implicitly.
          Has no effect unless [`Connection.autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") is set to
          [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL") (the default).
        - **check_same_thread** ([*bool*](functions.md#bool "bool")) – If `True` (default), [`ProgrammingError`](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") will be raised
          ...
          See [`threadsafety`](sqlite3.md#sqlite3.threadsafety "sqlite3.threadsafety") for more information.
        - **factory** ([*Connection*](sqlite3.md#sqlite3.Connection "sqlite3.Connection")) – A custom subclass of [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") to create the connection with,
          if not the default [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") class.
        - **cached_statements** ([*int*](functions.md#int "int")) – The number of statements that `sqlite3`
          should internally cache for this connection, to avoid parsing overhead.
          By default, 128 statements.
        - **uri** ([*bool*](functions.md#bool "bool")) – If set to `True`, *database* is interpreted as a
          ...
          enabling various [How to work with SQLite URIs](sqlite3.md#sqlite3-uri-tricks).
        - **autocommit** ([*bool*](functions.md#bool "bool")) – Control [**PEP 249**](https://peps.python.org/pep-0249/) transaction handling behaviour.
          See [`Connection.autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") and
          [Transaction control via the autocommit attribute](sqlite3.md#sqlite3-transaction-control-autocommit) for more information.
    ...
    Changed in version 3.7: *database* can now also be a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object), not only a string.
...
:   Return `True` if the string *statement* appears to contain
    ...
    or if additional input is needed before calling [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute").
...
:   Enable or disable callback tracebacks.
    ...
    will get tracebacks from callbacks on [`sys.stderr`](sys.md#sys.stderr "sys.stderr"). Use `False`
...
:   Register the *converter* [callable](https://docs.python.org/3.12/glossary.html#term-callable) to convert SQLite objects of type
    *typename* into a Python object of a specific type.
    ...
    it is passed a [`bytes`](stdtypes.md#bytes "bytes") object and should return an object of the
    desired Python type.
    Consult the parameter *detect_types* of
    [`connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect") for information regarding how type detection works.
...
:   Pass this flag value to the *detect_types* parameter of
    ...
    This flag may be combined with [`PARSE_COLNAMES`](sqlite3.md#sqlite3.PARSE_COLNAMES "sqlite3.PARSE_COLNAMES") using the `|`
    (bitwise or) operator.
...
:   Each open SQLite database is represented by a `Connection` object,
    ...
    and [Transaction control](sqlite3.md#sqlite3-controlling-transactions).

    > **See also:**
    >
    > - [How to use connection shortcut methods](sqlite3.md#sqlite3-connection-shortcuts)
    > - [How to use the connection context manager](sqlite3.md#sqlite3-connection-context-manager)
    ...
    :   Open a [`Blob`](sqlite3.md#sqlite3.Blob "sqlite3.Blob") handle to an existing
        ...
        Parameters:
        :   - **table** ([*str*](stdtypes.md#str "str")) – The name of the table where the blob is located.
            - **column** ([*str*](stdtypes.md#str "str")) – The name of the column where the blob is located.
            - **row** ([*str*](stdtypes.md#str "str")) – The name of the row where the blob is located.
            - **readonly** ([*bool*](functions.md#bool "bool")) – Set to `True` if the blob should be opened without write
              permissions.
              Defaults to `False`.
            - **name** ([*str*](stdtypes.md#str "str")) – The name of the database where the blob is located.
              Defaults to `"main"`.

        Raises:
        :   [**OperationalError**](sqlite3.md#sqlite3.OperationalError "sqlite3.OperationalError") – When trying to open a blob in a `WITHOUT ROWID` table.

        Return type:
        :   [Blob](sqlite3.md#sqlite3.Blob "sqlite3.Blob")

        > **Note:**
        >
        > The blob size cannot be changed using the [`Blob`](sqlite3.md#sqlite3.Blob "sqlite3.Blob") class.
    ...
    :   Close the database connection.
        ...
        If `autocommit` is `True` or [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL"),
    ...
    :   Create or remove a user-defined SQL function.
        ...
        Parameters:
        :   - **name** ([*str*](stdtypes.md#str "str")) – The name of the SQL function.
            - **narg** ([*int*](functions.md#int "int")) – The number of arguments the SQL function can accept.
              If `-1`, it may take any number of arguments.
            - **func** ([callback](https://docs.python.org/3.12/glossary.html#term-callback) | None) – A [callable](https://docs.python.org/3.12/glossary.html#term-callable) that is called when the SQL function is invoked.
              The callable must return [a type natively supported by SQLite](sqlite3.md#sqlite3-types).
              Set to `None` to remove an existing SQL function.
            - **deterministic** ([*bool*](functions.md#bool "bool")) – If `True`, the created SQL function is marked as
              [deterministic](https://sqlite.org/deterministic.html),
              which allows SQLite to perform additional optimizations.

        Raises:
        :   [**NotSupportedError**](sqlite3.md#sqlite3.NotSupportedError "sqlite3.NotSupportedError") – If *deterministic* is used with SQLite versions older than 3.8.3.
    ...
    :   Create or remove a user-defined SQL aggregate function.
        ...
        Parameters:
        :   - **name** ([*str*](stdtypes.md#str "str")) – The name of the SQL aggregate function.
            - **n_arg** ([*int*](functions.md#int "int")) – The number of arguments the SQL aggregate function can accept.
              If `-1`, it may take any number of arguments.
            - **aggregate_class** ([class](https://docs.python.org/3.12/glossary.html#term-class) | None) –

              A class must implement the following methods:

              - `step()`: Add a row to the aggregate.
              - `finalize()`: Return the final result of the aggregate as
                [a type natively supported by SQLite](sqlite3.md#sqlite3-types).
    ...
    :   Create or remove a user-defined aggregate window function.
        ...
        Parameters:
        :   - **name** ([*str*](stdtypes.md#str "str")) – The name of the SQL aggregate window function to create or remove.
            - **num_params** ([*int*](functions.md#int "int")) – The number of arguments the SQL aggregate window function can accept.
              If `-1`, it may take any number of arguments.
            - **aggregate_class** ([class](https://docs.python.org/3.12/glossary.html#term-class) | None) –
        ...
        Raises:
        :   [**NotSupportedError**](sqlite3.md#sqlite3.NotSupportedError "sqlite3.NotSupportedError") – If used with a version of SQLite older than 3.25.0,
    ...
    :   Register [callable](https://docs.python.org/3.12/glossary.html#term-callable) *authorizer_callback* to be invoked
        ...
        [`SQLITE_DENY`](sqlite3.md#sqlite3.SQLITE_DENY "sqlite3.SQLITE_DENY"), or [`SQLITE_IGNORE`](sqlite3.md#sqlite3.SQLITE_IGNORE "sqlite3.SQLITE_IGNORE")
    ...
    :   Register [callable](https://docs.python.org/3.12/glossary.html#term-callable) *trace_callback* to be invoked
        ...
        [`str`](stdtypes.md#str "str")) that is being executed. The return value of the callback is
        ignored. Note that the backend does not only run statements passed to the
        [`Cursor.execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") methods. Other sources include the
        [transaction management](sqlite3.md#sqlite3-controlling-transactions) of the
        ...
        > [`enable_callback_tracebacks()`](sqlite3.md#sqlite3.enable_callback_tracebacks "sqlite3.enable_callback_tracebacks") to enable printing
    ...
    :   Enable the SQLite engine to load SQLite extensions from shared libraries
        ...
        > you must pass the [`--enable-loadable-sqlite-extensions`](https://docs.python.org/3.12/using/configure.html#cmdoption-enable-loadable-sqlite-extensions) option
        > to **configure**.
    ...
    :   Load an SQLite extension from a shared library.
        ...
        Parameters:
        :   - **path** ([*str*](stdtypes.md#str "str")) – The path to the SQLite extension.
            - **entrypoint** ([*str*](stdtypes.md#str "str") *|* *None*) – Entry point name.
              If `None` (the default),
    ...
    :   Create a backup of an SQLite database.
        ...
        Parameters:
        :   - **target** ([*Connection*](sqlite3.md#sqlite3.Connection "sqlite3.Connection")) – The database connection to save the backup to.
            - **pages** ([*int*](functions.md#int "int")) – The number of pages to copy at a time.
              If equal to or less than `0`,
              the entire database is copied in a single step.
              Defaults to `-1`.
            - **progress** ([callback](https://docs.python.org/3.12/glossary.html#term-callback) | None) – If set to a [callable](https://docs.python.org/3.12/glossary.html#term-callable),
              ...
              Defaults to `None`.
            - **name** ([*str*](stdtypes.md#str "str")) – The name of the database to back up.
            ...
            - **sleep** ([*float*](functions.md#float "float")) – The number of seconds to sleep between successive attempts
    ...
    :   Get a connection runtime limit.
        ...
        Parameters:
        :   **category** ([*int*](functions.md#int "int")) – The [SQLite limit category](https://www.sqlite.org/c3ref/c_limit_attached.html) to be queried.

        Return type:
        :   [int](functions.md#int "int")

        Raises:
        :   [**ProgrammingError**](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") – If *category* is not recognised by the underlying SQLite library.

        Example, query the maximum length of an SQL statement
        for [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") `con` (the default is 1000000000):
    ...
    :   Set a connection runtime limit.
        ...
        Parameters:
        :   - **category** ([*int*](functions.md#int "int")) – The [SQLite limit category](https://www.sqlite.org/c3ref/c_limit_attached.html) to be set.
            - **limit** ([*int*](functions.md#int "int")) – The value of the new limit.
        ...
        for [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") `con` (the default limit is 10):
    ...
    :   Query a boolean connection configuration option.
        ...
        Parameters:
        :   **op** ([*int*](functions.md#int "int")) – A [SQLITE_DBCONFIG code](sqlite3.md#sqlite3-dbconfig-constants).
    ...
    :   Set a boolean connection configuration option.
        ...
        Parameters:
        :   - **op** ([*int*](functions.md#int "int")) – A [SQLITE_DBCONFIG code](sqlite3.md#sqlite3-dbconfig-constants).
            - **enable** ([*bool*](functions.md#bool "bool")) – `True` if the configuration option should be enabled (default);
    ...
    :   Serialize a database into a [`bytes`](stdtypes.md#bytes "bytes") object. For an
        ...
        Parameters:
        :   **name** ([*str*](stdtypes.md#str "str")) – The database name to be serialized.
            Defaults to `"main"`.
    ...
    :   Deserialize a [`serialized`](sqlite3.md#sqlite3.Connection.serialize "sqlite3.Connection.serialize") database into a
        ...
        *name*, and reopen *name* as an in-memory database based on the
        ...
        Parameters:
        :   - **data** ([*bytes*](stdtypes.md#bytes "bytes")) – A serialized database.
            - **name** ([*str*](stdtypes.md#str "str")) – The database name to deserialize into.
              Defaults to `"main"`.

        Raises:
        :   - [**OperationalError**](sqlite3.md#sqlite3.OperationalError "sqlite3.OperationalError") – If the database connection is currently involved in a read
              transaction or a backup operation.
            - [**DatabaseError**](sqlite3.md#sqlite3.DatabaseError "sqlite3.DatabaseError") – If *data* does not contain a valid SQLite database.
            - [**OverflowError**](exceptions.md#OverflowError "OverflowError") – If [`len(data)`](functions.md#len "len") is larger than `2**63 - 1`.
    ...
    :   This attribute controls [**PEP 249**](https://peps.python.org/pep-0249/)-compliant transaction behaviour.
        ...
        - `False`: Select [**PEP 249**](https://peps.python.org/pep-0249/)-compliant transaction behaviour,
          ...
          Use [`commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit") and [`rollback()`](sqlite3.md#sqlite3.Connection.rollback "sqlite3.Connection.rollback") to close transactions.
        ...
        - `True`: Use SQLite’s [autocommit mode](https://www.sqlite.org/lang_transaction.html#implicit_versus_explicit_transactions).
          [`commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit") and [`rollback()`](sqlite3.md#sqlite3.Connection.rollback "sqlite3.Connection.rollback") have no effect in this mode.
        - [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL"):
          Pre-Python 3.12 (non-[**PEP 249**](https://peps.python.org/pep-0249/)-compliant) transaction control.
          See [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") for more details.
        ...
        See [Transaction control via the autocommit attribute](sqlite3.md#sqlite3-transaction-control-autocommit) for more details.

        > **Note:**
        >
        > The [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") attribute has no effect unless
        > [`autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") is [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL").
    ...
    :   Controls the [legacy transaction handling mode](sqlite3.md#sqlite3-transaction-control-isolation-level) of `sqlite3`.
        ...
        [implicit transaction management](sqlite3.md#sqlite3-transaction-control-isolation-level) is performed.

        If not overridden by the *isolation_level* parameter of [`connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect"),
        the default is `""`, which is an alias for `"DEFERRED"`.

        > **Note:**
        >
        > Using [`autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") to control transaction handling is
    ...
    :   The initial [`row_factory`](sqlite3.md#sqlite3.Cursor.row_factory "sqlite3.Cursor.row_factory")
        ...
        Is `None` by default,
        meaning each row is returned as a [`tuple`](stdtypes.md#tuple "tuple").
    ...
    :   A [callable](https://docs.python.org/3.12/glossary.html#term-callable) that accepts a [`bytes`](stdtypes.md#bytes "bytes") parameter
        ...
        By default, this attribute is set to [`str`](stdtypes.md#str "str").
...
> Cursors are created using [`Connection.cursor()`](sqlite3.md#sqlite3.Connection.cursor "sqlite3.Connection.cursor"),
> or by using any of the [connection shortcut methods](sqlite3.md#sqlite3-connection-shortcuts).
>
> Cursor objects are [iterators](https://docs.python.org/3.12/glossary.html#term-iterator),
> meaning that if you [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") a `SELECT` query,
...
:   A [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") instance has the following attributes and methods.
    ...
    :   Execute a single SQL statement,
        ...
        Parameters:
        :   - **sql** ([*str*](stdtypes.md#str "str")) – A single SQL statement.
            - **parameters** ([`dict`](stdtypes.md#dict "dict") | [sequence](https://docs.python.org/3.12/glossary.html#term-sequence)) – Python values to bind to placeholders in *sql*.
              A `dict` if named placeholders are used.
              A sequence if unnamed placeholders are used.
              See [How to use placeholders to bind values in SQL queries](sqlite3.md#sqlite3-placeholders).

        Raises:
        :   [**ProgrammingError**](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") – If *sql* contains more than one SQL statement.

        If [`autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") is
        [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL"),
        [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") is not `None`,
        *sql* is an `INSERT`, `UPDATE`, `DELETE`, or `REPLACE` statement,
        and there is no open transaction,
        a transaction is implicitly opened before executing *sql*.

        Deprecated since version 3.12, will be removed in version 3.14: [`DeprecationWarning`](exceptions.md#DeprecationWarning "DeprecationWarning") is emitted if
        [named placeholders](sqlite3.md#sqlite3-placeholders) are used
        and *parameters* is a sequence instead of a [`dict`](stdtypes.md#dict "dict").
    ...
    :   For every item in *parameters*,
        ...
        Uses the same implicit transaction handling as [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute").

        Parameters:
        :   - **sql** ([*str*](stdtypes.md#str "str")) – A single SQL DML statement.
            - **parameters** ([iterable](https://docs.python.org/3.12/glossary.html#term-iterable)) – An iterable of parameters to bind with
        ...
        instead of [`dict`](stdtypes.md#dict "dict")s.
        Starting with Python 3.14, [`ProgrammingError`](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") will
        be raised instead.
    ...
    :   Execute the SQL statements in *sql_script*.
        ...
        *sql_script* must be a [`string`](stdtypes.md#str "str").
    ...
    :   Return the next set of rows of a query result as a [`list`](stdtypes.md#list "list").
        ...
        If *size* is not given, [`arraysize`](sqlite3.md#sqlite3.Cursor.arraysize "sqlite3.Cursor.arraysize") determines the number of rows
        to be fetched.
    ...
    :   Read-only attribute that provides the SQLite database [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection")
        ...
        [`connection`](sqlite3.md#sqlite3.Cursor.connection "sqlite3.Cursor.connection") attribute that refers to *con*:
    ...
    :   Read-only attribute that provides the row id of the last inserted row. It
        ...
        [`executemany()`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany") or [`executescript()`](sqlite3.md#sqlite3.Cursor.executescript "sqlite3.Cursor.executescript"), or if the insertion failed,
    ...
    :   Read-only attribute that provides the number of modified rows for
        ...
        It is only updated by the [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") and [`executemany()`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany") methods,
    ...
    :   Control how a row fetched from this `Cursor` is represented.
        ...
        or a [callable](https://docs.python.org/3.12/glossary.html#term-callable) that accepts two arguments,
        a [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") object and the `tuple` of row values,
        and returns a custom object representing an SQLite row.

        Defaults to what [`Connection.row_factory`](sqlite3.md#sqlite3.Connection.row_factory "sqlite3.Connection.row_factory") was set to
        when the `Cursor` was created.
        Assigning to this attribute does not affect
        [`Connection.row_factory`](sqlite3.md#sqlite3.Connection.row_factory "sqlite3.Connection.row_factory") of the parent connection.
...
:   A `Row` instance serves as a highly optimized
    ...
    and [mapping](https://docs.python.org/3.12/glossary.html#term-mapping) access by column name and index.
...
:   Added in version 3.11.
    ...
    Call [`len(blob)`](functions.md#len "len") to get the size (number of bytes) of the blob.
    Use indices and [slices](https://docs.python.org/3.12/glossary.html#term-slice) for direct access to the blob data.

    Use the [`Blob`](sqlite3.md#sqlite3.Blob "sqlite3.Blob") as a [context manager](https://docs.python.org/3.12/glossary.html#term-context-manager) to ensure that the blob
    ...
    :   Set the current access position of the blob to *offset*. The *origin*
        ...
        current position) and [`os.SEEK_END`](os.md#os.SEEK_END "os.SEEK_END") (seek relative to the blob’s
        end).
...
:   Exception raised in case a method or database API is not supported by the
    ...
    `NotSupportedError` is a subclass of [`DatabaseError`](sqlite3.md#sqlite3.DatabaseError "sqlite3.DatabaseError").
...
| --- | --- |
| `None` | `NULL` |
| [`int`](functions.md#int "int") | `INTEGER` |
| [`float`](functions.md#float "float") | `REAL` |
| [`str`](stdtypes.md#str "str") | `TEXT` |
| [`bytes`](stdtypes.md#bytes "bytes") | `BLOB` |
...
| --- | --- |
| `NULL` | `None` |
| `INTEGER` | [`int`](functions.md#int "int") |
| `REAL` | [`float`](functions.md#float "float") |
| `TEXT` | depends on [`text_factory`](sqlite3.md#sqlite3.Connection.text_factory "sqlite3.Connection.text_factory"), [`str`](stdtypes.md#str "str") by default |
| `BLOB` | [`bytes`](stdtypes.md#bytes "bytes") |
...
[object adapters](sqlite3.md#sqlite3-adapters),
and you can let the `sqlite3` module convert SQLite types to
Python types via [converters](sqlite3.md#sqlite3-converters).
...
> Instead, use the [Adapter and converter recipes](sqlite3.md#sqlite3-adapter-converter-recipes)
> and tailor them to your needs.

The deprecated default adapters and converters consist of:

- An adapter for [`datetime.date`](datetime.md#datetime.date "datetime.date") objects to [`strings`](stdtypes.md#str "str") in
  [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format.
- An adapter for [`datetime.datetime`](datetime.md#datetime.datetime "datetime.datetime") objects to strings in
  ISO 8601 format.
- A converter for [declared](sqlite3.md#sqlite3-converters) “date” types to
  [`datetime.date`](datetime.md#datetime.date "datetime.date") objects.
- A converter for declared “timestamp” types to
  [`datetime.datetime`](datetime.md#datetime.datetime "datetime.datetime") objects.
  Fractional parts will be truncated to 6 digits (microsecond precision).

> **Note:**
>
> The default “timestamp” converter ignores UTC offsets in the database and
> always returns a naive [`datetime.datetime`](datetime.md#datetime.datetime "datetime.datetime") object. To preserve UTC
> offsets in timestamps, either leave converters disabled, or register an
> offset-aware converter with [`register_converter()`](sqlite3.md#sqlite3.register_converter "sqlite3.register_converter").
...
using the interpreter’s [`-m`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-m) switch,
...
into the query by providing them as a [`tuple`](stdtypes.md#tuple "tuple") of values to the second
argument of the cursor’s [`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") method.

An SQL statement may use one of two kinds of placeholders:
question marks (qmark style) or named placeholders (named style).
For the qmark style, *parameters* must be a
[sequence](https://docs.python.org/3.12/glossary.html#term-sequence) whose length must match the number of placeholders,
or a [`ProgrammingError`](sqlite3.md#sqlite3.ProgrammingError "sqlite3.ProgrammingError") is raised.
For the named style, *parameters* must be
an instance of a [`dict`](stdtypes.md#dict "dict") (or a subclass),
...
[Python types SQLite natively understands](sqlite3.md#sqlite3-types).
...
The object passed to *protocol* will be of type [`PrepareProtocol`](sqlite3.md#sqlite3.PrepareProtocol "sqlite3.PrepareProtocol").
...
This function can then be registered using [`register_adapter()`](sqlite3.md#sqlite3.register_adapter "sqlite3.register_adapter").
...
> **Note:**
>
> Converter functions are **always** passed a [`bytes`](stdtypes.md#bytes "bytes") object,
...
of [`connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect"). There are three options:

- Implicit: set *detect_types* to [`PARSE_DECLTYPES`](sqlite3.md#sqlite3.PARSE_DECLTYPES "sqlite3.PARSE_DECLTYPES")
- Explicit: set *detect_types* to [`PARSE_COLNAMES`](sqlite3.md#sqlite3.PARSE_COLNAMES "sqlite3.PARSE_COLNAMES")
...
Using the [`execute()`](sqlite3.md#sqlite3.Connection.execute "sqlite3.Connection.execute"),
[`executemany()`](sqlite3.md#sqlite3.Connection.executemany "sqlite3.Connection.executemany"), and [`executescript()`](sqlite3.md#sqlite3.Connection.executescript "sqlite3.Connection.executescript")
methods of the [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") class, your code can
be written more concisely because you don’t have to create the (often
superfluous) [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") objects explicitly. Instead, the [`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor")
objects are created implicitly and these shortcut methods return the cursor
objects. This way, you can execute a `SELECT` statement and iterate over it
directly using only a single call on the [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") object.
...
A [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") object can be used as a context manager that
automatically commits or rolls back open transactions when leaving the body of
the context manager.
If the body of the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement finishes without exceptions,
...
or if [`autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") is `True`,
...
> using [`contextlib.closing()`](contextlib.md#contextlib.closing "contextlib.closing").
...
- Do not implicitly create a new database file if it does not already exist;
  will raise [`OperationalError`](sqlite3.md#sqlite3.OperationalError "sqlite3.OperationalError") if unable to create a new file:
...
By default, `sqlite3` represents each row as a [`tuple`](stdtypes.md#tuple "tuple").
If a `tuple` does not suit your needs,
you can use the [`sqlite3.Row`](sqlite3.md#sqlite3.Row "sqlite3.Row") class
or a custom [`row_factory`](sqlite3.md#sqlite3.Cursor.row_factory "sqlite3.Cursor.row_factory").

While `row_factory` exists as an attribute both on the
[`Cursor`](sqlite3.md#sqlite3.Cursor "sqlite3.Cursor") and the [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection"),
it is recommended to set [`Connection.row_factory`](sqlite3.md#sqlite3.Connection.row_factory "sqlite3.Connection.row_factory"),
...
You can create a custom [`row_factory`](sqlite3.md#sqlite3.Cursor.row_factory "sqlite3.Cursor.row_factory")
that returns each row as a [`dict`](stdtypes.md#dict "dict"), with column names mapped to values:
...
The following row factory returns a [named tuple](https://docs.python.org/3.12/glossary.html#term-named-tuple):
...
[`dataclass`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass"), or any other custom class,
instead of a [`namedtuple`](collections.md#collections.namedtuple "collections.namedtuple").

### How to handle non-UTF-8 text encodings

By default, `sqlite3` uses [`str`](stdtypes.md#str "str") to adapt SQLite values
with the `TEXT` data type.
This works well for UTF-8 encoded text, but it might fail for other encodings
and invalid UTF-8.
You can use a custom [`text_factory`](sqlite3.md#sqlite3.Connection.text_factory "sqlite3.Connection.text_factory") to handle such cases.
...
Assuming we now have a [`Connection`](sqlite3.md#sqlite3.Connection "sqlite3.Connection") instance `con`
connected to this database,
we can decode the Latin-2 encoded text using this [`text_factory`](sqlite3.md#sqlite3.Connection.text_factory "sqlite3.Connection.text_factory"):
...
you can use the following technique, borrowed from the [Unicode HOWTO](https://docs.python.org/3.12/howto/unicode.html#unicode-howto):
...
> **See also:**
>
> [Unicode HOWTO](https://docs.python.org/3.12/howto/unicode.html#unicode-howto)
...
[Transaction control via the autocommit attribute](sqlite3.md#sqlite3-transaction-control-autocommit) is recommended,
while [Transaction control via the isolation_level attribute](sqlite3.md#sqlite3-transaction-control-isolation-level)
...
the [`Connection.autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") attribute,
which should preferably be set using the *autocommit* parameter
of [`connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect").
...
- `sqlite3` ensures that a transaction is always open,
  so [`connect()`](sqlite3.md#sqlite3.connect "sqlite3.connect"), [`Connection.commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit"), and [`Connection.rollback()`](sqlite3.md#sqlite3.Connection.rollback "sqlite3.Connection.rollback")
...
- An implicit rollback is performed if the database is
  [`close()`](sqlite3.md#sqlite3.Connection.close "sqlite3.Connection.close")-ed with pending changes.
...
In this mode, [`Connection.commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit") and [`Connection.rollback()`](sqlite3.md#sqlite3.Connection.rollback "sqlite3.Connection.rollback")
have no effect.
Note that SQLite’s autocommit mode is distinct from
the [**PEP 249**](https://peps.python.org/pep-0249/)-compliant [`Connection.autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") attribute;
use [`Connection.in_transaction`](sqlite3.md#sqlite3.Connection.in_transaction "sqlite3.Connection.in_transaction") to query
the low-level SQLite autocommit mode.

Set *autocommit* to [`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL")
to leave transaction control behaviour to the
[`Connection.isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") attribute.
See [Transaction control via the isolation_level attribute](sqlite3.md#sqlite3-transaction-control-isolation-level) for more information.
...
> [`autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") attribute.
> See [Transaction control via the autocommit attribute](sqlite3.md#sqlite3-transaction-control-autocommit).

If [`Connection.autocommit`](sqlite3.md#sqlite3.Connection.autocommit "sqlite3.Connection.autocommit") is set to
[`LEGACY_TRANSACTION_CONTROL`](sqlite3.md#sqlite3.LEGACY_TRANSACTION_CONTROL "sqlite3.LEGACY_TRANSACTION_CONTROL") (the default),
transaction behaviour is controlled using
the [`Connection.isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") attribute.
Otherwise, `isolation_level` has no effect.

If the connection attribute [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level")
is not `None`,
new transactions are implicitly opened before
[`execute()`](sqlite3.md#sqlite3.Cursor.execute "sqlite3.Cursor.execute") and [`executemany()`](sqlite3.md#sqlite3.Cursor.executemany "sqlite3.Cursor.executemany") executes
`INSERT`, `UPDATE`, `DELETE`, or `REPLACE` statements;
for other statements, no implicit transaction handling is performed.
Use the [`commit()`](sqlite3.md#sqlite3.Connection.commit "sqlite3.Connection.commit") and [`rollback()`](sqlite3.md#sqlite3.Connection.rollback "sqlite3.Connection.rollback") methods
...
implicitly executes –
via the [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") attribute.

If [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level") is set to `None`,
...
[`in_transaction`](sqlite3.md#sqlite3.Connection.in_transaction "sqlite3.Connection.in_transaction") attribute.

The [`executescript()`](sqlite3.md#sqlite3.Cursor.executescript "sqlite3.Cursor.executescript") method implicitly commits
any pending transaction before execution of the given SQL script,
regardless of the value of [`isolation_level`](sqlite3.md#sqlite3.Connection.isolation_level "sqlite3.Connection.isolation_level").
