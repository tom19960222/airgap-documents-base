...
source_url: https://docs.python.org/3.12/library/multiprocessing.shared_memory.html
fetched_at: 2026-09-17T15:33:31+00:00
---
# `multiprocessing.shared_memory` — Shared memory for direct access across processes

**Source code:** [Lib/multiprocessing/shared_memory.py](https://github.com/python/cpython/tree/3.12/Lib/multiprocessing/shared_memory.py)

Added in version 3.8.

---

This module provides a class, [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory "multiprocessing.shared_memory.SharedMemory"), for the allocation
...
processes, a [`BaseManager`](multiprocessing.md#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") subclass,
[`SharedMemoryManager`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager "multiprocessing.managers.SharedMemoryManager"), is also provided in the
...
:   Create an instance of the `SharedMemory` class for either
    ...
    needed by other processes, the [`close()`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory.close "multiprocessing.shared_memory.SharedMemory.close") method should be called.
    When a shared memory block is no longer needed by any process, the
    [`unlink()`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory.unlink "multiprocessing.shared_memory.SharedMemory.unlink") method should be called to ensure proper cleanup.

    Parameters:
    :   - **name** ([*str*](stdtypes.md#str "str") *|* *None*) – The unique name for the requested shared memory, specified as a string.
          When creating a new shared memory block, if `None` (the default)
          is supplied for the name, a novel name will be generated.
        - **create** ([*bool*](functions.md#bool "bool")) – Control whether a new shared memory block is created (`True`)
          or an existing shared memory block is attached (`False`).
        - **size** ([*int*](functions.md#int "int")) – The requested number of bytes when creating a new shared memory block.
...
The following example demonstrates a practical use of the [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory "multiprocessing.shared_memory.SharedMemory")
...
:   A subclass of [`multiprocessing.managers.BaseManager`](multiprocessing.md#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") which can be
    ...
    A call to [`start()`](multiprocessing.md#multiprocessing.managers.BaseManager.start "multiprocessing.managers.BaseManager.start") on a
    ...
    [`shutdown()`](multiprocessing.md#multiprocessing.managers.BaseManager.shutdown "multiprocessing.managers.BaseManager.shutdown") on the instance.
    This triggers a [`unlink()`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory.unlink "multiprocessing.shared_memory.SharedMemory.unlink") call
    on all of the [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager.SharedMemory "multiprocessing.managers.SharedMemoryManager.SharedMemory") objects managed by that process and then
    ...
    This class provides methods for creating and returning [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager.SharedMemory "multiprocessing.managers.SharedMemoryManager.SharedMemory")
    instances and for creating a list-like object ([`ShareableList`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager.ShareableList "multiprocessing.managers.SharedMemoryManager.ShareableList"))
    backed by shared memory.

    Refer to [`BaseManager`](multiprocessing.md#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") for a description
...
[`SharedMemoryManager`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager "multiprocessing.managers.SharedMemoryManager"):
...
[`SharedMemoryManager`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager "multiprocessing.managers.SharedMemoryManager") objects via the
[`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement to ensure that all shared memory blocks are released
...
When using a [`SharedMemoryManager`](multiprocessing.shared_memory.md#multiprocessing.managers.SharedMemoryManager "multiprocessing.managers.SharedMemoryManager")
in a [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement, the shared memory blocks created using that
...
:   Provide a mutable list-like object where all values stored within are
    ...
    - [`int`](functions.md#int "int") (signed 64-bit)
    - [`float`](functions.md#float "float")
    - [`bool`](functions.md#bool "bool")
    - [`str`](stdtypes.md#str "str") (less than 10M bytes each when encoded as UTF-8)
    - [`bytes`](stdtypes.md#bytes "bytes") (less than 10M bytes each)
    - `None`

    It also notably differs from the built-in [`list`](stdtypes.md#list "list") type
    ...
    *name* is the unique name for the requested shared memory, as described
    in the definition for [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory "multiprocessing.shared_memory.SharedMemory"). When attaching to an
    existing `ShareableList`, specify its shared memory block’s unique
    name while leaving *sequence* set to `None`.

    > **Note:**
    >
    > A known issue exists for [`bytes`](stdtypes.md#bytes "bytes") and [`str`](stdtypes.md#str "str") values.
...
same [`ShareableList`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.ShareableList "multiprocessing.shared_memory.ShareableList") by supplying the name of the shared memory block
behind it:
...
The following examples demonstrates that [`ShareableList`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.ShareableList "multiprocessing.shared_memory.ShareableList")
(and underlying [`SharedMemory`](multiprocessing.shared_memory.md#multiprocessing.shared_memory.SharedMemory "multiprocessing.shared_memory.SharedMemory")) objects
