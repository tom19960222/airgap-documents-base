...
source_url: https://docs.python.org/3.12/library/bisect.html
fetched_at: 2026-09-17T15:32:27+00:00
---
...
The module is called [`bisect`](bisect.md#module-bisect "bisect: Array bisection algorithms for binary searching.") because it uses a basic bisection
algorithm to do its work. Unlike other bisection tools that search for a
specific value, the functions in this module are designed to locate an
insertion point. Accordingly, the functions never call an [`__eq__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__eq__ "object.__eq__")
method to determine whether a value has been found. Instead, the
functions only call the [`__lt__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__lt__ "object.__lt__") method and will return an insertion
...
:   Locate the insertion point for *x* in *a* to maintain sorted order.
    ...
    *key* specifies a [key function](https://docs.python.org/3.12/glossary.html#term-key-function) of one argument that is used to
...
:   Insert *x* in *a* in sorted order.
    ...
    Next, it runs the `insert()` method on *a* to insert *x* at the
...
:   Similar to [`insort_left()`](bisect.md#bisect.insort_left "bisect.insort_left"), but inserting *x* in *a* after any existing
    ...
    This function first runs [`bisect_right()`](bisect.md#bisect.bisect_right "bisect.bisect_right") to locate an insertion point.
    Next, it runs the `insert()` method on *a* to insert *x* at the
    appropriate position to maintain sort order.
...
- The search functions are stateless and discard key function results after
  ...
  [`functools.cache()`](functools.md#functools.cache "functools.cache") to avoid duplicate computations. Alternatively,
...
The above [bisect functions](bisect.md#bisect-functions) are useful for finding insertion points but
...
The [`bisect()`](bisect.md#bisect.bisect "bisect.bisect") function can be useful for numeric table lookups. This
example uses [`bisect()`](bisect.md#bisect.bisect "bisect.bisect") to look up a letter grade for an exam score (say)
...
The [`bisect()`](bisect.md#bisect.bisect "bisect.bisect") and [`insort()`](bisect.md#bisect.insort "bisect.insort") functions also work with
