...
source_url: https://docs.python.org/3.12/library/email.policy.html
...
[abstract base class](https://docs.python.org/3.12/glossary.html#term-abstract-base-class) that defines the features that are common to all
...
Originally added in 3.3 as a [provisional feature](https://docs.python.org/3.12/glossary.html#term-provisional-package).
