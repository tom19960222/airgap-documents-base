...
source_url: https://docs.python.org/3.12/library/mailcap.html
fetched_at: 2026-09-17T15:35:39+00:00
---
# `mailcap` — Mailcap file handling

**Source code:** [Lib/mailcap.py](https://github.com/python/cpython/tree/3.12/Lib/mailcap.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`mailcap`](mailcap.md#module-mailcap "mailcap: Mailcap file handling. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#mailcap) for details).
The [`mimetypes`](mimetypes.md#module-mimetypes "mimetypes: Mapping of filename extensions to MIME types.") module provides an alternative.
...
The mailcap format is documented in [**RFC 1524**](https://datatracker.ietf.org/doc/html/rfc1524.html), “A User Agent Configuration
...
:   Return a 2-tuple; the first element is a string containing the command line to
    ...
    *key* is the name of the field desired, which represents the type of activity to
    ...
    MIME type or alter the existing body data. See [**RFC 1524**](https://datatracker.ietf.org/doc/html/rfc1524.html) for a complete list
    of these fields.
    ...
    *plist* can be a list containing named parameters; the default value is simply
    ...
    use) to determine whether or not the mailcap line applies. [`findmatch()`](mailcap.md#mailcap.findmatch "mailcap.findmatch")
    will automatically check such conditions and skip the entry if the check fails.

    Changed in version 3.11: To prevent security issues with shell metacharacters (symbols that have
