...
source_url: https://docs.python.org/3.12/library/sunau.html
fetched_at: 2026-09-17T15:35:45+00:00
---
# `sunau` — Read and write Sun AU files

**Source code:** [Lib/sunau.py](https://github.com/python/cpython/tree/3.12/Lib/sunau.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`sunau`](sunau.md#module-sunau "sunau: Provide an interface to the Sun AU sound format. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#sunau) for details).
