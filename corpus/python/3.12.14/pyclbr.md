...
source_url: https://docs.python.org/3.12/library/pyclbr.html
fetched_at: 2026-09-17T15:35:22+00:00
---
# `pyclbr` — Python module browser support

**Source code:** [Lib/pyclbr.py](https://github.com/python/cpython/tree/3.12/Lib/pyclbr.py)

---

The [`pyclbr`](pyclbr.md#module-pyclbr "pyclbr: Supports information extraction for a Python module browser.") module provides limited information about the
