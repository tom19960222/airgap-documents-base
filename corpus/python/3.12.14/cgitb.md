...
collection: python
version: "3.12.14"
title: "cgitb — Traceback manager for CGI scripts"
source_url: https://docs.python.org/3.12/library/cgitb.html
fetched_at: 2026-09-17T15:35:37+00:00
---
# `cgitb` — Traceback manager for CGI scripts

**Source code:** [Lib/cgitb.py](https://github.com/python/cpython/tree/3.12/Lib/cgitb.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#cgitb) for details).

---

The [`cgitb`](cgitb.md#module-cgitb "cgitb: Configurable traceback handler for CGI scripts. (deprecated)") module provides a special exception handler for Python scripts.
...
The options to the [`enable()`](cgitb.md#cgitb.enable "cgitb.enable") function control whether the report is
...
:   This function handles an exception using the default settings (that is, show a
    ...
    *info* argument should be a 3-tuple containing an exception type, exception
    ...
    [`sys.exc_info()`](sys.md#sys.exc_info "sys.exc_info"). If the *info* argument is not supplied, the current
    exception is obtained from [`sys.exc_info()`](sys.md#sys.exc_info "sys.exc_info").
