...
source_url: https://docs.python.org/3.12/library/csv.html
...
:   Return a [reader object](csv.md#reader-objects) that will process
    ...
    it should be opened with `newline=''`. [[1]](csv.md#id4) An optional
...
:   Return a writer object responsible for converting the user’s data into delimited
    ...
    `newline=''` [[1]](csv.md#id4). An optional *dialect*
...
:   Create an object that operates like a regular reader but maps the
    ...
    The *fieldnames* parameter is a [sequence](https://docs.python.org/3.12/glossary.html#term-sequence). If *fieldnames* is
    ...
    *fieldnames* is provided, they will be used and the first row will be
    ...
    If the argument passed to *fieldnames* is an iterator, it will be coerced to a [`list`](stdtypes.md#list "list").
...
:   Create an object which operates like a regular writer but maps dictionaries
    ...
    *f*. The optional *restval* parameter specifies the value to be
    ...
    dictionary passed to the [`writerow()`](csv.md#csv.csvwriter.writerow "csv.csvwriter.writerow") method contains a key not found in
...
:   Instructs [`writer`](csv.md#csv.writer "csv.writer") objects to quote all fields which are not
    ...
    Instructs [`reader`](csv.md#csv.reader "csv.reader") objects to interpret an empty (unquoted) field
    as `None` and to otherwise behave as [`QUOTE_ALL`](csv.md#csv.QUOTE_ALL "csv.QUOTE_ALL").
...
:   Instructs [`writer`](csv.md#csv.writer "csv.writer") objects to always place quotes around fields
    ...
    Instructs [`reader`](csv.md#csv.reader "csv.reader") objects to interpret an empty (unquoted) string as `None` and
    to otherwise behave as [`QUOTE_NONNUMERIC`](csv.md#csv.QUOTE_NONNUMERIC "csv.QUOTE_NONNUMERIC").

    Added in version 3.12.

> **Note:**
>
> Due to a bug, constants [`QUOTE_NOTNULL`](csv.md#csv.QUOTE_NOTNULL "csv.QUOTE_NOTNULL") and [`QUOTE_STRINGS`](csv.md#csv.QUOTE_STRINGS "csv.QUOTE_STRINGS")
> do not affect behaviour of [`reader`](csv.md#csv.reader "csv.reader") objects.
...
subclass of the [`Dialect`](csv.md#csv.Dialect "csv.Dialect") class containing various attributes
describing the format of the CSV file. When creating [`reader`](csv.md#csv.reader "csv.reader") or
...
[`writer`](csv.md#csv.writer "csv.writer") objects ([`DictWriter`](csv.md#csv.DictWriter "csv.DictWriter") instances and objects returned by
the [`writer()`](csv.md#csv.writer "csv.writer") function) have the following public methods. A *row* must be
an iterable of strings or numbers for [`writer`](csv.md#csv.writer "csv.writer") objects and a dictionary
...
encoding (see [`locale.getencoding()`](locale.md#locale.getencoding "locale.getencoding")). To decode a file
...
[1]
([1](csv.md#id1),[2](csv.md#id2))

If `newline=''` is not specified, newlines embedded inside quoted fields
will not be interpreted correctly, and on platforms that use `\r\n` linendings
on write an extra `\r` will be added. It should always be safe to specify
`newline=''`, since the csv module does its own
([universal](https://docs.python.org/3.12/glossary.html#term-universal-newlines)) newline handling.
