...
source_url: https://docs.python.org/3.12/library/xml.etree.elementtree.html
fetched_at: 2026-09-17T15:33:52+00:00
---
# `xml.etree.ElementTree` — The ElementTree XML API

**Source code:** [Lib/xml/etree/ElementTree.py](https://github.com/python/cpython/tree/3.12/Lib/xml/etree/ElementTree.py)
...
:   Parses an XML section into an element tree incrementally, and reports what’s
    ...
    *parser* is an optional parser instance. If not given, the standard
    ...
    target. Returns an [iterator](https://docs.python.org/3.12/glossary.html#term-iterator) providing `(event, elem)` pairs;
...
This module provides limited support for
[XInclude directives](https://www.w3.org/TR/xinclude/), via the [`xml.etree.ElementInclude`](xml.etree.elementtree.md#module-xml.etree.ElementInclude "xml.etree.ElementInclude") helper module. This module can be used to insert subtrees and text strings into element trees, based on information in the tree.
...
:   Default loader. This default loader reads an included resource from disk.
    ...
    *encoding* is an optional text encoding. If not given, encoding is `utf-8`.
    ...
    If the parse mode is `"xml"`, this is an [`Element`](xml.etree.elementtree.md#xml.etree.ElementTree.Element "xml.etree.ElementTree.Element") instance.
...
:   This function expands XInclude directives in-place in tree pointed by *elem*.
    ...
    *loader* is an optional resource loader. If omitted, it defaults to [`default_loader()`](xml.etree.elementtree.md#xml.etree.ElementInclude.default_loader "xml.etree.ElementInclude.default_loader").
...
:   Element class. This class defines the Element interface, and provides a
    ...
    for working with subelements: [`__delitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__delitem__ "object.__delitem__"),
    [`__getitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getitem__ "object.__getitem__"), [`__setitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__setitem__ "object.__setitem__"),
    [`__len__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__len__ "object.__len__").
    ...
    Changed in version 3.12: Testing the truth value of an Element emits [`DeprecationWarning`](exceptions.md#DeprecationWarning "DeprecationWarning").
    ...
    *element* is the root element. The tree is initialized with the contents
    ...
    :   Writes the element tree to a file, as XML. *file* is a file name, or a
        ...
        *method* is either `"xml"`, `"html"` or `"text"` (default is
        ...
        [file object](https://docs.python.org/3.12/glossary.html#term-file-object); make sure you do not try to write a string to a
...
[1]
([1](xml.etree.elementtree.md#id1),[2](xml.etree.elementtree.md#id2),[3](xml.etree.elementtree.md#id6),[4](xml.etree.elementtree.md#id8))
