...
source_url: https://docs.python.org/3.12/library/msvcrt.html
...
implementations of their services. For example, the [`getpass`](getpass.md#module-getpass "getpass: Portable reading of passwords and retrieval of the userid.") module uses
this in the implementation of the [`getpass()`](getpass.md#module-getpass "getpass: Portable reading of passwords and retrieval of the userid.") function.
...
:   Create a C runtime file descriptor from the file handle *handle*. The *flags*
    ...
    to [`os.fdopen()`](os.md#os.fdopen "os.fdopen") to create a file object.
