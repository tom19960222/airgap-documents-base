...
source_url: https://docs.python.org/3.12/library/shutil.html
fetched_at: 2026-09-17T15:32:51+00:00
---
...
:   Copy the permission bits, last access time, last modification time, and
    ...
    group are unaffected. *src* and *dst* are [path-like objects](https://docs.python.org/3.12/glossary.html#term-path-like-object) or path
...
:   Delete an entire directory tree; *path* must point to a directory (but not a
    ...
    *excinfo*, is the exception that was raised. Exceptions raised by *onexc*
    ...
    parameter it receives is the tuple returned from [`sys.exc_info()`](sys.md#sys.exc_info "sys.exc_info").
...
:   Recursively move a file or directory (*src*) to another location and return
    ...
    depending on [`os.rename()`](os.md#os.rename "os.rename") semantics.
    ...
    *src* and the destination, and will be used to copy *src* to the destination
    if [`os.rename()`](os.md#os.rename "os.rename") cannot be used. If the source is a directory,
...
:   Return the path to an executable which would be run if the given *cmd* was
    ...
    *path* is a “`PATH` string” specifying the directories to look in,
    delimited by [`os.pathsep`](os.md#os.pathsep "os.pathsep"). When no *path* is specified, the
    `PATH` environment variable is read from [`os.environ`](os.md#os.environ "os.environ"),
    falling back to [`os.defpath`](os.md#os.defpath "os.defpath") if it is not set.
    ...
    if you call `shutil.which("python")`, [`which()`](shutil.md#shutil.which "shutil.which") will search `PATHEXT`
...
:   Create an archive file (such as zip or tar) and return its name.
    ...
    *logger* must be an object compatible with [**PEP 282**](https://peps.python.org/pep-0282/), usually an instance of
    ...
    > with [`register_archive_format()`](shutil.md#shutil.register_archive_format "shutil.register_archive_format") do not support the *root_dir*
...
:   Register an archiver for the format *name*.
    ...
    *dry_run* and *logger* (as passed in [`make_archive()`](shutil.md#shutil.make_archive "shutil.make_archive")).
    ...
    In this case [`make_archive()`](shutil.md#shutil.make_archive "shutil.make_archive") is not thread-safe.
...
:   Unpack an archive. *filename* is the full path of the archive.
    ...
    *format* is the archive format: one of “zip”, “tar”, “gztar”, “bztar”, or
    ...
    Changed in version 3.7: Accepts a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object) for *filename* and *extract_dir*.
...
:   Get the size of the terminal window.
    ...
    Changed in version 3.11: The `fallback` values are also used if [`os.get_terminal_size()`](os.md#os.get_terminal_size "os.get_terminal_size")
    returns zeroes.
