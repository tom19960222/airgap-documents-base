...
source_url: https://docs.python.org/3.12/library/logging.handlers.html
fetched_at: 2026-09-17T15:33:20+00:00
---
# `logging.handlers` — Logging handlers

**Source code:** [Lib/logging/handlers.py](https://github.com/python/cpython/tree/3.12/Lib/logging/handlers.py)
...
See [Configuring Logging for a Library](https://docs.python.org/3.12/howto/logging.html#library-config) for more information on how to use
...
For an example, see [Using a rotator and namer to customize log rotation processing](https://docs.python.org/3.12/howto/logging-cookbook.html#cookbook-rotator-namer).
