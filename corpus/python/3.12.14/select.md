...
source_url: https://docs.python.org/3.12/library/select.html
fetched_at: 2026-09-17T15:33:41+00:00
---
...
:   (Only supported on Linux 2.5.44 and newer.) Return an edge polling object,
    ...
    *flags* is deprecated and completely ignored. However, when supplied, its
    ...
    [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement, the new file descriptor is automatically closed
    ...
    Changed in version 3.4: Support for the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement was added.
...
:   This is a straightforward interface to the Unix `select()` system call.
    ...
    objects](https://docs.python.org/3.12/glossary.html#term-file-object) (e.g. `sys.stdin`, or objects returned by
