...
source_url: https://docs.python.org/3.12/library/pydoc.html
fetched_at: 2026-09-17T15:34:35+00:00
---
# `pydoc` — Documentation generator and online help system

**Source code:** [Lib/pydoc.py](https://github.com/python/cpython/tree/3.12/Lib/pydoc.py)
...
derived from the docstring (i.e. the [`__doc__`](stdtypes.md#definition.__doc__ "definition.__doc__") attribute) of the object,
...
Changed in version 3.4: `pydoc` now uses [`inspect.signature()`](inspect.md#inspect.signature "inspect.signature") rather than
