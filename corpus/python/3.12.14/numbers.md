...
source_url: https://docs.python.org/3.12/library/numbers.html
fetched_at: 2026-09-17T15:32:33+00:00
---
...
means that [`__add__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__add__ "object.__add__") and [`__radd__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__radd__ "object.__radd__") should be
defined as:
...
1. If `A` defines an [`__add__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__add__ "object.__add__") which accepts `b`, all is
   well.
2. If `A` falls back to the boilerplate code, and it were to
   return a value from [`__add__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__add__ "object.__add__"), we’d miss the possibility
   that `B` defines a more intelligent [`__radd__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__radd__ "object.__radd__"), so the
   ...
   all.)
3. Then `B`’s [`__radd__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__radd__ "object.__radd__") gets a chance. If it accepts
   `a`, all is well.
...
in [`complex`](functions.md#complex "complex"), and both [`__radd__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__radd__ "object.__radd__") s land there, so `a+b
== b+a`.
