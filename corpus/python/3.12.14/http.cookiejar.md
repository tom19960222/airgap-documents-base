...
source_url: https://docs.python.org/3.12/library/http.cookiejar.html
fetched_at: 2026-09-17T15:34:12+00:00
---
# `http.cookiejar` — Cookie handling for HTTP clients

**Source code:** [Lib/http/cookiejar.py](https://github.com/python/cpython/tree/3.12/Lib/http/cookiejar.py)
...
:   Instances of [`FileCookieJar`](http.cookiejar.md#http.cookiejar.FileCookieJar "http.cookiejar.FileCookieJar") raise this exception on failure to load
    ...
    Changed in version 3.3: [`LoadError`](http.cookiejar.md#http.cookiejar.LoadError "http.cookiejar.LoadError") used to be a subtype of [`IOError`](exceptions.md#IOError "IOError"), which is now an
...
[`CookieJar`](http.cookiejar.md#http.cookiejar.CookieJar "http.cookiejar.CookieJar") objects support the [iterator](https://docs.python.org/3.12/glossary.html#term-iterator) protocol for iterating over
