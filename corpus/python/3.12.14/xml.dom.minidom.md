...
source_url: https://docs.python.org/3.12/library/xml.dom.minidom.html
fetched_at: 2026-09-17T15:33:53+00:00
---
# `xml.dom.minidom` — Minimal DOM implementation

**Source code:** [Lib/xml/dom/minidom.py](https://github.com/python/cpython/tree/3.12/Lib/xml/dom/minidom.py)

---

[`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") is a minimal implementation of the Document Object
Model interface, with an API similar to that in other languages. It is intended
to be simpler than the full DOM and also significantly smaller. Users who are
not already proficient with the DOM should consider using the
[`xml.etree.ElementTree`](xml.etree.elementtree.md#module-xml.etree.ElementTree "xml.etree.ElementTree: Implementation of the ElementTree API.") module for their XML processing instead.

> **Warning:**
>
> The [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") module is not secure against
> maliciously constructed data. If you need to parse untrusted or
> unauthenticated data see [XML vulnerabilities](xml.md#xml-vulnerabilities).

DOM applications typically start by parsing some XML into a DOM. With
[`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation."), this is done through the parse functions:
...
What the [`parse()`](xml.dom.minidom.md#xml.dom.minidom.parse "xml.dom.minidom.parse") and [`parseString()`](xml.dom.minidom.md#xml.dom.minidom.parseString "xml.dom.minidom.parseString") functions do is connect an XML
...
`getDOMImplementation()` function in the [`xml.dom`](xml.dom.md#module-xml.dom "xml.dom: Document Object Model API for Python.") package or the
[`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") module. Once you have a `Document`, you
...
objects. `unlink()` is an [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.")-specific
...
The definition of the DOM API for Python is given as part of the [`xml.dom`](xml.dom.md#module-xml.dom "xml.dom: Document Object Model API for Python.")
...
:   Break internal references within the DOM so that it will be garbage collected on
    ...
    You can avoid calling this method explicitly by using the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with)
...
:   Write XML to the writer object. The writer receives texts but not bytes as input,
    ...
    Changed in version 3.8: The [`writexml()`](xml.dom.minidom.md#xml.dom.minidom.Node.writexml "xml.dom.minidom.Node.writexml") method now preserves the attribute order specified
    by the user.
...
:   Return a string or byte string containing the XML represented by
    ...
    With an explicit *encoding* [[1]](xml.dom.minidom.md#id3) argument, the result is a byte
    ...
    The *standalone* argument behaves exactly as in [`writexml()`](xml.dom.minidom.md#xml.dom.minidom.Node.writexml "xml.dom.minidom.Node.writexml").

    Changed in version 3.8: The [`toxml()`](xml.dom.minidom.md#xml.dom.minidom.Node.toxml "xml.dom.minidom.Node.toxml") method now preserves the attribute order specified
    by the user.
...
:   Return a pretty-printed version of the document. *indent* specifies the
    ...
    [`toxml()`](xml.dom.minidom.md#xml.dom.minidom.Node.toxml "xml.dom.minidom.Node.toxml").

    The *standalone* argument behaves exactly as in [`writexml()`](xml.dom.minidom.md#xml.dom.minidom.Node.writexml "xml.dom.minidom.Node.writexml").

    Changed in version 3.8: The [`toprettyxml()`](xml.dom.minidom.md#xml.dom.minidom.Node.toprettyxml "xml.dom.minidom.Node.toprettyxml") method now preserves the attribute order specified
    by the user.
...
The [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") module is essentially a DOM 1.0-compatible DOM with
...
- Operations are used as methods. Since the DOM uses only [`in`](https://docs.python.org/3.12/reference/expressions.html#in)
...
- The type `DOMString` maps to Python strings. [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") supports
...
- `DOMException` is currently not supported in [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.").
  Instead, [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation.") uses standard Python exceptions such as
  [`TypeError`](exceptions.md#TypeError "TypeError") and [`AttributeError`](exceptions.md#AttributeError "AttributeError").
...
The following interfaces have no implementation in [`xml.dom.minidom`](xml.dom.minidom.md#module-xml.dom.minidom "xml.dom.minidom: Minimal Document Object Model (DOM) implementation."):
