...
version: "3.12.14"
title: "Extending"
source_url: https://docs.python.org/3.12/library/asyncio-extending.html
fetched_at: 2026-09-17T15:35:58+00:00
---
# Extending

The main direction for [`asyncio`](asyncio.md#module-asyncio "asyncio: Asynchronous I/O.") extending is writing custom *event loop*
...
[`asyncio.AbstractEventLoop`](asyncio-eventloop.md#asyncio.AbstractEventLoop "asyncio.AbstractEventLoop") declares very many methods. Implementing all them
...
[`asyncio.Future`](asyncio-future.md#asyncio.Future "asyncio.Future") and [`asyncio.Task`](asyncio-task.md#asyncio.Task "asyncio.Task") should be never created directly,
please use corresponding [`loop.create_future()`](asyncio-eventloop.md#asyncio.loop.create_future "asyncio.loop.create_future") and [`loop.create_task()`](asyncio-eventloop.md#asyncio.loop.create_task "asyncio.loop.create_task"),
or [`asyncio.create_task()`](asyncio-task.md#asyncio.create_task "asyncio.create_task") factories instead.
...
:   Create a built-in task instance.
    ...
    *loop* is an optional event loop instance. The rest of arguments are described in
    [`loop.create_task()`](asyncio-eventloop.md#asyncio.loop.create_task "asyncio.loop.create_task") description.
