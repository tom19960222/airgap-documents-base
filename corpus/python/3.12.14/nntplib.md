...
source_url: https://docs.python.org/3.12/library/nntplib.html
fetched_at: 2026-09-17T15:35:41+00:00
---
# `nntplib` — NNTP protocol client

**Source code:** [Lib/nntplib.py](https://github.com/python/cpython/tree/3.12/Lib/nntplib.py)

Deprecated since version 3.11: The [`nntplib`](nntplib.md#module-nntplib "nntplib: NNTP protocol client (requires sockets). (deprecated)") module is deprecated (see [**PEP 594**](https://peps.python.org/pep-0594/) for details).
...
:   Return a new [`NNTP`](nntplib.md#nntplib.NNTP "nntplib.NNTP") object, representing a connection
    ...
    The [`NNTP`](nntplib.md#nntplib.NNTP "nntplib.NNTP") class supports the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement to
...
When the *file* argument is supplied, it must be either a [file object](https://docs.python.org/3.12/glossary.html#term-file-object)
...
:   Send an `XHDR` command. The *hdr* argument is a header keyword, e.g.
    ...
    If *file* is a [file object](https://docs.python.org/3.12/glossary.html#term-file-object), then it will start calling `write()` on
