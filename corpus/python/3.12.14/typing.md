...
source_url: https://docs.python.org/3.12/library/typing.html
fetched_at: 2026-09-17T15:34:34+00:00
---
...
> They can be used by third party tools such as [type checkers](https://docs.python.org/3.12/glossary.html#term-static-type-checker),
> IDEs, linters, etc.
...
be an instance of [`float`](functions.md#float "float"), as indicated by the [type hint](https://docs.python.org/3.12/glossary.html#term-type-hint)
`edge_length: float`. The function is expected to return an instance
of [`str`](stdtypes.md#str "str"), as indicated by the `-> str` hint.

While type hints can be simple classes like [`float`](functions.md#float "float") or [`str`](stdtypes.md#str "str"),
they can also be more complex. The [`typing`](typing.md#module-typing "typing: Support for type hints (see :pep:`484`).") module provides a vocabulary of
...
A type alias is defined using the [`type`](https://docs.python.org/3.12/reference/simple_stmts.html#type) statement, which creates
an instance of [`TypeAliasType`](typing.md#typing.TypeAliasType "typing.TypeAliasType"). In this example,
...
The [`type`](https://docs.python.org/3.12/reference/simple_stmts.html#type) statement is new in Python 3.12. For backwards
...
Or marked with [`TypeAlias`](typing.md#typing.TypeAlias "typing.TypeAlias") to make it explicit that this is a type alias,
...
Use the [`NewType`](typing.md#typing.NewType "typing.NewType") helper to create distinct types:
...
However, it is possible to create a [`NewType`](typing.md#typing.NewType "typing.NewType") based on a ‘derived’ `NewType`:
...
Functions – or other [callable](https://docs.python.org/3.12/glossary.html#term-callable) objects – can be annotated using
[`collections.abc.Callable`](collections.abc.md#collections.abc.Callable "collections.abc.Callable") or deprecated [`typing.Callable`](typing.md#typing.Callable "typing.Callable").
`Callable[[int], str]` signifies a function that takes a single parameter
of type [`int`](functions.md#int "int") and returns a [`str`](stdtypes.md#str "str").
...
a [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec"), [`Concatenate`](typing.md#typing.Concatenate "typing.Concatenate"), or an ellipsis. The return type must
be a single type.
...
variadic number of arguments, [overloaded functions](typing.md#overload), or
functions that have keyword-only parameters. However, these signatures can be
expressed by defining a [`Protocol`](typing.md#typing.Protocol "typing.Protocol") class with a
[`__call__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__call__ "object.__call__") method:
...
parameter types are dependent on each other using [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec").
Additionally, if that callable adds or removes arguments from other
callables, the [`Concatenate`](typing.md#typing.Concatenate "typing.Concatenate") operator may be used. They
...
> **See also:**
>
> The documentation for [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") and [`Concatenate`](typing.md#typing.Concatenate "typing.Concatenate") provides
...
[type parameter syntax](https://docs.python.org/3.12/reference/compound_stmts.html#type-params):
...
Or by using the [`TypeVar`](typing.md#typing.TypeVar "typing.TypeVar") factory directly:
...
[`list`](stdtypes.md#list "list") only accepts one type argument, so a type checker would emit an
error on the `y` assignment above. Similarly,
[`Mapping`](collections.abc.md#collections.abc.Mapping "collections.abc.Mapping") only accepts two type arguments: the first
...
reason, tuples are special-cased in Python’s typing system. [`tuple`](stdtypes.md#tuple "tuple")
...
[`typing.Type[C]`](typing.md#typing.Type "typing.Type")) may accept values that are classes
...
The only legal parameters for [`type`](functions.md#type "type") are classes, [`Any`](typing.md#typing.Any "typing.Any"),
[type variables](typing.md#generics), and unions of any of these types.
For example:
...
`type[Any]` is equivalent to [`type`](functions.md#type "type"), which is the root of Python’s
[metaclass hierarchy](https://docs.python.org/3.12/reference/datamodel.html#metaclasses).

## Annotating generators and coroutines

A generator can be annotated using the generic type
[`Generator[YieldType, SendType, ReturnType]`](collections.abc.md#collections.abc.Generator "collections.abc.Generator").
For example:
...
the `SendType` of [`Generator`](collections.abc.md#collections.abc.Generator "collections.abc.Generator") behaves
...
([`AsyncGenerator[YieldType, SendType]`](collections.abc.md#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator")):
...
[`AsyncIterable[YieldType]`](collections.abc.md#collections.abc.AsyncIterable "collections.abc.AsyncIterable")
and [`AsyncIterator[YieldType]`](collections.abc.md#collections.abc.AsyncIterator "collections.abc.AsyncIterator") are
available as well:
...
[`Coroutine[YieldType, SendType, ReturnType]`](collections.abc.md#collections.abc.Coroutine "collections.abc.Coroutine").
Generic arguments correspond to those of [`Generator`](collections.abc.md#collections.abc.Generator "collections.abc.Generator"),
for example:
...
single [type variable](typing.md#typevar) `T` . This also makes `T` valid as
a type within the class body.

Generic classes implicitly inherit from [`Generic`](typing.md#typing.Generic "typing.Generic"). For compatibility
with Python 3.11 and lower, it is also possible to inherit explicitly from
[`Generic`](typing.md#typing.Generic "typing.Generic") to indicate a generic class:
...
Generic classes have [`__class_getitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__class_getitem__ "object.__class_getitem__") methods, meaning they
...
[`TypeVar`](typing.md#typing.TypeVar "typing.TypeVar") are permissible as parameters for a generic type:
...
Each type variable argument to [`Generic`](typing.md#typing.Generic "typing.Generic") must be distinct.
...
[`Any`](typing.md#typing.Any "typing.Any") for each position. In the following example, `MyIterable` is
...
Changed in version 3.7: [`Generic`](typing.md#typing.Generic "typing.Generic") no longer has a custom metaclass.

Changed in version 3.12: Syntactic support for generics and type aliases is new in version 3.12.
Previously, generic classes had to explicitly inherit from [`Generic`](typing.md#typing.Generic "typing.Generic")
...
to this is that a list of types can be used to substitute a [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec"):
...
Classes generic over a [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") can also be created using explicit
inheritance from [`Generic`](typing.md#typing.Generic "typing.Generic"). In this case, `**` is not used:
...
Another difference between [`TypeVar`](typing.md#typing.TypeVar "typing.TypeVar") and [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") is that a
...
Note that generics with [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") may not have correct
`__parameters__` after substitution in some cases because they
are intended primarily for static type checking.

Changed in version 3.10: [`Generic`](typing.md#typing.Generic "typing.Generic") can now be parameterized over parameter expressions.
See [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") and [**PEP 612**](https://peps.python.org/pep-0612/) for more details.

A user-defined generic class can have ABCs as base classes without a metaclass
conflict. Generic metaclasses are not supported. The outcome of parameterizing
generics is cached, and most types in the typing module are [hashable](https://docs.python.org/3.12/glossary.html#term-hashable) and
comparable for equality.

## The `Any` type

A special kind of type is [`Any`](typing.md#typing.Any "typing.Any"). A static type checker will treat
every type as being compatible with [`Any`](typing.md#typing.Any "typing.Any") and [`Any`](typing.md#typing.Any "typing.Any") as being
compatible with every type.

This means that it is possible to perform any operation or method call on a
value of type [`Any`](typing.md#typing.Any "typing.Any") and assign it to any variable:
...
[`Any`](typing.md#typing.Any "typing.Any") to a more precise type. For example, the static type checker did
not report an error when assigning `a` to `s` even though `s` was
declared to be of type [`str`](stdtypes.md#str "str") and receives an [`int`](functions.md#int "int") value at
runtime!

Furthermore, all functions without a return type or parameter types will
implicitly default to using [`Any`](typing.md#typing.Any "typing.Any"):
...
This behavior allows [`Any`](typing.md#typing.Any "typing.Any") to be used as an *escape hatch* when you
need to mix dynamically and statically typed code.

Contrast the behavior of [`Any`](typing.md#typing.Any "typing.Any") with the behavior of [`object`](functions.md#object "object").
Similar to [`Any`](typing.md#typing.Any "typing.Any"), every type is a subtype of [`object`](functions.md#object "object"). However,
unlike [`Any`](typing.md#typing.Any "typing.Any"), the reverse is not true: [`object`](functions.md#object "object") is *not* a
subtype of every other type.

That means when the type of a value is [`object`](functions.md#object "object"), a type checker will
...
Use [`object`](functions.md#object "object") to indicate that a value could be any type in a typesafe
manner. Use [`Any`](typing.md#typing.Any "typing.Any") to indicate that a value is dynamically typed.
...
[`Iterable`](collections.abc.md#collections.abc.Iterable "collections.abc.Iterable"). The problem with this approach is that a class had
...
Moreover, by subclassing a special class [`Protocol`](typing.md#typing.Protocol "typing.Protocol"), a user
...
:   Special type indicating an unconstrained type.
    ...
    - [`Any`](typing.md#typing.Any "typing.Any") is compatible with every type.

    Changed in version 3.11: [`Any`](typing.md#typing.Any "typing.Any") can now be used as a base class. This can be useful for
...
:   A [constrained type variable](typing.md#typing-constrained-typevar).
    ...
    `AnyStr` is meant to be used for functions that may accept [`str`](stdtypes.md#str "str") or
    [`bytes`](stdtypes.md#bytes "bytes") arguments but cannot allow the two to mix.
    ...
    [`Any`](typing.md#typing.Any "typing.Any") type, nor does it mean “any string”. In particular, `AnyStr`
...
:   `Never` and `NoReturn` represent the
    ...
    such as [`sys.exit()`](sys.md#sys.exit "sys.exit"):
    ...
    [`assert_never()`](typing.md#typing.assert_never "typing.assert_never"):
    ...
    Added in version 3.6.2: Added [`NoReturn`](typing.md#typing.NoReturn "typing.NoReturn").
...
:   Special type to represent the current enclosed class.
    ...
    - [`classmethod`](functions.md#classmethod "classmethod")s that are used as alternative constructors and return instances
      of the `cls` parameter.
    - Annotating an [`__enter__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__enter__ "object.__enter__") method which returns self.
...
:   Special annotation for explicitly declaring a [type alias](typing.md#type-aliases).
    ...
    Deprecated since version 3.12: [`TypeAlias`](typing.md#typing.TypeAlias "typing.TypeAlias") is deprecated in favor of the [`type`](https://docs.python.org/3.12/reference/simple_stmts.html#type) statement,
    which creates instances of [`TypeAliasType`](typing.md#typing.TypeAliasType "typing.TypeAliasType")
    and which natively supports forward references.
    Note that while [`TypeAlias`](typing.md#typing.TypeAlias "typing.TypeAlias") and [`TypeAliasType`](typing.md#typing.TypeAliasType "typing.TypeAliasType") serve
    similar purposes and have similar names, they are distinct and the
    latter is not the type of the former.
    Removal of [`TypeAlias`](typing.md#typing.TypeAlias "typing.TypeAlias") is not currently planned, but users
    are encouraged to migrate to [`type`](https://docs.python.org/3.12/reference/simple_stmts.html#type) statements.
...
:   Special form for annotating higher-order functions.
    ...
    [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") to annotate a higher-order callable which adds, removes,
    or transforms parameters of another
    callable. Usage is in the form
    `Concatenate[Arg1Type, Arg2Type, ..., ParamSpecVariable]`. `Concatenate`
    is currently only valid when used as the first argument to a [Callable](typing.md#annotating-callables).
    The last parameter to `Concatenate` must be a [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") or
    ellipsis (`...`).

    For example, to annotate a decorator `with_lock` which provides a
    [`threading.Lock`](threading.md#threading.Lock "threading.Lock") to the decorated function, `Concatenate` can be
    ...
    signature. In this case, the [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec") indicates that the returned
...
:   Special type construct to mark class variables.
    ...
    [`ClassVar`](typing.md#typing.ClassVar "typing.ClassVar") accepts only types and cannot be further subscribed.

    [`ClassVar`](typing.md#typing.ClassVar "typing.ClassVar") is not a class itself, and should not
    be used with [`isinstance()`](functions.md#isinstance "isinstance") or [`issubclass()`](functions.md#issubclass "issubclass").
    [`ClassVar`](typing.md#typing.ClassVar "typing.ClassVar") does not change Python runtime behavior, but
...
:   Special typing construct to mark a [`TypedDict`](typing.md#typing.TypedDict "typing.TypedDict") key as potentially
    ...
    See [`TypedDict`](typing.md#typing.TypedDict "typing.TypedDict") and [**PEP 655**](https://peps.python.org/pep-0655/) for more details.
...
:   Special typing form to add context-specific metadata to an annotation.
    ...
    [`@no_type_check`](typing.md#typing.no_type_check "typing.no_type_check") decorator, which can also be used for
    ...
    `Annotated` cannot be used with an unpacked [`TypeVarTuple`](typing.md#typing.TypeVarTuple "typing.TypeVarTuple"):

    ```python3
    type Variadic[*Ts] = Annotated[*Ts, Ann1] = Annotated[T1, T2, T3, ..., Ann1]  # NOT valid
    ```

    where `T1`, `T2`, … are [`TypeVars`](typing.md#typing.TypeVar "typing.TypeVar"). This is invalid as
    only one type should be passed to Annotated.

    By default, [`get_type_hints()`](typing.md#typing.get_type_hints "typing.get_type_hints") strips the metadata from annotations.
    ...
    Note that using [`get_origin()`](typing.md#typing.get_origin "typing.get_origin") will return `Annotated` itself:
...
:   Typing operator to conceptually mark an object as having been unpacked.
    ...
    [type variable tuple](typing.md#typevartuple) is equivalent to using `Unpack`
    ...
    of [`typing.TypeVarTuple`](typing.md#typing.TypeVarTuple "typing.TypeVarTuple") and
    [`builtins.tuple`](stdtypes.md#tuple "tuple") types. You might see `Unpack` being used
    ...
    `Unpack` can also be used along with [`typing.TypedDict`](typing.md#typing.TypedDict "typing.TypedDict") for typing
...
([type parameter lists](https://docs.python.org/3.12/reference/compound_stmts.html#type-params) and the [`type`](https://docs.python.org/3.12/reference/simple_stmts.html#type) statement).
...
:   Abstract base class for generic types.
    ...
    [Language Reference](https://docs.python.org/3.12/reference/compound_stmts.html#generic-classes).
    ...
    [generic function](https://docs.python.org/3.12/reference/compound_stmts.html#generic-functions).
...
:   Type variable.
    ...
    for [generic functions](https://docs.python.org/3.12/reference/compound_stmts.html#generic-functions),
    [generic classes](https://docs.python.org/3.12/reference/compound_stmts.html#generic-classes), and
    [generic type aliases](https://docs.python.org/3.12/reference/compound_stmts.html#generic-type-aliases):
    ...
    See [`Generic`](typing.md#typing.Generic "typing.Generic") for more
    ...
    through the [type parameter syntax](https://docs.python.org/3.12/reference/compound_stmts.html#type-params) or when
...
:   Type variable tuple. A specialized form of [type variable](typing.md#typevar)
    ...
    Type variable tuples can be declared in [type parameter lists](https://docs.python.org/3.12/reference/compound_stmts.html#type-params)
    ...
    *arbitrary* number of types by acting like an *arbitrary* number of type
    ...
    see this written using [`Unpack`](typing.md#typing.Unpack "typing.Unpack") instead, as
    `Unpack[Ts]`.)
...
:   Parameter specification variable. A specialized version of
    ...
    In [type parameter lists](https://docs.python.org/3.12/reference/compound_stmts.html#type-params), parameter specifications
    ...
    Generics. See [`Generic`](typing.md#typing.Generic "typing.Generic") for more information on generic types.
    ...
    use a [`TypeVar`](typing.md#typing.TypeVar "typing.TypeVar") with upper bound `Callable[..., Any]`. However this
    causes two problems:

    1. The type checker can’t type check the `inner` function because
       `*args` and `**kwargs` have to be typed [`Any`](typing.md#typing.Any "typing.Any").
    2. [`cast()`](typing.md#typing.cast "typing.cast") may be required in the body of the `add_logging`
    ...
    [`TypeVar`](typing.md#typing.TypeVar "typing.TypeVar"). However the actual semantics of these keywords are yet to
    be decided.
...
:   Arguments and keyword arguments attributes of a [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec"). The
    ...
    Calling [`get_origin()`](typing.md#typing.get_origin "typing.get_origin") on either of these objects will return the
    original `ParamSpec`:
...
:   Typed version of [`collections.namedtuple()`](collections.md#collections.namedtuple "collections.namedtuple").
    ...
    `_field_defaults` attribute, both of which are part of the [`namedtuple()`](collections.md#collections.namedtuple "collections.namedtuple")
    API.)
...
:   Base class for protocol classes.
    ...
    [`runtime_checkable()`](typing.md#typing.runtime_checkable "typing.runtime_checkable") (described later) act as simple-minded runtime
...
:   Mark a protocol class as a runtime protocol.
    ...
    This raises [`TypeError`](exceptions.md#TypeError "TypeError") when applied to a non-protocol class. This
    allows a simple-minded structural check, very similar to “one trick ponies”
    in [`collections.abc`](collections.abc.md#module-collections.abc "collections.abc: Abstract base classes for containers") such as [`Iterable`](collections.abc.md#collections.abc.Iterable "collections.abc.Iterable"). For example:
    ...
    > For example, [`ssl.SSLObject`](ssl.md#ssl.SSLObject "ssl.SSLObject")
    > is a class, therefore it passes an [`issubclass()`](functions.md#issubclass "issubclass")
    > check against [Callable](typing.md#annotating-callables). However, the
    > `ssl.SSLObject.__init__` method exists only to raise a
    > [`TypeError`](exceptions.md#TypeError "TypeError") with a more informative message, therefore making
    > it impossible to call (instantiate) [`ssl.SSLObject`](ssl.md#ssl.SSLObject "ssl.SSLObject").

    > **Note:**
    >
    > An [`isinstance()`](functions.md#isinstance "isinstance") check against a runtime-checkable protocol can be
    > surprisingly slow compared to an `isinstance()` check against
    > a non-protocol class. Consider using alternative idioms such as
    > [`hasattr()`](functions.md#hasattr "hasattr") calls for structural checks in performance-sensitive
    > code.

    Added in version 3.8.

    Changed in version 3.12: The internal implementation of [`isinstance()`](functions.md#isinstance "isinstance") checks against
    runtime-checkable protocols now uses [`inspect.getattr_static()`](inspect.md#inspect.getattr_static "inspect.getattr_static")
    to look up attributes (previously, [`hasattr()`](functions.md#hasattr "hasattr") was used).
    ...
    have no impact on [`isinstance()`](functions.md#isinstance "isinstance") checks comparing objects to the
...
:   Special construct to add type hints to a dictionary.
    ...
    - Using a literal [`dict`](stdtypes.md#dict "dict") as the second argument:
    ...
    [identifiers](https://docs.python.org/3.12/reference/lexical_analysis.html#identifiers), for example because they are
    keywords or contain hyphens, or when key names must not be
    [mangled](https://docs.python.org/3.12/reference/expressions.html#private-name-mangling) like regular private names:
    ...
    mark individual keys as non-required using [`NotRequired`](typing.md#typing.NotRequired "typing.NotRequired"):
    ...
    required using [`Required`](typing.md#typing.Required "typing.Required"):
    ...
    except for [`Generic`](typing.md#typing.Generic "typing.Generic"). For example:
    ...
    or lower, inherit from [`Generic`](typing.md#typing.Generic "typing.Generic") explicitly:
    ...
    :   `Point2D.__total__` gives the value of the `total` argument.
        ...
        have keys marked with [`NotRequired`](typing.md#typing.NotRequired "typing.NotRequired"), or it may inherit from another
    ...
    :   `Point2D.__required_keys__` and `Point2D.__optional_keys__` return
        ...
        Keys marked with [`Required`](typing.md#typing.Required "typing.Required") will always appear in `__required_keys__`
        and keys marked with [`NotRequired`](typing.md#typing.NotRequired "typing.NotRequired") will always appear in `__optional_keys__`.
    ...
    Changed in version 3.11: Added support for marking individual keys as [`Required`](typing.md#typing.Required "typing.Required") or [`NotRequired`](typing.md#typing.NotRequired "typing.NotRequired").
...
:   Ask a static type checker to confirm that a line of code is unreachable.
    ...
    an [`int`](functions.md#int "int") or a [`str`](stdtypes.md#str "str"), and both options are covered by
    earlier cases.
    ...
    emit an error pointing out that `unreachable` is of type [`float`](functions.md#float "float").
    For a call to `assert_never` to pass type checking, the inferred type of
    the argument passed in must be the bottom type, [`Never`](typing.md#typing.Never "typing.Never"), and nothing
    else.
...
:   Ask a static type checker to reveal the inferred type of an expression.
    ...
    [`sys.stderr`](sys.md#sys.stderr "sys.stderr") and returns the argument unchanged (allowing the call to
...
:   Decorator to mark an object as providing
    ...
    [`@dataclasses.dataclass`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass").
    ...
    would have on the
    [`@dataclasses.dataclass`](dataclasses.md#dataclasses.dataclass "dataclasses.dataclass") decorator: `init`,
    ...
    Parameters:
    :   - **eq_default** ([*bool*](functions.md#bool "bool")) – Indicates whether the `eq` parameter is assumed to be
          `True` or `False` if it is omitted by the caller.
          Defaults to `True`.
        - **order_default** ([*bool*](functions.md#bool "bool")) – Indicates whether the `order` parameter is
          assumed to be `True` or `False` if it is omitted by the caller.
          Defaults to `False`.
        - **kw_only_default** ([*bool*](functions.md#bool "bool")) – Indicates whether the `kw_only` parameter is
          assumed to be `True` or `False` if it is omitted by the caller.
          Defaults to `False`.
        - **frozen_default** ([*bool*](functions.md#bool "bool")) –
          ...
          Added in version 3.12.
        - **field_specifiers** ([*tuple*](stdtypes.md#tuple "tuple")*[*[*Callable*](collections.abc.md#collections.abc.Callable "collections.abc.Callable")*[**...**,* *Any**]**,* *...**]*) – Specifies a static list of supported classes
          or functions that describe fields, similar to [`dataclasses.field()`](dataclasses.md#dataclasses.field "dataclasses.field").
          Defaults to `()`.
...
:   Return a sequence of [`@overload`](typing.md#typing.overload "typing.overload")-decorated definitions for
    ...
    *func* is the function object for the implementation of the
    ...
    the documentation for [`@overload`](typing.md#typing.overload "typing.overload"),
...
:   Return a dictionary containing type hints for a function, method, module
    ...
    - Forward references encoded as string literals or [`ForwardRef`](typing.md#typing.ForwardRef "typing.ForwardRef")
      objects are handled by evaluating them in *globalns*, *localns*, and
      (where applicable) *obj*’s [type parameter](https://docs.python.org/3.12/reference/compound_stmts.html#type-params) namespace.
      If *globalns* or *localns* is not given, appropriate namespace
      dictionaries are inferred from *obj*.
    - `None` is replaced with [`types.NoneType`](types.md#types.NoneType "types.NoneType").
    - If [`@no_type_check`](typing.md#typing.no_type_check "typing.no_type_check") has been applied to *obj*, an
      empty dictionary is returned.
    - If *obj* is a class `C`, the function returns a dictionary that merges
      annotations from `C`’s base classes with those on `C` directly. This
      is done by traversing [`C.__mro__`](https://docs.python.org/3.12/reference/datamodel.html#type.__mro__ "type.__mro__") and iteratively
      combining
      `__annotations__` dictionaries. Annotations on classes appearing
      earlier in the [method resolution order](https://docs.python.org/3.12/glossary.html#term-method-resolution-order) always take precedence over
      annotations on classes appearing later in the method resolution order.
    - The function recursively replaces all occurrences of `Annotated[T, ...]`
      with `T`, unless *include_extras* is set to `True` (see
      [`Annotated`](typing.md#typing.Annotated "typing.Annotated") for more information).

    See also [`inspect.get_annotations()`](inspect.md#inspect.get_annotations "inspect.get_annotations"), a lower-level function that
    ...
    > such as [`NameError`](exceptions.md#NameError "NameError"). For example, this can happen with imported
    > [type aliases](typing.md#type-aliases) that include forward references,
    > or with names imported under [`if TYPE_CHECKING`](typing.md#typing.TYPE_CHECKING "typing.TYPE_CHECKING").

    Changed in version 3.9: Added `include_extras` parameter as part of [**PEP 593**](https://peps.python.org/pep-0593/).
    See the documentation on [`Annotated`](typing.md#typing.Annotated "typing.Annotated") for more information.
...
:   Get the unsubscripted version of a type: for a typing object of the form
    ...
    [`collections`](collections.md#module-collections "collections: Container datatypes") class, it will be normalized to the original class.
    If `X` is an instance of [`ParamSpecArgs`](typing.md#typing.ParamSpecArgs "typing.ParamSpecArgs") or [`ParamSpecKwargs`](typing.md#typing.ParamSpecKwargs "typing.ParamSpecKwargs"),
    return the underlying [`ParamSpec`](typing.md#typing.ParamSpec "typing.ParamSpec").
...
:   Get type arguments with all substitutions performed: for a typing object
    ...
    If `X` is a union or [`Literal`](typing.md#typing.Literal "typing.Literal") contained in another
...
:   Deprecated alias to [`dict`](stdtypes.md#dict "dict").
    ...
    to use an abstract collection type such as [`Mapping`](collections.abc.md#collections.abc.Mapping "collections.abc.Mapping")
    rather than to use [`dict`](stdtypes.md#dict "dict") or `typing.Dict`.
...
:   Deprecated alias to [`list`](stdtypes.md#list "list").
    ...
    [`Sequence`](collections.abc.md#collections.abc.Sequence "collections.abc.Sequence") or [`Iterable`](collections.abc.md#collections.abc.Iterable "collections.abc.Iterable")
    rather than to use [`list`](stdtypes.md#list "list") or `typing.List`.
...
:   Deprecated alias to [`builtins.set`](stdtypes.md#set "set").
    ...
    Note that to annotate arguments, it is preferred
    to use an abstract collection type such as [`collections.abc.Set`](collections.abc.md#collections.abc.Set "collections.abc.Set")
    rather than to use [`set`](stdtypes.md#set "set") or [`typing.Set`](typing.md#typing.Set "typing.Set").
...
:   Deprecated alias for [`tuple`](stdtypes.md#tuple "tuple").
    ...
    [Annotating tuples](typing.md#annotating-tuples) for more details.
...
:   Deprecated alias to [`type`](functions.md#type "type").
    ...
    Deprecated since version 3.9: [`builtins.type`](functions.md#type "type") now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated alias to [`collections.deque`](collections.md#collections.deque "collections.deque").
    ...
    Deprecated since version 3.9: [`collections.deque`](collections.md#collections.deque "collections.deque") now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated aliases corresponding to the return types from
    ...
    [`AnyStr`](typing.md#typing.AnyStr "typing.AnyStr"). `Pattern` can be specialised as `Pattern[str]` or
...
:   Deprecated alias for [`str`](stdtypes.md#str "str").
    ...
    [`str`](stdtypes.md#str "str") instead of `Text`.
...
:   Deprecated alias to [`collections.abc.Coroutine`](collections.abc.md#collections.abc.Coroutine "collections.abc.Coroutine").
    ...
    for details on using [`collections.abc.Coroutine`](collections.abc.md#collections.abc.Coroutine "collections.abc.Coroutine")
...
:   Deprecated alias to [`collections.abc.AsyncGenerator`](collections.abc.md#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator").
    ...
    See [Annotating generators and coroutines](typing.md#annotating-generators-and-coroutines)
    for details on using [`collections.abc.AsyncGenerator`](collections.abc.md#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator")
    and `typing.AsyncGenerator` in type annotations.

    Added in version 3.6.1.

    Deprecated since version 3.9: [`collections.abc.AsyncGenerator`](collections.abc.md#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator")
    now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated alias to [`collections.abc.Awaitable`](collections.abc.md#collections.abc.Awaitable "collections.abc.Awaitable").
    ...
    Deprecated since version 3.9: [`collections.abc.Awaitable`](collections.abc.md#collections.abc.Awaitable "collections.abc.Awaitable") now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated alias to [`collections.abc.Callable`](collections.abc.md#collections.abc.Callable "collections.abc.Callable").
    ...
    [`collections.abc.Callable`](collections.abc.md#collections.abc.Callable "collections.abc.Callable") and `typing.Callable` in type annotations.

    Deprecated since version 3.9: [`collections.abc.Callable`](collections.abc.md#collections.abc.Callable "collections.abc.Callable") now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated alias to [`collections.abc.Generator`](collections.abc.md#collections.abc.Generator "collections.abc.Generator").
    ...
    See [Annotating generators and coroutines](typing.md#annotating-generators-and-coroutines)
    for details on using [`collections.abc.Generator`](collections.abc.md#collections.abc.Generator "collections.abc.Generator")
...
:   Deprecated alias to [`contextlib.AbstractContextManager`](contextlib.md#contextlib.AbstractContextManager "contextlib.AbstractContextManager").
    ...
    Deprecated since version 3.9: [`contextlib.AbstractContextManager`](contextlib.md#contextlib.AbstractContextManager "contextlib.AbstractContextManager")
    now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
:   Deprecated alias to [`contextlib.AbstractAsyncContextManager`](contextlib.md#contextlib.AbstractAsyncContextManager "contextlib.AbstractAsyncContextManager").
    ...
    Deprecated since version 3.9: [`contextlib.AbstractAsyncContextManager`](contextlib.md#contextlib.AbstractAsyncContextManager "contextlib.AbstractAsyncContextManager")
    now supports subscripting (`[]`).
    See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](stdtypes.md#types-genericalias).
...
| `typing` versions of standard collections | 3.9 | Undecided (see [Deprecated aliases](typing.md#deprecated-aliases) for more information) | [**PEP 585**](https://peps.python.org/pep-0585/) |
| [`typing.ByteString`](typing.md#typing.ByteString "typing.ByteString") | 3.9 | 3.14 | [gh-91896](https://github.com/python/cpython/issues/91896) |
| [`typing.Text`](typing.md#typing.Text "typing.Text") | 3.11 | Undecided | [gh-92332](https://github.com/python/cpython/issues/92332) |
| [`typing.Hashable`](typing.md#typing.Hashable "typing.Hashable") and [`typing.Sized`](typing.md#typing.Sized "typing.Sized") | 3.12 | Undecided | [gh-94309](https://github.com/python/cpython/issues/94309) |
| [`typing.TypeAlias`](typing.md#typing.TypeAlias "typing.TypeAlias") | 3.12 | Undecided | [**PEP 695**](https://peps.python.org/pep-0695/) |
