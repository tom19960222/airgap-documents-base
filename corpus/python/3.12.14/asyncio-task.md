...
source_url: https://docs.python.org/3.12/library/asyncio-task.html
fetched_at: 2026-09-17T15:35:50+00:00
---
...
- [Coroutines](asyncio-task.md#coroutines)
- [Awaitables](asyncio-task.md#awaitables)
- [Creating Tasks](asyncio-task.md#creating-tasks)
- [Task Cancellation](asyncio-task.md#task-cancellation)
- [Task Groups](asyncio-task.md#task-groups)
- [Sleeping](asyncio-task.md#sleeping)
- [Running Tasks Concurrently](asyncio-task.md#running-tasks-concurrently)
- [Eager Task Factory](asyncio-task.md#eager-task-factory)
- [Shielding From Cancellation](asyncio-task.md#shielding-from-cancellation)
- [Timeouts](asyncio-task.md#timeouts)
- [Waiting Primitives](asyncio-task.md#waiting-primitives)
- [Running in Threads](asyncio-task.md#running-in-threads)
- [Scheduling From Other Threads](asyncio-task.md#scheduling-from-other-threads)
- [Introspection](asyncio-task.md#introspection)
- [Task Object](asyncio-task.md#task-object)

## Coroutines

**Source code:** [Lib/asyncio/coroutines.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/coroutines.py)

---

[Coroutines](https://docs.python.org/3.12/glossary.html#term-coroutine) declared with the async/await syntax is the
...
- The [`asyncio.run()`](asyncio-runner.md#asyncio.run "asyncio.run") function to run the top-level
...
- Awaiting on a coroutine. The following snippet of code will
  ...
  ```
- The [`asyncio.create_task()`](asyncio-task.md#asyncio.create_task "asyncio.create_task") function to run coroutines
  concurrently as asyncio [`Tasks`](asyncio-task.md#asyncio.Task "asyncio.Task").
  ...
  *concurrently*:
  ...
  ```
- The [`asyncio.TaskGroup`](asyncio-task.md#asyncio.TaskGroup "asyncio.TaskGroup") class provides a more modern
  alternative to [`create_task()`](asyncio-task.md#asyncio.create_task "asyncio.create_task").
  ...
  Added in version 3.11: [`asyncio.TaskGroup`](asyncio-task.md#asyncio.TaskGroup "asyncio.TaskGroup").

## Awaitables

We say that an object is an **awaitable** object if it can be used
in an [`await`](https://docs.python.org/3.12/reference/expressions.html#await) expression. Many asyncio APIs are designed to
accept awaitables.
...
>
> - a *coroutine function*: an [`async def`](https://docs.python.org/3.12/reference/compound_stmts.html#async-def) function;
...
[`asyncio.create_task()`](asyncio-task.md#asyncio.create_task "asyncio.create_task") the coroutine is automatically
...
A [`Future`](asyncio-future.md#asyncio.Future "asyncio.Future") is a special **low-level** awaitable object that
...
is [`loop.run_in_executor()`](asyncio-eventloop.md#asyncio.loop.run_in_executor "asyncio.loop.run_in_executor").

## Creating Tasks

**Source code:** [Lib/asyncio/tasks.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/tasks.py)
...
:   Wrap the *coro* [coroutine](asyncio-task.md#coroutine) into a [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task")
    ...
    [`Task.set_name()`](asyncio-task.md#asyncio.Task.set_name "asyncio.Task.set_name").
    ...
    The task is executed in the loop returned by [`get_running_loop()`](asyncio-eventloop.md#asyncio.get_running_loop "asyncio.get_running_loop"),
    [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") is raised if there is no running loop in
    current thread.

    > **Note:**
    >
    > [`asyncio.TaskGroup.create_task()`](asyncio-task.md#asyncio.TaskGroup.create_task "asyncio.TaskGroup.create_task") is a new alternative
...
When a task is cancelled, [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") will be raised
in the task at the next opportunity.

It is recommended that coroutines use `try/finally` blocks to robustly
perform clean-up logic. In case [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError")
is explicitly caught, it should generally be propagated when
clean-up is complete. [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") directly subclasses
[`BaseException`](exceptions.md#BaseException "BaseException") so most code will not need to be aware of it.

The asyncio components that enable structured concurrency, like
[`asyncio.TaskGroup`](asyncio-task.md#asyncio.TaskGroup "asyncio.TaskGroup") and [`asyncio.timeout()`](asyncio-task.md#asyncio.timeout "asyncio.timeout"),
are implemented using cancellation internally and might misbehave if
a coroutine swallows [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError"). Similarly, user code
should not generally call [`uncancel`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel").
However, in cases when suppressing [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") is
...
with an exception other than [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError"),
...
(i.e., [`__aexit__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__aexit__ "object.__aexit__") hasn’t been called yet),
the task directly containing the `async with` statement is also cancelled.
The resulting [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") will interrupt an `await`,
...
[`ExceptionGroup`](exceptions.md#ExceptionGroup "ExceptionGroup") or [`BaseExceptionGroup`](exceptions.md#BaseExceptionGroup "BaseExceptionGroup")
(as appropriate; see their documentation)
which is then raised.

Two base exceptions are treated specially:
If any task fails with [`KeyboardInterrupt`](exceptions.md#KeyboardInterrupt "KeyboardInterrupt") or [`SystemExit`](exceptions.md#SystemExit "SystemExit"),
the task group still cancels the remaining tasks and waits for them,
but then the initial [`KeyboardInterrupt`](exceptions.md#KeyboardInterrupt "KeyboardInterrupt") or [`SystemExit`](exceptions.md#SystemExit "SystemExit")
is re-raised instead of [`ExceptionGroup`](exceptions.md#ExceptionGroup "ExceptionGroup") or [`BaseExceptionGroup`](exceptions.md#BaseExceptionGroup "BaseExceptionGroup").

If the body of the `async with` statement exits with an exception
(so [`__aexit__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__aexit__ "object.__aexit__") is called with an exception set),
...
The exception passed into [`__aexit__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__aexit__ "object.__aexit__"),
unless it is [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError"),
is also included in the exception group.
The same special case is made for
[`KeyboardInterrupt`](exceptions.md#KeyboardInterrupt "KeyboardInterrupt") and [`SystemExit`](exceptions.md#SystemExit "SystemExit") as in the previous paragraph.
...
:   Run [awaitable objects](asyncio-task.md#asyncio-awaitables) in the *aws*
    ...
    **won’t be cancelled** and will continue to run.
    ...
    treated as if it raised [`CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") – the `gather()`
    ...
    > wait for their completion is [`asyncio.TaskGroup`](asyncio-task.md#asyncio.TaskGroup "asyncio.TaskGroup"). *TaskGroup*
...
:   A task factory for eager task execution.
    ...
    coroutines begin execution synchronously during [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task") construction.
...
:   Create an eager task factory, similar to [`eager_task_factory()`](asyncio-task.md#asyncio.eager_task_factory "asyncio.eager_task_factory"),
    ...
    *custom_task_constructor* must be a *callable* with the signature matching
    the signature of [`Task.__init__`](asyncio-task.md#asyncio.Task "asyncio.Task").
    The callable must return a [`asyncio.Task`](asyncio-task.md#asyncio.Task "asyncio.Task")-compatible object.

    This function returns a *callable* intended to be used as a task factory of an
    event loop via [`loop.set_task_factory(factory)`](asyncio-eventloop.md#asyncio.loop.set_task_factory "asyncio.loop.set_task_factory")).
...
:   Protect an [awaitable object](asyncio-task.md#asyncio-awaitables)
    ...
    *except* that if the coroutine containing it is cancelled, the
    ...
    still raises a [`CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError").
...
:   Return an [asynchronous context manager](https://docs.python.org/3.12/reference/datamodel.html#async-context-managers)
    ...
    *delay* can either be `None`, or a float/int number of
    ...
    creation using [`Timeout.reschedule()`](asyncio-task.md#asyncio.Timeout.reschedule "asyncio.Timeout.reschedule").
    ...
    the resulting [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") internally, transforming it
    into a [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError") which can be caught and handled.

    > **Note:**
    >
    > The [`asyncio.timeout()`](asyncio-task.md#asyncio.timeout "asyncio.timeout") context manager is what transforms
    > the [`asyncio.CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") into a [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError"),
    > which means the [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError") can only be caught
    > *outside* of the context manager.

    Example of catching [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError"):
...
:   Wait for the *aw* [awaitable](asyncio-task.md#asyncio-awaitables)
    ...
    *timeout* can either be `None` or a float or int number of seconds
    ...
    To avoid the task [`cancellation`](asyncio-task.md#asyncio.Task.cancel "asyncio.Task.cancel"),
    wrap it in [`shield()`](asyncio-task.md#asyncio.shield "asyncio.shield").
    ...
    [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError") immediately.

    Changed in version 3.10: Removed the *loop* parameter.

    Changed in version 3.11: Raises [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError") instead of [`asyncio.TimeoutError`](asyncio-exceptions.md#asyncio.TimeoutError "asyncio.TimeoutError").
...
:   Run [`Future`](asyncio-future.md#asyncio.Future "asyncio.Future") and [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task") instances in the *aws*
    ...
    *timeout* (a float or int), if specified, can be used to control
    ...
    Note that this function does not raise [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError").
...
:   Run [awaitable objects](asyncio-task.md#asyncio-awaitables) in the *aws*
    ...
    Raises [`TimeoutError`](exceptions.md#TimeoutError "TimeoutError") if the timeout occurs before
...
:   Asynchronously run function *func* in a separate thread.
    ...
    to *func*. Also, the current [`contextvars.Context`](contextvars.md#contextvars.Context "contextvars.Context") is propagated,
    ...
    > **Note:**
    >
    > Due to the [GIL](https://docs.python.org/3.12/glossary.html#term-GIL), `asyncio.to_thread()` can typically only be used
...
:   Return the currently running [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task") instance, or `None` if
    ...
    If *loop* is `None` [`get_running_loop()`](asyncio-eventloop.md#asyncio.get_running_loop "asyncio.get_running_loop") is used to get
    the current loop.
...
:   Return a set of not yet finished [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task") objects run by
    ...
    If *loop* is `None`, [`get_running_loop()`](asyncio-eventloop.md#asyncio.get_running_loop "asyncio.get_running_loop") is used for getting
    current loop.
...
:   A [`Future-like`](asyncio-future.md#asyncio.Future "asyncio.Future") object that runs a Python
    ...
    Use the high-level [`asyncio.create_task()`](asyncio-task.md#asyncio.create_task "asyncio.create_task") function to create
    Tasks, or the low-level [`loop.create_task()`](asyncio-eventloop.md#asyncio.loop.create_task "asyncio.loop.create_task") or
    [`ensure_future()`](asyncio-future.md#asyncio.ensure_future "asyncio.ensure_future") functions. Manual instantiation of Tasks
    is discouraged.

    To cancel a running Task use the [`cancel()`](asyncio-task.md#asyncio.Task.cancel "asyncio.Task.cancel") method. Calling it
    will cause the Task to throw a [`CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") exception into
    ...
    [`cancelled()`](asyncio-task.md#asyncio.Task.cancelled "asyncio.Task.cancelled") can be used to check if the Task was cancelled.
    The method returns `True` if the wrapped coroutine did not
    suppress the [`CancelledError`](asyncio-exceptions.md#asyncio.CancelledError "asyncio.CancelledError") exception and was actually
    cancelled.

    [`asyncio.Task`](asyncio-task.md#asyncio.Task "asyncio.Task") inherits from [`Future`](asyncio-future.md#asyncio.Future "asyncio.Future") all of its
    APIs except [`Future.set_result()`](asyncio-future.md#asyncio.Future.set_result "asyncio.Future.set_result") and
    [`Future.set_exception()`](asyncio-future.md#asyncio.Future.set_exception "asyncio.Future.set_exception").
    ...
    the execution of the [`asyncio.Task`](asyncio-task.md#asyncio.Task "asyncio.Task") at task creation time.
    ...
    :   Print the stack or traceback for this Task.
        ...
        for the frames retrieved by [`get_stack()`](asyncio-task.md#asyncio.Task.get_stack "asyncio.Task.get_stack").

        The *limit* argument is passed to [`get_stack()`](asyncio-task.md#asyncio.Task.get_stack "asyncio.Task.get_stack") directly.
    ...
    :   Return the coroutine object wrapped by the [`Task`](asyncio-task.md#asyncio.Task "asyncio.Task").
        ...
        > completed eagerly. See the [Eager Task Factory](asyncio-task.md#eager-task-factory).
    ...
    :   Set the name of the Task.
        ...
        in the [`repr()`](functions.md#repr "repr") output of a task object.
    ...
    :   Request the Task to be cancelled.
        ...
        request by suppressing the exception with a [`try`](https://docs.python.org/3.12/reference/compound_stmts.html#try) …
        … `except CancelledError` … [`finally`](https://docs.python.org/3.12/reference/compound_stmts.html#finally) block.
        Therefore, unlike [`Future.cancel()`](asyncio-future.md#asyncio.Future.cancel "asyncio.Future.cancel"), [`Task.cancel()`](asyncio-task.md#asyncio.Task.cancel "asyncio.Task.cancel") does
        not guarantee that the Task will be cancelled, although
        suppressing cancellation completely is not common and is actively
        discouraged. Should the coroutine nevertheless decide to suppress
        the cancellation, it needs to call [`Task.uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel") in addition
    ...
    :   Decrement the count of cancellation requests to this Task.
        ...
        calls to [`uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel") are ineffective.
        ...
        [Task Groups](asyncio-task.md#taskgroups) and [`asyncio.timeout()`](asyncio-task.md#asyncio.timeout "asyncio.timeout") to continue running,
        ...
        with [`uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel"). [`TaskGroup`](asyncio-task.md#asyncio.TaskGroup "asyncio.TaskGroup") context managers use
        [`uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel") in a similar fashion.
    ...
    :   Return the number of pending cancellation requests to this Task, i.e.,
        ...
        still executing, [`cancelled()`](asyncio-task.md#asyncio.Task.cancelled "asyncio.Task.cancelled") will still return `False`.
        This is because this number can be lowered by calling [`uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel"),
        which can lead to the task not being cancelled after all if the
        cancellation requests go down to zero.

        This method is used by asyncio’s internals and isn’t expected to be
        used by end-user code. See [`uncancel()`](asyncio-task.md#asyncio.Task.uncancel "asyncio.Task.uncancel") for more details.
