...
source_url: https://docs.python.org/3.12/library/ctypes.html
fetched_at: 2026-09-17T15:33:26+00:00
---
...
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") is a foreign function library for Python. It provides C compatible
data types, and allows calling functions in DLLs or shared libraries. It can be
used to wrap these libraries in pure Python.

## ctypes tutorial

Note: The code samples in this tutorial use [`doctest`](doctest.md#module-doctest "doctest: Test pieces of code within docstrings.") to make sure that
they actually work. Since some code samples behave differently under Linux,
Windows, or macOS, they contain doctest directives in comments.

Note: Some code samples reference the ctypes [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int") type. On platforms
where `sizeof(long) == sizeof(int)` it is an alias to [`c_long`](ctypes.md#ctypes.c_long "ctypes.c_long").
So, you should not be confused if [`c_long`](ctypes.md#ctypes.c_long "ctypes.c_long") is printed if you would expect
[`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int") — they are actually the same type.

### Loading dynamic link libraries

[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") exports the *cdll*, and on Windows *windll* and *oledll*
...
code is used to automatically raise an [`OSError`](exceptions.md#OSError "OSError") exception when the
function call fails.

Changed in version 3.3: Windows errors used to raise [`WindowsError`](exceptions.md#WindowsError "WindowsError"), which is now an alias
...
[`LoadLibrary()`](ctypes.md#ctypes.LibraryLoader.LoadLibrary "ctypes.LibraryLoader.LoadLibrary") method of the dll loaders should be used,
...
[`getattr()`](functions.md#getattr "getattr") to retrieve the function:
...
[`ValueError`](exceptions.md#ValueError "ValueError") is raised when you call an `stdcall` function with the
...
On Windows, [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") uses win32 structured exception handling to prevent
...
There are, however, enough ways to crash Python with [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python."), so you
should be careful anyway. The [`faulthandler`](faulthandler.md#module-faulthandler "faulthandler: Dump the Python traceback.") module can be helpful in
...
more about [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") data types.

### Fundamental data types

[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") defines a number of primitive C compatible data types:

| ctypes type | C type | Python type |
| --- | --- | --- |
| [`c_bool`](ctypes.md#ctypes.c_bool "ctypes.c_bool") | _Bool | bool (1) |
| [`c_char`](ctypes.md#ctypes.c_char "ctypes.c_char") | char | 1-character bytes object |
| [`c_wchar`](ctypes.md#ctypes.c_wchar "ctypes.c_wchar") | `wchar_t` | 1-character string |
| [`c_byte`](ctypes.md#ctypes.c_byte "ctypes.c_byte") | char | int |
| [`c_ubyte`](ctypes.md#ctypes.c_ubyte "ctypes.c_ubyte") | unsigned char | int |
| [`c_short`](ctypes.md#ctypes.c_short "ctypes.c_short") | short | int |
| [`c_ushort`](ctypes.md#ctypes.c_ushort "ctypes.c_ushort") | unsigned short | int |
| [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int") | int | int |
| [`c_uint`](ctypes.md#ctypes.c_uint "ctypes.c_uint") | unsigned int | int |
| [`c_long`](ctypes.md#ctypes.c_long "ctypes.c_long") | long | int |
| [`c_ulong`](ctypes.md#ctypes.c_ulong "ctypes.c_ulong") | unsigned long | int |
| [`c_longlong`](ctypes.md#ctypes.c_longlong "ctypes.c_longlong") | __int64 or long long | int |
| [`c_ulonglong`](ctypes.md#ctypes.c_ulonglong "ctypes.c_ulonglong") | unsigned __int64 or unsigned long long | int |
| [`c_size_t`](ctypes.md#ctypes.c_size_t "ctypes.c_size_t") | `size_t` | int |
| [`c_ssize_t`](ctypes.md#ctypes.c_ssize_t "ctypes.c_ssize_t") | `ssize_t` or [Py_ssize_t](https://docs.python.org/3.12/c-api/intro.html#c.Py_ssize_t "Py_ssize_t") | int |
| [`c_time_t`](ctypes.md#ctypes.c_time_t "ctypes.c_time_t") | `time_t` | int |
| [`c_float`](ctypes.md#ctypes.c_float "ctypes.c_float") | float | float |
| [`c_double`](ctypes.md#ctypes.c_double "ctypes.c_double") | double | float |
| [`c_longdouble`](ctypes.md#ctypes.c_longdouble "ctypes.c_longdouble") | long double | float |
| [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p") | char\* (NUL terminated) | bytes object or `None` |
| [`c_wchar_p`](ctypes.md#ctypes.c_wchar_p "ctypes.c_wchar_p") | wchar_t\* (NUL terminated) | string or `None` |
| [`c_void_p`](ctypes.md#ctypes.c_void_p "ctypes.c_void_p") | void\* | int or `None` |
...
Assigning a new value to instances of the pointer types [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p"),
[`c_wchar_p`](ctypes.md#ctypes.c_wchar_p "ctypes.c_wchar_p"), and [`c_void_p`](ctypes.md#ctypes.c_void_p "ctypes.c_void_p") changes the *memory location* they
...
[`create_string_buffer()`](ctypes.md#ctypes.create_string_buffer "ctypes.create_string_buffer") function which creates these in various ways. The
...
The [`create_string_buffer()`](ctypes.md#ctypes.create_string_buffer "ctypes.create_string_buffer") function replaces the old `c_buffer()`
function (which is still available as an alias). To create a mutable memory
block containing unicode characters of the C type `wchar_t`, use the
[`create_unicode_buffer()`](ctypes.md#ctypes.create_unicode_buffer "ctypes.create_unicode_buffer") function.

### Calling functions, continued

Note that printf prints to the real standard output channel, *not* to
[`sys.stdout`](sys.md#sys.stdout "sys.stdout"), so these examples will only work at the console prompt, not
...
bytes objects have to be wrapped in their corresponding [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") type, so
...
On those platforms it is required to specify the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes")
...
specify [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") for all variadic functions.

### Calling functions with your own custom data types

You can also customize [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") argument conversion to allow instances of
your own classes be used as function arguments. [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") looks for an
`_as_parameter_` attribute and uses this as the function argument. The
attribute must be an integer, string, bytes, a [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") instance, or an
...
instance variable, you could define a [`property`](functions.md#property "property") which makes the
attribute available on request.

### Specifying the required argument types (function prototypes)

It is possible to specify the required argument types of functions exported from
DLLs by setting the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") attribute.

[`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") must be a sequence of C data types (the `printf()` function is
...
to implement a [`from_param()`](ctypes.md#ctypes._CData.from_param "ctypes._CData.from_param") class method for them to be able to use them
in the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") sequence. The [`from_param()`](ctypes.md#ctypes._CData.from_param "ctypes._CData.from_param") class method receives
the Python object passed to the function call, it should do a typecheck or
whatever is needed to make sure this object is acceptable, and then return the
object itself, its `_as_parameter_` attribute, or whatever you want to
pass as the C function argument in this case. Again, the result should be an
integer, string, bytes, a [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") instance, or an object with an
`_as_parameter_` attribute.

### Return types

By default functions are assumed to return the C int type. Other
return types can be specified by setting the [`restype`](ctypes.md#ctypes._CFuncPtr.restype "ctypes._CFuncPtr.restype") attribute of the
function object.
...
The argument types can be specified using [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes"):
...
If you want to avoid the [`ord("x")`](functions.md#ord "ord") calls above, you can set the
[`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") attribute, and the second argument will be converted from a
...
the [`restype`](ctypes.md#ctypes._CFuncPtr.restype "ctypes._CFuncPtr.restype") attribute, if the foreign function returns an integer. The
...
[`GetLastError()`](ctypes.md#ctypes.GetLastError "ctypes.GetLastError") to retrieve it.

Please note that a much more powerful error checking mechanism is available
through the [`errcheck`](ctypes.md#ctypes._CFuncPtr.errcheck "ctypes._CFuncPtr.errcheck") attribute;
...
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") exports the [`byref()`](ctypes.md#ctypes.byref "ctypes.byref") function which is used to pass parameters
by reference. The same effect can be achieved with the [`pointer()`](ctypes.md#ctypes.pointer "ctypes.pointer") function,
although [`pointer()`](ctypes.md#ctypes.pointer "ctypes.pointer") does a lot more work since it constructs a real pointer
object, so it is faster to use [`byref()`](ctypes.md#ctypes.byref "ctypes.byref") if you don’t need the pointer
...
Structures and unions must derive from the [`Structure`](ctypes.md#ctypes.Structure "ctypes.Structure") and [`Union`](ctypes.md#ctypes.Union "ctypes.Union")
base classes which are defined in the [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") module. Each subclass must
define a [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") attribute. `_fields_` must be a list of
*2-tuples*, containing a *field name* and a *field type*.

The field type must be a [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") type like [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int"), or any other
derived [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") type: structure, union, array, pointer.
...
Field [descriptor](https://docs.python.org/3.12/glossary.html#term-descriptor)s can be retrieved from the *class*, they are useful
...
> **Warning:**
>
> [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") does not support passing unions or structures with bit-fields
...
[`_pack_`](ctypes.md#ctypes.Structure._pack_ "ctypes.Structure._pack_") class attribute in the subclass definition.
This must be set to a positive integer and specifies the maximum alignment for the fields.
This is what `#pragma pack(n)` also does in MSVC.

[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") uses the native byte order for Structures and Unions. To build
structures with non-native byte order, you can use one of the
[`BigEndianStructure`](ctypes.md#ctypes.BigEndianStructure "ctypes.BigEndianStructure"), [`LittleEndianStructure`](ctypes.md#ctypes.LittleEndianStructure "ctypes.LittleEndianStructure"),
[`BigEndianUnion`](ctypes.md#ctypes.BigEndianUnion "ctypes.BigEndianUnion"), and [`LittleEndianUnion`](ctypes.md#ctypes.LittleEndianUnion "ctypes.LittleEndianUnion") base classes. These
...
item in the [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") tuples:
...
Pointer instances are created by calling the [`pointer()`](ctypes.md#ctypes.pointer "ctypes.pointer") function on a
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") type:
...
Pointer instances have a [`contents`](ctypes.md#ctypes._Pointer.contents "ctypes._Pointer.contents") attribute which
...
Note that [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") does not have OOR (original object return), it constructs a
...
Assigning another [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int") instance to the pointer’s contents attribute
...
Behind the scenes, the [`pointer()`](ctypes.md#ctypes.pointer "ctypes.pointer") function does more than simply create
pointer instances, it has to create pointer *types* first. This is done with the
[`POINTER()`](ctypes.md#ctypes.POINTER "ctypes.POINTER") function, which accepts any [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") type, and returns a
new type:
...
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") checks for `NULL` when dereferencing pointers (but dereferencing
...
`POINTER(c_int)` in the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") list of a function or as the type of
...
(such as `POINTER(c_int)`) in [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes"), an object of the pointed
type (`c_int` in this case) can be passed to the function. ctypes will apply
the required [`byref()`](ctypes.md#ctypes.byref "ctypes.byref") conversion in this case automatically.
...
into another type. [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") provides a [`cast()`](ctypes.md#ctypes.cast "ctypes.cast") function which can be
used in the same way. The `Bar` structure defined above accepts
`POINTER(c_int)` pointers or [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int") arrays for its `values` field,
...
For these cases, the [`cast()`](ctypes.md#ctypes.cast "ctypes.cast") function is handy.

The [`cast()`](ctypes.md#ctypes.cast "ctypes.cast") function can be used to cast a ctypes instance into a pointer
to a different ctypes data type. [`cast()`](ctypes.md#ctypes.cast "ctypes.cast") takes two parameters, a ctypes
...
So, [`cast()`](ctypes.md#ctypes.cast "ctypes.cast") can be used to assign to the `values` field of `Bar` the
structure:
...
In [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python."), we can define the `cell` class and set the
[`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") attribute later, after the class statement:
...
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") allows creating C callable function pointers from Python callables.
...
The [`CFUNCTYPE()`](ctypes.md#ctypes.CFUNCTYPE "ctypes.CFUNCTYPE") factory function creates types for callback functions
using the `cdecl` calling convention. On Windows, the [`WINFUNCTYPE()`](ctypes.md#ctypes.WINFUNCTYPE "ctypes.WINFUNCTYPE")
...
> **Note:**
>
> Make sure you keep references to [`CFUNCTYPE()`](ctypes.md#ctypes.CFUNCTYPE "ctypes.CFUNCTYPE") objects as long as they
> are used from C code. [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") doesn’t, and if you don’t, they may be
...
> [`threading.local`](threading.md#threading.local "threading.local") will *not* survive across different callbacks, even when
> those calls are made from the same C thread.

### Accessing values exported from dlls

Some shared libraries not only export functions, they also export variables. An
example in the Python library itself is the [`Py_Version`](https://docs.python.org/3.12/c-api/apiabiversion.html#c.Py_Version "Py_Version"), Python
runtime version number encoded in a single constant integer.

[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") can access values like this with the [`in_dll()`](ctypes.md#ctypes._CData.in_dll "ctypes._CData.in_dll") class methods of
...
[`PyImport_FrozenModules`](https://docs.python.org/3.12/c-api/import.html#c.PyImport_FrozenModules "PyImport_FrozenModules") pointer exported by Python.

Quoting the docs for that value:

> This pointer is initialized to point to an array of [`_frozen`](https://docs.python.org/3.12/c-api/import.html#c._frozen "_frozen")
> records, terminated by one whose members are all `NULL` or zero. When a frozen
> module is imported, it is searched in this table. Third-party code could play
> tricks with this to provide a dynamically created collection of frozen modules.

So manipulating this pointer could even prove useful. To restrict the example
size, we show only how this table can be read with [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python."):
...
We have defined the [`_frozen`](https://docs.python.org/3.12/c-api/import.html#c._frozen "_frozen") data type, so we can get the pointer
to the table:
...
There are some edges in [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") where you might expect something other
...
> **Note:**
>
> Objects instantiated from [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p") can only have their value set to bytes
> or integers.

Why is it printing `False`? ctypes instances are objects containing a memory
block plus some [descriptor](https://docs.python.org/3.12/glossary.html#term-descriptor)s accessing the contents of the memory.
...
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") provides some support for variable-sized arrays and structures.

The [`resize()`](ctypes.md#ctypes.resize "ctypes.resize") function can be used to resize the memory buffer of an
...
[`ValueError`](exceptions.md#ValueError "ValueError") is raised if this is tried:
...
Another way to use variable-sized data types with [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") is to use the
...
The purpose of the [`find_library()`](ctypes.md#ctypes.util.find_library "ctypes.util.find_library") function is to locate a library in a way
...
On Linux, [`find_library()`](ctypes.md#ctypes.util.find_library "ctypes.util.find_library") tries to run external programs
...
On macOS, [`find_library()`](ctypes.md#ctypes.util.find_library "ctypes.util.find_library") tries several predefined naming schemes and paths
...
On Windows, [`find_library()`](ctypes.md#ctypes.util.find_library "ctypes.util.find_library") searches along the system search path, and
returns the full pathname, but since there is no predefined naming scheme a call
like `find_library("c")` will fail and return `None`.

If wrapping a shared library with [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python."), it *may* be better to determine
the shared library name at development time, and hardcode that into the wrapper
module instead of using [`find_library()`](ctypes.md#ctypes.util.find_library "ctypes.util.find_library") to locate the library at runtime.
...
:   Instances of this class represent loaded shared libraries. Functions in these
    ...
    On Windows creating a [`CDLL`](ctypes.md#ctypes.CDLL "ctypes.CDLL") instance may fail even if the DLL name
    exists. When a dependent DLL of the loaded DLL is not found, a
    [`OSError`](exceptions.md#OSError "OSError") error is raised with the message *“[WinError 126] The
...
:   Instances of this class represent loaded shared libraries,
    ...
    failure, an [`OSError`](exceptions.md#OSError "OSError") is automatically raised.

    [Availability](intro.md#availability): Windows

    Changed in version 3.3: [`WindowsError`](exceptions.md#WindowsError "WindowsError") used to be raised,
    which is now an alias of [`OSError`](exceptions.md#OSError "OSError").
...
parameter, otherwise the underlying platforms `dlopen()` or
...
allows accessing the system [`errno`](errno.md#module-errno "errno: Standard errno system symbols.") error number in a safe way.
[`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") maintains a thread-local copy of the systems [`errno`](errno.md#module-errno "errno: Standard errno system symbols.")
variable; if you call foreign functions created with `use_errno=True` then the
[`errno`](errno.md#module-errno "errno: Standard errno system symbols.") value before the function call is swapped with the ctypes private
copy, the same happens immediately after the function call.

The function [`ctypes.get_errno()`](ctypes.md#ctypes.get_errno "ctypes.get_errno") returns the value of the ctypes private
copy, and the function [`ctypes.set_errno()`](ctypes.md#ctypes.set_errno "ctypes.set_errno") changes the ctypes private copy
to a new value and returns the former value.

The *use_last_error* parameter, when set to true, enables the same mechanism for
the Windows error code which is managed by the [`GetLastError()`](ctypes.md#ctypes.GetLastError "ctypes.GetLastError") and
`SetLastError()` Windows API functions; [`ctypes.get_last_error()`](ctypes.md#ctypes.get_last_error "ctypes.get_last_error") and
[`ctypes.set_last_error()`](ctypes.md#ctypes.set_last_error "ctypes.set_last_error") are used to request and change the ctypes private
...
which are instances of the [`LibraryLoader`](ctypes.md#ctypes.LibraryLoader "ctypes.LibraryLoader") class, either by calling the
...
in `ctypes`) which inherits from the private [`_CFuncPtr`](ctypes.md#ctypes._CFuncPtr "ctypes._CFuncPtr") class:
...
:   Base class for C callable foreign functions.
    ...
    :   Assign a tuple of ctypes types to specify the argument types that the
        ...
        [`from_param()`](ctypes.md#ctypes._CData.from_param "ctypes._CData.from_param") class method of the items in the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes")
        tuple, this method allows adapting the actual argument to an object that
        the foreign function accepts. For example, a [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p") item in
        the [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes") tuple will convert a string passed as argument into
        a bytes object using ctypes conversion rules.

        New: It is now possible to put items in argtypes which are not ctypes
        types, but each item must have a [`from_param()`](ctypes.md#ctypes._CData.from_param "ctypes._CData.from_param") method which returns a
...
:   The returned function prototype creates functions that use the standard C
    ...
    *use_errno* is set to true, the ctypes private copy of the system
    [`errno`](errno.md#module-errno "errno: Standard errno system symbols.") variable is exchanged with the real [`errno`](errno.md#module-errno "errno: Standard errno system symbols.") value before
...
*paramflags* must be a tuple of the same length as [`argtypes`](ctypes.md#ctypes._CFuncPtr.argtypes "ctypes._CFuncPtr.argtypes").
...
Here is the wrapping with [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python."):
...
Output parameters can be combined with the [`errcheck`](ctypes.md#ctypes._CFuncPtr.errcheck "ctypes._CFuncPtr.errcheck") protocol to do
...
If the [`errcheck`](ctypes.md#ctypes._CFuncPtr.errcheck "ctypes._CFuncPtr.errcheck") function returns the argument tuple it receives
unchanged, [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") continues the normal processing it does on the output
...
:   This function is probably the worst-named thing in ctypes. It
    ...
    specified, [`FormatError()`](ctypes.md#ctypes.FormatError "ctypes.FormatError") is called to get a textual description of the
    error.
...
:   This non-public class is the common base class of all ctypes data types.
    ...
    [`addressof()`](ctypes.md#ctypes.addressof "ctypes.addressof") helper function. Another instance variable is exposed as
    [`_objects`](ctypes.md#ctypes._CData._objects "ctypes._CData._objects"); this contains other Python objects that need to be kept
    ...
    :   This method returns a ctypes instance that shares the buffer of the
        *source* object. The *source* object must support the writeable buffer
        ...
        large enough a [`ValueError`](exceptions.md#ValueError "ValueError") is raised.
    ...
    :   This method creates a ctypes instance, copying the buffer from the
        *source* object buffer which must be readable. The optional *offset*
        ...
        is zero. If the source buffer is not large enough a [`ValueError`](exceptions.md#ValueError "ValueError") is
        raised.
...
:   This non-public class is the base class of all fundamental ctypes data
    ...
    [`_CData`](ctypes.md#ctypes._CData "ctypes._CData"), so it inherits their methods and attributes. ctypes data
    ...
    :   This attribute contains the actual value of the instance. For integer and
        ...
        a new object is returned each time. [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") does *not* implement
...
[`restype`](ctypes.md#ctypes._CFuncPtr.restype "ctypes._CFuncPtr.restype") of [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p"), you will always receive a Python bytes
object, *not* a [`c_char_p`](ctypes.md#ctypes.c_char_p "ctypes.c_char_p") instance.

Subclasses of fundamental data types do *not* inherit this behavior. So, if a
foreign functions `restype` is a subclass of [`c_void_p`](ctypes.md#ctypes.c_void_p "ctypes.c_void_p"), you will
...
:   Abstract base class for structures in *native* byte order.
    ...
    types, and at least define a [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") class variable. [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") will
    ...
    :   A sequence defining the structure fields. The items must be 2-tuples or
        ...
        For integer type fields like [`c_int`](ctypes.md#ctypes.c_int "ctypes.c_int"), a third optional item can be
        ...
        It is possible to define the [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") class variable *after* the
        ...
        The [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") class variable must, however, be defined before the
        type is first used (an instance is created, [`sizeof()`](ctypes.md#ctypes.sizeof "ctypes.sizeof") is called on it,
        and so on). Later assignments to the [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") class variable will
    ...
    :   An optional sequence that lists the names of unnamed (anonymous) fields.
        ...
        [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") will create descriptors in the structure type that allows
    ...
    [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") variable, the fields specified in this are appended to the
    fields of the base class.

    Structure and union constructors accept both positional and keyword
    arguments. Positional arguments are used to initialize member fields in the
    same order as they are appear in [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_"). Keyword arguments in the
    constructor are interpreted as attribute assignments, so they will initialize
    [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_") with the same name, or create new attributes for names not
    present in [`_fields_`](ctypes.md#ctypes.Structure._fields_ "ctypes.Structure._fields_").
...
:   Abstract base class for arrays.
    ...
    [`ctypes`](ctypes.md#module-ctypes "ctypes: A foreign function library for Python.") data type with a non-negative integer. Alternatively, you can subclass
    this type and define [`_length_`](ctypes.md#ctypes.Array._length_ "ctypes.Array._length_") and [`_type_`](ctypes.md#ctypes.Array._type_ "ctypes.Array._type_") class variables.
...
:   Private, abstract base class for pointers.
    ...
    [`pointer()`](ctypes.md#ctypes.pointer "ctypes.pointer").

    If a pointer points to an array, its elements can be read and
    written using standard subscript and slice accesses. Pointer objects
    have no size, so [`len()`](functions.md#len "len") will raise [`TypeError`](exceptions.md#TypeError "TypeError"). Negative
