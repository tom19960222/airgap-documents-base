...
source_url: https://docs.python.org/3.12/library/asyncio-platforms.html
...
**Source code:** [Lib/asyncio/proactor_events.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/proactor_events.py),
[Lib/asyncio/windows_events.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/windows_events.py),
[Lib/asyncio/windows_utils.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/windows_utils.py)
