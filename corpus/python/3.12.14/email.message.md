...
source_url: https://docs.python.org/3.12/library/email.message.html
...
Added in version 3.6: [[1]](email.message.md#id2)

The central class in the [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.") package is the [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage")
class, imported from the [`email.message`](email.message.md#module-email.message "email.message: The base class representing email messages.") module. It is the base class for
the [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.") object model. [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") provides the core
...
The conceptual model provided by an [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") object is that of an
...
The [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") dictionary-like interface is indexed by the header
...
objects, or a list of [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") objects, for MIME container
...
:   If *policy* is specified use the rules it specifies to update and serialize
    ...
    :   Return the entire message flattened as a string. When optional
        *unixfrom* is true, the envelope header is included in the returned
        ...
        with the base [`Message`](email.compat32-message.md#email.message.Message "email.message.Message") class *maxheaderlen* is
        accepted, but defaults to `None`, which means that by default the line
        length is controlled by the
        [`max_line_length`](email.policy.md#email.policy.Policy.max_line_length "email.policy.Policy.max_line_length") of the policy. The
        *policy* argument may be used to override the default policy obtained
        ...
        passed to the [`Generator`](email.generator.md#email.generator.Generator "email.generator.Generator").

        Flattening the message may trigger changes to the [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage")
        ...
        [`email.generator.Generator`](email.generator.md#email.generator.Generator "email.generator.Generator") for a more flexible API for
        serializing messages. Note also that this method is restricted to
        producing messages serialized as “7 bit clean” when
        [`utf8`](email.policy.md#email.policy.EmailPolicy.utf8 "email.policy.EmailPolicy.utf8") is `False`, which is the default.
    ...
    :   Return `True` if the message’s payload is a list of
        ...
        [`is_multipart()`](email.message.md#email.message.EmailMessage.is_multipart "email.message.EmailMessage.is_multipart") returning `True` does not necessarily mean that
    ...
    order to the keys returned by [`keys()`](email.message.md#email.message.EmailMessage.keys "email.message.EmailMessage.keys"), but in an [`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage")
    ...
    :   Return the value of the named header field. *name* does not include the
        ...
        undefined. Use the [`get_all()`](email.message.md#email.message.EmailMessage.get_all "email.message.EmailMessage.get_all") method to get the values of all the
    ...
    :   Add a header to the message with field name *name* and value *val*. The
        ...
        If the [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages") defines certain headers to be unique (as the standard
        policies do), this method may raise a [`ValueError`](exceptions.md#ValueError "ValueError") when an attempt
    ...
    :   Return the message’s content type, coerced to lower case of the form
        *maintype/subtype*. If there is no *Content-Type*
        ...
        [`get_default_type()`](email.message.md#email.message.EmailMessage.get_default_type "email.message.EmailMessage.get_default_type"). If the *Content-Type* header is
        ...
        [`get_content_type()`](email.message.md#email.message.EmailMessage.get_content_type "email.message.EmailMessage.get_content_type") will always return a value. [**RFC 2045**](https://datatracker.ietf.org/doc/html/rfc2045.html) defines
    ...
    :   Set a parameter in the *Content-Type* header. If the
        ...
        *header* specifies an alternative header to *Content-Type*.
        ...
        the [`params`](email.headerregistry.md#email.headerregistry.ParameterizedMIMEHeader.params "email.headerregistry.ParameterizedMIMEHeader.params") attribute of the
    ...
    :   Set the `boundary` parameter of the *Content-Type* header to
        ...
        *Content-Type* header and adding a new one with the new
        boundary via [`add_header()`](email.message.md#email.message.EmailMessage.add_header "email.message.EmailMessage.add_header"), because [`set_boundary()`](email.message.md#email.message.EmailMessage.set_boundary "email.message.EmailMessage.set_boundary") preserves
    ...
    :   The [`walk()`](email.message.md#email.message.EmailMessage.walk "email.message.EmailMessage.walk") method is an all-purpose generator which can be used to
        ...
        [`is_multipart()`](email.message.md#email.message.EmailMessage.is_multipart "email.message.EmailMessage.is_multipart") returns `True`, even though
    ...
    :   If the message is a `multipart/related`, create a new message
        ...
        the message is a non-`multipart`, call [`make_related()`](email.message.md#email.message.EmailMessage.make_related "email.message.EmailMessage.make_related") and then
        proceed as above. If the message is any other type of `multipart`,
        raise a [`TypeError`](exceptions.md#TypeError "TypeError"). If *content_manager* is not specified, use
        the `content_manager` specified by the current [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages").
    ...
    :   If the message is a `multipart/alternative`, create a new message
        ...
        [`make_alternative()`](email.message.md#email.message.EmailMessage.make_alternative "email.message.EmailMessage.make_alternative") and then proceed as above. If the message is
        any other type of `multipart`, raise a [`TypeError`](exceptions.md#TypeError "TypeError"). If
        *content_manager* is not specified, use the `content_manager` specified
        by the current [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages").
    ...
    :   If the message is a `multipart/mixed`, create a new message object,
        ...
        `multipart/alternative`, call [`make_mixed()`](email.message.md#email.message.EmailMessage.make_mixed "email.message.EmailMessage.make_mixed") and then proceed as
        above. If *content_manager* is not specified, use the `content_manager`
        specified by the current [`policy`](email.policy.md#module-email.policy "email.policy: Controlling the parsing and generating of messages"). If the added part
...
[[1](email.message.md#id1)]

Originally added in 3.4 as a [provisional module](https://docs.python.org/3.12/glossary.html#term-provisional-package). Docs for legacy message class moved to
[email.message.Message: Representing an email message using the compat32 API](email.compat32-message.md#compat32-message).
