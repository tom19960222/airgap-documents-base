...
source_url: https://docs.python.org/3.12/library/binascii.html
fetched_at: 2026-09-17T15:33:48+00:00
---
...
use these functions directly but use wrapper modules like [`uu`](uu.md#module-uu "uu: Encode and decode files in uuencode format. (deprecated)") or
[`base64`](base64.md#module-base64 "base64: RFC 4648: Base16, Base32, Base64 Data Encodings; Base85 and Ascii85") instead. The [`binascii`](binascii.md#module-binascii "binascii: Tools for converting between binary and various ASCII-encoded binary representations.") module contains
...
> Other functions only accept [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) (such as
...
:   Convert a block of base64 data back to binary and return the binary data. More
    ...
    data will raise [`binascii.Error`](binascii.md#binascii.Error "binascii.Error").
