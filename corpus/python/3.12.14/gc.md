...
source_url: https://docs.python.org/3.12/library/gc.html
fetched_at: 2026-09-17T15:35:04+00:00
---
...
:   Return a list of objects directly referred to by any of the arguments. The
    ...
    directly reachable. [`tp_traverse`](https://docs.python.org/3.12/c-api/typeobj.html#c.PyTypeObject.tp_traverse "PyTypeObject.tp_traverse") methods are supported only by objects
...
:   A list of objects which the collector found to be unreachable but could
    ...
    Changed in version 3.2: If this list is non-empty at [interpreter shutdown](https://docs.python.org/3.12/glossary.html#term-interpreter-shutdown), a
