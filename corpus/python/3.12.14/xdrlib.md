...
source_url: https://docs.python.org/3.12/library/xdrlib.html
fetched_at: 2026-09-17T15:35:47+00:00
---
# `xdrlib` — Encode and decode XDR data

**Source code:** [Lib/xdrlib.py](https://github.com/python/cpython/tree/3.12/Lib/xdrlib.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`xdrlib`](xdrlib.md#module-xdrlib "xdrlib: Encoders and decoders for the External Data Representation (XDR). (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#xdrlib) for details).

---

The [`xdrlib`](xdrlib.md#module-xdrlib "xdrlib: Encoders and decoders for the External Data Representation (XDR). (deprecated)") module supports the External Data Representation Standard as
described in [**RFC 1014**](https://datatracker.ietf.org/doc/html/rfc1014.html), written by Sun Microsystems, Inc. June 1987. It
supports most of the data types described in the RFC.

The [`xdrlib`](xdrlib.md#module-xdrlib "xdrlib: Encoders and decoders for the External Data Representation (XDR). (deprecated)") module defines two classes, one for packing variables into XDR
...
> **See also:**
>
> [**RFC 1014**](https://datatracker.ietf.org/doc/html/rfc1014.html) - XDR: External Data Representation Standard
> :   This RFC defined the encoding of data which was XDR at the time this module was
>     originally written. It has apparently been obsoleted by [**RFC 1832**](https://datatracker.ietf.org/doc/html/rfc1832.html).
>
> [**RFC 1832**](https://datatracker.ietf.org/doc/html/rfc1832.html) - XDR: External Data Representation Standard
...
In addition, every data type that can be packed with a [`Packer`](xdrlib.md#xdrlib.Packer "xdrlib.Packer"), can be
