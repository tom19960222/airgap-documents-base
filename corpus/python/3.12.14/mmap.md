...
source_url: https://docs.python.org/3.12/library/mmap.html
...
Memory-mapped file objects behave like both [`bytearray`](stdtypes.md#bytearray "bytearray") and like
[file objects](https://docs.python.org/3.12/glossary.html#term-file-object). You can use mmap objects in most places
where [`bytearray`](stdtypes.md#bytearray "bytearray") are expected; for example, you can use the [`re`](re.md#module-re "re: Regular expression operations.")
...
A memory-mapped file is created by the [`mmap`](mmap.md#mmap.mmap "mmap.mmap") constructor, which is
different on Unix and on Windows. In either case you must provide a file
descriptor for a file opened for update. If you wish to map an existing Python
file object, use its [`fileno()`](io.md#io.IOBase.fileno "io.IOBase.fileno") method to obtain the correct value for the
*fileno* parameter. Otherwise, you can open the file using the
[`os.open()`](os.md#os.open "os.open") function, which returns a file descriptor directly (the file
still needs to be closed when done).

> **Note:**
>
> If you want to create a memory-mapping for a writable, buffered file, you
> should [`flush()`](io.md#io.IOBase.flush "io.IOBase.flush") the file first. This is necessary to ensure
...
memory map raises a [`TypeError`](exceptions.md#TypeError "TypeError") exception. Assignment to an
...
:   **(Unix version)** Maps *length* bytes from the file specified by the file
    ...
    [`mmap`](mmap.md#mmap.mmap "mmap.mmap") is called.

    *flags* specifies the nature of the mapping. [`MAP_PRIVATE`](mmap.md#mmap.MAP_PRIVATE "mmap.MAP_PRIVATE") creates a
    private copy-on-write mapping, so changes to the contents of the mmap
    object will be private to this process, and [`MAP_SHARED`](mmap.md#mmap.MAP_SHARED "mmap.MAP_SHARED") creates a
    mapping that’s shared with all other processes mapping the same areas of
    the file. The default value is [`MAP_SHARED`](mmap.md#mmap.MAP_SHARED "mmap.MAP_SHARED"). Some systems have
    additional possible flags with the full list specified in
    [MAP_\* constants](mmap.md#map-constants).
    ...
    *offset* may be specified as a non-negative integer offset. mmap references
    ...
    This example shows a simple way of using [`mmap`](mmap.md#mmap.mmap "mmap.mmap"):
    ...
    [`mmap`](mmap.md#mmap.mmap "mmap.mmap") can also be used as a context manager in a [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with)
    statement:
    ...
    :   Resizes the map and the underlying file, if any. If the mmap was created
        ...
        **On Windows**: Resizing the map will raise an [`OSError`](exceptions.md#OSError "OSError") if there are other
    ...
    :   Write the bytes in *bytes* into memory at the current position of the
        ...
        writing to it will raise a [`TypeError`](exceptions.md#TypeError "TypeError") exception.
...
:   These are the various flags that can be passed to [`mmap.mmap()`](mmap.md#mmap.mmap "mmap.mmap"). [`MAP_ALIGNED_SUPER`](mmap.md#mmap.MAP_ALIGNED_SUPER "mmap.MAP_ALIGNED_SUPER")
    ...
    Changed in version 3.10: Added [`MAP_POPULATE`](mmap.md#mmap.MAP_POPULATE "mmap.MAP_POPULATE") constant.

    Added in version 3.11: Added [`MAP_STACK`](mmap.md#mmap.MAP_STACK "mmap.MAP_STACK") constant.

    Added in version 3.12: Added [`MAP_ALIGNED_SUPER`](mmap.md#mmap.MAP_ALIGNED_SUPER "mmap.MAP_ALIGNED_SUPER") constant.
    Added [`MAP_CONCEAL`](mmap.md#mmap.MAP_CONCEAL "mmap.MAP_CONCEAL") constant.
