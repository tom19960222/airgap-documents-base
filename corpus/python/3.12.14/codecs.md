...
source_url: https://docs.python.org/3.12/library/codecs.html
fetched_at: 2026-09-17T15:32:19+00:00
---
...
are [text encodings](https://docs.python.org/3.12/glossary.html#term-text-encoding), which encode text to bytes (and
...
[text encodings](https://docs.python.org/3.12/glossary.html#term-text-encoding) or with codecs that encode to
...
[text encodings](https://docs.python.org/3.12/glossary.html#term-text-encoding)):
...
:   `encode(input, errors='strict')`
    :   Encodes the object *input* and returns a tuple (output object, length consumed).
        ...
        The method may not store state in the [`Codec`](codecs.md#codecs.Codec "codecs.Codec") instance. Use
...
The [`StreamWriter`](codecs.md#codecs.StreamWriter "codecs.StreamWriter") class is a subclass of [`Codec`](codecs.md#codecs.Codec "codecs.Codec") and defines the
...
The [`StreamReader`](codecs.md#codecs.StreamReader "codecs.StreamReader") class is a subclass of [`Codec`](codecs.md#codecs.Codec "codecs.Codec") and defines the
...
:   Creates a [`StreamRecoder`](codecs.md#codecs.StreamRecoder "codecs.StreamRecoder") instance which implements a two-way conversion:
    *encode* and *decode* work on the frontend — the data visible to
    ...
    adhere to the [`Codec`](codecs.md#codecs.Codec "codecs.Codec") interface. *Reader* and
...
collectivity referred to as [text encodings](https://docs.python.org/3.12/glossary.html#term-text-encoding).
...
[bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) to [`str`](stdtypes.md#str "str") decoding, similar to the Unicode text
encodings.
...
The following codecs provide binary transforms: [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object)
...
| --- | --- | --- | --- |
| base64_codec [[1]](codecs.md#b64) | base64, base_64 | Convert the operand to multiline MIME base64 (the result always includes a trailing `'\n'`).  Changed in version 3.4: accepts any [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) as input for encoding and decoding | [`base64.encodebytes()`](base64.md#base64.encodebytes "base64.encodebytes") / [`base64.decodebytes()`](base64.md#base64.decodebytes "base64.decodebytes") |
...
| uu_codec | uu | Convert the operand using uuencode. | `uu.encode()` / `uu.decode()` (Note: [`uu`](uu.md#module-uu "uu: Encode and decode files in uuencode format. (deprecated)") is deprecated.) |
...
In addition to [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object),
