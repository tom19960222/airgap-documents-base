...
source_url: https://docs.python.org/3.12/library/readline.html
fetched_at: 2026-09-17T15:32:16+00:00
---
...
from the user’s [`PYTHONSTARTUP`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONSTARTUP) file.
...
[interactive mode](https://docs.python.org/3.12/tutorial/interpreter.html#tut-interactive) (see [Readline configuration](site.md#rlcompleter-config)).
