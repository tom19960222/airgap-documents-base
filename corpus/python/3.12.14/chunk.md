...
source_url: https://docs.python.org/3.12/library/chunk.html
fetched_at: 2026-09-17T15:35:37+00:00
---
# `chunk` — Read IFF chunked data

**Source code:** [Lib/chunk.py](https://github.com/python/cpython/tree/3.12/Lib/chunk.py)

Deprecated since version 3.11, will be removed in version 3.13: The [`chunk`](chunk.md#module-chunk "chunk: Module to read IFF chunks. (deprecated)") module is deprecated
(see [**PEP 594**](https://peps.python.org/pep-0594/#chunk) for details).

---

This module provides an interface for reading files that use EA IFF 85 chunks.
[[1]](chunk.md#id2) This format is used in at least the Audio Interchange File Format
...
the [`Chunk`](chunk.md#chunk.Chunk "chunk.Chunk") class defined here is to instantiate an instance at the start
...
:   Class which represents a chunk. The *file* argument is expected to be a
    ...
    [`seek()`](io.md#io.IOBase.seek "io.IOBase.seek") and [`tell()`](io.md#io.IOBase.tell "io.IOBase.tell") are present and don’t
    ...
    *bigendian* is false, the chunk size is assumed to be in little-endian order.
    ...
    The remaining methods will raise [`OSError`](exceptions.md#OSError "OSError") if called after the
