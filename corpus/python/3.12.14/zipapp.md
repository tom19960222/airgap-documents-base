...
source_url: https://docs.python.org/3.12/library/zipapp.html
...
**Source code:** [Lib/zipapp.py](https://github.com/python/cpython/tree/3.12/Lib/zipapp.py)

---

This module provides tools to manage the creation of zip files containing
Python code, which can be [executed directly by the Python interpreter](https://docs.python.org/3.12/using/cmdline.html#using-on-interface-options). The module provides both a
...
:   Create an application archive from *source*. The source can be any
    ...
    - The name of a directory, or a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object) referring
      to a directory, in which case a new application archive will be
      created from the content of that directory.
    - The name of an existing application archive file, or a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object)
    ...
    - If it is the name of a file, or a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object),
