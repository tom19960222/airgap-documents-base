...
source_url: https://docs.python.org/3.12/library/filecmp.html
...
The [`filecmp`](filecmp.md#module-filecmp "filecmp: Compare files efficiently.") module defines functions to compare files and directories,
with various optional time/correctness trade-offs. For comparing files,
see also the [`difflib`](difflib.md#module-difflib "difflib: Helpers for computing differences between objects.") module.
...
:   Compare the files named *f1* and *f2*, returning `True` if they seem equal,
    ...
    If *shallow* is true and the [`os.stat()`](os.md#os.stat "os.stat") signatures (file type, size, and
...
:   Compare the files in the two directories *dir1* and *dir2* whose names are
    ...
    *errors*. *match* contains the list of files that match, *mismatch* contains
    ...
    [`filecmp.cmp()`](filecmp.md#filecmp.cmp "filecmp.cmp").
...
:   Construct a new directory comparison object, to compare the directories *a*
    ...
    The [`dircmp`](filecmp.md#filecmp.dircmp "filecmp.dircmp") class compares files by doing *shallow* comparisons
    as described for [`filecmp.cmp()`](filecmp.md#filecmp.cmp "filecmp.cmp").
    ...
    The [`dircmp`](filecmp.md#filecmp.dircmp "filecmp.dircmp") class offers a number of interesting attributes that may be
    used to get various bits of information about the directory trees being
    compared.

    Note that via [`__getattr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattr__ "object.__getattr__") hooks, all attributes are computed lazily,
    ...
    :   A dictionary mapping names in [`common_dirs`](filecmp.md#filecmp.dircmp.common_dirs "filecmp.dircmp.common_dirs") to [`dircmp`](filecmp.md#filecmp.dircmp "filecmp.dircmp")
        ...
        Changed in version 3.10: Previously entries were always [`dircmp`](filecmp.md#filecmp.dircmp "filecmp.dircmp") instances. Now entries
