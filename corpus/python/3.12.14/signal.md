...
source_url: https://docs.python.org/3.12/library/signal.html
fetched_at: 2026-09-17T15:33:43+00:00
---
...
[virtual machine](https://docs.python.org/3.12/glossary.html#term-virtual-machine) to execute the corresponding Python signal handler
at a later point(for example at the next [bytecode](https://docs.python.org/3.12/glossary.html#term-bytecode) instruction).
...
[`enums`](enum.md#enum.IntEnum "enum.IntEnum") ([`Signals`](signal.md#signal.Signals "signal.Signals"), [`Handlers`](signal.md#signal.Handlers "signal.Handlers") and [`Sigmasks`](signal.md#signal.Sigmasks "signal.Sigmasks") respectively).
...
[`enums`](enum.md#enum.IntEnum "enum.IntEnum") as [`Signals`](signal.md#signal.Signals "signal.Signals") objects.
...
:   Raised to signal an error from the underlying [`setitimer()`](signal.md#signal.setitimer "signal.setitimer") or
    ...
    Added in version 3.3: This error used to be a subtype of [`IOError`](exceptions.md#IOError "IOError"), which is now an
...
:   Set the handler for signal *signalnum* to the function *handler*. *handler* can
    ...
    see the [description in the type hierarchy](https://docs.python.org/3.12/reference/datamodel.html#frame-objects) or see the
...
the main thread and may be raised after any [bytecode](https://docs.python.org/3.12/glossary.html#term-bytecode) instruction. Most
