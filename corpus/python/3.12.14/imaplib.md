...
source_url: https://docs.python.org/3.12/library/imaplib.html
fetched_at: 2026-09-17T15:34:08+00:00
---
# `imaplib` — IMAP4 protocol client

**Source code:** [Lib/imaplib.py](https://github.com/python/cpython/tree/3.12/Lib/imaplib.py)
...
:   This class implements the actual IMAP4 protocol. The connection is created and
    ...
    *port* is omitted, the standard IMAP4 port (143) is used. The optional *timeout*
    ...
    The [`IMAP4`](imaplib.md#imaplib.IMAP4 "imaplib.IMAP4") class supports the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. When used
    ...
    Changed in version 3.5: Support for the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement was added.
