...
source_url: https://docs.python.org/3.12/library/winsound.html
fetched_at: 2026-09-17T15:35:27+00:00
---
...
:   Call the underlying `PlaySound()` function from the Platform API. The
    *sound* parameter may be a filename, a system sound alias, audio data as a
    [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object), or `None`. Its
...
:   The *sound* parameter is an application-specific alias in the registry.
    This flag can be combined with the [`SND_ALIAS`](winsound.md#winsound.SND_ALIAS "winsound.SND_ALIAS") flag
