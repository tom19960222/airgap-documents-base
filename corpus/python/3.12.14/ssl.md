...
source_url: https://docs.python.org/3.12/library/ssl.html
fetched_at: 2026-09-17T15:33:40+00:00
---
...
[`SSLContext.wrap_socket()`](ssl.md#ssl.SSLContext.wrap_socket "ssl.SSLContext.wrap_socket") method. The helper function
...
:   Given the address `addr` of an SSL-protected server, as a (*hostname*,
    *port-number*) pair, fetches the server’s certificate, and returns it as a
    ...
    [`SSLContext.load_verify_locations()`](ssl.md#ssl.SSLContext.load_verify_locations "ssl.SSLContext.load_verify_locations"). The call will attempt to validate the
...
:   Returns a named tuple with paths to OpenSSL’s default cafile and capath.
    ...
    [named tuple](https://docs.python.org/3.12/glossary.html#term-named-tuple) `DefaultVerifyPaths`:
...
:   If there is no certificate for the peer on the other end of the connection,
    ...
    See also [`SSLContext.check_hostname`](ssl.md#ssl.SSLContext.check_hostname "ssl.SSLContext.check_hostname").
...
:   Create a new SSL context. You may pass *protocol* which must be one
    ...
    [`OP_NO_SSLv2`](ssl.md#ssl.OP_NO_SSLv2 "ssl.OP_NO_SSLv2"),
    ...
    > **Note:**
    >
    > [`SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") only supports limited mutation once it has been used
    ...
    > **Note:**
    >
    > [`SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext") is designed to be shared and used by multiple
    > connections.
...
:   Load a set of “certification authority” (CA) certificates used to validate
    ...
    PEM-encoded certificates or a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) of DER-encoded
...
:   Wrap an existing Python socket *sock* and return an instance of
    ...
    *session*, see [`session`](ssl.md#ssl.SSLSocket.session "ssl.SSLSocket.session").
    ...
    To wrap an [`SSLSocket`](ssl.md#ssl.SSLSocket "ssl.SSLSocket") in another [`SSLSocket`](ssl.md#ssl.SSLSocket "ssl.SSLSocket"), use
    [`SSLContext.wrap_bio()`](ssl.md#ssl.SSLContext.wrap_bio "ssl.SSLContext.wrap_bio").
...
> **See also:**
>
> The [`asyncio`](asyncio.md#module-asyncio "asyncio: Asynchronous I/O.") module supports [non-blocking SSL sockets](ssl.md#ssl-nonblocking) and provides a higher level [Streams API](asyncio-stream.md#asyncio-streams).
> It polls for events using the [`selectors`](selectors.md#module-selectors "selectors: High-level I/O multiplexing.") module and
...
:   A reduced-scope variant of [`SSLSocket`](ssl.md#ssl.SSLSocket "ssl.SSLSocket") representing an SSL protocol
    ...
    Changed in version 3.7: [`SSLObject`](ssl.md#ssl.SSLObject "ssl.SSLObject") instances must be created with
...
[`SSLContext.check_hostname`](ssl.md#ssl.SSLContext.check_hostname "ssl.SSLContext.check_hostname") is enabled.
...
successful call of [`RAND_add()`](ssl.md#ssl.RAND_add "ssl.RAND_add") or [`RAND_bytes()`](ssl.md#ssl.RAND_bytes "ssl.RAND_bytes") is
sufficient.
