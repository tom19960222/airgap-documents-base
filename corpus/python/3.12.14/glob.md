...
source_url: https://docs.python.org/3.12/library/glob.html
...
:   Return a possibly empty list of path names that match *pathname*, which must be
    ...
    If *root_dir* is not `None`, it should be a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object)
