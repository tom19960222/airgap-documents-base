...
source_url: https://docs.python.org/3.12/library/mailbox.html
fetched_at: 2026-09-17T15:33:46+00:00
---
...
`Message` extends the [`email.message`](email.message.md#module-email.message "email.message: The base class representing email messages.") module’s
...
:   A mailbox, which may be inspected and modified.
    ...
    The default `Mailbox` [iterator](https://docs.python.org/3.12/glossary.html#term-iterator) iterates over message
    representations, not keys as the default [`dictionary`](stdtypes.md#dict "dict")
    ...
    > tasks is [`Maildir`](mailbox.md#mailbox.Maildir "mailbox.Maildir"); try to avoid using single-file formats such as
    > [`mbox`](mailbox.md#mailbox.mbox "mailbox.mbox") for
    ...
    :   Return a [file-like](https://docs.python.org/3.12/glossary.html#term-file-like-object) representation of the
        ...
        Changed in version 3.2: The file object really is a [binary file](https://docs.python.org/3.12/glossary.html#term-binary-file); previously it was
        incorrectly returned in text mode. Also, the [file-like object](https://docs.python.org/3.12/glossary.html#term-file-like-object)
        now supports the [context manager](https://docs.python.org/3.12/glossary.html#term-context-manager) protocol: you can use a
        [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement to automatically close it.

        > **Note:**
        >
        > Unlike other representations of messages,
        > [file-like](https://docs.python.org/3.12/glossary.html#term-file-like-object) representations are not
...
[`MMDFMessage`](mailbox.md#mailbox.MMDFMessage "mailbox.MMDFMessage")
