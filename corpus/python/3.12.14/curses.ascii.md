...
source_url: https://docs.python.org/3.12/library/curses.ascii.html
fetched_at: 2026-09-17T15:33:23+00:00
---
# `curses.ascii` — Utilities for ASCII characters

**Source code:** [Lib/curses/ascii.py](https://github.com/python/cpython/tree/3.12/Lib/curses/ascii.py)

---

The [`curses.ascii`](curses.ascii.md#module-curses.ascii "curses.ascii: Constants and set-membership functions for ASCII characters.") module supplies name constants for ASCII characters and
...
string, it is first converted using the built-in function [`ord()`](functions.md#ord "ord").
