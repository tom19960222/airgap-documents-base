...
source_url: https://docs.python.org/3.12/library/hmac.html
...
:   Return `a == b`. This function uses an approach designed to prevent
    ...
    [`HMAC.hexdigest()`](hmac.md#hmac.HMAC.hexdigest "hmac.HMAC.hexdigest")), or a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object).
