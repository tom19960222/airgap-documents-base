...
source_url: https://docs.python.org/3.12/library/email.parser.html
fetched_at: 2026-09-17T15:36:02+00:00
---
...
[`EmailMessage`](email.message.md#email.message.EmailMessage "email.message.EmailMessage") class is embodied in the [`Policy`](email.policy.md#email.policy.Policy "email.policy.Policy")
...
object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object), string, or file, but the [`BytesParser`](email.parser.md#email.parser.BytesParser "email.parser.BytesParser") API may be more
...
of the message are available in a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or file. The
...
- Some non-standards-compliant messages may not be internally consistent about
  ...
  *Content-Type* header of type *multipart*, but their
  ...
  [`MultipartInvariantViolationDefect`](email.errors.md#email.errors.MultipartInvariantViolationDefect "email.errors.MultipartInvariantViolationDefect") class in their
