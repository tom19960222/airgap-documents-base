...
version: "3.12.14"
title: "Policies"
source_url: https://docs.python.org/3.12/library/asyncio-policy.html
...
The default policy can be [replaced](asyncio-policy.md#asyncio-policy-get-set) with
[built-in alternatives](asyncio-policy.md#asyncio-policy-builtin)
to use different event loop implementations,
or substituted by a [custom policy](asyncio-policy.md#asyncio-custom-policies)
that can override these behaviors.

The [policy object](asyncio-policy.md#asyncio-policy-objects)
...
[`get_event_loop()`](asyncio-eventloop.md#asyncio.get_event_loop "asyncio.get_event_loop"), [`set_event_loop()`](asyncio-eventloop.md#asyncio.set_event_loop "asyncio.set_event_loop"), and [`new_event_loop()`](asyncio-eventloop.md#asyncio.new_event_loop "asyncio.new_event_loop").

Policy objects should implement the APIs defined
in the [`AbstractEventLoopPolicy`](asyncio-policy.md#asyncio.AbstractEventLoopPolicy "asyncio.AbstractEventLoopPolicy") abstract base class.
...
:   An abstract base class for asyncio policies.
    ...
    :   Get the event loop for the current context.
        ...
        [`AbstractEventLoop`](asyncio-eventloop.md#asyncio.AbstractEventLoop "asyncio.AbstractEventLoop") interface.
    ...
    :   Get a child process watcher object.
        ...
        [`AbstractChildWatcher`](asyncio-policy.md#asyncio.AbstractChildWatcher "asyncio.AbstractChildWatcher") interface.
...
:   The default asyncio policy. Uses [`SelectorEventLoop`](asyncio-eventloop.md#asyncio.SelectorEventLoop "asyncio.SelectorEventLoop")
    ...
    Changed in version 3.8: On Windows, [`ProactorEventLoop`](asyncio-eventloop.md#asyncio.ProactorEventLoop "asyncio.ProactorEventLoop") is now used by default.

    Deprecated since version 3.12: The [`get_event_loop()`](asyncio-eventloop.md#asyncio.get_event_loop "asyncio.get_event_loop") method of the default asyncio policy now emits
    a [`DeprecationWarning`](exceptions.md#DeprecationWarning "DeprecationWarning") if there is no current event loop set and it
...
[`create_subprocess_exec()`](asyncio-subprocess.md#asyncio.create_subprocess_exec "asyncio.create_subprocess_exec") and [`loop.subprocess_exec()`](asyncio-eventloop.md#asyncio.loop.subprocess_exec "asyncio.loop.subprocess_exec")
functions.

asyncio defines the [`AbstractChildWatcher`](asyncio-policy.md#asyncio.AbstractChildWatcher "asyncio.AbstractChildWatcher") abstract base class, which child
watchers should implement, and has four different implementations:
[`ThreadedChildWatcher`](asyncio-policy.md#asyncio.ThreadedChildWatcher "asyncio.ThreadedChildWatcher") (configured to be used by default),
[`MultiLoopChildWatcher`](asyncio-policy.md#asyncio.MultiLoopChildWatcher "asyncio.MultiLoopChildWatcher"), [`SafeChildWatcher`](asyncio-policy.md#asyncio.SafeChildWatcher "asyncio.SafeChildWatcher"), and
[`FastChildWatcher`](asyncio-policy.md#asyncio.FastChildWatcher "asyncio.FastChildWatcher").
...
:   This implementation uses active event loop from the main thread to handle
    ...
    This solution is as safe as [`MultiLoopChildWatcher`](asyncio-policy.md#asyncio.MultiLoopChildWatcher "asyncio.MultiLoopChildWatcher") and has the same *O*(*n*)
...
:   This implementation reaps every terminated processes by calling
    ...
    [`SafeChildWatcher`](asyncio-policy.md#asyncio.SafeChildWatcher "asyncio.SafeChildWatcher").
...
[`DefaultEventLoopPolicy`](asyncio-policy.md#asyncio.DefaultEventLoopPolicy "asyncio.DefaultEventLoopPolicy") and override the methods for which
