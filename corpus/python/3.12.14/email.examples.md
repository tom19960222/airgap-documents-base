...
source_url: https://docs.python.org/3.12/library/email.examples.html
fetched_at: 2026-09-17T15:36:06+00:00
---
# [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages."): Examples

Here are a few examples of how to use the [`email`](email.md#module-email "email: Package supporting the parsing, manipulating, and generating email messages.") package to read, write,
...
from the [`parser`](email.parser.md#module-email.parser "email.parser: Parse flat text email messages to produce a message object structure.") module:
...
message: [[1]](email.examples.md#id3)
