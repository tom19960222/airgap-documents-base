...
source_url: https://docs.python.org/3.12/library/zipfile.html
fetched_at: 2026-09-17T15:33:02+00:00
---
# `zipfile` — Work with ZIP archives

**Source code:** [Lib/zipfile/](https://github.com/python/cpython/tree/3.12/Lib/zipfile/)
...
:   Open a ZIP file, where *file* can be a path to a file (a string), a
    ...
    a [`FileExistsError`](exceptions.md#FileExistsError "FileExistsError") will be raised.
    ...
    *compression* is the ZIP compression method to use when writing the archive,
    and should be [`ZIP_STORED`](zipfile.md#zipfile.ZIP_STORED "zipfile.ZIP_STORED"), [`ZIP_DEFLATED`](zipfile.md#zipfile.ZIP_DEFLATED "zipfile.ZIP_DEFLATED"),
    [`ZIP_BZIP2`](zipfile.md#zipfile.ZIP_BZIP2 "zipfile.ZIP_BZIP2") or [`ZIP_LZMA`](zipfile.md#zipfile.ZIP_LZMA "zipfile.ZIP_LZMA"); unrecognized
    values will cause [`NotImplementedError`](exceptions.md#NotImplementedError "NotImplementedError") to be raised. If
    [`ZIP_DEFLATED`](zipfile.md#zipfile.ZIP_DEFLATED "zipfile.ZIP_DEFLATED"), [`ZIP_BZIP2`](zipfile.md#zipfile.ZIP_BZIP2 "zipfile.ZIP_BZIP2") or [`ZIP_LZMA`](zipfile.md#zipfile.ZIP_LZMA "zipfile.ZIP_LZMA") is specified
    but the corresponding module ([`zlib`](zlib.md#module-zlib "zlib: Low-level interface to compression and decompression routines compatible with gzip."), [`bz2`](bz2.md#module-bz2 "bz2: Interfaces for bzip2 compression and decompression.") or [`lzma`](lzma.md#module-lzma "lzma: A Python wrapper for the liblzma compression library.")) is not
    available, [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") is raised. The default is [`ZIP_STORED`](zipfile.md#zipfile.ZIP_STORED "zipfile.ZIP_STORED").
    ...
    `false` [`zipfile`](zipfile.md#module-zipfile "zipfile: Read and write ZIP-format archive files.") will raise an exception when the ZIP file would
    require ZIP64 extensions.

    The *compresslevel* parameter controls the compression level to use when
    writing files to the archive.
    When using [`ZIP_STORED`](zipfile.md#zipfile.ZIP_STORED "zipfile.ZIP_STORED") or [`ZIP_LZMA`](zipfile.md#zipfile.ZIP_LZMA "zipfile.ZIP_LZMA") it has no effect.
    When using [`ZIP_DEFLATED`](zipfile.md#zipfile.ZIP_DEFLATED "zipfile.ZIP_DEFLATED") integers `0` through `9` are accepted
    (see [`zlib`](zlib.md#zlib.compressobj "zlib.compressobj") for more information).
    When using [`ZIP_BZIP2`](zipfile.md#zipfile.ZIP_BZIP2 "zipfile.ZIP_BZIP2") integers `1` through `9` are accepted
    (see [`bz2`](bz2.md#bz2.BZ2File "bz2.BZ2File") for more information).
    ...
    [`closed`](zipfile.md#zipfile.ZipFile.close "zipfile.ZipFile.close") without adding any files to the archive, the appropriate
    ZIP structures for an empty archive will be written to the file.

    ZipFile is also a context manager and therefore supports the
    [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. In the example, *myzip* is closed after the
    ...
    Changed in version 3.2: Added the ability to use [`ZipFile`](zipfile.md#zipfile.ZipFile "zipfile.ZipFile") as a context manager.

    Changed in version 3.3: Added support for [`bzip2`](bz2.md#module-bz2 "bz2: Interfaces for bzip2 compression and decompression.") and [`lzma`](lzma.md#module-lzma "lzma: A Python wrapper for the liblzma compression library.") compression.
    ...
    Changed in version 3.6: Previously, a plain [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") was raised for unrecognized
    compression values.

    Changed in version 3.6.2: The *file* parameter accepts a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object).
...
:   Access a member of the archive as a binary file-like object. *name*
    ...
    [`open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open") is also a context manager and therefore supports the
    ...
    [`read()`](io.md#io.BufferedIOBase.read "io.BufferedIOBase.read"), [`readline()`](io.md#io.IOBase.readline "io.IOBase.readline"),
    [`readlines()`](io.md#io.IOBase.readlines "io.IOBase.readlines"), [`seek()`](io.md#io.IOBase.seek "io.IOBase.seek"),
    [`tell()`](io.md#io.IOBase.tell "io.IOBase.tell"), [`__iter__()`](stdtypes.md#container.__iter__ "container.__iter__"), [`__next__()`](stdtypes.md#iterator.__next__ "iterator.__next__").
    These objects can operate independently of the ZipFile.

    With `mode='w'`, a writable file handle is returned, which supports the
    [`write()`](io.md#io.BufferedIOBase.write "io.BufferedIOBase.write") method. While a writable file handle is open,
    ...
    construct a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") object with [`file_size`](zipfile.md#zipfile.ZipInfo.file_size "zipfile.ZipInfo.file_size") set, and
    use that as the *name* parameter.

    > **Note:**
    >
    > The [`open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open"), [`read()`](zipfile.md#zipfile.ZipFile.read "zipfile.ZipFile.read") and [`extract()`](zipfile.md#zipfile.ZipFile.extract "zipfile.ZipFile.extract") methods can take a filename
    > or a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") object. You will appreciate this when trying to read a
    > ZIP file that contains members with duplicate names.

    Changed in version 3.6: Removed support of `mode='U'`. Use [`io.TextIOWrapper`](io.md#io.TextIOWrapper "io.TextIOWrapper") for reading
    compressed text files in [universal newlines](https://docs.python.org/3.12/glossary.html#term-universal-newlines) mode.

    Changed in version 3.6: [`ZipFile.open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open") can now be used to write files into the archive with the
    `mode='w'` option.
...
:   Extract a member from the archive to the current working directory; *member*
    ...
    to extract to. *member* can be a filename or a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") object.
    *pwd* is the password used for encrypted files as a [`bytes`](stdtypes.md#bytes "bytes") object.
    ...
    Changed in version 3.6: Calling [`extract()`](zipfile.md#zipfile.ZipFile.extract "zipfile.ZipFile.extract") on a closed ZipFile will raise a
...
:   Extract all members from the archive to the current working directory. *path*
    ...
    used for encrypted files as a [`bytes`](stdtypes.md#bytes "bytes") object.
    ...
    > See [`extract()`](zipfile.md#zipfile.ZipFile.extract "zipfile.ZipFile.extract") note.

    Changed in version 3.6: Calling [`extractall()`](zipfile.md#zipfile.ZipFile.extractall "zipfile.ZipFile.extractall") on a closed ZipFile will raise a
    [`ValueError`](exceptions.md#ValueError "ValueError"). Previously, a [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") was raised.
...
:   Return the bytes of the file *name* in the archive. *name* is the name of the
    ...
    object and, if specified, overrides the default password set with [`setpassword()`](zipfile.md#zipfile.ZipFile.setpassword "zipfile.ZipFile.setpassword").
    Calling [`read()`](zipfile.md#zipfile.ZipFile.read "zipfile.ZipFile.read") on a ZipFile that uses a compression method other than
    [`ZIP_STORED`](zipfile.md#zipfile.ZIP_STORED "zipfile.ZIP_STORED"), [`ZIP_DEFLATED`](zipfile.md#zipfile.ZIP_DEFLATED "zipfile.ZIP_DEFLATED"), [`ZIP_BZIP2`](zipfile.md#zipfile.ZIP_BZIP2 "zipfile.ZIP_BZIP2") or
    [`ZIP_LZMA`](zipfile.md#zipfile.ZIP_LZMA "zipfile.ZIP_LZMA") will raise a [`NotImplementedError`](exceptions.md#NotImplementedError "NotImplementedError"). An error will also
...
:   Write the file named *filename* to the archive, giving it the archive name
    *arcname* (by default, this will be the same as *filename*, but without a drive
    ...
    Changed in version 3.6: Calling [`write()`](zipfile.md#zipfile.ZipFile.write "zipfile.ZipFile.write") on a ZipFile created with mode `'r'` or
...
:   Write a file into the archive. The contents is *data*, which may be either
    ...
    name it will be given in the archive, or a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance. If it’s
    ...
    (if that is a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance). Similarly, *compresslevel* will
    override the constructor if given.

    > **Note:**
    >
    > When passing a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance as the *zinfo_or_arcname* parameter,
    > the compression method used will be that specified in the *compress_type*
    > member of the given [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance. By default, the
    > [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") constructor sets this member to [`ZIP_STORED`](zipfile.md#zipfile.ZIP_STORED "zipfile.ZIP_STORED").

    Changed in version 3.2: The *compress_type* argument.

    Changed in version 3.6: Calling [`writestr()`](zipfile.md#zipfile.ZipFile.writestr "zipfile.ZipFile.writestr") on a ZipFile created with mode `'r'` or
    a closed ZipFile will raise a [`ValueError`](exceptions.md#ValueError "ValueError"). Previously,
    a [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") was raised.
...
:   Create a directory inside the archive. If *zinfo_or_directory* is a string,
    ...
    a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance then the *mode* argument is ignored.
...
:   Construct a Path object from a `root` zipfile (which may be a
    ...
    > **Note:**
    >
    > The [`Path`](zipfile.md#zipfile.Path "zipfile.Path") class does not sanitize filenames within the ZIP archive. Unlike
    > the [`ZipFile.extract()`](zipfile.md#zipfile.ZipFile.extract "zipfile.ZipFile.extract") and [`ZipFile.extractall()`](zipfile.md#zipfile.ZipFile.extractall "zipfile.ZipFile.extractall") methods, it is the
    ...
    > untrusted archives, consider resolving filenames using [`os.path.abspath()`](os.path.md#os.path.abspath "os.path.abspath")
    > and checking against the target directory with [`os.path.commonpath()`](os.path.md#os.path.commonpath "os.path.commonpath").

Path objects expose the following features of [`pathlib.Path`](pathlib.md#pathlib.Path "pathlib.Path")
objects:
...
:   Invoke [`ZipFile.open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open") on the current path.
    ...
    [`io.TextIOWrapper`](io.md#io.TextIOWrapper "io.TextIOWrapper") when opened as text and
    ignored otherwise.
    `pwd` is the `pwd` parameter to
    [`ZipFile.open()`](zipfile.md#zipfile.ZipFile.open "zipfile.ZipFile.open").
    ...
    without causing a [`TypeError`](exceptions.md#TypeError "TypeError"). As it could in 3.9. Code needing to
...
:   Changed in version 3.2: Added the *optimize* parameter.
    ...
    :   Search for files `*.py` and add the corresponding file to the
        ...
        If the *optimize* parameter to [`PyZipFile`](zipfile.md#zipfile.PyZipFile "zipfile.PyZipFile") was not given or `-1`,
        the corresponding file is a `*.pyc` file, compiling if necessary.

        If the *optimize* parameter to [`PyZipFile`](zipfile.md#zipfile.PyZipFile "zipfile.PyZipFile") was `0`, `1` or
        `2`, only files with that optimization level (see [`compile()`](functions.md#compile "compile")) are
        ...
        `.py`, a [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError") will be raised. If it is a directory,
        ...
        *filterfunc* to exclude them:
        ...
        The [`writepy()`](zipfile.md#zipfile.PyZipFile.writepy "zipfile.PyZipFile.writepy") method makes archives with file names like
        this:
        ...
        Changed in version 3.6.2: The *pathname* parameter accepts a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object).

        Changed in version 3.7: Recursion sorts directory entries.

## ZipInfo Objects

Instances of the [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") class are returned by the [`getinfo()`](zipfile.md#zipfile.ZipFile.getinfo "zipfile.ZipFile.getinfo") and
[`infolist()`](zipfile.md#zipfile.ZipFile.infolist "zipfile.ZipFile.infolist") methods of [`ZipFile`](zipfile.md#zipfile.ZipFile "zipfile.ZipFile") objects. Each object stores
...
:   Construct a [`ZipInfo`](zipfile.md#zipfile.ZipInfo "zipfile.ZipInfo") instance for a file on the filesystem, in
    ...
    *filename* should be the path to a file or directory on the filesystem.
    ...
    Changed in version 3.6.2: The *filename* parameter accepts a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object).
...
The [`zipfile`](zipfile.md#module-zipfile "zipfile: Read and write ZIP-format archive files.") module provides a simple command-line interface to interact
with ZIP archives.

If you want to create a new ZIP archive, specify its name after the [`-c`](zipfile.md#cmdoption-zipfile-c)
...
the [`-e`](zipfile.md#cmdoption-zipfile-e) option:

```shell-session
$ python -m zipfile -e monty.zip target-dir/
```

For a list of the files in a ZIP archive, use the [`-l`](zipfile.md#cmdoption-zipfile-l) option:
