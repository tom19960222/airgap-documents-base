...
source_url: https://docs.python.org/3.12/library/ftplib.html
...
This module defines the class [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") and a few related items. The
[`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") class implements the client side of the FTP protocol. You can use
this to write Python programs that perform a variety of automated FTP jobs, such
as mirroring other FTP servers. It is also used by the module
[`urllib.request`](urllib.request.md#module-urllib.request "urllib.request: Extensible library for opening URLs.") to handle URLs that use FTP. For more information on FTP
...
Here’s a sample session using the [`ftplib`](ftplib.md#module-ftplib "ftplib: FTP protocol client (requires sockets).") module:
...
:   Return a new instance of the [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") class.
    ...
    Parameters:
    :   - **host** ([*str*](stdtypes.md#str "str")) – The hostname to connect to.
          If given, `connect(host)` is implicitly called by the constructor.
        - **user** ([*str*](stdtypes.md#str "str")) – The username to log in with (default: `'anonymous'`).
          If given, `login(host, passwd, acct)` is implicitly called
          by the constructor.
        - **passwd** ([*str*](stdtypes.md#str "str")) – The password to use when logging in.
          If not given, and if *passwd* is the empty string or `"-"`,
          a password will be automatically generated.
        - **acct** ([*str*](stdtypes.md#str "str")) – Account information to be used for the `ACCT` FTP command.
          Few systems implement this.
          See [RFC-959](https://datatracker.ietf.org/doc/html/rfc959.html)
          for more details.
        - **timeout** ([*float*](functions.md#float "float") *|* *None*) – A timeout in seconds for blocking operations like [`connect()`](ftplib.md#ftplib.FTP.connect "ftplib.FTP.connect")
          (default: the global default timeout setting).
        - **source_address** ([*tuple*](stdtypes.md#tuple "tuple") *|* *None*) – A 2-tuple `(host, port)` for the socket to bind to as its
          source address before connecting.
        - **encoding** ([*str*](stdtypes.md#str "str")) – The encoding for directories and filenames (default: `'utf-8'`).

    The [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") class supports the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement, e.g.:
    ...
    Changed in version 3.2: Support for the [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement was added.
    ...
    :   Connect to the given host and port.
        ...
        when the [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") instance was created.
        All other `FTP` methods can only be called
        after a connection has successfully been made.

        Parameters:
        :   - **host** ([*str*](stdtypes.md#str "str")) – The host to connect to.
            - **port** ([*int*](functions.md#int "int")) – The TCP port to connect to (default: `21`,
              as specified by the FTP protocol specification).
              It is rarely needed to specify a different port number.
            - **timeout** ([*float*](functions.md#float "float") *|* *None*) – A timeout in seconds for the connection attempt
              (default: the global default timeout setting).
            - **source_address** ([*tuple*](stdtypes.md#tuple "tuple") *|* *None*) – A 2-tuple `(host, port)` for the socket to bind to as its
              source address before connecting.
    ...
    :   Retrieve a file in binary transfer mode.
        ...
        Parameters:
        :   - **cmd** ([*str*](stdtypes.md#str "str")) – An appropriate `RETR` command: `"RETR filename"`.
            - **callback** ([callable](https://docs.python.org/3.12/glossary.html#term-callable)) – A single parameter callable that is called
              for each block of data received,
              with its single argument being the data as [`bytes`](stdtypes.md#bytes "bytes").
            - **blocksize** ([*int*](functions.md#int "int")) – The maximum chunk size to read on the low-level
              [`socket`](socket.md#socket.socket "socket.socket") object created to do the actual transfer.
    ...
    :   Store a file in binary transfer mode.
        ...
        Parameters:
        :   - **cmd** ([*str*](stdtypes.md#str "str")) – An appropriate `STOR` command: `"STOR filename"`.
            - **fp** ([file object](https://docs.python.org/3.12/glossary.html#term-file-object)) – A file object (opened in binary mode) which is read until EOF,
              using its [`read()`](io.md#io.RawIOBase.read "io.RawIOBase.read") method in blocks of size *blocksize*
              to provide the data to be stored.
            - **blocksize** ([*int*](functions.md#int "int")) – The read block size.
              Defaults to `8192`.
            - **callback** ([callable](https://docs.python.org/3.12/glossary.html#term-callable)) – A single parameter callable that is called
    ...
    :   Initiate a transfer over the data connection. If the transfer is active, send an
        ...
        *rest* as an argument. *rest* is usually a byte offset into the requested file,
        ...
        skipping over the initial bytes. Note however that the [`transfercmd()`](ftplib.md#ftplib.FTP.transfercmd "ftplib.FTP.transfercmd")
        ...
        server does not recognize the `REST` command, an [`error_reply`](ftplib.md#ftplib.error_reply "ftplib.error_reply") exception
    ...
    :   Produce a directory listing as returned by the `LIST` command, printing it to
        ...
        as a *callback* function as for [`retrlines()`](ftplib.md#ftplib.FTP.retrlines "ftplib.FTP.retrlines"); the default prints to
        [`sys.stdout`](sys.md#sys.stdout "sys.stdout"). This method returns `None`.
    ...
    :   Close the connection unilaterally. This should not be applied to an already
        ...
        a call to [`close()`](ftplib.md#ftplib.FTP.close "ftplib.FTP.close") or [`quit()`](ftplib.md#ftplib.FTP.quit "ftplib.FTP.quit") you cannot reopen the
        connection by issuing another [`login()`](ftplib.md#ftplib.FTP.login "ftplib.FTP.login") method).
...
:   An [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP") subclass which adds TLS support to FTP as described in
    ...
    > by calling the [`prot_p()`](ftplib.md#ftplib.FTP_TLS.prot_p "ftplib.FTP_TLS.prot_p") method.
    ...
    :   - **host** ([*str*](stdtypes.md#str "str")) – The hostname to connect to.
        ...
        - **acct** ([*str*](stdtypes.md#str "str")) – Account information to be used for the `ACCT` FTP command.
          ...
          See [RFC-959](https://datatracker.ietf.org/doc/html/rfc959.html)
          for more details.
        - **context** ([`ssl.SSLContext`](ssl.md#ssl.SSLContext "ssl.SSLContext")) – An SSL context object which allows bundling SSL configuration options,
    ...
    Here’s a sample session using the [`FTP_TLS`](ftplib.md#ftplib.FTP_TLS "ftplib.FTP_TLS") class:
...
:   The set of all exceptions (as a tuple) that methods of [`FTP`](ftplib.md#ftplib.FTP "ftplib.FTP")
    ...
    four exceptions listed above as well as [`OSError`](exceptions.md#OSError "OSError") and [`EOFError`](exceptions.md#EOFError "EOFError").

> **See also:**
>
> Module [`netrc`](netrc.md#module-netrc "netrc: Loading of .netrc files.")
