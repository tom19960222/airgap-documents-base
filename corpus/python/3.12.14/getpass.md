...
source_url: https://docs.python.org/3.12/library/getpass.html
fetched_at: 2026-09-17T15:33:21+00:00
---
# `getpass` — Portable password input

**Source code:** [Lib/getpass.py](https://github.com/python/cpython/tree/3.12/Lib/getpass.py)
...
:   Prompt the user for a password without echoing. The user is prompted using
    ...
    issuing a [`GetPassWarning`](getpass.md#getpass.GetPassWarning "getpass.GetPassWarning").
...
:   Return the “login name” of the user.
    ...
    systems which support the [`pwd`](pwd.md#module-pwd "pwd: The password database (getpwnam() and friends). (Unix)") module, otherwise, an exception is
    raised.

    In general, this function should be preferred over [`os.getlogin()`](os.md#os.getlogin "os.getlogin").
