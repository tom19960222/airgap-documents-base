...
source_url: https://docs.python.org/3.12/library/pkgutil.html
fetched_at: 2026-09-17T15:35:09+00:00
---
# `pkgutil` — Package extension utility

**Source code:** [Lib/pkgutil.py](https://github.com/python/cpython/tree/3.12/Lib/pkgutil.py)
...
:   Extend the search path for the modules which comprise a package. Intended
    ...
    For each directory on [`sys.path`](sys.md#sys.path "sys.path") that has a subdirectory that matches the
    package name, add the subdirectory to the package’s
    [`__path__`](https://docs.python.org/3.12/reference/datamodel.html#module.__path__ "module.__path__"). This is useful
...
:   Yields [`ModuleInfo`](pkgutil.md#pkgutil.ModuleInfo "pkgutil.ModuleInfo") for all submodules on *path*, or, if
    ...
    *prefix* is a string to output on the front of every module name on output.
    ...
    > **Note:**
    >
    > Only works for a [finder](https://docs.python.org/3.12/glossary.html#term-finder) which defines an `iter_modules()`
...
:   Get a resource from a package.
    ...
    *package* argument should be the name of a package, in standard module format
    ...
    If the package cannot be located or loaded, or it uses a [loader](https://docs.python.org/3.12/glossary.html#term-loader)
    which does not support [`get_data`](importlib.md#importlib.abc.ResourceLoader.get_data "importlib.abc.ResourceLoader.get_data"),
    then `None` is returned. In particular, the [loader](https://docs.python.org/3.12/glossary.html#term-loader) for
