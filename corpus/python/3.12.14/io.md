...
source_url: https://docs.python.org/3.12/library/io.html
fetched_at: 2026-09-17T15:33:13+00:00
---
# `io` — Core tools for working with streams

**Source code:** [Lib/io.py](https://github.com/python/cpython/tree/3.12/Lib/io.py)
...
categories is called a [file object](https://docs.python.org/3.12/glossary.html#term-file-object). Other common terms are *stream*
...
[bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) and produces [`bytes`](stdtypes.md#bytes "bytes")
...
locale-specific ([`locale.getencoding()`](locale.md#locale.getencoding "locale.getencoding")).
...
the [`-X warn_default_encoding`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-X) command line option or set the
[`PYTHONWARNDEFAULTENCODING`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONWARNDEFAULTENCODING) environment variable, which will
...
:   Opens the provided file with mode `'rb'`. This function should be used
    ...
    *path* should be a [`str`](stdtypes.md#str "str") and an absolute path.
    ...
    [`PyFile_SetOpenCodeHook()`](https://docs.python.org/3.12/c-api/file.html#c.PyFile_SetOpenCodeHook "PyFile_SetOpenCodeHook"). However, assuming that *path* is a
...
[abstract base classes](https://docs.python.org/3.12/glossary.html#term-abstract-base-class) (ABCs), which are used to
...
:   The abstract base class for all I/O classes.
    ...
    [`bytes`](stdtypes.md#bytes "bytes"). Other [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) are
    ...
    [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement. In this example, *file* is closed after the
    ...
    :   Change the stream position to the given byte *offset*,
        ...
        - [`os.SEEK_SET`](os.md#os.SEEK_SET "os.SEEK_SET") or `0` – start of the stream (the default);
          *offset* should be zero or positive
        - [`os.SEEK_CUR`](os.md#os.SEEK_CUR "os.SEEK_CUR") or `1` – current stream position;
          *offset* may be negative
        - [`os.SEEK_END`](os.md#os.SEEK_END "os.SEEK_END") or `2` – end of the stream;
...
:   A raw binary stream representing an OS-level file containing bytes data. It
    ...
    The [`read()`](io.md#io.RawIOBase.read "io.RawIOBase.read") (when called with a positive argument),
    [`readinto()`](io.md#io.RawIOBase.readinto "io.RawIOBase.readinto") and [`write()`](io.md#io.RawIOBase.write "io.RawIOBase.write") methods on this
...
:   A binary stream using an in-memory bytes buffer. It inherits from
    ...
    The optional argument *initial_bytes* is a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) that
...
:   A buffered binary stream providing higher-level access to a writeable, non
    ...
    - when a [`seek()`](io.md#io.IOBase.seek "io.IOBase.seek") is requested (for [`BufferedRandom`](io.md#io.BufferedRandom "io.BufferedRandom") objects);
...
:   A buffered text stream providing higher-level access to a
    ...
    *encoding* gives the name of the encoding that the stream will be decoded or
    encoded with. It defaults to [`locale.getencoding()`](locale.md#locale.getencoding "locale.getencoding").
    ...
    *newline* controls how line endings are handled. It can be `None`,
    ...
    - When reading input from the stream, if *newline* is `None`,
      [universal newlines](https://docs.python.org/3.12/glossary.html#term-universal-newlines) mode is enabled. Lines in the input can end in
    ...
    If *line_buffering* is `True`, [`flush()`](io.md#io.IOBase.flush "io.IOBase.flush") is implied when a call to
    write contains a newline character or a carriage return.

    If *write_through* is `True`, calls to [`write()`](io.md#io.BufferedIOBase.write "io.BufferedIOBase.write") are guaranteed
    ...
    :   Set the stream position.
        ...
        - `seek(cookie, SEEK_SET)`: Restore a previous position;
          *cookie* **must be** a number returned by [`tell()`](io.md#io.TextIOWrapper.tell "io.TextIOWrapper.tell").
...
:   A text stream using an in-memory text buffer. It inherits from
    ...
    [`write()`](io.md#io.TextIOBase.write "io.TextIOBase.write"). The stream is positioned at the start of the
...
[`tell()`](io.md#io.TextIOBase.tell "io.TextIOBase.tell") and [`seek()`](io.md#io.TextIOBase.seek "io.TextIOBase.seek") are both quite slow
