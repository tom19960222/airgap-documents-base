...
source_url: https://docs.python.org/3.12/library/functions.html
fetched_at: 2026-09-17T15:32:06+00:00
---
# Built-in Functions
...
:   Return an [asynchronous iterator](https://docs.python.org/3.12/glossary.html#term-asynchronous-iterator) for an [asynchronous iterable](https://docs.python.org/3.12/glossary.html#term-asynchronous-iterable).
    ...
    Note: Unlike [`iter()`](functions.md#iter "iter"), [`aiter()`](functions.md#aiter "aiter") has no 2-argument variant.
...
:   When awaited, return the next item from the given [asynchronous
    ...
    This is the async variant of the [`next()`](functions.md#next "next") builtin, and behaves
    similarly.

    This calls the [`__anext__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__anext__ "object.__anext__") method of *async_iterator*,
    returning an [awaitable](https://docs.python.org/3.12/glossary.html#term-awaitable). Awaiting this returns the next value of the
    iterator. If *default* is given, it is returned if the iterator is exhausted,
    otherwise [`StopAsyncIteration`](exceptions.md#StopAsyncIteration "StopAsyncIteration") is raised.
...
:   Return a Boolean value, i.e. one of `True` or `False`. The argument
    ...
    [`bool`](functions.md#bool "bool") class is a subclass of [`int`](functions.md#int "int") (see [Numeric Types — int, float, complex](stdtypes.md#typesnumeric)).
...
:   This function drops you into the debugger at the call site. Specifically,
    ...
    [`pdb.set_trace()`](pdb.md#pdb.set_trace "pdb.set_trace") expecting no arguments. In this case, it is
    purely a convenience function so you don’t have to explicitly import
    [`pdb`](pdb.md#module-pdb "pdb: The Python debugger for interactive interpreters.") or type as much code to enter the debugger. However,
    [`sys.breakpointhook()`](sys.md#sys.breakpointhook "sys.breakpointhook") can be set to some other function and
    [`breakpoint()`](functions.md#breakpoint "breakpoint") will automatically call that, allowing you to drop into
    the debugger of choice.
    If [`sys.breakpointhook()`](sys.md#sys.breakpointhook "sys.breakpointhook") is not accessible, this function will
    raise [`RuntimeError`](exceptions.md#RuntimeError "RuntimeError").

    By default, the behavior of [`breakpoint()`](functions.md#breakpoint "breakpoint") can be changed with
    the [`PYTHONBREAKPOINT`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONBREAKPOINT) environment variable.
    See [`sys.breakpointhook()`](sys.md#sys.breakpointhook "sys.breakpointhook") for usage details.

    Note that this is not guaranteed if [`sys.breakpointhook()`](sys.md#sys.breakpointhook "sys.breakpointhook")
    has been replaced.
...
:   Return a new array of bytes. The [`bytearray`](stdtypes.md#bytearray "bytearray") class is a mutable
    ...
    as most methods that the [`bytes`](stdtypes.md#bytes "bytes") type has, see [Bytes and Bytearray Operations](stdtypes.md#bytes-methods).

    The optional *source* parameter can be used to initialize the array in a few
    different ways:

    - If it is a *string*, you must also give the *encoding* (and optionally,
      *errors*) parameters; [`bytearray()`](stdtypes.md#bytearray "bytearray") then converts the string to
      bytes using [`str.encode()`](stdtypes.md#str.encode "str.encode").
    - If it is an *integer*, the array will have that size and will be
      initialized with null bytes.
    - If it is an object conforming to the [buffer interface](https://docs.python.org/3.12/c-api/buffer.html#bufferobjects),
...
:   Return a new “bytes” object which is an immutable sequence of integers in
    ...
    Accordingly, constructor arguments are interpreted as for [`bytearray()`](stdtypes.md#bytearray "bytearray").

    Bytes objects can also be created with literals, see [String and Bytes literals](https://docs.python.org/3.12/reference/lexical_analysis.html#strings).
...
:   Return [`True`](constants.md#True "True") if the *object* argument appears callable,
    ...
    instances are callable if their class has a [`__call__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__call__ "object.__call__") method.
...
:   Transform a method into a class method.
    ...
    The `@classmethod` form is a function [decorator](https://docs.python.org/3.12/glossary.html#term-decorator) – see
    [Function definitions](https://docs.python.org/3.12/reference/compound_stmts.html#function) for details.
    ...
    see [`staticmethod()`](functions.md#staticmethod "staticmethod") in this section.
    For more information on class methods, see [The standard type hierarchy](https://docs.python.org/3.12/reference/datamodel.html#types).

    Changed in version 3.9: Class methods can now wrap other [descriptors](https://docs.python.org/3.12/glossary.html#term-descriptor) such as
    [`property()`](functions.md#property "property").

    Changed in version 3.10: Class methods now inherit the method attributes
    ([`__module__`](https://docs.python.org/3.12/reference/datamodel.html#function.__module__ "function.__module__"), [`__name__`](https://docs.python.org/3.12/reference/datamodel.html#function.__name__ "function.__name__"),
    [`__qualname__`](https://docs.python.org/3.12/reference/datamodel.html#function.__qualname__ "function.__qualname__"), [`__doc__`](https://docs.python.org/3.12/reference/datamodel.html#function.__doc__ "function.__doc__") and
    [`__annotations__`](https://docs.python.org/3.12/reference/datamodel.html#function.__annotations__ "function.__annotations__")) and have a new `__wrapped__`
    attribute.
...
:   Compile the *source* into a code or AST object. Code objects can be executed
    ...
    and which [future features](https://docs.python.org/3.12/reference/simple_stmts.html#future) should be allowed. If neither
    is present (or both are zero) the code is compiled with the same flags that
    affect the code that is calling [`compile()`](functions.md#compile "compile"). If the *flags*
    ...
    [`compiler_flag`](__future__.md#future__._Feature.compiler_flag "__future__._Feature.compiler_flag") attribute on the
    [`_Feature`](__future__.md#future__._Feature "__future__._Feature") instance in the [`__future__`](__future__.md#module-__future__ "__future__: Future statement definitions") module.
    [Compiler flags](ast.md#ast-compiler-flags) can be found in [`ast`](ast.md#module-ast "ast: Abstract Syntax Tree classes and manipulation.")
    module, with `PyCF_` prefix.

    The argument *optimize* specifies the optimization level of the compiler; the
    default value of `-1` selects the optimization level of the interpreter as
    given by [`-O`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-O) options. Explicit levels are `0` (no optimization;
    `__debug__` is true), `1` (asserts are removed, `__debug__` is false)
    or `2` (docstrings are removed too).

    This function raises [`SyntaxError`](exceptions.md#SyntaxError "SyntaxError") if the compiled source is invalid,
    and [`ValueError`](exceptions.md#ValueError "ValueError") if the source contains null bytes.

    If you want to parse Python code into its AST representation, see
    [`ast.parse()`](ast.md#ast.parse "ast.parse").
    ...
    > statements in the [`code`](code.md#module-code "code: Facilities to implement read-eval-print loops.") module.
    ...
    Changed in version 3.5: Previously, [`TypeError`](exceptions.md#TypeError "TypeError") was raised when null bytes were encountered
    in *source*.
...
:   Convert a single string or number to a complex number, or create a
    ...
    same format as for [`float()`](functions.md#float "float")) or an imaginary part (in the same
    ...
    More precisely, the input must conform to the [`complexvalue`](functions.md#grammar-token-float-complexvalue)
    ...
    conversion like [`int`](functions.md#int "int") and [`float`](functions.md#float "float").
    For a general Python object `x`, `complex(x)` delegates to
    `x.__complex__()`.
    If [`__complex__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__complex__ "object.__complex__") is not defined then it falls back
    to [`__float__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__float__ "object.__float__").
    If `__float__()` is not defined then it falls back
    to [`__index__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__").
...
:   Without arguments, return the list of names in the current local scope. With an
    ...
    If the object has a method named [`__dir__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__dir__ "object.__dir__"),
    this method will be called and
    must return the list of attributes. This allows objects that implement a custom
    [`__getattr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattr__ "object.__getattr__") or [`__getattribute__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattribute__ "object.__getattribute__") function
    to customize the way
    [`dir()`](functions.md#dir "dir") reports their attributes.

    If the object does not provide [`__dir__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__dir__ "object.__dir__"),
    the function tries its best to gather information from the object’s
    [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#object.__dict__ "object.__dict__") attribute, if defined, and
    from its type object. The resulting list is not necessarily complete and may
    be inaccurate when the object has a custom [`__getattr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattr__ "object.__getattr__").

    The default [`dir()`](functions.md#dir "dir") mechanism behaves differently with different types of
    ...
    > **Note:**
    >
    > Because [`dir()`](functions.md#dir "dir") is supplied primarily as a convenience for use at an
...
:   Return an enumerate object. *iterable* must be a sequence, an
    ...
    [`enumerate()`](functions.md#enumerate "enumerate") returns a tuple containing a count (from *start* which
...
:   Parameters:
    :   - **expression** ([`str`](stdtypes.md#str "str") | [code object](https://docs.python.org/3.12/reference/datamodel.html#code-objects)) – A Python expression.
        ...
        - **locals** ([mapping](https://docs.python.org/3.12/glossary.html#term-mapping) | `None`) – The local namespace (default: `None`).
    ...
    reference to the dictionary of the built-in module [`builtins`](builtins.md#module-builtins "builtins: The module that provides the built-in namespace.") is
    inserted under that key before *expression* is parsed. That way you can
    control what builtins are available to the executed code by inserting your
    own `__builtins__` dictionary into *globals* before passing it to
    [`eval()`](functions.md#eval "eval"). If the *locals* dictionary is omitted it defaults to the
    *globals* dictionary. If both dictionaries are omitted, the expression is
    executed with the *globals* and *locals* in the environment where
    [`eval()`](functions.md#eval "eval") is called. Note, *eval()* does not have access to the
    [nested scopes](https://docs.python.org/3.12/glossary.html#term-nested-scope) (non-locals) in the enclosing
    environment.
    ...
    those created by [`compile()`](functions.md#compile "compile")). In this case, pass a code object instead
    of a string. If the code object has been compiled with `'exec'` as the
    *mode* argument, [`eval()`](functions.md#eval "eval")'s return value will be `None`.

    Hints: dynamic execution of statements is supported by the [`exec()`](functions.md#exec "exec")
    function. The [`globals()`](functions.md#globals "globals") and [`locals()`](functions.md#locals "locals") functions
    return the current global and local dictionary, respectively, which may be
    useful to pass around for use by [`eval()`](functions.md#eval "eval") or [`exec()`](functions.md#exec "exec").

    If the given source is a string, then leading and trailing spaces and tabs
    are stripped.

    See [`ast.literal_eval()`](ast.md#ast.literal_eval "ast.literal_eval") for a function that can safely evaluate strings
...
:   > **Warning:**
    ...
    occurs). [[1]](functions.md#id2) If it is a code object, it is simply executed. In all cases,
    the code that’s executed is expected to be valid as file input (see the
    section [File input](https://docs.python.org/3.12/reference/toplevel_components.html#file-input) in the Reference Manual). Be aware that the
    [`nonlocal`](https://docs.python.org/3.12/reference/simple_stmts.html#nonlocal), [`yield`](https://docs.python.org/3.12/reference/simple_stmts.html#yield), and [`return`](https://docs.python.org/3.12/reference/simple_stmts.html#return)
    statements may not be used outside of
    function definitions even within the context of code passed to the
    [`exec()`](functions.md#exec "exec") function. The return value is `None`.
    ...
    *locals* are given, they are used for the global and local variables,
    ...
    [`builtins`](builtins.md#module-builtins "builtins: The module that provides the built-in namespace.") is inserted under that key. That way you can control what
    builtins are available to the executed code by inserting your own
    `__builtins__` dictionary into *globals* before passing it to [`exec()`](functions.md#exec "exec").
    ...
    > **Note:**
    >
    > The built-in functions [`globals()`](functions.md#globals "globals") and [`locals()`](functions.md#locals "locals") return the current
    > global and local dictionary, respectively, which may be useful to pass around
    > for use as the second and third argument to [`exec()`](functions.md#exec "exec").

    > **Note:**
    >
    > The default *locals* act as described for function [`locals()`](functions.md#locals "locals") below:
    > modifications to the default *locals* dictionary should not be attempted.
    > Pass an explicit *locals* dictionary if you need to see effects of the
    > code on *locals* after function [`exec()`](functions.md#exec "exec") returns.
...
:   Return a floating-point number constructed from a number or a string.
    ...
    More precisely, the input must conform to the [`floatvalue`](functions.md#grammar-token-float-floatvalue)
    ...
    float, an [`OverflowError`](exceptions.md#OverflowError "OverflowError") will be raised.

    For a general Python object `x`, `float(x)` delegates to
    `x.__float__()`. If [`__float__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__float__ "object.__float__") is not defined then it falls back
    to [`__index__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__").
...
:   Convert a *value* to a “formatted” representation, as controlled by
    *format_spec*. The interpretation of *format_spec* will depend on the type
    ...
    effect as calling [`str(value)`](stdtypes.md#str "str").

    A call to `format(value, format_spec)` is translated to
    `type(value).__format__(value, format_spec)` which bypasses the instance
    dictionary when searching for the value’s [`__format__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__format__ "object.__format__") method.
    A [`TypeError`](exceptions.md#TypeError "TypeError") exception is raised if the method search reaches
    [`object`](functions.md#object "object") and the *format_spec* is non-empty, or if either the
...
:   Return a new [`frozenset`](stdtypes.md#frozenset "frozenset") object, optionally with elements taken from
    *iterable*. `frozenset` is a built-in class. See [`frozenset`](stdtypes.md#frozenset "frozenset") and
    ...
    For other containers see the built-in [`set`](stdtypes.md#set "set"), [`list`](stdtypes.md#list "list"),
...
:   Return the value of the named attribute of *object*. *name* must be a string.
    ...
    provided, otherwise [`AttributeError`](exceptions.md#AttributeError "AttributeError") is raised.
    *name* need not be a Python identifier (see [`setattr()`](functions.md#setattr "setattr")).

    > **Note:**
    >
    > Since [private name mangling](https://docs.python.org/3.12/reference/expressions.html#private-name-mangling) happens at
...
:   Return the hash value of the object (if it has one). Hash values are
    ...
    > **Note:**
    >
    > For objects with custom [`__hash__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__hash__ "object.__hash__") methods,
...
:   Invoke the built-in help system. (This function is intended for interactive
    ...
    invoking [`help()`](functions.md#help "help"), it means that the parameters prior to the slash are
    positional-only. For more info, see
    [the FAQ entry on positional-only parameters](https://docs.python.org/3.12/faq/programming.html#faq-positional-only-arguments).

    This function is added to the built-in namespace by the [`site`](site.md#module-site "site: Module responsible for site-specific configuration.") module.
...
:   Convert an integer number to a lowercase hexadecimal string prefixed with
    ...
    See also [`int()`](functions.md#int "int") for converting a hexadecimal string to an
...
:   If the *prompt* argument is present, it is written to standard output without
    ...
    read, [`EOFError`](exceptions.md#EOFError "EOFError") is raised. Example:
    ...
    If the [`readline`](readline.md#module-readline "readline: GNU readline support for Python. (Unix)") module was loaded, then [`input()`](functions.md#input "input") will use it
...
:   Return an integer object constructed from a number or a string, or return
    ...
    If the argument defines [`__int__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__int__ "object.__int__"),
    `int(x)` returns `x.__int__()`. If the argument defines [`__index__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__"),
    it returns `x.__index__()`. If the argument defines [`__trunc__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__trunc__ "object.__trunc__"),
    it returns `x.__trunc__()`.
    For floating-point numbers, this truncates towards zero.

    If the argument is not a number or if *base* is given, then it must be a string,
    [`bytes`](stdtypes.md#bytes "bytes"), or [`bytearray`](stdtypes.md#bytearray "bytearray") instance representing an integer
    ...
    interpreted in a similar way to an [integer literal in code](https://docs.python.org/3.12/reference/lexical_analysis.html#integers),
    ...
    Changed in version 3.4: If *base* is not an instance of [`int`](functions.md#int "int") and the *base* object has a
    [`base.__index__`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__") method, that method is called
    to obtain an integer for the base. Previous versions used
    [`base.__int__`](https://docs.python.org/3.12/reference/datamodel.html#object.__int__ "object.__int__") instead of [`base.__index__`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__").

    Changed in version 3.6: Grouping digits with underscores as in code literals is allowed.

    Changed in version 3.7: The first parameter is now positional-only.

    Changed in version 3.8: Falls back to [`__index__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__index__ "object.__index__") if [`__int__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__int__ "object.__int__") is not defined.

    Changed in version 3.11: The delegation to [`__trunc__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__trunc__ "object.__trunc__") is deprecated.

    Changed in version 3.11: [`int`](functions.md#int "int") string inputs and string representations can be limited to
    help avoid denial of service attacks. A [`ValueError`](exceptions.md#ValueError "ValueError") is raised when
    the limit is exceeded while converting a string to an [`int`](functions.md#int "int") or
...
:   Return `True` if the *object* argument is an instance of the *classinfo*
    ...
    *object* is an instance of any of the types.
    ...
    a [`TypeError`](exceptions.md#TypeError "TypeError") exception is raised. [`TypeError`](exceptions.md#TypeError "TypeError") may not be
...
:   Return `True` if *class* is a subclass (direct, indirect, or [virtual](https://docs.python.org/3.12/glossary.html#term-abstract-base-class)) of *classinfo*. A
    ...
    subclass of any entry in *classinfo*. In any other case, a [`TypeError`](exceptions.md#TypeError "TypeError")
    exception is raised.
...
:   Return an [iterator](https://docs.python.org/3.12/glossary.html#term-iterator) object. The first argument is interpreted very
    ...
    [iterable](https://docs.python.org/3.12/glossary.html#term-iterable) protocol (the [`__iter__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__iter__ "object.__iter__") method),
    or it must support
    the sequence protocol (the [`__getitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getitem__ "object.__getitem__") method with integer arguments
    starting at `0`). If it does not support either of those protocols,
    [`TypeError`](exceptions.md#TypeError "TypeError") is raised. If the second argument, *sentinel*, is given,
    then *object* must be a callable object. The iterator created in this case
    will call *object* with no arguments for each call to its
    [`__next__()`](stdtypes.md#iterator.__next__ "iterator.__next__") method; if the value returned is equal to
    *sentinel*, [`StopIteration`](exceptions.md#StopIteration "StopIteration") will be raised, otherwise the value will
    be returned.

    See also [Iterator Types](stdtypes.md#typeiter).

    One useful application of the second form of [`iter()`](functions.md#iter "iter") is to build a
...
:   Update and return a dictionary representing the current local symbol table.
    ...
    and [`globals()`](functions.md#globals "globals") are the same dictionary.
...
:   Return the largest item in an iterable or the largest of two or more
    ...
    If one positional argument is provided, it should be an [iterable](https://docs.python.org/3.12/glossary.html#term-iterable).
    The largest item in the iterable is returned. If two or more positional
    arguments are provided, the largest of the positional arguments is
    returned.

    There are two optional keyword-only arguments. The *key* argument specifies
    a one-argument ordering function like that used for [`list.sort()`](stdtypes.md#list.sort "list.sort"). The
...
:   This is the ultimate base class of all other classes. It has methods
    ...
    > **Note:**
    >
    > [`object`](functions.md#object "object") instances do *not* have [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#object.__dict__ "object.__dict__")
...
:   Open *file* and return a corresponding [file object](https://docs.python.org/3.12/glossary.html#term-file-object). If the file
    ...
    *file* is a [path-like object](https://docs.python.org/3.12/glossary.html#term-path-like-object) giving the pathname (absolute or
    ...
    *encoding* is not specified the encoding used is platform-dependent:
    [`locale.getencoding()`](locale.md#locale.getencoding "locale.getencoding") is called to get the current locale encoding.
    ...
    *encoding* unspecified.) The available modes are:
    ...
    argument) return contents as [`bytes`](stdtypes.md#bytes "bytes") objects without any decoding. In
    text mode (the default, or when `'t'` is included in the *mode* argument),
    the contents of the file are returned as [`str`](stdtypes.md#str "str"), the bytes having been
    ...
    *buffering* is an optional integer used to set the buffering policy. Pass 0
    ...
    [`io.TextIOWrapper.reconfigure()`](io.md#io.TextIOWrapper.reconfigure "io.TextIOWrapper.reconfigure"). When no *buffering* argument is
    given, the default buffering policy works as follows:

    - Binary files are buffered in fixed-size chunks; the size of the buffer is
      chosen using a heuristic trying to determine the underlying device’s “block
      size” and falling back on [`io.DEFAULT_BUFFER_SIZE`](io.md#io.DEFAULT_BUFFER_SIZE "io.DEFAULT_BUFFER_SIZE"). On many systems,
      the buffer will typically be 4096 or 8192 bytes long.
    - “Interactive” text files (files for which [`isatty()`](io.md#io.IOBase.isatty "io.IOBase.isatty")
      returns `True`) use line buffering. Other text files use the policy
      described above for binary files.

    *encoding* is the name of the encoding used to decode or encode the file.
    This should only be used in text mode. The default encoding is platform
    dependent (whatever [`locale.getencoding()`](locale.md#locale.getencoding "locale.getencoding") returns), but any
    [text encoding](https://docs.python.org/3.12/glossary.html#term-text-encoding) supported by Python can be used.
    See the [`codecs`](codecs.md#module-codecs "codecs: Encode and decode data and streams.") module for the list of supported encodings.

    *errors* is an optional string that specifies how encoding and decoding
    errors are to be handled—this cannot be used in binary mode.
    A variety of standard error handlers are available
    (listed under [Error Handlers](codecs.md#error-handlers)), though any
    error handling name that has been registered with
    [`codecs.register_error()`](codecs.md#codecs.register_error "codecs.register_error") is also valid. The standard names
    include:

    - `'strict'` to raise a [`ValueError`](exceptions.md#ValueError "ValueError") exception if there is
    ...
    *newline* determines how to parse newline characters from the stream.
    ...
    - When writing output to the stream, if *newline* is `None`, any `'\n'`
      ...
      [`os.linesep`](os.md#os.linesep "os.linesep"). If *newline* is `''` or `'\n'`, no translation
    ...
    [`os.open`](os.md#os.open "os.open") as *opener* results in functionality similar to passing
    `None`).
    ...
    [`os.open()`](os.md#os.open "os.open") function to open a file relative to a given directory:
    ...
    The type of [file object](https://docs.python.org/3.12/glossary.html#term-file-object) returned by the [`open()`](functions.md#open "open") function
    depends on the mode. When [`open()`](functions.md#open "open") is used to open a file in a text
    mode (`'w'`, `'r'`, `'wt'`, `'rt'`, etc.), it returns a subclass of
    [`io.TextIOBase`](io.md#io.TextIOBase "io.TextIOBase") (specifically [`io.TextIOWrapper`](io.md#io.TextIOWrapper "io.TextIOWrapper")). When used
    to open a file in a binary mode with buffering, the returned class is a
    subclass of [`io.BufferedIOBase`](io.md#io.BufferedIOBase "io.BufferedIOBase"). The exact class varies: in read
    binary mode, it returns an [`io.BufferedReader`](io.md#io.BufferedReader "io.BufferedReader"); in write binary and
    append binary modes, it returns an [`io.BufferedWriter`](io.md#io.BufferedWriter "io.BufferedWriter"), and in
    read/write mode, it returns an [`io.BufferedRandom`](io.md#io.BufferedRandom "io.BufferedRandom"). When buffering is
    disabled, the raw stream, a subclass of [`io.RawIOBase`](io.md#io.RawIOBase "io.RawIOBase"),
    [`io.FileIO`](io.md#io.FileIO "io.FileIO"), is returned.

    See also the file handling modules, such as [`fileinput`](fileinput.md#module-fileinput "fileinput: Loop over standard input or a list of files."), [`io`](io.md#module-io "io: Core tools for working with streams.")
    (where [`open()`](functions.md#open "open") is declared), [`os`](os.md#module-os "os: Miscellaneous operating system interfaces."), [`os.path`](os.path.md#module-os.path "os.path: Operations on pathnames."), [`tempfile`](tempfile.md#module-tempfile "tempfile: Generate temporary files and directories."),
    and [`shutil`](shutil.md#module-shutil "shutil: High-level file operations, including copying.").
    ...
    - [`IOError`](exceptions.md#IOError "IOError") used to be raised, it is now an alias of [`OSError`](exceptions.md#OSError "OSError").
    - [`FileExistsError`](exceptions.md#FileExistsError "FileExistsError") is now raised if the file opened in exclusive
    ...
    - Support added to accept objects implementing [`os.PathLike`](os.md#os.PathLike "os.PathLike").
    - On Windows, opening a console buffer may return a subclass of
      [`io.RawIOBase`](io.md#io.RawIOBase "io.RawIOBase") other than [`io.FileIO`](io.md#io.FileIO "io.FileIO").
...
:   Return *base* to the power *exp*; if *mod* is present, return *base* to the
    ...
    coercion rules for binary arithmetic operators apply. For [`int`](functions.md#int "int")
    ...
    type [`int`](functions.md#int "int") or [`float`](functions.md#float "float") and a non-integral exponent, a complex
    result is delivered. For example, `pow(-9, 0.5)` returns a value close
    to `3j`. Whereas, for a negative base of type [`int`](functions.md#int "int") or [`float`](functions.md#float "float")
    with an integral exponent, a float result is delivered. For example,
    `pow(-9, 2.0)` returns `81.0`.

    For [`int`](functions.md#int "int") operands *base* and *exp*, if *mod* is present, *mod* must
    ...
    *base* modulo *mod*.
    ...
    Changed in version 3.8: For [`int`](functions.md#int "int") operands, the three-argument form of `pow` now allows
...
:   Print *objects* to the text stream *file*, separated by *sep* and followed
    ...
    All non-keyword arguments are converted to strings like [`str()`](stdtypes.md#str "str") does and
    written to the stream, separated by *sep* and followed by *end*. Both *sep*
    and *end* must be strings; they can also be `None`, which means to use the
    default values. If no *objects* are given, [`print()`](functions.md#print "print") will just write
    *end*.

    The *file* argument must be an object with a `write(string)` method; if it
    is not present or `None`, [`sys.stdout`](sys.md#sys.stdout "sys.stdout") will be used. Since printed
    arguments are converted to text strings, [`print()`](functions.md#print "print") cannot be used with
...
:   Return a property attribute.
    ...
    *fget* is a function for getting an attribute value. *fset* is a function
    ...
    create read-only properties easily using [`property()`](functions.md#property "property") as a [decorator](https://docs.python.org/3.12/glossary.html#term-decorator):
...
:   Return a string containing a printable representation of an object. For many
    ...
    by defining a [`__repr__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__repr__ "object.__repr__") method.
    If [`sys.displayhook()`](sys.md#sys.displayhook "sys.displayhook") is not accessible, this function will raise
...
:   Return *number* rounded to *ndigits* precision after the decimal
    ...
    For the built-in types supporting [`round()`](functions.md#round "round"), values are rounded to the
    ...
    > **Note:**
    >
    > The behavior of [`round()`](functions.md#round "round") for floats can be surprising: for example,
...
:   Return a new [`set`](stdtypes.md#set "set") object, optionally with elements taken from
    *iterable*. `set` is a built-in class. See [`set`](stdtypes.md#set "set") and
    ...
    For other containers see the built-in [`frozenset`](stdtypes.md#frozenset "frozenset"), [`list`](stdtypes.md#list "list"),
    [`tuple`](stdtypes.md#tuple "tuple"), and [`dict`](stdtypes.md#dict "dict") classes, as well as the [`collections`](collections.md#module-collections "collections: Container datatypes")
    module.
...
:   This is the counterpart of [`getattr()`](functions.md#getattr "getattr"). The arguments are an object, a
    ...
    *name* need not be a Python identifier as defined in [Identifiers and keywords](https://docs.python.org/3.12/reference/lexical_analysis.html#identifiers)
    unless the object chooses to enforce that, for example in a custom
    [`__getattribute__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattribute__ "object.__getattribute__") or via [`__slots__`](https://docs.python.org/3.12/reference/datamodel.html#object.__slots__ "object.__slots__").
    An attribute whose name is not an identifier will not be accessible using
    the dot notation, but is accessible through [`getattr()`](functions.md#getattr "getattr") etc..
...
:   Return a [slice](https://docs.python.org/3.12/glossary.html#term-slice) object representing the set of indices specified by
    ...
    [`itertools.islice()`](itertools.md#itertools.islice "itertools.islice") for an alternate version that returns an
...
:   Return a new sorted list from the items in *iterable*.
    ...
    *reverse* is a boolean value. If set to `True`, then the list elements are
    ...
    Use [`functools.cmp_to_key()`](functools.md#functools.cmp_to_key "functools.cmp_to_key") to convert an old-style *cmp* function to a
    *key* function.

    The built-in [`sorted()`](functions.md#sorted "sorted") function is guaranteed to be stable. A sort is
    stable if it guarantees not to change the relative order of elements that
    compare equal — this is helpful for sorting in multiple passes (for
    example, sort by department, then by salary grade).

    The sort algorithm uses only `<` comparisons between items. While
    defining an [`__lt__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__lt__ "object.__lt__") method will suffice for sorting,
    [**PEP 8**](https://peps.python.org/pep-0008/) recommends that all six [rich comparisons](https://docs.python.org/3.12/reference/expressions.html#comparisons) be implemented. This will help avoid bugs when using
    the same data with other ordering tools such as [`max()`](functions.md#max "max") that rely
    on a different underlying method. Implementing all six comparisons
    also helps avoid confusion for mixed type comparisons which can call
    reflected the [`__gt__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__gt__ "object.__gt__") method.
...
:   Transform a method into a static method.
    ...
    The `@staticmethod` form is a function [decorator](https://docs.python.org/3.12/glossary.html#term-decorator) – see
    [Function definitions](https://docs.python.org/3.12/reference/compound_stmts.html#function) for details.

    A static method can be called either on the class (such as `C.f()`) or on
    an instance (such as `C().f()`).
    Moreover, the static method [descriptor](https://docs.python.org/3.12/glossary.html#term-descriptor) is also callable, so it can
    be used in the class definition (such as `f()`).

    Static methods in Python are similar to those found in Java or C++. Also, see
    [`classmethod()`](functions.md#classmethod "classmethod") for a variant that is useful for creating alternate class
    constructors.
    ...
    For more information on static methods, see [The standard type hierarchy](https://docs.python.org/3.12/reference/datamodel.html#types).
...
:   Sums *start* and the items of an *iterable* from left to right and returns the
    ...
    For some use cases, there are good alternatives to [`sum()`](functions.md#sum "sum").
    The preferred, fast way to concatenate a sequence of strings is by calling
    `''.join(sequence)`. To add floating-point values with extended precision,
    see [`math.fsum()`](math.md#math.fsum "math.fsum"). To concatenate a series of iterables, consider using
    [`itertools.chain()`](itertools.md#itertools.chain "itertools.chain").
...
:   Return a proxy object that delegates method calls to a parent or sibling
    ...
    The *object_or_type* determines the [method resolution order](https://docs.python.org/3.12/glossary.html#term-method-resolution-order)
    to be searched. The search starts from the class right after the
    *type*.

    For example, if [`__mro__`](https://docs.python.org/3.12/reference/datamodel.html#type.__mro__ "type.__mro__") of *object_or_type* is
    `D -> B -> C -> A -> object` and the value of *type* is `B`,
    then [`super()`](functions.md#super "super") searches `C -> A -> object`.

    The [`__mro__`](https://docs.python.org/3.12/reference/datamodel.html#type.__mro__ "type.__mro__") attribute of the class corresponding to
    *object_or_type* lists the method resolution search order used by both
    [`getattr()`](functions.md#getattr "getattr") and [`super()`](functions.md#super "super"). The attribute is dynamic and can change
    ...
    In addition to method lookups, [`super()`](functions.md#super "super") also works for attribute
    lookups. One possible use case for this is calling [descriptors](https://docs.python.org/3.12/glossary.html#term-descriptor)
    in a parent or sibling class.

    Note that [`super()`](functions.md#super "super") is implemented as part of the binding process for
    explicit dotted attribute lookups such as `super().__getitem__(name)`.
    It does so by implementing its own [`__getattribute__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getattribute__ "object.__getattribute__") method
    for searching
    classes in a predictable order that supports cooperative multiple inheritance.
    Accordingly, [`super()`](functions.md#super "super") is undefined for implicit lookups using statements or
    operators such as `super()[name]`.

    Also note that, aside from the zero argument form, [`super()`](functions.md#super "super") is not
...
:   With one argument, return the type of an *object*. The return value is a
    ...
    The [`isinstance()`](functions.md#isinstance "isinstance") built-in function is recommended for testing the type
    of an object, because it takes subclasses into account.

    With three arguments, return a new type object. This is essentially a
    dynamic form of the [`class`](https://docs.python.org/3.12/reference/compound_stmts.html#class) statement. The *name* string is
    the class name and becomes the [`__name__`](https://docs.python.org/3.12/reference/datamodel.html#type.__name__ "type.__name__") attribute.
    The *bases* tuple contains the base classes and becomes the
    [`__bases__`](https://docs.python.org/3.12/reference/datamodel.html#type.__bases__ "type.__bases__") attribute; if empty, [`object`](functions.md#object "object"), the
    ...
    or wrapped before becoming the [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#type.__dict__ "type.__dict__") attribute.
    ...
    - [Documentation on attributes and methods on classes](https://docs.python.org/3.12/reference/datamodel.html#class-attrs-and-methods).
    - [Type Objects](stdtypes.md#bltin-type-objects)

    Keyword arguments provided to the three argument form are passed to the
    appropriate metaclass machinery (usually [`__init_subclass__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__init_subclass__ "object.__init_subclass__"))
    in the same way that keywords in a class
    definition (besides *metaclass*) would.

    See also [Customizing class creation](https://docs.python.org/3.12/reference/datamodel.html#class-customization).
...
:   Return the [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#object.__dict__ "object.__dict__") attribute for a module, class, instance,
    ...
    Objects such as modules and instances have an updateable [`__dict__`](https://docs.python.org/3.12/reference/datamodel.html#object.__dict__ "object.__dict__")
    attribute; however, other objects may have write restrictions on their
    `__dict__` attributes (for example, classes use a
    [`types.MappingProxyType`](types.md#types.MappingProxyType "types.MappingProxyType") to prevent direct dictionary updates).

    Without an argument, [`vars()`](functions.md#vars "vars") acts like [`locals()`](functions.md#locals "locals"). Note, the
    locals dictionary is only useful for reads since updates to the locals
    dictionary are ignored.

    A [`TypeError`](exceptions.md#TypeError "TypeError") exception is raised if an object is specified but
...
:   Iterate over several iterables in parallel, producing tuples with an item
    ...
    More formally: [`zip()`](functions.md#zip "zip") returns an iterator of tuples, where the *i*-th
    tuple contains the *i*-th element from each of the argument iterables.

    Another way to think of [`zip()`](functions.md#zip "zip") is that it turns rows into columns, and
    columns into rows. This is similar to [transposing a matrix](https://en.wikipedia.org/wiki/Transpose).

    [`zip()`](functions.md#zip "zip") is lazy: The elements won’t be processed until the iterable is
    iterated on, e.g. by a `for` loop or by wrapping in a
    [`list`](stdtypes.md#list "list").

    One thing to consider is that the iterables passed to [`zip()`](functions.md#zip "zip") could have
    different lengths; sometimes by design, and sometimes because of a bug in
    the code that prepared these iterables. Python offers three different
    approaches to dealing with this issue:

    - By default, [`zip()`](functions.md#zip "zip") stops when the shortest iterable is exhausted.
      ...
      [(0, 'fee'), (1, 'fi'), (2, 'fo')]
      ```
    - [`zip()`](functions.md#zip "zip") is often used in cases where the iterables are assumed to be
      of equal length. In such cases, it’s recommended to use the `strict=True`
      option. Its output is the same as regular [`zip()`](functions.md#zip "zip"):
      ...
      Unlike the default behavior, it raises a [`ValueError`](exceptions.md#ValueError "ValueError") if one iterable
    ...
    - Shorter iterables can be padded with a constant value to make all the
      ...
      [`itertools.zip_longest()`](itertools.md#itertools.zip_longest "itertools.zip_longest").

    Edge cases: With a single iterable argument, [`zip()`](functions.md#zip "zip") returns an
    ...
    - [`zip()`](functions.md#zip "zip") in conjunction with the `*` operator can be used to unzip a
      list:
...
:   > **Note:**
    ...
    > programming, unlike [`importlib.import_module()`](importlib.md#importlib.import_module "importlib.import_module").

    This function is invoked by the [`import`](https://docs.python.org/3.12/reference/simple_stmts.html#import) statement. It can be
    replaced (by importing the [`builtins`](builtins.md#module-builtins "builtins: The module that provides the built-in namespace.") module and assigning to
    ...
    implementation is in use. Direct use of [`__import__()`](functions.md#import__ "__import__") is also
    discouraged in favor of [`importlib.import_module()`](importlib.md#importlib.import_module "importlib.import_module").
    ...
    determine the package context of the [`import`](https://docs.python.org/3.12/reference/simple_stmts.html#import) statement.

    *level* specifies whether to use absolute or relative imports. `0` (the
    default) means only perform absolute imports. Positive values for
    *level* indicate the number of parent directories to search relative to the
    directory of the module calling [`__import__()`](functions.md#import__ "__import__") (see [**PEP 328**](https://peps.python.org/pep-0328/) for the
    details).
    ...
    Note how [`__import__()`](functions.md#import__ "__import__") returns the toplevel module here because this is
    the object that is bound to a name by the [`import`](https://docs.python.org/3.12/reference/simple_stmts.html#import) statement.
    ...
    Here, the `spam.ham` module is returned from [`__import__()`](functions.md#import__ "__import__"). From this
    object, the names to import are retrieved and assigned to their respective
    names.

    If you simply want to import a module (potentially within a package) by name,
    use [`importlib.import_module()`](importlib.md#importlib.import_module "importlib.import_module").

    Changed in version 3.3: Negative values for *level* are no longer supported (which also changes
    the default value to 0).

    Changed in version 3.9: When the command line options [`-E`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-E) or [`-I`](https://docs.python.org/3.12/using/cmdline.html#cmdoption-I) are being used,
    the environment variable [`PYTHONCASEOK`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONCASEOK) is now ignored.
