...
source_url: https://docs.python.org/3.12/library/threading.html
fetched_at: 2026-09-17T15:33:28+00:00
---
# `threading` — Thread-based parallelism

**Source code:** [Lib/threading.py](https://github.com/python/cpython/tree/3.12/Lib/threading.py)
...
**CPython implementation detail:** In CPython, due to the [Global Interpreter Lock](https://docs.python.org/3.12/glossary.html#term-global-interpreter-lock), only one thread
...
:   A class that represents thread-local data.
    ...
    `_threading_local` module: [Lib/_threading_local.py](https://github.com/python/cpython/tree/3.12/Lib/_threading_local.py).
...
:   This constructor should always be called with keyword arguments. Arguments
    ...
    *kwargs* is a dictionary of keyword arguments for the target invocation.
    ...
    :   Method representing the thread’s activity.
        ...
        Using list or tuple as the *args* argument which passed to the [`Thread`](threading.md#threading.Thread "threading.Thread")
...
Threads call a lock’s [`acquire()`](threading.md#threading.RLock.acquire "threading.RLock.acquire") method to lock it,
and its [`release()`](threading.md#threading.Lock.release "threading.Lock.release") method to unlock it.

> **Note:**
>
> Reentrant locks support the [context management protocol](threading.md#with-locks),
> so it is recommended to use [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) instead of manually calling
> [`acquire()`](threading.md#threading.RLock.acquire "threading.RLock.acquire") and [`release()`](threading.md#threading.RLock.release "threading.RLock.release")
> to handle acquiring and releasing the lock for a block of code.

RLock’s [`acquire()`](threading.md#threading.RLock.acquire "threading.RLock.acquire")/[`release()`](threading.md#threading.RLock.release "threading.RLock.release") call pairs may be nested,
unlike Lock’s [`acquire()`](threading.md#threading.Lock.acquire "threading.Lock.acquire")/[`release()`](threading.md#threading.Lock.release "threading.Lock.release"). Only the final
[`release()`](threading.md#threading.RLock.release "threading.RLock.release") (the [`release()`](threading.md#threading.Lock.release "threading.Lock.release") of the outermost pair) resets
the lock to an unlocked state and allows another thread blocked in
[`acquire()`](threading.md#threading.RLock.acquire "threading.RLock.acquire") to proceed.

[`acquire()`](threading.md#threading.RLock.acquire "threading.RLock.acquire")/[`release()`](threading.md#threading.RLock.release "threading.RLock.release") must be used in pairs: each acquire
...
:   This class implements reentrant lock objects. A reentrant lock must be
    ...
    :   Acquire a lock, blocking or non-blocking.
        ...
        > **See also:**
        >
        > [Using RLock as a context manager](threading.md#with-locks)
        > :   Recommended over manual `acquire()` and [`release()`](threading.md#threading.RLock.release "threading.RLock.release") calls
        >     whenever practical.
        ...
        >   return immediately. This is the difference between [`Lock`](threading.md#threading.Lock "threading.Lock") and
        >   `RLock`; [`Lock`](threading.md#threading.Lock "threading.Lock") handles this case the same as the previous,
        ...
        If called multiple times, failing to call [`release()`](threading.md#threading.RLock.release "threading.RLock.release") as many times
...
Timers are started, as with threads, by calling their [`Timer.start`](threading.md#threading.Thread.start "threading.Thread.start")
...
`release` methods can be used as context managers for a [`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with)
...
[`with`](https://docs.python.org/3.12/reference/compound_stmts.html#with) statement context managers.
