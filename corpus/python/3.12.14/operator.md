...
source_url: https://docs.python.org/3.12/library/operator.html
fetched_at: 2026-09-17T15:32:42+00:00
---
# `operator` — Standard operators as functions

**Source code:** [Lib/operator.py](https://github.com/python/cpython/tree/3.12/Lib/operator.py)
...
:   Perform “rich comparisons” between *a* and *b*. Specifically, `lt(a, b)` is
    ...
    [Comparisons](https://docs.python.org/3.12/reference/expressions.html#comparisons) for more information about rich comparisons.
...
:   Return a callable object that fetches *item* from its operand using the
    ...
    The items can be any type accepted by the operand’s [`__getitem__()`](https://docs.python.org/3.12/reference/datamodel.html#object.__getitem__ "object.__getitem__")
    method. Dictionaries accept any [hashable](https://docs.python.org/3.12/glossary.html#term-hashable) value. Lists, tuples, and
...
does; for example, the [statement](https://docs.python.org/3.12/glossary.html#term-statement) `x += y` is equivalent to
