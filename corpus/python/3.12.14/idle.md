...
source_url: https://docs.python.org/3.12/library/idle.html
fetched_at: 2026-09-17T15:34:33+00:00
---
# IDLE — Python editor and shell

**Source code:** [Lib/idlelib/](https://github.com/python/cpython/tree/3.12/Lib/idlelib/)
...
IDLE also highlights the [soft keywords](https://docs.python.org/3.12/reference/lexical_analysis.html#soft-keywords) [`match`](https://docs.python.org/3.12/reference/compound_stmts.html#match),
[`case`](https://docs.python.org/3.12/reference/compound_stmts.html#match), and [`_`](https://docs.python.org/3.12/reference/compound_stmts.html#wildcard-patterns) in
...
the environment variables `IDLESTARTUP` or [`PYTHONSTARTUP`](https://docs.python.org/3.12/using/cmdline.html#envvar-PYTHONSTARTUP).
