...
version: "3.12.14"
title: "Subprocesses"
source_url: https://docs.python.org/3.12/library/asyncio-subprocess.html
fetched_at: 2026-09-17T15:35:50+00:00
---
# Subprocesses

**Source code:** [Lib/asyncio/subprocess.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/subprocess.py),
[Lib/asyncio/base_subprocess.py](https://github.com/python/cpython/tree/3.12/Lib/asyncio/base_subprocess.py)
...
:   Create a subprocess.
    ...
    wrappers for [`stdout`](asyncio-subprocess.md#asyncio.subprocess.Process.stdout "asyncio.subprocess.Process.stdout") and [`stderr`](asyncio-subprocess.md#asyncio.subprocess.Process.stderr "asyncio.subprocess.Process.stderr")
...
:   Can be passed to the *stdin*, *stdout* or *stderr* parameters.
    ...
    will point to a [`StreamWriter`](asyncio-stream.md#asyncio.StreamWriter "asyncio.StreamWriter") instance.
...
:   An object that wraps OS processes created by the
    ...
    :   Sends the signal *signal* to the child process.
        ...
        > **Note:**
        >
        > On Windows, [`SIGTERM`](signal.md#signal.SIGTERM "signal.SIGTERM") is an alias for [`terminate()`](asyncio-subprocess.md#asyncio.subprocess.Process.terminate "asyncio.subprocess.Process.terminate").
