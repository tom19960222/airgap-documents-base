...
source_url: https://docs.python.org/3.12/library/http.cookies.html
fetched_at: 2026-09-17T15:34:11+00:00
---
# `http.cookies` — HTTP state management

**Source code:** [Lib/http/cookies.py](https://github.com/python/cpython/tree/3.12/Lib/http/cookies.py)
...
in a cookie name (as [`key`](http.cookies.md#http.cookies.Morsel.key "http.cookies.Morsel.key")).
...
:   This class derives from [`BaseCookie`](http.cookies.md#http.cookies.BaseCookie "http.cookies.BaseCookie") and overrides [`value_decode()`](http.cookies.md#http.cookies.BaseCookie.value_decode "http.cookies.BaseCookie.value_decode")
    ...
    calls the builtin [`str()`](stdtypes.md#str "str") to convert
...
:   Abstract a key/value pair, which has some [**RFC 2109**](https://datatracker.ietf.org/doc/html/rfc2109.html) attributes.
    ...
    The attribute [`samesite`](http.cookies.md#http.cookies.Morsel.samesite "http.cookies.Morsel.samesite") specifies that the browser is not allowed to
