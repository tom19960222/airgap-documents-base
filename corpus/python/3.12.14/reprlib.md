...
source_url: https://docs.python.org/3.12/library/reprlib.html
fetched_at: 2026-09-17T15:32:31+00:00
---
# `reprlib` — Alternate [`repr()`](functions.md#repr "repr") implementation

**Source code:** [Lib/reprlib.py](https://github.com/python/cpython/tree/3.12/Lib/reprlib.py)
...
:   Class which provides formatting services useful in implementing functions
    ...
    attributes of the [`Repr`](reprlib.md#reprlib.Repr "reprlib.Repr") instance. Which means that the following
    initialization:
    ...
    See section [Repr Objects](reprlib.md#id1) for more information about [`Repr`](reprlib.md#reprlib.Repr "reprlib.Repr")
    attributes.
...
[`Repr`](reprlib.md#reprlib.Repr "reprlib.Repr") instances provide several attributes which can be used to provide
...
:   If this attribute is set to `None` (the default), the output is formatted
    ...
    If [`indent`](reprlib.md#reprlib.Repr.indent "reprlib.Repr.indent") is set to a string, each recursion level
    ...
    Setting [`indent`](reprlib.md#reprlib.Repr.indent "reprlib.Repr.indent") to a positive integer value behaves as if it
...
:   Formatting methods for specific types are implemented as methods with a name
    ...
    handled by [`repr1()`](reprlib.md#reprlib.Repr.repr1 "reprlib.Repr.repr1"). Type-specific methods which need to recursively
    format a value should call `self.repr1(subobj, level - 1)`.

## Subclassing Repr Objects

The use of dynamic dispatching by [`Repr.repr1()`](reprlib.md#reprlib.Repr.repr1 "reprlib.Repr.repr1") allows subclasses of
[`Repr`](reprlib.md#reprlib.Repr "reprlib.Repr") to add support for additional built-in object types or to modify
