...
source_url: https://docs.python.org/3.12/library/base64.html
fetched_at: 2026-09-17T15:33:47+00:00
---
...
supports encoding [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) to ASCII
[`bytes`](stdtypes.md#bytes "bytes"), and decoding [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or
...
provide functions for encoding and decoding to and from [file objects](https://docs.python.org/3.12/glossary.html#term-file-object). It only supports the Base64 standard alphabet, and it adds
...
Changed in version 3.4: Any [bytes-like objects](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) are now accepted by all
...
:   Encode the [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) *s* using Base64 and return the encoded
    ...
    Optional *altchars* must be a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) of length 2 which
...
:   Decode the Base64 encoded [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or ASCII string
    *s* and return the decoded [`bytes`](stdtypes.md#bytes "bytes").
    ...
    Optional *altchars* must be a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or ASCII string
    ...
    For more information about the strict base64 check, see [`binascii.a2b_base64()`](binascii.md#binascii.a2b_base64 "binascii.a2b_base64")
...
:   Decode the Ascii85 encoded [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or ASCII string *b* and
    ...
    *ignorechars* should be a [bytes-like object](https://docs.python.org/3.12/glossary.html#term-bytes-like-object) or ASCII string
