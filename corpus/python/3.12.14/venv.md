...
source_url: https://docs.python.org/3.12/library/venv.html
fetched_at: 2026-09-17T15:34:51+00:00
---
...
[Virtual environments](venv.md#venv-def) are created by executing the `venv`
module:
...
you have the [Python Launcher for Windows](https://docs.python.org/3.12/using/windows.html#launcher) installed. Thus, double-clicking an installed
