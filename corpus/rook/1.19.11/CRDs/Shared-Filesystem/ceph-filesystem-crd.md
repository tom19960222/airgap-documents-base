...
source_url: https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/Documentation/CRDs/Shared-Filesystem/ceph-filesystem-crd.md
...
(These definitions can also be found in the [`filesystem.yaml`](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples/filesystem.yaml) file)
...
(These definitions can also be found in the [`filesystem-ec.yaml`](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples/filesystem-ec.yaml) file.
Also see an example in the [`storageclass-ec.yaml`](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples/csi/cephfs/storageclass-ec.yaml) for how to configure the volume.)
