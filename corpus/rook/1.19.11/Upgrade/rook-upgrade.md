...
version: "1.19.11"
title: "Rook Upgrades"
source_url: https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/Documentation/Upgrade/rook-upgrade.md
...
* Helm: The rook-ceph-cluster chart has changed where the Ceph image is defined, to allow separate
    ...
    2. If desired to override the Ceph image repository or tag, apply the new
        [cephImage](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/charts/rook-ceph-cluster/values.yaml#L88-L102)
        settings such as:
