...
version: "1.19.11"
title: "OpenShift"
source_url: https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/Documentation/Getting-Started/ceph-openshift.md
...
The settings for Rook in OpenShift are described below, and are also included in the [example yaml files](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples):

* [`operator-openshift.yaml`](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples/operator-openshift.yaml): Creates the security context constraints and starts the operator deployment
* [`object-openshift.yaml`](https://github.com/rook/rook/blob/e6818be5fcdcc4e3752f1cb03a7c0fbcc12dbdf1/deploy/examples/object-openshift.yaml): Creates an object store with rgw listening on a valid port number for OpenShift
