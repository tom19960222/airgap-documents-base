...
version: "1.18.11"
title: "Snapshots"
source_url: https://github.com/rook/rook/blob/8059413c805f8ed3a0992af0113c002b0250805e/Documentation/Storage-Configuration/Ceph-CSI/ceph-csi-snapshot.md
...
In [VolumeSnapshotClass](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/rbd/snapshotclass.yaml),
...
In [snapshot](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/rbd/snapshot.yaml),
...
In [pvc-restore](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/rbd/pvc-restore.yaml),
...
In [VolumeSnapshotClass](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/cephfs/snapshotclass.yaml),
the `csi.storage.k8s.io/snapshotter-secret-name` parameter should reference the
...
In [snapshot](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/cephfs/snapshot.yaml),
`volumeSnapshotClassName` should be the name of the `VolumeSnapshotClass`
previously created. The `persistentVolumeClaimName` should be the name of the
...
In
[pvc-restore](https://github.com/rook/rook/tree/8059413c805f8ed3a0992af0113c002b0250805e/deploy/examples/csi/cephfs/pvc-restore.yaml),
`dataSource` should be the name of the `VolumeSnapshot` previously
