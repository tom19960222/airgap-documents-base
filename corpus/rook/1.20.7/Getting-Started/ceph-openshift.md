...
version: "1.20.7"
title: "OpenShift"
source_url: https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Getting-Started/ceph-openshift.md
...
The settings for Rook in OpenShift are described below, and are also included in the [example yaml files](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples):

* [`operator-openshift.yaml`](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/operator-openshift.yaml): Creates the security context constraints and starts the operator deployment
* [`object-openshift.yaml`](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/object-openshift.yaml): Creates an object store with rgw listening on a valid port number for OpenShift
