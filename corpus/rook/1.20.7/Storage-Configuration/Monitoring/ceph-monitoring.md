...
source_url: https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring.md
...
![Prometheus Monitoring Website](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring/prometheus-monitor.png)

Click on `Graph` in the top navigation bar.

![Prometheus Add graph](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring/prometheus-graph.png)
...
![Prometheus Select Metric](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring/prometheus-metric-cursor.png)

Click on the `Execute` button.

![Prometheus Execute Metric](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring/prometheus-execute-metric-cursor.png)

Below the `Execute` button, ensure the `Graph` tab is selected and you should now see a graph of your chosen metric over time.

![Prometheus Execute Metric](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/Storage-Configuration/Monitoring/ceph-monitoring/prometheus-metric-cursor-graph.png)
...
The dashboard JSON files are also available on [GitHub here `/deploy/examples/monitoring/grafana/`](https://github.com/rook/rook/tree/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/monitoring/grafana/).
