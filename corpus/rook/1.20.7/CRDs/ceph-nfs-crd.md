...
version: "1.20.7"
title: "CephNFS CRD"
source_url: https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/CRDs/ceph-nfs-crd.md
...
* `placement`: Kubernetes placement restrictions to apply to NFS server Pod(s). This is similar to
    ...
    [CephCluster CRD](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/cluster.yaml).
