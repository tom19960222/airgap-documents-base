...
source_url: https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/Documentation/CRDs/Shared-Filesystem/ceph-filesystem-crd.md
...
(These definitions can also be found in the [`filesystem.yaml`](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/filesystem.yaml) file)
...
(These definitions can also be found in the [`filesystem-ec.yaml`](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/filesystem-ec.yaml) file.
Also see an example in the [`storageclass-ec.yaml`](https://github.com/rook/rook/blob/95a8e2a8b61cf7f8152213939f995c88a2e72ab6/deploy/examples/csi/cephfs/storageclass-ec.yaml) for how to configure the volume.)
