...
source_url: https://rook.io/docs/rook/v1.17/Storage-Configuration/Object-Storage-RGW/ceph-object-multisite/
fetched_at: 2026-08-21T02:34:08+00:00
---
...
To review core multisite concepts please read the [ceph-multisite design overview](https://github.com/rook/rook/blob/release-1.17/design/ceph/object/ceph-multisite-overview.md).
...
1. A [realm](../../../CRDs/Object-Storage/ceph-object-realm-crd/index.md#settings)
2. A [zonegroup](../../../CRDs/Object-Storage/ceph-object-zonegroup-crd/index.md#settings)
3. A [zone](../../../CRDs/Object-Storage/ceph-object-zone-crd/index.md#settings)
4. A ceph object store with the `zone` section

object-multisite.yaml in the [examples](https://github.com/rook/rook/blob/release-1.17/deploy/examples/) directory can be used to create the multisite CRDs.
...
- [CephObjectRealm](../../../CRDs/Object-Storage/ceph-object-realm-crd/index.md)
- [CephObjectZoneGroup](../../../CRDs/Object-Storage/ceph-object-zonegroup-crd/index.md)
- [CephObjectZone](../../../CRDs/Object-Storage/ceph-object-zone-crd/index.md)
...
1. A [CephObjectRealm](../../../CRDs/Object-Storage/ceph-object-realm-crd/index.md#settings) matching to the realm on the other Ceph cluster, with an endpoint as described above.
2. A [CephObjectZoneGroup](../../../CRDs/Object-Storage/ceph-object-zonegroup-crd/index.md#settings) matching the master zone group name or the master CephObjectZoneGroup from the cluster the realm was pulled from.
3. A [CephObjectZone](../../../CRDs/Object-Storage/ceph-object-zone-crd/index.md#settings) referring to the CephObjectZoneGroup created above.
4. A CephObjectStore referring to the new CephObjectZone resource.

object-multisite-pull-realm.yaml (with changes) in the [examples](https://github.com/rook/rook/blob/release-1.17/deploy/examples/) directory can be used to create the multisite CRDs.
