...
version: "1.17.2"
title: "Cleanup"
source_url: https://rook.io/docs/rook/v1.17/Storage-Configuration/ceph-teardown/
fetched_at: 2026-08-21T02:34:18+00:00
---
# Cleanup
...
These commands will clean up the resources from the example application [block](../Block-Storage-RBD/block-storage/index.md#teardown) and [file](../Shared-Filesystem-CephFS/filesystem-storage/index.md#teardown) walkthroughs (unmount volumes, delete volume claims, etc).
