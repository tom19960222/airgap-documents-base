...
source_url: https://rook.io/docs/rook/v1.17/Contributing/rook-test-framework/
fetched_at: 2026-08-21T02:34:50+00:00
---
# Integration Tests
...
The CI runs the integration tests with each PR and each master or release branch build. If the tests fail in a PR, [access](../development-flow/index.md#tmate-session) the tmate for debugging.
...
Some settings are available to run the tests under different environments. The settings are all configured with environment variables. See [environment.go](https://rook.io/tests/framework/installer/environment.go) for the available environment variables.
