...
source_url: https://rook.io/docs/rook/v1.17/Getting-Started/storage-architecture/
fetched_at: 2026-08-21T02:33:58+00:00
---
...
The Rook operator is a simple container that has all that is needed to bootstrap and monitor the storage cluster. The operator will start and monitor [Ceph monitor pods](../../Storage-Configuration/Advanced/ceph-mon-health/index.md), the Ceph OSD daemons to provide RADOS storage, as well as start and manage other Ceph daemons. The operator manages CRDs for pools, object stores (S3/Swift), and filesystems by initializing the pods and other resources necessary to run the services.
...
- Ceph daemons (red layer): The Ceph daemons run the core storage architecture. See the [Glossary](../glossary/index.md#ceph) to learn more about each daemon.
