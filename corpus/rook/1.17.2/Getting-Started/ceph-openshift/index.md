...
version: "1.17.2"
title: "OpenShift"
source_url: https://rook.io/docs/rook/v1.17/Getting-Started/ceph-openshift/
...
The settings for Rook in OpenShift are described below, and are also included in the [example yaml files](https://github.com/rook/rook/blob/release-1.17/deploy/examples):

- [`operator-openshift.yaml`](https://github.com/rook/rook/blob/release-1.17/deploy/examples/operator-openshift.yaml): Creates the security context constraints and starts the operator deployment
- [`object-openshift.yaml`](https://github.com/rook/rook/blob/release-1.17/deploy/examples/object-openshift.yaml): Creates an object store with rgw listening on a valid port number for OpenShift
...
Configuration required for Openshift is automatically created by the Helm charts, such as the SecurityContextConstraints. See the [Rook Helm Charts](../../Helm-Charts/helm-charts/index.md).
...
In OpenShift, ports less than 1024 cannot be bound. In the [object store CRD](../../Storage-Configuration/Object-Storage-RGW/object-storage/index.md), ensure the port is modified to meet this requirement.
