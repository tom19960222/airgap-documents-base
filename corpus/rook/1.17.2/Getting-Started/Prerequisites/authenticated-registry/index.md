...
source_url: https://rook.io/docs/rook/v1.17/Getting-Started/Prerequisites/authenticated-registry/
fetched_at: 2026-08-21T02:33:57+00:00
---
# Authenticated Container Registries

If you want to use an image from authenticated docker registry (e.g. for image cache/mirror), you'll need to add `imagePullSecrets` to all relevant service accounts. See the next section for the required service accounts.
...
To get you started, here's a quick rundown for the ceph example from the [quickstart guide](../../quickstart/index.md).
