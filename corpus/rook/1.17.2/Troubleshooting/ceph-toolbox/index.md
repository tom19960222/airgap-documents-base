...
version: "1.17.2"
title: "Toolbox"
source_url: https://rook.io/docs/rook/v1.17/Troubleshooting/ceph-toolbox/
fetched_at: 2026-08-21T02:34:39+00:00
---
# Toolbox
...
1. [Interactive](index.md#interactive-toolbox): Start a toolbox pod where you can connect and execute Ceph commands from a shell
2. [One-time job](index.md#toolbox-job): Run a script with Ceph commands and collect the results from the job log

> **Hint:**
>
> Before running the toolbox you should have a running Rook cluster deployed (see the [Quickstart Guide](../../Getting-Started/quickstart/index.md)).

> **Note:**
>
> The toolbox is not necessary if you are using [kubectl plugin](../kubectl-plugin/index.md) to execute Ceph commands.
