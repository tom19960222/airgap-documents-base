...
source_url: https://rook.io/docs/rook/v1.17/Troubleshooting/openshift-common-issues/
fetched_at: 2026-08-21T02:34:43+00:00
---
...
1. Change the monitoring namespace to `openshift-monitoring`
   ...
   Change the namespace of the RoleBinding `rook-ceph-metrics` from `rook-ceph` to `openshift-monitoring` for the `prometheus-k8s` ServiceAccount in [rbac.yaml](https://github.com/rook/rook/blob/release-1.17/deploy/examples/monitoring/rbac.yaml#L70).
...
2. Enable Ceph Cluster monitoring
   ...
   Follow [ceph-monitoring/prometheus-alerts](../../Storage-Configuration/Monitoring/ceph-monitoring/index.md#prometheus-alerts).
