...
source_url: https://rook.io/docs/rook/v1.17/CRDs/ceph-client-crd/
fetched_at: 2026-08-21T02:34:37+00:00
---
# CephClient CRD

Rook allows creation and updating clients through the custom resource definitions (CRDs). For more information about user management and capabilities see the [Ceph docs](https://docs.ceph.com/docs/master/rados/operations/user-management/).
...
The Ceph project contains a [SQLite VFS](https://www.sqlite.org/vfs.html) that interacts with RADOS directly, called [`libcephsqlite`](https://docs.ceph.com/en/latest/rados/api/libcephsqlite/).
...
After creating a `CephClient` similar to [`deploy/examples/sqlitevfs-client.yaml`](https://github.com/rook/rook/blob/release-1.17/deploy/examples/sqlitevfs-client.yaml) and retrieving it's credentials, you may set the following ENV variables:
...
See [the libcephsqlite documentation](https://docs.ceph.com/en/latest/rados/api/libcephsqlite/) for more information on the VFS and database URL format.
