...
source_url: https://rook.io/docs/rook/v1.17/CRDs/Cluster/host-cluster/
...
More commonly, you will want to be more specific about which nodes and devices where Rook should configure the storage. The placement settings are very flexible to add node affinity, anti-affinity, or tolerations. For more options, see the [placement documentation](../ceph-cluster-crd/index.md#placement-configuration-settings).
