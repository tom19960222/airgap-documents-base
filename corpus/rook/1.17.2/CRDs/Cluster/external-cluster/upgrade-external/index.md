...
collection: rook
version: "1.17.2"
title: "External Cluster Upgrades"
source_url: https://rook.io/docs/rook/v1.17/CRDs/Cluster/external-cluster/upgrade-external/
...
4. Run the python script again using the [config file](../provider-export/index.md#config-file)
5. [Copy the bash output](../provider-export/index.md#2-copy-the-bash-output)
6. [Import-the-provider-data](../consumer-import/index.md#import-the-provider-data)
