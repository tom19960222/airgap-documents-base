...
source_url: https://rook.io/docs/rook/v1.17/CRDs/Block-Storage/ceph-block-pool-rados-namespace-crd/
fetched_at: 2026-08-21T02:34:30+00:00
---
...
A namespace would be a division of a pool into separate logical namespaces. For more information about BlockPool and namespace refer to the [Ceph docs](https://docs.ceph.com/en/latest/man/8/rbd/)
...
Rook allows creation of Ceph BlockPool [RadosNamespaces](https://docs.ceph.com/en/latest/man/8/rbd/) through the custom resource definitions (CRDs).
