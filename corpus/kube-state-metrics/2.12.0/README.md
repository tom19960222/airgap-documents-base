...
version: "2.12.0"
title: "Overview"
source_url: https://github.com/kubernetes/kube-state-metrics/blob/1e8b837eb1fa1cb2dc3c37821637334e2dd47488/README.md
...
> [!NOTE]
> This README is generated from a [template](./README.md.tpl) <!-- unresolved-source-link: target=./README.md.tpl -->. Please make your changes there and run `make generate-template`.
...
See the [`docs`](docs) <!-- unresolved-source-link: target=docs --> directory for more information on the exposed metrics.
...
run-time configuration, see [`/examples/prometheus-alerting-rules`](./examples/prometheus-alerting-rules) <!-- unresolved-source-link: target=./examples/prometheus-alerting-rules -->.
...
By default, kube-state-metrics exposes several metrics for events across your cluster. If you have a large number of frequently-updating resources on your cluster, you may find that a lot of data is ingested into these metrics. This can incur high costs on some cloud providers. Please take a moment to [configure what metrics you'd like to expose](cli-arguments.md), as well as consult the documentation for your Kubernetes environment in order to avoid unexpectedly high costs.
...
For the full list of arguments available, see the documentation in [docs/cli-arguments.md](cli-arguments.md)
...
To run the e2e tests locally see the documentation in [tests/README.md](https://github.com/kubernetes/kube-state-metrics/blob/1e8b837eb1fa1cb2dc3c37821637334e2dd47488/tests/README.md).

#### Developer Contributions

When developing, there are certain code patterns to follow to better your contributing experience and likelihood of e2e and other ci tests to pass. To learn more about them, see the documentation in [docs/developer/guide.md](developer/guide.md).
