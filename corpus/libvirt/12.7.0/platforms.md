...
collection: libvirt
version: "12.7.0"
title: "Supported host platforms"
source_url: https://libvirt.org/platforms.html
fetched_at: 2026-08-21T04:09:13+00:00
---
# Supported host platforms

Contents

- [Build targets](platforms.md#build-targets)

  - [Linux, FreeBSD and macOS](platforms.md#linux-freebsd-and-macos)
  - [Windows](platforms.md#windows)
- [Virtualization platforms](platforms.md#virtualization-platforms)
...
# [Build targets](platforms.md#id1)
...
The [Repology](https://repology.org/) site is a useful resource to identify currently shipped
versions of software in various operating systems, though it does not cover all
distros listed below.

- [libvirt on Repology](https://repology.org/metapackage/libvirt/versions)
- [qemu on Repology](https://repology.org/metapackage/qemu/versions)

## [Linux, FreeBSD and macOS](platforms.md#id2)
...
for macOS, [Homebrew](https://brew.sh/) will be used, although [MacPorts](https://www.macports.org/) is expected to carry
similar versions.

## [Windows](platforms.md#id3)
...
# [Virtualization platforms](platforms.md#id4)

For [hypervisor drivers](drivers.md) which execute locally (QEMU, LXC, VZ, libxl, etc),
