...
collection: libvirt
version: "12.7.0"
title: "Libvirt SSH proxy"
source_url: https://libvirt.org/ssh-proxy.html
fetched_at: 2026-08-21T04:10:10+00:00
---
# Libvirt SSH proxy

Sometimes it's necessary to run some commands inside a guest. While libvirt
already provides a [NSS module](nss.md) that can translate guest name to
...
inside the guest, it is a must to configure VSOCK in the [domain XML](formatdomain.md#vsock).
