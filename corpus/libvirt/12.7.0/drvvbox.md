...
collection: libvirt
version: "12.7.0"
title: "VirtualBox hypervisor driver"
source_url: https://libvirt.org/drvvbox.html
...
onwards ( since libvirt 3.0.0 ).

# Project Links

- The [VirtualBox](https://www.virtualbox.org/) hypervisor
