...
version: "12.7.0"
title: "Bug reporting"
source_url: https://libvirt.org/bugs.html
...
- [Security Issues](bugs.md#security-issues)
- [Bug Tracking](bugs.md#bug-tracking)
- [General libvirt bug reports](bugs.md#general-libvirt-bug-reports)
- [Linux Distribution specific bug reports](bugs.md#linux-distribution-specific-bug-reports)
- [Use of automated tools / AI agents](bugs.md#use-of-automated-tools-ai-agents)
- [How to file high quality bug reports](bugs.md#how-to-file-high-quality-bug-reports)

# [Security Issues](bugs.md#id1)
...
issues](https://libvirt.org/securityprocess.html) that should be used instead. So if your issue
has security implications, ignore the rest of this page and follow the [security
process](https://libvirt.org/securityprocess.html) instead.

# [Bug Tracking](bugs.md#id2)
...
# [General libvirt bug reports](bugs.md#id3)

Bugs in upstream libvirt code should be reported as issues in the appropriate
[project on GitLab.](https://gitlab.com/libvirt) Before submitting a ticket,
...
submitting patches on [the libvirt mailing lists](https://libvirt.org/contact.html) will increase
...
[contributor guidelines](hacking.md), especially the first point: "Discuss
...
- [New libvirt.git ticket](https://gitlab.com/libvirt/libvirt/-/issues/new)
...
# [Linux Distribution specific bug reports](bugs.md#id4)

- If you are using binaries from **Fedora**, enter tickets against the
  Fedora product and the libvirt component.

  - [View Fedora libvirt
    tickets](https://bugzilla.redhat.com/buglist.cgi?component=libvirt&product=Fedora)
  - [New Fedora libvirt
    ticket](https://bugzilla.redhat.com/bugzilla/enter_bug.cgi?product=Fedora&component=libvirt)
- If you are using binaries from **Red Hat Enterprise Linux**, enter tickets
  ...
  [additional guidance](https://bugzilla.redhat.com) about getting support
...
# [Use of automated tools / AI agents](bugs.md#id5)
...
# [How to file high quality bug reports](bugs.md#id6)
