...
source_url: https://libvirt.org/uri.html
...
- [Specifying URIs to libvirt](uri.md#specifying-uris-to-libvirt)
- [Configuring URI aliases](uri.md#configuring-uri-aliases)
- [Default URI choice](uri.md#default-uri-choice)
- [Specifying URIs to virsh, virt-manager and virt-install](uri.md#specifying-uris-to-virsh-virt-manager-and-virt-install)
- [Local hypervisor URIs](uri.md#local-hypervisor-uris)

  - [xen:///system URI](uri.md#xen-system-uri)
  - [qemu:///... QEMU and KVM URIs](uri.md#qemu-qemu-and-kvm-uris)
  - [test:///... Test URIs](uri.md#test-test-uris)
- [Remote URIs](uri.md#remote-uris)

  - [Transport configuration](uri.md#transport-configuration)

    - [ssh transport](uri.md#ssh-transport)
    - [libssh and libssh2 transport](uri.md#libssh-and-libssh2-transport)
    - [tls transport](uri.md#tls-transport)
    - [unix transport](uri.md#unix-transport)
    - [ext transport](uri.md#ext-transport)
    - [tcp transport](uri.md#tcp-transport)
  - [Common extra parameters](uri.md#common-extra-parameters)

    - [mode parameter](uri.md#mode-parameter)
    - [proxy parameter](uri.md#proxy-parameter)
    - [socket parameter](uri.md#socket-parameter)
    - [netcat parameter](uri.md#netcat-parameter)
    - [keyfile parameter](uri.md#keyfile-parameter)
...
2396](https://www.ietf.org/rfc/rfc2396.txt). This page documents libvirt
URIs.

# [Specifying URIs to libvirt](uri.md#id1)

The URI is passed as the name parameter to
[virConnectOpen](https://libvirt.org/html/libvirt-libvirt-host.html#virConnectOpen) or
[virConnectOpenReadOnly](https://libvirt.org/html/libvirt-libvirt-host.html#virConnectOpenReadOnly)
. For example:
...
# [Configuring URI aliases](uri.md#id2)
...
# [Specifying URIs to virsh, virt-manager and virt-install](uri.md#id4)
...
# [Local hypervisor URIs](uri.md#id5)

## [xen:///system URI](uri.md#id6)
...
## [qemu:///... QEMU and KVM URIs](uri.md#id7)
...
in the [guest XML as described here](drvqemu.md#example-domain-xml-config).

## [test:///... Test URIs](uri.md#id8)
...
## [Transport configuration](uri.md#id10)
...
[URI-escaped](https://gnome.pages.gitlab.gnome.org/libxml2/devhelp/libxml2-uri.html#xmlURIEscapeStr).
...
> mode
> :   See the info on the [mode parameter](uri.md#mode-parameter).
>
> proxy
> :   See the info on the [proxy parameter](uri.md#proxy-parameter).
>
> command
...
>
> socket
> :   See the info on the [socket parameter](uri.md#socket-parameter).
>
> netcat
> :   See the info on the [netcat parameter](uri.md#netcat-parameter).
>
> keyfile
> :   See the info on the [keyfile parameter](uri.md#keyfile-parameter).
>
> no_verify
...
### [libssh and libssh2 transport](uri.md#id12)
...
>     or IP address you must [change the libvirtd configuration](remote.md#libvirtd-configuration-file)
>
>     **Example:** no_verify=1
>
> pkipath
...
## [Common extra parameters](uri.md#id17)
