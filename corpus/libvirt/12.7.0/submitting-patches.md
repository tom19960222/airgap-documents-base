...
source_url: https://libvirt.org/submitting-patches.html
fetched_at: 2026-08-21T04:09:42+00:00
---
# Submitting patches

The simplest way to send patches is to use the
[git-publish](https://github.com/stefanha/git-publish)
...
patch submission threads from the [mailing list archive](https://libvirt.org/contact.html#mailing-lists) of the mailing list from the
.gitpublish file.
...
More hints on compiling can be found [here](compiling.md).
Make sure to express your agreement with the [Developer Certificate
of Origin](hacking.md#developer-certificate-of-origin) by
...
[devel list
archives](https://lists.libvirt.org/archives/list/devel@lists.libvirt.org/) in a
