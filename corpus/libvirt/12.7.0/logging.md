...
collection: libvirt
version: "12.7.0"
title: "Logging in the library and the daemon"
source_url: https://libvirt.org/logging.html
...
- [Logging in the library](logging.md#logging-in-the-library)
- [Configuring logging in the library](logging.md#configuring-logging-in-the-library)
- [Logging in the daemon](logging.md#logging-in-the-daemon)
- [Syntax for filters and output values](logging.md#syntax-for-filters-and-output-values)
- [Systemd journal fields](logging.md#systemd-journal-fields)

  - [Well known message ID values](logging.md#well-known-message-id-values)
- [Examples](logging.md#examples)

Libvirt includes logging facilities starting from version 0.6.0, this
complements the [error handling](errors.md) mechanism and APIs to allow
tracing through the execution of the library as well as in the libvirtd daemon.

# [Logging in the library](logging.md#id1)
...
# [Configuring logging in the library](logging.md#id2)
...
# [Logging in the daemon](logging.md#id3)
...
# [Syntax for filters and output values](logging.md#id4)
...
# [Systemd journal fields](logging.md#id5)
...
## [Well known message ID values](logging.md#id6)
...
[logging knowledge base article](kbase/debuglogs.md).
