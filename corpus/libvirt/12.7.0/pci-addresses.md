...
collection: libvirt
version: "12.7.0"
title: "PCI addresses in domain XML and guest OS"
source_url: https://libvirt.org/pci-addresses.html
...
- [Simple cases](pci-addresses.md#simple-cases)
- [More complex cases](pci-addresses.md#more-complex-cases)

  - [pcie-expander-bus](pci-addresses.md#pcie-expander-bus)
  - [spapr-pci-host-bridge](pci-addresses.md#spapr-pci-host-bridge)
  - [zPCI addresses](pci-addresses.md#zpci-addresses)
- [Device assignment](pci-addresses.md#device-assignment)
- [Reserved addresses](pci-addresses.md#reserved-addresses)
...
# [Simple cases](pci-addresses.md#id1)
...
# [More complex cases](pci-addresses.md#id2)
...
## [pcie-expander-bus](pci-addresses.md#id3)
...
## [spapr-pci-host-bridge](pci-addresses.md#id4)
...
## [zPCI addresses](pci-addresses.md#id5)
...
# [Device assignment](pci-addresses.md#id6)
...
# [Reserved addresses](pci-addresses.md#id7)
