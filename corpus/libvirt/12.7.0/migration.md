...
source_url: https://libvirt.org/migration.html
fetched_at: 2026-08-21T04:10:00+00:00
---
# Guest migration

Contents

- [Network data transports](migration.md#network-data-transports)

  - [Hypervisor native transport](migration.md#hypervisor-native-transport)
  - [libvirt tunnelled transport](migration.md#libvirt-tunnelled-transport)
- [Communication control paths/flows](migration.md#communication-control-paths-flows)

  - [Managed direct migration](migration.md#managed-direct-migration)
  - [Managed peer to peer migration](migration.md#managed-peer-to-peer-migration)
  - [Unmanaged direct migration](migration.md#unmanaged-direct-migration)
- [Data security](migration.md#data-security)
- [Offline migration](migration.md#offline-migration)
- [Migration URIs](migration.md#migration-uris)
- [Configuration file handling](migration.md#configuration-file-handling)
- [Migration scenarios](migration.md#migration-scenarios)

  - [Native migration, client to two libvirtd servers](migration.md#native-migration-client-to-two-libvirtd-servers)
  - [Native migration, client to and peer2peer between, two libvirtd servers](migration.md#native-migration-client-to-and-peer2peer-between-two-libvirtd-servers)
  - [Tunnelled migration, client and peer2peer between two libvirtd servers](migration.md#tunnelled-migration-client-and-peer2peer-between-two-libvirtd-servers)
  - [Native migration, client to one libvirtd server](migration.md#native-migration-client-to-one-libvirtd-server)
  - [Native migration, peer2peer between two libvirtd servers](migration.md#native-migration-peer2peer-between-two-libvirtd-servers)
  - [Tunnelled migration, peer2peer between two libvirtd servers](migration.md#tunnelled-migration-peer2peer-between-two-libvirtd-servers)
  - [Migration using only UNIX sockets](migration.md#migration-using-only-unix-sockets)
  - [Migration of VMs using non-shared images for disks](migration.md#migration-of-vms-using-non-shared-images-for-disks)
...
# [Network data transports](migration.md#id1)
...
## [Hypervisor native transport](migration.md#id2)
...
![Migration native path](images/migration-native.png)

## [libvirt tunnelled transport](migration.md#id3)
...
[remote access](remote.md), and there is only need for a single port to be
...
![Migration tunnel path](images/migration-tunnel.png)

# [Communication control paths/flows](migration.md#id4)
...
## [Managed direct migration](migration.md#id5)
...
![Migration direct, managed](images/migration-managed-direct.png)

## [Managed peer to peer migration](migration.md#id6)
...
![Migration peer-to-peer](images/migration-managed-p2p.png)

## [Unmanaged direct migration](migration.md#id7)
...
![Migration direct, unmanaged](images/migration-unmanaged-direct.png)

# [Data security](migration.md#id8)
...
# [Offline migration](migration.md#id9)
...
# [Migration URIs](migration.md#id10)
...
1. The configured hostname is incorrect, or DNS is broken. If a host has a
...
2. The host has multiple network interfaces. If a host has multiple network
...
3. The firewall restricts what ports are available. When libvirt generates a
...
4. The second URI uses UNIX transport method. In this advanced case libvirt
   should not guess a \*migrateuri\* and it should be specified using UNIX
   socket path URI: unix:///path/to/socket.

# [Configuration file handling](migration.md#id11)
...
# [Migration scenarios](migration.md#id12)

## [Native migration, client to two libvirtd servers](migration.md#id13)
...
## [Native migration, client to and peer2peer between, two libvirtd servers](migration.md#id14)
...
## [Tunnelled migration, client and peer2peer between two libvirtd servers](migration.md#id15)
...
## [Native migration, client to one libvirtd server](migration.md#id16)
...
## [Native migration, peer2peer between two libvirtd servers](migration.md#id17)
...
## [Tunnelled migration, peer2peer between two libvirtd servers](migration.md#id18)
...
## [Migration using only UNIX sockets](migration.md#id19)
...
## [Migration of VMs using non-shared images for disks](migration.md#id20)
