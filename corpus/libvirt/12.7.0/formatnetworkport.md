...
collection: libvirt
version: "12.7.0"
title: "Network port XML format"
source_url: https://libvirt.org/formatnetworkport.html
fetched_at: 2026-08-21T04:09:45+00:00
---
# Network port XML format

Contents

- [Element and attribute overview](formatnetworkport.md#element-and-attribute-overview)

  - [General metadata](formatnetworkport.md#general-metadata)
  - [Common elements](formatnetworkport.md#common-elements)
  - [Plugs](formatnetworkport.md#plugs)

    - [Network](formatnetworkport.md#network)
    - [Bridge](formatnetworkport.md#bridge)
    - [Direct](formatnetworkport.md#direct)
    - [Host PCI](formatnetworkport.md#host-pci)
...
# [Element and attribute overview](formatnetworkport.md#id1)
...
## [General metadata](formatnetworkport.md#id2)
...
## [Common elements](formatnetworkport.md#id3)
...
:   This part of the network port XML provides setting quality of service.
    ...
    [QoS](formatnetwork.md#quality-of-service) section of the Network XML. In
...
:   The virtualport element describes metadata that needs to be provided to
    ...
    [interface documentation](formatdomain.md#network-interfaces).

## [Plugs](formatnetworkport.md#id4)

The plug element has varying content depending on the value of the type
attribute.

### [Network](formatnetworkport.md#id5)
...
### [Bridge](formatnetworkport.md#id6)
...
### [Direct](formatnetworkport.md#id7)
...
XML](formatdomain.md#direct-attachment-to-physical-interface).

### [Host PCI](formatnetworkport.md#id8)
