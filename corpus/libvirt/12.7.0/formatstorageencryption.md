...
collection: libvirt
version: "12.7.0"
title: "Storage volume encryption XML format"
source_url: https://libvirt.org/formatstorageencryption.html
...
- [Storage volume encryption XML](formatstorageencryption.md#storage-volume-encryption-xml)

  - [qcow format](formatstorageencryption.md#qcow-format)
  - [luks format](formatstorageencryption.md#luks-format)
  - [luks2 format](formatstorageencryption.md#luks2-format)
  - [luks-any format](formatstorageencryption.md#luks-any-format)
- [Examples](formatstorageencryption.md#examples)

# [Storage volume encryption XML](formatstorageencryption.md#id1)
...
tag. since 9.3.0 RBD layered encryption is supported. Layered
...
since 2.1.0 ). The only currently defined value of type is
...
## [qcow format](formatstorageencryption.md#id2)

Since 4.5.0, encryption formats default and qcow may no longer
...
## [luks format](formatstorageencryption.md#id3)
...
## [luks2 format](formatstorageencryption.md#id4)
...
## [luks-any format](formatstorageencryption.md#id5)
...
for the case of RBD layered encryption mentioned above) Since 9.3.0.

# [Examples](formatstorageencryption.md#id6)

Assuming a [luks volume type secret](formatsecret.md#usage-type-volume) is
...
algorithm for volume creation. Since 6.10.0, the target format can
