...
source_url: https://libvirt.org/kbase/memorydevices.html
...
- [Basics](memorydevices.md#basics)
- [virtio-mem model](memorydevices.md#virtio-mem-model)

# [Basics](memorydevices.md#id1)
...
See [memory devices documentation](../formatdomain.md#memory-devices).

# [virtio-mem model](memorydevices.md#id2)
...
1. The maximum size the device can ever offer, exposed under <size/>
2. The size of a single block, exposed under <block/>
3. The current size exposed to the guest, exposed under <requested/>
