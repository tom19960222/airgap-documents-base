...
collection: libvirt
version: "12.7.0"
title: "Disk image chains"
source_url: https://libvirt.org/kbase/backing_chains.html
fetched_at: 2026-08-21T04:09:49+00:00
---
# Disk image chains
...
- [Domain XML image and chain specification](backing_chains.md#domain-xml-image-and-chain-specification)

  - [Basic disk setup](backing_chains.md#basic-disk-setup)
  - [Importance of proper backing chain setup](backing_chains.md#importance-of-proper-backing-chain-setup)
  - [Image detection caveats](backing_chains.md#image-detection-caveats)
  - [Advanced backing chain specifications](backing_chains.md#advanced-backing-chain-specifications)
- [Manual image creation](backing_chains.md#manual-image-creation)
- [Troubleshooting](backing_chains.md#troubleshooting)

  - [VM refuses to start due to misconfigured backing store format](backing_chains.md#vm-refuses-to-start-due-to-misconfigured-backing-store-format)
  - [Missing images reported after moving disk images into a different path](backing_chains.md#missing-images-reported-after-moving-disk-images-into-a-different-path)

# [Domain XML image and chain specification](backing_chains.md#id1)
...
## [Basic disk setup](backing_chains.md#id2)
...
## [Importance of proper backing chain setup](backing_chains.md#id3)
...
## [Image detection caveats](backing_chains.md#id4)
...
## [Advanced backing chain specifications](backing_chains.md#id5)
...
is supported only when the [backingStoreInput](../formatdomaincaps.md#backingstoreinput) capability is present.
...
# [Manual image creation](backing_chains.md#id6)
...
# [Troubleshooting](backing_chains.md#id7)

A few common problems which occur when managing chains of disk images.

## [VM refuses to start due to misconfigured backing store format](backing_chains.md#id8)
...
## [Missing images reported after moving disk images into a different path](backing_chains.md#id9)
