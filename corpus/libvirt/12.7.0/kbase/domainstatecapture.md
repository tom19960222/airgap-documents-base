...
collection: libvirt
version: "12.7.0"
title: "Domain state capture using Libvirt"
source_url: https://libvirt.org/kbase/domainstatecapture.html
fetched_at: 2026-08-21T04:09:48+00:00
---
# Domain state capture using Libvirt

Contents

- [State capture trade-offs](domainstatecapture.md#state-capture-trade-offs)
- [State capture APIs](domainstatecapture.md#state-capture-apis)
- [Examples](domainstatecapture.md#examples)

  - [Backup via temporary snapshot](domainstatecapture.md#backup-via-temporary-snapshot)
  - [Direct backup](domainstatecapture.md#direct-backup)
...
# [State capture trade-offs](domainstatecapture.md#id1)
...
# [State capture APIs](domainstatecapture.md#id2)

With those definitions, the following libvirt APIs related to state
capture have these properties:

[virDomainManagedSave](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainManagedSave)
...
[virDomainSave](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainSave)
...
[virDomainSnapshotCreateXML](https://libvirt.org/html/libvirt-libvirt-domain-snapshot.html#virDomainSnapshotCreateXML)
:   This API wraps several approaches for capturing guest state, with a
    ...
    can be coupled with
    [virDomainBlockCommit()](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainBlockCommit)
    ...
    commit. See also the [XML details](../formatsnapshot.md) used with
    this command.

[virDomainFSFreeze](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainFSFreeze), [virDomainFSThaw](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainFSThaw)
...
[virDomainCheckpointCreateXML](https://libvirt.org/html/libvirt-libvirt-domain-checkpoint.html#virDomainCheckpointCreateXML)
:   This API does not actually capture guest state, rather it makes it
    ...
    See also the [XML details](../formatcheckpoint.md) used with this
    command.

[virDomainBackupBegin](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainBackupBegin)
...
# [Examples](domainstatecapture.md#id3)
...
## [Backup via temporary snapshot](domainstatecapture.md#id4)
...
## [Direct backup](domainstatecapture.md#id5)
