...
collection: libvirt
version: "12.7.0"
title: "RPM Deployment Guidance"
source_url: https://libvirt.org/kbase/rpm-deployment.html
...
- [Deployment choices](rpm-deployment.md#deployment-choices)

  - [Full features for one virt driver](rpm-deployment.md#full-features-for-one-virt-driver)
  - [Client only install](rpm-deployment.md#client-only-install)
  - [Minimal features for one virt driver](rpm-deployment.md#minimal-features-for-one-virt-driver)
  - [Every possible virt driver](rpm-deployment.md#every-possible-virt-driver)
- [RPM packages](rpm-deployment.md#rpm-packages)
...
# [Deployment choices](rpm-deployment.md#id1)

## [Full features for one virt driver](rpm-deployment.md#id2)
...
## [Client only install](rpm-deployment.md#id3)
...
## [Minimal features for one virt driver](rpm-deployment.md#id4)
...
## [Every possible virt driver](rpm-deployment.md#id5)
...
# [RPM packages](rpm-deployment.md#id6)
...
- libvirt-daemon-driver-storage-sheepdog
  ...
  sub-package was removed in libvirt-8.8 as the sheepdog backend
