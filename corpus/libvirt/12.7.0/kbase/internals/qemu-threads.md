...
collection: libvirt
version: "12.7.0"
title: "QEMU Driver Threading: The Rules"
source_url: https://libvirt.org/kbase/internals/qemu-threads.html
...
- [Basic locking primitives](qemu-threads.md#basic-locking-primitives)
- [Helper methods](qemu-threads.md#helper-methods)
- [Design patterns](qemu-threads.md#design-patterns)
...
# [Basic locking primitives](qemu-threads.md#id1)
...
# [Helper methods](qemu-threads.md#id2)
...
# [Design patterns](qemu-threads.md#id3)
