...
collection: libvirt
version: "12.7.0"
title: "Internals of incremental backup handling in qemu"
source_url: https://libvirt.org/kbase/internals/incremental-backup.html
fetched_at: 2026-08-21T04:09:59+00:00
---
# Internals of incremental backup handling in qemu

Contents

- [Glossary](incremental-backup.md#glossary)
- [Relationships of bitmaps, checkpoints and VM disks](incremental-backup.md#relationships-of-bitmaps-checkpoints-and-vm-disks)
- [Integration with external snapshots](incremental-backup.md#integration-with-external-snapshots)

  - [External snapshot terminology](incremental-backup.md#external-snapshot-terminology)
  - [Handling of bitmaps during snapshots](incremental-backup.md#handling-of-bitmaps-during-snapshots)
  - [Manipulating bitmaps in shell](incremental-backup.md#manipulating-bitmaps-in-shell)
  - [Checking bitmap health](incremental-backup.md#checking-bitmap-health)
  - [Creating external snapshots manually](incremental-backup.md#creating-external-snapshots-manually)
  - [Committing external snapshots manually](incremental-backup.md#committing-external-snapshots-manually)
...
# [Glossary](incremental-backup.md#id1)

See the knowledge base article on [domain state capture](../domainstatecapture.md) for a deeper explanation of some of the
concepts.
...
# [Relationships of bitmaps, checkpoints and VM disks](incremental-backup.md#id2)
...
# [Integration with external snapshots](incremental-backup.md#id3)

## [External snapshot terminology](incremental-backup.md#id4)
...
## [Handling of bitmaps during snapshots](incremental-backup.md#id5)
...
## [Manipulating bitmaps in shell](incremental-backup.md#id6)
...
## [Checking bitmap health](incremental-backup.md#id7)
...
## [Creating external snapshots manually](incremental-backup.md#id8)
...
## [Committing external snapshots manually](incremental-backup.md#id9)
