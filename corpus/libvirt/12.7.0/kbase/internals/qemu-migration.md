...
collection: libvirt
version: "12.7.0"
title: "QEMU Migration Phases"
source_url: https://libvirt.org/kbase/internals/qemu-migration.html
fetched_at: 2026-08-21T04:10:04+00:00
---
# [QEMU Migration Phases](qemu-migration.md#id1)

Contents

- [QEMU Migration Phases](qemu-migration.md#qemu-migration-phases)

  - [Migration protocol v2 API Sequence](qemu-migration.md#migration-protocol-v2-api-sequence)
  - [Migration protocol v3 API Sequence](qemu-migration.md#migration-protocol-v3-api-sequence)
- [QEMU Migration Locking Rules](qemu-migration.md#qemu-migration-locking-rules)
...
## [Migration protocol v2 API Sequence](qemu-migration.md#id2)
...
## [Migration protocol v3 API Sequence](qemu-migration.md#id3)
...
# [QEMU Migration Locking Rules](qemu-migration.md#id4)
...
primitives (described in [qemu-threads](qemu-threads.md)) in the right way:
