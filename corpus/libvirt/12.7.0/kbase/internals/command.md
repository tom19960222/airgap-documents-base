...
collection: libvirt
version: "12.7.0"
title: "Spawning processes / commands from libvirt drivers"
source_url: https://libvirt.org/kbase/internals/command.html
fetched_at: 2026-08-21T04:10:01+00:00
---
# Spawning processes / commands from libvirt drivers

Contents

- [Problems with standard POSIX APIs](command.md#problems-with-standard-posix-apis)
- [The libvirt command execution API](command.md#the-libvirt-command-execution-api)

  - [Defining commands in libvirt](command.md#defining-commands-in-libvirt)
  - [Adding arguments to the command](command.md#adding-arguments-to-the-command)
  - [Setting up the environment](command.md#setting-up-the-environment)
  - [Miscellaneous other options](command.md#miscellaneous-other-options)
  - [Reducing command privileges](command.md#reducing-command-privileges)
  - [Managing file handles](command.md#managing-file-handles)
  - [Feeding & capturing strings to/from the child](command.md#feeding-capturing-strings-to-from-the-child)
  - [Setting working directory](command.md#setting-working-directory)
  - [Any additional hooks](command.md#any-additional-hooks)
  - [Logging commands](command.md#logging-commands)
  - [Running commands synchronously](command.md#running-commands-synchronously)
  - [Running commands asynchronously](command.md#running-commands-asynchronously)
  - [Releasing resources](command.md#releasing-resources)
- [Complete examples](command.md#complete-examples)
...
# [Problems with standard POSIX APIs](command.md#id1)
...
# [The libvirt command execution API](command.md#id2)
...
## [Defining commands in libvirt](command.md#id3)
...
## [Adding arguments to the command](command.md#id4)
...
## [Setting up the environment](command.md#id5)
...
## [Miscellaneous other options](command.md#id6)
...
## [Reducing command privileges](command.md#id7)
...
## [Managing file handles](command.md#id8)
...
## [Feeding & capturing strings to/from the child](command.md#id9)
...
## [Setting working directory](command.md#id10)
...
## [Any additional hooks](command.md#id11)
...
## [Logging commands](command.md#id12)
...
## [Running commands synchronously](command.md#id13)
...
## [Running commands asynchronously](command.md#id14)
...
## [Releasing resources](command.md#id15)
...
# [Complete examples](command.md#id16)
