...
collection: libvirt
version: "12.7.0"
title: "libvirt RPC infrastructure"
source_url: https://libvirt.org/kbase/internals/rpc.html
fetched_at: 2026-08-21T04:10:03+00:00
---
# libvirt RPC infrastructure

Contents

- [RPC protocol](rpc.md#rpc-protocol)

  - [Packet framing](rpc.md#packet-framing)
  - [Packet data](rpc.md#packet-data)
  - [Packet header](rpc.md#packet-header)
  - [Packet payload](rpc.md#packet-payload)
  - [Wire examples](rpc.md#wire-examples)

    - [Method call](rpc.md#method-call)
    - [Method call with error](rpc.md#method-call-with-error)
    - [Method call with upload stream](rpc.md#method-call-with-upload-stream)
    - [Method call bidirectional stream](rpc.md#method-call-bidirectional-stream)
    - [Method calls overlapping](rpc.md#method-calls-overlapping)
    - [Method call with passed FD](rpc.md#method-call-with-passed-fd)
- [RPC security](rpc.md#rpc-security)

  - [Authentication/encryption](rpc.md#authentication-encryption)
  - [Data limits](rpc.md#data-limits)
  - [Data validation](rpc.md#data-validation)
- [RPC internal APIs](rpc.md#rpc-internal-apis)

  - [Overview of RPC objects](rpc.md#overview-of-rpc-objects)
  - [Client RPC dispatch](rpc.md#client-rpc-dispatch)

    - [Example with buck passing](rpc.md#example-with-buck-passing)
    - [Example without buck passing](rpc.md#example-without-buck-passing)
    - [Example with async events](rpc.md#example-with-async-events)
  - [Server RPC dispatch](rpc.md#server-rpc-dispatch)

    - [Example with overlapping methods](rpc.md#example-with-overlapping-methods)
    - [Example with stream data](rpc.md#example-with-stream-data)
...
standard](https://en.wikipedia.org/wiki/External_Data_Representation) as
currently defined by [RFC 4506](https://tools.ietf.org/html/rfc4506). On any
...
:   This can one of the following enumeration values
    ...
    1. ok: a normal packet. this is always set for method calls or events. For
    ...
    2. error: for replies this indicates that the method call failed and error
       information is being returned. For streams this indicates that not all
       data was sent and the stream has aborted
    3. continue: for streams this indicates that further data packets will be
       following

## [Packet payload](rpc.md#id5)
...
### [Method call with error](rpc.md#id8)
...
### [Method call with upload stream](rpc.md#id9)
...
### [Method call bidirectional stream](rpc.md#id10)
...
### [Method calls overlapping](rpc.md#id11)
...
### [Method call with passed FD](rpc.md#id12)
...
## [Overview of RPC objects](rpc.md#id18)
...
## [Client RPC dispatch](rpc.md#id19)
...
### [Example with buck passing](rpc.md#id20)
...
### [Example without buck passing](rpc.md#id21)
...
### [Example with async events](rpc.md#id22)
...
## [Server RPC dispatch](rpc.md#id23)
...
### [Example with overlapping methods](rpc.md#id24)
...
### [Example with stream data](rpc.md#id25)
