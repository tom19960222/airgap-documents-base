...
collection: libvirt
version: "12.7.0"
title: "Libvirt migration internals"
source_url: https://libvirt.org/kbase/internals/migration.html
...
- [Migration protocol](migration.md#migration-protocol)

  - [Version 3 protocol sequence](migration.md#version-3-protocol-sequence)
- ["virsh migrate" entry point](migration.md#virsh-migrate-entry-point)

  - [virDomainMigrate3 function](migration.md#virdomainmigrate3-function)
  - [virDomainMigrateToURI3 function](migration.md#virdomainmigratetouri3-function)
- [QEMU driver specifics](migration.md#qemu-driver-specifics)
...
code level, as a way to complement [the base migration docs](../../migration.md)
...
# [Migration protocol](migration.md#id1)
...
## [Version 3 protocol sequence](migration.md#id2)
...
# ["virsh migrate" entry point](migration.md#id3)
...
## [virDomainMigrate3 function](migration.md#id4)
...
## [virDomainMigrateToURI3 function](migration.md#id5)
...
# [QEMU driver specifics](migration.md#id6)
