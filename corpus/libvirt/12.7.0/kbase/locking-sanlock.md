...
collection: libvirt
version: "12.7.0"
title: "Virtual machine lock manager, sanlock plugin"
source_url: https://libvirt.org/kbase/locking-sanlock.html
fetched_at: 2026-08-21T04:09:52+00:00
---
# Virtual machine lock manager, sanlock plugin

Contents

- [Sanlock daemon setup](locking-sanlock.md#sanlock-daemon-setup)
- [libvirt sanlock plugin configuration](locking-sanlock.md#libvirt-sanlock-plugin-configuration)
- [libvirt sanlock storage configuration](locking-sanlock.md#libvirt-sanlock-storage-configuration)
- [QEMU/KVM driver configuration](locking-sanlock.md#qemu-kvm-driver-configuration)
- [Domain configuration](locking-sanlock.md#domain-configuration)

This page describes use of the
[sanlock](https://fedorahosted.org/sanlock/) service as a [lock
driver](locking.md) plugin for virtual machine disk mutual
exclusion.

# [Sanlock daemon setup](locking-sanlock.md#id1)
...
# [libvirt sanlock plugin configuration](locking-sanlock.md#id2)
...
# [libvirt sanlock storage configuration](locking-sanlock.md#id3)
...
# [QEMU/KVM driver configuration](locking-sanlock.md#id4)
...
# [Domain configuration](locking-sanlock.md#id5)
...
using [on_lockfailure element](../formatdomain.md#events-configuration) in
...
file](../auth.md#client-configuration) needs to contain something like
the following:
