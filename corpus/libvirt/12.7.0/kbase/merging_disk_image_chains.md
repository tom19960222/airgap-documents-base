...
collection: libvirt
version: "12.7.0"
title: "Merging disk image image chains"
source_url: https://libvirt.org/kbase/merging_disk_image_chains.html
fetched_at: 2026-08-21T04:09:54+00:00
---
# Merging disk image image chains

Contents

- [Context](merging_disk_image_chains.md#context)
- [Reducing the disk image chain length](merging_disk_image_chains.md#reducing-the-disk-image-chain-length)

  - [A note on accessing 'base' and 'top' images](merging_disk_image_chains.md#a-note-on-accessing-base-and-top-images)
- [Consolidating an entire disk image chain into a single image](merging_disk_image_chains.md#consolidating-an-entire-disk-image-chain-into-a-single-image)

# [Context](merging_disk_image_chains.md#id1)

Sometimes a [disk image chain](backing_chains.md) can get long and
...
The same principles used in the [live full disk backup](live_full_disk_backup.md) document are used here too.

# [Reducing the disk image chain length](merging_disk_image_chains.md#id2)
...
4. Again, list the current active disk image in use:
   ...
   ```
5. Perform the "block-commit" by specify the "base" and "top" images,
...
## [A note on accessing 'base' and 'top' images](merging_disk_image_chains.md#id3)
...
# [Consolidating an entire disk image chain into a single image](merging_disk_image_chains.md#id4)
...
1. Again, check the current active block device in use:
   ...
   vda        /var/lib/libvirt/images/base.raw
   ```
2. Enumerate the backing file chain:
