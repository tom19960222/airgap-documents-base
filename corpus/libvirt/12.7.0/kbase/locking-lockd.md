...
collection: libvirt
version: "12.7.0"
title: "Virtual machine lock manager, virtlockd plugin"
source_url: https://libvirt.org/kbase/locking-lockd.html
fetched_at: 2026-08-21T04:09:51+00:00
---
# Virtual machine lock manager, virtlockd plugin

Contents

- [virtlockd background](locking-lockd.md#virtlockd-background)
- [virtlockd daemon setup](locking-lockd.md#virtlockd-daemon-setup)
- [libvirt lockd plugin configuration](locking-lockd.md#libvirt-lockd-plugin-configuration)
- [QEMU/KVM driver configuration](locking-lockd.md#qemu-kvm-driver-configuration)

This page describes use of the virtlockd service as a [lock
driver](locking.md) plugin for virtual machine disk mutual
exclusion.

# [virtlockd background](locking-lockd.md#id1)
...
# [virtlockd daemon setup](locking-lockd.md#id2)
...
# [libvirt lockd plugin configuration](locking-lockd.md#id3)
...
# [QEMU/KVM driver configuration](locking-lockd.md#id4)
