...
collection: libvirt
version: "12.7.0"
title: "Systemtap of Libvirt"
source_url: https://libvirt.org/kbase/systemtap.html
fetched_at: 2026-08-21T04:09:58+00:00
---
# Systemtap of Libvirt

Contents

- [Preparation](systemtap.md#preparation)

  - [Libvirt](systemtap.md#libvirt)
  - [Systemtap](systemtap.md#systemtap)
- [Tracing events](systemtap.md#tracing-events)
- [Tracing examples](systemtap.md#tracing-examples)

[Systemtap](https://sourceware.org/systemtap/) is a scripting
...
# [Preparation](systemtap.md#id1)

## [Libvirt](systemtap.md#id2)
...
[libvirt compiling](../compiling.md)):
...
# [Tracing events](systemtap.md#id4)
...
# [Tracing examples](systemtap.md#id5)
...
For more details of systemtap language, see [document of systemtap](https://sourceware.org/systemtap/documentation.html)
