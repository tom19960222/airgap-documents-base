...
collection: libvirt
version: "12.7.0"
title: "KVM Real Time Guest Config"
source_url: https://libvirt.org/kbase/kvm-realtime.html
...
- [Host partitioning plan](kvm-realtime.md#host-partitioning-plan)
- [Guest configuration](kvm-realtime.md#guest-configuration)

  - [CPU configuration](kvm-realtime.md#cpu-configuration)
  - [Memory configuration](kvm-realtime.md#memory-configuration)
  - [Device configuration](kvm-realtime.md#device-configuration)
...
# [Host partitioning plan](kvm-realtime.md#id1)
...
Once huge pages are reserved on the hypothetical machine, the virsh capabilities command output is expected to look approximately like:
...
# [Guest configuration](kvm-realtime.md#id2)
...
## [CPU configuration](kvm-realtime.md#id3)
...
When configuring the [guest CPU count](../formatdomain.md#cpu-allocation),
...
siblings. This is achieved using the [CPU tuning config](../formatdomain.md#cpu-tuning):
...
The [guest CPU model](../formatdomain.md#cpu-model-and-topology) now needs to be
...
via the [hypervisor features](../formatdomain.md#hypervisor-features):
...
## [Memory configuration](kvm-realtime.md#id4)
...
This is achieved by using the [memory backing config](../formatdomain.md#memory-backing):
...
## [Device configuration](kvm-realtime.md#id5)
