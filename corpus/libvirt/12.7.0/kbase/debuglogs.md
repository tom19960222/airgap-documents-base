...
version: "12.7.0"
title: "Debug Logs"
source_url: https://libvirt.org/kbase/debuglogs.html
fetched_at: 2026-08-21T04:09:57+00:00
---
# Debug Logs

Contents

- [Turning on debug logs](debuglogs.md#turning-on-debug-logs)
- [TL;DR - Enable debug logs for most common scenario](debuglogs.md#tl-dr-enable-debug-logs-for-most-common-scenario)
- [Logging settings in libvirt](debuglogs.md#logging-settings-in-libvirt)

  - [Log levels](debuglogs.md#log-levels)
  - [Log outputs](debuglogs.md#log-outputs)
  - [Log filters](debuglogs.md#log-filters)
- [Libvirt daemons logging configuration](debuglogs.md#libvirt-daemons-logging-configuration)

  - [Session vs system daemons](debuglogs.md#session-vs-system-daemons)

    - [System daemon mode](debuglogs.md#system-daemon-mode)
    - [Session daemon mode](debuglogs.md#session-daemon-mode)
  - [Modular vs. monolithic daemons](debuglogs.md#modular-vs-monolithic-daemons)

    - [Modular daemons](debuglogs.md#modular-daemons)
    - [Monolithic daemon](debuglogs.md#monolithic-daemon)
  - [Persistent setting](debuglogs.md#persistent-setting)
  - [Runtime setting](debuglogs.md#runtime-setting)

    - [Timeout of the configured daemon](debuglogs.md#timeout-of-the-configured-daemon)
    - [Adding filters and outputs](debuglogs.md#adding-filters-and-outputs)
    - [Removing filters and outputs](debuglogs.md#removing-filters-and-outputs)
  - [Legacy (pre-4.4.0) libvirt daemon logging configuration](debuglogs.md#legacy-pre-4-4-0-libvirt-daemon-logging-configuration)
- [Client library logging](debuglogs.md#client-library-logging)
- [What to attach?](debuglogs.md#what-to-attach)
- [Example filter settings](debuglogs.md#example-filter-settings)

  - [Targeted logging for debugging QEMU VMs](debuglogs.md#targeted-logging-for-debugging-qemu-vms)
  - [Less verbose logging for QEMU VMs](debuglogs.md#less-verbose-logging-for-qemu-vms)
  - [Minimalistic QEMU QMP monitor logging](debuglogs.md#minimalistic-qemu-qmp-monitor-logging)
- [Sensitive information in debug logs](debuglogs.md#sensitive-information-in-debug-logs)

# [Turning on debug logs](debuglogs.md#id1)

If you [report a bug](https://gitlab.com/libvirt/libvirt/-/issues/new)
...
# [TL;DR - Enable debug logs for most common scenario](debuglogs.md#id2)
...
# [Logging settings in libvirt](debuglogs.md#id3)

## [Log levels](debuglogs.md#id4)
...
settings explained in the [Log outputs](debuglogs.md#log-outputs) and [Log filters](debuglogs.md#log-filters) sections
respectively.
...
configuring your filters is to start with the [Example filter settings](debuglogs.md#example-filter-settings).

The rule of thumb here is to have more logs rather than less and miss something
important.

# [Libvirt daemons logging configuration](debuglogs.md#id7)
...
## [Session vs system daemons](debuglogs.md#id8)
...
Refer to [documentation about daemons](../daemons.md#checking-whether-modular-monolithic-mode-is-in-use)
to figure out which is in use by your system.

### [Modular daemons](debuglogs.md#id12)
...
### [Monolithic daemon](debuglogs.md#id13)
...
## [Persistent setting](debuglogs.md#id14)
...
- open the appropriate daemon config file in your favourite editor
  ...
  ```
- find & replace, or set the appropriate [Log outputs](debuglogs.md#log-outputs) and [Log filters](debuglogs.md#log-filters), e.g
...
## [Runtime setting](debuglogs.md#id15)
...
### [Timeout of the configured daemon](debuglogs.md#id16)
...
### [Adding filters and outputs](debuglogs.md#id17)
...
### [Removing filters and outputs](debuglogs.md#id18)
...
## [Legacy (pre-4.4.0) libvirt daemon logging configuration](debuglogs.md#id19)
...
# [Client library logging](debuglogs.md#id20)
...
# [What to attach?](debuglogs.md#id21)
...
- Consider whether you view any of the information in the debug logs
  sensitive: [Sensitive information in debug logs](debuglogs.md#sensitive-information-in-debug-logs).

# [Example filter settings](debuglogs.md#id22)
...
## [Targeted logging for debugging QEMU VMs](debuglogs.md#id23)
...
## [Less verbose logging for QEMU VMs](debuglogs.md#id24)
...
## [Minimalistic QEMU QMP monitor logging](debuglogs.md#id25)
...
# [Sensitive information in debug logs](debuglogs.md#id26)
