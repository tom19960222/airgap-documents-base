...
collection: libvirt
version: "12.7.0"
title: "QEMU command-line passthrough"
source_url: https://libvirt.org/kbase/qemu-passthrough-security.html
fetched_at: 2026-08-21T04:09:50+00:00
---
# QEMU command-line passthrough

Contents

- [XML document additions](qemu-passthrough-security.md#xml-document-additions)
- [Security confinement / sandboxing](qemu-passthrough-security.md#security-confinement-sandboxing)

  - [Granting access per VM](qemu-passthrough-security.md#granting-access-per-vm)
  - [Disabling security protection per VM](qemu-passthrough-security.md#disabling-security-protection-per-vm)
  - [Disabling security protection host-wide](qemu-passthrough-security.md#disabling-security-protection-host-wide)
  - [Private mount namespace](qemu-passthrough-security.md#private-mount-namespace)
...
# [XML document additions](qemu-passthrough-security.md#id1)
...
# [Security confinement / sandboxing](qemu-passthrough-security.md#id2)
...
## [Granting access per VM](qemu-passthrough-security.md#id3)
...
## [Disabling security protection per VM](qemu-passthrough-security.md#id4)
...
## [Disabling security protection host-wide](qemu-passthrough-security.md#id5)
...
## [Private mount namespace](qemu-passthrough-security.md#id6)
