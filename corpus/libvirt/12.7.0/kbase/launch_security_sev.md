...
collection: libvirt
version: "12.7.0"
title: "Launch security with AMD SEV"
source_url: https://libvirt.org/kbase/launch_security_sev.html
...
- [AMD Secure Encrypted Virtualization (SEV)](launch_security_sev.md#amd-secure-encrypted-virtualization-sev)
- [Enabling SEV on the host](launch_security_sev.md#enabling-sev-on-the-host)
- [Checking SEV support in the virt stack](launch_security_sev.md#checking-sev-support-in-the-virt-stack)
- [VM Configuration](launch_security_sev.md#vm-configuration)

  - [Machine type](launch_security_sev.md#machine-type)

    - [Q35](launch_security_sev.md#q35)
    - [i440fx (discouraged)](launch_security_sev.md#i440fx-discouraged)
  - [Boot loader](launch_security_sev.md#boot-loader)
  - [Memory](launch_security_sev.md#memory)
  - [Virtio](launch_security_sev.md#virtio)

    - [Virtio-net](launch_security_sev.md#virtio-net)
- [Checking SEV from within the guest](launch_security_sev.md#checking-sev-from-within-the-guest)
- [Guest attestation for SEV/SEV-ES from a trusted host](launch_security_sev.md#guest-attestation-for-sev-sev-es-from-a-trusted-host)
- [Limitations](launch_security_sev.md#limitations)
- [Full domain XML examples](launch_security_sev.md#full-domain-xml-examples)

  - [Q35 machine](launch_security_sev.md#q35-machine)
  - [PC-i440fx machine](launch_security_sev.md#pc-i440fx-machine)
...
# [AMD Secure Encrypted Virtualization (SEV)](launch_security_sev.md#id1)
...
visit [AMD's developer portal](https://developer.amd.com/sev/).

# [Enabling SEV on the host](launch_security_sev.md#id2)
...
# [Checking SEV support in the virt stack](launch_security_sev.md#id3)
...
2. you have libvirt <=5.1.0 which suffered from getting a
...
# [VM Configuration](launch_security_sev.md#id4)

SEV is enabled in the XML by specifying the
[<launchSecurity>](../formatdomain.md#launch-security)
...
## [Machine type](launch_security_sev.md#id5)
...
### [Q35](launch_security_sev.md#id6)
...
### [i440fx (discouraged)](launch_security_sev.md#id7)
...
## [Boot loader](launch_security_sev.md#id8)
...
## [Memory](launch_security_sev.md#id9)
...
## [Virtio](launch_security_sev.md#id10)
...
### [Virtio-net](launch_security_sev.md#id11)
...
# [Checking SEV from within the guest](launch_security_sev.md#id12)

After making the necessary adjustments discussed in
[VM Configuration](launch_security_sev.md#vm-configuration), the VM should now boot successfully
...
# [Guest attestation for SEV/SEV-ES from a trusted host](launch_security_sev.md#id13)
...
can be generated using the [sevctl](https://github.com/virtee/sevctl) tool.
...
The [man page](../manpages/virt-qemu-sev-validate.md) for
virt-qemu-sev-validate outlines a great many other ways to invoke this
tool.

# [Limitations](launch_security_sev.md#id14)
...
# [Full domain XML examples](launch_security_sev.md#id15)

## [Q35 machine](launch_security_sev.md#id16)
...
## [PC-i440fx machine](launch_security_sev.md#id17)
