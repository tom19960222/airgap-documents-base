...
collection: libvirt
version: "12.7.0"
title: "Secure Usage of Libvirt"
source_url: https://libvirt.org/kbase/secureusage.html
...
- [Disk image handling](secureusage.md#disk-image-handling)

  - [Disk image format probing](secureusage.md#disk-image-format-probing)
  - [Disk image backing files](secureusage.md#disk-image-backing-files)
  - [Disk image size validation](secureusage.md#disk-image-size-validation)
  - [Disk image data access](secureusage.md#disk-image-data-access)
- [Guest migration network](secureusage.md#guest-migration-network)
- [Storage encryption](secureusage.md#storage-encryption)
...
# [Disk image handling](secureusage.md#id1)

## [Disk image format probing](secureusage.md#id2)
...
## [Disk image backing files](secureusage.md#id3)
...
## [Disk image size validation](secureusage.md#id4)
...
## [Disk image data access](secureusage.md#id5)
...
them](https://lwn.net/Articles/538898/) undetected for years at a
time.
...
[libguestfs](https://libguestfs.org) tools and APIs for accessing
disks

# [Guest migration network](secureusage.md#id6)
...
# [Storage encryption](secureusage.md#id7)
