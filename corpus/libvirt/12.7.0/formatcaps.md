...
collection: libvirt
version: "12.7.0"
title: "Driver capabilities XML format"
source_url: https://libvirt.org/formatcaps.html
fetched_at: 2026-08-21T04:09:26+00:00
---
# Driver capabilities XML format

Contents

- [Element and attribute overview](formatcaps.md#element-and-attribute-overview)

  - [Host capabilities](formatcaps.md#host-capabilities)

    - [Host CPU model and features](formatcaps.md#host-cpu-model-and-features)
  - [Guest capabilities](formatcaps.md#guest-capabilities)
  - [Examples](formatcaps.md#examples)

# [Element and attribute overview](formatcaps.md#id1)
...
As can be seen in the [Examples](formatcaps.md#examples), the capabilities XML
...
## [Host capabilities](formatcaps.md#id2)
...
### [Host CPU model and features](formatcaps.md#id3)
...
[Examples](formatcaps.md#examples) where the baseline is Skylake-Client-noTSX-IBRS).
...
- Some features might be in the hardware but unavailable for various
  ...
  the [TSX mitigation](https://docs.kernel.org/arch/x86/tsx_async_abort.html).
...
[Domain capabilities](formatdomaincaps.md#cpu-configuration) do
not have such limitation, and the host-model CPU definition would
show the correct CPU model in almost all cases.

## [Guest capabilities](formatcaps.md#id4)

While the previous section ([Host capabilities](formatcaps.md#host-capabilities)) aims at host capabilities,
...
:   This element brings some information on supported guest architecture.
    ...
    :   Emulator (device model) path, for use in
        [emulator](formatdomain.md#devices) element of domain XML.

    loader
    :   Loader path, for use in [loader](formatdomain.md#guest-firmware)
        element of domain XML.

    machine
    :   Machine type, for use in
        [machine](formatdomain.md#operating-system-booting) attribute of
    ...
    :   The type attribute of this element specifies the type of hypervisor
        ...
        [type](formatdomain.md#element-and-attribute-overview) attribute of
...
:   This optional element encases possible features that can be used with a guest
    ...
    :   If this element is present, the default attribute describes whether
        ...
        checking for an error to find out for sure. Since 1.2.3
    ...
    :   If this element is present, the hypervisor supports deleting and
        ...
        snapshots. Since 9.9.0

## [Examples](formatcaps.md#id5)
