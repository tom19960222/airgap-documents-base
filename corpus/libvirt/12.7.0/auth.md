...
source_url: https://libvirt.org/auth.html
...
- [Client configuration](auth.md#client-configuration)
- [Server configuration](auth.md#server-configuration)

  - [UNIX socket permissions/group](auth.md#unix-socket-permissions-group)
  - [UNIX socket PolicyKit auth](auth.md#unix-socket-policykit-auth)
  - [SASL pluggable authentication](auth.md#sasl-pluggable-authentication)

    - [Username/password auth](auth.md#username-password-auth)
    - [GSSAPI/Kerberos auth](auth.md#gssapi-kerberos-auth)

When connecting to libvirt, some connections may require client
authentication before allowing use of the APIs. The set of possible
authentication mechanisms is administrator controlled, independent
of applications using libvirt. Once authenticated, libvirt can apply
fine grained [access control](acl.md) to the operations
performed by a client.

# [Client configuration](auth.md#id1)
...
# [Server configuration](auth.md#id2)
...
## [UNIX socket permissions/group](auth.md#id3)
...
## [UNIX socket PolicyKit auth](auth.md#id4)
...
[polkit-pkla-compat](https://pagure.io/polkit-pkla-compat). As an
...
## [SASL pluggable authentication](auth.md#id5)
...
### [Username/password auth](auth.md#id6)
...
### [GSSAPI/Kerberos auth](auth.md#id7)
