...
collection: libvirt
version: "12.7.0"
title: "virt-qemu-sev-validate"
source_url: https://libvirt.org/manpages/virt-qemu-sev-validate.html
fetched_at: 2026-08-21T04:10:21+00:00
---
...
- [SYNOPSIS](virt-qemu-sev-validate.md#synopsis)
- [DESCRIPTION](virt-qemu-sev-validate.md#description)
- [OPTIONS](virt-qemu-sev-validate.md#options)

  - [Common options](virt-qemu-sev-validate.md#common-options)
  - [Guest state options](virt-qemu-sev-validate.md#guest-state-options)
  - [Guest config options](virt-qemu-sev-validate.md#guest-config-options)
  - [Libvirt options](virt-qemu-sev-validate.md#libvirt-options)
  - [Secret injection options](virt-qemu-sev-validate.md#secret-injection-options)
- [EXAMPLES](virt-qemu-sev-validate.md#examples)

  - [Fully offline execution](virt-qemu-sev-validate.md#fully-offline-execution)
  - [Fetch from remote libvirt](virt-qemu-sev-validate.md#fetch-from-remote-libvirt)
  - [Fetch from local libvirt](virt-qemu-sev-validate.md#fetch-from-local-libvirt)
- [COMMON MISTAKES CHECKLIST](virt-qemu-sev-validate.md#common-mistakes-checklist)
- [EXIT STATUS](virt-qemu-sev-validate.md#exit-status)
- [AUTHOR](virt-qemu-sev-validate.md#author)
- [BUGS](virt-qemu-sev-validate.md#bugs)
- [COPYRIGHT](virt-qemu-sev-validate.md#copyright)
- [LICENSE](virt-qemu-sev-validate.md#license)
- [SEE ALSO](virt-qemu-sev-validate.md#see-also)

# [SYNOPSIS](virt-qemu-sev-validate.md#id1)

virt-qemu-sev-validate [*OPTIONS*]

# [DESCRIPTION](virt-qemu-sev-validate.md#id2)
...
# [OPTIONS](virt-qemu-sev-validate.md#id3)

## [Common options](virt-qemu-sev-validate.md#id4)
...
## [Guest state options](virt-qemu-sev-validate.md#id5)
...
## [Guest config options](virt-qemu-sev-validate.md#id6)
...
## [Libvirt options](virt-qemu-sev-validate.md#id7)
...
## [Secret injection options](virt-qemu-sev-validate.md#id8)
...
# [EXAMPLES](virt-qemu-sev-validate.md#id9)

## [Fully offline execution](virt-qemu-sev-validate.md#id10)
...
## [Fetch from remote libvirt](virt-qemu-sev-validate.md#id11)
...
## [Fetch from local libvirt](virt-qemu-sev-validate.md#id12)
...
# [COMMON MISTAKES CHECKLIST](virt-qemu-sev-validate.md#id13)
...
# [EXIT STATUS](virt-qemu-sev-validate.md#id14)
...
# [AUTHOR](virt-qemu-sev-validate.md#id15)

Daniel P. Berrangé

# [BUGS](virt-qemu-sev-validate.md#id16)
...
# [COPYRIGHT](virt-qemu-sev-validate.md#id17)

Copyright (C) 2022 by Red Hat, Inc.

# [LICENSE](virt-qemu-sev-validate.md#id18)
...
# [SEE ALSO](virt-qemu-sev-validate.md#id19)

virsh(1), [SEV launch security usage](../kbase/launch_security_sev.md),
