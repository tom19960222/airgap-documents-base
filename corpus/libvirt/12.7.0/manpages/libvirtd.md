...
version: "12.7.0"
title: "libvirtd"
source_url: https://libvirt.org/manpages/libvirtd.html
...
- [SYNOPSIS](libvirtd.md#synopsis)
- [DESCRIPTION](libvirtd.md#description)
- [SYSTEM SOCKET ACTIVATION](libvirtd.md#system-socket-activation)
- [OPTIONS](libvirtd.md#options)
- [SIGNALS](libvirtd.md#signals)
- [FILES](libvirtd.md#files)

  - [When run as *root*](libvirtd.md#when-run-as-root)
  - [When run as *non-root*](libvirtd.md#when-run-as-non-root)
- [EXAMPLES](libvirtd.md#examples)
- [BUGS](libvirtd.md#bugs)
- [AUTHORS](libvirtd.md#authors)
- [COPYRIGHT](libvirtd.md#copyright)
- [LICENSE](libvirtd.md#license)
- [SEE ALSO](libvirtd.md#see-also)

# [SYNOPSIS](libvirtd.md#id1)

libvirtd [*OPTION*]...

# [DESCRIPTION](libvirtd.md#id2)
...
# [SYSTEM SOCKET ACTIVATION](libvirtd.md#id3)
...
# [SIGNALS](libvirtd.md#id5)

On receipt of SIGHUP libvirtd will reload its configuration.

# [FILES](libvirtd.md#id6)

## [When run as *root*](libvirtd.md#id7)
...
## [When run as *non-root*](libvirtd.md#id8)
...
# [EXAMPLES](libvirtd.md#id9)

To retrieve the version of libvirtd:

```
# libvirtd --version
libvirtd (libvirt) 12.7.0
```
...
# [SEE ALSO](libvirtd.md#id14)

virsh(1), virt-install(1), virt-xml-validate(1), virt-top(1),
virt-df(1), [https://libvirt.org/](../index.md)
