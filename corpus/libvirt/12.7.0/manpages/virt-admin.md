...
version: "12.7.0"
title: "virt-admin"
source_url: https://libvirt.org/manpages/virt-admin.html
...
- [SYNOPSIS](virt-admin.md#synopsis)
- [DESCRIPTION](virt-admin.md#description)
- [NOTES](virt-admin.md#notes)
- [GENERIC COMMANDS](virt-admin.md#generic-commands)

  - [help](virt-admin.md#help)
  - [quit, exit](virt-admin.md#quit-exit)
  - [version](virt-admin.md#version)
  - [cd](virt-admin.md#cd)
  - [pwd](virt-admin.md#pwd)
  - [connect](virt-admin.md#connect)
  - [uri](virt-admin.md#uri)
- [DAEMON COMMANDS](virt-admin.md#daemon-commands)

  - [server-list](virt-admin.md#server-list)
  - [daemon-log-filters](virt-admin.md#daemon-log-filters)
  - [daemon-log-outouts](virt-admin.md#daemon-log-outouts)
  - [daemon-timeout](virt-admin.md#daemon-timeout)
  - [daemon-shutdown](virt-admin.md#daemon-shutdown)
- [SERVER COMMANDS](virt-admin.md#server-commands)

  - [server-threadpool-info](virt-admin.md#server-threadpool-info)
  - [server-threadpool-set](virt-admin.md#server-threadpool-set)
  - [server-clients-info](virt-admin.md#server-clients-info)
  - [server-clients-set](virt-admin.md#server-clients-set)
  - [server-update-tls](virt-admin.md#server-update-tls)
- [CLIENT COMMANDS](virt-admin.md#client-commands)

  - [client-list](virt-admin.md#client-list)
  - [client-info](virt-admin.md#client-info)
  - [client-disconnect](virt-admin.md#client-disconnect)
- [ENVIRONMENT](virt-admin.md#environment)
- [AUTHORS](virt-admin.md#authors)
- [BUGS](virt-admin.md#bugs)
- [COPYRIGHT](virt-admin.md#copyright)
- [LICENSE](virt-admin.md#license)
- [SEE ALSO](virt-admin.md#see-also)

# [SYNOPSIS](virt-admin.md#id1)

virt-admin [*OPTION*]... [*COMMAND_STRING*]

virt-admin [*OPTION*]... *COMMAND* [*ARG*]...

# [DESCRIPTION](virt-admin.md#id2)
...
instead of the default connection. See [NOTES](virt-admin.md#notes).
...
# [NOTES](virt-admin.md#id3)

The virt-admin supports both the monolithic libvirtd daemon and the
[modular daemons](../daemons.md#modular-driver-daemons)
whichever is in use by your system. The connection *URI* used with
-c/--connect or the [connect](virt-admin.md#connect) command is based on the name of the
...
# [GENERIC COMMANDS](virt-admin.md#id4)

The following commands are generic.

## [help](virt-admin.md#id5)
...
See [NOTES](virt-admin.md#notes) on picking the correct *URI* corresponding to a libvirt daemon.

To find the currently used URI, check the *uri* command documented below.

## [uri](virt-admin.md#id11)
...
## [daemon-log-filters](virt-admin.md#id14)
...
## [daemon-log-outouts](virt-admin.md#id15)
...
## [daemon-timeout](virt-admin.md#id16)
...
## [daemon-shutdown](virt-admin.md#id17)
...
## [server-threadpool-set](virt-admin.md#id20)
...
## [server-clients-info](virt-admin.md#id21)
...
## [server-clients-set](virt-admin.md#id22)
...
## [server-update-tls](virt-admin.md#id23)
...
# [CLIENT COMMANDS](virt-admin.md#id24)
...
## [client-list](virt-admin.md#id25)
...
## [client-info](virt-admin.md#id26)
...
## [client-disconnect](virt-admin.md#id27)
...
# [ENVIRONMENT](virt-admin.md#id28)
...
# [AUTHORS](virt-admin.md#id29)

Please refer to the AUTHORS file distributed with libvirt.

# [BUGS](virt-admin.md#id30)
