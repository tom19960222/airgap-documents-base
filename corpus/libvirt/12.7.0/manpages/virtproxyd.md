...
version: "12.7.0"
title: "virtproxyd"
source_url: https://libvirt.org/manpages/virtproxyd.html
...
- [SYNOPSIS](virtproxyd.md#synopsis)
- [DESCRIPTION](virtproxyd.md#description)
- [DAEMON STARTUP MODES](virtproxyd.md#daemon-startup-modes)

  - [Socket activation mode](virtproxyd.md#socket-activation-mode)
  - [Traditional service mode](virtproxyd.md#traditional-service-mode)
- [OPTIONS](virtproxyd.md#options)
- [SIGNALS](virtproxyd.md#signals)
- [FILES](virtproxyd.md#files)

  - [When run as *root*](virtproxyd.md#when-run-as-root)
  - [When run as *non-root*](virtproxyd.md#when-run-as-non-root)
- [EXAMPLES](virtproxyd.md#examples)
- [BUGS](virtproxyd.md#bugs)
- [AUTHORS](virtproxyd.md#authors)
- [COPYRIGHT](virtproxyd.md#copyright)
- [LICENSE](virtproxyd.md#license)
- [SEE ALSO](virtproxyd.md#see-also)

# [SYNOPSIS](virtproxyd.md#id1)

virtproxyd [*OPTION*]...

# [DESCRIPTION](virtproxyd.md#id2)
...
# [DAEMON STARTUP MODES](virtproxyd.md#id3)

The virtproxyd daemon is capable of starting in two modes.

## [Socket activation mode](virtproxyd.md#id4)
...
## [Traditional service mode](virtproxyd.md#id5)
...
# [SIGNALS](virtproxyd.md#id7)

On receipt of SIGHUP virtproxyd will reload its configuration.

# [FILES](virtproxyd.md#id8)

## [When run as *root*](virtproxyd.md#id9)
...
## [When run as *non-root*](virtproxyd.md#id10)
...
# [EXAMPLES](virtproxyd.md#id11)

To retrieve the version of virtproxyd:

```
# virtproxyd --version
virtproxyd (libvirt) 12.7.0
```
...
# [AUTHORS](virtproxyd.md#id13)

Please refer to the AUTHORS file distributed with libvirt.

# [COPYRIGHT](virtproxyd.md#id14)

Copyright (C) 2006-2020 Red Hat, Inc., and the authors listed in the
libvirt AUTHORS file.

# [LICENSE](virtproxyd.md#id15)
