...
collection: libvirt
version: "12.7.0"
title: "virt-login-shell"
source_url: https://libvirt.org/manpages/virt-login-shell.html
...
- [SYNOPSIS](virt-login-shell.md#synopsis)
- [DESCRIPTION](virt-login-shell.md#description)
- [OPTIONS](virt-login-shell.md#options)
- [CONFIG](virt-login-shell.md#config)
- [EXIT STATUS](virt-login-shell.md#exit-status)
- [BUGS](virt-login-shell.md#bugs)
- [AUTHOR](virt-login-shell.md#author)
- [COPYRIGHT](virt-login-shell.md#copyright)
- [LICENSE](virt-login-shell.md#license)
- [SEE ALSO](virt-login-shell.md#see-also)

# [SYNOPSIS](virt-login-shell.md#id1)

virt-login-shell [*OPTION*]

# [DESCRIPTION](virt-login-shell.md#id2)
...
# [OPTIONS](virt-login-shell.md#id3)
...
# [CONFIG](virt-login-shell.md#id4)
...
# [EXIT STATUS](virt-login-shell.md#id5)
...
# [AUTHOR](virt-login-shell.md#id7)

Daniel Walsh

# [COPYRIGHT](virt-login-shell.md#id8)

Copyright (C) 2013-2014 Red Hat, Inc., and the authors listed in the
libvirt AUTHORS file.

# [LICENSE](virt-login-shell.md#id9)
...
# [SEE ALSO](virt-login-shell.md#id10)
