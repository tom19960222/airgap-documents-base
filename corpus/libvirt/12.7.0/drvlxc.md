...
source_url: https://libvirt.org/drvlxc.html
fetched_at: 2026-08-21T04:09:16+00:00
---
# LXC container driver

Contents

- [Control groups Requirements](drvlxc.md#control-groups-requirements)
- [Namespace requirements](drvlxc.md#namespace-requirements)
- [Default container setup](drvlxc.md#default-container-setup)

  - [Command line arguments](drvlxc.md#command-line-arguments)
  - [Environment variables](drvlxc.md#environment-variables)
  - [Filesystem mounts](drvlxc.md#filesystem-mounts)
  - [Device nodes](drvlxc.md#device-nodes)
- [Security considerations](drvlxc.md#security-considerations)

  - [Network isolation](drvlxc.md#network-isolation)
  - [Filesystem isolation](drvlxc.md#filesystem-isolation)
  - [User and group isolation](drvlxc.md#user-and-group-isolation)
- [Location of configuration files](drvlxc.md#location-of-configuration-files)
- [Systemd Socket Activation Integration](drvlxc.md#systemd-socket-activation-integration)
- [Container security](drvlxc.md#container-security)

  - [sVirt SELinux](drvlxc.md#svirt-selinux)
  - [Auditing](drvlxc.md#auditing)
  - [Device access](drvlxc.md#device-access)
- [Example configurations](drvlxc.md#example-configurations)

  - [Example config version 1](drvlxc.md#example-config-version-1)
- [Altering the available capabilities](drvlxc.md#altering-the-available-capabilities)
- [Inherit namespaces](drvlxc.md#inherit-namespaces)
- [Container usage / management](drvlxc.md#container-usage-management)

  - [Defining (saving) container configuration](drvlxc.md#defining-saving-container-configuration)
  - [Viewing container configuration](drvlxc.md#viewing-container-configuration)
  - [Starting containers](drvlxc.md#starting-containers)
  - [Stopping containers](drvlxc.md#stopping-containers)
  - [Rebooting a container](drvlxc.md#rebooting-a-container)
  - [Undefining (deleting) a container configuration](drvlxc.md#undefining-deleting-a-container-configuration)
  - [Connecting to a container console](drvlxc.md#connecting-to-a-container-console)
  - [Running commands in a container](drvlxc.md#running-commands-in-a-container)
  - [Monitoring container utilization](drvlxc.md#monitoring-container-utilization)
  - [Converting LXC container configuration](drvlxc.md#converting-lxc-container-configuration)
...
# [Control groups Requirements](drvlxc.md#id1)
...
documentation](cgroups.md).

# [Namespace requirements](drvlxc.md#id2)
...
declares a [UID or GID mapping](formatdomain.md#container-boot), the
...
# [Default container setup](drvlxc.md#id3)

## [Command line arguments](drvlxc.md#id4)
...
## [Filesystem mounts](drvlxc.md#id6)
...
# [Security considerations](drvlxc.md#id8)
...
## [Network isolation](drvlxc.md#id9)
...
## [Filesystem isolation](drvlxc.md#id10)
...
## [User and group isolation](drvlxc.md#id11)
...
write-up on the topic](https://lwn.net/Articles/532593/). From the libvirt
...
# [Location of configuration files](drvlxc.md#id12)
...
# [Systemd Socket Activation Integration](drvlxc.md#id13)
...
capability](https://0pointer.de/blog/projects/socket-activated-containers.html),
...
# [Container security](drvlxc.md#id14)

## [sVirt SELinux](drvlxc.md#id15)
...
# [Example configurations](drvlxc.md#id18)

## [Example config version 1](drvlxc.md#id19)
...
# [Altering the available capabilities](drvlxc.md#id20)

By default the libvirt LXC driver drops some capabilities among which CAP_MKNOD.
However since 1.2.6 libvirt can be told to keep or drop some
...
# [Inherit namespaces](drvlxc.md#id21)
...
# [Container usage / management](drvlxc.md#id22)
...
## [Defining (saving) container configuration](drvlxc.md#id23)
...
## [Viewing container configuration](drvlxc.md#id24)
...
## [Starting containers](drvlxc.md#id25)
...
## [Stopping containers](drvlxc.md#id26)
...
## [Rebooting a container](drvlxc.md#id27)
...
## [Undefining (deleting) a container configuration](drvlxc.md#id28)
...
## [Connecting to a container console](drvlxc.md#id29)
...
## [Running commands in a container](drvlxc.md#id30)
...
## [Monitoring container utilization](drvlxc.md#id31)
...
## [Converting LXC container configuration](drvlxc.md#id32)
