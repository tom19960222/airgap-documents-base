...
source_url: https://libvirt.org/newreposetup.html
...
The [GitLab organization](https://gitlab.com/libvirt) hosts the master copy
...
The [GitHub organization](https://github.com/libvirt) hosts read-only
