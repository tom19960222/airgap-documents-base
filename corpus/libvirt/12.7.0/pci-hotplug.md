...
collection: libvirt
version: "12.7.0"
title: "PCI topology and hotplug"
source_url: https://libvirt.org/pci-hotplug.html
fetched_at: 2026-08-21T04:09:47+00:00
---
# PCI topology and hotplug

Contents

- [x86_64 architecture](pci-hotplug.md#x86-64-architecture)

  - [q35 machine type](pci-hotplug.md#q35-machine-type)
  - [i440fx (pc) machine type](pci-hotplug.md#i440fx-pc-machine-type)
- [ppc64 architecture](pci-hotplug.md#ppc64-architecture)

  - [pseries machine type](pci-hotplug.md#pseries-machine-type)
- [aarch64 architecture](pci-hotplug.md#aarch64-architecture)

  - [mach-virt (virt) machine type](pci-hotplug.md#mach-virt-virt-machine-type)
...
# [x86_64 architecture](pci-hotplug.md#id1)

## [q35 machine type](pci-hotplug.md#id2)
...
[libguestfs](https://libguestfs.org/) behind the scenes to access disk
...
## [i440fx (pc) machine type](pci-hotplug.md#id3)
...
# [ppc64 architecture](pci-hotplug.md#id4)

## [pseries machine type](pci-hotplug.md#id5)
...
# [aarch64 architecture](pci-hotplug.md#id6)

## [mach-virt (virt) machine type](pci-hotplug.md#id7)

This machine type mostly behaves the same as the [q35 machine type](pci-hotplug.md#q35-machine-type),
