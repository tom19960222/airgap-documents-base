...
collection: libvirt
version: "12.7.0"
title: "OpenVZ container driver"
source_url: https://libvirt.org/drvopenvz.html
fetched_at: 2026-08-21T04:09:37+00:00
---
# OpenVZ container driver

Contents

- [Project Links](drvopenvz.md#project-links)
- [Connections to OpenVZ driver](drvopenvz.md#connections-to-openvz-driver)
- [Notes on bridged networking](drvopenvz.md#notes-on-bridged-networking)

  - [Host network devices](drvopenvz.md#host-network-devices)
  - [OpenVZ tools configuration](drvopenvz.md#openvz-tools-configuration)
- [Example guest domain XML configuration](drvopenvz.md#example-guest-domain-xml-configuration)
...
# [Project Links](drvopenvz.md#id1)

- The [OpenVZ](https://openvz.org/) Linux container system

# [Connections to OpenVZ driver](drvopenvz.md#id2)
...
# [Notes on bridged networking](drvopenvz.md#id3)
...
## [Host network devices](drvopenvz.md#id4)
...
notes consult the [Wiki](https://wiki.libvirt.org) or your operating system's
...
## [OpenVZ tools configuration](drvopenvz.md#id5)
...
# [Example guest domain XML configuration](drvopenvz.md#id6)
