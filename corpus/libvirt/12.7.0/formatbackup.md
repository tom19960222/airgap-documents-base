...
collection: libvirt
version: "12.7.0"
title: "Backup XML format"
source_url: https://libvirt.org/formatbackup.html
fetched_at: 2026-08-21T04:09:30+00:00
---
# [Backup XML format](formatbackup.md#id1)

Contents

- [Backup XML format](formatbackup.md#backup-xml-format)

  - [Backup XML](formatbackup.md#backup-xml)
  - [Examples](formatbackup.md#examples)

## [Backup XML](formatbackup.md#id2)
...
checkpoint](formatcheckpoint.md) to create at the same point in time. See
also [a comparison](kbase/domainstatecapture.md) between the various state
capture APIs.
...
:   An optional listing of instructions for disks participating in the backup (if
    ...
    :   This sub-element describes the backup properties of a specific disk, with
        ...
        :   A mandatory attribute which must match the <target dev='name'/> of
            one of the [disk devices](formatdomain.md#hard-drives-floppy-disks-cdroms) specified
...
XML](formatcheckpoint.md) that resulted in a checkpoint named
