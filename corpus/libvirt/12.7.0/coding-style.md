...
version: "12.7.0"
title: "Coding style"
source_url: https://libvirt.org/coding-style.html
fetched_at: 2026-08-21T04:09:41+00:00
---
# Coding style

Contents

- [Naming conventions](coding-style.md#naming-conventions)
- [Code indentation](coding-style.md#code-indentation)
- [Code formatting (especially for new code)](coding-style.md#code-formatting-especially-for-new-code)

  - [Bracket spacing](coding-style.md#bracket-spacing)
  - [Commas](coding-style.md#commas)
  - [Semicolons](coding-style.md#semicolons)
  - [Curly braces](coding-style.md#curly-braces)
  - [Conditional expressions](coding-style.md#conditional-expressions)
  - [Preprocessor](coding-style.md#preprocessor)
  - [C types](coding-style.md#c-types)

    - [Scalars](coding-style.md#scalars)
    - [Pointers](coding-style.md#pointers)
  - [Defining Local Variables](coding-style.md#defining-local-variables)
  - [Attribute annotations](coding-style.md#attribute-annotations)
  - [File handling](coding-style.md#file-handling)
  - [String comparisons](coding-style.md#string-comparisons)
  - [String copying](coding-style.md#string-copying)
  - [Variable length string buffer](coding-style.md#variable-length-string-buffer)
  - [Include files](coding-style.md#include-files)
  - [Printf-style functions](coding-style.md#printf-style-functions)
  - [Error message format](coding-style.md#error-message-format)
  - [Use of goto](coding-style.md#use-of-goto)
  - [XML element and attribute naming](coding-style.md#xml-element-and-attribute-naming)

# [Naming conventions](coding-style.md#id1)
...
# [Code indentation](coding-style.md#id2)
...
# [Code formatting (especially for new code)](coding-style.md#id3)
...
## [Bracket spacing](coding-style.md#id4)
...
## [Semicolons](coding-style.md#id6)
...
## [Curly braces](coding-style.md#id7)
...
## [Conditional expressions](coding-style.md#id8)
...
## [Preprocessor](coding-style.md#id9)
...
## [C types](coding-style.md#id10)

Use the right type.

### [Scalars](coding-style.md#id11)
...
## [Defining Local Variables](coding-style.md#id13)
...
## [Attribute annotations](coding-style.md#id14)
...
## [File handling](coding-style.md#id15)
...
## [String comparisons](coding-style.md#id16)
...
## [String copying](coding-style.md#id17)
...
## [Variable length string buffer](coding-style.md#id18)
...
## [Include files](coding-style.md#id19)
...
## [Printf-style functions](coding-style.md#id20)
...
## [Error message format](coding-style.md#id21)
...
## [Use of goto](coding-style.md#id22)
...
issue archived at
[KernelTrap](https://web.archive.org/web/20130521051957/http://kerneltrap.org/node/553/2131)
...
## [XML element and attribute naming](coding-style.md#id23)
