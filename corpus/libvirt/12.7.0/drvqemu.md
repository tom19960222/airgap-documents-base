...
collection: libvirt
version: "12.7.0"
title: "QEMU/KVM/HVF hypervisor driver"
source_url: https://libvirt.org/drvqemu.html
fetched_at: 2026-08-21T04:09:14+00:00
---
...
Hypervisor.framework (since 8.1.0).

Contents

- [Project Links](drvqemu.md#project-links)
- [Deployment pre-requisites](drvqemu.md#deployment-pre-requisites)
- [Connections to QEMU driver](drvqemu.md#connections-to-qemu-driver)

  - [Embedded driver](drvqemu.md#embedded-driver)

    - [Directory tree](drvqemu.md#directory-tree)
    - [API usage with event loop](drvqemu.md#api-usage-with-event-loop)
- [Location of configuration files](drvqemu.md#location-of-configuration-files)
- [Driver security architecture](drvqemu.md#driver-security-architecture)

  - [Driver instances](drvqemu.md#driver-instances)
  - [POSIX users/groups](drvqemu.md#posix-users-groups)
  - [Linux process capabilities](drvqemu.md#linux-process-capabilities)
  - [SELinux basic confinement](drvqemu.md#selinux-basic-confinement)
  - [SELinux sVirt confinement](drvqemu.md#selinux-svirt-confinement)
  - [AppArmor sVirt confinement](drvqemu.md#apparmor-svirt-confinement)
  - [Cgroups device ACLs](drvqemu.md#cgroups-device-acls)
- [Live migration compatibility](drvqemu.md#live-migration-compatibility)

  - [Migration CPU model compatibility](drvqemu.md#migration-cpu-model-compatibility)
- [Import and export of libvirt domain XML configs](drvqemu.md#import-and-export-of-libvirt-domain-xml-configs)

  - [Converting from QEMU args to domain XML](drvqemu.md#converting-from-qemu-args-to-domain-xml)
  - [Converting from domain XML to QEMU args](drvqemu.md#converting-from-domain-xml-to-qemu-args)
- [Pass-through of arbitrary qemu commands](drvqemu.md#pass-through-of-arbitrary-qemu-commands)
- [QEMU feature configuration for testing](drvqemu.md#qemu-feature-configuration-for-testing)
- [Control of QEMU deprecation warnings](drvqemu.md#control-of-qemu-deprecation-warnings)
- [Overriding properties of QEMU devices](drvqemu.md#overriding-properties-of-qemu-devices)
- [Example domain XML config](drvqemu.md#example-domain-xml-config)

  - [QEMU emulated guest on x86_64](drvqemu.md#qemu-emulated-guest-on-x86-64)
  - [KVM hardware accelerated guest on i686](drvqemu.md#kvm-hardware-accelerated-guest-on-i686)
  - [HVF hardware accelerated guest on x86_64](drvqemu.md#hvf-hardware-accelerated-guest-on-x86-64)

# [Project Links](drvqemu.md#id1)

- The [KVM](https://www.linux-kvm.org/) Linux hypervisor
- The [QEMU](https://wiki.qemu.org/Index.html) emulator
- [Hypervisor.framework](https://developer.apple.com/documentation/hypervisor) reference

# [Deployment pre-requisites](drvqemu.md#id2)
...
# [Connections to QEMU driver](drvqemu.md#id3)
...
## [Embedded driver](drvqemu.md#id4)
...
### [API usage with event loop](drvqemu.md#id6)
...
# [Location of configuration files](drvqemu.md#id7)
...
# [Driver security architecture](drvqemu.md#id8)
...
## [Driver instances](drvqemu.md#id9)
...
## [POSIX users/groups](drvqemu.md#id10)
...
## [Linux process capabilities](drvqemu.md#id11)
...
## [SELinux basic confinement](drvqemu.md#id12)
...
migration destination side. Users are advised to use static labels (<seclabel type='static' .../>).

## [SELinux sVirt confinement](drvqemu.md#id13)
...
## [AppArmor sVirt confinement](drvqemu.md#id14)
...
## [Cgroups device ACLs](drvqemu.md#id15)
...
# [Live migration compatibility](drvqemu.md#id16)
...
## [Migration CPU model compatibility](drvqemu.md#id17)
...
# [Import and export of libvirt domain XML configs](drvqemu.md#id18)
...
## [Converting from QEMU args to domain XML](drvqemu.md#id19)

**Note:** this operation is deleted as of 5.5.0 and will return an
error.
...
APIs (see the [libvirt applications page](apps.md) for some examples) or by
manually crafting XML to pass to virsh.

## [Converting from domain XML to QEMU args](drvqemu.md#id20)
...
# [Pass-through of arbitrary qemu commands](drvqemu.md#id21)
...
Since 0.8.3 ), and virDomainQemuAttach, for registering a qemu
domain that was manually started so that it can then be managed by libvirtd (
Since 0.9.4, removed as of 5.5.0 ).

Additionally, the following XML additions allow fine-tuning of the command line
given to qemu when starting a domain ( Since 0.8.3 ). In order to use
...
# [QEMU feature configuration for testing](drvqemu.md#id22)
...
it's complete or disable it for debugging purposes. Since 5.5.0 it's
...
# [Control of QEMU deprecation warnings](drvqemu.md#id23)
...
# [Overriding properties of QEMU devices](drvqemu.md#id24)
...
# [Example domain XML config](drvqemu.md#id25)

## [QEMU emulated guest on x86_64](drvqemu.md#id26)
...
## [KVM hardware accelerated guest on i686](drvqemu.md#id27)
...
## [HVF hardware accelerated guest on x86_64](drvqemu.md#id28)
