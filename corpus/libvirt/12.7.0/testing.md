...
version: "12.7.0"
title: "Testing"
source_url: https://libvirt.org/testing.html
fetched_at: 2026-08-21T04:10:19+00:00
---
# Testing
...
- [Container builds](testing.md#container-builds)

  - [Registry](testing.md#registry)
  - [Running container builds with GitLab CI](testing.md#running-container-builds-with-gitlab-ci)
  - [Running container jobs locally](testing.md#running-container-jobs-locally)
  - [Podman Prerequisites](testing.md#podman-prerequisites)
  - [Docker Prerequisites](testing.md#docker-prerequisites)
  - [Examples of executing local container builds](testing.md#examples-of-executing-local-container-builds)
...
# [Container builds](testing.md#id2)
...
## [Running container builds with GitLab CI](testing.md#id4)
...
## [Running container jobs locally](testing.md#id5)
...
## [Podman Prerequisites](testing.md#id6)
...
## [Docker Prerequisites](testing.md#id7)
...
## [Examples of executing local container builds](testing.md#id8)
...
# [Integration tests](testing.md#id9)
...
- the [TCK test suite](testtck.md) is a functional test suite implemented
  using the [Perl bindings](https://search.cpan.org/dist/Sys-Virt/) of
  ...
  [TCK git repo](https://gitlab.com/libvirt/libvirt-tck).
- the [Avocado VT](https://github.com/avocado-framework/avocado-vt) test
...
- the [libvirt-test-API](testapi.md) is also a functional test suite, but
  implemented using the [Python bindings](python.md) of libvirt.
  ...
  [git repo](https://gitlab.com/libvirt/libvirt-test-API/).
