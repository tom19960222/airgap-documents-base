...
version: "12.7.0"
title: "Contributing"
source_url: https://libvirt.org/hacking.html
...
libvirt-python) [online](https://gitlab.com/libvirt).

Patches to translations are maintained via the [Fedora Weblate
service](https://translate.fedoraproject.org/projects/libvirt/libvirt).
...
The ["Git checkout" section](compiling.md#git-checkout)
of the libvirt installation instructions give an overview of the
compilation process.

Optionally, [Clangd with libvirt](clangd.md) can be used to
...
follows the project's [coding style](coding-style.md).
...
don't forget to update the [release notes](https://libvirt.org/news.html) if your
...
[continuous integration](https://libvirt.org/ci.html) test suite.
...
libvirt. Of particular concern is content generated by [Large Language Models](https://en.wikipedia.org/wiki/Large_language_model) (LLMs).
...
Origin](hacking.md#developer-certificate-of-origin).
...
- [Advanced test suite usage](advanced-tests.md)
- [Adoption of GLib APIs](glib-adoption.md)
- [Committer guidelines](committer-guidelines.md)
- [Contributing to libvirt](contribute.md)
