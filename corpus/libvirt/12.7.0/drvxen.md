...
collection: libvirt
version: "12.7.0"
title: "libxl hypervisor driver for Xen"
source_url: https://libvirt.org/drvxen.html
...
- [Project Links](drvxen.md#project-links)
- [Deployment pre-requisites](drvxen.md#deployment-pre-requisites)
- [Connections to libxl driver](drvxen.md#connections-to-libxl-driver)
- [Location of configuration files](drvxen.md#location-of-configuration-files)
- [Import and export of libvirt domain XML configs](drvxen.md#import-and-export-of-libvirt-domain-xml-configs)

  - [Converting from XM config files to domain XML](drvxen.md#converting-from-xm-config-files-to-domain-xml)
  - [Converting from domain XML to XM config files](drvxen.md#converting-from-domain-xml-to-xm-config-files)
- [Pass-through of arbitrary command-line arguments to the qemu device model](drvxen.md#pass-through-of-arbitrary-command-line-arguments-to-the-qemu-device-model)
- [Example domain XML config](drvxen.md#example-domain-xml-config)

  - [Paravirtualized guest bootloader](drvxen.md#paravirtualized-guest-bootloader)
  - [Paravirtualized guest direct kernel boot](drvxen.md#paravirtualized-guest-direct-kernel-boot)
  - [Fullyvirtualized guest BIOS boot](drvxen.md#fullyvirtualized-guest-bios-boot)
  - [Fullyvirtualized guest direct kernel boot](drvxen.md#fullyvirtualized-guest-direct-kernel-boot)

The libvirt libxl driver provides the ability to manage virtual machines on any
Xen release from 4.6.0 onwards.

# [Project Links](drvxen.md#id1)

- The [Xen](https://www.xenproject.org) hypervisor on Linux and Solaris
  hosts

# [Deployment pre-requisites](drvxen.md#id2)
...
# [Connections to libxl driver](drvxen.md#id3)
...
# [Location of configuration files](drvxen.md#id4)
...
# [Import and export of libvirt domain XML configs](drvxen.md#id5)
...
## [Converting from XM config files to domain XML](drvxen.md#id6)
...
## [Converting from domain XML to XM config files](drvxen.md#id7)
...
# [Pass-through of arbitrary command-line arguments to the qemu device model](drvxen.md#id8)

Since 6.7.0, the Xen driver supports passing arbitrary command-line
...
# [Example domain XML config](drvxen.md#id9)
...
format](formatdomain.md) guide.

## [Paravirtualized guest bootloader](drvxen.md#id10)
...
## [Paravirtualized guest direct kernel boot](drvxen.md#id11)
...
## [Fullyvirtualized guest BIOS boot](drvxen.md#id12)
...
## [Fullyvirtualized guest direct kernel boot](drvxen.md#id13)
