...
collection: libvirt
version: "12.7.0"
title: "libvirt-test-API: Python based test suite"
source_url: https://libvirt.org/testapi.html
...
- A [documentation
  PDF](https://download.libvirt.org/libvirt-test-API/Libvirt-test-API.pdf)
  file describing the test suite and how to write test cases and test
  scenarios.

Libvirt-test-API is maintained using [a GIT
repository](https://gitlab.com/libvirt/libvirt-test-API), and comment,
patches and reviews are carried on the [devel](https://libvirt.org/contact.html)
mailing list.
