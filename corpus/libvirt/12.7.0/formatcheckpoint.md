...
collection: libvirt
version: "12.7.0"
title: "Checkpoint XML format"
source_url: https://libvirt.org/formatcheckpoint.html
...
- [Checkpoint XML](formatcheckpoint.md#checkpoint-xml)
- [Examples](formatcheckpoint.md#examples)

# [Checkpoint XML](formatcheckpoint.md#id1)
...
state capture](kbase/domainstatecapture.md) for a comparison between APIs).
...
:   A readonly representation of the inactive [domain
    configuration](formatdomain.md) at the time the checkpoint was created.
    ...
    Since 7.0.0 the <domain> element can be omitted when redefining
    a checkpoint, but hypervisors may not support certain operations if it's
    missing.

# [Examples](formatcheckpoint.md#id2)
