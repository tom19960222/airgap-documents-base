...
source_url: https://libvirt.org/styleguide.html
...
- [Table of contents](styleguide.md#table-of-contents)
- [Whitespace](styleguide.md#whitespace)
- [Code blocks](styleguide.md#code-blocks)
- [Headings](styleguide.md#headings)
- [Tables](styleguide.md#tables)
- [Manual pages](styleguide.md#manual-pages)

The following documents some specific libvirt rules for writing docs in
reStructuredText

# [Table of contents](styleguide.md#id1)
...
# [Whitespace](styleguide.md#id2)

Blocks should be indented with 3 spaces, and no tabs

# [Code blocks](styleguide.md#id3)
...
# [Manual pages](styleguide.md#id6)
