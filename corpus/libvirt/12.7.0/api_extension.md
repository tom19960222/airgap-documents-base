...
collection: libvirt
version: "12.7.0"
title: "Implementing a new API in Libvirt"
source_url: https://libvirt.org/api_extension.html
...
- [Defining the public API](api_extension.md#defining-the-public-api)
- [Defining the internal API](api_extension.md#defining-the-internal-api)
- [Implementing the public API](api_extension.md#implementing-the-public-api)
- [Implementing the remote protocol](api_extension.md#implementing-the-remote-protocol)

  - [Defining the wire protocol format](api_extension.md#defining-the-wire-protocol-format)
  - [Implement the RPC client](api_extension.md#implement-the-rpc-client)
  - [Implement the server side dispatcher](api_extension.md#implement-the-server-side-dispatcher)
- [Use the new API internally](api_extension.md#use-the-new-api-internally)
- [Expose the new API in virsh](api_extension.md#expose-the-new-api-in-virsh)
- [Implement the driver methods](api_extension.md#implement-the-driver-methods)

  - [Implement common handling](api_extension.md#implement-common-handling)
  - [Implement driver handling](api_extension.md#implement-driver-handling)
...
out and build the code can be found at the [downloads](https://libvirt.org/downloads.html) page.
...
# [Defining the public API](api_extension.md#id1)
...
style](coding-style.md#xml-element-and-attribute-naming) guide on
...
# [Defining the internal API](api_extension.md#id2)
...
# [Implementing the public API](api_extension.md#id3)
...
1. SHOULD log a message with VIR_DEBUG() indicating that it is being
   called and its parameters;
2. MUST call virResetLastError();
3. SHOULD confirm that the connection is valid with
   virCheckConnectReturn() or virCheckConnectGoto();
4. **SECURITY: If the API requires a connection with write privileges,
   MUST confirm that the connection flags do not indicate that the
   connection is read-only with virCheckReadOnlyGoto();**
5. SHOULD do basic validation of the parameters that are being passed
   in, using helpers like virCheckNonNullArgGoto();
6. MUST confirm that the driver for this connection exists and that it
   implements this function;
7. MUST call the internal API;
8. SHOULD log a message with VIR_DEBUG() indicating that it is
...
# [Implementing the remote protocol](api_extension.md#id4)
...
## [Defining the wire protocol format](api_extension.md#id5)
...
## [Implement the RPC client](api_extension.md#id6)
...
## [Implement the server side dispatcher](api_extension.md#id7)
...
# [Use the new API internally](api_extension.md#id8)
...
# [Expose the new API in virsh](api_extension.md#id9)
...
# [Implement the driver methods](api_extension.md#id10)
...
## [Implement common handling](api_extension.md#id11)
...
## [Implement driver handling](api_extension.md#id12)
