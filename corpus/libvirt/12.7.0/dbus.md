...
collection: libvirt
version: "12.7.0"
title: "D-Bus API bindings"
source_url: https://libvirt.org/dbus.html
...
- [Description](dbus.md#description)
- [GIT source repository](dbus.md#git-source-repository)
- [Usage](dbus.md#usage)

# [Description](dbus.md#id1)

libvirt-dbus wraps libvirt API to provide a high-level object-oriented API
better suited for dbus-based applications.

# [GIT source repository](dbus.md#id2)

The D-Bus bindings source code is maintained in a [git](https://git-scm.com/)
repository available on
[gitlab.com](https://gitlab.com/libvirt/libvirt-dbus):
