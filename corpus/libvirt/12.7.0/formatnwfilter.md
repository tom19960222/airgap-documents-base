...
source_url: https://libvirt.org/formatnwfilter.html
...
- [Goals and background](formatnwfilter.md#goals-and-background)
- [Concepts](formatnwfilter.md#concepts)

  - [Filtering chains](formatnwfilter.md#filtering-chains)
  - [Filtering chain priorities](formatnwfilter.md#filtering-chain-priorities)
  - [Usage of variables in filters](formatnwfilter.md#usage-of-variables-in-filters)
  - [Automatic IP address detection](formatnwfilter.md#automatic-ip-address-detection)
  - [Reserved Variables](formatnwfilter.md#reserved-variables)
- [Element and attribute overview](formatnwfilter.md#element-and-attribute-overview)

  - [References to other filters](formatnwfilter.md#references-to-other-filters)
  - [Filter rules](formatnwfilter.md#filter-rules)

    - [Supported protocols](formatnwfilter.md#supported-protocols)

      - [MAC (Ethernet)](formatnwfilter.md#mac-ethernet)
      - [VLAN (802.1Q) (Since 0.9.8)](formatnwfilter.md#vlan-802-1q-since-0-9-8)
      - [STP (Spanning Tree Protocol) (Since 0.9.8)](formatnwfilter.md#stp-spanning-tree-protocol-since-0-9-8)
      - [ARP/RARP](formatnwfilter.md#arp-rarp)
      - [IPv4](formatnwfilter.md#ipv4)
      - [IPv6](formatnwfilter.md#ipv6)
      - [TCP/UDP/SCTP](formatnwfilter.md#tcp-udp-sctp)
      - [ICMP](formatnwfilter.md#icmp)
      - [IGMP, ESP, AH, UDPLITE, 'ALL'](formatnwfilter.md#igmp-esp-ah-udplite-all)
      - [TCP/UDP/SCTP over IPV6](formatnwfilter.md#tcp-udp-sctp-over-ipv6)
      - [ICMPv6](formatnwfilter.md#icmpv6)
      - [ESP, AH, UDPLITE, 'ALL' over IPv6](formatnwfilter.md#esp-ah-udplite-all-over-ipv6)
  - [Advanced Filter Configuration Topics](formatnwfilter.md#advanced-filter-configuration-topics)

    - [Connection tracking](formatnwfilter.md#connection-tracking)
    - [Limiting Number of Connections](formatnwfilter.md#limiting-number-of-connections)
- [Command line tools](formatnwfilter.md#command-line-tools)
- [Pre-existing network filters](formatnwfilter.md#pre-existing-network-filters)
- [Writing your own filters](formatnwfilter.md#writing-your-own-filters)

  - [Example custom filter](formatnwfilter.md#example-custom-filter)
  - [Second example custom filter](formatnwfilter.md#second-example-custom-filter)
- [Limitations](formatnwfilter.md#limitations)

  - [VM Migration](formatnwfilter.md#vm-migration)
  - [VLAN filtering on Linux](formatnwfilter.md#vlan-filtering-on-linux)

This page provides an introduction to libvirt's network filters, their goals,
concepts and XML format.

# [Goals and background](formatnwfilter.md#id1)
...
# [Concepts](formatnwfilter.md#id2)
...
## [Filtering chains](formatnwfilter.md#id3)
...
Since 0.9.8 multiple chains evaluating the mac, stp, vlan,
...
## [Filtering chain priorities](formatnwfilter.md#id4)
...
Since 0.9.8 the above listed chains can be assigned custom priorities
...
## [Usage of variables in filters](formatnwfilter.md#id5)
...
[Limitations](formatnwfilter.md#limitations) on how to use this feature and what to expect when using it.
...
Since 0.9.8 variables can contain lists of elements, e.g., the variable
...
Since 0.9.10 it is possible to access individual elements of a variable
...
Since 0.9.10 it is possible to create filtering rules that instantiate
...
## [Automatic IP address detection](formatnwfilter.md#id6)
...
been assigned to it. Since 0.9.13 the variable CTRL_IP_LEARNING can
...
## [Reserved Variables](formatnwfilter.md#id7)
...
# [Element and attribute overview](formatnwfilter.md#id8)
...
## [References to other filters](formatnwfilter.md#id9)
...
## [Filter rules](formatnwfilter.md#id10)
...
- action -- mandatory; must either be drop (matching the rule silently
  ...
  (since 0.9.0; matching the rule generates an ICMP reject message
  with no further analysis),
  accept (matching the rule accepts the packet with no further
  analysis), return (since 0.9.7; matching the rule passes this
  filter, but returns control to the calling filter for further analysis),
  or continue (since 0.9.7; matching the rule goes on to the next
...
- priority -- optional; the priority of the rule controls the order in which
  ...
  range of 0 to 1000. Since 0.9.8 this has been extended to cover the
...
- statematch -- optional; possible values are '0' or 'false' to turn the
  ...
  Also read the section on [Advanced Filter Configuration Topics](formatnwfilter.md#advanced-filter-configuration-topics).
...
### [Supported protocols](formatnwfilter.md#id11)
...
#### [MAC (Ethernet)](formatnwfilter.md#id12)
...
#### [VLAN (802.1Q) (Since 0.9.8)](formatnwfilter.md#id13)
...
#### [STP (Spanning Tree Protocol) (Since 0.9.8)](formatnwfilter.md#id14)
...
#### [ARP/RARP](formatnwfilter.md#id15)
...
| dstportstart | UINT16 | Start of range of valid destination ports; requires protocol |
| dstportend | UINT16 | End of range of valid destination ports; requires protocol |
| type (Since 1.2.12) | UINT8 | ICMPv6 type; requires protocol to be set to icmpv6 |
...
| code (Since 1.2.12) | UINT8 | ICMPv6 code end of range; requires protocol to be set to icmpv6 |
| comment (Since 0.8.5) | STRING | text with max. 256 characters |

Valid strings for protocol are: tcp, udp, udplite, esp, ah, icmpv6, sctp

#### [TCP/UDP/SCTP](formatnwfilter.md#id18)
...
| flags (Sinc 0.9.1) | STRING | TCP-only: format of mask/flags with mask and flags each being a comma separated list of SYN,ACK,URG,PSH,FIN,RST or NONE or ALL |
...
#### [IGMP, ESP, AH, UDPLITE, 'ALL'](formatnwfilter.md#id20)
...
#### [TCP/UDP/SCTP over IPV6](formatnwfilter.md#id21)
...
#### [ESP, AH, UDPLITE, 'ALL' over IPv6](formatnwfilter.md#id23)
...
## [Advanced Filter Configuration Topics](formatnwfilter.md#id24)

The following sections discuss advanced filter configuration topics.

### [Connection tracking](formatnwfilter.md#id25)
...
### [Limiting Number of Connections](formatnwfilter.md#id26)
...
# [Command line tools](formatnwfilter.md#id27)
...
# [Pre-existing network filters](formatnwfilter.md#id28)
...
| no-ip-spoofing | Prevent a VM from sending of IPv4 packets with a source IP address different from the one in the packet. |
...
# [Writing your own filters](formatnwfilter.md#id29)
...
Since 0.9.8 multiple chains for the same protocol can be created. For
...
## [Example custom filter](formatnwfilter.md#id30)
...
## [Second example custom filter](formatnwfilter.md#id31)
...
since 0.8.5. The requirements for this filter are:
...
## [VLAN filtering on Linux](formatnwfilter.md#id34)
