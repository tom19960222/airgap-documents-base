...
source_url: https://libvirt.org/formatdomain.html
fetched_at: 2026-08-21T04:09:23+00:00
---
# Domain XML format

Contents

- [Element and attribute overview](formatdomain.md#element-and-attribute-overview)

  - [General metadata](formatdomain.md#general-metadata)
  - [Operating system booting](formatdomain.md#operating-system-booting)

    - [Guest firmware](formatdomain.md#guest-firmware)
    - [Host bootloader](formatdomain.md#host-bootloader)
    - [Direct kernel boot](formatdomain.md#direct-kernel-boot)
    - [Container boot](formatdomain.md#container-boot)
    - [Common <os> element configuration](formatdomain.md#common-os-element-configuration)
  - [SMBIOS System Information](formatdomain.md#smbios-system-information)
  - [CPU Allocation](formatdomain.md#cpu-allocation)
  - [IOThreads Allocation](formatdomain.md#iothreads-allocation)
  - [CPU Tuning](formatdomain.md#cpu-tuning)
  - [Memory Allocation](formatdomain.md#memory-allocation)
  - [Memory Backing](formatdomain.md#memory-backing)
  - [Memory Tuning](formatdomain.md#memory-tuning)
  - [NUMA Node Tuning](formatdomain.md#numa-node-tuning)
  - [Block I/O Tuning](formatdomain.md#block-i-o-tuning)
  - [Host Device IOMMUFD](formatdomain.md#host-device-iommufd)
  - [Resource partitioning](formatdomain.md#resource-partitioning)
  - [Fibre Channel VMID](formatdomain.md#fibre-channel-vmid)
  - [CPU model and topology](formatdomain.md#cpu-model-and-topology)

    - [ACPI Heterogeneous Memory Attribute Table](formatdomain.md#acpi-heterogeneous-memory-attribute-table)
  - [Events configuration](formatdomain.md#events-configuration)
  - [Power Management](formatdomain.md#power-management)
  - [Disk Throttle Group Management](formatdomain.md#disk-throttle-group-management)
  - [Hypervisor features](formatdomain.md#hypervisor-features)
  - [Time keeping](formatdomain.md#time-keeping)
  - [Performance monitoring events](formatdomain.md#performance-monitoring-events)
  - [Devices](formatdomain.md#devices)

    - [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms)
    - [Filesystems](formatdomain.md#filesystems)
    - [Device Addresses](formatdomain.md#device-addresses)
    - [Virtio-related options](formatdomain.md#virtio-related-options)
    - [Virtio device models](formatdomain.md#virtio-device-models)
    - [Controllers](formatdomain.md#controllers)
    - [Device leases](formatdomain.md#device-leases)
    - [Host device assignment](formatdomain.md#host-device-assignment)

      - [USB / PCI / SCSI devices](formatdomain.md#usb-pci-scsi-devices)
      - [ACPI Generic Initiators](formatdomain.md#acpi-generic-initiators)
      - [Block / character devices](formatdomain.md#block-character-devices)
    - [Redirected devices](formatdomain.md#redirected-devices)
    - [Smartcard devices](formatdomain.md#smartcard-devices)
    - [Network interfaces](formatdomain.md#network-interfaces)

      - [Virtual network](formatdomain.md#virtual-network)
      - [Bridge to LAN](formatdomain.md#bridge-to-lan)
      - [Userspace connection using SLIRP](formatdomain.md#userspace-connection-using-slirp)
      - [Userspace connection using passt](formatdomain.md#userspace-connection-using-passt)
      - [Generic ethernet connection](formatdomain.md#generic-ethernet-connection)
      - [Direct attachment to physical interface](formatdomain.md#direct-attachment-to-physical-interface)
      - [PCI Passthrough](formatdomain.md#pci-passthrough)
      - [vDPA devices](formatdomain.md#vdpa-devices)
      - [Teaming a virtio/hostdev NIC pair](formatdomain.md#teaming-a-virtio-hostdev-nic-pair)
      - [Multicast tunnel](formatdomain.md#multicast-tunnel)
      - [TCP tunnel](formatdomain.md#tcp-tunnel)
      - [UDP unicast tunnel](formatdomain.md#udp-unicast-tunnel)
      - [Null network interface](formatdomain.md#null-network-interface)
      - [VMWare Distributed Switch](formatdomain.md#vmware-distributed-switch)
      - [Setting the NIC model](formatdomain.md#setting-the-nic-model)
      - [Setting NIC driver-specific options](formatdomain.md#setting-nic-driver-specific-options)
      - [Setting network backend-specific options](formatdomain.md#setting-network-backend-specific-options)
      - [Overriding the target element](formatdomain.md#overriding-the-target-element)
      - [Specifying boot order](formatdomain.md#specifying-boot-order)
      - [Interface ROM BIOS configuration](formatdomain.md#interface-rom-bios-configuration)
      - [Setting up a network backend in a driver domain](formatdomain.md#setting-up-a-network-backend-in-a-driver-domain)
      - [Quality of service](formatdomain.md#quality-of-service)
      - [Setting VLAN tag (on supported network types only)](formatdomain.md#setting-vlan-tag-on-supported-network-types-only)
      - [Isolating guests' network traffic from each other](formatdomain.md#isolating-guests-network-traffic-from-each-other)
      - [Modifying virtual link state](formatdomain.md#modifying-virtual-link-state)
      - [MTU configuration](formatdomain.md#mtu-configuration)
      - [Coalesce settings](formatdomain.md#coalesce-settings)
      - [IP configuration](formatdomain.md#ip-configuration)
      - [vhost-user connection](formatdomain.md#vhost-user-connection)
      - [vhost-user connection with passt backend](formatdomain.md#vhost-user-connection-with-passt-backend)
      - [Traffic filtering with NWFilter](formatdomain.md#traffic-filtering-with-nwfilter)
    - [Input devices](formatdomain.md#input-devices)
    - [Hub devices](formatdomain.md#hub-devices)
    - [Graphical framebuffers](formatdomain.md#graphical-framebuffers)
    - [Video devices](formatdomain.md#video-devices)
    - [Consoles, serial, parallel & channel devices](formatdomain.md#consoles-serial-parallel-channel-devices)

      - [Guest interface](formatdomain.md#guest-interface)

        - [Parallel port](formatdomain.md#parallel-port)
        - [Serial port](formatdomain.md#serial-port)
        - [Console](formatdomain.md#console)
        - [Relationship between serial ports and consoles](formatdomain.md#relationship-between-serial-ports-and-consoles)
        - [Channel](formatdomain.md#channel)
      - [Host interface](formatdomain.md#host-interface)

        - [Domain logfile](formatdomain.md#domain-logfile)
        - [Device logfile](formatdomain.md#device-logfile)
        - [Virtual console](formatdomain.md#virtual-console)
        - [Null device](formatdomain.md#null-device)
        - [Pseudo TTY](formatdomain.md#pseudo-tty)
        - [Host device proxy](formatdomain.md#host-device-proxy)
        - [Named pipe](formatdomain.md#named-pipe)
        - [TCP client/server](formatdomain.md#tcp-client-server)
        - [UDP network console](formatdomain.md#udp-network-console)
        - [UNIX domain socket client/server](formatdomain.md#unix-domain-socket-client-server)
        - [Spice channel](formatdomain.md#spice-channel)
        - [Nmdm device](formatdomain.md#nmdm-device)
    - [Sound devices](formatdomain.md#sound-devices)
    - [Audio backends](formatdomain.md#audio-backends)

      - [None audio backend](formatdomain.md#none-audio-backend)
      - [ALSA audio backend](formatdomain.md#alsa-audio-backend)
      - [Coreaudio audio backend](formatdomain.md#coreaudio-audio-backend)
      - [D-Bus audio backend](formatdomain.md#d-bus-audio-backend)
      - [Jack audio backend](formatdomain.md#jack-audio-backend)
      - [OSS audio backend](formatdomain.md#oss-audio-backend)
      - [PipeWire audio backend](formatdomain.md#pipewire-audio-backend)
      - [PulseAudio audio backend](formatdomain.md#pulseaudio-audio-backend)
      - [SDL audio backend](formatdomain.md#sdl-audio-backend)
      - [Spice audio backend](formatdomain.md#spice-audio-backend)
      - [File audio backend](formatdomain.md#file-audio-backend)
    - [Watchdog devices](formatdomain.md#watchdog-devices)
    - [Memory balloon device](formatdomain.md#memory-balloon-device)
    - [Random number generator device](formatdomain.md#random-number-generator-device)
    - [TPM device](formatdomain.md#tpm-device)
    - [NVRAM device](formatdomain.md#nvram-device)
    - [panic device](formatdomain.md#panic-device)
    - [Shared memory device](formatdomain.md#shared-memory-device)
    - [Memory devices](formatdomain.md#memory-devices)
    - [IOMMU devices](formatdomain.md#iommu-devices)
    - [Vsock](formatdomain.md#vsock)
    - [Crypto](formatdomain.md#crypto)
    - [Pstore](formatdomain.md#pstore)
  - [Security label](formatdomain.md#security-label)
  - [Key Wrap](formatdomain.md#key-wrap)
  - [Launch Security](formatdomain.md#launch-security)
- [Example configs](formatdomain.md#example-configs)
...
# [Element and attribute overview](formatdomain.md#id1)
...
"hvf" (since 8.1.0 and QEMU 2.12), "qemu"
...
## [General metadata](formatdomain.md#id2)
...
:   The content of the uuid element provides a globally unique identifier for
    ...
    new machine, a random UUID is generated. Since 0.0.1

    Since 0.8.7, it is also possible to provide the UUID via a
    [SMBIOS System Information](formatdomain.md#smbios-system-information) specification.
...
:   The optional hwuuid element can be used to supply an alternative UUID for
    ...
    via a [SMBIOS System Information](formatdomain.md#smbios-system-information) specification is that the hwuuid affects
    all devices that expose the UUID to the guest.
    Since 11.7.0 QEMU/KVM only

genid
:   Since 4.4.0, the genid element can be used to add a Virtual
...
:   The optional element title provides space for a short description of the
    domain. The title should not contain any newlines. Since 0.9.10.
...
:   The content of the description element provides a human readable
    ...
    way, it can contain any information the user wants. Since 0.7.2
...
## [Operating system booting](formatdomain.md#id3)

There are a number of different ways to boot virtual machines each with their
own pros and cons.

### [Guest firmware](formatdomain.md#id4)
...
:   The firmware attribute allows management applications to automatically
    ...
    to bother. Since 5.2.0 (QEMU and KVM only)
...
:   The content of the type element specifies the type of operating system to
    ...
    type. The [Capabilities XML](formatcaps.md) provides details on allowed
...
:   The optional loader tag refers to a firmware blob, which is specified by
    ...
    QEMU/KVM domains. Xen since 0.1.0, QEMU/KVM since 0.9.12 Then,
    since 1.2.8 it's possible for the element to have two optional
    ...
    Since 2.1.0. If the loader is marked as read-only, then with UEFI it
    ...
    any config changes on shutdown. The stateless flag (Since 8.6.0)
...
:   Some UEFI firmwares may want to use a non-volatile memory to store some
    ...
    the format of the picked template. Since 10.10.0 (QEMU only)
    ...
    to save and remove file (if needed to be persistent). Since 1.2.8

    Since 8.5.0, it's possible for the element to have type attribute
    ...
    disk's source. See [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms). For block
    ...
    **Note:** network backed NVRAM the variables are not instantiated from
    ...
    of the NVRAM image. Since 9.2.0 (QEMU only) Note that hypervisors
...
:   This works much the same way as the <nvram/> element described above,
    ...
    instead of being backed by a pflash device. Since 12.1.0 (QEMU only)
...
:   The dev attribute takes one of the values "fd", "hd", "cdrom" or
    ...
    elements (see [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms), [Network interfaces](formatdomain.md#network-interfaces),
    and [Host device assignment](formatdomain.md#host-device-assignment) sections below) were introduced and they are
...
:   How to populate SMBIOS information visible in the guest. The mode
    ...
    [virConnectGetSysinfo](https://libvirt.org/html/libvirt-libvirt-host.html#virConnectGetSysinfo)
    call can be used to see what values are copied), or "sysinfo" (use the values
    in the [SMBIOS System Information](formatdomain.md#smbios-system-information) element). If not specified, the
    hypervisor default is used. Since 0.8.7
...
:   Whether or not to enable an interactive boot menu prompt on guest startup.
    ...
    hypervisor default is used. Since 0.8.3 Additional attribute
    ...
    is ignored unless enable is set to "yes". Since 1.2.8
...
:   This element has attribute useserial with possible values yes or
    ...
    see BIOS messages on a serial port. Therefore, one needs to have [Serial port](formatdomain.md#serial-port)
    defined. Since 0.9.4.
    The rebootTimeout attribute (since 0.10.2 (QEMU only))
...
### [Host bootloader](formatdomain.md#id5)
...
:   The content of the bootloader element provides a fully qualified path to
    ...
    dependent on the hypervisor in use. Since 0.1.0

bootloader_args
:   The optional bootloader_args element allows command line arguments to be
    passed to the bootloader. Since 0.2.3

### [Direct kernel boot](formatdomain.md#id6)
...
:   This element has the same semantics as described earlier in the
    [guest firmware](formatdomain.md#guest-firmware) section.
...
### [Container boot](formatdomain.md#id7)
...
### [Common <os> element configuration](formatdomain.md#id8)
...
:   The table element contains a fully-qualified path to the ACPI table,
    ...
    - raw: a single ACPI table with header and data, with ACPI
      signature auto-detected from header (Since 11.2.0 (QEMU)).
    ...
    - slic: a single ACPI table with header and data, providing
      ...
      header will be forced to SLIC (Since 1.3.5 (QEMU),
      mis-interpreted as rawset Since 5.9.0 (Xen)).
...
## [SMBIOS System Information](formatdomain.md#id9)
...
covers all such categories of information. Since 0.8.7
...
:   Sub-elements call out specific SMBIOS values, which will affect the guest if
    ...
    (see [Operating system booting](formatdomain.md#operating-system-booting)). Each sub-element of sysinfo names a SMBIOS
    ...
    :   This is block 1 of SMBIOS, with entry names drawn from:
        ...
        :   Universal Unique ID number. If this entry is provided alongside a
            top-level uuid element (see [General metadata](formatdomain.md#general-metadata)), then the two
            values must match.
    ...
    chassis
    :   Since 4.1.0, this is block 3 of SMBIOS, with entry names drawn
        from:
...
## [CPU Allocation](formatdomain.md#id10)
...
:   The content of this element defines the maximum number of virtual CPUs
    ...
    :   The optional attribute placement can be used to indicate the CPU
        ...
        available physical CPUs. Since 0.9.11 (QEMU and KVM only)
...
:   The vcpus element allows to control state of individual vCPUs. The id
    ...
    boot need to be grouped after vCPU 0. Since 2.2.0 (QEMU only)

## [IOThreads Allocation](formatdomain.md#id11)
...
host/guest with many LUNs. Since 1.2.8 (QEMU only)
...
:   The content of this optional element defines the number of IOThreads to be
    ...
    supported device assigned to each IOThread. Since 1.2.8
...
:   The optional iothreadids element provides the capability to specifically
    ...
    adjusted accordingly. Since 1.2.15
    ...
    the latter can't. Since 8.5.0
    Since 9.4.0 an optional sub-element poll can be used to
    ...
    Since 12.7.0 the optional attribute weight sets the shift value
...
:   This element represents the default event loop within hypervisor, where I/O
    ...
    of time it takes to spawn new worker threads. Since 8.5.0

## [CPU Tuning](formatdomain.md#id12)
...
:   The optional vcpupin element specifies which of host's physical CPUs the
    ...
    QEMU driver support since 0.9.0, Xen driver support since 0.9.1
...
:   The optional iothreadpin element specifies which of host physical CPUs
    ...
    specifying which physical CPUs to pin to. See the [IOThreads Allocation](formatdomain.md#iothreads-allocation)
    section documenting valid values of iothread. Since 1.2.9
...
:   The optional shares element specifies the proportional weighted share for
    ...
    [2, 262144] using cgroups v1, [1, 10000] using cgroups v2. Since 0.9.0
...
:   The optional global_quota element specifies the maximum allowed bandwidth
    ...
    value 0 means no value. Only QEMU driver support since 1.3.3
...
:   The optional emulator_quota element specifies the maximum allowed
    ...
    no value. Only QEMU driver support since 0.10.0
...
:   The optional vcpusched, iothreadsched and emulatorsched elements
    ...
    domain. Valid iothreads values are described in the [IOThreads Allocation](formatdomain.md#iothreads-allocation)
...
:   Optional cachetune element can control allocations for CPU caches using
    ...
    :   This optional element controls the allocation of CPU cache and has the
        ...
        :   If specified it is the unit such as KiB, MiB, GiB, or TiB (described in
            the memory element for [Memory Allocation](formatdomain.md#memory-allocation)) in which size is
...
## [Memory Allocation](formatdomain.md#id13)
...
:   The maximum allocation of memory for the guest at boot time. The memory
    ...
    attribute unit, which defaults to "KiB" (kibibytes, 210 or
    blocks of 1024 bytes). Valid units are "b" or "bytes" for bytes, "KB" for
    kilobytes (103 or 1,000 bytes), "k" or "KiB" for kibibytes (1024
    bytes), "MB" for megabytes (106 or 1,000,000 bytes), "M" or "MiB" for
    mebibytes (220 or 1,048,576 bytes), "GB" for gigabytes (109 or
    1,000,000,000 bytes), "G" or "GiB" for gibibytes (230 or 1,073,741,824
    bytes), "TB" for terabytes (1012 or 1,000,000,000,000 bytes), or "T"
    or "TiB" for tebibytes (240 or 1,099,511,627,776 bytes). However, the
    ...
    configured for the guest (See [CPU model and topology](formatdomain.md#cpu-model-and-topology)) the memory element
    ...
    coredump or not (values "on", "off"). unit since 0.9.11,
    dumpCore since 0.10.2 (QEMU only)
...
## [Memory Backing](formatdomain.md#id14)
...
:   This tells the hypervisor that the guest should have its memory allocated
    using hugepages instead of the normal native page size. Since 1.2.5
...
:   When set and supported by the hypervisor, memory pages belonging to the
    ...
    [Memory Tuning](formatdomain.md#memory-tuning)) on memory allocation suitable for
...
:   Using the type attribute, it's possible to provide "file" to utilize file
    memorybacking or keep the default "anonymous". Since 4.10.0, you
...
:   Using the optional mode attribute, specify when to allocate the memory by
    supplying either "immediate" or "ondemand". Since 8.2.0 it is
...
:   When set and supported by hypervisor the memory content is discarded just
    ...
    when hypervisor crashes). Since 4.4.0 (QEMU/KVM only)

## [Memory Tuning](formatdomain.md#id15)
...
:   The optional memtune element provides details regarding the memory
    ...
    KiB. unit since 0.9.11 Possible values for all \*_limit
...
:   The optional hard_limit element is the maximum memory the guest can use.
    ...
    problem](https://en.wikipedia.org/wiki/Undecidable_problem); that said, if
    you already set locked in [Memory Backing](formatdomain.md#memory-backing)
...
## [NUMA Node Tuning](formatdomain.md#id16)
...
:   The optional numatune element provides details of how to tune the
    ...
    NB, only supported by QEMU driver. Since 0.9.3
...
:   The optional memory element specifies how to allocate memory for the
    ...
    to request movement of such memory for a running domain using virsh numatune or virDomainSetNumaParameters and is not guaranteed to happen.
    Attribute nodeset specifies the NUMA nodes, using the same
    syntax as attribute cpuset of element vcpu. Attribute placement (
    since 0.9.12 ) can be used to indicate the memory placement mode for
    ...
    'auto' and mode 'strict' will be added implicitly. Since 0.9.3
    See [virDomainSetNumaParameters](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainSetNumaParameters) for more
...
## [Block I/O Tuning](formatdomain.md#id17)
...
:   The domain may have multiple device elements that further tune the
    ...
    disks (See [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms)) can share a single host
    ...
    element of a disk definition (See [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms))
...
## [Host Device IOMMUFD](formatdomain.md#id18)
...
iommufd
:   Since 12.2.0 (QEMU/KVM only) The optional iommufd element with
    ...
    [virDomainFDAssociate](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainFDAssociate)
...
## [Resource partitioning](formatdomain.md#id19)
...
## [Fibre Channel VMID](formatdomain.md#id20)
...
## [CPU model and topology](formatdomain.md#id21)

Requirements for CPU model, its features and topology can be specified using the
following collection of elements. Since 0.7.5
...
cpu element can be used. Since 0.7.6
...
:   The cpu element is the main container for describing guest CPU
    ...
    provided to the guest matches these requirements. Since 0.7.6 the
    ...
    Since 0.8.5 the match attribute can be omitted and will default
    to exact. Sometimes the hypervisor is not able to create a virtual CPU
    exactly matching the specification passed by libvirt. Since 3.2.0,
    ...
    Since 0.9.10, an optional mode attribute may be used to make it
    ...
    :   The host-model mode is essentially a shortcut to copying host-model
        CPU definition from [domain capabilities XML](formatdomaincaps.md#cpu-configuration) into domain XML. Since the
        ...
        host-model may not work as expected. Since 3.2.0 and QEMU
        ...
        advertised in [domain capabilities XML](formatdomaincaps.md#cpu-configuration). When fallback attribute
        ...
        Since 1.2.11 PowerISA allows processors to run VMs in binary
    ...
    :   With this mode, the CPU visible to the guest should be exactly the same as
        ...
        host. Since 6.5.0 optional migratable attribute may be used
...
:   The content of the model element specifies CPU model requested by the
    ...
    features. Since 0.9.10, an optional fallback attribute can be
    ...
    The optional vendor_id attribute ( Since 0.10.0 ) can be used to
...
vendor
:   Since 0.8.3 the content of the vendor element specifies CPU
...
:   The topology element specifies requested topology of virtual CPU provided
    to the guest.
    Its attributes sockets, dies (Since 6.1.0), clusters
    (Since 10.1.0), cores, and threads accept non-zero positive
    integer values.
...
:   The cpu element can contain zero or more feature elements used to
    ...
    Since 0.8.5 the policy attribute can be omitted and will default
    to require.
...
deprecated_features
:   Since 11.0.0, S390 guests may utilize the deprecated_features
...
cache
:   Since 3.3.0 the cache element describes the virtual CPU cache.
...
maxphysaddr
:   Since 8.7.0 the maxphysaddr element describes the virtual CPU
    ...
    :   The limit attribute can be used to restrict the maximum value of
        ...
        more bits than that, limit is used. Since 9.3.0
...
the CPU or range of CPUs that are part of the node. Since 6.5.0 For the
...
kibibytes (i.e. blocks of 1024 bytes). Since 6.6.0 the cpus
attribute is optional and if omitted a CPU-less NUMA node is created.
Since 1.2.11 one can use an additional unit attribute
(See [Memory Allocation](formatdomain.md#memory-allocation)) to define units in which
memory is specified. Since 1.2.7 all cells should have id
attribute in case referring to some cell is necessary in the code, otherwise the
cells are assigned ids in the increasing order starting from 0. Mixing
cells with and without the id attribute is not recommended as it may result
in unwanted behaviour. Since 1.2.9 the optional attribute memAccess
...
for given numa node as described under [Memory Backing](formatdomain.md#memory-backing).
...
cells. Since 3.10.0 it is possible to define the distance between NUMA
...
### [ACPI Heterogeneous Memory Attribute Table](formatdomain.md#id22)
...
Since 6.6.0 the cell element can have a cache child element
...
## [Events configuration](formatdomain.md#id23)
...
[virDomainReboot](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainReboot) ,
[virDomainShutdown](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainShutdown) , or
[virDomainShutdownFlags](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainShutdownFlags)
...
:   The crashed domain will continue to run. This is useful if the guest OS can
    do an internal crash dump and reboot itself. Since 12.6.0

Since 3.9.0, the lifecycle events can be configured via the
[virDomainSetLifecycleAction](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainSetLifecycleAction)
API.

The on_lockfailure element ( since 1.0.0 ) may be used to configure
...
## [Power Management](formatdomain.md#id24)

Since 0.10.2 it is possible to forcibly enable or disable BIOS
...
## [Disk Throttle Group Management](formatdomain.md#id25)

Since 11.2.0 it is possible to create multiple named throttle groups
...
throttlegroup
:   It has the same sub-elements as iotune (See [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms)),
    The difference is that <group_name> is required.

## [Hypervisor features](formatdomain.md#id26)
...
[capabilities XML](formatcaps.md) and [domain capabilities
XML](formatdomaincaps.md), but a common set for fully virtualized domains
are:
...
:   APIC allows the use of programmable IRQ management.
    Since 0.10.2 (QEMU only) there is an optional
...
:   Enable various features improving behavior of guests running Microsoft
    Windows. Since 11.3.0 some of these flags are also available for
    ...
    Since 8.0.0 (QEMU) Since 11.3.0 (Xen), the hypervisor can be
    ...
    :   Similar to the passthrough mode, except libvirt detects which
        ...
        CPU mode (See [CPU model and topology](formatdomain.md#cpu-model-and-topology)). Since 11.9.0
        It is also possible to set features, like in custom mode. These are
        then left untouched and no expansion is done for them. Since
        12.1.0
...
:   Enable for architectures using a General Interrupt Controller instead of APIC
    ...
    values are 2, 3 and host. Since 1.2.16
...
:   Depending on the state attribute (values on, off, default on)
    ...
    **If the VM is booting you should leave this option alone, unless you are
    ...
    See [Memory Allocation](formatdomain.md#memory-allocation) for more details about
    the unit attribute. Since 4.5.0 (QEMU only)
...
:   Tune the I/O APIC. Possible values for the driver attribute are: kvm
    ...
    is also known as a split I/O APIC mode. Since 3.4.0 (QEMU/KVM only)
...
:   Configure the HPT (Hash Page Table) of a pSeries guest. Possible values for
    ...
    specified, the hypervisor default will be used. Since 4.5.0
    (QEMU/KVM only).

vmcoreinfo
:   Enable QEMU vmcoreinfo device to let the guest kernel save debug details.
    Since 4.4.0 (QEMU only)
...
:   Configure nested HV availability for pSeries guests. This needs to be enabled
    ...
    the hypervisor default will be used. Since 4.10.0 (QEMU/KVM only)
...
:   Configure cfpc (Cache Flush on Privilege Change) availability for pSeries
    ...
    will be used. Since 6.3.0 (QEMU/KVM only)
...
:   Configure aia (Advanced Interrupt Architecture) for RISC-V 'virt'
    ...
    will be used. Since 11.1.0 (QEMU/KVM and RISC-V guests only)

virtualization
:   Enable emulating a guest CPU which implements the Arm Virtualization Extensions.
    If the attribute is not defined, the hypervisor default will be used.
    Since 12.1.0 (QEMU/KVM and ARM virt guests only)

## [Time keeping](formatdomain.md#id27)
...
:   The offset attribute takes four possible values, allowing fine grained
    ...
    :   The guest clock will always be synchronized to UTC when booted.
        Since 0.9.11 'utc' mode can be converted to 'variable' mode,
    ...
    :   The guest clock will have an arbitrary offset applied relative to UTC or
        ...
        the RTC adjustments are lost at each reboot. Since 0.7.7
        Since 0.9.11 the basis attribute can be either 'utc'
...
:   Each timer element requires a name attribute, and has other optional
    ...
    :   The name attribute selects which timer is being modified, and can be
        ...
        since 3.2.0 ), "hypervclock" (qemu - since 1.2.2 ) or
        "armvtimer" (qemu - since 6.1.0 ). The hypervclock timer adds
...
## [Performance monitoring events](formatdomain.md#id28)
...
the virConnectGetAllDomainStats API. Since 2.0.0
...
:   The contents of the emulator element specify the fully qualified path to
    the device model emulator binary. The [capabilities XML](formatcaps.md)
...
following characters: [a-zA-Z0-9_-]. Since 3.9.0
...
### [Hard drives, floppy disks, CDROMs](formatdomain.md#id30)
...
:   The disk element is the main container for describing disks and supports
    ...
    type
    :   Valid values are "file", "block", "dir" ( since 0.7.5 ),
        "network" ( since 0.8.7 ), or "volume" ( since 1.0.5 ),
        or "nvme" ( since 6.0.0 ), or "vhostuser" ( since 7.1.0 ),
        or "vhostvdpa" ( since 9.8.0 (QEMU 8.1.0)), or "ctl" (
    ...
    :   Indicates how the disk is to be exposed to the guest OS. Possible values
        ...
        Using "lun" ( since 0.9.10 ) is only valid when the type is
        "block" or "network" for protocol='iscsi' or when the type is
        "volume" when using an iSCSI source pool for mode "host" or as an
        [NPIV](https://wiki.libvirt.org/page/NPIV_in_libvirt) virtual Host Bus
        ...
        identical to device='disk'). Since 0.1.4
    ...
    :   Indicates the emulated device model of the disk. Typically this is
        ...
        models](formatdomain.md#virtio-device-models) for more details. Since 5.2.0
        ...
        Since 11.5.0; relevant only for QEMU hypervisor.
    ...
    :   Indicates whether the disk needs rawio capability. Valid settings are
        ...
        (per-process basis, affects all the domain disks). Since 0.9.10
    ...
    :   If supported by the hypervisor and OS, indicates whether unprivileged
        ...
        device is 'lun'. The attribute exists Since 1.0.2, although
    ...
    :   Indicates the default behavior of the disk during disk snapshots:
        ...
        snapshot creation](formatsnapshot.md). Not all snapshot modes are
        supported; for example, enabling snapshots with a transient disk
        generally does not make sense. Since 0.9.5
...
:   Representation of the disk source depends on the disk type attribute
    ...
    :   The file attribute specifies the fully-qualified path to the file
        holding the disk. Since 0.0.3

        Since 9.0.0 a new optional attribute fdgroup can be added
    ...
    :   The dev attribute specifies the fully-qualified path to the host
        device to serve as the disk. Since 0.0.3

    dir
    :   The dir attribute specifies the fully-qualified path to the directory
        to use as the disk. Since 0.7.5
    ...
    :   The protocol attribute specifies the protocol to access to the
        ...
        /etc/libvirt/qemu.conf. ('tls' Since 4.5.0 ) Since 8.2.0
        ...
        pool_name/namespace/image_name ( Since 11.6.0 and QEMU 5.0 ).
        The pool name, namespace and image are separated by slash.

        For protocols http and https an optional attribute query
        specifies the query string. ( Since 6.2.0 )

        For "iscsi" ( since 1.0.4 ), the name attribute may include a
        ...
        For "vxhs" ( since 3.8.0 ), the name is the UUID of the
    ...
    :   The underlying disk source is represented by attributes pool and
        ...
        pool](formatstorage.md) (managed by libvirt) where the disk source
        ...
        Use the attribute mode ( since 1.1.1 ) to indicate how to
        ...
        pool's](formatstorage.md) source element host attribute as
    ...
    :   Enables the hypervisor to connect to another process using vhost-user
        ...
        see access mode for memoryBacking element (See [Memory Backing](formatdomain.md#memory-backing)).
    ...
    :   Enables the hypervisor to connect to a vDPA block device. Requires shared
        ...
        memoryBacking element (See [Memory Backing](formatdomain.md#memory-backing)).
    ...
    seclabel (See [Security label](formatdomain.md#security-label)) can be used to override the domain
    ...
    :   The file attribute for the config element provides a fully
        ...
        since 1.2.11 (QEMU only).

    auth
    :   Since 3.9.0, the auth element is supported for a
        ...
        a [libvirt secret object](formatsecret.md) that holds the actual
    ...
    encryption
    :   Since 3.9.0, the encryption can be a sub-element of
        the source element for encrypted storage sources. If present,
        specifies how the storage source is encrypted See the [Storage
        Encryption](formatstorageencryption.md) page for more information.
        Note that the 'qcow' format of encryption is broken and thus is no longer
        supported for use with disk images. ( Since 4.5.0 )

    reservations
    :   Since 4.4.0, the reservations can be a sub-element
        ...
        Since 12.1.0 the migration (values yes, no) controls
        whether the hypervisor should attempt to migrate persistent reservations
        during migration.

    initiator
    :   Since 4.7.0, the initiator element is supported for
    ...
    :   For disk of type nvme this element specifies the PCI address of the
        host NVMe controller. Since 6.0.0
    ...
    :   The slices element using its slice sub-elements allows configuring
        ...
        size values are in bytes. Since 6.1.0
    ...
    :   The timeout element has a seconds attribute which specifies the
        ...
        '0' is considered as if the value is not provided. Since 6.2.0
    ...
    :   This element describes external data store, which is storage holding the
        ...
        by the qcow2 format. Since 10.10.0
    ...
    type). This is done by the startupPolicy attribute ( since 0.9.7
    ...
    Since 1.1.2 the startupPolicy is extended to support hard disks
...
:   This element describes the backing store used by the disk specified by
    sibling source element. Since 1.2.4. If the hypervisor driver
    does not support the
    [backingStoreInput](formatdomaincaps.md#backingstoreinput) (
    Since 5.10.0 ) domain feature the backingStore is ignored on
...
:   This element is present if the hypervisor has started a long-running block
    ...
    for the virDomainBlockCommit API), since 1.2.7. The attribute
    ready, if present, tracks progress of the job: yes if the disk is
    known to be ready to pivot, or, since 1.2.7, abort or pivot
    ...
    jobs since 1.2.6. Older libvirt supported only block copy to a
    file, since 0.9.12; for compatibility with older clients, such jobs
...
:   The target element controls the bus / device under which the disk is
    ...
    "sd" since 1.1.2, "nvme" since 11.5.0. If
    ...
    attribute since 0.9.11; "usb" attribute value
    since after 0.4.4; "sata" attribute value since 0.9.7;
    "removable" attribute value since 1.1.3;
    "rotation_rate" attribute value since 7.3.0
    The optional attribute dpofua (Since 11.10.0, only QEMU driver)
...
:   The optional throttlefilters element provides the ability to provide additional
    per-device throttle chain Since 11.2.0
...
:   The optional iotune element provides the ability to provide additional
    ...
    this to the blkiotune element (See [Block I/O Tuning](formatdomain.md#block-i-o-tuning)), which applies
...
:   The optional driver element allows specifying further details related to the
    hypervisor driver used to provide the disk. Since 0.1.8
    ...
    - The optional cache attribute controls the cache mechanism, possible
      ...
      (since 0.9.5; like "writethrough", but it bypasses the host page
      cache) and "unsafe" (since 0.9.7; host may cache all disk io,
    ...
    - The optional error_policy attribute controls how the hypervisor will
      ...
      guest OS; since 0.9.7), ignore (ignore the error and try to
    ...
    - The optional io attribute controls specific policies on I/O; qemu
      guests support "threads" and "native" Since 0.8.8, io_uring
      Since 6.3.0 (QEMU 5.0).
    - The optional ioeventfd attribute allows users to set [domain I/O
      asynchronous handling](https://patchwork.kernel.org/patch/43390/) for
      ...
      Since 0.9.3 (QEMU and KVM only) **In general you should leave
    ...
    - The optional copy_on_read attribute controls whether to copy read
      ...
      copy-on-read is off. Since 0.9.10 (QEMU and KVM only)
    ...
    - The optional iothread attribute assigns the disk to an IOThread as
      ...
      [IOThreads Allocation](formatdomain.md#iothreads-allocation)). Multiple disks may be
    ...
    - The optional statistics sub-element allows configuring various optional
      ...
      [VIR_DOMAIN_STATS_BLOCK_SUFFIX_TIMED_GROUP_PREFIX](https://libvirt.org/html/libvirt-libvirt-domain.html#VIR_DOMAIN_STATS_BLOCK_SUFFIX_TIMED_GROUP_PREFIX)
      typed parameter prefix returned by the
      [virConnectGetAllDomainStats](https://libvirt.org/html/libvirt-libvirt-domain.html#virConnectGetAllDomainStats)
      ...
      the [virDomainUpdateDeviceFlags](https://libvirt.org/html/libvirt-libvirt-domain.html#virDomainUpdateDeviceFlags)
    ...
    - The optional queues attribute specifies the number of virt queues for
      virtio-blk ( Since 3.9.0 ) or vhost-user-blk
      ( Since 7.1.0 )
    - The optional queue_size attribute specifies the size of each virt
      queue for virtio-blk or vhost-user-blk. ( Since 7.8.0 )
    - For virtio disks, [Virtio-related options](formatdomain.md#virtio-related-options) can also
      be set. ( Since 3.5.0 )
    - The optional metadata_cache subelement controls aspects related to the
      ...
      Since 7.0.0 the maximum size of the metadata cache of qcow2
      ...
      to the qemu
      [qcow2 cache docs](https://git.qemu.org/?p=qemu.git;a=blob;f=docs/qcow2-cache.txt)
...
:   The optional backenddomain element allows specifying a backend domain
    ...
    the backend domain name. Since 1.2.13 (Xen only)
...
:   Specifies that the disk is bootable. The order attribute determines the
    ...
    entry. Since 3.5.0 The per-device boot elements cannot be used
    together with general boot elements in [guest firmware](formatdomain.md#guest-firmware)
    section. Since 0.8.8
...
:   If present, this indicates that changes to the device contents should be
    ...
    (Since 0.9.5) and qemu hypervisor (Since 6.9.0).
    ...
    configurations supporting hotplug. Since 7.4.0
...
:   If present, this element specifies the product of a virtual hard disk or
    ...
    (Since 1.0.1). For 'sata' or 'ide' not longer than 40 printable
    characters (Since 11.1.0). Other bus is not supported.
...
:   If present, the address element ties the disk to a given slot of a
    ...
    libvirt, although it can be be explicitly specified. See [Controllers](formatdomain.md#controllers)).
    ...
    multifunction (since 0.9.7). Multifunction defaults to 'off'.
    For a "drive" controller, additional attributes controller, bus,
    target (since 0.9.11), and unit are available, each
    defaulting to 0.

auth
:   Since 3.9.0, the auth element is preferred to be
...
:   If present, the blockio element allows to override any of the block
    device properties listed below. Since 0.10.2 (QEMU and KVM)
...
### [Filesystems](formatdomain.md#id31)
...
:   The filesystem attribute type specifies the type of the source. The
    ...
    :   A host directory to mount in the guest. Used by LXC, OpenVZ
        ...
        pages touched during a guest file write operation (since 0.9.10)
        . Since 6.2.0, type='virtiofs' is also supported. Using
        virtiofs requires setting up shared memory, see the guide:
        [Virtiofs](kbase/virtiofs.md)
    ...
    :   The source is accessed with the permissions of the user inside the
        ...
        info](https://lists.gnu.org/archive/html/qemu-devel/2010-05/msg02673.html)
    ...
    :   Similar to 'passthrough', the exception is that failure of privileged
        ...
        info](https://lists.gnu.org/archive/html/qemu-devel/2010-09/msg00121.html)

    Since 5.2.0, the filesystem element has an optional attribute
    model with supported values "virtio", "virtio-transitional" or
    "virtio-non-transitional". See [virtio device models](formatdomain.md#virtio-device-models) for more details.
    ...
    (since 6.10.0, requires QEMU 2.10 ).
    ...
    since 6.3.0, requires QEMU 4.2 ). This attribute is not available
...
driver
:   The optional driver element allows specifying further details related to the
    hypervisor driver used to provide the filesystem. Since 1.0.6
    ...
    - For virtio-backed devices, [Virtio-related options](formatdomain.md#virtio-related-options)
      can also be set. ( Since 3.5.0 )
    - For virtiofs, the queue attribute can be used to specify the queue
      size (i.e. how many requests can the queue fit). ( Since 6.2.0 )
...
:   The optional binary element can tune the options for virtiofsd. All of
    ...
    flock both accepting values on or off. ( Since 6.2.0 )
    ...
    chroot, see the
    [virtiofsd documentation](https://qemu.readthedocs.io/en/latest/tools/virtiofsd.html)
    for more details. ( Since 7.2.0 )
    ...
    fast, low latency filesystems, it may be best to turn it off. ( Since 8.5.0 )
...
:   For virtiofs, an idmap element can be specified to map IDs in the user
    namespace. See the [Container boot](formatdomain.md#container-boot) section for the syntax of the element.
    Since 10.0.0

readonly
:   Enables exporting filesystem as a readonly mount for guest, by default
    read-write access is given (works for QEMU/KVM driver, Since 11.0.0,
...
:   Maximum space available to this guest's filesystem. The container is
    ...
    the hard limit is enforced. Since 0.9.13
    Only supported by the OpenVZ driver.

### [Device Addresses](formatdomain.md#id32)
...
:   PCI addresses have the following additional attributes: domain (a 2-byte
    ...
    Since 1.3.5, some hypervisor drivers may accept an
    ...
    describes [how PCI addresses work](pci-addresses.md) in more detail.
...
:   This places the device on the virtio-mmio transport, which is currently only
    ...
    addresses do not have any additional attributes. Since 1.1.3
...
:   For PCI hostdevs, <address type='unassigned'/> allows the admin to
    ...
    address type for all other device types. Since 6.0.0

### [Virtio-related options](formatdomain.md#id33)
...
(see [IOMMU devices](formatdomain.md#iommu-devices)). Possible values are on or off.
Since 3.5.0
...
granularity. The default is determined by QEMU. Since 7.9.0 (QEMU 2.8)
Note: In general you should leave this option alone, unless you are very certain
you know what you are doing.

### [Virtio device models](formatdomain.md#id34)
...
Since 5.2.0, the following values can additionally be used with machine
...
posting](https://lists.gnu.org/archive/html/qemu-devel/2018-12/msg00923.html)
and the [virtio-1.0
spec](https://docs.oasis-open.org/virtio/virtio/v1.0/virtio-v1.0.html).

### [Controllers](formatdomain.md#id35)
...
notably when planning the [PCI topology](pci-hotplug.md) for guests where
...
<address> elements). Since 1.3.5 the index is optional; if not
...
:   The virtio-serial controller has two additional optional attributes
    ...
    through the controller. Since 5.2.0, it supports an optional
...
:   A scsi controller has an optional attribute model, which is one of
    ...
    See [virtio device models](formatdomain.md#virtio-device-models) for more details.
...
:   A usb controller has an optional attribute model, which is one of
    ...
    version 2.0) or "qemu-xhci". Additionally, since 0.10.0, if the USB
    bus needs to be explicitly disabled for the guest, model='none' may be
    used. Since 1.0.5, no default USB controller will be built on s390.
    Since 1.3.5, USB controllers accept a ports attribute to
    configure how many devices can be connected to the controller.

ide
:   Since 3.10.0 for the vbox driver, the ide controller has an
    optional attribute model, which is one of "piix3", "piix4" or "ich6".

xenbus
:   Since 5.2.0, the xenbus controller has an optional attribute
    maxGrantFrames, which specifies the maximum number of grant frames the
    controller makes available for connected devices. Since 6.3.0, the
...
nvme
:   Supported Since 11.5.0, the nvme controller can be used to
...
to its master bus, with semantics described in the [Device Addresses](formatdomain.md#device-addresses) section.
...
:   The optional queues attribute specifies the number of queues for the
    ...
    matching the number of vCPUs. Since 1.0.5 (QEMU and KVM only)
...
:   The optional ioeventfd attribute specifies whether the controller should
    use [I/O asynchronous handling](https://patchwork.kernel.org/patch/43390/)
    or not. Accepted values are "on" and "off". Since 1.2.18

iothread
:   Supported for controller type scsi using model virtio-scsi for
    address types pci and ccw since 1.3.5 (QEMU 2.4). The
    optional iothread attribute assigns the controller to an IOThread as
    defined by the range for the domain iothreads (See [IOThreads Allocation](formatdomain.md#iothreads-allocation)).
    Each SCSI disk
...
:   Supported for virtio-scsi controllers using address types pci and
    ccw. since 11.2.0 (QEMU 10.0). Mutually exclusive with iothread.
...
virtio options
:   For virtio controllers, [Virtio-related options](formatdomain.md#virtio-related-options) can
    also be set. ( Since 3.5.0 )
...
automatically generated by libvirt. Since 1.2.19 (QEMU only).
...
hotplug
:   pci-root (Since 7.9.0), pcie-root-port (Since 6.3.0) and
    pcie-switch-downstream-port controllers (Since 6.3.0) can
...
:   Some PCI controllers (pci-expander-bus for the pc machine type,
    pcie-expander-bus for the q35 machine type and, since 3.6.0,
...
:   pci-root controllers for pSeries guests use this attribute to record the
    order they will show up in the guest. Since 3.6.0
...
:   Some PCI devices have non-prefetchable memory bar larger than 2MiB. Use this
    ...
    correct amount of memory. Since 10.3.0
...
provides 31 usable PCI slots (1-31) with hotplug support ( since 4.3.0
...
libvirt will be placed on this pci-bridge device. ( since 1.1.2 ).
...
### [Device leases](formatdomain.md#id36)
...
### [Host device assignment](formatdomain.md#id37)

#### [USB / PCI / SCSI devices](formatdomain.md#id38)

USB (since 0.4.4), PCI (since 0.6.0, KVM only) and
SCSI (since 1.0.6, KVM only) devices attached to the host can be
...
:   The hostdev element is the main container for describing host devices.
    ...
    :   For PCI devices, when managed is "yes" it is detached from the host
        ...
        Since 10.3.0 an optional display attribute may be used to
    ...
    :   For SCSI devices, user is responsible to make sure the device is not used
        ...
        since 1.0.6, but currently no longer supported by any hypervisor
        ...
        The optional rawio (since 1.2.9 ) attribute indicates whether
        the lun needs the rawio capability. Valid settings are "yes" or "no".
        See the rawio description within the [Hard drives, floppy disks, CDROMs](formatdomain.md#hard-drives-floppy-disks-cdroms)
        section. If a disk lun in the domain already has the rawio capability,
        then this setting not required.

    scsi_host
    :   since 2.5.0 For SCSI devices, user is responsible to make sure
        the device is not used by host. This type passes all LUNs presented by
        a single HBA to the guest. Since 5.2.0, the model attribute
        can be specified further with "virtio", "virtio-transitional" or
        "virtio-non-transitional". See [virtio device models](formatdomain.md#virtio-device-models) for more details.

    mdev
    :   For mediated devices ( Since 3.2.0 ) the model attribute
        ...
        model='vfio-ccw' ( Since 4.4.0 ) and model='vfio-ap' (
        Since 4.9.0 ) is supported.
        [MDEV](drvnodedev.md#mediated-devices-mdevs)
        section provides more information about mediated devices as well as how to
        create mediated devices on the host. Since 4.6.0 (QEMU 2.12) an
        ...
        NVIDIA vGPU or Intel GVT-g) as an alternative to emulated [Video devices](formatdomain.md#video-devices).
        ...
        graphical framebuffer (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers)) in order to use this
        attribute, currently only supported with VNC, Spice and egl-headless graphics
        devices. Since version 5.10.0, there is an optional ramfb
...
:   The source element describes the device as seen from the host using the
    ...
    :   The USB device can either be addressed by vendor / product id using the
        ...
        Since 1.0.0, the source element of USB devices may contain
        ...
        Since 8.6.0, the source element can contain guestReset
    ...
    :   PCI devices can only be described by their address.
        Since 6.8.0 (Xen only), the source element of a PCI device
    ...
    mdev
    :   Mediated devices ( Since 3.2.0 ) are described by the address
...
:   Specifies that the device is bootable. The order attribute determines the
    ...
    [guest firmware](formatdomain.md#guest-firmware) section. Since 0.8.8 for PCI
    devices, Since 1.0.1 for USB devices.
...
:   The rom element is used to change how a PCI device's ROM is presented to
    ...
    will be rejected. Since 4.3.0 (QEMU and KVM only).
...
:   The address element for USB devices has a bus attribute to specify
    ...
    will result in an error. See the [Device Addresses](formatdomain.md#device-addresses) section for more details
...
:   PCI hostdev devices can have an optional driver subelement that
    ...
    Since 10.0.0 (useful for QEMU and KVM only).
    ...
    Since 12.1.0 (QEMU and KVM only), the iommufd element
    ...
    (Note: Since 1.0.5, the name attribute has been
    ...
    occasionally see <driver name='vfio'/> or <driver name='xen'/> in a domain's status XML, or more rarely in config,
...
:   Indicates that the device is readonly, only supported by SCSI host device
    now. Since 1.0.6 (QEMU and KVM only)

shareable
:   If present, this indicates the device is expected to be shared between
    domains (assuming the hypervisor and OS support this). Only supported by SCSI
    host device. Since 1.0.6, but only works as expected
    since 1.2.2.

#### [ACPI Generic Initiators](formatdomain.md#id39)
...
#### [Block / character devices](formatdomain.md#id40)
...
### [Redirected devices](formatdomain.md#id41)

USB device redirection through a character device is supported
since after 0.9.5 (KVM only):
...
:   The redirdev element is the main container for describing redirected
    ...
    (See [Consoles, serial, parallel & channel devices](formatdomain.md#consoles-serial-parallel-channel-devices)), to describe the host
    side of the tunnel; type='tcp' or type='spicevmc' (which uses the
    usbredir channel of a SPICE graphics device (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers)))
    are typical.
...
:   Specifies that the device is bootable. The order attribute determines the
    order in which devices will be tried during boot sequence. The per-device
    boot elements cannot be used together with general boot elements in
    [guest firmware](formatdomain.md#guest-firmware) section. ( Since 1.0.1 )

redirfilter
:   Theredirfilterelement is used for creating the filter rule to filter
...
### [Smartcard devices](formatdomain.md#id42)
...
:   Rather than having the hypervisor directly communicate with the host, it is
    ...
    type is required, matching one of the supported serial device types
    (See [Consoles, serial, parallel & channel devices](formatdomain.md#consoles-serial-parallel-channel-devices)),
    to describe the host side of the tunnel;
    type='tcp' or type='spicevmc' (which uses the smartcard channel of a
    SPICE graphics device (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers))) are typical. Further
...
Each mode supports an optional sub-element <address> (See [Device Addresses](formatdomain.md#device-addresses)),
...
### [Network interfaces](formatdomain.md#id43)
...
Since 1.2.10 ), the interface element property
...
documented in the [Device Addresses](formatdomain.md#device-addresses) section.

Since 6.6.0, one can force libvirt to keep the provided MAC address
...
Since 11.2.0, the <mac/> element can optionally contain
...
Since 7.3.0, one can set the ACPI index against network interfaces.
...
#### [Virtual network](formatdomain.md#id44)
...
with the <target> element (see [Overriding the target element](formatdomain.md#overriding-the-target-element)).
...
information for different classes of network connections. Since 0.9.4.
...
automatically during startup and shutdown. Since 5.1.0
...
Since 0.8.2 ), or to an Open vSwitch virtual switch
( Since 0.9.11 ).
...
Since 0.10.0 ). For example, in order to work properly with both an
...
#### [Bridge to LAN](formatdomain.md#id45)
...
[Overriding the target element](formatdomain.md#overriding-the-target-element)). The tun device will be
...
interface definition. ( Since 0.9.11 ). The Open vSwitch type
...
Since 1.2.13 ). The Midonet virtualport type requires an
...
#### [Userspace connection using SLIRP](formatdomain.md#id46)
...
Since 3.8.0 it is possible to override the guest's default
...
#### [Userspace connection using passt](formatdomain.md#id47)

Since 9.0.0 (QEMU and KVM only) an alternate backend
implementation of the user interface type can be selected by
setting the interface's <backend> subelement type attribute to
passt. In this case, the passt transport [(details here)](https://passt.top) is used. passt is run as a separate process
...
Since 11.1.0 (QEMU and KVM only) you may prefer to use the
...
described [here](formatdomain.md#vhost-user-connection-with-passt-backend).
...
where to write its message log (since 9.0.0)[\*], while the
hostname attribute is used to set the hostname sent to the guest
in a DHCPv4 response (using option 12) (since 11.8.0), and
fqdn sets the "fully qualified domain name" sent to the guest in
DHCPv4 response option 81 and DHCPv6 response option 39 (since
...
#### [Generic ethernet connection](formatdomain.md#id48)
...
setup at all. Since 5.7.0 Using managed='no' with a pre-created tap
...
Since 6.4.0 These can be used to do whatever extra host network
...
#### [Direct attachment to physical interface](formatdomain.md#id49)

Provides direct attachment of the virtual machine's NIC to the given physical
interface of the host. Since 0.7.7 (QEMU and KVM only)
...
Aggregator'](https://www.ieee802.org/1/files/public/docs2009/new-evb-congdon-vepa-modular-0709-v01.pdf)),
...
Since 1.2.10 ). If trustGuestRxFilters is not set, or is not
...
:   This feature attaches a virtual function of a SRIOV capable NIC directly to a
    ...
    requires kernel 2.6.38 or newer. Since 0.9.2
...
interface of a virtual machine. Since 0.8.2
...
should be provided by the network administrator. Since 0.8.2
...
#### [PCI Passthrough](formatdomain.md#id50)
...
Since 1.1.3 (prior to that the default was always "kvm").
...
#### [vDPA devices](formatdomain.md#id51)
...
#### [Teaming a virtio/hostdev NIC pair](formatdomain.md#id52)

Since 6.1.0 (QEMU and KVM only), the <teaming> element of two
...
Since 7.1.0 The <teaming> element can also be added to a
...
VF. Using plain <hostdev> rather than <interface type='hostdev'> or <interface type='network'> is useful if the
...
#### [Multicast tunnel](formatdomain.md#id53)
...
#### [TCP tunnel](formatdomain.md#id54)
...
#### [UDP unicast tunnel](formatdomain.md#id55)
...
#### [Null network interface](formatdomain.md#id56)
...
#### [VMWare Distributed Switch](formatdomain.md#id57)
...
valid in the hypervisor. Since 8.7.0
...
#### [Setting the NIC model](formatdomain.md#id58)
...
virtio, virtio-transitional (Since 5.2.0),
virtio-non-transitional (Since 5.2.0), e1000, e1000e,
igb (Since 9.3.0), rtl8139, netfront,
usb-net (Since 10.3.0), spapr-vlan, lan9118, scm91c111,
...
#### [Setting NIC driver-specific options](formatdomain.md#id59)
...
:   This optional attribute allows users to set [domain I/O asynchronous
    handling](https://patchwork.kernel.org/patch/43390/) for interface device.
    ...
    could increase guest I/O latency. Since 0.9.3 (QEMU and KVM only)
    **In general you should leave this option alone, unless you are very certain
    you know what you are doing.**
...
:   The event_idx attribute controls some aspects of device event processing.
    ...
    force the feature off. Since 0.9.5 (QEMU and KVM only)
    **In general you should leave this option alone, unless you are very certain
    you know what you are doing.**
...
:   The optional queues attribute controls the number of queues to be used
    ...
    virtio-net](https://www.linux-kvm.org/page/Multiqueue) or vhost-user (See
    [vhost-user connection](formatdomain.md#vhost-user-connection)) network interfaces. Use of multiple packet
...
:   The optional tx_queue_size attribute controls the size of virtio ring for
    ...
    only for vhostuser type. Since 3.7.0 (QEMU and KVM only)
    **In general you should leave this option alone, unless you are very certain
    you know what you are doing.**
...
:   The rss option enables in-qemu/ebpf RSS for virtio NIC. RSS works with
    ...
    not supported by default in libvirt. Since 8.3.0 and QEMU 5.1
    **In general you should leave this option alone, unless you are very certain
...
:   The rss_hash_report option enables in-qemu RSS hash report for virtio
    ...
    Since 8.3.0 and QEMU 5.1
    **In general you should leave this option alone, unless you are very certain
    you know what you are doing. Proper RSS configuration depends from vcpu,
    tap, and vhost settings.**

virtio options
:   For virtio interfaces, [Virtio-related options](formatdomain.md#virtio-related-options) can also
    be set. ( Since 3.5.0 )
...
:   The csum, gso, tso4, tso6, ecn and ufo attributes
    ...
    Since 1.2.9 (QEMU only) The mrg_rxbuf attribute can be used to
    control mergeable rx buffers on the host side. Possible values are on
    (default) and off. Since 1.2.13 (QEMU only)
...
#### [Setting network backend-specific options](formatdomain.md#id60)
...
bridge interfaces. This does not work in session mode. Since 1.2.9

For tap devices there is also sndbuf element which can adjust the size of
send buffer in the host. Since 0.8.8

#### [Overriding the target element](formatdomain.md#id61)
...
side. Since 1.2.7, to define the name of the device on the guest side,
...
#### [Specifying boot order](formatdomain.md#id62)
...
#### [Interface ROM BIOS configuration](formatdomain.md#id63)
...
device. Since 0.9.10 (QEMU and KVM only).

#### [Setting up a network backend in a driver domain](formatdomain.md#id64)
...
the backend domain. Since 1.2.13 (Xen only)

#### [Quality of service](formatdomain.md#id65)
...
child elements are described in the [QoS](formatnetwork.md#quality-of-service)
section of the Network XML.

#### [Setting VLAN tag (on supported network types only)](formatdomain.md#id66)
...
VLAN tags to apply to the guest's network traffic Since 0.10.0.
...
since 1.3.5, SRIOV VFs used via type='direct' with
mode='passthrough' (macvtap "passthru" mode) and, since 11.0.0
...
Since 1.1.0. This is done with the optional nativeMode attribute on
...
#### [Isolating guests' network traffic from each other](formatdomain.md#id67)
...
Since 6.1.0. The port element property isolated, when set to
...
#### [Modifying virtual link state](formatdomain.md#id68)
...
link state up. Since 0.9.5

#### [MTU configuration](formatdomain.md#id69)
...
integer which specifies the MTU size for the interface. Since 3.1.0

#### [Coalesce settings](formatdomain.md#id70)
...
packets that will be received before an interrupt. Since 3.3.0

#### [IP configuration](formatdomain.md#id71)
...
Since 1.2.12 network devices and hostdev devices with network
...
Since 1.2.12 route elements can also be added to define IP
...
definitions](formatnetwork.md#static-routes). This is used by the
...
Since 2.1.0 network devices of type "ethernet" can optionally be
...
#### [vhost-user connection](formatdomain.md#id72)

Since 1.2.7 the vhost-user enables the communication between a QEMU
...
supported. (Since 11.1.0 the default source type for
...
the <model> element type attribute is mandatory (Since
11.1.0 the default model type for vhostuser interfaces is now
'virtio' so <model> is no longer mandatory). Since 4.1.0
...
#### [vhost-user connection with passt backend](formatdomain.md#id73)

Since 11.1.0 (QEMU and KVM only) passt can be used as the
...
interface to use passt as the backend by adding <backend type='passt'/>. When passt is the backend, only a single driver
queue is supported, and the <source> path/type/mode are all
implied to be "matching the passt process" so **must not** be
specified. All of the passt options [described here](formatdomain.md#userspace-connection-using-passt), are also
...
#### [Traffic filtering with NWFilter](formatdomain.md#id74)

Since 0.8.0 (QEMU), 0.9.3 (LXC), 10.1.0 (Cloud Hypervisor) an
...
[nwfilter](formatnwfilter.md) documentation for more complete details.
...
[nwfilter](formatnwfilter.md#usage-of-variables-in-filters) docs for info
on parameters.

### [Input devices](formatdomain.md#id75)
...
:   The input element has one mandatory attribute, the type whose value
    can be 'mouse', 'tablet', ( since 1.2.2 ) 'keyboard', (
    since 1.3.0 ) 'passthrough' or ( since 7.4.0 ) 'evdev'.
...
the device to a particular PCI slot, documented in the [Device Addresses](formatdomain.md#device-addresses) section.
On S390, address can be used to provide a CCW address for an input device (
since 4.2.0 ). For types passthrough and evdev, the mandatory
...
grabToggle (since 7.6.0) with values ctrl-ctrl, alt-alt,
...
(KVM only) Since 5.2.0, the input element accepts a
...
[Virtio-related options](formatdomain.md#virtio-related-options) can also be set. ( Since 3.5.0 )

### [Hub devices](formatdomain.md#id76)
...
(See [Device Addresses](formatdomain.md#device-addresses)) type='usb' which can tie the device to a
particular controller.

### [Graphical framebuffers](formatdomain.md#id77)
...
:   The graphics element has a mandatory type attribute which takes the
    ...
    :   Starts a VNC server. The port attribute specifies the TCP port number
        ...
        changes. VNC accepts keep value only since 0.9.3. NB, this
        ...
        listening on a unix domain socket path Since 0.8.8.
        ...
        privileges in the guest Since 7.1.0.
        ...
        Where 1 is an id of the audio device (See [Audio backends](formatdomain.md#audio-backends)). If no
    ...
    :   Starts a SPICE server. The port attribute specifies the TCP port
        ...
        . NB, this may not be supported by all hypervisors. Since 0.9.3
        ...
        if no secure path is available). Since 0.9.12
        ...
        since 0.8.6 ); smartcard ( since 0.8.8 ); and
        usbredir ( since 0.9.12 ).
        ...
        stream compression (accepts on or off). Since 0.9.1
        ...
        default will be used (client mode). Since 0.9.11
        ...
        setting the enable property to no. Since 1.2.2
        ...
        setting the enable property. (QEMU only, since 1.3.3 ). Note
    ...
    :   Starts a RDP server. The port attribute specifies the TCP port number
        ...
        access may be disabled by the helper). Since 11.1.0
    ...
    :   This display type provides support for an OpenGL accelerated display
        ...
        newer). Since 5.0.0 this element accepts a <gl/> sub-element
    ...
    :   Export the display over D-Bus. By default, it will use a private bus,
        ...
        address (accepts a [D-Bus address](https://dbus.freedesktop.org/doc/dbus-specification.html#addresses)),
        ...
        Where 1 is an id of the audio device (See [Audio backends](formatdomain.md#audio-backends)).
...
Since 0.9.4. Available types are:
...
### [Video devices](formatdomain.md#id78)
...
:   The video element is the container for describing video devices. For
    ...
    optional attribute primary ( since 1.0.2 ) with value 'yes' can
    be used to mark the primary in cases of multiple video device. The
    non-primary must be type of "qxl" or ( since 2.4.0 ) "virtio".

model
:   The model element has a mandatory type attribute which takes the
    value "vga", "cirrus", "vmvga", "xen", "vbox", "qxl" ( since 0.8.6
    ), "virtio" ( since 1.3.0 ), "gop" ( since 3.2.0 ), "bochs"
    ( since 5.6.0 ), "ramfb" ( since 5.9.0 ), or "none" (
    since 4.6.0 ), depending on the hypervisor features available.
    ...
    the default behaviour. Refer to [Host device assignment](formatdomain.md#host-device-assignment) to see how to add
    ...
    optional attributes.
    Attribute ram ( since 1.0.2 ) specifies the size of
    ...
    optional attribute vgamem ( since 1.2.11 ) to set the size of
    VGA framebuffer for fallback mode of QXL device. Attribute vram64 (
    since 1.3.3 ) extends secondary bar and makes it addressable as
    64bit memory.

    Since 9.2.0 (QEMU driver only), devices with type "virtio" have an
    ...
    Since 5.9.0, the model element may also have an optional
    ...
    Since 11.7.0 (QEMU driver only), the model element may have an
    ...
    Since 12.5.0 the virtio video model has an additional attribute
...
:   Configure if video acceleration should be enabled.
    ...
    :   Absolute path to a host's DRI device to be used for rendering (for
        'vhostuser' driver only, since 5.8.0 ). If none is specified,
...
:   The optional address sub-element can be used to tie the video device to a
    ...
    address for the video device ( since 4.2.0 ).
...
:   The subelement driver can be used to tune the device:
    ...
    :   Specify the backend driver to use, either "qemu" or "vhostuser" depending
        on the hypervisor features available ( since 5.8.0 ). "qemu" is
    ...
    :   Control how the video devices exposed to the guest using the vgaconf
        ...
        applicable to the bhyve's "gop" video model type ( Since 3.5.0 )

### [Consoles, serial, parallel & channel devices](formatdomain.md#id79)
...
[Security label](formatdomain.md#security-label) is inherited from the per-domain setting.
...
values are "on" and "off" (default). Since 1.3.1.
...
same values described above. Since 1.3.3.
...
can tie the device to a particular controller (See [Controllers](formatdomain.md#controllers)) or PCI slot.
...
##### [Serial port](formatdomain.md#id82)
...
values are, since 1.0.2, isa-serial (usable with x86 guests),
usb-serial (usable whenever USB support is available) and pci-serial
(usable whenever PCI support is available); since 3.10.0,
spapr-vio-serial (usable with ppc64/pseries guests), system-serial
(usable with aarch64/virt and, since 4.7.0, riscv/virt guests),
sclp-serial (usable with s390 and s390x guests) are available as well
and since 8.1.0 isa-debug (usable with x86 guests).

Since 3.10.0, the target element can have an optional model
...
pl011 and, since 4.7.0, 16550a (usable with the
system-serial target type); sclpconsole and sclplmconsole (usable
with the sclp-serial target type). Since: 8.1.0, isa-debugcon
...
documented in the [Device Addresses](formatdomain.md#device-addresses) section; more specifically, acceptable address
...
[Relationship between serial ports and consoles](formatdomain.md#relationship-between-serial-ports-and-consoles) section.

##### [Console](formatdomain.md#id83)
...
serial element (See [Serial port](formatdomain.md#serial-port) for details). Valid
...
<https://fedoraproject.org/wiki/Features/VirtioSerial>. Since 0.8.3

For the relationship between serial ports and consoles, refer to the
[Relationship between serial ports and consoles](formatdomain.md#relationship-between-serial-ports-and-consoles) section.

##### [Relationship between serial ports and consoles](formatdomain.md#id84)
...
:   TCP traffic sent by the guest to a given IP address and port is forwarded to
    ...
    and port attributes. Since 0.7.3
...
:   Paravirtualized virtio channel. Channel is exposed in the guest under
    ...
    controller, as documented in the [Device Addresses](formatdomain.md#device-addresses) section. With qemu, if name
    ...
    quiescing. Since 0.7.7, guest agent interaction since 0.9.10
    Moreover, since 1.0.6 it is possible to have source path auto
    ...
    feature, they should leave <source> element out. Since 1.2.11
...
:   Paravirtualized Xen channel. Channel is exposed in the guest as a Xen console
    ...
    the necessary probing mechanism. Since 2.3.0

spicevmc
:   Paravirtualized SPICE channel. The domain must also have a SPICE server as a
    graphics device (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers)), at which point the host piggy-backs
...
:   Paravirtualized qemu vdagent channel. This channel implements the SPICE
    ...
    guest and a client when using a VNC graphics device (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers))
...
##### [Device logfile](formatdomain.md#id88)
...
##### [Virtual console](formatdomain.md#id89)
...
##### [Null device](formatdomain.md#id90)
...
##### [Pseudo TTY](formatdomain.md#id91)
...
##### [Host device proxy](formatdomain.md#id92)
...
##### [Named pipe](formatdomain.md#id93)
...
##### [TCP client/server](formatdomain.md#id94)
...
Since 0.8.5, some hypervisors support use of either telnets (secure
...
Since 2.4.0, the optional attribute tls can be used to control
...
##### [UDP network console](formatdomain.md#id95)
...
##### [UNIX domain socket client/server](formatdomain.md#id96)
...
##### [Spice channel](formatdomain.md#id97)

The character device is accessible through spice connection under a channel name
specified in the channel attribute. Since 1.2.2

Note: depending on the hypervisor, spiceports might (or might not) be enabled on
domains with or without spice graphics (See [Graphical framebuffers](formatdomain.md#graphical-framebuffers)).
...
##### [Nmdm device](formatdomain.md#id98)

The nmdm device driver, available on FreeBSD, provides two tty devices connected
together by a virtual null modem cable. Since 1.2.4
...
### [Sound devices](formatdomain.md#id99)
...
:   The sound element has one mandatory attribute, model, which specifies
    ...
    pcspk, ac97 (Since 0.6.0), ich6 (Since 0.8.8),
    ich9 (Since 1.1.3), usb (Since 1.2.8), ich7
    (Since 6.7.0, bhyve only) and virtio
    (Since 10.4.0 and QEMU 8.2.0).

Since 0.9.13, a sound element with ich6 or ich9 models can have
...
Since 9.4.0 the usb sound device can be optionally switched into
...
Since 10.4.0 and QEMU 8.2.0 the number of PCM streams in a virtio
...
the device to a particular PCI slot. See [Device Addresses](formatdomain.md#device-addresses).
...
### [Audio backends](formatdomain.md#id100)
...
#### [None audio backend](formatdomain.md#id101)
...
#### [ALSA audio backend](formatdomain.md#id102)
...
#### [Coreaudio audio backend](formatdomain.md#id103)
...
#### [D-Bus audio backend](formatdomain.md#id104)
...
#### [Jack audio backend](formatdomain.md#id105)
...
#### [OSS audio backend](formatdomain.md#id106)
...
#### [PipeWire audio backend](formatdomain.md#id107)
...
#### [PulseAudio audio backend](formatdomain.md#id108)
...
#### [SDL audio backend](formatdomain.md#id109)
...
#### [Spice audio backend](formatdomain.md#id110)
...
#### [File audio backend](formatdomain.md#id111)
...
### [Watchdog devices](formatdomain.md#id112)

A virtual hardware watchdog device can be added to the guest via the
watchdog element. Since 0.7.3, QEMU and KVM only
...
Since 0.8.0, a notification is available when the watchdog fires, using
...
:   The optional action attribute describes what action to take when the
    ...
    - 'dump' - automatically dump the guest, beware that after the
      dump the guest will be resumed Since 0.8.7
...
### [Memory balloon device](formatdomain.md#id113)
...
Additionally, since 0.8.4, if the memballoon device
...
:   The optional autodeflate attribute allows to enable/disable (values
    ...
    Out of Memory killer. Since 1.3.1, QEMU and KVM only
...
:   The optional period allows the QEMU virtio memory balloon driver to
    ...
    years) might be ignored. Since 1.1.1, requires QEMU 1.5

driver
:   For model virtio memballoon, [Virtio-related options](formatdomain.md#virtio-related-options) can also be set.
    ( Since 3.5.0 )

### [Random number generator device](formatdomain.md#id114)

The virtual random number generator device allows the host to pass through
entropy to guest operating systems. Since 1.0.3
...
:   The optional rate element allows limiting the rate at which entropy can
    ...
    period is taken as 1000 milliseconds (1 second). Since 1.0.4
...
:   The backend element specifies the source of entropy to be used for the
    ...
    :   This backend type expects a non-blocking character device as input. The
        ...
        Since 1.3.4 any path is accepted. Before that /dev/random and
    ...
    :   This backend connects to a source using the EGD protocol. The source is
        specified as a character device. Refer to the [Host interface](formatdomain.md#host-interface) for more
        information.
...
### [TPM device](formatdomain.md#id115)
...
the time the QEMU guest is started. 'passthrough' since 1.0.5
...
emulator device type each guest gets its own private TPM. Since 4.5.0

Since 5.6.0, the state of the TPM emulator can be encrypted by
...
:   The model attribute specifies what device model QEMU provides to the
    ...
    for non-PPC64 architectures. Since 4.4.0, another available choice
    is the tpm-crb, which should only be used when the backend device is a
    TPM 2.0. Since 6.1.0, pSeries guests on PPC64 are supported and the
    default is tpm-spapr. Since 6.5.0, a new model called
...
:   The backend element specifies the type of TPM device. The following types
    ...
    :   Use the host's TPM or TPM Resource Manager device.
        ...
        is specified then /dev/tpm0 is automatically used. Since 6.5.0,
    ...
    :   For this backend type the 'swtpm' TPM Emulator must be installed on the
        ...
        each QEMU guest requesting access to it. 10.6.0, the debug
...
:   For the emulator backend, the source element specifies the location
    of the TPM state storage. Since v10.10.0

    For the external backend, it specifies the socket of the externally
    started TPM emulator. Since v9.0.0
...
:   The active_pcr_banks node is used to define which of the PCR banks
    ...
    with the emulator backend. Since 7.10.0
...
:   The profile node is used to set a profile for a TPM 2.0 given in the
    ...
    potentially disabled algorithms will be removed. Since 10.10.0
...
### [NVRAM device](formatdomain.md#id116)
...
since 1.0.5 ) is provided to enable the address setting.
...
### [panic device](formatdomain.md#id117)
...
### [Shared memory device](formatdomain.md#id118)

A shared memory device allows to share a memory region between different virtual
machines and the host. Since 1.2.10, QEMU and KVM only
...
:   The shmem element has one mandatory attribute, name to identify the
    ...
    The optional role (since 6.6.0) attribute specifies the shared
...
### [Memory devices](formatdomain.md#id119)
...
:   Provide dimm to add a virtual DIMM module to the guest.
    ...
    Since 3.2.0 Provide virtio-pmem model to add a paravirtualized
    persistent memory device. Since 7.1.0 Provide virtio-mem model
    to add paravirtualized memory device. Since 7.9.0 Provide
    sgx-epc model to add a SGX enclave page cache (EPC) memory to the guest.
    Since 8.10.0 and QEMU 7.0.0
...
:   An optional attribute access ( since 3.2.0 ) that provides
    ...
    the same as [Memory Backing](formatdomain.md#memory-backing): shared and
    private. For nvdimm model, if using real NVDIMM DAX device as
    backend, shared is required. For virtio-pmem model shared is
    required.

discard
:   An optional attribute discard ( since 4.4.0 ) that provides
    capability to fine tune discard of data on per module basis. Accepted values
    are yes and no. The feature is described here: [Memory Backing](formatdomain.md#memory-backing).
...
:   For pSeries guests, an uuid can be set to identify the nvdimm module. If
    ...
    allowed only for model='nvdimm' for pSeries guests. Since 6.2.0
...
:   For model dimm and model virtio-mem this element is optional and
    ...
    :   If persistent memory is supported and enabled by the hypervisor in order
        ...
        the pmem element in order to utilize the feature. Since 5.0.0
    ...
    nodemask
    :   This element can be used to override the default set of NUMA nodes where
        the memory would be allocated. Since 8.10.0 and QEMU 7.0.0
...
:   The mandatory target element configures the placement and sizing of the
    ...
    :   For NVDIMM type devices one can use label and its subelement size
        ...
        [Memory Allocation](formatdomain.md#memory-allocation) section. label is mandatory for pSeries
        guests and optional for all other architectures. For QEMU domains the
        following restrictions apply:

        1. the minimum label size is 128KiB,
        2. the remaining size (total-size - label-size), also called guest area,
...
### [IOMMU devices](formatdomain.md#id120)
...
:   Supported values are intel (for Q35 guests) smmuv3
    (since 5.5.0, for ARM virt guests), virtio
    (since 8.3.0, for Q35 and ARM virt guests) and
    amd (since 11.5.0).
...
:   The driver subelement can be used to configure additional options, some
    ...
    :   The caching_mode attribute with possible values on and off can
        ...
        Since 3.4.0 (QEMU/KVM and intel model only)
    ...
    :   The eim attribute (with possible values on and off) can be
        ...
        APIC (as described in [Hypervisor features](formatdomain.md#hypervisor-features)), and
        both interrupt remapping and EIM turned on for the IOMMU, will be able to
        use more than 255 vCPUs. Since 3.4.0 (QEMU/KVM and intel model
        only)
    ...
    :   The iotlb attribute with possible values on and off can be
        ...
        devices. Since 3.5.0 (QEMU/KVM only)

    aw_bits
    :   The aw_bits attribute can be used to set the address width to allow
        mapping larger iova addresses in the guest. Since 6.5.0 (QEMU/KVM
    ...
    :   The dma_translation attribute with possible values on and off can
        ...
        Since 10.7.0 (QEMU/KVM and intel model only)

    passthrough
    :   Enable passthrough. In this mode, DMA read/writes are not translated.
        Since 11.5.0 (QEMU/KVM and amd model only)
...
than the host. Since 12.1.0 (QEMU/KVM and virtio model only).
...
in [Device addresses](formatdomain.md#device-addresses) (address has to by type of pci).

### [Vsock](formatdomain.md#id121)

A vsock host/guest interface. The model attribute defaults to virtio.
Since 5.2.0 model can also be 'virtio-transitional' or
'virtio-non-transitional', see [virtio device models](formatdomain.md#virtio-device-models) for more details.
...
assign a free CID automatically on domain startup. Since 4.4.0
The optional driver element allows to specify virtio options, see
[Virtio-related options](formatdomain.md#virtio-related-options) for more details. Since 7.1.0
...
### [Crypto](formatdomain.md#id122)

A crypto device. The model attribute defaults to virtio.
Since v9.0.0 model supports virtio only. The type attribute
defaults to qemu. Since v9.0.0 type supports qemu only.
...
## [Security label](formatdomain.md#id124)
...
(since 0.6.1) where libvirt automatically generates a unique security
label, 'static' (since 0.6.2) where the application/administrator
chooses the labels, or 'none' (since 0.9.10) where confinement is
...
since 0.9.9. When a seclabel element is attached to a specific
path rather than the top-level domain assignment, only the attribute relabel
or the sub-element label are supported. Additionally, since 1.1.2,
...
## [Key Wrap](formatdomain.md#id125)
...
## [Launch Security](formatdomain.md#id126)
...
[Protected Virtualization on s390](kbase/s390_protected_virt.md)
Since 7.6.0
...
spec](https://support.amd.com/TechDocs/55766_SEV-KM_API_Specification.pdf)
Since 4.4.0
...
:   The optional kernelHashes attribute indicates whether the
    ...
    using direct kernel boot. Since 8.0.0
...
Nested Paging enhancement, also known as SEV-SNP. Since 10.5.0 To
...
:   The optional policy element provides the guest TD attributes which is
    ...
    | Bit(s) | Description |
    | --- | --- |
    | 0 | Activate off-TD debug when set, i.e., activate debug from outside the TD. Its VCPU state and private memory are accessible by the host VMM. Deactivate off-TD debug when clear, i.e., deactivate debug from outside the TD. |
    | 1:27 | reserved |
...
# [Example configs](formatdomain.md#id127)

Example configurations for each driver are provide on the driver specific pages
listed below

- [Xen examples](drvxen.md#example-domain-xml-config)
- [QEMU/KVM examples](drvqemu.md#example-domain-xml-config)
