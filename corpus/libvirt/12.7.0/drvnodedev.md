...
collection: libvirt
version: "12.7.0"
title: "Host device management"
source_url: https://libvirt.org/drvnodedev.html
fetched_at: 2026-08-21T04:09:35+00:00
---
# Host device management

Contents

- [Basic structure of a node device](drvnodedev.md#basic-structure-of-a-node-device)
- [PCI host devices](drvnodedev.md#pci-host-devices)

  - [SR-IOV capability](drvnodedev.md#sr-iov-capability)
  - [MDEV capability](drvnodedev.md#mdev-capability)
  - [VPD capability](drvnodedev.md#vpd-capability)
- [Mediated devices (MDEVs)](drvnodedev.md#mediated-devices-mdevs)

  - [Example of a mediated device](drvnodedev.md#example-of-a-mediated-device)
...
NPIV)](https://wiki.libvirt.org/page/NPIV_in_libvirt)).
...
allows to modify devices (Since 10.1.0).
...
# [PCI host devices](drvnodedev.md#id2)

capability
:   When used as top level element, the supported values for the type
    attribute are pci and phys_function (see [SR-IOV capability](drvnodedev.md#sr-iov-capability) below).
...
## [SR-IOV capability](drvnodedev.md#id3)
...
Suppose the NIC above in [PCI host devices](drvnodedev.md#pci-host-devices) was also SR-IOV capable, it would
...
## [MDEV capability](drvnodedev.md#id4)
...
[here](formatnode.md#mdev-types-capability).
...
## [VPD capability](drvnodedev.md#id5)
...
found [here](formatnode.md#vpd-capability).
...
# [Mediated devices (MDEVs)](drvnodedev.md#id6)

Mediated devices ( Since 3.2.0 ) are software devices defining resource
...
[here](formatnode.md#mdev).

## [Example of a mediated device](drvnodedev.md#id7)
...
- update mediated devices ( Since 10.1.0 )
...
parent device's capabilities (see the example in [PCI host devices](drvnodedev.md#pci-host-devices)).
