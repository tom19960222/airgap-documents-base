...
collection: libvirt
version: "12.7.0"
title: "Polkit access control"
source_url: https://libvirt.org/aclpolkit.html
fetched_at: 2026-08-21T04:10:07+00:00
---
# Polkit access control

Libvirt's client [access control framework](acl.md) allows
...
- [Introduction](aclpolkit.md#introduction)
- [Permission names](aclpolkit.md#permission-names)
- [Object identity attributes](aclpolkit.md#object-identity-attributes)

  - [virConnectPtr](aclpolkit.md#virconnectptr)
  - [virDomainPtr](aclpolkit.md#virdomainptr)
  - [virInterfacePtr](aclpolkit.md#virinterfaceptr)
  - [virNetworkPtr](aclpolkit.md#virnetworkptr)
  - [virNodeDevicePtr](aclpolkit.md#virnodedeviceptr)
  - [virNWFilterPtr](aclpolkit.md#virnwfilterptr)
  - [virSecretPtr](aclpolkit.md#virsecretptr)
  - [virStoragePoolPtr](aclpolkit.md#virstoragepoolptr)
  - [virStorageVolPtr](aclpolkit.md#virstoragevolptr)
- [Hypervisor Driver connect_driver](aclpolkit.md#hypervisor-driver-connect-driver)

  - [Connection Driver Name](aclpolkit.md#connection-driver-name)
- [User identity attributes](aclpolkit.md#user-identity-attributes)
- [Writing access control policies](aclpolkit.md#writing-access-control-policies)

  - [Example: restricting ability to connect to drivers](aclpolkit.md#example-restricting-ability-to-connect-to-drivers)
  - [Example: restricting access to a single domain](aclpolkit.md#example-restricting-access-to-a-single-domain)

# [Introduction](aclpolkit.md#id1)

A default install of libvirt will typically use
[polkit](https://www.freedesktop.org/wiki/Software/polkit/) to
...
# [Permission names](aclpolkit.md#id2)

The libvirt [object names and permission names](acl.md#objects-and-permissions) are
...
# [Object identity attributes](aclpolkit.md#id3)
...
## [virConnectPtr](aclpolkit.md#id4)

| Attribute | Description |
| --- | --- |
| connect_driver | Name of the libvirt connection driver |

## [virDomainPtr](aclpolkit.md#id5)
...
## [virInterfacePtr](aclpolkit.md#id6)
...
## [virNetworkPtr](aclpolkit.md#id7)
...
## [virNodeDevicePtr](aclpolkit.md#id8)
...
## [virNWFilterPtr](aclpolkit.md#id9)
...
## [virSecretPtr](aclpolkit.md#id10)
...
## [virStoragePoolPtr](aclpolkit.md#id11)
...
## [virStorageVolPtr](aclpolkit.md#id12)
...
# [Hypervisor Driver connect_driver](aclpolkit.md#id13)

The connect_driver parameter describes the client's [remote
Connection Driver](remote.md) name based on the [URI](uri.md)
used for the connection.

Since 4.1.0, when calling an API outside the scope of the primary
...
## [Connection Driver Name](aclpolkit.md#id14)
...
# [User identity attributes](aclpolkit.md#id15)
...
# [Writing access control policies](aclpolkit.md#id16)
...
See [source
code](https://gitlab.com/libvirt/libvirt/-/tree/master/examples/polkit)
for a more complex example.

## [Example: restricting ability to connect to drivers](aclpolkit.md#id17)
...
## [Example: restricting access to a single domain](aclpolkit.md#id18)
