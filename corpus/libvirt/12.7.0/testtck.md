...
collection: libvirt
version: "12.7.0"
title: "libvirt TCK : Technology Compatibility Kit"
source_url: https://libvirt.org/testtck.html
...
- [Using TCK](testtck.md#using-tck)

  - [Installing dependencies](testtck.md#installing-dependencies)
  - [Running TCK](testtck.md#running-tck)

    - [Replicating upstream CI test suite execution locally](testtck.md#replicating-upstream-ci-test-suite-execution-locally)
    - [Manual invocation](testtck.md#manual-invocation)
- [Contributing a test](testtck.md#contributing-a-test)
...
repository](https://gitlab.com/libvirt/libvirt-tck). GitLab is also the place
where the whole TCK development workflow (issues, merge requests, comments)
happens.

# [Using TCK](testtck.md#id1)
...
your current host setup, see [Running TCK](testtck.md#running-tck).

## [Installing dependencies](testtck.md#id2)
...
[libvirt-ci's](https://gitlab.com/libvirt/libvirt-ci.git) lcitool can help
...
[Installing local VMs](https://gitlab.com/libvirt/libvirt-ci/-/blob/master/docs/vms.rst)
...
please refer to
[Updating VMs with a given project dependencies](https://gitlab.com/libvirt/libvirt-ci/-/blob/master/docs/vms.rst)
...
[PyPI](https://pypi.org/project/avocado-framework/) (recommended), or if
you're on Fedora you can make use of the Avocado [module](https://avocado-framework.readthedocs.io/en/latest/guides/user/chapters/installing.html#installing-from-packages).
...
### [Replicating upstream CI test suite execution locally](testtck.md#id4)
...
[virtiofs](kbase/virtiofs.md)). Make sure that the
...
### [Manual invocation](testtck.md#id5)
...
[TCK](https://gitlab.com/libvirt/libvirt-tck.git) repository and run
...
# [Contributing a test](testtck.md#id6)
