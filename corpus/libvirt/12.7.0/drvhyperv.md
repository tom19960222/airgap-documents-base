...
collection: libvirt
version: "12.7.0"
title: "Microsoft Hyper-V hypervisor driver"
source_url: https://libvirt.org/drvhyperv.html
fetched_at: 2026-08-21T04:09:39+00:00
---
# Microsoft Hyper-V hypervisor driver

Contents

- [Project Links](drvhyperv.md#project-links)
- [Connections to the Microsoft Hyper-V driver](drvhyperv.md#connections-to-the-microsoft-hyper-v-driver)

  - [URI Format](drvhyperv.md#uri-format)

    - [Extra parameters](drvhyperv.md#extra-parameters)
  - [Authentication](drvhyperv.md#authentication)
- [Version Numbers](drvhyperv.md#version-numbers)

The libvirt Microsoft Hyper-V driver can manage Hyper-V 2012 R2 and newer.

# [Project Links](drvhyperv.md#id1)

- The [Microsoft Hyper-V](https://docs.microsoft.com/en-us/windows-server/virtualization/hyper-v/hyper-v-on-windows-server)
  hypervisor

# [Connections to the Microsoft Hyper-V driver](drvhyperv.md#id2)
...
Therefore, the [remote transport mechanism](remote.md) provided by the
remote driver and libvirtd will not work, and you cannot use URIs like
hyperv+ssh://example.com.

## [URI Format](drvhyperv.md#id3)
...
### [Extra parameters](drvhyperv.md#id4)
...
## [Authentication](drvhyperv.md#id5)
...
# [Version Numbers](drvhyperv.md#id6)
