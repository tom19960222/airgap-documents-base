...
source_url: https://libvirt.org/support.html
fetched_at: 2026-08-21T04:10:14+00:00
---
# Support guarantees

Contents

- [Primary public API](support.md#primary-public-api)
- [Hypervisor specific APIs](support.md#hypervisor-specific-apis)
- [Error reporting](support.md#error-reporting)
- [XML schemas](support.md#xml-schemas)
- [Configuration files](support.md#configuration-files)
- [Hypervisor drivers](support.md#hypervisor-drivers)
- [RPC protocol](support.md#rpc-protocol)
- [virsh client](support.md#virsh-client)
...
# [Primary public API](support.md#id1)
...
# [Hypervisor specific APIs](support.md#id2)
...
# [Error reporting](support.md#id3)
...
# [Configuration files](support.md#id5)
...
# [Hypervisor drivers](support.md#id6)
...
separately](hvsupport.md).

# [RPC protocol](support.md#id7)
