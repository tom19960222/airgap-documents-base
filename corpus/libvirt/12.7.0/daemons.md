...
source_url: https://libvirt.org/daemons.html
fetched_at: 2026-08-21T04:10:06+00:00
---
# Libvirt Daemons

Contents

- [Architectural options](daemons.md#architectural-options)

  - [Monolithic vs modular daemons](daemons.md#monolithic-vs-modular-daemons)
  - [Operating modes](daemons.md#operating-modes)
- [Monolithic driver daemon](daemons.md#monolithic-driver-daemon)

  - [Monolithic sockets](daemons.md#monolithic-sockets)
  - [Monolithic Systemd Integration](daemons.md#monolithic-systemd-integration)
- [Modular driver daemons](daemons.md#modular-driver-daemons)

  - [Modular Sockets](daemons.md#modular-sockets)
  - [Modular Systemd Integration](daemons.md#modular-systemd-integration)
  - [Switching to modular daemons](daemons.md#switching-to-modular-daemons)
- [Checking whether modular/monolithic mode is in use](daemons.md#checking-whether-modular-monolithic-mode-is-in-use)
- [Proxy daemon](daemons.md#proxy-daemon)

  - [Proxy sockets](daemons.md#proxy-sockets)
  - [Proxy Systemd Integration](daemons.md#proxy-systemd-integration)
- [Logging daemon](daemons.md#logging-daemon)

  - [Logging Sockets](daemons.md#logging-sockets)
  - [Logging Systemd Integration](daemons.md#logging-systemd-integration)
- [Locking daemon](daemons.md#locking-daemon)

  - [Locking Sockets](daemons.md#locking-sockets)
  - [Locking Systemd Integration](daemons.md#locking-systemd-integration)
- [Changing command line options for daemons](daemons.md#changing-command-line-options-for-daemons)
...
# [Architectural options](daemons.md#id1)

## [Monolithic vs modular daemons](daemons.md#id2)
...
## [Operating modes](daemons.md#id3)
...
- *System mode* - the daemon is running as the root user account, enabling
  ...
  a root shell**. Suitable [authentication mechanisms](auth.md) **must
...
# [Monolithic driver daemon](daemons.md#id4)
...
## [Monolithic sockets](daemons.md#id5)
...
- TCP 16509 - the non-TLS socket for remotely accessing the libvirt APIs,
  ...
  not use TLS, an [authentication mechanism](auth.md) that provides
...
- TCP 16514 - the TLS socket for remotely accessing the libvirt APIs,
  ...
  can be enforced either through validation of [x509 certificates](kbase/tlscerts.md), and/or by enabling an [authentication mechanism](auth.md).
...
## [Monolithic Systemd Integration](daemons.md#id6)
...
# [Modular driver daemons](daemons.md#id7)
...
## [Modular Sockets](daemons.md#id8)
...
## [Modular Systemd Integration](daemons.md#id9)
...
## [Switching to modular daemons](daemons.md#id10)
...
2. Disable future start of the monolithic daemon
   ...
   too.
3. Enable the new daemons for the particular virtualizationd driver desired,
   ...
   ```
4. Start the sockets for the same set of daemons. There is no need to start the
   ...
   ```
5. If connections from remote hosts need to be supported the proxy daemon
...
# [Checking whether modular/monolithic mode is in use](daemons.md#id11)
...
1. Check whether the modular daemon infrastructure is in use
   ...
   [Modular driver daemons](daemons.md#modular-driver-daemons) for a summary of which daemons are provided by
...
2. Check whether the monolithic daemon is in use
   ...
   daemon.
3. To determine which of the above will be in use on the next boot of the system,
   substitute is-enabled for is-active in the above examples.

# [Proxy daemon](daemons.md#id12)

## [Proxy sockets](daemons.md#id13)
...
## [Proxy Systemd Integration](daemons.md#id14)
...
# [Logging daemon](daemons.md#id15)
...
## [Logging Sockets](daemons.md#id16)
...
## [Logging Systemd Integration](daemons.md#id17)
...
# [Locking daemon](daemons.md#id18)
...
## [Locking Sockets](daemons.md#id19)
...
## [Locking Systemd Integration](daemons.md#id20)
...
# [Changing command line options for daemons](daemons.md#id21)
