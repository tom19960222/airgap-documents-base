...
collection: libvirt
version: "12.7.0"
title: "Firewall and network filtering in libvirt"
source_url: https://libvirt.org/firewall.html
fetched_at: 2026-08-21T04:10:09+00:00
---
# Firewall and network filtering in libvirt

Contents

- [The virtual network driver](firewall.md#the-virtual-network-driver)
- [firewalld and the virtual network driver](firewall.md#firewalld-and-the-virtual-network-driver)
- [The network filter driver](firewall.md#the-network-filter-driver)
...
# [The virtual network driver](firewall.md#id1)
...
# [firewalld and the virtual network driver](firewall.md#id2)

If [firewalld](https://firewalld.org) is active on the host, libvirt will
...
# [The network filter driver](firewall.md#id3)
...
[here](formatnwfilter.md#supported-protocols).
...
More in depth documentation on this is [here](formatnwfilter.md).
