---
collection: prometheus-adapter
version: "0.9.0"
title: "Prometheus Adapter for Kubernetes Metrics APIs"
source_url: https://github.com/kubernetes-sigs/prometheus-adapter/blob/0a9c781e5c69b1777b922ede2f9df100ef90703c/README.md
fetched_at: 2021-08-16T02:35:49-07:00
---
...
- [Config walkthrough](config-walkthrough.md) and [config reference](config.md).
- [End-to-end walkthrough](walkthrough.md)
- [Deployment info and files](https://github.com/kubernetes-sigs/prometheus-adapter/blob/0a9c781e5c69b1777b922ede2f9df100ef90703c/deploy/README.md)
...
The rules governing this discovery are specified in a [configuration file](config.md).
...
A brief walkthrough exists in [docs/walkthrough.md](walkthrough.md).
