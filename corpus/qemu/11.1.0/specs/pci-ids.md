...
collection: qemu
version: "11.1.0"
title: "PCI IDs for QEMU"
source_url: https://www.qemu.org/docs/master/specs/pci-ids.html
fetched_at: 2026-08-21T03:22:32+00:00
---
# PCI IDs for QEMU
...
Contact Gerd Hoffmann <[kraxel@redhat.com](mailto:kraxel%40redhat.com)> to get a device ID assigned
for your devices.
...
1af4:1110
:   ivshmem device ([Device Specification for Inter-VM shared memory device](ivshmem-spec.md))
...
1b36:0002
:   PCI serial port (16550A) adapter ([QEMU PCI serial devices](pci-serial.md))

1b36:0003
:   PCI Dual-port 16550A adapter ([QEMU PCI serial devices](pci-serial.md))

1b36:0004
:   PCI Quad-port 16550A adapter ([QEMU PCI serial devices](pci-serial.md))

1b36:0005
:   PCI test device ([QEMU PCI test device](pci-testdev.md))
...
All these devices are documented in [System Emulation Guest Hardware Specifications](index.md).
