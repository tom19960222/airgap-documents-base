...
collection: qemu
version: "11.1.0"
title: "RISC-V IOMMU support for RISC-V machines"
source_url: https://www.qemu.org/docs/master/specs/riscv-iommu.html
fetched_at: 2026-08-21T03:22:59+00:00
---
# RISC-V IOMMU support for RISC-V machines

QEMU implements a RISC-V IOMMU emulation based on the RISC-V IOMMU spec
version 1.0 [iommu1.0.0](https://github.com/riscv-non-isa/riscv-iommu/releases/download/v1.0.0/riscv-iommu.pdf).
...
“Integrating an IOMMU as a PCIe device” of [iommu1.0.0](https://github.com/riscv-non-isa/riscv-iommu/releases/download/v1.0.0/riscv-iommu.pdf): a PCI device with base
...
There is a [VFIO](https://lore.kernel.org/linux-riscv/20241114161845.502027-17-ajones@ventanamicro.com/) RFC series that is not yet merged. The public Ventana Micro
Systems kernel repository in [ventana-linux](https://github.com/ventanamicro/linux/tree/dev-upstream) can be used for testing the VFIO
functions.
