...
collection: qemu
version: "11.1.0"
title: "sPAPR hypervisor calls"
source_url: https://www.qemu.org/docs/master/specs/ppc-spapr-hcalls.html
fetched_at: 2026-08-21T03:24:39+00:00
---
# sPAPR hypervisor calls

When used with the `pseries` machine type, `qemu-system-ppc64` implements
a set of hypervisor calls (a.k.a. hcalls) defined in the Linux on Power
Architecture Reference ([[LoPAR]](../system/ppc/pseries.md#lopar)) document. This document is a subset of the
