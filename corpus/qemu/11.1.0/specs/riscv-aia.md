...
collection: qemu
version: "11.1.0"
title: "RISC-V AIA support for RISC-V machines"
source_url: https://www.qemu.org/docs/master/specs/riscv-aia.html
fetched_at: 2026-08-21T03:23:00+00:00
---
...
How AIA and accel options changes controller emulation

| Accel | Accel props | AIA type | APLIC m-mode | IMSIC m-mode | APLIC s-mode | IMSIC s-mode |
| --- | --- | --- | --- | --- | --- | --- |
...
How ‘riscv-aia’ changes in-kernel IMSIC s-mode provisioning

| Accel | KVM riscv-aia | AIA type | IMSIC s-mode |
| --- | --- | --- | --- |
| kvm | none | aplic-imsic | in-kernel, default to ‘auto’ |
| kvm | auto | aplic-imsic | in-kernel, hwaccel if available, emul otherwise |
| kvm | hwaccel | aplic-imsic | in-kernel, use IMSIC controller from guest hardware |
| kvm | emul | aplic-imsic | in-kernel, IMSIC is emulated by KVM |
