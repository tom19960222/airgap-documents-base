...
source_url: https://www.qemu.org/docs/master/interop/vfio-user.html
fetched_at: 2026-08-21T03:22:26+00:00
---
# [vfio-user Protocol Specification](vfio-user.md#id32)

Table of Contents

- [vfio-user Protocol Specification](vfio-user.md#vfio-user-protocol-specification)

  - [Introduction](vfio-user.md#introduction)
  - [Overview](vfio-user.md#overview)

    - [VFIO Device Model](vfio-user.md#vfio-device-model)

      - [Connection Initiation](vfio-user.md#connection-initiation)
      - [Device Information](vfio-user.md#device-information)
      - [Region Information](vfio-user.md#region-information)

        - [Region Capabilities](vfio-user.md#region-capabilities)
        - [Sparse Regions](vfio-user.md#sparse-regions)
        - [Device-Specific Regions](vfio-user.md#device-specific-regions)
    - [Region I/O via file descriptors](vfio-user.md#region-i-o-via-file-descriptors)

      - [Interrupts](vfio-user.md#interrupts)
      - [Device Read and Write](vfio-user.md#device-read-and-write)
    - [Client memory access](vfio-user.md#client-memory-access)
  - [Client/server interactions](vfio-user.md#client-server-interactions)

    - [Socket](vfio-user.md#socket)
    - [Authentication](vfio-user.md#authentication)
    - [Command Concurrency](vfio-user.md#command-concurrency)
    - [Socket Disconnection Behavior](vfio-user.md#socket-disconnection-behavior)

      - [Server Disconnection](vfio-user.md#server-disconnection)
      - [Client Disconnection](vfio-user.md#client-disconnection)
    - [Security Considerations](vfio-user.md#security-considerations)
    - [Request Retry and Response Timeout](vfio-user.md#request-retry-and-response-timeout)
    - [Message sizes](vfio-user.md#message-sizes)
  - [Protocol Specification](vfio-user.md#protocol-specification)

    - [Commands](vfio-user.md#commands)
    - [Header](vfio-user.md#header)
    - [`VFIO_USER_VERSION`](vfio-user.md#vfio-user-version)

      - [Request](vfio-user.md#request)
      - [Reply](vfio-user.md#reply)
    - [`VFIO_USER_DMA_MAP`](vfio-user.md#vfio-user-dma-map)

      - [Request](vfio-user.md#id2)
      - [Reply](vfio-user.md#id3)
    - [`VFIO_USER_DMA_UNMAP`](vfio-user.md#vfio-user-dma-unmap)

      - [Request](vfio-user.md#id4)
      - [Reply](vfio-user.md#id5)
    - [`VFIO_USER_DEVICE_GET_INFO`](vfio-user.md#vfio-user-device-get-info)

      - [Request](vfio-user.md#id6)
      - [Reply](vfio-user.md#id7)
    - [`VFIO_USER_DEVICE_GET_REGION_INFO`](vfio-user.md#vfio-user-device-get-region-info)

      - [Request](vfio-user.md#id8)
      - [Reply](vfio-user.md#id9)

        - [VFIO region capabilities](vfio-user.md#vfio-region-capabilities)
        - [VFIO cap header format](vfio-user.md#vfio-cap-header-format)
        - [VFIO sparse mmap cap header](vfio-user.md#vfio-sparse-mmap-cap-header)
        - [VFIO region info cap sparse mmap](vfio-user.md#vfio-region-info-cap-sparse-mmap)
    - [`VFIO_USER_DEVICE_GET_REGION_IO_FDS`](vfio-user.md#vfio-user-device-get-region-io-fds)

      - [Request](vfio-user.md#id10)
      - [Reply](vfio-user.md#id11)

        - [Sub-Region IO FD info format (ioeventfd)](vfio-user.md#sub-region-io-fd-info-format-ioeventfd)
        - [Sub-Region IO FD info format (ioregionfd)](vfio-user.md#sub-region-io-fd-info-format-ioregionfd)
    - [`VFIO_USER_DEVICE_GET_IRQ_INFO`](vfio-user.md#vfio-user-device-get-irq-info)

      - [Request](vfio-user.md#id12)
      - [Reply](vfio-user.md#id13)
    - [`VFIO_USER_DEVICE_SET_IRQS`](vfio-user.md#vfio-user-device-set-irqs)

      - [Request](vfio-user.md#id14)
      - [Reply](vfio-user.md#id15)
    - [`VFIO_USER_REGION_READ`](vfio-user.md#vfio-user-region-read)

      - [Request](vfio-user.md#id16)
      - [Reply](vfio-user.md#id17)
    - [`VFIO_USER_REGION_WRITE`](vfio-user.md#vfio-user-region-write)

      - [Request](vfio-user.md#id18)
      - [Reply](vfio-user.md#id19)
    - [`VFIO_USER_DMA_READ`](vfio-user.md#vfio-user-dma-read)

      - [Request](vfio-user.md#id20)
      - [Reply](vfio-user.md#id21)
    - [`VFIO_USER_DMA_WRITE`](vfio-user.md#vfio-user-dma-write)

      - [Request](vfio-user.md#id22)
      - [Reply](vfio-user.md#id23)
    - [`VFIO_USER_DEVICE_RESET`](vfio-user.md#vfio-user-device-reset)
    - [`VFIO_USER_REGION_WRITE_MULTI`](vfio-user.md#vfio-user-region-write-multi)

      - [Request](vfio-user.md#id24)

        - [Single Device Write Format](vfio-user.md#single-device-write-format)
      - [Reply](vfio-user.md#id25)
    - [`VFIO_USER_DEVICE_FEATURE`](vfio-user.md#vfio-user-device-feature)

      - [Request](vfio-user.md#id26)
      - [Reply](vfio-user.md#id27)
      - [Device Features](vfio-user.md#device-features)

        - [`VFIO_DEVICE_FEATURE_MIGRATION`](vfio-user.md#vfio-device-feature-migration)
        - [`VFIO_DEVICE_FEATURE_MIG_DEVICE_STATE`](vfio-user.md#vfio-device-feature-mig-device-state)
        - [Direct State Transitions](vfio-user.md#direct-state-transitions)
        - [Complex State Transitions](vfio-user.md#complex-state-transitions)
        - [`VFIO_DEVICE_FEATURE_DMA_LOGGING_START` / `VFIO_DEVICE_FEATURE_DMA_LOGGING_STOP`](vfio-user.md#vfio-device-feature-dma-logging-start-vfio-device-feature-dma-logging-stop)
        - [`VFIO_DEVICE_FEATURE_DMA_LOGGING_REPORT`](vfio-user.md#vfio-device-feature-dma-logging-report)
    - [`VFIO_USER_MIG_DATA_READ`](vfio-user.md#vfio-user-mig-data-read)

      - [Request](vfio-user.md#id28)
      - [Reply](vfio-user.md#id29)
    - [`VFIO_USER_MIG_DATA_WRITE`](vfio-user.md#vfio-user-mig-data-write)

      - [Request](vfio-user.md#id30)
      - [Reply](vfio-user.md#id31)
  - [Appendices](vfio-user.md#appendices)

    - [Unused VFIO `ioctl()` commands](vfio-user.md#unused-vfio-ioctl-commands)

      - [VFIO groups and containers](vfio-user.md#vfio-groups-and-containers)
    - [Backend Program Conventions](vfio-user.md#backend-program-conventions)

## [Introduction](vfio-user.md#id33)
...
[Linux VFIO ioctl interface](https://www.kernel.org/doc/html/latest/driver-api/vfio.html).
...
### [VFIO Device Model](vfio-user.md#id35)
...
#### [Connection Initiation](vfio-user.md#id36)
...
#### [Device Information](vfio-user.md#id37)
...
#### [Region Information](vfio-user.md#id38)
...
##### [Region Capabilities](vfio-user.md#id39)
...
##### [Sparse Regions](vfio-user.md#id40)
...
##### [Device-Specific Regions](vfio-user.md#id41)
...
### [Region I/O via file descriptors](vfio-user.md#id42)
...
#### [Device Read and Write](vfio-user.md#id44)
...
write operations. See [Read and Write Operations](vfio-user.md#read-and-write-operations).

### [Client memory access](vfio-user.md#id45)
...
See [Read and Write Operations](vfio-user.md#read-and-write-operations).

## [Client/server interactions](vfio-user.md#id46)

### [Socket](vfio-user.md#id47)
...
### [Authentication](vfio-user.md#id48)
...
### [Command Concurrency](vfio-user.md#id49)
...
### [Socket Disconnection Behavior](vfio-user.md#id50)
...
#### [Server Disconnection](vfio-user.md#id51)
...
#### [Client Disconnection](vfio-user.md#id52)
...
### [Security Considerations](vfio-user.md#id53)
...
### [Request Retry and Response Timeout](vfio-user.md#id54)
...
### [Message sizes](vfio-user.md#id55)
...
In addition, during negotiation (see [Version](vfio-user.md#version)), the client and server may
...
messages; see [Read and Write Operations](vfio-user.md#read-and-write-operations).

## [Protocol Specification](vfio-user.md#id56)
...
| Message size | 4 | 4 |
| Flags | 8 | 4 |
|  | | Bit | Definition | | --- | --- | | 0-3 | Type | | 4 | No_reply | | 5 | Error | | |
| Error | 12 | 4 |
...
- *Message ID* identifies the message, and is echoed in the command’s reply
  ...
  uniqueness.
- *Command* specifies the command to be executed, listed in [Commands](vfio-user.md#commands). It is
...
Each command message in [Commands](vfio-user.md#commands) must be replied to with a reply message,
...
### [`VFIO_USER_VERSION`](vfio-user.md#id59)
...
| max_data_xfer_size | number | Maximum `count` for data transfer messages; see [Read and Write Operations](vfio-user.md#read-and-write-operations). Optional, with a default value of 1048576 bytes. |
...
### [`VFIO_USER_DMA_MAP`](vfio-user.md#id62)
...
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 | readable | | 1 | writeable | | 2 | access mode: mmap | | 3 | access mode: file I/O | | |
| offset | 8 | 8 |
| address | 16 | 8 |
| size | 24 | 8 |
...
- `VFIO_USER_DMA_READ` and `VFIO_USER_DMA_WRITE` messages, explained in
  [Read and Write Operations](vfio-user.md#read-and-write-operations).
...
#### [Reply](vfio-user.md#id64)

There is no payload in the reply message.

### [`VFIO_USER_DMA_UNMAP`](vfio-user.md#id65)
...
### [`VFIO_USER_DEVICE_GET_INFO`](vfio-user.md#id68)

This command message is sent by the client to the server to query for basic
information about the device.

#### [Request](vfio-user.md#id69)

| Name | Offset | Size |
| --- | --- | --- |
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 | VFIO_DEVICE_FLAGS_RESET | | 1 | VFIO_DEVICE_FLAGS_PCI | | |
| num_regions | 8 | 4 |
| num_irqs | 12 | 4 |
...
### [`VFIO_USER_DEVICE_GET_REGION_INFO`](vfio-user.md#id71)
...
#### [Reply](vfio-user.md#id73)

| Name | Offset | Size |
| --- | --- | --- |
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 | VFIO_REGION_INFO_FLAG_READ | | 1 | VFIO_REGION_INFO_FLAG_WRITE | | 2 | VFIO_REGION_INFO_FLAG_MMAP | | 3 | VFIO_REGION_INFO_FLAG_CAPS | | |
|  |  |  |
| index | 8 | 4 |
| cap_offset | 12 | 4 |
| size | 16 | 8 |
...
##### [VFIO region capabilities](vfio-user.md#id74)
...
##### [VFIO cap header format](vfio-user.md#id75)
...
##### [VFIO sparse mmap cap header](vfio-user.md#id76)
...
##### [VFIO region info cap sparse mmap](vfio-user.md#id77)
...
### [`VFIO_USER_DEVICE_GET_REGION_IO_FDS`](vfio-user.md#id78)
...
##### [Sub-Region IO FD info format (ioeventfd)](vfio-user.md#id81)
...
##### [Sub-Region IO FD info format (ioregionfd)](vfio-user.md#id82)
...
### [`VFIO_USER_DEVICE_GET_IRQ_INFO`](vfio-user.md#id83)

This command message is sent by the client to the server to query for
information about device interrupt types. The VFIO IRQ info structure is
defined in `<linux/vfio.h>` (`struct vfio_irq_info`).

#### [Request](vfio-user.md#id84)

| Name | Offset | Size |
| --- | --- | --- |
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 | VFIO_IRQ_INFO_EVENTFD | | 1 | VFIO_IRQ_INFO_MASKABLE | | 2 | VFIO_IRQ_INFO_AUTOMASKED | | 3 | VFIO_IRQ_INFO_NORESIZE | | |
| index | 8 | 4 |
| count | 12 | 4 |
...
### [`VFIO_USER_DEVICE_SET_IRQS`](vfio-user.md#id86)
...
#### [Request](vfio-user.md#id87)

| Name | Offset | Size |
| --- | --- | --- |
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 | VFIO_IRQ_SET_DATA_NONE | | 1 | VFIO_IRQ_SET_DATA_BOOL | | 2 | VFIO_IRQ_SET_DATA_EVENTFD | | 3 | VFIO_IRQ_SET_ACTION_MASK | | 4 | VFIO_IRQ_SET_ACTION_UNMASK | | 5 | VFIO_IRQ_SET_ACTION_TRIGGER | | |
| index | 8 | 4 |
| start | 12 | 4 |
| count | 16 | 4 |
| data | 20 | variable |
...
1. The client sends a `VFIO_USER_DEVICE_SET_IRQ` message with
   ...
   server side.
2. The client may send a `VFIO_USER_DEVICE_SET_IRQ` message with
...
4. The server may mask/unmask an IRQ which will write 1 to the corresponding
...
### [`VFIO_USER_REGION_READ`](vfio-user.md#id89)
...
### [`VFIO_USER_DMA_READ`](vfio-user.md#id95)
...
### [`VFIO_USER_DMA_WRITE`](vfio-user.md#id98)
...
### [`VFIO_USER_DEVICE_RESET`](vfio-user.md#id101)
...
### [`VFIO_USER_REGION_WRITE_MULTI`](vfio-user.md#id102)
...
##### [Single Device Write Format](vfio-user.md#id104)
...
| argsz | 0 | 4 |
| flags | 4 | 4 |
|  | | Bit | Definition | | --- | --- | | 0 to 15 | Feature index | | 16 | VFIO_DEVICE_FEATURE_GET | | 17 | VFIO_DEVICE_FEATURE_SET | | 18 | VFIO_DEVICE_FEATURE_PROBE | | |
| data | 8 | variable |
...
#### [Device Features](vfio-user.md#id109)
...
##### [`VFIO_DEVICE_FEATURE_MIGRATION`](vfio-user.md#id110)
...
| --- | --- | --- |
| flags | 0 | 8 |
|  | | Bit | Definition | | --- | --- | | 0 | VFIO_MIGRATION_STOP_COPY | | 1 | VFIO_MIGRATION_P2P | | 2 | VFIO_MIGRATION_PRE_COPY | | |

These flags are interpreted in the same way as VFIO.

##### [`VFIO_DEVICE_FEATURE_MIG_DEVICE_STATE`](vfio-user.md#id111)
...
##### [Direct State Transitions](vfio-user.md#id112)
...
##### [Complex State Transitions](vfio-user.md#id113)
...
##### [`VFIO_DEVICE_FEATURE_DMA_LOGGING_START` / `VFIO_DEVICE_FEATURE_DMA_LOGGING_STOP`](vfio-user.md#id114)
...
##### [`VFIO_DEVICE_FEATURE_DMA_LOGGING_REPORT`](vfio-user.md#id115)
...
### [`VFIO_USER_MIG_DATA_READ`](vfio-user.md#id116)
...
### [`VFIO_USER_MIG_DATA_WRITE`](vfio-user.md#id119)
...
#### [Reply](vfio-user.md#id121)

There is no reply payload for this message.

## [Appendices](vfio-user.md#id122)

### [Unused VFIO `ioctl()` commands](vfio-user.md#id123)
...
#### [VFIO groups and containers](vfio-user.md#id124)
...
### [Backend Program Conventions](vfio-user.md#id125)
