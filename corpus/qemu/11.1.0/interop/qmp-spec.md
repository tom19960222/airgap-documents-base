...
collection: qemu
version: "11.1.0"
title: "QEMU Machine Protocol Specification"
source_url: https://www.qemu.org/docs/master/interop/qmp-spec.html
fetched_at: 2026-08-21T03:22:16+00:00
---
# [QEMU Machine Protocol Specification](qmp-spec.md#id1)
...
be found in the [QEMU QMP Reference Manual](qemu-qmp-ref.md) and the [QEMU Guest Agent Protocol Reference](qemu-ga-ref.md).

Contents

- [QEMU Machine Protocol Specification](qmp-spec.md#qemu-machine-protocol-specification)

  - [Protocol Specification](qmp-spec.md#protocol-specification)

    - [General Definitions](qmp-spec.md#general-definitions)
    - [Server Greeting](qmp-spec.md#server-greeting)
    - [Capabilities](qmp-spec.md#capabilities)
    - [Issuing Commands](qmp-spec.md#issuing-commands)
    - [Out-of-band execution](qmp-spec.md#out-of-band-execution)
    - [Commands Responses](qmp-spec.md#commands-responses)
    - [Success](qmp-spec.md#success)
    - [Error](qmp-spec.md#error)
    - [Asynchronous events](qmp-spec.md#asynchronous-events)
    - [Forcing the JSON parser into known-good state](qmp-spec.md#forcing-the-json-parser-into-known-good-state)
    - [QGA Synchronization](qmp-spec.md#qga-synchronization)
...
## [Protocol Specification](qmp-spec.md#id2)
...
### [General Definitions](qmp-spec.md#id3)
...
### [Server Greeting](qmp-spec.md#id4)
...
### [Capabilities](qmp-spec.md#id5)

Currently supported capabilities are:

`oob`
:   the QMP server supports “out-of-band” (OOB) command
    execution, as described in section [Out-of-band execution](qmp-spec.md#out-of-band-execution).

### [Issuing Commands](qmp-spec.md#id6)
...
The actual commands are documented in the [QEMU QMP Reference Manual](qemu-qmp-ref.md).

### [Out-of-band execution](qmp-spec.md#id7)
...
With out-of-band execution enabled via [capabilities negotiation](qmp-spec.md#capabilities-negotiation),
...
### [Commands Responses](qmp-spec.md#id8)
...
### [Asynchronous events](qmp-spec.md#id11)
...
The actual asynchronous events are documented in the [QEMU QMP Reference Manual](qemu-qmp-ref.md).
...
### [Forcing the JSON parser into known-good state](qmp-spec.md#id12)
...
### [QGA Synchronization](qmp-spec.md#id13)
...
## [Capabilities Negotiation](qmp-spec.md#id15)
...
advertised in the [Server Greeting](qmp-spec.md#server-greeting) which they support.
...
## [Compatibility Considerations](qmp-spec.md#id16)

All protocol changes or new features which modify the protocol format in an
incompatible way are disabled by default and will be advertised by the
capabilities array (in the [Server Greeting](qmp-spec.md#server-greeting)). Thus, Clients can check
...
## [Downstream extension of QMP](qmp-spec.md#id17)
...
Downstream must not change the [server greeting](qmp-spec.md#server-greeting) other than
to offer additional capabilities. But see below for why even that is
discouraged.

The section [Compatibility Considerations](qmp-spec.md#compatibility-considerations) applies to downstream as well
