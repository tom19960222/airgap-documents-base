...
collection: qemu
version: "11.1.0"
title: "Persistent reservation helper protocol"
source_url: https://www.qemu.org/docs/master/interop/pr-helper.html
fetched_at: 2026-08-21T03:22:15+00:00
---
# [Persistent reservation helper protocol](pr-helper.md#id1)
...
- [Persistent reservation helper protocol](pr-helper.md#persistent-reservation-helper-protocol)

  - [Connection and initialization](pr-helper.md#connection-and-initialization)
  - [Command format](pr-helper.md#command-format)

## [Connection and initialization](pr-helper.md#id2)
...
## [Command format](pr-helper.md#id3)
