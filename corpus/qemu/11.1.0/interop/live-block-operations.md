...
collection: qemu
version: "11.1.0"
title: "Live Block Device Operations"
source_url: https://www.qemu.org/docs/master/interop/live-block-operations.html
fetched_at: 2026-08-21T03:22:08+00:00
---
# [Live Block Device Operations](live-block-operations.md#id2)
...
- [Live Block Device Operations](live-block-operations.md#live-block-device-operations)
  ...
  - [Live block streaming — `block-stream`](live-block-operations.md#live-block-streaming-block-stream)
    ...
    - [QMP invocation for `block-stream`](live-block-operations.md#qmp-invocation-for-block-stream)
  - [Live block commit — `block-commit`](live-block-operations.md#live-block-commit-block-commit)

    - [QMP invocation for `block-commit`](live-block-operations.md#qmp-invocation-for-block-commit)
  - [Live disk synchronization — `drive-mirror` and `blockdev-mirror`](live-block-operations.md#live-disk-synchronization-drive-mirror-and-blockdev-mirror)
    ...
    - [QMP invocation for `drive-mirror`](live-block-operations.md#qmp-invocation-for-drive-mirror)
    - [QMP invocation for live storage migration with `drive-mirror` + NBD](live-block-operations.md#qmp-invocation-for-live-storage-migration-with-drive-mirror-nbd)
    - [Notes on `blockdev-mirror`](live-block-operations.md#notes-on-blockdev-mirror)
    - [QMP invocation for `blockdev-mirror`](live-block-operations.md#qmp-invocation-for-blockdev-mirror)
  - [Live disk backup — `blockdev-backup` and the deprecated `drive-backup`](live-block-operations.md#live-disk-backup-blockdev-backup-and-the-deprecated-drive-backup)
    ...
    - [QMP invocation for `drive-backup`](live-block-operations.md#qmp-invocation-for-drive-backup)
    - [Moving from the deprecated `drive-backup` to newer `blockdev-backup`](live-block-operations.md#moving-from-the-deprecated-drive-backup-to-newer-blockdev-backup)
    - [Notes on `blockdev-backup`](live-block-operations.md#notes-on-blockdev-backup)
    - [QMP invocation for `blockdev-backup`](live-block-operations.md#qmp-invocation-for-blockdev-backup)

## [Disk image backing chain notation](live-block-operations.md#id3)
...
## [Brief overview of live block QMP primitives](live-block-operations.md#id4)
...
1. `block-stream`: Live copy of data from backing files into overlay
   ...
   > **Note:**
   >
   > Once the ‘stream’ operation has finished, three things to
   > note:
   >
   > > 1. QEMU rewrites the backing chain to remove
   > >    reference to the now-streamed and redundant backing
   > >    file;
   > > 2. the streamed file *itself* won’t be removed by QEMU,
   > >    and must be explicitly discarded by the user;
   > > 3. the streamed file remains valid – i.e. further
...
2. `block-commit`: Live merge of data from overlay files into backing
   ...
   > **Note:**
   >
   > Once the ‘commit’ operation has finished, there are three
   > things to note here as well:
   >
   > > 1. QEMU rewrites the backing chain to remove reference
   > >    to now-redundant overlay images that have been
   > >    committed into a backing file;
   > > 2. the committed file *itself* won’t be removed by QEMU
   > >    – it ought to be manually removed;
   > > 3. however, unlike in the case of `block-stream`, the
...
## [Interacting with a QEMU instance](live-block-operations.md#id5)
...
## [Example disk image chain](live-block-operations.md#id6)
...
## [A note on points-in-time vs file names](live-block-operations.md#id7)
...
## [Live block streaming — `block-stream`](live-block-operations.md#id8)
...
### [QMP invocation for `block-stream`](live-block-operations.md#id9)

For [Case-1](live-block-operations.md#case-1), to merge contents of all the backing files into the
...
For [Case-2](live-block-operations.md#case-2), merge contents of the images [B] and [C] into [D], where
...
And for [Case-3](live-block-operations.md#case-3), of “intermediate” streaming”, merge contents of
...
## [Live block commit — `block-commit`](live-block-operations.md#id10)
...
### [QMP invocation for `block-commit`](live-block-operations.md#id11)

For [Case-1](live-block-operations.md#block-commit-case-1), to merge contents only from
...
However, [Case-3](live-block-operations.md#block-commit-case-3) (also called: “active
...
The following is the flow for [Case-3](live-block-operations.md#block-commit-case-3) to
...
## [Live disk synchronization — `drive-mirror` and `blockdev-mirror`](live-block-operations.md#id12)
...
3. `none` – Synchronize only the new writes from this point on.
   ...
   > **Note:**
   >
   > In the case of `blockdev-backup` (or deprecated
...
> **Note:**
>
> Refer to the [Dirty Bitmaps and Incremental Backup](bitmaps.md) document in the QEMU source
> tree to learn about the detailed workings of the `incremental`
> synchronization mode.

### [QMP invocation for `drive-mirror`](live-block-operations.md#id13)
...
1. Create a point-in-time snapshot by ending the synchronization. The
   ...
   ```
2. Or, complete the operation and pivot the live QEMU to the target
   copy:
...
### [QMP invocation for live storage migration with `drive-mirror` + NBD](live-block-operations.md#id14)
...
– discussed in the section: [Interacting with a QEMU instance](live-block-operations.md#interacting-with-a-qemu-instance))
...
### [Notes on `blockdev-mirror`](live-block-operations.md#id15)
...
### [QMP invocation for `blockdev-mirror`](live-block-operations.md#id16)
...
## [Live disk backup — `blockdev-backup` and the deprecated `drive-backup`](live-block-operations.md#id17)
...
### [QMP invocation for `drive-backup`](live-block-operations.md#id18)
...
### [Moving from the deprecated `drive-backup` to newer `blockdev-backup`](live-block-operations.md#id19)
...
### [Notes on `blockdev-backup`](live-block-operations.md#id20)
...
### [QMP invocation for `blockdev-backup`](live-block-operations.md#id21)
