...
collection: qemu
version: "11.1.0"
title: "Parallels Disk Format"
source_url: https://www.qemu.org/docs/master/interop/prl-xml.html
fetched_at: 2026-08-21T03:22:11+00:00
---
...
- `Blocksize` - storage cluster size, number of sectors per one cluster.
  ...
  its header (see [Parallels Expandable Image File Format](parallels.md)).
