...
collection: qemu
version: "11.1.0"
title: "Load and Store APIs"
source_url: https://www.qemu.org/docs/master/devel/loads-stores.html
fetched_at: 2026-08-21T03:25:50+00:00
---
# Load and Store APIs
...
function, which is a return address into the generated code[[1]](loads-stores.md#gpc).

[[1](loads-stores.md#id1)]

Note that `GETPC()` should be used with great care: calling
