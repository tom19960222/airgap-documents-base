...
source_url: https://www.qemu.org/docs/master/devel/conflict-resolution.html
fetched_at: 2026-08-21T03:25:19+00:00
---
...
leadership committee by sending an email to [qemu@sfconservancy.org](mailto:qemu%40sfconservancy.org), providing
references to the misconduct.
For very urgent topics, you can also inform one or more members through IRC.
The up-to-date list of members is [available on the QEMU wiki](https://wiki.qemu.org/Conservancy).
...
Policy and Process](https://www.drupal.org/conflict-resolution)
and the [Mozilla Consequence Ladder](https://github.com/mozilla/diversity/blob/master/code-of-conduct-enforcement/consequence-ladder.md)
