...
version: "11.1.0"
title: "Postcopy"
source_url: https://www.qemu.org/docs/master/devel/migration/postcopy.html
fetched_at: 2026-08-21T03:26:34+00:00
---
# [Postcopy](postcopy.md#id1)

Contents

- [Postcopy](postcopy.md#postcopy)

  - [Enabling postcopy](postcopy.md#enabling-postcopy)
  - [Postcopy internals](postcopy.md#postcopy-internals)

    - [State machine](postcopy.md#state-machine)
    - [Device transfer](postcopy.md#device-transfer)
    - [Source behaviour](postcopy.md#source-behaviour)
    - [Destination behaviour](postcopy.md#destination-behaviour)
    - [Source side page bitmap](postcopy.md#source-side-page-bitmap)
  - [Postcopy features](postcopy.md#postcopy-features)

    - [Postcopy recovery](postcopy.md#postcopy-recovery)
    - [Postcopy with hugepages](postcopy.md#postcopy-with-hugepages)
    - [Postcopy with shared memory](postcopy.md#postcopy-with-shared-memory)
    - [Postcopy preemption mode](postcopy.md#postcopy-preemption-mode)
    - [Postcopy blocktime statistics](postcopy.md#postcopy-blocktime-statistics)
...
## [Enabling postcopy](postcopy.md#id2)
...
## [Postcopy internals](postcopy.md#id3)

### [State machine](postcopy.md#id4)
...
### [Device transfer](postcopy.md#id5)
...
### [Source behaviour](postcopy.md#id6)
...
### [Destination behaviour](postcopy.md#id7)
...
### [Source side page bitmap](postcopy.md#id8)
...
## [Postcopy features](postcopy.md#id9)

### [Postcopy recovery](postcopy.md#id10)
...
### [Postcopy with hugepages](postcopy.md#id11)

Postcopy now works with hugetlbfs backed memory:

> 1. The linux kernel on the destination must support userfault on hugepages.
> 2. The huge-page configuration on the source and destination VMs must be
>    identical; i.e. RAMBlocks on both sides must use the same page size.
> 3. Note that `-mem-path /dev/hugepages` will fall back to allocating normal
>    RAM if it doesn’t have enough hugepages, triggering (b) to fail.
>    Using `-mem-prealloc` enforces the allocation using hugepages.
> 4. Care should be taken with the size of hugepage used; postcopy with 2MB
>    hugepages works well, however 1GB hugepages are likely to be problematic
>    since it takes ~1 second to transfer a 1GB hugepage across a 10Gbps link,
>    and until the full page is transferred the destination thread is blocked.

### [Postcopy with shared memory](postcopy.md#id12)
...
> :   1. Some way to make QEMU ignorant of the addresses in the clients
>        address space
>     2. Avoiding the need for QEMU to perform ufd-wake calls after the
>        pages have arrived

Retro-fitting postcopy to existing clients is possible:
:   1. A mechanism is needed for the registration with userfault as above,
       ...
       control channel.
    2. Any thread that can block due to guest memory accesses must be
       identified and the implication understood; for example if the
       guest memory access is made while holding a lock then all other
       threads waiting for that lock will also be blocked.

### [Postcopy preemption mode](postcopy.md#id13)
...
### [Postcopy blocktime statistics](postcopy.md#id14)
