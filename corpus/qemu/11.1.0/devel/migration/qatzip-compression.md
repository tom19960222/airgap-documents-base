...
collection: qemu
version: "11.1.0"
title: "QATzip Compression"
source_url: https://www.qemu.org/docs/master/devel/migration/qatzip-compression.html
fetched_at: 2026-08-21T03:26:42+00:00
---
# QATzip Compression
...
For more `QATzip` introduction, please refer to [QATzip Introduction](https://github.com/intel/QATzip?tab=readme-ov-file#introductionl)
...
use the source code to build and install, please refer to [QATzip source code installation](https://github.com/intel/QATzip?tab=readme-ov-file#build-intel-quickassist-technology-driver)
...
For more `QAT` hardware introduction, please refer to [intel-quick-assist-technology-overview](https://www.intel.com/content/www/us/en/architecture-and-technology/intel-quick-assist-technology-overview.html)
...
Driver Queries](https://intel.github.io/quickassist/PG/infrastructure_debugability.html?highlight=memory)
for memory usage calculation.

An example of a PF used for migration

| Number of channels | Sender memory usage | Receiver memory usage |
| --- | --- | --- |
| 2 | 10M | 10M |
| 4 | 12M | 14M |
| 8 | 16M | 20M |
