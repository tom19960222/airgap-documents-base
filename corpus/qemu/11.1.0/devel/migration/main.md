...
source_url: https://www.qemu.org/docs/master/devel/migration/main.html
fetched_at: 2026-08-21T03:23:46+00:00
---
# [Migration framework](main.md#id1)
...
- [Migration framework](main.md#migration-framework)
  ...
  - [Saving the state of one device](main.md#saving-the-state-of-one-device)
    ...
    - [General advice for device developers](main.md#general-advice-for-device-developers)
    - [VMState](main.md#vmstate)
    - [Legacy way](main.md#legacy-way)
    - [Changing migration data structures](main.md#changing-migration-data-structures)
    - [Subsections](main.md#subsections)
    - [Connecting subsections to properties](main.md#connecting-subsections-to-properties)
    - [Not sending existing elements](main.md#not-sending-existing-elements)
    - [Versions](main.md#versions)
    - [Massaging functions](main.md#massaging-functions)
    - [Iterative device migration](main.md#iterative-device-migration)
    - [Device ordering](main.md#device-ordering)
  - [Stream structure](main.md#stream-structure)

    - [Return path](main.md#return-path)

## [Transports](main.md#id2)
...
## [Common infrastructure](main.md#id3)

The files, sockets or fd’s that carry the migration stream are abstracted by
the `QEMUFile` type (see `migration/qemu-file.h`). In most cases this
is connected to a subtype of `QIOChannel` (see `io/`).

## [Saving the state of one device](main.md#id4)
...
### [General advice for device developers](main.md#id5)
...
### [Changing migration data structures](main.md#id8)
...
### [Connecting subsections to properties](main.md#id10)
...
> 1. Add a new property using `DEFINE_PROP_BOOL` - e.g. support-foo and
>    default it to true.
> 2. Add an entry to the `hw_compat_` for the previous version that sets
>    the property to false.
> 3. Add a static bool support_foo function that tests the property.
> 4. Add a subsection with a .needed set to the support_foo function
> 5. (potentially) Add an outer pre_load that sets up a default value
...
### [Not sending existing elements](main.md#id11)
...
> 1. Add a new property/compatibility/function in the same way for subsections above.
> 2. replace the VMSTATE macro with the _TEST version of the macro, e.g.:
>
...
### [Massaging functions](main.md#id13)
...
### [Iterative device migration](main.md#id14)
