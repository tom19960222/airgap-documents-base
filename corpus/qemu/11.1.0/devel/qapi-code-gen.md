...
collection: qemu
version: "11.1.0"
title: "How to use the QAPI code generator"
source_url: https://www.qemu.org/docs/master/devel/qapi-code-gen.html
fetched_at: 2026-08-21T03:25:16+00:00
---
...
schema](qapi-code-gen.md#configuring-the-schema) below for more on this.

The optional ‘features’ member specifies features. See [Features](qapi-code-gen.md#features)
...
The form [TYPE-REF](qapi-code-gen.md#type-ref) is shorthand for `{ 'type': TYPE-REF }`.
...
the schema](qapi-code-gen.md#configuring-the-schema) below for more on this.
...
The ‘base’ member defines the common members. If it is a [MEMBERS](qapi-code-gen.md#members)
...
type. The type must a struct type. The form [TYPE-REF](qapi-code-gen.md#type-ref) is shorthand
for `{ 'type': TYPE-REF }`.
...
Member ‘data’ defines the arguments. It defaults to an empty [MEMBERS](qapi-code-gen.md#members)
object.

If ‘data’ is a [MEMBERS](qapi-code-gen.md#members) object, then MEMBERS defines arguments just
...
section [Code generated for commands](qapi-code-gen.md#code-generated-for-commands) for examples.
...
See the [QEMU Machine Protocol Specification](../interop/qmp-spec.md) for out-of-band execution syntax
and semantics.
...
empty [MEMBERS](qapi-code-gen.md#members) object.

If ‘data’ is a [MEMBERS](qapi-code-gen.md#members) object, then MEMBERS defines event-specific
...
order. Else it takes them wrapped in the C struct generated for the
complex type. See section [Code generated for events](qapi-code-gen.md#code-generated-for-events) for examples.
...
explained in section [Client JSON Protocol introspection](qapi-code-gen.md#client-json-protocol-introspection).
...
section [Downstream extensions](qapi-code-gen.md#downstream-extensions)) start with underscore.
...
See [Pragma directives](qapi-code-gen.md#pragma-directives) for details.
...
requires the longhand form of [ENUM-VALUE](qapi-code-gen.md#enum-value).
...
form of [FEATURE](qapi-code-gen.md#feature).
...
See below for more on [Definition documentation](qapi-code-gen.md#definition-documentation).
...
ambiguous, you can use [QAPI cross-reference roles](qapi-domain.md#qapi-domain-cross-references) to disambiguate.
...
When documentation is required (see [pragma](qapi-code-gen.md#pragma) ‘doc-required’), every
...
Example: the SchemaInfo for EVENT_C from section [Events](qapi-code-gen.md#events)
...
Example: the SchemaInfo for MyType from section [Struct types](qapi-code-gen.md#struct-types)
...
Example: the SchemaInfo for TestType from section [Features](qapi-code-gen.md#features):
...
Example: the SchemaInfo for BlockdevRef from section [Alternate types](qapi-code-gen.md#alternate-types)
...
Example: the SchemaInfo for MyEnum from section [Enumeration types](qapi-code-gen.md#enumeration-types)
...
the QAPI schema (see section [Built-in Types](qapi-code-gen.md#built-in-types)), with one exception
...
For a modular QAPI schema (see section [Include directives](qapi-code-gen.md#include-directives)), code for
...
> :   Trace event declarations, see [Tracing](tracing.md#tracing).
>
