...
source_url: https://www.qemu.org/docs/master/devel/qom.html
fetched_at: 2026-08-21T03:23:43+00:00
---
...
`info qom-tree` in the [QEMU Monitor](../system/monitor.md#qemu-monitor). It will contain both
...
can be found at [Device Life-cycle](qom.md#device-life-cycle).
...
See the [QOM API](qom-api.md#qom-api) and [QDEV API](qdev-api.md#qdev-api)
