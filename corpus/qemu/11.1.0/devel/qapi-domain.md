...
collection: qemu
version: "11.1.0"
title: "The Sphinx QAPI Domain"
source_url: https://www.qemu.org/docs/master/devel/qapi-domain.html
fetched_at: 2026-08-21T03:25:38+00:00
---
# The Sphinx QAPI Domain

An extension to the [rST syntax](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html)
in Sphinx is provided by the QAPI Domain, located in
`docs/sphinx/qapi_domain.py`. This extension is analogous to the
[Python Domain](https://www.sphinx-doc.org/en/master/usage/domains/python.html)
included with Sphinx, but provides special directives and roles
for annotating and documenting QAPI definitions
specifically.

A [Domain](https://www.sphinx-doc.org/en/master/usage/domains/index.html)
...
markup written by hand; the [autodoc](https://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html)
...
[Field lists](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html#field-lists)
are a standard syntax in reStructuredText. Sphinx [extends that syntax](https://www.sphinx-doc.org/en/master/usage/domains/python.html#info-field-lists)
...
availability:
:   This field list is available in the body of Command,
...
type:
:   [sphinx.util.docfields.GroupedField](https://pydoc.dev/sphinx/latest/sphinx.util.docfields.GroupedField.html?private=1)
...
availability:
:   This field list is only available in the body of the
    Command directive.
...
type:
:   [sphinx.util.docfields.TypedField](https://pydoc.dev/sphinx/latest/sphinx.util.docfields.TypedField.html?private=1)
...
type:
:   [sphinx.util.docfields.Field](https://pydoc.dev/sphinx/latest/sphinx.util.docfields.Field.html?private=1)
...
availability:
:   This field list is only available in the body of the Enum
    directive.
...
availability:
:   This field list is available in the body of Event or
    Object directives.
...
Cross-reference [roles](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html)
in the QAPI domain are modeled closely after the [Python
cross-referencing syntax](https://www.sphinx-doc.org/en/master/usage/domains/python.html#cross-referencing-python-objects).

QAPI definitions can be referenced using the standard [any](https://www.sphinx-doc.org/en/master/usage/referencing.html#role-any)
...
`[`[`QMP:Qcow2BitmapInfoFlags`](../interop/qemu-qmp-ref.md#enum-QMP-block-core.Qcow2BitmapInfoFlags "QMP:block-core.Qcow2BitmapInfoFlags")`]`
...
[`QMP:BitmapSyncMode`](../interop/qemu-qmp-ref.md#enum-QMP-block-core.BitmapSyncMode "QMP:block-core.BitmapSyncMode"), *optional*

### Namespaces

Mimicking the [Python domain target specification syntax](https://www.sphinx-doc.org/en/master/usage/domains/python.html#target-specification),
...
- A module can be explicitly provided;
  ...
  [`QMP:block-core.BitmapSyncMode`](../interop/qemu-qmp-ref.md#enum-QMP-block-core.BitmapSyncMode "QMP:block-core.BitmapSyncMode")
- If you don’t want to display the “fully qualified” name, it can be
  ...
  will render to: [`BitmapSyncMode`](../interop/qemu-qmp-ref.md#enum-QMP-block-core.BitmapSyncMode "QMP:block-core.BitmapSyncMode")
...
[most stock Sphinx references](https://www.sphinx-doc.org/en/master/usage/referencing.html#syntax)
using the `custom text <target>` syntax.

For example, `` :qapi:cmd:`Merge dirty bitmaps
<block-dirty-bitmap-merge>` `` will render as: [`Merge dirty
bitmaps`](../interop/qemu-qmp-ref.md#command-QMP-block-core.block-dirty-bitmap-merge "QMP:block-core.block-dirty-bitmap-merge")
...
All QAPI directives inherit a number of [standard options](https://www.sphinx-doc.org/en/master/usage/domains/index.html#basic-markup)
...
:   This event is deprecated.
    ...
    Members:
    :   - **reason** (`string`) – Diagnostics as to what caused your computer to
          be ruined.

    Features:
    :   - **sadness** – When present, the diagnostic message will also explain
...
:   This object has a bunch of disparate and unrelated things in it.
    ...
    Members:
    :   - **Birthday** (`int`) – Your birthday, represented in seconds since the
          UNIX epoch.
        - **Fav-Foods** (`[``string``]`) – A list of your favorite foods.
        - **Bizarre-Docs** (`boolean`, *optional*) – True if the documentation reference
          should be strange.
...
:   This alternate represents an Error Code from the VM.
    ...
    :   - **ec** (`int`) – An error code, like the type you’re used to.
        - **em** (`string`) – An expletive-laced error message, if your
          computer is feeling particularly cranky and tired of your
          antics.
