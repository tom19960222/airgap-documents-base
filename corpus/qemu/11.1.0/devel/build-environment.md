...
source_url: https://www.qemu.org/docs/master/devel/build-environment.html
fetched_at: 2026-08-21T03:23:51+00:00
---
...
| --- | --- | --- |
| Fedora | `sudo dnf update && sudo dnf builddep qemu` |  |
| Debian/Ubuntu | `sudo apt update && sudo apt build-dep qemu` | Must enable [Sources List](https://wiki.debian.org/SourcesList) first |
| MacOS | `brew update && brew install $(brew deps --include-build qemu)` | Using [Homebrew](https://brew.sh/). |

### Windows

You first need to install [MSYS2](https://www.msys2.org/).
MSYS2 offers [different environments](https://www.msys2.org/docs/environments/).
