...
version: "11.1.0"
title: "Rust in QEMU"
source_url: https://www.qemu.org/docs/master/devel/rust.html
fetched_at: 2026-08-21T03:26:58+00:00
---
# Rust in QEMU
...
from `SysBusDevice` in [\*safe\*](https://doc.rust-lang.org/nomicon/meet-safe-and-unsafe.html) Rust. Later, it may become possible
...
- by invoking `cargo` through the Meson [development environment](https://mesonbuild.com/Commands.html#devenv)
  feature:
...
- associated constants are still explicitly marked `'static` ([changed in
  1.81.0](https://github.com/rust-lang/rust/pull/125258))
...
- `pl011` (under `rust/hw/char/pl011`) and `hpet` (under `rust/hw/timer/hpet`)
  ...
  used to further develop them. These two crates are functional[[1]](rust.md#issues) replacements
  for the `hw/char/pl011.c` and `hw/timer/hpet.c` files.

[[1](rust.md#id4)]

The `pl011` crate is synchronized with `hw/char/pl011.c`
...
These rules can be tested with [MIRI](https://github.com/rust-lang/miri), for example.
