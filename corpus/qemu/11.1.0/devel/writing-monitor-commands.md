...
collection: qemu
version: "11.1.0"
title: "How to write monitor commands"
source_url: https://www.qemu.org/docs/master/devel/writing-monitor-commands.html
fetched_at: 2026-08-21T03:26:17+00:00
---
...
[How to use the QAPI code generator](qapi-code-gen.md). For the QMP protocol, see the
...
unstructured text](writing-monitor-commands.md#writing-a-debugging-aid-returning-unstructured-text) section for further guidance on commands that
...
1. Optional arguments other than pointers are accompanied by a ‘has_’
...
[Writing a debugging aid returning unstructured text](writing-monitor-commands.md#writing-a-debugging-aid-returning-unstructured-text) section for
an illustration.
...
As discussed in section [Modelling data in QAPI](writing-monitor-commands.md#modelling-data-in-qapi), it is required that
