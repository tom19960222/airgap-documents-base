...
source_url: https://www.qemu.org/docs/master/devel/testing/main.html
fetched_at: 2026-08-21T03:25:40+00:00
---
# Testing in QEMU
...
report their success or failure [[1]](main.md#id10).
...
[QTest Device Emulation Testing Framework](qtest.md) for more details.
...
for testing TCG. See [Testing with “make check-tcg”](main.md#checktcg-ref) for more details.
...
behavior errors, and initialization and termination errors [[3]](main.md#id12).
...
See [Functional testing with Python](functional.md#checkfunctional-ref) for more details.
...
See [Container based tests](main.md#container-ref) for more details.
...
Pressman, Roger S. & Maxim, Bruce R. (2020). Software Engineering,
...
Luo, Qingzhou, et al. An empirical analysis of flaky tests.
