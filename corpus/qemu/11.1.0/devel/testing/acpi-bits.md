...
collection: qemu
version: "11.1.0"
title: "ACPI/SMBIOS testing using biosbits"
source_url: https://www.qemu.org/docs/master/devel/testing/acpi-bits.html
fetched_at: 2026-08-21T03:25:43+00:00
---
...
[here](https://github.com/biosbits/bits/tree/master). It is a software that
...
in 2011](https://blog.linuxplumbersconf.org/2011/ocw/system/presentations/867/original/bits.pdf) and [at Linux.conf.au in 2012](https://www.youtube.com/watch?v=36QIepyUuhg).

For QEMU, we maintain a fork of bios bits in [gitlab](https://gitlab.com/qemu-project/biosbits-bits), along with all
...
author’s FOSDEM presentation](https://fosdem.org/2024/schedule/event/fosdem-2024-2262-exercising-qemu-generated-acpi-smbios-tables-using-biosbits-from-within-a-guest-vm-/) on this bios-bits based test framework.
...
- `tests/functional/acpi-bits/bits-tests`:
  ...
  > 2. They are run from within the bios bits VM and is not subjected to QEMU
  >    build/test python script maintenance and dependency resolutions.
  > 3. They need not be loaded by the test framework by accident when running
  >    tests.

Author: Ani Sinha <[anisinha@redhat.com](mailto:anisinha%40redhat.com)>
