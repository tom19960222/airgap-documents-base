...
collection: qemu
version: "11.1.0"
title: "Block I/O error injection using blkdebug"
source_url: https://www.qemu.org/docs/master/devel/testing/blkdebug.html
fetched_at: 2026-08-21T03:25:46+00:00
---
...
:   which type of operation to match (e.g. `read_aio`, `write_aio`,
    `flush_to_os`, `flush_to_disk`). See [Events](blkdebug.md#events) for
    information on events.

`state`
:   (optional) the engine must be in this state number in order for this
    rule to match. See [State transitions](blkdebug.md#state-transitions) for information
    on states.
