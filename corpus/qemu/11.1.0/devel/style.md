...
source_url: https://www.qemu.org/docs/master/devel/style.html
fetched_at: 2026-08-21T03:23:41+00:00
---
# [QEMU Coding Style](style.md#id1)

Table of Contents

- [QEMU Coding Style](style.md#qemu-coding-style)

  - [Formatting and style](style.md#formatting-and-style)

    - [Whitespace](style.md#whitespace)

      - [Multiline Indent](style.md#multiline-indent)
    - [Line width](style.md#line-width)
    - [Naming](style.md#naming)

      - [Variable Naming Conventions](style.md#variable-naming-conventions)
      - [Function Naming Conventions](style.md#function-naming-conventions)
    - [Block structure](style.md#block-structure)
    - [Declarations](style.md#declarations)
    - [Conditional statements](style.md#conditional-statements)
    - [Comment style](style.md#comment-style)
  - [Language usage](style.md#language-usage)

    - [Preprocessor](style.md#preprocessor)

      - [Variadic macros](style.md#variadic-macros)
      - [Include directives](style.md#include-directives)
      - [Generative Includes](style.md#generative-includes)
    - [C types](style.md#c-types)

      - [Scalars](style.md#scalars)
      - [Pointers](style.md#pointers)
      - [Typedefs](style.md#typedefs)
      - [Bitfields](style.md#bitfields)
      - [Reserved namespaces in C and POSIX](style.md#reserved-namespaces-in-c-and-posix)
    - [Low level memory management](style.md#low-level-memory-management)
    - [String manipulation](style.md#string-manipulation)
    - [Printf-style functions](style.md#printf-style-functions)
    - [C standard, implementation defined and undefined behaviors](style.md#c-standard-implementation-defined-and-undefined-behaviors)
    - [Automatic memory deallocation](style.md#automatic-memory-deallocation)
  - [QEMU Specific Idioms](style.md#qemu-specific-idioms)

    - [QEMU Object Model Declarations](style.md#qemu-object-model-declarations)
    - [QEMU GUARD macros](style.md#qemu-guard-macros)
    - [Error handling and reporting](style.md#error-handling-and-reporting)

      - [Reporting errors to the human user](style.md#reporting-errors-to-the-human-user)
      - [Propagating errors](style.md#propagating-errors)
      - [Handling errors](style.md#handling-errors)
    - [trace-events style](style.md#trace-events-style)

      - [0x prefix](style.md#x-prefix)
      - [‘#’ printf flag](style.md#printf-flag)

Please use the script checkpatch.pl in the scripts directory to check
patches before submitting.

## [Formatting and style](style.md#id2)
...
#### [Variable Naming Conventions](style.md#id7)
...
#### [Function Naming Conventions](style.md#id8)
...
### [Conditional statements](style.md#id11)
...
## [Language usage](style.md#id13)

### [Preprocessor](style.md#id14)

#### [Variadic macros](style.md#id15)
...
#### [Include directives](style.md#id16)
...
#### [Generative Includes](style.md#id17)
...
### [C types](style.md#id18)

It should be common sense to use the right type, but we have collected
a few useful guidelines here.

#### [Scalars](style.md#id19)
...
#### [Bitfields](style.md#id22)

C bitfields can be a cause of non-portability issues, especially under windows
where [MSVC has a different way to lay them out than GCC](https://gcc.gnu.org/onlinedocs/gcc/x86-Type-Attributes.html), or where
endianness matters.
...
#### [Reserved namespaces in C and POSIX](style.md#id23)

Underscore capital, double underscore, and underscore ‘t’ suffixes should be
avoided.

### [Low level memory management](style.md#id24)
...
by using `g_autofree` and related annotations. See [Automatic memory deallocation](style.md#autofree-ref)
for more details.
...
### [String manipulation](style.md#id25)
...
### [Printf-style functions](style.md#id26)
...
### [C standard, implementation defined and undefined behaviors](style.md#id27)
...
### [Automatic memory deallocation](style.md#id28)
...
## [QEMU Specific Idioms](style.md#id29)

### [QEMU Object Model Declarations](style.md#id30)
...
See [The QEMU Object Model (QOM)](qom.md#qom) for more details.

### [QEMU GUARD macros](style.md#id31)
...
### [Error handling and reporting](style.md#id32)

#### [Reporting errors to the human user](style.md#id33)
...
#### [Propagating errors](style.md#id34)
...
### [trace-events style](style.md#id36)

#### [0x prefix](style.md#id37)
