...
collection: qemu
version: "11.1.0"
title: "Decodetree Specification"
source_url: https://www.qemu.org/docs/master/devel/decodetree.html
fetched_at: 2026-08-21T03:26:26+00:00
---
...
| `%sz_imm 10:2 sz:3 !function=expand_sz_imm` | ``` expand_sz_imm(extract(i, 10, 2) << 3 |               extract(a->sz, 0, 3)) ``` |
