...
collection: qemu
version: "11.1.0"
title: "Locked Counters (aka QemuLockCnt )"
source_url: https://www.qemu.org/docs/master/devel/lockcnt.html
fetched_at: 2026-08-21T03:25:51+00:00
---
...
- on some platforms, one can implement `QemuLockCnt` to hold the lock
  ...
  [Atomic operations in QEMU](atomics.md)). This can be very helpful if concurrent access to
