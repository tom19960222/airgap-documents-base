...
version: "11.1.0"
title: "Disk Images"
source_url: https://www.qemu.org/docs/master/system/images.html
fetched_at: 2026-08-21T03:21:29+00:00
---
# Disk Images
...
disk images by using the `commit` monitor command (or `Ctrl+a s` in the
serial console).
...
([Snapshot mode](images.md#disk-005fimages-005fsnapshot-005fmode)),
