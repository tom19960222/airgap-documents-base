...
collection: qemu
version: "11.1.0"
title: "Boot devices on s390x"
source_url: https://www.qemu.org/docs/master/system/s390x/bootdevices.html
fetched_at: 2026-08-21T03:24:57+00:00
---
...
configuration files. See the [PXELINUX Configuration page](https://wiki.syslinux.org/wiki/index.php?title=PXELINUX#Configuration)
for details how to set up the configuration file on your TFTP server.
The supported configuration file entries are `DEFAULT`, `LABEL`,
`KERNEL`, `INITRD` and `APPEND` (see the [Syslinux Config file syntax](https://wiki.syslinux.org/wiki/index.php?title=Config) for more
information).
