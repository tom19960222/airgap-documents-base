...
collection: qemu
version: "11.1.0"
title: "Adjunct Processor (AP) Device"
source_url: https://www.qemu.org/docs/master/system/s390x/vfio-ap.html
fetched_at: 2026-08-21T03:24:52+00:00
---
# [Adjunct Processor (AP) Device](vfio-ap.md#id1)

Contents

- [Adjunct Processor (AP) Device](vfio-ap.md#adjunct-processor-ap-device)

  - [Introduction](vfio-ap.md#introduction)
  - [AP Architectural Overview](vfio-ap.md#ap-architectural-overview)
  - [Start Interpretive Execution (SIE) Instruction](vfio-ap.md#start-interpretive-execution-sie-instruction)

    - [Example 1: Valid configuration](vfio-ap.md#example-1-valid-configuration)
    - [Example 2: Valid configuration](vfio-ap.md#example-2-valid-configuration)
    - [Example 3: Invalid configuration](vfio-ap.md#example-3-invalid-configuration)
  - [AP Matrix Configuration on Linux Host](vfio-ap.md#ap-matrix-configuration-on-linux-host)

    - [Binding AP devices to device drivers](vfio-ap.md#binding-ap-devices-to-device-drivers)
    - [Configuring an AP matrix for a linux guest](vfio-ap.md#configuring-an-ap-matrix-for-a-linux-guest)
    - [Starting a Linux Guest Configured with an AP Matrix](vfio-ap.md#starting-a-linux-guest-configured-with-an-ap-matrix)
    - [Hot plug a vfio-ap device into a running guest](vfio-ap.md#hot-plug-a-vfio-ap-device-into-a-running-guest)
    - [Hot unplug a vfio-ap device from a running guest](vfio-ap.md#hot-unplug-a-vfio-ap-device-from-a-running-guest)
  - [Example: Configure AP Matrices for Three Linux Guests](vfio-ap.md#example-configure-ap-matrices-for-three-linux-guests)
  - [Limitations](vfio-ap.md#limitations)

## [Introduction](vfio-ap.md#id2)
...
## [AP Architectural Overview](vfio-ap.md#id3)
...
## [Start Interpretive Execution (SIE) Instruction](vfio-ap.md#id4)
...
### [Example 1: Valid configuration](vfio-ap.md#id5)
...
### [Example 2: Valid configuration](vfio-ap.md#id6)
...
### [Example 3: Invalid configuration](vfio-ap.md#id7)
...
## [AP Matrix Configuration on Linux Host](vfio-ap.md#id8)
...
### [Binding AP devices to device drivers](vfio-ap.md#id9)
...
### [Configuring an AP matrix for a linux guest](vfio-ap.md#id10)
...
### [Starting a Linux Guest Configured with an AP Matrix](vfio-ap.md#id11)
...
### [Hot plug a vfio-ap device into a running guest](vfio-ap.md#id12)
...
### [Hot unplug a vfio-ap device from a running guest](vfio-ap.md#id13)
...
## [Example: Configure AP Matrices for Three Linux Guests](vfio-ap.md#id14)
...
- Dynamically assigning AP resources to or unassigning AP resources from a
  mediated matrix device - see [Configuring an AP matrix for a linux guest](vfio-ap.md#configuring-an-ap-matrix-for-a-linux-guest)
...
- Live guest migration is not supported for guests using AP devices. If a guest
  ...
  running guest](vfio-ap.md#hot-unplug-a-vfio-ap-device-from-a-running-guest) section above.)
