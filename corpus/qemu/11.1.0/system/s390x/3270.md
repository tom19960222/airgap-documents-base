...
version: "11.1.0"
title: "3270 devices"
source_url: https://www.qemu.org/docs/master/system/s390x/3270.html
fetched_at: 2026-08-21T03:24:54+00:00
---
# 3270 devices

The 3270 is the classic ‘green-screen’ console of the mainframes (see the
[IBM 3270 Wikipedia article](https://en.wikipedia.org/wiki/IBM_3270)).

The 3270 data stream is not implemented within QEMU; the device only provides
TN3270 (a telnet extension; see [RFC 854](https://tools.ietf.org/html/rfc854)
and [RFC 1576](https://tools.ietf.org/html/rfc1576)) and leaves the heavy
