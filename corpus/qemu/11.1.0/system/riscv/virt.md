...
source_url: https://www.qemu.org/docs/master/system/riscv/virt.html
fetched_at: 2026-08-21T03:24:50+00:00
---
...
Refer to [RISC-V IOMMU support for RISC-V machines](../../specs/riscv-iommu.md#riscv-iommu) for more information on how the RISC-V IOMMU support
works.
...
- aia=[none|aplic|aplic-imsic]
  ...
  the irqchip. See [RISC-V AIA support for RISC-V machines](../../specs/riscv-aia.md#riscv-aia) for more details on all available AIA
  modes.
- aia-guests=nnn
