...
version: "11.1.0"
title: "CanoKey QEMU"
source_url: https://www.qemu.org/docs/master/system/devices/canokey.html
fetched_at: 2026-08-21T03:23:12+00:00
---
# CanoKey QEMU

CanoKey [[1]](canokey.md#id8) is an open-source secure key with supports of

- U2F / FIDO2 with Ed25519 and HMAC-secret
- OpenPGP Card V3.4 with RSA4096, Ed25519 and more [[2]](canokey.md#id9)
- PIV (NIST SP 800-73-4)
- HOTP / TOTP
- NDEF

All these platform-independent features are in canokey-core [[3]](canokey.md#id10).

For different platforms, CanoKey has different implementations,
including both hardware implementations and virtual cards:

- CanoKey STM32 [[4]](canokey.md#id11)
- CanoKey Pigeon [[5]](canokey.md#id12)
...
You may setup the key as guided in [[6]](canokey.md#id13). The console for the key is at [[7]](canokey.md#id14).
