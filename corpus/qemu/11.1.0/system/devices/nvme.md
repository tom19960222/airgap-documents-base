...
collection: qemu
version: "11.1.0"
title: "NVMe Emulation"
source_url: https://www.qemu.org/docs/master/system/devices/nvme.html
fetched_at: 2026-08-21T03:23:21+00:00
---
# NVMe Emulation
...
> - [Adding NVMe Devices](nvme.md#adding-nvme-devices), [additional namespaces](nvme.md#additional-namespaces) and [NVM subsystems](nvme.md#nvm-subsystems).
> - Configuration of [Optional Features](nvme.md#optional-features) such as [Controller Memory Buffer](nvme.md#controller-memory-buffer),
>   [Simple Copy](nvme.md#simple-copy), [Zoned Namespaces](nvme.md#zoned-namespaces), [metadata](nvme.md#metadata) and [End-to-End Data
>   Protection](nvme.md#end-to-end-data-protection),
