...
collection: qemu
version: "11.1.0"
title: "vhost-user daemons in contrib"
source_url: https://www.qemu.org/docs/master/system/devices/virtio/vhost-user-contrib.html
fetched_at: 2026-08-21T03:26:32+00:00
---
# vhost-user daemons in contrib

QEMU provides a number of [vhost-user back ends](vhost-user.md#vhost-user) daemons in the contrib
...
such as those from the rust-vmm [vhost-device repository](https://github.com/rust-vmm/vhost-device) are better
...
guest. You almost certainly want to use the [QEMU Storage Daemon](../../../tools/qemu-storage-daemon.md#storage-daemon)
...
You probably want to use the internal [VirtIO GPU](virtio-gpu.md#virtio-gpu) implementation
if you want the latest features. There is also a [vhost_device_gpu](https://github.com/rust-vmm/vhost-device/tree/main/vhost-device-gpu)
...
[shared memory](vhost-user.md#shared-memory-object).
