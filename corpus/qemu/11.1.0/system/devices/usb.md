...
version: "11.1.0"
title: "USB emulation"
source_url: https://www.qemu.org/docs/master/system/devices/usb.html
...
:   Mass storage device backed by drive_id (see the [Disk Images](../images.md#disk-images)
...
:   [Universal Second Factor (U2F) USB Key Device](usb-u2f.md)

`canokey`
:   An Open-source Secure Key implementing FIDO2, OpenPGP, PIV and more.
    For more information, see [CanoKey QEMU](canokey.md#canokey).
