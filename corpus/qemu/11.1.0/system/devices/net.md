...
source_url: https://www.qemu.org/docs/master/system/devices/net.html
fetched_at: 2026-08-21T03:23:20+00:00
---
# Network emulation
...
See [Invocation](../invocation.md#sec-005finvocation) to have examples of command
...
[passt](https://passt.top/) can be used as a simple replacement for SLIRP (`-net user`).
...
[passt](https://passt.top/) can be used in the same way as the user backend (using `-net passt`,
...
See [passt(1)](https://passt.top/builds/latest/web/passt.1.html) for more details on passt.
...
[Invocation](../invocation.md#sec-005finvocation) to have a basic
example.
