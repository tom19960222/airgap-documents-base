...
collection: qemu
version: "11.1.0"
title: "Qemu COLO Fault Tolerance"
source_url: https://www.qemu.org/docs/master/system/qemu-colo.html
fetched_at: 2026-08-21T03:21:52+00:00
---
...
Note:
:   1. The qmp command `nbd-server-start` and `nbd-server-add` must be run
       before running the qmp command migrate on primary QEMU
    2. Active disk, hidden disk and nbd target’s length should be the
       same.
    3. It is better to put active disk and hidden disk in ramdisk. They
...
:   1. There should be only one NBD Client for each primary disk.
    2. The qmp command line must be run after running qmp command line in
       secondary qemu.
...
Copyright (c) 2026 Lukas Straub <[lukasstraub2@web.de](mailto:lukasstraub2%40web.de)>
