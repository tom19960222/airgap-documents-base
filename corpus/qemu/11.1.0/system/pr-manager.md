...
collection: qemu
version: "11.1.0"
title: "Persistent reservation managers"
source_url: https://www.qemu.org/docs/master/system/pr-manager.html
fetched_at: 2026-08-21T03:21:43+00:00
---
...
**qemu-pr-helper** is running, and that it has been
...
again. **qemu-pr-helper** can do this if the `libmpathpersist`
...
Linking **qemu-pr-helper** to `libmpathpersist` does not impede
