...
collection: qemu
version: "11.1.0"
title: "‘nitro-enclave’ virtual machine ( nitro-enclave )"
source_url: https://www.qemu.org/docs/master/system/i386/nitro-enclave.html
fetched_at: 2026-08-21T03:25:01+00:00
---
# ‘nitro-enclave’ virtual machine (`nitro-enclave`)

`nitro-enclave` is a machine type which emulates an *AWS nitro enclave*
virtual machine. [AWS nitro enclaves](https://docs.aws.amazon.com/enclaves/latest/user/nitro-enclave.html) is an Amazon EC2 feature that allows
...
the enclave VM gets a dynamic CID. Enclaves use an EIF ([Enclave Image Format](https://github.com/aws/aws-nitro-enclaves-image-format))
...
AWS nitro enclaves look like a [Firecracker](https://firecracker-microvm.github.io) microvm. This is useful for
...
can do the userspace emulation, like [vhost-device-vsock](https://github.com/rust-vmm/vhost-device/tree/main/vhost-device-vsock) from rust-vmm crate,
...
First, run [vhost-device-vsock](https://github.com/rust-vmm/vhost-device/tree/main/vhost-device-vsock#using-the-vsock-backend) (or a similar tool that supports vhost-user-vsock).
