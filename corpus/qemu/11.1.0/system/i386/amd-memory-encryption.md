...
source_url: https://www.qemu.org/docs/master/system/i386/amd-memory-encryption.html
fetched_at: 2026-08-21T03:25:08+00:00
---
...
See SEV API Spec ([[SEVAPI]](amd-memory-encryption.md#sevapi)) section 3 and 6.2 for more details.
...
See SEV API Spec ([[SEVAPI]](amd-memory-encryption.md#sevapi)) ‘Launching a guest’ usage flow (Appendix A) for the
complete flow chart.
...
([[SEVAPI]](amd-memory-encryption.md#sevapi)) section 6.5.1 describes the AMD-SP operations:
...
([[SEVAPI]](amd-memory-encryption.md#sevapi)) section 6.5.2 Table 52: LAUNCH_MEASURE Measurement Buffer).
...
- if SEV-ES is enabled (`policy & 0x4 != 0`), `vmsas_blob` is the
  ...
  or in AMD APM Volume 2 ([[APMVOL2]](amd-memory-encryption.md#apmvol2)) Table B-2: VMCB Layout, State Save Area.
...
| guest-visible-workarounds | | | string| 0 | 16-byte base64 encoded string  | for guest OS visible  | workarounds. |
...
| id-auth | string | none | base64 encoded authentication information |
...
[AMD Memory Encryption whitepaper](https://www.amd.com/content/dam/amd/en/documents/epyc-business-docs/white-papers/memory-encryption-white-paper.pdf)

[SEVAPI]
([1](amd-memory-encryption.md#id1),[2](amd-memory-encryption.md#id2),[3](amd-memory-encryption.md#id3),[4](amd-memory-encryption.md#id4))

[Secure Encrypted Virtualization API](https://www.amd.com/system/files/TechDocs/55766_SEV-KM_API_Specification.pdf)

[[APMVOL2](amd-memory-encryption.md#id5)]
...
- [AMD’s Virtualization Memory Encryption (2016)](http://www.linux-kvm.org/images/7/74/02x08A-Thomas_Lendacky-AMDs_Virtualizatoin_Memory_Encryption_Technology.pdf)
- [Extending Secure Encrypted Virtualization With SEV-ES (2018)](https://www.linux-kvm.org/images/9/94/Extending-Secure-Encrypted-Virtualization-with-SEV-ES-Thomas-Lendacky-AMD.pdf)
