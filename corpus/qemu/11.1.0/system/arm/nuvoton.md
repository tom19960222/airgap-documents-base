...
collection: qemu
version: "11.1.0"
title: "Nuvoton iBMC boards ( kudo-bmc , mori-bmc , npcm750-evb , quanta-gbs-bmc , quanta-gsj , npcm845-evb )"
source_url: https://www.qemu.org/docs/master/system/arm/nuvoton.html
fetched_at: 2026-08-21T03:24:11+00:00
---
# Nuvoton iBMC boards (`kudo-bmc`, `mori-bmc`, `npcm750-evb`, `quanta-gbs-bmc`, `quanta-gsj`, `npcm845-evb`)

The [Nuvoton iBMC](https://www.nuvoton.com/products/cloud-computing/ibmc/) chips are a family of Arm-based SoCs that are
...
| QEMU machine | OpenBMC machine |
| --- | --- |
| `npcm750-evb` | `evb-npcm750` |
| `npcm845-evb` | `evb-npcm845` |
| `quanta-gbs-bmc` | `gbs` |
| `kudo-bmc` | `kudo` |
| `mori-bmc` | `mori` |
