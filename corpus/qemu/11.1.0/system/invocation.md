...
version: "11.1.0"
title: "Invocation"
source_url: https://www.qemu.org/docs/master/system/invocation.html
fetched_at: 2026-08-21T03:21:24+00:00
---
# Invocation
...
`-fdb file`
:   Use file as floppy disk 0/1 image (see the [Disk Images](images.md#disk-images) chapter in
...
:   Use file as hard disk 0, 1, 2 or 3 image on the default bus of the
    ...
    architectures). See also the [Disk Images](images.md#disk-images) chapter in the System
...
:   Define a new drive. This includes creating a block driver node (the
    ...
    `file=file`
    :   This option defines which disk image (see the [Disk Images](images.md#disk-images)
...
:   Write to temporary files instead of disk image files. In this case,
    ...
    force the write back by pressing C-a s (see the [Disk Images](images.md#disk-images)
...
:   Add the USB device devname, and enable an on-board USB controller
    ...
    [Connecting USB devices](devices/usb.md#connecting-usb-devices) in the System Emulation Users Guide.
...
:   Normally, if QEMU is compiled with graphical window support, it
    ...
    :   Require that password based authentication is used for client
        ...
        command in the [QEMU Monitor](monitor.md#qemu-monitor). The
    ...
    :   Require that the client use SASL to authenticate with the VNC
        ...
        [VNC security](vnc-security.md#vnc-security) section in the System Emulation Users Guide
...
:   Backend is one of: `null`, `socket`, `udp`, `msmouse`, `hub`,
    ...
    [Keys in the character backend multiplexer](mux-chardev.md#keys-in-the-character-backend-multiplexer) in the
...
Please see the [QEMU System Emulator Targets](targets.md#system-targets-ref) section of the manual for
...
`-gdb dev`
:   Accept a gdb connection on device dev (see the [GDB usage](gdb.md#gdb-usage) chapter
...
:   Shorthand for -gdb <tcp::1234>, i.e. open a gdbserver on TCP port 1234
    (see the [GDB usage](gdb.md#gdb-usage) chapter in the System Emulation Users Guide).
...
`-semihosting`
:   Enable [Semihosting](../about/emulation.md#semihosting) mode (ARM, M68K, Xtensa, MIPS, RISC-V only).
...
:   Enable and configure [Semihosting](../about/emulation.md#semihosting) (ARM, M68K, Xtensa, MIPS, RISC-V
    only).
