...
version: "11.1.0"
title: "Record/replay"
source_url: https://www.qemu.org/docs/master/system/replay.html
fetched_at: 2026-08-21T03:21:39+00:00
---
# Record/replay
...
>   for every enabled block device, as described in [Block devices](replay.md#block-label) section.
...
>   in [Network devices](replay.md#network-label) section.
...
command lines.
See the [Snapshotting](replay.md#snapshotting-label) section to learn more about running record/replay
