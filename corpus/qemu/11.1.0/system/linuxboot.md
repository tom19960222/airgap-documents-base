...
source_url: https://www.qemu.org/docs/master/system/linuxboot.html
fetched_at: 2026-08-21T03:21:30+00:00
---
# Direct Linux Boot
...
```
qemu-system-x86_64 -kernel bzImage -drive file=rootdisk.img,format=raw -append "root=/dev/sda"
```
...
[Keys in the graphical frontends](keys.md#gui-keys)).
