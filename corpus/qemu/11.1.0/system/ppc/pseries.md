...
collection: qemu
version: "11.1.0"
title: "pSeries family boards ( pseries )"
source_url: https://www.qemu.org/docs/master/system/ppc/pseries.html
fetched_at: 2026-08-21T03:24:37+00:00
---
# pSeries family boards (`pseries`)

The Power machine para-virtualized environment described by the Linux on Power
Architecture Reference ([[LoPAR]](pseries.md#lopar)) document is called pSeries. This environment
...
[SLOF](https://gitlab.com/slof/slof) (Slimline Open Firmware) is an
implementation of the [IEEE 1275-1994, Standard for Boot (Initialization
Configuration) Firmware: Core Requirements and Practices](https://standards.ieee.org/standard/1275-1994.html).
...
- `spapr-rng` : a pseudo-device for passing random number generator data to the
  guest (see the [H_RANDOM hypercall feature](https://wiki.qemu.org/Features/HRandomHypercall) for details).
...
The main source of documentation on the sPAPR standard is the [[LoPAR]](pseries.md#lopar) document.
...
| 64 | hash | yes | yes |
| radix | yes | no |
| pSeries [[1]](pseries.md#id6) | PowerNV | 32 | hash | no | yes |
| radix | N/A | N/A |
| 64 | hash | no | yes |
| radix | yes [[2]](pseries.md#id7) | no |
| PowerVM | 32 | hash | no | yes |
| radix | N/A | N/A |
| 64 | hash | no | yes |
| radix [[3]](pseries.md#id8) | no | yes |
...
Cédric Le Goater <[clg@kaod.org](mailto:clg%40kaod.org)>

Daniel Henrique Barboza <[danielhb413@gmail.com](mailto:danielhb413%40gmail.com)>

[LoPAR]
([1](pseries.md#id1),[2](pseries.md#id2))

[Linux on Power Architecture Reference document (LoPAR) revision
