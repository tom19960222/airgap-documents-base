...
source_url: https://www.qemu.org/docs/master/tools/qemu-img.html
fetched_at: 2026-08-21T03:21:54+00:00
---
...
bitmap (--merge SOURCE | --add | --remove | --remove-all | --clear | --enable | --disable)... [-b SOURCE_FILE [-F SOURCE_FMT]] [-g GRANULARITY] [--object OBJECTDEF] [--image-opts | -f FMT] FILENAME [BITMAP]
...
create [-f FMT] [-o FMT_OPTS] [-b BACKING_FILE [-B BACKING_FMT]] [-u] [-q] [--object OBJDEF] FILE [SIZE]
...
rebase [--object OBJECTDEF] [--image-opts] [-U] [-q] [-f FMT] [-t CACHE] [-T SRC_CACHE] [-p] [-u] [-c] -b BACKING_FILE [-B BACKING_FMT] FILENAME
...
:   Change the disk image as if it had been created with *SIZE*.
    ...
    description in the [Notes](qemu-img.md#notes) section which values are allowed. Using this
