...
source_url: https://www.qemu.org/docs/master/about/build-platforms.html
fetched_at: 2026-08-21T03:21:17+00:00
---
...
[Setup build environment](../devel/build-environment.md#setup-build-env) page.
...
[deprecation process](deprecated.md#deprecated-features).
...
:   Distributions with long-term support often provide multiple versions
    ...
    As of QEMU 11.1.50, the minimum supported version of Python is 3.9.
...
toolchain, either hosted on Linux (Debian/Fedora) or via [MSYS2](https://www.msys2.org/) on Windows.
