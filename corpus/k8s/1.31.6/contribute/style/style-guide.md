...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/contribute/style/style-guide.md
...
shortcodes in this category: **Note** ``,
**Caution** ``, and **Warning** ``.
