...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/contribute/localization.md
...
Previous version | [`release-1.30`](https://github.com/kubernetes/website/tree/release-1.30)
Next version | [`dev-1.32`](https://github.com/kubernetes/website/tree/dev-1.32)

The `main` branch holds content for the current release `v1.31`.
The release team creates a `release-1.31` branch before the next
release: v1.32.
