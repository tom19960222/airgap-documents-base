...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/contribute/review/reviewing-prs.md
...
![GitHub pull request details including link to Netlify preview](/images/docs/github_netlify_deploy_preview.png)
...
- The [style guide](/docs/contribute/style/style-guide/) largely also applies to blog PRs, but we make some exceptions.
  ...
  - code samples don't need to use the `` shortcode, and often it is better if they do not
