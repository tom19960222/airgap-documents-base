...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/contribute/generate-ref-docs/kubectl.md
...
For example, suppose the master branch is being used to develop Kubernetes 1.31
