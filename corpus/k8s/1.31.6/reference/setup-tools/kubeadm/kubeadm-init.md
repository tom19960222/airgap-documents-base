...
version: "1.31.6"
title: "kubeadm init"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/setup-tools/kubeadm/kubeadm-init.md
...
**Table: kubeadm deprecated feature gates**
...
**Table: kubeadm removed feature gates**
...
(for example: `kubelet-config-1.31`). Kubeadm ensures that RBAC rules for reading and writing
