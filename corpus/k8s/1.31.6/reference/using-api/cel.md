...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/using-api/cel.md
...
**Table: Examples of CEL expressions and the purpose of each**
...
**Table: Examples of CEL expressions using list library functions**
...
**Table: Examples of CEL expressions using regex library functions**
...
**Table: Examples of CEL expressions using URL library functions**
...
**Table: Available member functions of a Quantity**
...
**Table: Table showing the relationship between OpenAPIv3 types and CEL types**
...
**Table: Table of CEL identifier escaping rules**
...
**Table: Examples escaped CEL identifiers**
