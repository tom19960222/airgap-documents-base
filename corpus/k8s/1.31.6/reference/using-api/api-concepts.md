...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/using-api/api-concepts.md
...
(Feature gate: APIResponseCompression)
...
declare in their
[configuration object](/docs/reference/generated/kubernetes-api/version/#validatingwebhook-v1-admissionregistration-k8s-io)
...
[v1.meta/ObjectMeta](/docs/reference/generated/kubernetes-api/version/#objectmeta-v1-meta) -
The `metadata.resourceVersion` of a resource instance identifies the resource version the instance was last modified at.

[v1.meta/ListMeta](/docs/reference/generated/kubernetes-api/version/#listmeta-v1-meta) -
...
**Table: resourceVersionMatch and paging parameters for list**
...
: Return data at the most recent resource version. The returned data must be
  ...
  For etcd v3.4.31+ and v3.5.13+ Kubernetes 1.31 serves “most recent” reads from the _watch cache_:
...
> [list metadata](/docs/reference/generated/kubernetes-api/v1.31/#listmeta-v1-meta)
> of the collection as well as
> [object metadata](/docs/reference/generated/kubernetes-api/v1.31/#objectmeta-v1-meta)
...
**Table: resourceVersion for watch**
