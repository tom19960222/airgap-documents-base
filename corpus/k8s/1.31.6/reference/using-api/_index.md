...
version: "1.31.6"
title: "API Overview"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/using-api/_index.md
...
[API](/docs/reference/generated/kubernetes-api/version/).

The [Kubernetes API reference](/docs/reference/generated/kubernetes-api/version/)
lists the API for Kubernetes version version.
...
*  The named groups are at REST path `/apis/$GROUP_NAME/$VERSION` and use
   ...
   [Kubernetes API reference](/docs/reference/generated/kubernetes-api/version/#-strong-api-groups-strong-).
