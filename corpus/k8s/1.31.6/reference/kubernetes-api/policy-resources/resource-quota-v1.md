...
version: "1.31.6"
title: "ResourceQuota"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/policy-resources/resource-quota-v1.md
...
- **spec** (<a href="../policy-resources/resource-quota-v1#ResourceQuotaSpec">ResourceQuotaSpec</a>)

  Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status

- **status** (<a href="../policy-resources/resource-quota-v1#ResourceQuotaStatus">ResourceQuotaStatus</a>)
...
- **hard** (map[string]<a href="../common-definitions/quantity#Quantity">Quantity</a>)
...
- **used** (map[string]<a href="../common-definitions/quantity#Quantity">Quantity</a>)
...
- **items** ([]<a href="../policy-resources/resource-quota-v1#ResourceQuota">ResourceQuota</a>), required
...
200 (<a href="../policy-resources/resource-quota-v1#ResourceQuota">ResourceQuota</a>): OK
...
200 (<a href="../policy-resources/resource-quota-v1#ResourceQuotaList">ResourceQuotaList</a>): OK
...
- **body**: <a href="../policy-resources/resource-quota-v1#ResourceQuota">ResourceQuota</a>, required
...
201 (<a href="../policy-resources/resource-quota-v1#ResourceQuota">ResourceQuota</a>): Created

202 (<a href="../policy-resources/resource-quota-v1#ResourceQuota">ResourceQuota</a>): Accepted
