...
version: "1.31.6"
title: "NetworkPolicy"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/policy-resources/network-policy-v1.md
...
- **spec** (<a href="../policy-resources/network-policy-v1#NetworkPolicySpec">NetworkPolicySpec</a>)
...
- **podSelector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>), required
  ...
  *NetworkPolicyIngressRule describes a particular set of traffic that is allowed to the pods matched by a NetworkPolicySpec's podSelector. The traffic must match both ports and from.*
  ...
  - **ingress.from** ([]NetworkPolicyPeer)
    ...
    *NetworkPolicyPeer describes a peer to allow traffic to/from. Only certain combinations of fields are allowed*
    ...
    - **ingress.from.namespaceSelector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>)

      namespaceSelector selects namespaces using cluster-scoped labels. This field follows standard label selector semantics; if present but empty, it selects all namespaces.
      
      If podSelector is also set, then the NetworkPolicyPeer as a whole selects the pods matching podSelector in the namespaces selected by namespaceSelector. Otherwise it selects all pods in the namespaces selected by namespaceSelector.

    - **ingress.from.podSelector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>)
  ...
  *NetworkPolicyEgressRule describes a particular set of traffic that is allowed out of pods matched by a NetworkPolicySpec's podSelector. The traffic must match both ports and to. This type is beta-level in 1.8*
  ...
  - **egress.to** ([]NetworkPolicyPeer)
    ...
    *NetworkPolicyPeer describes a peer to allow traffic to/from. Only certain combinations of fields are allowed*
    ...
    - **egress.to.namespaceSelector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>)

      namespaceSelector selects namespaces using cluster-scoped labels. This field follows standard label selector semantics; if present but empty, it selects all namespaces.
      
      If podSelector is also set, then the NetworkPolicyPeer as a whole selects the pods matching podSelector in the namespaces selected by namespaceSelector. Otherwise it selects all pods in the namespaces selected by namespaceSelector.

    - **egress.to.podSelector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>)
...
- **items** ([]<a href="../policy-resources/network-policy-v1#NetworkPolicy">NetworkPolicy</a>), required
...
200 (<a href="../policy-resources/network-policy-v1#NetworkPolicy">NetworkPolicy</a>): OK
...
200 (<a href="../policy-resources/network-policy-v1#NetworkPolicyList">NetworkPolicyList</a>): OK
...
- **body**: <a href="../policy-resources/network-policy-v1#NetworkPolicy">NetworkPolicy</a>, required
...
201 (<a href="../policy-resources/network-policy-v1#NetworkPolicy">NetworkPolicy</a>): Created

202 (<a href="../policy-resources/network-policy-v1#NetworkPolicy">NetworkPolicy</a>): Accepted
