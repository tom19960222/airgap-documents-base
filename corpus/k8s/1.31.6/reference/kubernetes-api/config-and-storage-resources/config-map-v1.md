...
version: "1.31.6"
title: "ConfigMap"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/config-and-storage-resources/config-map-v1.md
...
- **items** ([]<a href="../config-and-storage-resources/config-map-v1#ConfigMap">ConfigMap</a>), required
...
200 (<a href="../config-and-storage-resources/config-map-v1#ConfigMap">ConfigMap</a>): OK
...
200 (<a href="../config-and-storage-resources/config-map-v1#ConfigMapList">ConfigMapList</a>): OK
...
- **body**: <a href="../config-and-storage-resources/config-map-v1#ConfigMap">ConfigMap</a>, required
...
201 (<a href="../config-and-storage-resources/config-map-v1#ConfigMap">ConfigMap</a>): Created

202 (<a href="../config-and-storage-resources/config-map-v1#ConfigMap">ConfigMap</a>): Accepted
