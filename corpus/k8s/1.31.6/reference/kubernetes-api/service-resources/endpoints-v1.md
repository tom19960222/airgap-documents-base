...
version: "1.31.6"
title: "Endpoints"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/service-resources/endpoints-v1.md
  ...
  *EndpointSubset is a group of addresses with a common set of ports. The expanded set of endpoints is the Cartesian product of Addresses x Ports. For example, given:
  ...
  - **subsets.addresses** ([]EndpointAddress)
    ...
    *EndpointAddress is a tuple that describes single IP address.*
    ...
    - **subsets.addresses.targetRef** (<a href="../common-definitions/object-reference#ObjectReference">ObjectReference</a>)
  ...
  - **subsets.notReadyAddresses** ([]EndpointAddress)
    ...
    *EndpointAddress is a tuple that describes single IP address.*
    ...
    - **subsets.notReadyAddresses.targetRef** (<a href="../common-definitions/object-reference#ObjectReference">ObjectReference</a>)
...
- **items** ([]<a href="../service-resources/endpoints-v1#Endpoints">Endpoints</a>), required
...
200 (<a href="../service-resources/endpoints-v1#Endpoints">Endpoints</a>): OK
...
200 (<a href="../service-resources/endpoints-v1#EndpointsList">EndpointsList</a>): OK
...
- **body**: <a href="../service-resources/endpoints-v1#Endpoints">Endpoints</a>, required
...
201 (<a href="../service-resources/endpoints-v1#Endpoints">Endpoints</a>): Created

202 (<a href="../service-resources/endpoints-v1#Endpoints">Endpoints</a>): Accepted
