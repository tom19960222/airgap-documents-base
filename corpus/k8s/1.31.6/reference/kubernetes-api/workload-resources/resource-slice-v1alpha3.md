...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/workload-resources/resource-slice-v1alpha3.md
...
- **spec** (<a href="../workload-resources/resource-slice-v1alpha3#ResourceSliceSpec">ResourceSliceSpec</a>), required
  ...
  *Device represents one individual hardware instance that can be selected based on its attributes. Besides the name, exactly one field must be set.*
  ...
  - **devices.basic** (BasicDevice)
    ...
    *BasicDevice defines one device instance.*
    ...
    - **devices.basic.capacity** (map[string]<a href="../common-definitions/quantity#Quantity">Quantity</a>)
  ...
  *A node selector represents the union of the results of one or more label queries over a set of nodes; that is, it represents the OR of the selectors represented by the node selector terms.*
  ...
  - **nodeSelector.nodeSelectorTerms** ([]NodeSelectorTerm), required
    ...
    *A null or empty node selector term matches no objects. The requirements of them are ANDed. The TopologySelectorTerm type implements a subset of the NodeSelectorTerm.*
    ...
    - **nodeSelector.nodeSelectorTerms.matchExpressions** ([]<a href="../common-definitions/node-selector-requirement#NodeSelectorRequirement">NodeSelectorRequirement</a>)

      *Atomic: will be replaced during a merge*
      
      A list of node selector requirements by node's labels.

    - **nodeSelector.nodeSelectorTerms.matchFields** ([]<a href="../common-definitions/node-selector-requirement#NodeSelectorRequirement">NodeSelectorRequirement</a>)
...
- **items** ([]<a href="../workload-resources/resource-slice-v1alpha3#ResourceSlice">ResourceSlice</a>), required
...
200 (<a href="../workload-resources/resource-slice-v1alpha3#ResourceSlice">ResourceSlice</a>): OK
...
200 (<a href="../workload-resources/resource-slice-v1alpha3#ResourceSliceList">ResourceSliceList</a>): OK
...
- **body**: <a href="../workload-resources/resource-slice-v1alpha3#ResourceSlice">ResourceSlice</a>, required
...
201 (<a href="../workload-resources/resource-slice-v1alpha3#ResourceSlice">ResourceSlice</a>): Created

202 (<a href="../workload-resources/resource-slice-v1alpha3#ResourceSlice">ResourceSlice</a>): Accepted
