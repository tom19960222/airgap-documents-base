...
version: "1.31.6"
title: "StatefulSet"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/kubernetes-api/workload-resources/stateful-set-v1.md
...
- **spec** (<a href="../workload-resources/stateful-set-v1#StatefulSetSpec">StatefulSetSpec</a>)

  Spec defines the desired identities of pods in this set.

- **status** (<a href="../workload-resources/stateful-set-v1#StatefulSetStatus">StatefulSetStatus</a>)
...
- **selector** (<a href="../common-definitions/label-selector#LabelSelector">LabelSelector</a>), required

  selector is a label query over pods that should match the replica count. It must match the pod template's labels. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors

- **template** (<a href="../workload-resources/pod-template-v1#PodTemplateSpec">PodTemplateSpec</a>), required
...
- **volumeClaimTemplates** ([]<a href="../config-and-storage-resources/persistent-volume-claim-v1#PersistentVolumeClaim">PersistentVolumeClaim</a>)
...
- **items** ([]<a href="../workload-resources/stateful-set-v1#StatefulSet">StatefulSet</a>), required
...
200 (<a href="../workload-resources/stateful-set-v1#StatefulSet">StatefulSet</a>): OK
...
200 (<a href="../workload-resources/stateful-set-v1#StatefulSetList">StatefulSetList</a>): OK
...
- **body**: <a href="../workload-resources/stateful-set-v1#StatefulSet">StatefulSet</a>, required
...
201 (<a href="../workload-resources/stateful-set-v1#StatefulSet">StatefulSet</a>): Created

202 (<a href="../workload-resources/stateful-set-v1#StatefulSet">StatefulSet</a>): Accepted
