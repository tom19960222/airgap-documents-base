...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/instrumentation/slis.md
...
By default, Kubernetes 1.31 publishes Service Level Indicator (SLI) metrics 
