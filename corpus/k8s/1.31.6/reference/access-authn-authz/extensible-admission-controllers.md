...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/access-authn-authz/extensible-admission-controllers.md
...
the [deployment API](/docs/reference/generated/kubernetes-api/version/#deployment-v1-apps).
The test also creates a [service](/docs/reference/generated/kubernetes-api/version/#service-v1-core)
...
webhooks via
[ValidatingWebhookConfiguration](/docs/reference/generated/kubernetes-api/version/#validatingwebhookconfiguration-v1-admissionregistration-k8s-io)
or
[MutatingWebhookConfiguration](/docs/reference/generated/kubernetes-api/version/#mutatingwebhookconfiguration-v1-admissionregistration-k8s-io).
...
**Tab: apiserver.config.k8s.io/v1**
...
See the [API documentation](/docs/reference/generated/kubernetes-api/version/#status-v1-meta)
