...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/access-authn-authz/certificate-signing-requests.md
...
> **Note:**
>
> In Kubernetes 1.31, you must enable the `ClusterTrustBundle`
...
* Read about the ClusterTrustBundle API:
  * [ClusterTrustBundle](/docs/reference/kubernetes-api/ClusterTrustBundle)
