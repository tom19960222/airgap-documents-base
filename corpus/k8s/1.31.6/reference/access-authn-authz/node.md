...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/access-authn-authz/node.md
...
(Feature gate: AuthorizeNodeWithSelectors)
