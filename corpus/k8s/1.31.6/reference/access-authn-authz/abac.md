...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/access-authn-authz/abac.md
...
[Complete file example](https://releases.k8s.io/v1.31.6/pkg/auth/authorizer/abac/example_policy_file.jsonl)
