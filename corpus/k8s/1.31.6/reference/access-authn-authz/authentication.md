...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/access-authn-authz/authentication.md
...
(Feature gate: StructuredAuthenticationConfiguration)
...
* User validation rule expression
  ...
  Refer to the [UserInfo](/docs/reference/generated/kubernetes-api/v1.31/#userinfo-v1-authentication-k8s-io)
...
**Tab: authentication.k8s.io/v1beta1**
...
**Tab: client.authentication.k8s.io/v1**
...
**Tab: client.authentication.k8s.io/v1beta1**
