...
version: "1.31.6"
title: "Node Status"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/reference/node/node-status.md
...
**Table: Node conditions, and a description of when each condition applies.**
