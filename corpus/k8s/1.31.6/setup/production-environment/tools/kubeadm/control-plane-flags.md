...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/setup/production-environment/tools/kubeadm/control-plane-flags.md
...
> patch the `kube-system/coredns` ConfigMap
