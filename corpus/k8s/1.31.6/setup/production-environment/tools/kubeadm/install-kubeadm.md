...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/setup/production-environment/tools/kubeadm/install-kubeadm.md
...
**Table: Linux container runtimes**
...
**Table: Windows container runtimes**
...
> > a minor version other than v1.31, please see the installation guide for
...
>    only for Kubernetes 1.31; for other Kubernetes minor versions, you need to
...
>    have packages only for Kubernetes 1.31; for other
