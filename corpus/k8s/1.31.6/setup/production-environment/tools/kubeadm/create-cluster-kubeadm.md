...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/setup/production-environment/tools/kubeadm/create-cluster-kubeadm.md
...
are supported. This page is written for Kubernetes version.
...
* kubeadm is at 1.31
* kubelet on the host must be at 1.31, 1.30,
  1.29 or 1.28
...
* The version of kubeadm used for upgrading the node must be at 1.30
  or 1.31
