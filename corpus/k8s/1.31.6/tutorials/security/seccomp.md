...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tutorials/security/seccomp.md
...
This tutorial assumes you are using Kubernetes version.
