...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tutorials/services/connect-applications-service.md
...
Service).
View [Service](/docs/reference/generated/kubernetes-api/version/#service-v1-core)
...
[CoreDNS cluster addon](https://releases.k8s.io/v1.31.6/cluster/addons/dns/coredns).
...
> the [pod spec](/docs/reference/generated/kubernetes-api/v1.31/#pod-v1-core).
