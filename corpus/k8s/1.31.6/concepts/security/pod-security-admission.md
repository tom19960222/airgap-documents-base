...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/security/pod-security-admission.md
...
**Table: Pod Security Admission modes**
