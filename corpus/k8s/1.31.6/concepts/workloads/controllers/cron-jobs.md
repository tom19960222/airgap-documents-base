...
version: "1.31.6"
title: "CronJob"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/cron-jobs.md
...
* `CronJob` is part of the Kubernetes REST API.
  Read the [cron-job-v1](/docs/reference/kubernetes-api/workload-resources/cron-job-v1)
