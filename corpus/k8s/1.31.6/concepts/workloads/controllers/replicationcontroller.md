...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/replicationcontroller.md
...
[ReplicationController API object](/docs/reference/generated/kubernetes-api/version/#replicationcontroller-v1-core).
...
* `ReplicationController` is part of the Kubernetes REST API.
  Read the [replication-controller-v1](/docs/reference/kubernetes-api/workload-resources/replication-controller-v1)
