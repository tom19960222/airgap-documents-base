...
version: "1.31.6"
title: "ReplicaSet"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/replicaset.md
...
* `ReplicaSet` is a top-level resource in the Kubernetes REST API.
  Read the [replica-set-v1](/docs/reference/kubernetes-api/workload-resources/replica-set-v1)
