...
version: "1.31.6"
title: "DaemonSet"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/daemonset.md
...
**Table: Tolerations for DaemonSet pods**
...
* `DaemonSet` is a top-level resource in the Kubernetes REST API.
  Read the [daemon-set-v1](/docs/reference/kubernetes-api/workload-resources/daemon-set-v1)
