...
version: "1.31.6"
title: "Deployments"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/deployment.md
...
* Read the [deployment-v1](/docs/reference/kubernetes-api/workload-resources/deployment-v1) to understand the Deployment API.
