...
version: "1.31.6"
title: "Jobs"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/workloads/controllers/job.md
...
* `Job` is part of the Kubernetes REST API.
  Read the [job-v1](/docs/reference/kubernetes-api/workload-resources/job-v1)
