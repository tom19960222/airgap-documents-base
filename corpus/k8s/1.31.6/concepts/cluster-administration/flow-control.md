...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/cluster-administration/flow-control.md
...
[PriorityLevelConfigurations](/docs/reference/generated/kubernetes-api/version/#prioritylevelconfiguration-v1-flowcontrol-apiserver-k8s-io)
define the available priority levels, the share of the available concurrency
budget that each can handle, and allow for fine-tuning queuing behavior.
[FlowSchemas](/docs/reference/generated/kubernetes-api/version/#flowschema-v1-flowcontrol-apiserver-k8s-io)
...
**Table: Example Shuffle Sharding Configurations**
