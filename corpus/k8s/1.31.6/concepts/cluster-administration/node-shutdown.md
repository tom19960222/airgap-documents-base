...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/cluster-administration/node-shutdown.md
...
(Feature gate: GracefulNodeShutdown)
...
(Feature gate: GracefulNodeShutdownBasedOnPodPriority)
...
> as an Alpha feature in Kubernetes v1.23. In Kubernetes 1.31
...
(Feature gate: NodeOutOfServiceVolumeDetach)
