...
version: "1.31.6"
title: "System Logs"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/cluster-administration/system-logs.md
...
For Kubernetes 1.31, this is gated behind the `ContextualLogging`
