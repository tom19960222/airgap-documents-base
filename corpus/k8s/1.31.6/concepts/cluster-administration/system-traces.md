...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/cluster-administration/system-traces.md
...
The kubelet in Kubernetes v1.31 collects spans from
