...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/windows/user-guide.md
...
All Kubernetes nodes running Kubernetes 1.31 have the following default labels:
...
The best practice for Kubernetes 1.31 is to use a `nodeSelector`.
