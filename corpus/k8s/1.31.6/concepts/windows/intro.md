...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/windows/intro.md
...
For Kubernetes v1.31.6 the recommended pause image is `registry.k8s.io/pause:3.6`.
...
For Kubernetes v1.31, operating system compatibility for Windows nodes (and Pods)
is as follows:
