...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/extend-kubernetes/compute-storage-net/_index.md
...
* [Network plugins](/docs/concepts/extend-kubernetes/compute-storage-net/network-plugins/)
  ...
  Kubernetes 1.31 is compatible with CNI
  network plugins.
