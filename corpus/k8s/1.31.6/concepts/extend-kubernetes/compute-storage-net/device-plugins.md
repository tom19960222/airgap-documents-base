...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/extend-kubernetes/compute-storage-net/device-plugins.md
...
(Feature gate: ResourceHealthStatus)
...
in the plugin's [PodSpec](/docs/reference/generated/kubernetes-api/version/#podspec-v1-core).
