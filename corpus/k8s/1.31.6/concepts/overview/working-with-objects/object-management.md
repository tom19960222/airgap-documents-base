...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/overview/working-with-objects/object-management.md
...
See the [API reference](/docs/reference/generated/kubernetes-api/version/)
