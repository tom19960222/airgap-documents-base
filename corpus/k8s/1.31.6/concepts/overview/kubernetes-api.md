...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/overview/kubernetes-api.md
...
The [discovery document](https://github.com/kubernetes/kubernetes/blob/release-1.31/api/discovery/aggregated_v2beta1.json)
