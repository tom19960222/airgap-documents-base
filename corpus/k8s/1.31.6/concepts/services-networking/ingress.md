...
version: "1.31.6"
title: "Ingress"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/services-networking/ingress.md
...
[Ingress](/docs/reference/generated/kubernetes-api/version/#ingress-v1-networking-k8s-io)
exposes HTTP and HTTPS routes from outside the cluster to
[services](/docs/concepts/services-networking/service/) within the cluster.
Traffic routing is controlled by rules defined on the Ingress resource.

Here is a simple example where an Ingress sends all its traffic to one Service:

![ingress-diagram](/docs/images/ingress.svg)
...
![ingress-fanout-diagram](/docs/images/ingressFanOut.svg)
...
![ingress-namebase-diagram](/docs/images/ingressNameBased.svg)
