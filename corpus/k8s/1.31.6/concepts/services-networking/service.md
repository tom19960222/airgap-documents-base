...
version: "1.31.6"
title: "Service"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/services-networking/service.md
...
(Feature gate: MixedProtocolLBService)
...
(Feature gate: LoadBalancerIPMode)
...
cluster and all of its nodes. In Kubernetes 1.31, the
...
about the [Service API object](/docs/reference/generated/kubernetes-api/version/#service-v1-core).
