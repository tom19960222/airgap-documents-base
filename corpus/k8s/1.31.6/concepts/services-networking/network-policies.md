...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/services-networking/network-policies.md
...
See the [NetworkPolicy](/docs/reference/generated/kubernetes-api/version/#networkpolicy-v1-networking-k8s-io)
...
As of Kubernetes 1.31, the following functionality does not exist in the
