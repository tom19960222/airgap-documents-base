...
version: "1.31.6"
title: "Gateway API"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/services-networking/gateway.md
...
![A diagram that provides an example of HTTP traffic being routed to a Service by using a Gateway and an HTTPRoute](/docs/images/gateway-request-flow.svg)
