...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/scheduling-eviction/dynamic-resource-allocation.md
...
(Feature gate: DRAControlPlaneController)
...
Kubernetes v1.31 includes cluster-level API support for
...
v1.31, check the documentation for that version of Kubernetes.
...
and the `resource.k8s.io/v1alpha3` API group
