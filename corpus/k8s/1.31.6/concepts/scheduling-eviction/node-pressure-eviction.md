...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/scheduling-eviction/node-pressure-eviction.md
...
(Feature gate: KubeletSeparateDiskGC)
...
> `containerfs`, the Kubernetes release v1.31 requires the
...
> **Note:**
>
> As of Kubernetes v1.31, you cannot set a custom value
...
- Check out the [Eviction API](/docs/reference/generated/kubernetes-api/version/#create-eviction-pod-v1-core)
