...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/architecture/garbage-collection.md
...
(Feature gate: ImageMaximumGCAge)
