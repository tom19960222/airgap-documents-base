...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/architecture/mixed-version-proxy.md
...
[`StorageVersion` API](/docs/reference/generated/kubernetes-api/v1.31/#storageversioncondition-v1alpha1-internal-apiserver-k8s-io).
