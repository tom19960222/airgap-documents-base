...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/containers/container-environment.md
...
if [DNS addon](https://releases.k8s.io/v1.31.6/cluster/addons/dns/) is enabled. 
