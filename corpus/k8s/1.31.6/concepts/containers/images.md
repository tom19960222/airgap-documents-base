...
version: "1.31.6"
title: "Images"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/containers/images.md
...
> release (such as v1.31, the latest minor release),
...
(Feature gate: RuntimeClassInImageCriApi)
...
are using. Kubernetes v1.26 through to v1.31 do not include the legacy mechanism, so
