...
version: "1.31.6"
title: "Volumes"
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/storage/volumes.md
...
In Kubernetes 1.31, all operations for the in-tree `awsElasticBlockStore` type
...
In Kubernetes 1.31, all operations for the in-tree `azureDisk` type
...
(Feature state: deprecated, as of v1.21)
...
Kubernetes 1.31 does not include a `cephfs` volume type.
...
In Kubernetes 1.31, all operations for the in-tree `cinder` type
...
In Kubernetes 1.31, all operations for the in-tree `gcePersistentDisk` type
...
Kubernetes 1.31 does not include a `glusterfs` volume type.
...
`registry.k8s.io/conformance:v1.31.6` to load the
...
(Feature state: beta, as of v1.25)
...
Kubernetes 1.31 does not include a `rbd` volume type.
...
In Kubernetes 1.31, all operations for the in-tree `vsphereVolume` type
...
If you are running a version of Kubernetes other than v1.31, consult
...
(Feature state: beta, as of v1.19)
...
(Feature gate: RecursiveReadOnlyMounts)
