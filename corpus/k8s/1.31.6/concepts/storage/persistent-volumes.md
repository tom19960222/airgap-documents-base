...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/concepts/storage/persistent-volumes.md
...
**Tab: Manually with Cluster Administrator access**
...
**Tab: By requesting expansion to smaller size**
...
(Feature gate: PersistentVolumeLastPhaseTransitionTime)
