...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/topology-manager.md
...
The `prefer-closest-numa-nodes` option is beta since Kubernetes 1.28. In Kubernetes 1.31
...
The `max-allowable-numa-nodes` option is beta since Kubernetes 1.31. In Kubernetes 1.31,
this policy option is visible by default provided that the `TopologyManagerPolicyOptions` and
`TopologyManagerPolicyBetaOptions` [feature gates](/docs/reference/command-line-tools-reference/feature-gates/)
are enabled.
...
> lack of data, using this policy option with Kubernetes 1.31 is **not** recommended and is
> at your own risk.
