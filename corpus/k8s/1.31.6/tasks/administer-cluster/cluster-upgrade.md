...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/cluster-upgrade.md
...
1.30 to Kubernetes 1.31. If your cluster
is not currently running Kubernetes 1.30 then please check
...
that node and then either replace it with a new node that uses the 1.31
