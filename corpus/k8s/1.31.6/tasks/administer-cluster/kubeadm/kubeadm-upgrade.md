...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/kubeadm/kubeadm-upgrade.md
fetched_at: 2026-01-16T10:18:07+05:30
---
<!-- overview -->

This page explains how to upgrade a Kubernetes cluster created with kubeadm from version
1.30.x to version 1.31.x, and from version
1.31.x to 1.31.y (where `y > x`). Skipping MINOR versions
