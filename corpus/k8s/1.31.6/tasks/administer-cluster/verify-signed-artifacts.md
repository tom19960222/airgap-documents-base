...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/verify-signed-artifacts.md
fetched_at: 2026-01-16T10:18:07+05:30
---
<!-- overview -->

(Feature state: beta, as of v1.26)
...
```bash
URL=https://dl.k8s.io/release/v1.31.6/bin/linux/amd64
BINARY=kubectl
...
```shell
cosign verify registry.k8s.io/kube-apiserver-amd64:v1.31.6 \
...
(v1.31.6), please run the following commands:
