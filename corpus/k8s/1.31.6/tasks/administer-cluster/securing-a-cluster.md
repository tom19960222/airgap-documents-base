...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/securing-a-cluster.md
...
In Kubernetes 1.31 you can also encrypt custom resources;
