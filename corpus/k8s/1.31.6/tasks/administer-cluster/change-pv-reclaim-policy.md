...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/administer-cluster/change-pv-reclaim-policy.md
...
* [persistent-volume-v1](/docs/reference/kubernetes-api/config-and-storage-resources/persistent-volume-v1)
  * Pay attention to the `.spec.persistentVolumeReclaimPolicy`
    ...
    of PersistentVolume.
* [persistent-volume-claim-v1](/docs/reference/kubernetes-api/config-and-storage-resources/persistent-volume-claim-v1)
