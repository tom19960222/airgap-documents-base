...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/tools/install-kubectl-macos.md
...
>
>    For example, to download version 1.31.6 on Intel macOS, type:
>
>    ```bash
>    curl -LO "https://dl.k8s.io/release/v1.31.6/bin/darwin/amd64/kubectl"
>    ```
>
>    And for macOS on Apple Silicon, type:
>
>    ```bash
>    curl -LO "https://dl.k8s.io/release/v1.31.6/bin/darwin/arm64/kubectl"
>    ```
