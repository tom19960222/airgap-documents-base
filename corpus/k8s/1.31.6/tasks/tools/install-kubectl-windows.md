...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/tools/install-kubectl-windows.md
...
1. You have two options for installing kubectl on your Windows device
   ...
   - Direct download:
     ...
     Download the latest 1.31 patch release binary directly for your specific architecture by visiting the [Kubernetes release page](https://kubernetes.io/releases/download/#binaries). Be sure to select the correct binary for your architecture (e.g., amd64, arm64, etc.).
   ...
   - Using curl:
     ...
     ```powershell
     curl.exe -LO "https://dl.k8s.io/release/v1.31.6/bin/windows/amd64/kubectl.exe"
     ```
...
1. Validate the binary (optional)
   ...
   ```powershell
   curl.exe -LO "https://dl.k8s.io/v1.31.6/bin/windows/amd64/kubectl.exe.sha256"
   ```
...
1. Download the latest release with the command:
   ...
   ```powershell
   curl.exe -LO "https://dl.k8s.io/release/v1.31.6/bin/windows/amd64/kubectl-convert.exe"
   ```
...
1. Validate the binary (optional).
   ...
   ```powershell
   curl.exe -LO "https://dl.k8s.io/v1.31.6/bin/windows/amd64/kubectl-convert.exe.sha256"
   ```
