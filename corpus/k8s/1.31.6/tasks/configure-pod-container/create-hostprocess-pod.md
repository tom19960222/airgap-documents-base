...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/configure-pod-container/create-hostprocess-pod.md
...
This task guide is specific to Kubernetes v1.31.
If you are not running Kubernetes v1.31, check the documentation for
that version of Kubernetes.

In Kubernetes 1.31, the HostProcess container feature is enabled by default. The kubelet will
...
These limitations are relevant for Kubernetes v1.31:
