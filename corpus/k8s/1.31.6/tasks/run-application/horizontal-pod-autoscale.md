...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/run-application/horizontal-pod-autoscale.md
...
[HorizontalPodAutoscaler Object](/docs/reference/generated/kubernetes-api/version/#horizontalpodautoscaler-v2-autoscaling).
...
**Tab: Client Side Apply (this is the default)**
