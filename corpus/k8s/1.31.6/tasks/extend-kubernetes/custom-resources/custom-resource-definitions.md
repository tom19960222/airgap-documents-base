...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions.md
...
[CustomResourceDefinition](/docs/reference/generated/kubernetes-api/version/#customresourcedefinition-v1-apiextensions-k8s-io).
...
1.31 and if violated will continue to throw an error as normally:
...
**Table: Transition rules examples**
...
(Feature gate: CustomResourceFieldSelectors)

For Kubernetes 1.31 the ability to define field selectors for
...
* See [CustomResourceDefinition](/docs/reference/generated/kubernetes-api/version/#customresourcedefinition-v1-apiextensions-k8s-io).
