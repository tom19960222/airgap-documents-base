...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definition-versioning.md
...
**Tab: apiextensions.k8s.io/v1beta1**
...
(Feature state: stable, as of v1.16)
...
>
> This page is part of the documentation for Kubernetes v1.31.
