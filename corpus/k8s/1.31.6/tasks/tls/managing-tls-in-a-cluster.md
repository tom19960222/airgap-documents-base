...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/tls/managing-tls-in-a-cluster.md
...
Finally, you can populate `ca.pem` into a ConfigMap
