...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/manage-kubernetes-objects/declarative-config.md
...
In Kubernetes 1.31, there are two pruning modes available in kubectl apply:
