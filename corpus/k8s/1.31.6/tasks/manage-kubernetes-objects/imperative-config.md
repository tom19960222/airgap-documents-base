...
source_url: https://github.com/kubernetes/website/blob/release-1.31/content/en/docs/tasks/manage-kubernetes-objects/imperative-config.md
...
Refer to the [kubernetes API reference](/docs/reference/generated/kubernetes-api/version/)
for details.
...
* [Kubernetes API Reference](/docs/reference/generated/kubernetes-api/version/)
