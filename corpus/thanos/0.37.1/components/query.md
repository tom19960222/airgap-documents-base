...
version: "0.37.1"
title: "Querier/Query"
source_url: https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/docs/components/query.md
...
In short, it gathers the data needed to evaluate the query from underlying [StoreAPIs](https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/pkg/store/storepb/rpc.proto), evaluates the query and returns the result.
...
QueryAPI and StoreAPI has additional behaviour controlled via query parameter called [PartialResponseStrategy](../../pkg/store/storepb/rpc.pb.go) <!-- unresolved-source-link: target=../../pkg/store/storepb/rpc.pb.go -->.
...
### Partial Response Strategy
 ...
 <!-- TODO(bwplotka): Update. This will change to "strategy" soon as [PartialResponseStrategy enum here](../../pkg/store/storepb/rpc.proto) <!-- unresolved-source-link: target=../../pkg/store/storepb/rpc.proto --> -->
