...
source_url: https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/docs/getting-started.md
...
Contributions are very welcome! See our [CONTRIBUTING.md](../CONTRIBUTING.md) <!-- unresolved-source-link: target=../CONTRIBUTING.md --> for more information.
...
See [MAINTAINERS.md](../MAINTAINERS.md) <!-- unresolved-source-link: target=../MAINTAINERS.md -->.
...
See up to date [jsonnet mixins](https://github.com/thanos-io/thanos/tree/e0812e2f46f81af3324686d910d885d8f2751d46/mixin/README.md) We also have example Grafana dashboards [here](https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/examples/dashboards/dashboards.md) and some [alerts](https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/examples/alerts/alerts.md) to get you started.
...
You can see example one-node setup [here](../scripts/quickstart.sh) <!-- unresolved-source-link: target=../scripts/quickstart.sh -->.
