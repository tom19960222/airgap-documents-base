...
version: "0.37.1"
title: "Tracing"
source_url: https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/docs/tracing.md
...
3. Add client implementation to the factory in [factory](../pkg/tracing/client/factory.go) <!-- unresolved-source-link: target=../pkg/tracing/client/factory.go --> code. (Using as small amount of flags as possible in every command)
4. Add client struct config to [cfggen](../scripts/cfggen/main.go) <!-- unresolved-source-link: target=../scripts/cfggen/main.go --> to allow config auto generation.
...
![view](https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/docs/img/tracing2.png)
...
![view](https://github.com/thanos-io/thanos/blob/e0812e2f46f81af3324686d910d885d8f2751d46/docs/img/tracing.png)
