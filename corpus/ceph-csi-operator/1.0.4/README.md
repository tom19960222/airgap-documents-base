...
version: "1.0.4"
title: "Ceph CSI Operator"
source_url: https://github.com/ceph/ceph-csi-operator/blob/29a66b683aa8873001c729b7b120e18604cdb445/README.md
...
We welcome contributions to the Ceph CSI Operator! Please follow [development-guide](development-guide.md)
and [coding style guidelines](coding.md) if you are interested to contribute to this repo.
...
The Ceph CSI Operator is licensed under the Apache License 2.0. See the [LICENSE](LICENSE) <!-- unresolved-source-link: target=LICENSE --> file for more details.
