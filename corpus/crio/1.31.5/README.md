...
source_url: https://github.com/cri-o/cri-o/blob/5184b74964ef620d64169a41fd27afdba6fe130e/README.md
fetched_at: 2025-02-03T17:22:57Z
---
<!-- markdownlint-disable-next-line MD041 -->

![CRI-O logo](https://github.com/cri-o/cri-o/blob/5184b74964ef620d64169a41fd27afdba6fe130e/logo/crio-logo.svg?raw=true)
...
[![Mentioned in Awesome CRI-O](https://awesome.re/mentioned-badge.svg)](awesome.md) <!-- unresolved-source-link: target=awesome.md -->
...
The security process for reporting vulnerabilities is described in [SECURITY.md](./SECURITY.md) <!-- unresolved-source-link: target=./SECURITY.md -->.
...
We provide [useful information for operations and development transfer](transfer.md) <!-- unresolved-source-link: target=transfer.md -->
...
We maintain a curated [list of links related to CRI-O](awesome.md) <!-- unresolved-source-link: target=awesome.md -->. Did you find
...
For more guidance in running `CRI-O`, visit our [tutorial page](tutorial.md) <!-- unresolved-source-link: target=tutorial.md -->
...
Please refer to the [CRI-O Metrics guide](metrics.md).

#### Tracing

Please refer to the [CRI-O Tracing guide](tracing.md).

#### Container Runtime Interface special cases

Some aspects of the Container Runtime are worth some additional explanation.
These details are summarized in a [dedicated guide](cri.md) <!-- unresolved-source-link: target=cri.md -->.

#### Debugging tips

Having an issue? There are some tips and tricks for debugging located in
[our debugging guide](debugging.md)

## Adopters

An incomplete list of adopters of CRI-O in production environments can be found [here](ADOPTERS.md) <!-- unresolved-source-link: target=ADOPTERS.md -->.
...
For more information on how CRI-O is goverened, take a look at the [governance file](GOVERNANCE.md) <!-- unresolved-source-link: target=GOVERNANCE.md -->
