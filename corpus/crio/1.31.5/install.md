...
collection: crio
version: "1.31.5"
title: "CRI-O Installation Instructions"
source_url: https://github.com/cri-o/cri-o/blob/5184b74964ef620d64169a41fd27afdba6fe130e/install.md
...
it [within this repository](../nix) <!-- unresolved-source-link: target=../nix -->. The builds are completely reproducible and
...
- Follow this [tutorial](crictl.md) to quickly get started running
