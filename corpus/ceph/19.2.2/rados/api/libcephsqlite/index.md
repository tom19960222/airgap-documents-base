...
collection: ceph
version: "19.2.2"
title: "Ceph SQLite VFS"
source_url: https://docs.ceph.com/en/squid/rados/api/libcephsqlite/
...
To learn why blocklisting is necessary, see [How to Corrupt Your Database](index.md#libcephsqlite-corrupt).
