...
source_url: https://docs.ceph.com/en/squid/rados/troubleshooting/memory-profiling/
...
2. replace `{daemon-id}` with the OSD number or the MON ID or the MDS ID
...
> **Note:**
>
> The reporting of stats with this command does not require the
