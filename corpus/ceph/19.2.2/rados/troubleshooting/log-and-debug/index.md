...
source_url: https://docs.ceph.com/en/squid/rados/troubleshooting/log-and-debug/
...
> **Important:**
>
> Verbose logging sometimes generates over 1 GB of data per hour.
...
size. For details on rotating log files, see [Accelerating Log Rotation](index.md#accelerating-log-rotation).
...
For details on available settings, see [Subsystem, Log and Debug Settings](index.md#subsystem-log-and-debug-settings).
...
For details, see [Subsystem, Log and Debug Settings](index.md#subsystem-log-and-debug-settings).
...
3. Start the crontab editor for your user space:
   ...
   crontab -e
   ```
4. Add an entry to crontab that instructs cron to check the
...
- sending in-memory logs to the output log has been manually triggered.
  ...
  that provides an example of how to submit admin socket commands](http://docs.ceph.com/en/latest/man/8/ceph/#daemon) for more detail.
...
:   > The location of the logging file for your cluster.
    ...
    >
    > see also:
    > :   [`log_to_file`](index.md#confval-log_to_file), [`log_to_stderr`](index.md#confval-log_to_stderr), [`err_to_stderr`](index.md#confval-err_to_stderr), [`log_to_syslog`](index.md#confval-log_to_syslog), [`err_to_syslog`](index.md#confval-err_to_syslog)
...
:   > The maximum number of new log files.
    ...
    >
    > see also:
    > :   [`log_max_recent`](index.md#confval-log_max_recent)

log_max_recent
:   > The purpose of this option is to log at a higher debug level only to
    > the in-memory buffer, and write out the detailed log messages only if
    > there is a crash. Only log entries below the lower log level will be
    > written unconditionally to the log. For example, debug_osd=1/5 will
    > write everything <= 1 to the log unconditionally but keep entries at
    > levels 2-5 in memory. If there is a seg fault or assertion failure,
    > all entries will be dumped to the log.
    >
    > type:
    > :   `int`
    >
...
:   > Determines if logging messages should appear in a file.
    ...
    >
    > see also:
    > :   [`log_file`](index.md#confval-log_file)
...
- [`mds_debug_scatterstat`](../../../cephfs/mds-config-ref/index.md#confval-mds_debug_scatterstat)
- [`mds_debug_frag`](../../../cephfs/mds-config-ref/index.md#confval-mds_debug_frag)
- [`mds_debug_auth_pins`](../../../cephfs/mds-config-ref/index.md#confval-mds_debug_auth_pins)
- [`mds_debug_subtrees`](../../../cephfs/mds-config-ref/index.md#confval-mds_debug_subtrees)

### RADOS Gateway

- [`rgw_log_nonexistent_bucket`](../../../radosgw/config-ref/index.md#confval-rgw_log_nonexistent_bucket)
- [`rgw_log_object_name`](../../../radosgw/config-ref/index.md#confval-rgw_log_object_name)
- [`rgw_log_object_name_utc`](../../../radosgw/config-ref/index.md#confval-rgw_log_object_name_utc)
- [`rgw_enable_ops_log`](../../../radosgw/config-ref/index.md#confval-rgw_enable_ops_log)
- [`rgw_enable_usage_log`](../../../radosgw/config-ref/index.md#confval-rgw_enable_usage_log)
- [`rgw_usage_log_flush_threshold`](../../../radosgw/config-ref/index.md#confval-rgw_usage_log_flush_threshold)
- [`rgw_usage_log_tick_interval`](../../../radosgw/config-ref/index.md#confval-rgw_usage_log_tick_interval)
