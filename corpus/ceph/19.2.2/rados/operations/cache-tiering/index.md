...
version: "19.2.2"
title: "Cache Tiering"
source_url: https://docs.ceph.com/en/squid/rados/operations/cache-tiering/
...
> **Warning:**
>
> Cache tiering has been deprecated in the Reef release. Cache
...
[CRUSH Device Class](../crush-map-edits/index.md#crush-map-device-class) for details.
...
[Absolute sizing](index.md#absolute-sizing)). When the cache pool consists of a certain percentage of
