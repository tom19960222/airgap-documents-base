...
version: "19.2.2"
title: "Erasure code"
source_url: https://docs.ceph.com/en/squid/rados/operations/erasure-code/
fetched_at: 2026-07-27T16:39:40+00:00
---
# Erasure code

By default, Ceph [pools](../pools.md) are created with the type “replicated”. In
...
The simplest erasure-coded pool is similar to [RAID5](https://en.wikipedia.org/wiki/Standard_RAID_levels#RAID_5) and
...
More information can be found in the [erasure-code profiles](../erasure-code-profile.md) documentation.
...
file system creation or via [file layouts](../../../cephfs/file-layouts.md).
...
> **Note:**
>
> Most erasure-coded pool deployments require at least k+m CRUSH failure
...
> **Note:**
>
> CephFS and RGW deployments with a significant proportion
...
| k=12 | 1.08 | 1.17 | 1.25 | 1.33 | 1.42 | 1.50 | 1.58 | 1.67 | 1.75 | 1.83 | 1.92 |
| k=20 | 1.05 | 1.10 | 1.15 | 1.20 | 1.25 | 1.30 | 1.35 | 1.40 | 1.45 | 1.50 | 1.55 |

## Erasure-coded pools and cache tiering

> **Note:**
>
> Cache tiering was deprecated in Reef. We strongly advise not deploying new cache tiers, and working to remove them from existing deployments.
...
To overcome these limitations, one can set up a [cache tier](../cache-tiering.md)
...
More information can be found in the [cache tiering](../cache-tiering.md) documentation. Note, however, that cache tiering
...
- [Erasure code profiles](../erasure-code-profile/index.md)
- [Jerasure erasure code plugin](../erasure-code-jerasure/index.md)
- [ISA erasure code plugin](../erasure-code-isa/index.md)
- [Locally repairable erasure code plugin](../erasure-code-lrc/index.md)
- [SHEC erasure code plugin](../erasure-code-shec/index.md)
- [CLAY code plugin](../erasure-code-clay/index.md)
