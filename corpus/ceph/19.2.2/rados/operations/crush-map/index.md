...
version: "19.2.2"
title: "CRUSH Maps"
source_url: https://docs.ceph.com/en/squid/rados/operations/crush-map/
...
[CRUSH - Controlled, Scalable, Decentralized Placement of Replicated Data](https://ceph.io/assets/pdfs/weil-crush-sc06.pdf)
...
![](../../../_images/ditaa-c6820cb15c82bde8e462dfb2ed29fa0ffaa542fe.png)
...
[Migrating from a legacy SSD rule to device classes](../crush-map-edits/index.md#crush-reclassify)).
...
2. A **per-pool** weight set is more flexible in that it allows placement to
...
> **Note:**
>
> Under normal conditions, OSDs automatically add themselves to the
...
`root`
:   Description:
    :   The root node of the CRUSH hierarchy in which the OSD resides (normally `default`).
...
> **Note:**
>
> OSDs are normally removed from the CRUSH map as a result of the
...
read** (see [Pool settings](../../configuration/mon-config-ref/index.md#pool-settings)).
...
> **Note:**
>
> If a primary SSD OSD fails, then requests to the associated PG will
