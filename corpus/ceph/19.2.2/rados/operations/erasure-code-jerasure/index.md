...
source_url: https://docs.ceph.com/en/squid/rados/operations/erasure-code-jerasure/
fetched_at: 2026-07-27T16:42:16+00:00
---
...
The *jerasure* plugin encapsulates the [Jerasure](https://github.com/ceph/jerasure) library. It is
...
Description:
:   Each object is split in **data-chunks** parts,
...
Description:
:   Compute **coding chunks** for each object and store them
...
Description:
:   The more flexible technique is *reed_sol_van* : it is
    ...
    *blaum_roth*, *liber8tion* are *RAID6* equivalents in
    ...
    > **Note:**
    >
    > When using `blaum_roth` coding, the default
    ...
    > commit f51d21b to ceph/ceph](https://github.com/ceph/ceph/commit/f51d21b53d26d4f27c950cb1ba3f989e713ab325) for information about
    ...
    > Applications”](https://github.com/ceph/jerasure/blob/master/Manual.pdf) for an unequivocal statement of the restriction that applies
...
Description:
:   The encoding will be done on packets of *bytes* size at
...
Description:
:   The name of the crush bucket used for the first step of
...
Description:
:   Ensure that no two chunks are in a bucket with the same
