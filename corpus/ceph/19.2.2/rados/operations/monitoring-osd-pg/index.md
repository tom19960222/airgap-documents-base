...
collection: ceph
version: "19.2.2"
title: "Monitoring OSDs and PGs"
source_url: https://docs.ceph.com/en/squid/rados/operations/monitoring-osd-pg/
...
placement](../data-placement.md) introduces a layer of indirection to ensure that data doesn’t bind
...
![](../../../_images/ditaa-83a02a232b72a2f08fddcc5f7d697a751499f16c.png)
...
2. You have just started or restarted the cluster and it’s not ready to show
...
> **Tip:**
>
> Searching through a well-designed CRUSH hierarchy to identify the physical
...
[Placement Group Concepts](../pg-concepts/index.md#rados-operations-pg-concepts).
...
> **Note:**
>
> If the Up Set and the Acting Set do not match, this might indicate
...
![](../../../_images/ditaa-c534576b8b40a180628e34f649b6bfc104bc853d.png)

The OSDs also report their status to the monitor. For details, see [Configuring Monitor/OSD
Interaction](../../configuration/mon-osd-interaction/index.md). To troubleshoot peering issues, see [Peering
Failure](../../troubleshooting/troubleshooting-pg.md#failures-osd-peering).
...
![](../../../_images/ditaa-bfce6c25b264cd756b5f4cf49e07ce71ccd1f775.png)
...
(default: 1; note you cannot change this if the [mClock](../../configuration/mclock-config-ref.rst.md) scheduler is active,
unless you set `osd_mclock_override_recovery_settings = true`, see
[mClock backfill](../../configuration/mclock-config-ref.rst.md#recovery-backfill-options)).
