...
source_url: https://docs.ceph.com/en/squid/rados/operations/erasure-code-lrc/
...
Description:
:   Group the coding and data chunks into sets of size
...
Description:
:   The type of the CRUSH bucket in which each set of chunks
