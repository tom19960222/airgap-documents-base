...
source_url: https://docs.ceph.com/en/squid/rados/operations/operating/
...
| `--allhosts` | `-a` | Execute on all nodes listed in `ceph.conf`. Otherwise, it only executes on `localhost`. |
