...
source_url: https://docs.ceph.com/en/squid/rados/operations/monitoring/
...
To mute a specific health check, use the health check code that corresponds to that health check (see [Health checks](../health-checks/index.md#health-checks)), and
...
> **Note:**
>
> The numbers in the POOLS section are notional. They do not include
...
Placement Groups](../monitoring-osd-pg.md).
...
Runtime](../../configuration/ceph-conf.md#viewing-a-configuration-at-runtime).
