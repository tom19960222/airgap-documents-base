...
source_url: https://docs.ceph.com/en/squid/rados/operations/devices/
...
> **Note:**
>
> Using this command to blink the lights might not work. Whether it
...
> **Note:**
>
> This command works only if the Cephadm or the Rook [orchestrator](https://docs.ceph.com/docs/master/mgr/orchestrator/#orchestrator-cli-module)
...
> **Note:**
>
> The `mon_osd_min_up_ratio` configuration option can help prevent
...
> [DEVICE_HEALTH_TOOMANY](../health-checks/index.md#rados-health-checks-device-health-toomany).
