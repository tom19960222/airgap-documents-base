...
collection: ceph
version: "19.2.2"
title: "CLAY code plugin"
source_url: https://docs.ceph.com/en/squid/rados/operations/erasure-code-clay/
fetched_at: 2026-07-27T16:42:18+00:00
---
# CLAY code plugin
...
Description:
:   Each object is split into **data-chunks** parts,
...
Description:
:   Number of OSDs requested to send data during recovery of
...
Description:
:   **scalar_mds** specifies the plugin that is used as a
...
1. For a configuration with *k=4*, *m=2*, *d=5*, the sub-chunk count is
   ...
   during repair.
2. When *k=8*, *m=4*, *d=11* the sub-chunk count is 64 and repair sub-chunk count
...
2. For small size workloads, *k=4*, *m=2* is a good configuration that provides both network
