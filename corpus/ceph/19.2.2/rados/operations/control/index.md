...
source_url: https://docs.ceph.com/en/squid/rados/operations/control/
...
To write a copy of the most recent OSD map to a file (see [osdmaptool](../../../man/8/osdmaptool/index.md#osdmaptool)), run the following command:
