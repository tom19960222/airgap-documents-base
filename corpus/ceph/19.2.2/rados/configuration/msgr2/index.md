...
version: "19.2.2"
title: "Messenger v2"
source_url: https://docs.ceph.com/en/squid/rados/configuration/msgr2/
...
> - [`ms_bind_ipv4`](../network-config-ref/index.md#confval-ms_bind_ipv4) [default: true] controls whether a daemon binds
>   to an IPv4 address
> - [`ms_bind_ipv6`](../network-config-ref/index.md#confval-ms_bind_ipv6) [default: false] controls whether a daemon binds
>   to an IPv6 address
...
- *secure* mode provides:
  ...
  In Nautilus, secure mode uses the [AES-GCM](https://en.wikipedia.org/wiki/Galois/Counter_Mode) stream cipher,
...
ms_cluster_mode
:   > connection mode (or permitted modes) used for intra-cluster
    ...
    >
    > see also:
    > :   [`ms_service_mode`](index.md#confval-ms_service_mode), [`ms_client_mode`](index.md#confval-ms_client_mode)
...
:   > a list of permitted modes for clients to use when connecting to the
    ...
    >
    > see also:
    > :   [`ms_cluster_mode`](index.md#confval-ms_cluster_mode), [`ms_client_mode`](index.md#confval-ms_client_mode)
...
:   > a list of connection modes, in order of preference, for clients to use
    ...
    >
    > see also:
    > :   [`ms_cluster_mode`](index.md#confval-ms_cluster_mode), [`ms_service_mode`](index.md#confval-ms_service_mode)
...
:   > the connection mode (or permitted modes) to use between monitors.
    ...
    >
    > see also:
    > :   [`ms_mon_service_mode`](index.md#confval-ms_mon_service_mode), [`ms_mon_client_mode`](index.md#confval-ms_mon_client_mode), [`ms_service_mode`](index.md#confval-ms_service_mode), [`ms_cluster_mode`](index.md#confval-ms_cluster_mode), [`ms_client_mode`](index.md#confval-ms_client_mode)
...
:   > a list of permitted modes for clients or other Ceph daemons to use
    ...
    >
    > see also:
    > :   [`ms_service_mode`](index.md#confval-ms_service_mode), [`ms_mon_cluster_mode`](index.md#confval-ms_mon_cluster_mode), [`ms_mon_client_mode`](index.md#confval-ms_mon_client_mode), [`ms_cluster_mode`](index.md#confval-ms_cluster_mode), [`ms_client_mode`](index.md#confval-ms_client_mode)
...
:   > a list of connection modes, in order of preference, for clients or
    ...
    >
    > see also:
    > :   [`ms_mon_service_mode`](index.md#confval-ms_mon_service_mode), [`ms_mon_cluster_mode`](index.md#confval-ms_mon_cluster_mode), [`ms_service_mode`](index.md#confval-ms_service_mode), [`ms_cluster_mode`](index.md#confval-ms_cluster_mode), [`ms_client_mode`](index.md#confval-ms_client_mode)
...
ms_compress_secure
:   > Combining encryption with compression reduces the level of security of
    ...
    > compressed. This behaviour can be override using this setting.
    >
    > type:
    > :   `bool`
    >
    ...
    >
    > see also:
    > :   [`ms_osd_compress_mode`](index.md#confval-ms_osd_compress_mode)
...
:   > Compression policy to use in Messenger for communicating with OSD
    ...
    >
    > see also:
    > :   [`ms_compress_secure`](index.md#confval-ms_compress_secure)
...
:   > Compression algorithm for connections with OSD in order of preference
    > Although the default value is set to snappy, a list (like snappy zlib
    > zstd etc.) is acceptable as well.
    >
    > type:
    > :   `str`
    >
...
For a detailed description of the v2 wire protocol, see [msgr2 protocol (msgr2.0 and msgr2.1)](../../../dev/msgr2/index.md#msgr2-protocol).
