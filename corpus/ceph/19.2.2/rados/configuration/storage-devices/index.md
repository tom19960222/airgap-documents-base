...
source_url: https://docs.ceph.com/en/squid/rados/configuration/storage-devices/
...
For more information, see [BlueStore Configuration Reference](../bluestore-config-ref/index.md) and [BlueStore Migration](../../operations/bluestore-migration/index.md).
...
For more information, see [Filestore Config Reference](../filestore-config-ref/index.md).
