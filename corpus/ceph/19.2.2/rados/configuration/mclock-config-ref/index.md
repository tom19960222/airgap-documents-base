...
collection: ceph
version: "19.2.2"
title: "mClock Config Reference"
source_url: https://docs.ceph.com/en/squid/rados/configuration/mclock-config-ref/
fetched_at: 2026-07-27T16:39:34+00:00
---
# mClock Config Reference

QoS support in Ceph is implemented using a queuing scheduler based on [the
dmClock algorithm](https://www.usenix.org/legacy/event/osdi10/tech/full_papers/Gulati.pdf). See [QoS Based on mClock](../osd-config-ref/index.md#dmclock-qos) section for more details.
...
- total capacity (IOPS) of each OSD (determined automatically -
  See [OSD Capacity Determination (Automated)](index.md#osd-capacity-determination-automated))
...
(see [QoS Based on mClock](../osd-config-ref/index.md#dmclock-qos)) differently for each client type. The next sections
...
described in the [QoS Based on mClock](../osd-config-ref/index.md#dmclock-qos) section.
...
> **Note:**
>
> The values mentioned in the tables below represent the proportion
...
> **Note:**
>
> Across the built-in profiles, internal background best-effort clients
...
[`osd_op_num_shards_hdd`](../osd-config-ref/index.md#confval-osd_op_num_shards_hdd). Items are queued and dequeued by one or
more worker threads and this is controlled by configuration
[`osd_op_num_threads_per_shard_hdd`](../osd-config-ref/index.md#confval-osd_op_num_threads_per_shard_hdd).

As described in [Caveats](../osd-config-ref/index.md#dmclock-qos-caveats), the number of OSD shards employed
...
| --- | --- | --- |
| [`osd_op_num_shards_hdd`](../osd-config-ref/index.md#confval-osd_op_num_shards_hdd) | 5 | 1 |
| [`osd_op_num_threads_per_shard_hdd`](../osd-config-ref/index.md#confval-osd_op_num_threads_per_shard_hdd) | 1 | 5 |
...
> **Important:**
>
> These defaults cannot be changed using any of the config
...
- [`osd_mclock_scheduler_client_res`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_client_res)
- [`osd_mclock_scheduler_client_wgt`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_client_wgt)
- [`osd_mclock_scheduler_client_lim`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_client_lim)
- [`osd_mclock_scheduler_background_recovery_res`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_recovery_res)
- [`osd_mclock_scheduler_background_recovery_wgt`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_recovery_wgt)
- [`osd_mclock_scheduler_background_recovery_lim`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_recovery_lim)
- [`osd_mclock_scheduler_background_best_effort_res`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_best_effort_res)
- [`osd_mclock_scheduler_background_best_effort_wgt`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_best_effort_wgt)
- [`osd_mclock_scheduler_background_best_effort_lim`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_background_best_effort_lim)
...
- [`osd_max_backfills`](../osd-config-ref/index.md#confval-osd_max_backfills)
- [`osd_recovery_max_active`](../osd-config-ref/index.md#confval-osd_recovery_max_active)
- [`osd_recovery_max_active_hdd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_hdd)
- [`osd_recovery_max_active_ssd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_ssd)
...
| --- | --- | --- |
| [`osd_max_backfills`](../osd-config-ref/index.md#confval-osd_max_backfills) | 1 | 1 |
| [`osd_recovery_max_active`](../osd-config-ref/index.md#confval-osd_recovery_max_active) | 0 | 0 |
| [`osd_recovery_max_active_hdd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_hdd) | 3 | 3 |
| [`osd_recovery_max_active_ssd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_ssd) | 10 | 10 |

The above mClock defaults, can be modified only if necessary by enabling
[`osd_mclock_override_recovery_settings`](index.md#confval-osd_mclock_override_recovery_settings) (default: false). The
steps for this is discussed in the
[Steps to Modify mClock Max Backfills/Recovery Limits](index.md#steps-to-modify-mclock-max-backfills-recovery-limits) section.
...
- [`osd_recovery_sleep`](../osd-config-ref/index.md#confval-osd_recovery_sleep)
- [`osd_recovery_sleep_hdd`](../osd-config-ref/index.md#confval-osd_recovery_sleep_hdd)
- [`osd_recovery_sleep_ssd`](../osd-config-ref/index.md#confval-osd_recovery_sleep_ssd)
- [`osd_recovery_sleep_hybrid`](../osd-config-ref/index.md#confval-osd_recovery_sleep_hybrid)
- [`osd_recovery_sleep_degraded`](../osd-config-ref/index.md#confval-osd_recovery_sleep_degraded)
- [`osd_recovery_sleep_degraded_hdd`](../osd-config-ref/index.md#confval-osd_recovery_sleep_degraded_hdd)
- [`osd_recovery_sleep_degraded_ssd`](../osd-config-ref/index.md#confval-osd_recovery_sleep_degraded_ssd)
- [`osd_recovery_sleep_degraded_hybrid`](../osd-config-ref/index.md#confval-osd_recovery_sleep_degraded_hybrid)
- [`osd_scrub_sleep`](../osd-config-ref/index.md#confval-osd_scrub_sleep)
- [`osd_delete_sleep`](../osd-config-ref/index.md#confval-osd_delete_sleep)
- [`osd_delete_sleep_hdd`](../osd-config-ref/index.md#confval-osd_delete_sleep_hdd)
- [`osd_delete_sleep_ssd`](../osd-config-ref/index.md#confval-osd_delete_sleep_ssd)
- [`osd_delete_sleep_hybrid`](../osd-config-ref/index.md#confval-osd_delete_sleep_hybrid)
- [`osd_snap_trim_sleep`](../osd-config-ref/index.md#confval-osd_snap_trim_sleep)
- [`osd_snap_trim_sleep_hdd`](../osd-config-ref/index.md#confval-osd_snap_trim_sleep_hdd)
- [`osd_snap_trim_sleep_ssd`](../osd-config-ref/index.md#confval-osd_snap_trim_sleep_ssd)
- [`osd_snap_trim_sleep_hybrid`](../osd-config-ref/index.md#confval-osd_snap_trim_sleep_hybrid)
...
[`osd_mclock_profile`](index.md#confval-osd_mclock_profile) may be set during runtime by using the following
command:
...
> **Note:**
>
> The *custom* profile is not recommended unless you are an advanced
> user.
...
> **Important:**
>
> Care must be taken to change the reservations of other services
...
> [`osd_op_num_shards_hdd`](../osd-config-ref/index.md#confval-osd_op_num_shards_hdd) and [`osd_op_num_shards_ssd`](../osd-config-ref/index.md#confval-osd_op_num_shards_ssd) for
> more details.
...
1. Set the desired built-in profile using:
   ...
   ```
2. Determine the existing custom mClock configuration settings in the central
   config database using the following command:

   ```
   ceph config dump
   ```
3. Remove the custom mClock configuration settings determined in the previous
   ...
   [`osd_mclock_scheduler_client_res`](../osd-config-ref/index.md#confval-osd_mclock_scheduler_client_res) that was set on all OSDs, run the
   following command:

   ```
   ceph config rm osd osd_mclock_scheduler_client_res
   ```
4. After all existing custom mClock configuration settings have been removed
...
1. Run the *injectargs* command as shown to override the mclock settings:
   ...
   [`osd_mclock_profile`](index.md#confval-osd_mclock_profile) option on osd.0:
...
> **Important:**
>
> The max backfill/recovery options that can be modified are listed
> in section [Recovery/Backfill Options](index.md#recovery-backfill-options). The modification of the mClock
> default backfills/recovery limit is gated by the
> [`osd_mclock_override_recovery_settings`](index.md#confval-osd_mclock_override_recovery_settings) option, which is set to
...
1. Set the [`osd_mclock_override_recovery_settings`](index.md#confval-osd_mclock_override_recovery_settings) config option on all
   osds to *true* using:
...
2. Set the desired max backfill/recovery option using:
   ...
   For example, the following command modifies the [`osd_max_backfills`](../osd-config-ref/index.md#confval-osd_max_backfills)
   option on all osds to 5.

   ```
   ceph config set osd osd_max_backfills 5
   ```
3. Wait for a few seconds and verify the running configuration for a specific
   OSD using:
   ...
   [`osd_max_backfills`](../osd-config-ref/index.md#confval-osd_max_backfills) on osd.0.

   ```
   ceph config show osd.0 | grep osd_max_backfills
   ```
4. Reset the [`osd_mclock_override_recovery_settings`](index.md#confval-osd_mclock_override_recovery_settings) config option on
...
> **Note:**
>
> If you wish to manually benchmark OSD(s) or manually tune the
> Bluestore throttle parameters, see section
> [Steps to Manually Benchmark an OSD (Optional)](index.md#steps-to-manually-benchmark-an-osd-optional).
...
- [`osd_mclock_iops_capacity_threshold_hdd`](index.md#confval-osd_mclock_iops_capacity_threshold_hdd) = 500
- [`osd_mclock_iops_capacity_threshold_ssd`](index.md#confval-osd_mclock_iops_capacity_threshold_ssd) = 80000
...
default value of [`osd_mclock_max_capacity_iops_hdd`](index.md#confval-osd_mclock_max_capacity_iops_hdd) or
[`osd_mclock_max_capacity_iops_ssd`](index.md#confval-osd_mclock_max_capacity_iops_ssd). The threshold config options
...
in the [`Specifying Max OSD Capacity`_](index.md#id2) section.
...
As already described in the [QoS Based on mClock](../osd-config-ref/index.md#dmclock-qos) section, the number of
...
:   We recommend using the default values as defined by
    [`bluestore_throttle_bytes`](../bluestore-config-ref/index.md#confval-bluestore_throttle_bytes) and
    [`bluestore_throttle_deferred_bytes`](../bluestore-config-ref/index.md#confval-bluestore_throttle_deferred_bytes). But these parameters may also be
    determined during the benchmarking phase as described below.

### OSD Bench Command Syntax

The [OSD Subsystem](../../operations/control/index.md#osd-subsystem) section describes the OSD bench command. The syntax
...
2. Run a simple 4KiB random write workload on an OSD using the following
   commands:
   ...
   ```
3. Note the overall throughput(IOPS) obtained from the output of the osd bench
...
4. If the intent is to determine the bluestore throttle values for your
   environment, then set the two options, [`bluestore_throttle_bytes`](../bluestore-config-ref/index.md#confval-bluestore_throttle_bytes)
   and [`bluestore_throttle_deferred_bytes`](../bluestore-config-ref/index.md#confval-bluestore_throttle_deferred_bytes) to 32 KiB(32768 Bytes) each
...
7. If the throughput doesn’t match with the baseline, increment the bluestore
...
[Config File Section Names](../ceph-conf/index.md#ceph-conf-settings) for more details.
...
> > **Note:**
> >
> > The examples use [`osd_mclock_max_capacity_iops_hdd`](index.md#confval-osd_mclock_max_capacity_iops_hdd) and
> > the steps are also applicable for SSD based OSDs in which case
> > the option to use is [`osd_mclock_max_capacity_iops_ssd`](index.md#confval-osd_mclock_max_capacity_iops_ssd).
...
1. Run the following command to verify the individual values set for the OSDs in
   ...
   > ```
2. If there are no individual values reported, skip to the next step. Otherwise,
   ...
   > ```
3. Confirm that the ceph config dump command from step 1 does not show any
   individual values.
4. Set the global value of osd_mclock_max_capacity_iops_hdd with a command of
   the following form:

   > ```
   > ceph config set global osd_mclock_max_capacity_iops_hdd 111
   > ```
5. Confirm that the global option is set by running:
   ...
   > ```
6. Confirm that the global setting is now in effect for any OSD that no longer
...
:   > This sets the type of mclock profile to use for providing QoS
    ...
    >
    > see also:
    > :   [`osd_op_queue`](../osd-config-ref/index.md#confval-osd_op_queue)

osd_mclock_max_capacity_iops_hdd
:   > Max random write IOPS capacity (at 4 KiB block size) to consider per
...
:   > The maximum sequential bandwidth in bytes/second to consider for the
    > OSD (for rotational media)
    >
    > type:
    > :   `size`
...
:   > Force run the OSD benchmark on OSD initialization/boot-up
    ...
    >
    > see also:
    > :   [`osd_mclock_max_capacity_iops_hdd`](index.md#confval-osd_mclock_max_capacity_iops_hdd), [`osd_mclock_max_capacity_iops_ssd`](index.md#confval-osd_mclock_max_capacity_iops_ssd)
...
:   > Setting this option will enable the override of the recovery/backfill
    ...
    >
    > see also:
    > :   [`osd_recovery_max_active_hdd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_hdd), [`osd_recovery_max_active_ssd`](../osd-config-ref/index.md#confval-osd_recovery_max_active_ssd), [`osd_max_backfills`](../osd-config-ref/index.md#confval-osd_max_backfills)

osd_mclock_iops_capacity_threshold_hdd
:   > The threshold IOPS capacity (at 4KiB block size) beyond which to
    ...
    >
    > see also:
    > :   [`osd_mclock_max_capacity_iops_hdd`](index.md#confval-osd_mclock_max_capacity_iops_hdd)

osd_mclock_iops_capacity_low_threshold_hdd
:   > The threshold IOPS capacity (at 4KiB block size) below which to ignore
...
:   > The threshold IOPS capacity (at 4KiB block size) beyond which to
    ...
    >
    > see also:
    > :   [`osd_mclock_max_capacity_iops_ssd`](index.md#confval-osd_mclock_max_capacity_iops_ssd)
