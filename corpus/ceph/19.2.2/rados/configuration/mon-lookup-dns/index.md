...
collection: ceph
version: "19.2.2"
title: "Looking up Monitors through DNS"
source_url: https://docs.ceph.com/en/squid/rados/configuration/mon-lookup-dns/
...
:   > the service name used querying the DNS for the monitor hosts/addresses
    ...
    >
    > see also:
    > :   [`mon_host`](../ceph-conf/index.md#confval-mon_host)
...
See also [Messenger v2](msgr2.md).
