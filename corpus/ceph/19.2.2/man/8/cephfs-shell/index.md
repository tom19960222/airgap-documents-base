...
collection: ceph
version: "19.2.2"
title: "cephfs-shell -- Shell-like tool talking with CephFS"
source_url: https://docs.ceph.com/en/squid/man/8/cephfs-shell/
...
[CephFS Shell Configuration File](index.md#cephfs-shell-configuration-file) for details.
...
> **Note:**
>
> This command is available as `pyscript` for cmd2 versions 0.9.13
> or less.
...
> **Note:**
>
> This command is available as `load` for cmd2 versions 0.9.13
> or less.
