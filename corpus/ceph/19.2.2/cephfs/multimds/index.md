...
source_url: https://docs.ceph.com/en/squid/cephfs/multimds/
...
See [CephFS Administrative commands](../administration/index.md) for more details which forms `<role>` can
take.
