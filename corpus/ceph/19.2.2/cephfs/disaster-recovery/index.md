...
source_url: https://docs.ceph.com/en/squid/cephfs/disaster-recovery/
...
separate page: [Advanced: Metadata repair tools](../disaster-recovery-experts/index.md#disaster-recovery-experts).
...
3. Fail the file system:
   ...
   ```
4. Recover dentries from the journal. If the MDS flushed the journal
...
7. Optionally, remove the damaged dentries:
   ...
   > **Note:**
   >
   > use `--memo` to specify a different file to save objects that
