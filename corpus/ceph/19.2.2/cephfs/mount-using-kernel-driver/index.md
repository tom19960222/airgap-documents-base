...
collection: ceph
version: "19.2.2"
title: "Mount CephFS using Kernel Driver"
source_url: https://docs.ceph.com/en/squid/cephfs/mount-using-kernel-driver/
fetched_at: 2026-07-27T16:40:00+00:00
---
...
> **Note:**
>
> The CephFS mount device string now uses a new syntax (“v2”). The
...
as described on the [Mount CephFS: Prerequisites](../mount-prerequisites.md) page.
...
2. `fsid` is the FSID of the Ceph cluster, which can be found using the
...
> **Note:**
>
> Note that the dot (`.` in the string `cephuser@.cephfs`) must be
...
> **Note:**
>
> The option `mds_namespace` is deprecated. Use `fs=` instead when
...
See [User Management](../../rados/operations/user-management/index.md) for details on CephX user management and the [mount.ceph](../../man/8/mount.ceph/index.md)
manual for a list of the options it recognizes. For troubleshooting, see
[Kernel mount debugging](../troubleshooting/index.md#kernel-mount-debugging).
