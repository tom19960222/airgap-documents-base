...
collection: ceph
version: "19.2.2"
title: "Snapshot Scheduling Module"
source_url: https://docs.ceph.com/en/squid/cephfs/snap-schedule/
...
This module uses [CephFS Snapshots](../../dev/cephfs-snapshots/index.md), please consider this documentation
as well.
...
multi-fs setups and [FS volumes and subvolumes](../fs-volumes/index.md) managed setups. If not
passed fs defaults to the first file system listed in the fs_map.
When using [FS volumes and subvolumes](../fs-volumes/index.md) the argument fs is equivalent to a
volume.
