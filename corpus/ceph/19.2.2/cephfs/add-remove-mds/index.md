...
collection: ceph
version: "19.2.2"
title: "Deploying Metadata Servers"
source_url: https://docs.ceph.com/en/squid/cephfs/add-remove-mds/
fetched_at: 2026-07-27T16:39:53+00:00
---
> **Note:**
>
> It is highly recommended to use [Cephadm](../../cephadm/index.md) or another Ceph
...
> manual way for deploying MDS daemons, [MDS Service](../../cephadm/services/mds/index.md) can
> also be used.
...
MDS cache size (see also [MDS Cache Configuration](../cache-configuration/index.md)) is 4GB. It is
...
standby MDS (see also [Terminology](../standby/index.md#mds-standby)) for rapid failover. To get a real
...
4. The status of the cluster should show:
   ...
   ```
5. Optionally, configure the file system the MDS should join ([Configuring MDS file system affinity](../standby/index.md#mds-join-fs)):
...
1. (Optionally:) Create a new replacement Metadata Server. If there are no
