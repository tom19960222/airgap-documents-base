...
version: "19.2.2"
title: "File layouts"
source_url: https://docs.ceph.com/en/squid/cephfs/file-layouts/
...
Clients must use the `p` flag when writing a file’s layout. See [Layout
and Quota restriction (the ‘p’ flag)](../client-auth/index.md#cephfs-layout-and-quota-restriction).
