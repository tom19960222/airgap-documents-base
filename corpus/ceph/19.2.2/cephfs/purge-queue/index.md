...
version: "19.2.2"
title: "Purge Queue"
source_url: https://docs.ceph.com/en/squid/cephfs/purge-queue/
...
> **Note:**
>
> If the users delete the files more quickly than the
...
filer_max_purge_ops
:   > Max in-flight operations for purging a striped range (e.g., MDS
    > journal)
    >
    > type:
    > :   `uint`
...
mds_max_purge_files
:   > maximum number of deleted files to purge in parallel
    >
    > type:
    > :   `uint`
    >
...
mds_max_purge_ops
:   > maximum number of purge operations performed in parallel
    >
    > type:
    > :   `uint`
    >
...
:   > number of parallel purge operations performed per PG
    >
    > type:
    > :   `float`
    >
...
> **Note:**
>
> Setting these values won’t immediately break anything except
...
> **Note:**
>
> The purge queue is not an auto-tuning system in terms of its work
...
| pq_executing_ops_high_water | Maximum number of executing purge operations recorded |
...
> **Note:**
>
> `pq_executing` and `pq_executing_ops` might look similar but
