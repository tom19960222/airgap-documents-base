...
source_url: https://docs.ceph.com/en/squid/cephfs/full/
...
more on the epoch barrier mechanism, see [Background: Blocklisting and OSD epoch barrier](../eviction/index.md#background-blocklisting-and-osd-epoch-barrier).
