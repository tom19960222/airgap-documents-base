...
version: "19.2.2"
title: "Metrics"
source_url: https://docs.ceph.com/en/squid/cephfs/metrics/
fetched_at: 2026-07-27T16:40:11+00:00
---
# Metrics

CephFS uses [Perf counters](../../dev/perf_counters/index.md#perf-counters) to track metrics. The counters can be labeled ([Labeled Perf Counters](../../dev/perf_counters/index.md#labeled-perf-counters)).

## Client Metrics

CephFS exports client metrics as [Labeled Perf Counters](../../dev/perf_counters/index.md#labeled-perf-counters), which could be used to monitor the client performance. CephFS exports the below client metrics.
...
| dentry_lease_hits | Gauge | Percentage of dentry lease hits handed out over the total dentry lease requests |
