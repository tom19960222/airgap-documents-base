...
collection: ceph
version: "19.2.2"
title: "Create a Ceph file system"
source_url: https://docs.ceph.com/en/squid/cephfs/createfs/
...
- We strongly suggest that the CephFS metadata pool be provisioned on dedicated
  ...
  impact metadata operations. See [Device classes](../../rados/operations/crush-map/index.md#device-classes) to configure pools this
  way.
- The data pool used to create the file system is the “default” data pool and
  ...
  data pool can be added (see also [Erasure code](../../rados/operations/erasure-code/index.md#ecpool)) that can be used on an entire
  hierarchy of directories and files (see also [File layouts](../file-layouts/index.md#file-layouts)).

Refer to [Pools](../../rados/operations/pools/index.md) to learn more about managing pools. For
...
> **Note:**
>
> The names of the file systems, metadata pools, and data pools can
> only have characters in the set [a-zA-Z0-9_-.].
...
- To set an erasure-coded pool for the default data pool. Use of an EC pool for the
  default data pool is discouraged. Refer to [Creating pools](index.md#creating-pools) for details.
...
See [Adding a data pool to the File System](../file-layouts/index.md#adding-data-pool-to-file-system).
