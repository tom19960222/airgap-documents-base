...
collection: ceph
version: "19.2.2"
title: "Ceph file system client eviction"
source_url: https://docs.ceph.com/en/squid/cephfs/eviction/
...
2. On an active MDS daemon, if a client has not responded to cap revoke messages
