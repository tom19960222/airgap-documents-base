...
collection: ceph
version: "19.2.2"
title: "CephFS Directory Entry Name Normalization and Case Folding"
source_url: https://docs.ceph.com/en/squid/cephfs/charmap/
...
> **Note:**
>
> You can remove a `charmap` on a subdirectory which inherited
...
> **Note:**
>
> For more information about Unicode normalization forms, please see [Unicode normalization standard documents](https://unicode.org/reports/tr15/).
...
> **Note:**
>
> The MDS maintains an `alternate_name` metadata (also used for
...
> **Note:**
>
> Normalization is applied before case folding. The directory entry name used
...
> **Note:**
>
> The kernel driver does not understand the `charmap` feature
