...
collection: ceph
version: "19.2.2"
title: "CephFS Distributed Metadata Cache"
source_url: https://docs.ceph.com/en/squid/cephfs/mdcache/
...
(aka **caps**) for each inode (see [Capabilities in CephFS](../capabilities/index.md)).
