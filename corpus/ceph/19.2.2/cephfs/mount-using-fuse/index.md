...
source_url: https://docs.ceph.com/en/squid/cephfs/mount-using-fuse/
fetched_at: 2026-07-27T16:40:00+00:00
---
# Mount CephFS using FUSE

[ceph-fuse](../../man/8/ceph-fuse/index.md#options) is an alternate way of mounting CephFS, although it mounts it
...
in [Mount CephFS: Prerequisites](../mount-prerequisites.md) page.
...
> **Tip:**
>
> Ensure that no shell or other processes have open files under the file system
...
See [User Management](../../rados/operations/user-management/index.md#user-management) for details on CephX user management and [ceph-fuse](../../man/8/ceph-fuse/index.md#options)
manual for more options it can take. For troubleshooting, see
[ceph-fuse debugging](../troubleshooting/index.md#ceph-fuse-debugging).
