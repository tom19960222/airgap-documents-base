...
source_url: https://docs.ceph.com/en/squid/radosgw/s3select/
fetched_at: 2026-07-27T16:40:45+00:00
---
# [Ceph s3 select](index.md#id1)

Contents

- [Ceph s3 select](index.md#ceph-s3-select)

  - [Overview](index.md#overview)
  - [Basic Workflow](index.md#basic-workflow)

    - [Basic Functionalities](index.md#basic-functionalities)
    - [Error Handling](index.md#error-handling)
  - [Features Support](index.md#features-support)

    - [NULL](index.md#null)
  - [S3-select Function Interfaces](index.md#s3-select-function-interfaces)

    - [Timestamp Functions](index.md#timestamp-functions)
    - [to_string parameters](index.md#to-string-parameters)
    - [Aggregation Functions](index.md#aggregation-functions)
    - [String Functions](index.md#string-functions)
    - [SQL Limit Operator](index.md#sql-limit-operator)
    - [Alias](index.md#alias)
    - [Testing](index.md#testing)
    - [Additional Syntax Support](index.md#additional-syntax-support)
  - [Sending Query to RGW](index.md#sending-query-to-rgw)

    - [Input Serialization](index.md#input-serialization)
    - [Output Serialization](index.md#output-serialization)
    - [Scan Range Option](index.md#scan-range-option)
  - [CSV Parsing Behavior](index.md#csv-parsing-behavior)
  - [JSON](index.md#json)
  - [A JSON Query Example](index.md#a-json-query-example)
  - [BOTO3](index.md#boto3)
  - [S3 SELECT Responses](index.md#s3-select-responses)

    - [Error Response](index.md#error-response)
    - [Report Response](index.md#report-response)
    - [Response Description](index.md#response-description)

## [Overview](index.md#id2)
...
### [Basic Functionalities](index.md#id4)
...
review the below [s3-select-feature-table](index.md#s3-select-feature-table).

### [Error Handling](index.md#id5)
...
| logical operator and NULL | unknown state | review [null-handle](index.md#null-handle) observe how logical operator result with null. the following query return **0**.  select count(\*) from s3object where null and (3>2); |
| Arithmetic operator with NULL | unknown state | review [null-handle](index.md#null-handle) observe the results of binary operations with NULL the following query return **0**.  select count(\*) from s3object where (null+1) and (3>2); |
| compare with NULL | unknown state | review [null-handle](index.md#null-handle) observe results of compare operations with NULL the following query return **0**.  select count(\*) from s3object where (null\*1.5) != 3; |
| missing column | unknown state | select count(\*) from s3object where _1 is null; |
| query is filtering rows where predicate is returning non null results. this predicate will return null upon _1 or _2 is null | | select count(\*) from s3object where (_1 > 12 and _2 = 0) is not null; |
...
| projection column | similar to if/then/else | select case when (1+1=(2+1)\*3) then ‘case_1’ when ((4\*3)=(12)) then ‘case_2’ else ‘case_else’ end, age\*2 from s3object; |
| logical operator | `coalesce {expression,expression ...} :: return first non-null argument`  select coalesce(nullif(5,5),nullif(1,1.0),age+12) from s3object; | |
| logical operator | `nullif {expr1,expr2} ::return null in case both arguments are equal,` `or else the first one`  select nullif(cast(_1 as int),cast(_2 as int)) from s3object; | |
...
| logical operator | `{expression} between {expression} and {expression}`  select count(\*) from s3object where substring(_3,char_length(_3),1) between “x” and trim(_1) and substring(_3,char_length(_3)-1,1) = “:”; | |
...
| logical operator | `{expression} like {match-pattern} escape {char}`  select count(\*) from s3object where “jok_ai” like “%#_ai” escape “#”; | |
| true / false predicate as a projection | select (cast(_1 as int)>123 = true) from s3object where address like ‘%new-york%’; | |
| an alias to predicate as a projection | select (_1 like “_3_”) as *likealias*,_1 from s3object where *likealias* = true and cast(_1 as int) between 800 and 900; | |
...
| Timestamp Functions | date_add | select count(0) from s3object where date_diff(year,to_timestamp(_1),date_add(day,366, to_timestamp(_1))) = 1; |
| Timestamp Functions | date_diff | select count(0) from s3object where date_diff(month,to_timestamp(_1),to_timestamp(_2))) = 2; |
| Timestamp Functions | utcnow | select count(0) from s3object where date_diff(hours,utcnow(),date_add(day,1,utcnow())) = 24; |
| Timestamp Functions | to_string | select to_string( to_timestamp(“2009-09-17T17:56:06.234567Z”), “yyyyMMdd-H:m:s”) from s3object;  `result: "20090917-17:56:6"` |
...
## [S3-select Function Interfaces](index.md#id8)

### [Timestamp Functions](index.md#id9)
...
### [to_string parameters](index.md#id10)
...
### [Aggregation Functions](index.md#id11)
...
### [String Functions](index.md#id12)
...
### [SQL Limit Operator](index.md#id13)
...
### [Additional Syntax Support](index.md#id16)
...
## [Sending Query to RGW](index.md#id17)
...
### [Input Serialization](index.md#id18)
...
### [Output Serialization](index.md#id19)
...
### [Scan Range Option](index.md#id20)
...
## [CSV Parsing Behavior](index.md#id21)
...
## [A JSON Query Example](index.md#id23)
...
## [S3 SELECT Responses](index.md#id25)

### [Error Response](index.md#id26)
...
### [Response Description](index.md#id28)
