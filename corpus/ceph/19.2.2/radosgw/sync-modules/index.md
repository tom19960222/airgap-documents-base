...
version: "19.2.2"
title: "Sync Modules"
source_url: https://docs.ceph.com/en/squid/radosgw/sync-modules/
...
The [Multi-Site](../multisite/index.md#multisite) functionality of RGW introduced in Jewel allowed the ability to
...
- [ElasticSearch Sync Module](../elastic-sync-module/index.md)
- [Cloud Sync Module](../cloud-sync-module/index.md)
- [Archive Sync Module](../archive-sync-module/index.md)

## Requirements and Assumptions

Let us assume a simple multisite configuration as described in the [Multi-Site](../multisite/index.md#multisite)
...
Create the third zone similar to the [Multi-Site](../multisite/index.md#multisite) docs, for example
