...
source_url: https://docs.ceph.com/en/squid/radosgw/bucketpolicy/
...
> **Note:**
>
> This list of S3 actions is accurate only for the Squid release of
...
| s3:ListBucket &  s3:ListBucketVersions | s3:prefix |  |
| s3:delimiter |  |
| s3:max-keys |  |
