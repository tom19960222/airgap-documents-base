...
collection: ceph
version: "19.2.2"
title: "Session tags for Attribute Based Access Control in STS"
source_url: https://docs.ceph.com/en/squid/radosgw/session-tags/
...
[Integrating Keycloak with RadosGW](../keycloak/index.md#radosgw-keycloak).
...
role tagging can be found here [Role](../role/index.md).
