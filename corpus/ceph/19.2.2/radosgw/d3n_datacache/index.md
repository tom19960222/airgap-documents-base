...
collection: ceph
version: "19.2.2"
title: "D3N RGW Data Cache"
source_url: https://docs.ceph.com/en/squid/radosgw/d3n_datacache/
fetched_at: 2026-07-27T16:40:46+00:00
---
# [D3N RGW Data Cache](index.md#id1)

Contents

- [D3N RGW Data Cache](index.md#d3n-rgw-data-cache)
  ...
  - [D3N Environment Setup](index.md#d3n-environment-setup)
...
D3Ns two-layer logical cache forms a traditional caching hierarchy \*
...
- D3N currently caches only tail objects, because they are immutable (by default it is parts of objects that are larger than 4MB).
  (the NGINX [RGW Data cache and CDN](../rgw-cache/index.md) supports caching of all object sizes)

### [Requirements](index.md#id4)
...
### [Limitations](index.md#id5)

- D3N will not cache objects compressed by [Rados Gateway Compression](../compression/index.md) (OSD level compression is supported).
- D3N will not cache objects encrypted by [Rados Gateway Encryption](../encryption/index.md).
...
## [D3N Environment Setup](index.md#id6)

### [Running](index.md#id7)
