...
source_url: https://docs.ceph.com/en/squid/radosgw/notifications/
fetched_at: 2026-07-27T16:40:40+00:00
---
# [Bucket Notifications](index.md#id5)

New in version Nautilus.

Changed in version Squid: A new “v2” format for Topic and Notification metadata can be enabled with
the [notification_v2](../zone-features/index.md#feature-notification-v2) zone feature.
...
- [Bucket Notifications](index.md#bucket-notifications)

  - [Notification Reliability](index.md#notification-reliability)

    - [Synchronous Notifications](index.md#synchronous-notifications)
    - [Asynchronous Notifications](index.md#asynchronous-notifications)
  - [Topic Management via CLI](index.md#topic-management-via-cli)
  - [Notification Performance Statistics](index.md#notification-performance-statistics)
  - [Bucket Notification REST API](index.md#bucket-notification-rest-api)

    - [Topics](index.md#topics)

      - [Create a Topic](index.md#create-a-topic)
      - [Get Topic Attributes](index.md#get-topic-attributes)
      - [Get Topic Information](index.md#get-topic-information)
      - [Delete Topic](index.md#delete-topic)
      - [List Topics](index.md#list-topics)
      - [Set Topic Attributes](index.md#set-topic-attributes)
...
- [S3 Bucket Notification Compatibility](../s3-notification-compatibility/index.md)

> **Note:**
>
> To enable bucket notifications API, the rgw_enable_apis configuration parameter should contain: “notifications”.

## [Notification Reliability](index.md#id6)
...
### [Synchronous Notifications](index.md#id7)
...
> **Note:**
>
> The original triggering operation is considered successful even if
> the notification fails with an error, cannot be delivered, or times out.

### [Asynchronous Notifications](index.md#id8)
...
> **Note:**
>
> If the notification fails with an error, cannot be delivered, or
...
## [Topic Management via CLI](index.md#id9)
...
## [Notification Performance Statistics](index.md#id10)
...
## [Bucket Notification REST API](index.md#id11)

### [Topics](index.md#id12)
...
> **Tip:**
>
> Any notification already associated with the topic must be re-created
...
> **Tip:**
>
> The topic-name (see [Create a Topic](index.md#create-a-topic)) is used for the
...
#### [Get Topic Attributes](index.md#id14)
...
#### [Get Topic Information](index.md#id15)
...
#### [Set Topic Attributes](index.md#id18)
...
- eventName: For the list of supported events see: [S3 Notification
  Compatibility](../s3-notification-compatibility.md). Note that eventName values do not start with the s3:
  prefix.
