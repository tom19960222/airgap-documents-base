...
source_url: https://docs.ceph.com/en/squid/radosgw/kmip/
...
![](../../_images/ditaa-2d83e816e55924eb5c1d3e3dcfff237b723766d4.png)

1. [Setting KMIP Access for Ceph](index.md#setting-kmip-access-for-ceph)
2. [Creating Keys in KMIP](index.md#creating-keys-in-kmip)
3. [Configure the Ceph Object Gateway](index.md#configure-the-ceph-object-gateway)
4. [Upload object](index.md#upload-object)
...
IBM [SKLM](https://www.ibm.com/products/ibm-security-key-lifecycle-manager) supports client authentication using certificates.
