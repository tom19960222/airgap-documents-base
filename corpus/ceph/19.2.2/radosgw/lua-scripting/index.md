...
version: "19.2.2"
title: "Lua Scripting"
source_url: https://docs.ceph.com/en/squid/radosgw/lua-scripting/
fetched_at: 2026-07-27T16:40:46+00:00
---
# [Lua Scripting](index.md#id1)

New in version Pacific.

Contents

- [Lua Scripting](index.md#lua-scripting)

  - [Script Management via CLI](index.md#script-management-via-cli)
  - [Package Management via CLI](index.md#package-management-via-cli)
  - [Context Free Functions](index.md#context-free-functions)

    - [Debug Log](index.md#debug-log)
  - [Request Fields](index.md#request-fields)
  - [Request Functions](index.md#request-functions)

    - [Operations Log](index.md#operations-log)
    - [Tracing](index.md#tracing)
  - [Background Context](index.md#background-context)
  - [Data Context](index.md#data-context)
  - [Global RGW Table](index.md#global-rgw-table)

    - [Increment/Decrement Functions](index.md#increment-decrement-functions)
  - [Lua Code Samples](index.md#lua-code-samples)
...
The request context script can also access fields in the request and modify certain fields, as well as the [Global RGW Table](index.md#global-rgw-table).
The data context script can access the content of the object as well as the request fields and the [Global RGW Table](index.md#global-rgw-table).
...
## [Script Management via CLI](index.md#id2)
...
## [Package Management via CLI](index.md#id3)
...
## [Context Free Functions](index.md#id4)

### [Debug Log](index.md#id5)
...
| `Request.UserAcl.Grants` | table | user ACL map of string to grant note: grants without an Id are not presented when iterated and only one of them can be accessed via brackets | yes | no | no |
...
## [Request Functions](index.md#id7)

### [Operations Log](index.md#id8)
...
## [Background Context](index.md#id10)
...
## [Global RGW Table](index.md#id12)
...
### [Increment/Decrement Functions](index.md#id13)
...
## [Lua Code Samples](index.md#id14)
...
If [tracing is enabled](https://docs.ceph.com/en/latest/jaegertracing/#how-to-enable-tracing-in-ceph/) on the RGW, the value of Request.Trace.Enable is true, so we should disable tracing for all other requests that do not match the bucket name.
