...
version: "19.2.2"
title: "STS in Ceph"
source_url: https://docs.ceph.com/en/squid/radosgw/STS/
...
[Session tags for Attribute Based Access Control in STS](../session-tags/index.md).
...
rgw_sts_key
:   > Key used for encrypting/ decrypting role session tokens. This key must
    > consist of 16 hexadecimal characters, which can be generated by the
    > command ‘openssl rand -hex 16’. All radosgw instances in a zone should
    > use the same key. In multisite configurations, all zones in a realm
...
rgw_s3_auth_use_sts
:   > Should S3 authentication use STS.
    >
    > type:
    > :   `bool`
    >
...
> **Note:**
>
> The STS and S3 APIs co-exist in the same namespace, and both S3
...
can be found here
[OpenID Connect Provider in RGW](../oidc/index.md).

## Keycloak integration with Radosgw

Steps for integrating Radosgw with Keycloak can be found here
[Integrating Keycloak with RadosGW](../keycloak/index.md).
