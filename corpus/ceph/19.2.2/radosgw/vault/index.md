...
source_url: https://docs.ceph.com/en/squid/radosgw/vault/
fetched_at: 2026-07-27T16:40:36+00:00
---
# [HashiCorp Vault Integration](index.md#id3)
...
![](../../_images/ditaa-54700cb967c0aee0f455b652b2377b74b9d47c6b.png)

Contents

- [HashiCorp Vault Integration](index.md#hashicorp-vault-integration)

  - [Vault Secrets Engines](index.md#vault-secrets-engines)
  - [Vault Authentication](index.md#vault-authentication)
  - [Vault Namespaces](index.md#vault-namespaces)
  - [Create a Key in Vault](index.md#create-a-key-in-vault)
  - [Configure the Ceph Object Gateway](index.md#configure-the-ceph-object-gateway)
  - [Upload Object](index.md#upload-object)
...
## [Vault Secrets Engines](index.md#id4)
...
## [Vault Authentication](index.md#id5)
...
## [Create a Key in Vault](index.md#id7)
...
## [Configure the Ceph Object Gateway](index.md#id8)
