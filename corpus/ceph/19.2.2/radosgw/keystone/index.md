...
source_url: https://docs.ceph.com/en/squid/radosgw/keystone/
...
Keystone documentation](http://docs.openstack.org/developer/keystone/configuringservices.html#setting-up-projects-users-and-roles), which explains the process in detail. The requisite
...
[Authentication and ACLs](../s3/authentication/index.md).
