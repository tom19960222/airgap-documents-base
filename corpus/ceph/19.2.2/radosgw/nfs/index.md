...
version: "19.2.2"
title: "NFS"
source_url: https://docs.ceph.com/en/squid/radosgw/nfs/
...
> **Note:**
>
> Only the NFSv4 protocol is supported when using a cephadm or Rook based deployment.
...
is using `ceph nfs ...` commands. See [CephFS & RGW Exports over NFS](../../mgr/nfs/index.md) for more details.
