...
source_url: https://docs.ceph.com/en/squid/radosgw/swift/containerops/
...
> **Note:**
>
> If you are planning to expose public read ACL functionality
...
> **Note:**
>
> Object versioning support is not enabled in radosgw by
...
Description:
:   The name of a container (the “archive container”) that
    ...
    > **Note:**
    >
    > `X-Versions-Location` is the only
...
Required:
:   No (if this header is passed with an empty value, object
