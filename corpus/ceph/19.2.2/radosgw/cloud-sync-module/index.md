...
source_url: https://docs.ceph.com/en/squid/radosgw/cloud-sync-module/
...
See [Multi-Site](../multisite/index.md#multisite) for how to multisite config instructions. The cloud sync module requires a creation of a new zone. The zone
