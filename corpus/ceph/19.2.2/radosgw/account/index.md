...
version: "19.2.2"
title: "User Accounts"
source_url: https://docs.ceph.com/en/squid/radosgw/account/
...
enable the self-service management of [Users](../admin/index.md#radosgw-user-management),
Groups and [Roles](../role/index.md) similar to those in [AWS Identity and Access Management](https://aws.amazon.com/iam/)
(IAM).
...
`radosgw-admin` or the [Admin Ops API](../adminops/index.md).
...
used with the [Ceph Object Gateway IAM API](../iam/index.md) to create additional IAM users
and roles for use with the [Ceph Object Gateway S3 API](../s3/index.md), as well as to
...
> **Warning:**
>
> While the account root user does not require IAM policy to
...
[Multitenancy](../multitenancy/index.md#rgw-multitenancy) for details.
...
> **Note:**
>
> Ownership of all of the user’s buckets will be transferred to
> the account.

> **Note:**
>
> Account membership is permanent. Once added, users cannot be
...
> **Warning:**
>
> Ownership of the user’s notification topics will not be
...
> in [Migrating Notification Topics](index.md#migrating-notification-topics).
...
as described in [Bucket Notifications](../notifications/index.md) and [Supported Zone Features](../zone-features/index.md#supported-features).
...
The account root user’s credentials unlock the [Ceph Object Gateway IAM API](../iam/index.md).
