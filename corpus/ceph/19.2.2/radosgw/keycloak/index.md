...
collection: ceph
version: "19.2.2"
title: "Integrating Keycloak with RadosGW"
source_url: https://docs.ceph.com/en/squid/radosgw/keycloak/
...
1. Add a user:
   ...
   ![../../_images/keycloak-adduser.png](../../_images/keycloak-adduser.png)
2. Add user details:

   ![../../_images/keycloak-userdetails.png](../../_images/keycloak-userdetails.png)
3. Add user credentials:

   ![../../_images/keycloak-usercredentials.png](../../_images/keycloak-usercredentials.png)
4. Add tags to the ‘attributes’ tab of the user:

   ![../../_images/keycloak-usertags.png](../../_images/keycloak-usertags.png)
5. Add a protocol mapper that maps the user attribute to a client:

   ![../../_images/keycloak-userclientmapper.png](../../_images/keycloak-userclientmapper.png)
