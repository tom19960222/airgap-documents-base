...
version: "19.2.2"
title: "Metrics"
source_url: https://docs.ceph.com/en/squid/radosgw/metrics/
fetched_at: 2026-07-27T16:40:47+00:00
---
# [Metrics](index.md#id2)

The Ceph Object Gateway uses [Perf counters](../../dev/perf_counters/index.md#perf-counters) to track metrics. The counters can be labeled ([Labeled Perf Counters](../../dev/perf_counters/index.md#labeled-perf-counters)). When counters are labeled, they are stored in the Ceph Object Gateway specific caches.
...
- [Metrics](index.md#metrics)
  ...
  - [Op Metrics](index.md#op-metrics)

    - [Op Metrics Labels](index.md#op-metrics-labels)

      - [User & Bucket Counter Caches](index.md#user-bucket-counter-caches)
      - [User & Bucket Counter Cache Size & Eviction](index.md#user-bucket-counter-cache-size-eviction)
  - [Sending Metrics to Prometheus](index.md#sending-metrics-to-prometheus)
  - [Config Reference](index.md#config-reference)

## [Op Metrics](index.md#id3)
...
### [Op Metrics Labels](index.md#id4)
...
[RGW Multi-tenancy](../multitenancy/index.md#rgw-multitenancy) allows the use of buckets and users with the same name,
...
#### [User & Bucket Counter Caches](index.md#id5)
...
#### [User & Bucket Counter Cache Size & Eviction](index.md#id6)
...
## [Sending Metrics to Prometheus](index.md#id7)
...
:   > enable a rgw perf counters cache for counters with user label
    ...
    >
    > see also:
    > :   [`rgw_user_counters_cache_size`](index.md#confval-rgw_user_counters_cache_size)
...
:   > Number of labeled perf counters the user perf counters cache can store
    ...
    >
    > see also:
    > :   [`rgw_user_counters_cache`](index.md#confval-rgw_user_counters_cache)
...
:   > enable a rgw perf counters cache for counters with bucket label
    ...
    >
    > see also:
    > :   [`rgw_bucket_counters_cache_size`](index.md#confval-rgw_bucket_counters_cache_size)

rgw_bucket_counters_cache_size
:   > Number of labeled perf counters the bucket perf counters cache can
    > store
    >
    > type:
    > :   `uint`
    ...
    >
    > see also:
    > :   [`rgw_bucket_counters_cache`](index.md#confval-rgw_bucket_counters_cache)
...
:   > Time to wait before sending requests again to exporter server
    > (seconds)
    >
    > type:
    > :   `int`
