...
source_url: https://docs.ceph.com/en/squid/radosgw/s3/commons/
...
Plan](https://aws.amazon.com/blogs/aws/amazon-s3-path-deprecation-plan-the-rest-of-the-story/) for more information.
...
Multisite Configuration](../../multisite/index.md#multisite) for more on zonegroups.
...
> **Tip:**
>
> You can define multiple hostnames directly with the
> [`rgw_dns_name`](../../config-ref/index.md#confval-rgw_dns_name) parameter.

> **Tip:**
>
> When SSL is enabled, the certificates must use a wildcard in the
...
> [`rgw_dns_name`](../../config-ref/index.md#confval-rgw_dns_name), in `rgw_dns_s3website_name`.
