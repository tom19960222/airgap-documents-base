...
source_url: https://docs.ceph.com/en/squid/radosgw/s3/authentication/
...
- the `rgw keystone` configuration options explained in [Integrating with OpenStack Keystone](../../keystone/index.md),
...
> **Note:**
>
> Consider that most production radosgw deployments
> authenticating against OpenStack Keystone are also set up
> for [RGW Multi-tenancy](../../multitenancy/index.md), for which special
