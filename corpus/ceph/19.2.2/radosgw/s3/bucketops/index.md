...
source_url: https://docs.ceph.com/en/squid/radosgw/s3/bucketops/
...
| `LocationConstraint` | String | A zonegroup api name, with optional [S3 Bucket Placement](../../placement/index.md#s3-bucket-placement) |
...
| `Event` | String | List of supported events see: [S3 Notification Compatibility](../../s3-notification-compatibility.md). Multiple `Event` entities can be used. If omitted, all “Created” and “Removed” events are handled. “Lifecycle” and “Synced” event types must be specified explicitly. | No |
