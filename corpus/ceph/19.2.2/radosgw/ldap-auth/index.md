...
source_url: https://docs.ceph.com/en/squid/radosgw/ldap-auth/
...
> **Note:**
>
> Make sure to use the same LDAP parameters like in the Ceph configuration file to
...
> **Important:**
>
> The access token is a base-64 encoded JSON struct and contains
