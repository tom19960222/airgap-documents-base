...
collection: ceph
version: "19.2.2"
title: "OS Recommendations"
source_url: https://docs.ceph.com/en/squid/start/os-recommendations/
...
- **Ceph Kernel Client**
  ...
  *at least* 4.19-based “longterm maintenance” kernel series. If you can
  ...
  For CephFS, see the section about [Mounting CephFS using Kernel Driver](../../cephfs/mount-using-kernel-driver.md#which-kernel-version)
  for kernel version guidance.

  Older kernel client versions may not support your [CRUSH tunables](../../rados/operations/crush-map.md#tunables) profile
...
> **Note:**
>
> See the list of QAed container hosts in the Ceph repository here:
> [List of Container Hosts](https://github.com/ceph/ceph/tree/main/qa/distros/supported-container-hosts).
