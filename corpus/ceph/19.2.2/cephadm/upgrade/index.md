...
source_url: https://docs.ceph.com/en/squid/cephadm/upgrade/
...
> > **Note:**
> >
> > [Staggered Upgrade](index.md#staggered-upgrade) of the Monitors and Managers may be necessary to use
...
For more information about available container images, see [Ceph Container Images](../../install/containers/index.md#containers).
...
follows the same format as the command line options for [Daemon Placement](../services/index.md#orchestrator-cli-placement-spec).
