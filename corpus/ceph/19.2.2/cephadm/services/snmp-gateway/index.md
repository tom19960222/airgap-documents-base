...
collection: ceph
version: "19.2.2"
title: "SNMP Gateway Service"
source_url: https://docs.ceph.com/en/squid/cephadm/services/snmp-gateway/
fetched_at: 2026-07-27T16:39:24+00:00
---
# SNMP Gateway Service

[SNMP](https://en.wikipedia.org/wiki/Simple_Network_Management_Protocol) is still a widely used protocol, to monitor distributed systems and devices across a variety of hardware
...
it on to a designated SNMP management platform. The gateway daemon is from the [snmp_notifier](https://github.com/maxwo/snmp_notifier) project,
...
downloaded from the main Ceph [repo](https://github.com/ceph/ceph/tree/master/monitoring/snmp)
