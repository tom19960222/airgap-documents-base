...
version: "19.2.2"
title: "NFS Service"
source_url: https://docs.ceph.com/en/squid/cephadm/services/nfs/
...
commands; see [CephFS & RGW Exports over NFS](../../../mgr/nfs/index.md#mgr-nfs). This document covers how to manage the
...
See [Daemon Placement](../index.md#orchestrator-cli-placement-spec) for the details of the placement
specification.
...
>   [Selecting network interfaces for the virtual IP](../rgw/index.md#ingress-virtual-ip) for more information.
...
(see [Create NFS Ganesha Cluster](../../../mgr/nfs/index.md#nfs-module-cluster-create)) or place the ingress service first, so
...
(see [Create NFS Ganesha Cluster](../../../mgr/nfs/index.md#nfs-module-cluster-create)) or manually create services with the
...
- CephFS: [NFS](../../../cephfs/nfs/index.md#cephfs-nfs)
- MGR: [CephFS & RGW Exports over NFS](../../../mgr/nfs/index.md#mgr-nfs)
