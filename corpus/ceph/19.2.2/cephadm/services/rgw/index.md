...
version: "19.2.2"
title: "RGW Service"
source_url: https://docs.ceph.com/en/squid/cephadm/services/rgw/
...
see [Multi-Site](../../../radosgw/multisite/index.md#multisite).)
...
use [RGW Module](../../../mgr/rgw/index.md#mgr-rgw-module) or issue commands of the following form:
...
See [Daemon Placement](../index.md#orchestrator-cli-placement-spec) for details of the placement
specification. See [Multi-Site](../../../radosgw/multisite/index.md#multisite) for more information of setting up multisite RGW.

See also [Multi-Site](../../../radosgw/multisite/index.md#multisite).
...
> **Note:**
>
> This will only stop the RGW daemon(s) from sending replication data.
...
:   Settings to configure a (multisite) Ceph RGW
    ...
    :   A list of network identities instructing the daemons to only bind
        ...
        [Specifying Networks](index.md#cephadm-rgw-networks) and [Specifying Networks](../mgr/index.md#cephadm-mgr-networks).
    ...
    :   List of extra arguments for rgw_frontend in the form opt=value. See [HTTP Frontends](../../../radosgw/frontends/index.md#rgw-frontends)

    rgw_frontend_port*: int | None*
    :   Port of the RGW daemons

    rgw_frontend_ssl_certificate*: List[str] | None*
    :   List of SSL certificates

    rgw_frontend_type*: str | None*
    :   civetweb or beast (default: beast). See [HTTP Frontends](../../../radosgw/frontends/index.md#rgw-frontends)
...
![../../../_images/HAProxy_for_RGW.svg](../../../_images/HAProxy_for_RGW.svg)
...
- [RGW Module](../../../mgr/rgw/index.md#mgr-rgw-module)
