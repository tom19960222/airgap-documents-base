...
collection: ceph
version: "19.2.2"
title: "Custom Container Service"
source_url: https://docs.ceph.com/en/squid/cephadm/services/custom-container/
...
A corresponding [Service Specification](../index.md#orchestrator-cli-service-spec) must look like:
...
> **Note:**
>
> Init containers are currently implemented as a step that runs
