...
collection: ceph
version: "19.2.2"
title: "Cephadm Operations"
source_url: https://docs.ceph.com/en/squid/cephadm/operations/
...
> **Note:**
>
> If you execute cephadm commands directly, such as cephadm shell,
...
- `/var/log/ceph/<cluster-fsid>` contains all cluster logs. By
  ...
  described in [cephadm-logs](index.md#cephadm-logs).
...
- See [Fully qualified domain names vs bare host names](../host-management/index.md#cephadm-fqdn) for more information about host names and
  domain names.
...
- If the daemon is a stateful one (monitor or OSD), it should be adopted
  by cephadm; see [Converting an existing cluster to cephadm](../adoption/index.md#cephadm-adoption). For stateless daemons, it is
...
>   [Daemon Placement](../services/index.md#orchestrator-cli-placement-spec))
...
(See [Daemon Placement](../services/index.md#orchestrator-cli-placement-spec) for more information about placement specs.)
...
> **Note:**
>
> Typically cephadm will execute `which` to determine what python3
...
> **Note:**
>
> This only supports LVM-based deployed OSD(s)
