...
source_url: https://docs.ceph.com/en/squid/rbd/rbd-encryption/
...
be lower than the raw image size. See the [Supported Formats](index.md#supported-formats) section for more
details.
...
> **Note:**
>
> Images with the [journal feature](../rbd-mirroring/index.md#enable-image-journaling-feature) enabled cannot be formatted and encrypted
> by RBD clients.
...
12MiB if using an image configured with a 4MiB object size and [stripe count](../../man/8/rbd/index.md#striping)
of 3.
