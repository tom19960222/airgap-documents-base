...
collection: ceph
version: "19.2.2"
title: "RBD on Windows"
source_url: https://docs.ceph.com/en/squid/rbd/rbd-windows/
...
Please check the [Limitations](index.md#limitations) section to learn about the Windows limitations
...
Let’s assume that the [SAN policy](index.md#san-policy) is set to `offlineShared`, three
