...
collection: ceph
version: "19.2.2"
title: "Block Devices and Kubernetes"
source_url: https://docs.ceph.com/en/squid/rbd/rbd-kubernetes/
...
![](../../_images/ditaa-b2ae4b6fe24a5fb214de31111e1dd566eb60e83e.png)

> **Important:**
>
> `ceph-csi` uses the RBD kernel modules by default which may not support all
> Ceph [CRUSH tunables](../../rados/operations/crush-map/index.md#tunables) or [RBD image features](../rbd-config-ref/index.md#image-features).
...
> **Note:**
>
> `ceph-csi` currently only supports the [legacy V1 protocol](../../rados/configuration/msgr2/index.md#address-formats).
