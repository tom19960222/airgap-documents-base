...
source_url: https://docs.ceph.com/en/squid/rbd/rbd-exclusive-locks/
...
cache](../rbd-persistent-write-log-cache.md) from concurrent modification.
...
> [client identities](../../rados/operations/user-management/index.md#user-management) using RBD.
