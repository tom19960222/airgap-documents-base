...
source_url: https://docs.ceph.com/en/squid/rbd/qemu-rbd/
fetched_at: 2026-07-27T16:40:18+00:00
---
...
many times). See [Snapshots](../rbd-snapshot/index.md) for details. The ability to make copy-on-write
...
![](../../_images/ditaa-bbd41a7cab7cb23689a82425f7f13c4ac09eaefc.png)
...
[QEMU Manual](http://wiki.qemu.org/Manual). For installation details, see [Installation](../../install.md).

> **Important:**
>
> To use Ceph Block Devices with QEMU, you must have access to a
...
User](../../rados/operations/user-management.md#user) for details. Do not prepend the client type (i.e., `client.`) to the
...
by avoiding context switches and taking advantage of [RBD caching](../rbd-config-ref/index.md#rbd-cache-config-settings).
...
[RBD caching](../rbd-config-ref/index.md#rbd-cache-config-settings) can significantly improve performance.
...
> **Important:**
>
> If you set rbd_cache=true, you must set cache=writeback
...
QEMU’s cache options correspond to the following Ceph [RBD Cache](../rbd-config-ref/index.md) settings.
...
> **Note:**
>
> Prior to QEMU v2.4.0, if you explicitly set [RBD Cache](../rbd-config-ref/index.md) settings
