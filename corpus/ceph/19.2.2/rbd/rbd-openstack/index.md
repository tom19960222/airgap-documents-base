...
collection: ceph
version: "19.2.2"
title: "Block Devices and OpenStack"
source_url: https://docs.ceph.com/en/squid/rbd/rbd-openstack/
...
![](../../_images/ditaa-b5b3c1e5436bc4194b054c832b1538529c89979f.png)

> **Important:**
>
> To use Ceph Block Devices with OpenStack, you must have
...
- **Guest Disks**: Guest disks are guest operating system disks. By default,
  ...
  [exclusive locks](../rbd-exclusive-locks/index.md#rbd-exclusive-locks) prevent multiple
...
See [Create a Pool](../../rados/operations/pools.md#createpool) for detail on specifying the number of placement groups for
your pools, and [Placement Groups](../../rados/operations/placement-groups.md) for details on the number of placement
...
If you have [cephx authentication](../../rados/configuration/auth-config-ref/index.md#enabling-disabling-cephx) enabled, create a new user for Nova/Cinder
...
> **Important:**
>
> You don’t necessarily need the UUID on all the compute nodes.
...
If you are using [cephx authentication](../../rados/configuration/auth-config-ref/index.md#enabling-disabling-cephx), also configure the user and uuid of
...
You can use [qemu-img](../qemu-rbd/index.md#running-qemu-with-rbd) to convert from one format to another. For example:
