...
version: "19.2.2"
title: "scan"
source_url: https://docs.ceph.com/en/squid/ceph-volume/simple/scan/
...
required data. Just like [Running OSDs scan](index.md#ceph-volume-simple-scan-directory), it would
