...
version: "19.2.2"
title: "activate"
source_url: https://docs.ceph.com/en/squid/ceph-volume/simple/activate/
fetched_at: 2026-07-27T16:41:44+00:00
---
# `activate`

Once [scan](../scan/index.md#ceph-volume-simple-scan) has been completed, and all the metadata
...
The activation process requires using both the [OSD id](../../../glossary/index.md#term-OSD-ID) and [OSD uuid](../../../glossary/index.md#term-OSD-UUID)
...
A systemd unit will capture the [OSD id](../../../glossary/index.md#term-OSD-ID) and [OSD uuid](../../../glossary/index.md#term-OSD-UUID) and
