...
version: "19.2.2"
title: "Overview"
source_url: https://docs.ceph.com/en/squid/ceph-volume/intro/
...
are still in use and have GPT partitions (handled by [simple](../simple/index.md#ceph-volume-simple)),
...
By making use of [LVM tags](../../glossary/index.md#term-LVM-tags), the [lvm](../lvm/index.md#ceph-volume-lvm) sub-command is
