...
version: "19.2.2"
title: "Encryption"
source_url: https://docs.ceph.com/en/squid/ceph-volume/lvm/encryption/
...
with [bluestore](../../../glossary/index.md#term-BlueStore)), the logical volume is left ready
...
2. All complementary devices (like journal, db, or wal) get created and
   ...
   OSD.
3. Activation continues by ensuring devices are mounted, retrieving the dmcrypt
