...
version: "19.2.2"
title: "batch"
source_url: https://docs.ceph.com/en/squid/ceph-volume/lvm/batch/
...
The subcommand is based to [create](../create/index.md#ceph-volume-lvm-create), and will use the very
...
For example assuming [bluestore](../../../glossary/index.md#term-BlueStore) is used and `--no-auto` is not passed,
...
3. Devices are a mix of HDDs and SSDs: data is placed on the spinning device,
...
This idempotency notion is tightly coupled to and extensively used by [Advanced OSD Service Specifications](../../../cephadm/services/osd/index.md#drivegroups).
