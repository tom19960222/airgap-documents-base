...
version: "19.2.2"
title: "new-db"
source_url: https://docs.ceph.com/en/squid/ceph-volume/lvm/newdb/
...
> **Note:**
>
> *The above procedure was developed by Chris Dunlop on the [ceph-users] mailing list, and can be seen in its original context here:* [[ceph-users] Re: Fixing BlueFS spillover (pacific 16.2.14)](https://lists.ceph.io/hyperkitty/list/ceph-users@ceph.io/message/POPUFSZGXR3P2RPYPJ4WJ4HGHZ3QESF6/)
