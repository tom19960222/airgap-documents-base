...
version: "19.2.2"
title: "list"
source_url: https://docs.ceph.com/en/squid/ceph-volume/lvm/list/
...
> **Note:**
>
> Tags are displayed in a readable format. The `osd id` key is stored
> as a `ceph.osd_id` tag. For more information on lvm tag conventions
> see [Tag API](../../../dev/ceph-volume/lvm/index.md#ceph-volume-lvm-tag-api)
