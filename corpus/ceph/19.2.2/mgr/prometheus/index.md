...
source_url: https://docs.ceph.com/en/squid/mgr/prometheus/
...
:   > Gathering perf-counters from a single Prometheus exporter can degrade
    ...
    > This should only be disabled when no ceph-exporters are deployed.
    >
    > type:
    > :   `bool`
    >
...
is registered with Prometheus’s [registry](https://github.com/prometheus/prometheus/wiki/Default-port-allocations).
...
> **Warning:**
>
> The [`mgr/prometheus/scrape_interval`](index.md#confval-mgr-prometheus-scrape_interval) of this module should match
...
Ceph exceeds the configured [`mgr/prometheus/scrape_interval`](index.md#confval-mgr-prometheus-scrape_interval).
...
See the [prometheus documentation](https://prometheus.io/docs/prometheus/latest/querying/basics) for more information about constructing
