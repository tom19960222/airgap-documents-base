...
source_url: https://docs.ceph.com/en/squid/mgr/dashboard/
...
The [Ceph Dashboard](../../glossary/index.md#term-Ceph-Dashboard) module adds web-based monitoring and administration
...
- **Multi-User and Role Management**: The dashboard supports multiple user
  ...
  [User and Role Management](index.md#dashboard-user-role-management) for details.
- **Single Sign-On (SSO)**: The dashboard supports authentication
  ...
  [Enabling Single Sign-On (SSO)](index.md#dashboard-sso-support) for details.
- **SSL/TLS support**: All HTTP communication between the web browser and the
  ...
  signed and issued by a CA. See [SSL/TLS Support](index.md#dashboard-ssl-tls-support) for details.
- **Auditing**: The dashboard backend can be configured to log all `PUT`, `POST`
  and `DELETE` API requests in the Ceph audit log. See [Auditing API Requests](index.md#dashboard-auditing)
...
- **Embedded Grafana Dashboards**: Ceph Dashboard
  ...
  the [Prometheus Module](../prometheus/index.md#mgr-prometheus) module. See
  [Enabling the Embedding of Grafana Dashboards](index.md#dashboard-grafana) for details on how to configure this functionality.
...
- **iSCSI**: List all hosts that run the TCMU runner service, display all
  ...
  See [Enabling iSCSI Management](index.md#dashboard-iscsi-management) for instructions on how to configure
  this feature.
...
- **Object Gateway**: List all active object gateways and their performance
  ...
  See [Enabling the Object Gateway Management Frontend](index.md#dashboard-enabling-object-gateway) for configuration instructions.
- **NFS**: Manage NFS exports of CephFS file systems and RGW S3 buckets via NFS
  Ganesha. See [NFS-Ganesha Management](index.md#dashboard-nfs-ganesha-management) for details on how to
...
![../../_images/dashboard-landing-page.png](../../_images/dashboard-landing-page.png)
> **Note:**
>
...
![../../_images/details-card.png](../../_images/details-card.png)

#### Status

Provides a visual indication of cluster health, and displays cluster alerts grouped by severity.

![../../_images/status-card-open.png](../../_images/status-card-open.png)
...
![../../_images/capacity-card.png](../../_images/capacity-card.png)
...
![../../_images/inventory-card.png](../../_images/inventory-card.png)
...
![../../_images/cluster-utilization-card.png](../../_images/cluster-utilization-card.png)
...
wanted or required. See [Proxy Configuration](index.md#dashboard-proxy-configuration) for more details.
...
you can use. For more details please refer to the [User and Role Management](index.md#user-and-role-management)
section.
...
`rbd-target-api` service of the [Ceph iSCSI Gateway](../../rbd/iscsi-overview/index.md#ceph-iscsi). Please make sure that it is
...
require Prometheus as the data source. The Ceph [Prometheus Module](../prometheus/index.md#mgr-prometheus)
...
[Monitoring Services](../../cephadm/services/monitoring/index.md#mgr-cephadm-monitoring) documentation for more details on how to use
...
1. Enable the Ceph Exporter which comes as Ceph Manager module by running:
   ...
   More details can be found in the documentation of the [Prometheus Module](../prometheus/index.md#mgr-prometheus).
...
performance. For more information please see [Ceph Health Checks](../prometheus/index.md#prometheus-rbd-io-statistics).
...
NFS clusters and NFS exports. For more information check [CephFS & RGW Exports over NFS](../nfs/index.md#mgr-nfs).
...
4. Ensure the SSL/TLS support is configured properly:
   ...
   - If it doesn’t return `true`, run the following command to generate a self-signed
     ...
     [SSL/TLS Support](index.md#dashboard-ssl-tls-support):
...
![../../_images/invalid-credentials.png](../../_images/invalid-credentials.png)
...
2. If your user credentials are correct, but you are experiencing the same
...
Please see [User and Role Management](index.md#dashboard-user-role-management) for more information.
...
1. Increase the logging level of manager daemons:
   ...
   ```
2. Adjust the logging level of the Ceph Dashboard module via the Dashboard or
   CLI:
...
To learn more about centralized logging, see [Centralized Logging in Ceph](../../cephadm/services/monitoring/index.md#cephadm-monitoring-centralized-logs)
