...
source_url: https://docs.ceph.com/en/squid/mgr/telemetry/
...
[`https://telemetry.ceph.com<https://telemetry.ceph.com>`_](index.md#id2).
...
> **Note:**
>
> `smartmontools` version 7.0 or later must be installed so that JSON
