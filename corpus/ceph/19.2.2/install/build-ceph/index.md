...
version: "19.2.2"
title: "Build Ceph"
source_url: https://docs.ceph.com/en/squid/install/build-ceph/
...
> **Tip:**
>
> When building on a multi-core CPU, use the `-j` and the number of
...
[Ceph](../clone-source.md) repository, installed the [Build Prerequisites](index.md#build-prerequisites) and installed
`debhelper`:
...
installed the [Build Prerequisites](index.md#build-prerequisites) and installed `rpm-build` and
`rpmdevtools`:
