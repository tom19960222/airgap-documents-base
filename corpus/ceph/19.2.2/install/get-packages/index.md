...
version: "19.2.2"
title: "Get Packages"
source_url: https://docs.ceph.com/en/squid/install/get-packages/
fetched_at: 2026-07-27T16:41:52+00:00
---
# Get Packages
...
- **Cephadm:** Cephadm can configure your Ceph repositories for you
  ...
  [Ceph Node](../../glossary/index.md#term-Ceph-Node) in your cluster must have internet access.
- **Configure Repositories Manually:** You can manually configure your
  ...
  software. Each [Ceph Node](../../glossary/index.md#term-Ceph-Node) in your cluster must have internet
  access.
- **Download Packages Manually:** Downloading packages manually is a convenient
  way to install Ceph if your environment does not allow a [Ceph Node](../../glossary/index.md#term-Ceph-Node) to
  access the internet.
...
The major releases of Ceph are summarized at: [Releases](https://docs.ceph.com/en/latest/releases/)
...
list of APT sources. See [the testing Debian repository](https://download.ceph.com/debian-testing/dists) for a complete list
...
wip-hack, master). See [the shaman page](https://shaman.ceph.com) for a complete
...
`/etc/yum.repos.d` directory. The [the shaman page](https://shaman.ceph.com) can be used to retrieve the full details
