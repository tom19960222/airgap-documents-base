...
collection: ceph
version: "19.2.2"
title: "The ClientRequest pipeline"
source_url: https://docs.ceph.com/en/squid/dev/crimson/pipeline/
...
| --- | --- |
| `ConnectionPipeline::await_map` `ConnectionPipeline::get_pg` | `OSDShardPGSlot::waiting` and `OSDShardPGSlot::waiting_peering` |
