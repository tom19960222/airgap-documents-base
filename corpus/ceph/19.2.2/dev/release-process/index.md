...
collection: ceph
version: "19.2.2"
title: "Ceph Release Process"
source_url: https://docs.ceph.com/en/squid/dev/release-process/
...
1. ceph.git Release Notes (e.g., [v15.2.17’s ceph.git (docs.ceph.com) PR](https://github.com/ceph/ceph/pull/47198))
2. ceph.io Release Notes (e.g., [v15.2.17’s ceph.io.git (www.ceph.io) PR](https://github.com/ceph/ceph.io/pull/427))
...
This must be done after [4. Signing and Publishing the Build](index.md#signing-and-publishing-the-build).
...
If this was a regular release (not a hotfix release or a security release), the only commit in that Pull Request should be the version commit. For example, see [v15.2.17’s version commit PR](https://github.com/ceph/ceph/pull/47520).
