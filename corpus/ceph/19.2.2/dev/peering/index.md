...
version: "19.2.2"
title: "Peering"
source_url: https://docs.ceph.com/en/squid/dev/peering/
...
>
>    1. ask it for copies of all PG log entries since *last epoch start*
...
>    2. ask it for its *missing set* (object updates recorded
...
>
>    1. send them log updates to bring their PG logs into agreement with
...
>    updates.
>
>    1. start accepting client write operations (because we have unanimous
...
>    2. update the *last epoch started* value in our local *PG info*, and instruct
>       other *active set* OSDs to do the same.
>    3. start pulling object data updates that other OSDs have, but I do not. We may
...
Use the [gen_state_diagram.py](https://github.com/ceph/ceph/blob/master/doc/scripts/gen_state_diagram.py) script to generate a copy of the latest peering state model:
...
![../../_images/peering_graph.generated.svg](../../_images/peering_graph.generated.svg)
