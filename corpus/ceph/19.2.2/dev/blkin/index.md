...
collection: ceph
version: "19.2.2"
title: "Tracing Ceph With LTTng"
source_url: https://docs.ceph.com/en/squid/dev/blkin/
...
If your Ceph deployment is package-based (YUM, DNF, APT) vs containerized, install the required software packages according to the module which you want to track， otherwise, it may cause a coredump due to missing [\*](index.md#id1)tp.solibrary files:
...
Deprecated since version This: feature was deprecated in the Squid release and will
