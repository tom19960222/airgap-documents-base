...
version: "19.2.2"
title: "LVM"
source_url: https://docs.ceph.com/en/squid/dev/ceph-volume/lvm/
...
> **Warning:**
>
> These APIs are not meant to be public, but are documented so that
...
Just used on [bluestore](../../../glossary/index.md#term-BlueStore) backends. Captures the path to the logical
volume path.
...
Just used on [bluestore](../../../glossary/index.md#term-BlueStore) backends. Captures either the logical volume UUID or
the partition UUID.
