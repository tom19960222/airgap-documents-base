...
collection: ceph
version: "19.2.2"
title: "Developing with cephadm"
source_url: https://docs.ceph.com/en/squid/dev/cephadm/developing-cephadm/
...
So things to do:
:   - 1. Review [requirements](https://kcli.readthedocs.io/en/latest/#libvirt-hypervisor-requisites)
...
> **Note:**
>
> Once you have used your kcli tool to create and use different labs, we
...
There is a [repository](https://github.com/karmab/kcli-plans) with a collection of
...
> **Warning:**
>
> This development environment is still experimental and can have unexpected
...
> **Note:**
>
> It is recommended to run box with verbose (-v) as it will show the output of
...
> **Warning:**
>
> OSDs are still not supported in the box implementation with Podman. It is
> work in progress.
