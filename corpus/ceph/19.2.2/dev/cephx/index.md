...
version: "19.2.2"
title: "Cephx"
source_url: https://docs.ceph.com/en/squid/dev/cephx/
...
- A write-up from 2012 on cephx as it existed at that time by Peter
  Reiher: [A Detailed Description of the Cephx Authentication Protocol](../cephx_protocol/index.md#cephx-2012-peter)
...
messenger protocol. See also [msgr2 protocol (msgr2.0 and msgr2.1)](../msgr2/index.md#msgr2-protocol).
