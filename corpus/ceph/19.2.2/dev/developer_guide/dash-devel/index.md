...
collection: ceph
version: "19.2.2"
title: "Ceph Dashboard Developer Documentation"
source_url: https://docs.ceph.com/en/squid/dev/developer_guide/dash-devel/
fetched_at: 2026-07-27T16:41:10+00:00
---
# [Ceph Dashboard Developer Documentation](index.md#id4)

Table of Contents

- [Ceph Dashboard Developer Documentation](index.md#ceph-dashboard-developer-documentation)

  - [Feature Design](index.md#feature-design)
  - [Preliminary Steps](index.md#preliminary-steps)

    - [vstart](index.md#vstart)
    - [Host-based vs Docker-based Development Environments](index.md#host-based-vs-docker-based-development-environments)

      - [Development environment on your host system](index.md#development-environment-on-your-host-system)
      - [Development environments based on Docker](index.md#development-environments-based-on-docker)
    - [vstart on your host system](index.md#vstart-on-your-host-system)
    - [Docker](index.md#docker)
  - [Frontend Development](index.md#frontend-development)

    - [Prerequisites](index.md#prerequisites)
    - [Package installation](index.md#package-installation)
    - [Adding or updating packages](index.md#adding-or-updating-packages)
    - [Setting up a Development Server](index.md#setting-up-a-development-server)
    - [Code Scaffolding](index.md#code-scaffolding)
    - [Build the Project](index.md#build-the-project)
    - [Build the Code Documentation](index.md#build-the-code-documentation)
    - [Code linting and formatting](index.md#code-linting-and-formatting)
    - [Ceph Dashboard and Bootstrap](index.md#ceph-dashboard-and-bootstrap)
    - [Writing Unit Tests](index.md#writing-unit-tests)
    - [Running Unit Tests](index.md#running-unit-tests)
    - [Running End-to-End (E2E) Tests](index.md#running-end-to-end-e2e-tests)

      - [E2E Prerequisites](index.md#e2e-prerequisites)
      - [run-frontend-e2e-tests.sh](index.md#run-frontend-e2e-tests-sh)
      - [run-cephadm-e2e-tests.sh](index.md#run-cephadm-e2e-tests-sh)
      - [Other running options](index.md#other-running-options)
      - [CYPRESS_CACHE_FOLDER](index.md#cypress-cache-folder)
    - [Writing End-to-End Tests](index.md#writing-end-to-end-tests)

      - [The PagerHelper class](index.md#the-pagerhelper-class)
      - [Subclasses of PageHelper](index.md#subclasses-of-pagehelper)

        - [Helper Methods](index.md#helper-methods)
        - [Using PageHelpers](index.md#using-pagehelpers)
      - [Code Style](index.md#code-style)

        - [`describe()` vs `it()`](index.md#describe-vs-it)
    - [Visual Regression Testing](index.md#visual-regression-testing)

      - [Running Visual Regression Tests Locally](index.md#running-visual-regression-tests-locally)
      - [Capturing Screenshots](index.md#capturing-screenshots)
      - [Writing More Visual Regression Tests](index.md#writing-more-visual-regression-tests)
      - [Visual Regression Tests In Jenkins](index.md#visual-regression-tests-in-jenkins)
      - [Accepting or Rejecting Differences](index.md#accepting-or-rejecting-differences)
      - [Debugging Regressions](index.md#debugging-regressions)
    - [Differences between Frontend Unit Tests and End-to-End (E2E) Tests / FAQ](index.md#differences-between-frontend-unit-tests-and-end-to-end-e2e-tests-faq)

      - [What are E2E/unit tests designed for?](index.md#what-are-e2e-unit-tests-designed-for)
      - [Which E2E/unit tests are considered to be valid?](index.md#which-e2e-unit-tests-are-considered-to-be-valid)
      - [How should an E2E/unit test look like?](index.md#how-should-an-e2e-unit-test-look-like)
      - [What should an E2E/unit test cover?](index.md#what-should-an-e2e-unit-test-cover)
      - [What should an E2E/unit test NOT cover?](index.md#what-should-an-e2e-unit-test-not-cover)
      - [Best practices/guideline](index.md#best-practices-guideline)
    - [Further Help](index.md#further-help)
    - [Example of a Generator](index.md#example-of-a-generator)
    - [Frontend Typescript Code Style Guide Recommendations](index.md#frontend-typescript-code-style-guide-recommendations)
    - [Frontend components](index.md#frontend-components)
    - [Helper](index.md#helper)
    - [Terminology and wording](index.md#terminology-and-wording)
    - [Frontend branding](index.md#frontend-branding)
    - [UI Style Guide](index.md#ui-style-guide)

      - [Colors](index.md#colors)
      - [Buttons](index.md#buttons)
      - [Links](index.md#links)
      - [Forms](index.md#forms)
      - [Modals](index.md#modals)
      - [Icons](index.md#icons)
      - [Navigation](index.md#navigation)
      - [Alerts and notifications](index.md#alerts-and-notifications)
    - [Error Handling](index.md#error-handling)
    - [How to extract messages from source code?](index.md#how-to-extract-messages-from-source-code)
    - [Supported languages](index.md#supported-languages)
    - [Translating process](index.md#translating-process)
    - [Updating translated messages](index.md#updating-translated-messages)
    - [Add a new release resource to transifex](index.md#add-a-new-release-resource-to-transifex)
    - [Suggestions](index.md#suggestions)
  - [Accessibility](index.md#accessibility)

    - [Summary](index.md#summary)
    - [Accessibility checkers](index.md#accessibility-checkers)
    - [Color contrast checkers](index.md#color-contrast-checkers)
    - [Accessibility linters](index.md#accessibility-linters)
    - [Accessibility testing](index.md#accessibility-testing)
    - [Additional guidelines](index.md#additional-guidelines)
  - [Backend Development](index.md#backend-development)

    - [Unit Testing](index.md#unit-testing)
    - [Unit tests based on tox](index.md#unit-tests-based-on-tox)
    - [API tests based on Teuthology](index.md#api-tests-based-on-teuthology)
    - [How to add a new controller?](index.md#how-to-add-a-new-controller)
    - [Implementing Proxy Controller](index.md#implementing-proxy-controller)
    - [How does the RESTController work?](index.md#how-does-the-restcontroller-work)
    - [How to use a custom API endpoint in a RESTController?](index.md#how-to-use-a-custom-api-endpoint-in-a-restcontroller)
    - [How to restrict access to a controller?](index.md#how-to-restrict-access-to-a-controller)
    - [How to create a dedicated UI endpoint which uses the ‘public’ API?](index.md#how-to-create-a-dedicated-ui-endpoint-which-uses-the-public-api)
    - [How to access the manager module instance from a controller?](index.md#how-to-access-the-manager-module-instance-from-a-controller)
    - [How to write a unit test for a controller?](index.md#how-to-write-a-unit-test-for-a-controller)
    - [How to update or create new dashboards in grafana?](index.md#how-to-update-or-create-new-dashboards-in-grafana)
    - [How to listen for manager notifications in a controller?](index.md#how-to-listen-for-manager-notifications-in-a-controller)
    - [How to write a unit test when a controller accesses a Ceph module?](index.md#how-to-write-a-unit-test-when-a-controller-accesses-a-ceph-module)
    - [How to add a new configuration setting?](index.md#how-to-add-a-new-configuration-setting)
    - [How to run a controller read-write operation asynchronously?](index.md#how-to-run-a-controller-read-write-operation-asynchronously)
    - [How to get the list of executing and finished asynchronous tasks?](index.md#how-to-get-the-list-of-executing-and-finished-asynchronous-tasks)
    - [How to use asynchronous APIs with asynchronous tasks?](index.md#how-to-use-asynchronous-apis-with-asynchronous-tasks)
    - [How to update the execution progress of an asynchronous task?](index.md#how-to-update-the-execution-progress-of-an-asynchronous-task)
    - [How to deal with asynchronous tasks in the front-end?](index.md#how-to-deal-with-asynchronous-tasks-in-the-front-end)
    - [REST API documentation](index.md#rest-api-documentation)
    - [Error Handling in Python](index.md#error-handling-in-python)
    - [Plug-ins](index.md#plug-ins)

## [Feature Design](index.md#id5)
...
- [UI Design Goals](../../dashboard/ui_goals/index.md)

## [Preliminary Steps](index.md#id6)
...
You can read more about vstart in [Deploying a development cluster](../../dev_cluster_deployment/index.md#dev-deploying-a-development-cluster). Additional information for developers
can also be found in the [Developer Guide](https://docs.ceph.com/docs/master/dev/quick_guide/).

### [Host-based vs Docker-based Development Environments](index.md#id8)
...
#### [Development environment on your host system](index.md#id9)
...
#### [Development environments based on Docker](index.md#id10)
...
### [vstart on your host system](index.md#id11)
...
## [Frontend Development](index.md#id13)
...
### [Package installation](index.md#id15)

Run `npm ci` in directory `src/pybind/mgr/dashboard/frontend` to
install the required packages locally.

### [Adding or updating packages](index.md#id16)
...
### [Setting up a Development Server](index.md#id17)
...
### [Code linting and formatting](index.md#id21)
...
### [Ceph Dashboard and Bootstrap](index.md#id22)
...
### [Writing Unit Tests](index.md#id23)
...
### [Running Unit Tests](index.md#id24)
...
### [Running End-to-End (E2E) Tests](index.md#id25)

We use [Cypress](https://www.cypress.io/) to run our frontend E2E tests.

#### [E2E Prerequisites](index.md#id26)
...
#### [run-frontend-e2e-tests.sh](index.md#id27)
...
#### [run-cephadm-e2e-tests.sh](index.md#id28)
...
#### [Other running options](index.md#id29)
...
#### [CYPRESS_CACHE_FOLDER](index.md#id30)
...
### [Writing End-to-End Tests](index.md#id31)

#### [The PagerHelper class](index.md#id32)
...
#### [Subclasses of PageHelper](index.md#id33)

##### [Helper Methods](index.md#id34)
...
##### [Using PageHelpers](index.md#id35)
...
### [Visual Regression Testing](index.md#id38)
...
#### [Running Visual Regression Tests Locally](index.md#id39)
...
#### [Capturing Screenshots](index.md#id40)
...
#### [Writing More Visual Regression Tests](index.md#id41)
...
#### [Visual Regression Tests In Jenkins](index.md#id42)
...
#### [Accepting or Rejecting Differences](index.md#id43)
...
#### [Debugging Regressions](index.md#id44)
...
### [Differences between Frontend Unit Tests and End-to-End (E2E) Tests / FAQ](index.md#id45)

General introduction about testing and E2E/unit tests

#### [What are E2E/unit tests designed for?](index.md#id46)
...
#### [Which E2E/unit tests are considered to be valid?](index.md#id47)
...
#### [How should an E2E/unit test look like?](index.md#id48)
...
#### [What should an E2E/unit test cover?](index.md#id49)
...
#### [What should an E2E/unit test NOT cover?](index.md#id50)
...
#### [Best practices/guideline](index.md#id51)
...
### [Frontend Typescript Code Style Guide Recommendations](index.md#id54)
...
### [Frontend components](index.md#id55)
...
### [Terminology and wording](index.md#id57)
...
### [Frontend branding](index.md#id58)
...
#### [Alerts and notifications](index.md#id67)
...
### [How to extract messages from source code?](index.md#id69)
...
### [Supported languages](index.md#id70)
...
### [Translating process](index.md#id71)
...
### [Updating translated messages](index.md#id72)

1. Download the [transifex CLI tool](https://github.com/transifex/cli)
2. Create an [API token](https://www.transifex.com/user/settings/api/).
...
### [Add a new release resource to transifex](index.md#id73)
...
4. Avoid poor [color contrast choices](https://www.w3.org/TR/WCAG21/#contrast-minimum) (foreground-background) when styling a component. Here are some [tools](index.md#color-contrast-checkers) you can use.
5. When testing menus or dropdowns, be sure to scan them with an [accessibility checker](index.md#accessibility-checkers) in both opened and closed states. Sometimes issues are hidden when menus are closed.

### [Accessibility checkers](index.md#id77)

During development, you can test the accessibility compliance of your features using one of the tools below:

- [Accessibility insights plugin](https://accessibilityinsights.io/downloads/)
- [Site Improve plugin](https://www.siteimprove.com/integrations/browser-extensions/)
- [Axe devtools](https://www.deque.com/axe/devtools/)

Testing with two or more of these tools can greatly improve the detection of accessibility violations.

### [Color contrast checkers](index.md#id78)
...
### [Accessibility linters](index.md#id79)
...
### [Accessibility testing](index.md#id80)
...
Tests can be found under the [a11y folder](src/pybind/mgr/dashboard/frontend/cypress/integration/a11y.md) in the dashboard. Here is an example:
...
### [Additional guidelines](index.md#id81)
...
## [Backend Development](index.md#id82)
...
### [Unit tests based on tox](index.md#id84)
...
### [API tests based on Teuthology](index.md#id85)
...
### [How to add a new controller?](index.md#id86)
...
### [Implementing Proxy Controller](index.md#id87)
...
### [How does the RESTController work?](index.md#id88)
...
### [How to use a custom API endpoint in a RESTController?](index.md#id89)
...
### [How to restrict access to a controller?](index.md#id90)
...
### [How to create a dedicated UI endpoint which uses the ‘public’ API?](index.md#id91)
...
### [How to access the manager module instance from a controller?](index.md#id92)
...
### [How to write a unit test for a controller?](index.md#id93)
...
### [How to update or create new dashboards in grafana?](index.md#id94)
...
### [How to listen for manager notifications in a controller?](index.md#id95)
...
### [How to write a unit test when a controller accesses a Ceph module?](index.md#id96)
...
### [How to add a new configuration setting?](index.md#id97)
...
### [How to run a controller read-write operation asynchronously?](index.md#id98)
...
### [How to get the list of executing and finished asynchronous tasks?](index.md#id99)
...
### [How to use asynchronous APIs with asynchronous tasks?](index.md#id100)
...
### [How to update the execution progress of an asynchronous task?](index.md#id101)
...
### [How to deal with asynchronous tasks in the front-end?](index.md#id102)
...
2. Failed messages always start with `'Failed to '` and should be continued
...
### [REST API documentation](index.md#id103)

Ceph-Dashboard provides two types of documentation for the **Ceph RESTful API**:

- **Static documentation**: available at [Ceph RESTful API](../../../mgr/ceph_api/index.md#mgr-ceph-api). This comes from a versioned specification located at `src/pybind/mgr/dashboard/openapi.yaml`.
...
1. The versioned OpenAPI specification should be updated explicitly: `tox -e
   openapi-fix`.
2. The team @ceph/api will be requested for reviews (this is automated via
...
### [Error Handling in Python](index.md#id104)
...
Ceph Dashboard relies on [Pluggy](https://pluggy.readthedocs.io) to provide
...
3. Create a class extending the desired interfaces. The plug-in library will
...
5. Import the plug-in from within the Ceph Dashboard `module.py` (currently no
