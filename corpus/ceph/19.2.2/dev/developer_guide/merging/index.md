...
collection: ceph
version: "19.2.2"
title: "Commit merging:  scope and cadence"
source_url: https://docs.ceph.com/en/squid/dev/developer_guide/merging/
...
- Commits that are not cherry-picked from *main* must pertain to a bug unique to
  the stable release
- See also the [backport HOWTO](http://tracker.ceph.com/projects/ceph-releases/wiki/HOWTO#HOWTO) document
