...
collection: ceph
version: "19.2.2"
title: "Analyzing and Debugging A Teuthology Job"
source_url: https://docs.ceph.com/en/squid/dev/developer_guide/testing_integration_tests/tests-integration-testing-teuthology-debugging-tips/
...
Test Run](../tests-integration-testing-teuthology-workflow/index.md#scheduling-test-run).
...
and access [teuthology archives](../tests-integration-testing-teuthology-workflow/index.md#teuthology-archives), as in this example:
...
expose bugs not exposed by [make check](../tests-integration-testing-teuthology-intro/index.md#make-check) testing.
...
> **Note:**
>
> The teuthology logs are deleted from time to time. If you are unable
