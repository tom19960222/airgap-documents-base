...
source_url: https://docs.ceph.com/en/squid/dev/developer_guide/testing_integration_tests/tests-integration-testing-teuthology-kernel/
...
fragments](https://github.com/ceph/ceph/tree/63f84c50e0851d456fc38b3330945c54162dd544/qa/cephfs/mount/kclient/overrides/distro). These are symbolically linked by other sub-suites under the `fs`
suite.
...
test, as mentioned in the [CephFS](index.md#kernel-cephfs) section; the override YAML will
