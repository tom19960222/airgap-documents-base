...
source_url: https://docs.ceph.com/en/squid/dev/developer_guide/running-tests-locally/
...
Refer to [Build Ceph](../../../install/build-ceph/index.md).
...
[Build Ceph](../../../install/build-ceph/index.md)) and do:
...
`--create-cluster-only`
:   creates the cluster and quits; tests can be issued
    later
...
`--teardown`
:   tears Ceph cluster down after test(s) has finished
    running
...
`--brxnet=<net/mask>`
:   specify a new net/mask for the mount clients’ network
...
> **Note:**
>
> A failure on the kernel client may crash the host, so it’s
...
> **Note:**
>
> The presence of binary file named after the first argument is
