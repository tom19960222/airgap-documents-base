...
collection: ceph
version: "19.2.2"
title: "Erasure Coded Placement Groups"
source_url: https://docs.ceph.com/en/squid/dev/osd_internals/erasure_coding/
...
- [Developer notes](developer_notes/index.md)
- [Jerasure plugin](jerasure/index.md)
- [ECBackend Implementation Strategy](ecbackend/index.md)
- [ECBackend](ecbackend/index.md#ecbackend)
