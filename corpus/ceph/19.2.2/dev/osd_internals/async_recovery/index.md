...
source_url: https://docs.ceph.com/en/squid/dev/osd_internals/async_recovery/
...
See [Log Based PG](../log_based_pg/index.md#log-based-pg) for more details on this process.
