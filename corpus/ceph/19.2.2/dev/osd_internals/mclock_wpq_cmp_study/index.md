...
source_url: https://docs.ceph.com/en/squid/dev/osd_internals/mclock_wpq_cmp_study/
...
[the dmClock algorithm](https://www.usenix.org/legacy/event/osdi10/tech/full_papers/Gulati.pdf). See [QoS Based on mClock](../../../rados/configuration/osd-config-ref/index.md#dmclock-qos) section for more details.
...
mClock could be enabled by setting the [`osd_op_queue`](../../../rados/configuration/osd-config-ref/index.md#confval-osd_op_queue) Ceph option to
...
See [QoS Based on mClock](../../../rados/configuration/osd-config-ref/index.md#dmclock-qos) section for more details. Even with all the mClock
...
code base. See [mClock Config Reference](../../../rados/configuration/mclock-config-ref/index.md). With the
...
> **Note:**
>
> Tests with HDDs were performed with and without the bluestore WAL and
...
in the [mClock Config Reference](../../../rados/configuration/mclock-config-ref/index.md) document under
...
> **Note:**
>
> The [`bluestore_throttle_bytes`](../../../rados/configuration/bluestore-config-ref/index.md#confval-bluestore_throttle_bytes) and
> [`bluestore_throttle_deferred_bytes`](../../../rados/configuration/bluestore-config-ref/index.md#confval-bluestore_throttle_deferred_bytes) for SSDs were determined to be
...
The *weight* parameter is unitless. See [QoS Based on mClock](../../../rados/configuration/osd-config-ref/index.md#dmclock-qos).
...
- [`osd_mclock_max_capacity_iops_hdd`](../../../rados/configuration/mclock-config-ref/index.md#confval-osd_mclock_max_capacity_iops_hdd)
- [`osd_mclock_max_capacity_iops_ssd`](../../../rados/configuration/mclock-config-ref/index.md#confval-osd_mclock_max_capacity_iops_ssd)
- [`osd_mclock_profile`](../../../rados/configuration/mclock-config-ref/index.md#confval-osd_mclock_profile)

See [mClock Config Reference](../../../rados/configuration/mclock-config-ref/index.md) for more details.
...
- [`osd_max_backfills`](../../../rados/configuration/osd-config-ref/index.md#confval-osd_max_backfills) = 1000
- [`osd_recovery_max_active`](../../../rados/configuration/osd-config-ref/index.md#confval-osd_recovery_max_active) = 1000
- [`osd_async_recovery_min_cost`](../../../rados/configuration/osd-config-ref/index.md#confval-osd_async_recovery_min_cost) = 1
...
![../../../_images/Avg_Client_Throughput_NVMe_SSD_WPQ_vs_mClock.png](../../../_images/Avg_Client_Throughput_NVMe_SSD_WPQ_vs_mClock.png)
...
default values. The default setting for [`osd_max_backfills`](../../../rados/configuration/osd-config-ref/index.md#confval-osd_max_backfills) limits the number
...
[Non-Default Ceph Recovery Options](index.md#non-default-ceph-recovery-options), things are quite different as shown in the
...
![../../../_images/Avg_Client_Latency_Percentiles_NVMe_SSD_WPQ_vs_mClock.png](../../../_images/Avg_Client_Latency_Percentiles_NVMe_SSD_WPQ_vs_mClock.png)
...
![../../../_images/Clat_Latency_Comparison_NVMe_SSD_WPQ_vs_mClock.png](../../../_images/Clat_Latency_Comparison_NVMe_SSD_WPQ_vs_mClock.png)
...
![../../../_images/Recovery_Rate_Comparison_NVMe_SSD_WPQ_vs_mClock.png](../../../_images/Recovery_Rate_Comparison_NVMe_SSD_WPQ_vs_mClock.png)
...
![../../../_images/Avg_Obj_Rec_Throughput_NVMe_SSD_WPQ_vs_mClock.png](../../../_images/Avg_Obj_Rec_Throughput_NVMe_SSD_WPQ_vs_mClock.png)
...
![../../../_images/Avg_Client_Throughput_HDD_WALdB_WPQ_vs_mClock.png](../../../_images/Avg_Client_Throughput_HDD_WALdB_WPQ_vs_mClock.png)
...
![../../../_images/Avg_Client_Latency_Percentiles_HDD_WALdB_WPQ_vs_mClock.png](../../../_images/Avg_Client_Latency_Percentiles_HDD_WALdB_WPQ_vs_mClock.png)
...
![../../../_images/Clat_Latency_Comparison_HDD_WALdB_WPQ_vs_mClock.png](../../../_images/Clat_Latency_Comparison_HDD_WALdB_WPQ_vs_mClock.png)
...
![../../../_images/Recovery_Rate_Comparison_HDD_WALdB_WPQ_vs_mClock.png](../../../_images/Recovery_Rate_Comparison_HDD_WALdB_WPQ_vs_mClock.png)
...
![../../../_images/Avg_Obj_Rec_Throughput_HDD_WALdB_WPQ_vs_mClock.png](../../../_images/Avg_Obj_Rec_Throughput_HDD_WALdB_WPQ_vs_mClock.png)
...
![../../../_images/Avg_Client_Throughput_HDD_NoWALdB_WPQ_vs_mClock.png](../../../_images/Avg_Client_Throughput_HDD_NoWALdB_WPQ_vs_mClock.png)
![../../../_images/Avg_Client_Latency_Percentiles_HDD_NoWALdB_WPQ_vs_mClock.png](../../../_images/Avg_Client_Latency_Percentiles_HDD_NoWALdB_WPQ_vs_mClock.png)
![../../../_images/Clat_Latency_Comparison_HDD_NoWALdB_WPQ_vs_mClock.png](../../../_images/Clat_Latency_Comparison_HDD_NoWALdB_WPQ_vs_mClock.png)

#### Recovery Statistics Comparison

The recovery rates and times are shown in the charts below.

![../../../_images/Avg_Obj_Rec_Throughput_HDD_NoWALdB_WPQ_vs_mClock.png](../../../_images/Avg_Obj_Rec_Throughput_HDD_NoWALdB_WPQ_vs_mClock.png)
![../../../_images/Recovery_Rate_Comparison_HDD_NoWALdB_WPQ_vs_mClock.png](../../../_images/Recovery_Rate_Comparison_HDD_NoWALdB_WPQ_vs_mClock.png)
