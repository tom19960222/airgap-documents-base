...
source_url: https://docs.ceph.com/en/squid/dev/cephfs-mirroring/
...
> **Note:**
>
> The user specified here is `mirror`, as created in the Creating
> Users section.
...
> **Note:**
>
> Configurations that have multiple mirror daemons are currently
...
> **Note:**
>
> The mirroring-module commands use the `fs snapshot mirror` prefix
...
> **Note:**
>
> See the Mirror Daemon Status section on how to figure out Peer
> UUID.
...
> **Note:**
>
> `instance_id` is the RADOS instance-id associated with a mirror
> daemon.
