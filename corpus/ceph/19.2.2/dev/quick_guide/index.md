...
collection: ceph
version: "19.2.2"
title: "Developer Guide (Quick)"
source_url: https://docs.ceph.com/en/squid/dev/quick_guide/
...
[Deploying a development cluster](../dev_cluster_deployment/index.md)) which allows developers to quickly test
