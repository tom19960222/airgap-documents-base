...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rados/api/librados-intro.rst
fetched_at: 2026-08-18T01:32:45Z
---
<a id="librados-intro"></a>
...
POSIX interfaces. Based upon RADOS (Reliable Autonomic Distributed Object
...
Refer to [../../architecture](../../architecture.md) for additional details of the Ceph
...
1. Clone the ``rados-java`` repository:

```bash
git clone --recursive https://github.com/ceph/rados-java.git
```

1. Build the ``rados-java`` repository:
...
1. Copy the JAR for RADOS to a common location (e.g., ``/usr/share/java``) and
...
1. Clone the ``phprados`` repository:
...
1. Enable ``phprados`` by adding the following line to ``php.ini``:
