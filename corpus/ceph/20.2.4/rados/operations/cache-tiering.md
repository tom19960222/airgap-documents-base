...
version: "20.2.4"
title: "Cache Tiering"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rados/operations/cache-tiering.rst
...
1. Remove the cache pool from the backing pool.:
...
1. Ensure that the cache pool has been flushed. This may take a few minutes:
...
1. Remove the overlay so that clients will not direct traffic to the cache.:
...
1. Finally, remove the cache tier pool from the backing storage pool.:
