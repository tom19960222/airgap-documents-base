...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rados/operations/erasure-code-clay.rst
...
1. For a configuration with *k=4*, *m=2*, *d=5*, the sub-chunk count is
   ...
   during repair.
1. When *k=8*, *m=4*, *d=11* the sub-chunk count is 64 and repair sub-chunk count
