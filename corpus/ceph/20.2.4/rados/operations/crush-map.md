...
version: "20.2.4"
title: "CRUSH Maps"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rados/operations/crush-map.rst
...
CRUSH maps contain a list of OSDs (Object Storage Devices) and a
...
> 1. The key name (left of ``=``) must be a valid CRUSH ``type``. By default,
...
rules, see **Section 3.2** of [CRUSH - Controlled, Scalable, Decentralized Placement of Replicated Data](https://ceph.io/assets/pdfs/weil-crush-sc06.pdf).
...
1. A **per-pool** weight set is more flexible in that it allows placement to
