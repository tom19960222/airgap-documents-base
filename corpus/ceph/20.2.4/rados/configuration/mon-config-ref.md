...
---
<a id="monitor-config-reference"></a>
...
Ceph Monitors use [Paxos](https://en.wikipedia.org/wiki/[Paxos](https://en.wikipedia.org/wiki/Paxos_(computer_science))(computer_science)) to establish consensus about the master cluster map.
...
distributed consensus algorithm called [Paxos](https://en.wikipedia.org/wiki/[Paxos](https://en.wikipedia.org/wiki/Paxos_(computer_science))(computer_science)). The Ceph Monitors must agree on
...
[Paxos](https://en.wikipedia.org/wiki/[Paxos](https://en.wikipedia.org/wiki/Paxos_(computer_science))(computer_science)) is not able to determine the current state of the system accurately.
...
See [Monitor Store Synchronization](mon-config-ref.md#monitor-store-synchronization) for details.
...
timeouts and the [Monitor Store Synchronization](mon-config-ref.md#monitor-store-synchronization) settings may influence
