...
version: "20.2.4"
title: "Emperor"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/releases/emperor.rst
...
1. Install the ceph-test package on each osd machine to get ceph_filestore_tool
1. Stop all osd processes
1. To see all lost objects, run the following on each osd with the osd stopped and
...
1. To fix all lost objects, run the following on each osd with the
...
1. Once lost objects have been repaired on each osd, you can restart
   the cluster.
...
1. Upgrade all monitors (upgrade ceph package, restart ceph-mon
   ...
   availability.
1. Upgrade all osds (upgrade ceph package, restart ceph-osd daemons).
