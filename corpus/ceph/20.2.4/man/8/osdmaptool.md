...
collection: ceph
version: "20.2.4"
title: "osdmaptool -- ceph osd cluster map manipulation tool"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/man/8/osdmaptool.rst
...
In which,
 ...
 1. A table for placement groups. Each row presents a placement group. With columns of:

    * placement group id,
    * acting set, and
    * primary OSD.
 1. A table for all OSDs. Each row presents an OSD. With columns of:
 ...
 1. Looking at the number of placement groups held by 3 OSDs. We have

    * average, stddev, stddev/average, expected stddev, expected stddev / average
    * min and max
 1. The number of placement groups mapping to n OSDs. In this case, all 8 placement
