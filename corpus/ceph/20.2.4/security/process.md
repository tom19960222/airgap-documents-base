...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/security/process.rst
fetched_at: 2026-08-18T01:32:45Z
---
# Vulnerability Management Process

1. The report will be acknowledged within three business days.
1. The team will investigate the reported issue and will update the email
   thread with relevant information. The team may ask for additional
   information regarding the reported issue.
1. If the team does not confirm the report, no further action will be
   taken and the issue will be closed.
1. If the report is confirmed by Ceph team members, a unique CVE identifier
   will be assigned to the report and then shared with the reporter. The Ceph
   security team will start working on a fix.
1. If a reporter has no disclosure date in mind, a Ceph security team
...
1. The vulnerability disclosure / release date is set excluding Friday and
   holiday periods.
1. Embargoes are preferred for Critical and High impact
...
1. Fixes for issues of "Medium" and "Low" severity will be released as part of
