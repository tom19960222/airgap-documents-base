...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/start/beginners-guide.rst
...
1. Install the Ceph development environment:
...
1. Build the vstart cluster:

```bash
ninja vstart
```

1. Start the vstart cluster:
...
1. [Sage Weil's 2018 talk "Ceph, the Future of Storage" (27m)](https://www.youtube.com/watch?v=szE4Hg1eXoA)
