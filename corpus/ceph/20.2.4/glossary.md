...
.. glossary::
   ...
   Application
	...
	Ceph Dashboard
                The Ceph Dashboard is a built-in
                ...
                the cluster. It is implemented as a ceph-manager-daemon
                module.
	...
	CephFS
        ...
        ceph-fuse
                ceph-fuse is a FUSE ("**F**\ilesystem in
	...
	Ceph Storage Cluster
                The collection of Ceph Monitor\s, :term:`Ceph
	...
	Dashboard
                ...
                mgr-dashboard for more details.
	...
	Dashboard Plugin
        ...
        Flapping OSD
                ...
                rapid succession. See rados_tshooting_flapping_osd.
	...
	Primary Affinity
        ...
        Prometheus
                ...
                "Prometheus module", which provides a
        ...
        Quorum
                ...
                Monitors in the cluster are `up`. A
                minimum of three Monitors must exist in
	...
	RADOS Cluster
                ...
                OSD\s, Ceph Monitor\s, and :term:`Ceph
                Manager`\s.
	...
	RGW
        ...
        scrubs
                ...
                See Scrubbing in the RADOS OSD
