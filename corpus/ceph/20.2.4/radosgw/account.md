...
version: "20.2.4"
title: "User Accounts"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/radosgw/account.rst
...
1. **Re-creation of Topics:** The account user should re-create the topics using
   the same names. The old topics (now inaccessible) and the new account-owned topics
   will coexist without interference.

1. **Updating Bucket Notification Configurations:** Buckets that are subscribed to
...
1. Create an IAM user, add credentials, and attach a policy for S3 access:
...
1. Create a profile for the S3 user:
...
1. Use the S3 user profile to create a bucket:
