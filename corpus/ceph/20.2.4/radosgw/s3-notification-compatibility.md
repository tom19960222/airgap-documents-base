...
The records sent for bucket notification follows the format described in: Event Message Structure.
...
## Topic Configuration
In the case of bucket notifications, the topics management API will be derived from AWS Simple Notification Service API.
