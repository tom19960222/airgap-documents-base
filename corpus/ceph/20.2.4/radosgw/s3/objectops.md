...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/radosgw/s3/objectops.rst
...
| **x-amz-acl** <br> <br> <br> | A canned ACL. <br> <br> <br> | ``private``, <br> ``public-read``, <br> ``public-read-write``, <br> ``authenticated-read`` | No <br> <br> <br> |
