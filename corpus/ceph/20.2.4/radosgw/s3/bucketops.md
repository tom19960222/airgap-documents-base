...
+-------------------------------+-----------+----------------------------------------------------------------+
| `LocationConstraint`        | String    | A zonegroup api name, with optional s3_bucket_placement |
+-------------------------------+-----------+----------------------------------------------------------------+
...
+-------------------------------+-----------+--------------------------------------------------------------------------------------+----------+
| `Event`                     | String    | List of supported events see: S3 Notification Compatibility.  Multiple `Event`  | No       |
