...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/radosgw/cloud-transition.rst
...
via storage_classes. The transition is unidirectional: data cannot be
...
See adding_a_storage_class for how to configure storage-class for a zonegroup. The cloud transition requires a creation of a special storage class with tier type defined as `cloud-s3` or `cloud-s3-glacier`.

> **Note:** If you have not performed previous Multisite Configuration,
...
[Restoring Objects from Cloud](https://docs.ceph.com/en/latest/radosgw/cloud-restore/).
