...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/mgr/modules.rst
fetched_at: 2026-08-18T01:32:45Z
---
<a id="mgr-module-dev"></a>
...
* a ``handle_command`` member function if your module
  ...
  is deprecated. For more details, see [mgr-module-exposing-commands](modules.md#mgr-module-exposing-commands).
...
[Orchestrator modules](orchestrator_modules.md#orchestrator-modules) for more on
...
<a id="mgr-module-exposing-commands"></a>
...
<a id="mgr-module-dev-configuration-options"></a>
...
> binary configuration data consider using the [KV store](modules.md#kv-store).
...
Apparently, we can always use the [mgr module dev logging](modules.md#mgr-module-dev-logging) facility
...
Mixin <!-- unresolved-rst-link: kind=named target=Mixin --> class and inherit your ``MgrModule`` subclass from it. And define
