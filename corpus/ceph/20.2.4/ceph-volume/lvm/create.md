...
The single-call process unifies exactly what ceph-volume-lvm-prepare and
ceph-volume-lvm-activate do, with the convenience of doing it all at
once.
...
Please refer to ceph-volume-lvm-prepare for details.
