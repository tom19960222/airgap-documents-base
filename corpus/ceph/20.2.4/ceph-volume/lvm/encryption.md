...
version: "20.2.4"
title: "Encryption"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/ceph-volume/lvm/encryption.rst
fetched_at: 2026-08-18T01:32:45Z
---
<a id="ceph-volume-lvm-encryption"></a>
...
with bluestore), the logical volume is left ready
...
1. OSD is created. Both lockbox and dmcrypt keys are created and sent to the
   monitors in JSON format, indicating an encrypted OSD.

1. All complementary devices (like journal, db, or wal) get created and
   encrypted with the same OSD key. Key is stored in the LVM metadata of the
   OSD.

1. Activation continues by ensuring devices are mounted, retrieving the dmcrypt
