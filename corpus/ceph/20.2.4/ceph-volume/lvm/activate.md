...
---
<a id="ceph-volume-lvm-activate"></a>

# ``activate``

After [ceph-volume-lvm-prepare](prepare.md#ceph-volume-lvm-prepare) has completed its run, the volume can be
activated.
...
[cephadm-osd-activate](../../cephadm/services/osd.md#cephadm-osd-activate).
...
> generated when [ceph-volume-lvm-prepare](prepare.md#ceph-volume-lvm-prepare) is used.

## Activating all OSDs

> **Note:** For OSDs deployed by cephadm, please refer to [cephadm-osd-activate](../../cephadm/services/osd.md#cephadm-osd-activate)
> instead.
...
> **Note:** for more details on the systemd workflow see [ceph-volume-lvm-systemd](systemd.md#ceph-volume-lvm-systemd)
...
[ceph-volume-lvm-existing-osds](prepare.md#ceph-volume-lvm-existing-osds) for details on how to proceed.
