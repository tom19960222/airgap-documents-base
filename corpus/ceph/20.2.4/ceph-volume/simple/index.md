...
* [ceph-volume-simple-scan](scan.md#ceph-volume-simple-scan)

* [ceph-volume-simple-activate](activate.md#ceph-volume-simple-activate)

* [ceph-volume-simple-systemd](systemd.md#ceph-volume-simple-systemd)
...
1. [Scan](scan.md#ceph-volume-simple-scan) the running OSD or the data device
1. [Activate](activate.md#ceph-volume-simple-activate) the scanned OSD
