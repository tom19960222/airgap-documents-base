...
pluggable tools (lvm/index itself is treated like a plugin) and trying to
...
The ceph-volume-inventory subcommand provides information and metadata
...
1. Keep OSDs deployed with `ceph-disk`: The ceph-volume-simple command
...
ceph-volume-simple. A scan is done on the data device or OSD directory,
