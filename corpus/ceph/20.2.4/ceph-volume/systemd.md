...
version: "20.2.4"
title: "systemd"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/ceph-volume/systemd.rst
fetched_at: 2026-08-18T01:32:45Z
---
<a id="ceph-volume-systemd"></a>

# systemd
As part of the activation process (either with [ceph-volume-lvm-activate](lvm/activate.md#ceph-volume-lvm-activate)
or [ceph-volume-simple-activate](simple/activate.md#ceph-volume-simple-activate)), systemd units will get enabled that
...
the processing might need. In the case of [ceph-volume-lvm](lvm/index.md#ceph-volume-lvm) and
[ceph-volume-simple](simple/index.md#ceph-volume-simple), both look to consume the OSD id and OSD uuid,
...
The enabled unit is a systemd oneshot service, meant to start at boot
