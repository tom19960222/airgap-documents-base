...
# systemd
As part of the activation process (either with ceph-volume-lvm-activate
or ceph-volume-simple-activate), systemd units will get enabled that
...
the processing might need. In the case of ceph-volume-lvm and
ceph-volume-simple, both look to consume the OSD id and OSD uuid,
