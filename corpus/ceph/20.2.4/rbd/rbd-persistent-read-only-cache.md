...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rbd/rbd-persistent-read-only-cache.rst
...
1. **LRU based promotion/demotion policy:** The daemon maintains in-memory
   statistics of cache hits for each cache file. It demotes the cold cache
   if capacity reaches the configured threshold.

1. **File-based caching store:** The daemon maintains a simple file-based cache
