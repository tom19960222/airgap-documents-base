...
collection: ceph
version: "20.2.4"
title: "Block Devices and CloudStack"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rbd/rbd-cloudstack.rst
...
1. Click **Infrastructure** on the left side navigation bar.
1. Select **View All** under **Primary Storage**.
1. Click the **Add Primary Storage** button on the top right hand side.
1. Fill in the following information, according to your infrastructure setup:
...
1. Add cluster information (``cephx`` is supported).
