...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rbd/iscsi-target-cli.rst
...
1. Go to iscsi-targets and create a target with the name
...
1. Create the iSCSI gateways. The IPs used below are the ones that will be
...
1. Add a RBD image with the name disk_1 in the pool rbd:
...
1. Create a client with the initiator name iqn.1994-05.com.redhat:rh7-client:
...
1. Set the initiator CHAP username and password which the target would
