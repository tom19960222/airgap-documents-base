...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/rbd/rbd-openstack.rst
...
- **Guest Disks**: Guest disks are guest operating system disks. By default,
  ...
  [exclusive locks](rbd-exclusive-locks.md#rbd-exclusive-locks) prevent multiple
...
If you are using [cephx authentication](../rados/configuration/auth-config-ref.md#enabling-disabling-cephx), also configure the user and uuid of
...
You can use [qemu-img](qemu-rbd.md#running-qemu-with-rbd) to convert from one format to another. For example:
...
1. Choose the image associated to the copy-on-write clone.
1. Select 'boot from volume'.
