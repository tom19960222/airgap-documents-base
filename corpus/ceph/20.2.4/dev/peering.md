...
version: "20.2.4"
title: "Peering"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/peering.rst
...
The high level process is for the current PG primary to:
  ...
  1. generate a list of *past intervals* since *last epoch started*.
  ...
  1. ask every node in that list for its *PG info*, which includes the most
  ...
  1. if anyone else has (in its PG log) operations that I do not have,
  ...
  1. if the primary's *up_thru* value in the current OSD map is not greater than
  ...
  1. at this point all OSDs in the *acting set* agree on all of the meta-data,
