...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/developer_guide/jaegertracing.rst
...
refer to the [Ceph Tracing documentation](../../jaegertracing/index.md#basic-architecture-and-terminology)
...
```
  ...
  will deploy [jaeger all-in-one](https://www.jaegertracing.io/docs/1.20/getting-started/#all-in-one)
