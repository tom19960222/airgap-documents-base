...
---
<a id="tests-integration-testing-teuthology-workflow"></a>
...
![](https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/developer_guide/testing_integration_tests/workflow.png)
...
1. Wait for the packages to be built and uploaded to [Chacra](https://github.com/ceph/chacra/blob/master/README.rst), and wait for
...
See [Suites Inventory](tests-integration-testing-teuthology-intro.md#suites-inventory) for a list of available suites of integration tests.

More details understanding of how these test suites are defined can be found on [Integration Test Introduction Page](tests-integration-testing-teuthology-intro.md#how-integration-tests-are-defined).
...
1. For initial setup, follow [teuthology installation guide](https://docs.ceph.com/projects/teuthology/en/latest/INSTALL.html#installation-and-setup) to setup teuthology for
...
> Do not use it in your own tests. See [Testing Priority](tests-integration-testing-teuthology-intro.md#testing-priority) for information
...
Read more about how to [Filter Tests by their Description](tests-integration-testing-teuthology-intro.md#filtering-tests-by-their-description).
