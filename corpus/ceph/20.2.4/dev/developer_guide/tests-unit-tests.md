...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/developer_guide/tests-unit-tests.rst
fetched_at: 2026-08-18T01:32:45Z
---
<a id="dev-testing-unit-tests"></a>
...
the more complex "integration tests" that are run via the [teuthology framework](https://github.com/ceph/teuthology).
...
called [cram](https://bitheap.org/cram/) via a shell script called ``./src/test/run-cli-tests``.
[cram](https://bitheap.org/cram/) tests that are not suitable for ``make check`` can also be run by
teuthology using the [cram task](https://github.com/ceph/ceph/blob/master/qa/tasks/cram.py).

### Tox-based testing of Python modules
Some of the Python modules in Ceph use [tox](https://tox.readthedocs.io/en/latest/)
...
1. Google Test unit testing library hides the client output from the shell.
