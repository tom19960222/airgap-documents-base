...
collection: ceph
version: "20.2.4"
title: "config-key layout"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/config-key.rst
...
* `mask` restricts who the option applies to, and can take two forms:
  ...
  1. `$crush_type:$crush_value`.  For example, `rack:foorack`
  1. `class:$classname`, in reference to CRUSH device classes (e.g., `ssd`)
