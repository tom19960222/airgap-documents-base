...
version: "20.2.4"
title: "Snaps"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/osd_internals/snaps.rst
...
PG is clean and not scrubbing.
  ...
  1. We determine the next object for trimming out of PG::snap_mapper.
     ...
     is empty.)
  1. We also locally update our *SnapMapper* instance with the object's
     new snaps.
  1. The log entry containing the modification of the object also
     contains the new set of snaps, which the replica uses to update
     its own *SnapMapper* instance.
  1. The primary shares the info with the replica, which persists
