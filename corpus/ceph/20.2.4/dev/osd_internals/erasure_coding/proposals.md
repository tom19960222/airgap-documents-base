...
collection: ceph
version: "20.2.4"
title: "Proposed Next Steps for ECBackend"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/osd_internals/erasure_coding/proposals.rst
...
1. During backfill, we compare versions between primary and target
   to avoid some pushes. We use it elsewhere as well
1. While pushing and pulling objects, we verify the version.
1. We return it on reads and writes and allow the librados user to
