...
collection: ceph
version: "20.2.4"
title: "OSDMap Trimming and PastIntervals"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/dev/osd_internals/past_intervals.rst
 ...
 * During peering, we need to consider the acting set for every epoch back to
   ...
   became active.
   (see [/dev/osd_internals/last_epoch_started](last_epoch_started.md) for a detailed explanation)
