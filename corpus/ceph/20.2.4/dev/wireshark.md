...
To use the Wireshark dissector you must build it from git_, the process is
outlined in great detail in the Building and Installing_ section of the
Wireshark Users Guide_.
...
The Ceph dissector lives in Wireshark git at
