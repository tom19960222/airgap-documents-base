...
The /dev/sepia runs `teuthology
<https://github.com/ceph/teuthology/>`_ integration tests [on a regular basis](http://tracker.ceph.com/projects/ceph-releases/wiki/HOWTO_monitor_the_automated_tests_AKA_nightlies#Automated-tests-AKA-nightlies) and the
