...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/cephadm/upgrade.rst
...
> **Note:**
> .. note::
>    Staggered Upgrade of the Monitors and Managers may be necessary to use
...
>                `up:standby` state.
>
>             1. Upgrade MDS daemons safely.
>
>             1. Bring CephFS filesystems back up, bringing the state of active
...
For more information about available container images, see containers.
...
follows the same format as the command line options for orchestrator-cli-placement-spec.
