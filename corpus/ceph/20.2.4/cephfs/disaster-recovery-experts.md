...
1. Scan the first object from every file to collect this metadata and
...
1. Check inode linkages and fixing found errors:
...
1. Use the following commands to rebuild the metadata pool from the data pool:
