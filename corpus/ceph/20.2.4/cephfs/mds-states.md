...
version: "20.2.4"
title: "MDS States"
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/cephfs/mds-states.rst
...
The MDS is available to takeover for a failed rank (see also [mds-standby](standby.md#mds-standby)).
...
(see also [cephfs-administration](administration.md#cephfs-administration)).
...
standby daemons have incompatible compat (see also [upgrade-mds-cluster](upgrading.md#upgrade-mds-cluster)).
...
Rank 0 has become damaged (see also [cephfs-disaster-recovery](disaster-recovery.md#cephfs-disaster-recovery)) and placed in
...
The rank has been stopped by reducing ``max_mds`` (see also [cephfs-multimds](multimds.md#cephfs-multimds)).
