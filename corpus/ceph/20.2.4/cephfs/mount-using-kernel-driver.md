...
source_url: https://github.com/ceph/ceph/blob/7f793731f1b39eb4f465e960113d2363c311b964/doc/cephfs/mount-using-kernel-driver.rst
...
as described on the Mount CephFS: Prerequisites page.
...
1. `fsid` is the FSID of the Ceph cluster, which can be found using the
...
See User Management for details on CephX user management and the mount.ceph_
manual for a list of the options it recognizes. For troubleshooting, see
kernel_mount_debugging.
