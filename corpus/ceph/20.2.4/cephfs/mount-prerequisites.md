...
cephfs-shell. A system mount can be performed using `the
kernel driver`_ as well as the FUSE driver. Both have their own advantages
...
```
   ...
   information, see Client Authentication and bootstrap-options.
