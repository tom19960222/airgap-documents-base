...
collection: cdi
version: "1.56.1"
title: "CDI Upload User Guide"
source_url: https://github.com/kubevirt/containerized-data-importer/blob/ee9a06635eed17f8a635915bbb2f354ce38c8f72/doc/upload.md
...
To create an upload datavolume use the following [example](../manifests/example/upload-datavolume.yaml) <!-- unresolved-source-link: target=../manifests/example/upload-datavolume.yaml -->.
```yaml
