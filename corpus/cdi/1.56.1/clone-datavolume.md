...
collection: cdi
version: "1.56.1"
title: "How to clone an image from a PV to a file system PV"
source_url: https://github.com/kubevirt/containerized-data-importer/blob/ee9a06635eed17f8a635915bbb2f354ce38c8f72/doc/clone-datavolume.md
...
Create the following DataVolume manifest [clone-datavolume.yaml](../manifests/example/clone-datavolume.yaml) <!-- unresolved-source-link: target=../manifests/example/clone-datavolume.yaml -->:
