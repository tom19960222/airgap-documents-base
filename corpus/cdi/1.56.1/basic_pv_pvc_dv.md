...
collection: cdi
version: "1.56.1"
title: "Create local-volume directories"
source_url: https://github.com/kubevirt/containerized-data-importer/blob/ee9a06635eed17f8a635915bbb2f354ce38c8f72/doc/basic_pv_pvc_dv.md
...
This will create a 5Gi sized PV, and now you are ready to apply one of the many [examples](../manifests/example) <!-- unresolved-source-link: target=../manifests/example --> to this PV. If you run
