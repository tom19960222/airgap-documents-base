...
source_url: https://github.com/kubernetes-csi/external-provisioner/blob/753b615576935c6abdd9eb770708abb5845f2ee6/README.md
...
The [design document](design.md) explains this in more detail.
...
[`deploy/kubernetes/storage-capacity.yaml`](deploy/kubernetes/storage-capacity.yaml) <!-- unresolved-source-link: target=deploy/kubernetes/storage-capacity.yaml -->
example):
