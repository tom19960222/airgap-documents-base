...
version: "17.9.8"
title: "Feature flags"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/feature_flags.md
...
To change these settings, select **Edit** ([icon: pencil])
...
and selecting **Edit** ([icon: pencil]).
...
You can view a list's User IDs by selecting **Edit** ([icon: pencil]) next to it.
When viewing a list, you can rename it by selecting **Edit** ([icon: pencil]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Deploy > Feature flags**.
1. Select **Edit** ([icon: pencil]) next to the list you want to add users to.
1. Select **Add Users**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Deploy > Feature flags**.
1. Select **Edit** ([icon: pencil]) next to the list you want to change.
1. Select **Remove** ([icon: remove]) next to the ID you want to remove.
...
1. Select **More actions** ([icon: ellipsis_v]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Deploy > Feature flags**.
1. For the feature flag you want to disable, select **Edit** ([icon: pencil]).
