...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/incident_management/incident_timeline_events.md
...
1. On the comment you want to add, select **Add comment to incident timeline** ([icon: clock]).
...
1. Select an incident.
1. Select the **Timeline** tab.
1. On the right of a timeline event, select **More actions** ([icon: ellipsis_v]) and then select **Delete**.
1. To confirm, select **Delete Event**.

Alternatively:

1. On the right of a timeline event, select **More actions** ([icon: ellipsis_v]) and then select **Edit**.
1. Select **Delete**.
1. To confirm, select **Delete event**.
