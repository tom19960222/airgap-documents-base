...
version: "17.9.8"
title: "Alerts"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/incident_management/alerts.md
...
|----------|-------------------------|---------------------|
| Critical | [icon: severity-critical] | `#8b2615`           |
| High     | [icon: severity-high]     | `#c0341d`           |
| Medium   | [icon: severity-medium]   | `#fca429`           |
| Low      | [icon: severity-low]      | `#fdbc60`           |
| Info     | [icon: severity-info]     | `#418cd8`           |
| Unknown  | [icon: severity-unknown]  | `#bababa`           |
...
1. If the right sidebar is not expanded, select
   **Expand sidebar** ([icon: chevron-double-lg-right]) to expand it.
