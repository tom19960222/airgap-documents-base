...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/incident_management/manage_incidents.md
...
To close an incident, in the upper-right corner, select **Incident actions** ([icon: ellipsis_v]) and then **Close incident**.
...
1. In an incident, select **Incident actions** ([icon: ellipsis_v]).
1. Select **Delete incident**.

Alternatively:

1. In an incident, select **Edit title and description** ([icon: pencil]).
1. Select **Delete incident**.
