...
version: "17.9.8"
title: "Integrations"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/incident_management/integrations.md
...
You can edit the integration by selecting the [icon: settings] settings icon on the right
...
1. Select the [icon: settings] settings icon on the right side of the integration in [the list](#integrations-list).
