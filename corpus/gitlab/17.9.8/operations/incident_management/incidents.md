...
version: "17.9.8"
title: "Incidents"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/operations/incident_management/incidents.md
...
- **Severity**: Severity of a particular incident, which can be one of the following
  ...
  - [icon: severity-critical] Critical - S1
  - [icon: severity-high] High - S2
  - [icon: severity-medium] Medium - S3
  - [icon: severity-low] Low - S4
  - [icon: severity-unknown] Unknown
...
**Turn recent updates view on** ([icon: history]) on the comment bar. Comments display
