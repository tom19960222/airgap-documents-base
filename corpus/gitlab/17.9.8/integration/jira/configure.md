...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/integration/jira/configure.md
...
> You can enable this setting only for individual projects and groups.
   ...
   1. Select **Fetch issue types for this project key** ([icon: retry]),
