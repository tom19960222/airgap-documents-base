...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/integration/jira/jira_server_configuration.md
...
1. On the top bar, in the upper-right corner, select **Administration** ([icon: settings]) > **User management**.
...
1. On the top bar, in the upper-right corner, select **Administration** ([icon: settings]) > **Issues**.
