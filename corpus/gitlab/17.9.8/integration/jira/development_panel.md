...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/integration/jira/development_panel.md
...
|:-------------------------------------|:-----------------------|:--------------------------|
| Smart Commits                        | [icon: check-circle] Yes | [icon: check-circle] Yes    |
| Sync merge requests                  | [icon: check-circle] Yes | [icon: check-circle] Yes    |
| Sync branches                        | [icon: check-circle] Yes | [icon: check-circle] Yes    |
| Sync commits                         | [icon: check-circle] Yes | [icon: check-circle] Yes    |
| Sync existing data                   | [icon: check-circle] Yes | [icon: check-circle] Yes (see [GitLab data synced to Jira](connect-app.md#gitlab-data-synced-to-jira)) |
| Sync builds                          | [icon: dotted-circle] No | [icon: check-circle] Yes    |
| Sync deployments                     | [icon: dotted-circle] No | [icon: check-circle] Yes    |
| Sync feature flags                   | [icon: dotted-circle] No | [icon: check-circle] Yes    |
| Sync interval                        | Up to 60 minutes       | Real time                 |
| Delete branches                      | [icon: dotted-circle] No | [icon: check-circle] Yes    |
| Create a merge request from a branch | [icon: check-circle] Yes | [icon: check-circle] Yes    |
| Create a branch from a Jira issue    | [icon: dotted-circle] No | [icon: check-circle] Yes    |
