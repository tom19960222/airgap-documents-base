...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/integration/jira/dvcs/troubleshooting.md
...
1. For the account (group or subgroup), select
   **Refresh repositories** from the [icon: ellipsis_h] (ellipsis) menu.
