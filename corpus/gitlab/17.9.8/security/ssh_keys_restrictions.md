...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/security/ssh_keys_restrictions.md
...
If you have a restricted key, a warning icon ([icon: warning]) is visible to you in the **SSH keys** section of your profile.
