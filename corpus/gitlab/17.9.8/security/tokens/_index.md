...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/security/tokens/_index.md
...
|-----------------------------|------------------------------------|------------------------------------|-------------------|
| Personal access token       | [icon: check-circle] Yes             | [icon: check-circle] Yes             | [icon: check-circle] Yes |
| OAuth 2.0 token             | [icon: check-circle] Yes             | [icon: dotted-circle] No             | [icon: check-circle] Yes |
| Impersonation token         | [icon: check-circle] Yes             | [icon: check-circle] Yes             | [icon: check-circle] Yes |
| Project access token        | [icon: check-circle] Yes<sup>1</sup> | [icon: check-circle] Yes<sup>1</sup> | [icon: check-circle] Yes<sup>1</sup> |
| Group access token          | [icon: check-circle] Yes<sup>2</sup> | [icon: check-circle] Yes<sup>2</sup> | [icon: check-circle] Yes<sup>2</sup> |
| Deploy token                | [icon: dotted-circle] No             | [icon: check-circle] Yes             | [icon: check-circle] Yes |
| Deploy key                  | [icon: dotted-circle] No             | [icon: dotted-circle] No             | [icon: check-circle] Yes |
| Runner registration token   | [icon: dotted-circle] No             | [icon: dotted-circle] No             | [icon: check-circle-dashed] Limited<sup>3</sup> |
| Runner authentication token | [icon: dotted-circle] No             | [icon: dotted-circle] No             | [icon: check-circle-dashed] Limited<sup>3</sup> |
| Job token                   | [icon: check-circle-dashed] Limited<sup>4</sup> | [icon: dotted-circle] No  | [icon: check-circle] Yes |
