...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/issue_triage/_index.md
...
1. On the Labels page, next to a label you want to prioritize, select the star ([icon: star-o]).
...
1. On the **Open** list, select **Create new issue** ([icon: plus]).
