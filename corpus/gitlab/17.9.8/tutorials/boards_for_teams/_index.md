...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/boards_for_teams/_index.md
...
1. In your group, on the left sidebar, at the top, select **Create new** ([icon: plus]) and then select
...
1. On the `Workflow::Ready for development` list, select **Create new issue** ([icon: plus]).
