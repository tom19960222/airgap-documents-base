...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/create_register_first_runner/_index.md
...
1. Select the plus icon ([icon: plus]), then select **New file**.
