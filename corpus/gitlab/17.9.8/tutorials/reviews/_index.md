...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/reviews/_index.md
...
- **Have any reviewers already approved?** If you know those reviewers and their areas of expertise,
  ...
  ([icon: dotted-circle]) the merge request. Nick has reviewed and approved ([icon: check-circle]):
...
- **What files have changed?** Expand the file browser ([icon: file-tree]) to see
...
1. When you find lines you want to ask questions about, or provide feedback on,
   select **Add a comment to this line** ([icon: comment]) in the gutter. This expands
...
and are shown in the reviewer list, a green check mark [icon: check-circle-filled]
