...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/update_commit_messages/_index.md
...
1. In the dropdown list, copy the URL for your repository by selecting [icon: copy-to-clipboard] next to:
