...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/scrum_events/_index.md
...
1. On the top of the **`priority::now`** list, select the **New epic** ([icon: plus]) icon.
...
1. Open the **Backlog** issue board:
   ...
   1. In the upper-left corner, select the dropdown list with the current board name.
   1. Select **Backlog**.
1. In the list for the upcoming sprint, select **Create new issue** ([icon: plus-square]).
