...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/merge_requests/homepage.md
...
- 31 open issues ([icon: issue-type-issue])
- 8 active merge requests ([icon: merge-request-open])
- 29 to-do items ([icon: todo-done])
