...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/protected_workflow/_index.md
...
1. On the overview page for the `engineering` group, on the left sidebar, at the top,
   select **Create new** ([icon: plus]) and **In this group > New project/repository**.
...
1. Next to the branch name, select the plus icon ([icon: plus]), then **New file**:
