...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/container_scanning/_index.md
...
1. In your `Tutorial container scanning project` project, select [icon: plus] > **New file**.
...
1. In the root directory of your project, select [icon: plus] > **New file**.
