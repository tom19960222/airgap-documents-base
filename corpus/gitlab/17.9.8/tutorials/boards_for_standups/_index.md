...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/tutorials/boards_for_standups/_index.md
...
1. In the upper-right corner, select **Add list** ([icon: plus]).
...
1. On your team stand-up board, select **Configure board** ([icon: settings]).
...
1. On your team stand-up board, in the `workflow::ready for development` list, select **Create new issue** ([icon: plus]).
1. Complete the fields:
