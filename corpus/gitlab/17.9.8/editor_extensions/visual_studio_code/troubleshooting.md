...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/editor_extensions/visual_studio_code/troubleshooting.md
...
1. In VS Code, on the left sidebar, select **GitLab Workflow** ([icon: tanuki]).
