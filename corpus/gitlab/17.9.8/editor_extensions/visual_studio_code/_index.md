...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/editor_extensions/visual_studio_code/_index.md
...
1. Find the shortcut you want to edit, and select **Change keybinding** ([icon: pencil]).
...
1. On the vertical menu bar, select **GitLab Workflow** ([icon: tanuki]) to display the extension sidebar.
...
1. On the menu bar, select **GitLab Workflow** ([icon: tanuki]) to display the extension sidebar.
