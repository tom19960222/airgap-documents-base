...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/profile/preferences.md
...
Control what page you view when you select the GitLab logo ([icon: tanuki]). You can set your homepage to be Your Projects (default), Your Groups, Your Activity, and other content.
...
1. On the left sidebar, select **Source Control** ([icon: branch]).
