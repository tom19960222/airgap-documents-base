...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/profile/comment_templates.md
...
1. In the editor toolbar for your comment, select **Comment templates** ([icon: comment-lines]).
...
1. On the left sidebar, select **Comment templates** ([icon: comment-lines]).
1. Select **Add new**.
...
1. In the editor toolbar for a comment, select **Comment templates**
   ([icon: comment-lines]), then select **Manage group comment templates**.
1. Select **Add new**.
1. Provide a **Name** for your comment template.
1. Enter the **Content** of your reply. You can use any formatting you use in
   other GitLab text areas.
...
1. In the editor toolbar for a comment, select **Comment templates**
   ([icon: comment-lines]), then select **Manage project comment templates**.
1. Select **Add new**.
1. Provide a **Name** for your comment template.
1. Enter the **Content** of your reply. You can use any formatting you use in
   other GitLab text areas.
...
1. To edit, select **Edit** ([icon: pencil]).
1. To delete, select **Delete** ([icon: remove]), then select **Delete** again on the dialog.
