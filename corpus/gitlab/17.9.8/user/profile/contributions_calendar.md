...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/profile/contributions_calendar.md
...
1. In the upper-right corner, select the feed symbol ([icon: rss]) to display the results as an RSS feed in Atom format.
