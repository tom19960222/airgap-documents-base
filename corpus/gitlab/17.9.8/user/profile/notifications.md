...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/profile/notifications.md
...
1. Select the notification dropdown list, next to the bell icon ([icon: notifications]).
1. Select the desired [notification level](#notification-levels).
...
select the vertical ellipsis ([icon: ellipsis_v]), then turn on or off the **Notifications** toggle.
