...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/profile/personal_access_tokens.md
...
1. Select **Edit profile**.
1. On the left sidebar, select **Access tokens**.
1. In the **Active personal access tokens** area, for the relevant token, select **Revoke** ([icon: remove]) or **Rotate** ([icon: retry]).
