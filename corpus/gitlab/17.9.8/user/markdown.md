...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/markdown.md
...
1. In the editor's toolbar, select **Insert or edit diagram** ([icon: diagram]).
...
1. Select **Insert or edit diagram** ([icon: diagram]).
...
1. In the editor's toolbar, select **More options** ([icon: plus]).
...
1. In the floating toolbar, select **Edit diagram** ([icon: diagram]).
1. Edit the diagram in the [app.diagrams.net](https://app.diagrams.net/) editor.
1. Select **Save & exit**.
