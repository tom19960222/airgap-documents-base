...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/infrastructure/clusters/connect/new_civo_cluster.md
...
1. Next to the **deploy** job, select **Manual action** ([icon: status_manual]).
...
1. Next to the **destroy-environment** job, select **Manual action** ([icon: status_manual]).
