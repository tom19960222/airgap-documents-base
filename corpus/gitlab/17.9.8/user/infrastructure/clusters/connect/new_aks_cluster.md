...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/infrastructure/clusters/connect/new_aks_cluster.md
...
1. Next to **Play** ([icon: play]), select the dropdown list icon ([icon: chevron-lg-down]).
...
1. For the `destroy` job, select **Play** ([icon: play]).
