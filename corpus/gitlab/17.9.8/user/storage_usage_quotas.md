...
version: "17.9.8"
title: "Storage"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/storage_usage_quotas.md
...
- Projects that are read-only because purchased storage available is zero. Read-only projects are
  marked with an information icon ([icon: information-o]) beside their name.
...
|------------|--------------|----------------|--------|----------------------|
| Red        | 10 GiB        | 0 GiB           | 10 GiB  | Read-only [icon: lock] |
| Blue       | 8 GiB         | 0 GiB           | 10 GiB  | Not read-only        |
| Green      | 10 GiB        | 0 GiB           | 10 GiB  | Read-only [icon: lock] |
