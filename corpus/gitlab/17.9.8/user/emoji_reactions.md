...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/emoji_reactions.md
...
1. In the upper-right corner of the comment, select the smile ([icon: slight-smile]).
...
1. Select **Add reaction** ([icon: slight-smile]).
1. Select the GitLab logo ([icon: tanuki]) or scroll down to the **Custom** section.
1. Select an emoji from the emoji picker.
...
1. On a description or a comment, select **Add reaction** ([icon: slight-smile]).
