...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/okrs.md
...
1. In the upper-right corner, next to **New issue**, select the down arrow [icon: chevron-lg-down] and then select **New objective**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Plan > Issues**, then select your issue to view it.
1. In the upper-right corner, select the vertical ellipsis ([icon: ellipsis_v]), then select **Copy objective email address** or **Copy key result email address**.
...
Wherever OKRs are listed, you can see the confidential ([icon: eye-slash]) icon
...
Likewise, while inside the OKR, you can see the confidential ([icon: eye-slash]) icon right next to
the breadcrumbs.
...
next to each item, select the vertical ellipsis ([icon: ellipsis_v]) and then select **Remove**.
