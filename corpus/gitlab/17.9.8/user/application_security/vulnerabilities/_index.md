...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/vulnerabilities/_index.md
...
1. Optional. To remove the default filters, select **Clear** ([icon: clear]).
...
1. Select a merge request.
   - Vulnerability findings supported by Vulnerability Resolution are indicated by the tanuki AI icon ([icon: tanuki-ai]).
...
1. Select **Secure > Vulnerability report**.
1. Select the vulnerability's description.
1. In the **Linked issues** section, select the plus icon ([icon: plus]).
