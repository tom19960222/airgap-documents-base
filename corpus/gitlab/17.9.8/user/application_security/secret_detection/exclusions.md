...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/secret_detection/exclusions.md
...
1. Select **Configure Secret Detection** ([icon: settings]).
