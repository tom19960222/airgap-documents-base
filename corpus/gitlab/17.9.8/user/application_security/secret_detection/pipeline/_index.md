...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/secret_detection/pipeline/_index.md
...
|:-----------------------------------------------------------------------------------------------------|:-----------------------|:-----------------------|
| [Enable the analyzer](#enable-the-analyzer)                                                          | [icon: check-circle] Yes | [icon: check-circle] Yes |
| [Customize analyzer settings](#customize-analyzer-settings)                                          | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Download [output](#output)                                                                           | [icon: check-circle] Yes | [icon: check-circle] Yes |
| See new findings in the merge request widget                                                         | [icon: dotted-circle] No | [icon: check-circle] Yes |
| View identified secrets in the pipelines' **Security** tab                                           | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Manage vulnerabilities](../../vulnerability_report/_index.md)                                        | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Access the Security Dashboard](../../security_dashboard/_index.md)                                   | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Customize analyzer rulesets](#customize-analyzer-rulesets)                                          | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Enable security policies](../../policies/_index.md)                                                  | [icon: dotted-circle] No | [icon: check-circle] Yes |
