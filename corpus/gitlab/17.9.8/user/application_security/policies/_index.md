...
version: "17.9.8"
title: "Policies"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/policies/_index.md
...
|-------------------|---------------------------------------------------------------|---------------------------------------------------------------------|-------------------------------------------------------------------|
| Group             | [icon: check-circle] Yes                                        | [icon: dotted-circle] No                                              | [icon: dotted-circle] No                                            |
| Subgroup          | [icon: check-circle] Yes                                        | [icon: check-circle] Yes                                              | [icon: dotted-circle] No                                            |
| Project           | [icon: check-circle] Yes                                        | [icon: check-circle] Yes                                              | [icon: check-circle] Yes                                            |
