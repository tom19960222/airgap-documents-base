...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/sast/_index.md
...
|:-----------------------------------------------------------------------------------------|:-----------------------|:-----------------------|
| Basic scanning with [open-source analyzers](#supported-languages-and-frameworks)         | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Downloadable [SAST JSON report](#download-a-sast-report)                                 | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Cross-file, cross-function scanning with [GitLab Advanced SAST](gitlab_advanced_sast.md) | [icon: dotted-circle] No | [icon: check-circle] Yes |
| New findings in [merge request widget](#merge-request-widget)                            | [icon: dotted-circle] No | [icon: check-circle] Yes |
| New findings in [merge request changes view](#merge-request-changes-view)                | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Vulnerability Management](../vulnerabilities/_index.md)                                  | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [UI-based scanner configuration](#configure-sast-by-using-the-ui)                        | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Ruleset customization](customize_rulesets.md)                                           | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Advanced Vulnerability Tracking](#advanced-vulnerability-tracking)                      | [icon: dotted-circle] No | [icon: check-circle] Yes |
