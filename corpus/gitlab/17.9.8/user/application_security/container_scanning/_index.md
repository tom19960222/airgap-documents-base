...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/container_scanning/_index.md
...
| --- | ------ | ------ |
| Customize Settings ([Variables](#available-cicd-variables), [Overriding](#overriding-the-container-scanning-template), [offline environment support](#running-container-scanning-in-an-offline-environment), etc) | [icon: check-circle] Yes | [icon: check-circle] Yes |
| [View JSON Report](#reports-json-format) as a CI job artifact | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Generate a [CycloneDX SBOM JSON report](#cyclonedx-software-bill-of-materials) as a CI job artifact | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Ability to enable container scanning via an MR in the GitLab UI | [icon: check-circle] Yes | [icon: check-circle] Yes |
| [UBI Image Support](#fips-enabled-images) | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Support for Trivy | [icon: check-circle] Yes | [icon: check-circle] Yes |
...
| Presentation of Report data in Merge Request and Security tab of the CI pipeline job | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Solutions for vulnerabilities (auto-remediation)](#solutions-for-vulnerabilities-auto-remediation) | [icon: dotted-circle] No | [icon: check-circle] Yes |
| Support for the [vulnerability allow list](#vulnerability-allowlisting) | [icon: dotted-circle] No | [icon: check-circle] Yes |
| [Access to Dependency List page](../dependency_list/_index.md) | [icon: dotted-circle] No | [icon: check-circle] Yes |
...
| `CS_DISABLE_DEPENDENCY_LIST`   | `"false"`      | [icon: warning] **[Removed](https://gitlab.com/gitlab-org/gitlab/-/issues/439782)** in GitLab 17.0. |
