...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/dependency_list/_index.md
...
1. On the left sidebar, at the top, select **Search GitLab** ([icon: search]) to find your group or project.
1. Select **Secure > Dependency list**.
