...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/api_security_testing/troubleshooting.md
...
| -- | -- | -- | -- |
| [Stoplight Studio](https://stoplight.io/solutions) | [icon: check-circle] YAML, JSON | [icon: check-circle] YAML, JSON | [icon: check-circle] YAML, JSON |
| [Swagger Editor](https://editor.swagger.io/) | [icon: check-circle] YAML, JSON | [icon: check-circle] YAML, JSON | [icon: dotted-circle] YAML, JSON |
