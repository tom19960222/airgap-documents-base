...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/application_security/security_dashboard/_index.md
...
1. Filter and search for what you need.
   ...
   - To view a specific time frame, use the time range handles ([icon: scroll-handle]).
   - To view a specific area of the chart, select the left-most icon ([icon: marquee-selection]) and drag
     across the chart.
   - To reset to the original range, select **Remove Selection** ([icon: redo]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Secure > Security dashboard**.
1. Select **Save chart as an image** ([icon: download]).
...
1. Select **Remove project from dashboard** ([icon: remove]).
