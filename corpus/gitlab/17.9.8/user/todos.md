...
version: "17.9.8"
title: "To-Do List"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/todos.md
...
On the left sidebar, at the top, select **To-Do List** ([icon: task-done]).
...
1. In the upper-right corner, select **Add a to-do item** ([icon: todo-add]).
...
1. On the left sidebar, at the top, select **To-Do List** ([icon: task-done]).
1. At the top, select **Done**.
1. [Find the to-do item](#search-the-to-do-list) you want to re-add.
1. Next to this to-do item, select **Re-add this to-do item** [icon: redo].
...
- In the To-Do List, to the right of the to-do item, select **Mark as done** ([icon: check]).
- In the upper-right corner of the resource (for example, issue or merge request), select **Mark as done** ([icon: todo-done]).
...
1. In your To-Do List, next to the to-do item you want to snooze, select Snooze ([icon: clock]).
