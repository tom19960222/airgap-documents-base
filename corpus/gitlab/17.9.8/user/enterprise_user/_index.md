...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/enterprise_user/_index.md
...
1. On the left sidebar, select **Search or go to** and find your group.
1. Select **Settings > Domain Verification**.
1. On the domain table row, Select **Retry verification** ([icon: retry]).
...
1. Select **More actions** ([icon: ellipsis_v]) and select **Disable two-factor authentication**.
