...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/clusters/agent/work_with_agent.md
...
1. To delete the token you're no longer using, return to the token list and select **Revoke** ([icon: remove]).
...
1. Select **Operate > Kubernetes clusters**.
1. In the table, in the row for your agent, in the **Options** column, select the vertical ellipsis ([icon: ellipsis_v]).
