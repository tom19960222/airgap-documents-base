...
version: "17.9.8"
title: "Iterations"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/iterations/_index.md
...
1. On the left sidebar, select **Search or go to** and find your group.
1. Select **Plan > Iterations**.
1. To the right of the cadence you want to edit, select the vertical ellipsis ([icon: ellipsis_v]) and
...
1. To the right of the cadence for which you want to turn on or off automatic scheduling, select the
   vertical ellipsis ([icon: ellipsis_v]) and then select **Edit cadence**.
...
1. On the left sidebar, select **Search or go to** and find your group.
1. Select **Plan > Iterations**.
1. To the right of the cadence you want to delete, select the vertical ellipsis ([icon: ellipsis_v]) and then select **Delete cadence**.
...
1. To the right of the cadence in which you want create an iteration, select the vertical ellipsis
   ([icon: ellipsis_v]) and then select **Add iteration**.
...
1. In the upper-right corner, select the vertical ellipsis ([icon: ellipsis_v]) and then select **Edit**.
1. Edit the fields:
...
1. Select **Plan > Iterations** and select an iteration cadence.
1. Select the iteration you want edit. The iteration details page opens.
1. In the upper-right corner, select the vertical ellipsis ([icon: ellipsis_v]) and then select **Delete**.
1. Select **Delete**.
