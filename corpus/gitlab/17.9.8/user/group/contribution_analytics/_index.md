...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/contribution_analytics/_index.md
...
To do this, select the sliders ([icon: status-paused]) below the chart and slide them along the axis.
...
To sort the table by a column, select the column header or the chevron ([icon: chevron-lg-down]
for descending order, [icon: chevron-lg-up] for ascending order).
