...
version: "17.9.8"
title: "Epics"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/epics/_index.md
...
- On the **Child items** section header, select **More actions** ([icon: ellipsis_v]) **> View on a roadmap**.
