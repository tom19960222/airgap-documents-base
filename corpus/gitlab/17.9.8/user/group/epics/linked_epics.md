...
version: "17.9.8"
title: "Linked epics"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/epics/linked_epics.md
...
1. In the **Linked epics** section of an epic,
   select the add linked epic button ([icon: plus]).
...
- In the **Linked epics** section of an epic, next to each epic, select **Remove** ([icon: close]).
...
- In the **Linked items** section of an epic, next to each item, select **Remove** ([icon: close]).
