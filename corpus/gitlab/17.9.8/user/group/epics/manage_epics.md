...
version: "17.9.8"
title: "Manage epics"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/epics/manage_epics.md
...
1. Get to the New Epic form:
   ...
   - From an epic in your group, select **Epic actions** ([icon: ellipsis_v]). Then select **New epic**.
   - From anywhere, in the top menu, select **New** ([icon: plus-square]). Then select **New epic**.
...
1. Select **Epic actions** ([icon: ellipsis_v]), then **Delete epic**.
...
- In the upper-right corner, select **Epic actions** ([icon: ellipsis_v]), then **Close epic**.
...
- In the upper-right corner, select **Epic actions** ([icon: ellipsis_v]) and then **Reopen epic**.
...
1. Next to the issue you want to remove, select **Remove** ([icon: close]).
...
1. Select **Remove** ([icon: close]) in the parent epic's list of epics.
