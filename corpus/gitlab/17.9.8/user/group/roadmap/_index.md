...
version: "17.9.8"
title: "Roadmap"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/roadmap/_index.md
...
You can select the chevron ([icon: chevron-down]) next to the epic title to expand and collapse the
child epics.
...
date. You can also select the chevron ([icon: chevron-down]) next to the **Milestones**
