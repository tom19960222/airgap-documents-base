...
version: "17.9.8"
title: "Groups"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/_index.md
...
1. On the left sidebar, select **Search or go to** and find your Group.
1. On the Group overview page, in the upper-right corner, select **Actions** ([icon: ellipsis_v]).
...
1. On the left sidebar, select **Search or go to**.
1. Select **View all my groups**.
1. Select ([icon: ellipsis_v]) for the group you want to delete.
1. Select **Delete**.
1. In the **Delete group** section, select **Delete group**.
1. On the confirmation dialog, type the group name and select **Confirm**.
...
1. To the right of the **Filter members** box, select the magnifying glass ([icon: search]).
...
1. To switch the sort between ascending and descending, to the right of the **Account** list, select the
   arrow ([icon: sort-lowest] or [icon: sort-highest]).
...
1. On the left sidebar, select **Search or go to** and find your group.
1. Select **Manage > Members**.
1. Next to the member you want to remove, select the vertical ellipsis ([icon: ellipsis_v]).
