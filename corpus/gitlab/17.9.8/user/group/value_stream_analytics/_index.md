...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/value_stream_analytics/_index.md
...
1. To switch between the task type, select the **Settings** ([icon: settings]) dropdown list
   and select **Issues** or **Merge Requests**.
1. To add or remove labels, select the **Settings** ([icon: settings]) dropdown list
...
1. Customize the default stages:
   ...
   - To hide a stage, select **Hide** ([icon: eye-slash]).
