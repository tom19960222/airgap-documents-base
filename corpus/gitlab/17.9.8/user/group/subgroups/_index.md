...
version: "17.9.8"
title: "Subgroups"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/subgroups/_index.md
...
1. Select the subgroup you want to view.
   To view nested subgroups, expand ([icon: chevron-down]) a subgroup.

### Private subgroups in public parent groups

In the hierarchy list, public groups with private subgroups have an expand option ([icon: chevron-down]),
which indicates the group has nested subgroups. All users can view the expand option ([icon: chevron-down]), but only direct or inherited members of the private subgroup can view the private group.
