...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/group/access_and_permissions.md
...
1. In the row for the user you are editing, select the pencil ([icon: pencil]) icon.
