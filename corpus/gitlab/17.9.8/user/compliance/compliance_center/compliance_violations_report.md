...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/compliance/compliance_center/compliance_violations_report.md
...
| Icon                    | Severity level |
|:------------------------|:---------------|
| [icon: severity-critical] | Critical       |
| [icon: severity-high]     | High           |
| [icon: severity-medium]   | Medium         |
| [icon: severity-low]      | Low            |
| [icon: severity-info]     | Info           |
