...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/gitlab_com/_index.md
...
| Support for custom domains                        | [icon: check-circle] Yes |
| Support for TLS certificates                      | [icon: check-circle] Yes |
