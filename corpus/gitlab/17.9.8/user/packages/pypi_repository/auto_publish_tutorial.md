...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/packages/pypi_repository/auto_publish_tutorial.md
...
1. Select **Create new** ([icon: plus]) and **New file**.
