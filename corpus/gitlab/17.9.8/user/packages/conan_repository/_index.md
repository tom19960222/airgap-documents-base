...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/packages/conan_repository/_index.md
...
- From the GitLab user interface:
  ...
  package by selecting **Remove repository** ([icon: remove]).
