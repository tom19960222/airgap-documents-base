...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/packages/package_registry/dependency_proxy/_index.md
...
| [GitLab](../../maven_repository/_index.md)                                                                                                | [icon: check-circle] Yes      |

| [Maven Central](https://mvnrepository.com/repos/central)                                                                                 | [icon: check-circle] Yes      |

| [Artifactory](https://jfrog.com/integration/maven-repository/)                                                                           | [icon: check-circle] Yes      |

| [Sonatype Nexus](https://help.sonatype.com/en/maven-repositories.html)                                                                   | [icon: check-circle] Yes      |

| [GitHub Packages](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-apache-maven-registry)    | [icon: dotted-circle] No      |
...
|--------------------|-------------------------------------------------------|-------------------------|--------------------------|----------|
| Public             | Anonymous                                             | [icon: dotted-circle] No  | [icon: dotted-circle] No   | Request rejected. |
| Public             | Guest                                                 | [icon: check-circle] Yes  | [icon: dotted-circle] No   | Package file returned from either the cache or the remote registry. |
| Public             | Developer                                             | [icon: check-circle] Yes  | [icon: check-circle] Yes   | Package file returned from either the cache or the remote registry. The file is published to the cache. |
| Internal           | Anonymous                                             | [icon: dotted-circle] No  | [icon: dotted-circle] No   | Request rejected |
| Internal           | Guest                                                 | [icon: check-circle] Yes  | [icon: dotted-circle] No   | Package file returned from either the cache or the remote registry. |
| Internal           | Developer                                             | [icon: check-circle] Yes  | [icon: check-circle] Yes   | Package file returned from either the cache or the remote registry. The file is published to the cache. |
| Private            | Anonymous                                             | [icon: dotted-circle] No  | [icon: dotted-circle] No   | Request rejected |
| Private            | Reporter                                              | [icon: check-circle] Yes  | [icon: dotted-circle] No   | Package file returned from either the cache or the remote registry. |
| Private           | Developer                                             | [icon: check-circle] Yes  | [icon: check-circle] Yes   | Package file returned from either the cache or the remote registry. The file is published to the cache. |
