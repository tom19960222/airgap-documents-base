...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/packages/container_registry/delete_container_registry_images.md
...
1. From the **Container Registry** page, you can select what you want to delete,
   ...
   - Deleting the entire repository, and all the tags it contains, by selecting
     the red [icon: remove] **Trash** icon.
   - Navigating to the repository, and deleting tags individually or in bulk
     by selecting the red [icon: remove] **Trash** icon next to the tag you want
     to delete.
