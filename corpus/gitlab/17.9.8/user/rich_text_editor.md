...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/rich_text_editor.md
...
1. Select **Insert table** [icon: table].
...
To open the menu: In the upper-right corner of a cell, select the chevron [icon: chevron-down].
...
1. In the upper-right corner of a cell, select the chevron [icon: chevron-down] **> Merge N cells**.

To split merged cells: In the upper-right corner of a cell, select the chevron [icon: chevron-down] **> Split cell**.
...
1. On the top bar of a text box, select [icon: plus] **More options** and then **Mermaid diagram** or **PlantUML diagram**.
