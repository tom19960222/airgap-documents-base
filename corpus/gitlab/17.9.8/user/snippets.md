...
version: "17.9.8"
title: "Snippets"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/snippets.md
...
1. Select the kind of snippet you want to create:
   - **To create a personal snippet**, do one of the following:
     - On the [Snippets dashboard](https://gitlab.com/dashboard/snippets), select
       **New snippet**.
     - From a project: On the left sidebar, select **Create new** ([icon: plus]). Below **In GitLab**, select **New snippet**.
     - From any other page: On the left sidebar, select **Create new** ([icon: plus]) and then **New snippet**.
   ...
   - **To create a project snippet**: Go to your project's page. Select
     **Create new** ([icon: plus]). Below **In this project**, select **New snippet**.
