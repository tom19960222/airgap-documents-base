...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/gitlab_duo_chat/_index.md
...
1. On the left sidebar, select **GitLab Duo Chat** ([icon: duo-chat]).
1. In the message box, enter your question and press **Enter** or select **Send**.
...
- For Duo Chat on the left sidebar, select **GitLab Duo Chat** ([icon: duo-chat]).
- For the quick chat window that's embedded in your file, in the upper-right corner,
  select **Collapse** ([icon: chevron-lg-up]).
...
- In the currently open file in your IDE, by selecting some code,
  then, in the floating toolbar, selecting **GitLab Duo Quick Chat** ([icon: tanuki-ai]).
