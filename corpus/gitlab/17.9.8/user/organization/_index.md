...
version: "17.9.8"
title: "Organization"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/organization/_index.md
...
1. On the left sidebar, at the top, select **Create new** ([icon: plus]) and **New organization**.
...
1. Optional. To sort the results by name, date created, or date updated, from the dropdown list select an option. Then select ascending ([icon: sort-lowest]) or descending ([icon: sort-highest]) order.
