...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/glql/_index.md
...
| `>`           | Greater than                            | [icon: dotted-circle] No |
| `<`           | Less than                               | [icon: dotted-circle] No |
