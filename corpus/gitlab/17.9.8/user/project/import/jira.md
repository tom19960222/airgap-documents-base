...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/import/jira.md
...
1. On the [icon: issues] **Issues** page, select **Actions** ([icon: ellipsis_v]) **> Import from Jira**.
