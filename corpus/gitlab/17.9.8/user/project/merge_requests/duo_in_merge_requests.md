...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/duo_in_merge_requests.md
...
1. On the toolbar above the text area, select **Summarize code changes** ([icon: tanuki-ai]).
