...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/cherry_pick_changes.md
...
to the related merge request thread. The format is [icon: cherry-pick-commit]
