...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/approvals/_index.md
...
To check if your approval satisfies Code Owner requirements, select **Expand eligible approvers** ([icon: chevron-lg-down]).
...
| Example | Description |
| :-----: | :---------- |
| ![Approvals not yet satisfied](img/approvals_unsatisfied_v17_1.png) | Required approvals are missing. ([icon: approval]) |
| ![Approvals are satisfied](img/approvals_satisfied_v17_1.png) | Approvals are satisfied. ([icon: check]) |
| ![Approvals are satisfied, and you approved](img/you_approvals_satisfied_v17_1.png) | Approvals are satisfied, and you are one of the approvers. ([icon: approval-solid]) |
...
- [icon: dash-circle] Awaiting review
- [icon: status_running] Review in progress
- [icon: check-circle] Approved
- [icon: comment-lines] Reviewer commented
- [icon: status_warning] Reviewer requested changes

   ![This reviewer has requested changes, and blocked this merge request.](img/reviewer_blocks_mr_v17_3.png)

To [re-request a review](../reviews/_index.md#re-request-a-review), select the **Re-request a review** icon ([icon: redo]) next to the user.
...
Approved merge requests display a green check mark ([icon: check-circle-filled]) next to the user's name in the reviewer list.
