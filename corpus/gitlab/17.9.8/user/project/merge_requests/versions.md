...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/versions.md
...
1. Next to **Compare** ([icon: file-tree]), select the pushes to compare. This example
