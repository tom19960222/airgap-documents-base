...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/reviews/suggestions.md
...
1. Find the lines of code you want to change.
   - To select a single line, hover over the line number and
     select **Add a comment to this line** ([icon: comment]).
   - To select more lines:
     1. Hover over the line number, and select **Add a comment to this line** ([icon: comment]):
...
1. In the comment toolbar, select **Insert suggestion** ([icon: doc-code]). GitLab
