...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/merge_requests/csv_export.md
...
1. Select **Actions** ([icon: ellipsis_v]) **> Export as CSV**.
