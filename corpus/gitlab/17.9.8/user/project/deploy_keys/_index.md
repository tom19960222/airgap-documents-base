...
version: "17.9.8"
title: "Deploy keys"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/deploy_keys/_index.md
...
1. To grant read-write permission to the public deploy key:
   1. In the key's row, select **Edit** ([icon: pencil]).
