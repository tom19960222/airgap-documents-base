...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/ml/model_registry/_index.md
...
1. In the most right column, select the vertical ellipsis ([icon: ellipsis_v]) and **Delete model**.
...
1. Select the vertical ellipsis ([icon: ellipsis_v]) and **Delete model**.
...
1. In the most right column, select the vertical ellipsis ([icon: ellipsis_v]) and **Delete model version**.
...
1. Select the vertical ellipsis ([icon: ellipsis_v]) and **Delete model version**.
1. Confirm the deletion.
