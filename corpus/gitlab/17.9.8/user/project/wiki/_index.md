...
version: "17.9.8"
title: "Wiki"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/wiki/_index.md
...
1. On the left sidebar, select **Search or go to** and find your project or group.
1. Select **Plan > Wiki**.
1. Select **Wiki actions** ([icon: ellipsis_v]), then **New page** on this page, or any other wiki page.
...
1. On the left sidebar, select **Search or go to** and find your project or group.
1. Select **Plan > Wiki**.
1. Select **Wiki actions** ([icon: ellipsis_v]), then **Clone repository**.
...
1. Select **Wiki actions** ([icon: ellipsis_v]), then **Delete page**.
...
1. On the top right, select **Wiki actions** ([icon: ellipsis_v]), then select **Print as PDF**.
...
1. On the left sidebar, select **Search or go to** and find your project or group.
1. Select **Plan > Wiki**.
1. Select **Wiki actions** ([icon: ellipsis_v]), then **Templates**.
...
1. Select **Wiki actions** ([icon: ellipsis_v]), then **Page history**.
...
1. Select **Wiki actions** ([icon: ellipsis_v]), then **Page history** to see all page versions.
...
1. On the left sidebar, select **Search or go to** and find your project or group.
1. Select **Plan > Wiki**.
1. In the upper-right corner of the page, select **Add custom sidebar** ([icon: settings]).
