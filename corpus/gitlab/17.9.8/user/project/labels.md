...
version: "17.9.8"
title: "Labels"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/labels.md
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Manage > Labels**.
1. Next to the label you want to edit, select the vertical ellipsis ([icon: ellipsis_v]), and then select **Edit**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Manage > Labels**.
1. Next to the **Subscribe** button, select ([icon: ellipsis_v]), and then select **Delete**.
...
1. Either:
   ...
   - Next to the **Subscribe** button, select ([icon: ellipsis_v]).
   - Next to the label you want to edit, select **Edit** ([icon: pencil]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Manage > Labels**.
1. Next to the **Subscribe** button, select the three dots ([icon: ellipsis_v]) and
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Manage > Labels**.
1. Next to a label you want to prioritize, select the star ([icon: star-o]).
