...
version: "17.9.8"
title: "Web IDE"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/web_ide/_index.md
...
The left **Explorer** sidebar adds a merge request icon ([icon: merge-request]) next to new or modified files.
...
1. Go to the directory where you want to upload the file.
   ...
   - On the left **Explorer** sidebar, in the upper right,
     select **New Folder** ([icon: folder-new]).
...
1. On the bottom status bar, on the right, select the bell icon ([icon: notifications]) for a list of notifications.
