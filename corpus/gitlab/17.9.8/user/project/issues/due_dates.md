...
version: "17.9.8"
title: "Due dates"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/issues/due_dates.md
...
Issue dates in the past are shown with a red icon ([icon: calendar-overdue]).
...
1. Optional. To reverse the sort order, select **Sort direction** ([icon: sort-lowest]).
...
1. On the right, from the **Actions** ([icon: ellipsis_v]) dropdown list, select **Subscribe to calendar** to display the `.ics` file.
