...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/issues/confidential_issues.md
...
1. On the left sidebar, at the top, select **Create new** ([icon: plus]).
...
1. In the upper-right corner, select **Issue actions** ([icon: ellipsis_v]) and then **Turn on confidentiality** (or **Turn off confidentiality** to make the issue non-confidential).
...
In the **Issues** and **Issue boards** pages, you can see the confidential ([icon: eye-slash]) icon
...
Likewise, while inside the issue, you can see the confidential ([icon: eye-slash]) icon right next to
