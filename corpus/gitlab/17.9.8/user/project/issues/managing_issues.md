...
version: "17.9.8"
title: "Manage issues"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/issues/managing_issues.md
...
1. To the right of the title, select **Edit title and description** ([icon: pencil]).
...
1. Above the **Description** field, select **GitLab Duo** ([icon: tanuki-ai]) **> Generate issue description**.
...
1. Hover over a task list item and select the options menu ([icon: ellipsis_v]).
1. Select **Delete**.
...
1. Hover over the list item row to make the grip icon ([icon: grip]) visible.
...
- From any other page in the GitLab UI:
  1. On the left sidebar, select **Search or go to** and find your project.
  1. Select **Plan > Issues**, then select your issue to view it.
  1. In the upper-right corner, select **Issue actions** ([icon: ellipsis_v]) and then **Close issue**.
...
To reopen a closed issue, in the upper-right corner, select **Issue actions** ([icon: ellipsis_v]) and then **Reopen issue**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Plan > Issues**, then select your issue to view it.
1. In the upper-right corner, select **Issue actions** ([icon: ellipsis_v]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Plan > Issues**, then select the title of your issue to view it.
1. Select **Edit title and description** ([icon: pencil]).
1. Select **Delete issue**.
...
- On the left sidebar, at the top, select **Assigned issues** ([icon: issues]).
...
1. Press <kbd>Enter</kbd> or select the search icon ([icon: search]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Plan > Issues**, then select your issue to view it.
1. On the right sidebar, next to **Reference**, select **Copy Reference** ([icon: copy-to-clipboard]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Plan > Issues**, then select your issue to view it.
1. On the right sidebar, next to **Issue email**, select **Copy Reference** ([icon: copy-to-clipboard]).
