...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/issues/csv_export.md
...
1. In the upper right, select **Actions** ([icon: ellipsis_v]) **> Export as CSV**.
