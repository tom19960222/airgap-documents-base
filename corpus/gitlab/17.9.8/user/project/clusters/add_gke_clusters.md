...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/clusters/add_gke_clusters.md
...
1. Go to your:
   - Project's [icon: cloud-gear] **Operate > Kubernetes clusters** page, for a project-level
     cluster.
