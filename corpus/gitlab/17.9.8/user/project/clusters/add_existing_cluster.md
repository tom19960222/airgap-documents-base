...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/clusters/add_existing_cluster.md
...
1. Go to your:
   1. Project's [icon: cloud-gear] **Operate > Kubernetes clusters** page, for a project-level cluster.
   1. Group's [icon: cloud-gear] **Kubernetes** page, for a group-level cluster.
