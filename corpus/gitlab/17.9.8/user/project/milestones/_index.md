...
version: "17.9.8"
title: "Milestones"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/milestones/_index.md
...
1. In the upper-right corner, select **Milestone actions** ([icon: ellipsis_v]) and then select **Edit**.
...
1. Select **Plan > Milestones**.
1. Either:
   - Next to the milestone you want to close, select **Milestone actions** ([icon: ellipsis_v]) > **Close**.
...
1. Select **Plan > Milestones**.
1. Either:
   - Next to the milestone you want to delete, select **Milestone actions** ([icon: ellipsis_v]) > **Delete**.
   - Select the milestone title, and then select **Milestone actions** ([icon: ellipsis_v]) > **Delete**.
...
1. Select **Plan > Milestones**.
1. Either:
   - Next to the milestone you want to promote, select **Milestone actions** ([icon: ellipsis_v]) > **Promote**.
   - Select the milestone title, and then select **Milestone actions** ([icon: ellipsis_v]) > **Promote**.
