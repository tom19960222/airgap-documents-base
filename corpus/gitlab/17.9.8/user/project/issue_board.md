...
version: "17.9.8"
title: "Issue boards"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/issue_board.md
...
| -------- | ------------------------------ | --------------------------------------------------- | ------------------------------------------------------- | --------------------------------- |
| Free     | Multiple                       | 1                                                   | [icon: dotted-circle] No                                  | [icon: dotted-circle] No            |
| Premium  | Multiple                       | Multiple                                            | [icon: check-circle] Yes                                  | [icon: check-circle] Yes            |
| Ultimate | Multiple                       | Multiple                                            | [icon: check-circle] Yes                                  | [icon: check-circle] Yes            |
...
1. In the upper-right corner of the issue board page, select **Configure board** ([icon: settings]).
...
To enable or disable focus mode, in the upper-right corner, select **Toggle focus mode** ([icon: maximize]).
...
You can define the scope of your board when creating it or by selecting the **Configure board** ([icon: settings]) button.
...
selecting **Board configuration** ([icon: settings]).
...
1. Select **View options** ([icon: preferences]).
...
1. On the top of the list you want to edit, select **Edit list settings** ([icon: settings]).
...
When you hover over the blocked icon ([icon: entity-blocked]), a detailed information popover is displayed.
...
1. On the top of the list you want to remove, select **Edit list settings** ([icon: settings]).
   The list settings sidebar opens on the right.
...
1. Select **Card options** ([icon: ellipsis_v]), then **Move to start of list**.
...
1. In an issue board, hover over the card of the issue you want to move.
1. Select **Card options** ([icon: ellipsis_v]), then **Move to end of list**.
