...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/project_topics.md
...
- From the **Explore topics** page:
  ...
  1. On the left sidebar, expand the top-most chevron ([icon: chevron-down]).
  1. Select **Explore**.
  1. Select **Topics**.
  1. Select the topic you want to subscribe to.
  1. In the upper-right corner, select **Subscribe to the new projects feed** ([icon: rss]).
