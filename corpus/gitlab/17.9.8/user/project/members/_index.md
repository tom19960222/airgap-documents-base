...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/members/_index.md
...
1. In the top right, select the vertical ellipsis ([icon: ellipsis_v]) and select **Request Access**.
...
| --- | ------------------- | ---------------------- | -------------------------- | ----------------------------- |
| Generate boards | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View issues of parent groups <sup>1</sup> | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View labels of parent groups | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View milestones of parent groups | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| Be shared into other groups | [icon: check-circle] Yes | [icon: dotted-circle] No | [icon: dotted-circle] No |  [icon: dotted-circle] No |
| Be imported into other projects | [icon: check-circle] Yes | [icon: dotted-circle] No | [icon: dotted-circle] No | [icon: dotted-circle] No |
| Share the project with other members | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
...
| --- | ------------------- | ---------------------- | -------------------------- | ----------------------------- |
| Generate boards | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View issues of parent groups | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View labels of parent groups | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
| View milestones of parent groups | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes | [icon: check-circle] Yes |
