...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/members/sharing_projects_groups.md
...
|---------------------------------------------------------------------|--------------------------|
| Direct member of the group that is shared                           | [icon: check-circle] Yes   |
| Inherited member of the group that is shared                        | [icon: check-circle] Yes   |
| Direct member of a subgroup, but not of the group that is shared    | [icon: dotted-circle] No   |
| Inherited member of a subgroup, but not of the group that is shared | [icon: dotted-circle] No   |
...
1. To the right of the group you want to remove, select **Remove group** ([icon: remove]).
