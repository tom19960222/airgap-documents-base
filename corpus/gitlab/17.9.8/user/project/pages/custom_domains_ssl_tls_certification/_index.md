...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/pages/custom_domains_ssl_tls_certification/_index.md
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Deploy > Pages**.
1. Next to the domain name, select **Edit** ([icon: pencil]).
1. In **Verification status**, select **Retry verification** ([icon: retry]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Deploy > Pages**.
1. Next to the domain name, select **Remove domain** ([icon: remove])
