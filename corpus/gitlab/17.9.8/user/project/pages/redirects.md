...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/pages/redirects.md
...
|---------------------------------------------------|------------------------|---------|
| [Redirects (`301`, `302`)](#redirects)            | [icon: check-circle] Yes | `/wardrobe.html /narnia.html 302` |
| [Rewrites (`200`)](#rewrites)                     | [icon: check-circle] Yes | `/* / 200` |
| [Splats](#splats)                                 | [icon: check-circle] Yes | `/news/*  /blog/:splat` |
| [Placeholders](#placeholders)                     | [icon: check-circle] Yes | `/news/:year/:month/:date /blog-:year-:month-:date.html` |
| Rewrites (other than `200`)                       | [icon: dotted-circle] No | `/en/* /en/404.html 404` |
| Query parameters                                  | [icon: dotted-circle] No | `/store id=:id  /blog/:id  301` |
| Force ([shadowing](https://docs.netlify.com/routing/redirects/rewrites-proxies/#shadowing)) | [icon: dotted-circle] No | `/app/  /app/index.html  200!` |
| [Domain-level redirects](#domain-level-redirects) | [icon: check-circle] Yes | `http://blog.example.com/* https://www.example.com/blog/:splat 301` |
| Redirect by country or language                   | [icon: dotted-circle] No | `/  /anz     302  Country=au,nz` |
| Redirect by role                                  | [icon: dotted-circle] No | `/admin/*  200!  Role=admin` |
