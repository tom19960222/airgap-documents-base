...
version: "17.9.8"
title: "Time tracking"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/time_tracking.md
...
1. In the **Time tracking** section of the sidebar, select **Add time entry** ([icon: plus]). A dialog opens.
1. Enter:
...
- In the time tracking report, on the right of a timelog entry, select **Delete time spent** ([icon: remove]).
