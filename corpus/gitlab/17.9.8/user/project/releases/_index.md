...
version: "17.9.8"
title: "Releases"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/releases/_index.md
...
1. For all projects:
   ...
   1. On the right sidebar, select **Releases** ([icon: rocket-launch]).
1. In the upper-right corner, select the feed symbol ([icon: rss]).
...
1. After the deploy freeze is saved, you can edit it by selecting the edit button ([icon: pencil]) and remove it by selecting the delete button ([icon: remove]).
