...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/code_suggestions/set_up.md
...
| Icon | Status | Meaning |
| :--- | :----- | :------ |
| [icon: tanuki-ai] | **Ready** | You've configured and enabled GitLab Duo, and you're using a language that supports Code Suggestions. |
| [icon: tanuki-ai-off] | **Not configured** | You haven't entered a personal access token, or you're using a language that Code Suggestions doesn't support. |
...
1. Select **Manage** ([icon: settings]) **> Settings**.
