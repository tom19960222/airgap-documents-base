...
version: "17.9.8"
title: "Forks"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/forking_workflow.md
...
1. On the project's homepage, in the upper-right corner, select **Fork** ([icon: fork]).
...
1. Below the dropdown list for branch name, find the **Forked from** ([icon: fork])
