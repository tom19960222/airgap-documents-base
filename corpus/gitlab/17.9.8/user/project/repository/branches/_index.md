...
version: "17.9.8"
title: "Branches"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/branches/_index.md
...
- See merge request links that point to the default branch.
  ...
  Branches with merge requests that do not point to the default branch display the [icon: merge-request] **New** merge request button.
...
1. Below the issue description, find the **Create merge request** dropdown list, and select
   [icon: chevron-down] to display the dropdown list.
...
1. Optional. To reverse the **Source** and **Target**, select **Swap revisions** ([icon: substitute]).
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Code > Branches**.
1. In the upper right corner of the page, select **More** [icon: ellipsis_v].
