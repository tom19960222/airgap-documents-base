...
version: "17.9.8"
title: "Web Editor"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/web_editor.md
...
1. Next to the directory name, select the plus icon ([icon: plus]) > **New file**.
...
1. Next to the directory name, select the plus icon ([icon: plus]) > **Upload file**.
...
1. Next to the directory name, select the plus icon ([icon: plus]) > **New directory**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Next to the repository name, select the plus icon ([icon: plus]) > **New branch**.
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Next to the repository name, select the plus icon ([icon: plus]) > **New tag**.
1. Complete the fields.
1. Select **Create tag**.
