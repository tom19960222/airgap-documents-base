...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/files/git_history.md
...
- The commit SHA. GitLab shows the first 8 characters. Select **Copy commit SHA** ([icon: copy-to-clipboard]) to copy the entire SHA.
- A link to **browse** ([icon: folder-open]) the file as it appeared at the time of this commit.
