...
version: "17.9.8"
title: "Tags"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/tags/_index.md
...
- The tag name. ([icon: tag])
- Optional. If the tag is [protected](../../protected_tags.md), a **protected** badge.
- The commit SHA ([icon: commit]), linked to the commit's contents.
- The commit's title and creation date.
- Optional. A link to the release ([icon: rocket]).
...
- A [**Create release**](../../releases/_index.md#create-a-release) ([icon: pencil]) link.
...
1. Commits with a tag are labeled with a tag icon ([icon: tag]) and the name of the tag.
