...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/mirror/_index.md
...
1. Select **Update now** ([icon: retry]).
...
1. Identify the correct repository, and select **Copy SSH public key** ([icon: copy-to-clipboard]).
