...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/repository/mirror/push.md
...
The repository pushes shortly thereafter. To force a push, select **Update now** ([icon: retry]).
