...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/integrations/mattermost_slash_commands.md
...
1. Next to your username, select the [icon: ellipsis_v] **Settings** icon, and
...
1. Select the [icon: ellipsis_v] **Settings** icon, and select **Integrations**.
