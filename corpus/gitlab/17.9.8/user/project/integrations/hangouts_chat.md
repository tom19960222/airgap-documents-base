...
version: "17.9.8"
title: "Google Chat"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/project/integrations/hangouts_chat.md
...
1. In the upper left, next to the space name, select the down arrow ([icon: chevron-down]) > **Apps & integrations**.
...
1. Select **Save**.
1. Next to the webhook URL, select the vertical ellipsis ([icon: ellipsis_v]) > **Copy link**.
