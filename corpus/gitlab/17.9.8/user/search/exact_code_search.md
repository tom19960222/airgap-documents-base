...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/search/exact_code_search.md
...
select **Use regular expression** ([icon: regular-expression]).
