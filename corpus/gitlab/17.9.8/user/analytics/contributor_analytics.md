...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/analytics/contributor_analytics.md
...
1. Optional. To display commits only for a specific time period, select the pause icons ([icon: status-paused]) and slide them along the horizontal axis:
