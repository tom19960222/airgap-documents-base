...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/analytics/analytics_dashboards.md
...
1. On the left sidebar, select **Search or go to** and find your project,
   or select **Create new** ([icon: plus]) and **New project/repository**
