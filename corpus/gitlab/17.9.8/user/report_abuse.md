...
version: "17.9.8"
title: "Report abuse"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/report_abuse.md
...
1. In the upper-right corner of the user's profile select the vertical ellipsis ([icon: ellipsis_v]), then **Report abuse**.
...
1. In the comment, in the upper-right corner, select **More actions** ([icon: ellipsis_v]).
...
1. On the issue, in the upper-right corner, select **Issue actions** ([icon: ellipsis_v]).
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the task, in the upper-right corner, select  **More actions** ([icon: ellipsis_v]).
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the objective, in the upper-right corner, select  **More actions** ([icon: ellipsis_v]).
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the key result, in the upper-right corner, select  **More actions** ([icon: ellipsis_v]).
1. Select **Report abuse**.
1. Select a reason for reporting the user.
1. Complete an abuse report.
1. Select **Send report**.
...
1. On the merge request, in the upper-right corner, select **Merge request actions** ([icon: ellipsis_v]).
1. Select **Report abuse**.
