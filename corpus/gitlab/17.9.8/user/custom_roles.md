...
version: "17.9.8"
title: "Custom roles"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/user/custom_roles.md
...
1. On the left sidebar, select **Search or go to** and find your group.
1. Select **Settings > Roles and permissions**.
1. Select the vertical ellipsis ([icon: ellipsis_v]) for the custom role, then
   select **Edit role**.
...
1. In the **Actions** column, select **Delete role** ([icon: remove]) and confirm.
