...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/backup_restore/backup_gitlab.md
...
**Tab: Linux package (Omnibus) / Docker / Self-compiled**
