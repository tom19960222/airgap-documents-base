...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/monitoring/performance/performance_bar.md
...
Requests that exceed predefined limits display a warning [icon: warning] icon and
