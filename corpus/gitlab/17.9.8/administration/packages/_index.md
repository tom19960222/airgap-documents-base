...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/packages/_index.md
...
**Tab: Linux package (Omnibus) 14.1 and earlier**

   ```shell
   sudo gitlab-rails dbconsole
   ```

**Tab: Linux package (Omnibus) 14.2 and later**
