...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/geo/setup/database.md
...
**Tab: Primary with Patroni cluster**
...
**Tab: Primary with single PostgreSQL instance**
