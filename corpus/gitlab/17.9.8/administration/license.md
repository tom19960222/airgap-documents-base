...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/license.md
...
**Help** ([icon: question-o]) > **Help**. The GitLab edition and version are listed
