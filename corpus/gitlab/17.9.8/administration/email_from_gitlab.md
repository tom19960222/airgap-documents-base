...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/email_from_gitlab.md
...
1. In the upper-right corner, select **Send email to users** ([icon: mail]).
