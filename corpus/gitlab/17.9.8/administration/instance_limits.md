...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/instance_limits.md
...
1. On the left sidebar, select **Help** ([icon: question-o]) > **Help**.
...
or when forcing an update by selecting **Update now** ([icon: retry]) in **Settings > Repository > Mirroring repositories**.
