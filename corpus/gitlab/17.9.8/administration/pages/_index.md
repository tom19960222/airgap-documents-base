...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/pages/_index.md
...
1. Have a domain for Pages that is not a subdomain of your GitLab instance domain.
   ...
   | -------------------- | ------------------- | ------------- |
   | `example.com`        | `example.io`        | [icon: check-circle] Yes |
   | `example.com`        | `pages.example.com` | [icon: dotted-circle] No |
   | `gitlab.example.com` | `pages.example.com` | [icon: check-circle] Yes |
