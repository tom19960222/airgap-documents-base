...
version: "17.9.8"
title: "Log system"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/logs/_index.md
...
|:------------------------------------------------|:------------------------|:------------------------|
| [Alertmanager logs](#alertmanager-logs)         | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [crond logs](#crond-logs)                       | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Gitaly](#gitaly-logs)                          | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
| [GitLab Exporter for Linux package installations](#gitlab-exporter) | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [GitLab Pages logs](#pages-logs)                | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
| GitLab Rails                                    | [icon: check-circle] Yes  | [icon: dotted-circle] No  |
| [GitLab Shell logs](#gitlab-shelllog)           | [icon: check-circle] Yes  | [icon: dotted-circle] No  |
| [Grafana logs](#grafana-logs)                   | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [LogRotate logs](#logrotate-logs)               | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Mailroom](#mail_room_jsonlog-default)          | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
| [NGINX](#nginx-logs)                            | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
| [PgBouncer logs](#pgbouncer-logs)               | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [PostgreSQL logs](#postgresql-logs)             | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Praefect logs](#praefect-logs)                 | [icon: dotted-circle] Yes | [icon: check-circle] Yes  |
| [Prometheus logs](#prometheus-logs)             | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Puma](#puma-logs)                              | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
| [Redis logs](#redis-logs)                       | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Registry logs](#registry-logs)                 | [icon: dotted-circle] No  | [icon: check-circle] Yes  |
| [Workhorse logs](#workhorse-logs)               | [icon: check-circle] Yes  | [icon: check-circle] Yes  |
