...
version: "17.9.8"
title: "What's new"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/whats-new.md
...
1. On the left sidebar, at the bottom, select **Help** ([icon: question]).
...
1. Expand **What's new**, and choose one of the following options:
   ...
   | Disable What's new | Disables this feature, so it no longer displays under the [icon: question] icon. |
