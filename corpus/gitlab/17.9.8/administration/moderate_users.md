...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/moderate_users.md
...
1. Select **Overview > Users**.
1. In the search box, filter by **State=Pending approval** and press <kbd>Enter</kbd>.
1. For the user sign up you want to approve or reject, select the vertical ellipsis ([icon: ellipsis_v]), then **Approve** or **Reject**.
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Overview > Users**.
1. For the user you want to block, select the vertical ellipsis ([icon: ellipsis_v]), then **Block**.
...
1. For the user you want to unblock, select the vertical ellipsis ([icon: ellipsis_v]), then **Unblock**.
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Overview > Users**.
1. For the user you want to deactivate, select the vertical ellipsis ([icon: ellipsis_v]) and then **Deactivate**.
...
1. For the user you want to reactivate, select the vertical ellipsis ([icon: ellipsis_v]), then **Activate**.
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Overview > Users**.
1. Next to the member you want to ban, select the vertical ellipsis ([icon: ellipsis_v]).
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Overview > Users**.
1. For the user you want to delete, select the vertical ellipsis ([icon: ellipsis_v]), then **Delete user**.
1. Type the username.
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **Overview > Users**.
1. For the user you want to delete, select the vertical ellipsis ([icon: ellipsis_v]), then **Delete user and contributions**.
1. Type the username.
