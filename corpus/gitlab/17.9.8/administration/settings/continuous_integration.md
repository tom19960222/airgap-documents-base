...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/administration/settings/continuous_integration.md
...
1. In the upper-right corner, select **Edit** ([icon: pencil]).
...
display a lock icon ([icon: lock]) and **This job is archived** at the top of the job log.
