...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/subscriptions/subscription-add-ons.md
...
1. On the subscription card, select the vertical ellipsis ([icon: ellipsis_v]).
...
1. Select **GitLab Duo**.
   - If the **GitLab Duo** menu item is not available, synchronize your subscription
     ...
     1. In **Subscription details**, to the right of **Last sync**, select
        synchronize subscription ([icon: retry]).
1. By **Seat utilization**, select **Assign seats**.
1. To the right of the user, turn on the toggle to assign a GitLab Duo seat.
