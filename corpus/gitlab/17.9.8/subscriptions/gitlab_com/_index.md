...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/subscriptions/gitlab_com/_index.md
...
1. Do one of the following:
   ...
   - If the subscription is already linked to a group, select **Subscription actions** ([icon: ellipsis_v]) > **Change linked group**.
