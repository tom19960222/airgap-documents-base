...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/components/_index.md
...
- GitLab-maintained ([icon: tanuki-verified]): Components that are created and maintained by GitLab.
- GitLab Partner ([icon: partner-verified]): Components that are independently created
