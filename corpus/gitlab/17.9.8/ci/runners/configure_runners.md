...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/runners/configure_runners.md
...
1. To the right of the runner, you want to edit, select **Edit** ([icon: pencil]).
...
1. Select **Settings > CI/CD**.
1. Expand **Runners**.
1. To the right of **New project runner**, select the vertical ellipsis ([icon: ellipsis_v]).
...
1. On the left sidebar, at the bottom, select **Admin**.
1. Select **CI/CD > Runners**.
1. To the right of the runner you want to protect, select **Edit** ([icon: pencil]).
