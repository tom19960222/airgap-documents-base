...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/runners/runners_scope.md
...
1. In the runner list, to the right of the runner:
   - To pause the runner, select **Pause** ([icon: pause]).
   - To resume the runner, select **Resume** ([icon: play]).
...
1. Delete the instance runner:
   - To delete a single runner, next to the runner, select **Delete runner** ([icon: remove]).
...
1. To the right of the runner:
   - To pause the runner, select **Pause** ([icon: pause]), then select **Pause**.
   - To resume the runner, select **Resume** ([icon: play]).
