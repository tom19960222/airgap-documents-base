...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/debugging.md
...
This message displays with a spinning status icon ([icon: spinner]) when the merge request
