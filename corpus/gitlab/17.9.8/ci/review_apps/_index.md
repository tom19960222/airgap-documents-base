...
version: "17.9.8"
title: "Review apps"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/review_apps/_index.md
...
- In the diff for a comparison or commit, by selecting **View** ([icon: external-link]) next to the file.

- In the blob file view, by selecting **View** ([icon: external-link]) next to the file.
