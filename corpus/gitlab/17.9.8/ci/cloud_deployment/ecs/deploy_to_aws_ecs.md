...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/cloud_deployment/ecs/deploy_to_aws_ecs.md
...
1. In GitLab on the left sidebar, at the top, select **Create new** ([icon: plus]) and **New project/repository**.
