...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/pipelines/schedules.md
...
1. On the left sidebar, select **Search or go to** and find your project.
1. Select **Build > Pipeline schedules**.
1. Next to the schedule, select **Edit** ([icon: pencil]) and fill in the form.
...
1. On the right of the list, for
   the pipeline you want to run, select **Run** ([icon: play]).
