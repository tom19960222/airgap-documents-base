...
version: "17.9.8"
title: "Merge trains"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/pipelines/merge_trains.md
...
You can also remove ([icon: close]) a merge request from the merge train details view.
...
- From the [merge train details](#view-a-merge-train), next to the merge request, select [icon: close].
