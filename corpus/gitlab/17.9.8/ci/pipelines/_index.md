...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/pipelines/_index.md
...
You can do this straight from the pipeline graph. Select **Run** ([icon: play]) to execute that particular job.
...
by selecting **Run all manual** ([icon: play]) above the stage. If the stage contains
