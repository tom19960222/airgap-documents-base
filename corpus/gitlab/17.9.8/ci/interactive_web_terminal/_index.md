...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/interactive_web_terminal/_index.md
...
running, on the right panel, you can see a `debug` button ([icon: external-link]) that opens the terminal
