...
version: "17.9.8"
title: "Deployments"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/environments/deployments.md
...
- Exposes the **Run** ([icon: play]) button for the job in the GitLab UI, with the text **Can be manually deployed to &lt;environment&gt;**.
- Means the `deploy_prod` job must be triggered manually.

You can find **Run** ([icon: play]) in the pipelines, environments, deployments, and jobs views.
