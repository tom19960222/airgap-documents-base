...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/environments/deployment_safety.md
...
When an older deployment job is manual, the **Run** ([icon: play]) button is disabled with a message
