...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/environments/incremental_rollouts.md
...
After the jobs are built, select **Run** ([icon: play]) next to the job's name
