...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/testing/unit_test_reports.md
...
1. Expand the **Test summary** panel by selecting **Show test summary details** ([icon: chevron-lg-down]).
1. Select the test you want to review.
1. Select **Copy test name to rerun locally** ([icon: copy-to-clipboard]).
