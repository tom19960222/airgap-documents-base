...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/jobs/job_logs.md
...
- `\r\e[0K`: Escape sequence that prevents the section markers from displaying in the
  ...
  in the upper-right corner of the job log by selecting **Show complete raw** ([icon: doc-text]).
