...
version: "17.9.8"
title: "Job artifacts"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/ci/jobs/job_artifacts.md
...
- Any **Pipelines** list. On the right of the pipeline, select **Download artifacts** ([icon: download]).
- Any **Jobs** list. On the right of the job, select **Download artifacts** ([icon: download]).
- A job's detail page. On the right of the page, select **Download**.
- A merge request **Overview** page. On the right of the latest pipeline, select **Artifacts** ([icon: download]).
- The [**Artifacts**](#view-all-job-artifacts-in-a-project) page. On the right of the job, select **Download** ([icon: download]).
- The [artifacts browser](#browse-the-contents-of-the-artifacts-archive). On the top of the page,
  select **Download artifacts archive** ([icon: download]).
...
- Any **Jobs** list. On the right of the job, select **Browse** ([icon: folder-open]).
- A job's detail page. On the right of the page, select **Browse**.
- The **Artifacts** page. On the right of the job, select **Browse** ([icon: folder-open]).
...
|----------------|------------------------|-----------------------------------|
| `.html`        | [icon: check-circle] Yes | [icon: check-circle] Yes            |
| `.json`        | [icon: check-circle] Yes | [icon: check-circle] Yes            |
| `.xml`         | [icon: check-circle] Yes | [icon: check-circle] Yes            |
| `.txt`         | [icon: dotted-circle] No | [icon: check-circle] Yes            |
| `.log`         | [icon: dotted-circle] No | [icon: check-circle] Yes            |
...
1. In the upper-right corner of the job's log, select **Erase job log and artifacts** ([icon: remove]).
