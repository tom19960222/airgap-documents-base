...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/cicd/pipeline_wizard.md
...
|---------------|------------------------|--------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `id`          | [icon: check-circle] Yes | string | A unique template ID. This ID should follow a namespacing pattern, with a forward slash `/` as separator. Templates committed to GitLab source code should always begin with `gitlab`. For example: `gitlab/my-template` |
| `title`       | [icon: check-circle] Yes | string | The page title as displayed to the user. It becomes an `h1` heading above the wizard.                                                                                                                                    |
| `description` | [icon: check-circle] Yes | string | The page description as displayed to the user.                                                                                                                                                                           |
| `filename`    | [icon: dotted-circle] No | string | The name of the file that is being generated. Defaults to `.gitlab-ci.yml`.                                                                                                                                              |
| `steps`       | [icon: check-circle] Yes | list   | A list of [step definitions](#step-reference).                                                                                                                                                                           |
...
| Name       | Required               | Type | Description                                                                                                                                                                           |
|------------|------------------------|------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `template` | [icon: check-circle] Yes | map  | The raw YAML to deep-merge into the final `.gitlab-ci.yml`. This template section can contain variables denoted by a `$` sign that is replaced with the values from the input fields. |
| `inputs`   | [icon: check-circle] Yes | list | A list of [input definitions](#input-reference).                                                                                                                                      |
...
| Name     | Required               | Type   | Description                                                                                                                 |
|----------|------------------------|--------|-----------------------------------------------------------------------------------------------------------------------------|
| `label`  | [icon: check-circle] Yes | string | The label for the input field.                                                                                              |
| `widget` | [icon: check-circle] Yes | string | The [widget](#widgets) type to use for this input.                                                                          |
| `target` | [icon: dotted-circle] No | string | The variable name inside the step's template that should be replaced with the value of the input field, for example `$FOO`. |
...
|-------------------|------------------------|---------|-----------------------|
| `label`           | [icon: check-circle] Yes | string  | The label for the input field. |
| `description`     | [icon: dotted-circle] No | string  | Help text related to the input field. |
| `required`        | [icon: dotted-circle] No | boolean | Whether or not the user must provide a value before proceeding to the next step. `false` if not defined. |
| `placeholder`     | [icon: dotted-circle] No | string  | A placeholder for the input field. |
| `pattern`         | [icon: dotted-circle] No | string  | A regular expression that the user's input must match before they can proceed to the next step. |
| `invalidFeedback` | [icon: dotted-circle] No | string  | Help text displayed when the pattern validation fails. |
| `default`         | [icon: dotted-circle] No | string  | The default value for the field. |
| `id`              | [icon: dotted-circle] No | string  | The input field ID is usually autogenerated but can be overridden by providing this property. |
...
| `pattern`         | [icon: dotted-circle] No | string  | A regular expression that the user's input must match before they can proceed to the next step. |
| `invalidFeedback` | [icon: dotted-circle] No | string  | Help text displayed when the pattern validation fails. |
| `default`         | [icon: dotted-circle] No | list    | The default value for the list |
| `id`              | [icon: dotted-circle] No | string  | The input field ID is usually autogenerated but can be overridden by providing this property. |
...
| Name    | Required               | Type   | Description                                                                                                                                                                        |
|---------|------------------------|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `title` | [icon: dotted-circle] No | string | A title above the checklist items.                                                                                                                                                  |
| `items` | [icon: dotted-circle] No | list   | A list of items that need to be checked. Each item corresponds to one checkbox, and can be a string or [checklist item](#checklist-item). |

##### Checklist Item

| Name   | Required               | Type    | Description                             |
|--------|------------------------|---------|-----------------------------------------|
| `text` | [icon: check-circle] Yes | string  | A title above the checklist items.      |
| `help` | [icon: dotted-circle] No | string  | Help text explaining the item.          |
| `id`   | [icon: dotted-circle] No | string  | The input field ID is usually autogenerated but can be overridden by providing this property. |
