...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/documentation/site_architecture/deployment_process.md
...
1. Next to `Build docs.gitlab.com every hour`, select **Play** ([icon: play]).
