...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/documentation/styleguide/_index.md
...
|--------|--------------------------|------------------------|
| No     | `[icon: dash-circle] No` | [icon: dash-circle] No |
| Yes    | `[icon: check-circle-filled] Yes` | [icon: check-circle-filled] Yes |
...
```markdown
1. On the left sidebar, at the top, select **Create new** ([icon: plus]) and **New group**.
```
...
directly in the documentation. For example, `{{</* icon name="tanuki" */>}}` renders as: [icon: tanuki].
...
- Avoid: `Select {{</* icon name="pencil" */>}} **Edit**.` This generates as: Select [icon: pencil] **Edit**.
- Use instead: `Select **Edit** ({{</* icon name="pencil" */>}}).` This generates as: Select **Edit** ([icon: pencil]).

Do not use words to describe the icon:

- Avoid: `Select **Erase job log** (the trash icon).`
- Use instead: `Select **Erase job log** ({{</* icon name="remove" */>}}).` This generates as: Select **Erase job log** ([icon: remove]).
...
- Use instead: `Select the vertical ellipsis ({{</* icon name="ellipsis_v" */>}}).` This generates as: Select the vertical ellipsis ([icon: ellipsis_v]).
