...
version: "17.9.8"
title: "Frontend FAQ"
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/fe_guide/frontend_faq.md
...
1. In the upper-left corner of the page, select the right arrow ([icon: chevron-lg-right])
