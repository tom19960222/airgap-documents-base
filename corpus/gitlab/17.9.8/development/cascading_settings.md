...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/cascading_settings.md
...
Initializes the JavaScript needed to display the tooltip when hovering over the lock icon ([icon: lock]).
