...
source_url: https://gitlab.com/gitlab-org/gitlab/-/blob/v17.9.8-ee/doc/development/api_graphql_styleguide.md
...
|---------------|---------------------------|
| Full path | [icon: check-circle] Yes |
| Database ID | [icon: dotted-circle] No |
| IID | [icon: dotted-circle] No |
