...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security/authentication-backends/jwt.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security/authentication-backends/jwt.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security/authentication-backends/jwt/"
canonical_url: "https://docs.opensearch.org/latest/security/authentication-backends/jwt/"
canonical_route: "/security/authentication-backends/jwt/"
redirect_from: []
...
If you use a JWT as your only authentication method, disable the user cache by setting the `plugins.security.cache.ttl_minutes` property to `0`. For more information about this property, see [opensearch.yml](../../configuration/yaml/index.md#opensearchyml).
{: .important }
...
In OpenSearch, this method of validation makes use of the [OpenID Connect authentication domain configuration](../openid-connect/index.md#configure-openid-connect-integration). To specify the JWKS endpoint, replace the `openid_connect_url` setting in the configuration with the `jwks_uri` setting and add the URL to the setting as its value. This is shown in the following example:
