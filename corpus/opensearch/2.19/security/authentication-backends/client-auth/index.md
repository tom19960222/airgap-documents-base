...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security/authentication-backends/client-auth.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security/authentication-backends/client-auth.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security/authentication-backends/client-auth/"
canonical_url: "https://docs.opensearch.org/latest/security/authentication-backends/client-auth/"
canonical_route: "/security/authentication-backends/client-auth/"
redirect_from: ["/security/configuration/client-auth/","/security-plugin/configuration/client-auth/"]
...
After obtaining your own certificates either from a certificate authority (CA) or by [generating your own certificates using OpenSSL](../../configuration/generate-certificates/index.md), you can start configuring OpenSearch to authenticate a user using a client certificate.
...
You can now assign your certificate's common name (CN) to a role. This step requires you to identify the certificate's CN and the role you want to assign it to. To view a list of all predefined OpenSearch roles, see [Predefined roles](../../access-control/users-roles/index.md#predefined-roles). To get started, first [define a role](../../access-control/users-roles/index.md#defining-roles) and then map your certificate's CN to that role.

After determining which role to map to your certificate's CN, you can use [OpenSearch Dashboards](../../access-control/users-roles/index.md#mapping-users-to-roles), [`roles_mapping.yml`](../../configuration/yaml/index.md#roles_mappingyml), or the [REST API](../../access-control/api/index.md#create-role-mapping) to map the role. The following example uses the `REST API` to map the CN `CLIENT1` to the role `readall`.
...
While we recommend using the [tarball](../../../install-and-configure/install-opensearch/tar/index.md) installation of ODFE to test client certificate authentication configurations, you can also use any of the other install types. For instructions on using Docker security, see [Configuring basic security settings](../../../install-and-configure/install-opensearch/docker/index.md#configuring-basic-security-settings).
