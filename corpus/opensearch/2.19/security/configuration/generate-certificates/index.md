...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security/configuration/generate-certificates.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security/configuration/generate-certificates.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security/configuration/generate-certificates/"
canonical_url: "https://docs.opensearch.org/latest/security/configuration/generate-certificates/"
canonical_route: "/security/configuration/generate-certificates/"
redirect_from: ["/security-plugin/configuration/generate-certificates/"]
...
If you want to use the same node certificate on all nodes (not recommended), set hostname verification to `false`. For more information, see [Configure TLS certificates](../tls/index.md#advanced-hostname-verification-and-dns-lookup).
...
For more information about adding and using these certificates in your own setup, see [Configuring basic security settings](../../../install-and-configure/install-opensearch/docker/index.md#configuring-basic-security-settings) for Docker, [Configure TLS certificates](../tls/index.md), and [Client certificate authentication](../../authentication-backends/client-auth/index.md).

## OpenSearch Dashboards

For information on using your root CA and a client certificate to enable TLS for OpenSearch Dashboards, see [Configure TLS for OpenSearch Dashboards](../../../install-and-configure/install-dashboards/tls/index.md).
