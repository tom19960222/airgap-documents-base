...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security/access-control/users-roles.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security/access-control/users-roles.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security/access-control/users-roles/"
canonical_url: "https://docs.opensearch.org/latest/security/access-control/users-roles/"
canonical_route: "/security/access-control/users-roles/"
redirect_from: ["/security/access-control/users-roles/","/security-plugin/access-control/users-roles/"]
...
You define users in OpenSearch to control who has access to OpenSearch data. You can use the internal user database to store users, or you can store them in an external authentication system, such as [LDAP or Active Directory](../../authentication-backends/ldap/index.md).
...
You can define users by using OpenSearch Dashboards, `internal_users.yml`, or the REST API. When creating users, you can map users to roles by using `internal_users.yml` or the REST API. If you are using OpenSearch Dashboards to define users, follow the steps in the [Map users to roles](index.md#mapping-users-to-roles) tutorial.

Unless you are defining new [reserved or hidden users](../api/index.md#reserved-and-hidden-resources), using OpenSearch Dashboards or the REST API to create new users, roles, and role mappings is recommended. The `.yml` files are for initial setup and are not for ongoing use.
{: .warning }
...
See [YAML files](../../configuration/yaml/index.md#internal_usersyml).

### REST API

See [Create user](../api/index.md#create-user).
...
See [YAML files](../../configuration/yaml/index.md#rolesyml).

### REST API

See [Create role](../api/index.md#create-role).
...
See [Patch role](../api/index.md#patch-role).
...
See [YAML files](../../configuration/yaml/index.md#roles_mappingyml).

### REST API

See [Create role mapping](../api/index.md#create-role-mapping).
...
![creating role](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/role_creation_read_only.png)
...
![mapping users](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/mapping-users.png)
...
![compare read only mode](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/compare_read_only_mode.png)
...
| `all_access` | Grants full access to the cluster, including all cluster-wide operations, permissions to write to all cluster indexes, and permissions to write to all tenants. For more information about access using the REST API, see [Access control for the API](../api/index.md#access-control-for-the-api). |
...
For more detailed summaries of the permissions for each role, reference their action groups against the descriptions in [Default action groups](../default-action-groups/index.md).
...
For more information about defining users, see [Defining users](index.md#defining-users). For more information about defining roles, see [Defining roles](index.md#defining-roles).
...
Admin users can perform these tasks by configuring settings in the `opensearch.yml` file, using OpenSearch Dashboards, or interacting with the REST API. For more information about configuring users and roles, see [predefined roles](index.md#predefined-roles).
...
For more information, see [Configuring super admin certificates](../../configuration/tls/index.md#configuring-admin-certificates).
