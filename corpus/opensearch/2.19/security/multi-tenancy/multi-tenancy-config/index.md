...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security/multi-tenancy/multi-tenancy-config.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security/multi-tenancy/multi-tenancy-config.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security/multi-tenancy/multi-tenancy-config/"
canonical_url: "https://docs.opensearch.org/latest/security/multi-tenancy/multi-tenancy-config/"
canonical_route: "/security/multi-tenancy/multi-tenancy-config/"
redirect_from: []
...
| `server_username` | Must match the name of the OpenSearch Dashboards server user in `opensearch_dashboards.yml`. Default is `kibanaserver`. If a different user is configured, then make sure that user is mapped to the `kibana_server` role through the `role_mappings.yml` file in order to give them the appropriate permissions listed in [kibana_server role details](index.md#kibana_server-role-details). |
...
See [Create tenant](../../access-control/api/index.md#create-tenant).
...
See [Create role](../../access-control/api/index.md#create-role).
...
To back up your OpenSearch Dashboards data, [take a snapshot](../../../tuning-your-cluster/availability-and-recovery/snapshots/snapshot-restore/index.md) of all tenant indexes using an index pattern such as `.kibana*`.
