...
version: "2.19"
title: "Tools"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tools/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tools/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tools/"
canonical_url: "https://docs.opensearch.org/latest/tools/"
canonical_route: "/tools/"
redirect_from: ["/clients/agents-and-ingestion-tools/index/","/tools/index/"]
...
For information about Data Prepper, the server-side data collector for filtering, enriching, transforming, normalizing, and aggregating data for downstream analytics and visualization, see [Data Prepper](https://docs.opensearch.org/latest/data-prepper/index/) <!-- unresolved-jekyll-link: route=/data-prepper/ -->.
...
[Just like any other setting](../install-and-configure/configuring-opensearch/index.md), the alternative is to add the following line to `opensearch.yml` on each node and then restart the node:
...
The OpenSearch CLI command line interface (opensearch-cli) lets you manage your OpenSearch cluster from the command line and automate tasks. For more information about OpenSearch CLI, see [OpenSearch CLI](cli/index.md).

## OpenSearch Kubernetes operator

The OpenSearch Kubernetes Operator is an open-source Kubernetes operator that helps automate the deployment and provisioning of OpenSearch and OpenSearch Dashboards in a containerized environment. For information about how to use the operator, see [OpenSearch Kubernetes Operator](k8s-operator/index.md).
...
For more information, see [Sycamore](sycamore/index.md).
