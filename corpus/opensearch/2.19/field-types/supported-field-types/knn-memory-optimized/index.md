...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_field-types/supported-field-types/knn-memory-optimized.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_field-types/supported-field-types/knn-memory-optimized.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/field-types/supported-field-types/knn-memory-optimized/"
canonical_url: "https://docs.opensearch.org/latest/mappings/supported-field-types/knn-memory-optimized/"
canonical_route: "/mappings/supported-field-types/knn-memory-optimized/"
redirect_from: ["/mappings/supported-field-types/knn-memory-optimized/"]
...
When using `byte` vectors with the `faiss` engine, we recommend using [Single Instruction Multiple Data (SIMD) optimization](../knn-methods-engines/index.md#simd-optimization), which helps to significantly reduce search latencies and improve indexing throughput.
{: .important}
...
The `ivf` method requires a training step that creates a model and trains it to initialize the native library index during segment creation. For more information, see [Building a vector index from a model](../../../vector-search/vector-search-techniques/approximate-knn/index.md#building-a-vector-index-from-a-model).
...
- [Approximate k-NN](../../../vector-search/vector-search-techniques/approximate-knn/index.md): Supports binary vectors only for the Faiss engine with the HNSW and IVF algorithms.
- [Script score k-NN](../../../vector-search/vector-search-techniques/knn-score-script/index.md): Enables the use of binary vectors in script scoring.
- [Painless extensions](../../../vector-search/vector-search-techniques/painless-functions/index.md): Allows the use of binary vectors with Painless scripting extensions.
...
- [Disk-based vector search](../../../vector-search/optimizing-storage/disk-based-vector-search/index.md)
