...
version: "2.19"
title: "Derived"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_field-types/supported-field-types/derived.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_field-types/supported-field-types/derived.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/field-types/supported-field-types/derived/"
canonical_url: "https://docs.opensearch.org/latest/mappings/supported-field-types/derived/"
canonical_route: "/mappings/supported-field-types/derived/"
redirect_from: ["/mappings/supported-field-types/derived/"]
...
- **Join field type**: Derived fields are not supported for the [join field type](../join/index.md).
...
- **Enable expensive queries**: Ensure that [`search.allow_expensive_queries`](../../../query-dsl/index.md#expensive-queries) is set to `true`.
...
| `format` | Optional | The format used for parsing dates. Only applicable to `date` fields. Valid values are `strict_date_time_no_millis`, `strict_date_optional_time`, and `epoch_millis`. For more information, see [Formats](../date/index.md#formats).|
...
Derived fields use the default analyzer specified in the index analysis settings during search. You can override the default analyzer or specify a search analyzer within a search request in the same way as with regular fields. For more information, see [Analyzers](../../../analyzers/index.md).
{: .note}
...
Derived fields of type `text` support highlighting using the [unified highlighter](../../../search-plugins/searching-data/highlight/index.md#the-unified-highlighter). For example, the following request specifies to highlight the derived `url` field:
