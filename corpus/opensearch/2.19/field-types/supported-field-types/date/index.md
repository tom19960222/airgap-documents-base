...
version: "2.19"
title: "Date"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_field-types/supported-field-types/date.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_field-types/supported-field-types/date.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/field-types/supported-field-types/date/"
canonical_url: "https://docs.opensearch.org/latest/mappings/supported-field-types/date/"
canonical_route: "/mappings/supported-field-types/date/"
redirect_from: ["/opensearch/supported-field-types/date/","/field-types/date/","/mappings/supported-field-types/date/"]
...
To represent date ranges, there is a date [range field type](../range/index.md).
{: .note }
...
As of OpenSearch 2.12, you can to choose to use an experimental default date format, `strict_date_time_no_millis||strict_date_optional_time||epoch_millis`. To use the experimental default, set the `opensearch.experimental.optimization.datetime_formatter_caching.enabled` feature flag to `true`. For more information about enabling and disabling feature flags, see [Enabling experimental features](../../../install-and-configure/configuring-opensearch/experimental/index.md).
...
The date field type supports using date math to specify durations in queries. For example, the `gt`, `gte`, `lt`, and `lte` parameters in [range queries](../../../query-dsl/term/range/index.md) and the `from` and `to` parameters in [date range aggregations](../../../aggregations/bucket/date-range/index.md) accept date math expressions.
...
The following example illustrates using date math in a [range query](../../../query-dsl/term/range/index.md).
