...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tuning-your-cluster/availability-and-recovery/snapshots/sm-api.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tuning-your-cluster/availability-and-recovery/snapshots/sm-api.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tuning-your-cluster/availability-and-recovery/snapshots/sm-api/"
canonical_url: "https://docs.opensearch.org/latest/tuning-your-cluster/availability-and-recovery/snapshots/sm-api/"
canonical_route: "/tuning-your-cluster/availability-and-recovery/snapshots/sm-api/"
redirect_from: ["/opensearch/snapshots/sm-api/"]
...
Use the snapshot management (SM) API to automate [taking snapshots](../snapshot-restore/index.md#take-snapshots).
...
`snapshot_config.include_global_state` | Boolean | Do you want to include cluster state? Optional. Default is `true` because of [Security plugin considerations](../snapshot-restore/index.md#security-considerations).
...
`notification.channel` | Object | Defines a channel for notifications. You must [create and configure a notification channel](../../../../observing-your-data/notifications/api/index.md) before setting up SM notifications. Required.
...
```
You can use a [query string](../../../../query-dsl/full-text/query-string/index.md) and specify pagination, the field to be sorted by, and sort order:
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/sm-state-machine.png" alt="SM State Machine" width="150" style="float: left; margin-right: 15px;"/>
