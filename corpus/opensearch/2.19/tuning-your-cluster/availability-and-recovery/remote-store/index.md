...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tuning-your-cluster/availability-and-recovery/remote-store/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tuning-your-cluster/availability-and-recovery/remote-store/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tuning-your-cluster/availability-and-recovery/remote-store/"
canonical_url: "https://docs.opensearch.org/latest/tuning-your-cluster/availability-and-recovery/remote-store/index/"
canonical_route: "/tuning-your-cluster/availability-and-recovery/remote-store/"
redirect_from: ["/opensearch/remote/","/tuning-your-cluster/availability-and-recovery/remote/","/tuning-your-cluster/availability-and-recovery/remote-store/"]
...
For more information about configuring settings for the remote cluster state, see [Remote Cluster State](remote-cluster-state/index.md). This is required in order for cluster metadata to persist on the remote store.
...
You can use the following [cluster settings](../../../api-reference/cluster-api/cluster-settings/index.md) to tune how remote-backed clusters handle each workload.
...
If the Security plugin is enabled, a user must have the `cluster:admin/remotestore/restore` permission. See [Access control](../../../security/access-control/index.md) for information about configuring user permissions.
{: .note}
...
The OpenSearch Project has run remote store using multiple workload options available within the [OpenSearch Benchmark](https://docs.opensearch.org/latest/benchmark/index/) <!-- unresolved-jekyll-link: route=/benchmark/ --> tool. This section summarizes the benchmark results for the following workloads:
