...
version: "2.19"
title: "Guardrails"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/remote-models/guardrails.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/remote-models/guardrails.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/remote-models/guardrails/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/remote-models/guardrails/"
canonical_route: "/ml-commons-plugin/remote-models/guardrails/"
redirect_from: []
...
Before you start, make sure you have fulfilled the [prerequisites](../index.md#prerequisites) for connecting to an externally hosted model.
...
To start, create an index that will store the excluded words (_stopwords_). In the index settings, specify a `title` field, which will contain excluded words, and a `query` field of the [percolator](../../../field-types/supported-field-types/percolator/index.md) type. The percolator query will be used to match the LLM input or output:
...
For more query string options, see [Query string query](../../../query-dsl/full-text/query-string/index.md).
...
For more information, see [The `guardrails` parameter](../../api/model-apis/register-model/index.md#the-guardrails-parameter).
...
- For more information about configuring guardrails, see [The `guardrails` parameter](../../api/model-apis/register-model/index.md#the-guardrails-parameter).
- For a tutorial demonstrating how to use Amazon Bedrock guardrails, see [Using Amazon Bedrock guardrails](../../../tutorials/gen-ai/model-controls/bedrock-guardrails/index.md).
