...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/remote-models/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/remote-models/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/remote-models/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/remote-models/index/"
canonical_route: "/ml-commons-plugin/remote-models/"
redirect_from: ["/ml-commons-plugin/extensibility/index/","/ml-commons-plugin/remote-models/"]
...
- If you're an ML developer wanting to create integrations with your specific ML services, see [Connector blueprints](blueprints/index.md).
- If you're a system administrator or data scientist wanting to create a connection to an ML service, see [Connectors](connectors/index.md).
...
When access control is enabled, you can install the [Security plugin](../../security/index.md). This makes the `backend_roles`, `add_all_backend_roles`, or `access_model` options required in order to use the connector API. If successful, OpenSearch returns the following response:
...
To learn more about model groups, see [Model access control](../model-access-control/index.md).

## Step 2: Create a connector

You can create a standalone connector that can be reused for multiple models. Alternatively, you can specify a connector when creating a model so that it can be used only for that model. For more information and example connectors, see [Connectors](connectors/index.md).
...
To check the status of the operation, provide the task ID to the [Tasks API](../api/tasks-apis/get-task/index.md):
...
To undeploy the model, use the [Undeploy API](../api/model-apis/undeploy-model/index.md).
...
Use the [Predict API](../api/train-predict/predict/index.md) to test the model:
...
To learn how to use the model for batch ingestion in order to improve ingestion performance, see [Using externally hosted ML models for batch ingestion](batch-ingestion/index.md).

## Step 7: Use the model for search

To learn how to use the model for vector search, see [AI search methods](../../vector-search/ai-search/index.md#ai-search-methods).

## Step 8 (Optional): Undeploy the model

You can undeploy the model automatically by defining a TTL in the model settings or by using the Undeploy API to undeploy the model manually. For more information, see [Undeploy API](../api/model-apis/undeploy-model/index.md).

## Next steps

- For more information about connectors, including example connectors, see [Connectors](connectors/index.md).
- For more information about connector parameters, see [Connector blueprints](blueprints/index.md).
- For more information about managing ML models in OpenSearch, see [Using ML models within OpenSearch](../using-ml-models/index.md).
- For more information about interacting with ML models in OpenSearch, see [Managing ML models in OpenSearch Dashboards](../ml-dashboard/index.md)
For instructions on how to configure model guardrails, see [Guardrails](guardrails/index.md).
