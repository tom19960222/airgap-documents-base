...
version: "2.19"
title: "Connectors"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/remote-models/connectors.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/remote-models/connectors.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/remote-models/connectors/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/remote-models/connectors/"
canonical_route: "/ml-commons-plugin/remote-models/connectors/"
redirect_from: ["/ml-commons-plugin/extensibility/connectors/"]
...
Standalone connectors can be used by multiple models. To create a standalone connector, send a request to the `connectors/_create` endpoint and provide all of the parameters described in [Connector blueprints](../blueprints/index.md):
...
To create a connector for a specific model, provide all of the parameters described in [Connector blueprints](../blueprints/index.md) within the `connector` object of a request to the `models/_register` endpoint:
...
The following sections contain examples of connectors for popular ML platforms. For a full list of supported connectors, see [Supported connectors](../supported-connectors/index.md).
...
- For a full list of connector blueprints provided by OpenSearch, see [Supported connectors](../supported-connectors/index.md).
- To learn more about connecting to external models, see [Connecting to externally hosted models](../index.md).
- To learn more about model access control and model groups, see [Model access control](../../model-access-control/index.md).
