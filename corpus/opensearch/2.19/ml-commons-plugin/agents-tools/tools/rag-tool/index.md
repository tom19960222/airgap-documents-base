...
version: "2.19"
title: "RAG tool"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/agents-tools/tools/rag-tool.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/agents-tools/tools/rag-tool.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/agents-tools/tools/rag-tool/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/agents-tools/tools/rag-tool/"
canonical_route: "/ml-commons-plugin/agents-tools/tools/rag-tool/"
redirect_from: []
...
The `RAGTool` performs retrieval-augmented generation (RAG). For more information about RAG, see [Conversational search](../../../../vector-search/ai-search/conversational-search/index.md).
...
- [Neural search](../../../../vector-search/ai-search/index.md): Dense vector retrieval, which uses a text embedding model.
- [Neural sparse search](../../../../vector-search/ai-search/neural-sparse-search/index.md): Sparse vector retrieval, which uses a sparse encoding model.

## Before you start

To register and deploy a text embedding model and an LLM and ingest data into an index, perform Steps 1--5 of the [Agents and tools tutorial](../../agents-tools-tutorial/index.md).

The following example uses neural search. To configure neural sparse search and deploy a sparse encoding model, see [Neural sparse search](../../../../vector-search/ai-search/neural-sparse-search/index.md).
...
To create a conversational agent containing a `RAGTool`, see [Conversational agents](../../index.md#conversational-agents).

## Step 2: Run the agent

Before you run the agent, make sure that you add the sample OpenSearch Dashboards `Sample web logs` dataset. To learn more, see [Adding sample data](https://docs.opensearch.org/latest/dashboards/quickstart#adding-sample-data) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/quickstart/ -->.
