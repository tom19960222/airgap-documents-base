...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/model-access-control.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/model-access-control.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/model-access-control/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/model-access-control/"
canonical_route: "/ml-commons-plugin/model-access-control/"
redirect_from: []
...
1. Enable the Security plugin on your cluster. For more information, see [Security in OpenSearch](../../security/index.md).
...
Create the appropriate backend roles and assign those roles to users. Backend roles usually come from an [LDAP server](../../security/authentication-backends/ldap/index.md) or [SAML provider](../../security/authentication-backends/saml/index.md), but if you use the internal user database, you can use the REST API to [add them manually](../../security/access-control/api/index.md#create-user).
...
For information about APIs related to model access control, see [Model Group APIs](../api/model-group-apis/index.md).

## Hidden models
**Introduced 2.12**
{: .label .label-purple }

To hide model details from end users, including the cluster admin, you can register a _hidden_ model. If a model is hidden, the non-superadmin users don't have permission to call any [Model APIs](../api/model-apis/index.md) except for the [Predict API](../api/train-predict/predict/index.md) on the model.

Only superadmin users can register a hidden model. A hidden model can be one of the OpenSearch-provided pretrained models, your own custom model, or an externally hosted model. To register a hidden model, you first need to authenticate with an [admin certificate](../../security/configuration/tls/index.md#configuring-admin-certificates):
