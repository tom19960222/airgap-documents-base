...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/api/model-group-apis/register-model-group.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/api/model-group-apis/register-model-group.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/api/model-group-apis/register-model-group/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/api/model-group-apis/register-model-group/"
canonical_route: "/ml-commons-plugin/api/model-group-apis/register-model-group/"
redirect_from: []
...
If model access control is disabled on your cluster (one of the [prerequisites](ml-commons-plugin/model-access-control/#model-access-control-prerequisites) <!-- unresolved-jekyll-link: target=ml-commons-plugin/model-access-control/#model-access-control-prerequisites --> is not met), you can register a model group with a `name` and `description` but cannot specify any of the access parameters (`model_access_name`, `backend_roles`, or `add_backend_roles`). By default, in such a cluster, all model groups are public.
