...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/api/agent-apis/register-agent.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/api/agent-apis/register-agent.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/api/agent-apis/register-agent/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/api/agent-apis/register-agent/"
canonical_route: "/ml-commons-plugin/api/agent-apis/register-agent/"
redirect_from: []
...
For more information about agents, see [Agents and tools](../../../agents-tools/index.md).
...
`type` | String | Required | All | The agent type. Valid values are `flow`, `conversational_flow`, and `conversational`. For more information, see [Agents](../../../agents-tools/index.md). |
...
`type` | String | Required | The tool type. For a list of supported tools, see [Tools](../../../agents-tools/tools/index.md).
`parameters` | Object | Optional | The parameters for this tool. The parameters are highly dependent on the tool type. You can find information about specific tool types in [Tools](../../../agents-tools/tools/index.md).
