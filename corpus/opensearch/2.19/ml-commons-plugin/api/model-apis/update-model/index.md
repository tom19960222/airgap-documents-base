...
version: "2.19"
title: "Update model"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/api/model-apis/update-model.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/api/model-apis/update-model.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/api/model-apis/update-model/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/api/model-apis/update-model/"
canonical_route: "/ml-commons-plugin/api/model-apis/update-model/"
redirect_from: []
...
The following table lists the updatable fields. Not all request fields are applicable to all models. To determine whether the field is applicable to your model type, see [Register Model API](../register-model/index.md).

Field | Data type |  Description
:---  | :--- | :---
`connector` | Object | Contains specifications for a connector for a model hosted on a third-party platform. For more information, see [Creating a connector for a specific model](../../../remote-models/connectors/index.md#creating-a-connector-for-a-specific-model). For information about the updatable fields within a connector, see [Update Connector API request fields](../../connector-apis/update-connector/index.md#request-body-fields).
`connector_id` | Optional | The connector ID of a standalone connector for a model hosted on a third-party platform. For more information, see [Standalone connector](../../../remote-models/connectors/index.md#creating-a-standalone-connector). To update a standalone connector, you must undeploy the model, update the connector, and then redeploy the model.
...
`model_config` | Object | The model's configuration, including the `model_type`, `embedding_dimension`, and `framework_type`. `all_config` is an optional JSON string that contains all model configurations. For more information, see [The `model_config` object](../register-model/index.md#the-model_config-object). |
`model_group_id` | String | The model group ID of the model group to which to register this model.
`name`| String | The model name.
`rate_limiter` | Object | Limits the number of times any user can call the Predict API on the model. For more information, see [Rate limiting inference calls](../../../integrating-ml-models/index.md#rate-limiting-inference-calls).
...
You can update a model's interface to define input and output schemas. This is useful when working with models that lack a default interface or require customization. For more information about model interfaces, see [The `Interface` parameter](../register-model/index.md#the-interface-parameter).
