...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ml-commons-plugin/api/controller-apis/create-controller.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ml-commons-plugin/api/controller-apis/create-controller.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ml-commons-plugin/api/controller-apis/create-controller/"
canonical_url: "https://docs.opensearch.org/latest/ml-commons-plugin/api/controller-apis/create-controller/"
canonical_route: "/ml-commons-plugin/api/controller-apis/create-controller/"
redirect_from: []
...
Use this API to create or update a controller for a model. A model may be shared by multiple users. A controller sets rate limits for the number of [Predict API](../../train-predict/predict/index.md) calls users can make on the model. A controller consists of a set of rate limiters for different users.
...
:---  | :--- | :--- | :---
`user_rate_limiter`| Object | Required | Limits the number of times users can call the Predict API on the model. For more information, see [Rate limiting inference calls](../../../integrating-ml-models/index.md#rate-limiting-inference-calls).
