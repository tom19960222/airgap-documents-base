...
version: "2.19"
title: "Sort results"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/searching-data/sort.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/searching-data/sort.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/searching-data/sort/"
canonical_url: "https://docs.opensearch.org/latest/search-plugins/searching-data/sort/"
canonical_route: "/search-plugins/searching-data/sort/"
redirect_from: ["/opensearch/search/sort/"]
...
Use `sort` with the [`search_after` parameter](../paginate/index.md#the-search_after-parameter) for more efficient scrolling.
...
When sorting [nested](../../../field-types/supported-field-types/nested/index.md) objects, provide the `path` parameter specifying the path to the field on which to sort.
...
You can provide coordinates in any format supported by the geopoint field type. For a description of all formats, see the [geopoint field type documentation](../../../field-types/supported-field-types/geo-point/index.md).
{: .note}
...
Sorted field values are loaded into memory for sorting. Therefore, for minimum overhead we recommend mapping [numeric types](../../../field-types/supported-field-types/numeric/index.md) to the smallest acceptable types, like `short`, `integer`, and `float`. [String types](../../../field-types/supported-field-types/string/index.md) should not have the sorted field analyzed or tokenized.
