...
version: "2.19"
title: "Point in Time"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/searching-data/point-in-time.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/searching-data/point-in-time.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/searching-data/point-in-time/"
canonical_url: "https://docs.opensearch.org/latest/search-plugins/searching-data/point-in-time/"
canonical_route: "/search-plugins/searching-data/point-in-time/"
redirect_from: ["/opensearch/point-in-time/","/search-plugins/point-in-time/"]
...
Besides the PIT functionality, there are three ways to [paginate search results](../paginate/index.md) in OpenSearch: using the Scroll API, specifying `from` and `size` parameters for your search, and using the `search_after` functionality. However, all three have limitations:
...
The [SQL plugin](../../sql/index.md) also supports pagination using PIT. When the `plugin.sql.pagination.api` setting is enabled (the default), SQL search queries in OpenSearch automatically use PIT internally. For more information, see [Pagination in SQL](../../sql/sql-ppl-api/index.md#paginating-results).
...
The following table lists all [Point in Time API](../point-in-time-api/index.md) functions.

Function | API | Description
:--- | :--- | :---
[Create PIT](../point-in-time-api/index.md#create-a-pit) | `POST /<target_indexes>/_search/point_in_time?keep_alive=1h` | Creates a PIT.
[List PIT](../point-in-time-api/index.md#list-all-pits) | `GET /_search/point_in_time/_all` | Lists all PITs.
[Delete PIT](../point-in-time-api/index.md#delete-pits) | `DELETE /_search/point_in_time`<br> `DELETE /_search/point_in_time/_all` | Deletes a PIT or all PITs.
[PIT segments](../point-in-time-api/index.md#pit-segments) | `GET /_cat/pit_segments/_all` | Provides information about the disk utilization of a PIT by describing its Lucene segments.

For information about the relevant cluster and node settings, see [PIT Settings](../point-in-time-api/index.md#pit-settings).
