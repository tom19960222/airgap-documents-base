...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/cross-cluster-search.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/cross-cluster-search.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/cross-cluster-search/"
canonical_url: "https://docs.opensearch.org/latest/search-plugins/cross-cluster-search/"
canonical_route: "/search-plugins/cross-cluster-search/"
redirect_from: ["/security/access-control/cross-cluster-search/","/security-plugin/access-control/cross-cluster-search/"]
...
For more information about the `ccs_minimize_roundtrips` parameter, see the list of [parameters](../../api-reference/search/index.md#query-parameters) for the Search API.
...
![OpenSearch Dashboards UI for creating a cross-cluster search role](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/security-ccs.png)
...
6fe89ebc5a8e    opensearchproject/opensearch:2.19.3   0.0.0.0:9200->9200/tcp, 0.0.0.0:9600->9600/tcp, 9300/tcp   opensearch-ccs-node1
2da08b6c54d8    opensearchproject/opensearch:2.19.3   9300/tcp, 0.0.0.0:9250->9200/tcp, 0.0.0.0:9700->9600/tcp   opensearch-ccs-node2
```
...
![OpenSearch Dashboards UI for configuring remote cluster for Cross-cluster search](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ccs-devtools.png)
...
stream {
    ...
    server {
        listen 8300;
        ssl_certificate /.../2.19.3/config/esnode.pem;
        ssl_certificate_key /.../2.19.3/config/esnode-key.pem;
        ssl_trusted_certificate /.../2.19.3/config/root-ca.pem;
...
Note the previously configured port `8300` in the [Proxy configuration](index.md#proxy-configuration) section.
