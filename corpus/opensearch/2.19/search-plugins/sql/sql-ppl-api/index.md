...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/sql/sql-ppl-api.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/sql/sql-ppl-api.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/sql/sql-ppl-api/"
canonical_url: "https://docs.opensearch.org/latest/sql-and-ppl/sql-and-ppl-api/index/"
canonical_route: "/sql-and-ppl/sql-and-ppl-api/"
redirect_from: ["/sql-and-ppl/sql-and-ppl-api/index/","/sql-and-ppl/sql-ppl-api/"]
...
Use the SQL and PPL API to send queries to the SQL plugin. Use the `_sql` endpoint to send queries in SQL, and the `_ppl` endpoint to send queries in PPL. For both of these, you can also use the `_explain` endpoint to translate your query into [OpenSearch domain-specific language](../../../query-dsl/index.md) (DSL) or to troubleshoot errors.
...
:--- | :--- | :---
[format](../response-formats/index.md) | String | The format for the response. The `_sql` endpoint supports `jdbc`, `csv`, `raw`, and `json` formats. The `_ppl` endpoint supports `jdbc`, `csv`, and `raw` formats. Default is `jdbc`.
sanitize | Boolean | Specifies whether to escape special characters in the results. See [Response formats](../response-formats/index.md) for more information. Default is `true`.
