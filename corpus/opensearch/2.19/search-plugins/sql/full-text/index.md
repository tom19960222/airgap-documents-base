...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/sql/full-text.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/sql/full-text.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/sql/full-text/"
canonical_url: "https://docs.opensearch.org/latest/sql-and-ppl/full-text/"
canonical_route: "/sql-and-ppl/full-text/"
redirect_from: ["/search-plugins/sql/sql-full-text/","/sql-and-ppl/full-text/"]
...
To learn about full-text queries in OpenSearch, see [Full-text queries](../../../query-dsl/full-text/index.md).
...
Refer to the `match` query [documentation](../../../query-dsl/full-text/match/index.md) for parameter descriptions and supported values.
...
Refer to `multi_match` query [documentation](../../../query-dsl/full-text/multi-match/index.md) for parameter description and supported values.
...
Refer to the `query_string` query [documentation](../../../query-dsl/full-text/query-string/index.md) for parameter descriptions and supported values.
...
Refer to the `match_phrase` query [documentation](../../../query-dsl/full-text/match-phrase/index.md) for parameter descriptions and supported values.
...
Refer to the `simple_query_string` query [documentation](../../../query-dsl/full-text/simple-query-string/index.md) for parameter descriptions and supported values.
...
Refer to the `match_phrase_prefix` query [documentation](../../../query-dsl/full-text/match-phrase-prefix/index.md) for parameter descriptions and supported values.
...
Refer to the `match_bool_prefix` query [documentation](../../../query-dsl/full-text/match-bool-prefix/index.md) for parameter descriptions and supported values.
