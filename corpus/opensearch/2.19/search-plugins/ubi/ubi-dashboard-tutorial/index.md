...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/ubi/ubi-dashboard-tutorial.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/ubi/ubi-dashboard-tutorial.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/ubi/ubi-dashboard-tutorial/"
canonical_url: "https://docs.opensearch.org/latest/search-plugins/ubi/ubi-dashboard-tutorial/"
canonical_route: "/search-plugins/ubi/ubi-dashboard-tutorial/"
redirect_from: []
...
1. Download and save the [sample UBI dashboard](https://docs.opensearch.org/latest/assets/examples/ubi-dashboard.ndjson) <!-- unresolved-jekyll-link: route=/assets/examples/ubi-dashboard.ndjson/ -->.
...
Start OpenSearch Dashboards. For example, go to `http://{server}:5601/app/home#/`. For more information, see [OpenSearch Dashboards](https://docs.opensearch.org/latest/dashboards/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/ -->. The following image shows the home page.
![Dashboard Home](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/home.png "Dashboards")
...
OpenSearch Dashboards accesses your indexes using index patterns. To visualize your users' online search behavior, you must create an index pattern in order to access the indexes that UBI creates. For more information, see [Index patterns](https://docs.opensearch.org/latest/dashboards/management/index-patterns/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/management/index-patterns/ -->.
...
![Index Patterns](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/index_pattern2.png "Index Patterns")
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/index_pattern3.png" alt="Index Patterns" width="400"/>
...
![Pie Chart](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/pie.png "Pie Chart")
...
![Word Cloud](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/tag_cloud1.png "Word Cloud")

The underlying queries can be found at [SQL trending queries](../sql-queries/index.md#trending-queries).
{: .note}
...
![Word Cloud](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/tag_cloud2.png "Word Cloud")
...
![UBI Dashboard](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/dashboard2.png "UBI Dashboard")
...
![Vertical Bar Chart](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/histogram.png "Vertical Bar Chart")
...
![Product Purchase](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/product_purchase.png "Product Purchase")

You can filter event messages containing the word `*laptop*` by adding wildcards, as shown in the following image.
![Laptop](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ubi/laptop.png "Laptop").
