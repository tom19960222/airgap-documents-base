...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_search-plugins/concurrent-segment-search.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_search-plugins/concurrent-segment-search.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/search-plugins/concurrent-segment-search/"
canonical_url: "https://docs.opensearch.org/latest/search-plugins/concurrent-segment-search/"
canonical_route: "/search-plugins/concurrent-segment-search/"
redirect_from: []
...
The index-level setting takes priority over the cluster-level setting. Thus, if the cluster setting is enabled but the index setting is disabled, then concurrent segment search will be disabled for that index. Because of this, the index-level setting is not evaluated unless it is explicitly set, regardless of the default value configured for the setting. You can retrieve the current value of the index-level setting by calling the [Index Settings API](../../api-reference/index-apis/get-settings/index.md) and omitting the `?include_defaults` query parameter.
{: .note}
...
- Parent aggregations on [join](../../field-types/supported-field-types/join/index.md) fields. See [this GitHub issue](https://github.com/opensearch-project/OpenSearch/issues/9316) for more information.
