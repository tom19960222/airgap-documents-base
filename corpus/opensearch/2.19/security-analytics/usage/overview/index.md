...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security-analytics/usage/overview.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security-analytics/usage/overview.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security-analytics/usage/overview/"
canonical_url: "https://docs.opensearch.org/latest/security-analytics/usage/overview/"
canonical_route: "/security-analytics/usage/overview/"
redirect_from: []
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/overview.png" alt="The overview page with getting started quick launch window" width="85%">

* In step 1 of setup, select **Create detector** to define a detector.
* In step 2, select **View findings** to go to the Findings page. For details about this page, see [Working with findings](../findings/index.md).
* In step 3, select **View alerts** to go to the Security alerts page. For details about this page, see [Working with alerts](../alerts/index.md).
* In step 4, select **Manage rules** to go to the Rules page. For more on rules, see [Working with rules](../rules/index.md).
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/count.png" alt="A graph showing counts for findings and alerts." width="75%">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/recent-alerts.png" alt="A table showing the most recent alerts." width="50%">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/recent-findings.png" alt="A table showing the most recent findings." width="50%">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/rule_graph.png" alt="The detection rule graph on the Overview page" width="50%">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/Security/detector-overview.png" alt="A table showing available detectors." width="50%">
