...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_security-analytics/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_security-analytics/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/security-analytics/"
canonical_url: "https://docs.opensearch.org/latest/security-analytics/"
canonical_route: "/security-analytics/"
redirect_from: ["/security-analytics/index/"]
...
For information about configuring detectors, see [Creating detectors](sec-analytics-config/detectors-config/index.md).

### Log types

[Log types](sec-analytics-config/log-types/index.md) provide the data used to evaluate events occurring in a system. OpenSearch supports several types of logs and provides out-of-the-box mappings for the most common log sources.
...
For information about configuring rules, see [Working with rules](usage/rules/index.md).
...
To learn more about findings, see [Working with findings](usage/findings/index.md).
...
For information about setting up alerts, see [Creating detectors](sec-analytics-config/detectors-config/index.md). For information about managing alerts in the Alerts window, see [Working with alerts](usage/alerts/index.md).
...
To learn more about defining threat scenarios for correlation rules, see [Creating correlation rules](sec-analytics-config/correlation-config/index.md). To learn more about using the correlation graph, see [Working with the correlation graph](usage/correlation-graph/index.md).

---
## First steps

To get started with Security Analytics, you need to define detectors, ingest log data, generate findings, define correlation rules, and configure alerts. See [Setting up Security Analytics](sec-analytics-config/index.md) to begin configuring the platform to meet your objectives.
