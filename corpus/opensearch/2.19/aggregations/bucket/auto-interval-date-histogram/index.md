...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_aggregations/bucket/auto-interval-date-histogram.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_aggregations/bucket/auto-interval-date-histogram.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/aggregations/bucket/auto-interval-date-histogram/"
canonical_url: "https://docs.opensearch.org/latest/aggregations/bucket/auto-interval-date-histogram/"
canonical_route: "/aggregations/bucket/auto-interval-date-histogram/"
redirect_from: []
...
Similar to the [date histogram aggregation](../date-histogram/index.md), in which you must specify an interval, the `auto_date_histogram` is a multi-bucket aggregation that automatically creates date histogram buckets based on the number of buckets you provide and the time range of your data. The actual number of buckets returned is always less than or equal to the number of buckets you specify. This aggregation is particularly useful when you are working with time-series data and want to visualize or analyze data over different time intervals without manually specifying the interval size.
...
Alternatively, you can specify one of the built-in date [formats](../../../field-types/supported-field-types/date/index.md#formats):
