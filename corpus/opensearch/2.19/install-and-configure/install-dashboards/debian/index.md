...
version: "2.19"
title: "Debian"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_install-and-configure/install-dashboards/debian.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_install-and-configure/install-dashboards/debian.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/install-and-configure/install-dashboards/debian/"
canonical_url: "https://docs.opensearch.org/latest/install-and-configure/install-dashboards/debian/"
canonical_route: "/install-and-configure/install-dashboards/debian/"
redirect_from: []
...
Installing OpenSearch Dashboards using the Advanced Packaging Tool (APT) package manager simplifies the process considerably compared to the [Tarball](../tar/index.md) method. For example, the package manager handles several technical considerations, such as the installation path, location of configuration files, and creation of a service managed by `systemd`.

Before installing OpenSearch Dashboards you must configure an OpenSearch cluster. Refer to the OpenSearch [Debian](../../install-opensearch/debian/index.md) installation guide for steps.
{: .important}
...
1. From the CLI, install using `dpkg`.
   ```bash
   # x64
   sudo dpkg -i opensearch-dashboards-2.19.3-linux-x64.deb
   # arm64
   sudo dpkg -i opensearch-dashboards-2.19.3-linux-arm64.deb
   ```
...
1. Download the desired Debian package.
   ```bash
   curl -SLO https://artifacts.opensearch.org/releases/bundle/opensearch-dashboards/2.19.3/opensearch-dashboards-2.19.3-linux-x64.deb
   ```
1. Download the corresponding signature file.
   ```bash
   curl -SLO https://artifacts.opensearch.org/releases/bundle/opensearch-dashboards/2.19.3/opensearch-dashboards-2.19.3-linux-x64.deb.sig
   ```
...
1. Verify the signature.
   ```bash
   gpg --verify opensearch-dashboards-2.19.3-linux-x64.deb.sig opensearch-dashboards-2.19.3-linux-x64.deb
   ```
...
1. Choose the version of OpenSearch you want to install:
   ...
   sudo apt-get install opensearch-dashboards=2.19.3
   ```
...
1. Visit [Getting started with OpenSearch Dashboards](https://docs.opensearch.org/latest/dashboards/index/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/ --> to learn more.
