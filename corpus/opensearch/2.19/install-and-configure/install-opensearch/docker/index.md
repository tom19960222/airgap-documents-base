...
version: "2.19"
title: "Docker"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_install-and-configure/install-opensearch/docker.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_install-and-configure/install-opensearch/docker.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/install-and-configure/install-opensearch/docker/"
canonical_url: "https://docs.opensearch.org/latest/install-and-configure/install-opensearch/docker/"
canonical_route: "/install-and-configure/install-opensearch/docker/"
redirect_from: ["/opensearch/install/docker/","/install-and-configure/install-opensearch/docker/"]
...
Before installing OpenSearch using Docker, configure the following settings. These are the most important settings that can affect the performance of your services, but for additional information, see [important system settings](../index.md#important-settings){:target='\_blank'}.
...
To download a specific version of OpenSearch or OpenSearch Dashboards other than the latest available version, modify the image tag where it is referenced (either in the command line or in a Docker Compose file). For example, `opensearchproject/opensearch:{{site.opensearch_version}}` will pull OpenSearch version 2.19.3. To pull the latest version, use `opensearchproject/opensearch:latest`. Refer to the official image repositories for available versions.
{: .tip}
...
For a full list of settings, see [Security](../../../security/configuration/index.md).

Use the same process to specify a [Backend configuration](../../../security/configuration/configuration/index.md) in `/usr/share/opensearch/config/opensearch-security/config.yml` as well as new internal users, roles, mappings, action groups, and tenants in their respective [YAML files](../../../security/configuration/yaml/index.md).
...
You can also use a Dockerfile to pass your own certificates for use with the [Security plugin](../../../security/index.md):
```
FROM opensearchproject/opensearch:latest
...
- [Performance analyzer](../../../monitoring-your-cluster/pa/index.md)
- [Install and configure OpenSearch Dashboards](../../install-dashboards/index.md)
- [About Security in OpenSearch](../../../security/index.md)
