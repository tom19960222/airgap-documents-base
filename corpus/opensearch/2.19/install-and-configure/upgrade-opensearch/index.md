...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_install-and-configure/upgrade-opensearch/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_install-and-configure/upgrade-opensearch/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/install-and-configure/upgrade-opensearch/"
canonical_url: "https://docs.opensearch.org/latest/migrate-or-upgrade/"
canonical_route: "/migrate-or-upgrade/"
redirect_from: ["/upgrade-opensearch/index/","/migrate-or-upgrade/","/upgrade-or-migrate/"]
...
If you would like a specific process to be added or would like to contribute, [create an issue](https://github.com/opensearch-project/documentation-website/issues) on GitHub. See the [Contributor Guidelines](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/CONTRIBUTING.md) to learn how you can help.
{: .tip}
...
It's important to determine how the new version of OpenSearch will integrate with your environment. Review [Breaking changes](../../breaking-changes/index.md) before beginning any upgrade procedures to determine whether you will need to make adjustments to your workflow. For example, upstream or downstream components might need to be modified to be compatible with an API change (see meta issue [#2589](https://github.com/opensearch-project/OpenSearch/issues/2589)).

### Reviewing the OpenSearch tools compatibility matrices

If your OpenSearch cluster interacts with other services in your environment, like Logstash or Beats, then you should check the [OpenSearch tools compatibility matrices](../../tools/index.md#compatibility-matrices) to determine whether other components will need to be upgraded.
...
Go to [Available plugins](../plugins/index.md#available-plugins) to see a reference table that highlights version compatibility for bundled OpenSearch plugins.
...
If you use security features, make sure to read [A word of caution](../../security/configuration/security-admin/index.md#a-word-of-caution) for information about backing up and restoring your security settings.

### Creating a snapshot

We recommend that you back up your cluster state and indexes using [snapshots](../../tuning-your-cluster/availability-and-recovery/snapshots/index.md). Snapshots you take before an upgrade can be used as restore points if you need to roll back the cluster to its original version.
...
| :--- | :--- |
| [Amazon Simple Storage Service (Amazon S3)](https://aws.amazon.com/s3/) | [repository-s3](https://github.com/opensearch-project/OpenSearch/tree/2.19.3/plugins/repository-s3) |
| [Google Cloud Storage (GCS)](https://cloud.google.com/storage) | [repository-gcs](https://github.com/opensearch-project/OpenSearch/tree/2.19.3/plugins/repository-gcs) |
| [Apache Hadoop Distributed File System (HDFS)](https://hadoop.apache.org/) | [repository-hdfs](https://github.com/opensearch-project/OpenSearch/tree/2.19.3/plugins/repository-hdfs) |
| [Microsoft Azure Blob Storage](https://azure.microsoft.com/en-us/products/storage/blobs) | [repository-azure](https://github.com/opensearch-project/OpenSearch/tree/2.19.3/plugins/repository-azure) |
...
See [Rolling Upgrade](rolling-upgrade/index.md) for more information about the process.
...
If your upgrade path spans more than a single major version and you want to retain any existing indexes, then you can use the [Reindex](../../api-reference/document-apis/reindex/index.md) API to make your indexes compatible with the target version of OpenSearch before upgrading. For example, if your cluster is currently running Elasticsearch 6.8 and you want to upgrade to OpenSearch 2.x, then you must first upgrade to OpenSearch 1.x, recreate your indexes using the [Reindex](../../api-reference/document-apis/reindex/index.md) API, and finally upgrade to 2.x. One alternative to reindexing is to reingest data from the origin, such as by replaying a data stream or ingesting data from a database.
