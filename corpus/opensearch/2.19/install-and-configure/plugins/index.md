...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_install-and-configure/plugins.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_install-and-configure/plugins.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/install-and-configure/plugins/"
canonical_url: "https://docs.opensearch.org/latest/install-and-configure/plugins/"
canonical_route: "/install-and-configure/plugins/"
redirect_from: ["/opensearch/install/plugins/","/install-and-configure/install-opensearch/plugins/"]
...
If you're running OpenSearch in a Docker container, plugins must be installed, removed, and configured by modifying the Docker image. For more information, see [Working with plugins](../install-opensearch/docker/index.md#working-with-plugins).
{: .note}
...
## List (with CAT API)
You can also list installed plugins by using the [CAT API](../../api-reference/cat/cat-plugins/index.md).
...
There are many more plugins available in addition to those provided by the default distribution. These additional plugins have been built by OpenSearch developers or members of the OpenSearch community. For a list of additional plugins you can install, see [Additional plugins](../additional-plugins/index.md).
...
- [Observability](../../observing-your-data/index.md)
- [Security Analytics](../../security-analytics/index.md)
- [Security](../../security/index.md)
- [Alerting](../../observing-your-data/alerting/index.md)
- [Anomaly detection](../../observing-your-data/ad/index.md)
- [Asynchronous search](../../search-plugins/async/index.md)
- [Cross-cluster replication](../../tuning-your-cluster/replication-plugin/index.md)
- [Index State Management](../../im-plugin/ism/index.md)
- [k-NN search](../../vector-search/vector-search-techniques/index.md)
- [Learning to Rank](../../search-plugins/ltr/index.md)
- [ML Commons](../../ml-commons-plugin/index.md)
- [Neural search](../../vector-search/ai-search/index.md)
- [Notifications](../../observing-your-data/notifications/index.md)
- [OpenSearch Dashboards](https://docs.opensearch.org/latest/dashboards/index/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/ -->
- [Performance Analyzer](../../monitoring-your-cluster/pa/index.md)
- [SQL](../../search-plugins/sql/index.md)
