...
version: "2.19"
title: "Intervals"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_query-dsl/full-text/intervals.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_query-dsl/full-text/intervals.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/query-dsl/full-text/intervals/"
canonical_url: "https://docs.opensearch.org/latest/query-dsl/full-text/intervals/"
canonical_route: "/query-dsl/full-text/intervals/"
redirect_from: []
...
`analyzer` | Optional | String | The [analyzer](../../../analyzers/index.md) used to analyze the `query` text. Default is the analyzer specified for the `<field>`.
...
`analyzer` | Optional | String | The [analyzer](../../../analyzers/index.md) used to normalize the `prefix`. Default is the analyzer specified for the `<field>`.
...
`analyzer` | Optional | String | The [analyzer](../../../analyzers/index.md) used to normalize the `pattern`. Default is the analyzer specified for the `<field>`.
`use_field` | Optional | String | Specifies to search this field instead of the top-level <field>. The `prefix` is normalized using the search analyzer specified for this field, unless you specify an `analyzer`.
...
`analyzer` | Optional | String | The [analyzer](../../../analyzers/index.md) used to normalize the `term`. Default is the analyzer specified for the `<field>`.
