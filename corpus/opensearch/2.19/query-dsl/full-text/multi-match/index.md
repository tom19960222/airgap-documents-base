...
version: "2.19"
title: "Multi-match"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_query-dsl/full-text/multi-match.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_query-dsl/full-text/multi-match.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/query-dsl/full-text/multi-match/"
canonical_url: "https://docs.opensearch.org/latest/query-dsl/full-text/multi-match/"
canonical_route: "/query-dsl/full-text/multi-match/"
redirect_from: []
...
A multi-match operation functions similarly to the [match](../match/index.md) operation. You can use a `multi_match` query to search multiple fields.
...
If you don't provide the `fields` parameter, `multi_match` query searches the fields specified in the `index.query. Default_field` setting, which defaults to `*`. The default behavior is to extract all fields in the mapping that are eligible for [term-level queries](../../term/index.md), filter the metadata fields, and combine all extracted fields to build a query.
...
The preceding query is executed as the following [`dis_max`](../../compound/disjunction-max/index.md) query with a `match` query for each field:
...
The preceding query is executed as the following [`dis_max`](../../compound/disjunction-max/index.md) query with a `match_phrase` query for each field:
...
The preceding query is executed as the following [`dis_max`](../../compound/disjunction-max/index.md) query with a `match_phrase_prefix` query for each field:
...
The `bool_prefix` query scores documents similarly to the [`most_fields`](#most-fields) query but uses a [`match_bool_prefix`](../match-bool-prefix/index.md) query instead of a `match` query.
...
The preceding query is executed as the following [`dis_max`](../../compound/disjunction-max/index.md) query with a `match_bool_prefix` query for each field:
