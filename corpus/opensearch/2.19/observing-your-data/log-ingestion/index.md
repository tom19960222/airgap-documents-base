...
version: "2.19"
title: "Log ingestion"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/log-ingestion.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/log-ingestion.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/log-ingestion/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/log-ingestion/"
canonical_route: "/observing-your-data/log-ingestion/"
redirect_from: ["/observability-plugin/log-analytics/"]
...
OpenSearch Log Ingestion consists of three components---[Data Prepper](https://docs.opensearch.org/latest/clients/data-prepper/index/) <!-- unresolved-jekyll-link: route=/clients/data-prepper/ -->, [OpenSearch](../../getting-started/quickstart/index.md), and [OpenSearch Dashboards](https://docs.opensearch.org/latest/dashboards/index/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/ -->. The Data Prepper repository contains several [sample applications](https://github.com/opensearch-project/data-prepper/tree/main/examples) that you can use to get started.

### Basic flow of data

![Log data flow diagram from a distributed application to OpenSearch](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/la.png)
...
2. [Data Prepper](https://docs.opensearch.org/latest/clients/data-prepper/index/) <!-- unresolved-jekyll-link: route=/clients/data-prepper/ --> receives the log data, transforms the data into a structure format, and indexes it on an OpenSearch cluster.
