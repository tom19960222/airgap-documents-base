...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/query-insights/grouping-top-n-queries.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/query-insights/grouping-top-n-queries.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/query-insights/grouping-top-n-queries/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/query-insights/grouping-top-n-queries/"
canonical_route: "/observing-your-data/query-insights/grouping-top-n-queries/"
redirect_from: []
...
Ensure that top N query monitoring is enabled for at least one of the metrics: latency, CPU, or memory. For more information, see [Configuring top N query monitoring](../top-n-queries/index.md#configuring-top-n-query-monitoring).
...
`top_queries.search_type` | String           | The search request execution type (`query_then_fetch` or `dfs_query_then_fetch`). For more information, see the `search_type` parameter in the [Search API documentation](../../../api-reference/search/index.md#query-parameters).
