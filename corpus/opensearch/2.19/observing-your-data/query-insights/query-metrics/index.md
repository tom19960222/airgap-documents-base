...
version: "2.19"
title: "Query metrics"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/query-insights/query-metrics.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/query-insights/query-metrics.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/query-insights/query-metrics/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/query-insights/query-metrics/"
canonical_route: "/observing-your-data/query-insights/query-metrics/"
redirect_from: []
...
For information about installing the Query Insights plugin, see [Installing the Query Insights plugin](../index.md#installing-the-query-insights-plugin).

### Step 2: Install the OpenTelemetry plugin

For information about installing the OpenTelemetry plugin, see [Distributed tracing](../../trace/distributed-tracing/index.md).
...
Configure the export of metrics and traces using a gRPC exporter. For more information, see [Exporters](../../trace/distributed-tracing/index.md#exporters). You can skip this step if you use the [default logging exporter](#default-logging-exporter):
