...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/alerting/dashboards-alerting.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/alerting/dashboards-alerting.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/alerting/dashboards-alerting/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/alerting/dashboards-alerting/"
canonical_route: "/observing-your-data/alerting/dashboards-alerting/"
redirect_from: []
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/alerting-dashboard.png" alt="Example alerting visualization" width="800" height="800">

## Getting started

Before getting started, you must have:

- Installed OpenSearch and OpenSearch Dashboards version 2.9 or later. See [Installing OpenSearch](../../../install-and-configure/install-opensearch/index.md).
- Installed the Alerting and Notifications Dashboards plugins. See [Managing OpenSearch Dashboards plugins](../../../install-and-configure/install-dashboards/plugins/index.md) to get started.
...
4. From the visualization panel, choose the ellipsis icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ellipsis-icon.png" class="inline-icon" alt="ellipsis icon"/>).
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/create-monitor-menu.png" alt="Create monitor interface" width="400" height="400">
...
1. From the visualization panel, choose the ellipsis icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ellipsis-icon.png" class="inline-icon" alt="ellipsis icon"/>).
...
1. Open the alerting dashboard. Alerts are indicated on the visualization with a triangle icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/triangle-icon.png" class="inline-icon" alt="triangle icon"/>).
2. Hover over the triangle icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/triangle-icon.png" class="inline-icon" alt="triangle icon"/>) to view high-level data, such as number of alerts. To investigate alert details, select the triangle icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/triangle-icon.png" class="inline-icon" alt="triangle icon"/>) to open a flyout with more detailed monitor information. Alternatively, select the ellipsis icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ellipsis-icon.png" class="inline-icon" alt="ellipsis icon"/>) in the visualization panel and choose **View events**.
3. Select the ellipsis icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ellipsis-icon.png" class="inline-icon" alt="ellipsis icon"/>), then **Alerting** > **Associated monitors**.
...
5. Unlink or edit a monitor.
   1. Unlink a monitor from the visualization by selecting the link icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/link-icon.png" class="inline-icon" alt="link icon"/>) under **Actions**. This only unlinks the monitor from the visualization; it does not delete the monitor.
   2. Edit the monitor's metrics by selecting the edit icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/edit-icon.png" class="inline-icon" alt="edit icon"/>).

## Next steps

- [Learn more about the Dashboard application](https://docs.opensearch.org/latest/dashboards/dashboard/index/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/dashboard/ -->.
- [Learn more about alerting](../index.md).
