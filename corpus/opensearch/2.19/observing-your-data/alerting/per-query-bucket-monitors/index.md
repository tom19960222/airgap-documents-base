...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/alerting/per-query-bucket-monitors.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/alerting/per-query-bucket-monitors.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/alerting/per-query-bucket-monitors/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/alerting/per-query-bucket-monitors/"
canonical_route: "/observing-your-data/alerting/per-query-bucket-monitors/"
redirect_from: []
...
Both monitor types support querying remote indexes using the same `cluster-name:index-name` pattern used by [cross-cluster search](../../../search-plugins/cross-cluster-search/index.md) or by using OpenSearch Dashboards 2.12 or later.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/alerting/cross-cluster-per-query-per-bucket-monitors.png" alt="Cluster metrics monitor" width="700"/>

## Creating a per query or per bucket monitor

To create a per query monitor, follow these steps:

**Step 1.** Define your query and [triggers](../triggers/index.md). You can use any of these methods: visual editor, query editor, or anomaly detector.
   ...
   - Query definition provides flexibility in relation to your query (using [OpenSearch query DSL](../../../query-dsl/full-text/index.md)) and how you evaluate the results of that query (Painless scripting).
...
"Start" and "end" refer to the interval at which the monitor runs. See [Monitor variables](../monitors/index.md#monitor-variables).
...
If you use the Security plugin, you can only choose indexes that you have permission to access. For details, see [Alerting security](../../../security/index.md).

To use a query, choose **Extraction query editor**, add your query (using [OpenSearch query DSL](../../../query-dsl/full-text/index.md)), and test it using the **Run** button.
...
The anomaly detection option is for pairing with the Anomaly Detection plugin. See [Anomaly Detection](../../ad/index.md).
...
**Step 2.** Choose the frequency to run the monitor, for example, either by time intervals (minutes, hours, days) or on a schedule. If you run it by time interval or on a custom [custom cron expression](../cron/index.md), then you must provide the time zone.
