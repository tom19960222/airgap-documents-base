...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/event-analytics.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/event-analytics.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/event-analytics/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/event-analytics/"
canonical_route: "/observing-your-data/event-analytics/"
redirect_from: ["/observability-plugin/event-analytics/"]
...
Event analytics in OpenSearch Observability allow you to create data visualizations using [Piped Processing Language](../../search-plugins/sql/ppl/index.md) (PPL) queries.
...
For more information about building PPL queries, see [Piped Processing Language](../../search-plugins/sql/ppl/index.md).
...
![Sample OpenSearch Query Assist screen view](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/log-explorer-query-assist.png)
...
After Dashboards generates a visualization, save it if you want to revisit it or include it in an [operational panel](../operational-panels/index.md). To save a visualization, expand the **Save** dropdown menu in the upper-right corner, enter a name for the visualization, and then select the **Save** button. You can reopen saved visualizations on the event analytics page.
...
![Demo of creating event analytics visualizations and adding them to a dashboard](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/event-analytics-dashboard.gif)

### Limitations of event analytics visualizations

Event analytics visualizations currently do not support [Dashboards Query Language (DQL)](https://docs.opensearch.org/latest/dashboards/discover/dql/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/discover/dql/ --> or [query domain-specific language (DSL)](../../query-dsl/index.md), and they do not use index patterns. Note the following limitations:
...
If you regularly track events across applications, you can correlate logs and traces. To view correlations, you must index the traces according to OpenTelemetry standards, similarly to [trace analytics](../trace/index.md). Once you add a `TraceId` field to your logs, you can view the correlated trace information in the event explorer log details. This method correlates logs and traces that correspond to the same execution context. The following demo shows this feature in action.

![Trace Log Correlation](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace_log_correlation.gif)
...
![Surrounding Events](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/surrounding_events.gif)
...
![Live Tail](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/live_tail.gif)
