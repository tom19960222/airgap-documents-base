...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/trace/getting-started.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/trace/getting-started.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/trace/getting-started/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/trace/getting-started/"
canonical_route: "/observing-your-data/trace/getting-started/"
redirect_from: ["/observability-plugin/trace/get-started/","/monitoring-plugins/trace/get-started/"]
...
![Data flow diagram from a distributed application to OpenSearch](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ta.svg)
...
1. [Data Prepper](https://docs.opensearch.org/latest/clients/data-prepper/index/) <!-- unresolved-jekyll-link: route=/clients/data-prepper/ --> processes the OpenTelemetry data, transforms it for use in OpenSearch, and indexes it on an OpenSearch cluster.

1. The [Trace Analytics OpenSearch Dashboards plugin](../ta-dashboards/index.md) displays the data in near real-time as a series of charts and tables, with an emphasis on service architecture, latency, error rate, and throughput.
...
![HotROD web interface](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/hot-rod.png)
...
If you don't see your trace, adjust the timeframe in OpenSearch Dashboards. For more information on using the plugin, see [OpenSearch Dashboards plugin](../ta-dashboards/index.md).
