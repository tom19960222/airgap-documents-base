...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_observing-your-data/trace/ta-dashboards.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_observing-your-data/trace/ta-dashboards.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/observing-your-data/trace/ta-dashboards/"
canonical_url: "https://docs.opensearch.org/latest/observing-your-data/trace/ta-dashboards/"
canonical_route: "/observing-your-data/trace/ta-dashboards/"
redirect_from: ["/observability-plugin/trace/ta-dashboards/","/monitoring-plugins/trace/ta-dashboards/"]
...
See [Standalone OpenSearch Dashboards plugin install](../../../install-and-configure/install-dashboards/plugins/index.md) for instructions on how to install the Trace Analytics plugin.
...
The plugin requires you to use [Data Prepper](https://docs.opensearch.org/latest/data-prepper/) <!-- unresolved-jekyll-link: route=/data-prepper/ --> to process and visualize OTel data and relies on the following Data Prepper pipelines for OTel correlations and service map calculations:

- [Trace analytics pipeline](https://docs.opensearch.org/latest/data-prepper/common-use-cases/trace-analytics/) <!-- unresolved-jekyll-link: route=/data-prepper/common-use-cases/trace-analytics/ -->
- [Service map pipeline](https://docs.opensearch.org/latest/data-prepper/pipelines/configuration/processors/service-map/) <!-- unresolved-jekyll-link: route=/data-prepper/pipelines/configuration/processors/service-map/ -->

### Standardized telemetry data

The plugin requires telemetry data to follow the OTel schema conventions, including the structure and naming of spans, traces, and metrics as specified by OTel, and to be implemented using the [Simple Schema for Observability](../../ss4o/index.md).
...
Navigating from the service dialog to its corresponding traces or logs requires the existence of correlating fields and that the target indexes (for example, logs) follow the specified naming conventions, as described at [Simple Schema for Observability](../../ss4o/index.md).
...
- **Services table**
  ...
  ![Services table](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/services-table.png)

  - General-purpose filter selection is used for field or filter composition. The following image shows this filter.

  ![Services filter selection](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/services-filter-selection.png)
  ...
  ![Services throughput tooltip ](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/service-throughput-tooltip.png)
  ...
  ![Services correlation dialog window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/single-service-correlation-dialog.png)
  ...
  ![Services RED metrics for duration](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/single-service-RED-metrics.png)
  ...
  ![Services Span details dialog window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/span-details-fly-out.png)
...
- **Service map**
  ...
  ![Services map tooltip](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/service-details-tooltip.png)
  ...
  ![Service map dialog window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/single-service-fly-out.png)
...
- **Trace groups**
  ...
  ![Trace Groups window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/trace-analytics/trace-group-RED-metrics.png)
  ...
  ![Trace group dialog window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ta-dashboard.png)
  ...
  ![Trace details window](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ta-trace.png)
