...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_api-reference/snapshots/create-repository.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_api-reference/snapshots/create-repository.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/api-reference/snapshots/create-repository/"
canonical_url: "https://docs.opensearch.org/latest/api-reference/snapshots/create-repository/"
canonical_route: "/api-reference/snapshots/create-repository/"
redirect_from: []
...
* File system (`fs`): For instructions on creating an `fs` repository, see [Register repository shared file system](../../../tuning-your-cluster/availability-and-recovery/snapshots/snapshot-restore/index.md#shared-file-system).

* Amazon Simple Storage Service (Amazon S3) bucket (`s3`): For instructions on creating an `s3` repository, see [Register repository Amazon S3](../../../tuning-your-cluster/availability-and-recovery/snapshots/snapshot-restore/index.md#amazon-s3).

For instructions on creating a repository, see [Register repository](../../../tuning-your-cluster/availability-and-recovery/snapshots/snapshot-restore/index.md#register-repository).
...
`shallow_snapshot_v2` | Boolean | Determines whether the snapshots of the remote store indexes are captured as a [shallow copy v2](../../../tuning-your-cluster/availability-and-recovery/remote-store/snapshot-interoperability/index.md#shallow-snapshot-v2). Default is `false`.
...
To verify that the repository was registered, use the [Get snapshot repository](../get-snapshot-repository/index.md) API, passing the repository name as the `repository` path parameter.
{: .note}
