...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_api-reference/snapshots/restore-snapshot.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_api-reference/snapshots/restore-snapshot.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/api-reference/snapshots/restore-snapshot/"
canonical_url: "https://docs.opensearch.org/latest/api-reference/snapshots/restore-snapshot/"
canonical_route: "/api-reference/snapshots/restore-snapshot/"
redirect_from: []
...
* For information about indices and clusters, see [Introduction to OpenSearch](../../../about/index.md).

* For information about data streams, see [Data streams](../../../im-plugin/data-streams/index.md).

If open indexes with the same name that you want to restore already exist in the cluster, you must close, delete, or rename the indexes. See [Example request](#example-request) for information about renaming an index. See [Close index](../../index-apis/close-index/index.md) for information about closing an index.
{: .note}
...
````
Except for the snapshot name, all properties are empty or `0`. This is because any changes made to the volume after the snapshot was generated are lost. However, if you invoke the [Get snapshot](../get-snapshot/index.md) API to examine the snapshot, a fully populated snapshot object is returned.
