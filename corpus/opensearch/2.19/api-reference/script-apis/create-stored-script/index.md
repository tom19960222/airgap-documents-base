...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_api-reference/script-apis/create-stored-script.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_api-reference/script-apis/create-stored-script.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/api-reference/script-apis/create-stored-script/"
canonical_url: "https://docs.opensearch.org/latest/api-reference/script-apis/create-stored-script/"
canonical_route: "/api-reference/script-apis/create-stored-script/"
redirect_from: []
...
* [k-NN Painless Scripting extensions](../../../vector-search/vector-search-techniques/painless-functions/index.md).

* [k-NN](../../../vector-search/vector-search-techniques/index.md).
...
| source | String or Object | Required. <br /> <br /> For scripts, a string with the contents of the script. <br /> <br /> For search templates, an object that defines the search template. Supports the same parameters as the [Search](../../search/index.md) API request body. Search templates also support Mustache variables. |
...
See [Execute Painless stored script](../exec-stored-script/index.md) for information about running the script.
...
To determine whether the script was successfully created, use the [Get stored script](../get-stored-script/index.md) API, passing the script name as the `script` path parameter.
{: .note}
