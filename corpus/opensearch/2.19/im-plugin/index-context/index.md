...
version: "2.19"
title: "Index context"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_im-plugin/index-context.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_im-plugin/index-context.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/im-plugin/index-context/"
canonical_url: "https://docs.opensearch.org/latest/im-plugin/index-context/"
canonical_route: "/im-plugin/index-context/"
redirect_from: ["/opensearch/index-context/"]
...
- Accurate mappings and aliases based on [OpenSearch Integrations](../../integrations/index.md)
...
1. Install the `opensearch-system-templates` plugin on all nodes in your cluster using one of the [installation methods](../../install-and-configure/plugins/index.md#install).

2. Set the feature flag `opensearch.experimental.feature.application_templates.enabled` to `true`. For more information about enabling and disabling feature flags, see [Enabling experimental features](../../install-and-configure/configuring-opensearch/experimental/index.md).

3. Set the `cluster.application_templates.enabled` setting to `true`. For instructions on how to configure OpenSearch, see [configuring settings](../../install-and-configure/configuring-opensearch/index.md#static-settings).
