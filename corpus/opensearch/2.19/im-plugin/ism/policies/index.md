...
version: "2.19"
title: "Policies"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_im-plugin/ism/policies.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_im-plugin/ism/policies.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/im-plugin/ism/policies/"
canonical_url: "https://docs.opensearch.org/latest/im-plugin/ism/policies/"
canonical_route: "/im-plugin/ism/policies/"
redirect_from: []
...
For a list of available unit types, see [Supported units](../../../api-reference/units/index.md).
...
`wait_for_completion` | Boolean | When set to `false`, the request returns immediately instead of after the operation is finished. To monitor the operation status, use the [Tasks API](../../../api-reference/tasks/tasks/index.md) with the task ID returned by the request. Default is `true`.
...
For information about setting replicas, see [Primary and replica shards](../../../getting-started/intro/index.md#primary-and-replica-shards).
...
If you want to add `aliases` to the action, the parameter must include an array of [alias objects](../../../api-reference/index-apis/alias/index.md). For example,
...
Back up your cluster’s indexes and state. For more information about snapshots, see [Take and restore snapshots](../../../tuning-your-cluster/availability-and-recovery/snapshots/snapshot-restore/index.md).
...
Allocate the index to a node with a specific attribute set [like this](../../../tuning-your-cluster/index.md#advanced-step-7-set-up-a-hot-warm-architecture).
...
[Index rollup](../../index-rollups/index.md) lets you periodically reduce data granularity by rolling up old data into summarized indexes.
...
Request fields are required when creating an ISM policy. You can reference the [Index rollups API](../../index-rollups/rollup-api/index.md#create-or-update-an-index-rollup-job) page for request field options.
...
- You can reference the [Index rollups API](../../index-rollups/rollup-api/index.md#create-or-update-an-index-rollup-job) page to configure the rollup policy.
...
For information on writing cron expressions, see [Cron expression reference](../../../observing-your-data/alerting/cron/index.md).
...
It notifies a single destination or [notification channel](../../../observing-your-data/notifications/index.md) with a custom message.
...
![Policy State Machine](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ism.png)
