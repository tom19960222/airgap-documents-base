...
version: "2.19"
title: "Index codecs"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_im-plugin/index-codecs.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_im-plugin/index-codecs.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/im-plugin/index-codecs/"
canonical_url: "https://docs.opensearch.org/latest/im-plugin/index-codecs/"
canonical_route: "/im-plugin/index-codecs/"
redirect_from: []
...
As of OpenSearch 2.10, the `zstd` and `zstd_no_dict` compression codecs cannot be used for [k-NN](../../vector-search/vector-search-techniques/index.md) or [Security Analytics](../../security-analytics/index.md) indexes.
{: .warning}
...
The [Split API](../../api-reference/index-apis/split/index.md) splits an original index into a new index where each original primary shard is divided into two or more primary shards. The [Shrink API](../../api-reference/index-apis/shrink-index/index.md) shrinks an existing index to a new index with a smaller number of primary shards. As part of split or shrink operations, any newly created segments will use the latest codec settings.

### Snapshots

When creating a [snapshot](../../tuning-your-cluster/availability-and-recovery/snapshots/index.md), the index codec setting influences the size of the snapshot and the time required for its creation. If the codec of an index is updated, newly created snapshots will use the latest codec setting. The resulting snapshot size will reflect the compression characteristics of the latest codec setting. Existing segments included in the snapshot will retain their original compression characteristics.
...
When you are performing a [reindex](../reindex-data/index.md) operation from a source index, the new segments created in the target index will have the properties of the codec settings of the target index.

### Index rollups and transforms

When an index [rollup](../index-rollups/index.md) or [transform](../index-transforms/index.md) job is completed, the segments created in the target index will have the properties of the index codec specified during target index creation, irrespective of the source index codec. If the target index is created dynamically through a rollup job, the default codec is used for segments of the target index.
