...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_im-plugin/index-rollups/rollup-api.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_im-plugin/index-rollups/rollup-api.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/im-plugin/index-rollups/rollup-api/"
canonical_url: "https://docs.opensearch.org/latest/im-plugin/index-rollups/rollup-api/"
canonical_route: "/im-plugin/index-rollups/rollup-api/"
redirect_from: []
...
`dimensions` | Specify aggregations to create dimensions for the roll up time window. Supported groups are `terms`, `histogram`, and `date_histogram`. For more information, see [Bucket Aggregations](../../../aggregations/bucket/index.md). | Array | Yes
`metrics` | Specify a list of objects that represent the fields and metrics that you want to calculate. Supported metrics are `sum`, `max`, `min`, `value_count` and `avg`. For more information, see [Metric Aggregations](../../../aggregations/metric/index.md). | Array | No
