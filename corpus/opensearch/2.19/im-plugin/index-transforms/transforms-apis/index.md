...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_im-plugin/index-transforms/transforms-apis.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_im-plugin/index-transforms/transforms-apis.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/im-plugin/index-transforms/transforms-apis/"
canonical_url: "https://docs.opensearch.org/latest/im-plugin/index-transforms/transforms-apis/"
canonical_route: "/im-plugin/index-transforms/transforms-apis/"
redirect_from: []
...
data_selection_query | Object | The query DSL to use to filter a subset of the source index for the transform job. See [query domain-specific language(DSL)](../../../query-dsl/index.md) for more information. | Yes
...
groups | Array | Specifies the grouping(s) to use in the transform job. Supported groups are `terms`, `histogram`, and `date_histogram`. For more information, see [Bucket Aggregations](../../../aggregations/bucket/index.md). | Yes if not using aggregations.
source_field | String | The field(s) to transform. | Yes
aggregations | Object | The aggregations to use in the transform job. Supported aggregations are `sum`, `max`, `min`, `value_count`, `avg`, `scripted_metric`, and `percentiles`. For more information, see [Metric Aggregations](../../../aggregations/metric/index.md). | Yes if not using groups.
