...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ingest-pipelines/pipeline-failures.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ingest-pipelines/pipeline-failures.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ingest-pipelines/pipeline-failures/"
canonical_url: "https://docs.opensearch.org/latest/ingest-pipelines/pipeline-failures/"
canonical_route: "/ingest-pipelines/pipeline-failures/"
redirect_from: ["/api-reference/ingest-apis/pipeline-failures/"]
...
If the processor fails, OpenSearch logs the failure and continues to run all remaining processors in the search pipeline. To check whether there were any failures, you can use [ingest pipeline metrics](index.md#ingest-pipeline-metrics).
{: tip}

## Ingest pipeline metrics

To view ingest pipeline metrics, use the [Nodes Stats API](../../api-reference/nodes-apis/nodes-stats/index.md):
