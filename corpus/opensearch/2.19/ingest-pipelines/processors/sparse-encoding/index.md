...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ingest-pipelines/processors/sparse-encoding.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ingest-pipelines/processors/sparse-encoding.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ingest-pipelines/processors/sparse-encoding/"
canonical_url: "https://docs.opensearch.org/latest/ingest-pipelines/processors/sparse-encoding/"
canonical_route: "/ingest-pipelines/processors/sparse-encoding/"
redirect_from: ["/api-reference/ingest-apis/processors/sparse-encoding/"]
...
The `sparse_encoding` processor is used to generate a sparse vector/token and weights from text fields for [neural sparse search](../../../vector-search/ai-search/neural-sparse-search/index.md) using sparse retrieval.

**PREREQUISITE**<br>
Before using the `sparse_encoding` processor, you must set up a machine learning (ML) model. For more information, see [Choosing a model](../../../ml-commons-plugin/integrating-ml-models/index.md#choosing-a-model).
{: .note}
...
|:---|:---|:---|:---|
`model_id` | String | Required | The ID of the model that will be used to generate the embeddings. The model must be deployed in OpenSearch before it can be used in neural search. For more information, see [Using custom models within OpenSearch](../../../ml-commons-plugin/using-ml-models/index.md) and [Neural sparse search](../../../vector-search/ai-search/neural-sparse-search/index.md).
...
Once you have created an ingest pipeline, you need to create an index for ingestion and ingest documents into the index. To learn more, see [Create an index for ingestion](../../../vector-search/ai-search/neural-sparse-with-pipelines/index.md#step-2b-create-an-index-for-ingestion) and [Step 3: Ingest documents into the index](../../../vector-search/ai-search/neural-sparse-with-pipelines/index.md#step-2c-ingest-documents-into-the-index) of [Neural sparse search](../../../vector-search/ai-search/neural-sparse-search/index.md).

---

## Next steps

- To learn how to use the `neural_sparse` query for a sparse search, see [Neural sparse query](../../../query-dsl/specialized/neural-sparse/index.md).
- To learn more about sparse search, see [Neural sparse search](../../../vector-search/ai-search/neural-sparse-search/index.md).
