...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_ingest-pipelines/processors/text-image-embedding.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_ingest-pipelines/processors/text-image-embedding.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/ingest-pipelines/processors/text-image-embedding/"
canonical_url: "https://docs.opensearch.org/latest/ingest-pipelines/processors/text-image-embedding/"
canonical_route: "/ingest-pipelines/processors/text-image-embedding/"
redirect_from: ["/api-reference/ingest-apis/processors/text-image-embedding/"]
...
The `text_image_embedding` processor is used to generate combined vector embeddings from text and image fields for [multimodal neural search](../../../vector-search/ai-search/multimodal-search/index.md).

**PREREQUISITE**<br>
Before using the `text_image_embedding` processor, you must set up a machine learning (ML) model. For more information, see [Choosing a model](../../../ml-commons-plugin/integrating-ml-models/index.md#choosing-a-model).
{: .note}
...
|:---|:---|:---|:---|
`model_id` | String | Required | The ID of the model that will be used to generate the embeddings. The model must be deployed in OpenSearch before it can be used in neural search. For more information, see [Using custom models within OpenSearch](../../../ml-commons-plugin/using-ml-models/index.md) and [Multimodal search](../../../vector-search/ai-search/multimodal-search/index.md).
...
Once you have created an ingest pipeline, you need to create an index for ingestion and ingest documents into the index. To learn more, see [Step 2: Create an index for ingestion](../../../vector-search/ai-search/multimodal-search/index.md#step-2-create-an-index-for-ingestion) and [Step 3: Ingest documents into the index](../../../vector-search/ai-search/multimodal-search/index.md#step-3-ingest-documents-into-the-index) of [Multimodal search](../../../vector-search/ai-search/multimodal-search/index.md).

## Next steps

- To learn how to use the `neural` query for a multimodal search, see [Neural query](../../../query-dsl/specialized/neural/index.md).
- To learn more about multimodal search, see [Multimodal search](../../../vector-search/ai-search/multimodal-search/index.md).
