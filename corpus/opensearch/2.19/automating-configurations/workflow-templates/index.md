...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_automating-configurations/workflow-templates.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_automating-configurations/workflow-templates.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/automating-configurations/workflow-templates/"
canonical_url: "https://docs.opensearch.org/latest/automating-configurations/workflow-templates/"
canonical_route: "/automating-configurations/workflow-templates/"
redirect_from: []
...
You can specify a workflow template when you call the [Create Workflow API](../api/create-workflow/index.md):
...
- To use a custom workflow template, provide the complete template in the request body. For an example of a custom template, see [an example JSON template](../api/create-workflow/index.md#example-request-register-and-deploy-a-remote-model-json) or [an example YAML template](../api/create-workflow/index.md#example-request-register-and-deploy-an-externally-hosted-model-yaml).
...
To perform a vector search on your index, use a [`neural` query](../../query-dsl/specialized/neural/index.md) clause:
...
The workflow you created provisioned all the necessary resources for semantic search. To view the provisioned resources, call the [Get Workflow Status API](../api/get-workflow-status/index.md) and provide the `workflowID` for your workflow:
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md).
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md) with a default model for neural queries.

- **Use case**: `semantic_search_with_query_enricher`
- **Created components**:
  - An ingest pipeline with a `text_embedding` processor
  - A vector index configured with the pipeline
  - A [`query_enricher`](../../search-plugins/search-pipelines/neural-query-enricher/index.md) search processor that sets a default model ID for neural queries.
- **Required parameters**:
  - `create_ingest_pipeline.model_id`: The model ID of the text embedding model to be used
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md) and deploys a pretrained model.
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md) and deploys a Cohere embedding model.
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md), deploys a Cohere embedding model, and adds a query enricher search processor.
...
This workflow configures [semantic search](../../vector-search/ai-search/semantic-search/index.md) with a Cohere embedding model and reindexes an existing index.
...
The following workflow template configures [neural sparse search](../../vector-search/ai-search/neural-sparse-search/index.md).

### Neural sparse search

This workflow configures [neural sparse search](../../vector-search/ai-search/neural-sparse-search/index.md).
...
The following workflow templates configure [multimodal search](../../vector-search/ai-search/multimodal-search/index.md).

### Multimodal search

This workflow configures [multimodal search](../../vector-search/ai-search/multimodal-search/index.md).
...
The following workflow templates configure [hybrid search](../../vector-search/ai-search/hybrid-search/index.md).

### Hybrid search

This workflow configures [hybrid search](../../vector-search/ai-search/hybrid-search/index.md).
...
The following workflow template configures [conversational search with RAG](../../vector-search/ai-search/conversational-search/index.md).
