...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_automating-configurations/workflow-tutorial.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_automating-configurations/workflow-tutorial.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/automating-configurations/workflow-tutorial/"
canonical_url: "https://docs.opensearch.org/latest/automating-configurations/workflow-tutorial/"
canonical_route: "/automating-configurations/workflow-tutorial/"
redirect_from: []
...
You can automate the setup of common use cases, such as conversational chat, using a Chain-of-Thought (CoT) agent. An _agent_ orchestrates and runs ML models and tools. A _tool_ performs a set of specific tasks. This page presents a complete example of setting up a CoT agent. For more information about agents and tools, see [Agents and tools](../../ml-commons-plugin/index.md)
...
![Example workflow steps graph](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/automatic-workflow-dag.png){:style="width: 100%; max-width: 600px;" class="img-centered"}
...
When registering a model, the `previous_node_inputs` field tells OpenSearch to obtain the required `connector_id` from the output of the `create_connector_1` step. Other inputs required by the [Register Model API](../../ml-commons-plugin/api/model-apis/register-model/index.md) are included in the `user_inputs` field:
...
The [Deploy Model API](../../ml-commons-plugin/api/model-apis/deploy-model/index.md) requires the `model_id` from the previous step, as specified in the `previous_node_inputs` field:
...
When using the Deploy Model API directly, a task ID is returned, requiring use of the [Tasks API](../../ml-commons-plugin/api/tasks-apis/get-task/index.md) to determine when the deployment is complete. The automated workflow eliminates the manual status check and returns the final `model_id` directly.
...
A CoT agent can use the deployed model in a tool. This step doesn’t strictly correspond to an API but represents a component of the body required by the [Register Agent API](../../ml-commons-plugin/index.md). This simplifies the register request and allows reuse of the same tool in multiple agents. For more information about agents and tools, see [Agents and tools](../../ml-commons-plugin/index.md).
...
To learn more about agents and tools, see [Agents and tools](../../ml-commons-plugin/index.md).
