...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tutorials/vector-search/neural-search-tutorial.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tutorials/vector-search/neural-search-tutorial.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tutorials/vector-search/neural-search-tutorial/"
canonical_url: "https://docs.opensearch.org/latest/tutorials/vector-search/neural-search-tutorial/"
canonical_route: "/tutorials/vector-search/neural-search-tutorial/"
redirect_from: ["/ml-commons-plugin/semantic-search/","/search-plugins/neural-search-tutorial/","/vector-search/tutorials/neural-search-tutorial/"]
...
- [Pretrained language models provided by OpenSearch](../../../ml-commons-plugin/pretrained-models/index.md)
- [Ingest pipeline](../../../api-reference/ingest-apis/index.md)
- [k-NN vector](../../../field-types/supported-field-types/knn-vector/index.md)
- [Search pipeline](../../../search-plugins/search-pipelines/index.md)
- [Normalization processor](../../../search-plugins/search-pipelines/normalization-processor/index.md)
- [Hybrid query](../../../query-dsl/compound/hybrid/index.md)
...
For a [custom local model](../../../ml-commons-plugin/custom-local-models/index.md) setup, note the following requirements:
...
For more information about ML-related cluster settings, see [ML Commons cluster settings](../../../ml-commons-plugin/cluster-settings/index.md).

## Tutorial

This tutorial consists of the following steps:

1. [Choose a model for embedding generation](index.md#step-1-choose-a-model)
2. [Register and deploy the model](index.md#step-2-register-and-deploy-the-model)
3. [Ingest data](index.md#step-3-ingest-data)
4. [Search the data](index.md#step-4-search-the-data)

You can follow this tutorial by using your command line or the OpenSearch Dashboards [Dev Tools console](https://docs.opensearch.org/latest/dashboards/dev-tools/run-queries/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/dev-tools/run-queries/ -->.
...
- Use any other pretrained model provided by OpenSearch. For more information, see [OpenSearch-provided pretrained models](../../../ml-commons-plugin/pretrained-models/index.md).
...
- Connect to a foundation model hosted on an external platform. For more information, see [Connecting to remote models](../../../ml-commons-plugin/remote-models/index.md).
...
For more information, see [Using ML models within OpenSearch](../../../ml-commons-plugin/using-ml-models/index.md).
...
You can also receive statistics for all deployed models in your cluster by sending a [Models Profile API](../../../ml-commons-plugin/api/profile/index.md) request:
...
Now that you have deployed a model, you can use this model to configure an [ingest pipeline](../../../api-reference/ingest-apis/index.md) that contains one processor: a task that transforms document fields before documents are ingested into an index. In this example, you'll set up a `text_embedding` processor that creates vector embeddings from text. You'll need the `model_id` of the model you set up in the previous section and a `field_map`, which specifies the name of the field from which to take the text (`text`) and the name of the field in which to record embeddings (`passage_embedding`):
...
Now you'll create a vector index with a field named `text`, which contains an image description, and a [`knn_vector`](../../../field-types/supported-field-types/knn-vector/index.md) field named `passage_embedding`, which contains the vector embedding of the text. Additionally, set the default ingest pipeline to the `nlp-ingest-pipeline` you created in the previous step:
...
Hybrid search combines keyword and semantic search to improve search relevance. To implement hybrid search, you need to set up a [search pipeline](../../../search-plugins/search-pipelines/index.md) that runs at search time. The search pipeline you'll configure intercepts search results at an intermediate stage and applies the [`normalization-processor`](../../../search-plugins/search-pipelines/normalization-processor/index.md) to them. The `normalization-processor` normalizes and combines the document scores from multiple query clauses, rescoring the documents according to the chosen normalization and combination techniques.
...
You'll use the [`hybrid` query](../../../query-dsl/compound/hybrid/index.md) to combine the `match` and `neural` query clauses. Make sure to apply the previously created `nlp-search-pipeline` to the request in the query parameter:
...
You can now experiment with different weights, normalization techniques, and combination techniques. For more information, see the [`normalization-processor`](../../../search-plugins/search-pipelines/normalization-processor/index.md) and [`hybrid` query](../../../query-dsl/compound/hybrid/index.md) documentation.

#### Advanced

You can parameterize the search by using search templates. Search templates hide implementation details, reducing the number of nested levels and thus the query complexity. For more information, see [search templates](../../../api-reference/search-template/index.md).

## Using automated workflows

You can quickly set up semantic or hybrid search using [_automated workflows_](../../../automating-configurations/index.md). This approach automatically creates and provisions all necessary resources. For more information, see [Workflow templates](../../../automating-configurations/workflow-templates/index.md).

### Automated semantic search setup

OpenSearch provides a [workflow template](../../../automating-configurations/workflow-templates/index.md) that automatically registers and deploys a default local model (`huggingface/sentence-transformers/paraphrase-MiniLM-L3-v2`) and creates an ingest pipeline and a vector index:
...
- Explore [AI search](../../../vector-search/ai-search/index.md) in OpenSearch.
