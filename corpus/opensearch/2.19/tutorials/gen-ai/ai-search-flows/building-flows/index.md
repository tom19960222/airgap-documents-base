...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tutorials/gen-ai/ai-search-flows/building-flows.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tutorials/gen-ai/ai-search-flows/building-flows.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tutorials/gen-ai/ai-search-flows/building-flows/"
canonical_url: "https://docs.opensearch.org/latest/vector-search/ai-search/workflow-builder/"
canonical_route: "/vector-search/ai-search/workflow-builder/"
redirect_from: ["/tutorials/ai-search-flows/building-flows/"]
...
This tutorial shows you how to build automated AI search workflows in OpenSearch Dashboards. For more information, see [Building AI search workflows in OpenSearch Dashboards](../../../../vector-search/ai-search/workflow-builder/index.md).

## Prerequisite: Provision ML resources

Before you start, select and provision the necessary machine learning (ML) resources depending on your use case. For example, to implement semantic search, you must configure a text embedding model in your OpenSearch cluster. For more information about deploying ML models locally or connecting to externally hosted models, see [Integrating ML models](../../../../ml-commons-plugin/integrating-ml-models/index.md).
...
![OpenSearch Flow template page](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/presets-page.png)
...
1. Ingest and search configuration forms: Used to configure ingest and search pipelines. An example ingest configuration is shown in the following image.
    ...
    ![Form](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/form.png)
...
2. **Preview** workspace: A read-only visual helper that displays the flow of data and transformations during ingestion and search, as shown in the following image.
    ...
    ![Workspace](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/workspace.png)
...
3. **Inspector**: Similar to an integrated development environment (IDE), the **Inspector** displays workflow execution details, responses from the ingest/search operations, errors, and created resources, as shown in the following image.
    ...
    ![Inspector](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/inspector.png)
...
4. Buttons: Manage your workflow by undoing changes, saving progress, exporting the configuration, or exiting, as shown in the following image.
    ...
    ![Buttons](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/buttons.png)
...
![import-data-populated](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/import-data-populated.png)
...
![enrich-data](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/enrich-data.png)
...
![ml-config-ingest](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/ml-config-ingest.png)

This mapping is necessary for configuring the `input_map` and `output_map` configuration settings of the [ML inference ingest processors](../../../../ingest-pipelines/processors/ml-inference/index.md).
...
![expression-ingest](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/expression-ingest.png)
...
![expression-modal-ingest-validated](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/expression-modal-ingest-validated.png)
...
For more information, see [Creating a vector index](../../../../vector-search/creating-vector-index/index.md).

For built-in use cases, some of this information is automatically populated, as shown in the following image.

![index-settings-updated](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/index-settings-updated.png)
...
![build-and-run-ingestion-response](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/build-and-run-ingestion-response.png)
...
![edit-query-term](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/edit-query-term.png)

## Step 7: Enrich the query

You can enrich the query by configuring a series of processors---in this case, [search request processors](../../../../search-plugins/search-pipelines/search-processors/index.md#search-request-processors). Currently, only the [ML inference processor](../../../../search-plugins/search-pipelines/ml-inference-search-request/index.md) is supported. For this example, you'll configure an ML inference processor using the same Amazon Titan Text Embeddings model.
...
![enrich-query-request](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/enrich-query-request.png)
...
![override-query-with-placeholders](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/override-query-with-placeholders.png)
...
![override-query](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/override-query.png)

## Step 8: Enrich the query results

You can configure a series of [search response processors](../../../../search-plugins/search-pipelines/search-processors/index.md#search-response-processors) to enrich or transform the returned matching documents. In this example, you won't transform the output data. For example transformations, see [configuration examples](#implementation-examples).
...
![search-response](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/search-response.png)

## Step 10: Export the workflow

When you are satisfied with your workflow results, select **Export** to export the [workflow template](../../../../automating-configurations/workflow-templates/index.md). The template contains the configuration details for your index, ingest pipeline, and search pipeline. The template also contains OpenSearch Dashboards metadata. You can copy the template in JSON or YAML format, as shown in the following image.

![export-modal](https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/flow-tutorial/export-modal.png)

If you're importing the template into a different cluster, update any cluster-specific IDs, such as model IDs.
{: .note}

You have now implemented semantic search using OpenSearch Flow, with all of the required resources bundled into a single template. You can import this template into the UI and rebuild it for different clusters or run the template directly using the [Flow Framework Provision API](../../../../automating-configurations/api/provision-workflow/index.md).
...
**For the normalization processor**, configure weights for each subquery. For more information, see the [hybrid search normalization processor example](../../../../vector-search/ai-search/hybrid-search/index.md#step-3-configure-a-search-pipeline).
