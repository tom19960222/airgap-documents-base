...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tutorials/gen-ai/chatbots/rag-conversational-agent.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tutorials/gen-ai/chatbots/rag-conversational-agent.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tutorials/gen-ai/chatbots/rag-conversational-agent/"
canonical_url: "https://docs.opensearch.org/latest/tutorials/gen-ai/chatbots/rag-conversational-agent/"
canonical_route: "/tutorials/gen-ai/chatbots/rag-conversational-agent/"
redirect_from: ["/ml-commons-plugin/tutorials/rag-conversational-agent/","/vector-search/tutorials/chatbots/rag-conversational-agent/"]
...
An alternative way to build RAG conversational search is to use a RAG pipeline. For more information, see [Conversational search using the Cohere Command model](../../rag/conversational-search-cohere/index.md).

## Prerequisite

In this tutorial, you'll build a RAG application that provides an OpenSearch [vector index](../../../../vector-search/creating-vector-index/index.md) as a knowledge base for a large language model (LLM). For data retrieval, you'll use [semantic search](../../../../vector-search/ai-search/semantic-search/index.md). For a comprehensive semantic search setup, see [this tutorial](../../../vector-search/neural-search-tutorial/index.md).
...
As an alternative, you can get the model ID by calling the [Get Task API](../../../../ml-commons-plugin/api/tasks-apis/get-task/index.md):
...
For more information about using models within your OpenSearch cluster, see [Pretrained models](../../../../ml-commons-plugin/pretrained-models/index.md).
...
For more information about ingest pipelines, see [Ingest pipelines](../../../../ingest-pipelines/index.md).
...
For more information about vector indexes, see [Creating a vector index](../../../../vector-search/creating-vector-index/index.md).
...
This tutorial uses the [Amazon Bedrock Claude model](https://aws.amazon.com/bedrock/claude/) for conversational search. You can also use other LLMs. For more information about using externally hosted models, see [Connecting to externally hosted models](../../../../ml-commons-plugin/remote-models/index.md).
...
OpenSearch provides the following agent types: `flow`, `conversational_flow`, and `conversational`. For more information about agents, see [Agents](../../../../ml-commons-plugin/agents-tools/index.md#agents).
...
To obtain memory details, call the [Get Memory API](ml-commons-plugin/api/memory-apis/get-memory/) <!-- unresolved-jekyll-link: target=ml-commons-plugin/api/memory-apis/get-memory/ -->:

```json
GET /_plugins/_ml/memory/gQ75lI0BHcHmo_cz2acL
```

To obtain all messages within a memory, call the [Get Messages API](ml-commons-plugin/api/memory-apis/get-message/) <!-- unresolved-jekyll-link: target=ml-commons-plugin/api/memory-apis/get-message/ -->:

```json
GET /_plugins/_ml/memory/gQ75lI0BHcHmo_cz2acL/messages
```

To obtain message details, call the [Get Message API](ml-commons-plugin/api/memory-apis/get-message/) <!-- unresolved-jekyll-link: target=ml-commons-plugin/api/memory-apis/get-message/ -->:

```json
GET /_plugins/_ml/memory/message/gg75lI0BHcHmo_cz2acZ
```

For debugging purposes, you can obtain trace data for a message by calling the [Get Message Traces API](ml-commons-plugin/api/memory-apis/get-message-traces/) <!-- unresolved-jekyll-link: target=ml-commons-plugin/api/memory-apis/get-message-traces/ -->:
...
Hybrid search combines keyword and vector search to improve search relevance. For more information, see [Hybrid search](../../../../vector-search/ai-search/hybrid-search/index.md).
...
The `PPLTool` can translate a natural language query (NLQ) to [Piped Processing Language (PPL)](../../../../search-plugins/sql/ppl/index.md) and execute the generated PPL query.
...
For more information, obtain trace data by calling the [Get Message Traces API](../../../../ml-commons-plugin/api/memory-apis/get-message-traces/index.md):
