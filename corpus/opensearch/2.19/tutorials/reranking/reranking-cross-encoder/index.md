...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_tutorials/reranking/reranking-cross-encoder.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_tutorials/reranking/reranking-cross-encoder.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/tutorials/reranking/reranking-cross-encoder/"
canonical_url: "https://docs.opensearch.org/latest/tutorials/reranking/reranking-cross-encoder/"
canonical_route: "/tutorials/reranking/reranking-cross-encoder/"
redirect_from: ["/ml-commons-plugin/tutorials/reranking-cross-encoder/","/vector-search/tutorials/reranking/reranking-cross-encoder/"]
...
A [reranking pipeline](../../../search-plugins/search-relevance/reranking-search-results/index.md) can rerank search results, providing a relevance score for each document in the search results with respect to the search query. The relevance score is calculated by a cross-encoder model.
...
For more information, see the [AWS documentation](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ml-amazon-connector.html), [this tutorial](../../vector-search/semantic-search/semantic-search-sagemaker/index.md), and [the AIConnectorHelper notebook](https://github.com/opensearch-project/ml-commons/blob/2.x/docs/tutorials/aws/AIConnectorHelper.ipynb).
...
The connector `pre_process_function` transforms the model output into the following format that can be interpreted by the [rerank processor](../../../search-plugins/search-pipelines/rerank-processor/index.md):
