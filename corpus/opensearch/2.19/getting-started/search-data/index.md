...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_getting-started/search-data.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_getting-started/search-data.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/getting-started/search-data/"
canonical_url: "https://docs.opensearch.org/latest/getting-started/search-data/"
canonical_route: "/getting-started/search-data/"
redirect_from: []
...
- [Query domain-specific language (DSL)](../../query-dsl/index.md): The primary OpenSearch query language, which you can use to create complex, fully customizable queries.
...
- [SQL](../../search-plugins/sql/sql/index.md): A traditional query language that bridges the gap between traditional relational database concepts and the flexibility of OpenSearch’s document-oriented data storage.
- [Piped Processing Language (PPL)](../../search-plugins/sql/ppl/index.md): The primary language used for observability in OpenSearch. PPL uses a pipe syntax that chains commands into a query.
...
For more information about query string syntax, see [Query string query language](../../query-dsl/full-text/query-string/index.md).
...
You can run a full-text search on fields mapped as `text`. By default, text fields are analyzed by the `default` analyzer. The analyzer splits text into terms and changes it to lowercase. For more information about OpenSearch analyzers, see [Analyzers](../../analyzers/index.md).
...
For more information about filters, see [Query and filter context](../../query-dsl/query-filter-context/index.md).
...
For more information about Boolean and other compound queries, see [Compound queries](../../query-dsl/compound/index.md).

## Search methods

Along with the traditional full-text search described in this tutorial, OpenSearch supports a range of machine learning (ML)-powered search methods, including k-NN, semantic, multimodal, sparse, hybrid, and conversational search. For information about all OpenSearch-supported search methods, see [Search](../../search-plugins/index.md).

## Next steps

- For information about available query types, see [Query DSL](../../query-dsl/index.md).
- For information about available search methods, see [Search](../../search-plugins/index.md).
