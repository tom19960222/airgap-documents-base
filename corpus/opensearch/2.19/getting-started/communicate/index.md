...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_getting-started/communicate.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_getting-started/communicate.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/getting-started/communicate/"
canonical_url: "https://docs.opensearch.org/latest/getting-started/communicate/"
canonical_route: "/getting-started/communicate/"
redirect_from: []
...
You can communicate with OpenSearch using the REST API or one of the OpenSearch language clients. This page introduces the OpenSearch REST API. If you need to communicate with OpenSearch in your programming language, see the [Clients](https://docs.opensearch.org/latest/clients/) <!-- unresolved-jekyll-link: route=/clients/ --> section for a list of available clients.
...
You can send HTTP requests in your terminal or in the [Dev Tools console](https://docs.opensearch.org/latest/dashboards/dev-tools/index-dev/) <!-- unresolved-cross-corpus-link: collection=opensearch-dashboards route=/dashboards/dev-tools/index-dev/ --> in OpenSearch Dashboards.
...
For more information about `pretty` and other useful query parameters, see [Common REST parameters](../../api-reference/common-parameters/index.md).
...
1. Choose the triangle icon on the upper right of the request to submit the query. You can also submit the request by pressing `Ctrl+Enter` (or `Cmd+Enter` for Mac users). To learn more about using the OpenSearch Dashboards console for submitting queries, see [Running queries in the console](https://docs.opensearch.org/latest/dashboards/run-queries/) <!-- unresolved-cross-corpus-link: ambiguous route=/dashboards/run-queries/ -->.
...
To learn more about indexing, see [Managing indexes](../../im-plugin/index.md).

## Dynamic mapping

When you index a document, OpenSearch infers the field types from the JSON types submitted in the document. This process is called _dynamic mapping_. For more information, see [Dynamic mapping](../../field-types/index.md#dynamic-mapping).
...
For more information about search, see [Search your data](../search-data/index.md).
...
For more information about partial document updates, see [Update Document API](../../api-reference/document-apis/update-document/index.md).
...
- A _mapping_ is a collection of fields and the types of those fields. For more information, see [Mappings and field types](../../field-types/index.md).
- _Settings_ include index data like the index name, creation date, and number of shards. For more information, see [Configuring OpenSearch](../../install-and-configure/configuring-opensearch/index.md).
...
- For information about the OpenSearch REST API, see the [REST API reference](../../api-reference/index.md).
- For information about OpenSearch language clients, see [Clients](https://docs.opensearch.org/latest/clients/) <!-- unresolved-jekyll-link: route=/clients/ -->.
- For information about mappings, see [Mappings and field types](../../field-types/index.md).
- For information about settings, see [Configuring OpenSearch](../../install-and-configure/configuring-opensearch/index.md).

## Next steps

- See [Ingest data into OpenSearch](../ingest-data/index.md) to learn about ingestion options.
