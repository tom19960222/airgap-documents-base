...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_vector-search/getting-started/auto-generated-embeddings.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_vector-search/getting-started/auto-generated-embeddings.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/vector-search/getting-started/auto-generated-embeddings/"
canonical_url: "https://docs.opensearch.org/latest/vector-search/getting-started/auto-generated-embeddings/"
canonical_route: "/vector-search/getting-started/auto-generated-embeddings/"
redirect_from: []
...
In this example, you'll use the [DistilBERT](https://huggingface.co/docs/transformers/model_doc/distilbert) model from Hugging Face, which is one of the [pretrained models](../../../ml-commons-plugin/pretrained-models/index.md#sentence-transformers) available in OpenSearch. For more information, see [Integrating ML models](../../../ml-commons-plugin/integrating-ml-models/index.md).
...
Now you'll create a vector index by setting `index.knn` to `true`. In the index, the field named `text` contains an image description, and a [`knn_vector`](../../../field-types/supported-field-types/knn-vector/index.md) field named `passage_embedding` contains the vector embedding of the text. The vector field `dimension` must match the dimensionality of the model you configured in Step 2. Additionally, set the default ingest pipeline to the `nlp-ingest-pipeline` you created in the previous step:
...
You can quickly set up automatic embedding generation using [_automated workflows_](../../../automating-configurations/index.md). This approach automatically creates and provisions all necessary resources. For more information, see [Workflow templates](../../../automating-configurations/workflow-templates/index.md).
...
To register and deploy a model, select the built-in workflow template for the model provider. For more information, see [Supported workflow templates](../../../automating-configurations/workflow-templates/index.md#supported-workflow-templates). Alternatively, to configure a custom model, use [Step 1 of the manual setup](#step-1-register-and-deploy-the-model).
...
- See [Getting started with semantic and hybrid search](../../../tutorials/vector-search/neural-search-tutorial/index.md) to learn about configuring semantic and hybrid search.
- See [AI search](../../ai-search/index.md) to learn about the supported types of AI search.
