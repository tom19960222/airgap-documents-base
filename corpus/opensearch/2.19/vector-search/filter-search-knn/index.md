...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_vector-search/filter-search-knn/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_vector-search/filter-search-knn/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/vector-search/filter-search-knn/"
canonical_url: "https://docs.opensearch.org/latest/vector-search/filter-search-knn/index/"
canonical_route: "/vector-search/filter-search-knn/"
redirect_from: ["/search-plugins/knn/filter-search-knn/","/vector-search/filter-search-knn/"]
...
-  [Post-filtering](post-filtering/index.md): Because it is performed after the vector search, this approach may return significantly fewer than `k` results for a restrictive filter. You can use the following two filtering strategies for this approach:
    - [Boolean post-filter](post-filtering/index.md#boolean-filter-with-ann-search): This approach runs an [approximate nearest neighbor (ANN)](../vector-search-techniques/approximate-knn/index.md) search and then applies a filter to the results. The two query parts are executed independently, and then the results are combined based on the query operator (`should`, `must`, and so on) provided in the query.
    - [The `post_filter` parameter](post-filtering/index.md#the-post_filter-parameter): This approach runs an [ANN](../vector-search-techniques/approximate-knn/index.md) search on the full dataset and then applies the filter to the k-NN results.

- [Scoring script filter](scoring-script-filter/index.md): This approach involves pre-filtering a document set and then running an exact k-NN search on the filtered subset. It may have high latency and does not scale when filtered subsets are large.
