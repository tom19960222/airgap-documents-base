...
version: "1.24"
title: "DNS Proxying"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/configuration/traffic-management/dns-proxy/index.md
...
This can also be enabled on a per-pod basis with the [`proxy.istio.io/config` annotation](https://istio.io/v1.24/docs/reference/config/annotations/) <!-- unresolved-site-link: route=/docs/reference/config/annotations -->:
...
> **Tip:**
>
> When deploying to a VM using [`istioctl workload entry configure`](../../../../setup/install/virtual-machine/index.md), basic DNS proxying will be enabled by default.
