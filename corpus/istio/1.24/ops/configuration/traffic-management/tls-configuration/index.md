...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/configuration/traffic-management/tls-configuration/index.md
...
Refer to [TLS configuration mistakes](../../../common-problems/network-issues/index.md#tls-configuration-mistakes)
...
![Sidecar proxy network connections](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/configuration/traffic-management/tls-configuration/sidecar-connections.svg)
...
1. **External inbound traffic**
    ...
    The mTLS mode is configured using a [`PeerAuthentication` resource](https://istio.io/v1.24/docs/reference/config/security/peer_authentication/) <!-- unresolved-site-link: route=/docs/reference/config/security/peer_authentication -->.
...
1. **Local outbound traffic**
    ...
    If [automatic protocol selection](../protocol-selection/index.md#automatic-protocol-selection)
    ...
    [manually specify the protocol](../protocol-selection/index.md#explicit-protocol-selection).
...
1. **External outbound traffic**
    ...
    [`DestinationRule` resource](https://istio.io/v1.24/docs/reference/config/networking/destination-rule/) <!-- unresolved-site-link: route=/docs/reference/config/networking/destination-rule -->.
...
[Istio mutual TLS](https://istio.io/v1.24/about/faq/#difference-between-mutual-and-istio-mutual) <!-- unresolved-site-link: route=/about/faq --> should be sent.
...
![Gateway network connections](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/configuration/traffic-management/tls-configuration/gateway-connections.svg)
...
This is done based on the server configuration in a [`Gateway` resource](https://istio.io/v1.24/docs/reference/config/networking/gateway/) <!-- unresolved-site-link: route=/docs/reference/config/networking/gateway -->.
...
you will end up with [double encryption](../../../common-problems/network-issues/index.md#double-tls).
This works, but is often not the desired behavior.

A `VirtualService` bound to the gateway needs care as well to
[ensure it is consistent](../../../common-problems/network-issues/index.md#gateway-mismatch)
