...
version: "1.24"
title: "Architecture"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/deployment/architecture/index.md
...
[shortcode image link="./arch.svg" alt="The overall architecture of an Istio-based application." caption="Istio architecture in sidecar mode"]
...
You can use Istio's
[Traffic Management API](../../../concepts/traffic-management/index.md#introducing-istio-traffic-management)
...
Istiod [security](../../../concepts/security/index.md) enables strong service-to-service and
...
Additionally, you can use [Istio's authorization feature](../../../concepts/security/index.md#authorization)
