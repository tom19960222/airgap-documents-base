...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/common-problems/validation/index.md
...
Use [istioctl validate -f](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-validate) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl --> and [istioctl analyze](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-analyze) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl --> for more insight into why the configuration is rejected.  Use an _istioctl_ CLI with a similar version to the control plane version.
...
[Istio API reference](../../../reference/config/_index.md) when
necessary.
