...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/common-problems/upgrade-issues/index.md
...
replaced by the [Telemetry API](../../../tasks/observability/metrics/customize-metrics/index.md),
...
[WasmPlugin API](../../../tasks/extensibility/wasm-module-distribution/index.md).
...
[`gatewayTopology`](https://istio.io/v1.24/docs/reference/config/istio.mesh.v1alpha1/#Topology) <!-- unresolved-site-link: route=/docs/reference/config/istio.mesh.v1alpha1 -->
field in
[`ProxyConfig`](../../configuration/traffic-management/network-topologies/index.md).
