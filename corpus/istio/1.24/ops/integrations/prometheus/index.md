...
version: "1.24"
title: "Prometheus"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/integrations/prometheus/index.md
...
[Grafana](../grafana/index.md) and [Kiali](../../../tasks/observability/kiali/index.md).
...
`--set meshConfig.enablePrometheusMerge=false` during [installation](../../../setup/install/istioctl/index.md).
...
* For application stats, if [Strict mTLS](../../../tasks/security/authentication/authn-policy/index.md#globally-enabling-istio-mutual-tls-in-strict-mode)
...
However, the application metrics will follow whatever [Istio authentication policy](../../../tasks/security/authentication/authn-policy/index.md) has been configured
for the workload.
...
>
> See [Understanding TLS Configuration](../../configuration/traffic-management/tls-configuration/index.md) for more information.
...
and deploy it with [sidecar injection](../../../setup/additional-setup/sidecar-injection/index.md).
...
See [Using Prometheus for production-scale monitoring](../../best-practices/observability/index.md#using-prometheus-for-production-scale-monitoring)
