...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/diagnostic-tools/cni/index.md
...
Before reading this, you should read the [CNI installation and operation guide](../../../setup/additional-setup/cni/index.md).
...
and [race condition repairing](../../../setup/additional-setup/cni/index.md#race-condition--mitigation).

## Monitoring

The CNI DaemonSet [generates metrics](https://istio.io/v1.24/docs/reference/commands/install-cni/#metrics) <!-- unresolved-site-link: route=/docs/reference/commands/install-cni -->,
...
By default, the Istio CNI DaemonSet has [race condition mitigation](../../../setup/additional-setup/cni/index.md#race-condition--mitigation) enabled,
...
CNI [race repair logic](../../../setup/additional-setup/cni/index.md#race-condition--mitigation) considers the pod is broken due to the race condition and evicts the pod continuously.
