...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/diagnostic-tools/proxy-cmd/index.md
...
the [`proxy-status`](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-proxy-status) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl -->
and [`proxy-config`](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-proxy-config) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl --> commands. The `proxy-status` command
...
[installation steps](../../../setup/getting-started/index.md) and
[Bookinfo installation steps](../../../examples/bookinfo/index.md#deploying-the-application)).
