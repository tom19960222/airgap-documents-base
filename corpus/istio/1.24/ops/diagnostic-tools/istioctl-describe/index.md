...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ops/diagnostic-tools/istioctl-describe/index.md
...
In Istio 1.3, we included the [`istioctl experimental describe`](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-experimental-describe-pod) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl -->
...
This guide assumes you have deployed the [Bookinfo](../../../examples/bookinfo/index.md)
sample in your mesh. If you haven't already done so,
[start the application's services](../../../examples/bookinfo/index.md#start-the-application-services)
and [determine the IP and port of the ingress](../../../examples/bookinfo/index.md#determine-the-ingress-ip-and-port)
before continuing.
...
if some of the [Istio requirements for pods](../../deployment/application-requirements/index.md)
are not met.
...
[destination rules](../../../concepts/traffic-management/index.md#destination-rules) apply to requests
to a pod. For example, apply the Bookinfo
[mutual TLS destination rules](https://raw.githubusercontent.com/istio/istio/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/bookinfo/networking/destination-rule-all-mtls.yaml):
...
When [virtual services](../../../concepts/traffic-management/index.md#virtual-services) configure
routes to a pod, `istioctl describe` will also include the routes in its output.
For example, apply the
[Bookinfo virtual services](https://raw.githubusercontent.com/istio/istio/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/bookinfo/networking/virtual-service-all-v1.yaml)
...
Following the [mutual TLS migration](../../../tasks/security/authentication/mtls-migration/index.md)
...
[plain HTTP destination rules](https://raw.githubusercontent.com/istio/istio/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/bookinfo/networking/destination-rule-all.yaml):
