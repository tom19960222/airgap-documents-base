...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/install/external-controlplane/index.md
fetched_at: 2025-08-28T08:00:11-04:00
app_version: "1.24.0"
description: "Install Istio with an external control plane and a remote cluster data plane."
---
This guide walks you through the process of installing an external control plane
and then connecting one or more remote clusters to it.
The external control plane [deployment model](../../../ops/deployment/deployment-models/index.md#control-plane-models)
...
![External control plane cluster and remote cluster](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/install/external-controlplane/external-controlplane.svg)
...
The second cluster is a remote cluster that will run the mesh application workloads.
...
```
    ...
    Refer to the [secure ingress task](../../../tasks/traffic-management/ingress/secure-ingress/index.md#configure-a-tls-ingress-gateway-for-a-single-host)
...
**Tabset (ingress-gateway-install-type):**
...
**Tabset (egress-gateway-install-type):**
...
3) Set the `GATEWAY_URL` environment variable
    (see [determining the ingress IP and ports](../../../tasks/traffic-management/ingress/ingress-control/index.md#determining-the-ingress-ip-and-ports) for details):
...
This allows you to easily distribute services and use [location-aware routing and fail over](../../../tasks/traffic-management/locality-load-balancing/_index.md) to support high availability of your application.

![External control plane with multiple remote clusters](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/install/external-controlplane/external-multicluster.svg)
...
[primary-remote](../multicluster/primary-remote_multi-network/index.md) Istio multicluster configuration.
