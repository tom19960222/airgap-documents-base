...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/additional-setup/customize-installation/index.md
...
[configuration profiles](../config-profiles/index.md),
`istioctl install` provides a complete API for customizing the configuration.

- [The `IstioOperator` API](https://istio.io/v1.24/docs/reference/config/istio.operator.v1alpha1/) <!-- unresolved-site-link: route=/docs/reference/config/istio.operator.v1alpha1 -->
...
> [Customize Istio settings using the Helm API](index.md#customize-istio-settings-using-the-helm-api), below.
>
> If you want to set Kubernetes resource settings, use the `IstioOperator` API as described in
>  [Customize Kubernetes settings](index.md#customize-kubernetes-settings).
...
Each component has a [`KubernetesResourceSpec`](https://istio.io/v1.24/docs/reference/config/istio.operator.v1alpha1/#KubernetesResourcesSpec) <!-- unresolved-site-link: route=/docs/reference/config/istio.operator.v1alpha1 -->,
...
[`IstioOperator` API](https://istio.io/v1.24/docs/reference/config/istio.operator.v1alpha1/) <!-- unresolved-site-link: route=/docs/reference/config/istio.operator.v1alpha1 -->, gateways are defined as a list type.
The `default` profile installs one ingress gateway, called `istio-ingressgateway`. You can [inspect the default values
for this gateway](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/manifests/charts/gateways/istio-ingress/values.yaml). The built-in gateways can be customized just like any other component.
...
through the `IstioOperator` [overlays](https://istio.io/v1.24/docs/reference/config/istio.operator.v1alpha1/#K8sObjectOverlay) <!-- unresolved-site-link: route=/docs/reference/config/istio.operator.v1alpha1 --> API, after it is
