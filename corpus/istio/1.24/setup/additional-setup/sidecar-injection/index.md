...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/additional-setup/sidecar-injection/index.md
...
or by manually using the [`istioctl`](https://istio.io/v1.24/docs/reference/commands/istioctl) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl --> command.
...
If you are using [control plane revisions](../../upgrade/canary/index.md), revision specific labels are instead used by a matching `istio.io/rev` label.
...
To manually inject a deployment, use [`istioctl kube-inject`](https://istio.io/v1.24/docs/reference/commands/istioctl/#istioctl-kube-inject) <!-- unresolved-site-link: route=/docs/reference/commands/istioctl -->:
...
Additionally, certain fields are configurable by [annotations](https://istio.io/v1.24/docs/reference/config/annotations/) <!-- unresolved-site-link: route=/docs/reference/config/annotations --> on the pod, although it is recommended to use the above approach to customizing settings. Additional care must be taken for certain annotations:
