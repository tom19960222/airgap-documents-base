...
version: "1.24"
title: "Huawei Cloud"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/platform-setup/huaweicloud/index.md
...
> **Tip:**
>
> Huawei offers a managed control plane add-on for the Huawei Cloud Container Engine,
...
>     select the version according to Istio's [support policy](../../../releases/supported-releases/index.md#support-status-of-istio-releases).

    The image below shows the GUI where you create and configure the cluster:

![Configure Cluster](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/platform-setup/huaweicloud/create-cluster.png)
...
![Configure Node](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/setup/platform-setup/huaweicloud/create-node.png)

1.  [Configure kubectl](https://support.huaweicloud.com/intl/en-us/cce_faq/cce_faq_00041.html)

1.  Now you can install Istio on CCE cluster according to [install guide](../../install/_index.md).
...
Start playing with Istio by trying out the various [tasks](../../../tasks/_index.md).
