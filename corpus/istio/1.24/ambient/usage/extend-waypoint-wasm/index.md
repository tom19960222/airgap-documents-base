...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/usage/extend-waypoint-wasm/index.md
...
Istio provides the ability to [extend its functionality using WebAssembly (Wasm)](../../../concepts/wasm/index.md).
...
1. Set up Istio by following the instructions in the [ambient mode Getting Started guide](../../getting-started/_index.md).
1. Deploy the [Bookinfo sample application](../../getting-started/deploy-sample-app/index.md).
1. [Add the default namespace to the ambient mesh](../../getting-started/secure-and-visualize/index.md).
...
Follow the [waypoint deployment instructions](../waypoint/index.md#deploy-a-waypoint-proxy) to deploy a waypoint proxy in the bookinfo namespace.
...
1. Follow [the ambient mode uninstall guide](../../getting-started/_index.md#uninstall) to remove Istio and sample test applications.
