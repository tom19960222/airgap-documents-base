...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/usage/waypoint/index.md
...
Using the services from the sample [bookinfo application](../../../examples/bookinfo/index.md), we can deploy a waypoint called `reviews-svc-waypoint` for the `reviews` service:
