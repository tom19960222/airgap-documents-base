...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/usage/verify-mtls-enabled/index.md
...
If you have [installed Prometheus](../../../ops/integrations/prometheus/index.md#installation), you can set up port-forwarding and open the Prometheus UI by using the following command:
...
Validate the `src.identity` and `dst.identity` values are correct. They are the identities used for the mTLS communication among the source and destination workloads. Refer to the [verifying ztunnel traffic through logs section](../troubleshoot-ztunnel/index.md#verifying-ztunnel-traffic-through-logs) for more details.
...
![Kiali dashboard](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/usage/verify-mtls-enabled/kiali-mtls.png)

Refer to the [Visualize the application and metrics](../../getting-started/secure-and-visualize/index.md#visualize-the-application-and-metrics) document for more details.
