...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/getting-started/manage-traffic/index.md
...
This section concludes the Getting Started guide for Istio's ambient mode. You can continue to the [Cleanup](../cleanup/index.md) section to remove Istio or continue exploring the [ambient mode user guides](../../usage/_index.md) to learn more about Istio's features and capabilities.
