...
version: "1.24"
title: "Overview"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/ambient/overview/index.md
fetched_at: 2025-08-28T08:00:11-04:00
app_version: "1.24.0"
description: "An overview of Istio's ambient data plane mode."
---
In **ambient mode**, Istio implements its [features](../../concepts/_index.md) using a per-node Layer 4 (L4) proxy, and optionally a per-namespace Layer 7 (L7) proxy.
...
For details on the design of ambient mode, and how it interacts with the Istio control plane, see the [data plane](../architecture/data-plane/index.md) and [control plane](../architecture/control-plane/index.md) architecture documentation.
...
The term "secure overlay" is used to collectively describe the set of L4 networking functions implemented in an ambient mesh via the ztunnel proxy. At the transport layer, this is implemented via an HTTP CONNECT-based traffic tunneling protocol called [HBONE](../architecture/hbone/index.md).
