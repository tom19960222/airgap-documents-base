...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/observability/distributed-tracing/telemetry-api/index.md
...
1.  Follow the tracing installation guide located under [Integrations](../../../../ops/integrations/_index.md)
    based on your preferred tracing backend to install the appropriate software and
    configure an extension provider.

## Installation

In this example, we will send traces to [Zipkin](../../../../ops/integrations/zipkin/index.md). Install Zipkin before you continue.
...
You can verify the results by [accessing the Zipkin UI](../zipkin/index.md).
