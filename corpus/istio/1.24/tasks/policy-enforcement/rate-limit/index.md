...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/policy-enforcement/rate-limit/index.md
...
1. Setup Istio in a Kubernetes cluster by following the instructions in the
   [Installation Guide](../../../setup/getting-started/index.md).

1. Deploy the [Bookinfo](../../../examples/bookinfo/index.md) sample application.
...
1. Create a global rate limit service which implements Envoy's
  ...
  As a reference, a demo configuration can be found [here](https://github.com/istio/istio/blob/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/ratelimit/rate-limit-service.yaml),
