...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/traffic-management/fault-injection/index.md
...
* Deploy the [Bookinfo](../../../examples/bookinfo/index.md) sample application including the
  [default destination rules](../../../examples/bookinfo/index.md#apply-default-destination-rules).

* Review the fault injection discussion in the
[Traffic Management](../../../concepts/traffic-management/index.md) concepts doc.

* Apply application version routing by either performing the
  [request routing](../request-routing/index.md) task or by
...
1. Open the [Bookinfo](../../../examples/bookinfo/index.md) web application in your browser.
...
[traffic shifting](../traffic-shifting/index.md) task, you can then
