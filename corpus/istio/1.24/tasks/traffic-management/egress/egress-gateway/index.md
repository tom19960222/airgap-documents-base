...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/traffic-management/egress/egress-gateway/index.md
...
The [Accessing External Services](../egress-control/index.md) task shows how to configure
...
Istio uses [ingress and egress gateways](https://istio.io/v1.24/docs/reference/config/networking/gateway/) <!-- unresolved-site-link: route=/docs/reference/config/networking/gateway -->
...
>     [destination rule lookup path](../../../../ops/best-practices/traffic-management/index.md#cross-namespace-configuration)
...
> **Tip:**
>
> Egress gateways are [deployed automatically](../../ingress/gateway-api/index.md#deployment-methods)
...
```
    ...
    [TLS Origination for Egress Traffic](../egress-tls-origination/index.md) example,
...
> **Tip:**
>
> If [mutual TLS Authentication](../../../security/authentication/authn-policy/index.md) is enabled, and you have issues connecting to the egress gateway, run the following command to verify the certificate is correct:
>
>
>
> ```bash
...
the [curl](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/curl) sample to it, and then attempt to send requests to a gateway-secured
external service.
...
3)  Deploy the [curl](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/curl) sample to the `test-egress` namespace.
