...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/traffic-management/egress/egress-gateway-tls-origination/index.md
fetched_at: 2025-08-28T08:00:11-04:00
app_version: "1.24.0"
description: "Describes how to configure an Egress Gateway to perform TLS origination to external services."
---
The [TLS Origination for Egress Traffic](../egress-tls-origination/index.md)
example shows how to configure Istio to perform TLS origination
for traffic to an external service. The [Configure an Egress Gateway](../egress-gateway/index.md)
...
*   Start the [curl](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/curl) sample
    which will be used as a test source for external calls.

    If you have enabled [automatic sidecar injection](../../../../setup/additional-setup/sidecar-injection/index.md#automatic-sidecar-injection), do
...
```
    ...
    The output should be the same as in the [TLS Origination for Egress Traffic](../egress-tls-origination/index.md)
