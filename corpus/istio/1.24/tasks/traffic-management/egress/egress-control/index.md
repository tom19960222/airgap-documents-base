...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/traffic-management/egress/egress-control/index.md
...
1. Configure [service entries](https://istio.io/v1.24/docs/reference/config/networking/service-entry/) <!-- unresolved-site-link: route=/docs/reference/config/networking/service-entry --> to provide controlled access to external services.
1. Completely bypass the Envoy proxy for a specific range of IPs.

## Before you begin

*   Set up Istio by following the instructions in the [Installation guide](../../../../setup/_index.md).
    Use the `demo` [configuration profile](../../../../setup/additional-setup/config-profiles/index.md) or otherwise
    [enable Envoy’s access logging](../../../observability/logs/access-log/index.md#enable-envoy-s-access-logging).
...
Istio has an [installation option](https://istio.io/v1.24/docs/reference/config/istio.mesh.v1alpha1/#MeshConfig-OutboundTrafficPolicy-Mode) <!-- unresolved-site-link: route=/docs/reference/config/istio.mesh.v1alpha1 -->,
...
[intercepting](../../../../concepts/traffic-management/index.md)
...
be configured on a pod by setting corresponding [annotations](https://istio.io/v1.24/docs/reference/config/annotations/) <!-- unresolved-site-link: route=/docs/reference/config/annotations --> such as
...
> **Warning:**
>
> Unlike [Envoy passthrough to external services](index.md#envoy-passthrough-to-external-services),
...
Use the same command that you used to [install Istio](../../../../setup/install/istioctl/index.md) and
...
[direct egress traffic through an egress gateway](../egress-gateway/index.md)
and review the security concerns described in the
[additional security considerations](../egress-gateway/index.md#additional-security-considerations)
section.
