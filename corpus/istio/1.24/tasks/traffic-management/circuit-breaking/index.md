...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/traffic-management/circuit-breaking/index.md
...
1.  Create a [destination rule](https://istio.io/v1.24/docs/reference/config/networking/destination-rule/) <!-- unresolved-site-link: route=/docs/reference/config/networking/destination-rule --> to apply circuit breaking settings
...
>     Otherwise requests will generate 503 errors as described [here](../../../ops/common-problems/network-issues/index.md#503-errors-after-setting-destination-rule).
...
governed by Istio.
    ...
    If you have enabled [automatic sidecar injection](../../../setup/additional-setup/sidecar-injection/index.md#automatic-sidecar-injection), deploy the `fortio` service:
...
1.  Shutdown the [httpbin](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/httpbin) service and client:
