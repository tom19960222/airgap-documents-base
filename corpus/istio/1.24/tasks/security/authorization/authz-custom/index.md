...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/tasks/security/authorization/authz-custom/index.md
fetched_at: 2025-08-28T08:00:11-04:00
app_version: "1.24.0"
description: "Shows how to integrate and delegate access control to an external authorization system."
---
This task shows you how to set up an Istio authorization policy using a new value for the [action field](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/#AuthorizationPolicy-Action) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy -->, `CUSTOM`,
...
* Follow the [Istio installation guide](../../../../setup/install/istioctl/index.md) to install Istio.
...
```bash
$ kubectl apply -n foo -f https://raw.githubusercontent.com/istio/istio/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/extauthz/ext-authz.yaml
...
In this task, you will use a [sample external authorizer](https://github.com/istio/istio/tree/8825a6b7f8c9a2d66005a5f8b64e98aaee0dda99/samples/extauthz) which
