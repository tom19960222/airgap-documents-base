...
version: "1.24"
title: "Security"
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/index.md
...
![Security overview](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/overview.svg)
...
Visit our
[mutual TLS Migration docs](../../tasks/security/authentication/mtls-migration/index.md)
to start using Istio security features with your deployed services. Visit our
[Security Tasks](../../tasks/security/_index.md) for detailed
...
- The configuration API server distributes to the proxies:
    ...
    - [authentication policies](index.md#authentication-policies)
    - [authorization policies](index.md#authorization-policies)
    - [secure naming information](index.md#secure-naming)
...
![Security Architecture](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/arch-sec.svg)
...
[secure naming](index.md#secure-naming)
...
![Identity Provisioning Workflow](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/id-prov.svg)
...
[Mutual TLS Migration tutorial](../../tasks/security/authentication/mtls-migration/index.md).
...
TLS mode with
[destination rules](../traffic-management/index.md#destination-rules).
You can find out more about how mutual TLS works in the
[Mutual TLS authentication section](index.md#mutual-tls-authentication).

![Authentication Architecture](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/authn.svg)
...
[Architecture section](index.md#authentication-architecture),
...
[TLS settings reference docs](https://istio.io/v1.24/docs/reference/config/networking/destination-rule#ClientTLSSettings) <!-- unresolved-site-link: route=/docs/reference/config/networking/destination-rule -->.
...
- A simple API: it includes a single [`AuthorizationPolicy` CRD](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy -->,
...
![Authorization Architecture](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/authz.svg)
...
![Authorization Policy Precedence](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/security/authz-eval.svg)
...
[`AuthorizationPolicy` custom resource](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy -->.
...
The supported `key` values of a condition are listed on the [conditions page](../../reference/config/security/conditions/index.md).
...
[conditions page](../../reference/config/security/conditions/index.md).
...
Check the [security advisory](https://istio.io/v1.24/news/security/istio-security-2021-004) <!-- unresolved-site-link: route=/news/security/istio-security-2021-004 --> for more details and alternatives if you cannot enable
...
- Try out the security policy by following the [authentication](../../tasks/security/authentication/_index.md)
  and [authorization](../../tasks/security/authorization/_index.md) tasks.

- Learn some security [policy examples](../../ops/configuration/security/security-policy-examples/index.md) that could be
  used to improve security in your mesh.

- Read [common problems](../../ops/common-problems/security-issues/index.md) to better troubleshoot security policy issues
