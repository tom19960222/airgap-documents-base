...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/concepts/traffic-management/index.md
...
Istio’s traffic management model relies on the Envoy
proxies that are deployed along with your services. All traffic that your mesh
services send and receive (data plane traffic) is proxied through Envoy, making
...
[architecture overview](../../ops/deployment/architecture/index.md). The rest of
...
service registry, Istio connects to a service
...
resource definitions (CRDs), which you can configure
...
[Virtual services](https://istio.io/v1.24/docs/reference/config/networking/virtual-service/#VirtualService) <!-- unresolved-site-link: route=/docs/reference/config/networking/virtual-service -->,
...
virtual services help with canary deployments in [Canary Deployments using Istio](https://istio.io/v1.24/blog/2017/0.1-canary/) <!-- unresolved-site-link: route=/blog/2017/0.1-canary -->.
...
-   Configure traffic rules in combination with
    [gateways](index.md#gateways) to control ingress
    and egress traffic.
...
[TCP](https://istio.io/v1.24/docs/reference/config/networking/virtual-service/#TCPRoute) <!-- unresolved-site-link: route=/docs/reference/config/networking/virtual-service --> and
unterminated
[TLS](https://istio.io/v1.24/docs/reference/config/networking/virtual-service/#TLSRoute) <!-- unresolved-site-link: route=/docs/reference/config/networking/virtual-service -->
...
[`HTTPMatchRequest` reference](https://istio.io/v1.24/docs/reference/config/networking/virtual-service/#HTTPMatchRequest) <!-- unresolved-site-link: route=/docs/reference/config/networking/virtual-service -->.
...
[`HTTPRoute` reference](https://istio.io/v1.24/docs/reference/config/networking/virtual-service/#HTTPRoute) <!-- unresolved-site-link: route=/docs/reference/config/networking/virtual-service -->.

## Destination rules {#destination-rules}

Along with [virtual services](#virtual-services),
[destination rules](https://istio.io/v1.24/docs/reference/config/networking/destination-rule/#DestinationRule) <!-- unresolved-site-link: route=/docs/reference/config/networking/destination-rule -->
...
[Destination Rule reference](https://istio.io/v1.24/docs/reference/config/networking/destination-rule/) <!-- unresolved-site-link: route=/docs/reference/config/networking/destination-rule -->.
...
You use a [gateway](https://istio.io/v1.24/docs/reference/config/networking/gateway/#Gateway) <!-- unresolved-site-link: route=/docs/reference/config/networking/gateway --> to
...
[secure control of egress traffic](https://istio.io/v1.24/blog/2019/egress-traffic-control-in-istio-part-1/) <!-- unresolved-site-link: route=/blog/2019/egress-traffic-control-in-istio-part-1 -->
...
deployed if you use our [demo installation](../../setup/getting-started/index.md),
while just the ingress gateway is deployed with our
[default profile](../../setup/additional-setup/config-profiles/index.md).
...
You use a
[service entry](https://istio.io/v1.24/docs/reference/config/networking/service-entry/#ServiceEntry) <!-- unresolved-site-link: route=/docs/reference/config/networking/service-entry --> to add
...
-   Run a mesh service in a Virtual Machine (VM) by
    [adding VMs to your mesh](../../examples/virtual-machines/index.md).
...
See the
[Service Entry reference](https://istio.io/v1.24/docs/reference/config/networking/service-entry) <!-- unresolved-site-link: route=/docs/reference/config/networking/service-entry -->
...
forwarding traffic. You can use a [sidecar](https://istio.io/v1.24/docs/reference/config/networking/sidecar/#Sidecar) <!-- unresolved-site-link: route=/docs/reference/config/networking/sidecar --> configuration to do the following:
...
See the [Sidecar reference](https://istio.io/v1.24/docs/reference/config/networking/sidecar/) <!-- unresolved-site-link: route=/docs/reference/config/networking/sidecar -->
for more details.
...
> [Traffic Management Problems](../../ops/common-problems/network-issues/index.md#virtual-service-with-fault-injection-and-retrytimeout-policies-not-working-as-expected).
