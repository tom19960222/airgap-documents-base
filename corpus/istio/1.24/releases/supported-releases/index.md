...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/releases/supported-releases/index.md
...
You can find high-level releases notes for each minor and patch release [here](https://istio.io/v1.24/news) <!-- unresolved-site-link: route=/news -->.
...
The Istio control plane can be one version ahead of the data plane. However, the data plane cannot be ahead of control plane. We recommend using [revisions](../../setup/upgrade/canary/index.md) so that there is no skew at all.
