...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/releases/security-vulnerabilities/index.md
...
our [Reporting Bugs](../bugs/index.md) page to learn what to do.
...
- Once the binaries are available, an announcement is sent out on the following channels:
    ...
    - The [Istio blog](https://istio.io/v1.24/blog) <!-- unresolved-site-link: route=/blog -->
...
Istio offers two sets of docker images, based on `ubuntu` (default) and based on `distroless` (see [Harden Docker Container Images](../../ops/configuration/security/harden-docker-images/index.md)).
...
The [`distroless`](../../ops/configuration/security/harden-docker-images/index.md) base images are strongly encouraged if reducing base image CVEs is important to you.
