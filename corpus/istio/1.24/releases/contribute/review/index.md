...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/releases/contribute/review/index.md
...
all changes to the [Istio website](../../../_index.md).
...
![Documentation review process](https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/releases/contribute/review/review-process.svg)
...
- Consistency: Content adheres to all recommendations in the
  [Istio contribution guides](../_index.md)
- Style: Content adheres to the [Google developer style guide](https://developers.google.com/style).
- Graphic assets: Diagrams follow the Istio [diagram creation guide](../diagrams/index.md).\
