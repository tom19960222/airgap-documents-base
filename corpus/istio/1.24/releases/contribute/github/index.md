...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/releases/contribute/github/index.md
...
- [Add](../add-content/index.md) new files to the repository.
- [Edit](#quick-edit) existing files.
- [Review](../review/index.md) the added or modified files.
...
Please see our guides on how to [contribute new content](../add-content/index.md)
or [review content](../review/index.md) to learn more about submitting more
substantial changes.
...
- The [public site](../../../_index.md) shows the content from the current
  release branch.
