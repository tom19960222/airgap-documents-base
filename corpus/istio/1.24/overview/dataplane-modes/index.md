...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/overview/dataplane-modes/index.md
...
<table>
  <thead>
   ...
   <tbody>
    <tr>
      <th>Encryption</th>
      <td>All traffic between pods is encrypted using mTLS.</td>
      <td>N/A&mdash;service identity in Istio is based on TLS.</td>
    </tr>
    <tr>
      <th>Service-to-service authentication</th>
      <td>SPIFFE, via mTLS certificates. Istio issues a short-lived X.509 certificate that encodes the pod's service account identity.</td>
      <td>N/A&mdash;service identity in Istio is based on TLS.</td>
    </tr>
    <tr>
