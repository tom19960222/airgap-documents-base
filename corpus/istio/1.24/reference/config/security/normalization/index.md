...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/reference/config/security/normalization/index.md
...
For more information, please refer to [authorization normalization best practices](../../../../ops/best-practices/security/index.md#customize-your-system-on-path-normalization).

## Path Related

This applies to the [`paths` field](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/#Operation-paths) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy --> and the [`notPaths` field](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/#Operation-not_paths) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy -->.
