...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/reference/config/security/conditions/index.md
...
in the `when` field of an [authorization policy rule](https://istio.io/v1.24/docs/reference/config/security/authorization-policy/#Rule) <!-- unresolved-site-link: route=/docs/reference/config/security/authorization-policy -->.

For more information, refer to the [authorization concept page](../../../../concepts/security/index.md#authorization).
