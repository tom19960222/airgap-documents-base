...
source_url: https://github.com/istio/istio.io/blob/34199a22213d0bbfe10ab1759d89242ee752ac12/content/en/docs/examples/microservices-istio/setup-kubernetes-cluster/index.md
...
> proceed to [setting up your local computer](../setup-local-computer/index.md).
...
1.  [Install Istio](../../../setup/getting-started/index.md) using the `demo` profile.

1.  The [Kiali](../../../ops/integrations/kiali/index.md) and [Prometheus](../../../ops/integrations/prometheus/index.md) addons are used in this example and need to be installed. All addons are installed using:
...
You are ready to [set up a local computer](../setup-local-computer/index.md).
