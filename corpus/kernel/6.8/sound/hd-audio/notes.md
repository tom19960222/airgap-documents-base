...
collection: kernel
version: "6.8"
title: "More Notes on HD-Audio Driver"
source_url: https://www.kernel.org/doc/html/v6.8/sound/hd-audio/notes.html
fetched_at: 2026-08-21T03:47:47+00:00
---
...
chip. Then, see [HD-Audio Codec-Specific Models](models.md) file,
...
This enables [`snd_printd()`](../kernel-api/alsa-driver-api.md#c.snd_printd "snd_printd") macro and others, and you'll get additional
...
The hd-audio driver reads the file via [`request_firmware()`](../../driver-api/firmware/request_firmware.md#c.request_firmware "request_firmware"). Thus,
...
alsa-devel ML
:   [alsa-devel@alsa-project.org](mailto:alsa-devel%40alsa-project.org)
