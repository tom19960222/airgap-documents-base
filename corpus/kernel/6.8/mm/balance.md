...
collection: kernel
version: "6.8"
title: "Memory Balancing"
source_url: https://www.kernel.org/doc/html/v6.8/mm/balance.html
fetched_at: 2026-08-21T03:46:08+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/balance.md)

# Memory Balancing

Started Jan 2000 by Kanoj Sarcar <[kanoj@sgi.com](mailto:kanoj%40sgi.com)>
...
1. Dynamic experience should influence balancing: number of failed requests
   for a zone can be tracked and fed into the balancing scheme ([jalvo@mbay.net](mailto:jalvo%40mbay.net))
2. Implement a replace_with_highmem()-like replace_with_regular() to preserve
   dma pages. ([lkd@tantalophile.demon.co.uk](mailto:lkd%40tantalophile.demon.co.uk))
