...
version: "6.8"
title: "zsmalloc"
source_url: https://www.kernel.org/doc/html/v6.8/mm/zsmalloc.html
...
be mapped using [`zs_map_object()`](zsmalloc.md#c.zs_map_object "zs_map_object") to get a usable pointer and subsequently
...
void obj_to_location(unsigned long obj, struct [page](zsmalloc.md#c.obj_to_location "page") \*\*page, unsigned int \*obj_idx)
...
unsigned long location_to_obj(struct [page](zsmalloc.md#c.location_to_obj "page") \*page, unsigned int obj_idx)
