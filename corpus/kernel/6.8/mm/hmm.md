...
source_url: https://www.kernel.org/doc/html/v6.8/mm/hmm.html
fetched_at: 2026-08-21T03:43:21+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/hmm.md)
...
- [Problems of using a device specific memory allocator](hmm.md#problems-of-using-a-device-specific-memory-allocator)
- [I/O bus, device memory characteristics](hmm.md#i-o-bus-device-memory-characteristics)
- [Shared address space and migration](hmm.md#shared-address-space-and-migration)
- [Address space mirroring implementation and API](hmm.md#address-space-mirroring-implementation-and-api)
- [Leverage default_flags and pfn_flags_mask](hmm.md#leverage-default-flags-and-pfn-flags-mask)
- [Represent and manage device memory from core kernel point of view](hmm.md#represent-and-manage-device-memory-from-core-kernel-point-of-view)
- [Migration to and from device memory](hmm.md#migration-to-and-from-device-memory)
- [Exclusive access memory](hmm.md#exclusive-access-memory)
- [Memory cgroup (memcg) and rss accounting](hmm.md#memory-cgroup-memcg-and-rss-accounting)

## [Problems of using a device specific memory allocator](hmm.md#id1)
...
## [I/O bus, device memory characteristics](hmm.md#id2)
...
## [Shared address space and migration](hmm.md#id3)
...
## [Address space mirroring implementation and API](hmm.md#id4)
...
## [Leverage default_flags and pfn_flags_mask](hmm.md#id5)
...
## [Represent and manage device memory from core kernel point of view](hmm.md#id6)
...
## [Migration to and from device memory](hmm.md#id7)
...
The [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup"), [`migrate_vma_pages()`](../core-api/mm-api.md#c.migrate_vma_pages "migrate_vma_pages"), and [`migrate_vma_finalize()`](../core-api/mm-api.md#c.migrate_vma_finalize "migrate_vma_finalize")
...
There are also [`devm_request_free_mem_region()`](../core-api/kernel-api.md#c.devm_request_free_mem_region "devm_request_free_mem_region"), [`devm_memremap_pages()`](../core-api/mm-api.md#c.devm_memremap_pages "devm_memremap_pages"),
...
memory (see [Page migration](page_migration.md)) but the steps are split
between device driver specific code and shared common code:

1. `mmap_read_lock()`

   The device driver has to pass a `struct vm_area_struct` to
   [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup") so the mmap_read_lock() or mmap_write_lock() needs to
   be held for the duration of the migration.
2. `migrate_vma_setup(struct migrate_vma *args)`

   The device driver initializes the `struct migrate_vma` fields and passes
   the pointer to [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup"). The `args->flags` field is used to
   ...
   One of the first steps [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup") does is to invalidate other
   ...
   the `args->pgmap_owner` field passed to [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup"). This is
   ...
   [`migrate_vma_setup()`](../core-api/mm-api.md#c.migrate_vma_setup "migrate_vma_setup") also clears the `args->dst` array.
...
## [Exclusive access memory](hmm.md#id8)
...
## [Memory cgroup (memcg) and rss accounting](hmm.md#id9)
