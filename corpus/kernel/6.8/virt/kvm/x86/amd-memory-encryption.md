...
source_url: https://www.kernel.org/doc/html/v6.8/virt/kvm/x86/amd-memory-encryption.html
fetched_at: 2026-08-21T04:00:54+00:00
---
...
See [[white-paper]](amd-memory-encryption.md#white-paper), [[api-spec]](amd-memory-encryption.md#api-spec), [[amd-apm]](amd-memory-encryption.md#amd-apm) and [[kvm-forum]](amd-memory-encryption.md#kvm-forum) for more info.

[white-paper](amd-memory-encryption.md#id2)
:   <https://developer.amd.com/wordpress/media/2013/12/AMD_Memory_Encryption_Whitepaper_v7-Public.pdf>

api-spec([1](amd-memory-encryption.md#id1),[2](amd-memory-encryption.md#id3))
:   <https://support.amd.com/TechDocs/55766_SEV-KM_API_Specification.pdf>

[amd-apm](amd-memory-encryption.md#id4)
:   <https://support.amd.com/TechDocs/24593.pdf> (section 15.34)

[kvm-forum](amd-memory-encryption.md#id5)
