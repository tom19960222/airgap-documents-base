...
source_url: https://www.kernel.org/doc/html/v6.8/virt/kvm/locking.html
...
Comment
:   KVM also disables CPU hotplug via cpus_read_lock() during
    enable/disable.
...
Comment
:   Exists because using kvm_lock leads to deadlock. cpu_hotplug_lock is
