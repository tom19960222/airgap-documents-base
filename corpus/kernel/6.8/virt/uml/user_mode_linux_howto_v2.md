...
version: "6.8"
title: "UML HowTo"
source_url: https://www.kernel.org/doc/html/v6.8/virt/uml/user_mode_linux_howto_v2.html
fetched_at: 2026-08-21T03:52:48+00:00
---
# UML HowTo

- [Introduction](user_mode_linux_howto_v2.md#introduction)

  - [How is UML Different from a VM using Virtualization package X?](user_mode_linux_howto_v2.md#how-is-uml-different-from-a-vm-using-virtualization-package-x)
  - [Why Would I Want User Mode Linux?](user_mode_linux_howto_v2.md#why-would-i-want-user-mode-linux)
  - [Why not to run UML](user_mode_linux_howto_v2.md#why-not-to-run-uml)
- [Building a UML instance](user_mode_linux_howto_v2.md#building-a-uml-instance)

  - [Creating an image](user_mode_linux_howto_v2.md#creating-an-image)
  - [Edit key system files](user_mode_linux_howto_v2.md#edit-key-system-files)
- [Setting Up UML Networking](user_mode_linux_howto_v2.md#setting-up-uml-networking)

  - [Network configuration privileges](user_mode_linux_howto_v2.md#network-configuration-privileges)
  - [Configuring vector transports](user_mode_linux_howto_v2.md#configuring-vector-transports)

    - [Common options](user_mode_linux_howto_v2.md#common-options)
    - [Shared Options](user_mode_linux_howto_v2.md#shared-options)
    - [tap transport](user_mode_linux_howto_v2.md#tap-transport)
    - [hybrid transport](user_mode_linux_howto_v2.md#hybrid-transport)
    - [raw socket transport](user_mode_linux_howto_v2.md#raw-socket-transport)
    - [GRE socket transport](user_mode_linux_howto_v2.md#gre-socket-transport)
    - [l2tpv3 socket transport](user_mode_linux_howto_v2.md#l2tpv3-socket-transport)
    - [BESS socket transport](user_mode_linux_howto_v2.md#bess-socket-transport)
  - [Configuring Legacy transports](user_mode_linux_howto_v2.md#configuring-legacy-transports)
- [Running UML](user_mode_linux_howto_v2.md#running-uml)

  - [Arguments](user_mode_linux_howto_v2.md#arguments)

    - [Mandatory Arguments:](user_mode_linux_howto_v2.md#mandatory-arguments)
    - [Important Optional Arguments](user_mode_linux_howto_v2.md#important-optional-arguments)
  - [Starting UML](user_mode_linux_howto_v2.md#starting-uml)
  - [Logging in](user_mode_linux_howto_v2.md#logging-in)
  - [The UML Management Console](user_mode_linux_howto_v2.md#the-uml-management-console)

    - [version](user_mode_linux_howto_v2.md#version)
    - [help](user_mode_linux_howto_v2.md#help)
    - [halt and reboot](user_mode_linux_howto_v2.md#halt-and-reboot)
    - [config](user_mode_linux_howto_v2.md#config)
    - [remove](user_mode_linux_howto_v2.md#remove)
    - [sysrq](user_mode_linux_howto_v2.md#sysrq)
    - [cad](user_mode_linux_howto_v2.md#cad)
    - [stop](user_mode_linux_howto_v2.md#stop)
    - [go](user_mode_linux_howto_v2.md#go)
    - [proc](user_mode_linux_howto_v2.md#proc)
    - [stack](user_mode_linux_howto_v2.md#stack)
- [Advanced UML Topics](user_mode_linux_howto_v2.md#advanced-uml-topics)

  - [Sharing Filesystems between Virtual Machines](user_mode_linux_howto_v2.md#sharing-filesystems-between-virtual-machines)

    - [Using layered block devices](user_mode_linux_howto_v2.md#using-layered-block-devices)
    - [Disk Usage](user_mode_linux_howto_v2.md#disk-usage)
    - [COW validity.](user_mode_linux_howto_v2.md#cow-validity)
    - [Cows can moo - uml_moo : Merging a COW file with its backing file](user_mode_linux_howto_v2.md#cows-can-moo-uml-moo-merging-a-cow-file-with-its-backing-file)
  - [Host file access](user_mode_linux_howto_v2.md#host-file-access)

    - [Using hostfs](user_mode_linux_howto_v2.md#using-hostfs)
    - [hostfs as the root filesystem](user_mode_linux_howto_v2.md#hostfs-as-the-root-filesystem)
    - [Hostfs Caveats](user_mode_linux_howto_v2.md#hostfs-caveats)
  - [Tuning UML](user_mode_linux_howto_v2.md#tuning-uml)
- [Contributing to UML and Developing with UML](user_mode_linux_howto_v2.md#contributing-to-uml-and-developing-with-uml)

  - [Tracing UML](user_mode_linux_howto_v2.md#tracing-uml)
  - [Kernel debugging](user_mode_linux_howto_v2.md#kernel-debugging)
  - [Developing Device Drivers](user_mode_linux_howto_v2.md#developing-device-drivers)
  - [Using UML as a Test Platform](user_mode_linux_howto_v2.md#using-uml-as-a-test-platform)

    - [Security Considerations](user_mode_linux_howto_v2.md#security-considerations)

## [Introduction](user_mode_linux_howto_v2.md#id1)
...
### [How is UML Different from a VM using Virtualization package X?](user_mode_linux_howto_v2.md#id2)
...
### [Why Would I Want User Mode Linux?](user_mode_linux_howto_v2.md#id3)
...
### [Why not to run UML](user_mode_linux_howto_v2.md#id4)
...
## [Building a UML instance](user_mode_linux_howto_v2.md#id5)
...
### [Creating an image](user_mode_linux_howto_v2.md#id6)
...
### [Edit key system files](user_mode_linux_howto_v2.md#id7)
...
## [Setting Up UML Networking](user_mode_linux_howto_v2.md#id8)
...
### [Network configuration privileges](user_mode_linux_howto_v2.md#id9)
...
### [Configuring vector transports](user_mode_linux_howto_v2.md#id10)
...
#### [Common options](user_mode_linux_howto_v2.md#id11)
...
#### [Shared Options](user_mode_linux_howto_v2.md#id12)
...
#### [tap transport](user_mode_linux_howto_v2.md#id13)
...
#### [hybrid transport](user_mode_linux_howto_v2.md#id14)
...
#### [raw socket transport](user_mode_linux_howto_v2.md#id15)
...
#### [GRE socket transport](user_mode_linux_howto_v2.md#id16)
...
#### [l2tpv3 socket transport](user_mode_linux_howto_v2.md#id17)
...
#### [BESS socket transport](user_mode_linux_howto_v2.md#id18)
...
### [Configuring Legacy transports](user_mode_linux_howto_v2.md#id19)

Legacy transports are now considered obsolete. Please use the vector
versions.

## [Running UML](user_mode_linux_howto_v2.md#id20)
...
### [Arguments](user_mode_linux_howto_v2.md#id21)

#### [Mandatory Arguments:](user_mode_linux_howto_v2.md#id22)
...
- `ubdX[s,d,c,t]=` virtual disk specification. This is not really
  ...
  in [Creating an image](user_mode_linux_howto_v2.md#creating-an-image)).
...
#### [Important Optional Arguments](user_mode_linux_howto_v2.md#id23)
...
### [Starting UML](user_mode_linux_howto_v2.md#id24)
...
### [Logging in](user_mode_linux_howto_v2.md#id25)
...
### [The UML Management Console](user_mode_linux_howto_v2.md#id26)
...
#### [version](user_mode_linux_howto_v2.md#id27)
...
#### [config](user_mode_linux_howto_v2.md#id30)
...
#### [remove](user_mode_linux_howto_v2.md#id31)
...
#### [sysrq](user_mode_linux_howto_v2.md#id32)

This command takes one argument, which is a single letter. It calls the
generic kernel's SysRq driver, which does whatever is called for by
that argument. See the SysRq documentation in
[Linux Magic System Request Key Hacks](../../admin-guide/sysrq.md) in your favorite kernel tree to
see what letters are valid and what they do.

#### [cad](user_mode_linux_howto_v2.md#id33)
...
#### [proc](user_mode_linux_howto_v2.md#id36)

This takes one argument - the name of a file in /proc which is printed
to the mconsole standard output

#### [stack](user_mode_linux_howto_v2.md#id37)

This takes one argument - the pid number of a process. Its stack is
printed to a standard output.

## [Advanced UML Topics](user_mode_linux_howto_v2.md#id38)

### [Sharing Filesystems between Virtual Machines](user_mode_linux_howto_v2.md#id39)

Don't attempt to share filesystems simply by booting two UMLs from the
same file. That's the same thing as booting two physical machines
from a shared disk. It will result in filesystem corruption.

#### [Using layered block devices](user_mode_linux_howto_v2.md#id40)
...
#### [Disk Usage](user_mode_linux_howto_v2.md#id41)
...
#### [COW validity.](user_mode_linux_howto_v2.md#id42)
...
#### [Cows can moo - uml_moo : Merging a COW file with its backing file](user_mode_linux_howto_v2.md#id43)
...
### [Host file access](user_mode_linux_howto_v2.md#id44)
...
#### [Using hostfs](user_mode_linux_howto_v2.md#id45)
...
#### [hostfs as the root filesystem](user_mode_linux_howto_v2.md#id46)
...
#### [Hostfs Caveats](user_mode_linux_howto_v2.md#id47)
...
### [Tuning UML](user_mode_linux_howto_v2.md#id48)
...
## [Contributing to UML and Developing with UML](user_mode_linux_howto_v2.md#id49)
...
### [Tracing UML](user_mode_linux_howto_v2.md#id50)
...
### [Kernel debugging](user_mode_linux_howto_v2.md#id51)
...
### [Developing Device Drivers](user_mode_linux_howto_v2.md#id52)
...
### [Using UML as a Test Platform](user_mode_linux_howto_v2.md#id53)
...
#### [Security Considerations](user_mode_linux_howto_v2.md#id54)
