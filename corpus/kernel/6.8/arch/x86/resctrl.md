...
collection: kernel
version: "6.8"
title: "24. User Interface for Resource Control feature"
source_url: https://www.kernel.org/doc/html/v6.8/arch/x86/resctrl.html
fetched_at: 2026-08-21T03:37:17+00:00
---
...
Authors
:   - Fenghua Yu <[fenghua.yu@intel.com](mailto:fenghua.yu%40intel.com)>
    - Tony Luck <[tony.luck@intel.com](mailto:tony.luck%40intel.com)>
    - Vikas Shivappa <[vikas.shivappa@intel.com](mailto:vikas.shivappa%40intel.com)>
...
### 24.2.1. Resource allocation rules
...
### 24.2.2. Resource monitoring rules
...
### 24.3.1. max_threshold_occupancy - generic concepts
...
### 24.3.2. Schemata files - general concepts
...
## 24.4. Memory bandwidth Allocation and monitoring
...
### 24.4.1. L3 schemata file details (code and data prioritization disabled)
...
### 24.4.2. L3 schemata file details (CDP enabled via mount option to resctrl)
...
### 24.4.3. L2 schemata file details
...
### 24.4.4. Memory bandwidth Allocation (default mode)
...
### 24.4.5. Memory bandwidth Allocation specified in MBps
...
### 24.4.6. Slow Memory Bandwidth Allocation (SMBA)
...
### 24.4.7. Reading/writing the schemata file
...
### 24.4.8. Reading/writing the schemata file (on AMD systems)
...
### 24.4.9. Reading/writing the schemata file (on AMD systems) with SMBA feature
...
### 24.5.1. Cache Pseudo-Locking Interface
...
### 24.5.2. Cache Pseudo-Locking Debugging Interface
...
#### 24.5.2.1. Example of latency debugging interface
...
#### 24.5.2.2. Example of cache hits/misses debugging
...
#### 24.5.2.3. Examples for RDT allocation usage
...
#### 24.5.2.4. Example of Cache Pseudo-Locking
...
### 24.5.3. Locking between applications
...
> 1. Take flock(LOCK_EX) on /sys/fs/resctrl
> 2. Read/write the directory structure.
> 3. funlock

Read lock:

> 1. Take flock(LOCK_SH) on /sys/fs/resctrl
> 2. If success read the directory structure.
> 3. funlock
...
## 24.6. Examples for RDT Monitoring along with allocation usage

### 24.6.1. Reading monitored data

Reading an event file (for ex: mon_data/mon_L3_00/llc_occupancy) would
show the current snapshot of LLC occupancy of the corresponding MON
group or CTRL_MON group.

### 24.6.2. Example 1 (Monitor CTRL_MON group and subset of tasks in CTRL_MON group)
...
### 24.6.3. Example 2 (Monitor a task from its creation)
...
### 24.6.4. Example 3 (Monitor without CAT support or before creating CAT groups)
...
### 24.6.5. Example 4 (Monitor real time tasks)
...
## 24.7. Intel RDT Errata

### 24.7.1. Intel MBM Counters May Report System Memory Bandwidth Incorrectly
