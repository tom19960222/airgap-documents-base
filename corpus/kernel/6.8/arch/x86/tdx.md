...
collection: kernel
version: "6.8"
title: "20. Intel Trust Domain Extensions (TDX)"
source_url: https://www.kernel.org/doc/html/v6.8/arch/x86/tdx.html
fetched_at: 2026-08-21T03:37:14+00:00
---
...
### 20.1.3. TDX Interaction to Other Kernel Components

#### 20.1.3.1. TDX Memory Policy
...
#### 20.1.3.2. Physical Memory Hotplug
...
#### 20.1.3.6. Interaction vs S3 and deeper states
...
to touch every driver. DMA buffers and [`ioremap()`](../../driver-api/device-io.md#c.ioremap "ioremap") do the conversions
automatically.
