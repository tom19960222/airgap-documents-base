...
collection: kernel
version: "6.8"
title: "Hypercall Op-codes (hcalls)"
source_url: https://www.kernel.org/doc/html/v6.8/arch/powerpc/papr_hcalls.html
fetched_at: 2026-08-21T03:36:39+00:00
---
...
specification [1](papr_hcalls.md#id9) which describes the run-time environment for a guest
...
- **Qemu/KVM**: Supports PPC64 linux guests running on a PPC64 linux host.
  Though it only implements a subset of PAPR specification called LoPAPR [2](papr_hcalls.md#id10).

On PPC64 arch a guest kernel running on top of a PAPR hypervisor is called
a *pSeries guest*. A pseries guest runs in a supervisor mode (HV=0) and must
issue hypercalls to the hypervisor whenever it needs to perform an action
that is hypervisor privileged [3](papr_hcalls.md#id11) or for other services managed by the
hypervisor.
...
is covered in section 14.5.3 of ref [2](papr_hcalls.md#id10). Switch to the Hypervisor context is
...
in a arch specific header [4](papr_hcalls.md#id12) to issue hcalls from the linux kernel
running as pseries guest.

## Register Conventions

Any hcall should follow same register convention as described in section 2.2.1.1
of "64-Bit ELF V2 ABI Specification: Power Architecture"[5](papr_hcalls.md#id13). Table below
...
corresponding opcode values please look into the arch specific header [4](papr_hcalls.md#id12):
...
[1](papr_hcalls.md#id1)
:   "Power Architecture Platform Reference"
    <https://en.wikipedia.org/wiki/Power_Architecture_Platform_Reference>

2([1](papr_hcalls.md#id2),[2](papr_hcalls.md#id4))
:   "Linux on Power Architecture Platform Reference"
    <https://members.openpowerfoundation.org/document/dl/469>

[3](papr_hcalls.md#id3)
:   "Definitions and Notation" Book III-Section 14.5.3
    <https://openpowerfoundation.org/?resource_lib=power-isa-version-3-0>

4([1](papr_hcalls.md#id5),[2](papr_hcalls.md#id7),[3](papr_hcalls.md#id8))
:   arch/powerpc/include/asm/hvcall.h

[5](papr_hcalls.md#id6)
