...
collection: kernel
version: "6.8"
title: "PCI Bus EEH Error Recovery"
source_url: https://www.kernel.org/doc/html/v6.8/arch/powerpc/eeh-pci-error-recovery.html
fetched_at: 2026-08-21T03:36:33+00:00
---
# PCI Bus EEH Error Recovery

Linas Vepstas <[linas@austin.ibm.com](mailto:linas%40austin.ibm.com)>
...
[`struct device_driver`](../../driver-api/infrastructure.md#c.device_driver "device_driver")->remove() is just pci_device_remove()
which calls [`struct pci_driver`](../../PCI/pci.md#c.pci_driver "pci_driver")->remove() which is pcnet32_remove_one()
which calls [`unregister_netdev()`](../../networking/kapi.md#c.unregister_netdev "unregister_netdev") (in net/core/dev.c)
which calls [`dev_close()`](../../networking/kapi.md#c.dev_close "dev_close") (in net/core/dev.c)
which calls dev->[`stop()`](../../networking/ieee802154.md#c.stop "stop") which is pcnet32_close()
