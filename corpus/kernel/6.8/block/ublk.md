...
source_url: https://www.kernel.org/doc/html/v6.8/block/ublk.html
fetched_at: 2026-08-21T03:45:05+00:00
---
...
program. `ublksrv` [1](ublk.md#userspace) is one of such implementation. It
provides `libublksrv` [2](ublk.md#userspace-lib) library for developing specific
user block device conveniently, while also generic type block device is
included, such as loop and null. Richard W.M. Jones wrote userspace nbd device
`nbdublk` [3](ublk.md#userspace-nbdublk) based on `libublksrv` [2](ublk.md#userspace-lib).
...
See usage details in README of `ublksrv` [4](ublk.md#userspace-readme).
...
problem [6](ublk.md#xiaoguang) Xiaoguang mentioned is that pages mapped to userspace
