...
collection: kernel
version: "6.8"
title: "7.7. Intel Image Processing Unit 3 (IPU3) Imaging Unit (ImgU) driver"
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/media/ipu3.html
...
### 7.7.2.1. Capturing frames in raw Bayer format
...
Image processing using IPU3 ImgU requires tools such as raw2pnm [2](ipu3.md#f1), and
yavta [3](ipu3.md#f2) due to the following unique requirements and / or features specific
to IPU3.
...
### 7.7.3.2. input, output and viewfinder video nodes
...
### 7.7.3.4. 3A statistics video node
...
## 7.7.4. Configuring the Intel IPU3
...
### 7.7.4.1. Running mode and firmware binary selection
...
### 7.7.4.2. Processing the image in raw Bayer format

#### 7.7.4.2.1. Configuring ImgU V4L2 subdev for image processing
...
V4L2 subdev as below, using the open source application v4l2n [2](ipu3.md#f1).

For an image captured with 2592x1944 [5](ipu3.md#f4) resolution, with desired output
...
You can also use yavta [3](ipu3.md#f2) command to do same thing as above:
...
### 7.7.4.3. Converting the raw Bayer image into YUV domain

The processed images after the above step, can be converted to YUV domain
as below.

#### 7.7.4.3.1. Main output frames
...
#### 7.7.4.3.2. Viewfinder output frames
...
## 7.7.5. Example user space code for IPU3
...
## 7.7.6. Overview of IPU3 pipeline
...
2([1](ipu3.md#id1),[2](ipu3.md#id3))
:   <https://github.com/intel/nvt>

3([1](ipu3.md#id2),[2](ipu3.md#id5))
