...
collection: kernel
version: "6.8"
title: "7.25. The Virtual Video Test Driver (vivid)"
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/media/vivid.html
fetched_at: 2026-08-21T03:56:03+00:00
---
...
### 7.25.2.2. TV and S-Video Inputs
...
## 7.25.8. Software Defined Radio Receiver
...
### 7.25.12.1. User Controls - Test Controls
...
### 7.25.12.2. User Controls - Video Capture
...
#### 7.25.12.4.2. Capture Feature Selection Controls
...
#### 7.25.12.4.3. Output Feature Selection Controls
...
#### 7.25.12.4.4. Error Injection Controls
...
- Inject Fatal Streaming Error:
  ...
  > [`vb2_queue_error()`](../../driver-api/media/v4l2-videobuf2.md#c.vb2_queue_error "vb2_queue_error") function is called.

#### 7.25.12.4.5. VBI Raw Capture Controls
...
### 7.25.12.5. Digital Video Controls
...
### 7.25.12.6. FM Radio Receiver Controls
...
### 7.25.12.7. FM Radio Modulator Controls
...
### 7.25.12.8. Metadata Capture Controls
...
## 7.25.13. Video, VBI and RDS Looping
...
### 7.25.13.1. Video and Sliced VBI looping
...
## 7.25.14. Cropping, Composing, Scaling
...
supported for multiplanar formats. It also honors the [`struct v4l2_window`](../../userspace-api/media/v4l/dev-overlay.md#c.v4l2_window "v4l2_window") field
...
## 7.25.18. CEC (Consumer Electronics Control)
...
## 7.25.19. Some Future Improvements
