...
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/kernel-parameters.html
fetched_at: 2026-08-21T03:34:26+00:00
---
English

- [Italian](../translations/it_IT/admin-guide/kernel-parameters.md)
...
need or coordination with <[The Linux/x86 Boot Protocol](../arch/x86/boot.md)>.

There are also arch-specific kernel-parameters not documented here.
See for example <[AMD64 Specific Boot Options](../arch/x86/x86_64/boot-options.md)>.
