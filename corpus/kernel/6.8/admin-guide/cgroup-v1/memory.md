...
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/cgroup-v1/memory.html
fetched_at: 2026-08-21T03:55:04+00:00
---
...
from the rest of the system. The article on LWN [12](memory.md#id16) mentions some probable
...
| memory.move_charge_at_immigrate | set/show controls of moving charges This knob is deprecated and shouldn't be used. |
...
controller was posted by Balbir Singh [1](memory.md#id10). At the time the RFC was posted
there were several implementations for memory control. The goal of the
RFC was to build consensus and agreement for the minimal features required
for memory control. The first RSS controller was posted by Balbir Singh [2](memory.md#id11)
in Feb 2007. Pavel Emelianov [3](memory.md#id12) [4](memory.md#id13) [5](memory.md#id14) has since posted three versions
...
Cache Control [11](memory.md#id15).
...
But see [section 8.2](memory.md#cgroup-v1-memory-movable-charges) when moving a
...
> of charges should be moved. See [section 8.2](memory.md#cgroup-v1-memory-movable-charges) for details.
