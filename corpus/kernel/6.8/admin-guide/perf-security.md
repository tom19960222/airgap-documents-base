...
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/perf-security.html
fetched_at: 2026-08-21T03:34:59+00:00
---
# Perf events and tool security

## Overview

Usage of Performance Counters for Linux (perf_events) [1](perf-security.md#id32) , [2](perf-security.md#id33) , [3](perf-security.md#id34)
...
direct usage of perf_events system call API [2](perf-security.md#id33) and over data files
generated by Perf tool user mode utility (Perf) [3](perf-security.md#id34) , [4](perf-security.md#id35) . The risk
depends on the nature of data that perf_events performance monitoring
units (PMU) [2](perf-security.md#id33) and Perf collect and expose for performance analysis.
...
3. Content of kernel software counters (e.g., for context switches, page
   ...
   (PMC) [8](perf-security.md#id39) and machine specific registers (MSR) [9](perf-security.md#id40) that provide
...
the subject for security access control management [5](perf-security.md#id36) .

## perf_events access control

To perform security checks, the Linux implementation splits processes
into two categories [6](perf-security.md#id37) : a) privileged processes (whose effective user
...
based on the process's credentials [5](perf-security.md#id36) (usually: effective UID,
effective GID, and supplementary group list).

Linux divides the privileges traditionally associated with superuser
into distinct units, known as capabilities [6](perf-security.md#id37) , which can be
...
privilege [13](perf-security.md#id44) (POSIX 1003.1e: 2.2.2.39) for performance monitoring and
...
If system audit records [14](perf-security.md#id45) for a process using perf_events system call
...
[7](perf-security.md#id38) , whose outcome determines whether monitoring is permitted.
...
Mechanisms of capabilities, privileged capability-dumb files [6](perf-security.md#id37),
file system ACLs [10](perf-security.md#id41) and sudo [15](perf-security.md#id46) utility can be used to create
...
2. Assign the required capabilities to the Perf tool executable file and
   ...
   privileges [6](perf-security.md#id37) :
...
If the libcap [16](perf-security.md#id47) installed doesn't yet support "cap_perfmon", use "38" instead,
i.e.:
...
1. Create shell script that uses capsh utility [16](perf-security.md#id47) to assign CAP_PERFMON
...
or root running processes with CAP_SETPCAP, CAP_SETFCAP [6](perf-security.md#id37)
capabilities.

## Unprivileged users

perf_events *scope* and *access* control for unprivileged processes
is governed by perf_event_paranoid [2](perf-security.md#id33) setting:

-1:
:   Impose no *scope* and *access* restrictions on using perf_events
    performance monitoring. Per-user per-cpu perf_event_mlock_kb [2](perf-security.md#id33)
...
:   *scope* includes per-process and system wide performance monitoring
    ...
    [6](perf-security.md#id37) capability.
...
The perf_events system call API [2](perf-security.md#id33) allocates file descriptors for
every configured PMU event. Open file descriptors are a per-process
accountable resource governed by the RLIMIT_NOFILE [11](perf-security.md#id42) limit
...
modifying content of the limits.conf file [12](perf-security.md#id43) . Ordinarily, a Perf
...
performance monitoring data is governed by the perf_event_mlock_kb [2](perf-security.md#id33)
...
RLIMIT_MEMLOCK [11](perf-security.md#id42) limit, but only for memory regions mapped
...
[1](perf-security.md#id1)
:   <https://lwn.net/Articles/337493/>

2([1](perf-security.md#id2),[2](perf-security.md#id4),[3](perf-security.md#id7),[4](perf-security.md#id24),[5](perf-security.md#id25),[6](perf-security.md#id27),[7](perf-security.md#id30))
:   <http://man7.org/linux/man-pages/man2/perf_event_open.2.html>

3([1](perf-security.md#id3),[2](perf-security.md#id5))
:   <http://web.eece.maine.edu/~vweaver/projects/perf_events/>

[4](perf-security.md#id6)
:   <https://perf.wiki.kernel.org/index.php/Main_Page>

5([1](perf-security.md#id10),[2](perf-security.md#id12))
:   <https://www.kernel.org/doc/html/latest/security/credentials.html>

6([1](perf-security.md#id11),[2](perf-security.md#id13),[3](perf-security.md#id17),[4](perf-security.md#id20),[5](perf-security.md#id23),[6](perf-security.md#id26))
:   <http://man7.org/linux/man-pages/man7/capabilities.7.html>

[7](perf-security.md#id16)
:   <http://man7.org/linux/man-pages/man2/ptrace.2.html>

[8](perf-security.md#id8)
:   <https://en.wikipedia.org/wiki/Hardware_performance_counter>

[9](perf-security.md#id9)
:   <https://en.wikipedia.org/wiki/Model-specific_register>

[10](perf-security.md#id18)
:   <http://man7.org/linux/man-pages/man5/acl.5.html>

11([1](perf-security.md#id28),[2](perf-security.md#id31))
:   <http://man7.org/linux/man-pages/man2/getrlimit.2.html>

[12](perf-security.md#id29)
:   <http://man7.org/linux/man-pages/man5/limits.conf.5.html>

[13](perf-security.md#id14)
:   <https://sites.google.com/site/fullycapable>

[14](perf-security.md#id15)
:   <http://man7.org/linux/man-pages/man8/auditd.8.html>

[15](perf-security.md#id19)
:   <https://man7.org/linux/man-pages/man8/sudo.8.html>

16([1](perf-security.md#id21),[2](perf-security.md#id22))
