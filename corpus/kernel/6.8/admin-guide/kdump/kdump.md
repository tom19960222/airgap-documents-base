...
collection: kernel
version: "6.8"
title: "Documentation for Kdump - The kexec-based Crash Dumping Solution"
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/kdump/kdump.html
...
system crash is triggered. Trigger points are located in [`panic()`](../../driver-api/basics.md#c.panic "panic"),
...
The kernel parameter, panic_on_warn, calls [`panic()`](../../driver-api/basics.md#c.panic "panic") in all WARN() paths. This
will cause a kdump to occur at the [`panic()`](../../driver-api/basics.md#c.panic "panic") call. In cases where a user wants
to specify this during runtime, /proc/sys/kernel/panic_on_warn can be set to 1
to achieve the same behaviour.

## Trigger Kdump on add_taint()

The kernel parameter panic_on_taint facilitates a conditional call to [`panic()`](../../driver-api/basics.md#c.panic "panic")
from within [`add_taint()`](../../driver-api/basics.md#c.add_taint "add_taint") whenever the value set in this bitmask matches with the
bit flag being set by [`add_taint()`](../../driver-api/basics.md#c.add_taint "add_taint").
This will cause a kdump to occur at the [`add_taint()`](../../driver-api/basics.md#c.add_taint "add_taint")->[`panic()`](../../driver-api/basics.md#c.panic "panic") call.
