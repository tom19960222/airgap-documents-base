...
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/ras.html
...
are referred to as the *syndrome*[1](ras.md#f1)[2](ras.md#f2).
...
Each `mc` device controls a set of memory modules [4](ras.md#f4). These modules
...
provided by the `dimmX` or `rankX` directories [5](ras.md#f5).

A typical EDAC system has the following structure under
`/sys/devices/system/edac/`[6](ras.md#f6):
