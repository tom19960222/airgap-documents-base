...
source_url: https://www.kernel.org/doc/html/v6.8/admin-guide/mm/damon/usage.html
fetched_at: 2026-08-21T04:01:49+00:00
---
English
...
- *DAMON user space tool.*
  [This](https://github.com/awslabs/damo) is for privileged people such as
  system administrators who want a just-working human-friendly interface.
  Using this, users can use the DAMON’s major features in a human-friendly way.
  It may not be highly tuned for special cases, though. For more detail,
  please refer to its [usage document](https://github.com/awslabs/damo/blob/next/USAGE.md).
- *sysfs interface.*
  [This](usage.md#sysfs-interface) is for privileged user space programmers who
  want more optimized use of DAMON. Using this, users can use DAMON’s major
  features by reading from and writing to special sysfs files. Therefore,
  you can write and use your personalized DAMON sysfs wrapper programs that
  reads/writes the sysfs files instead of you. The [DAMON user space tool](https://github.com/awslabs/damo) is one example of such programs.
...
- *debugfs interface. (DEPRECATED!)*
  [This](usage.md#debugfs-interface) is almost identical to [sysfs interface](usage.md#sysfs-interface). This is deprecated, so users should move to the
  [sysfs interface](usage.md#sysfs-interface). If you depend on this and cannot
  move, please report your usecase to [damon@lists.linux.dev](mailto:damon%40lists.linux.dev) and
  [linux-mm@kvack.org](mailto:linux-mm%40kvack.org).
...
Please refer to [regions sysfs directory](usage.md#sysfs-regions) for detailed
...
[implementation](usage.md#sysfs-context).
...
The directory for the [filters](../../../mm/damon/design.md#damon-design-damos-filters) of the given
DAMON-based operation scheme.
...
`paddr` [implementation](usage.md#sysfs-context) is being used.

Also, memory regions that are filtered out by `addr` or `target` filters
are not counted as the scheme has tried to those, while regions that filtered
out by other type filters are counted as the scheme has tried to. The
difference is applied to [stats](usage.md#damos-stats) and
[tried regions](usage.md#sysfs-schemes-tried-regions).
...
Please note that it's highly recommended to use user space tools like [damo](https://github.com/awslabs/damo) rather than manually reading and writing
...
attributes in detail, please refer to the [Design](../../../mm/damon/design.md). For
...
Users can get and set the DAMON-based operation [schemes](../../../mm/damon/design.md#damon-design-damos) by reading from and writing to `schemes` debugfs file.
...
The target access [pattern](../../../mm/damon/design.md#damon-design-damos-access-pattern) of the
...
The `<action>` is a predefined integer for memory management [actions](../../../mm/damon/design.md#damon-design-damos-action). The supported numbers and their meanings are as
below.
...
Users can set the [quotas](../../../mm/damon/design.md#damon-design-damos-quotas) of the given scheme
...
For the [prioritization](../../../mm/damon/design.md#damon-design-damos-quotas-prioritization), users
...
Users can specify [watermarks](../../../mm/damon/design.md#damon-design-damos-watermarks) of the
