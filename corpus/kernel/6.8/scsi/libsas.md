...
version: "6.8"
title: "SAS Layer"
source_url: https://www.kernel.org/doc/html/v6.8/scsi/libsas.html
fetched_at: 2026-08-21T03:44:43+00:00
---
# SAS Layer
...
:   - timer expired, loss of signal, loss of DWS, etc. [1](libsas.md#id5)

PORTE_TIMER_EVENT
:   - DWS reset timeout timer expired [1](libsas.md#id5)

PORTE_HARD_RESET
:   - Hard Reset primitive received.

PHYE_LOSS_OF_SIGNAL
:   - the device is gone [1](libsas.md#id5)
...
:   - Error while doing OOB, the device probably
      got disconnected. [1](libsas.md#id5)

PHYE_SPINUP_HOLD
:   - SATA is present, COMWAKE not sent.

1([1](libsas.md#id1),[2](libsas.md#id2),[3](libsas.md#id3),[4](libsas.md#id4))
...
> 1. It shows you the physical layout of the SAS domain at
>    the current time, i.e. how the domain looks in the
>    physical world right now.
> 2. Shows some device parameters _at_discovery_time_.
