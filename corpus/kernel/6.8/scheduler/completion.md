...
source_url: https://www.kernel.org/doc/html/v6.8/scheduler/completion.html
fetched_at: 2026-08-21T03:46:57+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/scheduler/completion.md)
...
[`yield()`](../driver-api/basics.md#c.yield "yield") or some quirky msleep(1) loop to allow something else to proceed,
...
does not happen until all related activities (complete() or [`reinit_completion()`](../driver-api/basics.md#c.reinit_completion "reinit_completion"))
...
The re-initialization function, [`reinit_completion()`](../driver-api/basics.md#c.reinit_completion "reinit_completion"), simply resets the
...
Calling [`init_completion()`](../driver-api/basics.md#c.init_completion "init_completion") on the same completion object twice is
most likely a bug as it re-initializes the queue to an empty queue and
enqueued tasks could get "lost" - use [`reinit_completion()`](../driver-api/basics.md#c.reinit_completion "reinit_completion") in that case,
...
[`DECLARE_COMPLETION()`](../driver-api/basics.md#c.DECLARE_COMPLETION "DECLARE_COMPLETION"):
...
initialized to 'not done' and doesn't require an [`init_completion()`](../driver-api/basics.md#c.init_completion "init_completion") call.

When a completion is declared as a local variable within a function,
then the initialization should always use [`DECLARE_COMPLETION_ONSTACK()`](../driver-api/basics.md#c.DECLARE_COMPLETION_ONSTACK "DECLARE_COMPLETION_ONSTACK")
...
A naive [`DECLARE_COMPLETION()`](../driver-api/basics.md#c.DECLARE_COMPLETION "DECLARE_COMPLETION") on the stack triggers a lockdep warning.
...
Timeouts are preferably calculated with [`msecs_to_jiffies()`](../driver-api/basics.md#c.msecs_to_jiffies "msecs_to_jiffies") or [`usecs_to_jiffies()`](../driver-api/basics.md#c.usecs_to_jiffies "usecs_to_jiffies"),
