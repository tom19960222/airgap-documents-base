...
collection: kernel
version: "6.8"
title: "Estilo en el código del kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.8/translations/sp_SP/process/coding-style.html
fetched_at: 2026-08-21T03:37:36+00:00
---
Spanish

- [English](../../../process/coding-style.md)
- [Chinese (Simplified)](../../zh_CN/process/coding-style.md)
- [Chinese (Traditional)](../../zh_TW/process/coding-style.md)
- [Italian](../../it_IT/process/coding-style.md)
...
Original
:   [Documentation/process/coding-style.rst](../../../process/submitting-patches.md#submittingpatches)
...
> 1. objetos totalmente opacos (donde el typedef se usa activamente para
...
>    > forma portátil allí.
> 2. Tipos enteros claros, donde la abstracción **ayuda** a evitar
...
> 3. cuando lo use para crear literalmente un tipo **nuevo** para
>    comprobación de tipos.
> 4. Nuevos tipos que son idénticos a los tipos estándar C99, en ciertas
...
> 5. Tipos seguros para usar en el espacio de usuario.
>
...
Al escribir prototipos de funciones, mantenga el [orden de los elementos regular](https://lore.kernel.org/mm-commits/CAHk-=wiOCLRny5aifWNhr621kYrJwhfURsa0vFPeUEm8mF0ufg@mail.gmail.com/).
...
kernel-doc. Consulte los archivos en [Documentation/doc-guide/](../../../doc-guide/index.md#doc-guide)
...
[Documentation/process/clang-format.rst](../../../process/clang-format.md#clangformat) para más
detalles.
...
consulte el archivo [Kconfig Language](../../../kbuild/kconfig-language.md).
...
[`pr_notice()`](../../../core-api/printk-basics.md#c.pr_notice "pr_notice"), [`pr_info()`](../../../core-api/printk-basics.md#c.pr_info "pr_info"), [`pr_warn()`](../../../core-api/printk-basics.md#c.pr_warn "pr_warn"), [`pr_err()`](../../../core-api/printk-basics.md#c.pr_err "pr_err"), etc.
...
[`pr_debug()`](../../../core-api/printk-basics.md#c.pr_debug "pr_debug") no lo hace; se compila fuera por defecto, a menos que DEBUG sea
...
general: [`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc"), [`kzalloc()`](../../../core-api/mm-api.md#c.kzalloc "kzalloc"), [`kmalloc_array()`](../../../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"), [`kcalloc()`](../../../core-api/mm-api.md#c.kcalloc "kcalloc"), [`vmalloc()`](../../../core-api/mm-api.md#c.vmalloc "vmalloc") y
[`vzalloc()`](../../../core-api/mm-api.md#c.vzalloc "vzalloc"). Consulte la documentación de la API para obtener más información.
a cerca de ellos. [Documentation/core-api/memory-allocation.rst](../../../core-api/memory-allocation.md#memory-allocation)
...
este último caso, véase la función en línea [`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc").
...
función [`pci_dev_present()`](../../../driver-api/pci/pci.md#c.pci_dev_present "pci_dev_present") devuelve 1 si tiene éxito en encontrar un
...
[`panic()`](../../../driver-api/basics.md#c.panic "panic") debe usarse con cuidado y principalmente solo durante el arranque
del sistema. [`panic()`](../../../driver-api/basics.md#c.panic "panic") es, por ejemplo, aceptable cuando se queda sin memoria
...
[process/coding-style.rst](../../../process/coding-style.md#codingstyle) del kernel, por [greg@kroah.com](mailto:greg%40kroah.com) at OLS 2002:
