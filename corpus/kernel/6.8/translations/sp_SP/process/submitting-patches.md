...
collection: kernel
version: "6.8"
title: "Envío de parches: la guía esencial para incluir su código en el kernel"
source_url: https://www.kernel.org/doc/html/v6.8/translations/sp_SP/process/submitting-patches.html
fetched_at: 2026-08-21T03:29:17+00:00
---
Spanish
...
- [Italian](../../it_IT/process/submitting-patches.md)
...
[A guide to the Kernel Development Process](../../../process/development-process.md). Además, lea
[Linux Kernel patch submission checklist](../../../process/submit-checklist.md) para obtener una lista de
elementos a verificar antes de enviar código. Para los parches de
"binding" del árbol de dispositivos, lea
[Submitting Devicetree (DT) binding patches](../../../devicetree/bindings/submitting-patches.md).
...
[Documentation/process/maintainer-handbooks.rst](../../../process/maintainer-handbooks.md#maintainer-handbooks-main).
...
Consulte [Formato de parche canónico](submitting-patches.md#sp-the-canonical-patch-format).
...
Lea [Separate your changes](../../../process/submitting-patches.md#split-changes).
...
detalles pueden ser encontrados en [Linux kernel coding style](../../../process/coding-style.md).
...
([akpm@linux-foundation.org](mailto:akpm%40linux-foundation.org)) sirve como maintainer de último recurso.

Normalmente, también debe elegir al menos una lista de correo para recibir
una copia de su conjunto de parches. [linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org) debe
...
<[torvalds@linux-foundation.org](mailto:torvalds%40linux-foundation.org)>. Recibe muchos correos electrónicos y, en
...
parche a [security@kernel.org](mailto:security%40kernel.org). Para errores graves, se debe mantener un
...
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.md) además de este documento.
...
Consulte [Email clients info for Linux](../../../process/email-clients.md) para obtener sugerencias
...
[Formato de parche canónico](submitting-patches.md#sp-the-canonical-patch-format)).

Consulte [Email clients info for Linux](../../../process/email-clients.md) para obtener
...
> 1. La contribución fue creada en su totalidad o en parte por mí y
>    tengo derecho a enviarlo bajo la licencia de código abierto
>    indicada en el documento; o
> 2. La contribución se basa en trabajo previo que, hasta donde yo
...
> 3. La contribución me fue proporcionada directamente por alguna
>    otra persona que certificó (a), (b) o (c) y no he modificado
>    esto.
> 4. Entiendo y acepto que este proyecto y la contribución
...
[Describe your changes](../../../process/submitting-patches.md#describe-changes) para más detalles.

Nota: Adjuntar una etiqueta Fixes: no subvierte las reglas estables del
proceso del kernel ni el requisito de CC: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) en todos
...
NO!!!! Gente, no mas bombas enormes de parches a [linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org)!
:   <<https://lore.kernel.org/r/20050711.125305.08322243.davem@davemloft.net>>

Kernel [Linux kernel coding style](../../../process/coding-style.md)
