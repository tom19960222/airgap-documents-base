...
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/devicetree/of_unittest.html
...
调用detach_node_and_children()，使用[`of_detach_node()`](../../../devicetree/kernel-api.md#c.of_detach_node "of_detach_node")将节点从实时设备树上分离。
