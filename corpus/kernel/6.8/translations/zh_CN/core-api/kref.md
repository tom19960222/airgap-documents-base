...
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/core-api/kref.html
...
上面的例子中在持有锁的情况下调用[`kfree()`](../../../core-api/mm-api.md#c.kfree "kfree")（因为这样做有点无意义）。你可以使用kref_put()，
如下所示:
