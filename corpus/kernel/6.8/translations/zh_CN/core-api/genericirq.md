...
version: "6.8"
title: "Linux通用IRQ处理"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/core-api/genericirq.html
fetched_at: 2026-08-21T03:45:55+00:00
---
Chinese (Simplified)

- [English](../../../core-api/genericirq.md)
...
Original
:   [Linux generic IRQ handling](../../../core-api/genericirq.md)
...
- [`request_irq()`](../../../core-api/genericirq.md#c.request_irq "request_irq")
- [`request_threaded_irq()`](../../../core-api/genericirq.md#c.request_threaded_irq "request_threaded_irq")
- [`free_irq()`](../../../core-api/genericirq.md#c.free_irq "free_irq")
- [`disable_irq()`](../../../core-api/genericirq.md#c.disable_irq "disable_irq")
- [`enable_irq()`](../../../core-api/genericirq.md#c.enable_irq "enable_irq")
- [`disable_irq_nosync()`](../../../core-api/genericirq.md#c.disable_irq_nosync "disable_irq_nosync") (SMP only)
- [`synchronize_irq()`](../../../core-api/genericirq.md#c.synchronize_irq "synchronize_irq") (SMP only)
- [`irq_set_irq_type()`](../../../core-api/genericirq.md#c.irq_set_irq_type "irq_set_irq_type")
- [`irq_set_irq_wake()`](../../../core-api/genericirq.md#c.irq_set_irq_wake "irq_set_irq_wake")
- [`irq_set_handler_data()`](../../../core-api/genericirq.md#c.irq_set_handler_data "irq_set_handler_data")
- [`irq_set_chip()`](../../../core-api/genericirq.md#c.irq_set_chip "irq_set_chip")
- [`irq_set_chip_data()`](../../../core-api/genericirq.md#c.irq_set_chip_data "irq_set_chip_data")
...
- [`handle_level_irq()`](../../../core-api/genericirq.md#c.handle_level_irq "handle_level_irq")
- [`handle_edge_irq()`](../../../core-api/genericirq.md#c.handle_edge_irq "handle_edge_irq")
- [`handle_fasteoi_irq()`](../../../core-api/genericirq.md#c.handle_fasteoi_irq "handle_fasteoi_irq")
- [`handle_simple_irq()`](../../../core-api/genericirq.md#c.handle_simple_irq "handle_simple_irq")
- [`handle_percpu_irq()`](../../../core-api/genericirq.md#c.handle_percpu_irq "handle_percpu_irq")
- [`handle_edge_eoi_irq()`](../../../core-api/genericirq.md#c.handle_edge_eoi_irq "handle_edge_eoi_irq")
- [`handle_bad_irq()`](../../../core-api/genericirq.md#c.handle_bad_irq "handle_bad_irq")
...
每个中断可选择的功能是由Russell King在ARM中断实现中引入的，当调用[`disable_irq()`](../../../core-api/genericirq.md#c.disable_irq "disable_irq")
...
IRQ_PENDING位被设置。当中断被[`enable_irq()`](../../../core-api/genericirq.md#c.enable_irq "enable_irq")重新启用时，将检查挂起位，如果它被设置，
...
芯片级硬件描述符结构体 [`irq_chip`](../../../core-api/genericirq.md#c.irq_chip "irq_chip") 包含了所有与芯片直接相关的功能，这些功
能可以被irq流实现所利用。
