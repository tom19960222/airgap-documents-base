...
version: "6.8"
title: "内核骇客指北"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/kernel-hacking/hacking.html
...
`udelay()` 和 `ndelay()` 函数可被用于小暂停。不要对它们使用
大的值，因为这样会导致溢出——帮助函数 `mdelay()` 在这里很有用，或者
考虑 [`msleep()`](../../../driver-api/basics.md#c.msleep "msleep")。
...
通常 [`list_for_each_entry()`](../../../core-api/kernel-api.md#c.list_for_each_entry "list_for_each_entry") 很有用。
