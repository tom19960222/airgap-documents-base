...
version: "6.8"
title: "传统GPIO接口"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/driver-api/gpio/legacy.html
fetched_at: 2026-08-21T03:46:38+00:00
---
Chinese (Simplified)

- [English](../../../../driver-api/gpio/legacy.md)
...
Original
:   [Legacy GPIO Interfaces](../../../../driver-api/gpio/legacy.md)

翻译
:   傅炜 Fu Wei <[tekkamanninja@gmail.com](mailto:tekkamanninja%40gmail.com)>
...
gpio_to_irq()返回的非错误值可以传递给 [`request_irq()`](../../../../core-api/genericirq.md#c.request_irq "request_irq")或者 [`free_irq()`](../../../../core-api/genericirq.md#c.free_irq "free_irq")。
...
[PINCTRL (PIN CONTROL) subsystem](../../../../driver-api/pin-control.md)
...
对于非DT支持，用户可以用适当的参数调用[`gpiochip_add_pin_range()`](../../../../driver-api/gpio/index.md#c.gpiochip_add_pin_range "gpiochip_add_pin_range")，将一
...
在框架中每个 GPIO 控制器都包装为一个 "[`struct gpio_chip`](../../../../driver-api/gpio/index.md#c.gpio_chip "gpio_chip")"，他包含了
该类型的每个控制器的常用信息:
...
但在必要的时候可以使用 [`gpiochip_remove()`](../../../../driver-api/gpio/index.md#c.gpiochip_remove "gpiochip_remove")。
