...
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_CN/dev-tools/gcov.html
...
（见 [编译机和测试机分离 a.](gcov.md#gcov-test-zh) ）
...
（见 [编译机和测试机分离 b.](gcov.md#gcov-build-zh) ）
