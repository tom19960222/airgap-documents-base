...
source_url: https://www.kernel.org/doc/html/v6.8/translations/it_IT/kernel-hacking/hacking.html
fetched_at: 2026-08-21T03:54:31+00:00
---
Italian
...
Le funzioni `udelay()` e `ndelay()` possono essere utilizzate
per brevi pause. Non usate grandi valori perché rischiate d'avere un
overflow - in questo contesto la funzione `mdelay()` è utile,
oppure considerate [`msleep()`](../../../driver-api/basics.md#c.msleep "msleep").
...
In particolare, [`list_for_each_entry()`](../../../core-api/kernel-api.md#c.list_for_each_entry "list_for_each_entry") è utile.
