...
collection: kernel
version: "6.8"
title: "Tutto quello che volevate sapere sui rilasci -stable di Linux"
source_url: https://www.kernel.org/doc/html/v6.8/translations/it_IT/process/stable-kernel-rules.html
...
- [Chinese (Traditional)](../../zh_TW/process/stable-kernel-rules.md)
...
[stable@vger.kernel.org](mailto:stable%40vger.kernel.org) includendo: il titolo della patch, l'identificativo
...
precedenza, a [stable@vger.kernel.org](mailto:stable%40vger.kernel.org). Dovete annotare nel changelog
l'identificativo del commit nei sorgenti principali, così come la versione
del kernel nel quale vorreste vedere la patch.

L'[Opzione 1](stable-kernel-rules.md#it-option-1) è fortemente raccomandata; è il modo più facile e usato.
L'[Opzione 2](stable-kernel-rules.md#it-option-2) e l'[Opzione 3](stable-kernel-rules.md#it-option-3) sono più utili quando, al momento
...
fare più verifiche per eventuali regressioni). L'[Opzione 3](stable-kernel-rules.md#it-option-3) è
...
Notate che per l'[Opzione 3](stable-kernel-rules.md#it-option-3), se la patch è diversa da quella nei
...
In aggiunta, alcune patch inviate attraverso l'[Opzione 1](stable-kernel-rules.md#it-option-1) potrebbero
