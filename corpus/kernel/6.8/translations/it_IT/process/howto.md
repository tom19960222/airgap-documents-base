...
collection: kernel
version: "6.8"
title: "Come partecipare allo sviluppo del kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.8/translations/it_IT/process/howto.html
fetched_at: 2026-08-21T03:42:03+00:00
---
Italian

- [English](../../../process/howto.md)
- [Chinese (Simplified)](../../zh_CN/process/howto.md)
- [Chinese (Traditional)](../../zh_TW/process/howto.md)
- [Spanish](../../sp_SP/process/howto.md)
...
Original
:   [Documentation/process/howto.rst](../../../process/howto.md#process-howto)
...
queste pagine all'indirizzo [mtk.manpages@gmail.com](mailto:mtk.manpages%40gmail.com), aggiungendo
in CC la lista [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).

Di seguito una lista di file che sono presenti nei sorgente del kernel e che
è richiesto che voi leggiate:

> [Documentation/translations/it_IT/admin-guide/README.rst](../admin-guide/README.md#it-readme)
...
>
> [Documentation/translations/it_IT/process/changes.rst](changes.md#it-changes)
>
> > Questo file fornisce una lista dei pacchetti software necessari
> > a compilare e far funzionare il kernel con successo.
>
> [Documentation/translations/it_IT/process/coding-style.rst](coding-style.md#it-codingstyle)
>
...
>
> [Documentation/translations/it_IT/process/submitting-patches.rst](submitting-patches.md#it-submittingpatches)
>
...
>
> [Documentation/translations/it_IT/process/stable-api-nonsense.rst](stable-api-nonsense.md#it-stable-api-nonsense)
>
...
>
> [Documentation/translations/it_IT/admin-guide/security-bugs.rst](../admin-guide/security-bugs.md#it-securitybugs)
...
>
> [Documentation/translations/it_IT/process/management-style.rst](management-style.md#it-managementstyle)
...
>
> [Documentation/translations/it_IT/process/stable-kernel-rules.rst](stable-kernel-rules.md#it-stable-kernel-rules)
...
>
> [Documentation/translations/it_IT/process/kernel-docs.rst](kernel-docs.md#it-kernel-docs)
...
>
> [Documentation/translations/it_IT/process/applying-patches.rst](applying-patches.md#it-applying-patches)
...
4.x.y sono amministrati dal gruppo "stable" <[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)>, e sono
...
Il file [Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.md) (nei sorgenti) documenta
...
Il file '[Reporting issues](../../../admin-guide/reporting-issues.md)' nella
...
leggibili come indicato in [Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.md).
...
Manutentore: Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
