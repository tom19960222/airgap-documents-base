...
collection: kernel
version: "6.8"
title: "Linux內核6.x版本 < http://kernel.org/ >"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_TW/admin-guide/README.html
fetched_at: 2026-08-21T03:54:33+00:00
---
Chinese (Traditional)

- [English](../../../admin-guide/README.md)
- [Chinese (Simplified)](../../zh_CN/admin-guide/README.md)
- [Italian](../../it_IT/admin-guide/README.md)
...
Original
:   [Linux kernel release 6.x <http://kernel.org/>](../../../admin-guide/README.md)
...
>   內核安裝說明。請閱讀
>   [Documentation/process/changes.rst](../../../process/changes.md#changes) 文件，它包含了升級內核
>   可能會導致的問題的相關信息。
...
>   [Kconfig make config](../../../kbuild/kconfig.md)。
> - `make config` 注意事項:
>
...
>   >   內核問題，從而降低內核的穩定性（[`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc")）。因此，您可能應該
>   >   用於研究“開發”、“實驗”或“調試”特性相關問題。

## 編譯內核

> - 確保您至少有gcc 5.1可用。
>   有關更多信息，請參閱 [Documentation/process/changes.rst](../../../process/changes.md#changes) 。
...
[报告问题](../../zh_CN/admin-guide/reporting-issues.md) 。

想要理解內核錯誤報告，請參閱：
[追踪缺陷](../../zh_CN/admin-guide/bug-hunting.md) 。

更多用GDB調試內核的信息，請參閱：
[通过gdb调试内核和模块](../../zh_CN/dev-tools/gdb-kernel-debugging.md)
和 [Using kgdb, kdb and the kernel debugger internals](../../../dev-tools/kgdb.md) 。
