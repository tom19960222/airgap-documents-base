...
collection: kernel
version: "6.8"
title: "在Linux內核裏使用gcov做代碼覆蓋率檢查"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_TW/dev-tools/gcov.html
fetched_at: 2026-08-21T03:54:29+00:00
---
Chinese (Traditional)

- [English](../../../dev-tools/gcov.md)
- [Chinese (Simplified)](../../zh_CN/dev-tools/gcov.md)
...
Original
:   [Using gcov with the Linux kernel](../../../dev-tools/gcov.md)
...
gcov分析核心支持在Linux內核中啓用GCC的覆蓋率測試工具 [gcov](https://gcc.gnu.org/onlinedocs/gcc/Gcov.html) ，Linux內核
...
在獲得這些統計文件後，可以使用圖形化的gcov前端工具（比如 [lcov](http://ltp.sourceforge.net/coverage/lcov.php) ），來實現
...
如果編譯器是GCC，使用 [gcov](https://gcc.gnu.org/onlinedocs/gcc/Gcov.html) 來處理.gcno和.gcda文件，如果是Clang編譯器，
則使用 [llvm-cov](https://llvm.org/docs/CommandGuide/llvm-cov.html) 。
...
（見 [編譯機和測試機分離 a.](../../zh_CN/dev-tools/gcov.md#gcov-test-zh) ）
...
（見 [編譯機和測試機分離 b.](../../zh_CN/dev-tools/gcov.md#gcov-build-zh) ）
