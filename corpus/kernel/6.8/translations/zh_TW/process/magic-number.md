...
version: "6.8"
title: "Linux 魔術數"
source_url: https://www.kernel.org/doc/html/v6.8/translations/zh_TW/process/magic-number.html
fetched_at: 2026-08-21T03:45:24+00:00
---
Chinese (Traditional)

- [English](../../../process/magic-number.md)
- [Chinese (Simplified)](../../zh_CN/process/magic-number.md)
- [Italian](../../it_IT/process/magic-number.md)
- [Spanish](../../sp_SP/process/magic-number.md)
...
Original
:   [Documentation/process/magic-number.rst](../../../process/magic-number.md#magicnumbers)
...
> Michael Chastain
> <[mailto:mec@shout.net](mailto:mec%40shout.net)>
> 22 Sep 1997

現在應該最新的Linux 2.1.112.因爲在特性凍結期間，不能在2.2.x前改變任何東西。這些條目被數域所排序。

> Krzysztof G.Baranowski
> <mailto: [kgb@knm.org.pl](mailto:kgb%40knm.org.pl)>
> 29 Jul 1998

更新魔術表到Linux 2.5.45。剛好越過特性凍結，但是有可能還會有一些新的魔術值在2.6.x之前融入到內核中。

> Petr Baudis
> <[pasky@ucw.cz](mailto:pasky%40ucw.cz)>
> 03 Nov 2002

更新魔術表到Linux 2.5.74。

> Fabian Frederick
> <[ffrederick@users.sourceforge.net](mailto:ffrederick%40users.sourceforge.net)>
> 09 Jul 2003
