...
source_url: https://www.kernel.org/doc/html/v6.8/bpf/bpf_devel_QA.html
fetched_at: 2026-08-21T04:01:08+00:00
---
...
## [Stable submission](bpf_devel_QA.md#id20)

### [Q: I need a specific BPF commit in stable kernels. What should I do?](bpf_devel_QA.md#id21)
...
### [Q: Do you also backport to kernels not currently maintained as stable?](bpf_devel_QA.md#id22)
...
### [Q: The BPF patch I am about to submit needs to go to stable as well](bpf_devel_QA.md#id23)
...
### [Q: Queue stable patches](bpf_devel_QA.md#id24)
...
## [Testing patches](bpf_devel_QA.md#id25)

### [Q: How to run BPF selftests](bpf_devel_QA.md#id26)
...
[commit 21507cd3e97b ("pahole: add libbpf as submodule under lib/bpf")](https://git.kernel.org/torvalds/c/21507cd3e97b).
...
### [Q: Which BPF kernel selftests version should I run my kernel against?](bpf_devel_QA.md#id27)
...
## [LLVM](bpf_devel_QA.md#id28)

### [Q: Where do I find LLVM with BPF support?](bpf_devel_QA.md#id29)
...
### [Q: Got it, so how do I build LLVM manually anyway?](bpf_devel_QA.md#id30)
...
### [Q: Reporting LLVM BPF issues](bpf_devel_QA.md#id31)
...
### [Q: New BPF instruction for kernel and LLVM](bpf_devel_QA.md#id32)
...
### [Q: clang flag for target bpf?](bpf_devel_QA.md#id33)
