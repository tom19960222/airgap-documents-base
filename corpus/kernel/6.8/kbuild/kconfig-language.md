...
source_url: https://www.kernel.org/doc/html/v6.8/kbuild/kconfig-language.html
fetched_at: 2026-08-21T03:35:11+00:00
---
# Kconfig Language
...
>
>     1. A new Kconfig option for something that used to always be built
>        should be "default y".
>     2. A new gatekeeping Kconfig option that hides/shows other Kconfig
>        options (but does not generate any code of its own), should be
>        "default y" so people will see those other options.
>     3. Sub-driver behavior or similar options for a driver that is
>        "default n". This allows you to provide sane defaults.
>     4. Hardware or infrastructure that everybody expects, such as CONFIG_NET
...
one study has completed a broad analysis of Kconfig use in 12 projects [0](kconfig-language.md#id10).
Despite its widespread use, and although this document does a reasonable job
in documenting basic Kconfig syntax a more precise definition of Kconfig
semantics is welcomed. One project deduced Kconfig semantics through
the use of the xconfig configurator [1](kconfig-language.md#id11). Work should be done to confirm if
the deduced semantics matches our intended Kconfig design goals.
Another project formalized a denotational semantics of a core subset of
the Kconfig language [10](kconfig-language.md#id26).
...
Linux using this methodology [1](kconfig-language.md#id11) (Section 8: Threats to validity).
The kismet tool, based on the semantics in [10](kconfig-language.md#id26), finds abuses of reverse
dependencies and has led to dozens of committed fixes to Linux Kconfig files [11](kconfig-language.md#id27).

Confirming this could prove useful as Kconfig stands as one of the leading
industrial variability modeling languages [1](kconfig-language.md#id11) [2](kconfig-language.md#id12). Its study would help
evaluate practical uses of such languages, their use was only theoretical
and real world requirements were not well understood. As it stands though
only reverse engineering techniques have been used to deduce semantics from
variability modeling languages such as Kconfig [3](kconfig-language.md#id13).

[0](kconfig-language.md#id1)
:   <https://www.eng.uwaterloo.ca/~shshe/kconfig_semantics.pdf>

1([1](kconfig-language.md#id2),[2](kconfig-language.md#id4),[3](kconfig-language.md#id7))
:   <https://gsd.uwaterloo.ca/sites/default/files/vm-2013-berger.pdf>

[2](kconfig-language.md#id8)
:   <https://gsd.uwaterloo.ca/sites/default/files/ase241-berger_0.pdf>

[3](kconfig-language.md#id9)
:   <https://gsd.uwaterloo.ca/sites/default/files/icse2011.pdf>

### Full SAT solver for Kconfig

Although SAT solvers [4](kconfig-language.md#id20) haven't yet been used by Kconfig directly, as noted
in the previous subsection, work has been done however to express in boolean
abstraction the inferred semantics of Kconfig to translate Kconfig logic into
boolean formulas and run a SAT solver on it [5](kconfig-language.md#id21). Another known related project
is CADOS [6](kconfig-language.md#id22) (former VAMOS [7](kconfig-language.md#id23)) and the tools, mainly undertaker [8](kconfig-language.md#id24), which
has been introduced first with [9](kconfig-language.md#id25). The basic concept of undertaker is to
...
[4](kconfig-language.md#id14)
:   <https://www.cs.cornell.edu/~sabhar/chapters/SATSolvers-KR-Handbook.pdf>

[5](kconfig-language.md#id15)
:   <https://gsd.uwaterloo.ca/sites/default/files/vm-2013-berger.pdf>

[6](kconfig-language.md#id16)
:   <https://cados.cs.fau.de>

[7](kconfig-language.md#id17)
:   <https://vamos.cs.fau.de>

[8](kconfig-language.md#id18)
:   <https://undertaker.cs.fau.de>

[9](kconfig-language.md#id19)
:   <https://www4.cs.fau.de/Publications/2011/tartler_11_eurosys.pdf>

10([1](kconfig-language.md#id3),[2](kconfig-language.md#id5))
:   <https://paulgazzillo.com/papers/esecfse21.pdf>

[11](kconfig-language.md#id6)
