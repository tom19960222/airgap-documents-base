...
collection: kernel
version: "6.8"
title: "3. Multi-touch (MT) Protocol"
source_url: https://www.kernel.org/doc/html/v6.8/input/multi-touch-protocol.html
fetched_at: 2026-08-21T03:43:37+00:00
---
# 3. Multi-touch (MT) Protocol

Copyright
:   © 2009-2010 Henrik Rydberg <[rydberg@euromail.se](mailto:rydberg%40euromail.se)>
...
[`input_mt_slot()`](../driver-api/input.md#c.input_mt_slot "input_mt_slot"), with a slot as argument, at the beginning of each packet.
...
the raw data [5](multi-touch-protocol.md#f5).

For type A devices, the kernel driver should generate an arbitrary
enumeration of the full set of anonymous contacts currently on the
surface. The order in which the packets appear in the event stream is not
important. Event filtering and finger tracking is left to user space [3](multi-touch-protocol.md#f3).
...
use_count to false when calling [`input_mt_report_pointer_emulation()`](../driver-api/input.md#c.input_mt_report_pointer_emulation "input_mt_report_pointer_emulation").
...
may be used to track identified contacts over time [5](multi-touch-protocol.md#f5).

In the type B protocol, ABS_MT_TOOL_TYPE and ABS_MT_TRACKING_ID are
implicitly handled by input core; drivers should instead call
[`input_mt_report_slot_state()`](../driver-api/input.md#c.input_mt_report_slot_state "input_mt_report_slot_state").
...
:   The length of the major axis of the contact. The length should be given in
    ...
    possible value of ABS_MT_TOUCH_MAJOR is sqrt(X^2 + Y^2), the diagonal [4](multi-touch-protocol.md#f4).

ABS_MT_TOUCH_MINOR
:   The length, in surface units, of the minor axis of the contact. If the
    contact is circular, this event can be omitted [4](multi-touch-protocol.md#f4).

ABS_MT_WIDTH_MAJOR
:   The length, in surface units, of the major axis of the approaching
    tool. This should be understood as the size of the tool itself. The
    orientation of the contact and the approaching tool are assumed to be the
    same [4](multi-touch-protocol.md#f4).

ABS_MT_WIDTH_MINOR
:   The length, in surface units, of the minor axis of the approaching
    tool. Omit if circular [4](multi-touch-protocol.md#f4).
...
:   The pressure, in arbitrary units, on the contact area. May be used instead
    ...
    [Input event codes](event-codes.md#input-event-codes) for details.
...
:   The orientation of the touching ellipse. The value should describe a signed
    ...
    ABS_MT_ORIENTATION should be [0, 1] [4](multi-touch-protocol.md#f4).
...
:   The surface Y coordinate of the center of the approaching tool. Omit if the
    ...
    tool axis points towards the touch point [1](multi-touch-protocol.md#f1). Otherwise, the tool axes are
...
:   The type of approaching tool. A lot of kernel drivers cannot distinguish
    ...
    MT_TOOL_FINGER, MT_TOOL_PEN, and MT_TOOL_PALM [2](multi-touch-protocol.md#f2).
    For type B devices, this event is handled by input core; drivers should
    instead use [`input_mt_report_slot_state()`](../driver-api/input.md#c.input_mt_report_slot_state "input_mt_report_slot_state"). A contact's ABS_MT_TOOL_TYPE may
...
:   The BLOB_ID groups several packets together into one arbitrarily shaped
    ...
    should not be confused with the high-level trackingID [5](multi-touch-protocol.md#f5). Most type A
    devices do not have blob capability, so drivers can safely omit this event.

ABS_MT_TRACKING_ID
:   The TRACKING_ID identifies an initiated contact throughout its life cycle
    [5](multi-touch-protocol.md#f5). The value range of the TRACKING_ID should be large enough to ensure
    unique identification of a contact maintained over an extended period of
    time. For type B devices, this event is handled by input core; drivers
    should instead use [`input_mt_report_slot_state()`](../driver-api/input.md#c.input_mt_report_slot_state "input_mt_report_slot_state").
...
implementation can be found in [3](multi-touch-protocol.md#f3).
...
[1](multi-touch-protocol.md#id9)
:   Also, the difference (TOOL_X - POSITION_X) can be used to model tilt.

[2](multi-touch-protocol.md#id10)
:   The list can of course be extended.

3([1](multi-touch-protocol.md#id2),[2](multi-touch-protocol.md#id13))
:   The mtdev project: <http://bitmath.org/code/mtdev/>.

4([1](multi-touch-protocol.md#id4),[2](multi-touch-protocol.md#id5),[3](multi-touch-protocol.md#id6),[4](multi-touch-protocol.md#id7),[5](multi-touch-protocol.md#id8))
:   See the section on event computation.

5([1](multi-touch-protocol.md#id1),[2](multi-touch-protocol.md#id3),[3](multi-touch-protocol.md#id11),[4](multi-touch-protocol.md#id12))
