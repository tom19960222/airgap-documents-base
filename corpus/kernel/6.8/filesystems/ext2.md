...
source_url: https://www.kernel.org/doc/html/v6.8/filesystems/ext2.html
...
| dax |  | Use direct access (no page cache). See [Direct Access for files](dax.md). |
...
| Compression [1](ext2.md#id5) | <http://e2compr.sourceforge.net/> |
...
| Windows 95 [1](ext2.md#id5) | <http://www.yipton.net/content.html#FSDEXT2> |
| DOS client [1](ext2.md#id5) | <ftp://metalab.unc.edu/pub/Linux/system/filesystems/ext2/> |
| OS/2 [2](ext2.md#id6) | <ftp://metalab.unc.edu/pub/Linux/system/filesystems/ext2/> |
| RISC OS client | <http://www.esw-heim.tu-clausthal.de/~marco/smorbrod/IscaFS/> |

1([1](ext2.md#id1),[2](ext2.md#id2),[3](ext2.md#id3))
