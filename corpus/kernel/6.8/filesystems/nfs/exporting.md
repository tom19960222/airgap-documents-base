...
collection: kernel
version: "6.8"
title: "Making Filesystems Exportable"
source_url: https://www.kernel.org/doc/html/v6.8/filesystems/nfs/exporting.html
fetched_at: 2026-08-21T03:43:08+00:00
---
...
1. A dentry flag DCACHE_DISCONNECTED which is set on
   ...
   umount.
2. A primitive for creation of secondary roots - d_obtain_root(inode).
...
>     it's own ->lock() functionality as core [`posix_lock_file()`](../api-summary.md#c.posix_lock_file "posix_lock_file") implementation
>     has no async lock request handling yet. For more information about how to
>     indicate an async lock request from a ->lock() file_operations struct, see
>     fs/locks.c and comment for the function [`vfs_lock_file()`](../api-summary.md#c.vfs_lock_file "vfs_lock_file").
