...
collection: kernel
version: "6.8"
title: "Network Filesystem Helper Library"
source_url: https://www.kernel.org/doc/html/v6.8/filesystems/netfs_library.html
fetched_at: 2026-08-21T03:39:43+00:00
---
...
>
>   There is no return value; the [`netfs_subreq_terminated()`](netfs_library.md#c.netfs_subreq_terminated "netfs_subreq_terminated") function should be
...
> - `check_write_begin()`
>
>   [Optional] This is called from the [`netfs_write_begin()`](netfs_library.md#c.netfs_write_begin "netfs_write_begin") helper once it has
...
> - `expand_readahead()`
>
>   [Optional] Called at the beginning of a [`netfs_readahead()`](netfs_library.md#c.netfs_readahead "netfs_readahead") operation to allow
...
void folio_start_fscache(struct [folio](netfs_library.md#c.folio_start_fscache "folio") \*folio)
...
void folio_end_fscache(struct [folio](netfs_library.md#c.folio_end_fscache "folio") \*folio)
...
void folio_wait_fscache(struct [folio](netfs_library.md#c.folio_wait_fscache "folio") \*folio)
...
int folio_wait_fscache_killable(struct [folio](netfs_library.md#c.folio_wait_fscache_killable "folio") \*folio)
:   Wait for an fscache write on this folio to end.
...
struct [netfs_inode](netfs_library.md#c.netfs_inode "netfs_inode") \*netfs_inode(struct [inode](netfs_library.md#c.netfs_inode "inode") \*inode)
...
void netfs_inode_init(struct [netfs_inode](netfs_library.md#c.netfs_inode "netfs_inode") \*ctx, const struct netfs_request_ops \*ops, bool use_zero_point)
...
void netfs_resize_file(struct [netfs_inode](netfs_library.md#c.netfs_inode "netfs_inode") \*ctx, loff_t new_i_size, bool changed_on_server)
...
struct fscache_cookie \*netfs_i_cookie(struct [netfs_inode](netfs_library.md#c.netfs_inode "netfs_inode") \*ctx)
...
void netfs_readahead(struct [readahead_control](../core-api/mm-api.md#c.readahead_control "readahead_control") \*ractl)
...
int netfs_read_folio(struct [file](netfs_library.md#c.netfs_read_folio "file") \*file, struct [folio](netfs_library.md#c.netfs_read_folio "folio") \*folio)
...
int netfs_write_begin(struct [netfs_inode](netfs_library.md#c.netfs_inode "netfs_inode") \*ctx, struct [file](netfs_library.md#c.netfs_write_begin "file") \*file, struct [address_space](api-summary.md#c.address_space "address_space") \*mapping, loff_t pos, unsigned int len, struct [folio](../core-api/mm-api.md#c.folio "folio") \*\*_folio, void \*\*_fsdata)
