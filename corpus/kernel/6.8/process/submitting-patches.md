...
source_url: https://www.kernel.org/doc/html/v6.8/process/submitting-patches.html
fetched_at: 2026-08-21T03:28:36+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/submitting-patches.md)
- [Chinese (Traditional)](../translations/zh_TW/process/submitting-patches.md)
- [Italian](../translations/it_IT/process/submitting-patches.md)
- [Spanish](../translations/sp_SP/process/submitting-patches.md)
...
works, see [A guide to the Kernel Development Process](development-process.md). Also, read
...
[Documentation/process/maintainer-handbooks.rst](maintainer-handbooks.md#maintainer-handbooks-main).
...
system, `git`, as a "commit log". See [The canonical patch format](submitting-patches.md#the-canonical-patch-format).

Solve only one problem per patch. If your description starts to get
long, that's a sign that you probably need to split up your patch.
See [Separate your changes](submitting-patches.md#split-changes).
...
found in [Linux kernel coding style](coding-style.md).
...
([akpm@linux-foundation.org](mailto:akpm%40linux-foundation.org)) serves as a maintainer of last resort.

[linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org) should be used by default for all patches, but the
...
Linux kernel. His e-mail address is <[torvalds@linux-foundation.org](mailto:torvalds%40linux-foundation.org)>.
He gets a lot of e-mail, and, at this point, very few patches go through
Linus directly, so typically you should do your best to -avoid-
sending him e-mail.

If you have a patch that fixes an exploitable security bug, send that patch
to [security@kernel.org](mailto:security%40kernel.org). For severe bugs, a short embargo may be considered
...
should also read [Everything you ever wanted to know about Linux -stable releases](stable-kernel-rules.md)
...
See [Email clients info for Linux](email-clients.md) for hints about configuring
...
[The canonical patch format](submitting-patches.md#the-canonical-patch-format)).
Notify people that commented on your patch about new versions by adding them to
the patches CC list.

See [Email clients info for Linux](email-clients.md) for recommendations on email
...
> 1. I have carried out a technical review of this patch to
>    evaluate its appropriateness and readiness for inclusion into
>    the mainline kernel.
> 2. Any problems, concerns, or questions relating to the patch
>    have been communicated back to the submitter. I am satisfied
>    with the submitter's response to my comments.
> 3. While there may be things that could be improved with this
>    submission, I believe that it is, at this time, (1) a
>    worthwhile modification to the kernel, and (2) free of known
>    issues which would argue against its inclusion.
> 4. While I have reviewed the patch and believe it to be sound, I
...
method for indicating a bug fixed by the patch. See [Describe your changes](submitting-patches.md#describe-changes)
for more details.

Note: Attaching a Fixes: tag does not subvert the stable kernel rules
process nor the requirement to Cc: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) on all stable
...
NO!!!! No more huge patch bombs to [linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org) people!
:   <<https://lore.kernel.org/r/20050711.125305.08322243.davem@davemloft.net>>

Kernel [Linux kernel coding style](coding-style.md)
