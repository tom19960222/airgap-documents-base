...
source_url: https://www.kernel.org/doc/html/v6.8/process/maintainer-soc.html
...
alias [soc@kernel.org](mailto:soc%40kernel.org) if there is no platform-specific maintainer, or if they
are unresponsive.
