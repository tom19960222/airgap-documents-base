...
source_url: https://www.kernel.org/doc/html/v6.8/process/license-rules.html
fetched_at: 2026-08-21T03:28:41+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/license-rules.md)
- [Chinese (Traditional)](../translations/zh_TW/process/license-rules.md)
- [Italian](../translations/it_IT/process/license-rules.md)
...
[License identifiers](license-rules.md#license-identifiers) and have been retrieved from the official SPDX
...
3. Syntax:
   ...
   file. For details see the point [Exceptions](license-rules.md#exceptions) in the chapter [License
   identifiers](license-rules.md#license-identifiers).
...
1. Preferred licenses:
   ...
   [Metatags](license-rules.md#metatags). The file names are identical to the SPDX license
   ...
   - Usage-Guidance:
     ...
     files according to the [License identifier syntax](license-rules.md#license-identifier-syntax) guidelines.
   - License-Text:
...
2. Deprecated licenses:
   ...
   requirements of the [Preferred licenses](license-rules.md#preferred-licenses).
...
4. Exceptions:
   ...
   exception text and the required [Exception Metatags](license-rules.md#exception-metatags).
   ...
   - Usage-Guidance:
     ...
     source files according to the [License identifier syntax](license-rules.md#license-identifier-syntax) guidelines.
   - Exception-Text:
...
> > | "Dual MIT/GPL" | The correct way of expressing that the module is dual licensed under a GPL v2 variant or MIT license choice. |
> > | "Dual BSD/GPL" | The module is dual licensed under a GPL v2 variant or BSD license choice. The exact variant of the BSD license can only be determined via the license information in the corresponding source files. |
> > | "Dual MPL/GPL" | The module is dual licensed under a GPL v2 variant or Mozilla Public License (MPL) choice. The exact variant of the MPL license can only be determined via the license information in the corresponding source files. |
> > | "Proprietary" | The module is under a proprietary license. This string is solely for proprietary third party modules and cannot be used for modules which have their source code in the kernel tree. Modules tagged that way are tainting the kernel with the 'P' flag when loaded and the kernel module loader refuses to link such modules against symbols which are exported with EXPORT_SYMBOL_GPL(). |
