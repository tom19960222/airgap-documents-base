...
source_url: https://www.kernel.org/doc/html/v6.8/process/handling-regressions.html
fetched_at: 2026-08-21T03:29:38+00:00
---
English

- [Spanish](../translations/sp_SP/process/handling-regressions.md)
...
[Reporting regressions](../admin-guide/reporting-regressions.md), which covers the topic from a
user's point of view; if you never read that text, go and at least skim over it
before continuing here.

## The important bits (aka "The TL;DR")

1. Ensure subscribers of the [regression mailing list](https://lore.kernel.org/regressions/)
   ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) quickly become aware of any new regression
   report:
...
2. Make the Linux kernel regression tracking bot "regzbot" track the issue (this
   ...
   >   ```
3. When submitting fixes for regressions, add "Link:" tags to the patch
   description pointing to all places where the issue was reported, as
   mandated by [Submitting patches: the essential guide to getting your code into the kernel](submitting-patches.md) and
   [Documentation/process/5.Posting.rst](5.Posting.md#development-posting).
4. Try to fix regressions quickly once the culprit has been identified; fixes
...
[regression mailing list](https://lore.kernel.org/regressions/)
([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) become aware of any newly reported regression:
...
remember to do what [Submitting patches: the essential guide to getting your code into the kernel](submitting-patches.md),
[Documentation/process/5.Posting.rst](5.Posting.md#development-posting), and
[Everything you ever wanted to know about Linux -stable releases](stable-kernel-rules.md) already explain in more detail:
...
>   twelve months, ensure to tag the fix with "Cc: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org)", as a
...
Check out [Reporting regressions](../admin-guide/reporting-regressions.md), it covers a lot
...
Send a mail to the regressions mailing list ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) while
CCing the Linux kernel's regression tracker ([regressions@leemhuis.info](mailto:regressions%40leemhuis.info)); if the
...
Check [regzbot's web-interface](https://linux-regtracking.leemhuis.info/regzbot/)
for the latest info; alternatively, [search for the latest regression report](https://lore.kernel.org/lkml/?q=%22Linux+regressions+report%22+f%3Aregzbot),
...
[project page](https://gitlab.com/knurd42/regzbot), which among others
contains a [getting started guide](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/getting_started.md)
and [reference documentation](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/reference.md)
