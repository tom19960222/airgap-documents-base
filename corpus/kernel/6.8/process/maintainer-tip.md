...
collection: kernel
version: "6.8"
title: "4. The tip tree handbook"
source_url: https://www.kernel.org/doc/html/v6.8/process/maintainer-tip.html
fetched_at: 2026-08-21T03:41:51+00:00
---
English

- [Italian](../translations/it_IT/process/maintainer-tip.md)
...
### 4.2.1. Selecting the tree/branch
...
The general rules about changelogs in the [Submitting patches guide](submitting-patches.md#describe-changes), apply.
...
### 4.2.4. Function references in changelogs
...
### 4.2.5. Backtraces in changelogs

See [Backtraces in commit messages](submitting-patches.md#backtraces).
...
### 4.2.8. Patch resend or reminders

See [Don't get discouraged - or impatient](submitting-patches.md#resend-reminders).
...
### 4.3.2. Documenting locking requirements
...
### 4.3.7. Struct declarations and initializers
...
Please note that 'xxx_vendor_' and 'vendor_xxx_` prefixes are not
