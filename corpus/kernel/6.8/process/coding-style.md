...
source_url: https://www.kernel.org/doc/html/v6.8/process/coding-style.html
fetched_at: 2026-08-21T03:29:19+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/coding-style.md)
- [Chinese (Traditional)](../translations/zh_TW/process/coding-style.md)
- [Italian](../translations/it_IT/process/coding-style.md)
- [Spanish](../translations/sp_SP/process/coding-style.md)
...
See the files at [Documentation/doc-guide/](../doc-guide/index.md#doc-guide) and
...
See the file [Documentation/process/clang-format.rst](clang-format.md#clangformat)
for more details.
...
[Kconfig Language](../kbuild/kconfig-language.md).
...
particular device, <linux/printk.h> defines [`pr_notice()`](../core-api/printk-basics.md#c.pr_notice "pr_notice"), [`pr_info()`](../core-api/printk-basics.md#c.pr_info "pr_info"),
[`pr_warn()`](../core-api/printk-basics.md#c.pr_warn "pr_warn"), [`pr_err()`](../core-api/printk-basics.md#c.pr_err "pr_err"), etc.

Coming up with good debugging messages can be quite a challenge; and once
you have them, they can be a huge help for remote troubleshooting. However
debug message printing is handled differently than printing other non-debug
messages. While the other pr_XXX() functions print unconditionally,
[`pr_debug()`](../core-api/printk-basics.md#c.pr_debug "pr_debug") does not; it is compiled out by default, unless either DEBUG is
...
[`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc"), [`kzalloc()`](../core-api/mm-api.md#c.kzalloc "kzalloc"), [`kmalloc_array()`](../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"), [`kcalloc()`](../core-api/mm-api.md#c.kcalloc "kcalloc"), [`vmalloc()`](../core-api/mm-api.md#c.vmalloc "vmalloc"), and
[`vzalloc()`](../core-api/mm-api.md#c.vzalloc "vzalloc"). Please refer to the API documentation for further information
about them. [Documentation/core-api/memory-allocation.rst](../core-api/memory-allocation.md#memory-allocation)
...
the [`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc") inline function.
...
a predicate, and the [`pci_dev_present()`](../driver-api/pci/pci.md#c.pci_dev_present "pci_dev_present") function returns 1 if it succeeds in
...
[`panic()`](../driver-api/basics.md#c.panic "panic") should be used with care and primarily only during system boot.
[`panic()`](../driver-api/basics.md#c.panic "panic") is, for example, acceptable when running out of memory during boot and
