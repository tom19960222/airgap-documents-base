...
source_url: https://www.kernel.org/doc/html/v6.8/process/submit-checklist.html
...
11. Include [kernel-doc](../doc-guide/kernel-doc.md#kernel-doc) to document global kernel APIs.
    (Not required for static functions, but OK there also.) Use
    `make htmldocs` or `make pdfdocs` to check the
    [kernel-doc](../doc-guide/kernel-doc.md#kernel-doc) and fix any issues.
