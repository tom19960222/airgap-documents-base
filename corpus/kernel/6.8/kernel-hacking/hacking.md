...
source_url: https://www.kernel.org/doc/html/v6.8/kernel-hacking/hacking.html
fetched_at: 2026-08-21T03:33:46+00:00
---
English
...
consider [`msleep()`](../driver-api/basics.md#c.msleep "msleep").
...
modules with a `MODULE_LICENSE()` that specifies a GPL
...
In particular, [`list_for_each_entry()`](../core-api/kernel-api.md#c.list_for_each_entry "list_for_each_entry") is useful.
