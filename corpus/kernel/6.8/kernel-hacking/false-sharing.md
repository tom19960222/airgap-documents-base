...
version: "6.8"
title: "False Sharing"
source_url: https://www.kernel.org/doc/html/v6.8/kernel-hacking/false-sharing.html
...
academic definition for it is in [1](false-sharing.md#id4). Consider a struct with a
...
regression and Linus analyzed in [2](false-sharing.md#id5).
...
A nice introduction for perf-c2c is [3](false-sharing.md#id6).
...
- Separate hot global data in its own dedicated cache line, even if it
  ...
  - [Commit 91b6d3256356 ("net: cache align tcp_memory_allocated, tcp_sockets_allocated")](https://git.kernel.org/torvalds/c/91b6d3256356)
- Reorganize the data structure, separate the interfering members to
  different cache lines. One downside is it may introduce new false
  sharing of other members.

  - [Commit 802f1d522d5f ("mm: page_counter: re-layout structure to reduce false sharing")](https://git.kernel.org/torvalds/c/802f1d522d5f)
- Replace 'write' with 'read' when possible, especially in loops.
  ...
  - [Commit 7b1002f7cfe5 ("bcache: fixup bcache_dev_sectors_dirty_add() multithreaded CPU false sharing")](https://git.kernel.org/torvalds/c/7b1002f7cfe5)bcache_dev_sectors_dirty_add() multithreaded CPU false sharing")
  - [Commit 292648ac5cf1 ("mm: gup: allow FOLL_PIN to scale in SMP")](https://git.kernel.org/torvalds/c/292648ac5cf1)
- Turn hot global data to 'per-cpu data + global data' when possible,
  or reasonably increase the threshold for syncing per-cpu data to
  global data, to reduce or postpone the 'write' to that global data.

  - [Commit 520f897a3554 ("ext4: use percpu_counters for extent_status cache hits/misses")](https://git.kernel.org/torvalds/c/520f897a3554)
  - [Commit 56f3547bfa4d ("mm: adjust vm_committed_as_batch according to vm overcommit policy")](https://git.kernel.org/torvalds/c/56f3547bfa4d)
