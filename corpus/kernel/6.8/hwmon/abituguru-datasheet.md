...
collection: kernel
version: "6.8"
title: "uGuru datasheet"
source_url: https://www.kernel.org/doc/html/v6.8/hwmon/abituguru-datasheet.html
fetched_at: 2026-08-21T04:00:59+00:00
---
# uGuru datasheet
...
Olle Sandberg <[ollebull@gmail.com](mailto:ollebull%40gmail.com)>, 2005-05-25
...
Hans de Goede <[j.w.r.degoede@hhs.nl](mailto:j.w.r.degoede%40hhs.nl)>, 28-01-2006
...
Bit 0:
:   Give an alarm if measured temp is over the warning threshold (RW) [1](abituguru-datasheet.md#id4)

Bit 1:
:   Give an alarm if measured volt is over the max threshold (RW) [2](abituguru-datasheet.md#id5)

Bit 2:
:   Give an alarm if measured volt is under the min threshold (RW) [2](abituguru-datasheet.md#id5)
...
[1](abituguru-datasheet.md#id1)
:   This bit is only honored/used by the uGuru if a temp sensor is connected

2([1](abituguru-datasheet.md#id2),[2](abituguru-datasheet.md#id3))
