...
source_url: https://www.kernel.org/doc/html/v6.8/gpu/i915.html
fetched_at: 2026-08-21T03:38:21+00:00
---
...
bool intel_set_cpu_fifo_underrun_reporting(struct drm_i915_private \*dev_priv, enum [pipe](i915.md#c.intel_set_cpu_fifo_underrun_reporting "pipe") pipe, bool enable)
...
void intel_cpu_fifo_underrun_irq_handler(struct drm_i915_private \*dev_priv, enum [pipe](i915.md#c.intel_cpu_fifo_underrun_irq_handler "pipe") pipe)
...
enum hpd_pin intel_hpd_pin_default(struct drm_i915_private \*dev_priv, enum [port](i915.md#c.intel_hpd_pin_default "port") port)
...
void intel_lpe_audio_notify(struct drm_i915_private \*dev_priv, enum transcoder cpu_transcoder, enum [port](i915.md#c.intel_lpe_audio_notify "port") port, const void \*eld, int ls_clock, bool dp_output)
...
bool intel_bios_is_port_present(struct drm_i915_private \*i915, enum [port](i915.md#c.intel_bios_is_port_present "port") port)
...
bool intel_bios_is_dsi_present(struct drm_i915_private \*i915, enum [port](i915.md#c.intel_bios_is_dsi_present "port") \*port)
...
void intel_set_cdclk(struct drm_i915_private \*dev_priv, const struct intel_cdclk_config \*cdclk_config, enum [pipe](i915.md#c.intel_set_cdclk "pipe") pipe)
...
[`intel_shared_dpll_init()`](i915.md#c.intel_shared_dpll_init "intel_shared_dpll_init") initializes the PLLs for the given platform. The
users of a PLL are tracked and that tracking is integrated with the atomic
modset interface. During an atomic operation, required PLLs can be reserved
for a given CRTC and encoder configuration by calling
[`intel_reserve_shared_dplls()`](i915.md#c.intel_reserve_shared_dplls "intel_reserve_shared_dplls") and previously reserved PLLs can be released
with [`intel_release_shared_dplls()`](i915.md#c.intel_release_shared_dplls "intel_release_shared_dplls").
Changes to the users are first staged in the atomic state, and then made
effective by calling [`intel_shared_dpll_swap_state()`](i915.md#c.intel_shared_dpll_swap_state "intel_shared_dpll_swap_state") during the atomic
commit phase.

struct [intel_shared_dpll](i915.md#c.intel_shared_dpll "intel_shared_dpll") \*intel_get_shared_dpll_by_id(struct drm_i915_private \*i915, enum [intel_dpll_id](i915.md#c.intel_dpll_id "intel_dpll_id") id)
...
void intel_reference_shared_dpll_crtc(const struct intel_crtc \*crtc, const struct [intel_shared_dpll](i915.md#c.intel_shared_dpll "intel_shared_dpll") \*pll, struct [intel_shared_dpll_state](i915.md#c.intel_shared_dpll_state "intel_shared_dpll_state") \*shared_dpll_state)
...
void intel_unreference_shared_dpll_crtc(const struct intel_crtc \*crtc, const struct [intel_shared_dpll](i915.md#c.intel_shared_dpll "intel_shared_dpll") \*pll, struct [intel_shared_dpll_state](i915.md#c.intel_shared_dpll_state "intel_shared_dpll_state") \*shared_dpll_state)
...
calling [`intel_shared_dpll_swap_state()`](i915.md#c.intel_shared_dpll_swap_state "intel_shared_dpll_swap_state").
...
[`intel_release_shared_dplls()`](i915.md#c.intel_release_shared_dplls "intel_release_shared_dplls").
...
This function releases all DPLLs reserved by [`intel_reserve_shared_dplls()`](i915.md#c.intel_reserve_shared_dplls "intel_reserve_shared_dplls")
...
from the port DPLLs reserved previously by [`intel_reserve_shared_dplls()`](i915.md#c.intel_reserve_shared_dplls "intel_reserve_shared_dplls"). The
DPLL selected will be based on the current mode of the encoder's port.

int intel_dpll_get_freq(struct drm_i915_private \*i915, const struct [intel_shared_dpll](i915.md#c.intel_shared_dpll "intel_shared_dpll") \*pll, const struct intel_dpll_hw_state \*pll_state)
...
bool intel_dpll_get_hw_state(struct drm_i915_private \*i915, struct [intel_shared_dpll](i915.md#c.intel_shared_dpll "intel_shared_dpll") \*pll, struct intel_dpll_hw_state \*hw_state)
...
either its current state (in struct [`intel_shared_dpll`](i915.md#c.intel_shared_dpll "intel_shared_dpll")) or a desired
future state which would be applied by an atomic mode set (stored in
a struct `intel_atomic_state`).

See also [`intel_reserve_shared_dplls()`](i915.md#c.intel_reserve_shared_dplls "intel_reserve_shared_dplls") and [`intel_release_shared_dplls()`](i915.md#c.intel_release_shared_dplls "intel_release_shared_dplls").
...
This is a simple wraper around [`i915_gem_shrink()`](i915.md#c.i915_gem_shrink "i915_gem_shrink") to aggressively shrink all
...
:   the [`struct drm_mm_node`](drm-mm.md#c.drm_mm_node "drm_mm_node") (typically i915_vma.mode)
...
`ctrl_gt`
:   poiner to the tile that owns the controls for PXP subsystem assets that
...
:   timestamp of previous 'dead guc' occurrance
