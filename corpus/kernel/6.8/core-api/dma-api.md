...
source_url: https://www.kernel.org/doc/html/v6.8/core-api/dma-api.html
fetched_at: 2026-08-21T03:30:14+00:00
---
...
specify the `GFP_` flags (see [`kmalloc()`](mm-api.md#c.kmalloc "kmalloc")) for the allocation (the
...
[`dma_pool_create()`](mm-api.md#c.dma_pool_create "dma_pool_create") initializes a pool of DMA-coherent buffers
...
Wraps [`dma_pool_alloc()`](mm-api.md#c.dma_pool_alloc "dma_pool_alloc") and also zeroes the returned memory if the
...
[`dma_pool_alloc()`](mm-api.md#c.dma_pool_alloc "dma_pool_alloc"); the CPU (vaddr) and DMA addresses are what
...
[`dma_pool_destroy()`](mm-api.md#c.dma_pool_destroy "dma_pool_destroy") frees the resources of the pool. It must be
