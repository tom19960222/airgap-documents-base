...
collection: kernel
version: "6.8"
title: "DPAA2 MAC / PHY support"
source_url: https://www.kernel.org/doc/html/v6.8/networking/device_drivers/ethernet/freescale/dpaa2/mac-phy-support.html
fetched_at: 2026-08-21T03:42:58+00:00
---
...
> - connect to the PHY using [`phylink_of_phy_connect()`](../../../../kapi.md#c.phylink_of_phy_connect "phylink_of_phy_connect")
...
> - .[`mac_config()`](../../../../kapi.md#c.mac_config "mac_config") will configure the MAC in the new configuration using the
>   dpmac_set_link_state() MC firmware API.
> - .[`mac_link_up()`](../../../../kapi.md#c.mac_link_up "mac_link_up") / .[`mac_link_down()`](../../../../kapi.md#c.mac_link_down "mac_link_down") will update the MAC link using the same
>   API described above.
...
1. [`phylink_start()`](../../../../kapi.md#c.phylink_start "phylink_start") called from .[`dev_open()`](../../../../kapi.md#c.dev_open "dev_open").
2. The .[`mac_config()`](../../../../kapi.md#c.mac_config "mac_config") and .[`mac_link_up()`](../../../../kapi.md#c.mac_link_up "mac_link_up") callbacks are called by PHYLINK.
...
5. A [`netif_carrier_on()`](../../../../kapi.md#c.netif_carrier_on "netif_carrier_on") call is made directly from PHYLINK on the associated
   net_device.
...
6. The [`netif_carrier_on()`](../../../../kapi.md#c.netif_carrier_on "netif_carrier_on") is called on the exported net_device from
   link_state_update().
