...
collection: kernel
version: "6.8"
title: "SB100 device driver"
source_url: https://www.kernel.org/doc/html/v6.8/networking/device_drivers/cable/sb1000.html
...
This driver was written by Franco Venturi <[fventuri@mediaone.net](mailto:fventuri%40mediaone.net)>. He deserves
...
7. As root, copy all the files under the ppp/ subdirectory in Franco's
   ...
   already in there. Then modify [ppp@gi-on](mailto:ppp%40gi-on) to set the correct login name,
...
8. Be sure to modify /etc/ppp/firewall to use ipchains instead of
   ...
   firewalling scheme.
9. Start the PPP connection via the script [/etc/ppp/ppp@gi-on](mailto:/etc/ppp/ppp%40gi-on). You must be
...
4. I can't execute the [/etc/ppp/ppp@gi-on](mailto:/etc/ppp/ppp%40gi-on) file.
...
> Clemmitt Sigler
> [csigler@vt.edu](mailto:csigler%40vt.edu)
