...
source_url: https://www.kernel.org/doc/html/v6.8/userspace-api/iommu.html
fetched_at: 2026-08-21T03:35:25+00:00
---
# IOMMU Userspace API
...
- [Interfaces](iommu.md#interfaces)
  ...
  - [Extension Rules & Precautions](iommu.md#extension-rules-precautions)
  - [Compatibility Checking](iommu.md#compatibility-checking)
  - [Feature Checking](iommu.md#feature-checking)
  - [Data Passing Example with VFIO](iommu.md#data-passing-example-with-vfio)
  - [Sharing UAPI with in-kernel users](iommu.md#sharing-uapi-with-in-kernel-users)

## [Functionalities](iommu.md#id1)
...
### [Compatibility Checking](iommu.md#id5)
...
[VFIO - "Virtual Function I/O"](../driver-api/vfio.md) .

### [Data Passing Example with VFIO](iommu.md#id7)
...
### [Sharing UAPI with in-kernel users](iommu.md#id8)
