...
collection: kernel
version: "6.8"
title: "2.13.1. V4L2_META_FMT_D4XX ('D4XX')"
source_url: https://www.kernel.org/doc/html/v6.8/userspace-api/media/v4l/metafmt-d4xx.html
fetched_at: 2026-08-21T03:57:21+00:00
---
...
payload headers, following the Microsoft(R) UVC extension proposal [[1](metafmt-d4xx.md#id1)]. That
...
and MetadataId_CameraIntrinsics (ID 5). For their description see [[1](metafmt-d4xx.md#id1)]. This
...
This document implements Intel Configuration version 3 [[9](metafmt-d4xx.md#id9)].
...
| __u32 Flags | A bitmask of flags: see [[2](metafmt-d4xx.md#id2)] below |
...
| __u8 Emitter mode (v3 only) (__u32 Laser mode for v1) [[8](metafmt-d4xx.md#id8)] | 0: off, 1: on, same as __u32 Laser mode for v1 |
...
| __u32 Flags | A bitmask of flags: see [[3](metafmt-d4xx.md#id3)] below |
...
| __u32 Version | Version of this structure. The documentation herein corresponds to version xxx. The version number will be incremented when new fields are added. |
| __u32 Flags | A bitmask of flags: see [[4](metafmt-d4xx.md#id4)] below |
| __u8 Hardware type | Camera hardware version [[5](metafmt-d4xx.md#id5)] |
| __u8 SKU ID | Camera hardware configuration [[6](metafmt-d4xx.md#id6)] |
| __u32 Cookie | Internal synchronisation |
| __u16 Format | Image format code [[7](metafmt-d4xx.md#id7)] |
...
| __u16 Calibration count (v3 only) | Calibration counter, see [[4](metafmt-d4xx.md#id4)] below |
| __u8 GPIO input data (v3 only) | GPIO readout, see [[4](metafmt-d4xx.md#id4)] below (Supported from FW 5.12.7.0) |
| __u32 Sub-preset info (v3 only) | Sub-preset choice information, see [[4](metafmt-d4xx.md#id4)] below |
...
compatible with the same data format and they are supported. See [[2](metafmt-d4xx.md#id2)] for which
