...
collection: kernel
version: "6.8"
title: "4.13. Sub-device Interface"
source_url: https://www.kernel.org/doc/html/v6.8/userspace-api/media/v4l/dev-subdev.html
...
node with the V4L2 control API described in [User Controls](control.md#control). The ioctls
...
[Event Interface](dev-event.md#event). The API behaves identically as when used on V4L2 device
...
[selection](vidioc-subdev-g-selection.md#vidioc-subdev-g-selection) ioctls. The driver is
...
[Image Format Negotiation on Pipelines](dev-subdev.md#pipeline-scaling), where image scaling can be performed on both
the video sensor and the host image processing hardware.

![pipeline.dot](../../../_images/pipeline.svg)
...
Drivers that implement the [media API](../mediactl/media-controller-intro.md#media-controller-intro)
can expose pad-level image format configuration to applications. When
they do, applications can use the
[VIDIOC_SUBDEV_G_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) and
[VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) ioctls. to
...
[VIDIOC_STREAMON](vidioc-streamon.md#vidioc-streamon) time, and an `EPIPE` error
...
the [ioctl VIDIOC_SUBDEV_G_FMT, VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) ioctl on pad
...
[V4L2_SUBDEV_FORMAT_TRY](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt), the
[VIDIOC_SUBDEV_G_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) and
[VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) ioctls operate on
...
[VIDIOC_SUBDEV_G_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) call will return
...
[VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) ioctl. Drivers
...
to an [VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) call as-is
...
[Sample Pipeline Configuration](dev-subdev.md#sample-pipeline-config) shows a sample configuration sequence
for the pipeline described in [Image Format Negotiation on Pipelines](dev-subdev.md#pipeline-scaling) (table columns
...
struct [`v4l2_rect`](dev-overlay.md#c.v4l2_rect "v4l2_rect") by the coordinates of the top
...
selection targets [Common selection definitions](selections-common.md#v4l2-selections-common).
...
struct [`v4l2_rect`](dev-overlay.md#c.v4l2_rect "v4l2_rect").

Scaling support is optional. When supported by a subdev, the crop
rectangle on the subdev's sink pad is scaled to the size configured
using the
[VIDIOC_SUBDEV_S_SELECTION](vidioc-subdev-g-selection.md#vidioc-subdev-g-selection) IOCTL
...
the image size either up or down. [Selection flags](v4l2-selection-flags.md#v4l2-selection-flags)
...
![subdev-image-processing-crop.svg](../../../_images/subdev-image-processing-crop.svg)
...
![subdev-image-processing-scaling-multi-source.svg](../../../_images/subdev-image-processing-scaling-multi-source.svg)
...
![subdev-image-processing-full.svg](../../../_images/subdev-image-processing-full.svg)
...
the same as without streams (see [Order of configuration and format propagation](dev-subdev.md#format-propagation)).
...
#### 4.13.3.5.3. Configuring streams
...
1. Set up links. Connect the pads between sub-devices using the
   [Media Controller API](../mediactl/media-controller.md#media-controller)
2. Streams. Streams are declared and their routing is configured by setting the
   routing table for the sub-device using [VIDIOC_SUBDEV_S_ROUTING](vidioc-subdev-g-routing.md#vidioc-subdev-g-routing) ioctl. Note that setting the routing table will
...
3. Configure formats and selections. Formats and selections of each stream are
   ...
   [Order of configuration and format propagation](dev-subdev.md#format-propagation). The stream ID is set to the same stream ID
   associated with either sink or source pads of routes configured using the
   [VIDIOC_SUBDEV_S_ROUTING](vidioc-subdev-g-routing.md#vidioc-subdev-g-routing) ioctl.

#### 4.13.3.5.4. Multiplexed streams setup example
...
| Sink Pad/Stream | Source Pad/Stream | Routing Flags | Comments |
| --- | --- | --- | --- |
| 0/0 | 2/0 | V4L2_SUBDEV_ROUTE_FL_ACTIVE | Pixel data stream from Sensor A |
| 1/0 | 2/1 | V4L2_SUBDEV_ROUTE_FL_ACTIVE | Pixel data stream from Sensor B |

Receiver routing table

| Sink Pad/Stream | Source Pad/Stream | Routing Flags | Comments |
| --- | --- | --- | --- |
| 0/0 | 1/0 | V4L2_SUBDEV_ROUTE_FL_ACTIVE | Pixel data stream from Sensor A |
| 0/1 | 2/0 | V4L2_SUBDEV_ROUTE_FL_ACTIVE | Pixel data stream from Sensor B |
...
3. Configure formats and selections
   ...
   [VIDIOC_SUBDEV_S_FMT](vidioc-subdev-g-fmt.md#vidioc-subdev-g-fmt) ioctls to configure each
