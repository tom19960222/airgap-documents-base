...
source_url: https://www.kernel.org/doc/html/v6.8/power/pci.html
...
The SIMPLE_DEV_PM_OPS macro declares a [`struct dev_pm_ops`](../driver-api/pm/types.md#c.dev_pm_ops "dev_pm_ops") object with one
