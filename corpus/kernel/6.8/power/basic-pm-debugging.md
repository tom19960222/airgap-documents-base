...
collection: kernel
version: "6.8"
title: "Debugging hibernation and suspend"
source_url: https://www.kernel.org/doc/html/v6.8/power/basic-pm-debugging.html
fetched_at: 2026-08-21T03:46:44+00:00
---
...
:   - test the freezing of processes, suspending of devices and platform
      global control methods [1](basic-pm-debugging.md#id4)

processors
:   - test the freezing of processes, suspending of devices, platform
      global control methods [1](basic-pm-debugging.md#id4) and the disabling of nonboot CPUs

core
:   - test the freezing of processes, suspending of devices, platform global
      control methods[1](basic-pm-debugging.md#id4), the disabling of nonboot CPUs and suspending
      of platform/system devices

1([1](basic-pm-debugging.md#id1),[2](basic-pm-debugging.md#id2),[3](basic-pm-debugging.md#id3))
...
use the PM_TRACE mechanism documented in [How to get s2ram working](s2ram.md) .
