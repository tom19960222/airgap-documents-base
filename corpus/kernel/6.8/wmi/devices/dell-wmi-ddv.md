...
collection: kernel
version: "6.8"
title: "1. Dell DDV WMI interface driver (dell-wmi-ddv)"
source_url: https://www.kernel.org/doc/html/v6.8/wmi/devices/dell-wmi-ddv.html
fetched_at: 2026-08-21T03:42:53+00:00
---
# 1. Dell DDV WMI interface driver (dell-wmi-ddv)
...
## 1.2. Dell ePPID (electronic Piece Part Identification)
...
### 1.3.5. WMI method BatterySerialNumber()

Returns the serial number of the battery as an u16.

### 1.3.6. WMI method BatteryChemistryValue()
...
### 1.3.15. WMI method BatteryeRawAnalytics()
...
### 1.3.16. WMI method BatteryDesignVoltage()

Returns the design voltage of the battery in mV as an u16.

### 1.3.17. WMI method BatteryeRawAnalyticsABlock()
...
### 1.3.18. WMI method ReturnVersion()

Returns the WMI interface version as an u32.

### 1.3.19. WMI method FanSensorInformation()
...
### 1.3.20. WMI method ThermalSensorInformation()
...
## 1.4. ACPI battery matching algorithm
...
## 1.5. Reverse-Engineering the DDV WMI interface
