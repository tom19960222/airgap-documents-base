...
source_url: https://www.kernel.org/doc/html/v6.8/driver-api/gpio/driver.html
fetched_at: 2026-08-21T03:32:16+00:00
---
...
gpio_chip and issue gpiochip_add(), [`gpiochip_add_data()`](index.md#c.gpiochip_add_data "gpiochip_add_data"), or
devm_gpiochip_add_data(). Removing a GPIO controller should be rare; use
[`gpiochip_remove()`](index.md#c.gpiochip_remove "gpiochip_remove") when it is unavoidable.
