...
collection: kernel
version: "6.8"
title: "Legacy GPIO Interfaces"
source_url: https://www.kernel.org/doc/html/v6.8/driver-api/gpio/legacy.html
fetched_at: 2026-08-21T03:32:19+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/driver-api/gpio/legacy.md)
...
Non-error values returned from gpio_to_irq() can be passed to [`request_irq()`](../../core-api/genericirq.md#c.request_irq "request_irq")
or [`free_irq()`](../../core-api/genericirq.md#c.free_irq "free_irq"). They will often be stored into IRQ resources for platform
...
For non-DT support, user can call [`gpiochip_add_pin_range()`](index.md#c.gpiochip_add_pin_range "gpiochip_add_pin_range") with appropriate
...
In this framework each GPIO controller is packaged as a "[`struct gpio_chip`](index.md#c.gpio_chip "gpio_chip")"
...
rare; use [`gpiochip_remove()`](index.md#c.gpiochip_remove "gpiochip_remove") when it is unavoidable.
