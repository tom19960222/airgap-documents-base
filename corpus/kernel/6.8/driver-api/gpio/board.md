...
version: "6.8"
title: "GPIO Mappings"
source_url: https://www.kernel.org/doc/html/v6.8/driver-api/gpio/board.html
...
[Legacy GPIO Interfaces](legacy.md) (actually, there is no real mapping possible with the old
...
through [`gpiod_get()`](index.md#c.gpiod_get "gpiod_get"). For example:
...
The second parameter of the [`gpiod_get()`](index.md#c.gpiod_get "gpiod_get") functions, the con_id string, has to be
...
[_DSD Device Properties Related to GPIO](../../firmware-guide/acpi/gpio-properties.md).
...
calls to [`gpiod_get()`](index.md#c.gpiod_get "gpiod_get") with a NULL device.
...
A set of functions such as [`gpiod_set_value()`](index.md#c.gpiod_set_value "gpiod_set_value") is available to work with
