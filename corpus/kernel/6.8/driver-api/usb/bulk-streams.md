...
collection: kernel
version: "6.8"
title: "USB bulk streams"
source_url: https://www.kernel.org/doc/html/v6.8/driver-api/usb/bulk-streams.html
...
without calling [`usb_free_streams()`](usb.md#c.usb_free_streams "usb_free_streams"). This is a simplification for the xHCI host
...
[`usb_alloc_streams()`](usb.md#c.usb_alloc_streams "usb_alloc_streams") returns with a value of N, you may use streams 1 though N.
