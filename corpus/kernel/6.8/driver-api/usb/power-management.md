...
collection: kernel
version: "6.8"
title: "Power Management for USB"
source_url: https://www.kernel.org/doc/html/v6.8/driver-api/usb/power-management.html
fetched_at: 2026-08-21T03:31:47+00:00
---
...
methods in its [`usb_driver`](usb.md#c.usb_driver "usb_driver") structure, and the `reset_resume` method
...
>   outstanding URBs ([`usb_kill_urb()`](usb.md#c.usb_kill_urb "usb_kill_urb")) and not submit any more.
...
[USB device persistence during system suspend](persist.md#usb-persist)) and it can also be used under certain
...
> [`usb_autopm_get_interface()`](usb.md#c.usb_autopm_get_interface "usb_autopm_get_interface") increments the usage counter and
> does an autoresume if the device is suspended. If the
> autoresume fails, the counter is decremented back.
>
> [`usb_autopm_put_interface()`](usb.md#c.usb_autopm_put_interface "usb_autopm_put_interface") decrements the usage counter and
> attempts an autosuspend if the new value is = 0.
>
> [`usb_autopm_get_interface_async()`](usb.md#c.usb_autopm_get_interface_async "usb_autopm_get_interface_async") and
> [`usb_autopm_put_interface_async()`](usb.md#c.usb_autopm_put_interface_async "usb_autopm_put_interface_async") do almost the same things as
...
>
> [`usb_autopm_get_interface_no_resume()`](usb.md#c.usb_autopm_get_interface_no_resume "usb_autopm_get_interface_no_resume") and
> [`usb_autopm_put_interface_no_suspend()`](usb.md#c.usb_autopm_put_interface_no_suspend "usb_autopm_put_interface_no_suspend") merely increment or
> decrement the usage counter; they do not attempt to carry out
> an autoresume or an autosuspend. Hence they can be called in
> an atomic context.

The simplest usage pattern is that a driver calls
[`usb_autopm_get_interface()`](usb.md#c.usb_autopm_get_interface "usb_autopm_get_interface") in its open routine and
[`usb_autopm_put_interface()`](usb.md#c.usb_autopm_put_interface "usb_autopm_put_interface") in its close or release routine. But other
...
should call [`usb_autopm_get_interface_async()`](usb.md#c.usb_autopm_get_interface_async "usb_autopm_get_interface_async") before starting output and
[`usb_autopm_put_interface_async()`](usb.md#c.usb_autopm_put_interface_async "usb_autopm_put_interface_async") when the output queue drains. When
...
driver may call the [`usb_autopm_get_interface_async()`](usb.md#c.usb_autopm_get_interface_async "usb_autopm_get_interface_async") routine at a time
...
[`usb_autopm_get_interface()`](usb.md#c.usb_autopm_get_interface "usb_autopm_get_interface") (and do the reverse at the end of the
critical section). Holding the device semaphore will block all
external PM calls, and the [`usb_autopm_get_interface()`](usb.md#c.usb_autopm_get_interface "usb_autopm_get_interface") will prevent any
...
Linux Plumbers Conference 2012 slides [1](power-management.md#f1) and video [2](power-management.md#f2):

Upon receiving a `ClearPortFeature(PORT_POWER)` request a USB port is
logically off, and may trigger the actual loss of VBUS to the port [3](power-management.md#f3).
...
need to unbind the interface drivers before the [`usb_device`](usb.md#c.usb_device "usb_device") will
