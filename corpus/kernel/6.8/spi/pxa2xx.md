...
collection: kernel
version: "6.8"
title: "PXA2xx SPI on SSP driver HOWTO"
source_url: https://www.kernel.org/doc/html/v6.8/spi/pxa2xx.html
fetched_at: 2026-08-21T03:51:23+00:00
---
# PXA2xx SPI on SSP driver HOWTO

This a mini HOWTO on the pxa2xx_spi driver. The driver turns a PXA2xx
synchronous serial port into an SPI host controller
(see [Overview of Linux kernel SPI support](spi-summary.md)). The driver has the following features
...
The driver is built around a &[`struct spi_message`](../driver-api/spi.md#c.spi_message "spi_message") FIFO serviced by kernel
...
"linux/spi/spi.h". See "[Overview of Linux kernel SPI support](spi-summary.md)" for additional
information.
