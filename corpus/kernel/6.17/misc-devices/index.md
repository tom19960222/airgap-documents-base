...
source_url: https://www.kernel.org/doc/html/v6.17/misc-devices/index.html
fetched_at: 2026-09-16T16:21:07+00:00
---
...
- [AMD SIDE BAND interface](amd-sbi.md)
  - [SBRMI device](amd-sbi.md#sbrmi-device)
  - [Driver IOCTLs](amd-sbi.md#driver-ioctls)
  - [User-space usage](amd-sbi.md#user-space-usage)
...
- [Marvell CN10K DMA packet interface (DPI) driver](mrvl_cn10k_dpi.md)
  - [Overview](mrvl_cn10k_dpi.md#overview)
  - [Driver location](mrvl_cn10k_dpi.md#driver-location)
  - [Driver IOCTLs](mrvl_cn10k_dpi.md#driver-ioctls)
  - [User space code example](mrvl_cn10k_dpi.md#user-space-code-example)
