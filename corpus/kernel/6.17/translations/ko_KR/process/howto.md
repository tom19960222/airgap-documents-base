...
collection: kernel
version: "6.17"
title: "어떻게 리눅스 커널 개발을 하는가"
source_url: https://www.kernel.org/doc/html/v6.17/translations/ko_KR/process/howto.html
fetched_at: 2026-09-16T16:25:54+00:00
---
Korean
...
NOTE:
This is a version of [HOWTO do Linux kernel development](../../../process/howto.md) translated into korean
This document is maintained by Minchan Kim <[minchan@kernel.org](mailto:minchan%40kernel.org)>
...
역자： 김민찬 <[minchan@kernel.org](mailto:minchan%40kernel.org)>
감수： 이제이미 <[jamee.lee@samsung.com](mailto:jamee.lee%40samsung.com)>
...
파일을 봐라. 리눅스 커널 라이센싱 규칙과 소스 코드 안의 [SPDX](https://spdx.org/) 식별자 사용법은
[Documentation/process/license-rules.rst](../../../process/license-rules.md#kernel-licensing) 에 설명되어
...
[mtk.manpages@gmail](mailto:mtk.manpages%40gmail).com의 메인테이너에게 보낼 것을 권장한다.
...
-stable 트리들은 “stable” 팀<[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)>에 의해 관리되며 거의 매번
격주로 배포된다.

커널 트리 문서들 내의 [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.md#stable-kernel-rules)
...
메인 커널 소스 디렉토리에 있는 ‘[Reporting issues](../../../admin-guide/reporting-issues.md)’
...
[Documentation/process/submitting-patches.rst](../../../process/submitting-patches.md#submittingpatches) 에
...
메인테이너: Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
