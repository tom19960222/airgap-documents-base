...
version: "6.17"
title: "内核维护者 PGP 指南"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/maintainer-pgp-guide.html
fetched_at: 2026-09-16T16:31:47+00:00
---
Chinese (Simplified)

- [English](../../../process/maintainer-pgp-guide.md)
- [Italian](../../it_IT/process/maintainer-pgp-guide.md)
...
Original:
:   [Kernel Maintainer PGP guide](../../../process/maintainer-pgp-guide.md)
...
会发布的更通用的 [保护代码完整性](https://github.com/lfit/itpol/blob/master/protecting-code-integrity.md) 指南中讨论的内容子集。阅读该文档，以更
深入地讨论本指南中提到的一些主题。
...
有，请参阅前面提到的 “[保护代码完整性](https://github.com/lfit/itpol/blob/master/protecting-code-integrity.md)” 文档，以获取有关如何创建新
密钥的指导。
...
- [Nitrokey Start](https://shop.nitrokey.com/shop/product/nitrokey-start-6): 开放硬件和免费软件，日本基于FSI的 Gnuk 。
  少数支持 ED25519 ECC 密钥的商用设备之一，但提供的安全功能最少
  （例如防篡改或某些旁路攻击）。
- [Nitrokey Pro 2](https://shop.nitrokey.com/shop/product/nkpr2-nitrokey-pro-2-3): 与 Nitrokey Start 类似，但更防篡改并提供
  更多安全功能。Pro 2 支持 ECC 加密 (NISTP)。
- [Yubikey 5](https://www.yubico.com/products/yubikey-5-overview/): 专有硬件和软件，但比 Nitrokey Pro 便宜，并且以
...
- [Agent通过SSH转发](https://wiki.gnupg.org/AgentForwarding)
...
而你非常确定 [自己与它无关](https://github.com/jayphelps/git-blame-someone-else) ，会发生什么？
...
请参阅下面的”[如何使用签名补丁](maintainer-pgp-guide.md#id25)”部分。
...
如果你有 kernel.org 帐户，那么你应该 [添加 kernel.org UID 到你的密钥中](https://korg.wiki.kernel.org/userdoc/mail#adding_a_kernelorg_uid_to_your_pgp_key)
...
- [内核开发者密钥环](https://korg.docs.kernel.org/pgpkeys.html)
