...
version: "6.17"
title: "如何参与Linux内核开发"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/howto.html
...
[Documentation/translations/zh_CN/process/license-rules.rst](license-rules.md#cn-kernel-licensing)
...
:   [Documentation/admin-guide/README.rst](../../../admin-guide/README.md#readme)
    ...
    [Documentation/translations/zh_CN/process/coding-style.rst](coding-style.md#cn-codingstyle)
    ...
    [Documentation/translations/zh_CN/process/stable-api-nonsense.rst](stable-api-nonsense.md#cn-stable-api-nonsense)
    ...
    [Documentation/translations/zh_CN/process/management-style.rst](management-style.md#cn-managementstyle)
...
稳定版内核树版本由“稳定版”小组（邮件地址<[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)>）维护，一般
隔周发布新版本。

内核源码中的 [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.md#stable-kernel-rules)
...
英文版维护者： Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
