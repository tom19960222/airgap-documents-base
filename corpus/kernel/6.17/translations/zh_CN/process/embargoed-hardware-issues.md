...
version: "6.17"
title: "被限制的硬件问题"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/embargoed-hardware-issues.html
...
小组处理，报告者将被引导至常规Linux内核安全小组([Documentation/admin-guide/](../../../process/security-bugs.md#securitybugs))联系。

可以通过电子邮件 <[hardware-security@kernel.org](mailto:hardware-security%40kernel.org)> 与小组联系。这是一份私密的安全
...
初次接触见 [接触](embargoed-hardware-issues.md#zh-contact). 对于特定于事件的邮件列表，密钥和S/MIME证书通过
特定列表发送的电子邮件传递给订阅者。
