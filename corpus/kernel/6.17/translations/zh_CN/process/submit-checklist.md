...
collection: kernel
version: "6.17"
title: "Linux内核补丁提交检查单"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/submit-checklist.html
...
这些都是在 [提交补丁：如何让你的改动进入内核](submitting-patches.md)
...
10. 使用 `make checkstack` 并修复他们发现的任何问题。
    ...
    > 字节的函数都可以进行更改。
11. 包括 [kernel-doc](../doc-guide/kernel-doc.md#kernel-doc-zh) 内核文档以记录全局内核API。（静态
    函数不需要，但也可以。）使用 `make htmldocs` 或 `make pdfdocs` 检查
    [kernel-doc](../doc-guide/kernel-doc.md#kernel-doc-zh) 并修复任何问题。
...
18. 所有新的用户空间接口都记录在 `Documentation/ABI/` 中。有关详细信息，
    请参阅 [Linux ABI description](../../../admin-guide/abi.md) (或 `Documentation/ABI/README`)。
    更改用户空间接口的补丁应该抄送 [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org)。
