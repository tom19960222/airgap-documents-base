...
version: "6.17"
title: "Linux 内核代码风格"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/coding-style.html
fetched_at: 2026-09-16T16:31:18+00:00
---
Chinese (Simplified)
...
译者:
:   - 张乐 Zhang Le <[r0bertz@gentoo.org](mailto:r0bertz%40gentoo.org)>
    - Andy Deng <[theandy.deng@gmail.com](mailto:theandy.deng%40gmail.com)>
    - 吴想成 <[bobwxc@email.cn](mailto:bobwxc%40email.cn)>

校译:
:   - 王聪 Wang Cong <[xiyou.wangcong@gmail.com](mailto:xiyou.wangcong%40gmail.com)>
    - wheelz <[kernel.zeng@gmail.com](mailto:kernel.zeng%40gmail.com)>
    - 管旭东 Xudong Guan <[xudong.guan@gmail.com](mailto:xudong.guan%40gmail.com)>
...
> 1. 完全不透明的对象 (这种情况下要主动使用 typedef 来 **隐藏** 这个对象实际上
>    是什么)。
>
...
>    > 的是完全没有任何共用的可访问信息。
> 2. 清楚的整数类型，如此，这层抽象就可以 **帮助** 消除到底是 `int` 还是
>    `long` 的混淆。
>
...
写函数原型时，请保持 [元素顺序规则](https://lore.kernel.org/mm-commits/CAHk-=wiOCLRny5aifWNhr621kYrJwhfURsa0vFPeUEm8mF0ufg@mail.gmail.com/) 。
例如下列函数声明:
...
[如何编写内核文档](../doc-guide/index.md) 和 scripts/kernel-doc 。
...
详见 [clang-format](../../../dev-tools/clang-format.md) 。
...
要查看配置文件的完整文档，请看 [Kconfig Language](../../../kbuild/kconfig-language.md) 。
...
函数能无条件地打印，[`pr_debug()`](../../../core-api/printk-basics.md#c.pr_debug "pr_debug") 却不；默认情况下它不会被编译，除非定义了 DEBUG
...
[`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc") 内联函数就是一个很好的例子。
...
-EBUSY。类似的，因为 `PCI device present` 是一个判断，所以 [`pci_dev_present()`](../../../driver-api/pci/pci.md#c.pci_dev_present "pci_dev_present")
...
内核文档 [Linux kernel coding style](../../../process/coding-style.md)，
作者 [greg@kroah.com](mailto:greg%40kroah.com) 发表于 OLS 2002：
