...
version: "6.17"
title: "8. 更多信息"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/8.Conclusion.html
fetched_at: 2026-09-16T16:31:12+00:00
---
Chinese (Simplified)

- [English](../../../process/8.Conclusion.md)
- [Chinese (Traditional)](../../zh_TW/process/8.Conclusion.md)
- [Italian](../../it_IT/process/8.Conclusion.md)
- [Spanish](../../sp_SP/process/8.Conclusion.md)
...
Translator:
:   时奎亮 Alex Shi <[alex.shi@linux.alibaba.com](mailto:alex.shi%40linux.alibaba.com)>
...
文档目录。顶级
[Documentation/translations/zh_CN/process/howto.rst](howto.md#cn-process-howto)
文件是一个重要的起点；
[Documentation/translations/zh_CN/process/submitting-patches.rst](submitting-patches.md#cn-submittingpatches)
