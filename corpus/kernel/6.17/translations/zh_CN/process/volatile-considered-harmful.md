...
collection: kernel
version: "6.17"
title: "为什么不应该使用“volatile”类型"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/volatile-considered-harmful.html
fetched_at: 2026-09-16T16:31:50+00:00
---
Chinese (Simplified)

- [English](../../../process/volatile-considered-harmful.md)
- [Chinese (Traditional)](../../zh_TW/process/volatile-considered-harmful.md)
- [Italian](../../it_IT/process/volatile-considered-harmful.md)
...
Original:
:   [Documentation/process/volatile-considered-harmful.rst](../../../process/volatile-considered-harmful.md#volatile-considered-harmful)
...
它知道在shared_data里面将有什么，但是因为`spin_lock()`调用跟内存屏障一样，会强制编
