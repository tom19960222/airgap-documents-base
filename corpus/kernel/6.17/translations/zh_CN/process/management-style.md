...
version: "6.17"
title: "Linux内核管理风格"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/management-style.html
...
它的目的是在某种程度上参照 [process/coding-style.rst](../../../process/coding-style.md#codingstyle)
主要是为了避免反复回答 [[1]](management-style.md#cnf1) 相同（或类似）的问题。
...
本文件并不是通过回答问题，而是通过让提问者痛苦地明白，我们不知道
答案是什么。
...
[1）决策](management-style.md#cn-decisions) 成为绝不可以做的事情。
...
问题在于 #1 很容易去做，因为你可以用数百万种不同的方式说“你是一个笨蛋” [[2]](management-style.md#cnf2)
...
[[2](management-style.md#id4)]

保罗·西蒙演唱了“离开爱人的50种方法”，因为坦率地说，“告诉开发者
...
[[3](management-style.md#id8)]

提示：与你的工作没有直接关系的网络新闻组是消除你对他人不满的好
