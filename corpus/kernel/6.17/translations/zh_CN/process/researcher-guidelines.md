...
version: "6.17"
title: "研究人员指南"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/process/researcher-guidelines.html
fetched_at: 2026-09-16T16:31:38+00:00
---
Chinese (Simplified)

- [English](../../../process/researcher-guidelines.md)
- [Spanish](../../sp_SP/process/researcher-guidelines.md)
...
Original:
:   [Researcher Guidelines](../../../process/researcher-guidelines.md)
...
- [研究伦理史](https://www.unlv.edu/research/ORI-HSR/history-ethics)
- [IEEE 伦理](https://www.ieee.org/about/ethics/index.html)
- [开发者和研究人员对开源项目实验伦理的看法](https://arxiv.org/pdf/2112.13217.pdf)
...
- 在哪个版本的 Linux 上发现了这个问题？强烈推荐使用最新的发布版本或最近的 linux-next 分支（参见 [HOWTO do Linux kernel development](../../../process/howto.md)）。
...
有任何其他问题，请联系技术咨询委员会私有邮件列表：<[tech-board@groups.linuxfoundation.org](mailto:tech-board%40groups.linuxfoundation.org)>。
