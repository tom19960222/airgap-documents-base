...
collection: kernel
version: "6.17"
title: "CPUFreq核心和CPUFreq通知器的通用说明"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/cpu-freq/core.html
fetched_at: 2026-09-16T16:53:30+00:00
---
Chinese (Simplified)

- [English](../../../cpu-freq/core.md)
- [Chinese (Traditional)](../../zh_TW/cpu-freq/core.md)
...
Original:
:   [General description of the CPUFreq core and CPUFreq notifiers](../../../cpu-freq/core.md)
...
关于OPP的细节请参阅 [Operating Performance Points (OPP) Library](../../../power/opp.md)
