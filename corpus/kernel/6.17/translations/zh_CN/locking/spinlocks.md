...
version: "6.17"
title: "加锁的教训"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/locking/spinlocks.html
fetched_at: 2026-09-16T16:46:48+00:00
---
Chinese (Simplified)

- [English](../../../locking/spinlocks.md)
...
Original:
:   [Locking lessons](../../../locking/spinlocks.md)
...
对于动态初始化，使用`spin_lock_init()`或`rwlock_init()`是合适的:
...
对于静态初始化，使用`DEFINE_SPINLOCK()` / `DEFINE_RWLOCK()`或
