...
collection: kernel
version: "6.17"
title: "Linux 内核中文文档翻译规范"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/how-to.html
...
详细的贡献指南：[与Linux 内核社区一起工作](process/index.md)。
...
关于邮件客户端的配置，请查阅 [Linux邮件客户端配置信息](process/email-clients.md)。
...
文档文件和对应的 [中文翻译](index.md) 复制到 zh_CN 目录下对应的位置，然后修改更
上一级的 index 即可开始您的翻译。
...
关于详细操作说明，请参考：[工作原理](doc-guide/checktransupdate.md)。
