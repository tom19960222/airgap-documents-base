...
version: "6.17"
title: "操作性能值（OPP）库"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/power/opp.html
fetched_at: 2026-09-16T16:51:41+00:00
---
Chinese (Simplified)

- [English](../../../power/opp.md)
...
Original:
:   [Operating Performance Points (OPP) Library](../../../power/opp.md)
...
3. 2009-2010 Nishanth Menon <[nm@ti.com](mailto:nm%40ti.com)>, 德州仪器公司
...
否则返回错误。这些错误预计由标准的错误检查，如[`IS_ERR()`](../../../core-api/kernel-api.md#c.IS_ERR "IS_ERR")来处理，并由调用者采取适当的
行动。

这些函数的调用者应在使用完OPP后调用`dev_pm_opp_put()`。否则，OPP的内存将永远不会
被释放，并导致内存泄露。
