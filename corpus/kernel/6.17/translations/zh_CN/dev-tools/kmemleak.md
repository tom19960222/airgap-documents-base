...
version: "6.17"
title: "内核内存泄露检测器"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/dev-tools/kmemleak.html
fetched_at: 2026-09-16T16:47:00+00:00
---
Chinese (Simplified)

- [English](../../../dev-tools/kmemleak.md)
...
Kmemleak 提供了一个类似 [可追踪的垃圾收集器](https://en.wikipedia.org/wiki/Tracing_garbage_collection) 的方法来检测可能的内核内存泄漏，不同的是孤立对象不会
...
通过 [`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc"), [`vmalloc()`](../../../core-api/mm-api.md#c.vmalloc "vmalloc"), [`kmem_cache_alloc()`](../../../core-api/mm-api.md#c.kmem_cache_alloc "kmem_cache_alloc") 以及同类
...
- `kmemleak_vmalloc` - 通知一个使用 [`vmalloc()`](../../../core-api/mm-api.md#c.vmalloc "vmalloc") 的内存分配
