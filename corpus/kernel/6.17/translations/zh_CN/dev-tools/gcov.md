...
collection: kernel
version: "6.17"
title: "在Linux内核里使用gcov做代码覆盖率检查"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/dev-tools/gcov.html
fetched_at: 2026-09-16T16:46:56+00:00
---
Chinese (Simplified)

- [English](../../../dev-tools/gcov.md)
- [Chinese (Traditional)](../../zh_TW/dev-tools/gcov.md)
...
gcov分析核心支持在Linux内核中启用GCC的覆盖率测试工具 [gcov](https://gcc.gnu.org/onlinedocs/gcc/Gcov.html) ，Linux内核
...
在获得这些统计文件后，可以使用图形化的gcov前端工具（比如 [lcov](http://ltp.sourceforge.net/coverage/lcov.php) ），来实现
...
如果编译器是GCC，使用 [gcov](https://gcc.gnu.org/onlinedocs/gcc/Gcov.html) 来处理.gcno和.gcda文件，如果是Clang编译器，
则使用 [llvm-cov](https://llvm.org/docs/CommandGuide/llvm-cov.html) 。
...
（见 [编译机和测试机分离 a.](gcov.md#gcov-test-zh-cn) ）
...
（见 [编译机和测试机分离 b.](gcov.md#gcov-build-zh-cn) ）
