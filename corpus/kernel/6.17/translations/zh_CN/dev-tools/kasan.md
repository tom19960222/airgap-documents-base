...
version: "6.17"
title: "内核地址消毒剂(KASAN)"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/dev-tools/kasan.html
fetched_at: 2026-09-16T16:46:58+00:00
---
Chinese (Simplified)

- [English](../../../dev-tools/kasan.md)
- [Chinese (Traditional)](../../zh_TW/dev-tools/kasan.md)
...
Translator:
:   万家兵 Wan Jiabing <[wanjiabing@vivo.com](mailto:wanjiabing%40vivo.com)>
...
出现在错误访问堆栈跟踪中的位置。目前，这包括 [`call_rcu()`](../../../core-api/kernel-api.md#c.call_rcu "call_rcu") 和排队的工作队列。
...
3. 使用kunit_tool
   ...
   [KUnit文档](https://www.kernel.org/doc/html/latest/dev-tools/kunit/index.html) 。
