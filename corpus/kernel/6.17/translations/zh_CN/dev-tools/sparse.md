...
version: "6.17"
title: "Sparse"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/dev-tools/sparse.html
fetched_at: 2026-09-16T16:46:55+00:00
---
Chinese (Simplified)

- [English](../../../dev-tools/sparse.md)
- [Chinese (Traditional)](../../zh_TW/dev-tools/sparse.md)
...
Original:
:   [Sparse](../../../dev-tools/sparse.md)

翻译:
:   Li Yang <[leoyang.li@nxp.com](mailto:leoyang.li%40nxp.com)>
