...
collection: kernel
version: "6.17"
title: "架构特定代码的CPU调度器实现提示"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/scheduler/sched-arch.html
fetched_at: 2026-09-16T16:52:06+00:00
---
Chinese (Simplified)

- [English](../../../scheduler/sched-arch.md)
...
Original:
:   [CPU Scheduler implementation hints for architecture specific code](../../../scheduler/sched-arch.md)
...
3. 当cpu_idle发现（`need_resched()` == ‘true’），它应该调用`schedule()`。否则
   它不应该调用`schedule()`。
