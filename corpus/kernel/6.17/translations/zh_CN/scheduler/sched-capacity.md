...
version: "6.17"
title: "算力感知调度"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/scheduler/sched-capacity.html
fetched_at: 2026-09-16T16:52:07+00:00
---
Chinese (Simplified)

- [English](../../../scheduler/sched-capacity.md)
...
Original:
:   [Capacity Aware Scheduling](../../../scheduler/sched-capacity.md)
...
此外，uclamp允许用户空间指定任务的最小和最大利用率，要么以`sched_setattr()`的方式，要么以
cgroup接口的方式（参阅Documentation/admin-guide/cgroup-v2.rst）。如其名字所暗示，uclamp
可以被用在前一条准则中限制`task_util()`。
...
> [Energy Aware Scheduling](../../../scheduler/sched-energy.md)中描述。
