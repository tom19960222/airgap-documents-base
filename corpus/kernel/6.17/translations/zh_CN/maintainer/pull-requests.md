...
version: "6.17"
title: "如何创建拉取请求"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/maintainer/pull-requests.html
fetched_at: 2026-09-16T16:31:41+00:00
---
Chinese (Simplified)

- [English](../../../maintainer/pull-requests.md)
...
Original:
:   [Creating Pull Requests](../../../maintainer/pull-requests.md)
...
Harding <[me@tobin.cc](mailto:me%40tobin.cc)>。
...
的标记，并用您的gpg密钥签名（参见 [Configuring Git](../../../maintainer/configure-git.md) ）。
