...
version: "6.17"
title: "快速入门"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/rust/quick-start.html
fetched_at: 2026-09-16T16:47:15+00:00
---
Chinese (Simplified)

- [English](../../../rust/quick-start.md)
...
请参阅 [Building Linux with Clang/LLVM](../../../kbuild/llvm.md) 了解更多信息，以及获取预构建版本和发行包
的进一步方法。
...
传递 `CLIPPY=1` 来运行（关于细节，详见 [基本信息](general-information.md) ）。
...
`rustdoc` 是Rust的文档工具。它为Rust代码生成漂亮的HTML文档（详情请见 [基本信息](general-information.md) ）。
...
[rust-analyzer](https://rust-analyzer.github.io/) 语言服务器可以和许多编辑器
