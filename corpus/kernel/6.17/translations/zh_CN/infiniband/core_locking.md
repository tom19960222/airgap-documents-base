...
collection: kernel
version: "6.17"
title: "infiniband中间层锁"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/infiniband/core_locking.html
fetched_at: 2026-09-16T16:53:08+00:00
---
Chinese (Simplified)

- [English](../../../infiniband/core_locking.md)
...
Original:
:   [InfiniBand Midlayer Locking](../../../infiniband/core_locking.md)
...
> 当一个低级驱动程序调用[`ib_register_device()`](../../../driver-api/infiniband.md#c.ib_register_device "ib_register_device")时，它宣布一个设备已经
> 准备好供使用者使用，所有的初始化必须在这个调用之前完成。设备必须保
> 持可用，直到驱动对[`ib_unregister_device()`](../../../driver-api/infiniband.md#c.ib_unregister_device "ib_unregister_device")的调用返回。
>
> 低级驱动程序必须从进程上下文调用[`ib_register_device()`](../../../driver-api/infiniband.md#c.ib_register_device "ib_register_device")和
> [`ib_unregister_device()`](../../../driver-api/infiniband.md#c.ib_unregister_device "ib_unregister_device")。如果使用者在这些调用中回调到驱动程序，它
