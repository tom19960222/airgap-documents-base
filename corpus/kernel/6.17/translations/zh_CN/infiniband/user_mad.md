...
version: "6.17"
title: "用户空间MAD访问"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/infiniband/user_mad.html
fetched_at: 2026-09-16T16:53:10+00:00
---
Chinese (Simplified)

- [English](../../../infiniband/user_mad.md)
...
Original:
:   [Userspace MAD access](../../../infiniband/user_mad.md)
...
> 一个`struct ib_user_mad` + 256字节。比如说:
>
...
> P_Key索引的方法。一个带有pkey_index成员的`struct ib_user_mad_hdr`的新布局已
