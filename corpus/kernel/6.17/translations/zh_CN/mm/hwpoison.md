...
version: "6.17"
title: "hwpoison"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/mm/hwpoison.html
fetched_at: 2026-09-16T16:51:53+00:00
---
Chinese (Simplified)

- [English](../../../mm/hwpoison.md)
...
- 通过debugfs `/sys/kernel/debug/hwpoison/` hwpoison-inject模块
  ...
  :   当指定时，只有在((page_flags & mask) == value)的情况下才会poison页面。
      ...
      [Examining Process Page Tables](../../../admin-guide/mm/pagemap.md)中记录。
- 架构特定的MCE注入器
