...
collection: kernel
version: "6.17"
title: "分页表锁（split page table lock）"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/mm/split_page_table_lock.html
fetched_at: 2026-09-16T16:52:00+00:00
---
Chinese (Simplified)

- [English](../../../mm/split_page_table_lock.md)
...
中，但要确保覆盖所有的PMD表分配/释放路径：即X86_PAE在`pgd_alloc()`中预先
分配一些PMD。
...
PTE表的spinlock_t分配在`pagetable_pte_ctor()`中，PMD表的spinlock_t
