...
collection: kernel
version: "6.17"
title: "何为非统一内存访问(NUMA)？"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/mm/numa.html
fetched_at: 2026-09-16T16:51:55+00:00
---
Chinese (Simplified)

- [English](../../../mm/numa.md)

始于1999年11月，作者： <[kanoj@sgi.com](mailto:kanoj%40sgi.com)>
...
可以作为一种内存资源管理机制。[见 [CPUSETS](../../../admin-guide/cgroup-v1/cpusets.md)]
...
中[见 [Scheduler Domains](../../../scheduler/sched-domains.md)]——并且调度器试图尽量减少任务迁移到遥
...
的内存。 [见 [CPUSETS](../../../admin-guide/cgroup-v1/cpusets.md)]
...
一个典型的分配模式是使用内核的`numa_node_id()`或`CPU_to_node()`函数获得“当前CPU”所在节点的
...
以使用`numa_mem_id()`或`cpu_to_mem()`函数来定位调用或指定CPU的“本地内存节点”。同样，这是同
