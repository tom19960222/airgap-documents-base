...
version: "6.17"
title: "物理内存模型"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/mm/memory-model.html
fetched_at: 2026-09-16T16:51:53+00:00
---
Chinese (Simplified)

- [English](../../../mm/memory-model.md)
...
为了分配 mem_map 数组，架构特定的设置代码应该调用`free_area_init()`函数。
然而，在调用[`memblock_free_all()`](../../../core-api/boot-time-mm.md#c.memblock_free_all "memblock_free_all")函数之前，映射数组是不能使用的，该函数
将所有的内存交给页分配器。

一个架构可能会释放 mem_map 数组中不包括实际物理页的部分。在这种情况下，特
定架构的 [`pfn_valid()`](../../../core-api/mm-api.md#c.pfn_valid "pfn_valid") 实现应该考虑到 mem_map 中的孔隙。
...
是页面，以保持内存被“锁定”以便使用。 ZONE_DEVICE ，通过 [`devm_memremap_pages()`](../../../core-api/mm-api.md#c.devm_memremap_pages "devm_memremap_pages") ，
...
[`devm_memremap_pages()`](../../../core-api/mm-api.md#c.devm_memremap_pages "devm_memremap_pages") 的跨架构通用对齐颗粒度。
