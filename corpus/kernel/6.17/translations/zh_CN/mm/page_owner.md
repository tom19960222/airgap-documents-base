...
collection: kernel
version: "6.17"
title: "page owner: 跟踪谁分配的每个页面"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/mm/page_owner.html
fetched_at: 2026-09-16T16:51:57+00:00
---
Chinese (Simplified)

- [English](../../../mm/page_owner.md)
...
有一个问题是由实现细节引起的。页所有者将信息存储到`struct page`扩展的内存中。这
