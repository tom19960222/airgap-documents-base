...
collection: kernel
version: "6.17"
title: "Unicode（统一码）支持"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/admin-guide/unicode.html
fetched_at: 2026-09-16T16:49:26+00:00
---
Chinese (Simplified)

- [English](../../../admin-guide/unicode.md)
- [Chinese (Traditional)](../../zh_TW/admin-guide/unicode.md)
...
Original:
:   [Unicode support](../../../admin-guide/unicode.md)
...
此文档由H. Peter Anvin <[unicode@lanana.org](mailto:unicode%40lanana.org)>管理，是Linux注册名称与编号管理局
...
自从分配了克林贡Linux Unicode块之后，John Cowan <[jcowan@reutershealth.com](mailto:jcowan%40reutershealth.com)>
和 Michael Everson <[everson@evertype.com](mailto:everson%40evertype.com)> 建立了一个虚构和人工字母的注册表。
征募Unicode注册表请访问：
