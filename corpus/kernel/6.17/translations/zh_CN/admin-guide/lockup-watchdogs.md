...
collection: kernel
version: "6.17"
title: "Softlockup与hardlockup检测机制(又名:nmi_watchdog)"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/admin-guide/lockup-watchdogs.html
fetched_at: 2026-09-16T16:47:58+00:00
---
Chinese (Simplified)

- [English](../../../admin-guide/lockup-watchdogs.md)
- [Chinese (Traditional)](../../zh_TW/admin-guide/lockup-watchdogs.md)
...
Original:
:   [Softlockup detector and hardlockup detector (aka nmi_watchdog)](../../../admin-guide/lockup-watchdogs.md)
...
“nmi_watchdog”(详见:”[The kernel’s command-line parameters](../../../admin-guide/kernel-parameters.md)“)外，一旦检
