...
collection: kernel
version: "6.17"
title: "如何通过sysfs将CPU拓扑导出"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/admin-guide/cputopology.html
fetched_at: 2026-09-16T16:47:23+00:00
---
Chinese (Simplified)

- [English](../../../admin-guide/cputopology.md)
- [Chinese (Traditional)](../../zh_TW/admin-guide/cputopology.md)
...
`**_siblings` sysfs属性对应（除了`topology_sibling_cpumask()`，它和thread_siblings
对应）。
