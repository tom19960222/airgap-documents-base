...
version: "6.17"
title: "基于DAMON的LRU排序"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/admin-guide/mm/damon/lru_sort.html
fetched_at: 2026-09-16T16:56:25+00:00
---
Chinese (Simplified)

- [English](../../../../../admin-guide/mm/damon/lru_sort.md)
- [Chinese (Traditional)](../../../../zh_TW/admin-guide/mm/damon/lru_sort.md)
...
翻译:
:   臧雷刚 Leigang Zang <[zangleigang@hisilicon.com](mailto:zangleigang%40hisilicon.com)>
...
DAMON对冷内存监测的采样周期。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。默认5
毫秒。
...
DAMON对冷内存进行收集的时间周期。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。默认
100毫秒。
...
大会增加开销。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。默认值为10。
...
低会导致监测结果变差。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。默认值为1000。
