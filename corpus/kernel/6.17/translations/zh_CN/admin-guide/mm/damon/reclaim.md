...
version: "6.17"
title: "基于DAMON的回收"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/admin-guide/mm/damon/reclaim.html
fetched_at: 2026-09-16T16:56:25+00:00
---
Chinese (Simplified)

- [English](../../../../../admin-guide/mm/damon/reclaim.md)
- [Chinese (Traditional)](../../../../zh_TW/admin-guide/mm/damon/reclaim.md)
...
Original:
:   [DAMON-based Reclamation](../../../../../admin-guide/mm/damon/reclaim.md)
...
生最小的性能下降 [[1]](reclaim.md#id8) [[2]](reclaim.md#id9) 。

基于空闲页报告 [[3]](reclaim.md#id10) 的内存过度承诺的虚拟化系统就是很好的例子。在这样的系统中，客户机
...
DAMON用于监测冷内存的采样间隔。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。

### aggr_interval

监测的聚集间隔，单位是微秒。

DAMON对冷内存监测的聚集间隔。更多细节请参考DAMON文档 ([详细用法](usage.md))。
...
置的太高可能会导致监测开销的增加。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。
...
设置得太低可能会导致监测质量不好。更多细节请参考DAMON文档 ([详细用法](usage.md)) 。
