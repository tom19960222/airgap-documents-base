...
version: "6.17"
title: "GCC 插件基础设施"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/kbuild/gcc-plugins.html
fetched_at: 2026-09-16T16:49:30+00:00
---
Chinese (Simplified)

- [English](../../../kbuild/gcc-plugins.md)
...
Original:
:   [GCC plugin infrastructure](../../../kbuild/gcc-plugins.md)
...
GCC 插件是为编译器提供额外功能的可加载模块 [[1]](gcc-plugins.md#id9)。它们对于运行时插装和静态分析非常有用。
我们可以在编译过程中通过回调 [[2]](gcc-plugins.md#id10)，GIMPLE [[3]](gcc-plugins.md#id11)，IPA [[4]](gcc-plugins.md#id12) 和 RTL Passes [[5]](gcc-plugins.md#id13)
