...
collection: kernel
version: "6.17"
title: "genalloc/genpool子系统"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/genalloc.html
fetched_at: 2026-09-16T16:36:01+00:00
---
Chinese (Simplified)

- [English](../../../core-api/genalloc.md)
...
Original:
:   [The genalloc/genpool subsystem](../../../core-api/genalloc.md)
...
对[`gen_pool_create()`](../../../core-api/genalloc.md#c.gen_pool_create "gen_pool_create")的调用将创建一个内存池。分配的粒度由min_alloc_order设置；它
...
“管理的”接口[`devm_gen_pool_create()`](../../../core-api/genalloc.md#c.devm_gen_pool_create "devm_gen_pool_create")将内存池与一个特定的设备联系起来。在其他方面，
...
对[`gen_pool_add()`](../../../core-api/genalloc.md#c.gen_pool_add "gen_pool_add")的调用将把从地址（在内核的虚拟地址空间）开始的内存的大小字节放入
...
正如人们所期望的，[`gen_pool_alloc()`](../../../core-api/genalloc.md#c.gen_pool_alloc "gen_pool_alloc")将从给定的池中分配size<字节。[`gen_pool_dma_alloc()`](../../../core-api/genalloc.md#c.gen_pool_dma_alloc "gen_pool_dma_alloc")
...
使用`gen_pool_alloc_algo()`进行的分配指定了一种用于选择要分配的内存的算法；默认算法可
以用[`gen_pool_set_algo()`](../../../core-api/genalloc.md#c.gen_pool_set_algo "gen_pool_set_algo")来设置。数据值被传递给算法；大多数算法会忽略它，但偶尔也会需
