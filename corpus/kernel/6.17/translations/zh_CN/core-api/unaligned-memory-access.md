...
version: "6.17"
title: "非对齐内存访问"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/unaligned-memory-access.html
fetched_at: 2026-09-16T16:35:29+00:00
---
Chinese (Simplified)

- [English](../../../core-api/unaligned-memory-access.md)
...
避免非对齐访问的最简单方法是使用<linux/unaligned.h>头文件提供的`get_unaligned()`和
`put_unaligned()`宏。
...
如果使用这些宏不方便，另一个选择是使用[`memcpy()`](../../../core-api/kernel-api.md#c.memcpy "memcpy")，其中源或目标（或两者）的类型为u8\*或
