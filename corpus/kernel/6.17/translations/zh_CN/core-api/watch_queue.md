...
version: "6.17"
title: "通用通知机制"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/watch_queue.html
fetched_at: 2026-09-16T16:35:32+00:00
---
Chinese (Simplified)

- [English](../../../core-api/watch_queue.md)
...
Original:
:   [General notification mechanism](../../../core-api/watch_queue.md)
...
- [概述](watch_queue.md#id2)
- [消息结构](watch_queue.md#id3)
- [观测列表（通知源）API](watch_queue.md#api)
- [观测队列（通知输出）API](watch_queue.md#id4)
- [观测订阅API](watch_queue.md#id5)
- [通知发布API](watch_queue.md#id6)
- [观测源](watch_queue.md#id7)
- [事件过滤](watch_queue.md#id8)
- [用户空间代码示例](watch_queue.md#id9)

## [概述](watch_queue.md#id10)
...
## [观测列表（通知源）API](watch_queue.md#id12)
...
## [观测队列（通知输出）API](watch_queue.md#id13)
...
联的观测队列缓冲区时，这将与`struct watch_notification`::info的WATCH_INFO_ID字段进
行或运算。
