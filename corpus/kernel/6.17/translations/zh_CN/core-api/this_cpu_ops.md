...
version: "6.17"
title: "this_cpu操作"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/this_cpu_ops.html
fetched_at: 2026-09-16T16:35:41+00:00
---
Chinese (Simplified)

- [English](../../../core-api/this_cpu_ops.md)
...
Original:
:   [this_cpu operations](../../../core-api/this_cpu_ops.md)
...
作者:
:   Christoph Lameter, 2014年8月4日

作者:
:   Pranith Kumar, 2014年8月2日
...
定义了以下具有隐含抢占保护的`this_cpu()`操作。可以使用这些操作而不用担心抢占和中断:
