...
version: "6.17"
title: "内存热插拔"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/memory-hotplug.html
fetched_at: 2026-09-16T16:35:57+00:00
---
Chinese (Simplified)

- [English](../../../core-api/memory-hotplug.md)
...
Original:
:   [Memory hotplug](../../../core-api/memory-hotplug.md)
...
- `device_online()`将首先接受`device_lock()`，然后是mem_hotplug_lock。
- `add_memory_resource()`将首先使用mem_hotplug_lock，然后是`device_lock()`（在创
