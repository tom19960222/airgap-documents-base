...
version: "6.17"
title: "Linux通用IRQ处理"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/core-api/genericirq.html
fetched_at: 2026-09-16T16:35:58+00:00
---
Chinese (Simplified)
...
Linux中中断处理的原始实现使用`__do_IRQ()`超级处理程序，它能够处理每种类型的
中断逻辑。
...
在SMP的`__do_IRQ()`超级处理程序中，还需定义一种类型：
