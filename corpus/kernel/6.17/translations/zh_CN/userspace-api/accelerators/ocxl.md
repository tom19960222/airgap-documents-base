...
collection: kernel
version: "6.17"
title: "OpenCAPI （开放相干加速器处理器接口）"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/userspace-api/accelerators/ocxl.html
fetched_at: 2026-09-16T16:49:44+00:00
---
Chinese (Simplified)

- [English](../../../../userspace-api/accelerators/ocxl.md)
...
Original:
:   [OpenCAPI (Open Coherent Accelerator Processor Interface)](../../../../userspace-api/accelerators/ocxl.md)
...
由 [OpenCAPI Consortium](http://opencapi.org/) 开发。
...
[ABI file testing/sysfs-class-ocxl](../../../../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-class-ocxl) 中描述。
