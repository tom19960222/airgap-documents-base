...
version: "6.17"
title: "futex2"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/userspace-api/futex2.html
fetched_at: 2026-09-16T16:49:39+00:00
---
Chinese (Simplified)

- [English](../../../userspace-api/futex2.md)
...
Original:
:   [futex2](../../../userspace-api/futex2.md)
...
作者:
:   André Almeida <[andrealmeid@collabora.com](mailto:andrealmeid%40collabora.com)>
...
用户空间设置一个`struct futex_waitv`数组（最多128项），设置 `uaddr` 为等待的
