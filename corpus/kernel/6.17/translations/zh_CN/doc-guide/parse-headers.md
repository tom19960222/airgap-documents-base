...
version: "6.17"
title: "包含用户空间API头文件"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/doc-guide/parse-headers.html
fetched_at: 2026-09-16T16:46:51+00:00
---
Chinese (Simplified)

- [English](../../../doc-guide/parse-headers.md)
- [Italian](../../it_IT/doc-guide/parse-headers.md)
...
Original:
:   [Including uAPI header files](../../../doc-guide/parse-headers.md)
...
[parse_headers.pl](parse-headers.md#parse-headers-zh) 提供了生成此类交叉引用的一种方法。
...
>
> replace语句中， **new_value** 会自动使用 **typedef**, **enum**和 **struct**类型的 :c:type: 引用；以及 **ioctl**, **define** 和
