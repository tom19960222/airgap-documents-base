...
collection: kernel
version: "6.17"
title: "5. 通过sysfs访问PCI设备资源"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/PCI/sysfs-pci.html
fetched_at: 2026-09-16T16:54:30+00:00
---
Chinese (Simplified)

- [English](../../../PCI/sysfs-pci.md)
...
Original:
:   [Accessing PCI device resources through sysfs](../../../PCI/sysfs-pci.md)
...
> | resource0..N | PCI资源N，如果存在的话 (binary, mmap, rw[[1]](sysfs-pci.md#id2)) |
...
rw 仅适用于 IORESOURCE_IO（I/O 端口）区域
...
支持PCI资源的写组合映射的平台必须定义`arch_can_pci_mmap_wc()`，当写组合被允许时，在运行时应
评估为非零。支持I/O资源映射的平台同样定义`arch_can_pci_mmap_io()`。
