...
version: "6.17"
title: "LoongArch体系结构"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/arch/loongarch/index.html
...
- [3. LoongArch的IRQ芯片模型（层级关系）](irq-chip-model.md)
  ...
  - [3.3. 虚拟扩展IRQ模型](irq-chip-model.md#id2)
  - [3.4. 高级扩展IRQ模型](irq-chip-model.md#id4)
  - [3.5. ACPI相关的定义](irq-chip-model.md#acpi)
  - [3.6. 参考文献](irq-chip-model.md#id5)
