...
collection: kernel
version: "6.17"
title: "RISC-V内核启动要求和限制"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/arch/riscv/boot.html
fetched_at: 2026-09-16T16:50:14+00:00
---
Chinese (Simplified)

- [English](../../../../arch/riscv/boot.md)
...
Original:
:   [RISC-V Kernel Boot Requirements and Constraints](../../../../arch/riscv/boot.md)

翻译:
:   龙进 Jin Long <[longjin@dragonos.org](mailto:longjin%40dragonos.org)>

# RISC-V内核启动要求和限制

Author:
:   Alexandre Ghiti <[alexghiti@rivosinc.com](mailto:alexghiti%40rivosinc.com)>
