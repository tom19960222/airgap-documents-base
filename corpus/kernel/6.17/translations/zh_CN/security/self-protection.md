...
version: "6.17"
title: "内核自我保护"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/security/self-protection.html
fetched_at: 2026-09-16T16:54:10+00:00
---
Chinese (Simplified)

- [English](../../../security/self-protection.md)
...
Original:
:   [Kernel Self-Protection](../../../security/self-protection.md)
...
复制到用户空间的内存必须始终被完全初始化，如果没有显式地使用[`memset()`](../../../core-api/kernel-api.md#c.memset "memset")
