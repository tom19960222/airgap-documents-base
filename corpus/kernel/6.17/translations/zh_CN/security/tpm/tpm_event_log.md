...
version: "6.17"
title: "TPM事件日志"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/security/tpm/tpm_event_log.html
fetched_at: 2026-09-16T16:56:21+00:00
---
Chinese (Simplified)

- [English](../../../../security/tpm/tpm_event_log.md)
...
Original:
:   [TPM Event Log](../../../../security/tpm/tpm_event_log.md)
...
在调用`ExitBootServices()`之前，Linux EFI引导加载程序会将事件日志复制到由
引导加载程序自定义的配置表中。不幸的是，通过`ExitBootServices()`生成的事件
并不会出现在这个表里。
