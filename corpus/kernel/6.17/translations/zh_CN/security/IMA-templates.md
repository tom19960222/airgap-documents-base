...
version: "6.17"
title: "IMA模板管理机制"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_CN/security/IMA-templates.html
fetched_at: 2026-09-16T16:54:12+00:00
---
Chinese (Simplified)

- [English](../../../security/IMA-templates.md)
...
Original:
:   [IMA Template Management Mechanism](../../../security/IMA-templates.md)
...
标识符，并实现两个函数，分别为`init()`和`show()`，用于生成和显示度量条目。
...
每个条目检索用于生成该条目的模板描述符，并为模板字段结构数组中的每一项调用`show()`
方法。
