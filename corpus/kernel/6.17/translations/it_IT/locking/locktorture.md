...
collection: kernel
version: "6.17"
title: "Funzionamento del test Kernel Lock Torture"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/locking/locktorture.html
fetched_at: 2026-09-16T16:46:47+00:00
---
Italian

- [English](../../../locking/locktorture.md)
...
:   Tipo di blocco da verificare. Di base, solo gli spinlock
    ...
    >       `unlock_irq()`.
    > - “mutex_lock”:
    >   :   coppie di [`mutex_lock()`](../../../kernel-hacking/locking.md#c.mutex_lock "mutex_lock") e [`mutex_unlock()`](../../../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock").
    > - “rtmutex_lock”:
...
stat_interval
:   Numero di secondi fra una stampa ([`printk()`](../../../core-api/printk-basics.md#c.printk "printk")) delle
...
verbose
:   Abilita le stampe di debug, via [`printk()`](../../../core-api/printk-basics.md#c.printk "printk"). Di base è
...
stampa (usando [`printk()`](../../../core-api/printk-basics.md#c.printk "printk")) di “SUCCESS”, “FAILURE”, oppure “RCU_HOTPLUG”. I primi
...
Consultate anche: [Le operazioni RCU per le verifiche torture](../RCU/torture.md)
