...
collection: kernel
version: "6.17"
title: "Validatore di sincronizzazione durante l’esecuzione"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/locking/lockdep-design.html
fetched_at: 2026-09-16T16:46:46+00:00
---
Italian

- [English](../../../locking/lockdep-design.md)
...
una qualsiasi classe di blocco. [[1]](lockdep-design.md#id2)
...
[`rcu_read_lock()`](../../../core-api/kernel-api.md#c.rcu_read_lock "rcu_read_lock")). D’ora in poi, per questi tipi di bloccatori, useremo la
seguente notazione:
