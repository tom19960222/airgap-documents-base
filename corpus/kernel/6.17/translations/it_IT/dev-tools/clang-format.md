...
version: "6.17"
title: "clang-format"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/dev-tools/clang-format.html
fetched_at: 2026-09-16T16:46:54+00:00
---
Italian

- [English](../../../dev-tools/clang-format.md)
...
Original:
:   [Documentation/dev-tools/clang-format.rst](../../../dev-tools/clang-format.md#clangformat)
...
>   allinea/ordina. Vedere [it_clangformatreformat](clang-format.md#it-clangformatreformat).
...
>   eccetera. Vedere [it_clangformatreview](clang-format.md#it-clangformatreview).
...
il più possibile
[Documentation/translations/it_IT/process/coding-style.rst](../process/coding-style.md#it-codingstyle).
...
Consultare [it_clangformatextra](clang-format.md#it-clangformatextra).
