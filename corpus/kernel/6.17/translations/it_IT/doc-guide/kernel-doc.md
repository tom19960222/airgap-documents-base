...
collection: kernel
version: "6.17"
title: "Scrivere i commenti in kernel-doc"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/doc-guide/kernel-doc.html
fetched_at: 2026-09-16T16:46:50+00:00
---
Italian

- [English](../../../doc-guide/kernel-doc.md)
- [Chinese (Simplified)](../../zh_CN/doc-guide/kernel-doc.md)
...
> **Note:**
>
> Il formato kernel-doc può sembrare simile a gtk-doc o Doxygen ma
...
generato il [dominio Sphinx per il C](http://www.sphinx-doc.org/en/stable/domains.html) con un’adeguata descrizione per le
...
> **Note:**
>
> 1. La descrizione multiriga non riconosce il termine d’una riga, per cui
...
>    ```
> 2. Se il vostro testo ha delle righe che iniziano con una frase seguita dai
...
Generalmente il formato di un commento kernel-doc per struct, [`union ed`](../../../networking/ieee802154.md#c.ed "ed") enum è:
...
> **Note:**
>
> 1. Quando documentate una struttura od unione annidata, ad esempio
>    di nome `foo`, il suo campo `bar` dev’essere documentato
>    usando `@foo.bar:`
> 2. Quando la struttura od unione annidata è anonima, il suo campo
...
del [dominio Sphinx per il C](http://www.sphinx-doc.org/en/stable/domains.html).

> **Attention:**
>
> Questi sono riconosciuti **solo** all’interno di commenti
