...
collection: kernel
version: "6.17"
title: "Regole per licenziare il kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/license-rules.html
fetched_at: 2026-09-16T16:21:23+00:00
---
Italian

- [English](../../../process/license-rules.md)
- [Chinese (Simplified)](../../zh_CN/process/license-rules.md)
- [Chinese (Traditional)](../../zh_TW/process/license-rules.md)
...
Original:
:   [Documentation/process/license-rules.rst](../../../process/license-rules.md#kernel-licensing)
...
[Identificatori di licenza](license-rules.md#identificatori-di-licenza) e sono stati copiati dalla lista ufficiale di
...
3. Sintassi:
   ...
   [Eccezioni](license-rules.md#eccezioni) nel capitolo [Identificatori di licenza](license-rules.md#identificatori-di-licenza)
...
1. Licenze raccomandate:
   ...
   [Metatag](license-rules.md#metatag). Il nome di questi file è lo stesso usato come identificatore
   ...
   - Usage-Guidance:
     ...
     [Sintassi degli identificatori di licenza](license-rules.md#sintassi-degli-identificatori-di-licenza).
   - License-Text:
...
2. Licenze deprecate:
   ...
   di usati per le [Licenze raccomandate](license-rules.md#licenze-raccomandate).
...
3. Solo per doppie licenze
   ...
   licenza e i suoi [Metatag](license-rules.md#metatag). I nomi dei file sono identici agli
   ...
   [Licenze raccomandate](license-rules.md#licenze-raccomandate).
...
4. Eccezioni:
   ...
   [Metatag per le eccezioni](license-rules.md#metatag-per-le-eccezioni).
...
> > |  |  |
> > | --- | --- |
> > | “GPL” | Il modulo è licenziato con la GPL versione 2. Questo non fa distinzione fra GPL’2.0-only o GPL-2.0-or-later. L’esatta licenza può essere determinata solo leggendo i corrispondenti file sorgenti. |
> > | “GPL v2” | Stesso significato di “GPL”. Esiste per motivi storici. |
> > | “GPL and additional rights” | Questa è una variante che esiste per motivi storici che indica che i sorgenti di un modulo sono rilasciati sotto una variante della licenza GPL v2 e quella MIT. Per favore non utilizzatela per codice nuovo. |
> > | “Dual MIT/GPL” | Questo è il modo corretto per esprimere il il fatto che il modulo è rilasciato con doppia licenza a scelta fra: una variante della GPL v2 o la licenza MIT. |
> > | “Dual BSD/GPL” | Questo modulo è rilasciato con doppia licenza a scelta fra: una variante della GPL v2 o la licenza BSD. La variante esatta della licenza BSD può essere determinata solo attraverso i corrispondenti file sorgenti. |
> > | “Dual MPL/GPL” | Questo modulo è rilasciato con doppia licenza a scelta fra: una variante della GPL v2 o la Mozilla Public License (MPL). La variante esatta della licenza MPL può essere determinata solo attraverso i corrispondenti file sorgenti. |
