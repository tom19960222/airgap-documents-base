...
collection: kernel
version: "6.17"
title: "Lista delle verifiche da fare prima di inviare una patch per il kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/submit-checklist.html
...
Original:
:   [Documentation/process/submit-checklist.rst](../../../process/submit-checklist.md#submitchecklist)
...
2. Controllate lo stile del codice della vostra patch secondo le direttive
   scritte in [Documentation/translations/it_IT/process/coding-style.rst](coding-style.md#it-codingstyle).
...
1. Includete [kernel-doc](../../../doc-guide/kernel-doc.md#kernel-doc) per documentare API globali del
   kernel.
...
5. Tutte le nuove interfacce verso lo spazio utente sono documentate in
   :   `Documentation/ABI/`. Leggete [Linux ABI description](../../../admin-guide/abi.md)
       ...
       in copia anche a [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).
...
> 1. con le opzioni `CONFIG` negli stati `=y`, `=m` e `=n`. Nessun
>    avviso/errore di `gcc` e nessun avviso/errore dal linker.
> 2. con `allnoconfig`, `allmodconfig`
> 3. quando si usa `O=builddir`
> 4. Qualsiasi modifica in Documentation/ deve compilare con successo senza
