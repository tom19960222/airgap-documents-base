...
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/1.Intro.html
fetched_at: 2026-09-16T16:30:55+00:00
---
Italian

- [English](../../../process/1.Intro.md)
- [Chinese (Simplified)](../../zh_CN/process/1.Intro.md)
- [Chinese (Traditional)](../../zh_TW/process/1.Intro.md)
- [Spanish](../../sp_SP/process/1.Intro.md)
...
Original:
:   [Documentation/process/1.Intro.rst](../../../process/1.Intro.md#development-process-intro)
...
La sezione [Come funziona il processo di sviluppo](2.Process.md#it-development-process) introduce il processo di sviluppo,
...
La sezione [I primi passi della pianificazione](3.Early-stage.md#it-development-early-stage) copre i primi stadi della
pianificazione di un progetto di sviluppo, con particolare enfasi sul
coinvolgimento della comunità, il prima possibile.

La sezione [Scrivere codice corretto](4.Coding.md#it-development-coding) riguarda il processo di scrittura
...
La sezione [Pubblicare modifiche](5.Posting.md#it-development-posting) parla del processo di pubblicazione
...
La sezione [Completamento](6.Followthrough.md#it-development-followthrough) copre ciò che accade dopo
...
La sezione [Argomenti avanzati](7.AdvancedTopics.md#it-development-advancedtopics) introduce un paio di argomenti
“avanzati”: gestire le modifiche con git e controllare le modifiche pubblicate
da altri.

La sezione [Per maggiori informazioni](8.Conclusion.md#it-development-conclusion) chiude il documento con dei
...
Questo documento è stato scritto da Jonathan Corbet, [corbet@lwn.net](mailto:corbet%40lwn.net).
