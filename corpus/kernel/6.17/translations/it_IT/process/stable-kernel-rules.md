...
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/stable-kernel-rules.html
...
L’[Opzione 1](stable-kernel-rules.md#it-option-1) è **fortemente** raccomandata; è il modo più facile e
usato. L’[Opzione 2](stable-kernel-rules.md#it-option-2) si usa quando al momento della sottomissione non si
era pensato di riportare la modifica su versioni precedenti.
L’[Opzione 3](stable-kernel-rules.md#it-option-3) è un’alternativa ai due metodi precedenti quando la patch
...
- Ritardare l’inclusione di patch::
  :   Cc: <[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)> # after -rc3
...
patch a [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) facendo anche menzione delle versioni nella quale
