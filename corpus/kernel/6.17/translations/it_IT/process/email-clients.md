...
collection: kernel
version: "6.17"
title: "Informazioni sui programmi di posta elettronica per Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/email-clients.html
fetched_at: 2026-09-16T16:31:23+00:00
---
Italian

- [English](../../../process/email-clients.md)
- [Chinese (Simplified)](../../zh_CN/process/email-clients.md)
- [Chinese (Traditional)](../../zh_TW/process/email-clients.md)
- [Spanish](../../sp_SP/process/email-clients.md)
...
Original:
:   [Email clients info for Linux](../../../process/email-clients.md)
...
Per inserire una patch usate Messaggio‣Inserisci file
...
disabilitata Configurazione‣Preferenze‣Composizione‣Interruzione riga.
...
:   da Formato‣Stile del paragrafo‣Preformattato
    (CTRL-7) o dalla barra degli strumenti

Poi per inserire la patch usate:
Inserisci‣ File di testo... (ALT-N x)

Potete anche eseguire `diff -Nru old.c new.c | xclip`, selezionare
Preformattato, e poi usare il tasto centrale del mouse.
...
Ora, dal menu Messaggio, selezionate Inserisci file di testo...
quindi scegliete la vostra patch.
Come soluzione aggiuntiva potreste personalizzare la vostra barra degli
strumenti aggiungendo un’icona per Inserisci file di testo....
...
selezionate Proprietà, e poi attivate
Suggerisci visualizzazione automatica per far si che
...
Salva come. Se il messaggio fu ben preparato, allora potrete
...
editor hanno un’opzione Inserisci file che inserisce il
...
- permettere l’uso di editor esterni:
  ...
  - “External Editor”
    ...
    Scrivi e a seguire aggiungete un bottone per eseguirlo
    ...
    configurazione di external editor. Se usate altri editor
...
- Modificate le impostazioni di Thunderbird per far si che non usi `format=flowed`!
  ...
  Poi Modifica‣Preferenze‣Avanzate‣Editor di configurazione
...
- Non scrivete messaggi HTML! Andate sulla finestra principale ed aprite la
  schermata Menu principale‣Impostazioni account‣nome@unserver.ovunque‣Composizioni e indirizzi.
...
- Aprite i messaggi solo in formato testo! Andate sulla finestra principale e
  selezionate
  Menu principale‣Visualizza‣Copro del messaggio come‣Testo semplice
