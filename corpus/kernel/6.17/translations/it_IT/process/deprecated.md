...
collection: kernel
version: "6.17"
title: "Interfacce deprecate, caratteristiche del linguaggio, attributi, e convenzioni"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/deprecated.html
fetched_at: 2026-09-16T16:35:27+00:00
---
Italian

- [English](../../../process/deprecated.md)
- [Spanish](../../sp_SP/process/deprecated.md)
...
[non produce più alcun avviso durante la compilazione](https://git.kernel.org/linus/771c035372a036f83353eef46dbb829780330234)
...
[email 1](https://lore.kernel.org/lkml/CA+55aFy6jNLsywVYdGp83AMrXBo_P-pkjkphPGrO=82SPKCpLQ@mail.gmail.com/),
[email 2](https://lore.kernel.org/lkml/CAHk-=whDHsbK3HTOpTF=ue_o04onRwTEaK_ZoJp_fjbqq4+=Jw@mail.gmail.com/)
...
indesiderato, usare le funzioni della famiglia [`pr_warn()`](../../../core-api/printk-basics.md#c.pr_warn "pr_warn"). Chi
...
date un’occhiata al questo [commit](https://git.kernel.org/linus/d4689846881d160a4d12a514e991a740bcb5d65a))
...
Nello specifico, [`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc") può essere sostituta da [`kmalloc_array()`](../../../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"), e [`kzalloc()`](../../../core-api/mm-api.md#c.kzalloc "kzalloc")
da [`kcalloc()`](../../../core-api/mm-api.md#c.kcalloc "kcalloc").
...
> **Note:**
>
> Se per caso state usando [`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size") su una struttura dati che
> in coda contiene un array di lunghezza zero o uno, allora siete
> invitati a riorganizzare il vostro codice usando il
> [flexible array member](deprecated.md#zero-length-and-one-element-arrays).

Per altri calcoli, usate le funzioni [`size_mul()`](../../../core-api/kernel-api.md#c.size_mul "size_mul"), [`size_add()`](../../../core-api/kernel-api.md#c.size_add "size_add"), e [`size_sub()`](../../../core-api/kernel-api.md#c.size_sub "size_sub"). Per
esempio, al posto di:
...
Per maggiori dettagli fate riferimento a [`array3_size()`](../../../core-api/kernel-api.md#c.array3_size "array3_size") e [`flex_array_size()`](../../../core-api/kernel-api.md#c.flex_array_size "flex_array_size"), ma
anche le funzioni della famiglia [`check_mul_overflow()`](../../../core-api/kernel-api.md#c.check_mul_overflow "check_mul_overflow"), [`check_add_overflow()`](../../../core-api/kernel-api.md#c.check_add_overflow "check_add_overflow"),
[`check_sub_overflow()`](../../../core-api/kernel-api.md#c.check_sub_overflow "check_sub_overflow"), e [`check_shl_overflow()`](../../../core-api/kernel-api.md#c.check_shl_overflow "check_shl_overflow").

## simple_strtol(), simple_strtoll(), simple_strtoul(), simple_strtoull()

Le funzioni [`simple_strtol()`](../../../core-api/kernel-api.md#c.simple_strtol "simple_strtol"), [`simple_strtoll()`](../../../core-api/kernel-api.md#c.simple_strtoll "simple_strtoll"),
[`simple_strtoul()`](../../../core-api/kernel-api.md#c.simple_strtoul "simple_strtoul"), e [`simple_strtoull()`](../../../core-api/kernel-api.md#c.simple_strtoull "simple_strtoull") ignorano volutamente
i possibili overflow, e questo può portare il chiamante a generare risultati
inaspettati. Le rispettive funzioni [`kstrtol()`](../../../core-api/kernel-api.md#c.kstrtol "kstrtol"), [`kstrtoll()`](../../../core-api/kernel-api.md#c.kstrtoll "kstrtoll"),
[`kstrtoul()`](../../../core-api/kernel-api.md#c.kstrtoul "kstrtoul"), e [`kstrtoull()`](../../../core-api/kernel-api.md#c.kstrtoull "kstrtoull") sono da considerarsi le corrette
...
La funzione [`strcpy()`](../../../core-api/kernel-api.md#c.strcpy "strcpy") non fa controlli agli estremi del buffer
...
questa funzione. La versione sicura da usare è [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), tuttavia va
prestata attenzione a tutti quei casi dove viene usato il valore di
ritorno di [`strcpy()`](../../../core-api/kernel-api.md#c.strcpy "strcpy"). La funzione [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy") non ritorna un puntatore
...
L’utilizzo di [`strncpy()`](../../../core-api/kernel-api.md#c.strncpy "strncpy") non fornisce alcuna garanzia sul fatto che
...
[`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), tuttavia va prestata attenzione a tutti quei casi dove
viene usato il valore di ritorno di [`strncpy()`](../../../core-api/kernel-api.md#c.strncpy "strncpy"). La funzione [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy")
...
terminazione con NUL dovrebbero usare [`strscpy_pad()`](../../../core-api/kernel-api.md#c.strscpy_pad "strscpy_pad").

Se il chiamate no usa stringhe terminate con NUL, allore [`strncpy()`](../../../core-api/kernel-api.md#c.strncpy "strncpy")
può continuare ad essere usata, ma i buffer di destinazione devono essere
marchiati con l’attributo [__nonstring](https://gcc.gnu.org/onlinedocs/gcc/Common-Variable-Attributes.html)
...
terminata con NUL. La versione sicura da usare è [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), tuttavia
va prestata attenzione a tutti quei casi dove viene usato il valore di
ritorno di `strlcpy()`, dato che [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy") ritorna un valore di errno
...
Parafrasando la [guida](https://lore.kernel.org/lkml/CA+55aFwQEd_d40g4mUCSsVRZzrFPUJt74vc6PPpb675hYNXcKw@mail.gmail.com/)
di Linus:
...
aggiungete l’opzione di debug “[no_hash_pointers](https://git.kernel.org/linus/5ead723a20e0447bc7db33dc3070b420e5f80aa6)” alla
riga di comando del kernel.

## Vettori a dimensione variabile (VLA)

Usare VLA sullo stack produce codice molto peggiore rispetto a quando si usano
vettori a dimensione fissa. Questi [problemi di prestazioni](https://git.kernel.org/linus/02361bc77888),
...
“break”](https://cwe.mitre.org/data/definitions/484.html), oggigiorno non
...
__attribute__((fallthrough)) [Statement Attributes](https://gcc.gnu.org/onlinedocs/gcc/Statement-Attributes.html).
...
member”](https://en.wikipedia.org/wiki/Flexible_array_member). La
...
stata introdotta un’ [estensione a GNU C](https://gcc.gnu.org/onlinedocs/gcc/Zero-Length.html) che
...
alcuni tipi di bachi dovuti a [comportamenti inaspettati](https://git.kernel.org/linus/76497732932f15e7323dc805e8ea8dc11bb587cf).
...
`items`. Qui un paio di esempi reali del problema: [collegamento 1](https://git.kernel.org/linus/f2cd32a443da694ac4e28fbf4ac6f9d5cc63a539),
[collegamento 2](https://git.kernel.org/linus/ab91c2a89f86be2898cee208d492816ec238b2cf).
Invece, [i flexible array members hanno un tipo incompleto, e quindi
sizeof() non può essere applicato](https://gcc.gnu.org/onlinedocs/gcc/Zero-Length.html); dunque ogni
...
singolo oggetti dello stesso tipo](https://gcc.gnu.org/onlinedocs/gcc/Zero-Length.html), e quindi
...
[`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size"), altrimenti avremmo --inavvertitamente-- allocato
...
combinazione con [`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size") e [`flex_array_size()`](../../../core-api/kernel-api.md#c.flex_array_size "flex_array_size"):
