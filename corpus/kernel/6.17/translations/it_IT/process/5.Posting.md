...
collection: kernel
version: "6.17"
title: "5. Pubblicare modifiche"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/5.Posting.html
fetched_at: 2026-09-16T16:31:05+00:00
---
Italian

- [English](../../../process/5.Posting.md)
- [Chinese (Simplified)](../../zh_CN/process/5.Posting.md)
- [Chinese (Traditional)](../../zh_TW/process/5.Posting.md)
- [Spanish](../../sp_SP/process/5.Posting.md)
...
[translations/it_IT/process/submitting-patches.rst](submitting-patches.md#it-submittingpatches)
e [translations/it_IT/process/submit-checklist.rst](submit-checklist.md#it-submitchecklist).
...
‘[Configurare Git](../maintainer/configure-git.md)’
...
>   in [Documentation/translations/it_IT/process/submitting-patches.rst](submitting-patches.md#it-submittingpatches).
...
>
>   [Documentation/translations/it_IT/process/email-clients.rst](email-clients.md#it-email-clients)
...
>   [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) dovrebbe riceverne una copia. Aggiungete anche
>   l’etichetta “Cc: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org)” nella patch stessa; questo
