...
collection: kernel
version: "6.17"
title: "2. Come funziona il processo di sviluppo"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/2.Process.html
fetched_at: 2026-09-16T16:30:58+00:00
---
Italian

- [English](../../../process/2.Process.md)
- [Chinese (Simplified)](../../zh_CN/process/2.Process.md)
- [Chinese (Traditional)](../../zh_TW/process/2.Process.md)
- [Spanish](../../sp_SP/process/2.Process.md)
...
Original:
:   [Documentation/process/2.Process.rst](../../../process/2.Process.md#development-process)

Translator:
:   Alessia Mantegazza <[amantegazza@vaga.pv.it](mailto:amantegazza%40vaga.pv.it)>

# 2. Come funziona il processo di sviluppo
...
## 2.2. Il ciclo di vita di una patch
...
## 2.3. Come le modifiche finiscono nel Kernel
...
- Rispondete sotto alla porzione di righe citate, così da dare un contesto alle
  ...
  leggete [Documentation/translations/it_IT/process/submitting-patches.rst](submitting-patches.md#it-interleaved-replies).
...
## 2.8. Iniziare con lo sviluppo del Kernel
