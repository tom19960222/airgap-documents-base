...
collection: kernel
version: "6.17"
title: "Inviare patch: la guida essenziale per vedere il vostro codice nel kernel"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/submitting-patches.html
fetched_at: 2026-09-16T16:18:18+00:00
---
Italian

- [English](../../../process/submitting-patches.md)
- [Chinese (Simplified)](../../zh_CN/process/submitting-patches.md)
- [Chinese (Traditional)](../../zh_TW/process/submitting-patches.md)
- [Spanish](../../sp_SP/process/submitting-patches.md)
...
[Una guida al processo di sviluppo del Kernel](development-process.md). Leggete anche
[Lista delle verifiche da fare prima di inviare una patch per il kernel Linux](submit-checklist.md) per una lista di
punti da verificare prima di inviare del codice.
Per delle patch relative alle associazioni per Device Tree leggete
[Inviare patch: la guida essenziale per vedere il vostro codice nel kernel](submitting-patches.md).
...
[Documentation/translations/it_IT/process/maintainer-handbooks.rst](maintainer-handbooks.md#it-maintainer-handbooks-main)
...
`git`, come un “commit log”. Leggete [Il formato canonico delle patch](submitting-patches.md#it-the-canonical-patch-format).
...
divisa. Leggete [Separate le vostre modifiche](submitting-patches.md#it-split-changes).
...
dettagli sono disponibili in [Stile del codice per il kernel Linux](coding-style.md).
...
([akpm@linux-foundation.org](mailto:akpm%40linux-foundation.org)) sarà la vostra ultima possibilità.

La lista [linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org) dovrebbe essere usata per l’invio di tutte
...
vostra serie di patch. La lista di discussione [linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org)
...
Linux Torvalds. Il suo indirizzo e-mail è <[torvalds@linux-foundation.org](mailto:torvalds%40linux-foundation.org)>.
...
sfruttato, inviatela a [security@kernel.org](mailto:security%40kernel.org). Per bachi importanti, un breve
embargo potrebbe essere preso in considerazione per dare il tempo alle
distribuzioni di prendere la patch e renderla disponibile ai loro utenti;
in questo caso, ovviamente, la patch non dovrebbe essere inviata su alcuna
lista di discussione pubblica. Leggete anche
[Security bugs](../../../process/security-bugs.md).
...
[Tutto quello che volevate sapere sui rilasci -stable di Linux](stable-kernel-rules.md).
...
Leggete [Informazioni sui programmi di posta elettronica per Linux](email-clients.md)
...
[Il formato canonico delle patch](submitting-patches.md#it-the-canonical-patch-format)). Aggiungete a CC tutte le persone che
vi hanno fornito dei commenti per notificarle di eventuali nuove versioni.

Leggete [Informazioni sui programmi di posta elettronica per Linux](email-clients.md) per
...
> 1. Il contributo è stato creato interamente, o in parte, da me e che
>    ho il diritto di inviarlo in accordo con la licenza open-source
>    indicata nel file; oppure
> 2. Il contributo è basato su un lavoro precedente che, nei limiti
...
> 3. Il contributo mi è stato fornito direttamente da qualcuno che
>    ha certificato (a), (b) o (c) e non l’ho modificata.
> 4. Capisco e concordo col fatto che questo progetto e i suoi
...
> 1. Ho effettuato una revisione tecnica di questa patch per valutarne
>    l’adeguatezza ai fini dell’inclusione nel ramo principale del
>    kernel.
> 2. Tutti i problemi e le domande riguardanti la patch sono stati
>    comunicati al mittente. Sono soddisfatto dalle risposte
>    del mittente.
> 3. Nonostante ci potrebbero essere cose migliorabili in queste
...
> 4. Nonostante abbia revisionato la patch e creda che vada bene,
...
patch. Per maggiori dettagli leggete [Descrivete le vostre modifiche](submitting-patches.md#it-describe-changes)
...
in copia conoscenza [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) su tutte le patch per
suddetti kernel.
...
Kernel [Stile del codice per il kernel Linux](coding-style.md).
