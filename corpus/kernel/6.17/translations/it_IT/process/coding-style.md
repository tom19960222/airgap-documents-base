...
collection: kernel
version: "6.17"
title: "Stile del codice per il kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/coding-style.html
fetched_at: 2026-09-16T16:31:22+00:00
---
Italian
...
Original:
:   [Documentation/process/coding-style.rst](../../../process/coding-style.md#codingstyle)
...
> 1. gli oggetti completamente opachi (dove `typedef viene` proprio usato allo
...
> 2. i tipi chiaramente interi, dove l’astrazione **aiuta** ad evitare
...
>    > è una buona scelta.
> 3. quando di rado create letteralmente dei **nuovi** tipi su cui effettuare
>    verifiche.
> 4. circostanze eccezionali, in cui si definiscono nuovi tipi identici a
...
Quando scrivete i prototipi di funzione mantenete [l’ordine degli elementi](https://lore.kernel.org/mm-commits/CAHk-=wiOCLRny5aifWNhr621kYrJwhfURsa0vFPeUEm8mF0ufg@mail.gmail.com/).
...
:ref:[Documentation/translations/it_IT/doc-guide/](../doc-guide/index.md#it-doc-guide) e in
`script/kernel-doc`.
...
[Documentation/translations/it_IT/dev-tools/clang-format.rst](../dev-tools/clang-format.md#it-clangformat).
...
il documento [Kconfig Language](../../../kbuild/kconfig-language.md)
...
alcun dispositivo, <linux/printk.h> definisce [`pr_info()`](../../../core-api/printk-basics.md#c.pr_info "pr_info"), [`pr_warn()`](../../../core-api/printk-basics.md#c.pr_warn "pr_warn"), [`pr_err()`](../../../core-api/printk-basics.md#c.pr_err "pr_err"),
...
altri. Le funzioni `pr_XXX()` stampano incondizionatamente ma [`pr_debug()`](../../../core-api/printk-basics.md#c.pr_debug "pr_debug") no;
...
[`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc"), [`kzalloc()`](../../../core-api/mm-api.md#c.kzalloc "kzalloc"), [`kmalloc_array()`](../../../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"), [`kcalloc()`](../../../core-api/mm-api.md#c.kcalloc "kcalloc"), [`vmalloc()`](../../../core-api/mm-api.md#c.vmalloc "vmalloc"), e [`vzalloc()`](../../../core-api/mm-api.md#c.vzalloc "vzalloc").
Per maggiori informazioni, consultate la documentazione dell’API:
[Documentation/translations/it_IT/core-api/memory-allocation.rst](../core-api/memory-allocation.md#it-memory-allocation)
...
`PCI device present` è un predicato, e la funzione [`pci_dev_present()`](../../../driver-api/pci/pci.md#c.pci_dev_present "pci_dev_present") ritorna
...
Kernel CodingStyle, by [greg@kroah.com](mailto:greg%40kroah.com) at OLS 2002:
