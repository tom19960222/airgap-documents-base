...
collection: kernel
version: "6.17"
title: "Requisiti minimi per compilare il kernel"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/process/changes.html
fetched_at: 2026-09-16T16:31:45+00:00
---
Italian

- [English](../../../process/changes.md)
...
| Sphinx[[1]](changes.md#f1) | 2.4.4 | sphinx-build --version |
...
Sphinx è necessario solo per produrre la documentazione del Kernel
...
L’ultima versione di clang e *LLVM utils* (secondo [releases.llvm.org](https://releases.llvm.org)) sono supportati per la generazione del
...
Verificate le istruzioni [Quick Start](../../../rust/quick-start.md) su come soddisfare i
...
Per i dettaglio sui requisiti di Sphinx, fate riferimento a [Installazione Sphinx](../doc-guide/sphinx.md#it-sphinx-install)
in [Documentation/translations/it_IT/doc-guide/sphinx.rst](../doc-guide/sphinx.md#it-sphinxdoc)
...
- [Getting LLVM](../../../kbuild/llvm.md#getting-llvm).
