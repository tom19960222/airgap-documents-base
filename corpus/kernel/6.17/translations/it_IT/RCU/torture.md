...
collection: kernel
version: "6.17"
title: "Le operazioni RCU per le verifiche torture"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/RCU/torture.html
fetched_at: 2026-09-16T16:51:45+00:00
---
Italian

- [English](../../../RCU/torture.md)
...
verifiche. La verifica userà [`printk()`](../../../core-api/printk-basics.md#c.printk "printk") per riportare lo stato, dunque potrete
...
usare altri comandi per visualizzare i messaggi di [`printk()`](../../../core-api/printk-basics.md#c.printk "printk"). La funzione
[`printk()`](../../../core-api/printk-basics.md#c.printk "printk") usa KERN_ALERT, dunque i messaggi dovrebbero essere ben visibili. ;-)
...
- “rtmbe”: Un valore diverso da zero indica che rcutorture crede che
  [`rcu_assign_pointer()`](../../../core-api/kernel-api.md#c.rcu_assign_pointer "rcu_assign_pointer") e [`rcu_dereference()`](../../../core-api/kernel-api.md#c.rcu_dereference "rcu_dereference") non funzionino correttamente. Il
  valore dovrebbe essere zero.
- “rtbe”: un valore diverso da zero indica che le funzioni della famiglia
  [`rcu_barrier()`](../../../core-api/kernel-api.md#c.rcu_barrier "rcu_barrier") non funzionano correttamente.
