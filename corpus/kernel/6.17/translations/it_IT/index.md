...
collection: kernel
version: "6.17"
title: "La documentazione del kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/it_IT/index.html
fetched_at: 2026-09-16T16:17:53+00:00
---
Italian
...
ufficiale è quella in lingua inglese: [The Linux Kernel documentation](../../index.md#linux-doc)

La propagazione simultanea a tutte le traduzioni di una modifica in
[The Linux Kernel documentation](../../index.md#linux-doc) è altamente improbabile. I manutentori delle traduzioni -
...
- [Una guida al processo di sviluppo del Kernel](process/development-process.md)
- [Inviare patch: la guida essenziale per vedere il vostro codice nel kernel](process/submitting-patches.md)
- [Code of conduct](process/code-of-conduct.md)
- [All development-process docs](process/index.md)
...
- [Documentazione dell’API di base](core-api/index.md)
- [Sincronizzazione nel kernel](locking/index.md)
- [Documentazione dei sottosistemi del kernel](subsystem-apis.md)
...
- [Regole sulle licenze](process/license-rules.md)
- [Scrivere la documentazione](doc-guide/index.md)
- [Strumenti di sviluppo](dev-tools/index.md)
- [La guida all'\*hacking\*](kernel-hacking/index.md)
