...
collection: kernel
version: "6.17"
title: "CFS con control de ancho de banda"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/scheduler/sched-bwc.html
fetched_at: 2026-09-16T16:26:07+00:00
---
Spanish

- [English](../../../scheduler/sched-bwc.md)
- [Chinese (Simplified)](../../zh_CN/scheduler/sched-bwc.md)
...
Original:
:   [Documentation/scheduler/sched-design-CFS.rst](../../../scheduler/sched-design-CFS.md#sched-design-cfs)
...
> para SCHED_NORMAL. El caso de SCHED_RT se trata en [Real-Time group scheduling](../../../scheduler/sched-rt-group.md)
...
> v1. Para cgroup v2, ver [Documentation/admin-guide/cgroup-v2.rst](../../../admin-guide/cgroup-v2.md#cgroup-v2-cpu).
...
> 1. este consume totalmente su propia cuota en un periodo.
> 2. la cuota del padre es consumida totalmente en su periodo.
...
[Gestor de tareas CFS](sched-design-CFS.md)) el que decida qué aplicación es la elegida para
