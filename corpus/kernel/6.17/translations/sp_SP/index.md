...
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/index.html
fetched_at: 2026-09-16T16:17:55+00:00
---
Spanish

- [English](../../index.md)
- [Chinese (Simplified)](../zh_CN/index.md)
...
maintainer:
:   Carlos Bilbao <[carlos.bilbao@kernel.org](mailto:carlos.bilbao%40kernel.org)>
...
está en inglés: [The Linux Kernel documentation](../../index.md#linux-doc)

La propagación simultánea de la traducción de una modificación en
[The Linux Kernel documentation](../../index.md#linux-doc) es altamente improbable. Los maintainers y colaboradores
...
- [Guía del proceso de desarrollo del kernel](process/development-process.md)
- [Envío de parches: la guía esencial para incluir su código en el kernel](process/submitting-patches.md)
- [Índice de documentación adicional del kernel](process/kernel-docs.md)
- [Estilo en el código del kernel Linux](process/coding-style.md)
- [Código de Conducta para Contribuyentes](process/code-of-conduct.md)
- [Aplicación de la licencia en el kernel Linux](process/kernel-enforcement-statement.md)
- [Información de clientes de correo electrónico para Linux](process/email-clients.md)
- [Números mágicos de Linux](process/magic-number.md)
- [Lenguaje de programación](process/programming-language.md)
- [Interfaces obsoletos, Características del lenguaje, Atributos y Convenciones](process/deprecated.md)
- [Agregando una Nueva Llamada del Sistema](process/adding-syscalls.md)
- [Directrices para Investigadores](process/researcher-guidelines.md)
- [Modelo de Madurez de Contribución al Kernel de Linux](process/contribution-maturity-model.md)
- [Errores de seguridad](process/security-bugs.md)
- [Problemas de hardware embargados](process/embargoed-hardware-issues.md)
- [Gestión de regresiones](process/handling-regressions.md)
- [Estilo de gestión del kernel de Linux](process/management-style.md)
- [Lista de comprobación para enviar parches del kernel de Linux](process/submit-checklist.md)
- [Cómo participar en el desarrollo del kernel de Linux](process/howto.md)
- [KVM x86](process/maintainer-kvm-x86.md)
- [Barreras de Memoria del kernel Linux](wrappers/memory-barriers.md)
- [Gestor de tareas CFS](scheduler/sched-design-CFS.md)
- [Gestor de tareas EEVDF](scheduler/sched-eevdf.md)
- [CFS con control de ancho de banda](scheduler/sched-bwc.md)
