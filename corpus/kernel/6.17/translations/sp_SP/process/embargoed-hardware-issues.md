...
collection: kernel
version: "6.17"
title: "Problemas de hardware embargados"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/embargoed-hardware-issues.html
fetched_at: 2026-09-16T16:26:02+00:00
---
Spanish

- [English](../../../process/embargoed-hardware-issues.md)
- [Chinese (Simplified)](../../zh_CN/process/embargoed-hardware-issues.md)
- [Chinese (Traditional)](../../zh_TW/process/embargoed-hardware-issues.md)
...
Original:
:   [Embargoed hardware issues](../../../process/embargoed-hardware-issues.md)
...
del kernel de Linux ([errores de seguridad](security-bugs.md)) en su
lugar.

El equipo puede contactar por correo electrónico en
<[hardware-security@kernel.org](mailto:hardware-security%40kernel.org)>. Esta es una lista privada de oficiales de
...
Para el contacto inicial, consulte [Contacto](embargoed-hardware-issues.md#contacto). Para las listas de
