...
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/1.Intro.html
...
- [Italian](../../it_IT/process/1.Intro.md)
...
[Cómo funciona el proceso de desarrollo](2.Process.md#sp-development-process) introduce el proceso de desarrollo, el ciclo
...
[Planificación en etapa inicial](3.Early-stage.md#sp-development-early-stage) cubre la planificación de proyectos en
etapas tempranas, con énfasis en involucrar a la comunidad de desarrollo
lo antes posible.

[Conseguir el código correcto](4.Coding.md#sp-development-coding) trata sobre el proceso de codificación. Se
...
[Publicación de parches](5.Posting.md#sp-development-posting) trata sobre el proceso de enviar parches para
...
[Seguimiento](6.Followthrough.md#sp-development-followthrough) cubre lo que sucede después de publicar
...
[Temas avanzados](7.AdvancedTopics.md#sp-development-advancedtopics) introduce un par de temas “avanzados”:
la administración de parches con git y la revisión de parches publicados
por otros.

[Para más información](8.Conclusion.md#sp-development-conclusion) concluye el documento con punteros a las
...
Este documento fue escrito por Jonathan Corbet, [corbet@lwn.net](mailto:corbet%40lwn.net). Ha sido
