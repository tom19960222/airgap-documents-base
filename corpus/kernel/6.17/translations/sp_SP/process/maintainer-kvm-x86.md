...
version: "6.17"
title: "KVM x86"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/maintainer-kvm-x86.html
fetched_at: 2026-09-16T16:26:05+00:00
---
Spanish

- [English](../../../process/maintainer-kvm-x86.md)
...
Translator:
:   Juan Embid <[jembid@ucm.es](mailto:jembid%40ucm.es)>
...
[Coding style notes](../../../process/maintainer-tip.md#maintainer-tip-coding-style), ya que los parches/series a menudo
...
Consulte [The canonical patch format](../../../process/submitting-patches.md#the-canonical-patch-format) para obtener más información,
...
Consulte [Describe your changes](../../../process/submitting-patches.md#describe-changes) para obtener más información, con una
...
explícitamente el parche con “Cc: [stable@vger.kernel](mailto:stable%40vger.kernel)” (aunque no es
...
Por favor, siga el protocolo para [Security bugs](../../../process/security-bugs.md#securitybugs) si sospecha que un
