...
collection: kernel
version: "6.17"
title: "Errores de seguridad"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/security-bugs.html
fetched_at: 2026-09-16T16:26:02+00:00
---
Spanish

- [English](../../../process/security-bugs.md)
- [Chinese (Simplified)](../../zh_CN/process/security-bugs.md)
- [Italian](../../it_IT/process/security-bugs.md)
...
electrónico en <[security@kernel.org](mailto:security%40kernel.org)>. Esta es una lista privada de
...
procedimiento descrito en ‘[Reporting issues](../../../admin-guide/reporting-issues.md)’
...
[envío de parche regular](submitting-patches.md) (incluso si no tiene
