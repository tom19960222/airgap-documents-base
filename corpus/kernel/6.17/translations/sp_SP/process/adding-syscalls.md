...
collection: kernel
version: "6.17"
title: "Agregando una Nueva Llamada del Sistema"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/adding-syscalls.html
fetched_at: 2026-09-16T16:26:00+00:00
---
Spanish

- [English](../../../process/adding-syscalls.md)
- [Italian](../../it_IT/process/adding-syscalls.md)
...
Original:
:   [Documentation/process/adding-syscalls.rst](../../../process/adding-syscalls.md#addsyscalls)

Translator:
:   Mauricio Fuentes <[mauriciofb@gmail.com](mailto:mauriciofb%40gmail.com)>
...
[Documentation/process/submitting-patches.rst](../../../process/submitting-patches.md#submittingpatches) que
...
>   >   *read(2)*/*write(2)* tienen que ser implementadas
>   >   como solicitudes *ioctl(2)*, las cuales pueden llevar a un
>   >   API algo opaca.
...
>   específico, entonces la opción de comando adicional *fcntl(2)*
>   podría ser más apropiada. Sin embargo, *fcntl(2)* es una
...
>   la funcionalidad existente *fcntl(2)*, o la nueva funcionalidad
...
>   un comando adicional *prctl(2)* podría ser más apropiado. Tal
>   como con *fcntl(2)*, esta llamada al sistema es un multiplexor
...
Revise *perf_event_open(2)* y la función `perf_copy_attr()` (en
...
*poll(2)* en ese descriptor de archivo. Hacer un descriptor de
...
revise el man page *openat(2)*; para un ejemplo de AT_EMPTY_PATH,
mire el man page *fstatat(2)* manpage.)
...
Si su nueva llamada de sistema *xyzzy* involucra una
...
describe en el man page *capabilities(7)*. Elija una parte de
...
kernel, debería siempre ser copiado a [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).
...
por ejemplo, los argumentos de *splice(2)*) del tipo
...
El man page debe ser cc’do a [linux-man@vger.kernel.org](mailto:linux-man%40vger.kernel.org)
...
> - Discusión de Michael Kerrisk de nuevas system call vs. extensiones *prctl(2)*:
...
>
>   > - [commit 75069f2b5bfb](https://git.kernel.org/torvalds/c/75069f2b5bfb) (“vfs: renumber FMODE_NONOTIFY and add to uniqueness
>   >   check”)
>   > - [commit 12ed2e36c98a](https://git.kernel.org/torvalds/c/12ed2e36c98a) (“fanotify: FMODE_NONOTIFY and __O_SYNC in sparc
>   >   conflict”)
>   > - [commit bb458c644a59](https://git.kernel.org/torvalds/c/bb458c644a59) (“Safer ABI for O_TMPFILE”)
