...
collection: kernel
version: "6.17"
title: "2. Cómo funciona el proceso de desarrollo"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/2.Process.html
...
- [Italian](../../it_IT/process/2.Process.md)
...
- Utilice respuestas intercaladas (“en línea”), lo que hace que su
  ...
  [Documentation/translations/sp_SP/process/submitting-patches.rst](submitting-patches.md#sp-interleaved-replies).
