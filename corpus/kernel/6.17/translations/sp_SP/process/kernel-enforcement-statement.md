...
collection: kernel
version: "6.17"
title: "Aplicación de la licencia en el kernel Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/kernel-enforcement-statement.html
fetched_at: 2026-09-16T16:25:57+00:00
---
Spanish

- [English](../../../process/kernel-enforcement-statement.md)
- [Chinese (Simplified)](../../zh_CN/process/kernel-enforcement-statement.md)
- [Chinese (Traditional)](../../zh_TW/process/kernel-enforcement-statement.md)
- [Italian](../../it_IT/process/kernel-enforcement-statement.md)
...
Original:
:   [Documentation/process/kernel-enforcement-statement.rst](../../../process/kernel-enforcement-statement.md#process-statement-kernel)
