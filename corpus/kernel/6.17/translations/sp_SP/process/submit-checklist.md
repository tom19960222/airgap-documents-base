...
collection: kernel
version: "6.17"
title: "Lista de comprobación para enviar parches del kernel de Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/submit-checklist.html
fetched_at: 2026-09-16T16:26:04+00:00
---
Spanish
...
[Documentation/translations/sp_SP/process/submitting-patches.rst](submitting-patches.md#sp-submittingpatches)
...
5. Verifique su parche para el estilo general según se detalla en
   [Documentation/translations/sp_SP/process/coding-style.rst](coding-style.md#sp-codingstyle).
...
11. Incluya [kernel-doc](../../../doc-guide/kernel-doc.md#kernel-doc) para documentar las API
    globales del kernel. (No es necesario para funciones estáticas, pero
    también está bien.) Utilice `make htmldocs` o `make pdfdocs`
    para comprobar el [kernel-doc](../../../doc-guide/kernel-doc.md#kernel-doc) y solucionar
    cualquier problema.
...
18. Todas las nuevas interfaces de espacio de usuario están documentadas
    en `Documentation/ABI/`. Consulte [Linux ABI description](../../../admin-guide/abi.md)
