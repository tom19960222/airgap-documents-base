...
collection: kernel
version: "6.17"
title: "Información de clientes de correo electrónico para Linux"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/email-clients.html
fetched_at: 2026-09-16T16:25:57+00:00
---
Spanish
...
- [Italian](../../it_IT/process/email-clients.md)
...
Original:
:   [Documentation/process/email-clients.rst](../../../process/email-clients.md#email-clients)
...
- menuselection:
  :   Do Not Send Flowed Text debe estar `enabled`
...
Para insertar un parche haga Message‣Insert File (CTRL-I)
o use un editor externo.

Si el parche insertado debe editarse en la ventana de composición de Claws
“Auto wrapping” en
Configuration‣Preferences‣Compose‣Wrapping debe
...
:   desde Format‣Paragraph Style‣Preformatted (CTRL-7)
...
Preformat, luego pege con el boton del medio.
...
Luego desde la opción de menu Message seleccione
insert file y busque su parche.
De forma adicional, puede personalizar el menú de la barra de herramientas
de creación de mensajes y poner el icono insert file.
...
adjunto y seleccione properties, y luego
Suggest automatic display para hacer que el archivo
...
clic con el botón derecho y seleccione save as. Puede usar
...
los editores tienen una opción insert file que inserta el
...
- Permitir el uso de un editor externo:
  ...
  - “External Editor”
    ...
    compose, agregue un botón para ello usando
    ...
    external editor. Si está utilizando algún otro editor,
...
- Edite sus ajustes de configuración de Thunderbird para que no utilice `format=flowed`!
  ...
  Main Menu‣Preferences‣General‣Config Editor...
...
- ¡No escriba mensajes HTML! Acuda a la ventana principal
  Main Menu‣Account Settings‣youracc@server.something‣Composition & Addressing!
...
- ¡Abra mensajes solo como texto sin formato! Acuda a la ventana principal
  Main Menu‣View‣Message Body As‣Plain Text!
