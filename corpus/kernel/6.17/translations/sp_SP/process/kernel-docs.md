...
collection: kernel
version: "6.17"
title: "Índice de documentación adicional del kernel"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/kernel-docs.html
fetched_at: 2026-09-16T16:25:55+00:00
---
Spanish

- [English](../../../process/kernel-docs.md)
- [Italian](../../it_IT/process/kernel-docs.md)
...
>
>   Palabras Clave:
>   :   archivos de texto, Sphinx.
>
>   Descripción:
>   :   Documentación que viene con las fuentes del kernel,
...
>
>   Palabras Clave:
>   :   glosario terminos, linux-kernel.
>
>   Descripción:
>   :   De la Introducción: “This glossary is intended as
...
>
>   Descripción:
>   :   Un muy buen libro GPL sobre el tema de la programación
...
>
>   Notas:
>   :   Libro fundacional. Más información en
...
>
>   Descripción:
>   :   Otro navegador de código fuente del kernel Linux que se
...
>
>   Palabras Clave:
>   :   latest kernel news, noticias del kernel Linux.
>
>   Descripción:
>   :   El título lo dice todo (Noticias Semanales de Linux).
...
>
>   Descripción:
>   :   Sitio dedicado al desarrollo de la gestión de memoria
...
>
>   Palabras Clave:
>   :   IRC, newbies, channel, asking doubts, canal, dudas,
>       novatos, preguntar.
>
>   Descripción:
>   :   #kernelnewbies en irc.oftc.net.
...
>
>   Palabras Clave:
>   :   linux-kernel, archives, buscar, search, archivos.
>
>   Descripción:
>   :   Algunos de los archivadores de listas de correo del
