...
collection: kernel
version: "6.17"
title: "Gestión de regresiones"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/handling-regressions.html
fetched_at: 2026-09-16T16:26:03+00:00
---
Spanish

- [English](../../../process/handling-regressions.md)
...
[Reporting regressions](../../../admin-guide/reporting-regressions.md), que cubre el tema
...
1. Asegúrese de que los suscriptores a la lista [regression mailing list](https://lore.kernel.org/regressions/) ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev))
   ...
   - Mande o redirija cualquier informe originado en los gestores de bugs
     a la lista.
2. Haga que el bot del kernel de Linux “regzbot” realice el seguimiento del
   ...
   >   ```
3. Cuando se manden correcciones para las regresiones, añadir etiquetas
   “Link:” a la descripción, apuntado a todos los sitios donde se informó
   del incidente, como se indica en el documento:
   [Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.md) y
   [Documentation/process/5.Posting.rst](../../../process/5.Posting.md#development-posting).
4. Intente arreglar las regresiones rápidamente una vez la causa haya sido
...
y los subscritos a la lista de correo [regression mailing list](https://lore.kernel.org/regressions/) ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) son
...
>   [Reporting issues](../../../admin-guide/reporting-issues.md).
...
[Documentation/process/5.Posting.rst](../../../process/5.Posting.md#development-posting), y
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.md)
...
Repase la documentación: [Reporting regressions](../../../admin-guide/reporting-regressions.md),
...
([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) y CC al seguidor de regresiones del kernel de
Linux ([regressions@leemhuis.info](mailto:regressions%40leemhuis.info)); Si el incidente pudiera ser mejor
...
Verifique el [interfaz web de regzbot](https://linux-regtracking.leemhuis.info/regzbot/)
para ver la última información; o [busque el último informe de regresiones](https://lore.kernel.org/lkml/?q=%22Linux+regressions+report%22+f%3Aregzbot),
...
regresiones del kernel de Linux en: [project page](https://gitlab.com/knurd42/regzbot),
y entre otros contiene una [guia de inicio](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/getting_started.md)
y [documentación de referencia](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/reference.md)
...
>   ```
> - De [2017-10-26 (2/2)](https://lore.kernel.org/lkml/CA+55aFxW7NMAMvYhkvz1UPbUTUJewRt6Yb51QAx5RtrWOwjebg@mail.gmail.com/):
>
>   ```
...
>   ```
> - De [2020-05-21](https://lore.kernel.org/all/CAHk-=wiVi7mSrsMP=fLXQrXK_UimybW=ziLOwSzFTtoXUacWVQ@mail.gmail.com/):
>
>   ```
...
>   antes funcionaba".
>   ```
> - De [2017-11-05](https://lore.kernel.org/all/CA+55aFzUvbGjD8nQ-+3oiMBx14c_6zOj2n7KLN3UsJ-qsd4Dcw@mail.gmail.com/):
>
>   ```
...
>   ```
> - De [2018-08-03](https://lore.kernel.org/all/CA+55aFwWZX=CXmWDTkDGb36kf12XmTehmQjbiMPCqCRG2hi9kw@mail.gmail.com/):
>
>   ```
...
>   tenemos un problema.
>   ```
> - De [2021-06-05](https://lore.kernel.org/all/CAHk-=wiUVqHN76YUwhkjZzwTdjMMJf_zN4+u7vEJjmEGh3recw@mail.gmail.com/):
>
>   ```
...
>   inutil.
>   ```
> - De [2011-05-06 (1/3)](https://lore.kernel.org/all/BANLkTim9YvResB+PwRp7QTK-a5VNg2PvmQ@mail.gmail.com/):
>
>   ```
...
>   ```
>
>   De [2011-05-06 (2/3)](https://lore.kernel.org/all/BANLkTi=KVXjKR82sqsz4gwjr+E0vtqCmvA@mail.gmail.com/):
>
>   ```
...
>   ```
>
>   De [2011-05-06 (3/3)](https://lore.kernel.org/all/BANLkTinazaXRdGovYL7rRVp+j6HbJ7pzhg@mail.gmail.com/):
>
>   ```
>   Tenemos programas que usan esa ABI y si eso se rompe eso es una
>   regresión.
>   ```
> - De [2012-07-06](https://lore.kernel.org/all/CA+55aFwnLJ+0sjx92EGREGTWOx84wwKaraSzpTNJwPVV8edw8g@mail.gmail.com/):
>
>   ```
...
>   ```
> - De [2019-09-15](https://lore.kernel.org/lkml/CAHk-=wiP4K8DRJWsCo=20hn_6054xBamGKF2kPgUzpB5aMaofA@mail.gmail.com/):
>
>   ```
