...
collection: kernel
version: "6.17"
title: "Interfaces obsoletos, Características del lenguaje, Atributos y Convenciones"
source_url: https://www.kernel.org/doc/html/v6.17/translations/sp_SP/process/deprecated.html
fetched_at: 2026-09-16T16:25:59+00:00
---
Spanish

- [English](../../../process/deprecated.md)
- [Italian](../../it_IT/process/deprecated.md)
...
Original:
:   [Documentation/process/deprecated.rst](../../../process/deprecated.md#deprecated)

Translator:
:   Sergio Gonzalez <[sergio.collado@gmail.com](mailto:sergio.collado%40gmail.com)>
...
declarado obsoleto, este [no produce más avisos durante las compilaciones](https://git.kernel.org/linus/771c035372a036f83353eef46dbb829780330234)
...
crash. Linus tiene una [opinión muy fuerte](https://lore.kernel.org/lkml/CA+55aFy6jNLsywVYdGp83AMrXBo_P-pkjkphPGrO=82SPKCpLQ@mail.gmail.com/)
y sentimientos [sobre esto](https://lore.kernel.org/lkml/CAHk-=whDHsbK3HTOpTF=ue_o04onRwTEaK_ZoJp_fjbqq4+=Jw@mail.gmail.com/).
...
de funciones [`pr_warn()`](../../../core-api/printk-basics.md#c.pr_warn "pr_warn"). Los responsables del sistema pueden haber definido
...
véase commits como [este](https://git.kernel.org/linus/d4689846881d160a4d12a514e991a740bcb5d65a).)
...
Específicamente, [`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc") puede ser sustituido con [`kmalloc_array()`](../../../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"),
[`kzalloc()`](../../../core-api/mm-api.md#c.kzalloc "kzalloc") puede ser sustituido con [`kcalloc()`](../../../core-api/mm-api.md#c.kcalloc "kcalloc").
...
> **Note:**
>
> Si se usa [`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size") en una estructura que contiene un elemento
> de longitud cero o un array de un único elemento como un array miembro,
> por favor reescribir ese uso y cambiar a un [miembro array flexible](deprecated.md#zero-length-and-one-element-arrays)

Para otros cálculos, por favor use las funciones de ayuda: [`size_mul()`](../../../core-api/kernel-api.md#c.size_mul "size_mul"),
[`size_add()`](../../../core-api/kernel-api.md#c.size_add "size_add"), and [`size_sub()`](../../../core-api/kernel-api.md#c.size_sub "size_sub"). Por ejemplo, en el caso de:
...
Para más detalles, mire también [`array3_size()`](../../../core-api/kernel-api.md#c.array3_size "array3_size") y [`flex_array_size()`](../../../core-api/kernel-api.md#c.flex_array_size "flex_array_size"),
como también la familia de funciones relacionadas [`check_mul_overflow()`](../../../core-api/kernel-api.md#c.check_mul_overflow "check_mul_overflow"),
[`check_add_overflow()`](../../../core-api/kernel-api.md#c.check_add_overflow "check_add_overflow"), [`check_sub_overflow()`](../../../core-api/kernel-api.md#c.check_sub_overflow "check_sub_overflow"), y [`check_shl_overflow()`](../../../core-api/kernel-api.md#c.check_shl_overflow "check_shl_overflow").

## simple_strtol(), simple_strtoll(), simple_strtoul(), simple_strtoull()

Las funciones: [`simple_strtol()`](../../../core-api/kernel-api.md#c.simple_strtol "simple_strtol"), [`simple_strtoll()`](../../../core-api/kernel-api.md#c.simple_strtoll "simple_strtoll"), [`simple_strtoul()`](../../../core-api/kernel-api.md#c.simple_strtoul "simple_strtoul"), y
[`simple_strtoull()`](../../../core-api/kernel-api.md#c.simple_strtoull "simple_strtoull") explícitamente ignoran los desbordamientos, lo que puede
llevar a resultados inesperados por las funciones que las llaman. Las
funciones respectivas [`kstrtol()`](../../../core-api/kernel-api.md#c.kstrtol "kstrtol"), [`kstrtoll()`](../../../core-api/kernel-api.md#c.kstrtoll "kstrtoll"), [`kstrtoul()`](../../../core-api/kernel-api.md#c.kstrtoul "kstrtoul"), y [`kstrtoull()`](../../../core-api/kernel-api.md#c.kstrtoull "kstrtoull")
...
[`strcpy()`](../../../core-api/kernel-api.md#c.strcpy "strcpy") no realiza verificaciones de los límites del buffer de destino.
...
es la función [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), aunque se ha de tener cuidado con cualquier caso
en el el valor retornado por [`strcpy()`](../../../core-api/kernel-api.md#c.strcpy "strcpy") sea usado, ya que [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy") no
...
El uso de [`strncpy()`](../../../core-api/kernel-api.md#c.strncpy "strncpy") no garantiza que el buffer de destino esté terminado en
...
el mejor reemplazo es usar la función [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), aunque se ha de tener
cuidado en los casos en los que el valor de [`strncpy()`](../../../core-api/kernel-api.md#c.strncpy "strncpy") fuera usado, ya que
[`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy") no devuelve un puntero al destino, sino el número de
...
ser terminado en el caracter nulo, debería usar [`strscpy_pad()`](../../../core-api/kernel-api.md#c.strscpy_pad "strscpy_pad").

Si una función usa cadenas de caracteres que no necesitan terminar en NUL,
debería usarse [`strtomem()`](../../../core-api/kernel-api.md#c.strtomem "strtomem"), y el destino debería señalarse con el atributo
[__nonstring](https://gcc.gnu.org/onlinedocs/gcc/Common-Variable-Attributes.html)
...
caracter NUL, usar [`strtomem_pad()`](../../../core-api/kernel-api.md#c.strtomem_pad "strtomem_pad").

## strlcpy()

`strlcpy()` primero lee por completo el buffer de origen (ya que el valor
devuelto intenta ser el mismo que el de [`strlen()`](../../../core-api/kernel-api.md#c.strlen "strlen")). Esta lectura puede
...
carácter NUL. El reemplazo seguro de esta función es [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy"), pero se ha
de tener cuidado que en los casos en lso que se usase el valor devuelto de
`strlcpy()`, ya que [`strscpy()`](../../../core-api/kernel-api.md#c.strscpy "strscpy") devolverá valores negativos de erno cuando se
produzcan truncados.
...
Parafraseando las actuales [direcciones de Linus](https://lore.kernel.org/lkml/CA+55aFwQEd_d40g4mUCSsVRZzrFPUJt74vc6PPpb675hYNXcKw@mail.gmail.com/):
...
se puede arrancar temporalmente con la opción de depuración “[no_hash_pointers](https://git.kernel.org/linus/5ead723a20e0447bc7db33dc3070b420e5f80aa6)”.

## Arrays de longitud variable (VLAs)

Usando VLA en la pila (stack) produce un código mucho peor que los arrays
de tamaño estático. Mientras que estos errores no triviales de [rendimiento](https://git.kernel.org/linus/02361bc77888) son razón suficiente
...
que faltan](https://cwe.mitre.org/data/definitions/484.html), no se
...
que expande las extensiones de gcc [__attribute__((__fallthrough__))](https://gcc.gnu.org/onlinedocs/gcc/Statement-Attributes.html).
...
El código del kernel debería usar siempre [“miembros array flexible”](https://en.wikipedia.org/wiki/Flexible_array_member)
...
para tener un tamaño correcto de la “cabecera”). Una [extensión de GNU C](https://gcc.gnu.org/onlinedocs/gcc/Zero-Length.html) se empezó a usar
...
[comportamiento indefinido](https://git.kernel.org/linus/76497732932f15e7323dc805e8ea8dc11bb587cf).
...
más sobre este tema: [link 1](https://git.kernel.org/linus/f2cd32a443da694ac4e28fbf4ac6f9d5cc63a539),
...
usa la función de ayuda [`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size"), de otro modo estaríamos
...
[`struct_size()`](../../../core-api/kernel-api.md#c.struct_size "struct_size") y [`flex_array_size()`](../../../core-api/kernel-api.md#c.flex_array_size "flex_array_size"):
