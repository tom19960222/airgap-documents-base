...
collection: kernel
version: "6.17"
title: "Linux カーネル開発のやり方"
source_url: https://www.kernel.org/doc/html/v6.17/translations/ja_JP/process/howto.html
...
をマニュアルページのメンテナ [alx@kernel.org](mailto:alx%40kernel.org) に送り、CC を
[linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org) に送ることを勧めます。
...
>     だけをレビューします。
>
> [Documentation/process/submitting-patches.rst](../../../process/coding-style.md#codingstyle)
...
安定版ツリーは”stable” チーム <[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)> でメンテされており、
必要に応じてリリースされます。通常のリリース期間は 2週間毎ですが、差
し迫った問題がなければもう少し長くなることもあります。セキュリティ関
連の問題の場合はこれに対してだいたいの場合、すぐにリリースがされます。

カーネルツリーに入っている、
[Everything you ever wanted to know about Linux -stable releases](../../../process/stable-kernel-rules.md) ファイルにはどのような種
...
もしパッチをメールに付ける場合は、
[Submitting patches: the essential guide to getting your code into the kernel](../../../process/submitting-patches.md) に提示されているように、そ
