...
version: "6.17"
title: "Translations"
source_url: https://www.kernel.org/doc/html/v6.17/translations/index.html
fetched_at: 2026-09-16T16:17:52+00:00
---
# Translations

- [中文翻译](zh_CN/index.md)
- [繁體中文翻譯](zh_TW/index.md)
- [La documentazione del kernel Linux](it_IT/index.md)
- [한국어 번역](ko_KR/index.md)
- [日本語訳](ja_JP/index.md)
- [Traducción al español](sp_SP/index.md)
...
*only* official documentation is the English one: [The Linux Kernel documentation](../index.md#linux-doc).

It is very unlikely that an update to [The Linux Kernel documentation](../index.md#linux-doc) will be propagated
