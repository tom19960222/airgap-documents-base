...
version: "6.17"
title: "1. LoongArch介紹"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/arch/loongarch/introduction.html
fetched_at: 2026-09-16T16:50:27+00:00
---
Chinese (Traditional)

- [English](../../../../arch/loongarch/introduction.md)
- [Chinese (Simplified)](../../../zh_CN/arch/loongarch/introduction.md)
...
Original:
:   [Introduction to LoongArch](../../../../arch/loongarch/introduction.md)
...
[參考文獻](introduction.md#loongarch-references-zh-tw):
...
[參考文獻](introduction.md#loongarch-references-zh-tw) 中的文檔。
...
| 區段名 | 地址範圍 | 屬性 |
| --- | --- | --- |
| `XUVRANGE` | `0x0000000000000000 - 0x3FFFFFFFFFFFFFFF` | 分頁映射, 可緩存, PLV0~3 |
| `XSPRANGE` | `0x4000000000000000 - 0x7FFFFFFFFFFFFFFF` | 直接映射, 可緩存 / 非緩存, PLV0 |
| `XKPRANGE` | `0x8000000000000000 - 0xBFFFFFFFFFFFFFFF` | 直接映射, 可緩存 / 非緩存, PLV0 |
| `XKVRANGE` | `0xC000000000000000 - 0xFFFFFFFFFFFFFFFF` | 分頁映射, 可緩存, PLV0 |
