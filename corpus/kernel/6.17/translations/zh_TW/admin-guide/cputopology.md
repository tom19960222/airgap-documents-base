...
collection: kernel
version: "6.17"
title: "如何通過sysfs將CPU拓撲導出"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/cputopology.html
fetched_at: 2026-09-16T16:47:24+00:00
---
Chinese (Traditional)

- [English](../../../admin-guide/cputopology.md)
- [Chinese (Simplified)](../../zh_CN/admin-guide/cputopology.md)
...
Original:
:   [How CPU topology info is exported via sysfs](../../../admin-guide/cputopology.md)
...
[ABI file stable/sysfs-devices-system-cpu](../../../admin-guide/abi-stable-files.md#abi-file-stable-sysfs-devices-system-cpu)。
...
`**_siblings` sysfs屬性對應（除了`topology_sibling_cpumask()`，它和thread_siblings
對應）。
...
> | offline: | 由於熱插拔移除或者超過內核允許的CPU上限（上文描述的kernel_max） 導致未上線的CPU。[~cpu_online_mask + cpus >= NR_CPUS] |
> | online: | 在線的CPU，可供調度使用。[cpu_online_mask] |
> | possible: | 已被分配資源的CPU，如果它們CPU實際存在，可以上線。 [cpu_possible_mask] |
