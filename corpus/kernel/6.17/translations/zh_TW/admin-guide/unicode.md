...
collection: kernel
version: "6.17"
title: "Unicode（統一碼）支持"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/unicode.html
fetched_at: 2026-09-16T16:49:27+00:00
---
Chinese (Traditional)

- [English](../../../admin-guide/unicode.md)
- [Chinese (Simplified)](../../zh_CN/admin-guide/unicode.md)
...
此文檔由H. Peter Anvin <[unicode@lanana.org](mailto:unicode%40lanana.org)>管理，是Linux註冊名稱與編號管理局
...
自從分配了克林貢Linux Unicode塊之後，John Cowan <[jcowan@reutershealth.com](mailto:jcowan%40reutershealth.com)>
和 Michael Everson <[everson@evertype.com](mailto:everson%40evertype.com)> 建立了一個虛構和人工字母的註冊表。
徵募Unicode註冊表請訪問：
