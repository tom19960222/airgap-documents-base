...
version: "6.17"
title: "基於DAMON的LRU排序"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/mm/damon/lru_sort.html
fetched_at: 2026-09-16T16:56:27+00:00
---
Chinese (Traditional)

- [English](../../../../../admin-guide/mm/damon/lru_sort.md)
- [Chinese (Simplified)](../../../../zh_CN/admin-guide/mm/damon/lru_sort.md)
...
DAMON對冷內存監測的採樣週期。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。默認5
毫秒。
...
DAMON對冷內存進行收集的時間週期。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。默認
100毫秒。
...
大會增加開銷。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。默認值爲10。
...
低會導致監測結果變差。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。默認值爲1000。
