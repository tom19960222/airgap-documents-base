...
version: "6.17"
title: "基於DAMON的回收"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/mm/damon/reclaim.html
fetched_at: 2026-09-16T16:56:27+00:00
---
Chinese (Traditional)

- [English](../../../../../admin-guide/mm/damon/reclaim.md)
- [Chinese (Simplified)](../../../../zh_CN/admin-guide/mm/damon/reclaim.md)
...
基於空閒頁報告 [[3]](reclaim.md#id10) 的內存過度承諾的虛擬化系統就是很好的例子。在這樣的系統中，客戶機
...
DAMON用於監測冷內存的採樣間隔。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。

### aggr_interval

監測的聚集間隔，單位是微秒。

DAMON對冷內存監測的聚集間隔。更多細節請參考DAMON文檔 ([詳細用法](usage.md))。
...
置的太高可能會導致監測開銷的增加。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。
...
設置得太低可能會導致監測質量不好。更多細節請參考DAMON文檔 ([詳細用法](usage.md)) 。
