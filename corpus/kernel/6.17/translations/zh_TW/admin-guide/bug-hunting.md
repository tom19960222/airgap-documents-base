...
version: "6.17"
title: "追蹤缺陷"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/bug-hunting.html
fetched_at: 2026-09-16T16:47:45+00:00
---
Chinese (Traditional)

- [English](../../../admin-guide/bug-hunting.md)
- [Chinese (Simplified)](../../zh_CN/admin-guide/bug-hunting.md)
...
[Tainted kernels](../../../admin-guide/tainted-kernels.md) 文件中進行了描述，“正在被加
載”用“+”標註，“正在被卸載”用“-”標註。
...
2. 從串口終端啓動（參見
   ...
   Minicom運行良好。
3. 使用Kdump（參閱 [Documentation for Kdump - The kexec-based Crash Dumping Solution](../../../admin-guide/kdump/kdump.md) ），使用
...
- 驅動程序和/或子系統郵件列表（[linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org)）；
- Linux內核郵件列表（[linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org)）。

通常，修復缺陷的最快方法是將它報告給用於開發相關代碼的郵件列表（linux-media
ML），抄送驅動程序維護者（Hans）。

如果你完全不知道該把報告寄給誰，且 `get_maintainer.pl` 也沒有提供任何有用
的信息，請發送到linux-[kernel@vger.kernel.org](mailto:kernel%40vger.kernel.org)。
