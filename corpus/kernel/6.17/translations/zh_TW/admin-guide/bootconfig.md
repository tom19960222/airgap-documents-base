...
version: "6.17"
title: "引導配置"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/admin-guide/bootconfig.html
fetched_at: 2026-09-16T16:47:42+00:00
---
Chinese (Traditional)

- [English](../../../admin-guide/bootconfig.md)
- [Chinese (Simplified)](../../zh_CN/admin-guide/bootconfig.md)
...
如果您有一個關鍵字字符串，則可以直接使用 [`xbc_find_value()`](../../../admin-guide/bootconfig.md#c.xbc_find_value "xbc_find_value") 查詢該鍵的值。如果
你想知道引導配置裏有哪些關鍵字，可以使用 [`xbc_for_each_key_value()`](../../../admin-guide/bootconfig.md#c.xbc_for_each_key_value "xbc_for_each_key_value") 迭代鍵值對。
請注意，您需要使用 [`xbc_array_for_each_value()`](../../../admin-guide/bootconfig.md#c.xbc_array_for_each_value "xbc_array_for_each_value") 訪問數組的值，例如:
...
如果您想查找具有前綴字符串的鍵，可以使用 [`xbc_find_node()`](../../../admin-guide/bootconfig.md#c.xbc_find_node "xbc_find_node") 通過前綴字符串查找
節點，然後用 [`xbc_node_for_each_key_value()`](../../../admin-guide/bootconfig.md#c.xbc_node_for_each_key_value "xbc_node_for_each_key_value") 迭代前綴節點下的鍵。
