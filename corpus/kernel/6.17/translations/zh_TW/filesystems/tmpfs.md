...
version: "6.17"
title: "Tmpfs"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/filesystems/tmpfs.html
fetched_at: 2026-09-16T16:53:13+00:00
---
Chinese (Traditional)

- [English](../../../filesystems/tmpfs.md)
- [Chinese (Simplified)](../../zh_CN/filesystems/tmpfs.md)
...
Original:
:   [Tmpfs](../../../filesystems/tmpfs.md)

translated by Wang Qing<[wangqing@vivo.com](mailto:wangqing%40vivo.com)>
...
|  |  |
| --- | --- |
| size | tmpfs實例分配的字節數限制。默認值是不swap時物理RAM的一半。 如果tmpfs實例過大，機器將死鎖，因爲OOM處理將無法釋放該內存。 |
| nr_blocks | 與size相同，但以PAGE_SIZE爲單位。 |
| nr_inodes | tmpfs實例的最大inode個數。默認值是物理內存頁數的一半，或者 (有高端內存的機器)低端內存RAM的頁數，二者以較低者爲準。 |
...
|  |  |
| --- | --- |
| mpol=default | 採用進程分配策略 (請參閱 set_mempolicy(2)) |
...
標誌可以在NodeList之前生效。
[NUMA Memory Policy](../../../admin-guide/mm/numa_memory_policy.md)列出所有可用的內存
分配策略模式標誌及其對內存策略。
