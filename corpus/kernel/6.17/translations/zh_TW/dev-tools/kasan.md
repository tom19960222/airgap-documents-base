...
version: "6.17"
title: "內核地址消毒劑(KASAN)"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/dev-tools/kasan.html
fetched_at: 2026-09-16T16:46:58+00:00
---
Chinese (Traditional)

- [English](../../../dev-tools/kasan.md)
- [Chinese (Simplified)](../../zh_CN/dev-tools/kasan.md)
...
Translator:
:   萬家兵 Wan Jiabing <[wanjiabing@vivo.com](mailto:wanjiabing%40vivo.com)>
...
出現在錯誤訪問堆棧跟蹤中的位置。目前，這包括 [`call_rcu()`](../../../core-api/kernel-api.md#c.call_rcu "call_rcu") 和排隊的工作隊列。
...
3. 使用kunit_tool
   ...
   [KUnit文檔](https://www.kernel.org/doc/html/latest/dev-tools/kunit/index.html) 。
