...
version: "6.17"
title: "8. 更多信息"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/process/8.Conclusion.html
...
Translator:
:   時奎亮 Alex Shi <[alex.shi@linux.alibaba.com](mailto:alex.shi%40linux.alibaba.com)>
...
文檔目錄。頂級
[Documentation/translations/zh_CN/process/howto.rst](howto.md#tw-process-howto)
文件是一個重要的起點；
[Documentation/translations/zh_CN/process/submitting-patches.rst](submitting-patches.md#tw-submittingpatches)
