...
version: "6.17"
title: "Linux內核管理風格"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/process/management-style.html
fetched_at: 2026-09-16T16:31:37+00:00
---
Chinese (Traditional)
...
它的目的是在某種程度上參照 [process/coding-style.rst](../../../process/coding-style.md#codingstyle)
主要是爲了避免反覆回答 [[1]](management-style.md#cnf1) 相同（或類似）的問題。
...
本文件並不是通過回答問題，而是通過讓提問者痛苦地明白，我們不知道
答案是什麼。
...
[1）決策](management-style.md#tw-decisions) 成爲絕不可以做的事情。
...
問題在於 #1 很容易去做，因爲你可以用數百萬種不同的方式說“你是一個笨蛋” [[2]](management-style.md#cnf2)
...
保羅·西蒙演唱了“離開愛人的50種方法”，因爲坦率地說，“告訴開發者
...
提示：與你的工作沒有直接關係的網絡新聞組是消除你對他人不滿的好
