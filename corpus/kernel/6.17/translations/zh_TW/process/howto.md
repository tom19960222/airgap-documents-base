...
version: "6.17"
title: "如何參與Linux內核開發"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/process/howto.html
...
[Documentation/translations/zh_TW/process/license-rules.rst](license-rules.md#tw-kernel-licensing)
...
:   [Documentation/admin-guide/README.rst](../../../admin-guide/README.md#readme)
    ...
    [Documentation/translations/zh_TW/process/coding-style.rst](coding-style.md#tw-codingstyle)
    :   描述Linux內核的代碼風格和理由。所有新代碼需要遵守這篇文檔中定義的規
        范。大多數維護者只會接收符合規定的補丁，很多人也只會幫忙檢查符合風格
        的代碼。

    [Documentation/translations/zh_TW/process/submitting-patches.rst](submitting-patches.md#tw-submittingpatches)
    ...
    [Documentation/translations/zh_TW/process/stable-api-nonsense.rst](stable-api-nonsense.md#tw-stable-api-nonsense)
    ...
    [Documentation/translations/zh_TW/process/management-style.rst](management-style.md#tw-managementstyle)
...
穩定版內核樹版本由「穩定版」小組（郵件地址<[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)>）維護，一般
隔周發布新版本。

內核源碼中的 [Documentation/process/stable-kernel-rules.rst](../../../process/stable-kernel-rules.md#stable-kernel-rules)
...
英文版維護者： Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
