...
version: "6.17"
title: "被限制的硬件問題"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/process/embargoed-hardware-issues.html
fetched_at: 2026-09-16T16:31:55+00:00
---
Chinese (Traditional)

- [English](../../../process/embargoed-hardware-issues.md)
- [Chinese (Simplified)](../../zh_CN/process/embargoed-hardware-issues.md)
- [Spanish](../../sp_SP/process/embargoed-hardware-issues.md)
...
Original:
:   [Documentation/process/embargoed-hardware-issues.rst](../../../process/embargoed-hardware-issues.md#embargoed-hardware-issues)
...
小組處理，報告者將被引導至常規Linux內核安全小組([Documentation/admin-guide/](../../../process/security-bugs.md#securitybugs))聯繫。

可以通過電子郵件 <[hardware-security@kernel.org](mailto:hardware-security%40kernel.org)> 與小組聯繫。這是一份私密的安全
...
> | Microsoft | Sasha Levin <[sashal@kernel.org](mailto:sashal%40kernel.org)> |
> | VMware |  |
...
初次接觸見 [接触](../../zh_CN/process/embargoed-hardware-issues.md#zh-contact). 對於特定於事件的郵件列表，密鑰和S/MIME證書通過
特定列表發送的電子郵件傳遞給訂閱者。
