...
version: "6.17"
title: "Linux 內核代碼風格"
source_url: https://www.kernel.org/doc/html/v6.17/translations/zh_TW/process/coding-style.html
fetched_at: 2026-09-16T16:31:27+00:00
---
Chinese (Traditional)
...
- [Spanish](../../sp_SP/process/coding-style.md)
...
Original:
:   [Linux kernel coding style](../../../process/coding-style.md)

譯者:
:   - 張樂 Zhang Le <[r0bertz@gentoo.org](mailto:r0bertz%40gentoo.org)>
    - Andy Deng <[theandy.deng@gmail.com](mailto:theandy.deng%40gmail.com)>
    - 吳想成 <[bobwxc@email.cn](mailto:bobwxc%40email.cn)>

校譯:
:   - 王聰 Wang Cong <[xiyou.wangcong@gmail.com](mailto:xiyou.wangcong%40gmail.com)>
    - wheelz <[kernel.zeng@gmail.com](mailto:kernel.zeng%40gmail.com)>
    - 管旭東 Xudong Guan <[xudong.guan@gmail.com](mailto:xudong.guan%40gmail.com)>
    - Li Zefan <[lizf@cn.fujitsu.com](mailto:lizf%40cn.fujitsu.com)>
    - Wang Chen <[wangchen@cn.fujitsu.com](mailto:wangchen%40cn.fujitsu.com)>
...
> 1. 完全不透明的對象 (這種情況下要主動使用 typedef 來 **隱藏** 這個對象實際上
>    是什麼)。
>
...
>    > 的是完全沒有任何共用的可訪問信息。
> 2. 清楚的整數類型，如此，這層抽象就可以 **幫助** 消除到底是 `int` 還是
>    `long` 的混淆。
>
...
寫函數原型時，請保持 [元素順序規則](https://lore.kernel.org/mm-commits/CAHk-=wiOCLRny5aifWNhr621kYrJwhfURsa0vFPeUEm8mF0ufg@mail.gmail.com/) 。
例如下列函數聲明:
...
[如何编写内核文档](../../zh_CN/doc-guide/index.md) 和 scripts/kernel-doc 。
...
詳見 [clang-format](../../../dev-tools/clang-format.md) 。
...
要查看配置文件的完整文檔，請看 [Kconfig Language](../../../kbuild/kconfig-language.md) 。
...
了 [`pr_notice()`](../../../core-api/printk-basics.md#c.pr_notice "pr_notice"), [`pr_info()`](../../../core-api/printk-basics.md#c.pr_info "pr_info"), [`pr_warn()`](../../../core-api/printk-basics.md#c.pr_warn "pr_warn"), [`pr_err()`](../../../core-api/printk-basics.md#c.pr_err "pr_err") 和其他。

寫出好的調試信息可以是一個很大的挑戰；一旦你寫出後，這些信息在遠程除錯時能提
供極大的幫助。然而打印調試信息的處理方式同打印非調試信息不同。其他 `pr_XXX()`
函數能無條件地打印，[`pr_debug()`](../../../core-api/printk-basics.md#c.pr_debug "pr_debug") 卻不；默認情況下它不會被編譯，除非定義了 DEBUG
...
內核提供了下面的一般用途的內存分配函數：
[`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc"), [`kzalloc()`](../../../core-api/mm-api.md#c.kzalloc "kzalloc"), [`kmalloc_array()`](../../../core-api/mm-api.md#c.kmalloc_array "kmalloc_array"), [`kcalloc()`](../../../core-api/mm-api.md#c.kcalloc "kcalloc"), [`vmalloc()`](../../../core-api/mm-api.md#c.vmalloc "vmalloc") 和 [`vzalloc()`](../../../core-api/mm-api.md#c.vzalloc "vzalloc")。
請參考 API 文檔以獲取有關它們的詳細信息：
[内存分配指南](../../zh_CN/core-api/memory-allocation.md) 。
...
[`kmalloc()`](../../../core-api/mm-api.md#c.kmalloc "kmalloc") 內聯函數就是一個很好的例子。
...
-EBUSY。類似的，因爲 `PCI device present` 是一個判斷，所以 [`pci_dev_present()`](../../../driver-api/pci/pci.md#c.pci_dev_present "pci_dev_present")
...
內核文檔 [Linux kernel coding style](../../../process/coding-style.md)，
作者 [greg@kroah.com](mailto:greg%40kroah.com) 發表於 OLS 2002：
