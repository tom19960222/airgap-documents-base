...
version: "6.17"
title: "Livepatch"
source_url: https://www.kernel.org/doc/html/v6.17/livepatch/livepatch.html
...
- [1. Motivation](livepatch.md#motivation)
- [2. Kprobes, Ftrace, Livepatching](livepatch.md#kprobes-ftrace-livepatching)
- [3. Consistency model](livepatch.md#consistency-model)

  - [3.1 Adding consistency model support to new architectures](livepatch.md#adding-consistency-model-support-to-new-architectures)
- [4. Livepatch module](livepatch.md#livepatch-module)

  - [4.1. New functions](livepatch.md#new-functions)
  - [4.2. Metadata](livepatch.md#metadata)
- [5. Livepatch life-cycle](livepatch.md#livepatch-life-cycle)

  - [5.1. Loading](livepatch.md#loading)
  - [5.2. Enabling](livepatch.md#enabling)
  - [5.3. Replacing](livepatch.md#replacing)
  - [5.4. Disabling](livepatch.md#disabling)
  - [5.5. Removing](livepatch.md#removing)
- [6. Sysfs](livepatch.md#sysfs)
- [7. Limitations](livepatch.md#limitations)

## [1. Motivation](livepatch.md#id3)
...
## [2. Kprobes, Ftrace, Livepatching](livepatch.md#id4)
...
## [3. Consistency model](livepatch.md#id5)
...
2. The second approach, if needed, is kernel exit switching. A
   ...
   1. Patching I/O-bound user tasks which are sleeping on an affected
      function. In this case you have to send SIGSTOP and SIGCONT to
      force it to exit the kernel and be patched.
   2. Patching CPU-bound user tasks. If the task is highly CPU-bound
...
### [3.1 Adding consistency model support to new architectures](livepatch.md#id6)
...
2. Alternatively, ensure that every kthread has a call to
   ...
   1. patching user tasks when they cross the kernel/user space
      boundary; and
...
## [4. Livepatch module](livepatch.md#id7)
...
### [4.1. New functions](livepatch.md#id8)
...
[Livepatch module ELF format](module-elf-format.md) for more details.

### [4.2. Metadata](livepatch.md#id9)

The patch is described by several structures that split the information
into three levels:

> - [`struct klp_func`](api.md#c.klp_func "klp_func") is defined for each patched function. It describes
...
> - [`struct klp_object`](api.md#c.klp_object "klp_object") defines an array of patched functions ([`struct
>   klp_func`](api.md#c.klp_func "klp_func")) in the same object. Where the object is either vmlinux
...
> - [`struct klp_patch`](api.md#c.klp_patch "klp_patch") defines an array of patched objects ([`struct
>   klp_object`](api.md#c.klp_object "klp_object")).
>
...
## [5. Livepatch life-cycle](livepatch.md#id10)
...
### [5.1. Loading](livepatch.md#id11)

The only reasonable way is to enable the patch when the livepatch kernel
module is being loaded. For this, [`klp_enable_patch()`](api.md#c.klp_enable_patch "klp_enable_patch") has to be called
in the [`module_init()`](../driver-api/basics.md#c.module_init "module_init") callback. There are two main reasons:

First, only the module has an easy access to the related [`struct klp_patch`](api.md#c.klp_patch "klp_patch").

Second, the error code might be used to refuse loading the module when
the patch cannot get enabled.

### [5.2. Enabling](livepatch.md#id12)

The livepatch gets enabled by calling [`klp_enable_patch()`](api.md#c.klp_enable_patch "klp_enable_patch") from
the [`module_init()`](../driver-api/basics.md#c.module_init "module_init") callback. The system will start using the new
...
ftrace handler is registered[[1]](livepatch.md#id2). This stage is indicated by a value of ‘1’
...
### [5.3. Replacing](livepatch.md#id13)

All enabled patches might get replaced by a cumulative patch that
has the .replace flag set.

Once the new patch is enabled and the ‘transition’ finishes then
all the functions ([`struct klp_func`](api.md#c.klp_func "klp_func")) associated with the replaced
patches are removed from the corresponding `struct klp_ops`. Also
the ftrace handler is unregistered and the `struct klp_ops` is
freed when the related function is not modified by the new patch
and func_stack list becomes empty.

See [Atomic Replace & Cumulative Patches](cumulative-patches.md) for more details.

### [5.4. Disabling](livepatch.md#id14)
...
to ‘0’. All the functions ([`struct klp_func`](api.md#c.klp_func "klp_func")) associated with the to-be-disabled
...
### [5.5. Removing](livepatch.md#id15)
...
See [ABI file testing/sysfs-kernel-livepatch](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-kernel-livepatch) for more details.

## [7. Limitations](livepatch.md#id17)
