...
source_url: https://www.kernel.org/doc/html/v6.17/livepatch/shadow-vars.html
...
It is important to note that the [`klp_shadow_alloc()`](api.md#c.klp_shadow_alloc "klp_shadow_alloc") and
[`klp_shadow_get_or_alloc()`](api.md#c.klp_shadow_get_or_alloc "klp_shadow_get_or_alloc") are zeroing the variable by default.
...
- [`klp_shadow_get()`](api.md#c.klp_shadow_get "klp_shadow_get") - retrieve a shadow variable data pointer
  - search hashtable for <obj, id> pair
- [`klp_shadow_alloc()`](api.md#c.klp_shadow_alloc "klp_shadow_alloc") - allocate and add a new shadow variable
  - search hashtable for <obj, id> pair
...
- [`klp_shadow_get_or_alloc()`](api.md#c.klp_shadow_get_or_alloc "klp_shadow_get_or_alloc") - get existing or alloc a new shadow variable
  - search hashtable for <obj, id> pair
...
- [`klp_shadow_free()`](api.md#c.klp_shadow_free "klp_shadow_free") - detach and free a <obj, id> shadow variable
...
- [`klp_shadow_free_all()`](api.md#c.klp_shadow_free_all "klp_shadow_free_all") - detach and free all <_, id> shadow variables
...
For the following use-case examples, consider [commit 1d147bfa6429](https://git.kernel.org/torvalds/c/1d147bfa6429)
(“mac80211: fix AP powersave TX vs. wakeup race”), which added a
spinlock to net/mac80211/sta_info.h :: [`struct sta_info`](../driver-api/80211/mac80211-advanced.md#c.sta_info "sta_info"). Each use-case
...
For [commit 1d147bfa6429](https://git.kernel.org/torvalds/c/1d147bfa6429), when a parent sta_info structure is allocated,
...
for a specific [`struct sta_info`](../driver-api/80211/mac80211-advanced.md#c.sta_info "sta_info")::
...
In these cases, the [`klp_shadow_get_or_alloc()`](api.md#c.klp_shadow_get_or_alloc "klp_shadow_get_or_alloc") call can be used to attach
shadow variables to parents already in-flight.

For [commit 1d147bfa6429](https://git.kernel.org/torvalds/c/1d147bfa6429), a good spot to allocate a shadow spinlock is
