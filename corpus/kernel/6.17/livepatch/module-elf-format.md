...
source_url: https://www.kernel.org/doc/html/v6.17/livepatch/module-elf-format.html
fetched_at: 2026-09-16T16:22:17+00:00
---
# Livepatch module ELF format

This document outlines the ELF format requirements that livepatch modules must follow.

- [1. Background and motivation](module-elf-format.md#background-and-motivation)

  - [Why does livepatch need to write its own relocations?](module-elf-format.md#why-does-livepatch-need-to-write-its-own-relocations)
- [2. Livepatch modinfo field](module-elf-format.md#livepatch-modinfo-field)

  - [Example:](module-elf-format.md#example)
- [3. Livepatch relocation sections](module-elf-format.md#livepatch-relocation-sections)
- [3.1 Livepatch relocation section format](module-elf-format.md#livepatch-relocation-section-format)

  - [Examples:](module-elf-format.md#examples)
- [4. Livepatch symbols](module-elf-format.md#livepatch-symbols)
- [4.1 A livepatch module’s symbol table](module-elf-format.md#a-livepatch-module-s-symbol-table)
- [4.2 Livepatch symbol format](module-elf-format.md#livepatch-symbol-format)

  - [Examples:](module-elf-format.md#id1)
- [5. Symbol table and ELF section access](module-elf-format.md#symbol-table-and-elf-section-access)

## [1. Background and motivation](module-elf-format.md#id2)
...
### [Why does livepatch need to write its own relocations?](module-elf-format.md#id3)
...
## [2. Livepatch modinfo field](module-elf-format.md#id4)
...
### [Example:](module-elf-format.md#id5)
...
## [3. Livepatch relocation sections](module-elf-format.md#id6)
...
## [3.1 Livepatch relocation section format](module-elf-format.md#id7)
...
### [Examples:](module-elf-format.md#id8)
...
## [4. Livepatch symbols](module-elf-format.md#id9)
...
## [4.1 A livepatch module’s symbol table](module-elf-format.md#id10)
...
## [4.2 Livepatch symbol format](module-elf-format.md#id11)
...
### [Examples:](module-elf-format.md#id12)
...
## [5. Symbol table and ELF section access](module-elf-format.md#id13)
...
module->klp_info, which is a [`klp_modinfo`](../driver-api/basics.md#c.klp_modinfo "klp_modinfo") struct. When a livepatch module
