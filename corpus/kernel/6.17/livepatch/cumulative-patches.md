...
collection: kernel
version: "6.17"
title: "Atomic Replace & Cumulative Patches"
source_url: https://www.kernel.org/doc/html/v6.17/livepatch/cumulative-patches.html
fetched_at: 2026-09-16T16:22:16+00:00
---
...
The atomic replace can be enabled by setting “replace” flag in [`struct klp_patch`](api.md#c.klp_patch "klp_patch"),
for example:
...
>   extra modifications in (un)patching callbacks or in the [`module_init()`](../driver-api/basics.md#c.module_init "module_init")
>   or [`module_exit()`](../driver-api/basics.md#c.module_exit "module_exit") functions, see below.
>
...
>   them in [`module_exit()`](../driver-api/basics.md#c.module_exit "module_exit") functions.
>
