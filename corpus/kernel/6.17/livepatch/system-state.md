...
source_url: https://www.kernel.org/doc/html/v6.17/livepatch/system-state.html
fetched_at: 2026-09-16T16:22:18+00:00
---
...
Each modified state is described by [`struct klp_state`](api.md#c.klp_state "klp_state"), see
...
[`struct klp_state`](api.md#c.klp_state "klp_state"):
...
> - [`klp_get_state()`](api.md#c.klp_get_state "klp_get_state")
>
>   - Get [`struct klp_state`](api.md#c.klp_state "klp_state") associated with the given livepatch
>     and state id.
> - [`klp_get_prev_state()`](api.md#c.klp_get_prev_state "klp_get_prev_state")
>
>   - Get [`struct klp_state`](api.md#c.klp_state "klp_state") associated with the given feature id and
>     already installed livepatches.
...
>   checking *[`klp_get_prev_state()`](api.md#c.klp_get_prev_state "klp_get_prev_state")*.
