...
collection: kernel
version: "6.17"
title: "E-MU Digital Audio System mixer / default DSP code"
source_url: https://www.kernel.org/doc/html/v6.17/sound/cards/emu-mixer.html
fetched_at: 2026-09-16T16:39:08+00:00
---
...
This document is based on [Sound Blaster Audigy mixer / default DSP code](audigy-mixer.md).
...
device (see [Low latency, multichannel audio with JACK and the emu10k1/emu10k2](emu10k1-jack.md)) additionally supports 24-bit capture.

A patchset to enhance the driver is available from [a GitHub repository](https://github.com/ossilator/linux/tree/ossis-emu10k1).
...
These controls are described in [Sound Blaster Audigy mixer / default DSP code](audigy-mixer.md).

## MANUALS/PATENTS

See [Sound Blaster Live mixer / default DSP code](sb-live-mixer.md).
