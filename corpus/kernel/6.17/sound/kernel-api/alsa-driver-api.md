...
source_url: https://www.kernel.org/doc/html/v6.17/sound/kernel-api/alsa-driver-api.html
fetched_at: 2026-09-16T16:26:56+00:00
---
# The ALSA Driver API
...
`name`
:   Component name. If null, dev_name will be used.
...
void snd_compr_task_finished(struct [snd_compr_stream](alsa-driver-api.md#c.snd_compr_stream "snd_compr_stream") \*stream, struct [snd_compr_task_runtime](alsa-driver-api.md#c.snd_compr_task_runtime "snd_compr_task_runtime") \*task)
...
`flags`
:   see SND_COMPRESS_TFLG_\* defines
...
`state`
:   actual task state (SND_COMPRESS_TASK_STATE_\*)
