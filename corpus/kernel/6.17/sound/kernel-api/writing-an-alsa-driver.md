...
source_url: https://www.kernel.org/doc/html/v6.17/sound/kernel-api/writing-an-alsa-driver.html
fetched_at: 2026-09-16T16:38:45+00:00
---
...
[`mdelay()`](../../timers/delay_sleep_functions.md#c.mdelay "mdelay") or [`udelay()`](../../timers/delay_sleep_functions.md#c.udelay "udelay") functions, you’ll need
...
Of course, a modern way with [`pci_iomap()`](../../driver-api/pci/pci.md#c.pci_iomap "pci_iomap") will make things a
bit easier, too:
...
callback, please use [`udelay()`](../../timers/delay_sleep_functions.md#c.udelay "udelay") or [`mdelay()`](../../timers/delay_sleep_functions.md#c.mdelay "mdelay").
