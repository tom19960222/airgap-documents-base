...
collection: kernel
version: "6.17"
title: "Advanced Linux Sound Architecture - Driver Configuration guide"
source_url: https://www.kernel.org/doc/html/v6.17/sound/alsa-configuration.html
fetched_at: 2026-09-16T16:39:01+00:00
---
...
:   Reserve the slot index for the given driver;
    ...
    See [Module Autoloading Support](alsa-configuration.md#module-autoloading-support) section for details.
...
ac97_quirk
:   AC’97 workaround for strange hardware;
    See [AC97 Quirk Option](alsa-configuration.md#ac97-quirk-option) section below.
...
:   Specifies the early “patch” files to modify the HD-audio setup
    ...
    is set. See [More Notes on HD-Audio Driver](hd-audio/notes.md) for details.
...
See [More Notes on HD-Audio Driver](hd-audio/notes.md) for more details about HD-audio driver.
...
is found in [HD-Audio Codec-Specific Models](hd-audio/models.md).
...
ML (see the section [Links and Addresses](alsa-configuration.md#links-and-addresses)).
...
stage of boot sequence. See [Early Buffer Allocation](alsa-configuration.md#early-buffer-allocation)
section.
...
See [Alsa driver for Digigram miXart8 and miXart8AES/EBU soundcards](cards/mixart.md) for details.
...
use_vmalloc
:   Use [`vmalloc()`](../core-api/mm-api.md#c.vmalloc "vmalloc") for allocations of the PCM buffers (default: yes).
...
subsystem vendor/device ids. See [Links and Addresses](alsa-configuration.md#links-and-addresses)
below.
...
ALSA Developers ML
:   [mailto:alsa-devel@alsa-project.org](mailto:alsa-devel%40alsa-project.org)
