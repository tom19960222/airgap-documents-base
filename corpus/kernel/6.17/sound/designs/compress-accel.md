...
collection: kernel
version: "6.17"
title: "ALSA Co-processor Acceleration API"
source_url: https://www.kernel.org/doc/html/v6.17/sound/designs/compress-accel.html
fetched_at: 2026-09-16T16:38:48+00:00
---
# ALSA Co-processor Acceleration API

Jaroslav Kysela <[perex@perex.cz](mailto:perex%40perex.cz)>
...
The hardware drivers allocate internal ‘[`struct dma_buf`](../../driver-api/dma-buf.md#c.dma_buf "dma_buf")’ for both input and
output buffers (using ‘[`dma_buf_export()`](../../driver-api/dma-buf.md#c.dma_buf_export "dma_buf_export")’ function). The anonymous
...
- Shengjiu Wang <[shengjiu.wang@gmail.com](mailto:shengjiu.wang%40gmail.com)>
- Takashi Iwai <[tiwai@suse.de](mailto:tiwai%40suse.de)>
- Vinod Koul <[vkoul@kernel.org](mailto:vkoul%40kernel.org)>
