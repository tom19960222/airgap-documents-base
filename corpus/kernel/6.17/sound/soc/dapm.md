...
collection: kernel
version: "6.17"
title: "Dynamic Audio Power Management for Portable Devices"
source_url: https://www.kernel.org/doc/html/v6.17/sound/soc/dapm.html
fetched_at: 2026-09-16T16:38:56+00:00
---
...
![Example DAPM graph](../../_images/dapm-graph.svg)
...
can be registered programmatically by calling [`snd_soc_dapm_new_controls()`](../kernel-api/alsa-driver-api.md#c.snd_soc_dapm_new_controls "snd_soc_dapm_new_controls")
and [`snd_soc_dapm_add_routes()`](../kernel-api/alsa-driver-api.md#c.snd_soc_dapm_add_routes "snd_soc_dapm_add_routes").
...
Finally, [`snd_soc_dapm_new_widgets()`](../kernel-api/alsa-driver-api.md#c.snd_soc_dapm_new_widgets "snd_soc_dapm_new_widgets") must be called after all widgets and
