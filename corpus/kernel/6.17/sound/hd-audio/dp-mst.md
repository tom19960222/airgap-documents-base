...
collection: kernel
version: "6.17"
title: "HD-Audio DP-MST Support"
source_url: https://www.kernel.org/doc/html/v6.17/sound/hd-audio/dp-mst.html
fetched_at: 2026-09-16T16:39:04+00:00
---
...
- acomp
  ...
  Use directly [`snd_jack_report()`](../kernel-api/alsa-driver-api.md#c.snd_jack_report "snd_jack_report") on spec->pcm_rec[pcm_idx].jack for
...
- !acomp
  ...
  Use directly [`snd_jack_report()`](../kernel-api/alsa-driver-api.md#c.snd_jack_report "snd_jack_report") on spec->pcm_rec[pcm_idx].jack for dyn_pcm_assign.
