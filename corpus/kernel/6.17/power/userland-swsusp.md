...
collection: kernel
version: "6.17"
title: "Documentation for userland software suspend interface"
source_url: https://www.kernel.org/doc/html/v6.17/power/userland-swsusp.html
fetched_at: 2026-09-16T16:38:04+00:00
---
# Documentation for userland software suspend interface

> 3. 2006 Rafael J. Wysocki <[rjw@sisk.pl](mailto:rjw%40sisk.pl)>

First, the warnings at the beginning of [Swap suspend](swsusp.md) still apply.

Second, you should read the FAQ in [Swap suspend](swsusp.md) _now_ if you have not
done it already.
...
:   set the resume partition and the offset (in <PAGE_SIZE>
    ...
    swap files (see [Using swap files with software suspend (swsusp)](swsusp-and-swap-files.md) for
    details).
