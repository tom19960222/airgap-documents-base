...
collection: kernel
version: "6.17"
title: "Regulator Consumer Driver Interface"
source_url: https://www.kernel.org/doc/html/v6.17/power/regulator/consumer.html
fetched_at: 2026-09-16T16:38:05+00:00
---
# Regulator Consumer Driver Interface

This text describes the regulator interface for consumer device drivers.
Please see [Linux voltage and current regulator framework](overview.md) for a description of the terms used in this text.
...
The consumer passes in its [`struct device`](../../driver-api/infrastructure.md#c.device "device") pointer and power supply ID. The core
...
The regulator access functions [`regulator_get()`](../../driver-api/regulator.md#c.regulator_get "regulator_get") and [`regulator_put()`](../../driver-api/regulator.md#c.regulator_put "regulator_put") will
...
NOTE:
:   The supply may already be enabled before [`regulator_enable()`](../../driver-api/regulator.md#c.regulator_enable "regulator_enable") is called.
...
use [`regulator_get_exclusive()`](../../driver-api/regulator.md#c.regulator_get_exclusive "regulator_get_exclusive"), as it can’t work if there’s more than one
