...
source_url: https://www.kernel.org/doc/html/v6.17/power/runtime_pm.html
fetched_at: 2026-09-16T16:37:59+00:00
---
# Runtime Power Management Framework for I/O Devices

3. 2009-2011 Rafael J. Wysocki <[rjw@sisk.pl](mailto:rjw%40sisk.pl)>, Novell Inc.

3. 2010 Alan Stern <[stern@rowland.harvard.edu](mailto:stern%40rowland.harvard.edu)>

3. 2014 Intel Corp., Rafael J. Wysocki <[rafael.j.wysocki@intel.com](mailto:rafael.j.wysocki%40intel.com)>
...
- A number of runtime PM fields in the ‘power’ member of ‘[`struct device`](../driver-api/infrastructure.md#c.device "device")’ (which
  is of the type ‘`struct dev_pm_info`’, defined in include/linux/pm.h) that can
  be used for synchronizing runtime PM operations with one another.
- Three device runtime PM callbacks in ‘[`struct dev_pm_ops`](../driver-api/pm/types.md#c.dev_pm_ops "dev_pm_ops")’ (defined in
  include/linux/pm.h).
...
The runtime PM callbacks present in ‘[`struct dev_pm_ops`](../driver-api/pm/types.md#c.dev_pm_ops "dev_pm_ops")’, the device runtime PM
fields of ‘`struct dev_pm_info`’ and the core helper functions provided for
runtime PM are described below.

## 2. Device Runtime PM Callbacks

There are three device runtime PM callbacks defined in ‘[`struct dev_pm_ops`](../driver-api/pm/types.md#c.dev_pm_ops "dev_pm_ops")’:
...
All of the above fields are members of the ‘power’ member of ‘[`struct device`](../driver-api/infrastructure.md#c.device "device")’.
...
related to hibernation (see [Device Power Management Basics](../driver-api/pm/devices.md) for more
information).
