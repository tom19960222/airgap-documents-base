...
source_url: https://www.kernel.org/doc/html/v6.17/power/freezing-of-tasks.html
fetched_at: 2026-09-16T16:33:00+00:00
---
# Freezing of tasks
...
explicitly in suitable places or use the [`wait_event_freezable()`](../driver-api/basics.md#c.wait_event_freezable "wait_event_freezable") or
...
[`wait_event_freezable()`](../driver-api/basics.md#c.wait_event_freezable "wait_event_freezable") and `wait_event_freezable_timeout()` macros.
...
and must call `try_to_freeze()` or variants of [`wait_event_freezable()`](../driver-api/basics.md#c.wait_event_freezable "wait_event_freezable") in a
suitable place.
...
they are not directly related to it. For example, if [`request_firmware()`](../driver-api/firmware/request_firmware.md#c.request_firmware "request_firmware") is
called from a device driver’s .`resume()` routine, it will timeout and eventually
fail, because the user land process that should respond to the request is frozen
at this point. So, seemingly, the failure is due to the freezing of tasks.
Suppose, however, that the firmware file is located on a filesystem accessible
only through another device that hasn’t been resumed yet. In that case,
[`request_firmware()`](../driver-api/firmware/request_firmware.md#c.request_firmware "request_firmware") will fail regardless of whether or not the freezing of tasks
...
[Suspend/Hibernation Notifiers](../driver-api/pm/notifiers.md).
