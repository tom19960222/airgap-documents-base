...
version: "6.17"
title: "Swap suspend"
source_url: https://www.kernel.org/doc/html/v6.17/power/swsusp.html
...
:   The freezing of tasks is a mechanism by which user space processes and some
    ...
    some architectures). See [Freezing of tasks](freezing-of-tasks.md) for details.
...
:   Generally, yes, you can. However, it requires you to use the “resume=” and
    ...
    [Using swap files with software suspend (swsusp)](swsusp-and-swap-files.md) for details.
...
:   That’s right ... if you disconnect that device, you may lose data.
    ...
    [USB device persistence during system suspend](../driver-api/usb/persist.md).
