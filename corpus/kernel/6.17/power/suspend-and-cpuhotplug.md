...
collection: kernel
version: "6.17"
title: "Interaction of Suspend code (S3) with the CPU hotplug infrastructure"
source_url: https://www.kernel.org/doc/html/v6.17/power/suspend-and-cpuhotplug.html
fetched_at: 2026-09-16T16:38:00+00:00
---
# Interaction of Suspend code (S3) with the CPU hotplug infrastructure

3. 2011 - 2014 Srivatsa S. Bhat <[srivatsa.bhat@linux.vnet.ibm.com](mailto:srivatsa.bhat%40linux.vnet.ibm.com)>
...
userspace, using the [`request_firmware()`](../driver-api/firmware/request_firmware.md#c.request_firmware "request_firmware") function defined in
drivers/base/firmware_loader/main.c]

1. When all the CPUs are identical:
...
2. When some of the CPUs are different than the rest:
...
3. When a CPU is physically hot-unplugged and a new (and possibly different
...
4. Handling microcode update during suspend/hibernate:
