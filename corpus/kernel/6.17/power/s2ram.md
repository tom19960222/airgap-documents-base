...
collection: kernel
version: "6.17"
title: "How to get s2ram working"
source_url: https://www.kernel.org/doc/html/v6.17/power/s2ram.html
...
2. If that does not help, try reading [swsusp/S3 tricks](tricks.md) and
   [Video issues with S3 resume](video.md). Perhaps problem is as simple as broken module, and
