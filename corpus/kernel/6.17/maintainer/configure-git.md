...
source_url: https://www.kernel.org/doc/html/v6.17/maintainer/configure-git.html
fetched_at: 2026-09-16T16:18:30+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/maintainer/configure-git.md)
- [Italian](../translations/it_IT/maintainer/configure-git.md)
...
[Creating Pull Requests](pull-requests.md)) should be signed with the
