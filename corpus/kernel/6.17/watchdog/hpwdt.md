...
source_url: https://www.kernel.org/doc/html/v6.17/watchdog/hpwdt.html
fetched_at: 2026-09-16T16:33:06+00:00
---
...
>     [The Linux Watchdog driver API](watchdog-api.md) and [The Linux IPMI Driver](../driver-api/ipmi.md)
>
...
> :   - [Documentation for Kdump - The kexec-based Crash Dumping Solution](../admin-guide/kdump/kdump.md)
>     - [The kernel’s command-line parameters](../admin-guide/kernel-parameters.md) (panic=)
