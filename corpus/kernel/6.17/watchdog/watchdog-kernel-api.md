...
source_url: https://www.kernel.org/doc/html/v6.17/watchdog/watchdog-kernel-api.html
...
Wim Van Sebroeck <[wim@iguana.be](mailto:wim%40iguana.be)>
...
file: [The Linux Watchdog driver API](watchdog-api.md) .
