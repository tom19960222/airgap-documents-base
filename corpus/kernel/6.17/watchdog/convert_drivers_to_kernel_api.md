...
source_url: https://www.kernel.org/doc/html/v6.17/watchdog/convert_drivers_to_kernel_api.html
fetched_at: 2026-09-16T16:43:34+00:00
---
# Converting old watchdog drivers to the watchdog framework

by Wolfram Sang <[wsa@kernel.org](mailto:wsa%40kernel.org)>
...
explained in ‘[The Linux WatchDog Timer Driver Core kernel API](watchdog-kernel-api.md)’ in this directory. [`start()`](../networking/ieee802154.md#c.start "start") and
...
in ‘[The Linux WatchDog Timer Driver Core kernel API](watchdog-kernel-api.md)’ in this directory. We pass it the mandatory
...
Make sure you understood [Submitting patches: the essential guide to getting your code into the kernel](../process/submitting-patches.md) and send your patch to
[linux-watchdog@vger.kernel.org](mailto:linux-watchdog%40vger.kernel.org). We are looking forward to it :)
