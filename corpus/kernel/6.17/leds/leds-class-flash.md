...
collection: kernel
version: "6.17"
title: "Flash LED handling under Linux"
source_url: https://www.kernel.org/doc/html/v6.17/leds/leds-class-flash.html
fetched_at: 2026-09-16T16:40:05+00:00
---
# Flash LED handling under Linux

Some LED devices provide two modes - torch and flash. In the LED subsystem
those modes are supported by LED class (see [LED handling under Linux](leds-class.md))
...
(see [ABI file testing/sysfs-class-led-flash](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-class-led-flash))
...
argument - [`struct v4l2_flash`](../driver-api/media/v4l2-flash-led-class.md#c.v4l2_flash "v4l2_flash") pointer returned previously by v4l2_flash_init.
