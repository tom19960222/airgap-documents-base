...
collection: kernel
version: "6.17"
title: "LED handling under Linux"
source_url: https://www.kernel.org/doc/html/v6.17/leds/leds-class.html
fetched_at: 2026-09-16T16:40:04+00:00
---
...
:   - hw_control_is_supported:
    ...
    - hw_control_get_device:
      :   return the device associated with the LED driver in
          ...
          Returns a pointer to a [`struct device`](../driver-api/infrastructure.md#c.device "device") or NULL if nothing
