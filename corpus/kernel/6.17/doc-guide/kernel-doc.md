...
collection: kernel
version: "6.17"
title: "Writing kernel-doc comments"
source_url: https://www.kernel.org/doc/html/v6.17/doc-guide/kernel-doc.html
fetched_at: 2026-09-16T16:21:24+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/doc-guide/kernel-doc.md)
- [Italian](../translations/it_IT/doc-guide/kernel-doc.md)
...
> **Note:**
>
> The kernel-doc format is deceptively similar to javadoc,
...
> **Note:**
>
> kernel-doc does not cover Rust code: please see
> [General Information](../rust/general-information.md) instead.

The kernel-doc structure is extracted from the comments, and proper
[Sphinx C Domain](http://www.sphinx-doc.org/en/stable/domains.html) function and type descriptions with anchors are
...
> **Note:**
>
> 1. The multi-line descriptive text you provide does *not* recognize
...
>    ```
> 2. If the descriptive text you provide has lines that begin with
...
> **Note:**
>
> 1. When documenting nested structs or unions, if the struct/union `foo`
>    is named, the member `bar` inside it should be documented as
>    `@foo.bar:`
> 2. When the nested struct/`union is` anonymous, the member `bar` in it
...
Domain](http://www.sphinx-doc.org/en/stable/domains.html) references.

> **Attention:**
>
> The below are **only** recognized within kernel-doc comments,
...
For further details, please refer to the [Sphinx C Domain](http://www.sphinx-doc.org/en/stable/domains.html) documentation.
