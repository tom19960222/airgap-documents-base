...
collection: kernel
version: "6.17"
title: "Using Sphinx for kernel documentation"
source_url: https://www.kernel.org/doc/html/v6.17/doc-guide/sphinx.html
fetched_at: 2026-09-16T16:21:23+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/doc-guide/sphinx.md)
- [Italian](../translations/it_IT/doc-guide/sphinx.md)

# Using Sphinx for kernel documentation

The Linux kernel uses [Sphinx](http://www.sphinx-doc.org/) to generate pretty documentation from
[reStructuredText](http://docutils.sourceforge.net/rst.html) files under `Documentation`. To build the documentation in
...
[Checking for Sphinx dependencies](sphinx.md#sphinx-pre-install) for further details.
...
handles images in both GraphViz and SVG formats (see [Figures & Images](sphinx.md#sphinx-kfigure)).
...
One is an extension called [imgmath](https://www.sphinx-doc.org/en/master/usage/extensions/math.html#module-sphinx.ext.imgmath) which converts math expressions into
images and embeds them in html pages.
The other is an extension called [mathjax](https://www.sphinx-doc.org/en/master/usage/extensions/math.html#module-sphinx.ext.mathjax) which delegates math rendering
...
without installing any texlive packages. See [Choice of Math Renderer](sphinx.md#choice-of-math-renderer) for
further info.
...
[Minimal requirements to compile the Kernel](../process/changes.md) can be done by creating
...
from ImageMagick (<https://www.imagemagick.org>).[[1]](sphinx.md#ink) All of these are
...
html output.[[2]](sphinx.md#sph1-8)
...
2. Refer to it from the Sphinx main [TOC tree](http://www.sphinx-doc.org/en/stable/markup/toctree.html) in `Documentation/index.rst`.
...
See the documentation for [Sphinx](http://www.sphinx-doc.org/) and [reStructuredText](http://docutils.sourceforge.net/rst.html) on what you can do
with them. In particular, the Sphinx [reStructuredText Primer](http://www.sphinx-doc.org/en/stable/rest.html) is a good place
to get started with reStructuredText. There are also some [Sphinx specific
markup constructs](http://www.sphinx-doc.org/en/stable/markup/index.html).
...
[reStructuredText user reference for table syntax](https://docutils.sourceforge.io/docs/user/rst/quickref.html#tables) for more details.
...
and *targets* (e.g. a ref to `` :ref:`last row <last row>` `` / [last row](sphinx.md#last-row)).
...
[Writing kernel-doc comments](kernel-doc.md).
...
image format, use SVG ([SVG image example](sphinx.md#svg-image-example)):
...
![simple SVG image](../_images/svg_image.svg)
...
A simple example ([DOT’s hello world example](sphinx.md#hello-dot-file)):
...
*literal-block* ([Embedded DOT (Graphviz) code](sphinx.md#hello-dot-render)).
...
you want to refer to it ([Embedded SVG markup](sphinx.md#hello-svg-render)).
