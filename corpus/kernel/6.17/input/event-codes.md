...
collection: kernel
version: "6.17"
title: "2. Input event codes"
source_url: https://www.kernel.org/doc/html/v6.17/input/event-codes.html
fetched_at: 2026-09-16T16:38:23+00:00
---
# 2. Input event codes
...
- SYN_MT_REPORT:
  ...
  - Used to synchronize and separate touch events. See the
    [Multi-touch (MT) Protocol](multi-touch-protocol.md) document for more information.
- SYN_DROPPED:
...
Note: In multitouch drivers, the [`input_mt_report_finger_count()`](../driver-api/input.md#c.input_mt_report_finger_count "input_mt_report_finger_count") function should
be used to emit these codes. Please see [Multi-touch (MT) Protocol](multi-touch-protocol.md) for details.
...
- ABS_MT_<name>:
  ...
  - Used to describe multitouch input events. Please see
    [Multi-touch (MT) Protocol](multi-touch-protocol.md) for details.
...
For multi-touch functionality, see the [Multi-touch (MT) Protocol](multi-touch-protocol.md) document for
more information.
