...
collection: kernel
version: "6.17"
title: "17. xpad - Linux USB driver for Xbox compatible controllers"
source_url: https://www.kernel.org/doc/html/v6.17/input/devices/xpad.html
fetched_at: 2026-09-16T16:38:38+00:00
---
...
can be found on the net ([[1]](xpad.md#id5), [[2]](xpad.md#id6), [[3]](xpad.md#id7)).
...
dump from InterAct PowerPad Pro (Germany)
...
dump from Redoctane Xbox Dance Pad (US)
...
IDs see the xpad_device[] array[[4]](xpad.md#id8).
...
2002-07-16 - Marko Friedemann <[mfr@bmx-chemnitz.de](mailto:mfr%40bmx-chemnitz.de)>
:   - original doc

2005-03-19 - Dominic Cerquetti <[binary1230@yahoo.com](mailto:binary1230%40yahoo.com)>
:   - added stuff for dance pads, new d-pad->axes mappings

Later changes may be viewed with
‘git log --follow [xpad - Linux USB driver for Xbox compatible controllers](xpad.md)’
