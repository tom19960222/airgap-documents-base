...
collection: kernel
version: "6.17"
title: "6.6. Programming Interface"
source_url: https://www.kernel.org/doc/html/v6.17/input/joydev/joystick-api.html
fetched_at: 2026-09-16T16:52:11+00:00
---
# 6.6. Programming Interface

Author:
:   Ragnar Hojland Espinosa <[ragnar@macula.net](mailto:ragnar%40macula.net)> - 7 Aug 1998
...
driver now reports only any changes of its state. See [Programming Interface](joystick-api.md),
...
> 1. use select to wait until there’s data to be read on fd, or
