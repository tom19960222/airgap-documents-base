...
collection: kernel
version: "6.17"
title: "1. Creating an input device driver"
source_url: https://www.kernel.org/doc/html/v6.17/input/input-programming.html
fetched_at: 2026-09-16T16:38:27+00:00
---
...
Then it allocates a new input device structure with [`input_allocate_device()`](../driver-api/input.md#c.input_allocate_device "input_allocate_device")
...
device has appeared. [`input_register_device()`](../driver-api/input.md#c.input_register_device "input_register_device") may sleep and therefore must
