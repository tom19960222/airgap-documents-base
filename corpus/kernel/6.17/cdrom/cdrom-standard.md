...
collection: kernel
version: "6.17"
title: "A Linux CD-ROM standard"
source_url: https://www.kernel.org/doc/html/v6.17/cdrom/cdrom-standard.html
fetched_at: 2026-09-16T16:42:38+00:00
---
# A Linux CD-ROM standard

Author:
:   David van Leeuwen <[david@ElseWare.cistron.nl](mailto:david%40ElseWare.cistron.nl)>

Date:
:   12 March 1999

Updated by:
:   Erik Andersen ([andersee@debian.org](mailto:andersee%40debian.org))

Updated by:
:   Jens Axboe ([axboe@image.dk](mailto:axboe%40image.dk))
...
set of commands and data formats [[1]](cdrom-standard.md#f1). It seemed that many
...
satisfy certain drivers [[2]](cdrom-standard.md#f2), any non-standard *ioctl()*s
...
configurations[[3]](cdrom-standard.md#f3).

[[3](cdrom-standard.md#id3)]
...
The contents of this structure were described in [cdrom_api](cdrom-standard.md#cdrom-api).
...
as described in [cdrom_api](cdrom-standard.md#cdrom-api), should be registered with the
...
CDROMEJECT_SW
:   If *argnot=0*, set behavior to auto-close (close
...
:   Returns the status of the drive by a call to
    *`drive_status()`*. Return values are defined in [cdrom_drive_status](cdrom-standard.md#cdrom-drive-status).
...
:   Returns the *capability* flags for the drive. Refer to section
    [cdrom_capabilities](cdrom-standard.md#cdrom-capabilities) for more information on these flags.
...
- Implement all functions in your <device>_dops structure,
  ...
  in [cdrom_api](cdrom-standard.md#cdrom-api). Most likely you have already implemented
...
- Rename your <device>`_ioctl()` function to *audio_ioctl* and
  ...
  part in [cdrom_ioctl](cdrom-standard.md#cdrom-ioctl), if your code was OK, these are
  just calls to the routines you adapted in the previous step.
- You may remove all remaining memory checking code in the
  *`audio_ioctl()`* function that deals with audio commands (these are
  listed in the second part of [cdrom_ioctl](cdrom-standard.md#cdrom-ioctl). There is no
