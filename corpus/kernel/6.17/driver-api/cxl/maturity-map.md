...
collection: kernel
version: "6.17"
title: "Compute Express Link Subsystem Maturity Map"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/maturity-map.html
fetched_at: 2026-09-16T16:36:29+00:00
---
# Compute Express Link Subsystem Maturity Map

The Linux CXL subsystem tracks the dynamic [CXL specification](https://computeexpresslink.org/cxl-specification-landing-page) that
...
[work being incorporated each merge window](https://lore.kernel.org/linux-cxl/?q=s%3APULL+s%3ACXL+tc%3Atorvalds+NOT+s%3ARe),
...
- [0] Known gap: Feature is on a medium to long term horizon to
  ...
  the [linux-cxl@vger.kernel.org](mailto:linux-cxl%40vger.kernel.org) community has started to look at it.
...
- [2] CXL Window Enumeration
  ...
  - [2] [Extended-linear memory-side cache](maturity-map.md#extended-linear)
  - [0] Low Memory-hole
  - [X] Hetero-interleave
...
- [0] [RCH link status](maturity-map.md#rch-link-status)
...
- [3] Firmware update
- [3] Health / Alerts
- [1] [Background commands](maturity-map.md#background-commands)
- [3] Sanitization
- [3] Security commands
...
- **Extended-linear memory-side cache**: An HMAT proposal to enumerate the presence of a
  ...
  range capacity. [See the ECN](https://lore.kernel.org/linux-cxl/6650e4f835a0e_195e294a8@dwillia2-mobl3.amr.corp.intel.com.notmuch/)
  for more details:
...
- **Background commands**: The CXL background command mechanism is
  ...
  various commands. A [cancel on conflict](http://lore.kernel.org/r/66035c2e8ba17_770232948b@dwillia2-xfh.jf.intel.com.notmuch)
