...
collection: kernel
version: "6.17"
title: "BIOS/EFI Configuration"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/platform/bios-and-efi.html
fetched_at: 2026-09-16T16:36:31+00:00
---
...
If your platform supports it, the `uefisettings` command can be used to
...
On some AMD platforms, the `EFI_MEMORY_SP` bit is set via the `CXL
...
If providing cross-host-bridge interleave, a CFMWS entry in the [CEDT](acpi/cedt.md) must be presented with target host-bridges for the interleaved
...
memory regions in the [SRAT](acpi/srat.md) to determine the number of
