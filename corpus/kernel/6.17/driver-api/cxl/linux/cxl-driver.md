...
collection: kernel
version: "6.17"
title: "CXL Driver Operation"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/linux/cxl-driver.html
fetched_at: 2026-09-16T16:36:40+00:00
---
...
![Digraph of CXL fabric describing host-bridge interleaving](../../../_images/DOT-289c17ebc0291f90ccaf431961707504464a78d4.svg)
...
- Host Bridge Ports defined by CHBS in the [CEDT](../platform/acpi/cedt.md)
- Downstream Ports typically connected to Host Bridge Ports.
- Root Decoders defined by CFMWS the [CEDT](../platform/acpi/cedt.md)
...
![Digraph of CXL fabric describing host-bridge interleaving](../../../_images/DOT-e0310787169fe0163aed990b83bf9f52b82de066.svg)
...
configurations present in the CFMWS field of the [CEDT](../platform/acpi/cedt.md).
...
is created per CFMWS entry in the [CEDT](../platform/acpi/cedt.md).
...
host bridge UIDs in the CHBS field of the [CEDT](../platform/acpi/cedt.md) and the UID field of CXL Host Bridges defined in
the [DSDT](../platform/acpi/dsdt.md).
...
![Digraph of hierarchical relationship between root, switch, and endpoint decoders.](../../../_images/DOT-1e98886fceca6e25a115532f5efebb44c09dc98b.svg)
...
![Digraph of CXL memory region relationships between root and endpoint decoders.](../../../_images/DOT-d98d145a30f1ad2016fd5e4ce200438d74dad680.svg)
...
4x4 cross-link first interleave settings
...
Root decoder interleave is defined by CFMWS field of the [CEDT](../platform/acpi/cedt.md). The CEDT may actually define multiple CFMWS
...
- [Single Device](example-configurations/single-device.md)
- [Inter-Host-Bridge Interleave](example-configurations/hb-interleave.md)
- [Intra-Host-Bridge Interleave](example-configurations/intra-hb-interleave.md)
- [Multi-Level Interleave](example-configurations/multi-interleave.md)
