...
version: "6.17"
title: "Single Device"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/linux/example-configurations/single-device.html
...
is a pass-through decoder because `interleave_ways` is set to `1`.
...
`decoder0.0`. This region describes the discrete region associated
