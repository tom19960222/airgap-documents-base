...
collection: kernel
version: "6.17"
title: "Intra-Host-Bridge Interleave"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/linux/example-configurations/intra-hb-interleave.html
...
Host Bridge `port1` has a single decoder (`decoder1.0`) with two
targets: `dport1` and `dport3` - which are attached to
