...
collection: kernel
version: "6.17"
title: "Inter-Host-Bridge Interleave"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/linux/example-configurations/hb-interleave.html
fetched_at: 2026-09-16T16:52:03+00:00
---
...
ports: `dport1`, `dport2`, and `dport113`..
...
Host Bridge `port1` has a single decoder (`decoder1.0`), whose only
target is `dport1` - which is attached to `endpoint5`.
