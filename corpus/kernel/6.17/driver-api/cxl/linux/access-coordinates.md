...
collection: kernel
version: "6.17"
title: "CXL Access Coordinates Computation"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/cxl/linux/access-coordinates.html
fetched_at: 2026-09-16T16:36:42+00:00
---
...
provided via ACPI tables [SRAT](../platform/acpi/srat.md) and
[HMAT](../platform/acpi/hmat.md). However, the platform firmware (BIOS) is
...
The [SRAT](../platform/acpi/srat.md) provides a Generic Port Affinity
...
[HMAT](../platform/acpi/hmat.md) subtable. This piece represents the
performance coordinates between a CPU and a Generic Port (CXL hostbridge).

The [CDAT](../platform/cdat.md) provides the performance coordinates for
...
See [CXL Memory Device SW Guide r1.0](https://www.intel.com/content/www/us/en/content-details/643805/cxl-memory-device-software-guide.html),
...
Window Structure (CFMWS) in the [CEDT](../platform/acpi/cedt.md).
...
[`cxl_endpoint_gather_bandwidth()`](../theory-of-operation.md#c.cxl_endpoint_gather_bandwidth "cxl_endpoint_gather_bandwidth") function. The `min()` of bandwidth from the
...
or walking through the switch(es), [`cxl_rp_gather_bandwidth()`](../theory-of-operation.md#c.cxl_rp_gather_bandwidth "cxl_rp_gather_bandwidth") is called. At
...
via ACPI tables ([SRAT](../platform/acpi/srat.md) and
[HMAT](../platform/acpi/hmat.md)). The minimum bandwidth are aggregated
under the same ACPI0017 device to form a new xarray.

Finally, the [`cxl_region_update_bandwidth()`](../theory-of-operation.md#c.cxl_region_update_bandwidth "cxl_region_update_bandwidth") is called and the aggregated
...
Each [CEDT](../platform/acpi/cedt.md) has a QTG ID field. This field provides
