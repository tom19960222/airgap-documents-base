...
collection: kernel
version: "6.17"
title: "IAA Compression Accelerator Crypto Driver"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/crypto/iaa/iaa-crypto.html
fetched_at: 2026-09-16T16:33:29+00:00
---
# IAA Compression Accelerator Crypto Driver

Tom Zanussi <[tom.zanussi@linux.intel.com](mailto:tom.zanussi%40linux.intel.com)>
...
The [IAA disable script](iaa-crypto.md#iaa-disable-script) in the ‘Use Cases’
section below can be used to disable the default configuration.

See [IAA Default Configuration](iaa-crypto.md#iaa-default-config) below for details of the default
configuration.
...
The [IAA sysfs config interface](iaa-crypto.md#iaa-sysfs-config) section in the appendix below can be
...
the iaa_crypto module. The [IAA disable script](iaa-crypto.md#iaa-disable-script) in the ‘Use
...
further IAA configuration is necessary. See [IAA Default Configuration](iaa-crypto.md#iaa-default-config)
...
Then run the [IAA disable script](iaa-crypto.md#iaa-disable-script) in the ‘Use Cases’ section
