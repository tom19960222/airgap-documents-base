...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/usb/dwc3.html
...
`susphy_state`
:   state of DWC3_GUSB2PHYCFG_SUSPHY + DWC3_GUSB3PIPECTL_SUSPHY
    before PM suspend.
...
int dwc3_gadget_start_config(struct [dwc3](dwc3.md#c.dwc3 "dwc3") \*dwc, unsigned int resource_index)
...
int dwc3_gadget_calc_ram_depth(struct [dwc3](dwc3.md#c.dwc3 "dwc3") \*dwc)
...
[1]
([1](dwc3.md#id1),[2](dwc3.md#id4),[3](dwc3.md#id6))
