...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/usb/error-codes.html
fetched_at: 2026-09-16T16:36:53+00:00
---
# USB Error codes
...
| `-EPIPE` [[2]](error-codes.md#f2) | Endpoint stalled. For non-control endpoints, reset this status with `usb_clear_halt()`. |
...
[1]
([1](error-codes.md#id2),[2](error-codes.md#id4),[3](error-codes.md#id8))
...
[2]
([1](error-codes.md#id3),[2](error-codes.md#id5),[3](error-codes.md#id6),[4](error-codes.md#id7))
