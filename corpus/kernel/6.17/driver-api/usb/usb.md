...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/usb/usb.html
fetched_at: 2026-09-16T16:29:12+00:00
---
...
:   the minor number assigned to this interface, if this
    ...
    number from the USB core by calling [`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev").
...
that setting using [`usb_set_interface()`](usb.md#c.usb_core.usb_set_interface "usb_core.usb_set_interface"). Alternate settings are often
...
stored in numerical order anyhow. Use [`usb_altnum_to_altsetting()`](usb.md#c.usb_core.usb_altnum_to_altsetting "usb_core.usb_altnum_to_altsetting") to
...
guaranteed to be sorted in numerical order. Use [`usb_ifnum_to_if()`](usb.md#c.usb_core.usb_ifnum_to_if "usb_core.usb_ifnum_to_if") to
...
[`usb_reset_configuration()`](usb.md#c.usb_core.usb_reset_configuration "usb_core.usb_reset_configuration") to reinitialize the current configuration and
all its interfaces.
...
[`usb_set_device_state()`](usb.md#c.usb_core.usb_set_device_state "usb_core.usb_set_device_state").
...
:   Called to see if the driver is willing to manage a particular
    ...
    interface. It may also use [`usb_set_interface()`](usb.md#c.usb_core.usb_set_interface "usb_core.usb_set_interface") to specify the
...
`pre_reset`
:   Called by [`usb_reset_device()`](usb.md#c.usb_core.usb_reset_device "usb_core.usb_reset_device") when the device is about to be
    reset. This routine must not return until the driver has no active
    URBs for the device, and no more URBs may be submitted until the
    post_reset method is called.

`post_reset`
:   Called by [`usb_reset_device()`](usb.md#c.usb_core.usb_reset_device "usb_core.usb_reset_device") after the device
    has been reset
...
This structure is used for the [`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev") and
[`usb_deregister_dev()`](usb.md#c.usb_core.usb_deregister_dev "usb_core.usb_deregister_dev") functions, to consolidate a number of the
...
`sgt`
:   used to hold a scatter gather table returned by [`usb_alloc_noncoherent()`](usb.md#c.usb_core.usb_alloc_noncoherent "usb_core.usb_alloc_noncoherent"),
    ...
    allocated memory needs to be freed by [`usb_free_noncoherent()`](usb.md#c.usb_core.usb_free_noncoherent "usb_core.usb_free_noncoherent").
...
allocate a DMA buffer with [`usb_alloc_coherent()`](usb.md#c.usb_core.usb_alloc_coherent "usb_core.usb_alloc_coherent") or call `usb_buffer_map()`.
...
These requests are initialized using [`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init"), and then are used
as request handles passed to [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait") or [`usb_sg_cancel()`](usb.md#c.usb_core.usb_sg_cancel "usb_core.usb_sg_cancel"). Most
members of the request object aren’t for driver access.

The status and bytecount values are valid only after [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait")
...
For control endpoints, the synchronous [`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") call is
often used (in non-interrupt context) instead of this call.
That is often used through convenience wrappers, for the requests
that are standardized in the USB 2.0 specification. For bulk
endpoints, a synchronous [`usb_bulk_msg()`](usb.md#c.usb_core.usb_bulk_msg "usb_core.usb_bulk_msg") call is available.
...
[`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") has where the data pointer must be to dynamically allocated
...
restriction that [`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") has where the data pointer must be to
...
Because there is no [`usb_interrupt_msg()`](usb.md#c.usb_core.usb_interrupt_msg "usb_core.usb_interrupt_msg") and no USBDEVFS_INTERRUPT ioctl,
...
:   request block being initialized. until [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait") returns,
...
The request must be issued using [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait"), which waits for the I/O to
complete (or to be canceled) and then cleans up all resources allocated by
[`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init").

The request may be canceled with [`usb_sg_cancel()`](usb.md#c.usb_core.usb_sg_cancel "usb_core.usb_sg_cancel"), either before or after
[`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait") is called.
...
`struct usb_sg_request *io`
:   request block handle, as initialized with [`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init").
...
3. cancellation, a type of error with status -ECONNRESET that
   is initiated by [`usb_sg_cancel()`](usb.md#c.usb_core.usb_sg_cancel "usb_core.usb_sg_cancel").

When this function returns, all memory allocated through [`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init") or
this call will have been freed. The request block parameter may still be
passed to [`usb_sg_cancel()`](usb.md#c.usb_core.usb_sg_cancel "usb_core.usb_sg_cancel"), or it may be freed. It could also be
...
:   stop scatter/gather i/o issued by [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait")

**Parameters**

`struct usb_sg_request *io`
:   request block, initialized with [`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init")

**Description**

This stops a request after it has been started by [`usb_sg_wait()`](usb.md#c.usb_core.usb_sg_wait "usb_core.usb_sg_wait").
It can also prevents one initialized by [`usb_sg_init()`](usb.md#c.usb_core.usb_sg_init "usb_core.usb_sg_init") from starting,
...
`usb_get_string()` or [`usb_string()`](usb.md#c.usb_core.usb_string "usb_core.usb_string") for USB_DT_STRING.
...
returned by the underlying [`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") call.
...
and cleared using the CLEAR_FEATURE request. The [`usb_clear_halt()`](usb.md#c.usb_core.usb_clear_halt "usb_core.usb_clear_halt")
function should be used to clear halt (“stall”) status.

This call is synchronous, and may not be used in an interrupt context.

Returns 0 and the status value in **\*data** (in host byte order) on success,
or else the status code from the underlying [`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") call.
...
underlying [`usb_control_msg()`](usb.md#c.usb_core.usb_control_msg "usb_core.usb_control_msg") call.
...
use [`usb_set_interface()`](usb.md#c.usb_core.usb_set_interface "usb_core.usb_set_interface") on the interfaces it claims. Be careful though;
...
[`usb_deregister_dev()`](usb.md#c.usb_core.usb_deregister_dev "usb_core.usb_deregister_dev") must be called when the driver is done with
...
Used in conjunction with [`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev"). This function is called
when the USB driver is finished with the minor numbers gotten from a
call to [`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev") (usually when the device is disconnected
from the system.)
...
[`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev") to enable that functionality. This function no longer
takes care of that.
...
If you called [`usb_register_dev()`](usb.md#c.usb_core.usb_register_dev "usb_core.usb_register_dev"), you still need to call
[`usb_deregister_dev()`](usb.md#c.usb_core.usb_deregister_dev "usb_core.usb_deregister_dev") to clean up your driver’s allocated minor numbers,
...
This routine does much the same thing as [`usb_autopm_put_interface()`](usb.md#c.usb_core.usb_autopm_put_interface "usb_core.usb_autopm_put_interface"):
...
This prevention will persist until [`usb_autopm_put_interface()`](usb.md#c.usb_core.usb_autopm_put_interface "usb_core.usb_autopm_put_interface") is called
...
[`usb_autopm_get_interface()`](usb.md#c.usb_core.usb_autopm_get_interface "usb_core.usb_autopm_get_interface"): It increments **intf**’s usage counter and
...
them by calling [`usb_put_dev()`](usb.md#c.usb_core.usb_put_dev "usb_core.usb_put_dev"), in their `disconnect()` methods.
...
Drivers for USB interfaces should normally record such references in
their `probe()` methods, when they bind to an interface, and release
them by calling [`usb_put_intf()`](usb.md#c.usb_core.usb_put_intf "usb_core.usb_put_intf"), in their `disconnect()` methods.
...
controllers can. A call to [`usb_intf_get_dma_device()`](usb.md#c.usb_core.usb_intf_get_dma_device "usb_core.usb_intf_get_dma_device") returns the DMA endpoint
...
When the buffer is no longer used, free it with [`usb_free_coherent()`](usb.md#c.usb_core.usb_free_coherent "usb_core.usb_free_coherent").

void usb_free_coherent(struct [usb_device](usb.md#c.usb_device "usb_device") \*dev, size_t size, void \*addr, dma_addr_t dma)
:   free memory allocated with [`usb_alloc_coherent()`](usb.md#c.usb_core.usb_alloc_coherent "usb_core.usb_alloc_coherent")
...
been allocated using [`usb_alloc_coherent()`](usb.md#c.usb_core.usb_alloc_coherent "usb_core.usb_alloc_coherent"), and the parameters must match
those provided in that allocation request.

void \*usb_alloc_noncoherent(struct [usb_device](usb.md#c.usb_device "usb_device") \*dev, size_t size, gfp_t mem_flags, dma_addr_t \*dma, enum dma_data_direction dir, struct sg_table \*\*table)
:   allocate dma-noncoherent buffer for URB_NO_xxx_DMA_MAP
...
:   used to return sg_table of allocated memory
...
When the buffer is no longer used, free it with [`usb_free_noncoherent()`](usb.md#c.usb_core.usb_free_noncoherent "usb_core.usb_free_noncoherent").
...
void usb_free_noncoherent(struct [usb_device](usb.md#c.usb_device "usb_device") \*dev, size_t size, void \*addr, enum dma_data_direction dir, struct sg_table \*table)
:   free memory allocated with [`usb_alloc_noncoherent()`](usb.md#c.usb_core.usb_alloc_noncoherent "usb_core.usb_alloc_noncoherent")
...
This reclaims an I/O buffer, letting it be reused. The memory must have
been allocated using [`usb_alloc_noncoherent()`](usb.md#c.usb_core.usb_alloc_noncoherent "usb_core.usb_alloc_noncoherent"), and the parameters must match
those provided in that allocation request.

int usb_hub_clear_tt_buffer(struct [urb](usb.md#c.usb_core.usb_hub_clear_tt_buffer "urb") \*urb)
...
the device using [`usb_lock_device_for_reset()`](usb.md#c.usb_core.usb_lock_device_for_reset "usb_core.usb_lock_device_for_reset").
...
context, where [`usb_reset_device()`](usb.md#c.usb_core.usb_reset_device "usb_core.usb_reset_device") won’t work (as it blocks).

Doing a reset via this method is functionally equivalent to calling
[`usb_reset_device()`](usb.md#c.usb_core.usb_reset_device "usb_core.usb_reset_device"), except for the fact that it is delayed to a
...
- This function can be called during .`probe()`. It can also be called
  ...
  .`disconnect()`, call [`usb_reset_device()`](usb.md#c.usb_core.usb_reset_device "usb_core.usb_reset_device") directly -- but watch out
...
int usb_hcd_link_urb_to_ep(struct usb_hcd \*hcd, struct [urb](usb.md#c.usb_core.usb_hcd_link_urb_to_ep "urb") \*urb)
...
anyway, it must call [`usb_hcd_unlink_urb_from_ep()`](usb.md#c.usb_core.usb_hcd_unlink_urb_from_ep "usb_core.usb_hcd_unlink_urb_from_ep") before releasing
the private spinlock and returning.

int usb_hcd_check_unlink_urb(struct usb_hcd \*hcd, struct [urb](usb.md#c.usb_core.usb_hcd_check_unlink_urb "urb") \*urb, int status)
...
void usb_hcd_unlink_urb_from_ep(struct usb_hcd \*hcd, struct [urb](usb.md#c.usb_core.usb_hcd_unlink_urb_from_ep "urb") \*urb)
...
[`usb_hcd_giveback_urb()`](usb.md#c.usb_core.usb_hcd_giveback_urb "usb_core.usb_hcd_giveback_urb"). The HCD’s private spinlock must be held and
interrupts must be disabled. The actions carried out here are required
for URB completion.

void usb_hcd_giveback_urb(struct usb_hcd \*hcd, struct [urb](usb.md#c.usb_core.usb_hcd_giveback_urb "urb") \*urb, int status)
...
Disconnects the root hub, then reverses the effects of [`usb_add_hcd()`](usb.md#c.usb_core.usb_add_hcd "usb_core.usb_add_hcd"),
...
Reverses the effect of [`usb_hcd_pci_probe()`](usb.md#c.usb_core.usb_hcd_pci_probe "usb_core.usb_hcd_pci_probe"), first invoking
...
Call [`hcd_buffer_destroy()`](usb.md#c.usb_core.hcd_buffer_destroy "usb_core.hcd_buffer_destroy") to clean up after using those pools.
...
This frees the buffer pools created by [`hcd_buffer_create()`](usb.md#c.usb_core.hcd_buffer_create "usb_core.hcd_buffer_create").
