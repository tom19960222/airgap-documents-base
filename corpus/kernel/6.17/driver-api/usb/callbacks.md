...
collection: kernel
version: "6.17"
title: "USB core callbacks"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/usb/callbacks.html
...
completion callback can be found in [USB Request Block (URB)](URB.md#usb-urb).
...
separately in [Power Management for USB](power-management.md#usb-power-management).
...
[`usb_set_intfdata()`](usb.md#c.usb_set_intfdata "usb_set_intfdata"), to associate a data structure with an interface, so
