...
version: "6.17"
title: "USB DMA"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/usb/dma.html
fetched_at: 2026-09-16T16:36:50+00:00
---
# USB DMA
...
[Dynamic DMA mapping Guide](../../core-api/dma-api-howto.md)). That’s how they’ve worked through
...
- If you’re doing lots of small data transfers from the same buffer all
  ...
  [`kmalloc()`](../../core-api/mm-api.md#c.kmalloc "kmalloc") will work just fine.

  The memory buffer returned is “dma-coherent”; sometimes you might need to
  force a consistent memory access ordering by using memory barriers. It’s
  not using a streaming DMA mapping, so it’s good for small transfers on
  systems where the I/O would otherwise thrash an IOMMU mapping. (See
  [Dynamic DMA mapping Guide](../../core-api/dma-api-howto.md) for definitions of “coherent” and
...
of [Dynamic DMA mapping Guide](../../core-api/dma-api-howto.md), titled “What memory is DMA-able?”)
