...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/device-io.html
fetched_at: 2026-09-16T16:19:41+00:00
---
...
> for mapping PCI I/O space with [`pci_iomap()`](pci/pci.md#c.pci_iomap "pci_iomap") or `ioport_map()`. On architectures
...
>
> There are no direct 64-bit I/O port accessors, but [`pci_iomap()`](pci/pci.md#c.pci_iomap "pci_iomap") in combination
...
[`pci_iomap()`](pci/pci.md#c.pci_iomap "pci_iomap"), [`pci_iomap_wc()`](pci/pci.md#c.pci_iomap_wc "pci_iomap_wc")
...
[`pcim_iomap()`](pci/pci.md#c.pcim_iomap "pcim_iomap")

> Like [`pci_iomap()`](pci/pci.md#c.pci_iomap "pci_iomap"), but uses devres to automatically unmap the resource when
...
look at [`pci_iomap()`](pci/pci.md#c.pci_iomap "pci_iomap").
