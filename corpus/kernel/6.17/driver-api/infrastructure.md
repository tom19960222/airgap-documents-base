...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/infrastructure.html
fetched_at: 2026-09-16T16:19:37+00:00
---
...
Like [`DEVICE_ULONG_ATTR()`](infrastructure.md#c.DEVICE_ULONG_ATTR "DEVICE_ULONG_ATTR"), but **_var** is a string. Because the length of the
...
struct [device](infrastructure.md#c.device "device") \*driver_find_device_by_name(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, const char \*name)
...
struct [device](infrastructure.md#c.device "device") \*driver_find_device_by_of_node(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, const struct device_node \*np)
...
struct [device](infrastructure.md#c.device "device") \*driver_find_device_by_devt(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, dev_t devt)
...
struct [device](infrastructure.md#c.device "device") \*driver_find_device_by_acpi_dev(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, const struct acpi_device \*adev)
...
int driver_for_each_device(struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, struct [device](infrastructure.md#c.device "device") \*start, void \*data, device_iter_t fn)
...
struct [device](infrastructure.md#c.device "device") \*driver_find_device(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, struct [device](infrastructure.md#c.device "device") \*start, const void \*data, device_match_t match)
...
int driver_create_file(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, const struct driver_attribute \*attr)
...
void driver_remove_file(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, const struct driver_attribute \*attr)
...
int device_for_each_child(struct [device](infrastructure.md#c.device "device") \*parent, void \*data, device_iter_t fn)
...
int device_for_each_child_reverse(struct [device](infrastructure.md#c.device "device") \*parent, void \*data, device_iter_t fn)
...
int device_for_each_child_reverse_from(struct [device](infrastructure.md#c.device "device") \*parent, struct [device](infrastructure.md#c.device "device") \*from, void \*data, device_iter_t fn)
:   device child iterator in reversed order.
...
[`device_for_each_child_reverse()`](infrastructure.md#c.device_for_each_child_reverse "device_for_each_child_reverse") when **from** is NULL.

**fn** is checked each iteration. If it returns anything other than 0,
iteration stop and that value is returned to the caller of
[`device_for_each_child_reverse_from()`](infrastructure.md#c.device_for_each_child_reverse_from "device_for_each_child_reverse_from");

struct [device](infrastructure.md#c.device "device") \*device_find_child(struct [device](infrastructure.md#c.device "device") \*parent, const void \*data, device_match_t match)
:   device iterator for locating a particular device.
...
int dev_warn_probe(const struct [device](infrastructure.md#c.device "device") \*dev, int err, const char \*fmt, ...)
:   probe error check and log helper
...
void device_remove_of_node(struct [device](infrastructure.md#c.device "device") \*dev)
:   Remove an of_node from a device
...
int device_add_of_node(struct [device](infrastructure.md#c.device "device") \*dev, struct device_node \*of_node)
...
int class_for_each_device(const struct [class](infrastructure.md#c.class_for_each_device "class") \*class, const struct [device](infrastructure.md#c.device "device") \*start, void \*data, device_iter_t fn)
:   device iterator
...
struct [device](infrastructure.md#c.device "device") \*class_find_device(const struct [class](infrastructure.md#c.class_find_device "class") \*class, const struct [device](infrastructure.md#c.device "device") \*start, const void \*data, device_match_t match)
:   device iterator for locating a particular device
...
int class_compat_create_link(struct class_compat \*cls, struct [device](infrastructure.md#c.device "device") \*dev)
...
void class_compat_remove_link(struct class_compat \*cls, struct [device](infrastructure.md#c.device "device") \*dev)
...
`dev`
:   internal [`struct device`](infrastructure.md#c.device "device") of the object
...
:   a set of callbacks for a [`struct faux_device`](infrastructure.md#c.faux_device "faux_device")
...
struct [faux_device](infrastructure.md#c.faux_device "faux_device") \*faux_device_create_with_groups(const char \*name, struct [device](infrastructure.md#c.device "device") \*parent, const struct [faux_device_ops](infrastructure.md#c.faux_device_ops "faux_device_ops") \*faux_ops, const struct attribute_group \*\*groups)
...
`struct device *parent`
:   Pointer to a potential parent [`struct device`](infrastructure.md#c.device "device"). If set to
    NULL, the device will be created in the “root” of the faux
    device tree in sysfs.

`const struct faux_device_ops *faux_ops`
:   [`struct faux_device_ops`](infrastructure.md#c.faux_device_ops "faux_device_ops") that the new device will call back
    into, can be NULL.
...
- pointer to a valid [`struct faux_device`](infrastructure.md#c.faux_device "faux_device") that is registered with sysfs

struct [faux_device](infrastructure.md#c.faux_device "faux_device") \*faux_device_create(const char \*name, struct [device](infrastructure.md#c.device "device") \*parent, const struct [faux_device_ops](infrastructure.md#c.faux_device_ops "faux_device_ops") \*faux_ops)
...
void faux_device_destroy(struct [faux_device](infrastructure.md#c.faux_device "faux_device") \*faux_dev)
...
[`faux_device_create()`](infrastructure.md#c.faux_device_create "faux_device_create")
...
bool device_is_bound(struct [device](infrastructure.md#c.device "device") \*dev)
...
int device_driver_attach(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv, struct [device](infrastructure.md#c.device "device") \*dev)
...
int driver_attach(const struct [device_driver](infrastructure.md#c.device_driver "device_driver") \*drv)
...
int bus_for_each_dev(const struct [bus_type](infrastructure.md#c.bus_type "bus_type") \*bus, struct [device](infrastructure.md#c.device "device") \*start, void \*data, device_iter_t fn)
:   device iterator.
...
struct [device](infrastructure.md#c.device "device") \*bus_find_device(const struct [bus_type](infrastructure.md#c.bus_type "bus_type") \*bus, struct [device](infrastructure.md#c.device "device") \*start, const void \*data, device_match_t match)
:   device iterator for locating a particular device.
...
bool dma_need_unmap(struct [device](infrastructure.md#c.device "device") \*dev)
:   does this device need dma_unmap_\* operations
...
`dma_addr`
:   DMA handle set by dma_alloc_coherent, used with
...
`dma_device`
:   device `struct that` was passed to dma_alloc_coherent,
