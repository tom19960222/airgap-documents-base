...
collection: kernel
version: "6.17"
title: "VFIO - “Virtual Function I/O” [ 1 ]"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/vfio.html
fetched_at: 2026-09-16T16:19:46+00:00
---
# VFIO - “Virtual Function I/O” [[1]](vfio.md#id7)
...
safe [[2]](vfio.md#id8), non-privileged, userspace drivers.
...
bare-metal device drivers [[3]](vfio.md#id9).
...
This device is behind a PCIe-to-PCI bridge [[4]](vfio.md#id10), therefore we also
...
features (nested translation [[5]](vfio.md#id11), PASID [[6]](vfio.md#id12), etc.) while also providing
...
“safe” also depends upon a device being “well behaved”. It’s
...
In this case the device is below a PCI bridge, so transactions
...
Nested translation is an IOMMU feature which supports two stage
address translations. This improves the address translation efficiency
in IOMMU virtualization.

[[6](vfio.md#id6)]

PASID stands for Process Address Space ID, introduced by PCI
