...
collection: kernel
version: "6.17"
title: "EISA bus support"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/eisa.html
fetched_at: 2026-09-16T16:19:49+00:00
---
# EISA bus support

Author:
:   Marc Zyngier <[maz@wild-wind.fr.eu.org](mailto:maz%40wild-wind.fr.eu.org)>
...
| driver | a generic driver, such as described in [Device Drivers](driver-model/driver.md). Only .name, .probe and .remove members are mandatory. |
...
Both functions are passed a pointer to a ‘[`struct device`](infrastructure.md#c.device "device")’, which is
...
| dev | generic device (see [The Basic Device Structure](driver-model/device.md)) |

You can get the ‘`struct eisa_device`’ from ‘[`struct device`](infrastructure.md#c.device "device")’ using the
