...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/w1.html
...
`read_byte`
:   Reads a byte. Same as 8 touch_bit(1) calls.
...
`search`
:   Really nice hardware can handle the different types of ROM search
