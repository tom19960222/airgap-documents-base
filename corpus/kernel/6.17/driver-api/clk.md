...
collection: kernel
version: "6.17"
title: "The Common Clk Framework"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/clk.html
fetched_at: 2026-09-16T16:19:59+00:00
---
# The Common Clk Framework

Author:
:   Mike Turquette <[mturquette@ti.com](mailto:mturquette%40ti.com)>
...
|  |  |  |  |  |  |
| .recalc_rate |  | y |  |  |  |
| .round_rate |  | y [[1]](clk.md#id3) |  |  |  |
| .determine_rate |  | y [[1]](clk.md#id3) |  |  |  |
| .set_rate |  | y |  |  |  |
|  |  |  |  |  |  |
| .set_parent |  |  | n | y | n |
| .get_parent |  |  | n | y | n |
...
[1]
([1](clk.md#id1),[2](clk.md#id2))

either one of round_rate or determine_rate is required.
...
and calls to the [`clk_enable()`](../core-api/kernel-api.md#c.clk_enable "clk_enable"), [`clk_disable()`](../core-api/kernel-api.md#c.clk_disable "clk_disable") API functions are allowed in
atomic context.
