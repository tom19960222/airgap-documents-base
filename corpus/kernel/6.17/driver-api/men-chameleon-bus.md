...
collection: kernel
version: "6.17"
title: "MEN Chameleon Bus"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/men-chameleon-bus.html
fetched_at: 2026-09-16T16:19:51+00:00
---
# MEN Chameleon Bus
...
inside the carrier and is intended to be passed to [`ioremap()`](device-io.md#c.ioremap "ioremap") and friends. It
...
number is suitable to be passed to [`request_irq()`](../core-api/genericirq.md#c.request_irq "request_irq").
...
carrier device’s ‘[`struct device`](infrastructure.md#c.device "device")’. Fortunately ‘`struct mcb_device`’ embeds a
