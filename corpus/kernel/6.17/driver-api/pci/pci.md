...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/pci/pci.html
...
:   managed [`pci_intx()`](pci.md#c.pci_intx "pci_intx")
...
Managed [`pci_enable_device()`](pci.md#c.pci_enable_device "pci_enable_device"). Device will automatically be disabled on
driver detach.
...
detach. **pdev** must have been enabled with [`pcim_enable_device()`](pci.md#c.pcim_enable_device "pcim_enable_device").
...
:   Managed [`pcim_iomap()`](pci.md#c.pcim_iomap "pcim_iomap")
...
Managed [`pci_iomap()`](pci.md#c.pci_iomap "pci_iomap"). Map is automatically unmapped on driver detach. If
desired, unmap manually only with [`pcim_iounmap()`](pci.md#c.pcim_iounmap "pcim_iounmap").
...
desired, release manually only with [`pcim_iounmap_region()`](pci.md#c.pcim_iounmap_region "pcim_iounmap_region").
...
previously mapped by [`pcim_iomap_region()`](pci.md#c.pcim_iomap_region "pcim_iomap_region").
...
Use [`pcim_iomap_region()`](pci.md#c.pcim_iomap_region "pcim_iomap_region") instead.
...
release manually only with [`pcim_iounmap()`](pci.md#c.pcim_iounmap "pcim_iounmap").
...
means that following calls to [`pci_enable_sriov()`](pci.md#c.pci_enable_sriov "pci_enable_sriov") can fail if the resources
no longer fit.
...
ssize_t pci_read_legacy_io(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*bin_attr, char \*buf, loff_t off, size_t count)
...
ssize_t pci_write_legacy_io(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*bin_attr, char \*buf, loff_t off, size_t count)
...
int pci_mmap_legacy_mem(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*attr, struct vm_area_struct \*vma)
...
int pci_mmap_legacy_io(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*attr, struct vm_area_struct \*vma)
...
ssize_t pci_write_rom(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*bin_attr, char \*buf, loff_t off, size_t count)
...
ssize_t pci_read_rom(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp, struct kobject \*kobj, const struct bin_attribute \*bin_attr, char \*buf, loff_t off, size_t count)
:   read a PCI ROM
