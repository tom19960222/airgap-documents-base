...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/regulator.html
...
`init_cb`
:   Optional callback called after the parsing of init_data.
...
:   A flag to indicate that changes to vsel_range_reg
...
producer, or an [`ERR_PTR()`](../core-api/kernel-api.md#c.ERR_PTR "ERR_PTR") encoded negative error number.
...
Voltage for **selector** that can be passed to [`regulator_set_voltage()`](regulator.md#c.regulator_set_voltage "regulator_set_voltage"),
0 if **selector** can’t be used on this system, or a negative error
number on failure.

struct regmap \*regulator_get_regmap(struct [regulator](regulator.md#c.regulator_get_regmap "regulator") \*regulator)
...
Pointer to the `struct regmap` for **regulator**, or [`ERR_PTR()`](../core-api/kernel-api.md#c.ERR_PTR "ERR_PTR")
...
int regulator_hardware_enable(struct [regulator](regulator.md#c.regulator_hardware_enable "regulator") \*regulator, bool enable)
...
int regulator_get_unclaimed_power_budget(struct [regulator](regulator.md#c.regulator_get_unclaimed_power_budget "regulator") \*regulator)
...
int regulator_request_power_budget(struct [regulator](regulator.md#c.regulator_request_power_budget "regulator") \*regulator, unsigned int pw_req)
...
void regulator_free_power_budget(struct [regulator](regulator.md#c.regulator_free_power_budget "regulator") \*regulator, unsigned int pw)
...
an [`ERR_PTR()`](../core-api/kernel-api.md#c.ERR_PTR "ERR_PTR") encoded negative error number on failure.
