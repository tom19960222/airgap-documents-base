...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/gpio/index.html
fetched_at: 2026-09-16T16:20:07+00:00
---
English
...
:   Required for static IRQ allocation. If set,
    [`irq_domain_create_simple()`](../../core-api/irq/irq-domain.md#c.irq_domain_create_simple "irq_domain_create_simple") will allocate and map all IRQs
...
`bgpio_pinctrl`
:   the generic GPIO uses a pin control backend.
...
const unsigned long \*gpiochip_query_valid_mask(const struct [gpio_chip](index.md#c.gpio_chip "gpio_chip") \*gc)
...
struct gpio_device \*gpio_device_find(const void \*data, int (\*match)(struct [gpio_chip](index.md#c.gpio_chip "gpio_chip") \*gc, const void \*data))
...
int gpiochip_irqchip_add_domain(struct [gpio_chip](index.md#c.gpio_chip "gpio_chip") \*gc, struct [irq_domain](../../core-api/irq/irq-domain.md#c.irq_domain "irq_domain") \*domain)
...
or another [`IS_ERR()`](../../core-api/kernel-api.md#c.IS_ERR "IS_ERR") code if an error occurred while trying to acquire
the GPIOs.
