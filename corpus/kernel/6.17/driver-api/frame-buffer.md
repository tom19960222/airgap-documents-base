...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/frame-buffer.html
...
int devm_register_framebuffer(struct [device](infrastructure.md#c.device "device") \*dev, struct [fb_info](frame-buffer.md#c.devm_register_framebuffer "fb_info") \*fb_info)
