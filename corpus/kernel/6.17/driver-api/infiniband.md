...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/infiniband.html
...
struct ib_device \*_ib_alloc_device(size_t size, struct [net](infiniband.md#c._ib_alloc_device "net") \*net)
...
:   network namespace device should be located in, namespace
    must stay valid until [`ib_register_device()`](infiniband.md#c.ib_register_device "ib_register_device") is completed.
...
int ib_query_netdev_port(struct ib_device \*ibdev, struct [net_device](../networking/kapi.md#c.net_device "net_device") \*ndev, u32 \*port)
