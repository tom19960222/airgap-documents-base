...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/i3c/master-driver-api.html
...
the private data previously attached with [`i3c_dev_set_master_data()`](master-driver-api.md#c.i3c_dev_set_master_data "i3c_dev_set_master_data")
...
the private data previously attached with [`i2c_dev_set_master_data()`](master-driver-api.md#c.i2c_dev_set_master_data "i2c_dev_set_master_data")
or NULL if no data has been attached to the device.
