...
version: "6.17"
title: "TTY Port"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/tty/tty_port.html
fetched_at: 2026-09-16T16:29:41+00:00
---
# TTY Port
...
int tty_port_block_til_ready(struct [tty_port](tty_port.md#c.tty_port "tty_port") \*port, struct [tty_struct](tty_struct.md#c.tty_struct "tty_struct") \*tty, struct [file](../../filesystems/api-summary.md#c.file "file") \*filp)
...
int tty_port_close_start(struct [tty_port](tty_port.md#c.tty_port "tty_port") \*port, struct [tty_struct](tty_struct.md#c.tty_struct "tty_struct") \*tty, struct [file](../../filesystems/api-summary.md#c.file "file") \*filp)
...
void tty_port_close(struct [tty_port](tty_port.md#c.tty_port "tty_port") \*port, struct [tty_struct](tty_struct.md#c.tty_struct "tty_struct") \*tty, struct [file](../../filesystems/api-summary.md#c.file "file") \*filp)
...
int tty_port_open(struct [tty_port](tty_port.md#c.tty_port "tty_port") \*port, struct [tty_struct](tty_struct.md#c.tty_struct "tty_struct") \*tty, struct [file](../../filesystems/api-summary.md#c.file "file") \*filp)
...
void tty_port_tty_vhangup(struct [tty_port](tty_port.md#c.tty_port "tty_port") \*port)
