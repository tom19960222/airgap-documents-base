...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/tty/tty_driver.html
fetched_at: 2026-09-16T16:27:00+00:00
---
...
is done by [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver") (or [`__tty_alloc_driver()`](tty_driver.md#c.__tty_alloc_driver "__tty_alloc_driver")). Next, the newly
...
`flags`
:   some of [`enum tty_driver_flag`](tty_driver.md#c.tty_driver_flag "tty_driver_flag"), will be set in driver->flags

**Return**

[`struct tty_driver`](tty_driver.md#c.tty_driver "tty_driver") or a PTR-encoded error (use [`IS_ERR()`](../../core-api/kernel-api.md#c.IS_ERR "IS_ERR") and friends).
...
This should not be called directly, [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver") should be used
instead.
...
Here comes the documentation of flags accepted by [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver") (or
...
These are flags passed to [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver").
...
flags of [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver"). If it is not passed, *all* devices are also
...
Unless `TTY_DRIVER_DYNAMIC_DEV` was passed as flags to [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver"),
...
register more devices than passed to [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver").
...
:   modules owning this driver. Used drivers cannot be rmmod’ed.
    Automatically set by [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver").
...
[`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver"), set up all the necessary members, and register it by
...
>
> If the driver sets `TTY_DRIVER_HARDWARE_BREAK` in [`tty_alloc_driver()`](tty_driver.md#c.tty_alloc_driver "tty_alloc_driver"),
...
>
> kgdboc support ([Using kgdb, kdb and the kernel debugger internals](../../process/debugging/kgdb.md)). This routine is
