...
collection: kernel
version: "6.17"
title: "SPI NOR framework"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/mtd/spi-nor.html
...
3. Dump debugfs data:
   ...
   ```
4. Use [mtd-utils](https://git.infradead.org/mtd-utils.git)
