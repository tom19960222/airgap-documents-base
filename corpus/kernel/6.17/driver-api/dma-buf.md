...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/dma-buf.html
fetched_at: 2026-09-16T16:19:42+00:00
---
...
[ABI file testing/sysfs-kernel-dmabuf-buffers](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-kernel-dmabuf-buffers).
...
:   This callback is used by the [`dma_buf_mmap()`](dma-buf.md#c.dma_buf_mmap "dma_buf_mmap") function
    ...
    address_space`](../filesystems/api-summary.md#c.address_space "address_space") associated with the [`struct file`](../filesystems/api-summary.md#c.file "file") stored in vma->vm_file
    to do that with the function unmap_mapping_range. But the dma_buf
    framework only backs every dma_buf fd with the anon_file [`struct file`](../filesystems/api-summary.md#c.file "file"),
...
this reason prefer the locked [`dma_resv_iter_first()`](dma-buf.md#c.dma_resv_iter_first "dma_resv_iter_first") whenever possible.
...
Beware that the iterator can be restarted. Code which accumulates statistics
or similar needs to check for this with [`dma_resv_iter_is_restarted()`](dma-buf.md#c.dma_resv_iter_is_restarted "dma_resv_iter_is_restarted"). For
this reason prefer the locked [`dma_resv_iter_next()`](dma-buf.md#c.dma_resv_iter_next "dma_resv_iter_next") whenever possible.
...
void dma_fence_init64(struct [dma_fence](dma-buf.md#c.dma_fence "dma_fence") \*fence, const struct [dma_fence_ops](dma-buf.md#c.dma_fence_ops "dma_fence_ops") \*ops, spinlock_t \*lock, u64 context, u64 seqno)
...
const char __rcu \*dma_fence_driver_name(struct [dma_fence](dma-buf.md#c.dma_fence "dma_fence") \*fence)
...
directly embedded into the object itself), such as the [`dma_fence.lock`](dma-buf.md#c.dma_fence "dma_fence") and
memory potentially accessed by the [`dma_fence.ops`](dma-buf.md#c.dma_fence "dma_fence") functions, is forbidden
...
by the [`rcu_read_lock`](../core-api/kernel-api.md#c.rcu_read_lock "rcu_read_lock") and [`rcu_read_unlock`](../core-api/kernel-api.md#c.rcu_read_unlock "rcu_read_unlock") pair.

const char __rcu \*dma_fence_timeline_name(struct [dma_fence](dma-buf.md#c.dma_fence "dma_fence") \*fence)
...
bool __dma_fence_is_later(struct [dma_fence](dma-buf.md#c.dma_fence "dma_fence") \*fence, u64 f1, u64 f2)
...
struct [dma_fence_array](dma-buf.md#c.dma_fence_array "dma_fence_array") \*dma_fence_array_alloc(int num_fences)
...
void dma_fence_array_init(struct [dma_fence_array](dma-buf.md#c.dma_fence_array "dma_fence_array") \*array, int num_fences, struct [dma_fence](dma-buf.md#c.dma_fence "dma_fence") \*\*fences, u64 context, unsigned seqno, bool signal_on_any)
