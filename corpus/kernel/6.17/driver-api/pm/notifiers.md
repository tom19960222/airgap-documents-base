...
collection: kernel
version: "6.17"
title: "Suspend/Hibernation Notifiers"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/pm/notifiers.html
...
resume/restore, but they cannot do it by calling [`request_firmware()`](../firmware/request_firmware.md#c.request_firmware "request_firmware")
...
The hibernation and suspend notifiers are called with `pm_mutex` held.
...
`register_pm_notifier()` and `unregister_pm_notifier()`,
respectively (both defined in `include/linux/suspend.h`). If you don’t
