...
version: "6.17"
title: "ISA Drivers"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/isa.html
...
[`struct device_driver`](infrastructure.md#c.device_driver "device_driver"), the normal probe/remove/shutdown/suspend/resume
...
[`struct device`](infrastructure.md#c.device "device") anyways, and it makes for nicer code in the callbacks as
well.
...
`isa_register_driver()` register’s the [`struct device_driver`](infrastructure.md#c.device_driver "device_driver"), and then
