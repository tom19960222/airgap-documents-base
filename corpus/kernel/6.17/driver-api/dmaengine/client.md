...
collection: kernel
version: "6.17"
title: "DMA Engine API Guide"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/dmaengine/client.html
fetched_at: 2026-09-16T16:36:59+00:00
---
...
> **Note:**
>
> For DMA Engine usage in async_tx please see:
...
> The scatterlist must be mapped using the DMA [`struct device`](../infrastructure.md#c.device "device").
> If a mapping needs to be synchronized later, dma_sync_\*_for_\*() must be
> called using the DMA [`struct device`](../infrastructure.md#c.device "device"), too.
