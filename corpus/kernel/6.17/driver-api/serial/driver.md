...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/serial/driver.html
fetched_at: 2026-09-16T16:29:10+00:00
---
...
decoding command line arguments ([`uart_parse_options()`](driver.md#c.uart_parse_options "uart_parse_options")).
...
int uart_set_options(struct uart_port \*port, struct [console](../tty/console.md#c.console "console") \*co, int baud, int parity, int bits, int flow)
