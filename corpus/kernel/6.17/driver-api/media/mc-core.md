...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/mc-core.html
fetched_at: 2026-09-16T16:26:52+00:00
---
...
Once a pipeline has been constructed with [`media_pipeline_start()`](mc-core.md#c.media_pipeline_start "media_pipeline_start"),
...
struct [media_devnode](mc-core.md#c.media_devnode "media_devnode") \*media_devnode_data(struct [file](../../filesystems/api-summary.md#c.file "file") \*filp)
...
int media_pipeline_start(struct [media_pad](mc-core.md#c.media_pad "media_pad") \*origin, struct [media_pipeline](mc-core.md#c.media_pipeline "media_pipeline") \*pipe)
...
int __media_pipeline_start(struct [media_pad](mc-core.md#c.media_pad "media_pad") \*origin, struct [media_pipeline](mc-core.md#c.media_pipeline "media_pipeline") \*pipe)
:   Mark a pipeline as streaming
...
:   Release media device. Calls [`kref_put()`](../../core-api/kref.md#c.kref_put "kref_put").
