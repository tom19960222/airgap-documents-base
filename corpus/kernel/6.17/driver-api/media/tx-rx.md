...
collection: kernel
version: "6.17"
title: "7. Pixel data transmitter and receiver drivers"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/tx-rx.html
fetched_at: 2026-09-16T16:35:13+00:00
---
...
See [Media Bus Pixel Codes](../../userspace-api/media/v4l/subdev-formats.md#v4l2-mbus-pixelcode).

### 7.2.2. Link frequency

The [V4L2_CID_LINK_FREQ](../../userspace-api/media/v4l/ext-ctrls-image-process.md#v4l2-cid-link-freq) control is used to tell the
...
field of [`struct v4l2_mbus_config`](v4l2-mediabus.md#c.v4l2_mbus_config "v4l2_mbus_config"), instead of through controls.

Receiver drivers should use [`v4l2_get_link_freq()`](v4l2-common.md#c.v4l2_get_link_freq "v4l2_get_link_freq") helper to obtain the
link frequency from the transmitter sub-device.

### 7.2.3. `.enable_streams()` and `.disable_streams()` callbacks

The [`struct v4l2_subdev_pad_ops`](v4l2-subdev.md#c.v4l2_subdev_pad_ops "v4l2_subdev_pad_ops")->`enable_streams()` and [`struct
v4l2_subdev_pad_ops`](v4l2-subdev.md#c.v4l2_subdev_pad_ops "v4l2_subdev_pad_ops")->`disable_streams()` callbacks are used by the receiver driver
...
| nr_of_lanes | Number of data lanes used on the CSI-2 link. |
...
> [V4L2_CID_PIXEL_RATE](../../userspace-api/media/v4l/ext-ctrls-image-process.md#v4l2-cid-pixel-rate) control.
