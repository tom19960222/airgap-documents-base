...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/v4l2-controls.html
fetched_at: 2026-09-16T16:27:02+00:00
---
# 2.15. V4L2 Controls
...
[`v4l2_ctrl_handler_free()`](v4l2-controls.md#c.v4l2_ctrl_handler_free "v4l2_ctrl_handler_free") does not touch the handler’s `error` field.
...
int v4l2_ctrl_handler_free(struct [v4l2_ctrl_handler](v4l2-controls.md#c.v4l2_ctrl_handler "v4l2_ctrl_handler") \*hdl)
...
Same as [`v4l2_ctrl_new_std()`](v4l2-controls.md#c.v4l2_ctrl_new_std "v4l2_ctrl_new_std"), but with support for compound controls.
To fill in the **p_def**, **p_min** and **p_max** fields, use [`v4l2_ctrl_ptr_create()`](v4l2-controls.md#c.v4l2_ctrl_ptr_create "v4l2_ctrl_ptr_create")
to convert a pointer to a const [`union v4l2_ctrl_ptr`](v4l2-controls.md#c.v4l2_ctrl_ptr "v4l2_ctrl_ptr").
...
`struct file *file`
:   pointer to [`struct file`](../../filesystems/api-summary.md#c.file "file")
...
void v4l2_query_ext_ctrl_to_v4l2_queryctrl(struct [v4l2_queryctrl](v4l2-controls.md#c.v4l2_queryctrl "v4l2_queryctrl") \*to, const struct [v4l2_query_ext_ctrl](v4l2-controls.md#c.v4l2_query_ext_ctrl "v4l2_query_ext_ctrl") \*from)
:   Convert a qec to qe.
