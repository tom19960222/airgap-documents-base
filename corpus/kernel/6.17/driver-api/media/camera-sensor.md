...
collection: kernel
version: "6.17"
title: "8. Writing camera sensor drivers"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/camera-sensor.html
fetched_at: 2026-09-16T16:29:20+00:00
---
# 8. Writing camera sensor drivers

This document covers the in-kernel APIs only. For the best practices on
userspace API implementation in camera sensor drivers, please see
[Using camera sensor drivers](../../userspace-api/media/drivers/camera-sensor.md#media-using-camera-sensor-drivers).

## 8.1. CSI-2, parallel and BT.656 buses

Please see [Pixel data transmitter and receiver drivers](tx-rx.md#transmitter-receiver).
...
[clock device tree bindings](https://github.com/devicetree-org/dt-schema/blob/main/dtschema/schemas/clock/clock.yaml)
...
[async sub-device registration](v4l2-subdev.md#media-registering-async-subdevs).
...
Please also see [examples](camera-sensor.md#media-camera-sensor-examples).
...
int pm_runtime_get_if_in_use(struct [device](../infrastructure.md#c.device "device") \*dev);
