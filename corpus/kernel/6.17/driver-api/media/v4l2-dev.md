...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/v4l2-dev.html
fetched_at: 2026-09-16T16:27:05+00:00
---
...
> ([`struct file`](../../filesystems/api-summary.md#c.file "file") \*file);
...
`__entity`
:   pointer to [`struct media_entity`](mc-core.md#c.media_entity "media_entity"), may be NULL
...
:   gets [`struct video_device`](v4l2-dev.md#c.video_device "video_device") from [`struct file`](../../filesystems/api-summary.md#c.file "file").
...
:   gets private data from [`struct video_device`](v4l2-dev.md#c.video_device "video_device") using the [`struct file`](../../filesystems/api-summary.md#c.file "file").
