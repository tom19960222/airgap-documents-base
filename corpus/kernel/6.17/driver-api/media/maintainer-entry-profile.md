...
collection: kernel
version: "6.17"
title: "1. Media Subsystem Profile"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/maintainer-entry-profile.html
fetched_at: 2026-09-16T16:31:42+00:00
---
...
> - Documentation/devicetree/bindings/media/[[1]](maintainer-entry-profile.md#id2)
> - include/media

[[1](maintainer-entry-profile.md#id1)]

Device tree bindings are maintained by the
...
at [linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org) as plain text only e-mail. Emails with
...
email is in plain text[[2]](maintainer-entry-profile.md#id4) only and if your emailer is not mangling
...
[[2](maintainer-entry-profile.md#id3)]

If your email contains HTML, the mailing list server will simply
...
- Remote Controllers (infrared):
  :   Sean Young <[sean@mess.org](mailto:sean%40mess.org)>
- HDMI CEC:
  :   Hans Verkuil <[hverkuil@xs4all.nl](mailto:hverkuil%40xs4all.nl)>
- Media controller drivers:
  :   Laurent Pinchart <[laurent.pinchart@ideasonboard.com](mailto:laurent.pinchart%40ideasonboard.com)>
- ISP, v4l2-async, v4l2-fwnode, v4l2-flash-led-class and Sensor drivers:
  :   Sakari Ailus <[sakari.ailus@linux.intel.com](mailto:sakari.ailus%40linux.intel.com)>
- V4L2 drivers and core V4L2 frameworks:
  :   Hans Verkuil <[hverkuil@xs4all.nl](mailto:hverkuil%40xs4all.nl)>

The subsystem maintainer is:
:   Mauro Carvalho Chehab <[mchehab@kernel.org](mailto:mchehab%40kernel.org)>
...
| Type | Tool |
| --- | --- |
| V4L2 drivers[[3]](maintainer-entry-profile.md#id6) | `v4l2-compliance` |
| V4L2 virtual drivers | `contrib/test/test-media` |
| CEC drivers | `cec-compliance` |

[[3](maintainer-entry-profile.md#id5)]

The `v4l2-compliance` also covers the media controller usage inside
V4L2 drivers.
