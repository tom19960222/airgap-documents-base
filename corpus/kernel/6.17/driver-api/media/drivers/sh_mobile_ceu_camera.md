...
collection: kernel
version: "6.17"
title: "9.1.10. Cropping and Scaling algorithm, used in the sh_mobile_ceu_camera driver"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/drivers/sh_mobile_ceu_camera.html
fetched_at: 2026-09-16T16:37:24+00:00
---
...
## 9.1.10.1. Terminology

sensor scales: horizontal and vertical scales, configured by the sensor driver
host scales: -”- host driver
combined scales: sensor_scale \* host_scale

## 9.1.10.2. Generic scaling / cropping scheme
...
The [V4L2 crop API](../../../userspace-api/media/v4l/crop.md#crop-scale) says:
