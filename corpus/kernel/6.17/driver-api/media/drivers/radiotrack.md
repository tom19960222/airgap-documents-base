...
collection: kernel
version: "6.17"
title: "9.1.7. The Radiotrack radio driver"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/drivers/radiotrack.html
fetched_at: 2026-09-16T16:37:22+00:00
---
# 9.1.7. The Radiotrack radio driver

Author: Stephen M. Benoit <[benoits@servicepro.com](mailto:benoits%40servicepro.com)>

Date: Dec 14, 1996

## 9.1.7.1. ACKNOWLEDGMENTS

This document was made based on ‘C’ code for Linux from Gideon le Grange
([legrang@active.co.za](mailto:legrang%40active.co.za) or [legrang@cs.sun.ac.za](mailto:legrang%40cs.sun.ac.za)) in 1994, and elaborations from
Frans Brinkman ([brinkman@esd.nl](mailto:brinkman%40esd.nl)) in 1996. The results reported here are from
...
## 9.1.7.4. CONTROLLING THE CARD WITH IOPORT
