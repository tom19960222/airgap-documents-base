...
collection: kernel
version: "6.17"
title: "9.1.6. PXA-Camera Host Driver"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/drivers/pxa_camera.html
fetched_at: 2026-09-16T16:37:21+00:00
---
# 9.1.6. PXA-Camera Host Driver

Author: Robert Jarzmik <[robert.jarzmik@free.fr](mailto:robert.jarzmik%40free.fr)>

## 9.1.6.1. Constraints

1. Image size for YUV422P format
   All YUV422P images are enforced to have width x height % 16 = 0.
   This is due to DMA constraints, which transfers only planes of 8 byte
   multiples.

## 9.1.6.2. Global video workflow
