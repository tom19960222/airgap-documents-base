...
collection: kernel
version: "6.17"
title: "9.2.1. Idea behind the dvb-usb-framework"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/drivers/dvb-usb.html
fetched_at: 2026-09-16T16:37:25+00:00
---
# 9.2.1. Idea behind the dvb-usb-framework

> **Note:**
>
> 1. This documentation is outdated. Please check at the DVB wiki
...
## 9.2.1.3. Known problems and bugs

- Don’t remove the USB device while running an DVB application, your system
  will go crazy or die most likely.

### 9.2.1.3.1. Adding support for devices

TODO

### 9.2.1.3.2. USB1.1 Bandwidth limitation
...
## 9.2.1.4. 3. Acknowledgements

> Amaury Demol ([Amaury.Demol@parrot.com](mailto:Amaury.Demol%40parrot.com)) and Francois Kanounnikoff from DiBcom for
