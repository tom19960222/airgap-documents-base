...
collection: kernel
version: "6.17"
title: "9.1.16. Intel IPU6 Driver"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/drivers/ipu6.html
fetched_at: 2026-09-16T16:28:56+00:00
---
# 9.1.16. Intel IPU6 Driver

Author: Bingbu Cao <[bingbu.cao@intel.com](mailto:bingbu.cao%40intel.com)>
...
### 9.1.16.2.1. ISYS and PSYS Power flow
...
> **Note:**
>
> ISYS power up needs take place prior to PSYS power up, ISYS power down
> needs take place after PSYS power down due to hardware limitation.

### 9.1.16.2.2. Interrupt
...
### 9.1.16.2.3. Security and firmware authentication
...
### 9.1.16.6.1. D-PHYs and CSI-2 ports lane mapping
...
> **Note:**
>
> Each pair of CSI-2 two ports is a single unit that can share the data
...
> **Note:**
>
> See [Examples](../../../admin-guide/media/ipu6-isys.md#ipu6-isys-capture-examples) about how to do
