...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/media/v4l2-common.html
fetched_at: 2026-09-16T16:30:33+00:00
---
...
struct [v4l2_subdev](v4l2-subdev.md#c.v4l2_subdev "v4l2_subdev") \*v4l2_spi_new_subdev(struct [v4l2_device](v4l2-device.md#c.v4l2_device "v4l2_device") \*v4l2_dev, struct [spi_controller](../spi.md#c.spi_controller "spi_controller") \*ctlr, struct [spi_board_info](../spi.md#c.spi_board_info "spi_board_info") \*info)
...
:   pointer to [`struct spi_controller`](../spi.md#c.spi_controller "spi_controller").
...
`pad`
:   The transmitter’s media pad (or control handler for non-MC users or
...
int v4l2_link_freq_to_bitmap(struct [device](../infrastructure.md#c.device "device") \*dev, const u64 \*fw_link_freqs, unsigned int num_of_fw_link_freqs, const s64 \*driver_link_freqs, unsigned int num_of_driver_link_freqs, unsigned long \*bitmap)
:   Figure out platform-supported link frequencies

**Parameters**

`struct device *dev`
:   The [`struct device`](../infrastructure.md#c.device "device")
...
`vidioc_remove_bufs`
:   pointer to the function that implements
    [VIDIOC_REMOVE_BUFS](../../userspace-api/media/v4l/vidioc-remove-bufs.md#vidioc-remove-bufs) ioctl
