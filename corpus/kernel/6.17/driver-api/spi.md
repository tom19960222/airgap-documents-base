...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/spi.html
fetched_at: 2026-09-16T16:20:36+00:00
---
...
`unoptimize_message`
:   release resources allocated by optimize_message
...
`put_offload`
:   release the offload instance acquired by **get_offload**.
...
`tx_sg_mapped`
:   If true, the **tx_sg** is mapped for DMA

`rx_sg_mapped`
:   If true, the **rx_sg** is mapped for DMA
...
`tx_dma`
:   DMA address of tx_buf, currently not for client use

`rx_dma`
:   DMA address of rx_buf, currently not for client use
...
int spi_target_abort(struct [spi_device](spi.md#c.spi_device "spi_device") \*spi)
:   abort the ongoing transfer request on an SPI target controller
...
struct [spi_controller](spi.md#c.spi_controller "spi_controller") \*__spi_alloc_controller(struct [device](infrastructure.md#c.device "device") \*dev, unsigned int size, bool target)
...
struct [spi_controller](spi.md#c.spi_controller "spi_controller") \*__devm_spi_alloc_controller(struct [device](infrastructure.md#c.device "device") \*dev, unsigned int size, bool target)
...
int spi_split_transfers_maxsize(struct [spi_controller](spi.md#c.spi_controller "spi_controller") \*ctlr, struct [spi_message](spi.md#c.spi_message "spi_message") \*msg, size_t maxsize)
...
int spi_split_transfers_maxwords(struct [spi_controller](spi.md#c.spi_controller "spi_controller") \*ctlr, struct [spi_message](spi.md#c.spi_message "spi_message") \*msg, size_t maxwords)
...
int spi_optimize_message(struct [spi_device](spi.md#c.spi_device "spi_device") \*spi, struct [spi_message](spi.md#c.spi_message "spi_message") \*msg)
...
Calls to this function must be balanced with calls to [`spi_unoptimize_message()`](spi.md#c.spi_unoptimize_message "spi_unoptimize_message")
...
void spi_unoptimize_message(struct [spi_message](spi.md#c.spi_message "spi_message") \*msg)
:   releases any resources allocated by [`spi_optimize_message()`](spi.md#c.spi_optimize_message "spi_optimize_message")
...
Calls to this function must be balanced with calls to [`spi_optimize_message()`](spi.md#c.spi_optimize_message "spi_optimize_message").

**Context**

can sleep

int devm_spi_optimize_message(struct [device](infrastructure.md#c.device "device") \*dev, struct [spi_device](spi.md#c.spi_device "spi_device") \*spi, struct [spi_message](spi.md#c.spi_message "spi_message") \*msg)
:   managed version of [`spi_optimize_message()`](spi.md#c.spi_optimize_message "spi_optimize_message")
...
[`spi_unoptimize_message()`](spi.md#c.spi_unoptimize_message "spi_unoptimize_message") will automatically be called when the device is
removed.
