...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/reset.html
fetched_at: 2026-09-16T16:20:30+00:00
---
...
struct reset_control \*devm_reset_control_get_exclusive_deasserted(struct [device](infrastructure.md#c.device "device") \*dev, const char \*id)
:   resource managed [`reset_control_get_exclusive()`](reset.md#c.reset_control_get_exclusive "reset_control_get_exclusive") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert")
...
Managed [`reset_control_get_exclusive()`](reset.md#c.reset_control_get_exclusive "reset_control_get_exclusive") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert"). For reset
controllers returned from this function, [`reset_control_assert()`](reset.md#c.reset_control_assert "reset_control_assert") +
[`reset_control_put()`](reset.md#c.reset_control_put "reset_control_put") is called automatically on driver detach.
...
struct reset_control \*devm_reset_control_get_shared_deasserted(struct [device](infrastructure.md#c.device "device") \*dev, const char \*id)
:   resource managed [`reset_control_get_shared()`](reset.md#c.reset_control_get_shared "reset_control_get_shared") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert")
...
Managed [`reset_control_get_shared()`](reset.md#c.reset_control_get_shared "reset_control_get_shared") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert"). For reset
controllers returned from this function, [`reset_control_assert()`](reset.md#c.reset_control_assert "reset_control_assert") +
[`reset_control_put()`](reset.md#c.reset_control_put "reset_control_put") is called automatically on driver detach.

See [`devm_reset_control_get_shared()`](reset.md#c.devm_reset_control_get_shared "devm_reset_control_get_shared") for more information.
...
int devm_reset_control_bulk_get_shared_deasserted(struct [device](infrastructure.md#c.device "device") \*dev, int num_rstcs, struct [reset_control_bulk_data](reset.md#c.reset_control_bulk_data "reset_control_bulk_data") \*rstcs)
:   resource managed [`reset_control_bulk_get_shared()`](reset.md#c.reset_control_bulk_get_shared "reset_control_bulk_get_shared") + `reset_control_bulk_deassert()`
...
Managed [`reset_control_bulk_get_shared()`](reset.md#c.reset_control_bulk_get_shared "reset_control_bulk_get_shared") + `reset_control_bulk_deassert()`. For
...
See [`devm_reset_control_bulk_get_shared()`](reset.md#c.devm_reset_control_bulk_get_shared "devm_reset_control_bulk_get_shared") for more information.
...
struct reset_control \*devm_reset_control_get_optional_exclusive_deasserted(struct [device](infrastructure.md#c.device "device") \*dev, const char \*id)
:   resource managed [`reset_control_get_optional_exclusive()`](reset.md#c.reset_control_get_optional_exclusive "reset_control_get_optional_exclusive") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert")
...
Managed [`reset_control_get_optional_exclusive()`](reset.md#c.reset_control_get_optional_exclusive "reset_control_get_optional_exclusive") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert").
For reset controllers returned from this function, [`reset_control_assert()`](reset.md#c.reset_control_assert "reset_control_assert") +
[`reset_control_put()`](reset.md#c.reset_control_put "reset_control_put") is called automatically on driver detach.

See [`devm_reset_control_get_optional_exclusive()`](reset.md#c.devm_reset_control_get_optional_exclusive "devm_reset_control_get_optional_exclusive") for more information.
...
struct reset_control \*devm_reset_control_get_optional_shared_deasserted(struct [device](infrastructure.md#c.device "device") \*dev, const char \*id)
:   resource managed [`reset_control_get_optional_shared()`](reset.md#c.reset_control_get_optional_shared "reset_control_get_optional_shared") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert")
...
Managed [`reset_control_get_optional_shared()`](reset.md#c.reset_control_get_optional_shared "reset_control_get_optional_shared") + [`reset_control_deassert()`](reset.md#c.reset_control_deassert "reset_control_deassert"). For
reset controllers returned from this function, [`reset_control_assert()`](reset.md#c.reset_control_assert "reset_control_assert") +
[`reset_control_put()`](reset.md#c.reset_control_put "reset_control_put") is called automatically on driver detach.

See [`devm_reset_control_get_optional_shared()`](reset.md#c.devm_reset_control_get_optional_shared "devm_reset_control_get_optional_shared") for more information.
...
struct reset_control \*of_reset_control_array_get(struct device_node \*np, enum [reset_control_flags](reset.md#c.reset_control_flags "reset_control_flags") flags)
...
struct reset_control \*devm_reset_control_array_get(struct [device](infrastructure.md#c.device "device") \*dev, enum [reset_control_flags](reset.md#c.reset_control_flags "reset_control_flags") flags)
...
`of_args`
:   for reset-gpios controllers: corresponding phandle args with
