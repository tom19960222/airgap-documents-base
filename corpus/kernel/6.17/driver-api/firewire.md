...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/firewire.html
...
is required to process the context in the current context, [`fw_iso_context_flush_completions()`](firewire.md#c.fw_iso_context_flush_completions "fw_iso_context_flush_completions") is
available instead.
...
required to process the context asynchronously, [`fw_iso_context_schedule_flush_completions()`](firewire.md#c.fw_iso_context_schedule_flush_completions "fw_iso_context_schedule_flush_completions") is
available instead.

**Context**

Process context. May sleep due to [`disable_work_sync()`](../core-api/workqueue.md#c.disable_work_sync "disable_work_sync").
