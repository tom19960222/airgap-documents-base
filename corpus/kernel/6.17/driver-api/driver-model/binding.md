...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/driver-model/binding.html
...
int match([`struct device`](../infrastructure.md#c.device "device") \* dev, [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") \* drv);
