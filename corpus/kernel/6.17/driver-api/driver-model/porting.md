...
collection: kernel
version: "6.17"
title: "Porting Drivers to the New Driver Model"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/driver-model/porting.html
fetched_at: 2026-09-16T16:36:24+00:00
---
...
- Define a [`struct bus_type`](../infrastructure.md#c.bus_type "bus_type") for the bus driver:
...
- Register the bus type.
  ...
  which is usually the [`module_init()`](../basics.md#c.module_init "module_init"), or equivalent, function:
...
[`struct device`](../infrastructure.md#c.device "device") represents a single device. It mainly contains metadata
describing the relationship the device has to other entities.

- Embed a [`struct device`](../infrastructure.md#c.device "device") in the bus-specific device type:
...
[`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") is a simple driver structure that contains a set
of operations that the driver model core may call.

- Embed a [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") in the bus-specific driver.
...
[`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") defines a set of operations that the driver model
...
Instead, a bus may supply a method in [`struct bus_type`](../infrastructure.md#c.bus_type "bus_type") that does the
comparison:
...
[`struct bus_type`](../infrastructure.md#c.bus_type "bus_type"):
...
[`struct bus_type`](../infrastructure.md#c.bus_type "bus_type") contains a list of all devices registered with the bus
...
[`struct bus_type`](../infrastructure.md#c.bus_type "bus_type") also contains a list of all drivers registered with
...
[`struct bus_type`](../infrastructure.md#c.bus_type "bus_type") contains an rwsem that protects all core accesses to
...
Some of the fields in [`struct device`](../infrastructure.md#c.device "device") and [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") duplicate
