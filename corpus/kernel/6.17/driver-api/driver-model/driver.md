...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/driver-model/driver.html
fetched_at: 2026-09-16T16:36:23+00:00
---
# Device Drivers

See the kerneldoc for the [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver").

## Allocation

Device drivers are statically allocated structures. Though there may
be multiple devices in a system that a driver supports, [`struct
device_driver`](../infrastructure.md#c.device_driver "device_driver") represents the driver as a whole (not a particular
device instance).
...
As stated above, [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") objects are statically
...
Bus-specific drivers should include a generic [`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") in
...
[`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") object.
...
[`struct device_driver`](../infrastructure.md#c.device_driver "device_driver") object, including the reference count and the
