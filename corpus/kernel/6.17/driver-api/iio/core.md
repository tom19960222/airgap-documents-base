...
version: "6.17"
title: "Core elements"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/iio/core.html
fetched_at: 2026-09-16T16:26:50+00:00
---
# Core elements
...
:   Used in rare cases where there is more than one scan
    ...
    implement get_current_scan_type in [`struct iio_info`](core.md#c.iio_info "iio_info").
...
:   must be implemented by drivers that use ext_scan_type
...
:   function pointer to set the current hardware
    ...
    [ABI file testing/sysfs-bus-iio](../../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-bus-iio) for details on
...
Same as [`IIO_DECLARE_BUFFER_WITH_TS()`](core.md#c.IIO_DECLARE_BUFFER_WITH_TS "IIO_DECLARE_BUFFER_WITH_TS"), but is uses __aligned(IIO_DMA_MINALIGN)
...
int iio_device_suspend_triggering(struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
...
int iio_device_resume_triggering(struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
:   resume trigger attached to an iio_dev that was previously suspended with [`iio_device_suspend_triggering()`](core.md#c.iio_device_suspend_triggering "iio_device_suspend_triggering")
...
const struct [iio_scan_type](core.md#c.iio_scan_type "iio_scan_type") \*iio_get_current_scan_type(const struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev, const struct [iio_chan_spec](core.md#c.iio_chan_spec "iio_chan_spec") \*chan)
...
unsigned int iio_get_masklength(const struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
...
int iio_active_scan_mask_index(struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
...
bool __iio_device_claim_direct(struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
...
that way until [`__iio_device_release_direct()`](core.md#c.__iio_device_release_direct "__iio_device_release_direct") is called.

Use with [`__iio_device_release_direct()`](core.md#c.__iio_device_release_direct "__iio_device_release_direct").
...
void __iio_device_release_direct(struct [iio_dev](core.md#c.iio_dev "iio_dev") \*indio_dev)
...
Use with [`__iio_device_claim_direct()`](core.md#c.__iio_device_claim_direct "__iio_device_claim_direct")
