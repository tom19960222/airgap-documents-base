...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/firmware/other_interfaces.html
fetched_at: 2026-09-16T16:27:44+00:00
---
...
void sysfb_disable(struct [device](../infrastructure.md#c.device "device") \*dev)
...
:   reports if sysfb handles the global screen_info
...
Callers can use [`sysfb_handles_screen_info()`](other_interfaces.md#c.sysfb_handles_screen_info "sysfb_handles_screen_info") to determine whether the Generic
