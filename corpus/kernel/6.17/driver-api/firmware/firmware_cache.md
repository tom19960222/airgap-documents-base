...
collection: kernel
version: "6.17"
title: "Firmware cache"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/firmware/firmware_cache.html
fetched_at: 2026-09-16T16:37:03+00:00
---
# Firmware cache
...
- The firmware cache is setup by adding a devres entry for each device that
  uses all synchronous call except [`request_firmware_into_buf()`](request_firmware.md#c.request_firmware_into_buf "request_firmware_into_buf").
- If an asynchronous call is used the firmware cache is only set up for a
  device if the second argument (uevent) to [`request_firmware_nowait()`](request_firmware.md#c.request_firmware_nowait "request_firmware_nowait") is
