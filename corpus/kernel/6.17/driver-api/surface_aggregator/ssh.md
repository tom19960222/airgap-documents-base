...
collection: kernel
version: "6.17"
title: "Surface Serial Hub Protocol"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/surface_aggregator/ssh.html
...
([`struct ssh_frame`](client-api.md#c.ssh_frame "ssh_frame")). A frame consists of the following
...
([`enum ssh_frame_type`](client-api.md#c.ssh_frame_type "ssh_frame_type")):
...
`0x80` ([`SSH_PLD_TYPE_CMD`](client-api.md#c.ssh_payload_type "ssh_payload_type")).

The command-type payload ([`struct ssh_command`](client-api.md#c.ssh_command "ssh_command"))
...
| `TID` | `u8` | Target ID for commands/messages. |
| `SID` | `u8` | Source ID for commands/messages. |
| `IID` | `u8` | Instance ID. |
| `RQID` | `u16` | Request ID. |
| `CID` | `u8` | Command ID. |
...
See (`enum ssh_request_id`) for possible values of
both.
