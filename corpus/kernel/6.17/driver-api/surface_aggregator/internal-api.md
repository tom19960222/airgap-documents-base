...
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/surface_aggregator/internal-api.html
fetched_at: 2026-09-16T16:29:14+00:00
---
...
int ssam_controller_caps_load_from_of(struct [device](../infrastructure.md#c.device "device") \*dev, struct [ssam_controller_caps](internal-api.md#c.ssam_controller_caps "ssam_controller_caps") \*caps)
...
int ssam_controller_caps_load(struct [device](../infrastructure.md#c.device "device") \*dev, struct [ssam_controller_caps](internal-api.md#c.ssam_controller_caps "ssam_controller_caps") \*caps)
