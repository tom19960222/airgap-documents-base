...
collection: kernel
version: "6.17"
title: "User-Space DTX (Clipboard Detachment System) Interface"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/surface_aggregator/clients/dtx.html
fetched_at: 2026-09-16T16:29:34+00:00
---
# [User-Space DTX (Clipboard Detachment System) Interface](dtx.md#id13)
...
- [User-Space DTX (Clipboard Detachment System) Interface](dtx.md#user-space-dtx-clipboard-detachment-system-interface)

  - [Nomenclature](dtx.md#nomenclature)
  - [Detachment Process](dtx.md#detachment-process)

    - [Latch States](dtx.md#latch-states)
    - [Detachment Procedure](dtx.md#detachment-procedure)
  - [User-Space Interface Documentation](dtx.md#user-space-interface-documentation)

    - [Error Codes and Status Values](dtx.md#error-codes-and-status-values)
    - [Events](dtx.md#events)

      - [`SDTX_EVENT_REQUEST`](dtx.md#sdtx-event-request)
      - [`SDTX_EVENT_CANCEL`](dtx.md#sdtx-event-cancel)
      - [`SDTX_EVENT_BASE_CONNECTION`](dtx.md#sdtx-event-base-connection)
      - [`SDTX_EVENT_LATCH_STATUS`](dtx.md#sdtx-event-latch-status)
      - [`SDTX_EVENT_DEVICE_MODE`](dtx.md#sdtx-event-device-mode)
    - [IOCTLs](dtx.md#ioctls)

      - [`SDTX_IOCTL_EVENTS_ENABLE`](dtx.md#sdtx-ioctl-events-enable)
      - [`SDTX_IOCTL_EVENTS_DISABLE`](dtx.md#sdtx-ioctl-events-disable)
      - [`SDTX_IOCTL_LATCH_LOCK`](dtx.md#sdtx-ioctl-latch-lock)
      - [`SDTX_IOCTL_LATCH_UNLOCK`](dtx.md#sdtx-ioctl-latch-unlock)
      - [`SDTX_IOCTL_LATCH_REQUEST`](dtx.md#sdtx-ioctl-latch-request)
      - [`SDTX_IOCTL_LATCH_CONFIRM`](dtx.md#sdtx-ioctl-latch-confirm)
      - [`SDTX_IOCTL_LATCH_HEARTBEAT`](dtx.md#sdtx-ioctl-latch-heartbeat)
      - [`SDTX_IOCTL_LATCH_CANCEL`](dtx.md#sdtx-ioctl-latch-cancel)
      - [`SDTX_IOCTL_GET_BASE_INFO`](dtx.md#sdtx-ioctl-get-base-info)
      - [`SDTX_IOCTL_GET_DEVICE_MODE`](dtx.md#sdtx-ioctl-get-device-mode)
      - [`SDTX_IOCTL_GET_LATCH_STATUS`](dtx.md#sdtx-ioctl-get-latch-status)
    - [A Note on Base IDs](dtx.md#a-note-on-base-ids)
    - [Structures and Enums](dtx.md#structures-and-enums)
  - [API Users](dtx.md#api-users)

## [Nomenclature](dtx.md#id14)
...
## [Detachment Process](dtx.md#id15)
...
### [Detachment Procedure](dtx.md#id17)
...
3. The EC waits for instructions from user-space and acts according to them.
   ...
   - If the latch is locked, the EC will *not* open the latch, meaning the
     ...
     reason `SDTX_DETACH_TIMEDOUT` (see [Events](dtx.md#events) for details).
...
See [IOCTLs](dtx.md#ioctls) for more details on these responses.
...
## [User-Space Interface Documentation](dtx.md#id18)

### [Error Codes and Status Values](dtx.md#id19)
...
first. All events follow the layout prescribed by [`struct sdtx_event`](dtx.md#c.sdtx_event "sdtx_event"). Specific
event types can be identified by their event code, described in
[`enum sdtx_event_code`](dtx.md#c.sdtx_event_code "sdtx_event_code"). Note that other event codes are reserved for future use,
...
#### [`SDTX_EVENT_REQUEST`](dtx.md#id21)
...
#### [`SDTX_EVENT_BASE_CONNECTION`](dtx.md#id23)
...
provided as payload of type [`struct sdtx_base_info`](dtx.md#c.sdtx_base_info "sdtx_base_info") with its layout presented
below:
...
#### [`SDTX_EVENT_LATCH_STATUS`](dtx.md#id24)
...
#### [`SDTX_EVENT_DEVICE_MODE`](dtx.md#id25)
...
#### [`SDTX_IOCTL_EVENTS_ENABLE`](dtx.md#id27)
...
#### [`SDTX_IOCTL_EVENTS_DISABLE`](dtx.md#id28)
...
#### [`SDTX_IOCTL_LATCH_LOCK`](dtx.md#id29)
...
#### [`SDTX_IOCTL_LATCH_UNLOCK`](dtx.md#id30)
...
#### [`SDTX_IOCTL_LATCH_REQUEST`](dtx.md#id31)
...
#### [`SDTX_IOCTL_LATCH_CONFIRM`](dtx.md#id32)
...
#### [`SDTX_IOCTL_LATCH_HEARTBEAT`](dtx.md#id33)
...
#### [`SDTX_IOCTL_LATCH_CANCEL`](dtx.md#id34)
...
#### [`SDTX_IOCTL_GET_BASE_INFO`](dtx.md#id35)
...
#### [`SDTX_IOCTL_GET_DEVICE_MODE`](dtx.md#id36)
...
See [`struct sdtx_device_mode`](dtx.md#c.sdtx_device_mode "sdtx_device_mode") for details. Other values are reserved for future
use.

#### [`SDTX_IOCTL_GET_LATCH_STATUS`](dtx.md#id37)
...
### [A Note on Base IDs](dtx.md#id38)
...
### [Structures and Enums](dtx.md#id39)

enum sdtx_device_mode
:   Mode describing how (and if) the clipboard is attached to the base of the device.

**Constants**

`SDTX_DEVICE_MODE_TABLET`
:   The clipboard is detached from the base and the
    device operates as tablet.

`SDTX_DEVICE_MODE_LAPTOP`
:   The clipboard is attached normally to the base
    and the device operates as laptop.

`SDTX_DEVICE_MODE_STUDIO`
:   The clipboard is attached to the base in reverse.
...
struct sdtx_event
:   Event provided by reading from the DTX device file.
...
`code`
:   Event code, detailing what type of event this is.

`data`
:   Payload of the event, containing **length** bytes.

**Description**

See [`enum sdtx_event_code`](dtx.md#c.sdtx_event_code "sdtx_event_code") for currently valid event codes.

enum sdtx_event_code
:   Code describing the type of an event.

**Constants**

`SDTX_EVENT_REQUEST`
:   Detachment request event type.

`SDTX_EVENT_CANCEL`
:   Cancel detachment process event type.

`SDTX_EVENT_BASE_CONNECTION`
:   Base/clipboard connection change event type.

`SDTX_EVENT_LATCH_STATUS`
:   Latch status change event type.

`SDTX_EVENT_DEVICE_MODE`
:   Device mode change event type.

**Description**

Used in [`struct sdtx_event`](dtx.md#c.sdtx_event "sdtx_event") to describe the type of the event. Further event
...
:   Describes if and what type of base is connected.
...
`state`
:   The state of the connection. Valid values are `SDTX_BASE_DETACHED`,
...
`base_id`
:   The type of base connected. Zero if no base is connected.

## [API Users](dtx.md#id40)
