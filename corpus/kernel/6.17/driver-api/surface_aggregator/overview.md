...
version: "6.17"
title: "Overview"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/surface_aggregator/overview.html
...
([`struct ssam_device`](client-api.md#c.ssam_device "ssam_device")) has been implemented.
...
See [Surface Serial Hub Protocol](ssh.md) for a
more technical protocol documentation and
[Core Driver Internals](internal.md) for an
