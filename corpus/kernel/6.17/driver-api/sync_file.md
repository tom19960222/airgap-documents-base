...
collection: kernel
version: "6.17"
title: "Sync File API Guide"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/sync_file.html
fetched_at: 2026-09-16T16:20:38+00:00
---
# Sync File API Guide
...
the fences([`struct dma_fence`](dma-buf.md#c.dma_fence "dma_fence")) that are needed to synchronize between drivers or
...
[`dma_fence_signal()`](dma-buf.md#c.dma_fence_signal "dma_fence_signal"), when it has finished using (or processing) that buffer.
...
afterwards using [`dma_fence_put()`](dma-buf.md#c.dma_fence_put "dma_fence_put"). In case of error, a NULL is returned instead.

References:

1. [`struct sync_file`](dma-buf.md#c.sync_file "sync_file") in include/linux/sync_file.h
