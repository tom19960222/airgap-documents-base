...
version: "6.17"
title: "Introduction"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/mei/mei.html
fetched_at: 2026-09-16T16:37:26+00:00
---
# Introduction
...
`MEI_CONNECT_CLIENT_IOCTL`, which passes the desired GUID.
...
The session is terminated calling close(fd).

A code snippet for an application communicating with Intel AMTHI client:

In order to support virtualization or sandboxing a trusted supervisor
can use `MEI_CONNECT_CLIENT_IOCTL_VTAG` to create
...
[linux-mei@linux.intel.com](mailto:linux-mei%40linux.intel.com)
