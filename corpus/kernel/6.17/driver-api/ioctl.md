...
collection: kernel
version: "6.17"
title: "ioctl based interfaces"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/ioctl.html
fetched_at: 2026-09-16T16:19:38+00:00
---
...
:   An 8-bit number, often a character literal, specific to a subsystem
    or driver, and listed in [Ioctl Numbers](../userspace-api/ioctl/ioctl-number.md)
...
space timespec exactly. The [`get_timespec64()`](basics.md#c.get_timespec64 "get_timespec64") and [`put_timespec64()`](basics.md#c.put_timespec64 "put_timespec64") helper
...
as returned by [`ktime_get_ns()`](../core-api/timekeeping.md#c.ktime_get_ns "ktime_get_ns") or [`ktime_get_ts64()`](../core-api/timekeeping.md#c.ktime_get_ts64 "ktime_get_ts64"). Unlike
...
[`ktime_get_real_ns()`](../core-api/timekeeping.md#c.ktime_get_real_ns "ktime_get_real_ns") can be used for CLOCK_REALTIME timestamps that
...
space. This is usually done by calling [`memset()`](../core-api/kernel-api.md#c.memset "memset") before assigning to
individual members.
