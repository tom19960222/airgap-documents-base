...
collection: kernel
version: "6.17"
title: "BTT - Block Translation Table"
source_url: https://www.kernel.org/doc/html/v6.17/driver-api/nvdimm/btt.html
fetched_at: 2026-09-16T16:37:36+00:00
---
...
| Bit | Description |
| --- | --- |
| 31 - 30 | Error and Zero flags - Used in the following way:  ``` == ==  ==================================================== 31 30  Description == ==  ==================================================== 0  0   Initial state. Reads return zeroes; Premap = Postmap 0  1   Zero state: Reads return zeroes 1  0   Error state: Reads fail; Writes clear 'E' bit 1  1   Normal Block – has valid postmap == ==  ==================================================== ``` |
