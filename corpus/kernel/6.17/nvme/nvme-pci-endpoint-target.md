...
collection: kernel
version: "6.17"
title: "2. NVMe PCI Endpoint Function Target"
source_url: https://www.kernel.org/doc/html/v6.17/nvme/nvme-pci-endpoint-target.html
fetched_at: 2026-09-16T16:42:55+00:00
---
# 2. NVMe PCI Endpoint Function Target
...
### 2.1.3. Minimum number of PCI Address Mapping Windows Required
...
### 2.1.4. Maximum Number of Queue Pairs
...
### 2.1.5. Limitations and NVMe Specification Non-Compliance
...
### 2.2.4. Creating an NVMe Subsystem and Port
...
### 2.2.5. Creating an NVMe PCI Endpoint Device
...
| subsys_vendor_id | Ignored (the subsystem vendor id of the NVMe target subsystem is used) |
