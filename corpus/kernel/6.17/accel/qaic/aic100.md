...
collection: kernel
version: "6.17"
title: "Qualcomm Cloud AI 100 (AIC100)"
source_url: https://www.kernel.org/doc/html/v6.17/accel/qaic/aic100.html
...
[MHI](../../mhi/index.md) MHI is the mechanism the host uses to communicate
...
| QAIC_TIMESYNC | 20 & 21 | SBL | Used to synchronize timestamps in the device side logs with the host time source. |
| QAIC_TIMESYNC _PERIODIC | 22 & 23 | AMSS | Used to periodically synchronize timestamps in the device side logs with the host time source. |
