...
version: "6.17"
title: "AMD NPU"
source_url: https://www.kernel.org/doc/html/v6.17/accel/amdxdna/amdnpu.html
...
[AMD XDNA Architecture](https://www.amd.com/en/technologies/xdna.html). NPU is managed by **amdxdna** driver.
...
[AMD AI Engine Technology](https://www.xilinx.com/products/technology/ai-engine.html). Each column has 4 rows of compute tiles and 1
...
1. AMD XDNA Array overlay, which is used to configure a NPU spatial partition.
   ...
   Refer to the
   [Versal Adaptive SoC AIE-ML Architecture Manual (AM020)](https://docs.amd.com/r/en-US/am020-versal-aie-ml) for more details.
2. `ctrlcode`, used for orchestrating the overlay loaded on the spatial
   ...
   [AI Engine Run Time](https://github.com/Xilinx/aie-rt/tree/release/main_aig) for more details.
