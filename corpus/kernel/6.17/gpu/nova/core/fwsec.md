...
collection: kernel
version: "6.17"
title: "FWSEC (Firmware Security)"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/nova/core/fwsec.html
fetched_at: 2026-09-16T16:39:42+00:00
---
...
ROM (see [VBIOS](vbios.md) for more details). It contains different commands like FRTS
...
(see [Falcon (FAst Logic Controller)](falcon.md) for privilege levels).
...
it is extracted, see [VBIOS](vbios.md) and the vbios.rs source code.
