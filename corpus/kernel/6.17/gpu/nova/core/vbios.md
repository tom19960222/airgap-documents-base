...
version: "6.17"
title: "VBIOS"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/nova/core/vbios.html
fetched_at: 2026-09-16T16:39:41+00:00
---
# VBIOS
...
- Second FwSec Image (Type 0xE0) - The second FwSec image (Secure Firmware)
  ...
  loads (see [Device Initialization (devinit)](devinit.md)). The DEVINIT ucode is itself another ucode that is
...
The location of the PMU lookup table is found by scanning the BIT ([BIOS Information Table](https://download.nvidia.com/open-gpu-doc/BIOS-Information-Table/1/BIOS-Information-Table.html))
