...
collection: kernel
version: "6.17"
title: "Device Initialization (devinit)"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/nova/core/devinit.html
...
FWSEC (Firmware Security) image (see [FWSEC (Firmware Security)](fwsec.md) and [VBIOS](vbios.md)) and it runs before the
...
1. Located in the VBIOS ROM in the same ROM partition (see [VBIOS](vbios.md) and [FWSEC (Firmware Security)](fwsec.md)).
