...
collection: kernel
version: "6.17"
title: "DRM client usage stats"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/drm-usage-stats.html
fetched_at: 2026-09-16T16:39:16+00:00
---
# DRM client usage stats

DRM drivers can choose to export partly standardised text output via the
fops->`show_fdinfo()` as part of the driver specific file operations registered
in the [`struct drm_driver`](drm-internals.md#c.drm_driver "drm_driver") object registered with the DRM core.
...
- Driver-specific keys shall be prefixed with driver_name-, where
  ...
  [`struct drm_driver`](drm-internals.md#c.drm_driver "drm_driver"), although this is not mandatory.
...
[`struct drm_driver`](drm-internals.md#c.drm_driver "drm_driver") data structure.
...
to the in kernel representation of [`struct drm_file`](drm-internals.md#c.drm_file "drm_file") instances.
...
Drivers should use [`drm_show_fdinfo()`](drm-internals.md#c.drm_show_fdinfo "drm_show_fdinfo") in their `struct file_operations`, and
implement &drm_driver.show_fdinfo if they wish to provide any stats which
are not provided by [`drm_show_fdinfo()`](drm-internals.md#c.drm_show_fdinfo "drm_show_fdinfo"). But even driver specific stats should
be documented above and where possible, aligned with other drivers.

### Driver specific implementations

- [i915 DRM client usage stats implementation](i915.md#i915-usage-stats)
- [Panfrost DRM client usage stats implementation](panfrost.md#panfrost-usage-stats)
- [Panthor DRM client usage stats implementation](panthor.md#panthor-usage-stats)
- [Xe DRM client usage stats implementation](xe/xe-drm-usage-stats.md#xe-usage-stats)
