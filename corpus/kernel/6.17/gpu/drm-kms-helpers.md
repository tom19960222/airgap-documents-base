...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/drm-kms-helpers.html
fetched_at: 2026-09-16T16:26:41+00:00
---
...
:   This function should fill in all modes currently valid for the sink
    ...
    one using [`drm_set_preferred_mode()`](drm-kms.md#c.drm_set_preferred_mode "drm_set_preferred_mode").
    ...
    The number of modes added by calling [`drm_mode_probed_add()`](drm-kms.md#c.drm_mode_probed_add "drm_mode_probed_add"). Return 0
...
:   Get the current scanout buffer, to display a message with drm_panic.
    ...
    Please look the documentation at [`drm_panic_trylock()`](drm-kms.md#c.drm_panic_trylock "drm_panic_trylock") for an in-depth
    ...
    The returned [`drm_scanout_buffer.map`](drm-kms.md#c.drm_scanout_buffer "drm_scanout_buffer") must be valid if no error code is
    returned.
...
As this function calls [`drm_atomic_helper_check_modeset()`](drm-kms-helpers.md#c.drm_atomic_helper_check_modeset "drm_atomic_helper_check_modeset") internally, its
restrictions also apply:
Drivers which set [`drm_crtc_state.mode_changed`](drm-kms.md#c.drm_crtc_state "drm_crtc_state") (e.g. in their
[`drm_plane_helper_funcs.atomic_check`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") hooks if a plane update can’t be done
without a full modeset) _must_ call [`drm_atomic_helper_check_modeset()`](drm-kms-helpers.md#c.drm_atomic_helper_check_modeset "drm_atomic_helper_check_modeset")
...
void drm_atomic_helper_update_legacy_modeset_state(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_modeset_disables(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_modeset_enables(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_wait_for_vblanks(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_wait_for_flip_done(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_tail(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_tail_rpm(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
:   commit atomic update to hardware
...
void drm_atomic_helper_wait_for_dependencies(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_fake_vblank(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_hw_done(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_cleanup_done(struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_helper_commit_planes(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state, uint32_t flags)
:   commit plane state
...
void drm_atomic_helper_cleanup_planes(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
int drm_atomic_helper_reset_crtc(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, struct [drm_modeset_acquire_ctx](drm-kms.md#c.drm_modeset_acquire_ctx "drm_modeset_acquire_ctx") \*ctx)
...
This relies on resetting [`drm_crtc_state.connectors_changed`](drm-kms.md#c.drm_crtc_state "drm_crtc_state").
...
:   Driver callback to suspend or resume, if set, fbdev emulation will
    ...
    [`fb_set_suspend()`](../driver-api/frame-buffer.md#c.fb_set_suspend "fb_set_suspend") from their implementation. If not set, fbdev
    emulation will invoke [`fb_set_suspend()`](../driver-api/frame-buffer.md#c.fb_set_suspend "fb_set_suspend") directly.
...
This helper should be called from fbdev emulation’s [`drm_client_funcs.restore`](drm-client.md#c.drm_client_funcs "drm_client_funcs")
...
within the struct [`drm_driver.fbdev_probe`](drm-internals.md#c.drm_driver "drm_driver") callback function. Drivers do
...
[`drm_driver.fbdev_probe`](drm-internals.md#c.drm_driver "drm_driver") callback after having allocated the fbdev
...
This function will call down into the [`drm_driver.fbdev_probe`](drm-internals.md#c.drm_driver "drm_driver") callback
...
This function is obsolete. Call [`drm_fb_helper_restore_fbdev_mode_unlocked()`](drm-kms-helpers.md#c.drm_fb_helper_restore_fbdev_mode_unlocked "drm_fb_helper_restore_fbdev_mode_unlocked")
instead.
...
void drm_fb_xrgb8888_to_rgb565be(struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*dst, const unsigned int \*dst_pitch, const struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*src, const struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*clip, struct drm_format_conv_state \*state)
...
void drm_fb_xrgb8888_to_bgr888(struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*dst, const unsigned int \*dst_pitch, const struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*src, const struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*clip, struct drm_format_conv_state \*state)
...
void drm_fb_xrgb8888_to_abgr8888(struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*dst, const unsigned int \*dst_pitch, const struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*src, const struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*clip, struct drm_format_conv_state \*state)
...
void drm_fb_xrgb8888_to_bgrx8888(struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*dst, const unsigned int \*dst_pitch, const struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*src, const struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*clip, struct drm_format_conv_state \*state)
...
void drm_fb_argb8888_to_argb4444(struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*dst, const unsigned int \*dst_pitch, const struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*src, const struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*clip, struct drm_format_conv_state \*state)
...
int drm_fb_dma_get_scanout_buffer(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane, struct [drm_scanout_buffer](drm-kms.md#c.drm_scanout_buffer "drm_scanout_buffer") \*sb)
...
int drm_gem_fb_init_with_funcs(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file, const struct [drm_format_info](drm-kms.md#c.drm_format_info "drm_format_info") \*info, const struct [drm_mode_fb_cmd2](drm-uapi.md#c.drm_mode_fb_cmd2 "drm_mode_fb_cmd2") \*mode_cmd, const struct [drm_framebuffer_funcs](drm-kms.md#c.drm_framebuffer_funcs "drm_framebuffer_funcs") \*funcs)
...
struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*drm_gem_fb_create(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file, const struct [drm_format_info](drm-kms.md#c.drm_format_info "drm_format_info") \*info, const struct [drm_mode_fb_cmd2](drm-uapi.md#c.drm_mode_fb_cmd2 "drm_mode_fb_cmd2") \*mode_cmd)
:   Helper function for the [`drm_mode_config_funcs.fb_create`](drm-kms.md#c.drm_mode_config_funcs "drm_mode_config_funcs") callback
...
int drm_gem_fb_afbc_init(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, const struct [drm_format_info](drm-kms.md#c.drm_format_info "drm_format_info") \*info, const struct [drm_mode_fb_cmd2](drm-uapi.md#c.drm_mode_fb_cmd2 "drm_mode_fb_cmd2") \*mode_cmd, struct [drm_afbc_framebuffer](drm-kms.md#c.drm_afbc_framebuffer "drm_afbc_framebuffer") \*afbc_fb)
...
:   The **disable** callback should disable the bridge.
    ...
    If the preceding element is a [`drm_bridge`](drm-kms-helpers.md#c.drm_bridge "drm_bridge"), then this is called before
    that bridge is disabled via one of:

    - [`drm_bridge_funcs.disable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
    - [`drm_bridge_funcs.atomic_disable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
    ...
    - [`drm_encoder_helper_funcs.prepare`](drm-kms-helpers.md#c.drm_encoder_helper_funcs "drm_encoder_helper_funcs")
    - [`drm_encoder_helper_funcs.disable`](drm-kms-helpers.md#c.drm_encoder_helper_funcs "drm_encoder_helper_funcs")
    - [`drm_encoder_helper_funcs.dpms`](drm-kms-helpers.md#c.drm_encoder_helper_funcs "drm_encoder_helper_funcs")

    and the CRTC is disabled via one of:

    - [`drm_crtc_helper_funcs.prepare`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs")
    - [`drm_crtc_helper_funcs.atomic_disable`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs")
    - [`drm_crtc_helper_funcs.disable`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs")
    - [`drm_crtc_helper_funcs.dpms`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs").
...
:   The bridge must assume that the display pipe (i.e. clocks and timing
    ...
    **post_disable** is called.
    ...
    If the preceding element is a [`drm_bridge`](drm-kms-helpers.md#c.drm_bridge "drm_bridge"), then this is called after
    that bridge is post-disabled (unless marked otherwise by the
    **pre_enable_prev_first** flag) via one of:

    - [`drm_bridge_funcs.post_disable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
    - [`drm_bridge_funcs.atomic_post_disable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
...
:   The display pipe (i.e. clocks and timing signals) feeding this bridge
    ...
    **pre_enable_prev_first** flag) via one of:
    ...
    - [`drm_bridge_funcs.pre_enable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
    - [`drm_bridge_funcs.atomic_pre_enable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")

    If the preceding element of the bridge is a display controller, then
    this callback is called before the CRTC is enabled via one of:

    - [`drm_crtc_helper_funcs.atomic_enable`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs")
    - [`drm_crtc_helper_funcs.commit`](drm-kms-helpers.md#c.drm_crtc_helper_funcs "drm_crtc_helper_funcs")
    ...
    - [`drm_encoder_helper_funcs.enable`](drm-kms-helpers.md#c.drm_encoder_helper_funcs "drm_encoder_helper_funcs")
    - [`drm_encoder_helper_funcs.commit`](drm-kms-helpers.md#c.drm_encoder_helper_funcs "drm_encoder_helper_funcs")
...
:   The **enable** callback should enable the bridge.
    ...
    - [`drm_bridge_funcs.enable`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs")
...
:   Fill all modes currently valid for the sink into the [`drm_connector`](drm-kms.md#c.drm_connector "drm_connector")
    ...
    [`drm_bridge_funcs->edid_read`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") callback instead.
...
:   Read the EDID data of the connected display.
    ...
    An edid structure newly allocated with [`drm_edid_alloc()`](drm-kms-helpers.md#c.drm_edid_alloc "drm_edid_alloc") or returned
    from [`drm_edid_read()`](drm-kms-helpers.md#c.drm_edid_read "drm_edid_read") family of functions on success, or NULL
    otherwise. The caller is responsible for freeing the returned edid
    structure with [`drm_edid_free()`](drm-kms-helpers.md#c.drm_edid_free "drm_edid_free").
...
:   Check whether a particular TMDS character rate is supported by the
    ...
    [`drm_bridge->ops`](drm-kms-helpers.md#c.drm_bridge "drm_bridge").

    Returns:

    Either [`drm_mode_status.MODE_OK`](drm-kms.md#c.drm_mode_status "drm_mode_status") or one of the failure reasons
    in [`enum drm_mode_status`](drm-kms.md#c.drm_mode_status "drm_mode_status").
...
:   This callback clears the infoframes in the hardware during commit.
    ...
    set the DRM_BRIDGE_OP_HDMI flag in their [`drm_bridge->ops`](drm-kms-helpers.md#c.drm_bridge "drm_bridge").
...
:   Called when ASoC starts an audio stream setup.
    ...
    set the **DRM_BRIDGE_OP_HDMI_AUDIO** flag in their [`drm_bridge->ops`](drm-kms-helpers.md#c.drm_bridge "drm_bridge").
...
:   Called when ASoC starts a DisplayPort audio stream setup.
    ...
    This callback is optional, it can be implemented by bridges that
    set the **DRM_BRIDGE_OP_DP_AUDIO** flag in their [`drm_bridge->ops`](drm-kms-helpers.md#c.drm_bridge "drm_bridge").
...
:   The bridge can retrieve the EDID of the display
    ...
    the [`drm_bridge_funcs->edid_read`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") callback.
...
:   The bridge provides HDMI connector operations,
    ...
    implement the [`drm_bridge_funcs->write_infoframe`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") callback.
...
:   The bridge provides HDMI audio operations.
    ...
    [`drm_bridge_funcs->hdmi_audio_prepare`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") and
    [`drm_bridge_funcs->hdmi_audio_shutdown`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") callbacks.
...
:   The bridge provides DisplayPort audio operations.
    Bridges that set this flag must implement the
    [`drm_bridge_funcs->dp_audio_prepare`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") and
    [`drm_bridge_funcs->dp_audio_shutdown`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") callbacks.
...
`dev`
:   [`struct device`](../driver-api/infrastructure.md#c.device "device") of the bridge device

`type`
:   the type of the `struct which` contains struct [`drm_bridge`](drm-kms-helpers.md#c.drm_bridge "drm_bridge")

`member`
:   the name of the [`drm_bridge`](drm-kms-helpers.md#c.drm_bridge "drm_bridge") within **type**
...
[`drm_bridge_put()`](drm-kms-helpers.md#c.drm_bridge_put "drm_bridge_put")) when **dev** is removed.

**Return**

Pointer to new bridge, or ERR_PTR on failure.

struct [drm_bridge_state](drm-kms.md#c.drm_bridge_state "drm_bridge_state") \*drm_bridge_get_current_state(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge)
...
struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*drm_bridge_get(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge)
...
void drm_bridge_put(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge)
...
[`devm_drm_bridge_alloc()`](drm-kms-helpers.md#c.devm_drm_bridge_alloc "devm_drm_bridge_alloc").
...
void drm_atomic_bridge_chain_disable(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_bridge_chain_post_disable(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_bridge_chain_pre_enable(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
void drm_atomic_bridge_chain_enable(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
enum [drm_connector_status](drm-kms.md#c.drm_connector_status "drm_connector_status") drm_bridge_detect(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
:   check if anything is attached to the bridge output
...
const struct drm_edid \*drm_bridge_edid_read(struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge, struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
:   read the EDID data of the connected display
...
DRM_BRIDGE_OP_EDID bridge ops flag, call [`drm_bridge_funcs.edid_read`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") to get
...
void devm_drm_put_bridge(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, struct [drm_bridge](drm-kms-helpers.md#c.drm_bridge "drm_bridge") \*bridge)
...
`struct drm_bridge *bridge`
:   pointer to a [`struct drm_bridge`](drm-kms-helpers.md#c.drm_bridge "drm_bridge") obtained via devm

**Description**

Same as [`drm_bridge_put()`](drm-kms-helpers.md#c.drm_bridge_put "drm_bridge_put") for bridge pointers obtained via devm functions
such as [`devm_drm_bridge_alloc()`](drm-kms-helpers.md#c.devm_drm_bridge_alloc "devm_drm_bridge_alloc").
...
`dev`
:   [`struct device`](../driver-api/infrastructure.md#c.device "device") of the panel device

`type`
:   the type of the `struct which` contains struct [`drm_panel`](drm-kms-helpers.md#c.drm_panel "drm_panel")

`member`
:   the name of the [`drm_panel`](drm-kms-helpers.md#c.drm_panel "drm_panel") within **type**
...
reference will be automatically dropped via devm (by calling
[`drm_panel_put()`](drm-kms-helpers.md#c.drm_panel_put "drm_panel_put")) when **dev** is removed.
...
allocated by [`devm_drm_panel_alloc()`](drm-kms-helpers.md#c.devm_drm_panel_alloc "devm_drm_panel_alloc").
...
void drm_panel_prepare(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
:   power on a panel
...
[`drm_panel_disable()`](drm-kms-helpers.md#c.drm_panel_disable "drm_panel_disable") afterwards.

void drm_panel_unprepare(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
:   power off a panel
...
void drm_panel_enable(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
:   enable a panel
...
enable call chain). There will always be a call to [`drm_panel_disable()`](drm-kms-helpers.md#c.drm_panel_disable "drm_panel_disable")
afterwards.

void drm_panel_disable(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
:   disable a panel
...
struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*drm_panel_get(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
...
void drm_panel_put(struct [drm_panel](drm-kms-helpers.md#c.drm_panel "drm_panel") \*panel)
...
:   Get minimum supported brightness level for a panel.
...
void __drm_atomic_helper_connector_hdmi_reset(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, struct [drm_connector_state](drm-kms.md#c.drm_connector_state "drm_connector_state") \*new_conn_state)
:   Initializes all HDMI **drm_connector_state** resources
...
combination with [`__drm_atomic_helper_connector_reset()`](drm-kms-helpers.md#c.__drm_atomic_helper_connector_reset "__drm_atomic_helper_connector_reset") or
[`drm_atomic_helper_connector_reset()`](drm-kms-helpers.md#c.drm_atomic_helper_connector_reset "drm_atomic_helper_connector_reset").

int drm_atomic_helper_connector_hdmi_check(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
enum [drm_mode_status](drm-kms.md#c.drm_mode_status "drm_mode_status") drm_hdmi_connector_mode_valid(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, const struct [drm_display_mode](drm-kms.md#c.drm_display_mode "drm_display_mode") \*mode)
...
int drm_atomic_helper_connector_hdmi_update_infoframes(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, struct [drm_atomic_state](drm-kms.md#c.drm_atomic_state "drm_atomic_state") \*state)
...
int drm_atomic_helper_connector_hdmi_update_audio_infoframe(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, struct hdmi_audio_infoframe \*frame)
...
int drm_atomic_helper_connector_hdmi_clear_audio_infoframe(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
void drm_atomic_helper_connector_hdmi_hotplug(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, enum [drm_connector_status](drm-kms.md#c.drm_connector_status "drm_connector_status") status)
...
void drm_atomic_helper_connector_hdmi_force(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
int drm_dp_dpcd_read_data(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned int offset, void \*buffer, size_t size)
...
int drm_dp_dpcd_write_data(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned int offset, void \*buffer, size_t size)
...
[`drm_dp_dpcd_read_byte()`](drm-kms-helpers.md#c.drm_dp_dpcd_read_byte "drm_dp_dpcd_read_byte") instead.
...
Returns the number of bytes transferred (1) on success, or a negative
error code on failure. In most of the cases you should be using
[`drm_dp_dpcd_write_byte()`](drm-kms-helpers.md#c.drm_dp_dpcd_write_byte "drm_dp_dpcd_write_byte") instead.

int drm_dp_dpcd_read_byte(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned int offset, u8 \*valuep)
:   read a single byte from the DPCD
...
int drm_dp_dpcd_write_byte(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned int offset, u8 value)
:   write a single byte to the DPCD
...
void drm_dp_lttpr_wake_timeout_setup(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, bool transparent_mode)
...
void drm_dp_dpcd_set_powered(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, bool powered)
...
void drm_dp_dpcd_set_probe(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, bool enable)
...
In most of the cases you want to use [`drm_dp_dpcd_read_data()`](drm-kms-helpers.md#c.drm_dp_dpcd_read_data "drm_dp_dpcd_read_data") instead.
...
In most of the cases you want to use [`drm_dp_dpcd_write_data()`](drm-kms-helpers.md#c.drm_dp_dpcd_write_data "drm_dp_dpcd_write_data") instead.
...
int drm_dp_link_power_up(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned char revision)
...
int drm_dp_link_power_down(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, unsigned char revision)
...
int drm_dp_dpcd_write_payload(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, int vcpid, u8 start_time_slot, u8 time_slot_count)
...
int drm_dp_dpcd_clear_payload(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux)
...
int drm_dp_dpcd_poll_act_handled(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, int timeout_ms)
...
int drm_dp_dump_lttpr_desc(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, enum drm_dp_phy dp_phy)
...
int drm_dp_lttpr_set_transparent_mode(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, bool enable)
...
int drm_dp_lttpr_init(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, int lttpr_count)
...
:   Number of LTTPRs. Between 0 and 8, according to DP standard.
    ...
    See [`drm_dp_lttpr_count()`](drm-kms-helpers.md#c.drm_dp_lttpr_count "drm_dp_lttpr_count").
...
bool drm_dp_as_sdp_supported(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, const u8 dpcd[DP_RECEIVER_CAP_SIZE])
...
bool drm_dp_vsc_sdp_supported(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, const u8 dpcd[DP_RECEIVER_CAP_SIZE])
...
ssize_t drm_dp_vsc_sdp_pack(const struct [drm_dp_vsc_sdp](drm-kms-helpers.md#c.drm_dp_vsc_sdp "drm_dp_vsc_sdp") \*vsc, struct [dp_sdp](drm-kms-helpers.md#c.dp_sdp "dp_sdp") \*sdp)
...
int drm_edp_backlight_set_level(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, const struct [drm_edp_backlight_info](drm-kms-helpers.md#c.drm_edp_backlight_info "drm_edp_backlight_info") \*bl, u32 level)
...
int drm_edp_backlight_enable(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, const struct [drm_edp_backlight_info](drm-kms-helpers.md#c.drm_edp_backlight_info "drm_edp_backlight_info") \*bl, const u32 level)
...
int drm_edp_backlight_init(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, struct [drm_edp_backlight_info](drm-kms-helpers.md#c.drm_edp_backlight_info "drm_edp_backlight_info") \*bl, u32 max_luminance, u16 driver_pwm_freq_hz, const u8 edp_dpcd[EDP_DISPLAY_CTL_CAP_SIZE], u32 \*current_level, u8 \*current_mode, bool need_luminance)
...
int drm_lspcon_set_mode(const struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct i2c_adapter \*adapter, enum [drm_lspcon_mode](drm-kms-helpers.md#c.drm_lspcon_mode "drm_lspcon_mode") mode, int time_out)
...
:   Relative Address of the MST branch.
    For [`drm_dp_mst_topology_mgr.mst_primary`](drm-kms-helpers.md#c.drm_dp_mst_topology_mgr "drm_dp_mst_topology_mgr"), it’s rad[8] are all 0,
...
int drm_dp_add_payload_part2(struct [drm_dp_mst_topology_mgr](drm-kms-helpers.md#c.drm_dp_mst_topology_mgr "drm_dp_mst_topology_mgr") \*mgr, struct [drm_dp_mst_atomic_payload](drm-kms-helpers.md#c.drm_dp_mst_atomic_payload "drm_dp_mst_atomic_payload") \*payload)
...
enum [drm_dp_mst_mode](drm-kms-helpers.md#c.drm_dp_mst_mode "drm_dp_mst_mode") drm_dp_read_mst_cap(struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*aux, const u8 dpcd[DP_RECEIVER_CAP_SIZE])
...
[`enum drm_dp_mst_mode`](drm-kms-helpers.md#c.drm_dp_mst_mode "drm_dp_mst_mode") to indicate MST mode capability
...
void drm_dp_mst_topology_queue_probe(struct [drm_dp_mst_topology_mgr](drm-kms-helpers.md#c.drm_dp_mst_topology_mgr "drm_dp_mst_topology_mgr") \*mgr)
...
struct [drm_dp_aux](drm-kms-helpers.md#c.drm_dp_aux "drm_dp_aux") \*drm_dp_mst_aux_for_parent(struct [drm_dp_mst_port](drm-kms-helpers.md#c.drm_dp_mst_port "drm_dp_mst_port") \*port)
...
Use [`mipi_dbi_dev_init()`](drm-kms-helpers.md#c.mipi_dbi_dev_init "mipi_dbi_dev_init") if you want native RGB565 and emulated XRGB8888 format.
...
:   sent as-is. If not the caller is responsible for swapping the bytes
    before calling [`mipi_dbi_command_buf()`](drm-kms-helpers.md#c.mipi_dbi_command_buf "mipi_dbi_command_buf") and the buffer is sent 8 bpw.
...
Please replace calls of it with [`mipi_dsi_generic_write_seq_multi()`](drm-kms-helpers.md#c.mipi_dsi_generic_write_seq_multi "mipi_dsi_generic_write_seq_multi").
...
This function is deprecated. Use [`mipi_dsi_turn_on_peripheral_multi()`](drm-kms-helpers.md#c.mipi_dsi_turn_on_peripheral_multi "mipi_dsi_turn_on_peripheral_multi") instead.

**Return**

0 on success or a negative error code on failure.

int mipi_dsi_compression_mode_ext(struct [mipi_dsi_device](drm-kms-helpers.md#c.mipi_dsi_device "mipi_dsi_device") \*dsi, bool enable, enum mipi_dsi_compression_algo algo, unsigned int pps_selector)
...
This function is deprecated. Use [`mipi_dsi_compression_mode_ext_multi()`](drm-kms-helpers.md#c.mipi_dsi_compression_mode_ext_multi "mipi_dsi_compression_mode_ext_multi") instead.

**Return**

0 on success or a negative error code on failure.

int mipi_dsi_compression_mode(struct [mipi_dsi_device](drm-kms-helpers.md#c.mipi_dsi_device "mipi_dsi_device") \*dsi, bool enable)
:   enable/disable DSC on the peripheral
...
int mipi_dsi_picture_parameter_set(struct [mipi_dsi_device](drm-kms-helpers.md#c.mipi_dsi_device "mipi_dsi_device") \*dsi, const struct [drm_dsc_picture_parameter_set](drm-kms-helpers.md#c.drm_dsc_picture_parameter_set "drm_dsc_picture_parameter_set") \*pps)
...
This function is deprecated. Use [`mipi_dsi_picture_parameter_set_multi()`](drm-kms-helpers.md#c.mipi_dsi_picture_parameter_set_multi "mipi_dsi_picture_parameter_set_multi") instead.
...
int mipi_dsi_generic_write_chatty(struct [mipi_dsi_device](drm-kms-helpers.md#c.mipi_dsi_device "mipi_dsi_device") \*dsi, const void \*payload, size_t size)
:   [`mipi_dsi_generic_write()`](drm-kms-helpers.md#c.mipi_dsi_generic_write "mipi_dsi_generic_write") w/ an error log
...
Like [`mipi_dsi_generic_write()`](drm-kms-helpers.md#c.mipi_dsi_generic_write "mipi_dsi_generic_write") but includes a `dev_err()`
...
void mipi_dsi_generic_write_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, const void \*payload, size_t size)
:   [`mipi_dsi_generic_write_chatty()`](drm-kms-helpers.md#c.mipi_dsi_generic_write_chatty "mipi_dsi_generic_write_chatty") w/ accum_err
...
Like [`mipi_dsi_generic_write_chatty()`](drm-kms-helpers.md#c.mipi_dsi_generic_write_chatty "mipi_dsi_generic_write_chatty") but deals with errors in a way that
...
[`drm_bridge_funcs.atomic_get_input_bus_fmts`](drm-kms-helpers.md#c.drm_bridge_funcs "drm_bridge_funcs") operation to ascertain
...
int mipi_dsi_dcs_write_buffer_chatty(struct [mipi_dsi_device](drm-kms-helpers.md#c.mipi_dsi_device "mipi_dsi_device") \*dsi, const void \*data, size_t len)
:   [`mipi_dsi_dcs_write_buffer()`](drm-kms-helpers.md#c.mipi_dsi_dcs_write_buffer "mipi_dsi_dcs_write_buffer") w/ an error log
...
Like [`mipi_dsi_dcs_write_buffer()`](drm-kms-helpers.md#c.mipi_dsi_dcs_write_buffer "mipi_dsi_dcs_write_buffer") but includes a `dev_err()`
call for you and returns 0 upon success, not the number of bytes sent.
...
void mipi_dsi_dcs_write_buffer_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, const void \*data, size_t len)
:   [`mipi_dsi_dcs_write_buffer_chatty()`](drm-kms-helpers.md#c.mipi_dsi_dcs_write_buffer_chatty "mipi_dsi_dcs_write_buffer_chatty") w/ accum_err
...
Like [`mipi_dsi_dcs_write_buffer_chatty()`](drm-kms-helpers.md#c.mipi_dsi_dcs_write_buffer_chatty "mipi_dsi_dcs_write_buffer_chatty") but deals with errors in a way that
makes it convenient to make several calls in a row.
...
This function is deprecated. Use [`mipi_dsi_dcs_nop_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_nop_multi "mipi_dsi_dcs_nop_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_soft_reset_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_soft_reset_multi "mipi_dsi_dcs_soft_reset_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_enter_sleep_mode_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_enter_sleep_mode_multi "mipi_dsi_dcs_enter_sleep_mode_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_exit_sleep_mode_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_exit_sleep_mode_multi "mipi_dsi_dcs_exit_sleep_mode_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_display_off_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_off_multi "mipi_dsi_dcs_set_display_off_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_display_on_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_on_multi "mipi_dsi_dcs_set_display_on_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_column_address_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_column_address_multi "mipi_dsi_dcs_set_column_address_multi")
instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_page_address_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_page_address_multi "mipi_dsi_dcs_set_page_address_multi")
instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_tear_on_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_tear_on_multi "mipi_dsi_dcs_set_tear_on_multi") instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_pixel_format_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_pixel_format_multi "mipi_dsi_dcs_set_pixel_format_multi")
instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_tear_scanline_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_tear_scanline_multi "mipi_dsi_dcs_set_tear_scanline_multi")
instead.
...
This function is deprecated. Use [`mipi_dsi_dcs_set_display_brightness_multi()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_brightness_multi "mipi_dsi_dcs_set_display_brightness_multi")
instead.
...
void mipi_dsi_picture_parameter_set_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, const struct [drm_dsc_picture_parameter_set](drm-kms-helpers.md#c.drm_dsc_picture_parameter_set "drm_dsc_picture_parameter_set") \*pps)
:   transmit the DSC PPS to the peripheral
...
Like [`mipi_dsi_picture_parameter_set()`](drm-kms-helpers.md#c.mipi_dsi_picture_parameter_set "mipi_dsi_picture_parameter_set") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_compression_mode_ext_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, bool enable, enum mipi_dsi_compression_algo algo, unsigned int pps_selector)
:   enable/disable DSC on the peripheral
...
Like [`mipi_dsi_compression_mode_ext()`](drm-kms-helpers.md#c.mipi_dsi_compression_mode_ext "mipi_dsi_compression_mode_ext") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_compression_mode_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, bool enable)
:   enable/disable DSC on the peripheral
...
void mipi_dsi_dcs_nop_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
:   send DCS NOP packet
...
Like [`mipi_dsi_dcs_nop()`](drm-kms-helpers.md#c.mipi_dsi_dcs_nop "mipi_dsi_dcs_nop") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_enter_sleep_mode_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
...
Like [`mipi_dsi_dcs_enter_sleep_mode()`](drm-kms-helpers.md#c.mipi_dsi_dcs_enter_sleep_mode "mipi_dsi_dcs_enter_sleep_mode") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_exit_sleep_mode_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
...
Like [`mipi_dsi_dcs_exit_sleep_mode()`](drm-kms-helpers.md#c.mipi_dsi_dcs_exit_sleep_mode "mipi_dsi_dcs_exit_sleep_mode") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_display_off_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
...
Like [`mipi_dsi_dcs_set_display_off()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_off "mipi_dsi_dcs_set_display_off") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_display_on_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
...
Like [`mipi_dsi_dcs_set_display_on()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_on "mipi_dsi_dcs_set_display_on") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_tear_on_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, enum [mipi_dsi_dcs_tear_mode](drm-kms-helpers.md#c.mipi_dsi_dcs_tear_mode "mipi_dsi_dcs_tear_mode") mode)
...
Like [`mipi_dsi_dcs_set_tear_on()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_tear_on "mipi_dsi_dcs_set_tear_on") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_turn_on_peripheral_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
:   sends a Turn On Peripheral command
...
Like [`mipi_dsi_turn_on_peripheral()`](drm-kms-helpers.md#c.mipi_dsi_turn_on_peripheral "mipi_dsi_turn_on_peripheral") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_tear_off_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
...
void mipi_dsi_dcs_soft_reset_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx)
:   perform a software reset of the display module
...
Like [`mipi_dsi_dcs_soft_reset()`](drm-kms-helpers.md#c.mipi_dsi_dcs_soft_reset "mipi_dsi_dcs_soft_reset") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_display_brightness_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, u16 brightness)
:   sets the brightness value of the display
...
Like [`mipi_dsi_dcs_set_display_brightness()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_display_brightness "mipi_dsi_dcs_set_display_brightness") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_pixel_format_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, u8 format)
:   sets the pixel format for the RGB image data used by the interface
...
Like [`mipi_dsi_dcs_set_pixel_format()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_pixel_format "mipi_dsi_dcs_set_pixel_format") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_column_address_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, u16 start, u16 end)
:   define the column extent of the frame memory accessed by the host processor
...
Like [`mipi_dsi_dcs_set_column_address()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_column_address "mipi_dsi_dcs_set_column_address") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_page_address_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, u16 start, u16 end)
:   define the page extent of the frame memory accessed by the host processor
...
Like [`mipi_dsi_dcs_set_page_address()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_page_address "mipi_dsi_dcs_set_page_address") but deals with errors in a way that
makes it convenient to make several calls in a row.

void mipi_dsi_dcs_set_tear_scanline_multi(struct [mipi_dsi_multi_context](drm-kms-helpers.md#c.mipi_dsi_multi_context "mipi_dsi_multi_context") \*ctx, u16 scanline)
:   set the scanline to use as trigger for the Tearing Effect output signal of the display module
...
Like [`mipi_dsi_dcs_set_tear_scanline()`](drm-kms-helpers.md#c.mipi_dsi_dcs_set_tear_scanline "mipi_dsi_dcs_set_tear_scanline") but deals with errors in a way that
makes it convenient to make several calls in a row.
...
void drm_dsc_dump_config(struct [drm_printer](drm-internals.md#c.drm_printer "drm_printer") \*p, int indent, const struct [drm_dsc_config](drm-kms-helpers.md#c.drm_dsc_config "drm_dsc_config") \*cfg)
...
void drmm_kms_helper_poll_init(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev)
:   initialize and enable output polling
...
This function initializes and then also enables output polling support for
**dev** similar to [`drm_kms_helper_poll_init()`](drm-kms-helpers.md#c.drm_kms_helper_poll_init "drm_kms_helper_poll_init"). Polling will automatically be
cleaned up when the DRM device goes away.

See [`drm_kms_helper_poll_init()`](drm-kms-helpers.md#c.drm_kms_helper_poll_init "drm_kms_helper_poll_init") for more information.
...
int drm_connector_helper_detect_from_ddc(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, struct [drm_modeset_acquire_ctx](drm-kms.md#c.drm_modeset_acquire_ctx "drm_modeset_acquire_ctx") \*ctx, bool force)
...
Detects the connector status by reading the EDID using [`drm_probe_ddc()`](drm-kms-helpers.md#c.drm_probe_ddc "drm_probe_ddc"),
...
The connector status as defined by [`enum drm_connector_status`](drm-kms.md#c.drm_connector_status "drm_connector_status").
...
void drm_edid_get_product_id(const struct [drm_edid](drm-kms-helpers.md#c.drm_edid_get_product_id "drm_edid") \*drm_edid, struct drm_edid_product_id \*id)
...
void drm_edid_print_product_id(struct [drm_printer](drm-internals.md#c.drm_printer "drm_printer") \*p, const struct drm_edid_product_id \*id, bool raw)
...
u32 drm_edid_get_panel_id(const struct [drm_edid](drm-kms-helpers.md#c.drm_edid_get_panel_id "drm_edid") \*drm_edid)
...
Caller should call [`drm_edid_free()`](drm-kms-helpers.md#c.drm_edid_free "drm_edid_free") after use.
...
bool drm_edid_match(const struct [drm_edid](drm-kms-helpers.md#c.drm_edid_match "drm_edid") \*drm_edid, const struct drm_edid_ident \*ident)
...
int drm_add_modes_noedid(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, unsigned int hdisplay, unsigned int vdisplay)
...
bool drm_rect_overlap(const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*a, const struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*b)
...
void drm_helper_mode_fill_fb_struct(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_framebuffer](drm-kms.md#c.drm_framebuffer "drm_framebuffer") \*fb, const struct [drm_format_info](drm-kms.md#c.drm_format_info "drm_format_info") \*info, const struct [drm_mode_fb_cmd2](drm-uapi.md#c.drm_mode_fb_cmd2 "drm_mode_fb_cmd2") \*mode_cmd)
...
See also:
[`drm_kms_helper_poll_disable()`](drm-kms-helpers.md#c.drm_kms_helper_poll_disable "drm_kms_helper_poll_disable") and `drm_client_dev_suspend()`.
...
See also:
`drm_client_dev_resume()` and [`drm_kms_helper_poll_enable()`](drm-kms-helpers.md#c.drm_kms_helper_poll_enable "drm_kms_helper_poll_enable").
