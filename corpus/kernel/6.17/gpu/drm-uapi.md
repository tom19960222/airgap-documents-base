...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/drm-uapi.html
fetched_at: 2026-09-16T16:27:47+00:00
---
# Userland interfaces
...
[`dma_fence_set_error()`](../driver-api/dma-buf.md#c.dma_fence_set_error "dma_fence_set_error") on how to do this and for examples of error codes to use.
...
context, the DRM scheduler provides the [`drm_sched_entity_error()`](drm-mm.md#c.drm_sched_entity_error "drm_sched_entity_error") function as
...
[`drm_dev_wedged_event()`](drm-internals.md#c.drm_dev_wedged_event "drm_dev_wedged_event") in DRM subsystem), which notifies userspace of ‘wedged’
...
long drm_ioctl(struct [file](../filesystems/api-summary.md#c.file "file") \*filp, unsigned int cmd, unsigned long arg)
...
long drm_compat_ioctl(struct [file](../filesystems/api-summary.md#c.file "file") \*filp, unsigned int cmd, unsigned long arg)
...
array of [`struct drm_plane_size_hint`](drm-uapi.md#c.drm_plane_size_hint "drm_plane_size_hint").
...
See [Using the Linux Kernel Tracepoints](../trace/tracepoints.md) for information about using
...
- `dev` - the [`dev_name()`](../driver-api/infrastructure.md#c.dev_name "dev_name") of the device running the job.
- `ring` - the hardware ring running the job. Together with `dev` it
  uniquely identifies where the job is going to be executed.
- `fence` - the [`struct dma_fence`](../driver-api/dma-buf.md#c.dma_fence "dma_fence").context and the [`struct dma_fence`](../driver-api/dma-buf.md#c.dma_fence "dma_fence").seqno of
  [`struct drm_sched_fence`](drm-mm.md#c.drm_sched_fence "drm_sched_fence").finished

All the events depends on [`drm_sched_job_arm()`](drm-mm.md#c.drm_sched_job_arm "drm_sched_job_arm") having been called already for
the job because they use [`struct drm_sched_job`](drm-mm.md#c.drm_sched_job "drm_sched_job").sched or
[`struct drm_sched_job`](drm-mm.md#c.drm_sched_job "drm_sched_job").s_fence.
