...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/amdgpu/display/mpo-overview.html
fetched_at: 2026-09-16T16:39:23+00:00
---
# Multiplane Overlay (MPO)

> **Note:**
>
> You will get more from this page if you have already read the
...
> **Note:**
>
> Keep in mind that MPO is all about power-saving; if you want to learn
> more about power-save in the display context, check the link:
> [Power](https://gitlab.freedesktop.org/pq/color-and-hdr/-/blob/main/doc/power.rst).
...
> **Note:**
>
> Keep in mind that different ASICs might expose other numbers of
> planes.

For this hardware example, we have 4 pipes (if you don’t know what AMD pipe
means, look at ‘[Display Core Next (DCN)](dcn-overview.md)’, section
...
![../../../_images/mpo-cursor.svg](../../../_images/mpo-cursor.svg)
...
> **Note:**
>
> Keep in mind that we could extend this configuration to more planes,
...
![../../../_images/single-display-mpo.svg](../../../_images/single-display-mpo.svg)
> **Note:**
>
> We could extend this behavior to more planes, but that is currently
...
![../../../_images/multi-display-hdcp-mpo.svg](../../../_images/multi-display-hdcp-mpo.svg)
...
![../../../_images/multi-display-hdcp-mpo-less-pipe-ex.svg](../../../_images/multi-display-hdcp-mpo-less-pipe-ex.svg)
