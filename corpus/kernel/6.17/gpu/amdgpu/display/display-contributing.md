...
collection: kernel
version: "6.17"
title: "AMDGPU - Display Contributions"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/amdgpu/display/display-contributing.html
fetched_at: 2026-09-16T16:39:24+00:00
---
...
[IGT](https://gitlab.freedesktop.org/drm/igt-gpu-tools) provides many integration tests that can be run on your GPU. We always
...
The Ftrace debug feature (check ‘[ftrace - Function Tracer](../../../trace/ftrace.md)’) is a
...
‘[Multiplane Overlay (MPO)](mpo-overview.md)’) which is intended to
