...
collection: kernel
version: "6.17"
title: "DC Programming Model"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/amdgpu/display/programming-model-dcn.html
fetched_at: 2026-09-16T16:39:22+00:00
---
# DC Programming Model

In the [Display Core Next (DCN)](dcn-overview.md#dcn-overview) and [DCN Block](dcn-blocks.md#dcn-blocks) pages, you learned about the hardware components and how they
...
Core Next (DCN)](dcn-overview.md#dcn-overview)); still, it is worth bringing back for this
