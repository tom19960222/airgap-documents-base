...
collection: kernel
version: "6.17"
title: "Display Core Debug tools"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/amdgpu/display/dc-debug.html
...
- **The DC version (e.g., v3.2.285)**: Display developers release a new DC version
  ...
  version of the display code. Remember from page [Display Core](index.md#amdgpu-display-core),
