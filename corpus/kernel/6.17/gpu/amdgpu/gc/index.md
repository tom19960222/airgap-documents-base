...
collection: kernel
version: "6.17"
title: "drm/amdgpu - Graphics and Compute (GC)"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/amdgpu/gc/index.html
...
:   The name for the hardware block that encompasses the front end of the
    ...
    :   This is the engine for managing queues. For more details check
        [MicroEngine Scheduler (MES)](mes.md#amdgpu-mes).
...
- [MicroEngine Scheduler (MES)](mes.md)
