...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/drm-client.html
fetched_at: 2026-09-16T16:27:48+00:00
---
# Kernel clients
...
int drm_client_buffer_vmap_local(struct [drm_client_buffer](drm-client.md#c.drm_client_buffer "drm_client_buffer") \*buffer, struct [iosys_map](../driver-api/device-io.md#c.iosys_map "iosys_map") \*map_copy)
...
[`drm_client_buffer_vmap_local()`](drm-client.md#c.drm_client_buffer_vmap_local "drm_client_buffer_vmap_local") should be closely followed by a call to
[`drm_client_buffer_vunmap_local()`](drm-client.md#c.drm_client_buffer_vunmap_local "drm_client_buffer_vunmap_local"). See [`drm_client_buffer_vmap()`](drm-client.md#c.drm_client_buffer_vmap "drm_client_buffer_vmap") for
long-term mappings.
...
void drm_client_buffer_vunmap_local(struct [drm_client_buffer](drm-client.md#c.drm_client_buffer "drm_client_buffer") \*buffer)
...
with [`drm_client_buffer_vunmap_local()`](drm-client.md#c.drm_client_buffer_vunmap_local "drm_client_buffer_vunmap_local"). Calling this function is only
...
void drm_client_dev_unregister(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev)
:   Unregister clients
...
[`drm_client_funcs.unregister`](drm-client.md#c.drm_client_funcs "drm_client_funcs") callback. The callback function
is responsibe for releaseing all resources including the client
itself.

The helper [`drm_dev_unregister()`](drm-internals.md#c.drm_dev_unregister "drm_dev_unregister") calls this function. Drivers
