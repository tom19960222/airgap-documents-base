...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/xe/xe_rtp.html
...
`size_t n_entries`
:   Number of entries to process, usually ARRAY_SIZE(entries)
...
rules. One difference from [`xe_rtp_process_to_sr()`](xe_rtp.md#c.xe_rtp_process_to_sr "xe_rtp_process_to_sr"): there is no action
