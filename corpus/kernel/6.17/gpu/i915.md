...
collection: kernel
version: "6.17"
title: "drm/i915 Intel GFX Driver"
source_url: https://www.kernel.org/doc/html/v6.17/gpu/i915.html
fetched_at: 2026-09-16T16:26:49+00:00
---
...
call to [`intel_runtime_pm_put_raw()`](i915.md#c.intel_runtime_pm_put_raw "intel_runtime_pm_put_raw") to release the reference again.

**Return**

the wakeref cookie to pass to [`intel_runtime_pm_put_raw()`](i915.md#c.intel_runtime_pm_put_raw "intel_runtime_pm_put_raw"), evaluates
...
Any runtime pm reference obtained by this function must have a symmetric
call to [`intel_runtime_pm_put()`](i915.md#c.intel_runtime_pm_put "intel_runtime_pm_put") to release the reference again.

**Return**

the wakeref cookie to pass to [`intel_runtime_pm_put()`](i915.md#c.intel_runtime_pm_put "intel_runtime_pm_put")
...
the wakeref cookie to pass to [`intel_runtime_pm_put()`](i915.md#c.intel_runtime_pm_put "intel_runtime_pm_put"), evaluates
as True if the wakeref was acquired, or False otherwise.
...
[`intel_runtime_pm_get_raw()`](i915.md#c.intel_runtime_pm_get_raw "intel_runtime_pm_get_raw") and might power down the corresponding
...
This function drops the device-level runtime pm reference obtained by
[`intel_runtime_pm_get()`](i915.md#c.intel_runtime_pm_get "intel_runtime_pm_get") and might power down the corresponding
hardware block right away if this is the last reference.

This function exists only for historical reasons and should be avoided in
new code, as the correctness of its use cannot be checked. Always use
[`intel_runtime_pm_put()`](i915.md#c.intel_runtime_pm_put "intel_runtime_pm_put") instead.
...
This function is a wrapper around [`intel_uncore_forcewake_get()`](i915.md#c.intel_uncore_forcewake_get "intel_uncore_forcewake_get") to acquire
...
This function complements [`intel_uncore_forcewake_user_get()`](i915.md#c.intel_uncore_forcewake_user_get "intel_uncore_forcewake_user_get") and releases
...
See [`intel_uncore_forcewake_get()`](i915.md#c.intel_uncore_forcewake_get "intel_uncore_forcewake_get"). This variant places the onus
...
domains obtained by [`intel_uncore_forcewake_get()`](i915.md#c.intel_uncore_forcewake_get "intel_uncore_forcewake_get").
...
See [`intel_uncore_forcewake_put()`](i915.md#c.intel_uncore_forcewake_put "intel_uncore_forcewake_put"). This variant places the onus
on the caller to explicitly handle the dev_priv->uncore.lock spinlock.
...
- GT workarounds: the list of these WAs is applied whenever these registers
  revert to their default values: on GPU reset, suspend/resume [[1]](i915.md#id2), etc.
...
frontbuffer slots through [`intel_frontbuffer_track()`](i915.md#c.intel_frontbuffer_track "intel_frontbuffer_track"). The functions in this
...
bool intel_set_cpu_fifo_underrun_reporting(struct intel_display \*display, enum [pipe](i915.md#c.intel_set_cpu_fifo_underrun_reporting "pipe") pipe, bool enable)
...
void intel_cpu_fifo_underrun_irq_handler(struct intel_display \*display, enum [pipe](i915.md#c.intel_cpu_fifo_underrun_irq_handler "pipe") pipe)
...
void intel_plane_destroy(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane)
:   destroy a plane
...
struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*intel_plane_duplicate_state(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane)
...
void intel_plane_destroy_state(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane, struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*state)
:   destroy plane state
...
int intel_prepare_plane_fb(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*_plane, struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*_new_plane_state)
...
void intel_cleanup_plane_fb(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane, struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*_old_plane_state)
...
The platform independent interrupt handler [`intel_hpd_irq_handler()`](i915.md#c.intel_hpd_irq_handler "intel_hpd_irq_handler") in
...
uevent to userspace via [`drm_kms_helper_hotplug_event()`](drm-kms-helpers.md#c.drm_kms_helper_hotplug_event "drm_kms_helper_hotplug_event").
...
enum hpd_pin intel_hpd_pin_default(enum [port](i915.md#c.intel_hpd_pin_default "port") port)
...
Also see: [`intel_hpd_poll_enable()`](i915.md#c.intel_hpd_poll_enable "intel_hpd_poll_enable") and [`intel_hpd_poll_disable()`](i915.md#c.intel_hpd_poll_disable "intel_hpd_poll_disable").
...
Also see: [`intel_hpd_init()`](i915.md#c.intel_hpd_init "intel_hpd_init") and [`intel_hpd_poll_disable()`](i915.md#c.intel_hpd_poll_disable "intel_hpd_poll_disable").
...
Also see: [`intel_hpd_init()`](i915.md#c.intel_hpd_init "intel_hpd_init") and [`intel_hpd_poll_enable()`](i915.md#c.intel_hpd_poll_enable "intel_hpd_poll_enable").
...
The call must be followed by calling [`intel_hpd_unblock()`](i915.md#c.intel_hpd_unblock "intel_hpd_unblock"), or
[`intel_hpd_clear_and_unblock()`](i915.md#c.intel_hpd_clear_and_unblock "intel_hpd_clear_and_unblock").
...
previously blocked by [`intel_hpd_block()`](i915.md#c.intel_hpd_block "intel_hpd_block"). Any HPD IRQ raised on the
...
The struct [`i915_audio_component`](i915.md#c.i915_audio_component "i915_audio_component") is used to interact between the graphics
and audio drivers. The struct `i915_audio_component_ops` **ops** in it is
defined in graphics driver and called in audio driver. The
struct `i915_audio_component_audio_ops` **audio_ops** is called from i915 driver.

void intel_audio_codec_enable(struct intel_encoder \*encoder, const struct intel_crtc_state \*crtc_state, const struct [drm_connector_state](drm-kms.md#c.drm_connector_state "drm_connector_state") \*conn_state)
...
void intel_audio_codec_disable(struct intel_encoder \*encoder, const struct intel_crtc_state \*old_crtc_state, const struct [drm_connector_state](drm-kms.md#c.drm_connector_state "drm_connector_state") \*old_conn_state)
...
initializes an instance of [`struct i915_audio_component`](i915.md#c.i915_audio_component "i915_audio_component") which it receives
...
void intel_lpe_audio_notify(struct intel_display \*display, enum transcoder cpu_transcoder, enum [port](i915.md#c.intel_lpe_audio_notify "port") port, const void \*eld, int ls_clock, bool dp_output)
...
update. For this integration [`intel_psr_invalidate()`](i915.md#c.intel_psr_invalidate "intel_psr_invalidate") and [`intel_psr_flush()`](i915.md#c.intel_psr_flush "intel_psr_flush")
...
void intel_psr_disable(struct [intel_dp](i915.md#c.intel_psr_disable "intel_dp") \*intel_dp, const struct intel_crtc_state \*old_crtc_state)
:   Disable PSR
...
void intel_psr_pause(struct [intel_dp](i915.md#c.intel_psr_pause "intel_dp") \*intel_dp)
:   Pause PSR
...
void intel_psr_resume(struct [intel_dp](i915.md#c.intel_psr_resume "intel_dp") \*intel_dp)
:   Resume PSR
...
:   Minimum vblank delay needed by PSR
...
void intel_psr_init(struct [intel_dp](i915.md#c.intel_psr_init "intel_dp") \*intel_dp)
...
bool intel_psr_link_ok(struct [intel_dp](i915.md#c.intel_psr_link_ok "intel_dp") \*intel_dp)
:   return psr->link_ok
...
For integration with frontbuffer tracking code, [`intel_drrs_invalidate()`](i915.md#c.intel_drrs_invalidate "intel_drrs_invalidate")
and [`intel_drrs_flush()`](i915.md#c.intel_drrs_flush "intel_drrs_flush") are called.
...
void intel_dmc_block_pkgc(struct intel_display \*display, enum [pipe](i915.md#c.intel_dmc_block_pkgc "pipe") pipe, bool block)
:   block PKG C-state
...
void intel_dmc_start_pkgc_exit_at_start_of_undelayed_vblank(struct intel_display \*display, enum [pipe](i915.md#c.intel_dmc_start_pkgc_exit_at_start_of_undelayed_vblank "pipe") pipe, bool enable)
...
resources released in [`intel_dmc_suspend()`](i915.md#c.intel_dmc_suspend "intel_dmc_suspend").
...
The VBT consists of a VBT Header (defined as [`struct vbt_header`](i915.md#c.vbt_header "vbt_header")), a BDB
Header ([`struct bdb_header`](i915.md#c.bdb_header "bdb_header")), and a number of BIOS Data Blocks (BDB) that
...
:   Free any resources allocated by [`intel_bios_init()`](i915.md#c.intel_bios_init "intel_bios_init")
...
bool intel_bios_is_port_present(struct intel_display \*display, enum [port](i915.md#c.intel_bios_is_port_present "port") port)
...
bool intel_bios_is_dsi_present(struct intel_display \*display, enum [port](i915.md#c.intel_bios_is_dsi_present "port") \*port)
...
`bdb_offset`
:   Offset of [`struct bdb_header`](i915.md#c.bdb_header "bdb_header") from beginning of VBT
...
[`intel_dpll_init()`](i915.md#c.intel_dpll_init "intel_dpll_init") initializes the PLLs for the given platform. The
users of a PLL are tracked and that tracking is integrated with the atomic
modset interface. During an atomic operation, required PLLs can be reserved
for a given CRTC and encoder configuration by calling
[`intel_dpll_reserve()`](i915.md#c.intel_dpll_reserve "intel_dpll_reserve") and previously reserved PLLs can be released
with [`intel_dpll_release()`](i915.md#c.intel_dpll_release "intel_dpll_release").
Changes to the users are first staged in the atomic state, and then made
effective by calling [`intel_dpll_swap_state()`](i915.md#c.intel_dpll_swap_state "intel_dpll_swap_state") during the atomic
commit phase.

struct [intel_dpll](i915.md#c.intel_dpll "intel_dpll") \*intel_get_dpll_by_id(struct intel_display \*display, enum [intel_dpll_id](i915.md#c.intel_dpll_id "intel_dpll_id") id)
...
void intel_dpll_crtc_get(const struct intel_crtc \*crtc, const struct [intel_dpll](i915.md#c.intel_dpll "intel_dpll") \*pll, struct [intel_dpll_state](i915.md#c.intel_dpll_state "intel_dpll_state") \*dpll_state)
...
void intel_dpll_crtc_put(const struct intel_crtc \*crtc, const struct [intel_dpll](i915.md#c.intel_dpll "intel_dpll") \*pll, struct [intel_dpll_state](i915.md#c.intel_dpll_state "intel_dpll_state") \*dpll_state)
...
This is the dpll version of [`drm_atomic_helper_swap_state()`](drm-kms-helpers.md#c.drm_atomic_helper_swap_state "drm_atomic_helper_swap_state") since the
...
calling [`intel_dpll_swap_state()`](i915.md#c.intel_dpll_swap_state "intel_dpll_swap_state").
...
[`intel_dpll_release()`](i915.md#c.intel_dpll_release "intel_dpll_release").
...
This function releases all DPLLs reserved by [`intel_dpll_reserve()`](i915.md#c.intel_dpll_reserve "intel_dpll_reserve")
...
from the port DPLLs reserved previously by [`intel_dpll_reserve()`](i915.md#c.intel_dpll_reserve "intel_dpll_reserve"). The
DPLL selected will be based on the current mode of the encoder’s port.

int intel_dpll_get_freq(struct intel_display \*display, const struct [intel_dpll](i915.md#c.intel_dpll "intel_dpll") \*pll, const struct intel_dpll_hw_state \*dpll_hw_state)
...
bool intel_dpll_get_hw_state(struct intel_display \*display, struct [intel_dpll](i915.md#c.intel_dpll "intel_dpll") \*pll, struct intel_dpll_hw_state \*dpll_hw_state)
...
void intel_dpll_dump_hw_state(struct intel_display \*display, struct [drm_printer](drm-internals.md#c.drm_printer "drm_printer") \*p, const struct intel_dpll_hw_state \*dpll_hw_state)
:   dump hw_state
...
`wakeref`
:   In some platforms a device-level runtime pm reference may
...
Takes gt->mcr_lock. uncore->lock should *not* be held when this
...
Releases the lock acquired by [`intel_gt_mcr_lock()`](i915.md#c.intel_gt_mcr_lock "intel_gt_mcr_lock").
...
domains; use [`intel_gt_mcr_multicast_write()`](i915.md#c.intel_gt_mcr_multicast_write "intel_gt_mcr_multicast_write") in cases where forcewake should
...
domains; use [`intel_gt_mcr_multicast_rmw()`](i915.md#c.intel_gt_mcr_multicast_rmw "intel_gt_mcr_multicast_rmw") in cases where forcewake should
be obtained automatically.
...
This function assumes the caller is already holding any necessary forcewake
domains; use [`intel_gt_mcr_read_any()`](i915.md#c.intel_gt_mcr_read_any "intel_gt_mcr_read_any") in cases where forcewake should be
...
[`__intel_wait_for_register_fw()`](i915.md#c.__intel_wait_for_register_fw "__intel_wait_for_register_fw"). Generally this function will only be used
...
3. dma_resv will be the outermost lock (when needed) and ww_acquire_ctx
   is to be hoisted at highest level and passed down within i915_gem_ctx
   in the call chain
4. While holding lru/memory manager (buddy, drm_mm, whatever) locks
   ...
   >   real bad.
5. Do not nest different lru/memory manager locks within each other.
   Take them in turn to update memory allocations, relying on the object’s
   dma_resv ww_mutex to serialize against other operations.
6. The suggestion for lru/memory managers locks is that they are small
   enough to be spinlocks.
7. All features need to come with exhaustive kernel selftests and/or
   IGT tests when appropriate
8. All LMEM uAPI paths need to be fully restartable (`_interruptible()`
...
int i915_gem_evict_for_node(struct i915_address_space \*vm, struct i915_gem_ww_ctx \*ww, struct [drm_mm_node](drm-mm.md#c.drm_mm_node "drm_mm_node") \*target, unsigned int flags)
:   Evict vmas to make room for binding a new one
...
`struct i915_gem_ww_ctx *ww`
:   An optional `struct i915_gem_ww_ctx`. If not NULL, i915_gem_evict_vm
    will be able to evict vma’s locked by the ww as well.

`struct drm_i915_gem_object **busy_bo`
:   Optional pointer to `struct drm_i915_gem_object`. If not NULL, then
    in the event [`i915_gem_evict_vm()`](i915.md#c.i915_gem_evict_vm "i915_gem_evict_vm") is unable to trylock an object for eviction,
...
avoid deadlocks in memory reclaim) must fall back to [`i915_gem_shrink_all()`](i915.md#c.i915_gem_shrink_all "i915_gem_shrink_all").
...
This is a simple wrapper around [`i915_gem_shrink()`](i915.md#c.i915_gem_shrink "i915_gem_shrink") to aggressively shrink all
...
MUST be balanced with previous call to [`i915_gem_object_make_unshrinkable()`](i915.md#c.i915_gem_object_make_unshrinkable "i915_gem_object_make_unshrinkable").
...
`vm`
:   See [`i915_gem_context.vm`](i915.md#c.i915_gem_context "i915_gem_context")

`user_flags`
:   See [`i915_gem_context.user_flags`](i915.md#c.i915_gem_context "i915_gem_context")

`sched`
:   See [`i915_gem_context.sched`](i915.md#c.i915_gem_context "i915_gem_context")
...
`single_timeline`
:   See See [`i915_gem_context.syncobj`](i915.md#c.i915_gem_context "i915_gem_context")

`uses_protected_content`
:   See [`i915_gem_context.uses_protected_content`](i915.md#c.i915_gem_context "i915_gem_context")

`pxp_wakeref`
:   See [`i915_gem_context.pxp_wakeref`](i915.md#c.i915_gem_context "i915_gem_context")

**Description**

The [`struct i915_gem_proto_context`](i915.md#c.i915_gem_proto_context "i915_gem_proto_context") represents the creation parameters for
a [`struct i915_gem_context`](i915.md#c.i915_gem_context "i915_gem_context"). This is used to gather parameters provided
...
:   Work item for deferred cleanup, since `i915_gem_context_put()` tends to
    ...
    FIXME: The only real reason for this is [`i915_gem_engines.fence`](i915.md#c.i915_gem_engines "i915_gem_engines"), all
...
`active_count`
:   How many times this context was active during a GPU
...
`handles_vma`
:   rbtree to look up our context specific obj/vma for
...
The [`struct i915_gem_context`](i915.md#c.i915_gem_context "i915_gem_context") represents the combined view of the driver and
...
`lock`
:   protects requests in priority lists, requests, hold and
...
:   indicate request is retired to
    priority tracking
...
int i915_gem_gtt_reserve(struct i915_address_space \*vm, struct i915_gem_ww_ctx \*ww, struct [drm_mm_node](drm-mm.md#c.drm_mm_node "drm_mm_node") \*node, u64 size, u64 offset, unsigned long color, unsigned int flags)
...
:   the [`struct drm_mm_node`](drm-mm.md#c.drm_mm_node "drm_mm_node") (typically i915_vma.node)
...
[`i915_gem_gtt_reserve()`](i915.md#c.i915_gem_gtt_reserve "i915_gem_gtt_reserve") tries to insert the **node** at the exact **offset** inside
the address space (using **size** and **color**). If the **node** does not fit, it
tries to evict any overlapping nodes from the GTT, including any
neighbouring nodes if the colors do not match (to ensure guard pages between
differing domains). See [`i915_gem_evict_for_node()`](i915.md#c.i915_gem_evict_for_node "i915_gem_evict_for_node") for the gory details
...
int i915_gem_gtt_insert(struct i915_address_space \*vm, struct i915_gem_ww_ctx \*ww, struct [drm_mm_node](drm-mm.md#c.drm_mm_node "drm_mm_node") \*node, u64 size, u64 alignment, unsigned long color, u64 start, u64 end, unsigned int flags)
...
[`i915_gem_gtt_insert()`](i915.md#c.i915_gem_gtt_insert "i915_gem_gtt_insert") first searches for an available hole into which
...
searching for an eviction candidate. See [`i915_gem_evict_something()`](i915.md#c.i915_gem_evict_something "i915_gem_evict_something") for
...
[`i915_gem_object_save_bit_17_swizzle()`](i915.md#c.i915_gem_object_save_bit_17_swizzle "i915_gem_object_save_bit_17_swizzle").
...
can be fixed up later on with [`i915_gem_object_do_bit_17_swizzle()`](i915.md#c.i915_gem_object_do_bit_17_swizzle "i915_gem_object_do_bit_17_swizzle"). This must
...
int i915_gem_set_tiling_ioctl(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, void \*data, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
...
int i915_gem_get_tiling_ioctl(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, void \*data, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
...
[`i915_gem_set_tiling_ioctl()`](i915.md#c.i915_gem_set_tiling_ioctl "i915_gem_set_tiling_ioctl") and [`i915_gem_get_tiling_ioctl()`](i915.md#c.i915_gem_get_tiling_ioctl "i915_gem_get_tiling_ioctl") is the userspace
...
`ctrl_gt`
:   pointer to the tile that owns the controls for PXP subsystem assets that
    the VDBOX, the KCR engine (and GSC CS depending on the platform)

`platform_cfg_is_bad`
:   used to track if any prior arb session creation resulted
...
`pxp_component`
:   i915_pxp_component `struct of` the bound mei_pxp
...
`pxp_component_added`
:   track if the pxp component has been added.
...
`arb_is_valid`
:   tracks arb session status.
    After a teardown, the arb session can still be in play on the HW
    even if the keys are gone, so we can’t rely on the HW state of the
    session to know if it’s valid and need to track the status in SW.

`key_instance`
:   tracks which key instance we’re on, so we can use it
...
:   if the HW perceives an attack on the integrity
...
`termination`
:   tracks the status of a pending termination. Only
...
`stalled_request`
:   if GuC can’t process a request for any reason, we
...
`msg_enabled_mask`
:   mask of events that are processed when receiving
    an INTEL_GUC_ACTION_DEFAULT G2H message.

`outstanding_submission_g2h`
:   number of outstanding GuC to Host
...
`serial_slot`
:   id to the initial waiter created in tlb_lookup,
...
`submission_state`
:   sub-structure for submission state protected by
    single lock

`submission_state.lock`
:   protects everything in
...
:   tracks whether we support GuC submission on
...
`ads_regset_count`
:   number of save/restore registers in the ADS for
    each engine
...
`context_lookup`
:   used to resolve intel_context from guc_id, if a
...
`mmio_msg`
:   notification bitmask that the GuC writes in one of its
...
`timestamp`
:   GT timestamp object that stores a copy of the timestamp
    and adjusts it for overflow using a worker.

`timestamp.lock`
:   Lock protecting the below fields and
    the engine stats.

`timestamp.gt_stamp`
:   64-bit extended value of the GT
    timestamp.

`timestamp.ping_delay`
:   Period for polling the GT
    timestamp for overflow.

`timestamp.work`
:   Periodic work to adjust GT timestamp,
...
`dead_guc_worker`
:   Asynchronous worker thread for forcing a GuC reset.
...
:   timestamp of previous ‘dead guc’ occurrence
...
u32 intel_guc_ggtt_offset(struct [intel_guc](i915.md#c.intel_guc "intel_guc") \*guc, struct i915_vma \*vma)
...
GGTT, all gfx objects used by GuC are allocated with [`intel_guc_allocate_vma()`](i915.md#c.intel_guc_allocate_vma "intel_guc_allocate_vma")
...
struct i915_vma \*intel_guc_allocate_vma(struct [intel_guc](i915.md#c.intel_guc "intel_guc") \*guc, u32 size)
...
int intel_guc_fw_upload(struct [intel_guc](i915.md#c.intel_guc "intel_guc") \*guc)
...
> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | **ORIGIN** - originator of the message  - GUC_HXG_ORIGIN_HOST = 0 - GUC_HXG_ORIGIN_GUC = 1 |
> | 30:28 | **TYPE** - message type  - GUC_HXG_TYPE_REQUEST = 0 - GUC_HXG_TYPE_EVENT = 1 - GUC_HXG_TYPE_FAST_REQUEST = 2 - GUC_HXG_TYPE_NO_RESPONSE_BUSY = 3 - GUC_HXG_TYPE_NO_RESPONSE_RETRY = 5 - GUC_HXG_TYPE_RESPONSE_FAILURE = 6 - GUC_HXG_TYPE_RESPONSE_SUCCESS = 7 |
> | 27:0 | **AUX** - auxiliary data (depends on TYPE) |
> | 1 | 31:0 | **PAYLOAD** - optional payload (depends on TYPE) |
> | ... |  |
> | n | 31:0 |

**HXG Request**

The [HXG Request](i915.md#hxg-request) message should be used to initiate synchronous activity
for which confirmation or return data is expected.

The recipient of this message shall use [HXG Response](i915.md#hxg-response), [HXG Failure](i915.md#hxg-failure)
or [HXG Retry](i915.md#hxg-retry) message as a definite reply, and may use [HXG Busy](i915.md#hxg-busy)
...
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_REQUEST](i915.md#guc-hxg-type-request) |
> | 27:16 | **DATA0** - request data (depends on ACTION) |
> | 15:0 | **ACTION** - requested action code |
> | 1 | 31:0 | **DATAn** - optional data (depends on ACTION) |
> | ... |  |
> | n | 31:0 |

**HXG Fast Request**

The [HXG Request](i915.md#hxg-request) message should be used to initiate asynchronous activity
for which confirmation or return data is not expected.

If confirmation is required then [HXG Request](i915.md#hxg-request) shall be used instead.

The recipient of this message may only use [HXG Failure](i915.md#hxg-failure) message if it was
unable to accept this request (like invalid data).

Format of [HXG Fast Request](i915.md#hxg-fast-request) message is same as [HXG Request](i915.md#hxg-request) except **TYPE**.

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN - see [HXG Message](i915.md#hxg-message) |
> | 30:28 | TYPE = [GUC_HXG_TYPE_FAST_REQUEST](i915.md#guc-hxg-type-fast-request) |
> | 27:16 | DATA0 - see [HXG Request](i915.md#hxg-request) |
> | 15:0 | ACTION - see [HXG Request](i915.md#hxg-request) |
> | ... |  | DATAn - see [HXG Request](i915.md#hxg-request) |

**HXG Event**

The [HXG Event](i915.md#hxg-event) message should be used to initiate asynchronous activity
...
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_EVENT](i915.md#guc-hxg-type-event) |
> | 27:16 | **DATA0** - event data (depends on ACTION) |
> | 15:0 | **ACTION** - event action code |
> | 1 | 31:0 | **DATAn** - optional event data (depends on ACTION) |
> | ... |  |
> | n | 31:0 |

**HXG Busy**

The [HXG Busy](i915.md#hxg-busy) message may be used to acknowledge reception of the [HXG Request](i915.md#hxg-request)
...
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_NO_RESPONSE_BUSY](i915.md#guc-hxg-type-no-response-busy) |
> | 27:0 | **COUNTER** - progress indicator |

**HXG Retry**

The [HXG Retry](i915.md#hxg-retry) message should be used by recipient to indicate that the
[HXG Request](i915.md#hxg-request) message was dropped and it should be resent again.
...
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_NO_RESPONSE_RETRY](i915.md#guc-hxg-type-no-response-retry) |
> | 27:0 | **REASON** - reason for retry  - GUC_HXG_RETRY_REASON_UNSPECIFIED = 0 |

**HXG Failure**

The [HXG Failure](i915.md#hxg-failure) message shall be used as a reply to the [HXG Request](i915.md#hxg-request)
message that could not be processed due to an error.

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_RESPONSE_FAILURE](i915.md#guc-hxg-type-response-failure) |
> | 27:16 | **HINT** - additional error hint |
> | 15:0 | **ERROR** - error/result code |

**HXG Response**

The [HXG Response](i915.md#hxg-response) message shall be used as a reply to the [HXG Request](i915.md#hxg-request)
message that was successfully processed without an error.

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN |
> | 30:28 | TYPE = [GUC_HXG_TYPE_RESPONSE_SUCCESS](i915.md#guc-hxg-type-response-success) |
> | 27:0 | **DATA0** - data (depends on ACTION from [HXG Request](i915.md#hxg-request)) |
> | 1 | 31:0 | **DATAn** - data (depends on ACTION from [HXG Request](i915.md#hxg-request)) |
> | ... |  |
> | n | 31:0 |
...
phase to setup the [CTB based communication](i915.md#ctb-based-communication) that will be used afterwards.

**MMIO HXG Message**

Format of the MMIO messages follows definitions of [HXG Message](i915.md#hxg-message).

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31:0 | [Embedded [HXG Message](i915.md#hxg-message)] |
> | ... |  |
> | n | 31:0 |

**CT Buffer**

Circular buffer used to send [CTB Message](i915.md#ctb-message)

**CTB Descriptor**

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31:0 | **HEAD** - offset (in dwords) to the last dword that was read from the [CT Buffer](i915.md#ct-buffer). It can only be updated by the receiver. |
> | 1 | 31:0 | **TAIL** - offset (in dwords) to the last dword that was written to the [CT Buffer](i915.md#ct-buffer). It can only be updated by the sender. |
> | 2 | 31:0 | **STATUS** - status of the CTB  - GUC_CTB_STATUS_NO_ERROR = 0 (normal operation) - GUC_CTB_STATUS_OVERFLOW = 1 (head/tail too large) - GUC_CTB_STATUS_UNDERFLOW = 2 (truncated message) - GUC_CTB_STATUS_MISMATCH = 4 (head/tail modified) - GUC_CTB_STATUS_UNUSED = 8 (CTB is not in use) |
> | ... |  | RESERVED = MBZ |
...
> | 15:12 | **FORMAT** - format of the CTB message  - GUC_CTB_FORMAT_HXG = 0 - see [CTB HXG Message](i915.md#ctb-hxg-message) |
> | 11:8 | **RESERVED** |
...
> | --- | --- | --- |
> | 0 | 31:16 | FENCE |
> | 15:12 | FORMAT = [GUC_CTB_FORMAT_HXG](i915.md#guc-ctb-format-hxg) |
> | 11:8 | RESERVED = MBZ |
> | 7:0 | NUM_DWORDS = length (in dwords) of the embedded HXG message |
> | 1 | 31:0 | [Embedded [HXG Message](i915.md#hxg-message)] |
> | ... |  |
> | n | 31:0 |
...
This message is used by Host KMD to setup of the [GuC Self Config KLVs](i915.md#guc-self-config-klvs).

This message must be sent as [MMIO HXG Message](i915.md#mmio-hxg-message).

> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN = [GUC_HXG_ORIGIN_HOST](i915.md#guc-hxg-origin-host) |
> | 30:28 | TYPE = [GUC_HXG_TYPE_REQUEST](i915.md#guc-hxg-type-request) |
> | 27:16 | DATA0 = MBZ |
> | 15:0 | ACTION = GUC_ACTION_HOST2GUC_SELF_CFG = 0x0508 |
> | 1 | 31:16 | **KLV_KEY** - KLV key, see [GuC Self Config KLVs](i915.md#guc-self-config-klvs) |
> | 15:0 | **KLV_LEN** - KLV length  - 32 bit KLV = 1 - 64 bit KLV = 2 |
> | 2 | 31:0 | **VALUE32** - Bits 31-0 of the KLV value |
> | 3 | 31:0 | **VALUE64** - Bits 63-32 of the KLV value (**KLV_LEN** = 2) |
>
> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN = [GUC_HXG_ORIGIN_GUC](i915.md#guc-hxg-origin-guc) |
> | 30:28 | TYPE = [GUC_HXG_TYPE_RESPONSE_SUCCESS](i915.md#guc-hxg-type-response-success) |
> | 27:0 | DATA0 = **NUM** - 1 if KLV was parsed, 0 if not recognized |

**HOST2GUC_CONTROL_CTB**

This H2G action allows Vf Host to enable or disable H2G and G2H [CT Buffer](i915.md#ct-buffer).
...
> | 30:28 | TYPE = [GUC_HXG_TYPE_REQUEST](i915.md#guc-hxg-type-request) |
> | 27:16 | DATA0 = MBZ |
> | 15:0 | ACTION = GUC_ACTION_HOST2GUC_CONTROL_CTB = 0x4509 |
> | 1 | 31:0 | **CONTROL** - control [CTB based communication](i915.md#ctb-based-communication)  - GUC_CTB_CONTROL_DISABLE = 0 - GUC_CTB_CONTROL_ENABLE = 1 |
>
> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31 | ORIGIN = [GUC_HXG_ORIGIN_GUC](i915.md#guc-hxg-origin-guc) |
...
> |  | Bits | Description |
> | --- | --- | --- |
> | 0 | 31:16 | **KEY** - KLV key identifier  - [GuC Self Config KLVs](i915.md#guc-self-config-klvs) |
...
[GuC KLV](i915.md#guc-klv) keys available for use with [HOST2GUC_SELF_CFG](i915.md#host2guc-self-cfg).

GUC_KLV_SELF_CFG_H2G_CTB_ADDR0x0902
:   Refers to 64 bit Global Gfx address of H2G [CT Buffer](i915.md#ct-buffer).
    Should be above WOPCM address but below APIC base address for native mode.

GUC_KLV_SELF_CFG_H2G_CTB_DESCRIPTOR_ADDR0x0903
:   Refers to 64 bit Global Gfx address of H2G [CTB Descriptor](i915.md#ctb-descriptor).
    Should be above WOPCM address but below APIC base address for native mode.

GUC_KLV_SELF_CFG_H2G_CTB_SIZE0x0904
:   Refers to size of H2G [CT Buffer](i915.md#ct-buffer) in bytes.
    Should be a multiple of 4K.

GUC_KLV_SELF_CFG_G2H_CTB_ADDR0x0905
:   Refers to 64 bit Global Gfx address of G2H [CT Buffer](i915.md#ct-buffer).
    Should be above WOPCM address but below APIC base address for native mode.

GUC_KLV_SELF_CFG_G2H_CTB_DESCRIPTOR_ADDR0x0906
:   Refers to 64 bit Global Gfx address of G2H [CTB Descriptor](i915.md#ctb-descriptor).
    Should be above WOPCM address but below APIC base address for native mode.

GUC_KLV_SELF_CFG_G2H_CTB_SIZE0x0907
:   Refers to size of G2H [CT Buffer](i915.md#ct-buffer) in bytes.
    Should be a multiple of 4K.
...
The HuC FW layout is the same as the GuC one, see [GuC Firmware Layout](i915.md#guc-firmware-layout)

### DMC

See [DMC Firmware Support](i915.md#dmc-firmware-support)
...
phase with the [`i915_perf_register()`](i915.md#c.i915_perf_register "i915_perf_register") exposing state to userspace.

void i915_perf_fini(struct drm_i915_private \*i915)
:   Counter part to [`i915_perf_init()`](i915.md#c.i915_perf_init "i915_perf_init")
...
userspace by [`i915_perf_unregister()`](i915.md#c.i915_perf_unregister "i915_perf_unregister") before cleaning up
remaining state in [`i915_perf_fini()`](i915.md#c.i915_perf_fini "i915_perf_fini").

int i915_perf_open_ioctl(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, void \*data, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
...
[`i915_perf_open_ioctl_locked()`](i915.md#c.i915_perf_open_ioctl_locked "i915_perf_open_ioctl_locked") after taking the `gt->perf`.lock
...
int i915_perf_release(struct [inode](i915.md#c.i915_perf_release "inode") \*inode, struct [file](i915.md#c.i915_perf_release "file") \*file)
...
int i915_perf_add_config_ioctl(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, void \*data, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
...
`void *data`
:   ioctl data (pointer to [`struct drm_i915_perf_oa_config`](driver-uapi.md#c.drm_i915_perf_oa_config "drm_i915_perf_oa_config")) copied from
...
int i915_perf_remove_config_ioctl(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, void \*data, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
...
`ctx`
:   `NULL` if measuring system-wide across all contexts or a
...
`hold_preemption`
:   Whether preemption is put on hold for command
...
`poll_check_timer`
:   High resolution timer that will periodically
    check for data in the circular OA buffer for notifying userspace
    (e.g. during a read() or poll()).

`poll_wq`
:   The wait queue that hrtimer callback wakes when it
...
`oa_buffer.head`
:   Although we can always read back
...
`oa_buffer.tail`
:   The last verified tail that can be
    read by userspace.
...
`poll_oa_period`
:   The period in nanoseconds at which the OA
...
int read_properties_unlocked(struct i915_perf \*perf, u64 __user \*uprops, u32 n_props, struct [perf_open_properties](i915.md#c.perf_open_properties "perf_open_properties") \*props)
...
int i915_perf_open_ioctl_locked(struct i915_perf \*perf, struct drm_i915_perf_open_param \*param, struct [perf_open_properties](i915.md#c.perf_open_properties "perf_open_properties") \*props, struct [drm_file](drm-internals.md#c.drm_file "drm_file") \*file)
:   DRM ioctl() for userspace to open a stream FD
...
behalf of [`i915_perf_open_ioctl()`](i915.md#c.i915_perf_open_ioctl "i915_perf_open_ioctl") with the `gt->perf`.lock mutex
...
[`i915_oa_stream_init()`](i915.md#c.i915_oa_stream_init "i915_oa_stream_init"). The code here should only validate config state that
...
void i915_perf_destroy_locked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
ssize_t i915_perf_read(struct [file](i915.md#c.i915_perf_read "file") \*file, char __user \*buf, size_t count, loff_t \*ppos)
...
[`i915_perf_stream_ops->read`](i915.md#c.i915_perf_stream_ops "i915_perf_stream_ops") but to save having stream implementations (of
...
long i915_perf_ioctl(struct [file](i915.md#c.i915_perf_ioctl "file") \*file, unsigned int cmd, unsigned long arg)
...
Implementation deferred to [`i915_perf_ioctl_locked()`](i915.md#c.i915_perf_ioctl_locked "i915_perf_ioctl_locked").
...
void i915_perf_enable_locked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
void i915_perf_disable_locked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
__poll_t i915_perf_poll(struct [file](i915.md#c.i915_perf_poll "file") \*file, poll_table \*wait)
...
Implementation deferred to [`i915_perf_poll_locked()`](i915.md#c.i915_perf_poll_locked "i915_perf_poll_locked")

**Return**

any poll events that are ready without sleeping

__poll_t i915_perf_poll_locked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, struct [file](i915.md#c.i915_perf_poll_locked "file") \*file, poll_table \*wait)
...
[`i915_perf_stream_ops->poll_wait`](i915.md#c.i915_perf_stream_ops "i915_perf_stream_ops") to call `poll_wait()` with a wait queue that
...
int i915_oa_stream_init(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, struct drm_i915_perf_open_param \*param, struct [perf_open_properties](i915.md#c.perf_open_properties "perf_open_properties") \*props)
...
While [`read_properties_unlocked()`](i915.md#c.read_properties_unlocked "read_properties_unlocked") validates properties in isolation it
...
int i915_oa_read(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset)
:   just calls through to [`i915_oa_ops->read`](i915.md#c.i915_oa_ops "i915_oa_ops")
...
void i915_oa_stream_enable(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
void i915_oa_stream_disable(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
int i915_oa_wait_unlocked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
void i915_oa_poll_wait(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, struct [file](i915.md#c.i915_oa_poll_wait "file") \*file, poll_table \*wait)
...
As [`read_properties_unlocked()`](i915.md#c.read_properties_unlocked "read_properties_unlocked") enumerates and validates the properties given
to open a stream of metrics the configuration is built up in the structure
which starts out zero initialized.

bool oa_buffer_check_unlocked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
int append_oa_status(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset, enum drm_i915_perf_record_type type)
...
int append_oa_sample(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset, const u8 \*report)
...
int gen8_append_oa_reports(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset)
...
int gen8_oa_read(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset)
...
int gen7_append_oa_reports(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset)
:   Copies all buffered OA reports into userspace read() buffer.
...
int gen7_oa_read(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, char __user \*buf, size_t count, size_t \*offset)
:   copy status records then buffered OA reports
...
int oa_get_render_ctx_id(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
void oa_put_render_ctx_id(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream)
...
long i915_perf_ioctl_locked(struct [i915_perf_stream](i915.md#c.i915_perf_stream "i915_perf_stream") \*stream, unsigned int cmd, unsigned long arg)
:   support ioctl() usage with i915 perf stream FDs
