...
source_url: https://www.kernel.org/doc/html/v6.17/gpu/drm-kms.html
fetched_at: 2026-09-16T16:26:38+00:00
---
...
:   Raw spinlock used to protect critical sections of code that access
    ...
    printing code must be protected against. See [`drm_panic_trylock()`](drm-kms.md#c.drm_panic_trylock "drm_panic_trylock"),
    [`drm_panic_lock()`](drm-kms.md#c.drm_panic_lock "drm_panic_lock") and [`drm_panic_unlock()`](drm-kms.md#c.drm_panic_unlock "drm_panic_unlock").
...
object they have, filtering on [`drm_private_obj.funcs`](drm-kms.md#c.drm_private_obj "drm_private_obj") using `for_each_if()`, at
...
:   Allow full modeset. This is used by the ATOMIC IOCTL handler to
    ...
    [`drm_atomic_crtc_needs_modeset()`](drm-kms.md#c.drm_atomic_crtc_needs_modeset "drm_atomic_crtc_needs_modeset"). The detailed rules are:

    - Drivers must not consult **allow_modeset** in the atomic commit path.
      Use [`drm_atomic_crtc_needs_modeset()`](drm-kms.md#c.drm_atomic_crtc_needs_modeset "drm_atomic_crtc_needs_modeset") instead.
    - Drivers must consult **allow_modeset** before adding unrelated [`struct
      drm_crtc_state`](drm-kms.md#c.drm_crtc_state "drm_crtc_state") to this commit by calling
      [`drm_atomic_get_crtc_state()`](drm-kms.md#c.drm_atomic_get_crtc_state "drm_atomic_get_crtc_state"). See also the warning in the
...
[`struct drm_atomic_state`](drm-kms.md#c.drm_atomic_state "drm_atomic_state") first started as a single collection of
...
to [`drm_atomic_helper_swap_state()`](drm-kms-helpers.md#c.drm_atomic_helper_swap_state "drm_atomic_helper_swap_state"), the entities state pointer would
...
collection we were replacing after [`drm_atomic_helper_swap_state()`](drm-kms-helpers.md#c.drm_atomic_helper_swap_state "drm_atomic_helper_swap_state"),
...
[`drm_atomic_get_connector_for_encoder()`](drm-kms.md#c.drm_atomic_get_connector_for_encoder "drm_atomic_get_connector_for_encoder").
...
struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*drm_atomic_get_connector_for_encoder(const struct [drm_encoder](drm-kms.md#c.drm_encoder "drm_encoder") \*encoder, struct [drm_modeset_acquire_ctx](drm-kms.md#c.drm_modeset_acquire_ctx "drm_modeset_acquire_ctx") \*ctx)
...
It is similar to the [`drm_atomic_get_old_connector_for_encoder()`](drm-kms.md#c.drm_atomic_get_old_connector_for_encoder "drm_atomic_get_old_connector_for_encoder") and
[`drm_atomic_get_new_connector_for_encoder()`](drm-kms.md#c.drm_atomic_get_new_connector_for_encoder "drm_atomic_get_new_connector_for_encoder") helpers, but doesn’t
...
bool drm_crtc_in_clone_mode(struct [drm_crtc_state](drm-kms.md#c.drm_crtc_state "drm_crtc_state") \*crtc_state)
...
void drm_crtc_load_gamma_888(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, const struct drm_color_lut \*lut, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_load_gamma_565_from_888(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, const struct drm_color_lut \*lut, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_load_gamma_555_from_888(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, const struct drm_color_lut \*lut, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_fill_gamma_888(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_fill_gamma_565(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_fill_gamma_555(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, drm_crtc_set_lut_func set_gamma)
...
void drm_crtc_load_palette_8(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, const struct drm_color_lut \*lut, drm_crtc_set_lut_func set_palette)
...
void drm_crtc_fill_palette_8(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, drm_crtc_set_lut_func set_palette)
...
uint32_t drm_driver_color_mode_format(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, unsigned int color_mode)
...
const struct [drm_format_info](drm-kms.md#c.drm_format_info "drm_format_info") \*drm_get_format_info(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, u32 pixel_format, u64 modifier)
...
bool drm_plane_has_format(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane, u32 format, u64 modifier)
...
int drm_plane_add_size_hints_property(struct [drm_plane](drm-kms.md#c.drm_plane "drm_plane") \*plane, const struct [drm_plane_size_hint](drm-uapi.md#c.drm_plane_size_hint "drm_plane_size_hint") \*hints, int num_hints)
...
bool drm_atomic_helper_damage_merged(const struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*old_state, const struct [drm_plane_state](drm-kms.md#c.drm_plane_state "drm_plane_state") \*state, struct [drm_rect](drm-kms-helpers.md#c.drm_rect "drm_rect") \*rect)
:   Merged plane damage
...
[`drm_plane_helper_funcs.get_scanout_buffer`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") helper function. It is then
automatically registered to the drm panic handler.
When a panic occurs, the [`drm_plane_helper_funcs.get_scanout_buffer`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") will be
...
Optionally the driver can also provide a [`drm_plane_helper_funcs.panic_flush`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs")
...
`dev`
:   [`struct drm_device`](drm-internals.md#c.drm_device "drm_device")
...
- Anything protected by [`drm_panic_lock()`](drm-kms.md#c.drm_panic_lock "drm_panic_lock") and [`drm_panic_unlock()`](drm-kms.md#c.drm_panic_unlock "drm_panic_unlock") pairs is safe
  to access.
- Furthermore the panic printing code only registers in [`drm_dev_unregister()`](drm-internals.md#c.drm_dev_unregister "drm_dev_unregister")
  and gets removed in [`drm_dev_unregister()`](drm-internals.md#c.drm_dev_unregister "drm_dev_unregister"). This allows the panic code to
  safely access any state which is invariant in between these two function
  calls, like the list of planes [`drm_mode_config.plane_list`](drm-kms.md#c.drm_mode_config "drm_mode_config") or most of the
  [`struct drm_plane`](drm-kms.md#c.drm_plane "drm_plane") structure.

Specifically thanks to the protection around plane updates in
[`drm_atomic_helper_swap_state()`](drm-kms-helpers.md#c.drm_atomic_helper_swap_state "drm_atomic_helper_swap_state") the following additional guarantees hold:

- It is safe to deference the drm_plane.state pointer.
- Anything in [`struct drm_plane_state`](drm-kms.md#c.drm_plane_state "drm_plane_state") or the driver’s subclass thereof which
  ...
  and buffer objects.
- Anything set up by [`drm_plane_helper_funcs.fb_prepare`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") and cleaned up
  [`drm_plane_helper_funcs.fb_cleanup`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") is safe to access, as long as it stays
...
- Importantly, software and hardware state set up by
  [`drm_plane_helper_funcs.begin_fb_access`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") and
  [`drm_plane_helper_funcs.end_fb_access`](drm-kms-helpers.md#c.drm_plane_helper_funcs "drm_plane_helper_funcs") is not safe to access.

Drivers must not make any assumptions about the actual state of the hardware,
unless they explicitly protected these hardware access with [`drm_panic_lock()`](drm-kms.md#c.drm_panic_lock "drm_panic_lock")
and [`drm_panic_unlock()`](drm-kms.md#c.drm_panic_unlock "drm_panic_unlock").
...
- Updates to pointers like [`drm_plane.state`](drm-kms.md#c.drm_plane "drm_plane"), allowing the panic handler to
  safely deference these. This is done in [`drm_atomic_helper_swap_state()`](drm-kms-helpers.md#c.drm_atomic_helper_swap_state "drm_atomic_helper_swap_state").
...
Unlocks the raw spinlock acquired by either [`drm_panic_lock()`](drm-kms.md#c.drm_panic_lock "drm_panic_lock") or
[`drm_panic_trylock()`](drm-kms.md#c.drm_panic_trylock "drm_panic_trylock").

bool drm_panic_is_enabled(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev)
...
:   Broadcast RGB Selection for an HDMI **drm_connector**
...
:   HDMI-related variable and properties. Filled by
    **[`drm_atomic_helper_connector_hdmi_check()`](drm-kms-helpers.md#c.drm_atomic_helper_connector_hdmi_check "drm_atomic_helper_connector_hdmi_check")**.
...
:   This callback is used by the framework as a replacement for reading
    ...
    should be freed via the [`drm_edid_free()`](drm-kms-helpers.md#c.drm_edid_free "drm_edid_free").
...
:   Platform device created to hold the HDMI Codec. It will be
    automatically unregistered during [`drm_connector_cleanup()`](drm-kms.md#c.drm_connector_cleanup "drm_connector_cleanup").
...
:   DRM property containing EDID if present. Protected by
    ...
    This must be updated only by calling [`drm_edid_connector_update()`](drm-kms-helpers.md#c.drm_edid_connector_update "drm_edid_connector_update") or
...
`eld`
:   EDID-like data, if present, protected by **eld_mutex**
...
int drm_connector_dynamic_init(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, const struct [drm_connector_funcs](drm-kms.md#c.drm_connector_funcs "drm_connector_funcs") \*funcs, int connector_type, struct i2c_adapter \*ddc)
...
after [`drm_dev_register()`](drm-internals.md#c.drm_dev_register "drm_dev_register") has been called already, e.g. DP MST connectors.
...
[`drm_connector_dynamic_register()`](drm-kms.md#c.drm_connector_dynamic_register "drm_connector_dynamic_register").

To remove the connector the driver must call [`drm_connector_unregister()`](drm-kms.md#c.drm_connector_unregister "drm_connector_unregister")
followed by [`drm_connector_put()`](drm-kms.md#c.drm_connector_put "drm_connector_put"). Putting the last reference will call the
driver’s [`drm_connector_funcs.destroy`](drm-kms.md#c.drm_connector_funcs "drm_connector_funcs") hook, which in turn must call
[`drm_connector_cleanup()`](drm-kms.md#c.drm_connector_cleanup "drm_connector_cleanup") and free the connector structure.
...
int drmm_connector_hdmi_init(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector, const char \*vendor, const char \*product, const struct [drm_connector_funcs](drm-kms.md#c.drm_connector_funcs "drm_connector_funcs") \*funcs, const struct [drm_connector_hdmi_funcs](drm-kms.md#c.drm_connector_hdmi_funcs "drm_connector_hdmi_funcs") \*hdmi_funcs, int connector_type, struct i2c_adapter \*ddc, unsigned long supported_formats, unsigned int max_bpc)
...
:   Bitmask of **hdmi_colorspace** listing supported output formats
...
void drm_connector_cec_phys_addr_invalidate(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
void drm_connector_cec_phys_addr_set(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
from [`drm_dev_register()`](drm-internals.md#c.drm_dev_register "drm_dev_register"), dynamic connectors (MST) should be registered by
drivers calling [`drm_connector_dynamic_register()`](drm-kms.md#c.drm_connector_dynamic_register "drm_connector_dynamic_register").
...
int drm_connector_dynamic_register(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
initialized by calling [`drm_connector_dynamic_init()`](drm-kms.md#c.drm_connector_dynamic_init "drm_connector_dynamic_init"). All other connectors
will be registered automatically when calling [`drm_dev_register()`](drm-internals.md#c.drm_dev_register "drm_dev_register").
...
calling [`drm_connector_dynamic_register()`](drm-kms.md#c.drm_connector_dynamic_register "drm_connector_dynamic_register"). All other - static - connectors
...
int drm_connector_attach_broadcast_rgb_property(struct [drm_connector](drm-kms.md#c.drm_connector "drm_connector") \*connector)
...
int drmm_writeback_connector_init(struct [drm_device](drm-internals.md#c.drm_device "drm_device") \*dev, struct [drm_writeback_connector](drm-kms.md#c.drm_writeback_connector "drm_writeback_connector") \*wb_connector, const struct [drm_connector_funcs](drm-kms.md#c.drm_connector_funcs "drm_connector_funcs") \*con_funcs, struct [drm_encoder](drm-kms.md#c.drm_encoder "drm_encoder") \*enc, const u32 \*formats, int n_formats)
:   Initialize a writeback connector with a custom encoder
...
:   Connector property to enable userspace to send HDR Metadata to
    ...
    [`drm_connector.display_info`](drm-kms.md#c.drm_connector "drm_connector").hdr_sink_metadata. Driver uses
...
:   Indicates the Quantization Range (Full vs Limited) used. The color
    ...
    [`drm_connector_attach_broadcast_rgb_property()`](drm-kms.md#c.drm_connector_attach_broadcast_rgb_property "drm_connector_attach_broadcast_rgb_property").
...
:   Blob property which contains the set of recommended plane size
    ...
    The blob contains an array of [`struct drm_plane_size_hint`](drm-uapi.md#c.drm_plane_size_hint "drm_plane_size_hint"), in
    ...
    [`DRM_CAP_CURSOR_WIDTH`](drm-uapi.md#c.DRM_CAP_CURSOR_WIDTH "DRM_CAP_CURSOR_WIDTH") and [`DRM_CAP_CURSOR_HEIGHT`](drm-uapi.md#c.DRM_CAP_CURSOR_HEIGHT "DRM_CAP_CURSOR_HEIGHT")) to determine
...
manner, see [`drm_vblank_crtc_config.disable_immediate`](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config") and
...
:   Vblank off delay in ms, used to determine how long
    [`drm_vblank_crtc.disable_timer`](drm-kms.md#c.drm_vblank_crtc "drm_vblank_crtc") waits before disabling.

    Defaults to the value of drm_vblank_offdelay in [`drm_crtc_vblank_on()`](drm-kms.md#c.drm_crtc_vblank_on "drm_crtc_vblank_on").

`disable_immediate`
:   See [`drm_device.vblank_disable_immediate`](drm-internals.md#c.drm_device "drm_device")
    ...
    Defaults to the value of [`drm_device.vblank_disable_immediate`](drm-internals.md#c.drm_device "drm_device") in
    [`drm_crtc_vblank_on()`](drm-kms.md#c.drm_crtc_vblank_on "drm_crtc_vblank_on").
...
:   Disable timer for the delayed vblank disabling
    ...
    [`drm_vblank_crtc_config.offdelay_ms`](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config") and the setting of the
...
:   Stores vblank configuration values for a given CRTC.
    Also, see [`drm_crtc_vblank_on_config()`](drm-kms.md#c.drm_crtc_vblank_on_config "drm_crtc_vblank_on_config").
...
if possible. Disable interrupts after [`drm_vblank_crtc_config.offdelay_ms`](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config")
milliseconds.
...
void drm_crtc_vblank_on_config(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc, const struct [drm_vblank_crtc_config](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config") \*config)
...
See [`drm_crtc_vblank_on()`](drm-kms.md#c.drm_crtc_vblank_on "drm_crtc_vblank_on"). In addition, this function allows you to provide a
...
[`struct drm_vblank_crtc_config`](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config").
...
Note that unlike in [`drm_crtc_vblank_on_config()`](drm-kms.md#c.drm_crtc_vblank_on_config "drm_crtc_vblank_on_config"), default values are used.
...
[`drm_vblank_crtc_config.disable_immediate`](drm-kms.md#c.drm_vblank_crtc_config "drm_vblank_crtc_config") must be set to indicate the
...
[`drm_vblank_work_flush_all()`](drm-kms.md#c.drm_vblank_work_flush_all "drm_vblank_work_flush_all")
...
void drm_vblank_work_flush_all(struct [drm_crtc](drm-kms.md#c.drm_crtc "drm_crtc") \*crtc)
