...
source_url: https://www.kernel.org/doc/html/v6.17/staging/remoteproc.html
fetched_at: 2026-09-16T16:25:42+00:00
---
...
please read [Remote Processor Messaging (rpmsg) Framework](rpmsg.md)).
...
The ->[`start()`](../networking/ieee802154.md#c.start "start") handler takes an rproc handle and should then power on the
device and boot it (use rproc->priv to access platform-specific private data).
The boot address, in case needed, can be found in rproc->bootaddr (remoteproc
core puts there the ELF entry point).
On success, 0 should be returned, and on failure, an appropriate error code.

The ->[`stop()`](../networking/ieee802154.md#c.stop "stop") handler takes an rproc handle and powers the device down.
...
rpmsg channels; read more about it in [Remote Processor Messaging (rpmsg) Framework](rpmsg.md)).
