...
collection: kernel
version: "6.17"
title: "The TCM v4 fabric module script generator"
source_url: https://www.kernel.org/doc/html/v6.17/target/tcm_mod_builder.html
fetched_at: 2026-09-16T16:42:54+00:00
---
...
1. Run ‘make menuconfig’ and select the new CONFIG_TCM_NAB5000 item:

   ```
   <M>   TCM_NAB5000 fabric module
   ```
2. Build using ‘make modules’, once completed you will have:
   ...
   ```
3. Load the new module, create a lun_0 configfs group, and add new TCM Core
...
Nicholas A. Bellinger <[nab@linux-iscsi.org](mailto:nab%40linux-iscsi.org)>
