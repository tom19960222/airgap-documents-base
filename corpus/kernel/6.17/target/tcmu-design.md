...
collection: kernel
version: "6.17"
title: "TCM Userspace Design"
source_url: https://www.kernel.org/doc/html/v6.17/target/tcmu-design.html
fetched_at: 2026-09-16T16:34:41+00:00
---
...
then signaling userspace via [`uio_event_notify()`](../driver-api/infrastructure.md#c.uio_event_notify "uio_event_notify"). Once the command is
...
2. Waiting for events on the device(s)
3. Managing the command ring: Parsing operations and commands,
