...
source_url: https://www.kernel.org/doc/html/v6.17/bpf/libbpf/libbpf_overview.html
fetched_at: 2026-09-16T16:54:19+00:00
---
# libbpf Overview
...
the return value, see the [bpf-helpers](https://man7.org/linux/man-pages/man7/bpf-helpers.7.html) man page.
...
portability across different kernel versions and configurations. [BCC](https://github.com/iovisor/bcc/) is one of the solutions for BPF
...
([BTF types](../btf.md)) that the running kernel uses. Including
...
Check out the [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap)
repository with simple examples of using libbpf to build various BPF
applications.

See also [libbpf API documentation](https://libbpf.readthedocs.io/en/latest/api.html).

## libbpf and Rust

If you are building BPF applications in Rust, it is recommended to use the
[Libbpf-rs](https://github.com/libbpf/libbpf-rs) library instead of bindgen
