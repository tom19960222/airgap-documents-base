...
source_url: https://www.kernel.org/doc/html/v6.17/bpf/libbpf/program_types.html
fetched_at: 2026-09-16T16:54:20+00:00
---
...
| `raw_tracepoint+` |  |
| `BPF_PROG_TYPE_SCHED_ACT` |  | `action` [[9]](program_types.md#tc-legacy) |  |
| `BPF_PROG_TYPE_SCHED_CLS` |  | `classifier` [[9]](program_types.md#tc-legacy) |  |
| `tc` [[9]](program_types.md#tc-legacy) |  |
...
| `BPF_PROG_TYPE_STRUCT_OPS` |  | `struct_ops+` [[10]](program_types.md#struct-ops) |  |
| `struct_ops.s+` [[10]](program_types.md#struct-ops) | Yes |
| `BPF_PROG_TYPE_SYSCALL` |  | `syscall` | Yes |
| `BPF_PROG_TYPE_TRACEPOINT` |  | `tp+` [[11]](program_types.md#tp) |  |
| `tracepoint+` [[11]](program_types.md#tp) |  |
...
| `BPF_TRACE_ITER` | `iter+` [[12]](program_types.md#iter) |  |
| `iter.s+` [[12]](program_types.md#iter) | Yes |
...
[1]
([1](program_types.md#id1),[2](program_types.md#id24),[3](program_types.md#id25),[4](program_types.md#id26),[5](program_types.md#id27),[6](program_types.md#id28),[7](program_types.md#id29),[8](program_types.md#id32))

The `fentry` attach format is `fentry[.s]/<function>`.

[2]
([1](program_types.md#id2),[2](program_types.md#id3))
...
[3]
([1](program_types.md#id4),[2](program_types.md#id5))

The `ksyscall` attach format is `ksyscall/<syscall>`.

[4]
([1](program_types.md#id6),[2](program_types.md#id7),[3](program_types.md#id8),[4](program_types.md#id9))
...
[6]
([1](program_types.md#id11),[2](program_types.md#id12))
...
[7]
([1](program_types.md#id13),[2](program_types.md#id14))

The `lsm` attachment format is `lsm[.s]/<hook>`.

[8]
([1](program_types.md#id15),[2](program_types.md#id16))

The `raw_tp` attach format is `raw_tracepoint[.w]/<tracepoint>`.

[9]
([1](program_types.md#id17),[2](program_types.md#id18),[3](program_types.md#id19))

The `tc`, `classifier` and `action` attach types are deprecated, use
`tcx/*` instead.

[10]
([1](program_types.md#id20),[2](program_types.md#id21))
...
[11]
([1](program_types.md#id22),[2](program_types.md#id23))

The `tracepoint` attach format is `tracepoint/<category>/<name>`.

[12]
([1](program_types.md#id30),[2](program_types.md#id31))
