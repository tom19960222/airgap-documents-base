...
collection: kernel
version: "6.17"
title: "BPF_PROG_TYPE_CGROUP_SYSCTL"
source_url: https://www.kernel.org/doc/html/v6.17/bpf/prog_cgroup_sysctl.html
fetched_at: 2026-09-16T16:54:24+00:00
---
...
See [linux/bpf.h](https://www.kernel.org/doc/html/include/uapi/linux/bpf.h) for more details on how context field can be accessed.
...
- `bpf_strtol()` to convert initial part of the string to long integer
  similar to user space [strtol(3)](http://man7.org/linux/man-pages/man3/strtol.3p.html);
- `bpf_strtoul()` to convert initial part of the string to unsigned long
  integer similar to user space [strtoul(3)](http://man7.org/linux/man-pages/man3/strtoul.3p.html);

See [linux/bpf.h](https://www.kernel.org/doc/html/include/uapi/linux/bpf.h) for more details on helpers described here.

## 5. Examples

See [test_sysctl_prog.c](https://www.kernel.org/doc/html/tools/testing/selftests/bpf/progs/test_sysctl_prog.c) for an example of BPF program in C that access
