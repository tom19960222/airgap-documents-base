...
source_url: https://www.kernel.org/doc/html/v6.17/bpf/btf.html
fetched_at: 2026-09-16T16:46:02+00:00
---
# BPF Type Format (BTF)
...
sections are discussed in details in [2. BTF Type and String Encoding](btf.md#btf-type-string).
...
[Commit 9d5f9f701b18](https://git.kernel.org/torvalds/c/9d5f9f701b18) introduced `kind_flag` and explains why both modes
exist.
...
:   - `name_off`: offset to a valid C identifier
    ...
    - `info.vlen`: linkage information (BTF_FUNC_STATIC, BTF_FUNC_GLOBAL
      :   or BTF_FUNC_EXTERN - see [2.3.1 Function Linkage Constant Values](btf.md#btf-function-linkage-constants))
...
[4.2 .BTF.ext section](btf.md#btf-ext-section) (ELF) or in the arguments to [3.3 BPF_PROG_LOAD](btf.md#bpf-prog-load)
(ABI).
...
see [2.3.2 Variable Linkage Constant Values](btf.md#btf-var-linkage-constants).
...
[2. BTF Type and String Encoding](btf.md#btf-type-string), can be directly loaded into the kernel. A `btf_fd`
...
same as the one describe in [2. BTF Type and String Encoding](btf.md#btf-type-string).
...
See [3.3 BPF_PROG_LOAD](btf.md#bpf-prog-load) for details about func_info and line_info
record format.
...
See [Documentation/bpf/llvm_reloc.rst](llvm_reloc.md#btf-co-re-relocations)
...
The kernel BPF selftest [tools/testing/selftests/bpf/prog_tests/btf.c](https://git.kernel.org/pub/scm/linux/kernel/git/stable/linux.git/tree/tools/testing/selftests/bpf/prog_tests/btf.c)
