...
collection: kernel
version: "6.17"
title: "HOWTO interact with BPF subsystem"
source_url: https://www.kernel.org/doc/html/v6.17/bpf/bpf_devel_QA.html
fetched_at: 2026-09-16T16:54:23+00:00
---
...
[Submitting patches: the essential guide to getting your code into the kernel](../process/submitting-patches.md). This document only describes
additional specifics related to BPF.

- [Reporting bugs](bpf_devel_QA.md#reporting-bugs)

  - [Q: How do I report bugs for BPF kernel code?](bpf_devel_QA.md#q-how-do-i-report-bugs-for-bpf-kernel-code)
- [Submitting patches](bpf_devel_QA.md#submitting-patches)

  - [Q: How do I run BPF CI on my changes before sending them out for review?](bpf_devel_QA.md#q-how-do-i-run-bpf-ci-on-my-changes-before-sending-them-out-for-review)
  - [Q: To which mailing list do I need to submit my BPF patches?](bpf_devel_QA.md#q-to-which-mailing-list-do-i-need-to-submit-my-bpf-patches)
  - [Q: Where can I find patches currently under discussion for BPF subsystem?](bpf_devel_QA.md#q-where-can-i-find-patches-currently-under-discussion-for-bpf-subsystem)
  - [Q: How do the changes make their way into Linux?](bpf_devel_QA.md#q-how-do-the-changes-make-their-way-into-linux)
  - [Q: How do I indicate which tree (bpf vs. bpf-next) my patch should be applied to?](bpf_devel_QA.md#q-how-do-i-indicate-which-tree-bpf-vs-bpf-next-my-patch-should-be-applied-to)
  - [Q: What does it mean when a patch gets applied to bpf or bpf-next tree?](bpf_devel_QA.md#q-what-does-it-mean-when-a-patch-gets-applied-to-bpf-or-bpf-next-tree)
  - [Q: How long do I need to wait for feedback on my BPF patches?](bpf_devel_QA.md#q-how-long-do-i-need-to-wait-for-feedback-on-my-bpf-patches)
  - [Q: How often do you send pull requests to major kernel trees like net or net-next?](bpf_devel_QA.md#q-how-often-do-you-send-pull-requests-to-major-kernel-trees-like-net-or-net-next)
  - [Q: Are patches applied to bpf-next when the merge window is open?](bpf_devel_QA.md#q-are-patches-applied-to-bpf-next-when-the-merge-window-is-open)
  - [Q: Verifier changes and test cases](bpf_devel_QA.md#q-verifier-changes-and-test-cases)
  - [Q: samples/bpf preference vs selftests?](bpf_devel_QA.md#q-samples-bpf-preference-vs-selftests)
  - [Q: When should I add code to the bpftool?](bpf_devel_QA.md#q-when-should-i-add-code-to-the-bpftool)
  - [Q: When should I add code to iproute2’s BPF loader?](bpf_devel_QA.md#q-when-should-i-add-code-to-iproute2-s-bpf-loader)
  - [Q: Do you accept patches as well for iproute2’s BPF loader?](bpf_devel_QA.md#q-do-you-accept-patches-as-well-for-iproute2-s-bpf-loader)
  - [Q: What is the minimum requirement before I submit my BPF patches?](bpf_devel_QA.md#q-what-is-the-minimum-requirement-before-i-submit-my-bpf-patches)
  - [Q: Features changing BPF JIT and/or LLVM](bpf_devel_QA.md#q-features-changing-bpf-jit-and-or-llvm)
  - [Q: What “BPF_INTERNAL” symbol namespace is for?](bpf_devel_QA.md#q-what-bpf-internal-symbol-namespace-is-for)
- [Stable submission](bpf_devel_QA.md#stable-submission)

  - [Q: I need a specific BPF commit in stable kernels. What should I do?](bpf_devel_QA.md#q-i-need-a-specific-bpf-commit-in-stable-kernels-what-should-i-do)
  - [Q: Do you also backport to kernels not currently maintained as stable?](bpf_devel_QA.md#q-do-you-also-backport-to-kernels-not-currently-maintained-as-stable)
  - [Q: The BPF patch I am about to submit needs to go to stable as well](bpf_devel_QA.md#q-the-bpf-patch-i-am-about-to-submit-needs-to-go-to-stable-as-well)
  - [Q: Queue stable patches](bpf_devel_QA.md#q-queue-stable-patches)
- [Testing patches](bpf_devel_QA.md#testing-patches)

  - [Q: How to run BPF selftests](bpf_devel_QA.md#q-how-to-run-bpf-selftests)
  - [Q: Which BPF kernel selftests version should I run my kernel against?](bpf_devel_QA.md#q-which-bpf-kernel-selftests-version-should-i-run-my-kernel-against)
- [LLVM](bpf_devel_QA.md#llvm)

  - [Q: Where do I find LLVM with BPF support?](bpf_devel_QA.md#q-where-do-i-find-llvm-with-bpf-support)
  - [Q: Got it, so how do I build LLVM manually anyway?](bpf_devel_QA.md#q-got-it-so-how-do-i-build-llvm-manually-anyway)
  - [Q: Reporting LLVM BPF issues](bpf_devel_QA.md#q-reporting-llvm-bpf-issues)
  - [Q: New BPF instruction for kernel and LLVM](bpf_devel_QA.md#q-new-bpf-instruction-for-kernel-and-llvm)
  - [Q: clang flag for target bpf?](bpf_devel_QA.md#q-clang-flag-for-target-bpf)

## [Reporting bugs](bpf_devel_QA.md#id1)

### [Q: How do I report bugs for BPF kernel code?](bpf_devel_QA.md#id2)
...
> [bpf@vger.kernel.org](mailto:bpf%40vger.kernel.org)
...
- Daniel Borkmann <[daniel@iogearbox.net](mailto:daniel%40iogearbox.net)>
...
## [Submitting patches](bpf_devel_QA.md#id3)

### [Q: How do I run BPF CI on my changes before sending them out for review?](bpf_devel_QA.md#id4)
...
### [Q: To which mailing list do I need to submit my BPF patches?](bpf_devel_QA.md#id5)
...
### [Q: Where can I find patches currently under discussion for BPF subsystem?](bpf_devel_QA.md#id6)
...
### [Q: How do the changes make their way into Linux?](bpf_devel_QA.md#id7)
...
[Networking subsystem (netdev)](../process/maintainer-netdev.md).
...
### [Q: How do I indicate which tree (bpf vs. bpf-next) my patch should be applied to?](bpf_devel_QA.md#id8)

A: The process is the very same as described in the netdev subsystem
documentation at [Networking subsystem (netdev)](../process/maintainer-netdev.md),
...
### [Q: What does it mean when a patch gets applied to bpf or bpf-next tree?](bpf_devel_QA.md#id9)
...
1. accumulate and stage BPF patches for integration into trees
   like net and net-next, and
2. run extensive BPF test suite and
...
[Networking subsystem (netdev)](../process/maintainer-netdev.md) for additional information
e.g. on how often they are merged to mainline.

### [Q: How long do I need to wait for feedback on my BPF patches?](bpf_devel_QA.md#id10)
...
### [Q: How often do you send pull requests to major kernel trees like net or net-next?](bpf_devel_QA.md#id11)
...
### [Q: Are patches applied to bpf-next when the merge window is open?](bpf_devel_QA.md#id12)

A: For the time when the merge window is open, bpf-next will not be
processed. This is roughly analogous to net-next patch processing,
so feel free to read up on the netdev docs at
[Networking subsystem (netdev)](../process/maintainer-netdev.md) about further details.
...
### [Q: Verifier changes and test cases](bpf_devel_QA.md#id13)

Q: I made a BPF verifier change, do I need to add test cases for
BPF kernel [selftests](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/testing/selftests/bpf/)?

A: If the patch has changes to the behavior of the verifier, then yes,
it is absolutely necessary to add test cases to the BPF kernel
[selftests](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/testing/selftests/bpf/) suite. If they are not present and we think they are
...
### [Q: samples/bpf preference vs selftests?](bpf_devel_QA.md#id14)

Q: When should I add code to `samples/bpf/` and when to BPF kernel
[selftests](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/testing/selftests/bpf/)?

A: In general, we prefer additions to BPF kernel [selftests](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/testing/selftests/bpf/) rather than
...
### [Q: When should I add code to the bpftool?](bpf_devel_QA.md#id15)
...
### [Q: When should I add code to iproute2’s BPF loader?](bpf_devel_QA.md#id16)
...
### [Q: Do you accept patches as well for iproute2’s BPF loader?](bpf_devel_QA.md#id17)

A: Patches for the iproute2’s BPF loader have to be sent to:

> [netdev@vger.kernel.org](mailto:netdev%40vger.kernel.org)
...
### [Q: What is the minimum requirement before I submit my BPF patches?](bpf_devel_QA.md#id18)
...
### [Q: Features changing BPF JIT and/or LLVM](bpf_devel_QA.md#id19)
...
end. See [LLVM](bpf_devel_QA.md#llvm) section below for further information.

### [Q: What “BPF_INTERNAL” symbol namespace is for?](bpf_devel_QA.md#id20)
...
## [Stable submission](bpf_devel_QA.md#id21)

### [Q: I need a specific BPF commit in stable kernels. What should I do?](bpf_devel_QA.md#id22)
...
### [Q: Do you also backport to kernels not currently maintained as stable?](bpf_devel_QA.md#id23)
...
### [Q: The BPF patch I am about to submit needs to go to stable as well](bpf_devel_QA.md#id24)

What should I do?

A: The same rules apply as with netdev patch submissions in general, see
the netdev docs at [Networking subsystem (netdev)](../process/maintainer-netdev.md).
...
### [Q: Queue stable patches](bpf_devel_QA.md#id25)
...
## [Testing patches](bpf_devel_QA.md#id26)

### [Q: How to run BPF selftests](bpf_devel_QA.md#id27)

A: After you have booted into the newly compiled kernel, navigate to
the BPF [selftests](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/testing/selftests/bpf/) suite in order to test BPF functionality (current
...
See [kernel selftest documentation](../dev-tools/kselftest.md)
for details.
...
discussed in [BPF Type Format (BTF)](btf.md) - pahole version 1.16
...
[commit 21507cd3e97b](https://git.kernel.org/torvalds/c/21507cd3e97b) (“pahole: add libbpf as submodule under lib/bpf”).
...
### [Q: Which BPF kernel selftests version should I run my kernel against?](bpf_devel_QA.md#id28)
...
## [LLVM](bpf_devel_QA.md#id29)

### [Q: Where do I find LLVM with BPF support?](bpf_devel_QA.md#id30)
...
### [Q: Got it, so how do I build LLVM manually anyway?](bpf_devel_QA.md#id31)
...
### [Q: Reporting LLVM BPF issues](bpf_devel_QA.md#id32)
...
- Yonghong Song <[yhs@fb.com](mailto:yhs%40fb.com)>
- Alexei Starovoitov <[ast@kernel.org](mailto:ast%40kernel.org)>
- Daniel Borkmann <[daniel@iogearbox.net](mailto:daniel%40iogearbox.net)>
...
### [Q: New BPF instruction for kernel and LLVM](bpf_devel_QA.md#id33)
...
### [Q: clang flag for target bpf?](bpf_devel_QA.md#id34)
