...
source_url: https://www.kernel.org/doc/html/v6.17/bpf/classic_vs_extended.html
fetched_at: 2026-09-16T16:46:06+00:00
---
# Classic BPF vs eBPF
...
- Introduces bpf_call insn and register passing convention for zero overhead
  ...
  An in-kernel [eBPF verifier](verifier.md) is used to validate eBPF programs.
...
Safety of eBPF can come from the [eBPF verifier](verifier.md). In such use cases as
