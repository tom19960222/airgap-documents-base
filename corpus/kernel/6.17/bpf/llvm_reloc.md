...
source_url: https://www.kernel.org/doc/html/v6.17/bpf/llvm_reloc.html
fetched_at: 2026-09-16T16:54:22+00:00
---
...
See [Documentation/bpf/btf.rst](btf.md#btf-ext-section) for more
...
- `access_str_off` - offset into corresponding .BTF string section.
  ...
  - for field-based relocations, string encodes an accessed field using
    ...
    conceptually very close to LLVM’s [getelementptr](https://llvm.org/docs/LangRef.html#getelementptr-instruction) instruction’s
