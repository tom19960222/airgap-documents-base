...
collection: kernel
version: "6.17"
title: "BPF Graph Data Structures"
source_url: https://www.kernel.org/doc/html/v6.17/bpf/graph_ds_impl.html
fetched_at: 2026-09-16T16:54:28+00:00
---
...
- [Introduction](graph_ds_impl.md#introduction)
- [Unstable API](graph_ds_impl.md#unstable-api)
- [Locking](graph_ds_impl.md#locking)
- [Non-owning references](graph_ds_impl.md#non-owning-references)

## [Introduction](graph_ds_impl.md#id1)
...
## [Unstable API](graph_ds_impl.md#id2)
...
## [Non-owning references](graph_ds_impl.md#id4)
