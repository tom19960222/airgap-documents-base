...
version: "6.17"
title: "eBPF verifier"
source_url: https://www.kernel.org/doc/html/v6.17/bpf/verifier.html
fetched_at: 2026-09-16T16:46:00+00:00
---
# eBPF verifier
...
>     (see [BPF maps](maps.md)) return this type, which becomes a
...
- Function `propagate_liveness()` (see section [Read marks propagation for cache hits](verifier.md#read-marks-for-cache-hits))
