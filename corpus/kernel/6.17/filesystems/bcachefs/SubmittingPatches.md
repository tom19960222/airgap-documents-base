...
collection: kernel
version: "6.17"
title: "2. Submitting patches to bcachefs"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/bcachefs/SubmittingPatches.html
fetched_at: 2026-09-16T16:32:22+00:00
---
# 2. Submitting patches to bcachefs
...
[[0]](SubmittingPatches.md#id6), or the full bcachefs test suite in ktest [[1]](SubmittingPatches.md#id7), depending on what’s being
...
That exists [[2]](SubmittingPatches.md#id8), and community members may request an account. If you work for
a big tech company, you’ll need to help out with server costs to get access -
but the CI is not restricted to running bcachefs tests: it runs any ktest test
(which generally makes it easy to wrap other tests that can run in qemu).

## 2.3. Other things to think about
...
## 2.4. Mailing list, IRC

Patches should hit the list [[3]](SubmittingPatches.md#id9), but much discussion and code review happens
on IRC as well [[4]](SubmittingPatches.md#id10); many people appreciate the more conversational approach
...
[[0](SubmittingPatches.md#id1)]

git://git.kernel.org/pub/scm/fs/xfs/xfstests-dev.git

[[1](SubmittingPatches.md#id2)]

<https://evilpiepirate.org/git/ktest.git/>

[[2](SubmittingPatches.md#id3)]

<https://evilpiepirate.org/~testdashboard/ci/>

[[3](SubmittingPatches.md#id4)]

[linux-bcachefs@vger.kernel.org](mailto:linux-bcachefs%40vger.kernel.org)

[[4](SubmittingPatches.md#id5)]

irc.oftc.net#bcache, #bcachefs-dev
