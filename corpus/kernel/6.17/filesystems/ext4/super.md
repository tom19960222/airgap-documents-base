...
collection: kernel
version: "6.17"
title: "3.1. Super Block"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ext4/super.html
fetched_at: 2026-09-16T16:53:22+00:00
---
# 3.1. Super Block
...
| 0x3A | __le16 | s_state | File system state. See [super_state](super.md#super-state) for more info. |
| 0x3C | __le16 | s_errors | Behaviour when detecting errors. See [super_errors](super.md#super-errors) for more info. |
...
| 0x48 | __le32 | s_creator_os | Creator OS. See the table [super_creator](super.md#super-creator) for more info. |
| 0x4C | __le32 | s_rev_level | Revision level. See the table [super_revision](super.md#super-revision) for more info. |
...
| 0x5C | __le32 | s_feature_compat | Compatible feature set flags. Kernel can still read/write this fs even if it doesn’t understand a flag; fsck should not do that. See the [super_compat](super.md#super-compat) table for more info. |
| 0x60 | __le32 | s_feature_incompat | Incompatible feature set. If the kernel or fsck doesn’t understand one of these bits, it should stop. See the [super_incompat](super.md#super-incompat) table for more info. |
| 0x64 | __le32 | s_feature_ro_compat | Readonly-compatible feature set. If the kernel doesn’t understand one of these bits, it can still mount read-only. See the [super_rocompat](super.md#super-rocompat) table for more info. |
...
| 0xFC | __u8 | s_def_hash_version | Default hash algorithm to use for directory hashes. See [super_def_hash](super.md#super-def-hash) for more info. |
...
| 0x100 | __le32 | s_default_mount_opts | Default mount options. See the [super_mountopts](super.md#super-mountopts) table for more info. |
...
| 0x160 | __le32 | s_flags | Miscellaneous flags. See the [super_flags](super.md#super-flags) table for more info. |
...
| 0x176 | __u8 | s_encryption_level | Versioning level for encryption. |
| 0x177 | __u8 | s_reserved_pad | Padding to next 32bits. |
...
| 0x254 | __u8 | s_encrypt_algos[4] | Encryption algorithms in use. There can be up to four algorithms in use at any time; valid algorithm codes are given in the [super_encrypt](super.md#super-encrypt) table below. |
...
| 0x27A | __u8 | s_first_error_errcode |  |
| 0x27B | __u8 | s_last_error_errcode |  |
