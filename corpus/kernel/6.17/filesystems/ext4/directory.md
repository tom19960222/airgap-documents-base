...
collection: kernel
version: "6.17"
title: "4.3. Directory Entries"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ext4/directory.html
fetched_at: 2026-09-16T16:53:27+00:00
---
...
| 0x7 | __u8 | file_type | File type code, see [ftype](directory.md#ftype) table below. |
| 0x8 | char | name[EXT4_NAME_LEN] | File name. |
...
| 0x1C | u8 | `struct dx_root_info`.hash_version | Hash type, see [dirhash](directory.md#dirhash) table below. |
