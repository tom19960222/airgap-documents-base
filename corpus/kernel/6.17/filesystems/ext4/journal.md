...
collection: kernel
version: "6.17"
title: "3.6. Journal (jbd2)"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ext4/journal.html
fetched_at: 2026-09-16T16:53:25+00:00
---
# 3.6. Journal (jbd2)
...
| 0x4 | __be32 | h_blocktype | Description of what this block contains. See the [jbd2_blocktype](journal.md#jbd2-blocktype) table below. |
...
| 0x24 | __be32 | s_feature_compat; | Compatible feature set. See the table [jbd2_compat](journal.md#jbd2-compat) below. |
| 0x28 | __be32 | s_feature_incompat | Incompatible feature set. See the table [jbd2_incompat](journal.md#jbd2-incompat) below. |
...
| 0x50 | __u8 | s_checksum_type | Checksum algorithm used for the journal. See [jbd2_checksum_type](journal.md#jbd2-checksum-type) for more info. |
...
| 0x4 | __be32 | t_flags | Flags that go with the descriptor. See the table [jbd2_tag_flags](journal.md#jbd2-tag-flags) for more info. |
...
| 0x6 | __be16 | t_flags | Flags that go with the descriptor. See the table [jbd2_tag_flags](journal.md#jbd2-tag-flags) for more info. |
...
| 0xC | unsigned char | h_chksum_type | The type of checksum to use to verify the integrity of the data blocks in the transaction. See [jbd2_checksum_type](journal.md#jbd2-checksum-type) for more info. |
