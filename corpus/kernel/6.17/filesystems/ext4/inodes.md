...
collection: kernel
version: "6.17"
title: "4.1. Index Nodes"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ext4/inodes.html
...
| --- | --- | --- | --- |
| 0x0 | __le16 | i_mode | File mode. See the table [i_mode](inodes.md#i-mode) below. |
...
| 0x20 | __le32 | i_flags | Inode flags. See the table [i_flags](inodes.md#i-flags) below. |
| 0x24 | 4 bytes | i_osd1 | See the table [i_osd1](inodes.md#i-osd1) for more details. |
...
| 0x74 | 12 bytes | i_osd2 | See the table [i_osd2](inodes.md#i-osd2) for more details. |
