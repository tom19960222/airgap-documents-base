...
collection: kernel
version: "6.17"
title: "Cache Backend API"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/caching/backend-api.html
...
See the [Network Filesystem Services Library](../netfs_library.md) for a description.
...
enum [fscache_cookie_state](backend-api.md#c.fscache_cookie_state "fscache_cookie_state") fscache_cookie_state(struct fscache_cookie \*cookie)
