...
collection: kernel
version: "6.17"
title: "Cache on Already Mounted Filesystem"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/caching/cachefiles.html
fetched_at: 2026-09-16T16:32:27+00:00
---
...
> - `openat()` and friends.
> - [`bmap()`](../api-summary.md#c.bmap "bmap") support on files in the filesystem (FIBMAP ioctl).
> - The use of [`bmap()`](../api-summary.md#c.bmap "bmap") to detect a partial page at the end of the file.
...
The reason it does this is that it calls [`vfs_mkdir()`](../api-summary.md#c.vfs_mkdir "vfs_mkdir") and suchlike rather than
