...
collection: kernel
version: "6.17"
title: "2. Supported File Operations"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/iomap/operations.html
fetched_at: 2026-09-16T16:41:58+00:00
---
# 2. Supported File Operations

Table of Contents

- [Buffered I/O](operations.md#buffered-i-o)

  - [`struct address_space_operations`](operations.md#struct-address-space-operations)
  - [`struct iomap_write_ops`](operations.md#struct-iomap-write-ops)
  - [Internal per-Folio State](operations.md#internal-per-folio-state)
  - [Buffered Readahead and Reads](operations.md#buffered-readahead-and-reads)
  - [Buffered Writes](operations.md#buffered-writes)

    - [mmap Write Faults](operations.md#mmap-write-faults)
    - [Buffered Write Failures](operations.md#buffered-write-failures)
    - [Zeroing for File Operations](operations.md#zeroing-for-file-operations)
    - [Unsharing Reflinked File Data](operations.md#unsharing-reflinked-file-data)
  - [Truncation](operations.md#truncation)
  - [Pagecache Writeback](operations.md#pagecache-writeback)

    - [`struct iomap_writeback_ops`](operations.md#struct-iomap-writeback-ops)
    - [Pagecache Writeback Completion](operations.md#pagecache-writeback-completion)
- [Direct I/O](operations.md#direct-i-o)

  - [Return Values](operations.md#return-values)
  - [Direct Reads](operations.md#direct-reads)
  - [Direct Writes](operations.md#direct-writes)
  - [`struct iomap_dio_ops:`](operations.md#struct-iomap-dio-ops)
- [DAX I/O](operations.md#dax-i-o)

  - [fsdax Reads](operations.md#fsdax-reads)
  - [fsdax Writes](operations.md#fsdax-writes)

    - [fsdax mmap Faults](operations.md#fsdax-mmap-faults)
  - [fsdax Truncation, fallocate, and Unsharing](operations.md#fsdax-truncation-fallocate-and-unsharing)
  - [fsdax Deduplication](operations.md#fsdax-deduplication)
- [Seeking Files](operations.md#seeking-files)

  - [SEEK_DATA](operations.md#seek-data)
  - [SEEK_HOLE](operations.md#seek-hole)
- [Swap File Activation](operations.md#swap-file-activation)
- [File Space Mapping Reporting](operations.md#file-space-mapping-reporting)

  - [FS_IOC_FIEMAP](operations.md#fs-ioc-fiemap)
  - [FIBMAP (deprecated)](operations.md#fibmap-deprecated)

Below are a discussion of the high level file operations that iomap
implements.

## [2.1. Buffered I/O](operations.md#id1)
...
### [2.1.1. `struct address_space_operations`](operations.md#id2)
...
### [2.1.2. `struct iomap_write_ops`](operations.md#id3)
...
>   `iomap_get_folio`.
>   This could be used to [set up per-folio filesystem state](https://lore.kernel.org/all/20190429220934.10415-5-agruenba@redhat.com/)
>   for a write.
...
>   This could be used to [commit per-folio filesystem state](https://lore.kernel.org/all/20180619164137.13720-6-hch@lst.de/)
...
>   takes](https://lore.kernel.org/all/20221123055812.747923-8-david@fromorbit.com/)
...
### [2.1.3. Internal per-Folio State](operations.md#id4)
...
This enables iomap to handle both “bs < ps” [filesystems](https://lore.kernel.org/all/20230725122932.144426-1-ritesh.list@gmail.com/)
...
### [2.1.4. Buffered Readahead and Reads](operations.md#id5)
...
### [2.1.5. Buffered Writes](operations.md#id6)
...
#### [2.1.5.1. mmap Write Faults](operations.md#id7)
...
#### [2.1.5.2. Buffered Write Failures](operations.md#id8)

After a short write to the pagecache, the areas not written will not
become marked dirty.
The filesystem must arrange to [cancel](https://lore.kernel.org/all/20221123055812.747923-6-david@fromorbit.com/)
such [reservations](https://lore.kernel.org/linux-xfs/20220817093627.GZ3600936@dread.disaster.area/)
...
#### [2.1.5.3. Zeroing for File Operations](operations.md#id9)
...
#### [2.1.5.4. Unsharing Reflinked File Data](operations.md#id10)
...
### [2.1.6. Truncation](operations.md#id11)
...
### [2.1.7. Pagecache Writeback](operations.md#id12)
...
#### [2.1.7.1. `struct iomap_writeback_ops`](operations.md#id13)
...
>   though it will [reuse mappings](https://lore.kernel.org/all/20231207072710.176093-15-hch@lst.de/)
...
>   pagecache.
>   Filesystems can use this callback to [remove](https://lore.kernel.org/all/20201029163313.1766967-1-bfoster@redhat.com/)
...
#### [2.1.7.2. Pagecache Writeback Completion](operations.md#id14)
...
transactions](https://lore.kernel.org/all/20220120034733.221737-1-david@fromorbit.com/)
...
## [2.2. Direct I/O](operations.md#id15)
...
request](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=c03098d4b9ad76bca2966a8769dcfe59f7f85103)
...
>   but a lot of [detailed checking](https://lore.kernel.org/linux-ext4/20230314130759.642710-1-bfoster@redhat.com/)
>   is required to do it [correctly](https://lore.kernel.org/linux-ext4/20230810165559.946222-1-bfoster@redhat.com/).
...
### [2.2.1. Return Values](operations.md#id16)
...
### [2.2.2. Direct Reads](operations.md#id17)
...
### [2.2.3. Direct Writes](operations.md#id18)
...
### [2.2.4. `struct iomap_dio_ops:`](operations.md#id19)
...
>   This enables filesystems to [stash additional per-bio information](https://lore.kernel.org/all/20220505201115.937837-3-hch@lst.de/)
>   for private use.
...
## [2.3. DAX I/O](operations.md#id20)
...
### [2.3.1. fsdax Reads](operations.md#id21)
...
### [2.3.2. fsdax Writes](operations.md#id22)
...
#### [2.3.2.1. fsdax mmap Faults](operations.md#id23)
...
### [2.3.3. fsdax Truncation, fallocate, and Unsharing](operations.md#id24)
...
### [2.3.4. fsdax Deduplication](operations.md#id25)
...
## [2.4. Seeking Files](operations.md#id26)

iomap implements the two iterating whence modes of the `llseek` system
call.

### [2.4.1. SEEK_DATA](operations.md#id27)
...
### [2.4.2. SEEK_HOLE](operations.md#id28)
...
## [2.5. Swap File Activation](operations.md#id29)
...
## [2.6. File Space Mapping Reporting](operations.md#id30)

iomap implements two of the file space mapping system calls.

### [2.6.1. FS_IOC_FIEMAP](operations.md#id31)
...
### [2.6.2. FIBMAP (deprecated)](operations.md#id32)
