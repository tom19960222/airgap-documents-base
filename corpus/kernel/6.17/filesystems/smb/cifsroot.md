...
collection: kernel
version: "6.17"
title: "Mounting root file system via SMB (cifs.ko)"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/smb/cifsroot.html
fetched_at: 2026-09-16T16:42:23+00:00
---
# Mounting root file system via SMB (cifs.ko)

Written 2019 by Paulo Alcantara <[palcantara@suse.de](mailto:palcantara%40suse.de)>

Written 2019 by Aurelien Aptel <[aaptel@suse.com](mailto:aaptel%40suse.com)>
...
[Mounting the root filesystem via NFS (nfsroot)](../../admin-guide/nfs/nfsroot.md).
