...
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/journalling.html
...
might have used [`bforget()`](buffer.md#c.bforget "bforget") in the past.
...
:   [`bforget()`](buffer.md#c.bforget "bforget") for potentially-journaled buffers.
...
so [`try_to_free_buffers()`](buffer.md#c.try_to_free_buffers "try_to_free_buffers") can reap them.

This function returns non-zero if we wish [`try_to_free_buffers()`](buffer.md#c.try_to_free_buffers "try_to_free_buffers")
to be called. We do this if the page is releasable by [`try_to_free_buffers()`](buffer.md#c.try_to_free_buffers "try_to_free_buffers").
