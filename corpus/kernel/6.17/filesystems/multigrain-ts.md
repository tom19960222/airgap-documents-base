...
collection: kernel
version: "6.17"
title: "Multigrain Timestamps"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/multigrain-ts.html
fetched_at: 2026-09-16T16:41:54+00:00
---
...
[`inode_set_ctime_current()`](api-summary.md#c.inode_set_ctime_current "inode_set_ctime_current"). If the filesystem has a ->getattr routine that
doesn’t call generic_fillattr, then it should call [`fill_mg_cmtime()`](api-summary.md#c.fill_mg_cmtime "fill_mg_cmtime") to
fill those values. For setattr, it should use [`setattr_copy()`](api-summary.md#c.setattr_copy "setattr_copy") to update the
