...
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/splice.html
fetched_at: 2026-09-16T16:26:57+00:00
---
# splice and pipes
...
ssize_t copy_splice_read(struct [file](api-summary.md#c.file "file") \*in, loff_t \*ppos, struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe, size_t len, unsigned int flags)
...
ssize_t splice_from_pipe(struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe, struct [file](api-summary.md#c.file "file") \*out, loff_t \*ppos, size_t len, unsigned int flags, splice_actor \*actor)
...
ssize_t iter_file_splice_write(struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe, struct [file](api-summary.md#c.file "file") \*out, loff_t \*ppos, size_t len, unsigned int flags)
:   splice data from a pipe to a file
...
ssize_t splice_to_socket(struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe, struct [file](api-summary.md#c.file "file") \*out, loff_t \*ppos, size_t len, unsigned int flags)
...
ssize_t vfs_splice_read(struct [file](api-summary.md#c.file "file") \*in, loff_t \*ppos, struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe, size_t len, unsigned int flags)
...
ssize_t splice_direct_to_actor(struct [file](api-summary.md#c.file "file") \*in, struct splice_desc \*sd, splice_direct_actor \*actor)
...
ssize_t do_splice_direct(struct [file](api-summary.md#c.file "file") \*in, loff_t \*ppos, struct [file](api-summary.md#c.file "file") \*out, loff_t \*opos, size_t len, unsigned int flags)
...
ssize_t splice_file_range(struct [file](api-summary.md#c.file "file") \*in, loff_t \*ppos, struct [file](api-summary.md#c.file "file") \*out, loff_t \*opos, size_t len)
...
`files`
:   number of [`struct file`](api-summary.md#c.file "file") referring this pipe (protected by ->i_lock)
...
bool pipe_is_full(const struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe)
:   Return true if the pipe is full
...
bool pipe_is_empty(const struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe)
:   Return true if the pipe is empty
...
unsigned int pipe_buf_usage(const struct [pipe_inode_info](splice.md#c.pipe_inode_info "pipe_inode_info") \*pipe)
