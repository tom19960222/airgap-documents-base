...
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/path-lookup.html
fetched_at: 2026-09-16T16:41:51+00:00
---
# Pathname lookup
...
“`*at()`” system calls such as [openat()](http://man7.org/linux/man-pages/man2/openat.2.html).
...
can execute it by calling [execveat()](http://man7.org/linux/man-pages/man2/execveat.2.html) passing
...
ending in “`/`”. According to [POSIX](https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/V1_chap04.html#tag_04_12):
...
as in [Meet the Lockers](https://lwn.net/Articles/453685/).
...
all the way back to [First Edition Unix](https://minnie.tuhs.org/cgi-bin/utree.pl?file=V1/u2.s) - of the function that
...
covered in greater detail in [autofs - how it works](autofs.md) in the Linux documentation
...
involves using [READ_ONCE()](https://lwn.net/Articles/624126/) to access fields, and verifying the
...
common [object-oriented design pattern](https://lwn.net/Articles/446317/) in the kernel). This will
...
subject. The [clearest statement](https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/V1_chap04.html#tag_04_08) is that, if a particular implementation
...
An examination of history shows that prior to [Linux 1.3.87](https://git.kernel.org/cgit/linux/kernel/git/history/history.git/diff/fs/ext2/symlink.c?id=f806c6db77b8eaa6e00dcfb6b567706feae8dbb8), the ext2
