...
version: "6.17"
title: "NFS LOCALIO"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/nfs/localio.html
fetched_at: 2026-09-16T16:42:15+00:00
---
# NFS LOCALIO
...
1. What are the use cases for LOCALIO?
   ...
   1. Workloads where the NFS client and server are on the same host
...
2. What are the requirements for LOCALIO?
   ...
   1. Bypass use of the network RPC protocol as much as possible. This
      includes bypassing XDR and RPC for open, read, write and commit
      operations.
   2. Allow client and server to autonomously discover if they are
      running local to each other without making any assumptions about
      the local network topology.
   3. Support the use of containers by being compatible with relevant
      namespaces (e.g. network, user, mount).
   4. Support all versions of NFS. NFSv3 is of particular importance
