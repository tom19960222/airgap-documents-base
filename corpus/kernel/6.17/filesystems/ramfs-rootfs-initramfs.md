...
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ramfs-rootfs-initramfs.html
fetched_at: 2026-09-16T16:42:20+00:00
---
...
tmpfs mounts. See [Tmpfs](tmpfs.md) for more information.
...
>   see cpio(1) and [initramfs buffer format](../driver-api/early-userspace/buffer-format.md)).
...
[Early userspace support](../driver-api/early-userspace/early_userspace_support.md) for more details.)
