...
version: "6.17"
title: "Tmpfs"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/tmpfs.html
fetched_at: 2026-09-16T16:42:27+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/filesystems/tmpfs.md)
- [Chinese (Traditional)](../translations/zh_TW/filesystems/tmpfs.md)
...
See also [Transparent Hugepage Support](../admin-guide/mm/transhuge.md), which describes the
...
[See [CPUSETS](../admin-guide/cgroup-v1/cpusets.md)] and any optional flags,
...
See [NUMA Memory Policy](../admin-guide/mm/numa_memory_policy.md) for a list of
...
|  |  |
| --- | --- |
| casefold | Enable casefold support at this mount point using the given argument as the encoding standard. Currently only UTF-8 encodings are supported. If no argument is used, it will load the latest UTF-8 encoding available. |
| strict_encoding | Enable strict encoding at this mount point (disabled by default). In this mode, the filesystem refuses to create file and directory with names containing invalid UTF-8 characters. |
...
Author:
:   Christoph Rohland <[cr@sap.com](mailto:cr%40sap.com)>, 1.12.01
