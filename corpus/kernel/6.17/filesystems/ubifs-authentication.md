...
collection: kernel
version: "6.17"
title: "UBIFS Authentication Support"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/ubifs-authentication.html
...
LEB type and amount of free and *dirty* (old, obsolete content) space [[1]](ubifs-authentication.md#id2) on
...
[[1](ubifs-authentication.md#id1)]

Since LEBs can only be appended and never overwritten, there is a
