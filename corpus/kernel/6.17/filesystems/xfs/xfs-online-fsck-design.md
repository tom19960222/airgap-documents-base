...
collection: kernel
version: "6.17"
title: "4. XFS Online Fsck Design"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/xfs/xfs-online-fsck-design.html
fetched_at: 2026-09-16T16:42:30+00:00
---
...
- [1. What is a Filesystem Check?](xfs-online-fsck-design.md#what-is-a-filesystem-check)

  - [TLDR; Show Me the Code!](xfs-online-fsck-design.md#tldr-show-me-the-code)
  - [Existing Tools](xfs-online-fsck-design.md#existing-tools)
  - [Problem Statement](xfs-online-fsck-design.md#problem-statement)
- [2. Theory of Operation](xfs-online-fsck-design.md#theory-of-operation)

  - [Scope](xfs-online-fsck-design.md#scope)
  - [Phases of Work](xfs-online-fsck-design.md#phases-of-work)
  - [Steps for Each Scrub Item](xfs-online-fsck-design.md#steps-for-each-scrub-item)
  - [Classification of Metadata](xfs-online-fsck-design.md#classification-of-metadata)

    - [Primary Metadata](xfs-online-fsck-design.md#primary-metadata)
    - [Secondary Metadata](xfs-online-fsck-design.md#secondary-metadata)
    - [Summary Information](xfs-online-fsck-design.md#summary-information)
  - [Risk Management](xfs-online-fsck-design.md#risk-management)
- [3. Testing Plan](xfs-online-fsck-design.md#testing-plan)

  - [Integrated Testing with fstests](xfs-online-fsck-design.md#integrated-testing-with-fstests)
  - [General Fuzz Testing of Metadata Blocks](xfs-online-fsck-design.md#general-fuzz-testing-of-metadata-blocks)
  - [Targeted Fuzz Testing of Metadata Records](xfs-online-fsck-design.md#targeted-fuzz-testing-of-metadata-records)
  - [Stress Testing](xfs-online-fsck-design.md#stress-testing)
- [4. User Interface](xfs-online-fsck-design.md#user-interface)

  - [Checking on Demand](xfs-online-fsck-design.md#checking-on-demand)
  - [Background Service](xfs-online-fsck-design.md#background-service)
  - [Health Reporting](xfs-online-fsck-design.md#health-reporting)
- [5. Kernel Algorithms and Data Structures](xfs-online-fsck-design.md#kernel-algorithms-and-data-structures)

  - [Self Describing Metadata](xfs-online-fsck-design.md#self-describing-metadata)
  - [Reverse Mapping](xfs-online-fsck-design.md#reverse-mapping)
  - [Checking and Cross-Referencing](xfs-online-fsck-design.md#checking-and-cross-referencing)

    - [Metadata Buffer Verification](xfs-online-fsck-design.md#metadata-buffer-verification)
    - [Internal Consistency Checks](xfs-online-fsck-design.md#internal-consistency-checks)
    - [Validation of Userspace-Controlled Record Attributes](xfs-online-fsck-design.md#validation-of-userspace-controlled-record-attributes)
    - [Cross-Referencing Space Metadata](xfs-online-fsck-design.md#cross-referencing-space-metadata)
    - [Checking Extended Attributes](xfs-online-fsck-design.md#checking-extended-attributes)
    - [Checking and Cross-Referencing Directories](xfs-online-fsck-design.md#checking-and-cross-referencing-directories)

      - [Checking Directory/Attribute Btrees](xfs-online-fsck-design.md#checking-directory-attribute-btrees)
    - [Cross-Referencing Summary Counters](xfs-online-fsck-design.md#cross-referencing-summary-counters)
    - [Post-Repair Reverification](xfs-online-fsck-design.md#post-repair-reverification)
  - [Eventual Consistency vs. Online Fsck](xfs-online-fsck-design.md#eventual-consistency-vs-online-fsck)

    - [Discovery of the Problem](xfs-online-fsck-design.md#discovery-of-the-problem)
    - [Intent Drains](xfs-online-fsck-design.md#intent-drains)
    - [Static Keys (aka Jump Label Patching)](xfs-online-fsck-design.md#static-keys-aka-jump-label-patching)
  - [Pageable Kernel Memory](xfs-online-fsck-design.md#pageable-kernel-memory)

    - [xfile Access Models](xfs-online-fsck-design.md#xfile-access-models)
    - [xfile Access Coordination](xfs-online-fsck-design.md#xfile-access-coordination)
    - [Arrays of Fixed-Sized Records](xfs-online-fsck-design.md#arrays-of-fixed-sized-records)

      - [Array Access Patterns](xfs-online-fsck-design.md#array-access-patterns)
      - [Iterating Array Elements](xfs-online-fsck-design.md#iterating-array-elements)
      - [Sorting Array Elements](xfs-online-fsck-design.md#sorting-array-elements)

        - [Case Study: Sorting xfarrays](xfs-online-fsck-design.md#case-study-sorting-xfarrays)
    - [Blob Storage](xfs-online-fsck-design.md#blob-storage)
    - [In-Memory B+Trees](xfs-online-fsck-design.md#in-memory-b-trees)

      - [Using xfiles as a Buffer Cache Target](xfs-online-fsck-design.md#using-xfiles-as-a-buffer-cache-target)
      - [Space Management with an xfbtree](xfs-online-fsck-design.md#space-management-with-an-xfbtree)
      - [Populating an xfbtree](xfs-online-fsck-design.md#populating-an-xfbtree)
      - [Committing Logged xfbtree Buffers](xfs-online-fsck-design.md#committing-logged-xfbtree-buffers)
  - [Bulk Loading of Ondisk B+Trees](xfs-online-fsck-design.md#bulk-loading-of-ondisk-b-trees)

    - [Geometry Computation](xfs-online-fsck-design.md#geometry-computation)
    - [Reserving New B+Tree Blocks](xfs-online-fsck-design.md#reserving-new-b-tree-blocks)
    - [Writing the New Tree](xfs-online-fsck-design.md#writing-the-new-tree)

      - [Case Study: Rebuilding the Inode Index](xfs-online-fsck-design.md#case-study-rebuilding-the-inode-index)
      - [Case Study: Rebuilding the Space Reference Counts](xfs-online-fsck-design.md#case-study-rebuilding-the-space-reference-counts)
      - [Case Study: Rebuilding File Fork Mapping Indices](xfs-online-fsck-design.md#case-study-rebuilding-file-fork-mapping-indices)
  - [Reaping Old Metadata Blocks](xfs-online-fsck-design.md#reaping-old-metadata-blocks)

    - [Case Study: Reaping After a Regular Btree Repair](xfs-online-fsck-design.md#case-study-reaping-after-a-regular-btree-repair)
    - [Case Study: Rebuilding the Free Space Indices](xfs-online-fsck-design.md#case-study-rebuilding-the-free-space-indices)
    - [Case Study: Reaping After Repairing Reverse Mapping Btrees](xfs-online-fsck-design.md#case-study-reaping-after-repairing-reverse-mapping-btrees)
    - [Case Study: Rebuilding the AGFL](xfs-online-fsck-design.md#case-study-rebuilding-the-agfl)
  - [Inode Record Repairs](xfs-online-fsck-design.md#inode-record-repairs)
  - [Quota Record Repairs](xfs-online-fsck-design.md#quota-record-repairs)
  - [Freezing to Fix Summary Counters](xfs-online-fsck-design.md#freezing-to-fix-summary-counters)
  - [Full Filesystem Scans](xfs-online-fsck-design.md#full-filesystem-scans)

    - [Coordinated Inode Scans](xfs-online-fsck-design.md#coordinated-inode-scans)
    - [Inode Management](xfs-online-fsck-design.md#inode-management)

      - [iget and irele During a Scrub](xfs-online-fsck-design.md#iget-and-irele-during-a-scrub)
      - [Locking Inodes](xfs-online-fsck-design.md#locking-inodes)
      - [Case Study: Finding a Directory Parent](xfs-online-fsck-design.md#case-study-finding-a-directory-parent)
    - [Filesystem Hooks](xfs-online-fsck-design.md#filesystem-hooks)
    - [Live Updates During a Scan](xfs-online-fsck-design.md#live-updates-during-a-scan)

      - [Case Study: Quota Counter Checking](xfs-online-fsck-design.md#case-study-quota-counter-checking)
      - [Case Study: File Link Count Checking](xfs-online-fsck-design.md#case-study-file-link-count-checking)
      - [Case Study: Rebuilding Reverse Mapping Records](xfs-online-fsck-design.md#case-study-rebuilding-reverse-mapping-records)
  - [Staging Repairs with Temporary Files on Disk](xfs-online-fsck-design.md#staging-repairs-with-temporary-files-on-disk)

    - [Using a Temporary File](xfs-online-fsck-design.md#using-a-temporary-file)
  - [Logged File Content Exchanges](xfs-online-fsck-design.md#logged-file-content-exchanges)

    - [Mechanics of a Logged File Content Exchange](xfs-online-fsck-design.md#mechanics-of-a-logged-file-content-exchange)
    - [Preparation for File Content Exchanges](xfs-online-fsck-design.md#preparation-for-file-content-exchanges)
    - [Special Features for Exchanging Metadata File Contents](xfs-online-fsck-design.md#special-features-for-exchanging-metadata-file-contents)
    - [Exchanging Temporary File Contents](xfs-online-fsck-design.md#exchanging-temporary-file-contents)

      - [Case Study: Repairing the Realtime Summary File](xfs-online-fsck-design.md#case-study-repairing-the-realtime-summary-file)
      - [Case Study: Salvaging Extended Attributes](xfs-online-fsck-design.md#case-study-salvaging-extended-attributes)
  - [Fixing Directories](xfs-online-fsck-design.md#fixing-directories)

    - [Case Study: Salvaging Directories](xfs-online-fsck-design.md#case-study-salvaging-directories)
    - [Parent Pointers](xfs-online-fsck-design.md#parent-pointers)

      - [Case Study: Repairing Directories with Parent Pointers](xfs-online-fsck-design.md#case-study-repairing-directories-with-parent-pointers)
      - [Case Study: Repairing Parent Pointers](xfs-online-fsck-design.md#case-study-repairing-parent-pointers)
      - [Digression: Offline Checking of Parent Pointers](xfs-online-fsck-design.md#digression-offline-checking-of-parent-pointers)
      - [Case Study: Directory Tree Structure](xfs-online-fsck-design.md#case-study-directory-tree-structure)
  - [The Orphanage](xfs-online-fsck-design.md#the-orphanage)
- [6. Userspace Algorithms and Data Structures](xfs-online-fsck-design.md#userspace-algorithms-and-data-structures)

  - [Checking Metadata](xfs-online-fsck-design.md#checking-metadata)
  - [Parallel Inode Scans](xfs-online-fsck-design.md#parallel-inode-scans)
  - [Scheduling Repairs](xfs-online-fsck-design.md#scheduling-repairs)
  - [Checking Names for Confusable Unicode Sequences](xfs-online-fsck-design.md#checking-names-for-confusable-unicode-sequences)
  - [Media Verification of File Data Extents](xfs-online-fsck-design.md#media-verification-of-file-data-extents)
- [7. Conclusion and Future Work](xfs-online-fsck-design.md#conclusion-and-future-work)

  - [XFS_IOC_EXCHANGE_RANGE](xfs-online-fsck-design.md#xfs-ioc-exchange-range)

    - [File Content Exchanges with Regular User Files](xfs-online-fsck-design.md#file-content-exchanges-with-regular-user-files)
  - [Vectorized Scrub](xfs-online-fsck-design.md#vectorized-scrub)
  - [Quality of Service Targets for Scrub](xfs-online-fsck-design.md#quality-of-service-targets-for-scrub)
  - [Defragmenting Free Space](xfs-online-fsck-design.md#defragmenting-free-space)
  - [Shrinking Filesystems](xfs-online-fsck-design.md#shrinking-filesystems)

## [4.1. 1. What is a Filesystem Check?](xfs-online-fsck-design.md#id13)
...
### [4.1.1. TLDR; Show Me the Code!](xfs-online-fsck-design.md#id14)

Code is posted to the kernel.org git trees as follows:
[kernel changes](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-symlink),
[userspace changes](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-media-scan-service), and
[QA test changes](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=repair-dirs).
...
### [4.1.2. Existing Tools](xfs-online-fsck-design.md#id15)
...
### [4.1.3. Problem Statement](xfs-online-fsck-design.md#id16)
...
## [4.2. 2. Theory of Operation](xfs-online-fsck-design.md#id17)
...
### [4.2.1. Scope](xfs-online-fsck-design.md#id18)
...
### [4.2.2. Phases of Work](xfs-online-fsck-design.md#id19)
...
This allocation of responsibilities will be [revisited](xfs-online-fsck-design.md#scrubcheck)
later in this document.

### [4.2.3. Steps for Each Scrub Item](xfs-online-fsck-design.md#id20)
...
### [4.2.4. Classification of Metadata](xfs-online-fsck-design.md#id21)

Each type of metadata object (and therefore each type of scrub item) is
classified as follows:

#### [4.2.4.1. Primary Metadata](xfs-online-fsck-design.md#id22)
...
Algorithms”](https://minds.wisconsin.edu/bitstream/handle/1793/59524/TR1047.pdf),
...
#### [4.2.4.2. Secondary Metadata](xfs-online-fsck-design.md#id23)
...
Creating Indexes for Very Large Tables Without Quiescing Updates”](https://dl.acm.org/doi/10.1145/130283.130337), 1992.
...
#### [4.2.4.3. Summary Information](xfs-online-fsck-design.md#id24)
...
and Their Indexes”](http://www.odbms.org/wp-content/uploads/2014/06/Increment-locks.pdf), 2011.
...
### [4.2.5. Risk Management](xfs-online-fsck-design.md#id25)
...
## [4.3. 3. Testing Plan](xfs-online-fsck-design.md#id26)
...
### [4.3.1. Integrated Testing with fstests](xfs-online-fsck-design.md#id27)
...
[fstests](https://git.kernel.org/pub/scm/fs/xfs/xfstests-dev.git/), for
...
### [4.3.2. General Fuzz Testing of Metadata Blocks](xfs-online-fsck-design.md#id28)
...
### [4.3.3. Targeted Fuzz Testing of Metadata Records](xfs-online-fsck-design.md#id29)
...
[general fuzzer improvements](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=fuzzer-improvements),
[fuzzing baselines](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=fuzz-baseline),
and [improvements in fuzz testing comprehensiveness](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=more-fuzz-testing).

### [4.3.4. Stress Testing](xfs-online-fsck-design.md#id30)
...
Proposed patchsets include [general stress testing](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=race-scrub-and-mount-state-changes)
and the [evolution of existing per-function stress testing](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfstests-dev.git/log/?h=refactor-scrub-stress).

## [4.4. 4. User Interface](xfs-online-fsck-design.md#id31)
...
### [4.4.1. Checking on Demand](xfs-online-fsck-design.md#id32)
...
### [4.4.2. Background Service](xfs-online-fsck-design.md#id33)

To reduce the workload of system administrators, the `xfs_scrub` package
provides a suite of [systemd](https://systemd.io/) timers and services that
...
Proposed patchset:
[Enabling the xfs_scrub background service](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-media-scan-service).

### [4.4.3. Health Reporting](xfs-online-fsck-design.md#id34)
...
Proposed patchsets include
[wiring up health reports to correction returns](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=corruption-health-reports)
and
[preservation of sickness info during memory reclaim](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=indirect-health-reporting).

## [4.5. 5. Kernel Algorithms and Data Structures](xfs-online-fsck-design.md#id35)
...
### [4.5.1. Self Describing Metadata](xfs-online-fsck-design.md#id36)
...
[XFS Self Describing Metadata](xfs-self-describing-metadata.md)

### [4.5.2. Reverse Mapping](xfs-online-fsck-design.md#id37)
...
### [4.5.3. Checking and Cross-Referencing](xfs-online-fsck-design.md#id38)
...
#### [4.5.3.1. Metadata Buffer Verification](xfs-online-fsck-design.md#id39)
...
#### [4.5.3.2. Internal Consistency Checks](xfs-online-fsck-design.md#id40)
...
#### [4.5.3.3. Validation of Userspace-Controlled Record Attributes](xfs-online-fsck-design.md#id41)
...
#### [4.5.3.4. Cross-Referencing Space Metadata](xfs-online-fsck-design.md#id42)
...
[refcount btree](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-detect-refcount-gaps),
[inode btree](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-detect-inobt-gaps), and
[rmap btree](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-detect-rmapbt-gaps) records;
to find
[mergeable records](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-detect-mergeable-records);
and to
[improve cross referencing with rmap](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-strengthen-rmap-checking)
before starting a repair.

#### [4.5.3.5. Checking Extended Attributes](xfs-online-fsck-design.md#id43)
...
#### [4.5.3.6. Checking and Cross-Referencing Directories](xfs-online-fsck-design.md#id44)
...
2. Walk the blocks of the first partition looking for directory entries.
   ...
   4. If a file type is included in the dirent, does it match the type of the
      inode?
   5. If the child is a subdirectory, does the child’s dotdot pointer point
      back to the parent?
   6. If the directory has a second partition, perform a named lookup of the
...
Checking operations involving [parents](xfs-online-fsck-design.md#dirparent) and
[file link counts](xfs-online-fsck-design.md#nlinks) are discussed in more detail in later
sections.

##### [4.5.3.6.1. Checking Directory/Attribute Btrees](xfs-online-fsck-design.md#id45)
...
#### [4.5.3.7. Cross-Referencing Summary Counters](xfs-online-fsck-design.md#id46)
...
[more detail](xfs-online-fsck-design.md#fscounters) later.

[Quota usage](xfs-online-fsck-design.md#quotacheck) and [file link count](xfs-online-fsck-design.md#nlinks)
checking are sufficiently complicated to warrant separate sections.

#### [4.5.3.8. Post-Repair Reverification](xfs-online-fsck-design.md#id47)
...
### [4.5.4. Eventual Consistency vs. Online Fsck](xfs-online-fsck-design.md#id48)
...
[next section](xfs-online-fsck-design.md#chain-coordination), and details about the solution
are presented [after that](xfs-online-fsck-design.md#intent-drains).

#### [4.5.4.1. Discovery of the Problem](xfs-online-fsck-design.md#id49)
...
#### [4.5.4.2. Intent Drains](xfs-online-fsck-design.md#id50)
...
[scrub intent drain series](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-drain-intents).

#### [4.5.4.3. Static Keys (aka Jump Label Patching)](xfs-online-fsck-design.md#id51)
...
[Static Keys](../../staging/static-keys.md).

### [4.5.5. Pageable Kernel Memory](xfs-online-fsck-design.md#id52)
...
#### [4.5.5.1. xfile Access Models](xfs-online-fsck-design.md#id53)
...
The fifth use case is discussed in the [realtime summary](xfs-online-fsck-design.md#rtsummary) case
study.
...
[sorting](xfs-online-fsck-design.md#xfarray-sort) algorithms and the [in-memory
btrees](xfs-online-fsck-design.md#xfbtree).

#### [4.5.5.2. xfile Access Coordination](xfs-online-fsck-design.md#id54)
...
#### [4.5.5.3. Arrays of Fixed-Sized Records](xfs-online-fsck-design.md#id55)
...
##### [4.5.5.3.1. Array Access Patterns](xfs-online-fsck-design.md#id56)
...
The proposed patchset is the
[big in-memory array](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=big-array).

##### [4.5.5.3.2. Iterating Array Elements](xfs-online-fsck-design.md#id57)
...
##### [4.5.5.3.3. Sorting Array Elements](xfs-online-fsck-design.md#id58)
...
###### [4.5.5.3.3.1. Case Study: Sorting xfarrays](xfs-online-fsck-design.md#id59)
...
[Sedgewick](https://algs4.cs.princeton.edu/23quicksort/) and
[pdqsort](https://github.com/orlp/pdqsort), with customizations for the Linux
kernel.
...
#### [4.5.5.4. Blob Storage](xfs-online-fsck-design.md#id60)
...
[extended attribute repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-xattrs) series.

#### [4.5.5.5. In-Memory B+Trees](xfs-online-fsck-design.md#id61)

The chapter about [secondary metadata](xfs-online-fsck-design.md#secondary-metadata) mentioned that
...
Recall that the [xfile](xfs-online-fsck-design.md#xfile) abstraction represents memory pages as a
...
The proposed patchset is the
[in-memory btree](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=in-memory-btrees)
series.

##### [4.5.5.5.1. Using xfiles as a Buffer Cache Target](xfs-online-fsck-design.md#id62)
...
##### [4.5.5.5.2. Space Management with an xfbtree](xfs-online-fsck-design.md#id63)
...
##### [4.5.5.5.3. Populating an xfbtree](xfs-online-fsck-design.md#id64)
...
5. Pass the btree cursor to the regular btree functions to make queries against
   ...
   See the [next section](xfs-online-fsck-design.md#xfbtree-commit) for information on dealing with
...
##### [4.5.5.5.4. Committing Logged xfbtree Buffers](xfs-online-fsck-design.md#id65)
...
### [4.5.6. Bulk Loading of Ondisk B+Trees](xfs-online-fsck-design.md#id66)
...
#### [4.5.6.1. Geometry Computation](xfs-online-fsck-design.md#id67)
...
#### [4.5.6.2. Reserving New B+Tree Blocks](xfs-online-fsck-design.md#id68)
...
next section and the section about [reaping](xfs-online-fsck-design.md#reaping) for more details.

Proposed patchsets are the
[bitmap rework](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-bitmap-rework)
and the
[preparation for bulk loading btrees](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-prep-for-bulk-loading).

#### [4.5.6.3. Writing the New Tree](xfs-online-fsck-design.md#id69)
...
2. For each incore reservation:
   ...
   1. Log Extent Freeing Done (EFD) items for all the space that was consumed
   ...
   2. For unclaimed portions of incore reservations, create a regular deferred
      extent free work item to be free the unused space later in the
      transaction chain.
   3. The EFDs and EFIs logged in steps 2a and 2b must not overrun the
...
subsequent [section](xfs-online-fsck-design.md#reaping) after a few case studies of bulk loading.

##### [4.5.6.3.1. Case Study: Rebuilding the Inode Index](xfs-online-fsck-design.md#id70)
...
The proposed patchset is the
[AG btree repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-ag-btrees)
series.

##### [4.5.6.3.2. Case Study: Rebuilding the Space Reference Counts](xfs-online-fsck-design.md#id71)
...
[xfarray access patterns](xfs-online-fsck-design.md#xfarray-access-patterns) section.
...
##### [4.5.6.3.3. Case Study: Rebuilding File Fork Mapping Indices](xfs-online-fsck-design.md#id72)
...
The proposed patchset is the
[file mapping repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-file-mappings)
series.

### [4.5.7. Reaping Old Metadata Blocks](xfs-online-fsck-design.md#id73)
...
#### [4.5.7.1. Case Study: Reaping After a Regular Btree Repair](xfs-online-fsck-design.md#id74)
...
#### [4.5.7.2. Case Study: Rebuilding the Free Space Indices](xfs-online-fsck-design.md#id75)
...
#### [4.5.7.3. Case Study: Reaping After Repairing Reverse Mapping Btrees](xfs-online-fsck-design.md#id76)
...
[live rebuilds of rmap data](xfs-online-fsck-design.md#rmap-repair), but a crucial point from that
...
in a separate [case study](xfs-online-fsck-design.md#rmap-repair).

The proposed patchset is the
[AG btree repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-ag-btrees)
series.

#### [4.5.7.4. Case Study: Rebuilding the AGFL](xfs-online-fsck-design.md#id77)
...
See [fs/xfs/scrub/agheader_repair.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/fs/xfs/scrub/agheader_repair.c) for more details.

### [4.5.8. Inode Record Repairs](xfs-online-fsck-design.md#id78)
...
### [4.5.9. Quota Record Repairs](xfs-online-fsck-design.md#id79)
...
section about [live quotacheck](xfs-online-fsck-design.md#quotacheck).

The proposed patchset is the
[quota](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-quota)
repair series.

### [4.5.10. Freezing to Fix Summary Counters](xfs-online-fsck-design.md#id80)
...
#### [4.5.11.1. Coordinated Inode Scans](xfs-online-fsck-design.md#id82)
...
This system is described by J. Lions, [“inode (5659)”](http://www.lemis.com/grog/Documentation/Lions/) in *Lions’ Commentary on
...
[“Implementation of the File System”](https://archive.org/details/bstj57-6-1905/page/n8/mode/1up), from *The UNIX
...
3. If there are no more inodes left in this AG:
   ...
   1. Move the examination cursor to the point of the inumber keyspace that
      corresponds to the start of the next AG.
   2. Adjust the visited inode cursor to indicate that it has “visited” the
      ...
      inode keyspace.
   3. Unlock the AGI and return to step 1 if there are unexamined AGs in the
      filesystem.
   4. If there are no more AGs to examine, set both cursors to the end of the
      inumber keyspace.
      The scan is now complete.
4. Otherwise, there is at least one more inode to scan in this AG:

   1. Move the examination cursor ahead to the next inode marked as allocated
      by the inode btree.
   2. Adjust the visited inode cursor to point to the inode just prior to where
...
2. Advance the scan cursor (`xchk_iscan_iter`) to get the next inode.
   ...
   2. Scan the inode.
   3. While still holding the inode lock, adjust the visited inode cursor
...
[inode scanner](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-iscan)
series.
The first user of the new functionality is the
[online quotacheck](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-quotacheck)
series.

#### [4.5.11.2. Inode Management](xfs-online-fsck-design.md#id83)
...
##### [4.5.11.2.1. iget and irele During a Scrub](xfs-online-fsck-design.md#id84)
...
[scrub iget usage](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-iget-fixes) and
[dir iget usage](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-dir-iget-fixes).

##### [4.5.11.2.2. Locking Inodes](xfs-online-fsck-design.md#id85)
...
##### [4.5.11.2.3. Case Study: Finding a Directory Parent](xfs-online-fsck-design.md#id86)
...
The proposed patchset is the
[directory repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-dirs)
series.

#### [4.5.11.3. Filesystem Hooks](xfs-online-fsck-design.md#id87)
...
filesystem operations: filesystem hooks and [static keys](xfs-online-fsck-design.md#jump-labels).
...
#### [4.5.11.4. Live Updates During a Scan](xfs-online-fsck-design.md#id88)

The code paths of the online fsck scanning code and the [hooked](xfs-online-fsck-design.md#fshooks)
...
##### [4.5.11.4.1. Case Study: Quota Counter Checking](xfs-online-fsck-design.md#id89)
...
2. For each dquot attached to the file:
   ...
   2. A quota reservation is added to the dquot’s resource usage.
...
4. At transaction commit time, each dquot is examined again:
   ...
   2. Quota usage changes are logged and unused reservation is given back to
      the dquot.
   3. The dquot is unlocked.
...
2. For each inode returned by the inode scan iterator:
   ...
   2. Determine that inode’s resource usage (data blocks, inode counts,
...
3. For each dquot in the system:
   ...
   2. Check the dquot against the shadow dquots created by the scan and updated
      by the live hooks.
...
##### [4.5.11.4.2. Case Study: File Link Count Checking](xfs-online-fsck-design.md#id90)
...
shadow information.
If no parents are found, the file must be [reparented](xfs-online-fsck-design.md#orphanage) to the
orphanage to prevent the file from being lost forever.

The proposed patchset is the
[file link count repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-nlinks)
series.

##### [4.5.11.4.3. Case Study: Rebuilding Reverse Mapping Records](xfs-online-fsck-design.md#id91)
...
and use an [in-memory array](xfs-online-fsck-design.md#xfarray) to store the gathered observations.
...
It combines a [coordinated inode scanner](xfs-online-fsck-design.md#iscan), [live update hooks](xfs-online-fsck-design.md#liveupdate), and an [in-memory rmap btree](xfs-online-fsck-design.md#xfbtree) to complete the
...
5. For each space mapping found in either fork of each file scanned,
   ...
   3. Use the [special commit function](xfs-online-fsck-design.md#xfbtree-commit) to write the
...
11. Reap the old rmap btree blocks as discussed in the case study about how
    to [reap after rmap btree repair](xfs-online-fsck-design.md#rmap-reap).
12. Free the xfbtree now that it not needed.

The proposed patchset is the
[rmap repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-rmap-btree)
series.

### [4.5.12. Staging Repairs with Temporary Files on Disk](xfs-online-fsck-design.md#id92)
...
locking](xfs-online-fsck-design.md#ilocking) section, it is recommended that scrub functions use the
...
[repair temporary files](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-tempfiles)
series.

### [4.5.13. Logged File Content Exchanges](xfs-online-fsck-design.md#id94)
...
1. When the reverse-mapping btree is enabled, the swap code must keep the
...
2. Reverse-mapping is critical for the operation of online fsck, so the old
   defragmentation code (which swapped entire extent forks in a single
   operation) is not useful here.
3. Defragmentation is assumed to occur between two files with identical
   contents.
...
4. Online repair needs to swap the contents of two files that are by definition
   *not* identical.
...
5. Old blocks in the file may be cross-linked with another structure and must
...
3. Until `xmi_blockcount` of the deferred mapping exchange work item is zero,
   ...
   1. Read the block maps of both file ranges starting at `xmi_startoff1` and
   ...
   8. Log a mapping exchange done log item for th mapping exchange intent log
      item that was read at the start of step 3.
   9. Compute the amount of file range that has just been covered.
      This quantity is `(map1.br_startoff + map1.br_blockcount -
      xmi_startoff1)`, because step 3a could have skipped holes.
   10. Increase the starting offsets of `xmi_startoff1` and `xmi_startoff2`
       by the number of blocks computed in the previous step, and decrease
       `xmi_blockcount` by the same quantity.
       This advances the cursor.
   11. Log a new mapping exchange intent log item reflecting the advanced state
       of the work item.
   12. Return the proper error code (EAGAIN) to the deferred operation manager
...
#### [4.5.13.2. Preparation for File Content Exchanges](xfs-online-fsck-design.md#id96)
...
#### [4.5.13.3. Special Features for Exchanging Metadata File Contents](xfs-online-fsck-design.md#id97)
...
extent reaping](xfs-online-fsck-design.md#reaping) mechanism that is done post-repair.
...
#### [4.5.13.4. Exchanging Temporary File Contents](xfs-online-fsck-design.md#id98)
...
##### [4.5.13.4.1. Case Study: Repairing the Realtime Summary File](xfs-online-fsck-design.md#id99)
...
2. For each free space extent recorded in the bitmap:
   ...
   1. Compute the position in the summary file that contains a counter that
...
The proposed patchset is the
[realtime summary repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-rtsummary)
series.

##### [4.5.13.4.2. Case Study: Salvaging Extended Attributes](xfs-online-fsck-design.md#id100)
...
1. Walk the attr fork mappings of the file being repaired to find the attribute
   ...
   1. Walk the attr leaf block to find candidate keys.
      When one is found,
...
The proposed patchset is the
[extended attribute repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-xattrs)
series.

### [4.5.14. Fixing Directories](xfs-online-fsck-design.md#id101)
...
The [file link count fsck](xfs-online-fsck-design.md#nlinks) code takes care of fixing link counts
and moving orphans to the `/lost+found` directory.

#### [4.5.14.1. Case Study: Salvaging Directories](xfs-online-fsck-design.md#id102)
...
2. Walk the first partition of data fork of the directory to find the directory
   ...
   1. Walk the directory data block to find candidate entries.
      When an entry is found:

      1. Check the name for problems, and ignore the name if there are.
      2. Retrieve the inumber and grab the inode.
...
#### [4.5.14.2. Parent Pointers](xfs-online-fsck-design.md#id103)
...
3. For each parent pointer found in each file scanned, decide if the parent
   ...
   1. Stash the parent pointer name and an addname entry for this dirent in the
      xfblob and xfarray, respectively.
   2. When finished scanning that file or the kernel memory consumption exceeds
...
4. For each live directory update received via the hook, decide if the child
   ...
   1. Stash the parent pointer name an addname or removename entry for this
...
The proposed patchset is the
[parent pointers directory repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=pptrs-fsck)
series.

##### [4.5.14.2.2. Case Study: Repairing Parent Pointers](xfs-online-fsck-design.md#id105)
...
3. For each directory entry found in each directory scanned, decide if the
   ...
   1. Stash the dirent name and an addpptr entry for this parent pointer in the
      xfblob and xfarray, respectively.
   2. When finished scanning the directory or the kernel memory consumption
...
4. For each live directory update received via the hook, decide if the parent
   ...
   1. Stash the dirent name and an addpptr or removepptr entry for this dirent
...
The proposed patchset is the
[parent pointers repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=pptrs-fsck)
series.

##### [4.5.14.2.3. Digression: Offline Checking of Parent Pointers](xfs-online-fsck-design.md#id106)
...
2. For each directory entry found,
   ...
   1. If the name has already been stored in the xfblob, then use that cookie
      and skip the next step.
   2. Otherwise, record the name in an xfblob, and remember the xfblob cookie.
   ...
   3. Store `(child_ag_inum, parent_inum, parent_gen, name_hash, name_len,
...
3. For each AG in the filesystem,
   ...
   1. Sort the per-AG tuple set in order of `child_ag_inum`, `parent_inum`,
   ...
   2. For each inode in the AG,
      ...
      1. Scan the inode for parent pointers.
         ...
         1. Validate the ondisk parent pointer.
            If validation fails, move on to the next parent pointer in the
            file.
         2. If the name has already been stored in the xfblob, then use that
            cookie and skip the next step.
         3. Record the name in a per-file xfblob, and remember the xfblob
            cookie.
         4. Store `(parent_inum, parent_gen, name_hash, name_len,
      ...
      5. Iterate the two cursors in lockstep, comparing the `parent_ino`,
         ...
         1. If the per-AG cursor is at a lower point in the keyspace than the
            ...
            cursor.
         2. If the per-file cursor is at a lower point in the keyspace than
            ...
            cursor.
         3. Otherwise, both cursors point at the same parent pointer.
            Update the parent_gen component if necessary.
            Advance both cursors.
4. Move on to examining link counts, as we do today.

The proposed patchset is the
[offline parent pointers repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=pptrs-fsck)
series.
...
##### [4.5.14.2.4. Case Study: Directory Tree Structure](xfs-online-fsck-design.md#id107)
...
1. For each subdirectory in the filesystem,
   ...
   1. For each parent pointer of that subdirectory,
      ...
      6. For each parent pointer of this alleged ancestor directory,
         ...
         1. Record the parent pointer name and inode number in the path object
            if no parent has been set for that level.
         2. If an ancestor has more than one parent, mark the path as corrupt.
            Repeat step 1a with the next subdirectory parent pointer.
         3. Repeat steps 1a3-1a6 for the ancestor identified in step 1a6a.
...
1. Walk each path of the target subdirectory.
   ...
   1. Corrupt paths and cycle paths are counted as suspect.
   2. Paths already marked for deletion are counted as bad.
   3. Paths that reached the root are counted as good.
...
The proposed patches are in the
[directory tree repair](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=scrub-directory-tree)
series.

### [4.5.15. The Orphanage](xfs-online-fsck-design.md#id108)
...
The proposed patches are in the
[orphanage adoption](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=repair-orphanage)
series.

## [4.6. 6. Userspace Algorithms and Data Structures](xfs-online-fsck-design.md#id109)
...
### [4.6.1. Checking Metadata](xfs-online-fsck-design.md#id110)

Recall the [phases of fsck work](xfs-online-fsck-design.md#scrubphases) outlined earlier.
...
1. Filesystem summary counts depend on consistency within the inode indices,
   the allocation group space btrees, and the realtime volume space
   information.
2. Quota resource counts depend on consistency within the quota file data
   forks, inode indices, inode records, and the forks of every file on the
   system.
3. The naming hierarchy depends on consistency within the directory and
   extended attribute structures.
   This includes file link counts.
4. Directories, extended attributes, and file data depend on consistency within
   the file forks that map directory and extended attribute data to physical
   storage media.
5. The file forks depends on consistency within inode records and the space
...
7. Realtime space metadata depend on the inode records and data forks of the
   realtime metadata inodes.
8. The allocation group metadata indices (free space, inodes, reference count,
   and reverse mapping btrees) depend on consistency within the AG headers and
   between all the AG metadata btrees.
9. `xfs_scrub` depends on the filesystem being mounted and kernel support
...
### [4.6.2. Parallel Inode Scans](xfs-online-fsck-design.md#id111)
...
[performance tweaks](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-performance-tweaks)
and the
[inode scan rebalance](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-iscan-rebalance)
series.

### [4.6.3. Scheduling Repairs](xfs-online-fsck-design.md#id112)
...
The [data dependencies](xfs-online-fsck-design.md#scrubcheck) outlined earlier still apply, which
...
1. Start a round of repair with a workqueue and enough workers to keep the CPUs
   ...
   1. For each repair item queued by phase 2,
      ...
      1. Ask the kernel to repair everything listed in the repair item for a
         given filesystem object.
      2. Make a note if the kernel made any progress in reducing the number
         of repairs needed for this object.
      3. If the object no longer requires repairs, revalidate all metadata
...
[repair warning improvements](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-better-repair-warnings),
refactoring of the
[repair data dependency](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-repair-data-deps)
and
[object tracking](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-object-tracking),
and the
[repair scheduling](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=scrub-repair-scheduling)
improvement series.

### [4.6.4. Checking Names for Confusable Unicode Sequences](xfs-online-fsck-design.md#id113)
...
### [4.6.5. Media Verification of File Data Extents](xfs-online-fsck-design.md#id114)
...
## [4.7. 7. Conclusion and Future Work](xfs-online-fsck-design.md#id115)
...
### [4.7.1. XFS_IOC_EXCHANGE_RANGE](xfs-online-fsck-design.md#id116)
...
#### [4.7.1.1. File Content Exchanges with Regular User Files](xfs-online-fsck-design.md#id117)
...
### [4.7.2. Vectorized Scrub](xfs-online-fsck-design.md#id118)

As it turns out, the [refactoring](xfs-online-fsck-design.md#scrubrepair) of repair items mentioned
...
[kernel vectorized scrub](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=vectorized-scrub)
and
[userspace vectorized scrub](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=vectorized-scrub)
series.

### [4.7.3. Quality of Service Targets for Scrub](xfs-online-fsck-design.md#id119)
...
### [4.7.4. Defragmenting Free Space](xfs-online-fsck-design.md#id120)
...
cleared, and uses `FIEDEUPRANGE` (or the [atomic file content exchanges](xfs-online-fsck-design.md#exchrange-if-unchanged) feature) to change the target file’s data extent
...
The relevant patchsets are the
[kernel freespace defrag](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfs-linux.git/log/?h=defrag-freespace)
and
[userspace freespace defrag](https://git.kernel.org/pub/scm/linux/kernel/git/djwong/xfsprogs-dev.git/log/?h=defrag-freespace)
series.

### [4.7.5. Shrinking Filesystems](xfs-online-fsck-design.md#id121)
