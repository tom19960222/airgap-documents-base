...
collection: kernel
version: "6.17"
title: "1. XFS Logging Design"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/xfs/xfs-delayed-logging-design.html
fetched_at: 2026-09-16T16:42:28+00:00
---
...
### 1.9.3. Delayed Logging: Checkpoints
...
### 1.9.4. Delayed Logging: Checkpoint Sequencing
...
### 1.9.5. Delayed Logging: Checkpoint Log Space Accounting
...
### 1.9.6. Delayed Logging: Log Item Pinning
...
### 1.9.7. Delayed Logging: Concurrent Scalability
...
across the formatting of the objects into memory buffers (i.e. while [`memcpy()`](../../core-api/kernel-api.md#c.memcpy "memcpy")s
