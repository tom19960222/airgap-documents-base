...
collection: kernel
version: "6.17"
title: "Filesystem Mount API"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/mount_api.html
...
>   [`sget_fc()`](api-summary.md#c.sget_fc "sget_fc"). This can be used to distinguish superblocks.
> - ```
>   unsigned int sb_flags
>   unsigned int sb_flags_mask
>   ```
...
The following helpers all wrap [`sget_fc()`](api-summary.md#c.sget_fc "sget_fc"):
