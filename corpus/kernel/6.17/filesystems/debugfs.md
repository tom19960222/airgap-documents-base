...
version: "6.17"
title: "DebugFS"
source_url: https://www.kernel.org/doc/html/v6.17/filesystems/debugfs.html
fetched_at: 2026-09-16T16:42:05+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/filesystems/debugfs.md)
- [Chinese (Traditional)](../translations/zh_TW/filesystems/debugfs.md)

# DebugFS

Copyright © 2009 Jonathan Corbet <[corbet@lwn.net](mailto:corbet%40lwn.net)>
...
files exported there. The real world is not always so simple, though [[1]](debugfs.md#id2);
...
[`debugfs_create_blob()`](api-summary.md#c.debugfs_create_blob "debugfs_create_blob") are read-only.
...
A call to [`debugfs_change_name()`](api-summary.md#c.debugfs_change_name "debugfs_change_name") will give a new name to an existing debugfs
...
Symbolic links can be created with [`debugfs_create_symlink()`](api-summary.md#c.debugfs_create_symlink "debugfs_create_symlink").
...
[`debugfs_remove()`](api-summary.md#c.debugfs_remove "debugfs_remove"). `debugfs_remove_recursive()` should be considered
deprecated.
