...
source_url: https://www.kernel.org/doc/html/v6.17/block/blk-mq.html
...
the reference from `blk_mq_alloc_queue()` by calling [`blk_put_queue()`](../core-api/kernel-api.md#c.blk_put_queue "blk_put_queue").
