...
source_url: https://www.kernel.org/doc/html/v6.17/block/bfq-iosched.html
...
completion hooks---is, e.g., 1.9 us on an Intel Core [i7-2760QM@2.40GHz](mailto:i7-2760QM%402.40GHz)
...
[Block IO Controller](../admin-guide/cgroup-v1/blkio-controller.md). If, instead,
