...
collection: kernel
version: "6.17"
title: "8. The PCI Express Advanced Error Reporting Driver Guide HOWTO"
source_url: https://www.kernel.org/doc/html/v6.17/PCI/pcieaer-howto.html
fetched_at: 2026-09-16T16:46:24+00:00
---
# 8. The PCI Express Advanced Error Reporting Driver Guide HOWTO

Authors:
:   - 20. Long Nguyen <[tom.l.nguyen@intel.com](mailto:tom.l.nguyen%40intel.com)>
    - Yanmin Zhang <[yanmin.zhang@intel.com](mailto:yanmin.zhang%40intel.com)>
...
See [ABI file testing/sysfs-bus-pci-devices-aer](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-bus-pci-devices-aer).

### 8.2.5. AER Statistics / Counters

When PCIe AER errors are captured, the counters / statistics are also exposed
in the form of sysfs attributes which are documented at
[ABI file testing/sysfs-bus-pci-devices-aer](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-bus-pci-devices-aer).
...
Data [`struct pci_driver`](pci.md#c.pci_driver "pci_driver") has a pointer, err_handler, to point to
pci_error_handlers who consists of a couple of callback function
pointers. The AER driver follows the rules defined in
[PCI Error Recovery](pci-error-recovery.md) except PCIe-specific parts (e.g.
reset_link). Please refer to [PCI Error Recovery](pci-error-recovery.md) for detailed
