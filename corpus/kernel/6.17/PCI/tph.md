...
collection: kernel
version: "6.17"
title: "12. TPH Support"
source_url: https://www.kernel.org/doc/html/v6.17/PCI/tph.html
fetched_at: 2026-09-16T16:46:33+00:00
---
# 12. TPH Support
...
Authors:
:   - Eric van Tassell <[eric.vantassell@amd.com](mailto:eric.vantassell%40amd.com)>
    - Wei Huang <[wei.huang2@amd.com](mailto:wei.huang2%40amd.com)>
...
### 12.2.1. Enable TPH support in Linux
...
[`pcie_enable_tph()`](../driver-api/pci/pci.md#c.pcie_enable_tph "pcie_enable_tph") checks whether the requested mode is actually
...
return value of [`pcie_enable_tph()`](../driver-api/pci/pci.md#c.pcie_enable_tph "pcie_enable_tph").
...
(see the [Revised _DSM for Cache Locality TPH Features ECN](https://members.pcisig.com/wg/PCI-SIG/document/15470)) for retrieving
...
written into. [`pcie_tph_set_st_entry()`](../driver-api/pci/pci.md#c.pcie_tph_set_st_entry "pcie_tph_set_st_entry") will figure out the proper
...
### 12.2.4. Disable TPH system-wide
