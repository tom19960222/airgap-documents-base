...
collection: kernel
version: "6.17"
title: "11. Boot Interrupts"
source_url: https://www.kernel.org/doc/html/v6.17/PCI/boot-interrupts.html
fetched_at: 2026-09-16T16:46:32+00:00
---
# 11. Boot Interrupts

Author:
:   - Sean V Kelley <[sean.v.kelley@linux.intel.com](mailto:sean.v.kelley%40linux.intel.com)>
...
added. [[1]](boot-interrupts.md#id4)
...
line due to excessive unhandled counts. [[2]](boot-interrupts.md#id5)

The config option X86_REROUTE_FOR_BROKEN_BOOT_IRQS exists to enable (or
disable) the redirection of the interrupt handler to the PCH interrupt
line. The option can be overridden by either pci=ioapicreroute or
pci=noioapicreroute. [[3]](boot-interrupts.md#id6)

## 11.6. More Documentation
...
### 11.6.1. Example of disabling of the boot interrupt
...
### 11.6.2. Example of handler rerouting
...
Cheers,
:   Sean V Kelley
    [sean.v.kelley@linux.intel.com](mailto:sean.v.kelley%40linux.intel.com)

[[1](boot-interrupts.md#id1)]

<https://lore.kernel.org/r/12131949181903-git-send-email-sassmann@suse.de/>

[[2](boot-interrupts.md#id2)]

<https://lore.kernel.org/r/12131949182094-git-send-email-sassmann@suse.de/>

[[3](boot-interrupts.md#id3)]

<https://lore.kernel.org/r/487C8EA7.6020205@suse.de/>
