...
collection: kernel
version: "6.17"
title: "SPI userspace API"
source_url: https://www.kernel.org/doc/html/v6.17/spi/spidev.html
fetched_at: 2026-09-16T16:43:25+00:00
---
# SPI userspace API
...
>   bound when these are defined using a [`struct spi_board_info`](../driver-api/spi.md#c.spi_board_info "spi_board_info") with a
...
post a patch for spidev to the [linux-spi@vger.kernel.org](mailto:linux-spi%40vger.kernel.org) mailing list.
...
transfer.) The model is the same as that used in the kernel [`spi_sync()`](../driver-api/spi.md#c.spi_sync "spi_sync")
