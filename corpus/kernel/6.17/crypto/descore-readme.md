...
collection: kernel
version: "6.17"
title: "Fast & Portable DES encryption & decryption"
source_url: https://www.kernel.org/doc/html/v6.17/crypto/descore-readme.html
fetched_at: 2026-09-16T16:45:58+00:00
---
...
Author’s address: [how@isl.stanford.edu](mailto:how%40isl.stanford.edu)
...
[71755.204@compuserve.com](mailto:71755.204%40compuserve.com), sparked a number of these enhancements.
...
> >   >
> >   > (code from [eay@psych.psy.uq.oz.au](mailto:eay%40psych.psy.uq.oz.au) via comp.sources.misc)
...
>
> (code from [glad@daimi.aau.dk](mailto:glad%40daimi.aau.dk) via alt.sources or comp.sources.misc)
...
>
> (code obtained from [aem@aber.ac.uk](mailto:aem%40aber.ac.uk) via alt.sources or comp.sources.misc)
...
1. additionally, i have tried to put the larger constants in registers.
...
2. the compiler may be too stupid to realize table and table+256 should
