...
collection: kernel
version: "6.17"
title: "Asymmetric / Public-key Cryptography Key Type"
source_url: https://www.kernel.org/doc/html/v6.17/crypto/asymmetric-keys.html
fetched_at: 2026-09-16T16:32:20+00:00
---
...
>    [Kernel Key Retention Service](../security/keys/core.md)]:
>
>    ```
...
>    ->description will be [`kfree()`](../core-api/mm-api.md#c.kfree "kfree")’d and the data attached to
