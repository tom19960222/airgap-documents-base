...
collection: kernel
version: "6.17"
title: "Developing Cipher Algorithms"
source_url: https://www.kernel.org/doc/html/v6.17/crypto/devel-algos.html
fetched_at: 2026-09-16T16:45:55+00:00
---
...
filled with each, [`struct crypto_alg`](api-skcipher.md#c.crypto_alg "crypto_alg"), must be considered -- see below
...
crypto_alg`](api-skcipher.md#c.crypto_alg "crypto_alg") field .cra_type is empty. The .cra_u.cipher has to be
filled in with proper callbacks to implement this transformation.

See [`struct cipher_alg`](api-skcipher.md#c.cipher_alg "cipher_alg") below.
