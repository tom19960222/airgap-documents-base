...
source_url: https://www.kernel.org/doc/html/v6.17/crypto/api-rng.html
fetched_at: 2026-09-16T16:27:34+00:00
---
...
allocated cipher handle in case of success; [`IS_ERR()`](../core-api/kernel-api.md#c.IS_ERR "IS_ERR") is true in case
...
:   obtain ‘[`struct rng_alg`](api-rng.md#c.rng_alg "rng_alg")’ pointer from RNG handle
...
Pointer to ‘[`struct rng_alg`](api-rng.md#c.rng_alg "rng_alg")’, derived from **tfm** RNG handle
