...
collection: kernel
version: "6.17"
title: "Kernel Crypto API Architecture"
source_url: https://www.kernel.org/doc/html/v6.17/crypto/architecture.html
...
1. `esp_output()` invokes [`crypto_aead_encrypt()`](api-aead.md#c.crypto_aead_encrypt "crypto_aead_encrypt") to trigger an
