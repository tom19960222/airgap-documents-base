...
source_url: https://www.kernel.org/doc/html/v6.17/fault-injection/fault-injection.html
fetched_at: 2026-09-16T16:22:12+00:00
---
...
- failslab
  ...
  injects slab allocation failures. ([`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc"), [`kmem_cache_alloc()`](../core-api/mm-api.md#c.kmem_cache_alloc "kmem_cache_alloc"), ...)
- fail_page_alloc

  injects page allocation failures. ([`alloc_pages()`](../core-api/mm-api.md#c.alloc_pages "alloc_pages"), `get_free_pages()`, ...)
- fail_usercopy

  injects failures in user memory access functions. (`copy_from_user()`, [`get_user()`](../core-api/mm-api.md#c.get_user "get_user"), ...)
- fail_futex
...
- fail_make_request
  ...
  /sys/block/<device>/<partition>/make-it-fail. ([`submit_bio_noacct()`](../core-api/kernel-api.md#c.submit_bio_noacct "submit_bio_noacct"))
- fail_mmc_request
...
:   This function will return an -errno error code if it fails. e.g. return
    ...
    return an address which encodes -errno by [`ERR_PTR()`](../core-api/kernel-api.md#c.ERR_PTR "ERR_PTR") macro.

EI_ETYPE_ERRNO_NULL
:   This function will return an -errno or NULL if it fails. If the caller
    of this function checks the return value with [`IS_ERR_OR_NULL()`](../core-api/kernel-api.md#c.IS_ERR_OR_NULL "IS_ERR_OR_NULL") macro, this
