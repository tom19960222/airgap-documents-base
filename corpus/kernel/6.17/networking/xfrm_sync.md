...
version: "6.17"
title: "XFRM"
source_url: https://www.kernel.org/doc/html/v6.17/networking/xfrm_sync.html
fetched_at: 2026-09-16T16:41:38+00:00
---
# XFRM

The sync patches work is based on initial patches from
Krisztian <[hidden@balabit.hu](mailto:hidden%40balabit.hu)> and others and additional patches
from Jamal <[hadi@cyberus.ca](mailto:hadi%40cyberus.ca)>.
...
4. expiry timer (XFRMA_ETIMER_THRESH)
...
1. XFRM_MSG_GETAE issued by user-->kernel.
...
2. XFRM_MSG_NEWAE is issued by either user space to configure
   or kernel to announce events or respond to a XFRM_MSG_GETAE.

1. user --> kernel to configure a specific SA.
...
2. kernel->user direction as a response to XFRM_MSG_GETAE
...
3. kernel->user to report as event if someone sets any values or
   thresholds for an SA using XFRM_MSG_NEWAE (as described in #i above).
   In such a case XFRM_AE_CU flag is set to inform the user that
   the change happened as a result of an update.
   The message will always have XFRMA_LTIME_VAL and XFRMA_REPLAY_VAL TLVs.
4. kernel->user to report event when replay threshold or a timeout
   is exceeded.
