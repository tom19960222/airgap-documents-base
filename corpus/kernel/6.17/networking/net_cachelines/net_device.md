...
collection: kernel
version: "6.17"
title: "net_device struct fast path usage breakdown"
source_url: https://www.kernel.org/doc/html/v6.17/networking/net_cachelines/net_device.html
...
| [`struct tipc_bearer`](../tipc.md#c.tipc_bearer "tipc_bearer")\* | tipc_ptr |  |  |  |
| void\* | atalk_ptr |  |  |  |
| void\* | ax25_ptr |  |  |  |
| [`struct wireless_dev`](../../driver-api/80211/cfg80211.md#c.wireless_dev "wireless_dev")\* | ieee80211_ptr |  |  |  |
...
| void\*priv_destructor | [`struct net_device`](../kapi.md#c.net_device "net_device") |  |  |  |
...
| [`struct device`](../../driver-api/infrastructure.md#c.device "device") | dev |  |  |  |
...
| [`struct phy_device`](../kapi.md#c.phy_device "phy_device")\* | phydev |  |  |  |
| [`struct sfp_bus`](../kapi.md#c.sfp_bus "sfp_bus")\* | sfp_bus |  |  |  |
...
| [`struct dim_irq_moder`](../net_dim.md#c.dim_irq_moder "dim_irq_moder")\* | irq_moder |  |  |  |
