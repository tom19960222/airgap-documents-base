...
source_url: https://www.kernel.org/doc/html/v6.17/networking/bonding.html
fetched_at: 2026-09-16T16:32:24+00:00
---
...
> ioctls vs. [`netif_carrier_ok()`](kapi.md#c.netif_carrier_ok "netif_carrier_ok") to determine the link
> status. The MII or ETHTOOL ioctls are less efficient and
> utilize a deprecated calling sequence within the kernel. The
> [`netif_carrier_ok()`](kapi.md#c.netif_carrier_ok "netif_carrier_ok") relies on the device driver to maintain its
...
>
> A value of 1 enables the use of [`netif_carrier_ok()`](kapi.md#c.netif_carrier_ok "netif_carrier_ok"), a value of
...
when the driver initializes (see [HOWTO for multiqueue network device support](multiqueue.md)
...
> 1. ad_actor_system : You can set a random mac-address that can be used for
...
>    ```
> 2. ad_actor_sys_prio : Randomize the system priority. The default value
...
>    ```
> 3. ad_user_port_key : Use the user portion of the port-key. The default
...
source (named [Linux Ethernet Bonding Driver HOWTO](bonding.md)).
