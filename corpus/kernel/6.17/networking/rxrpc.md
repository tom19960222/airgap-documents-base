...
collection: kernel
version: "6.17"
title: "RxRPC Network Protocol"
source_url: https://www.kernel.org/doc/html/v6.17/networking/rxrpc.html
fetched_at: 2026-09-16T16:29:32+00:00
---
...
> 1. The AF_RXRPC protocol transparently uses internal sockets of the transport
>    protocol to represent transport endpoints.
> 2. AF_RXRPC sockets map onto RxRPC connection bundles. Actual RxRPC
...
>    replying.
> 9. SO_KEEPALIVE automatically pings the other side to keep the connection
>    alive [TODO].
...
> 9. When sending data for a call, sendmsg is given MSG_MORE if there’s more
>    data to come on that call.
> 10. When receiving data for a call, recvmsg flags MSG_MORE if there’s more
>     data to come for that call.
> 11. When receiving data or messages for a call, MSG_EOR is flagged by recvmsg
...
> 1. MSG_WAITALL can be set to tell sendmsg to ignore signals if the peer is
...
>    is returned by [`rxrpc_kernel_recv_data()`](rxrpc.md#c.rxrpc_kernel_recv_data "rxrpc_kernel_recv_data").
>
...
>    function is similar to [`rxrpc_kernel_begin_call()`](rxrpc.md#c.rxrpc_kernel_begin_call "rxrpc_kernel_begin_call") and calls accepted must
...
>     state.
> 15. Apply the RXRPC_MIN_SECURITY_LEVEL sockopt to a socket from within in the
>     kernel:
>
>     ```
...
struct rxrpc_peer \*rxrpc_kernel_lookup_peer(struct [socket](kapi.md#c.socket "socket") \*sock, struct sockaddr_rxrpc \*srx, gfp_t gfp)
...
The peer record found with a reference, `NULL` if no record is found
...
struct rxrpc_call \*rxrpc_kernel_begin_call(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_peer \*peer, struct [key](rxrpc.md#c.rxrpc_kernel_begin_call "key") \*key, unsigned long user_call_ID, s64 tx_total_len, u32 hard_timeout, gfp_t gfp, rxrpc_notify_rx_t notify_rx, u16 service_id, bool upgrade, enum rxrpc_interruptibility interruptibility, unsigned int debug_id)
...
void rxrpc_kernel_shutdown_call(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call)
...
void rxrpc_kernel_put_call(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call)
...
bool rxrpc_kernel_check_life(const struct [socket](kapi.md#c.socket "socket") \*sock, const struct rxrpc_call \*call)
...
void rxrpc_kernel_set_notifications(struct [socket](kapi.md#c.socket "socket") \*sock, const struct rxrpc_kernel_ops \*app_ops)
...
enum rxrpc_oob_type rxrpc_kernel_query_oob(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*oob, struct rxrpc_peer \*\*_peer, unsigned long \*_peer_appdata)
...
struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*rxrpc_kernel_dequeue_oob(struct [socket](kapi.md#c.socket "socket") \*sock, enum rxrpc_oob_type \*_type)
...
The sk_buff representing the OOB message or `NULL` if the queue was
empty.

void rxrpc_kernel_free_oob(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*oob)
...
void rxrpc_kernel_query_challenge(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*challenge, struct rxrpc_peer \*\*_peer, unsigned long \*_peer_appdata, u16 \*_service_id, u8 \*_security_index)
...
int rxrpc_kernel_reject_challenge(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*challenge, u32 abort_code, int error, enum rxrpc_abort_reason why)
...
struct rxrpc_peer \*rxrpc_kernel_get_call_peer(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call)
...
int rxrpc_kernel_recv_data(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call, struct iov_iter \*iter, size_t \*_len, bool want_more, u32 \*_abort, u16 \*_service)
...
u32 rxgk_kernel_query_challenge(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*challenge)
...
int rxgk_kernel_respond_to_challenge(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*challenge, struct krb5_buffer \*appdata)
...
int rxkad_kernel_respond_to_challenge(struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*challenge)
:   Respond to a challenge with appdata
...
int rxrpc_kernel_send_data(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call, struct msghdr \*msg, size_t len, rxrpc_notify_end_tx_t notify_end_tx)
...
bool rxrpc_kernel_abort_call(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call, u32 abort_code, int error, enum rxrpc_abort_reason why)
...
void rxrpc_kernel_set_tx_length(struct [socket](kapi.md#c.socket "socket") \*sock, struct rxrpc_call \*call, s64 tx_total_len)
...
int rxrpc_sock_set_security_keyring(struct [sock](kapi.md#c.sock "sock") \*sk, struct key \*keyring)
...
int rxrpc_sock_set_manage_response(struct [sock](kapi.md#c.sock "sock") \*sk, bool set)
