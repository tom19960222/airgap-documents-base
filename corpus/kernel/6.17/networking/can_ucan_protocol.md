...
collection: kernel
version: "6.17"
title: "The UCAN Protocol"
source_url: https://www.kernel.org/doc/html/v6.17/networking/can_ucan_protocol.html
fetched_at: 2026-09-16T16:40:16+00:00
---
# The UCAN Protocol
...
| `wLength` | - Host to Device - Number of bytes to transmit - Device to Host - Maximum Number of bytes to   receive. If the device send less. Common ZLP   semantics are used. |
...
> **Note:**
>
> Devices that do not implement this command use the old
> protocol version 1
...
[CAN Error Handling](can_ucan_protocol.md#can-ucan-error-handling))
...
same as described in [len field](can_ucan_protocol.md#can-ucan-in-message-len).
