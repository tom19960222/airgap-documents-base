...
collection: kernel
version: "6.17"
title: "PSE Power Interface (PSE PI) Documentation"
source_url: https://www.kernel.org/doc/html/v6.17/networking/pse-pd/pse-pi.html
fetched_at: 2026-09-16T16:41:25+00:00
---
...
| Conductor | Alternative A  (MDI-X) | Alternative A | Alternative B | Alternative B |
| --- | --- | --- | --- | --- |
...
| Variant | Alternative (A/B) | Power Feeding Type (Direct/Phantom) | Compatibility with 1000/2.5G/5G/10GBaseT |
| --- | --- | --- | --- |
| 1 | A | Phantom | Yes |
| 2 | B | Phantom | Yes |
| 3 | B | Direct | No |
