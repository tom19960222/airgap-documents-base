...
collection: kernel
version: "6.17"
title: "Linux kernel driver for Elastic Network Adapter (ENA) family"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/amazon/ena.html
fetched_at: 2026-09-16T16:32:06+00:00
---
...
| ena_phc.[ch] | PTP hardware clock infrastructure (see [PHC](ena.md#phc) for more info) |
...
To retrieve PHC timestamp, use [ptp-userspace-api](https://docs.kernel.org/driver-api/ptp.html#ptp-hardware-clock-user-space-api), usage example using [testptp](https://elixir.bootlin.com/linux/latest/source/tools/testing/selftests/ptp/testptp.c):
...
| **phc_err_ts** | Number of failed get time attempts due to timestamp errors (entering into block state),  This occurs if driver exceeded the request limit or device received an invalid timestamp. |
...
[devlink](https://www.kernel.org/doc/html/latest/networking/devlink/index.html) supports reloading the driver and initiating re-negotiation with the ENA device
...
for it and the RX buffer remains the same size, see [RX copybreak](ena.md#rx-copybreak)).
