...
collection: kernel
version: "6.17"
title: "Linux Driver for the AMD/Pensando(R) DSC adapter family"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/amd/pds_core.html
...
| `fw.goldfw` | stored | Version of firmware stored in the goldfw slot |
| `fw.mainfwa` | stored | Version of firmware stored in the mainfwa slot |
| `fw.mainfwb` | stored | Version of firmware stored in the mainfwb slot |
...
| `enable_vnet` | runtime | Boolean | Enables vDPA functionality through an auxiliary_bus device |
