...
collection: kernel
version: "6.17"
title: "Marvell OcteonTx2 RVU Kernel Drivers"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/marvell/octeontx2.html
fetched_at: 2026-09-16T16:33:50+00:00
---
...
- [Overview](octeontx2.md#overview)
- [Drivers](octeontx2.md#drivers)
- [Basic packet flow](octeontx2.md#basic-packet-flow)
- [Devlink health reporters](octeontx2.md#devlink-health-reporters)
- [Quality of service](octeontx2.md#quality-of-service)
- [RVU representors](octeontx2.md#rvu-representors)
...
(see [Documentation/networking/devlink/devlink-port.rst](../../../devlink/devlink-port.md#devlink-port)) interface.
...
address. (refer to [Devlink Port](../../../devlink/devlink-port.md))
