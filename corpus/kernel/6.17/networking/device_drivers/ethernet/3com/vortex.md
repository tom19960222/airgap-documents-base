...
collection: kernel
version: "6.17"
title: "3Com Vortex device driver"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/3com/vortex.html
fetched_at: 2026-09-16T16:31:56+00:00
---
...
The driver was written by Donald Becker <[becker@scyld.com](mailto:becker%40scyld.com)>

Don is no longer the prime maintainer of this version of the driver.
Please report problems to one or more of:

- Andrew Morton
- Netdev mailing list <[netdev@vger.kernel.org](mailto:netdev%40vger.kernel.org)>
- Linux kernel mailing list <[linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org)>
...
>
> Cisco interoperability note from Walter Wong <[wcw+@CMU.EDU](mailto:wcw+%40CMU.EDU)>:
>
...
>
> Cisco switches (Jeff Busch <[jbusch@deja.com](mailto:jbusch%40deja.com)>)
>
...
- OK, it’s a driver problem.
  ...
  > maintainer and/or [netdev@vger.kernel.org](mailto:netdev%40vger.kernel.org). The maintainer’s
...
- The contents of your report will vary a lot depending upon the
  ...
  > >      2. In /etc/modprobe.d/driver.conf:
  ...
  > >
  > >      1. Run ‘vortex-diag -aaee’ and ‘mii-diag -v’ when the card is
  > >         working correctly. Save the output.
  > >      2. Run the above commands when the card is malfunctioning. Send
  > >         both sets of output.
