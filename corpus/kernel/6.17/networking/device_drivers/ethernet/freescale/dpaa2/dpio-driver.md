...
collection: kernel
version: "6.17"
title: "DPAA2 DPIO (Data Path I/O) Overview"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/freescale/dpaa2/dpio-driver.html
fetched_at: 2026-09-16T16:52:46+00:00
---
...
See
[DPAA2 (Data Path Acceleration Architecture Gen2) Overview](overview.md)
...
> 1. allow other drivers, such as the Ethernet driver, to enqueue and dequeue
>    frames for their respective objects
> 2. allow drivers to register callbacks for data availability notifications
>    when data becomes available on a queue or channel
> 3. allow drivers to manage hardware buffer pools
