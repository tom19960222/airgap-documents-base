...
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/mellanox/mlx5/kconfig.html
...
Enable [Ethernet Bridging (BRIDGE) offloading support](switchdev.md#mlx5-bridge-offload).
...
Enables [IPSec XFRM cryptography-offload acceleration](../../../../xfrm_device.md#xfrm-device).
...
2) [Switchdev mode (eswitch offloads)](../../../../switchdev.md#switchdev).
