...
collection: kernel
version: "6.17"
title: "Network Flow Processor (NFP) Kernel Drivers"
source_url: https://www.kernel.org/doc/html/v6.17/networking/device_drivers/ethernet/netronome/nfp.html
fetched_at: 2026-09-16T16:52:36+00:00
---
...
- [Overview](nfp.md#overview)
- [Acquiring Firmware](nfp.md#acquiring-firmware)
- [Devlink Info](nfp.md#devlink-info)
- [Configure Device](nfp.md#configure-device)
- [Statistics](nfp.md#statistics)
...
(see the [Auto-negotiation](nfp.md#auto-negotiation) section). An example of how to set the FEC mode
to Reed-Solomon is:
...
| dev_rx_errors | 2 | A packet can be counted (and dropped) as RX error for the following reasons:   - A problem with the VEB lookup (only when SR-IOV is used). - A physical layer problem that causes Ethernet errors, like FCS or   alignment errors. The cause is usually faulty cables or SFPs. |
