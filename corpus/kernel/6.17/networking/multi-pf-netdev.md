...
collection: kernel
version: "6.17"
title: "Multi-PF Netdev"
source_url: https://www.kernel.org/doc/html/v6.17/networking/multi-pf-netdev.html
fetched_at: 2026-09-16T16:41:10+00:00
---
# Multi-PF Netdev

## Contents

- [Background](multi-pf-netdev.md#background)
- [Overview](multi-pf-netdev.md#overview)
- [mlx5 implementation](multi-pf-netdev.md#mlx5-implementation)
- [Channels distribution](multi-pf-netdev.md#channels-distribution)
- [Observability](multi-pf-netdev.md#observability)
- [Steering](multi-pf-netdev.md#steering)
- [Mutually exclusive features](multi-pf-netdev.md#mutually-exclusive-features)
