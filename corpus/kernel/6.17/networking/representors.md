...
collection: kernel
version: "6.17"
title: "Network Function Representors"
source_url: https://www.kernel.org/doc/html/v6.17/networking/representors.html
fetched_at: 2026-09-16T16:41:26+00:00
---
...
[Documentation/networking/switchdev.rst](switchdev.md#switchdev).
...
>   if) their network access is implemented through a virtual switch port. [[1]](representors.md#id2)
...
[Documentation/networking/devlink/devlink-port.rst](devlink/devlink-port.md#devlink-port) for the
details of this API.
...
>   [Documentation/networking/devlink/devlink-port.rst](devlink/devlink-port.md#devlink-port))
