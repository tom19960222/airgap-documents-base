...
source_url: https://www.kernel.org/doc/html/v6.17/networking/scaling.html
fetched_at: 2026-09-16T16:40:33+00:00
---
...
affinity of each interrupt see [SMP IRQ affinity](../core-api/irq/irq-affinity.md). Some systems
...
a driver sends a packet up the network stack with [`netif_rx()`](kapi.md#c.netif_rx "netif_rx") or
[`netif_receive_skb()`](kapi.md#c.netif_receive_skb "netif_receive_skb"). These call the `get_rps_cpu()` function, which
...
CPU. [SMP IRQ affinity](../core-api/irq/irq-affinity.md) explains how CPUs are assigned to
the bitmap.
...
([therbert@google.com](mailto:therbert%40google.com))

Accelerated RFS was introduced in 2.6.35. Original patches were
submitted by Ben Hutchings ([bwh@kernel.org](mailto:bwh%40kernel.org))

Authors:

- Tom Herbert ([therbert@google.com](mailto:therbert%40google.com))
- Willem de Bruijn ([willemb@google.com](mailto:willemb%40google.com))
