...
source_url: https://www.kernel.org/doc/html/v6.17/networking/net_dim.html
fetched_at: 2026-09-16T16:27:43+00:00
---
...
- [Net DIM - Generic Network Dynamic Interrupt Moderation](net_dim.md#net-dim-generic-network-dynamic-interrupt-moderation)
  ...
  - [Tuning DIM](net_dim.md#tuning-dim)
...
[`struct dim_cq_moder`](net_dim.md#c.dim_cq_moder "dim_cq_moder")).
...
## [Dynamic Interrupt Moderation (DIM) library API](net_dim.md#id8)
...
`rx_dim_work`
:   Rx DIM worker scheduled by [`net_dim()`](net_dim.md#c.net_dim "net_dim")

`tx_dim_work`
:   Tx DIM worker scheduled by [`net_dim()`](net_dim.md#c.net_dim "net_dim")
...
int net_dim_init_irq_moder(struct [net_device](kapi.md#c.net_device "net_device") \*dev, u8 profile_flags, u8 coal_flags, u8 rx_mode, u8 tx_mode, void (\*rx_dim_work)(struct work_struct \*work), void (\*tx_dim_work)(struct work_struct \*work))
...
void net_dim_free_irq_moder(struct [net_device](kapi.md#c.net_device "net_device") \*dev)
...
void net_dim_setting(struct [net_device](kapi.md#c.net_device "net_device") \*dev, struct [dim](net_dim.md#c.net_dim_setting "dim") \*dim, bool is_tx)
...
void net_dim_work_cancel(struct [dim](net_dim.md#c.net_dim_work_cancel "dim") \*dim)
...
struct [dim_cq_moder](net_dim.md#c.dim_cq_moder "dim_cq_moder") net_dim_get_rx_irq_moder(struct [net_device](kapi.md#c.net_device "net_device") \*dev, struct [dim](net_dim.md#c.net_dim_get_rx_irq_moder "dim") \*dim)
...
struct [dim_cq_moder](net_dim.md#c.dim_cq_moder "dim_cq_moder") net_dim_get_tx_irq_moder(struct [net_device](kapi.md#c.net_device "net_device") \*dev, struct [dim](net_dim.md#c.net_dim_get_tx_irq_moder "dim") \*dim)
...
void net_dim_set_rx_mode(struct [net_device](kapi.md#c.net_device "net_device") \*dev, u8 rx_mode)
:   set DIM rx cq mode
...
void net_dim_set_tx_mode(struct [net_device](kapi.md#c.net_device "net_device") \*dev, u8 tx_mode)
:   set DIM tx cq mode
...
bool dim_calc_stats(const struct [dim_sample](net_dim.md#c.dim_sample "dim_sample") \*start, const struct [dim_sample](net_dim.md#c.dim_sample "dim_sample") \*end, struct [dim_stats](net_dim.md#c.dim_stats "dim_stats") \*curr_stats)
...
void net_dim(struct [dim](net_dim.md#c.net_dim "dim") \*dim, const struct [dim_sample](net_dim.md#c.dim_sample "dim_sample") \*end_sample)
