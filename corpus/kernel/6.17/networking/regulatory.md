...
collection: kernel
version: "6.17"
title: "Linux wireless regulatory documentation"
source_url: https://www.kernel.org/doc/html/v6.17/networking/regulatory.html
fetched_at: 2026-09-16T16:31:57+00:00
---
...
set they can inform the wireless core using [`regulatory_hint()`](../driver-api/80211/cfg80211.md#c.regulatory_hint "regulatory_hint").
...
registering on its [`struct wiphy`](../driver-api/80211/cfg80211.md#c.wiphy "wiphy") a `reg_notifier()` callback. This notifier
...
[`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc") a structure big enough to hold your regulatory domain
structure and you should then fill it with your data. Finally you simply
call [`regulatory_hint()`](../driver-api/80211/cfg80211.md#c.regulatory_hint "regulatory_hint") with the regulatory domain structure in it.
