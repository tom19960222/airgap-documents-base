...
version: "6.17"
title: "Page Pool API"
source_url: https://www.kernel.org/doc/html/v6.17/networking/page_pool.html
...
`fast`
:   params accessed frequently on hotpath
...
`slow`
:   params with slowpath access only (initialization and Netlink)

`netdev`
:   netdev this pool will serve (leave as NULL if none or multiple)

`queue_idx`
:   queue idx this page_pool is being created for.
...
dma_addr_t page_pool_get_dma_addr(const struct [page](page_pool.md#c.page_pool_get_dma_addr "page") \*page)
