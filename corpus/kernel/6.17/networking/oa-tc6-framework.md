...
collection: kernel
version: "6.17"
title: "OPEN Alliance 10BASE-T1x MAC-PHY Serial Interface (TC6) Framework Support"
source_url: https://www.kernel.org/doc/html/v6.17/networking/oa-tc6-framework.html
fetched_at: 2026-09-16T16:29:16+00:00
---
...
struct oa_tc6 \*oa_tc6_init(struct [spi_device](../driver-api/spi.md#c.spi_device "spi_device") \*spi, struct [net_device](kapi.md#c.net_device "net_device") \*netdev)
...
netdev_tx_t oa_tc6_start_xmit(struct oa_tc6 \*tc6, struct [sk_buff](kapi.md#c.sk_buff "sk_buff") \*skb);
