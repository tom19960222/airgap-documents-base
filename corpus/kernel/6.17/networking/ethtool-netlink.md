...
collection: kernel
version: "6.17"
title: "Netlink interface for ethtool"
source_url: https://www.kernel.org/doc/html/v6.17/networking/ethtool-netlink.html
...
corresponding members of [`struct net_device`](kapi.md#c.net_device "net_device")). Legacy “flags” are not provided,
...
As request is subject to [`netdev_change_features()`](kapi.md#c.netdev_change_features "netdev_change_features") sanity checks, optional
...
request but also each time features are modified with [`netdev_update_features()`](kapi.md#c.netdev_update_features "netdev_update_features")
or [`netdev_change_features()`](kapi.md#c.netdev_change_features "netdev_change_features").
...
:   Group of pd_dll_power_type
    states

`ETHTOOL_C33_PSE_EXT_STATE_POWER_NOT_AVAILABLE`
:   Group of power_not_available
    states
...
`verify_time`
:   see [`struct ethtool_mm_state`](ethtool-netlink.md#c.ethtool_mm_state "ethtool_mm_state")
...
For more information, refer to [PHY link topology](phy-link-topology.md#phy-link-topology)
