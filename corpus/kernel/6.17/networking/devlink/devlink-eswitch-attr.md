...
collection: kernel
version: "6.17"
title: "Devlink E-Switch Attribute"
source_url: https://www.kernel.org/doc/html/v6.17/networking/devlink/devlink-eswitch-attr.html
fetched_at: 2026-09-16T16:52:55+00:00
---
...
[Documentation/networking/switchdev.rst](../switchdev.md#switchdev) and
[Documentation/networking/representors.rst](../representors.md#representors).
...
| `mode` | enum | The mode of the device. The mode can be one of the following:   - `legacy` operates based on traditional MAC/VLAN steering   rules. - `switchdev` allows for more advanced offloading capabilities of   the E-Switch to hardware. |
