...
version: "6.17"
title: "ARCnet"
source_url: https://www.kernel.org/doc/html/v6.17/networking/arcnet.html
...
> **Note:**
>
> See also [ARCnet Hardware](arcnet-hardware.md) in this directory for jumper-setting
...
>
> My e-mail address is: [apenwarr@worldvisions.ca](mailto:apenwarr%40worldvisions.ca)

These are the ARCnet drivers for Linux.

This new release (2.91) has been put together by David Woodhouse
<[dwmw2@infradead.org](mailto:dwmw2%40infradead.org)>, in an attempt to tidy up the driver after adding support
...
REAL NAME” to [listserv@tichy.ch.uj.edu.pl](mailto:listserv%40tichy.ch.uj.edu.pl). Then, to submit messages to the
list, mail to [linux-arcnet@tichy.ch.uj.edu.pl](mailto:linux-arcnet%40tichy.ch.uj.edu.pl).

There are archives of the mailing list at:

> <http://epistolary.org/mailman/listinfo.cgi/arcnet>

The people on [linux-net@vger.kernel.org](mailto:linux-net%40vger.kernel.org) (now defunct, replaced by
[netdev@vger.kernel.org](mailto:netdev%40vger.kernel.org)) have also been known to be very helpful, especially
...
:   Should be fine linux->linux, just pretend you’re using Ethernet cards.
    ...
    (Thanks to Christian Gottschling <[ferksy@indigo.tng.oche.de](mailto:ferksy%40indigo.tng.oche.de)>
    for this.)
...
> |  |  |
> | --- | --- |
> | arc0 | RFC1201 protocol, the official Internet standard which just happens to be 100% compatible with Novell’s TRXNET driver. Version 1.00 of the ARCnet driver supported _only_ this protocol. arc0 is the fastest of the three protocols (for whatever reason), and allows larger packets to be used because it supports RFC1201 “packet splitting” operations. Unless you have a specific need to use a different protocol, I strongly suggest that you stick with this one. |
