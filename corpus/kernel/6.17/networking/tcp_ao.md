...
collection: kernel
version: "6.17"
title: "TCP Authentication Option Linux implementation (RFC5925)"
source_url: https://www.kernel.org/doc/html/v6.17/networking/tcp_ao.html
fetched_at: 2026-09-16T16:41:33+00:00
---
...
| --- | --- | --- |
| Extendability | `setsockopt()` commands should be extendable syscalls | Netlink messages are simple and extendable |
| Required userspace changes | BGP or any application that wants TCP-AO needs to perform `setsockopt()s` and do key management | could be transparent as tunnels, providing something like `ip tcpao add key` (delete/show/rotate) |
| MKTs removal or adding | harder for userspace | harder for kernel |
| Dump-ability | `getsockopt()` | Netlink .`dump()` callback |
...
Author:
:   Dmitry Safonov <[dima@arista.com](mailto:dima%40arista.com)>
