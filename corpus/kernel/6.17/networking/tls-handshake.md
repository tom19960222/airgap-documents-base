...
collection: kernel
version: "6.17"
title: "In-Kernel TLS Handshake"
source_url: https://www.kernel.org/doc/html/v6.17/networking/tls-handshake.html
fetched_at: 2026-09-16T16:33:05+00:00
---
...
instantiated a [`struct file`](../filesystems/api-summary.md#c.file "file") in sock->file.
...
subsequent [`sock_recvmsg()`](kapi.md#c.sock_recvmsg "sock_recvmsg"). Each control message indicates whether the
received message data is TLS record data or session metadata.

See [Kernel TLS](tls.md) for details on how a kTLS consumer recognizes incoming
