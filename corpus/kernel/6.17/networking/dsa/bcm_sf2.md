...
collection: kernel
version: "6.17"
title: "Broadcom Starfighter 2 Ethernet switch driver"
source_url: https://www.kernel.org/doc/html/v6.17/networking/dsa/bcm_sf2.html
fetched_at: 2026-09-16T16:40:25+00:00
---
...
driver require a [`struct device`](../../driver-api/infrastructure.md#c.device "device") to be bound to a `struct device_node`, but things
