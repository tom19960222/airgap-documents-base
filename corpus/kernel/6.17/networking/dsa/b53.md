...
collection: kernel
version: "6.17"
title: "Broadcom RoboSwitch Ethernet switch driver"
source_url: https://www.kernel.org/doc/html/v6.17/networking/dsa/b53.html
fetched_at: 2026-09-16T16:40:24+00:00
---
...
configuration described in the [Configuration showcases](configuration.md#dsa-config-showcases).
...
See [Configuration with tagging support](configuration.md#dsa-tagged-configuration).
...
The configuration slightly differ from the [Configuration without tagging support](configuration.md#dsa-vlan-configuration).
...
In difference to the configuration described in [Configuration without tagging support](configuration.md#dsa-vlan-configuration)
