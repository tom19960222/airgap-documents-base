...
collection: kernel
version: "6.17"
title: "PHY link topology"
source_url: https://www.kernel.org/doc/html/v6.17/networking/phy-link-topology.html
fetched_at: 2026-09-16T16:34:09+00:00
---
# PHY link topology
...
[`struct net_device`](kapi.md#c.net_device "net_device"), which exposes configuration options
...
The `struct phy_link_topology` is a per-netdevice
...
are linked to a net_device through [`phy_attach_direct()`](kapi.md#c.phy_attach_direct "phy_attach_direct") will automatically
...
PHY drivers that can be used as SFP upstream need to call `phy_sfp_attach_phy()`
and `phy_sfp_detach_phy()`, which can be used as a
.attach_phy / .detach_phy implementation for the
[`struct sfp_upstream_ops`](kapi.md#c.sfp_upstream_ops "sfp_upstream_ops").
...
field in [`struct phy_device`](kapi.md#c.phy_device "phy_device"). This index is reported to
