...
version: "6.17"
title: "Quick Start"
source_url: https://www.kernel.org/doc/html/v6.17/rust/quick-start.html
fetched_at: 2026-09-16T16:22:20+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/rust/quick-start.md)
...
[kernel.org](https://kernel.org/pub/tools/llvm/rust/). These are the same slim
and fast LLVM toolchains from [Getting LLVM](../kbuild/llvm.md#getting-llvm) with versions
...
Please see [Building Linux with Clang/LLVM](../kbuild/llvm.md) for more information and further ways
...
The [rust-analyzer](https://rust-analyzer.github.io/) language server can
