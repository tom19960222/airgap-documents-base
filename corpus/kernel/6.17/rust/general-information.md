...
source_url: https://www.kernel.org/doc/html/v6.17/rust/general-information.html
fetched_at: 2026-09-16T16:22:20+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/rust/general-information.md)
...
The Rust support in the kernel can link only [core](https://doc.rust-lang.org/core/),
but not [std](https://doc.rust-lang.org/std/). Crates for use in the
...
To learn about how to write the documentation, please see [Coding Guidelines](coding-guidelines.md).
...
2. Any `unsafe` blocks respect the safety contract necessary to call the
