...
source_url: https://www.kernel.org/doc/html/v6.17/security/landlock.html
fetched_at: 2026-09-16T16:29:02+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/security/landlock.md)
...
struct access_masks landlock_union_access_masks(const struct [landlock_ruleset](landlock.md#c.landlock_ruleset "landlock_ruleset") \*const domain)
...
an access_masks result of the OR of all the domain’s access masks.
