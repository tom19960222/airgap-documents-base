...
version: "6.17"
title: "SCTP"
source_url: https://www.kernel.org/doc/html/v6.17/security/SCTP.html
...
described in the [SCTP SELinux Support](SCTP.md#sctp-selinux-support) chapter.
...
The [SCTP LSM Support](SCTP.md#sctp-lsm-support) chapter above describes the following SCTP security
...
[SCTP LSM Support](SCTP.md#sctp-lsm-support) gives a summary of the `@optname`
...
:   1. If peer labeling is not enabled, then the peer context will always be
    ...
    6. CIPSO is only supported for IPv4 addressing: `socket(AF_INET, ...)`
       ...
       :   1. CIPSO will send an ICMP packet if an SCTP packet cannot be
