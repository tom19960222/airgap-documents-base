...
collection: kernel
version: "6.17"
title: "TPM CRB over FF-A Driver"
source_url: https://www.kernel.org/doc/html/v6.17/security/tpm/tpm_ffa_crb.html
fetched_at: 2026-09-16T16:54:17+00:00
---
# TPM CRB over FF-A Driver

The TPM Command Response Buffer (CRB) interface is a standard TPM interface
defined in the TCG PC Client Platform TPM Profile (PTP) Specification [[1]](tpm_ffa_crb.md#id5).
...
The Firmware Framework for Arm A-profile (FF-A) [[2]](tpm_ffa_crb.md#id6) is a specification
...
The Arm TPM Service Command Response Buffer Interface Over FF-A [[3]](tpm_ffa_crb.md#id7)
...
- The probing and initialization of the Linux CRB driver is triggered
  ...
  method for Arm FF-A was defined in TCG ACPI v1.4 [[4]](tpm_ffa_crb.md#id8).
