...
source_url: https://www.kernel.org/doc/html/v6.17/security/lsm-development.html
...
int security_dentry_init_security(struct [dentry](lsm-development.md#c.security_dentry_init_security "dentry") \*dentry, int mode, const struct qstr \*name, const char \*\*xattr_name, struct lsm_context \*lsmctx)
...
int security_inode_setintegrity(const struct [inode](lsm-development.md#c.security_inode_setintegrity "inode") \*inode, enum lsm_integrity_type type, const void \*value, size_t size)
...
int security_file_post_open(struct [file](lsm-development.md#c.security_file_post_open "file") \*file, int mask)
...
int security_inode_getsecctx(struct [inode](lsm-development.md#c.security_inode_getsecctx "inode") \*inode, struct lsm_context \*cp)
