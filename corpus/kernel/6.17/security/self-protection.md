...
source_url: https://www.kernel.org/doc/html/v6.17/security/self-protection.html
fetched_at: 2026-09-16T16:45:50+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/security/self-protection.md)
...
explicitly [`memset()`](../core-api/kernel-api.md#c.memset "memset"), this will require changes to the compiler to make
