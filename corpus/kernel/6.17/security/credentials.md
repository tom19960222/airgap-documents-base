...
source_url: https://www.kernel.org/doc/html/v6.17/security/credentials.html
fetched_at: 2026-09-16T16:32:40+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/security/credentials.md)

# Credentials in Linux

By: David Howells <[dhowells@redhat.com](mailto:dhowells%40redhat.com)>

- [Overview](credentials.md#overview)
- [Types of Credentials](credentials.md#types-of-credentials)
- [File Markings](credentials.md#file-markings)
- [Task Credentials](credentials.md#task-credentials)

  - [Immutable Credentials](credentials.md#immutable-credentials)
  - [Accessing Task Credentials](credentials.md#accessing-task-credentials)
  - [Accessing Another Task’s Credentials](credentials.md#accessing-another-task-s-credentials)
  - [Altering Credentials](credentials.md#altering-credentials)
  - [Managing Credentials](credentials.md#managing-credentials)
- [Open File Credentials](credentials.md#open-file-credentials)
- [Overriding the VFS’s Use of Credentials](credentials.md#overriding-the-vfs-s-use-of-credentials)

## [Overview](credentials.md#id1)
...
## [Types of Credentials](credentials.md#id2)
...
## [File Markings](credentials.md#id3)
...
## [Task Credentials](credentials.md#id4)
...
### [Immutable Credentials](credentials.md#id5)
...
has _const_ pointers to its credential sets, as does [`struct file`](../filesystems/api-summary.md#c.file "file"). Furthermore,
...
### [Accessing Task Credentials](credentials.md#id6)
...
### [Accessing Another Task’s Credentials](credentials.md#id7)
...
### [Altering Credentials](credentials.md#id8)
...
### [Managing Credentials](credentials.md#id9)
...
## [Open File Credentials](credentials.md#id10)
...
## [Overriding the VFS’s Use of Credentials](credentials.md#id11)
