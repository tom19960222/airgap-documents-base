...
source_url: https://www.kernel.org/doc/html/v6.17/security/keys/request-key.html
fetched_at: 2026-09-16T16:51:38+00:00
---
# Key Request Service

The key request service is part of the key retention service (refer to
[Kernel Key Retention Service](core.md)). This document explains more fully how
...
>    two things:
>
>    > 1. An uninstantiated key U of requested type and description.
>    > 2. An authorisation key V that refers to key U and notes that process A
...
>
>    > 1. If extant, the calling process’s thread keyring is searched.
>    > 2. If extant, the calling process’s process keyring is searched.
>    > 3. The calling process’s session keyring is searched.
