...
source_url: https://www.kernel.org/doc/html/v6.17/security/keys/core.html
fetched_at: 2026-09-16T16:33:39+00:00
---
...
- [Key Overview](core.md#key-overview)
- [Key Service Overview](core.md#key-service-overview)
- [Key Access Permissions](core.md#key-access-permissions)
- [SELinux Support](core.md#selinux-support)
- [New ProcFS Files](core.md#new-procfs-files)
- [Userspace System Call Interface](core.md#userspace-system-call-interface)
- [Kernel Services](core.md#kernel-services)
- [Notes On Accessing Payload Contents](core.md#notes-on-accessing-payload-contents)
- [Defining a Key Type](core.md#defining-a-key-type)
- [Request-Key Callback Service](core.md#request-key-callback-service)
- [Garbage Collection](core.md#garbage-collection)

## [Key Overview](core.md#id1)
...
## [Key Service Overview](core.md#id2)
...
## [Key Access Permissions](core.md#id3)
...
## [Userspace System Call Interface](core.md#id6)
...
>   permission.
>
>   See also [Key Request Service](request-key.md).
...
>   See [Asymmetric / Public-key Cryptography Key Type](../../crypto/asymmetric-keys.md) for specific restrictions
...
>
>   See [General notification mechanism](../../core-api/watch_queue.md) for more information.
>
...
## [Notes On Accessing Payload Contents](core.md#id8)
...
>    use of [`call_rcu()`](../../core-api/kernel-api.md#c.call_rcu "call_rcu") and, if the payload is of variable size, the length of
...
## [Defining a Key Type](core.md#id9)
...
>   be made under RCU conditions, and [`call_rcu()`](../../core-api/kernel-api.md#c.call_rcu "call_rcu") must be used to dispose of
>   the old payload.
>
...
>
>   This method will be called with the RCU read lock held. [`rcu_dereference()`](../../core-api/kernel-api.md#c.rcu_dereference "rcu_dereference")
...
## [Request-Key Callback Service](core.md#id10)
...
## [Garbage Collection](core.md#id11)
