...
source_url: https://www.kernel.org/doc/html/v6.17/security/keys/trusted-encrypted.html
...
The total size of a DCP BLOB is sizeof([`struct dcp_blob_fmt`](trusted-encrypted.md#c.dcp_blob_fmt "dcp_blob_fmt")) + **payload_len** +
DCP_BLOB_AUTHLEN.
