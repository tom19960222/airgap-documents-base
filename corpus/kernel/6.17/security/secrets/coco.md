...
source_url: https://www.kernel.org/doc/html/v6.17/security/secrets/coco.html
fetched_at: 2026-09-16T16:54:18+00:00
---
...
`KVM_SEV_LAUNCH_SECRET` command (see [[sev]](coco.md#sev)). The structure of the injected
...
efi_secret filesystem interface are in [[secrets-coco-abi]](coco.md#secrets-coco-abi).
...
See [[sev-api-spec]](coco.md#sev-api-spec) for more info regarding SEV `LAUNCH_SECRET` operation.

[[sev](coco.md#id1)]

[Secure Encrypted Virtualization (SEV)](../../virt/kvm/x86/amd-memory-encryption.md)

[[secrets-coco-abi](coco.md#id2)]

[ABI file testing/securityfs-secrets-coco](../../admin-guide/abi-testing-files.md#abi-file-testing-securityfs-secrets-coco)

[[sev-api-spec](coco.md#id3)]
