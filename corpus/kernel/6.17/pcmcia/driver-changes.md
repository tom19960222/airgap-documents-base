...
source_url: https://www.kernel.org/doc/html/v6.17/pcmcia/driver-changes.html
fetched_at: 2026-09-16T16:43:23+00:00
---
# Driver changes
...
- no cs_error / CS_CHECK / CONFIG_PCMCIA_DEBUG (as of 2.6.33)
  :   Instead of the `cs_error()` callback or the `CS_CHECK()` macro, please use
      ...
      messages using “`dev_dbg()`” or “[`pr_debug()`](../core-api/printk-basics.md#c.pr_debug "pr_debug")”.
...
- in-kernel device<->driver matching (as of 2.6.13)
  :   PCMCIA devices and their correct drivers can now be matched in
      kernelspace. See ‘[Device table](devicetable.md)’ for details.
