...
collection: kernel
version: "6.17"
title: "uvesafb - A Generic Driver for VBE2+ compliant video cards"
source_url: https://www.kernel.org/doc/html/v6.17/fb/uvesafb.html
...
| mtrr:n | Setup memory type range registers for the framebuffer where n:  - 0 - disabled (equivalent to nomtrr) - 3 - write-combining (default)  Values other than 0 and 3 will result in a warning and will be treated just like 3. |
...
| <mode> | The mode you want to set, in the standard modedb format. Refer to [modedb default video mode support](modedb.md) for a detailed description. When uvesafb is compiled as a module, the mode string should be provided as a value of the ‘mode_option’ option. |
...
| v86d:path | Set path to the v86d executable. This option is only available as a module parameter, and not as a part of the video= string. If you need to use it and have uvesafb built into the kernel, use uvesafb.v86d=”path”. |
...
> Michal Januszewski <[spock@gentoo.org](mailto:spock%40gentoo.org)>
>
> Last updated: 2017-10-10
>
> Documentation of the uvesafb options is loosely based on [What is vesafb?](vesafb.md).
