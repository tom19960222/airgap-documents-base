...
collection: kernel
version: "6.17"
title: "What is vesafb?"
source_url: https://www.kernel.org/doc/html/v6.17/fb/vesafb.html
fetched_at: 2026-09-16T16:40:02+00:00
---
# What is vesafb?
...
[Video Mode Selection Support 2.13](../admin-guide/svga.md) for details.
...
| mtrr:n | Setup memory type range registers for the vesafb framebuffer where n:  - 0 - disabled (equivalent to nomtrr) (default) - 1 - uncachable - 2 - write-back - 3 - write-combining - 4 - write-through  If you see the following in dmesg, choose the type that matches the old one. In this example, use “mtrr:2”. |
| ... |  |
| mtrr: | type mismatch for e0000000,8000000 old: write-back new: write-combining |
| ... |  |
| nomtrr | disable mtrr |
| vremap:n | Remap ‘n’ MiB of video RAM. If 0 or not specified, remap memory according to video mode. (2.5.66 patch/idea by Antonino Daplas reversed to give override possibility (allocate more fb memory than the kernel would) to 2.4 by [tmb@iki.fi](mailto:tmb%40iki.fi)) |
...
Gerd Knorr <[kraxel@goldbach.in-berlin.de](mailto:kraxel%40goldbach.in-berlin.de)>

Minor (mostly typo) changes
by Nico Schmoigl <[schmoigl@rumms.uni-mannheim.de](mailto:schmoigl%40rumms.uni-mannheim.de)>
