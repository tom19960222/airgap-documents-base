...
source_url: https://www.kernel.org/doc/html/v6.17/fb/framebuffer.html
...
a driver just has to call [`register_framebuffer()`](../driver-api/frame-buffer.md#c.register_framebuffer "register_framebuffer") and supply some functions.
...
[linux-fbdev@vger.kernel.org](mailto:linux-fbdev%40vger.kernel.org).
