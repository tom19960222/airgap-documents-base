...
source_url: https://www.kernel.org/doc/html/v6.17/fb/fbcon.html
fetched_at: 2026-09-16T16:39:52+00:00
---
...
3. Attaching, Detaching and Unloading
...
[Console Drivers](../driver-api/console.md) for more information).
...
[Console Drivers](../driver-api/console.md). To summarize:
...
> 1. Before detaching fbcon, do:
>
>    ```
>    vbetool vbemode save > <vesa state file> # do once for each vesafb mode,
>                                             # the file can be reused
>    ```
> 2. Detach fbcon as in step 5.
> 3. Attach fbcon:
>
>    ```
...
>    vbetool vbemode get
>    ```
> 2. Take note of the mode number
>
> 2. Detach fbcon as in step 5.
> 3. Attach fbcon:
>
