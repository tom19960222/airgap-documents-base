...
collection: kernel
version: "6.17"
title: "What is pvr2fb?"
source_url: https://www.kernel.org/doc/html/v6.17/fb/pvr2fb.html
fetched_at: 2026-09-16T16:39:57+00:00
---
# What is pvr2fb?
...
| mode:X | default video mode with format [xres]x[yres]-<bpp>@<refresh rate> The following video modes are supported: [640x640-16@60](mailto:640x640-16%4060), [640x480-24@60](mailto:640x480-24%4060), [640x480-32@60](mailto:640x480-32%4060). The Dreamcast defaults to [640x480-16@60](mailto:640x480-16%4060). At the time of writing the 24bpp and 32bpp modes function poorly. Work to fix that is ongoing  Note: the 640x240 mode is currently broken, and should not be used for any reason. It is only mentioned here as a reference. |
...
Paul Mundt <[lethal@linuxdc.org](mailto:lethal%40linuxdc.org)>

Updated by Adrian McMenamin <[adrian@mcmen.demon.co.uk](mailto:adrian%40mcmen.demon.co.uk)>
