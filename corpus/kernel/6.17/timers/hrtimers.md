...
source_url: https://www.kernel.org/doc/html/v6.17/timers/hrtimers.html
fetched_at: 2026-09-16T16:38:20+00:00
---
...
[`hrtimer_try_to_cancel()`](../driver-api/basics.md#c.hrtimer_try_to_cancel "hrtimer_try_to_cancel") and [`hrtimer_cancel()`](../driver-api/basics.md#c.hrtimer_cancel "hrtimer_cancel") [which are roughly
equivalent to [`timer_delete()`](../driver-api/basics.md#c.timer_delete "timer_delete") and [`timer_delete_sync()`](../driver-api/basics.md#c.timer_delete_sync "timer_delete_sync")] - so there’s no direct
