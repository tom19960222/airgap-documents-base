...
source_url: https://www.kernel.org/doc/html/v6.17/timers/no_hz.html
fetched_at: 2026-09-16T16:38:21+00:00
---
...
- Dyntick-idle slows transitions to and from idle slightly.
  ...
  1. Use PMQOS from userspace to inform the kernel of your
     latency requirements (preferred).
  2. On x86 systems, use the “idle=mwait” boot parameter.

  c. On x86 systems, use the “intel_idle.max_cstate=” to limit
  ` the maximum C-state depth.

  4. On x86 systems, use the “idle=poll” boot parameter.
