...
source_url: https://www.kernel.org/doc/html/v6.17/locking/seqlock.html
fetched_at: 2026-09-16T16:21:15+00:00
---
...
Check [`write_seqcount_latch()`](seqlock.md#c.write_seqcount_latch "write_seqcount_latch") for more information.
...
Similar to [`raw_seqcount_begin()`](seqlock.md#c.raw_seqcount_begin "raw_seqcount_begin"), except it enables eliding the critical
...
See [`write_seqcount_latch()`](seqlock.md#c.write_seqcount_latch "write_seqcount_latch") for details and a full reader/writer usage
example.
...
sequence counter raw value. Use the lowest bit as an index for
picking which data copy to read. The full counter must then be checked
with [`read_seqcount_latch_retry()`](seqlock.md#c.read_seqcount_latch_retry "read_seqcount_latch_retry").
...
`unsigned start`
:   count, from [`read_seqcount_latch()`](seqlock.md#c.read_seqcount_latch "read_seqcount_latch")
