...
collection: kernel
version: "6.17"
title: "Kernel Lock Torture Test Operation"
source_url: https://www.kernel.org/doc/html/v6.17/locking/locktorture.html
fetched_at: 2026-09-16T16:21:12+00:00
---
English

- [Italian](../translations/it_IT/locking/locktorture.md)
...
messages via [`printk()`](../core-api/printk-basics.md#c.printk "printk"), which can be examined via the dmesg (perhaps
...
:   Type of lock to torture. By default, only spinlocks will
    ...
    >       rwlock pairs.
    > - “mutex_lock”:
    >   :   [`mutex_lock()`](../kernel-hacking/locking.md#c.mutex_lock "mutex_lock") and [`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock") pairs.
    > - “rtmutex_lock”:
...
stat_interval
:   Number of seconds between statistics-related [`printk()`](../core-api/printk-basics.md#c.printk "printk")s.
...
verbose
:   Enable verbose debugging printing, via [`printk()`](../core-api/printk-basics.md#c.printk "printk"). Enabled
...
Also see: [RCU Torture Test Operation](../RCU/torture.md)
