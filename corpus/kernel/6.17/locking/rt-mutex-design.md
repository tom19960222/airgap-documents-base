...
source_url: https://www.kernel.org/doc/html/v6.17/locking/rt-mutex-design.html
...
[RT-mutex subsystem with PI support](rt-mutex.md). Although this document does explain problems
...
See [RT-mutex subsystem with PI support](rt-mutex.md) for further details.
...
For updates on this document, please email Steven Rostedt <[rostedt@goodmis.org](mailto:rostedt%40goodmis.org)>

## Credits

Author: Steven Rostedt <[rostedt@goodmis.org](mailto:rostedt%40goodmis.org)>

Updated: Alex Shi <[alex.shi@linaro.org](mailto:alex.shi%40linaro.org)> - 7/6/2017
