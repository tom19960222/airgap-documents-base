...
source_url: https://www.kernel.org/doc/html/v6.17/locking/mutex-design.html
fetched_at: 2026-09-16T16:21:13+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/locking/mutex-design.md)

# Generic Mutex Subsystem

started by Ingo Molnar <[mingo@redhat.com](mailto:mingo%40redhat.com)>

updated by Davidlohr Bueso <[davidlohr@hp.com](mailto:davidlohr%40hp.com)>
...
1. fastpath: tries to atomically acquire the lock by `cmpxchg()`ing the owner with
...
with [`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock").
...
[`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock") may access the mutex structure even after it has internally
released the lock already - so it’s not safe for another context to
acquire the mutex and assume that the [`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock") context is not using
...
[`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock") must ensure that the mutex stays alive until [`mutex_unlock()`](../kernel-hacking/locking.md#c.mutex_unlock "mutex_unlock")
has returned.
