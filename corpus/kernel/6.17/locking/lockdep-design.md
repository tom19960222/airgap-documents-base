...
source_url: https://www.kernel.org/doc/html/v6.17/locking/lockdep-design.html
fetched_at: 2026-09-16T16:21:11+00:00
---
English

- [Italian](../translations/it_IT/locking/lockdep-design.md)

# Runtime locking correctness validator

started by Ingo Molnar <[mingo@redhat.com](mailto:mingo%40redhat.com)>

additions by Arjan van de Ven <[arjan@linux.intel.com](mailto:arjan%40linux.intel.com)>
...
lock related deadlock. [[1]](lockdep-design.md#id2)
...
`down_read()`) and recursive readers (recursive shared lockers, like [`rcu_read_lock()`](../core-api/kernel-api.md#c.rcu_read_lock "rcu_read_lock")).
