...
source_url: https://www.kernel.org/doc/html/v6.17/devicetree/kernel-api.html
fetched_at: 2026-09-16T16:23:49+00:00
---
English
...
This function is like [`of_get_next_child()`](kernel-api.md#c.of_get_next_child "of_get_next_child"), except that it automatically
...
refcount of node **out_irq->np** is increased by 1 on success.
...
struct [irq_domain](../core-api/irq/irq-domain.md#c.irq_domain "irq_domain") \*of_msi_get_domain(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, const struct device_node \*np, enum irq_domain_bus_token token)
...
void of_msi_configure(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, const struct device_node \*np)
...
int of_changeset_add_prop_string_array(struct [of_changeset](kernel-api.md#c.of_changeset "of_changeset") \*ocs, struct device_node \*np, const char \*prop_name, const char \*const \*str_array, size_t sz)
...
int of_changeset_add_prop_bool(struct [of_changeset](kernel-api.md#c.of_changeset "of_changeset") \*ocs, struct device_node \*np, const char \*prop_name)
...
int of_changeset_update_prop_string(struct [of_changeset](kernel-api.md#c.of_changeset "of_changeset") \*ocs, struct device_node \*np, const char \*prop_name, const char \*str)
