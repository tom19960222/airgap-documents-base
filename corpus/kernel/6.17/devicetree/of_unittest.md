...
collection: kernel
version: "6.17"
title: "Open Firmware Devicetree Unittest"
source_url: https://www.kernel.org/doc/html/v6.17/devicetree/of_unittest.html
fetched_at: 2026-09-16T16:23:48+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/devicetree/of_unittest.md)

# Open Firmware Devicetree Unittest

Author: Gaurav Minocha <[gaurav.minocha.os@gmail.com](mailto:gaurav.minocha.os%40gmail.com)>
...
1. [Linux and the Devicetree](usage-model.md)
...
Secondly, it calls [`of_fdt_unflatten_tree()`](kernel-api.md#c.of_fdt_unflatten_tree "of_fdt_unflatten_tree") to unflatten the flattened
...
[`of_detach_node()`](kernel-api.md#c.of_detach_node "of_detach_node") to detach the nodes from the live device tree.

To detach a node, [`of_detach_node()`](kernel-api.md#c.of_detach_node "of_detach_node") either updates the child pointer of given
