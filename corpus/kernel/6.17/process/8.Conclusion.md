...
collection: kernel
version: "6.17"
title: "8. For more information"
source_url: https://www.kernel.org/doc/html/v6.17/process/8.Conclusion.html
fetched_at: 2026-09-16T16:18:12+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/8.Conclusion.md)
- [Chinese (Traditional)](../translations/zh_TW/process/8.Conclusion.md)
- [Italian](../translations/it_IT/process/8.Conclusion.md)
- [Spanish](../translations/sp_SP/process/8.Conclusion.md)
...
top-level [process/howto.rst](howto.md#process-howto); also read
[process/submitting-patches.rst](submitting-patches.md#submittingpatches). Many internal
