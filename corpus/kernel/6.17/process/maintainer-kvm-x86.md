...
version: "6.17"
title: "5. KVM x86"
source_url: https://www.kernel.org/doc/html/v6.17/process/maintainer-kvm-x86.html
fetched_at: 2026-09-16T16:31:27+00:00
---
English

- [Spanish](../translations/sp_SP/process/maintainer-kvm-x86.md)
...
[Coding style notes](maintainer-tip.md#maintainer-tip-coding-style), as patches/series often touch both KVM and
...
See [The canonical patch format](submitting-patches.md#the-canonical-patch-format) for more information, with one amendment:
...
See [Describe your changes](submitting-patches.md#describe-changes) for more information, with one amendment: lead with
...
“Cc: [stable@vger.kernel](mailto:stable%40vger.kernel)” (though the email itself doesn’t need to Cc: stable);
...
[Security bugs](security-bugs.md#securitybugs) if you suspect a bug can lead to an escape, data leak, etc.
