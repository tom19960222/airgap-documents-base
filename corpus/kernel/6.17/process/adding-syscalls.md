...
source_url: https://www.kernel.org/doc/html/v6.17/process/adding-syscalls.html
fetched_at: 2026-09-16T16:18:37+00:00
---
English

- [Italian](../translations/it_IT/process/adding-syscalls.md)
- [Spanish](../translations/sp_SP/process/adding-syscalls.md)
...
>   >   *read(2)*/*write(2)*-like operations
>   >   have to be implemented as *ioctl(2)* requests, which can lead
...
>   additional *prctl(2)* command option may be more appropriate. As
>   with *fcntl(2)*, this system call is a complicated multiplexor so
...
*openat(2)* man page; for an example of AT_EMPTY_PATH, see the
*fstatat(2)* man page.)
...
a call to `capable()`), as described in the *capabilities(7)* man
...
be cc’ed to [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).
...
This applies to all the architectures listed in [Since 6.11](adding-syscalls.md#syscall-generic-6-11)
under “Generic System Call Implementation”, except arm64. See
[Compatibility System Calls (arm64)](adding-syscalls.md#compat-arm64) for more information.
...
The man page should be cc’ed to [linux-man@vger.kernel.org](mailto:linux-man%40vger.kernel.org)
