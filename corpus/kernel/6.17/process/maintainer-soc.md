...
collection: kernel
version: "6.17"
title: "2. SoC Subsystem"
source_url: https://www.kernel.org/doc/html/v6.17/process/maintainer-soc.html
fetched_at: 2026-09-16T16:31:24+00:00
---
# 2. SoC Subsystem
...
### 2.2.1. Submitting Patches for Given SoC
...
### 2.2.2. Submitting Patches to the Main SoC Maintainers

The main SoC maintainers can be reached via the alias [soc@kernel.org](mailto:soc%40kernel.org) only in
following cases:
...
3. Introducing a completely new SoC platform. Such new SoC work should be sent
   ...
   [soc@kernel.org](mailto:soc%40kernel.org) in one patchset containing new arch/foo/Kconfig entry, DTS
...
Note that the [soc@kernel.org](mailto:soc%40kernel.org) is usually not the place to discuss the patches,
...
### 2.3.1. Devicetree ABI Stability
...
Please read [Devicetree (DT) ABI](../devicetree/bindings/ABI.md).
...
### 2.3.3. Devicetree Naming Convention
...
### 2.3.4. Validating Devicetree Files
...
“Running checks” of [Writing Devicetree Bindings in json-schema](../devicetree/bindings/writing-schema.md) for
...
### 2.3.5. Branches and Pull Requests
...
Small sets of patches can also be sent as separate emails to [soc@kernel.org](mailto:soc%40kernel.org),
...
requests, please see [Creating Pull Requests](../maintainer/pull-requests.md).
