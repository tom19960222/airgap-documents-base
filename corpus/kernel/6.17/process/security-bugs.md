...
version: "6.17"
title: "Security bugs"
source_url: https://www.kernel.org/doc/html/v6.17/process/security-bugs.html
fetched_at: 2026-09-16T16:18:21+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/security-bugs.md)
- [Italian](../translations/it_IT/process/security-bugs.md)
- [Spanish](../translations/sp_SP/process/security-bugs.md)
...
‘[Reporting issues](../admin-guide/reporting-issues.md)’ if you are unclear about what
information is helpful. Any exploit code is very helpful and will not
be released without consent from the reporter unless it has already been
made public.

The Linux kernel security team can be contacted by email at
<[security@kernel.org](mailto:security%40kernel.org)>. This is a private list of security officers
...
[regular patch submission](submitting-patches.md)
...
assigned for a confirmed issue, they can contact the [kernel CVE
assignment team](cve.md) to obtain one.
