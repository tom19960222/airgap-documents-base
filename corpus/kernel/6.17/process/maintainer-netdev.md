...
collection: kernel
version: "6.17"
title: "1. Networking subsystem (netdev)"
source_url: https://www.kernel.org/doc/html/v6.17/process/maintainer-netdev.html
fetched_at: 2026-09-16T16:31:25+00:00
---
...
| RFC | not to be applied, usually not in maintainer’s review queue, pw-bot can automatically set patches to this state based on subject tags |
...
Patches [marked](maintainer-netdev.md#patch-status) as `Changes Requested` need
...
OK with that, then perhaps consider mailing [security@kernel.org](mailto:security%40kernel.org) or
...
### 1.6.3. Local variable ordering (“reverse xmas tree”, “RCS”)
...
- Addressing [Local variable ordering](maintainer-netdev.md#rcs) issues
...
to the previous posting (see [Changes requested](maintainer-netdev.md#changes-requested)).
...
gets overloaded very easily and [netdev@vger](mailto:netdev%40vger) really doesn’t need more
...
helpful tips please see [Reviewing patches](7.AdvancedTopics.md#development-advancedtopics-reviews).
