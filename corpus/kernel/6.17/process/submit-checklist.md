...
source_url: https://www.kernel.org/doc/html/v6.17/process/submit-checklist.html
fetched_at: 2026-09-16T16:18:13+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/submit-checklist.md)
- [Chinese (Traditional)](../translations/zh_TW/process/submit-checklist.md)
- [Italian](../translations/it_IT/process/submit-checklist.md)
- [Japanese](../translations/ja_JP/process/submit-checklist.md)
- [Spanish](../translations/sp_SP/process/submit-checklist.md)
...
1. Include [kernel-doc](../doc-guide/kernel-doc.md#kernel-doc) to document global kernel APIs.
...
5. All new userspace interfaces are documented in `Documentation/ABI/`.
   See [Linux ABI description](../admin-guide/abi.md) (or `Documentation/ABI/README`)
...
> 1. with applicable or modified `CONFIG` options `=y`, `=m`, and
>    `=n`. No `gcc` warnings/errors, no linker warnings/errors.
> 2. Passes `allnoconfig`, `allmodconfig`
> 3. Builds successfully when using `O=builddir`
> 4. Any Documentation/ changes build successfully without new warnings/errors.
