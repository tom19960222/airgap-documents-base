...
source_url: https://www.kernel.org/doc/html/v6.17/process/stable-kernel-rules.html
fetched_at: 2026-09-16T16:18:21+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/stable-kernel-rules.md)
- [Chinese (Traditional)](../translations/zh_TW/process/stable-kernel-rules.md)
- [Italian](../translations/it_IT/process/stable-kernel-rules.md)
...
[Option 1](stable-kernel-rules.md#option-1) is **strongly** preferred, it is the easiest and most common.
[Option 2](stable-kernel-rules.md#option-2) is mainly meant for changes where backporting was not considered
at the time of submission. [Option 3](stable-kernel-rules.md#option-3) is an alternative to the two earlier
...
[stable@vger.kernel.org](mailto:stable%40vger.kernel.org) containing the subject of the patch, the commit ID,
...
[stable@vger.kernel.org](mailto:stable%40vger.kernel.org) and mention the kernel versions you wish it to be applied
