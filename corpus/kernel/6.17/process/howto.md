...
source_url: https://www.kernel.org/doc/html/v6.17/process/howto.html
fetched_at: 2026-09-16T16:18:13+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/howto.md)
- [Chinese (Traditional)](../translations/zh_TW/process/howto.md)
- [Italian](../translations/it_IT/process/howto.md)
- [Japanese](../translations/ja_JP/process/howto.md)
- [Korean](../translations/ko_KR/process/howto.md)
- [Spanish](../translations/sp_SP/process/howto.md)
...
rules and how to use [SPDX](https://spdx.org/) identifiers in source code are
described in [Documentation/process/license-rules.rst](license-rules.md#kernel-licensing).
...
maintainer at [alx@kernel.org](mailto:alx%40kernel.org), and CC the list [linux-api@vger.kernel.org](mailto:linux-api%40vger.kernel.org).

Here is a list of files that are in the kernel source tree that are
required reading:

> [Documentation/admin-guide/README.rst](../admin-guide/README.md#readme)
> :   This file gives a short background on the Linux kernel and describes
>     what is necessary to do to configure and build the kernel. People
>     who are new to the kernel should start here.
>
> [Documentation/process/changes.rst](changes.md#changes)
> :   This file gives a list of the minimum levels of various software
>     packages that are necessary to build and run the kernel
>     successfully.
>
> [Documentation/process/coding-style.rst](coding-style.md#codingstyle)
...
>
> [Documentation/process/submitting-patches.rst](submitting-patches.md#submittingpatches)
...
>
> [Documentation/process/stable-api-nonsense.rst](stable-api-nonsense.md#stable-api-nonsense)
...
>
> [Documentation/process/security-bugs.rst](security-bugs.md#securitybugs)
> :   If you feel you have found a security problem in the Linux kernel,
>     please follow the steps in this document to help notify the kernel
>     developers, and help solve the issue.
>
> [Documentation/process/management-style.rst](management-style.md#managementstyle)
...
>
> [Documentation/process/stable-kernel-rules.rst](stable-kernel-rules.md#stable-kernel-rules)
> :   This file describes the rules on how the stable kernel releases
>     happen, and what to do if you want to get a change into one of these
>     releases.
>
> [Documentation/process/kernel-docs.rst](kernel-docs.md#kernel-docs)
> :   A list of external documentation that pertains to kernel
>     development. Please consult this list if you do not find what you
>     are looking for within the in-kernel documentation.
>
> [Documentation/process/applying-patches.rst](applying-patches.md#applying-patches)
...
Stable trees are maintained by the “stable” team <[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)>, and
are released as needs dictate. The normal release period is approximately
two weeks, but it can be longer if there are no pressing problems. A
security-related problem, instead, can cause a release to happen almost
instantly.

The file [Documentation/process/stable-kernel-rules.rst](stable-kernel-rules.md#stable-kernel-rules)
...
The file ‘[Reporting issues](../admin-guide/reporting-issues.md)’ in the main kernel
...
as stated in [Documentation/process/submitting-patches.rst](submitting-patches.md#submittingpatches).
...
Maintainer: Greg Kroah-Hartman <[greg@kroah.com](mailto:greg%40kroah.com)>
