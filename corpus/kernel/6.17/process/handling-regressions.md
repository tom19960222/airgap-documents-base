...
source_url: https://www.kernel.org/doc/html/v6.17/process/handling-regressions.html
...
2. Make the Linux kernel regression tracking bot “regzbot” track the issue (this
   ...
   >   ```
3. When submitting fixes for regressions, add “Closes:” tags to the patch
   ...
   [Documentation/process/5.Posting.rst](5.Posting.md#development-posting). If you are
