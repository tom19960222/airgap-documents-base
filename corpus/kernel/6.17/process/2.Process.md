...
source_url: https://www.kernel.org/doc/html/v6.17/process/2.Process.html
fetched_at: 2026-09-16T16:18:08+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/2.Process.md)
- [Chinese (Traditional)](../translations/zh_TW/process/2.Process.md)
- [Italian](../translations/it_IT/process/2.Process.md)
- [Spanish](../translations/sp_SP/process/2.Process.md)
...
- Use interleaved (“inline”) replies, which makes your response easier to
  ...
  [Documentation/process/submitting-patches.rst](submitting-patches.md#interleaved-replies).
