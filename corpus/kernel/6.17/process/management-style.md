...
source_url: https://www.kernel.org/doc/html/v6.17/process/management-style.html
fetched_at: 2026-09-16T16:18:26+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/management-style.md)
- [Chinese (Traditional)](../translations/zh_TW/process/management-style.md)
- [Italian](../translations/it_IT/process/management-style.md)
- [Spanish](../translations/sp_SP/process/management-style.md)

# Linux kernel management style

This is a short document describing the preferred (or made up, depending
on who you ask) management style for the linux kernel. It’s meant to
mirror the [process/coding-style.rst](coding-style.md#codingstyle) document to some
degree, and mainly written to avoid answering [[1]](management-style.md#f1) the same (or similar)
...
no-no according to [1) Decisions](management-style.md#decisions).
...
“you’re a d\*ckhead” in millions of different ways [[2]](management-style.md#f2), sometimes without
...
somebody [[3]](management-style.md#f3).
