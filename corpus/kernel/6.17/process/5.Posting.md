...
collection: kernel
version: "6.17"
title: "5. Posting patches"
source_url: https://www.kernel.org/doc/html/v6.17/process/5.Posting.html
fetched_at: 2026-09-16T16:18:10+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/5.Posting.md)
- [Chinese (Traditional)](../translations/zh_TW/process/5.Posting.md)
- [Italian](../translations/it_IT/process/5.Posting.md)
- [Spanish](../translations/sp_SP/process/5.Posting.md)
...
and [Documentation/process/submit-checklist.rst](submit-checklist.md#submitchecklist).
...
>   which can be found in [Documentation/process/submitting-patches.rst](submitting-patches.md#submittingpatches)
...
>   see the reviewer’s statement in [Documentation/process/submitting-patches.rst](submitting-patches.md#submittingpatches)
>   for more detail.
...
>
>   [Documentation/process/email-clients.rst](email-clients.md#email-clients) has some
...
>   next stable update. If so, [stable@vger.kernel.org](mailto:stable%40vger.kernel.org) should get a copy of
>   the patch. Also add a “Cc: [stable@vger.kernel.org](mailto:stable%40vger.kernel.org)” to the tags within
