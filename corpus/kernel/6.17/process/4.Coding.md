...
collection: kernel
version: "6.17"
title: "4. Getting the code right"
source_url: https://www.kernel.org/doc/html/v6.17/process/4.Coding.html
fetched_at: 2026-09-16T16:18:09+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/4.Coding.md)
- [Chinese (Traditional)](../translations/zh_TW/process/4.Coding.md)
- [Italian](../translations/it_IT/process/4.Coding.md)
- [Spanish](../translations/sp_SP/process/4.Coding.md)
...
[Documentation/process/coding-style.rst](coding-style.md#codingstyle). For much of
...
[Fault injection capabilities infrastructure](../fault-injection/fault-injection.md) for more information on
...
The file [Documentation/admin-guide/kernel-parameters.rst](../admin-guide/kernel-parameters.md#kernelparameters) describes all of the kernel’s boot-time parameters.
...
[Documentation/doc-guide/](../doc-guide/index.md#doc-guide).
