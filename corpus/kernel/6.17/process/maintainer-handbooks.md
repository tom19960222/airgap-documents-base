...
source_url: https://www.kernel.org/doc/html/v6.17/process/maintainer-handbooks.html
...
- [1. Networking subsystem (netdev)](maintainer-netdev.md)
  ...
  - [1.8. Supported status for drivers](maintainer-netdev.md#supported-status-for-drivers)
  - [1.9. Reviewer guidance](maintainer-netdev.md#reviewer-guidance)
  - [1.10. Testimonials / feedback](maintainer-netdev.md#testimonials-feedback)
- [2. SoC Subsystem](maintainer-soc.md)
  - [2.1. Overview](maintainer-soc.md#overview)
  - [2.2. Maintainers](maintainer-soc.md#maintainers)
  - [2.3. Information for (new) Submaintainers](maintainer-soc.md#information-for-new-submaintainers)
