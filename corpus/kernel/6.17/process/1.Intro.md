...
source_url: https://www.kernel.org/doc/html/v6.17/process/1.Intro.html
fetched_at: 2026-09-16T16:18:08+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/process/1.Intro.md)
- [Chinese (Traditional)](../translations/zh_TW/process/1.Intro.md)
- [Italian](../translations/it_IT/process/1.Intro.md)
- [Spanish](../translations/sp_SP/process/1.Intro.md)
...
[How the development process works](2.Process.md#development-process) introduces the development process, the kernel
...
[Early-stage planning](3.Early-stage.md#development-early-stage) covers early-stage project planning, with an
emphasis on involving the development community as soon as possible.

[Getting the code right](4.Coding.md#development-coding) is about the coding process; several pitfalls which
have been encountered by other developers are discussed. Some requirements for
patches are covered, and there is an introduction to some of the tools
which can help to ensure that kernel patches are correct.

[Posting patches](5.Posting.md#development-posting) talks about the process of posting patches for
...
[Followthrough](6.Followthrough.md#development-followthrough) covers what happens after posting patches; the
...
[Advanced topics](7.AdvancedTopics.md#development-advancedtopics) introduces a couple of “advanced” topics:
managing patches with git and reviewing patches posted by others.

[For more information](8.Conclusion.md#development-conclusion) concludes the document with pointers to sources
...
This document was written by Jonathan Corbet, [corbet@lwn.net](mailto:corbet%40lwn.net). It has been
