...
collection: kernel
version: "6.17"
title: "Kernel driver vt1211"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/vt1211.html
...
Authors: Juerg Haefliger <[juergh@gmail.com](mailto:juergh%40gmail.com)>
...
| VccP | --- | --- | 1.0 | 1400 mV [[1]](vt1211.md#id3) |
| +5V | 14K | 10K | 2.4 | 2083 mV |
| +12V | 47K | 10K | 5.7 | 2105 mV |
| +3.3V (int) | 2K | 3.4K | 1.588 | 3300 mV [[2]](vt1211.md#id4) |
| +3.3V (ext) | 6.8K | 10K | 1.68 | 1964 mV |

[[1](vt1211.md#id1)]

Depending on the CPU (1.4V is for a VIA C3 Nehemiah).

[[2](vt1211.md#id2)]

R1 and R2 for 3.3V (int) are internal to the VT1211 chip and the driver
...
| --- | --- | --- |
| Intel CPU | 88.638 65.000 | 0.9528 0.9686 [[3]](vt1211.md#id6) |
