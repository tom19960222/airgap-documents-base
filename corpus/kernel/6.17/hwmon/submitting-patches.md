...
collection: kernel
version: "6.17"
title: "How to Get Your Patch Accepted Into the Hwmon Subsystem"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/submitting-patches.html
fetched_at: 2026-09-16T16:43:52+00:00
---
...
- Use devres functions whenever possible to allocate resources. For rationale
  and supported functions, please see [Devres - Managed Device Resource](../driver-api/driver-model/devres.md).
...
- Do not create non-standard attributes unless really needed. If you have to use
  ...
  Standard attributes are specified in [Naming and data format standards for sysfs files](sysfs-interface.md).
