...
collection: kernel
version: "6.17"
title: "Kernel driver smsc47m192"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/smsc47m192.html
...
Author:
:   - Hartmut Rick <[linux@rick.claranet.de](mailto:linux%40rick.claranet.de)>
...
| temp[2-3]_input_fault | diode fault flags for temperature inputs 2 and 3. A fault is detected if the two pins for the corresponding sensor are open or shorted, or any of the two is shorted to ground or Vcc. ‘1’ indicates a diode fault. |
