...
collection: kernel
version: "6.17"
title: "Kernel driver sis5595"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/sis5595.html
...
> > - Aurelien Jarno <[aurelien@aurel32.net](mailto:aurelien%40aurel32.net)> 2.6 port
>
...
|  |  |
| --- | --- |
| force_addr=0xaddr | Set the I/O base address. Useful for boards that don’t set the address in the BIOS. Does not do a PCI force; the device must still be present in lspci. Don’t use this unless the driver complains that the base address is not set.  Example: ‘modprobe sis5595 force_addr=0x290’ |
