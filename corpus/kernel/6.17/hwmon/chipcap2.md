...
collection: kernel
version: "6.17"
title: "Kernel driver ChipCap2"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/chipcap2.html
...
| Name | Perm | Description |
| --- | --- | --- |
| humidity1_min: | RW | humidity low limit. Measurements under this limit trigger a humidity low alarm |
| humidity1_max: | RW | humidity high limit. Measurements above this limit trigger a humidity high alarm |
