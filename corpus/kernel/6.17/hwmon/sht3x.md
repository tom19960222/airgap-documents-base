...
collection: kernel
version: "6.17"
title: "Kernel driver sht3x"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/sht3x.html
...
[How to instantiate I2C devices](../i2c/instantiating-devices.md) for methods to instantiate the
device.
...
| heater_enable: | heater enable, heating element removes excess humidity from sensor:  - 0: turned off - 1: turned on |
