...
collection: kernel
version: "6.17"
title: "Kernel driver asc7621"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/asc7621.html
...
:   |  |  |
    | --- | --- |
    | 0 | (default) peci_legacy = 0, PECI Processor Temperature 0 peci_legacy = 1, Remote 1 Temperature |
    | 1 | Remote 1 Temperature |
    | 2 | Remote 2 Temperature |
    | 3 | Internal Temperature |
    | 4 | PECI Processor Temperature 0 |
