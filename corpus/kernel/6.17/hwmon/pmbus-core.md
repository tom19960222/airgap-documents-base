...
collection: kernel
version: "6.17"
title: "PMBus core driver and internal API"
source_url: https://www.kernel.org/doc/html/v6.17/hwmon/pmbus-core.html
fetched_at: 2026-09-16T16:43:51+00:00
---
...
[`i2c_smbus_read_word_data()`](../driver-api/i2c.md#c.i2c_smbus_read_word_data "i2c_smbus_read_word_data"), but selects page and phase first. If the chip does
...
Write word data to <page>, <reg>. Similar to [`i2c_smbus_write_word_data()`](../driver-api/i2c.md#c.i2c_smbus_write_word_data "i2c_smbus_write_word_data"), but
selects page first.
...
Read byte data from <page>, <reg>. Similar to [`i2c_smbus_read_byte_data()`](../driver-api/i2c.md#c.i2c_smbus_read_byte_data "i2c_smbus_read_byte_data"), but
...
Write byte data to <page>, <reg>. Similar to [`i2c_smbus_write_byte()`](../driver-api/i2c.md#c.i2c_smbus_write_byte "i2c_smbus_write_byte"), but
selects page first. <page> may be -1, which means “current page”.
...
no data, [`i2c_smbus_write_byte()`](../driver-api/i2c.md#c.i2c_smbus_write_byte "i2c_smbus_write_byte")). With such controllers, clearing the status
