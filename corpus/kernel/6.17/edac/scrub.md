...
version: "6.17"
title: "Scrub Control"
source_url: https://www.kernel.org/doc/html/v6.17/edac/scrub.html
fetched_at: 2026-09-16T16:43:02+00:00
---
# Scrub Control
...
CXL spec r3.1 [[1]](scrub.md#id5) section 8.2.9.9.11.1 describes the memory device patrol
...
CXL spec r3.1 [[1]](scrub.md#id5) section 8.2.9.9.11.2 describes Error Check Scrub (ECS)
...
ACPI spec 6.5 [[2]](scrub.md#id6) section 5.2.21 ACPI RAS2 describes an ACPI RAS2 table
...
ACPI spec 6.5 [[2]](scrub.md#id6) section 9.19.7.2 describes Address Range Scrubbing (ARS).
...
[1]
([1](scrub.md#id1),[2](scrub.md#id2))

<https://computeexpresslink.org/cxl-specification/>

[2]
([1](scrub.md#id3),[2](scrub.md#id4))
...
> |  |  |  |  |  |
> | --- | --- | --- | --- | --- |
> | Name | ACPI RAS2 | CXL patrol scrub | CXL ECS | ARS |
> | On-demand Scrubbing | Supported | No | No | Supported |
> | Background scrubbing | Supported | Supported | Supported | No |
> | Mode of scrubbing | Scrub ctrl per NUMA domain. | per device | per memory media | Unknown |
> | Query scrub capabilities | Supported | Supported | Supported | Supported |
> | Setting address range | Supported | No | No | Supported |
> | Setting scrub rate | Supported | Supported | No | No |
> | Unit for scrub rate | Not Defined | in hours | No | No |
> | Scrub status/ Completion | Supported on-demand scrubbing only | No | No | Supported |
> | UC error reporting | Exception | CXL general media/DRAM event/media scan? | CXL general media/DRAM event/media scan? | ACPI UCE notify and query ARS status |
> | Support for EDAC control | Supported | Supported | Supported | No |
...
[ABI file testing/sysfs-edac-scrub](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-edac-scrub)

[ABI file testing/sysfs-edac-ecs](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-edac-ecs)
