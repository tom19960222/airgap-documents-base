...
collection: kernel
version: "6.17"
title: "EDAC/RAS features"
source_url: https://www.kernel.org/doc/html/v6.17/edac/features.html
...
Memory scrub features are documented in [Scrub Control](scrub.md).

2. Memory Repair

Memory repair features are documented in [EDAC Memory Repair Control](memory_repair.md).
