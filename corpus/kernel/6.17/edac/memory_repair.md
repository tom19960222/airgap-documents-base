...
collection: kernel
version: "6.17"
title: "EDAC Memory Repair Control"
source_url: https://www.kernel.org/doc/html/v6.17/edac/memory_repair.html
...
For example, for CXL memory devices, see CXL spec rev 3.1 [[1]](memory_repair.md#id3) sections
...
See CXL spec 3.1 [[1]](memory_repair.md#id3) section 8.2.9.7.1.4 Memory Sparing Maintenance
Operations for more details.

[1]
([1](memory_repair.md#id1),[2](memory_repair.md#id2))
...
[ABI file testing/sysfs-edac-memory-repair](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-edac-memory-repair).
