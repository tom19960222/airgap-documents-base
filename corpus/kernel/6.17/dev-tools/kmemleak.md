...
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kmemleak.html
fetched_at: 2026-09-16T16:21:34+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/dev-tools/kmemleak.md)

# Kernel Memory Leak Detector

Kmemleak provides a way of detecting possible kernel memory leaks in a
way similar to a [tracing garbage collector](https://en.wikipedia.org/wiki/Tracing_garbage_collection),
...
The memory allocations via [`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc"), [`vmalloc()`](../core-api/mm-api.md#c.vmalloc "vmalloc"),
[`kmem_cache_alloc()`](../core-api/mm-api.md#c.kmem_cache_alloc "kmem_cache_alloc") and
...
- `kmemleak_vmalloc` - notify of a [`vmalloc()`](../core-api/mm-api.md#c.vmalloc "vmalloc") memory allocation
