...
version: "6.17"
title: "clang-format"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/clang-format.html
fetched_at: 2026-09-16T16:21:29+00:00
---
English

- [Italian](../translations/it_IT/dev-tools/clang-format.md)
...
>   when moving code around and aligning/sorting. See [clangformatreformat](clang-format.md#clangformatreformat).
> - Spot style mistakes, typos and possible improvements in files
>   you maintain, patches you review, diffs, etc. See [clangformatreview](clang-format.md#clangformatreview).
...
coding style. They also try to follow [Documentation/process/coding-style.rst](../process/coding-style.md#codingstyle)
...
so that you can tweak a few options. See [clangformatextra](clang-format.md#clangformatextra).
