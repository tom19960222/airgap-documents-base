...
version: "6.17"
title: "Checkpatch"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/checkpatch.html
fetched_at: 2026-09-16T16:21:28+00:00
---
# Checkpatch
...
>
> **CONSIDER_KSTRTO**
> :   The [`simple_strtol()`](../core-api/kernel-api.md#c.simple_strtol "simple_strtol"), [`simple_strtoll()`](../core-api/kernel-api.md#c.simple_strtoll "simple_strtoll"), [`simple_strtoul()`](../core-api/kernel-api.md#c.simple_strtoul "simple_strtoul"), and
>     [`simple_strtoull()`](../core-api/kernel-api.md#c.simple_strtoull "simple_strtoull") functions explicitly ignore overflows, which
>     may lead to unexpected results in callers. The respective [`kstrtol()`](../core-api/kernel-api.md#c.kstrtol "kstrtol"),
>     [`kstrtoll()`](../core-api/kernel-api.md#c.kstrtoll "kstrtoll"), [`kstrtoul()`](../core-api/kernel-api.md#c.kstrtoul "kstrtoul"), and [`kstrtoull()`](../core-api/kernel-api.md#c.kstrtoull "kstrtoull") functions tend to be the
...
> :   [Commit d91bff3011cf](https://git.kernel.org/torvalds/c/d91bff3011cf) (“proc/sysctl: add shared variables for range
...
>
> **USLEEP_RANGE**
> :   [`usleep_range()`](../timers/delay_sleep_functions.md#c.usleep_range "usleep_range") should be preferred over [`udelay()`](../timers/delay_sleep_functions.md#c.udelay "udelay"). The proper way of
>     using [`usleep_range()`](../timers/delay_sleep_functions.md#c.usleep_range "usleep_range") is mentioned in the kernel docs.
...
>
>     Earlier, the default line length was 80 columns. [Commit bdc48fa11e46](https://git.kernel.org/torvalds/c/bdc48fa11e46)
