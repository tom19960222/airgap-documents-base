...
collection: kernel
version: "6.17"
title: "Kernel Memory Sanitizer (KMSAN)"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kmsan.html
fetched_at: 2026-09-16T16:21:33+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/dev-tools/kmsan.md)

# Kernel Memory Sanitizer (KMSAN)

KMSAN is a dynamic error detector aimed at finding uses of uninitialized
values. It is based on compiler instrumentation, and is quite similar to the
userspace [MemorySanitizer tool](https://clang.llvm.org/docs/MemorySanitizer.html).
...
Please refer to [LLVM documentation](https://llvm.org/docs/GettingStarted.html) for the instructions on how to build Clang.
...
based on the userspace [MemorySanitizer tool](https://clang.llvm.org/docs/MemorySanitizer.html).
...
Please refer to the [LKML discussion](https://lore.kernel.org/all/20220614144853.3693273-1-glider@google.com/) for more details.
