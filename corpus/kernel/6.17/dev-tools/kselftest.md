...
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kselftest.html
...
- [Device testing with kselftest](testing-devices.md)
...
`FIXTURE_TEARDOWN_PARENT()` is used instead of [`FIXTURE_TEARDOWN()`](kselftest.md#c.FIXTURE_TEARDOWN "FIXTURE_TEARDOWN").
