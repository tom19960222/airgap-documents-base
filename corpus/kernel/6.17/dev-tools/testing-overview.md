...
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/testing-overview.html
fetched_at: 2026-09-16T16:17:43+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/dev-tools/testing-overview.md)
- [Chinese (Traditional)](../translations/zh_TW/dev-tools/testing-overview.md)
...
KUnit ([KUnit - Linux Kernel Unit Testing](kunit/index.md)) is an entirely in-kernel system
...
kselftest ([Linux Kernel Selftests](kselftest.md)), on the other hand, is
...
[Using gcov with the Linux kernel](gcov.md) is GCC’s coverage testing tool, which can be
...
[KCOV: code coverage for fuzzing](kcov.md) is a feature which can be built in to the
...
- KASAN detects invalid memory accesses such as out-of-bounds and
  use-after-free errors. See [Kernel Address Sanitizer (KASAN)](kasan.md)
- UBSAN detects behaviour that is undefined by the C standard, like integer
  overflows. See [Undefined Behavior Sanitizer - UBSAN](ubsan.md)
- KCSAN detects data races. See [Kernel Concurrency Sanitizer (KCSAN)](kcsan.md)
- KFENCE is a low-overhead detector of memory issues, which is much faster than
  KASAN and can be used in production. See [Kernel Electric-Fence (KFENCE)](kfence.md)
- lockdep is a locking correctness validator. See
  [Runtime locking correctness validator](../locking/lockdep-design.md)
- Runtime Verification (RV) supports checking specific behaviours for a given
  subsystem. See [Runtime Verification](../trace/rv/runtime-verification.md)
...
examining the code. See the [Sparse](sparse.md) documentation
...
[Coccinelle](coccinelle.md) documentation page for details.
