...
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kfence.html
fetched_at: 2026-09-16T16:21:35+00:00
---
...
corruptions, therefore [`is_kfence_address()`](kfence.md#c.is_kfence_address "is_kfence_address") must be used to check whether
...
[`kfence_alloc()`](kfence.md#c.kfence_alloc "kfence_alloc") should be inserted into the heap allocation fast path,
...
[`kfence_ksize()`](kfence.md#c.kfence_ksize "kfence_ksize") returns the number of bytes requested for a KFENCE object at
...
In userspace, a similar approach is taken by [GWP-ASan](http://llvm.org/docs/GwpAsan.html). GWP-ASan also relies on guard pages and
a sampling strategy to detect memory unsafety bugs at scale. KFENCE’s design is
directly influenced by GWP-ASan, and can be seen as its kernel sibling. Another
similar but non-sampling approach, that also inspired the name “KFENCE”, can be
found in the userspace [Electric Fence Malloc Debugger](https://linux.die.net/man/3/efence).
