...
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kasan.html
fetched_at: 2026-09-16T16:21:32+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/dev-tools/kasan.md)
- [Chinese (Traditional)](../translations/zh_TW/dev-tools/kasan.md)
...
the accessed address (see the [Implementation details](kasan.md#implementation-details) section).
...
[`call_rcu()`](../core-api/kernel-api.md#c.call_rcu "call_rcu") and workqueue queuing.
...
3. Using kunit_tool
   ...
   See [KUnit documentation](https://www.kernel.org/doc/html/latest/dev-tools/kunit/index.html)
