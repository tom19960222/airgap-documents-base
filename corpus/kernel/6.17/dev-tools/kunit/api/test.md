...
version: "6.17"
title: "Test API"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kunit/api/test.html
fetched_at: 2026-09-16T16:29:00+00:00
---
# Test API
...
void kunit_kfree_const(struct [kunit](test.md#c.kunit "kunit") \*test, const void \*x)
...
Calls [`kunit_kfree()`](test.md#c.kunit_kfree "kunit_kfree") only if **x** is not in .rodata section.
See [`kunit_kstrdup_const()`](test.md#c.kunit_kstrdup_const "kunit_kstrdup_const") for more information.

char \*kunit_kstrdup(struct [kunit](test.md#c.kunit "kunit") \*test, const char \*str, gfp_t gfp)
...
See [`kstrdup()`](../../../core-api/kernel-api.md#c.kstrdup "kstrdup") and [`kunit_kmalloc_array()`](test.md#c.kunit_kmalloc_array "kunit_kmalloc_array") for more information.

const char \*kunit_kstrdup_const(struct [kunit](test.md#c.kunit "kunit") \*test, const char \*str, gfp_t gfp)
...
Calls [`kunit_kstrdup()`](test.md#c.kunit_kstrdup "kunit_kstrdup") only if **str** is not in the rodata section. Must be freed with
[`kunit_kfree_const()`](test.md#c.kunit_kfree_const "kunit_kfree_const") -- not [`kunit_kfree()`](test.md#c.kunit_kfree "kunit_kfree").
See [`kstrdup_const()`](../../../core-api/kernel-api.md#c.kstrdup_const "kstrdup_const") and [`kunit_kmalloc_array()`](test.md#c.kunit_kmalloc_array "kunit_kmalloc_array") for more information.
...
[`kunit_vm_mmap()`](test.md#c.kunit_vm_mmap "kunit_vm_mmap") without calling [`kunit_attach_mm()`](test.md#c.kunit_attach_mm "kunit_attach_mm") directly. Only necessary when
...
unsigned long kunit_vm_mmap(struct [kunit](test.md#c.kunit "kunit") \*test, struct [file](test.md#c.kunit_vm_mmap "file") \*file, unsigned long addr, unsigned long len, unsigned long prot, unsigned long flag, unsigned long offset)
...
`struct file *file`
:   [`struct file`](../../../filesystems/api-summary.md#c.file "file") pointer to map from, if any
...
The opposite of [`KUNIT_SUCCEED()`](test.md#c.KUNIT_SUCCEED "KUNIT_SUCCEED"), it is an assertion that always fails. In
...
See [`KUNIT_ASSERT_TRUE()`](test.md#c.KUNIT_ASSERT_TRUE "KUNIT_ASSERT_TRUE") for more information.
...
[`KUNIT_ASSERT_TRUE()`](test.md#c.KUNIT_ASSERT_TRUE "KUNIT_ASSERT_TRUE") for more information.
