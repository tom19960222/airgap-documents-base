...
collection: kernel
version: "6.17"
title: "KUnit Architecture"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kunit/architecture.html
fetched_at: 2026-09-16T16:21:42+00:00
---
# KUnit Architecture
...
`struct called` [`struct kunit_case`](api/test.md#c.kunit_case "kunit_case").
...
definition in
[include/asm-generic/vmlinux.lds.h](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/asm-generic/vmlinux.lds.h?h=v6.0#n950).
...
![KUnit Suite Memory](../../_images/kunit_suitememorydiagram.svg)
...
executor, see
[lib/kunit/executor.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/lib/kunit/executor.c).
...
[lib/kunit/try-catch.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/lib/kunit/try-catch.c?h=v5.15#n58).
...
The test case includes a [`KUNIT_CASE_PARAM()`](api/test.md#c.KUNIT_CASE_PARAM "KUNIT_CASE_PARAM") macro that accepts a
...
[Run Tests without kunit_tool](run_manual.md)) or use `kunit_tool`
(see [Running tests with kunit_tool](run_wrapper.md)).
