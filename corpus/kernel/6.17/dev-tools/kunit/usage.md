...
version: "6.17"
title: "Writing Tests"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kunit/usage.html
fetched_at: 2026-09-16T16:21:44+00:00
---
# Writing Tests
...
To learn about more KUnit expectations, see [Test API](api/test.md).
...
For more information, see [Test API](api/test.md).
...
For a full example, see this [patch](https://lore.kernel.org/all/20221207014024.340230-3-rmoar@google.com/)
...
avoid resource leaks. For more information, see [Resource API](api/resource.md).
...
described in [Devres - Managed Device Resource](../../driver-api/driver-model/devres.md)
