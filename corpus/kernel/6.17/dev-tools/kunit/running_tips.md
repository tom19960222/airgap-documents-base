...
collection: kernel
version: "6.17"
title: "Tips For Running KUnit Tests"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kunit/running_tips.html
...
> **Note:**
>
> TODO([brendanhiggins@google.com](mailto:brendanhiggins%40google.com)): There are various issues with UML and
> versions of gcc 7 and up. You’re likely to run into missing `.gcda`
> files or compile errors.

This is different from the “normal” way of getting coverage information that is
documented in [Using gcov with the Linux kernel](../gcov.md).
...
See [Using gcov with the Linux kernel](../gcov.md) for details on how to do this.
