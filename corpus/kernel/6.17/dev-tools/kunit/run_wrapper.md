...
collection: kernel
version: "6.17"
title: "Running tests with kunit_tool"
source_url: https://www.kernel.org/doc/html/v6.17/dev-tools/kunit/run_wrapper.html
...
manually, see: [Run Tests without kunit_tool](run_manual.md).
...
> **Note:**
>
> Removing something from the `.kunitconfig` will
...
- `--help`: Lists all available options. To list common options,
  ...
  > **Note:**
  >
  > Different commands (`config`, `build`, `run`, etc)
