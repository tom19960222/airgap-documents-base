...
source_url: https://www.kernel.org/doc/html/v6.17/firmware-guide/acpi/enumeration.html
fetched_at: 2026-09-16T16:49:57+00:00
---
...
>   are represented as [`struct spi_device`](../../driver-api/spi.md#c.spi_device "spi_device") or [`struct i2c_client`](../../driver-api/i2c.md#c.i2c_client "i2c_client"). Note
...
See [_DSD Device Properties Related to GPIO](gpio-properties.md) for more information
...
Refer to [_DSD Device Properties Usage Rules](DSD-properties-rules.md) for more
information.
...
16 GPIOs and we want to add the property `gpio-line-names` [[1]](enumeration.md#id4) to these pins.
...
in particular the DSDT (see also [[2]](enumeration.md#id5)):
...
and the _ADR method [[3]](enumeration.md#id6) returns exactly the device/function couple that
...
[[1](enumeration.md#id1)]

[_DSD Device Properties Related to GPIO](gpio-properties.md)

[[2](enumeration.md#id2)]

[Upgrading ACPI tables via initrd](../../admin-guide/acpi/initrd_table_override.md)

[[3](enumeration.md#id3)]

ACPI Specifications, Version 6.3 - Paragraph 6.1.1 _ADR Address)
