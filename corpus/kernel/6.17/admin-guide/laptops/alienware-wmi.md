...
collection: kernel
version: "6.17"
title: "Alienware WMI Driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/laptops/alienware-wmi.html
fetched_at: 2026-09-16T16:32:05+00:00
---
# Alienware WMI Driver

Kurt Borja <[kuurtb@gmail.com](mailto:kuurtb%40gmail.com)>
...
WMI device documentation: [Dell AWCC WMI interface driver (alienware-wmi)](../../wmi/devices/alienware-wmi.md)
...
- [Platform Profile](alienware-wmi.md#platform-profile):

  - Thermal profile control
  - G-Mode toggling
- [HWMON](alienware-wmi.md#hwmon):
...
[sysfs-class-platform-profile](../abi-testing-files.md#abi-file-testing-sysfs-class-platform-profile)
...
[sysfs-class-hwmon](../abi-testing-files.md#abi-file-testing-sysfs-class-hwmon) for more
information.
...
| --- | --- | --- |
| fan[1-4]_boost | RW | Fan boost value.  Integer value between 0 and 255 |
