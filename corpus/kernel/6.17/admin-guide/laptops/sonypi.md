...
collection: kernel
version: "6.17"
title: "Sony Programmable I/O Control Device Driver Readme"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/laptops/sonypi.html
fetched_at: 2026-09-16T16:49:00+00:00
---
# Sony Programmable I/O Control Device Driver Readme

> - Copyright (C) 2001-2004 Stelian Pop <[stelian@popies.net](mailto:stelian%40popies.net)>
> - Copyright (C) 2001-2002 Alcôve <www.alcove.com>
> - Copyright (C) 2001 Michael Ashley <[m.ashley@unsw.edu.au](mailto:m.ashley%40unsw.edu.au)>
> - Copyright (C) 2001 Junichi Morita <[jun1m@mars.dti.ne.jp](mailto:jun1m%40mars.dti.ne.jp)>
> - Copyright (C) 2000 Takaya Kinjo <[t-kinjo@tc4.so-net.ne.jp](mailto:t-kinjo%40tc4.so-net.ne.jp)>
> - Copyright (C) 2000 Andrew Tridgell <[tridge@samba.org](mailto:tridge%40samba.org)>
...
> | camera: | if you have a PictureBook series Vaio (with the integrated MotionEye camera), set this parameter to 1 in order to let the driver access to the camera |
