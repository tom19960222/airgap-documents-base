...
collection: kernel
version: "6.17"
title: "Sony Notebook Control Driver (SNC) Readme"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/laptops/sony-laptop.html
fetched_at: 2026-09-16T16:34:50+00:00
---
# Sony Notebook Control Driver (SNC) Readme

> - Copyright (C) 2004- 2005 Stelian Pop <[stelian@popies.net](mailto:stelian%40popies.net)>
> - Copyright (C) 2007 Mattia Dongili <[malattia@linux.it](mailto:malattia%40linux.it)>
...
> |  |  |
> | --- | --- |
> | brightness | get/set screen brightness (an integer between 0 and 7) |
...
> |  |  |
> | --- | --- |
> | brightness_default | screen brightness which will be set when the laptop will be rebooted |
