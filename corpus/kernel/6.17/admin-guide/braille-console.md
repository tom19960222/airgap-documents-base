...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/braille-console.html
fetched_at: 2026-09-16T16:23:03+00:00
---
# Linux Braille Console

To get early boot messages on a braille device (before userspace screen
readers can start), you first need to compile the support for the usual serial
console (see [Documentation/admin-guide/serial-console.rst](serial-console.md#serial-console)), and
for braille device
