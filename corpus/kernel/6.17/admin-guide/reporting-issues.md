...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/reporting-issues.html
fetched_at: 2026-09-16T16:17:48+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/admin-guide/reporting-issues.md)
- [Chinese (Traditional)](../translations/zh_TW/admin-guide/reporting-issues.md)
...
longterm series? One still supported? Then search the [LKML](https://lore.kernel.org/lkml/) and the [Linux stable mailing list](https://lore.kernel.org/stable/) archives for matching reports to join. If
you don’t find any, install [the latest release from that series](https://kernel.org/). If it still shows the issue, report it to the stable
mailing list ([stable@vger.kernel.org](mailto:stable%40vger.kernel.org)) and CC the regressions list
([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)); ideally also CC the maintainer and the mailing
list for the subsystem in question.

In all other cases try your best guess which kernel part might be causing the
issue. Check the [MAINTAINERS](../process/maintainers.md#maintainers) file for how its developers
...
search the [LKML](https://lore.kernel.org/lkml/) and the web, too. If you
don’t find any to join, install [the latest mainline kernel](https://kernel.org/). If the issue is present there, send a report.
...
regressions mailing list ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) to your report. Also try
...
>   List (LKML)](https://lore.kernel.org/lkml/). If you find matching reports,
...
>   line you care about: go to the [front page of kernel.org](https://kernel.org/) and make sure it mentions
...
>   ([stable@vger.kernel.org](mailto:stable%40vger.kernel.org)) and CC the Linux regressions mailing list
>   ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)); if you suspect the cause in a particular
...
>   reading [How to Report Bugs Effectively](https://www.chiark.greenend.org.uk/~sgtatham/bugs.html), [How To Ask
>   Questions The Smart Way](http://www.catb.org/esr/faqs/smart-questions.html), and [How to ask good
...
search the [Linux Kernel Mailing List (LKML) archives](https://lore.kernel.org/lkml/).
...
[Reporting regressions](reporting-regressions.md) explains this in more
...
[Security bugs](../process/security-bugs.md) before proceeding, as it
...
If your kernel is tainted, study [Tainted kernels](tainted-kernels.md)
...
To illustrate how to use the [MAINTAINERS](../process/maintainers.md#maintainers) file, lets assume
...
(LKML) <[linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org)> to CC. Don’t omit either of the mailing
...
would need to send the report to ‘Some Human <[shuman@example.com](mailto:shuman%40example.com)>’ with
[‘ath10k@lists.infradead.org](mailto:'ath10k%40lists.infradead.org)’ and [‘linux-kernel@vger.kernel.org](mailto:'linux-kernel%40vger.kernel.org)’ in CC.
...
often find its archives on [lore.kernel.org](https://lore.kernel.org/).
...
[ath10k@lists.infradead.org](mailto:ath10k%40lists.infradead.org)’ for example will lead you to the [Info page for the
ath10k mailing list](https://lists.infradead.org/mailman/listinfo/ath10k),
which at the top links to its
[list archives](https://lists.infradead.org/pipermail/ath10k/). Sadly this and
...
>   kernel.org](https://kernel.org/) and not modified or enhanced in any way.

#### Choosing the right version for testing

Head over to [kernel.org](https://kernel.org/) to find out which version you
...
[official development repository on kernel.org](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/).
...
downloading the sources as tarball from [kernel.org](https://kernel.org/).
...
[Bisecting a regression](bug-bisect.md) describes in detail. That process
...
[Reporting regressions](reporting-regressions.md); that document also
...
>   ([foobar@example.com](mailto:foobar%40example.com)) (gcc (GCC) 10.2.1, GNU ld version 2.34) #1 SMP Mon Aug
...
>   service, a ticket created just for this purpose on [bugzilla.kernel.org](https://bugzilla.kernel.org/), ...) and include a link to them in your
...
>   subsystem developers provide](https://www.alsa-project.org/wiki/AlsaInfo).
...
Now send or file the report like the [MAINTAINERS](../process/maintainers.md#maintainers) file told
...
([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)). In case the report needs to be filed to some web
...
See [Security bugs](../process/security-bugs.md) for more information.
...
[search the archives of the Linux stable mailing list](https://lore.kernel.org/stable/) for reports about an issue like yours. If
...
the document [Bisecting a regression](bug-bisect.md) for details how to
...
within rules outlined in [Everything you ever wanted to know about Linux -stable releases](../process/stable-kernel-rules.md).
...
>   sources. You can do this with the web interfaces [on kernel.org](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/)
>   or its mirror [on GitHub](https://github.com/torvalds/linux); if you have
...
>
>   > Cc: <[stable@vger.kernel.org](mailto:stable%40vger.kernel.org)> # 5.4+
>
...
>   developers mailing list](https://lore.kernel.org/lkml/). Also read the
...
for the subsystem as well as the stable mailing list ([stable@vger.kernel.org](mailto:stable%40vger.kernel.org)).
