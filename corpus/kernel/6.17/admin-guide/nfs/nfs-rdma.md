...
collection: kernel
version: "6.17"
title: "Setting up NFS/RDMA"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/nfs/nfs-rdma.html
...
[nfs-rdma-devel@lists.sourceforge.net](mailto:nfs-rdma-devel%40lists.sourceforge.net) mailing list.
...
- Build, install, reboot
  ...
  > 1. N if either SUNRPC or INFINIBAND are N, in this case the NFS/RDMA client
  >    and server will not be built
  > 2. M if both SUNRPC and INFINIBAND are on (M or Y) and at least one is M,
  >    in this case the NFS/RDMA client and server will be built as modules
  > 3. Y if both SUNRPC and INFINIBAND are Y, in this case the NFS/RDMA client
