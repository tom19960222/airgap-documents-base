...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/ext4.html
fetched_at: 2026-09-16T16:22:57+00:00
---
...
Mailing list: [linux-ext4@vger.kernel.org](mailto:linux-ext4%40vger.kernel.org)
...
>     [Direct Access for files](../filesystems/dax.md). Note that this option is
...
>     [Inline Encryption](../block/inline-encryption.md).
...
(see also [ABI file testing/sysfs-fs-ext4](abi-testing-files.md#abi-file-testing-sysfs-fs-ext4))
