...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/quickly-build-trimmed-linux.html
fetched_at: 2026-09-16T16:22:34+00:00
---
...
>
>   [[details](quickly-build-trimmed-linux.md#backup)]
...
>
>   [[details](quickly-build-trimmed-linux.md#secureboot)]
...
>   distributions.
>
>   [[details](quickly-build-trimmed-linux.md#buildrequires)]
...
>
>   [[details](quickly-build-trimmed-linux.md#diskspace)]
...
>   clone. The reference section explains two alternatives:* [packaged
>   archives](quickly-build-trimmed-linux.md#sources-archive) *and* [a full git clone](quickly-build-trimmed-linux.md#sources-full) *;
>   prefer the latter, if downloading a lot of data does not bother you, as that
>   will avoid some* [peculiar characteristics of shallow clones the
>   reference section explains](quickly-build-trimmed-linux.md#sources-shallow) *.]*
>
...
>
>   [[details](quickly-build-trimmed-linux.md#sources)]
...
>
>   [[details](quickly-build-trimmed-linux.md#patching)]
...
>
>   [[details](quickly-build-trimmed-linux.md#tagging)]
>
...
>
>   [[details](quickly-build-trimmed-linux.md#configuration)]
...
> >   to simply not bother with this. [[details](quickly-build-trimmed-linux.md#configmods-debugsymbols)]
> > - Are you running Debian? Then to avoid known problems by performing
> >   additional adjustments explained in the reference section.
> >   [[details](quickly-build-trimmed-linux.md#configmods-distros)].
...
> >   [[details](quickly-build-trimmed-linux.md#configmods-individual)].
...
>
>   [[details](quickly-build-trimmed-linux.md#build)]
...
>
>   [[details](quickly-build-trimmed-linux.md#install)]
...
>   ```
>
>   [[details](quickly-build-trimmed-linux.md#another)]
...
>
>   [[details](quickly-build-trimmed-linux.md#uninstall)]
...
know by email (Thorsten Leemhuis <[linux@leemhuis.info](mailto:linux%40leemhuis.info)>), ideally while CCing the
Linux docs mailing list ([linux-doc@vger.kernel.org](mailto:linux-doc%40vger.kernel.org)). Such feedback is vital to
...
> [[...](quickly-build-trimmed-linux.md#backup-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#backup-sbs)]

### Dealing with techniques like Secure Boot

> *On platforms with ‘Secure Boot’ or similar techniques, prepare everything to
> ensure the system will permit your self-compiled kernel to boot later.*
> [[...](quickly-build-trimmed-linux.md#secureboot-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#secureboot-sbs)]

### Install build requirements

> *Install all software required to build a Linux kernel.*
> [[...](quickly-build-trimmed-linux.md#buildrequires-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#buildrequires-sbs)]

### Space requirements

> *Ensure to have enough free space for building and installing Linux.*
> [[...](quickly-build-trimmed-linux.md#diskspace-sbs)]

The numbers mentioned are rough estimates with a big extra charge to be on the
safe side, so often you will need less.

If you have space constraints, remember to read the reference section when you
reach the [section about configuration adjustments’](quickly-build-trimmed-linux.md#configmods), as
ensuring debug symbols are disabled will reduce the consumed disk space by quite
a few gigabytes.

[[back to step-by-step guide](quickly-build-trimmed-linux.md#diskspace-sbs)]

### Download the sources

> *Retrieve the sources of the Linux version you intend to build.*
> [[...](quickly-build-trimmed-linux.md#sources-sbs)]

The step-by-step guide outlines how to retrieve Linux’ sources using a shallow
git clone. There is [more to tell about this method](quickly-build-trimmed-linux.md#sources-shallow) and
two alternate ways worth describing: [packaged archives](quickly-build-trimmed-linux.md#sources-archive)
and [a full git clone](quickly-build-trimmed-linux.md#sources-full). And the aspects ‘[wouldn’t it
be wiser to use a proper pre-release than the latest mainline code](quickly-build-trimmed-linux.md#sources-snapshot)’ and ‘[how to get an even fresher mainline codebase](quickly-build-trimmed-linux.md#sources-fresher)’ need elaboration, too.
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#sources-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#sources-sbs)] [[back to section intro](quickly-build-trimmed-linux.md#sources)]
...
> [[...](quickly-build-trimmed-linux.md#patching-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#patching-sbs)]
...
> [[...](quickly-build-trimmed-linux.md#tagging-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#tagging-sbs)]

### Define the build configuration for your kernel

> *Create the build configuration for your kernel based on an existing
> configuration.* [[...](quickly-build-trimmed-linux.md#configuration-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#configuration-sbs)]
...
> [[...](quickly-build-trimmed-linux.md#configmods-sbs)]
...
failure messages’ in [Tainted kernels](tainted-kernels.md) in more
detail):
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#configmods-sbs)]

#### Distro specific adjustments

> *Are you running* [[...](quickly-build-trimmed-linux.md#configmods-sbs)]
...
> now* [[...](quickly-build-trimmed-linux.md#configmods-sbs)]
...
> *Build the image and the modules of your kernel* [[...](quickly-build-trimmed-linux.md#build-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#build-sbs)]

### Install your kernel

> *Now install your kernel* [[...](quickly-build-trimmed-linux.md#install-sbs)]
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#install-sbs)]

### Another round later

> *To later build another kernel you need similar, but sometimes slightly
> different commands* [[...](quickly-build-trimmed-linux.md#another-sbs)]
...
explained the setup described in more detail](quickly-build-trimmed-linux.md#sources): you need to use a
slightly different `git fetch` command and when switching to another series
need to add an additional remote branch.

[[back to step-by-step guide](quickly-build-trimmed-linux.md#another-sbs)]

### Uninstall the kernel later

> *All parts of your installed kernel are identifiable by its release name and
> thus easy to remove later.* [[...](quickly-build-trimmed-linux.md#uninstall-sbs)]
...
distribution’s installkernel executable ([see above](quickly-build-trimmed-linux.md#install)) and its
...
[[back to step-by-step guide](quickly-build-trimmed-linux.md#uninstall-sbs)]
...
document, as [described above](quickly-build-trimmed-linux.md#submit-improvements-qbtl).
