...
collection: kernel
version: "6.17"
title: "TAA - TSX Asynchronous Abort"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/tsx_async_abort.html
fetched_at: 2026-09-16T16:47:33+00:00
---
...
vulnerability file in sysfs. See [TAA system information](tsx_async_abort.md#tsx-async-abort-sys-info).
...
architecture section: [Documentation/arch/x86/tsx_async_abort.rst](../../arch/x86/tsx_async_abort.md#tsx-async-abort).
...
See [Mitigation control on the kernel command line](tsx_async_abort.md#taa-mitigation-control-command-line).
...
> |  |  |
> | --- | --- |
> | off | Disables TSX on the system.  Note that this option takes effect only on newer CPUs which are not vulnerable to MDS, i.e., have MSR_IA32_ARCH_CAPABILITIES.MDS_NO=1 and which get the new IA32_TSX_CTRL MSR through a microcode update. This new MSR allows for the reliable deactivation of the TSX functionality. |
