...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/core-scheduling.html
...
mentioned in [Usage](core-scheduling.md#usage), tasks with the same cookie value are assumed to trust
