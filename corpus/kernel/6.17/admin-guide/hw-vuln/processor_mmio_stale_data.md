...
collection: kernel
version: "6.17"
title: "Processor MMIO Stale Data Vulnerabilities"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/processor_mmio_stale_data.html
fetched_at: 2026-09-16T16:47:36+00:00
---
...
Below is the list of affected Intel processors [[1]](processor_mmio_stale_data.md#f1):
...
> |  |  |
> | --- | --- |
> | full | If the CPU is vulnerable, enable mitigation; CPU buffer clearing on exit to userspace and when entering a VM. Idle transitions are protected as well. It does not automatically disable SMT. |
...
[[1](processor_mmio_stale_data.md#id1)]
