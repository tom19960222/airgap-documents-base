...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/l1tf.html
...
vulnerability file in sysfs. See [L1TF system information](l1tf.md#l1tf-sys-info).
...
> at the end of this document. See [Default mitigations](l1tf.md#default-mitigations).
...
> line and sysfs control files. See [Mitigation control on the kernel command line](l1tf.md#mitigation-control-command-line)
> and [Mitigation control for KVM - module parameter](l1tf.md#mitigation-control-kvm).
...
> [Mitigation control on the kernel command line](l1tf.md#mitigation-control-command-line).
...
The default is ‘flush’. For details about L1D flushing see [1. L1D flush on VMENTER](l1tf.md#l1d-flush).
...
> sysfs control files. See [Mitigation control on the kernel command line](l1tf.md#mitigation-control-command-line) and
> [Mitigation control for KVM - module parameter](l1tf.md#mitigation-control-kvm).
...
> [Mitigation control on the kernel command line](l1tf.md#mitigation-control-command-line) and [Mitigation control for KVM - module parameter](l1tf.md#mitigation-control-kvm).
...
>   [2. Guest VCPU confinement to dedicated physical cores](l1tf.md#guest-confinement).
> - Interrupt isolation:
>
...
>   [3. Interrupt affinity](l1tf.md#interrupt-isolation).
...
>   time with the matching sysfs control files. See [4. SMT control](l1tf.md#smt-control),
>   [Mitigation control on the kernel command line](l1tf.md#mitigation-control-command-line) and
>   [Mitigation control for KVM - module parameter](l1tf.md#mitigation-control-kvm).
> - Disabling EPT:
>
