...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/mds.html
fetched_at: 2026-09-16T16:47:32+00:00
---
...
vulnerability file in sysfs. See [MDS system information](mds.md#mds-sys-info).
...
architecture section: [Documentation/arch/x86/mds.rst](../../arch/x86/mds.md#mds).
...
[Mitigation control on the kernel command line](mds.md#mds-mitigation-control-command-line).
...
>   [Documentation/admin-guide/hw-vuln//l1tf.rst](l1tf.md#mitigation-control-kvm).
...
> exception is XEON PHI, see [XEON PHI specific considerations](mds.md#xeon-phi).
>
> Disabling SMT can have a significant performance impact, but the impact
> depends on the type of workloads.
>
> See the relevant chapter in the L1TF mitigation documentation for details:
> [Documentation/admin-guide/hw-vuln/l1tf.rst](l1tf.md#smt-control).
...
> See [Virtualization mitigation](mds.md#virt-mechanism).
>
...
> for L1TF applies.
> See [Documentation/admin-guide/hw-vuln//l1tf.rst](l1tf.md#default-mitigations).
