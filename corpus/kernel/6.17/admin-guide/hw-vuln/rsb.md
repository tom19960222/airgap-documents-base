...
collection: kernel
version: "6.17"
title: "RSB-related mitigations"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/rsb.html
fetched_at: 2026-09-16T16:47:38+00:00
---
...
RSB poisoning is a technique used by SpectreRSB [[1]](rsb.md#spectre-rsb) where
...
- All attack vectors can potentially be mitigated by flushing out any
  ...
  [[2]](rsb.md#intel-rsb-filling) [[3]](rsb.md#amd-rsb-filling) when transitioning between
...
- On context switch, the user->user mitigation requires ensuring the
  RSB gets filled or cleared whenever IBPB gets written [[4]](rsb.md#cond-ibpb)
  during a context switch:

  - AMD:
    :   On Zen 4+, IBPB (or SBPB [[5]](rsb.md#amd-sbpb) if used) clears the RSB.
        This is indicated by IBPB_RET in CPUID [[6]](rsb.md#amd-ibpb-rsb).

        On Zen < 4, the RSB filling sequence [[3]](rsb.md#amd-rsb-filling) must be
        always be done in addition to IBPB [[7]](rsb.md#amd-ibpb-no-rsb). This is
  ...
  - Intel:
    :   IBPB always clears the RSB:
        ...
        predicted targets may come from the RSB.” [[8]](rsb.md#intel-ibpb-rsb)
- On context switch, user->kernel attacks are prevented by SMEP. User
  ...
  - AMD:
    :   “Finally, branches that are predicted as ‘ret’ instructions get
        ...
        Protection”.” [[9]](rsb.md#amd-smep-rsb)
  - Intel:
    :   “On processors with enhanced IBRS, an RSB overwrite sequence may
        ...
        IA32_SPEC_CTRL.IBRS set during VM exits.” [[10]](rsb.md#intel-smep-rsb)
- On VMEXIT, guest->host attacks are mitigated by eIBRS (and PBRSB
  ...
  - Intel:
    :   “On processors with enhanced IBRS, an RSB overwrite sequence may
        ...
        at the time of the VM exit.” [[12]](rsb.md#intel-eibrs-vmexit)

    Note that some Intel CPUs are susceptible to Post-barrier Return
    Stack Buffer Predictions (PBRSB) [[13]](rsb.md#intel-pbrsb), where the last
...
variant [[14]](rsb.md#retbleed-paper) [[15]](rsb.md#amd-btc) or by Speculative Return Stack
Overflow [[16]](rsb.md#amd-srso) (Inception [[17]](rsb.md#inception-paper)). The kernel
...
of RETBleed [[14]](rsb.md#retbleed-paper) (Return Stack Buffer Underflow
[[18]](rsb.md#intel-rsbu)). If a RET is executed when the RSB buffer is empty due
...
- On context switch, user->user underflow attacks are mitigated by the
  conditional IBPB [[4]](rsb.md#cond-ibpb) on context switch which effectively
  clears the BTB:
  ...
  - “The indirect branch predictor barrier (IBPB) is an indirect branch
    ...
    logical processor.” [[19]](rsb.md#intel-ibpb-btb)
...
- “Restricted RSB Alternate (RRSBA) behavior allows alternate branch
  ...
  [[20]](rsb.md#intel-eibrs-rrsba)

When a CPU with RRSBA is vulnerable to Branch History Injection
[[21]](rsb.md#bhi-paper) [[22]](rsb.md#intel-bhi), an RSB underflow could be used for an
...
- “Where software is using retpoline as a mitigation for BHI or
  ...
  [[23]](rsb.md#intel-retpoline-rrsba)
...
[4]
([1](rsb.md#id4),[2](rsb.md#id21))

Whether IBPB is written depends on whether the prev and/or next task is protected from Spectre attacks. It typically requires opting in per task or system-wide. For more details see the documentation for the `spectre_v2_user` cmdline option in [The kernel’s command-line parameters](../kernel-parameters.md).
