...
collection: kernel
version: "6.17"
title: "Attack Vector Controls"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/hw-vuln/attack_vector_controls.html
...
1. [User-to-Kernel](attack_vector_controls.md#user-kernel)
2. [User-to-User](attack_vector_controls.md#user-user)
3. [Guest-to-Host](attack_vector_controls.md#guest-host)
4. [Guest-to-Guest](attack_vector_controls.md#guest-guest)
5. [Cross-Thread](attack_vector_controls.md#smt)

To control the enabled attack vectors, see [Command Line Controls](attack_vector_controls.md#cmdline).
