...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/sysctl/kernel.html
fetched_at: 2026-09-16T16:35:34+00:00
---
...
- [core_sort_vma](kernel.md#core-sort-vma)
...
- [hung_task_detect_count](kernel.md#hung-task-detect-count)
...
- [panic_sys_info](kernel.md#panic-sys-info)
...
- [timer_migration](kernel.md#timer-migration)
...
## [domainname & hostname](kernel.md#id17)
...
## [firmware_config](kernel.md#id18)
...
## [ftrace_dump_on_oops](kernel.md#id19)
...
| <instance>=2(orig_cpu) | Dump the specific instance buffer on the CPU that triggered the oops. |
...
## [ftrace_enabled, stack_tracer_enabled](kernel.md#id20)

See [ftrace - Function Tracer](../../trace/ftrace.md).

## [hardlockup_all_cpu_backtrace](kernel.md#id21)
...
## [hardlockup_panic](kernel.md#id22)
...
## [hung_task_all_cpu_backtrace](kernel.md#id24)
...
## [hung_task_panic](kernel.md#id25)
...
## [hung_task_check_count](kernel.md#id26)

The upper bound on the number of tasks that are checked.
This file shows up if `CONFIG_DETECT_HUNG_TASK` is enabled.

## [hung_task_detect_count](kernel.md#id27)
...
## [hung_task_timeout_secs](kernel.md#id28)
...
## [hung_task_check_interval_secs](kernel.md#id29)
...
## [hung_task_warnings](kernel.md#id30)
...
## [hyperv_record_panic_msg](kernel.md#id31)
...
## [ignore-unaligned-usertrap](kernel.md#id32)
...
## [io_uring_disabled](kernel.md#id33)
...
## [kexec_load_disabled](kernel.md#id35)
...
## [kexec_load_limit_panic](kernel.md#id36)
...
## [kexec_load_limit_reboot](kernel.md#id37)

Similar functionality as `kexec_load_limit_panic`, but for a normal
image.

## [kptr_restrict](kernel.md#id38)
...
## [modules_disabled](kernel.md#id40)
...
## [msgmax, msgmnb, and msgmni](kernel.md#id41)
...
## [msg_next_id, sem_next_id, and shm_next_id (System V IPC)](kernel.md#id42)
...
## [nmi_wd_lpm_factor (PPC only)](kernel.md#id45)
...
## [numa_balancing_promote_rate_limit_MBps](kernel.md#id47)
...
## [oops_all_cpu_backtrace](kernel.md#id48)
...
## [osrelease, ostype & version](kernel.md#id50)
...
## [overflowgid & overflowuid](kernel.md#id51)
...
## [panic_on_io_nmi](kernel.md#id53)
...
## [panic_on_stackoverflow](kernel.md#id55)
...
## [panic_on_unrecovered_nmi](kernel.md#id56)
...
## [panic_on_rcu_stall](kernel.md#id60)
...
## [max_rcu_stall_to_panic](kernel.md#id61)
...
## [perf_cpu_time_max_percent](kernel.md#id62)
...
## [perf_event_paranoid](kernel.md#id63)
...
## [perf_event_max_stack](kernel.md#id64)
...
## [perf_event_mlock_kb](kernel.md#id65)

Control size of per-cpu ring buffer not counted against mlock limit.

The default value is 512 + 1 page

## [perf_event_max_contexts_per_stack](kernel.md#id66)
...
## [perf_user_access (arm64 and riscv only)](kernel.md#id67)
...
## [pid_max](kernel.md#id68)

PID allocation wrap value. When the kernel’s next PID value
reaches this value, it wraps back to a minimum PID value.
PIDs of value `pid_max` or larger are not allocated.

## [ns_last_pid](kernel.md#id69)

The last pid allocated in the current (the one task using this sysctl
lives in) pid namespace. When selecting a pid for a next task on fork
kernel tries to allocate a number starting from this one.

## [powersave-nap (PPC only)](kernel.md#id70)
...
## [printk_delay](kernel.md#id72)

Delay each printk message in `printk_delay` milliseconds

Value from 0 - 10000 is allowed.

## [printk_ratelimit](kernel.md#id73)
...
## [randomize_va_space](kernel.md#id78)
...
## [real-root-dev](kernel.md#id79)

See [Using the initial RAM disk (initrd)](../initrd.md).

## [reboot-cmd (SPARC only)](kernel.md#id80)

??? This seems to be a way to give an argument to the Sparc
ROM/Flash boot loader. Maybe to tell it what to do after
rebooting. ???

## [sched_energy_aware](kernel.md#id81)
...
## [sched_schedstats](kernel.md#id83)

Enables/disables scheduler statistics. Enabling this feature
incurs a small amount of overhead in the scheduler but is
useful for debugging and performance tuning.

## [sched_util_clamp_min](kernel.md#id84)
...
## [sched_util_clamp_max](kernel.md#id85)
...
## [sched_util_clamp_min_rt_default](kernel.md#id86)
...
## [sysctl_writes_strict](kernel.md#id93)
...
## [softlockup_all_cpu_backtrace](kernel.md#id94)
...
## [softlockup_panic](kernel.md#id95)
...
## [split_lock_mitigate (x86 only)](kernel.md#id97)
...
## [stop-a (SPARC only)](kernel.md#id99)
...
## [timer_migration](kernel.md#id103)
...
## [unaligned-trap](kernel.md#id106)
...
## [unknown_nmi_panic](kernel.md#id107)
...
## [unprivileged_bpf_disabled](kernel.md#id108)
...
## [watchdog_cpumask](kernel.md#id111)
...
## [watchdog_thresh](kernel.md#id112)
