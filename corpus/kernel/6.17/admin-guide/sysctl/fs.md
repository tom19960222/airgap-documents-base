...
collection: kernel
version: "6.17"
title: "Documentation for /proc/sys/fs/"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/sysctl/fs.html
fetched_at: 2026-09-16T16:47:20+00:00
---
...
- [aio-nr & aio-max-nr](fs.md#aio-nr-aio-max-nr)
- [dentry-negative](fs.md#dentry-negative)
- [dentry-state](fs.md#dentry-state)
- [file-max & file-nr](fs.md#file-max-file-nr)
- [inode-nr & inode-state](fs.md#inode-nr-inode-state)
- [mount-max](fs.md#mount-max)
- [nr_open](fs.md#nr-open)
- [overflowgid & overflowuid](fs.md#overflowgid-overflowuid)
- [pipe-user-pages-hard](fs.md#pipe-user-pages-hard)
- [pipe-user-pages-soft](fs.md#pipe-user-pages-soft)
- [protected_fifos](fs.md#protected-fifos)
- [protected_hardlinks](fs.md#protected-hardlinks)
- [protected_regular](fs.md#protected-regular)
- [protected_symlinks](fs.md#protected-symlinks)
- [suid_dumpable](fs.md#suid-dumpable)

### [aio-nr & aio-max-nr](fs.md#id1)
...
### [inode-nr & inode-state](fs.md#id5)
...
### [overflowgid & overflowuid](fs.md#id8)
...
### [pipe-user-pages-hard](fs.md#id9)
...
### [pipe-user-pages-soft](fs.md#id10)
...
### [protected_hardlinks](fs.md#id12)
...
### [protected_regular](fs.md#id13)

This protection is similar to [protected_fifos](fs.md#protected-fifos), but it
