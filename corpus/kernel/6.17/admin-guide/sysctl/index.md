...
collection: kernel
version: "6.17"
title: "Documentation for /proc/sys"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/sysctl/index.html
fetched_at: 2026-09-16T16:22:26+00:00
---
...
stories to: <[riel@nl.linux.org](mailto:riel%40nl.linux.org)>
...
| fs/ | specific filesystems filehandle, inode, dentry and quota tuning binfmt_misc <[Kernel Support for miscellaneous Binary Formats (binfmt_misc)](../binfmt-misc.md)> |
...
- [Documentation for /proc/sys/abi/](abi.md)
- [Documentation for /proc/sys/fs/](fs.md)
- [Documentation for /proc/sys/kernel/](kernel.md)
- [Documentation for /proc/sys/net/](net.md)
- [Documentation for /proc/sys/sunrpc/](sunrpc.md)
- [Documentation for /proc/sys/user/](user.md)
- [Documentation for /proc/sys/vm/](vm.md)
