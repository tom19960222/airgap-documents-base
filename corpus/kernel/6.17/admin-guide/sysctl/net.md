...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/sysctl/net.html
...
> - Terrehon Bowden <[terrehon@pacbell.net](mailto:terrehon%40pacbell.net)>
> - Bodo Bauer <[bb@ricochet.net](mailto:bb%40ricochet.net)>

Copyright (c) 2000

> - Jorge Nerin <[comandante@zaralinux.com](mailto:comandante%40zaralinux.com)>

Copyright (c) 2009

> - Shen Feng <[shen@cn.fujitsu.com](mailto:shen%40cn.fujitsu.com)>
...
[The kernel’s command-line parameters](../kernel-parameters.md) for additional details.
...
Please see: [IP Sysctl](../../networking/ip-sysctl.md) and
[Documentation for /proc/sys/net/](net.md) for descriptions of these entries.
