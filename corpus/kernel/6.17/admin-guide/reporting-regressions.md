...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/reporting-regressions.html
fetched_at: 2026-09-16T16:22:33+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/admin-guide/reporting-regressions.md)
- [Chinese (Traditional)](../translations/zh_TW/admin-guide/reporting-regressions.md)
...
for kernel developers are left to [Handling regressions](../process/handling-regressions.md).

## The important bits (aka “TL;DR”)

1. It’s a regression if something running fine with one Linux kernel works worse
...
2. Report your issue as outlined in [Reporting issues](reporting-issues.md),
   ...
   with “[REGRESSION]” and CC or forward it to [the regression mailing list](https://lore.kernel.org/regressions/) ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)).
3. Optional, but recommended: when sending or forwarding your report, make the
...
[Reporting issues](reporting-issues.md), it already describes the
...
>   Linux regressions mailing list](https://lore.kernel.org/regressions/) and
>   [regzbot’s web-interface](https://linux-regtracking.leemhuis.info/regzbot/).
...
>   ([regressions@lists.linux.dev](mailto:regressions%40lists.linux.dev)) know about your report:
>
...
>   v5.15.3..v5.15.5), remember to CC the [Linux stable mailing list](https://lore.kernel.org/stable/) ([stable@vger.kernel.org](mailto:stable%40vger.kernel.org)).
>
...
kernel regressions](https://linux-regtracking.leemhuis.info/regzbot/) and the
...
[Reporting issues](reporting-issues.md) and described in more detail by
[Bisecting a regression](bug-bisect.md). It might sound like a lot of work, but
...
issues, or other problematic aspects already fixed in later versions](http://www.kroah.com/log/blog/2018/08/24/what-stable-kernel-should-i-use/).
...
[Handling regressions](../process/handling-regressions.md).
...
staging code](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/staging/Kconfig),
...
commands can be found in the [getting started guide](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/getting_started.md) and
the [reference documentation](https://gitlab.com/knurd42/regzbot/-/blob/main/docs/reference.md)
for regzbot.
