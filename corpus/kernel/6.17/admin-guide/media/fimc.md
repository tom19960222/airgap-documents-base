...
collection: kernel
version: "6.17"
title: "7.5. The Samsung S5P/Exynos4 FIMC driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/fimc.html
fetched_at: 2026-09-16T16:49:14+00:00
---
# 7.5. The Samsung S5P/Exynos4 FIMC driver
...
## 7.5.1. Supported SoCs

S5PC100 (mem-to-mem only), S5PV210, Exynos4210

## 7.5.2. Supported features
...
## 7.5.3. Not currently supported

- LCD writeback input
- per frame clock gating (mem-to-mem)

## 7.5.4. User space interfaces

### 7.5.4.1. Media device interface
...
### 7.5.4.2. Memory-to-memory video node
...
### 7.5.4.4. Camera capture subdevs
...
## 7.5.5. 5. Device mapping to video and subdev device nodes
