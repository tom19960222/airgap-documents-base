...
collection: kernel
version: "6.17"
title: "8.2. How to get the bt8xx cards working"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/bt8xx.html
fetched_at: 2026-09-16T16:49:23+00:00
---
...
Please see [BTTV cards list](bttv-cardlist.md) for a complete
...
As shown at [BTTV cards list](bttv-cardlist.md), TwinHan and
...
Please also see [Digital TV Conditional Access Interface](ci.md).

### 8.2.2.2. Running multiple cards

See [BTTV cards list](bttv-cardlist.md) for a complete list of
