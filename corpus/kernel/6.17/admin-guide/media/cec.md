...
version: "6.17"
title: "4. HDMI CEC"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/cec.html
...
- Extron DA HD 4K PLUS HDMI Distribution Amplifier. See
  [Extron DA HD 4K PLUS CEC Adapter driver](cec.md#extron-da-hd-4k-plus) for more information.
...
The documentation on how to use the error injection is here: [CEC Pin Framework Error Injection](../../userspace-api/media/cec/cec-pin-error-inj.md#cec-pin-error-inj).
...
## 4.8. Extron DA HD 4K PLUS CEC Adapter driver
