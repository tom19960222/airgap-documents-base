...
collection: kernel
version: "6.17"
title: "7.6. i.MX Video Capture Driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/imx.html
fetched_at: 2026-09-16T16:33:52+00:00
---
# 7.6. i.MX Video Capture Driver
...
manuals [[1]](imx.md#f1) and [[2]](imx.md#f2).
...
![Diagram of the i.MX6Q SabreSD media pipeline topology](../../_images/imx6q-sabresd.svg)

Media pipeline graph on i.MX6Q SabreSD

![Diagram of the i.MX6Q SabreAuto media pipeline topology](../../_images/imx6q-sabreauto.svg)
...
## 7.6.9. Frame Skipping in ipuX_csiY
...
## 7.6.10. Frame Interval Monitor in ipuX_csiY
...
## 7.6.16. Unprocessed Video Capture:
...
## 7.6.18. Motion Compensated De-interlace:
...
## 7.6.20. i.MX6Q SabreLite with OV5642 and OV5640
...
## 7.6.21. i.MX6Q SabreAuto with ADV7180 decoder
...
## 7.6.22. i.MX6DL SabreAuto with ADV7180 decoder
...
## 7.6.23. i.MX6Q SabreSD with MIPI CSI-2 OV5640
...
- Steve Longerbeam <[steve_longerbeam@mentor.com](mailto:steve_longerbeam%40mentor.com)>
- Philipp Zabel <[kernel@pengutronix.de](mailto:kernel%40pengutronix.de)>
- Russell King <[linux@armlinux.org.uk](mailto:linux%40armlinux.org.uk)>
