...
collection: kernel
version: "6.17"
title: "7.26. The Virtual Video Test Driver (vivid)"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/vivid.html
fetched_at: 2026-09-16T16:49:21+00:00
---
# 7.26. The Virtual Video Test Driver (vivid)
...
### 7.26.2.2. TV and S-Video Inputs
...
## 7.26.8. Software Defined Radio Receiver
...
### 7.26.12.1. User Controls - Test Controls
...
### 7.26.12.2. User Controls - Video Capture
...
#### 7.26.12.4.2. Capture Feature Selection Controls
...
#### 7.26.12.4.3. Output Feature Selection Controls
...
#### 7.26.12.4.4. Error Injection Controls
...
#### 7.26.12.4.5. VBI Raw Capture Controls
...
### 7.26.12.5. Digital Video Controls
...
### 7.26.12.6. FM Radio Receiver Controls
...
### 7.26.12.7. FM Radio Modulator Controls
...
### 7.26.12.8. Metadata Capture Controls
...
## 7.26.13. Video, Sliced VBI and HDMI CEC Looping
...
## 7.26.15. Cropping, Composing, Scaling
...
## 7.26.18. CEC (Consumer Electronics Control)
...
## 7.26.19. Some Future Improvements
