...
collection: kernel
version: "6.17"
title: "7.1. The bttv driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/bttv.html
fetched_at: 2026-09-16T16:49:12+00:00
---
# 7.1. The bttv driver
...
In this case, please see [How to get the bt8xx cards working](bt8xx.md)
...
cards is in [BTTV cards list](bttv-cardlist.md).
...
If your card isn’t listed in [BTTV cards list](bttv-cardlist.md)
or if you have trouble making audio work, please read [Still doesn’t work?](bttv.md#still-doesnt-work).
...
at [BTTV cards list](bttv-cardlist.md)
...
screen. See [Linux Serial Console](../serial-console.md) for details on
setting up a serial console.

Read [Bug hunting](../bug-hunting.md) to learn how to get any useful
information out of a register+stack dump printed by the kernel on
protection faults (so-called “kernel oops”).

If you run into some kind of deadlock, you can try to dump a call trace
for each process using sysrq-t (see [Linux Magic System Request Key Hacks](../sysrq.md)).
...
| --- | --- | --- | --- | --- | --- | --- |
| M101.C | ISA ! |  |  |  |  |  |
| M108-B | Bt848 |  | -- | FR1236 |  | US [[2]](bttv.md#f2), [[3]](bttv.md#f3) |
| M1A8-A | Bt848 | AVer TV-Phone |  | FM1216 | -- |  |
| M168-T | 1461:0003 | AVerTV Studio | 48:17 | FM1216 | TDA9840T | D [[1]](bttv.md#f1) w/FM w/Remote |
