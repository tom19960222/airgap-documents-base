...
collection: kernel
version: "6.17"
title: "7.2. Amlogic C3 Image Signal Processing (C3ISP) driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/c3-isp.html
fetched_at: 2026-09-16T16:32:09+00:00
---
...
video device node using the [V4L2_META_FMT_C3ISP_PARAMS](../../userspace-api/media/v4l/metafmt-c3-isp.md#v4l2-meta-fmt-c3isp-params) as data format. The buffer structure is defined by
[`c3_isp_params_cfg`](../../userspace-api/media/v4l/metafmt-c3-isp.md#c.c3_isp_params_cfg "c3_isp_params_cfg").

Statistics are captured from the c3-isp-stats video device node using the
[V4L2_META_FMT_C3ISP_STATS](../../userspace-api/media/v4l/metafmt-c3-isp.md#v4l2-meta-fmt-c3isp-stats) data format.
...
The Amlogic C3 ISP is supported by [libcamera](https://libcamera.org) with a
