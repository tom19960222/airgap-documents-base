...
collection: kernel
version: "6.17"
title: "7.9. Intel Image Processing Unit 6 (IPU6) Input System driver"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/ipu6-isys.html
fetched_at: 2026-09-16T16:33:31+00:00
---
# 7.9. Intel Image Processing Unit 6 (IPU6) Input System driver
...
> **Note:**
>
> See [Intel IPU6 Driver](../../driver-api/media/drivers/ipu6.md) for more
> information about the IPU6 hardware.

## 7.9.2. Input system driver
...
![ipu6 isys media graph with multiple streams support](../../_images/ipu6_isys_graph.svg)
...
### 7.9.2.1. Capturing frames with IPU6 ISYS
...
media-ctl [[1]](ipu6-isys.md#f1) and yavta [[2]](ipu6-isys.md#f2) to transmit frames to IPU6 ISYS.
...
<https://git.ideasonboard.org/media-ctl.git>
