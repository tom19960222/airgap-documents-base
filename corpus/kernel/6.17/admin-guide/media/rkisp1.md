...
collection: kernel
version: "6.17"
title: "7.17. Rockchip Image Signal Processor (rkisp1)"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/media/rkisp1.html
fetched_at: 2026-09-16T16:34:37+00:00
---
...
later SoCs. Revisions can be found in the enum [`rkisp1_cif_isp_version`](../../userspace-api/media/v4l/metafmt-rkisp1.md#c.rkisp1_cif_isp_version "rkisp1_cif_isp_version")
...
### 7.17.3.1. rkisp1_mainpath, rkisp1_selfpath - Frames Capture Video Nodes
...
the `V4L2_CAP_IO_MC` [capability](../../userspace-api/media/v4l/vidioc-querycap.md#device-capabilities).

### 7.17.3.2. rkisp1_resizer_mainpath, rkisp1_resizer_selfpath - Resizers Subdevices Nodes
...
### 7.17.3.3. rkisp1_isp - Image Signal Processing Subdevice Node
...
### 7.17.3.4. rkisp1_stats - Statistics Video Node
...
video stream.
The buffer format is defined by struct [`rkisp1_stat_buffer`](../../userspace-api/media/v4l/metafmt-rkisp1.md#c.rkisp1_stat_buffer "rkisp1_stat_buffer"), and
userspace should set
[V4L2_META_FMT_RK_ISP1_STAT_3A](../../userspace-api/media/v4l/metafmt-rkisp1.md#v4l2-meta-fmt-rk-isp1-stat-3a) as the
dataformat.

### 7.17.3.5. rkisp1_params - Parameters Video Node
...
[`rkisp1_params_cfg`](../../userspace-api/media/v4l/metafmt-rkisp1.md#c.rkisp1_params_cfg "rkisp1_params_cfg"), and userspace should set
[V4L2_META_FMT_RK_ISP1_PARAMS](../../userspace-api/media/v4l/metafmt-rkisp1.md#v4l2-meta-fmt-rk-isp1-params) as the
dataformat.

When using the extensible parameters method the buffer format is defined by
struct [`rkisp1_ext_params_cfg`](../../userspace-api/media/v4l/metafmt-rkisp1.md#c.rkisp1_ext_params_cfg "rkisp1_ext_params_cfg"), and userspace should set
[V4L2_META_FMT_RK_ISP1_EXT_PARAMS](../../userspace-api/media/v4l/metafmt-rkisp1.md#v4l2-meta-fmt-rk-isp1-ext-params) as
the dataformat.

## 7.17.4. Capturing Video Frames Example
...
## 7.17.5. Configuring Quantization
