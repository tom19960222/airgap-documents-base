...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/cgroup-v2.html
...
v1 is available under [Documentation/admin-guide/cgroup-v1/index.rst](cgroup-v1/index.md#cgroup-v1).
...
>     [Documentation/accounting/psi.rst](../accounting/psi.md#psi) for details.
...
check out [Documentation/scheduler/sched-ext.rst](../scheduler/sched-ext.md#sched-ext).
...
2. the process has CAP_SYS_ADMIN against the target cgroup
   namespace’s userns
