...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/thermal/intel_powerclamp.html
fetched_at: 2026-09-16T16:49:26+00:00
---
# Intel Powerclamp Driver

By:
:   - Arjan van de Ven <[arjan@linux.intel.com](mailto:arjan%40linux.intel.com)>
    - Jacob Pan <[jacob.jun.pan@linux.intel.com](mailto:jacob.jun.pan%40linux.intel.com)>
...
1. determine the effective range of idle injection ratio
2. determine the amount of compensation needed at each target ratio

Compensation to each target ratio consists of two parts:

> 1. steady state error compensation
>
>    This is to offset the error occurring when the system can
>    enter idle without extra wakeups (such as external interrupts).
> 2. dynamic error compensation
>
