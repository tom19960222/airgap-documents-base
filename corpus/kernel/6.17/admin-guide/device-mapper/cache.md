...
version: "6.17"
title: "Cache"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/device-mapper/cache.html
fetched_at: 2026-09-16T16:48:28+00:00
---
# Cache
...
messages are used. Refer to [Guidance for writing policies](cache-policies.md).
...
> | policy args | key/value pairs passed to the policy E.g. ‘sequential_threshold 1024’ See [Guidance for writing policies](cache-policies.md) for details. |
...
| cache metadata mode | ro if read-only, rw if read-write  In serious cases where even a read-only mode is deemed unsafe no further I/O will be permitted and the status will just contain the string ‘Fail’. The userspace recovery tools should then be used. |
