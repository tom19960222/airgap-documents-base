...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/serial-console.html
...
7. Thanks
   ...
   Thanks to Geert Uytterhoeven <[geert@linux-m68k.org](mailto:geert%40linux-m68k.org)>
   for porting the patches from 2.1.4x to 2.1.6x for taking care of
   the integration of these patches into m68k, ppc and alpha.

Miquel van Smoorenburg <[miquels@cistron.nl](mailto:miquels%40cistron.nl)>, 11-Jun-2000
