...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/damon/start.html
fetched_at: 2026-09-16T16:54:32+00:00
---
English

- [Chinese (Simplified)](../../../translations/zh_CN/admin-guide/mm/damon/start.md)
- [Chinese (Traditional)](../../../translations/zh_TW/admin-guide/mm/damon/start.md)

# Getting Started

This document briefly describes how you can use DAMON by demonstrating its
default user space tool. Please note that this document describes only a part
of its features for brevity. Please refer to the usage [doc](https://github.com/damonitor/damo/blob/next/USAGE.md) of the tool for more
details.
...
Because DAMO is using the sysfs interface (refer to [Detailed Usages](usage.md) for the
detail) of DAMON, you should ensure [sysfs](../../../filesystems/sysfs.md) is
mounted.
