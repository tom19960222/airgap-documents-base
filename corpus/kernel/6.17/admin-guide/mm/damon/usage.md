...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/damon/usage.html
fetched_at: 2026-09-16T16:54:33+00:00
---
English

- [Chinese (Simplified)](../../../translations/zh_CN/admin-guide/mm/damon/usage.md)
- [Chinese (Traditional)](../../../translations/zh_TW/admin-guide/mm/damon/usage.md)
...
- *DAMON user space tool.*
  [This](https://github.com/damonitor/damo) is for privileged people such as
  system administrators who want a just-working human-friendly interface.
  Using this, users can use the DAMON’s major features in a human-friendly way.
  It may not be highly tuned for special cases, though. For more detail,
  please refer to its [usage document](https://github.com/damonitor/damo/blob/next/USAGE.md).
- *sysfs interface.*
  [This](usage.md#sysfs-interface) is for privileged user space programmers who
  want more optimized use of DAMON. Using this, users can use DAMON’s major
  features by reading from and writing to special sysfs files. Therefore,
  you can write and use your personalized DAMON sysfs wrapper programs that
  reads/writes the sysfs files instead of you. The [DAMON user space tool](https://github.com/damonitor/damo) is one example of such programs.
- *Kernel Space Programming Interface.*
  [This](../../../mm/damon/api.md) is for kernel space programmers. Using this,
  users can utilize every feature of DAMON most flexibly and efficiently by
  writing kernel space DAMON application programs for you. You can even extend
  DAMON for various address spaces. For detail, please refer to the interface
  [document](../../../mm/damon/api.md).
...
[design](../../../mm/damon/design.md#damon-design-execution-model-and-data-structures) for more
...
- `update_tuned_intervals`: Update the contents of `sample_us` and
  ...
  [intervals_goal section](usage.md#damon-usage-sysfs-monitoring-intervals-goal)
  for more details.
- `commit_schemes_quota_goals`: Read the DAMON-based operation schemes’
  [quota goals](usage.md#sysfs-schemes-quota-goals).
- `update_schemes_stats`: Update the contents of stats files for each
  DAMON-based operation scheme of the kdamond. For details of the stats,
  please refer to [stats section](usage.md#sysfs-schemes-stats).
- `update_schemes_tried_regions`: Update the DAMON-based operation scheme
  ...
  [tried_regions section](usage.md#sysfs-schemes-tried-regions).
...
- `update_schemes_effective_quotas`: Update the contents of
  ...
  kdamond. For more details, refer to [quotas directory](usage.md#sysfs-quotas).
...
DAMON supports multiple types of [monitoring operations](../../../mm/damon/design.md#damon-design-configurable-operations-set), including those for virtual address
...
list different available operation sets. Please refer to the [design](../../../mm/damon/design.md#damon-operations-set) for the list of all available operation sets and their
brief explanations.
...
to the Design document ([Design](../../../mm/damon/design.md)).
...
Please refer to the [design document of the feature](../../../mm/damon/design.md#damon-design-monitoring-intervals-autotuning) for the internal of the tuning
...
monitoring region to specific address ranges. Please refer to the [design](../../../mm/damon/design.md#damon-design-vaddr-target-regions-construction) for more details.
...
The directory for DAMON-based Operation Schemes ([DAMOS](../../../mm/damon/design.md#damon-design-damos)). Users can get and set the schemes by reading from and
...
The `action` file is for setting and getting the scheme’s [action](../../../mm/damon/design.md#damon-design-damos-action). The keywords that can be written to and read
from the file and their meaning are same to those of the list on
[design doc](../../../mm/damon/design.md#damon-design-damos-action).
...
[apply_interval](../../../mm/damon/design.md#damon-design-damos) in microseconds.

### schemes/<N>/access_pattern/

The directory for the target access [pattern](../../../mm/damon/design.md#damon-design-damos-access-pattern) of the given DAMON-based operation scheme.
...
The directory for the [quotas](../../../mm/damon/design.md#damon-design-damos-quotas) of the given
...
quota limits unless at least one [goal](usage.md#sysfs-schemes-quota-goals) is
set.

The time quota is internally transformed to a size quota. Between the
transformed size quota and user-specified size quota, smaller one is applied.
Based on the user-specified [goal](usage.md#sysfs-schemes-quota-goals), the
...
You can set the [prioritization weights](../../../mm/damon/design.md#damon-design-damos-quotas-prioritization) for size, access frequency, and age
in per-thousand unit by writing the values to the three files under the
`weights` directory.

### schemes/<N>/quotas/goals/

The directory for the [automatic quota tuning goals](../../../mm/damon/design.md#damon-design-damos-quotas-auto-tuning) of the given DAMON-based operation
scheme.
...
[design doc](../../../mm/damon/design.md#damon-design-damos-quotas-auto-tuning) by writing to and
reading from each of the files. Note that users should further write
`commit_schemes_quota_goals` to the `state` file of the [kdamond
directory](usage.md#sysfs-kdamond) to pass the feedback to DAMON.

### schemes/<N>/watermarks/

The directory for the [watermarks](../../../mm/damon/design.md#damon-design-damos-watermarks) of the
...
Directories for [filters](../../../mm/damon/design.md#damon-design-damos-filters) of the given
DAMON-based operation scheme.
...
Refer to [the design doc](../../../mm/damon/design.md#damon-design-damos-filters) for available type
...
Refer to the [DAMOS filters design documentation](../../../mm/damon/design.md#damon-design-damos-filters) for more details including how multiple filters
...
online analysis or tuning of the schemes. Refer to [design doc](../../../mm/damon/design.md#damon-design-damos-stat) for more details about the stats.
...
this directory, during next [apply interval](../../../mm/damon/design.md#damon-design-damos) of the
...
Please note that it’s highly recommended to use user space tools like [damo](https://github.com/damonitor/damo) rather than manually reading and writing
the files as above. Above is only for an example.

## Tracepoints for Monitoring Results

Users can get the monitoring results via the [tried_regions](usage.md#sysfs-schemes-tried-regions). The interface is useful for getting a
...
Scheme ([DAMOS](../../../mm/damon/design.md#damon-design-damos)) is gonna be applied. Hence,
`damon:damos_before_apply` is more useful for recording internal behavior of
DAMOS, or DAMOS target access
[pattern](../../../mm/damon/design.md#damon-design-damos-access-pattern) based query-like efficient
...
[design](../../../mm/damon/design.md#damon-design-region-based-sampling) for more details of the
counter). Finally the tenth field (`X`) shows the `age` of the region
(refer to [design](../../../mm/damon/design.md#damon-design-age-tracking) for more details of the
counter).
