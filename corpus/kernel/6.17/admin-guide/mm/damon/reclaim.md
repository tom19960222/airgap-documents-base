...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/damon/reclaim.html
fetched_at: 2026-09-16T16:54:34+00:00
---
English

- [Chinese (Simplified)](../../../translations/zh_CN/admin-guide/mm/damon/reclaim.md)
- [Chinese (Traditional)](../../../translations/zh_TW/admin-guide/mm/damon/reclaim.md)
...
minimal performance degradation [[1]](reclaim.md#id4) [[2]](reclaim.md#id5) .

Free Pages Reporting [[3]](reclaim.md#id6) based memory over-commit virtualization systems are
...
the DAMON documentation ([Detailed Usages](usage.md)) for more detail.
...
refer to the DAMON documentation ([Detailed Usages](usage.md)) for more detail.
...
Please refer to the DAMON documentation ([Detailed Usages](usage.md)) for more detail.
