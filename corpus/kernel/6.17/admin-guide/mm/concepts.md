...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/concepts.html
fetched_at: 2026-09-16T16:48:10+00:00
---
# Concepts overview
...
- [Virtual Memory Primer](concepts.md#virtual-memory-primer)
- [Huge Pages](concepts.md#huge-pages)
- [Zones](concepts.md#zones)
- [Nodes](concepts.md#nodes)
- [Page cache](concepts.md#page-cache)
- [Anonymous Memory](concepts.md#anonymous-memory)
- [Reclaim](concepts.md#reclaim)
- [Compaction](concepts.md#compaction)
- [OOM killer](concepts.md#oom-killer)

## [Virtual Memory Primer](concepts.md#id1)
...
name. See [Transparent Hugepage Support](transhuge.md) for more details
about THP.

## [Zones](concepts.md#id3)
...
[What is NUMA?](../../mm/numa.md)` and in
[NUMA Memory Policy](numa_memory_policy.md).

## [Page cache](concepts.md#id5)
...
## [Anonymous Memory](concepts.md#id6)
