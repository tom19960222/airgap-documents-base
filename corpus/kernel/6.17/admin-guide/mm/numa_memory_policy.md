...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/numa_memory_policy.html
...
takes priority. See [Memory Policies and cpusets](numa_memory_policy.md#mem-pol-and-cpusets)
...
:   this is an optional, per-task policy. When defined for a
    ...
    [Memory Policy APIs](numa_memory_policy.md#memory-policy-apis) section,
...
:   Conceptually, shared policies apply to “memory objects” mapped
    ...
    As mentioned above in [VMA policies](numa_memory_policy.md#vma-policy) section,
