...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/ksm.html
fetched_at: 2026-09-16T16:33:57+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/admin-guide/mm/ksm.md)
- [Chinese (Traditional)](../../translations/zh_TW/admin-guide/mm/ksm.md)
...
and the time between the passes are configured using [sysfs
interface](ksm.md#ksm-sysfs)
...
will exceed `vm.max_map_count` (see [Documentation for /proc/sys/vm/](../sysctl/vm.md)).
