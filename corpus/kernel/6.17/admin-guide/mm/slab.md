...
collection: kernel
version: "6.17"
title: "Short users guide for the slab allocator"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/mm/slab.html
...
2. Pre-process those STATS files:
   ...
   ```
3. Execute `slabinfo-gnuplot.sh` in ‘-t’ mode, passing all of the
   ...
   2. `-r %d,%d` -- specifies a range of samples to use (for example,
