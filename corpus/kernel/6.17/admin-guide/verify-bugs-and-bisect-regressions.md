...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/verify-bugs-and-bisect-regressions.html
fetched_at: 2026-09-16T16:22:35+00:00
---
...
over to the* ‘[step-by-step guide](verify-bugs-and-bisect-regressions.md#introguide-bissbs)’ *below. It utilizes
...
- **Segment 2**: ensure the ‘good’ kernel is also a ‘working’ kernel.
  ...
  1. Start by checking out the sources of the ‘good’ version:
     ...
     ```
  2. Build, install, and boot a kernel as described earlier in *segment 1,
     section b* -- just feel free to skip the ‘du’ commands, as you have a rough
     estimate already.
  3. Ensure the feature that regressed with the ‘broken’ kernel actually works
     with this one.
- **Segment 3**: perform and validate the bisection.
  ...
  2. Initialize the bisection:
     ...
     ```
  3. Build, install, and boot a kernel as described earlier in *segment 1,
     section b*.
...
- **Complementary tasks**: cleanup during and after the process.
  ...
  1. To avoid running out of disk space during a bisection, you might need to
  ...
  2. If you performed a bisection and successfully validated the result, feel
...
> [Preparations: set up everything to build your own kernels](verify-bugs-and-bisect-regressions.md#introprep-bissbs).
>
> [Segment 1: try to reproduce the problem with the latest codebase](verify-bugs-and-bisect-regressions.md#introlatestcheck-bissbs).
>
> [Segment 2: check if the kernels you build work fine](verify-bugs-and-bisect-regressions.md#introworkingcheck-bissbs).
>
> [Segment 3: perform a bisection and validate the result](verify-bugs-and-bisect-regressions.md#introbisect-bissbs).
>
> [Complementary tasks: cleanup during and after following this guide](verify-bugs-and-bisect-regressions.md#introclosure-bissbs).
>
> [Optional tasks: test reverts, patches, or later versions](verify-bugs-and-bisect-regressions.md#introoptional-bissbs).
...
out [Reporting issues](reporting-issues.md), which works in conjunction
...
as a regression check out [Reporting regressions](reporting-regressions.md).

If you run into any problems while following this guide or have ideas how to
improve it, [please let the kernel developers know](verify-bugs-and-bisect-regressions.md#submit-improvements-vbbr).
...
[Build kernels on a different machine](verify-bugs-and-bisect-regressions.md#buildhost-bis) below.

- Create a fresh backup and put system repair and restore tools at hand, just
  to be prepared for the unlikely case of something going sideways.

  [[details](verify-bugs-and-bisect-regressions.md#backup-bisref)]
...
- Remove all software that depends on externally developed kernel drivers or
  ...
  [[details](verify-bugs-and-bisect-regressions.md#vanilla-bisref)]
...
- On platforms with ‘Secure Boot’ or similar solutions, prepare everything to
  ...
  [[details](verify-bugs-and-bisect-regressions.md#secureboot-bisref)]
...
- Determine the kernel versions considered ‘good’ and ‘bad’ throughout this
  ...
  *Note, do not confuse ‘good’ version with ‘working’ kernel; the latter term
  ...
  [[details](verify-bugs-and-bisect-regressions.md#rangecheck-bisref)]

- Boot into the ‘working’ kernel and briefly use the apparently broken feature.

  [[details](verify-bugs-and-bisect-regressions.md#bootworking-bisref)]
...
- Ensure to have enough free space for building Linux. 15 Gigabyte in your home
  ...
  [[details](verify-bugs-and-bisect-regressions.md#diskspace-bisref)]
...
- Install all software required to build a Linux kernel. Often you will need:
  ...
  [[details](verify-bugs-and-bisect-regressions.md#buildrequires-bisref)]
...
- Retrieve the mainline Linux sources; then change into the directory holding
  ...
  *Note, the following describe how to retrieve the sources using a full
  ...
  [reference section describes two alternatives](verify-bugs-and-bisect-regressions.md#sources-bisref) *:
  ...
  [[details](verify-bugs-and-bisect-regressions.md#sources-bisref)]
...
- Start preparing a kernel build configuration (the ‘.config’ file).
  ...
  [[details](verify-bugs-and-bisect-regressions.md#oldconfig-bisref)]
...
- Disable any kernel modules apparently superfluous for your setup. This is
  ...
  [[details](verify-bugs-and-bisect-regressions.md#localmodconfig-bisref)]
...
- Ensure all the kernels you will build are clearly identifiable using a special
  ...
  [[details](verify-bugs-and-bisect-regressions.md#tagging-bisref)]
...
- Decide how to handle debug symbols.
  ...
  [[details](verify-bugs-and-bisect-regressions.md#debugsymbols-bisref)]
...
- Check if you may want or need to adjust some other kernel configuration
  ...
  - Are you running Debian? Then you want to avoid known problems by performing
    ...
    [[details](verify-bugs-and-bisect-regressions.md#configmods-distros-bisref)].
  - If you want to influence other aspects of the configuration, do so now using
    ...
    [[details](verify-bugs-and-bisect-regressions.md#configmods-individual-bisref)].
...
- Reprocess the .config after the latest adjustments and store it in a safe
  ...
  [[details](verify-bugs-and-bisect-regressions.md#saveconfig-bisref)]
...
be a waste of time. [[details](verify-bugs-and-bisect-regressions.md#introlatestcheck-bisref)]

- Check out the latest Linux codebase.

  - Are your ‘good’ and ‘bad’ versions from the same stable or longterm series?
    Then check the [front page of kernel.org](https://kernel.org/): if it
  ...
  [[details](verify-bugs-and-bisect-regressions.md#checkoutmaster-bisref)]
...
- Build the image and the modules of your first kernel using the config file you
  ...
  [[details](verify-bugs-and-bisect-regressions.md#build-bisref)]
...
- Install your newly built kernel.
  ...
  [[details](verify-bugs-and-bisect-regressions.md#install-bisref)]
...
- In case you plan to follow this guide further, check how much storage space
  ...
  [[details](verify-bugs-and-bisect-regressions.md#storagespace-bisref)]
...
- Check if the kernel marked itself as ‘tainted’:
  ...
  [[details](verify-bugs-and-bisect-regressions.md#tainted-bisref)]
...
- Verify if your bug occurs with the newly built kernel. If it does not, check
  ...
  [[details](verify-bugs-and-bisect-regressions.md#recheckbroken-bisref)]
...
- Did you just built a stable or longterm kernel? And were you able to reproduce
  ...
  stable team. See [Reporting issues](reporting-issues.md) for details.

  [[details](verify-bugs-and-bisect-regressions.md#recheckstablebroken-bisref)]
...
otherwise would be a waste of time. [[details](verify-bugs-and-bisect-regressions.md#introworkingcheck-bisref)]
...
- Build your own variant of the ‘working’ kernel and check if the feature that
  ...
  [[details](verify-bugs-and-bisect-regressions.md#recheckworking-bisref)]
...
- Start the bisection and tell Git about the versions earlier established as
  ...
  [[details](verify-bugs-and-bisect-regressions.md#bisectstart-bisref)]
...
- Now use the code Git checked out to build, install, and boot a kernel using
  ...
  [[details](verify-bugs-and-bisect-regressions.md#bisectbuild-bisref)]
...
- Now check if the feature that regressed works in the kernel you just built.
  ...
  [[details](verify-bugs-and-bisect-regressions.md#bisecttest-bisref)]
...
- Store Git’s bisection log and the current .config file in a safe place before
  ...
  [[details](verify-bugs-and-bisect-regressions.md#bisectlog-bisref)]
...
- Try reverting the culprit on top of latest mainline to see if this fixes your
  ...
  - In all other cases check out latest mainline:
    ...
    the top which looks like ‘[commit cafec0cacaca0](https://git.kernel.org/torvalds/c/cafec0cacaca0) upstream.’ or
    ‘Upstream [commit cafec0cacaca0](https://git.kernel.org/torvalds/c/cafec0cacaca0)’; use that commit-id in the next command
  ...
  [[details](verify-bugs-and-bisect-regressions.md#revert-bisref)]
...
- To remove one of the kernels you installed, look up its ‘kernelrelease’
  ...
  [[details](verify-bugs-and-bisect-regressions.md#makeroom-bisref)]
...
- Once you have finished the bisection, do not immediately remove anything you
  ...
  [[details](verify-bugs-and-bisect-regressions.md#finishingtouch-bisref)]
...
[[details](verify-bugs-and-bisect-regressions.md#introoptional-bisref)]
...
document know by email (Thorsten Leemhuis <[linux@leemhuis.info](mailto:linux%40leemhuis.info)>), ideally while
CCing the Linux docs mailing list ([linux-doc@vger.kernel.org](mailto:linux-doc%40vger.kernel.org)). Such feedback is
...
> [[...](verify-bugs-and-bisect-regressions.md#introprep-bissbs)]

The steps in all later sections of this guide depend on those described here.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introprep-bissbs)].

#### Prepare for emergencies

> *Create a fresh backup and put system repair and restore tools at hand.*
> [[...](verify-bugs-and-bisect-regressions.md#backup-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#backup-bissbs)]

#### Remove anything related to externally maintained kernel modules

> *Remove all software that depends on externally developed kernel drivers or
> builds them automatically.* [[...](verify-bugs-and-bisect-regressions.md#vanilla-bissbs)]
...
considered ‘vanilla’ anymore, as [Reporting issues](reporting-issues.md)
explains in more detail.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#vanilla-bissbs)]

#### Deal with techniques like Secure Boot

> *On platforms with ‘Secure Boot’ or similar techniques, prepare everything to
> ensure the system will permit your self-compiled kernel to boot later.*
> [[...](verify-bugs-and-bisect-regressions.md#secureboot-bissbs)]
...
its purpose; ‘[Kernel module signing facility](module-signing.md)’ and various web
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#secureboot-bissbs)]

#### Boot the last kernel that was working

> *Boot into the last working kernel and briefly recheck if the feature that
> regressed really works.* [[...](verify-bugs-and-bisect-regressions.md#bootworking-bissbs)]

This will make later steps that cover creating and trimming the configuration do
the right thing.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#bootworking-bissbs)]

#### Space requirements

> *Ensure to have enough free space for building Linux.*
> [[...](verify-bugs-and-bisect-regressions.md#diskspace-bissbs)]

The numbers mentioned are rough estimates with a big extra charge to be on the
safe side, so often you will need less.

If you have space constraints, be sure to hay attention to the [step about
debug symbols’](verify-bugs-and-bisect-regressions.md#debugsymbols-bissbs) and its [accompanying reference
section’](verify-bugs-and-bisect-regressions.md#debugsymbols-bisref), as disabling then will reduce the consumed disk
space by quite a few gigabytes.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#diskspace-bissbs)]

#### Bisection range

> *Determine the kernel versions considered ‘good’ and ‘bad’ throughout this
> guide.* [[...](verify-bugs-and-bisect-regressions.md#rangecheck-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#rangecheck-bissbs)]

#### Install build requirements

> *Install all software required to build a Linux kernel.*
> [[...](verify-bugs-and-bisect-regressions.md#buildrequires-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#buildrequires-bissbs)]

#### Download the sources using Git

> *Retrieve the Linux mainline sources.*
> [[...](verify-bugs-and-bisect-regressions.md#sources-bissbs)]
...
- If you have an unreliable internet connection, consider
  [using a ‘Git bundle’](verify-bugs-and-bisect-regressions.md#sources-bundle-bisref).
- If downloading the complete repository would take too long or requires too
  much storage space, consider [using a ‘shallow
  clone’](verify-bugs-and-bisect-regressions.md#sources-shallow-bisref).
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#sources-bissbs)]
[[back to section intro](verify-bugs-and-bisect-regressions.md#sources-bisref)]
...
> *Start preparing a kernel build configuration (the ‘.config’ file).*
> [[...](verify-bugs-and-bisect-regressions.md#oldconfig-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#oldconfig-bissbs)]

#### Trim the build configuration for your kernel

> *Disable any kernel modules apparently superfluous for your setup.*
> [[...](verify-bugs-and-bisect-regressions.md#localmodconfig-bissbs)]
...
a few weeks. You can automate this with [modprobed-db](https://github.com/graysky2/modprobed-db). Afterwards use `LSMOD=<path>` to
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#localmodconfig-bissbs)]

#### Tag the kernels about to be build

> *Ensure all the kernels you will build are clearly identifiable using a
> special tag and a unique version identifier.* [[...](verify-bugs-and-bisect-regressions.md#tagging-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#tagging-bissbs)]

#### Decide to enable or disable debug symbols

> *Decide how to handle debug symbols.* [[...](verify-bugs-and-bisect-regressions.md#debugsymbols-bissbs)]
...
‘Decode failure messages’ in [Reporting issues](reporting-issues.md)
explains this process in more detail.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#debugsymbols-bissbs)]
...
> *Are you running* [[...](verify-bugs-and-bisect-regressions.md#configmods-bissbs)]
...
- Remove a stale reference to a certificate file that would cause your build to
  ...
  option point to it, as [the Debian handbook explains in more detail](https://debian-handbook.info/browse/stable/sect.kernel-compilation.html)
  -- or generate your own, as explained in
  [Kernel module signing facility](module-signing.md).

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#configmods-bissbs)]

##### Individual adjustments

> *If you want to influence the other aspects of the configuration, do so
> now.* [[...](verify-bugs-and-bisect-regressions.md#configmods-bissbs)]
...
> [[...](verify-bugs-and-bisect-regressions.md#saveconfig-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#saveconfig-bissbs)]
...
> still occurs with the latest codebase.* [[...](verify-bugs-and-bisect-regressions.md#introlatestcheck-bissbs)]
...
- These steps will rule out if your problem is caused by some change in the
  ...
  [Reporting regressions](reporting-regressions.md) explains in more detail.
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introlatestcheck-bissbs)]

#### Check out the latest Linux codebase

> *Check out the latest Linux codebase.*
> [[...](verify-bugs-and-bisect-regressions.md#checkoutmaster-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#checkoutmaster-bissbs)]

#### Build your kernel

> *Build the image and the modules of your first kernel using the config file
> you prepared.* [[...](verify-bugs-and-bisect-regressions.md#build-bissbs)]
...
lists via [lore.kernel.org/all/](https://lore.kernel.org/all/).
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#build-bissbs)]

#### Put the kernel in place

> *Install the kernel you just built.* [[...](verify-bugs-and-bisect-regressions.md#install-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#install-bissbs)]

#### Storage requirements per kernel

> *Check how much storage space the kernel, its modules, and other related files
> like the initramfs consume.* [[...](verify-bugs-and-bisect-regressions.md#storagespace-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#storagespace-bissbs)]

#### Check if your newly built kernel considers itself ‘tainted’

> *Check if the kernel marked itself as ‘tainted’.*
> [[...](verify-bugs-and-bisect-regressions.md#tainted-bissbs)]
...
[Tainted kernels](tainted-kernels.md); doing so is also in your own
interest, as your testing might be flawed otherwise.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#tainted-bissbs)]

#### Check the kernel built from a recent mainline codebase

> *Verify if your bug occurs with the newly built kernel.*
> [[...](verify-bugs-and-bisect-regressions.md#recheckbroken-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#recheckbroken-bissbs)]
...
> the problem.* [[...](verify-bugs-and-bisect-regressions.md#recheckstablebroken-bissbs)]

If this kernel does not show the regression either, there most likely is no need
for a bisection.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#recheckstablebroken-bissbs)]

### Ensure the ‘good’ version is really working well

> *Check if the kernels you build work fine.*
> [[...](verify-bugs-and-bisect-regressions.md#introworkingcheck-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introworkingcheck-bissbs)]

#### Build your own version of the ‘good’ kernel

> *Build your own variant of the working kernel and check if the feature that
> regressed works as expected with it.* [[...](verify-bugs-and-bisect-regressions.md#recheckworking-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#recheckworking-bissbs)]

### Perform a bisection and validate the result

> *With all the preparations and precaution builds taken care of, you are now
> ready to begin the bisection.* [[...](verify-bugs-and-bisect-regressions.md#introbisect-bissbs)]

The steps in this segment perform and validate the bisection.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introbisect-bissbs)].

#### Start the bisection

> *Start the bisection and tell Git about the versions earlier established as
> ‘good’ and ‘bad’.* [[...](verify-bugs-and-bisect-regressions.md#bisectstart-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#bisectstart-bissbs)]

#### Build a kernel from the bisection point

> *Build, install, and boot a kernel from the code Git checked out using the
> same commands you used earlier.* [[...](verify-bugs-and-bisect-regressions.md#bisectbuild-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#bisectbuild-bissbs)]

#### Bisection checkpoint

> *Check if the feature that regressed works in the kernel you just built.*
> [[...](verify-bugs-and-bisect-regressions.md#bisecttest-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#bisecttest-bissbs)]

#### Put the bisection log away

> *Store Git’s bisection log and the current .config file in a safe place.*
> [[...](verify-bugs-and-bisect-regressions.md#bisectlog-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#bisectlog-bissbs)]

#### Try reverting the culprit

> *Try reverting the culprit on top of the latest codebase to see if this fixes
> your regression.* [[...](verify-bugs-and-bisect-regressions.md#revert-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#revert-bissbs)]
...
> of the kernels you installed.* [[...](verify-bugs-and-bisect-regressions.md#introclosure-bissbs)]

The steps in this section describe clean-up procedures.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introclosure-bissbs)].

#### Cleaning up during the bisection

> *To remove one of the kernels you installed, look up its ‘kernelrelease’
> identifier.* [[...](verify-bugs-and-bisect-regressions.md#makeroom-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#makeroom-bissbs)]
...
> [[...](verify-bugs-and-bisect-regressions.md#finishingtouch-bissbs)]
...
Details on how to perform those can be found in the section [Optional
tasks: test reverts, patches, or later versions](verify-bugs-and-bisect-regressions.md#introoptional-bissbs).

Additional tests are also the reason why you want to keep the
~/kernel-config-working file around for a few weeks.

[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#finishingtouch-bissbs)]
...
> [[...](verify-bugs-and-bisect-regressions.md#introoptional-bissbs)]
...
[[back to step-by-step guide](verify-bugs-and-bisect-regressions.md#introoptional-bissbs)].
...
- After executing ‘[Boot into the working kernel and briefly use the
  apparently broken feature](verify-bugs-and-bisect-regressions.md#bootworking-bissbs)’, save the list of loaded
  modules to a file using `lsmod > ~/test-machine-lsmod`. Then locate the
  build configuration for the running kernel (see ‘[Start defining the
  build configuration for your kernel](verify-bugs-and-bisect-regressions.md#oldconfig-bisref)’ for hints on where
  to find it) and store it as ‘~/test-machine-config-working’. Transfer both
  files to the home directory of your build host.
- Continue the guide on the build host (e.g. with ‘[Ensure to have enough
  free space for building [...]](verify-bugs-and-bisect-regressions.md#diskspace-bissbs)’).
- When you reach ‘[Start preparing a kernel build configuration[...]](verify-bugs-and-bisect-regressions.md#oldconfig-bissbs)’: before running `make olddefconfig` for the first time,
...
- During the next step to ‘[disable any apparently superfluous kernel
  modules](verify-bugs-and-bisect-regressions.md#localmodconfig-bissbs)’ use the following command instead:
...
- Switch to the test machine to check if you have enough space to hold another
  ...
  loader’s configuration](verify-bugs-and-bisect-regressions.md#install-bisref); on some distributions the following
...
- The [man page for ‘git bisect’](https://git-scm.com/docs/git-bisect) and
  [fighting regressions with ‘git bisect’](https://git-scm.com/docs/git-bisect-lk2009.html)
  in the Git documentation.
- [Working with git bisect](https://nathanchance.dev/posts/working-with-git-bisect/)
