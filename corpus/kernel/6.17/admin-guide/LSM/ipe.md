...
collection: kernel
version: "6.17"
title: "Integrity Policy Enforcement (IPE)"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/LSM/ipe.html
fetched_at: 2026-09-16T16:33:28+00:00
---
...
> documentation about IPE please see [the design docs](../../security/ipe.md).
...
Security -> Integrity Policy Enforcement (IPE)) config
option is enabled.
...
The digest_cache LSM [[1]](ipe.md#digest-cache-lsm) is a system that when combined with IPE,
...
(as opposed to compiled executables) [[2]](ipe.md#interpreters).
...
IPE policy is a plain-text [[3]](ipe.md#devdoc) policy composed of multiple statements
...
> > implemented by using switch_root(8) [[4]](ipe.md#switch-root). Therefore the
...
> ```
>
> The supported DigestNames for dmverity_roothash are [[5]](ipe.md#dmveritydigests)
>
> > - blake2b-512
> > - blake2s-256
> > - sha256
...
> ```
>
> The supported DigestNames for fsverity_digest are [[6]](ipe.md#fsveritydigest)
>
> > - sha256
> > - sha512
...
- [Github Repository](https://github.com/microsoft/ipe)
- [Developer and design docs for IPE](../../security/ipe.md)
...
> the two is the policy. [[3]](ipe.md#devdoc)
>
...
<https://lore.kernel.org/lkml/20240415142436.2545003-1-roberto.sassu@huaweicloud.com/>

[[2](ipe.md#id2)]

There is [some interest in solving this issue](https://lore.kernel.org/lkml/20220321161557.495388-1-mic@digikod.net/).

[3]
([1](ipe.md#id3),[2](ipe.md#id7))

Please see [the design docs](../../security/ipe.md) for more on
this topic.
...
These hash algorithms are based on values accepted by
...
These hash algorithms are based on values accepted by the
