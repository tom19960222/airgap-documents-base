...
collection: kernel
version: "6.17"
title: "Landlock: system-wide management"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/LSM/landlock.html
fetched_at: 2026-09-16T16:33:40+00:00
---
...
[`sys_landlock_restrict_self()`](../../userspace-api/landlock.md#c.sys_landlock_restrict_self "sys_landlock_restrict_self") flags (cf.
[Landlock: unprivileged access control](../../userspace-api/landlock.md)). Landlock logs can also be masked
...
:   This record type describes the status of a Landlock domain. The `status`
    ...
    Landlock domain information at the time of the [`sys_landlock_restrict_self()`](../../userspace-api/landlock.md#c.sys_landlock_restrict_self "sys_landlock_restrict_self")
    ...
    [`sys_landlock_restrict_self()`](../../userspace-api/landlock.md#c.sys_landlock_restrict_self "sys_landlock_restrict_self")’s flags.
...
- with [`sys_landlock_restrict_self()`](../../userspace-api/landlock.md#c.sys_landlock_restrict_self "sys_landlock_restrict_self")’s flags if we can fix the sandboxed
  programs,
- or with audit rules (see *auditctl(8)*).
