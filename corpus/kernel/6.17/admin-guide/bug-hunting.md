...
version: "6.17"
title: "Bug hunting"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/bug-hunting.html
fetched_at: 2026-09-16T16:22:36+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/admin-guide/bug-hunting.md)
- [Chinese (Traditional)](../translations/zh_TW/admin-guide/bug-hunting.md)
...
file:[Tainted kernels](tainted-kernels.md), “being loaded” is
...
2. Boot with a serial console (see
   [Documentation/admin-guide/serial-console.rst](serial-console.md#serial-console)),
   run a null modem to a second machine and capture the output there
   using your favourite communication program. Minicom works well.
3. Use Kdump (see [Documentation for Kdump - The kexec-based Crash Dumping Solution](kdump/kdump.md)),
...
- The driver and/or subsystem mailing list ([linux-media@vger.kernel.org](mailto:linux-media%40vger.kernel.org));
- The Linux Kernel mailing list ([linux-kernel@vger.kernel.org](mailto:linux-kernel%40vger.kernel.org));
...
Please do read
[Documentation/process/submitting-patches.rst](../process/submitting-patches.md#submittingpatches) though
