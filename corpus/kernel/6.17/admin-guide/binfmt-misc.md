...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/binfmt-misc.html
fetched_at: 2026-09-16T16:22:52+00:00
---
...
For java support see [Java(tm) Binary Kernel Support for Linux v1.03](java.md)
...
See [Documentation/admin-guide/java.rst](java.md) for an example.

Your interpreter should NOT look in the PATH for the filename; the kernel
passes it the full filename (or the file descriptor) to use. Using `$PATH` can
cause unexpected behaviour and can be a security hazard.

Richard Günther <[rguenth@tat.physik.uni-tuebingen.de](mailto:rguenth%40tat.physik.uni-tuebingen.de)>
