...
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/initrd.html
fetched_at: 2026-09-16T16:22:32+00:00
---
# Using the initial RAM disk (initrd)

Written 1996,2000 by Werner Almesberger <[werner.almesberger@epfl.ch](mailto:werner.almesberger%40epfl.ch)> and
Hans Lermen <[lermen@fgan.de](mailto:lermen%40fgan.de)>
...
discussion of the boot process can be found in [[1]](initrd.md#f1).
...
can try the experimental newlib environment [[2]](initrd.md#f2) to create a small
initrd.
...
is also available via the `pivot_root` utility (see *pivot_root(8)*
man page; `pivot_root` is distributed with util-linux version 2.10h or higher
[[3]](initrd.md#f3)). `pivot_root` moves the current root to a directory under the new
