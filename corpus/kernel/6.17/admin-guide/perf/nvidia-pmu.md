...
collection: kernel
version: "6.17"
title: "NVIDIA Tegra SoC Uncore Performance Monitoring Unit (PMU)"
source_url: https://www.kernel.org/doc/html/v6.17/admin-guide/perf/nvidia-pmu.html
fetched_at: 2026-09-16T16:47:55+00:00
---
...
[Traffic Coverage](nvidia-pmu.md#nvidia-uncore-pmu-traffic-coverage-section) for more info about the PMU
traffic coverage.
...
Please see [Traffic Coverage](nvidia-pmu.md#nvidia-uncore-pmu-traffic-coverage-section) for more info about
...
(RO) write traffic. Please see [Traffic Coverage](nvidia-pmu.md#nvidia-uncore-pmu-traffic-coverage-section)
...
local/remote memory. Please see [Traffic Coverage](nvidia-pmu.md#nvidia-uncore-pmu-traffic-coverage-section)
for more info about the PMU traffic coverage.
