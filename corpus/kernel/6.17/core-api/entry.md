...
collection: kernel
version: "6.17"
title: "Entry/exit handling for exceptions, interrupts, syscalls and KVM"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/entry.html
...
the transition type sections: [Syscalls](entry.md#syscalls), [KVM](entry.md#kvm), [Interrupts and regular
exceptions](entry.md#interrupts-and-regular-exceptions), [NMI and NMI-like exceptions](entry.md#nmi-and-nmi-like-exceptions).
