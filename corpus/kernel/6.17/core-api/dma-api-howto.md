...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/dma-api-howto.html
...
where pool is what you passed to [`dma_pool_alloc()`](dma-api.md#c.dma_pool_alloc "dma_pool_alloc"), and cpu_addr and
dma_handle are the values [`dma_pool_alloc()`](dma-api.md#c.dma_pool_alloc "dma_pool_alloc") returned. This function
...
Make sure you’ve called [`dma_pool_free()`](dma-api.md#c.dma_pool_free "dma_pool_free") for all memory allocated
