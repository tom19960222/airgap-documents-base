...
collection: kernel
version: "6.17"
title: "How to get printk format specifiers right"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/printk-formats.html
fetched_at: 2026-09-16T16:18:54+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/core-api/printk-formats.md)
...
return from [`vsnprintf()`](kernel-api.md#c.vsnprintf "vsnprintf").
...
e.g. procfs or sysfs (using e.g. `seq_printf()`, not [`printk()`](printk-basics.md#c.printk "printk")) read by a
...
For printing error pointers (i.e. a pointer for which [`IS_ERR()`](kernel-api.md#c.IS_ERR "IS_ERR") is true)
...
results in printing a string. For direct use in regular [`vsnprintf()`](kernel-api.md#c.vsnprintf "vsnprintf") the (k)
...
[Documentation for /proc/sys/kernel/](../admin-guide/sysctl/kernel.md) for more details.
...
in [`printk()`](printk-basics.md#c.printk "printk").
...
of flags (see [`string_escape_mem()`](kernel-api.md#c.string_escape_mem "string_escape_mem") kernel documentation for the
details):
...
For printing dentry name; if we race with `d_move()`, the name might
be a mix of old and new ones, but it won’t oops. %pd dentry is a safer
equivalent of %s dentry->d_name.name we used to use, %pd<n> prints `n`
last components. %pD does the same thing for [`struct file`](../filesystems/api-summary.md#c.file "file").
