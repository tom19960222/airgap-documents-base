...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/genericirq.html
fetched_at: 2026-09-16T16:19:17+00:00
---
English
...
void irq_gc_mask_disable_and_ack_set(struct [irq_data](genericirq.md#c.irq_data "irq_data") \*d)
...
int irq_domain_alloc_generic_chips(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*d, const struct [irq_domain_chip_generic_info](genericirq.md#c.irq_domain_chip_generic_info "irq_domain_chip_generic_info") \*info)
...
void irq_domain_remove_generic_chips(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*d)
...
int __irq_alloc_domain_generic_chips(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*d, int irqs_per_chip, int num_ct, const char \*name, irq_flow_handler_t handler, unsigned int clr, unsigned int set, enum [irq_gc_flags](genericirq.md#c.irq_gc_flags "irq_gc_flags") gcflags)
:   Allocate generic chips for an irq domain
...
struct [irq_chip_generic](genericirq.md#c.irq_chip_generic "irq_chip_generic") \*irq_get_domain_generic_chip(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*d, unsigned int hw_irq)
...
`num_ct`
:   Number of irq_chip_type instances associated with each
    chip
...
interrupt thread itself. We can not call [`set_cpus_allowed_ptr()`](../driver-api/basics.md#c.set_cpus_allowed_ptr "set_cpus_allowed_ptr") here as
...
using [`free_irq()`](genericirq.md#c.free_irq "free_irq").
...
example code path is as below: KVM -> IOMMU -> [`irq_set_vcpu_affinity()`](genericirq.md#c.irq_set_vcpu_affinity "irq_set_vcpu_affinity").
...
Undoes the effect of one call to [`disable_irq()`](genericirq.md#c.disable_irq "disable_irq"). If this matches the
...
[`disable_irq()`](genericirq.md#c.disable_irq "disable_irq") and still wake the system as long as the irq has wake
...
Like handle_simple_irq, the caller is expected to handle the ack,
...
Like [`handle_fasteoi_irq()`](genericirq.md#c.handle_fasteoi_irq "handle_fasteoi_irq"), but for use with hierarchy where the irq_chip
...
int generic_handle_domain_irq(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*domain, unsigned int hwirq)
...
int generic_handle_domain_nmi(struct [irq_domain](irq/irq-domain.md#c.irq_domain "irq_domain") \*domain, unsigned int hwirq)
