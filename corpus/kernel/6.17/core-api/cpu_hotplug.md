...
collection: kernel
version: "6.17"
title: "CPU hotplug in the Kernel"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/cpu_hotplug.html
fetched_at: 2026-09-16T16:19:16+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/core-api/cpu_hotplug.md)
...
> - [`cpuhp_setup_state_nocalls()`](cpu_hotplug.md#c.cpuhp_setup_state_nocalls "cpuhp_setup_state_nocalls"), [`cpuhp_setup_state_nocalls_cpuslocked()`](cpu_hotplug.md#c.cpuhp_setup_state_nocalls_cpuslocked "cpuhp_setup_state_nocalls_cpuslocked")
>   and [`cpuhp_setup_state_multi()`](cpu_hotplug.md#c.cpuhp_setup_state_multi "cpuhp_setup_state_multi") only install the callbacks
> - [`cpuhp_setup_state()`](cpu_hotplug.md#c.cpuhp_setup_state "cpuhp_setup_state") and [`cpuhp_setup_state_cpuslocked()`](cpu_hotplug.md#c.cpuhp_setup_state_cpuslocked "cpuhp_setup_state_cpuslocked") install the
...
> - [`cpuhp_remove_state_nocalls()`](cpu_hotplug.md#c.cpuhp_remove_state_nocalls "cpuhp_remove_state_nocalls"), [`cpuhp_remove_state_nocalls_cpuslocked()`](cpu_hotplug.md#c.cpuhp_remove_state_nocalls_cpuslocked "cpuhp_remove_state_nocalls_cpuslocked")
>   and [`cpuhp_remove_multi_state()`](cpu_hotplug.md#c.cpuhp_remove_multi_state "cpuhp_remove_multi_state") only remove the callbacks.
> - [`cpuhp_remove_state()`](cpu_hotplug.md#c.cpuhp_remove_state "cpuhp_remove_state") removes the callbacks and invokes the teardown
...
The @state argument is either a statically allocated state or the state
number which was allocated in the dynamic range by [`cpuhp_setup_state_multi()`](cpu_hotplug.md#c.cpuhp_setup_state_multi "cpuhp_setup_state_multi").
...
> - [`cpuhp_state_add_instance_nocalls()`](cpu_hotplug.md#c.cpuhp_state_add_instance_nocalls "cpuhp_state_add_instance_nocalls") and only adds the instance to the
>   multi-instance state’s node list.
> - [`cpuhp_state_add_instance()`](cpu_hotplug.md#c.cpuhp_state_add_instance "cpuhp_state_add_instance") adds the instance and invokes the startup
...
> - [`cpuhp_state_remove_instance_nocalls()`](cpu_hotplug.md#c.cpuhp_state_remove_instance_nocalls "cpuhp_state_remove_instance_nocalls") only removes the instance from the
>   state’s node list.
> - [`cpuhp_state_remove_instance()`](cpu_hotplug.md#c.cpuhp_state_remove_instance "cpuhp_state_remove_instance") removes the instance and invokes the
...
Same as [`cpuhp_setup_state()`](cpu_hotplug.md#c.cpuhp_setup_state "cpuhp_setup_state") except that it must be invoked from within a
...
Same as [`cpuhp_setup_state()`](cpu_hotplug.md#c.cpuhp_setup_state "cpuhp_setup_state") except that the **startup** callback is not
...
Same as [`cpuhp_setup_state_nocalls()`](cpu_hotplug.md#c.cpuhp_setup_state_nocalls "cpuhp_setup_state_nocalls") except that it must be invoked from
...
[`cpuhp_state_add_instance()`](cpu_hotplug.md#c.cpuhp_state_add_instance "cpuhp_state_add_instance") or [`cpuhp_state_add_instance_nocalls()`](cpu_hotplug.md#c.cpuhp_state_add_instance_nocalls "cpuhp_state_add_instance_nocalls")
...
[`cpuhp_setup_state_multi()`](cpu_hotplug.md#c.cpuhp_setup_state_multi "cpuhp_setup_state_multi").
...
Same as [`cpuhp_state_add_instance_nocalls()`](cpu_hotplug.md#c.cpuhp_state_add_instance_nocalls "cpuhp_state_add_instance_nocalls") except that it must be
...
[`cpuhp_setup_state_multi()`](cpu_hotplug.md#c.cpuhp_setup_state_multi "cpuhp_setup_state_multi"). All instances should have been removed before
