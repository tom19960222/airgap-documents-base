...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/index.html
...
- [Scope-based Cleanup Helpers](cleanup.md)
- [Generic Associative Array Implementation](assoc_array.md)
- [Folio Queue](folio_queue.md)
- [XArray](xarray.md)
...
- [Floating-point API](floating-point.md)
- [Union-Find in Linux](union_find.md)
- [Min Heap API](min_heap.md)
- [Generic parser](parser.md)
- [Linked Lists in Linux](list.md)
...
- [DMA and swiotlb](swiotlb.md)
- [Memory Management APIs](mm-api.md)
- [Cgroup Kernel APIs](cgroup.md)
...
- [Kexec Handover Subsystem](kho/index.md)
