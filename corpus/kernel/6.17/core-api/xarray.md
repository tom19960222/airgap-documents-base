...
version: "6.17"
title: "XArray"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/xarray.html
fetched_at: 2026-09-16T16:19:00+00:00
---
English
...
[`xa_erase()`](xarray.md#c.xa_erase "xa_erase") or [`xa_store()`](xarray.md#c.xa_store "xa_store") with `NULL`) any entry will cause the XArray
...
You can then set entries using [`xa_store()`](xarray.md#c.xa_store "xa_store") and get entries using
[`xa_load()`](xarray.md#c.xa_load "xa_load"). [`xa_store()`](xarray.md#c.xa_store "xa_store") will overwrite any entry with the new entry and
return the previous entry stored at that index. You can unset entries
using [`xa_erase()`](xarray.md#c.xa_erase "xa_erase") or by setting the entry to `NULL` using [`xa_store()`](xarray.md#c.xa_store "xa_store").
There is no difference between an entry that has never been stored to
and one that has been erased with [`xa_erase()`](xarray.md#c.xa_erase "xa_erase"); an entry that has most
...
and calling [`xas_split()`](xarray.md#c.xas_split "xas_split") or calling [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") with xa_lock. The
difference between [`xas_split_alloc()`](xarray.md#c.xas_split_alloc "xas_split_alloc")+[`xas_split()`](xarray.md#c.xas_split "xas_split") and `xas_try_alloc()` is
that [`xas_split_alloc()`](xarray.md#c.xas_split_alloc "xas_split_alloc") + [`xas_split()`](xarray.md#c.xas_split "xas_split") split the entry from the original
order to the new order in one shot uniformly, whereas [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split")
...
assuming `XA_CHUNK_SHIFT` is 6, [`xas_split_alloc()`](xarray.md#c.xas_split_alloc "xas_split_alloc") + [`xas_split()`](xarray.md#c.xas_split "xas_split") need
8 xa_node. [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") splits the order-9 entry into
...
When splitting the order-6 entry and a new xa_node is needed, [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split")
will try to allocate one if possible. As a result, [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") would only
...
use [`__xa_alloc_cyclic()`](xarray.md#c.__xa_alloc_cyclic "__xa_alloc_cyclic") instead.
...
:   Minimal split order [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") can accept
...
[`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") can split a multi-index entry to smaller than **order** - 1 if
no new xa_node is needed. This function provides the minimal order
[`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") supports.

**Return**

the minimal order [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") supports
...
use [`xas_try_split_min_order()`](xarray.md#c.xas_try_split_min_order "xas_try_split_min_order") to get next split order instead of
**order** - 1 if you want to minmize [`xas_try_split()`](xarray.md#c.xas_try_split "xas_try_split") calls.
