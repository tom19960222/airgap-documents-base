...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/cachetlb.html
fetched_at: 2026-09-16T16:19:15+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/core-api/cachetlb.md)
...
> >
> > > 1. the kernel did write to a page that is in the page cache page
> > >    and / or in high memory
> > > 2. the kernel is about to read from a page cache page and user space
...
> > [`folio_flush_mapping()`](mm-api.md#c.folio_flush_mapping "folio_flush_mapping") returns a mapping, and `mapping_mapped()` on that
