...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/timekeeping.html
fetched_at: 2026-09-16T16:19:05+00:00
---
# ktime accessors

Device drivers can read the current time using [`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get") and the many
...
:   CLOCK_BOOTTIME
    ...
    Like [`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get"), but does not stop when suspended. This can be
...
:   > CLOCK_TAI
    ...
    Like [`ktime_get_real()`](timekeeping.md#c.ktime_get_real "ktime_get_real"), but uses the International Atomic Time (TAI)
...
:   CLOCK_MONOTONIC_RAW
    ...
    Like [`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get"), but runs at the same rate as the hardware
...
:   Use [`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get") or [`ktime_get_ts64()`](timekeeping.md#c.ktime_get_ts64 "ktime_get_ts64") instead.
...
:   [`ktime_get_real_ts64()`](timekeeping.md#c.ktime_get_real_ts64 "ktime_get_real_ts64") is a direct replacement, but consider using
    monotonic time ([`ktime_get_ts64()`](timekeeping.md#c.ktime_get_ts64 "ktime_get_ts64")) and/or a ktime_t based interface
    ([`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get")/[`ktime_get_real()`](timekeeping.md#c.ktime_get_real "ktime_get_real")).
...
:   These are replaced by [`ktime_get_coarse_real_ts64()`](timekeeping.md#c.ktime_get_coarse_real_ts64 "ktime_get_coarse_real_ts64") and
    [`ktime_get_coarse_ts64()`](timekeeping.md#c.ktime_get_coarse_ts64 "ktime_get_coarse_ts64"). However, A lot of code that wants
...
:   These are replaced by [`ktime_get_raw()`](timekeeping.md#c.ktime_get_raw "ktime_get_raw")/[`ktime_get_raw_ts64()`](timekeeping.md#c.ktime_get_raw_ts64 "ktime_get_raw_ts64"),
    [`ktime_get_clocktai()`](timekeeping.md#c.ktime_get_clocktai "ktime_get_clocktai")/[`ktime_get_clocktai_ts64()`](timekeeping.md#c.ktime_get_clocktai_ts64 "ktime_get_clocktai_ts64") as well
    as [`ktime_get_boottime()`](timekeeping.md#c.ktime_get_boottime "ktime_get_boottime")/[`ktime_get_boottime_ts64()`](timekeeping.md#c.ktime_get_boottime_ts64 "ktime_get_boottime_ts64").
    However, if the particular choice of clock source is not
    important for the user, consider converting to
    [`ktime_get()`](timekeeping.md#c.ktime_get "ktime_get")/[`ktime_get_ts64()`](timekeeping.md#c.ktime_get_ts64 "ktime_get_ts64") instead for consistency.
