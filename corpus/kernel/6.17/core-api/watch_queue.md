...
collection: kernel
version: "6.17"
title: "General notification mechanism"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/watch_queue.html
fetched_at: 2026-09-16T16:18:53+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/core-api/watch_queue.md)
...
- [Overview](watch_queue.md#overview)
- [Message Structure](watch_queue.md#message-structure)
- [Watch List (Notification Source) API](watch_queue.md#watch-list-notification-source-api)
- [Watch Queue (Notification Output) API](watch_queue.md#watch-queue-notification-output-api)
- [Watch Subscription API](watch_queue.md#watch-subscription-api)
- [Notification Posting API](watch_queue.md#notification-posting-api)
- [Watch Sources](watch_queue.md#watch-sources)
- [Event Filtering](watch_queue.md#event-filtering)
- [Userspace Code Example](watch_queue.md#userspace-code-example)

## [Overview](watch_queue.md#id1)
...
## [Message Structure](watch_queue.md#id2)
...
## [Watch List (Notification Source) API](watch_queue.md#id3)
...
## [Watch Queue (Notification Output) API](watch_queue.md#id4)
...
## [Watch Subscription API](watch_queue.md#id5)
...
## [Notification Posting API](watch_queue.md#id6)
...
## [Watch Sources](watch_queue.md#id7)
...
>
>   See [Kernel Key Retention Service](../security/keys/core.md) for more information.

## [Event Filtering](watch_queue.md#id8)
...
## [Userspace Code Example](watch_queue.md#id9)
