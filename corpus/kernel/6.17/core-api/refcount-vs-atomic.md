...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/refcount-vs-atomic.html
fetched_at: 2026-09-16T16:19:11+00:00
---
English
...
- [Comparison of functions](refcount-vs-atomic.md#comparison-of-functions)
  ...
  - [case 2) - non-“Read/Modify/Write” (RMW) ops with release ordering](refcount-vs-atomic.md#case-2-non-read-modify-write-rmw-ops-with-release-ordering)
  - [case 3) - increment-based ops that return no value](refcount-vs-atomic.md#case-3-increment-based-ops-that-return-no-value)
  - [case 4) - decrement-based RMW ops that return no value](refcount-vs-atomic.md#case-4-decrement-based-rmw-ops-that-return-no-value)
  - [case 5) - increment-based RMW ops that return a value](refcount-vs-atomic.md#case-5-increment-based-rmw-ops-that-return-a-value)
  - [case 6) - increment-based RMW ops with acquire ordering that return a value](refcount-vs-atomic.md#case-6-increment-based-rmw-ops-with-acquire-ordering-that-return-a-value)
  - [case 7) - generic dec/sub decrement-based RMW ops that return a value](refcount-vs-atomic.md#case-7-generic-dec-sub-decrement-based-rmw-ops-that-return-a-value)
  - [case 8) other decrement-based RMW ops that return a value](refcount-vs-atomic.md#case-8-other-decrement-based-rmw-ops-that-return-a-value)
  - [case 9) - lock-based RMW](refcount-vs-atomic.md#case-9-lock-based-rmw)
...
### [case 2) - non-“Read/Modify/Write” (RMW) ops with release ordering](refcount-vs-atomic.md#id5)

Function changes:

> - [`atomic_set_release()`](../driver-api/basics.md#c.atomic_set_release "atomic_set_release") --> [`refcount_set_release()`](../driver-api/basics.md#c.refcount_set_release "refcount_set_release")

Memory ordering guarantee changes:

> - none (both provide RELEASE ordering)

### [case 3) - increment-based ops that return no value](refcount-vs-atomic.md#id6)
...
### [case 4) - decrement-based RMW ops that return no value](refcount-vs-atomic.md#id7)
...
### [case 5) - increment-based RMW ops that return a value](refcount-vs-atomic.md#id8)
...
### [case 6) - increment-based RMW ops with acquire ordering that return a value](refcount-vs-atomic.md#id9)

Function changes:

> - [`atomic_inc_not_zero()`](../driver-api/basics.md#c.atomic_inc_not_zero "atomic_inc_not_zero") --> [`refcount_inc_not_zero_acquire()`](../driver-api/basics.md#c.refcount_inc_not_zero_acquire "refcount_inc_not_zero_acquire")
> - no atomic counterpart --> [`refcount_add_not_zero_acquire()`](../driver-api/basics.md#c.refcount_add_not_zero_acquire "refcount_add_not_zero_acquire")

Memory ordering guarantees changes:

> - fully ordered --> ACQUIRE ordering on success

### [case 7) - generic dec/sub decrement-based RMW ops that return a value](refcount-vs-atomic.md#id10)
...
### [case 8) other decrement-based RMW ops that return a value](refcount-vs-atomic.md#id11)
...
### [case 9) - lock-based RMW](refcount-vs-atomic.md#id12)
