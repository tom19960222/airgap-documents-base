...
source_url: https://www.kernel.org/doc/html/v6.17/core-api/kernel-api.html
fetched_at: 2026-09-16T16:18:49+00:00
---
English
...
This is a replacement for [`strncpy()`](kernel-api.md#c.strncpy "strncpy") uses where the source is not
...
[1]
([1](kernel-api.md#id1),[2](kernel-api.md#id2))
...
A relationship exists between [`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter") and [`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather"). See
[`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather") for the bitmap gather detailed operations. TL;DR:
[`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather") can be seen as the ‘reverse’ [`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter") operation.
...
A relationship exists between [`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather") and [`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter"). See
[`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter") for the bitmap scatter detailed operations. TL;DR:
[`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter") can be seen as the ‘reverse’ [`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather") operation.

Suppose scattered computed using bitmap_scatter(scattered, src, mask, n).
The operation bitmap_gather(result, scattered, mask, n) leads to a result
equal or equivalent to src.

The result can be ‘equivalent’ because [`bitmap_scatter()`](kernel-api.md#c.bitmap_scatter "bitmap_scatter") and [`bitmap_gather()`](kernel-api.md#c.bitmap_gather "bitmap_gather")
are not bijective.
...
[`bitmap_write()`](kernel-api.md#c.bitmap_write "bitmap_write") behaves as-if implemented as **nbits** calls of `__assign_bit()`,
...
> helper macro for [`DEFINE_FLEX()`](kernel-api.md#c.DEFINE_FLEX "DEFINE_FLEX") family. Enables caller macro to pass arbitrary trailing expressions
...
> helper macro for [`DEFINE_FLEX()`](kernel-api.md#c.DEFINE_FLEX "DEFINE_FLEX") family. Returns the number of elements in **array**.

**Parameters**

`name`
:   Name for a variable defined in [`DEFINE_RAW_FLEX()`](kernel-api.md#c.DEFINE_RAW_FLEX "DEFINE_RAW_FLEX")/[`DEFINE_FLEX()`](kernel-api.md#c.DEFINE_FLEX "DEFINE_FLEX").
...
For new applications, prefer to use CRC-32C instead. See [`crc32c()`](kernel-api.md#c.crc32c "crc32c").
...
[`crc32_be()`](kernel-api.md#c.crc32_be "crc32_be") is the same as [`crc32_le()`](kernel-api.md#c.crc32_le "crc32_le") except that [`crc32_be()`](kernel-api.md#c.crc32_be "crc32_be") computes the
...
:   Similar to [`ipc_obtain_object_idr()`](kernel-api.md#c.ipc_obtain_object_idr "ipc_obtain_object_idr") but also checks the ipc object sequence number.
...
data processing (like [`memcpy()`](kernel-api.md#c.memcpy "memcpy") of (**fifo->data** + **tail**) with count
returned).
...
Similarly to [`kfifo_out_linear()`](kernel-api.md#c.kfifo_out_linear "kfifo_out_linear"), this macro obtains the pointer to the
...
processing (like [`memcpy()`](kernel-api.md#c.memcpy "memcpy") of **ptr** with count returned).
...
> Should only be called from [`kref_put()`](kref.md#c.kref_put "kref_put").
...
> [`kref_put()`](kref.md#c.kref_put "kref_put").
...
int relay_file_open(struct [inode](kernel-api.md#c.relay_file_open "inode") \*inode, struct [file](../filesystems/api-summary.md#c.file "file") \*filp)
...
int relay_file_mmap(struct [file](../filesystems/api-summary.md#c.file "file") \*filp, struct vm_area_struct \*vma)
...
__poll_t relay_file_poll(struct [file](../filesystems/api-summary.md#c.file "file") \*filp, poll_table \*wait)
...
int relay_file_release(struct [inode](kernel-api.md#c.relay_file_release "inode") \*inode, struct [file](../filesystems/api-summary.md#c.file "file") \*filp)
...
int lsm_inode_alloc(struct [inode](kernel-api.md#c.lsm_inode_alloc "inode") \*inode, gfp_t gfp)
...
int lsm_key_alloc(struct [key](kernel-api.md#c.lsm_key_alloc "key") \*key)
...
int security_inode_alloc(struct [inode](kernel-api.md#c.security_inode_alloc "inode") \*inode, gfp_t gfp)
...
[`security_inode_free()`](kernel-api.md#c.security_inode_free "security_inode_free"), **inode** may still be referenced in a VFS path walk
and calls to [`security_inode_permission()`](kernel-api.md#c.security_inode_permission "security_inode_permission") may be made during, or after,
a call to [`security_inode_free()`](kernel-api.md#c.security_inode_free "security_inode_free"). For this reason the inode->i_security
field is released via a [`call_rcu()`](kernel-api.md#c.call_rcu "call_rcu") callback and any LSMs which need to
retain inode state for use in [`security_inode_permission()`](kernel-api.md#c.security_inode_permission "security_inode_permission") should only
...
void security_path_post_mknod(struct mnt_idmap \*idmap, struct [dentry](kernel-api.md#c.security_path_post_mknod "dentry") \*dentry)
...
void security_inode_post_create_tmpfile(struct mnt_idmap \*idmap, struct [inode](kernel-api.md#c.security_inode_post_create_tmpfile "inode") \*inode)
...
void security_inode_post_setattr(struct mnt_idmap \*idmap, struct [dentry](kernel-api.md#c.security_inode_post_setattr "dentry") \*dentry, int ia_valid)
...
void security_inode_post_set_acl(struct [dentry](kernel-api.md#c.security_inode_post_set_acl "dentry") \*dentry, const char \*acl_name, struct posix_acl \*kacl)
...
void security_inode_post_remove_acl(struct mnt_idmap \*idmap, struct [dentry](kernel-api.md#c.security_inode_post_remove_acl "dentry") \*dentry, const char \*acl_name)
...
void security_inode_post_removexattr(struct [dentry](kernel-api.md#c.security_inode_post_removexattr "dentry") \*dentry, const char \*name)
...
int security_inode_file_setattr(struct [dentry](kernel-api.md#c.security_inode_file_setattr "dentry") \*dentry, struct file_kattr \*fa)
...
int security_inode_file_getattr(struct [dentry](kernel-api.md#c.security_inode_file_getattr "dentry") \*dentry, struct file_kattr \*fa)
...
void security_inode_getlsmprop(struct [inode](kernel-api.md#c.security_inode_getlsmprop "inode") \*inode, struct lsm_prop \*prop)
...
void security_file_release(struct [file](kernel-api.md#c.security_file_release "file") \*file)
...
that the fown_struct, **fown**, is never outside the context of a [`struct file`](../filesystems/api-summary.md#c.file "file"),
so the file structure (and associated security information) can always be
obtained: container_of(fown, [`struct file`](../filesystems/api-summary.md#c.file "file"), f_owner).
...
int lsm_sock_alloc(struct [sock](kernel-api.md#c.lsm_sock_alloc "sock") \*sock, gfp_t gfp)
...
void security_key_post_create_or_update(struct [key](kernel-api.md#c.security_key_post_create_or_update "key") \*keyring, struct [key](kernel-api.md#c.security_key_post_create_or_update "key") \*key, const void \*payload, size_t payload_len, unsigned long flags, bool create)
...
int security_bpf_token_create(struct bpf_token \*token, union bpf_attr \*attr, const struct [path](kernel-api.md#c.security_bpf_token_create "path") \*path)
...
bool bio_is_zone_append(struct [bio](kernel-api.md#c.bio_is_zone_append "bio") \*bio)
...
[`blk_stack_limits()`](kernel-api.md#c.blk_stack_limits "blk_stack_limits").
...
[`queue_limits_commit_update()`](kernel-api.md#c.queue_limits_commit_update "queue_limits_commit_update") instead.
...
int add_disk_fwnode(struct [device](../driver-api/infrastructure.md#c.device "device") \*parent, struct gendisk \*disk, const struct attribute_group \*\*groups, struct fwnode_handle \*fwnode)
...
void bdev_fput(struct [file](../filesystems/api-summary.md#c.file "file") \*bdev_file)
...
int devm_clk_rate_exclusive_get(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, struct [clk](kernel-api.md#c.devm_clk_rate_exclusive_get "clk") \*clk)
...
Calls [`clk_rate_exclusive_get()`](kernel-api.md#c.clk_rate_exclusive_get "clk_rate_exclusive_get") on **clk** and registers a devm cleanup handler
on **dev** to call [`clk_rate_exclusive_put()`](kernel-api.md#c.clk_rate_exclusive_put "clk_rate_exclusive_put").
...
int devm_clk_bulk_get_all_enabled(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, struct [clk_bulk_data](kernel-api.md#c.clk_bulk_data "clk_bulk_data") \*\*clks)
...
struct clk \*devm_clk_get_optional_enabled_with_rate(struct [device](../driver-api/infrastructure.md#c.device "device") \*dev, const char \*id, unsigned long rate)
:   [`devm_clk_get_optional()`](kernel-api.md#c.devm_clk_get_optional "devm_clk_get_optional") + [`clk_set_rate()`](kernel-api.md#c.clk_set_rate "clk_set_rate") + `clk_prepare_enable()`
...
will invoke [`rcu_softirq_qs()`](kernel-api.md#c.rcu_softirq_qs "rcu_softirq_qs") every 100 milliseconds thereafter, which will
...
(“rcu: Reject [`RCU_LOCKDEP_WARN()`](kernel-api.md#c.RCU_LOCKDEP_WARN "RCU_LOCKDEP_WARN") false positives”) for more detail.

lockdep_assert_in_rcu_read_lock

`lockdep_assert_in_rcu_read_lock ()`

> > WARN if not protected by [`rcu_read_lock()`](kernel-api.md#c.rcu_read_lock "rcu_read_lock")
>
> **Description**
>
> Splats if lockdep is enabled and there is no [`rcu_read_lock()`](kernel-api.md#c.rcu_read_lock "rcu_read_lock") in effect.

lockdep_assert_in_rcu_read_lock_bh

`lockdep_assert_in_rcu_read_lock_bh ()`

> > WARN if not protected by [`rcu_read_lock_bh()`](kernel-api.md#c.rcu_read_lock_bh "rcu_read_lock_bh")
>
> **Description**
>
> Splats if lockdep is enabled and there is no [`rcu_read_lock_bh()`](kernel-api.md#c.rcu_read_lock_bh "rcu_read_lock_bh") in effect.
> Note that `local_bh_disable()` and friends do not suffice here, instead an
> actual [`rcu_read_lock_bh()`](kernel-api.md#c.rcu_read_lock_bh "rcu_read_lock_bh") is required.

lockdep_assert_in_rcu_read_lock_sched

`lockdep_assert_in_rcu_read_lock_sched ()`

> > WARN if not protected by [`rcu_read_lock_sched()`](kernel-api.md#c.rcu_read_lock_sched "rcu_read_lock_sched")
>
> **Description**
>
> Splats if lockdep is enabled and there is no [`rcu_read_lock_sched()`](kernel-api.md#c.rcu_read_lock_sched "rcu_read_lock_sched")
> in effect. Note that `preempt_disable()` and friends do not suffice here,
> instead an actual [`rcu_read_lock_sched()`](kernel-api.md#c.rcu_read_lock_sched "rcu_read_lock_sched") is required.
...
Both [`synchronize_rcu()`](kernel-api.md#c.synchronize_rcu "synchronize_rcu") and [`call_rcu()`](kernel-api.md#c.call_rcu "call_rcu") also wait for regions of code
...
deferral that is carried out when [`rcu_read_unlock()`](kernel-api.md#c.rcu_read_unlock "rcu_read_unlock") is invoked with
interrupts disabled.
...
The [`kfree_rcu()`](kernel-api.md#c.kfree_rcu "kfree_rcu") function handles this issue. In order to have a universal
...
Note that from RCU’s viewpoint, a call to [`rcu_softirq_qs()`](kernel-api.md#c.rcu_softirq_qs "rcu_softirq_qs") is
...
A call to [`synchronize_rcu()`](kernel-api.md#c.synchronize_rcu "synchronize_rcu") that began concurrently with the
call to `do_something()` would be guaranteed to wait only until
execution reached statement A. Without that [`rcu_softirq_qs()`](kernel-api.md#c.rcu_softirq_qs "rcu_softirq_qs"),
that same [`synchronize_rcu()`](kernel-api.md#c.synchronize_rcu "synchronize_rcu") would instead be guaranteed to wait
...
Specific to [`call_rcu()`](kernel-api.md#c.call_rcu "call_rcu") (as opposed to the other call_rcu\*() functions),
in kernels built with CONFIG_RCU_LAZY=y, [`call_rcu()`](kernel-api.md#c.call_rcu "call_rcu") might delay for many
...
in latency-sensitive kernel code, use [`call_rcu_hurry()`](kernel-api.md#c.call_rcu_hurry "call_rcu_hurry").
...
Returns a value that [`poll_state_synchronize_srcu()`](kernel-api.md#c.poll_state_synchronize_srcu "poll_state_synchronize_srcu") will always treat
...
The two old-state values must have been obtained from either
[`get_state_synchronize_srcu()`](kernel-api.md#c.get_state_synchronize_srcu "get_state_synchronize_srcu"), [`start_poll_synchronize_srcu()`](kernel-api.md#c.start_poll_synchronize_srcu "start_poll_synchronize_srcu"), or
[`get_completed_synchronize_srcu()`](kernel-api.md#c.get_completed_synchronize_srcu "get_completed_synchronize_srcu"). Returns **true** if the two values are
identical and **false** otherwise. This allows structures whose lifetimes
are tracked by old-state values to push these values to a list header,
allowing those structures to be slightly smaller.
...
The return value from [`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock") is guaranteed to be
non-negative. This value must be passed unaltered to the matching
[`srcu_read_unlock()`](kernel-api.md#c.srcu_read_unlock "srcu_read_unlock"). Note that [`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock") and the matching
[`srcu_read_unlock()`](kernel-api.md#c.srcu_read_unlock "srcu_read_unlock") must occur in the same context, for example, it is
illegal to invoke [`srcu_read_unlock()`](kernel-api.md#c.srcu_read_unlock "srcu_read_unlock") in an irq handler if the matching
[`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock") was invoked in process context. Or, for that matter to
invoke [`srcu_read_unlock()`](kernel-api.md#c.srcu_read_unlock "srcu_read_unlock") from one task and the matching [`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock")
from another.
...
`smp_mb()`-free reader. See [`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock") for more information.

If [`srcu_read_lock_fast()`](kernel-api.md#c.srcu_read_lock_fast "srcu_read_lock_fast") is ever used on an srcu_struct structure,
then none of the other flavors may be used, whether before, during,
or after. Note that grace-period auto-expediting is disabled for _fast
srcu_struct structures because auto-expedited grace periods invoke
[`synchronize_rcu_expedited()`](kernel-api.md#c.synchronize_rcu_expedited "synchronize_rcu_expedited"), IPIs and all.

Note that [`srcu_read_lock_fast()`](kernel-api.md#c.srcu_read_lock_fast "srcu_read_lock_fast") can be invoked only from those contexts
where RCU is watching, that is, from contexts where it would be legal
to invoke [`rcu_read_lock()`](kernel-api.md#c.rcu_read_lock "rcu_read_lock"). Otherwise, lockdep will complain.
...
a light-weight `smp_mb()`-free reader. See [`srcu_read_lock_fast()`](kernel-api.md#c.srcu_read_lock_fast "srcu_read_lock_fast") and
[`srcu_down_read()`](kernel-api.md#c.srcu_down_read "srcu_down_read") for more information.

The same srcu_struct may be used concurrently by [`srcu_down_read_fast()`](kernel-api.md#c.srcu_down_read_fast "srcu_down_read_fast")
and [`srcu_read_lock_fast()`](kernel-api.md#c.srcu_read_lock_fast "srcu_read_lock_fast").
...
If [`srcu_read_lock_nmisafe()`](kernel-api.md#c.srcu_read_lock_nmisafe "srcu_read_lock_nmisafe") is ever used on an srcu_struct structure,
then none of the other flavors may be used, whether before, during,
or after.
...
used concurrently by [`srcu_down_read()`](kernel-api.md#c.srcu_down_read "srcu_down_read") and [`srcu_read_lock()`](kernel-api.md#c.srcu_read_lock "srcu_read_lock").
...
:   return value from corresponding [`srcu_read_lock_fast()`](kernel-api.md#c.srcu_read_lock_fast "srcu_read_lock_fast").
...
the same context as the maching [`srcu_down_read_fast()`](kernel-api.md#c.srcu_down_read_fast "srcu_down_read_fast").
...
`int idx`
:   return value from corresponding [`srcu_read_lock_nmisafe()`](kernel-api.md#c.srcu_read_lock_nmisafe "srcu_read_lock_nmisafe").
...
only if [`list_del()`](list.md#c.list_del "list_del") and similar primitives are not also used on the
list header.
...
[`list_empty()`](list.md#c.list_empty "list_empty") on entry does not return true after this,
the entry is in an undefined state. It is useful for RCU based
lockfree traversal.
...
In contrast to [`list_del_rcu()`](kernel-api.md#c.list_del_rcu "list_del_rcu") doesn’t poison the prev pointer thus
allowing backwards traversal via `list_bidir_prev_rcu()`.

**Note**

[`list_empty()`](list.md#c.list_empty "list_empty") on entry does not return true after this because
...
primitive, such as [`list_bidir_del_rcu()`](kernel-api.md#c.list_bidir_del_rcu "list_bidir_del_rcu") or [`list_add_rcu()`](kernel-api.md#c.list_add_rcu "list_add_rcu"), running on
this same list. However, it is perfectly legal to run concurrently
with the _rcu list-traversal primitives, such as
[`list_for_each_entry_rcu()`](kernel-api.md#c.list_for_each_entry_rcu "list_for_each_entry_rcu").

Note that [`list_del_rcu()`](kernel-api.md#c.list_del_rcu "list_del_rcu") and [`list_bidir_del_rcu()`](kernel-api.md#c.list_bidir_del_rcu "list_bidir_del_rcu") must not be used on
the same list.
...
However, it is perfectly legal to run concurrently with
the _rcu list-traversal primitives, such as
[`hlist_for_each_entry()`](list.md#c.hlist_for_each_entry "hlist_for_each_entry").
...
signaled by [`rcuref_put()`](kernel-api.md#c.rcuref_put "rcuref_put")) please use `rcuread_is_dead()`.
...
invocation of [`rcuref_put()`](kernel-api.md#c.rcuref_put "rcuref_put") returned true on this reference counter meaning
