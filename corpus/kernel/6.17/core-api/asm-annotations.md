...
collection: kernel
version: "6.17"
title: "Assembler Annotations"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/asm-annotations.html
...
([ORC unwinder](../arch/x86/orc-unwinder.md))
for most code. Both of these are especially important to support reliable
stack traces which are in turn necessary for kernel live patching
([Livepatch](../livepatch/livepatch.md)).
...
There was a [discussion](https://lore.kernel.org/r/20170217104757.28588-1-jslaby@suse.cz) and instead of extending the current `ENTRY/END*`
