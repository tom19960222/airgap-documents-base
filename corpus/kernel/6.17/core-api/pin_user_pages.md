...
collection: kernel
version: "6.17"
title: "pin_user_pages() and related calls"
source_url: https://www.kernel.org/doc/html/v6.17/core-api/pin_user_pages.html
fetched_at: 2026-09-16T16:19:26+00:00
---
# pin_user_pages() and related calls

- [Overview](pin_user_pages.md#overview)
- [Basic description of FOLL_PIN](pin_user_pages.md#basic-description-of-foll-pin)
- [Which flags are set by each wrapper](pin_user_pages.md#which-flags-are-set-by-each-wrapper)
- [Tracking dma-pinned pages](pin_user_pages.md#tracking-dma-pinned-pages)
- [FOLL_PIN, FOLL_GET, FOLL_LONGTERM: when to use which flags](pin_user_pages.md#foll-pin-foll-get-foll-longterm-when-to-use-which-flags)

  - [CASE 1: Direct IO (DIO)](pin_user_pages.md#case-1-direct-io-dio)
  - [CASE 2: RDMA](pin_user_pages.md#case-2-rdma)
  - [CASE 3: MMU notifier registration, with or without page faulting hardware](pin_user_pages.md#case-3-mmu-notifier-registration-with-or-without-page-faulting-hardware)
  - [CASE 4: Pinning for struct page manipulation only](pin_user_pages.md#case-4-pinning-for-struct-page-manipulation-only)
  - [CASE 5: Pinning in order to write to the data within the page](pin_user_pages.md#case-5-pinning-in-order-to-write-to-the-data-within-the-page)
- [folio_maybe_dma_pinned(): the whole point of pinning](pin_user_pages.md#folio-maybe-dma-pinned-the-whole-point-of-pinning)
- [Another way of thinking about FOLL_GET, FOLL_PIN, and FOLL_LONGTERM](pin_user_pages.md#another-way-of-thinking-about-foll-get-foll-pin-and-foll-longterm)
- [Unit testing](pin_user_pages.md#unit-testing)
- [Other diagnostics](pin_user_pages.md#other-diagnostics)
- [References](pin_user_pages.md#references)

## [Overview](pin_user_pages.md#id1)
...
## [Basic description of FOLL_PIN](pin_user_pages.md#id2)
...
## [Which flags are set by each wrapper](pin_user_pages.md#id3)
...
the extra space available in the [`struct folio`](mm-api.md#c.folio "folio") is used to store the
pincount directly.
...
## [Tracking dma-pinned pages](pin_user_pages.md#id4)
...
## [FOLL_PIN, FOLL_GET, FOLL_LONGTERM: when to use which flags](pin_user_pages.md#id5)

Thanks to Jan Kara, Vlastimil Babka and several other -mm people, for describing
these categories:

### [CASE 1: Direct IO (DIO)](pin_user_pages.md#id6)
...
### [CASE 2: RDMA](pin_user_pages.md#id7)
...
### [CASE 3: MMU notifier registration, with or without page faulting hardware](pin_user_pages.md#id8)
...
### [CASE 4: Pinning for struct page manipulation only](pin_user_pages.md#id9)
...
### [CASE 5: Pinning in order to write to the data within the page](pin_user_pages.md#id10)
...
## [folio_maybe_dma_pinned(): the whole point of pinning](pin_user_pages.md#id11)
...
## [Another way of thinking about FOLL_GET, FOLL_PIN, and FOLL_LONGTERM](pin_user_pages.md#id12)
...
## [Unit testing](pin_user_pages.md#id13)
...
## [Other diagnostics](pin_user_pages.md#id14)
...
## [References](pin_user_pages.md#id15)

- [Some slow progress on get_user_pages() (Apr 2, 2019)](https://lwn.net/Articles/784574/)
- [DMA and get_user_pages() (LPC: Dec 12, 2018)](https://lwn.net/Articles/774411/)
- [The trouble with get_user_pages() (Apr 30, 2018)](https://lwn.net/Articles/753027/)
