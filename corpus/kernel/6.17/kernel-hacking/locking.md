...
source_url: https://www.kernel.org/doc/html/v6.17/kernel-hacking/locking.html
fetched_at: 2026-09-16T16:21:49+00:00
---
English
...
[`list_for_each_entry()`](../core-api/list.md#c.list_for_each_entry "list_for_each_entry"), since there cannot be two
...
void futex_queue(struct [futex_q](locking.md#c.futex_q "futex_q") \*q, struct futex_hash_bucket \*hb, struct task_struct \*task)
...
void futex_do_wait(struct [futex_q](locking.md#c.futex_q "futex_q") \*q, struct [hrtimer_sleeper](../driver-api/basics.md#c.hrtimer_sleeper "hrtimer_sleeper") \*timeout)
...
int futex_wait_setup(u32 __user \*uaddr, u32 val, unsigned int flags, struct [futex_q](locking.md#c.futex_q "futex_q") \*q, union futex_key \*key2, struct task_struct \*task)
...
`union futex_key *key2`
:   the second futex_key if used for requeue PI
