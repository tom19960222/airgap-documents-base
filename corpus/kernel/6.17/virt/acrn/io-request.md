...
collection: kernel
version: "6.17"
title: "I/O request handling"
source_url: https://www.kernel.org/doc/html/v6.17/virt/acrn/io-request.html
fetched_at: 2026-09-16T16:43:44+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/virt/acrn/io-request.md)
...
1. The I/O handler of the hypervisor will fill an I/O request with PENDING
   state when a trapped I/O access happens in a User VM.
2. The hypervisor makes an upcall, which is a notification interrupt, to
   the Service VM.
3. The upcall handler schedules a worker to dispatch I/O requests.
4. The worker looks for the PENDING I/O requests, assigns them to different
...
5. The notified client handles the assigned I/O requests.
6. The HSM updates I/O requests states to COMPLETE and notifies the hypervisor
