...
collection: kernel
version: "6.17"
title: "KVM Lock Overview"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/locking.html
fetched_at: 2026-09-16T16:43:39+00:00
---
# KVM Lock Overview
...
Comment:
:   Exists to allow taking `cpus_read_lock()` while kvm_usage_count is
...
Comment:
:   Exists because using kvm_lock leads to deadlock. kvm_lock is taken
