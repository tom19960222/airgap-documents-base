...
collection: kernel
version: "6.17"
title: "KVM VCPU Requests"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/vcpu-requests.html
fetched_at: 2026-09-16T16:43:40+00:00
---
# KVM VCPU Requests
...
This means general bitops, like those documented in [[atomic-ops]](vcpu-requests.md#atomic-ops) could
also be used, e.g.
...
scenario 3, Message and Flag, of [[lwn-mb]](vcpu-requests.md#lwn-mb) and the kernel documentation
[[memory-barriers]](vcpu-requests.md#memory-barriers).
...
(scenario 10 of [[lwn-mb]](vcpu-requests.md#lwn-mb)). As the Dekker pattern requires two variables,
...
[[atomic-ops](vcpu-requests.md#id1)]

Documentation/atomic_bitops.txt and Documentation/atomic_t.txt

[[memory-barriers](vcpu-requests.md#id3)]

Documentation/memory-barriers.txt

[lwn-mb]
([1](vcpu-requests.md#id2),[2](vcpu-requests.md#id4))
