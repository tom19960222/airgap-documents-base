...
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/x86/index.html
...
- [Secure Encrypted Virtualization (SEV)](amd-memory-encryption.md)
  ...
  - [The KVM_MEMORY_ENCRYPT_OP ioctl](amd-memory-encryption.md#the-kvm-memory-encrypt-op-ioctl)
  - [Device attribute API](amd-memory-encryption.md#device-attribute-api)
  - [Firmware Management](amd-memory-encryption.md#firmware-management)
...
- [Intel Trust Domain Extensions (TDX)](intel-tdx.md)
  - [Overview](intel-tdx.md#overview)
  - [API description](intel-tdx.md#api-description)
  - [KVM TDX creation flow](intel-tdx.md#kvm-tdx-creation-flow)
  - [References](intel-tdx.md#references)
