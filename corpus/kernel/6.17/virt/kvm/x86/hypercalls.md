...
collection: kernel
version: "6.17"
title: "Linux KVM Hypercall"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/x86/hypercalls.html
fetched_at: 2026-09-16T16:54:01+00:00
---
# Linux KVM Hypercall
...
:   R2-R7 are used for parameters 1-6. In addition, R1 is used for hypercall
    ...
    refer to [The s390 DIAGNOSE call on KVM](../s390/s390-diag.md).
...
:   It uses R3-R10 and hypercall number in R11. R4-R11 are used as output registers.
    ...
    For more information refer to [The PPC KVM paravirtual interface](../ppc-pv.md)
...
Purpose:
:   Trigger guest exit so that the host can check for pending
...
Purpose:
:   Support MMU operations such as writing to PTE,
...
Purpose:
:   Expose hypercall availability to the guest. On x86 platforms, cpuid
...
Purpose:
:   To enable communication between the hypervisor and guest there is a
...
Usage example:
:   When sending a call-function IPI-many to vCPUs, yield if
