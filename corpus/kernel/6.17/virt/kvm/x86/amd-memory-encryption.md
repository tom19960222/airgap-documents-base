...
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/x86/amd-memory-encryption.html
fetched_at: 2026-09-16T16:54:00+00:00
---
...
See SNP_LAUNCH_START in the SEV-SNP specification [[snp-fw-abi]](amd-memory-encryption.md#snp-fw-abi) for further
...
See the SEV-SNP spec [[snp-fw-abi]](amd-memory-encryption.md#snp-fw-abi) for further details on how each page type is
used/measured.
...
See SNP_LAUNCH_FINISH in the SEV-SNP specification [[snp-fw-abi]](amd-memory-encryption.md#snp-fw-abi) for further
...
information, see the SEV Key Management spec [[api-spec]](amd-memory-encryption.md#api-spec)
...
See [[white-paper]](amd-memory-encryption.md#white-paper), [[api-spec]](amd-memory-encryption.md#api-spec), [[amd-apm]](amd-memory-encryption.md#amd-apm), [[kvm-forum]](amd-memory-encryption.md#kvm-forum), and [[snp-fw-abi]](amd-memory-encryption.md#snp-fw-abi)
for more info.

[[white-paper](amd-memory-encryption.md#id5)]

<https://developer.amd.com/wordpress/media/2013/12/AMD_Memory_Encryption_Whitepaper_v7-Public.pdf>

[api-spec]
([1](amd-memory-encryption.md#id4),[2](amd-memory-encryption.md#id6))

<https://support.amd.com/TechDocs/55766_SEV-KM_API_Specification.pdf>

[[amd-apm](amd-memory-encryption.md#id7)]

<https://support.amd.com/TechDocs/24593.pdf> (section 15.34)

[[kvm-forum](amd-memory-encryption.md#id8)]

<https://www.linux-kvm.org/images/7/74/02x08A-Thomas_Lendacky-AMDs_Virtualizatoin_Memory_Encryption_Technology.pdf>

[snp-fw-abi]
([1](amd-memory-encryption.md#id1),[2](amd-memory-encryption.md#id2),[3](amd-memory-encryption.md#id3),[4](amd-memory-encryption.md#id9))
