...
collection: kernel
version: "6.17"
title: "Generic vm interface"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/devices/vm.html
fetched_at: 2026-09-16T16:53:52+00:00
---
...
Returns:
:   -EINVAL if CMMA was not enabled;
    0 otherwise
...
Returns:
:   -EFAULT if the given address is not accessible;
...
Parameters:
:   address of buffer to store the machine related cpu data
...
Parameters:
:   address of buffer to store/set the processor related cpu
...
See [2.3. ATTRIBUTE: KVM_S390_VM_CPU_MACHINE_FEAT (r/o)](vm.md#kvm-s390-vm-cpu-machine-feat) for
...
See [2.5. ATTRIBUTE: KVM_S390_VM_CPU_MACHINE_SUBFUNC (r/o)](vm.md#kvm-s390-vm-cpu-machine-subfunc) for a
...
Returns:
:   -ENOMEM if there is not enough free memory to start migration mode;
