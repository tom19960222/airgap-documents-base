...
collection: kernel
version: "6.17"
title: "ARM Virtual Interrupt Translation Service (ITS)"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/devices/arm-vgic-its.html
fetched_at: 2026-09-16T16:53:48+00:00
---
...
[ARM Virtual Generic Interrupt Controller v3 and later (VGICv3)](arm-vgic-v3.md)), but does not depend on having physical ITS controllers.
...
4. restore the ITS in the following order:
   ...
   > 4. Restore GITS_CTLR
5. restore KVM_IRQFD assignments for MSIs
