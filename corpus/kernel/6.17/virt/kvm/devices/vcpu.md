...
collection: kernel
version: "6.17"
title: "Generic vcpu interface"
source_url: https://www.kernel.org/doc/html/v6.17/virt/kvm/devices/vcpu.html
fetched_at: 2026-09-16T16:53:51+00:00
---
...
Parameters:
:   in kvm_device_attr.addr the address for PMU overflow interrupt is a
    pointer to an int
...
Parameters:
:   in kvm_device_attr.addr the address for a PMU event filter is a
...
Parameters:
:   in kvm_device_attr.addr the address to an unsigned int
...
Parameters:
:   in kvm_device_attr.addr the address for the timer interrupt is a
    pointer to an int
...
region. See [Paravirtualized time support for arm64](../arm/pvtime.md) for more information
