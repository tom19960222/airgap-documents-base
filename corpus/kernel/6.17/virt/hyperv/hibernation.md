...
collection: kernel
version: "6.17"
title: "Hibernating Guest VMs"
source_url: https://www.kernel.org/doc/html/v6.17/virt/hyperv/hibernation.html
fetched_at: 2026-09-16T16:43:50+00:00
---
...
[System Sleep States](../../admin-guide/pm/sleep-states.md).
...
[VMBus](vmbus.md).) Upon resume from hibernation,
...
[Device Power Management Basics](../../driver-api/pm/devices.md) for the sequencing of the
phases.
...
Virtual Functions (VF) devices. See [PCI pass-thru devices](vpci.md).
