...
collection: kernel
version: "6.17"
title: "Confidential Computing VMs"
source_url: https://www.kernel.org/doc/html/v6.17/virt/hyperv/coco.html
...
objectives described in [Confidential Computing in Linux for x86 virtualization](../../security/snp-tdx-threat-model.md). Note
...
Paravisor mode has similarities to the [Coconut project](https://github.com/coconut-svsm/svsm), which aims to provide
