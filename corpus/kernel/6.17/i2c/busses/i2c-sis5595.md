...
collection: kernel
version: "6.17"
title: "Kernel driver i2c-sis5595"
source_url: https://www.kernel.org/doc/html/v6.17/i2c/busses/i2c-sis5595.html
...
|  |  |
| --- | --- |
| force_addr=0xaddr | Set the I/O base address. Useful for boards that don’t set the address in the BIOS. Does not do a PCI force; the device must still be present in lspci. Don’t use this unless the driver complains that the base address is not set. |
