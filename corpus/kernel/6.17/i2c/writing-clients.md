...
collection: kernel
version: "6.17"
title: "Implementing I2C device drivers"
source_url: https://www.kernel.org/doc/html/v6.17/i2c/writing-clients.html
fetched_at: 2026-09-16T16:43:06+00:00
---
...
[`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device"). This will create the device, then the driver core
...
similar to [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device"), except that it takes an additional list
...
The call to [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device") or `i2c_new_scanned_device()` typically
...
Each I2C device which has been created using [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device")
or `i2c_new_scanned_device()` can be unregistered by calling
[`i2c_unregister_device()`](../driver-api/i2c.md#c.i2c_unregister_device "i2c_unregister_device"). If you don’t call it explicitly, it will be
...
You can read the file [The I2C Protocol](i2c-protocol.md) for more information about the
actual I2C protocol.
...
You can read the file [The SMBus Protocol](smbus-protocol.md) for more information about the
