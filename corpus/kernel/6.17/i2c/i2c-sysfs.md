...
collection: kernel
version: "6.17"
title: "Linux I2C Sysfs"
source_url: https://www.kernel.org/doc/html/v6.17/i2c/i2c-sysfs.html
...
[i2cdetect -l](https://manpages.debian.org/unstable/i2c-tools/i2cdetect.8.en.html)
in
...
[Naming and data format standards for sysfs files](../hwmon/sysfs-interface.md)

### Instantiate I2C Devices in I2C Sysfs

Refer to section “Method 4: Instantiate from user-space” of [How to instantiate I2C devices](instantiating-devices.md)
