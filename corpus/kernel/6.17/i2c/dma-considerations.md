...
collection: kernel
version: "6.17"
title: "Linux I2C and DMA"
source_url: https://www.kernel.org/doc/html/v6.17/i2c/dma-considerations.html
fetched_at: 2026-09-16T16:43:08+00:00
---
# Linux I2C and DMA
...
of [`i2c_master_send()`](../driver-api/i2c.md#c.i2c_master_send "i2c_master_send") and [`i2c_master_recv()`](../driver-api/i2c.md#c.i2c_master_recv "i2c_master_recv") functions can now use DMA safe
variants ([`i2c_master_send_dmasafe()`](../driver-api/i2c.md#c.i2c_master_send_dmasafe "i2c_master_send_dmasafe") and [`i2c_master_recv_dmasafe()`](../driver-api/i2c.md#c.i2c_master_recv_dmasafe "i2c_master_recv_dmasafe")) once they
know their buffers are DMA safe. Users of [`i2c_transfer()`](../driver-api/i2c.md#c.i2c_transfer "i2c_transfer") must set the
