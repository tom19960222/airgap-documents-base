...
source_url: https://www.kernel.org/doc/html/v6.17/i2c/instantiating-devices.html
...
which is currently located at [ACPI Based Device Enumeration](../firmware-guide/acpi/enumeration.md).
...
[`struct i2c_board_info`](../driver-api/i2c.md#c.i2c_board_info "i2c_board_info") which is registered by calling
[`i2c_register_board_info()`](../driver-api/i2c.md#c.i2c_register_board_info "i2c_register_board_info").
...
a [`struct i2c_board_info`](../driver-api/i2c.md#c.i2c_board_info "i2c_board_info") and calling [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device").
...
`i2c_new_scanned_device()` instead of [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device").
...
it on cleanup. This is done by calling [`i2c_unregister_device()`](../driver-api/i2c.md#c.i2c_unregister_device "i2c_unregister_device") on the
pointer that was earlier returned by [`i2c_new_client_device()`](../driver-api/i2c.md#c.i2c_new_client_device "i2c_new_client_device") or
