...
collection: kernel
version: "6.17"
title: "Linux I2C slave interface description"
source_url: https://www.kernel.org/doc/html/v6.17/i2c/slave-interface.html
fetched_at: 2026-09-16T16:43:10+00:00
---
# Linux I2C slave interface description

by Wolfram Sang <[wsa@sang-engineering.com](mailto:wsa%40sang-engineering.com)> in 2014-15
...
them as described in the document [How to instantiate I2C devices](instantiating-devices.md). The only
...
- implement calls to register/unregister the slave and add those to the
  [`struct i2c_algorithm`](../driver-api/i2c.md#c.i2c_algorithm "i2c_algorithm"). When registering, you probably need to set the I2C
