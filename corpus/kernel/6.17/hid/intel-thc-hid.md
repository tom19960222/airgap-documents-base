...
collection: kernel
version: "6.17"
title: "Intel Touch Host Controller (THC)"
source_url: https://www.kernel.org/doc/html/v6.17/hid/intel-thc-hid.html
fetched_at: 2026-09-16T16:38:43+00:00
---
...
| --- | --- | --- |
| dest_addr | 53..0 | destination memory address, as every entry is 4KB, ignore lowest 10 bits of address. |
| reserved1 | 54..62 | reserved |
| int_on_completion | 63 | completion interrupt enable bit, if this bit set it means THC will trigger a completion interrupt. This bit is set by SW driver. |
| len | 87..64 | how many bytes of data in this entry. |
| end_of_prd | 88 | end of PRD table bit, if this bit is set, it means this entry is last entry in this PRD table. This bit is set by SW driver. |
