...
source_url: https://www.kernel.org/doc/html/v6.17/hid/hidintro.html
fetched_at: 2026-09-16T16:38:39+00:00
---
...
- [Introduction](hidintro.md#introduction)
- [Parsing HID report descriptors](hidintro.md#parsing-hid-report-descriptors)

  - [Output, Input and Feature Reports](hidintro.md#output-input-and-feature-reports)
- [Collections, Report IDs and Evdev events](hidintro.md#collections-report-ids-and-evdev-events)
- [Events](hidintro.md#events)
- [When something does not work](hidintro.md#when-something-does-not-work)

  - [Quirks](hidintro.md#quirks)
  - [Fixing HID report descriptors](hidintro.md#fixing-hid-report-descriptors)
  - [Modifying the transmitted data on the fly](hidintro.md#modifying-the-transmitted-data-on-the-fly)
  - [Writing a specialized driver](hidintro.md#writing-a-specialized-driver)

- [Manual parsing of HID report descriptors](hidreport-parsing.md)

## [Introduction](hidintro.md#id4)
...
[HID I/O Transport Drivers](hid-transport.md)). Devices may misbehave because the
...
available from the [USB Implementers Forum](https://www.usb.org/)
[HID web page](https://www.usb.org/hid) address:
...
(USB, I2C, Bluetooth, etc.). See [HID I/O Transport Drivers](hid-transport.md).

## [Parsing HID report descriptors](hidintro.md#id5)
...
directly accessing the hidraw driver [[1]](hidintro.md#hidraw).
...
[Manual parsing of HID report descriptors](hidreport-parsing.md); you only need to understand it
...
Parsing the mouse HID report descriptor with [hid-tools](https://gitlab.freedesktop.org/libevdev/hid-tools) leads to
...
tool, from [hid-tools](https://gitlab.freedesktop.org/libevdev/hid-tools):
...
### [Output, Input and Feature Reports](hidintro.md#id6)
...
## [Collections, Report IDs and Evdev events](hidintro.md#id7)
...
## [When something does not work](hidintro.md#id9)
...
See [Submitting patches: the essential guide to getting your code into the kernel](../process/submitting-patches.md) for guidelines on how
to submit a patch. Quirks for other busses need to go into hid-quirks.c.

### [Fixing HID report descriptors](hidintro.md#id11)

Should you need to patch HID report descriptors the easiest way is to
resort to eBPF, as described in [HID-BPF](hid-bpf.md).
...
Check [Manual parsing of HID report descriptors](hidreport-parsing.md) if you need any help
...
everyone else. See [Submitting patches: the essential guide to getting your code into the kernel](../process/submitting-patches.md) for
guidelines on how to do this.

### [Modifying the transmitted data on the fly](hidintro.md#id12)
...
### [Writing a specialized driver](hidintro.md#id13)
...
read hidraw: see [HIDRAW - Raw Access to USB and Bluetooth Human Interface Devices](hidraw.md) and
