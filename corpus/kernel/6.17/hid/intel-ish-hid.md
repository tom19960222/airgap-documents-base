...
collection: kernel
version: "6.17"
title: "Intel Integrated Sensor Hub (ISH)"
source_url: https://www.kernel.org/doc/html/v6.17/hid/intel-ish-hid.html
fetched_at: 2026-09-16T16:38:42+00:00
---
...
Refer to
[HID Sensors Framework](hid-sensor.md) for HID sensor
[ABI file testing/sysfs-bus-iio](../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-bus-iio) for IIO ABIs to user space.
...
- During this process, the ISHTP driver first invokes the [`request_firmware()`](../driver-api/firmware/request_firmware.md#c.request_firmware "request_firmware") function, followed by sending a LOADER_CMD_XFER_QUERY command. Upon receiving a response from the bootloader, the ISHTP driver sends a LOADER_CMD_XFER_FRAGMENT command. After receiving another response, the ISHTP driver sends a LOADER_CMD_START command. The bootloader responds and then proceeds to the Main Firmware.
