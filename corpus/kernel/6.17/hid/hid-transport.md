...
source_url: https://www.kernel.org/doc/html/v6.17/hid/hid-transport.html
fetched_at: 2026-09-16T16:38:40+00:00
---
...
> ->[`start()`](../networking/ieee802154.md#c.start "start") might be called again if another HID device driver is loaded on the
> device.
>
...
> ->open() calls have been followed by a ->close() call. However, ->[`start()`](../networking/ieee802154.md#c.start "start") may
...
> ```
>
> Called once during device setup after ->[`start()`](../networking/ieee802154.md#c.start "start") has been called. Transport
...
Written 2013, David Herrmann <[dh.herrmann@gmail.com](mailto:dh.herrmann%40gmail.com)>
