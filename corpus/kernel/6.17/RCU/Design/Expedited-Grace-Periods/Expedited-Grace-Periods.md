...
collection: kernel
version: "6.17"
title: "A Tour Through TREE_RCU’s Expedited Grace Periods"
source_url: https://www.kernel.org/doc/html/v6.17/RCU/Design/Expedited-Grace-Periods/Expedited-Grace-Periods.html
...
![../../../_images/ExpRCUFlow.svg](../../../_images/ExpRCUFlow.svg)
...
![../../../_images/ExpSchedFlow.svg](../../../_images/ExpSchedFlow.svg)
...
1. The number of CPUs that have ever been online is tracked by the
...
2. The identities of the CPUs that have ever been online is tracked by
...
3. Each `rcu_node` structure’s `->expmaskinit` field is used to
   ...
   period.
4. Any CPU that goes offline will clear its bit in its leaf `rcu_node`
...
5. For each non-idle CPU that RCU believes is currently online, the
...
6. In the case of RCU-sched, one of the last acts of an outgoing CPU is
...
1. `rcu_exp_gp_seq_start()`, which marks the start of an expedited
   grace period.
2. `rcu_exp_gp_seq_end()`, which marks the end of an expedited grace
   period.
3. `rcu_exp_gp_seq_snap()`, which obtains a snapshot of the counter.
4. `rcu_exp_gp_seq_done()`, which returns `true` if a full expedited
...
![../../../_images/Funnel0.svg](../../../_images/Funnel0.svg)
...
![../../../_images/Funnel1.svg](../../../_images/Funnel1.svg)
...
![../../../_images/Funnel2.svg](../../../_images/Funnel2.svg)
...
![../../../_images/Funnel3.svg](../../../_images/Funnel3.svg)
...
![../../../_images/Funnel4.svg](../../../_images/Funnel4.svg)
...
![../../../_images/Funnel5.svg](../../../_images/Funnel5.svg)
...
![../../../_images/Funnel6.svg](../../../_images/Funnel6.svg)
...
![../../../_images/Funnel7.svg](../../../_images/Funnel7.svg)
...
![../../../_images/Funnel8.svg](../../../_images/Funnel8.svg)
...
workqueues (see [Workqueue](../../../core-api/workqueue.md)).
