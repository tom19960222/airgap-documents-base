...
source_url: https://www.kernel.org/doc/html/v6.17/RCU/Design/Requirements/Requirements.html
fetched_at: 2026-09-16T16:35:54+00:00
---
...
5. [Tasks Trace RCU](Requirements.md#tasks-trace-rcu)
...
not provide a Tasks RCU quiescent state. (Instead, use [`rcu_softirq_qs()`](../../../core-api/kernel-api.md#c.rcu_softirq_qs "rcu_softirq_qs")
...
consisting solely of [`synchronize_rcu_tasks_rude()`](../../../core-api/kernel-api.md#c.synchronize_rcu_tasks_rude "synchronize_rcu_tasks_rude").
