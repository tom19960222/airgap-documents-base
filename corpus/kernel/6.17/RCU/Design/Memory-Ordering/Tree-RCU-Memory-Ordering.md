...
collection: kernel
version: "6.17"
title: "A Tour Through TREE_RCU’s Grace-Period Memory Ordering"
source_url: https://www.kernel.org/doc/html/v6.17/RCU/Design/Memory-Ordering/Tree-RCU-Memory-Ordering.html
fetched_at: 2026-09-16T16:35:30+00:00
---
...
| **Answer**: |
| Because we must provide ordering for RCU’s polling grace-period primitives, for example, [`get_state_synchronize_rcu()`](../../../core-api/kernel-api.md#c.get_state_synchronize_rcu "get_state_synchronize_rcu") and [`poll_state_synchronize_rcu()`](../../../core-api/kernel-api.md#c.poll_state_synchronize_rcu "poll_state_synchronize_rcu"). Consider this code:  ``` CPU 0                                     CPU 1 ----                                      ---- WRITE_ONCE(X, 1)                          WRITE_ONCE(Y, 1) g = get_state_synchronize_rcu()           smp_mb() while (!poll_state_synchronize_rcu(g))    r1 = READ_ONCE(X)         continue; r0 = READ_ONCE(Y) ```  RCU guarantees that the outcome r0 == 0 && r1 == 0 will not happen, even if CPU 1 is in an RCU extended quiescent state (idle or offline) and thus won’t interact directly with the RCU core processing at all. |
...
![../../../_images/rcu_node-lock.svg](../../../_images/rcu_node-lock.svg)
...
1. [Callback Registry](Tree-RCU-Memory-Ordering.md#callback-registry)
2. [Grace-Period Initialization](Tree-RCU-Memory-Ordering.md#grace-period-initialization)
3. [Self-Reported Quiescent States](Tree-RCU-Memory-Ordering.md#self-reported-quiescent-states)
4. [Dynamic Tick Interface](Tree-RCU-Memory-Ordering.md#dynamic-tick-interface)
5. [CPU-Hotplug Interface](Tree-RCU-Memory-Ordering.md#cpu-hotplug-interface)
6. [Forcing Quiescent States](Tree-RCU-Memory-Ordering.md#forcing-quiescent-states)
7. [Grace-Period Cleanup](Tree-RCU-Memory-Ordering.md#grace-period-cleanup)
8. [Callback Invocation](Tree-RCU-Memory-Ordering.md#callback-invocation)
...
![../../../_images/TreeRCU-callback-registry.svg](../../../_images/TreeRCU-callback-registry.svg)
...
![../../../_images/TreeRCU-gp-init-1.svg](../../../_images/TreeRCU-gp-init-1.svg)
...
![../../../_images/TreeRCU-gp-init-2.svg](../../../_images/TreeRCU-gp-init-2.svg)
...
![../../../_images/TreeRCU-gp-init-3.svg](../../../_images/TreeRCU-gp-init-3.svg)
...
![../../../_images/TreeRCU-qs.svg](../../../_images/TreeRCU-qs.svg)
...
![../../../_images/TreeRCU-dyntick.svg](../../../_images/TreeRCU-dyntick.svg)
...
[below](Tree-RCU-Memory-Ordering.md#forcing-quiescent-states).
...
![../../../_images/TreeRCU-hotplug.svg](../../../_images/TreeRCU-hotplug.svg)
...
![../../../_images/TreeRCU-gp-fqs.svg](../../../_images/TreeRCU-gp-fqs.svg)
...
![../../../_images/TreeRCU-gp-cleanup.svg](../../../_images/TreeRCU-gp-cleanup.svg)
...
![../../../_images/TreeRCU-callback-invocation.svg](../../../_images/TreeRCU-callback-invocation.svg)
...
cleanup](Tree-RCU-Memory-Ordering.md#grace-period-cleanup) diagram. The callback might be
...
![../../../_images/TreeRCU-gp.svg](../../../_images/TreeRCU-gp.svg)
