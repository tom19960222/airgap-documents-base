...
source_url: https://www.kernel.org/doc/html/v6.17/RCU/listRCU.html
fetched_at: 2026-09-16T16:35:42+00:00
---
...
and [`rcu_read_unlock()`](../core-api/kernel-api.md#c.rcu_read_unlock "rcu_read_unlock"), respectively, and the [`list_for_each_entry()`](../core-api/list.md#c.list_for_each_entry "list_for_each_entry")
...
The [`list_del()`](../core-api/list.md#c.list_del "list_del"), [`list_add()`](../core-api/list.md#c.list_add "list_add"), and [`list_add_tail()`](../core-api/list.md#c.list_add_tail "list_add_tail") primitives have been
