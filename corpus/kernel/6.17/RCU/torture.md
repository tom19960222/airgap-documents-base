...
source_url: https://www.kernel.org/doc/html/v6.17/RCU/torture.html
fetched_at: 2026-09-16T16:34:37+00:00
---
English

- [Italian](../translations/it_IT/RCU/torture.md)
...
status messages via [`printk()`](../core-api/printk-basics.md#c.printk "printk"), which can be examined via the dmesg
command (perhaps grepping for “torture”). The test is started
when the module is loaded, and stops when the module is unloaded.

Module parameters are prefixed by “rcutorture.” in
[The kernel’s command-line parameters](../admin-guide/kernel-parameters.md).
...
use other commands to access the output of the [`printk()`](../core-api/printk-basics.md#c.printk "printk")s used by
the RCU torture test. The [`printk()`](../core-api/printk-basics.md#c.printk "printk")s use KERN_ALERT, so they should
be evident. ;-)
...
- “rtmbe”: A non-zero value indicates that rcutorture believes that
  [`rcu_assign_pointer()`](../core-api/kernel-api.md#c.rcu_assign_pointer "rcu_assign_pointer") and [`rcu_dereference()`](../core-api/kernel-api.md#c.rcu_dereference "rcu_dereference") are not working
  correctly. This value should be zero.
- “rtbe”: A non-zero value indicates that one of the [`rcu_barrier()`](../core-api/kernel-api.md#c.rcu_barrier "rcu_barrier")
...
“FAILURE”, or “RCU_HOTPLUG” indication to be [`printk()`](../core-api/printk-basics.md#c.printk "printk")ed. The first
