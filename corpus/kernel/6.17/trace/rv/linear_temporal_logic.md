...
source_url: https://www.kernel.org/doc/html/v6.17/trace/rv/linear_temporal_logic.html
...
the LTL. See [Runtime Verification Monitor Synthesis](monitor_synthesis.md) for details on using
rvgen.
