...
collection: kernel
version: "6.17"
title: "Real-time application monitors"
source_url: https://www.kernel.org/doc/html/v6.17/trace/rv/monitor_rtapp.html
...
- Author: Nam Cao <[namcao@linutronix.de](mailto:namcao%40linutronix.de)>
...
>   thread by waking it and waiting for it to exit ([`kthread_stop()`](../../driver-api/basics.md#c.kthread_stop "kthread_stop")). This
