...
collection: kernel
version: "6.17"
title: "Coresight - HW Assisted Tracing on ARM"
source_url: https://www.kernel.org/doc/html/v6.17/trace/coresight/coresight.html
fetched_at: 2026-09-16T16:27:32+00:00
---
# Coresight - HW Assisted Tracing on ARM

> Author:
> :   Mathieu Poirier <[mathieu.poirier@linaro.org](mailto:mathieu.poirier%40linaro.org)>
>
> Date:
> :   September 11th, 2014
...
via the CTM. See ([CoreSight Embedded Cross Trigger (CTI & CTM).](coresight-ect.md))
[[4]](coresight.md#fourth) for further details.
...
> [linaro@linaro-nano](mailto:linaro%40linaro-nano):~$ ./perf list pmu
>
...
[Config option formats](coresight.md#config-option-formats)).
...
repository [[3]](coresight.md#third).
...
| Option | Description |
| --- | --- |
| branch_broadcast | Session local version of the system wide setting: [ETM_MODE_BB](coresight-etm4x-reference.md#coresight-branch-broadcast) |
| contextid | See [Tracing PID](coresight.md#tracing-pid) |
| contextid1 | See [Tracing PID](coresight.md#tracing-pid) |
| contextid2 | See [Tracing PID](coresight.md#tracing-pid) |
| configid | Selection for a custom configuration. This is an implementation detail and not used directly, see [Using Configurations in perf](coresight-config.md#using-configurations-in-perf) |
| preset | Override for parameters in a custom configuration, see [Using Configurations in perf](coresight-config.md#using-configurations-in-perf) |
| sinkid | Hashed version of the string to select a sink, automatically set when using the @ notation. This is an internal implementation detail and is not used directly, see [Using perf framework](coresight.md#using-perf-framework). |
| cycacc | Session local version of the system wide setting: [ETMv4_MODE_CYCACC](coresight-etm4x-reference.md#coresight-cycle-accurate) |
| retstack | Session local version of the system wide setting: [ETM_MODE_RETURNSTACK](coresight-etm4x-reference.md#coresight-return-stack) |
| timestamp | Session local version of the system wide setting: [ETMv4_MODE_TIMESTAMP](coresight-etm4x-reference.md#coresight-timestamp) |
| cc_threshold | Cycle count threshold value. If nothing is provided here or the provided value is 0, then the default value i.e 0x100 will be used. If provided value is less than minimum cycles threshold value, as indicated via TRCIDR3.CCITMIN, then the minimum value will be used instead. |
...
found in sysfs with more information on each entry being found in [[1]](coresight.md#first):
...
- [System Trace Module](../stm.md) [[2]](coresight.md#second).
...
([CoreSight Embedded Cross Trigger (CTI & CTM).](coresight-ect.md)) [[4]](coresight.md#fourth).
...
([CoreSight System Configuration Manager](coresight-config.md)) [[5]](coresight.md#fifth).

[[1](coresight.md#id3)]

[ABI file testing/sysfs-bus-coresight-devices-stm](../../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-bus-coresight-devices-stm)
...
[4]
([1](coresight.md#id1),[2](coresight.md#id5))
