...
collection: kernel
version: "6.17"
title: "ETMv4 sysfs linux driver programming reference."
source_url: https://www.kernel.org/doc/html/v6.17/trace/coresight/coresight-etm4x-reference.html
fetched_at: 2026-09-16T16:47:06+00:00
---
# ETMv4 sysfs linux driver programming reference.

> Author:
> :   Mike Leach <[mike.leach@linaro.org](mailto:mike.leach%40linaro.org)>
>
> Date:
> :   October 11th, 2019
...
:   Set to enable branch broadcast if supported in hardware [IDR0]. The primary use for this feature
    ...
    overrides any setting of [ETM_MODE_RETURNSTACK](coresight-etm4x-reference.md#coresight-return-stack), so where a branch
