...
source_url: https://www.kernel.org/doc/html/v6.17/trace/ftrace.html
fetched_at: 2026-09-16T16:21:55+00:00
---
...
Author:
:   Steven Rostedt <[srostedt@redhat.com](mailto:srostedt%40redhat.com)>
...
Original Reviewers:
:   Elias Oltmanns, Randy Dunlap, Andrew Morton,
    John Kacur, and David Teigland.

- Written for: 2.6.28-rc2
- Updated for: 3.10
- Updated for: 4.13 - Copyright 2017 VMware Inc. Steven Rostedt
- Converted to rst format - Changbin Du <[changbin.du@intel.com](mailto:changbin.du%40intel.com)>
...
See [Event Tracing](events.md) for more information.

## Implementation Details

See [Function Tracer Design](ftrace-design.md) for details for arch porters and such.
...
> > kprobe_events:
> >
> > > Enable dynamic trace points. See [Kprobe-based Event Tracing](kprobetrace.md).
> >
> > kprobe_profile:
> >
> > > Dynamic trace points stats. See [Kprobe-based Event Tracing](kprobetrace.md).
> >
> > max_graph_depth:
> >
...
> > >     [`ktime_get_boot_fast_ns()`](../core-api/timekeeping.md#c.ktime_get_boot_fast_ns "ktime_get_boot_fast_ns") function for more information.
> > >
> > > tai:
...
> > >     handle them. See comments in the [`ktime_get_tai_fast_ns()`](../core-api/timekeeping.md#c.ktime_get_tai_fast_ns "ktime_get_tai_fast_ns")
...
> > >     See “Event triggers” in [Event Tracing](events.md) and an
> > >     example in [Event Histograms](histogram.md) (Section 3.)
> >
> > trace_marker_raw:
> >
...
> > > See [Uprobe-tracer: Uprobe-based Event Tracing](uprobetracer.md)
> >
> > uprobe_profile:
> >
...
>
> trace_printk
> :   Can disable [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") from writing into the buffer.
>
> trace_printk_dest
> :   Set to have [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") and similar internal tracing functions
...
>
> printk-msg-only
> :   When set, [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk")s will only show the format
>     and not their parameters (if `trace_bprintk()` or
>     `trace_bputs()` was used to save the [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk")).
>
> context-info
...
> **Tip:**
>
> Some tracers have their own options. They only appear in this
...
[`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") For example, if you want to put a comment inside
the `__might_sleep()` function, you just have to include
<linux/ftrace.h> and call [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") inside `__might_sleep()`:
