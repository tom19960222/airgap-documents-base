...
source_url: https://www.kernel.org/doc/html/v6.17/trace/debugging.html
fetched_at: 2026-09-16T16:21:52+00:00
---
...
Author:
:   Steven Rostedt <[rostedt@goodmis.org](mailto:rostedt%40goodmis.org)>
...
[`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") is a very lightweight utility that can be used in any context
...
[`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") format conversions are not done during the hot path, where
the trace is being recorded.

[`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") is meant only for debugging, and should never be added into
a subsystem of the kernel. If you need debugging traces, add trace events
instead. If a [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") is found in the kernel, the following will
appear in the dmesg:
...
By default, the content of [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") goes into the top level tracing
instance. But this instance is never preserved across boots. To have the
[`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk") content, and some other internal tracing go to the preserved
buffer (like dump stacks), either set the instance to be the [`trace_printk()`](../driver-api/basics.md#c.trace_printk "trace_printk")
