...
source_url: https://www.kernel.org/doc/html/v6.17/trace/ftrace-uses.html
fetched_at: 2026-09-16T16:21:56+00:00
---
...
:   If this is set, then the callback will only be called by functions
    ...
    performs any [`rcu_read_lock()`](../core-api/kernel-api.md#c.rcu_read_lock "rcu_read_lock") operation.
