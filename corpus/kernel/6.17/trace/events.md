...
version: "6.17"
title: "Event Tracing"
source_url: https://www.kernel.org/doc/html/v6.17/trace/events.html
fetched_at: 2026-09-16T16:22:00+00:00
---
# Event Tracing
...
Tracepoints (see [Using the Linux Kernel Tracepoints](tracepoints.md)) can be used
...
section of [ftrace - Function Tracer](ftrace.md)), but there are major
differences and the implementation isn’t currently tied to it in any
way, so beware about making generalizations between the two.

> **Note:**
>
> Writing into trace_marker (See [ftrace - Function Tracer](ftrace.md))
...
- hist
  ...
  See [Event Histograms](histogram.md) for details and examples.
