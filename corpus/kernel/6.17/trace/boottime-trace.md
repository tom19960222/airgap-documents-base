...
source_url: https://www.kernel.org/doc/html/v6.17/trace/boottime-trace.html
fetched_at: 2026-09-16T16:22:03+00:00
---
# Boot-time tracing
...
boot config file [[1]](boottime-trace.md#id3). All options are under “ftrace.” or “kernel.”
prefix. See kernel parameters for the options which starts
with “kernel.” prefix [[2]](boottime-trace.md#id4).

[[1](boottime-trace.md#id1)]

See [Documentation/admin-guide/bootconfig.rst](../admin-guide/bootconfig.md#bootconfig)

[[2](boottime-trace.md#id2)]

See [Documentation/admin-guide/kernel-parameters.rst](../admin-guide/kernel-parameters.md#kernelparameters)
...
please read the event histogram document ([Event Histograms](histogram.md))
...
“kernel_” functions, you can write boot config as below:
