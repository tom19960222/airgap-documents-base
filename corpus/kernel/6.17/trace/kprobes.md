...
source_url: https://www.kernel.org/doc/html/v6.17/trace/kprobes.html
fetched_at: 2026-09-16T16:21:57+00:00
---
# Kernel Probes (Kprobes)

Author:
:   Jim Keniston <[jkenisto@us.ibm.com](mailto:jkenisto%40us.ibm.com)>

Author:
:   Prasanna S Panchamukhi <[prasanna.panchamukhi@gmail.com](mailto:prasanna.panchamukhi%40gmail.com)>
...
can trap at almost any kernel code address [[1]](kprobes.md#id2), specifying a handler
routine to be invoked when the breakpoint is hit.

[[1](kprobes.md#id1)]

some parts of the kernel code can not be trapped, see
[Blacklist](kprobes.md#kprobes-blacklist))
...
can skip ahead to [Architectures Supported](kprobes.md#kprobes-archs-supported).
...
rather, it calls [`synchronize_rcu()`](../core-api/kernel-api.md#c.synchronize_rcu "synchronize_rcu") for safety first, because it’s
possible for a CPU to be interrupted in the middle of executing the
optimized region [[3]](kprobes.md#id5). As you know, [`synchronize_rcu()`](../core-api/kernel-api.md#c.synchronize_rcu "synchronize_rcu") can ensure
that all interruptions that were active when [`synchronize_rcu()`](../core-api/kernel-api.md#c.synchronize_rcu "synchronize_rcu")
was called are done, but only if CONFIG_PREEMPT=n. So, this version
of kprobe optimization supports only kernels with CONFIG_PREEMPT=n [[4]](kprobes.md#id6).
...
each other -- e.g., probing [`printk()`](../core-api/printk-basics.md#c.printk "printk") and then calling [`printk()`](../core-api/printk-basics.md#c.printk "printk") from a
...
1. SystemTap (<http://sourceware.org/systemtap>): Provides a simplified
...
[How Does Jump Optimization Work?](kprobes.md#kprobes-jump-optimization)) ON or OFF. By default, jump optimization
