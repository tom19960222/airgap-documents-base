...
collection: kernel
version: "6.17"
title: "How to Implement a new CPUFreq Processor Driver"
source_url: https://www.kernel.org/doc/html/v6.17/cpu-freq/cpu-drivers.html
fetched_at: 2026-09-16T16:43:00+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/cpu-freq/cpu-drivers.md)
- [Chinese (Traditional)](../translations/zh_TW/cpu-freq/cpu-drivers.md)
...
First of all, in an __initcall level 7 ([`module_init()`](../driver-api/basics.md#c.module_init "module_init")) or later
...
|  |  |
| --- | --- |
| policy->cpuinfo.min_freq _and_ policy->cpuinfo.max_freq | the minimum and maximum frequency (in kHz) which is supported by this CPU |
