...
collection: kernel
version: "6.17"
title: "Scalable Vector Extension support for AArch64 Linux"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/sve.html
...
- On hardware that supports the SME extensions, HWCAP2_SME will also be
  ...
  separate SME vector length and the same Z/V registers. See [Scalable Matrix Extension support for AArch64 Linux](sme.md)
  for more details.
