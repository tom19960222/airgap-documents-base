...
collection: kernel
version: "6.17"
title: "Asymmetric 32-bit SoCs"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/asymmetric-32bit.html
fetched_at: 2026-09-16T16:24:08+00:00
---
# Asymmetric 32-bit SoCs

Author: Will Deacon <[will@kernel.org](mailto:will%40kernel.org)>
...
[ABI file testing/sysfs-devices-system-cpu](../../admin-guide/abi-testing-files.md#abi-file-testing-sysfs-devices-system-cpu).
...
>    See [SCHED_DEADLINE](asymmetric-32bit.md#sched-deadline).
...
[execve(2)](asymmetric-32bit.md#execve-2), in which case step (1) is skipped and a warning is
...
(2) of the process described in [execve(2)](asymmetric-32bit.md#execve-2) and the cpuset hierarchy is
