...
collection: kernel
version: "6.17"
title: "Scalable Matrix Extension support for AArch64 Linux"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/sme.html
fetched_at: 2026-09-16T16:24:18+00:00
---
...
documentation in [Scalable Vector Extension support for AArch64 Linux](sve.md) which provides details on the Streaming SVE mode
included in SME.
...
- There are a number of optional SME features, presence of these is reported
  ...
  which userspace can read using an MRS instruction. See [ARM64 ELF hwcaps](elf_hwcaps.md) and
  [ARM64 CPU Feature Registers](cpu-feature-registers.md) for details.
...
[3] [ARM64 CPU Feature Registers](cpu-feature-registers.md)
