...
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/memory-tagging-extension.html
fetched_at: 2026-09-16T16:24:14+00:00
---
# Memory Tagging Extension (MTE) in AArch64 Linux

Authors: Vincenzo Frascino <[vincenzo.frascino@arm.com](mailto:vincenzo.frascino%40arm.com)>
:   Catalin Marinas <[catalin.marinas@arm.com](mailto:catalin.marinas%40arm.com)>
...
[AArch64 TAGGED ADDRESS ABI](tagged-address-abi.md) and above. The corresponding
...
`p_vaddr`:
:   segment virtual address, same as the corresponding
    `PT_LOAD` segment
...
`p_filesz`:
:   segment size in file, calculated as `p_mem_sz / 32`
    (two 4-bit tags cover 32 bytes of memory)

`p_memsz`:
:   segment size in memory, same as the corresponding
    `PT_LOAD` segment
