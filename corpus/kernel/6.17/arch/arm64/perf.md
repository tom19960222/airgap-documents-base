...
version: "6.17"
title: "Perf"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/perf.html
fetched_at: 2026-09-16T16:24:15+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/arch/arm64/perf.md)
- [Chinese (Traditional)](../../translations/zh_TW/arch/arm64/perf.md)
...
and `perf_evsel__read()` functions. See [tools/lib/perf/tests/test-evsel.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/lib/perf/tests/test-evsel.c) for
an example.
...
Have a look at [tools/perf/arch/arm64/tests/user-events.c](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/tools/perf/arch/arm64/tests/user-events.c) for an example. It
...
| --- | --- |
| threshold | Value to threshold the event by. A value of 0 means that thresholding is disabled and the other parameters have no effect. |
| threshold_compare | Comparison function to use, with the following values supported:    0: Not-equal  1: Equals  2: Greater-than-or-equal  3: Less-than |
| threshold_count | If this is set, count by 1 after passing the threshold condition instead of the value of the event on this cycle. |
