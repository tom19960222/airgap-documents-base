...
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/elf_hwcaps.html
fetched_at: 2026-09-16T16:24:10+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/arch/arm64/elf_hwcaps.md)
- [Chinese (Traditional)](../../translations/zh_TW/arch/arm64/elf_hwcaps.md)
...
:   EL0 access to certain ID registers is available, to the extent
    described by [ARM64 CPU Feature Registers](cpu-feature-registers.md).
...
:   Functionality implied by ID_AA64PFR1_EL1.GCS == 0b1, as
    described by [Guarded Control Stack support for AArch64 Linux](gcs.md).
...
:   Functionality implied by ID_AA64PFR1_EL1.MTE == 0b0010, as described
    by [Memory Tagging Extension (MTE) in AArch64 Linux](memory-tagging-extension.md).
...
:   Functionality implied by ID_AA64PFR1_EL1.SME == 0b0001, as described
    by [Scalable Matrix Extension support for AArch64 Linux](sme.md).
