...
collection: kernel
version: "6.17"
title: "ARM64 CPU Feature Registers"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arm64/cpu-feature-registers.html
fetched_at: 2026-09-16T16:24:09+00:00
---
# ARM64 CPU Feature Registers

Author: Suzuki K Poulose <[suzuki.poulose@arm.com](mailto:suzuki.poulose%40arm.com)>
...
> 1. Any change to the HWCAPs requires an update to userspace (e.g libc)
>    to detect the new changes, which can take a long time to appear in
>    distributions. Exposing the registers allows applications to get the
>    information without requiring updates to the toolchains.
> 2. Access to HWCAPs is sometimes limited (e.g prior to libc, or
>    when ld is initialised at startup time).
> 3. HWCAPs cannot represent non-boolean information effectively. The
...
> 1. The value of an ‘IMPLEMENTATION DEFINED’ field is set to 0.
> 2. The value of a reserved field is populated with the reserved
>    value as defined by the architecture.
> 3. The value of a ‘visible’ field holds the system wide safe value
>    for the particular feature (except for MIDR_EL1, see section 4).
> 4. All other fields (i.e, invisible fields) are set to indicate
