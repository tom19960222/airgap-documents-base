...
source_url: https://www.kernel.org/doc/html/v6.17/arch/openrisc/openrisc_port.html
fetched_at: 2026-09-16T16:24:28+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/arch/openrisc/openrisc_port.md)
- [Chinese (Traditional)](../../translations/zh_TW/arch/openrisc/openrisc_port.md)
...
> | email | [linux-openrisc@vger.kernel.org](mailto:linux-openrisc%40vger.kernel.org) |
...
For more information on this, please check [Ramfs, rootfs and initramfs](../../filesystems/ramfs-rootfs-initramfs.md).
...
18-11-2003 Matjaz Breskvar ([phoenix@bsemi.com](mailto:phoenix%40bsemi.com))
:   initial port of linux to OpenRISC/or32 architecture.
    all the core stuff is implemented and seams usable.

08-12-2003 Matjaz Breskvar ([phoenix@bsemi.com](mailto:phoenix%40bsemi.com))
:   complete change of TLB miss handling.
    rewrite of exceptions handling.
    fully functional sash-3.6 in default initrd.
    a much improved version with changes all around.

10-04-2004 Matjaz Breskvar ([phoenix@bsemi.com](mailto:phoenix%40bsemi.com))
:   a lot of bugfixes all over.
    ethernet support, functional http and telnet servers.
    running many standard linux apps.

26-06-2004 Matjaz Breskvar ([phoenix@bsemi.com](mailto:phoenix%40bsemi.com))
:   port to 2.6.x

30-11-2004 Matjaz Breskvar ([phoenix@bsemi.com](mailto:phoenix%40bsemi.com))
:   lots of bugfixes and enhancements.
    added opencores framebuffer driver.

09-10-2010 Jonas Bonn ([jonas@southpole.se](mailto:jonas%40southpole.se))
