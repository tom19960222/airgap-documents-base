...
collection: kernel
version: "6.17"
title: "IMC (In-Memory Collection Counters)"
source_url: https://www.kernel.org/doc/html/v6.17/arch/powerpc/imc.html
fetched_at: 2026-09-16T16:24:40+00:00
---
# [IMC (In-Memory Collection Counters)](imc.md#id1)

Anju T Sudhakar, 10 May 2019

Contents

- [IMC (In-Memory Collection Counters)](imc.md#imc-in-memory-collection-counters)

  - [Basic overview](imc.md#basic-overview)
  - [IMC example usage](imc.md#imc-example-usage)
  - [IMC Trace-mode](imc.md#imc-trace-mode)

    - [LDBAR Register Layout](imc.md#ldbar-register-layout)
    - [TRACE_IMC_SCOM bit representation](imc.md#trace-imc-scom-bit-representation)
  - [Trace IMC example usage](imc.md#trace-imc-example-usage)
  - [Benefits of using IMC trace-mode](imc.md#benefits-of-using-imc-trace-mode)

## [Basic overview](imc.md#id2)
...
### [LDBAR Register Layout](imc.md#id5)
...
### [TRACE_IMC_SCOM bit representation](imc.md#id6)
...
## [Trace IMC example usage](imc.md#id7)
...
## [Benefits of using IMC trace-mode](imc.md#id8)
