...
source_url: https://www.kernel.org/doc/html/v6.17/arch/x86/x86_64/uefi.html
...
2. Booting Linux kernel on UEFI x86_64 platform can either be
   done using the <[The EFI Boot Stub](../../../admin-guide/efi-stub.md)> or using a
   separate bootloader.
3. x86_64 platform with EFI/UEFI firmware.

## 30.1.1. Mechanics

Refer to <[The EFI Boot Stub](../../../admin-guide/efi-stub.md)> to learn how to use the EFI stub.
...
- Copy the boot files to the VFAT partition:
  :   If you use the EFI stub method, the kernel acts also as an EFI executable.
      ...
      so that it will automatically get booted, see the <[The EFI Boot Stub](../../../admin-guide/efi-stub.md)> page
