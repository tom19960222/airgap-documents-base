...
collection: kernel
version: "6.17"
title: "13. PAT (Page Attribute Table)"
source_url: https://www.kernel.org/doc/html/v6.17/arch/x86/pat.html
fetched_at: 2026-09-16T16:25:25+00:00
---
...
> 1. `pgprot_noncached()`
> 2. `io_remap_pfn_range()` or [`remap_pfn_range()`](../../core-api/mm-api.md#c.remap_pfn_range "remap_pfn_range") or [`vmf_insert_pfn()`](../../core-api/mm-api.md#c.vmf_insert_pfn "vmf_insert_pfn")
...
`mtrr_add()` usage will be phased out in favor of [`arch_phys_wc_add()`](../../core-api/kernel-api.md#c.arch_phys_wc_add "arch_phys_wc_add") which will
be a no-op on PAT enabled systems. The region over which a [`arch_phys_wc_add()`](../../core-api/kernel-api.md#c.arch_phys_wc_add "arch_phys_wc_add")
