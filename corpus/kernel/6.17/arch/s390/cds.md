...
collection: kernel
version: "6.17"
title: "Linux for S/390 and zSeries"
source_url: https://www.kernel.org/doc/html/v6.17/arch/s390/cds.html
fetched_at: 2026-09-16T16:25:01+00:00
---
...
:   In order to write a driver for S/390, you also need to look into the interface
    described in [S/390 driver model interfaces](driver-model.md).
...
- All drivers must define a ccw_driver (see [S/390 driver model interfaces](driver-model.md)) and the associated
  functions.
- [`request_irq()`](../../core-api/genericirq.md#c.request_irq "request_irq") and [`free_irq()`](../../core-api/genericirq.md#c.free_irq "free_irq") are no longer done by the driver.
...
- Before initiating an io, the options must be set via [`ccw_device_set_options()`](../../driver-api/s390-drivers.md#c.ccw_device_set_options "ccw_device_set_options").
...
support using the information saved in the [`struct ccw_device`](../../driver-api/s390-drivers.md#c.ccw_device "ccw_device") given to them.
...
[`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") interface that takes a device specific channel program (one
...
[`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") routine allows to specify whether it expects the CDS layer
to notify the device driver for every interrupt it observes, or with final status
only. See [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") for more details. A device driver must never issue
...
[`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt") function. Some devices require to initially issue a HALT
SUBCHANNEL (HSCH) command without having pending I/O requests. This function is
also covered by [`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt").
...
[`ccw_device_get_ciw()`](../../driver-api/s390-drivers.md#c.ccw_device_get_ciw "ccw_device_get_ciw") returns:
...
The [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") routines is the I/O request front-end processor. All
device driver I/O requests must be issued using this routine. A device driver
must not issue ESA/390 I/O commands itself. Instead the [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start")
...
with the associated I/O request when calling [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start").
...
Via [`ccw_device_set_options()`](../../driver-api/s390-drivers.md#c.ccw_device_set_options "ccw_device_set_options"), the device driver may specify the following
...
The [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") function returns:
...
accumulate the status in a [`struct irb`](../../driver-api/s390-drivers.md#c.irb "irb") and then call the device interrupt handler.
...
never started, even though [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") returned with successful completion.
...
[`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") must be called disabled and with the ccw device lock held.

The device driver is allowed to issue the next [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") call from
...
must not try to obtain it again when calling [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") or we end in a
deadlock situation!
...
successful completion for all overlapping [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") requests that have
...
[`ccw_device_resume()`](../../driver-api/s390-drivers.md#c.ccw_device_resume "ccw_device_resume") - Resume Channel Program Execution
...
provides the [`ccw_device_resume()`](../../driver-api/s390-drivers.md#c.ccw_device_resume "ccw_device_resume") routine.
...
The [`ccw_device_resume()`](../../driver-api/s390-drivers.md#c.ccw_device_resume "ccw_device_resume") function returns:
...
Please have a look at the [`ccw_device_start()`](../../driver-api/s390-drivers.md#c.ccw_device_start "ccw_device_start") usage notes for more details on
suspended channel programs.

[`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt") - Halt I/O Request Processing
...
a halt subchannel (HSCH) I/O command. For those purposes the [`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt")
command is provided.

[`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt") must be called disabled and with the ccw device lock held.
...
The [`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt") function returns:
...
read to a network device (with or without PCI flag) a [`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt")
...
(CSCH) command is used. It can be issued via [`ccw_device_clear()`](../../driver-api/s390-drivers.md#c.ccw_device_clear "ccw_device_clear").

[`ccw_device_clear()`](../../driver-api/s390-drivers.md#c.ccw_device_clear "ccw_device_clear") must be called disabled and with the ccw device lock held.
...
| intparm | interruption parameter (see [`ccw_device_halt()`](../../driver-api/s390-drivers.md#c.ccw_device_halt "ccw_device_halt")) |

The [`ccw_device_clear()`](../../driver-api/s390-drivers.md#c.ccw_device_clear "ccw_device_clear") function returns:
