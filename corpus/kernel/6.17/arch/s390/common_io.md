...
collection: kernel
version: "6.17"
title: "S/390 common I/O-Layer"
source_url: https://www.kernel.org/doc/html/v6.17/arch/s390/common_io.html
...
- For some of the information present in the /proc filesystem in 2.4 (namely,
  /proc/subchannels and /proc/chpids), see [S/390 driver model interfaces](driver-model.md).
...
- /sys/kernel/debug/s390dbf/cio_\*/ (S/390 debug feature)
  ...
  documentation on the S/390 debug feature ([S390 Debug Feature](s390dbf.md))
  for details.
