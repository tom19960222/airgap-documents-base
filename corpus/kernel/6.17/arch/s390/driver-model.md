...
collection: kernel
version: "6.17"
title: "S/390 driver model interfaces"
source_url: https://www.kernel.org/doc/html/v6.17/arch/s390/driver-model.html
fetched_at: 2026-09-16T16:25:02+00:00
---
...
1. Each driver can provide one or more parameter interfaces where parameters can
   be specified. These interfaces are also in the driver’s responsibility.
2. After a. has been performed, if necessary, the device is finally brought up
   via the ‘online’ interface.

## 1.2 Writing a driver for ccw devices

The basic [`struct ccw_device`](../../driver-api/s390-drivers.md#c.ccw_device "ccw_device") and [`struct ccw_driver`](../../driver-api/s390-drivers.md#c.ccw_driver "ccw_driver") data structures can be found
...
The handler field of the [`struct ccw_device`](../../driver-api/s390-drivers.md#c.ccw_device "ccw_device") is meant to be set to the interrupt
