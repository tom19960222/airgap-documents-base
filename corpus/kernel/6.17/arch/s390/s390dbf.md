...
collection: kernel
version: "6.17"
title: "S390 Debug Feature"
source_url: https://www.kernel.org/doc/html/v6.17/arch/s390/s390dbf.html
fetched_at: 2026-09-16T16:25:06+00:00
---
# S390 Debug Feature
...
feature with the function call [`debug_register()`](s390dbf.md#c.debug_register "debug_register").
...
used through registering them with the function [`debug_register_view()`](s390dbf.md#c.debug_register_view "debug_register_view").
...
`...`
:   varargs used as in [`sprintf()`](../../core-api/kernel-api.md#c.sprintf "sprintf")
...
for the length of the data field in [`debug_register()`](s390dbf.md#c.debug_register "debug_register") in
...
byte data area in the [`debug_register()`](s390dbf.md#c.debug_register "debug_register") function.
