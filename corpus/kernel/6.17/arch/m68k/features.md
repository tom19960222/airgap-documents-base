...
collection: kernel
version: "6.17"
title: "Feature status on m68k architecture"
source_url: https://www.kernel.org/doc/html/v6.17/arch/m68k/features.html
fetched_at: 2026-09-16T16:24:24+00:00
---
...
| core | generic-idle-thread | GENERIC_SMP_IDLE_THREAD | TODO | arch makes use of the generic SMP idle thread facility |
| core | jump-labels | HAVE_ARCH_JUMP_LABEL | TODO | arch supports live patched, high efficiency branches |
| core | mseal-system-mappings | ARCH_SUPPORTS_MSEAL_SYSTEM_MAPPINGS | N/A | arch supports mseal system mappings |
...
| core | tracehook | HAVE_ARCH_TRACEHOOK | TODO | arch supports tracehook (ptrace) register handling APIs |
...
| locking | lockdep | LOCKDEP_SUPPORT | TODO | arch supports the runtime locking correctness debug facility |
...
| time | clockevents | !LEGACY_TIMER_TICK | TODO | arch support generic clock events |
