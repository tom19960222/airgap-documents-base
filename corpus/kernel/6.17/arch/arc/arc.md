...
collection: kernel
version: "6.17"
title: "Linux kernel for ARC processors"
source_url: https://www.kernel.org/doc/html/v6.17/arch/arc/arc.html
...
- <https://embarc.org> - Community portal for open source on ARC.
...
- [Official Synopsys ARC Processors website](https://www.synopsys.com/designware-ip/processor-solutions.html) -
  location, with access to some IP documentation ([Programmer’s Reference
  Manual, AKA PRM for ARC HS processors](https://www.synopsys.com/dw/doc.php/ds/cc/programmers-reference-manual-ARC-HS.pdf))
  and free versions of some commercial tools ([Free nSIM](https://www.synopsys.com/cgi-bin/dwarcnsim/req1.cgi) and
  [MetaWare Light Edition](https://www.synopsys.com/cgi-bin/arcmwtk_lite/reg1.cgi)).
