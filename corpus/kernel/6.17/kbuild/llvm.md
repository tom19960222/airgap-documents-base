...
source_url: https://www.kernel.org/doc/html/v6.17/kbuild/llvm.html
fetched_at: 2026-09-16T16:23:24+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/kbuild/llvm.md)
...
such as GCC and binutils. Ongoing work has allowed for [Clang](https://clang.llvm.org/) and [LLVM](https://llvm.org/) utilities to be
used as viable substitutes. Distributions such as [Android](https://www.android.com/), [ChromeOS](https://www.chromium.org/chromium-os), [OpenMandriva](https://www.openmandriva.org/), and [Chimera Linux](https://chimera-linux.org/) use Clang built kernels. Google’s and Meta’s
...
objects](https://www.aosabook.org/en/llvm.html). Clang is a front-end to LLVM
...
[KBUILD_BUILD_TIMESTAMP](kbuild.md#kbuild-build-timestamp) should be set to a deterministic value between builds
in order to avoid 100% cache misses, see [Reproducible_builds](reproducible-builds.md#timestamps) for more info):
...
| s390 | Maintained | `LLVM=1` (LLVM >= 18.1.0), `CC=clang` (LLVM < 18.1.0) |
...
- [Mailing List](https://lore.kernel.org/llvm/): <[llvm@lists.linux.dev](mailto:llvm%40lists.linux.dev)>
- [Old Mailing List Archives](https://groups.google.com/g/clang-built-linux)
...
- [Beginner Bugs](https://github.com/ClangBuiltLinux/linux/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)

## Getting LLVM

We provide prebuilt stable versions of LLVM on [kernel.org](https://kernel.org/pub/tools/llvm/). These have been optimized with profile
