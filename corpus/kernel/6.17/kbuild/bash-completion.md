...
collection: kernel
version: "6.17"
title: "Bash completion for Kbuild"
source_url: https://www.kernel.org/doc/html/v6.17/kbuild/bash-completion.html
fetched_at: 2026-09-16T16:23:26+00:00
---
# Bash completion for Kbuild

The kernel build system is written using Makefiles, and Bash completion
for the make command is available through the [bash-completion](https://github.com/scop/bash-completion/) project.
...
The script relies on helper functions provided by [bash-completion](https://github.com/scop/bash-completion/) project.
