...
source_url: https://www.kernel.org/doc/html/v6.17/kbuild/makefiles.html
fetched_at: 2026-09-16T16:23:21+00:00
---
...
Section [Goal definitions](makefiles.md#goal-definitions) is a quick intro; further chapters provide
...
([`module_init()`](../driver-api/basics.md#c.module_init "module_init") / __initcall) will be called during boot in the
...
See also [List directories to visit when descending](makefiles.md#list-directories-to-visit-when-descending).
...
used in conjunction with custom rules as defined in [Custom Rules](makefiles.md#custom-rules).
...
From command line, [USERCFLAGS and USERLDFLAGS](kbuild.md#userkbuildflags) will also be used.
...
:   Generic $(LD) options
    ...
    the flags used. See [Non-builtin vmlinux targets - extra-y](makefiles.md#non-builtin-vmlinux-targets-extra-y).
...
:   Assembler options specific for modules
    ...
    From commandline AFLAGS_MODULE shall be used (see [Kbuild](kbuild.md)).
...
:   Options for $(CC) when building modules
    ...
    From commandline CFLAGS_MODULE shall be used (see [Kbuild](kbuild.md)).
...
:   Options for $(RUSTC) when building modules
    ...
    From commandline RUSTFLAGS_MODULE shall be used (see [Kbuild](kbuild.md)).
...
:   Options for $(LD) when linking modules
    ...
    From commandline LDFLAGS_MODULE shall be used (see [Kbuild](kbuild.md)).
...
See [generic-y](makefiles.md#generic-y) for further info on syntax etc.
...
- Original version made by Michael Elizabeth Chastain, <[mailto:mec@shout.net](mailto:mec%40shout.net)>
- Updates by Kai Germaschewski <[kai@tp1.ruhr-uni-bochum.de](mailto:kai%40tp1.ruhr-uni-bochum.de)>
- Updates by Sam Ravnborg <[sam@ravnborg.org](mailto:sam%40ravnborg.org)>
- Language QA by Jan Engelhardt <[jengelh@gmx.de](mailto:jengelh%40gmx.de)>
