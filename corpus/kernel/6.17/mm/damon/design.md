...
version: "6.17"
title: "Design"
source_url: https://www.kernel.org/doc/html/v6.17/mm/damon/design.html
fetched_at: 2026-09-16T16:52:01+00:00
---
English

- [Chinese (Simplified)](../../translations/zh_CN/mm/damon/design.md)
...
[DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface) documentation.

## Overall Architecture

DAMON subsystem is configured with three layers including

- [Operations Set](design.md#damon-operations-set): Implements fundamental
...
- [Core](design.md#damon-core-logic): Implements core logics including monitoring
  overhead/accuracy control and access-aware system operations on top of the
  operations set layer, and
- [Modules](design.md#damon-modules): Implements kernel modules for various
...
To know how user-space can do the configuration via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [operations](../../admin-guide/mm/damon/usage.md#sysfs-context) file part of the
documentation.
...
To know how user-space can set the attributes via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [monitoring_attrs](../../admin-guide/mm/damon/usage.md#sysfs-monitoring-attrs)
...
[DAMOS tried regions](../../admin-guide/mm/damon/usage.md#sysfs-schemes-tried-regions) and [Tracepoints for Monitoring Results](../../admin-guide/mm/damon/usage.md#tracepoint),
respectively.
...
to converge regions with the [regions adjustment mechanism](design.md#damon-design-adaptive-regions-adjustment) can be too long, depending on the
...
intervals auto tuning mechanism. Please refer to [the design document of
the feature](design.md#damon-design-monitoring-intervals-autotuning) for detail.

Refer to below documents for an example tuning based on the above guide.

- [DAMON Moniting Interval Parameters Tuning Example](monitoring_intervals_tuning_example.md)

#### Monitoring Intervals Auto-tuning

DAMON provides automatic tuning of the `sampling interval` and `aggregation
interval` based on the [the tuning guide idea](design.md#damon-design-monitoring-params-tuning-guide). The tuning mechanism allows
...
DAMON [region assumption](design.md#damon-design-region-based-sampling). For
...
To know how user-space can use this feature via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [intervals_goal](../../admin-guide/mm/damon/usage.md#sysfs-scheme) part of
the documentation.
...
To know how user-space can set `apply_interval` via [DAMON sysfs
interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [apply_interval_us](../../admin-guide/mm/damon/usage.md#sysfs-scheme)
part of the documentation.
...
To know how user-space can set the action via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [action](../../admin-guide/mm/damon/usage.md#sysfs-scheme) part of the
documentation.
...
To know how user-space can set the access pattern via [DAMON sysfs
interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [access_pattern](../../admin-guide/mm/damon/usage.md#sysfs-access-pattern) part of the documentation.
...
To know how user-space can set the basic quotas via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [quotas](../../admin-guide/mm/damon/usage.md#sysfs-quotas) part of the
documentation.
...
To know how user-space can set the prioritization weights via [DAMON sysfs
interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [weights](../../admin-guide/mm/damon/usage.md#sysfs-quotas) part of
the documentation.
...
the current value via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to
[quota goals](../../admin-guide/mm/damon/usage.md#sysfs-schemes-quota-goals) part of the documentation.
...
To know how user-space can set the watermarks via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [watermarks](../../admin-guide/mm/damon/usage.md#sysfs-watermarks) part of the
documentation.
...
To know how user-space can set the filters via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to [filters](../../admin-guide/mm/damon/usage.md#sysfs-filters) part of the
documentation.
...
the region is eligible to apply the scheme’s [action](design.md#damon-design-damos-action). The [access pattern](design.md#damon-design-damos-access-pattern), [quotas](design.md#damon-design-damos-quotas), [watermarks](design.md#damon-design-damos-watermarks), and [filters](design.md#damon-design-damos-filters) that handled on core logic could affect this.
The core logic will only ask the underlying [operation set](design.md#damon-operations-set) to do apply the action to the region, so whether the
action is really applied or not is unclear. That’s why it is called “tried”.

“A scheme is applied to a region” means the [operation set](design.md#damon-operations-set) has applied the action to at least a part of the
region. The [filters](design.md#damon-design-damos-filters) that handled by the
operation set, and the types of the [action](design.md#damon-design-damos-action)
...
To know how user-space can read the stats via [DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface), refer to :ref:s`stats <sysfs_stats>` part of the
documentation.

#### Regions Walking

DAMOS feature allowing users access each region that a DAMOS action has just
applied. Using this feature, DAMON [API](design.md#damon-design-api) allows users
...
[DAMON sysfs interface](../../admin-guide/mm/damon/usage.md#sysfs-interface) also allows users read the data
via special [files](../../admin-guide/mm/damon/usage.md#sysfs-schemes-tried-regions).
...
[document](api.md) for details of the interface.
...
available. Please refer to the ABI [doc](../../admin-guide/mm/damon/usage.md#sysfs-interface) for details of
the interfaces.
...
([DAMON-based Reclamation](../../admin-guide/mm/damon/reclaim.md) and
[DAMON-based LRU-lists Sorting](../../admin-guide/mm/damon/lru_sort.md)).
