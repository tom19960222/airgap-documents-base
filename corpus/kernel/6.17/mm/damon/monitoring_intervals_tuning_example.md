...
collection: kernel
version: "6.17"
title: "DAMON Moniting Interval Parameters Tuning Example"
source_url: https://www.kernel.org/doc/html/v6.17/mm/damon/monitoring_intervals_tuning_example.html
fetched_at: 2026-09-16T16:56:19+00:00
---
...
monitoring purpose. There is a [tuning guide](design.md#damon-design-monitoring-params-tuning-guide) for that. This document
provides an example tuning based on the guide.

## Setup

For below example, DAMON of Linux kernel v6.11 and [damo](https://github.com/damonitor/damo) (DAMON user-space tool) v2.5.9 was used to
...
regions detection. According to the [guide](design.md#damon-design-monitoring-params-tuning-guide), this is due to the too short
