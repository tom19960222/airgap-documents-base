...
source_url: https://www.kernel.org/doc/html/v6.17/mm/memory-model.html
fetched_at: 2026-09-16T16:36:13+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/memory-model.md)
...
usable until the call to [`memblock_free_all()`](../core-api/boot-time-mm.md#c.memblock_free_all "memblock_free_all") that hands all the
memory to the page allocator.

An architecture may free parts of the mem_map array that do not cover the
actual physical pages. In such case, the architecture specific
[`pfn_valid()`](../core-api/mm-api.md#c.pfn_valid "pfn_valid") implementation should take the holes in the
...
[`devm_memremap_pages()`](../core-api/mm-api.md#c.devm_memremap_pages "devm_memremap_pages"), performs just enough memory hotplug to
...
common alignment granularity for [`devm_memremap_pages()`](../core-api/mm-api.md#c.devm_memremap_pages "devm_memremap_pages").
