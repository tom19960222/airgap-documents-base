...
source_url: https://www.kernel.org/doc/html/v6.17/mm/allocation-profiling.html
...
e.g. [`kmalloc()`](../core-api/mm-api.md#c.kmalloc "kmalloc") and do a little more work, then are called in multiple places;
