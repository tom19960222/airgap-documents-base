...
collection: kernel
version: "6.17"
title: "Hugetlbfs Reservation"
source_url: https://www.kernel.org/doc/html/v6.17/mm/hugetlbfs_reserv.html
fetched_at: 2026-09-16T16:33:14+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/hugetlbfs_reserv.md)

# Hugetlbfs Reservation

## Overview

Huge pages as described at [HugeTLB Pages](../admin-guide/mm/hugetlbpage.md) are
...
section [Reservation Map Modifications](hugetlbfs_reserv.md#resv-map-modifications)
for details on how this is accomplished.

The mapping may be associated with a subpool. If so, the subpool is consulted
to ensure there is sufficient space for the mapping. It is possible that the
subpool has set aside reservations that can be used for the mapping. See the
section [Subpool Reservations](hugetlbfs_reserv.md#sub-pool-resv) for more details.
...
[Reservation Map Helper Routines](hugetlbfs_reserv.md#resv-map-helpers) for detailed
...
[Reservation Map Helper Routines](hugetlbfs_reserv.md#resv-map-helpers) for more
...
[Consuming Reservations/Allocating a Huge Page](hugetlbfs_reserv.md#consume-resv)
...
2. 1. If the operation can succeed, `region_add()` is called to actually modify
      the reservation map for the same range [f, t) previously passed to
      `region_chg()`.
   2. If the operation can not succeed, region_abort is called for the same
...
[Reservation Map Helper Routines](hugetlbfs_reserv.md#resv-map-helpers), reservation
