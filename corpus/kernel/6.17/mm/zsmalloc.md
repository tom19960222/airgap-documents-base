...
version: "6.17"
title: "zsmalloc"
source_url: https://www.kernel.org/doc/html/v6.17/mm/zsmalloc.html
fetched_at: 2026-09-16T16:29:03+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/zsmalloc.md)
...
Additionally, [`zs_malloc()`](zsmalloc.md#c.zs_malloc "zs_malloc") does not return a dereferenceable pointer.
...
void obj_to_location(unsigned long obj, struct [zpdesc](zsmalloc.md#c.obj_to_location "zpdesc") \*\*zpdesc, unsigned int \*obj_idx)
:   get (<zpdesc>, <obj_idx>) from encoded object value
...
:   zpdesc object resides in zspage

`unsigned int *obj_idx`
:   object index

unsigned long location_to_obj(struct [zpdesc](zsmalloc.md#c.location_to_obj "zpdesc") \*zpdesc, unsigned int obj_idx)
:   get obj value encoded from (<zpdesc>, <obj_idx>)
...
the index of the zsmalloc `size_class` that hold objects of the
provided size.
...
`const int nid`
:   The preferred node id to allocate new zspage (if needed)

**Description**

On success, handle to the allocated object is returned,
otherwise an [`ERR_PTR()`](../core-api/kernel-api.md#c.ERR_PTR "ERR_PTR").
