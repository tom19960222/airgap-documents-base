...
source_url: https://www.kernel.org/doc/html/v6.17/mm/physical_memory.html
fetched_at: 2026-09-16T16:36:04+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/physical_memory.md)
...
be discussed further in Section [Nodes](physical_memory.md#nodes)
...
- `ZONE_DMA` and `ZONE_DMA32` historically represented memory suitable for
  ...
  memory with DMA specific requirements ([Dynamic DMA mapping using the generic device](../core-api/dma-api.md)),
...
- `ZONE_MOVABLE` is for normal accessible memory, just like `ZONE_NORMAL`.
  ...
  [Page migration](page_migration.md) and
  [Memory Hot(Un)Plug](../admin-guide/mm/memory-hotplug.md) for additional details.
- `ZONE_DEVICE` represents memory residing on devices such as PMEM and GPU.
  It has different characteristics than RAM zone types and it exists to provide
  [struct page](physical_memory.md#pages) and memory map services for device driver
...
discussed further in Section [Zones](physical_memory.md#zones).
...
[NUMA Memory Policy](../admin-guide/mm/numa_memory_policy.md).
...
[Initialization](physical_memory.md#initialization).
...
See also [Page Reclaim](page_reclaim.md).
...
The page allocator uses the GFP flags, see [Memory Allocation Controls](../core-api/mm-api.md#mm-api-gfp-flags), specified by
