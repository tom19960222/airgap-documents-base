...
source_url: https://www.kernel.org/doc/html/v6.17/mm/transhuge.html
fetched_at: 2026-09-16T16:36:18+00:00
---
...
All tail pages have zero ->_refcount until [`atomic_add()`](../driver-api/basics.md#c.atomic_add "atomic_add"). This prevents the
scanner from getting a reference to the tail page up to that point. After the
[`atomic_add()`](../driver-api/basics.md#c.atomic_add "atomic_add") we don’t care about the ->_refcount value. We already know how
