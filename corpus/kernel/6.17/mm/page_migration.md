...
source_url: https://www.kernel.org/doc/html/v6.17/mm/page_migration.html
fetched_at: 2026-09-16T16:29:13+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/mm/page_migration.md)
...
Also see [Heterogeneous Memory Management (HMM)](hmm.md) for migrating pages to or from device
private memory.
...
[CPUSETS](../admin-guide/cgroup-v1/cpusets.md#cpusets)).
...
1. Remove folios from the LRU.
   ...
   calling [`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru").
   Calling [`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru") increases the references to the folio
...
already been removed from the LRU via [`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru") and the refcount
...
The “[`struct movable_operations`](page_migration.md#c.movable_operations "movable_operations")” provide callbacks specific to a page type
...
1. a page type
2. indicating them as possibly having movable_ops in [`page_has_movable_ops()`](../core-api/mm-api.md#c.page_has_movable_ops "page_has_movable_ops")
   based on the page type
3. returning the movable_ops from `page_movable_ops()` based on the page
   type
4. not reusing the PG_movable_ops and PG_movable_ops_isolated page flags
   for other purposes
