...
source_url: https://www.kernel.org/doc/html/v6.17/mm/unevictable-lru.html
fetched_at: 2026-09-16T16:36:19+00:00
---
# Unevictable LRU Infrastructure

- [Introduction](unevictable-lru.md#introduction)
- [The Unevictable LRU](unevictable-lru.md#the-unevictable-lru)

  - [The Unevictable LRU Folio List](unevictable-lru.md#the-unevictable-lru-folio-list)
  - [Memory Control Group Interaction](unevictable-lru.md#memory-control-group-interaction)
  - [Marking Address Spaces Unevictable](unevictable-lru.md#marking-address-spaces-unevictable)
  - [Detecting Unevictable Pages](unevictable-lru.md#detecting-unevictable-pages)
  - [Vmscan’s Handling of Unevictable Folios](unevictable-lru.md#vmscan-s-handling-of-unevictable-folios)
- [MLOCKED Pages](unevictable-lru.md#mlocked-pages)

  - [History](unevictable-lru.md#history)
  - [Basic Management](unevictable-lru.md#basic-management)
  - [mlock()/mlock2()/mlockall() System Call Handling](unevictable-lru.md#mlock-mlock2-mlockall-system-call-handling)
  - [Filtering Special VMAs](unevictable-lru.md#filtering-special-vmas)
  - [munlock()/munlockall() System Call Handling](unevictable-lru.md#munlock-munlockall-system-call-handling)
  - [Migrating MLOCKED Pages](unevictable-lru.md#migrating-mlocked-pages)
  - [Compacting MLOCKED Pages](unevictable-lru.md#compacting-mlocked-pages)
  - [MLOCKING Transparent Huge Pages](unevictable-lru.md#mlocking-transparent-huge-pages)
  - [mmap(MAP_LOCKED) System Call Handling](unevictable-lru.md#mmap-map-locked-system-call-handling)
  - [munmap()/exit()/exec() System Call Handling](unevictable-lru.md#munmap-exit-exec-system-call-handling)
  - [Truncating MLOCKED Pages](unevictable-lru.md#truncating-mlocked-pages)
  - [Page Reclaim in shrink_\*_list()](unevictable-lru.md#page-reclaim-in-shrink-list)

## [Introduction](unevictable-lru.md#id1)
...
## [The Unevictable LRU](unevictable-lru.md#id2)
...
### [The Unevictable LRU Folio List](unevictable-lru.md#id3)
...
>    detected by [`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru"), we would prevent their migration.
...
### [Memory Control Group Interaction](unevictable-lru.md#id4)

The unevictable LRU facility interacts with the memory control group [aka
memory controller; see [Memory Resource Controller](../admin-guide/cgroup-v1/memory.md)] by
...
### [Marking Address Spaces Unevictable](unevictable-lru.md#id5)
...
### [Detecting Unevictable Pages](unevictable-lru.md#id6)

The function `folio_evictable()` in mm/internal.h determines whether a folio is
evictable or not using the query function outlined above [see section
[Marking address spaces unevictable](unevictable-lru.md#mark-addr-space-unevict)]
...
### [Vmscan’s Handling of Unevictable Folios](unevictable-lru.md#id7)
...
will be detected when vmscan walks the reverse map in [`folio_referenced()`](../core-api/mm-api.md#c.folio_referenced "folio_referenced")
or [`try_to_unmap()`](../core-api/mm-api.md#c.try_to_unmap "try_to_unmap"). The folio is culled to the unevictable list when it
is released by the shrinker.

To “cull” an unevictable folio, vmscan simply puts the folio back on
the LRU list using [`folio_putback_lru()`](../core-api/mm-api.md#c.folio_putback_lru "folio_putback_lru") - the inverse operation to
[`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru") - after dropping the folio lock. Because the
...
[`folio_isolate_lru()`](../core-api/mm-api.md#c.folio_isolate_lru "folio_isolate_lru") could not detect them, and the LRU list link field was not
...
### [Basic Management](unevictable-lru.md#id10)
...
>    reclaim a page in a VM_LOCKED VMA by [`folio_referenced()`](../core-api/mm-api.md#c.folio_referenced "folio_referenced") or [`try_to_unmap()`](../core-api/mm-api.md#c.try_to_unmap "try_to_unmap").
...
### [mlock()/mlock2()/mlockall() System Call Handling](unevictable-lru.md#id11)
...
it is a newly allocated anonymous page, [`folio_add_lru_vma()`](../core-api/mm-api.md#c.folio_add_lru_vma "folio_add_lru_vma") calls
...
### [Filtering Special VMAs](unevictable-lru.md#id12)
...
### [munlock()/munlockall() System Call Handling](unevictable-lru.md#id13)
...
### [Migrating MLOCKED Pages](unevictable-lru.md#id14)
...
### [Compacting MLOCKED Pages](unevictable-lru.md#id15)
...
controls this behavior (see [Documentation for /proc/sys/vm/](../admin-guide/sysctl/vm.md)). The work
...
### [MLOCKING Transparent Huge Pages](unevictable-lru.md#id16)
...
### [mmap(MAP_LOCKED) System Call Handling](unevictable-lru.md#id17)
...
### [munmap()/exit()/exec() System Call Handling](unevictable-lru.md#id18)
...
### [Truncating MLOCKED Pages](unevictable-lru.md#id19)
...
[`release_pages()`](../core-api/mm-api.md#c.release_pages "release_pages") (or `__page_cache_release()`) to clear it and update statistics
before freeing (this event is counted in /proc/vmstat unevictable_pgs_cleared,
which is usually 0).

### [Page Reclaim in shrink_\*_list()](unevictable-lru.md#id20)
