...
collection: kernel
version: "6.17"
title: "SCSI FC Transport"
source_url: https://www.kernel.org/doc/html/v6.17/scsi/scsi_fc_transport.html
fetched_at: 2026-09-16T16:42:50+00:00
---
# SCSI FC Transport
...
This file is found at [SCSI FC Transport](scsi_fc_transport.md)
...
> fc_rport_identifiers structure and invokes [`fc_remote_port_add()`](../driver-api/scsi.md#c.fc_remote_port_add "fc_remote_port_add") to
...
>
> For developers: use [`fc_remote_port_add()`](../driver-api/scsi.md#c.fc_remote_port_add "fc_remote_port_add") and [`fc_remote_port_delete()`](../driver-api/scsi.md#c.fc_remote_port_delete "fc_remote_port_delete") when
...
> >
> >   > - Call [`scsi_host_alloc()`](../driver-api/scsi.md#c.scsi_host_alloc "scsi_host_alloc") to allocate a scsi_host for the vport.
...
> will call [`fc_remove_host()`](../driver-api/scsi.md#c.fc_remove_host "fc_remove_host") for the vports scsi_host, followed by
> [`scsi_remove_host()`](../driver-api/scsi.md#c.scsi_remove_host "scsi_remove_host") and [`scsi_host_put()`](../driver-api/scsi.md#c.scsi_host_put "scsi_host_put") for the vports scsi_host.
...
:   fc_host port_type attribute:
    ...
    Driver unload:
    :   FC drivers are required to call [`fc_remove_host()`](../driver-api/scsi.md#c.fc_remove_host "fc_remove_host") prior to calling
        [`scsi_remove_host()`](../driver-api/scsi.md#c.scsi_remove_host "scsi_remove_host"). This allows the fc_host to tear down all remote
        ports prior the scsi_host being torn down. The [`fc_remove_host()`](../driver-api/scsi.md#c.fc_remove_host "fc_remove_host") call
...
James Smart
[james.smart@broadcom.com](mailto:james.smart%40broadcom.com)
