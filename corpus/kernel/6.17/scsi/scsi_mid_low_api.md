...
source_url: https://www.kernel.org/doc/html/v6.17/scsi/scsi_mid_low_api.html
fetched_at: 2026-09-16T16:42:39+00:00
---
...
format. This file is named [SCSI mid_level - lower_level driver interface](scsi_mid_low_api.md) and can be
found in that directory. A more recent copy of this document may be found
at <https://docs.kernel.org/scsi/scsi_mid_low_api.html>. Many LLDs are
documented in Documentation/scsi (e.g. [Adaptec Aic7xxx Fast -> Ultra160 Family Manager Set v7.0](aic7xxx.md)). The SCSI mid-level is
briefly described in [SCSI subsystem documentation](scsi.md) which contains a URL to a document describing
...
[`scsi_host_alloc()`](../driver-api/scsi.md#c.scsi_host_alloc "scsi_host_alloc"). Those interface functions that the LLD does not
...
[`scsi_change_queue_depth()`](../driver-api/scsi.md#c.scsi_change_queue_depth "scsi_change_queue_depth") in its `sdev_configure()` routine.
...
HBA is added, the [`scsi_scan_host()`](../driver-api/scsi.md#c.scsi_scan_host "scsi_scan_host") function causes a scan for SCSI devices
...
is passed to [`scsi_host_alloc()`](../driver-api/scsi.md#c.scsi_host_alloc "scsi_host_alloc").
...
should be passed to the mid level’s [`scsi_host_alloc()`](../driver-api/scsi.md#c.scsi_host_alloc "scsi_host_alloc").
.
...
There is one “`struct scsi_host_template`” instance per LLD [[1]](scsi_mid_low_api.md#id2). It is
...
>       [`scsi_host_alloc()`](../driver-api/scsi.md#c.scsi_host_alloc "scsi_host_alloc").
