...
collection: kernel
version: "6.17"
title: "Megaraid Common Management Module"
source_url: https://www.kernel.org/doc/html/v6.17/scsi/megaraid.html
fetched_at: 2026-09-16T16:33:54+00:00
---
...
> 1. Avoid duplicate code from the low level drivers.
> 2. Unburden the low level drivers from having to export the
>    character node device and related handling.
> 3. Implement any policy mechanisms in one place.
> 4. Applications have to interface with only module instead of
...
- Jeff Garzik ([jgarzik@pobox.com](mailto:jgarzik%40pobox.com)), 02.25.2004 LKML
...
- Matt Domsch, ([Matt_Domsch@dell.com](mailto:Matt_Domsch%40dell.com)), 02.25.2004 LKML
