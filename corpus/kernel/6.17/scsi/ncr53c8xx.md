...
collection: kernel
version: "6.17"
title: "NCR53C8XX/SYM53C8XX drivers"
source_url: https://www.kernel.org/doc/html/v6.17/scsi/ncr53c8xx.html
fetched_at: 2026-09-16T16:42:47+00:00
---
# NCR53C8XX/SYM53C8XX drivers

Written by Gerard Roudier <[groudier@free.fr](mailto:groudier%40free.fr)>
...
> - Gerard Roudier <[groudier@free.fr](mailto:groudier%40free.fr)>

The original driver has been written for 386bsd and FreeBSD by:

> - Wolfgang Stanglmeier <[wolf@cologne.de](mailto:wolf%40cologne.de)>
> - Stefan Esser <[se@mi.Uni-Koeln.de](mailto:se%40mi.Uni-Koeln.de)>
...
| 1010_66 [[1]](ncr53c8xx.md#id2) | Y | Y | FAST80 | 160 MB/s | N | Y |
...
Module:
:   allow to load the driver

Memory mapped I/O:
:   increases performance

Profiling information:
:   read operations from the proc SCSI file system
...
>
> tags:
> :   number of concurrent tagged commands
...
| sync:#factor | |  |  | | --- | --- | | #factor = 10 | Ultra-2 SCSI 40 Mega-transfers / second | | #factor = 11 | Ultra-2 SCSI 33 Mega-transfers / second | | #factor < 25 | Ultra SCSI 20 Mega-transfers / second | | #factor < 50 | Fast SCSI-2 | |
...
| iarb:#x | use this feature according to bit fields as follow:   |  |  | | --- | --- | | bit 0 (1) | enable IARB each time the initiator has been reselected when it arbitrated for the SCSI BUS. | | (#x >> 4) | maximum number of successive settings of IARB if the initiator win arbitration and it has other commands to send to a device. | |
...
1. Allow the initiator with ID 7 to win arbitration when it wants so.
2. Overlap at least 4 micro-seconds of arbitration time with the execution
...
> My email address: Gerard Roudier <[groudier@free.fr](mailto:groudier%40free.fr)>
...
Field CSIST io register (SCSI Interrupt Status)
:   |  |  |
    | --- | --- |
...
(added by Richard Waltham: [dormouse@farsrobt.demon.co.uk](mailto:dormouse%40farsrobt.demon.co.uk))
...
added to the driver by Cort <[cort@cs.nmt.edu](mailto:cort%40cs.nmt.edu)> and is available in driver
