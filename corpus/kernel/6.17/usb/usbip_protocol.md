...
source_url: https://www.kernel.org/doc/html/v6.17/usb/usbip_protocol.html
fetched_at: 2026-09-16T16:35:08+00:00
---
# USB/IP protocol
...
| 4 | 4 | 0x00000000 | Status:  - 0 for OK - 1 for error |
...
| 0xC | 4 | direction:  - 0: USBIP_DIR_OUT - 1: USBIP_DIR_IN  only used by client, for server this shall be 0 |
...
| 0x14 | 4 | transfer_flags: possible values depend on the USBIP_URB transfer_flags. Refer to include/uapi/linux/usbip.h and [USB Request Block (URB)](../driver-api/usb/URB.md). Refer to `usbip_pack_cmd_submit()` and `tweak_transfer_flags()` in drivers/usb/usbip/ usbip_common.c. |
