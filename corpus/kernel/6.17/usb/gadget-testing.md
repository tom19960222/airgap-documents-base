...
source_url: https://www.kernel.org/doc/html/v6.17/usb/gadget-testing.html
fetched_at: 2026-09-16T16:46:17+00:00
---
# Gadget Testing
...
- run a program which writes to /dev/hidg<N>, e.g.
  a userspace program found in [Linux USB HID gadget driver](gadget_hid.md):
...
> | host_addr | MAC address of host’s end of this Ethernet over USB link |
> | dev_addr | MAC address of device’s end of this Ethernet over USB link |
> | max_segment_size | Segment size required for P2P connections. This will set MTU to 14 bytes |
...
described in [Linux USB Printer Gadget Driver](gadget_printer.md).
