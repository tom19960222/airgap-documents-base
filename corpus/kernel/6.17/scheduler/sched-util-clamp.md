...
source_url: https://www.kernel.org/doc/html/v6.17/scheduler/sched-util-clamp.html
fetched_at: 2026-09-16T16:38:15+00:00
---
...
See [section 3.4](sched-util-clamp.md#uclamp-default-values) for default values and
[3.4.1](sched-util-clamp.md#sched-util-clamp-min-rt-default) on how to change RT tasks
default value.
...
uclamp value of the rq. See [section 2.1](sched-util-clamp.md#uclamp-buckets) for details on
how this works.
...
See [section 3.4](sched-util-clamp.md#uclamp-default-values) for details on default values.
...
As we shall see in [section 5.1](sched-util-clamp.md#uclamp-capping-fail), this max
...
[Section 3](sched-util-clamp.md#uclamp-interfaces) discusses the interfaces and will expand
further on that.
...
- cpu.uclamp.min is a protection as described in [section 3-3 of cgroup
  v2 documentation](../admin-guide/cgroup-v2.md#cgroupv2-protections-distributor).
...
- cpu.uclamp.max is a limit as described in [section 3-2 of cgroup v2
  documentation](../admin-guide/cgroup-v2.md#cgroupv2-limits-distributor).
