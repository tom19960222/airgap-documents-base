...
source_url: https://www.kernel.org/doc/html/v6.17/scheduler/sched-bwc.html
fetched_at: 2026-09-16T16:38:11+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/scheduler/sched-bwc.md)
- [Spanish](../translations/sp_SP/scheduler/sched-bwc.md)
...
> The SCHED_RT case is covered in [Real-Time group scheduling](sched-rt-group.md)
...
> [Documentation/admin-guide/cgroup-v2.rst](../admin-guide/cgroup-v2.md#cgroup-v2-cpu).
...
instances it will be up to the CFS algorithm (see [CFS Scheduler](sched-design-CFS.md)) to
