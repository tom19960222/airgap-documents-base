...
source_url: https://www.kernel.org/doc/html/v6.17/scheduler/sched-energy.html
fetched_at: 2026-09-16T16:38:14+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/scheduler/sched-energy.md)
...
please refer to its documentation (see [Energy Model of devices](../power/energy-model.md)).
...
per ‘performance domain’ in the system (see [Energy Model of devices](../power/energy-model.md)
...
em_perf_domain`](../power/energy-model.md#c.em_perf_domain "em_perf_domain") as provided by the EM framework.
...
> 1. there is some idle time on all CPUs, so the utilization signals used by
>    EAS are likely to accurately represent the ‘size’ of the various tasks
>    in the system;
> 2. all tasks should already be provided with enough CPU capacity,
>    regardless of their nice values;
> 3. since there is spare capacity all tasks must be blocking/sleeping
...
See [Capacity Aware Scheduling](sched-capacity.md) for requirements to be met for this
...
independent EM framework in [Energy Model of devices](../power/energy-model.md).
