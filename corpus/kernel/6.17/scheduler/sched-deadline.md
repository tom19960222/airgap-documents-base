...
source_url: https://www.kernel.org/doc/html/v6.17/scheduler/sched-deadline.html
fetched_at: 2026-09-16T16:38:11+00:00
---
...
> State transitions:
>
> > 1. When a task blocks, it does not become immediately inactive since its
...
> > 2. If the task wakes up before the inactive timer fires, the task re-enters
...
> > 3. When the “inactive timer” fires, the task enters the Inactive state and
> >    its utilization is removed from the runqueue’s active utilization.
> > 4. When an inactive task wakes up, it enters the ActiveContending state and
...
> [Real-Time group scheduling](sched-rt-group.md)), and is based on readable/
...
> See [Documentation/admin-guide/cgroup-v1/cpusets.rst](../admin-guide/cgroup-v1/cpusets.md#cpusets) and
> [Documentation/admin-guide/cgroup-v2.rst](../admin-guide/cgroup-v2.md#cgroup-v2) for more information.
