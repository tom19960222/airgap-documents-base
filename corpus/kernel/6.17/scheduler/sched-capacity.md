...
source_url: https://www.kernel.org/doc/html/v6.17/scheduler/sched-capacity.html
fetched_at: 2026-09-16T16:38:14+00:00
---
English

- [Chinese (Simplified)](../translations/zh_CN/scheduler/sched-capacity.md)
...
[Control Group v2](../admin-guide/cgroup-v2.md)). As its name imply, this can be used to
...
> (EAS), which is described in [Energy Aware Scheduling](sched-energy.md).
