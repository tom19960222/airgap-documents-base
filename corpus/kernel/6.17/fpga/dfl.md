...
collection: kernel
version: "6.17"
title: "FPGA Device Feature List (DFL) Framework Overview"
source_url: https://www.kernel.org/doc/html/v6.17/fpga/dfl.html
fetched_at: 2026-09-16T16:32:59+00:00
---
# FPGA Device Feature List (DFL) Framework Overview

Authors:

- Enno Luebbers <[enno.luebbers@intel.com](mailto:enno.luebbers%40intel.com)>
- Xiao Guangrong <[guangrong.xiao@linux.intel.com](mailto:guangrong.xiao%40linux.intel.com)>
- Wu Hao <[hao.wu@intel.com](mailto:hao.wu%40intel.com)>
- Xu Yilun <[yilun.xu@intel.com](mailto:yilun.xu%40intel.com)>
...
> 1. Expose static FPGA region information, e.g. version and metadata.
>    Users can read related information via sysfs interfaces exposed
>    by FME driver.
> 2. Partial Reconfiguration. The FME driver creates FPGA manager, FPGA
...
1. The PF owns all AFU ports by default. Any port that needs to be
   reassigned to a VF must first be released through the
   DFL_FPGA_FME_PORT_RELEASE ioctl on the FME device.
2. Once N ports are released from PF, then user can use command below
...
4. The AFU under VF is accessible from applications in VM (using the
