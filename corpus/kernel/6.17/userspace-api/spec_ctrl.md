...
collection: kernel
version: "6.17"
title: "Speculation Control"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/spec_ctrl.html
fetched_at: 2026-09-16T16:23:35+00:00
---
# Speculation Control
...
| --- | --- | --- |
| 0 | PR_SPEC_PRCTL | Mitigation can be controlled per task by PR_SET_SPECULATION_CTRL. |
...
| 4 | PR_SPEC_DISABLE_NOEXEC | Same as PR_SPEC_DISABLE, but the state will be cleared on *execve(2)*. |
...
is selected by arg2 of *prctl(2)* per task. arg3 is used to hand
