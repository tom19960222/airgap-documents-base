...
collection: kernel
version: "6.17"
title: "GPIO_GET_LINEHANDLE_IOCTL"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/gpio/gpio-get-linehandle-ioctl.html
fetched_at: 2026-09-16T16:28:40+00:00
---
...
`request`
:   The [`handle_request`](chardev_v1.md#c.gpiohandle_request "gpiohandle_request") specifying the lines to
...
In all cases, the configuration reported by [GPIO_GET_LINEINFO_IOCTL](gpio-get-lineinfo-ioctl.md)
...
On success 0 and the [`request.fd`](chardev_v1.md#c.gpiohandle_request "gpiohandle_request") contains the
