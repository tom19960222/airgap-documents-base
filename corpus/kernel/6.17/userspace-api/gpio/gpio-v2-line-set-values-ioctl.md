...
collection: kernel
version: "6.17"
title: "GPIO_V2_LINE_SET_VALUES_IOCTL"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/gpio/gpio-v2-line-set-values-ioctl.html
...
`values`
:   The [`line_values`](chardev.md#c.gpio_v2_line_values "gpio_v2_line_values") to set with the `mask` set
