...
collection: kernel
version: "6.17"
title: "GPIO_V2_LINE_EVENT_READ"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/gpio/gpio-v2-line-event-read.html
...
`buf`
:   The buffer to contain the [`events`](chardev.md#c.gpio_v2_line_event "gpio_v2_line_event").

`count`
:   The number of bytes available in `buf`, which must be at
    least the size of a [`gpio_v2_line_event`](chardev.md#c.gpio_v2_line_event "gpio_v2_line_event").
...
[`request.event_buffer_size`](chardev.md#c.gpio_v2_line_request "gpio_v2_line_request").
...
Changing the edge detection flags using [GPIO_V2_LINE_SET_CONFIG_IOCTL](gpio-v2-line-set-config-ioctl.md)
...
[`gpio_v2_line_event`](chardev.md#c.gpio_v2_line_event "gpio_v2_line_event") event.
