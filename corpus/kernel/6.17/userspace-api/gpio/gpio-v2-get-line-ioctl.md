...
collection: kernel
version: "6.17"
title: "GPIO_V2_GET_LINE_IOCTL"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/gpio/gpio-v2-get-line-ioctl.html
...
`request`
:   The [`line_request`](chardev.md#c.gpio_v2_line_request "gpio_v2_line_request") specifying the lines
...
as possible. e.g. [GPIO_V2_LINE_GET_VALUES_IOCTL](gpio-v2-line-get-values-ioctl.md) will read all the
...
The [`debounce_period_us`](chardev.md#c.gpio_v2_line_attribute "gpio_v2_line_attribute") attribute may only
be applied to lines with `GPIO_V2_LINE_FLAG_INPUT` set. When set, debounce
applies to both the values returned by [GPIO_V2_LINE_GET_VALUES_IOCTL](gpio-v2-line-get-values-ioctl.md) and
the edges returned by [GPIO_V2_LINE_EVENT_READ](gpio-v2-line-event-read.md). If not
...
In all cases, the configuration reported by [GPIO_V2_GET_LINEINFO_IOCTL](gpio-v2-get-lineinfo-ioctl.md)
...
On success 0 and the [`request.fd`](chardev.md#c.gpio_v2_line_request "gpio_v2_line_request") contains the
