...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/gpio/sysfs.html
fetched_at: 2026-09-16T16:54:37+00:00
---
# GPIO Sysfs Interface for Userspace

> **Warning:**
>
> This API is obsoleted by the [GPIO Character Device Userspace API](chardev.md) and the ABI documentation has
> been moved to [ABI file obsolete/sysfs-gpio](../../admin-guide/abi-obsolete-files.md#abi-file-obsolete-sysfs-gpio).
>
> New developments should use the [GPIO Character Device Userspace API](chardev.md), and existing developments are
...
> Please read [Subsystem drivers using GPIO](../../driver-api/gpio/drivers-on-gpio.md)
...
the sysfs interface by [`gpiod_export()`](../../driver-api/gpio/index.md#c.gpiod_export "gpiod_export"). The driver can control whether the
...
After the GPIO has been exported, [`gpiod_export_link()`](../../driver-api/gpio/index.md#c.gpiod_export_link "gpiod_export_link") allows creating
