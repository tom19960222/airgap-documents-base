...
collection: kernel
version: "6.17"
title: "5.4. ioctl MEDIA_IOC_DEVICE_INFO"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/mediactl/media-ioc-device-info.html
fetched_at: 2026-09-16T16:29:04+00:00
---
...
`argp`
:   Pointer to struct [`media_device_info`](media-ioc-device-info.md#c.MC.media_device_info "media_device_info").
...
a struct [`media_device_info`](media-ioc-device-info.md#c.MC.media_device_info "media_device_info"). The driver
