...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/cec/cec-ioc-adap-g-caps.html
...
| `CEC_CAP_REPLY_VENDOR_ID` | 0x00000200 | If this capability is set, then [CEC_MSG_FL_REPLY_VENDOR_ID](cec-ioc-receive.md#cec-msg-flags) can be used. |
