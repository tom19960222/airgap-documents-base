...
collection: kernel
version: "6.17"
title: "2.3. Standard Image Formats"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/pixfmt-intro.html
fetched_at: 2026-09-16T16:55:18+00:00
---
...
defined in the [videodev2.h](videodev.md#videodev) header file. These
identifiers represent
[four character (FourCC) codes](vidioc-enum-fmt.md#v4l2-fourcc) which are also
...
[YUV422](pixfmt-yuv-planar.md#v4l2-pix-fmt-yuv422m) frame is normally stored in one
