...
collection: kernel
version: "6.17"
title: "7.64. ioctl VIDIOC_SUBDEV_G_CLIENT_CAP, VIDIOC_SUBDEV_S_CLIENT_CAP"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-subdev-g-client-cap.html
fetched_at: 2026-09-16T16:30:15+00:00
---
...
`argp`
:   Pointer to struct [`v4l2_subdev_client_capability`](vidioc-subdev-g-client-cap.md#c.V4L.v4l2_subdev_client_capability "v4l2_subdev_client_capability").
...
[`v4l2_subdev_client_capability`](vidioc-subdev-g-client-cap.md#c.V4L.v4l2_subdev_client_capability "v4l2_subdev_client_capability") to reflect the capabilities that have
...
|  |  |  |
| --- | --- | --- |
| __u64 | `capabilities` | Sub-device client capabilities of the opened device. |
