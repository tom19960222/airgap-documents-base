...
collection: kernel
version: "6.17"
title: "1.11. Camera Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-camera.html
fetched_at: 2026-09-16T16:51:20+00:00
---
...
:   Enables or disables the camera’s wide dynamic range feature. This
    ...
    different exposure times. [[1]](ext-ctrls-camera.md#f1)
...
:   Determines ISO equivalent of an image sensor indicating the sensor’s
    ...
    as per [ISO 12232:2006](biblio.md#iso12232) standard, where doubling the sensor
...
|  |  |
| --- | --- |
| `V4L2_CAMERA_ORIENTATION_FRONT` | The camera is oriented towards the user facing side of the device. |
| `V4L2_CAMERA_ORIENTATION_BACK` | The camera is oriented towards the back facing side of the device. |
| `V4L2_CAMERA_ORIENTATION_EXTERNAL` | The camera is not directly attached to the device and is freely movable. |
