...
collection: kernel
version: "6.17"
title: "1.12. Flash Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-flash.html
...
## 1.12.1. Supported use cases

### 1.12.1.1. Unsynchronised LED flash (software strobe)
...
### 1.12.1.2. Synchronised LED flash (hardware strobe)
...
### 1.12.1.3. LED flash as torch

LED flash may be used as torch in conjunction with another use case
involving camera or individually.

### 1.12.1.4. Flash Control IDs
