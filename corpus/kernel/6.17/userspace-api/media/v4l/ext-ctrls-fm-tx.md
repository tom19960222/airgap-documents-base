...
collection: kernel
version: "6.17"
title: "1.20. FM Transmitter Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-fm-tx.html
fetched_at: 2026-09-16T16:51:21+00:00
---
...
:   Sets the Programme Service name (PS_NAME) for transmission. It is
    ...
    Annex E of [IEC 62106](biblio.md#iec62106), the RDS specification, there is a full
...
:   Sets the Radio Text info for transmission. It is a textual
    ...
    E of [IEC 62106](biblio.md#iec62106). The length of Radio Text strings depends on
...
:   Sets the
    [Artificial Head](http://en.wikipedia.org/wiki/Artificial_head)
...
For more details about RDS specification, refer to [IEC 62106](biblio.md#iec62106)
