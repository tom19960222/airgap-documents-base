...
collection: kernel
version: "6.17"
title: "1.19. RF Tuner Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-rf-tuner.html
fetched_at: 2026-09-16T16:51:24+00:00
---
...
[Tuner (radio)](http://en.wikipedia.org/wiki/Tuner_%28radio%29)
and [RF front end](http://en.wikipedia.org/wiki/RF_front_end)
from Wikipedia.

## 1.19.1. RF_TUNER Control IDs
