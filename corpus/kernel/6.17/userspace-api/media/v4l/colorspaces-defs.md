...
collection: kernel
version: "6.17"
title: "2.16. Defining Colorspaces in V4L2"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/colorspaces-defs.html
fetched_at: 2026-09-16T16:30:32+00:00
---
# 2.16. Defining Colorspaces in V4L2

In V4L2 colorspaces are defined by four values. The first is the
colorspace identifier (enum [`v4l2_colorspace`](colorspaces-defs.md#c.v4l2_colorspace "v4l2_colorspace"))
...
[`v4l2_xfer_func`](colorspaces-defs.md#c.v4l2_xfer_func "v4l2_xfer_func")) to specify non-standard
transfer functions. The third is the Y’CbCr encoding identifier (enum
[`v4l2_ycbcr_encoding`](colorspaces-defs.md#c.v4l2_ycbcr_encoding "v4l2_ycbcr_encoding")) to specify
non-standard Y’CbCr encodings and the fourth is the quantization
identifier (enum [`v4l2_quantization`](colorspaces-defs.md#c.v4l2_quantization "v4l2_quantization")) to
specify non-standard quantization methods. Most of the time only the
colorspace field of struct [`v4l2_pix_format`](pixfmt-v4l2.md#c.v4l2_pix_format "v4l2_pix_format")
or struct [`v4l2_pix_format_mplane`](pixfmt-v4l2-mplane.md#c.v4l2_pix_format_mplane "v4l2_pix_format_mplane")
needs to be filled in.

On [HSV formats](hsv-formats.md#hsv-formats) the *Hue* is defined as the angle on
...
[`v4l2_hsv_encoding`](colorspaces-defs.md#c.v4l2_hsv_encoding "v4l2_hsv_encoding") specifies which encoding is used.
...
| `V4L2_COLORSPACE_SMPTE170M` | See [Colorspace SMPTE 170M (V4L2_COLORSPACE_SMPTE170M)](colorspaces-details.md#col-smpte-170m). |
| `V4L2_COLORSPACE_REC709` | See [Colorspace Rec. 709 (V4L2_COLORSPACE_REC709)](colorspaces-details.md#col-rec709). |
| `V4L2_COLORSPACE_SRGB` | See [Colorspace sRGB (V4L2_COLORSPACE_SRGB)](colorspaces-details.md#col-srgb). |
| `V4L2_COLORSPACE_OPRGB` | See [Colorspace opRGB (V4L2_COLORSPACE_OPRGB)](colorspaces-details.md#col-oprgb). |
| `V4L2_COLORSPACE_BT2020` | See [Colorspace BT.2020 (V4L2_COLORSPACE_BT2020)](colorspaces-details.md#col-bt2020). |
| `V4L2_COLORSPACE_DCI_P3` | See [Colorspace DCI-P3 (V4L2_COLORSPACE_DCI_P3)](colorspaces-details.md#col-dcip3). |
| `V4L2_COLORSPACE_SMPTE240M` | See [Colorspace SMPTE 240M (V4L2_COLORSPACE_SMPTE240M)](colorspaces-details.md#col-smpte-240m). |
| `V4L2_COLORSPACE_470_SYSTEM_M` | See [Colorspace NTSC 1953 (V4L2_COLORSPACE_470_SYSTEM_M)](colorspaces-details.md#col-sysm). |
| `V4L2_COLORSPACE_470_SYSTEM_BG` | See [Colorspace EBU Tech. 3213 (V4L2_COLORSPACE_470_SYSTEM_BG)](colorspaces-details.md#col-sysbg). |
| `V4L2_COLORSPACE_JPEG` | See [Colorspace JPEG (V4L2_COLORSPACE_JPEG)](colorspaces-details.md#col-jpeg). |
...
| `V4L2_XFER_FUNC_SMPTE2084` | Use the SMPTE 2084 transfer function. See [Transfer Function SMPTE 2084 (V4L2_XFER_FUNC_SMPTE2084)](colorspaces-details.md#xf-smpte-2084). |
