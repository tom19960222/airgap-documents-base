...
collection: kernel
version: "6.17"
title: "7.27. ioctl VIDIOC_G_EDID, VIDIOC_S_EDID, VIDIOC_SUBDEV_G_EDID, VIDIOC_SUBDEV_S_EDID"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-g-edid.html
fetched_at: 2026-09-16T16:29:58+00:00
---
...
`argp`
:   Pointer to struct [`v4l2_edid`](vidioc-g-edid.md#c.V4L.v4l2_edid "v4l2_edid").
...
returned by [ioctl VIDIOC_ENUMINPUT](vidioc-enuminput.md#vidioc-enuminput) and
[ioctl VIDIOC_ENUMOUTPUT](vidioc-enumoutput.md#vidioc-enumoutput) respectively. When used
...
array and call [VIDIOC_G_EDID](vidioc-g-edid.md#vidioc-g-edid). The current EDID from block
...
[VIDIOC_G_EDID](vidioc-g-edid.md#vidioc-g-edid) is called, then the driver will set `blocks` to the
...
|  |  |  |
| --- | --- | --- |
| __u32 | `pad` | Pad for which to get/set the EDID blocks. When used with a video device node the pad represents the input or output index as returned by [ioctl VIDIOC_ENUMINPUT](vidioc-enuminput.md#vidioc-enuminput) and [ioctl VIDIOC_ENUMOUTPUT](vidioc-enumoutput.md#vidioc-enumoutput) respectively. |
