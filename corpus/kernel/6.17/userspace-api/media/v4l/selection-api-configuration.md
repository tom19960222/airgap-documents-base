...
collection: kernel
version: "6.17"
title: "1.27.3. Configuration"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/selection-api-configuration.html
fetched_at: 2026-09-16T16:55:16+00:00
---
# 1.27.3. Configuration

Applications can use the [selection API](vidioc-g-selection.md#vidioc-g-selection) to
...
[constraint flags](v4l2-selection-flags.md#v4l2-selection-flags).

## 1.27.3.1. Configuration of video capture

See figure [Cropping and composing targets](selection-api-targets.md#sel-targets-capture) for examples of the selection
...
the image size set by [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt).
...
## 1.27.3.2. Configuration of video output
...
specified using [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt) ioctl.
