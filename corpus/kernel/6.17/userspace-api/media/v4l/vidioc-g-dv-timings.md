...
collection: kernel
version: "6.17"
title: "7.26. ioctl VIDIOC_G_DV_TIMINGS, VIDIOC_S_DV_TIMINGS"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-g-dv-timings.html
fetched_at: 2026-09-16T16:29:50+00:00
---
...
[VIDIOC_S_DV_TIMINGS](vidioc-g-dv-timings.md#vidioc-g-dv-timings) ioctl and to get the current timings,
applications use the [VIDIOC_G_DV_TIMINGS](vidioc-g-dv-timings.md#vidioc-g-dv-timings) ioctl. The detailed timing
information is filled in using the structure struct
[`v4l2_dv_timings`](vidioc-g-dv-timings.md#c.V4L.v4l2_dv_timings "v4l2_dv_timings"). These ioctls take a
pointer to the struct [`v4l2_dv_timings`](vidioc-g-dv-timings.md#c.V4L.v4l2_dv_timings "v4l2_dv_timings")
...
the formats in the [CEA-861-E](biblio.md#cea861) and [VESA DMT](biblio.md#vesadmt) standards. If
the current input or output does not support DV timings (e.g. if
[ioctl VIDIOC_ENUMINPUT](vidioc-enuminput.md#vidioc-enuminput) does not set the
...
EINVAL
:   This ioctl is not supported, or the [VIDIOC_S_DV_TIMINGS](vidioc-g-dv-timings.md#vidioc-g-dv-timings)
...
| __u32 | `standards` | The video standard(s) this format belongs to. This will be filled in by the driver. Applications must set this to 0. See [DV BT Timing standards](vidioc-g-dv-timings.md#dv-bt-standards) for a list of standards. |
| __u32 | `flags` | Several flags giving more information about the format. See [DV BT Timing flags](vidioc-g-dv-timings.md#dv-bt-flags) for a description of the flags. |
| struct [`v4l2_fract`](vidioc-enumstd.md#c.V4L.v4l2_fract "v4l2_fract") | `picture_aspect` | The picture aspect if the pixels are not square. Only valid if the `V4L2_DV_FL_HAS_PICTURE_ASPECT` flag is set. |
...
| union { | (anonymous) | |
| struct [`v4l2_bt_timings`](vidioc-g-dv-timings.md#c.V4L.v4l2_bt_timings "v4l2_bt_timings") | `bt` | Timings defined by BT.656/1120 specifications |
| __u32 | `reserved`[32] |  |
| } |  | |
