...
collection: kernel
version: "6.17"
title: "7.62. ioctl VIDIOC_SUBDEV_G_ROUTING, VIDIOC_SUBDEV_S_ROUTING"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-subdev-g-routing.html
fetched_at: 2026-09-16T16:30:19+00:00
---
...
[`v4l2_subdev_route`](vidioc-subdev-g-routing.md#c.V4L.v4l2_subdev_route "v4l2_subdev_route"). Similarly to `VIDIOC_SUBDEV_G_ROUTING`, also
...
| __u32 | `len_routes` | The length of the array (as in memory reserved for the array) |
...
| __u32 | `reserved`[11] | Reserved for future extensions. Applications and drivers must set the array to zero. |
