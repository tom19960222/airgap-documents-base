...
collection: kernel
version: "6.17"
title: "1.9. User Controls"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/control.html
fetched_at: 2026-09-16T16:51:16+00:00
---
# 1.9. User Controls
...
controls using `V4L2_CID_PRIVATE_BASE` [[1]](control.md#f1) and higher values. The
pre-defined control IDs have the prefix `V4L2_CID_`, and are listed in
[Control IDs](control.md#control-id). The ID is used when querying the attributes of a
...
change value (see
[ioctl VIDIOC_SUBSCRIBE_EVENT, VIDIOC_UNSUBSCRIBE_EVENT](vidioc-subscribe-event.md#vidioc-subscribe-event), event
...
| `V4L2_COLORFX_SET_RGB` | The RGB components are replaced by the fixed RGB components determined by `V4L2_CID_COLORFX_RGB` control. |
...
:   Rotates the image by specified angle. Common angles are 90, 270 and
    ...
    [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt) ioctl according to the
...
:   Sets the alpha color component. When a capture device (or capture
    ...
    [packed RGB image formats](pixfmt-rgb.md#pixfmt-rgb)) and the alpha value
...
:   ID of the first custom (driver specific) control. Applications
    ...
    and version, see [Querying Capabilities](querycap.md#querycap).

Applications can enumerate the available controls with the
[ioctls VIDIOC_QUERYCTRL, VIDIOC_QUERY_EXT_CTRL and VIDIOC_QUERYMENU](vidioc-queryctrl.md#vidioc-queryctrl) and
[VIDIOC_QUERYMENU](vidioc-queryctrl.md#vidioc-queryctrl) ioctls, get and set a
control value with the [VIDIOC_G_CTRL](vidioc-g-ctrl.md#vidioc-g-ctrl) and
[VIDIOC_S_CTRL](vidioc-g-ctrl.md#vidioc-g-ctrl) ioctls. Drivers must implement
...
## 1.9.2. Example: Enumerating all controls
...
## 1.9.3. Example: Enumerating all controls including compound controls
...
## 1.9.4. Example: Enumerating all user controls (old style)
...
## 1.9.5. Example: Changing controls
...
instead of using [ioctls VIDIOC_QUERYCTRL, VIDIOC_QUERY_EXT_CTRL and VIDIOC_QUERYMENU](vidioc-queryctrl.md#vidioc-queryctrl) with
