...
collection: kernel
version: "6.17"
title: "2.13.4. V4L2_META_FMT_IPU3_PARAMS (‘ip3p’), V4L2_META_FMT_IPU3_3A (‘ip3s’)"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/metafmt-intel-ipu3.html
fetched_at: 2026-09-16T16:28:55+00:00
---
# 2.13.4. V4L2_META_FMT_IPU3_PARAMS (‘ip3p’), V4L2_META_FMT_IPU3_3A (‘ip3s’)

## 2.13.4.1. 3A statistics
...
## 2.13.4.3. Intel IPU3 ImgU uAPI data types
