...
collection: kernel
version: "6.17"
title: "7.60. ioctl VIDIOC_SUBDEV_G_FMT, VIDIOC_SUBDEV_S_FMT"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-subdev-g-fmt.html
fetched_at: 2026-09-16T16:30:16+00:00
---
...
`argp`
:   Pointer to struct [`v4l2_subdev_format`](vidioc-subdev-g-fmt.md#c.V4L.v4l2_subdev_format "v4l2_subdev_format").
...
struct [`v4l2_subdev_format`](vidioc-subdev-g-fmt.md#c.V4L.v4l2_subdev_format "v4l2_subdev_format") to the desired
...
[`v4l2_subdev_format`](vidioc-subdev-g-fmt.md#c.V4L.v4l2_subdev_format "v4l2_subdev_format") contains the current
...
| __u32 | `which` | Format to modified, from enum [v4l2_subdev_format_whence](vidioc-subdev-g-fmt.md#v4l2-subdev-format-whence). |
| struct [`v4l2_mbus_framefmt`](subdev-formats.md#c.v4l2_mbus_framefmt "v4l2_mbus_framefmt") | `format` | Definition of an image format, see [`v4l2_mbus_framefmt`](subdev-formats.md#c.v4l2_mbus_framefmt "v4l2_mbus_framefmt") for details. |
...
EINVAL
:   The struct [`v4l2_subdev_format`](vidioc-subdev-g-fmt.md#c.V4L.v4l2_subdev_format "v4l2_subdev_format") `pad` references a non-existing
