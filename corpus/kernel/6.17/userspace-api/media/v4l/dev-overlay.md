...
collection: kernel
version: "6.17"
title: "4.2. Video Overlay Interface"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/dev-overlay.html
fetched_at: 2026-09-16T16:30:31+00:00
---
...
files as [video capture](dev-capture.md#capture) devices.
...
with V4L and earlier versions of V4L2. [[1]](dev-overlay.md#f1)

A common application of two file descriptors is the X11
[Xv/V4L](hist-v4l2.md#xvideo) interface driver and a V4L2 application.
...
[ioctl VIDIOC_QUERYCAP](vidioc-querycap.md#vidioc-querycap) ioctl. The overlay I/O
method specified below must be supported. Tuners and audio inputs are
optional.

## 4.2.2. Supplemental Functions

Video overlay devices shall support [audio input](audio.md#audio),
...
[video input](video.md#video) and [video standard](standard.md#standard)
...
[VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf) ioctls are available to get and
set these parameters, respectively. The [VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf) ioctl is
...
driver. The [VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf) ioctl is not privileged. An application
can check for this type of device by calling the [VIDIOC_G_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf)
ioctl.
...
([VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt)) or overlay
([VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf)) may fail with an `EBUSY` error
...
given in [Image Cropping, Insertion and Scaling -- the CROP API](crop.md#crop).

The overlay window is described by a struct
[`v4l2_window`](dev-overlay.md#c.v4l2_window "v4l2_window"). It defines the size of the image,
...
call the [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt) ioctl. The driver
adjusts the parameters against hardware limits and returns the actual
parameters as [VIDIOC_G_FMT](vidioc-g-fmt.md#vidioc-g-fmt) does. Like [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt), the
[VIDIOC_TRY_FMT](vidioc-g-fmt.md#vidioc-g-fmt) ioctl can be used to learn
...
height given in struct [`v4l2_window`](dev-overlay.md#c.v4l2_window "v4l2_window") and the size
of the cropping rectangle. For more information see [Image Cropping, Insertion and Scaling -- the CROP API](crop.md#crop).
...
([VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt)) may fail with an `EBUSY` error
code or return accordingly modified parameters.
...
:   Size and position of the window relative to the top, left corner of
    ...
    [VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf). The window can extend the
...
:   *Note: support for this has been removed.*
    ...
    contents after calling [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt)
    are undefined.
...
:   *Note: support for this has been removed.*
    ...
    after calling [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt) are undefined. When clip lists are
...
where `0` ≤ x < `w.width` and `0` ≤ y <`w.height`. [[2]](dev-overlay.md#f2)

When a clipping bit mask is not supported the driver ignores this field,
its contents after calling [VIDIOC_S_FMT](vidioc-g-fmt.md#vidioc-g-fmt) are
...
exceeded are undefined. [[3]](dev-overlay.md#f3)
...
:   The global alpha value used to blend the framebuffer with video
    ...
    [VIDIOC_S_FBUF](vidioc-g-fbuf.md#vidioc-g-fbuf),
    [Frame Buffer Flags](vidioc-g-fbuf.md#framebuffer-flags)).

> **Note:**
>
> This field was added in Linux 2.6.23, extending the
> structure. However the [VIDIOC_[G|S|TRY]_FMT](vidioc-g-fmt.md#vidioc-g-fmt)
> ioctls, which take a pointer to a `v4l2_format`
> parent structure with padding bytes at the end, are not affected.

type v4l2_clip

### 4.2.4.2. struct v4l2_clip [[4]](dev-overlay.md#f4)
...
[ioctl VIDIOC_OVERLAY](vidioc-overlay.md#vidioc-overlay) ioctl.

[[1](dev-overlay.md#id1)]
