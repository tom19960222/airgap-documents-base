...
collection: kernel
version: "6.17"
title: "1.21. FM Receiver Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-fm-rx.html
fetched_at: 2026-09-16T16:51:23+00:00
---
...
:   Gets the Programme Service name (PS_NAME). It is intended for
    ...
    [IEC 62106](biblio.md#iec62106), the RDS specification, there is a full
...
:   Gets the Radio Text info. It is a textual description of what is
    ...
    also fully described in Annex E of [IEC 62106](biblio.md#iec62106). The length of
