...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/vidioc-enum-fmt.html
fetched_at: 2026-09-16T16:30:03+00:00
---
...
| `V4L2_FMT_FLAG_META_LINE_BASED` | 0x0200 | The metadata format is line-based. In this case the `width`, `height` and `bytesperline` fields of [`v4l2_meta_format`](dev-meta.md#c.v4l2_meta_format "v4l2_meta_format") are valid. The buffer consists of `height` lines, each having `width` Data Units of data and the offset (in bytes) between the beginning of each two consecutive lines is `bytesperline`. |
