...
collection: kernel
version: "6.17"
title: "4.5. Video Memory-To-Memory Interface"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/dev-mem2mem.html
fetched_at: 2026-09-16T16:51:28+00:00
---
...
both sides and finally call [VIDIOC_STREAMON](vidioc-streamon.md#vidioc-streamon)
...
See [Codec Control Reference](ext-ctrls-codec.md#codec-controls). More details on how to use codec memory-to-memory
