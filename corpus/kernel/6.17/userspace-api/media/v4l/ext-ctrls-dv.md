...
collection: kernel
version: "6.17"
title: "1.18. Digital Video Control Reference"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/v4l/ext-ctrls-dv.html
fetched_at: 2026-09-16T16:55:14+00:00
---
# 1.18. Digital Video Control Reference

The Digital Video control class is intended to control receivers and
transmitters for [VGA](http://en.wikipedia.org/wiki/Vga),
[DVI](http://en.wikipedia.org/wiki/Digital_Visual_Interface)
(Digital Visual Interface), HDMI ([HDMI](biblio.md#hdmi)) and DisplayPort
([DP](biblio.md#dp)). These controls are generally expected to be private to
...
> Identification Data, [EDID](biblio.md#vesaedid)) and HDCP (High-bandwidth Digital
> Content Protection System, [HDCP](biblio.md#hdcp)) processing, allowing the
...
## 1.18.1. Digital Video Control IDs
...
:   Select the quantization range for RGB output. V4L2_DV_RANGE_AUTO
    ...
    video interface (ie. [CEA-861-E](biblio.md#cea861) for HDMI).
