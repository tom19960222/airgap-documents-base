...
collection: kernel
version: "6.17"
title: "6.2.3.3. DVB OSD Device"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/dvb/legacy_dvb_osd.html
...
The installed memory size can be identified with the [OSD_GET_CAPABILITY](legacy_dvb_osd.md#osd-get-capability)
ioctl.
...
| Command | Used variables of `struct` [osd_cmd_t](legacy_dvb_osd.md#osd-cmd-t).  Usage{variable} if alternative use. | Description | | |
| --- | --- | --- | --- | --- |
...
| `OSD_OpenRaw` | x0,y0,x1,y1,  [osd_raw_window_t](legacy_dvb_osd.md#osd-raw-window-t) {color} | Open other types of OSD windows. | | |

#### 6.2.3.3.1.1.3. Description

The `OSD_Command` data type is used with the [OSD_SEND_CMD](legacy_dvb_osd.md#osd-send-cmd) ioctl to
...
|  |  |
| --- | --- |
| `OSD_Command cmd` | [OSD_Command](legacy_dvb_osd.md#osd-command) to be executed. |
...
The `osd_cmd_t` data type is used with the [OSD_SEND_CMD](legacy_dvb_osd.md#osd-send-cmd) ioctl.
It contains the data for the OSD_Command and the [OSD_Command](legacy_dvb_osd.md#osd-command) itself.
...
The `osd_raw_window_t` data type is used with the [OSD_Command](legacy_dvb_osd.md#osd-command)
...
This structure of data used with the [OSD_GET_CAPABILITY](legacy_dvb_osd.md#osd-get-capability) call.
...
|  |  |  |
| --- | --- | --- |
| `int fd` | File descriptor returned by a previous call to [open()](legacy_dvb_osd.md#open). | |
| `int request` | Pointer to the location of the structure [osd_cmd_t](legacy_dvb_osd.md#osd-cmd-t) for this command. | |
...
This ioctl sends the [OSD_Command](legacy_dvb_osd.md#osd-command) to the card.
...
| `unsigned int *cap` | Pointer to the location of the structure [osd_cap_t](legacy_dvb_osd.md#osd-cap-t) for this command. | |
