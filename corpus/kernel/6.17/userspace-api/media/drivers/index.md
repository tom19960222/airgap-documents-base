...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/drivers/index.html
fetched_at: 2026-09-16T16:49:51+00:00
---
...
- [10. THine THP7312 ISP driver](thp7312.md)
- [11. The Linux USB Video Class (UVC) driver](uvcvideo.md)
  - [11.1. Extension Unit (XU) support](uvcvideo.md#extension-unit-xu-support)
    - [11.1.1. Introduction](uvcvideo.md#introduction)
    - [11.1.2. Control mappings](uvcvideo.md#control-mappings)
    - [11.1.3. Security](uvcvideo.md#security)
    - [11.1.4. Debugging](uvcvideo.md#debugging)
    - [11.1.5. IOCTL reference](uvcvideo.md#ioctl-reference)
      - [11.1.5.1. UVCIOC_CTRL_MAP - Map a UVC control to a V4L2 control](uvcvideo.md#uvcioc-ctrl-map-map-a-uvc-control-to-a-v4l2-control)
      - [11.1.5.2. UVCIOC_CTRL_QUERY - Query a UVC XU control](uvcvideo.md#uvcioc-ctrl-query-query-a-uvc-xu-control)
  - [11.2. Driver-specific V4L2 controls](uvcvideo.md#driver-specific-v4l2-controls)
- [12. ST VGXY61 camera sensor driver](vgxy61.md)
  - [12.1. `V4L2_CID_HDR_SENSOR_MODE`](vgxy61.md#v4l2-cid-hdr-sensor-mode)
