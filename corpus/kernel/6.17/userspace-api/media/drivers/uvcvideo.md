...
collection: kernel
version: "6.17"
title: "11. The Linux USB Video Class (UVC) driver"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/drivers/uvcvideo.html
...
## 11.1. Extension Unit (XU) support
...
### 11.1.5. IOCTL reference

#### 11.1.5.1. UVCIOC_CTRL_MAP - Map a UVC control to a V4L2 control
...
#### 11.1.5.2. UVCIOC_CTRL_QUERY - Query a UVC XU control
...
## 11.2. Driver-specific V4L2 controls
...
:   This control determines the region of interest (ROI). ROI is a
    rectangular area represented by a struct [`v4l2_rect`](../v4l/dev-overlay.md#c.v4l2_rect "v4l2_rect"). The
