...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/drivers/ccs.html
...
Also see [the CCS driver kernel documentation](../../../driver-api/media/drivers/ccs/ccs.md#media-ccs-driver).
