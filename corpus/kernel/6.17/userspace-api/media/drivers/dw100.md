...
collection: kernel
version: "6.17"
title: "5. DW100 dewarp driver"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/media/drivers/dw100.html
...
*chapter 13.15 DeWarp* of [IMX8MP](https://www.nxp.com/webapp/Download?colCode=IMX8MPRM) reference manual.

The Vivante DW100 m2m driver implements the following driver-specific control:

`V4L2_CID_DW100_DEWARPING_16x16_VERTEX_MAP (__u32 array)`
:   Specifies to DW100 driver its dewarping map (aka LUT) blob as described in
    *chapter 13.15.2.3 Dewarping Remap* of [IMX8MP](https://www.nxp.com/webapp/Download?colCode=IMX8MPRM) reference manual as an U32
