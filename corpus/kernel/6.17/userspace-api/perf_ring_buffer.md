...
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/perf_ring_buffer.html
fetched_at: 2026-09-16T16:23:45+00:00
---
# Perf ring buffer
...
[2.3.3 Writing samples into buffer](perf_ring_buffer.md#writing-samples-into-buffer).
...
section [2.3.5 Memory synchronization](perf_ring_buffer.md#memory-synchronization).
...
| Mapping mode | Forward | Backward |
| --- | --- | --- |
| read-write | Non-overwrite ring buffer | Not used |
| read-only | Not used | Overwritable ring buffer |
...
[2.3.5 Memory synchronization](perf_ring_buffer.md#memory-synchronization). Since the AUX ring buffer is managed by the
