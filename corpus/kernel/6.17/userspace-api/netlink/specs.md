...
collection: kernel
version: "6.17"
title: "Netlink protocol specifications (in YAML)"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/netlink/specs.html
fetched_at: 2026-09-16T16:35:21+00:00
---
...
> - the C uAPI header
> - documentation of the protocol as a ReST file - see [Documentation/networking/netlink_spec/index.rst](../../networking/netlink_spec/index.md#specs)
...
See [Using Netlink protocol specifications](intro-specs.md) for a practical starting guide.
...
schema. See the documentation of [genetlink-c](c-code-gen.md)
for information on how C names are derived from name properties.

See also [Documentation/core-api/netlink.rst](../../core-api/netlink.md#kernel-netlink) for
...
Netlink attribute type, see [Attribute types](specs.md#attr-types).
...
more detail in [Netlink specification support for legacy Generic Netlink families](genetlink-legacy.md).
...
[attribute values](specs.md#assign-val).
...
or both of these properties, each holding a [Message attribute list](specs.md#attr-list).
...
Specification of attributes in the event, holds a [Message attribute list](specs.md#attr-list).
...
See [pad](specs.md#pad-type) for padding of 64 bit attributes.
