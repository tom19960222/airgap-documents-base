...
collection: kernel
version: "6.17"
title: "Netlink specification support for raw Netlink families"
source_url: https://www.kernel.org/doc/html/v6.17/userspace-api/netlink/netlink-raw.html
fetched_at: 2026-09-16T16:49:53+00:00
---
...
The netlink-raw schema extends the [genetlink-legacy](genetlink-legacy.md)
schema with properties that are needed to specify the protocol numbers and
multicast IDs used by raw netlink families. See [Classic Netlink](intro.md#classic-netlink) for more
...
[rt-link](../../networking/netlink_spec/rt-link.md) and
[tc](../../networking/netlink_spec/tc.md) use attribute nesting as an
...
Many raw netlink families such as [tc](../../networking/netlink_spec/tc.md)
