...
source_url: https://github.com/influxdata/telegraf/blob/fd4af886672c8256ff17c888935a801d941894c4/docs/EXTERNAL_PLUGINS.md
...
5. Optionally add a [plugin.conf](./example/cmd/plugin.conf) <!-- unresolved-source-link: target=./example/cmd/plugin.conf --> for configuration
