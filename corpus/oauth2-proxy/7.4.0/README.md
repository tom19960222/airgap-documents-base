...
version: "7.4.0"
title: "README"
source_url: https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/README.md
...
[![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE) <!-- unresolved-source-link: target=./LICENSE -->
...
A list of changes can be seen in the [CHANGELOG](CHANGELOG.md) <!-- unresolved-source-link: target=CHANGELOG.md -->.
...
Please see our [Contributing](CONTRIBUTING.md) <!-- unresolved-source-link: target=CONTRIBUTING.md --> guidelines. For releasing see our [release creation guide](RELEASE.md) <!-- unresolved-source-link: target=RELEASE.md -->.
