...
version: "7.4.0"
title: "Overview"
source_url: https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/docs/versioned_docs/version-7.4.x/configuration/overview.md
...
An example [oauth2-proxy.cfg](https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/contrib/oauth2-proxy.cfg.example) config file is in the contrib directory. It can be used by specifying `--config=/etc/oauth2-proxy.cfg`
