---
collection: oauth2-proxy
version: "7.4.0"
title: "OAuth Provider Configuration"
source_url: https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/docs/versioned_docs/version-7.4.x/configuration/auth.md
fetched_at: 2022-10-29T13:27:20+01:00
---
...
See also [our local testing environment](https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/contrib/local-environment) for a self-contained example using Docker and etcd as storage for Dex.
...
Follow the examples in the [`providers` package](https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/providers/) to define a new
`Provider` instance. Add a new `case` to
[`providers.New()`](https://github.com/oauth2-proxy/oauth2-proxy/blob/aafa96655048bc1ed26487e92410f5fe64968fa2/providers/providers.go) to allow `oauth2-proxy` to use the
new `Provider`.
