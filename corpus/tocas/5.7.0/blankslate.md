...
version: "5.7.0"
title: "空白看板 - Tocas UI"
source_url: https://github.com/teacat/tocas-docs/blob/ef8248b165f458215fb8f18bb400c4bfba1767fa/docs/5.7/zh-tw/blankslate.html
...
### [可互動的](blankslate.md#interactive)
...
### [上傳區域](blankslate.md#composition-uploadzone)

透過結合[箱型容器](box.md)呈現出一個能夠讓使用者拖曳檔案上傳的空虛區塊。
...
### [背景區塊](blankslate.md#composition-content)

結合[內容區塊](content.md)來呈現較不重要的背景來與目前頁面明顯區隔。
...
### [搜尋欄位](blankslate.md#composition-grid)

動作區塊裡可以使用[網格系統](grid.md)來呈現更豐富的行為。
