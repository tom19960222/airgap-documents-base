...
version: "5.0.2"
title: "國家旗幟 - Tocas UI"
source_url: https://github.com/teacat/tocas-docs/blob/e62614c61a3fdb5d75cc5573e66f64dbfdbb7be7/docs/5.0/zh-tw/flag.html
...
### [邊框的](flag.md#bordered)

以邊框描繪國旗外觀，適合用於全白底國旗繪出旗幟邊界。
...
```html
這是法國 <span class="ts-flag is-start-spaced is-france-flag"></span>
<span class="ts-flag is-end-spaced is-brazil-flag"></span> 是巴西
然後 <span class="ts-flag is-spaced is-vietnam-flag"></span> 是越南
```

## 可用列表

想要使用某個國旗，可以透過其 `ISO 3166-2` 標準代碼或是別名。
...
|  | `sh` | `saint-helena` |
|  | `si` | `slovenia` |
|  | `sj` | `jan-mayen-and-svalbard`, `svalbard`, `jan-mayen` |
|  | `sk` | `slovakia` |
|  | `sl` | `sierra-leone` |
|  | `sm` | `san-marino` |
|  | `sn` | `senegal` |
...
|  | `tt` | `trinidad` |
|  | `tv` | `tuvalu` |
|  | `tw` | `taiwan`, `republic-of-china`, `formosa` |
|  | `tz` | `tanzania` |
|  | `ua` | `ukraine` |
|  | `ug` | `uganda` |
|  | `um` | `us-minor-islands` |
