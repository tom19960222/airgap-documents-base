...
version: "0.14.0"
title: "CSI-Addons for Kubernetes"
source_url: https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/README.md
...
Condition Reporter Documentation](volume-condition.md) for more details.
...
See the [`csi-addons` tool documentation](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/cmd/csi-addons/README.md) for more
details.
...
Refer to the [installation guide](deploy-controller.md) for more details.

## Contributing

The [Contribution Guidelines](CONTRIBUTING.md) <!-- unresolved-source-link: target=CONTRIBUTING.md --> contain details on the process
