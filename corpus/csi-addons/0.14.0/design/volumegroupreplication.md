...
version: "0.14.0"
title: "Summary"
source_url: https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/docs/design/volumegroupreplication.md
...
![VolumeGroupReplication Workflow Diagram](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/docs/design/volumegroupreplication_arch.svg)
...
- [volumereplication_controller](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/internal/controller/replication.storage/volumereplication_controller.go) - It manages the mirroring operations for a volume/group.
- [volumegroupreplication_controller](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/internal/controller/replication.storage/volumegroupreplication_controller.go) - It manages the flow of VGR and necessary validations to keep the VGR as the source of truth for the user.
- [volumegroupreplicationcontent_controller](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/internal/controller/replication.storage/volumegroupreplicationcontent_controller.go) - It manages the group level operations for the VGR.
...
- [VR Type Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/api/replication.storage/v1alpha1/volumegroupreplication_types.go)
- [VR CRD Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/config/crd/bases/replication.storage.openshift.io_volumegroupreplications.yaml)

## API definition of VolumeGroupReplicationContent CRD

- [VR Type Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/api/replication.storage/v1alpha1/volumegroupreplicationcontent_types.go)
- [VR CRD Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/config/crd/bases/replication.storage.openshift.io_volumegroupreplicationcontents.yaml)

## API definition of VolumeGroupReplicationClass (VGRC) CRD

- [VR Type Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/api/replication.storage/v1alpha1/volumegroupreplicationclass_types.go)
- [VR CRD Definition](https://github.com/csi-addons/kubernetes-csi-addons/blob/621cfdc3b7d36922a8d328324643540eeac2671d/config/crd/bases/replication.storage.openshift.io_volumegroupreplicationclasses.yaml)
