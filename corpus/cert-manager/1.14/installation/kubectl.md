...
version: "1.14"
title: "kubectl apply"
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/installation/kubectl.md
...
- [Install `kubectl` version `>= v1.19.0`](https://kubernetes.io/docs/tasks/tools/). (otherwise, you'll have issues updating the CRDs - see [v0.16 upgrade notes](../releases/upgrading/upgrading-0.15-0.16.md#issue-with-older-versions-of-kubectl) <!-- unresolved-source-link: target=../releases/upgrading/upgrading-0.15-0.16.md#issue-with-older-versions-of-kubectl -->)
