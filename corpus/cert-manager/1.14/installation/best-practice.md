...
version: "1.14"
title: "Best Practice"
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/installation/best-practice.md
...
1. **UDP / TCP: cert-manager (controller) -> External DNS**:
   ...
   In the case of DNS01, cert-manager also [supports DNS over HTTPS](../releases/release-notes/release-notes-1.13.md#dns-over-https-doh-support) <!-- unresolved-source-link: target=../releases/release-notes/release-notes-1.13.md#dns-over-https-doh-support -->.
...
> [Please get in touch](../contributing/README.md) <!-- unresolved-source-link: target=../contributing/README.md -->.
...
If you have other best practice recommendations please [contribute to this page](../contributing/contributing-flow.md) <!-- unresolved-source-link: target=../contributing/contributing-flow.md -->.
