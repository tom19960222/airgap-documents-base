...
version: "1.14"
title: "Helm"
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/installation/helm.md
...
- Install a [supported version of Kubernetes or OpenShift](../releases/README.md) <!-- unresolved-source-link: target=../releases/README.md -->.
...
Note that if you're using a `helm` version based on Kubernetes `v1.18` or below (Helm `v3.2`), `installCRDs` will not work with cert-manager `v0.16`. See the [v0.16 upgrade notes](../releases/upgrading/upgrading-0.15-0.16.md#helm) <!-- unresolved-source-link: target=../releases/upgrading/upgrading-0.15-0.16.md#helm --> for more details.
