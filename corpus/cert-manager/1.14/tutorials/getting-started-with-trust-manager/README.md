...
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/tutorials/getting-started-with-trust-manager/README.md
...
See the [Gatekeeper](./gatekeeper/) <!-- unresolved-source-link: target=./gatekeeper/ --> directory for two example `Assign` policies
