...
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/policy/defaulting.md
...
be used (see [Approval Policy](approval) <!-- unresolved-source-link: target=approval --> for more details).
