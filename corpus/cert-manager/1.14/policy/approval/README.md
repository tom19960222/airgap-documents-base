...
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/policy/approval/README.md
...
auto-approver that limits who can request which certificates. [approver-policy](approver-policy) <!-- unresolved-source-link: target=approver-policy -->
