...
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/trust/README.md
...
[trust-manager](trust-manager) <!-- unresolved-source-link: target=trust-manager --> can be used to manage these certificates and automatically distribute them to multiple namespaces.
