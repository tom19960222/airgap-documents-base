...
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/usage/csi-driver-spiffe/installation.md
...
> ⚠️ It is **vital** that the [default approver is disabled in cert-manager](../certificaterequest.md#approver-controller) ⚠️
...
configured so that the approver has [permissions to approve referencing CertificateRequests](../certificaterequest.md#rbac-syntax).
