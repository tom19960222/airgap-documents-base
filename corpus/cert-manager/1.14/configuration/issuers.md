...
version: "1.14"
title: "Issuers"
source_url: https://github.com/cert-manager/website/blob/d2e1bdfbbe23fcf24dcb68ab54353a65a4131c20/content/v1.14-docs/configuration/issuers.md
...
At the time of checking[^1], the used cert-manager version has to be still supported (see [Supported Releases](../releases/README.md) <!-- unresolved-source-link: target=../releases/README.md -->).
An end-to-end tutorial must include:
  1. a short explanation on how to install cert-manager (including the used version and a link to [https://cert-manager.io/docs/installation/](../installation/) <!-- unresolved-source-link: target=../installation/ -->)
...
If you're interested in building a new external issuer, check the [development documentation](../contributing/external-issuers.md) <!-- unresolved-source-link: target=../contributing/external-issuers.md -->.
