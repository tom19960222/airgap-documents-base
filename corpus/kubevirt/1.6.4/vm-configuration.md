...
source_url: https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/docs/vm-configuration.md
...
![VMI configuration diagram](vm-configuration.png "VMI Configuration") <!-- unresolved-source-link: target=vm-configuration.png "VMI Configuration" -->
