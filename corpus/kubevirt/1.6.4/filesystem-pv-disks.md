...
collection: kubevirt
version: "1.6.4"
title: "Using file-system based PersistentVolumes as virtual disk backends"
source_url: https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/docs/filesystem-pv-disks.md
...
introduced with [direct PV proposal](direct-pv-disks.md) <!-- unresolved-source-link: target=direct-pv-disks.md -->.
