...
version: "1.6.4"
title: "Architecture"
source_url: https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/docs/architecture.md
...
![Architecture diagram](architecture.png "Architecture") <!-- unresolved-source-link: target=architecture.png "Architecture" -->

And a simplified version:

![Simplified architecture diagram](architecture-simple.png "Simplified architecture") <!-- unresolved-source-link: target=architecture-simple.png "Simplified architecture" -->
