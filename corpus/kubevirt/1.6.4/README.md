...
version: "1.6.4"
title: "KubeVirt"
source_url: https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/README.md
...
[Getting Started Guide](getting-started.md). To learn how to contribute, please read our [contribution guide](https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/CONTRIBUTING.md).

You can learn more about how KubeVirt is designed (and why it is that way),
and learn more about the major components by taking a look at
[our developer documentation](docs/) <!-- unresolved-source-link: target=docs/ -->:

 * [Architecture](architecture.md) - High-level view on the architecture
 * [Components](components.md) - Detailed look at all components
