...
collection: kubevirt
version: "1.6.4"
title: "Backing Up and Restoring KubeVirt resources"
source_url: https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/docs/backup-restore-integration.md
...
![Object Graph Example](backup-graph.png "VM Graph") <!-- unresolved-source-link: target=backup-graph.png "VM Graph" -->
...
See [this guide](https://github.com/kubevirt/kubevirt/blob/ac5324e8f6e7cda1cfe92542df3ceb0cd0d8e68f/docs/freeze.md) for how to execute the freeze/thaw hooks for each VirtualMachineInstance encountered in the object graph.
