...
version: "1.9.0"
title: "Clone API"
source_url: https://kubevirt.io/user-guide/storage/clone_api/
fetched_at: 2026-08-21T02:36:54+00:00
---
# Clone API
...
(see [Using clones as a "golden VM image"](index.md#using-clones-as-a-golden-vm-image) below).
...
please see [Snapshot & Restore prerequisites](../snapshot_restore_api/index.md#prerequisites).
...
to look at [Snapshot & Restore](../snapshot_restore_api/index.md) user-guide page for more info.
