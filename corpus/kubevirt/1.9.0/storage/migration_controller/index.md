...
collection: kubevirt
version: "1.9.0"
title: "KubeVirt Migration Controller"
source_url: https://kubevirt.io/user-guide/storage/migration_controller/
fetched_at: 2026-08-21T02:37:52+00:00
---
...
Your KubeVirt environment must have the [Containerized Data Importer (CDI)](../containerized_data_importer/index.md) installed to use persistent disks.
...
> **Note:** This differs from KubeVirt's built-in [volume migration](../volume_migration/index.md#volume-migration-cancellation), where cancellation requires applying the old VM spec to revert the volume set. With the migration controller, deleting the migration CR is sufficient — the controller handles the revert automatically.
