...
collection: kubevirt
version: "1.9.0"
title: "Update volume strategy and volume migration"
source_url: https://kubevirt.io/user-guide/storage/volume_migration/
fetched_at: 2026-08-21T02:37:53+00:00
---
...
Updates are declarative and [GitOps](../../cluster_admin/gitops/index.md) compatible. For example, a new version of the VM specification with the new volume set and the migration volume update strategy can be directly applied using `kubectl apply` or interactively editing the VM with `kubectl edit`
