...
source_url: https://kubevirt.io/user-guide/storage/disks_and_volumes/
fetched_at: 2026-08-21T02:37:49+00:00
---
...
- [**lun**](index.md#lun)
- [**disk**](index.md#disk)
- [**cdrom**](index.md#cdrom)
- [**fileystems**](index.md#filesystems)
...
This can be done through [cloudInitNoCloud](index.md#cloudinitnocloud) or manually connecting to the VM shell and targeting the same
command.
...
Refer to section [Sharing Directories with VMs](index.md#sharing-directories-with-vms) for usage examples of `filesystems`.
...
- [**cloudInitNoCloud**](index.md#cloudinitnocloud)
- [**cloudInitConfigDrive**](index.md#cloudinitconfigdrive)
- [**persistentVolumeClaim**](index.md#persistentvolumeclaim)
- [**dataVolume**](index.md#datavolume)
- [**ephemeral**](index.md#ephemeral)
- [**containerDisk**](index.md#containerdisk)
- [**emptyDisk**](index.md#emptydisk)
- [**hostDisk**](index.md#hostdisk)
- [**configMap**](index.md#configmap)
- [**secret**](index.md#secret)
- [**serviceAccount**](index.md#serviceaccount)
- [**downwardMetrics**](index.md#downwardmetrics)
...
If the disk must persist across VM restarts or stops, use a PVC or a [dataVolume](index.md#datavolume) instead.
...
> Note: This does not always work as expected. Instead you may want to consider creating a [PersistentVolume](index.md#persistentvolumeclaim)
...
> [must be enabled](../../cluster_admin/activating_feature_gates/index.md#how-to-activate-a-feature-gate)
...
additional dedicated physical CPU[1](../../compute/virtual_hardware/index.md#cpu), exclusively for the emulator thread, to which it will
...
The following configuration can be done in using startup script. See [cloudInitNoCloud](index.md#cloudinitnocloud) section for
more details.
...
However, the [PVCs](index.md#sharing-persistent-volume-claims) method is preferred since using hostpath is generally discouraged for
security reasons.
...
found in the [volume migration documentation](../volume_migration/index.md).
