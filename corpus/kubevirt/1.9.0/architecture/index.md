...
version: "1.9.0"
title: "Architecture"
source_url: https://kubevirt.io/user-guide/architecture/
fetched_at: 2026-08-21T02:36:50+00:00
---
# Architecture
...
this object is of a specific type or *kind* - that is how it's called in the
specification.
...
*on top of* the Kubernetes cluster, and are not installed alongside it. The type
...
For more information regarding Run Strategies, please refer to [Run Strategies](../compute/run_strategies/index.md)
...
Find more details about [a VM's life-cycle in the relevant section](../user_workloads/lifecycle/index.md)
...
See [Service Objects](../network/service_objects/index.md) for more details.
