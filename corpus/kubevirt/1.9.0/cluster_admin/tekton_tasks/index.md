...
collection: kubevirt
version: "1.9.0"
title: "KubeVirt Tekton"
source_url: https://kubevirt.io/user-guide/cluster_admin/tekton_tasks/
fetched_at: 2026-08-21T02:37:07+00:00
---
# KubeVirt Tekton
...
> **Note:**
>
> - If you define a different namespace for Pipelines and a different namespace for Tasks, you will have to create a [cluster resolver](https://tekton.dev/docs/pipelines/cluster-resolver/) object.
...
> - In case you would like to live migrate the VM while a given Pipeline is running, the following [prerequisities](../operations/live_migration.md.md#limitations) must be met
