...
source_url: https://kubevirt.io/user-guide/cluster_admin/confidential_computing/
fetched_at: 2026-08-21T02:37:02+00:00
---
...
- `WorkloadEncryptionSEV` [feature gate](../activating_feature_gates/index.md#how-to-activate-a-feature-gate) must be enabled.
- The guest must support [UEFI boot](../../compute/virtual_hardware/index.md#biosuefi)
...
- Before kubevirt 1.9: `SecureExecution` [feature gate](../activating_feature_gates/index.md#how-to-activate-a-feature-gate) must be enabled.
...
3. Edit `zipl.conf`:
   ...
   ...
   ```
4. Run `zipl` to ensure the change is picked up during the next reboot
5. Reboot the node
6. Verify that Secure Execution is now enabled:
...
Ensure that your workload is [uploaded to a data volume using CDI](../../storage/containerized_data_importer/index.md#virtctl-image-upload).
