...
source_url: https://kubevirt.io/user-guide/cluster_admin/customize_components/
fetched_at: 2026-08-21T02:37:03+00:00
---
...
> ![⚠](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/26a0.svg ":warning:") If the patch created is invalid KubeVirt will not be able to update or deploy the system. This is intended for special use cases and should not be used unless you know what you are doing.
...
> ![⚠](https://cdn.jsdelivr.net/gh/jdecked/twemoji@16.0.1/assets/svg/26a0.svg ":warning:") If the flags are invalid or become invalid on update the component will not be able to run
