...
collection: kubevirt
version: "1.9.0"
title: "Launch QEMU with gdb and connect locally with gdb client"
source_url: https://kubevirt.io/user-guide/debug_virt_stack/launch-qemu-gdb/
fetched_at: 2026-08-21T02:37:57+00:00
---
...
This scenario is a slight variation of the [guide about starting strace](../launch-qemu-strace/index.md), hence some of the details on the image build and the PVC population are simply skipped and explained in the other section.
...
Then, we can create and populate the `debug-tools` PVC as we did in the [strace example](../launch-qemu-strace/index.md):
