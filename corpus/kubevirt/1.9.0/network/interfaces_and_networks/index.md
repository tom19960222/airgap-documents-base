...
source_url: https://kubevirt.io/user-guide/network/interfaces_and_networks/
fetched_at: 2026-08-21T02:37:41+00:00
---
...
- **[Macvtap](../net_binding_plugins/macvtap/index.md)** — NADs reference macvtap device resources (e.g. `macvtap.network.kubevirt.io/eth0`).
...
- The name of supported network core binding from the table below, or a reference to a [network binding plugin](../network_binding_plugins/index.md).
...
> See the network binding plugin [documentation](../network_binding_plugins/index.md) for details.
...
exposed by a Kubernetes [service](../service_objects/index.md#service-objects).
...
not automatic; it should be configured via cloud init, as shown in the [dual-stack section](index.md#masquerade-ipv4-and-ipv6-dual-stack-support).
...
> For further details please refer to the [dedicated cpu resources documentation](../compute/dedicated-cpu_resources.md/index.md).
...
The `PasstBinding` [feature gate](../../cluster_admin/activating_feature_gates/index.md#how-to-activate-a-feature-gate) must be enabled.
...
> **WARNING:** When [HTTP / TCP readiness and/or liveness probes](../../user_workloads/liveness_and_readiness_probes/index.md) are specified
