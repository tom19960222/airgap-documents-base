...
collection: kubevirt
version: "1.9.0"
title: "Hotplug Network Interfaces"
source_url: https://kubevirt.io/user-guide/network/hotplug/interfaces/
fetched_at: 2026-08-21T02:37:45+00:00
---
...
> `HotplugNICs` [feature-gate](../../../operations/activating_feature_gates/index.md#how-to-activate-a-feature-gate))
> must be enabled.
...
> hotplug or hot-unplug operations, provided the [LiveUpdate roll-out strategy](../user_workloads/vm_rollout_strategies.md.md#liveupdate) is configured on the KubeVirt Custom Resource (CR).
>
...
Please refer to the [Live Migration](../compute/live_migration.md.md) documentation for more information.
...
Please refer to the [Interface and Networks](../network/interfaces_and_networks.md/index.md#sriov)
