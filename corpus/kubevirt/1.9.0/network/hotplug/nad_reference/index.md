...
collection: kubevirt
version: "1.9.0"
title: "Live update NAD Reference"
source_url: https://kubevirt.io/user-guide/network/hotplug/nad_reference/
fetched_at: 2026-08-21T02:37:46+00:00
---
...
- The `LiveUpdateNADRef` [feature-gate](../../../operations/activating_feature_gates/index.md#how-to-activate-a-feature-gate) must be enabled (only required for v1.8)
...
Please refer to the [Live Migration](../../../compute/live_migration/index.md) documentation for more information.
...
- When updating multiple VMs only a limited number of migrations run in parallel. So updates may be queued. For more information, see [Changing Cluster Wide Migration Configuration](../../../compute/live_migration/index.md#changing-cluster-wide-migration-configuration).
