...
source_url: https://kubevirt.io/user-guide/network/istio_service_mesh/
fetched_at: 2026-08-21T02:37:42+00:00
---
# Istio service mesh
...
**Resolution:** Make sure the `istio-cni` NetworkAttachmentDefinition (provided in the [Prerequisites](index.md#prerequisites) section) is created in the target namespace.
