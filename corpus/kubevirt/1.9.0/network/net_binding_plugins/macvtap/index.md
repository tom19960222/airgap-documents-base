...
collection: kubevirt
version: "1.9.0"
title: "Macvtap binding"
source_url: https://kubevirt.io/user-guide/network/net_binding_plugins/macvtap/
fetched_at: 2026-08-21T02:38:00+00:00
---
# Macvtap binding
...
The macvtap plugin similarly has no feature gate of its own, but the plugin needs to be made available in the cluster by [registering it](index.md#macvtap-registration).
...
the [network attachment definition](index.md#macvtap-networkattachmentdefinition) section.

The `binding` value should correspond with the name used in the
[registration](index.md#macvtap-registration).
