...
version: "1.9.0"
title: "Passt binding"
source_url: https://kubevirt.io/user-guide/network/net_binding_plugins/passt/
fetched_at: 2026-08-21T02:38:01+00:00
---
# Passt binding

> **Warning:**
>
> The passt network binding plugin has been replaced in v1.8.0 with a [core binding](../../interfaces_and_networks.md#passtbinding).
...
As described in the [definition & flow](../../network_binding_plugins/index.md#definition--flow) section,
...
The passt plugin similarly has no feature gate of its own, but the plugin needs to be made available in the cluster by [registering it](index.md#passt-registration).

### Passt Registration

As described in the [registration section](../../network_binding_plugins/index.md#register), passt binding plugin
...
names used in the previous sections, [here](index.md#passt-networkattachmentdefinition)
and [here](index.md#passt-sidecar-image).
