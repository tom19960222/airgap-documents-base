...
version: "1.9.0"
title: "Slirp"
source_url: https://kubevirt.io/user-guide/network/net_binding_plugins/slirp/
fetched_at: 2026-08-21T02:38:02+00:00
---
# Slirp
...
The binding plugin replaces the [core `slirp` binding](../../interfaces_and_networks/index.md#slirp)
API.
...
The slirp plugin similarly has no feature gate of its own, but the plugin needs to be made available in the cluster by [registering it](index.md#slirp-registration).

### Slirp Registration

As described in the [registration section](../../network_binding_plugins/index.md#register), slirp binding plugin
