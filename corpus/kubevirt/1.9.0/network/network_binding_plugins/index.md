...
source_url: https://kubevirt.io/user-guide/network/network_binding_plugins/
fetched_at: 2026-08-21T02:37:43+00:00
---
...
> The [plugin examples](index.md#plugins) listed below are an exception to this
...
- [passt](../net_binding_plugins/passt/index.md)
- [macvtap](../net_binding_plugins/macvtap/index.md)
- [slirp](../net_binding_plugins/slirp/index.md)
...
- [networkAttachmentDefinition](index.md#networkattachmentdefinition)
- [sidecarImage](index.md#sidecarimage)
- [domainAttachmentType](index.md#domainattachmenttype)
