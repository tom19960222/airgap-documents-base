...
source_url: https://kubevirt.io/user-guide/release_notes/
fetched_at: 2026-08-21T02:36:56+00:00
---
...
- [[PR #17976]](https://github.com/kubevirt/kubevirt/pull/17976)[ethan-gallant] virt-operator: customizeComponents.Patches now apply to the install-strategy job (match it with resourceType "Job" and resourceName "virt-operator-install-strategy"). The job's generated name changed from "kubevirt--job" to "virt-operator-install-strategy-".
