...
collection: kubevirt
version: "1.9.0"
title: "Host Devices Assignment"
source_url: https://kubevirt.io/user-guide/compute/host-devices/
fetched_at: 2026-08-21T02:37:28+00:00
---
...
See the [Mediated devices and virtual GPUs](../mediated_devices_configuration/index.md) to learn more about this functionality.
...
- Enable the `HostDevices` [feature gate](../../cluster_admin/activating_feature_gates/index.md)
...
"46f4"` and `product: "0001"` [1](index.md#fn:1).
...
1. Note that you can easily find the `vendor:product` value with the `lsusb` command. [↩](index.md#fnref:1 "Jump back to footnote 1 in the text")
