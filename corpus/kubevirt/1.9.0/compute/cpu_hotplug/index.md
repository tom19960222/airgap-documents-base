...
version: "1.9.0"
title: "CPU Hotplug"
source_url: https://kubevirt.io/user-guide/compute/cpu_hotplug/
fetched_at: 2026-08-21T02:37:27+00:00
---
# CPU Hotplug
...
More information can be found on the [VM Rollout Strategies](../../user_workloads/vm_rollout_strategies/index.md) page
...
| VM level | Cluster level value | Cluster level ratio |
| --- | --- | --- |
| ``` apiVersion: kubevirt.io/v1 kind: VirtualMachine spec:   template:     spec:       domain:         cpu:           maxSockets: 8 ``` | ``` apiVersion: kubevirt.io/v1 kind: KubeVirt spec:   configuration:     liveUpdateConfiguration:       maxCpuSockets: 8 ``` | ``` apiVersion: kubevirt.io/v1 kind: KubeVirt spec:   configuration:     liveUpdateConfiguration:       maxHotplugRatio: 4 ``` |
