...
source_url: https://kubevirt.io/user-guide/user_workloads/instancetypes/
fetched_at: 2026-08-21T02:37:20+00:00
---
...
See the [Version History](index.md#version-history) section for more details.
...
- `spread` - Spreads vCPUs across sockets and cores by default. See the following [SpreadOptions](index.md#### SpreadOptions) section for more details.
...
- `RevisionName` (string) : Optional, name of a [`ControllerRevision`](https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/controller-revision-v1/) containing a copy of the `VirtualMachineInstancetypeSpec` or `VirtualMachinePreferenceSpec` taken when the `VirtualMachine` is first created. See the [Versioning](index.md#versioning) section below for more details on how and why this is captured.
- `InferFromVolume` (string): Optional, see the [Inferring defaults from a Volume](index.md#inferring-defaults-from-a-volume) section below for more details.

## Creating InstanceTypes, Preferences and VirtualMachines

It is possible to streamline the creation of instance types, preferences, and virtual machines with the usage of the virtctl command-line tool. To read more about it, please see the [Creating VirtualMachines](../creating_vms/index.md#creating-virtualmachines).
...
Support for instance-type-based vCPU and memory hotplug was introduced in KubeVirt 1.3 and is built on existing [vCPU](../../compute/cpu_hotplug/index.md) hotplug, [memory](../../compute/memory_hotplug/index.md) hotplug and [LiveUpdate](../vm_rollout_strategies/index.md) support.
...
The [`kubevirt/common-instancetypes`](https://github.com/kubevirt/common-instancetypes) provide a set of [instancetypes and preferences](index.md) to help create KubeVirt [`VirtualMachines`](http://kubevirt.io/api-reference/main/definitions.html#_v1alpha1_virtualmachine).

See [Deploy common-instancetypes](../deploy_common_instancetypes/index.md) on how to deploy them.
