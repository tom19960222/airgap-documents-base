...
source_url: https://kubevirt.io/user-guide/user_workloads/accessing_virtual_machines/
fetched_at: 2026-08-21T02:37:13+00:00
---
...
> [installed](../virtctl_client_tool/index.md) to gain
...
- [Static key injection](index.md#static-ssh-key-injection-via-cloud-init),
which places keys on the virtual machine the first time it is booted.
- [Dynamic key injection](index.md#dynamic-ssh-key-injection-via-qemu-user-agent),
...
[cloud-init startup script](../startup_scripts/index.md#cloud-init).
...
1. The `virtctl port-forward` command provides an option to tunnel a single
