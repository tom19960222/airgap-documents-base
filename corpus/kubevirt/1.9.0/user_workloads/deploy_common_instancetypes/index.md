...
collection: kubevirt
version: "1.9.0"
title: "Deploy common-instancetypes"
source_url: https://kubevirt.io/user-guide/user_workloads/deploy_common_instancetypes/
fetched_at: 2026-08-21T02:37:21+00:00
---
# Deploy common-instancetypes

The [`kubevirt/common-instancetypes`](https://github.com/kubevirt/common-instancetypes) provide a set of [instancetypes and preferences](../instancetypes/index.md) to help create KubeVirt [`VirtualMachines`](http://kubevirt.io/api-reference/main/definitions.html#_v1_virtualmachine).
