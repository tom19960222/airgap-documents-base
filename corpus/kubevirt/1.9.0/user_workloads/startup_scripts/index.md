...
source_url: https://kubevirt.io/user-guide/user_workloads/startup_scripts/
fetched_at: 2026-08-21T02:37:15+00:00
---
# Startup Scripts
...
Cloud-init [user-data](index.md#user-data) **must** be set for cloud-init to
