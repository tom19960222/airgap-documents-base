...
version: "1.9.0"
title: "Templates"
source_url: https://kubevirt.io/user-guide/user_workloads/templates/
...
> **Note:**
>
> Starting with KubeVirt v1.8.0, the native [VirtualMachine Templates](../vm_templates/index.md) feature
> replaces this legacy OpenShift-based templating mechanism. New deployments should use
> [VirtualMachine Templates](../vm_templates/index.md) instead.
...
You can follow [Virtual Machine Lifecycle Guide](../lifecycle/index.md) for further reference.
