...
collection: kubevirt
version: "1.9.0"
title: "Hook Sidecar Container"
source_url: https://kubevirt.io/user-guide/user_workloads/hook-sidecar/
fetched_at: 2026-08-21T02:37:21+00:00
---
...
> not yet determined. Use the new [Plugins](../../cluster_admin/plugins/index.md) mechanism
...
3. In this case a predefined image can be used to handle the communication with the main container.
...
The default Sidecar-shim image, if not override with a custom value, will also be updated as other images as for [Updating KubeVirt Workloads](../cluster_admin/updating_and_deletion/index.md#updating-kubevirt-workloads).
