...
collection: kubevirt
version: "1.9.0"
title: "VirtualMachine Templates"
source_url: https://kubevirt.io/user-guide/user_workloads/vm_templates/
fetched_at: 2026-08-21T02:37:23+00:00
---
# VirtualMachine Templates

**FEATURE STATE:**

- `template.kubevirt.io/v1alpha1` (Alpha) as of the [`v1.8.0`](https://github.com/kubevirt/kubevirt/releases/tag/v1.8.0) KubeVirt
  release
...
> OpenShift clusters. See [Templates](../templates/index.md) for details. New deployments
...
preferences, use
[VirtualMachineInstancetype and VirtualMachinePreference](../instancetypes/index.md).
...
[used together](index.md#example) for maximum flexibility.
...
[Activating feature gates](../../cluster_admin/activating_feature_gates/index.md).
...
[Instance types and preferences](../instancetypes/index.md) for more details.
...
> direct `VirtualMachine` create permissions. See the [RBAC](index.md#rbac) section for
> details.
...
artifacts using the [Export API](../../storage/export_api/index.md). This allows you to
...
[virt-template deployment](index.md#disabling-virt-template-deployment) must be enabled.
...
see the [Export API - OCI format](../../storage/export_api/index.md#oci-format)
documentation.
