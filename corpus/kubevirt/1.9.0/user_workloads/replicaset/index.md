...
source_url: https://kubevirt.io/user-guide/user_workloads/replicaset/
...
VirtualMachineInstance](../../network/service_objects/index.md)
for more details.
...
[Volume types](../../storage/disks_and_volumes/index.md) which
