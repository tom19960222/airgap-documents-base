...
collection: kubevirt
version: "1.9.0"
title: "Creating VirtualMachines by using virtctl"
source_url: https://kubevirt.io/user-guide/user_workloads/creating_vms/
...
[instance types and preferences](../instancetypes/index.md) and
inference by default (see
[Using instance types and preferences](index.md#using-instance-types-and-preferences))
...
about inference, see [below](index.md#inference-of-instance-type-andor-preference).
...
To explicitly
infer [instance types and/or preferences](../instancetypes/index.md#inferFromVolume)
...
> **Note:**
>
> Generating cloud-init user data is mutually exclusive with [specifying custom cloud-init user data](index.md#specifying-custom-cloud-init-user-data), as explained below.
...
> **Note:**
>
> Specifying custom cloud-init user data is mutually exclusive with [generating cloud-init user data](index.md#generating-cloud-init-user-data), as explained above.
...
[access credentials](../accessing_virtual_machines/index.md#dynamic-ssh-public-key-injection-via-qemu-guest-agent)
...
[generate cloud-init user data](index.md#generating-cloud-init-user-data), namely it
...
A [sysprep volume](../startup_scripts/index.md#sysprep-examples) can be added to
