...
collection: ubuntu
version: "26.04"
title: "Ubuntu 26.04 LTS changes since 25.10"
source_url: https://documentation.ubuntu.com/release-notes/26.04/changes-since-previous-interim/
fetched_at: 2026-09-16T16:17:20+00:00
---
...
See also [Breaking changes in SSSD](index.md#sssd-changes).
...
See also [Removed options and directives in Squid](index.md#squid-removals).
...
Starting with 26.04, MariaDB is provided with [full support in Ubuntu *main*](https://bugs.launchpad.net/ubuntu/+source/mariadb/+bug/2122095), with security enhancements including an AppArmor profile tailored for Ubuntu and hardened systemd service.
...
For example, the dependency metadata for *[sudo-rs(1)](https://manpages.ubuntu.com/manpages/resolute/en/man1/sudo-rs.1.html)* looks like this:
...
- [cgroup v1 support has been removed](index.md#cgroup-v1-removed)
- [Legacy System V service scripts are deprecated](index.md#system-v-scripts-deprecated)
...
Some limitations remain: see [Limitations of TPM-backed full disk encryption](index.md#resolute-tpm-fde-limitations).
...
[Ubuntu no longer supports IBM Z generations z14 or older](index.md#ibm-z14-support-removed).
...
Note that currently, [AMD ROCm fails Blender tests on gfx908](index.md#resolute-gfx908-blender-tests-issue).
