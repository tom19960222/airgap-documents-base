...
collection: ubuntu
version: "26.04"
title: "Ubuntu 26.04 LTS summary"
source_url: https://documentation.ubuntu.com/release-notes/26.04/summary-for-lts-users/
fetched_at: 2026-09-16T16:17:19+00:00
---
...
For details, see the complete interim release notes: [24.10](https://documentation.ubuntu.com/release-notes/24.10/#ubuntu-24-10-release-notes), [25.04](https://documentation.ubuntu.com/release-notes/25.04/#ubuntu-25-04-release-notes) and [25.10](https://documentation.ubuntu.com/release-notes/25.10/#ubuntu-25-10-release-notes). Finally, review the latest [Ubuntu 26.04 LTS changes since 25.10](../changes-since-previous-interim/index.md#ubuntu-26-04-lts-changes-since-25-10).
...
- It features a modern and accessible interface based on GTK 4 and `libadwaita`.
...
To work around the issue, you can reimplement the behavior of the removed scripts using *[PAM session modules](https://manpages.ubuntu.com/manpages/resolute/en/man5/pam.conf.5.html)*. For example, the actions that you were invoking from the GDM `PreLogin`, `PostLogin`, `PreSession` or `PostSession` scripts can be invoked from the *[pam_exec(8)](https://manpages.ubuntu.com/manpages/resolute/en/man8/pam_exec.8.html)* module instead.
...
![Sample colored output](../../_images/strace-color.png)
...
interim release like [libvirt@24.10](https://documentation.ubuntu.com/release-notes/24.10/#libvirt-24-10),
[qemu@25.10](https://documentation.ubuntu.com/release-notes/25.04/#qemu-25-04), or [edk2@25.10](https://documentation.ubuntu.com/release-notes/25.10/#edk2-25-10)
...
Some limitations remain: see [Limitations of TPM-backed full disk encryption](../changes-since-previous-interim/index.md#resolute-tpm-fde-limitations).
...
- Install the compiler and the library:

  ```bash
  sudo apt install dpclang-6
  sudo apt install onedpl-headers
  ```
- Install the oneDNN development package and the oneDNN runtime:
...
Note that currently, [AMD ROCm fails Blender tests on gfx908](../changes-since-previous-interim/index.md#resolute-gfx908-blender-tests-issue).
...
- [IBM Z and LinuxONE (s390x)](../changes-since-previous-interim/index.md#ibm-z15-level)
- [Ubuntu no longer supports IBM Z generations z14 or older](../changes-since-previous-interim/index.md#ibm-z14-support-removed)
...
- The RISC-V kernel supports only architectures compliant with the RVA23S64 ISA profile.
  ...
  For details, see [New RISC-V requirements](index.md#resolute-new-risc-v-requirements).
...
- Support for `cgroup` version 1 (`legacy` and `hybrid` hierarchies) has been removed. For details, see [cgroup v1 support has been removed](../changes-since-previous-interim/index.md#cgroup-v1-removed).
...
You can find the [Known issues](../changes-since-previous-interim/index.md#resolute-known-issues) in this release on a separate page.
...
- [Ubuntu 24.10 release notes](https://documentation.ubuntu.com/release-notes/24.10/#ubuntu-24-10-release-notes)
- [Ubuntu 25.04 release notes](https://documentation.ubuntu.com/release-notes/25.04/#ubuntu-25-04-release-notes)
- [Ubuntu 25.10 release notes](https://documentation.ubuntu.com/release-notes/25.10/#ubuntu-25-10-release-notes)
- [Ubuntu 26.04 LTS changes since 25.10](../changes-since-previous-interim/index.md#ubuntu-26-04-lts-changes-since-25-10)
