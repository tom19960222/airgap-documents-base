...
collection: ansible
version: "6"
title: "Ansible 2.7 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/6/porting_guides/porting_guide_2.7.html
fetched_at: 2026-07-27T16:39:43+00:00
---
# [Ansible 2.7 Porting Guide](porting_guide_2.7.md#id1)

This section discusses the behavioral changes between Ansible 2.6 and Ansible 2.7.

It is intended to assist in updating your playbooks, plugins and other parts of your Ansible infrastructure so they will work with this version of Ansible.

We suggest you read this page along with [Ansible Changelog for 2.7](https://github.com/ansible/ansible/blob/stable-2.7/changelogs/CHANGELOG-v2.7.rst) to understand what updates you may need to make.
...
- [Ansible 2.7 Porting Guide](porting_guide_2.7.md#ansible-2-7-porting-guide)

  - [Command Line](porting_guide_2.7.md#command-line)
  - [Python Compatibility](porting_guide_2.7.md#python-compatibility)
  - [Playbook](porting_guide_2.7.md#playbook)

    - [Role Precedence Fix during Role Loading](porting_guide_2.7.md#role-precedence-fix-during-role-loading)
    - [include_role and import_role variable exposure](porting_guide_2.7.md#include-role-and-import-role-variable-exposure)
    - [include_tasks/import_tasks inline variables](porting_guide_2.7.md#include-tasks-import-tasks-inline-variables)
    - [vars_prompt with unknown algorithms](porting_guide_2.7.md#vars-prompt-with-unknown-algorithms)
  - [Deprecated](porting_guide_2.7.md#deprecated)

    - [Expedited Deprecation: Use of `__file__` in `AnsibleModule`](porting_guide_2.7.md#expedited-deprecation-use-of-file-in-ansiblemodule)
    - [Using a loop on a package module via squash_actions](porting_guide_2.7.md#using-a-loop-on-a-package-module-via-squash-actions)
  - [Modules](porting_guide_2.7.md#modules)

    - [Modules removed](porting_guide_2.7.md#modules-removed)
    - [Deprecation notices](porting_guide_2.7.md#deprecation-notices)
    - [Noteworthy module changes](porting_guide_2.7.md#noteworthy-module-changes)
  - [Plugins](porting_guide_2.7.md#plugins)
  - [Porting custom scripts](porting_guide_2.7.md#porting-custom-scripts)
  - [Networking](porting_guide_2.7.md#networking)

## [Command Line](porting_guide_2.7.md#id2)
...
## [Python Compatibility](porting_guide_2.7.md#id3)

Ansible has dropped compatibility with Python-2.6 on the controller (The host where **/usr/bin/ansible**
or **/usr/bin/ansible-playbook** is run). Modules shipped with Ansible can still be used to
...
One thing that this does affect is the ability to use **/usr/bin/ansible-pull** to manage
...
## [Playbook](porting_guide_2.7.md#id4)

### [Role Precedence Fix during Role Loading](porting_guide_2.7.md#id5)

Ansible 2.7 makes a small change to variable precedence when loading roles, resolving a bug, ensuring that role loading matches [variable precedence expectations](../user_guide/playbooks_variables.md#ansible-variable-precedence).
...
### [include_role and import_role variable exposure](porting_guide_2.7.md#id6)
...
### [include_tasks/import_tasks inline variables](porting_guide_2.7.md#id7)
...
### [vars_prompt with unknown algorithms](porting_guide_2.7.md#id8)
...
## [Deprecated](porting_guide_2.7.md#id9)

### [Expedited Deprecation: Use of `__file__` in `AnsibleModule`](porting_guide_2.7.md#id10)
...
If you are the author of a third-party module which uses `__file__` with `AnsibleModule`, please update your module(s) now, while the use of `__file__` is deprecated but still available. The most common use of `__file__` is to find a directory to write a temporary file. In Ansible 2.5 and above, you can use the `tmpdir` attribute on an `AnsibleModule` instance instead, as shown in this code from the [apt module](https://docs.ansible.com/ansible/2.7/modules/apt_module.html#apt-module "(in Ansible v2.7)"):
...
### [Using a loop on a package module via squash_actions](porting_guide_2.7.md#id11)
...
## [Modules](porting_guide_2.7.md#id12)

Major changes in popular modules are detailed here

- The [DEFAULT_SYSLOG_FACILITY](../reference_appendices/config.md#default-syslog-facility) configuration option tells Ansible modules to use a specific
  [syslog facility](https://en.wikipedia.org/wiki/Syslog#Facility) when logging information on all
  ...
  messages were sent to `/var/log/messages`, even if you set [DEFAULT_SYSLOG_FACILITY](../reference_appendices/config.md#default-syslog-facility).
  Ansible 2.7 fixes this bug, routing all Ansible log messages according to the value set for
  [DEFAULT_SYSLOG_FACILITY](../reference_appendices/config.md#default-syslog-facility). If you have [DEFAULT_SYSLOG_FACILITY](../reference_appendices/config.md#default-syslog-facility) configured, the
  location of remote logs on systems which use journald may change.

### [Modules removed](porting_guide_2.7.md#id13)

The following modules no longer exist:

### [Deprecation notices](porting_guide_2.7.md#id14)

The following modules will be removed in Ansible 2.11. Please update your playbooks accordingly.

- `na_cdot_aggregate` use [na_ontap_aggregate](https://docs.ansible.com/ansible/2.7/modules/na_ontap_aggregate_module.html#na-ontap-aggregate-module "(in Ansible v2.7)") instead.
- `na_cdot_license` use [na_ontap_license](https://docs.ansible.com/ansible/2.7/modules/na_ontap_license_module.html#na-ontap-license-module "(in Ansible v2.7)") instead.
- `na_cdot_lun` use [na_ontap_lun](https://docs.ansible.com/ansible/2.7/modules/na_ontap_lun_module.html#na-ontap-lun-module "(in Ansible v2.7)") instead.
- `na_cdot_qtree` use [na_ontap_qtree](https://docs.ansible.com/ansible/2.7/modules/na_ontap_qtree_module.html#na-ontap-qtree-module "(in Ansible v2.7)") instead.
- `na_cdot_svm` use [na_ontap_svm](https://docs.ansible.com/ansible/2.7/modules/na_ontap_svm_module.html#na-ontap-svm-module "(in Ansible v2.7)") instead.
- `na_cdot_user` use [na_ontap_user](https://docs.ansible.com/ansible/2.7/modules/na_ontap_user_module.html#na-ontap-user-module "(in Ansible v2.7)") instead.
- `na_cdot_user_role` use [na_ontap_user_role](https://docs.ansible.com/ansible/2.7/modules/na_ontap_user_role_module.html#na-ontap-user-role-module "(in Ansible v2.7)") instead.
- `na_cdot_volume` use [na_ontap_volume](https://docs.ansible.com/ansible/2.7/modules/na_ontap_volume_module.html#na-ontap-volume-module "(in Ansible v2.7)") instead.
- `sf_account_manager` use [na_elementsw_account](https://docs.ansible.com/ansible/2.7/modules/na_elementsw_account_module.html#na-elementsw-account-module "(in Ansible v2.7)") instead.
- `sf_check_connections` use [na_elementsw_check_connections](https://docs.ansible.com/ansible/2.7/modules/na_elementsw_check_connections_module.html#na-elementsw-check-connections-module "(in Ansible v2.7)") instead.
- `sf_snapshot_schedule_manager` use [na_elementsw_snapshot_schedule](https://docs.ansible.com/ansible/2.7/modules/na_elementsw_snapshot_schedule_module.html#na-elementsw-snapshot-schedule-module "(in Ansible v2.7)") instead.
- `sf_volume_access_group_manager` use [na_elementsw_access_group](https://docs.ansible.com/ansible/2.7/modules/na_elementsw_access_group_module.html#na-elementsw-access-group-module "(in Ansible v2.7)") instead.
- `sf_volume_manager` use [na_elementsw_volume](https://docs.ansible.com/ansible/2.7/modules/na_elementsw_volume_module.html#na-elementsw-volume-module "(in Ansible v2.7)") instead.

### [Noteworthy module changes](porting_guide_2.7.md#id15)
...
## [Plugins](porting_guide_2.7.md#id16)
...
## [Porting custom scripts](porting_guide_2.7.md#id17)

No notable changes.

## [Networking](porting_guide_2.7.md#id18)
