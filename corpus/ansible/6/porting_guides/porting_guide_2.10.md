...
collection: ansible
version: "6"
title: "Ansible 2.10 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/6/porting_guides/porting_guide_2.10.html
fetched_at: 2026-07-27T16:39:41+00:00
---
# Ansible 2.10 Porting Guide

> **Warning:**
>
> In Ansible 2.10, many plugins and modules have migrated to Collections on [Ansible Galaxy](https://galaxy.ansible.com). Your playbooks should continue to work without any changes. We recommend you start using the fully-qualified collection name (FQCN) in your playbooks as the explicit and authoritative indicator of which collection to use as some collections may contain duplicate module names. You can search the [index of all modules](https://docs.ansible.com/ansible/2.10/collections/index_module.html) to find the collection a module has been relocated to.

This section discusses the behavioral changes between Ansible 2.9 and Ansible 2.10.

It is intended to assist in updating your playbooks, plugins and other parts of your Ansible infrastructure so they will work with this version of Ansible.

We suggest you read this page along with the [Ansible Changelog for 2.10](https://github.com/ansible-community/ansible-build-data/blob/main/2.10/CHANGELOG-v2.10.rst) to understand what updates you may need to make.
...
- a [set of collections](https://github.com/ansible-community/ansible-build-data/blob/main/2.10/ansible.in).

The [Ansible-base 2.10 Porting Guide](https://docs.ansible.com/ansible/2.10/porting_guides/porting_guide_base_2.10.html#porting-2-10-guide-base "(in Ansible v2.10)") is included in this porting guide. The complete list of porting guides can be found at [porting guides](porting_guides.md#porting-guides).

- [Playbook](porting_guide_2.10.md#playbook)
- [Command Line](porting_guide_2.10.md#command-line)
- [Deprecated](porting_guide_2.10.md#deprecated)
- [Modules](porting_guide_2.10.md#modules)

  - [Noteworthy module changes](porting_guide_2.10.md#noteworthy-module-changes)
- [Plugins](porting_guide_2.10.md#plugins)

  - [Lookup plugin names case-sensitivity](porting_guide_2.10.md#lookup-plugin-names-case-sensitivity)
  - [Noteworthy plugin changes](porting_guide_2.10.md#noteworthy-plugin-changes)
  - [Action plugins which execute modules should use fully-qualified module names](porting_guide_2.10.md#action-plugins-which-execute-modules-should-use-fully-qualified-module-names)
- [Porting custom scripts](porting_guide_2.10.md#porting-custom-scripts)
- [Porting Guide for v2.10.7](porting_guide_2.10.md#porting-guide-for-v2-10-7)

  - [Breaking Changes](porting_guide_2.10.md#breaking-changes)
  - [Major Changes](porting_guide_2.10.md#major-changes)
  - [Deprecated Features](porting_guide_2.10.md#deprecated-features)
- [Porting Guide for v2.10.6](porting_guide_2.10.md#porting-guide-for-v2-10-6)

  - [Major Changes](porting_guide_2.10.md#id1)
- [Porting Guide for v2.10.5](porting_guide_2.10.md#porting-guide-for-v2-10-5)

  - [Breaking Changes](porting_guide_2.10.md#id3)
  - [Major Changes](porting_guide_2.10.md#id4)
  - [Deprecated Features](porting_guide_2.10.md#id7)
- [Porting Guide for v2.10.4](porting_guide_2.10.md#porting-guide-for-v2-10-4)

  - [Breaking Changes](porting_guide_2.10.md#id9)
  - [Major Changes](porting_guide_2.10.md#id10)
  - [Removed Features](porting_guide_2.10.md#removed-features)
  - [Deprecated Features](porting_guide_2.10.md#id17)
- [Porting Guide for v2.10.2](porting_guide_2.10.md#porting-guide-for-v2-10-2)

  - [Breaking Changes](porting_guide_2.10.md#id20)
  - [Major Changes](porting_guide_2.10.md#id21)
  - [Removed Features](porting_guide_2.10.md#id24)
  - [Deprecated Features](porting_guide_2.10.md#id26)
- [Porting Guide for v2.10.1](porting_guide_2.10.md#porting-guide-for-v2-10-1)

  - [Major Changes](porting_guide_2.10.md#id28)
  - [Deprecated Features](porting_guide_2.10.md#id29)
- [Porting Guide for v2.10.0](porting_guide_2.10.md#porting-guide-for-v2-10-0)

  - [Known Issues](porting_guide_2.10.md#known-issues)
  - [Breaking Changes](porting_guide_2.10.md#id31)
  - [Major Changes](porting_guide_2.10.md#id36)
  - [Removed Features](porting_guide_2.10.md#id45)
  - [Deprecated Features](porting_guide_2.10.md#id54)

## [Playbook](porting_guide_2.10.md#id64)
...
## [Command Line](porting_guide_2.10.md#id65)
...
## [Deprecated](porting_guide_2.10.md#id66)

- Windows Server 2008 and 2008 R2 will no longer be supported or tested in the next Ansible release, see [Are Server 2008, 2008 R2 and Windows 7 supported?](../user_guide/windows_faq.md#windows-faq-server2008).

## [Modules](porting_guide_2.10.md#id67)
...
### [Noteworthy module changes](porting_guide_2.10.md#id68)
...
## [Plugins](porting_guide_2.10.md#id69)

### [Lookup plugin names case-sensitivity](porting_guide_2.10.md#id70)
...
### [Noteworthy plugin changes](porting_guide_2.10.md#id71)
...
### [Action plugins which execute modules should use fully-qualified module names](porting_guide_2.10.md#id72)
...
## [Porting custom scripts](porting_guide_2.10.md#id73)

No notable changes

## [Porting Guide for v2.10.7](porting_guide_2.10.md#id74)

### [Breaking Changes](porting_guide_2.10.md#id75)
...
### [Major Changes](porting_guide_2.10.md#id76)
...
### [Deprecated Features](porting_guide_2.10.md#id77)
...
## [Porting Guide for v2.10.6](porting_guide_2.10.md#id78)

### [Major Changes](porting_guide_2.10.md#id79)

#### community.general

- For community.general 2.0.0, the kubevirt modules will be moved to the [community.kubevirt](https://galaxy.ansible.com/community/kubevirt) collection.
...
- For community.network 2.0.0, the Cisco NSO modules will be moved to the [cisco.nso](https://galaxy.ansible.com/cisco/nso) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.network 2.0.0, the FortiOS modules will be moved to the [community.fortios](https://galaxy.ansible.com/ansible-collections/community.fortios) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
## [Porting Guide for v2.10.5](porting_guide_2.10.md#id80)

### [Breaking Changes](porting_guide_2.10.md#id81)
...
### [Major Changes](porting_guide_2.10.md#id82)

#### community.general

- For community.general 2.0.0, the Google modules will be moved to the [community.google](https://galaxy.ansible.com/community/google) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.general 2.0.0, the OC connection plugin will be moved to the [community.okd](https://galaxy.ansible.com/community/okd) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.general 2.0.0, the hashi_vault lookup plugin will be moved to the [community.hashi_vault](https://galaxy.ansible.com/community/hashi_vault) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
### [Deprecated Features](porting_guide_2.10.md#id83)
...
## [Porting Guide for v2.10.4](porting_guide_2.10.md#id84)

### [Breaking Changes](porting_guide_2.10.md#id85)

#### community.hrobot

- firewall - now requires the [ipaddress](https://pypi.org/project/ipaddress/) library (<https://github.com/ansible-collections/community.hrobot/pull/2>).

### [Major Changes](porting_guide_2.10.md#id86)

#### community.general

- For community.general 2.0.0, the Hetzner Robot modules will be moved to the [community.hrobot](https://galaxy.ansible.com/community/hrobot) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.general 2.0.0, the `docker` modules and plugins will be moved to the [community.docker](https://galaxy.ansible.com/community/docker) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.general 2.0.0, the `postgresql` modules and plugins will be moved to the [community.postgresql](https://galaxy.ansible.com/community/postgresql) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
- For community.network 2.0.0, the `routeros` modules and plugins will be moved to the [community.routeros](https://galaxy.ansible.com/community/routeros) collection.
  A redirection will be inserted so that users using ansible-base 2.10 or newer do not have to change anything.
...
### [Removed Features](porting_guide_2.10.md#id87)
...
### [Deprecated Features](porting_guide_2.10.md#id88)
...
## [Porting Guide for v2.10.2](porting_guide_2.10.md#id89)

### [Breaking Changes](porting_guide_2.10.md#id90)

#### Ansible-base

- ansible-galaxy login command has been removed (see <https://github.com/ansible/ansible/issues/71560>)

### [Major Changes](porting_guide_2.10.md#id91)
...
### [Removed Features](porting_guide_2.10.md#id92)

#### f5networks.f5_modules

- Removed arp_state parameter from the bigip_virtual_address module

### [Deprecated Features](porting_guide_2.10.md#id93)

#### cisco.nxos

- Deprecated nxos_interface_ospf in favor of nxos_ospf_interfaces Resource Module.

## [Porting Guide for v2.10.1](porting_guide_2.10.md#id94)

### [Major Changes](porting_guide_2.10.md#id95)
...
### [Deprecated Features](porting_guide_2.10.md#id96)
...
## [Porting Guide for v2.10.0](porting_guide_2.10.md#id97)

### [Known Issues](porting_guide_2.10.md#id98)
...
### [Breaking Changes](porting_guide_2.10.md#id99)
...
- zabbix_javagateway - options `javagateway_pidfile`, `javagateway_listenip`, `javagateway_listenport` and `javagateway_startpollers` renamed to `zabbix_javagateway_xyz` (see [UPGRADE.md](https://github.com/ansible-collections/community.zabbix/blob/main/docs/UPGRADE.md)).
...
### [Major Changes](porting_guide_2.10.md#id100)
...
### [Removed Features](porting_guide_2.10.md#id101)
...
### [Deprecated Features](porting_guide_2.10.md#id102)
