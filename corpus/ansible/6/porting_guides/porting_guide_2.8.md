...
collection: ansible
version: "6"
title: "Ansible 2.8 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/6/porting_guides/porting_guide_2.8.html
...
We suggest you read this page along with [Ansible Changelog for 2.8](https://github.com/ansible/ansible/blob/stable-2.8/changelogs/CHANGELOG-v2.8.rst) to understand what updates you may need to make.
...
- [Playbook](porting_guide_2.8.md#playbook)

  - [Distribution Facts](porting_guide_2.8.md#distribution-facts)
  - [Imports as handlers](porting_guide_2.8.md#imports-as-handlers)
  - [Jinja Undefined values](porting_guide_2.8.md#jinja-undefined-values)
  - [Module option conversion to string](porting_guide_2.8.md#module-option-conversion-to-string)
  - [Command line facts](porting_guide_2.8.md#command-line-facts)
  - [Bare variables in conditionals](porting_guide_2.8.md#bare-variables-in-conditionals)

    - [Updating your playbooks](porting_guide_2.8.md#updating-your-playbooks)
    - [Double-interpolation](porting_guide_2.8.md#double-interpolation)
    - [Nested variables](porting_guide_2.8.md#nested-variables)
  - [Gathering Facts](porting_guide_2.8.md#gathering-facts)
- [Python Interpreter Discovery](porting_guide_2.8.md#python-interpreter-discovery)

  - [Retry File Creation default](porting_guide_2.8.md#retry-file-creation-default)
- [Command Line](porting_guide_2.8.md#command-line)

  - [Become Prompting](porting_guide_2.8.md#become-prompting)
- [Deprecated](porting_guide_2.8.md#deprecated)
- [Modules](porting_guide_2.8.md#modules)

  - [Modules removed](porting_guide_2.8.md#modules-removed)
  - [Deprecation notices](porting_guide_2.8.md#deprecation-notices)
  - [Noteworthy module changes](porting_guide_2.8.md#noteworthy-module-changes)
- [Plugins](porting_guide_2.8.md#plugins)
- [Porting custom scripts](porting_guide_2.8.md#porting-custom-scripts)

  - [Display class](porting_guide_2.8.md#display-class)
- [Networking](porting_guide_2.8.md#networking)

## [Playbook](porting_guide_2.8.md#id2)

### [Distribution Facts](porting_guide_2.8.md#id3)

The information returned for the `ansible_distribution_*` group of facts may have changed
slightly. Ansible 2.8 uses a new backend library for information about distributions: [nir0s/distro](https://github.com/nir0s/distro). This library runs on Python-3.8 and fixes many bugs, including correcting release and version names.
...
### [Imports as handlers](porting_guide_2.8.md#id4)
...
To achieve the results of notifying a single name but running multiple handlers, utilize `include_tasks`, or `listen` [Handlers: running operations on change](../user_guide/playbooks_handlers.md#handlers).

### [Jinja Undefined values](porting_guide_2.8.md#id5)
...
### [Module option conversion to string](porting_guide_2.8.md#id6)
...
### [Command line facts](porting_guide_2.8.md#id7)
...
### [Bare variables in conditionals](porting_guide_2.8.md#id8)
...
#### [Updating your playbooks](porting_guide_2.8.md#id9)
...
#### [Double-interpolation](porting_guide_2.8.md#id10)
...
#### [Nested variables](porting_guide_2.8.md#id11)
...
### [Gathering Facts](porting_guide_2.8.md#id12)
...
## [Python Interpreter Discovery](porting_guide_2.8.md#id13)
...
| auto_legacy_silent | Behaves like `auto_legacy` but suppresses the deprecation and fallback-list warnings. |
...
### [Retry File Creation default](porting_guide_2.8.md#id14)
...
## [Command Line](porting_guide_2.8.md#id15)

### [Become Prompting](porting_guide_2.8.md#id16)
...
If you want the prompt to display the specific `become_method` you’re using, instead of the general value `BECOME`, set [AGNOSTIC_BECOME_PROMPT](../reference_appendices/config.md#agnostic-become-prompt) to `False` in your Ansible configuration.
...
## [Deprecated](porting_guide_2.8.md#id17)
...
- Supporting file-backed caching via self.cache is deprecated and will
  ...
  the [developer guide on inventory plugins](../dev_guide/developing_inventory.md#inventory-plugin-caching).
...
## [Modules](porting_guide_2.8.md#id18)
...
### [Modules removed](porting_guide_2.8.md#id19)
...
### [Deprecation notices](porting_guide_2.8.md#id20)

The following modules will be removed in Ansible 2.12. Please update your playbooks accordingly.

- `foreman` use [foreman-ansible-modules](https://github.com/theforeman/foreman-ansible-modules) instead.
- `katello` use [foreman-ansible-modules](https://github.com/theforeman/foreman-ansible-modules) instead.
- `github_hooks` use [github_webhook](https://docs.ansible.com/ansible/2.8/modules/github_webhook_module.html#github-webhook-module "(in Ansible v2.8)") and [github_webhook_facts](https://docs.ansible.com/ansible/2.8/modules/github_webhook_facts_module.html#github-webhook-facts-module "(in Ansible v2.8)") instead.
- `digital_ocean` use [digital_ocean_droplet](https://docs.ansible.com/ansible/2.8/modules/digital_ocean_droplet_module.html#digital-ocean-droplet-module "(in Ansible v2.8)") instead.
- `gce` use [gcp_compute_instance](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_instance_module.html#gcp-compute-instance-module "(in Ansible v2.8)") instead.
- `gcspanner` use [gcp_spanner_instance](https://docs.ansible.com/ansible/2.8/modules/gcp_spanner_instance_module.html#gcp-spanner-instance-module "(in Ansible v2.8)") and [gcp_spanner_database](https://docs.ansible.com/ansible/2.8/modules/gcp_spanner_database_module.html#gcp-spanner-database-module "(in Ansible v2.8)") instead.
- `gcdns_record` use [gcp_dns_resource_record_set](https://docs.ansible.com/ansible/2.8/modules/gcp_dns_resource_record_set_module.html#gcp-dns-resource-record-set-module "(in Ansible v2.8)") instead.
- `gcdns_zone` use [gcp_dns_managed_zone](https://docs.ansible.com/ansible/2.8/modules/gcp_dns_managed_zone_module.html#gcp-dns-managed-zone-module "(in Ansible v2.8)") instead.
- `gcp_forwarding_rule` use [gcp_compute_global_forwarding_rule](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_global_forwarding_rule_module.html#gcp-compute-global-forwarding-rule-module "(in Ansible v2.8)") or [gcp_compute_forwarding_rule](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_forwarding_rule_module.html#gcp-compute-forwarding-rule-module "(in Ansible v2.8)") instead.
- `gcp_healthcheck` use [gcp_compute_health_check](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_health_check_module.html#gcp-compute-health-check-module "(in Ansible v2.8)"), [gcp_compute_http_health_check](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_http_health_check_module.html#gcp-compute-http-health-check-module "(in Ansible v2.8)"), or [gcp_compute_https_health_check](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_https_health_check_module.html#gcp-compute-https-health-check-module "(in Ansible v2.8)") instead.
- `gcp_backend_service` use [gcp_compute_backend_service](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_backend_service_module.html#gcp-compute-backend-service-module "(in Ansible v2.8)") instead.
- `gcp_target_proxy` use [gcp_compute_target_http_proxy](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_target_http_proxy_module.html#gcp-compute-target-http-proxy-module "(in Ansible v2.8)") instead.
- `gcp_url_map` use [gcp_compute_url_map](https://docs.ansible.com/ansible/2.8/modules/gcp_compute_url_map_module.html#gcp-compute-url-map-module "(in Ansible v2.8)") instead.
- `panos` use the [Palo Alto Networks Ansible Galaxy role](https://galaxy.ansible.com/PaloAltoNetworks/paloaltonetworks) instead.

### [Noteworthy module changes](porting_guide_2.8.md#id21)
...
- The `docker_service` module was renamed to [docker_compose](https://docs.ansible.com/ansible/2.8/modules/docker_compose_module.html#docker-compose-module "(in Ansible v2.8)").
...
- The `panos` modules have been deprecated in favor of using the Palo Alto Networks [Ansible Galaxy role](https://galaxy.ansible.com/PaloAltoNetworks/paloaltonetworks). Contributions to the role can be made
  [here](https://github.com/PaloAltoNetworks/ansible-pan).
...
## [Plugins](porting_guide_2.8.md#id22)
...
- Order of enabled inventory plugins ([INVENTORY_ENABLED](../reference_appendices/config.md#inventory-enabled)) has been updated, [auto](../collections/ansible/builtin/auto_inventory.md#auto-inventory) is now before [yaml](../collections/ansible/builtin/yaml_inventory.md#yaml-inventory) and [ini](../collections/ansible/builtin/ini_inventory.md#ini-inventory).
...
- `osx_say` callback plugin was renamed into [say](https://docs.ansible.com/ansible/2.9/plugins/callback/say.html#say-callback "(in Ansible v2.9)").
- Inventory plugins now support caching via cache plugins. To start using a cache plugin with your inventory see the section on caching in the [inventory guide](../plugins/inventory.md#using-inventory). To port a custom cache plugin to be compatible with inventory see [developer guide on cache plugins](../dev_guide/developing_plugins.md#developing-cache-plugins).

## [Porting custom scripts](porting_guide_2.8.md#id23)

### [Display class](porting_guide_2.8.md#id24)
...
## [Networking](porting_guide_2.8.md#id25)
