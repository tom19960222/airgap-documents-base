...
source_url: https://docs.ansible.com/projects/ansible/6/porting_guides/porting_guide_2.5.html
...
See [Tests](../user_guide/playbooks_tests.md#playbooks-tests) for more information.
...
- nxos_mtu use [nxos_system](https://docs.ansible.com/ansible/2.5/modules/nxos_system_module.html#nxos-system-module "(in Ansible Documentation v2.5)")’s `system_mtu` option or [nxos_interface](https://docs.ansible.com/ansible/2.5/modules/nxos_interface_module.html#nxos-interface-module "(in Ansible Documentation v2.5)") instead
- cl_interface_policy use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_bridge use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_img_install use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_ports use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_license use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_interface use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- cl_bond use [nclu](https://docs.ansible.com/ansible/2.5/modules/nclu_module.html#nclu-module "(in Ansible Documentation v2.5)") instead
- ec2_vpc use [ec2_vpc_net](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_net_module.html#ec2-vpc-net-module "(in Ansible Documentation v2.5)") along with supporting modules [ec2_vpc_igw](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_igw_module.html#ec2-vpc-igw-module "(in Ansible Documentation v2.5)"), [ec2_vpc_route_table](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_route_table_module.html#ec2-vpc-route-table-module "(in Ansible Documentation v2.5)"), [ec2_vpc_subnet](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_subnet_module.html#ec2-vpc-subnet-module "(in Ansible Documentation v2.5)"), [ec2_vpc_dhcp_option](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_dhcp_option_module.html#ec2-vpc-dhcp-option-module "(in Ansible Documentation v2.5)"), [ec2_vpc_nat_gateway](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_nat_gateway_module.html#ec2-vpc-nat-gateway-module "(in Ansible Documentation v2.5)"), [ec2_vpc_nacl](https://docs.ansible.com/ansible/2.5/modules/ec2_vpc_nacl_module.html#ec2-vpc-nacl-module "(in Ansible Documentation v2.5)") instead.
- ec2_ami_search use [ec2_ami_facts](https://docs.ansible.com/ansible/2.5/modules/ec2_ami_facts_module.html#ec2-ami-facts-module "(in Ansible Documentation v2.5)") instead
- docker use [docker_container](https://docs.ansible.com/ansible/2.5/modules/docker_container_module.html#docker-container-module "(in Ansible Documentation v2.5)") and [docker_image](https://docs.ansible.com/ansible/2.5/modules/docker_image_module.html#docker-image-module "(in Ansible Documentation v2.5)") instead
...
- nxos_ip_interface use [nxos_l3_interface](https://docs.ansible.com/ansible/2.5/modules/nxos_l3_interface_module.html#nxos-l3-interface-module "(in Ansible Documentation v2.5)") instead.
- nxos_portchannel use [nxos_linkagg](https://docs.ansible.com/ansible/2.5/modules/nxos_linkagg_module.html#nxos-linkagg-module "(in Ansible Documentation v2.5)") instead.
- nxos_switchport use [nxos_l2_interface](https://docs.ansible.com/ansible/2.5/modules/nxos_l2_interface_module.html#nxos-l2-interface-module "(in Ansible Documentation v2.5)") instead.
- panos_security_policy use [panos_security_rule](https://docs.ansible.com/ansible/2.5/modules/panos_security_rule_module.html#panos-security-rule-module "(in Ansible Documentation v2.5)") instead.
- panos_nat_policy use [panos_nat_rule](https://docs.ansible.com/ansible/2.5/modules/panos_nat_rule_module.html#panos-nat-rule-module "(in Ansible Documentation v2.5)") instead.
- vsphere_guest use [vmware_guest](https://docs.ansible.com/ansible/2.5/modules/vmware_guest_module.html#vmware-guest-module "(in Ansible Documentation v2.5)") instead.

### [Noteworthy module changes](porting_guide_2.5.md#id23)

- The [stat](https://docs.ansible.com/ansible/2.5/modules/stat_module.html#stat-module "(in Ansible Documentation v2.5)") and [win_stat](https://docs.ansible.com/ansible/2.5/modules/win_stat_module.html#win-stat-module "(in Ansible Documentation v2.5)") modules have changed the default of the option `get_md5` from `true` to `false`.
...
- `osx_say` module was renamed into [say](https://docs.ansible.com/ansible/2.5/modules/say_module.html#say-module "(in Ansible Documentation v2.5)").
- Several modules which could deal with symlinks had the default value of their `follow` option
  ...
  - The [file module](https://docs.ansible.com/ansible/2.5/modules/file_module.html#file-module "(in Ansible Documentation v2.5)") changed from `follow=False` to `follow=True` because
  ...
  - The [replace module](https://docs.ansible.com/ansible/2.5/modules/replace_module.html#replace-module "(in Ansible Documentation v2.5)") had its `follow` parameter removed because it
    inherently modifies the content of an existing file so it makes no sense to operate on the link
    itself.
  - The [blockinfile module](https://docs.ansible.com/ansible/2.5/modules/blockinfile_module.html#blockinfile-module "(in Ansible Documentation v2.5)") had its `follow` parameter removed because
    it inherently modifies the content of an existing file so it makes no sense to operate on the
    link itself.
  - In Ansible-2.5.3, the [template module](https://docs.ansible.com/ansible/2.5/modules/template_module.html#template-module "(in Ansible Documentation v2.5)") became more strict about its
