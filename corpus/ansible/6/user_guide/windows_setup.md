...
collection: ansible
version: "6"
title: "Setting up a Windows Host"
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/windows_setup.html
...
- [Host Requirements](windows_setup.md#host-requirements)
  ...
  - [Upgrading PowerShell and .NET Framework](windows_setup.md#upgrading-powershell-and-net-framework)
  - [WinRM Memory Hotfix](windows_setup.md#winrm-memory-hotfix)
- [WinRM Setup](windows_setup.md#winrm-setup)

  - [WinRM Listener](windows_setup.md#winrm-listener)

    - [Setup WinRM Listener](windows_setup.md#setup-winrm-listener)
    - [Delete WinRM Listener](windows_setup.md#delete-winrm-listener)
  - [WinRM Service Options](windows_setup.md#winrm-service-options)
  - [Common WinRM Issues](windows_setup.md#common-winrm-issues)

    - [HTTP 401/Credentials Rejected](windows_setup.md#http-401-credentials-rejected)
    - [HTTP 500 Error](windows_setup.md#http-500-error)
    - [Timeout Errors](windows_setup.md#timeout-errors)
    - [Connection Refused Errors](windows_setup.md#connection-refused-errors)
    - [Failure to Load Builtin Modules](windows_setup.md#failure-to-load-builtin-modules)
- [Windows SSH Setup](windows_setup.md#windows-ssh-setup)

  - [Installing OpenSSH using Windows Settings](windows_setup.md#installing-openssh-using-windows-settings)
  - [Installing Win32-OpenSSH](windows_setup.md#installing-win32-openssh)
  - [Configuring the Win32-OpenSSH shell](windows_setup.md#configuring-the-win32-openssh-shell)
  - [Win32-OpenSSH Authentication](windows_setup.md#win32-openssh-authentication)
  - [Configuring Ansible for SSH on Windows](windows_setup.md#configuring-ansible-for-ssh-on-windows)
  - [Known issues with SSH on Windows](windows_setup.md#known-issues-with-ssh-on-windows)

## [Host Requirements](windows_setup.md#id1)
...
> **Note:**
>
> While these are the base requirements for Ansible connectivity, some Ansible
...
### [Upgrading PowerShell and .NET Framework](windows_setup.md#id2)
...
requirement. You can use the [Upgrade-PowerShell.ps1](https://github.com/jborean93/ansible-windows/blob/master/scripts/Upgrade-PowerShell.ps1) script to update these.
...
> **Note:**
>
> Windows Server 2008 can only install PowerShell 3.0; specifying a
> newer version will result in the script failing.

> **Note:**
>
> The `username` and `password` parameters are stored in plain text
...
### [WinRM Memory Hotfix](windows_setup.md#id3)
...
imaging process. The script [Install-WMF3Hotfix.ps1](https://github.com/jborean93/ansible-windows/blob/master/scripts/Install-WMF3Hotfix.ps1) can be used to install the hotfix on affected hosts.
...
## [WinRM Setup](windows_setup.md#id4)
...
### [WinRM Listener](windows_setup.md#id5)
...
#### [Setup WinRM Listener](windows_setup.md#id6)
...
- Using Group Policy Objects. This is the best way to create a listener when the
  ...
  [Group Policy Objects documentation](https://msdn.microsoft.com/en-us/library/aa374162(v=vs.85).aspx).
- Using PowerShell to create the listener with a specific configuration. This
  ...
  [New-WSManInstance](https://docs.microsoft.com/en-us/powershell/module/microsoft.wsman.management/new-wsmaninstance?view=powershell-5.1).
...
#### [Delete WinRM Listener](windows_setup.md#id7)
...
### [WinRM Service Options](windows_setup.md#id8)
...
> **Note:**
>
> If running in a domain environment, some of these options are set by
...
### [Common WinRM Issues](windows_setup.md#id9)
...
#### [HTTP 401/Credentials Rejected](windows_setup.md#id10)
...
#### [HTTP 500 Error](windows_setup.md#id11)
...
#### [Timeout Errors](windows_setup.md#id12)
...
#### [Connection Refused Errors](windows_setup.md#id13)
...
#### [Failure to Load Builtin Modules](windows_setup.md#id14)
...
## [Windows SSH Setup](windows_setup.md#id15)
...
### [Installing OpenSSH using Windows Settings](windows_setup.md#id16)
...
Please refer [this guide](https://docs.microsoft.com/en-us/windows-server/administration/openssh/openssh_install_firstuse).

### [Installing Win32-OpenSSH](windows_setup.md#id17)

The first step to using SSH with Windows is to install the [Win32-OpenSSH](https://github.com/PowerShell/Win32-OpenSSH)
...
- Manually install the service, following the [install instructions](https://github.com/PowerShell/Win32-OpenSSH/wiki/Install-Win32-OpenSSH)
  from Microsoft.
...
- Use an existing Ansible Galaxy role like [jborean93.win_openssh](https://galaxy.ansible.com/jborean93/win_openssh):
...
> **Note:**
>
> `Win32-OpenSSH` is still a beta product and is constantly
...
### [Configuring the Win32-OpenSSH shell](windows_setup.md#id18)
...
### [Win32-OpenSSH Authentication](windows_setup.md#id19)
...
### [Configuring Ansible for SSH on Windows](windows_setup.md#id20)
...
### [Known issues with SSH on Windows](windows_setup.md#id21)
