...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/windows_faq.html
...
- Use `become`, which runs a command as it would when run locally. This will
  ...
  under WinRM when `become` is used. See the [Understanding privilege escalation: become](become.md#become) documentation for more
  information.
...
See [Understanding privilege escalation: become](become.md#become) more info on how to use become. The limitations section at
...
> **See also:**
>
> [Windows Guides](windows.md#windows)
