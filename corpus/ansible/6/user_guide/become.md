...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/become.html
...
- [Using become](become.md#using-become)
  ...
  - [Become directives](become.md#become-directives)
  - [Become connection variables](become.md#become-connection-variables)
  - [Become command-line options](become.md#become-command-line-options)
- [Risks and limitations of become](become.md#risks-and-limitations-of-become)

  - [Risks of becoming an unprivileged user](become.md#risks-of-becoming-an-unprivileged-user)
  - [Not supported by all connection plugins](become.md#not-supported-by-all-connection-plugins)
  - [Only one method may be enabled per host](become.md#only-one-method-may-be-enabled-per-host)
  - [Privilege escalation must be general](become.md#privilege-escalation-must-be-general)
  - [May not access environment variables populated by pamd_systemd](become.md#may-not-access-environment-variables-populated-by-pamd-systemd)
  - [Resolving Temporary File Error Messsages](become.md#resolving-temporary-file-error-messsages)
- [Become and network automation](become.md#become-and-network-automation)

  - [Setting enable mode for all tasks](become.md#setting-enable-mode-for-all-tasks)

    - [Passwords for enable mode](become.md#passwords-for-enable-mode)
  - [authorize and auth_pass](become.md#authorize-and-auth-pass)
- [Become and Windows](become.md#become-and-windows)

  - [Administrative rights](become.md#administrative-rights)
  - [Local service accounts](become.md#local-service-accounts)
  - [Become without setting a password](become.md#become-without-setting-a-password)
  - [Accounts without a password](become.md#accounts-without-a-password)
  - [Become flags for Windows](become.md#become-flags-for-windows)
  - [Limitations of become on Windows](become.md#limitations-of-become-on-windows)

## [Using become](become.md#id1)
...
### [Become directives](become.md#id2)
...
### [Become connection variables](become.md#id3)
...
:   set the privilege escalation password. See [Using encrypted variables and files](vault.md#playbooks-vault) for details on how to avoid having secrets in plain text

ansible_common_remote_group
:   determines if Ansible should try to `chgrp` its temporary files to a group if `setfacl` and `chown` both fail. See [Risks of becoming an unprivileged user](become.md#risks-of-becoming-an-unprivileged-user) for more information. Added in version 2.10.
...
### [Become command-line options](become.md#id4)
...
## [Risks and limitations of become](become.md#id5)
...
### [Risks of becoming an unprivileged user](become.md#id6)
...
**chown** for systems which support doing so as an unprivileged user.
...
### [Not supported by all connection plugins](become.md#id7)
...
### [Only one method may be enabled per host](become.md#id8)
...
### [Privilege escalation must be general](become.md#id9)
...
### [May not access environment variables populated by pamd_systemd](become.md#id10)
...
### [Resolving Temporary File Error Messsages](become.md#id11)
...
## [Become and network automation](become.md#id12)
...
### [Setting enable mode for all tasks](become.md#id13)
...
#### [Passwords for enable mode](become.md#id14)
...
> **Warning:**
>
> As a reminder passwords should never be stored in plain text. For information on encrypting your passwords and other secrets with Ansible Vault, see [Encrypting content with Ansible Vault](vault.md#vault).

### [authorize and auth_pass](become.md#id15)
...
### [Administrative rights](become.md#id17)
...
### [Local service accounts](become.md#id18)
...
### [Become without setting a password](become.md#id19)
...
### [Accounts without a password](become.md#id20)
...
### [Become flags for Windows](become.md#id21)
...
### [Limitations of become on Windows](become.md#id22)
