...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_intro.html
...
Your playbook can include more than just a hosts line and tasks. For example, the playbook above sets a `remote_user` for each play. This is the user account for the SSH connection. You can add other [Playbook Keywords](../reference_appendices/playbooks_keywords.md#playbook-keywords) at the playbook, play, or task level to influence how Ansible behaves. Playbook keywords can control the [connection plugin](../plugins/connection.md#connection-plugins), whether to use [privilege escalation](become.md#become), how to handle errors, and more. To support a variety of environments, Ansible lets you set many of these parameters as command-line flags, in your Ansible configuration, or in your inventory. Learning the [precedence rules](../reference_appendices/general_precedence.md#general-precedence-rules) for these sources of data will help you as you expand your Ansible ecosystem.
...
## [Ansible-Pull](playbooks_intro.md#id8)
...
## [Verifying playbooks](playbooks_intro.md#id9)
...
### [ansible-lint](playbooks_intro.md#id10)
