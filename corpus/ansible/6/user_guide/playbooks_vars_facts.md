...
collection: ansible
version: "6"
title: "Discovering variables: facts and magic variables"
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_vars_facts.html
...
- [Ansible facts](playbooks_vars_facts.md#ansible-facts)
  ...
  - [Package requirements for fact gathering](playbooks_vars_facts.md#package-requirements-for-fact-gathering)
  - [Caching facts](playbooks_vars_facts.md#caching-facts)
  - [Disabling facts](playbooks_vars_facts.md#disabling-facts)
  - [Adding custom facts](playbooks_vars_facts.md#adding-custom-facts)

    - [facts.d or local facts](playbooks_vars_facts.md#facts-d-or-local-facts)
- [Information about Ansible: magic variables](playbooks_vars_facts.md#information-about-ansible-magic-variables)

  - [Ansible version](playbooks_vars_facts.md#ansible-version)

## [Ansible facts](playbooks_vars_facts.md#id3)

Ansible facts are data related to your remote systems, including operating systems, IP addresses, attached filesystems, and more. You can access this data in the `ansible_facts` variable. By default, you can also access some Ansible facts as top-level variables with the `ansible_` prefix. You can disable this behavior using the [INJECT_FACTS_AS_VARS](../reference_appendices/config.md#inject-facts-as-vars) setting. To see all available facts, add this task to a play:
...
You can use facts in conditionals (see [Conditionals](playbooks_conditionals.md#playbooks-conditionals)) and also in templates. You can also use facts to create dynamic groups of hosts that match particular criteria, see the [group_by module](../collections/ansible/builtin/group_by_module.md#group-by-module) documentation for details.

> **Note:**
>
> Because `ansible_date_time` is created and cached when Ansible gathers facts before each playbook run, it can get stale with long-running playbooks. If your playbook takes a long time to run, use the `pipe` filter (for example, `lookup('pipe', 'date +%Y-%m-%d.%H:%M:%S')`) or [now()](playbooks_templating.md#templating-now) with a Jinja 2 template instead of `ansible_date_time`.

### [Package requirements for fact gathering](playbooks_vars_facts.md#id4)
...
### [Caching facts](playbooks_vars_facts.md#id5)
...
Caching is controlled by the cache plugins. By default, Ansible uses the memory cache plugin, which stores facts in memory for the duration of the current playbook run. To retain Ansible facts for repeated use, select a different cache plugin. See [Cache plugins](../plugins/cache.md#cache-plugins) for details.
...
### [Disabling facts](playbooks_vars_facts.md#id6)
...
### [Adding custom facts](playbooks_vars_facts.md#id7)
...
#### [facts.d or local facts](playbooks_vars_facts.md#id8)
...
### [Ansible version](playbooks_vars_facts.md#id10)
