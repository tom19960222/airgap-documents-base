...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_variables.html
fetched_at: 2026-07-27T16:40:23+00:00
---
# Using Variables

Ansible uses variables to manage differences between systems. With Ansible, you can execute tasks and playbooks on multiple different systems with a single command. To represent the variations among those different systems, you can create variables with standard YAML syntax, including lists and dictionaries. You can define these variables in your playbooks, in your [inventory](intro_inventory.md#intro-inventory), in re-usable [files](playbooks_reuse.md#playbooks-reuse) or [roles](playbooks_reuse_roles.md#playbooks-reuse-roles), or at the command line. You can also create variables during a playbook run by registering the return value or values of a task as a new variable.
...
## [Creating valid variable names](playbooks_variables.md#id17)
...
## [Simple variables](playbooks_variables.md#id18)
...
### [Defining simple variables](playbooks_variables.md#id19)
...
### [Referencing simple variables](playbooks_variables.md#id20)
...
## [When to quote variables (a YAML gotcha)](playbooks_variables.md#id21)
...
## [List variables](playbooks_variables.md#id22)
...
### [Defining variables as lists](playbooks_variables.md#id23)
...
### [Referencing list variables](playbooks_variables.md#id24)
...
## [Dictionary variables](playbooks_variables.md#id25)
...
### [Defining variables as key:value dictionaries](playbooks_variables.md#id26)
...
### [Referencing key:value dictionary variables](playbooks_variables.md#id27)
...
## [Registering variables](playbooks_variables.md#id28)
...
## [Referencing nested variables](playbooks_variables.md#id29)
...
## [Transforming variables with Jinja2 filters](playbooks_variables.md#id30)
...
## [Where to set variables](playbooks_variables.md#id31)
...
### [Defining variables in inventory](playbooks_variables.md#id32)

You can define different variables for each individual host, or set shared variables for a group of hosts in your inventory. For example, if all machines in the `[Boston]` group use ‘boston.ntp.example.com’ as an NTP server, you can set a group variable. The [How to build your inventory](intro_inventory.md#intro-inventory) page has details on setting [host variables](intro_inventory.md#host-variables) and [group variables](intro_inventory.md#group-variables) in inventory.

### [Defining variables in a play](playbooks_variables.md#id33)
...
### [Defining variables in included files and roles](playbooks_variables.md#id34)
...
> **Note:**
>
> You can keep per-host and per-group variables in similar files. To learn about organizing your variables, see [Organizing host and group variables](intro_inventory.md#splitting-out-vars).

### [Defining variables at runtime](playbooks_variables.md#id35)
...
#### [key=value format](playbooks_variables.md#id36)
...
#### [JSON string format](playbooks_variables.md#id37)
...
#### [vars from a JSON or YAML file](playbooks_variables.md#id38)

```
ansible-playbook release.yml --extra-vars "@some_file.json"
```

## [Variable precedence: Where should I put a variable?](playbooks_variables.md#id39)
...
### [Understanding variable precedence](playbooks_variables.md#id40)

Ansible does apply variable precedence, and you might have a use for it. Here is the order of precedence from least to greatest (the last listed variables override all other variables):

> 1. command line values (for example, `-u my_user`, these are not variables)
> 2. role defaults (defined in role/defaults/main.yml) [[1]](playbooks_variables.md#id13)
> 3. inventory file or script group vars [[2]](playbooks_variables.md#id14)
> 4. inventory group_vars/all [[3]](playbooks_variables.md#id15)
> 5. playbook group_vars/all [[3]](playbooks_variables.md#id15)
> 6. inventory group_vars/\* [[3]](playbooks_variables.md#id15)
> 7. playbook group_vars/\* [[3]](playbooks_variables.md#id15)
> 8. inventory file or script host vars [[2]](playbooks_variables.md#id14)
> 9. inventory host_vars/\* [[3]](playbooks_variables.md#id15)
> 10. playbook host_vars/\* [[3]](playbooks_variables.md#id15)
> 11. host facts / cached set_facts [[4]](playbooks_variables.md#id16)
> 12. play vars
> 13. play vars_prompt
> 14. play vars_files
...
Ansible merges different variables set in inventory so that more specific settings override more generic settings. For example, `ansible_ssh_user` specified as a group_var is overridden by `ansible_user` specified as a host_var. For details about the precedence of variables set in inventory, see [How variables are merged](intro_inventory.md#how-we-merge).

Footnotes

[[1](playbooks_variables.md#id3)]

Tasks in each role see their own role’s defaults. Tasks defined outside of a role see the last role’s defaults.

[2]
([1](playbooks_variables.md#id4),[2](playbooks_variables.md#id9))

Variables defined in inventory file or provided by dynamic inventory.

[3]
([1](playbooks_variables.md#id5),[2](playbooks_variables.md#id6),[3](playbooks_variables.md#id7),[4](playbooks_variables.md#id8),[5](playbooks_variables.md#id10),[6](playbooks_variables.md#id11))
...
### [Scoping variables](playbooks_variables.md#id41)
...
### [Tips on where to set variables](playbooks_variables.md#id42)
...
Set common defaults in a `group_vars/all` file. See [Organizing host and group variables](intro_inventory.md#splitting-out-vars) for details on how to organize host and group variables in your inventory. Group variables are generally placed alongside your inventory file, but they can also be returned by dynamic inventory (see [Working with dynamic inventory](intro_dynamic_inventory.md#intro-dynamic-inventory)) or defined in AWX or on [Red Hat Ansible Automation Platform](../reference_appendices/tower.md#ansible-platform) from the UI or API:
...
## [Using advanced variable syntax](playbooks_variables.md#id43)

For information about advanced YAML syntax used to declare variables and have more control over the data placed in YAML files used by Ansible, see [Advanced Syntax](playbooks_advanced_syntax.md#playbooks-advanced-syntax).
