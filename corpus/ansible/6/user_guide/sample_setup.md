...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/sample_setup.html
...
This layout gives you more flexibility for larger environments, as well as a total separation of inventory variables between different environments. However, this approach is harder to maintain, because there are more files. For more information on organizing group and host variables, see [Organizing host and group variables](intro_inventory.md#splitting-out-vars).
...
Again, if you are using [dynamic inventory](intro_dynamic_inventory.md#dynamic-inventory), Ansible creates many dynamic groups automatically. So a tag like “class:webserver” would load in variables from the file “group_vars/ec2_tag_class_webserver” automatically.
...
See [Roles](playbooks_reuse_roles.md#playbooks-reuse-roles) for more information.
