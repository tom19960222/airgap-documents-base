...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_reuse.html
...
- [Re-using files and roles](playbooks_reuse.md#re-using-files-and-roles)
  ...
  - [Includes: dynamic re-use](playbooks_reuse.md#includes-dynamic-re-use)
  - [Imports: static re-use](playbooks_reuse.md#imports-static-re-use)
  - [Comparing includes and imports: dynamic and static re-use](playbooks_reuse.md#comparing-includes-and-imports-dynamic-and-static-re-use)
...
## [Creating re-usable files and roles](playbooks_reuse.md#id1)
...
> - A role contains a set of related tasks, variables, defaults, handlers, and even modules or other plugins in a defined file-tree. Unlike variables files, task files, or playbooks, roles can be easily uploaded and shared via Ansible Galaxy. See [Roles](playbooks_reuse_roles.md#playbooks-reuse-roles) for details about creating and using roles.
...
### [Includes: dynamic re-use](playbooks_reuse.md#id5)
...
### [Imports: static re-use](playbooks_reuse.md#id6)
...
### [Comparing includes and imports: dynamic and static re-use](playbooks_reuse.md#id7)
...
You can also use includes and imports in the [Handlers: running operations on change](playbooks_handlers.md#handlers) section of a playbook. For instance, if you want to define how to restart Apache, you only have to do that once for all of your playbooks. You might make a `restarts.yml` file that looks like:
