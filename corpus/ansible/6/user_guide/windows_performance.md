...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/windows_performance.html
...
high CPU task near startup via [processing the ngen queue](https://docs.microsoft.com/en-us/dotnet/framework/tools/ngen-exe-native-image-generator#native-image-service)
