...
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/intro_patterns.html
...
You use a pattern almost any time you execute an ad hoc command or a playbook. The pattern is the only element of an [ad hoc command](intro_adhoc.md#intro-adhoc) that has no flag. It is usually the second element:
...
### [Using regexes in patterns](intro_patterns.md#id9)
...
## [Patterns and ad-hoc commands](intro_patterns.md#id10)
...
## [Patterns and ansible-playbook flags](intro_patterns.md#id11)
...
To apply your knowledge of patterns with Ansible commands and playbooks, read [Introduction to ad hoc commands](intro_adhoc.md#intro-adhoc) and [Intro to playbooks](playbooks_intro.md#playbooks-intro).
