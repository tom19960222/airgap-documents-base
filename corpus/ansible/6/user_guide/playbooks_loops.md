...
version: "6"
title: "Loops"
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_loops.html
...
- [Adding controls to loops](playbooks_loops.md#adding-controls-to-loops)
  ...
  - [Defining inner and outer variable names with `loop_var`](playbooks_loops.md#defining-inner-and-outer-variable-names-with-loop-var)
...
## [Comparing `loop` and `with_*`](playbooks_loops.md#id3)
...
## [Standard loops](playbooks_loops.md#id4)
...
## [Complex loops](playbooks_loops.md#id9)

### [Iterating over nested lists](playbooks_loops.md#id10)
...
### [Retrying a task until a condition is met](playbooks_loops.md#id11)
...
### [Looping over inventory](playbooks_loops.md#id12)
...
More information on the patterns can be found in [Patterns: targeting hosts and groups](intro_patterns.md#intro-patterns).

## [Ensuring list input for `loop`: using `query` rather than `lookup`](playbooks_loops.md#id13)
...
## [Adding controls to loops](playbooks_loops.md#id14)

New in version 2.1.

The `loop_control` keyword lets you manage your loops in useful ways.

### [Limiting loop output with `label`](playbooks_loops.md#id15)
...
### [Pausing within a loop](playbooks_loops.md#id16)
...
### [Tracking progress through a loop with `index_var`](playbooks_loops.md#id17)
...
### [Defining inner and outer variable names with `loop_var`](playbooks_loops.md#id18)
...
### [Extended loop variables](playbooks_loops.md#id19)
...
### [Accessing the name of your loop_var](playbooks_loops.md#id20)
...
## [Migrating from with_X to loop](playbooks_loops.md#id21)
...
### [with_list](playbooks_loops.md#id22)
...
### [with_items](playbooks_loops.md#id23)
...
### [with_indexed_items](playbooks_loops.md#id24)
...
### [with_flattened](playbooks_loops.md#id25)
...
### [with_together](playbooks_loops.md#id26)
...
### [with_dict](playbooks_loops.md#id27)
...
### [with_sequence](playbooks_loops.md#id28)
...
### [with_subelements](playbooks_loops.md#id29)
...
### [with_nested/with_cartesian](playbooks_loops.md#id30)
...
### [with_random_choice](playbooks_loops.md#id31)
