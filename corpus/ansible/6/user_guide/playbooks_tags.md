...
version: "6"
title: "Tags"
source_url: https://docs.ansible.com/projects/ansible/6/user_guide/playbooks_tags.html
fetched_at: 2026-07-27T16:40:21+00:00
---
# Tags
...
- [Selecting or skipping tags when you run a playbook](playbooks_tags.md#selecting-or-skipping-tags-when-you-run-a-playbook)
  ...
  - [Selectively running tagged tasks in re-usable files](playbooks_tags.md#selectively-running-tagged-tasks-in-re-usable-files)
...
These command-line flags have one limitation: they cannot show tags or tasks within dynamically included files or roles. See [Comparing includes and imports: dynamic and static re-use](playbooks_reuse.md#dynamic-vs-static) for more information on differences between static imports and dynamic includes.

### [Selectively running tagged tasks in re-usable files](playbooks_tags.md#id14)
