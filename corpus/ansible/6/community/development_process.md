...
source_url: https://docs.ansible.com/projects/ansible/6/community/development_process.html
...
- [Micro development: the lifecycle of a PR](development_process.md#micro-development-the-lifecycle-of-a-pr)
  ...
  - [Automated PR review: ansibullbot](development_process.md#automated-pr-review-ansibullbot)

    - [Ansibot workflow](development_process.md#ansibot-workflow)
    - [PR labels](development_process.md#pr-labels)

      - [Workflow labels](development_process.md#workflow-labels)
      - [Information labels](development_process.md#information-labels)
      - [Special Labels](development_process.md#special-labels)
  - [Human PR review](development_process.md#human-pr-review)
- [Making your PR merge-worthy](development_process.md#making-your-pr-merge-worthy)
  ...
  - [Creating changelog fragments](development_process.md#creating-changelog-fragments)
    ...
    - [Changelog fragment entry format for new jinja2 plugins, roles, and playbooks](development_process.md#changelog-fragment-entry-format-for-new-jinja2-plugins-roles-and-playbooks)
...
- various GitHub [projects](https://github.com/ansible/ansible/projects) - for example:
  ...
  > - the [2.12 release project](https://github.com/ansible/ansible/projects/43)
  > - the [core documentation project](https://github.com/ansible/ansible/projects/27)
...
### [Automated PR review: ansibullbot](development_process.md#id3)
...
[Ansibullbot](https://github.com/ansible/ansibullbot/blob/master/ISSUE_HELP.md) serves many functions:
...
#### [Ansibot workflow](development_process.md#id4)
...
##### [Information labels](development_process.md#id7)
...
##### [Special Labels](development_process.md#id8)
...
### [Human PR review](development_process.md#id9)
...
Each module has at least one assigned [maintainer](maintainers.md#maintainers), listed in the [BOTMETA.yml](https://github.com/ansible/ansible/blob/devel/.github/BOTMETA.yml) file.
...
Once a human applies the `shipit` label, the [committers](committer_guidelines.md#community-committer-guidelines) decide whether the PR is ready to be merged. Not every PR that gets the `shipit` label is actually ready to be merged, but the better our reviewers are, and the better our guidelines are, the more likely it will be that a PR that reaches **shipit** will be mergeable.

## [Making your PR merge-worthy](development_process.md#id10)

We do not merge every PR. Here are some tips for making your PR useful, attractive, and merge-worthy.

### [Creating changelog fragments](development_process.md#id11)
...
#### [Creating a changelog fragment](development_process.md#id12)
...
#### [Changelog fragment entry format](development_process.md#id13)
...
You can find more example changelog fragments in the [changelog directory](https://github.com/ansible/ansible/tree/stable-2.12/changelogs/fragments) for the 2.12 release.

After you have written the changelog fragment for your PR, commit the file and include it with the pull request.

#### [Changelog fragment entry format for new jinja2 plugins, roles, and playbooks](development_process.md#id14)
...
## [Backporting merged PRs in `ansible-core`](development_process.md#id15)
...
1. Submit the pull request for `backport/2.13/[PR_NUMBER_FROM_DEVEL]` against the `stable-2.13` branch
