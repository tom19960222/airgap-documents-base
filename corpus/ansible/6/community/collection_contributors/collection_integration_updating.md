...
source_url: https://docs.ansible.com/projects/ansible/6/community/collection_contributors/collection_integration_updating.html
...
In reality, we would alternate the tasks above with the same tasks run with the `check_mode: yes` option to be sure our option works as expected in check-mode as well. See [Recommendations on coverage](collection_integration_about.md#collection-integration-recommendations) for details.
