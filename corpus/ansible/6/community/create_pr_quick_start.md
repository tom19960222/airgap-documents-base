...
source_url: https://docs.ansible.com/projects/ansible/6/community/create_pr_quick_start.html
...
8. Wait for reviews. You can also ask for review in the `#ansible-community` [Matrix/Libera.Chat IRC channel](communication.md#communication-irc).
