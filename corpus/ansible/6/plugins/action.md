...
source_url: https://docs.ansible.com/projects/ansible/6/plugins/action.html
...
Action plugins act in conjunction with [modules](../user_guide/modules.md#working-with-modules) to execute the actions required by playbook tasks. They usually execute automatically in the background doing prerequisite work before modules execute.
