...
source_url: https://docs.ansible.com/projects/ansible/6/plugins/lookup.html
fetched_at: 2026-07-27T16:40:41+00:00
---
# Lookup plugins
...
Lookups are an integral part of loops. Wherever you see `with_`, the part after the underscore is the name of a lookup. For this reason, most lookups output lists and take lists as input; for example, `with_items` uses the [items](../collections/ansible/builtin/items_lookup.md#items-lookup) lookup:
...
You can combine lookups with [filters](../user_guide/playbooks_filters.md#playbooks-filters), [tests](../user_guide/playbooks_tests.md#playbooks-tests) and even each other to do some complex data generation and manipulation. For example:
