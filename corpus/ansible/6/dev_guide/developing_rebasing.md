...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_rebasing.html
...
For help with rebasing your PR, or other development related questions, join us on the #ansible-devel chat channel (using Matrix at ansible.im or using IRC at [irc.libera.chat](https://libera.chat/)).

> **See also:**
>
> [The Ansible Development Cycle](../community/development_process.md#community-development-process)
