...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing_validate-modules.html
fetched_at: 2026-07-28T00:24:24+00:00
---
# [validate-modules](testing_validate-modules.md#id1)

Topics

- [validate-modules](testing_validate-modules.md#validate-modules)

  - [Usage](testing_validate-modules.md#usage)
  - [Help](testing_validate-modules.md#help)
  - [Extending validate-modules](testing_validate-modules.md#extending-validate-modules)
  - [Codes](testing_validate-modules.md#codes)

Python program to help test or validate Ansible modules.

`validate-modules` is one of the `ansible-test` Sanity Tests, see [Sanity Tests](testing_sanity.md#testing-sanity) for more information.

Originally developed by Matt Martz (@sivel)

## [Usage](testing_validate-modules.md#id2)
...
## [Help](testing_validate-modules.md#id3)
...
## [Extending validate-modules](testing_validate-modules.md#id4)
...
## [Codes](testing_validate-modules.md#id5)
...
| use-short-gplv3-license | Documentation | Error | GPLv3 license header should be the [short form](developing_modules_documenting.md#copyright) for new modules |
