...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_program_flow_modules.html
...
## [Types of modules](developing_program_flow_modules.md#id2)
...
### [Action plugins](developing_program_flow_modules.md#id3)
...
### [New-style modules](developing_program_flow_modules.md#id4)
...
#### [Python](developing_program_flow_modules.md#id5)
...
#### [PowerShell](developing_program_flow_modules.md#id6)
...
### [JSONARGS modules](developing_program_flow_modules.md#id7)
...
### [Non-native want JSON modules](developing_program_flow_modules.md#id8)
...
### [Binary modules](developing_program_flow_modules.md#id9)
...
### [Old-style modules](developing_program_flow_modules.md#id10)
...
## [How modules are executed](developing_program_flow_modules.md#id11)
...
### [Executor/task_executor](developing_program_flow_modules.md#id12)
...
**/usr/bin/ansible**). It uses the name to decide whether it’s looking
at a module or an [Action Plugin](developing_program_flow_modules.md#flow-action-plugins). If it’s
...
### [The `normal` action plugin](developing_program_flow_modules.md#id13)
...
### [Executor/module_common.py](developing_program_flow_modules.md#id14)
...
### [Assembler frameworks](developing_program_flow_modules.md#id15)

Ansible supports two assembler frameworks: Ansiballz and the older Module Replacer.

#### [Module Replacer framework](developing_program_flow_modules.md#id16)
...
#### [Ansiballz framework](developing_program_flow_modules.md#id17)
...
### [Passing args](developing_program_flow_modules.md#id18)
...
### [Internal arguments](developing_program_flow_modules.md#id19)
...
the features are implemented in [`ansible.module_utils.basic`](../reference_appendices/module_utils.md#module-ansible.module_utils.basic "ansible.module_utils.basic") but certain
features need support from the module so it’s good to know about them.

The internal arguments listed here are global. If you need to add a local internal argument to a custom module, create an action plugin for that specific module - see `_original_basename` in the [copy action plugin](https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/action/copy.py#L329) for an example.

#### [_ansible_no_log](developing_program_flow_modules.md#id20)

Boolean. Set to True whenever a parameter in a task or play specifies `no_log`. Any module that calls [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") handles this automatically. If a module implements its own logging then
it needs to check this value. To access in a module, instantiate an
`AnsibleModule` and then check the value of [`AnsibleModule.no_log`](../api/index.md#AnsibleModule.no_log "AnsibleModule.no_log").

> **Note:**
>
> `no_log` specified in a module’s argument_spec is handled by a different mechanism.

#### [_ansible_debug](developing_program_flow_modules.md#id21)
...
[`AnsibleModule.debug()`](../api/index.md#AnsibleModule.debug "AnsibleModule.debug") rather than [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") then
the messages are only logged if `_ansible_debug` is set to `True`.
To set, add `debug: True` to `ansible.cfg` or set the environment
variable [`ANSIBLE_DEBUG`](../reference_appendices/config.md#envvar-ANSIBLE_DEBUG). To access in a module, instantiate an
`AnsibleModule` and access [`AnsibleModule._debug`](../api/index.md#AnsibleModule._debug "AnsibleModule._debug").

#### [_ansible_diff](developing_program_flow_modules.md#id22)
...
[`AnsibleModule._diff`](../api/index.md#AnsibleModule._diff "AnsibleModule._diff").

#### [_ansible_verbosity](developing_program_flow_modules.md#id23)

Unused. This value could be used for finer grained control over logging.

#### [_ansible_selinux_special_fs](developing_program_flow_modules.md#id24)
...
[`AnsibleModule._selinux_special_fs`](../api/index.md#AnsibleModule._selinux_special_fs "AnsibleModule._selinux_special_fs").

This replaces [`ansible.module_utils.basic.SELINUX_SPECIAL_FS`](../api/index.md#ansible.module_utils.basic.SELINUX_SPECIAL_FS "ansible.module_utils.basic.SELINUX_SPECIAL_FS") from
[Module Replacer framework](developing_program_flow_modules.md#module-replacer). In module replacer it was a comma separated string of
filesystem names. Under Ansiballz it’s an actual list.

New in version 2.1.

#### [_ansible_syslog_facility](developing_program_flow_modules.md#id25)

This parameter controls which syslog facility Ansible module logs to. To set, change the `syslog_facility` value in `ansible.cfg`. Most
modules should just use [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") which will then make use of
...
[`AnsibleModule._syslog_facility`](../api/index.md#AnsibleModule._syslog_facility "AnsibleModule._syslog_facility"). The Ansiballz code is less hacky than the old [Module Replacer framework](developing_program_flow_modules.md#module-replacer) code:
...
#### [_ansible_version](developing_program_flow_modules.md#id26)
...
from [`AnsibleModule.ansible_version`](../api/index.md#AnsibleModule.ansible_version "AnsibleModule.ansible_version"). This replaces
[`ansible.module_utils.basic.ANSIBLE_VERSION`](../api/index.md#ansible.module_utils.basic.ANSIBLE_VERSION "ansible.module_utils.basic.ANSIBLE_VERSION") from
[Module Replacer framework](developing_program_flow_modules.md#module-replacer).

New in version 2.1.

### [Module return values & Unsafe strings](developing_program_flow_modules.md#id27)
...
### [Special considerations](developing_program_flow_modules.md#id28)

#### [Pipelining](developing_program_flow_modules.md#id29)
...
#### [Why pass args over stdin?](developing_program_flow_modules.md#id30)
...
### [AnsibleModule](developing_program_flow_modules.md#id31)

#### [Argument spec](developing_program_flow_modules.md#id32)
...
#### [Dependencies between module options](developing_program_flow_modules.md#id33)
...
#### [Declaring check mode support](developing_program_flow_modules.md#id34)
...
#### [Adding file options](developing_program_flow_modules.md#id35)
