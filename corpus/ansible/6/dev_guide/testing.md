...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing.html
...
- [Testing within GitHub & Azure Pipelines](testing.md#testing-within-github-azure-pipelines)
  ...
  - [Organization](testing.md#organization)
  - [Rerunning a failing CI job](testing.md#rerunning-a-failing-ci-job)
- [How to test a PR](testing.md#how-to-test-a-pr)

  - [Setup: Checking out a Pull Request](testing.md#setup-checking-out-a-pull-request)
  - [Testing the Pull Request](testing.md#testing-the-pull-request)

    - [Run sanity tests](testing.md#run-sanity-tests)
    - [Run unit tests](testing.md#run-unit-tests)
    - [Run integration tests](testing.md#run-integration-tests)
    - [Code Coverage Online](testing.md#code-coverage-online)
- [Want to know more about testing?](testing.md#want-to-know-more-about-testing)

## [Why test your Ansible contributions?](testing.md#id1)
...
If you want to learn about testing collections, read [Testing collections](developing_collections_testing.md#testing-collections)

## [Types of tests](testing.md#id2)

At a high level we have the following classifications of tests:

compile:
:   - [Compile Tests](testing_compile.md#testing-compile)
...
## [Testing within GitHub & Azure Pipelines](testing.md#id3)

### [Organization](testing.md#id4)
...
### [Rerunning a failing CI job](testing.md#id5)
...
If the issue persists, please contact us in the `#ansible-devel` chat channel (using Matrix at ansible.im or using IRC at [irc.libera.chat](https://libera.chat/)).

## [How to test a PR](testing.md#id6)
...
### [Setup: Checking out a Pull Request](testing.md#id7)
...
### [Testing the Pull Request](testing.md#id8)
...
#### [Run sanity tests](testing.md#id9)

```shell
ansible-test sanity
```

More information: [Sanity Tests](testing_sanity.md#testing-sanity)

#### [Run unit tests](testing.md#id10)

```shell
ansible-test units
```

More information: [Unit Tests](testing_units.md#testing-units)

#### [Run integration tests](testing.md#id11)

```shell
ansible-test integration -v ping
```

More information: [Integration tests](testing_integration.md#testing-integration)
...
#### [Code Coverage Online](testing.md#id12)
...
testing. See [Testing Ansible and Collections](testing_running_locally.md#testing-running-locally) for more information.

## [Want to know more about testing?](testing.md#id13)

If you’d like to know more about the plans for improving testing Ansible then why not join the
[Testing Working Group](https://github.com/ansible/community/blob/master/meetings/README.md).
