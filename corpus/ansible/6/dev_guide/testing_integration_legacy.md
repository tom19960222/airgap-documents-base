...
collection: ansible
version: "6"
title: "Testing using the Legacy Integration system"
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing_integration_legacy.html
fetched_at: 2026-07-28T00:24:26+00:00
---
# [Testing using the Legacy Integration system](testing_integration_legacy.md#id1)

Topics

- [Testing using the Legacy Integration system](testing_integration_legacy.md#testing-using-the-legacy-integration-system)

  - [Running Cloud Tests](testing_integration_legacy.md#running-cloud-tests)
  - [Other configuration](testing_integration_legacy.md#other-configuration)
  - [IAM policies for AWS](testing_integration_legacy.md#iam-policies-for-aws)

    - [testing-iam-policy.json.j2](testing_integration_legacy.md#testing-iam-policy-json-j2)
    - [Other Definitions required](testing_integration_legacy.md#other-definitions-required)
  - [Running Tests](testing_integration_legacy.md#running-tests)
...
## [Running Cloud Tests](testing_integration_legacy.md#id2)
...
## [Other configuration](testing_integration_legacy.md#id3)
...
## [IAM policies for AWS](testing_integration_legacy.md#id4)
...
### [testing-iam-policy.json.j2](testing_integration_legacy.md#id5)
...
### [Other Definitions required](testing_integration_legacy.md#id6)
...
## [Running Tests](testing_integration_legacy.md#id7)
