...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_locally.html
...
- [Plugins](../plugins/plugins.md#working-with-plugins) extend Ansible’s core functionality and execute on the control node within the `/usr/bin/ansible` process. Plugins offer options and extensions for the core features of Ansible - transforming data, logging output, connecting to inventory, and more.
...
## [Adding a module outside of a collection](developing_locally.md#id3)
...
> **Note:**
>
> Although modules are plugins, the naming patterns for directory names and environment variables that apply to other plugin types do not apply to modules. See [Adding a module outside of a collection](developing_locally.md#local-modules).
