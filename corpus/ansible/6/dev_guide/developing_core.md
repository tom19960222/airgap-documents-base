...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_core.html
fetched_at: 2026-07-27T16:39:59+00:00
---
# Developing `ansible-core`

Although `ansible-core` (the code hosted in the [ansible/ansible repository](https://github.com/ansible/ansible) on GitHub) includes a few plugins that can be swapped out via playbook directives or configuration, much of the code there is not modular. The documents here give insight into how the parts of `ansible-core` work together.
