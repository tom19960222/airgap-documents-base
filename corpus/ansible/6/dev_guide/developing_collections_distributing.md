...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_collections_distributing.html
...
## [Initial configuration of your distribution server or servers](developing_collections_distributing.md#id2)
...
### [Creating a namespace](developing_collections_distributing.md#id3)
...
### [Getting your API token](developing_collections_distributing.md#id4)
...
### [Specifying your API token and distribution server](developing_collections_distributing.md#id5)
...
You cannot use `apt-key` with any servers defined in your [galaxy_server_list](../user_guide/collections_using.md#galaxy-server-config). See [Configuring the ansible-galaxy client](../user_guide/collections_using.md#galaxy-server-config) for complete details.
...
## [Building your collection tarball](developing_collections_distributing.md#id6)
...
### [Ignoring files and folders](developing_collections_distributing.md#id7)
...
For more information on the `galaxy.yml` file, see [Collection Galaxy metadata structure](collections_galaxy_meta.md#collections-galaxy-meta).

> **Note:**
>
> The `build_ignore` feature is only supported with `ansible-galaxy collection build` in Ansible 2.10 or newer.

### [Signing a collection](developing_collections_distributing.md#id8)
...
## [Preparing to publish your collection](developing_collections_distributing.md#id9)
...
### [Installing your collection locally](developing_collections_distributing.md#id10)
...
### [Reviewing your collection](developing_collections_distributing.md#id11)

Review the collection:

- Run a playbook that uses the modules and plugins in your collection. Verify that new features and functionality work as expected. For examples and more details see [Using collections](../user_guide/collections_using.md#id2).
...
### [Understanding collection versioning](developing_collections_distributing.md#id12)
...
## [Publishing your collection](developing_collections_distributing.md#id13)
...
### [Publishing a collection from the command line](developing_collections_distributing.md#id14)
...
### [Publishing a collection from the website](developing_collections_distributing.md#id15)
