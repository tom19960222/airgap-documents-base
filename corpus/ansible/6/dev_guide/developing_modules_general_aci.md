...
collection: ansible
version: "6"
title: "Developing Cisco ACI modules"
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_modules_general_aci.html
fetched_at: 2026-07-27T16:39:55+00:00
---
# Developing Cisco ACI modules

This is a brief walk-through of how to create new Cisco ACI modules for Ansible.

For more information about Cisco ACI, look at the [Cisco ACI user guide](../scenario_guides/guide_aci.md#aci-guide).

What’s covered in this section:

- [Introduction](developing_modules_general_aci.md#introduction)
- [ACI module structure](developing_modules_general_aci.md#aci-module-structure)

  - [Importing objects from Python libraries](developing_modules_general_aci.md#importing-objects-from-python-libraries)
  - [Defining the argument spec](developing_modules_general_aci.md#defining-the-argument-spec)
  - [Using the AnsibleModule object](developing_modules_general_aci.md#using-the-ansiblemodule-object)
  - [Mapping variable definition](developing_modules_general_aci.md#mapping-variable-definition)
  - [Using the ACIModule object](developing_modules_general_aci.md#using-the-acimodule-object)

    - [Constructing URLs](developing_modules_general_aci.md#constructing-urls)
    - [Getting the existing configuration](developing_modules_general_aci.md#getting-the-existing-configuration)
    - [When state is present](developing_modules_general_aci.md#when-state-is-present)
    - [When state is absent](developing_modules_general_aci.md#when-state-is-absent)
    - [Exiting the module](developing_modules_general_aci.md#exiting-the-module)
- [Testing ACI library functions](developing_modules_general_aci.md#testing-aci-library-functions)

  - [Testing for sanity checks](developing_modules_general_aci.md#testing-for-sanity-checks)
  - [Testing ACI integration tests](developing_modules_general_aci.md#testing-aci-integration-tests)
  - [Testing for test coverage](developing_modules_general_aci.md#testing-for-test-coverage)

## [Introduction](developing_modules_general_aci.md#id2)

The [cisco.aci collection](https://galaxy.ansible.com/cisco/aci) already includes a large number of Cisco ACI modules, however the ACI object model is huge and covering all possible functionality would easily cover more than 1500 individual modules.

If you need specific functionality, you have 2 options:

- Learn the ACI object model and use the low-level APIC REST API using the [aci_rest](https://docs.ansible.com/ansible/2.9/modules/aci_rest_module.html#aci-rest-module "(in Ansible v2.9)") module
- Write your own dedicated modules, which is actually quite easy

> **See also:**
>
> [Ansible ACI collection](https://github.com/CiscoDevNet/ansible-aci)
> :   Github repository of the ansible ACI collection
>
> [Contributing to collections](developing_collections_contributing.md#hacking-collections)
...
## [ACI module structure](developing_modules_general_aci.md#id3)

### [Importing objects from Python libraries](developing_modules_general_aci.md#id4)
...
### [Defining the argument spec](developing_modules_general_aci.md#id5)
...
### [Using the AnsibleModule object](developing_modules_general_aci.md#id6)
...
### [Mapping variable definition](developing_modules_general_aci.md#id7)
...
### [Using the ACIModule object](developing_modules_general_aci.md#id8)
...
#### [Constructing URLs](developing_modules_general_aci.md#id9)
...
#### [Getting the existing configuration](developing_modules_general_aci.md#id10)
...
#### [When state is present](developing_modules_general_aci.md#id11)
...
#### [When state is absent](developing_modules_general_aci.md#id12)
...
#### [Exiting the module](developing_modules_general_aci.md#id13)
...
## [Testing ACI library functions](developing_modules_general_aci.md#id14)
...
### [Testing for sanity checks](developing_modules_general_aci.md#id15)
...
>
> [Sanity Tests](testing_sanity.md#testing-sanity)
> :   Information on how to build sanity tests.
>
> [Ansible ACI collection](https://github.com/CiscoDevNet/ansible-aci)
> :   Github repository of the ansible ACI collection

### [Testing ACI integration tests](developing_modules_general_aci.md#id16)
...
> **See also:**
>
> [Integration tests](testing_integration.md#testing-integration)
> :   Information on how to build integration tests.

### [Testing for test coverage](developing_modules_general_aci.md#id17)
