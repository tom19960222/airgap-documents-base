...
version: "6"
title: "ignores"
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing/sanity/ignores.html
fetched_at: 2026-07-27T16:42:25+00:00
---
# ignores
...
If this occurs, open a new [bug report](https://github.com/ansible/ansible/issues/new?template=bug_report.md) for the issue so it can be fixed.
...
See the full list of [sanity tests](index.md#all-sanity-tests), which details the various tests and details how to fix identified issues.
