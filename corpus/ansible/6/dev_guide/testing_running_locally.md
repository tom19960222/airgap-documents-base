...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing_running_locally.html
...
## [Setup](testing_running_locally.md#id1)

Before running `ansible-test`, set up your environment for Testing an Ansible Collection or
Testing ansible-core, depending on which scenario applies to you.
...
### [Testing an Ansible Collection](testing_running_locally.md#id2)
...
### [Testing `ansible-core`](testing_running_locally.md#id3)
...
## [Commands](testing_running_locally.md#id4)
...
#### [Choosing a container](testing_running_locally.md#id7)
...
##### [Custom containers](testing_running_locally.md#id8)
...
##### [Configuration requirements](testing_running_locally.md#id11)
...
##### [Setup instructions](testing_running_locally.md#id12)

> **Note:**
>
> If all WSL instances have been stopped, these changes will need to be re-applied.

1. Verify Docker Desktop is properly configured (see Configuration requirements).
...
5. Start a WSL instance and perform the following steps as `root`:
   ...
   1. Verify the `systemd` subsystem is not registered:
      ...
      1. Check for the `systemd` cgroup hierarchy with the following command:
         ...
         ```
      2. If any matches are found, re-check the Configuration requirements and follow the
...
#### [Linux cgroup configuration](testing_running_locally.md#id13)
...
##### [Podman](testing_running_locally.md#id14)
...
### [Remote virtual machines](testing_running_locally.md#id15)
...
### [Python virtual environments](testing_running_locally.md#id16)
...
### [Composite environment arguments](testing_running_locally.md#id17)
...
## [Additional Requirements](testing_running_locally.md#id18)
...
## [Environment variables](testing_running_locally.md#id19)
...
- Not exposed to the test environment unless enabled in `test/lib/ansible_test/_internal/util.py` in the `common_environment` function.
  ...
  > [Debugging AnsibleModule-based modules](debugging.md#debugging-modules) instructions.

## [Interactive shell](testing_running_locally.md#id20)
...
## [Code coverage](testing_running_locally.md#id21)
