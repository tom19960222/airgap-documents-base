...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/testing_integration.html
fetched_at: 2026-07-27T16:42:48+00:00
---
...
- [Integration tests](testing_integration.md#integration-tests)
  ...
  - [Legacy Cloud Tests](testing_integration.md#legacy-cloud-tests)
...
## [Legacy Cloud Tests](testing_integration.md#id13)

Some of the cloud tests run as normal integration tests, and others run as legacy tests; see the
[Testing using the Legacy Integration system](testing_integration_legacy.md#testing-integration-legacy) page for more information.

## [Other configuration for Cloud Tests](testing_integration.md#id14)
...
## [IAM policies for AWS](testing_integration.md#id15)
...
### [testing-policies](testing_integration.md#id16)
...
### [Other Definitions required](testing_integration.md#id17)
...
## [Network Tests](testing_integration.md#id18)
...
## [Where to find out more](testing_integration.md#id19)

If you’d like to know more about the plans for improving testing Ansible, join the [Testing Working Group](https://github.com/ansible/community/blob/master/meetings/README.md).
