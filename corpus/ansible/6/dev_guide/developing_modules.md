...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/developing_modules.html
...
A combination of existing modules may cover the functionality you want. You can write a role for this type of use case. Check out the [roles documentation](../user_guide/playbooks_reuse_roles.md#playbooks-reuse-roles).
