...
source_url: https://docs.ansible.com/projects/ansible/6/dev_guide/index.html
...
- I’ve read the info above, and I’m sure I want to develop a module:
  ...
  >       - an [OpenStack module](platforms/openstack_guidelines.md#openstack-module-development).
  >       - an [oVirt/RHV module](platforms/ovirt_dev_guide.md#ovirt-module-development).
...
- I want to contribute back to the Ansible project:
  ...
  - I want to [understand the license agreement](../community/contributor_license_agreement.md#contributor-license-agreement) for contributions to Ansible.
...
- [Adding modules and plugins locally](developing_locally.md)
  ...
  - [Adding a module outside of a collection](developing_locally.md#adding-a-module-outside-of-a-collection)
...
- [Developing Cisco ACI modules](developing_modules_general_aci.md)
...
- [Guidelines for Ansible Amazon AWS module development](platforms/aws_guidelines.md)
- [OpenStack Ansible Modules](platforms/openstack_guidelines.md)
- [oVirt Ansible Modules](platforms/ovirt_dev_guide.md)
- [Guidelines for VMware module development](platforms/vmware_guidelines.md)
- [Guidelines for VMware REST module development](platforms/vmware_rest_guidelines.md)
