...
source_url: https://docs.ansible.com/projects/ansible/6/galaxy/user_guide.html
...
Use Galaxy to jump-start your automation project with great content from the Ansible community. Galaxy provides pre-packaged units of work such as [roles](../user_guide/playbooks_reuse_roles.md#playbooks-reuse-roles), and new in Galaxy 3.2, [collections](../user_guide/collections_using.md#collections)
...
- [Installing collections](user_guide.md#installing-collections)

  - [Installing a collection from Galaxy](user_guide.md#installing-a-collection-from-galaxy)
  - [Downloading a collection from Automation Hub](user_guide.md#downloading-a-collection-from-automation-hub)
  - [Installing an older version of a collection](user_guide.md#installing-an-older-version-of-a-collection)
  - [Install multiple collections with a requirements file](user_guide.md#install-multiple-collections-with-a-requirements-file)
  - [Downloading a collection for offline use](user_guide.md#downloading-a-collection-for-offline-use)
  - [Installing a collection from source files](user_guide.md#installing-a-collection-from-source-files)
  - [Installing a collection from a git repository](user_guide.md#installing-a-collection-from-a-git-repository)
  - [Listing installed collections](user_guide.md#listing-installed-collections)
  - [Configuring the `ansible-galaxy` client](user_guide.md#configuring-the-ansible-galaxy-client)
...
## [Finding collections on Galaxy](user_guide.md#id6)
...
## [Installing collections](user_guide.md#id7)

### [Installing a collection from Galaxy](user_guide.md#id8)
...
See [Configuring the ansible-galaxy client](../user_guide/collections_using.md#galaxy-server-config) if you are using any other Galaxy server, such as Red Hat Automation Hub.
...
### [Downloading a collection from Automation Hub](user_guide.md#id9)
...
### [Installing an older version of a collection](user_guide.md#id10)
...
### [Install multiple collections with a requirements file](user_guide.md#id11)
...
The `version` key uses the same range identifier format documented in [Installing an older version of a collection](../user_guide/collections_using.md#collections-older-version).
...
### [Downloading a collection for offline use](user_guide.md#id12)
...
### [Installing a collection from source files](user_guide.md#id13)
...
### [Installing a collection from a git repository](user_guide.md#id14)
...
### [Listing installed collections](user_guide.md#id15)

To list installed collections, run `ansible-galaxy collection list`. See [Listing collections](../user_guide/collections_using.md#collections-listing) for more details.

### [Configuring the `ansible-galaxy` client](user_guide.md#id16)
...
## [Finding roles on Galaxy](user_guide.md#id17)
...
### [Get more information about a role](user_guide.md#id18)
...
## [Installing roles from Galaxy](user_guide.md#id19)
...
the Galaxy server value in your `ansible.cfg` file to use it . For information on setting the value in *ansible.cfg* see [GALAXY_SERVER](../reference_appendices/config.md#galaxy-server).

### [Installing roles](user_guide.md#id20)
...
### [Installing a specific version of a role](user_guide.md#id21)
...
### [Installing multiple roles from a file](user_guide.md#id22)
...
### [Installing roles and collections from the same requirements.yml file](user_guide.md#id23)
...
### [Installing multiple roles from multiple files](user_guide.md#id24)
...
### [Dependencies](user_guide.md#id25)
...
To better understand how dependencies are handled during play execution, see [Roles](../user_guide/playbooks_reuse_roles.md#playbooks-reuse-roles).
...
### [List installed roles](user_guide.md#id26)
...
### [Remove an installed role](user_guide.md#id27)
...
>
> [Working with command line tools](../user_guide/command_line_tools.md#command-line-tools)
