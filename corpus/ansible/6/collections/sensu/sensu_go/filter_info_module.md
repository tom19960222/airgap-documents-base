...
collection: ansible
version: "6"
title: "sensu.sensu_go.filter_info module – List Sensu info"
source_url: https://docs.ansible.com/projects/ansible/6/collections/sensu/sensu_go/filter_info_module.html
fetched_at: 2026-07-28T00:19:33+00:00
---
# sensu.sensu_go.filter_info module – List Sensu info
...
> see [Requirements](filter_info_module.md#ansible-collections-sensu-sensu-go-filter-info-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.filter_info`.

New in sensu.sensu_go 1.0.0

- [Synopsis](filter_info_module.md#synopsis)
- [Requirements](filter_info_module.md#requirements)
- [Parameters](filter_info_module.md#parameters)
- [See Also](filter_info_module.md#see-also)
- [Examples](filter_info_module.md#examples)
- [Return Values](filter_info_module.md#return-values)

## [Synopsis](filter_info_module.md#id1)
...
## [Requirements](filter_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](filter_info_module.md#id3)
...
## [See Also](filter_info_module.md#id4)
...
## [Examples](filter_info_module.md#id5)
...
## [Return Values](filter_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **objects**  list / elements=dictionary | List of Sensu filters.  Returned: success  Sample: `[{"action": "allow", "expressions": ["event.check.occurrences == 1"], "metadata": {"name": "filter_minimum", "namespace": "default"}}]` |
