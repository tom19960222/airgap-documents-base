...
collection: ansible
version: "6"
title: "sensu.sensu_go.cluster_role module – Manage Sensu cluster roles"
source_url: https://docs.ansible.com/projects/ansible/6/collections/sensu/sensu_go/cluster_role_module.html
fetched_at: 2026-07-28T00:19:24+00:00
---
# sensu.sensu_go.cluster_role module – Manage Sensu cluster roles
...
> see [Requirements](cluster_role_module.md#ansible-collections-sensu-sensu-go-cluster-role-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.cluster_role`.

New in sensu.sensu_go 1.0.0

- [Synopsis](cluster_role_module.md#synopsis)
- [Requirements](cluster_role_module.md#requirements)
- [Parameters](cluster_role_module.md#parameters)
- [See Also](cluster_role_module.md#see-also)
- [Examples](cluster_role_module.md#examples)
- [Return Values](cluster_role_module.md#return-values)

## [Synopsis](cluster_role_module.md#id1)
...
## [Requirements](cluster_role_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](cluster_role_module.md#id3)
...
| **verbs**  list / elements=string / required | Permissions to be applied by the rule.  Choices:   - `"get"` - `"list"` - `"create"` - `"update"` - `"delete"` |
| **state**  string | Target state of the Sensu object.  Choices:   - `"present"` ← (default) - `"absent"` |

## [See Also](cluster_role_module.md#id4)

> **See also:**
>
> [sensu.sensu_go.cluster_role_info](cluster_role_info_module.md#ansible-collections-sensu-sensu-go-cluster-role-info-module)
...
## [Examples](cluster_role_module.md#id5)
...
## [Return Values](cluster_role_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **object**  dictionary | Object representing Sensu cluster role.  Returned: success  Sample: `{"metadata": {"name": "cluster-role"}, "rules": [{"resource_names": ["sample-name"], "resources": ["assets", "checks"], "verbs": ["get", "list"]}]}` |
