...
collection: ansible
version: "6"
title: "sensu.sensu_go.handler_set module – Manage Sensu handler set"
source_url: https://docs.ansible.com/projects/ansible/6/collections/sensu/sensu_go/handler_set_module.html
fetched_at: 2026-07-28T00:19:34+00:00
---
# sensu.sensu_go.handler_set module – Manage Sensu handler set
...
> see [Requirements](handler_set_module.md#ansible-collections-sensu-sensu-go-handler-set-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.handler_set`.

New in sensu.sensu_go 1.0.0

- [Synopsis](handler_set_module.md#synopsis)
- [Requirements](handler_set_module.md#requirements)
- [Parameters](handler_set_module.md#parameters)
- [See Also](handler_set_module.md#see-also)
- [Examples](handler_set_module.md#examples)
- [Return Values](handler_set_module.md#return-values)

## [Synopsis](handler_set_module.md#id1)
...
## [Requirements](handler_set_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](handler_set_module.md#id3)
...
## [See Also](handler_set_module.md#id4)
...
## [Examples](handler_set_module.md#id5)
...
## [Return Values](handler_set_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **object**  dictionary | Object representing Sensu handler set.  Returned: success  Sample: `{"handlers": ["slack"], "metadata": {"name": "tcp_udp_handler_minimum", "namespace": "default"}, "type": "set"}` |
