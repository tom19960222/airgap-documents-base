...
collection: ansible
version: "6"
title: "sensu.sensu_go.role_binding_info module – List Sensu role bindings"
source_url: https://docs.ansible.com/projects/ansible/6/collections/sensu/sensu_go/role_binding_info_module.html
fetched_at: 2026-07-28T00:19:43+00:00
---
# sensu.sensu_go.role_binding_info module – List Sensu role bindings
...
> see [Requirements](role_binding_info_module.md#ansible-collections-sensu-sensu-go-role-binding-info-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.role_binding_info`.

New in sensu.sensu_go 1.0.0

- [Synopsis](role_binding_info_module.md#synopsis)
- [Requirements](role_binding_info_module.md#requirements)
- [Parameters](role_binding_info_module.md#parameters)
- [See Also](role_binding_info_module.md#see-also)
- [Examples](role_binding_info_module.md#examples)
- [Return Values](role_binding_info_module.md#return-values)

## [Synopsis](role_binding_info_module.md#id1)
...
## [Requirements](role_binding_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](role_binding_info_module.md#id3)
...
## [See Also](role_binding_info_module.md#id4)
...
## [Examples](role_binding_info_module.md#id5)
...
## [Return Values](role_binding_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **role_bindings**  list / elements=dictionary | List of Sensu role bindings.  Returned: success  Sample: `[{"metadata": {"name": "event-reader-binding", "namespace": "default"}, "role_ref": {"name": "event-reader", "type": "Role"}, "subjects": [{"name": "bob", "type": "User"}]}]` |
