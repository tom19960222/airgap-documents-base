...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_network_endpoint_group_info module – Gather info for GCP NetworkEndpointGroup"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_network_endpoint_group_info_module.html
fetched_at: 2026-07-27T17:48:14+00:00
---
# google.cloud.gcp_compute_network_endpoint_group_info module – Gather info for GCP NetworkEndpointGroup
...
> see [Requirements](gcp_compute_network_endpoint_group_info_module.md#ansible-collections-google-cloud-gcp-compute-network-endpoint-group-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_network_endpoint_group_info`.

- [Synopsis](gcp_compute_network_endpoint_group_info_module.md#synopsis)
- [Requirements](gcp_compute_network_endpoint_group_info_module.md#requirements)
- [Parameters](gcp_compute_network_endpoint_group_info_module.md#parameters)
- [Notes](gcp_compute_network_endpoint_group_info_module.md#notes)
- [Examples](gcp_compute_network_endpoint_group_info_module.md#examples)
- [Return Values](gcp_compute_network_endpoint_group_info_module.md#return-values)

## [Synopsis](gcp_compute_network_endpoint_group_info_module.md#id1)

- Gather info for GCP NetworkEndpointGroup

## [Requirements](gcp_compute_network_endpoint_group_info_module.md#id2)
...
## [Parameters](gcp_compute_network_endpoint_group_info_module.md#id3)
...
## [Notes](gcp_compute_network_endpoint_group_info_module.md#id4)
...
## [Examples](gcp_compute_network_endpoint_group_info_module.md#id5)
...
## [Return Values](gcp_compute_network_endpoint_group_info_module.md#id6)
