...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_region_disk_info module – Gather info for GCP RegionDisk"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_region_disk_info_module.html
fetched_at: 2026-07-27T17:48:22+00:00
---
# google.cloud.gcp_compute_region_disk_info module – Gather info for GCP RegionDisk
...
> see [Requirements](gcp_compute_region_disk_info_module.md#ansible-collections-google-cloud-gcp-compute-region-disk-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_region_disk_info`.

- [Synopsis](gcp_compute_region_disk_info_module.md#synopsis)
- [Requirements](gcp_compute_region_disk_info_module.md#requirements)
- [Parameters](gcp_compute_region_disk_info_module.md#parameters)
- [Notes](gcp_compute_region_disk_info_module.md#notes)
- [Examples](gcp_compute_region_disk_info_module.md#examples)
- [Return Values](gcp_compute_region_disk_info_module.md#return-values)

## [Synopsis](gcp_compute_region_disk_info_module.md#id1)

- Gather info for GCP RegionDisk

## [Requirements](gcp_compute_region_disk_info_module.md#id2)
...
## [Parameters](gcp_compute_region_disk_info_module.md#id3)
...
## [Notes](gcp_compute_region_disk_info_module.md#id4)
...
## [Examples](gcp_compute_region_disk_info_module.md#id5)
...
## [Return Values](gcp_compute_region_disk_info_module.md#id6)
