...
collection: ansible
version: "6"
title: "google.cloud.gcp_logging_metric_info module – Gather info for GCP Metric"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_logging_metric_info_module.html
fetched_at: 2026-07-27T17:49:10+00:00
---
...
> see [Requirements](gcp_logging_metric_info_module.md#ansible-collections-google-cloud-gcp-logging-metric-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_logging_metric_info`.

- [Synopsis](gcp_logging_metric_info_module.md#synopsis)
- [Requirements](gcp_logging_metric_info_module.md#requirements)
- [Parameters](gcp_logging_metric_info_module.md#parameters)
- [Notes](gcp_logging_metric_info_module.md#notes)
- [Examples](gcp_logging_metric_info_module.md#examples)
- [Return Values](gcp_logging_metric_info_module.md#return-values)

## [Synopsis](gcp_logging_metric_info_module.md#id1)

- Gather info for GCP Metric

## [Requirements](gcp_logging_metric_info_module.md#id2)
...
## [Parameters](gcp_logging_metric_info_module.md#id3)
...
## [Notes](gcp_logging_metric_info_module.md#id4)
...
## [Examples](gcp_logging_metric_info_module.md#id5)
...
## [Return Values](gcp_logging_metric_info_module.md#id6)
