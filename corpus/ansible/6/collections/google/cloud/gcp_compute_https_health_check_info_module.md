...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_https_health_check_info module – Gather info for GCP HttpsHealthCheck"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_https_health_check_info_module.html
fetched_at: 2026-07-27T17:48:04+00:00
---
# google.cloud.gcp_compute_https_health_check_info module – Gather info for GCP HttpsHealthCheck
...
> see [Requirements](gcp_compute_https_health_check_info_module.md#ansible-collections-google-cloud-gcp-compute-https-health-check-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_https_health_check_info`.

- [Synopsis](gcp_compute_https_health_check_info_module.md#synopsis)
- [Requirements](gcp_compute_https_health_check_info_module.md#requirements)
- [Parameters](gcp_compute_https_health_check_info_module.md#parameters)
- [Notes](gcp_compute_https_health_check_info_module.md#notes)
- [Examples](gcp_compute_https_health_check_info_module.md#examples)
- [Return Values](gcp_compute_https_health_check_info_module.md#return-values)

## [Synopsis](gcp_compute_https_health_check_info_module.md#id1)

- Gather info for GCP HttpsHealthCheck

## [Requirements](gcp_compute_https_health_check_info_module.md#id2)
...
## [Parameters](gcp_compute_https_health_check_info_module.md#id3)
...
## [Notes](gcp_compute_https_health_check_info_module.md#id4)
...
## [Examples](gcp_compute_https_health_check_info_module.md#id5)
...
## [Return Values](gcp_compute_https_health_check_info_module.md#id6)
...
| **port**  integer | The TCP port number for the HTTPS health check request.  The default value is 80.  Returned: success |
