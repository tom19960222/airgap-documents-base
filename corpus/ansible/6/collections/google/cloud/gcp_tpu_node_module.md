...
collection: ansible
version: "6"
title: "google.cloud.gcp_tpu_node module – Creates a GCP Node"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_tpu_node_module.html
fetched_at: 2026-07-27T17:49:35+00:00
---
# google.cloud.gcp_tpu_node module – Creates a GCP Node
...
> see [Requirements](gcp_tpu_node_module.md#ansible-collections-google-cloud-gcp-tpu-node-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_tpu_node`.

- [Synopsis](gcp_tpu_node_module.md#synopsis)
- [Requirements](gcp_tpu_node_module.md#requirements)
- [Parameters](gcp_tpu_node_module.md#parameters)
- [Notes](gcp_tpu_node_module.md#notes)
- [Examples](gcp_tpu_node_module.md#examples)
- [Return Values](gcp_tpu_node_module.md#return-values)

## [Synopsis](gcp_tpu_node_module.md#id1)

- A Cloud TPU instance.

## [Requirements](gcp_tpu_node_module.md#id2)
...
## [Parameters](gcp_tpu_node_module.md#id3)
...
| **scheduling_config**  dictionary | Sets the scheduling options for this TPU instance. |
| **preemptible**  boolean / required | Defines whether the TPU instance is preemptible.  Choices:   - `false` - `true` |
...
| **use_service_networking**  boolean | Whether the VPC peering for the node is set up through Service Networking API.  The VPC Peering should be set up before provisioning the node. If this field is set, cidr_block field should not be specified. If the network that you want to peer the TPU Node to is a Shared VPC network, the node must be created with this this field enabled.  Choices:   - `false` ← (default) - `true` |
| **zone**  string | The GCP location for the TPU. If it is not provided, the provider zone is used. |

## [Notes](gcp_tpu_node_module.md#id4)
...
## [Examples](gcp_tpu_node_module.md#id5)
...
## [Return Values](gcp_tpu_node_module.md#id6)
