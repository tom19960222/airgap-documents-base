...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_instance_group_manager_info module – Gather info for GCP InstanceGroupManager"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_instance_group_manager_info_module.html
fetched_at: 2026-07-27T17:48:09+00:00
---
# google.cloud.gcp_compute_instance_group_manager_info module – Gather info for GCP InstanceGroupManager
...
> see [Requirements](gcp_compute_instance_group_manager_info_module.md#ansible-collections-google-cloud-gcp-compute-instance-group-manager-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_instance_group_manager_info`.

- [Synopsis](gcp_compute_instance_group_manager_info_module.md#synopsis)
- [Requirements](gcp_compute_instance_group_manager_info_module.md#requirements)
- [Parameters](gcp_compute_instance_group_manager_info_module.md#parameters)
- [Notes](gcp_compute_instance_group_manager_info_module.md#notes)
- [Examples](gcp_compute_instance_group_manager_info_module.md#examples)
- [Return Values](gcp_compute_instance_group_manager_info_module.md#return-values)

## [Synopsis](gcp_compute_instance_group_manager_info_module.md#id1)

- Gather info for GCP InstanceGroupManager

## [Requirements](gcp_compute_instance_group_manager_info_module.md#id2)
...
## [Parameters](gcp_compute_instance_group_manager_info_module.md#id3)
...
## [Notes](gcp_compute_instance_group_manager_info_module.md#id4)
...
## [Examples](gcp_compute_instance_group_manager_info_module.md#id5)
...
## [Return Values](gcp_compute_instance_group_manager_info_module.md#id6)
...
| **region**  string | The region this managed instance group resides (for regional resources).  Returned: success |
...
| **zone**  string | The zone the managed instance group resides.  Returned: success |
