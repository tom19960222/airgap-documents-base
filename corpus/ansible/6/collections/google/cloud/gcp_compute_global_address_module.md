...
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_global_address_module.html
fetched_at: 2026-07-27T17:47:57+00:00
---
...
| **prefix_length**  integer | The prefix length of the IP range. If not present, it means the address field is a single IP address.  This field is not applicable to addresses with addressType=EXTERNAL. |
| **project**  string | The Google Cloud Platform project to use. |
| **purpose**  string | The purpose of the resource. For global internal addresses it can be \* VPC_PEERING - for peer networks This should only be set when using an Internal address.  Some valid choices include: “VPC_PEERING” |
