...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_target_tcp_proxy module – Creates a GCP TargetTcpProxy"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_target_tcp_proxy_module.html
fetched_at: 2026-07-27T17:48:49+00:00
---
# google.cloud.gcp_compute_target_tcp_proxy module – Creates a GCP TargetTcpProxy
...
> see [Requirements](gcp_compute_target_tcp_proxy_module.md#ansible-collections-google-cloud-gcp-compute-target-tcp-proxy-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_target_tcp_proxy`.

- [Synopsis](gcp_compute_target_tcp_proxy_module.md#synopsis)
- [Requirements](gcp_compute_target_tcp_proxy_module.md#requirements)
- [Parameters](gcp_compute_target_tcp_proxy_module.md#parameters)
- [Notes](gcp_compute_target_tcp_proxy_module.md#notes)
- [Examples](gcp_compute_target_tcp_proxy_module.md#examples)
- [Return Values](gcp_compute_target_tcp_proxy_module.md#return-values)

## [Synopsis](gcp_compute_target_tcp_proxy_module.md#id1)
...
## [Requirements](gcp_compute_target_tcp_proxy_module.md#id2)
...
## [Parameters](gcp_compute_target_tcp_proxy_module.md#id3)
...
## [Notes](gcp_compute_target_tcp_proxy_module.md#id4)
...
## [Examples](gcp_compute_target_tcp_proxy_module.md#id5)
...
## [Return Values](gcp_compute_target_tcp_proxy_module.md#id6)
