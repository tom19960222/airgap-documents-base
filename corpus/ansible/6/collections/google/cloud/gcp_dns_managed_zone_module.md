...
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_dns_managed_zone_module.html
fetched_at: 2026-07-27T17:48:58+00:00
---
...
| **network_url**  string / required | The fully qualified URL of the VPC network to forward queries to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects>/{project}/global/networks/{network}%60 . |
...
| **network_url**  string / required | The fully qualified URL of the VPC network to bind to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects>/{project}/global/networks/{network}%60 . |
