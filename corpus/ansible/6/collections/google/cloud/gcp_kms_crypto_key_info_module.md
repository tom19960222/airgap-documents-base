...
collection: ansible
version: "6"
title: "google.cloud.gcp_kms_crypto_key_info module – Gather info for GCP CryptoKey"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_kms_crypto_key_info_module.html
...
> see [Requirements](gcp_kms_crypto_key_info_module.md#ansible-collections-google-cloud-gcp-kms-crypto-key-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_kms_crypto_key_info`.

- [Synopsis](gcp_kms_crypto_key_info_module.md#synopsis)
- [Requirements](gcp_kms_crypto_key_info_module.md#requirements)
- [Parameters](gcp_kms_crypto_key_info_module.md#parameters)
- [Notes](gcp_kms_crypto_key_info_module.md#notes)
- [Examples](gcp_kms_crypto_key_info_module.md#examples)
- [Return Values](gcp_kms_crypto_key_info_module.md#return-values)

## [Synopsis](gcp_kms_crypto_key_info_module.md#id1)

- Gather info for GCP CryptoKey

## [Requirements](gcp_kms_crypto_key_info_module.md#id2)
...
## [Parameters](gcp_kms_crypto_key_info_module.md#id3)
...
## [Notes](gcp_kms_crypto_key_info_module.md#id4)
...
## [Examples](gcp_kms_crypto_key_info_module.md#id5)
...
## [Return Values](gcp_kms_crypto_key_info_module.md#id6)
