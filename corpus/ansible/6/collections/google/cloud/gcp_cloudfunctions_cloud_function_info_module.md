...
collection: ansible
version: "6"
title: "google.cloud.gcp_cloudfunctions_cloud_function_info module – Gather info for GCP CloudFunction"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_cloudfunctions_cloud_function_info_module.html
fetched_at: 2026-07-27T17:47:42+00:00
---
...
> see [Requirements](gcp_cloudfunctions_cloud_function_info_module.md#ansible-collections-google-cloud-gcp-cloudfunctions-cloud-function-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_cloudfunctions_cloud_function_info`.

- [Synopsis](gcp_cloudfunctions_cloud_function_info_module.md#synopsis)
- [Requirements](gcp_cloudfunctions_cloud_function_info_module.md#requirements)
- [Parameters](gcp_cloudfunctions_cloud_function_info_module.md#parameters)
- [Notes](gcp_cloudfunctions_cloud_function_info_module.md#notes)
- [Examples](gcp_cloudfunctions_cloud_function_info_module.md#examples)
- [Return Values](gcp_cloudfunctions_cloud_function_info_module.md#return-values)

## [Synopsis](gcp_cloudfunctions_cloud_function_info_module.md#id1)

- Gather info for GCP CloudFunction

## [Requirements](gcp_cloudfunctions_cloud_function_info_module.md#id2)
...
## [Parameters](gcp_cloudfunctions_cloud_function_info_module.md#id3)
...
## [Notes](gcp_cloudfunctions_cloud_function_info_module.md#id4)
...
## [Examples](gcp_cloudfunctions_cloud_function_info_module.md#id5)
...
## [Return Values](gcp_cloudfunctions_cloud_function_info_module.md#id6)
