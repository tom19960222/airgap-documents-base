...
collection: ansible
version: "6"
title: "google.cloud.gcp_dns_resource_record_set_info module – Gather info for GCP ResourceRecordSet"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_dns_resource_record_set_info_module.html
fetched_at: 2026-07-27T17:49:00+00:00
---
...
> see [Requirements](gcp_dns_resource_record_set_info_module.md#ansible-collections-google-cloud-gcp-dns-resource-record-set-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_dns_resource_record_set_info`.

- [Synopsis](gcp_dns_resource_record_set_info_module.md#synopsis)
- [Requirements](gcp_dns_resource_record_set_info_module.md#requirements)
- [Parameters](gcp_dns_resource_record_set_info_module.md#parameters)
- [Notes](gcp_dns_resource_record_set_info_module.md#notes)
- [Examples](gcp_dns_resource_record_set_info_module.md#examples)
- [Return Values](gcp_dns_resource_record_set_info_module.md#return-values)

## [Synopsis](gcp_dns_resource_record_set_info_module.md#id1)

- Gather info for GCP ResourceRecordSet

## [Requirements](gcp_dns_resource_record_set_info_module.md#id2)
...
## [Parameters](gcp_dns_resource_record_set_info_module.md#id3)
...
## [Notes](gcp_dns_resource_record_set_info_module.md#id4)
...
## [Examples](gcp_dns_resource_record_set_info_module.md#id5)
...
## [Return Values](gcp_dns_resource_record_set_info_module.md#id6)
