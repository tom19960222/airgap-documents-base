...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_target_ssl_proxy module – Creates a GCP TargetSslProxy"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_target_ssl_proxy_module.html
fetched_at: 2026-07-27T17:48:48+00:00
---
# google.cloud.gcp_compute_target_ssl_proxy module – Creates a GCP TargetSslProxy
...
> see [Requirements](gcp_compute_target_ssl_proxy_module.md#ansible-collections-google-cloud-gcp-compute-target-ssl-proxy-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_target_ssl_proxy`.

- [Synopsis](gcp_compute_target_ssl_proxy_module.md#synopsis)
- [Requirements](gcp_compute_target_ssl_proxy_module.md#requirements)
- [Parameters](gcp_compute_target_ssl_proxy_module.md#parameters)
- [Notes](gcp_compute_target_ssl_proxy_module.md#notes)
- [Examples](gcp_compute_target_ssl_proxy_module.md#examples)
- [Return Values](gcp_compute_target_ssl_proxy_module.md#return-values)

## [Synopsis](gcp_compute_target_ssl_proxy_module.md#id1)
...
## [Requirements](gcp_compute_target_ssl_proxy_module.md#id2)
...
## [Parameters](gcp_compute_target_ssl_proxy_module.md#id3)
...
| **ssl_certificates**  list / elements=dictionary / required | A list of SslCertificate resources that are used to authenticate connections between users and the load balancer. Currently, exactly one SSL certificate must be specified. |
...
## [Notes](gcp_compute_target_ssl_proxy_module.md#id4)
...
## [Examples](gcp_compute_target_ssl_proxy_module.md#id5)
...
## [Return Values](gcp_compute_target_ssl_proxy_module.md#id6)
...
| **sslCertificates**  list / elements=string | A list of SslCertificate resources that are used to authenticate connections between users and the load balancer. Currently, exactly one SSL certificate must be specified.  Returned: success |
