...
collection: ansible
version: "6"
title: "google.cloud.gcp_compute_global_address_info module – Gather info for GCP GlobalAddress"
source_url: https://docs.ansible.com/projects/ansible/6/collections/google/cloud/gcp_compute_global_address_info_module.html
fetched_at: 2026-07-27T17:47:58+00:00
---
...
> see [Requirements](gcp_compute_global_address_info_module.md#ansible-collections-google-cloud-gcp-compute-global-address-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_global_address_info`.

- [Synopsis](gcp_compute_global_address_info_module.md#synopsis)
- [Requirements](gcp_compute_global_address_info_module.md#requirements)
- [Parameters](gcp_compute_global_address_info_module.md#parameters)
- [Notes](gcp_compute_global_address_info_module.md#notes)
- [Examples](gcp_compute_global_address_info_module.md#examples)
- [Return Values](gcp_compute_global_address_info_module.md#return-values)

## [Synopsis](gcp_compute_global_address_info_module.md#id1)

- Gather info for GCP GlobalAddress

## [Requirements](gcp_compute_global_address_info_module.md#id2)
...
## [Parameters](gcp_compute_global_address_info_module.md#id3)
...
## [Notes](gcp_compute_global_address_info_module.md#id4)
...
## [Examples](gcp_compute_global_address_info_module.md#id5)
...
## [Return Values](gcp_compute_global_address_info_module.md#id6)
...
| **prefixLength**  integer | The prefix length of the IP range. If not present, it means the address field is a single IP address.  This field is not applicable to addresses with addressType=EXTERNAL.  Returned: success |
| **purpose**  string | The purpose of the resource. For global internal addresses it can be \* VPC_PEERING - for peer networks This should only be set when using an Internal address.  Returned: success |
