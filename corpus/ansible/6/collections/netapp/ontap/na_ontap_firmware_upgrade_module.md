...
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/ontap/na_ontap_firmware_upgrade_module.html
fetched_at: 2026-07-28T00:12:23+00:00
---
...
| **rename_package**  string  added in netapp.ontap 20.6.1 | Rename the package.  Only available if ‘firmware_type’ is ‘service-processor’.  Not supported with REST. |
| **replace_package**  boolean  added in netapp.ontap 20.6.1 | Replace the local package.  Only available if ‘firmware_type’ is ‘service-processor’.  Not supported with REST when set to false.  Choices:   - `false` - `true` |
