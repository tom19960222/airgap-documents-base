...
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/ontap/na_ontap_svm_module.html
...
| **allowed**  boolean | If this is set to true, an SVM administrator can manage the NDMP service  If it is false, only the cluster administrator can manage the service.  Choices:   - `false` - `true` |
