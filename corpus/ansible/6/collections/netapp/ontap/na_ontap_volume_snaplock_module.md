...
collection: ansible
version: "6"
title: "netapp.ontap.na_ontap_volume_snaplock module – NetApp ONTAP manage volume snaplock retention."
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/ontap/na_ontap_volume_snaplock_module.html
...
> see [Requirements](na_ontap_volume_snaplock_module.md#ansible-collections-netapp-ontap-na-ontap-volume-snaplock-module-requirements) for details.
>
> To use it in a playbook, specify: `netapp.ontap.na_ontap_volume_snaplock`.

New in netapp.ontap 20.2.0

- [Synopsis](na_ontap_volume_snaplock_module.md#synopsis)
- [Requirements](na_ontap_volume_snaplock_module.md#requirements)
- [Parameters](na_ontap_volume_snaplock_module.md#parameters)
- [Notes](na_ontap_volume_snaplock_module.md#notes)
- [Examples](na_ontap_volume_snaplock_module.md#examples)

## [Synopsis](na_ontap_volume_snaplock_module.md#id1)

- Modifies the snaplock retention of volumes on NetApp ONTAP.

## [Requirements](na_ontap_volume_snaplock_module.md#id2)
...
## [Parameters](na_ontap_volume_snaplock_module.md#id3)
...
## [Notes](na_ontap_volume_snaplock_module.md#id4)
...
## [Examples](na_ontap_volume_snaplock_module.md#id5)
