...
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/ontap/na_ontap_s3_buckets_module.html
fetched_at: 2026-07-28T00:13:04+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **aggregates**  list / elements=string | List of aggregates names to use for the S3 bucket. |
| **audit_event_selector**  dictionary | Audit event selector allows you to specify access and permission types to audit. |
...
| **constituents_per_aggregate**  integer | Number of constituents per aggregate. |
...
| **qos_policy**  dictionary | A policy group defines measurable service level objectives (SLOs) that apply to the storage objects with which the policy group is associated.  If you do not assign a policy group to a bucket, the system wil not monitor and control the traffic to it. |
...
| **size**  integer | Size of the S3 bucket in bytes. |
