...
collection: ansible
version: "6"
title: "netapp.ontap.na_ontap_snmp module – NetApp ONTAP SNMP community"
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/ontap/na_ontap_snmp_module.html
fetched_at: 2026-07-28T00:13:17+00:00
---
# netapp.ontap.na_ontap_snmp module – NetApp ONTAP SNMP community
...
| **community_name**  string / required | The name of the SNMP community to manage. |
...
| **state**  string | Whether the specified SNMP community should exist or not.  Choices:   - `"present"` ← (default) - `"absent"` |
