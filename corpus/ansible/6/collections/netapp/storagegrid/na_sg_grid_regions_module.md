...
collection: ansible
version: "6"
title: "netapp.storagegrid.na_sg_grid_regions module – NetApp StorageGRID manage Regions for the grid."
source_url: https://docs.ansible.com/projects/ansible/6/collections/netapp/storagegrid/na_sg_grid_regions_module.html
...
- [Synopsis](na_sg_grid_regions_module.md#synopsis)
- [Parameters](na_sg_grid_regions_module.md#parameters)
- [Notes](na_sg_grid_regions_module.md#notes)
- [Examples](na_sg_grid_regions_module.md#examples)
- [Return Values](na_sg_grid_regions_module.md#return-values)

## [Synopsis](na_sg_grid_regions_module.md#id1)

- Create, Update, Delete Users within a NetApp StorageGRID tenant.

## [Parameters](na_sg_grid_regions_module.md#id2)
...
## [Return Values](na_sg_grid_regions_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **resp**  list / elements=string | Returns information about the configured regions.  Returned: success  Sample: `["us-east-1", "us-central-1"]` |
