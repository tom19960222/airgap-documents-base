...
collection: ansible
version: "6"
title: "infinidat.infinibox.infini_port module – Add and Delete fiber channel and iSCSI ports to a host on Infinibox"
source_url: https://docs.ansible.com/projects/ansible/6/collections/infinidat/infinibox/infini_port_module.html
fetched_at: 2026-07-27T17:50:50+00:00
---
...
> see [Requirements](infini_port_module.md#ansible-collections-infinidat-infinibox-infini-port-module-requirements) for details.
>
> To use it in a playbook, specify: `infinidat.infinibox.infini_port`.

New in infinidat.infinibox 2.9.0

- [Synopsis](infini_port_module.md#synopsis)
- [Requirements](infini_port_module.md#requirements)
- [Parameters](infini_port_module.md#parameters)
- [Notes](infini_port_module.md#notes)
- [Examples](infini_port_module.md#examples)

## [Synopsis](infini_port_module.md#id1)

- This module adds or deletes fiber channel or iSCSI ports to hosts on Infinibox.

## [Requirements](infini_port_module.md#id2)
...
## [Parameters](infini_port_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **host**  string / required | Host Name |
| **iqns**  list / elements=string | List of iqns of the host  Default: `[]` |
| **password**  string / required | Infinibox User password. |
| **state**  string | Creates mapping when present, removes when absent, or provides details of a mapping when stat.  Choices:   - `"stat"` - `"present"` ← (default) - `"absent"` |
...
| **wwns**  list / elements=string | List of wwns of the host  Default: `[]` |

## [Notes](infini_port_module.md#id4)
...
## [Examples](infini_port_module.md#id5)
