...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_qkview_module.html
...
| **max_file_size**  integer | Maximum file size of the QKview file, in bytes. By default, no max file size is specified.  Default: `0` |
| **only_create_file**  boolean  added in f5networks.f5_modules 1.20.0 | If `yes`, the file is created on the device and not downloaded. The file will not be deleted by the module from the device.  Choices:   - `false` ← (default) - `true` |
