...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigip_firewall_policy module – Manage AFM security firewall policies on a BIG-IP"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_firewall_policy_module.html
...
- [Synopsis](bigip_firewall_policy_module.md#synopsis)
- [Parameters](bigip_firewall_policy_module.md#parameters)
- [Notes](bigip_firewall_policy_module.md#notes)
- [Examples](bigip_firewall_policy_module.md#examples)
- [Return Values](bigip_firewall_policy_module.md#return-values)

## [Synopsis](bigip_firewall_policy_module.md#id1)

- Manages AFM (Advanced Firewall Manager) security firewall policies on a BIG-IP.

## [Parameters](bigip_firewall_policy_module.md#id2)
...
| **state**  string | When `state` is `present`, ensures the policy exists.  When `state` is `absent`, ensures the policy is removed.  Choices:   - `"present"` ← (default) - `"absent"` |

## [Notes](bigip_firewall_policy_module.md#id3)
...
## [Examples](bigip_firewall_policy_module.md#id4)
...
## [Return Values](bigip_firewall_policy_module.md#id5)
...
| **rules**  list / elements=string | The list of rules, in the order that they are evaluated, on the device.  Returned: changed  Sample: `["rule1", "rule2", "rule3"]` |
