...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigiq_application_fasthttp module – Manages BIG-IQ FastHTTP applications"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigiq_application_fasthttp_module.html
...
- [Synopsis](bigiq_application_fasthttp_module.md#synopsis)
- [Parameters](bigiq_application_fasthttp_module.md#parameters)
- [Notes](bigiq_application_fasthttp_module.md#notes)
- [Examples](bigiq_application_fasthttp_module.md#examples)
- [Return Values](bigiq_application_fasthttp_module.md#return-values)

## [Synopsis](bigiq_application_fasthttp_module.md#id1)
...
## [Parameters](bigiq_application_fasthttp_module.md#id2)
...
| **port**  string | The port of the server.  When creating a new application and specifying a server, if this parameter is not provided, the default is `80`.  Default: `"80"` |
...
## [Notes](bigiq_application_fasthttp_module.md#id3)
...
## [Examples](bigiq_application_fasthttp_module.md#id4)
...
## [Return Values](bigiq_application_fasthttp_module.md#id5)
...
| **port**  integer | The port the server listens on.  Returned: changed  Sample: `8080` |
