...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigiq_application_fastl4_tcp_module.html
fetched_at: 2026-07-27T17:28:05+00:00
---
...
| **port**  string | The port on which the virtual listens for connections.  When creating a new application, if this parameter is not specified, the default value is `8080`.  Default: `"8080"` |
...
| **port**  string | The port of the server.  When creating a new application and specifying a server, if this parameter is not provided, the default is `8000`.  Default: `"8000"` |
