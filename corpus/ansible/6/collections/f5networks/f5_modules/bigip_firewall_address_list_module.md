...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_firewall_address_list_module.html
fetched_at: 2026-07-27T17:26:39+00:00
---
...
| **country**  string / required | The country name or code of the geolocation to use.  In addition to the country full names, you may also specify their abbreviated form, such as `US` instead of `United States`.  Valid country codes can be found here <https://countrycode.org/>.  Choices:   - `"Any valid 2 character ISO country code."` - `"Any valid country name."` |
