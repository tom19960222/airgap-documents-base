...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_gtm_wide_ip_module.html
fetched_at: 2026-07-27T17:26:57+00:00
---
...
| **persistence**  boolean | When `yes`, ensures that when a local DNS makes repetitive requests on behalf of a client, the system reconnects the client to the same resource as previous requests.  When `no`, ensures repetitive requests do not reconnect the client to the same resource.  Choices:   - `false` - `true` |
