...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_device_license_module.html
fetched_at: 2026-07-27T17:26:31+00:00
---
...
| **force**  boolean | Declares whether to force license renewal. By default, this value is `no`.  This parameter is not required and will be ignored if it is provided.  Choices:   - `false` ← (default) - `true` |
