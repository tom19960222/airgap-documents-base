...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_cgnat_lsn_pool_module.html
fetched_at: 2026-07-27T17:26:17+00:00
---
...
| **egress_intf_enabled**  boolean | Specifies how the system handles address translation on the interfaces specified in `egress_interfaces`.  When set to `yes`, source address translation is allowed only on the specified `egress_interfaces`.  When set to `no`, source address translation is disabled on the specified `egress_interfaces`.  Choices:   - `false` - `true` |
