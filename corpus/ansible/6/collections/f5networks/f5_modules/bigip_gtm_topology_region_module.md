...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_gtm_topology_region_module.html
...
| **negate**  boolean | When set to c(yes), the system selects this topology region when the request source does not match.  Only a single list entry can be specified together with negate.  Choices:   - `false` ← (default) - `true` |
