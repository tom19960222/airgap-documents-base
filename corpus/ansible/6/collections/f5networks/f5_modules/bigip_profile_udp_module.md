...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_profile_udp_module.html
fetched_at: 2026-07-27T17:27:37+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **datagram_load_balancing**  boolean | When `yes`, specifies the system load balances UDP traffic packet-by-packet.  Choices:   - `false` - `true` |
