...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigip_monitor_udp module – Manages F5 BIG-IP LTM UDP monitors"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_monitor_udp_module.html
fetched_at: 2026-07-27T17:27:20+00:00
---
# f5networks.f5_modules.bigip_monitor_udp module – Manages F5 BIG-IP LTM UDP monitors
...
- [Synopsis](bigip_monitor_udp_module.md#synopsis)
- [Parameters](bigip_monitor_udp_module.md#parameters)
- [Notes](bigip_monitor_udp_module.md#notes)
- [Examples](bigip_monitor_udp_module.md#examples)
- [Return Values](bigip_monitor_udp_module.md#return-values)

## [Synopsis](bigip_monitor_udp_module.md#id1)

- Manages F5 BIG-IP LTM UDP monitors.

## [Parameters](bigip_monitor_udp_module.md#id2)
...
| **parent**  string | The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the `udp` parent on the `Common` partition.  Default: `"/Common/udp"` |
...
## [Notes](bigip_monitor_udp_module.md#id3)
...
## [Examples](bigip_monitor_udp_module.md#id4)
...
## [Return Values](bigip_monitor_udp_module.md#id5)
