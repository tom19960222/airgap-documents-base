...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigiq_utility_license_assignment module – Manage utility license assignment on BIG-IPs from a BIG-IQ"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigiq_utility_license_assignment_module.html
fetched_at: 2026-07-27T17:28:13+00:00
---
# f5networks.f5_modules.bigiq_utility_license_assignment module – Manage utility license assignment on BIG-IPs from a BIG-IQ
...
- [Synopsis](bigiq_utility_license_assignment_module.md#synopsis)
- [Parameters](bigiq_utility_license_assignment_module.md#parameters)
- [Notes](bigiq_utility_license_assignment_module.md#notes)
- [Examples](bigiq_utility_license_assignment_module.md#examples)

## [Synopsis](bigiq_utility_license_assignment_module.md#id1)
...
## [Parameters](bigiq_utility_license_assignment_module.md#id2)
...
| **state**  string | When `present`, ensures the device is assigned the specified license.  When `absent`, ensures the license is revokes from the remote device and freed on the BIG-IQ.  Choices:   - `"present"` ← (default) - `"absent"` |
| **unit_of_measure**  string | Sets the rate at which this license usage is billed.  Depending on your license, you may have different units of measure available to you. If a particular unit is not available to you, the module notifies you at licensing time.  Choices:   - `"hourly"` ← (default) - `"daily"` - `"monthly"` - `"yearly"` |

## [Notes](bigiq_utility_license_assignment_module.md#id3)
...
## [Examples](bigiq_utility_license_assignment_module.md#id4)
