...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigip_monitor_smtp module – Manage SMTP monitors on a BIG-IP"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_monitor_smtp_module.html
fetched_at: 2026-07-27T17:27:17+00:00
---
...
- [Synopsis](bigip_monitor_smtp_module.md#synopsis)
- [Parameters](bigip_monitor_smtp_module.md#parameters)
- [Notes](bigip_monitor_smtp_module.md#notes)
- [Examples](bigip_monitor_smtp_module.md#examples)
- [Return Values](bigip_monitor_smtp_module.md#return-values)

## [Synopsis](bigip_monitor_smtp_module.md#id1)

- Manage SMTP monitors on a BIG-IP.

## [Parameters](bigip_monitor_smtp_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **app_service**  string | The iApp service to be associated with this profile. When no service is specified, the default is None. |
| **debug**  boolean | Specifies whether the monitor sends error messages and additional information to a log file created and labeled specifically for this monitor.  When `yes` the system redirects error messages and additional information to the `/var/log/monitors/<monitor_name>-<node_name>-<port>.log` file.  Choices:   - `false` - `true` |
...
## [Notes](bigip_monitor_smtp_module.md#id3)
...
## [Examples](bigip_monitor_smtp_module.md#id4)
...
## [Return Values](bigip_monitor_smtp_module.md#id5)
...
| **domain**  string | Specifies the domain name to check.  Returned: changed  Sample: `"bigipinternal.com"` |
...
| **parent**  string | The parent monitor.  Returned: changed  Sample: `"/Common/foo_smtp"` |
