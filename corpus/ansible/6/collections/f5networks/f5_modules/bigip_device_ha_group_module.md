...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_device_ha_group_module.html
fetched_at: 2026-07-27T17:26:28+00:00
---
...
| **enable**  boolean | When set to `no`, the system disables the HA score feature.  Choices:   - `false` - `true` ← (default) |
