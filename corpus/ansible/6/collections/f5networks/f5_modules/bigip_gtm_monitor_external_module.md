...
collection: ansible
version: "6"
title: "f5networks.f5_modules.bigip_gtm_monitor_external module – Manages external GTM monitors on a BIG-IP"
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigip_gtm_monitor_external_module.html
fetched_at: 2026-07-27T17:26:49+00:00
---
...
- [Synopsis](bigip_gtm_monitor_external_module.md#synopsis)
- [Parameters](bigip_gtm_monitor_external_module.md#parameters)
- [Notes](bigip_gtm_monitor_external_module.md#notes)
- [Examples](bigip_gtm_monitor_external_module.md#examples)
- [Return Values](bigip_gtm_monitor_external_module.md#return-values)

## [Synopsis](bigip_gtm_monitor_external_module.md#id1)

- Manages external GTM (now BIG-IP DNS) monitors on a BIG-IP.

## [Parameters](bigip_gtm_monitor_external_module.md#id2)
...
| **parent**  string | The parent template of this monitor template. Once this value has been set, it cannot be changed. By default, this value is the `http` parent on the `Common` partition.  Default: `"/Common/external"` |
...
## [Notes](bigip_gtm_monitor_external_module.md#id3)
...
## [Examples](bigip_gtm_monitor_external_module.md#id4)
...
## [Return Values](bigip_gtm_monitor_external_module.md#id5)
