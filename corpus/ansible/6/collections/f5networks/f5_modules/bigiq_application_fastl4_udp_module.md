...
source_url: https://docs.ansible.com/projects/ansible/6/collections/f5networks/f5_modules/bigiq_application_fastl4_udp_module.html
fetched_at: 2026-07-27T17:28:06+00:00
---
...
| **port**  string | The port on which the virtual listens for connections.  When creating a new application, if this parameter is not specified, the default value is `53`.  Default: `"53"` |
