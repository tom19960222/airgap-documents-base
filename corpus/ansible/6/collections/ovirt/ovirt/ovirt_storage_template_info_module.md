...
collection: ansible
version: "6"
title: "ovirt.ovirt.ovirt_storage_template_info module – Retrieve information about one or more oVirt/RHV templates relate to a storage domain."
source_url: https://docs.ansible.com/projects/ansible/6/collections/ovirt/ovirt/ovirt_storage_template_info_module.html
fetched_at: 2026-07-28T00:17:49+00:00
---
# ovirt.ovirt.ovirt_storage_template_info module – Retrieve information about one or more oVirt/RHV templates relate to a storage domain.
...
> see [Requirements](ovirt_storage_template_info_module.md#ansible-collections-ovirt-ovirt-ovirt-storage-template-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_storage_template_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_storage_template_info_module.md#synopsis)
- [Requirements](ovirt_storage_template_info_module.md#requirements)
- [Parameters](ovirt_storage_template_info_module.md#parameters)
- [Notes](ovirt_storage_template_info_module.md#notes)
- [Examples](ovirt_storage_template_info_module.md#examples)
- [Return Values](ovirt_storage_template_info_module.md#return-values)

## [Synopsis](ovirt_storage_template_info_module.md#id1)

- Retrieve information about one or more oVirt/RHV templates relate to a storage domain.
- This module was called `ovirt_storage_template_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_storage_template_info](ovirt_storage_template_info_module.md#ansible-collections-ovirt-ovirt-ovirt-storage-template-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_storage_template_info_module.md#id2)
...
## [Parameters](ovirt_storage_template_info_module.md#id3)
...
| **storage_domain**  string / required | The storage domain name where the templates should be listed. |
| **unregistered**  boolean | Flag which indicates whether to get unregistered templates which contain one or more disks which reside on a storage domain or diskless templates.  Choices:   - `false` ← (default) - `true` |

## [Notes](ovirt_storage_template_info_module.md#id4)
...
## [Examples](ovirt_storage_template_info_module.md#id5)
...
## [Return Values](ovirt_storage_template_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_storage_templates**  list / elements=string | List of dictionaries describing the Templates. Template attributes are mapped to dictionary keys, all Templates attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/template>.  Returned: On success. |
