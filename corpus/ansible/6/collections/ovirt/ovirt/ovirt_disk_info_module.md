...
collection: ansible
version: "6"
title: "ovirt.ovirt.ovirt_disk_info module – Retrieve information about one or more oVirt/RHV disks"
source_url: https://docs.ansible.com/projects/ansible/6/collections/ovirt/ovirt/ovirt_disk_info_module.html
fetched_at: 2026-07-28T00:17:27+00:00
---
# ovirt.ovirt.ovirt_disk_info module – Retrieve information about one or more oVirt/RHV disks
...
> see [Requirements](ovirt_disk_info_module.md#ansible-collections-ovirt-ovirt-ovirt-disk-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_disk_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_disk_info_module.md#synopsis)
- [Requirements](ovirt_disk_info_module.md#requirements)
- [Parameters](ovirt_disk_info_module.md#parameters)
- [Notes](ovirt_disk_info_module.md#notes)
- [Examples](ovirt_disk_info_module.md#examples)
- [Return Values](ovirt_disk_info_module.md#return-values)

## [Synopsis](ovirt_disk_info_module.md#id1)

- Retrieve information about one or more oVirt/RHV disks.
- This module was called `ovirt_disk_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_disk_info](ovirt_disk_info_module.md#ansible-collections-ovirt-ovirt-ovirt-disk-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_disk_info_module.md#id2)
...
## [Parameters](ovirt_disk_info_module.md#id3)
...
## [Notes](ovirt_disk_info_module.md#id4)
...
## [Examples](ovirt_disk_info_module.md#id5)
...
## [Return Values](ovirt_disk_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_disks**  list / elements=string | List of dictionaries describing the Disks. Disk attributes are mapped to dictionary keys, all Disks attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/disk>.  Returned: On success. |
