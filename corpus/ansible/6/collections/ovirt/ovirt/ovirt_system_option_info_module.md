...
collection: ansible
version: "6"
title: "ovirt.ovirt.ovirt_system_option_info module – Retrieve information about one oVirt/RHV system options."
source_url: https://docs.ansible.com/projects/ansible/6/collections/ovirt/ovirt/ovirt_system_option_info_module.html
fetched_at: 2026-07-28T00:17:50+00:00
---
# ovirt.ovirt.ovirt_system_option_info module – Retrieve information about one oVirt/RHV system options.
...
> see [Requirements](ovirt_system_option_info_module.md#ansible-collections-ovirt-ovirt-ovirt-system-option-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_system_option_info`.

New in ovirt.ovirt 1.3.0

- [Synopsis](ovirt_system_option_info_module.md#synopsis)
- [Requirements](ovirt_system_option_info_module.md#requirements)
- [Parameters](ovirt_system_option_info_module.md#parameters)
- [Notes](ovirt_system_option_info_module.md#notes)
- [Examples](ovirt_system_option_info_module.md#examples)
- [Return Values](ovirt_system_option_info_module.md#return-values)

## [Synopsis](ovirt_system_option_info_module.md#id1)

- Retrieve information about one oVirt/RHV system options.

## [Requirements](ovirt_system_option_info_module.md#id2)
...
## [Parameters](ovirt_system_option_info_module.md#id3)
...
## [Notes](ovirt_system_option_info_module.md#id4)
...
## [Examples](ovirt_system_option_info_module.md#id5)
...
## [Return Values](ovirt_system_option_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_system_option**  dictionary | Dictionary describing the system option. Option attributes are mapped to dictionary keys, all option attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/system_option>.  Returned: On success. |
