...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_settings_module.html
...
| **name**  string | Select column name. |
...
| **gui_vpn**  string | Enable/disable VPN tunnels on the GUI.  Choices:   - `"enable"` - `"disable"` |
