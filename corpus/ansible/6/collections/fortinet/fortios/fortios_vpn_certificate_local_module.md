...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_vpn_certificate_local_module.html
fetched_at: 2026-07-27T17:46:13+00:00
---
...
| **enroll_protocol**  string | Certificate enrollment protocol.  Choices:   - `"none"` - `"scep"` - `"cmpv2"` - `"acme2"` |
