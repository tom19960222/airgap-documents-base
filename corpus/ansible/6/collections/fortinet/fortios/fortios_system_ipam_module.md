...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_ipam_module.html
fetched_at: 2026-07-27T17:44:41+00:00
---
...
| **name**  string | Fortigate serial number or wildcard. |
...
| **name**  string | Interface name or wildcard. |
| **name**  string | IPAM rule name. |
| **pool**  list / elements=dictionary | Configure name of IPAM pool to use. |
| **name**  string | Ipam pool name. Source . |
| **role**  string | Configure role of interface to match.  Choices:   - `"any"` - `"lan"` - `"wan"` - `"dmz"` - `"undefined"` |
| **server_type**  string | Configure the type of IPAM server to use.  Choices:   - `"cloud"` - `"fabric-root"` |
