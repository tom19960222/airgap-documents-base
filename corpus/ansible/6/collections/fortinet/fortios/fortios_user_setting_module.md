...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_user_setting_module.html
...
| **auth_ssl_min_proto_version**  string | Minimum supported protocol version for SSL/TLS connections .  Choices:   - `"default"` - `"SSLv3"` - `"TLSv1"` - `"TLSv1-1"` - `"TLSv1-2"` |
