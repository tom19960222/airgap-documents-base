...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_pfcp_message_filter_module.html
...
| **id**  integer | Message IDs (range from 1 to 255). |
