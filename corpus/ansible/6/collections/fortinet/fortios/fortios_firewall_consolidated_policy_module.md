...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_consolidated_policy_module.html
...
| **name**  string | IPv4 pool name. Source firewall.ippool.name. |
