...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_firewall_vip46 module – Configure IPv4 to IPv6 virtual IPs in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_vip46_module.html
fetched_at: 2026-07-27T17:41:42+00:00
---
# fortinet.fortios.fortios_firewall_vip46 module – Configure IPv4 to IPv6 virtual IPs in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_firewall_vip46_module.md#ansible-collections-fortinet-fortios-fortios-firewall-vip46-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_firewall_vip46`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_firewall_vip46_module.md#synopsis)
- [Requirements](fortios_firewall_vip46_module.md#requirements)
- [Parameters](fortios_firewall_vip46_module.md#parameters)
- [Notes](fortios_firewall_vip46_module.md#notes)
- [Examples](fortios_firewall_vip46_module.md#examples)
- [Return Values](fortios_firewall_vip46_module.md#return-values)

## [Synopsis](fortios_firewall_vip46_module.md#id1)
...
## [Requirements](fortios_firewall_vip46_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_firewall_vip46_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  Choices:   - `false` ← (default) - `true` |
| **firewall_vip46**  dictionary | Configure IPv4 to IPv6 virtual IPs. |
...
| **mappedip**  string | Start-mapped-IPv6-address [-end mapped-IPv6-address]. |
...
| **src_filter**  list / elements=dictionary | Source IP filter (x.x.x.x/x). |
| **range**  string | Src-filter range. |
| **srcintf_filter**  list / elements=dictionary | Interfaces to which the VIP46 applies. Separate the names with spaces. |
...
## [Notes](fortios_firewall_vip46_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_firewall_vip46_module.md#id5)
...
## [Return Values](fortios_firewall_vip46_module.md#id6)
