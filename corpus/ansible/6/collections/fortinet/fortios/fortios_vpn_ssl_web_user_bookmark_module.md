...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_vpn_ssl_web_user_bookmark module – Configure SSL-VPN user bookmark in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_vpn_ssl_web_user_bookmark_module.html
fetched_at: 2026-07-27T17:46:29+00:00
---
# fortinet.fortios.fortios_vpn_ssl_web_user_bookmark module – Configure SSL-VPN user bookmark in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_vpn_ssl_web_user_bookmark_module.md#ansible-collections-fortinet-fortios-fortios-vpn-ssl-web-user-bookmark-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_vpn_ssl_web_user_bookmark`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_vpn_ssl_web_user_bookmark_module.md#synopsis)
- [Requirements](fortios_vpn_ssl_web_user_bookmark_module.md#requirements)
- [Parameters](fortios_vpn_ssl_web_user_bookmark_module.md#parameters)
- [Notes](fortios_vpn_ssl_web_user_bookmark_module.md#notes)
- [Examples](fortios_vpn_ssl_web_user_bookmark_module.md#examples)
- [Return Values](fortios_vpn_ssl_web_user_bookmark_module.md#return-values)

## [Synopsis](fortios_vpn_ssl_web_user_bookmark_module.md#id1)
...
## [Requirements](fortios_vpn_ssl_web_user_bookmark_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_vpn_ssl_web_user_bookmark_module.md#id3)
...
| **vpn_ssl_web_user_bookmark**  dictionary | Configure SSL-VPN user bookmark. |
...
| **custom_lang**  string | Personal language. Source system.custom-language.name. |
| **name**  string / required | User and group name. |

## [Notes](fortios_vpn_ssl_web_user_bookmark_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_vpn_ssl_web_user_bookmark_module.md#id5)
...
## [Return Values](fortios_vpn_ssl_web_user_bookmark_module.md#id6)
