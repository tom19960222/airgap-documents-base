...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_web_proxy_forward_server_module.html
fetched_at: 2026-07-27T17:46:40+00:00
---
...
| **addr_type**  string | Address type of the forwarding proxy server: IP or FQDN.  Choices:   - `"ip"` - `"fqdn"` |
