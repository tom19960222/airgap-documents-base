...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_router_ospf_module.html
fetched_at: 2026-07-27T17:43:06+00:00
---
...
| **id**  integer | Key ID (1 - 255). |
| **key_string**  string | Password for the key. |
| **name**  string | Virtual link entry name. |
| **peer**  string | Peer IP. |
...
| **id**  integer | Distribute list entry ID. |
...
| **name**  string | Interface entry name. |
