...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_proxy_address_module.html
...
| **name**  string | SaaS applicaton name. |
...
| **id**  integer | FortiGuard category ID. |
...
| **ua**  list / elements=string | Names of browsers to be used as user agent.  Choices:   - `"chrome"` - `"ms"` - `"firefox"` - `"safari"` - `"other"` |
