...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_vpn_ssl_web_realm_module.html
...
| **url_path**  string | URL path to access SSL-VPN login page. |
