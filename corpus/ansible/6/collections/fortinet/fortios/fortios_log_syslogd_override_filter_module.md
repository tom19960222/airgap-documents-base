...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_log_syslogd_override_filter module – Override filters for remote system server in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_log_syslogd_override_filter_module.html
fetched_at: 2026-07-27T17:42:39+00:00
---
# fortinet.fortios.fortios_log_syslogd_override_filter module – Override filters for remote system server in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_log_syslogd_override_filter_module.md#ansible-collections-fortinet-fortios-fortios-log-syslogd-override-filter-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_log_syslogd_override_filter`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_log_syslogd_override_filter_module.md#synopsis)
- [Requirements](fortios_log_syslogd_override_filter_module.md#requirements)
- [Parameters](fortios_log_syslogd_override_filter_module.md#parameters)
- [Notes](fortios_log_syslogd_override_filter_module.md#notes)
- [Examples](fortios_log_syslogd_override_filter_module.md#examples)
- [Return Values](fortios_log_syslogd_override_filter_module.md#return-values)

## [Synopsis](fortios_log_syslogd_override_filter_module.md#id1)
...
## [Requirements](fortios_log_syslogd_override_filter_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_log_syslogd_override_filter_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  Choices:   - `false` ← (default) - `true` |
| **log_syslogd_override_filter**  dictionary | Override filters for remote system server. |
...
## [Notes](fortios_log_syslogd_override_filter_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_log_syslogd_override_filter_module.md#id5)
...
## [Return Values](fortios_log_syslogd_override_filter_module.md#id6)
