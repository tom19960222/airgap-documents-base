...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_vpn_ipsec_concentrator_module.html
...
| **id**  integer / required | Concentrator ID (1 - 65535). |
| **member**  list / elements=dictionary | Names of up to 3 VPN tunnels to add to the concentrator. |
| **name**  string | Member name. Source vpn.ipsec.manualkey.name vpn.ipsec.phase1.name. |
