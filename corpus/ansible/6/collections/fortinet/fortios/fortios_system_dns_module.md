...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_dns_module.html
...
| **domain**  string | DNS search domain list separated by space (maximum 8 domains). |
