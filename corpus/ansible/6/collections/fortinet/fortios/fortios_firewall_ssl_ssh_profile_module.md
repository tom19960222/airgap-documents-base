...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_ssl_ssh_profile_module.html
fetched_at: 2026-07-27T17:41:38+00:00
---
...
| **name**  string | Certificate list. Source vpn.certificate.local.name. |
...
| **ssl_exemption_log**  string | Enable/disable logging SSL exemptions.  Choices:   - `"disable"` - `"enable"` |
...
| **ssl_negotiation_log**  string | Enable/disable logging SSL negotiation.  Choices:   - `"disable"` - `"enable"` |
