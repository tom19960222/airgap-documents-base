...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_wanopt_content_delivery_network_rule_module.html
...
| **name**  string | Suffix portion of the fully qualified domain name. |
...
| **name**  string | WAN optimization content delivery network rule name. |
