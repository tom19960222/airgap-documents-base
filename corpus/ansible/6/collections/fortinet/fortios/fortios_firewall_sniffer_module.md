...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_sniffer_module.html
...
| **id**  integer / required | Sniffer ID (0 - 9999). |
...
| **name**  string | Threat feed name. Source system.external-resource.name. |
