...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_extension_controller_extender_module.html
...
| **profile**  string | FortiExtender profile configuration. Source . |
| **wan_extension**  dictionary | FortiExtender wan extension configuration. |
| **modem1_extension**  string | FortiExtender interface name. Source . |
| **modem2_extension**  string | FortiExtender interface name. Source . |
