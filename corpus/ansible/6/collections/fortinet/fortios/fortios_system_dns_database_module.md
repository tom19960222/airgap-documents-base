...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_dns_database_module.html
fetched_at: 2026-07-27T17:44:23+00:00
---
...
| **view**  string | Zone view (public to serve public clients, shadow to serve internal clients).  Choices:   - `"shadow"` - `"public"` - `"shadow-ztna"` |
