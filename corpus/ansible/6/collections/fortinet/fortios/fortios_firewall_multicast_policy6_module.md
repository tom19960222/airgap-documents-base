...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_multicast_policy6_module.html
...
| **name**  string | Address name. Source firewall.multicast-address6.name. |
