...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_standalone_cluster_module.html
...
| **name**  string | Interface name. Source . |
...
| **peervd**  string | VDOM that contains the session synchronization link interface on the peer unit. Usually both peers would have the same peervd. Source . |
...
| **dstintf**  string | Only sessions to this interface are synchronized. Source . |
...
| **srcintf**  string | Only sessions from this interface are synchronized. Source . |
