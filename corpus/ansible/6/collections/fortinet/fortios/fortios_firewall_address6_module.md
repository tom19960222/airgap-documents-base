...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_address6_module.html
...
| **type**  string | Type of IPv6 address object .  Choices:   - `"ipprefix"` - `"iprange"` - `"fqdn"` - `"geography"` - `"dynamic"` - `"template"` - `"mac"` |
