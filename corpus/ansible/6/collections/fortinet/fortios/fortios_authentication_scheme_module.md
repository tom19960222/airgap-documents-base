...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_authentication_scheme_module.html
fetched_at: 2026-07-27T17:39:58+00:00
---
...
| **name**  string | Authentication server name. Source system.datasource.name user.radius.name user.tacacs+.name user.ldap.name user.group.name. |
