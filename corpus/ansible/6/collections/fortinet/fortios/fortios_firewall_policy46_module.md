...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_policy46_module.html
...
| **name**  string | Address name. Source firewall.vip46.name firewall.vipgrp46.name. |
