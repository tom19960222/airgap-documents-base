...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_vpn_ipsec_phase2_interface module – Configure VPN autokey tunnel in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_vpn_ipsec_phase2_interface_module.html
fetched_at: 2026-07-27T17:46:23+00:00
---
# fortinet.fortios.fortios_vpn_ipsec_phase2_interface module – Configure VPN autokey tunnel in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_vpn_ipsec_phase2_interface_module.md#ansible-collections-fortinet-fortios-fortios-vpn-ipsec-phase2-interface-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_vpn_ipsec_phase2_interface`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_vpn_ipsec_phase2_interface_module.md#synopsis)
- [Requirements](fortios_vpn_ipsec_phase2_interface_module.md#requirements)
- [Parameters](fortios_vpn_ipsec_phase2_interface_module.md#parameters)
- [Notes](fortios_vpn_ipsec_phase2_interface_module.md#notes)
- [Examples](fortios_vpn_ipsec_phase2_interface_module.md#examples)
- [Return Values](fortios_vpn_ipsec_phase2_interface_module.md#return-values)

## [Synopsis](fortios_vpn_ipsec_phase2_interface_module.md#id1)
...
## [Requirements](fortios_vpn_ipsec_phase2_interface_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_vpn_ipsec_phase2_interface_module.md#id3)
...
| **vpn_ipsec_phase2_interface**  dictionary | Configure VPN autokey tunnel. |
| **add_route**  string | Enable/disable automatic route addition.  Choices:   - `"phase1"` - `"enable"` - `"disable"` |
| **auto_discovery_forwarder**  string | Enable/disable forwarding short-cut messages.  Choices:   - `"phase1"` - `"enable"` - `"disable"` |
| **auto_discovery_sender**  string | Enable/disable sending short-cut messages.  Choices:   - `"phase1"` - `"enable"` - `"disable"` |
...
| **dst_addr_type**  string | Remote proxy ID type.  Choices:   - `"subnet"` - `"range"` - `"ip"` - `"name"` - `"subnet6"` - `"range6"` - `"ip6"` - `"name6"` |
...
| **inbound_dscp_copy**  string | Enable/disable copy the dscp in the ESP header to the inner IP Header.  Choices:   - `"phase1"` - `"enable"` - `"disable"` |
...
| **src_addr_type**  string | Local proxy ID type.  Choices:   - `"subnet"` - `"range"` - `"ip"` - `"name"` - `"subnet6"` - `"range6"` - `"ip6"` - `"name6"` |
...
## [Notes](fortios_vpn_ipsec_phase2_interface_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_vpn_ipsec_phase2_interface_module.md#id5)
...
## [Return Values](fortios_vpn_ipsec_phase2_interface_module.md#id6)
