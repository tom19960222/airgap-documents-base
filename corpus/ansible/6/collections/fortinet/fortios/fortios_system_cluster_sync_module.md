...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_system_cluster_sync module – Configure FortiGate Session Life Support Protocol (FGSP) session synchronization in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_cluster_sync_module.html
fetched_at: 2026-07-27T17:44:16+00:00
---
...
> see [Requirements](fortios_system_cluster_sync_module.md#ansible-collections-fortinet-fortios-fortios-system-cluster-sync-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_system_cluster_sync`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_system_cluster_sync_module.md#synopsis)
- [Requirements](fortios_system_cluster_sync_module.md#requirements)
- [Parameters](fortios_system_cluster_sync_module.md#parameters)
- [Notes](fortios_system_cluster_sync_module.md#notes)
- [Examples](fortios_system_cluster_sync_module.md#examples)
- [Return Values](fortios_system_cluster_sync_module.md#return-values)

## [Synopsis](fortios_system_cluster_sync_module.md#id1)
...
## [Requirements](fortios_system_cluster_sync_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_system_cluster_sync_module.md#id3)
...
| **system_cluster_sync**  dictionary | Configure FortiGate Session Life Support Protocol (FGSP) session synchronization. |
...
| **ike_heartbeat_interval**  integer | IKE heartbeat interval (1 - 60 secs). |
| **ike_monitor**  string | Enable/disable IKE HA monitor.  Choices:   - `"enable"` - `"disable"` |
| **ike_monitor_interval**  integer | IKE HA monitor interval (10 - 300 secs). |
| **ike_seqjump_speed**  integer | ESP jump ahead factor (1G - 10G pps equivalent). |
...
| **slave_add_ike_routes**  string | Enable/disable IKE route announcement on the backup unit.  Choices:   - `"enable"` - `"disable"` |
...
## [Notes](fortios_system_cluster_sync_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_system_cluster_sync_module.md#id5)
...
## [Return Values](fortios_system_cluster_sync_module.md#id6)
