...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_system_link_monitor_module.html
...
| **interval**  integer | Detection interval in milliseconds (500 - 3600 \* 1000 msec). |
...
| **protocol**  list / elements=string | Protocols used to monitor the server.  Choices:   - `"ping"` - `"tcp-echo"` - `"udp-echo"` - `"http"` - `"twamp"` - `"ping6"` |
...
| **subnet**  string | IP and netmask (x.x.x.x/y). |
...
| **port**  integer | Port number of the traffic to be used to monitor the server. |
| **protocol**  list / elements=string | Protocols used to monitor the server.  Choices:   - `"ping"` - `"tcp-echo"` - `"udp-echo"` - `"http"` - `"twamp"` |
