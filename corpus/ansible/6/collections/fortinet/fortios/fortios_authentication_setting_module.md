...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_authentication_setting_module.html
...
| **name**  string | CA certificate list. Source vpn.certificate.ca.name. |
