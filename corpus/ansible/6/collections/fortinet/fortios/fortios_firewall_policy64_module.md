...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_firewall_policy64 module – Configure IPv6 to IPv4 policies in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_policy64_module.html
fetched_at: 2026-07-27T17:41:20+00:00
---
...
> see [Requirements](fortios_firewall_policy64_module.md#ansible-collections-fortinet-fortios-fortios-firewall-policy64-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_firewall_policy64`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_firewall_policy64_module.md#synopsis)
- [Requirements](fortios_firewall_policy64_module.md#requirements)
- [Parameters](fortios_firewall_policy64_module.md#parameters)
- [Notes](fortios_firewall_policy64_module.md#notes)
- [Examples](fortios_firewall_policy64_module.md#examples)
- [Return Values](fortios_firewall_policy64_module.md#return-values)

## [Synopsis](fortios_firewall_policy64_module.md#id1)
...
## [Requirements](fortios_firewall_policy64_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_firewall_policy64_module.md#id3)
...
| **action**  string | Policy action.  Choices:   - `"accept"` - `"deny"` |
| **comments**  string | Comment. |
| **dstaddr**  list / elements=dictionary | Destination address name. |
| **name**  string | Address name. Source firewall.address.name firewall.addrgrp.name firewall.vip64.name firewall.vipgrp64.name. |
| **dstintf**  string | Destination interface name. Source system.interface.name system.zone.name. |
| **fixedport**  string | Enable/disable policy fixed port.  Choices:   - `"enable"` - `"disable"` |
| **ippool**  string | Enable/disable policy64 IP pool.  Choices:   - `"enable"` - `"disable"` |
| **logtraffic**  string | Enable/disable policy log traffic.  Choices:   - `"enable"` - `"disable"` |
...
| **permit_any_host**  string | Enable/disable permit any host in.  Choices:   - `"enable"` - `"disable"` |
| **policyid**  integer / required | Policy ID (0 - 4294967294). |
| **poolname**  list / elements=dictionary | Policy IP pool names. |
...
| **status**  string | Enable/disable policy status.  Choices:   - `"enable"` - `"disable"` |
...
## [Notes](fortios_firewall_policy64_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_firewall_policy64_module.md#id5)
...
## [Return Values](fortios_firewall_policy64_module.md#id6)
