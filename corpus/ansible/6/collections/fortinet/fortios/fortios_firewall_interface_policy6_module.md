...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_firewall_interface_policy6 module – Configure IPv6 interface policies in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_firewall_interface_policy6_module.html
fetched_at: 2026-07-27T17:40:54+00:00
---
# fortinet.fortios.fortios_firewall_interface_policy6 module – Configure IPv6 interface policies in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_firewall_interface_policy6_module.md#ansible-collections-fortinet-fortios-fortios-firewall-interface-policy6-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_firewall_interface_policy6`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_firewall_interface_policy6_module.md#synopsis)
- [Requirements](fortios_firewall_interface_policy6_module.md#requirements)
- [Parameters](fortios_firewall_interface_policy6_module.md#parameters)
- [Notes](fortios_firewall_interface_policy6_module.md#notes)
- [Examples](fortios_firewall_interface_policy6_module.md#examples)
- [Return Values](fortios_firewall_interface_policy6_module.md#return-values)

## [Synopsis](fortios_firewall_interface_policy6_module.md#id1)
...
## [Requirements](fortios_firewall_interface_policy6_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_firewall_interface_policy6_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  Choices:   - `false` ← (default) - `true` |
| **firewall_interface_policy6**  dictionary | Configure IPv6 interface policies. |
...
| **dstaddr6**  list / elements=dictionary | IPv6 address object to limit traffic monitoring to network traffic sent to the specified address or range. |
...
| **srcaddr6**  list / elements=dictionary | IPv6 address object to limit traffic monitoring to network traffic sent from the specified address or range. |
| **name**  string | Address name. Source firewall.address6.name firewall.addrgrp6.name. |
...
## [Notes](fortios_firewall_interface_policy6_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_firewall_interface_policy6_module.md#id5)
...
## [Return Values](fortios_firewall_interface_policy6_module.md#id6)
