...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_extension_controller_extender_profile module – FortiExtender extender profile configuration in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_extension_controller_extender_profile_module.html
fetched_at: 2026-07-27T17:40:33+00:00
---
# fortinet.fortios.fortios_extension_controller_extender_profile module – FortiExtender extender profile configuration in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_extension_controller_extender_profile_module.md#ansible-collections-fortinet-fortios-fortios-extension-controller-extender-profile-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_extension_controller_extender_profile`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_extension_controller_extender_profile_module.md#synopsis)
- [Requirements](fortios_extension_controller_extender_profile_module.md#requirements)
- [Parameters](fortios_extension_controller_extender_profile_module.md#parameters)
- [Notes](fortios_extension_controller_extender_profile_module.md#notes)
- [Examples](fortios_extension_controller_extender_profile_module.md#examples)
- [Return Values](fortios_extension_controller_extender_profile_module.md#return-values)

## [Synopsis](fortios_extension_controller_extender_profile_module.md#id1)
...
## [Requirements](fortios_extension_controller_extender_profile_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_extension_controller_extender_profile_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  Choices:   - `false` ← (default) - `true` |
| **extension_controller_extender_profile**  dictionary | FortiExtender extender profile configuration. |
...
| **name**  string | Dataplan name. Source . |
...
| **backhaul_interface**  string | IPsec phase1 interface. Source . |
...
| **model**  string | Model.  Choices:   - `"FX201E"` - `"FX211E"` - `"FX200F"` - `"FXA11F"` - `"FXE11F"` - `"FXA21F"` - `"FXE21F"` - `"FXA22F"` - `"FXE22F"` - `"FX212F"` - `"FX311F"` - `"FX312F"` - `"FX511F"` - `"FVG21F"` - `"FVA21F"` - `"FVG22F"` - `"FVA22F"` - `"FX04DA"` |
...
## [Notes](fortios_extension_controller_extender_profile_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_extension_controller_extender_profile_module.md#id5)
...
## [Return Values](fortios_extension_controller_extender_profile_module.md#id6)
