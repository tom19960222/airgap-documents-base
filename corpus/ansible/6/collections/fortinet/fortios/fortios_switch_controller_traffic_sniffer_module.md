...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_switch_controller_traffic_sniffer_module.html
...
| **name**  string | Interface name. |
| **switch_id**  string | Managed-switch ID. Source switch-controller.managed-switch.switch-id. |
