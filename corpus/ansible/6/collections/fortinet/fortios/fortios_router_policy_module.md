...
collection: ansible
version: "6"
title: "fortinet.fortios.fortios_router_policy module – Configure IPv4 routing policies in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortios/fortios_router_policy_module.html
...
> see [Requirements](fortios_router_policy_module.md#ansible-collections-fortinet-fortios-fortios-router-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_router_policy`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_router_policy_module.md#synopsis)
- [Requirements](fortios_router_policy_module.md#requirements)
- [Parameters](fortios_router_policy_module.md#parameters)
- [Notes](fortios_router_policy_module.md#notes)
- [Examples](fortios_router_policy_module.md#examples)
- [Return Values](fortios_router_policy_module.md#return-values)

## [Synopsis](fortios_router_policy_module.md#id1)
...
## [Requirements](fortios_router_policy_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.9

## [Parameters](fortios_router_policy_module.md#id3)
...
| **dst**  list / elements=dictionary | Destination IP and mask (x.x.x.x/x). |
| **subnet**  string | IP and mask. |
...
| **name**  string | Address/group name. Source firewall.address.name firewall.addrgrp.name. |
...
| **input_device**  list / elements=dictionary | Incoming interface name. |
...
| **name**  string | Custom Destination Internet Service name. Source firewall.internet-service-custom.name. |
| **internet_service_id**  list / elements=dictionary | Destination Internet Service ID. |
| **id**  integer | Destination Internet Service ID. Source firewall.internet-service.id. |
...
| **src**  list / elements=dictionary | Source IP and mask (x.x.x.x/x). |
| **subnet**  string | IP and mask. |
...
## [Notes](fortios_router_policy_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_router_policy_module.md#id5)
...
## [Return Values](fortios_router_policy_module.md#id6)
