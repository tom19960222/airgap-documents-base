...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_application_group module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_application_group_module.html
fetched_at: 2026-07-27T17:28:30+00:00
---
# fortinet.fortimanager.fmgr_application_group module – no description
...
| **type**  string | no description  Choices:   - `"application"` - `"category"` - `"filter"` |
