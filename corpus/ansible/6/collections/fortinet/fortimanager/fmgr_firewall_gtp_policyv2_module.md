...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_gtp_policyv2 module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_gtp_policyv2_module.html
fetched_at: 2026-07-27T17:31:10+00:00
---
# fortinet.fortimanager.fmgr_firewall_gtp_policyv2 module – no description
...
| **apn-sel-mode**  list / elements=string | description  Choices:   - `"ms"` - `"net"` - `"vrf"` |
...
| **messages**  list / elements=string | description  Choices:   - `"create-ses-req"` - `"create-ses-res"` - `"modify-bearer-req"` - `"modify-bearer-res"` |
| **msisdn-prefix**  string | no description |
| **rat-type**  list / elements=string | description  Choices:   - `"any"` - `"utran"` - `"geran"` - `"wlan"` - `"gan"` - `"hspa"` - `"eutran"` - `"virtual"` - `"nbiot"` - `"ltem"` - `"nr"` |
| **uli**  string | description |
