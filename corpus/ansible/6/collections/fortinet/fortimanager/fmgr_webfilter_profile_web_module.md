...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_webfilter_profile_web module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_webfilter_profile_web_module.html
fetched_at: 2026-07-27T17:39:32+00:00
---
# fortinet.fortimanager.fmgr_webfilter_profile_web module – no description
...
| **allowlist**  list / elements=string | description  Choices:   - `"exempt-av"` - `"exempt-webcontent"` - `"exempt-activex-java-cookie"` - `"exempt-dlp"` - `"exempt-rangeblock"` - `"extended-log-others"` |
...
| **keyword-match**  string | description |
| **log-search**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **safe-search**  list / elements=string | description  Choices:   - `"google"` - `"yahoo"` - `"bing"` - `"url"` - `"header"` |
| **urlfilter-table**  string | no description |
| **vimeo-restrict**  string | no description |
| **whitelist**  list / elements=string | description  Choices:   - `"exempt-av"` - `"exempt-webcontent"` - `"exempt-activex-java-cookie"` - `"exempt-dlp"` - `"exempt-rangeblock"` - `"extended-log-others"` |
