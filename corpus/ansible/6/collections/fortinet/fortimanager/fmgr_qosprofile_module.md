...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_qosprofile module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_qosprofile_module.html
fetched_at: 2026-07-27T17:34:24+00:00
---
# fortinet.fortimanager.fmgr_qosprofile module – no description
...
| **burst**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **call-admission-control**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **call-capacity**  integer | no description |
| **comment**  string | no description |
| **downlink**  integer | no description |
| **downlink-sta**  integer | no description |
| **dscp-wmm-be**  integer | no description |
| **dscp-wmm-bk**  integer | no description |
| **dscp-wmm-mapping**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **dscp-wmm-vi**  integer | no description |
| **dscp-wmm-vo**  integer | no description |
| **name**  string | no description |
| **uplink**  integer | no description |
| **uplink-sta**  integer | no description |
| **wmm**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **wmm-be-dscp**  integer | no description |
| **wmm-bk-dscp**  integer | no description |
| **wmm-dscp-marking**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **wmm-uapsd**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **wmm-vi-dscp**  integer | no description |
| **wmm-vo-dscp**  integer | no description |
