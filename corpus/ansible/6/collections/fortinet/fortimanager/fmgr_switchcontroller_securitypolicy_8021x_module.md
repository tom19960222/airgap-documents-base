...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_switchcontroller_securitypolicy_8021x module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_switchcontroller_securitypolicy_8021x_module.html
fetched_at: 2026-07-27T17:35:23+00:00
---
# fortinet.fortimanager.fmgr_switchcontroller_securitypolicy_8021x module – no description
...
| **auth-fail-vlan**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **auth-fail-vlan-id**  string | no description |
| **auth-fail-vlanid**  integer | no description |
| **authserver-timeout-period**  integer | no description |
| **authserver-timeout-vlan**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **authserver-timeout-vlanid**  string | no description |
| **eap-auto-untagged-vlans**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **eap-passthru**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **framevid-apply**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **guest-auth-delay**  integer | no description |
| **guest-vlan**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **guest-vlan-id**  string | no description |
| **guest-vlanid**  integer | no description |
| **mac-auth-bypass**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **name**  string | no description |
| **open-auth**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **policy-type**  string | no description  Choices:   - `"802.1X"` |
| **radius-timeout-overwrite**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **security-mode**  string | no description  Choices:   - `"802.1X"` - `"802.1X-mac-based"` |
| **user-group**  string | no description |
