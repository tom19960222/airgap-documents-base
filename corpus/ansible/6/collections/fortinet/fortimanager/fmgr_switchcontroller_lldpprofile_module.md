...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_switchcontroller_lldpprofile module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_switchcontroller_lldpprofile_module.html
fetched_at: 2026-07-27T17:35:04+00:00
---
# fortinet.fortimanager.fmgr_switchcontroller_lldpprofile module – no description
...
| **802.1-tlvs**  list / elements=string | no description  Choices:   - `"port-vlan-id"` |
| **802.3-tlvs**  list / elements=string | no description  Choices:   - `"max-frame-size"` - `"power-negotiation"` |
| **auto-isl**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **auto-isl-hello-timer**  integer | no description |
| **auto-isl-port-group**  integer | no description |
| **auto-isl-receive-timeout**  integer | no description |
| **auto-mclag-icl**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **med-tlvs**  list / elements=string | no description  Choices:   - `"inventory-management"` - `"network-policy"` - `"power-management"` - `"location-identification"` |
| **name**  string | no description |
