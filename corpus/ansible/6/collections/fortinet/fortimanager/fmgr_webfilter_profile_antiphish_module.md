...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_webfilter_profile_antiphish module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_webfilter_profile_antiphish_module.html
fetched_at: 2026-07-27T17:39:25+00:00
---
# fortinet.fortimanager.fmgr_webfilter_profile_antiphish module – no description
...
- [Synopsis](fmgr_webfilter_profile_antiphish_module.md#synopsis)
- [Parameters](fmgr_webfilter_profile_antiphish_module.md#parameters)
- [Notes](fmgr_webfilter_profile_antiphish_module.md#notes)
- [Examples](fmgr_webfilter_profile_antiphish_module.md#examples)
- [Return Values](fmgr_webfilter_profile_antiphish_module.md#return-values)

## [Synopsis](fmgr_webfilter_profile_antiphish_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_webfilter_profile_antiphish_module.md#id2)
...
| **webfilter_profile_antiphish**  dictionary | the top level parameters set |
...
| **custom-patterns**  list / elements=string | description |
...
| **inspection-entries**  list / elements=string | description |
...
## [Notes](fmgr_webfilter_profile_antiphish_module.md#id3)
...
## [Examples](fmgr_webfilter_profile_antiphish_module.md#id4)
...
## [Return Values](fmgr_webfilter_profile_antiphish_module.md#id5)
