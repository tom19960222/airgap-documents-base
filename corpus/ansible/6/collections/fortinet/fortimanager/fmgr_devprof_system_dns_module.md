...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_devprof_system_dns module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_devprof_system_dns_module.html
fetched_at: 2026-07-27T17:28:49+00:00
---
# fortinet.fortimanager.fmgr_devprof_system_dns module – no description
...
| **cache-notfound-responses**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **dns-cache-limit**  integer | no description |
| **dns-cache-ttl**  integer | no description |
| **dns-over-tls**  string | no description  Choices:   - `"disable"` - `"enable"` - `"enforce"` |
...
| **ip6-primary**  string | no description |
| **ip6-secondary**  string | no description |
| **primary**  string | no description |
| **retry**  integer | no description |
| **secondary**  string | no description |
| **server-hostname**  string | description |
