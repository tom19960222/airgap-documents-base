...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_wtpprofile_radio4 module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_wtpprofile_radio4_module.html
fetched_at: 2026-07-27T17:39:46+00:00
---
# fortinet.fortimanager.fmgr_wtpprofile_radio4 module – no description
...
- [Synopsis](fmgr_wtpprofile_radio4_module.md#synopsis)
- [Parameters](fmgr_wtpprofile_radio4_module.md#parameters)
- [Notes](fmgr_wtpprofile_radio4_module.md#notes)
- [Examples](fmgr_wtpprofile_radio4_module.md#examples)
- [Return Values](fmgr_wtpprofile_radio4_module.md#return-values)

## [Synopsis](fmgr_wtpprofile_radio4_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_wtpprofile_radio4_module.md#id2)
...
| **wtpprofile_radio4**  dictionary | the top level parameters set |
...
| **band**  string | no description  Choices:   - `"802.11b"` - `"802.11a"` - `"802.11g"` - `"802.11n"` - `"802.11ac"` - `"802.11n-5G"` - `"802.11ax-5G"` - `"802.11ax"` - `"802.11g-only"` - `"802.11n-only"` - `"802.11n,g-only"` - `"802.11ac-only"` - `"802.11ac,n-only"` - `"802.11n-5G-only"` - `"802.11ax-5G-only"` - `"802.11ax,ac-only"` - `"802.11ax,ac,n-only"` - `"802.11ax-only"` - `"802.11ax,n-only"` - `"802.11ax,n,g-only"` - `"802.11ac-2G"` |
...
## [Notes](fmgr_wtpprofile_radio4_module.md#id3)
...
## [Examples](fmgr_wtpprofile_radio4_module.md#id4)
...
## [Return Values](fmgr_wtpprofile_radio4_module.md#id5)
