...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_dlp_sensor module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_dlp_sensor_module.html
fetched_at: 2026-07-27T17:29:14+00:00
---
# fortinet.fortimanager.fmgr_dlp_sensor module – no description
...
| **dictionary**  string | no description |
| **id**  integer | no description |
| **status**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **eval**  string | no description |
...
| **proto**  list / elements=string | no description  Choices:   - `"imap"` - `"smtp"` - `"pop3"` - `"ftp"` - `"nntp"` - `"mm1"` - `"mm3"` - `"mm4"` - `"mm7"` - `"mapi"` - `"aim"` - `"icq"` - `"msn"` - `"yahoo"` - `"http-get"` - `"http-post"` - `"ssh"` - `"cifs"` |
...
| **full-archive-proto**  list / elements=string | no description  Choices:   - `"imap"` - `"smtp"` - `"pop3"` - `"ftp"` - `"nntp"` - `"mm1"` - `"mm3"` - `"mm4"` - `"mm7"` - `"mapi"` - `"aim"` - `"icq"` - `"msn"` - `"yahoo"` - `"http-get"` - `"http-post"` - `"ssh"` - `"cifs"` |
| **match-type**  string | no description  Choices:   - `"match-all"` - `"match-any"` - `"match-eval"` |
| **nac-quar-log**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **name**  string | no description |
| **options**  string | no description  Choices:   - `"strict-file"` |
| **replacemsg-group**  string | no description |
| **summary-proto**  list / elements=string | no description  Choices:   - `"imap"` - `"smtp"` - `"pop3"` - `"ftp"` - `"nntp"` - `"mm1"` - `"mm3"` - `"mm4"` - `"mm7"` - `"mapi"` - `"aim"` - `"icq"` - `"msn"` - `"yahoo"` - `"http-get"` - `"http-post"` - `"ssh"` - `"cifs"` |
