...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_system_log_settings_rollingregular module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_system_log_settings_rollingregular_module.html
fetched_at: 2026-07-27T17:36:37+00:00
---
# fortinet.fortimanager.fmgr_system_log_settings_rollingregular module – no description
...
- [Synopsis](fmgr_system_log_settings_rollingregular_module.md#synopsis)
- [Parameters](fmgr_system_log_settings_rollingregular_module.md#parameters)
- [Notes](fmgr_system_log_settings_rollingregular_module.md#notes)
- [Examples](fmgr_system_log_settings_rollingregular_module.md#examples)
- [Return Values](fmgr_system_log_settings_rollingregular_module.md#return-values)

## [Synopsis](fmgr_system_log_settings_rollingregular_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_system_log_settings_rollingregular_module.md#id2)
...
## [Notes](fmgr_system_log_settings_rollingregular_module.md#id3)
...
## [Examples](fmgr_system_log_settings_rollingregular_module.md#id4)
...
## [Return Values](fmgr_system_log_settings_rollingregular_module.md#id5)
