...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_system_passwordpolicy module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_system_passwordpolicy_module.html
fetched_at: 2026-07-27T17:36:51+00:00
---
# fortinet.fortimanager.fmgr_system_passwordpolicy module – no description
...
| **change-4-characters**  string | no description  no description  no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **expire**  integer | no description  Default: `0` |
| **minimum-length**  integer | no description  Default: `8` |
| **must-contain**  list / elements=string | no description  Choices:   - `"upper-case-letter"` - `"lower-case-letter"` - `"number"` - `"non-alphanumeric"` |
