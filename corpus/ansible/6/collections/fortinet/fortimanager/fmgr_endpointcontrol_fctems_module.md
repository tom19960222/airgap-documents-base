...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_endpointcontrol_fctems module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_endpointcontrol_fctems_module.html
fetched_at: 2026-07-27T17:30:24+00:00
---
# fortinet.fortimanager.fmgr_endpointcontrol_fctems module – no description
...
| **call-timeout**  integer | no description |
| **capabilities**  list / elements=string | description  Choices:   - `"fabric-auth"` - `"silent-approval"` - `"websocket"` - `"websocket-malware"` - `"push-ca-certs"` - `"common-tags-api"` |
| **certificate-fingerprint**  string | no description |
| **cloud-server-type**  string | no description  Choices:   - `"production"` - `"alpha"` - `"beta"` |
| **fortinetone-cloud-authentication**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **https-port**  integer | no description |
| **name**  string | no description |
| **out-of-sync-threshold**  integer | no description |
| **preserve-ssl-session**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **pull-avatars**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **pull-malware-hash**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **pull-sysinfo**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **pull-tags**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **pull-vulnerabilities**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **server**  string | no description |
| **source-ip**  string | no description |
| **websocket-override**  string | no description  Choices:   - `"disable"` - `"enable"` |
