...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_dnsfilter_profile module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_dnsfilter_profile_module.html
fetched_at: 2026-07-27T17:29:17+00:00
---
# fortinet.fortimanager.fmgr_dnsfilter_profile module – no description
...
| **block-action**  string | no description  Choices:   - `"block"` - `"redirect"` - `"block-sevrfail"` |
| **block-botnet**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **external-ip-blocklist**  string | no description |
| **ftgd-dns**  dictionary | no description |
| **filters**  list / elements=string | no description |
| **action**  string | no description  Choices:   - `"monitor"` - `"block"` |
| **category**  string | no description |
| **id**  integer | no description |
| **log**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **options**  list / elements=string | no description  Choices:   - `"error-allow"` - `"ftgd-disable"` |
| **log-all-domain**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **name**  string | no description |
| **redirect-portal**  string | no description |
| **redirect-portal6**  string | no description |
| **safe-search**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **sdns-domain-log**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **sdns-ftgd-err-log**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **youtube-restrict**  string | no description  Choices:   - `"strict"` - `"moderate"` |
