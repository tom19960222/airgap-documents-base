...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_internetservice module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_internetservice_module.html
fetched_at: 2026-07-27T17:31:13+00:00
---
# fortinet.fortimanager.fmgr_firewall_internetservice module – no description
...
| **database**  string | no description  Choices:   - `"isdb"` - `"irdb"` |
| **direction**  string | no description  Choices:   - `"src"` - `"dst"` - `"both"` |
| **entry**  list / elements=string | description |
