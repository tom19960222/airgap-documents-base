...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_system_log_settings module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_system_log_settings_module.html
fetched_at: 2026-07-27T17:36:35+00:00
---
# fortinet.fortimanager.fmgr_system_log_settings module – no description
...
| **browse-max-logfiles**  integer | no description  Default: `10000` |
| **dns-resolve-dstip**  string | no description  no description  no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **download-max-logs**  integer | no description  Default: `500000` |
| **FAC-custom-field1**  string | no description |
| **FAZ-custom-field1**  string | no description |
| **FCH-custom-field1**  string | no description |
| **FCT-custom-field1**  string | no description |
| **FDD-custom-field1**  string | no description |
| **FGT-custom-field1**  string | no description |
| **FMG-custom-field1**  string | no description |
| **FML-custom-field1**  string | no description |
| **FPX-custom-field1**  string | no description |
| **FSA-custom-field1**  string | no description |
| **FWB-custom-field1**  string | no description |
| **ha-auto-migrate**  string | no description  no description  no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **import-max-logfiles**  integer | no description  Default: `10000` |
| **keep-dev-logs**  string | no description  no description  no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **log-file-archive-name**  string | no description  no description  no description  Choices:   - `"basic"` ← (default) - `"extended"` |
...
| **username3**  string | no description |
| **when**  string | no description  no description  no description  no description  Choices:   - `"none"` ← (default) - `"daily"` - `"weekly"` |
| **sync-search-timeout**  integer | no description  Default: `60` |
