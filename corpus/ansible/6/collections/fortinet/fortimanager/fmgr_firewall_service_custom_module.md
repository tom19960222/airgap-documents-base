...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_service_custom module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_service_custom_module.html
fetched_at: 2026-07-27T17:31:49+00:00
---
# fortinet.fortimanager.fmgr_firewall_service_custom module – no description
...
| **app-category**  integer | no description |
| **app-service-type**  string | no description  Choices:   - `"disable"` - `"app-id"` - `"app-category"` |
| **application**  integer | no description |
| **category**  string | no description |
| **check-reset-range**  string | no description  Choices:   - `"disable"` - `"default"` - `"strict"` |
...
| **helper**  string | no description  Choices:   - `"disable"` - `"auto"` - `"ftp"` - `"tftp"` - `"ras"` - `"h323"` - `"tns"` - `"mms"` - `"sip"` - `"pptp"` - `"rtsp"` - `"dns-udp"` - `"dns-tcp"` - `"pmap"` - `"rsh"` - `"dcerpc"` - `"mgcp"` - `"gtp-c"` - `"gtp-u"` - `"gtp-b"` - `"pfcp"` |
| **icmpcode**  integer | no description |
| **icmptype**  integer | no description |
| **iprange**  string | no description |
| **name**  string | no description |
| **protocol**  string | no description  Choices:   - `"ICMP"` - `"IP"` - `"TCP/UDP/SCTP"` - `"ICMP6"` - `"HTTP"` - `"FTP"` - `"CONNECT"` - `"SOCKS"` - `"ALL"` - `"SOCKS-TCP"` - `"SOCKS-UDP"` |
| **protocol-number**  integer | no description |
| **proxy**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **sctp-portrange**  string | no description |
| **session-ttl**  integer | no description |
| **tcp-halfclose-timer**  integer | no description |
| **tcp-halfopen-timer**  integer | no description |
| **tcp-portrange**  string | no description |
| **tcp-rst-timer**  integer | no description |
| **tcp-timewait-timer**  integer | no description |
| **udp-idle-timer**  integer | no description |
| **udp-portrange**  string | no description |
