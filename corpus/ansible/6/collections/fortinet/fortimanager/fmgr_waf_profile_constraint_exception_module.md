...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_waf_profile_constraint_exception module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_waf_profile_constraint_exception_module.html
fetched_at: 2026-07-27T17:38:47+00:00
---
# fortinet.fortimanager.fmgr_waf_profile_constraint_exception module – no description
...
- [Synopsis](fmgr_waf_profile_constraint_exception_module.md#synopsis)
- [Parameters](fmgr_waf_profile_constraint_exception_module.md#parameters)
- [Notes](fmgr_waf_profile_constraint_exception_module.md#notes)
- [Examples](fmgr_waf_profile_constraint_exception_module.md#examples)
- [Return Values](fmgr_waf_profile_constraint_exception_module.md#return-values)

## [Synopsis](fmgr_waf_profile_constraint_exception_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_waf_profile_constraint_exception_module.md#id2)
...
| **waf_profile_constraint_exception**  dictionary | the top level parameters set |
...
## [Notes](fmgr_waf_profile_constraint_exception_module.md#id3)
...
## [Examples](fmgr_waf_profile_constraint_exception_module.md#id4)
...
## [Return Values](fmgr_waf_profile_constraint_exception_module.md#id5)
