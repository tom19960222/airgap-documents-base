...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_profileprotocoloptions_ssh module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_profileprotocoloptions_ssh_module.html
fetched_at: 2026-07-27T17:31:42+00:00
---
# fortinet.fortimanager.fmgr_firewall_profileprotocoloptions_ssh module – no description
...
| **options**  list / elements=string | description  Choices:   - `"oversize"` - `"clientcomfort"` - `"servercomfort"` |
