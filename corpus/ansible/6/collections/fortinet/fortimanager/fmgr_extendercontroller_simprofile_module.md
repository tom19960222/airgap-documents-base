...
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_extendercontroller_simprofile_module.html
...
| **conn-status**  integer | no description  Default: `0` |
| **default-sim**  string | no description  Choices:   - `"sim1"` ← (default) - `"sim2"` - `"carrier"` - `"cost"` |
| **description**  string | no description |
| **gps**  string | no description  Choices:   - `"disable"` - `"enable"` ← (default) |
| **modem-id**  integer | no description  Default: `0` |
| **name**  string | no description |
| **preferred-carrier**  string | no description |
| **redundant-intf**  string | no description |
| **redundant-mode**  string | no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **sim1-pin**  string | no description  Choices:   - `"disable"` ← (default) - `"enable"` |
| **sim1-pin-code**  string | no description |
| **sim2-pin**  string | no description  Choices:   - `"disable"` ← (default) - `"enable"` |
