...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_user_radius_dynamicmapping module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_user_radius_dynamicmapping_module.html
fetched_at: 2026-07-27T17:38:07+00:00
---
# fortinet.fortimanager.fmgr_user_radius_dynamicmapping module – no description
...
| **accounting-server**  list / elements=string | description |
...
| **dp-log-dyn_flags**  list / elements=string | description  Choices:   - `"none"` - `"protocol-error"` - `"profile-missing"` - `"context-missing"` - `"accounting-stop-missed"` - `"accounting-event"` - `"radiusd-other"` - `"endpoint-block"` |
...
| **rsso-log-flags**  list / elements=string | description  Choices:   - `"none"` - `"protocol-error"` - `"profile-missing"` - `"context-missing"` - `"accounting-stop-missed"` - `"accounting-event"` - `"radiusd-other"` - `"endpoint-block"` |
...
| **switch-controller-service-type**  list / elements=string | description  Choices:   - `"login"` - `"framed"` - `"callback-login"` - `"callback-framed"` - `"outbound"` - `"administrative"` - `"nas-prompt"` - `"authenticate-only"` - `"callback-nas-prompt"` - `"call-check"` - `"callback-administrative"` |
| **tertiary-secret**  string | description |
