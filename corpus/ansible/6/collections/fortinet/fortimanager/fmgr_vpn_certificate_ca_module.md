...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_vpn_certificate_ca module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_vpn_certificate_ca_module.html
fetched_at: 2026-07-27T17:38:26+00:00
---
# fortinet.fortimanager.fmgr_vpn_certificate_ca module – no description
...
| **_private_key**  string | no description |
| **auto-update-days**  integer | no description |
| **auto-update-days-warning**  integer | no description |
| **ca**  string | no description |
| **ca-identifier**  string | no description |
| **last-updated**  integer | no description |
| **name**  string | no description |
| **range**  string | no description  Choices:   - `"global"` - `"vdom"` |
| **scep-url**  string | no description |
| **source**  string | no description  Choices:   - `"factory"` - `"user"` - `"bundle"` - `"fortiguard"` |
| **source-ip**  string | no description |
| **ssl-inspection-trusted**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **trusted**  string | no description  Choices:   - `"disable"` - `"enable"` |
