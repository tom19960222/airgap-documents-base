...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_vip_dynamicmapping module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_vip_dynamicmapping_module.html
fetched_at: 2026-07-27T17:32:12+00:00
---
# fortinet.fortimanager.fmgr_firewall_vip_dynamicmapping module – no description
...
- [Synopsis](fmgr_firewall_vip_dynamicmapping_module.md#synopsis)
- [Parameters](fmgr_firewall_vip_dynamicmapping_module.md#parameters)
- [Notes](fmgr_firewall_vip_dynamicmapping_module.md#notes)
- [Examples](fmgr_firewall_vip_dynamicmapping_module.md#examples)
- [Return Values](fmgr_firewall_vip_dynamicmapping_module.md#return-values)

## [Synopsis](fmgr_firewall_vip_dynamicmapping_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_firewall_vip_dynamicmapping_module.md#id2)
...
| **firewall_vip_dynamicmapping**  dictionary | the top level parameters set |
| **_scope**  list / elements=string | description |
| **name**  string | no description |
| **vdom**  string | no description |
| **add-nat46-route**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **ipv6-mappedip**  string | no description |
| **ipv6-mappedport**  string | no description |
...
| **nat44**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **portmapping-type**  string | no description  Choices:   - `"1-to-1"` - `"m-to-n"` |
| **protocol**  string | no description  Choices:   - `"tcp"` - `"udp"` - `"sctp"` - `"icmp"` |
| **realservers**  list / elements=string | description |
| **address**  string | no description |
| **client-ip**  string | description |
...
| **type**  string | no description  Choices:   - `"ip"` - `"address"` |
| **weight**  integer | no description |
| **server-type**  string | no description  Choices:   - `"http"` - `"https"` - `"ssl"` - `"tcp"` - `"udp"` - `"ip"` - `"imaps"` - `"pop3s"` - `"smtps"` - `"ssh"` |
| **service**  string | no description |
| **src-filter**  string | description |
| **srcintf-filter**  string | description |
...
| **type**  string | no description  Choices:   - `"static-nat"` - `"load-balance"` - `"server-load-balance"` - `"dns-translation"` - `"fqdn"` - `"access-proxy"` |
...
## [Notes](fmgr_firewall_vip_dynamicmapping_module.md#id3)
...
## [Examples](fmgr_firewall_vip_dynamicmapping_module.md#id4)
...
## [Return Values](fmgr_firewall_vip_dynamicmapping_module.md#id5)
