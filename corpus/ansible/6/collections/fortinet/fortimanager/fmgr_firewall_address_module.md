...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_address module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_address_module.html
fetched_at: 2026-07-27T17:30:46+00:00
---
# fortinet.fortimanager.fmgr_firewall_address module – no description
...
| **dirty**  string | no description  Choices:   - `"dirty"` - `"clean"` |
...
| **node-ip-only**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **sub-type**  string | no description  Choices:   - `"sdn"` - `"clearpass-spt"` - `"fsso"` - `"ems-tag"` - `"swc-tag"` - `"fortivoice-tag"` - `"fortinac-tag"` |
| **subnet**  string | no description |
| **subnet-name**  string | no description |
| **tag-detection-level**  string | no description |
| **tag-type**  string | no description |
| **tags**  string | no description |
| **tenant**  string | no description |
| **type**  string | no description  Choices:   - `"ipmask"` - `"iprange"` - `"fqdn"` - `"wildcard"` - `"geography"` - `"wildcard-fqdn"` - `"dynamic"` |
