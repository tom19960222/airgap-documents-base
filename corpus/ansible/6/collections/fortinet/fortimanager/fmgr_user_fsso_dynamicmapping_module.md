...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_user_fsso_dynamicmapping module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_user_fsso_dynamicmapping_module.html
fetched_at: 2026-07-27T17:37:50+00:00
---
# fortinet.fortimanager.fmgr_user_fsso_dynamicmapping module – no description
...
| **logon-timeout**  integer | no description |
| **password**  string | description |
| **password2**  string | description |
| **password3**  string | description |
| **password4**  string | description |
| **password5**  string | description |
