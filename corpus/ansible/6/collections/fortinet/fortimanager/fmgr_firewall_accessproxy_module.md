...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_accessproxy module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_accessproxy_module.html
fetched_at: 2026-07-27T17:30:39+00:00
---
# fortinet.fortimanager.fmgr_firewall_accessproxy module – no description
...
- [Synopsis](fmgr_firewall_accessproxy_module.md#synopsis)
- [Parameters](fmgr_firewall_accessproxy_module.md#parameters)
- [Notes](fmgr_firewall_accessproxy_module.md#notes)
- [Examples](fmgr_firewall_accessproxy_module.md#examples)
- [Return Values](fmgr_firewall_accessproxy_module.md#return-values)

## [Synopsis](fmgr_firewall_accessproxy_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_firewall_accessproxy_module.md#id2)
...
| **firewall_accessproxy**  dictionary | the top level parameters set |
...
| **ssl-algorithm**  string | no description  Choices:   - `"high"` - `"medium"` - `"low"` - `"custom"` |
...
| **api-gateway6**  list / elements=string | description |
| **http-cookie-age**  integer | no description |
| **http-cookie-domain**  string | no description |
| **http-cookie-domain-from-host**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **http-cookie-generation**  integer | no description |
...
| **auth-virtual-host**  string | no description |
| **client-cert**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **decrypted-traffic-mirror**  string | no description |
| **empty-cert-action**  string | no description  Choices:   - `"block"` - `"accept"` |
| **ldb-method**  string | no description  Choices:   - `"static"` - `"round-robin"` - `"weighted"` - `"least-session"` - `"least-rtt"` - `"first-alive"` |
| **log-blocked-traffic**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **status**  string | no description  Choices:   - `"active"` - `"standby"` - `"disable"` |
| **weight**  integer | no description |
| **server-pubkey-auth**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **server-pubkey-auth-settings**  dictionary | no description |
| **auth-ca**  string | no description |
| **cert-extension**  list / elements=string | no description |
| **critical**  string | no description  Choices:   - `"no"` - `"yes"` |
| **data**  string | no description |
| **name**  string | no description |
| **type**  string | no description  Choices:   - `"fixed"` - `"user"` |
| **permit-agent-forwarding**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **permit-port-forwarding**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **permit-pty**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **permit-user-rc**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **permit-x11-forwarding**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **source-address**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **vip**  string | no description |
...
## [Notes](fmgr_firewall_accessproxy_module.md#id3)
...
## [Examples](fmgr_firewall_accessproxy_module.md#id4)
...
## [Return Values](fmgr_firewall_accessproxy_module.md#id5)
