...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_proxyaddress module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_proxyaddress_module.html
fetched_at: 2026-07-27T17:31:43+00:00
---
# fortinet.fortimanager.fmgr_firewall_proxyaddress module – no description
...
| **host-regex**  string | no description |
...
| **referrer**  string | no description  Choices:   - `"disable"` - `"enable"` |
| **tagging**  list / elements=string | no description |
| **category**  string | no description |
| **name**  string | no description |
| **tags**  string | no description |
| **type**  string | no description  Choices:   - `"host-regex"` - `"url"` - `"category"` - `"method"` - `"ua"` - `"header"` - `"src-advanced"` - `"dst-advanced"` - `"url-list"` |
