...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_carrierendpointbwl_entries module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_carrierendpointbwl_entries_module.html
fetched_at: 2026-07-27T17:31:00+00:00
---
# fortinet.fortimanager.fmgr_firewall_carrierendpointbwl_entries module – no description
...
| **action**  list / elements=string | description  Choices:   - `"block"` - `"exempt"` - `"exempt-mass-mms"` |
| **carrier-endpoint**  string | no description |
| **log-action**  list / elements=string | description  Choices:   - `"archive"` - `"intercept"` |
