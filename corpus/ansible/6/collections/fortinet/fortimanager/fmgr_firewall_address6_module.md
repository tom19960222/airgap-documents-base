...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_firewall_address6 module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_firewall_address6_module.html
fetched_at: 2026-07-27T17:30:47+00:00
---
# fortinet.fortimanager.fmgr_firewall_address6 module – no description
...
| **type**  string | no description  Choices:   - `"ipprefix"` - `"iprange"` - `"dynamic"` - `"fqdn"` - `"template"` |
