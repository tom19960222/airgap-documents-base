...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_devprof_log_fortianalyzercloud_setting module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_devprof_log_fortianalyzercloud_setting_module.html
...
| **__change_ip**  integer | no description |
...
| **enc-algorithm**  string | no description  Choices:   - `"high"` - `"low"` - `"high-medium"` |
...
| **ssl-min-proto-version**  string | no description  Choices:   - `"default"` - `"TLSv1-1"` - `"TLSv1-2"` - `"SSLv3"` - `"TLSv1"` - `"TLSv1-3"` |
