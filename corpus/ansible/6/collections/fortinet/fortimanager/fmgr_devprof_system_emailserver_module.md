...
collection: ansible
version: "6"
title: "fortinet.fortimanager.fmgr_devprof_system_emailserver module – no description"
source_url: https://docs.ansible.com/projects/ansible/6/collections/fortinet/fortimanager/fmgr_devprof_system_emailserver_module.html
fetched_at: 2026-07-27T17:28:50+00:00
---
# fortinet.fortimanager.fmgr_devprof_system_emailserver module – no description
...
| **authenticate**  string | no description  Choices:   - `"disable"` - `"enable"` |
...
| **reply-to**  string | no description |
| **security**  string | no description  Choices:   - `"none"` - `"starttls"` - `"smtps"` |
...
| **type**  string | no description  Choices:   - `"custom"` |
| **username**  string | no description |
| **validate-server**  string | no description  Choices:   - `"disable"` - `"enable"` |
