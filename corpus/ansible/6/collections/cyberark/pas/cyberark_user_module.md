...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cyberark/pas/cyberark_user_module.html
...
| **logging_level**  string / required | Parameter used to define the level of troubleshooting output to the `logging_file` value.  Choices:   - `"NOTSET"` ← (default) - `"DEBUG"` - `"INFO"` |
