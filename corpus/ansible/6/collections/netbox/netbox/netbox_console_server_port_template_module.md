...
collection: ansible
version: "6"
title: "netbox.netbox.netbox_console_server_port_template module – Create, update or delete console server port templates within NetBox"
source_url: https://docs.ansible.com/projects/ansible/6/collections/netbox/netbox/netbox_console_server_port_template_module.html
...
> see [Requirements](netbox_console_server_port_template_module.md#ansible-collections-netbox-netbox-netbox-console-server-port-template-module-requirements) for details.
>
> To use it in a playbook, specify: `netbox.netbox.netbox_console_server_port_template`.

New in netbox.netbox 0.2.3

- [Synopsis](netbox_console_server_port_template_module.md#synopsis)
- [Requirements](netbox_console_server_port_template_module.md#requirements)
- [Parameters](netbox_console_server_port_template_module.md#parameters)
- [Notes](netbox_console_server_port_template_module.md#notes)
- [Examples](netbox_console_server_port_template_module.md#examples)
- [Return Values](netbox_console_server_port_template_module.md#return-values)

## [Synopsis](netbox_console_server_port_template_module.md#id1)

- Creates, updates or removes console server port templates from NetBox

## [Requirements](netbox_console_server_port_template_module.md#id2)

The below requirements are needed on the host that executes this module.

- pynetbox

## [Parameters](netbox_console_server_port_template_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **cert**  any | Certificate path |
| **data**  dictionary / required | Defines the console server port template configuration |
| **device_type**  any / required | The device type the console server port template is attached to |
| **name**  string / required | The name of the console server port template |
| **type**  string | The type of the console server port template  Choices:   - `"de-9"` - `"db-25"` - `"rj-11"` - `"rj-12"` - `"rj-45"` - `"usb-a"` - `"usb-b"` - `"usb-c"` - `"usb-mini-a"` - `"usb-mini-b"` - `"usb-micro-a"` - `"usb-micro-b"` - `"other"` |
...
## [Notes](netbox_console_server_port_template_module.md#id4)
...
## [Examples](netbox_console_server_port_template_module.md#id5)
...
## [Return Values](netbox_console_server_port_template_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **console_server_port_template**  dictionary | Serialized object as created or already existent within NetBox  Returned: success (when *state=present*) |
