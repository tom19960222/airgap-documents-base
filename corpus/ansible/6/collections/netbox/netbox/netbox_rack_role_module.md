...
collection: ansible
version: "6"
title: "netbox.netbox.netbox_rack_role module – Create, update or delete racks roles within NetBox"
source_url: https://docs.ansible.com/projects/ansible/6/collections/netbox/netbox/netbox_rack_role_module.html
...
> see [Requirements](netbox_rack_role_module.md#ansible-collections-netbox-netbox-netbox-rack-role-module-requirements) for details.
>
> To use it in a playbook, specify: `netbox.netbox.netbox_rack_role`.

New in netbox.netbox 0.1.0

- [Synopsis](netbox_rack_role_module.md#synopsis)
- [Requirements](netbox_rack_role_module.md#requirements)
- [Parameters](netbox_rack_role_module.md#parameters)
- [Notes](netbox_rack_role_module.md#notes)
- [Examples](netbox_rack_role_module.md#examples)
- [Return Values](netbox_rack_role_module.md#return-values)

## [Synopsis](netbox_rack_role_module.md#id1)

- Creates, updates or removes racks roles from NetBox

## [Requirements](netbox_rack_role_module.md#id2)

The below requirements are needed on the host that executes this module.

- pynetbox

## [Parameters](netbox_rack_role_module.md#id3)
...
## [Notes](netbox_rack_role_module.md#id4)
...
## [Examples](netbox_rack_role_module.md#id5)
...
## [Return Values](netbox_rack_role_module.md#id6)
...
| **rack_role**  dictionary | Serialized object as created or already existent within NetBox  Returned: success (when *state=present*) |
