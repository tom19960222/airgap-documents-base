...
collection: ansible
version: "6"
title: "netbox.netbox.netbox_rack_group module – Create, update or delete racks groups within NetBox"
source_url: https://docs.ansible.com/projects/ansible/6/collections/netbox/netbox/netbox_rack_group_module.html
fetched_at: 2026-07-28T00:15:02+00:00
---
...
> see [Requirements](netbox_rack_group_module.md#ansible-collections-netbox-netbox-netbox-rack-group-module-requirements) for details.
>
> To use it in a playbook, specify: `netbox.netbox.netbox_rack_group`.

New in netbox.netbox 0.1.0

- [Synopsis](netbox_rack_group_module.md#synopsis)
- [Requirements](netbox_rack_group_module.md#requirements)
- [Parameters](netbox_rack_group_module.md#parameters)
- [Notes](netbox_rack_group_module.md#notes)
- [Examples](netbox_rack_group_module.md#examples)
- [Return Values](netbox_rack_group_module.md#return-values)

## [Synopsis](netbox_rack_group_module.md#id1)

- Creates, updates or removes racks groups from NetBox

## [Requirements](netbox_rack_group_module.md#id2)

The below requirements are needed on the host that executes this module.

- pynetbox

## [Parameters](netbox_rack_group_module.md#id3)
...
## [Notes](netbox_rack_group_module.md#id4)
...
## [Examples](netbox_rack_group_module.md#id5)
...
## [Return Values](netbox_rack_group_module.md#id6)
...
| **rack_group**  dictionary | Serialized object as created or already existent within NetBox  Returned: success (when *state=present*) |
