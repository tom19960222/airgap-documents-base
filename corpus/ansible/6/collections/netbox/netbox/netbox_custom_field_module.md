...
source_url: https://docs.ansible.com/projects/ansible/6/collections/netbox/netbox/netbox_custom_field_module.html
fetched_at: 2026-07-28T00:14:42+00:00
---
...
| **type**  string | The type of custom field  Choices:   - `"text"` - `"longtext"` - `"integer"` - `"boolean"` - `"date"` - `"url"` - `"json"` - `"select"` - `"multiselect"` - `"object"` - `"multiobject"` |
