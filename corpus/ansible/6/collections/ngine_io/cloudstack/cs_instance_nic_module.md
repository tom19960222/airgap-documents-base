...
collection: ansible
version: "6"
title: "ngine_io.cloudstack.cs_instance_nic module – Manages NICs of an instance on Apache CloudStack based clouds."
source_url: https://docs.ansible.com/projects/ansible/6/collections/ngine_io/cloudstack/cs_instance_nic_module.html
fetched_at: 2026-07-28T00:15:30+00:00
---
# ngine_io.cloudstack.cs_instance_nic module – Manages NICs of an instance on Apache CloudStack based clouds.
...
> see [Requirements](cs_instance_nic_module.md#ansible-collections-ngine-io-cloudstack-cs-instance-nic-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.cloudstack.cs_instance_nic`.

New in ngine_io.cloudstack 0.1.0

- [Synopsis](cs_instance_nic_module.md#synopsis)
- [Requirements](cs_instance_nic_module.md#requirements)
- [Parameters](cs_instance_nic_module.md#parameters)
- [Notes](cs_instance_nic_module.md#notes)
- [Examples](cs_instance_nic_module.md#examples)
- [Return Values](cs_instance_nic_module.md#return-values)

## [Synopsis](cs_instance_nic_module.md#id1)

- Add and remove nic to and from network

## [Requirements](cs_instance_nic_module.md#id2)
...
## [Parameters](cs_instance_nic_module.md#id3)
...
| **state**  string | State of the nic.  Choices:   - `"present"` ← (default) - `"absent"` |
...
## [Notes](cs_instance_nic_module.md#id4)
...
## [Examples](cs_instance_nic_module.md#id5)
...
## [Return Values](cs_instance_nic_module.md#id6)
