...
collection: ansible
version: "6"
title: "ngine_io.vultr.vultr_firewall_group module – Manages firewall groups on Vultr."
source_url: https://docs.ansible.com/projects/ansible/6/collections/ngine_io/vultr/vultr_firewall_group_module.html
fetched_at: 2026-07-28T00:16:05+00:00
---
# ngine_io.vultr.vultr_firewall_group module – Manages firewall groups on Vultr.
...
> see [Requirements](vultr_firewall_group_module.md#ansible-collections-ngine-io-vultr-vultr-firewall-group-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_firewall_group`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_firewall_group_module.md#synopsis)
- [Requirements](vultr_firewall_group_module.md#requirements)
- [Parameters](vultr_firewall_group_module.md#parameters)
- [Notes](vultr_firewall_group_module.md#notes)
- [Examples](vultr_firewall_group_module.md#examples)
- [Return Values](vultr_firewall_group_module.md#return-values)

## [Synopsis](vultr_firewall_group_module.md#id1)

- Create and remove firewall groups.

## [Requirements](vultr_firewall_group_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_firewall_group_module.md#id3)
...
| **name**  aliases: description  string / required | Name of the firewall group. |
...
## [Notes](vultr_firewall_group_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_firewall_group_module.md#id5)
...
## [Return Values](vultr_firewall_group_module.md#id6)
...
| **vultr_firewall_group**  complex | Response from Vultr API  Returned: success |
...
| **name**  string | Name of the firewall group  Returned: success  Sample: `"my firewall group"` |
