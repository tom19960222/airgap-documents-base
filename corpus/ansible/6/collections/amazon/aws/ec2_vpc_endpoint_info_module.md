...
source_url: https://docs.ansible.com/projects/ansible/6/collections/amazon/aws/ec2_vpc_endpoint_info_module.html
...
| **query**  string | Defaults to `endpoints`.  Specifies the query action to take.  *query=endpoints* returns information about AWS VPC endpoints.  Retrieving information about services using *query=services* has been deprecated in favour of the [amazon.aws.ec2_vpc_endpoint_service_info](ec2_vpc_endpoint_service_info_module.md#ansible-collections-amazon-aws-ec2-vpc-endpoint-service-info-module) module.  The *query* option has been deprecated and will be removed after 2022-12-01.  Choices:   - `"services"` - `"endpoints"` |
...
| Key | Description |
| --- | --- |
| **service_names**  list / elements=string | AWS VPC endpoint service names  Returned: *query* is `services`  Sample: `{"service_names": ["com.amazonaws.ap-southeast-2.s3"]}` |
| **vpc_endpoints**  list / elements=string | A list of endpoints that match the query. Each endpoint has the keys creation_timestamp, policy_document, route_table_ids, service_name, state, vpc_endpoint_id, vpc_id.  Returned: *query* is `endpoints`  Sample: `{"vpc_endpoints": [{"creation_timestamp": "2017-02-16T11:06:48+00:00", "policy_document": "\"{\\\"Version\\\":\\\"2012-10-17\\\",\\\"Id\\\":\\\"Policy1450910922815\\\", \\\"Statement\\\":[{\\\"Sid\\\":\\\"Stmt1450910920641\\\",\\\"Effect\\\":\\\"Allow\\\", \\\"Principal\\\":\\\"*\\\",\\\"Action\\\":\\\"s3:*\\\",\\\"Resource\\\":[\\\"arn:aws:s3:::*/*\\\",\\\"arn:aws:s3:::*\\\"]}]}\"\n", "route_table_ids": ["rtb-abcd1234"], "service_name": "com.amazonaws.ap-southeast-2.s3", "state": "available", "vpc_endpoint_id": "vpce-abbad0d0", "vpc_id": "vpc-1111ffff"}]}` |
