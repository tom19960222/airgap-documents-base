...
source_url: https://docs.ansible.com/projects/ansible/6/collections/amazon/aws/ec2_vpc_dhcp_option_info_module.html
...
| **dhcp_options_ids**  aliases: DhcpOptionIds  list / elements=string | Get details of specific DHCP Option IDs. |
| **dry_run**  aliases: DryRun  boolean | Checks whether you have the required permissions to view the DHCP Options.  Choices:   - `false` ← (default) - `true` |
...
| **dhcp_config**  list / elements=string | The boto2-style DHCP options created, associated or found. Provided for consistency with ec2_vpc_dhcp_option’s `dhcp_config`.  Returned: always |
