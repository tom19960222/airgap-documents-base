...
source_url: https://docs.ansible.com/projects/ansible/6/collections/hetzner/hcloud/hcloud_server_module.html
fetched_at: 2026-07-27T17:49:50+00:00
---
...
| **force_upgrade**  boolean | Deprecated  Force the upgrade of the server.  Power off the server if it is running on upgrade.  Choices:   - `false` ← (default) - `true` |
...
| **private_networks**  list / elements=string | List of private networks the server is attached to (name or ID)  Default: `[]` |
