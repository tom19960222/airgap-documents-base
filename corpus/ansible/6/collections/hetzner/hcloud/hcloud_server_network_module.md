...
source_url: https://docs.ansible.com/projects/ansible/6/collections/hetzner/hcloud/hcloud_server_network_module.html
...
| **alias_ips**  string | Alias IPs of the server within the Network ip range  Returned: always  Sample: `"['10.1.0.1', '...']"` |
