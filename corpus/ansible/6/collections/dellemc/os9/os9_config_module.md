...
collection: ansible
version: "6"
title: "dellemc.os9.os9_config module – Manage Dell EMC Networking OS9 configuration sections"
source_url: https://docs.ansible.com/projects/ansible/6/collections/dellemc/os9/os9_config_module.html
...
- [Synopsis](os9_config_module.md#synopsis)
- [Parameters](os9_config_module.md#parameters)
- [Notes](os9_config_module.md#notes)
- [Examples](os9_config_module.md#examples)
- [Return Values](os9_config_module.md#return-values)

## [Synopsis](os9_config_module.md#id1)
...
## [Parameters](os9_config_module.md#id2)
...
## [Notes](os9_config_module.md#id3)

> **Note:**
>
> - This module requires Dell OS9 version 9.10.0.1P13 or above.
> - This module requires to increase the ssh connection rate limit. Use the following command *ip ssh connection-rate-limit 60* to configure the same. This can also be done with the **ERROR while parsing**: While parsing M() at index 180: Module name “os9_config” is not a FQCN module.
...
## [Examples](os9_config_module.md#id4)
...
## [Return Values](os9_config_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **backup_path**  string | The full path to the backup file  Returned: when backup is yes  Sample: `"/playbooks/ansible/backup/os9_config.2016-07-16@22:28:34"` |
| **commands**  list / elements=string | The set of commands that will be pushed to the remote device  Returned: always  Sample: `["hostname foo", "router bgp 1", "bgp router-id 1.1.1.1"]` |
...
| **updates**  list / elements=string | The set of commands that will be pushed to the remote device.  Returned: always  Sample: `["hostname foo", "router bgp 1", "bgp router-id 1.1.1.1"]` |
