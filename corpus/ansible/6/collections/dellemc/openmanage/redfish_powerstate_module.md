...
source_url: https://docs.ansible.com/projects/ansible/6/collections/dellemc/openmanage/redfish_powerstate_module.html
fetched_at: 2026-07-27T17:25:56+00:00
---
...
| **resource_id**  string | The unique identifier of the device being managed. For example- [https:/](https://docs.ansible.com/)/<I%28baseuri>/redfish/v1/Systems/<*resource_id*>).  This option is mandatory for *base_uri* with multiple devices.  To get the device details, use the API [https:/](https://docs.ansible.com/)/<I%28baseuri>/redfish/v1/Systems). |
