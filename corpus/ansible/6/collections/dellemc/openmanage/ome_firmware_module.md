...
source_url: https://docs.ansible.com/projects/ansible/6/collections/dellemc/openmanage/ome_firmware_module.html
fetched_at: 2026-07-27T17:25:39+00:00
---
...
| **components**  list / elements=string | List of components to be updated.  If not provided, all components applicable are considered.  This option is case sensitive.  This is applicable to *device_service_tag*, *device_id*, and *baseline_name*. |
...
| **components**  list / elements=string | The target components to be updated. If not specified, all applicable device components are considered. |
