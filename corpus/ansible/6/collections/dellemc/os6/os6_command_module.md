...
collection: ansible
version: "6"
title: "dellemc.os6.os6_command module – Run commands on devices running Dell EMC OS6"
source_url: https://docs.ansible.com/projects/ansible/6/collections/dellemc/os6/os6_command_module.html
fetched_at: 2026-07-27T17:26:04+00:00
---
# dellemc.os6.os6_command module – Run commands on devices running Dell EMC OS6
...
- [Synopsis](os6_command_module.md#synopsis)
- [Parameters](os6_command_module.md#parameters)
- [Notes](os6_command_module.md#notes)
- [Examples](os6_command_module.md#examples)
- [Return Values](os6_command_module.md#return-values)

## [Synopsis](os6_command_module.md#id1)
...
- This module does not support running commands in configuration mode. Please use **ERROR while parsing**: While parsing M() at index 81: Module name “dellemc_os6_os6_config” is not a FQCN to configure OS6 devices.

> **Note:**
>
> This module has a corresponding [action plugin](../../../plugins/action.md#action-plugins).

## [Parameters](os6_command_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **commands**  list / elements=string / required | List of commands to send to the remote os6 device over the configured provider. The resulting output from the command is returned. If the *wait_for* argument is provided, the module is not returned until the condition is satisfied or the number of retries has expired. |
...
## [Notes](os6_command_module.md#id3)
...
## [Examples](os6_command_module.md#id4)
...
## [Return Values](os6_command_module.md#id5)
