...
collection: ansible
version: "6"
title: "cisco.ise.device_administration_authorization_rules_info module – Information module for Device Administration Authorization Rules"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/device_administration_authorization_rules_info_module.html
fetched_at: 2026-07-27T16:56:35+00:00
---
...
> see [Requirements](device_administration_authorization_rules_info_module.md#ansible-collections-cisco-ise-device-administration-authorization-rules-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.device_administration_authorization_rules_info`.

New in cisco.ise 1.0.0

- [Synopsis](device_administration_authorization_rules_info_module.md#synopsis)
- [Requirements](device_administration_authorization_rules_info_module.md#requirements)
- [Parameters](device_administration_authorization_rules_info_module.md#parameters)
- [Notes](device_administration_authorization_rules_info_module.md#notes)
- [See Also](device_administration_authorization_rules_info_module.md#see-also)
- [Examples](device_administration_authorization_rules_info_module.md#examples)
- [Return Values](device_administration_authorization_rules_info_module.md#return-values)

## [Synopsis](device_administration_authorization_rules_info_module.md#id1)
...
## [Requirements](device_administration_authorization_rules_info_module.md#id2)
...
## [Parameters](device_administration_authorization_rules_info_module.md#id3)
...
## [Notes](device_administration_authorization_rules_info_module.md#id4)
...
## [See Also](device_administration_authorization_rules_info_module.md#id5)
...
## [Examples](device_administration_authorization_rules_info_module.md#id6)
...
## [Return Values](device_administration_authorization_rules_info_module.md#id7)
