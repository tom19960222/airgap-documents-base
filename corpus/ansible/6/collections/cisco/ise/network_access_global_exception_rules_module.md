...
collection: ansible
version: "6"
title: "cisco.ise.network_access_global_exception_rules module – Resource module for Network Access Global Exception Rules"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/network_access_global_exception_rules_module.html
fetched_at: 2026-07-27T16:58:04+00:00
---
# cisco.ise.network_access_global_exception_rules module – Resource module for Network Access Global Exception Rules
...
> see [Requirements](network_access_global_exception_rules_module.md#ansible-collections-cisco-ise-network-access-global-exception-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.network_access_global_exception_rules`.

New in cisco.ise 1.0.0

- [Synopsis](network_access_global_exception_rules_module.md#synopsis)
- [Requirements](network_access_global_exception_rules_module.md#requirements)
- [Parameters](network_access_global_exception_rules_module.md#parameters)
- [Notes](network_access_global_exception_rules_module.md#notes)
- [See Also](network_access_global_exception_rules_module.md#see-also)
- [Examples](network_access_global_exception_rules_module.md#examples)
- [Return Values](network_access_global_exception_rules_module.md#return-values)

## [Synopsis](network_access_global_exception_rules_module.md#id1)
...
## [Requirements](network_access_global_exception_rules_module.md#id2)
...
## [Parameters](network_access_global_exception_rules_module.md#id3)
...
| **link**  dictionary | Network Access Global Exception Rules’s link. |
| **href**  string | Network Access Global Exception Rules’s href. |
| **rel**  string | Network Access Global Exception Rules’s rel. |
| **type**  string | Network Access Global Exception Rules’s type. |
...
| **condition**  dictionary | Network Access Global Exception Rules’s condition. |
...
| **endDate**  string | Network Access Global Exception Rules’s endDate. |
| **startDate**  string | Network Access Global Exception Rules’s startDate. |
...
| **endTime**  string | Network Access Global Exception Rules’s endTime. |
| **startTime**  string | Network Access Global Exception Rules’s startTime. |
...
| **endTime**  string | Network Access Global Exception Rules’s endTime. |
| **startTime**  string | Network Access Global Exception Rules’s startTime. |
| **id**  string | Network Access Global Exception Rules’s id. |
| **isNegate**  boolean | Indicates whereas this condition is in negate mode.  Choices:   - `false` - `true` |
| **link**  dictionary | Network Access Global Exception Rules’s link. |
| **href**  string | Network Access Global Exception Rules’s href. |
| **rel**  string | Network Access Global Exception Rules’s rel. |
...
## [Notes](network_access_global_exception_rules_module.md#id4)
...
## [See Also](network_access_global_exception_rules_module.md#id5)
...
## [Examples](network_access_global_exception_rules_module.md#id6)
...
## [Return Values](network_access_global_exception_rules_module.md#id7)
