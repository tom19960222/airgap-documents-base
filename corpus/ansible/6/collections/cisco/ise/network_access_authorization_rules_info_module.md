...
collection: ansible
version: "6"
title: "cisco.ise.network_access_authorization_rules_info module – Information module for Network Access Authorization Rules"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/network_access_authorization_rules_info_module.html
fetched_at: 2026-07-27T16:57:54+00:00
---
# cisco.ise.network_access_authorization_rules_info module – Information module for Network Access Authorization Rules
...
> see [Requirements](network_access_authorization_rules_info_module.md#ansible-collections-cisco-ise-network-access-authorization-rules-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.network_access_authorization_rules_info`.

New in cisco.ise 1.0.0

- [Synopsis](network_access_authorization_rules_info_module.md#synopsis)
- [Requirements](network_access_authorization_rules_info_module.md#requirements)
- [Parameters](network_access_authorization_rules_info_module.md#parameters)
- [Notes](network_access_authorization_rules_info_module.md#notes)
- [See Also](network_access_authorization_rules_info_module.md#see-also)
- [Examples](network_access_authorization_rules_info_module.md#examples)
- [Return Values](network_access_authorization_rules_info_module.md#return-values)

## [Synopsis](network_access_authorization_rules_info_module.md#id1)
...
## [Requirements](network_access_authorization_rules_info_module.md#id2)
...
## [Parameters](network_access_authorization_rules_info_module.md#id3)
...
## [Notes](network_access_authorization_rules_info_module.md#id4)
...
## [See Also](network_access_authorization_rules_info_module.md#id5)
...
## [Examples](network_access_authorization_rules_info_module.md#id6)
...
## [Return Values](network_access_authorization_rules_info_module.md#id7)
