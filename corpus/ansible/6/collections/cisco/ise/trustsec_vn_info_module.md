...
collection: ansible
version: "6"
title: "cisco.ise.trustsec_vn_info module – Information module for Trustsec VN"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trustsec_vn_info_module.html
fetched_at: 2026-07-27T17:00:13+00:00
---
# cisco.ise.trustsec_vn_info module – Information module for Trustsec VN
...
> see [Requirements](trustsec_vn_info_module.md#ansible-collections-cisco-ise-trustsec-vn-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trustsec_vn_info`.

New in cisco.ise 2.0.0

- [Synopsis](trustsec_vn_info_module.md#synopsis)
- [Requirements](trustsec_vn_info_module.md#requirements)
- [Parameters](trustsec_vn_info_module.md#parameters)
- [Notes](trustsec_vn_info_module.md#notes)
- [See Also](trustsec_vn_info_module.md#see-also)
- [Examples](trustsec_vn_info_module.md#examples)
- [Return Values](trustsec_vn_info_module.md#return-values)

## [Synopsis](trustsec_vn_info_module.md#id1)
...
## [Requirements](trustsec_vn_info_module.md#id2)
...
## [Parameters](trustsec_vn_info_module.md#id3)
...
## [Notes](trustsec_vn_info_module.md#id4)

> **Note:**
>
> - SDK Method used are virtual_network.VirtualNetwork.get_virtual_network_by_id, virtual_network.VirtualNetwork.get_virtual_networks_generator,
> - Paths used are get /api/v1/trustsec/virtualnetwork, get /api/v1/trustsec/virtualnetwork/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](trustsec_vn_info_module.md#id5)
...
## [Examples](trustsec_vn_info_module.md#id6)
...
## [Return Values](trustsec_vn_info_module.md#id7)
