...
collection: ansible
version: "6"
title: "cisco.ise.profiler_profile_info module – Information module for Profiler Profile"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/profiler_profile_info_module.html
fetched_at: 2026-07-27T16:58:43+00:00
---
# cisco.ise.profiler_profile_info module – Information module for Profiler Profile
...
> see [Requirements](profiler_profile_info_module.md#ansible-collections-cisco-ise-profiler-profile-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.profiler_profile_info`.

New in cisco.ise 1.0.0

- [Synopsis](profiler_profile_info_module.md#synopsis)
- [Requirements](profiler_profile_info_module.md#requirements)
- [Parameters](profiler_profile_info_module.md#parameters)
- [Notes](profiler_profile_info_module.md#notes)
- [Examples](profiler_profile_info_module.md#examples)
- [Return Values](profiler_profile_info_module.md#return-values)

## [Synopsis](profiler_profile_info_module.md#id1)
...
## [Requirements](profiler_profile_info_module.md#id2)
...
## [Parameters](profiler_profile_info_module.md#id3)
...
## [Notes](profiler_profile_info_module.md#id4)

> **Note:**
>
> - SDK Method used are profiler_profile.ProfilerProfile.get_profiler_profile_by_id, profiler_profile.ProfilerProfile.get_profiler_profiles_generator,
> - Paths used are get /ers/config/profilerprofile, get /ers/config/profilerprofile/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](profiler_profile_info_module.md#id5)
...
## [Return Values](profiler_profile_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `{"description": "string", "id": "string", "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "parentId": "string"}` |
