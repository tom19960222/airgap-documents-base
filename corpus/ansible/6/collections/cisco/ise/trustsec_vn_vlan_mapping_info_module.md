...
collection: ansible
version: "6"
title: "cisco.ise.trustsec_vn_vlan_mapping_info module – Information module for Trustsec VN VLAN Mapping"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trustsec_vn_vlan_mapping_info_module.html
fetched_at: 2026-07-27T17:00:16+00:00
---
...
> see [Requirements](trustsec_vn_vlan_mapping_info_module.md#ansible-collections-cisco-ise-trustsec-vn-vlan-mapping-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trustsec_vn_vlan_mapping_info`.

New in cisco.ise 2.0.0

- [Synopsis](trustsec_vn_vlan_mapping_info_module.md#synopsis)
- [Requirements](trustsec_vn_vlan_mapping_info_module.md#requirements)
- [Parameters](trustsec_vn_vlan_mapping_info_module.md#parameters)
- [Notes](trustsec_vn_vlan_mapping_info_module.md#notes)
- [See Also](trustsec_vn_vlan_mapping_info_module.md#see-also)
- [Examples](trustsec_vn_vlan_mapping_info_module.md#examples)
- [Return Values](trustsec_vn_vlan_mapping_info_module.md#return-values)

## [Synopsis](trustsec_vn_vlan_mapping_info_module.md#id1)
...
## [Requirements](trustsec_vn_vlan_mapping_info_module.md#id2)
...
## [Parameters](trustsec_vn_vlan_mapping_info_module.md#id3)
...
## [Notes](trustsec_vn_vlan_mapping_info_module.md#id4)

> **Note:**
>
> - SDK Method used are vn_vlan_mapping.VnVlanMapping.get_vn_vlan_mapping_by_id, vn_vlan_mapping.VnVlanMapping.get_vn_vlan_mappings_generator,
...
## [See Also](trustsec_vn_vlan_mapping_info_module.md#id5)
...
## [Examples](trustsec_vn_vlan_mapping_info_module.md#id6)
...
## [Return Values](trustsec_vn_vlan_mapping_info_module.md#id7)
