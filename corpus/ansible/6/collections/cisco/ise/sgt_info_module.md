...
collection: ansible
version: "6"
title: "cisco.ise.sgt_info module – Information module for SGt"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sgt_info_module.html
fetched_at: 2026-07-27T16:59:34+00:00
---
# cisco.ise.sgt_info module – Information module for SGt
...
> see [Requirements](sgt_info_module.md#ansible-collections-cisco-ise-sgt-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sgt_info`.

New in cisco.ise 1.0.0

- [Synopsis](sgt_info_module.md#synopsis)
- [Requirements](sgt_info_module.md#requirements)
- [Parameters](sgt_info_module.md#parameters)
- [Notes](sgt_info_module.md#notes)
- [See Also](sgt_info_module.md#see-also)
- [Examples](sgt_info_module.md#examples)
- [Return Values](sgt_info_module.md#return-values)

## [Synopsis](sgt_info_module.md#id1)
...
## [Requirements](sgt_info_module.md#id2)
...
## [Parameters](sgt_info_module.md#id3)
...
## [Notes](sgt_info_module.md#id4)

> **Note:**
>
> - SDK Method used are security_groups.SecurityGroups.get_security_group_by_id, security_groups.SecurityGroups.get_security_groups_generator,
> - Paths used are get /ers/config/sgt, get /ers/config/sgt/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](sgt_info_module.md#id5)
...
## [Examples](sgt_info_module.md#id6)
...
## [Return Values](sgt_info_module.md#id7)
