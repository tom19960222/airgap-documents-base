...
collection: ansible
version: "6"
title: "cisco.ise.node_info module – Information module for Node"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/node_info_module.html
fetched_at: 2026-07-27T16:58:25+00:00
---
# cisco.ise.node_info module – Information module for Node
...
> see [Requirements](node_info_module.md#ansible-collections-cisco-ise-node-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.node_info`.

New in cisco.ise 1.0.0

- [Synopsis](node_info_module.md#synopsis)
- [Requirements](node_info_module.md#requirements)
- [Parameters](node_info_module.md#parameters)
- [Notes](node_info_module.md#notes)
- [See Also](node_info_module.md#see-also)
- [Examples](node_info_module.md#examples)
- [Return Values](node_info_module.md#return-values)

## [Synopsis](node_info_module.md#id1)
...
## [Requirements](node_info_module.md#id2)
...
## [Parameters](node_info_module.md#id3)
...
## [Notes](node_info_module.md#id4)

> **Note:**
>
> - SDK Method used are node_details.NodeDetails.get_node_detail_by_id, node_details.NodeDetails.get_node_detail_by_name, node_details.NodeDetails.get_node_details_generator,
> - Paths used are get /ers/config/node, get /ers/config/node/name/{name}, get /ers/config/node/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](node_info_module.md#id5)

> **See also:**
>
> [Cisco ISE documentation for NodeDetails](https://developer.cisco.com/docs/identity-services-engine/v1/#!node)
> :   Complete reference of the NodeDetails API.

## [Examples](node_info_module.md#id6)
...
## [Return Values](node_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `{"displayName": "string", "fqdn": "string", "gateWay": "string", "id": "string", "inDeployment": true, "ipAddress": "string", "ipAddresses": ["string"], "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "nodeServiceTypes": "string", "otherPapFqdn": "string", "papNode": true, "passWord": "string", "primaryPapNode": true, "pxGridNode": true, "sxpIpAddress": "string", "userName": "string"}` |
