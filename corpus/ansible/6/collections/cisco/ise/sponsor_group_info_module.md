...
collection: ansible
version: "6"
title: "cisco.ise.sponsor_group_info module – Information module for Sponsor Group"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sponsor_group_info_module.html
fetched_at: 2026-07-27T16:59:36+00:00
---
# cisco.ise.sponsor_group_info module – Information module for Sponsor Group
...
> see [Requirements](sponsor_group_info_module.md#ansible-collections-cisco-ise-sponsor-group-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sponsor_group_info`.

New in cisco.ise 1.0.0

- [Synopsis](sponsor_group_info_module.md#synopsis)
- [Requirements](sponsor_group_info_module.md#requirements)
- [Parameters](sponsor_group_info_module.md#parameters)
- [Notes](sponsor_group_info_module.md#notes)
- [Examples](sponsor_group_info_module.md#examples)
- [Return Values](sponsor_group_info_module.md#return-values)

## [Synopsis](sponsor_group_info_module.md#id1)
...
## [Requirements](sponsor_group_info_module.md#id2)
...
## [Parameters](sponsor_group_info_module.md#id3)
...
## [Notes](sponsor_group_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sponsor_group.SponsorGroup.get_sponsor_group_by_id, sponsor_group.SponsorGroup.get_sponsor_group_generator,
> - Paths used are get /ers/config/sponsorgroup, get /ers/config/sponsorgroup/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](sponsor_group_info_module.md#id5)
...
## [Return Values](sponsor_group_info_module.md#id6)
