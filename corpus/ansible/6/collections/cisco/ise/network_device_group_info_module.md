...
collection: ansible
version: "6"
title: "cisco.ise.network_device_group_info module – Information module for Network Device Group"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/network_device_group_info_module.html
fetched_at: 2026-07-27T16:58:18+00:00
---
# cisco.ise.network_device_group_info module – Information module for Network Device Group
...
> see [Requirements](network_device_group_info_module.md#ansible-collections-cisco-ise-network-device-group-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.network_device_group_info`.

New in cisco.ise 1.0.0

- [Synopsis](network_device_group_info_module.md#synopsis)
- [Requirements](network_device_group_info_module.md#requirements)
- [Parameters](network_device_group_info_module.md#parameters)
- [Notes](network_device_group_info_module.md#notes)
- [Examples](network_device_group_info_module.md#examples)
- [Return Values](network_device_group_info_module.md#return-values)

## [Synopsis](network_device_group_info_module.md#id1)
...
## [Requirements](network_device_group_info_module.md#id2)
...
## [Parameters](network_device_group_info_module.md#id3)
...
| **name**  string | Name path parameter. Colon is used as a separator instead of (#) in the NDG name. For example, if the name is a#b#c it should appear in the request URL as a b c. |
...
## [Notes](network_device_group_info_module.md#id4)
...
## [Examples](network_device_group_info_module.md#id5)
...
## [Return Values](network_device_group_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `{"description": "string", "id": "string", "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "othername": "string"}` |
