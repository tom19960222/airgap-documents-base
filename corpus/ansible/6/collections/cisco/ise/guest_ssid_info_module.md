...
collection: ansible
version: "6"
title: "cisco.ise.guest_ssid_info module – Information module for Guest SSID"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/guest_ssid_info_module.html
fetched_at: 2026-07-27T16:57:11+00:00
---
# cisco.ise.guest_ssid_info module – Information module for Guest SSID
...
> see [Requirements](guest_ssid_info_module.md#ansible-collections-cisco-ise-guest-ssid-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.guest_ssid_info`.

New in cisco.ise 1.0.0

- [Synopsis](guest_ssid_info_module.md#synopsis)
- [Requirements](guest_ssid_info_module.md#requirements)
- [Parameters](guest_ssid_info_module.md#parameters)
- [Notes](guest_ssid_info_module.md#notes)
- [Examples](guest_ssid_info_module.md#examples)
- [Return Values](guest_ssid_info_module.md#return-values)

## [Synopsis](guest_ssid_info_module.md#id1)
...
## [Requirements](guest_ssid_info_module.md#id2)
...
## [Parameters](guest_ssid_info_module.md#id3)
...
## [Notes](guest_ssid_info_module.md#id4)

> **Note:**
>
> - SDK Method used are guest_ssid.GuestSsid.get_guest_ssid_by_id, guest_ssid.GuestSsid.get_guest_ssid_generator,
> - Paths used are get /ers/config/guestssid, get /ers/config/guestssid/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](guest_ssid_info_module.md#id5)
...
## [Return Values](guest_ssid_info_module.md#id6)
