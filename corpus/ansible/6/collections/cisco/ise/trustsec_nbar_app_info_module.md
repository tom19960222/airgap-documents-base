...
collection: ansible
version: "6"
title: "cisco.ise.trustsec_nbar_app_info module – Information module for Trustsec NBAR App"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trustsec_nbar_app_info_module.html
fetched_at: 2026-07-27T17:00:06+00:00
---
# cisco.ise.trustsec_nbar_app_info module – Information module for Trustsec NBAR App
...
> see [Requirements](trustsec_nbar_app_info_module.md#ansible-collections-cisco-ise-trustsec-nbar-app-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trustsec_nbar_app_info`.

New in cisco.ise 2.0.0

- [Synopsis](trustsec_nbar_app_info_module.md#synopsis)
- [Requirements](trustsec_nbar_app_info_module.md#requirements)
- [Parameters](trustsec_nbar_app_info_module.md#parameters)
- [Notes](trustsec_nbar_app_info_module.md#notes)
- [See Also](trustsec_nbar_app_info_module.md#see-also)
- [Examples](trustsec_nbar_app_info_module.md#examples)
- [Return Values](trustsec_nbar_app_info_module.md#return-values)

## [Synopsis](trustsec_nbar_app_info_module.md#id1)
...
## [Requirements](trustsec_nbar_app_info_module.md#id2)
...
## [Parameters](trustsec_nbar_app_info_module.md#id3)
...
## [Notes](trustsec_nbar_app_info_module.md#id4)

> **Note:**
>
> - SDK Method used are nbar_app.NbarApp.get_nbar_app_by_id, nbar_app.NbarApp.get_nbar_apps_generator,
> - Paths used are get /api/v1/trustsec/sgacl/nbarapp, get /api/v1/trustsec/sgacl/nbarapp/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](trustsec_nbar_app_info_module.md#id5)
...
## [Examples](trustsec_nbar_app_info_module.md#id6)
...
## [Return Values](trustsec_nbar_app_info_module.md#id7)
