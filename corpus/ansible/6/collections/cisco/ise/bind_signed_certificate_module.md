...
collection: ansible
version: "6"
title: "cisco.ise.bind_signed_certificate module – Resource module for Bind Signed Certificate"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/bind_signed_certificate_module.html
...
> see [Requirements](bind_signed_certificate_module.md#ansible-collections-cisco-ise-bind-signed-certificate-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.bind_signed_certificate`.

New in cisco.ise 1.0.0

- [Synopsis](bind_signed_certificate_module.md#synopsis)
- [Requirements](bind_signed_certificate_module.md#requirements)
- [Parameters](bind_signed_certificate_module.md#parameters)
- [Notes](bind_signed_certificate_module.md#notes)
- [See Also](bind_signed_certificate_module.md#see-also)
- [Examples](bind_signed_certificate_module.md#examples)
- [Return Values](bind_signed_certificate_module.md#return-values)

## [Synopsis](bind_signed_certificate_module.md#id1)
...
## [Requirements](bind_signed_certificate_module.md#id2)
...
## [Parameters](bind_signed_certificate_module.md#id3)
...
| **hostName**  string | Name of Host whose CSR ID has been provided (required). |
...
## [Notes](bind_signed_certificate_module.md#id4)
...
## [See Also](bind_signed_certificate_module.md#id5)
...
## [Examples](bind_signed_certificate_module.md#id6)
...
## [Return Values](bind_signed_certificate_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `{"response": {"message": "string", "status": "string"}, "version": "string"}` |
