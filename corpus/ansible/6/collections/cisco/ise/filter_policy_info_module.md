...
collection: ansible
version: "6"
title: "cisco.ise.filter_policy_info module – Information module for Filter Policy"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/filter_policy_info_module.html
fetched_at: 2026-07-27T16:57:08+00:00
---
# cisco.ise.filter_policy_info module – Information module for Filter Policy
...
> see [Requirements](filter_policy_info_module.md#ansible-collections-cisco-ise-filter-policy-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.filter_policy_info`.

New in cisco.ise 1.0.0

- [Synopsis](filter_policy_info_module.md#synopsis)
- [Requirements](filter_policy_info_module.md#requirements)
- [Parameters](filter_policy_info_module.md#parameters)
- [Notes](filter_policy_info_module.md#notes)
- [Examples](filter_policy_info_module.md#examples)
- [Return Values](filter_policy_info_module.md#return-values)

## [Synopsis](filter_policy_info_module.md#id1)
...
## [Requirements](filter_policy_info_module.md#id2)
...
## [Parameters](filter_policy_info_module.md#id3)
...
## [Notes](filter_policy_info_module.md#id4)
...
## [Examples](filter_policy_info_module.md#id5)
...
## [Return Values](filter_policy_info_module.md#id6)
