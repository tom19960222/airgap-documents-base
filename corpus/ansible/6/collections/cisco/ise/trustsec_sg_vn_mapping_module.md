...
collection: ansible
version: "6"
title: "cisco.ise.trustsec_sg_vn_mapping module – Resource module for Trustsec SG VN Mapping"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trustsec_sg_vn_mapping_module.html
...
> see [Requirements](trustsec_sg_vn_mapping_module.md#ansible-collections-cisco-ise-trustsec-sg-vn-mapping-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trustsec_sg_vn_mapping`.

New in cisco.ise 2.0.0

- [Synopsis](trustsec_sg_vn_mapping_module.md#synopsis)
- [Requirements](trustsec_sg_vn_mapping_module.md#requirements)
- [Parameters](trustsec_sg_vn_mapping_module.md#parameters)
- [Notes](trustsec_sg_vn_mapping_module.md#notes)
- [See Also](trustsec_sg_vn_mapping_module.md#see-also)
- [Examples](trustsec_sg_vn_mapping_module.md#examples)
- [Return Values](trustsec_sg_vn_mapping_module.md#return-values)

## [Synopsis](trustsec_sg_vn_mapping_module.md#id1)
...
## [Requirements](trustsec_sg_vn_mapping_module.md#id2)
...
## [Parameters](trustsec_sg_vn_mapping_module.md#id3)
...
## [Notes](trustsec_sg_vn_mapping_module.md#id4)
...
## [See Also](trustsec_sg_vn_mapping_module.md#id5)
...
## [Examples](trustsec_sg_vn_mapping_module.md#id6)
...
## [Return Values](trustsec_sg_vn_mapping_module.md#id7)
