...
collection: ansible
version: "6"
title: "cisco.ise.sg_to_vn_to_vlan module – Resource module for SG To VN To VLAN"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sg_to_vn_to_vlan_module.html
fetched_at: 2026-07-27T16:59:29+00:00
---
...
> see [Requirements](sg_to_vn_to_vlan_module.md#ansible-collections-cisco-ise-sg-to-vn-to-vlan-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sg_to_vn_to_vlan`.

New in cisco.ise 1.0.0

- [Synopsis](sg_to_vn_to_vlan_module.md#synopsis)
- [Requirements](sg_to_vn_to_vlan_module.md#requirements)
- [Parameters](sg_to_vn_to_vlan_module.md#parameters)
- [Notes](sg_to_vn_to_vlan_module.md#notes)
- [See Also](sg_to_vn_to_vlan_module.md#see-also)
- [Examples](sg_to_vn_to_vlan_module.md#examples)
- [Return Values](sg_to_vn_to_vlan_module.md#return-values)

## [Synopsis](sg_to_vn_to_vlan_module.md#id1)
...
## [Requirements](sg_to_vn_to_vlan_module.md#id2)
...
## [Parameters](sg_to_vn_to_vlan_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **description**  string | SG To VN To VLAN’s description. |
| **id**  string | SG To VN To VLAN’s id. |
...
| **name**  string | SG To VN To VLAN’s name. |
| **sgtId**  string | SG To VN To VLAN’s sgtId. |
| **virtualnetworklist**  list / elements=dictionary | SG To VN To VLAN’s virtualnetworklist. |
| **defaultVirtualNetwork**  boolean | DefaultVirtualNetwork flag.  Choices:   - `false` - `true` |
| **description**  string | SG To VN To VLAN’s description. |
| **id**  string | SG To VN To VLAN’s id. |
| **name**  string | SG To VN To VLAN’s name. |
| **vlans**  list / elements=dictionary | SG To VN To VLAN’s vlans. |
| **data**  boolean | Data flag.  Choices:   - `false` - `true` |
| **defaultVLAN**  boolean | DefaultVLAN flag.  Choices:   - `false` - `true` |
| **description**  string | SG To VN To VLAN’s description. |
| **id**  string | SG To VN To VLAN’s id. |
| **maxValue**  integer | SG To VN To VLAN’s maxValue. |
| **name**  string | SG To VN To VLAN’s name. |

## [Notes](sg_to_vn_to_vlan_module.md#id4)
...
## [See Also](sg_to_vn_to_vlan_module.md#id5)
...
## [Examples](sg_to_vn_to_vlan_module.md#id6)
...
## [Return Values](sg_to_vn_to_vlan_module.md#id7)
