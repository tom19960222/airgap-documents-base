...
collection: ansible
version: "6"
title: "cisco.ise.pxgrid_node_info module – Information module for pxGrid Node"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/pxgrid_node_info_module.html
fetched_at: 2026-07-27T16:58:58+00:00
---
# cisco.ise.pxgrid_node_info module – Information module for pxGrid Node
...
> see [Requirements](pxgrid_node_info_module.md#ansible-collections-cisco-ise-pxgrid-node-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.pxgrid_node_info`.

New in cisco.ise 1.0.0

- [Synopsis](pxgrid_node_info_module.md#synopsis)
- [Requirements](pxgrid_node_info_module.md#requirements)
- [Parameters](pxgrid_node_info_module.md#parameters)
- [Notes](pxgrid_node_info_module.md#notes)
- [Examples](pxgrid_node_info_module.md#examples)
- [Return Values](pxgrid_node_info_module.md#return-values)

## [Synopsis](pxgrid_node_info_module.md#id1)
...
## [Requirements](pxgrid_node_info_module.md#id2)
...
## [Parameters](pxgrid_node_info_module.md#id3)
...
## [Notes](pxgrid_node_info_module.md#id4)
...
## [Examples](pxgrid_node_info_module.md#id5)
...
## [Return Values](pxgrid_node_info_module.md#id6)
