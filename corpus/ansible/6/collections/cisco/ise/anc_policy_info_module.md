...
collection: ansible
version: "6"
title: "cisco.ise.anc_policy_info module – Information module for ANC Policy"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/anc_policy_info_module.html
fetched_at: 2026-07-27T16:56:18+00:00
---
# cisco.ise.anc_policy_info module – Information module for ANC Policy
...
> see [Requirements](anc_policy_info_module.md#ansible-collections-cisco-ise-anc-policy-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.anc_policy_info`.

New in cisco.ise 1.0.0

- [Synopsis](anc_policy_info_module.md#synopsis)
- [Requirements](anc_policy_info_module.md#requirements)
- [Parameters](anc_policy_info_module.md#parameters)
- [Notes](anc_policy_info_module.md#notes)
- [Examples](anc_policy_info_module.md#examples)
- [Return Values](anc_policy_info_module.md#return-values)

## [Synopsis](anc_policy_info_module.md#id1)
...
## [Requirements](anc_policy_info_module.md#id2)
...
## [Parameters](anc_policy_info_module.md#id3)
...
## [Notes](anc_policy_info_module.md#id4)

> **Note:**
>
> - SDK Method used are anc_policy.AncPolicy.get_anc_policy_by_id, anc_policy.AncPolicy.get_anc_policy_by_name, anc_policy.AncPolicy.get_anc_policy_generator,
> - Paths used are get /ers/config/ancpolicy, get /ers/config/ancpolicy/name/{name}, get /ers/config/ancpolicy/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](anc_policy_info_module.md#id5)
...
## [Return Values](anc_policy_info_module.md#id6)
