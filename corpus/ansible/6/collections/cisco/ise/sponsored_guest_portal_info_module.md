...
collection: ansible
version: "6"
title: "cisco.ise.sponsored_guest_portal_info module – Information module for Sponsored Guest Portal"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sponsored_guest_portal_info_module.html
fetched_at: 2026-07-27T16:59:39+00:00
---
# cisco.ise.sponsored_guest_portal_info module – Information module for Sponsored Guest Portal
...
> see [Requirements](sponsored_guest_portal_info_module.md#ansible-collections-cisco-ise-sponsored-guest-portal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sponsored_guest_portal_info`.

New in cisco.ise 1.0.0

- [Synopsis](sponsored_guest_portal_info_module.md#synopsis)
- [Requirements](sponsored_guest_portal_info_module.md#requirements)
- [Parameters](sponsored_guest_portal_info_module.md#parameters)
- [Notes](sponsored_guest_portal_info_module.md#notes)
- [Examples](sponsored_guest_portal_info_module.md#examples)
- [Return Values](sponsored_guest_portal_info_module.md#return-values)

## [Synopsis](sponsored_guest_portal_info_module.md#id1)
...
## [Requirements](sponsored_guest_portal_info_module.md#id2)
...
## [Parameters](sponsored_guest_portal_info_module.md#id3)
...
## [Notes](sponsored_guest_portal_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sponsored_guest_portal.SponsoredGuestPortal.get_sponsored_guest_portal_by_id, sponsored_guest_portal.SponsoredGuestPortal.get_sponsored_guest_portals_generator,
> - Paths used are get /ers/config/sponsoredguestportal, get /ers/config/sponsoredguestportal/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](sponsored_guest_portal_info_module.md#id5)
...
## [Return Values](sponsored_guest_portal_info_module.md#id6)
