...
collection: ansible
version: "6"
title: "cisco.ise.sms_provider_info module – Information module for SMS Provider"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sms_provider_info_module.html
fetched_at: 2026-07-27T16:59:34+00:00
---
# cisco.ise.sms_provider_info module – Information module for SMS Provider
...
> see [Requirements](sms_provider_info_module.md#ansible-collections-cisco-ise-sms-provider-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sms_provider_info`.

New in cisco.ise 1.0.0

- [Synopsis](sms_provider_info_module.md#synopsis)
- [Requirements](sms_provider_info_module.md#requirements)
- [Parameters](sms_provider_info_module.md#parameters)
- [Notes](sms_provider_info_module.md#notes)
- [Examples](sms_provider_info_module.md#examples)
- [Return Values](sms_provider_info_module.md#return-values)

## [Synopsis](sms_provider_info_module.md#id1)
...
## [Requirements](sms_provider_info_module.md#id2)
...
## [Parameters](sms_provider_info_module.md#id3)
...
## [Notes](sms_provider_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sms_provider.SmsProvider.get_sms_provider_generator,
> - Paths used are get /ers/config/smsprovider,
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](sms_provider_info_module.md#id5)
...
## [Return Values](sms_provider_info_module.md#id6)
