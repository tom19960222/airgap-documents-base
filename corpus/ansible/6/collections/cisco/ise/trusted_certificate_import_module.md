...
collection: ansible
version: "6"
title: "cisco.ise.trusted_certificate_import module – Resource module for Trusted Certificate Import"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trusted_certificate_import_module.html
fetched_at: 2026-07-27T17:00:04+00:00
---
...
> see [Requirements](trusted_certificate_import_module.md#ansible-collections-cisco-ise-trusted-certificate-import-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trusted_certificate_import`.

New in cisco.ise 1.0.0

- [Synopsis](trusted_certificate_import_module.md#synopsis)
- [Requirements](trusted_certificate_import_module.md#requirements)
- [Parameters](trusted_certificate_import_module.md#parameters)
- [Notes](trusted_certificate_import_module.md#notes)
- [See Also](trusted_certificate_import_module.md#see-also)
- [Examples](trusted_certificate_import_module.md#examples)
- [Return Values](trusted_certificate_import_module.md#return-values)

## [Synopsis](trusted_certificate_import_module.md#id1)
...
## [Requirements](trusted_certificate_import_module.md#id2)
...
## [Parameters](trusted_certificate_import_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **allowBasicConstraintCAFalse**  boolean | Allow certificates with Basic Constraints CA Field as False (required).  Choices:   - `false` - `true` |
...
| **validateCertificateExtensions**  boolean | Validate trust certificate extension.  Choices:   - `false` - `true` |

## [Notes](trusted_certificate_import_module.md#id4)
...
## [See Also](trusted_certificate_import_module.md#id5)
...
## [Examples](trusted_certificate_import_module.md#id6)
...
## [Return Values](trusted_certificate_import_module.md#id7)
