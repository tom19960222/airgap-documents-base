...
collection: ansible
version: "6"
title: "cisco.ise.network_access_conditions module – Resource module for Network Access Conditions"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/network_access_conditions_module.html
fetched_at: 2026-07-27T16:57:56+00:00
---
...
> see [Requirements](network_access_conditions_module.md#ansible-collections-cisco-ise-network-access-conditions-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.network_access_conditions`.

New in cisco.ise 1.0.0

- [Synopsis](network_access_conditions_module.md#synopsis)
- [Requirements](network_access_conditions_module.md#requirements)
- [Parameters](network_access_conditions_module.md#parameters)
- [Notes](network_access_conditions_module.md#notes)
- [See Also](network_access_conditions_module.md#see-also)
- [Examples](network_access_conditions_module.md#examples)
- [Return Values](network_access_conditions_module.md#return-values)

## [Synopsis](network_access_conditions_module.md#id1)
...
## [Requirements](network_access_conditions_module.md#id2)
...
## [Parameters](network_access_conditions_module.md#id3)
...
| **link**  dictionary | Network Access Conditions’s link. |
| **href**  string | Network Access Conditions’s href. |
| **rel**  string | Network Access Conditions’s rel. |
| **type**  string | Network Access Conditions’s type. |
| **conditionType**  string | <ul><li>Inidicates whether the record is the condition itself(data) or a logical(or,and) aggregation</li> <li>Data type enum(reference,single) indicates than “conditonId” OR “ConditionAttrs” fields should contain condition data but not both</li> <li>Logical aggreation(and,or) enum indicates that additional conditions are present under the children field</li></ul>. |
...
| **endDate**  string | Network Access Conditions’s endDate. |
| **startDate**  string | Network Access Conditions’s startDate. |
...
| **endTime**  string | Network Access Conditions’s endTime. |
| **startTime**  string | Network Access Conditions’s startTime. |
...
| **endTime**  string | Network Access Conditions’s endTime. |
| **startTime**  string | Network Access Conditions’s startTime. |
| **id**  string | Network Access Conditions’s id. |
...
## [Notes](network_access_conditions_module.md#id4)
...
## [See Also](network_access_conditions_module.md#id5)

> **See also:**
>
> [Cisco ISE documentation for Network Access - Conditions](https://developer.cisco.com/docs/identity-services-engine/v1/#!policy-openapi)
> :   Complete reference of the Network Access - Conditions API.

## [Examples](network_access_conditions_module.md#id6)
...
## [Return Values](network_access_conditions_module.md#id7)
