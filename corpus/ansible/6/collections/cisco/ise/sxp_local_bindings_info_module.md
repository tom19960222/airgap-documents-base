...
collection: ansible
version: "6"
title: "cisco.ise.sxp_local_bindings_info module – Information module for SXP Local Bindings"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/sxp_local_bindings_info_module.html
fetched_at: 2026-07-27T16:59:46+00:00
---
# cisco.ise.sxp_local_bindings_info module – Information module for SXP Local Bindings
...
> see [Requirements](sxp_local_bindings_info_module.md#ansible-collections-cisco-ise-sxp-local-bindings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sxp_local_bindings_info`.

New in cisco.ise 1.0.0

- [Synopsis](sxp_local_bindings_info_module.md#synopsis)
- [Requirements](sxp_local_bindings_info_module.md#requirements)
- [Parameters](sxp_local_bindings_info_module.md#parameters)
- [Notes](sxp_local_bindings_info_module.md#notes)
- [Examples](sxp_local_bindings_info_module.md#examples)
- [Return Values](sxp_local_bindings_info_module.md#return-values)

## [Synopsis](sxp_local_bindings_info_module.md#id1)
...
## [Requirements](sxp_local_bindings_info_module.md#id2)
...
## [Parameters](sxp_local_bindings_info_module.md#id3)
...
## [Notes](sxp_local_bindings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sxp_local_bindings.SxpLocalBindings.get_sxp_local_bindings_by_id, sxp_local_bindings.SxpLocalBindings.get_sxp_local_bindings_generator,
> - Paths used are get /ers/config/sxplocalbindings, get /ers/config/sxplocalbindings/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](sxp_local_bindings_info_module.md#id5)
...
## [Return Values](sxp_local_bindings_info_module.md#id6)
