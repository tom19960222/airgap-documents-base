...
collection: ansible
version: "6"
title: "cisco.ise.byod_portal_info module – Information module for BYOD Portal"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/byod_portal_info_module.html
fetched_at: 2026-07-27T16:56:25+00:00
---
# cisco.ise.byod_portal_info module – Information module for BYOD Portal
...
> see [Requirements](byod_portal_info_module.md#ansible-collections-cisco-ise-byod-portal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.byod_portal_info`.

New in cisco.ise 1.0.0

- [Synopsis](byod_portal_info_module.md#synopsis)
- [Requirements](byod_portal_info_module.md#requirements)
- [Parameters](byod_portal_info_module.md#parameters)
- [Notes](byod_portal_info_module.md#notes)
- [Examples](byod_portal_info_module.md#examples)
- [Return Values](byod_portal_info_module.md#return-values)

## [Synopsis](byod_portal_info_module.md#id1)
...
## [Requirements](byod_portal_info_module.md#id2)
...
## [Parameters](byod_portal_info_module.md#id3)
...
## [Notes](byod_portal_info_module.md#id4)

> **Note:**
>
> - SDK Method used are byod_portal.ByodPortal.get_byod_portal_by_id, byod_portal.ByodPortal.get_byod_portal_generator,
> - Paths used are get /ers/config/byodportal, get /ers/config/byodportal/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](byod_portal_info_module.md#id5)
...
## [Return Values](byod_portal_info_module.md#id6)
