...
collection: ansible
version: "6"
title: "cisco.ise.admin_user_info module – Information module for Admin User"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/admin_user_info_module.html
fetched_at: 2026-07-27T16:56:10+00:00
---
# cisco.ise.admin_user_info module – Information module for Admin User
...
> see [Requirements](admin_user_info_module.md#ansible-collections-cisco-ise-admin-user-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.admin_user_info`.

New in cisco.ise 1.0.0

- [Synopsis](admin_user_info_module.md#synopsis)
- [Requirements](admin_user_info_module.md#requirements)
- [Parameters](admin_user_info_module.md#parameters)
- [Notes](admin_user_info_module.md#notes)
- [Examples](admin_user_info_module.md#examples)
- [Return Values](admin_user_info_module.md#return-values)

## [Synopsis](admin_user_info_module.md#id1)
...
## [Requirements](admin_user_info_module.md#id2)
...
## [Parameters](admin_user_info_module.md#id3)
...
## [Notes](admin_user_info_module.md#id4)

> **Note:**
>
> - SDK Method used are admin_user.AdminUser.get_admin_user_by_id, admin_user.AdminUser.get_admin_users_generator,
> - Paths used are get /ers/config/adminuser, get /ers/config/adminuser/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](admin_user_info_module.md#id5)
...
## [Return Values](admin_user_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `{"adminGroups": "string", "changePassword": true, "customAttributes": {}, "description": "string", "enabled": true, "externalUser": true, "id": "string", "inactiveAccountNeverDisabled": true, "includeSystemAlarmsInEmail": true, "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "password": "string"}` |
