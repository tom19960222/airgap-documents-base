...
collection: ansible
version: "6"
title: "cisco.ise.trustsec_sg_vn_mapping_info module – Information module for Trustsec SG VN Mapping"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ise/trustsec_sg_vn_mapping_info_module.html
fetched_at: 2026-07-27T17:00:09+00:00
---
# cisco.ise.trustsec_sg_vn_mapping_info module – Information module for Trustsec SG VN Mapping
...
> see [Requirements](trustsec_sg_vn_mapping_info_module.md#ansible-collections-cisco-ise-trustsec-sg-vn-mapping-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.trustsec_sg_vn_mapping_info`.

New in cisco.ise 2.0.0

- [Synopsis](trustsec_sg_vn_mapping_info_module.md#synopsis)
- [Requirements](trustsec_sg_vn_mapping_info_module.md#requirements)
- [Parameters](trustsec_sg_vn_mapping_info_module.md#parameters)
- [Notes](trustsec_sg_vn_mapping_info_module.md#notes)
- [See Also](trustsec_sg_vn_mapping_info_module.md#see-also)
- [Examples](trustsec_sg_vn_mapping_info_module.md#examples)
- [Return Values](trustsec_sg_vn_mapping_info_module.md#return-values)

## [Synopsis](trustsec_sg_vn_mapping_info_module.md#id1)
...
## [Requirements](trustsec_sg_vn_mapping_info_module.md#id2)
...
## [Parameters](trustsec_sg_vn_mapping_info_module.md#id3)
...
## [Notes](trustsec_sg_vn_mapping_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sg_vn_mapping.SgVnMapping.get_sg_vn_mapping_by_id, sg_vn_mapping.SgVnMapping.get_sg_vn_mappings_generator,
> - Paths used are get /api/v1/trustsec/sgvnmapping, get /api/v1/trustsec/sgvnmapping/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](trustsec_sg_vn_mapping_info_module.md#id5)
...
## [Examples](trustsec_sg_vn_mapping_info_module.md#id6)
...
## [Return Values](trustsec_sg_vn_mapping_info_module.md#id7)
...
| **ise_responses**  list / elements=dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  Returned: always  Sample: `"[\n  {\n    \"id\": \"string\",\n    \"lastUpdate\": \"string\",\n    \"sgName\": \"string\",\n    \"sgtId\": \"string\",\n    \"vnId\": \"string\",\n    \"vnName\": \"string\"\n  }\n]\n"` |
