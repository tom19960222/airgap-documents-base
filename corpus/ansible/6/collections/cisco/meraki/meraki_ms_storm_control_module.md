...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_ms_storm_control_module.html
...
## [Synopsis](meraki_ms_storm_control_module.md#id1)

- Allows for management of storm control settings for Meraki MS switches.

## [Parameters](meraki_ms_storm_control_module.md#id2)
...
## [Notes](meraki_ms_storm_control_module.md#id3)
...
## [Examples](meraki_ms_storm_control_module.md#id4)
...
## [Return Values](meraki_ms_storm_control_module.md#id5)
