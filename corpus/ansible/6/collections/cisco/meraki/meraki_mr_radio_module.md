...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_mr_radio_module.html
...
## [Synopsis](meraki_mr_radio_module.md#id1)

- Allows for configuration of radio settings in Meraki MR wireless networks.

## [Parameters](meraki_mr_radio_module.md#id2)
...
## [Notes](meraki_mr_radio_module.md#id3)
...
## [Examples](meraki_mr_radio_module.md#id4)
...
## [Return Values](meraki_mr_radio_module.md#id5)
