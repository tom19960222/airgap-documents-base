...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_config_template_module.html
...
## [Synopsis](meraki_config_template_module.md#id1)

- Allows for querying, deleting, binding, and unbinding of configuration templates.

## [Parameters](meraki_config_template_module.md#id2)
...
## [Notes](meraki_config_template_module.md#id3)
...
## [Examples](meraki_config_template_module.md#id4)
...
## [Return Values](meraki_config_template_module.md#id5)
