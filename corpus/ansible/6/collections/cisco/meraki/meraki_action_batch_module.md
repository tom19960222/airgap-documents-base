...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_action_batch_module.html
...
## [Synopsis](meraki_action_batch_module.md#id1)

- Allows for management of Action Batch jobs for Meraki.

## [Parameters](meraki_action_batch_module.md#id2)
...
## [Notes](meraki_action_batch_module.md#id3)
...
## [Examples](meraki_action_batch_module.md#id4)
...
## [Return Values](meraki_action_batch_module.md#id5)
