...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_mx_uplink_bandwidth_module.html
...
## [Synopsis](meraki_mx_uplink_bandwidth_module.md#id1)

- Configure and query information about uplinks on Meraki MX appliances.

## [Parameters](meraki_mx_uplink_bandwidth_module.md#id2)
...
## [Notes](meraki_mx_uplink_bandwidth_module.md#id3)

> **Note:**
>
> - Some of the options are likely only used for developers within Meraki.
> - Module was formerly named [cisco.meraki.meraki_mx_uplink](meraki_mx_uplink_module.md#ansible-collections-cisco-meraki-meraki-mx-uplink-module).
...
## [Examples](meraki_mx_uplink_bandwidth_module.md#id4)
...
## [Return Values](meraki_mx_uplink_bandwidth_module.md#id5)
