...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_management_interface_module.html
...
## [Synopsis](meraki_management_interface_module.md#id1)

- Allows for configuration of management interfaces on Meraki MX, MS, and MR devices.

## [Parameters](meraki_management_interface_module.md#id2)
...
## [Notes](meraki_management_interface_module.md#id3)
...
## [Examples](meraki_management_interface_module.md#id4)
...
## [Return Values](meraki_management_interface_module.md#id5)
