...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/meraki/meraki_ms_switchport_module.html
fetched_at: 2026-07-27T17:00:31+00:00
---
...
## [Synopsis](meraki_ms_switchport_module.md#id1)

- Allows for management of switchports settings for Meraki MS switches.

## [Parameters](meraki_ms_switchport_module.md#id2)
...
| **link_negotiation**  string | Link speed for the switchport.  Choices:   - `"Auto negotiate"` ← (default) - `"100 Megabit (auto)"` - `"100 Megabit full duplex (forced)"` |
...
## [Notes](meraki_ms_switchport_module.md#id3)
...
## [Examples](meraki_ms_switchport_module.md#id4)
...
## [Return Values](meraki_ms_switchport_module.md#id5)
