...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_template_external_epg_subnet module – Manage External EPG subnets in schema templates"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_template_external_epg_subnet_module.html
fetched_at: 2026-07-27T17:01:19+00:00
---
# cisco.mso.mso_schema_template_external_epg_subnet module – Manage External EPG subnets in schema templates
...
> see [Requirements](mso_schema_template_external_epg_subnet_module.md#ansible-collections-cisco-mso-mso-schema-template-external-epg-subnet-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_external_epg_subnet`.

New in cisco.mso 0.0.8

- [Synopsis](mso_schema_template_external_epg_subnet_module.md#synopsis)
- [Requirements](mso_schema_template_external_epg_subnet_module.md#requirements)
- [Parameters](mso_schema_template_external_epg_subnet_module.md#parameters)
- [Notes](mso_schema_template_external_epg_subnet_module.md#notes)
- [Examples](mso_schema_template_external_epg_subnet_module.md#examples)

## [Synopsis](mso_schema_template_external_epg_subnet_module.md#id1)

- Manage External EPG subnets in schema templates on Cisco ACI Multi-Site.

## [Requirements](mso_schema_template_external_epg_subnet_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_external_epg_subnet_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **aggregate**  list / elements=string | The aggregate option aggregates shared routes for the subnet.  Use `shared-rtctrl` to add Aggregate Shared Routes  The `shared-rtctrl` option can only be used when scope parameter Shared Route Control in the Route Control section is selected. |
| **external_epg**  string / required | The name of the External EPG to manage. |
...
## [Notes](mso_schema_template_external_epg_subnet_module.md#id4)
...
## [Examples](mso_schema_template_external_epg_subnet_module.md#id5)
