...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_site_anp_epg_selector module – Manage site-local EPG selector in schema templates"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_site_anp_epg_selector_module.html
fetched_at: 2026-07-27T17:00:56+00:00
---
# cisco.mso.mso_schema_site_anp_epg_selector module – Manage site-local EPG selector in schema templates
...
> see [Requirements](mso_schema_site_anp_epg_selector_module.md#ansible-collections-cisco-mso-mso-schema-site-anp-epg-selector-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_anp_epg_selector`.

- [Synopsis](mso_schema_site_anp_epg_selector_module.md#synopsis)
- [Requirements](mso_schema_site_anp_epg_selector_module.md#requirements)
- [Parameters](mso_schema_site_anp_epg_selector_module.md#parameters)
- [Notes](mso_schema_site_anp_epg_selector_module.md#notes)
- [See Also](mso_schema_site_anp_epg_selector_module.md#see-also)
- [Examples](mso_schema_site_anp_epg_selector_module.md#examples)

## [Synopsis](mso_schema_site_anp_epg_selector_module.md#id1)

- Manage EPG selector in schema template on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_anp_epg_selector_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_anp_epg_selector_module.md#id3)
...
| **operator**  string / required | The operator associated to the expression.  Operator has_key or does_not_have_key is only available for custom type / tag  Choices:   - `"not_in"` - `"in"` - `"equals"` - `"not_equals"` - `"has_key"` - `"does_not_have_key"` |
| **type**  aliases: tag  string / required | The type of the expression.  The type is custom or is one of region, zone and ip_address  The type can be zone only when the site is AWS. |
| **value**  string | The value associated to the expression.  If the operator is in or not_in, the value should be a comma separated string. |
...
## [Notes](mso_schema_site_anp_epg_selector_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_site_anp_epg_selector_module.md#id5)
...
## [Examples](mso_schema_site_anp_epg_selector_module.md#id6)
