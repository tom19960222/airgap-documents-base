...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_site_vrf module – Manage site-local VRFs in schema template"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_site_vrf_module.html
fetched_at: 2026-07-27T17:01:04+00:00
---
# cisco.mso.mso_schema_site_vrf module – Manage site-local VRFs in schema template
...
> see [Requirements](mso_schema_site_vrf_module.md#ansible-collections-cisco-mso-mso-schema-site-vrf-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_vrf`.

- [Synopsis](mso_schema_site_vrf_module.md#synopsis)
- [Requirements](mso_schema_site_vrf_module.md#requirements)
- [Parameters](mso_schema_site_vrf_module.md#parameters)
- [Notes](mso_schema_site_vrf_module.md#notes)
- [See Also](mso_schema_site_vrf_module.md#see-also)
- [Examples](mso_schema_site_vrf_module.md#examples)

## [Synopsis](mso_schema_site_vrf_module.md#id1)

- Manage site-local VRFs in schema template on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_vrf_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_vrf_module.md#id3)
...
## [Notes](mso_schema_site_vrf_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_site_vrf_module.md#id5)
...
## [Examples](mso_schema_site_vrf_module.md#id6)
