...
collection: ansible
version: "6"
title: "cisco.mso.mso_label module – Manage labels"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_label_module.html
fetched_at: 2026-07-27T17:00:49+00:00
---
# cisco.mso.mso_label module – Manage labels
...
> see [Requirements](mso_label_module.md#ansible-collections-cisco-mso-mso-label-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_label`.

- [Synopsis](mso_label_module.md#synopsis)
- [Requirements](mso_label_module.md#requirements)
- [Parameters](mso_label_module.md#parameters)
- [Notes](mso_label_module.md#notes)
- [Examples](mso_label_module.md#examples)

## [Synopsis](mso_label_module.md#id1)

- Manage labels on Cisco ACI Multi-Site.

## [Requirements](mso_label_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_label_module.md#id3)
...
| **label**  aliases: name  string | The name of the label. |
...
| **type**  string | The type of the label.  Choices:   - `"site"` ← (default) |
...
## [Notes](mso_label_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_label_module.md#id5)
