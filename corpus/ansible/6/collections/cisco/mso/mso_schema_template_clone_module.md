...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_template_clone module – Clone templates"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_template_clone_module.html
...
> see [Requirements](mso_schema_template_clone_module.md#ansible-collections-cisco-mso-mso-schema-template-clone-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_clone`.

- [Synopsis](mso_schema_template_clone_module.md#synopsis)
- [Requirements](mso_schema_template_clone_module.md#requirements)
- [Parameters](mso_schema_template_clone_module.md#parameters)
- [Notes](mso_schema_template_clone_module.md#notes)
- [See Also](mso_schema_template_clone_module.md#see-also)
- [Examples](mso_schema_template_clone_module.md#examples)

## [Synopsis](mso_schema_template_clone_module.md#id1)

- Clone templates on Cisco ACI Multi-Site.
- Clones only template objects and not site objects.

## [Requirements](mso_schema_template_clone_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_clone_module.md#id3)
...
## [Notes](mso_schema_template_clone_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_template_clone_module.md#id5)
...
> :   Manage schemas.
>
> [cisco.mso.mso_schema_clone](mso_schema_clone_module.md#ansible-collections-cisco-mso-mso-schema-clone-module)
> :   Clone schemas.

## [Examples](mso_schema_template_clone_module.md#id6)
