...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_site_anp_epg_staticleaf module – Manage site-local EPG static leafs in schema template"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_site_anp_epg_staticleaf_module.html
fetched_at: 2026-07-27T17:00:57+00:00
---
# cisco.mso.mso_schema_site_anp_epg_staticleaf module – Manage site-local EPG static leafs in schema template
...
> see [Requirements](mso_schema_site_anp_epg_staticleaf_module.md#ansible-collections-cisco-mso-mso-schema-site-anp-epg-staticleaf-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_anp_epg_staticleaf`.

- [Synopsis](mso_schema_site_anp_epg_staticleaf_module.md#synopsis)
- [Requirements](mso_schema_site_anp_epg_staticleaf_module.md#requirements)
- [Parameters](mso_schema_site_anp_epg_staticleaf_module.md#parameters)
- [Notes](mso_schema_site_anp_epg_staticleaf_module.md#notes)
- [See Also](mso_schema_site_anp_epg_staticleaf_module.md#see-also)
- [Examples](mso_schema_site_anp_epg_staticleaf_module.md#examples)

## [Synopsis](mso_schema_site_anp_epg_staticleaf_module.md#id1)

- Manage site-local EPG static leafs in schema template on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_anp_epg_staticleaf_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_anp_epg_staticleaf_module.md#id3)
...
| **leaf**  aliases: name  string | The path of the static leaf. |
...
| **vlan**  integer | The VLAN id of the static leaf. |

## [Notes](mso_schema_site_anp_epg_staticleaf_module.md#id4)
...
## [See Also](mso_schema_site_anp_epg_staticleaf_module.md#id5)
...
## [Examples](mso_schema_site_anp_epg_staticleaf_module.md#id6)
