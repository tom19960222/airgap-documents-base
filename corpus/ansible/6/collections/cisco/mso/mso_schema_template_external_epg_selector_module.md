...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_template_external_epg_selector module – Manage External EPG selector in schema templates"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_template_external_epg_selector_module.html
fetched_at: 2026-07-27T17:01:18+00:00
---
# cisco.mso.mso_schema_template_external_epg_selector module – Manage External EPG selector in schema templates
...
> see [Requirements](mso_schema_template_external_epg_selector_module.md#ansible-collections-cisco-mso-mso-schema-template-external-epg-selector-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_external_epg_selector`.

- [Synopsis](mso_schema_template_external_epg_selector_module.md#synopsis)
- [Requirements](mso_schema_template_external_epg_selector_module.md#requirements)
- [Parameters](mso_schema_template_external_epg_selector_module.md#parameters)
- [Notes](mso_schema_template_external_epg_selector_module.md#notes)
- [See Also](mso_schema_template_external_epg_selector_module.md#see-also)
- [Examples](mso_schema_template_external_epg_selector_module.md#examples)

## [Synopsis](mso_schema_template_external_epg_selector_module.md#id1)

- Manage External EPG selector in schema templates on Cisco ACI Multi-Site.

## [Requirements](mso_schema_template_external_epg_selector_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_external_epg_selector_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **expressions**  list / elements=dictionary | Expressions associated to this selector. |
| **operator**  string / required | The operator associated with the expression which in this case is always equals.  Choices:   - `"equals"` |
| **type**  string / required | The name of the expression which in this case is always IP address.  Choices:   - `"ip_address"` |
| **value**  string / required | The value of the IP Address / Subnet associated with the expression. |
| **external_epg**  string / required | The name of the External EPG to be managed. |
...
## [Notes](mso_schema_template_external_epg_selector_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_template_external_epg_selector_module.md#id5)
...
## [Examples](mso_schema_template_external_epg_selector_module.md#id6)
