...
collection: ansible
version: "6"
title: "cisco.mso.mso_schema_site module – Manage sites in schemas"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/mso/mso_schema_site_module.html
fetched_at: 2026-07-27T17:00:53+00:00
---
# cisco.mso.mso_schema_site module – Manage sites in schemas
...
> see [Requirements](mso_schema_site_module.md#ansible-collections-cisco-mso-mso-schema-site-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site`.

- [Synopsis](mso_schema_site_module.md#synopsis)
- [Requirements](mso_schema_site_module.md#requirements)
- [Parameters](mso_schema_site_module.md#parameters)
- [Notes](mso_schema_site_module.md#notes)
- [See Also](mso_schema_site_module.md#see-also)
- [Examples](mso_schema_site_module.md#examples)

## [Synopsis](mso_schema_site_module.md#id1)

- Manage sites on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_module.md#id3)
...
## [Notes](mso_schema_site_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_site_module.md#id5)
...
>
> [cisco.mso.mso_site](mso_site_module.md#ansible-collections-cisco-mso-mso-site-module)
> :   Manage sites.

## [Examples](mso_schema_site_module.md#id6)
