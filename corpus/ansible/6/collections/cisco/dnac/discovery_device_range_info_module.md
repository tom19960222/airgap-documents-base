...
collection: ansible
version: "6"
title: "cisco.dnac.discovery_device_range_info module – Information module for Discovery Device Range"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/discovery_device_range_info_module.html
fetched_at: 2026-07-27T16:51:42+00:00
---
...
> see [Requirements](discovery_device_range_info_module.md#ansible-collections-cisco-dnac-discovery-device-range-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.discovery_device_range_info`.

New in cisco.dnac 3.1.0

- [Synopsis](discovery_device_range_info_module.md#synopsis)
- [Requirements](discovery_device_range_info_module.md#requirements)
- [Parameters](discovery_device_range_info_module.md#parameters)
- [Notes](discovery_device_range_info_module.md#notes)
- [See Also](discovery_device_range_info_module.md#see-also)
- [Examples](discovery_device_range_info_module.md#examples)
- [Return Values](discovery_device_range_info_module.md#return-values)

## [Synopsis](discovery_device_range_info_module.md#id1)
...
## [Requirements](discovery_device_range_info_module.md#id2)
...
## [Parameters](discovery_device_range_info_module.md#id3)
...
## [Notes](discovery_device_range_info_module.md#id4)

> **Note:**
>
> - SDK Method used are discovery.Discovery.get_discovered_devices_by_range,
...
## [See Also](discovery_device_range_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Discovery GetDiscoveredDevicesByRange](https://developer.cisco.com/docs/dna-center/#!get-discovered-devices-by-range)
> :   Complete reference of the GetDiscoveredDevicesByRange API.

## [Examples](discovery_device_range_info_module.md#id6)
...
## [Return Values](discovery_device_range_info_module.md#id7)
