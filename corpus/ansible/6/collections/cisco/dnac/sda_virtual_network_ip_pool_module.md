...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/sda_virtual_network_ip_pool_module.html
fetched_at: 2026-07-27T16:53:58+00:00
---
...
| **isThisCriticalPool**  boolean  added in cisco.dnac 4.0.0 | Critical pool enablement(applicable for L3 and default value is False ).  Choices:   - `false` - `true` |
