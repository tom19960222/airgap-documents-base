...
collection: ansible
version: "6"
title: "cisco.dnac.task_info module – Information module for Task"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/task_info_module.html
fetched_at: 2026-07-27T16:54:36+00:00
---
...
> see [Requirements](task_info_module.md#ansible-collections-cisco-dnac-task-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.task_info`.

New in cisco.dnac 3.1.0

- [Synopsis](task_info_module.md#synopsis)
- [Requirements](task_info_module.md#requirements)
- [Parameters](task_info_module.md#parameters)
- [Notes](task_info_module.md#notes)
- [See Also](task_info_module.md#see-also)
- [Examples](task_info_module.md#examples)
- [Return Values](task_info_module.md#return-values)

## [Synopsis](task_info_module.md#id1)
...
## [Requirements](task_info_module.md#id2)
...
## [Parameters](task_info_module.md#id3)
...
## [See Also](task_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Task GetTaskById](https://developer.cisco.com/docs/dna-center/#!get-task-by-id)
> :   Complete reference of the GetTaskById API.
>
> [Cisco DNA Center documentation for Task GetTasks](https://developer.cisco.com/docs/dna-center/#!get-tasks)
> :   Complete reference of the GetTasks API.

## [Examples](task_info_module.md#id6)
...
## [Return Values](task_info_module.md#id7)
