...
collection: ansible
version: "6"
title: "cisco.dnac.configuration_template_create module – Resource module for Configuration Template Create"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/configuration_template_create_module.html
fetched_at: 2026-07-27T16:51:16+00:00
---
...
> see [Requirements](configuration_template_create_module.md#ansible-collections-cisco-dnac-configuration-template-create-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.configuration_template_create`.

New in cisco.dnac 3.1.0

- [Synopsis](configuration_template_create_module.md#synopsis)
- [Requirements](configuration_template_create_module.md#requirements)
- [Parameters](configuration_template_create_module.md#parameters)
- [Notes](configuration_template_create_module.md#notes)
- [See Also](configuration_template_create_module.md#see-also)
- [Examples](configuration_template_create_module.md#examples)
- [Return Values](configuration_template_create_module.md#return-values)

## [Synopsis](configuration_template_create_module.md#id1)
...
## [Requirements](configuration_template_create_module.md#id2)
...
## [Parameters](configuration_template_create_module.md#id3)
...
| **deviceTypes**  list / elements=dictionary | Configuration Template Create’s deviceTypes. |
...
## [Notes](configuration_template_create_module.md#id4)
...
## [See Also](configuration_template_create_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Configuration Templates CreateTemplate](https://developer.cisco.com/docs/dna-center/#!create-template)
> :   Complete reference of the CreateTemplate API.

## [Examples](configuration_template_create_module.md#id6)
...
## [Return Values](configuration_template_create_module.md#id7)
