...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/tag_info_module.html
fetched_at: 2026-07-27T16:54:31+00:00
---
...
| Key | Description |
| --- | --- |
| **dnac_response**  dictionary | A dictionary or list with the response returned by the Cisco DNAC Python SDK  Returned: always  Sample: `{"response": {"description": "string", "dynamicRules": [{"memberType": "string", "rules": {"items": [{}], "name": "string", "operation": "string", "value": "string", "values": ["string"]}}], "id": "string", "instanceTenantId": "string", "name": "string", "systemTag": true}, "version": "string"}` |
