...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/dnac/sda_virtual_network_v2_module.html
...
| **isGuestVirtualNetwork**  boolean | To create guest virtual network.  Choices:   - `false` - `true` |
