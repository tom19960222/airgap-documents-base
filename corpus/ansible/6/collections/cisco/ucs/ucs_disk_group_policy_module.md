...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ucs/ucs_disk_group_policy_module.html
fetched_at: 2026-07-27T17:02:43+00:00
---
...
| **role**  string | The role of the disk. This can be one of the following:  normal - Normal  ded-hot-spare - Dedicated Hot Spare  glob-hot-spare - Glob Hot Spare |
| **slot_num**  string | The slot number of the specific disk. |
...
| **strip_size**  string | Virtual drive strip size.  Choices:   - `"present"` - `"absent"`   Default: `"platform-default"` |
