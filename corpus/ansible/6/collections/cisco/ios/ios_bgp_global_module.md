...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ios/ios_bgp_global_module.html
fetched_at: 2026-07-27T16:55:09+00:00
---
...
| **asnotation**  boolean | Change the default asplain notation  asdot notation  Choices:   - `false` - `true` |
...
| **aigp**  boolean | if both paths doesn’t have aigp ignore on bestpath comparision  ignore  Choices:   - `false` - `true` |
