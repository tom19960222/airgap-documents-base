...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ios/ios_l2_interfaces_module.html
...
| **mode**  string | Mode in which interface needs to be configured.  An interface whose trunk encapsulation is “Auto” can not be configured to “trunk” mode.  Choices:   - `"access"` - `"trunk"` |
...
| **commands**  list / elements=string | The set of commands pushed to the remote device  Returned: always  Sample: `["interface GigabitEthernet0/1", "switchport access vlan 20"]` |
