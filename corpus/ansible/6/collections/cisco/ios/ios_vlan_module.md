...
collection: ansible
version: "6"
title: "cisco.ios.ios_vlan module – (deprecated, removed after 2022-06-01) Manage VLANs on IOS network devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/ios/ios_vlan_module.html
fetched_at: 2026-07-27T16:55:32+00:00
---
...
- [DEPRECATED](ios_vlan_module.md#deprecated)
- [Synopsis](ios_vlan_module.md#synopsis)
- [Parameters](ios_vlan_module.md#parameters)
- [Notes](ios_vlan_module.md#notes)
- [Examples](ios_vlan_module.md#examples)
- [Return Values](ios_vlan_module.md#return-values)
- [Status](ios_vlan_module.md#status)

## [DEPRECATED](ios_vlan_module.md#id1)
...
## [Synopsis](ios_vlan_module.md#id2)
...
## [Parameters](ios_vlan_module.md#id3)
...
| **state**  string | State of the VLAN configuration.  Choices:   - `"present"` - `"absent"` - `"active"` - `"suspend"` |
...
## [Examples](ios_vlan_module.md#id5)
...
## [Return Values](ios_vlan_module.md#id6)
...
## [Status](ios_vlan_module.md#id7)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](ios_vlan_module.md#deprecated).
