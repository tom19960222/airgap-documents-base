...
collection: ansible
version: "6"
title: "cisco.aci.aci_fabric_node module – Manage Fabric Node Members (fabric:NodeIdentP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_fabric_node_module.html
fetched_at: 2026-07-27T16:49:45+00:00
---
# cisco.aci.aci_fabric_node module – Manage Fabric Node Members (fabric:NodeIdentP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_node`.

- [Synopsis](aci_fabric_node_module.md#synopsis)
- [Parameters](aci_fabric_node_module.md#parameters)
- [See Also](aci_fabric_node_module.md#see-also)
- [Examples](aci_fabric_node_module.md#examples)
- [Return Values](aci_fabric_node_module.md#return-values)

## [Synopsis](aci_fabric_node_module.md#id1)

- Manage Fabric Node Members on Cisco ACI fabrics.

## [Parameters](aci_fabric_node_module.md#id2)
...
| **description**  aliases: descr  string | Description for the new Fabric Node Member. |
...
| **node_id**  integer | Node ID Number for the new Fabric Node Member. |
...
| **pod_id**  integer | The pod id of the new Fabric Node Member. |
...
| **role**  aliases: role_name  string | Role for the new Fabric Node Member.  Choices:   - `"leaf"` - `"spine"` - `"unspecified"` |
| **serial**  aliases: serial_number  string | Serial Number for the new Fabric Node Member. |
...
| **switch**  aliases: name, switch_name  string | Switch Name for the new Fabric Node Member. |
...
## [See Also](aci_fabric_node_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabric:NodeIdentP**.
>
...
## [Examples](aci_fabric_node_module.md#id4)
...
## [Return Values](aci_fabric_node_module.md#id5)
