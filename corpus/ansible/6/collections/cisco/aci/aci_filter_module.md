...
collection: ansible
version: "6"
title: "cisco.aci.aci_filter module – Manages top level filter objects (vz:Filter)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_filter_module.html
fetched_at: 2026-07-27T16:49:49+00:00
---
# cisco.aci.aci_filter module – Manages top level filter objects (vz:Filter)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_filter`.

- [Synopsis](aci_filter_module.md#synopsis)
- [Parameters](aci_filter_module.md#parameters)
- [Notes](aci_filter_module.md#notes)
- [See Also](aci_filter_module.md#see-also)
- [Examples](aci_filter_module.md#examples)
- [Return Values](aci_filter_module.md#return-values)

## [Synopsis](aci_filter_module.md#id1)

- Manages top level filter objects on Cisco ACI fabrics.
- This modules does not manage filter entries, see [cisco.aci.aci_filter_entry](aci_filter_entry_module.md#ansible-collections-cisco-aci-aci-filter-entry-module) for this functionality.

## [Parameters](aci_filter_module.md#id2)
...
| **description**  aliases: descr  string | Description for the filter. |
| **filter**  aliases: filter_name, name  string | The name of the filter. |
...
## [Notes](aci_filter_module.md#id3)
...
## [See Also](aci_filter_module.md#id4)
...
## [Examples](aci_filter_module.md#id5)
...
## [Return Values](aci_filter_module.md#id6)
