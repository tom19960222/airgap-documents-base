...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_external_epg module – Manage Cloud External EPG (cloud:ExtEPg)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_external_epg_module.html
fetched_at: 2026-07-27T16:49:20+00:00
---
# cisco.aci.aci_cloud_external_epg module – Manage Cloud External EPG (cloud:ExtEPg)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_external_epg`.

- [Synopsis](aci_cloud_external_epg_module.md#synopsis)
- [Parameters](aci_cloud_external_epg_module.md#parameters)
- [Notes](aci_cloud_external_epg_module.md#notes)
- [See Also](aci_cloud_external_epg_module.md#see-also)
- [Examples](aci_cloud_external_epg_module.md#examples)
- [Return Values](aci_cloud_external_epg_module.md#return-values)

## [Synopsis](aci_cloud_external_epg_module.md#id1)

- Configures WAN router connectivity to the cloud infrastructure.

## [Parameters](aci_cloud_external_epg_module.md#id2)
...
| **description**  aliases: descr  string | configuration item description. |
...
| **name**  aliases: cloud_external_epg, cloud_external_epg_name, external_epg, external_epg_name, extepg, extepg_name  string | Name of Object cloud_external_epg. |
...
| **route_reachability**  string | Route reachability for this EPG.  Choices:   - `"inter-site"` - `"internet"` - `"unspecified"` |
...
| **vrf**  aliases: context, vrf_name  string | The name of the VRF. |

## [Notes](aci_cloud_external_epg_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:ExtEPg** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_external_epg_module.md#id4)
...
## [Examples](aci_cloud_external_epg_module.md#id5)
...
## [Return Values](aci_cloud_external_epg_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **current**  list / elements=string | The existing configuration from the APIC after the module has finished  Returned: success  Sample: `[{"fvTenant": {"attributes": {"descr": "Production environment", "dn": "uni/tn-production", "name": "production", "name_alias": "", "ownerKey": "", "ownerTag": ""}}}]` |
...
| **previous**  list / elements=string | The original configuration from the APIC before the module has started  Returned: info  Sample: `[{"fvTenant": {"attributes": {"descr": "Production", "dn": "uni/tn-production", "name": "production", "name_alias": "", "ownerKey": "", "ownerTag": ""}}}]` |
