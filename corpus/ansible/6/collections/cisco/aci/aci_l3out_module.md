...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_module.html
...
| **l3protocol**  list / elements=string | Routing protocol for the L3Out  Choices:   - `"bgp"` - `"eigrp"` - `"ospf"` - `"pim"` - `"static"` |
...
| **route_control**  aliases: route_control_enforcement  list / elements=string | Route Control enforcement direction. The only allowed values are export or import,export.  Choices:   - `"export"` - `"import"` |
