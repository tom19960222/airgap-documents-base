...
collection: ansible
version: "6"
title: "cisco.aci.aci_vmm_uplink_container module – Manage VMM uplink containers (vmm:UplinkPCont)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vmm_uplink_container_module.html
...
- [Synopsis](aci_vmm_uplink_container_module.md#synopsis)
- [Parameters](aci_vmm_uplink_container_module.md#parameters)
- [Notes](aci_vmm_uplink_container_module.md#notes)
- [See Also](aci_vmm_uplink_container_module.md#see-also)
- [Examples](aci_vmm_uplink_container_module.md#examples)
- [Return Values](aci_vmm_uplink_container_module.md#return-values)

## [Synopsis](aci_vmm_uplink_container_module.md#id1)

- Manage VMM Uplink containers on Cisco ACI fabrics.
- Individual uplinks within the container are managed using the [cisco.aci.aci_vmm_uplink](aci_vmm_uplink_module.md#ansible-collections-cisco-aci-aci-vmm-uplink-module) module

## [Parameters](aci_vmm_uplink_container_module.md#id2)
...
| **num_of_uplinks**  integer | Number of uplinks in the container |
...
## [Notes](aci_vmm_uplink_container_module.md#id3)
...
## [See Also](aci_vmm_uplink_container_module.md#id4)
...
## [Examples](aci_vmm_uplink_container_module.md#id5)
...
## [Return Values](aci_vmm_uplink_container_module.md#id6)
