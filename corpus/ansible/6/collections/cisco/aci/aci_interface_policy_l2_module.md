...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_l2 module – Manage Layer 2 interface policies (l2:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_l2_module.html
fetched_at: 2026-07-27T16:49:56+00:00
---
# cisco.aci.aci_interface_policy_l2 module – Manage Layer 2 interface policies (l2:IfPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_l2`.

- [Synopsis](aci_interface_policy_l2_module.md#synopsis)
- [Parameters](aci_interface_policy_l2_module.md#parameters)
- [See Also](aci_interface_policy_l2_module.md#see-also)
- [Examples](aci_interface_policy_l2_module.md#examples)
- [Return Values](aci_interface_policy_l2_module.md#return-values)

## [Synopsis](aci_interface_policy_l2_module.md#id1)

- Manage Layer 2 interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_l2_module.md#id2)
...
| **description**  aliases: descr  string | The description of the Layer 2 interface policy. |
...
| **l2_policy**  aliases: name  string | The name of the Layer 2 interface policy. |
...
| **qinq**  string | Determines if QinQ is disabled or if the port should be considered a core or edge port.  The APIC defaults to `disabled` when unset during creation.  Choices:   - `"core"` - `"disabled"` - `"edge"` |
...
| **vepa**  boolean | Determines if Virtual Ethernet Port Aggregator is disabled or enabled.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
| **vlan_scope**  string | The scope of the VLAN.  The APIC defaults to `global` when unset during creation.  Choices:   - `"global"` - `"portlocal"` |

## [See Also](aci_interface_policy_l2_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **l2:IfPol**.
>
...
## [Examples](aci_interface_policy_l2_module.md#id4)
...
## [Return Values](aci_interface_policy_l2_module.md#id5)
