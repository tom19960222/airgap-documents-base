...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_leaf_profile module – Manage fabric interface policy leaf profiles (infra:AccPortP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_leaf_profile_module.html
fetched_at: 2026-07-27T16:49:58+00:00
---
# cisco.aci.aci_interface_policy_leaf_profile module – Manage fabric interface policy leaf profiles (infra:AccPortP)
...
- [Synopsis](aci_interface_policy_leaf_profile_module.md#synopsis)
- [Parameters](aci_interface_policy_leaf_profile_module.md#parameters)
- [See Also](aci_interface_policy_leaf_profile_module.md#see-also)
- [Examples](aci_interface_policy_leaf_profile_module.md#examples)
- [Return Values](aci_interface_policy_leaf_profile_module.md#return-values)

## [Synopsis](aci_interface_policy_leaf_profile_module.md#id1)

- Manage fabric interface policy leaf profiles on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_leaf_profile_module.md#id2)
...
| **description**  aliases: descr  string | Description for the Fabric access policy leaf interface profile. |
...
| **interface_profile**  aliases: name, leaf_interface_profile_name, leaf_interface_profile, interface_profile_name  string | The name of the Fabric access policy leaf interface profile. |
...
| **type**  string | The type of profile to be created.  Choices:   - `"fex"` - `"leaf"` ← (default) |
...
## [See Also](aci_interface_policy_leaf_profile_module.md#id3)
...
## [Examples](aci_interface_policy_leaf_profile_module.md#id4)
...
## [Return Values](aci_interface_policy_leaf_profile_module.md#id5)
