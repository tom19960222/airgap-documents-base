...
collection: ansible
version: "6"
title: "cisco.aci.aci_ntp_policy module – Manage NTP policies."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_ntp_policy_module.html
fetched_at: 2026-07-27T16:50:21+00:00
---
# cisco.aci.aci_ntp_policy module – Manage NTP policies.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_ntp_policy`.

- [Synopsis](aci_ntp_policy_module.md#synopsis)
- [Parameters](aci_ntp_policy_module.md#parameters)
- [See Also](aci_ntp_policy_module.md#see-also)
- [Examples](aci_ntp_policy_module.md#examples)
- [Return Values](aci_ntp_policy_module.md#return-values)

## [Synopsis](aci_ntp_policy_module.md#id1)

- Manage NTP policy (datetimePol) configuration on Cisco ACI fabrics.

## [Parameters](aci_ntp_policy_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  string | Admin state of the policy  Choices:   - `"disabled"` - `"enabled"` |
| **auth_state**  string | Enable authentication  Choices:   - `"disabled"` - `"enabled"` |
...
| **master_mode**  string | Enable master mode. Only applicable if server_state is enabled  Choices:   - `"disabled"` - `"enabled"` |
| **name**  aliases: ntp_policy  string | Name of the NTP policy |
...
| **server_state**  string | Allow switches to act as NTP servers  Choices:   - `"disabled"` - `"enabled"` |
...
## [See Also](aci_ntp_policy_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **datetimePol**.
>
...
## [Examples](aci_ntp_policy_module.md#id4)
...
## [Return Values](aci_ntp_policy_module.md#id5)
