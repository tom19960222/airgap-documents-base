...
collection: ansible
version: "6"
title: "cisco.aci.aci_esg_tag_selector module – Manage ESG Tag Selectors (fv:TagSelector)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_esg_tag_selector_module.html
fetched_at: 2026-07-27T16:49:43+00:00
---
# cisco.aci.aci_esg_tag_selector module – Manage ESG Tag Selectors (fv:TagSelector)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_esg_tag_selector`.

- [Synopsis](aci_esg_tag_selector_module.md#synopsis)
- [Parameters](aci_esg_tag_selector_module.md#parameters)
- [See Also](aci_esg_tag_selector_module.md#see-also)
- [Examples](aci_esg_tag_selector_module.md#examples)
- [Return Values](aci_esg_tag_selector_module.md#return-values)

## [Synopsis](aci_esg_tag_selector_module.md#id1)

- Manage Endpoint Security Groups Tag Selectors on Cisco ACI fabrics.

## [Parameters](aci_esg_tag_selector_module.md#id2)
...
| **description**  aliases: tag_selector_description  string | Description of the ESG Tag Selector. |
...
| **name**  aliases: match_key  string | ESG Tag Selector Key Name |
| **name_alias**  string | The alias for the current object. This relates to the nameAlias field in ACI. |
| **operator**  aliases: value_operator  string | `equals` is the default operator type of the ESG Tag Selector.  `contains` is used to match values partially.  `regex` allows to pass patterns values.  Choices:   - `"contains"` - `"equals"` - `"regex"` |
...
## [See Also](aci_esg_tag_selector_module.md#id3)
...
## [Examples](aci_esg_tag_selector_module.md#id4)
...
## [Return Values](aci_esg_tag_selector_module.md#id5)
