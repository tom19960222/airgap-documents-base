...
collection: ansible
version: "6"
title: "cisco.aci.aci_aep module – Manage attachable Access Entity Profile (AEP) objects (infra:AttEntityP, infra:ProvAcc)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aep_module.html
fetched_at: 2026-07-27T16:49:07+00:00
---
# cisco.aci.aci_aep module – Manage attachable Access Entity Profile (AEP) objects (infra:AttEntityP, infra:ProvAcc)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aep`.

- [Synopsis](aci_aep_module.md#synopsis)
- [Parameters](aci_aep_module.md#parameters)
- [See Also](aci_aep_module.md#see-also)
- [Examples](aci_aep_module.md#examples)
- [Return Values](aci_aep_module.md#return-values)

## [Synopsis](aci_aep_module.md#id1)

- Connect to external virtual and physical domains by using attachable Access Entity Profiles (AEP) on Cisco ACI fabrics.

## [Parameters](aci_aep_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **aep**  aliases: aep_name, name  string | The name of the Attachable Access Entity Profile. |
...
| **description**  aliases: descr  string | Description for the AEP. |
...
| **infra_vlan**  aliases: infrastructure_vlan  boolean | Enable infrastructure VLAN.  The hypervisor functions of the AEP.  `no` will disable the infrastructure vlan if it is enabled.  Choices:   - `false` - `true` |
...
## [See Also](aci_aep_module.md#id3)
...
## [Examples](aci_aep_module.md#id4)
...
## [Return Values](aci_aep_module.md#id5)
