...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_epg module – Manage Cloud EPG (cloud:EPg)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_epg_module.html
fetched_at: 2026-07-27T16:49:18+00:00
---
# cisco.aci.aci_cloud_epg module – Manage Cloud EPG (cloud:EPg)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_epg`.

- [Synopsis](aci_cloud_epg_module.md#synopsis)
- [Parameters](aci_cloud_epg_module.md#parameters)
- [Notes](aci_cloud_epg_module.md#notes)
- [See Also](aci_cloud_epg_module.md#see-also)
- [Examples](aci_cloud_epg_module.md#examples)
- [Return Values](aci_cloud_epg_module.md#return-values)

## [Synopsis](aci_cloud_epg_module.md#id1)

- Manage Cloud EPG on Cisco Cloud ACI

## [Parameters](aci_cloud_epg_module.md#id2)
...
| **description**  aliases: descr  string | Description of the cloud EPG. |
...
| **name**  aliases: cloud_epg, cloud_epg_name, epg, epg_name  string | The name of the cloud EPG. |
...
## [Notes](aci_cloud_epg_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:EPg** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_epg_module.md#id4)
...
## [Examples](aci_cloud_epg_module.md#id5)
...
## [Return Values](aci_cloud_epg_module.md#id6)
