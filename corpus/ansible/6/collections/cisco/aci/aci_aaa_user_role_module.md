...
collection: ansible
version: "6"
title: "cisco.aci.aci_aaa_user_role module – Manage AAA user role (aaaUserRole) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aaa_user_role_module.html
fetched_at: 2026-07-27T16:49:04+00:00
---
# cisco.aci.aci_aaa_user_role module – Manage AAA user role (aaaUserRole) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_user_role`.

- [Synopsis](aci_aaa_user_role_module.md#synopsis)
- [Parameters](aci_aaa_user_role_module.md#parameters)
- [Notes](aci_aaa_user_role_module.md#notes)
- [See Also](aci_aaa_user_role_module.md#see-also)
- [Examples](aci_aaa_user_role_module.md#examples)
- [Return Values](aci_aaa_user_role_module.md#return-values)

## [Synopsis](aci_aaa_user_role_module.md#id1)

- Manage AAA User Role configuration on Cisco ACI fabrics.

## [Parameters](aci_aaa_user_role_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **aaa_user**  string / required | Name of an existing AAA user |
...
| **domain_name**  string / required | Name of the user domain |
...
| **priv_type**  string | Privilege for the role  Choices:   - `"read"` - `"write"` |
...
| **role_name**  string | Name of the AAA role |
...
## [Notes](aci_aaa_user_role_module.md#id3)

> **Note:**
>
> - The `aaa_user` and `domain_name` must exist before using this module in your playbook. The [cisco.aci.aci_aaa_user](aci_aaa_user_module.md#ansible-collections-cisco-aci-aci-aaa-user-module) and [cisco.aci.aci_aaa_user_domain](aci_aaa_user_domain_module.md#ansible-collections-cisco-aci-aci-aaa-user-domain-module) modules can be used for this.

## [See Also](aci_aaa_user_role_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **aaaUserRole**.
>
...
## [Examples](aci_aaa_user_role_module.md#id5)
...
## [Return Values](aci_aaa_user_role_module.md#id6)
