...
collection: ansible
version: "6"
title: "cisco.aci.aci_contract_export module – Manage contract interfaces (vz:CPIf)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_contract_export_module.html
fetched_at: 2026-07-27T16:49:26+00:00
---
# cisco.aci.aci_contract_export module – Manage contract interfaces (vz:CPIf)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_contract_export`.

- [Synopsis](aci_contract_export_module.md#synopsis)
- [Parameters](aci_contract_export_module.md#parameters)
- [See Also](aci_contract_export_module.md#see-also)
- [Examples](aci_contract_export_module.md#examples)
- [Return Values](aci_contract_export_module.md#return-values)

## [Synopsis](aci_contract_export_module.md#id1)

- Manage Contract interfaces on Cisco ACI fabrics.

## [Parameters](aci_contract_export_module.md#id2)
...
| **contract**  aliases: contract_name  string | The name of the contract to export. |
| **description**  aliases: descr  string | Description for the contract interface. |
...
| **name**  aliases: interface_name  string | The name of the contract interface. |
...
| **tenant**  aliases: tenant_name  string | The name of the tenant hosting the contract to export. |
...
## [See Also](aci_contract_export_module.md#id3)
...
## [Examples](aci_contract_export_module.md#id4)
...
## [Return Values](aci_contract_export_module.md#id5)
