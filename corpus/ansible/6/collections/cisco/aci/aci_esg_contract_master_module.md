...
collection: ansible
version: "6"
title: "cisco.aci.aci_esg_contract_master module – Manage ESG contract master relationships (fv:RsSecInherited)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_esg_contract_master_module.html
fetched_at: 2026-07-27T16:49:41+00:00
---
# cisco.aci.aci_esg_contract_master module – Manage ESG contract master relationships (fv:RsSecInherited)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_esg_contract_master`.

- [Synopsis](aci_esg_contract_master_module.md#synopsis)
- [Parameters](aci_esg_contract_master_module.md#parameters)
- [See Also](aci_esg_contract_master_module.md#see-also)
- [Examples](aci_esg_contract_master_module.md#examples)
- [Return Values](aci_esg_contract_master_module.md#return-values)

## [Synopsis](aci_esg_contract_master_module.md#id1)

- Manage Endpoint Security Groups (ESG) contract master relationships on Cisco ACI fabrics.

## [Parameters](aci_esg_contract_master_module.md#id2)
...
## [See Also](aci_esg_contract_master_module.md#id3)
...
## [Examples](aci_esg_contract_master_module.md#id4)
...
## [Return Values](aci_esg_contract_master_module.md#id5)
