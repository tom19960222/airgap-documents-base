...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_cidr module – Manage CIDR under Cloud Context Profile (cloud:Cidr)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_cidr_module.html
fetched_at: 2026-07-27T16:49:17+00:00
---
# cisco.aci.aci_cloud_cidr module – Manage CIDR under Cloud Context Profile (cloud:Cidr)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_cidr`.

- [Synopsis](aci_cloud_cidr_module.md#synopsis)
- [Parameters](aci_cloud_cidr_module.md#parameters)
- [Notes](aci_cloud_cidr_module.md#notes)
- [See Also](aci_cloud_cidr_module.md#see-also)
- [Examples](aci_cloud_cidr_module.md#examples)
- [Return Values](aci_cloud_cidr_module.md#return-values)

## [Synopsis](aci_cloud_cidr_module.md#id1)

- Manage Cloud CIDR on Cisco Cloud ACI.

## [Parameters](aci_cloud_cidr_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  aliases: cidr  string | CIDR ip and its netmask. |
...
| **cloud_context_profile**  string / required | The name of the Cloud Context Profile. |
...
## [Notes](aci_cloud_cidr_module.md#id3)

> **Note:**
>
> - This module is only used to manage non_primary Cloud CIDR, see [cisco.aci.aci_cloud_ctx_profile](aci_cloud_ctx_profile_module.md#ansible-collections-cisco-aci-aci-cloud-ctx-profile-module) to create the primary CIDR.
> - More information about the internal APIC class **cloud:Cidr** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_cidr_module.md#id4)
...
## [Examples](aci_cloud_cidr_module.md#id5)
...
## [Return Values](aci_cloud_cidr_module.md#id6)
