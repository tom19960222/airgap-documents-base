...
collection: ansible
version: "6"
title: "cisco.aci.aci_vmm_vswitch_policy module – Manage vSwitch policy for VMware virtual domains profiles (vmm:DomP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vmm_vswitch_policy_module.html
fetched_at: 2026-07-27T16:50:42+00:00
---
...
- [Synopsis](aci_vmm_vswitch_policy_module.md#synopsis)
- [Parameters](aci_vmm_vswitch_policy_module.md#parameters)
- [See Also](aci_vmm_vswitch_policy_module.md#see-also)
- [Examples](aci_vmm_vswitch_policy_module.md#examples)
- [Return Values](aci_vmm_vswitch_policy_module.md#return-values)

## [Synopsis](aci_vmm_vswitch_policy_module.md#id1)

- Manage vSwitch policy for VMware VMM domains on Cisco ACI fabrics.

## [Parameters](aci_vmm_vswitch_policy_module.md#id2)
...
| **lacp_mode**  string | LACP port channel mode.  Choices:   - `"active"` - `"passive"` |
| **load_balancing_mode**  string | Load balancing mode of the port channel.  See also <https://pubhub.devnetcloud.com/media/apic-mim-ref-421/docs/MO-lacpEnhancedLagPol.html>.  Choices:   - `"dst-ip"` - `"dst-ip-l4port"` - `"dst-ip-vlan"` - `"dst-ip-l4port-vlan"` - `"dst-mac"` - `"dst-l4port"` - `"src-ip"` - `"src-ip-l4port"` - `"src-ip-vlan"` - `"src-ip-l4port-vlan"` - `"src-mac"` - `"src-l4port"` - `"src-dst-ip"` - `"src-dst-ip-l4port"` - `"src-dst-ip-vlan"` - `"src-dst-ip-l4port-vlan"` - `"src-dst-mac"` - `"src-dst-l4port"` - `"src-port-id"` - `"vlan"` |
...
## [See Also](aci_vmm_vswitch_policy_module.md#id3)
...
## [Examples](aci_vmm_vswitch_policy_module.md#id4)
...
## [Return Values](aci_vmm_vswitch_policy_module.md#id5)
