...
collection: ansible
version: "6"
title: "cisco.aci.aci_encap_pool_range module – Manage encap ranges assigned to pools (fvns:EncapBlk, fvns:VsanEncapBlk)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_encap_pool_range_module.html
fetched_at: 2026-07-27T16:49:35+00:00
---
...
- [Synopsis](aci_encap_pool_range_module.md#synopsis)
- [Parameters](aci_encap_pool_range_module.md#parameters)
- [Notes](aci_encap_pool_range_module.md#notes)
- [See Also](aci_encap_pool_range_module.md#see-also)
- [Examples](aci_encap_pool_range_module.md#examples)
- [Return Values](aci_encap_pool_range_module.md#return-values)

## [Synopsis](aci_encap_pool_range_module.md#id1)

- Manage vlan, vxlan, and vsan ranges that are assigned to pools on Cisco ACI fabrics.

## [Parameters](aci_encap_pool_range_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **allocation_mode**  aliases: mode  string | The method used for allocating encaps to resources.  Only vlan and vsan support allocation modes.  Choices:   - `"dynamic"` - `"inherit"` - `"static"` |
...
| **description**  aliases: descr  string | Description for the pool range. |
...
| **pool**  aliases: pool_name  string | The name of the pool that the range should be assigned to. |
| **pool_allocation_mode**  aliases: pool_mode  string | The method used for allocating encaps to resources.  Only vlan and vsan support allocation modes.  Choices:   - `"dynamic"` - `"static"` |
| **pool_type**  aliases: type  string / required | The encap type of `pool`.  Choices:   - `"vlan"` - `"vxlan"` - `"vsan"` |
...
| **range_end**  aliases: end  integer | The end of encap range. |
| **range_name**  aliases: name, range  string | The name to give to the encap range. |
| **range_start**  aliases: start  integer | The start of the encap range. |
...
## [Notes](aci_encap_pool_range_module.md#id3)

> **Note:**
>
> - The `pool` must exist in order to add or delete a range.

## [See Also](aci_encap_pool_range_module.md#id4)
...
>
> [cisco.aci.aci_vlan_pool_encap_block](aci_vlan_pool_encap_block_module.md#ansible-collections-cisco-aci-aci-vlan-pool-encap-block-module)
...
## [Examples](aci_encap_pool_range_module.md#id5)
...
## [Return Values](aci_encap_pool_range_module.md#id6)
