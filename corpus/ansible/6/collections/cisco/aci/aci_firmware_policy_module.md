...
collection: ansible
version: "6"
title: "cisco.aci.aci_firmware_policy module – This creates a firmware policy"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_firmware_policy_module.html
fetched_at: 2026-07-27T16:49:52+00:00
---
# cisco.aci.aci_firmware_policy module – This creates a firmware policy
...
- [Synopsis](aci_firmware_policy_module.md#synopsis)
- [Parameters](aci_firmware_policy_module.md#parameters)
- [See Also](aci_firmware_policy_module.md#see-also)
- [Examples](aci_firmware_policy_module.md#examples)
- [Return Values](aci_firmware_policy_module.md#return-values)

## [Synopsis](aci_firmware_policy_module.md#id1)
...
## [Parameters](aci_firmware_policy_module.md#id2)
...
| **ignoreCompat**  boolean | Check if compatibility checks should be ignored  Choices:   - `false` - `true` |
| **name**  string | Name of the firmware policy |
...
| **version**  string | The version of the firmware associated with this policy. This value is very import as well as constructing  it correctly. The syntax for this field is n9000-xx.x. If you look at the firmware repository using the UI  each version will have a “Full Version” column, this is the value you need to use. So, if the Full Version  is 13.1(1i), the value for this field would be n9000-13.1(1i) |

## [See Also](aci_firmware_policy_module.md#id3)
...
## [Examples](aci_firmware_policy_module.md#id4)
...
## [Return Values](aci_firmware_policy_module.md#id5)
