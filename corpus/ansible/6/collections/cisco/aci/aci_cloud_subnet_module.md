...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_subnet module – Manage Cloud Subnet (cloud:Subnet)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_subnet_module.html
fetched_at: 2026-07-27T16:49:22+00:00
---
...
- [Synopsis](aci_cloud_subnet_module.md#synopsis)
- [Parameters](aci_cloud_subnet_module.md#parameters)
- [Notes](aci_cloud_subnet_module.md#notes)
- [See Also](aci_cloud_subnet_module.md#see-also)
- [Examples](aci_cloud_subnet_module.md#examples)
- [Return Values](aci_cloud_subnet_module.md#return-values)

## [Synopsis](aci_cloud_subnet_module.md#id1)

- Manage Cloud Subnet on Cisco Cloud ACI.

## [Parameters](aci_cloud_subnet_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  aliases: subnet  string | Ip address of the Cloud Subnet. |
...
| **availability_zone**  string | The cloud zone which is attached to the given cloud context profile.  Only used when it is an aws cloud apic. |
...
| **cidr**  string / required | Address of cloud cidr. |
...
| **vnet_gateway**  boolean | Determine if a vNet Gateway Router will be deployed or not.  Only used when it is an azure cloud apic.  Choices:   - `false` ← (default) - `true` |

## [Notes](aci_cloud_subnet_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:Subnet** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_subnet_module.md#id4)
...
## [Examples](aci_cloud_subnet_module.md#id5)
...
## [Return Values](aci_cloud_subnet_module.md#id6)
