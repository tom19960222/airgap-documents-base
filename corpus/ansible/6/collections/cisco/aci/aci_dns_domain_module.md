...
collection: ansible
version: "6"
title: "cisco.aci.aci_dns_domain module – Manage DNS Provider (dnsDomain) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_dns_domain_module.html
fetched_at: 2026-07-27T16:49:30+00:00
---
# cisco.aci.aci_dns_domain module – Manage DNS Provider (dnsDomain) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_dns_domain`.

- [Synopsis](aci_dns_domain_module.md#synopsis)
- [Parameters](aci_dns_domain_module.md#parameters)
- [Notes](aci_dns_domain_module.md#notes)
- [See Also](aci_dns_domain_module.md#see-also)
- [Examples](aci_dns_domain_module.md#examples)
- [Return Values](aci_dns_domain_module.md#return-values)

## [Synopsis](aci_dns_domain_module.md#id1)

- Manage DNS Domain configuration on Cisco ACI fabrics.

## [Parameters](aci_dns_domain_module.md#id2)
...
| **default**  boolean | Whether this is the default domain  Choices:   - `false` - `true` |
| **dns_profile**  aliases: profile_name  string / required | Name of the DNS profile. |
| **domain**  aliases: name, domain_name  string | DNS domain name |
...
## [Notes](aci_dns_domain_module.md#id3)
...
## [See Also](aci_dns_domain_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **dnsDomain**.
>
...
## [Examples](aci_dns_domain_module.md#id5)
...
## [Return Values](aci_dns_domain_module.md#id6)
