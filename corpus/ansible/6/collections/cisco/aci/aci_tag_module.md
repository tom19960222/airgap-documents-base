...
collection: ansible
version: "6"
title: "cisco.aci.aci_tag module – Tagging of ACI objects"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tag_module.html
fetched_at: 2026-07-27T16:50:33+00:00
---
# cisco.aci.aci_tag module – Tagging of ACI objects
...
- [Synopsis](aci_tag_module.md#synopsis)
- [Parameters](aci_tag_module.md#parameters)
- [Notes](aci_tag_module.md#notes)
- [See Also](aci_tag_module.md#see-also)
- [Examples](aci_tag_module.md#examples)
- [Return Values](aci_tag_module.md#return-values)

## [Synopsis](aci_tag_module.md#id1)

- Tagging a object on Cisco ACI fabric.

## [Parameters](aci_tag_module.md#id2)
...
| **tag_type**  string / required | Type of tag object.  Choices:   - `"annotation"` - `"instance"` - `"tag"` |
...
## [See Also](aci_tag_module.md#id4)

> **See also:**
>
> [Cisco APIC System Management Configuration Guide](https://www.cisco.com/c/en/us/support/cloud-systems-management/application-policy-infrastructure-controller-apic/tsd-products-support-series-home.html)
...
## [Examples](aci_tag_module.md#id5)
...
## [Return Values](aci_tag_module.md#id6)
