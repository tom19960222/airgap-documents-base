...
collection: ansible
version: "6"
title: "cisco.aci.aci_static_binding_to_epg module – Bind static paths to EPGs (fv:RsPathAtt)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_static_binding_to_epg_module.html
fetched_at: 2026-07-27T16:50:26+00:00
---
...
- [Synopsis](aci_static_binding_to_epg_module.md#synopsis)
- [Parameters](aci_static_binding_to_epg_module.md#parameters)
- [Notes](aci_static_binding_to_epg_module.md#notes)
- [See Also](aci_static_binding_to_epg_module.md#see-also)
- [Examples](aci_static_binding_to_epg_module.md#examples)
- [Return Values](aci_static_binding_to_epg_module.md#return-values)

## [Synopsis](aci_static_binding_to_epg_module.md#id1)

- Bind static paths to EPGs on Cisco ACI fabrics.

## [Parameters](aci_static_binding_to_epg_module.md#id2)
...
| **leafs**  aliases: leaves, nodes, paths, switches  list / elements=string | The switch ID(s) that the `interface` belongs to.  When `interface_type` is `switch_port`, `port_channel`, or `fex`, then `leafs` is a string of the leaf ID.  When `interface_type` is `vpc`, then `leafs` is a list with both leaf IDs.  The `leafs` value is usually something like ‘101’ or ‘101-102’ depending on `connection_type`. |
...
| **pod_id**  aliases: pod, pod_number  integer | The pod number part of the tDn.  `pod_id` is usually an integer below `10`. |
...
## [Notes](aci_static_binding_to_epg_module.md#id3)
...
## [See Also](aci_static_binding_to_epg_module.md#id4)
...
## [Examples](aci_static_binding_to_epg_module.md#id5)
...
## [Return Values](aci_static_binding_to_epg_module.md#id6)
