...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant module – Manage tenants (fv:Tenant)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_module.html
fetched_at: 2026-07-27T16:50:34+00:00
---
# cisco.aci.aci_tenant module – Manage tenants (fv:Tenant)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_tenant`.

- [Synopsis](aci_tenant_module.md#synopsis)
- [Parameters](aci_tenant_module.md#parameters)
- [See Also](aci_tenant_module.md#see-also)
- [Examples](aci_tenant_module.md#examples)
- [Return Values](aci_tenant_module.md#return-values)

## [Synopsis](aci_tenant_module.md#id1)

- Manage tenants on Cisco ACI fabrics.

## [Parameters](aci_tenant_module.md#id2)
...
| **tenant**  aliases: name, tenant_name  string | The name of the tenant. |
...
## [See Also](aci_tenant_module.md#id3)
...
## [Examples](aci_tenant_module.md#id4)
...
## [Return Values](aci_tenant_module.md#id5)
