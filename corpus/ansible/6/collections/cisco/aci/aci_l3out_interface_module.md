...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_interface module – Manage Layer 3 Outside (L3Out) interfaces (l3ext:RsPathL3OutAtt)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_interface_module.html
...
- [Synopsis](aci_l3out_interface_module.md#synopsis)
- [Parameters](aci_l3out_interface_module.md#parameters)
- [See Also](aci_l3out_interface_module.md#see-also)
- [Examples](aci_l3out_interface_module.md#examples)
- [Return Values](aci_l3out_interface_module.md#return-values)

## [Synopsis](aci_l3out_interface_module.md#id1)

- Manage L3Out interfaces on Cisco ACI fabrics.

## [Parameters](aci_l3out_interface_module.md#id2)
...
| **interface_type**  string | Type of interface to build.  Choices:   - `"l3-port"` - `"sub-interface"` - `"ext-svi"` |
...
| **mode**  string | Interface mode, only used if instance_type is ext-svi  Choices:   - `"regular"` - `"native"` - `"untagged"` |
...
## [See Also](aci_l3out_interface_module.md#id3)
...
## [Examples](aci_l3out_interface_module.md#id4)
...
## [Return Values](aci_l3out_interface_module.md#id5)
