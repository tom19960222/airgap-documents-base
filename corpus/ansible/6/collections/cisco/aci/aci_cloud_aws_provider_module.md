...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_aws_provider module – Manage Cloud AWS Provider (cloud:AwsProvider)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_aws_provider_module.html
fetched_at: 2026-07-27T16:49:16+00:00
---
# cisco.aci.aci_cloud_aws_provider module – Manage Cloud AWS Provider (cloud:AwsProvider)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_aws_provider`.

- [Synopsis](aci_cloud_aws_provider_module.md#synopsis)
- [Parameters](aci_cloud_aws_provider_module.md#parameters)
- [Notes](aci_cloud_aws_provider_module.md#notes)
- [See Also](aci_cloud_aws_provider_module.md#see-also)
- [Examples](aci_cloud_aws_provider_module.md#examples)
- [Return Values](aci_cloud_aws_provider_module.md#return-values)

## [Synopsis](aci_cloud_aws_provider_module.md#id1)

- Manage AWS provider on Cisco Cloud ACI.

## [Parameters](aci_cloud_aws_provider_module.md#id2)
...
| **is_account_in_org**  boolean | Is Account in Organization.  Choices:   - `false` - `true` |
| **is_trusted**  boolean | Trusted Tenant  Choices:   - `false` - `true` |
...
| **secret_access_key**  string | Cloud Secret Access Key. |
...
## [Notes](aci_cloud_aws_provider_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:AwsProvider** from
> - [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_aws_provider_module.md#id4)
...
## [Examples](aci_cloud_aws_provider_module.md#id5)
...
## [Return Values](aci_cloud_aws_provider_module.md#id6)
