...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_extepg_to_contract module – Bind Contracts to External End Point Groups (EPGs)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_extepg_to_contract_module.html
fetched_at: 2026-07-27T16:50:10+00:00
---
# cisco.aci.aci_l3out_extepg_to_contract module – Bind Contracts to External End Point Groups (EPGs)
...
- [Synopsis](aci_l3out_extepg_to_contract_module.md#synopsis)
- [Parameters](aci_l3out_extepg_to_contract_module.md#parameters)
- [Notes](aci_l3out_extepg_to_contract_module.md#notes)
- [See Also](aci_l3out_extepg_to_contract_module.md#see-also)
- [Examples](aci_l3out_extepg_to_contract_module.md#examples)
- [Return Values](aci_l3out_extepg_to_contract_module.md#return-values)

## [Synopsis](aci_l3out_extepg_to_contract_module.md#id1)

- Bind Contracts to External End Point Groups (EPGs) on ACI fabrics.

## [Parameters](aci_l3out_extepg_to_contract_module.md#id2)
...
| **l3out**  aliases: l3out_name  string | Name of the l3out. |
...
## [Notes](aci_l3out_extepg_to_contract_module.md#id3)

> **Note:**
>
> - The `tenant`, `l3out` and `extepg` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), [cisco.aci.aci_l3out](aci_l3out_module.md#ansible-collections-cisco-aci-aci-l3out-module) and [cisco.aci.aci_l3out_extepg](aci_l3out_extepg_module.md#ansible-collections-cisco-aci-aci-l3out-extepg-module) modules can be used for this.

## [See Also](aci_l3out_extepg_to_contract_module.md#id4)
...
## [Examples](aci_l3out_extepg_to_contract_module.md#id5)
...
## [Return Values](aci_l3out_extepg_to_contract_module.md#id6)
