...
collection: ansible
version: "6"
title: "cisco.aci.aci_esg module – Manage Endpoint Security Groups (ESGs) objects (fv:ESg)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_esg_module.html
fetched_at: 2026-07-27T16:49:40+00:00
---
# cisco.aci.aci_esg module – Manage Endpoint Security Groups (ESGs) objects (fv:ESg)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_esg`.

- [Synopsis](aci_esg_module.md#synopsis)
- [Parameters](aci_esg_module.md#parameters)
- [See Also](aci_esg_module.md#see-also)
- [Examples](aci_esg_module.md#examples)
- [Return Values](aci_esg_module.md#return-values)

## [Synopsis](aci_esg_module.md#id1)

- Manage Endpoint Security Groups (ESGs) on Cisco ACI fabrics.

## [Parameters](aci_esg_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Use `false` to set ‘Admin Up’ on the ESG Admin state and is the default.  Use `true` to set ‘Admin Shut’ on the ESG Admin state  Choices:   - `false` - `true` |
...
| **description**  aliases: descr  string | Endpoint security group description. |
| **esg**  aliases: esg_name, name  string | Name of the Endpoint Security Group. |
...
| **intra_esg_isolation**  string | The default value of Intra ESG Isolation is `unenforced`.  Choices:   - `"enforced"` - `"unenforced"` |
...
| **preferred_group_member**  string | The default value of Preferred Group Member is `exclude`.  Choices:   - `"exclude"` - `"include"` |
...
| **vrf**  aliases: vrf_name  string | Name of the VRF |

## [See Also](aci_esg_module.md#id3)
...
## [Examples](aci_esg_module.md#id4)
...
## [Return Values](aci_esg_module.md#id5)
