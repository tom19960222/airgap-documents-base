...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_port_security module – Manage port security (l2:PortSecurityPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_port_security_module.html
fetched_at: 2026-07-27T16:50:02+00:00
---
# cisco.aci.aci_interface_policy_port_security module – Manage port security (l2:PortSecurityPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_port_security`.

- [Synopsis](aci_interface_policy_port_security_module.md#synopsis)
- [Parameters](aci_interface_policy_port_security_module.md#parameters)
- [See Also](aci_interface_policy_port_security_module.md#see-also)
- [Examples](aci_interface_policy_port_security_module.md#examples)
- [Return Values](aci_interface_policy_port_security_module.md#return-values)

## [Synopsis](aci_interface_policy_port_security_module.md#id1)

- Manage port security on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_port_security_module.md#id2)
...
| **description**  aliases: descr  string | The description for the contract. |
...
| **max_end_points**  integer | Maximum number of end points.  Accepted values range between `0` and `12000`.  The APIC defaults to `0` when unset during creation. |
...
| **port_security**  aliases: name  string | The name of the port security. |
| **port_security_timeout**  integer | The delay time in seconds before MAC learning is re-enabled  Accepted values range between `60` and `3600`  The APIC defaults to `60` when unset during creation |
...
## [See Also](aci_interface_policy_port_security_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **l2:PortSecurityPol**.
>
...
## [Examples](aci_interface_policy_port_security_module.md#id4)
...
## [Return Values](aci_interface_policy_port_security_module.md#id5)
