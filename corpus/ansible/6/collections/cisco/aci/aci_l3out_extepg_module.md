...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_extepg module – Manage External Network Instance Profile (ExtEpg) objects (l3extInstP:instP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_extepg_module.html
fetched_at: 2026-07-27T16:50:09+00:00
---
# cisco.aci.aci_l3out_extepg module – Manage External Network Instance Profile (ExtEpg) objects (l3extInstP:instP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_extepg`.

- [Synopsis](aci_l3out_extepg_module.md#synopsis)
- [Parameters](aci_l3out_extepg_module.md#parameters)
- [Notes](aci_l3out_extepg_module.md#notes)
- [See Also](aci_l3out_extepg_module.md#see-also)
- [Examples](aci_l3out_extepg_module.md#examples)
- [Return Values](aci_l3out_extepg_module.md#return-values)

## [Synopsis](aci_l3out_extepg_module.md#id1)

- Manage External Network Instance Profile (ExtEpg) objects (l3extInstP:instP)

## [Parameters](aci_l3out_extepg_module.md#id2)
...
| **description**  aliases: descr  string | Description for the ExtEpg. |
...
| **extepg**  aliases: extepg_name, name  string | Name of ExtEpg being created. |
...
| **preferred_group**  boolean | Whether ot not the EPG is part of the Preferred Group and can communicate without contracts.  This is very convenient for migration scenarios, or when ACI is used for network automation but not for policy.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
...
## [Notes](aci_l3out_extepg_module.md#id3)
...
## [See Also](aci_l3out_extepg_module.md#id4)
...
## [Examples](aci_l3out_extepg_module.md#id5)
...
## [Return Values](aci_l3out_extepg_module.md#id6)
