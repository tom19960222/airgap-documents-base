...
collection: ansible
version: "6"
title: "cisco.aci.aci_bgp_rr_asn module – Manage BGP Route Reflector ASN."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_bgp_rr_asn_module.html
fetched_at: 2026-07-27T16:49:13+00:00
---
# cisco.aci.aci_bgp_rr_asn module – Manage BGP Route Reflector ASN.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_bgp_rr_asn`.

- [Synopsis](aci_bgp_rr_asn_module.md#synopsis)
- [Parameters](aci_bgp_rr_asn_module.md#parameters)
- [See Also](aci_bgp_rr_asn_module.md#see-also)
- [Examples](aci_bgp_rr_asn_module.md#examples)
- [Return Values](aci_bgp_rr_asn_module.md#return-values)

## [Synopsis](aci_bgp_rr_asn_module.md#id1)
...
## [Parameters](aci_bgp_rr_asn_module.md#id2)
...
| **asn**  integer | BGP Autonomous System Number |
...
## [See Also](aci_bgp_rr_asn_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **bgpAsP**.
>
...
## [Examples](aci_bgp_rr_asn_module.md#id4)
...
## [Return Values](aci_bgp_rr_asn_module.md#id5)
