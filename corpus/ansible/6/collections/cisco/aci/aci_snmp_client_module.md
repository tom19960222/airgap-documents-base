...
collection: ansible
version: "6"
title: "cisco.aci.aci_snmp_client module – Manage SNMP clients ( snmp:ClientP )."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_snmp_client_module.html
fetched_at: 2026-07-27T16:50:23+00:00
---
# cisco.aci.aci_snmp_client module – Manage SNMP clients (<snmp:ClientP>).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_snmp_client`.

- [Synopsis](aci_snmp_client_module.md#synopsis)
- [Parameters](aci_snmp_client_module.md#parameters)
- [See Also](aci_snmp_client_module.md#see-also)
- [Examples](aci_snmp_client_module.md#examples)
- [Return Values](aci_snmp_client_module.md#return-values)

## [Synopsis](aci_snmp_client_module.md#id1)

- Manage SNMP clients

## [Parameters](aci_snmp_client_module.md#id2)
...
| **client_group**  aliases: client_group_name, client_group_profile  string | Name of an existing SNMP client group |
...
## [See Also](aci_snmp_client_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **snmp:ClientP**.
>
...
## [Examples](aci_snmp_client_module.md#id4)
...
## [Return Values](aci_snmp_client_module.md#id5)
