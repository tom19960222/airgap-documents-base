...
collection: ansible
version: "6"
title: "cisco.aci.aci_switch_leaf_selector module – Bind leaf selectors to switch policy leaf profiles (infra:LeafS, infra:NodeBlk, infra:RsAccNodePGrep)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_switch_leaf_selector_module.html
fetched_at: 2026-07-27T16:50:28+00:00
---
# cisco.aci.aci_switch_leaf_selector module – Bind leaf selectors to switch policy leaf profiles (infra:LeafS, infra:NodeBlk, infra:RsAccNodePGrep)
...
- [Synopsis](aci_switch_leaf_selector_module.md#synopsis)
- [Parameters](aci_switch_leaf_selector_module.md#parameters)
- [Notes](aci_switch_leaf_selector_module.md#notes)
- [See Also](aci_switch_leaf_selector_module.md#see-also)
- [Examples](aci_switch_leaf_selector_module.md#examples)
- [Return Values](aci_switch_leaf_selector_module.md#return-values)

## [Synopsis](aci_switch_leaf_selector_module.md#id2)

- Bind leaf selectors (with node block range and policy group) to switch policy leaf profiles on Cisco ACI fabrics.

## [Parameters](aci_switch_leaf_selector_module.md#id3)
...
| **from**  aliases: node_blk_range_from, from_range, range_from  integer | Start of Node Block range. |
...
| **leaf**  aliases: name, leaf_name, leaf_profile_leaf_name, leaf_selector_name  string | Name of Leaf Selector. |
| **leaf_node_blk**  aliases: leaf_node_blk_name, node_blk_name  string | Name of Node Block range to be added to Leaf Selector of given Leaf Profile. |
...
| **policy_group**  aliases: name, policy_group_name  string | Name of the Policy Group to be added to Leaf Selector of given Leaf Profile. |
...
| **to**  aliases: node_blk_range_to, to_range, range_to  integer | Start of Node Block range. |
...
## [Notes](aci_switch_leaf_selector_module.md#id4)

> **Note:**
>
> - This module is to be used with [cisco.aci.aci_switch_policy_leaf_profile](aci_switch_policy_leaf_profile_module.md#ansible-collections-cisco-aci-aci-switch-policy-leaf-profile-module). One first creates a leaf profile (infra:NodeP) and then creates an associated selector (infra:LeafS),

## [See Also](aci_switch_leaf_selector_module.md#id5)
...
## [Examples](aci_switch_leaf_selector_module.md#id6)
...
## [Return Values](aci_switch_leaf_selector_module.md#id7)
