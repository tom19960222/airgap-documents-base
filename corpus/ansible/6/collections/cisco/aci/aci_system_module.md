...
collection: ansible
version: "6"
title: "cisco.aci.aci_system module – Query the ACI system information (top:System)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_system_module.html
fetched_at: 2026-07-27T16:50:32+00:00
---
# cisco.aci.aci_system module – Query the ACI system information (top:System)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_system`.

- [Synopsis](aci_system_module.md#synopsis)
- [Parameters](aci_system_module.md#parameters)
- [Notes](aci_system_module.md#notes)
- [See Also](aci_system_module.md#see-also)
- [Examples](aci_system_module.md#examples)
- [Return Values](aci_system_module.md#return-values)

## [Synopsis](aci_system_module.md#id1)

- Query the ACI system information (top:System) on Cisco ACI.

## [Parameters](aci_system_module.md#id2)
...
| **id**  aliases: controller, node  integer | The controller node ID |
...
## [Notes](aci_system_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **top:System** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).
> - This module is used to query system information for both cloud and on-premises controllers.

## [See Also](aci_system_module.md#id4)
...
## [Examples](aci_system_module.md#id5)
...
## [Return Values](aci_system_module.md#id6)
