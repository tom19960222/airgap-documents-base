...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_static_routes_module.html
fetched_at: 2026-07-27T16:50:17+00:00
---
...
| **bfd**  string | Determines if bfd is required for route control.  The APIC defaults to `None` when unset during creation.  Choices:   - `"bfd"` - `"None"` |
