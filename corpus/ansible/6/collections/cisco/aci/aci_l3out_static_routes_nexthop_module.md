...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_static_routes_nexthop module – Manage nexthops for static routes (ip:NexthopP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_static_routes_nexthop_module.html
fetched_at: 2026-07-27T16:50:17+00:00
---
# cisco.aci.aci_l3out_static_routes_nexthop module – Manage nexthops for static routes (ip:NexthopP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_static_routes_nexthop`.

- [Synopsis](aci_l3out_static_routes_nexthop_module.md#synopsis)
- [Parameters](aci_l3out_static_routes_nexthop_module.md#parameters)
- [See Also](aci_l3out_static_routes_nexthop_module.md#see-also)
- [Examples](aci_l3out_static_routes_nexthop_module.md#examples)
- [Return Values](aci_l3out_static_routes_nexthop_module.md#return-values)

## [Synopsis](aci_l3out_static_routes_nexthop_module.md#id1)

- Manage nexthops for static routes.

## [Parameters](aci_l3out_static_routes_nexthop_module.md#id2)
...
| **prefix**  aliases: route  string | The IP prefix |
...
## [See Also](aci_l3out_static_routes_nexthop_module.md#id3)
...
>
> aci_l3out_logical_node_profile_to_node
> :   The official documentation on the **aci_l3out_logical_node_profile_to_node** module.
>
> aci_l3out_static_routes
> :   The official documentation on the **aci_l3out_static_routes** module.
>
...
## [Examples](aci_l3out_static_routes_nexthop_module.md#id4)
...
## [Return Values](aci_l3out_static_routes_nexthop_module.md#id5)
