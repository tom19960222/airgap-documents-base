...
collection: ansible
version: "6"
title: "cisco.aci.aci_vrf module – Manage contexts or VRFs (fv:Ctx)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vrf_module.html
fetched_at: 2026-07-27T16:50:43+00:00
---
# cisco.aci.aci_vrf module – Manage contexts or VRFs (fv:Ctx)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_vrf`.

- [Synopsis](aci_vrf_module.md#synopsis)
- [Parameters](aci_vrf_module.md#parameters)
- [Notes](aci_vrf_module.md#notes)
- [See Also](aci_vrf_module.md#see-also)
- [Examples](aci_vrf_module.md#examples)
- [Return Values](aci_vrf_module.md#return-values)

## [Synopsis](aci_vrf_module.md#id1)

- Manage contexts or VRFs on Cisco ACI fabrics.
- Each context is a private network associated to a tenant, i.e. VRF.
- Enable Preferred Groups for VRF

## [Parameters](aci_vrf_module.md#id2)
...
| **description**  aliases: descr  string | The description for the VRF. |
...
| **match_type**  string | Configures match type for contracts under vzAny  Choices:   - `"all"` - `"at_least_one"` - `"at_most_one"` - `"none"` |
...
| **policy_control_direction**  string | Determines if the policy should be enforced by the fabric on ingress or egress.  Choices:   - `"egress"` - `"ingress"` |
| **policy_control_preference**  string | Determines if the fabric should enforce contract policies to allow routing and packet forwarding.  Choices:   - `"enforced"` - `"unenforced"` |
...
| **preferred_group**  string | Enables preferred groups for the VRF under vzAny  Choices:   - `"enabled"` - `"disabled"` |
...
| **tenant**  aliases: tenant_name  string | The name of the Tenant the VRF should belong to. |
...
| **vrf**  aliases: context, name, vrf_name  string | The name of the VRF. |

## [Notes](aci_vrf_module.md#id3)
...
## [See Also](aci_vrf_module.md#id4)
...
## [Examples](aci_vrf_module.md#id5)
...
## [Return Values](aci_vrf_module.md#id6)
