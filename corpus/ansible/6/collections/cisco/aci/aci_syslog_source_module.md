...
collection: ansible
version: "6"
title: "cisco.aci.aci_syslog_source module – Manage Syslog Source objects (syslog:Src)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_syslog_source_module.html
fetched_at: 2026-07-27T16:50:31+00:00
---
# cisco.aci.aci_syslog_source module – Manage Syslog Source objects (syslog:Src)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_syslog_source`.

- [Synopsis](aci_syslog_source_module.md#synopsis)
- [Parameters](aci_syslog_source_module.md#parameters)
- [See Also](aci_syslog_source_module.md#see-also)
- [Examples](aci_syslog_source_module.md#examples)
- [Return Values](aci_syslog_source_module.md#return-values)

## [Synopsis](aci_syslog_source_module.md#id1)

- Manage Syslog Source objects

## [Parameters](aci_syslog_source_module.md#id2)
...
| **include**  list / elements=string | List of message types to include  Choices:   - `"audit"` - `"events"` - `"faults"` - `"session"` |
| **min_severity**  string | Minimum Severity of message to include  Choices:   - `"alerts"` - `"critical"` - `"debugging"` - `"emergencies"` - `"errors"` - `"information"` - `"notifications"` - `"warnings"` |
| **name**  aliases: syslog_src, syslog_source  string | Name of the Syslog Source policy |
...
## [See Also](aci_syslog_source_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **syslog:Src**.
>
...
## [Examples](aci_syslog_source_module.md#id4)
...
## [Return Values](aci_syslog_source_module.md#id5)
