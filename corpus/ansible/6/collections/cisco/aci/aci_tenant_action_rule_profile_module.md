...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant_action_rule_profile module – Manage action rule profiles (rtctrl:AttrP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_action_rule_profile_module.html
...
- [Synopsis](aci_tenant_action_rule_profile_module.md#synopsis)
- [Parameters](aci_tenant_action_rule_profile_module.md#parameters)
- [Notes](aci_tenant_action_rule_profile_module.md#notes)
- [See Also](aci_tenant_action_rule_profile_module.md#see-also)
- [Examples](aci_tenant_action_rule_profile_module.md#examples)
- [Return Values](aci_tenant_action_rule_profile_module.md#return-values)

## [Synopsis](aci_tenant_action_rule_profile_module.md#id1)

- Manage action rule profiles on Cisco ACI fabrics.

## [Parameters](aci_tenant_action_rule_profile_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **action_rule**  aliases: action_rule_name, name  string | The name of the action rule profile. |
...
| **description**  aliases: descr  string | The description for the action rule profile. |
...
## [Notes](aci_tenant_action_rule_profile_module.md#id3)
...
## [See Also](aci_tenant_action_rule_profile_module.md#id4)
...
## [Examples](aci_tenant_action_rule_profile_module.md#id5)
...
## [Return Values](aci_tenant_action_rule_profile_module.md#id6)
