...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_logical_interface_profile module – Manage Layer 3 Outside (L3Out) logical interface profiles (l3ext:LIfP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_logical_interface_profile_module.html
fetched_at: 2026-07-27T16:50:13+00:00
---
# cisco.aci.aci_l3out_logical_interface_profile module – Manage Layer 3 Outside (L3Out) logical interface profiles (l3ext:LIfP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_logical_interface_profile`.

- [Synopsis](aci_l3out_logical_interface_profile_module.md#synopsis)
- [Parameters](aci_l3out_logical_interface_profile_module.md#parameters)
- [See Also](aci_l3out_logical_interface_profile_module.md#see-also)
- [Examples](aci_l3out_logical_interface_profile_module.md#examples)
- [Return Values](aci_l3out_logical_interface_profile_module.md#return-values)

## [Synopsis](aci_l3out_logical_interface_profile_module.md#id1)

- Manage L3Out interface profiles on Cisco ACI fabrics.

## [Parameters](aci_l3out_logical_interface_profile_module.md#id2)
...
| **egress_dpp_policy**  string | Name of the egress data plane policing policy. |
...
| **ingress_dpp_policy**  string | Name of the ingress data plane policing policy. |
...
| **nd_policy**  string | Name of the neighbor discovery interface policy. |
...
## [See Also](aci_l3out_logical_interface_profile_module.md#id3)
...
## [Examples](aci_l3out_logical_interface_profile_module.md#id4)
...
## [Return Values](aci_l3out_logical_interface_profile_module.md#id5)
