...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_logical_node_profile module – Manage Layer 3 Outside (L3Out) logical node profiles (l3extLNodeP:lnodep)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_logical_node_profile_module.html
fetched_at: 2026-07-27T16:50:15+00:00
---
# cisco.aci.aci_l3out_logical_node_profile module – Manage Layer 3 Outside (L3Out) logical node profiles (l3extLNodeP:lnodep)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_logical_node_profile`.

- [Synopsis](aci_l3out_logical_node_profile_module.md#synopsis)
- [Parameters](aci_l3out_logical_node_profile_module.md#parameters)
- [See Also](aci_l3out_logical_node_profile_module.md#see-also)
- [Examples](aci_l3out_logical_node_profile_module.md#examples)
- [Return Values](aci_l3out_logical_node_profile_module.md#return-values)

## [Synopsis](aci_l3out_logical_node_profile_module.md#id1)

- Manage Layer 3 Outside (L3Out) logical node profiles on Cisco ACI fabrics.

## [Parameters](aci_l3out_logical_node_profile_module.md#id2)
...
| **description**  aliases: descr  string | Description for the node profile. |
| **dscp**  aliases: target_dscp  string | The target Differentiated Service (DSCP) value.  The APIC defaults to `unspecified` when unset during creation.  Choices:   - `"AF11"` - `"AF12"` - `"AF13"` - `"AF21"` - `"AF22"` - `"AF23"` - `"AF31"` - `"AF32"` - `"AF33"` - `"AF41"` - `"AF42"` - `"AF43"` - `"CS0"` - `"CS1"` - `"CS2"` - `"CS3"` - `"CS4"` - `"CS5"` - `"CS6"` - `"CS7"` - `"EF"` - `"VA"` - `"unspecified"` |
...
| **node_profile**  aliases: node_profile_name, name, logical_node  string | Name of the node profile. |
...
## [See Also](aci_l3out_logical_node_profile_module.md#id3)
...
## [Examples](aci_l3out_logical_node_profile_module.md#id4)
...
## [Return Values](aci_l3out_logical_node_profile_module.md#id5)
