...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_ctx_profile module – Manage Cloud Context Profile (cloud:CtxProfile)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_ctx_profile_module.html
fetched_at: 2026-07-27T16:49:18+00:00
---
# cisco.aci.aci_cloud_ctx_profile module – Manage Cloud Context Profile (cloud:CtxProfile)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_ctx_profile`.

- [Synopsis](aci_cloud_ctx_profile_module.md#synopsis)
- [Parameters](aci_cloud_ctx_profile_module.md#parameters)
- [Notes](aci_cloud_ctx_profile_module.md#notes)
- [See Also](aci_cloud_ctx_profile_module.md#see-also)
- [Examples](aci_cloud_ctx_profile_module.md#examples)
- [Return Values](aci_cloud_ctx_profile_module.md#return-values)

## [Synopsis](aci_cloud_ctx_profile_module.md#id1)

- Manage the Cloud Context Profile objects on Cisco Cloud ACI.

## [Parameters](aci_cloud_ctx_profile_module.md#id2)
...
| **cloud**  string | The cloud vendor in which the controller runs.  Choices:   - `"aws"` - `"azure"` |
...
| **name**  aliases: cloud_context_profile  string | The name of the Cloud Context Profile |
...
## [Notes](aci_cloud_ctx_profile_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:CtxProfile** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_ctx_profile_module.md#id4)
...
## [Examples](aci_cloud_ctx_profile_module.md#id5)
...
## [Return Values](aci_cloud_ctx_profile_module.md#id6)
