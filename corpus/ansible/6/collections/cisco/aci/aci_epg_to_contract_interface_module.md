...
collection: ansible
version: "6"
title: "cisco.aci.aci_epg_to_contract_interface module – Bind EPGs to Consumed Contracts Interface (fv:RsConsIf)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_epg_to_contract_interface_module.html
fetched_at: 2026-07-27T16:49:38+00:00
---
...
- [Synopsis](aci_epg_to_contract_interface_module.md#synopsis)
- [Parameters](aci_epg_to_contract_interface_module.md#parameters)
- [Notes](aci_epg_to_contract_interface_module.md#notes)
- [See Also](aci_epg_to_contract_interface_module.md#see-also)
- [Examples](aci_epg_to_contract_interface_module.md#examples)
- [Return Values](aci_epg_to_contract_interface_module.md#return-values)

## [Synopsis](aci_epg_to_contract_interface_module.md#id1)

- Bind EPGs to Consumed Contracts Interface on Cisco ACI fabrics.

## [Parameters](aci_epg_to_contract_interface_module.md#id2)
...
| **ap**  aliases: app_profile, app_profile_name  string | Name of an existing application profile, that will contain the EPGs. |
...
| **contract_interface**  aliases: contract_interface_name  string | Name of the Contract interface, which is the contract with a “Global” scope which is exported to the tenant. |
...
| **priority**  string | QoS class.  The default value of QoS is `unspecified` during the creation.  Choices:   - `"level1"` - `"level2"` - `"level3"` - `"level4"` - `"level5"` - `"level6"` - `"unspecified"` |
...
>
> [cisco.aci.aci_contract_export](aci_contract_export_module.md#ansible-collections-cisco-aci-aci-contract-export-module)
...
## [Examples](aci_epg_to_contract_interface_module.md#id5)
...
## [Return Values](aci_epg_to_contract_interface_module.md#id6)
