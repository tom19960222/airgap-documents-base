...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_port_channel module – Manage port channel interface policies (lacp:LagPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_port_channel_module.html
fetched_at: 2026-07-27T16:50:02+00:00
---
# cisco.aci.aci_interface_policy_port_channel module – Manage port channel interface policies (lacp:LagPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_port_channel`.

- [Synopsis](aci_interface_policy_port_channel_module.md#synopsis)
- [Parameters](aci_interface_policy_port_channel_module.md#parameters)
- [See Also](aci_interface_policy_port_channel_module.md#see-also)
- [Examples](aci_interface_policy_port_channel_module.md#examples)
- [Return Values](aci_interface_policy_port_channel_module.md#return-values)

## [Synopsis](aci_interface_policy_port_channel_module.md#id1)

- Manage port channel interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_port_channel_module.md#id2)
...
| **description**  aliases: descr  string | The description for the port channel. |
| **fast_select**  boolean | Determines if Fast Select is enabled for Hot Standby Ports.  This makes up the LACP Policy Control Policy; if one setting is defined, then all other Control Properties left undefined or set to false will not exist after the task is ran.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
| **graceful_convergence**  boolean | Determines if Graceful Convergence is enabled.  This makes up the LACP Policy Control Policy; if one setting is defined, then all other Control Properties left undefined or set to false will not exist after the task is ran.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
| **load_defer**  boolean | Determines if Load Defer is enabled.  This makes up the LACP Policy Control Policy; if one setting is defined, then all other Control Properties left undefined or set to false will not exist after the task is ran.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
...
| **mode**  string | Port channel interface policy mode.  Determines the LACP method to use for forming port-channels.  The APIC defaults to `off` when unset during creation.  Choices:   - `"active"` - `"mac-pin"` - `"mac-pin-nicload"` - `"off"` - `"passive"` |
...
| **port_channel**  aliases: name  string | Name of the port channel. |
...
| **suspend_individual**  boolean | Determines if Suspend Individual is enabled.  This makes up the LACP Policy Control Policy; if one setting is defined, then all other Control Properties left undefined or set to false will not exist after the task is ran.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
| **symmetric_hash**  boolean | Determines if Symmetric Hashing is enabled.  This makes up the LACP Policy Control Policy; if one setting is defined, then all other Control Properties left undefined or set to false will not exist after the task is ran.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
...
## [See Also](aci_interface_policy_port_channel_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **lacp:LagPol**.
>
...
## [Examples](aci_interface_policy_port_channel_module.md#id4)
...
## [Return Values](aci_interface_policy_port_channel_module.md#id5)
