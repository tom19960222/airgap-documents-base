...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_ospf_module.html
fetched_at: 2026-07-27T16:50:01+00:00
---
...
| **description**  aliases: descr  string | The description for the OSPF interface. |
...
| **network_type**  string | The OSPF interface policy network type.  OSPF supports broadcast and point-to-point.  The APIC defaults to `unspecified` when unset during creation.  Choices:   - `"bcast"` - `"p2p"` |
...
| **prefix_suppression**  boolean | Whether prefix suppressions is enabled or disabled.  The APIC defaults to `inherit` when unset during creation.  Choices:   - `false` - `true` |
