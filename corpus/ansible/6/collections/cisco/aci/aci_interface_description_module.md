...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_description module – Setting and removing description on physical interfaces."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_description_module.html
fetched_at: 2026-07-27T16:49:54+00:00
---
# cisco.aci.aci_interface_description module – Setting and removing description on physical interfaces.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_description`.

- [Synopsis](aci_interface_description_module.md#synopsis)
- [Parameters](aci_interface_description_module.md#parameters)
- [See Also](aci_interface_description_module.md#see-also)
- [Examples](aci_interface_description_module.md#examples)
- [Return Values](aci_interface_description_module.md#return-values)

## [Synopsis](aci_interface_description_module.md#id1)

- Setting and removing description on physical interfaces on Cisco ACI fabrics.

## [Parameters](aci_interface_description_module.md#id2)
...
| **fex_id**  integer | The fex ID that the `interface` belongs to.  The `fex_id` value is usually something like ‘123’. |
...
| **node_id**  aliases: leaf, spine, node  integer | The switch ID that the `interface` belongs to.  The `node_id` value is usually something like ‘101’. |
| **node_type**  string | The type of node the `interface` is configured on.  Choices:   - `"leaf"` - `"spine"` |
...
| **pod_id**  aliases: pod, pod_number  integer | The pod number.  `pod_id` is usually an integer below `12` |
...
## [See Also](aci_interface_description_module.md#id3)
...
## [Examples](aci_interface_description_module.md#id4)
...
## [Return Values](aci_interface_description_module.md#id5)
