...
collection: ansible
version: "6"
title: "cisco.aci.aci_fabric_leaf_profile module – Manage fabric leaf profiles (fabric:LeafP)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_fabric_leaf_profile_module.html
fetched_at: 2026-07-27T16:49:43+00:00
---
# cisco.aci.aci_fabric_leaf_profile module – Manage fabric leaf profiles (fabric:LeafP).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_leaf_profile`.

- [Synopsis](aci_fabric_leaf_profile_module.md#synopsis)
- [Parameters](aci_fabric_leaf_profile_module.md#parameters)
- [See Also](aci_fabric_leaf_profile_module.md#see-also)
- [Examples](aci_fabric_leaf_profile_module.md#examples)
- [Return Values](aci_fabric_leaf_profile_module.md#return-values)

## [Synopsis](aci_fabric_leaf_profile_module.md#id1)

- Manage fabric leaf switch profiles in an ACI fabric.

## [Parameters](aci_fabric_leaf_profile_module.md#id2)
...
| **name**  aliases: leaf_profile, leaf_switch_profile  string | Name of the fabric leaf switch profile |
...
## [See Also](aci_fabric_leaf_profile_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabricLeafP**.
>
...
## [Examples](aci_fabric_leaf_profile_module.md#id4)
...
## [Return Values](aci_fabric_leaf_profile_module.md#id5)
