...
collection: ansible
version: "6"
title: "cisco.aci.aci_bgp_rr_node module – Manage BGP Route Reflector objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_bgp_rr_node_module.html
fetched_at: 2026-07-27T16:49:13+00:00
---
# cisco.aci.aci_bgp_rr_node module – Manage BGP Route Reflector objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_bgp_rr_node`.

- [Synopsis](aci_bgp_rr_node_module.md#synopsis)
- [Parameters](aci_bgp_rr_node_module.md#parameters)
- [See Also](aci_bgp_rr_node_module.md#see-also)
- [Examples](aci_bgp_rr_node_module.md#examples)
- [Return Values](aci_bgp_rr_node_module.md#return-values)

## [Synopsis](aci_bgp_rr_node_module.md#id1)

- Manage ACI BGP Route Reflector Nodes (bgpRRNodePEp).

## [Parameters](aci_bgp_rr_node_module.md#id2)
...
| **node_id**  integer | ID of the Route Reflector Node |
...
| **pod_id**  integer | Pod the node belongs to |
...
## [See Also](aci_bgp_rr_node_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **bgpRRNodePEp**.
>
...
## [Examples](aci_bgp_rr_node_module.md#id4)
...
## [Return Values](aci_bgp_rr_node_module.md#id5)
