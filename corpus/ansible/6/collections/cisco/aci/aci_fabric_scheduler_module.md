...
collection: ansible
version: "6"
title: "cisco.aci.aci_fabric_scheduler module – This modules creates ACI schedulers."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_fabric_scheduler_module.html
fetched_at: 2026-07-27T16:49:46+00:00
---
# cisco.aci.aci_fabric_scheduler module – This modules creates ACI schedulers.
...
- [Synopsis](aci_fabric_scheduler_module.md#synopsis)
- [Parameters](aci_fabric_scheduler_module.md#parameters)
- [See Also](aci_fabric_scheduler_module.md#see-also)
- [Examples](aci_fabric_scheduler_module.md#examples)
- [Return Values](aci_fabric_scheduler_module.md#return-values)

## [Synopsis](aci_fabric_scheduler_module.md#id1)

- With the module you can create schedule policies that can be a shell, onetime execution or recurring

## [Parameters](aci_fabric_scheduler_module.md#id2)
...
| **date**  string | This is the date and time that the scheduler will execute |
| **day**  string | This sets the day when execution will take place  Choices:   - `"Monday"` - `"Tuesday"` - `"Wednesday"` - `"Thursday"` - `"Friday"` - `"Saturday"` - `"Sunday"` - `"even-day"` - `"odd-day"` - `"every-day"` ← (default) |
| **description**  aliases: descr  string | Description for the Scheduler. |
...
| **hour**  integer | This set the hour of execution |
| **maxTime**  string | This is the amount MAX amount of time a process can be executed |
| **minute**  integer | This sets the minute of execution, used in conjunction with hour |
| **name**  aliases: scheduler_name  string | The name of the Scheduler. |
...
| **recurring**  boolean | If you want to make the Scheduler a recurring it would be a “True” and for a oneTime execution it would be “False”. For a shell just exclude this option from the task  Choices:   - `false` - `true` |
...
| **windowname**  string | This is the name for your what recurring or oneTime execution |

## [See Also](aci_fabric_scheduler_module.md#id3)
...
## [Examples](aci_fabric_scheduler_module.md#id4)
...
## [Return Values](aci_fabric_scheduler_module.md#id5)
