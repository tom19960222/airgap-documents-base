...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_leaf_breakout_port_group module – Manage fabric interface policy leaf breakout port group (infra:BrkoutPortGrp)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_leaf_breakout_port_group_module.html
fetched_at: 2026-07-27T16:49:57+00:00
---
# cisco.aci.aci_interface_policy_leaf_breakout_port_group module – Manage fabric interface policy leaf breakout port group (infra:BrkoutPortGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_leaf_breakout_port_group`.

- [Synopsis](aci_interface_policy_leaf_breakout_port_group_module.md#synopsis)
- [Parameters](aci_interface_policy_leaf_breakout_port_group_module.md#parameters)
- [See Also](aci_interface_policy_leaf_breakout_port_group_module.md#see-also)
- [Examples](aci_interface_policy_leaf_breakout_port_group_module.md#examples)
- [Return Values](aci_interface_policy_leaf_breakout_port_group_module.md#return-values)

## [Synopsis](aci_interface_policy_leaf_breakout_port_group_module.md#id1)

- Manage fabric interface policy leaf breakout port group on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_leaf_breakout_port_group_module.md#id2)
...
| **breakout_port_group**  aliases: name  string | Name of the leaf breakout port group to be added/deleted. |
...
| **description**  aliases: descr  string | Description for the leaf breakout port group to be created. |
...
## [See Also](aci_interface_policy_leaf_breakout_port_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **infra:BrkoutPortGrp**.
>
...
## [Examples](aci_interface_policy_leaf_breakout_port_group_module.md#id4)
...
## [Return Values](aci_interface_policy_leaf_breakout_port_group_module.md#id5)
