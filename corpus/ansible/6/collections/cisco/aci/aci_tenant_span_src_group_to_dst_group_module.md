...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant_span_src_group_to_dst_group module – Bind SPAN source groups to destination groups (span:SpanLbl)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_span_src_group_to_dst_group_module.html
fetched_at: 2026-07-27T16:50:37+00:00
---
# cisco.aci.aci_tenant_span_src_group_to_dst_group module – Bind SPAN source groups to destination groups (span:SpanLbl)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_tenant_span_src_group_to_dst_group`.

- [Synopsis](aci_tenant_span_src_group_to_dst_group_module.md#synopsis)
- [Parameters](aci_tenant_span_src_group_to_dst_group_module.md#parameters)
- [Notes](aci_tenant_span_src_group_to_dst_group_module.md#notes)
- [See Also](aci_tenant_span_src_group_to_dst_group_module.md#see-also)
- [Examples](aci_tenant_span_src_group_to_dst_group_module.md#examples)
- [Return Values](aci_tenant_span_src_group_to_dst_group_module.md#return-values)

## [Synopsis](aci_tenant_span_src_group_to_dst_group_module.md#id1)

- Bind SPAN source groups to associated destination groups on Cisco ACI fabrics.

## [Parameters](aci_tenant_span_src_group_to_dst_group_module.md#id2)
...
| **description**  aliases: descr  string | The description for Span source group to destination group binding. |
...
## [Notes](aci_tenant_span_src_group_to_dst_group_module.md#id3)

> **Note:**
>
> - The `tenant`, `src_group`, and `dst_group` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), [cisco.aci.aci_tenant_span_src_group](aci_tenant_span_src_group_module.md#ansible-collections-cisco-aci-aci-tenant-span-src-group-module), and [cisco.aci.aci_tenant_span_dst_group](aci_tenant_span_dst_group_module.md#ansible-collections-cisco-aci-aci-tenant-span-dst-group-module) modules can be used for this.

## [See Also](aci_tenant_span_src_group_to_dst_group_module.md#id4)
...
>
> [cisco.aci.aci_tenant_span_src_group](aci_tenant_span_src_group_module.md#ansible-collections-cisco-aci-aci-tenant-span-src-group-module)
> :   Manage SPAN source groups (span:SrcGrp).
>
> [cisco.aci.aci_tenant_span_dst_group](aci_tenant_span_dst_group_module.md#ansible-collections-cisco-aci-aci-tenant-span-dst-group-module)
...
## [Examples](aci_tenant_span_src_group_to_dst_group_module.md#id5)
...
## [Return Values](aci_tenant_span_src_group_to_dst_group_module.md#id6)
