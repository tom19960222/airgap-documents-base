...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_logical_interface_profile_ospf_policy module – Manage Layer 3 Outside (L3Out) logical interface profile (l3ext:LIfP) OSPF policy (ospfIfP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_logical_interface_profile_ospf_policy_module.html
fetched_at: 2026-07-27T16:50:13+00:00
---
...
- [Synopsis](aci_l3out_logical_interface_profile_ospf_policy_module.md#synopsis)
- [Parameters](aci_l3out_logical_interface_profile_ospf_policy_module.md#parameters)
- [See Also](aci_l3out_logical_interface_profile_ospf_policy_module.md#see-also)
- [Examples](aci_l3out_logical_interface_profile_ospf_policy_module.md#examples)
- [Return Values](aci_l3out_logical_interface_profile_ospf_policy_module.md#return-values)

## [Synopsis](aci_l3out_logical_interface_profile_ospf_policy_module.md#id2)

- Manage L3Out interface profile OSPF policies on Cisco ACI fabrics.

## [Parameters](aci_l3out_logical_interface_profile_ospf_policy_module.md#id3)
...
| **interface_profile**  aliases: name, interface_profile_name, logical_interface  string | Name of an existing interface profile. |
...
| **ospf_auth_key**  string | OSPF authentication key.  When using `ospf_auth_key` this module will always show as `changed` as the module cannot know what the currently configured key is.  Default: `""` |
| **ospf_auth_type**  string | OSPF authentication type. The value `default` represents the “No Authentication” setting.  Choices:   - `"default"` - `"simple"` - `"md5"` |
| **ospf_policy**  aliases: name, ospf_policy_name  string | Name of an existing OSPF interface policy. |
...
## [See Also](aci_l3out_logical_interface_profile_ospf_policy_module.md#id4)
...
## [Examples](aci_l3out_logical_interface_profile_ospf_policy_module.md#id5)
...
## [Return Values](aci_l3out_logical_interface_profile_ospf_policy_module.md#id6)
