...
collection: ansible
version: "6"
title: "cisco.aci.aci_contract_subject_to_service_graph module – Bind contract subject to service graph (vz:RsSubjGraphAtt)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_contract_subject_to_service_graph_module.html
fetched_at: 2026-07-27T16:49:28+00:00
---
# cisco.aci.aci_contract_subject_to_service_graph module – Bind contract subject to service graph (vz:RsSubjGraphAtt).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_contract_subject_to_service_graph`.

- [Synopsis](aci_contract_subject_to_service_graph_module.md#synopsis)
- [Parameters](aci_contract_subject_to_service_graph_module.md#parameters)
- [See Also](aci_contract_subject_to_service_graph_module.md#see-also)
- [Examples](aci_contract_subject_to_service_graph_module.md#examples)
- [Return Values](aci_contract_subject_to_service_graph_module.md#return-values)

## [Synopsis](aci_contract_subject_to_service_graph_module.md#id1)

- Bind contract subject to service graph.

## [Parameters](aci_contract_subject_to_service_graph_module.md#id2)
...
## [See Also](aci_contract_subject_to_service_graph_module.md#id3)
...
## [Examples](aci_contract_subject_to_service_graph_module.md#id4)
...
## [Return Values](aci_contract_subject_to_service_graph_module.md#id5)
