...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_route_tag_policy module – Manage route tag policies (l3ext:RouteTagPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_route_tag_policy_module.html
fetched_at: 2026-07-27T16:50:16+00:00
---
# cisco.aci.aci_l3out_route_tag_policy module – Manage route tag policies (l3ext:RouteTagPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_route_tag_policy`.

- [Synopsis](aci_l3out_route_tag_policy_module.md#synopsis)
- [Parameters](aci_l3out_route_tag_policy_module.md#parameters)
- [Notes](aci_l3out_route_tag_policy_module.md#notes)
- [See Also](aci_l3out_route_tag_policy_module.md#see-also)
- [Examples](aci_l3out_route_tag_policy_module.md#examples)
- [Return Values](aci_l3out_route_tag_policy_module.md#return-values)

## [Synopsis](aci_l3out_route_tag_policy_module.md#id1)

- Manage route tag policies on Cisco ACI fabrics.

## [Parameters](aci_l3out_route_tag_policy_module.md#id2)
...
| **description**  aliases: descr  string | The description for the route tag policy. |
...
| **rtp**  aliases: name, rtp_name  string | The name of the route tag policy. |
...
| **tag**  integer | The value of the route tag.  Accepted values range between `0` and `4294967295`.  The APIC defaults to `4294967295` when unset during creation. |
...
## [Notes](aci_l3out_route_tag_policy_module.md#id3)
...
## [See Also](aci_l3out_route_tag_policy_module.md#id4)
...
> :   More information about the internal APIC class **l3ext:RouteTagPol**.
>
...
## [Examples](aci_l3out_route_tag_policy_module.md#id5)
...
## [Return Values](aci_l3out_route_tag_policy_module.md#id6)
