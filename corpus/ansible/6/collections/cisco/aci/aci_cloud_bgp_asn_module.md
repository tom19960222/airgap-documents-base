...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_bgp_asn module – Manage Cloud APIC BGP Autonomous System Profile (cloud:BgpAsP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_bgp_asn_module.html
fetched_at: 2026-07-27T16:49:16+00:00
---
# cisco.aci.aci_cloud_bgp_asn module – Manage Cloud APIC BGP Autonomous System Profile (cloud:BgpAsP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_bgp_asn`.

New in cisco.aci 2.1.0

- [Synopsis](aci_cloud_bgp_asn_module.md#synopsis)
- [Parameters](aci_cloud_bgp_asn_module.md#parameters)
- [Notes](aci_cloud_bgp_asn_module.md#notes)
- [See Also](aci_cloud_bgp_asn_module.md#see-also)
- [Examples](aci_cloud_bgp_asn_module.md#examples)
- [Return Values](aci_cloud_bgp_asn_module.md#return-values)

## [Synopsis](aci_cloud_bgp_asn_module.md#id1)

- Manage the BGP Autonomous System Profile for Cloud APIC

## [Parameters](aci_cloud_bgp_asn_module.md#id2)
...
| **description**  aliases: descr  string | Description of the BGP Autonomous System Profile. |
...
| **name**  aliases: autonomous_system_profile, autonomous_system_profile_name  string | object name |
...
## [Notes](aci_cloud_bgp_asn_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:BgpAsP** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_bgp_asn_module.md#id4)
...
## [Examples](aci_cloud_bgp_asn_module.md#id5)
...
## [Return Values](aci_cloud_bgp_asn_module.md#id6)
