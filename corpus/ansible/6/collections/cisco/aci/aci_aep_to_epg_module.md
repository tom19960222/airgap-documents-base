...
collection: ansible
version: "6"
title: "cisco.aci.aci_aep_to_epg module – Bind EPG to AEP (infra:RsFuncToEpg)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aep_to_epg_module.html
fetched_at: 2026-07-27T16:49:09+00:00
---
# cisco.aci.aci_aep_to_epg module – Bind EPG to AEP (infra:RsFuncToEpg).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aep_to_epg`.

- [Synopsis](aci_aep_to_epg_module.md#synopsis)
- [Parameters](aci_aep_to_epg_module.md#parameters)
- [See Also](aci_aep_to_epg_module.md#see-also)
- [Examples](aci_aep_to_epg_module.md#examples)
- [Return Values](aci_aep_to_epg_module.md#return-values)

## [Synopsis](aci_aep_to_epg_module.md#id1)

- Bind EPG to AEP.

## [Parameters](aci_aep_to_epg_module.md#id2)
...
| **encap**  aliases: vlan, vlan_id, encap_id  integer | The VLAN associated with this application EPG. |
...
| **primary_encap**  aliases: primary_vlan, primary_vlan_id, primary_encap_id  integer | The primary VLAN associated with this EPG |
...
## [See Also](aci_aep_to_epg_module.md#id3)
...
## [Examples](aci_aep_to_epg_module.md#id4)
...
## [Return Values](aci_aep_to_epg_module.md#id5)
