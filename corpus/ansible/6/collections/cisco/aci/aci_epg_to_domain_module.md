...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_epg_to_domain_module.html
fetched_at: 2026-07-27T16:49:39+00:00
---
...
| **netflow**  boolean | Determines if netflow should be enabled.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
