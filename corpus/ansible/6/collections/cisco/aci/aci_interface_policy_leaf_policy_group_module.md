...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_leaf_policy_group_module.html
fetched_at: 2026-07-27T16:49:57+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **aep**  aliases: aep_name  string | Choice of attached_entity_profile (AEP) to be used as part of the leaf policy group to be created. |
...
| **cdp_policy**  aliases: cdp_policy_name  string | Choice of cdp_policy to be used as part of the leaf policy group to be created. |
...
| **description**  aliases: descr  string | Description for the leaf policy group to be created. |
| **egress_data_plane_policing_policy**  aliases: egress_data_plane_policing_policy_name  string | Choice of egress_data_plane_policing_policy to be used as part of the leaf policy group to be created. |
| **fibre_channel_interface_policy**  aliases: fibre_channel_interface_policy_name  string | Choice of fibre_channel_interface_policy to be used as part of the leaf policy group to be created. |
...
| **ingress_data_plane_policing_policy**  aliases: ingress_data_plane_policing_policy_name  string | Choice of ingress_data_plane_policing_policy to be used as part of the leaf policy group to be created. |
| **l2_interface_policy**  aliases: l2_interface_policy_name  string | Choice of l2_interface_policy to be used as part of the leaf policy group to be created. |
| **lag_type**  aliases: lag_type_name  string / required | Selector for the type of leaf policy group we want to create.  `leaf` for Leaf Access Port Policy Group  `link` for Port Channel (PC)  `node` for Virtual Port Channel (VPC)  Choices:   - `"leaf"` - `"link"` - `"node"` |
| **link_level_policy**  aliases: link_level_policy_name  string | Choice of link_level_policy to be used as part of the leaf policy group to be created. |
| **lldp_policy**  aliases: lldp_policy_name  string | Choice of lldp_policy to be used as part of the leaf policy group to be created. |
| **mcp_policy**  aliases: mcp_policy_name  string | Choice of mcp_policy to be used as part of the leaf policy group to be created. |
| **monitoring_policy**  aliases: monitoring_policy_name  string | Choice of monitoring_policy to be used as part of the leaf policy group to be created. |
...
| **policy_group**  aliases: name, policy_group_name  string | Name of the leaf policy group to be added/deleted. |
...
| **port_channel_policy**  aliases: port_channel_policy_name  string | Choice of port_channel_policy to be used as part of the leaf policy group to be created. |
| **port_security_policy**  aliases: port_security_policy_name  string | Choice of port_security_policy to be used as part of the leaf policy group to be created. |
| **priority_flow_control_policy**  aliases: priority_flow_control_policy_name  string | Choice of priority_flow_control_policy to be used as part of the leaf policy group to be created. |
...
| **slow_drain_policy**  aliases: slow_drain_policy_name  string | Choice of slow_drain_policy to be used as part of the leaf policy group to be created. |
...
| **storm_control_interface_policy**  aliases: storm_control_interface_policy_name  string | Choice of storm_control_interface_policy to be used as part of the leaf policy group to be created. |
| **stp_interface_policy**  aliases: stp_interface_policy_name  string | Choice of stp_interface_policy to be used as part of the leaf policy group to be created. |
...
> **Note:**
>
> - When using the module please select the appropriate link_aggregation_type (lag_type). `link` for Port Channel(PC), `node` for Virtual Port Channel(VPC) and `leaf` for Leaf Access Port Policy Group.
