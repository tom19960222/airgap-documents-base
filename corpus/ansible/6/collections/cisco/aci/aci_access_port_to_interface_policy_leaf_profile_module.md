...
collection: ansible
version: "6"
title: "cisco.aci.aci_access_port_to_interface_policy_leaf_profile module – Manage Fabric interface policy leaf profile interface selectors (infra:HPortS, infra:RsAccBaseGrp, infra:PortBlk)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_access_port_to_interface_policy_leaf_profile_module.html
fetched_at: 2026-07-27T16:49:06+00:00
---
# cisco.aci.aci_access_port_to_interface_policy_leaf_profile module – Manage Fabric interface policy leaf profile interface selectors (infra:HPortS, infra:RsAccBaseGrp, infra:PortBlk)
...
- [Synopsis](aci_access_port_to_interface_policy_leaf_profile_module.md#synopsis)
- [Parameters](aci_access_port_to_interface_policy_leaf_profile_module.md#parameters)
- [Notes](aci_access_port_to_interface_policy_leaf_profile_module.md#notes)
- [See Also](aci_access_port_to_interface_policy_leaf_profile_module.md#see-also)
- [Examples](aci_access_port_to_interface_policy_leaf_profile_module.md#examples)
- [Return Values](aci_access_port_to_interface_policy_leaf_profile_module.md#return-values)

## [Synopsis](aci_access_port_to_interface_policy_leaf_profile_module.md#id1)

- Manage Fabric interface policy leaf profile interface selectors on Cisco ACI fabrics.

## [Parameters](aci_access_port_to_interface_policy_leaf_profile_module.md#id2)
...
| **from_card**  aliases: from_card_range  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The beginning (from-range) of the card range block for the leaf access port block. |
| **from_port**  aliases: from, fromPort, from_port_range  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The beginning (from-range) of the port range block for the leaf access port block. |
...
| **interface_profile**  aliases: leaf_interface_profile_name, leaf_interface_profile, interface_profile_name  string | The name of the Fabric access policy leaf interface profile. |
| **interface_type**  string | The type of interface for the static EPG deployment.  Choices:   - `"breakout"` - `"fex"` - `"port_channel"` - `"switch_port"` ← (default) - `"vpc"` - `"fex_port_channel"` - `"fex_vpc"` |
| **leaf_port_blk_description**  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The description to assign to the `leaf_port_blk` |
...
| **policy_group**  aliases: policy_group_name  string | The name of the fabric access policy group to be associated with the leaf interface profile interface selector. |
...
| **port_blk**  aliases: leaf_port_blk_name, leaf_port_blk, port_blk_name  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The name of the Fabric access policy leaf interface profile access port block. |
...
| **to_card**  aliases: to_card_range  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The end (to-range) of the card range block for the leaf access port block. |
| **to_port**  aliases: to, toPort, to_port_range  string | **Deprecated**  Starting with Ansible 2.8 we recommend using [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module) instead.  The parameter will be removed in Ansible 2.12.   ---   The end (to-range) of the port range block for the leaf access port block. |
| **type**  string | The type of access port to be created under respective profile.  Choices:   - `"fex"` - `"leaf"` ← (default) |
...
## [Notes](aci_access_port_to_interface_policy_leaf_profile_module.md#id3)

> **Note:**
>
> - The `interface_profile` must exist before using this module in your playbook. The [cisco.aci.aci_interface_policy_leaf_profile](aci_interface_policy_leaf_profile_module.md#ansible-collections-cisco-aci-aci-interface-policy-leaf-profile-module) modules can be used for this.

## [See Also](aci_access_port_to_interface_policy_leaf_profile_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_access_port_block_to_access_port](aci_access_port_block_to_access_port_module.md#ansible-collections-cisco-aci-aci-access-port-block-to-access-port-module)
...
## [Examples](aci_access_port_to_interface_policy_leaf_profile_module.md#id5)
...
## [Return Values](aci_access_port_to_interface_policy_leaf_profile_module.md#id6)
