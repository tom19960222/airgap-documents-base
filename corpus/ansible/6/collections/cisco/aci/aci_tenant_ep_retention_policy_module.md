...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant_ep_retention_policy module – Manage End Point (EP) retention protocol policies (fv:EpRetPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_ep_retention_policy_module.html
fetched_at: 2026-07-27T16:50:35+00:00
---
# cisco.aci.aci_tenant_ep_retention_policy module – Manage End Point (EP) retention protocol policies (fv:EpRetPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_tenant_ep_retention_policy`.

- [Synopsis](aci_tenant_ep_retention_policy_module.md#synopsis)
- [Parameters](aci_tenant_ep_retention_policy_module.md#parameters)
- [Notes](aci_tenant_ep_retention_policy_module.md#notes)
- [See Also](aci_tenant_ep_retention_policy_module.md#see-also)
- [Examples](aci_tenant_ep_retention_policy_module.md#examples)
- [Return Values](aci_tenant_ep_retention_policy_module.md#return-values)

## [Synopsis](aci_tenant_ep_retention_policy_module.md#id1)

- Manage End Point (EP) retention protocol policies on Cisco ACI fabrics.

## [Parameters](aci_tenant_ep_retention_policy_module.md#id2)
...
| **bounce_age**  integer | Bounce entry aging interval in seconds.  Accepted values range between `150` and `65535`; 0 is used for infinite.  The APIC defaults to `630` when unset during creation. |
| **bounce_trigger**  string | Determines if the bounce entries are installed by RARP Flood or COOP Protocol.  The APIC defaults to `coop` when unset during creation.  Choices:   - `"coop"` - `"flood"` |
...
| **description**  aliases: descr  string | Description for the End point retention policy. |
| **epr_policy**  aliases: epr_name, name  string | The name of the end point retention policy. |
| **hold_interval**  integer | Hold interval in seconds.  Accepted values range between `5` and `65535`.  The APIC defaults to `300` when unset during creation. |
...
| **local_ep_interval**  integer | Local end point aging interval in seconds.  Accepted values range between `120` and `65535`; 0 is used for infinite.  The APIC defaults to `900` when unset during creation. |
| **move_frequency**  integer | Move frequency per second.  Accepted values range between `0` and `65535`; 0 is used for none.  The APIC defaults to `256` when unset during creation. |
...
| **remote_ep_interval**  integer | Remote end point aging interval in seconds.  Accepted values range between `120` and `65535`; 0 is used for infinite.  The APIC defaults to `300` when unset during creation. |
...
## [Notes](aci_tenant_ep_retention_policy_module.md#id3)
...
## [See Also](aci_tenant_ep_retention_policy_module.md#id4)
...
## [Examples](aci_tenant_ep_retention_policy_module.md#id5)
...
## [Return Values](aci_tenant_ep_retention_policy_module.md#id6)
