...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_ap module – Manage Cloud Application Profile (AP) (cloud:App)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_ap_module.html
fetched_at: 2026-07-27T16:49:15+00:00
---
# cisco.aci.aci_cloud_ap module – Manage Cloud Application Profile (AP) (cloud:App)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_ap`.

- [Synopsis](aci_cloud_ap_module.md#synopsis)
- [Parameters](aci_cloud_ap_module.md#parameters)
- [Notes](aci_cloud_ap_module.md#notes)
- [See Also](aci_cloud_ap_module.md#see-also)
- [Examples](aci_cloud_ap_module.md#examples)
- [Return Values](aci_cloud_ap_module.md#return-values)

## [Synopsis](aci_cloud_ap_module.md#id1)

- Manage Cloud Application Profile (AP) objects on Cisco Cloud ACI

## [Parameters](aci_cloud_ap_module.md#id2)
...
| **description**  aliases: descr  string | Description for the cloud application profile. |
...
| **name**  aliases: app_profile, app_profile_name, ap  string | The name of the cloud application profile. |
...
## [Notes](aci_cloud_ap_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:App** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_ap_module.md#id4)
...
## [Examples](aci_cloud_ap_module.md#id5)
...
## [Return Values](aci_cloud_ap_module.md#id6)
