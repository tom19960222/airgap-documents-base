...
collection: ansible
version: "6"
title: "cisco.aci.aci_ntp_server module – Manage NTP servers."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_ntp_server_module.html
...
- [Synopsis](aci_ntp_server_module.md#synopsis)
- [Parameters](aci_ntp_server_module.md#parameters)
- [Notes](aci_ntp_server_module.md#notes)
- [See Also](aci_ntp_server_module.md#see-also)
- [Examples](aci_ntp_server_module.md#examples)
- [Return Values](aci_ntp_server_module.md#return-values)

## [Synopsis](aci_ntp_server_module.md#id1)

- Manage NTP server (datetimeNtpProv) configuration on Cisco ACI fabrics.

## [Parameters](aci_ntp_server_module.md#id2)
...
| **epg_type**  string | Type of management EPG to use to reach the NTP server, inb or oob  Choices:   - `"inb"` - `"oob"` |
...
| **max_poll**  integer | Maximum polling interval |
| **min_poll**  integer | Minimum polling interval |
| **ntp_policy**  aliases: policy_name  string / required | Name of an existing NTP policy |
| **ntp_server**  aliases: server_name  string | Name of the NTP server |
...
| **preferred**  boolean | Is this the preferred NTP server  Choices:   - `false` - `true` |
...
## [Notes](aci_ntp_server_module.md#id3)

> **Note:**
>
> - The used `ntp_policy` must exist before using this module in your playbook. The [cisco.aci.aci_ntp_policy](aci_ntp_policy_module.md#ansible-collections-cisco-aci-aci-ntp-policy-module) module can be used for this.

## [See Also](aci_ntp_server_module.md#id4)
...
## [Examples](aci_ntp_server_module.md#id5)
...
## [Return Values](aci_ntp_server_module.md#id6)
