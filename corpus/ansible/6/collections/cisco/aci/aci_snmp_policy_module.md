...
collection: ansible
version: "6"
title: "cisco.aci.aci_snmp_policy module – Manage Syslog groups ( snmp:Pol )."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_snmp_policy_module.html
fetched_at: 2026-07-27T16:50:25+00:00
---
# cisco.aci.aci_snmp_policy module – Manage Syslog groups (<snmp:Pol>).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_snmp_policy`.

- [Synopsis](aci_snmp_policy_module.md#synopsis)
- [Parameters](aci_snmp_policy_module.md#parameters)
- [See Also](aci_snmp_policy_module.md#see-also)
- [Examples](aci_snmp_policy_module.md#examples)
- [Return Values](aci_snmp_policy_module.md#return-values)

## [Synopsis](aci_snmp_policy_module.md#id1)

- Manage syslog policies

## [Parameters](aci_snmp_policy_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  string | Administrative State of the policy  Choices:   - `"enabled"` - `"disabled"` |
...
| **name**  aliases: snmp_policy, snmp_policy_name  string | Name of the SNMP policy |
...
## [See Also](aci_snmp_policy_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **snmp:Pol**.
>
...
## [Examples](aci_snmp_policy_module.md#id4)
...
## [Return Values](aci_snmp_policy_module.md#id5)
