...
collection: ansible
version: "6"
title: "cisco.aci.aci_config_snapshot module – Manage Config Snapshots (config:Snapshot, config:ExportP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_config_snapshot_module.html
fetched_at: 2026-07-27T16:49:25+00:00
---
...
- [Synopsis](aci_config_snapshot_module.md#synopsis)
- [Parameters](aci_config_snapshot_module.md#parameters)
- [Notes](aci_config_snapshot_module.md#notes)
- [See Also](aci_config_snapshot_module.md#see-also)
- [Examples](aci_config_snapshot_module.md#examples)
- [Return Values](aci_config_snapshot_module.md#return-values)

## [Synopsis](aci_config_snapshot_module.md#id1)

- Manage Config Snapshots on Cisco ACI fabrics.
- Creating new Snapshots is done using the configExportP class.
- Removing Snapshots is done using the configSnapshot class.

## [Parameters](aci_config_snapshot_module.md#id2)
...
| **description**  aliases: descr  string | The description for the Config Export Policy. |
| **export_policy**  aliases: name  string | The name of the Export Policy to use for Config Snapshots. |
| **format**  string | Sets the config backup to be formatted in JSON or XML.  The APIC defaults to `json` when unset.  Choices:   - `"json"` - `"xml"` |
...
| **include_secure**  boolean | Determines if secure information should be included in the backup.  The APIC defaults to `yes` when unset.  Choices:   - `false` - `true` |
| **max_count**  integer | Determines how many snapshots can exist for the Export Policy before the APIC starts to rollover.  Accepted values range between `1` and `10`.  The APIC defaults to `3` when unset. |
...
## [Notes](aci_config_snapshot_module.md#id3)
...
## [See Also](aci_config_snapshot_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_config_rollback](aci_config_rollback_module.md#ansible-collections-cisco-aci-aci-config-rollback-module)
...
## [Examples](aci_config_snapshot_module.md#id5)
...
## [Return Values](aci_config_snapshot_module.md#id6)
