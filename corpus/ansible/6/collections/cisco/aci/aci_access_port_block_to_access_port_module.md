...
collection: ansible
version: "6"
title: "cisco.aci.aci_access_port_block_to_access_port module – Manage port blocks of Fabric interface policy leaf profile interface selectors (infra:HPortS, infra:PortBlk)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_access_port_block_to_access_port_module.html
fetched_at: 2026-07-27T16:49:05+00:00
---
...
- [Synopsis](aci_access_port_block_to_access_port_module.md#synopsis)
- [Parameters](aci_access_port_block_to_access_port_module.md#parameters)
- [Notes](aci_access_port_block_to_access_port_module.md#notes)
- [See Also](aci_access_port_block_to_access_port_module.md#see-also)
- [Examples](aci_access_port_block_to_access_port_module.md#examples)
- [Return Values](aci_access_port_block_to_access_port_module.md#return-values)

## [Synopsis](aci_access_port_block_to_access_port_module.md#id1)

- Manage port blocks of Fabric interface policy leaf profile interface selectors on Cisco ACI fabrics.

## [Parameters](aci_access_port_block_to_access_port_module.md#id2)
...
| **port_blk**  aliases: leaf_port_blk_name, leaf_port_blk  string | The name of the Fabric access policy leaf interface profile access port block. |
| **port_blk_description**  aliases: leaf_port_blk_description  string | The description to assign to the `leaf_port_blk`. |
...
| **type**  string | The type of access port block to be created under respective access port.  Choices:   - `"fex"` - `"leaf"` ← (default) |
...
## [Notes](aci_access_port_block_to_access_port_module.md#id3)

> **Note:**
>
> - The `interface_profile` and `access_port_selector` must exist before using this module in your playbook. The [cisco.aci.aci_interface_policy_leaf_profile](aci_interface_policy_leaf_profile_module.md#ansible-collections-cisco-aci-aci-interface-policy-leaf-profile-module) and [cisco.aci.aci_access_port_to_interface_policy_leaf_profile](aci_access_port_to_interface_policy_leaf_profile_module.md#ansible-collections-cisco-aci-aci-access-port-to-interface-policy-leaf-profile-module) modules can be used for this.

## [See Also](aci_access_port_block_to_access_port_module.md#id4)
...
## [Examples](aci_access_port_block_to_access_port_module.md#id5)
...
## [Return Values](aci_access_port_block_to_access_port_module.md#id6)
