...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_zone module – Manage Cloud Availability Zone (cloud:Zone)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_zone_module.html
fetched_at: 2026-07-27T16:49:24+00:00
---
# cisco.aci.aci_cloud_zone module – Manage Cloud Availability Zone (cloud:Zone)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_zone`.

- [Synopsis](aci_cloud_zone_module.md#synopsis)
- [Parameters](aci_cloud_zone_module.md#parameters)
- [Notes](aci_cloud_zone_module.md#notes)
- [See Also](aci_cloud_zone_module.md#see-also)
- [Examples](aci_cloud_zone_module.md#examples)
- [Return Values](aci_cloud_zone_module.md#return-values)

## [Synopsis](aci_cloud_zone_module.md#id1)

- Manage Cloud Availability Zone on Cisco Cloud ACI.

## [Parameters](aci_cloud_zone_module.md#id2)
...
| **cloud**  string / required | The cloud provider.  Choices:   - `"aws"` - `"azure"` |
...
| **name**  aliases: zone  string | object name |
...
| **region**  string / required | The name of the cloud provider’s region. |
| **state**  string | Use `query` for listing an object or multiple objects.  Choices:   - `"query"` ← (default) |
...
## [Notes](aci_cloud_zone_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:Zone** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).
> - This module is used to query Cloud Availability Zone.

## [See Also](aci_cloud_zone_module.md#id4)
...
## [Examples](aci_cloud_zone_module.md#id5)
...
## [Return Values](aci_cloud_zone_module.md#id6)
