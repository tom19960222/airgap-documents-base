...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_contract_subject_module.html
fetched_at: 2026-07-27T16:49:27+00:00
---
...
| **reverse_filter**  boolean | Determines if the APIC should reverse the src and dst ports to allow the return traffic back, since ACI is stateless filter.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
