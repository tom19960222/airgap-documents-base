...
collection: ansible
version: "6"
title: "cisco.aci.aci_aaa_ssh_auth module – Manage AAA SSH auth (aaaSshAuth) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aaa_ssh_auth_module.html
fetched_at: 2026-07-27T16:49:01+00:00
---
# cisco.aci.aci_aaa_ssh_auth module – Manage AAA SSH auth (aaaSshAuth) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_ssh_auth`.

- [Synopsis](aci_aaa_ssh_auth_module.md#synopsis)
- [Parameters](aci_aaa_ssh_auth_module.md#parameters)
- [Notes](aci_aaa_ssh_auth_module.md#notes)
- [See Also](aci_aaa_ssh_auth_module.md#see-also)
- [Examples](aci_aaa_ssh_auth_module.md#examples)
- [Return Values](aci_aaa_ssh_auth_module.md#return-values)

## [Synopsis](aci_aaa_ssh_auth_module.md#id1)

- Manage AAA SSH Auth key configuration on Cisco ACI fabrics.

## [Parameters](aci_aaa_ssh_auth_module.md#id2)
...
## [Notes](aci_aaa_ssh_auth_module.md#id3)
...
## [See Also](aci_aaa_ssh_auth_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **aaaSshAuth**.
>
...
## [Examples](aci_aaa_ssh_auth_module.md#id5)
...
## [Return Values](aci_aaa_ssh_auth_module.md#id6)
