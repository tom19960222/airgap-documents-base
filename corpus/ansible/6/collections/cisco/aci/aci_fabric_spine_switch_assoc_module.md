...
collection: ansible
version: "6"
title: "cisco.aci.aci_fabric_spine_switch_assoc module – Manage spine switch bindings to profiles and policy groups (fabric:SpineS and fabric:RsSpNodePGrp)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_fabric_spine_switch_assoc_module.html
fetched_at: 2026-07-27T16:49:47+00:00
---
# cisco.aci.aci_fabric_spine_switch_assoc module – Manage spine switch bindings to profiles and policy groups (fabric:SpineS and fabric:RsSpNodePGrp).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_spine_switch_assoc`.

- [Synopsis](aci_fabric_spine_switch_assoc_module.md#synopsis)
- [Parameters](aci_fabric_spine_switch_assoc_module.md#parameters)
- [Notes](aci_fabric_spine_switch_assoc_module.md#notes)
- [See Also](aci_fabric_spine_switch_assoc_module.md#see-also)
- [Examples](aci_fabric_spine_switch_assoc_module.md#examples)
- [Return Values](aci_fabric_spine_switch_assoc_module.md#return-values)

## [Synopsis](aci_fabric_spine_switch_assoc_module.md#id1)
...
## [Parameters](aci_fabric_spine_switch_assoc_module.md#id2)
...
| **description**  aliases: descr  string | Description of the Fabric Switch Association |
...
| **name**  aliases: association_name, switch_association  string | Name of the switch association |
...
| **profile**  aliases: spine_profile, spine_switch_profile  string | Name of an existing fabric spine switch profile |
...
## [Notes](aci_fabric_spine_switch_assoc_module.md#id3)

> **Note:**
>
> - The `profile` must exist before using this module in your playbook. The [cisco.aci.aci_fabric_spine_profile](aci_fabric_spine_profile_module.md#ansible-collections-cisco-aci-aci-fabric-spine-profile-module) module can be used for this.

## [See Also](aci_fabric_spine_switch_assoc_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **fabricSpineS** and **fabricRsSpNodePGrp**.
>
...
## [Examples](aci_fabric_spine_switch_assoc_module.md#id5)
...
## [Return Values](aci_fabric_spine_switch_assoc_module.md#id6)
