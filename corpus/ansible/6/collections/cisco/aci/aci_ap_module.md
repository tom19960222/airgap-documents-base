...
collection: ansible
version: "6"
title: "cisco.aci.aci_ap module – Manage top level Application Profile (AP) objects (fv:Ap)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_ap_module.html
fetched_at: 2026-07-27T16:49:09+00:00
---
# cisco.aci.aci_ap module – Manage top level Application Profile (AP) objects (fv:Ap)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_ap`.

- [Synopsis](aci_ap_module.md#synopsis)
- [Parameters](aci_ap_module.md#parameters)
- [Notes](aci_ap_module.md#notes)
- [See Also](aci_ap_module.md#see-also)
- [Examples](aci_ap_module.md#examples)
- [Return Values](aci_ap_module.md#return-values)

## [Synopsis](aci_ap_module.md#id1)

- Manage top level Application Profile (AP) objects on Cisco ACI fabrics

## [Parameters](aci_ap_module.md#id2)
...
| **ap**  aliases: app_profile, app_profile_name, name  string | The name of the application network profile. |
...
| **description**  aliases: descr  string | Description for the AP. |
...
## [Notes](aci_ap_module.md#id3)

> **Note:**
>
> - This module does not manage EPGs, see [cisco.aci.aci_epg](aci_epg_module.md#ansible-collections-cisco-aci-aci-epg-module) to do this.
> - The used `tenant` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module) module can be used for this.

## [See Also](aci_ap_module.md#id4)
...
> :   More information about the internal APIC class **fv:Ap**.
>
...
## [Return Values](aci_ap_module.md#id6)
