...
collection: ansible
version: "6"
title: "cisco.aci.aci_bd_to_l3out module – Bind Bridge Domain to L3 Out (fv:RsBDToOut)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_bd_to_l3out_module.html
fetched_at: 2026-07-27T16:49:12+00:00
---
...
- [Synopsis](aci_bd_to_l3out_module.md#synopsis)
- [Parameters](aci_bd_to_l3out_module.md#parameters)
- [Notes](aci_bd_to_l3out_module.md#notes)
- [See Also](aci_bd_to_l3out_module.md#see-also)
- [Examples](aci_bd_to_l3out_module.md#examples)
- [Return Values](aci_bd_to_l3out_module.md#return-values)

## [Synopsis](aci_bd_to_l3out_module.md#id1)

- Bind Bridge Domain to L3 Out on Cisco ACI fabrics.

## [Parameters](aci_bd_to_l3out_module.md#id2)
...
| **bd**  aliases: bd_name, bridge_domain  string | The name of the Bridge Domain. |
...
## [Notes](aci_bd_to_l3out_module.md#id3)

> **Note:**
>
> - The `bd` and `l3out` parameters should exist before using this module. The [cisco.aci.aci_bd](aci_bd_module.md#ansible-collections-cisco-aci-aci-bd-module) and `aci_l3out` can be used for these.

## [See Also](aci_bd_to_l3out_module.md#id4)
...
## [Examples](aci_bd_to_l3out_module.md#id5)
...
## [Return Values](aci_bd_to_l3out_module.md#id6)
