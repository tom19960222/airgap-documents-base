...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant_span_dst_group module – Manage SPAN destination groups (span:DestGrp)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_span_dst_group_module.html
fetched_at: 2026-07-27T16:50:36+00:00
---
...
- [Synopsis](aci_tenant_span_dst_group_module.md#synopsis)
- [Parameters](aci_tenant_span_dst_group_module.md#parameters)
- [Notes](aci_tenant_span_dst_group_module.md#notes)
- [See Also](aci_tenant_span_dst_group_module.md#see-also)
- [Examples](aci_tenant_span_dst_group_module.md#examples)
- [Return Values](aci_tenant_span_dst_group_module.md#return-values)

## [Synopsis](aci_tenant_span_dst_group_module.md#id1)

- Manage SPAN destination groups on Cisco ACI fabrics.

## [Parameters](aci_tenant_span_dst_group_module.md#id2)
...
| **description**  aliases: descr  string | The description of the SPAN destination group. |
| **destination_epg**  dictionary | The destination end point group. |
| **ap**  string | The name of application profile. |
| **epg**  string | The name of the end point group. |
| **tenant**  aliases: tenant_name  string | The name of the tenant. |
| **destination_group**  aliases: name, dst_group  string | The name of the SPAN destination group. |
| **destination_ip**  string | The destination IP address. |
| **dscp**  string | The DSCP value for sending the monitored packets using ERSPAN.  Choices:   - `"CS0"` - `"CS1"` - `"CS2"` - `"CS3"` - `"CS4"` - `"CS5"` - `"CS6"` - `"CS7"` - `"EF"` - `"VA"` - `"AF11"` - `"AF12"` - `"AF13"` - `"AF21"` - `"AF22"` - `"AF23"` - `"AF31"` - `"AF32"` - `"AF33"` - `"AF41"` - `"AF42"` - `"AF43"` - `"unspecified"` |
| **flow_id**  integer | The flow ID of the SPAN packet. |
...
| **mtu**  integer | The MTU truncation size for the packets. |
...
| **span_version**  string | SPAN version.  Choices:   - `"version_1"` - `"version_2"` |
...
| **ttl**  integer | The time to live of the span session packets. |
...
## [Notes](aci_tenant_span_dst_group_module.md#id3)
...
## [See Also](aci_tenant_span_dst_group_module.md#id4)
...
## [Examples](aci_tenant_span_dst_group_module.md#id5)
...
## [Return Values](aci_tenant_span_dst_group_module.md#id6)
