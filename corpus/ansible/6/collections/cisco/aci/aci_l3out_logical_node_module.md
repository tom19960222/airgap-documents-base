...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_logical_node module – Manage Layer 3 Outside (L3Out) logical node profile nodes (l3ext:RsNodeL3OutAtt)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_logical_node_module.html
...
- [Synopsis](aci_l3out_logical_node_module.md#synopsis)
- [Parameters](aci_l3out_logical_node_module.md#parameters)
- [See Also](aci_l3out_logical_node_module.md#see-also)
- [Examples](aci_l3out_logical_node_module.md#examples)
- [Return Values](aci_l3out_logical_node_module.md#return-values)

## [Synopsis](aci_l3out_logical_node_module.md#id1)

- Bind nodes to node profiles on Cisco ACI fabrics.

## [Parameters](aci_l3out_logical_node_module.md#id2)
...
| **router_id_as_loopback**  string | Configure the router ID as a loopback IP.  Choices:   - `"yes"` ← (default) - `"no"` |
...
## [See Also](aci_l3out_logical_node_module.md#id3)
...
## [Examples](aci_l3out_logical_node_module.md#id4)
...
## [Return Values](aci_l3out_logical_node_module.md#id5)
