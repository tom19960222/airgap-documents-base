...
collection: ansible
version: "6"
title: "cisco.aci.aci_vmm_credential module – Manage virtual domain credential profiles (vmm:UsrAccP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vmm_credential_module.html
fetched_at: 2026-07-27T16:50:40+00:00
---
# cisco.aci.aci_vmm_credential module – Manage virtual domain credential profiles (vmm:UsrAccP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_vmm_credential`.

- [Synopsis](aci_vmm_credential_module.md#synopsis)
- [Parameters](aci_vmm_credential_module.md#parameters)
- [See Also](aci_vmm_credential_module.md#see-also)
- [Examples](aci_vmm_credential_module.md#examples)
- [Return Values](aci_vmm_credential_module.md#return-values)

## [Synopsis](aci_vmm_credential_module.md#id2)

- Manage virtual domain credential profiles on Cisco ACI fabrics.

## [Parameters](aci_vmm_credential_module.md#id3)
...
| **credential_password**  string | VMM controller password. |
| **credential_username**  string | VMM controller username. |
| **description**  aliases: descr  string | Description for the tenant. |
| **domain**  aliases: domain_name, domain_profile, name  string | Name of the virtual domain profile. |
...
| **name**  aliases: credential_name, credential_profile  string | Name of the credential profile. |
...
## [See Also](aci_vmm_credential_module.md#id4)
...
## [Examples](aci_vmm_credential_module.md#id5)
...
## [Return Values](aci_vmm_credential_module.md#id6)
