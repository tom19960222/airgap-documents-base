...
collection: ansible
version: "6"
title: "cisco.aci.aci_domain module – Manage physical, virtual, bridged, routed or FC domain profiles (phys:DomP, vmm:DomP, l2ext:DomP, l3ext:DomP, fc:DomP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_domain_module.html
fetched_at: 2026-07-27T16:49:32+00:00
---
...
- [Synopsis](aci_domain_module.md#synopsis)
- [Parameters](aci_domain_module.md#parameters)
- [See Also](aci_domain_module.md#see-also)
- [Examples](aci_domain_module.md#examples)
- [Return Values](aci_domain_module.md#return-values)

## [Synopsis](aci_domain_module.md#id1)

- Manage physical, virtual, bridged, routed or FC domain profiles on Cisco ACI fabrics.

## [Parameters](aci_domain_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **access_mode**  string | Access mode for vmm domains  This parameter cannot be changed after a domain is created  Choices:   - `"read-only"` - `"read-write"` |
| **add_infra_pg**  aliases: infra_pg  boolean | Configure port groups for infra VLAN (e.g. Virtual APIC).  Choices:   - `false` - `true` |
...
| **enable_vm_folder**  boolean | Enable VM folder data retrieval  Choices:   - `false` - `true` |
| **encap_mode**  string | The layer 2 encapsulation protocol to use with the virtual switch.  Choices:   - `"unknown"` - `"vlan"` - `"vxlan"` |
...
| **tag_collection**  boolean | Enables Cisco APIC to collect VMs that have been assigned tags in VMware vCenter for microsegmentation.  Choices:   - `false` - `true` |
...
| **vswitch**  string | The virtual switch to use for vmm domains.  The APIC defaults to `default` when unset during creation.  Choices:   - `"avs"` - `"default"` - `"dvs"` - `"unknown"` |

## [See Also](aci_domain_module.md#id3)

> **See also:**
>
> [cisco.aci.aci_aep_to_domain](aci_aep_to_domain_module.md#ansible-collections-cisco-aci-aci-aep-to-domain-module)
> :   Bind AEPs to Physical or Virtual Domains (infra:RsDomP).
>
> [cisco.aci.aci_domain_to_encap_pool](aci_domain_to_encap_pool_module.md#ansible-collections-cisco-aci-aci-domain-to-encap-pool-module)
> :   Bind Domain to Encap Pools (infra:RsVlanNs).
>
> [cisco.aci.aci_domain_to_vlan_pool](aci_domain_to_vlan_pool_module.md#ansible-collections-cisco-aci-aci-domain-to-vlan-pool-module)
...
## [Examples](aci_domain_module.md#id4)
...
## [Return Values](aci_domain_module.md#id5)
