...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_lldp module – Manage LLDP interface policies (lldp:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_lldp_module.html
fetched_at: 2026-07-27T16:50:00+00:00
---
# cisco.aci.aci_interface_policy_lldp module – Manage LLDP interface policies (lldp:IfPol)
...
- [Synopsis](aci_interface_policy_lldp_module.md#synopsis)
- [Parameters](aci_interface_policy_lldp_module.md#parameters)
- [See Also](aci_interface_policy_lldp_module.md#see-also)
- [Examples](aci_interface_policy_lldp_module.md#examples)
- [Return Values](aci_interface_policy_lldp_module.md#return-values)

## [Synopsis](aci_interface_policy_lldp_module.md#id1)

- Manage LLDP interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_lldp_module.md#id2)
...
| **description**  aliases: descr  string | The description for the LLDP interface policy name. |
...
| **lldp_policy**  aliases: name  string | The LLDP interface policy name. |
...
| **receive_state**  boolean | Enable or disable Receive state.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
| **transmit_state**  boolean | Enable or Disable Transmit state.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
## [See Also](aci_interface_policy_lldp_module.md#id3)
...
## [Examples](aci_interface_policy_lldp_module.md#id4)
...
## [Return Values](aci_interface_policy_lldp_module.md#id5)
