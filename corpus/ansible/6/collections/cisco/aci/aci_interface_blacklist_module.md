...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_blacklist module – Enabling or Disabling physical interfaces."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_blacklist_module.html
fetched_at: 2026-07-27T16:49:53+00:00
---
# cisco.aci.aci_interface_blacklist module – Enabling or Disabling physical interfaces.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_blacklist`.

- [Synopsis](aci_interface_blacklist_module.md#synopsis)
- [Parameters](aci_interface_blacklist_module.md#parameters)
- [See Also](aci_interface_blacklist_module.md#see-also)
- [Examples](aci_interface_blacklist_module.md#examples)
- [Return Values](aci_interface_blacklist_module.md#return-values)

## [Synopsis](aci_interface_blacklist_module.md#id1)

- Enables or Disables physical interfaces on Cisco ACI fabrics.

## [Parameters](aci_interface_blacklist_module.md#id2)
...
## [See Also](aci_interface_blacklist_module.md#id3)
...
## [Examples](aci_interface_blacklist_module.md#id4)
...
## [Return Values](aci_interface_blacklist_module.md#id5)
