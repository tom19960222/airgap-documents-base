...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_vpn_gateway module – Manage cloudRouterP in Cloud Context Profile (cloud:cloudRouterP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_vpn_gateway_module.html
fetched_at: 2026-07-27T16:49:23+00:00
---
# cisco.aci.aci_cloud_vpn_gateway module – Manage cloudRouterP in Cloud Context Profile (cloud:cloudRouterP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_vpn_gateway`.

- [Synopsis](aci_cloud_vpn_gateway_module.md#synopsis)
- [Parameters](aci_cloud_vpn_gateway_module.md#parameters)
- [Notes](aci_cloud_vpn_gateway_module.md#notes)
- [See Also](aci_cloud_vpn_gateway_module.md#see-also)
- [Examples](aci_cloud_vpn_gateway_module.md#examples)
- [Return Values](aci_cloud_vpn_gateway_module.md#return-values)

## [Synopsis](aci_cloud_vpn_gateway_module.md#id1)

- Manage cloudRouterP objects on Cisco Cloud ACI.

## [Parameters](aci_cloud_vpn_gateway_module.md#id2)
...
| **cloud_context_profile**  string / required | The name of cloud context profile. |
...
| **state**  string | Use `present` or `absent` for adding or removing.  Use `query` for listing an object or multiple objects.  Choices:   - `"absent"` - `"present"` - `"query"` ← (default) |
| **tenant**  string / required | The name of tenant. |
...
## [Notes](aci_cloud_vpn_gateway_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:cloudRouterP** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_vpn_gateway_module.md#id4)
...
## [Examples](aci_cloud_vpn_gateway_module.md#id5)
...
## [Return Values](aci_cloud_vpn_gateway_module.md#id6)
