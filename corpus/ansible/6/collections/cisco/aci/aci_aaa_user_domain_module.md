...
collection: ansible
version: "6"
title: "cisco.aci.aci_aaa_user_domain module – Manage AAA user domain (aaaUserDomain) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aaa_user_domain_module.html
fetched_at: 2026-07-27T16:49:04+00:00
---
# cisco.aci.aci_aaa_user_domain module – Manage AAA user domain (aaaUserDomain) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_user_domain`.

- [Synopsis](aci_aaa_user_domain_module.md#synopsis)
- [Parameters](aci_aaa_user_domain_module.md#parameters)
- [Notes](aci_aaa_user_domain_module.md#notes)
- [See Also](aci_aaa_user_domain_module.md#see-also)
- [Examples](aci_aaa_user_domain_module.md#examples)
- [Return Values](aci_aaa_user_domain_module.md#return-values)

## [Synopsis](aci_aaa_user_domain_module.md#id1)

- Manage AAA user domain configuration on Cisco ACI fabrics.

## [Parameters](aci_aaa_user_domain_module.md#id2)
...
| **domain_name**  string | Name of the user domain |
...
## [Notes](aci_aaa_user_domain_module.md#id3)

> **Note:**
>
> - The `aaa_user` must exist before using this module in your playbook. The [cisco.aci.aci_aaa_user](aci_aaa_user_module.md#ansible-collections-cisco-aci-aci-aaa-user-module) modules can be used for this.

## [See Also](aci_aaa_user_domain_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **aaaUserDomain**.
>
...
## [Examples](aci_aaa_user_domain_module.md#id5)
...
## [Return Values](aci_aaa_user_domain_module.md#id6)
