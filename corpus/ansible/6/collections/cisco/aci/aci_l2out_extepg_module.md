...
collection: ansible
version: "6"
title: "cisco.aci.aci_l2out_extepg module – Manage External Network Instance (L2Out External EPG) objects (l2extInstP)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l2out_extepg_module.html
fetched_at: 2026-07-27T16:50:04+00:00
---
# cisco.aci.aci_l2out_extepg module – Manage External Network Instance (L2Out External EPG) objects (l2extInstP).
...
- [Synopsis](aci_l2out_extepg_module.md#synopsis)
- [Parameters](aci_l2out_extepg_module.md#parameters)
- [Notes](aci_l2out_extepg_module.md#notes)
- [See Also](aci_l2out_extepg_module.md#see-also)
- [Examples](aci_l2out_extepg_module.md#examples)
- [Return Values](aci_l2out_extepg_module.md#return-values)

## [Synopsis](aci_l2out_extepg_module.md#id1)

- Manage External Network Instance (L2Out External EPG) objects (l2extInstP) on ACI fabrics.

## [Parameters](aci_l2out_extepg_module.md#id2)
...
| **extepg**  aliases: external_epg, extepg_name, name  string | Name of the external end point group. |
...
| **preferred_group**  boolean | This depicts whether this External EPG is part of the Preferred Group and can communicate without contracts.  This is convenient for migration scenarios, or when ACI is used for network automation but not for policy.  The APIC defaults to `no` when unset during creation.  Choices:   - `false` - `true` |
...
| **qos_class**  string | The bandwidth level for Quality of service.  Choices:   - `"level1"` - `"level2"` - `"level3"` - `"level4"` - `"level5"` - `"level6"` - `"Unspecified"` |
...
## [Notes](aci_l2out_extepg_module.md#id3)

> **Note:**
>
> - The `tenant` and `l2out` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module) and [cisco.aci.aci_l2out](aci_l2out_module.md#ansible-collections-cisco-aci-aci-l2out-module) modules can be used for this.

## [See Also](aci_l2out_extepg_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fvtenant** and **l2extOut**.
>
...
## [Examples](aci_l2out_extepg_module.md#id5)
...
## [Return Values](aci_l2out_extepg_module.md#id6)
