...
collection: ansible
version: "6"
title: "cisco.aci.aci_bd_dhcp_label module – Manage DHCP Labels (dhcp:Lbl)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_bd_dhcp_label_module.html
fetched_at: 2026-07-27T16:49:11+00:00
---
# cisco.aci.aci_bd_dhcp_label module – Manage DHCP Labels (dhcp:Lbl)
...
- [Synopsis](aci_bd_dhcp_label_module.md#synopsis)
- [Parameters](aci_bd_dhcp_label_module.md#parameters)
- [Notes](aci_bd_dhcp_label_module.md#notes)
- [See Also](aci_bd_dhcp_label_module.md#see-also)
- [Examples](aci_bd_dhcp_label_module.md#examples)
- [Return Values](aci_bd_dhcp_label_module.md#return-values)

## [Synopsis](aci_bd_dhcp_label_module.md#id1)

- Manage DHCP Labels on Cisco ACI fabrics.

## [Parameters](aci_bd_dhcp_label_module.md#id2)
...
| **description**  aliases: descr  string | The description for the DHCP Label. |
| **dhcp_label**  aliases: name  string | The name of the DHCP Relay Label. |
...
| **scope**  aliases: owner  string | Represents the target relay servers ownership.  Choices:   - `"infra"` ← (default) - `"tenant"` |
...
## [Notes](aci_bd_dhcp_label_module.md#id3)
...
## [See Also](aci_bd_dhcp_label_module.md#id4)
...
## [Examples](aci_bd_dhcp_label_module.md#id5)
...
## [Return Values](aci_bd_dhcp_label_module.md#id6)
