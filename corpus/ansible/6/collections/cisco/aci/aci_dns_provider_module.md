...
collection: ansible
version: "6"
title: "cisco.aci.aci_dns_provider module – Manage DNS Provider (dnsProv) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_dns_provider_module.html
fetched_at: 2026-07-27T16:49:32+00:00
---
# cisco.aci.aci_dns_provider module – Manage DNS Provider (dnsProv) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_dns_provider`.

- [Synopsis](aci_dns_provider_module.md#synopsis)
- [Parameters](aci_dns_provider_module.md#parameters)
- [Notes](aci_dns_provider_module.md#notes)
- [See Also](aci_dns_provider_module.md#see-also)
- [Examples](aci_dns_provider_module.md#examples)
- [Return Values](aci_dns_provider_module.md#return-values)

## [Synopsis](aci_dns_provider_module.md#id1)

- Manage DNS Provider configuration on Cisco ACI fabrics.

## [Parameters](aci_dns_provider_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  aliases: addr, ip_address  string | address of the DNS server |
...
| **dns_profile**  aliases: profile_name  string / required | Name of the DNS profile. |
...
| **preferred**  boolean | Whether this is the preferred DNS server  Choices:   - `false` - `true` |
...
## [Notes](aci_dns_provider_module.md#id3)

> **Note:**
>
> - The `dns_profile` must exist before using this module in your playbook. The [cisco.aci.aci_dns_profile](aci_dns_profile_module.md#ansible-collections-cisco-aci-aci-dns-profile-module) modules can be used for this.

## [See Also](aci_dns_provider_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **dnsProv**.
>
...
## [Examples](aci_dns_provider_module.md#id5)
...
## [Return Values](aci_dns_provider_module.md#id6)
