...
collection: ansible
version: "6"
title: "cisco.aci.aci_epg_to_contract_master module – Manage End Point Group (EPG) contract master relationships (fv:RsSecInherited)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_epg_to_contract_master_module.html
fetched_at: 2026-07-27T16:49:39+00:00
---
# cisco.aci.aci_epg_to_contract_master module – Manage End Point Group (EPG) contract master relationships (fv:RsSecInherited)
...
- [Synopsis](aci_epg_to_contract_master_module.md#synopsis)
- [Parameters](aci_epg_to_contract_master_module.md#parameters)
- [Notes](aci_epg_to_contract_master_module.md#notes)
- [See Also](aci_epg_to_contract_master_module.md#see-also)
- [Examples](aci_epg_to_contract_master_module.md#examples)
- [Return Values](aci_epg_to_contract_master_module.md#return-values)

## [Synopsis](aci_epg_to_contract_master_module.md#id1)

- Manage End Point Groups (EPG) contract master relationships on Cisco ACI fabrics.

## [Parameters](aci_epg_to_contract_master_module.md#id2)
...
| **ap**  aliases: app_profile, app_profile_name  string / required | Name of an existing application network profile, that will contain the EPGs. |
...
| **epg**  aliases: epg_name, name  string / required | Name of the end point group. |
...
## [Notes](aci_epg_to_contract_master_module.md#id3)
...
## [See Also](aci_epg_to_contract_master_module.md#id4)
...
## [Examples](aci_epg_to_contract_master_module.md#id5)
...
## [Return Values](aci_epg_to_contract_master_module.md#id6)
