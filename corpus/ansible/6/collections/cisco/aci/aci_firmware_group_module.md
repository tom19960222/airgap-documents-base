...
collection: ansible
version: "6"
title: "cisco.aci.aci_firmware_group module – This module creates a firmware group"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_firmware_group_module.html
fetched_at: 2026-07-27T16:49:50+00:00
---
# cisco.aci.aci_firmware_group module – This module creates a firmware group
...
>
> To use it in a playbook, specify: `cisco.aci.aci_firmware_group`.

- [Synopsis](aci_firmware_group_module.md#synopsis)
- [Parameters](aci_firmware_group_module.md#parameters)
- [See Also](aci_firmware_group_module.md#see-also)
- [Examples](aci_firmware_group_module.md#examples)
- [Return Values](aci_firmware_group_module.md#return-values)

## [Synopsis](aci_firmware_group_module.md#id1)

- This module creates a firmware group, so that you can apply firmware policy to nodes.

## [Parameters](aci_firmware_group_module.md#id2)
...
| **firmwarepol**  string | This is the name of the firmware policy, which was create by aci_firmware_policy. It is important that  you use the same name as the policy created with aci_firmware_policy |
| **group**  string | This the name of the firmware group |
...
## [See Also](aci_firmware_group_module.md#id3)
...
## [Examples](aci_firmware_group_module.md#id4)
...
## [Return Values](aci_firmware_group_module.md#id5)
