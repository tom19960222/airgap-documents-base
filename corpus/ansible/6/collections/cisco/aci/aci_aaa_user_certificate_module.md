...
collection: ansible
version: "6"
title: "cisco.aci.aci_aaa_user_certificate module – Manage AAA user certificates (aaa:UserCert)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aaa_user_certificate_module.html
fetched_at: 2026-07-27T16:49:03+00:00
---
# cisco.aci.aci_aaa_user_certificate module – Manage AAA user certificates (aaa:UserCert)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_user_certificate`.

- [Synopsis](aci_aaa_user_certificate_module.md#synopsis)
- [Parameters](aci_aaa_user_certificate_module.md#parameters)
- [Notes](aci_aaa_user_certificate_module.md#notes)
- [See Also](aci_aaa_user_certificate_module.md#see-also)
- [Examples](aci_aaa_user_certificate_module.md#examples)
- [Return Values](aci_aaa_user_certificate_module.md#return-values)

## [Synopsis](aci_aaa_user_certificate_module.md#id2)

- Manage AAA user certificates on Cisco ACI fabrics.

## [Parameters](aci_aaa_user_certificate_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **aaa_user**  string / required | The name of the user to add a certificate to. |
| **aaa_user_type**  string | Whether this is a normal user or an appuser.  Choices:   - `"appuser"` - `"user"` ← (default) |
...
| **certificate**  aliases: cert_data, certificate_data  string | The PEM format public key extracted from the X.509 certificate. |
...
| **name**  aliases: cert_name  string | The name of the user certificate entry in ACI. |
...
## [Notes](aci_aaa_user_certificate_module.md#id4)

> **Note:**
>
> - The `aaa_user` must exist before using this module in your playbook. The [cisco.aci.aci_aaa_user](aci_aaa_user_module.md#ansible-collections-cisco-aci-aci-aaa-user-module) module can be used for this.

## [See Also](aci_aaa_user_certificate_module.md#id5)

> **See also:**
>
> [cisco.aci.aci_aaa_user](aci_aaa_user_module.md#ansible-collections-cisco-aci-aci-aaa-user-module)
...
## [Examples](aci_aaa_user_certificate_module.md#id6)
...
## [Return Values](aci_aaa_user_certificate_module.md#id7)
