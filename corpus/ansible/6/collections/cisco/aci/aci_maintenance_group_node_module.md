...
collection: ansible
version: "6"
title: "cisco.aci.aci_maintenance_group_node module – Manage maintenance group nodes"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_maintenance_group_node_module.html
fetched_at: 2026-07-27T16:50:19+00:00
---
# cisco.aci.aci_maintenance_group_node module – Manage maintenance group nodes
...
>
> To use it in a playbook, specify: `cisco.aci.aci_maintenance_group_node`.

- [Synopsis](aci_maintenance_group_node_module.md#synopsis)
- [Parameters](aci_maintenance_group_node_module.md#parameters)
- [See Also](aci_maintenance_group_node_module.md#see-also)
- [Examples](aci_maintenance_group_node_module.md#examples)
- [Return Values](aci_maintenance_group_node_module.md#return-values)

## [Synopsis](aci_maintenance_group_node_module.md#id1)

- Manage maintenance group nodes

## [Parameters](aci_maintenance_group_node_module.md#id2)
...
## [See Also](aci_maintenance_group_node_module.md#id3)
...
## [Examples](aci_maintenance_group_node_module.md#id4)
...
## [Return Values](aci_maintenance_group_node_module.md#id5)
