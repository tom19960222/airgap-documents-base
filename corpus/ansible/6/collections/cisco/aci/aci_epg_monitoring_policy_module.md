...
collection: ansible
version: "6"
title: "cisco.aci.aci_epg_monitoring_policy module – Manage monitoring policies (mon:EPGPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_epg_monitoring_policy_module.html
fetched_at: 2026-07-27T16:49:37+00:00
---
# cisco.aci.aci_epg_monitoring_policy module – Manage monitoring policies (mon:EPGPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_epg_monitoring_policy`.

- [Synopsis](aci_epg_monitoring_policy_module.md#synopsis)
- [Parameters](aci_epg_monitoring_policy_module.md#parameters)
- [Notes](aci_epg_monitoring_policy_module.md#notes)
- [See Also](aci_epg_monitoring_policy_module.md#see-also)
- [Examples](aci_epg_monitoring_policy_module.md#examples)
- [Return Values](aci_epg_monitoring_policy_module.md#return-values)

## [Synopsis](aci_epg_monitoring_policy_module.md#id1)

- Manage monitoring policies on Cisco ACI fabrics.

## [Parameters](aci_epg_monitoring_policy_module.md#id2)
...
| **description**  aliases: descr  string | Description for the monitoring policy. |
...
| **monitoring_policy**  aliases: name  string | The name of the monitoring policy. |
...
## [Notes](aci_epg_monitoring_policy_module.md#id3)
...
## [See Also](aci_epg_monitoring_policy_module.md#id4)
...
> :   More information about the internal APIC class **mon:EPGPol**.
>
...
## [Examples](aci_epg_monitoring_policy_module.md#id5)
...
## [Return Values](aci_epg_monitoring_policy_module.md#id6)
