...
collection: ansible
version: "6"
title: "cisco.aci.aci_dns_profile module – Manage DNS Profile (dnsProfile) objects."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_dns_profile_module.html
fetched_at: 2026-07-27T16:49:31+00:00
---
# cisco.aci.aci_dns_profile module – Manage DNS Profile (dnsProfile) objects.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_dns_profile`.

- [Synopsis](aci_dns_profile_module.md#synopsis)
- [Parameters](aci_dns_profile_module.md#parameters)
- [See Also](aci_dns_profile_module.md#see-also)
- [Examples](aci_dns_profile_module.md#examples)
- [Return Values](aci_dns_profile_module.md#return-values)

## [Synopsis](aci_dns_profile_module.md#id1)

- Manage DNS Profile configuration on Cisco ACI fabrics.

## [Parameters](aci_dns_profile_module.md#id2)
...
| **dns_profile**  aliases: name, profile_name  string | Name of the DNS profile. |
...
## [See Also](aci_dns_profile_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **dnsProfile**.
>
...
## [Examples](aci_dns_profile_module.md#id4)
...
## [Return Values](aci_dns_profile_module.md#id5)
