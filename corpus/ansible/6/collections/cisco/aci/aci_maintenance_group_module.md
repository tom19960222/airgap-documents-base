...
collection: ansible
version: "6"
title: "cisco.aci.aci_maintenance_group module – This creates an ACI maintenance group"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_maintenance_group_module.html
fetched_at: 2026-07-27T16:50:18+00:00
---
# cisco.aci.aci_maintenance_group module – This creates an ACI maintenance group
...
>
> To use it in a playbook, specify: `cisco.aci.aci_maintenance_group`.

- [Synopsis](aci_maintenance_group_module.md#synopsis)
- [Parameters](aci_maintenance_group_module.md#parameters)
- [Notes](aci_maintenance_group_module.md#notes)
- [See Also](aci_maintenance_group_module.md#see-also)
- [Examples](aci_maintenance_group_module.md#examples)
- [Return Values](aci_maintenance_group_module.md#return-values)

## [Synopsis](aci_maintenance_group_module.md#id1)

- This modules creates an ACI maintenance group

## [Parameters](aci_maintenance_group_module.md#id2)
...
| **group**  string | This is the name of the group |
...
| **policy**  string | This is the name of the policy that was created using aci_maintenance_policy |
...
## [Examples](aci_maintenance_group_module.md#id5)
...
## [Return Values](aci_maintenance_group_module.md#id6)
