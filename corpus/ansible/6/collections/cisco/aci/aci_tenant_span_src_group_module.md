...
collection: ansible
version: "6"
title: "cisco.aci.aci_tenant_span_src_group module – Manage SPAN source groups (span:SrcGrp)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_tenant_span_src_group_module.html
fetched_at: 2026-07-27T16:50:37+00:00
---
# cisco.aci.aci_tenant_span_src_group module – Manage SPAN source groups (span:SrcGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_tenant_span_src_group`.

- [Synopsis](aci_tenant_span_src_group_module.md#synopsis)
- [Parameters](aci_tenant_span_src_group_module.md#parameters)
- [Notes](aci_tenant_span_src_group_module.md#notes)
- [See Also](aci_tenant_span_src_group_module.md#see-also)
- [Examples](aci_tenant_span_src_group_module.md#examples)
- [Return Values](aci_tenant_span_src_group_module.md#return-values)

## [Synopsis](aci_tenant_span_src_group_module.md#id1)

- Manage SPAN source groups on Cisco ACI fabrics.

## [Parameters](aci_tenant_span_src_group_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Enable or disable the span sources.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
| **description**  aliases: descr  string | The description for Span source group. |
...
| **src_group**  aliases: name  string | The name of the Span source group. |
...
## [Notes](aci_tenant_span_src_group_module.md#id3)
...
## [See Also](aci_tenant_span_src_group_module.md#id4)
...
## [Examples](aci_tenant_span_src_group_module.md#id5)
...
## [Return Values](aci_tenant_span_src_group_module.md#id6)
