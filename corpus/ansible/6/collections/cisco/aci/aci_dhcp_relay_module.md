...
collection: ansible
version: "6"
title: "cisco.aci.aci_dhcp_relay module – Manage DHCP relay policies."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_dhcp_relay_module.html
fetched_at: 2026-07-27T16:49:29+00:00
---
# cisco.aci.aci_dhcp_relay module – Manage DHCP relay policies.
...
>
> To use it in a playbook, specify: `cisco.aci.aci_dhcp_relay`.

- [Synopsis](aci_dhcp_relay_module.md#synopsis)
- [Parameters](aci_dhcp_relay_module.md#parameters)
- [Notes](aci_dhcp_relay_module.md#notes)
- [See Also](aci_dhcp_relay_module.md#see-also)
- [Examples](aci_dhcp_relay_module.md#examples)
- [Return Values](aci_dhcp_relay_module.md#return-values)

## [Synopsis](aci_dhcp_relay_module.md#id1)

- Manage DHCP relay policy (dhcpRelayP) configuration on Cisco ACI fabrics.

## [Parameters](aci_dhcp_relay_module.md#id2)
...
| **name**  aliases: relay_policy  string | Name of the DHCP relay policy |
...
## [Notes](aci_dhcp_relay_module.md#id3)
...
## [See Also](aci_dhcp_relay_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **dhcpRelayP**.
>
...
## [Examples](aci_dhcp_relay_module.md#id5)
...
## [Return Values](aci_dhcp_relay_module.md#id6)
