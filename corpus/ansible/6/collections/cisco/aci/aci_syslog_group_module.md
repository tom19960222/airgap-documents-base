...
collection: ansible
version: "6"
title: "cisco.aci.aci_syslog_group module – Manage Syslog groups (syslog:Group, syslog:Console, syslog:File and syslog:Prof)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_syslog_group_module.html
fetched_at: 2026-07-27T16:50:30+00:00
---
# cisco.aci.aci_syslog_group module – Manage Syslog groups (syslog:Group, syslog:Console, syslog:File and syslog:Prof).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_syslog_group`.

- [Synopsis](aci_syslog_group_module.md#synopsis)
- [Parameters](aci_syslog_group_module.md#parameters)
- [See Also](aci_syslog_group_module.md#see-also)
- [Examples](aci_syslog_group_module.md#examples)
- [Return Values](aci_syslog_group_module.md#return-values)

## [Synopsis](aci_syslog_group_module.md#id1)

- Manage syslog groups

## [Parameters](aci_syslog_group_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  string | Administrative state of the syslog group  Choices:   - `"enabled"` - `"disabled"` |
...
| **console_log_severity**  string | Severity of events to log to console  Choices:   - `"alerts"` - `"critical"` - `"debugging"` - `"emergencies"` - `"error"` - `"information"` - `"notifications"` - `"warnings"` |
| **console_logging**  string | Log events to console  Choices:   - `"enabled"` - `"disabled"` |
| **format**  string | Format of the syslog messages. If omitted when creating a group, ACI defaults to using aci format.  Choices:   - `"aci"` - `"nxos"` |
...
| **include_ms**  boolean | Include milliseconds in log timestamps  Choices:   - `false` - `true` |
| **include_time_zone**  boolean | Include timezone in log timestamps  Choices:   - `false` - `true` |
| **local_file_log_severity**  string | Severity of events to log to local file  Choices:   - `"alerts"` - `"critical"` - `"debugging"` - `"emergencies"` - `"error"` - `"information"` - `"notifications"` - `"warnings"` |
| **local_file_logging**  string | Log to local file  Choices:   - `"enabled"` - `"disabled"` |
| **name**  aliases: syslog_group, syslog_group_name  string | Name of the syslog group |
...
## [See Also](aci_syslog_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **syslog:Group**.
>
...
## [Examples](aci_syslog_group_module.md#id4)
...
## [Return Values](aci_syslog_group_module.md#id5)
