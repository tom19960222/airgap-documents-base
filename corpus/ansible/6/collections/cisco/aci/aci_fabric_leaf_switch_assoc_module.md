...
collection: ansible
version: "6"
title: "cisco.aci.aci_fabric_leaf_switch_assoc module – Manage leaf switch bindings to profiles and policy groups (fabric:LeafS and fabric:RsLeNodePGrp)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_fabric_leaf_switch_assoc_module.html
fetched_at: 2026-07-27T16:49:44+00:00
---
# cisco.aci.aci_fabric_leaf_switch_assoc module – Manage leaf switch bindings to profiles and policy groups (fabric:LeafS and fabric:RsLeNodePGrp).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_leaf_switch_assoc`.

- [Synopsis](aci_fabric_leaf_switch_assoc_module.md#synopsis)
- [Parameters](aci_fabric_leaf_switch_assoc_module.md#parameters)
- [Notes](aci_fabric_leaf_switch_assoc_module.md#notes)
- [See Also](aci_fabric_leaf_switch_assoc_module.md#see-also)
- [Examples](aci_fabric_leaf_switch_assoc_module.md#examples)
- [Return Values](aci_fabric_leaf_switch_assoc_module.md#return-values)

## [Synopsis](aci_fabric_leaf_switch_assoc_module.md#id1)
...
## [Parameters](aci_fabric_leaf_switch_assoc_module.md#id2)
...
| **profile**  aliases: leaf_profile, leaf_switch_profile  string | Name of an existing fabric leaf switch profile |
...
## [Notes](aci_fabric_leaf_switch_assoc_module.md#id3)

> **Note:**
>
> - The `profile` must exist before using this module in your playbook. The [cisco.aci.aci_fabric_leaf_profile](aci_fabric_leaf_profile_module.md#ansible-collections-cisco-aci-aci-fabric-leaf-profile-module) module can be used for this.

## [See Also](aci_fabric_leaf_switch_assoc_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **fabricLeafS** and **fabricRsLeNodePGrp**.
>
...
## [Examples](aci_fabric_leaf_switch_assoc_module.md#id5)
...
## [Return Values](aci_fabric_leaf_switch_assoc_module.md#id6)
