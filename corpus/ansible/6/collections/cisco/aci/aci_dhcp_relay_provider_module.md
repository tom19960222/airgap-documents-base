...
collection: ansible
version: "6"
title: "cisco.aci.aci_dhcp_relay_provider module – Manage DHCP relay policy providers."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_dhcp_relay_provider_module.html
fetched_at: 2026-07-27T16:49:30+00:00
---
...
- [Synopsis](aci_dhcp_relay_provider_module.md#synopsis)
- [Parameters](aci_dhcp_relay_provider_module.md#parameters)
- [Notes](aci_dhcp_relay_provider_module.md#notes)
- [See Also](aci_dhcp_relay_provider_module.md#see-also)
- [Examples](aci_dhcp_relay_provider_module.md#examples)
- [Return Values](aci_dhcp_relay_provider_module.md#return-values)

## [Synopsis](aci_dhcp_relay_provider_module.md#id1)

- Manage DHCP relay policy providers (dhcpRsProv) configuration on Cisco ACI fabrics.

## [Parameters](aci_dhcp_relay_provider_module.md#id2)
...
| **epg**  aliases: app_epg  string | Name of the Application EPG the DHCP server is in.  Only used when epg_type is epg |
| **epg_type**  string / required | Type of EPG the DHCP server is in  Choices:   - `"epg"` - `"l2_external"` - `"l3_external"` - `"dn"` |
| **external_epg**  aliases: external_net  string | Name of the external network object the DHCP server is in.  Only used when epg_type is l2_external or l3_external. |
...
| **provider_tenant**  string | Name of the tenant the epg or external_epg is in  Only required if the epg or external_epg is in a different tenant than the relay_policy |
| **relay_policy**  aliases: relay_policy_name  string | Name of an existing DHCP relay policy |
...
| **tenant**  string | Name of the tenant the relay_policy is in. |
...
## [Notes](aci_dhcp_relay_provider_module.md#id3)

> **Note:**
>
> - The `tenant` and `relay_policy` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module) and `cisco.aci.aci_dhcp_relay` modules can be used for this.

## [See Also](aci_dhcp_relay_provider_module.md#id4)
...
## [Examples](aci_dhcp_relay_provider_module.md#id5)
...
## [Return Values](aci_dhcp_relay_provider_module.md#id6)
