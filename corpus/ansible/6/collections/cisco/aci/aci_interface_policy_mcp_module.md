...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_mcp module – Manage MCP interface policies (mcp:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_mcp_module.html
fetched_at: 2026-07-27T16:50:00+00:00
---
# cisco.aci.aci_interface_policy_mcp module – Manage MCP interface policies (mcp:IfPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_mcp`.

- [Synopsis](aci_interface_policy_mcp_module.md#synopsis)
- [Parameters](aci_interface_policy_mcp_module.md#parameters)
- [See Also](aci_interface_policy_mcp_module.md#see-also)
- [Examples](aci_interface_policy_mcp_module.md#examples)
- [Return Values](aci_interface_policy_mcp_module.md#return-values)

## [Synopsis](aci_interface_policy_mcp_module.md#id1)

- Manage MCP interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_mcp_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Enable or disable admin state.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
| **description**  aliases: descr  string | The description for the MCP interface. |
...
| **mcp**  aliases: mcp_interface, name  string | The name of the MCP interface. |
...
## [See Also](aci_interface_policy_mcp_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **mcp:IfPol**.
>
...
## [Examples](aci_interface_policy_mcp_module.md#id4)
...
## [Return Values](aci_interface_policy_mcp_module.md#id5)
