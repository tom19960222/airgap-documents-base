...
collection: ansible
version: "6"
title: "cisco.aci.aci_vlan_pool module – Manage VLAN pools (fvns:VlanInstP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vlan_pool_module.html
fetched_at: 2026-07-27T16:50:38+00:00
---
# cisco.aci.aci_vlan_pool module – Manage VLAN pools (fvns:VlanInstP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_vlan_pool`.

- [Synopsis](aci_vlan_pool_module.md#synopsis)
- [Parameters](aci_vlan_pool_module.md#parameters)
- [See Also](aci_vlan_pool_module.md#see-also)
- [Examples](aci_vlan_pool_module.md#examples)
- [Return Values](aci_vlan_pool_module.md#return-values)

## [Synopsis](aci_vlan_pool_module.md#id1)

- Manage VLAN pools on Cisco ACI fabrics.

## [Parameters](aci_vlan_pool_module.md#id2)
...
| **pool_allocation_mode**  aliases: allocation_mode, mode  string | The method used for allocating VLANs to resources.  Choices:   - `"dynamic"` - `"static"` |
...
## [See Also](aci_vlan_pool_module.md#id3)
...
> :   More information about the internal APIC class **fvns:VlanInstP**.
>
...
## [Examples](aci_vlan_pool_module.md#id4)
...
## [Return Values](aci_vlan_pool_module.md#id5)
