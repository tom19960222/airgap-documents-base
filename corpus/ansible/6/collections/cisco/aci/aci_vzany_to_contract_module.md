...
collection: ansible
version: "6"
title: "cisco.aci.aci_vzany_to_contract module – Attach contracts to vzAny (vz:RsAnyToProv, vz:RsAnyToCons, vz:RsAnyToConsIf)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vzany_to_contract_module.html
fetched_at: 2026-07-27T16:50:43+00:00
---
# cisco.aci.aci_vzany_to_contract module – Attach contracts to vzAny (vz:RsAnyToProv, vz:RsAnyToCons, vz:RsAnyToConsIf)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_vzany_to_contract`.

- [Synopsis](aci_vzany_to_contract_module.md#synopsis)
- [Parameters](aci_vzany_to_contract_module.md#parameters)
- [See Also](aci_vzany_to_contract_module.md#see-also)
- [Examples](aci_vzany_to_contract_module.md#examples)
- [Return Values](aci_vzany_to_contract_module.md#return-values)

## [Synopsis](aci_vzany_to_contract_module.md#id1)

- Bind contracts to vzAny on Cisco ACI fabrics.

## [Parameters](aci_vzany_to_contract_module.md#id2)
...
| **contract**  aliases: contract_name  string | The name of the contract or contract interface. |
...
| **type**  aliases: contract_type  string / required | Determines if this is a provided or consumed contract or a consumed contract interface.  Choices:   - `"provider"` - `"consumer"` - `"interface"` |
...
## [See Also](aci_vzany_to_contract_module.md#id3)
...
## [Examples](aci_vzany_to_contract_module.md#id4)
...
## [Return Values](aci_vzany_to_contract_module.md#id5)
