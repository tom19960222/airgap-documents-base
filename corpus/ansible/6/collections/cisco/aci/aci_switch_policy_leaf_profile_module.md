...
collection: ansible
version: "6"
title: "cisco.aci.aci_switch_policy_leaf_profile module – Manage switch policy leaf profiles (infra:NodeP)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_switch_policy_leaf_profile_module.html
fetched_at: 2026-07-27T16:50:28+00:00
---
# cisco.aci.aci_switch_policy_leaf_profile module – Manage switch policy leaf profiles (infra:NodeP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_switch_policy_leaf_profile`.

- [Synopsis](aci_switch_policy_leaf_profile_module.md#synopsis)
- [Parameters](aci_switch_policy_leaf_profile_module.md#parameters)
- [See Also](aci_switch_policy_leaf_profile_module.md#see-also)
- [Examples](aci_switch_policy_leaf_profile_module.md#examples)
- [Return Values](aci_switch_policy_leaf_profile_module.md#return-values)

## [Synopsis](aci_switch_policy_leaf_profile_module.md#id1)

- Manage switch policy leaf profiles on Cisco ACI fabrics.

## [Parameters](aci_switch_policy_leaf_profile_module.md#id2)
...
| **description**  aliases: descr  string | Description for the Leaf Profile. |
...
| **leaf_profile**  aliases: leaf_profile_name, name  string | The name of the Leaf Profile. |
...
## [See Also](aci_switch_policy_leaf_profile_module.md#id3)
...
> :   More information about the internal APIC class **infra:NodeP**.
>
...
## [Examples](aci_switch_policy_leaf_profile_module.md#id4)
...
## [Return Values](aci_switch_policy_leaf_profile_module.md#id5)
