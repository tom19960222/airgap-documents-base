...
collection: ansible
version: "6"
title: "cisco.aci.aci_aaa_user module – Manage AAA users (aaa:User)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_aaa_user_module.html
fetched_at: 2026-07-27T16:49:02+00:00
---
...
> see [Requirements](aci_aaa_user_module.md#ansible-collections-cisco-aci-aci-aaa-user-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_user`.

- [Synopsis](aci_aaa_user_module.md#synopsis)
- [Requirements](aci_aaa_user_module.md#requirements)
- [Parameters](aci_aaa_user_module.md#parameters)
- [Notes](aci_aaa_user_module.md#notes)
- [See Also](aci_aaa_user_module.md#see-also)
- [Examples](aci_aaa_user_module.md#examples)
- [Return Values](aci_aaa_user_module.md#return-values)

## [Synopsis](aci_aaa_user_module.md#id2)

- Manage AAA users on Cisco ACI fabrics.

## [Requirements](aci_aaa_user_module.md#id3)

The below requirements are needed on the host that executes this module.

- python-dateutil

## [Parameters](aci_aaa_user_module.md#id4)
...
| **aaa_password_update_required**  boolean | Whether this account needs password update.  Choices:   - `false` - `true` |
| **aaa_user**  aliases: name, user  string | The name of the locally-authenticated user user to add. |
...
| **clear_password_history**  boolean | Whether to clear the password history of a locally-authenticated user.  Choices:   - `false` - `true` |
| **description**  aliases: descr  string | Description for the AAA user. |
| **email**  string | The email address of the locally-authenticated user. |
| **enabled**  boolean | The status of the locally-authenticated user account.  Choices:   - `false` - `true` |
| **expiration**  string | The expiration date of the locally-authenticated user account. |
| **expires**  boolean | Whether to enable an expiration date for the locally-authenticated user account.  Choices:   - `false` - `true` |
...
## [Notes](aci_aaa_user_module.md#id5)
...
## [See Also](aci_aaa_user_module.md#id6)

> **See also:**
>
> [cisco.aci.aci_aaa_user_certificate](aci_aaa_user_certificate_module.md#ansible-collections-cisco-aci-aci-aaa-user-certificate-module)
...
## [Examples](aci_aaa_user_module.md#id7)
...
## [Return Values](aci_aaa_user_module.md#id8)
