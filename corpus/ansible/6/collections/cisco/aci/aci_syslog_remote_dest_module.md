...
collection: ansible
version: "6"
title: "cisco.aci.aci_syslog_remote_dest module – Manage Syslog Remote Destinations (syslog:RemoteDest)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_syslog_remote_dest_module.html
fetched_at: 2026-07-27T16:50:30+00:00
---
# cisco.aci.aci_syslog_remote_dest module – Manage Syslog Remote Destinations (syslog:RemoteDest).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_syslog_remote_dest`.

- [Synopsis](aci_syslog_remote_dest_module.md#synopsis)
- [Parameters](aci_syslog_remote_dest_module.md#parameters)
- [See Also](aci_syslog_remote_dest_module.md#see-also)
- [Examples](aci_syslog_remote_dest_module.md#examples)
- [Return Values](aci_syslog_remote_dest_module.md#return-values)

## [Synopsis](aci_syslog_remote_dest_module.md#id1)

- Manage remote destinations for syslog messages within an existing syslog group object

## [Parameters](aci_syslog_remote_dest_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  string | Administrative state of the syslog remote destination  Choices:   - `"enabled"` - `"disabled"` |
...
| **facility**  string | Forwarding facility for syslog messages  Choices:   - `"local0"` - `"local1"` - `"local2"` - `"local3"` - `"local4"` - `"local5"` - `"local6"` - `"local7"` |
| **format**  string | Format of the syslog messages  Choices:   - `"aci"` - `"nxos"` |
| **group**  aliases: syslog_group, syslog_group_name  string | Name of an existing syslog group |
...
| **name**  aliases: remote_destination_name, remote_destination  string | Name of the syslog remote destination |
...
| **severity**  string | Severity of messages to send to remote syslog  Choices:   - `"alerts"` - `"critical"` - `"debugging"` - `"emergencies"` - `"error"` - `"information"` - `"notifications"` - `"warnings"` |
...
| **syslog_port**  integer | UDP port to send syslog messages to |
...
## [See Also](aci_syslog_remote_dest_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **syslog:RemoteDest**.
>
...
## [Examples](aci_syslog_remote_dest_module.md#id4)
...
## [Return Values](aci_syslog_remote_dest_module.md#id5)
