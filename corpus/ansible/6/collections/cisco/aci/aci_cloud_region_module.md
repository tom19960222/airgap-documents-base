...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_region module – Manage Cloud Providers Region (cloud:Region)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_region_module.html
fetched_at: 2026-07-27T16:49:22+00:00
---
# cisco.aci.aci_cloud_region module – Manage Cloud Providers Region (cloud:Region)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_region`.

- [Synopsis](aci_cloud_region_module.md#synopsis)
- [Parameters](aci_cloud_region_module.md#parameters)
- [Notes](aci_cloud_region_module.md#notes)
- [See Also](aci_cloud_region_module.md#see-also)
- [Examples](aci_cloud_region_module.md#examples)
- [Return Values](aci_cloud_region_module.md#return-values)

## [Synopsis](aci_cloud_region_module.md#id1)

- Manage Cloud Providers Region on Cisco Cloud ACI.

## [Parameters](aci_cloud_region_module.md#id2)
...
| **cloud**  string / required | The vendor of the controller  Choices:   - `"aws"` - `"azure"` |
...
| **region**  aliases: name  string | The name of the cloud provider’s region. |
| **state**  string | Use `present` or `absent` for adding or removing.  Use `query` for listing an object or multiple objects.  Choices:   - `"query"` ← (default) |
...
## [Notes](aci_cloud_region_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:Region** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).
> - This module is used to query Cloud Providers Region.

## [See Also](aci_cloud_region_module.md#id4)
...
## [Examples](aci_cloud_region_module.md#id5)
...
## [Return Values](aci_cloud_region_module.md#id6)
