...
collection: ansible
version: "6"
title: "cisco.aci.aci_l3out_interface_secondary_ip module – Manage Layer 3 Outside (L3Out) interface secondary IP addresses (l3ext:Ip)."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l3out_interface_secondary_ip_module.html
fetched_at: 2026-07-27T16:50:12+00:00
---
# cisco.aci.aci_l3out_interface_secondary_ip module – Manage Layer 3 Outside (L3Out) interface secondary IP addresses (l3ext:Ip).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_interface_secondary_ip`.

- [Synopsis](aci_l3out_interface_secondary_ip_module.md#synopsis)
- [Parameters](aci_l3out_interface_secondary_ip_module.md#parameters)
- [Notes](aci_l3out_interface_secondary_ip_module.md#notes)
- [See Also](aci_l3out_interface_secondary_ip_module.md#see-also)
- [Examples](aci_l3out_interface_secondary_ip_module.md#examples)
- [Return Values](aci_l3out_interface_secondary_ip_module.md#return-values)

## [Synopsis](aci_l3out_interface_secondary_ip_module.md#id1)

- Manage Layer 3 Outside (L3Out) interface secondary IP addresses (l3ext:Ip).

## [Parameters](aci_l3out_interface_secondary_ip_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  aliases: addr, ip_address  string | Secondary IP address. |
...
| **side**  string | Provides the side for vPC member interfaces.  Choices:   - `"A"` - `"B"` |
...
## [Notes](aci_l3out_interface_secondary_ip_module.md#id3)

> **Note:**
>
> - This is a test

## [See Also](aci_l3out_interface_secondary_ip_module.md#id4)
...
> :   The official documentation on the **aci_l3out_logical_interface** module.
>
...
## [Examples](aci_l3out_interface_secondary_ip_module.md#id5)
...
## [Return Values](aci_l3out_interface_secondary_ip_module.md#id6)
