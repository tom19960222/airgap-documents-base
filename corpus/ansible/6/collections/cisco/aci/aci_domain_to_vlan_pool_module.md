...
collection: ansible
version: "6"
title: "cisco.aci.aci_domain_to_vlan_pool module – Bind Domain to VLAN Pools (infra:RsVlanNs)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_domain_to_vlan_pool_module.html
fetched_at: 2026-07-27T16:49:34+00:00
---
# cisco.aci.aci_domain_to_vlan_pool module – Bind Domain to VLAN Pools (infra:RsVlanNs)
...
- [Synopsis](aci_domain_to_vlan_pool_module.md#synopsis)
- [Parameters](aci_domain_to_vlan_pool_module.md#parameters)
- [Notes](aci_domain_to_vlan_pool_module.md#notes)
- [See Also](aci_domain_to_vlan_pool_module.md#see-also)
- [Examples](aci_domain_to_vlan_pool_module.md#examples)
- [Return Values](aci_domain_to_vlan_pool_module.md#return-values)

## [Synopsis](aci_domain_to_vlan_pool_module.md#id1)

- Bind Domain to VLAN Pools on Cisco ACI fabrics.

## [Parameters](aci_domain_to_vlan_pool_module.md#id2)
...
| **domain**  aliases: domain_name, domain_profile  string | Name of the domain being associated with the VLAN Pool. |
...
| **pool**  aliases: pool_name, vlan_pool  string | The name of the pool. |
| **pool_allocation_mode**  aliases: allocation_mode, mode  string / required | The method used for allocating VLANs to resources.  Choices:   - `"dynamic"` - `"static"` |
...
## [Notes](aci_domain_to_vlan_pool_module.md#id3)

> **Note:**
>
> - The `domain` and `vlan_pool` parameters should exist before using this module. The [cisco.aci.aci_domain](aci_domain_module.md#ansible-collections-cisco-aci-aci-domain-module) and [cisco.aci.aci_vlan_pool](aci_vlan_pool_module.md#ansible-collections-cisco-aci-aci-vlan-pool-module) can be used for these.

## [See Also](aci_domain_to_vlan_pool_module.md#id4)
...
## [Examples](aci_domain_to_vlan_pool_module.md#id5)
...
## [Return Values](aci_domain_to_vlan_pool_module.md#id6)
