...
collection: ansible
version: "6"
title: "cisco.aci.aci_contract_subject_to_filter module – Bind Contract Subjects to Filters (vz:RsSubjFiltAtt)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_contract_subject_to_filter_module.html
fetched_at: 2026-07-27T16:49:28+00:00
---
# cisco.aci.aci_contract_subject_to_filter module – Bind Contract Subjects to Filters (vz:RsSubjFiltAtt)
...
- [Synopsis](aci_contract_subject_to_filter_module.md#synopsis)
- [Parameters](aci_contract_subject_to_filter_module.md#parameters)
- [Notes](aci_contract_subject_to_filter_module.md#notes)
- [See Also](aci_contract_subject_to_filter_module.md#see-also)
- [Examples](aci_contract_subject_to_filter_module.md#examples)
- [Return Values](aci_contract_subject_to_filter_module.md#return-values)

## [Synopsis](aci_contract_subject_to_filter_module.md#id1)

- Bind Contract Subjects to Filters on Cisco ACI fabrics.

## [Parameters](aci_contract_subject_to_filter_module.md#id2)
...
| **filter**  aliases: filter_name  string | The name of the Filter to bind to the Subject. |
...
| **log**  aliases: directive  string | Determines if the binding should be set to log.  The APIC defaults to `none` when unset during creation.  Choices:   - `"log"` - `"none"` |
...
| **subject**  aliases: contract_subject, subject_name  string | The name of the Contract Subject. |
...
## [Notes](aci_contract_subject_to_filter_module.md#id3)

> **Note:**
>
> - The `tenant`, `contract`, `subject`, and `filter_name` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), [cisco.aci.aci_contract](aci_contract_module.md#ansible-collections-cisco-aci-aci-contract-module), [cisco.aci.aci_contract_subject](aci_contract_subject_module.md#ansible-collections-cisco-aci-aci-contract-subject-module), and [cisco.aci.aci_filter](aci_filter_module.md#ansible-collections-cisco-aci-aci-filter-module) modules can be used for these.

## [See Also](aci_contract_subject_to_filter_module.md#id4)
...
## [Examples](aci_contract_subject_to_filter_module.md#id5)
...
## [Return Values](aci_contract_subject_to_filter_module.md#id6)
