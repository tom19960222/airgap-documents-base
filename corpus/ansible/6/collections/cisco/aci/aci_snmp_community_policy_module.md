...
collection: ansible
version: "6"
title: "cisco.aci.aci_snmp_community_policy module – Manage SNMP community policies ( snmp:CommunityP )."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_snmp_community_policy_module.html
fetched_at: 2026-07-27T16:50:24+00:00
---
# cisco.aci.aci_snmp_community_policy module – Manage SNMP community policies (<snmp:CommunityP>).
...
>
> To use it in a playbook, specify: `cisco.aci.aci_snmp_community_policy`.

- [Synopsis](aci_snmp_community_policy_module.md#synopsis)
- [Parameters](aci_snmp_community_policy_module.md#parameters)
- [See Also](aci_snmp_community_policy_module.md#see-also)
- [Examples](aci_snmp_community_policy_module.md#examples)
- [Return Values](aci_snmp_community_policy_module.md#return-values)

## [Synopsis](aci_snmp_community_policy_module.md#id1)

- Manage SNMP community policies

## [Parameters](aci_snmp_community_policy_module.md#id2)
...
## [See Also](aci_snmp_community_policy_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **snmp:CommunityP**.
>
...
## [Examples](aci_snmp_community_policy_module.md#id4)
...
## [Return Values](aci_snmp_community_policy_module.md#id5)
