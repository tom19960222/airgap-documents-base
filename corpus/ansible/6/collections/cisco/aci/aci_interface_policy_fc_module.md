...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_fc module – Manage Fibre Channel interface policies (fc:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_fc_module.html
fetched_at: 2026-07-27T16:49:55+00:00
---
# cisco.aci.aci_interface_policy_fc module – Manage Fibre Channel interface policies (fc:IfPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_fc`.

- [Synopsis](aci_interface_policy_fc_module.md#synopsis)
- [Parameters](aci_interface_policy_fc_module.md#parameters)
- [See Also](aci_interface_policy_fc_module.md#see-also)
- [Examples](aci_interface_policy_fc_module.md#examples)
- [Return Values](aci_interface_policy_fc_module.md#return-values)

## [Synopsis](aci_interface_policy_fc_module.md#id1)

- Manage ACI Fiber Channel interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_fc_module.md#id2)
...
| **description**  aliases: descr  string | The description of the Fiber Channel interface policy. |
| **fc_policy**  aliases: name  string | The name of the Fiber Channel interface policy. |
...
| **port_mode**  string | The Port Mode to use.  The APIC defaults to `f` when unset during creation.  Choices:   - `"f"` - `"np"` |
...
## [See Also](aci_interface_policy_fc_module.md#id3)
...
## [Examples](aci_interface_policy_fc_module.md#id4)
...
## [Return Values](aci_interface_policy_fc_module.md#id5)
