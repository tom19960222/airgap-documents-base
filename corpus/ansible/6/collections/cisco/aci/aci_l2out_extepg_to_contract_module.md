...
collection: ansible
version: "6"
title: "cisco.aci.aci_l2out_extepg_to_contract module – Bind Contracts to L2 External End Point Groups (EPGs)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_l2out_extepg_to_contract_module.html
fetched_at: 2026-07-27T16:50:05+00:00
---
# cisco.aci.aci_l2out_extepg_to_contract module – Bind Contracts to L2 External End Point Groups (EPGs)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l2out_extepg_to_contract`.

- [Synopsis](aci_l2out_extepg_to_contract_module.md#synopsis)
- [Parameters](aci_l2out_extepg_to_contract_module.md#parameters)
- [Notes](aci_l2out_extepg_to_contract_module.md#notes)
- [See Also](aci_l2out_extepg_to_contract_module.md#see-also)
- [Examples](aci_l2out_extepg_to_contract_module.md#examples)
- [Return Values](aci_l2out_extepg_to_contract_module.md#return-values)

## [Synopsis](aci_l2out_extepg_to_contract_module.md#id1)

- Bind Contracts to L2 External End Point Groups (EPGs) on ACI fabrics.

## [Parameters](aci_l2out_extepg_to_contract_module.md#id2)
...
| **contract_type**  string / required | The type of contract.  Choices:   - `"consumer"` - `"provider"` |
| **extepg**  aliases: extepg_name, external_epg  string | Name of the external end point group. |
...
| **l2out**  aliases: l2out_name  string | Name of the l2out. |
...
| **priority**  string | This has four levels of priority.  Choices:   - `"level1"` - `"level2"` - `"level3"` - `"unspecified"` |
...
| **provider_match**  string | This is configurable for provided contracts.  Choices:   - `"all"` - `"at_least_one"` - `"at_most_one"` - `"none"` |
...
## [Notes](aci_l2out_extepg_to_contract_module.md#id3)

> **Note:**
>
> - The `tenant`, `l2out` and `extepg` must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), [cisco.aci.aci_l2out](aci_l2out_module.md#ansible-collections-cisco-aci-aci-l2out-module) and [cisco.aci.aci_l2out_extepg](aci_l2out_extepg_module.md#ansible-collections-cisco-aci-aci-l2out-extepg-module) modules can be used for this.

## [See Also](aci_l2out_extepg_to_contract_module.md#id4)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fvtenant**, **l2extInstP** and **l2extOut**.
>
...
## [Examples](aci_l2out_extepg_to_contract_module.md#id5)
...
## [Return Values](aci_l2out_extepg_to_contract_module.md#id6)
