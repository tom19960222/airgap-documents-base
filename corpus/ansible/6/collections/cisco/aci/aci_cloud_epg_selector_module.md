...
collection: ansible
version: "6"
title: "cisco.aci.aci_cloud_epg_selector module – Manage Cloud Endpoint Selector (cloud:EPSelector)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_cloud_epg_selector_module.html
fetched_at: 2026-07-27T16:49:19+00:00
---
# cisco.aci.aci_cloud_epg_selector module – Manage Cloud Endpoint Selector (cloud:EPSelector)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_cloud_epg_selector`.

- [Synopsis](aci_cloud_epg_selector_module.md#synopsis)
- [Parameters](aci_cloud_epg_selector_module.md#parameters)
- [Notes](aci_cloud_epg_selector_module.md#notes)
- [See Also](aci_cloud_epg_selector_module.md#see-also)
- [Examples](aci_cloud_epg_selector_module.md#examples)
- [Return Values](aci_cloud_epg_selector_module.md#return-values)

## [Synopsis](aci_cloud_epg_selector_module.md#id1)

- Manage Cloud Endpoint Selector on Cisco Cloud ACI

## [Parameters](aci_cloud_epg_selector_module.md#id2)
...
| **ap**  string / required | The name of the cloud application profile. |
...
| **epg**  string / required | The name of the cloud EPG. |
| **expressions**  list / elements=dictionary | Expressions associated to this selector. |
| **key**  string / required | The key of the expression.  The key is custom or is one of region, zone and ip  The key can be zone only when the site is AWS. |
| **operator**  string / required | The operator associated to the expression.  Operator `has_key` or `does_not_have_key` is only available for key custom or zone  Choices:   - `"not_in"` - `"in"` - `"equals"` - `"not_equals"` - `"has_key"` - `"does_not_have_key"` |
...
| **name**  aliases: selector, selector_name  string | The name of the Cloud Endpoint selector. |
...
| **tenant**  string / required | The name of the existing tenant. |
...
## [Notes](aci_cloud_epg_selector_module.md#id3)

> **Note:**
>
> - More information about the internal APIC class **cloud:EPSelector** from [the APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/).

## [See Also](aci_cloud_epg_selector_module.md#id4)
...
## [Examples](aci_cloud_epg_selector_module.md#id5)
...
## [Return Values](aci_cloud_epg_selector_module.md#id6)
