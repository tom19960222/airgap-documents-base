...
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_vmm_controller_module.html
...
| **dvs_version**  string | Version of the VMware DVS.  Choices:   - `"unmanaged"` - `"5.1"` - `"5.5"` - `"6.0"` - `"6.5"` - `"6.6"` - `"7.0"` |
