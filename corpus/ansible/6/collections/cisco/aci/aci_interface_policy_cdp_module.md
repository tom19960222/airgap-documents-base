...
collection: ansible
version: "6"
title: "cisco.aci.aci_interface_policy_cdp module – Manage CDP interface policies (cdp:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_interface_policy_cdp_module.html
fetched_at: 2026-07-27T16:49:55+00:00
---
# cisco.aci.aci_interface_policy_cdp module – Manage CDP interface policies (cdp:IfPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_cdp`.

- [Synopsis](aci_interface_policy_cdp_module.md#synopsis)
- [Parameters](aci_interface_policy_cdp_module.md#parameters)
- [See Also](aci_interface_policy_cdp_module.md#see-also)
- [Examples](aci_interface_policy_cdp_module.md#examples)
- [Return Values](aci_interface_policy_cdp_module.md#return-values)

## [Synopsis](aci_interface_policy_cdp_module.md#id1)

- Manage CDP interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_cdp_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Enable or Disable CDP state.  The APIC defaults to `yes` when unset during creation.  Choices:   - `false` - `true` |
...
| **cdp_policy**  aliases: cdp_interface, name  string | The CDP interface policy name. |
...
| **description**  aliases: descr  string | The description for the CDP interface policy name. |
...
## [See Also](aci_interface_policy_cdp_module.md#id3)
...
## [Examples](aci_interface_policy_cdp_module.md#id4)
...
## [Return Values](aci_interface_policy_cdp_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **current**  list / elements=string | The existing configuration from the APIC after the module has finished  Returned: success  Sample: `[{"cdpIfPol": {"attributes": {"adminSt": "disabled", "annotation": "", "descr": "Ansible Created CDP Test Policy", "dn": "uni/infra/cdpIfP-Ansible_CDP_Test_Policy", "name": "Ansible_CDP_Test_Policy", "nameAlias": "", "ownerKey": "", "ownerTag": ""}}}]` |
