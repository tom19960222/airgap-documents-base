...
collection: ansible
version: "6"
title: "cisco.aci.aci_esg_ip_subnet_selector module – Manage ESG IP Subnet selector(fv:EPSelector)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_esg_ip_subnet_selector_module.html
fetched_at: 2026-07-27T16:49:42+00:00
---
# cisco.aci.aci_esg_ip_subnet_selector module – Manage ESG IP Subnet selector(fv:EPSelector)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_esg_ip_subnet_selector`.

- [Synopsis](aci_esg_ip_subnet_selector_module.md#synopsis)
- [Parameters](aci_esg_ip_subnet_selector_module.md#parameters)
- [See Also](aci_esg_ip_subnet_selector_module.md#see-also)
- [Examples](aci_esg_ip_subnet_selector_module.md#examples)
- [Return Values](aci_esg_ip_subnet_selector_module.md#return-values)

## [Synopsis](aci_esg_ip_subnet_selector_module.md#id1)

- Manage Endpoint Security Groups (ESG) IP Subnet selector on Cisco ACI fabrics.

## [Parameters](aci_esg_ip_subnet_selector_module.md#id2)
...
| **description**  aliases: ip_subnet_selector_description  string | Description of the ESG IP Subnet selector. |
...
| **ip**  aliases: subnet  string | IP address of the subnet selector. |
...
## [See Also](aci_esg_ip_subnet_selector_module.md#id3)
...
## [Examples](aci_esg_ip_subnet_selector_module.md#id4)
...
## [Return Values](aci_esg_ip_subnet_selector_module.md#id5)
