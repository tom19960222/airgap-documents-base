...
collection: ansible
version: "6"
title: "cisco.aci.aci_domain_to_encap_pool module – Bind Domain to Encap Pools (infra:RsVlanNs)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/aci/aci_domain_to_encap_pool_module.html
fetched_at: 2026-07-27T16:49:33+00:00
---
# cisco.aci.aci_domain_to_encap_pool module – Bind Domain to Encap Pools (infra:RsVlanNs)
...
- [Synopsis](aci_domain_to_encap_pool_module.md#synopsis)
- [Parameters](aci_domain_to_encap_pool_module.md#parameters)
- [Notes](aci_domain_to_encap_pool_module.md#notes)
- [See Also](aci_domain_to_encap_pool_module.md#see-also)
- [Examples](aci_domain_to_encap_pool_module.md#examples)
- [Return Values](aci_domain_to_encap_pool_module.md#return-values)

## [Synopsis](aci_domain_to_encap_pool_module.md#id1)

- Bind Domain to Encap Pools on Cisco ACI fabrics.

## [Parameters](aci_domain_to_encap_pool_module.md#id2)
...
| **domain**  aliases: domain_name, domain_profile  string | Name of the domain being associated with the Encap Pool. |
| **domain_type**  string / required | Determines if the Domain is physical (phys) or virtual (vmm).  Choices:   - `"fc"` - `"l2dom"` - `"l3dom"` - `"phys"` - `"vmm"` |
...
| **pool**  aliases: pool_name  string | The name of the pool. |
...
| **pool_type**  string / required | The encap type of `pool`.  Choices:   - `"vlan"` - `"vsan"` - `"vxlan"` |
...
## [Notes](aci_domain_to_encap_pool_module.md#id3)

> **Note:**
>
> - The `domain` and `encap_pool` parameters should exist before using this module. The [cisco.aci.aci_domain](aci_domain_module.md#ansible-collections-cisco-aci-aci-domain-module) and [cisco.aci.aci_encap_pool](aci_encap_pool_module.md#ansible-collections-cisco-aci-aci-encap-pool-module) can be used for these.

## [See Also](aci_domain_to_encap_pool_module.md#id4)
...
>
> [cisco.aci.aci_encap_pool](aci_encap_pool_module.md#ansible-collections-cisco-aci-aci-encap-pool-module)
...
## [Examples](aci_domain_to_encap_pool_module.md#id5)
...
## [Return Values](aci_domain_to_encap_pool_module.md#id6)
