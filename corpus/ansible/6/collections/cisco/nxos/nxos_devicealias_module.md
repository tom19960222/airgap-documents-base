...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_devicealias module – Configuration of device alias for Cisco NXOS MDS Switches."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_devicealias_module.html
...
- [Synopsis](nxos_devicealias_module.md#synopsis)
- [Parameters](nxos_devicealias_module.md#parameters)
- [Notes](nxos_devicealias_module.md#notes)
- [Examples](nxos_devicealias_module.md#examples)
- [Return Values](nxos_devicealias_module.md#return-values)

## [Synopsis](nxos_devicealias_module.md#id1)

- Configuration of device alias for Cisco MDS NXOS.

## [Parameters](nxos_devicealias_module.md#id2)
...
## [Notes](nxos_devicealias_module.md#id3)

> **Note:**
>
> - Tested against Cisco MDS NX-OS 8.4(1)

## [Examples](nxos_devicealias_module.md#id4)
...
## [Return Values](nxos_devicealias_module.md#id5)
