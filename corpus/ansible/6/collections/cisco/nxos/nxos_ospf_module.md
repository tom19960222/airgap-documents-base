...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_ospf module – (deprecated, removed after 2022-06-01) Manages configuration of an ospf instance."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_ospf_module.html
fetched_at: 2026-07-27T17:02:09+00:00
---
# cisco.nxos.nxos_ospf module – (deprecated, removed after 2022-06-01) Manages configuration of an ospf instance.
...
>
> To use it in a playbook, specify: `cisco.nxos.nxos_ospf`.

New in cisco.nxos 1.0.0

- [DEPRECATED](nxos_ospf_module.md#deprecated)
- [Synopsis](nxos_ospf_module.md#synopsis)
- [Parameters](nxos_ospf_module.md#parameters)
- [Notes](nxos_ospf_module.md#notes)
- [Examples](nxos_ospf_module.md#examples)
- [Return Values](nxos_ospf_module.md#return-values)
- [Status](nxos_ospf_module.md#status)

## [DEPRECATED](nxos_ospf_module.md#id1)
...
## [Synopsis](nxos_ospf_module.md#id2)
...
## [Parameters](nxos_ospf_module.md#id3)
...
## [Examples](nxos_ospf_module.md#id5)
...
## [Return Values](nxos_ospf_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **commands**  list / elements=string | commands sent to the device  Returned: always  Sample: `["router ospf 1"]` |

## [Status](nxos_ospf_module.md#id7)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](nxos_ospf_module.md#deprecated).
