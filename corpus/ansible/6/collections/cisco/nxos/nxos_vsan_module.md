...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_vsan module – Configuration of vsan for Cisco NXOS MDS Switches."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_vsan_module.html
fetched_at: 2026-07-27T17:02:36+00:00
---
...
- [Synopsis](nxos_vsan_module.md#synopsis)
- [Parameters](nxos_vsan_module.md#parameters)
- [Notes](nxos_vsan_module.md#notes)
- [Examples](nxos_vsan_module.md#examples)
- [Return Values](nxos_vsan_module.md#return-values)

## [Synopsis](nxos_vsan_module.md#id1)

- Configuration of vsan for Cisco MDS NXOS.

## [Parameters](nxos_vsan_module.md#id2)
...
## [Notes](nxos_vsan_module.md#id3)

> **Note:**
>
> - Tested against Cisco MDS NX-OS 8.4(1)

## [Examples](nxos_vsan_module.md#id4)
...
## [Return Values](nxos_vsan_module.md#id5)
