...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_lldp module – (deprecated, removed after 2022-06-01) Manage LLDP configuration on Cisco NXOS network devices."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_lldp_module.html
fetched_at: 2026-07-27T17:02:02+00:00
---
# cisco.nxos.nxos_lldp module – (deprecated, removed after 2022-06-01) Manage LLDP configuration on Cisco NXOS network devices.
...
>
> To use it in a playbook, specify: `cisco.nxos.nxos_lldp`.

New in cisco.nxos 1.0.0

- [DEPRECATED](nxos_lldp_module.md#deprecated)
- [Synopsis](nxos_lldp_module.md#synopsis)
- [Parameters](nxos_lldp_module.md#parameters)
- [Notes](nxos_lldp_module.md#notes)
- [Examples](nxos_lldp_module.md#examples)
- [Return Values](nxos_lldp_module.md#return-values)
- [Status](nxos_lldp_module.md#status)

## [DEPRECATED](nxos_lldp_module.md#id1)
...
## [Synopsis](nxos_lldp_module.md#id2)
...
## [Parameters](nxos_lldp_module.md#id3)
...
## [Examples](nxos_lldp_module.md#id5)
...
## [Return Values](nxos_lldp_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **commands**  list / elements=string | The list of configuration mode commands to send to the device  Returned: always, except for the platforms that use Netconf transport to manage the device.  Sample: `["feature lldp"]` |

## [Status](nxos_lldp_module.md#id7)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](nxos_lldp_module.md#deprecated).
