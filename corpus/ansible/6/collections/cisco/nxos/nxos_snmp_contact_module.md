...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_snmp_contact module – (deprecated, removed after 2024-01-01) Manages SNMP contact info."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_snmp_contact_module.html
fetched_at: 2026-07-27T17:02:22+00:00
---
# cisco.nxos.nxos_snmp_contact module – (deprecated, removed after 2024-01-01) Manages SNMP contact info.
...
>
> To use it in a playbook, specify: `cisco.nxos.nxos_snmp_contact`.

New in cisco.nxos 1.0.0

- [DEPRECATED](nxos_snmp_contact_module.md#deprecated)
- [Synopsis](nxos_snmp_contact_module.md#synopsis)
- [Parameters](nxos_snmp_contact_module.md#parameters)
- [Notes](nxos_snmp_contact_module.md#notes)
- [Examples](nxos_snmp_contact_module.md#examples)
- [Return Values](nxos_snmp_contact_module.md#return-values)
- [Status](nxos_snmp_contact_module.md#status)

## [DEPRECATED](nxos_snmp_contact_module.md#id1)
...
## [Synopsis](nxos_snmp_contact_module.md#id2)
...
## [Parameters](nxos_snmp_contact_module.md#id3)
...
## [Notes](nxos_snmp_contact_module.md#id4)
...
## [Examples](nxos_snmp_contact_module.md#id5)
...
## [Return Values](nxos_snmp_contact_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **commands**  list / elements=string | commands sent to the device  Returned: always  Sample: `["snmp-server contact New_Test"]` |

## [Status](nxos_snmp_contact_module.md#id7)

- This module will be removed in a major release after 2024-01-01.
  *[deprecated]*
- For more information see [DEPRECATED](nxos_snmp_contact_module.md#deprecated).
