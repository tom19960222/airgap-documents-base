...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_acl_interface module – (deprecated, removed after 2022-06-01) Manages applying ACLs to interfaces."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_acl_interface_module.html
fetched_at: 2026-07-27T17:01:34+00:00
---
# cisco.nxos.nxos_acl_interface module – (deprecated, removed after 2022-06-01) Manages applying ACLs to interfaces.
...
>
> To use it in a playbook, specify: `cisco.nxos.nxos_acl_interface`.

New in cisco.nxos 1.0.0

- [DEPRECATED](nxos_acl_interface_module.md#deprecated)
- [Synopsis](nxos_acl_interface_module.md#synopsis)
- [Parameters](nxos_acl_interface_module.md#parameters)
- [Notes](nxos_acl_interface_module.md#notes)
- [Examples](nxos_acl_interface_module.md#examples)
- [Return Values](nxos_acl_interface_module.md#return-values)
- [Status](nxos_acl_interface_module.md#status)

## [DEPRECATED](nxos_acl_interface_module.md#id1)
...
## [Synopsis](nxos_acl_interface_module.md#id2)
...
## [Parameters](nxos_acl_interface_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **direction**  string / required | Direction ACL to be applied in on the interface.  Choices:   - `"ingress"` - `"egress"` |
| **interface**  string / required | Full name of interface, e.g. *Ethernet1/1*. |
...
## [Notes](nxos_acl_interface_module.md#id4)
...
## [Examples](nxos_acl_interface_module.md#id5)
...
## [Return Values](nxos_acl_interface_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **acl_applied_to**  list / elements=string | list of interfaces the ACL is applied to  Returned: always  Sample: `[{"acl_type": "Router ACL", "direction": "egress", "interface": "Ethernet1/41", "name": "ANSIBLE"}]` |
| **commands**  list / elements=string | commands sent to the device  Returned: always  Sample: `["interface ethernet1/41", "ip access-group ANSIBLE out"]` |

## [Status](nxos_acl_interface_module.md#id7)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](nxos_acl_interface_module.md#deprecated).
