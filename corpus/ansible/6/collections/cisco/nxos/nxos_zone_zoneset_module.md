...
collection: ansible
version: "6"
title: "cisco.nxos.nxos_zone_zoneset module – Configuration of zone/zoneset for Cisco NXOS MDS Switches."
source_url: https://docs.ansible.com/projects/ansible/6/collections/cisco/nxos/nxos_zone_zoneset_module.html
...
- [Synopsis](nxos_zone_zoneset_module.md#synopsis)
- [Parameters](nxos_zone_zoneset_module.md#parameters)
- [Notes](nxos_zone_zoneset_module.md#notes)
- [Examples](nxos_zone_zoneset_module.md#examples)
- [Return Values](nxos_zone_zoneset_module.md#return-values)

## [Synopsis](nxos_zone_zoneset_module.md#id1)

- Configuration of zone/zoneset for Cisco MDS NXOS.

## [Parameters](nxos_zone_zoneset_module.md#id2)
...
## [Notes](nxos_zone_zoneset_module.md#id3)

> **Note:**
>
> - Tested against Cisco MDS NX-OS 8.4(1)

## [Examples](nxos_zone_zoneset_module.md#id4)
...
## [Return Values](nxos_zone_zoneset_module.md#id5)
