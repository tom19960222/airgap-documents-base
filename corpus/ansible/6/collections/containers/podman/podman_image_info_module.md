...
collection: ansible
version: "6"
title: "containers.podman.podman_image_info module – Gather info about images using podman"
source_url: https://docs.ansible.com/projects/ansible/6/collections/containers/podman/podman_image_info_module.html
fetched_at: 2026-07-27T17:24:31+00:00
---
...
- [Synopsis](podman_image_info_module.md#synopsis)
- [Parameters](podman_image_info_module.md#parameters)
- [Notes](podman_image_info_module.md#notes)
- [Examples](podman_image_info_module.md#examples)
- [Return Values](podman_image_info_module.md#return-values)

## [Synopsis](podman_image_info_module.md#id1)

- Gather info about images using `podman`

## [Parameters](podman_image_info_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **executable**  string | Path to `podman` executable if it is not in the `$PATH` on the machine running `podman`  Default: `"podman"` |
| **name**  list / elements=string | List of tags or UID to gather info about. If no name is given return info about all images. |

## [Notes](podman_image_info_module.md#id3)

> **Note:**
>
> - Podman may required elevated privileges in order to run properly.

## [Examples](podman_image_info_module.md#id4)
