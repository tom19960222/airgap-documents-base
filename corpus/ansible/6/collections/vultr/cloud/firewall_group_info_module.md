...
collection: ansible
version: "6"
title: "vultr.cloud.firewall_group_info module – Gather information about the Vultr firewall groups"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vultr/cloud/firewall_group_info_module.html
fetched_at: 2026-07-28T00:23:00+00:00
---
# vultr.cloud.firewall_group_info module – Gather information about the Vultr firewall groups
...
>
> To use it in a playbook, specify: `vultr.cloud.firewall_group_info`.

New in vultr.cloud 1.0.0

- [Synopsis](firewall_group_info_module.md#synopsis)
- [Parameters](firewall_group_info_module.md#parameters)
- [Notes](firewall_group_info_module.md#notes)
- [Examples](firewall_group_info_module.md#examples)
- [Return Values](firewall_group_info_module.md#return-values)

## [Synopsis](firewall_group_info_module.md#id1)

- Gather information about firewall groups available.

## [Parameters](firewall_group_info_module.md#id2)
...
## [Notes](firewall_group_info_module.md#id3)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](firewall_group_info_module.md#id4)
...
## [Return Values](firewall_group_info_module.md#id5)
...
| **vultr_firewall_group_info**  list / elements=string | Response from Vultr API as list.  Returned: success |
