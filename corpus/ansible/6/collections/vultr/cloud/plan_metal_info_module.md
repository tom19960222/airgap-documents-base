...
collection: ansible
version: "6"
title: "vultr.cloud.plan_metal_info module – Gather information about the Vultr bare metal plans"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vultr/cloud/plan_metal_info_module.html
fetched_at: 2026-07-28T00:23:04+00:00
---
# vultr.cloud.plan_metal_info module – Gather information about the Vultr bare metal plans
...
>
> To use it in a playbook, specify: `vultr.cloud.plan_metal_info`.

New in vultr.cloud 1.0.0

- [Synopsis](plan_metal_info_module.md#synopsis)
- [Parameters](plan_metal_info_module.md#parameters)
- [Notes](plan_metal_info_module.md#notes)
- [Examples](plan_metal_info_module.md#examples)
- [Return Values](plan_metal_info_module.md#return-values)

## [Synopsis](plan_metal_info_module.md#id1)

- Gather information about plans available to boot servers.

## [Parameters](plan_metal_info_module.md#id2)
...
## [Notes](plan_metal_info_module.md#id3)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](plan_metal_info_module.md#id4)
...
## [Return Values](plan_metal_info_module.md#id5)
...
| **bandwidth**  integer | Bandwidth in MB.  Returned: success  Sample: `5120` |
| **cpu_count**  integer | Amount of CPUs.  Returned: success  Sample: `4` |
| **cpu_model**  string | CPU model.  Returned: success  Sample: `"E3-1270v6"` |
| **cpu_threads**  integer | Amount of CPU threads.  Returned: success  Sample: `8` |
| **disk**  integer | Disk size in GB.  Returned: success  Sample: `240` |
| **disk_count**  integer | Amount of disks.  Returned: success  Sample: `2` |
| **id**  string | ID of the plan.  Returned: success  Sample: `"vbm-4c-32gb"` |
| **locations**  list / elements=string | List of locations the plan is available in.  Returned: success  Sample: `["ewr"]` |
| **monthly_cost**  integer | Monthly cost in $.  Returned: success  Sample: `300` |
| **ram**  integer | Amount of RAM in MB.  Returned: success  Sample: `32768` |
| **type**  string | Type of plan.  Returned: success  Sample: `"SSD"` |
