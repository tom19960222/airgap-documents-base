...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/keypair_info_module.html
...
| Key | Description |
| --- | --- |
| **openstack_keypairs**  list / elements=dictionary | Lists keypairs that are associated with the account.  Returned: always |
