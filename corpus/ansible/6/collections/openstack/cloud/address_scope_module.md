...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/address_scope_module.html
...
| **shared**  boolean | Whether this address scope is shared or not.  Choices:   - `false` ← (default) - `true` |
...
| Key | Description |
| --- | --- |
| **address_scope**  complex | Dictionary describing the address scope.  Returned: On success when *state* is ‘present’ |
