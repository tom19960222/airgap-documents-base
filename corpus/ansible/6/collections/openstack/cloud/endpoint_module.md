...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/endpoint_module.html
...
| **region**  string | Region that the service belongs to. Note that *region_name* is used for authentication. |
...
| Key | Description |
| --- | --- |
| **endpoint**  complex | Dictionary describing the endpoint.  Returned: On success when *state* is `present` |
...
| **region**  string | Same as `region_id`. Deprecated.  Returned: success  Sample: `"RegionOne"` |
