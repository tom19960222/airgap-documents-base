...
collection: ansible
version: "6"
title: "openstack.cloud.compute_service_info module – Retrieve information about one or more OpenStack compute services"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/compute_service_info_module.html
fetched_at: 2026-07-28T00:16:29+00:00
---
# openstack.cloud.compute_service_info module – Retrieve information about one or more OpenStack compute services
...
| **binary**  string | Filter by service binary type. Requires openstacksdk>=0.53. |
...
| **host**  string | Filter by service host. Requires openstacksdk>=0.53. |
...
| Key | Description |
| --- | --- |
| **openstack_compute_services**  complex | has all the OpenStack information about compute services  Returned: always, but can be null |
...
| **disabled_reason**  string | The reason why the service is disabled  Returned: success and OpenStack SDK >= 0.53 |
| **disables_reason**  string | The reason why the service is disabled  Returned: success and OpenStack SDK < 0.53 |
