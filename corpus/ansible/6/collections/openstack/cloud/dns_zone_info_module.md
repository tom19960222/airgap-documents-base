...
collection: ansible
version: "6"
title: "openstack.cloud.dns_zone_info module – Getting information about dns zones"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/dns_zone_info_module.html
fetched_at: 2026-07-28T00:16:31+00:00
---
# openstack.cloud.dns_zone_info module – Getting information about dns zones
...
> see [Requirements](dns_zone_info_module.md#ansible-collections-openstack-cloud-dns-zone-info-module-requirements) for details.
>
> To use it in a playbook, specify: `openstack.cloud.dns_zone_info`.

- [Synopsis](dns_zone_info_module.md#synopsis)
- [Requirements](dns_zone_info_module.md#requirements)
- [Parameters](dns_zone_info_module.md#parameters)
- [Notes](dns_zone_info_module.md#notes)
- [Examples](dns_zone_info_module.md#examples)
- [Return Values](dns_zone_info_module.md#return-values)

## [Synopsis](dns_zone_info_module.md#id1)

- Getting information about dns zones. Output can be filtered.

## [Requirements](dns_zone_info_module.md#id2)
...
## [Parameters](dns_zone_info_module.md#id3)
...
| **type**  string | Zone type.  Choices:   - `"primary"` - `"secondary"` |
...
## [Notes](dns_zone_info_module.md#id4)
...
## [Examples](dns_zone_info_module.md#id5)
...
## [Return Values](dns_zone_info_module.md#id6)
...
| **links**  dictionary | Links to the resource, and other related resources. When a response has been broken into pages, we will include a next link that should be followed to retrieve all results.  Returned: success  Sample: `{"self": "https://127.0.0.1:9001/v2/zones/a86dba58-0043-4cc6-a1bb-69d5e86f3ca3"}` |
| **masters**  list / elements=string | Mandatory for secondary zones. The servers to slave from to get DNS information.  Returned: success  Sample: `["[]"]` |
