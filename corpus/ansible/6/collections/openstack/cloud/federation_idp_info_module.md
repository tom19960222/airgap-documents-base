...
collection: ansible
version: "6"
title: "openstack.cloud.federation_idp_info module – Get the information about the available federation identity providers"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/federation_idp_info_module.html
fetched_at: 2026-07-28T00:16:33+00:00
---
# openstack.cloud.federation_idp_info module – Get the information about the available federation identity providers
...
| **name**  aliases: id  string | The name of the identity provider to fetch.  If *name* is specified, the module will return failed if the identity provider doesn’t exist. |
