...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/volume_module.html
fetched_at: 2026-07-28T00:17:13+00:00
---
...
| **bootable**  boolean | Bootable flag for volume.  Choices:   - `false` ← (default) - `true` |
...
| **display_description**  aliases: description  string | String describing the volume |
| **display_name**  aliases: name  string / required | Name of volume |
...
| **snapshot_id**  string | Volume snapshot id to create from |
