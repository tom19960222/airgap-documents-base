...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/subnets_info_module.html
...
- This module was called `openstack.cloud.subnets_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [openstack.cloud.subnets_info](subnets_info_module.md#ansible-collections-openstack-cloud-subnets-info-module) module no longer returns `ansible_facts`!
...
| Key | Description |
| --- | --- |
| **openstack_subnets**  complex | has all the openstack information about the subnets  Returned: always, but can be null |
...
| **enable_dhcp**  boolean | DHCP enable flag for this subnet.  Returned: success |
...
| **tenant_id**  string | Tenant id associated with this subnet.  Returned: success |
