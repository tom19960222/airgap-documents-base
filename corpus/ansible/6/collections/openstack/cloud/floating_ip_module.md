...
collection: ansible
version: "6"
title: "openstack.cloud.floating_ip module – Add/Remove floating IP from an instance"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/floating_ip_module.html
fetched_at: 2026-07-28T00:16:35+00:00
---
...
| **reuse**  boolean | When *state* is present, and *floating_ip_address* is not present, this parameter can be used to specify whether we should try to reuse a floating IP address already allocated to the project.  Choices:   - `false` ← (default) - `true` |
...
| **timeout**  integer | Time to wait for an IP address to appear as attached. See wait.  Default: `60` |
...
| **wait**  boolean | When attaching a floating IP address, specify whether to wait for it to appear as attached.  Must be set to `yes` for the module to return the value of the floating IP when attaching.  Choices:   - `false` ← (default) - `true` |
