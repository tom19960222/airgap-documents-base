...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/host_aggregate_module.html
...
| Key | Description |
| --- | --- |
| **aggregate**  complex | A host aggregate resource.  Returned: On success, when *state* is present |
| **availability_zone**  string | Availability zone of the aggregate  Returned: always |
| **deleted**  boolean | Whether or not the resource is deleted  Returned: always |
