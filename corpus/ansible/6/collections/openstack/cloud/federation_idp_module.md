...
collection: ansible
version: "6"
title: "openstack.cloud.federation_idp module – manage a federation Identity Provider"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/federation_idp_module.html
fetched_at: 2026-07-28T00:16:32+00:00
---
# openstack.cloud.federation_idp module – manage a federation Identity Provider
...
| **enabled**  aliases: is_enabled  boolean | Whether the Identity Provider is enabled or not.  Will default to `true` when creating a new Identity Provider.  Choices:   - `false` - `true` |
| **interface**  aliases: endpoint_type  string | Endpoint URL type to fetch from the service catalog.  Choices:   - `"admin"` - `"internal"` - `"public"` ← (default) |
| **name**  aliases: id  string / required | The name of the Identity Provider. |
