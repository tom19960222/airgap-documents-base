...
collection: ansible
version: "6"
title: "openstack.cloud.security_group_rule_info module – Querying security group rules"
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/security_group_rule_info_module.html
fetched_at: 2026-07-28T00:17:05+00:00
---
# openstack.cloud.security_group_rule_info module – Querying security group rules
...
| **ethertype**  string | Filter the security group rule list result by the ethertype of network traffic. The value must be IPv4 or IPv6.  Choices:   - `"IPv4"` - `"IPv6"` |
...
| **protocol**  string | Filter the security group rule list result by the IP protocol.  Choices:   - `"any"` - `"tcp"` - `"udp"` - `"icmp"` - `"112"` - `"132"` |
...
| Key | Description |
| --- | --- |
| **security_group_rules**  complex | List of dictionaries describing security group rules.  Returned: On Success. |
...
| **ethertype**  string | One of IPv4 or IPv6.  Returned: success  Sample: `"IPv4"` |
...
| **project**  string | Unique ID of the project.  Returned: success  Sample: `"16d53a84a13b49529d2e2c3646691123"` |
