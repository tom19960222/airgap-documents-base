...
source_url: https://docs.ansible.com/projects/ansible/6/collections/openstack/cloud/server_info_module.html
...
- This module was called `os_server_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [openstack.cloud.server_info](server_info_module.md#ansible-collections-openstack-cloud-server-info-module) module no longer returns `ansible_facts`!
