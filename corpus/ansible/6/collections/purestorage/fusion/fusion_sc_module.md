...
source_url: https://docs.ansible.com/projects/ansible/6/collections/purestorage/fusion/fusion_sc_module.html
...
| **storage_service**  string | Storage service to which the storage class belongs. |
