...
source_url: https://docs.ansible.com/projects/ansible/6/collections/purestorage/flashblade/purefb_bucket_module.html
fetched_at: 2026-07-28T00:18:41+00:00
---
...
| **mode**  string  added in purestorage.flashblade 1.10.0 | The type of bucket to be created. Also referred to a VSO Mode.  Requires Purity//FB 3.3.3 or higher  *multi-site* type can only be used after feature is enabled by Pure Technical Support  Choices:   - `"classic"` - `"multi-site"` |
