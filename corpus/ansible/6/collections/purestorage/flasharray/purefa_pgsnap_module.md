...
source_url: https://docs.ansible.com/projects/ansible/6/collections/purestorage/flasharray/purefa_pgsnap_module.html
fetched_at: 2026-07-28T00:18:21+00:00
---
...
| **state**  string | Define whether the protection group snapshot should exist or not. Copy (added in 2.7) will create a full read/write clone of the snapshot.  Choices:   - `"absent"` - `"present"` ← (default) - `"copy"` |
