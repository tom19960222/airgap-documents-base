...
source_url: https://docs.ansible.com/projects/ansible/6/collections/purestorage/flasharray/purefa_user_module.html
...
| **role**  string | Sets the local user’s access level to the array  Choices:   - `"readonly"` - `"storage_admin"` - `"array_admin"` |
