...
source_url: https://docs.ansible.com/projects/ansible/6/collections/purestorage/flasharray/purefa_snap_module.html
fetched_at: 2026-07-28T00:18:28+00:00
---
...
| **offload**  string | Only valid for Purity//FA 6.1 or higher  Name of offload target for the snapshot.  Target can be either another FlashArray or an Offload Target  This is only applicable for creation, deletion and eradication of snapshots  *state* of *copy* is not supported.  *suffix* is not supported for offload snapshots. |
