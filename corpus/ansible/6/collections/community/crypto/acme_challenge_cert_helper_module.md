...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/crypto/acme_challenge_cert_helper_module.html
fetched_at: 2026-07-27T17:06:12+00:00
---
...
| **identifier**  string | The identifier for the actual resource. Will be a domain name if the type is `dns`, or an IP address if the type is `ip`.  Returned: always |
| **identifier_type**  string | The identifier type for the actual resource identifier. Will be `dns` or `ip`.  Returned: always |
