...
collection: ansible
version: "6"
title: "community.sap.sap_snote module – This module will upload and (de)implements SNOTES in a SAP S4HANA environment."
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/sap/sap_snote_module.html
fetched_at: 2026-07-27T17:20:58+00:00
---
# community.sap.sap_snote module – This module will upload and (de)implements `SNOTES` in a SAP S4HANA environment.
...
> see [Requirements](sap_snote_module.md#ansible-collections-community-sap-sap-snote-module-requirements) for details.
>
> To use it in a playbook, specify: `community.sap.sap_snote`.
