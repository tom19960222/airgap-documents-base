...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/pamd_module.html
...
| **type**  string / required | The type of the PAM rule being modified.  The `type`, `control` and `module_path` all must match a rule to be modified.  Choices:   - `"account"` - `"-account"` - `"auth"` - `"-auth"` - `"password"` - `"-password"` - `"session"` - `"-session"` |

## [Notes](pamd_module.md#id3)

> **Note:**
>
> - This module does not handle authselect profiles.

## [Examples](pamd_module.md#id4)
...
## [Return Values](pamd_module.md#id5)
