...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/netcup_dns_module.html
...
| **record**  aliases: name  string | Record to add or delete, supports wildcard (\*). Default is `@` (e.g. the zone name).  Default: `"@"` |
...
## [Examples](netcup_dns_module.md#id4)
...
## [Return Values](netcup_dns_module.md#id5)
...
| **type**  string | the record type  Returned: succcess  Sample: `"A"` |
