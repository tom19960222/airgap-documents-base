...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/gitlab_group_members_module.html
...
- [Notes](gitlab_group_members_module.md#notes)
...
| **gitlab_group**  string / required | The `full_path` of the GitLab group the member is added to/removed from.  Setting this to `name` or `path` is deprecated and will be removed in community.general 6.0.0. Use `full_path` instead. |
...
## [Notes](gitlab_group_members_module.md#id4)
