...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/sysrc_module.html
fetched_at: 2026-07-27T17:13:32+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **delim**  string | Delimiter to be used instead of .  Only used when *state=value_present* or *state=value_absent*.  Default: `" "` |
...
## [Return Values](sysrc_module.md#id5)
