...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/udm_share_module.html
...
> see [Requirements](udm_share_module.md#ansible-collections-community-general-udm-share-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.udm_share`.

- [Synopsis](udm_share_module.md#synopsis)
- [Requirements](udm_share_module.md#requirements)
...
## [Requirements](udm_share_module.md#id2)

The below requirements are needed on the host that executes this module.

- Python >= 2.6

## [Parameters](udm_share_module.md#id3)
...
| **sambaCustomSettings**  aliases: samba_custom_settings  list / elements=string | Option name in smb.conf and its value.  Default: `[]` |
