...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/rocketchat_module.html
...
| **protocol**  string | Specify the protocol used to send notification messages before the webhook url. (i.e. http or https)  Choices:   - `"http"` - `"https"` ← (default) |
...
## [Examples](rocketchat_module.md#id3)
...
## [Return Values](rocketchat_module.md#id4)
