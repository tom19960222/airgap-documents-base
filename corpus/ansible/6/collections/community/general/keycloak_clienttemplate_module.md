...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/keycloak_clienttemplate_module.html
...
| **protocol**  string | Type of client template (either `openid-connect` or `saml`.  Choices:   - `"openid-connect"` - `"saml"` |
...
## [Notes](keycloak_clienttemplate_module.md#id3)
...
## [Examples](keycloak_clienttemplate_module.md#id4)
...
## [Return Values](keycloak_clienttemplate_module.md#id5)
