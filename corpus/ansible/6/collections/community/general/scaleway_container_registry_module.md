...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/scaleway_container_registry_module.html
fetched_at: 2026-07-27T17:12:54+00:00
---
...
| **state**  string | Indicate desired state of the container regitry.  Choices:   - `"present"` ← (default) - `"absent"` |
...
## [Notes](scaleway_container_registry_module.md#id3)
...
## [Examples](scaleway_container_registry_module.md#id4)
...
## [Return Values](scaleway_container_registry_module.md#id5)
