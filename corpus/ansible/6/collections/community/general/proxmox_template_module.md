...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/proxmox_template_module.html
fetched_at: 2026-07-27T17:12:12+00:00
---
...
## [Notes](proxmox_template_module.md#id4)

> **Note:**
>
> - Requires `proxmoxer` and `requests` modules on host. This modules can be installed with [ansible.builtin.pip](../../ansible/builtin/pip_module.md#ansible-collections-ansible-builtin-pip-module).

## [Examples](proxmox_template_module.md#id5)
