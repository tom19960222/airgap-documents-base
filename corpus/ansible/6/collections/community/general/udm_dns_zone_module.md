...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/udm_dns_zone_module.html
fetched_at: 2026-07-27T17:13:38+00:00
---
...
> see [Requirements](udm_dns_zone_module.md#ansible-collections-community-general-udm-dns-zone-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.udm_dns_zone`.

- [Synopsis](udm_dns_zone_module.md#synopsis)
- [Requirements](udm_dns_zone_module.md#requirements)
...
## [Requirements](udm_dns_zone_module.md#id2)

The below requirements are needed on the host that executes this module.

- Python >= 2.6

## [Parameters](udm_dns_zone_module.md#id3)
...
| **zone**  aliases: name  string / required | DNS zone name, e.g. `example.com`. |
