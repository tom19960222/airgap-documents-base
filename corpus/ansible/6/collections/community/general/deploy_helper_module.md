...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/deploy_helper_module.html
fetched_at: 2026-07-27T17:08:42+00:00
---
...
| **current_path**  path | The name of the symlink that is created when the deploy is finalized. Used in *finalize* and *clean*. Returned in the `deploy_helper.current_path` fact.  Default: `"current"` |
...
| **keep_releases**  integer | The number of old releases to keep when cleaning. Used in *finalize* and *clean*. Any unfinished builds will be deleted first, so only correct releases will count. The current version will not count.  Default: `5` |
...
## [Notes](deploy_helper_module.md#id3)
...
## [Examples](deploy_helper_module.md#id4)
