...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/portage_module.html
...
| **package**  aliases: name  list / elements=string | Package atom or set, e.g. `sys-apps/foo` or `>foo-2.13` or `@world` |
...
## [Examples](portage_module.md#id3)
