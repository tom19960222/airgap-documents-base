...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/layman_module.html
...
| Parameter | Comments |
| --- | --- |
| **list_url**  aliases: url  string | An URL of the alternative overlays list that defines the overlay to install. This list will be fetched and saved under `${overlay_defs}`/${name}.xml), where `overlay_defs` is readed from the Layman’s configuration. |
