...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/linode_v4_module.html
fetched_at: 2026-07-27T17:10:32+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **access_token**  string / required | The Linode API v4 access token. It may also be specified by exposing the `LINODE_ACCESS_TOKEN` environment variable. See <https://www.linode.com/docs/api#access-and-authentication>. |
...
## [Examples](linode_v4_module.md#id5)
...
## [Return Values](linode_v4_module.md#id6)
