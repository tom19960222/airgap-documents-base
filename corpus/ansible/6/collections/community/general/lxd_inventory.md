...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/lxd_inventory.html
fetched_at: 2026-07-27T17:14:48+00:00
---
...
| **prefered_instance_network_family**  string | If an instance has multiple network interfaces, which one is the prefered by family.  Specify `inet` for IPv4 and `inet6` for IPv6.  Choices:   - `"inet"` ← (default) - `"inet6"` |
