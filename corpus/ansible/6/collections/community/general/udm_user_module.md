...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/udm_user_module.html
fetched_at: 2026-07-27T17:13:40+00:00
---
...
> see [Requirements](udm_user_module.md#ansible-collections-community-general-udm-user-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.udm_user`.

- [Synopsis](udm_user_module.md#synopsis)
- [Requirements](udm_user_module.md#requirements)
...
## [Requirements](udm_user_module.md#id2)

The below requirements are needed on the host that executes this module.

- Python >= 2.6

## [Parameters](udm_user_module.md#id3)
...
| **ou**  string | Organizational Unit inside the LDAP Base DN, e.g. `school` for LDAP OU `ou=school,dc=example,dc=com`.  Default: `""` |
...
| **position**  string | Define the whole position of users object inside the LDAP tree, e.g. `cn=employee,cn=users,ou=school,dc=example,dc=com`.  Default: `""` |
...
| **subpath**  string | LDAP subpath inside the organizational unit, e.g. `cn=teachers,cn=users` for LDAP container `cn=teachers,cn=users,dc=example,dc=com`.  Default: `"cn=users"` |
