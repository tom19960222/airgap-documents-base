...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/stacki_host_module.html
fetched_at: 2026-07-27T17:13:24+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **appliance**  string | Applicance to be used in host creation.  Required if *state* is `present` and host does not yet exist.  Default: `"backend"` |
...
| **rack**  integer | Rack to be used in host creation.  Required if *state* is `present` and host does not yet exist.  Default: `0` |
| **rank**  integer | Rank to be used in host creation.  In Stacki terminology, the rank is the position of the machine in a rack.  Required if *state* is `present` and host does not yet exist.  Default: `0` |
...
## [Examples](stacki_host_module.md#id3)
...
## [Return Values](stacki_host_module.md#id4)
