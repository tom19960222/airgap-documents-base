...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/xen_orchestra_inventory.html
fetched_at: 2026-07-27T17:14:54+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **api_host**  string | API host to XOA API.  If the value is not specified in the inventory configuration, the value of environment variable `ANSIBLE_XO_HOST` will be used instead.  Configuration:   - Environment variable: [`ANSIBLE_XO_HOST`](../../environment_variables.md#envvar-ANSIBLE_XO_HOST) |
...
| **password**  string / required | Xen Orchestra password.  If the value is not specified in the inventory configuration, the value of environment variable `ANSIBLE_XO_PASSWORD` will be used instead.  Configuration:   - Environment variable: [`ANSIBLE_XO_PASSWORD`](../../environment_variables.md#envvar-ANSIBLE_XO_PASSWORD) |
...
| **user**  string / required | Xen Orchestra user.  If the value is not specified in the inventory configuration, the value of environment variable `ANSIBLE_XO_USER` will be used instead.  Configuration:   - Environment variable: [`ANSIBLE_XO_USER`](../../environment_variables.md#envvar-ANSIBLE_XO_USER) |
