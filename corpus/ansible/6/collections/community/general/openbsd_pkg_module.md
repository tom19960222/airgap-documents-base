...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/openbsd_pkg_module.html
...
> see [Requirements](openbsd_pkg_module.md#ansible-collections-community-general-openbsd-pkg-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.openbsd_pkg`.

- [Synopsis](openbsd_pkg_module.md#synopsis)
- [Requirements](openbsd_pkg_module.md#requirements)
...
## [Requirements](openbsd_pkg_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.5

## [Parameters](openbsd_pkg_module.md#id3)
