...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/zfs_delegate_admin_module.html
fetched_at: 2026-07-27T17:14:12+00:00
---
...
| **recursive**  boolean | Unallow permissions recursively (ignored when `state` is `present`).  Choices:   - `false` ← (default) - `true` |
...
## [Examples](zfs_delegate_admin_module.md#id4)
