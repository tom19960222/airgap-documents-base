...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/bzr_module.html
...
| **force**  boolean | If `true`, any modified files in the working tree will be discarded. Before 1.9 the default value was `true`.  Choices:   - `false` ← (default) - `true` |
