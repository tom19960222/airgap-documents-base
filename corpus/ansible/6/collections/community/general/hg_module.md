...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/hg_module.html
fetched_at: 2026-07-27T17:09:17+00:00
---
...
| **force**  boolean | Discards uncommitted changes. Runs `hg update -C`. Prior to 1.9, the default was `true`.  Choices:   - `false` ← (default) - `true` |
