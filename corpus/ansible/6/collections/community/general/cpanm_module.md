...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/cpanm_module.html
fetched_at: 2026-07-27T17:08:37+00:00
---
...
| **mode**  string  added in community.general 3.0.0 | Controls the module behavior. See notes below for more details.  Choices:   - `"compatibility"` ← (default) - `"new"` |
...
| **name_check**  string  added in community.general 3.0.0 | When in `new` mode, this parameter can be used to check if there is a module *name* installed (at *version*, when specified). |
