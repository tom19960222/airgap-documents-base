...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/one_vm_module.html
fetched_at: 2026-07-27T17:11:17+00:00
---
...
| **datastore_id**  integer  added in community.general 0.2.0 | Name of Datastore to use to create a new instace |
| **datastore_name**  string  added in community.general 0.2.0 | Name of Datastore to use to create a new instace |
...
| **mode**  string | Set permission mode of the instance in octet format, e.g. `600` to give owner `use` and `manage` and nothing to group and others. |
...
| **template_name**  string | Name of VM template to use to create a new instace |
...
## [Return Values](one_vm_module.md#id5)
