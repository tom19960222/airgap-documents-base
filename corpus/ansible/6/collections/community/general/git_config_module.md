...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/git_config_module.html
fetched_at: 2026-07-27T17:09:00+00:00
---
...
- The `git_config` module changes git configuration by invoking ‘git config’. This is needed if you don’t want to use [ansible.builtin.template](../../ansible/builtin/template_module.md#ansible-collections-ansible-builtin-template-module) for the entire git config file (e.g. because you need to change just `user.email` in /etc/.git/config). Solutions involving [ansible.builtin.command](../../ansible/builtin/command_module.md#ansible-collections-ansible-builtin-command-module) are cumbersome or don’t work correctly in check mode.
...
## [Examples](git_config_module.md#id4)
...
## [Return Values](git_config_module.md#id5)
