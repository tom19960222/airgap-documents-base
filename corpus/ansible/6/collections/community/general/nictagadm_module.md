...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/general/nictagadm_module.html
...
| **force**  boolean | When *state* is absent set this switch will use the `-f` parameter and delete the nic tag regardless of existing VMs.  Choices:   - `false` ← (default) - `true` |
...
## [Examples](nictagadm_module.md#id3)
...
## [Return Values](nictagadm_module.md#id4)
