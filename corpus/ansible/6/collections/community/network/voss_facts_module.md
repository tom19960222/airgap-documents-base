...
collection: ansible
version: "6"
title: "community.network.voss_facts module – Collect facts from remote devices running Extreme VOSS"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/network/voss_facts_module.html
fetched_at: 2026-07-27T17:19:52+00:00
---
# community.network.voss_facts module – Collect facts from remote devices running Extreme VOSS
...
- [Synopsis](voss_facts_module.md#synopsis)
- [Parameters](voss_facts_module.md#parameters)
- [Notes](voss_facts_module.md#notes)
- [Examples](voss_facts_module.md#examples)
- [Return Values](voss_facts_module.md#return-values)

## [Synopsis](voss_facts_module.md#id1)
...
## [Parameters](voss_facts_module.md#id2)
...
## [Notes](voss_facts_module.md#id3)

> **Note:**
>
> - Tested against VOSS 7.0.0

## [Examples](voss_facts_module.md#id4)
...
## [Return Values](voss_facts_module.md#id5)
