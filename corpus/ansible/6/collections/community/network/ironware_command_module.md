...
collection: ansible
version: "6"
title: "community.network.ironware_command module – Run arbitrary commands on Extreme IronWare devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/network/ironware_command_module.html
fetched_at: 2026-07-27T17:18:55+00:00
---
# community.network.ironware_command module – Run arbitrary commands on Extreme IronWare devices
...
- [Synopsis](ironware_command_module.md#synopsis)
- [Parameters](ironware_command_module.md#parameters)
- [Notes](ironware_command_module.md#notes)
- [Examples](ironware_command_module.md#examples)
- [Return Values](ironware_command_module.md#return-values)

## [Synopsis](ironware_command_module.md#id1)
...
## [Parameters](ironware_command_module.md#id2)
...
| **match**  string | The *match* argument is used in conjunction with the *wait_for* argument to specify the match policy. If the value is set to `all` then all conditionals in the *wait_for* must be satisfied. If the value is set to `any` then only one of the values must be satisfied.  Choices:   - `"any"` - `"all"` ← (default) |
...
## [Notes](ironware_command_module.md#id3)

> **Note:**
>
> - For more information on using Ansible to manage network devices see the :ref:`Ansible Network Guide <network_guide>`

## [Examples](ironware_command_module.md#id4)
...
## [Return Values](ironware_command_module.md#id5)
