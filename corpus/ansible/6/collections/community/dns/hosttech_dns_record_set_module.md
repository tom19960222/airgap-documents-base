...
collection: ansible
version: "6"
title: "community.dns.hosttech_dns_record_set module – Add or delete record sets in Hosttech DNS service"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/dns/hosttech_dns_record_set_module.html
...
> see [Requirements](hosttech_dns_record_set_module.md#ansible-collections-community-dns-hosttech-dns-record-set-module-requirements) for details.
>
> To use it in a playbook, specify: `community.dns.hosttech_dns_record_set`.

New in community.dns 2.0.0

- [Synopsis](hosttech_dns_record_set_module.md#synopsis)
- [Requirements](hosttech_dns_record_set_module.md#requirements)
- [Parameters](hosttech_dns_record_set_module.md#parameters)
- [Attributes](hosttech_dns_record_set_module.md#attributes)
- [Examples](hosttech_dns_record_set_module.md#examples)
- [Return Values](hosttech_dns_record_set_module.md#return-values)

## [Synopsis](hosttech_dns_record_set_module.md#id1)
...
## [Requirements](hosttech_dns_record_set_module.md#id2)

The below requirements are needed on the host that executes this module.

- lxml

## [Parameters](hosttech_dns_record_set_module.md#id3)
...
| **ttl**  integer | The TTL to give the new record, in seconds.  Will be ignored if *state=absent* and *on_existing=replace*.  Default: `3600` |
...
## [Attributes](hosttech_dns_record_set_module.md#id4)
...
## [Examples](hosttech_dns_record_set_module.md#id5)
...
## [Return Values](hosttech_dns_record_set_module.md#id6)
