...
collection: ansible
version: "6"
title: "community.okd.openshift_adm_prune_auth module – Removes references to the specified roles, clusterroles, users, and groups"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/okd/openshift_adm_prune_auth_module.html
fetched_at: 2026-07-27T17:20:09+00:00
---
# community.okd.openshift_adm_prune_auth module – Removes references to the specified roles, clusterroles, users, and groups
...
> see [Requirements](openshift_adm_prune_auth_module.md#ansible-collections-community-okd-openshift-adm-prune-auth-module-requirements) for details.
>
> To use it in a playbook, specify: `community.okd.openshift_adm_prune_auth`.

New in community.okd 2.2.0

- [Synopsis](openshift_adm_prune_auth_module.md#synopsis)
- [Requirements](openshift_adm_prune_auth_module.md#requirements)
- [Parameters](openshift_adm_prune_auth_module.md#parameters)
- [Notes](openshift_adm_prune_auth_module.md#notes)
- [Examples](openshift_adm_prune_auth_module.md#examples)
- [Return Values](openshift_adm_prune_auth_module.md#return-values)

## [Synopsis](openshift_adm_prune_auth_module.md#id1)
...
## [Requirements](openshift_adm_prune_auth_module.md#id2)
...
## [Parameters](openshift_adm_prune_auth_module.md#id3)
...
| **label_selectors**  list / elements=string | Selector (label query) to filter on.  Mutually exclusive with option *name*. |
...
| **resource**  string / required | The specified resource to remove.  Choices:   - `"roles"` - `"clusterroles"` - `"users"` - `"groups"` |
...
## [Notes](openshift_adm_prune_auth_module.md#id4)

> **Note:**
>
> - To avoid SSL certificate validation errors when `validate_certs` is *True*, the full certificate chain for the API server must be provided via `ca_cert` or in the kubeconfig file.

## [Examples](openshift_adm_prune_auth_module.md#id5)
...
## [Return Values](openshift_adm_prune_auth_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **authorization**  list / elements=string | list of OAuthClientAuthorization deleted.  Returned: *resource=users* |
| **cluster_role_binding**  list / elements=string | list of cluster role binding deleted.  Returned: always |
| **group**  list / elements=string | list of Security Context Constraints deleted.  Returned: *resource=users* |
| **role_binding**  list / elements=string | list of role binding deleted.  Returned: *resource=users* or *resource=groups* or *resource=clusterroles* |
| **security_context_constraints**  list / elements=string | list of Security Context Constraints deleted.  Returned: *resource=users* or *resource=groups* |
