...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/libvirt/libvirt_qemu_connection.html
fetched_at: 2026-07-27T17:16:00+00:00
---
# community.libvirt.libvirt_qemu connection – Run tasks on libvirt/qemu virtual machines

> **Note:**
>
> This connection plugin is part of the [community.libvirt collection](https://galaxy.ansible.com/community/libvirt) (version 1.2.0).
>
...
| **remote_addr**  string | Virtual machine name.  Default: `"inventory_hostname"`  Configuration:   - Variable: ansible_host |
