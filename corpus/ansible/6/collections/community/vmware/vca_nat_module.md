...
collection: ansible
version: "6"
title: "community.vmware.vca_nat module – add remove nat rules in a gateway  in a vca"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vca_nat_module.html
...
- [DEPRECATED](vca_nat_module.md#deprecated)
- [Synopsis](vca_nat_module.md#synopsis)
- [Parameters](vca_nat_module.md#parameters)
- [Examples](vca_nat_module.md#examples)
- [Status](vca_nat_module.md#status)

## [DEPRECATED](vca_nat_module.md#id1)
...
## [Synopsis](vca_nat_module.md#id2)

- Adds or removes nat rules from a gateway in a vca environment

## [Parameters](vca_nat_module.md#id3)
...
| **nat_rules**  string / required | A list of rules to be added to the gateway, Please see examples on valid entries  Default: `false` |
...
| **purge_rules**  boolean | If set to true, it will delete all rules in the gateway that are not given as parameter to this module.  Choices:   - `false` ← (default) - `true` |
...
## [Examples](vca_nat_module.md#id4)
...
## [Status](vca_nat_module.md#id5)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](vca_nat_module.md#deprecated).
