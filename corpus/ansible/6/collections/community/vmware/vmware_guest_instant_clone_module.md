...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_guest_instant_clone_module.html
...
| **wait_vm_tools**  boolean  added in community.vmware 1.12.0 | Whether waiting until vm tools start after rebooting an instant clone vm.  Choices:   - `false` - `true` ← (default) |
| **wait_vm_tools_timeout**  integer  added in community.vmware 1.12.0 | Define a timeout (in seconds) for *the wait_vm_tools* parameter.  Default: `300` |
