...
collection: ansible
version: "6"
title: "Find folder path of an existing VMware virtual machine"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/docsite/vmware_scenarios/scenario_find_vm_folder.html
fetched_at: 2026-07-28T00:25:38+00:00
---
# Find folder path of an existing VMware virtual machine

- [Introduction](scenario_find_vm_folder.md#introduction)
- [Scenario requirements](scenario_find_vm_folder.md#scenario-requirements)
- [Caveats](scenario_find_vm_folder.md#caveats)
- [Example description](scenario_find_vm_folder.md#example-description)

  - [What to expect](scenario_find_vm_folder.md#what-to-expect)
  - [Troubleshooting](scenario_find_vm_folder.md#troubleshooting)

## [Introduction](scenario_find_vm_folder.md#id1)

This guide will show you how to utilize Ansible to find folder path of an existing VMware virtual machine.

## [Scenario requirements](scenario_find_vm_folder.md#id2)
...
## [Caveats](scenario_find_vm_folder.md#id3)
...
## [Example description](scenario_find_vm_folder.md#id4)
...
For now, you will be entering these directly, but in a more advanced playbook this can be abstracted out and stored in a more secure fashion using [ansible-vault](../../../../../cli/ansible-vault.md#ansible-vault) or using [Ansible Tower credentials](https://docs.ansible.com/ansible-tower/latest/html/userguide/credentials.html).
...
### [What to expect](scenario_find_vm_folder.md#id5)
...
### [Troubleshooting](scenario_find_vm_folder.md#id6)
