...
collection: ansible
version: "6"
title: "Rename an existing virtual machine"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/docsite/vmware_scenarios/scenario_rename_vm.html
fetched_at: 2026-07-28T00:25:37+00:00
---
# Rename an existing virtual machine

- [Introduction](scenario_rename_vm.md#introduction)
- [Scenario requirements](scenario_rename_vm.md#scenario-requirements)
- [Caveats](scenario_rename_vm.md#caveats)
- [Example description](scenario_rename_vm.md#example-description)

  - [What to expect](scenario_rename_vm.md#what-to-expect)
  - [Troubleshooting](scenario_rename_vm.md#troubleshooting)

## [Introduction](scenario_rename_vm.md#id1)

This guide will show you how to utilize Ansible to rename an existing virtual machine.

## [Scenario requirements](scenario_rename_vm.md#id2)
...
## [Caveats](scenario_rename_vm.md#id3)
...
## [Example description](scenario_rename_vm.md#id4)
...
### [What to expect](scenario_rename_vm.md#id5)
...
### [Troubleshooting](scenario_rename_vm.md#id6)
