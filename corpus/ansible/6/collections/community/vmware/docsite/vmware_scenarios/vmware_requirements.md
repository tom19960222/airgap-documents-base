...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/docsite/vmware_scenarios/vmware_requirements.html
fetched_at: 2026-07-28T00:25:13+00:00
---
...
For example, if `/var/vmware/certs/vcenter1.crt` is the SSL certificate for your vCenter Server, you can use the [environment](../../../../../user_guide/playbooks_environment.md#playbooks-environment) keyword to pass it to the modules:
