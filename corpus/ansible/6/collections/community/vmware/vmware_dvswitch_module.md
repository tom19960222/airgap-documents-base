...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_dvswitch_module.html
...
| **network_policy**  dictionary  added in community.vmware 1.11.0 | Dictionary which configures the different default security values for portgroups.  If set, these options are inherited by the portgroups of the DVS. |
