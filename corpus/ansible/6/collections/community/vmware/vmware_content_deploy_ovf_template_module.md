...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_content_deploy_ovf_template_module.html
fetched_at: 2026-07-27T17:21:27+00:00
---
...
| **datastore_cluster**  string  added in community.vmware 1.9.0 | Name of the datastore cluster housing a datastore to store deployed VM and disk.  If datastore is not specified, the recommended datastore from this cluster will be used. |
...
| **library**  aliases: content_library, content_library_src  string  added in community.vmware 1.5.0 | The name of the content library from where the template resides. |
| **log_level**  string  added in community.vmware 1.12.0 | The level of logging desired in this module.  Choices:   - `"debug"` - `"info"` - `"normal"` ← (default) |
