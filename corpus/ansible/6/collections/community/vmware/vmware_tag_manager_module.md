...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_tag_manager_module.html
...
| **moid**  string  added in community.vmware 1.4.0 | Managed object ID for the given object.  Required if `object_name` is not set. |
...
| Key | Description |
| --- | --- |
| **tag_status**  list / elements=string | metadata about tags related to object configuration  Returned: on success  Sample: `{"current_tags": ["backup", "security"], "desired_tags": ["security"], "previous_tags": ["backup", "security"]}` |
