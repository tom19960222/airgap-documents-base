...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_cluster_ha_module.html
fetched_at: 2026-07-27T17:21:25+00:00
---
...
| **apd_response**  string  added in community.vmware 1.4.0 | VM storage protection setting for storage failures categorized as All Paths Down (APD).  Choices:   - `"disabled"` - `"warning"` ← (default) - `"restartConservative"` - `"restartAggressive"` |
...
| **pdl_response**  string  added in community.vmware 1.4.0 | VM storage protection setting for storage failures categorized as Permenant Device Loss (PDL).  Choices:   - `"disabled"` - `"warning"` ← (default) - `"restartAggressive"` |
