...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/vmware/vmware_guest_controller_module.html
...
| **bus_sharing**  string  added in community.vmware 1.11.0 | Bus sharing type for SCSI controller.  Choices:   - `"noSharing"` ← (default) - `"physicalSharing"` - `"virtualSharing"` |
