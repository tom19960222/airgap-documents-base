...
collection: ansible
version: "6"
title: "community.aws.route53_zone module – add or delete Route53 zones"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/aws/route53_zone_module.html
...
> see [Requirements](route53_zone_module.md#ansible-collections-community-aws-route53-zone-module-requirements) for details.
>
...
| **purge_tags**  boolean  added in community.aws 2.1.0 | Delete any tags not specified in the task that are on the zone. This means you have to specify all the desired tags on each task affecting a zone.  Choices:   - `false` ← (default) - `true` |
...
| **tags**  dictionary  added in community.aws 2.1.0 | A hash/dictionary of tags to add to the new instance or to add/remove from an existing one. |
...
| **vpc_id**  string | id of vpc attached to private hosted zone  Returned: for private hosted zone  Sample: `"vpc-1d36c84f"` |
| **vpc_region**  string | region of vpc attached to private hosted zone  Returned: for private hosted zone  Sample: `"eu-west-1"` |
