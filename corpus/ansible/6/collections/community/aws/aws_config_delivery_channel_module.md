...
collection: ansible
version: "6"
title: "community.aws.aws_config_delivery_channel module – Manage AWS Config delivery channels"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/aws/aws_config_delivery_channel_module.html
fetched_at: 2026-07-27T17:03:19+00:00
---
# community.aws.aws_config_delivery_channel module – Manage AWS Config delivery channels
...
> see [Requirements](aws_config_delivery_channel_module.md#ansible-collections-community-aws-aws-config-delivery-channel-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.aws_config_delivery_channel`.

New in community.aws 1.0.0

- [Synopsis](aws_config_delivery_channel_module.md#synopsis)
- [Requirements](aws_config_delivery_channel_module.md#requirements)
- [Parameters](aws_config_delivery_channel_module.md#parameters)
- [Notes](aws_config_delivery_channel_module.md#notes)
- [Examples](aws_config_delivery_channel_module.md#examples)

## [Synopsis](aws_config_delivery_channel_module.md#id1)

- This module manages AWS Config delivery locations for rule checks and configuration info.

## [Requirements](aws_config_delivery_channel_module.md#id2)
...
## [Parameters](aws_config_delivery_channel_module.md#id3)
...
## [Notes](aws_config_delivery_channel_module.md#id4)
...
## [Examples](aws_config_delivery_channel_module.md#id5)
