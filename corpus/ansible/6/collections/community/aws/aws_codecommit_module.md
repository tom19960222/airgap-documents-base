...
collection: ansible
version: "6"
title: "community.aws.aws_codecommit module – Manage repositories in AWS CodeCommit"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/aws/aws_codecommit_module.html
fetched_at: 2026-07-27T17:03:16+00:00
---
# community.aws.aws_codecommit module – Manage repositories in AWS CodeCommit
...
> see [Requirements](aws_codecommit_module.md#ansible-collections-community-aws-aws-codecommit-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.aws_codecommit`.

New in community.aws 1.0.0

- [Synopsis](aws_codecommit_module.md#synopsis)
- [Requirements](aws_codecommit_module.md#requirements)
- [Parameters](aws_codecommit_module.md#parameters)
- [Notes](aws_codecommit_module.md#notes)
- [Examples](aws_codecommit_module.md#examples)
- [Return Values](aws_codecommit_module.md#return-values)

## [Synopsis](aws_codecommit_module.md#id1)
...
## [Requirements](aws_codecommit_module.md#id2)
...
## [Parameters](aws_codecommit_module.md#id3)
...
| **description**  aliases: comment  string | description or comment of repository. |
...
## [Notes](aws_codecommit_module.md#id4)
...
## [Examples](aws_codecommit_module.md#id5)
...
## [Return Values](aws_codecommit_module.md#id6)
...
| **account_id**  string | The ID of the AWS account associated with the repository.  Returned: when state is present  Sample: `"268342293637"` |
| **arn**  string | The Amazon Resource Name (ARN) of the repository.  Returned: when state is present  Sample: `"arn:aws:codecommit:ap-northeast-1:268342293637:username"` |
