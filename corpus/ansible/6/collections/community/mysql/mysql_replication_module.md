...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/mysql/mysql_replication_module.html
fetched_at: 2026-07-27T17:16:17+00:00
---
...
| **mode**  string | Module operating mode. Could be `changeprimary` (CHANGE PRIMARY TO), `getprimary` (SHOW PRIMARY STATUS), `getreplica` (SHOW REPLICA), `startreplica` (START REPLICA), `stopreplica` (STOP REPLICA), `resetprimary` (RESET PRIMARY) - supported since community.mysql 0.1.0, `resetreplica` (RESET REPLICA), `resetreplicaall` (RESET REPLICA ALL).  Choices:   - `"changeprimary"` - `"getprimary"` - `"getreplica"` ← (default) - `"startreplica"` - `"stopreplica"` - `"resetprimary"` - `"resetreplica"` - `"resetreplicaall"` |
...
## [Notes](mysql_replication_module.md#id4)
...
## [See Also](mysql_replication_module.md#id5)
...
## [Examples](mysql_replication_module.md#id6)
...
## [Return Values](mysql_replication_module.md#id7)
