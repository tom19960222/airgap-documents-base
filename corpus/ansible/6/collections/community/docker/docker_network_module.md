...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/docker/docker_network_module.html
...
| **ipam_config**  list / elements=dictionary | List of IPAM config blocks. Consult [Docker docs](https://docs.docker.com/compose/compose-file/compose-file-v2/#ipam) for valid options and values. Note that *iprange* is spelled differently here (we use the notation from the Docker SDK for Python). |
...
## [Notes](docker_network_module.md#id4)
...
## [Examples](docker_network_module.md#id5)
...
## [Return Values](docker_network_module.md#id6)
