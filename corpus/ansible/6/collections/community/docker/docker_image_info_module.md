...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/docker/docker_image_info_module.html
...
- The module will not attempt to pull images from registries. Use [community.docker.docker_image](docker_image_module.md#ansible-collections-community-docker-docker-image-module) with *source* set to `pull` to ensure an image is pulled.
...
## [Notes](docker_image_info_module.md#id4)
...
## [Examples](docker_image_info_module.md#id5)
...
## [Return Values](docker_image_info_module.md#id6)
