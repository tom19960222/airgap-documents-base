...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/docker/docker_container_exec_module.html
fetched_at: 2026-07-27T17:07:16+00:00
---
...
| **argv**  list / elements=string | The command to execute.  Since this is a list of arguments, no quoting is needed.  Exactly one of *argv* and *command* must be specified. |
...
| **command**  string | The command to execute.  Exactly one of *argv* and *command* must be specified. |
...
## [Notes](docker_container_exec_module.md#id4)
...
## [Examples](docker_container_exec_module.md#id5)
...
## [Return Values](docker_container_exec_module.md#id6)
