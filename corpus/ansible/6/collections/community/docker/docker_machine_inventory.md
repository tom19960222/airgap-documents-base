...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/docker/docker_machine_inventory.html
...
| **verbose_output**  boolean | When `true`, include all available nodes metadata (for exmaple `Image`, `Region`, `Size`) as a JSON object named `docker_machine_node_attributes`.  Choices:   - `false` - `true` ← (default) |
