...
Check out the documenation of the [community.routeros.api module](../api_module.md#ansible-collections-community-routeros-api-module) for details on the options.
