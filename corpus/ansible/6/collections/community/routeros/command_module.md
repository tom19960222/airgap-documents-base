...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/routeros/command_module.html
...
- The module always indicates a (changed) status. You can use [the changed_when task property](../../../user_guide/playbooks_error_handling.md#override-the-changed-result) to determine whether a command task actually resulted in a change or not.
