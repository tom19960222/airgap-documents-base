...
collection: ansible
version: "6"
title: "community.azure.azure_rm_lock_info module – Manage Azure locks"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/azure/azure_rm_lock_info_module.html
...
> see [Requirements](azure_rm_lock_info_module.md#ansible-collections-community-azure-azure-rm-lock-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.azure.azure_rm_lock_info`.

- [DEPRECATED](azure_rm_lock_info_module.md#deprecated)
- [Synopsis](azure_rm_lock_info_module.md#synopsis)
- [Requirements](azure_rm_lock_info_module.md#requirements)
- [Parameters](azure_rm_lock_info_module.md#parameters)
- [Notes](azure_rm_lock_info_module.md#notes)
- [See Also](azure_rm_lock_info_module.md#see-also)
- [Examples](azure_rm_lock_info_module.md#examples)
- [Return Values](azure_rm_lock_info_module.md#return-values)
- [Status](azure_rm_lock_info_module.md#status)

## [DEPRECATED](azure_rm_lock_info_module.md#id1)
...
Alternative:
:   Use [azure.azcollection.azure_rm_lock_info](../../azure/azcollection/azure_rm_lock_info_module.md#ansible-collections-azure-azcollection-azure-rm-lock-info-module) instead.

## [Synopsis](azure_rm_lock_info_module.md#id2)

- Create, delete an Azure lock.

## [Requirements](azure_rm_lock_info_module.md#id3)
...
## [Parameters](azure_rm_lock_info_module.md#id4)
...
## [Notes](azure_rm_lock_info_module.md#id5)
...
## [See Also](azure_rm_lock_info_module.md#id6)
...
## [Examples](azure_rm_lock_info_module.md#id7)
...
## [Return Values](azure_rm_lock_info_module.md#id8)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **locks**  complex | List of locks dicts.  Returned: always |
| **id**  string | ID of the Lock.  Returned: always  Sample: `"/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Authorization/locks/myLock"` |
| **level**  string | Type level of the lock.  Returned: always  Sample: `"can_not_delete"` |
| **name**  string | Name of the lock.  Returned: always  Sample: `"myLock"` |
| **notes**  string | Notes of the lock added by creator.  Returned: always  Sample: `"This is a lock"` |

## [Status](azure_rm_lock_info_module.md#id9)

- This module will be removed in version 2.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](azure_rm_lock_info_module.md#deprecated).
