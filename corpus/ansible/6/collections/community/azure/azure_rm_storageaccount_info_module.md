...
collection: ansible
version: "6"
title: "community.azure.azure_rm_storageaccount_info module – Get storage account facts"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/azure/azure_rm_storageaccount_info_module.html
fetched_at: 2026-07-27T17:05:55+00:00
---
# community.azure.azure_rm_storageaccount_info module – Get storage account facts
...
> see [Requirements](azure_rm_storageaccount_info_module.md#ansible-collections-community-azure-azure-rm-storageaccount-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.azure.azure_rm_storageaccount_info`.

- [DEPRECATED](azure_rm_storageaccount_info_module.md#deprecated)
...
- [Status](azure_rm_storageaccount_info_module.md#status)

## [DEPRECATED](azure_rm_storageaccount_info_module.md#id1)
...
Alternative:
:   Use [azure.azcollection.azure_rm_storageaccount_info](../../azure/azcollection/azure_rm_storageaccount_info_module.md#ansible-collections-azure-azcollection-azure-rm-storageaccount-info-module) instead.

## [Synopsis](azure_rm_storageaccount_info_module.md#id2)

- Get facts for one storage account or all storage accounts within a resource group.

## [Requirements](azure_rm_storageaccount_info_module.md#id3)
...
## [Parameters](azure_rm_storageaccount_info_module.md#id4)
...
## [Notes](azure_rm_storageaccount_info_module.md#id5)
...
## [See Also](azure_rm_storageaccount_info_module.md#id6)
...
## [Examples](azure_rm_storageaccount_info_module.md#id7)
...
## [Return Values](azure_rm_storageaccount_info_module.md#id8)
...
| **primary_endpoints**  complex | URLs to retrieve a public *blob*, *queue*, or *table* object.  Note that `Standard_ZRS` and `Premium_LRS` accounts only return the blob endpoint.  Returned: always |
...
| **secondary_endpoints**  complex | The URLs to retrieve a public *blob*, *queue*, or *table* object from the secondary location.  Only available if the SKU *name=Standard_RAGRS*.  Returned: always |
...
## [Status](azure_rm_storageaccount_info_module.md#id9)

- This module will be removed in version 2.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](azure_rm_storageaccount_info_module.md#deprecated).
