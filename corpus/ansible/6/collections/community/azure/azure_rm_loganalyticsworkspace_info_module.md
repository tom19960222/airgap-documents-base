...
collection: ansible
version: "6"
title: "community.azure.azure_rm_loganalyticsworkspace_info module – Get facts of Azure Log Analytics workspaces"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/azure/azure_rm_loganalyticsworkspace_info_module.html
fetched_at: 2026-07-27T17:05:36+00:00
---
# community.azure.azure_rm_loganalyticsworkspace_info module – Get facts of Azure Log Analytics workspaces
...
> see [Requirements](azure_rm_loganalyticsworkspace_info_module.md#ansible-collections-community-azure-azure-rm-loganalyticsworkspace-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.azure.azure_rm_loganalyticsworkspace_info`.

- [DEPRECATED](azure_rm_loganalyticsworkspace_info_module.md#deprecated)
...
- [Status](azure_rm_loganalyticsworkspace_info_module.md#status)

## [DEPRECATED](azure_rm_loganalyticsworkspace_info_module.md#id1)
...
Alternative:
:   Use [azure.azcollection.azure_rm_loganalyticsworkspace_info](../../azure/azcollection/azure_rm_loganalyticsworkspace_info_module.md#ansible-collections-azure-azcollection-azure-rm-loganalyticsworkspace-info-module) instead.

## [Synopsis](azure_rm_loganalyticsworkspace_info_module.md#id2)

- Get, query Azure Log Analytics workspaces.

## [Requirements](azure_rm_loganalyticsworkspace_info_module.md#id3)
...
## [Parameters](azure_rm_loganalyticsworkspace_info_module.md#id4)
...
## [Notes](azure_rm_loganalyticsworkspace_info_module.md#id5)
...
## [See Also](azure_rm_loganalyticsworkspace_info_module.md#id6)
...
## [Examples](azure_rm_loganalyticsworkspace_info_module.md#id7)
...
## [Return Values](azure_rm_loganalyticsworkspace_info_module.md#id8)
...
| **shared_keys**  dictionary | Shared keys for the workspace.  Returned: success  Sample: `{"primarySharedKey": "BozLY1JnZbxu0jWUQSY8iRPEM8ObmpP8rW+8bUl3+HpDJI+n689SxXgTgU7k1qdxo/WugRLxechxbolAfHM5uA==", "secondarySharedKey": "7tDt5W0JBrCQKtQA3igfFltLSzJeyr9LmuT+B/ibzd8cdC1neZ1ePOQLBx5NUzc0q2VUIK0cLhWNyFvo/hT8Ww=="}` |
...
## [Status](azure_rm_loganalyticsworkspace_info_module.md#id9)

- This module will be removed in version 2.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](azure_rm_loganalyticsworkspace_info_module.md#deprecated).
