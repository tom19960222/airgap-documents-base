...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/postgresql/postgresql_publication_module.html
...
## [Notes](postgresql_publication_module.md#id4)
...
## [See Also](postgresql_publication_module.md#id5)
...
## [Examples](postgresql_publication_module.md#id6)
...
## [Return Values](postgresql_publication_module.md#id7)
...
| **exists**  boolean | Flag indicates the publication exists or not at the end of runtime.  Returned: always  Sample: `true` |
...
| **queries**  string | List of executed queries.  Returned: always  Sample: `"['DROP PUBLICATION \"acme\" CASCADE']"` |
