...
collection: ansible
version: "6"
title: "community.hashi_vault.vault_kv2_get lookup – Get a secret from HashiCorp Vault’s KV version 2 secret store"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/hashi_vault/vault_kv2_get_lookup.html
fetched_at: 2026-07-27T17:15:46+00:00
---
...
> see [Requirements](vault_kv2_get_lookup.md#ansible-collections-community-hashi-vault-vault-kv2-get-lookup-requirements) for details.
>
> To use it in a playbook, specify: `community.hashi_vault.vault_kv2_get`.

New in community.hashi_vault 2.5.0

- [Synopsis](vault_kv2_get_lookup.md#synopsis)
- [Requirements](vault_kv2_get_lookup.md#requirements)
- [Terms](vault_kv2_get_lookup.md#terms)
- [Keyword parameters](vault_kv2_get_lookup.md#keyword-parameters)
- [Notes](vault_kv2_get_lookup.md#notes)
- [See Also](vault_kv2_get_lookup.md#see-also)
- [Examples](vault_kv2_get_lookup.md#examples)
- [Return Value](vault_kv2_get_lookup.md#return-value)

## [Synopsis](vault_kv2_get_lookup.md#id1)

- Gets a secret from HashiCorp Vault’s KV version 2 secret store.

## [Requirements](vault_kv2_get_lookup.md#id2)
...
## [Terms](vault_kv2_get_lookup.md#id3)
...
## [Keyword parameters](vault_kv2_get_lookup.md#id4)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('community.hashi_vault.vault_kv2_get', key1=value1, key2=value2, ...)` and `query('community.hashi_vault.vault_kv2_get', key1=value1, key2=value2, ...)`
...
| **engine_mount_point**  string | The path where the secret backend is mounted.  The default value is `kv`.  The default value will change to `secret` in version 4.0.0 to match the module’s default.  Configuration:   - Variable: ansible_hashi_vault_engine_mount_point |
...
## [Notes](vault_kv2_get_lookup.md#id5)

> **Note:**
>
> - When keyword and positional parameters are used together, positional parameters must be listed before keyword parameters:
>   `lookup('community.hashi_vault.vault_kv2_get', term1, term2, key1=value1, key2=value2)` and `query('community.hashi_vault.vault_kv2_get', term1, term2, key1=value1, key2=value2)`

## [See Also](vault_kv2_get_lookup.md#id6)
...
## [Examples](vault_kv2_get_lookup.md#id7)
...
## [Return Value](vault_kv2_get_lookup.md#id8)
