...
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/hashi_vault/vault_kv2_delete_module.html
...
## [Notes](vault_kv2_delete_module.md#id4)
...
> - In check mode, the module returns `changed` status without contacting Vault. Consider using [community.hashi_vault.vault_kv2_get](vault_kv2_get_module.md#ansible-collections-community-hashi-vault-vault-kv2-get-module) to verify the existence of the secret first.

## [See Also](vault_kv2_delete_module.md#id5)
...
## [Examples](vault_kv2_delete_module.md#id6)
...
## [Return Values](vault_kv2_delete_module.md#id7)
