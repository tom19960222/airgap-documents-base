...
collection: ansible
version: "6"
title: "Migrating from the hashi_vault lookup"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/hashi_vault/docsite/migration_hashi_vault_lookup.html
fetched_at: 2026-07-27T17:15:35+00:00
---
# Migrating from the `hashi_vault` lookup

This is a guide for migrating from the `hashi_vault` [lookup plugin](../hashi_vault_lookup.md#ansible-collections-community-hashi-vault-hashi-vault-lookup) to newer content in this collection.

To understand why, please see [this page describing the plugin’s history and future](about_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-about-hashi-vault-lookup).

- [A note about lookups vs. modules](migration_hashi_vault_lookup.md#a-note-about-lookups-vs-modules)
- [General changes](migration_hashi_vault_lookup.md#general-changes)

  - [Options: direct vs. term string](migration_hashi_vault_lookup.md#options-direct-vs-term-string)
  - [Key dereferencing](migration_hashi_vault_lookup.md#key-dereferencing)
  - [Return format](migration_hashi_vault_lookup.md#return-format)
- [Vault KV reads](migration_hashi_vault_lookup.md#vault-kv-reads)

  - [KV1 and KV2 response structure](migration_hashi_vault_lookup.md#kv1-and-kv2-response-structure)
  - [KV1 and KV2 API paths](migration_hashi_vault_lookup.md#kv1-and-kv2-api-paths)
  - [KV2 secret vesions](migration_hashi_vault_lookup.md#kv2-secret-vesions)
  - [KV get replacements](migration_hashi_vault_lookup.md#kv-get-replacements)
  - [Examples](migration_hashi_vault_lookup.md#examples)
- [General reads (non-KV)](migration_hashi_vault_lookup.md#general-reads-non-kv)

## [A note about lookups vs. modules](migration_hashi_vault_lookup.md#id1)
...
For more information, see the [lookup guide](lookup_guide.md#ansible-collections-community-hashi-vault-docsite-lookup-guide).

## [General changes](migration_hashi_vault_lookup.md#id2)

This section will cover some general differences not related to specific scenarios.

### [Options: direct vs. term string](migration_hashi_vault_lookup.md#id3)
...
### [Key dereferencing](migration_hashi_vault_lookup.md#id4)
...
This looks a lot better, and it is from a readability perspective, but **in fact it will operate exactly the same way**, making a new request on every reference to `secret`. This is due to lazy template evaluation in Ansible, and is discussed in more detail in the [lookup guide](lookup_guide.md#ansible-collections-community-hashi-vault-docsite-lookup-guide). This can be remedied by either using `ansible.builtin.set_fact` to set the `secret` variable, or by using a module to do the read.

If you have extensive use of the colon `:` syntax, updating it before moving onto other plugins is recommended.

### [Return format](migration_hashi_vault_lookup.md#id5)
...
The `hashi_vault` lookup takes a `return_format` option that defaults to `dict`. The lookup always looks for a `data` field (see the [KV response details](migration_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-migration-hashi-vault-lookup-kv-response) for more information), and that is what is returned by default.
...
For reading non-KV paths [other options are available](migration_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-migration-hashi-vault-lookup-non-kv-replacements).

For getting access to KV2 metadata, see the section on [KV replacements](migration_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-migration-hashi-vault-lookup-kv-replacements).
...
## [Vault KV reads](migration_hashi_vault_lookup.md#id6)
...
### [KV1 and KV2 response structure](migration_hashi_vault_lookup.md#id7)
...
### [KV1 and KV2 API paths](migration_hashi_vault_lookup.md#id8)
...
### [KV2 secret vesions](migration_hashi_vault_lookup.md#id9)
...
### [KV get replacements](migration_hashi_vault_lookup.md#id10)

As of collection version 2.5.0, the `vault_kv1_get` and `vault_kv2_get` lookups and modules were added:

> - `vault_kv1_get` [lookup](../vault_kv1_get_lookup.md#ansible-collections-community-hashi-vault-vault-kv1-get-lookup)
> - `vault_kv2_get` [lookup](../vault_kv2_get_lookup.md#ansible-collections-community-hashi-vault-vault-kv2-get-lookup)
> - `vault_kv1_get` [module](../vault_kv1_get_module.md#ansible-collections-community-hashi-vault-vault-kv1-get-module)
> - `vault_kv2_get` [module](../vault_kv2_get_module.md#ansible-collections-community-hashi-vault-vault-kv2-get-module)
...
### [Examples](migration_hashi_vault_lookup.md#id11)
...
## [General reads (non-KV)](migration_hashi_vault_lookup.md#id12)
...
> - `vault_read` [lookup](../vault_read_lookup.md#ansible-collections-community-hashi-vault-vault-read-lookup)
> - `vault_read` [module](../vault_read_module.md#ansible-collections-community-hashi-vault-vault-read-module)
