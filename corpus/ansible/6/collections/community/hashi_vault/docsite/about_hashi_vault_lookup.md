...
collection: ansible
version: "6"
title: "About the hashi_vault lookup"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/hashi_vault/docsite/about_hashi_vault_lookup.html
fetched_at: 2026-07-27T17:15:36+00:00
---
# About the `hashi_vault` lookup

This page explains the past, present, and future of the `hashi_vault` [lookup plugin](../hashi_vault_lookup.md#ansible-collections-community-hashi-vault-hashi-vault-lookup).
...
At this time, we recommend using newer content in the collection, and we believe all use cases for `hashi_vault` have been covered by newer plugins. To understand the history, continue reading this document. For help with migration, [the hashi_vault migration guide](migration_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-migration-hashi-vault-lookup) has you covered.

- [Synopsis](about_hashi_vault_lookup.md#synopsis)
- [The long story](about_hashi_vault_lookup.md#the-long-story)

  - [`hashi_vault` lookup considerations](about_hashi_vault_lookup.md#hashi-vault-lookup-considerations)
  - [How we are addressing the considerations](about_hashi_vault_lookup.md#how-we-are-addressing-the-considerations)
  - [The future of the `hashi_vault` lookup](about_hashi_vault_lookup.md#the-future-of-the-hashi-vault-lookup)

## [Synopsis](about_hashi_vault_lookup.md#id1)
...
## [The long story](about_hashi_vault_lookup.md#id2)

### [`hashi_vault` lookup considerations](about_hashi_vault_lookup.md#id3)
...
### [How we are addressing the considerations](about_hashi_vault_lookup.md#id4)
...
In addition, it is now possible to perform a login directly and return the token, for general re-use, via the `community.hashi_vault.vault_login` [module](../vault_login_module.md#ansible-collections-community-hashi-vault-vault-login-module) and [lookup plugin](../vault_login_lookup.md#ansible-collections-community-hashi-vault-vault-login-lookup).

Generic read (not `kv` specific) is still important functionality, so we have the `community.hashi_vault.vault_read` [module](../vault_read_module.md#ansible-collections-community-hashi-vault-vault-read-module) and [lookup plugin](../vault_read_lookup.md#ansible-collections-community-hashi-vault-vault-read-lookup) to provide that without trying to infer whether the response is from a specific backend.

Since reading from the `kv` store is by far the most common use case, we have dedicated content for that:

- `community.hashi_vault.vault_kv1_get` [module](../vault_kv1_get_module.md#ansible-collections-community-hashi-vault-vault-kv1-get-module)
- `community.hashi_vault.vault_kv2_get` [module](../vault_kv2_get_module.md#ansible-collections-community-hashi-vault-vault-kv2-get-module)
...
- specialized filters in some circumstances, such as the `vault_login_token` [filter](filter_guide.md#ansible-collections-community-hashi-vault-docsite-filter-guide-vault-login-token).
...
### [The future of the `hashi_vault` lookup](about_hashi_vault_lookup.md#id5)
