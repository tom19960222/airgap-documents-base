...
collection: ansible
version: "6"
title: "localenv developer guide"
source_url: https://docs.ansible.com/projects/ansible/6/collections/community/hashi_vault/docsite/localenv_developer_guide.html
fetched_at: 2026-07-27T17:15:38+00:00
---
...
- [Required external dependencies](localenv_developer_guide.md#required-external-dependencies)

  - [HashiCorp Vault](localenv_developer_guide.md#hashicorp-vault)
  - [Proxy server](localenv_developer_guide.md#proxy-server)
  - [MMock server](localenv_developer_guide.md#mmock-server)
- [localenv role conventions](localenv_developer_guide.md#localenv-role-conventions)

## [Required external dependencies](localenv_developer_guide.md#id3)

### [HashiCorp Vault](localenv_developer_guide.md#id4)

A Vault server is required for the integration tests. Using [Vault Dev Server Mode](https://www.vaultproject.io/docs/concepts/dev-server) is recommended as it’s the easiest and fastest way to get a server started.
...
### [Proxy server](localenv_developer_guide.md#id5)

A proxy server is used to test the proxy connectivity options.

In theory any proxy supporting http/s targets could be used for this purpose, but [tinyproxy](https://github.com/tinyproxy/tinyproxy) is recommended for being, well.. tiny, as well as easy to configure and run, and available in package managers and containers.
...
### [MMock server](localenv_developer_guide.md#id6)

[MMock (short for Monster Mock)](https://github.com/jmartin82/mmock) is an HTTP server designed for mocking HTTP responses. It can also transparently proxy through to a real server. We use it to proxy our test Vault server while intercepting certain API calls to Vault and returning mocked responses.
...
## [localenv role conventions](localenv_developer_guide.md#id7)
