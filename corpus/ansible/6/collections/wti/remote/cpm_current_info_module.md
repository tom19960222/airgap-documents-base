...
collection: ansible
version: "6"
title: "wti.remote.cpm_current_info module – Get the Current Information of a WTI device"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_current_info_module.html
fetched_at: 2026-07-28T00:23:38+00:00
---
# wti.remote.cpm_current_info module – Get the Current Information of a WTI device
...
- [Synopsis](cpm_current_info_module.md#synopsis)
- [Parameters](cpm_current_info_module.md#parameters)
- [Notes](cpm_current_info_module.md#notes)
- [Examples](cpm_current_info_module.md#examples)
- [Return Values](cpm_current_info_module.md#return-values)

## [Synopsis](cpm_current_info_module.md#id1)

- Get the Current Information of a WTI device

## [Parameters](cpm_current_info_module.md#id2)
...
## [Notes](cpm_current_info_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_current_info_module.md#id4)
...
## [Return Values](cpm_current_info_module.md#id5)
