...
collection: ansible
version: "6"
title: "wti.remote.cpm_status_info module – Get general status information from WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_status_info_module.html
fetched_at: 2026-07-28T00:23:53+00:00
---
...
- [Synopsis](cpm_status_info_module.md#synopsis)
- [Parameters](cpm_status_info_module.md#parameters)
- [Notes](cpm_status_info_module.md#notes)
- [Examples](cpm_status_info_module.md#examples)
- [Return Values](cpm_status_info_module.md#return-values)

## [Synopsis](cpm_status_info_module.md#id1)

- Get temperature general status from WTI OOB and PDU devices

## [Parameters](cpm_status_info_module.md#id2)
...
## [Notes](cpm_status_info_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_status_info_module.md#id4)
...
## [Return Values](cpm_status_info_module.md#id5)
