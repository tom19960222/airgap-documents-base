...
collection: ansible
version: "6"
title: "wti.remote.cpm_hostname_config module – Set Hostname (Site ID), Location, Asset Tag parameters in WTI OOB and PDU devices."
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_hostname_config_module.html
fetched_at: 2026-07-28T00:23:40+00:00
---
...
- [Synopsis](cpm_hostname_config_module.md#synopsis)
- [Parameters](cpm_hostname_config_module.md#parameters)
- [Notes](cpm_hostname_config_module.md#notes)
- [Examples](cpm_hostname_config_module.md#examples)
- [Return Values](cpm_hostname_config_module.md#return-values)

## [Synopsis](cpm_hostname_config_module.md#id1)

- Set Hostname (Site ID), Location, Asset Tag parameters parameters in WTI OOB and PDU devices

## [Parameters](cpm_hostname_config_module.md#id2)
...
## [Notes](cpm_hostname_config_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.

## [Examples](cpm_hostname_config_module.md#id4)
...
## [Return Values](cpm_hostname_config_module.md#id5)
