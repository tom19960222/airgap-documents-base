...
collection: ansible
version: "6"
title: "wti.remote.cpm_current_info lookup – Get the Current Information of a WTI device"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_current_info_lookup.html
fetched_at: 2026-07-28T00:24:02+00:00
---
...
- [Synopsis](cpm_current_info_lookup.md#synopsis)
- [Keyword parameters](cpm_current_info_lookup.md#keyword-parameters)
- [Notes](cpm_current_info_lookup.md#notes)
- [Examples](cpm_current_info_lookup.md#examples)
- [Return Value](cpm_current_info_lookup.md#return-value)

## [Synopsis](cpm_current_info_lookup.md#id1)

- Get the Current Information of a WTI device

## [Keyword parameters](cpm_current_info_lookup.md#id2)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('wti.remote.cpm_current_info', key1=value1, key2=value2, ...)` and `query('wti.remote.cpm_current_info', key1=value1, key2=value2, ...)`
...
## [Notes](cpm_current_info_lookup.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_current_info_lookup.md#id4)
...
## [Return Value](cpm_current_info_lookup.md#id5)
...
| **powerdata**  dictionary | Power data of the WTI device after module execution.  Returned: success  Sample: `[{"branch1": [{"current1": "0.00", "voltage1": "118.00"}], "format": "F", "temperature": "90", "timestamp": "2020-02-24T23:29:31+00:00"}]` |
