...
collection: ansible
version: "6"
title: "wti.remote.cpm_snmp_info lookup – Get network SNMP parameters from WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_snmp_info_lookup.html
fetched_at: 2026-07-28T00:24:15+00:00
---
# wti.remote.cpm_snmp_info lookup – Get network SNMP parameters from WTI OOB and PDU devices
...
- [Synopsis](cpm_snmp_info_lookup.md#synopsis)
- [Keyword parameters](cpm_snmp_info_lookup.md#keyword-parameters)
- [Notes](cpm_snmp_info_lookup.md#notes)
- [Examples](cpm_snmp_info_lookup.md#examples)
- [Return Value](cpm_snmp_info_lookup.md#return-value)

## [Synopsis](cpm_snmp_info_lookup.md#id1)

- Get network SNMP parameters from WTI OOB and PDU devices

## [Keyword parameters](cpm_snmp_info_lookup.md#id2)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('wti.remote.cpm_snmp_info', key1=value1, key2=value2, ...)` and `query('wti.remote.cpm_snmp_info', key1=value1, key2=value2, ...)`
...
| **interface**  string | This is the ethernet port name that is getting retrieved. It can include a single ethernet  port name, multiple ethernet port names separated by commas or not defined for all ports.  Choices:   - `"eth0"` - `"eth1"` - `"ppp0"` |
...
## [Notes](cpm_snmp_info_lookup.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_snmp_info_lookup.md#id4)
...
## [Return Value](cpm_snmp_info_lookup.md#id5)
