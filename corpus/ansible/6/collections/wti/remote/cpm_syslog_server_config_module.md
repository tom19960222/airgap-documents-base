...
collection: ansible
version: "6"
title: "wti.remote.cpm_syslog_server_config module – Set network SYSLOG Server parameters in WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_syslog_server_config_module.html
fetched_at: 2026-07-28T00:23:55+00:00
---
# wti.remote.cpm_syslog_server_config module – Set network SYSLOG Server parameters in WTI OOB and PDU devices
...
- [Synopsis](cpm_syslog_server_config_module.md#synopsis)
- [Parameters](cpm_syslog_server_config_module.md#parameters)
- [Notes](cpm_syslog_server_config_module.md#notes)
- [Examples](cpm_syslog_server_config_module.md#examples)
- [Return Values](cpm_syslog_server_config_module.md#return-values)

## [Synopsis](cpm_syslog_server_config_module.md#id1)

- Set network SYSLOG Server parameters in WTI OOB and PDU devices

## [Parameters](cpm_syslog_server_config_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  list / elements=string | Sets the IP Address to block message logging. |
...
## [Notes](cpm_syslog_server_config_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.

## [Examples](cpm_syslog_server_config_module.md#id4)
...
## [Return Values](cpm_syslog_server_config_module.md#id5)
