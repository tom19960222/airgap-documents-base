...
collection: ansible
version: "6"
title: "wti.remote.cpm_serial_port_action_info module – Get Serial port connection status in WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/wti/remote/cpm_serial_port_action_info_module.html
fetched_at: 2026-07-28T00:23:48+00:00
---
# wti.remote.cpm_serial_port_action_info module – Get Serial port connection status in WTI OOB and PDU devices
...
- [Synopsis](cpm_serial_port_action_info_module.md#synopsis)
- [Parameters](cpm_serial_port_action_info_module.md#parameters)
- [Notes](cpm_serial_port_action_info_module.md#notes)
- [Examples](cpm_serial_port_action_info_module.md#examples)
- [Return Values](cpm_serial_port_action_info_module.md#return-values)

## [Synopsis](cpm_serial_port_action_info_module.md#id1)

- Get Serial port connection status from WTI OOB and PDU devices

## [Parameters](cpm_serial_port_action_info_module.md#id2)
...
## [Notes](cpm_serial_port_action_info_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_serial_port_action_info_module.md#id4)
...
## [Return Values](cpm_serial_port_action_info_module.md#id5)
