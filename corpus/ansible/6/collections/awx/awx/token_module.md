...
source_url: https://docs.ansible.com/projects/ansible/6/collections/awx/awx/token_module.html
...
| **description**  string | Optional description of this access token.  Default: `""` |
...
| **scope**  string | Allowed scopes, further restricts user’s permissions. Must be a simple space-separated string with allowed scopes [‘read’, ‘write’].  Choices:   - `"read"` - `"write"` ← (default) |
