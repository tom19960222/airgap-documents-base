...
source_url: https://docs.ansible.com/projects/ansible/6/collections/awx/awx/schedule_module.html
...
| **extra_data**  dictionary | Specify `extra_vars` for the template.  Default: `{}` |
...
| **unified_job_template**  string | Name of unified job template to schedule. Used to look up an already existing schedule. |
