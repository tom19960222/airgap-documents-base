...
source_url: https://docs.ansible.com/projects/ansible/6/collections/awx/awx/credential_input_source_module.html
...
| **source_credential**  string | The credential which is the source of the credential lookup |
| **state**  string | Desired state of the resource.  Choices:   - `"present"` ← (default) - `"absent"` |
| **target_credential**  string / required | The credential which will have its input defined by this source |
