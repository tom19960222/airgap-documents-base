...
collection: ansible
version: "6"
title: "t_systems_mms.icinga_director.icinga_host module – Manage hosts in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/6/collections/t_systems_mms/icinga_director/icinga_host_module.html
...
| **address6**  string  added in t_systems_mms.icinga_director 1.4.0 | Host IPv6 address. Usually an IPv6 address, but may be any kind of address your check plugin is able to deal with. |
