...
collection: ansible
version: "6"
title: "t_systems_mms.icinga_director.icinga_user module – Manage users in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/6/collections/t_systems_mms/icinga_director/icinga_user_module.html
fetched_at: 2026-07-28T00:20:22+00:00
---
# t_systems_mms.icinga_director.icinga_user module – Manage users in Icinga2
...
- [Synopsis](icinga_user_module.md#synopsis)
- [Parameters](icinga_user_module.md#parameters)
- [Notes](icinga_user_module.md#notes)
- [Examples](icinga_user_module.md#examples)

## [Synopsis](icinga_user_module.md#id1)

- Add or remove a user to Icinga2 through the director API.

## [Parameters](icinga_user_module.md#id2)
...
| **groups**  list / elements=string | User groups that should be directly assigned to this user.  Groups can be useful for various reasons. You might prefer to send notifications to groups instead of single users. |
...
| **object_name**  aliases: name  string / required | Name of the user. |
...
## [Notes](icinga_user_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_user_module.md#id4)
