...
collection: ansible
version: "6"
title: "t_systems_mms.icinga_director.icinga_scheduled_downtime module – Manage downtimes in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/6/collections/t_systems_mms/icinga_director/icinga_scheduled_downtime_module.html
fetched_at: 2026-07-28T00:20:12+00:00
---
...
- [Synopsis](icinga_scheduled_downtime_module.md#synopsis)
- [Parameters](icinga_scheduled_downtime_module.md#parameters)
- [Notes](icinga_scheduled_downtime_module.md#notes)
- [Examples](icinga_scheduled_downtime_module.md#examples)

## [Synopsis](icinga_scheduled_downtime_module.md#id1)

- Add or remove a downtime to Icinga2 through the director API.

## [Parameters](icinga_scheduled_downtime_module.md#id2)
...
| **apply_to**  string | Whether this dependency should affect hosts or services  Required if *state* is `present`.  Choices:   - `"host"` - `"service"` |
...
| **fixed**  boolean | Whether this downtime is fixed or flexible. If unsure please check the related documentation <https://icinga.com/docs/icinga2/latest/doc/08-advanced-topics/#downtimes>  Required if *state* is `present`.  Choices:   - `false` ← (default) - `true` |
...
| **object_name**  aliases: name  string / required | Icinga object name for this downtime. |
| **ranges**  dictionary | The period which should be downtimed  Default: `{}` |
...
| **with_services**  boolean | Whether you only downtime the hosts or add some services with it.  Choices:   - `false` - `true` ← (default) |

## [Notes](icinga_scheduled_downtime_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_scheduled_downtime_module.md#id4)
