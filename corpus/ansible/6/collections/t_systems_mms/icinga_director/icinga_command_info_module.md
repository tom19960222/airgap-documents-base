...
collection: ansible
version: "6"
title: "t_systems_mms.icinga_director.icinga_command_info module – Query commands in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/6/collections/t_systems_mms/icinga_director/icinga_command_info_module.html
fetched_at: 2026-07-28T00:20:02+00:00
---
# t_systems_mms.icinga_director.icinga_command_info module – Query commands in Icinga2
...
>
> To use it in a playbook, specify: `t_systems_mms.icinga_director.icinga_command_info`.

New in t_systems_mms.icinga_director 1.13.0

- [Synopsis](icinga_command_info_module.md#synopsis)
- [Parameters](icinga_command_info_module.md#parameters)
- [Notes](icinga_command_info_module.md#notes)
- [Examples](icinga_command_info_module.md#examples)
- [Return Values](icinga_command_info_module.md#return-values)

## [Synopsis](icinga_command_info_module.md#id1)

- Get a list of command objects from Icinga2 through the director API.

## [Parameters](icinga_command_info_module.md#id2)
...
| **external**  boolean | Also include external objects in output.  Choices:   - `false` ← (default) - `true` |
...
## [Notes](icinga_command_info_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_command_info_module.md#id4)
...
## [Return Values](icinga_command_info_module.md#id5)
