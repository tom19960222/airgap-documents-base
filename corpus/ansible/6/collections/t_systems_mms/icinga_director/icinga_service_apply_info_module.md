...
collection: ansible
version: "6"
title: "t_systems_mms.icinga_director.icinga_service_apply_info module – Query service apply rules in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/6/collections/t_systems_mms/icinga_director/icinga_service_apply_info_module.html
fetched_at: 2026-07-28T00:20:15+00:00
---
# t_systems_mms.icinga_director.icinga_service_apply_info module – Query service apply rules in Icinga2
...
>
> To use it in a playbook, specify: `t_systems_mms.icinga_director.icinga_service_apply_info`.

New in t_systems_mms.icinga_director 1.13.0

- [Synopsis](icinga_service_apply_info_module.md#synopsis)
- [Parameters](icinga_service_apply_info_module.md#parameters)
- [Notes](icinga_service_apply_info_module.md#notes)
- [Examples](icinga_service_apply_info_module.md#examples)
- [Return Values](icinga_service_apply_info_module.md#return-values)

## [Synopsis](icinga_service_apply_info_module.md#id1)

- Get a list of service apply rule objects from Icinga2 through the director API.

## [Parameters](icinga_service_apply_info_module.md#id2)
...
## [Notes](icinga_service_apply_info_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_service_apply_info_module.md#id4)
...
## [Return Values](icinga_service_apply_info_module.md#id5)
