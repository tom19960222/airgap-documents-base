...
collection: ansible
version: "6"
title: "inspur.sm.add_user module – Create user."
source_url: https://docs.ansible.com/projects/ansible/6/collections/inspur/sm/add_user_module.html
fetched_at: 2026-07-27T17:52:41+00:00
---
# inspur.sm.add_user module – Create user.
...
- [DEPRECATED](add_user_module.md#deprecated)
- [Synopsis](add_user_module.md#synopsis)
- [Parameters](add_user_module.md#parameters)
- [Examples](add_user_module.md#examples)
- [Return Values](add_user_module.md#return-values)
- [Status](add_user_module.md#status)

## [DEPRECATED](add_user_module.md#id1)
...
## [Synopsis](add_user_module.md#id2)

- Create user on Inspur server.

## [Parameters](add_user_module.md#id3)
...
## [Examples](add_user_module.md#id4)
...
## [Return Values](add_user_module.md#id5)
...
## [Status](add_user_module.md#id6)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](add_user_module.md#deprecated).
