...
collection: ansible
version: "6"
title: "inspur.ispim.ldap_group module – Manage ldap group information"
source_url: https://docs.ansible.com/projects/ansible/6/collections/inspur/ispim/ldap_group_module.html
fetched_at: 2026-07-27T17:52:02+00:00
---
# inspur.ispim.ldap_group module – Manage ldap group information
...
> see [Requirements](ldap_group_module.md#ansible-collections-inspur-ispim-ldap-group-module-requirements) for details.
>
> To use it in a playbook, specify: `inspur.ispim.ldap_group`.

New in inspur.ispim 1.0.0

- [Synopsis](ldap_group_module.md#synopsis)
- [Requirements](ldap_group_module.md#requirements)
- [Parameters](ldap_group_module.md#parameters)
- [Notes](ldap_group_module.md#notes)
...
## [Requirements](ldap_group_module.md#id2)
...
## [Parameters](ldap_group_module.md#id3)
...
## [Notes](ldap_group_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`.

## [Examples](ldap_group_module.md#id5)
...
## [Return Values](ldap_group_module.md#id6)
