...
source_url: https://docs.ansible.com/projects/ansible/6/collections/theforeman/foreman/compute_resource_module.html
fetched_at: 2026-07-28T00:20:32+00:00
---
...
| **provider**  string | Compute resource provider. Required if *state=present_with_defaults*.  Choices:   - `"vmware"` - `"libvirt"` - `"ovirt"` - `"proxmox"` - `"EC2"` - `"AzureRm"` - `"GCE"` |
...
## [Examples](compute_resource_module.md#id4)
...
## [Return Values](compute_resource_module.md#id5)
