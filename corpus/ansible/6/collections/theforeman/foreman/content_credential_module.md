...
source_url: https://docs.ansible.com/projects/ansible/6/collections/theforeman/foreman/content_credential_module.html
fetched_at: 2026-07-28T00:20:33+00:00
---
...
| **content_type**  string / required | Type of credential  Choices:   - `"gpg_key"` - `"cert"` |
...
## [Examples](content_credential_module.md#id4)
...
## [Return Values](content_credential_module.md#id5)
