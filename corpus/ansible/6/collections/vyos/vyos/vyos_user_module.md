...
source_url: https://docs.ansible.com/projects/ansible/6/collections/vyos/vyos/vyos_user_module.html
...
| **configured_password**  string | The password to be configured on the VyOS device. The password needs to be provided in clear and it will be encrypted on the device. Please note that this option is not same as `provider password`. |
