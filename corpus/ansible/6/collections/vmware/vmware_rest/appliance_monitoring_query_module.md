...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_monitoring_query module – Get monitoring data."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_monitoring_query_module.html
...
> see [Requirements](appliance_monitoring_query_module.md#ansible-collections-vmware-vmware-rest-appliance-monitoring-query-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_monitoring_query`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_monitoring_query_module.md#synopsis)
- [Requirements](appliance_monitoring_query_module.md#requirements)
- [Parameters](appliance_monitoring_query_module.md#parameters)
- [Notes](appliance_monitoring_query_module.md#notes)
- [Examples](appliance_monitoring_query_module.md#examples)
- [Return Values](appliance_monitoring_query_module.md#return-values)

## [Synopsis](appliance_monitoring_query_module.md#id1)

- Get monitoring data.

## [Requirements](appliance_monitoring_query_module.md#id2)
...
## [Parameters](appliance_monitoring_query_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **end_time**  string / required | End time in UTC This parameter is mandatory. |
| **function**  string / required | `function_type` Defines aggregation function This parameter is mandatory.  Choices:   - `"AVG"` - `"COUNT"` - `"MAX"` - `"MIN"` |
| **interval**  string / required | `interval_type` Defines interval between the values in hours and mins, for which aggregation will apply This parameter is mandatory.  Choices:   - `"DAY1"` - `"HOURS2"` - `"HOURS6"` - `"MINUTES30"` - `"MINUTES5"` |
| **names**  list / elements=string / required | monitored item IDs Ex: CPU, MEMORY This parameter is mandatory. |
...
| **start_time**  string / required | Start time in UTC This parameter is mandatory. |
...
## [Notes](appliance_monitoring_query_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_monitoring_query_module.md#id5)
...
## [Return Values](appliance_monitoring_query_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  list / elements=string | Query the monitoring backend  Returned: On success  Sample: `[{"data": ["", "", "", "", "", "", "", "", "", "", "", "", ""], "end_time": "2021-04-14T09:34:56.000Z", "function": "AVG", "interval": "MINUTES5", "name": "mem.total", "start_time": "2021-04-14T08:34:56.000Z"}]` |
