...
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_host_info_module.html
...
| Key | Description |
| --- | --- |
| **value**  list / elements=string | Get a list of the hosts  Returned: On success  Sample: `[{"connection_state": "CONNECTED", "host": "host-1147", "name": "esxi1.test", "power_state": "POWERED_ON"}]` |
