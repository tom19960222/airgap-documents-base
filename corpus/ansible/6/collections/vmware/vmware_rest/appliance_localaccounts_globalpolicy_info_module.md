...
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_localaccounts_globalpolicy_info_module.html
...
| Key | Description |
| --- | --- |
| **value**  dictionary | Get the global policy of the local accounts  Returned: On success  Sample: `{"max_days": -1, "min_days": -1, "warn_days": 5}` |
