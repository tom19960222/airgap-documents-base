...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_system_globalfips_info module – Get current appliance FIPS settings."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_system_globalfips_info_module.html
fetched_at: 2026-07-28T00:21:53+00:00
---
# vmware.vmware_rest.appliance_system_globalfips_info module – Get current appliance FIPS settings.
...
> see [Requirements](appliance_system_globalfips_info_module.md#ansible-collections-vmware-vmware-rest-appliance-system-globalfips-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_system_globalfips_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_system_globalfips_info_module.md#synopsis)
- [Requirements](appliance_system_globalfips_info_module.md#requirements)
- [Parameters](appliance_system_globalfips_info_module.md#parameters)
- [Notes](appliance_system_globalfips_info_module.md#notes)
- [Examples](appliance_system_globalfips_info_module.md#examples)

## [Synopsis](appliance_system_globalfips_info_module.md#id1)

- Get current appliance FIPS settings.

## [Requirements](appliance_system_globalfips_info_module.md#id2)
...
## [Parameters](appliance_system_globalfips_info_module.md#id3)
...
## [Notes](appliance_system_globalfips_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_system_globalfips_info_module.md#id5)
