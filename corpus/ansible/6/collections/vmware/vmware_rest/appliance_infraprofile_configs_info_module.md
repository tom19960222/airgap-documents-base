...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_infraprofile_configs_info module – List all the profiles which are registered."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_infraprofile_configs_info_module.html
fetched_at: 2026-07-28T00:21:31+00:00
---
# vmware.vmware_rest.appliance_infraprofile_configs_info module – List all the profiles which are registered.
...
> see [Requirements](appliance_infraprofile_configs_info_module.md#ansible-collections-vmware-vmware-rest-appliance-infraprofile-configs-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_infraprofile_configs_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_infraprofile_configs_info_module.md#synopsis)
- [Requirements](appliance_infraprofile_configs_info_module.md#requirements)
- [Parameters](appliance_infraprofile_configs_info_module.md#parameters)
- [Notes](appliance_infraprofile_configs_info_module.md#notes)
- [Examples](appliance_infraprofile_configs_info_module.md#examples)
- [Return Values](appliance_infraprofile_configs_info_module.md#return-values)

## [Synopsis](appliance_infraprofile_configs_info_module.md#id1)

- List all the profiles which are registered.

## [Requirements](appliance_infraprofile_configs_info_module.md#id2)
...
## [Parameters](appliance_infraprofile_configs_info_module.md#id3)
...
## [Notes](appliance_infraprofile_configs_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_infraprofile_configs_info_module.md#id5)
...
## [Return Values](appliance_infraprofile_configs_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  list / elements=string | List infraprofile configs  Returned: On success  Sample: `[{"info": "Appliance Mangment Service", "name": "ApplianceManagement"}, {"info": "ApplianceNetwork", "name": "ApplianceNetwork"}, {"info": "Authentication & Authorization Management", "name": "AuthManagement"}]` |
