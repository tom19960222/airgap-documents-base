...
collection: ansible
version: "6"
title: "vmware.vmware_rest.datastore_moid lookup – Look up MoID for vSphere datastore objects using vCenter REST API"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/datastore_moid_lookup.html
fetched_at: 2026-07-28T00:22:52+00:00
---
# vmware.vmware_rest.datastore_moid lookup – Look up MoID for vSphere datastore objects using vCenter REST API
...
> see [Requirements](datastore_moid_lookup.md#ansible-collections-vmware-vmware-rest-datastore-moid-lookup-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.datastore_moid`.

New in vmware.vmware_rest 2.1.0

- [Synopsis](datastore_moid_lookup.md#synopsis)
- [Requirements](datastore_moid_lookup.md#requirements)
- [Terms](datastore_moid_lookup.md#terms)
- [Keyword parameters](datastore_moid_lookup.md#keyword-parameters)
- [Notes](datastore_moid_lookup.md#notes)
- [Examples](datastore_moid_lookup.md#examples)
- [Return Value](datastore_moid_lookup.md#return-value)

## [Synopsis](datastore_moid_lookup.md#id1)

- Returns Managed Object Reference (MoID) of the vSphere datastore object object contained in the specified path.

## [Requirements](datastore_moid_lookup.md#id2)
...
## [Terms](datastore_moid_lookup.md#id3)

| Parameter | Comments |
| --- | --- |
| **Terms**  string / required | Path to query. |

## [Keyword parameters](datastore_moid_lookup.md#id4)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('vmware.vmware_rest.datastore_moid', key1=value1, key2=value2, ...)` and `query('vmware.vmware_rest.datastore_moid', key1=value1, key2=value2, ...)`
...
## [Notes](datastore_moid_lookup.md#id5)

> **Note:**
>
> - When keyword and positional parameters are used together, positional parameters must be listed before keyword parameters:
>   `lookup('vmware.vmware_rest.datastore_moid', term1, term2, key1=value1, key2=value2)` and `query('vmware.vmware_rest.datastore_moid', term1, term2, key1=value1, key2=value2)`

## [Examples](datastore_moid_lookup.md#id6)
...
## [Return Value](datastore_moid_lookup.md#id7)

| Key | Description |
| --- | --- |
| **Return value**  string | MoID of the vSphere datastore object  Returned: success  Sample: `"datastore-1019"` |
