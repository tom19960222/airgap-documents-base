...
collection: ansible
version: "6"
title: "vmware.vmware_rest.vcenter_vm_hardware_floppy module – Adds a virtual floppy drive to the virtual machine."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_vm_hardware_floppy_module.html
fetched_at: 2026-07-28T00:22:33+00:00
---
# vmware.vmware_rest.vcenter_vm_hardware_floppy module – Adds a virtual floppy drive to the virtual machine.
...
> see [Requirements](vcenter_vm_hardware_floppy_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-hardware-floppy-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_hardware_floppy`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_hardware_floppy_module.md#synopsis)
- [Requirements](vcenter_vm_hardware_floppy_module.md#requirements)
- [Parameters](vcenter_vm_hardware_floppy_module.md#parameters)
- [Notes](vcenter_vm_hardware_floppy_module.md#notes)
- [Examples](vcenter_vm_hardware_floppy_module.md#examples)
- [Return Values](vcenter_vm_hardware_floppy_module.md#return-values)

## [Synopsis](vcenter_vm_hardware_floppy_module.md#id1)

- Adds a virtual floppy drive to the virtual machine.

## [Requirements](vcenter_vm_hardware_floppy_module.md#id2)
...
## [Parameters](vcenter_vm_hardware_floppy_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **allow_guest_control**  boolean | Flag indicating whether the guest can connect and disconnect the device.  Choices:   - `false` - `true` |
| **backing**  dictionary | Physical resource backing for the virtual floppy drive. Required with *state=[‘present’]*  Valid attributes are:  - `type` (str): The `backing_type` defines the valid backing types for a virtual floppy drive. ([‘present’])  This key is required with [‘present’].    - Accepted values:      - CLIENT_DEVICE     - HOST_DEVICE     - IMAGE_FILE - `image_file` (str): Path of the image file that should be used as the virtual floppy drive backing. ([‘present’]) - `host_device` (str): Name of the device that should be used as the virtual floppy drive backing. ([‘present’]) |
| **floppy**  string | Virtual floppy drive identifier. Required with *state=[‘absent’, ‘connect’, ‘disconnect’, ‘present’]* |
...
## [Notes](vcenter_vm_hardware_floppy_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_hardware_floppy_module.md#id5)
...
## [Return Values](vcenter_vm_hardware_floppy_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **id**  string | moid of the resource  Returned: On success  Sample: `"8000"` |
| **value**  dictionary | Add a floppy disk drive  Returned: On success  Sample: `{"allow_guest_control": 1, "backing": {"auto_detect": 1, "host_device": "", "type": "HOST_DEVICE"}, "label": "Floppy drive 1", "start_connected": 0, "state": "NOT_CONNECTED"}` |
