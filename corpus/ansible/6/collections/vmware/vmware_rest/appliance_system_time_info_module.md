...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_system_time_info module – Get system time."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_system_time_info_module.html
fetched_at: 2026-07-28T00:21:54+00:00
---
# vmware.vmware_rest.appliance_system_time_info module – Get system time.
...
> see [Requirements](appliance_system_time_info_module.md#ansible-collections-vmware-vmware-rest-appliance-system-time-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_system_time_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_system_time_info_module.md#synopsis)
- [Requirements](appliance_system_time_info_module.md#requirements)
- [Parameters](appliance_system_time_info_module.md#parameters)
- [Notes](appliance_system_time_info_module.md#notes)
- [Examples](appliance_system_time_info_module.md#examples)
- [Return Values](appliance_system_time_info_module.md#return-values)

## [Synopsis](appliance_system_time_info_module.md#id1)

- Get system time.

## [Requirements](appliance_system_time_info_module.md#id2)
...
## [Parameters](appliance_system_time_info_module.md#id3)
...
## [Notes](appliance_system_time_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_system_time_info_module.md#id5)
...
## [Return Values](appliance_system_time_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Get the current time  Returned: On success  Sample: `{"date": "Thu 06-23-2022", "seconds_since_epoch": null, "time": "10:45:11 PM", "timezone": "UTC"}` |
