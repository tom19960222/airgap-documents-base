...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_networking_dns_hostname_info module – Get the Fully Qualified Doman Name."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_networking_dns_hostname_info_module.html
fetched_at: 2026-07-28T00:21:38+00:00
---
# vmware.vmware_rest.appliance_networking_dns_hostname_info module – Get the Fully Qualified Doman Name.
...
> see [Requirements](appliance_networking_dns_hostname_info_module.md#ansible-collections-vmware-vmware-rest-appliance-networking-dns-hostname-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_networking_dns_hostname_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_networking_dns_hostname_info_module.md#synopsis)
- [Requirements](appliance_networking_dns_hostname_info_module.md#requirements)
- [Parameters](appliance_networking_dns_hostname_info_module.md#parameters)
- [Notes](appliance_networking_dns_hostname_info_module.md#notes)
- [Examples](appliance_networking_dns_hostname_info_module.md#examples)
- [Return Values](appliance_networking_dns_hostname_info_module.md#return-values)

## [Synopsis](appliance_networking_dns_hostname_info_module.md#id1)

- Get the Fully Qualified Doman Name.

## [Requirements](appliance_networking_dns_hostname_info_module.md#id2)
...
## [Parameters](appliance_networking_dns_hostname_info_module.md#id3)
...
## [Notes](appliance_networking_dns_hostname_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_networking_dns_hostname_info_module.md#id5)
...
## [Return Values](appliance_networking_dns_hostname_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  string | Get the hostname configuration  Returned: On success  Sample: `"vcenter.test"` |
