...
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_system_time_timezone_info_module.html
...
| Key | Description |
| --- | --- |
| **value**  string | Get the timezone configuration  Returned: On success  Sample: `"UTC"` |
