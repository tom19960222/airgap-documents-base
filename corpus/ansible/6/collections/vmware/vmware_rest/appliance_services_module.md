...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_services module – Restarts a service"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_services_module.html
fetched_at: 2026-07-28T00:21:49+00:00
---
# vmware.vmware_rest.appliance_services module – Restarts a service
...
> see [Requirements](appliance_services_module.md#ansible-collections-vmware-vmware-rest-appliance-services-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_services`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_services_module.md#synopsis)
- [Requirements](appliance_services_module.md#requirements)
- [Parameters](appliance_services_module.md#parameters)
- [Notes](appliance_services_module.md#notes)
- [Examples](appliance_services_module.md#examples)
- [Return Values](appliance_services_module.md#return-values)

## [Synopsis](appliance_services_module.md#id1)

- Restarts a service

## [Requirements](appliance_services_module.md#id2)
...
## [Parameters](appliance_services_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **service**  string / required | identifier of the service to restart This parameter is mandatory. |
...
| **state**  string / required | Choices:   - `"restart"` - `"start"` - `"stop"` |
...
## [Notes](appliance_services_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_services_module.md#id5)
...
## [Return Values](appliance_services_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Restart the ntpd service  Returned: On success  Sample: `{}` |
