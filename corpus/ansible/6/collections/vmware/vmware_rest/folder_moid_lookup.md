...
collection: ansible
version: "6"
title: "vmware.vmware_rest.folder_moid lookup – Look up MoID for vSphere folder objects using vCenter REST API"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/folder_moid_lookup.html
...
> see [Requirements](folder_moid_lookup.md#ansible-collections-vmware-vmware-rest-folder-moid-lookup-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.folder_moid`.

New in vmware.vmware_rest 2.1.0

- [Synopsis](folder_moid_lookup.md#synopsis)
- [Requirements](folder_moid_lookup.md#requirements)
- [Terms](folder_moid_lookup.md#terms)
- [Keyword parameters](folder_moid_lookup.md#keyword-parameters)
- [Notes](folder_moid_lookup.md#notes)
- [Examples](folder_moid_lookup.md#examples)
- [Return Value](folder_moid_lookup.md#return-value)

## [Synopsis](folder_moid_lookup.md#id1)

- Returns Managed Object Reference (MoID) of the vSphere folder object contained in the specified path.

## [Requirements](folder_moid_lookup.md#id2)
...
## [Terms](folder_moid_lookup.md#id3)

| Parameter | Comments |
| --- | --- |
| **Terms**  string / required | Path to query. |

## [Keyword parameters](folder_moid_lookup.md#id4)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('vmware.vmware_rest.folder_moid', key1=value1, key2=value2, ...)` and `query('vmware.vmware_rest.folder_moid', key1=value1, key2=value2, ...)`
...
## [Notes](folder_moid_lookup.md#id5)
...
## [Examples](folder_moid_lookup.md#id6)
...
## [Return Value](folder_moid_lookup.md#id7)

| Key | Description |
| --- | --- |
| **Return value**  string | MoID of the vSphere folder object  Returned: success  Sample: `"group-v1029"` |
