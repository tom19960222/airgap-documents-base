...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_system_time_timezone module – Set time zone."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_system_time_timezone_module.html
fetched_at: 2026-07-28T00:21:55+00:00
---
# vmware.vmware_rest.appliance_system_time_timezone module – Set time zone.
...
> see [Requirements](appliance_system_time_timezone_module.md#ansible-collections-vmware-vmware-rest-appliance-system-time-timezone-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_system_time_timezone`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_system_time_timezone_module.md#synopsis)
- [Requirements](appliance_system_time_timezone_module.md#requirements)
- [Parameters](appliance_system_time_timezone_module.md#parameters)
- [Notes](appliance_system_time_timezone_module.md#notes)
- [Examples](appliance_system_time_timezone_module.md#examples)
- [Return Values](appliance_system_time_timezone_module.md#return-values)

## [Synopsis](appliance_system_time_timezone_module.md#id1)

- Set time zone.

## [Requirements](appliance_system_time_timezone_module.md#id2)
...
## [Parameters](appliance_system_time_timezone_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **name**  string / required | Time zone name. This parameter is mandatory. |
...
## [Notes](appliance_system_time_timezone_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_system_time_timezone_module.md#id5)
...
## [Return Values](appliance_system_time_timezone_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  string | Use the UTC timezone  Returned: On success  Sample: `"UTC"` |
