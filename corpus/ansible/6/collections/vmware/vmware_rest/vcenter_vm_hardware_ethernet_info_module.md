...
collection: ansible
version: "6"
title: "vmware.vmware_rest.vcenter_vm_hardware_ethernet_info module – Returns information about a virtual Ethernet adapter."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_vm_hardware_ethernet_info_module.html
fetched_at: 2026-07-28T00:22:32+00:00
---
...
> see [Requirements](vcenter_vm_hardware_ethernet_info_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-hardware-ethernet-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_hardware_ethernet_info`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_hardware_ethernet_info_module.md#synopsis)
- [Requirements](vcenter_vm_hardware_ethernet_info_module.md#requirements)
- [Parameters](vcenter_vm_hardware_ethernet_info_module.md#parameters)
- [Notes](vcenter_vm_hardware_ethernet_info_module.md#notes)
- [Examples](vcenter_vm_hardware_ethernet_info_module.md#examples)
- [Return Values](vcenter_vm_hardware_ethernet_info_module.md#return-values)

## [Synopsis](vcenter_vm_hardware_ethernet_info_module.md#id1)

- Returns information about a virtual Ethernet adapter.

## [Requirements](vcenter_vm_hardware_ethernet_info_module.md#id2)
...
## [Parameters](vcenter_vm_hardware_ethernet_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **label**  string | The name of the item |
| **nic**  string | Virtual Ethernet adapter identifier. Required with *state=[‘get’]* |
...
## [Notes](vcenter_vm_hardware_ethernet_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_hardware_ethernet_info_module.md#id5)
...
## [Return Values](vcenter_vm_hardware_ethernet_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  list / elements=string | Collect a list of the NIC for a given VM  Returned: On success  Sample: `[]` |
