...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_shutdown_info module – Get details about the pending shutdown action."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_shutdown_info_module.html
fetched_at: 2026-07-28T00:21:51+00:00
---
# vmware.vmware_rest.appliance_shutdown_info module – Get details about the pending shutdown action.
...
> see [Requirements](appliance_shutdown_info_module.md#ansible-collections-vmware-vmware-rest-appliance-shutdown-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_shutdown_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_shutdown_info_module.md#synopsis)
- [Requirements](appliance_shutdown_info_module.md#requirements)
- [Parameters](appliance_shutdown_info_module.md#parameters)
- [Notes](appliance_shutdown_info_module.md#notes)
- [Examples](appliance_shutdown_info_module.md#examples)
- [Return Values](appliance_shutdown_info_module.md#return-values)

## [Synopsis](appliance_shutdown_info_module.md#id1)

- Get details about the pending shutdown action.

## [Requirements](appliance_shutdown_info_module.md#id2)
...
## [Parameters](appliance_shutdown_info_module.md#id3)
...
## [Notes](appliance_shutdown_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_shutdown_info_module.md#id5)
...
## [Return Values](appliance_shutdown_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Get the ongoing shutdown  Returned: On success  Sample: `{"action": "reboot", "reason": "this is an example", "shutdown_time": "2022-06-24T08:45:02.000Z"}` |
