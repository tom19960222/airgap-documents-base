...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_networking_dns_domains module – Set DNS search domains."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_networking_dns_domains_module.html
fetched_at: 2026-07-28T00:21:36+00:00
---
# vmware.vmware_rest.appliance_networking_dns_domains module – Set DNS search domains.
...
> see [Requirements](appliance_networking_dns_domains_module.md#ansible-collections-vmware-vmware-rest-appliance-networking-dns-domains-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_networking_dns_domains`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_networking_dns_domains_module.md#synopsis)
- [Requirements](appliance_networking_dns_domains_module.md#requirements)
- [Parameters](appliance_networking_dns_domains_module.md#parameters)
- [Notes](appliance_networking_dns_domains_module.md#notes)
- [Examples](appliance_networking_dns_domains_module.md#examples)
- [Return Values](appliance_networking_dns_domains_module.md#return-values)

## [Synopsis](appliance_networking_dns_domains_module.md#id1)

- Set DNS search domains.

## [Requirements](appliance_networking_dns_domains_module.md#id2)
...
## [Parameters](appliance_networking_dns_domains_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **domain**  string | Domain to add. Required with *state=[‘add’]* |
| **domains**  list / elements=string | List of domains. Required with *state=[‘set’]* |
...
| **state**  string | Choices:   - `"add"` - `"set"` ← (default) |
...
## [Notes](appliance_networking_dns_domains_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_networking_dns_domains_module.md#id5)
...
## [Return Values](appliance_networking_dns_domains_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Add another domain configuration  Returned: On success  Sample: `{}` |
