...
collection: ansible
version: "6"
title: "vmware.vmware_rest.vcenter_vm_hardware module – Updates the virtual hardware settings of a virtual machine."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_vm_hardware_module.html
...
> see [Requirements](vcenter_vm_hardware_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-hardware-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_hardware`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_hardware_module.md#synopsis)
- [Requirements](vcenter_vm_hardware_module.md#requirements)
- [Parameters](vcenter_vm_hardware_module.md#parameters)
- [Notes](vcenter_vm_hardware_module.md#notes)
- [Examples](vcenter_vm_hardware_module.md#examples)
- [Return Values](vcenter_vm_hardware_module.md#return-values)

## [Synopsis](vcenter_vm_hardware_module.md#id1)

- Updates the virtual hardware settings of a virtual machine.

## [Requirements](vcenter_vm_hardware_module.md#id2)
...
## [Parameters](vcenter_vm_hardware_module.md#id3)
...
| **version**  string | The `version` defines the valid virtual hardware versions for a virtual machine. See <https://kb.vmware.com/s/article/1003746> (Virtual machine hardware versions (1003746)).  Choices:   - `"VMX_03"` - `"VMX_04"` - `"VMX_06"` - `"VMX_07"` - `"VMX_08"` - `"VMX_09"` - `"VMX_10"` - `"VMX_11"` - `"VMX_12"` - `"VMX_13"` - `"VMX_14"` - `"VMX_15"` - `"VMX_16"` - `"VMX_17"` - `"VMX_18"` - `"VMX_19"` |
| **vm**  string / required | Virtual machine identifier. This parameter is mandatory. |

## [Notes](vcenter_vm_hardware_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_hardware_module.md#id5)
...
## [Return Values](vcenter_vm_hardware_module.md#id6)
...
| **value**  dictionary | Upgrade the VM hardware version  Returned: On success  Sample: `{}` |
