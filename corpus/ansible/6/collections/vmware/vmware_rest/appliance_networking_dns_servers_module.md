...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_networking_dns_servers module – Set the DNS server configuration"
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_networking_dns_servers_module.html
fetched_at: 2026-07-28T00:21:38+00:00
---
# vmware.vmware_rest.appliance_networking_dns_servers module – Set the DNS server configuration
...
> see [Requirements](appliance_networking_dns_servers_module.md#ansible-collections-vmware-vmware-rest-appliance-networking-dns-servers-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_networking_dns_servers`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_networking_dns_servers_module.md#synopsis)
- [Requirements](appliance_networking_dns_servers_module.md#requirements)
- [Parameters](appliance_networking_dns_servers_module.md#parameters)
- [Notes](appliance_networking_dns_servers_module.md#notes)
- [Examples](appliance_networking_dns_servers_module.md#examples)
- [Return Values](appliance_networking_dns_servers_module.md#return-values)

## [Synopsis](appliance_networking_dns_servers_module.md#id1)

- Set the DNS server configuration. If you set the mode argument to “DHCP”, a DHCP refresh is forced.

## [Requirements](appliance_networking_dns_servers_module.md#id2)
...
## [Parameters](appliance_networking_dns_servers_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **mode**  string | `dns_server_mode` Describes DNS Server source (DHCP,static) Required with *state=[‘set’]*  Choices:   - `"dhcp"` - `"is_static"` |
| **server**  string | DNS server. Required with *state=[‘add’]* |
| **servers**  list / elements=string | List of the currently used DNS servers. Required with *state=[‘set’, ‘test’]* |
...
| **state**  string | Choices:   - `"add"` - `"set"` ← (default) - `"test"` |
...
## [Notes](appliance_networking_dns_servers_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_networking_dns_servers_module.md#id5)
...
## [Return Values](appliance_networking_dns_servers_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Add another DNS server  Returned: On success  Sample: `{"mode": "is_static", "servers": ["1.1.1.1", "192.168.123.1", "8.8.4.4"]}` |
