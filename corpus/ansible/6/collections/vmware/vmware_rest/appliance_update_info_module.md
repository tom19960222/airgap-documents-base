...
collection: ansible
version: "6"
title: "vmware.vmware_rest.appliance_update_info module – Gets the current status of the appliance update."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/appliance_update_info_module.html
fetched_at: 2026-07-28T00:21:58+00:00
---
# vmware.vmware_rest.appliance_update_info module – Gets the current status of the appliance update.
...
> see [Requirements](appliance_update_info_module.md#ansible-collections-vmware-vmware-rest-appliance-update-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_update_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_update_info_module.md#synopsis)
- [Requirements](appliance_update_info_module.md#requirements)
- [Parameters](appliance_update_info_module.md#parameters)
- [Notes](appliance_update_info_module.md#notes)
- [Examples](appliance_update_info_module.md#examples)
- [Return Values](appliance_update_info_module.md#return-values)

## [Synopsis](appliance_update_info_module.md#id1)

- Gets the current status of the appliance update.

## [Requirements](appliance_update_info_module.md#id2)
...
## [Parameters](appliance_update_info_module.md#id3)
...
## [Notes](appliance_update_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_update_info_module.md#id5)
...
## [Return Values](appliance_update_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Check if the system is up to date  Returned: On success  Sample: `{"state": "UP_TO_DATE", "version": "7.0.3.00600"}` |
