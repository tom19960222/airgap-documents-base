...
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_cluster_info_module.html
...
| Key | Description |
| --- | --- |
| **id**  string | moid of the resource  Returned: On success  Sample: `"domain-c1140"` |
| **value**  dictionary | Retrieve details about the first cluster  Returned: On success  Sample: `{"name": "my_cluster", "resource_pool": "resgroup-1141"}` |
