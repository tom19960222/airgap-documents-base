...
collection: ansible
version: "6"
title: "vmware.vmware_rest.vcenter_vm_storage_policy_compliance module – Returns the storage policy Compliance { @ link Info} of a virtual machine after explicitly re-computing compliance check."
source_url: https://docs.ansible.com/projects/ansible/6/collections/vmware/vmware_rest/vcenter_vm_storage_policy_compliance_module.html
fetched_at: 2026-07-28T00:22:44+00:00
---
# vmware.vmware_rest.vcenter_vm_storage_policy_compliance module – Returns the storage policy Compliance [{@link](mailto:{%40link) Info} of a virtual machine after explicitly re-computing compliance check.
...
> see [Requirements](vcenter_vm_storage_policy_compliance_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-storage-policy-compliance-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_storage_policy_compliance`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_storage_policy_compliance_module.md#synopsis)
- [Requirements](vcenter_vm_storage_policy_compliance_module.md#requirements)
- [Parameters](vcenter_vm_storage_policy_compliance_module.md#parameters)
- [Notes](vcenter_vm_storage_policy_compliance_module.md#notes)
- [Examples](vcenter_vm_storage_policy_compliance_module.md#examples)

## [Synopsis](vcenter_vm_storage_policy_compliance_module.md#id1)

- Returns the storage policy Compliance [{@link](mailto:{%40link) Info} of a virtual machine after explicitly re-computing compliance check.

## [Requirements](vcenter_vm_storage_policy_compliance_module.md#id2)
...
## [Parameters](vcenter_vm_storage_policy_compliance_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **disks**  list / elements=string | Identifiers of the virtual machine’s virtual disks for which compliance should be checked. |
...
| **state**  string / required | Choices:   - `"check"` |
...
| **vm_home**  boolean / required | Invoke compliance check on the virtual machine home directory if set to true. This parameter is mandatory.  Choices:   - `false` - `true` |

## [Notes](vcenter_vm_storage_policy_compliance_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_storage_policy_compliance_module.md#id5)
