...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_servicebussaspolicy_module.html
...
| **rights**  string / required | Claim rights of the SAS policy.  Choices:   - `"manage"` - `"listen"` - `"send"` - `"listen_send"` |
