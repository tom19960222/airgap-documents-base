...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_loganalyticsworkspace_module.html
...
| **retention_in_days**  string | The workspace data retention in days.  -1 means Unlimited retention for *sku=unlimited*.  730 days is the maximum allowed for all other SKUs. |
