...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_containerinstance_module.html
...
| **ip_address**  string | The IP address type of the container group.  Default is `none` and creating an instance without public IP.  Choices:   - `"public"` - `"none"` ← (default) |
