...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_functionapp_module.html
...
| **storage_account**  aliases: storage, storage_account_name  string / required | Name of the storage account to use. |
