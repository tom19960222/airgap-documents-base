...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_openshiftmanagedcluster_module.html
...
| **pull_secret**  string | Pull secret for the cluster (immutable).  Default: `""` |
| **version**  string | The Openshift version (immutable). |
| **ingress_profiles**  list / elements=string | Ingress profiles configuration. only one profile is supported at the current API version. |
...
| **vm_size**  string | Size of agent VMs (immutable).  Choices:   - `"Standard_D2s_v3"` - `"Standard_D4s_v3"` - `"Standard_D8s_v3"` |
...
| **worker_profiles**  list / elements=string | Configuration for OpenShift worker Vms. |
...
| **vm_size**  string | The size of the worker Vms (immutable).  Choices:   - `"Standard_D2s_v3"` - `"Standard_D4s_v3"` - `"Standard_D8s_v3"` |
