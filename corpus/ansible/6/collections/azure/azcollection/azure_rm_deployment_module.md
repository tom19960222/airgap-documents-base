...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_deployment_module.html
...
| **wait_for_deployment_polling_period**  string | Time (in seconds) to wait between polls when waiting for deployment completion.  Default: `10` |
...
| **outputs**  complex | Dictionary of outputs received from the deployment.  Returned: always  Sample: `{"hostname": {"type": "String", "value": "myvirtualmachine.eastus2.cloudapp.azure.com"}}` |
