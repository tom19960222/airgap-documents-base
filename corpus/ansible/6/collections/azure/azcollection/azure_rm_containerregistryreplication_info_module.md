...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_containerregistryreplication_info_module.html
...
## [Synopsis](azure_rm_containerregistryreplication_info_module.md#id2)

- Get facts of Replication.

## [Requirements](azure_rm_containerregistryreplication_info_module.md#id3)
...
## [Parameters](azure_rm_containerregistryreplication_info_module.md#id4)
...
## [Notes](azure_rm_containerregistryreplication_info_module.md#id5)
...
## [See Also](azure_rm_containerregistryreplication_info_module.md#id6)
...
## [Examples](azure_rm_containerregistryreplication_info_module.md#id7)
...
- ```YAML+Jinja
  Unable to normalize azure_rm_containerregistryreplication_info: return due to: 1 validation error for PluginReturnSchema
