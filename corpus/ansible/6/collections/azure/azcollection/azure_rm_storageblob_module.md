...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_storageblob_module.html
...
| **dest**  aliases: destination  string | Destination file path. Use with state `present` to download a blob. |
