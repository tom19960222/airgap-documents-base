...
source_url: https://docs.ansible.com/projects/ansible/6/collections/azure/azcollection/azure_rm_keyvaultkey_module.html
...
| **key_size**  string | The key size in bits. For example 2048, 3072, or 4096 for RSA. |
