...
collection: ansible
version: "6"
title: "kubernetes.core.k8s_cluster_info module – Describe Kubernetes (K8s) cluster, APIs available and their respective versions"
source_url: https://docs.ansible.com/projects/ansible/6/collections/kubernetes/core/k8s_cluster_info_module.html
fetched_at: 2026-07-27T17:54:51+00:00
---
# kubernetes.core.k8s_cluster_info module – Describe Kubernetes (K8s) cluster, APIs available and their respective versions
...
> see [Requirements](k8s_cluster_info_module.md#ansible-collections-kubernetes-core-k8s-cluster-info-module-requirements) for details.
>
> To use it in a playbook, specify: `kubernetes.core.k8s_cluster_info`.

New in kubernetes.core 0.11.1

- [Synopsis](k8s_cluster_info_module.md#synopsis)
- [Requirements](k8s_cluster_info_module.md#requirements)
- [Parameters](k8s_cluster_info_module.md#parameters)
- [Notes](k8s_cluster_info_module.md#notes)
- [Examples](k8s_cluster_info_module.md#examples)
- [Return Values](k8s_cluster_info_module.md#return-values)

## [Synopsis](k8s_cluster_info_module.md#id1)
...
## [Requirements](k8s_cluster_info_module.md#id2)
...
## [Parameters](k8s_cluster_info_module.md#id3)
...
| **invalidate_cache**  boolean | Invalidate cache before retrieving information about cluster.  Choices:   - `false` - `true` ← (default) |
...
## [Notes](k8s_cluster_info_module.md#id4)

> **Note:**
>
> - To avoid SSL certificate validation errors when `validate_certs` is *True*, the full certificate chain for the API server must be provided via `ca_cert` or in the kubeconfig file.

## [Examples](k8s_cluster_info_module.md#id5)
...
## [Return Values](k8s_cluster_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **apis**  dictionary | dictionary of group + version of resource found from cluster  Returned: success |
| **categories**  list / elements=string | API categories  Returned: success |
| **name**  string | Resource short name  Returned: success |
| **namespaced**  boolean | If resource is namespaced  Returned: success |
| **preferred**  boolean | If resource version preferred  Returned: success |
| **short_names**  string | Resource short names  Returned: success |
| **singular_name**  string | Resource singular name  Returned: success |
| **connection**  dictionary | Connection information  Returned: success |
| **cert_file**  string | Path to client certificate.  Returned: success |
| **host**  string | Host URL  Returned: success |
| **password**  string | User password  Returned: success |
| **proxy**  string | Proxy details  Returned: success |
| **ssl_ca_cert**  string | Path to CA certificate  Returned: success |
| **username**  string | Username  Returned: success |
| **verify_ssl**  boolean | SSL verification status  Returned: success |
| **version**  dictionary | Information about server and client version  Returned: success |
| **client**  string | Client version  Returned: success |
| **server**  dictionary | Server version  Returned: success |
