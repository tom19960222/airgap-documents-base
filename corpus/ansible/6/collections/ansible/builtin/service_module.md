...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/service_module.html
...
> module name
> `service` even without specifying the `collections:` keyword.
...
| Parameter | Comments |
| --- | --- |
| **arguments**  aliases: args  string | Additional arguments provided on the command line.  While using remote hosts with systemd this setting will be ignored. |
