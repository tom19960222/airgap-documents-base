...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/varnames_lookup.html
...
> plugin name
> `varnames` even without specifying the `collections:` keyword.
