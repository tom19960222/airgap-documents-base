...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/host_pinned_strategy.html
...
> plugin name
> `host_pinned` even without specifying the `collections:` keyword.
