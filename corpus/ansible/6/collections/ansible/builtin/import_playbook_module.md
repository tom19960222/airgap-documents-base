...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/import_playbook_module.html
...
> module name
> `import_playbook` even without specifying the `collections:` keyword.
