...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/host_list_inventory.html
...
> plugin name
> `host_list` even without specifying the `collections:` keyword.
