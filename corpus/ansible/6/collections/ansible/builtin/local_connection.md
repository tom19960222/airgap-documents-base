...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/local_connection.html
...
> plugin name
> `local` even without specifying the `collections:` keyword.
