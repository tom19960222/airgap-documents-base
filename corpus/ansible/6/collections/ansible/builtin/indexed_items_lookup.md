...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/indexed_items_lookup.html
...
> plugin name
> `indexed_items` even without specifying the `collections:` keyword.
