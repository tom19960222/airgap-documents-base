...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/runas_become.html
...
> plugin name
> `runas` even without specifying the `collections:` keyword.
