...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/winrm_connection.html
...
> plugin name
> `winrm` even without specifying the `collections:` keyword.
