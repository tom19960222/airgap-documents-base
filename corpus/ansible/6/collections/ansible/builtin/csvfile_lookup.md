...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/csvfile_lookup.html
...
> plugin name
> `csvfile` even without specifying the `collections:` keyword.
