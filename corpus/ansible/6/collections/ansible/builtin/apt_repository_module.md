...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/apt_repository_module.html
...
> module name
> `apt_repository` even without specifying the `collections:` keyword.
...
| **validate_certs**  boolean | If `no`, SSL certificates for the target repo will not be validated. This should only be used on personally controlled sites using self-signed certificates.  Choices:   - `false` - `true` ← (default) |
...
## [Examples](apt_repository_module.md#id7)
