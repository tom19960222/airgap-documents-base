...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/template_module.html
...
> module name
> `template` even without specifying the `collections:` keyword.
...
| **follow**  boolean | Determine whether symbolic links should be followed.  When set to `yes` symbolic links will be followed, if they exist.  When set to `no` symbolic links will not be followed.  Previous to Ansible 2.4, this was hardcoded as `yes`.  Choices:   - `false` ← (default) - `true` |
