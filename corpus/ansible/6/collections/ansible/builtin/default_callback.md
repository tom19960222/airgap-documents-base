...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/default_callback.html
...
> plugin name
> `default` even without specifying the `collections:` keyword.
