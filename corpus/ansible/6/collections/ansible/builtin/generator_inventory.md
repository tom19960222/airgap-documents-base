...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/generator_inventory.html
...
> plugin name
> `generator` even without specifying the `collections:` keyword.
