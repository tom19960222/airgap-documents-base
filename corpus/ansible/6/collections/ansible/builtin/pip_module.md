...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/pip_module.html
...
> module name
> `pip` even without specifying the `collections:` keyword.
...
> - The interpreter used by Ansible (see [ansible_python_interpreter](../../../user_guide/intro_inventory.md#ansible-python-interpreter)) requires the setuptools package, regardless of the version of pip set with the *executable* option.
