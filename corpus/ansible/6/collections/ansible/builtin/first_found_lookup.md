...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/first_found_lookup.html
...
> plugin name
> `first_found` even without specifying the `collections:` keyword.
