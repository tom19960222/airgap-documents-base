...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/assert_module.html
...
> module name
> `assert` even without specifying the `collections:` keyword.
...
| **quiet**  boolean  added in Ansible 2.8 | Set this to `yes` to avoid verbose output.  Choices:   - `false` ← (default) - `true` |
