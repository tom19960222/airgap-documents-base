...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/host_group_vars_vars.html
...
> plugin name
> `host_group_vars` even without specifying the `collections:` keyword.
