...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/lineinfile_module.html
...
> module name
> `lineinfile` even without specifying the `collections:` keyword.
