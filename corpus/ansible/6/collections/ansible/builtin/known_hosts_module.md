...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/known_hosts_module.html
...
> module name
> `known_hosts` even without specifying the `collections:` keyword.
