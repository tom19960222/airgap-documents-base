...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/free_strategy.html
...
> plugin name
> `free` even without specifying the `collections:` keyword.
