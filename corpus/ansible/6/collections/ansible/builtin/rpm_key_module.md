...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/rpm_key_module.html
fetched_at: 2026-07-27T16:44:06+00:00
---
...
> module name
> `rpm_key` even without specifying the `collections:` keyword.
...
| **validate_certs**  boolean | If `no` and the `key` is a url starting with https, SSL certificates will not be validated.  This should only be used on personally controlled sites using self-signed certificates.  Choices:   - `false` - `true` ← (default) |
