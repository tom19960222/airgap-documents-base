...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/expect_module.html
...
> module name
> `expect` even without specifying the `collections:` keyword.
