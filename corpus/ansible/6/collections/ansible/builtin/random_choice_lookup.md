...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/random_choice_lookup.html
...
> plugin name
> `random_choice` even without specifying the `collections:` keyword.
