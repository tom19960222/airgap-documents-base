...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/minimal_callback.html
...
> plugin name
> `minimal` even without specifying the `collections:` keyword.
