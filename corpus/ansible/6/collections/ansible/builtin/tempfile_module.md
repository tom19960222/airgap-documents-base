...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/tempfile_module.html
...
> module name
> `tempfile` even without specifying the `collections:` keyword.
