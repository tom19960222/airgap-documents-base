...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/subelements_lookup.html
...
> plugin name
> `subelements` even without specifying the `collections:` keyword.
