...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/stat_module.html
...
| **charset**  string | file character set or encoding  Returned: success, path exists and user can read stats and installed python supports it and the *mime* option was true, will return `unknown` on error.  Sample: `"us-ascii"` |
...
| **mimetype**  string | file magic data or mime-type  Returned: success, path exists and user can read stats and installed python supports it and the *mime* option was true, will return `unknown` on error.  Sample: `"application/pdf; charset=binary"` |
