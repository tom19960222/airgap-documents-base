...
collection: ansible
version: "6"
title: "ansible.builtin.systemd module – Manage systemd units"
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/systemd_module.html
...
> module name
> `systemd` even without specifying the `collections:` keyword.
> However, we recommend you use the FQCN for easy linking to the
> module documentation and to avoid conflicting with other collections that may have
> the same module name.

- [Synopsis](systemd_module.md#synopsis)
- [Requirements](systemd_module.md#requirements)
- [Parameters](systemd_module.md#parameters)
- [Attributes](systemd_module.md#attributes)
- [Notes](systemd_module.md#notes)
- [Examples](systemd_module.md#examples)
- [Return Values](systemd_module.md#return-values)

## [Synopsis](systemd_module.md#id3)

- Controls systemd units (services, timers, and so on) on remote hosts.

## [Requirements](systemd_module.md#id4)

The below requirements are needed on the host that executes this module.

- A system managed by systemd.

## [Parameters](systemd_module.md#id5)
...
## [Attributes](systemd_module.md#id6)
...
## [Examples](systemd_module.md#id8)
...
## [Return Values](systemd_module.md#id9)
