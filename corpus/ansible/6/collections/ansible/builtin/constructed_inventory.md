...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/constructed_inventory.html
...
> plugin name
> `constructed` even without specifying the `collections:` keyword.
