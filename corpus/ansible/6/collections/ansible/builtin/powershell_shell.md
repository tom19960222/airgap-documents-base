...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/powershell_shell.html
...
> plugin name
> `powershell` even without specifying the `collections:` keyword.
