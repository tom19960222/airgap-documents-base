...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/debconf_module.html
...
> module name
> `debconf` even without specifying the `collections:` keyword.
