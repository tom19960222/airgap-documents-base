...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/package_module.html
...
> module name
> `package` even without specifying the `collections:` keyword.
