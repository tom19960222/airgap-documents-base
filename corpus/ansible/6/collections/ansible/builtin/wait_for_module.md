...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/wait_for_module.html
...
> module name
> `wait_for` even without specifying the `collections:` keyword.
