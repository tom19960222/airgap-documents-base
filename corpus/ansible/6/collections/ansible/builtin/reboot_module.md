...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/builtin/reboot_module.html
...
> module name
> `reboot` even without specifying the `collections:` keyword.
