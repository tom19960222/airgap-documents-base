...
collection: ansible
version: "6"
title: "ansible.posix.csh shell – C shell (/bin/csh)"
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/posix/csh_shell.html
...
> **Note:**
>
> This shell plugin is part of the [ansible.posix collection](https://galaxy.ansible.com/ansible/posix) (version 1.4.0).
>
...
- [Synopsis](csh_shell.md#synopsis)
- [Parameters](csh_shell.md#parameters)

## [Synopsis](csh_shell.md#id1)

- When you have no other option than to use csh

## [Parameters](csh_shell.md#id2)
