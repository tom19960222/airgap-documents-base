...
source_url: https://docs.ansible.com/projects/ansible/6/collections/ansible/posix/seboolean_module.html
...
| **persistent**  boolean | Set to `yes` if the boolean setting should survive a reboot.  Choices:   - `false` ← (default) - `true` |
