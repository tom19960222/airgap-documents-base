...
collection: ansible
version: "6"
title: "check_point.mgmt.cp_mgmt_group_facts module – Get group objects facts on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/6/collections/check_point/mgmt/cp_mgmt_group_facts_module.html
...
- [Synopsis](cp_mgmt_group_facts_module.md#synopsis)
- [Parameters](cp_mgmt_group_facts_module.md#parameters)
- [Examples](cp_mgmt_group_facts_module.md#examples)

## [Synopsis](cp_mgmt_group_facts_module.md#id1)
...
## [Parameters](cp_mgmt_group_facts_module.md#id2)
...
| **show_as_ranges**  boolean | When true, the group’s matched content is displayed as ranges of IP addresses rather than network objects.<br />Objects that are not represented using IP addresses are presented as objects.<br />The ‘members’ parameter is omitted from the response and instead the ‘ranges’ parameter is displayed.  Choices:   - `false` - `true` |
...
## [Examples](cp_mgmt_group_facts_module.md#id3)
