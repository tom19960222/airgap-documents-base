...
collection: ansible
version: "6"
title: "check_point.mgmt.cp_mgmt_trusted_client_facts module – Get trusted-client objects facts on Checkpoint over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/6/collections/check_point/mgmt/cp_mgmt_trusted_client_facts_module.html
fetched_at: 2026-07-27T16:48:52+00:00
---
# check_point.mgmt.cp_mgmt_trusted_client_facts module – Get trusted-client objects facts on Checkpoint over Web Services API
...
- [Synopsis](cp_mgmt_trusted_client_facts_module.md#synopsis)
- [Parameters](cp_mgmt_trusted_client_facts_module.md#parameters)
- [Examples](cp_mgmt_trusted_client_facts_module.md#examples)

## [Synopsis](cp_mgmt_trusted_client_facts_module.md#id1)
...
## [Parameters](cp_mgmt_trusted_client_facts_module.md#id2)
...
## [Examples](cp_mgmt_trusted_client_facts_module.md#id3)
