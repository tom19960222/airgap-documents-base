...
collection: ansible
version: "6"
title: "check_point.mgmt.cp_mgmt_set_session module – Edit user’s current session."
source_url: https://docs.ansible.com/projects/ansible/6/collections/check_point/mgmt/cp_mgmt_set_session_module.html
fetched_at: 2026-07-27T16:48:34+00:00
---
# check_point.mgmt.cp_mgmt_set_session module – Edit user’s current session.
...
- [Synopsis](cp_mgmt_set_session_module.md#synopsis)
- [Parameters](cp_mgmt_set_session_module.md#parameters)
- [Examples](cp_mgmt_set_session_module.md#examples)
- [Return Values](cp_mgmt_set_session_module.md#return-values)

## [Synopsis](cp_mgmt_set_session_module.md#id1)

- Edit user’s current session.
- All operations are performed over Web Services API.

## [Parameters](cp_mgmt_set_session_module.md#id2)
...
## [Examples](cp_mgmt_set_session_module.md#id3)
...
## [Return Values](cp_mgmt_set_session_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_set_session**  dictionary | The checkpoint set-session output.  Returned: always. |
