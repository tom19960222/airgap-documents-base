...
collection: ansible
version: "6"
title: "junipernetworks.junos.junos_lldp_interface module – (deprecated, removed after 2022-06-01) Manage LLDP interfaces configuration on Juniper JUNOS network devices"
source_url: https://docs.ansible.com/projects/ansible/6/collections/junipernetworks/junos/junos_lldp_interface_module.html
fetched_at: 2026-07-27T17:54:25+00:00
---
...
> see [Requirements](junos_lldp_interface_module.md#ansible-collections-junipernetworks-junos-junos-lldp-interface-module-requirements) for details.
>
> To use it in a playbook, specify: `junipernetworks.junos.junos_lldp_interface`.

New in junipernetworks.junos 1.0.0

- [DEPRECATED](junos_lldp_interface_module.md#deprecated)
- [Synopsis](junos_lldp_interface_module.md#synopsis)
- [Requirements](junos_lldp_interface_module.md#requirements)
- [Parameters](junos_lldp_interface_module.md#parameters)
- [Notes](junos_lldp_interface_module.md#notes)
- [Examples](junos_lldp_interface_module.md#examples)
- [Return Values](junos_lldp_interface_module.md#return-values)
- [Status](junos_lldp_interface_module.md#status)

## [DEPRECATED](junos_lldp_interface_module.md#id1)
...
Alternative:
:   Use [junipernetworks.junos.junos_lldp_interfaces](junos_lldp_interfaces_module.md#ansible-collections-junipernetworks-junos-junos-lldp-interfaces-module) instead.

## [Synopsis](junos_lldp_interface_module.md#id2)
...
## [Requirements](junos_lldp_interface_module.md#id3)

The below requirements are needed on the host that executes this module.

- ncclient (>=v0.5.2)

## [Parameters](junos_lldp_interface_module.md#id4)
...
## [Examples](junos_lldp_interface_module.md#id6)
...
## [Return Values](junos_lldp_interface_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **diff.prepared**  string | Configuration difference before and after applying change.  Returned: when configuration is changed and diff option is enabled.  Sample: `"[edit protocols lldp] +    interface ge-0/0/5;\n"` |

## [Status](junos_lldp_interface_module.md#id8)

- This module will be removed in a major release after 2022-06-01.
  *[deprecated]*
- For more information see [DEPRECATED](junos_lldp_interface_module.md#deprecated).
