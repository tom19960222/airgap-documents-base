...
source_url: https://docs.ansible.com/projects/ansible/6/collections/junipernetworks/junos/junos_config_module.html
fetched_at: 2026-07-27T17:54:14+00:00
---
...
> - Abbreviated commands are NOT idempotent, see **ERROR while parsing**: While parsing L() at index 46: Cannot find closing “)” after last parameter
...
| **filename**  string | The name of the backup file  Returned: when backup is yes and filename is not specified in backup options  Sample: `"junos01_config.2016-07-16@22:28:34"` |
| **shortname**  string | The full path to the backup file excluding the timestamp  Returned: when backup is yes and filename is not specified in backup options  Sample: `"/playbooks/ansible/backup/junos01_config"` |
