...
source_url: https://docs.ansible.com/projects/ansible/6/collections/junipernetworks/junos/junos_prefix_lists_module.html
fetched_at: 2026-07-27T17:54:33+00:00
---
...
- [Return Values](junos_prefix_lists_module.md#return-values)
...
## [Return Values](junos_prefix_lists_module.md#id6)
...
| **commands**  list / elements=string | The set of commands pushed to the remote device.  Returned: always  Sample: `["<nc:policy-options xmlns:nc=\"urn:ietf:params:xml:ns:netconf:base:1.0\"> \"<nc:prefix-list delete=\"delete\"/></nc:policy-options>\"", "xml 2", "command 3"]` |
