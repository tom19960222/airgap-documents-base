...
source_url: https://docs.ansible.com/projects/ansible/6/scenario_guides/guide_packet.html
...
The following code block is a simple playbook that creates one [Type 0](https://www.packet.com/cloud/servers/t1-small/) server (the ‘plan’ parameter). You have to supply ‘plan’ and ‘operating_system’. ‘location’ defaults to ‘ewr1’ (Parsippany, NJ). You can find all the possible values for the parameters via a [CLI client](https://www.packet.net/developers/integrations/).
