...
source_url: https://docs.ansible.com/projects/ansible/6/scenario_guides/guide_scaleway.html
fetched_at: 2026-07-27T16:41:02+00:00
---
# Scaleway Guide

## Introduction

[Scaleway](https://scaleway.com) is a cloud provider supported by Ansible, version 2.6 or higher via a dynamic inventory plugin and modules.
Those modules are:
...
> If you’re not, have a look at [ansible_documentation](https://docs.ansible.com/ansible/6/index.html#ansible-documentation "(in Ansible v6)") before getting started.
...
You can generate an API token via the Scaleway console [here](https://cloud.scaleway.com/#/credentials).
