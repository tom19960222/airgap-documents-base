...
version: "6"
title: "Vultr Guide"
source_url: https://docs.ansible.com/projects/ansible/6/scenario_guides/guide_vultr.html
...
If you don’t yet own one, log in to [Vultr](https://www.vultr.com) go to Account, then API, enable API then the API key should show up.
...
Ansible provides a dynamic inventory plugin for [Vultr](https://www.vultr.com).
