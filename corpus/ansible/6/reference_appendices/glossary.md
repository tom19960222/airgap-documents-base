...
version: "6"
title: "Glossary"
source_url: https://docs.ansible.com/projects/ansible/6/reference_appendices/glossary.html
...
:   By default, Ansible talks to remote machines through pluggable
    ...
    started section](https://docs.ansible.com/ansible/5/user_guide/intro_getting_started.html#remote-connection-information "(in Ansible v5)"). There are also
...
:   A conditional is an expression that evaluates to true or false that
    ...
    discussed in the [Working with playbooks](../user_guide/playbooks.md#working-with-playbooks).
...
:   A file (by default, Ansible uses a simple INI format) that describes
    ...
    can also be provided via an [Inventory Script](glossary.md#term-Inventory-Script) (sometimes called
...
:   By passing `--limit somegroup` to **ansible** or
    **ansible-playbook**, the commands can be limited to a subset
    of [hosts](glossary.md#term-Host). For instance, this can be used to run
