...
source_url: https://docs.ansible.com/projects/ansible/6/reference_appendices/playbooks_keywords.html
...
>
> become_flags
> :   A string of flag(s) to pass to the privilege escalation program when [become](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-52 "(in Ansible v4)") is True.
>
> become_method
...
>
> check_mode
> :   A boolean that controls if a task is executed in ‘check’ mode. See [Validating tasks: check mode and diff mode](../user_guide/playbooks_checkmode.md#check-mode-dry).
>
> collections
> :   List of collection namespaces to search for modules, plugins, and roles. See [Using collections in a Playbook](../user_guide/collections_using.md#collections-using-playbook)
>
>     > **Note:**
>     >
...
>
> debugger
> :   Enable debugging tasks based on state of the task result. See [Debugging tasks](../user_guide/playbooks_debugger.md#playbook-debugger).
>
> diff
...
>
> fact_path
> :   Set the fact path option for the fact gathering plugin controlled by [gather_facts](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-gather_facts "(in Ansible v4)").
>
> force_handlers
...
>
> gather_subset
> :   Allows you to pass subset options to the fact gathering plugin controlled by [gather_facts](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-gather_facts "(in Ansible v4)").
>
> gather_timeout
> :   Allows you to set the timeout for the fact gathering plugin controlled by [gather_facts](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-gather_facts "(in Ansible v4)").
>
> handlers
...
>
> serial
> :   Explicitly define how Ansible batches the execution of the current play on the play’s target. See [Setting the batch size with serial](../user_guide/playbooks_strategies.md#rolling-update-batch-size).
>
> strategy
...
>
> tasks
> :   Main list of tasks to execute in the play, they run after [roles](glossary.md#term-Roles) and before [post_tasks](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-post_tasks "(in Ansible v4)").
>
> throttle
...
>
> rescue
> :   List of tasks in a [block](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-block "(in Ansible v4)") that run if there is a task error in the main [block](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-block "(in Ansible v4)") list.
>
> run_once
> :   Boolean that will bypass the host loop, forcing the task to attempt to execute on the first host available and afterwards apply any results and facts to all active hosts in the same batch.
>
...
>
> delay
> :   Number of seconds to delay between retries. This setting is only used in combination with [until](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-until "(in Ansible v4)").
>
> delegate_facts
> :   Boolean that allows you to apply facts to a delegated host instead of inventory_hostname.
>
...
>
> loop_control
> :   Several keys here allow you to modify/set loop behaviour in a task. See [Adding controls to loops](../user_guide/playbooks_loops.md#loop-control).
>
> module_defaults
> :   Specifies default parameter values for modules.
>
...
>
> retries
> :   Number of retries before giving up in a [until](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-until "(in Ansible v4)") loop. This setting is only used in combination with [until](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-until "(in Ansible v4)").
>
> run_once
> :   Boolean that will bypass the host loop, forcing the task to attempt to execute on the first host available and afterwards apply any results and facts to all active hosts in the same batch.
>
...
>
> until
> :   This keyword implies a ‘[retries](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-retries "(in Ansible v4)") loop’ that will go on until the condition supplied here is met or we hit the [retries](https://docs.ansible.com/ansible/4/reference_appendices/playbooks_keywords.html#term-retries "(in Ansible v4)") limit.
>
> vars
> :   Dictionary/map of variables
>
