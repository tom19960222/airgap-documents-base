...
source_url: https://docs.ansible.com/projects/ansible/6/reference_appendices/special_variables.html
...
These are variables that contain information pertinent to the current host (inventory_hostname). They are only available if gathered first. See [Discovering variables: facts and magic variables](../user_guide/playbooks_vars_facts.md#vars-and-facts) for more information.
...
:   Contains any ‘local facts’ gathered or cached for the inventory_hostname.
    ...
    See the [setup](../collections/ansible/builtin/setup_module.md#setup-module) module and [facts.d or local facts](../user_guide/playbooks_vars_facts.md#local-facts) for more details.
...
See [Controlling how Ansible behaves: precedence rules](general_precedence.md#general-precedence-rules) for how connection variables interact with [configuration settings](config.md#ansible-configuration-settings), [command-line options](../user_guide/command_line_tools.md#command-line-tools), and [playbook keywords](playbooks_keywords.md#playbook-keywords).
