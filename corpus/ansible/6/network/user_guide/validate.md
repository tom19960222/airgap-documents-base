...
source_url: https://docs.ansible.com/projects/ansible/6/network/user_guide/validate.html
...
The [ansible.utils](https://galaxy.ansible.com/ansible/utils) collection includes the [validate](../../collections/ansible/utils/validate_module.md#ansible-collections-ansible-utils-validate-module) module.
