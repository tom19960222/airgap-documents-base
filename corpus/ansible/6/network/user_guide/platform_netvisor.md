...
source_url: https://docs.ansible.com/projects/ansible/6/network/user_guide/platform_netvisor.html
fetched_at: 2026-07-27T16:41:12+00:00
---
# Pluribus NETVISOR Platform Options

Pluribus NETVISOR Ansible is part of the [community.network](https://galaxy.ansible.com/community/network) collection and only supports CLI connections today. `httpapi` modules may be added in future.
