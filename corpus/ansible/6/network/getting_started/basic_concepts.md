...
source_url: https://docs.ansible.com/projects/ansible/6/network/getting_started/basic_concepts.html
...
To learn more about inventory, see [the Working with Inventory](../../user_guide/intro_inventory.md#intro-inventory) section. Sometimes an inventory source file is also referred to as a ‘hostfile’.
...
Playbooks are written in YAML and are easy to read, write, share and understand. To learn more about playbooks, see [Intro to playbooks](../../user_guide/playbooks_intro.md#about-playbooks).
