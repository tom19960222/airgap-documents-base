...
source_url: https://docs.ansible.com/projects/ansible/6/network/getting_started/first_inventory.html
...
For more details on building inventory files, see [the introduction to inventory](../../user_guide/intro_inventory.md#intro-inventory); for more details on ansible-vault, see [the full Ansible Vault documentation](../../user_guide/vault.md#vault).
