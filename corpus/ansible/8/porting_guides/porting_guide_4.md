...
collection: ansible
version: "8"
title: "Ansible 4 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_4.html
fetched_at: 2026-07-28T00:58:19+00:00
---
# Ansible 4 Porting Guide

- [Playbook](porting_guide_4.md#playbook)
- [Command Line](porting_guide_4.md#command-line)
- [Deprecated](porting_guide_4.md#deprecated)
- [Breaking Changes](porting_guide_4.md#breaking-changes)

  - [Changes to `AnsibleModule`](porting_guide_4.md#changes-to-ansiblemodule)
  - [Changes to](porting_guide_4.md#changes-to-ansible-module-utils-common-parameters) [`ansible.module_utils.common.parameters`](../reference_appendices/module_utils.md#module-ansible.module_utils.common.parameters "ansible.module_utils.common.parameters")
- [Other](porting_guide_4.md#other)
- [Modules](porting_guide_4.md#modules)

  - [Modules removed](porting_guide_4.md#modules-removed)
  - [Deprecation notices](porting_guide_4.md#deprecation-notices)
  - [Noteworthy module changes](porting_guide_4.md#noteworthy-module-changes)
- [Plugins](porting_guide_4.md#plugins)
- [Porting custom scripts](porting_guide_4.md#porting-custom-scripts)
- [Porting Guide for v4.10.0](porting_guide_4.md#porting-guide-for-v4-10-0)

  - [Major Changes](porting_guide_4.md#major-changes)
  - [Deprecated Features](porting_guide_4.md#deprecated-features)
- [Porting Guide for v4.9.0](porting_guide_4.md#porting-guide-for-v4-9-0)

  - [Known Issues](porting_guide_4.md#known-issues)
  - [Major Changes](porting_guide_4.md#id1)
- [Porting Guide for v4.8.0](porting_guide_4.md#porting-guide-for-v4-8-0)

  - [Breaking Changes](porting_guide_4.md#id2)
  - [Deprecated Features](porting_guide_4.md#id3)
- [Porting Guide for v4.7.0](porting_guide_4.md#porting-guide-for-v4-7-0)

  - [Major Changes](porting_guide_4.md#id4)
  - [Deprecated Features](porting_guide_4.md#id5)
- [Porting Guide for v4.6.0](porting_guide_4.md#porting-guide-for-v4-6-0)

  - [Major Changes](porting_guide_4.md#id8)
  - [Deprecated Features](porting_guide_4.md#id10)
- [Porting Guide for v4.5.0](porting_guide_4.md#porting-guide-for-v4-5-0)

  - [Major Changes](porting_guide_4.md#id11)
  - [Deprecated Features](porting_guide_4.md#id12)
- [Porting Guide for v4.4.0](porting_guide_4.md#porting-guide-for-v4-4-0)

  - [Known Issues](porting_guide_4.md#id15)
  - [Deprecated Features](porting_guide_4.md#id16)
- [Porting Guide for v4.3.0](porting_guide_4.md#porting-guide-for-v4-3-0)

  - [Major Changes](porting_guide_4.md#id19)
  - [Deprecated Features](porting_guide_4.md#id20)
- [Porting Guide for v4.2.0](porting_guide_4.md#porting-guide-for-v4-2-0)

  - [Known Issues](porting_guide_4.md#id22)
  - [Major Changes](porting_guide_4.md#id24)
  - [Deprecated Features](porting_guide_4.md#id28)
- [Porting Guide for v4.1.0](porting_guide_4.md#porting-guide-for-v4-1-0)

  - [Known Issues](porting_guide_4.md#id30)
  - [Major Changes](porting_guide_4.md#id32)
  - [Removed Features](porting_guide_4.md#removed-features)
  - [Deprecated Features](porting_guide_4.md#id36)
- [Porting Guide for v4.0.0](porting_guide_4.md#porting-guide-for-v4-0-0)

  - [Known Issues](porting_guide_4.md#id40)
  - [Breaking Changes](porting_guide_4.md#id43)
  - [Major Changes](porting_guide_4.md#id49)
  - [Removed Features](porting_guide_4.md#id66)
  - [Deprecated Features](porting_guide_4.md#id71)

We suggest you read this page along with the [Ansible 4 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/4/CHANGELOG-v4.rst) to understand what updates you may need to make.

## [Playbook](porting_guide_4.md#id79)
...
## [Command Line](porting_guide_4.md#id80)
...
## [Deprecated](porting_guide_4.md#id81)

The constant `ansible.module_utils.basic._CHECK_ARGUMENT_TYPES_DISPATCHER` is deprecated. Use [`ansible.module_utils.common.parameters.DEFAULT_TYPE_VALIDATORS`](../reference_appendices/module_utils.md#ansible.module_utils.common.parameters.DEFAULT_TYPE_VALIDATORS "ansible.module_utils.common.parameters.DEFAULT_TYPE_VALIDATORS") instead.

## [Breaking Changes](porting_guide_4.md#id82)

### [Changes to `AnsibleModule`](porting_guide_4.md#id83)

With the move to [`ArgumentSpecValidator`](../reference_appendices/module_utils.md#ansible.module_utils.common.arg_spec.ArgumentSpecValidator "ansible.module_utils.common.arg_spec.ArgumentSpecValidator") for performing argument spec validation, the following private methods in [`AnsibleModule`](https://docs.ansible.com/ansible/2.9/reference_appendices/module_utils.html#ansible.module_utils.basic.AnsibleModule "(in Ansible v2.9)") have been removed:

> - `_check_argument_types()`
> - `_check_argument_values()`
> - `_check_arguments()`
> - `_check_mutually_exclusive()` –> [`ansible.module_utils.common.validation.check_mutually_exclusive()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_mutually_exclusive "ansible.module_utils.common.validation.check_mutually_exclusive")
> - `_check_required_arguments()` –> [`ansible.module_utils.common.validation.check_required_arguments()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_required_arguments "ansible.module_utils.common.validation.check_required_arguments")
> - `_check_required_by()` –> [`ansible.module_utils.common.validation.check_required_by()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_required_by "ansible.module_utils.common.validation.check_required_by")
> - `_check_required_if()` –> [`ansible.module_utils.common.validation.check_required_if()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_required_if "ansible.module_utils.common.validation.check_required_if")
> - `_check_required_one_of()` –> [`ansible.module_utils.common.validation.check_required_one_of()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_required_one_of "ansible.module_utils.common.validation.check_required_one_of")
> - `_check_required_together()` –> [`ansible.module_utils.common.validation.check_required_together()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_required_together "ansible.module_utils.common.validation.check_required_together")
> - `_check_type_bits()` –> [`ansible.module_utils.common.validation.check_type_bits()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_bits "ansible.module_utils.common.validation.check_type_bits")
> - `_check_type_bool()` –> [`ansible.module_utils.common.validation.check_type_bool()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_bool "ansible.module_utils.common.validation.check_type_bool")
> - `_check_type_bytes()` –> [`ansible.module_utils.common.validation.check_type_bytes()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_bytes "ansible.module_utils.common.validation.check_type_bytes")
> - `_check_type_dict()` –> [`ansible.module_utils.common.validation.check_type_dict()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_dict "ansible.module_utils.common.validation.check_type_dict")
> - `_check_type_float()` –> [`ansible.module_utils.common.validation.check_type_float()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_float "ansible.module_utils.common.validation.check_type_float")
> - `_check_type_int()` –> [`ansible.module_utils.common.validation.check_type_int()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_int "ansible.module_utils.common.validation.check_type_int")
> - `_check_type_jsonarg()` –> [`ansible.module_utils.common.validation.check_type_jsonarg()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_jsonarg "ansible.module_utils.common.validation.check_type_jsonarg")
> - `_check_type_list()` –> [`ansible.module_utils.common.validation.check_type_list()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_list "ansible.module_utils.common.validation.check_type_list")
> - `_check_type_path()` –> [`ansible.module_utils.common.validation.check_type_path()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_path "ansible.module_utils.common.validation.check_type_path")
> - `_check_type_raw()` –> [`ansible.module_utils.common.validation.check_type_raw()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_raw "ansible.module_utils.common.validation.check_type_raw")
> - `_check_type_str()` –> [`ansible.module_utils.common.validation.check_type_str()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.check_type_str "ansible.module_utils.common.validation.check_type_str")
> - `_count_terms()` –> [`ansible.module_utils.common.validation.count_terms()`](../reference_appendices/module_utils.md#ansible.module_utils.common.validation.count_terms "ansible.module_utils.common.validation.count_terms")
> - `_get_wanted_type()`
> - `_handle_aliases()`
...
Modules or plugins using these private methods should use the public functions in [`ansible.module_utils.common.validation`](../reference_appendices/module_utils.md#module-ansible.module_utils.common.validation "ansible.module_utils.common.validation") or [`ArgumentSpecValidator.validate()`](../reference_appendices/module_utils.md#ansible.module_utils.common.arg_spec.ArgumentSpecValidator.validate "ansible.module_utils.common.arg_spec.ArgumentSpecValidator.validate") if no public function was listed above.

### [Changes to](porting_guide_4.md#id84) [`ansible.module_utils.common.parameters`](../reference_appendices/module_utils.md#module-ansible.module_utils.common.parameters "ansible.module_utils.common.parameters")

The following functions in [`ansible.module_utils.common.parameters`](../reference_appendices/module_utils.md#module-ansible.module_utils.common.parameters "ansible.module_utils.common.parameters") are now private and should not be used directly. Use [`ArgumentSpecValidator.validate()`](../reference_appendices/module_utils.md#ansible.module_utils.common.arg_spec.ArgumentSpecValidator.validate "ansible.module_utils.common.arg_spec.ArgumentSpecValidator.validate") instead.

> - `list_no_log_values`
> - `list_deprecations`
> - `handle_aliases`

## [Other](porting_guide_4.md#id85)
...
## [Modules](porting_guide_4.md#id86)
...
### [Modules removed](porting_guide_4.md#id87)

The following modules no longer exist:

- No notable changes

### [Deprecation notices](porting_guide_4.md#id88)

No notable changes

### [Noteworthy module changes](porting_guide_4.md#id89)
...
- The parameter `filter` type is changed from `string` to `list` in the [setup](../collections/ansible/builtin/setup_module.md#setup-module) module in order to use more than one filter. Previous behavior (using a `string`) still remains and works as a single filter.

## [Plugins](porting_guide_4.md#id90)
...
## [Porting custom scripts](porting_guide_4.md#id91)

No notable changes

## [Porting Guide for v4.10.0](porting_guide_4.md#id92)

### [Major Changes](porting_guide_4.md#id93)
...
### [Deprecated Features](porting_guide_4.md#id94)
...
## [Porting Guide for v4.9.0](porting_guide_4.md#id95)

### [Known Issues](porting_guide_4.md#id96)

#### purestorage.flashblade

- purefb_lag - The mac_address field in the response is not populated. This will be fixed in a future FlashBlade update.

### [Major Changes](porting_guide_4.md#id97)
...
## [Porting Guide for v4.8.0](porting_guide_4.md#id98)

### [Breaking Changes](porting_guide_4.md#id99)

#### community.zabbix

- all roles now reference other roles and modules through their fully qualified collection names, which makes Ansible 2.10 minimum supported version for roles (see [issue 477](https://github.com/ansible-collections/community.zabbix/pull/477)).

### [Deprecated Features](porting_guide_4.md#id100)
...
## [Porting Guide for v4.7.0](porting_guide_4.md#id101)

### [Major Changes](porting_guide_4.md#id102)
...
### [Deprecated Features](porting_guide_4.md#id103)
...
## [Porting Guide for v4.6.0](porting_guide_4.md#id104)

### [Major Changes](porting_guide_4.md#id105)
...
### [Deprecated Features](porting_guide_4.md#id106)

#### community.grafana

- grafana_dashboard lookup - Providing a mangled version of the API key is no longer preferred.

## [Porting Guide for v4.5.0](porting_guide_4.md#id107)

### [Major Changes](porting_guide_4.md#id108)
...
### [Deprecated Features](porting_guide_4.md#id109)
...
## [Porting Guide for v4.4.0](porting_guide_4.md#id110)

### [Known Issues](porting_guide_4.md#id111)
...
### [Deprecated Features](porting_guide_4.md#id112)
...
## [Porting Guide for v4.3.0](porting_guide_4.md#id113)

### [Major Changes](porting_guide_4.md#id114)

#### netapp.cloudmanager

- Adding stage environment to all modules in cloudmanager

### [Deprecated Features](porting_guide_4.md#id115)
...
## [Porting Guide for v4.2.0](porting_guide_4.md#id116)

### [Known Issues](porting_guide_4.md#id117)
...
### [Major Changes](porting_guide_4.md#id118)
...
### [Deprecated Features](porting_guide_4.md#id119)
...
## [Porting Guide for v4.1.0](porting_guide_4.md#id120)

### [Known Issues](porting_guide_4.md#id121)
...
### [Major Changes](porting_guide_4.md#id122)
...
## [Porting Guide for v4.0.0](porting_guide_4.md#id125)

### [Known Issues](porting_guide_4.md#id126)

#### Ansible-core

- ansible-test - The `pylint` sanity test no longer correctly detects “bad” variable names for non-constants. See [issue 3701](https://github.com/PyCQA/pylint/issues/3701) for additional details.
...
### [Breaking Changes](porting_guide_4.md#id127)
...
- ansible-galaxy login command has been removed (see [issue 71560](https://github.com/ansible/ansible/issues/71560))
...
### [Major Changes](porting_guide_4.md#id128)
...
### [Removed Features](porting_guide_4.md#id129)
...
- The `ome_device_info`, `idrac_firmware` and `idrac_server_config_profile` modules have now been migrated from community.general to the [dellemc.openmanage](https://galaxy.ansible.com/dellemc/openmanage) Ansible collection.
...
### [Deprecated Features](porting_guide_4.md#id130)
