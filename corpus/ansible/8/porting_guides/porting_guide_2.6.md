...
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_2.6.html
...
- The [file_module](https://docs.ansible.com/ansible/7/collections/ansible/builtin/file_module.html#file-module "(in Ansible v7)") now emits a deprecation warning when `src` is specified with a state
