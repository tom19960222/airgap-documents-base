...
collection: ansible
version: "8"
title: "Ansible 2.0 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_2.0.html
fetched_at: 2026-07-28T00:58:26+00:00
---
# [Ansible 2.0 Porting Guide](porting_guide_2.0.md#id7)

This section discusses the behavioral changes between Ansible 1.x and Ansible 2.0.

It is intended to assist in updating your playbooks, plugins and other parts of your Ansible infrastructure so they will work with this version of Ansible.

We suggest you read this page along with [Ansible Changelog for 2.0](https://github.com/ansible/ansible/blob/stable-2.0/CHANGELOG.md) to understand what updates you may need to make.
...
- [Ansible 2.0 Porting Guide](porting_guide_2.0.md#ansible-2-0-porting-guide)

  - [Playbook](porting_guide_2.0.md#playbook)

    - [Deprecated](porting_guide_2.0.md#deprecated)
    - [Other caveats](porting_guide_2.0.md#other-caveats)
  - [Porting plugins](porting_guide_2.0.md#porting-plugins)

    - [Lookup plugins](porting_guide_2.0.md#lookup-plugins)
    - [Connection plugins](porting_guide_2.0.md#connection-plugins)
    - [Action plugins](porting_guide_2.0.md#action-plugins)
    - [Callback plugins](porting_guide_2.0.md#callback-plugins)
    - [Connection plugins](porting_guide_2.0.md#id1)
  - [Hybrid plugins](porting_guide_2.0.md#hybrid-plugins)

    - [Lookup plugins](porting_guide_2.0.md#id2)
    - [Connection plugins](porting_guide_2.0.md#id3)
    - [Action plugins](porting_guide_2.0.md#id4)
    - [Callback plugins](porting_guide_2.0.md#id5)
    - [Connection plugins](porting_guide_2.0.md#id6)
  - [Porting custom scripts](porting_guide_2.0.md#porting-custom-scripts)

## [Playbook](porting_guide_2.0.md#id8)
...
- variables defined in the yaml dict format see [issue 13324](https://github.com/ansible/ansible/issues/13324)
...
- Empty variables and variables set to null in yaml are no longer converted to empty strings. They will retain the value of None.
  You can override the null_representation setting to an empty string in your config file by setting the [`ANSIBLE_NULL_REPRESENTATION`](../reference_appendices/config.md#envvar-ANSIBLE_NULL_REPRESENTATION) environment variable.
...
### [Deprecated](porting_guide_2.0.md#id9)
...
### [Other caveats](porting_guide_2.0.md#id10)
...
## [Porting plugins](porting_guide_2.0.md#id11)
...
### [Lookup plugins](porting_guide_2.0.md#id12)

- lookup plugins ; import version

### [Connection plugins](porting_guide_2.0.md#id13)

- connection plugins

### [Action plugins](porting_guide_2.0.md#id14)

- action plugins

### [Callback plugins](porting_guide_2.0.md#id15)
...
[`self.playbook`](../api/index.md#self.playbook "self.playbook"), [`self.play`](../api/index.md#self.play "self.play"), or [`self.task`](../api/index.md#self.task "self.task") then you will
...
### [Connection plugins](porting_guide_2.0.md#id16)

- connection plugins

## [Hybrid plugins](porting_guide_2.0.md#id17)
...
### [Lookup plugins](porting_guide_2.0.md#id18)
...
### [Connection plugins](porting_guide_2.0.md#id19)

- connection plugins

### [Action plugins](porting_guide_2.0.md#id20)

- action plugins

### [Callback plugins](porting_guide_2.0.md#id21)

- callback plugins

### [Connection plugins](porting_guide_2.0.md#id22)

- connection plugins

## [Porting custom scripts](porting_guide_2.0.md#id23)

Custom scripts that used the `ansible.runner.Runner` API in 1.x have to be ported in 2.x. Please refer to: [Python API](../dev_guide/developing_api.md#developing-api)
