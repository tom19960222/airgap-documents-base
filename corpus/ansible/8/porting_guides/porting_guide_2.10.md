...
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_2.10.html
fetched_at: 2026-07-28T00:58:20+00:00
---
...
The [Ansible-base 2.10 Porting Guide](porting_guide_base_2.10.md#porting-2-10-guide-base) is included in this porting guide. The complete list of porting guides can be found at [porting guides](porting_guides.md#porting-guides).
...
- Windows Server 2008 and 2008 R2 will no longer be supported or tested in the next Ansible release, see [Are Server 2008, 2008 R2 and Windows 7 supported?](../os_guide/windows_faq.md#windows-faq-server2008).
