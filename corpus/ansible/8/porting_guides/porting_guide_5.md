...
collection: ansible
version: "8"
title: "Ansible 5 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_5.html
fetched_at: 2026-07-28T00:58:18+00:00
---
# Ansible 5 Porting Guide

- [Playbook](porting_guide_5.md#playbook)
- [Python Interpreter Discovery](porting_guide_5.md#python-interpreter-discovery)
- [Command Line](porting_guide_5.md#command-line)
- [Deprecated](porting_guide_5.md#deprecated)
- [Modules](porting_guide_5.md#modules)

  - [Modules removed](porting_guide_5.md#modules-removed)
  - [Deprecation notices](porting_guide_5.md#deprecation-notices)
  - [Noteworthy module changes](porting_guide_5.md#noteworthy-module-changes)
- [Plugins](porting_guide_5.md#plugins)
- [Porting custom scripts](porting_guide_5.md#porting-custom-scripts)
- [Networking](porting_guide_5.md#networking)
- [Porting Guide for v5.9.0](porting_guide_5.md#porting-guide-for-v5-9-0)

  - [Added Collections](porting_guide_5.md#added-collections)
  - [Major Changes](porting_guide_5.md#major-changes)
  - [Deprecated Features](porting_guide_5.md#deprecated-features)
- [Porting Guide for v5.8.0](porting_guide_5.md#porting-guide-for-v5-8-0)

  - [Added Collections](porting_guide_5.md#id1)
  - [Breaking Changes](porting_guide_5.md#breaking-changes)
  - [Major Changes](porting_guide_5.md#id2)
  - [Deprecated Features](porting_guide_5.md#id3)
- [Porting Guide for v5.7.0](porting_guide_5.md#porting-guide-for-v5-7-0)

  - [Major Changes](porting_guide_5.md#id5)
  - [Deprecated Features](porting_guide_5.md#id8)
- [Porting Guide for v5.6.0](porting_guide_5.md#porting-guide-for-v5-6-0)

  - [Added Collections](porting_guide_5.md#id9)
  - [Deprecated Features](porting_guide_5.md#id10)
- [Porting Guide for v5.5.0](porting_guide_5.md#porting-guide-for-v5-5-0)

  - [Known Issues](porting_guide_5.md#known-issues)
  - [Deprecated Features](porting_guide_5.md#id12)
- [Porting Guide for v5.4.0](porting_guide_5.md#porting-guide-for-v5-4-0)

  - [Major Changes](porting_guide_5.md#id14)
  - [Deprecated Features](porting_guide_5.md#id15)
- [Porting Guide for v5.3.0](porting_guide_5.md#porting-guide-for-v5-3-0)

  - [Major Changes](porting_guide_5.md#id17)
  - [Deprecated Features](porting_guide_5.md#id18)
- [Porting Guide for v5.2.0](porting_guide_5.md#porting-guide-for-v5-2-0)

  - [Known Issues](porting_guide_5.md#id20)
  - [Major Changes](porting_guide_5.md#id21)
  - [Deprecated Features](porting_guide_5.md#id22)
- [Porting Guide for v5.1.0](porting_guide_5.md#porting-guide-for-v5-1-0)

  - [Known Issues](porting_guide_5.md#id24)
  - [Major Changes](porting_guide_5.md#id26)
  - [Removed Features](porting_guide_5.md#removed-features)
  - [Deprecated Features](porting_guide_5.md#id28)
- [Porting Guide for v5.0.1](porting_guide_5.md#porting-guide-for-v5-0-1)

  - [Major Changes](porting_guide_5.md#id31)
- [Porting Guide for v5.0.0](porting_guide_5.md#porting-guide-for-v5-0-0)

  - [Added Collections](porting_guide_5.md#id32)
  - [Known Issues](porting_guide_5.md#id33)
  - [Breaking Changes](porting_guide_5.md#id35)
  - [Major Changes](porting_guide_5.md#id41)
  - [Removed Features](porting_guide_5.md#id53)
  - [Deprecated Features](porting_guide_5.md#id60)

Ansible 5 is based on Ansible-core 2.12.

We suggest you read this page along with the [Ansible 5 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/5/CHANGELOG-v5.rst) to understand what updates you may need to make.

## [Playbook](porting_guide_5.md#id77)
...
## [Python Interpreter Discovery](porting_guide_5.md#id78)
...
## [Command Line](porting_guide_5.md#id79)
...
## [Deprecated](porting_guide_5.md#id80)
...
## [Modules](porting_guide_5.md#id81)
...
### [Modules removed](porting_guide_5.md#id82)

The following modules no longer exist:

- No notable changes

### [Deprecation notices](porting_guide_5.md#id83)

No notable changes

### [Noteworthy module changes](porting_guide_5.md#id84)

No notable changes

## [Plugins](porting_guide_5.md#id85)
...
## [Porting custom scripts](porting_guide_5.md#id86)

No notable changes

## [Networking](porting_guide_5.md#id87)

No notable changes

## [Porting Guide for v5.9.0](porting_guide_5.md#id88)

### [Added Collections](porting_guide_5.md#id89)

- cisco.dnac (version 6.4.0)
- community.sap_libs (version 1.1.0)

### [Major Changes](porting_guide_5.md#id90)

#### fortinet.fortios

- Support FortiOS 7.0.2, 7.0.3, 7.0.4, 7.0.5.

### [Deprecated Features](porting_guide_5.md#id91)
...
## [Porting Guide for v5.8.0](porting_guide_5.md#id92)

### [Added Collections](porting_guide_5.md#id93)

- vmware.vmware_rest (version 2.1.5)

### [Breaking Changes](porting_guide_5.md#id94)
...
### [Major Changes](porting_guide_5.md#id95)
...
### [Deprecated Features](porting_guide_5.md#id96)
...
## [Porting Guide for v5.7.0](porting_guide_5.md#id97)

### [Major Changes](porting_guide_5.md#id98)
...
### [Deprecated Features](porting_guide_5.md#id99)
...
## [Porting Guide for v5.6.0](porting_guide_5.md#id100)

### [Added Collections](porting_guide_5.md#id101)

- community.sap (version 1.0.0)

### [Deprecated Features](porting_guide_5.md#id102)

#### cisco.ios

- Deprecates lldp module.

## [Porting Guide for v5.5.0](porting_guide_5.md#id103)

### [Known Issues](porting_guide_5.md#id104)
...
### [Deprecated Features](porting_guide_5.md#id105)
...
## [Porting Guide for v5.4.0](porting_guide_5.md#id106)

### [Major Changes](porting_guide_5.md#id107)
...
### [Deprecated Features](porting_guide_5.md#id108)

#### cisco.ios

- ios_acls - Deprecated fragment attribute added boolean alternate as enable_fragment.

## [Porting Guide for v5.3.0](porting_guide_5.md#id109)

### [Major Changes](porting_guide_5.md#id110)
...
### [Deprecated Features](porting_guide_5.md#id111)
...
## [Porting Guide for v5.2.0](porting_guide_5.md#id112)

### [Known Issues](porting_guide_5.md#id113)
...
### [Major Changes](porting_guide_5.md#id114)

#### cisco.meraki

- meraki_mr_radio - New module

### [Deprecated Features](porting_guide_5.md#id115)

#### purestorage.flasharray

- purefa_sso - Deprecated in favor of M(purefa_admin). Will be removed in Collection 2.0

## [Porting Guide for v5.1.0](porting_guide_5.md#id116)

### [Known Issues](porting_guide_5.md#id117)
...
### [Major Changes](porting_guide_5.md#id118)
...
### [Removed Features](porting_guide_5.md#id119)
...
### [Deprecated Features](porting_guide_5.md#id120)
...
## [Porting Guide for v5.0.1](porting_guide_5.md#id121)

### [Major Changes](porting_guide_5.md#id122)

- Raised python requirement of the ansible package from >=2.7 to >=3.8 to match ansible-core

## [Porting Guide for v5.0.0](porting_guide_5.md#id123)

### [Added Collections](porting_guide_5.md#id124)
...
### [Known Issues](porting_guide_5.md#id125)

#### Ansible-core

- ansible-test - Tab completion anywhere other than the end of the command with the new composite options will provide incorrect results. See [issue 351](https://github.com/kislyuk/argcomplete/issues/351) for additional details.
...
### [Breaking Changes](porting_guide_5.md#id126)
...
- Adjust `dirName` text parsing and to text converting code to conform to [Sections 2 and 3 of RFC 4514](https://datatracker.ietf.org/doc/html/rfc4514.html). This is similar to how [cryptography handles this](https://cryptography.io/en/latest/x509/reference/#cryptography.x509.Name.rfc4514_string) (<https://github.com/ansible-collections/community.crypto/pull/274>).
...
- lxd inventory plugin - when used with Python 2, the plugin now needs `ipaddress` installed [from pypi](https://pypi.org/project/ipaddress/) (<https://github.com/ansible-collections/community.general/pull/2441>).
- scaleway_security_group_rule - when used with Python 2, the module now needs `ipaddress` installed [from pypi](https://pypi.org/project/ipaddress/) (<https://github.com/ansible-collections/community.general/pull/2441>).
...
### [Major Changes](porting_guide_5.md#id127)
...
### [Removed Features](porting_guide_5.md#id128)
...
- All inventory and vault scripts contained in community.general were moved to the [contrib-scripts GitHub repository](https://github.com/ansible-community/contrib-scripts) (<https://github.com/ansible-collections/community.general/pull/2696>).
...
- The nios, nios_next_ip, nios_next_network lookup plugins, the nios documentation fragment, and the nios_host_record, nios_ptr_record, nios_mx_record, nios_fixed_address, nios_zone, nios_member, nios_a_record, nios_aaaa_record, nios_network, nios_dns_view, nios_txt_record, nios_naptr_record, nios_srv_record, nios_cname_record, nios_nsgroup, and nios_network_view module have been removed from community.general 4.0.0 and were replaced by redirects to the [infoblox.nios_modules](https://galaxy.ansible.com/infoblox/nios_modules) collection. Please install the `infoblox.nios_modules` collection to continue using these plugins and modules, and update your FQCNs (<https://github.com/ansible-collections/community.general/pull/3592>).
- The vendored copy of `ipaddress` has been removed. Please use `ipaddress` from the Python 3 standard library, or [from pypi](https://pypi.org/project/ipaddress/). (<https://github.com/ansible-collections/community.general/pull/2441>).
...
### [Deprecated Features](porting_guide_5.md#id129)
