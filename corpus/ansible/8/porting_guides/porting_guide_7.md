...
collection: ansible
version: "8"
title: "Ansible 7 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_7.html
fetched_at: 2026-07-28T00:58:16+00:00
---
# Ansible 7 Porting Guide

- [Playbook](porting_guide_7.md#playbook)
- [Command Line](porting_guide_7.md#command-line)
- [Deprecated](porting_guide_7.md#deprecated)
- [Modules](porting_guide_7.md#modules)

  - [Modules removed](porting_guide_7.md#modules-removed)
  - [Deprecation notices](porting_guide_7.md#deprecation-notices)
  - [Noteworthy module changes](porting_guide_7.md#noteworthy-module-changes)
- [Plugins](porting_guide_7.md#plugins)
- [Porting custom scripts](porting_guide_7.md#porting-custom-scripts)
- [Networking](porting_guide_7.md#networking)
- [Porting Guide for v7.7.0](porting_guide_7.md#porting-guide-for-v7-7-0)

  - [Major Changes](porting_guide_7.md#major-changes)
  - [Removed Features](porting_guide_7.md#removed-features)
  - [Deprecated Features](porting_guide_7.md#deprecated-features)
- [Porting Guide for v7.6.0](porting_guide_7.md#porting-guide-for-v7-6-0)

  - [Known Issues](porting_guide_7.md#known-issues)
  - [Major Changes](porting_guide_7.md#id2)
  - [Deprecated Features](porting_guide_7.md#id10)
- [Porting Guide for v7.5.0](porting_guide_7.md#porting-guide-for-v7-5-0)

  - [Added Collections](porting_guide_7.md#added-collections)
  - [Deprecated Features](porting_guide_7.md#id11)
- [Porting Guide for v7.4.0](porting_guide_7.md#porting-guide-for-v7-4-0)

  - [Breaking Changes](porting_guide_7.md#breaking-changes)
  - [Major Changes](porting_guide_7.md#id12)
  - [Deprecated Features](porting_guide_7.md#id15)
- [Porting Guide for v7.3.0](porting_guide_7.md#porting-guide-for-v7-3-0)

  - [Breaking Changes](porting_guide_7.md#id17)
  - [Major Changes](porting_guide_7.md#id18)
  - [Deprecated Features](porting_guide_7.md#id19)
- [Porting Guide for v7.2.0](porting_guide_7.md#porting-guide-for-v7-2-0)

  - [Added Collections](porting_guide_7.md#id20)
  - [Known Issues](porting_guide_7.md#id21)
  - [Breaking Changes](porting_guide_7.md#id23)
  - [Major Changes](porting_guide_7.md#id25)
  - [Deprecated Features](porting_guide_7.md#id27)
- [Porting Guide for v7.1.0](porting_guide_7.md#porting-guide-for-v7-1-0)

  - [Added Collections](porting_guide_7.md#id32)
  - [Known Issues](porting_guide_7.md#id33)
  - [Major Changes](porting_guide_7.md#id34)
  - [Deprecated Features](porting_guide_7.md#id37)
- [Porting Guide for v7.0.0](porting_guide_7.md#porting-guide-for-v7-0-0)

  - [Added Collections](porting_guide_7.md#id39)
  - [Known Issues](porting_guide_7.md#id40)
  - [Breaking Changes](porting_guide_7.md#id42)
  - [Major Changes](porting_guide_7.md#id50)
  - [Removed Collections](porting_guide_7.md#removed-collections)
  - [Removed Features](porting_guide_7.md#id69)
  - [Deprecated Features](porting_guide_7.md#id82)

Ansible 7 is based on Ansible-core 2.14.

We suggest you read this page along with the [Ansible 7 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/7/CHANGELOG-v7.rst) to understand what updates you may need to make.

## [Playbook](porting_guide_7.md#id91)
...
## [Command Line](porting_guide_7.md#id92)
...
## [Deprecated](porting_guide_7.md#id93)

No notable changes

## [Modules](porting_guide_7.md#id94)

No notable changes

### [Modules removed](porting_guide_7.md#id95)

The following modules no longer exist:

- No notable changes

### [Deprecation notices](porting_guide_7.md#id96)

No notable changes

### [Noteworthy module changes](porting_guide_7.md#id97)

No notable changes

## [Plugins](porting_guide_7.md#id98)

No notable changes

## [Porting custom scripts](porting_guide_7.md#id99)

No notable changes

## [Networking](porting_guide_7.md#id100)

No notable changes

## [Porting Guide for v7.7.0](porting_guide_7.md#id101)

### [Major Changes](porting_guide_7.md#id102)
...
### [Removed Features](porting_guide_7.md#id103)
...
### [Deprecated Features](porting_guide_7.md#id104)

- The gluster.gluster collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/225>).
- The netapp.aws collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/223>).
...
## [Porting Guide for v7.6.0](porting_guide_7.md#id105)

### [Known Issues](porting_guide_7.md#id106)
...
### [Major Changes](porting_guide_7.md#id107)
...
- Added Grid Master Candidate feature [#152](https://github.com/infobloxopen/infoblox-ansible/pull/152)
- Added Member Assignment to network and ranges [#152](https://github.com/infobloxopen/infoblox-ansible/pull/152)
- Added NIOS Range module with Create, Update and Delete features [#152](https://github.com/infobloxopen/infoblox-ansible/pull/152)
- Fixes issue unable to update/delete EAs using Ansible plugin [#180](https://github.com/infobloxopen/infoblox-ansible/pull/180)
- Fixes static and dynamic allocation of IPV4 address of A Record [#182](https://github.com/infobloxopen/infoblox-ansible/pull/182)
- Fixes to Update host name of NIOS member [#176](https://github.com/infobloxopen/infoblox-ansible/pull/176)
- Updates default WAPI version to 2.9 [#176](https://github.com/infobloxopen/infoblox-ansible/pull/176)

### [Deprecated Features](porting_guide_7.md#id108)
...
## [Porting Guide for v7.5.0](porting_guide_7.md#id109)

### [Added Collections](porting_guide_7.md#id110)

- microsoft.ad (version 1.0.0)

### [Deprecated Features](porting_guide_7.md#id111)
...
## [Porting Guide for v7.4.0](porting_guide_7.md#id112)

### [Breaking Changes](porting_guide_7.md#id113)
...
### [Major Changes](porting_guide_7.md#id114)
...
### [Deprecated Features](porting_guide_7.md#id115)
...
## [Porting Guide for v7.3.0](porting_guide_7.md#id116)

### [Breaking Changes](porting_guide_7.md#id117)

#### hetzner.hcloud

- inventory plugin - Python v3.5+ is now required.

### [Major Changes](porting_guide_7.md#id118)

#### kubernetes.core

- refactor K8sAnsibleMixin into module_utils/k8s/ (<https://github.com/ansible-collections/kubernetes.core/pull/481>).

### [Deprecated Features](porting_guide_7.md#id119)

- Since the google.cloud collection seems to be maintained again, we [cancelled the removal process](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection). So contrary to an earlier announcement, this collection is NOT deprecated and will NOT be removed from Ansible 8 (<https://github.com/ansible-community/community-topics/issues/105>).
...
## [Porting Guide for v7.2.0](porting_guide_7.md#id120)

### [Added Collections](porting_guide_7.md#id121)

- dellemc.powerflex (version 1.5.0)
- dellemc.unity (version 1.5.0)

### [Known Issues](porting_guide_7.md#id122)
...
### [Breaking Changes](porting_guide_7.md#id123)

#### community.general

- ModuleHelper module utils - when the module sets output variables named `msg`, `exception`, `output`, `vars`, or `changed`, the actual output will prefix those names with `_` (underscore symbol) only when they clash with output variables generated by ModuleHelper itself, which only occurs when handling exceptions. Please note that this breaking change does not require a new major release since before this release, it was not possible to add such variables to the output [due to a bug](https://github.com/ansible-collections/community.general/pull/5755) (<https://github.com/ansible-collections/community.general/pull/5765>).

### [Major Changes](porting_guide_7.md#id124)
...
### [Deprecated Features](porting_guide_7.md#id125)

- The cisco.nso collection is considered unmaintained and will be removed from Ansible 9 if no one starts maintaining it again before Ansible 9. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/155>).
- The community.fortios collection is considered unmaintained and will be removed from Ansible 9 if no one starts maintaining it again before Ansible 9. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/162>).
- The community.google collection is considered unmaintained and will be removed from Ansible 9 if no one starts maintaining it again before Ansible 9. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/160>).
- The community.skydive collection is considered unmaintained and will be removed from Ansible 9 if no one starts maintaining it again before Ansible 9. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/171>).
...
- The default of the newly added option `txt_character_encoding` will change from `octal` to `decimal` in community.dns 3.0.0. The new default will be compatible with [RFC 1035](https://www.ietf.org/rfc/rfc1035.txt) (<https://github.com/ansible-collections/community.dns/pull/134>).
...
## [Porting Guide for v7.1.0](porting_guide_7.md#id126)

### [Added Collections](porting_guide_7.md#id127)

- grafana.grafana (version 1.1.0)

### [Known Issues](porting_guide_7.md#id128)
...
### [Major Changes](porting_guide_7.md#id129)
...
### [Deprecated Features](porting_guide_7.md#id130)
...
## [Porting Guide for v7.0.0](porting_guide_7.md#id131)

### [Added Collections](porting_guide_7.md#id132)
...
### [Known Issues](porting_guide_7.md#id133)
...
### [Breaking Changes](porting_guide_7.md#id134)
...
### [Major Changes](porting_guide_7.md#id135)
...
- Fix to remove issue causing due to template attr in deleting network using Ansible module nios network [#147](https://github.com/infobloxopen/infoblox-ansible/pull/147)
- Update text field of TXT Record [#128](https://github.com/infobloxopen/infoblox-ansible/pull/128)
- Update operation using old_name and new_name for the object with dummy name in old_name (which does not exist in system) will not create a new object in the system. An error will be thrown stating the object does not exist in the system [#129](https://github.com/infobloxopen/infoblox-ansible/pull/129)
...
### [Removed Collections](porting_guide_7.md#id136)

- servicenow.servicenow (previously included version: 1.0.6)

### [Removed Features](porting_guide_7.md#id137)
...
### [Deprecated Features](porting_guide_7.md#id138)

- The dellemc.os10 collection is considered unmaintained and will be removed from Ansible 8 if no one starts maintaining it again before Ansible 8. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/134>).
- The dellemc.os6 collection is considered unmaintained and will be removed from Ansible 8 if no one starts maintaining it again before Ansible 8. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/132>).
- The dellemc.os9 collection is considered unmaintained and will be removed from Ansible 8 if no one starts maintaining it again before Ansible 8. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/133>).
- The google.cloud collection is considered unmaintained and will be removed from Ansible 8 if no one starts maintaining it again before Ansible 8. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/105>).
- The mellanox.onyx collection is considered unmaintained and will be removed from Ansible 8 if no one starts maintaining it again before Ansible 8. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/136>).
