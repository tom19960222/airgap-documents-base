...
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_2.7.html
fetched_at: 2026-07-28T00:58:23+00:00
---
...
- [Ansible 2.7 Porting Guide](porting_guide_2.7.md#ansible-2-7-porting-guide)
  ...
  - [Deprecated](porting_guide_2.7.md#deprecated)
    ...
    - [Using a loop on a package module through squash_actions](porting_guide_2.7.md#using-a-loop-on-a-package-module-through-squash-actions)
...
Ansible 2.7 makes a small change to variable precedence when loading roles, resolving a bug, ensuring that role loading matches [variable precedence expectations](../playbook_guide/playbooks_variables.md#ansible-variable-precedence).
...
### [Using a loop on a package module through squash_actions](porting_guide_2.7.md#id11)
