...
collection: ansible
version: "8"
title: "Ansible 3 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_3.html
fetched_at: 2026-07-28T00:58:20+00:00
---
# Ansible 3 Porting Guide

- [Porting Guide for v3.4.0](porting_guide_3.md#porting-guide-for-v3-4-0)

  - [Known Issues](porting_guide_3.md#known-issues)
  - [Major Changes](porting_guide_3.md#major-changes)
  - [Deprecated Features](porting_guide_3.md#deprecated-features)
- [Porting Guide for v3.3.0](porting_guide_3.md#porting-guide-for-v3-3-0)

  - [Major Changes](porting_guide_3.md#id1)
  - [Deprecated Features](porting_guide_3.md#id2)
- [Porting Guide for v3.2.0](porting_guide_3.md#porting-guide-for-v3-2-0)

  - [Known Issues](porting_guide_3.md#id3)
  - [Breaking Changes](porting_guide_3.md#breaking-changes)
  - [Deprecated Features](porting_guide_3.md#id6)
- [Porting Guide for v3.1.0](porting_guide_3.md#porting-guide-for-v3-1-0)

  - [Known Issues](porting_guide_3.md#id7)
  - [Major Changes](porting_guide_3.md#id9)
  - [Removed Features](porting_guide_3.md#removed-features)
  - [Deprecated Features](porting_guide_3.md#id12)
- [Porting Guide for v3.0.0](porting_guide_3.md#porting-guide-for-v3-0-0)

  - [Known Issues](porting_guide_3.md#id15)
  - [Breaking Changes](porting_guide_3.md#id17)
  - [Major Changes](porting_guide_3.md#id21)
  - [Removed Features](porting_guide_3.md#id27)
  - [Deprecated Features](porting_guide_3.md#id37)
...
We suggest you read this page along with the [Ansible 3 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/3/CHANGELOG-v3.rst) to understand what updates you may need to make.

## [Porting Guide for v3.4.0](porting_guide_3.md#id45)

### [Known Issues](porting_guide_3.md#id46)
...
### [Major Changes](porting_guide_3.md#id47)
...
### [Deprecated Features](porting_guide_3.md#id48)
...
## [Porting Guide for v3.3.0](porting_guide_3.md#id49)

### [Major Changes](porting_guide_3.md#id50)
...
### [Deprecated Features](porting_guide_3.md#id51)
...
## [Porting Guide for v3.2.0](porting_guide_3.md#id52)

### [Known Issues](porting_guide_3.md#id53)
...
### [Breaking Changes](porting_guide_3.md#id54)
...
### [Deprecated Features](porting_guide_3.md#id55)
...
## [Porting Guide for v3.1.0](porting_guide_3.md#id56)

### [Known Issues](porting_guide_3.md#id57)
...
### [Major Changes](porting_guide_3.md#id58)
...
### [Removed Features](porting_guide_3.md#id59)
...
### [Deprecated Features](porting_guide_3.md#id60)
...
## [Porting Guide for v3.0.0](porting_guide_3.md#id61)

### [Known Issues](porting_guide_3.md#id62)
...
### [Breaking Changes](porting_guide_3.md#id63)
...
### [Major Changes](porting_guide_3.md#id64)
...
- For community.general 3.0.0, the `ome_device_info`, `idrac_firmware` and `idrac_server_config_profile` modules will be moved to the [dellemc.openmanage](https://galaxy.ansible.com/dellemc/openmanage) collection.
...
### [Removed Features](porting_guide_3.md#id65)
...
- All Google cloud modules and plugins have now been migrated away from this collection.
  They can be found in either the [community.google](https://galaxy.ansible.com/community/google) or [google.cloud](https://galaxy.ansible.com/google/cloud) collections.
...
- All Kubevirt modules and plugins have now been migrated from community.general to the [community.kubevirt](https://galaxy.ansible.com/community/kubevirt) Ansible collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All `docker` modules and plugins have been removed from this collection.
  They have been migrated to the [community.docker](https://galaxy.ansible.com/community/docker) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All `hetzner` modules have been removed from this collection.
  They have been migrated to the [community.hrobot](https://galaxy.ansible.com/community/hrobot) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All `postgresql` modules have been removed from this collection.
  They have been migrated to the [community.postgresql](https://galaxy.ansible.com/community/postgresql) collection.
...
- The `hashi_vault` lookup plugin has been removed from this collection.
  It has been migrated to the [community.hashi_vault](https://galaxy.ansible.com/community/hashi_vault) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- The `oc` connection plugin has been removed from this collection.
  It has been migrated to the [community.okd](https://galaxy.ansible.com/community/okd) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All FortiOS modules and plugins have been removed from this collection.
  They have been migrated to the [community.fortios](https://galaxy.ansible.com/community/fortios) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All `nso` modules have been removed from this collection.
  They have been migrated to the [cisco.nso](https://galaxy.ansible.com/cisco/nso) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- All `routeros` modules and plugins have been removed from this collection.
  They have been migrated to the [community.routeros](https://galaxy.ansible.com/community/routeros) collection.
  If you use ansible-base 2.10 or newer, redirections have been provided.
...
- The `cp_publish` module has been removed from this collection. It was a duplicate of `check_point.mgmt.cp_mgmt_publish` in the [check_point.mgmt](https://galaxy.ansible.com/check_point/mgmt) collection. If you use ansible-base 2.10 or newer, redirections have been provided.
...
- The `fortimanager` httpapi plugin has been removed from this collection.
  It was a duplicate of the one in the [fortinet.fortimanager](https://galaxy.ansible.com/fortinet/fortimanager) collection.
...
### [Deprecated Features](porting_guide_3.md#id66)
