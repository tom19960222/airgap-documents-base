...
collection: ansible
version: "8"
title: "Ansible-base 2.10 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_base_2.10.html
fetched_at: 2026-07-28T01:04:06+00:00
---
# [Ansible-base 2.10 Porting Guide](porting_guide_base_2.10.md#id1)

> **Warning:**
>
> In preparation for the release of 2.10, many plugins and modules have migrated to Collections on [Ansible Galaxy](https://galaxy.ansible.com). For the current development status of Collections and FAQ see [Ansible Collections Community Guide](https://github.com/ansible-collections/overview/blob/main/README.rst). We expect the 2.10 Porting Guide to change frequently up to the 2.10 release. Follow the conversations about collections on our various [Communicating with the Ansible community](../community/communication.md#communication) channels for the latest information on the status of the `devel` branch.
...
We suggest you read this page along with the [Ansible-base Changelog for 2.10](https://github.com/ansible/ansible/blob/stable-2.10/changelogs/CHANGELOG-v2.10.rst) to understand what updates you may need to make.
...
- [Ansible-base 2.10 Porting Guide](porting_guide_base_2.10.md#ansible-base-2-10-porting-guide)

  - [Playbook](porting_guide_base_2.10.md#playbook)
  - [Command Line](porting_guide_base_2.10.md#command-line)
  - [Deprecated](porting_guide_base_2.10.md#deprecated)
  - [Modules](porting_guide_base_2.10.md#modules)

    - [Noteworthy module changes](porting_guide_base_2.10.md#noteworthy-module-changes)
  - [Plugins](porting_guide_base_2.10.md#plugins)

    - [Lookup plugin names case-sensitivity](porting_guide_base_2.10.md#lookup-plugin-names-case-sensitivity)
    - [Noteworthy plugin changes](porting_guide_base_2.10.md#noteworthy-plugin-changes)
    - [Action plugins which execute modules should use fully-qualified module names](porting_guide_base_2.10.md#action-plugins-which-execute-modules-should-use-fully-qualified-module-names)
  - [Porting custom scripts](porting_guide_base_2.10.md#porting-custom-scripts)

## [Playbook](porting_guide_base_2.10.md#id2)
...
## [Command Line](porting_guide_base_2.10.md#id3)
...
## [Deprecated](porting_guide_base_2.10.md#id4)
...
## [Modules](porting_guide_base_2.10.md#id5)
...
### [Noteworthy module changes](porting_guide_base_2.10.md#id6)
...
## [Plugins](porting_guide_base_2.10.md#id7)

### [Lookup plugin names case-sensitivity](porting_guide_base_2.10.md#id8)
...
### [Noteworthy plugin changes](porting_guide_base_2.10.md#id9)
...
### [Action plugins which execute modules should use fully-qualified module names](porting_guide_base_2.10.md#id10)
...
## [Porting custom scripts](porting_guide_base_2.10.md#id11)
