...
collection: ansible
version: "8"
title: "Ansible 8 Porting Guide"
source_url: https://docs.ansible.com/projects/ansible/8/porting_guides/porting_guide_8.html
fetched_at: 2026-07-28T00:58:15+00:00
---
# Ansible 8 Porting Guide

- [Playbook](porting_guide_8.md#playbook)
- [Command Line](porting_guide_8.md#command-line)
- [Deprecated](porting_guide_8.md#deprecated)
- [Modules](porting_guide_8.md#modules)

  - [Modules removed](porting_guide_8.md#modules-removed)
  - [Deprecation notices](porting_guide_8.md#deprecation-notices)
  - [Noteworthy module changes](porting_guide_8.md#noteworthy-module-changes)
- [Plugins](porting_guide_8.md#plugins)
- [Porting custom scripts](porting_guide_8.md#porting-custom-scripts)
- [Networking](porting_guide_8.md#networking)
- [Porting Guide for v8.7.0](porting_guide_8.md#porting-guide-for-v8-7-0)

  - [Breaking Changes](porting_guide_8.md#breaking-changes)
- [Porting Guide for v8.6.0](porting_guide_8.md#porting-guide-for-v8-6-0)

  - [Added Collections](porting_guide_8.md#added-collections)
  - [Major Changes](porting_guide_8.md#major-changes)
  - [Deprecated Features](porting_guide_8.md#deprecated-features)
- [Porting Guide for v8.5.0](porting_guide_8.md#porting-guide-for-v8-5-0)

  - [Deprecated Features](porting_guide_8.md#id1)
- [Porting Guide for v8.4.0](porting_guide_8.md#porting-guide-for-v8-4-0)

  - [Major Changes](porting_guide_8.md#id2)
  - [Deprecated Features](porting_guide_8.md#id4)
- [Porting Guide for v8.3.0](porting_guide_8.md#porting-guide-for-v8-3-0)

  - [Added Collections](porting_guide_8.md#id6)
  - [Major Changes](porting_guide_8.md#id7)
  - [Deprecated Features](porting_guide_8.md#id9)
- [Porting Guide for v8.2.0](porting_guide_8.md#porting-guide-for-v8-2-0)

  - [Known Issues](porting_guide_8.md#known-issues)
  - [Breaking Changes](porting_guide_8.md#id13)
  - [Major Changes](porting_guide_8.md#id14)
  - [Deprecated Features](porting_guide_8.md#id15)
- [Porting Guide for v8.1.0](porting_guide_8.md#porting-guide-for-v8-1-0)

  - [Known Issues](porting_guide_8.md#id17)
  - [Breaking Changes](porting_guide_8.md#id19)
  - [Major Changes](porting_guide_8.md#id20)
  - [Removed Features](porting_guide_8.md#removed-features)
  - [Deprecated Features](porting_guide_8.md#id22)
- [Porting Guide for v8.0.0](porting_guide_8.md#porting-guide-for-v8-0-0)

  - [Added Collections](porting_guide_8.md#id25)
  - [Known Issues](porting_guide_8.md#id26)
  - [Breaking Changes](porting_guide_8.md#id31)
  - [Major Changes](porting_guide_8.md#id37)
  - [Removed Collections](porting_guide_8.md#removed-collections)
  - [Removed Features](porting_guide_8.md#id56)
  - [Deprecated Features](porting_guide_8.md#id65)

Ansible 8 is based on Ansible-core 2.15.

We suggest you read this page along with the [Ansible 8 Changelog](https://github.com/ansible-community/ansible-build-data/blob/main/8/CHANGELOG-v8.rst) to understand what updates you may need to make.

## [Playbook](porting_guide_8.md#id75)
...
## [Command Line](porting_guide_8.md#id76)
...
## [Deprecated](porting_guide_8.md#id77)
...
## [Modules](porting_guide_8.md#id78)

No notable changes

### [Modules removed](porting_guide_8.md#id79)

The following modules no longer exist:

- No notable changes

### [Deprecation notices](porting_guide_8.md#id80)

No notable changes

### [Noteworthy module changes](porting_guide_8.md#id81)

No notable changes

## [Plugins](porting_guide_8.md#id82)

No notable changes

## [Porting custom scripts](porting_guide_8.md#id83)

No notable changes

## [Networking](porting_guide_8.md#id84)

No notable changes

## [Porting Guide for v8.7.0](porting_guide_8.md#id85)

### [Breaking Changes](porting_guide_8.md#id86)

#### Ansible-core

- assert - Nested templating may result in an inability for the conditional to be evaluated. See the porting guide for more information.

## [Porting Guide for v8.6.0](porting_guide_8.md#id87)

### [Added Collections](porting_guide_8.md#id88)

- ibm.storage_virtualize (version 2.1.0)

### [Major Changes](porting_guide_8.md#id89)
...
### [Deprecated Features](porting_guide_8.md#id90)
...
## [Porting Guide for v8.5.0](porting_guide_8.md#id91)

### [Deprecated Features](porting_guide_8.md#id92)
...
## [Porting Guide for v8.4.0](porting_guide_8.md#id93)

### [Major Changes](porting_guide_8.md#id94)

#### fortinet.fortios

- Improve the document for adding notes and examples in Q&A for modules using Integer number as the mkey.

### [Deprecated Features](porting_guide_8.md#id95)
...
- The `hpe.nimble` collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/254>).
...
## [Porting Guide for v8.3.0](porting_guide_8.md#id96)

### [Added Collections](porting_guide_8.md#id97)

- telekom_mms.icinga_director (version 1.34.1)

### [Major Changes](porting_guide_8.md#id98)
...
### [Deprecated Features](porting_guide_8.md#id99)
...
- The netapp.azure collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/234>).
- The netapp.elementsw collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/235>).
- The netapp.um_info collection is considered unmaintained and will be removed from Ansible 10 if no one starts maintaining it again before Ansible 10. See [the removal process for details on how this works](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#cancelling-removal-of-an-unmaintained-collection) (<https://github.com/ansible-community/community-topics/issues/244>).
...
## [Porting Guide for v8.2.0](porting_guide_8.md#id100)

### [Known Issues](porting_guide_8.md#id101)
...
### [Breaking Changes](porting_guide_8.md#id102)

#### hetzner.hcloud

- hcloud-python 1.20.0 is now required for full compatibility

### [Major Changes](porting_guide_8.md#id103)
...
### [Deprecated Features](porting_guide_8.md#id104)
...
## [Porting Guide for v8.1.0](porting_guide_8.md#id105)

### [Known Issues](porting_guide_8.md#id106)
...
### [Breaking Changes](porting_guide_8.md#id107)
...
### [Major Changes](porting_guide_8.md#id108)
...
### [Removed Features](porting_guide_8.md#id109)
...
### [Deprecated Features](porting_guide_8.md#id110)
...
## [Porting Guide for v8.0.0](porting_guide_8.md#id111)

### [Added Collections](porting_guide_8.md#id112)
...
### [Known Issues](porting_guide_8.md#id113)
...
### [Breaking Changes](porting_guide_8.md#id114)
...
### [Major Changes](porting_guide_8.md#id115)
...
### [Removed Collections](porting_guide_8.md#id116)
...
### [Removed Features](porting_guide_8.md#id117)

- `dellemc.os10` was considered unmaintained and removed from Ansible 8 as per the [removal from Ansible process](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#unmaintained-collections). Users can still install this collection with `ansible-galaxy collection install dellemc.os10`.
- `dellemc.os6` was considered unmaintained and removed from Ansible 8 as per the [removal from Ansible process](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#unmaintained-collections). Users can still install this collection with `ansible-galaxy collection install dellemc.os6`.
- `dellemc.os9` was considered unmaintained and removed from Ansible 8 as per the [removal from Ansible process](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#unmaintained-collections). Users can still install this collection with `ansible-galaxy collection install dellemc.os9`.
- `mellanox.onyx` was considered unmaintained and removed from Ansible 8 as per the [removal from Ansible process](https://github.com/ansible-collections/overview/blob/main/removal_from_ansible.rst#unmaintained-collections). Users can still install this collection with `ansible-galaxy collection install mellanox.onyx`.
...
- All `sap` modules have been removed from this collection.
  They have been migrated to the [community.sap_libs](https://galaxy.ansible.com/community/sap_libs) collection.
...
### [Deprecated Features](porting_guide_8.md#id118)
