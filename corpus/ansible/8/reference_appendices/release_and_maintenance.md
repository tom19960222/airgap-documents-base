...
source_url: https://docs.ansible.com/projects/ansible/8/reference_appendices/release_and_maintenance.html
fetched_at: 2026-07-28T00:58:02+00:00
---
...
- [Release cycle overview](release_and_maintenance.md#release-cycle-overview)
  ...
  - [`ansible-core` control node Python support](release_and_maintenance.md#ansible-core-control-node-python-support)
  - [`ansible-core` target node Python support](release_and_maintenance.md#ansible-core-target-node-python-support)
  - [`ansible-core` support matrix](release_and_maintenance.md#ansible-core-support-matrix)
...
## [Release cycle overview](release_and_maintenance.md#id14)
...
### [Ansible community package release cycle](release_and_maintenance.md#id15)
...
### [Ansible community changelogs](release_and_maintenance.md#id16)
...
| [8.x Changelogs](https://github.com/ansible-community/ansible-build-data/blob/main/8/CHANGELOG-v8.rst) | Current | 2.15 |
| [7.x Changelogs](https://github.com/ansible-community/ansible-build-data/blob/main/7/CHANGELOG-v7.rst) | Unmaintained (end of life) after Ansible 7.7.0 | 2.14 |
...
### [ansible-core release cycle](release_and_maintenance.md#id17)
...
see the chart in [ansible-core control node Python support](release_and_maintenance.md#release-schedule) for the degrees to which current releases are maintained.
...
You can refer to the [Ansible Core Porting Guides](../porting_guides/core_porting_guides.md#core-porting-guides) for tips on updating your playbooks to run on newer versions of `ansible-core`.
...
### [`ansible-core` control node Python support](release_and_maintenance.md#id18)
...
### [`ansible-core` target node Python support](release_and_maintenance.md#id19)
...
### [`ansible-core` support matrix](release_and_maintenance.md#id20)
...
| --- | --- | --- | --- | --- |
| [2.15](https://github.com/ansible/ansible/blob/stable-2.15/changelogs/CHANGELOG-v2.15.rst) | GA: 22 May 2023  Critical: 06 Nov 2023  Security: 20 May 2024 | Nov 2024 | Python 3.9 - 3.11 | Python 2.7  Python 3.5 - 3.11  PowerShell 3 - 5.1 |
| [2.14](https://github.com/ansible/ansible/blob/stable-2.14/changelogs/CHANGELOG-v2.14.rst) | GA: 07 Nov 2022  Critical: 22 May 2023  Security: 06 Nov 2023 | 20 May 2024 | Python 3.9 - 3.11 | Python 2.7  Python 3.5 - 3.11  PowerShell 3 - 5.1 |
| [2.13](https://github.com/ansible/ansible/blob/stable-2.13/changelogs/CHANGELOG-v2.13.rst) | GA: 23 May 2022  Critical: 07 Nov 2022  Security: 22 May 2023 | **EOL**  06 Nov 2023 | Python 3.8 - 3.10 | Python 2.7  Python 3.5 - 3.10  PowerShell 3 - 5.1 |
| [2.12](https://github.com/ansible/ansible/blob/stable-2.12/changelogs/CHANGELOG-v2.12.rst) | GA: 08 Nov 2021  Critical: 23 May 2022  Security: 07 Nov 2022 | **EOL**  22 May 2023 | Python 3.8 - 3.10 | Python 2.6 - 2.7  Python 3.5 - 3.10  PowerShell 3 - 5.1 |
| [2.11](https://github.com/ansible/ansible/blob/stable-2.11/changelogs/CHANGELOG-v2.11.rst) | GA: 26 Apr 2021  Critical: 08 Nov 2021  Security: 23 May 2022 | **EOL**  07 Nov 2022 | Python 2.7  Python 3.5 - 3.9 | Python 2.6 - 2.7  Python 3.5 - 3.9  PowerShell 3 - 5.1 |
| [2.10](https://github.com/ansible/ansible/blob/stable-2.10/changelogs/CHANGELOG-v2.10.rst) | GA: 13 Aug 2020  Critical: 26 Apr 2021  Security: 08 Nov 2021 | **EOL**  23 May 2022 | Python 2.7  Python 3.5 - 3.9 | Python 2.6 - 2.7  Python 3.5 - 3.9  PowerShell 3 - 5.1 |
| [2.9](https://github.com/ansible/ansible/blob/stable-2.9/changelogs/CHANGELOG-v2.9.rst) | GA: 31 Oct 2019  Critical: 13 Aug 2020  Security: 26 Apr 2021 | **EOL**  23 May 2022 | Python 2.7  Python 3.5 - 3.8 | Python 2.6 - 2.7  Python 3.5 - 3.8  PowerShell 3 - 5.1 |

## [Preparing for a new release](release_and_maintenance.md#id21)

### [Feature freezes](release_and_maintenance.md#id22)
...
### [Release candidates](release_and_maintenance.md#id23)
...
## [Development and maintenance workflows](release_and_maintenance.md#id24)
...
### [Ansible community package workflow](release_and_maintenance.md#id25)
...
### [ansible-core workflow](release_and_maintenance.md#id26)
...
### [Generating changelogs](release_and_maintenance.md#id27)
...
## [Deprecation cycles](release_and_maintenance.md#id28)
...
### [Ansible community package deprecation cycle](release_and_maintenance.md#id29)
...
### [ansible-core deprecation cycle](release_and_maintenance.md#id30)
