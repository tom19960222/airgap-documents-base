...
source_url: https://docs.ansible.com/projects/ansible/8/reference_appendices/test_strategies.html
fetched_at: 2026-07-28T00:58:03+00:00
---
# Testing Strategies
...
If you have read into [Controlling where tasks run: delegation and local actions](../playbook_guide/playbooks_delegation.md#playbooks-delegation) it may quickly become apparent that the rolling update pattern can be extended, and you
