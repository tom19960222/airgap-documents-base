...
collection: ansible
version: "8"
title: "ansible-core project branches and tags"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/core_branches_and_tags.html
fetched_at: 2026-07-28T01:00:41+00:00
---
...
features under active development. As described in the [ansible-core Roadmaps](../roadmap/ansible_core_roadmap_index.md#ansible-core-roadmaps) for a given release, development is
...
The following example is for illustrative purposes only. See the [ansible-core Roadmaps](../roadmap/ansible_core_roadmap_index.md#ansible-core-roadmaps) for accurate dates. For example, the `milestone` branch in 2.13 `ansible-core` roadmap updated as follows:
