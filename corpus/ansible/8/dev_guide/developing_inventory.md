...
collection: ansible
version: "8"
title: "Developing dynamic inventory"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/developing_inventory.html
fetched_at: 2026-07-28T00:59:14+00:00
---
# Developing dynamic inventory

Ansible can pull inventory information from dynamic sources, including cloud sources, by using the supplied [inventory plugins](../plugins/inventory.md#inventory-plugins). For details about how to pull inventory information, see [Working with dynamic inventory](../inventory_guide/intro_dynamic_inventory.md#dynamic-inventory). If the source you want is not currently covered by existing plugins, you can create your own inventory plugin as with any other plugin type.
...
You can still use and write inventory scripts, as we ensured backwards compatibility through the [script inventory plugin](../collections/ansible/builtin/script_inventory.md#script-inventory)
...
If you use [inventory plugins](../plugins/inventory.md#inventory-plugins) instead, you can use the Ansible codebase and add these common features automatically.
...
- [Inventory plugins](developing_inventory.md#inventory-plugins)
  ...
  - [Developing an inventory plugin](developing_inventory.md#developing-an-inventory-plugin)

    - [verify_file method](developing_inventory.md#verify-file-method)
    - [parse method](developing_inventory.md#parse-method)
    - [inventory object](developing_inventory.md#inventory-object)
    - [inventory cache](developing_inventory.md#inventory-cache)
    - [constructed features](developing_inventory.md#constructed-features)
  - [Common format for inventory sources](developing_inventory.md#common-format-for-inventory-sources)
  - [The ‘auto’ plugin](developing_inventory.md#the-auto-plugin)
- [Inventory scripts](developing_inventory.md#developing-inventory-scripts)

  - [Inventory script conventions](developing_inventory.md#inventory-script-conventions)
  - [Tuning the external inventory script](developing_inventory.md#tuning-the-external-inventory-script)

## [Inventory sources](developing_inventory.md#id6)
...
| --- | --- |
| Plugin | Source |
| [host list](../collections/ansible/builtin/host_list_inventory.md#host-list-inventory) | A comma-separated list of hosts |
| [yaml](../collections/ansible/builtin/yaml_inventory.md#yaml-inventory) | Path to a YAML format data file |
| [constructed](../collections/ansible/builtin/constructed_inventory.md#constructed-inventory) | Path to a YAML configuration file |
| [ini](../collections/ansible/builtin/ini_inventory.md#ini-inventory) | Path to an INI formatted data file |
| [virtualbox](https://docs.ansible.com/ansible/2.9/plugins/inventory/virtualbox.html#virtualbox-inventory "(in Ansible v2.9)") | Path to a YAML configuration file |
| [script plugin](../collections/ansible/builtin/script_inventory.md#script-inventory) | Path to an executable that outputs JSON |

## [Inventory plugins](developing_inventory.md#id7)

Like most plugin types (except modules), inventory plugins must be developed in Python. They execute on the controller and should therefore adhere to the [Control node requirements](../installation_guide/intro_installation.md#control-node-requirements).

Most of the documentation in [Developing plugins](developing_plugins.md#developing-plugins) also applies here. You should read that document first for a general understanding and then come back to this document for specifics on inventory plugins.
...
### [Developing an inventory plugin](developing_inventory.md#id8)
...
#### [verify_file method](developing_inventory.md#id9)
...
In the above example, from the [virtualbox inventory plugin](https://docs.ansible.com/ansible/2.9/plugins/inventory/virtualbox.html#virtualbox-inventory "(in Ansible v2.9)"), we screen for specific file name patterns to avoid attempting to consume any valid YAML file. You can add any type of condition here, but the most common one is ‘extension matching’. If you implement extension matching for YAML configuration files, the path suffix <plugin_name>.<yml|yaml> should be accepted. All valid extensions should be documented in the plugin description.

The following is another example that does not use a ‘file’ but the inventory source string itself,
from the [host list](../collections/ansible/builtin/host_list_inventory.md#host-list-inventory) plugin:
...
#### [parse method](developing_inventory.md#id10)
...
[lib/ansible/plugins/inventory](https://github.com/ansible/ansible/tree/devel/lib/ansible/plugins/inventory).

#### [inventory object](developing_inventory.md#id11)
...
[lib/ansible/inventory/data.py](https://github.com/ansible/ansible/tree/devel/lib/ansible/inventory/data.py).

#### [inventory cache](developing_inventory.md#id12)
...
#### [constructed features](developing_inventory.md#id13)
...
### [Common format for inventory sources](developing_inventory.md#id14)
...
### [Inventory script conventions](developing_inventory.md#id17)
...
### [Tuning the external inventory script](developing_inventory.md#id18)
...
An easy way to see how this should look is using [ansible-inventory](../cli/ansible-inventory.md#ansible-inventory), which also supports `--list` and `--host` parameters like an inventory script would.
