...
collection: ansible
version: "8"
title: "Ansible module architecture"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/developing_program_flow_modules.html
...
- [Types of modules](developing_program_flow_modules.md#types-of-modules)
  ...
  - [Action plugins](developing_program_flow_modules.md#action-plugins)
  - [New-style modules](developing_program_flow_modules.md#new-style-modules)

    - [Python](developing_program_flow_modules.md#python)
    - [PowerShell](developing_program_flow_modules.md#powershell)
  - [JSONARGS modules](developing_program_flow_modules.md#jsonargs-modules)
  - [Non-native want JSON modules](developing_program_flow_modules.md#non-native-want-json-modules)
  - [Binary modules](developing_program_flow_modules.md#binary-modules)
  - [Old-style modules](developing_program_flow_modules.md#old-style-modules)
- [How modules are executed](developing_program_flow_modules.md#how-modules-are-executed)

  - [Executor/task_executor](developing_program_flow_modules.md#executor-task-executor)
  - [The `normal` action plugin](developing_program_flow_modules.md#the-normal-action-plugin)
  - [Executor/module_common.py](developing_program_flow_modules.md#executor-module-common-py)
  - [Assembler frameworks](developing_program_flow_modules.md#assembler-frameworks)

    - [Module Replacer framework](developing_program_flow_modules.md#module-replacer-framework)
    - [Ansiballz framework](developing_program_flow_modules.md#ansiballz-framework)
  - [Passing args](developing_program_flow_modules.md#passing-args)
  - [Internal arguments](developing_program_flow_modules.md#internal-arguments)

    - [_ansible_no_log](developing_program_flow_modules.md#ansible-no-log)
    - [_ansible_debug](developing_program_flow_modules.md#ansible-debug)
    - [_ansible_diff](developing_program_flow_modules.md#ansible-diff)
    - [_ansible_verbosity](developing_program_flow_modules.md#ansible-verbosity)
    - [_ansible_selinux_special_fs](developing_program_flow_modules.md#ansible-selinux-special-fs)
    - [_ansible_syslog_facility](developing_program_flow_modules.md#ansible-syslog-facility)
    - [_ansible_version](developing_program_flow_modules.md#ansible-version)
    - [_ansible_module_name](developing_program_flow_modules.md#ansible-module-name)
    - [_ansible_string_conversion_action](developing_program_flow_modules.md#ansible-string-conversion-action)
    - [_ansible_keep_remote_files](developing_program_flow_modules.md#ansible-keep-remote-files)
    - [_ansible_socket](developing_program_flow_modules.md#ansible-socket)
    - [_ansible_shell_executable](developing_program_flow_modules.md#ansible-shell-executable)
    - [_ansible_tmpdir](developing_program_flow_modules.md#ansible-tmpdir)
    - [_ansible_remote_tmp](developing_program_flow_modules.md#ansible-remote-tmp)
  - [Module return values & Unsafe strings](developing_program_flow_modules.md#module-return-values-unsafe-strings)
  - [Special considerations](developing_program_flow_modules.md#special-considerations)

    - [Pipelining](developing_program_flow_modules.md#pipelining)
    - [Why pass args over stdin?](developing_program_flow_modules.md#why-pass-args-over-stdin)
  - [AnsibleModule](developing_program_flow_modules.md#ansiblemodule)

    - [Argument spec](developing_program_flow_modules.md#argument-spec)
    - [Dependencies between module options](developing_program_flow_modules.md#dependencies-between-module-options)
    - [Declaring check mode support](developing_program_flow_modules.md#declaring-check-mode-support)
    - [Adding file options](developing_program_flow_modules.md#adding-file-options)

## [Types of modules](developing_program_flow_modules.md#id3)
...
### [Action plugins](developing_program_flow_modules.md#id4)
...
example, the [debug](../collections/ansible/builtin/debug_module.md#debug-module) action plugin (which prints text for
the user to see) and the [assert](../collections/ansible/builtin/assert_module.md#assert-module) action plugin (which
...
actual module on the managed node that does something with these values. For example, the [template](../collections/ansible/builtin/template_module.md#template-module) action plugin takes values from
...
[copy module](../collections/ansible/builtin/copy_module.md#copy-module) which operates on the remote system to move the file
into its final location, sets file permissions, and so on.

### [New-style modules](developing_program_flow_modules.md#id5)
...
#### [Python](developing_program_flow_modules.md#id6)

New-style Python modules use the [Ansiballz framework](developing_program_flow_modules.md#ansiballz) framework for constructing
modules. These modules use imports from `ansible.module_utils` to pull in
boilerplate module code, such as argument parsing, formatting of return
values as [JSON](../reference_appendices/glossary.md#term-JSON), and various file operations.

> **Note:**
>
> In Ansible, up to version 2.0.x, the official Python modules used the
> [Module Replacer framework](developing_program_flow_modules.md#module-replacer) framework. For module authors, [Ansiballz framework](developing_program_flow_modules.md#ansiballz) is
> largely a superset of [Module Replacer framework](developing_program_flow_modules.md#module-replacer) functionality, so you usually
> do not need to understand the differences between them.

#### [PowerShell](developing_program_flow_modules.md#id7)

New-style PowerShell modules use the [Module Replacer framework](developing_program_flow_modules.md#module-replacer) framework for
...
### [JSONARGS modules](developing_program_flow_modules.md#id8)
...
> **Note:**
>
> Ansible outputs a [JSON](../reference_appendices/glossary.md#term-JSON) string with bare quotes. Double quotes are
...
> a [non-native JSON module](developing_program_flow_modules.md#flow-want-json-modules) or
> [Old-style module](developing_program_flow_modules.md#flow-old-style-modules) instead.
...
### [Non-native want JSON modules](developing_program_flow_modules.md#id9)
...
parameter. The filename is for a temporary file containing a [JSON](../reference_appendices/glossary.md#term-JSON)
...
> **See also:**
>
> Examples of Non-native modules written in ruby are in the [Ansible
> for Rubyists](https://github.com/ansible/ansible-for-rubyists) repository.

### [Binary modules](developing_program_flow_modules.md#id10)
...
way as [want JSON modules](developing_program_flow_modules.md#flow-want-json-modules).

> **See also:**
>
> One example of a [binary module](https://github.com/ansible/ansible/blob/devel/test/integration/targets/binary_modules/library/helloworld.go)
> written in go.

### [Old-style modules](developing_program_flow_modules.md#id11)

Old-style modules are similar to
[want JSON modules](developing_program_flow_modules.md#flow-want-json-modules), except that the file that
they take contains `key=value` pairs for their parameters instead of
[JSON](../reference_appendices/glossary.md#term-JSON). Ansible decides that a module is old-style when it doesn’t have
any of the markers that would show that it is one of the other types.

## [How modules are executed](developing_program_flow_modules.md#id12)

When a user uses **ansible** or **ansible-playbook**, they
...
### [Executor/task_executor](developing_program_flow_modules.md#id13)

The TaskExecutor receives the module name and parameters that were parsed from
the [playbook](../reference_appendices/glossary.md#term-Playbooks) (or from the command-line in the case of
**/usr/bin/ansible**). It uses the name to decide whether it is looking
at a module or an [Action Plugin](developing_program_flow_modules.md#flow-action-plugins). If it is
a module, it loads the [Normal Action Plugin](developing_program_flow_modules.md#flow-normal-action-plugin)
and passes the name, variables, and other information about the task and play
to that Action Plugin for further processing.

### [The `normal` action plugin](developing_program_flow_modules.md#id14)
...
- It pushes the module and module parameters to the
  remote host, although the [module_common](developing_program_flow_modules.md#flow-executor-module-common)
...
which lives in `plugins/action/__init__.py`. It uses the
`Connection` and `Shell` objects to do its work.

> **Note:**
>
> When [tasks](../reference_appendices/glossary.md#term-Tasks) are run with the `async:` parameter, Ansible
...
### [Executor/module_common.py](developing_program_flow_modules.md#id15)

Code in `executor/module_common.py` assembles the module
to be shipped to the managed node. The module is first read in, then examined
to determine its type:

- [PowerShell](developing_program_flow_modules.md#flow-powershell-modules) and [JSON-args modules](developing_program_flow_modules.md#flow-jsonargs-modules) are passed through [Module Replacer](developing_program_flow_modules.md#module-replacer).
- New-style [Python modules](developing_program_flow_modules.md#flow-python-modules) are assembled by [Ansiballz framework](developing_program_flow_modules.md#ansiballz).
- [Non-native-want-JSON](developing_program_flow_modules.md#flow-want-json-modules), [Binary modules](developing_program_flow_modules.md#flow-binary-modules), and [Old-Style modules](developing_program_flow_modules.md#flow-old-style-modules) aren’t touched by either of these and pass through unchanged.
...
[Normal Action](developing_program_flow_modules.md#flow-normal-action-plugin) which continues execution of
the module.

### [Assembler frameworks](developing_program_flow_modules.md#id16)

Ansible supports two assembler frameworks: Ansiballz and the older Module Replacer.

#### [Module Replacer framework](developing_program_flow_modules.md#id17)
...
- Replacements that only happen in the module file. These are public
  ...
  - `from ansible.module_utils.MOD_LIB_NAME import *` is replaced with the
    contents of the `ansible/module_utils/MOD_LIB_NAME.py` These should
    only be used with [new-style Python modules](developing_program_flow_modules.md#flow-python-modules).
  - `#<<INCLUDE_ANSIBLE_MODULE_COMMON>>` is equivalent to
    `from ansible.module_utils.basic import *` and should also only apply
  ...
  - `# POWERSHELL_COMMON` substitutes the contents of
    ...
    [new-style Powershell modules](developing_program_flow_modules.md#flow-powershell-modules).
- Replacements that are used by `ansible.module_utils` code. These are internal replacement patterns. They may be used internally, in the above public replacements, but shouldn’t be used directly by modules.
  ...
  - `"<<ANSIBLE_VERSION>>"` is substituted with the Ansible version. In
    [new-style Python modules](developing_program_flow_modules.md#flow-python-modules) under the
    [Ansiballz framework](developing_program_flow_modules.md#ansiballz) framework the proper way is to instead instantiate an
    AnsibleModule and then access the version from
    :attr:`AnsibleModule.ansible_version`.
  - `"<<INCLUDE_ANSIBLE_MODULE_COMPLEX_ARGS>>"` is substituted with
    a string which is the Python `repr` of the [JSON](../reference_appendices/glossary.md#term-JSON) encoded module
    ...
    then using [`AnsibleModule.params`](../api/index.md#AnsibleModule.params "AnsibleModule.params").
  - `<<SELINUX_SPECIAL_FILESYSTEMS>>` substitutes a string which is
    ...
    [`AnsibleModule._selinux_special_fs`](../api/index.md#AnsibleModule._selinux_special_fs "AnsibleModule._selinux_special_fs"). The variable has also changed
    from a comma-separated string of file system names to an actual python
    list of file system names.
  - `<<INCLUDE_ANSIBLE_MODULE_JSON_ARGS>>` substitutes the module
    ...
    way.
  - The string `syslog.LOG_USER` is replaced wherever it occurs with the
    `syslog_facility` which was named in `ansible.cfg` or any
    ...
    [`AnsibleModule._syslog_facility`](../api/index.md#AnsibleModule._syslog_facility "AnsibleModule._syslog_facility") to access it. It is no longer the
    actual syslog facility and is now the name of the syslog facility. See
    the [documentation on internal arguments](developing_program_flow_modules.md#flow-internal-arguments)
    for details.

#### [Ansiballz framework](developing_program_flow_modules.md#id18)
...
in `ansible/module_utils` that are imported by the module, and some
...
[`ansible.module_utils`](../api/index.md#module-ansible.module_utils "ansible.module_utils") package trigger inclusion of that Python file
into the zipfile. Instances of `#<<INCLUDE_ANSIBLE_MODULE_COMMON>>` in
the module are turned into `from ansible.module_utils.basic import *`
and `ansible/module-utils/basic.py` is then included in the zipfile.
Files that are included from `module_utils` are themselves scanned for
imports of other Python modules from `module_utils` to be included in
the zipfile as well.

### [Passing args](developing_program_flow_modules.md#id19)

Arguments are passed differently by the two frameworks:

- In [Module Replacer framework](developing_program_flow_modules.md#module-replacer), module arguments are turned into a JSON-ified string and substituted into the combined module file.
- In [Ansiballz framework](developing_program_flow_modules.md#ansiballz), the JSON-ified string is part of the script which wraps the zipfile. Just before the wrapper script imports the Ansible module as `__main__`, it monkey-patches the private, `_ANSIBLE_ARGS` variable in `basic.py` with the variable values. When a [`ansible.module_utils.basic.AnsibleModule`](https://docs.ansible.com/ansible/2.9/reference_appendices/module_utils.html#ansible.module_utils.basic.AnsibleModule "(in Ansible v2.9)") is instantiated, it parses this string and places the args into [`AnsibleModule.params`](../api/index.md#AnsibleModule.params "AnsibleModule.params") where it can be accessed by the module’s other code.
...
> code allow Ansible modules to forgo using [`ansible.module_utils.basic.AnsibleModule`](https://docs.ansible.com/ansible/2.9/reference_appendices/module_utils.html#ansible.module_utils.basic.AnsibleModule "(in Ansible v2.9)"). Do not rely on the internal global `_ANSIBLE_ARGS` variable.
>
...
### [Internal arguments](developing_program_flow_modules.md#id20)

Both [Module Replacer framework](developing_program_flow_modules.md#module-replacer) and [Ansiballz framework](developing_program_flow_modules.md#ansiballz) send additional arguments to
...
the features are implemented in [`ansible.module_utils.basic`](../reference_appendices/module_utils.md#module-ansible.module_utils.basic "ansible.module_utils.basic"). However, certain
...
#### [_ansible_no_log](developing_program_flow_modules.md#id21)

Type: `bool`

Set to `True` whenever an argument in a task or play specifies `no_log`. Any module that calls the [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") function handles this action automatically. If you have a module that implements its own logging then you need to check the value of `_ansible_no_log`. To access `_ansible_no_log` in a module, instantiate the `AnsibleModule` utility and then check the value of [`AnsibleModule.no_log`](../api/index.md#AnsibleModule.no_log "AnsibleModule.no_log").

> **Note:**
>
> `no_log` specified in a module’s `argument_spec` is handled by a different mechanism.

#### [_ansible_debug](developing_program_flow_modules.md#id22)

Type: `bool`

Operates verbose logging and logging of external commands that a module executes. If the module uses the [`AnsibleModule.debug()`](../api/index.md#AnsibleModule.debug "AnsibleModule.debug") function rather than the [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") function then the messages are only logged if you set the `_ansible_debug` argument to `True`. To access `_ansible_debug` in a module, instantiate the `AnsibleModule` utility and access [`AnsibleModule._debug`](../api/index.md#AnsibleModule._debug "AnsibleModule._debug"). For more details, see [DEFAULT_DEBUG](../reference_appendices/config.md#default-debug).

#### [_ansible_diff](developing_program_flow_modules.md#id23)

Type: `bool`

With this parameter you can configure your module to show a unified diff of changes that will be applied to the templated files. To access `_ansible_diff` in a module, instantiate the `AnsibleModule` utility and access [`AnsibleModule._diff`](../api/index.md#AnsibleModule._diff "AnsibleModule._diff"). You can also access this parameter using the `diff` keyword in your playbook, or the relevant environment variable. For more details, see [Playbook Keywords](../reference_appendices/playbooks_keywords.md#playbook-keywords) and the [DIFF_ALWAYS](../reference_appendices/config.md#diff-always) configuration option.

#### [_ansible_verbosity](developing_program_flow_modules.md#id24)

Type: `int`

You can use this argument to control the level (0 for none) of verbosity in logging.

#### [_ansible_selinux_special_fs](developing_program_flow_modules.md#id25)
...
Most modules can use the built-in `AnsibleModule` methods to manipulate files. To access in a module that needs to know about these special context file systems, instantiate `AnsibleModule` and examine the list in [`AnsibleModule._selinux_special_fs`](../api/index.md#AnsibleModule._selinux_special_fs "AnsibleModule._selinux_special_fs").

This argument replaces [`ansible.module_utils.basic.SELINUX_SPECIAL_FS`](../api/index.md#ansible.module_utils.basic.SELINUX_SPECIAL_FS "ansible.module_utils.basic.SELINUX_SPECIAL_FS") from [Module Replacer framework](developing_program_flow_modules.md#module-replacer). In the module replacer framework the argument was formatted as a comma-separated string of file system names. Under the Ansiballz framework it is a list. You can access `_ansible_selinux_special_fs` using the corresponding environment variable. For more details, see the [DEFAULT_SELINUX_SPECIAL_FS](../reference_appendices/config.md#default-selinux-special-fs) configuration option.

New in version 2.1.

#### [_ansible_syslog_facility](developing_program_flow_modules.md#id26)

This argument controls which syslog facility the module logs to. Most modules should just use the [`AnsibleModule.log()`](../api/index.md#AnsibleModule.log "AnsibleModule.log") function which will then make use of this. If a module has to use this on its own, it should instantiate the `AnsibleModule` method and then retrieve the name of the syslog facility from [`AnsibleModule._syslog_facility`](../api/index.md#AnsibleModule._syslog_facility "AnsibleModule._syslog_facility"). The Ansiballz code is less elegant than the [Module Replacer framework](developing_program_flow_modules.md#module-replacer) code:
...
For more details, see the [DEFAULT_SYSLOG_FACILITY](../reference_appendices/config.md#default-syslog-facility) configuration option.

New in version 2.1.

#### [_ansible_version](developing_program_flow_modules.md#id27)

This argument passes the version of Ansible to the module. To access it, a module should instantiate the `AnsibleModule` method and then retrieve the version from [`AnsibleModule.ansible_version`](../api/index.md#AnsibleModule.ansible_version "AnsibleModule.ansible_version"). This replaces [`ansible.module_utils.basic.ANSIBLE_VERSION`](../api/index.md#ansible.module_utils.basic.ANSIBLE_VERSION "ansible.module_utils.basic.ANSIBLE_VERSION") from [Module Replacer framework](developing_program_flow_modules.md#module-replacer).

New in version 2.1.

#### [_ansible_module_name](developing_program_flow_modules.md#id28)

Type: `str`

This argument passes the information to modules about their name. For more details see, the configuration option [DEFAULT_MODULE_NAME](../reference_appendices/config.md#default-module-name).

#### [_ansible_string_conversion_action](developing_program_flow_modules.md#id29)

This argument provides instructions about what modules should do after the values of the user-specified module parameters are converted to strings. For more details, see the [STRING_CONVERSION_ACTION](../reference_appendices/config.md#string-conversion-action) configuration option.

#### [_ansible_keep_remote_files](developing_program_flow_modules.md#id30)

Type: `bool`

This argument provides instructions that modules must be ready if they need to keep the remote files. For more details, see the [DEFAULT_KEEP_REMOTE_FILES](../reference_appendices/config.md#default-keep-remote-files) configuration option.

#### [_ansible_socket](developing_program_flow_modules.md#id31)

This argument provides modules with a socket for persistent connections. The argument is created using the [PERSISTENT_CONTROL_PATH_DIR](../reference_appendices/config.md#persistent-control-path-dir) configuration option.

#### [_ansible_shell_executable](developing_program_flow_modules.md#id32)

Type: `bool`

This argument ensures that modules use the designated shell executable. For more details, see the [ansible_shell_executable](../inventory_guide/intro_inventory.md#ansible-shell-executable) remote host environment parameter.

#### [_ansible_tmpdir](developing_program_flow_modules.md#id33)
...
- [DEFAULT_LOCAL_TMP](../reference_appendices/config.md#default-local-tmp)
- [remote_tmp](https://docs.ansible.com/ansible/latest/collections/ansible/builtin/sh_shell.html#parameter-remote_tmp)
- [system_tmpdirs](https://docs.ansible.com/ansible/latest/collections/ansible/builtin/sh_shell.html#parameter-system_tmpdirs)
...
#### [_ansible_remote_tmp](developing_program_flow_modules.md#id34)

The module’s `tmpdir` property creates a randomized directory name in this directory if the action plugin did not set `_ansible_tmpdir`. For more details, see the [remote_tmp](https://docs.ansible.com/ansible/latest/collections/ansible/builtin/sh_shell.html#parameter-remote_tmp) parameter of the shell plugin.

### [Module return values & Unsafe strings](developing_program_flow_modules.md#id35)
...
### [Special considerations](developing_program_flow_modules.md#id36)

#### [Pipelining](developing_program_flow_modules.md#id37)
...
#### [Why pass args over stdin?](developing_program_flow_modules.md#id38)

Passing arguments through stdin was chosen for the following reasons:

- When combined with [ANSIBLE_PIPELINING](../reference_appendices/config.md#ansible-pipelining), this keeps the module’s arguments from
...
### [AnsibleModule](developing_program_flow_modules.md#id39)

#### [Argument spec](developing_program_flow_modules.md#id40)
...
mutually_exclusive:
:   If `options` is specified, `mutually_exclusive` refers to the sub-options described in `options` and behaves as in [Dependencies between module options](developing_program_flow_modules.md#argument-spec-dependencies).

required_together:
:   If `options` is specified, `required_together` refers to the sub-options described in `options` and behaves as in [Dependencies between module options](developing_program_flow_modules.md#argument-spec-dependencies).

required_one_of:
:   If `options` is specified, `required_one_of` refers to the sub-options described in `options` and behaves as in [Dependencies between module options](developing_program_flow_modules.md#argument-spec-dependencies).

required_if:
:   If `options` is specified, `required_if` refers to the sub-options described in `options` and behaves as in [Dependencies between module options](developing_program_flow_modules.md#argument-spec-dependencies).

required_by:
:   If `options` is specified, `required_by` refers to the sub-options described in `options` and behaves as in [Dependencies between module options](developing_program_flow_modules.md#argument-spec-dependencies).

#### [Dependencies between module options](developing_program_flow_modules.md#id41)
...
#### [Declaring check mode support](developing_program_flow_modules.md#id42)
...
#### [Adding file options](developing_program_flow_modules.md#id43)
...
You can find [a list of all file options here](https://github.com/ansible/ansible/blob/devel/lib/ansible/plugins/doc_fragments/files.py). It is recommended that you make your `DOCUMENTATION` extend the doc fragment `ansible.builtin.files` (see [Documentation fragments](developing_modules_documenting.md#module-docs-fragments)) in this case, to make sure that all these fields are correctly documented.
