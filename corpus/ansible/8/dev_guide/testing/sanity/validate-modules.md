...
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/testing/sanity/validate-modules.html
fetched_at: 2026-07-28T01:03:53+00:00
---
# validate-modules

Analyze modules for common issues in code and documentation.

- [Usage](validate-modules.md#usage)
- [Help](validate-modules.md#help)
- [Extending validate-modules](validate-modules.md#extending-validate-modules)
- [Codes](validate-modules.md#codes)

## [Usage](validate-modules.md#id1)
...
| invalid-removal-version | Documentation | Error | The version at which a feature is supposed to be removed cannot be parsed (for collections, it must be a [semantic version](https://semver.org/)) |
