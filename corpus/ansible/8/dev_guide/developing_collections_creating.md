...
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/developing_collections_creating.html
...
1. Create a [collection skeleton](developing_collections_creating.md#creating-collections-skeleton) with the `ansible-galaxy collection init` command.
...
4. Publish the collection artifact to Galaxy with [ansible-galaxy collection publish](https://docs.ansible.com/ansible/2.9/dev_guide/developing_collections.html#publishing-collections "(in Ansible v2.9)").
