...
collection: ansible
version: "8"
title: "Testing Ansible and Collections"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/testing_running_locally.html
fetched_at: 2026-07-28T01:04:24+00:00
---
# Testing Ansible and Collections

This document describes how to run tests using `ansible-test`.

- [Setup](testing_running_locally.md#setup)

  - [Testing an Ansible Collection](testing_running_locally.md#testing-an-ansible-collection)
  - [Testing `ansible-core`](testing_running_locally.md#testing-ansible-core)
- [Commands](testing_running_locally.md#commands)
- [Environments](testing_running_locally.md#environments)

  - [Containers](testing_running_locally.md#containers)

    - [Choosing a container](testing_running_locally.md#choosing-a-container)

      - [Custom containers](testing_running_locally.md#custom-containers)
    - [Docker and SELinux](testing_running_locally.md#docker-and-selinux)
    - [Docker Desktop with WSL2](testing_running_locally.md#docker-desktop-with-wsl2)

      - [Configuration requirements](testing_running_locally.md#configuration-requirements)
      - [Setup instructions](testing_running_locally.md#setup-instructions)
    - [Linux cgroup configuration](testing_running_locally.md#linux-cgroup-configuration)

      - [Podman](testing_running_locally.md#podman)
  - [Remote virtual machines](testing_running_locally.md#remote-virtual-machines)
  - [Python virtual environments](testing_running_locally.md#python-virtual-environments)
  - [Composite environment arguments](testing_running_locally.md#composite-environment-arguments)
- [Additional Requirements](testing_running_locally.md#additional-requirements)
- [Environment variables](testing_running_locally.md#environment-variables)
- [Interactive shell](testing_running_locally.md#interactive-shell)
- [Code coverage](testing_running_locally.md#code-coverage)

## [Setup](testing_running_locally.md#id6)

Before running `ansible-test`, set up your environment for [Testing an Ansible Collection](testing_running_locally.md#testing-an-ansible-collection) or
[Testing ansible-core](testing_running_locally.md#testing-ansible-core), depending on which scenario applies to you.
...
### [Testing an Ansible Collection](testing_running_locally.md#id7)
...
### [Testing `ansible-core`](testing_running_locally.md#id8)
...
## [Commands](testing_running_locally.md#id9)
...
#### [Choosing a container](testing_running_locally.md#id12)
...
##### [Custom containers](testing_running_locally.md#id13)
...
##### [Configuration requirements](testing_running_locally.md#id16)
...
##### [Setup instructions](testing_running_locally.md#id17)

> **Note:**
>
> If all WSL instances have been stopped, these changes will need to be re-applied.

1. Verify Docker Desktop is properly configured (see [Configuration requirements](testing_running_locally.md#configuration-requirements)).
...
5. Start a WSL instance and perform the following steps as `root`:
   ...
   1. Verify the `systemd` subsystem is not registered:
      ...
      1. Check for the `systemd` cgroup hierarchy with the following command:
         ...
         ```
      2. If any matches are found, re-check the [Configuration requirements](testing_running_locally.md#configuration-requirements) and follow the
         [Setup instructions](testing_running_locally.md#setup-instructions) again.
...
#### [Linux cgroup configuration](testing_running_locally.md#id18)
...
##### [Podman](testing_running_locally.md#id19)

When using Podman, you may need to stop existing Podman processes after following the [Linux cgroup configuration](testing_running_locally.md#linux-cgroup-configuration)
...
### [Remote virtual machines](testing_running_locally.md#id20)
...
### [Python virtual environments](testing_running_locally.md#id21)
...
### [Composite environment arguments](testing_running_locally.md#id22)
...
## [Additional Requirements](testing_running_locally.md#id23)
...
## [Environment variables](testing_running_locally.md#id24)
...
- Not exposed to the test environment unless enabled in `test/lib/ansible_test/_internal/util.py` in the `common_environment` function.
  ...
  > [Debugging modules](debugging.md#debugging-modules) instructions.

## [Interactive shell](testing_running_locally.md#id25)
...
## [Code coverage](testing_running_locally.md#id26)
...
[Testing Ansible](testing.md#developing-testing)). For new code local reports are needed.
