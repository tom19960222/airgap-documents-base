...
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/developing_collections_structure.html
fetched_at: 2026-07-28T01:00:46+00:00
---
...
- [Collection directories and files](developing_collections_structure.md#collection-directories-and-files)
  ...
  - [meta directory](developing_collections_structure.md#meta-directory)
...
Vars plugins in collections are not loaded automatically, and always require being explicitly enabled by using their fully qualified collection name. See [Enabling vars plugins](../plugins/vars.md#enable-vars) for details.
...
This ensures users do not need to add these requirements manually when building [Execution Environments](https://ansible.readthedocs.io/en/latest/getting_started_ee/index.html) containing your collection.
See the [collection-level metadata guide](https://ansible.readthedocs.io/projects/builder/en/stable/collection_metadata/#collection-level-metadata) for details.
