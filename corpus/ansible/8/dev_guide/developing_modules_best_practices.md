...
collection: ansible
version: "8"
title: "Conventions, tips, and pitfalls"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/developing_modules_best_practices.html
fetched_at: 2026-07-28T00:59:07+00:00
---
...
## [Scoping your module(s)](developing_modules_best_practices.md#id1)

Especially if you want to contribute your module(s) to an existing Ansible Collection, make sure each module includes enough logic and functionality, but not too much. If these guidelines seem confusing, consider [whether you really need to write a module](developing_modules.md#module-dev-should-you) at all.
...
## [Designing module interfaces](developing_modules_best_practices.md#id2)
...
## [General guidelines & tips](developing_modules_best_practices.md#id3)
...
## [Functions and Methods](developing_modules_best_practices.md#id4)
...
## [Python tips](developing_modules_best_practices.md#id5)
...
## [Importing and using shared code](developing_modules_best_practices.md#id6)

- Use shared code whenever possible - don’t reinvent the wheel. Ansible offers the `AnsibleModule` common Python code, plus [utilities](developing_module_utilities.md#developing-module-utilities) for many common use cases and patterns. You can also create documentation fragments for docs that apply to multiple modules.
...
And document the dependency in the `requirements` section of your module’s [DOCUMENTATION block](developing_modules_documenting.md#documentation-block).

## [Handling module failures](developing_modules_best_practices.md#id7)
...
## [Handling exceptions (bugs) gracefully](developing_modules_best_practices.md#id8)
...
## [Creating correct and informative module output](developing_modules_best_practices.md#id9)
...
- Enable your return values to be serialized as JSON with Python’s standard [JSON encoder and decoder](https://docs.python.org/3/library/json.html) library. Basic python types (strings, int, dicts, lists, and so on) are serializable.
...
## [Following Ansible conventions](developing_modules_best_practices.md#id10)
...
- Return facts from `*_facts` modules in the `ansible_facts` field of the [result dictionary](../reference_appendices/common_return_values.md#common-return-values) so other modules can access them.
...
## [Module Security](developing_modules_best_practices.md#id11)
