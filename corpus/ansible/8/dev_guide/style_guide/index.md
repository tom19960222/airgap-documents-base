...
collection: ansible
version: "8"
title: "Ansible documentation style guide"
source_url: https://docs.ansible.com/projects/ansible/8/dev_guide/style_guide/index.html
...
- [Linguistic guidelines](index.md#linguistic-guidelines)

  - [Stylistic cheat-sheet](index.md#stylistic-cheat-sheet)
  - [Header case](index.md#header-case)
  - [Avoid using Latin phrases](index.md#avoid-using-latin-phrases)
- [reStructuredText guidelines](index.md#restructuredtext-guidelines)

  - [Header notation](index.md#header-notation)
  - [Syntax highlighting - Pygments](index.md#syntax-highlighting-pygments)
  - [Internal navigation](index.md#internal-navigation)

    - [Adding anchors](index.md#adding-anchors)
    - [Adding internal links](index.md#adding-internal-links)
    - [Adding links to modules and plugins](index.md#adding-links-to-modules-and-plugins)
    - [Adding local TOCs](index.md#adding-local-tocs)
- [Accessibility guidelines](index.md#accessibility-guidelines)

  - [Accessibility resources](index.md#accessibility-resources)
- [More resources](index.md#more-resources)

## [Linguistic guidelines](index.md#id2)
...
### [Stylistic cheat-sheet](index.md#id3)
...
## [reStructuredText guidelines](index.md#id6)
...
### [Header notation](index.md#id7)

[Section headers in reStructuredText](https://www.sphinx-doc.org/en/master/usage/restructuredtext/basics.html#sections)
...
### [Syntax highlighting - Pygments](index.md#id8)

The Ansible documentation supports a range of [Pygments lexers](https://pygments.org/)
for [syntax highlighting](https://www.sphinx-doc.org/en/master/usage/restructuredtext/directives.html#code-examples) to make our code examples look good. Each code-block must be correctly indented and surrounded by blank lines.
...
### [Internal navigation](index.md#id9)

[Anchors (also called labels) and links](https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#ref-role)
...
> **Note:**
>
> Avoid raw URLs. RST and sphinx allow :`https://my.example.com`, but this is unhelpful for those using screen readers. `:ref:` links automatically pick up the header from the anchor, but for external links, always use the :`` link title <link-url>`_ `` format.

#### [Adding anchors](index.md#id10)
...
#### [Adding internal links](index.md#id11)
...
#### [Adding links to modules and plugins](index.md#id12)
...
displays as [ansible.builtin.first_found lookup plugin](../../collections/ansible/builtin/first_found_lookup.md#ansible-collections-ansible-builtin-first-found-lookup).
...
#### [Adding local TOCs](index.md#id13)

The page you’re reading includes a [local TOC](https://docutils.sourceforge.io/docs/ref/rst/directives.html#table-of-contents).
...
## [Accessibility guidelines](index.md#id14)
...
Links and hypertext
:   URLs and cross-reference links have descriptive text that conveys information about the content of the linked target. See [Internal navigation](index.md#style-links) for how to format links.
...
### [Accessibility resources](index.md#id15)

Use the following resources to help test your documentation changes:

- [axe DevTools browser extension](https://chrome.google.com/webstore/detail/axe-devtools-web-accessib/lhdoppojpmngadmnindnejefpokejbdd?hl=en-US&_ga=2.98933278.1490638154.1645821120-953800914.1645821120) - Highlights accessibility issues on a website page.
- [WAVE browser extension](https://wave.webaim.org/extension/) from WebAIM - another accessibility tester.
- [Orca screen reader](https://help.gnome.org/users/orca/stable/) - Common tool used by people with vision impairments.
- [color filter](https://www.toptal.com/designers/colorfilter/) - For color-blind testing.

## [More resources](index.md#id16)

These pages offer more help with grammatical, stylistic, and technical rules for documentation.

- [Basic rules](basic_rules.md)
- [Voice Style](voice_style.md)
- [Trademark Usage](trademarks.md)
- [Grammar and Punctuation](grammar_punctuation.md)
- [Spelling - Word Usage - Common Words and Phrases to Use and Avoid](spelling_word_choice.md)
- [Preferred terminology](preferred_terms.md)
- [Writing documentation so search can find it](search_hints.md)
- [Resources](resources.md)

> **See also:**
>
> [Contributing to the Ansible Documentation](../../community/documentation_contributions.md#community-documentation-contributions)
> :   How to contribute to the Ansible documentation
>
> [Testing the documentation locally](../../community/documentation_contributions.md#testing-documentation-locally)
