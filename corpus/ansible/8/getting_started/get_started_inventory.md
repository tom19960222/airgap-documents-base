...
source_url: https://docs.ansible.com/projects/ansible/8/getting_started/get_started_inventory.html
...
3. Add a new group for your hosts then specify the IP address or fully qualified domain name (FQDN) of each managed node with the `ansible_host` field.
...
4. Verify your inventory.
   ...
   ```
5. Ping the managed nodes in your inventory.
...
Now that you know how to build an inventory, continue by [learning how to create a playbook](get_started_playbook.md#get-started-playbook).
...
>
> [Adding variables to inventory](../inventory_guide/intro_inventory.md#variables-in-inventory)
> :   Find out more about inventory variables and their syntax.
>
> [Ansible Vault](../vault_guide/vault.md#vault)
