...
source_url: https://docs.ansible.com/projects/ansible/8/inventory_guide/connection_details.html
fetched_at: 2026-07-28T00:58:29+00:00
---
...
> **See also:**
>
> [ssh_connection](https://docs.ansible.com/ansible/7/collections/ansible/builtin/ssh_connection.html#ssh-connection "(in Ansible v7)")
...
By default, Ansible assumes you are using SSH keys to connect to remote machines. SSH keys are encouraged, but you can use password authentication if needed with the `--ask-pass` option. If you need to provide a password for [privilege escalation](../playbook_guide/playbooks_privilege_escalation.md#become) (sudo, pbrun, and so on), use `--ask-become-pass`.
