...
source_url: https://docs.ansible.com/projects/ansible/8/plugins/strategy.html
...
Strategy plugins control the flow of play execution by handling task and host scheduling. For more information on using strategy plugins and other ways to control execution order, see [Controlling playbook execution: strategies and more](../playbook_guide/playbooks_strategies.md#playbooks-strategies).
...
You can also specify the strategy plugin in the play with the [strategy keyword](../reference_appendices/playbooks_keywords.md#playbook-keywords) in a play:
