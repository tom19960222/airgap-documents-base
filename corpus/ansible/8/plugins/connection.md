...
source_url: https://docs.ansible.com/projects/ansible/8/plugins/connection.html
fetched_at: 2026-07-28T01:00:14+00:00
---
# Connection plugins
...
You can set the connection plugin globally with [configuration](../reference_appendices/config.md#ansible-configuration-settings), at the command line (`-c`, `--connection`), as a [keyword](../reference_appendices/playbooks_keywords.md#playbook-keywords) in your play, or by setting a [variable](../inventory_guide/intro_inventory.md#behavioral-parameters), most often in your inventory.
...
[ansible_host](../playbook_guide/playbooks_vars_facts.md#magic-variables-and-hostvars)
:   The name of the host to connect to, if different from the [inventory](../inventory_guide/intro_inventory.md#intro-inventory) hostname.

[ansible_port](../reference_appendices/faq.md#faq-setting-users-and-ports)
:   The ssh port number, for [ssh](../collections/ansible/builtin/ssh_connection.md#ssh-connection) and [paramiko_ssh](../collections/ansible/builtin/paramiko_ssh_connection.md#paramiko-connection) it defaults to 22.
