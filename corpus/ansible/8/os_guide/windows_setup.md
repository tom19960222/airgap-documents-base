...
source_url: https://docs.ansible.com/projects/ansible/8/os_guide/windows_setup.html
fetched_at: 2026-07-28T00:58:45+00:00
---
...
## [Host Requirements](windows_setup.md#id2)
...
### [Upgrading PowerShell and .NET Framework](windows_setup.md#id3)
...
### [WinRM Memory Hotfix](windows_setup.md#id4)
...
## [WinRM Setup](windows_setup.md#id5)
...
### [WinRM Listener](windows_setup.md#id6)
...
#### [Setup WinRM Listener](windows_setup.md#id7)
...
- Using PowerShell to create a listener with a specific configuration. This can be done by running the following PowerShell commands:
  ...
  [New-WSManInstance](https://docs.microsoft.com/en-us/powershell/module/microsoft.wsman.management/new-wsmaninstance?view=powershell-5.1) documentation.

> **Note:**
>
> When creating an HTTPS listener, you must create and store a certificate in the `LocalMachine\My` certificate store.

#### [Delete WinRM Listener](windows_setup.md#id8)
...
### [WinRM Service Options](windows_setup.md#id9)
...
### [Common WinRM Issues](windows_setup.md#id10)
...
#### [HTTP 401/Credentials Rejected](windows_setup.md#id11)
...
#### [HTTP 500 Error](windows_setup.md#id12)
...
#### [Timeout Errors](windows_setup.md#id13)
...
#### [Connection Refused Errors](windows_setup.md#id14)
...
#### [Failure to Load Builtin Modules](windows_setup.md#id15)
...
## [Windows SSH Setup](windows_setup.md#id16)
...
### [Installing OpenSSH using Windows Settings](windows_setup.md#id17)
...
### [Installing Win32-OpenSSH](windows_setup.md#id18)

To install the [Win32-OpenSSH](https://github.com/PowerShell/Win32-OpenSSH) service for use with
...
### [Configuring the Win32-OpenSSH shell](windows_setup.md#id19)
...
### [Win32-OpenSSH Authentication](windows_setup.md#id20)
...
### [Configuring Ansible for SSH on Windows](windows_setup.md#id21)
...
### [Known issues with SSH on Windows](windows_setup.md#id22)
