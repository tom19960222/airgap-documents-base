...
source_url: https://docs.ansible.com/projects/ansible/8/os_guide/windows_dsc.html
fetched_at: 2026-07-28T00:58:48+00:00
---
...
- [How to Use DSC?](windows_dsc.md#how-to-use-dsc)
  ...
  - [Property Types](windows_dsc.md#property-types)

    - [PSCredential](windows_dsc.md#pscredential)
    - [CimInstance Type](windows_dsc.md#ciminstance-type)
    - [HashTable Type](windows_dsc.md#hashtable-type)
    - [Arrays](windows_dsc.md#arrays)
    - [DateTime](windows_dsc.md#datetime)
  - [Run As Another User](windows_dsc.md#run-as-another-user)
- [Custom DSC Resources](windows_dsc.md#custom-dsc-resources)

  - [Finding Custom DSC Resources](windows_dsc.md#finding-custom-dsc-resources)
  - [Installing a Custom Resource](windows_dsc.md#installing-a-custom-resource)
- [Examples](windows_dsc.md#examples)

  - [Extract a zip file](windows_dsc.md#extract-a-zip-file)
  - [Create a directory](windows_dsc.md#create-a-directory)
  - [Interact with Azure](windows_dsc.md#interact-with-azure)
  - [Setup IIS Website](windows_dsc.md#setup-iis-website)

## [What is Desired State Configuration?](windows_dsc.md#id1)
...
## [Host Requirements](windows_dsc.md#id2)
...
## [Why Use DSC?](windows_dsc.md#id3)

DSC and Ansible modules have a common goal which is to define and ensure the state of a
resource. Because of
this, resources like the DSC [File resource](https://docs.microsoft.com/en-us/powershell/scripting/dsc/reference/resources/windows/fileresource)
...
## [How to Use DSC?](windows_dsc.md#id4)
...
found at [resources](https://docs.microsoft.com/en-us/powershell/scripting/dsc/resources/resources).

Using the [Registry](https://docs.microsoft.com/en-us/powershell/scripting/dsc/reference/resources/windows/registryresource)
...
### [Property Types](windows_dsc.md#id5)
...
#### [PSCredential](windows_dsc.md#id6)
...
#### [CimInstance Type](windows_dsc.md#id7)
...
[MSFT_xWebAuthenticationInformation](https://github.com/dsccommunity/xWebAdministration/blob/master/source/DSCResources/MSFT_xWebSite/MSFT_xWebSite.schema.mof).
...
#### [HashTable Type](windows_dsc.md#id8)
...
#### [DateTime](windows_dsc.md#id10)

A `[DateTime]` object is a DateTime string representing the date and time in
the [ISO 8601](https://www.w3.org/TR/NOTE-datetime) date time format. The
...
### [Run As Another User](windows_dsc.md#id11)
...
## [Custom DSC Resources](windows_dsc.md#id12)
...
### [Finding Custom DSC Resources](windows_dsc.md#id13)

You can use the
[PSGallery](https://www.powershellgallery.com/) to find custom resources, along with documentation on how to install them on a Windows host.
...
### [Installing a Custom Resource](windows_dsc.md#id14)
...
## [Examples](windows_dsc.md#id15)

### [Extract a zip file](windows_dsc.md#id16)
...
### [Create a directory](windows_dsc.md#id17)
...
### [Interact with Azure](windows_dsc.md#id18)
...
### [Setup IIS Website](windows_dsc.md#id19)
...
> **See also:**
>
> [Ansible playbooks](../playbook_guide/playbooks_intro.md#playbooks-intro)
