...
source_url: https://docs.ansible.com/projects/ansible/8/os_guide/windows_winrm.html
fetched_at: 2026-07-28T00:58:47+00:00
---
...
- [WinRM authentication options](windows_winrm.md#winrm-authentication-options)
  ...
  - [Basic](windows_winrm.md#basic)
  - [Certificate](windows_winrm.md#certificate)
  - [NTLM](windows_winrm.md#ntlm)
  - [Kerberos](windows_winrm.md#kerberos)
  - [CredSSP](windows_winrm.md#credssp)
...
## [What is WinRM?](windows_winrm.md#id2)
...
Ansible uses the [pywinrm](https://github.com/diyan/pywinrm) package to
...
## [WinRM authentication options](windows_winrm.md#id3)
...
### [Certificate](windows_winrm.md#id5)
...
> **Note:**
>
> Encrypted private keys cannot be used as the urllib3 library that
> is used by Ansible for WinRM does not support this functionality.

> **Note:**
>
> For enabling certificate authentication with a TLS 1.3 connection, Python 3.8+, 3.7.1, or 3.6.7 and Python packages urllib3==2.0.7 or newer are required.
...
see the [Active Directory Certificate Services documentation](https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc732625(v=ws.11)).
...
> **Note:**
>
> To convert the PFX file to a private key that pywinrm can use, run
...
> **Note:**
>
> If using ADCS to generate the certificate, then the issuing
...
- If the default kerberos tooling has been replaced or modified (some IdM solutions may do this), this may cause issues when installing or upgrading the Python Kerberos library. As of the time of this writing, this library is called `pykerberos` and is known to work with both MIT and Heimdal Kerberos libraries. To resolve `pykerberos` installation issues, ensure the system dependencies for Kerberos have been met (see: [Installing the Kerberos Library](windows_winrm.md#installing-the-kerberos-library)), remove any custom Kerberos tooling paths from the PATH environment variable, and retry the installation of Python Kerberos library package.

### [CredSSP](windows_winrm.md#id8)
...
See [TLS 1.2 Support](windows_winrm.md#winrm-tls12) for more information on how to enable TLS 1.2 on the
Windows host.
...
## [Non-Administrator Accounts](windows_winrm.md#id9)
...
## [WinRM Encryption](windows_winrm.md#id10)
...
## [Inventory Options](windows_winrm.md#id11)
...
## [IPv6 Addresses](windows_winrm.md#id12)
...
using the [ipaddress](https://docs.python.org/3/library/ipaddress.html)
...
> **Note:**
>
> The ipaddress library is only included by default in Python 3.x. To
> use IPv6 addresses in Python 2.7, make sure to run `pip install ipaddress` which installs
> a backported package.

## [HTTPS Certificate Validation](windows_winrm.md#id13)
...
## [TLS 1.2 Support](windows_winrm.md#id14)
...
to manage these settings is [IIS Crypto](https://www.nartac.com/Products/IISCrypto/)
from Nartac Software.

## [WinRM limitations](windows_winrm.md#id15)
