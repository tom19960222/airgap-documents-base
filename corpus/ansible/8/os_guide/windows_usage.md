...
collection: ansible
version: "8"
title: "Using Ansible and Windows"
source_url: https://docs.ansible.com/projects/ansible/8/os_guide/windows_usage.html
fetched_at: 2026-07-28T00:58:46+00:00
---
...
- [Use Cases](windows_usage.md#use-cases)
  ...
  - [Installing Software](windows_usage.md#installing-software)
  - [Installing Updates](windows_usage.md#installing-updates)
  - [Set Up Users and Groups](windows_usage.md#set-up-users-and-groups)

    - [Local](windows_usage.md#local)
    - [Domain](windows_usage.md#domain)
  - [Running Commands](windows_usage.md#running-commands)

    - [Choosing Command or Shell](windows_usage.md#choosing-command-or-shell)
    - [Argument Rules](windows_usage.md#argument-rules)
  - [Creating and Running a Scheduled Task](windows_usage.md#creating-and-running-a-scheduled-task)
- [Path Formatting for Windows](windows_usage.md#path-formatting-for-windows)

  - [YAML Style](windows_usage.md#yaml-style)
  - [Legacy key=value Style](windows_usage.md#legacy-key-value-style)
- [Limitations](windows_usage.md#limitations)
- [Developing Windows Modules](windows_usage.md#developing-windows-modules)

## [Use Cases](windows_usage.md#id1)
...
### [Installing Software](windows_usage.md#id2)
...
- Using the `win_chocolatey` module. This sources the program data from the default
  public [Chocolatey](https://chocolatey.org/) repository. Internal repositories can
...
### [Installing Updates](windows_usage.md#id3)
...
### [Running Commands](windows_usage.md#id7)
...
#### [Choosing Command or Shell](windows_usage.md#id8)
...
#### [Argument Rules](windows_usage.md#id9)
...
### [Creating and Running a Scheduled Task](windows_usage.md#id10)
...
## [Path Formatting for Windows](windows_usage.md#id11)
...
### [YAML Style](windows_usage.md#id12)
...
### [Legacy key=value Style](windows_usage.md#id13)
...
## [Limitations](windows_usage.md#id14)
...
## [Developing Windows Modules](windows_usage.md#id15)
...
[Windows module development walkthrough](../dev_guide/developing_modules_general_windows.md#developing-modules-general-windows) for more information.
