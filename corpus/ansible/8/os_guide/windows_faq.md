...
source_url: https://docs.ansible.com/projects/ansible/8/os_guide/windows_faq.html
fetched_at: 2026-07-28T00:58:49+00:00
---
...
> **Note:**
>
> This document covers questions about managing Microsoft Windows servers with Ansible.
> For questions about Ansible Core, please see the
> [general FAQ page](../reference_appendices/faq.md#ansible-faq).
...
1 - See the [Server 2008 FAQ](windows_faq.md#windows-faq-server2008) entry for more details.

Ansible also has minimum PowerShell version requirements - please see
[Setting up a Windows Host](windows_setup.md#windows-setup) for the latest information.
...
> **Note:**
>
> The Windows Subsystem for Linux is not supported by Ansible and
...
from the SSH implementation; consult the [Windows Remote Management](windows_winrm.md#windows-winrm) documentation for
more information.

Ansible 2.8 has added an experimental option to use the SSH connection plugin,
which uses SSH keys for authentication, for Windows servers. See [this question](windows_faq.md#windows-faq-ssh)
...
- Use `become`, which runs a command as it would when run locally. This will
  ...
  under WinRM when `become` is used. See the [Understanding privilege escalation: become](../playbook_guide/playbooks_privilege_escalation.md#become) documentation for more
  information.
...
See [Understanding privilege escalation: become](../playbook_guide/playbooks_privilege_escalation.md#become) more info on how to use become. The limitations section at
[Windows Remote Management](windows_winrm.md#windows-winrm) has more details around WinRM limitations.

## This program won’t install on Windows with Ansible

See [this question](windows_faq.md#windows-faq-winrm) for more information about WinRM limitations.
...
can be found [here](https://docs.ansible.com/ansible/2.9/modules/list_of_windows_modules.html#windows-modules "(in Ansible v2.9)").
...
Ansible Windows modules exist in the [Ansible.Windows](../collections/ansible/windows/index.md#plugins-in-ansible-windows), [Community.Windows](../collections/community/windows/index.md#plugins-in-community-windows), and [Chocolatey.Chocolatey](../collections/chocolatey/chocolatey/index.md#plugins-in-chocolatey-chocolatey) collections.
...
Ansible 2.8 has added an experimental option to use the SSH connection plugin
to manage Windows hosts. To connect to Windows hosts over SSH, you must install and configure the [Win32-OpenSSH](https://github.com/PowerShell/Win32-OpenSSH)
...
fixed in every release. It is highly recommend you [install](https://github.com/PowerShell/Win32-OpenSSH/wiki/Install-Win32-OpenSSH) the latest release
...
Windows hosts using [Windows Remote Management](windows_winrm.md#windows-winrm). If your Ansible output indicates that
...
See HTTP 401/Credentials Rejected at [Setting up a Windows Host](windows_setup.md#windows-setup) for a more detailed
...
> **See also:**
>
> [Windows Guides](https://docs.ansible.com/ansible/6/user_guide/windows.html#windows "(in Ansible v6)")
