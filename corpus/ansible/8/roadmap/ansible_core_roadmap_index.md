...
collection: ansible
version: "8"
title: "ansible-core Roadmaps"
source_url: https://docs.ansible.com/projects/ansible/8/roadmap/ansible_core_roadmap_index.html
...
- Edit the agenda of an [Core Team Meeting](https://github.com/ansible/community/blob/main/meetings/README.md) (preferred)
- Post on the `#ansible-devel` chat channel (using Matrix at ansible.im or using IRC at [irc.libera.chat](https://libera.chat/))
- Email the ansible-devel list

See [Ansible communication channels](../community/communication.md#communication) for details on how to join and use the email lists and chat channels.

ansible-core Roadmaps

- [Ansible-core 2.15](ROADMAP_2_15.md)
- [Ansible-core 2.14](ROADMAP_2_14.md)
- [Ansible-core 2.13](ROADMAP_2_13.md)
- [Ansible-core 2.12](ROADMAP_2_12.md)
- [Ansible-core 2.11](ROADMAP_2_11.md)
- [Ansible-base 2.10](ROADMAP_2_10.md)
