...
source_url: https://docs.ansible.com/projects/ansible/8/roadmap/ansible_roadmap_index.html
fetched_at: 2026-07-28T00:58:09+00:00
---
# Ansible Roadmap
...
- Edit the agenda of an [Ansible Community Meeting](https://github.com/ansible/community/issues/539) (preferred)
- Post on the `#ansible-community` chat channel (using Matrix at ansible.im or using IRC at [irc.libera.chat](https://libera.chat/))

See [Ansible communication channels](../community/communication.md#communication) for details on how to join and use our chat channels.

Ansible Release Roadmaps

- [Ansible project 8.0](COLLECTIONS_8.md)
- [Ansible project 7.0](COLLECTIONS_7.md)
- [Ansible project 6.0](COLLECTIONS_6.md)
- [Ansible project 5.0](COLLECTIONS_5.md)
- [Ansible project 4.0](COLLECTIONS_4.md)
- [Ansible project 3.0](COLLECTIONS_3_0.md)
- [Ansible project 2.10](COLLECTIONS_2_10.md)
- [Older Roadmaps](old_roadmap_index.md)
