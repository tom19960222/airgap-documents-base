...
collection: ansible
version: "8"
title: "Ansible project 8.0"
source_url: https://docs.ansible.com/projects/ansible/8/roadmap/COLLECTIONS_8.html
fetched_at: 2026-07-28T00:59:34+00:00
---
# Ansible project 8.0
...
- [Release schedule](COLLECTIONS_8.md#release-schedule)
- [Ansible minor releases](COLLECTIONS_8.md#ansible-minor-releases)

## [Release schedule](COLLECTIONS_8.md#id7)
...
2023-05-16:
:   Ansible-8.0.0 beta1 – feature freeze [[1]](COLLECTIONS_8.md#id4) (weekly beta releases; collection owners and interested users should test for bugs).

2023-05-23:
:   Ansible-8.0.0 rc1 [[2]](COLLECTIONS_8.md#id5) [[3]](COLLECTIONS_8.md#id6) (weekly release candidates as needed; test and alert us to any blocker bugs). Blocker bugs will slip release.
...
## [Ansible minor releases](COLLECTIONS_8.md#id8)
...
> **Note:**
>
> Minor releases will stop when Ansible-9 is released. See the [Release and Maintenance Page](../reference_appendices/release_and_maintenance.md#release-and-maintenance) for more information.
