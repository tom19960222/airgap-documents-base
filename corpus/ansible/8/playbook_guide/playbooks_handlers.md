...
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_handlers.html
fetched_at: 2026-07-28T00:59:58+00:00
---
...
## [Meta tasks as handlers](playbooks_handlers.md#id8)

Since Ansible 2.14 [meta tasks](../collections/ansible/builtin/meta_module.md#ansible-collections-ansible-builtin-meta-module) are allowed to be used and notified as handlers. Note that however `flush_handlers` cannot be used as a handler to prevent unexpected behavior.

## [Limitations](playbooks_handlers.md#id9)
