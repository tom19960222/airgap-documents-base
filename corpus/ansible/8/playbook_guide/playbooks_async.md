...
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_async.html
fetched_at: 2026-07-28T01:00:09+00:00
---
...
You can execute long-running operations in the background with [ad hoc tasks](../command_guide/intro_adhoc.md#intro-adhoc). For example, to execute `long_running_operation` asynchronously in the background, with a timeout (`-B`) of 3600 seconds, and without polling (`-P`):
