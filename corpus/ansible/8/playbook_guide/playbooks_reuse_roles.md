...
version: "8"
title: "Roles"
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_reuse_roles.html
fetched_at: 2026-07-28T01:00:01+00:00
---
# Roles
...
When you add a [tag](playbooks_tags.md#tags) to an `include_role` task, Ansible applies the tag only to the include itself. This means you can pass `--tags` to run only selected tasks from the role, if those tasks themselves have the same tag as the include statement. See [Selectively running tagged tasks in reusable files](playbooks_tags.md#selective-reuse) for details.
...
If you write a custom module (see [Should you develop a module?](../dev_guide/developing_modules.md#developing-modules)) or a plugin (see [Developing plugins](../dev_guide/developing_plugins.md#developing-plugins)), you might wish to distribute it as part of a role. For example, if you write a module that helps configure your company’s internal software, and you want other people in your organization to use this module, but do not want to tell everyone how to configure their Ansible library path, you can include the module in your internal_config role.
