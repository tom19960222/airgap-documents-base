...
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_startnstep.html
fetched_at: 2026-07-28T01:00:08+00:00
---
...
In this example, Ansible starts executing your playbook at a task named “install packages”. This feature does not work with tasks inside dynamically re-used roles or tasks (`include_*`), see [Comparing includes and imports: dynamic and static reuse](playbooks_reuse.md#dynamic-vs-static).
...
>
> [Debugging tasks](playbooks_debugger.md#playbook-debugger)
