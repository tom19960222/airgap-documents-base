...
collection: ansible
version: "8"
title: "Search paths in Ansible"
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbook_pathing.html
fetched_at: 2026-07-28T03:00:27+00:00
---
...
- [Config paths](playbook_pathing.md#config-paths)
- [Task paths](playbook_pathing.md#task-paths)

  - [Resolving local relative paths](playbook_pathing.md#resolving-local-relative-paths)

## [Config paths](playbook_pathing.md#id1)
...
## [Task paths](playbook_pathing.md#id2)

Relative paths used in a task typically refer to remote files and directories on the managed nodes. However, paths passed to lookup plugins and some paths used in action plugins such as the “src” path for the [template](../collections/ansible/builtin/template_module.md#ansible-collections-ansible-builtin-template-module) and [copy](../collections/ansible/builtin/copy_module.md#ansible-collections-ansible-builtin-copy-module) modules refer to local files and directories on the control node.

### [Resolving local relative paths](playbook_pathing.md#id3)
