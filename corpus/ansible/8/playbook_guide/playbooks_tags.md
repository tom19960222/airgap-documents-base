...
version: "8"
title: "Tags"
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_tags.html
fetched_at: 2026-07-28T01:00:07+00:00
---
# Tags
...
- [Adding tags with the tags keyword](playbooks_tags.md#adding-tags-with-the-tags-keyword)
  ...
  - [Adding tags to individual tasks](playbooks_tags.md#adding-tags-to-individual-tasks)
  - [Adding tags to includes](playbooks_tags.md#adding-tags-to-includes)
  - [Tag inheritance: adding tags to multiple tasks](playbooks_tags.md#tag-inheritance-adding-tags-to-multiple-tasks)

    - [Adding tags to blocks](playbooks_tags.md#adding-tags-to-blocks)
    - [Adding tags to plays](playbooks_tags.md#adding-tags-to-plays)
    - [Adding tags to roles](playbooks_tags.md#adding-tags-to-roles)
    - [Adding tags to imports](playbooks_tags.md#adding-tags-to-imports)
    - [Tag inheritance for includes: blocks and the `apply` keyword](playbooks_tags.md#tag-inheritance-for-includes-blocks-and-the-apply-keyword)
...
- [Selecting or skipping tags when you run a playbook](playbooks_tags.md#selecting-or-skipping-tags-when-you-run-a-playbook)
  ...
  - [Previewing the results of using tags](playbooks_tags.md#previewing-the-results-of-using-tags)
  - [Selectively running tagged tasks in reusable files](playbooks_tags.md#selectively-running-tagged-tasks-in-reusable-files)
  - [Configuring tags globally](playbooks_tags.md#configuring-tags-globally)

## [Adding tags with the tags keyword](playbooks_tags.md#id2)

You can add tags to a single task or include. You can also add tags to multiple tasks by defining them at the level of a block, play, role, or import. The keyword `tags` addresses all these use cases. The `tags` keyword always defines tags and adds them to tasks; it does not select or skip tasks for execution. You can only select or skip tasks based on tags at the command line when you run a playbook. See [Selecting or skipping tags when you run a playbook](playbooks_tags.md#using-tags) for more details.

### [Adding tags to individual tasks](playbooks_tags.md#id3)
...
#### [Adding tags to blocks](playbooks_tags.md#id6)

If you want to apply a tag to many, but not all, of the tasks in your play, use a [block](playbooks_blocks.md#playbooks-blocks) and define the tags at that level. For example, we could edit the NTP example shown above to use a block:
...
#### [Adding tags to plays](playbooks_tags.md#id7)
...
#### [Adding tags to roles](playbooks_tags.md#id8)
...
#### [Adding tags to imports](playbooks_tags.md#id9)
...
#### [Tag inheritance for includes: blocks and the `apply` keyword](playbooks_tags.md#id10)

By default, Ansible does not apply [tag inheritance](playbooks_tags.md#tag-inheritance) to dynamic reuse with `include_role` and `include_tasks`. If you add tags to an include, they apply only to the include itself, not to any tasks in the included file or role. This allows you to execute selected tasks within a role or task file - see [Selectively running tagged tasks in reusable files](playbooks_tags.md#selective-reuse) when you run your playbook.
...
## [Special tags: always and never](playbooks_tags.md#id11)
...
## [Selecting or skipping tags when you run a playbook](playbooks_tags.md#id12)

Once you have added tags to your tasks, includes, blocks, plays, roles, and imports, you can selectively execute or skip tasks based on their tags when you run [ansible-playbook](../cli/ansible-playbook.md#ansible-playbook). Ansible runs or skips all tasks with tags that match the tags you pass at the command line. If you have added a tag at the block or play level, with `roles`, or with an import, that tag applies to every task within the block, play, role, or imported role or file. If you have a role with lots of tags and you want to call subsets of the role at different times, either [use it with dynamic includes](playbooks_tags.md#selective-reuse), or split the role into multiple roles.

[ansible-playbook](../cli/ansible-playbook.md#ansible-playbook) offers five tag-related command-line options:
...
### [Previewing the results of using tags](playbooks_tags.md#id13)

When you run a role or playbook, you might not know or remember which tasks have which tags, or which tags exist at all. Ansible offers two command-line flags for [ansible-playbook](../cli/ansible-playbook.md#ansible-playbook) that help you manage tagged playbooks:
...
These command-line flags have one limitation: they cannot show tags or tasks within dynamically included files or roles. See [Comparing includes and imports: dynamic and static reuse](playbooks_reuse.md#dynamic-vs-static) for more information on differences between static imports and dynamic includes.

### [Selectively running tagged tasks in reusable files](playbooks_tags.md#id14)
...
### [Configuring tags globally](playbooks_tags.md#id15)

If you run or skip certain tags by default, you can use the [TAGS_RUN](../reference_appendices/config.md#tags-run) and [TAGS_SKIP](../reference_appendices/config.md#tags-skip) options in Ansible configuration to set those defaults.
