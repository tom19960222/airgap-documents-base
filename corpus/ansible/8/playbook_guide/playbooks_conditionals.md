...
version: "8"
title: "Conditionals"
source_url: https://docs.ansible.com/projects/ansible/8/playbook_guide/playbooks_conditionals.html
fetched_at: 2026-07-28T00:59:57+00:00
---
# Conditionals
...
- [Basic conditionals with `when`](playbooks_conditionals.md#basic-conditionals-with-when)
  ...
  - [Conditionals with reuse](playbooks_conditionals.md#conditionals-with-reuse)
...
### [Conditionals based on ansible_facts](playbooks_conditionals.md#id4)
...
### [Conditions based on registered variables](playbooks_conditionals.md#id5)
...
### [Conditionals based on variables](playbooks_conditionals.md#id6)
...
### [Using conditionals in loops](playbooks_conditionals.md#id7)
...
### [Loading custom facts](playbooks_conditionals.md#id8)

You can provide your own facts, as described in [Should you develop a module?](../dev_guide/developing_modules.md#developing-modules). To run them, just make a call to your own custom fact gathering module at the top of your list of tasks, and the variables returned there will be accessible for future tasks:
...
### [Conditionals with reuse](playbooks_conditionals.md#id9)

You can use conditionals with reusable tasks files, playbooks, or roles. Ansible executes these conditional statements differently for dynamic reuse (includes) and static reuse (imports). See [Re-using Ansible artifacts](playbooks_reuse.md#playbooks-reuse) for more information on reuse in Ansible.

#### [Conditionals with imports](playbooks_conditionals.md#id10)
...
#### [Conditionals with roles](playbooks_conditionals.md#id12)
...
### [Selecting variables, files, or templates based on facts](playbooks_conditionals.md#id13)
...
#### [Selecting variables files based on facts](playbooks_conditionals.md#id14)
...
#### [Selecting files and templates based on facts](playbooks_conditionals.md#id15)
...
## [Debugging conditionals](playbooks_conditionals.md#id16)
...
## [Commonly-used facts](playbooks_conditionals.md#id17)

The following Ansible facts are frequently used in conditionals.

### [ansible_facts[‘distribution’]](playbooks_conditionals.md#id18)
...
### [ansible_facts[‘distribution_major_version’]](playbooks_conditionals.md#id19)

The major version of the operating system. For example, the value is 16 for Ubuntu 16.04.

### [ansible_facts[‘os_family’]](playbooks_conditionals.md#id20)
