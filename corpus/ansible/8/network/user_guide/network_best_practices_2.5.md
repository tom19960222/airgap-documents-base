...
source_url: https://docs.ansible.com/projects/ansible/8/network/user_guide/network_best_practices_2.5.html
fetched_at: 2026-07-28T00:59:27+00:00
---
...
- Basic understanding of Jinja2 templates. See [Templating (Jinja2)](../../playbook_guide/playbooks_templating.md#playbooks-templating) for more information.
...
In our example, the inventory file defines the groups `eos`, `ios`, `vyos` and a “group of groups” called `switches`. Further details about subgroups and inventory files can be found in the [Ansible inventory Group documentation](../../inventory_guide/intro_inventory.md#subgroups).
...
The “Vault” feature of Ansible allows you to keep sensitive data such as passwords or keys in encrypted files, rather than as plain text in your playbooks or roles. These vault files can then be distributed or placed in source control. See [Using encrypted variables and files](../../vault_guide/vault_using_encrypted_content.md#playbooks-vault) for more information.
...
For more information, see the [using become with network modules](../../playbook_guide/playbooks_privilege_escalation.md#become-network) guide.
...
To ensure we call the correct mode (`*_facts`) the task is conditionally run based on the group defined in the inventory file, for more information on the use of conditionals in Ansible Playbooks see [Basic conditionals with when](../../playbook_guide/playbooks_conditionals.md#the-when-statement).
...
For more information, see [Information about Ansible: magic variables](../../playbook_guide/playbooks_vars_facts.md#magic-variables-and-hostvars).
...
> - [How to build your inventory](../../inventory_guide/intro_inventory.md#intro-inventory)
> - [Keeping vaulted variables visible](../../tips_tricks/ansible_tips_tricks.md#tip-for-variables-and-vaults)
