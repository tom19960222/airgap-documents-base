...
collection: ansible
version: "8"
title: "VOSS Platform Options"
source_url: https://docs.ansible.com/projects/ansible/8/network/user_guide/platform_voss.html
fetched_at: 2026-07-28T01:01:13+00:00
---
# VOSS Platform Options

Extreme VOSS is part of the [community.network](https://galaxy.ansible.com/ui/repo/published/community/network) collection and only supports CLI connections today. This page offers details on how to
...
- [Using CLI in Ansible](platform_voss.md#using-cli-in-ansible)
  ...
  - [Example CLI `group_vars/voss.yml`](platform_voss.md#example-cli-group-vars-voss-yml)
  - [Example CLI task](platform_voss.md#example-cli-task)

## [Connections available](platform_voss.md#id2)
...
## [Using CLI in Ansible](platform_voss.md#id3)

### [Example CLI `group_vars/voss.yml`](platform_voss.md#id4)
...
### [Example CLI task](platform_voss.md#id5)
