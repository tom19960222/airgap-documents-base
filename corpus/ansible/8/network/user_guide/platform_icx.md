...
collection: ansible
version: "8"
title: "ICX Platform Options"
source_url: https://docs.ansible.com/projects/ansible/8/network/user_guide/platform_icx.html
fetched_at: 2026-07-28T01:01:05+00:00
---
# ICX Platform Options

ICX is part of the [community.network](https://galaxy.ansible.com/ui/repo/published/community/network) collection supports Enable Mode (Privilege Escalation). This page offers details on how to use Enable Mode on ICX in Ansible.

- [Connections available](platform_icx.md#connections-available)
- [Using CLI in Ansible](platform_icx.md#using-cli-in-ansible)

  - [Example CLI `group_vars/icx.yml`](platform_icx.md#example-cli-group-vars-icx-yml)
  - [Example CLI task](platform_icx.md#example-cli-task)

## [Connections available](platform_icx.md#id2)
...
## [Using CLI in Ansible](platform_icx.md#id3)

### [Example CLI `group_vars/icx.yml`](platform_icx.md#id4)
...
### [Example CLI task](platform_icx.md#id5)
