...
collection: ansible
version: "8"
title: "Working with command output and prompts in network modules"
source_url: https://docs.ansible.com/projects/ansible/8/network/user_guide/network_working_with_command_output.html
fetched_at: 2026-07-28T00:59:30+00:00
---
...
## [Conditionals in networking modules](network_working_with_command_output.md#id1)
...
the path
`(result[0].interfaces.Ethernet4.interfaceStatus)` is not equal to
...
## [Handling prompts in network modules](network_working_with_command_output.md#id2)

Network devices may require that you answer a prompt before performing a change on the device. Individual network modules such as [cisco.ios.ios_command](../../collections/cisco/ios/ios_command_module.md#ansible-collections-cisco-ios-ios-command-module) and [cisco.nxos.nxos_command](../../collections/cisco/nxos/nxos_command_module.md#ansible-collections-cisco-nxos-nxos-command-module) can handle this with a `prompt` parameter.
...
You can also use the [ansible.netcommon.cli_command](../../collections/ansible/netcommon/cli_command_module.md#ansible-collections-ansible-netcommon-cli-command-module) to handle multiple prompts.
