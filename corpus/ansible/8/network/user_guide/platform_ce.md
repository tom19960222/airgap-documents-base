...
source_url: https://docs.ansible.com/projects/ansible/8/network/user_guide/platform_ce.html
fetched_at: 2026-07-28T01:00:58+00:00
---
...
- [Using CLI in Ansible](platform_ce.md#using-cli-in-ansible)
  ...
  - [Example CLI inventory `[ce:vars]`](platform_ce.md#example-cli-inventory-ce-vars)
  - [Example CLI task](platform_ce.md#example-cli-task)
- [Using NETCONF in Ansible](platform_ce.md#using-netconf-in-ansible)

  - [Enabling NETCONF](platform_ce.md#enabling-netconf)
  - [Example NETCONF inventory `[ce:vars]`](platform_ce.md#example-netconf-inventory-ce-vars)
  - [Example NETCONF task](platform_ce.md#example-netconf-task)
- [Notes](platform_ce.md#notes)

  - [Modules that work with `ansible.netcommon.network_cli`](platform_ce.md#modules-that-work-with-ansible-netcommon-network-cli)
  - [Modules that work with `ansible.netcommon.netconf`](platform_ce.md#modules-that-work-with-ansible-netcommon-netconf)

## [Connections available](platform_ce.md#id1)
...
| Indirect Access | with a bastion (jump host) | with a bastion (jump host) |
...
## [Using CLI in Ansible](platform_ce.md#id2)

### [Example CLI inventory `[ce:vars]`](platform_ce.md#id3)
...
### [Example CLI task](platform_ce.md#id4)
...
## [Using NETCONF in Ansible](platform_ce.md#id5)

### [Enabling NETCONF](platform_ce.md#id6)
...
### [Example NETCONF inventory `[ce:vars]`](platform_ce.md#id7)
...
### [Example NETCONF task](platform_ce.md#id8)
...
## [Notes](platform_ce.md#id9)

### [Modules that work with `ansible.netcommon.network_cli`](platform_ce.md#id10)
...
### [Modules that work with `ansible.netcommon.netconf`](platform_ce.md#id11)
