...
source_url: https://docs.ansible.com/projects/ansible/8/network/getting_started/first_inventory.html
fetched_at: 2026-07-28T00:59:23+00:00
---
...
## [Basic inventory](first_inventory.md#id1)
...
## [Add variables to the inventory](first_inventory.md#id2)
...
## [Group variables within inventory](first_inventory.md#id3)
...
## [Variable syntax](first_inventory.md#id4)
...
## [Group inventory by platform](first_inventory.md#id5)
...
With the `-k` flag, you provide the SSH password(s) at the prompt. Alternatively, you can store SSH and other secrets and passwords securely in your group_vars files with `ansible-vault`. See [Protecting sensitive variables with ansible-vault](first_inventory.md#network-vault) for details.

## [Verifying the inventory](first_inventory.md#id6)

You can use the [ansible-inventory](../../cli/ansible-inventory.md#ansible-inventory) CLI command to display the inventory as Ansible sees it.
...
## [Protecting sensitive variables with `ansible-vault`](first_inventory.md#id7)
...
The [`--vault-id`](../../cli/ansible-playbook.md#cmdoption-ansible-playbook-vault-id) flag allows different vault passwords for different users or different levels of access. The output includes the user name `my_user` from your `ansible-vault` command and uses the YAML syntax `key: value`:
...
For more details on building inventory files, see [the introduction to inventory](../../inventory_guide/intro_inventory.md#intro-inventory); for more details on ansible-vault, see [the full Ansible Vault documentation](../../vault_guide/vault.md#vault).
