...
source_url: https://docs.ansible.com/projects/ansible/8/network/getting_started/basic_concepts.html
fetched_at: 2026-07-28T00:59:21+00:00
---
# Basic Concepts
...
To learn more about inventory, see [the Working with Inventory](../../inventory_guide/intro_inventory.md#intro-inventory) section. Sometimes an inventory source file is also referred to as a ‘hostfile’.
...
Playbooks are written in YAML and are easy to read, write, share and understand. To learn more about playbooks, see [Ansible playbooks](../../playbook_guide/playbooks_intro.md#about-playbooks).
