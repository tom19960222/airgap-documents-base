...
source_url: https://docs.ansible.com/projects/ansible/8/network/getting_started/network_resources.html
fetched_at: 2026-07-28T00:59:26+00:00
---
...
## [Documents](network_resources.md#id1)

Read more about Ansible for Network Automation:

- [Network Platform Options](../user_guide/platform_index.md#platform-options)
...
## [Events (on video and in person)](network_resources.md#id2)
...
## [GitHub repos](network_resources.md#id3)
...
- [Network-Automation](https://github.com/network-automation) is an open community for all things network automation. Have an idea, some playbooks, or roles to share? Email [ansible-network@redhat.com](mailto:ansible-network%40redhat.com) and we will add you as a contributor to the repository.
...
## [Chat channels](network_resources.md#id4)
