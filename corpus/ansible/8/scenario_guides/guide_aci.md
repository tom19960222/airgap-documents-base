...
collection: ansible
version: "8"
title: "Cisco ACI Guide"
source_url: https://docs.ansible.com/projects/ansible/8/scenario_guides/guide_aci.html
fetched_at: 2026-07-28T01:00:54+00:00
---
# Cisco ACI Guide
...
If you want to learn how to write your own ACI modules to contribute, look at the [Developing Cisco ACI modules](https://docs.ansible.com/ansible/6/dev_guide/developing_modules_general_aci.html#aci-dev-guide "(in Ansible v6)") section.
...
By default, if an environment variable `<protocol>_proxy` is set on the target host, requests will be sent through that proxy. This behavior can be overridden by setting a variable for this task (see [Setting the remote environment](../playbook_guide/playbooks_environment.md#playbooks-environment)), or by using the `use_proxy` module parameter.
...
- More information on Ansible Vault can be found on the [Ansible Vault](../vault_guide/vault.md#vault) page.
...
>
> [Network Working Group](https://github.com/ansible/community/tree/main/group-network)
