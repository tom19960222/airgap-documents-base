...
collection: ansible
version: "8"
title: "Cisco Meraki Guide"
source_url: https://docs.ansible.com/projects/ansible/8/scenario_guides/guide_meraki.html
fetched_at: 2026-07-28T01:00:55+00:00
---
# Cisco Meraki Guide

- [What is Cisco Meraki?](guide_meraki.md#what-is-cisco-meraki)

  - [MS Switches](guide_meraki.md#ms-switches)
  - [MX Firewalls](guide_meraki.md#mx-firewalls)
  - [MR Wireless Access Points](guide_meraki.md#mr-wireless-access-points)
- [Using the Meraki modules](guide_meraki.md#using-the-meraki-modules)
- [Common Parameters](guide_meraki.md#common-parameters)
- [Meraki Authentication](guide_meraki.md#meraki-authentication)
- [Returned Data Structures](guide_meraki.md#returned-data-structures)
- [Handling Returned Data](guide_meraki.md#handling-returned-data)
- [Merging Existing and New Data](guide_meraki.md#merging-existing-and-new-data)
- [Error Handling](guide_meraki.md#error-handling)

## [What is Cisco Meraki?](guide_meraki.md#id1)
...
### [MS Switches](guide_meraki.md#id2)
...
### [MX Firewalls](guide_meraki.md#id3)
...
### [MR Wireless Access Points](guide_meraki.md#id4)
...
## [Using the Meraki modules](guide_meraki.md#id5)
...
## [Common Parameters](guide_meraki.md#id6)
...
## [Meraki Authentication](guide_meraki.md#id7)
...
## [Returned Data Structures](guide_meraki.md#id8)
...
## [Handling Returned Data](guide_meraki.md#id9)
...
## [Merging Existing and New Data](guide_meraki.md#id10)
...
## [Error Handling](guide_meraki.md#id11)
