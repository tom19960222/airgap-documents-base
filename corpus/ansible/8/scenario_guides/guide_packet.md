...
collection: ansible
version: "8"
title: "Packet.net Guide"
source_url: https://docs.ansible.com/projects/ansible/8/scenario_guides/guide_packet.html
fetched_at: 2026-07-28T01:00:51+00:00
---
# Packet.net Guide
...
Note, this guide assumes you are familiar with Ansible and how it works. If you’re not, have a look at their [docs](../index.md#ansible-documentation) before getting started.
...
In order to check the state of devices created by Ansible on Packet, it is a good idea to install one of the [Packet CLI clients](https://www.packet.net/developers/integrations/). Otherwise you can check them through the [Packet portal](https://app.packet.net/portal).
...
If you have any questions or comments let us know! [help@packet.net](mailto:help%40packet.net)
