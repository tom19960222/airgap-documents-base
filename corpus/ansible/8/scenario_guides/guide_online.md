...
collection: ansible
version: "8"
title: "Online.net Guide"
source_url: https://docs.ansible.com/projects/ansible/8/scenario_guides/guide_online.html
...
Check it out: <https://www.online.net/en>
...
2. Set your `ONLINE_TOKEN` environment variable with your token.
   :   You need to open an account and log into it before you can get a token.
       You can find your token at the following page: <https://console.online.net/en/api/access>
