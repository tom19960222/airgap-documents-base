...
collection: ansible
version: "8"
title: "Rackspace Cloud Guide"
source_url: https://docs.ansible.com/projects/ansible/8/scenario_guides/guide_rax.html
fetched_at: 2026-07-28T01:00:52+00:00
---
...
For more information see [Implicit Localhost](../inventory/implicit_localhost.md#implicit-localhost)
...
The GUI component of [Red Hat Ansible Automation Platform](https://docs.ansible.com/ansible/2.9/reference_appendices/tower.html#ansible-tower "(in Ansible v2.9)") also contains a very nice feature for auto-scaling use cases. In this mode, a simple curl script can call
a defined URL and the server will “dial out” to the requester and configure an instance that is spinning up. This can be a great way
to reconfigure ephemeral nodes. See [the documentation on provisioning callbacks](https://docs.ansible.com/ansible-tower/latest/html/userguide/job_templates.html#provisioning-callbacks) for more details.
