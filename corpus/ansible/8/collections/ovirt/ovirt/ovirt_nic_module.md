...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_nic_module.html
fetched_at: 2026-07-28T02:49:42+00:00
---
...
| **network_filter_parameters**  list / elements=dictionary  *added in ovirt.ovirt 3.0.0* | The list of network filter parameters. |
| **name**  string | Name of the network filter parameter. |
| **value**  string | Value of the network filter parameter. |
