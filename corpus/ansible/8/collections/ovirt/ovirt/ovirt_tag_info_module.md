...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_tag_info module – Retrieve information about one or more oVirt/RHV tags"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_tag_info_module.html
fetched_at: 2026-07-28T02:50:04+00:00
---
# ovirt.ovirt.ovirt_tag_info module – Retrieve information about one or more oVirt/RHV tags
...
> see [Requirements](ovirt_tag_info_module.md#ansible-collections-ovirt-ovirt-ovirt-tag-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_tag_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_tag_info_module.md#synopsis)
- [Requirements](ovirt_tag_info_module.md#requirements)
- [Parameters](ovirt_tag_info_module.md#parameters)
- [Notes](ovirt_tag_info_module.md#notes)
- [Examples](ovirt_tag_info_module.md#examples)
- [Return Values](ovirt_tag_info_module.md#return-values)

## [Synopsis](ovirt_tag_info_module.md#id1)

- Retrieve information about one or more oVirt/RHV tags.
- This module was called `ovirt_tag_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_tag_info](ovirt_tag_info_module.md#ansible-collections-ovirt-ovirt-ovirt-tag-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_tag_info_module.md#id2)
...
## [Parameters](ovirt_tag_info_module.md#id3)
...
## [Notes](ovirt_tag_info_module.md#id4)
...
## [Examples](ovirt_tag_info_module.md#id5)
...
## [Return Values](ovirt_tag_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_tags**  list / elements=string | List of dictionaries describing the tags. Tags attributes are mapped to dictionary keys, all tags attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/tag>.  **Returned:** On success. |
