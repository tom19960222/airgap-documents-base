...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_nic_info module – Retrieve information about one or more oVirt/RHV virtual machine network interfaces"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_nic_info_module.html
fetched_at: 2026-07-28T02:49:43+00:00
---
# ovirt.ovirt.ovirt_nic_info module – Retrieve information about one or more oVirt/RHV virtual machine network interfaces
...
> see [Requirements](ovirt_nic_info_module.md#ansible-collections-ovirt-ovirt-ovirt-nic-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_nic_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_nic_info_module.md#synopsis)
- [Requirements](ovirt_nic_info_module.md#requirements)
- [Parameters](ovirt_nic_info_module.md#parameters)
- [Notes](ovirt_nic_info_module.md#notes)
- [Examples](ovirt_nic_info_module.md#examples)
- [Return Values](ovirt_nic_info_module.md#return-values)

## [Synopsis](ovirt_nic_info_module.md#id1)

- Retrieve information about one or more oVirt/RHV virtual machine network interfaces.
- This module was called `ovirt_nic_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_nic_info](ovirt_nic_info_module.md#ansible-collections-ovirt-ovirt-ovirt-nic-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_nic_info_module.md#id2)
...
## [Parameters](ovirt_nic_info_module.md#id3)
...
| **template**  string  *added in ovirt.ovirt 1.2.0* | Name of the template where NIC is attached.  You must provide either `vm` parameter or `template` parameter. |
| **vm**  string | Name of the VM where NIC is attached.  You must provide either `vm` parameter or `template` parameter. |

## [Notes](ovirt_nic_info_module.md#id4)
...
## [Examples](ovirt_nic_info_module.md#id5)
...
## [Return Values](ovirt_nic_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_nics**  list / elements=string | List of dictionaries describing the network interfaces. NIC attributes are mapped to dictionary keys, all NICs attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/nic>.  **Returned:** On success. |
