...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_disk_module.html
fetched_at: 2026-07-28T02:49:20+00:00
---
...
| **id**  string | ID of the disk to manage. Either `id` or `name`/`alias` is required. |
