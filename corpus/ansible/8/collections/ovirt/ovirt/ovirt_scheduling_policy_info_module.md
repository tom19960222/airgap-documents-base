...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_scheduling_policy_info module – Retrieve information about one or more oVirt scheduling policies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_scheduling_policy_info_module.html
fetched_at: 2026-07-28T02:49:51+00:00
---
# ovirt.ovirt.ovirt_scheduling_policy_info module – Retrieve information about one or more oVirt scheduling policies
...
> see [Requirements](ovirt_scheduling_policy_info_module.md#ansible-collections-ovirt-ovirt-ovirt-scheduling-policy-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_scheduling_policy_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_scheduling_policy_info_module.md#synopsis)
- [Requirements](ovirt_scheduling_policy_info_module.md#requirements)
- [Parameters](ovirt_scheduling_policy_info_module.md#parameters)
- [Notes](ovirt_scheduling_policy_info_module.md#notes)
- [Examples](ovirt_scheduling_policy_info_module.md#examples)
- [Return Values](ovirt_scheduling_policy_info_module.md#return-values)

## [Synopsis](ovirt_scheduling_policy_info_module.md#id1)

- Retrieve information about one or more oVirt scheduling policies.
- This module was called `ovirt_scheduling_policy_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_scheduling_policy_info](ovirt_scheduling_policy_info_module.md#ansible-collections-ovirt-ovirt-ovirt-scheduling-policy-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_scheduling_policy_info_module.md#id2)
...
## [Parameters](ovirt_scheduling_policy_info_module.md#id3)
...
## [Notes](ovirt_scheduling_policy_info_module.md#id4)
...
## [Examples](ovirt_scheduling_policy_info_module.md#id5)
...
## [Return Values](ovirt_scheduling_policy_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_scheduling_policies**  list / elements=string | List of dictionaries describing the scheduling policies. Scheduling policies attributes are mapped to dictionary keys, all scheduling policies attributes can be found at following url: <https://ovirt.example.com/ovirt-engine/api/model#types/scheduling_policy>.  **Returned:** On success. |
