...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_api_info module – Retrieve information about the oVirt/RHV API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_api_info_module.html
fetched_at: 2026-07-28T02:49:14+00:00
---
# ovirt.ovirt.ovirt_api_info module – Retrieve information about the oVirt/RHV API
...
> see [Requirements](ovirt_api_info_module.md#ansible-collections-ovirt-ovirt-ovirt-api-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_api_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_api_info_module.md#synopsis)
- [Requirements](ovirt_api_info_module.md#requirements)
- [Parameters](ovirt_api_info_module.md#parameters)
- [Notes](ovirt_api_info_module.md#notes)
- [Examples](ovirt_api_info_module.md#examples)
- [Return Values](ovirt_api_info_module.md#return-values)

## [Synopsis](ovirt_api_info_module.md#id1)

- Retrieve information about the oVirt/RHV API.
- This module was called `ovirt_api_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [ovirt.ovirt.ovirt_api_info](ovirt_api_info_module.md#ansible-collections-ovirt-ovirt-ovirt-api-info-module) module no longer returns `ansible_facts`!

## [Requirements](ovirt_api_info_module.md#id2)
...
## [Parameters](ovirt_api_info_module.md#id3)
...
## [Notes](ovirt_api_info_module.md#id4)
...
## [Examples](ovirt_api_info_module.md#id5)
...
## [Return Values](ovirt_api_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_api**  dictionary | Dictionary describing the oVirt API information. Api attributes are mapped to dictionary keys, all API attributes can be found at following url: <https://ovirt.example.com/ovirt-engine/api/model#types/api>.  **Returned:** On success. |
