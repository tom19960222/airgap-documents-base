...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_vnic_profile_info module – Retrieve information about one or more oVirt/RHV vnic profiles"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_vnic_profile_info_module.html
fetched_at: 2026-07-28T02:50:17+00:00
---
# ovirt.ovirt.ovirt_vnic_profile_info module – Retrieve information about one or more oVirt/RHV vnic profiles
...
> see [Requirements](ovirt_vnic_profile_info_module.md#ansible-collections-ovirt-ovirt-ovirt-vnic-profile-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_vnic_profile_info`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_vnic_profile_info_module.md#synopsis)
- [Requirements](ovirt_vnic_profile_info_module.md#requirements)
- [Parameters](ovirt_vnic_profile_info_module.md#parameters)
- [Notes](ovirt_vnic_profile_info_module.md#notes)
- [Examples](ovirt_vnic_profile_info_module.md#examples)
- [Return Values](ovirt_vnic_profile_info_module.md#return-values)

## [Synopsis](ovirt_vnic_profile_info_module.md#id1)

- Retrieve information about one or more oVirt/RHV vnic profiles.

## [Requirements](ovirt_vnic_profile_info_module.md#id2)
...
## [Parameters](ovirt_vnic_profile_info_module.md#id3)
...
## [Notes](ovirt_vnic_profile_info_module.md#id4)
...
## [Examples](ovirt_vnic_profile_info_module.md#id5)
...
## [Return Values](ovirt_vnic_profile_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_vnic_profiles**  list / elements=string | List of dictionaries describing the vnic profiles. Vnic_profile attributes are mapped to dictionary keys, all vnic profiles attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/vnic_profile>.  **Returned:** On success. |
