...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_network module – Module to manage logical networks in oVirt/RHV"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_network_module.html
fetched_at: 2026-07-28T02:49:39+00:00
---
...
> see [Requirements](ovirt_network_module.md#ansible-collections-ovirt-ovirt-ovirt-network-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_network`.

New in ovirt.ovirt 1.0.0

- [Synopsis](ovirt_network_module.md#synopsis)
- [Requirements](ovirt_network_module.md#requirements)
- [Parameters](ovirt_network_module.md#parameters)
- [Notes](ovirt_network_module.md#notes)
- [Examples](ovirt_network_module.md#examples)
- [Return Values](ovirt_network_module.md#return-values)

## [Synopsis](ovirt_network_module.md#id1)

- Module to manage logical networks in oVirt/RHV

## [Requirements](ovirt_network_module.md#id2)
...
## [Parameters](ovirt_network_module.md#id3)
...
| **assigned**  boolean | *true* if the network should be assigned to cluster. Default is *true*.  **Choices:**   - `false` - `true` |
| **default_route**  boolean | *true* if the default gateway and the DNS resolver configuration of the host will be taken from this network.  **Choices:**   - `false` - `true` |
| **display**  boolean | *true* if the network should marked as display network.  **Choices:**   - `false` - `true` |
| **gluster**  boolean | *true* if the network should marked as gluster network.  **Choices:**   - `false` - `true` |
| **migration**  boolean | *true* if the network should marked as migration network.  **Choices:**   - `false` - `true` |
| **name**  string | Cluster name. |
| **required**  boolean | *true* if the network must remain operational for all hosts associated with this network.  **Choices:**   - `false` - `true` |
...
| **state**  string | Should the network be present or absent  **Choices:**   - `"present"` ← (default) - `"absent"` |
...
| **vm_network**  boolean | If *True* network will be marked as network for VM.  VM network carries traffic relevant to the virtual machine.  **Choices:**   - `false` - `true` |
| **wait**  boolean | `yes` if the module should wait for the entity to get into desired state.  **Choices:**   - `false` - `true` ← (default) |

## [Notes](ovirt_network_module.md#id4)

> **Note:**
>
> - In order to use this module you have to install oVirt Python SDK. To ensure it’s installed with correct version you can create the following task: *pip: name=ovirt-engine-sdk-python version=4.4.0*

## [Examples](ovirt_network_module.md#id5)
...
## [Return Values](ovirt_network_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **id**  string | ID of the managed network  **Returned:** On success if network is found.  **Sample:** `"7de90f31-222c-436c-a1ca-7e655bd5b60c"` |
| **network**  dictionary | Dictionary of all the network attributes. Network attributes can be found on your oVirt/RHV instance at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/network>.  **Returned:** On success if network is found. |
