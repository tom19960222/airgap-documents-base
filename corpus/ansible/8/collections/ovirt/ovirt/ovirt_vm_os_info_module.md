...
collection: ansible
version: "8"
title: "ovirt.ovirt.ovirt_vm_os_info module – Retrieve information on all supported oVirt/RHV operating systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ovirt/ovirt/ovirt_vm_os_info_module.html
fetched_at: 2026-07-28T02:50:12+00:00
---
...
> see [Requirements](ovirt_vm_os_info_module.md#ansible-collections-ovirt-ovirt-ovirt-vm-os-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ovirt.ovirt.ovirt_vm_os_info`.

New in ovirt.ovirt 1.1.0

- [Synopsis](ovirt_vm_os_info_module.md#synopsis)
- [Requirements](ovirt_vm_os_info_module.md#requirements)
- [Parameters](ovirt_vm_os_info_module.md#parameters)
- [Notes](ovirt_vm_os_info_module.md#notes)
- [Examples](ovirt_vm_os_info_module.md#examples)
- [Return Values](ovirt_vm_os_info_module.md#return-values)

## [Synopsis](ovirt_vm_os_info_module.md#id1)

- Retrieve information on all supported oVirt/RHV operating systems.

## [Requirements](ovirt_vm_os_info_module.md#id2)
...
## [Parameters](ovirt_vm_os_info_module.md#id3)
...
| **filter_keys**  list / elements=string | List of attributes which should be in returned. |
...
## [Notes](ovirt_vm_os_info_module.md#id4)
...
## [Examples](ovirt_vm_os_info_module.md#id5)
...
## [Return Values](ovirt_vm_os_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ovirt_operating_systems**  list / elements=string | List of dictionaries describing the operating systems. Operating system attributes are mapped to dictionary keys, all operating systems attributes can be found at following url: <http://ovirt.github.io/ovirt-engine-api-model/master/#types/operating_system_info>.  **Returned:** On success. |
