...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/role_module.html
fetched_at: 2026-07-28T01:11:42+00:00
---
...
| **credentials**  list / elements=string | Credential names, IDs, or named URLs the role acts on. |
| **instance_groups**  list / elements=string | Instance Group names, IDs, or named URLs the role acts on. |
| **inventories**  list / elements=string | Inventory names, IDs, or named URLs the role acts on. |
...
| **job_templates**  list / elements=string | The job template names, IDs, or named URLs the role acts on. |
...
| **organizations**  list / elements=string | Organization names, IDs, or named URLs the role acts on. |
| **project**  string | Project name, ID, or named URL the role acts on.  Deprecated, use ‘projects’. |
| **projects**  list / elements=string | Project names, IDs, or named URLs the role acts on. |
...
| **target_teams**  list / elements=string | Team names, IDs, or named URLs that the role acts on.  For example, make someone a member or an admin of a team.  Members of a team implicitly receive the permissions that the team has. |
| **team**  string | Team name, ID, or named URL that receives the permissions specified by the role.  Deprecated, use ‘teams’. |
| **teams**  list / elements=string | Team names, IDs, or named URLs that receive the permissions specified by the role. |
| **user**  string | User name, ID, or named URL that receives the permissions specified by the role.  Deprecated, use ‘users’. |
| **users**  list / elements=string | User names, IDs, or named URLs that receive the permissions specified by the role. |
...
| **workflows**  list / elements=string | The workflow job template names, IDs, or named URLs the role acts on. |
