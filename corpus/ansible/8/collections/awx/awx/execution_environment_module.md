...
collection: ansible
version: "8"
title: "awx.awx.execution_environment module – create, update, or destroy Execution Environments in Automation Platform Controller."
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/execution_environment_module.html
fetched_at: 2026-07-28T01:11:27+00:00
---
# awx.awx.execution_environment module – create, update, or destroy Execution Environments in Automation Platform Controller.
...
- [Synopsis](execution_environment_module.md#synopsis)
- [Parameters](execution_environment_module.md#parameters)
- [Notes](execution_environment_module.md#notes)
- [Examples](execution_environment_module.md#examples)

## [Synopsis](execution_environment_module.md#id1)
...
Aliases: tower_execution_environment

## [Parameters](execution_environment_module.md#id2)
...
| **pull**  string | determine image pull behavior  **Choices:**   - `"always"` - `"missing"` ← (default) - `"never"` |
...
## [Notes](execution_environment_module.md#id3)
...
## [Examples](execution_environment_module.md#id4)
