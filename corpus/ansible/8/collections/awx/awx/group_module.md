...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/group_module.html
fetched_at: 2026-07-28T01:11:28+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **children**  aliases: groups  list / elements=string | List of groups names, IDs, or named URLs that should be nested inside in this group. |
...
| **hosts**  list / elements=string | List of host names, IDs, or named URLs that should be put in this group. |
| **inventory**  string / required | Inventory name, ID, or named URL that the group should be made a member of. |
