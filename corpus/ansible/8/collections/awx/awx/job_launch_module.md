...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/job_launch_module.html
fetched_at: 2026-07-28T01:11:35+00:00
---
...
| **credentials**  aliases: credential  list / elements=string | Credential names, IDs, or named URLs to use for job, only used if prompt for credential is set. |
...
| **instance_groups**  list / elements=string | Instance group names, IDs, or named URLs to use for the job, only used if prompt for instance groups is set. |
