...
collection: ansible
version: "8"
title: "awx.awx.credential_type module – Create, update, or destroy custom Automation Platform Controller credential type."
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/credential_type_module.html
fetched_at: 2026-07-28T01:11:26+00:00
---
# awx.awx.credential_type module – Create, update, or destroy custom Automation Platform Controller credential type.
...
- [Synopsis](credential_type_module.md#synopsis)
- [Parameters](credential_type_module.md#parameters)
- [Notes](credential_type_module.md#notes)
- [Examples](credential_type_module.md#examples)

## [Synopsis](credential_type_module.md#id1)

- Create, update, or destroy Automation Platform Controller credential type. See <https://www.ansible.com/tower> for an overview.

Aliases: tower_credential_type

## [Parameters](credential_type_module.md#id2)
...
| **inputs**  dictionary | Enter inputs using either JSON or YAML syntax. Refer to the Automation Platform Controller documentation for example syntax. |
| **kind**  string | The type of credential type being added. Note that only cloud and net can be used for creating credential types. Refer to the Ansible for more information.  **Choices:**   - `"ssh"` - `"vault"` - `"net"` - `"scm"` - `"cloud"` - `"insights"` |
...
## [Notes](credential_type_module.md#id3)
...
## [Examples](credential_type_module.md#id4)
