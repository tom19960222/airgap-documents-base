...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/user_module.html
fetched_at: 2026-07-28T01:11:46+00:00
---
...
| **is_superuser**  aliases: superuser  boolean | Designates that this user has all permissions without explicitly assigning them.  **Choices:**   - `false` - `true` |
| **is_system_auditor**  aliases: auditor  boolean | User is a system wide auditor.  **Choices:**   - `false` - `true` |
