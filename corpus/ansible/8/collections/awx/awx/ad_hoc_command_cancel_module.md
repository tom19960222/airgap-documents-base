...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/ad_hoc_command_cancel_module.html
...
| **timeout**  integer | Maximum time in seconds to wait for a job to finish.  Not specifying means the task will wait until the controller cancels the command.  **Default:** `0` |
