...
collection: ansible
version: "8"
title: "awx.awx.workflow_node_wait module – Wait for a workflow node to finish."
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/workflow_node_wait_module.html
fetched_at: 2026-07-28T01:11:50+00:00
---
# awx.awx.workflow_node_wait module – Wait for a workflow node to finish.
...
- [Synopsis](workflow_node_wait_module.md#synopsis)
- [Parameters](workflow_node_wait_module.md#parameters)
- [Notes](workflow_node_wait_module.md#notes)
- [Examples](workflow_node_wait_module.md#examples)

## [Synopsis](workflow_node_wait_module.md#id1)

- Approve an approval node in a workflow job. See <https://www.ansible.com/tower> for an overview.

Aliases: tower_workflow_node_wait

## [Parameters](workflow_node_wait_module.md#id2)
...
| **timeout**  integer | Maximum time in seconds to wait for a workflow job to reach approval node.  **Default:** `10` |
...
| **workflow_job_id**  integer / required | ID of the workflow job to monitor for node. |

## [Notes](workflow_node_wait_module.md#id3)
...
## [Examples](workflow_node_wait_module.md#id4)
