...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/label_module.html
fetched_at: 2026-07-28T01:11:38+00:00
---
...
| **organization**  string / required | Organization name, ID, or named URL this label belongs to. |
...
| **state**  string | Desired state of the resource.  **Choices:**   - `"present"` ← (default) - `"exists"` |
