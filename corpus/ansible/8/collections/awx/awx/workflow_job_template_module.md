...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/workflow_job_template_module.html
...
| **inventory**  dictionary | Inventory applied as a prompt, if job template prompts for inventory |
| **name**  string | Name Inventory to be applied to job as launch-time prompts. |
...
| **always_nodes**  list / elements=dictionary | Nodes that will run after this node completes.  List of node identifiers. |
| **identifier**  string | Identifier of Node that will run after this node completes given this option. |
| **credentials**  list / elements=dictionary | Credentials to be applied to job as launch-time prompts.  List of credential names.  Uniqueness is not handled rigorously. |
| **name**  string | Name Credentials to be applied to job as launch-time prompts. |
| **organization**  dictionary | Name of key for use in model for organizational reference |
| **name**  string | The organization of the credentials exists in. |
| **failure_nodes**  list / elements=dictionary | Nodes that will run after this node on failure.  List of node identifiers. |
| **identifier**  string | Identifier of Node that will run after this node completes given this option. |
| **instance_groups**  list / elements=dictionary | Instance groups to be applied to job as launch-time prompts.  List of Instance group names.  Uniqueness is not handled rigorously. |
| **name**  string | Name of Instance groups to be applied to job as launch-time prompts. |
| **labels**  list / elements=dictionary | Labels to be applied to job as launch-time prompts.  List of Label names.  Uniqueness is not handled rigorously. |
...
| **success_nodes**  list / elements=dictionary | Nodes that will run after this node on success.  List of node identifiers. |
| **identifier**  string | Identifier of Node that will run after this node completes given this option. |
