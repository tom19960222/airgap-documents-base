...
source_url: https://docs.ansible.com/projects/ansible/8/collections/awx/awx/ad_hoc_command_module.html
fetched_at: 2026-07-28T01:11:20+00:00
---
...
| **credential**  string / required | Credential name, ID, or named URL to use for ad hoc command. |
...
| **inventory**  string / required | Inventory name, ID, or named URL to use for the ad hoc command. |
