...
collection: ansible
version: "8"
title: "community.network.nos_command module – Run commands on remote devices running Extreme Networks NOS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/nos_command_module.html
fetched_at: 2026-07-28T01:57:14+00:00
---
# community.network.nos_command module – Run commands on remote devices running Extreme Networks NOS
...
- [Synopsis](nos_command_module.md#synopsis)
- [Parameters](nos_command_module.md#parameters)
- [Notes](nos_command_module.md#notes)
- [Examples](nos_command_module.md#examples)
- [Return Values](nos_command_module.md#return-values)

## [Synopsis](nos_command_module.md#id1)
...
- This module does not support running commands in configuration mode. Please use [community.network.nos_config](nos_config_module.md#ansible-collections-community-network-nos-config-module) to configure NOS devices.

Aliases: network.nos.nos_command

## [Parameters](nos_command_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **commands**  string / required | List of commands to send to the remote NOS device over the configured provider. The resulting output from the command is returned. If the *wait_for* argument is provided, the module is not returned until the condition is satisfied or the number of retries has expired. |
...
## [Notes](nos_command_module.md#id3)
...
## [Examples](nos_command_module.md#id4)
...
## [Return Values](nos_command_module.md#id5)
