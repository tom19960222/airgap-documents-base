...
collection: ansible
version: "8"
title: "community.network.avi_trafficcloneprofile module – Module for setup of TrafficCloneProfile Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_trafficcloneprofile_module.html
fetched_at: 2026-07-28T01:55:01+00:00
---
# community.network.avi_trafficcloneprofile module – Module for setup of TrafficCloneProfile Avi RESTful Object
...
> see [Requirements](avi_trafficcloneprofile_module.md#ansible-collections-community-network-avi-trafficcloneprofile-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_trafficcloneprofile`.

- [Synopsis](avi_trafficcloneprofile_module.md#synopsis)
- [Requirements](avi_trafficcloneprofile_module.md#requirements)
- [Parameters](avi_trafficcloneprofile_module.md#parameters)
- [Notes](avi_trafficcloneprofile_module.md#notes)
- [Examples](avi_trafficcloneprofile_module.md#examples)
- [Return Values](avi_trafficcloneprofile_module.md#return-values)

## [Synopsis](avi_trafficcloneprofile_module.md#id1)

- This module is used to configure TrafficCloneProfile object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_trafficcloneprofile

## [Requirements](avi_trafficcloneprofile_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_trafficcloneprofile_module.md#id3)
...
| **clone_servers**  string | Field introduced in 17.1.1. |
...
| **preserve_client_ip**  boolean | Specifies if client ip needs to be preserved to clone destination.  Field introduced in 17.1.1.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
## [Notes](avi_trafficcloneprofile_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_trafficcloneprofile_module.md#id5)
...
## [Return Values](avi_trafficcloneprofile_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | TrafficCloneProfile (api/trafficcloneprofile) object  **Returned:** success, changed |
