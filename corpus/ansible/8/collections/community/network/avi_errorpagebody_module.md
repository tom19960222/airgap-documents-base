...
collection: ansible
version: "8"
title: "community.network.avi_errorpagebody module – Module for setup of ErrorPageBody Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_errorpagebody_module.html
fetched_at: 2026-07-28T01:54:37+00:00
---
# community.network.avi_errorpagebody module – Module for setup of ErrorPageBody Avi RESTful Object
...
> see [Requirements](avi_errorpagebody_module.md#ansible-collections-community-network-avi-errorpagebody-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_errorpagebody`.

- [Synopsis](avi_errorpagebody_module.md#synopsis)
- [Requirements](avi_errorpagebody_module.md#requirements)
- [Parameters](avi_errorpagebody_module.md#parameters)
- [Notes](avi_errorpagebody_module.md#notes)
- [Examples](avi_errorpagebody_module.md#examples)
- [Return Values](avi_errorpagebody_module.md#return-values)

## [Synopsis](avi_errorpagebody_module.md#id1)

- This module is used to configure ErrorPageBody object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_errorpagebody

## [Requirements](avi_errorpagebody_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_errorpagebody_module.md#id3)
...
| **error_page_body**  string | Error page body sent to client when match.  Field introduced in 17.2.4. |
| **format**  string | Format of an error page body html or json.  Enum options - ERROR_PAGE_FORMAT_HTML, ERROR_PAGE_FORMAT_JSON.  Field introduced in 18.2.3.  Default value when not specified in API or module is interpreted by Avi Controller as ERROR_PAGE_FORMAT_HTML. |
...
## [Notes](avi_errorpagebody_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_errorpagebody_module.md#id5)
...
## [Return Values](avi_errorpagebody_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | ErrorPageBody (api/errorpagebody) object  **Returned:** success, changed |
