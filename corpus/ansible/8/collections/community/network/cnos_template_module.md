...
collection: ansible
version: "8"
title: "community.network.cnos_template module – Manage switch configuration using templates on devices running Lenovo CNOS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/cnos_template_module.html
fetched_at: 2026-07-28T01:56:20+00:00
---
...
- [Synopsis](cnos_template_module.md#synopsis)
- [Parameters](cnos_template_module.md#parameters)
- [Notes](cnos_template_module.md#notes)
- [Examples](cnos_template_module.md#examples)
- [Return Values](cnos_template_module.md#return-values)

## [Synopsis](cnos_template_module.md#id1)
...
## [Parameters](cnos_template_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **commandfile**  string / required | This specifies the path to the CNOS command file which needs to be applied. This usually comes from the commands folder. Generally this file is the output of the variables applied on a template file. So this command is preceded by a template module. Note The command file must contain the Ansible keyword {{ inventory_hostname }} in its filename to ensure that the command file is unique for each switch and condition. If this is omitted, the command file will be overwritten during iteration. For example, commandfile=./commands/clos_leaf_bgp_{{ inventory_hostname }}_commands.txt |
...
## [Return Values](cnos_template_module.md#id5)
