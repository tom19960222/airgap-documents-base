...
collection: ansible
version: "8"
title: "community.network.cnos_linkagg module – Manage link aggregation groups on Lenovo CNOS devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/cnos_linkagg_module.html
fetched_at: 2026-07-28T01:56:14+00:00
---
...
- [Synopsis](cnos_linkagg_module.md#synopsis)
- [Parameters](cnos_linkagg_module.md#parameters)
- [Notes](cnos_linkagg_module.md#notes)
- [Examples](cnos_linkagg_module.md#examples)
- [Return Values](cnos_linkagg_module.md#return-values)

## [Synopsis](cnos_linkagg_module.md#id1)
...
## [Parameters](cnos_linkagg_module.md#id2)
...
## [Notes](cnos_linkagg_module.md#id3)

> **Note:**
>
> - Tested against CNOS 10.8.1

## [Examples](cnos_linkagg_module.md#id4)
...
## [Return Values](cnos_linkagg_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **commands**  list / elements=string | The list of configuration mode commands to send to the device  **Returned:** always, except for the platforms that use Netconf transport to manage the device.  **Sample:** `["interface port-channel 30", "interface Ethernet1/33", "channel-group 30 mode on", "no interface port-channel 30"]` |
