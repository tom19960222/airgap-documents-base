...
collection: ansible
version: "8"
title: "community.network.avi_cluster module – Module for setup of Cluster Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_cluster_module.html
fetched_at: 2026-07-28T01:54:34+00:00
---
# community.network.avi_cluster module – Module for setup of Cluster Avi RESTful Object
...
> see [Requirements](avi_cluster_module.md#ansible-collections-community-network-avi-cluster-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_cluster`.

- [Synopsis](avi_cluster_module.md#synopsis)
- [Requirements](avi_cluster_module.md#requirements)
- [Parameters](avi_cluster_module.md#parameters)
- [Notes](avi_cluster_module.md#notes)
- [Examples](avi_cluster_module.md#examples)
- [Return Values](avi_cluster_module.md#return-values)

## [Synopsis](avi_cluster_module.md#id1)

- This module is used to configure Cluster object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_cluster

## [Requirements](avi_cluster_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_cluster_module.md#id3)
...
| **rejoin_nodes_automatically**  boolean | Re-join cluster nodes automatically in the event one of the node is reset to factory.  Default value when not specified in API or module is interpreted by Avi Controller as True.  **Choices:**   - `false` - `true` |
...
| **virtual_ip**  string | A virtual ip address.  This ip address will be dynamically reconfigured so that it always is the ip of the cluster leader. |

## [Notes](avi_cluster_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_cluster_module.md#id5)
...
## [Return Values](avi_cluster_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | Cluster (api/cluster) object  **Returned:** success, changed |
