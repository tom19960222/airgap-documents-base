...
collection: ansible
version: "8"
title: "community.network.avi_networkprofile module – Module for setup of NetworkProfile Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_networkprofile_module.html
fetched_at: 2026-07-28T01:54:47+00:00
---
# community.network.avi_networkprofile module – Module for setup of NetworkProfile Avi RESTful Object
...
> see [Requirements](avi_networkprofile_module.md#ansible-collections-community-network-avi-networkprofile-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_networkprofile`.

- [Synopsis](avi_networkprofile_module.md#synopsis)
- [Requirements](avi_networkprofile_module.md#requirements)
- [Parameters](avi_networkprofile_module.md#parameters)
- [Notes](avi_networkprofile_module.md#notes)
- [Examples](avi_networkprofile_module.md#examples)
- [Return Values](avi_networkprofile_module.md#return-values)

## [Synopsis](avi_networkprofile_module.md#id1)

- This module is used to configure NetworkProfile object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_networkprofile

## [Requirements](avi_networkprofile_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_networkprofile_module.md#id3)
...
| **connection_mirror**  boolean | When enabled, avi mirrors all tcp fastpath connections to standby.  Applicable only in legacy ha mode.  Field introduced in 18.1.3,18.2.1.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
## [Notes](avi_networkprofile_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_networkprofile_module.md#id5)
...
## [Return Values](avi_networkprofile_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | NetworkProfile (api/networkprofile) object  **Returned:** success, changed |
