...
collection: ansible
version: "8"
title: "community.network.exos_config module – Manage Extreme Networks EXOS configuration sections"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/exos_config_module.html
fetched_at: 2026-07-28T01:56:35+00:00
---
# community.network.exos_config module – Manage Extreme Networks EXOS configuration sections
...
- [Synopsis](exos_config_module.md#synopsis)
- [Parameters](exos_config_module.md#parameters)
- [Notes](exos_config_module.md#notes)
- [Examples](exos_config_module.md#examples)
- [Return Values](exos_config_module.md#return-values)

## [Synopsis](exos_config_module.md#id1)
...
Aliases: network.exos.exos_config

## [Parameters](exos_config_module.md#id2)
...
## [Notes](exos_config_module.md#id3)

> **Note:**
>
> - Tested against EXOS version 22.6.0b19

## [Examples](exos_config_module.md#id4)
...
## [Return Values](exos_config_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **backup_path**  string | The full path to the backup file  **Returned:** when backup is yes  **Sample:** `"/playbooks/ansible/backup/x870_config.2018-08-08@15:00:21"` |
| **commands**  list / elements=string | The set of commands that will be pushed to the remote device  **Returned:** always  **Sample:** `["create vlan \"foo\"", "configure snmp sysName \"x620-red\""]` |
