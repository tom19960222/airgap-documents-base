...
collection: ansible
version: "8"
title: "community.network.cnos_showrun module – Collect the current running configuration on devices running on CNOS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/cnos_showrun_module.html
fetched_at: 2026-07-28T01:56:18+00:00
---
# community.network.cnos_showrun module – Collect the current running configuration on devices running on CNOS
...
- [Synopsis](cnos_showrun_module.md#synopsis)
- [Parameters](cnos_showrun_module.md#parameters)
- [Notes](cnos_showrun_module.md#notes)
- [Examples](cnos_showrun_module.md#examples)
- [Return Values](cnos_showrun_module.md#return-values)

## [Synopsis](cnos_showrun_module.md#id1)
...
Aliases: network.cnos.cnos_showrun

## [Parameters](cnos_showrun_module.md#id2)
...
## [Return Values](cnos_showrun_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **msg**  string | Success or failure message  **Returned:** always  **Sample:** `"Running Configuration saved in file"` |
