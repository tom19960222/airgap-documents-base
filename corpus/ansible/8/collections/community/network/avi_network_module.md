...
collection: ansible
version: "8"
title: "community.network.avi_network module – Module for setup of Network Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_network_module.html
fetched_at: 2026-07-28T01:54:47+00:00
---
# community.network.avi_network module – Module for setup of Network Avi RESTful Object
...
> see [Requirements](avi_network_module.md#ansible-collections-community-network-avi-network-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_network`.

- [Synopsis](avi_network_module.md#synopsis)
- [Requirements](avi_network_module.md#requirements)
- [Parameters](avi_network_module.md#parameters)
- [Notes](avi_network_module.md#notes)
- [Examples](avi_network_module.md#examples)
- [Return Values](avi_network_module.md#return-values)

## [Synopsis](avi_network_module.md#id1)

- This module is used to configure Network object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_network

## [Requirements](avi_network_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_network_module.md#id3)
...
| **configured_subnets**  string | List of subnet. |
| **controller**  string | IP address or hostname of the controller. The default value is the environment variable `AVI_CONTROLLER`. |
| **dhcp_enabled**  boolean | Select the ip address management scheme for this network.  Default value when not specified in API or module is interpreted by Avi Controller as True.  **Choices:**   - `false` - `true` |
| **exclude_discovered_subnets**  boolean | When selected, excludes all discovered subnets in this network from consideration for virtual service placement.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
| **ip6_autocfg_enabled**  boolean | Enable ipv6 auto configuration.  Field introduced in 18.1.1.  Default value when not specified in API or module is interpreted by Avi Controller as True.  **Choices:**   - `false` - `true` |
...
| **synced_from_se**  boolean | Boolean flag to set synced_from_se.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
| **vcenter_dvs**  boolean | Boolean flag to set vcenter_dvs.  Default value when not specified in API or module is interpreted by Avi Controller as True.  **Choices:**   - `false` - `true` |
| **vimgrnw_ref**  string | It is a reference to an object of type vimgrnwruntime. |
| **vrf_context_ref**  string | It is a reference to an object of type vrfcontext. |

## [Notes](avi_network_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_network_module.md#id5)
...
## [Return Values](avi_network_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | Network (api/network) object  **Returned:** success, changed |
