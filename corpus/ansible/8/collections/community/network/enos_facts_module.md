...
collection: ansible
version: "8"
title: "community.network.enos_facts module – Collect facts from remote devices running Lenovo ENOS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/enos_facts_module.html
fetched_at: 2026-07-28T01:56:33+00:00
---
# community.network.enos_facts module – Collect facts from remote devices running Lenovo ENOS
...
- [Synopsis](enos_facts_module.md#synopsis)
- [Parameters](enos_facts_module.md#parameters)
- [Notes](enos_facts_module.md#notes)
- [Examples](enos_facts_module.md#examples)
- [Return Values](enos_facts_module.md#return-values)

## [Synopsis](enos_facts_module.md#id1)
...
Aliases: network.enos.enos_facts

## [Parameters](enos_facts_module.md#id2)
...
## [Notes](enos_facts_module.md#id3)

> **Note:**
>
> - Tested against ENOS 8.4.1

## [Examples](enos_facts_module.md#id4)
...
## [Return Values](enos_facts_module.md#id5)
...
| **ansible_net_model**  string | The model name returned from the Lenovo ENOS device  **Returned:** always |
...
| **ansible_net_serialnum**  string | The serial number of the Lenovo ENOS device  **Returned:** always |
| **ansible_net_version**  string | The ENOS operating system version running on the remote device  **Returned:** always |
