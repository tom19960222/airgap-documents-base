...
collection: ansible
version: "8"
title: "community.network.avi_hardwaresecuritymodulegroup module – Module for setup of HardwareSecurityModuleGroup Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_hardwaresecuritymodulegroup_module.html
fetched_at: 2026-07-28T01:54:42+00:00
---
# community.network.avi_hardwaresecuritymodulegroup module – Module for setup of HardwareSecurityModuleGroup Avi RESTful Object
...
> see [Requirements](avi_hardwaresecuritymodulegroup_module.md#ansible-collections-community-network-avi-hardwaresecuritymodulegroup-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_hardwaresecuritymodulegroup`.

- [Synopsis](avi_hardwaresecuritymodulegroup_module.md#synopsis)
- [Requirements](avi_hardwaresecuritymodulegroup_module.md#requirements)
- [Parameters](avi_hardwaresecuritymodulegroup_module.md#parameters)
- [Notes](avi_hardwaresecuritymodulegroup_module.md#notes)
- [Examples](avi_hardwaresecuritymodulegroup_module.md#examples)
- [Return Values](avi_hardwaresecuritymodulegroup_module.md#return-values)

## [Synopsis](avi_hardwaresecuritymodulegroup_module.md#id1)

- This module is used to configure HardwareSecurityModuleGroup object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_hardwaresecuritymodulegroup

## [Requirements](avi_hardwaresecuritymodulegroup_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_hardwaresecuritymodulegroup_module.md#id3)
...
## [Notes](avi_hardwaresecuritymodulegroup_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_hardwaresecuritymodulegroup_module.md#id5)
...
## [Return Values](avi_hardwaresecuritymodulegroup_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | HardwareSecurityModuleGroup (api/hardwaresecuritymodulegroup) object  **Returned:** success, changed |
