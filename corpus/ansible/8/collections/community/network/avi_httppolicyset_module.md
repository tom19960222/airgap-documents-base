...
collection: ansible
version: "8"
title: "community.network.avi_httppolicyset module – Module for setup of HTTPPolicySet Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_httppolicyset_module.html
fetched_at: 2026-07-28T01:54:43+00:00
---
# community.network.avi_httppolicyset module – Module for setup of HTTPPolicySet Avi RESTful Object
...
> see [Requirements](avi_httppolicyset_module.md#ansible-collections-community-network-avi-httppolicyset-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_httppolicyset`.

- [Synopsis](avi_httppolicyset_module.md#synopsis)
- [Requirements](avi_httppolicyset_module.md#requirements)
- [Parameters](avi_httppolicyset_module.md#parameters)
- [Notes](avi_httppolicyset_module.md#notes)
- [Examples](avi_httppolicyset_module.md#examples)
- [Return Values](avi_httppolicyset_module.md#return-values)

## [Synopsis](avi_httppolicyset_module.md#id1)

- This module is used to configure HTTPPolicySet object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_httppolicyset

## [Requirements](avi_httppolicyset_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_httppolicyset_module.md#id3)
...
| **http_request_policy**  string | Http request policy for the virtual service. |
| **http_response_policy**  string | Http response policy for the virtual service. |
| **http_security_policy**  string | Http security policy for the virtual service. |
| **is_internal_policy**  boolean | Boolean flag to set is_internal_policy.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
## [Notes](avi_httppolicyset_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_httppolicyset_module.md#id5)
...
## [Return Values](avi_httppolicyset_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | HTTPPolicySet (api/httppolicyset) object  **Returned:** success, changed |
