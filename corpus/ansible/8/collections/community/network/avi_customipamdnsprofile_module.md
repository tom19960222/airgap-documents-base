...
collection: ansible
version: "8"
title: "community.network.avi_customipamdnsprofile module – Module for setup of CustomIpamDnsProfile Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_customipamdnsprofile_module.html
fetched_at: 2026-07-28T01:54:36+00:00
---
# community.network.avi_customipamdnsprofile module – Module for setup of CustomIpamDnsProfile Avi RESTful Object
...
> see [Requirements](avi_customipamdnsprofile_module.md#ansible-collections-community-network-avi-customipamdnsprofile-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_customipamdnsprofile`.

- [Synopsis](avi_customipamdnsprofile_module.md#synopsis)
- [Requirements](avi_customipamdnsprofile_module.md#requirements)
- [Parameters](avi_customipamdnsprofile_module.md#parameters)
- [Notes](avi_customipamdnsprofile_module.md#notes)
- [Examples](avi_customipamdnsprofile_module.md#examples)
- [Return Values](avi_customipamdnsprofile_module.md#return-values)

## [Synopsis](avi_customipamdnsprofile_module.md#id1)

- This module is used to configure CustomIpamDnsProfile object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_customipamdnsprofile

## [Requirements](avi_customipamdnsprofile_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_customipamdnsprofile_module.md#id3)
...
| **script_params**  string | Parameters that are always passed to the ipam/dns script.  Field introduced in 17.1.1. |
| **script_uri**  string / required | Script uri of form controller //ipamdnsscripts/<file-name>.  Field introduced in 17.1.1. |
...
## [Notes](avi_customipamdnsprofile_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_customipamdnsprofile_module.md#id5)
...
## [Return Values](avi_customipamdnsprofile_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | CustomIpamDnsProfile (api/customipamdnsprofile) object  **Returned:** success, changed |
