...
collection: ansible
version: "8"
title: "community.network.avi_prioritylabels module – Module for setup of PriorityLabels Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_prioritylabels_module.html
fetched_at: 2026-07-28T01:54:52+00:00
---
# community.network.avi_prioritylabels module – Module for setup of PriorityLabels Avi RESTful Object
...
> see [Requirements](avi_prioritylabels_module.md#ansible-collections-community-network-avi-prioritylabels-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_prioritylabels`.

- [Synopsis](avi_prioritylabels_module.md#synopsis)
- [Requirements](avi_prioritylabels_module.md#requirements)
- [Parameters](avi_prioritylabels_module.md#parameters)
- [Notes](avi_prioritylabels_module.md#notes)
- [Examples](avi_prioritylabels_module.md#examples)
- [Return Values](avi_prioritylabels_module.md#return-values)

## [Synopsis](avi_prioritylabels_module.md#id1)

- This module is used to configure PriorityLabels object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_prioritylabels

## [Requirements](avi_prioritylabels_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_prioritylabels_module.md#id3)
...
| **equivalent_labels**  string | Equivalent priority labels in descending order. |
...
## [Notes](avi_prioritylabels_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_prioritylabels_module.md#id5)
...
## [Return Values](avi_prioritylabels_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | PriorityLabels (api/prioritylabels) object  **Returned:** success, changed |
