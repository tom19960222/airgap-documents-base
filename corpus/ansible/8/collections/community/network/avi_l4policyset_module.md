...
collection: ansible
version: "8"
title: "community.network.avi_l4policyset module – Module for setup of L4PolicySet Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_l4policyset_module.html
fetched_at: 2026-07-28T01:54:45+00:00
---
# community.network.avi_l4policyset module – Module for setup of L4PolicySet Avi RESTful Object
...
> see [Requirements](avi_l4policyset_module.md#ansible-collections-community-network-avi-l4policyset-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_l4policyset`.

- [Synopsis](avi_l4policyset_module.md#synopsis)
- [Requirements](avi_l4policyset_module.md#requirements)
- [Parameters](avi_l4policyset_module.md#parameters)
- [Notes](avi_l4policyset_module.md#notes)
- [Examples](avi_l4policyset_module.md#examples)
- [Return Values](avi_l4policyset_module.md#return-values)

## [Synopsis](avi_l4policyset_module.md#id1)

- This module is used to configure L4PolicySet object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_l4policyset

## [Requirements](avi_l4policyset_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_l4policyset_module.md#id3)
...
| **created_by**  string | Creator name.  Field introduced in 17.2.7. |
| **description**  string | Field introduced in 17.2.7. |
| **is_internal_policy**  boolean | Field introduced in 17.2.7.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
| **l4_connection_policy**  string | Policy to apply when a new transport connection is setup.  Field introduced in 17.2.7. |
...
| **tenant_ref**  string | It is a reference to an object of type tenant.  Field introduced in 17.2.7. |
...
## [Notes](avi_l4policyset_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_l4policyset_module.md#id5)
...
## [Return Values](avi_l4policyset_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | L4PolicySet (api/l4policyset) object  **Returned:** success, changed |
