...
collection: ansible
version: "8"
title: "community.network.avi_useraccountprofile module – Module for setup of UserAccountProfile Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_useraccountprofile_module.html
fetched_at: 2026-07-28T01:55:03+00:00
---
# community.network.avi_useraccountprofile module – Module for setup of UserAccountProfile Avi RESTful Object
...
> see [Requirements](avi_useraccountprofile_module.md#ansible-collections-community-network-avi-useraccountprofile-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_useraccountprofile`.

- [Synopsis](avi_useraccountprofile_module.md#synopsis)
- [Requirements](avi_useraccountprofile_module.md#requirements)
- [Parameters](avi_useraccountprofile_module.md#parameters)
- [Notes](avi_useraccountprofile_module.md#notes)
- [Examples](avi_useraccountprofile_module.md#examples)
- [Return Values](avi_useraccountprofile_module.md#return-values)

## [Synopsis](avi_useraccountprofile_module.md#id1)

- This module is used to configure UserAccountProfile object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_useraccountprofile

## [Requirements](avi_useraccountprofile_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_useraccountprofile_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **account_lock_timeout**  string | Lock timeout period (in minutes).  Default is 30 minutes.  Default value when not specified in API or module is interpreted by Avi Controller as 30. |
...
| **credentials_timeout_threshold**  string | The time period after which credentials expire.  Default is 180 days.  Default value when not specified in API or module is interpreted by Avi Controller as 180. |
| **max_concurrent_sessions**  string | Maximum number of concurrent sessions allowed.  There are unlimited sessions by default.  Default value when not specified in API or module is interpreted by Avi Controller as 0. |
| **max_login_failure_count**  string | Number of login attempts before lockout.  Default is 3 attempts.  Default value when not specified in API or module is interpreted by Avi Controller as 3. |
| **max_password_history_count**  string | Maximum number of passwords to be maintained in the password history.  Default is 4 passwords.  Default value when not specified in API or module is interpreted by Avi Controller as 4. |
...
## [Notes](avi_useraccountprofile_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_useraccountprofile_module.md#id5)
...
## [Return Values](avi_useraccountprofile_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | UserAccountProfile (api/useraccountprofile) object  **Returned:** success, changed |
