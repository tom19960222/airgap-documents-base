...
collection: ansible
version: "8"
title: "community.network.avi_certificatemanagementprofile module – Module for setup of CertificateManagementProfile Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_certificatemanagementprofile_module.html
fetched_at: 2026-07-28T01:54:31+00:00
---
# community.network.avi_certificatemanagementprofile module – Module for setup of CertificateManagementProfile Avi RESTful Object
...
> see [Requirements](avi_certificatemanagementprofile_module.md#ansible-collections-community-network-avi-certificatemanagementprofile-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_certificatemanagementprofile`.

- [Synopsis](avi_certificatemanagementprofile_module.md#synopsis)
- [Requirements](avi_certificatemanagementprofile_module.md#requirements)
- [Parameters](avi_certificatemanagementprofile_module.md#parameters)
- [Notes](avi_certificatemanagementprofile_module.md#notes)
- [Examples](avi_certificatemanagementprofile_module.md#examples)
- [Return Values](avi_certificatemanagementprofile_module.md#return-values)

## [Synopsis](avi_certificatemanagementprofile_module.md#id1)

- This module is used to configure CertificateManagementProfile object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_certificatemanagementprofile

## [Requirements](avi_certificatemanagementprofile_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_certificatemanagementprofile_module.md#id3)
...
| **script_params**  string | List of customparams. |
| **script_path**  string / required | Script_path of certificatemanagementprofile. |
...
## [Notes](avi_certificatemanagementprofile_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_certificatemanagementprofile_module.md#id5)
...
## [Return Values](avi_certificatemanagementprofile_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | CertificateManagementProfile (api/certificatemanagementprofile) object  **Returned:** success, changed |
