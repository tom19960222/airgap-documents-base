...
collection: ansible
version: "8"
title: "community.network.cnos_backup module – Backup the current running or startup configuration to a remote server on devices running Lenovo CNOS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/cnos_backup_module.html
fetched_at: 2026-07-28T01:56:05+00:00
---
# community.network.cnos_backup module – Backup the current running or startup configuration to a remote server on devices running Lenovo CNOS
...
- [Synopsis](cnos_backup_module.md#synopsis)
- [Parameters](cnos_backup_module.md#parameters)
- [Notes](cnos_backup_module.md#notes)
- [Examples](cnos_backup_module.md#examples)
- [Return Values](cnos_backup_module.md#return-values)

## [Synopsis](cnos_backup_module.md#id1)
...
Aliases: network.cnos.cnos_backup

## [Parameters](cnos_backup_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **configType**  string / required | This specifies what type of configuration will be backed up. The choices are the running or startup configurations. There is no default value, so it will result in an error if the input is incorrect.  **Choices:**   - `"running-config"` - `"startup-config"` |
...
## [Return Values](cnos_backup_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **msg**  string | Success or failure message  **Returned:** always  **Sample:** `"Config file transferred to server"` |
