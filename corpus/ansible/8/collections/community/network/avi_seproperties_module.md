...
collection: ansible
version: "8"
title: "community.network.avi_seproperties module – Module for setup of SeProperties Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_seproperties_module.html
fetched_at: 2026-07-28T01:54:54+00:00
---
# community.network.avi_seproperties module – Module for setup of SeProperties Avi RESTful Object
...
> see [Requirements](avi_seproperties_module.md#ansible-collections-community-network-avi-seproperties-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_seproperties`.

- [Synopsis](avi_seproperties_module.md#synopsis)
- [Requirements](avi_seproperties_module.md#requirements)
- [Parameters](avi_seproperties_module.md#parameters)
- [Notes](avi_seproperties_module.md#notes)
- [Examples](avi_seproperties_module.md#examples)
- [Return Values](avi_seproperties_module.md#return-values)

## [Synopsis](avi_seproperties_module.md#id1)

- This module is used to configure SeProperties object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_seproperties

## [Requirements](avi_seproperties_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_seproperties_module.md#id3)
...
| **se_agent_properties**  string | Seagentproperties settings for seproperties. |
| **se_bootup_properties**  string | Sebootupproperties settings for seproperties. |
| **se_runtime_properties**  string | Seruntimeproperties settings for seproperties. |
...
## [Notes](avi_seproperties_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_seproperties_module.md#id5)
...
## [Return Values](avi_seproperties_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | SeProperties (api/seproperties) object  **Returned:** success, changed |
