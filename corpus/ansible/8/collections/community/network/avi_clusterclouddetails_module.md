...
collection: ansible
version: "8"
title: "community.network.avi_clusterclouddetails module – Module for setup of ClusterCloudDetails Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_clusterclouddetails_module.html
fetched_at: 2026-07-28T01:54:34+00:00
---
# community.network.avi_clusterclouddetails module – Module for setup of ClusterCloudDetails Avi RESTful Object
...
> see [Requirements](avi_clusterclouddetails_module.md#ansible-collections-community-network-avi-clusterclouddetails-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_clusterclouddetails`.

- [Synopsis](avi_clusterclouddetails_module.md#synopsis)
- [Requirements](avi_clusterclouddetails_module.md#requirements)
- [Parameters](avi_clusterclouddetails_module.md#parameters)
- [Notes](avi_clusterclouddetails_module.md#notes)
- [Examples](avi_clusterclouddetails_module.md#examples)
- [Return Values](avi_clusterclouddetails_module.md#return-values)

## [Synopsis](avi_clusterclouddetails_module.md#id1)

- This module is used to configure ClusterCloudDetails object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_clusterclouddetails

## [Requirements](avi_clusterclouddetails_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_clusterclouddetails_module.md#id3)
...
| **azure_info**  string | Azure info to configure cluster_vip on the controller.  Field introduced in 17.2.5. |
...
| **tenant_ref**  string | It is a reference to an object of type tenant.  Field introduced in 17.2.5. |
...
## [Notes](avi_clusterclouddetails_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_clusterclouddetails_module.md#id5)
...
## [Return Values](avi_clusterclouddetails_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | ClusterCloudDetails (api/clusterclouddetails) object  **Returned:** success, changed |
