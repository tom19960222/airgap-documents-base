...
collection: ansible
version: "8"
title: "community.network.avi_actiongroupconfig module – Module for setup of ActionGroupConfig Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_actiongroupconfig_module.html
fetched_at: 2026-07-28T01:54:21+00:00
---
# community.network.avi_actiongroupconfig module – Module for setup of ActionGroupConfig Avi RESTful Object
...
> see [Requirements](avi_actiongroupconfig_module.md#ansible-collections-community-network-avi-actiongroupconfig-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_actiongroupconfig`.

- [Synopsis](avi_actiongroupconfig_module.md#synopsis)
- [Requirements](avi_actiongroupconfig_module.md#requirements)
- [Parameters](avi_actiongroupconfig_module.md#parameters)
- [Notes](avi_actiongroupconfig_module.md#notes)
- [Examples](avi_actiongroupconfig_module.md#examples)
- [Return Values](avi_actiongroupconfig_module.md#return-values)

## [Synopsis](avi_actiongroupconfig_module.md#id1)

- This module is used to configure ActionGroupConfig object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_actiongroupconfig

## [Requirements](avi_actiongroupconfig_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_actiongroupconfig_module.md#id3)
...
| **autoscale_trigger_notification**  boolean | Trigger notification to autoscale manager.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
| **external_only**  boolean / required | Generate alert only to external destinations.  Default value when not specified in API or module is interpreted by Avi Controller as False.  **Choices:**   - `false` - `true` |
...
## [Notes](avi_actiongroupconfig_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_actiongroupconfig_module.md#id5)
...
## [Return Values](avi_actiongroupconfig_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | ActionGroupConfig (api/actiongroupconfig) object  **Returned:** success, changed |
