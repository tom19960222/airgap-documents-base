...
collection: ansible
version: "8"
title: "community.network.avi_alertemailconfig module – Module for setup of AlertEmailConfig Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_alertemailconfig_module.html
fetched_at: 2026-07-28T01:54:22+00:00
---
# community.network.avi_alertemailconfig module – Module for setup of AlertEmailConfig Avi RESTful Object
...
> see [Requirements](avi_alertemailconfig_module.md#ansible-collections-community-network-avi-alertemailconfig-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_alertemailconfig`.

- [Synopsis](avi_alertemailconfig_module.md#synopsis)
- [Requirements](avi_alertemailconfig_module.md#requirements)
- [Parameters](avi_alertemailconfig_module.md#parameters)
- [Notes](avi_alertemailconfig_module.md#notes)
- [Examples](avi_alertemailconfig_module.md#examples)
- [Return Values](avi_alertemailconfig_module.md#return-values)

## [Synopsis](avi_alertemailconfig_module.md#id1)

- This module is used to configure AlertEmailConfig object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_alertemailconfig

## [Requirements](avi_alertemailconfig_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_alertemailconfig_module.md#id3)
...
| **cc_emails**  string | Alerts are copied to the comma separated list of email recipients. |
...
| **to_emails**  string / required | Alerts are sent to the comma separated list of email recipients. |
...
## [Notes](avi_alertemailconfig_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_alertemailconfig_module.md#id5)
...
## [Return Values](avi_alertemailconfig_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | AlertEmailConfig (api/alertemailconfig) object  **Returned:** success, changed |
