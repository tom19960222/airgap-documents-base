...
collection: ansible
version: "8"
title: "community.network.avi_autoscalelaunchconfig module – Module for setup of AutoScaleLaunchConfig Avi RESTful Object"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/network/avi_autoscalelaunchconfig_module.html
fetched_at: 2026-07-28T01:54:29+00:00
---
# community.network.avi_autoscalelaunchconfig module – Module for setup of AutoScaleLaunchConfig Avi RESTful Object
...
> see [Requirements](avi_autoscalelaunchconfig_module.md#ansible-collections-community-network-avi-autoscalelaunchconfig-module-requirements) for details.
>
> To use it in a playbook, specify: `community.network.avi_autoscalelaunchconfig`.

- [Synopsis](avi_autoscalelaunchconfig_module.md#synopsis)
- [Requirements](avi_autoscalelaunchconfig_module.md#requirements)
- [Parameters](avi_autoscalelaunchconfig_module.md#parameters)
- [Notes](avi_autoscalelaunchconfig_module.md#notes)
- [Examples](avi_autoscalelaunchconfig_module.md#examples)
- [Return Values](avi_autoscalelaunchconfig_module.md#return-values)

## [Synopsis](avi_autoscalelaunchconfig_module.md#id1)

- This module is used to configure AutoScaleLaunchConfig object
- more examples at <https://github.com/avinetworks/devops>

Aliases: network.avi.avi_autoscalelaunchconfig

## [Requirements](avi_autoscalelaunchconfig_module.md#id2)

The below requirements are needed on the host that executes this module.

- avisdk

## [Parameters](avi_autoscalelaunchconfig_module.md#id3)
...
| **image_id**  string | Unique id of the amazon machine image (ami) or openstack vm id. |
...
| **use_external_asg**  boolean | If set to true, serverautoscalepolicy will use the autoscaling group (external_autoscaling_groups) from pool to perform scale up and scale down.  Pool should have single autoscaling group configured.  Field introduced in 17.2.3.  Default value when not specified in API or module is interpreted by Avi Controller as True.  **Choices:**   - `false` - `true` |
...
## [Notes](avi_autoscalelaunchconfig_module.md#id4)

> **Note:**
>
> - For more information on using Ansible to manage Avi Network devices see <https://www.ansible.com/ansible-avi-networks>.

## [Examples](avi_autoscalelaunchconfig_module.md#id5)
...
## [Return Values](avi_autoscalelaunchconfig_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **obj**  dictionary | AutoScaleLaunchConfig (api/autoscalelaunchconfig) object  **Returned:** success, changed |
