...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/openssl_privatekey_pipe_module.html
...
- One can generate [RSA](https://en.wikipedia.org/wiki/RSA_%2528cryptosystem%2529), [DSA](https://en.wikipedia.org/wiki/Digital_Signature_Algorithm), [ECC](https://en.wikipedia.org/wiki/Elliptic-curve_cryptography) or [EdDSA](https://en.wikipedia.org/wiki/EdDSA) private keys.
