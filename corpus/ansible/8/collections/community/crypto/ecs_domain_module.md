...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/ecs_domain_module.html
fetched_at: 2026-07-28T01:42:26+00:00
---
...
| **ov_eligible**  boolean | Whether the domain is eligible for submission of “OV” certificates. Will never be `false` if `ev_eligible` is `true`  **Returned:** success and `domain_status` is `APPROVED`, `RE_VERIFICATION`, `EXPIRING`, or `EXPIRED`.  **Sample:** `true` |
