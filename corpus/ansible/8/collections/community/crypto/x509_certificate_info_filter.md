...
collection: ansible
version: "8"
title: "community.crypto.x509_certificate_info filter – Retrieve information from X.509 certificates in PEM format"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/x509_certificate_info_filter.html
...
> see [Requirements](x509_certificate_info_filter.md#ansible-collections-community-crypto-x509-certificate-info-filter-requirements) for details.
>
> To use it in a playbook, specify: `community.crypto.x509_certificate_info`.

New in community.crypto 2.10.0

- [Synopsis](x509_certificate_info_filter.md#synopsis)
- [Requirements](x509_certificate_info_filter.md#requirements)
- [Input](x509_certificate_info_filter.md#input)
- [Keyword parameters](x509_certificate_info_filter.md#keyword-parameters)
- [See Also](x509_certificate_info_filter.md#see-also)
- [Examples](x509_certificate_info_filter.md#examples)
- [Return Value](x509_certificate_info_filter.md#return-value)

## [Synopsis](x509_certificate_info_filter.md#id1)

- Provided a X.509 certificate in PEM format, retrieve information.
- This is a filter version of the [community.crypto.x509_certificate_info](x509_certificate_info_module.md#ansible-collections-community-crypto-x509-certificate-info-module) module.

## [Requirements](x509_certificate_info_filter.md#id2)
...
## [Input](x509_certificate_info_filter.md#id3)
...
## [Keyword parameters](x509_certificate_info_filter.md#id4)
...
## [See Also](x509_certificate_info_filter.md#id5)

> **See also:**
>
> [community.crypto.x509_certificate_info](x509_certificate_info_module.md#ansible-collections-community-crypto-x509-certificate-info-module)
> :   Provide information of OpenSSL X.509 certificates.

## [Examples](x509_certificate_info_filter.md#id6)
...
## [Return Value](x509_certificate_info_filter.md#id7)
...
| **issuer_uri**  string | The Issuer URI, if included in the certificate. Will be `none` if no issuer URI is included.  **Returned:** success |
...
| **public_key**  string | Certificate’s public key in PEM format.  **Returned:** success  **Sample:** `"-----BEGIN PUBLIC KEY----- MIICIjANBgkqhkiG9w0BAQEFAAOCAg8A..."` |
...
| **public_key_type**  string | The certificate’s public key’s type.  One of `RSA`, `DSA`, `ECC`, `Ed25519`, `X25519`, `Ed448`, or `X448`.  Will start with `unknown` if the key type cannot be determined.  **Returned:** success  **Sample:** `"RSA"` |
