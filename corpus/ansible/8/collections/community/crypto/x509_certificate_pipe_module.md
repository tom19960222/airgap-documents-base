...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/x509_certificate_pipe_module.html
...
| **privatekey_content**  string | Content of the private key to use when signing the certificate.  This is mutually exclusive with `privatekey_path`. |
