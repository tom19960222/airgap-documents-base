...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/openssl_csr_pipe_module.html
fetched_at: 2026-07-28T01:42:31+00:00
---
...
| **privatekey_path**  path | The path to the private key to use when signing the certificate signing request.  Either `privatekey_path` or `privatekey_content` must be specified, but not both. |
