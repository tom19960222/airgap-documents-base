...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/crypto/openssl_csr_info_module.html
...
> :   Generate OpenSSL Certificate Signing Request (CSR).
>
> [community.crypto.openssl_csr_info](openssl_csr_info_filter.md#ansible-collections-community-crypto-openssl-csr-info-filter) filter plugin
