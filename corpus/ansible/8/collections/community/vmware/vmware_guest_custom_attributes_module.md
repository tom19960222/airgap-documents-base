...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_guest_custom_attributes_module.html
...
| **state**  string | The action to take.  If set to `present`, then custom attribute is added or updated.  If set to `absent`, then custom attribute value is removed.  **Choices:**   - `"present"` ← (default) - `"absent"` |
