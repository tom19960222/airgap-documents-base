...
collection: ansible
version: "8"
title: "community.vmware.vmware_guest_disk_info module – Gather info about disks of given virtual machine"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_guest_disk_info_module.html
fetched_at: 2026-07-28T02:00:12+00:00
---
...
- [Synopsis](vmware_guest_disk_info_module.md#synopsis)
- [Parameters](vmware_guest_disk_info_module.md#parameters)
- [Notes](vmware_guest_disk_info_module.md#notes)
- [Examples](vmware_guest_disk_info_module.md#examples)
- [Return Values](vmware_guest_disk_info_module.md#return-values)

## [Synopsis](vmware_guest_disk_info_module.md#id1)

- This module can be used to gather information about disks belonging to given virtual machine.
- All parameters and VMware object names are case sensitive.

## [Parameters](vmware_guest_disk_info_module.md#id2)
...
## [Notes](vmware_guest_disk_info_module.md#id3)

> **Note:**
>
> - All modules requires API write access and hence is not supported on a free ESXi license.

## [Examples](vmware_guest_disk_info_module.md#id4)
