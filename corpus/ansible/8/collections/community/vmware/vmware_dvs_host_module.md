...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_dvs_host_module.html
...
| **lag_uplinks**  list / elements=dictionary | The ESXi hosts vmnics to use with specific LAGs.  **Default:** `[]` |
