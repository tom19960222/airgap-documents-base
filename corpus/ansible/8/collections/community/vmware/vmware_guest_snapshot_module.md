...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_guest_snapshot_module.html
...
| **snapshot_id**  integer  *added in community.vmware 3.10.0* | Sets the snapshot id to manage.  This param is available when state is `absent`. |
