...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_vcenter_settings_module.html
...
| Parameter | Comments |
| --- | --- |
| **advanced_settings**  dictionary | A dictionary of advanced settings.  **Default:** `{}` |
