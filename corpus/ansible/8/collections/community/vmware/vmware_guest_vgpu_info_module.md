...
collection: ansible
version: "8"
title: "community.vmware.vmware_guest_vgpu_info module – Gather information about vGPU profiles of the specified virtual machine in the given vCenter infrastructure"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_guest_vgpu_info_module.html
...
>
> To use it in a playbook, specify: `community.vmware.vmware_guest_vgpu_info`.

New in community.vmware 3.3.0

- [Synopsis](vmware_guest_vgpu_info_module.md#synopsis)
- [Parameters](vmware_guest_vgpu_info_module.md#parameters)
- [Notes](vmware_guest_vgpu_info_module.md#notes)
- [Examples](vmware_guest_vgpu_info_module.md#examples)
- [Return Values](vmware_guest_vgpu_info_module.md#return-values)

## [Synopsis](vmware_guest_vgpu_info_module.md#id1)

- This module is used to gather metadata about vGPU profiles of the given virtual machine.
- All parameters and VMware object names are case sensitive.

## [Parameters](vmware_guest_vgpu_info_module.md#id2)
...
## [Notes](vmware_guest_vgpu_info_module.md#id3)

> **Note:**
>
> - All modules requires API write access and hence is not supported on a free ESXi license.

## [Examples](vmware_guest_vgpu_info_module.md#id4)
...
## [Return Values](vmware_guest_vgpu_info_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **vgpu_info**  list / elements=string | metadata about the virtual machine’s vGPU profiles  **Returned:** always  **Sample:** `{"vgpu": [{"Controller_Key": 100, "Key": 13000, "Label": "PCI device 0", "Summary": "NVIDIA GRID vGPU grid_m10-8q", "Unit_Number": 18, "Vgpu": "grid_m10-8q"}]}` |
