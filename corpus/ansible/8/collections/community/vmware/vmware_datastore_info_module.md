...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_datastore_info_module.html
...
| **show_tag**  boolean | Tags related to Datastore are shown if set to `true`.  **Choices:**   - `false` ← (default) - `true` |
