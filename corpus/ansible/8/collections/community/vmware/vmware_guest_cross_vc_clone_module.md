...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_guest_cross_vc_clone_module.html
fetched_at: 2026-07-28T02:00:08+00:00
---
...
| **is_template**  boolean | Specifies whether or not the new virtual machine should be marked as a template.  **Choices:**   - `false` ← (default) - `true` |
...
| **timeout**  integer  *added in community.vmware 3.5.0* | The timeout in seconds. When the timeout is reached, the module will fail.  **Default:** `3600` |
