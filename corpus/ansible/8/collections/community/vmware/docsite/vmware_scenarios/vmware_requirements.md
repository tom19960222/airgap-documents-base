...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/docsite/vmware_scenarios/vmware_requirements.html
fetched_at: 2026-07-28T03:00:58+00:00
---
# VMware Prerequisites

- [ESXi License](vmware_requirements.md#esxi-license)
- [Installing SSL Certificates](vmware_requirements.md#installing-ssl-certificates)

  - [Installing vCenter SSL certificates for Ansible](vmware_requirements.md#installing-vcenter-ssl-certificates-for-ansible)
  - [Installing ESXi SSL certificates for Ansible](vmware_requirements.md#installing-esxi-ssl-certificates-for-ansible)
  - [Using custom path for SSL certificates](vmware_requirements.md#using-custom-path-for-ssl-certificates)

## [ESXi License](vmware_requirements.md#id1)
...
Please check [this blog post](https://blogs.vmware.com/vsphere/2012/02/introduction-to-the-vsphere-api-part-1.html) for more details.

## [Installing SSL Certificates](vmware_requirements.md#id2)
...
### [Installing vCenter SSL certificates for Ansible](vmware_requirements.md#id3)
...
### [Installing ESXi SSL certificates for Ansible](vmware_requirements.md#id4)

- Enable SSH Service on ESXi either by using Ansible VMware module [vmware_host_service_manager](https://github.com/ansible-collections/vmware/blob/main/plugins/modules/vmware_host_config_manager.py) or manually using vSphere Web interface.
...
### [Using custom path for SSL certificates](vmware_requirements.md#id5)
...
For example, if `/var/vmware/certs/vcenter1.crt` is the SSL certificate for your vCenter Server, you can use the [environment](../../../../../playbook_guide/playbooks_environment.md#playbooks-environment) keyword to pass it to the modules:
