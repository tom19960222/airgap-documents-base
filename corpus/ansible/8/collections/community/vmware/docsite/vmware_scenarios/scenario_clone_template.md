...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/docsite/vmware_scenarios/scenario_clone_template.html
fetched_at: 2026-07-28T03:01:19+00:00
---
# Deploy a virtual machine from a template

- [Introduction](scenario_clone_template.md#introduction)
- [Scenario requirements](scenario_clone_template.md#scenario-requirements)
- [Assumptions](scenario_clone_template.md#assumptions)
- [Caveats](scenario_clone_template.md#caveats)
- [Example description](scenario_clone_template.md#example-description)

  - [What to expect](scenario_clone_template.md#what-to-expect)
  - [Troubleshooting](scenario_clone_template.md#troubleshooting)

## [Introduction](scenario_clone_template.md#id1)
...
## [Scenario requirements](scenario_clone_template.md#id2)
...
## [Assumptions](scenario_clone_template.md#id3)
...
## [Caveats](scenario_clone_template.md#id4)
...
## [Example description](scenario_clone_template.md#id5)
...
To begin, there are a few bits of information we will need. First and foremost is the hostname of the ESXi server or vCenter server. After this, you will need the username and password for this server. For now, you will be entering these directly, but in a more advanced playbook this can be abstracted out and stored in a more secure fashion using [ansible-vault](../../../../../cli/ansible-vault.md#ansible-vault) or using [Ansible Tower credentials](https://docs.ansible.com/ansible-tower/latest/html/userguide/credentials.html). If your vCenter or ESXi server is not setup with proper CA certificates that can be verified from the Ansible server, then it is necessary to disable validation of these certificates by using the `validate_certs` parameter. To do this you need to set `validate_certs=False` in your playbook.
...
### [What to expect](scenario_clone_template.md#id6)
...
### [Troubleshooting](scenario_clone_template.md#id7)
