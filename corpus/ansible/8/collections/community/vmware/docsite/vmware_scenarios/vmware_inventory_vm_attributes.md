...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/docsite/vmware_scenarios/vmware_inventory_vm_attributes.html
fetched_at: 2026-07-28T03:00:59+00:00
---
...
> Indicates whether [memoryReservationLockedToMax (bool, optional)](vmware_inventory_vm_attributes.md#ansible-collections-community-vmware-docsite-memory-reservation-locked-to-max) may be set to true for the virtual machine.
...
> This is the full name of the guest operating system for the virtual machine. For example: Windows 2000 Professional. See [alternateGuestName (str)](vmware_inventory_vm_attributes.md#ansible-collections-community-vmware-docsite-alternate-guest-name).
...
> Used as display name for the operating system if guestId isotherorother-64. See [guestFullName (str)](vmware_inventory_vm_attributes.md#ansible-collections-community-vmware-docsite-guest-full-name).
...
> See [guestFullName (str)](vmware_inventory_vm_attributes.md#ansible-collections-community-vmware-docsite-guest-full-name).
