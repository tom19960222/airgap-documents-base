...
collection: ansible
version: "8"
title: "Remove an existing VMware virtual machine"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/docsite/vmware_scenarios/scenario_remove_vm.html
fetched_at: 2026-07-28T03:01:21+00:00
---
# Remove an existing VMware virtual machine

- [Introduction](scenario_remove_vm.md#introduction)
- [Scenario requirements](scenario_remove_vm.md#scenario-requirements)
- [Caveats](scenario_remove_vm.md#caveats)
- [Example description](scenario_remove_vm.md#example-description)

  - [What to expect](scenario_remove_vm.md#what-to-expect)
  - [Troubleshooting](scenario_remove_vm.md#troubleshooting)

## [Introduction](scenario_remove_vm.md#id1)

This guide will show you how to utilize Ansible to remove an existing VMware virtual machine.

## [Scenario requirements](scenario_remove_vm.md#id2)
...
## [Caveats](scenario_remove_vm.md#id3)
...
## [Example description](scenario_remove_vm.md#id4)
...
### [What to expect](scenario_remove_vm.md#id5)
...
### [Troubleshooting](scenario_remove_vm.md#id6)
