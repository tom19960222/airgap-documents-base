...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_resource_pool_module.html
...
| **cpu_allocation_shares**  integer | The number of cpu shares allocated.  This value is only set if *cpu_shares* is set to `custom`.  **Default:** `4000` |
...
| **mem_allocation_shares**  integer | The number of memory shares allocated.  This value is only set if *mem_shares* is set to `custom`.  **Default:** `163840` |
