...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/vmware/vmware_dvs_portgroup_info_module.html
fetched_at: 2026-07-28T01:59:57+00:00
---
...
| **show_mac_learning**  boolean | Show or hide MAC learning information of the DVS portgroup.  **Choices:**   - `false` - `true` ← (default) |
...
| **show_uplinks**  boolean | Show or hide uplinks of DVS portgroup.  **Choices:**   - `false` - `true` ← (default) |
...
| Key | Description |
| --- | --- |
| **dvs_portgroup_info**  dictionary | metadata about DVS portgroup configuration  **Returned:** on success  **Sample:** `{"dvs_0": [{"active_uplinks": ["uplink 1"], "description": null, "dvswitch_name": "dvs_001", "key": "dvportgroup-1014", "mac_learning": {"allow_unicast_flooding": null, "enabled": false, "limit": null, "limit_policy": null}, "moid": "dvportgroup-1014", "network_policy": {"forged_transmits": false, "mac_changes": false, "promiscuous": false}, "num_ports": 8, "port_allocation": "elastic", "port_binding": "static", "port_policy": {"block_override": true, "ipfix_override": false, "live_port_move": false, "network_rp_override": false, "port_config_reset_at_disconnect": true, "security_override": false, "shaping_override": false, "traffic_filter_override": false, "uplink_teaming_override": false, "vendor_config_override": false, "vlan_override": false}, "portgroup_name": "dvpg_001", "standby_uplinks": [], "teaming_policy": {"inbound_policy": true, "notify_switches": true, "policy": "loadbalance_srcid", "rolling_order": false}, "type": "earlyBinding", "vlan_info": {"pvlan": false, "trunk": false, "vlan_id": 0}}]}` |
