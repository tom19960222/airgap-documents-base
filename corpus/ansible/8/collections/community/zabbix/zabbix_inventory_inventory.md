...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/zabbix/zabbix_inventory_inventory.html
...
> **Note:**
>
> This inventory plugin is part of the [community.zabbix collection](https://galaxy.ansible.com/ui/repo/published/community/zabbix/) (version 2.2.0).
>
...
| **auth_token**  string | Zabbix authentication token (see <https://www.zabbix.com/documentation/current/en/manual/web_interface/frontend_sections/users/api_tokens>)  If provided then `login_user` and `login_password` are ignored |
