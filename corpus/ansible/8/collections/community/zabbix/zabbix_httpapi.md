...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/zabbix/zabbix_httpapi.html
fetched_at: 2026-07-28T02:03:01+00:00
---
# community.zabbix.zabbix httpapi – HttpApi Plugin for Zabbix

> **Note:**
>
> This httpapi plugin is part of the [community.zabbix collection](https://galaxy.ansible.com/ui/repo/published/community/zabbix/) (version 2.2.0).
>
...
| Parameter | Comments |
| --- | --- |
| **http_login_password**  string | The http password to access zabbix url with Basic Auth  **Configuration:**   - Variable: http_login_password |
| **http_login_user**  string | The http user to access zabbix url with Basic Auth  **Configuration:**   - Variable: http_login_user |
