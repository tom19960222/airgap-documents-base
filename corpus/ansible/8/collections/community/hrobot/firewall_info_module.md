...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hrobot/firewall_info_module.html
...
| **filter_ipv6**  boolean | Whether the firewall rules apply to IPv6 as well or not.  **Returned:** success  **Sample:** `false` |
