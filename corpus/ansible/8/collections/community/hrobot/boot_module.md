...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hrobot/boot_module.html
fetched_at: 2026-07-28T01:53:41+00:00
---
...
| **password**  string | The root password for the active boot configuration, if available.  For non-rescue boot configurations, it is avised to change the root password as soon as possible.  **Returned:** success and if `configuration_type` is not `regular_boot` |
