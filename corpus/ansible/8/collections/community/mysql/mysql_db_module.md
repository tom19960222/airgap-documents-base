...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/mysql/mysql_db_module.html
fetched_at: 2026-07-28T01:54:09+00:00
---
...
- [Attributes](mysql_db_module.md#attributes)
...
## [Attributes](mysql_db_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](mysql_db_module.md#id5)
...
## [See Also](mysql_db_module.md#id6)
...
## [Examples](mysql_db_module.md#id7)
...
## [Return Values](mysql_db_module.md#id8)
