...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/mysql/mysql_query_module.html
...
- [Attributes](mysql_query_module.md#attributes)
...
| **query**  any / required | SQL query to run. Multiple queries can be passed using YAML list syntax.  Must be a string or YAML list containing strings.  If you use *named_args* or *positional_args* any `%` will be interpreted as a formatting character. All literal `%` characters in the query should be escaped as `%%`.  Note that if you use the `IF EXISTS/IF NOT EXISTS` clauses in your query and `mysqlclient` or `PyMySQL 0.10.0+` connectors, the module will report that the state has been changed even if it has not. If it is important in your workflow, use the `PyMySQL 0.9.3` connector instead. |
...
## [Attributes](mysql_query_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **none** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](mysql_query_module.md#id5)
...
## [See Also](mysql_query_module.md#id6)
...
## [Examples](mysql_query_module.md#id7)
...
## [Return Values](mysql_query_module.md#id8)
