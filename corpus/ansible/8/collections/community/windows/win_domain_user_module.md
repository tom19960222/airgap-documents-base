...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/windows/win_domain_user_module.html
fetched_at: 2026-07-28T02:01:50+00:00
---
...
| **display_name**  string  *added in community.windows 1.12.0* | Configures the user’s display name. |
...
| **display_name**  string | The user display name  **Returned:** always  **Sample:** `"Nick Doe"` |
