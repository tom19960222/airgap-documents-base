...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/windows/win_psmodule_module.html
fetched_at: 2026-07-28T02:02:13+00:00
---
...
| **force**  boolean  *added in community.windows 1.13.0* | Overrides warning messages about module installation conflicts  If there is an existing module with the same name and version, force overwrites that version  Corresponds to the `-Force` parameter of `Install-Module`.  If module as dependency, it will also force reinstallation of dependency. Updating them to latest if version isn’t specified in module manifest.  **Choices:**   - `false` ← (default) - `true` |
