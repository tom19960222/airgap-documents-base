...
collection: ansible
version: "8"
title: "community.aws.aws_mq inventory – MQ broker inventory source"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/aws_mq_inventory.html
fetched_at: 2026-07-28T01:42:15+00:00
---
# community.aws.aws_mq inventory – MQ broker inventory source

> **Note:**
>
> This inventory plugin is part of the [community.aws collection](https://galaxy.ansible.com/ui/repo/published/community/aws/) (version 6.4.0).
>
...
> see [Requirements](aws_mq_inventory.md#ansible-collections-community-aws-aws-mq-inventory-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.aws_mq`.

New in community.aws 6.1.0

- [Synopsis](aws_mq_inventory.md#synopsis)
- [Requirements](aws_mq_inventory.md#requirements)
- [Parameters](aws_mq_inventory.md#parameters)
- [Notes](aws_mq_inventory.md#notes)
- [Examples](aws_mq_inventory.md#examples)

## [Synopsis](aws_mq_inventory.md#id1)

- Get brokers from Amazon Web Services MQ.
- Uses a YAML configuration file that ends with aws_mq.(yml|yaml).

## [Requirements](aws_mq_inventory.md#id2)
...
## [Examples](aws_mq_inventory.md#id5)
