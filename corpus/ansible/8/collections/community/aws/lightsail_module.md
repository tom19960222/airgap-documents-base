...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/lightsail_module.html
...
| **public_ports**  list / elements=dictionary  *added in community.aws 6.0.0* | A list of dictionaries to describe the ports to open for the specified instance. |
| **cidrs**  list / elements=string | The IPv4 address, or range of IPv4 addresses (in CIDR notation) that are allowed to connect to the instance through the ports, and the protocol.  One of *cidrs* or *ipv6_cidrs* must be specified. |
| **from_port**  integer / required | The first port in a range of open ports on the instance. |
| **ipv6_cidrs**  list / elements=string | The IPv6 address, or range of IPv6 addresses (in CIDR notation) that are allowed to connect to the instance through the ports, and the protocol.  One of *cidrs* or *ipv6_cidrs* must be specified. |
| **protocol**  string / required | The IP protocol name accepted for the defined range of open ports.  **Choices:**   - `"tcp"` - `"all"` - `"udp"` - `"icmp"` |
| **to_port**  integer / required | The last port in a range of open ports on the instance. |
...
| **user_data**  string | Launch script that can configure the instance with additional data.  **Default:** `""` |
