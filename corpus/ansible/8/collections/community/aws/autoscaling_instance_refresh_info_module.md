...
collection: ansible
version: "8"
title: "community.aws.autoscaling_instance_refresh_info module – Gather information about EC2 Auto Scaling Group (ASG) Instance Refreshes in AWS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/autoscaling_instance_refresh_info_module.html
...
> see [Requirements](autoscaling_instance_refresh_info_module.md#ansible-collections-community-aws-autoscaling-instance-refresh-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.autoscaling_instance_refresh_info`.

New in community.aws 3.2.0

- [Synopsis](autoscaling_instance_refresh_info_module.md#synopsis)
- [Requirements](autoscaling_instance_refresh_info_module.md#requirements)
- [Parameters](autoscaling_instance_refresh_info_module.md#parameters)
- [Notes](autoscaling_instance_refresh_info_module.md#notes)
- [Examples](autoscaling_instance_refresh_info_module.md#examples)
- [Return Values](autoscaling_instance_refresh_info_module.md#return-values)

## [Synopsis](autoscaling_instance_refresh_info_module.md#id1)
...
Aliases: ec2_asg_instance_refresh_info

## [Requirements](autoscaling_instance_refresh_info_module.md#id2)
...
## [Parameters](autoscaling_instance_refresh_info_module.md#id3)
...
## [Notes](autoscaling_instance_refresh_info_module.md#id4)
...
## [Examples](autoscaling_instance_refresh_info_module.md#id5)
...
## [Return Values](autoscaling_instance_refresh_info_module.md#id6)
