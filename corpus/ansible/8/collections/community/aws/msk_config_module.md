...
collection: ansible
version: "8"
title: "community.aws.msk_config module – Manage Amazon MSK cluster configurations"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/msk_config_module.html
...
> see [Requirements](msk_config_module.md#ansible-collections-community-aws-msk-config-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.msk_config`.

New in community.aws 2.0.0

- [Synopsis](msk_config_module.md#synopsis)
- [Requirements](msk_config_module.md#requirements)
- [Parameters](msk_config_module.md#parameters)
- [Notes](msk_config_module.md#notes)
- [Examples](msk_config_module.md#examples)
- [Return Values](msk_config_module.md#return-values)

## [Synopsis](msk_config_module.md#id1)
...
Aliases: aws_msk_config

## [Requirements](msk_config_module.md#id2)
...
## [Parameters](msk_config_module.md#id3)
...
| **config**  aliases: configuration  dictionary | Contents of the server.properties file.  **Default:** `{}` |
| **debug_botocore_endpoint_logs**  boolean | Use a `botocore.endpoint` logger to parse the unique (rather than total) `"resource:action"` API calls made during a task, outputing the set to the resource_actions key in the task results. Use the `aws_resource_action` callback to output to total list made during a playbook.  The `ANSIBLE_DEBUG_BOTOCORE_LOGS` environment variable may also be used.  **Choices:**   - `false` ← (default) - `true` |
| **description**  string | The description of the configuration.  **Default:** `""` |
...
## [Notes](msk_config_module.md#id4)
...
## [Examples](msk_config_module.md#id5)
...
## [Return Values](msk_config_module.md#id6)
