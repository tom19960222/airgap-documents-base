...
collection: ansible
version: "8"
title: "community.aws.api_gateway_domain module – Manage AWS API Gateway custom domains"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/api_gateway_domain_module.html
...
> see [Requirements](api_gateway_domain_module.md#ansible-collections-community-aws-api-gateway-domain-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.api_gateway_domain`.

New in community.aws 3.3.0

- [Synopsis](api_gateway_domain_module.md#synopsis)
- [Requirements](api_gateway_domain_module.md#requirements)
- [Parameters](api_gateway_domain_module.md#parameters)
- [Notes](api_gateway_domain_module.md#notes)
- [Examples](api_gateway_domain_module.md#examples)
- [Return Values](api_gateway_domain_module.md#return-values)

## [Synopsis](api_gateway_domain_module.md#id1)
...
## [Requirements](api_gateway_domain_module.md#id2)
...
## [Parameters](api_gateway_domain_module.md#id3)
...
## [Notes](api_gateway_domain_module.md#id4)

> **Note:**
>
> - Does not create a DNS entry on Route53, for that use the [community.aws.route53](route53_module.md#ansible-collections-community-aws-route53-module) module.
...
## [Examples](api_gateway_domain_module.md#id5)
...
## [Return Values](api_gateway_domain_module.md#id6)
