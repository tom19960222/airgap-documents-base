...
collection: ansible
version: "8"
title: "community.aws.config_rule module – Manage AWS Config rule resources"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/config_rule_module.html
...
> see [Requirements](config_rule_module.md#ansible-collections-community-aws-config-rule-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.config_rule`.

New in community.aws 1.0.0

- [Synopsis](config_rule_module.md#synopsis)
- [Requirements](config_rule_module.md#requirements)
- [Parameters](config_rule_module.md#parameters)
- [Notes](config_rule_module.md#notes)
- [Examples](config_rule_module.md#examples)

## [Synopsis](config_rule_module.md#id1)

- Module manages AWS Config rules.
- Prior to release 5.0.0 this module was called `community.aws.aws_config_rule`. The usage did not change.

Aliases: aws_config_rule

## [Requirements](config_rule_module.md#id2)
...
## [Parameters](config_rule_module.md#id3)
...
## [Notes](config_rule_module.md#id4)
...
## [Examples](config_rule_module.md#id5)
