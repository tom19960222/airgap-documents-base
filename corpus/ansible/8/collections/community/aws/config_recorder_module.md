...
collection: ansible
version: "8"
title: "community.aws.config_recorder module – Manage AWS Config Recorders"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/config_recorder_module.html
fetched_at: 2026-07-28T01:40:29+00:00
---
...
> see [Requirements](config_recorder_module.md#ansible-collections-community-aws-config-recorder-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.config_recorder`.

New in community.aws 1.0.0

- [Synopsis](config_recorder_module.md#synopsis)
- [Requirements](config_recorder_module.md#requirements)
- [Parameters](config_recorder_module.md#parameters)
- [Notes](config_recorder_module.md#notes)
- [Examples](config_recorder_module.md#examples)

## [Synopsis](config_recorder_module.md#id1)
...
Aliases: aws_config_recorder

## [Requirements](config_recorder_module.md#id2)
...
## [Parameters](config_recorder_module.md#id3)
...
## [Notes](config_recorder_module.md#id4)
...
## [Examples](config_recorder_module.md#id5)
