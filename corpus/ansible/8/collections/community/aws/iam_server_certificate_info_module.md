...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/iam_server_certificate_info_module.html
...
| Key | Description |
| --- | --- |
| **arn**  string | The Amazon resource name of the server certificate  **Returned:** success  **Sample:** `"arn:aws:iam::123456789012:server-certificate/server-cert-name"` |
| **certificate_body**  string | The asn1der encoded PEM string  **Returned:** success  **Sample:** `"-----BEGIN CERTIFICATE-----\nbunch of random data\n-----END CERTIFICATE-----"` |
