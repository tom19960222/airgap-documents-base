...
collection: ansible
version: "8"
title: "community.aws.autoscaling_instance_refresh module – Start or cancel an EC2 Auto Scaling Group (ASG) instance refresh in AWS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/autoscaling_instance_refresh_module.html
fetched_at: 2026-07-28T01:40:09+00:00
---
...
> see [Requirements](autoscaling_instance_refresh_module.md#ansible-collections-community-aws-autoscaling-instance-refresh-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.autoscaling_instance_refresh`.

New in community.aws 3.2.0

- [Synopsis](autoscaling_instance_refresh_module.md#synopsis)
- [Requirements](autoscaling_instance_refresh_module.md#requirements)
- [Parameters](autoscaling_instance_refresh_module.md#parameters)
- [Notes](autoscaling_instance_refresh_module.md#notes)
- [Examples](autoscaling_instance_refresh_module.md#examples)
- [Return Values](autoscaling_instance_refresh_module.md#return-values)

## [Synopsis](autoscaling_instance_refresh_module.md#id1)

- Start or cancel an EC2 Auto Scaling Group instance refresh in AWS.
- Can be used with [community.aws.autoscaling_instance_refresh_info](autoscaling_instance_refresh_info_module.md#ansible-collections-community-aws-autoscaling-instance-refresh-info-module) to track the subsequent progress.
...
## [Requirements](autoscaling_instance_refresh_module.md#id2)
...
## [Parameters](autoscaling_instance_refresh_module.md#id3)
...
## [Notes](autoscaling_instance_refresh_module.md#id4)
...
## [Examples](autoscaling_instance_refresh_module.md#id5)
...
## [Return Values](autoscaling_instance_refresh_module.md#id6)
