...
collection: ansible
version: "8"
title: "community.aws.application_autoscaling_policy module – Manage Application Auto Scaling Scaling Policies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/application_autoscaling_policy_module.html
fetched_at: 2026-07-28T01:40:07+00:00
---
...
> see [Requirements](application_autoscaling_policy_module.md#ansible-collections-community-aws-application-autoscaling-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.application_autoscaling_policy`.

New in community.aws 1.0.0

- [Synopsis](application_autoscaling_policy_module.md#synopsis)
- [Requirements](application_autoscaling_policy_module.md#requirements)
- [Parameters](application_autoscaling_policy_module.md#parameters)
- [Notes](application_autoscaling_policy_module.md#notes)
- [Examples](application_autoscaling_policy_module.md#examples)
- [Return Values](application_autoscaling_policy_module.md#return-values)

## [Synopsis](application_autoscaling_policy_module.md#id1)
...
## [Requirements](application_autoscaling_policy_module.md#id2)
...
## [Parameters](application_autoscaling_policy_module.md#id3)
...
## [Notes](application_autoscaling_policy_module.md#id4)
...
## [Examples](application_autoscaling_policy_module.md#id5)
...
## [Return Values](application_autoscaling_policy_module.md#id6)
...
| **role_arn**  string | The ARN of an IAM role that allows Application Auto Scaling to modify the scalable target on your behalf. Required if *state* is `present`.  **Returned:** when state present  **Sample:** `"arn:aws:iam::123456789012:role/roleName"` |
