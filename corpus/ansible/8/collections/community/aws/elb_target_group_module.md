...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/elb_target_group_module.html
fetched_at: 2026-07-28T01:41:14+00:00
---
...
| **protocol_version**  string  *added in community.aws 5.1.0* | Specifies protocol version.  The protocol_version parameter is immutable and cannot be changed when updating an elb_target_group.  **Choices:**   - `"GRPC"` - `"HTTP1"` - `"HTTP2"` |
...
| **target_group_arn**  string | The Amazon Resource Name (ARN) of the target group.  **Returned:** when state present  **Sample:** `"arn:aws:elasticloadbalancing:ap-southeast-2:123456789012:targetgroup/mytargetgroup/aabbccddee0044332211"` |
