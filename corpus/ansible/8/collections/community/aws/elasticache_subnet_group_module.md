...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/elasticache_subnet_group_module.html
...
| **arn**  string | The Amazon Resource Name (ARN) of the cache subnet group.  **Returned:** when the subnet group exists  **Sample:** `"arn:aws:elasticache:us-east-1:123456789012:subnetgroup:norwegian-blue"` |
