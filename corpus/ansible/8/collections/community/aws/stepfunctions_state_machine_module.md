...
collection: ansible
version: "8"
title: "community.aws.stepfunctions_state_machine module – Manage AWS Step Functions state machines"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/stepfunctions_state_machine_module.html
fetched_at: 2026-07-28T01:42:00+00:00
---
...
> see [Requirements](stepfunctions_state_machine_module.md#ansible-collections-community-aws-stepfunctions-state-machine-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.stepfunctions_state_machine`.

New in community.aws 1.0.0

- [Synopsis](stepfunctions_state_machine_module.md#synopsis)
- [Requirements](stepfunctions_state_machine_module.md#requirements)
- [Parameters](stepfunctions_state_machine_module.md#parameters)
- [Notes](stepfunctions_state_machine_module.md#notes)
- [Examples](stepfunctions_state_machine_module.md#examples)
- [Return Values](stepfunctions_state_machine_module.md#return-values)

## [Synopsis](stepfunctions_state_machine_module.md#id1)
...
Aliases: aws_step_functions_state_machine

## [Requirements](stepfunctions_state_machine_module.md#id2)
...
## [Parameters](stepfunctions_state_machine_module.md#id3)
...
| **definition**  json | The Amazon States Language definition of the state machine. See <https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html> for more information on the Amazon States Language.  Required when *state=present*. |
...
## [Notes](stepfunctions_state_machine_module.md#id4)
...
## [Examples](stepfunctions_state_machine_module.md#id5)
...
## [Return Values](stepfunctions_state_machine_module.md#id6)
