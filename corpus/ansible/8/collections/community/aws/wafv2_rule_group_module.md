...
collection: ansible
version: "8"
title: "community.aws.wafv2_rule_group module – wafv2_web_acl"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/wafv2_rule_group_module.html
fetched_at: 2026-07-28T01:42:11+00:00
---
...
> see [Requirements](wafv2_rule_group_module.md#ansible-collections-community-aws-wafv2-rule-group-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.wafv2_rule_group`.

New in community.aws 1.5.0

- [Synopsis](wafv2_rule_group_module.md#synopsis)
- [Requirements](wafv2_rule_group_module.md#requirements)
- [Parameters](wafv2_rule_group_module.md#parameters)
- [Notes](wafv2_rule_group_module.md#notes)
- [Examples](wafv2_rule_group_module.md#examples)
- [Return Values](wafv2_rule_group_module.md#return-values)

## [Synopsis](wafv2_rule_group_module.md#id1)

- Create, modify and delete wafv2 rule groups.

## [Requirements](wafv2_rule_group_module.md#id2)
...
## [Parameters](wafv2_rule_group_module.md#id3)
...
| **cloudwatch_metrics**  boolean | Enable cloudwatch metric for wafv2 rule group  **Choices:**   - `false` - `true` ← (default) |
...
| **sampled_requests**  boolean | Sampled requests, true or false.  **Choices:**   - `false` ← (default) - `true` |
...
## [Notes](wafv2_rule_group_module.md#id4)
...
## [Examples](wafv2_rule_group_module.md#id5)
...
## [Return Values](wafv2_rule_group_module.md#id6)
