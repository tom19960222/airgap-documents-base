...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/ec2_vpc_vgw_module.html
fetched_at: 2026-07-28T01:40:51+00:00
---
...
| **asn**  integer | The BGP ASN on the Amazon side. |
...
| Key | Description |
| --- | --- |
| **vgw**  dictionary | A description of the VGW  **Returned:** success |
| **id**  string | The ID of the VGW.  **Returned:** success  **Sample:** `"vgw-0123456789abcdef0"` |
| **state**  string | The state of the VGW.  **Returned:** success  **Sample:** `"available"` |
| **tags**  dictionary | A dictionary representing the tags attached to the VGW  **Returned:** success  **Sample:** `{"Name": "ansible-test-ec2-vpc-vgw"}` |
| **type**  string | The type of VPN connection the virtual private gateway supports.  **Returned:** success  **Sample:** `"ipsec.1"` |
| **vpc_id**  string | The ID of the VPC to which the VGW is attached.  **Returned:** success  **Sample:** `"vpc-123456789abcdef01"` |
