...
collection: ansible
version: "8"
title: "community.aws.ec2_vpc_peering_info module – Retrieves AWS VPC Peering details using AWS methods."
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/aws/ec2_vpc_peering_info_module.html
fetched_at: 2026-07-28T01:40:50+00:00
---
...
> see [Requirements](ec2_vpc_peering_info_module.md#ansible-collections-community-aws-ec2-vpc-peering-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.aws.ec2_vpc_peering_info`.

New in community.aws 1.0.0

- [Synopsis](ec2_vpc_peering_info_module.md#synopsis)
- [Requirements](ec2_vpc_peering_info_module.md#requirements)
- [Parameters](ec2_vpc_peering_info_module.md#parameters)
- [Notes](ec2_vpc_peering_info_module.md#notes)
- [Examples](ec2_vpc_peering_info_module.md#examples)
- [Return Values](ec2_vpc_peering_info_module.md#return-values)

## [Synopsis](ec2_vpc_peering_info_module.md#id1)

- Gets various details related to AWS VPC Peers

## [Requirements](ec2_vpc_peering_info_module.md#id2)
...
## [Parameters](ec2_vpc_peering_info_module.md#id3)
...
| **filters**  dictionary | A dict of filters to apply. Each dict item consists of a filter key and a filter value. See <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcPeeringConnections.html> for possible filters.  **Default:** `{}` |
...
## [Notes](ec2_vpc_peering_info_module.md#id4)
...
## [Examples](ec2_vpc_peering_info_module.md#id5)
...
## [Return Values](ec2_vpc_peering_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **result**  list / elements=string | The result of the describe.  **Returned:** success |
| **vpc_peering_connections**  list / elements=string | Details of the matching VPC peering connections.  **Returned:** success |
