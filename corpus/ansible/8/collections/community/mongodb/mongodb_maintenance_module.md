...
collection: ansible
version: "8"
title: "community.mongodb.mongodb_maintenance module – Enables or disables maintenance mode for a secondary member."
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/mongodb/mongodb_maintenance_module.html
fetched_at: 2026-07-28T01:53:57+00:00
---
...
> see [Requirements](mongodb_maintenance_module.md#ansible-collections-community-mongodb-mongodb-maintenance-module-requirements) for details.
>
> To use it in a playbook, specify: `community.mongodb.mongodb_maintenance`.

New in community.mongodb 1.0.0

- [Synopsis](mongodb_maintenance_module.md#synopsis)
- [Requirements](mongodb_maintenance_module.md#requirements)
- [Parameters](mongodb_maintenance_module.md#parameters)
- [Notes](mongodb_maintenance_module.md#notes)
- [Examples](mongodb_maintenance_module.md#examples)
- [Return Values](mongodb_maintenance_module.md#return-values)

## [Synopsis](mongodb_maintenance_module.md#id1)
...
## [Requirements](mongodb_maintenance_module.md#id2)

The below requirements are needed on the host that executes this module.

- pymongo

## [Parameters](mongodb_maintenance_module.md#id3)
...
| **maintenance**  boolean | Enable or disable maintenance mode.  **Choices:**   - `false` ← (default) - `true` |
...
## [Notes](mongodb_maintenance_module.md#id4)
...
## [Examples](mongodb_maintenance_module.md#id5)
...
## [Return Values](mongodb_maintenance_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **changed**  boolean | Whether the member was placed into maintenance mode or not.  **Returned:** success |
