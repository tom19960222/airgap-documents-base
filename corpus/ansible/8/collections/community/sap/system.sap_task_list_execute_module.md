...
collection: ansible
version: "8"
title: "community.sap.system.sap_task_list_execute module – Perform SAP Task list execution"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/sap/system.sap_task_list_execute_module.html
fetched_at: 2026-07-28T01:59:13+00:00
---
...
> see [Requirements](system.sap_task_list_execute_module.md#ansible-collections-community-sap-system-sap-task-list-execute-module-requirements) for details.
>
> To use it in a playbook, specify: `community.sap.system.sap_task_list_execute`.

New in community.sap 0.1.0

- [Synopsis](system.sap_task_list_execute_module.md#synopsis)
- [Requirements](system.sap_task_list_execute_module.md#requirements)
- [Parameters](system.sap_task_list_execute_module.md#parameters)
- [Notes](system.sap_task_list_execute_module.md#notes)
- [Examples](system.sap_task_list_execute_module.md#examples)
- [Return Values](system.sap_task_list_execute_module.md#return-values)

## [Synopsis](system.sap_task_list_execute_module.md#id1)

- The [community.sap.sap_task_list_execute](sap_task_list_execute_module.md#ansible-collections-community-sap-sap-task-list-execute-module) module depends on `pyrfc` Python library (version 2.4.0 and upwards). Depending on distribution you are using, you may need to install additional packages to have these available.
...
## [Requirements](system.sap_task_list_execute_module.md#id2)
...
## [Parameters](system.sap_task_list_execute_module.md#id3)
...
## [Notes](system.sap_task_list_execute_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`. Always returns that the state has changed.

## [Examples](system.sap_task_list_execute_module.md#id5)
...
## [Return Values](system.sap_task_list_execute_module.md#id6)
