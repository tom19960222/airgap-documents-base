...
collection: ansible
version: "8"
title: "community.sap.database.saphana.hana_query module – Execute SQL on HANA"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/sap/database.saphana.hana_query_module.html
fetched_at: 2026-07-28T01:59:09+00:00
---
# community.sap.database.saphana.hana_query module – Execute SQL on HANA
...
>
> To use it in a playbook, specify: `community.sap.database.saphana.hana_query`.

New in community.sap 0.1.0

- [Synopsis](database.saphana.hana_query_module.md#synopsis)
- [Parameters](database.saphana.hana_query_module.md#parameters)
- [Notes](database.saphana.hana_query_module.md#notes)
- [Examples](database.saphana.hana_query_module.md#examples)
- [Return Values](database.saphana.hana_query_module.md#return-values)

## [Synopsis](database.saphana.hana_query_module.md#id1)

- This module executes SQL statements on HANA with hdbsql.

Aliases: hana_query

## [Parameters](database.saphana.hana_query_module.md#id2)
...
## [Return Values](database.saphana.hana_query_module.md#id5)
