...
collection: ansible
version: "8"
title: "community.sap.files.sapcar_extract module – Manages SAP SAPCAR archives"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/sap/files.sapcar_extract_module.html
...
- [Synopsis](files.sapcar_extract_module.md#synopsis)
- [Parameters](files.sapcar_extract_module.md#parameters)
- [Notes](files.sapcar_extract_module.md#notes)
- [Examples](files.sapcar_extract_module.md#examples)

## [Synopsis](files.sapcar_extract_module.md#id1)
...
## [Parameters](files.sapcar_extract_module.md#id2)
...
## [Notes](files.sapcar_extract_module.md#id3)

> **Note:**
>
> - Always returns `changed=true` in `check_mode`.

## [Examples](files.sapcar_extract_module.md#id4)
