...
collection: ansible
version: "8"
title: "community.sap.system.sap_snote module – This module will upload and (de)implements SNOTES in a SAP S4HANA environment."
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/sap/system.sap_snote_module.html
fetched_at: 2026-07-28T01:59:11+00:00
---
# community.sap.system.sap_snote module – This module will upload and (de)implements `SNOTES` in a SAP S4HANA environment.
...
> see [Requirements](system.sap_snote_module.md#ansible-collections-community-sap-system-sap-snote-module-requirements) for details.
>
> To use it in a playbook, specify: `community.sap.system.sap_snote`.

New in community.sap 1.0.0

- [Synopsis](system.sap_snote_module.md#synopsis)
- [Requirements](system.sap_snote_module.md#requirements)
- [Parameters](system.sap_snote_module.md#parameters)
- [Examples](system.sap_snote_module.md#examples)
- [Return Values](system.sap_snote_module.md#return-values)

## [Synopsis](system.sap_snote_module.md#id1)
...
## [Requirements](system.sap_snote_module.md#id2)

The below requirements are needed on the host that executes this module.

- pyrfc >= 2.4.0

## [Parameters](system.sap_snote_module.md#id3)
...
## [Examples](system.sap_snote_module.md#id4)
...
## [Return Values](system.sap_snote_module.md#id5)
