...
collection: ansible
version: "8"
title: "community.docker.docker_container_info module – Retrieves facts about docker container"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/docker/docker_container_info_module.html
...
> see [Requirements](docker_container_info_module.md#ansible-collections-community-docker-docker-container-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.docker.docker_container_info`.

- [Synopsis](docker_container_info_module.md#synopsis)
- [Requirements](docker_container_info_module.md#requirements)
- [Parameters](docker_container_info_module.md#parameters)
- [Attributes](docker_container_info_module.md#attributes)
- [Notes](docker_container_info_module.md#notes)
- [Examples](docker_container_info_module.md#examples)
- [Return Values](docker_container_info_module.md#return-values)

## [Synopsis](docker_container_info_module.md#id1)

- Retrieves facts about a docker container.
- Essentially returns the output of `docker inspect <name>`, similar to what [community.docker.docker_container](docker_container_module.md#ansible-collections-community-docker-docker-container-module) returns for a non-absent container.

## [Requirements](docker_container_info_module.md#id2)
...
## [Parameters](docker_container_info_module.md#id3)
...
| **name**  string / required | The name of the container to inspect.  When identifying an existing container name may be a name or a long or short container ID. |
...
## [Attributes](docker_container_info_module.md#id4)
...
## [Notes](docker_container_info_module.md#id5)
...
## [Examples](docker_container_info_module.md#id6)
