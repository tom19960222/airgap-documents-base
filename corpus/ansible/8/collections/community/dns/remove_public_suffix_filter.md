...
collection: ansible
version: "8"
title: "community.dns.remove_public_suffix filter – Removes the public suffix from a DNS name"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/dns/remove_public_suffix_filter.html
fetched_at: 2026-07-28T01:43:35+00:00
---
...
- [Synopsis](remove_public_suffix_filter.md#synopsis)
- [Input](remove_public_suffix_filter.md#input)
- [Keyword parameters](remove_public_suffix_filter.md#keyword-parameters)
- [Examples](remove_public_suffix_filter.md#examples)
- [Return Value](remove_public_suffix_filter.md#return-value)

## [Synopsis](remove_public_suffix_filter.md#id1)

- Removes the public suffix from a DNS name.

## [Input](remove_public_suffix_filter.md#id2)
...
## [Keyword parameters](remove_public_suffix_filter.md#id3)
...
| **keep_trailing_period**  boolean | This controls whether the trailing period of the prefix (that is, the part before the public suffix) is preserved or not.  **Choices:**   - `false` ← (default) - `true` |
...
## [Examples](remove_public_suffix_filter.md#id4)
...
## [Return Value](remove_public_suffix_filter.md#id5)

| Key | Description |
| --- | --- |
| **Return value**  string | The part of the DNS name before the public suffix.  **Returned:** success |
