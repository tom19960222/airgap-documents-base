...
collection: ansible
version: "8"
title: "community.dns.get_registrable_domain filter – Returns the registrable domain name of a DNS name"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/dns/get_registrable_domain_filter.html
...
- [Synopsis](get_registrable_domain_filter.md#synopsis)
- [Input](get_registrable_domain_filter.md#input)
- [Keyword parameters](get_registrable_domain_filter.md#keyword-parameters)
- [Examples](get_registrable_domain_filter.md#examples)
- [Return Value](get_registrable_domain_filter.md#return-value)

## [Synopsis](get_registrable_domain_filter.md#id1)

- Returns the registrable domain name of a DNS name.

## [Input](get_registrable_domain_filter.md#id2)
...
## [Keyword parameters](get_registrable_domain_filter.md#id3)
...
## [Examples](get_registrable_domain_filter.md#id4)
...
## [Return Value](get_registrable_domain_filter.md#id5)

| Key | Description |
| --- | --- |
| **Return value**  string | The registrable domain.  **Returned:** success |
