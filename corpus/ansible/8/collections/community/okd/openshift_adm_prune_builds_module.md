...
collection: ansible
version: "8"
title: "community.okd.openshift_adm_prune_builds module – Prune old completed and failed builds"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/okd/openshift_adm_prune_builds_module.html
fetched_at: 2026-07-28T01:58:17+00:00
---
# community.okd.openshift_adm_prune_builds module – Prune old completed and failed builds
...
> see [Requirements](openshift_adm_prune_builds_module.md#ansible-collections-community-okd-openshift-adm-prune-builds-module-requirements) for details.
>
> To use it in a playbook, specify: `community.okd.openshift_adm_prune_builds`.

New in community.okd 2.3.0

- [Synopsis](openshift_adm_prune_builds_module.md#synopsis)
- [Requirements](openshift_adm_prune_builds_module.md#requirements)
- [Parameters](openshift_adm_prune_builds_module.md#parameters)
- [Notes](openshift_adm_prune_builds_module.md#notes)
- [Examples](openshift_adm_prune_builds_module.md#examples)
- [Return Values](openshift_adm_prune_builds_module.md#return-values)

## [Synopsis](openshift_adm_prune_builds_module.md#id1)

- This module allow administrators to delete old completed and failed builds.
- Analogous to `oc adm prune builds`.

## [Requirements](openshift_adm_prune_builds_module.md#id2)
...
## [Parameters](openshift_adm_prune_builds_module.md#id3)
...
| **keep_younger_than**  integer | Specify the minimum age (in minutes) of a Build for it to be considered a candidate for pruning. |
...
| **orphans**  boolean | If `true`, prune all builds whose associated BuildConfig no longer exists and whose status is complete, failed, error, or cancelled.  **Choices:**   - `false` ← (default) - `true` |
...
## [Notes](openshift_adm_prune_builds_module.md#id4)

> **Note:**
>
> - To avoid SSL certificate validation errors when `validate_certs` is *True*, the full certificate chain for the API server must be provided via `ca_cert` or in the kubeconfig file.

## [Examples](openshift_adm_prune_builds_module.md#id5)
...
## [Return Values](openshift_adm_prune_builds_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **builds**  complex | The builds that were deleted  **Returned:** success |
