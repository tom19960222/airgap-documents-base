...
collection: ansible
version: "8"
title: "community.okd.openshift_adm_prune_deployments module – Remove old completed and failed deployment configs"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/okd/openshift_adm_prune_deployments_module.html
fetched_at: 2026-07-28T01:58:17+00:00
---
# community.okd.openshift_adm_prune_deployments module – Remove old completed and failed deployment configs
...
> see [Requirements](openshift_adm_prune_deployments_module.md#ansible-collections-community-okd-openshift-adm-prune-deployments-module-requirements) for details.
>
> To use it in a playbook, specify: `community.okd.openshift_adm_prune_deployments`.

New in community.okd 2.2.0

- [Synopsis](openshift_adm_prune_deployments_module.md#synopsis)
- [Requirements](openshift_adm_prune_deployments_module.md#requirements)
- [Parameters](openshift_adm_prune_deployments_module.md#parameters)
- [Notes](openshift_adm_prune_deployments_module.md#notes)
- [Examples](openshift_adm_prune_deployments_module.md#examples)
- [Return Values](openshift_adm_prune_deployments_module.md#return-values)

## [Synopsis](openshift_adm_prune_deployments_module.md#id1)
...
## [Requirements](openshift_adm_prune_deployments_module.md#id2)
...
## [Parameters](openshift_adm_prune_deployments_module.md#id3)
...
| **keep_younger_than**  integer | Specify the minimum age (in minutes) of a deployment for it to be considered a candidate for pruning. |
...
| **orphans**  boolean | If `true`, prune all deployments where the associated DeploymentConfig no longer exists, the status is complete or failed, and the replica size is `0`.  **Choices:**   - `false` ← (default) - `true` |
...
## [Notes](openshift_adm_prune_deployments_module.md#id4)

> **Note:**
>
> - To avoid SSL certificate validation errors when `validate_certs` is *True*, the full certificate chain for the API server must be provided via `ca_cert` or in the kubeconfig file.

## [Examples](openshift_adm_prune_deployments_module.md#id5)
...
## [Return Values](openshift_adm_prune_deployments_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **replication_controllers**  list / elements=string | list of replication controllers candidate for pruning.  **Returned:** always |
