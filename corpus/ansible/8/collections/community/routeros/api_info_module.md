...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/routeros/api_info_module.html
...
| **include_read_only**  boolean  *added in community.routeros 2.10.0* | Whether to include read-only fields.  By default, they are not returned.  **Choices:**   - `false` ← (default) - `true` |
