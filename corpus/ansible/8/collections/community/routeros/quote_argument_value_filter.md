...
collection: ansible
version: "8"
title: "community.routeros.quote_argument_value filter – Quote an argument value"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/routeros/quote_argument_value_filter.html
...
- [Synopsis](quote_argument_value_filter.md#synopsis)
- [Input](quote_argument_value_filter.md#input)
- [Examples](quote_argument_value_filter.md#examples)
- [Return Value](quote_argument_value_filter.md#return-value)

## [Synopsis](quote_argument_value_filter.md#id1)

- Quote an argument value.

## [Input](quote_argument_value_filter.md#id2)

This describes the input of the filter, the value before `| community.routeros.quote_argument_value`.

| Parameter | Comments |
| --- | --- |
| **Input**  string / required | An argument value to quote. |

## [Examples](quote_argument_value_filter.md#id3)
...
## [Return Value](quote_argument_value_filter.md#id4)

| Key | Description |
| --- | --- |
| **Return value**  string | The quoted argument value.  **Returned:** success |
