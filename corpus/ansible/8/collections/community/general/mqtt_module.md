...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/mqtt_module.html
fetched_at: 2026-07-28T01:48:02+00:00
---
...
- [Attributes](mqtt_module.md#attributes)
...
| **payload**  string / required | Payload. The special string `"None"` may be used to send a NULL (that is, empty) payload which is useful to simply notify with the `topic` or to clear previously retained messages. |
