...
collection: ansible
version: "8"
title: "community.general.oneview_network_set_info module – Retrieve information about the OneView Network Sets"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/oneview_network_set_info_module.html
fetched_at: 2026-07-28T01:48:37+00:00
---
# community.general.oneview_network_set_info module – Retrieve information about the OneView Network Sets
...
> see [Requirements](oneview_network_set_info_module.md#ansible-collections-community-general-oneview-network-set-info-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.oneview_network_set_info`.

- [Synopsis](oneview_network_set_info_module.md#synopsis)
- [Requirements](oneview_network_set_info_module.md#requirements)
- [Parameters](oneview_network_set_info_module.md#parameters)
- [Attributes](oneview_network_set_info_module.md#attributes)
- [Notes](oneview_network_set_info_module.md#notes)
- [Examples](oneview_network_set_info_module.md#examples)
- [Return Values](oneview_network_set_info_module.md#return-values)

## [Synopsis](oneview_network_set_info_module.md#id1)

- Retrieve information about the Network Sets from OneView.
- This module was called `oneview_network_set_facts` before Ansible 2.9, returning `ansible_facts`. Note that the [community.general.oneview_network_set_info](oneview_network_set_info_module.md#ansible-collections-community-general-oneview-network-set-info-module) module no longer returns `ansible_facts`!

Aliases: remote_management.oneview.oneview_network_set_info

## [Requirements](oneview_network_set_info_module.md#id2)
...
## [Parameters](oneview_network_set_info_module.md#id3)
...
| **options**  list / elements=string | List with options to gather information about Network Set. Option allowed: `withoutEthernet`. The option `withoutEthernet` retrieves the list of network_sets excluding Ethernet networks. |
...
## [Attributes](oneview_network_set_info_module.md#id4)
...
## [Notes](oneview_network_set_info_module.md#id5)
...
## [Examples](oneview_network_set_info_module.md#id6)
...
## [Return Values](oneview_network_set_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **network_sets**  dictionary | Has all the OneView information about the Network Sets.  **Returned:** Always, but can be empty. |
