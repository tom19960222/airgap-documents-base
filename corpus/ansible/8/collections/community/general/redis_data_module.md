...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/redis_data_module.html
fetched_at: 2026-07-28T01:49:54+00:00
---
...
- [Attributes](redis_data_module.md#attributes)
...
## [Attributes](redis_data_module.md#id4)
...
## [Notes](redis_data_module.md#id5)
...
## [See Also](redis_data_module.md#id6)
...
## [Examples](redis_data_module.md#id7)
...
## [Return Values](redis_data_module.md#id8)
...
| **old_value**  string | Value of key before setting.  **Returned:** on_success if `state=present` and key exists in database.  **Sample:** `"old_value_of_key"` |
| **value**  string | Value key was set to.  **Returned:** on success if `state=present`.  **Sample:** `"new_value_of_key"` |
