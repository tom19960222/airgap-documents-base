...
collection: ansible
version: "8"
title: "community.general.rax_keypair module – Create a keypair for use with Rackspace Cloud Servers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_keypair_module.html
fetched_at: 2026-07-28T01:49:41+00:00
---
# community.general.rax_keypair module – Create a keypair for use with Rackspace Cloud Servers
...
> see [Requirements](rax_keypair_module.md#ansible-collections-community-general-rax-keypair-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.rax_keypair`.

- [DEPRECATED](rax_keypair_module.md#deprecated)
- [Synopsis](rax_keypair_module.md#synopsis)
- [Requirements](rax_keypair_module.md#requirements)
- [Parameters](rax_keypair_module.md#parameters)
- [Attributes](rax_keypair_module.md#attributes)
- [Notes](rax_keypair_module.md#notes)
- [Examples](rax_keypair_module.md#examples)
- [Status](rax_keypair_module.md#status)

## [DEPRECATED](rax_keypair_module.md#id1)
...
## [Synopsis](rax_keypair_module.md#id2)

- Create a keypair for use with Rackspace Cloud Servers

Aliases: cloud.rackspace.rax_keypair

## [Requirements](rax_keypair_module.md#id3)
...
## [Parameters](rax_keypair_module.md#id4)
...
| **public_key**  string | Public Key string to upload. Can be a file path or string |
...
## [Attributes](rax_keypair_module.md#id5)
...
## [Notes](rax_keypair_module.md#id6)
...
## [Examples](rax_keypair_module.md#id7)
...
## [Status](rax_keypair_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_keypair_module.md#deprecated).
