...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/zypper_module.html
...
- [Attributes](zypper_module.md#attributes)
...
## [Attributes](zypper_module.md#id4)
...
## [Notes](zypper_module.md#id5)

> **Note:**
>
> - When used with a `loop:` each package will be processed individually, it is much more efficient to pass the list directly to the `name` option.

## [Examples](zypper_module.md#id6)
