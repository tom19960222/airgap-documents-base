...
collection: ansible
version: "8"
title: "community.general.to_hours filter – Converte a duration string to hours"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/to_hours_filter.html
...
- [Synopsis](to_hours_filter.md#synopsis)
- [Input](to_hours_filter.md#input)
- [Keyword parameters](to_hours_filter.md#keyword-parameters)
- [Examples](to_hours_filter.md#examples)
- [Return Value](to_hours_filter.md#return-value)

## [Synopsis](to_hours_filter.md#id1)

- Parse a human readable time duration string and convert to hours.

## [Input](to_hours_filter.md#id2)
...
## [Keyword parameters](to_hours_filter.md#id3)
...
## [Examples](to_hours_filter.md#id4)
...
## [Return Value](to_hours_filter.md#id5)

| Key | Description |
| --- | --- |
| **Return value**  float | Number of hours.  **Returned:** success |
