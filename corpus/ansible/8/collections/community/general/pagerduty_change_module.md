...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/pagerduty_change_module.html
...
- [Attributes](pagerduty_change_module.md#attributes)
...
## [Attributes](pagerduty_change_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full**  Check mode simply does nothing except returning `changed=true` in case the `url` seems to be correct. | Can run in `check_mode` and return changed status prediction without modifying target. |
