...
collection: ansible
version: "8"
title: "community.general.unixy callback – condensed Ansible output"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/unixy_callback.html
fetched_at: 2026-07-28T01:52:08+00:00
---
# community.general.unixy callback – condensed Ansible output
...
> see [Requirements](unixy_callback.md#ansible-collections-community-general-unixy-callback-requirements) for details.
>
> To use it in a playbook, specify: `community.general.unixy`.

- [Callback plugin](unixy_callback.md#callback-plugin)
- [Synopsis](unixy_callback.md#synopsis)
- [Requirements](unixy_callback.md#requirements)
- [Parameters](unixy_callback.md#parameters)

## [Callback plugin](unixy_callback.md#id1)
...
## [Synopsis](unixy_callback.md#id2)

- Consolidated Ansible output in the style of LINUX/UNIX startup logs.

## [Requirements](unixy_callback.md#id3)

The below requirements are needed on the local controller node that executes this callback.

- set as stdout in configuration

## [Parameters](unixy_callback.md#id4)
