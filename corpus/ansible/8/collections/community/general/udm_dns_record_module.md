...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/udm_dns_record_module.html
...
- [Attributes](udm_dns_record_module.md#attributes)
...
Aliases: cloud.univention.udm_dns_record
...
| Parameter | Comments |
| --- | --- |
| **data**  dictionary | Additional data for this record, for example `{'a': '192.0.2.1'}`.  Required if `state=present`.  **Default:** `{}` |
...
## [Attributes](udm_dns_record_module.md#id4)
...
## [Examples](udm_dns_record_module.md#id5)
