...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_files_objects_module.html
fetched_at: 2026-07-28T01:49:40+00:00
---
...
- [DEPRECATED](rax_files_objects_module.md#deprecated)
...
- [Attributes](rax_files_objects_module.md#attributes)
- [Notes](rax_files_objects_module.md#notes)
- [Examples](rax_files_objects_module.md#examples)
- [Status](rax_files_objects_module.md#status)

## [DEPRECATED](rax_files_objects_module.md#id1)
...
## [Synopsis](rax_files_objects_module.md#id2)

- Upload, download, and delete objects in Rackspace Cloud Files.

Aliases: cloud.rackspace.rax_files_objects

## [Requirements](rax_files_objects_module.md#id3)
...
## [Parameters](rax_files_objects_module.md#id4)
...
## [Attributes](rax_files_objects_module.md#id5)
...
## [Notes](rax_files_objects_module.md#id6)
...
## [Examples](rax_files_objects_module.md#id7)
...
## [Status](rax_files_objects_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_files_objects_module.md#deprecated).
