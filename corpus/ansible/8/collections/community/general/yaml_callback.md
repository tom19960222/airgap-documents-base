...
collection: ansible
version: "8"
title: "community.general.yaml callback – YAML-ized Ansible screen output"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/yaml_callback.html
...
> see [Requirements](yaml_callback.md#ansible-collections-community-general-yaml-callback-requirements) for details.
>
> To use it in a playbook, specify: `community.general.yaml`.

- [Callback plugin](yaml_callback.md#callback-plugin)
- [Synopsis](yaml_callback.md#synopsis)
- [Requirements](yaml_callback.md#requirements)
- [Parameters](yaml_callback.md#parameters)

## [Callback plugin](yaml_callback.md#id1)
