...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/memset_memstore_info_module.html
...
- [Attributes](memset_memstore_info_module.md#attributes)
...
| **name**  string / required | The Memstore product name (that is, `mstestyaa1`). |

## [Attributes](memset_memstore_info_module.md#id3)
...
## [Return Values](memset_memstore_info_module.md#id6)
