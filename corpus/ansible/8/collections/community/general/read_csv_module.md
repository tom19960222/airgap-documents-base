...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/read_csv_module.html
...
- [Attributes](read_csv_module.md#attributes)
- [See Also](read_csv_module.md#see-also)
...
## [Attributes](read_csv_module.md#id3)
...
## [See Also](read_csv_module.md#id4)

> **See also:**
>
> [ansible.builtin.csvfile](../../ansible/builtin/csvfile_lookup.md#ansible-collections-ansible-builtin-csvfile-lookup) lookup plugin
> :   Can be used to do selective lookups in CSV files from Jinja.

## [Examples](read_csv_module.md#id5)
...
## [Return Values](read_csv_module.md#id6)
