...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/keycloak_authentication_module.html
fetched_at: 2026-07-28T01:47:06+00:00
---
...
- [Attributes](keycloak_authentication_module.md#attributes)
...
Aliases: identity.keycloak.keycloak_authentication
...
| **subFlowType**  string  *added in community.general 6.6.0* | For new subflows, optionally specify the type.  Is only used at creation.  **Choices:**   - `"basic-flow"` ← (default) - `"form-flow"` |
...
| **providerId**  string | `providerId` for the new flow when not copied from an existing flow.  **Choices:**   - `"basic-flow"` - `"client-flow"` |
...
## [Attributes](keycloak_authentication_module.md#id3)
...
## [Examples](keycloak_authentication_module.md#id4)
...
## [Return Values](keycloak_authentication_module.md#id5)
