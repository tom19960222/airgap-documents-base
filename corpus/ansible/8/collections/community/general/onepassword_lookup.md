...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/onepassword_lookup.html
fetched_at: 2026-07-28T01:52:55+00:00
---
...
- [community.general.onepassword](onepassword_lookup.md#ansible-collections-community-general-onepassword-lookup) wraps the `op` command line utility to fetch specific field values from 1Password.
...
| **domain**  string  *added in community.general 3.2.0* | Domain of 1Password.  **Default:** `"1password.com"` |
