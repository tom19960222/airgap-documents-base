...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/dsv_lookup.html
...
| Parameter | Comments |
| --- | --- |
| **Terms**  string / required | The path to the secret, for example `/staging/servers/web1`. |
