...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/webfaction_db_module.html
...
- [DEPRECATED](webfaction_db_module.md#deprecated)
- [Synopsis](webfaction_db_module.md#synopsis)
- [Parameters](webfaction_db_module.md#parameters)
- [Attributes](webfaction_db_module.md#attributes)
- [Notes](webfaction_db_module.md#notes)
- [Examples](webfaction_db_module.md#examples)
- [Status](webfaction_db_module.md#status)

## [DEPRECATED](webfaction_db_module.md#id1)
...
## [Attributes](webfaction_db_module.md#id4)
...
## [Notes](webfaction_db_module.md#id5)
...
## [Examples](webfaction_db_module.md#id6)
...
## [Status](webfaction_db_module.md#id7)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](webfaction_db_module.md#deprecated).
