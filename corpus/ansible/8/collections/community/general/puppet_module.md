...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/puppet_module.html
fetched_at: 2026-07-28T01:49:28+00:00
---
...
- [Attributes](puppet_module.md#attributes)
- [Examples](puppet_module.md#examples)

## [Synopsis](puppet_module.md#id1)

- Runs `puppet` agent or apply in a reliable manner.

Aliases: system.puppet

## [Requirements](puppet_module.md#id2)

The below requirements are needed on the host that executes this module.

- puppet

## [Parameters](puppet_module.md#id3)
...
| **show_diff**  boolean | Whether to print file changes details  **Choices:**   - `false` ← (default) - `true` |
| **skip_tags**  list / elements=string  *added in community.general 6.6.0* | A list of puppet tags to be excluded. |
...
## [Attributes](puppet_module.md#id4)
