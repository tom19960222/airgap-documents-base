...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/imgadm_module.html
fetched_at: 2026-07-28T01:46:27+00:00
---
...
- [Attributes](imgadm_module.md#attributes)
...
| **state**  string / required | State the object operated on should be in. `imported` is an alias for for `present` and `deleted` for `absent`. When set to `vacuumed` and `uuid=*`, it will remove all unused images.  **Choices:**   - `"present"` - `"absent"` - `"deleted"` - `"imported"` - `"updated"` - `"vacuumed"` |
...
## [Attributes](imgadm_module.md#id4)
...
## [Return Values](imgadm_module.md#id6)
