...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/gitlab_project_variable_module.html
fetched_at: 2026-07-28T01:45:53+00:00
---
...
- [Attributes](gitlab_project_variable_module.md#attributes)
...
- Variables which are untouched in the playbook, but are not untouched in the GitLab project, they stay untouched (`purge=false`) or will be deleted (`purge=true`).

Aliases: source_control.gitlab.gitlab_project_variable
...
| **environment_scope**  string | The scope for the variable.  Support for `variables[].environment_scope` requires GitLab Premium >= 13.11.  **Default:** `"*"` |
| **masked**  boolean | Whether variable value is masked or not.  Support for masked values requires GitLab >= 11.10.  **Choices:**   - `false` ← (default) - `true` |
| **name**  string / required | The name of the variable. |
| **protected**  boolean | Whether variable value is protected or not.  Support for protected values requires GitLab >= 9.3.  **Choices:**   - `false` ← (default) - `true` |
...
| **variable_type**  string | Whether a variable is an environment variable (`env_var`) or a file (`file`).  Support for `variables[].variable_type` requires GitLab >= 11.11.  **Choices:**   - `"env_var"` ← (default) - `"file"` |
...
## [Attributes](gitlab_project_variable_module.md#id4)
...
## [Examples](gitlab_project_variable_module.md#id5)
...
## [Return Values](gitlab_project_variable_module.md#id6)
