...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/terraform_module.html
...
- [Attributes](terraform_module.md#attributes)
...
| **workspace**  string | The terraform workspace to work with. This sets the `TF_WORKSPACE` environmental variable that is used to override workspace selection. For more information about workspaces have a look at <https://developer.hashicorp.com/terraform/language/state/workspaces>.  **Default:** `"default"` |

## [Attributes](terraform_module.md#id4)
...
## [Notes](terraform_module.md#id5)

> **Note:**
>
> - To just run a `terraform plan`, use check mode.

## [Examples](terraform_module.md#id6)
...
## [Return Values](terraform_module.md#id7)
