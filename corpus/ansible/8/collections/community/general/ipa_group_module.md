...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/ipa_group_module.html
fetched_at: 2026-07-28T01:46:37+00:00
---
...
- [Attributes](ipa_group_module.md#attributes)
...
Aliases: identity.ipa.ipa_group
...
| **external_user**  list / elements=string  *added in community.general 6.3.0* | List of external users assigned to this group.  Behaves identically to `user` with respect to `append` attribute.  List entries can be in `DOMAIN\\username` or SID format.  Unless SIDs are provided, the module will always attempt to make changes even if the group already has all the users. This is because only SIDs are returned by IPA query.  `external=true` is needed for this option to work. |
...
## [Attributes](ipa_group_module.md#id3)
...
## [Examples](ipa_group_module.md#id4)
...
## [Return Values](ipa_group_module.md#id5)
