...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/filesize_module.html
fetched_at: 2026-07-28T01:45:32+00:00
---
...
- [Attributes](filesize_module.md#attributes)
...
## [Attributes](filesize_module.md#id4)
...
| **bytes**  integer | Size of the file, in bytes, as the product of `filesize.blocks` and `filesize.blocksize`.  **Returned:** success  **Sample:** `512000` |
