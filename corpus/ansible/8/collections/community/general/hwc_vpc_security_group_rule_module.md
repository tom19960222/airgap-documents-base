...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/hwc_vpc_security_group_rule_module.html
...
- [Attributes](hwc_vpc_security_group_rule_module.md#attributes)
...
## [Attributes](hwc_vpc_security_group_rule_module.md#id4)
...
## [Notes](hwc_vpc_security_group_rule_module.md#id5)

> **Note:**
>
> - If `id` option is provided, it takes precedence over `security_group_id` for security group rule selection.
...
## [Examples](hwc_vpc_security_group_rule_module.md#id6)
...
## [Return Values](hwc_vpc_security_group_rule_module.md#id7)
