...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/flattened_lookup.html
fetched_at: 2026-07-28T01:52:50+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **Terms**  list / elements=any / required | lists to flatten |

## [Notes](flattened_lookup.md#id3)

> **Note:**
>
> - Unlike the [ansible.builtin.items](../../ansible/builtin/items_lookup.md#ansible-collections-ansible-builtin-items-lookup) lookup which only flattens 1 level, this plugin will continue to flatten until it cannot find lists anymore.
