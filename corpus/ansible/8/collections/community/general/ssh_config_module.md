...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/ssh_config_module.html
fetched_at: 2026-07-28T01:50:46+00:00
---
...
- [Attributes](ssh_config_module.md#attributes)
...
| **host_key_algorithms**  string  *added in community.general 6.1.0* | Sets the `HostKeyAlgorithms` option. |
...
| **proxyjump**  string  *added in community.general 6.5.0* | Sets the `ProxyJump` option.  Mutually exclusive with `proxycommand`. |
...
## [Attributes](ssh_config_module.md#id4)
