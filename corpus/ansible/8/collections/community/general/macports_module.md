...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/macports_module.html
...
- [Attributes](macports_module.md#attributes)
...
| **variant**  aliases: variants  string | A port variant specification.  `variant` is only supported with `state=installed` and `state=present`. |

## [Attributes](macports_module.md#id3)
...
## [Examples](macports_module.md#id4)
