...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/pulp_repo_module.html
fetched_at: 2026-07-28T01:49:27+00:00
---
...
- [Attributes](pulp_repo_module.md#attributes)
...
| **feed_client_key**  aliases: importer_ssl_client_key  string | Private key to the certificate specified in `feed_client_cert`, assuming it is not included in the certificate file itself. This can be the file content or the path to the file. |
...
| **repo_type**  string | Repo plugin type to use (that is, `rpm`, `docker`).  **Default:** `"rpm"` |
...
## [Attributes](pulp_repo_module.md#id3)
...
## [Examples](pulp_repo_module.md#id5)
...
## [Return Values](pulp_repo_module.md#id6)
