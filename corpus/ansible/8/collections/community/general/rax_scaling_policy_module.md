...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_scaling_policy_module.html
fetched_at: 2026-07-28T01:49:49+00:00
---
...
- [DEPRECATED](rax_scaling_policy_module.md#deprecated)
...
- [Attributes](rax_scaling_policy_module.md#attributes)
- [Notes](rax_scaling_policy_module.md#notes)
- [Examples](rax_scaling_policy_module.md#examples)
- [Status](rax_scaling_policy_module.md#status)

## [DEPRECATED](rax_scaling_policy_module.md#id1)
...
## [Synopsis](rax_scaling_policy_module.md#id2)

- Manipulate Rackspace Cloud Autoscale Scaling Policy

Aliases: cloud.rackspace.rax_scaling_policy

## [Requirements](rax_scaling_policy_module.md#id3)
...
## [Parameters](rax_scaling_policy_module.md#id4)
...
## [Attributes](rax_scaling_policy_module.md#id5)
...
## [Notes](rax_scaling_policy_module.md#id6)
...
## [Examples](rax_scaling_policy_module.md#id7)
...
## [Status](rax_scaling_policy_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_scaling_policy_module.md#deprecated).
