...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/ipa_config_module.html
fetched_at: 2026-07-28T01:46:35+00:00
---
...
- [Attributes](ipa_config_module.md#attributes)
...
Aliases: identity.ipa.ipa_config
...
| **ipauserauthtype**  aliases: userauthtype  list / elements=string  *added in community.general 2.5.0* | The authentication type to use by default.  The choice `idp` has been added in community.general 7.3.0.  **Choices:**   - `"password"` - `"radius"` - `"otp"` - `"pkinit"` - `"hardened"` - `"idp"` - `"disabled"` |
...
## [Attributes](ipa_config_module.md#id3)
...
## [Examples](ipa_config_module.md#id4)
...
## [Return Values](ipa_config_module.md#id5)
