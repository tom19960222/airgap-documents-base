...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/redis_module.html
...
- [Attributes](redis_module.md#attributes)
...
| **value**  string | A redis config value. When memory size is needed, it is possible to specify it in the usual form of 1KB, 2M, 400MB where the base is 1024. Units are case insensitive i.e. 1m = 1mb = 1M = 1MB. |

## [Attributes](redis_module.md#id4)
