...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_mon_notification_plan_module.html
...
- [DEPRECATED](rax_mon_notification_plan_module.md#deprecated)
...
- [Attributes](rax_mon_notification_plan_module.md#attributes)
- [Notes](rax_mon_notification_plan_module.md#notes)
- [Examples](rax_mon_notification_plan_module.md#examples)
- [Status](rax_mon_notification_plan_module.md#status)

## [DEPRECATED](rax_mon_notification_plan_module.md#id1)
...
## [Synopsis](rax_mon_notification_plan_module.md#id2)
...
## [Requirements](rax_mon_notification_plan_module.md#id3)
...
## [Parameters](rax_mon_notification_plan_module.md#id4)
...
## [Attributes](rax_mon_notification_plan_module.md#id5)
...
## [Notes](rax_mon_notification_plan_module.md#id6)
...
## [Examples](rax_mon_notification_plan_module.md#id7)
...
## [Status](rax_mon_notification_plan_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_mon_notification_plan_module.md#deprecated).
