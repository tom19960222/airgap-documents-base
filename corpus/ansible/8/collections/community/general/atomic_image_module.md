...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/atomic_image_module.html
fetched_at: 2026-07-28T01:44:45+00:00
---
...
- [Attributes](atomic_image_module.md#attributes)
...
Aliases: cloud.atomic.atomic_image
...
## [Attributes](atomic_image_module.md#id4)
...
## [Notes](atomic_image_module.md#id5)

> **Note:**
>
> - Host should support `atomic` command.

## [Examples](atomic_image_module.md#id6)
...
## [Return Values](atomic_image_module.md#id7)
