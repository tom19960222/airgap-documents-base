...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/gitlab_group_module.html
fetched_at: 2026-07-28T01:45:47+00:00
---
...
- [Attributes](gitlab_group_module.md#attributes)
...
| **force_delete**  boolean  *added in community.general 7.5.0* | Force delete group even if projects in it.  Used only when `state=absent`.  **Choices:**   - `false` ← (default) - `true` |
...
## [Attributes](gitlab_group_module.md#id4)
...
## [Examples](gitlab_group_module.md#id5)
...
## [Return Values](gitlab_group_module.md#id6)
