...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_meta_module.html
fetched_at: 2026-07-28T01:49:42+00:00
---
...
## [Synopsis](rax_meta_module.md#id2)

- Manipulate metadata for Rackspace Cloud Servers

Aliases: cloud.rackspace.rax_meta

## [Requirements](rax_meta_module.md#id3)
...
## [Parameters](rax_meta_module.md#id4)
...
## [Attributes](rax_meta_module.md#id5)
...
## [Examples](rax_meta_module.md#id7)
...
## [Status](rax_meta_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_meta_module.md#deprecated).
