...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/lmdb_kv_lookup.html
fetched_at: 2026-07-28T01:52:53+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **db**  string | Path to LMDB database.  **Default:** `"ansible.mdb"`  **Configuration:**   - Variable: lmdb_kv_db |
