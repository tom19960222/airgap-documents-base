...
collection: ansible
version: "8"
title: "community.general.ipa_sudocmd module – Manage FreeIPA sudo command"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/ipa_sudocmd_module.html
fetched_at: 2026-07-28T01:46:45+00:00
---
# community.general.ipa_sudocmd module – Manage FreeIPA sudo command
...
- [Synopsis](ipa_sudocmd_module.md#synopsis)
- [Parameters](ipa_sudocmd_module.md#parameters)
- [Attributes](ipa_sudocmd_module.md#attributes)
- [Examples](ipa_sudocmd_module.md#examples)
- [Return Values](ipa_sudocmd_module.md#return-values)

## [Synopsis](ipa_sudocmd_module.md#id1)

- Add, modify or delete sudo command within FreeIPA server using FreeIPA API.

Aliases: identity.ipa.ipa_sudocmd

## [Parameters](ipa_sudocmd_module.md#id2)
...
| **sudocmd**  aliases: name  string / required | Sudo command. |
...
## [Attributes](ipa_sudocmd_module.md#id3)
...
## [Examples](ipa_sudocmd_module.md#id4)
...
## [Return Values](ipa_sudocmd_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **sudocmd**  dictionary | Sudo command as return from IPA API  **Returned:** always |
