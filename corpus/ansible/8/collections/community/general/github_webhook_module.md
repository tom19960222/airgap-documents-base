...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/github_webhook_module.html
fetched_at: 2026-07-28T01:45:44+00:00
---
...
- [Attributes](github_webhook_module.md#attributes)
...
Aliases: source_control.github.github_webhook
...
| **events**  list / elements=string | A list of GitHub events the hook is triggered for. Events are listed at <https://developer.github.com/v3/activity/events/types/>. Required unless `state=absent` |
...
## [Attributes](github_webhook_module.md#id4)
...
## [Examples](github_webhook_module.md#id5)
...
## [Return Values](github_webhook_module.md#id6)
