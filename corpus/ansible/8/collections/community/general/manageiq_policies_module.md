...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/manageiq_policies_module.html
fetched_at: 2026-07-28T01:47:48+00:00
---
...
- [Attributes](manageiq_policies_module.md#attributes)
...
Aliases: remote_management.manageiq.manageiq_policies
...
| **state**  string | `absent` - policy_profiles should not exist,  `present` - policy_profiles should exist,  `list` - list current policy_profiles and policies. This state is deprecated and will be removed 8.0.0. Please use the module [community.general.manageiq_policies_info](manageiq_policies_info_module.md#ansible-collections-community-general-manageiq-policies-info-module) instead.  **Choices:**   - `"absent"` - `"present"` ← (default) - `"list"` |

## [Attributes](manageiq_policies_module.md#id4)
...
## [Examples](manageiq_policies_module.md#id5)
...
## [Return Values](manageiq_policies_module.md#id6)
