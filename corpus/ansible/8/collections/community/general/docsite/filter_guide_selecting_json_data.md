...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/docsite/filter_guide_selecting_json_data.html
fetched_at: 2026-07-28T03:00:47+00:00
---
# Selecting JSON data: JSON queries

To select a single element or a data subset from a complex data structure in JSON format (for example, Ansible facts), use the [community.general.json_query filter](../json_query_filter.md#ansible-collections-community-general-json-query-filter). The [community.general.json_query](../json_query_filter.md#ansible-collections-community-general-json-query-filter) filter lets you query a complex JSON structure and iterate over it using a loop structure.
