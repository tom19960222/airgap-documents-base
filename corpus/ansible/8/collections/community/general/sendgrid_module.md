...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/sendgrid_module.html
fetched_at: 2026-07-28T01:50:30+00:00
---
...
- [Attributes](sendgrid_module.md#attributes)
...
## [Attributes](sendgrid_module.md#id4)
...
> - Since Ansible 2.2 `username` and `password` are not required if you supply an `api_key`

## [Examples](sendgrid_module.md#id6)
