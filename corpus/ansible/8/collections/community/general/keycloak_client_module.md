...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/keycloak_client_module.html
fetched_at: 2026-07-28T01:47:10+00:00
---
...
- [Attributes](keycloak_client_module.md#attributes)
...
Aliases: identity.keycloak.keycloak_client
...
| **protocol**  string | Type of client.  At creation only, default value will be `openid-connect` if `protocol` is omitted.  **Choices:**   - `"openid-connect"` - `"saml"` |
...
## [Attributes](keycloak_client_module.md#id3)
...
## [Examples](keycloak_client_module.md#id4)
...
## [Return Values](keycloak_client_module.md#id5)
