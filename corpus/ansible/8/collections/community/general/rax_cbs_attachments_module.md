...
collection: ansible
version: "8"
title: "community.general.rax_cbs_attachments module – Manipulate Rackspace Cloud Block Storage Volume Attachments"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_cbs_attachments_module.html
fetched_at: 2026-07-28T01:49:32+00:00
---
# community.general.rax_cbs_attachments module – Manipulate Rackspace Cloud Block Storage Volume Attachments
...
> see [Requirements](rax_cbs_attachments_module.md#ansible-collections-community-general-rax-cbs-attachments-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.rax_cbs_attachments`.

- [DEPRECATED](rax_cbs_attachments_module.md#deprecated)
- [Synopsis](rax_cbs_attachments_module.md#synopsis)
- [Requirements](rax_cbs_attachments_module.md#requirements)
- [Parameters](rax_cbs_attachments_module.md#parameters)
- [Attributes](rax_cbs_attachments_module.md#attributes)
- [Notes](rax_cbs_attachments_module.md#notes)
- [Examples](rax_cbs_attachments_module.md#examples)
- [Status](rax_cbs_attachments_module.md#status)

## [DEPRECATED](rax_cbs_attachments_module.md#id1)
...
## [Synopsis](rax_cbs_attachments_module.md#id2)

- Manipulate Rackspace Cloud Block Storage Volume Attachments

Aliases: cloud.rackspace.rax_cbs_attachments

## [Requirements](rax_cbs_attachments_module.md#id3)
...
## [Parameters](rax_cbs_attachments_module.md#id4)
...
| **wait**  boolean | wait for the volume to be in ‘in-use’/’available’ state before returning  **Choices:**   - `false` ← (default) - `true` |
| **wait_timeout**  integer | how long before wait gives up, in seconds  **Default:** `300` |

## [Attributes](rax_cbs_attachments_module.md#id5)
...
## [Notes](rax_cbs_attachments_module.md#id6)
...
## [Examples](rax_cbs_attachments_module.md#id7)
...
## [Status](rax_cbs_attachments_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_cbs_attachments_module.md#deprecated).
