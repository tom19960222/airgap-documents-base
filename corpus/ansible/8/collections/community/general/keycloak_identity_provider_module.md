...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/keycloak_identity_provider_module.html
fetched_at: 2026-07-28T01:47:16+00:00
---
...
- [Attributes](keycloak_identity_provider_module.md#attributes)
...
Aliases: identity.keycloak.keycloak_identity_provider
...
| **config**  dictionary | Dict specifying the configuration options for the mapper; the contents differ depending on the value of `mappers[].identityProviderMapper`. |
...
## [Attributes](keycloak_identity_provider_module.md#id3)
...
## [Examples](keycloak_identity_provider_module.md#id4)
...
## [Return Values](keycloak_identity_provider_module.md#id5)
