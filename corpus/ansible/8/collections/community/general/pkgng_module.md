...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/pkgng_module.html
...
- [Attributes](pkgng_module.md#attributes)
...
| **state**  string | State of the package.  Note: `latest` added in Ansible 2.7.  **Choices:**   - `"present"` ← (default) - `"latest"` - `"absent"` |

## [Attributes](pkgng_module.md#id3)
