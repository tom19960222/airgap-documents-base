...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/alternatives_module.html
...
- [Attributes](alternatives_module.md#attributes)
...
| **subcommands**  aliases: slaves  list / elements=dictionary  *added in community.general 5.1.0* | A list of subcommands.  Each subcommand needs a name, a link and a path parameter.  Subcommands are also named ‘slaves’ or ‘followers’, depending on the version of alternatives. |
...
## [Attributes](alternatives_module.md#id4)
...
## [Examples](alternatives_module.md#id5)
