...
collection: ansible
version: "8"
title: "community.general.rax_facts module – Gather facts for Rackspace Cloud Servers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rax_facts_module.html
fetched_at: 2026-07-28T01:49:38+00:00
---
# community.general.rax_facts module – Gather facts for Rackspace Cloud Servers
...
> see [Requirements](rax_facts_module.md#ansible-collections-community-general-rax-facts-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.rax_facts`.

- [DEPRECATED](rax_facts_module.md#deprecated)
- [Synopsis](rax_facts_module.md#synopsis)
- [Requirements](rax_facts_module.md#requirements)
- [Parameters](rax_facts_module.md#parameters)
- [Attributes](rax_facts_module.md#attributes)
- [Notes](rax_facts_module.md#notes)
- [Examples](rax_facts_module.md#examples)
- [Status](rax_facts_module.md#status)

## [DEPRECATED](rax_facts_module.md#id1)
...
## [Synopsis](rax_facts_module.md#id2)

- Gather facts for Rackspace Cloud Servers.

Aliases: cloud.rackspace.rax_facts

## [Requirements](rax_facts_module.md#id3)
...
## [Parameters](rax_facts_module.md#id4)
...
## [Attributes](rax_facts_module.md#id5)
...
## [Examples](rax_facts_module.md#id7)
...
## [Status](rax_facts_module.md#id8)

- This module will be removed in version 9.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rax_facts_module.md#deprecated).
