...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/jail_connection.html
fetched_at: 2026-07-28T01:52:11+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **remote_addr**  string | Path to the jail  **Default:** `"inventory_hostname"`  **Configuration:**   - Variable: inventory_hostname - Variable: ansible_host - Variable: ansible_jail_host |
