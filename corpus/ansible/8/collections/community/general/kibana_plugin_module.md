...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/kibana_plugin_module.html
fetched_at: 2026-07-28T01:47:24+00:00
---
...
- [Attributes](kibana_plugin_module.md#attributes)
...
| **version**  string | Version of the plugin to be installed.  If plugin exists with previous version, plugin will **not** be updated unless `force` is set to `true`. |

## [Attributes](kibana_plugin_module.md#id3)
...
## [Examples](kibana_plugin_module.md#id4)
...
## [Return Values](kibana_plugin_module.md#id5)
