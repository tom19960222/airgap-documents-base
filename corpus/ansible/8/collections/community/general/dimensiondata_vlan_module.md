...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/dimensiondata_vlan_module.html
fetched_at: 2026-07-28T01:45:22+00:00
---
...
- [Attributes](dimensiondata_vlan_module.md#attributes)
...
Aliases: cloud.dimensiondata.dimensiondata_vlan
...
## [Attributes](dimensiondata_vlan_module.md#id3)
...
## [Examples](dimensiondata_vlan_module.md#id4)
...
## [Return Values](dimensiondata_vlan_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **vlan**  complex | Dictionary describing the VLAN.  **Returned:** On success when `state=present` |
