...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/online_server_info_module.html
fetched_at: 2026-07-28T01:48:39+00:00
---
...
- [Attributes](online_server_info_module.md#attributes)
...
Aliases: cloud.online.online_server_info
...
## [Attributes](online_server_info_module.md#id3)
...
## [Notes](online_server_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://console.online.net/en/api/>
> - If `api_token` is not set within the module, the following environment variables can be used in decreasing order of precedence [`ONLINE_TOKEN`](../../environment_variables.md#envvar-ONLINE_TOKEN), [`ONLINE_API_KEY`](../../environment_variables.md#envvar-ONLINE_API_KEY), [`ONLINE_OAUTH_TOKEN`](../../environment_variables.md#envvar-ONLINE_OAUTH_TOKEN), `ONLINE_API_TOKEN`.
> - If one wants to use a different `api_url` one can also set the `ONLINE_API_URL` environment variable.

## [Examples](online_server_info_module.md#id5)
...
## [Return Values](online_server_info_module.md#id6)
