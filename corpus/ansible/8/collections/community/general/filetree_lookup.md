...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/filetree_lookup.html
...
| **src**  path | Full path to file.  Not returned when `_raw[].state` is set to `directory`.  **Returned:** success |
