...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/rhn_channel_module.html
...
- [DEPRECATED](rhn_channel_module.md#deprecated)
- [Synopsis](rhn_channel_module.md#synopsis)
- [Parameters](rhn_channel_module.md#parameters)
- [Attributes](rhn_channel_module.md#attributes)
- [Notes](rhn_channel_module.md#notes)
- [Examples](rhn_channel_module.md#examples)
- [Status](rhn_channel_module.md#status)

## [DEPRECATED](rhn_channel_module.md#id1)
...
## [Synopsis](rhn_channel_module.md#id2)

- Adds or removes Red Hat software channels.

Aliases: packaging.os.rhn_channel

## [Parameters](rhn_channel_module.md#id3)
...
## [Attributes](rhn_channel_module.md#id4)
...
## [Notes](rhn_channel_module.md#id5)

> **Note:**
>
> - This module fetches the system id from RHN.

## [Examples](rhn_channel_module.md#id6)
...
## [Status](rhn_channel_module.md#id7)

- This module will be removed in version 10.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](rhn_channel_module.md#deprecated).
