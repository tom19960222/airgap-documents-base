...
collection: ansible
version: "8"
title: "community.general.xen_orchestra inventory – Xen Orchestra inventory source"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/xen_orchestra_inventory.html
fetched_at: 2026-07-28T01:52:39+00:00
---
...
> see [Requirements](xen_orchestra_inventory.md#ansible-collections-community-general-xen-orchestra-inventory-requirements) for details.
>
> To use it in a playbook, specify: `community.general.xen_orchestra`.

New in community.general 4.1.0

- [Synopsis](xen_orchestra_inventory.md#synopsis)
- [Requirements](xen_orchestra_inventory.md#requirements)
- [Parameters](xen_orchestra_inventory.md#parameters)
- [Examples](xen_orchestra_inventory.md#examples)

## [Synopsis](xen_orchestra_inventory.md#id1)
...
## [Requirements](xen_orchestra_inventory.md#id2)

The below requirements are needed on the local controller node that executes this inventory.

- websocket-client >= 1.0.0

## [Parameters](xen_orchestra_inventory.md#id3)

| Parameter | Comments |
| --- | --- |
| **api_host**  string | API host to XOA API.  If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_HOST`](../../environment_variables.md#envvar-ANSIBLE_XO_HOST) will be used instead.  **Configuration:**   - Environment variable: [`ANSIBLE_XO_HOST`](../../environment_variables.md#envvar-ANSIBLE_XO_HOST) |
...
| **password**  string / required | Xen Orchestra password.  If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_PASSWORD`](../../environment_variables.md#envvar-ANSIBLE_XO_PASSWORD) will be used instead.  **Configuration:**   - Environment variable: [`ANSIBLE_XO_PASSWORD`](../../environment_variables.md#envvar-ANSIBLE_XO_PASSWORD) |
| **plugin**  string / required | The name of this plugin, it should always be set to `community.general.xen_orchestra` for this plugin to recognize it as its own.  **Choices:**   - `"community.general.xen_orchestra"` |
...
| **use_ssl**  boolean | Use wss when connecting to the Xen Orchestra API  **Choices:**   - `false` - `true` ← (default) |
| **user**  string / required | Xen Orchestra user.  If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_USER`](../../environment_variables.md#envvar-ANSIBLE_XO_USER) will be used instead.  **Configuration:**   - Environment variable: [`ANSIBLE_XO_USER`](../../environment_variables.md#envvar-ANSIBLE_XO_USER) |
| **validate_certs**  boolean | Verify TLS certificate if using HTTPS.  **Choices:**   - `false` - `true` ← (default) |

## [Examples](xen_orchestra_inventory.md#id4)
