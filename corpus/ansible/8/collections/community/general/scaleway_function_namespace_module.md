...
collection: ansible
version: "8"
title: "community.general.scaleway_function_namespace module – Scaleway Function namespace management"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/scaleway_function_namespace_module.html
fetched_at: 2026-07-28T01:50:15+00:00
---
# community.general.scaleway_function_namespace module – Scaleway Function namespace management
...
> see [Requirements](scaleway_function_namespace_module.md#ansible-collections-community-general-scaleway-function-namespace-module-requirements) for details.
>
> To use it in a playbook, specify: `community.general.scaleway_function_namespace`.

New in community.general 6.0.0

- [Synopsis](scaleway_function_namespace_module.md#synopsis)
- [Requirements](scaleway_function_namespace_module.md#requirements)
- [Parameters](scaleway_function_namespace_module.md#parameters)
- [Attributes](scaleway_function_namespace_module.md#attributes)
- [Notes](scaleway_function_namespace_module.md#notes)
- [Examples](scaleway_function_namespace_module.md#examples)
- [Return Values](scaleway_function_namespace_module.md#return-values)

## [Synopsis](scaleway_function_namespace_module.md#id1)

- This module manages function namespaces on Scaleway account.

Aliases: cloud.scaleway.scaleway_function_namespace

## [Requirements](scaleway_function_namespace_module.md#id2)

The below requirements are needed on the host that executes this module.

- passlib[argon2] >= 1.7.4

## [Parameters](scaleway_function_namespace_module.md#id3)
...
| **description**  string | Description of the function namespace.  **Default:** `""` |
| **environment_variables**  dictionary | Environment variables of the function namespace.  Injected in functions at runtime.  **Default:** `{}` |
| **name**  string / required | Name of the function namespace. |
...
| **secret_environment_variables**  dictionary | Secret environment variables of the function namespace.  Updating those values will not output a `changed` state in Ansible.  Injected in functions at runtime.  **Default:** `{}` |
| **state**  string | Indicate desired state of the function namespace.  **Choices:**   - `"present"` ← (default) - `"absent"` |
...
## [Attributes](scaleway_function_namespace_module.md#id4)
...
## [Notes](scaleway_function_namespace_module.md#id5)
...
## [Examples](scaleway_function_namespace_module.md#id6)
