...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/spotinst_aws_elastigroup_module.html
...
- [Attributes](spotinst_aws_elastigroup_module.md#attributes)
...
Aliases: cloud.spotinst.spotinst_aws_elastigroup
...
| **elastic_beanstalk**  dictionary | Placeholder parameter for future implementation of Elastic Beanstalk configurations. |
...
| **multai_load_balancers**  list / elements=dictionary | Configuration parameters for Multai load balancers. |
...
| **opsworks**  dictionary | The elastigroup OpsWorks integration configuration.; Expects the following key - layer_id (String) |
| **persistence**  dictionary | The Stateful elastigroup configuration.; Accepts the following keys - should_persist_root_device (Boolean), should_persist_block_devices (Boolean), should_persist_private_ip (Boolean) |
...
| **token**  string | A Personal API Access Token issued by Spotinst.  When not specified, the module will try to obtain it, in that order, from: environment variable `SPOTINST_TOKEN`, or from the credentials path. |
...
## [Attributes](spotinst_aws_elastigroup_module.md#id4)
...
## [Examples](spotinst_aws_elastigroup_module.md#id5)
...
## [Return Values](spotinst_aws_elastigroup_module.md#id6)
