...
collection: ansible
version: "8"
title: "community.general.to_seconds filter – Converte a duration string to seconds"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/to_seconds_filter.html
fetched_at: 2026-07-28T01:52:26+00:00
---
...
- [Synopsis](to_seconds_filter.md#synopsis)
- [Input](to_seconds_filter.md#input)
- [Keyword parameters](to_seconds_filter.md#keyword-parameters)
- [Examples](to_seconds_filter.md#examples)
- [Return Value](to_seconds_filter.md#return-value)

## [Synopsis](to_seconds_filter.md#id1)

- Parse a human readable time duration string and convert to seconds.

## [Input](to_seconds_filter.md#id2)
...
## [Keyword parameters](to_seconds_filter.md#id3)

This describes keyword parameters of the filter. These are the values `key1=value1`, `key2=value2` and so on in the following
example: `input | community.general.to_seconds(key1=value1, key2=value2, ...)`
...
## [Examples](to_seconds_filter.md#id4)
...
## [Return Value](to_seconds_filter.md#id5)

| Key | Description |
| --- | --- |
| **Return value**  float | Number of seconds.  **Returned:** success |
