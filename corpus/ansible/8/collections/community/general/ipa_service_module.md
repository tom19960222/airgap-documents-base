...
collection: ansible
version: "8"
title: "community.general.ipa_service module – Manage FreeIPA service"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/ipa_service_module.html
fetched_at: 2026-07-28T01:46:43+00:00
---
# community.general.ipa_service module – Manage FreeIPA service
...
- [Synopsis](ipa_service_module.md#synopsis)
- [Parameters](ipa_service_module.md#parameters)
- [Attributes](ipa_service_module.md#attributes)
- [Examples](ipa_service_module.md#examples)
- [Return Values](ipa_service_module.md#return-values)

## [Synopsis](ipa_service_module.md#id1)

- Add and delete an IPA service using IPA API.

Aliases: identity.ipa.ipa_service

## [Parameters](ipa_service_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **force**  boolean | Force principal name even if host is not in DNS.  **Choices:**   - `false` - `true` |
| **hosts**  list / elements=string | Defines the list of ‘ManagedBy’ hosts. |
...
| **krbcanonicalname**  aliases: name  string / required | Principal of the service.  Can not be changed as it is the unique identifier. |
| **skip_host_check**  boolean  *added in community.general 4.7.0* | Force service to be created even when host object does not exist to manage it.  This is only used on creation, not for updating existing services.  **Choices:**   - `false` ← (default) - `true` |
...
## [Attributes](ipa_service_module.md#id3)
...
## [Examples](ipa_service_module.md#id4)
...
## [Return Values](ipa_service_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **service**  dictionary | Service as returned by IPA API.  **Returned:** always |
