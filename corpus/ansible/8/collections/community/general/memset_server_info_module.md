...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/general/memset_server_info_module.html
fetched_at: 2026-07-28T01:47:57+00:00
---
...
- [Attributes](memset_server_info_module.md#attributes)
...
Aliases: cloud.memset.memset_server_info
...
| **name**  string / required | The server product name (that is, `testyaa1`). |

## [Attributes](memset_server_info_module.md#id3)
...
## [Return Values](memset_server_info_module.md#id6)
