...
collection: ansible
version: "8"
title: "community.hashi_vault.vault_list lookup – Perform a list operation against HashiCorp Vault"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/vault_list_lookup.html
fetched_at: 2026-07-28T01:53:38+00:00
---
# community.hashi_vault.vault_list lookup – Perform a list operation against HashiCorp Vault
...
> see [Requirements](vault_list_lookup.md#ansible-collections-community-hashi-vault-vault-list-lookup-requirements) for details.
>
> To use it in a playbook, specify: `community.hashi_vault.vault_list`.

New in community.hashi_vault 4.1.0

- [Synopsis](vault_list_lookup.md#synopsis)
- [Requirements](vault_list_lookup.md#requirements)
- [Terms](vault_list_lookup.md#terms)
- [Keyword parameters](vault_list_lookup.md#keyword-parameters)
- [Notes](vault_list_lookup.md#notes)
- [See Also](vault_list_lookup.md#see-also)
- [Examples](vault_list_lookup.md#examples)
- [Return Value](vault_list_lookup.md#return-value)

## [Synopsis](vault_list_lookup.md#id1)

- Performs a generic list operation against a given path in HashiCorp Vault.

## [Requirements](vault_list_lookup.md#id2)
...
## [Terms](vault_list_lookup.md#id3)

| Parameter | Comments |
| --- | --- |
| **Terms**  string / required | Vault path(s) to be listed. |

## [Keyword parameters](vault_list_lookup.md#id4)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('community.hashi_vault.vault_list', key1=value1, key2=value2, ...)` and `query('community.hashi_vault.vault_list', key1=value1, key2=value2, ...)`
...
## [Notes](vault_list_lookup.md#id5)

> **Note:**
>
> - When keyword and positional parameters are used together, positional parameters must be listed before keyword parameters:
>   `lookup('community.hashi_vault.vault_list', term1, term2, key1=value1, key2=value2)` and `query('community.hashi_vault.vault_list', term1, term2, key1=value1, key2=value2)`

## [See Also](vault_list_lookup.md#id6)

> **See also:**
>
> [community.hashi_vault.vault_list](vault_list_module.md#ansible-collections-community-hashi-vault-vault-list-module)
> :   Perform a list operation against HashiCorp Vault.

## [Examples](vault_list_lookup.md#id7)
...
## [Return Value](vault_list_lookup.md#id8)
