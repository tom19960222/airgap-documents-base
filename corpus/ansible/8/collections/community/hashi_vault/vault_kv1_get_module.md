...
collection: ansible
version: "8"
title: "community.hashi_vault.vault_kv1_get module – Get a secret from HashiCorp Vault’s KV version 1 secret store"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/vault_kv1_get_module.html
fetched_at: 2026-07-28T01:53:26+00:00
---
...
> see [Requirements](vault_kv1_get_module.md#ansible-collections-community-hashi-vault-vault-kv1-get-module-requirements) for details.
>
> To use it in a playbook, specify: `community.hashi_vault.vault_kv1_get`.

New in community.hashi_vault 2.5.0

- [Synopsis](vault_kv1_get_module.md#synopsis)
- [Requirements](vault_kv1_get_module.md#requirements)
- [Parameters](vault_kv1_get_module.md#parameters)
- [Attributes](vault_kv1_get_module.md#attributes)
- [See Also](vault_kv1_get_module.md#see-also)
- [Examples](vault_kv1_get_module.md#examples)
- [Return Values](vault_kv1_get_module.md#return-values)

## [Synopsis](vault_kv1_get_module.md#id1)

- Gets a secret from HashiCorp Vault’s KV version 1 secret store.

## [Requirements](vault_kv1_get_module.md#id2)
...
## [Parameters](vault_kv1_get_module.md#id3)
...
| **engine_mount_point**  string | The path where the secret backend is mounted.  **Default:** `"kv"` |
...
| **path**  string / required | Vault KV path to be read.  This is relative to the *engine_mount_point*, so the mount path should not be included. |
...
## [Attributes](vault_kv1_get_module.md#id4)
...
## [See Also](vault_kv1_get_module.md#id5)
...
## [Examples](vault_kv1_get_module.md#id6)
...
## [Return Values](vault_kv1_get_module.md#id7)
