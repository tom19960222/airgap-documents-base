...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/docsite/contributor_guide.html
fetched_at: 2026-07-28T01:53:25+00:00
---
# Contributor guide
...
> **Note:**
>
> This guide can be improved with your help! Open a [GitHub issue in the repository](https://github.com/ansible-collections/community.hashi_vault/issues) or contribute directly by following the instructions below.

- [Quick start](contributor_guide.md#quick-start)
- [Contributing documentation](contributor_guide.md#contributing-documentation)

  - [README and other markdown files](contributor_guide.md#readme-and-other-markdown-files)
  - [Module and plugin documentation](contributor_guide.md#module-and-plugin-documentation)
  - [Collection docsite](contributor_guide.md#collection-docsite)
- [Running tests locally](contributor_guide.md#running-tests-locally)

  - [Integration Tests](contributor_guide.md#integration-tests)

    - [Docker Compose localenv](contributor_guide.md#docker-compose-localenv)
- [Contributing auth methods](contributor_guide.md#contributing-auth-methods)

  - [File location & scope](contributor_guide.md#file-location-scope)
  - [Class anatomy](contributor_guide.md#class-anatomy)
  - [Raising exceptions and warnings](contributor_guide.md#raising-exceptions-and-warnings)
  - [Accessing options](contributor_guide.md#accessing-options)
  - [The authenticator](contributor_guide.md#the-authenticator)
  - [Auth method options and documentation](contributor_guide.md#auth-method-options-and-documentation)
  - [Testing auth methods](contributor_guide.md#testing-auth-methods)

    - [Unit tests](contributor_guide.md#unit-tests)
    - [Integration tests](contributor_guide.md#id1)
    - [Test coverage](contributor_guide.md#test-coverage)

## [Quick start](contributor_guide.md#id2)

1. Log into your GitHub account.
2. Fork the [ansible-collections/community.hashi_vault repository](https://github.com/ansible-collections/community.hashi_vault) by clicking the **Fork** button in the upper right corner. This will create a fork in your own account.
3. Clone the repository locally, following [the example instructions here](../../../../dev_guide/developing_collections_contributing.md#hacking-collections) (but replace `general` with `hashi_vault`). **Pay special attention to the local path structure** of the cloned repository as described in those instructions (for example `ansible_collections/community/hashi_vault`).
...
5. [See the guidance on Changelogs](../../../../community/development_process.md#community-changelogs) and include a [changelog fragment](../../../../community/development_process.md#changelogs-how-to) if appropriate.

## [Contributing documentation](contributor_guide.md#id3)
...
### [README and other markdown files](contributor_guide.md#id4)
...
The main exception to the above is the `README.md` in the repository root. This file is more important because it provides introductory information and links for anyone browsing the repository, both on GitHub and on the collection’s [Ansible Galaxy page](https://galaxy.ansible.com/community/hashi_vault).
...
Your IDE or code editor may also be able to preview these files. For example [Visual Studio Code has built-in markdown preview](https://code.visualstudio.com/docs/languages/markdown#_markdown-preview).

### [Module and plugin documentation](contributor_guide.md#id5)

This type of documentation gets generated from structured YAML, inside of a Python string. It is included in the same code that it’s documenting, or in a separate Python file, such as a doc fragment. Please see the [module format and documentation guidance](../../../../dev_guide/developing_modules_documenting.md#developing-modules-documenting) for more information.

This type of documentation is highly structured and tested with `ansible-test sanity`. Full instructions are available on the [testing module documentation](../../../../dev_guide/testing_documentation.md#testing-module-documentation) page.
...
### [Collection docsite](contributor_guide.md#id6)

The collection docsite is what you are reading now. It is written in reStructuredText (RST) format and published on the [ansible_documentation](https://docs.ansible.com/ansible/7/index.html#ansible-documentation "(in Ansible v7)") site. This is where we have long-form documentation that doesn’t fit into the other two categories.
...
Refer to the [Ansible style guide](../../../../dev_guide/style_guide/index.md#style-guide) for all submissions to the collection docsite.
...
## [Running tests locally](contributor_guide.md#id7)
...
First, [review the guidance on testing collections](../../../../dev_guide/developing_collections_testing.md#testing-collections), as it applies to this collection as well.

### [Integration Tests](contributor_guide.md#id8)

Unlike other collections, we require an [integration_config.yml](https://docs.ansible.com/ansible/latest/dev_guide/testing_integration.html#integration-config-yml) file for properly running integration tests, as the tests require external dependencies (like a Vault server) and they need to know where to find those dependencies.
...
#### [Docker Compose localenv](contributor_guide.md#id9)
...
## [Contributing auth methods](contributor_guide.md#id10)
...
### [File location & scope](contributor_guide.md#id11)
...
It is best to look at [existing auth methods](https://github.com/ansible-collections/community.hashi_vault/tree/main/plugins/module_utils) to get a feel for how they are implemented.

### [Class anatomy](contributor_guide.md#id12)
...
### [Raising exceptions and warnings](contributor_guide.md#id13)
...
### [Accessing options](contributor_guide.md#id14)
...
### [The authenticator](contributor_guide.md#id15)

The `HashiVaultAuthenticator` class is how most of the content in the collection will handle authentication, rather than having to directly references each individual auth method. As a result, `_authenticator.py` needs to be modified for every new auth method, because it imports and directly references each class. See [the implementation of this class](https://github.com/ansible-collections/community.hashi_vault/blob/main/plugins/module_utils/_authenticator.py) to find the places that need to be modified.

### [Auth method options and documentation](contributor_guide.md#id16)
...
### [Testing auth methods](contributor_guide.md#id17)
...
#### [Unit tests](contributor_guide.md#id18)
...
#### [Integration tests](contributor_guide.md#id19)
...
#### [Test coverage](contributor_guide.md#id20)
