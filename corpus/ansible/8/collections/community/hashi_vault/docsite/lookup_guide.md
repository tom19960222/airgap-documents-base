...
version: "8"
title: "Lookup guide"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/docsite/lookup_guide.html
fetched_at: 2026-07-28T01:53:24+00:00
---
# Lookup guide
...
For information about the `hashi_vault` lookup specifically, see [this page that covers it in detail](about_hashi_vault_lookup.md#ansible-collections-community-hashi-vault-docsite-about-hashi-vault-lookup).

- [Lookups and writes](lookup_guide.md#lookups-and-writes)

  - [Writes in Vault](lookup_guide.md#writes-in-vault)
  - [How to reason about when to use lookups](lookup_guide.md#how-to-reason-about-when-to-use-lookups)
  - [Lookups and lazy templating](lookup_guide.md#lookups-and-lazy-templating)

## [Lookups and writes](lookup_guide.md#id1)

Most Ansible lookups perform read-only, non-destructive operations. They are run in templating, they generally *return* values, and they **do not run differently in check mode** (that is they do the same thing they would in normal mode, even if that means changing something). However, some lookups do change state, sometimes by performing write operations. For example, the `password` [lookup](../../../ansible/builtin/password_lookup.md#ansible-collections-ansible-builtin-password-lookup) writes a generated password to a file, to act as a sort of cache, and the `pipe` [lookup](../../../ansible/builtin/pipe_lookup.md#ansible-collections-ansible-builtin-pipe-lookup) runs an arbitrary shell command so it could easily write or change state.

### [Writes in Vault](lookup_guide.md#id2)
...
### [How to reason about when to use lookups](lookup_guide.md#id3)
...
### [Lookups and lazy templating](lookup_guide.md#id4)
