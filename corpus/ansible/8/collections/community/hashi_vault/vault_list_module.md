...
collection: ansible
version: "8"
title: "community.hashi_vault.vault_list module – Perform a list operation against HashiCorp Vault"
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/vault_list_module.html
fetched_at: 2026-07-28T01:53:29+00:00
---
...
> see [Requirements](vault_list_module.md#ansible-collections-community-hashi-vault-vault-list-module-requirements) for details.
>
> To use it in a playbook, specify: `community.hashi_vault.vault_list`.

New in community.hashi_vault 4.1.0

- [Synopsis](vault_list_module.md#synopsis)
- [Requirements](vault_list_module.md#requirements)
- [Parameters](vault_list_module.md#parameters)
- [Attributes](vault_list_module.md#attributes)
- [See Also](vault_list_module.md#see-also)
- [Examples](vault_list_module.md#examples)
- [Return Values](vault_list_module.md#return-values)

## [Synopsis](vault_list_module.md#id1)

- Performs a generic list operation against a given path in HashiCorp Vault.

## [Requirements](vault_list_module.md#id2)
...
## [Parameters](vault_list_module.md#id3)
...
| **path**  string / required | Vault path to be listed. |
...
## [Attributes](vault_list_module.md#id4)
...
## [See Also](vault_list_module.md#id5)

> **See also:**
>
> [community.hashi_vault.vault_list lookup](vault_list_lookup.md#ansible-collections-community-hashi-vault-vault-list-lookup)
> :   The official documentation for the `community.hashi_vault.vault_list` lookup plugin.

## [Examples](vault_list_module.md#id6)
...
## [Return Values](vault_list_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **data**  dictionary | The raw result of the list against the given path.  **Returned:** success |
