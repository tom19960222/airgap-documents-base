...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/hashi_vault/vault_token_create_module.html
fetched_at: 2026-07-28T01:53:32+00:00
---
...
- [Attributes](vault_token_create_module.md#attributes)
...
## [Attributes](vault_token_create_module.md#id4)
...
| **check_mode** | **Support:** **partial**  In check mode, this module will not create a token, and will instead return a basic structure with an empty token. However, this may not be useful if the token is required for follow on tasks.  It may be better to use this module with *check_mode=false* in order to have a valid token that can be used. | Can run in `check_mode` and return changed status prediction without modifying target. |

## [Notes](vault_token_create_module.md#id5)
...
## [See Also](vault_token_create_module.md#id6)
...
>
> [community.hashi_vault.vault_login_token filter](vault_login_token_filter.md#ansible-collections-community-hashi-vault-vault-login-token-filter)
> :   The official documentation for the `community.hashi_vault.vault_login_token` filter plugin.

## [Examples](vault_token_create_module.md#id7)
...
## [Return Values](vault_token_create_module.md#id8)
