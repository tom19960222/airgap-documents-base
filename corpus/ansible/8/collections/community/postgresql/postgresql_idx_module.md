...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_idx_module.html
...
- [Attributes](postgresql_idx_module.md#attributes)
...
## [Attributes](postgresql_idx_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](postgresql_idx_module.md#id5)
...
## [See Also](postgresql_idx_module.md#id6)
...
## [Examples](postgresql_idx_module.md#id7)
...
## [Return Values](postgresql_idx_module.md#id8)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **name**  string | Index name.  **Returned:** success  **Sample:** `"foo_idx"` |
| **query**  string | Query that was tried to be executed.  **Returned:** success  **Sample:** `"CREATE INDEX CONCURRENTLY foo_idx ON test_table USING BTREE (id)"` |
| **schema**  string | Schema where index exists.  **Returned:** success  **Sample:** `"public"` |
| **state**  string | Index state.  **Returned:** success  **Sample:** `"present"` |
| **storage_params**  list / elements=string | Index storage parameters.  **Returned:** success  **Sample:** `["fillfactor=90"]` |
| **tablespace**  string | Tablespace where index exists.  **Returned:** success  **Sample:** `"ssd"` |
| **valid**  boolean | Index validity.  **Returned:** success  **Sample:** `true` |
