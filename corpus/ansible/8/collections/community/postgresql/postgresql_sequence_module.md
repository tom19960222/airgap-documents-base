...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_sequence_module.html
fetched_at: 2026-07-28T01:58:35+00:00
---
...
- [Attributes](postgresql_sequence_module.md#attributes)
...
## [Attributes](postgresql_sequence_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](postgresql_sequence_module.md#id5)
...
## [See Also](postgresql_sequence_module.md#id6)
...
## [Examples](postgresql_sequence_module.md#id7)
...
## [Return Values](postgresql_sequence_module.md#id8)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cycle**  boolean | Shows if the sequence cycle or not.  **Returned:** success  **Sample:** `false` |
| **data_type**  string | Shows the current data type of the sequence.  **Returned:** success  **Sample:** `"bigint"` |
| **increment**  integer | The value of increment of the sequence. A positive value will make an ascending sequence, a negative one a descending sequence.  **Returned:** success  **Sample:** `-1` |
| **maxvalue**  integer | The value of maxvalue of the sequence.  **Returned:** success  **Sample:** `9223372036854775807` |
| **minvalue**  integer | The value of minvalue of the sequence.  **Returned:** success  **Sample:** `1` |
| **newname**  string | Shows the new sequence name after rename.  **Returned:** success  **Sample:** `"barfoo"` |
| **newschema**  string | Shows the new schema of the sequence after schema change.  **Returned:** success  **Sample:** `"foobar"` |
| **owner**  string | Shows the current owner of the sequence after the successful run of the task.  **Returned:** success  **Sample:** `"postgres"` |
| **queries**  string | List of queries that was tried to be executed.  **Returned:** success  **Sample:** `"['CREATE SEQUENCE \"foo\"']"` |
| **schema**  string | Name of the schema of the sequence.  **Returned:** success  **Sample:** `"foo"` |
| **sequence**  string | Sequence name.  **Returned:** success  **Sample:** `"foobar"` |
| **start**  integer | The value of start of the sequence.  **Returned:** success  **Sample:** `12` |
| **state**  string | Sequence state at the end of execution.  **Returned:** success  **Sample:** `"present"` |
