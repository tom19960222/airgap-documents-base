...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_membership_module.html
...
- [Attributes](postgresql_membership_module.md#attributes)
...
## [Attributes](postgresql_membership_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](postgresql_membership_module.md#id5)
...
## [See Also](postgresql_membership_module.md#id6)
...
## [Examples](postgresql_membership_module.md#id7)
...
## [Return Values](postgresql_membership_module.md#id8)
...
| **queries**  string | List of executed queries.  **Returned:** success  **Sample:** `"['GRANT \"user_ro\" TO \"alice\"']"` |
| **revoked**  dictionary | Dict of revoked groups and roles.  **Returned:** if *state=absent*  **Sample:** `{"ro_group": ["alice", "bob"]}` |
| **state**  string | Membership state that tried to be set.  **Returned:** success  **Sample:** `"present"` |
