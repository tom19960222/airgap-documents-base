...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_subscription_module.html
fetched_at: 2026-07-28T01:58:38+00:00
---
...
- [Attributes](postgresql_subscription_module.md#attributes)
...
## [Attributes](postgresql_subscription_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](postgresql_subscription_module.md#id5)
...
## [See Also](postgresql_subscription_module.md#id6)
...
## [Examples](postgresql_subscription_module.md#id7)
...
## [Return Values](postgresql_subscription_module.md#id8)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **exists**  boolean | Flag indicates the subscription exists or not at the end of runtime.  **Returned:** success  **Sample:** `true` |
| **final_state**  dictionary | Subscription configuration at the end of runtime.  **Returned:** success  **Sample:** `{"conninfo": {}, "enabled": true, "owner": "postgres", "slotname": "test", "synccommit": true}` |
| **initial_state**  dictionary | Subscription configuration at the beginning of runtime.  **Returned:** success  **Sample:** `{"conninfo": {}, "enabled": true, "owner": "postgres", "slotname": "test", "synccommit": true}` |
| **name**  string | Name of the subscription.  **Returned:** success  **Sample:** `"acme"` |
| **queries**  string | List of executed queries.  **Returned:** success  **Sample:** `"['DROP SUBSCRIPTION \"mysubscription\"']"` |
