...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_pg_hba_module.html
fetched_at: 2026-07-28T01:58:30+00:00
---
...
- [Attributes](postgresql_pg_hba_module.md#attributes)
...
## [Attributes](postgresql_pg_hba_module.md#id4)
...
## [Notes](postgresql_pg_hba_module.md#id5)
...
## [See Also](postgresql_pg_hba_module.md#id6)
...
## [Examples](postgresql_pg_hba_module.md#id7)
...
## [Return Values](postgresql_pg_hba_module.md#id8)
...
| **msgs**  list / elements=string | List of textual messages what was done.  **Returned:** success  **Sample:** `{"msgs": ["Removing", "Changed", "Writing"]}` |
| **pg_hba**  list / elements=string | List of the pg_hba rules as they are configured in the specified hba file.  **Returned:** success  **Sample:** `{"pg_hba": [{"db": "all", "method": "md5", "src": "samehost", "type": "host", "usr": "all"}]}` |
