...
source_url: https://docs.ansible.com/projects/ansible/8/collections/community/postgresql/postgresql_privs_module.html
...
- [Attributes](postgresql_privs_module.md#attributes)
...
## [Synopsis](postgresql_privs_module.md#id1)
...
## [Requirements](postgresql_privs_module.md#id2)

The below requirements are needed on the host that executes this module.

- psycopg2

## [Parameters](postgresql_privs_module.md#id3)
...
## [Attributes](postgresql_privs_module.md#id4)

| Attribute | Support | Description |
| --- | --- | --- |
| **check_mode** | **Support:** **full** | Can run in check_mode and return changed status prediction without modifying target. |

## [Notes](postgresql_privs_module.md#id5)
...
## [See Also](postgresql_privs_module.md#id6)
...
## [Examples](postgresql_privs_module.md#id7)
...
## [Return Values](postgresql_privs_module.md#id8)
