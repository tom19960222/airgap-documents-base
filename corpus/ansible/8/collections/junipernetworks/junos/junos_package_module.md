...
source_url: https://docs.ansible.com/projects/ansible/8/collections/junipernetworks/junos/junos_package_module.html
...
| **unlink**  boolean | The *unlink* argument is responsible for instructing the remote device to remove the installation packages after installation.  **Choices:**   - `false` ← (default) - `true` |
