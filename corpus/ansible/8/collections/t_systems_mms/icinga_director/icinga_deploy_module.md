...
collection: ansible
version: "8"
title: "t_systems_mms.icinga_director.icinga_deploy module – Trigger deployment in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/t_systems_mms/icinga_director/icinga_deploy_module.html
fetched_at: 2026-07-28T02:54:01+00:00
---
# t_systems_mms.icinga_director.icinga_deploy module – Trigger deployment in Icinga2
...
>
> To use it in a playbook, specify: `t_systems_mms.icinga_director.icinga_deploy`.

New in t_systems_mms.icinga_director 1.33.0

- [Synopsis](icinga_deploy_module.md#synopsis)
- [Parameters](icinga_deploy_module.md#parameters)
- [Examples](icinga_deploy_module.md#examples)
- [Return Values](icinga_deploy_module.md#return-values)

## [Synopsis](icinga_deploy_module.md#id1)

- Trigger a deployment to Icinga2 through the director API.

## [Parameters](icinga_deploy_module.md#id2)
...
## [Examples](icinga_deploy_module.md#id3)
...
## [Return Values](icinga_deploy_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **checksum**  string | Checksum of the configuration that should be rolled out  **Returned:** always  **Sample:** `"{'checksum': '294bdfb53c4da471e37317beed549a953c939424'}"` |
