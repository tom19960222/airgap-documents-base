...
collection: ansible
version: "8"
title: "t_systems_mms.icinga_director.icinga_user_template module – Manage user templates in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/t_systems_mms/icinga_director/icinga_user_template_module.html
fetched_at: 2026-07-28T02:54:36+00:00
---
# t_systems_mms.icinga_director.icinga_user_template module – Manage user templates in Icinga2
...
>
> To use it in a playbook, specify: `t_systems_mms.icinga_director.icinga_user_template`.

New in t_systems_mms.icinga_director 1.0.0

- [Synopsis](icinga_user_template_module.md#synopsis)
- [Parameters](icinga_user_template_module.md#parameters)
- [Notes](icinga_user_template_module.md#notes)
- [Examples](icinga_user_template_module.md#examples)

## [Synopsis](icinga_user_template_module.md#id1)

- Add or remove a user template to Icinga2 through the director API.

## [Parameters](icinga_user_template_module.md#id2)
...
| **enable_notifications**  boolean | Whether to send notifications for this user.  **Choices:**   - `false` - `true` |
...
| **object_name**  aliases: name  string / required | Name of the user template. |
...
## [Notes](icinga_user_template_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_user_template_module.md#id4)
