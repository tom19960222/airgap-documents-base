...
collection: ansible
version: "8"
title: "t_systems_mms.icinga_director.icinga_user_info module – Query users in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/t_systems_mms/icinga_director/icinga_user_info_module.html
fetched_at: 2026-07-28T02:54:35+00:00
---
# t_systems_mms.icinga_director.icinga_user_info module – Query users in Icinga2
...
>
> To use it in a playbook, specify: `t_systems_mms.icinga_director.icinga_user_info`.

New in t_systems_mms.icinga_director 1.13.0

- [Synopsis](icinga_user_info_module.md#synopsis)
- [Parameters](icinga_user_info_module.md#parameters)
- [Notes](icinga_user_info_module.md#notes)
- [Examples](icinga_user_info_module.md#examples)
- [Return Values](icinga_user_info_module.md#return-values)

## [Synopsis](icinga_user_info_module.md#id1)

- Get a list of user objects from Icinga2 through the director API.

## [Parameters](icinga_user_info_module.md#id2)
...
## [Notes](icinga_user_info_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_user_info_module.md#id4)
...
## [Return Values](icinga_user_info_module.md#id5)
