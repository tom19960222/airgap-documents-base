...
collection: ansible
version: "8"
title: "t_systems_mms.icinga_director.icinga_notification module – Manage notifications in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/t_systems_mms/icinga_director/icinga_notification_module.html
fetched_at: 2026-07-28T02:54:11+00:00
---
...
| **disabled**  boolean  *added in t_systems_mms.icinga_director 1.9.0* | Disabled objects will not be deployed.  **Choices:**   - `false` ← (default) - `true` |
...
| **states**  list / elements=string  *added in t_systems_mms.icinga_director 1.9.0* | The host or service states you want to get notifications for. |
| **times_begin**  integer  *added in t_systems_mms.icinga_director 1.15.0* | First notification delay.  Delay unless the first notification should be sent. |
| **times_end**  integer  *added in t_systems_mms.icinga_director 1.15.0* | Last notification.  When the last notification should be sent. |
...
| **vars**  dictionary  *added in t_systems_mms.icinga_director 1.9.0* | Custom properties of the notification.  **Default:** `{}` |
