...
version: "8"
title: "Ansible.Posix"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/posix/index.html
...
- [rhel_facts module](rhel_facts_module.md#ansible-collections-ansible-posix-rhel-facts-module) – Facts module to set or override RHEL specific facts.
- [rhel_rpm_ostree module](rhel_rpm_ostree_module.md#ansible-collections-ansible-posix-rhel-rpm-ostree-module) – Ensure packages exist in a RHEL for Edge rpm-ostree based system
- [rpm_ostree_upgrade module](rpm_ostree_upgrade_module.md#ansible-collections-ansible-posix-rpm-ostree-upgrade-module) – Manage rpm-ostree upgrade transactions
...
- [jsonl callback](jsonl_callback.md#ansible-collections-ansible-posix-jsonl-callback) – Ansible screen output as JSONL (lines in json format)
