...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/posix/sysctl_module.html
fetched_at: 2026-07-28T01:09:33+00:00
---
...
| **reload**  boolean | If `true`, performs a */sbin/sysctl -p* if the `sysctl_file` is updated. If `false`, does not reload *sysctl* even if the `sysctl_file` is updated.  **Choices:**   - `false` - `true` ← (default) |
