...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/posix/json_callback.html
fetched_at: 2026-07-28T01:09:35+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **json_indent**  integer | If specified, use this many spaces for indenting in the JSON output. If <= 0, write to a single line.  **Default:** `4`  **Configuration:**   - INI entry:  ```YAML+Jinja   [defaults]   json_indent = 4   ``` - Environment variable: [`ANSIBLE_JSON_INDENT`](../../environment_variables.md#envvar-ANSIBLE_JSON_INDENT) |
