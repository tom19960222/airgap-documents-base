...
collection: ansible
version: "8"
title: "ansible.posix.debug callback – formatted stdout/stderr display"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/posix/debug_callback.html
fetched_at: 2026-07-28T01:09:34+00:00
---
...
> see [Requirements](debug_callback.md#ansible-collections-ansible-posix-debug-callback-requirements) for details.
>
> To use it in a playbook, specify: `ansible.posix.debug`.

- [Callback plugin](debug_callback.md#callback-plugin)
- [Synopsis](debug_callback.md#synopsis)
- [Requirements](debug_callback.md#requirements)
- [Parameters](debug_callback.md#parameters)

## [Callback plugin](debug_callback.md#id1)
...
## [Synopsis](debug_callback.md#id2)

- Use this callback to sort through extensive debug output

## [Requirements](debug_callback.md#id3)

The below requirements are needed on the local controller node that executes this callback.

- set as stdout in configuration

## [Parameters](debug_callback.md#id4)
