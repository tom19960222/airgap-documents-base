...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/advanced_host_list_inventory.html
fetched_at: 2026-07-28T01:08:26+00:00
---
...
> plugin name
> `advanced_host_list`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.advanced_host_list` for easy linking to the
