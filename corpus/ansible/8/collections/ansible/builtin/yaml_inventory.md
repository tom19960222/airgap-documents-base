...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/yaml_inventory.html
fetched_at: 2026-07-28T01:04:08+00:00
---
...
> plugin name
> `yaml`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.yaml` for easy linking to the
