...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/psrp_connection.html
fetched_at: 2026-07-28T01:07:56+00:00
---
...
> plugin name
> `psrp`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.psrp` for easy linking to the
