...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/async_status_module.html
...
> module name
> `async_status` even without specifying the [collections keyword](../../../collections_guide/collections_using_playbooks.md#collections-keyword).
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.async_status` for easy linking to the
...
> **See also:**
>
> [Asynchronous actions and polling](../../../playbook_guide/playbooks_async.md#playbooks-async)
