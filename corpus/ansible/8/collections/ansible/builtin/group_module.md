...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/group_module.html
...
> module name
> `group` even without specifying the [collections keyword](../../../collections_guide/collections_using_playbooks.md#collections-keyword).
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.group` for easy linking to the
...
| Parameter | Comments |
| --- | --- |
| **force**  boolean  *added in ansible-core 2.15* | Whether to delete a group even if it is the primary group of a user.  Only applicable on platforms which implement a –force flag on the group deletion command.  **Choices:**   - `false` ← (default) - `true` |
