...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/jsonfile_cache.html
fetched_at: 2026-07-28T01:07:52+00:00
---
...
> plugin name
> `jsonfile`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.jsonfile` for easy linking to the
