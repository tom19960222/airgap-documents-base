...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/sh_shell.html
fetched_at: 2026-07-28T01:08:41+00:00
---
...
> plugin name
> `sh`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.sh` for easy linking to the
