...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/inventory_hostnames_lookup.html
fetched_at: 2026-07-28T01:05:17+00:00
---
...
> plugin name
> `inventory_hostnames`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.inventory_hostnames` for easy linking to the
