...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/password_lookup.html
fetched_at: 2026-07-28T01:08:34+00:00
---
...
> plugin name
> `password`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.password` for easy linking to the
