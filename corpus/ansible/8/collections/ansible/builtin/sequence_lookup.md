...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/sequence_lookup.html
fetched_at: 2026-07-28T01:08:36+00:00
---
...
> plugin name
> `sequence`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.sequence` for easy linking to the
