...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/builtin/nested_lookup.html
fetched_at: 2026-07-28T01:08:33+00:00
---
...
> plugin name
> `nested`.
> However, we recommend you use the [Fully Qualified Collection Name (FQCN)](../../../reference_appendices/glossary.md#term-Fully-Qualified-Collection-Name-FQCN) `ansible.builtin.nested` for easy linking to the
