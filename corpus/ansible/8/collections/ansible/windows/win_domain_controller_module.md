...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/windows/win_domain_controller_module.html
fetched_at: 2026-07-28T01:10:33+00:00
---
...
| **site_name**  string | Specifies the name of an existing site where you can place the new domain controller.  This option is required when *read_only* is `true`. |
