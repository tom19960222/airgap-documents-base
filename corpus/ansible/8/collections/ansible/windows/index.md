...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/windows/index.html
...
- [async_status module](async_status_module.md#ansible-collections-ansible-windows-async-status-module) – Obtain status of asynchronous task
- [setup module](setup_module.md#ansible-collections-ansible-windows-setup-module) – Gathers facts about remote hosts
- [slurp module](slurp_module.md#ansible-collections-ansible-windows-slurp-module) – Slurps a file from remote nodes
...
- [quote filter](quote_filter.md#ansible-collections-ansible-windows-quote-filter) – Quotes argument(s) for various Windows shells
