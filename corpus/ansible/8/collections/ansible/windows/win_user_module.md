...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/windows/win_user_module.html
fetched_at: 2026-07-28T01:10:54+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **account_disabled**  boolean | `true` will disable the user account.  `false` will clear the disabled flag.  **Choices:**   - `false` - `true` |
| **account_locked**  boolean | Only `false` can be set and it will unlock the user account if locked.  **Choices:**   - `false` - `true` |
...
| **password_expired**  boolean | `true` will require the user to change their password at next login.  `false` will clear the expired password flag.  **Choices:**   - `false` - `true` |
| **password_never_expires**  boolean | `true` will set the password to never expire.  `false` will allow the password to expire.  **Choices:**   - `false` - `true` |
...
| **user_cannot_change_password**  boolean | `true` will prevent the user from changing their password.  `false` will allow the user to change their password.  **Choices:**   - `false` - `true` |
