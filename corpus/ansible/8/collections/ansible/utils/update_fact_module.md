...
collection: ansible
version: "8"
title: "ansible.utils.update_fact module – Update currently set facts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/utils/update_fact_module.html
fetched_at: 2026-07-28T01:09:42+00:00
---
# ansible.utils.update_fact module – Update currently set facts

> **Note:**
>
> This module is part of the [ansible.utils collection](https://galaxy.ansible.com/ui/repo/published/ansible/utils/) (version 2.12.0).
>
...
- [Synopsis](update_fact_module.md#synopsis)
- [Parameters](update_fact_module.md#parameters)
- [Examples](update_fact_module.md#examples)

## [Synopsis](update_fact_module.md#id1)
...
## [Parameters](update_fact_module.md#id2)
...
| **value**  any / required | The value to be set at the path.  Can be a simple or complex data structure. |

## [Examples](update_fact_module.md#id3)
