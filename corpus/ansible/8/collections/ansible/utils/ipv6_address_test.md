...
collection: ansible
version: "8"
title: "ansible.utils.ipv6_address test – Test if something is an IPv6 address"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/utils/ipv6_address_test.html
fetched_at: 2026-07-28T01:10:15+00:00
---
# ansible.utils.ipv6_address test – Test if something is an IPv6 address
...
>
> To use it in a playbook, specify: `ansible.utils.ipv6_address`.

New in ansible.utils 2.2.0

- [Synopsis](ipv6_address_test.md#synopsis)
- [Keyword parameters](ipv6_address_test.md#keyword-parameters)
- [Examples](ipv6_address_test.md#examples)
- [Return Value](ipv6_address_test.md#return-value)

## [Synopsis](ipv6_address_test.md#id1)

- This plugin checks if the provided value is a valid host IP address with IPv6 addressing scheme

## [Keyword parameters](ipv6_address_test.md#id2)

This describes keyword parameters of the test. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `input is ansible.utils.ipv6_address(key1=value1, key2=value2, ...)` and `input is not ansible.utils.ipv6_address(key1=value1, key2=value2, ...)`
...
## [Examples](ipv6_address_test.md#id3)
...
## [Return Value](ipv6_address_test.md#id4)
