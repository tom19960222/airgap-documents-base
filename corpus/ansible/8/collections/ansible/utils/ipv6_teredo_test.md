...
collection: ansible
version: "8"
title: "ansible.utils.ipv6_teredo test – Test if something appears to be an IPv6 teredo address"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/utils/ipv6_teredo_test.html
fetched_at: 2026-07-28T01:10:17+00:00
---
# ansible.utils.ipv6_teredo test – Test if something appears to be an IPv6 teredo address
...
>
> To use it in a playbook, specify: `ansible.utils.ipv6_teredo`.

New in ansible.utils 2.2.0

- [Synopsis](ipv6_teredo_test.md#synopsis)
- [Keyword parameters](ipv6_teredo_test.md#keyword-parameters)
- [Examples](ipv6_teredo_test.md#examples)
- [Return Value](ipv6_teredo_test.md#return-value)

## [Synopsis](ipv6_teredo_test.md#id1)

- This plugin checks if the provided value is a valid IPv6 teredo address

## [Keyword parameters](ipv6_teredo_test.md#id2)

This describes keyword parameters of the test. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `input is ansible.utils.ipv6_teredo(key1=value1, key2=value2, ...)` and `input is not ansible.utils.ipv6_teredo(key1=value1, key2=value2, ...)`

| Parameter | Comments |
| --- | --- |
| **ip**  string / required | A string that represents the value against which the test is going to be performed  For example: `2001::c0a8:6301:1`, `2002::c0a8:6301:1`, or `"hello_world"` |

## [Examples](ipv6_teredo_test.md#id3)
...
## [Return Value](ipv6_teredo_test.md#id4)
