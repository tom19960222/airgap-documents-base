...
collection: ansible
version: "8"
title: "ansible.utils.ip_address test – Test if something in an IP address"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ansible/utils/ip_address_test.html
fetched_at: 2026-07-28T01:10:10+00:00
---
# ansible.utils.ip_address test – Test if something in an IP address
...
>
> To use it in a playbook, specify: `ansible.utils.ip_address`.

New in ansible.utils 2.2.0

- [Synopsis](ip_address_test.md#synopsis)
- [Keyword parameters](ip_address_test.md#keyword-parameters)
- [Examples](ip_address_test.md#examples)
- [Return Value](ip_address_test.md#return-value)

## [Synopsis](ip_address_test.md#id1)

- This plugin checks if the provided value is a valid host IP address

## [Keyword parameters](ip_address_test.md#id2)

This describes keyword parameters of the test. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `input is ansible.utils.ip_address(key1=value1, key2=value2, ...)` and `input is not ansible.utils.ip_address(key1=value1, key2=value2, ...)`

| Parameter | Comments |
| --- | --- |
| **ip**  string / required | A string that represents the value against which the test is going to be performed  For example: `10.1.1.1` or `"hello-world"` |

## [Examples](ip_address_test.md#id3)
...
## [Return Value](ip_address_test.md#id4)
