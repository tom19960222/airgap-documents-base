...
collection: ansible
version: "8"
title: "vultr.cloud.user_info module – Get information about the Vultr users"
source_url: https://docs.ansible.com/projects/ansible/8/collections/vultr/cloud/user_info_module.html
fetched_at: 2026-07-28T02:59:04+00:00
---
# vultr.cloud.user_info module – Get information about the Vultr users
...
>
> To use it in a playbook, specify: `vultr.cloud.user_info`.
...
## [Parameters](user_info_module.md#id2)
...
## [Notes](user_info_module.md#id3)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](user_info_module.md#id4)
...
## [Return Values](user_info_module.md#id5)
...
| **vultr_user_info**  list / elements=string | Response from Vultr API as list.  **Returned:** available |
