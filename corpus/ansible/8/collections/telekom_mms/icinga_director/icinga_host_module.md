...
collection: ansible
version: "8"
title: "telekom_mms.icinga_director.icinga_host module – Manage hosts in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/telekom_mms/icinga_director/icinga_host_module.html
fetched_at: 2026-07-28T02:54:53+00:00
---
# telekom_mms.icinga_director.icinga_host module – Manage hosts in Icinga2
...
>
> To use it in a playbook, specify: `telekom_mms.icinga_director.icinga_host`.

New in telekom_mms.icinga_director 1.0.0

- [Synopsis](icinga_host_module.md#synopsis)
- [Parameters](icinga_host_module.md#parameters)
- [Notes](icinga_host_module.md#notes)
- [Examples](icinga_host_module.md#examples)

## [Synopsis](icinga_host_module.md#id1)

- Add or remove a host to Icinga2 through the director API.

## [Parameters](icinga_host_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **accept_config**  boolean  *added in telekom_mms.icinga_director 1.9.0* | Whether the agent is configured to accept config.  **Choices:**   - `false` - `true` |
...
| **address6**  string  *added in telekom_mms.icinga_director 1.4.0* | Host IPv6 address. Usually an IPv6 address, but may be any kind of address your check plugin is able to deal with. |
...
| **has_agent**  boolean  *added in telekom_mms.icinga_director 1.9.0* | Whether this host has the Icinga 2 Agent installed.  **Choices:**   - `false` - `true` |
...
| **imports**  list / elements=string | Choose a Host Template. Required when state is `present`.  Required if *state* is `present`. |
| **master_should_connect**  boolean  *added in telekom_mms.icinga_director 1.9.0* | Whether the parent (master) node should actively try to connect to this agent.  **Choices:**   - `false` - `true` |
...
## [Notes](icinga_host_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_host_module.md#id4)
