...
collection: ansible
version: "8"
title: "telekom_mms.icinga_director.icinga_servicegroup module – Manage servicegroups in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/telekom_mms/icinga_director/icinga_servicegroup_module.html
fetched_at: 2026-07-28T02:55:15+00:00
---
# telekom_mms.icinga_director.icinga_servicegroup module – Manage servicegroups in Icinga2
...
>
> To use it in a playbook, specify: `telekom_mms.icinga_director.icinga_servicegroup`.

New in telekom_mms.icinga_director 1.0.0

- [Synopsis](icinga_servicegroup_module.md#synopsis)
- [Parameters](icinga_servicegroup_module.md#parameters)
- [Notes](icinga_servicegroup_module.md#notes)
- [Examples](icinga_servicegroup_module.md#examples)

## [Synopsis](icinga_servicegroup_module.md#id1)

- Add or remove a servicegroup to Icinga2 through the director API.

## [Parameters](icinga_servicegroup_module.md#id2)
...
| **object_name**  aliases: name  string / required | Name for the Icinga servicegroup. |
...
## [Notes](icinga_servicegroup_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_servicegroup_module.md#id4)
