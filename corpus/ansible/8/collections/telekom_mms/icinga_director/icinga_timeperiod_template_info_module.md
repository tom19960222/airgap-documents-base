...
collection: ansible
version: "8"
title: "telekom_mms.icinga_director.icinga_timeperiod_template_info module – Query timeperiod templates in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/telekom_mms/icinga_director/icinga_timeperiod_template_info_module.html
fetched_at: 2026-07-28T02:55:22+00:00
---
# telekom_mms.icinga_director.icinga_timeperiod_template_info module – Query timeperiod templates in Icinga2
...
>
> To use it in a playbook, specify: `telekom_mms.icinga_director.icinga_timeperiod_template_info`.

New in telekom_mms.icinga_director 1.17.0

- [Synopsis](icinga_timeperiod_template_info_module.md#synopsis)
- [Parameters](icinga_timeperiod_template_info_module.md#parameters)
- [Notes](icinga_timeperiod_template_info_module.md#notes)
- [Examples](icinga_timeperiod_template_info_module.md#examples)
- [Return Values](icinga_timeperiod_template_info_module.md#return-values)

## [Synopsis](icinga_timeperiod_template_info_module.md#id1)

- Get a list of timeperiod template objects from Icinga2 through the director API.

## [Parameters](icinga_timeperiod_template_info_module.md#id2)
...
## [Notes](icinga_timeperiod_template_info_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_timeperiod_template_info_module.md#id4)
...
## [Return Values](icinga_timeperiod_template_info_module.md#id5)
