...
collection: ansible
version: "8"
title: "telekom_mms.icinga_director.icinga_service_template module – Manage service templates in Icinga2"
source_url: https://docs.ansible.com/projects/ansible/8/collections/telekom_mms/icinga_director/icinga_service_template_module.html
fetched_at: 2026-07-28T02:55:14+00:00
---
# telekom_mms.icinga_director.icinga_service_template module – Manage service templates in Icinga2
...
>
> To use it in a playbook, specify: `telekom_mms.icinga_director.icinga_service_template`.

New in telekom_mms.icinga_director 1.0.0

- [Synopsis](icinga_service_template_module.md#synopsis)
- [Parameters](icinga_service_template_module.md#parameters)
- [Notes](icinga_service_template_module.md#notes)
- [Examples](icinga_service_template_module.md#examples)

## [Synopsis](icinga_service_template_module.md#id1)

- Add or remove a service template to Icinga2 through the director API.

## [Parameters](icinga_service_template_module.md#id2)
...
| **object_name**  aliases: name  string / required | Name of the service template. |
...
| **vars**  dictionary | Custom properties of the service template.  **Default:** `{}` |
| **volatile**  boolean | Whether this check is volatile.  **Choices:**   - `false` - `true` |

## [Notes](icinga_service_template_module.md#id3)

> **Note:**
>
> - This module supports check mode.

## [Examples](icinga_service_template_module.md#id4)
