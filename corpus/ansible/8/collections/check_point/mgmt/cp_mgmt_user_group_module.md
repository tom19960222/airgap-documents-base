...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_user_group module – Manages user-group objects on Checkpoint over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_user_group_module.html
fetched_at: 2026-07-28T01:18:26+00:00
---
# check_point.mgmt.cp_mgmt_user_group module – Manages user-group objects on Checkpoint over Web Services API
...
>
> To use it in a playbook, specify: `check_point.mgmt.cp_mgmt_user_group`.

New in check_point.mgmt 5.0.0

- [Synopsis](cp_mgmt_user_group_module.md#synopsis)
- [Parameters](cp_mgmt_user_group_module.md#parameters)
- [Examples](cp_mgmt_user_group_module.md#examples)
- [Return Values](cp_mgmt_user_group_module.md#return-values)

## [Synopsis](cp_mgmt_user_group_module.md#id1)

- Manages user-group objects on Checkpoint devices including creating, updating and removing objects.
- All operations are performed over Web Services API.

## [Parameters](cp_mgmt_user_group_module.md#id2)
...
| **members**  list / elements=string | Collection of User Group objects identified by the name or UID. |
...
## [Examples](cp_mgmt_user_group_module.md#id3)
...
## [Return Values](cp_mgmt_user_group_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_user_group**  dictionary | The checkpoint object created or updated.  **Returned:** always, except when deleting the object. |
