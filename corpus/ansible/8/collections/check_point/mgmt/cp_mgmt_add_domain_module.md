...
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_add_domain_module.html
...
| **servers**  list / elements=dictionary | Domain servers. When this field is provided, ‘set-domain’ command is executed asynchronously. |
