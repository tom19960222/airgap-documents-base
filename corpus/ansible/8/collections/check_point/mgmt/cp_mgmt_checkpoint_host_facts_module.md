...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_checkpoint_host_facts module – Get checkpoint-host objects facts on Checkpoint over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_checkpoint_host_facts_module.html
fetched_at: 2026-07-28T01:15:57+00:00
---
# check_point.mgmt.cp_mgmt_checkpoint_host_facts module – Get checkpoint-host objects facts on Checkpoint over Web Services API
...
>
> To use it in a playbook, specify: `check_point.mgmt.cp_mgmt_checkpoint_host_facts`.

New in check_point.mgmt 5.0.0

- [Synopsis](cp_mgmt_checkpoint_host_facts_module.md#synopsis)
- [Parameters](cp_mgmt_checkpoint_host_facts_module.md#parameters)
- [Examples](cp_mgmt_checkpoint_host_facts_module.md#examples)

## [Synopsis](cp_mgmt_checkpoint_host_facts_module.md#id1)
...
## [Parameters](cp_mgmt_checkpoint_host_facts_module.md#id2)
...
## [Examples](cp_mgmt_checkpoint_host_facts_module.md#id3)
