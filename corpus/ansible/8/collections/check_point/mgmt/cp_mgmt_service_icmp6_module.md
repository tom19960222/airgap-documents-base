...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_service_icmp6 module – Manages service-icmp6 objects on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_service_icmp6_module.html
fetched_at: 2026-07-28T01:17:15+00:00
---
# check_point.mgmt.cp_mgmt_service_icmp6 module – Manages service-icmp6 objects on Check Point over Web Services API
...
- [Synopsis](cp_mgmt_service_icmp6_module.md#synopsis)
- [Parameters](cp_mgmt_service_icmp6_module.md#parameters)
- [Examples](cp_mgmt_service_icmp6_module.md#examples)
- [Return Values](cp_mgmt_service_icmp6_module.md#return-values)

## [Synopsis](cp_mgmt_service_icmp6_module.md#id1)

- Manages service-icmp6 objects on Check Point devices including creating, updating and removing objects.
- All operations are performed over Web Services API.

## [Parameters](cp_mgmt_service_icmp6_module.md#id2)
...
## [Examples](cp_mgmt_service_icmp6_module.md#id3)
...
## [Return Values](cp_mgmt_service_icmp6_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_service_icmp6**  dictionary | The checkpoint object created or updated.  **Returned:** always, except when deleting the object. |
