...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_cluster_members_facts module – Retrieve all existing cluster members in domain."
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_cluster_members_facts_module.html
fetched_at: 2026-07-28T01:15:58+00:00
---
...
- [Synopsis](cp_mgmt_cluster_members_facts_module.md#synopsis)
- [Parameters](cp_mgmt_cluster_members_facts_module.md#parameters)
- [Examples](cp_mgmt_cluster_members_facts_module.md#examples)

## [Synopsis](cp_mgmt_cluster_members_facts_module.md#id1)

- Retrieve all existing cluster members in domain.
- All operations are performed over Web Services API.

## [Parameters](cp_mgmt_cluster_members_facts_module.md#id2)
...
| **limit_interfaces**  integer | Limit number of cluster member interfaces to show. |
...
## [Examples](cp_mgmt_cluster_members_facts_module.md#id3)
