...
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_access_layer_module.html
...
- [DEPRECATED](cp_mgmt_access_layer_module.md#deprecated)
...
- [Status](cp_mgmt_access_layer_module.md#status)

## [DEPRECATED](cp_mgmt_access_layer_module.md#id1)
...
## [Examples](cp_mgmt_access_layer_module.md#id4)
...
## [Return Values](cp_mgmt_access_layer_module.md#id5)
...
## [Status](cp_mgmt_access_layer_module.md#id6)

- This module will be removed in a major release after 2024-11-01.
  *[deprecated]*
- For more information see [DEPRECATED](cp_mgmt_access_layer_module.md#deprecated).
