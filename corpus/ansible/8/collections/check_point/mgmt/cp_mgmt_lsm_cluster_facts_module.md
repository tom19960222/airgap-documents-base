...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_lsm_cluster_facts module – Get lsm-cluster objects facts on Checkpoint over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_lsm_cluster_facts_module.html
fetched_at: 2026-07-28T01:16:41+00:00
---
# check_point.mgmt.cp_mgmt_lsm_cluster_facts module – Get lsm-cluster objects facts on Checkpoint over Web Services API
...
>
> To use it in a playbook, specify: `check_point.mgmt.cp_mgmt_lsm_cluster_facts`.

New in check_point.mgmt 2.3.0

- [Synopsis](cp_mgmt_lsm_cluster_facts_module.md#synopsis)
- [Parameters](cp_mgmt_lsm_cluster_facts_module.md#parameters)
- [Examples](cp_mgmt_lsm_cluster_facts_module.md#examples)

## [Synopsis](cp_mgmt_lsm_cluster_facts_module.md#id1)
...
## [Parameters](cp_mgmt_lsm_cluster_facts_module.md#id2)
...
## [Examples](cp_mgmt_lsm_cluster_facts_module.md#id3)
