...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_threat_layer module – Manages threat-layer objects on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_threat_layer_module.html
fetched_at: 2026-07-28T01:18:11+00:00
---
# check_point.mgmt.cp_mgmt_threat_layer module – Manages threat-layer objects on Check Point over Web Services API
...
- [DEPRECATED](cp_mgmt_threat_layer_module.md#deprecated)
- [Synopsis](cp_mgmt_threat_layer_module.md#synopsis)
- [Parameters](cp_mgmt_threat_layer_module.md#parameters)
- [Examples](cp_mgmt_threat_layer_module.md#examples)
- [Return Values](cp_mgmt_threat_layer_module.md#return-values)
- [Status](cp_mgmt_threat_layer_module.md#status)

## [DEPRECATED](cp_mgmt_threat_layer_module.md#id1)
...
## [Examples](cp_mgmt_threat_layer_module.md#id4)
...
## [Return Values](cp_mgmt_threat_layer_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_threat_layer**  dictionary | The checkpoint object created or updated.  **Returned:** always, except when deleting the object. |

## [Status](cp_mgmt_threat_layer_module.md#id6)

- This module will be removed in a major release after 2024-11-01.
  *[deprecated]*
- For more information see [DEPRECATED](cp_mgmt_threat_layer_module.md#deprecated).
