...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_service_group_facts module – Get service-group objects facts on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_service_group_facts_module.html
fetched_at: 2026-07-28T01:17:14+00:00
---
# check_point.mgmt.cp_mgmt_service_group_facts module – Get service-group objects facts on Check Point over Web Services API
...
- [Synopsis](cp_mgmt_service_group_facts_module.md#synopsis)
- [Parameters](cp_mgmt_service_group_facts_module.md#parameters)
- [Examples](cp_mgmt_service_group_facts_module.md#examples)

## [Synopsis](cp_mgmt_service_group_facts_module.md#id1)
...
## [Parameters](cp_mgmt_service_group_facts_module.md#id2)
...
| **show_as_ranges**  boolean | When true, the service group’s matched content is displayed as ranges of port numbers rather than service objects.<br />Objects that are not represented using port numbers are presented as objects.<br />The ‘members’ parameter is omitted from the response and instead the ‘ranges’ parameter is displayed.  **Choices:**   - `false` - `true` |
...
## [Examples](cp_mgmt_service_group_facts_module.md#id3)
