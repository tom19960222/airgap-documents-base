...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_time module – Manages time objects on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_time_module.html
fetched_at: 2026-07-28T01:18:18+00:00
---
...
- [Synopsis](cp_mgmt_time_module.md#synopsis)
- [Parameters](cp_mgmt_time_module.md#parameters)
- [Examples](cp_mgmt_time_module.md#examples)
- [Return Values](cp_mgmt_time_module.md#return-values)

## [Synopsis](cp_mgmt_time_module.md#id1)

- Manages time objects on Check Point devices including creating, updating and removing objects.
- All operations are performed over Web Services API.

## [Parameters](cp_mgmt_time_module.md#id2)
...
| **end_never**  boolean | End never.  **Choices:**   - `false` - `true` |
| **groups**  list / elements=string | Collection of group identifiers. |
| **hours_ranges**  list / elements=dictionary | Hours recurrence. Note, Each gateway may interpret this time differently according to its time zone. |
| **enabled**  boolean | Is hour range enabled.  **Choices:**   - `false` - `true` |
...
| **posix**  integer | Number of milliseconds that have elapsed since 00,00,00, 1 January 1970. |
| **time**  string | Time in format HH,mm. |
| **start_now**  boolean | Start immediately.  **Choices:**   - `false` - `true` |
...
## [Examples](cp_mgmt_time_module.md#id3)
...
## [Return Values](cp_mgmt_time_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_time**  dictionary | The checkpoint object created or updated.  **Returned:** always, except when deleting the object. |
