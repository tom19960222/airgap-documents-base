...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_application_site_category module – Manages application-site-category objects on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_application_site_category_module.html
fetched_at: 2026-07-28T01:15:49+00:00
---
# check_point.mgmt.cp_mgmt_application_site_category module – Manages application-site-category objects on Check Point over Web Services API
...
- [Synopsis](cp_mgmt_application_site_category_module.md#synopsis)
- [Parameters](cp_mgmt_application_site_category_module.md#parameters)
- [Examples](cp_mgmt_application_site_category_module.md#examples)
- [Return Values](cp_mgmt_application_site_category_module.md#return-values)

## [Synopsis](cp_mgmt_application_site_category_module.md#id1)
...
## [Parameters](cp_mgmt_application_site_category_module.md#id2)
...
## [Examples](cp_mgmt_application_site_category_module.md#id3)
...
## [Return Values](cp_mgmt_application_site_category_module.md#id4)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cp_mgmt_application_site_category**  dictionary | The checkpoint object created or updated.  **Returned:** always, except when deleting the object. |
