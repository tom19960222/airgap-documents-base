...
collection: ansible
version: "8"
title: "check_point.mgmt.cp_mgmt_network_facts module – Get network objects facts on Check Point over Web Services API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/check_point/mgmt/cp_mgmt_network_facts_module.html
fetched_at: 2026-07-28T01:16:53+00:00
---
# check_point.mgmt.cp_mgmt_network_facts module – Get network objects facts on Check Point over Web Services API
...
- [Synopsis](cp_mgmt_network_facts_module.md#synopsis)
- [Parameters](cp_mgmt_network_facts_module.md#parameters)
- [Examples](cp_mgmt_network_facts_module.md#examples)

## [Synopsis](cp_mgmt_network_facts_module.md#id1)
...
## [Parameters](cp_mgmt_network_facts_module.md#id2)
...
## [Examples](cp_mgmt_network_facts_module.md#id3)
