...
collection: ansible
version: "8"
title: "vyos.vyos.vyos_interfaces module – Interfaces resource module"
source_url: https://docs.ansible.com/projects/ansible/8/collections/vyos/vyos/vyos_interfaces_module.html
fetched_at: 2026-07-28T02:59:14+00:00
---
...
- [Synopsis](vyos_interfaces_module.md#synopsis)
- [Parameters](vyos_interfaces_module.md#parameters)
- [Notes](vyos_interfaces_module.md#notes)
- [Examples](vyos_interfaces_module.md#examples)
- [Return Values](vyos_interfaces_module.md#return-values)

## [Synopsis](vyos_interfaces_module.md#id1)
...
## [Parameters](vyos_interfaces_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **config**  list / elements=dictionary | The provided interfaces configuration. |
| **description**  string | Interface description. |
| **duplex**  string | Interface duplex mode.  Applicable for Ethernet interfaces only.  **Choices:**   - `"full"` - `"half"` - `"auto"` |
...
| **speed**  string | Interface link speed.  Applicable for Ethernet interfaces only.  **Choices:**   - `"auto"` - `"10"` - `"100"` - `"1000"` - `"2500"` - `"10000"` |
...
| **enabled**  boolean | Administrative state of the virtual sub-interface.  Set the value to `true` to administratively enable the interface or `false` to disable it.  **Choices:**   - `false` - `true` ← (default) |
...
## [Notes](vyos_interfaces_module.md#id3)
...
## [Examples](vyos_interfaces_module.md#id4)
...
## [Return Values](vyos_interfaces_module.md#id5)
...
| **commands**  list / elements=string | The set of commands pushed to the remote device.  **Returned:** always  **Sample:** `["set interfaces ethernet eth1 mtu 1200", "set interfaces ethernet eth2 vif 100 description VIF 100"]` |
