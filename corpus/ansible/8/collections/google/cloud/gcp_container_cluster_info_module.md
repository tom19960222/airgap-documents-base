...
collection: ansible
version: "8"
title: "google.cloud.gcp_container_cluster_info module – Gather info for GCP Cluster"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_container_cluster_info_module.html
fetched_at: 2026-07-28T02:33:05+00:00
---
...
> see [Requirements](gcp_container_cluster_info_module.md#ansible-collections-google-cloud-gcp-container-cluster-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_container_cluster_info`.

- [Synopsis](gcp_container_cluster_info_module.md#synopsis)
- [Requirements](gcp_container_cluster_info_module.md#requirements)
- [Parameters](gcp_container_cluster_info_module.md#parameters)
- [Notes](gcp_container_cluster_info_module.md#notes)
- [Examples](gcp_container_cluster_info_module.md#examples)
- [Return Values](gcp_container_cluster_info_module.md#return-values)

## [Synopsis](gcp_container_cluster_info_module.md#id1)

- Gather info for GCP Cluster

## [Requirements](gcp_container_cluster_info_module.md#id2)
...
## [Parameters](gcp_container_cluster_info_module.md#id3)
...
| **location**  aliases: region, zone  string / required | The location where the cluster is deployed. |
...
## [Notes](gcp_container_cluster_info_module.md#id4)
...
## [Examples](gcp_container_cluster_info_module.md#id5)
...
## [Return Values](gcp_container_cluster_info_module.md#id6)
