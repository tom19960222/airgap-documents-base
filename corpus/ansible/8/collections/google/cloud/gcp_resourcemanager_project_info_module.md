...
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_resourcemanager_project_info_module.html
...
| **page_size**  string | Indicates the number of projects that should be returned by the API request |
