...
collection: ansible
version: "8"
title: "google.cloud.gcp_dns_managed_zone module – Creates a GCP ManagedZone"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_dns_managed_zone_module.html
fetched_at: 2026-07-28T02:33:07+00:00
---
# google.cloud.gcp_dns_managed_zone module – Creates a GCP ManagedZone
...
> see [Requirements](gcp_dns_managed_zone_module.md#ansible-collections-google-cloud-gcp-dns-managed-zone-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_dns_managed_zone`.

- [Synopsis](gcp_dns_managed_zone_module.md#synopsis)
- [Requirements](gcp_dns_managed_zone_module.md#requirements)
- [Parameters](gcp_dns_managed_zone_module.md#parameters)
- [Notes](gcp_dns_managed_zone_module.md#notes)
- [Examples](gcp_dns_managed_zone_module.md#examples)
- [Return Values](gcp_dns_managed_zone_module.md#return-values)

## [Synopsis](gcp_dns_managed_zone_module.md#id1)

- A zone is a subtree of the DNS namespace under one administrative responsibility. A ManagedZone is a resource that represents a DNS zone hosted by the Cloud DNS service.

## [Requirements](gcp_dns_managed_zone_module.md#id2)
...
## [Parameters](gcp_dns_managed_zone_module.md#id3)
...
| **kind**  string | Identifies what kind of resource this is.  **Default:** `"dns#dnsKeySpec"` |
| **kind**  string | Identifies what kind of resource this is.  **Default:** `"dns#managedZoneDnsSecConfig"` |
...
| **network_url**  string / required | The fully qualified URL of the VPC network to forward queries to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects/%7Bproject%7D/global/networks/%7Bnetwork%7D%60> . |
...
| **network_url**  string / required | The fully qualified URL of the VPC network to bind to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects/%7Bproject%7D/global/networks/%7Bnetwork%7D%60> . |
...
| **visibility**  string | The zone’s visibility: public zones are exposed to the Internet, while private zones are visible only to Virtual Private Cloud resources.  Some valid choices include: “private”, “public”  **Default:** `"public"` |

## [Notes](gcp_dns_managed_zone_module.md#id4)
...
## [Examples](gcp_dns_managed_zone_module.md#id5)
...
## [Return Values](gcp_dns_managed_zone_module.md#id6)
...
| **networkUrl**  string | The fully qualified URL of the VPC network to forward queries to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects/%7Bproject%7D/global/networks/%7Bnetwork%7D%60> .  **Returned:** success |
...
| **networkUrl**  string | The fully qualified URL of the VPC network to bind to.  This should be formatted like `<https://www.googleapis.com/compute/v1/projects/%7Bproject%7D/global/networks/%7Bnetwork%7D%60> .  **Returned:** success |
