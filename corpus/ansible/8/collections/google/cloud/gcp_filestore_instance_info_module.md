...
collection: ansible
version: "8"
title: "google.cloud.gcp_filestore_instance_info module – Gather info for GCP Instance"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_filestore_instance_info_module.html
fetched_at: 2026-07-28T02:33:11+00:00
---
...
> see [Requirements](gcp_filestore_instance_info_module.md#ansible-collections-google-cloud-gcp-filestore-instance-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_filestore_instance_info`.

- [Synopsis](gcp_filestore_instance_info_module.md#synopsis)
- [Requirements](gcp_filestore_instance_info_module.md#requirements)
- [Parameters](gcp_filestore_instance_info_module.md#parameters)
- [Notes](gcp_filestore_instance_info_module.md#notes)
- [Examples](gcp_filestore_instance_info_module.md#examples)
- [Return Values](gcp_filestore_instance_info_module.md#return-values)

## [Synopsis](gcp_filestore_instance_info_module.md#id1)

- Gather info for GCP Instance

## [Requirements](gcp_filestore_instance_info_module.md#id2)
...
## [Parameters](gcp_filestore_instance_info_module.md#id3)
...
## [Notes](gcp_filestore_instance_info_module.md#id4)
...
## [Examples](gcp_filestore_instance_info_module.md#id5)
...
## [Return Values](gcp_filestore_instance_info_module.md#id6)
