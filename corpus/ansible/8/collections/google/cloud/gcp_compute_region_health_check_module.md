...
collection: ansible
version: "8"
title: "google.cloud.gcp_compute_region_health_check module – Creates a GCP RegionHealthCheck"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_region_health_check_module.html
fetched_at: 2026-07-28T02:32:30+00:00
---
...
> see [Requirements](gcp_compute_region_health_check_module.md#ansible-collections-google-cloud-gcp-compute-region-health-check-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_region_health_check`.

- [Synopsis](gcp_compute_region_health_check_module.md#synopsis)
- [Requirements](gcp_compute_region_health_check_module.md#requirements)
- [Parameters](gcp_compute_region_health_check_module.md#parameters)
- [Notes](gcp_compute_region_health_check_module.md#notes)
- [Examples](gcp_compute_region_health_check_module.md#examples)
- [Return Values](gcp_compute_region_health_check_module.md#return-values)

## [Synopsis](gcp_compute_region_health_check_module.md#id1)
...
## [Requirements](gcp_compute_region_health_check_module.md#id2)
...
## [Parameters](gcp_compute_region_health_check_module.md#id3)
...
| **response**  string | The bytes to match against the beginning of the response data. If left empty (the default value), any response will indicate health. The response data can only be ASCII. |
| **timeout_sec**  integer | How long (in seconds) to wait before claiming failure.  The default value is 5 seconds. It is invalid for timeoutSec to have greater value than checkIntervalSec.  **Default:** `5` |
...
## [Notes](gcp_compute_region_health_check_module.md#id4)
...
## [Examples](gcp_compute_region_health_check_module.md#id5)
...
## [Return Values](gcp_compute_region_health_check_module.md#id6)
...
| **region**  string | The region where the regional health check resides.  **Returned:** success |
...
| **port**  integer | The TCP port number for the TCP health check request.  The default value is 80.  **Returned:** success |
| **portName**  string | Port name as defined in InstanceGroup#NamedPort#name. If both port and port_name are defined, port takes precedence.  **Returned:** success |
