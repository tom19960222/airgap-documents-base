...
collection: ansible
version: "8"
title: "google.cloud.gcp_compute_instance_group_manager module – Creates a GCP InstanceGroupManager"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_instance_group_manager_module.html
fetched_at: 2026-07-28T02:32:14+00:00
---
# google.cloud.gcp_compute_instance_group_manager module – Creates a GCP InstanceGroupManager
...
> see [Requirements](gcp_compute_instance_group_manager_module.md#ansible-collections-google-cloud-gcp-compute-instance-group-manager-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_instance_group_manager`.

- [Synopsis](gcp_compute_instance_group_manager_module.md#synopsis)
- [Requirements](gcp_compute_instance_group_manager_module.md#requirements)
- [Parameters](gcp_compute_instance_group_manager_module.md#parameters)
- [Examples](gcp_compute_instance_group_manager_module.md#examples)
- [Return Values](gcp_compute_instance_group_manager_module.md#return-values)

## [Synopsis](gcp_compute_instance_group_manager_module.md#id1)
...
## [Requirements](gcp_compute_instance_group_manager_module.md#id2)
...
## [Parameters](gcp_compute_instance_group_manager_module.md#id3)
...
## [Examples](gcp_compute_instance_group_manager_module.md#id4)
...
## [Return Values](gcp_compute_instance_group_manager_module.md#id5)
