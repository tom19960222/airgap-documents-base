...
collection: ansible
version: "8"
title: "google.cloud.gcp_compute_firewall_info module – Gather info for GCP Firewall"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_firewall_info_module.html
fetched_at: 2026-07-28T02:32:01+00:00
---
# google.cloud.gcp_compute_firewall_info module – Gather info for GCP Firewall
...
> see [Requirements](gcp_compute_firewall_info_module.md#ansible-collections-google-cloud-gcp-compute-firewall-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_firewall_info`.

- [Synopsis](gcp_compute_firewall_info_module.md#synopsis)
- [Requirements](gcp_compute_firewall_info_module.md#requirements)
- [Parameters](gcp_compute_firewall_info_module.md#parameters)
- [Notes](gcp_compute_firewall_info_module.md#notes)
- [Examples](gcp_compute_firewall_info_module.md#examples)
- [Return Values](gcp_compute_firewall_info_module.md#return-values)

## [Synopsis](gcp_compute_firewall_info_module.md#id1)

- Gather info for GCP Firewall

## [Requirements](gcp_compute_firewall_info_module.md#id2)
...
## [Parameters](gcp_compute_firewall_info_module.md#id3)
...
## [Notes](gcp_compute_firewall_info_module.md#id4)
...
## [Examples](gcp_compute_firewall_info_module.md#id5)
...
## [Return Values](gcp_compute_firewall_info_module.md#id6)
