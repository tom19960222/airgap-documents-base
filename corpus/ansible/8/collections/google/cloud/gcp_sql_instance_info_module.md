...
collection: ansible
version: "8"
title: "google.cloud.gcp_sql_instance_info module – Gather info for GCP Instance"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_sql_instance_info_module.html
fetched_at: 2026-07-28T02:33:39+00:00
---
# google.cloud.gcp_sql_instance_info module – Gather info for GCP Instance
...
> see [Requirements](gcp_sql_instance_info_module.md#ansible-collections-google-cloud-gcp-sql-instance-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_sql_instance_info`.

- [Synopsis](gcp_sql_instance_info_module.md#synopsis)
- [Requirements](gcp_sql_instance_info_module.md#requirements)
- [Parameters](gcp_sql_instance_info_module.md#parameters)
- [Notes](gcp_sql_instance_info_module.md#notes)
- [Examples](gcp_sql_instance_info_module.md#examples)
- [Return Values](gcp_sql_instance_info_module.md#return-values)

## [Synopsis](gcp_sql_instance_info_module.md#id1)

- Gather info for GCP Instance

## [Requirements](gcp_sql_instance_info_module.md#id2)
...
## [Parameters](gcp_sql_instance_info_module.md#id3)
...
## [Notes](gcp_sql_instance_info_module.md#id4)
...
## [Examples](gcp_sql_instance_info_module.md#id5)
...
## [Return Values](gcp_sql_instance_info_module.md#id6)
...
| **privateNetwork**  string | The resource link for the VPC network from which the Cloud SQL instance is accessible for private IP (e.g /projects/myProject/global/networks/default)  **Returned:** success |
