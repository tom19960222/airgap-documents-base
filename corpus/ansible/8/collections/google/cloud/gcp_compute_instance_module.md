...
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_instance_module.html
fetched_at: 2026-07-28T02:32:12+00:00
---
...
| **confidential_instance_config**  dictionary | Configuration for confidential computing (requires setting the machine type to any of the n2d-\* types and a boot disk of type pd-ssd). |
| **enable_confidential_compute**  boolean | Enables confidential computing.  **Choices:**   - `false` - `true` |
...
| **machineType**  string | A reference to a machine type which defines VM kind. See <https://cloud.google.com/compute/docs/machine-types> for a list of current valid machine types.  **Returned:** success |
