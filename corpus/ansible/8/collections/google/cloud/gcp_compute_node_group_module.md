...
collection: ansible
version: "8"
title: "google.cloud.gcp_compute_node_group module – Creates a GCP NodeGroup"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_node_group_module.html
fetched_at: 2026-07-28T02:32:23+00:00
---
...
> see [Requirements](gcp_compute_node_group_module.md#ansible-collections-google-cloud-gcp-compute-node-group-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_node_group`.

- [Synopsis](gcp_compute_node_group_module.md#synopsis)
- [Requirements](gcp_compute_node_group_module.md#requirements)
- [Parameters](gcp_compute_node_group_module.md#parameters)
- [Notes](gcp_compute_node_group_module.md#notes)
- [Examples](gcp_compute_node_group_module.md#examples)
- [Return Values](gcp_compute_node_group_module.md#return-values)

## [Synopsis](gcp_compute_node_group_module.md#id1)

- Represents a NodeGroup resource to manage a group of sole-tenant nodes.

## [Requirements](gcp_compute_node_group_module.md#id2)
...
## [Parameters](gcp_compute_node_group_module.md#id3)
...
| **autoscaling_policy**  dictionary | If you use sole-tenant nodes for your workloads, you can use the node group autoscaler to automatically manage the sizes of your node groups. |
| **max_nodes**  integer / required | Maximum size of the node group. Set to a value less than or equal to 100 and greater than or equal to min-nodes. |
| **min_nodes**  integer | Minimum size of the node group. Must be less than or equal to max-nodes. The default value is 0. |
| **mode**  string / required | The autoscaling mode. Set to one of the following: - OFF: Disables the autoscaler.   - ON: Enables scaling in and scaling out. - ONLY_SCALE_OUT: Enables only scaling out.   You must use this mode if your node groups are configured to restart their hosted VMs on minimal servers.  Some valid choices include: “OFF”, “ON”, “ONLY_SCALE_OUT” |
| **description**  string | An optional textual description of the resource. |
| **env_type**  string | Specifies which Ansible environment you’re running this module within.  This should not be set unless you know what you’re doing.  This only alters the User Agent string for any API requests. |
| **maintenance_policy**  string | Specifies how to handle instances when a node in the group undergoes maintenance. Set to one of: DEFAULT, RESTART_IN_PLACE, or MIGRATE_WITHIN_NODE_GROUP. The default value is DEFAULT.  **Default:** `"DEFAULT"` |
| **maintenance_window**  dictionary | contains properties for the timeframe of maintenance . |
| **start_time**  string / required | instances.start time of the window. This must be in UTC format that resolves to one of 00:00, 04:00, 08:00, 12:00, 16:00, or 20:00. For example, both 13:00-5 and 08:00 are valid. |
...
## [Notes](gcp_compute_node_group_module.md#id4)
...
## [Examples](gcp_compute_node_group_module.md#id5)
...
## [Return Values](gcp_compute_node_group_module.md#id6)
...
| **maintenanceWindow**  complex | contains properties for the timeframe of maintenance .  **Returned:** success |
| **startTime**  string | instances.start time of the window. This must be in UTC format that resolves to one of 00:00, 04:00, 08:00, 12:00, 16:00, or 20:00. For example, both 13:00-5 and 08:00 are valid.  **Returned:** success |
