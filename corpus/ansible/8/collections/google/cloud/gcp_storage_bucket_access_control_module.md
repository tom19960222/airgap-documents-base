...
collection: ansible
version: "8"
title: "google.cloud.gcp_storage_bucket_access_control module – Creates a GCP BucketAccessControl"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_storage_bucket_access_control_module.html
fetched_at: 2026-07-28T02:33:43+00:00
---
...
> see [Requirements](gcp_storage_bucket_access_control_module.md#ansible-collections-google-cloud-gcp-storage-bucket-access-control-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_storage_bucket_access_control`.

- [Synopsis](gcp_storage_bucket_access_control_module.md#synopsis)
- [Requirements](gcp_storage_bucket_access_control_module.md#requirements)
- [Parameters](gcp_storage_bucket_access_control_module.md#parameters)
- [Notes](gcp_storage_bucket_access_control_module.md#notes)
- [Examples](gcp_storage_bucket_access_control_module.md#examples)
- [Return Values](gcp_storage_bucket_access_control_module.md#return-values)

## [Synopsis](gcp_storage_bucket_access_control_module.md#id1)
...
## [Requirements](gcp_storage_bucket_access_control_module.md#id2)
...
## [Parameters](gcp_storage_bucket_access_control_module.md#id3)
...
## [Notes](gcp_storage_bucket_access_control_module.md#id4)
...
## [Examples](gcp_storage_bucket_access_control_module.md#id5)
...
## [Return Values](gcp_storage_bucket_access_control_module.md#id6)
