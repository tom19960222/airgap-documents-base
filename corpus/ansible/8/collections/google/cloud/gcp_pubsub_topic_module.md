...
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_pubsub_topic_module.html
...
| **schema_settings**  dictionary | Settings for validating messages published against a schema. |
| **encoding**  string | The encoding of messages validated against schema.  Some valid choices include: “ENCODING_UNSPECIFIED”, “JSON”, “BINARY”  **Default:** `"ENCODING_UNSPECIFIED"` |
