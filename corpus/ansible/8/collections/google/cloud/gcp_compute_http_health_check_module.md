...
collection: ansible
version: "8"
title: "google.cloud.gcp_compute_http_health_check module – Creates a GCP HttpHealthCheck"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_compute_http_health_check_module.html
...
> see [Requirements](gcp_compute_http_health_check_module.md#ansible-collections-google-cloud-gcp-compute-http-health-check-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_compute_http_health_check`.

- [Synopsis](gcp_compute_http_health_check_module.md#synopsis)
- [Requirements](gcp_compute_http_health_check_module.md#requirements)
- [Parameters](gcp_compute_http_health_check_module.md#parameters)
- [Notes](gcp_compute_http_health_check_module.md#notes)
- [Examples](gcp_compute_http_health_check_module.md#examples)
- [Return Values](gcp_compute_http_health_check_module.md#return-values)

## [Synopsis](gcp_compute_http_health_check_module.md#id1)

- An HttpHealthCheck resource. This resource defines a template for how individual VMs should be checked for health, via HTTP.

## [Requirements](gcp_compute_http_health_check_module.md#id2)
...
## [Parameters](gcp_compute_http_health_check_module.md#id3)
...
| **check_interval_sec**  aliases: check_interval_seconds  integer | How often (in seconds) to send a health check. The default value is 5 seconds.  **Default:** `5` |
...
## [Notes](gcp_compute_http_health_check_module.md#id4)
...
## [Examples](gcp_compute_http_health_check_module.md#id5)
...
## [Return Values](gcp_compute_http_health_check_module.md#id6)
