...
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_redis_instance_module.html
fetched_at: 2026-07-28T02:33:25+00:00
---
...
| **transit_encryption_mode**  string | The TLS mode of the Redis instance, If not provided, TLS is disabled for the instance.   - SERVER_AUTHENTICATION: Client to Server traffic encryption enabled with server authentcation .   Some valid choices include: “SERVER_AUTHENTICATION”, “DISABLED”  **Default:** `"DISABLED"` |
