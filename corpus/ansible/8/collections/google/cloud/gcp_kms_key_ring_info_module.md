...
collection: ansible
version: "8"
title: "google.cloud.gcp_kms_key_ring_info module – Gather info for GCP KeyRing"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_kms_key_ring_info_module.html
fetched_at: 2026-07-28T02:33:17+00:00
---
# google.cloud.gcp_kms_key_ring_info module – Gather info for GCP KeyRing
...
> see [Requirements](gcp_kms_key_ring_info_module.md#ansible-collections-google-cloud-gcp-kms-key-ring-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_kms_key_ring_info`.

- [Synopsis](gcp_kms_key_ring_info_module.md#synopsis)
- [Requirements](gcp_kms_key_ring_info_module.md#requirements)
- [Parameters](gcp_kms_key_ring_info_module.md#parameters)
- [Notes](gcp_kms_key_ring_info_module.md#notes)
- [Examples](gcp_kms_key_ring_info_module.md#examples)
- [Return Values](gcp_kms_key_ring_info_module.md#return-values)

## [Synopsis](gcp_kms_key_ring_info_module.md#id1)

- Gather info for GCP KeyRing

## [Requirements](gcp_kms_key_ring_info_module.md#id2)
...
## [Parameters](gcp_kms_key_ring_info_module.md#id3)
...
## [Notes](gcp_kms_key_ring_info_module.md#id4)
...
## [Examples](gcp_kms_key_ring_info_module.md#id5)
...
## [Return Values](gcp_kms_key_ring_info_module.md#id6)
