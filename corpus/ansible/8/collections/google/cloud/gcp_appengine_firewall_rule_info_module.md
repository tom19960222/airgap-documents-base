...
collection: ansible
version: "8"
title: "google.cloud.gcp_appengine_firewall_rule_info module – Gather info for GCP FirewallRule"
source_url: https://docs.ansible.com/projects/ansible/8/collections/google/cloud/gcp_appengine_firewall_rule_info_module.html
fetched_at: 2026-07-28T02:31:40+00:00
---
...
> see [Requirements](gcp_appengine_firewall_rule_info_module.md#ansible-collections-google-cloud-gcp-appengine-firewall-rule-info-module-requirements) for details.
>
> To use it in a playbook, specify: `google.cloud.gcp_appengine_firewall_rule_info`.

- [Synopsis](gcp_appengine_firewall_rule_info_module.md#synopsis)
- [Requirements](gcp_appengine_firewall_rule_info_module.md#requirements)
- [Parameters](gcp_appengine_firewall_rule_info_module.md#parameters)
- [Notes](gcp_appengine_firewall_rule_info_module.md#notes)
- [Examples](gcp_appengine_firewall_rule_info_module.md#examples)
- [Return Values](gcp_appengine_firewall_rule_info_module.md#return-values)

## [Synopsis](gcp_appengine_firewall_rule_info_module.md#id1)

- Gather info for GCP FirewallRule

## [Requirements](gcp_appengine_firewall_rule_info_module.md#id2)
...
## [Parameters](gcp_appengine_firewall_rule_info_module.md#id3)
...
## [Notes](gcp_appengine_firewall_rule_info_module.md#id4)
...
## [Examples](gcp_appengine_firewall_rule_info_module.md#id5)
...
## [Return Values](gcp_appengine_firewall_rule_info_module.md#id6)
