...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cyberark/pas/cyberark_authentication_module.html
fetched_at: 2026-07-28T02:03:23+00:00
---
...
| **concurrentSession**  boolean | Whether or not to allow concurrent sessions for the same user.  **Choices:**   - `false` ← (default) - `true` |
...
| **timeout**  integer | Allows you set a timeout for when your authenticating to Cyberark  **Default:** `10` |
