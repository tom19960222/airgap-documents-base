...
collection: ansible
version: "8"
title: "f5networks.f5_modules.bigiq_application_fastl4_udp module – Manages BIG-IQ FastL4 UDP applications"
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigiq_application_fastl4_udp_module.html
fetched_at: 2026-07-28T02:07:37+00:00
---
# f5networks.f5_modules.bigiq_application_fastl4_udp module – Manages BIG-IQ FastL4 UDP applications
...
- [Synopsis](bigiq_application_fastl4_udp_module.md#synopsis)
- [Parameters](bigiq_application_fastl4_udp_module.md#parameters)
- [Notes](bigiq_application_fastl4_udp_module.md#notes)
- [Examples](bigiq_application_fastl4_udp_module.md#examples)
- [Return Values](bigiq_application_fastl4_udp_module.md#return-values)

## [Synopsis](bigiq_application_fastl4_udp_module.md#id1)

- Manages BIG-IQ applications used for load balancing a UDP-based application. with a FastL4 profile.

## [Parameters](bigiq_application_fastl4_udp_module.md#id2)
...
| **inbound_virtual**  dictionary | Settings to configure the virtual which receives the inbound connection. |
...
| **port**  integer | The port on which the virtual listens for connections.  When creating a new application, if this parameter is not specified, the default value is `53`.  **Default:** `53` |
...
## [Notes](bigiq_application_fastl4_udp_module.md#id3)
...
## [Examples](bigiq_application_fastl4_udp_module.md#id4)
...
## [Return Values](bigiq_application_fastl4_udp_module.md#id5)
