...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_device_certificate_module.html
fetched_at: 2026-07-28T02:05:50+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **add_to_trusted**  boolean | Specifies if the certificate should be added to the trusted client and server certificate files.  **Choices:**   - `false` ← (default) - `true` |
...
| **new_cert**  boolean | Specifies if the module should generate a new certificate.  When `true`, the device certificate and key will be replaced.  **Choices:**   - `false` ← (default) - `true` |
