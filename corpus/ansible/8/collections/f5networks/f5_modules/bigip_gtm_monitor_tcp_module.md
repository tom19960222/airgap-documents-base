...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_gtm_monitor_tcp_module.html
fetched_at: 2026-07-28T02:06:18+00:00
---
...
| **interval**  integer | The interval specifying how frequently the monitor instance of this template runs.  If this parameter is not provided when creating a new monitor, the default value is 30.  This value **must** be less than the `timeout` value. |
