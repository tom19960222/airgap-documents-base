...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_device_connectivity_module.html
...
| **multicast_port**  integer | Port for the system to send multicast messages associated with failover.  When `failover_multicast` is `true` and this option is not provided, a default of `62960` will be used. This value must be between 0 and 65535. |
