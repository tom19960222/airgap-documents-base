...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_asm_policy_import_module.html
...
| **force**  boolean | When set to `true`, any existing policy with the same name will be overwritten by the new import.  This works for both inline and file imports, if the policy does not exist this setting is ignored.  **Choices:**   - `false` ← (default) - `true` |
