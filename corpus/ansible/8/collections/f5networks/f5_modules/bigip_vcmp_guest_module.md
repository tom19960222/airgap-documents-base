...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_vcmp_guest_module.html
fetched_at: 2026-07-28T02:07:32+00:00
---
...
| **delete_virtual_disk**  boolean | When `state` is `absent`, the system additionally deletes the virtual disk associated with the vCMP guest. By default, this value is `false`.  **Choices:**   - `false` ← (default) - `true` |
