...
collection: ansible
version: "8"
title: "f5networks.f5_modules.bigip_gtm_monitor_http module – Manages F5 BIG-IP GTM HTTP monitors"
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_gtm_monitor_http_module.html
...
- [Synopsis](bigip_gtm_monitor_http_module.md#synopsis)
- [Parameters](bigip_gtm_monitor_http_module.md#parameters)
- [Notes](bigip_gtm_monitor_http_module.md#notes)
- [Examples](bigip_gtm_monitor_http_module.md#examples)
- [Return Values](bigip_gtm_monitor_http_module.md#return-values)

## [Synopsis](bigip_gtm_monitor_http_module.md#id1)

- Manages F5 BIG-IP GTM (now BIG-IP DNS) HTTP monitors.

## [Parameters](bigip_gtm_monitor_http_module.md#id2)
...
## [Notes](bigip_gtm_monitor_http_module.md#id3)
...
## [Examples](bigip_gtm_monitor_http_module.md#id4)
...
## [Return Values](bigip_gtm_monitor_http_module.md#id5)
