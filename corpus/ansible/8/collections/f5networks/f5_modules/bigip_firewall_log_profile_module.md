...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_firewall_log_profile_module.html
fetched_at: 2026-07-28T02:06:07+00:00
---
...
| **log_rtbh**  boolean | When `true`, specifies remotely triggered blackholing events are logged.  **Choices:**   - `false` - `true` |
| **log_shun**  boolean | When `true`, specifies IP Intelligence shun list events are logged.  This option can only be set on the `global-network` built-in profile.  **Choices:**   - `false` - `true` |
