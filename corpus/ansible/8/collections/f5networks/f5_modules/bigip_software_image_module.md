...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_software_image_module.html
fetched_at: 2026-07-28T02:07:19+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **force**  boolean | When `true`, uploads the file every time and replaces the file on the device.  When `false`, the file is only uploaded if it does not already exist.  Generally should be `true` only in cases where you have reason to believe the image was corrupted during upload.  **Choices:**   - `false` ← (default) - `true` |
