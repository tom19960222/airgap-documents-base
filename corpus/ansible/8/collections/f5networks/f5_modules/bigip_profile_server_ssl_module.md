...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_profile_server_ssl_module.html
fetched_at: 2026-07-28T02:07:05+00:00
---
...
| **sni_require**  boolean | Requires the network peers also provide SNI support. This setting only takes effect when `sni_default` is `true`.  When creating a new profile, the setting is provided by the parent profile.  **Choices:**   - `false` - `true` |
...
| **options**  list / elements=string | The list of options for SSL processing.  **Returned:** changed  **Sample:** `["no-ssl", "no-sslv3"]` |
