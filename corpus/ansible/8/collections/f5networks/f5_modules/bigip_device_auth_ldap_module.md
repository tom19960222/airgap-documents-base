...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_device_auth_ldap_module.html
...
| **referrals**  boolean  *added in f5networks.f5_modules 1.22.0* | Specifies whether automatic referral chasing should be enabled.  Option only available on `TMOS 15.1.0` and above.  **Choices:**   - `false` - `true` |
...
| **referrals**  boolean | Specifies whether automatic referral chasing should be enabled  **Returned:** changed  **Sample:** `true` |
