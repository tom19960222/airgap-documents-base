...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_gtm_virtual_server_module.html
...
| **bits_enabled**  boolean | Whether or not the bits limit is enabled.  This parameter allows you to switch on or off the effect of the limit.  **Choices:**   - `false` - `true` |
...
| **connections_enabled**  boolean | Whether or not the current connections limit is enabled.  This parameter allows you to switch on or off the effect of the limit.  **Choices:**   - `false` - `true` |
...
| **packets_enabled**  boolean | Whether or not the packets limit is enabled.  This parameter allows you to switch on or off the effect of the limit.  **Choices:**   - `false` - `true` |
