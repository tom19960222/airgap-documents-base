...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_remote_role_module.html
fetched_at: 2026-07-28T02:07:10+00:00
---
...
| **remote_access**  boolean | Enables or disables remote access for the specified group of remotely authenticated users.  When creating a new remote role, if this parameter is not specified, the default is `true`.  **Choices:**   - `false` - `true` |
