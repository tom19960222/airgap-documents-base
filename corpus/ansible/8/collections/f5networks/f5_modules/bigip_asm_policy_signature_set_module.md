...
collection: ansible
version: "8"
title: "f5networks.f5_modules.bigip_asm_policy_signature_set module – Manages Signature Sets on an ASM policy"
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_asm_policy_signature_set_module.html
fetched_at: 2026-07-28T02:05:41+00:00
---
# f5networks.f5_modules.bigip_asm_policy_signature_set module – Manages Signature Sets on an ASM policy
...
## [Notes](bigip_asm_policy_signature_set_module.md#id3)
...
## [Examples](bigip_asm_policy_signature_set_module.md#id4)
...
## [Return Values](bigip_asm_policy_signature_set_module.md#id5)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **alarm**  boolean | Specifies whether the security policy logs the request data in the Statistics screen.  **Returned:** changed  **Sample:** `true` |
| **block**  boolean | Determines how the system treats requests that match a signature included in the signature set.  **Returned:** changed  **Sample:** `false` |
| **learn**  boolean | Specifies if the policy learns all requests that match a signature that is included in the signature set.  **Returned:** changed  **Sample:** `true` |
| **name**  string | The name of the Signature Set added/removed on an ASM policy.  **Returned:** changed  **Sample:** `"Cisco Signatures"` |
