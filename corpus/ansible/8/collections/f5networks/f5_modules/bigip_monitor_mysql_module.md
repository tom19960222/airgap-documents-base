...
collection: ansible
version: "8"
title: "f5networks.f5_modules.bigip_monitor_mysql module – Manages BIG-IP MySQL monitors"
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_monitor_mysql_module.html
fetched_at: 2026-07-28T02:06:44+00:00
---
# f5networks.f5_modules.bigip_monitor_mysql module – Manages BIG-IP MySQL monitors
...
- [Synopsis](bigip_monitor_mysql_module.md#synopsis)
- [Parameters](bigip_monitor_mysql_module.md#parameters)
- [Notes](bigip_monitor_mysql_module.md#notes)
- [Examples](bigip_monitor_mysql_module.md#examples)
- [Return Values](bigip_monitor_mysql_module.md#return-values)

## [Synopsis](bigip_monitor_mysql_module.md#id1)

- Manages BIG-IP MySQL monitors.

## [Parameters](bigip_monitor_mysql_module.md#id2)
...
## [Notes](bigip_monitor_mysql_module.md#id3)
...
## [Examples](bigip_monitor_mysql_module.md#id4)
...
## [Return Values](bigip_monitor_mysql_module.md#id5)
...
| **database**  string | The name of the database the monitor tries to access.  **Returned:** changed  **Sample:** `"primary1"` |
...
| **parent**  string | The parent monitor.  **Returned:** changed  **Sample:** `"/Common/foo_mysql"` |
...
| **recv**  string | The text string the monitor looks for in the returned resource.  **Returned:** changed  **Sample:** `"OPEN"` |
