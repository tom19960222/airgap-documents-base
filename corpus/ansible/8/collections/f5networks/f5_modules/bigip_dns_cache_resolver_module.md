...
source_url: https://docs.ansible.com/projects/ansible/8/collections/f5networks/f5_modules/bigip_dns_cache_resolver_module.html
...
| Parameter | Comments |
| --- | --- |
| **answer_default_zones**  boolean | Specifies whether the system answers DNS queries for the default zones localhost, reverse 127.0.0.1 and ::1, and AS112.  When creating a new cache resolver, if this parameter is not specified, the default is `false`.  **Choices:**   - `false` - `true` |
