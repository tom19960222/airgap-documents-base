...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_iotdevice module – Manage Azure IoT hub device"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_iotdevice_module.html
fetched_at: 2026-07-28T01:13:31+00:00
---
...
> see [Requirements](azure_rm_iotdevice_module.md#ansible-collections-azure-azcollection-azure-rm-iotdevice-module-requirements) for details.
>
> To use it in a playbook, specify: `azure.azcollection.azure_rm_iotdevice`.

New in azure.azcollection 0.1.2

- [Synopsis](azure_rm_iotdevice_module.md#synopsis)
- [Requirements](azure_rm_iotdevice_module.md#requirements)
- [Parameters](azure_rm_iotdevice_module.md#parameters)
- [Notes](azure_rm_iotdevice_module.md#notes)
- [See Also](azure_rm_iotdevice_module.md#see-also)
- [Examples](azure_rm_iotdevice_module.md#examples)
- [Return Values](azure_rm_iotdevice_module.md#return-values)

## [Synopsis](azure_rm_iotdevice_module.md#id1)

- Create, delete an Azure IoT hub device.

## [Requirements](azure_rm_iotdevice_module.md#id2)
...
## [Parameters](azure_rm_iotdevice_module.md#id3)
...
| **edge_enabled**  boolean | Flag indicating edge enablement.  Not supported in IoT Hub with Basic tier.  **Choices:**   - `false` - `true` |
| **hub**  string / required | Name of IoT Hub. |
| **hub_policy_key**  string / required | Key of the *hub_policy_name*. |
| **hub_policy_name**  string / required | Policy name of the IoT Hub which will be used to query from IoT hub.  This policy should have ‘RegistryWrite, ServiceConnect, DeviceConnect’ accesses. You may get 401 error when you lack any of these. |
...
| **status**  boolean | Set device status upon creation.  **Choices:**   - `false` - `true` |
...
| **twin_tags**  dictionary | A section that the solution back end can read from and write to.  Tags are not visible to device apps.  The tag can be nested dictionary, ‘.’, ‘$’, ‘#’, ‘ ‘ is not allowed in the key.  List is not supported.  Not supported in IoT Hub with Basic tier. |
| **x509_certificate_path**  path  *added in azure.azcollection 1.14.0* | Path to the X509 certificate used to create the service principal in PEM format.  The certificate must be appended to the private key.  Use when authenticating with a Service Principal. |

## [Notes](azure_rm_iotdevice_module.md#id4)
...
## [See Also](azure_rm_iotdevice_module.md#id5)
...
## [Examples](azure_rm_iotdevice_module.md#id6)
