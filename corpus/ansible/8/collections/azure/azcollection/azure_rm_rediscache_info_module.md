...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_rediscache_info_module.html
...
| **redis_version**  string  *added in azure.azcollection 1.10.0* | The version of Redis.  **Returned:** always  **Sample:** `"6.0.14"` |
