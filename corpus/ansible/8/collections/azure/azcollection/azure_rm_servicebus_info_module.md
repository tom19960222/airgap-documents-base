...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_servicebus_info_module.html
fetched_at: 2026-07-28T01:14:44+00:00
---
...
| **type**  string / required | Type of the resource.  **Choices:**   - `"namespace"` - `"queue"` - `"topic"` - `"subscription"` |
