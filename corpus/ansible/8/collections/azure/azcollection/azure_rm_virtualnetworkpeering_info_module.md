...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_virtualnetworkpeering_info module – Get facts of Azure Virtual Network Peering"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_virtualnetworkpeering_info_module.html
...
> see [Requirements](azure_rm_virtualnetworkpeering_info_module.md#ansible-collections-azure-azcollection-azure-rm-virtualnetworkpeering-info-module-requirements) for details.
>
...
## [Synopsis](azure_rm_virtualnetworkpeering_info_module.md#id1)

- Get facts of Azure Virtual Network Peering.

## [Requirements](azure_rm_virtualnetworkpeering_info_module.md#id2)
...
## [Parameters](azure_rm_virtualnetworkpeering_info_module.md#id3)
...
| **virtual_network**  any / required | Name or resource ID of a virtual network. |
| **x509_certificate_path**  path  *added in azure.azcollection 1.14.0* | Path to the X509 certificate used to create the service principal in PEM format.  The certificate must be appended to the private key.  Use when authenticating with a Service Principal. |

## [Notes](azure_rm_virtualnetworkpeering_info_module.md#id4)
...
## [See Also](azure_rm_virtualnetworkpeering_info_module.md#id5)
...
## [Examples](azure_rm_virtualnetworkpeering_info_module.md#id6)
...
## [Return Values](azure_rm_virtualnetworkpeering_info_module.md#id7)
