...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_privatednsrecordset module – Create, delete and update Private DNS record sets and records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_privatednsrecordset_module.html
fetched_at: 2026-07-28T01:14:14+00:00
---
...
> see [Requirements](azure_rm_privatednsrecordset_module.md#ansible-collections-azure-azcollection-azure-rm-privatednsrecordset-module-requirements) for details.
>
> To use it in a playbook, specify: `azure.azcollection.azure_rm_privatednsrecordset`.

New in azure.azcollection 1.1.0

- [Synopsis](azure_rm_privatednsrecordset_module.md#synopsis)
- [Requirements](azure_rm_privatednsrecordset_module.md#requirements)
- [Parameters](azure_rm_privatednsrecordset_module.md#parameters)
- [Notes](azure_rm_privatednsrecordset_module.md#notes)
- [See Also](azure_rm_privatednsrecordset_module.md#see-also)
- [Examples](azure_rm_privatednsrecordset_module.md#examples)
- [Return Values](azure_rm_privatednsrecordset_module.md#return-values)

## [Synopsis](azure_rm_privatednsrecordset_module.md#id1)

- Creates, deletes, and updates Private DNS records sets and records within an existing Azure Private DNS Zone.

## [Requirements](azure_rm_privatednsrecordset_module.md#id2)
...
## [Parameters](azure_rm_privatednsrecordset_module.md#id3)
...
| **record_type**  string / required | The type of record set to create or delete.  **Choices:**   - `"A"` - `"AAAA"` - `"CNAME"` - `"MX"` - `"PTR"` - `"SOA"` - `"SRV"` - `"TXT"` |
...
## [Notes](azure_rm_privatednsrecordset_module.md#id4)
...
## [See Also](azure_rm_privatednsrecordset_module.md#id5)
...
## [Examples](azure_rm_privatednsrecordset_module.md#id6)
...
## [Return Values](azure_rm_privatednsrecordset_module.md#id7)
...
| **a_records**  list / elements=dictionary | A list of records in the record set.  **Returned:** always  **Sample:** `[{"ipv4_address": "192.0.2.2"}, {"ipv4_address": "192.0.2.4"}, {"ipv4_address": "192.0.2.8"}]` |
...
| **id**  string | The DNS record set ID.  **Returned:** always  **Sample:** `"/subscriptions/xxxx......xxx/resourceGroups/v-xisuRG/providers/Microsoft.Network/privateDnsZones/ b57dc95985712e4523282.com/A/www"` |
| **is_auto_registered**  boolean | Is the record set auto-registered in the Private DNS zone through a virtual network link.  **Returned:** always  **Sample:** `false` |
