...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_autoscale_module.html
fetched_at: 2026-07-28T01:12:27+00:00
---
...
| **notifications**  list / elements=dictionary | The collection of notifications. |
| **custom_emails**  list / elements=string | The custom e-mails list. This value can be null or empty, in which case this attribute will be ignored. |
| **send_to_subscription_administrator**  aliases: email_admin  boolean | A value indicating whether to send email to subscription administrator.  **Choices:**   - `false` ← (default) - `true` |
| **send_to_subscription_co_administrators**  aliases: email_co_admin  boolean | A value indicating whether to send email to subscription co-administrators.  **Choices:**   - `false` ← (default) - `true` |
| **webhooks**  list / elements=string | The list of webhook notifications service uri. |
| **password**  string | Active Directory user password. Use when authenticating with an Active Directory user rather than service principal. |
| **profile**  string | Security profile found in ~/.azure/credentials file. |
| **profiles**  list / elements=dictionary | The collection of automatic scaling profiles that specify different scaling parameters for different time periods.  A maximum of 20 profiles can be specified. |
...
| **recurrence_days**  list / elements=string | The days of repeating times at which this profile begins.  This element is not used if the FixedDate element is used. |
...
| **recurrence_hours**  list / elements=string | The hours of repeating times at which this profile begins.  This element is not used if the FixedDate element is used. |
| **recurrence_mins**  list / elements=string | The mins of repeating times at which this profile begins.  This element is not used if the FixedDate element is used. |
...
| **rules**  list / elements=dictionary | The collection of rules that provide the triggers and parameters for the scaling action.  A maximum of 10 rules can be specified. |
| **cooldown**  float | The amount of time (minutes) to wait since the last scaling action before this action occurs.  It must be between 1 ~ 10080. |
...
| **threshold**  float | The threshold of the metric that triggers the scale action.  **Default:** `70.0` |
...
| **time_grain**  float / required | The granularity(minutes) of metrics the rule monitors.  Must be one of the predefined values returned from metric definitions for the metric.  Must be between 1 ~ 720. |
| **time_window**  float / required | The range of time(minutes) in which instance data is collected.  This value must be greater than the delay in metric collection, which can vary from resource-to-resource.  Must be between 5 ~ 720. |
...
| **target**  any | The identifier of the resource to apply autoscale setting.  It could be the resource id string.  It also could be a dict contains the `name`, `subscription_id`, `namespace`, `types`, `resource_group` of the resource. |
