...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_backuppolicy_module.html
...
| **schedule_weekly_frequency**  integer | The amount of weeks between backups.  Backup every *schedule_weekly_frequency* week(s).  Azure will default behavior to running weekly if this is left blank.  Does not apply to Daily frequency. |
