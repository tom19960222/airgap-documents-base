...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_cdnendpoint_info_module.html
...
| **origins**  dictionary | The source of the content being delivered via CDN.  **Returned:** success  **Sample:** `{"host_name": "xxxxxxxx.blob.core.windows.net", "http_port": null, "https_port": null, "name": "xxxxxxxx-blob-core-windows-net"}` |
