...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_dnsrecordset_info module – Get DNS Record Set facts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_dnsrecordset_info_module.html
fetched_at: 2026-07-28T01:13:15+00:00
---
...
> see [Requirements](azure_rm_dnsrecordset_info_module.md#ansible-collections-azure-azcollection-azure-rm-dnsrecordset-info-module-requirements) for details.
>
...
## [Synopsis](azure_rm_dnsrecordset_info_module.md#id1)

- Get facts for a specific DNS Record Set in a Zone, or a specific type in all Zones or in one Zone etc.

## [Requirements](azure_rm_dnsrecordset_info_module.md#id2)
...
## [Parameters](azure_rm_dnsrecordset_info_module.md#id3)
...
## [Notes](azure_rm_dnsrecordset_info_module.md#id4)
...
## [See Also](azure_rm_dnsrecordset_info_module.md#id5)
...
## [Examples](azure_rm_dnsrecordset_info_module.md#id6)
...
## [Return Values](azure_rm_dnsrecordset_info_module.md#id7)
...
| **dnsrecordsets**  complex | List of record set dicts, which shares the same hierarchy as [azure.azcollection.azure_rm_dnsrecordset](azure_rm_dnsrecordset_module.md#ansible-collections-azure-azcollection-azure-rm-dnsrecordset-module) module’s parameter.  **Returned:** always |
...
| **records**  dictionary | List of records depending on the type of recordset.  **Returned:** success  **Sample:** `[{"ipv4Address": "10.4.5.7"}, {"ipv4Address": "2.4.5.8"}]` |
| **relative_name**  string | Name of the dns recordset.  **Returned:** success  **Sample:** `"servera"` |
| **time_to_live**  integer | Time to live of the record set in seconds.  **Returned:** success  **Sample:** `12900` |
