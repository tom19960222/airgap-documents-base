...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_functionapp module – Manage Azure Function Apps"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_functionapp_module.html
fetched_at: 2026-07-28T01:13:21+00:00
---
...
> see [Requirements](azure_rm_functionapp_module.md#ansible-collections-azure-azcollection-azure-rm-functionapp-module-requirements) for details.
>
> To use it in a playbook, specify: `azure.azcollection.azure_rm_functionapp`.

New in azure.azcollection 0.1.2

- [Synopsis](azure_rm_functionapp_module.md#synopsis)
- [Requirements](azure_rm_functionapp_module.md#requirements)
- [Parameters](azure_rm_functionapp_module.md#parameters)
- [Notes](azure_rm_functionapp_module.md#notes)
- [See Also](azure_rm_functionapp_module.md#see-also)
- [Examples](azure_rm_functionapp_module.md#examples)
- [Return Values](azure_rm_functionapp_module.md#return-values)

## [Synopsis](azure_rm_functionapp_module.md#id1)

- Create, update or delete an Azure Function App.

## [Requirements](azure_rm_functionapp_module.md#id2)
...
## [Parameters](azure_rm_functionapp_module.md#id3)
...
| **app_settings**  dictionary | Dictionary containing application settings. |
...
| **name**  string / required | Name of container. For example “imagename:tag”. |
...
| **plan**  any | App service plan.  It can be name of existing app service plan in same resource group as function app.  It can be resource id of existing app service plan.  Resource id. For example /subscriptions/<subs_id>/resourceGroups/<resource_group>/providers/Microsoft.Web/serverFarms/<plan_name>.  It can be a dict which contains `name`, `resource_group`.  `name`. Name of app service plan.  `resource_group`. Resource group name of app service plan. |
| **profile**  string | Security profile found in ~/.azure/credentials file. |
| **resource_group**  aliases: resource_group_name  string / required | Name of resource group. |
| **secret**  string | Azure client secret. Use when authenticating with a Service Principal. |
| **state**  string | Assert the state of the Function App. Use `present` to create or update a Function App and `absent` to delete.  **Choices:**   - `"absent"` - `"present"` ← (default) |
| **storage_account**  aliases: storage, storage_account_name  string | Name of the storage account to use.  Required when creating. |
...
## [Notes](azure_rm_functionapp_module.md#id4)
...
## [See Also](azure_rm_functionapp_module.md#id5)
...
## [Examples](azure_rm_functionapp_module.md#id6)
