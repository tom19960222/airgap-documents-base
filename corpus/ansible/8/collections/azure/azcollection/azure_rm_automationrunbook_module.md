...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_automationrunbook module – Mange automation runbook"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_automationrunbook_module.html
fetched_at: 2026-07-28T01:12:25+00:00
---
# azure.azcollection.azure_rm_automationrunbook module – Mange automation runbook
...
> see [Requirements](azure_rm_automationrunbook_module.md#ansible-collections-azure-azcollection-azure-rm-automationrunbook-module-requirements) for details.
>
> To use it in a playbook, specify: `azure.azcollection.azure_rm_automationrunbook`.

New in azure.azcollection 1.12.0

- [Synopsis](azure_rm_automationrunbook_module.md#synopsis)
- [Requirements](azure_rm_automationrunbook_module.md#requirements)
- [Parameters](azure_rm_automationrunbook_module.md#parameters)
- [Notes](azure_rm_automationrunbook_module.md#notes)
- [See Also](azure_rm_automationrunbook_module.md#see-also)
- [Examples](azure_rm_automationrunbook_module.md#examples)
- [Return Values](azure_rm_automationrunbook_module.md#return-values)

## [Synopsis](azure_rm_automationrunbook_module.md#id1)

- Create, update, delete or publish automation runbook.

## [Requirements](azure_rm_automationrunbook_module.md#id2)
...
## [Parameters](azure_rm_automationrunbook_module.md#id3)
...
| **log_activity_trace**  integer | Sets the option to log activity trace of the runbook. |
| **log_mode**  string | Parent argument. |
| **log_path**  string | Parent argument. |
| **log_progress**  boolean | Sets progress log option.  **Choices:**   - `false` - `true` |
| **log_verbose**  boolean | Sets verbose log option.  **Choices:**   - `false` - `true` |
| **name**  string / required | The name of the automation runbook. |
| **password**  string | Active Directory user password. Use when authenticating with an Active Directory user rather than service principal. |
| **profile**  string | Security profile found in ~/.azure/credentials file. |
| **publish**  boolean | Whether to publish the runbook.  **Choices:**   - `false` - `true` |
| **resource_group**  string / required | The name of the resource group. |
| **runbook_type**  string | Sets the type of the runbook.  **Choices:**   - `"Script"` - `"Graph"` - `"PowerShellWorkflow"` - `"PowerShell"` - `"GraphPowerShellWorkflow"` - `"GraphPowerShell"` |
...
## [Notes](azure_rm_automationrunbook_module.md#id4)
...
## [See Also](azure_rm_automationrunbook_module.md#id5)
...
## [Examples](azure_rm_automationrunbook_module.md#id6)
...
## [Return Values](azure_rm_automationrunbook_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **state**  complex | List of automation runbook dicts.  **Returned:** always |
