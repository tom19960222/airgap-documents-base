...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_storageaccount_info_module.html
fetched_at: 2026-07-28T01:14:56+00:00
---
...
| **show_georeplication_stats**  boolean | Show the Geo Replication Stats for each storage account.  Using this option on an account that does not support georeplication will cause a delay in getting results.  **Choices:**   - `false` - `true` |
...
| **georeplication_stats**  complex | Parameters related to the status of geo-replication.  This will be null on accounts that don’t support geo-replication.  **Returned:** always |
| **can_failover**  boolean | Property indicating if fail over is supported by the account.  **Returned:** success  **Sample:** `true` |
| **last_sync_time**  string | Writes to the primary before this time are guaranteed to be replicated to the secondary.  **Returned:** success  **Sample:** `"2023-04-10T21:22:15+00:00"` |
| **sync_status**  string | Property showing status of the secondary region.  Known values are “Live”, “Bootstrap”, and “Unavailable”.  **Returned:** success  **Sample:** `"Live"` |
