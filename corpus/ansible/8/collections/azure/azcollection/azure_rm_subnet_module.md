...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_subnet_module.html
fetched_at: 2026-07-28T01:14:59+00:00
---
...
| **delegations**  list / elements=dictionary | An array of delegations. |
| **actions**  list / elements=string | A list of actions.  **Default:** `[]` |
...
| **route_table**  any | The reference of the RouteTable resource.  Can be the name or resource ID of the route table.  Can be a dict containing the *name* and *resource_group* of the route table.  Without this configuration, the associated route table will be dissociate. If there is no associated route table, it has no impact. |
| **secret**  string | Azure client secret. Use when authenticating with a Service Principal. |
| **security_group**  aliases: security_group_name  any | Existing security group with which to associate the subnet.  It can be the security group name which is in the same resource group.  Can be the resource ID of the security group.  Can be a dict containing the *name* and *resource_group* of the security group. |
| **service_endpoints**  list / elements=dictionary | An array of service endpoints. |
