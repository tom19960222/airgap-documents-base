...
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_keyvault_module.html
fetched_at: 2026-07-28T01:13:37+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **access_policies**  list / elements=dictionary | An array of 0 to 16 identities that have access to the key vault.  All identities in the array must use the same tenant ID as the key vault’s tenant ID. |
| **application_id**  string | Application ID of the client making request on behalf of a principal. |
| **certificates**  list / elements=string | List of permissions to certificates.  **Choices:**   - `"get"` - `"list"` - `"delete"` - `"create"` - `"import"` - `"update"` - `"managecontacts"` - `"getissuers"` - `"listissuers"` - `"setissuers"` - `"deleteissuers"` - `"manageissuers"` - `"recover"` - `"purge"` - `"backup"` - `"restore"` |
| **keys**  list / elements=string | List of permissions to keys.  **Choices:**   - `"encrypt"` - `"decrypt"` - `"wrapkey"` - `"unwrapkey"` - `"sign"` - `"verify"` - `"get"` - `"list"` - `"create"` - `"update"` - `"import"` - `"delete"` - `"backup"` - `"restore"` - `"recover"` - `"purge"` |
...
| **secrets**  list / elements=string | List of permissions to secrets.  **Choices:**   - `"get"` - `"list"` - `"set"` - `"delete"` - `"backup"` - `"restore"` - `"recover"` - `"purge"` |
| **storage**  list / elements=string | List of permissions to storage accounts. |
