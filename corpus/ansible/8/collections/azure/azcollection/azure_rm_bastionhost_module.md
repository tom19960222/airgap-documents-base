...
collection: ansible
version: "8"
title: "azure.azcollection.azure_rm_bastionhost module – Managed bastion host resource"
source_url: https://docs.ansible.com/projects/ansible/8/collections/azure/azcollection/azure_rm_bastionhost_module.html
fetched_at: 2026-07-28T01:12:35+00:00
---
...
> see [Requirements](azure_rm_bastionhost_module.md#ansible-collections-azure-azcollection-azure-rm-bastionhost-module-requirements) for details.
>
> To use it in a playbook, specify: `azure.azcollection.azure_rm_bastionhost`.

New in azure.azcollection 1.13.0

- [Synopsis](azure_rm_bastionhost_module.md#synopsis)
- [Requirements](azure_rm_bastionhost_module.md#requirements)
- [Parameters](azure_rm_bastionhost_module.md#parameters)
- [Notes](azure_rm_bastionhost_module.md#notes)
- [See Also](azure_rm_bastionhost_module.md#see-also)
- [Examples](azure_rm_bastionhost_module.md#examples)
- [Return Values](azure_rm_bastionhost_module.md#return-values)

## [Synopsis](azure_rm_bastionhost_module.md#id1)

- Create, Update or Delete bastion host resource.

## [Requirements](azure_rm_bastionhost_module.md#id2)
...
## [Parameters](azure_rm_bastionhost_module.md#id3)
...
| **disable_copy_paste**  boolean | Enable or Disable Copy or Paste feature of the Bastion Host resource.  **Choices:**   - `false` - `true` |
| **enable_file_copy**  boolean | Enable or Disable File Copy feature of the Bastion Host resource.  **Choices:**   - `false` - `true` |
| **enable_ip_connect**  boolean | Enable or Disable IP Connect feature of the Bastion Host resource.  **Choices:**   - `false` - `true` |
| **enable_shareable_link**  boolean | Enable or Disable Shareable Link of the Bastion Host resource.  **Choices:**   - `false` - `true` |
| **enable_tunneling**  boolean | Enable or Disable Tunneling feature of the Bastion Host resource.  **Choices:**   - `false` - `true` |
| **ip_configurations**  list / elements=dictionary | An array of bastion host IP configurations. |
| **name**  string | The name of bastion host ip configuration. |
| **private_ip_allocation_method**  string | Private IP allocation method.  **Choices:**   - `"Static"` - `"Dynamic"` |
| **public_ip_address**  dictionary | Reference of the PublicIP resource. |
...
| **name**  string / required | The name of the bastion host. |
| **password**  string | Active Directory user password. Use when authenticating with an Active Directory user rather than service principal. |
| **profile**  string | Security profile found in ~/.azure/credentials file. |
| **resource_group**  string / required | The name of the resource group. |
| **scale_units**  integer | The scale units for the Bastion Host resource. |
| **secret**  string | Azure client secret. Use when authenticating with a Service Principal. |
| **sku**  dictionary | The sku of this Bastion Host. |
| **name**  string | The name of the SKU.  **Choices:**   - `"Standard"` - `"Basic"` |
...
## [Notes](azure_rm_bastionhost_module.md#id4)
...
## [See Also](azure_rm_bastionhost_module.md#id5)
...
## [Examples](azure_rm_bastionhost_module.md#id6)
...
## [Return Values](azure_rm_bastionhost_module.md#id7)
...
| **subnet**  string | The reference to the subnet resource.  **Returned:** always |
