...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_router_static module – Configure IPv4 static routing tables in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_router_static_module.html
fetched_at: 2026-07-28T02:26:57+00:00
---
...
> see [Requirements](fortios_router_static_module.md#ansible-collections-fortinet-fortios-fortios-router-static-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_router_static`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_router_static_module.md#synopsis)
- [Requirements](fortios_router_static_module.md#requirements)
- [Parameters](fortios_router_static_module.md#parameters)
- [Notes](fortios_router_static_module.md#notes)
- [Examples](fortios_router_static_module.md#examples)
- [Return Values](fortios_router_static_module.md#return-values)

## [Synopsis](fortios_router_static_module.md#id1)
...
## [Requirements](fortios_router_static_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_router_static_module.md#id3)
...
| **router_static**  dictionary | Configure IPv4 static routing tables. |
...
| **dynamic_gateway**  string | Enable use of dynamic gateway retrieved from a DHCP or PPP server.  **Choices:**   - `"enable"` - `"disable"` |
...
| **preferred_source**  string | Preferred source IP for this route. |
| **priority**  integer | Administrative priority (1 - 65535). |
| **sdwan**  string | Enable/disable egress through SD-WAN.  **Choices:**   - `"enable"` - `"disable"` |
...
## [Notes](fortios_router_static_module.md#id4)
...
## [Examples](fortios_router_static_module.md#id5)
...
## [Return Values](fortios_router_static_module.md#id6)
