...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_dnsfilter_profile_module.html
...
| **transparent_dns_database**  list / elements=dictionary | Transparent DNS database zones. |
| **name**  string / required | DNS database zone name. Source system.dns-database.name. |
