...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_user_domain_controller_module.html
fetched_at: 2026-07-28T02:29:52+00:00
---
...
| **change_detection**  string | Enable/disable detection of a configuration change in the Active Directory server.  **Choices:**   - `"enable"` - `"disable"` |
| **change_detection_period**  integer | Minutes to detect a configuration change in the Active Directory server (5 - 10080 minutes (7 days)). |
...
| **name**  string / required | LDAP server name. Source user.ldap.name. |
