...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_log_fortiguard_filter module – Filters for FortiCloud in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_log_fortiguard_filter_module.html
fetched_at: 2026-07-28T02:26:02+00:00
---
# fortinet.fortios.fortios_log_fortiguard_filter module – Filters for FortiCloud in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_log_fortiguard_filter_module.md#ansible-collections-fortinet-fortios-fortios-log-fortiguard-filter-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_log_fortiguard_filter`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_log_fortiguard_filter_module.md#synopsis)
- [Requirements](fortios_log_fortiguard_filter_module.md#requirements)
- [Parameters](fortios_log_fortiguard_filter_module.md#parameters)
- [Notes](fortios_log_fortiguard_filter_module.md#notes)
- [Examples](fortios_log_fortiguard_filter_module.md#examples)
- [Return Values](fortios_log_fortiguard_filter_module.md#return-values)

## [Synopsis](fortios_log_fortiguard_filter_module.md#id1)
...
## [Requirements](fortios_log_fortiguard_filter_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_log_fortiguard_filter_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  **Choices:**   - `false` ← (default) - `true` |
| **log_fortiguard_filter**  dictionary | Filters for FortiCloud. |
...
## [Notes](fortios_log_fortiguard_filter_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_log_fortiguard_filter_module.md#id5)
...
## [Return Values](fortios_log_fortiguard_filter_module.md#id6)
