...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_endpoint_control_fctems_override module – Configure FortiClient Enterprise Management Server (EMS) entries in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_endpoint_control_fctems_override_module.html
fetched_at: 2026-07-28T02:23:53+00:00
---
# fortinet.fortios.fortios_endpoint_control_fctems_override module – Configure FortiClient Enterprise Management Server (EMS) entries in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_endpoint_control_fctems_override_module.md#ansible-collections-fortinet-fortios-fortios-endpoint-control-fctems-override-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_endpoint_control_fctems_override`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_endpoint_control_fctems_override_module.md#synopsis)
- [Requirements](fortios_endpoint_control_fctems_override_module.md#requirements)
- [Parameters](fortios_endpoint_control_fctems_override_module.md#parameters)
- [Notes](fortios_endpoint_control_fctems_override_module.md#notes)
- [Examples](fortios_endpoint_control_fctems_override_module.md#examples)
- [Return Values](fortios_endpoint_control_fctems_override_module.md#return-values)

## [Synopsis](fortios_endpoint_control_fctems_override_module.md#id1)
...
## [Requirements](fortios_endpoint_control_fctems_override_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_endpoint_control_fctems_override_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  **Choices:**   - `false` ← (default) - `true` |
| **endpoint_control_fctems_override**  dictionary | Configure FortiClient Enterprise Management Server (EMS) entries. |
| **call_timeout**  integer | FortiClient EMS call timeout in seconds (1 - 180 seconds). |
| **capabilities**  list / elements=string | List of EMS capabilities.  **Choices:**   - `"fabric-auth"` - `"silent-approval"` - `"websocket"` - `"websocket-malware"` - `"push-ca-certs"` - `"common-tags-api"` - `"tenant-id"` - `"client-avatars"` - `"single-vdom-connector"` |
...
| **ems_id**  integer / required | EMS ID in order (1 - 7). see <a href=’#notes’>Notes</a>. |
...
| **trust_ca_cn**  string | Enable/disable trust of the EMS certificate issuer(CA) and common name(CN) for certificate auto-renewal.  **Choices:**   - `"enable"` - `"disable"` |
...
## [Notes](fortios_endpoint_control_fctems_override_module.md#id4)
...
## [Examples](fortios_endpoint_control_fctems_override_module.md#id5)
...
## [Return Values](fortios_endpoint_control_fctems_override_module.md#id6)
