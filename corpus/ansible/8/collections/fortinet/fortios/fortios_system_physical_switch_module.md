...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_system_physical_switch_module.html
...
| **name**  string / required | Physical port name. |
