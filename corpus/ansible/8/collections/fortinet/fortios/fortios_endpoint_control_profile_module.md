...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_endpoint_control_profile_module.html
...
| **id**  integer / required | Operating system entry ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | File ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Registry entry ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Application ID. see <a href=’#notes’>Notes</a>. |
...
| **profile_name**  string / required | Profile name. |
