...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_user_fsso_polling_module.html
...
| **id**  integer / required | Active Directory server ID. see <a href=’#notes’>Notes</a>. |
