...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_router_policy6_module.html
fetched_at: 2026-07-28T02:26:52+00:00
---
...
| **addr6**  string / required | IPv6 address prefix. |
...
| **name**  string / required | Address/group name. Source firewall.address6.name firewall.addrgrp6.name. |
| **end_port**  integer | End destination port number (1 - 65535). |
| **end_source_port**  integer | End source port number (1 - 65535). |
...
| **output_device**  string | Outgoing interface name. Source system.interface.name system.interface.name. |
...
| **start_source_port**  integer | Start source port number (1 - 65535). |
