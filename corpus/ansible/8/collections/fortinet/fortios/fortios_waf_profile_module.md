...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_waf_profile_module.html
fetched_at: 2026-07-28T02:30:33+00:00
---
...
| **id**  integer / required | Exception ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | HTTP method policy ID. see <a href=’#notes’>Notes</a>. |
| **pattern**  string | URL pattern. |
| **regex**  string | Enable/disable regular expression based pattern match.  **Choices:**   - `"enable"` - `"disable"` |
| **severity**  string | Severity.  **Choices:**   - `"high"` - `"medium"` - `"low"` |
| **status**  string | Status.  **Choices:**   - `"enable"` - `"disable"` |
...
| **id**  integer / required | Signature ID. see <a href=’#notes’>Notes</a>. Source waf.signature.id. |
| **disabled_sub_class**  list / elements=dictionary | Disabled signature subclasses. |
| **id**  integer / required | Signature subclass ID. see <a href=’#notes’>Notes</a>. Source waf.sub-class.id. |
| **main_class**  list / elements=dictionary | Main signature class. |
| **action**  string | Action.  **Choices:**   - `"allow"` - `"block"` - `"erase"` |
| **id**  integer / required | Main signature class ID. see <a href=’#notes’>Notes</a>. Source waf.main-class.id. |
| **log**  string | Enable/disable logging.  **Choices:**   - `"enable"` - `"disable"` |
| **severity**  string | Severity.  **Choices:**   - `"high"` - `"medium"` - `"low"` |
| **status**  string | Status.  **Choices:**   - `"enable"` - `"disable"` |
| **url_access**  list / elements=dictionary | URL access list. |
| **access_pattern**  list / elements=dictionary | URL access pattern. |
| **id**  integer / required | URL access pattern ID. see <a href=’#notes’>Notes</a>. |
...
| **address**  string | Host address. Source firewall.address.name firewall.addrgrp.name. |
| **id**  integer / required | URL access ID. see <a href=’#notes’>Notes</a>. |
| **log**  string | Enable/disable logging.  **Choices:**   - `"enable"` - `"disable"` |
| **severity**  string | Severity.  **Choices:**   - `"high"` - `"medium"` - `"low"` |
