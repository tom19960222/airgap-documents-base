...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_firewall_ssh_setting module – SSH proxy settings in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_firewall_ssh_setting_module.html
fetched_at: 2026-07-28T02:25:13+00:00
---
# fortinet.fortios.fortios_firewall_ssh_setting module – SSH proxy settings in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_firewall_ssh_setting_module.md#ansible-collections-fortinet-fortios-fortios-firewall-ssh-setting-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_firewall_ssh_setting`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_firewall_ssh_setting_module.md#synopsis)
- [Requirements](fortios_firewall_ssh_setting_module.md#requirements)
- [Parameters](fortios_firewall_ssh_setting_module.md#parameters)
- [Notes](fortios_firewall_ssh_setting_module.md#notes)
- [Examples](fortios_firewall_ssh_setting_module.md#examples)
- [Return Values](fortios_firewall_ssh_setting_module.md#return-values)

## [Synopsis](fortios_firewall_ssh_setting_module.md#id1)
...
## [Requirements](fortios_firewall_ssh_setting_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_firewall_ssh_setting_module.md#id3)
...
| **host_trusted_checking**  string | Enable/disable host trusted checking.  **Choices:**   - `"enable"` - `"disable"` |
...
## [Notes](fortios_firewall_ssh_setting_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_firewall_ssh_setting_module.md#id5)
...
## [Return Values](fortios_firewall_ssh_setting_module.md#id6)
