...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_web_proxy_explicit_module.html
fetched_at: 2026-07-28T02:30:42+00:00
---
...
| **http_connection_mode**  string | HTTP connection mode .  **Choices:**   - `"static"` - `"multiplex"` - `"serverpool"` |
...
| **secure_web_proxy**  string | Enable/disable/require the secure web proxy for HTTP and HTTPS session.  **Choices:**   - `"disable"` - `"enable"` - `"secure"` |
| **secure_web_proxy_cert**  list / elements=dictionary | Name of certificates for secure web proxy. |
