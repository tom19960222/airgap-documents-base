...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_vpn_certificate_ca module – CA certificate in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_vpn_certificate_ca_module.html
fetched_at: 2026-07-28T02:30:11+00:00
---
# fortinet.fortios.fortios_vpn_certificate_ca module – CA certificate in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_vpn_certificate_ca_module.md#ansible-collections-fortinet-fortios-fortios-vpn-certificate-ca-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_vpn_certificate_ca`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_vpn_certificate_ca_module.md#synopsis)
- [Requirements](fortios_vpn_certificate_ca_module.md#requirements)
- [Parameters](fortios_vpn_certificate_ca_module.md#parameters)
- [Notes](fortios_vpn_certificate_ca_module.md#notes)
- [Examples](fortios_vpn_certificate_ca_module.md#examples)
- [Return Values](fortios_vpn_certificate_ca_module.md#return-values)

## [Synopsis](fortios_vpn_certificate_ca_module.md#id1)
...
## [Requirements](fortios_vpn_certificate_ca_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_vpn_certificate_ca_module.md#id3)
...
| **vpn_certificate_ca**  dictionary | CA certificate. |
...
## [Notes](fortios_vpn_certificate_ca_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_vpn_certificate_ca_module.md#id5)
...
## [Return Values](fortios_vpn_certificate_ca_module.md#id6)
