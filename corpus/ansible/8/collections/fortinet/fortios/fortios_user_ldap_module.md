...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_user_ldap_module.html
fetched_at: 2026-07-28T02:29:57+00:00
---
...
| **account_key_upn_san**  string | Define SAN in certificate for user principle name matching.  **Choices:**   - `"othername"` - `"rfc822name"` - `"dnsname"` |
