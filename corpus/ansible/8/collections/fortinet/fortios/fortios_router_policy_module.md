...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_router_policy_module.html
fetched_at: 2026-07-28T02:26:51+00:00
---
...
| **id**  integer / required | Destination Internet Service ID. see <a href=’#notes’>Notes</a>. Source firewall.internet-service.id. |
| **output_device**  string | Outgoing interface name. Source system.interface.name. |
| **protocol**  integer | Protocol number (0 - 255). |
| **seq_num**  integer / required | Sequence number(1-65535). see <a href=’#notes’>Notes</a>. |
