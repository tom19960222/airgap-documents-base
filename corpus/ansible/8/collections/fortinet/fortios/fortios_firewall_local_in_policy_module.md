...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_firewall_local_in_policy module – Configure user defined IPv4 local-in policies in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_firewall_local_in_policy_module.html
fetched_at: 2026-07-28T02:24:47+00:00
---
...
> see [Requirements](fortios_firewall_local_in_policy_module.md#ansible-collections-fortinet-fortios-fortios-firewall-local-in-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_firewall_local_in_policy`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_firewall_local_in_policy_module.md#synopsis)
- [Requirements](fortios_firewall_local_in_policy_module.md#requirements)
- [Parameters](fortios_firewall_local_in_policy_module.md#parameters)
- [Notes](fortios_firewall_local_in_policy_module.md#notes)
- [Examples](fortios_firewall_local_in_policy_module.md#examples)
- [Return Values](fortios_firewall_local_in_policy_module.md#return-values)

## [Synopsis](fortios_firewall_local_in_policy_module.md#id1)
...
## [Requirements](fortios_firewall_local_in_policy_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_firewall_local_in_policy_module.md#id3)
...
| **ha_mgmt_intf_only**  string | Enable/disable dedicating the HA management interface only for local-in policy.  **Choices:**   - `"enable"` - `"disable"` |
| **intf**  string | Incoming interface name from available options. Source system.zone.name system.interface.name. |
| **policyid**  integer / required | User defined local in policy ID. see <a href=’#notes’>Notes</a>. |
...
| **virtual_patch**  string | Enable/disable virtual patching.  **Choices:**   - `"enable"` - `"disable"` |
...
## [Notes](fortios_firewall_local_in_policy_module.md#id4)
...
## [Examples](fortios_firewall_local_in_policy_module.md#id5)
...
## [Return Values](fortios_firewall_local_in_policy_module.md#id6)
