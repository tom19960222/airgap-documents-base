...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_firewall_policy_module.html
fetched_at: 2026-07-28T02:24:53+00:00
---
...
| **name**  string / required | Address name. Source firewall.address6.name firewall.vipgrp6.name firewall.vip6.name system.external-resource.name firewall .addrgrp6.name. |
...
| **name**  string / required | Custom Internet Service6 group name. Source firewall.internet-service-custom-group.name. |
...
| **name**  string / required | IPv6 Internet Service name. Source firewall.internet-service-name.name. |
...
| **name**  string / required | Dynamic Network Service name. Source firewall.network-service-dynamic.name. |
...
| **user_agent_string**  string / required | User agent string. |
...
| **pcp_inbound**  string | Enable/disable PCP inbound DNAT.  **Choices:**   - `"enable"` - `"disable"` |
| **pcp_outbound**  string | Enable/disable PCP outbound SNAT.  **Choices:**   - `"enable"` - `"disable"` |
| **pcp_poolname**  list / elements=dictionary | PCP pool names. |
| **name**  string / required | PCP pool name. Source system.pcp-server.pools.name. |
...
| **reputation_minimum6**  integer | IPv6 Minimum Reputation to take action. Source firewall.internet-service-reputation.id. |
...
| **name**  string / required | Address name. Source firewall.internet-service-custom-group.name firewall.addrgrp.name. |
...
| **id**  integer / required | Security group tag (1 - 65535). see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Vendor MAC ID. see <a href=’#notes’>Notes</a>. Source firewall.vendor-mac.id. |
...
| **name**  string / required | Address name. Source firewall.address6.name system.external-resource.name firewall.addrgrp6.name. |
...
| **name**  string / required | Names of individual users that can authenticate with this policy. Source user.local.name user.certificate.name. |
...
| **ztna_device_ownership**  string | Enable/disable zero trust device ownership.  **Choices:**   - `"enable"` - `"disable"` |
...
| **ztna_ems_tag_secondary**  list / elements=dictionary | Source ztna-ems-tag-secondary names. |
| **name**  string / required | Address name. Source firewall.address.name firewall.addrgrp.name. |
| **ztna_geo_tag**  list / elements=dictionary | Source ztna-geo-tag names. |
| **name**  string / required | Address name. Source firewall.address.name firewall.addrgrp.name. |
| **ztna_policy_redirect**  string | Redirect ZTNA traffic to matching Access-Proxy proxy-policy.  **Choices:**   - `"enable"` - `"disable"` |
