...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_user_nac_policy_module.html
fetched_at: 2026-07-28T02:29:58+00:00
---
...
| **severity**  list / elements=dictionary | NAC policy matching devices vulnerability severity lists. |
| **severity_num**  integer / required | Enter multiple severity levels, where 0 = Info, 1 = Low, …, 4 = Critical see <a href=’#notes’>Notes</a>. |
...
| **name**  string / required | Managed FortiSwitch group name from available options. Source switch-controller.switch-group.name. |
...
| **switch_id**  string / required | Managed FortiSwitch name from available options. Source switch-controller.managed-switch.switch-id. |
