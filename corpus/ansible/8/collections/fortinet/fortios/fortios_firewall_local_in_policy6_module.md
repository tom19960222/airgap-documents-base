...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_firewall_local_in_policy6_module.html
...
| **virtual_patch**  string | Enable/disable the virtual patching feature.  **Choices:**   - `"enable"` - `"disable"` |
