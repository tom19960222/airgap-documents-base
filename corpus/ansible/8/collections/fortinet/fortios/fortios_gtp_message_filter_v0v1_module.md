...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_gtp_message_filter_v0v1_module.html
...
| **ue_registration_query**  string | UE Registration Query (req 61, resp ack 62).  **Choices:**   - `"allow"` - `"deny"` |
