...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_log_fortianalyzer2_override_setting module – Override FortiAnalyzer settings in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_log_fortianalyzer2_override_setting_module.html
fetched_at: 2026-07-28T02:25:51+00:00
---
# fortinet.fortios.fortios_log_fortianalyzer2_override_setting module – Override FortiAnalyzer settings in Fortinet’s FortiOS and FortiGate.
...
> see [Requirements](fortios_log_fortianalyzer2_override_setting_module.md#ansible-collections-fortinet-fortios-fortios-log-fortianalyzer2-override-setting-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_log_fortianalyzer2_override_setting`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_log_fortianalyzer2_override_setting_module.md#synopsis)
- [Requirements](fortios_log_fortianalyzer2_override_setting_module.md#requirements)
- [Parameters](fortios_log_fortianalyzer2_override_setting_module.md#parameters)
- [Notes](fortios_log_fortianalyzer2_override_setting_module.md#notes)
- [Examples](fortios_log_fortianalyzer2_override_setting_module.md#examples)
- [Return Values](fortios_log_fortianalyzer2_override_setting_module.md#return-values)

## [Synopsis](fortios_log_fortianalyzer2_override_setting_module.md#id1)
...
## [Requirements](fortios_log_fortianalyzer2_override_setting_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_log_fortianalyzer2_override_setting_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Token-based authentication. Generated from GUI of Fortigate. |
| **enable_log**  boolean | Enable/Disable logging for task.  **Choices:**   - `false` ← (default) - `true` |
| **log_fortianalyzer2_override_setting**  dictionary | Override FortiAnalyzer settings. |
...
| **alt_server**  string | Alternate FortiAnalyzer. |
...
| **fallback_to_primary**  string | Enable/disable this FortiGate unit to fallback to the primary FortiAnalyzer when it is available.  **Choices:**   - `"enable"` - `"disable"` |
...
| **override**  string | Enable/disable overriding FortiAnalyzer settings or use global settings.  **Choices:**   - `"enable"` - `"disable"` |
...
| **use_management_vdom**  string | Enable/disable use of management VDOM IP address as source IP for logs sent to FortiAnalyzer.  **Choices:**   - `"enable"` - `"disable"` |
| **member_path**  string | Member attribute path to operate on.  Delimited by a slash character if there are more than one attribute.  Parameter marked with member_path is legitimate for doing member operation. |
| **member_state**  string | Add or delete a member under specified attribute path.  When member_state is specified, the state option is ignored.  **Choices:**   - `"present"` - `"absent"` |
| **vdom**  string | Virtual domain, among those defined previously. A vdom is a virtual instance of the FortiGate that can be configured and used as a different unit.  **Default:** `"root"` |

## [Notes](fortios_log_fortianalyzer2_override_setting_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_log_fortianalyzer2_override_setting_module.md#id5)
...
## [Return Values](fortios_log_fortianalyzer2_override_setting_module.md#id6)
