...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_report_style module – Report style configuration in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_report_style_module.html
...
> see [Requirements](fortios_report_style_module.md#ansible-collections-fortinet-fortios-fortios-report-style-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_report_style`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_report_style_module.md#synopsis)
- [Requirements](fortios_report_style_module.md#requirements)
- [Parameters](fortios_report_style_module.md#parameters)
- [Notes](fortios_report_style_module.md#notes)
- [Examples](fortios_report_style_module.md#examples)
- [Return Values](fortios_report_style_module.md#return-values)

## [Synopsis](fortios_report_style_module.md#id1)
...
## [Requirements](fortios_report_style_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_report_style_module.md#id3)
...
| **align**  string | Alignment.  **Choices:**   - `"left"` - `"center"` - `"right"` - `"justify"` |
...
| **column_span**  string | Column span.  **Choices:**   - `"none"` - `"all"` |
| **fg_color**  string | Foreground color. |
| **font_family**  string | Font family.  **Choices:**   - `"Verdana"` - `"Arial"` - `"Helvetica"` - `"Courier"` - `"Times"` |
| **font_size**  string | Font size. |
| **font_style**  string | Font style.  **Choices:**   - `"normal"` - `"italic"` |
| **font_weight**  string | Font weight.  **Choices:**   - `"normal"` - `"bold"` |
...
| **options**  list / elements=string | Report style options.  **Choices:**   - `"font"` - `"text"` - `"color"` - `"align"` - `"size"` - `"margin"` - `"border"` - `"padding"` - `"column"` |
...
## [Notes](fortios_report_style_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_report_style_module.md#id5)
...
## [Return Values](fortios_report_style_module.md#id6)
