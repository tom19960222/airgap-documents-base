...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_system_accprofile_module.html
...
| **casb**  string | Inline CASB filter profile and settings  **Choices:**   - `"none"` - `"read"` - `"read-write"` |
| **data_leak_prevention**  string | DLP profiles and settings.  **Choices:**   - `"none"` - `"read"` - `"read-write"` |
...
| **virtual_patch**  string | Virtual patch profiles and settings.  **Choices:**   - `"none"` - `"read"` - `"read-write"` |
