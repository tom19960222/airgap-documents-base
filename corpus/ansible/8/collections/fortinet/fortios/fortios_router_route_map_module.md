...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_router_route_map_module.html
...
| **match_extcommunity**  string | Match BGP extended community list. Source router.extcommunity-list.name. |
| **match_extcommunity_exact**  string | Enable/disable exact matching of extended communities.  **Choices:**   - `"enable"` - `"disable"` |
...
| **as**  string / required | AS number (0 - 4294967295). Use quotes for repeating numbers, For example, “1 1 2”. |
...
| **community**  string / required | Community (format = AA:NN). |
...
| **set_ip_prefsrc**  string | IP address of preferred source. |
...
| **set_vpnv4_nexthop**  string | IP address of VPNv4 next-hop. |
