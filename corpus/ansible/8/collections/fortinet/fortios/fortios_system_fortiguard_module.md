...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_system_fortiguard_module.html
...
| **antispam_cache_mpermille**  integer | Maximum permille of FortiGate memory the antispam cache is allowed to use (1 - 150). |
...
| **auto_firmware_upgrade_day**  list / elements=string | Allowed day(s) of the week to install an automatic patch-level firmware upgrade from FortiGuard . Disallow any day of the week to use auto-firmware-upgrade-delay instead, which waits for designated days before installing an automatic patch-level firmware upgrade.  **Choices:**   - `"sunday"` - `"monday"` - `"tuesday"` - `"wednesday"` - `"thursday"` - `"friday"` - `"saturday"` |
| **auto_firmware_upgrade_delay**  integer | Delay of day(s) before installing an automatic patch-level firmware upgrade from FortiGuard of the week for installing an automatic patch-level firmware upgrade. |
...
| **FDS_license_expiring_days**  integer | Threshold for number of days before FortiGuard license expiration to generate license expiring event log (1 - 100 days). |
...
| **outbreak_prevention_cache_mpermille**  integer | Maximum permille of memory FortiGuard Virus Outbreak Prevention cache can use (1 - 150 permille). |
...
| **proxy_server_ip**  string | Hostname or IPv4 address of the proxy server. |
...
| **update_dldb**  string | Enable/disable DLP signature update.  **Choices:**   - `"enable"` - `"disable"` |
