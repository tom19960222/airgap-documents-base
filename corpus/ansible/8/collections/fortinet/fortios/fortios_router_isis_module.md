...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_router_isis_module.html
...
| **id**  integer / required | ISIS network ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Prefix entry ID. see <a href=’#notes’>Notes</a>. |
| **level**  string | Level.  **Choices:**   - `"level-1-2"` - `"level-1"` - `"level-2"` |
