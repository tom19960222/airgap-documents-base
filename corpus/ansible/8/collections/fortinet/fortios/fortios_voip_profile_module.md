...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_voip_profile_module.html
fetched_at: 2026-07-28T02:30:10+00:00
---
...
| **feature_set**  string | IPS or voipd (SIP-ALG) inspection feature set.  **Choices:**   - `"ips"` - `"voipd"` - `"flow"` - `"proxy"` |
...
| **call_id_regex**  string | Validate PCRE regular expression for Call-Id header value. |
...
| **content_type_regex**  string | Validate PCRE regular expression for Content-Type header value. |
