...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_vpn_ssl_web_portal_module.html
fetched_at: 2026-07-28T02:30:29+00:00
---
...
| **client_src_range**  string | Allow client to add source range for the tunnel traffic.  **Choices:**   - `"enable"` - `"disable"` |
...
| **default_protocol**  string | Application type that is set by default.  **Choices:**   - `"web"` - `"ftp"` - `"telnet"` - `"smb"` - `"vnc"` - `"rdp"` - `"ssh"` - `"sftp"` |
...
| **focus_bookmark**  string | Enable to prioritize the placement of the bookmark section over the quick-connection section in the SSL-VPN application.  **Choices:**   - `"enable"` - `"disable"` |
...
| **ip_mode**  string | Method by which users of this SSL-VPN tunnel obtain IP addresses.  **Choices:**   - `"range"` - `"user-group"` - `"dhcp"` - `"no-ip"` |
...
| **landing_page**  dictionary | Landing page options. |
| **form_data**  list / elements=dictionary | Form data. |
| **name**  string / required | Name. |
| **value**  string | Value. |
| **logout_url**  string | Landing page log out URL. |
| **sso**  string | Single sign-on.  **Choices:**   - `"disable"` - `"static"` - `"auto"` |
| **sso_credential**  string | Single sign-on credentials.  **Choices:**   - `"sslvpn-login"` - `"alternative"` |
| **sso_password**  string | SSO password. |
| **sso_username**  string | SSO user name. |
| **url**  string | Landing page URL. |
| **landing_page_mode**  string | Enable/disable SSL-VPN landing page mode.  **Choices:**   - `"enable"` - `"disable"` |
...
| **theme**  string | Web portal color scheme.  **Choices:**   - `"jade"` - `"neutrino"` - `"mariner"` - `"graphite"` - `"melongene"` - `"jet-stream"` - `"security-fabric"` - `"dark-matter"` - `"onyx"` - `"eclipse"` - `"blue"` - `"green"` - `"red"` |
