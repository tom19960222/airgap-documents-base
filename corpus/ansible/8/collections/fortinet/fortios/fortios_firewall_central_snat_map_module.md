...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_firewall_central_snat_map_module.html
...
| **dst_port**  string | Destination port or port range (1 to 65535, 0 means any port). |
