...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_system_sso_admin_module.html
...
| **id**  integer / required | Dashboard ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | FortiView Filter ID. see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Widget ID. see <a href=’#notes’>Notes</a>. |
