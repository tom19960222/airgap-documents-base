...
collection: ansible
version: "8"
title: "fortinet.fortios.fortios_vpn_certificate_local module – Local keys and certificates in Fortinet’s FortiOS and FortiGate."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_vpn_certificate_local_module.html
fetched_at: 2026-07-28T02:30:12+00:00
---
...
> see [Requirements](fortios_vpn_certificate_local_module.md#ansible-collections-fortinet-fortios-fortios-vpn-certificate-local-module-requirements) for details.
>
> To use it in a playbook, specify: `fortinet.fortios.fortios_vpn_certificate_local`.

New in fortinet.fortios 2.0.0

- [Synopsis](fortios_vpn_certificate_local_module.md#synopsis)
- [Requirements](fortios_vpn_certificate_local_module.md#requirements)
- [Parameters](fortios_vpn_certificate_local_module.md#parameters)
- [Notes](fortios_vpn_certificate_local_module.md#notes)
- [Examples](fortios_vpn_certificate_local_module.md#examples)
- [Return Values](fortios_vpn_certificate_local_module.md#return-values)

## [Synopsis](fortios_vpn_certificate_local_module.md#id1)
...
## [Requirements](fortios_vpn_certificate_local_module.md#id2)

The below requirements are needed on the host that executes this module.

- ansible>=2.14

## [Parameters](fortios_vpn_certificate_local_module.md#id3)
...
| **vpn_certificate_local**  dictionary | Local keys and certificates. |
...
| **cmp_server_cert**  string | CMP server certificate. Source vpn.certificate.ca.name vpn.certificate.remote.name. |
...
| **est_client_cert**  string | Certificate used to authenticate this FortiGate to EST server. Source vpn.certificate.local.name. |
...
| **est_server_cert**  string | EST server”s certificate must be verifiable by this certificate to be authenticated. Source vpn.certificate.ca.name vpn.certificate .remote.name. |
...
## [Notes](fortios_vpn_certificate_local_module.md#id4)

> **Note:**
>
> - Legacy fortiosapi has been deprecated, httpapi is the preferred way to run playbooks

## [Examples](fortios_vpn_certificate_local_module.md#id5)
...
## [Return Values](fortios_vpn_certificate_local_module.md#id6)
