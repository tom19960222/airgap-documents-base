...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_extension_controller_extender_profile_module.html
...
| **name**  string / required | Dataplan name. Source extension-controller.dataplan.name. |
