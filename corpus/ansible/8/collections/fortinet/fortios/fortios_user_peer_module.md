...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_user_peer_module.html
fetched_at: 2026-07-28T02:30:00+00:00
---
...
| **mfa_mode**  string | MFA mode for remote peer authentication/authorization.  **Choices:**   - `"none"` - `"password"` - `"subject-identity"` |
| **mfa_password**  string | Unified password for remote authentication. This field may be left empty when RADIUS authentication is used, in which case the FortiGate will use the RADIUS username as a password. |
| **mfa_server**  string | Name of a remote authenticator. Performs client access right check. Source user.ldap.name user.radius.name. |
| **mfa_username**  string | Unified username for remote authentication. |
