...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_web_proxy_profile_module.html
...
| **action**  string | Configure adding, removing, or logging of the HTTP header entry in HTTP requests and responses.  **Choices:**   - `"add-to-request"` - `"add-to-response"` - `"remove-from-request"` - `"remove-from-response"` - `"monitor-request"` - `"monitor-response"` |
