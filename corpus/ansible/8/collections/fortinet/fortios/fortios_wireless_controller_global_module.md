...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_wireless_controller_global_module.html
...
| **acd_process_count**  integer | Configure the number cw_acd daemons for multi-core CPU support . |
...
| **dfs_lab_test**  string | Enable/disable DFS certificate lab test mode.  **Choices:**   - `"enable"` - `"disable"` |
...
| **wpad_process_count**  integer | Wpad daemon process count for multi-core CPU support. |
