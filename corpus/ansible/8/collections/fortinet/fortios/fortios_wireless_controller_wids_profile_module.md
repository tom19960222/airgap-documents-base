...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_wireless_controller_wids_profile_module.html
fetched_at: 2026-07-28T02:31:31+00:00
---
...
| **ap_scan_channel_list_2G_5G**  list / elements=dictionary | Selected ap scan channel list for 2.4G and 5G bands. |
| **chan**  string / required | Channel number. |
| **ap_scan_channel_list_6G**  list / elements=dictionary | Selected ap scan channel list for 6G band. |
| **chan**  string / required | Channel 6g number. |
