...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortios/fortios_system_virtual_wan_link_module.html
fetched_at: 2026-07-28T02:29:43+00:00
---
...
| **seq_num**  integer / required | Member sequence number. see <a href=’#notes’>Notes</a>. Source system.virtual-wan-link.members.seq-num. |
...
| **seq_num**  integer / required | Sequence number(1-255). see <a href=’#notes’>Notes</a>. |
...
| **ip**  string / required | IP address of neighbor. Source router.bgp.neighbor.ip. |
...
| **id**  integer / required | Priority rule ID (1 - 4000). see <a href=’#notes’>Notes</a>. |
...
| **id**  integer / required | Control-based Internet Service ID. see <a href=’#notes’>Notes</a>. |
...
| **sla**  list / elements=dictionary | Service level agreement (SLA). |
| **health_check**  string / required | Virtual WAN Link health-check. Source system.virtual-wan-link.health-check.name. |
| **id**  integer | SLA ID. |
