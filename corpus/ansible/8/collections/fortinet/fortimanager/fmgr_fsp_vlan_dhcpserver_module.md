...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_fsp_vlan_dhcpserver module – Configure DHCP servers."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_fsp_vlan_dhcpserver_module.html
fetched_at: 2026-07-28T02:13:51+00:00
---
# fortinet.fortimanager.fmgr_fsp_vlan_dhcpserver module – Configure DHCP servers.
...
- [Synopsis](fmgr_fsp_vlan_dhcpserver_module.md#synopsis)
- [Parameters](fmgr_fsp_vlan_dhcpserver_module.md#parameters)
- [Notes](fmgr_fsp_vlan_dhcpserver_module.md#notes)
- [Examples](fmgr_fsp_vlan_dhcpserver_module.md#examples)
- [Return Values](fmgr_fsp_vlan_dhcpserver_module.md#return-values)

## [Synopsis](fmgr_fsp_vlan_dhcpserver_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_fsp_vlan_dhcpserver_module.md#id2)
...
| **fsp_vlan_dhcpserver**  dictionary | the top level parameters set |
...
## [Notes](fmgr_fsp_vlan_dhcpserver_module.md#id3)
...
## [Examples](fmgr_fsp_vlan_dhcpserver_module.md#id4)
...
## [Return Values](fmgr_fsp_vlan_dhcpserver_module.md#id5)
