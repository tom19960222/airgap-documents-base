...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_cloud_orchestawstemplate_autoscaleexistingvpc module – no description"
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.html
fetched_at: 2026-07-28T02:08:36+00:00
---
# fortinet.fortimanager.fmgr_cloud_orchestawstemplate_autoscaleexistingvpc module – no description
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_cloud_orchestawstemplate_autoscaleexistingvpc`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#synopsis)
- [Parameters](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#parameters)
- [Notes](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#notes)
- [Examples](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#examples)
- [Return Values](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#return-values)

## [Synopsis](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#id2)
...
| **cloud_orchestawstemplate_autoscaleexistingvpc**  dictionary | the top level parameters set |
...
| **internal-balancer-dns-name**  string | no description |
| **internal-balancing-options**  string | no description  **Choices:**   - `"add a new internal load balancer"` - `"use a load balancer specified below"` - `"do not need one"` |
| **internal-target-group-health-check-path**  string | no description |
| **key-pair-name**  string | no description |
| **lifecycle-hook-timeout**  integer | no description |
| **loadbalancing-health-check-threshold**  integer | no description |
| **loadbalancing-traffic-port**  integer | no description |
| **loadbalancing-traffic-protocol**  string | no description  **Choices:**   - `"HTTPS"` - `"HTTP"` - `"TCP"` |
...
| **private-subnet-route-table**  string | no description |
| **private-subnet1**  string | no description |
| **private-subnet2**  string | no description |
| **public-subnet1**  string | no description |
| **public-subnet2**  string | no description |
...
| **vpc-endpoint-id**  string | no description |
...
## [Notes](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#id3)
...
## [Examples](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#id4)
...
## [Return Values](fmgr_cloud_orchestawstemplate_autoscaleexistingvpc_module.md#id5)
