...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_pm_pblock_obj module – no description"
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_pm_pblock_obj_module.html
fetched_at: 2026-07-28T02:16:15+00:00
---
# fortinet.fortimanager.fmgr_pm_pblock_obj module – no description
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_pm_pblock_obj`.

New in fortinet.fortimanager 2.1.0

- [Synopsis](fmgr_pm_pblock_obj_module.md#synopsis)
- [Parameters](fmgr_pm_pblock_obj_module.md#parameters)
- [Notes](fmgr_pm_pblock_obj_module.md#notes)
- [Examples](fmgr_pm_pblock_obj_module.md#examples)
- [Return Values](fmgr_pm_pblock_obj_module.md#return-values)

## [Synopsis](fmgr_pm_pblock_obj_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_pm_pblock_obj_module.md#id2)
...
| **pm_pblock_obj**  dictionary | the top level parameters set |
...
## [Notes](fmgr_pm_pblock_obj_module.md#id3)
...
## [Examples](fmgr_pm_pblock_obj_module.md#id4)
...
## [Return Values](fmgr_pm_pblock_obj_module.md#id5)
