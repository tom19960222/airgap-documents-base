...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_wtpprofile_radio2 module – Configuration options for radio 2."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_wtpprofile_radio2_module.html
...
| **band**  string | WiFi band that Radio 2 operates on.  **Choices:**   - `"802.11b"` - `"802.11a"` - `"802.11g"` - `"802.11n"` - `"802.11ac"` - `"802.11n-5G"` - `"802.11g-only"` - `"802.11n-only"` - `"802.11n,g-only"` - `"802.11ac-only"` - `"802.11ac,n-only"` - `"802.11n-5G-only"` - `"802.11ax-5G"` - `"802.11ax"` - `"802.11ax-5G-only"` - `"802.11ax,ac-only"` - `"802.11ax,ac,n-only"` - `"802.11ax-only"` - `"802.11ax,n-only"` - `"802.11ax,n,g-only"` - `"802.11ac-2G"` - `"802.11ax-6G"` |
