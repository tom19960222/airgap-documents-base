...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_spamfilter_profile module – Configure AntiSpam profiles."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_spamfilter_profile_module.html
...
| **flow-based**  string | Enable/disable flow-based spam filtering.  **Choices:**   - `"disable"` - `"enable"` |
...
| **options**  list / elements=string | no description  **Choices:**   - `"bannedword"` - `"spamemailbwl"` - `"spamfsip"` - `"spamfssubmit"` - `"spamfschksum"` - `"spamfsurl"` - `"spamhelodns"` - `"spamipbwl"` - `"spamraddrdns"` - `"spamrbl"` - `"spamhdrcheck"` - `"spamfsphish"` - `"spambwl"` |
...
| **yahoo-mail**  dictionary | no description |
| **log**  string | Enable/disable logging.  **Choices:**   - `"disable"` - `"enable"` |
