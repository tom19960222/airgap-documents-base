...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_dlp_profile module – Configure DLP profiles."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_dlp_profile_module.html
fetched_at: 2026-07-28T02:09:16+00:00
---
# fortinet.fortimanager.fmgr_dlp_profile module – Configure DLP profiles.
...
| **feature-set**  string | Flow/proxy feature set.  **Choices:**   - `"flow"` - `"proxy"` |
| **full-archive-proto**  list / elements=string | no description  **Choices:**   - `"smtp"` - `"pop3"` - `"imap"` - `"http-post"` - `"http-get"` - `"ftp"` - `"nntp"` - `"mapi"` - `"ssh"` - `"cifs"` |
...
| **summary-proto**  list / elements=string | no description  **Choices:**   - `"smtp"` - `"pop3"` - `"imap"` - `"http-post"` - `"http-get"` - `"ftp"` - `"nntp"` - `"mapi"` - `"ssh"` - `"cifs"` |
