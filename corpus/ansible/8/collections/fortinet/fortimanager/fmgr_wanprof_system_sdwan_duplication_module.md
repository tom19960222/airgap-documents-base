...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_wanprof_system_sdwan_duplication module – Create SD-WAN duplication rule."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_wanprof_system_sdwan_duplication_module.html
fetched_at: 2026-07-28T02:22:27+00:00
---
# fortinet.fortimanager.fmgr_wanprof_system_sdwan_duplication module – Create SD-WAN duplication rule.
...
- [Synopsis](fmgr_wanprof_system_sdwan_duplication_module.md#synopsis)
- [Parameters](fmgr_wanprof_system_sdwan_duplication_module.md#parameters)
- [Notes](fmgr_wanprof_system_sdwan_duplication_module.md#notes)
- [Examples](fmgr_wanprof_system_sdwan_duplication_module.md#examples)
- [Return Values](fmgr_wanprof_system_sdwan_duplication_module.md#return-values)

## [Synopsis](fmgr_wanprof_system_sdwan_duplication_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_wanprof_system_sdwan_duplication_module.md#id2)
...
| **wanprof_system_sdwan_duplication**  dictionary | the top level parameters set |
...
| **id**  integer / required | Duplication rule ID |
...
## [Notes](fmgr_wanprof_system_sdwan_duplication_module.md#id3)
...
## [Examples](fmgr_wanprof_system_sdwan_duplication_module.md#id4)
...
## [Return Values](fmgr_wanprof_system_sdwan_duplication_module.md#id5)
