...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_firewall_accessproxy6_apigateway module – Set IPv4 API Gateway."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_firewall_accessproxy6_apigateway_module.html
fetched_at: 2026-07-28T02:11:10+00:00
---
...
- [Synopsis](fmgr_firewall_accessproxy6_apigateway_module.md#synopsis)
- [Parameters](fmgr_firewall_accessproxy6_apigateway_module.md#parameters)
- [Notes](fmgr_firewall_accessproxy6_apigateway_module.md#notes)
- [Examples](fmgr_firewall_accessproxy6_apigateway_module.md#examples)
- [Return Values](fmgr_firewall_accessproxy6_apigateway_module.md#return-values)

## [Synopsis](fmgr_firewall_accessproxy6_apigateway_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_firewall_accessproxy6_apigateway_module.md#id2)
...
| **firewall_accessproxy6_apigateway**  dictionary | the top level parameters set |
...
## [Notes](fmgr_firewall_accessproxy6_apigateway_module.md#id3)
...
## [Examples](fmgr_firewall_accessproxy6_apigateway_module.md#id4)
...
## [Return Values](fmgr_firewall_accessproxy6_apigateway_module.md#id5)
