...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_system_npu_npqueues module – Configure queue assignment on NP7."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_system_npu_npqueues_module.html
...
- [Synopsis](fmgr_system_npu_npqueues_module.md#synopsis)
- [Parameters](fmgr_system_npu_npqueues_module.md#parameters)
- [Notes](fmgr_system_npu_npqueues_module.md#notes)
- [Examples](fmgr_system_npu_npqueues_module.md#examples)
- [Return Values](fmgr_system_npu_npqueues_module.md#return-values)

## [Synopsis](fmgr_system_npu_npqueues_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_system_npu_npqueues_module.md#id2)
...
| **system_npu_npqueues**  dictionary | the top level parameters set |
...
## [Notes](fmgr_system_npu_npqueues_module.md#id3)
...
## [Examples](fmgr_system_npu_npqueues_module.md#id4)
...
## [Return Values](fmgr_system_npu_npqueues_module.md#id5)
