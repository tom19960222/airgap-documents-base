...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_log_npuserver_servergroup module – create server group."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_log_npuserver_servergroup_module.html
fetched_at: 2026-07-28T02:15:00+00:00
---
# fortinet.fortimanager.fmgr_log_npuserver_servergroup module – create server group.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_log_npuserver_servergroup`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_log_npuserver_servergroup_module.md#synopsis)
- [Parameters](fmgr_log_npuserver_servergroup_module.md#parameters)
- [Notes](fmgr_log_npuserver_servergroup_module.md#notes)
- [Examples](fmgr_log_npuserver_servergroup_module.md#examples)
- [Return Values](fmgr_log_npuserver_servergroup_module.md#return-values)

## [Synopsis](fmgr_log_npuserver_servergroup_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_log_npuserver_servergroup_module.md#id2)
...
| **log_npuserver_servergroup**  dictionary | the top level parameters set |
...
## [Notes](fmgr_log_npuserver_servergroup_module.md#id3)
...
## [Examples](fmgr_log_npuserver_servergroup_module.md#id4)
...
## [Return Values](fmgr_log_npuserver_servergroup_module.md#id5)
