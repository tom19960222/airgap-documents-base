...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_wanprof_system_sdwan_members module – FortiGate interfaces added to the SD-WAN."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_wanprof_system_sdwan_members_module.html
fetched_at: 2026-07-28T02:22:30+00:00
---
# fortinet.fortimanager.fmgr_wanprof_system_sdwan_members module – FortiGate interfaces added to the SD-WAN.
...
- [Synopsis](fmgr_wanprof_system_sdwan_members_module.md#synopsis)
- [Parameters](fmgr_wanprof_system_sdwan_members_module.md#parameters)
- [Notes](fmgr_wanprof_system_sdwan_members_module.md#notes)
- [Examples](fmgr_wanprof_system_sdwan_members_module.md#examples)
- [Return Values](fmgr_wanprof_system_sdwan_members_module.md#return-values)

## [Synopsis](fmgr_wanprof_system_sdwan_members_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_wanprof_system_sdwan_members_module.md#id2)
...
| **wanprof_system_sdwan_members**  dictionary | the top level parameters set |
...
## [Notes](fmgr_wanprof_system_sdwan_members_module.md#id3)
...
## [Examples](fmgr_wanprof_system_sdwan_members_module.md#id4)
...
## [Return Values](fmgr_wanprof_system_sdwan_members_module.md#id5)
