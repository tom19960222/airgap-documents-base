...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile module – FortiExtender extender profile configuration."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_extensioncontroller_extenderprofile_module.html
fetched_at: 2026-07-28T02:10:57+00:00
---
# fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile module – FortiExtender extender profile configuration.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_extensioncontroller_extenderprofile_module.md#synopsis)
- [Parameters](fmgr_extensioncontroller_extenderprofile_module.md#parameters)
- [Notes](fmgr_extensioncontroller_extenderprofile_module.md#notes)
- [Examples](fmgr_extensioncontroller_extenderprofile_module.md#examples)
- [Return Values](fmgr_extensioncontroller_extenderprofile_module.md#return-values)

## [Synopsis](fmgr_extensioncontroller_extenderprofile_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_extensioncontroller_extenderprofile_module.md#id2)
...
| **extensioncontroller_extenderprofile**  dictionary | the top level parameters set |
| **_is_factory_setting**  string | no description  **Choices:**   - `"disable"` - `"enable"` - `"ext"` |
| **allowaccess**  list / elements=string | no description  **Choices:**   - `"https"` - `"ping"` - `"ssh"` - `"snmp"` - `"http"` - `"telnet"` |
| **bandwidth-limit**  integer | FortiExtender LAN extension bandwidth limit |
| **cellular**  dictionary | no description |
| **controller-report**  dictionary | no description |
| **interval**  integer | Controller report interval. |
| **signal-threshold**  integer | Controller report signal threshold. |
| **status**  string | FortiExtender controller report status.  **Choices:**   - `"disable"` - `"enable"` |
| **dataplan**  any | (list) no description |
...
| **data-exhausted**  string | Display string when data exhausted. |
| **fgt-backup-mode-switch**  string | Display string when FortiGate backup mode switched. |
| **low-signal-strength**  string | Display string when signal strength is low. |
| **mode-switch**  string | Display string when mode is switched. |
| **os-image-fallback**  string | Display string when falling back to a previous OS image. |
| **session-disconnect**  string | Display string when session disconnected. |
| **system-reboot**  string | Display string when system rebooted. |
| **receiver**  list / elements=dictionary | no description |
| **alert**  list / elements=string | no description  **Choices:**   - `"system-reboot"` - `"data-exhausted"` - `"session-disconnect"` - `"low-signal-strength"` - `"mode-switch"` - `"os-image-fallback"` - `"fgt-backup-mode-switch"` |
| **name**  string | FortiExtender SMS notification receiver name. |
| **phone-number**  string | Receiver phone number. |
...
| **enforce-bandwidth**  string | Enable/disable enforcement of bandwidth on LAN extension interface.  **Choices:**   - `"disable"` - `"enable"` |
| **extension**  string | Extension option.  **Choices:**   - `"wan-extension"` - `"lan-extension"` |
| **id**  integer / required | ID. |
| **lan-extension**  dictionary | no description |
| **backhaul**  list / elements=dictionary | no description |
| **name**  string | FortiExtender LAN extension backhaul name. |
...
| **backhaul-interface**  string | IPsec phase1 interface. |
| **backhaul-ip**  string | IPsec phase1 IPv4/FQDN. |
| **ipsec-tunnel**  string | IPsec tunnel name. |
| **link-loadbalance**  string | LAN extension link load balance strategy.  **Choices:**   - `"activebackup"` - `"loadbalance"` |
| **login-password**  any | (list) no description |
| **login-password-change**  string | Change or reset the administrator password of a managed extender  **Choices:**   - `"no"` - `"yes"` - `"default"` |
...
## [Notes](fmgr_extensioncontroller_extenderprofile_module.md#id3)
...
## [Examples](fmgr_extensioncontroller_extenderprofile_module.md#id4)
...
## [Return Values](fmgr_extensioncontroller_extenderprofile_module.md#id5)
