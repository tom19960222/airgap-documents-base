...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_firewall_accessproxy_apigateway_sslciphersuites module – SSL/TLS cipher suites to offer to a server, ordered by priority."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.html
fetched_at: 2026-07-28T02:11:22+00:00
---
# fortinet.fortimanager.fmgr_firewall_accessproxy_apigateway_sslciphersuites module – SSL/TLS cipher suites to offer to a server, ordered by priority.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_firewall_accessproxy_apigateway_sslciphersuites`.

New in fortinet.fortimanager 2.1.0

- [Synopsis](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#synopsis)
- [Parameters](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#parameters)
- [Notes](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#notes)
- [Examples](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#examples)
- [Return Values](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#return-values)

## [Synopsis](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#id2)
...
| **api-gateway**  string / required | the parameter (api-gateway) in requested url |
| **bypass_validation**  boolean | Only set to True when module schema diffs with FortiManager API structure, module continues to execute without validating parameters.  **Choices:**   - `false` ← (default) - `true` |
| **enable_log**  boolean | Enable/Disable logging for task.  **Choices:**   - `false` ← (default) - `true` |
| **firewall_accessproxy_apigateway_sslciphersuites**  dictionary | the top level parameters set |
...
## [Notes](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#id3)
...
## [Examples](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#id4)
...
## [Return Values](fmgr_firewall_accessproxy_apigateway_sslciphersuites_module.md#id5)
