...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_voip_profile module – Configure VoIP profiles."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_voip_profile_module.html
fetched_at: 2026-07-28T02:21:34+00:00
---
...
| **feature-set**  string | Flow or proxy inspection feature set.  **Choices:**   - `"flow"` - `"proxy"` - `"ips"` - `"voipd"` |
