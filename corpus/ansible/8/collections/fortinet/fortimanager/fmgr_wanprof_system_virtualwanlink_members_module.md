...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_wanprof_system_virtualwanlink_members module – Physical FortiGate interfaces added to the virtual-wan-link."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_wanprof_system_virtualwanlink_members_module.html
fetched_at: 2026-07-28T02:22:36+00:00
---
# fortinet.fortimanager.fmgr_wanprof_system_virtualwanlink_members module – Physical FortiGate interfaces added to the virtual-wan-link.
...
- [Synopsis](fmgr_wanprof_system_virtualwanlink_members_module.md#synopsis)
- [Parameters](fmgr_wanprof_system_virtualwanlink_members_module.md#parameters)
- [Notes](fmgr_wanprof_system_virtualwanlink_members_module.md#notes)
- [Examples](fmgr_wanprof_system_virtualwanlink_members_module.md#examples)
- [Return Values](fmgr_wanprof_system_virtualwanlink_members_module.md#return-values)

## [Synopsis](fmgr_wanprof_system_virtualwanlink_members_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_wanprof_system_virtualwanlink_members_module.md#id2)
...
| **seq-num**  integer / required | Sequence number |
...
## [Notes](fmgr_wanprof_system_virtualwanlink_members_module.md#id3)
...
## [Examples](fmgr_wanprof_system_virtualwanlink_members_module.md#id4)
...
## [Return Values](fmgr_wanprof_system_virtualwanlink_members_module.md#id5)
