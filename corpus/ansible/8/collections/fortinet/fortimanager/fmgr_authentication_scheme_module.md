...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_authentication_scheme module – Configure Authentication Schemes."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_authentication_scheme_module.html
fetched_at: 2026-07-28T02:08:17+00:00
---
# fortinet.fortimanager.fmgr_authentication_scheme module – Configure Authentication Schemes.
...
| **ems-device-owner**  string | Enable/disable SSH public-key authentication with device owner  **Choices:**   - `"disable"` - `"enable"` |
| **fsso-agent-for-ntlm**  string | FSSO agent to use for NTLM authentication. |
| **fsso-guest**  string | Enable/disable user fsso-guest authentication  **Choices:**   - `"disable"` - `"enable"` |
| **kerberos-keytab**  string | Kerberos keytab setting. |
| **method**  list / elements=string | Authentication methods  **Choices:**   - `"ntlm"` - `"basic"` - `"digest"` - `"form"` - `"negotiate"` - `"fsso"` - `"rsso"` - `"ssh-publickey"` - `"saml"` - `"cert"` - `"x-auth-user"` - `"saml-sp"` |
| **name**  string / required | Authentication scheme name. |
| **negotiate-ntlm**  string | Enable/disable negotiate authentication for NTLM  **Choices:**   - `"disable"` - `"enable"` |
| **require-tfa**  string | Enable/disable two-factor authentication  **Choices:**   - `"disable"` - `"enable"` |
...
| **user-cert**  string | Enable/disable authentication with user certificate  **Choices:**   - `"disable"` - `"enable"` |
| **user-database**  any | (list or str) Authentication server to contain user information; local |
