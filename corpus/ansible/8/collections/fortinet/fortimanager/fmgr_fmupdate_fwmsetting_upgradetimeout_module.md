...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_fmupdate_fwmsetting_upgradetimeout module – Configure the timeout value of image upgrade process."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_fmupdate_fwmsetting_upgradetimeout_module.html
fetched_at: 2026-07-28T02:13:40+00:00
---
# fortinet.fortimanager.fmgr_fmupdate_fwmsetting_upgradetimeout module – Configure the timeout value of image upgrade process.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_fmupdate_fwmsetting_upgradetimeout`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#synopsis)
- [Parameters](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#parameters)
- [Notes](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#notes)
- [Examples](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#examples)
- [Return Values](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#return-values)

## [Synopsis](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#id2)
...
| **fmupdate_fwmsetting_upgradetimeout**  dictionary | the top level parameters set |
...
## [Notes](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#id3)
...
## [Examples](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#id4)
...
## [Return Values](fmgr_fmupdate_fwmsetting_upgradetimeout_module.md#id5)
