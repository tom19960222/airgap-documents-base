...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_firewall_vip_quic module – QUIC setting."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_firewall_vip_quic_module.html
fetched_at: 2026-07-28T02:13:17+00:00
---
# fortinet.fortimanager.fmgr_firewall_vip_quic module – QUIC setting.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_firewall_vip_quic`.

New in fortinet.fortimanager 2.3.0

- [Synopsis](fmgr_firewall_vip_quic_module.md#synopsis)
- [Parameters](fmgr_firewall_vip_quic_module.md#parameters)
- [Notes](fmgr_firewall_vip_quic_module.md#notes)
- [Examples](fmgr_firewall_vip_quic_module.md#examples)
- [Return Values](fmgr_firewall_vip_quic_module.md#return-values)

## [Synopsis](fmgr_firewall_vip_quic_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_firewall_vip_quic_module.md#id2)
...
| **firewall_vip_quic**  dictionary | the top level parameters set |
...
## [Notes](fmgr_firewall_vip_quic_module.md#id3)
...
## [Examples](fmgr_firewall_vip_quic_module.md#id4)
...
## [Return Values](fmgr_firewall_vip_quic_module.md#id5)
