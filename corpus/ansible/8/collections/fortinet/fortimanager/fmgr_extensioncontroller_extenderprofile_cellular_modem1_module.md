...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile_cellular_modem1 module – Configuration options for modem 1."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.html
fetched_at: 2026-07-28T02:10:59+00:00
---
# fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile_cellular_modem1 module – Configuration options for modem 1.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_extensioncontroller_extenderprofile_cellular_modem1`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#synopsis)
- [Parameters](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#parameters)
- [Notes](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#notes)
- [Examples](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#examples)
- [Return Values](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#return-values)

## [Synopsis](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#id2)
...
| **extensioncontroller_extenderprofile_cellular_modem1**  dictionary | the top level parameters set |
...
## [Notes](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#id3)
...
## [Examples](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#id4)
...
## [Return Values](fmgr_extensioncontroller_extenderprofile_cellular_modem1_module.md#id5)
