...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_pm_config_pblock_firewall_consolidated_policy module – Configure consolidated IPv4/IPv6 policies."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_pm_config_pblock_firewall_consolidated_policy_module.html
fetched_at: 2026-07-28T02:16:00+00:00
---
# fortinet.fortimanager.fmgr_pm_config_pblock_firewall_consolidated_policy module – Configure consolidated IPv4/IPv6 policies.
...
- [Synopsis](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#synopsis)
- [Parameters](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#parameters)
- [Notes](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#notes)
- [Examples](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#examples)
- [Return Values](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#return-values)

## [Synopsis](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#id2)
...
| **dstaddr4**  any | (list) no description |
...
| **poolname4**  any | (list) no description |
...
| **srcaddr4**  any | (list) no description |
...
## [Notes](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#id3)
...
## [Examples](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#id4)
...
## [Return Values](fmgr_pm_config_pblock_firewall_consolidated_policy_module.md#id5)
