...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_firewall_address6_dynamicmapping module – Configure IPv6 firewall addresses."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_firewall_address6_dynamicmapping_module.html
fetched_at: 2026-07-28T02:11:29+00:00
---
...
| **subnet-segment**  list / elements=dictionary | no description |
| **name**  string | no description |
...
| **type**  string | no description  **Choices:**   - `"ipprefix"` - `"iprange"` - `"nsx"` - `"dynamic"` - `"fqdn"` - `"template"` - `"mac"` - `"geography"` - `"route-tag"` |
