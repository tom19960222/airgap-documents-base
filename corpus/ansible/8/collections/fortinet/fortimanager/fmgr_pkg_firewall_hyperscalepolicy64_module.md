...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_pkg_firewall_hyperscalepolicy64 module – Configure IPv6 to IPv4 policies."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_pkg_firewall_hyperscalepolicy64_module.html
fetched_at: 2026-07-28T02:15:28+00:00
---
# fortinet.fortimanager.fmgr_pkg_firewall_hyperscalepolicy64 module – Configure IPv6 to IPv4 policies.
...
>
> To use it in a playbook, specify: `fortinet.fortimanager.fmgr_pkg_firewall_hyperscalepolicy64`.

New in fortinet.fortimanager 2.2.0

- [Synopsis](fmgr_pkg_firewall_hyperscalepolicy64_module.md#synopsis)
- [Parameters](fmgr_pkg_firewall_hyperscalepolicy64_module.md#parameters)
- [Notes](fmgr_pkg_firewall_hyperscalepolicy64_module.md#notes)
- [Examples](fmgr_pkg_firewall_hyperscalepolicy64_module.md#examples)
- [Return Values](fmgr_pkg_firewall_hyperscalepolicy64_module.md#return-values)

## [Synopsis](fmgr_pkg_firewall_hyperscalepolicy64_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_pkg_firewall_hyperscalepolicy64_module.md#id2)
...
| **pkg_firewall_hyperscalepolicy64**  dictionary | the top level parameters set |
...
## [Notes](fmgr_pkg_firewall_hyperscalepolicy64_module.md#id3)
...
## [Examples](fmgr_pkg_firewall_hyperscalepolicy64_module.md#id4)
...
## [Return Values](fmgr_pkg_firewall_hyperscalepolicy64_module.md#id5)
