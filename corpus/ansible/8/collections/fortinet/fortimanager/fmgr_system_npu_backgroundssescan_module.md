...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_system_npu_backgroundssescan module – Configure driver background scan for SSE."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_system_npu_backgroundssescan_module.html
fetched_at: 2026-07-28T02:19:18+00:00
---
# fortinet.fortimanager.fmgr_system_npu_backgroundssescan module – Configure driver background scan for SSE.
...
- [Synopsis](fmgr_system_npu_backgroundssescan_module.md#synopsis)
- [Parameters](fmgr_system_npu_backgroundssescan_module.md#parameters)
- [Notes](fmgr_system_npu_backgroundssescan_module.md#notes)
- [Examples](fmgr_system_npu_backgroundssescan_module.md#examples)
- [Return Values](fmgr_system_npu_backgroundssescan_module.md#return-values)

## [Synopsis](fmgr_system_npu_backgroundssescan_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_system_npu_backgroundssescan_module.md#id2)
...
## [Notes](fmgr_system_npu_backgroundssescan_module.md#id3)
...
## [Examples](fmgr_system_npu_backgroundssescan_module.md#id4)
...
## [Return Values](fmgr_system_npu_backgroundssescan_module.md#id5)
