...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_pkg_footer_shapingpolicy module – Configure shaping policies."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_pkg_footer_shapingpolicy_module.html
fetched_at: 2026-07-28T02:15:48+00:00
---
# fortinet.fortimanager.fmgr_pkg_footer_shapingpolicy module – Configure shaping policies.
...
- [Synopsis](fmgr_pkg_footer_shapingpolicy_module.md#synopsis)
- [Parameters](fmgr_pkg_footer_shapingpolicy_module.md#parameters)
- [Notes](fmgr_pkg_footer_shapingpolicy_module.md#notes)
- [Examples](fmgr_pkg_footer_shapingpolicy_module.md#examples)
- [Return Values](fmgr_pkg_footer_shapingpolicy_module.md#return-values)

## [Synopsis](fmgr_pkg_footer_shapingpolicy_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_pkg_footer_shapingpolicy_module.md#id2)
...
| **pkg_footer_shapingpolicy**  dictionary | the top level parameters set |
...
## [Notes](fmgr_pkg_footer_shapingpolicy_module.md#id3)
...
## [Examples](fmgr_pkg_footer_shapingpolicy_module.md#id4)
...
## [Return Values](fmgr_pkg_footer_shapingpolicy_module.md#id5)
