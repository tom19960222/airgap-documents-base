...
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_generic_module.html
...
| **workspace_locking_timeout**  integer | no description  **Default:** `300` |
