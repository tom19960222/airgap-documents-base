...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_antivirus_profile_contentdisarm module – AV Content Disarm and Reconstruction settings."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_antivirus_profile_contentdisarm_module.html
...
- [Synopsis](fmgr_antivirus_profile_contentdisarm_module.md#synopsis)
- [Parameters](fmgr_antivirus_profile_contentdisarm_module.md#parameters)
- [Notes](fmgr_antivirus_profile_contentdisarm_module.md#notes)
- [Examples](fmgr_antivirus_profile_contentdisarm_module.md#examples)
- [Return Values](fmgr_antivirus_profile_contentdisarm_module.md#return-values)

## [Synopsis](fmgr_antivirus_profile_contentdisarm_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_antivirus_profile_contentdisarm_module.md#id2)
...
| **pdf-act-form**  string | Enable/disable stripping of actions that submit data to other targets in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
| **pdf-act-gotor**  string | Enable/disable stripping of links to other PDFs in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
| **pdf-act-java**  string | Enable/disable stripping of actions that execute JavaScript code in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
| **pdf-act-launch**  string | Enable/disable stripping of links to external applications in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
| **pdf-act-movie**  string | Enable/disable stripping of embedded movies in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
| **pdf-act-sound**  string | Enable/disable stripping of embedded sound files in PDF documents.  **Choices:**   - `"disable"` - `"enable"` |
...
## [Notes](fmgr_antivirus_profile_contentdisarm_module.md#id3)
...
## [Examples](fmgr_antivirus_profile_contentdisarm_module.md#id4)
...
## [Return Values](fmgr_antivirus_profile_contentdisarm_module.md#id5)
