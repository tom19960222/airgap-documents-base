...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_casb_useractivity_controloptions module – CASB control options."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_casb_useractivity_controloptions_module.html
fetched_at: 2026-07-28T02:08:26+00:00
---
# fortinet.fortimanager.fmgr_casb_useractivity_controloptions module – CASB control options.
...
- [Synopsis](fmgr_casb_useractivity_controloptions_module.md#synopsis)
- [Parameters](fmgr_casb_useractivity_controloptions_module.md#parameters)
- [Notes](fmgr_casb_useractivity_controloptions_module.md#notes)
- [Examples](fmgr_casb_useractivity_controloptions_module.md#examples)
- [Return Values](fmgr_casb_useractivity_controloptions_module.md#return-values)

## [Synopsis](fmgr_casb_useractivity_controloptions_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_casb_useractivity_controloptions_module.md#id2)
...
## [Notes](fmgr_casb_useractivity_controloptions_module.md#id3)
...
## [Examples](fmgr_casb_useractivity_controloptions_module.md#id4)
...
## [Return Values](fmgr_casb_useractivity_controloptions_module.md#id5)
