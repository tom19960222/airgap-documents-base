...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_ips_baseline_sensor_entries module – IPS sensor filter."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_ips_baseline_sensor_entries_module.html
...
- [Synopsis](fmgr_ips_baseline_sensor_entries_module.md#synopsis)
- [Parameters](fmgr_ips_baseline_sensor_entries_module.md#parameters)
- [Notes](fmgr_ips_baseline_sensor_entries_module.md#notes)
- [Examples](fmgr_ips_baseline_sensor_entries_module.md#examples)
- [Return Values](fmgr_ips_baseline_sensor_entries_module.md#return-values)

## [Synopsis](fmgr_ips_baseline_sensor_entries_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_ips_baseline_sensor_entries_module.md#id2)
...
| **ips_baseline_sensor_entries**  dictionary | the top level parameters set |
...
## [Notes](fmgr_ips_baseline_sensor_entries_module.md#id3)
...
## [Examples](fmgr_ips_baseline_sensor_entries_module.md#id4)
...
## [Return Values](fmgr_ips_baseline_sensor_entries_module.md#id5)
