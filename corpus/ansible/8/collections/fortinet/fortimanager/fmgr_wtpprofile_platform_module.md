...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_wtpprofile_platform module – WTP, FortiAP, or AP platform."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_wtpprofile_platform_module.html
fetched_at: 2026-07-28T02:23:09+00:00
---
# fortinet.fortimanager.fmgr_wtpprofile_platform module – WTP, FortiAP, or AP platform.
...
| **ddscan**  string | Enable/disable use of one radio for dedicated dual-band scanning to detect RF characterization and wireless threat management.  **Choices:**   - `"disable"` - `"enable"` |
