...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_cloud_orchestawstemplate_autoscalenewvpc module – no description"
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.html
fetched_at: 2026-07-28T02:08:36+00:00
---
# fortinet.fortimanager.fmgr_cloud_orchestawstemplate_autoscalenewvpc module – no description
...
- [Synopsis](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#synopsis)
- [Parameters](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#parameters)
- [Notes](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#notes)
- [Examples](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#examples)
- [Return Values](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#return-values)

## [Synopsis](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#id2)
...
| **cloud_orchestawstemplate_autoscalenewvpc**  dictionary | the top level parameters set |
...
| **private-subnet1-cidr**  string | no description |
| **private-subnet2-cidr**  string | no description |
...
## [Notes](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#id3)
...
## [Examples](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#id4)
...
## [Return Values](fmgr_cloud_orchestawstemplate_autoscalenewvpc_module.md#id5)
