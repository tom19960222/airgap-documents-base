...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_system_npu_hpe module – Host protection engine configuration."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_system_npu_hpe_module.html
fetched_at: 2026-07-28T02:19:22+00:00
---
...
- [Synopsis](fmgr_system_npu_hpe_module.md#synopsis)
- [Parameters](fmgr_system_npu_hpe_module.md#parameters)
- [Notes](fmgr_system_npu_hpe_module.md#notes)
- [Examples](fmgr_system_npu_hpe_module.md#examples)
- [Return Values](fmgr_system_npu_hpe_module.md#return-values)

## [Synopsis](fmgr_system_npu_hpe_module.md#id1)

- This module is able to configure a FortiManager device.
- Examples include all parameters and values which need to be adjusted to data sources before usage.

## [Parameters](fmgr_system_npu_hpe_module.md#id2)
...
| **system_npu_hpe**  dictionary | the top level parameters set |
...
## [Notes](fmgr_system_npu_hpe_module.md#id3)
...
## [Examples](fmgr_system_npu_hpe_module.md#id4)
...
## [Return Values](fmgr_system_npu_hpe_module.md#id5)
