...
collection: ansible
version: "8"
title: "fortinet.fortimanager.fmgr_firewall_vip_dynamicmapping module – Configure virtual IP for IPv4."
source_url: https://docs.ansible.com/projects/ansible/8/collections/fortinet/fortimanager/fmgr_firewall_vip_dynamicmapping_module.html
fetched_at: 2026-07-28T02:13:15+00:00
---
...
| **extaddr**  any | (list or str) no description |
...
| **mappedip**  any | (list) no description |
...
| **client-ip**  any | (list) no description |
...
| **src-filter**  any | (list) no description |
| **srcintf-filter**  any | (list) no description |
