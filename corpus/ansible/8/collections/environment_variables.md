...
source_url: https://docs.ansible.com/projects/ansible/8/collections/environment_variables.html
fetched_at: 2026-07-28T01:03:18+00:00
---
...
:   URL to the Vault service.
    ...
    *Used by:*
    ...
    [community.hashi_vault.vault_list lookup plugin](community/hashi_vault/vault_list_lookup.md#ansible-collections-community-hashi-vault-vault-list-lookup),
...
:   The password for the Hosttech API user.
    ...
    *Used by:*
    [community.dns.hosttech_dns_records inventory plugin](community/dns/hosttech_dns_records_inventory.md#ansible-collections-community-dns-hosttech-dns-records-inventory)
...
:   The login domain name to use for authentication.
    ...
    *Used by:*
    [cisco.mso.mso httpapi plugin](cisco/mso/mso_httpapi.md#ansible-collections-cisco-mso-mso-httpapi)
...
:   Merge extra vars into the available variables for composition (highest precedence).
    ...
    *Used by:*
    ...
    [community.aws.aws_mq inventory plugin](community/aws/aws_mq_inventory.md#ansible-collections-community-aws-aws-mq-inventory),
    ...
    [microsoft.ad.ldap inventory plugin](microsoft/ad/ldap_inventory.md#ansible-collections-microsoft-ad-ldap-inventory),
    ...
    [telekom_mms.icinga_director.icinga_director_inventory inventory plugin](telekom_mms/icinga_director/icinga_director_inventory_inventory.md#ansible-collections-telekom-mms-icinga-director-icinga-director-inventory-inventory),
    ...
    [vultr.cloud.vultr inventory plugin](vultr/cloud/vultr_inventory.md#ansible-collections-vultr-cloud-vultr-inventory)
...
:   Enable or disable commit confirm mode.
    ...
    *Used by:*
    [cisco.ios.ios cliconf plugin](cisco/ios/ios_cliconf.md#ansible-collections-cisco-ios-ios-cliconf)
...
:   See the documentations for the options where this environment variable is used.
    ...
    *Used by:*
    [ansible.posix.json callback plugin](ansible/posix/json_callback.md#ansible-collections-ansible-posix-json-callback),
    [ansible.posix.jsonl callback plugin](ansible/posix/jsonl_callback.md#ansible-collections-ansible-posix-jsonl-callback)
...
:   SSL/TLS Ciphers to use for the request
    ...
    See the [OpenSSL Cipher List Format](https://www.openssl.org/docs/manmaster/man1/openssl-ciphers.html#CIPHER-LIST-FORMAT) for more details.
...
:   Return an error, print a warning or ignore it when a key will be overwritten.
    ...
    *Used by:*
    [community.general.merge_variables lookup plugin](community/general/merge_variables_lookup.md#ansible-collections-community-general-merge-variables-lookup)
...
:   The AWS access key ID to use for requests to AWS.
    ...
    Sets the environment variable [`AWS_ACCESS_KEY_ID`](environment_variables.md#envvar-AWS_ACCESS_KEY_ID) for the sops call.
...
:   The AWS secret access key to use for requests to AWS.
    ...
    Sets the environment variable [`AWS_SECRET_ACCESS_KEY`](environment_variables.md#envvar-AWS_SECRET_ACCESS_KEY) for the sops call.
...
:   The AWS session token to use for requests to AWS.
    ...
    Sets the environment variable [`AWS_SESSION_TOKEN`](environment_variables.md#envvar-AWS_SESSION_TOKEN) for the sops call.
...
:   API host to XOA API.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_HOST`](environment_variables.md#envvar-ANSIBLE_XO_HOST) will be used instead.
...
:   Xen Orchestra password.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_PASSWORD`](environment_variables.md#envvar-ANSIBLE_XO_PASSWORD) will be used instead.
...
:   Xen Orchestra user.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`ANSIBLE_XO_USER`](environment_variables.md#envvar-ANSIBLE_XO_USER) will be used instead.
...
:   See the documentations for the options where this environment variable is used.
    ...
    *Used by:*
    ...
    [amazon.aws.aws_ec2 inventory plugin](amazon/aws/aws_ec2_inventory.md#ansible-collections-amazon-aws-aws-ec2-inventory),
    [amazon.aws.aws_rds inventory plugin](amazon/aws/aws_rds_inventory.md#ansible-collections-amazon-aws-aws-rds-inventory),
    [amazon.aws.secretsmanager_secret lookup plugin](amazon/aws/secretsmanager_secret_lookup.md#ansible-collections-amazon-aws-secretsmanager-secret-lookup),
    [amazon.aws.ssm_parameter lookup plugin](amazon/aws/ssm_parameter_lookup.md#ansible-collections-amazon-aws-ssm-parameter-lookup),
    [community.aws.aws_mq inventory plugin](community/aws/aws_mq_inventory.md#ansible-collections-community-aws-aws-mq-inventory),
    [community.hashi_vault.hashi_vault lookup plugin](community/hashi_vault/hashi_vault_lookup.md#ansible-collections-community-hashi-vault-hashi-vault-lookup),
    [community.hashi_vault.vault_kv1_get lookup plugin](community/hashi_vault/vault_kv1_get_lookup.md#ansible-collections-community-hashi-vault-vault-kv1-get-lookup),
    [community.hashi_vault.vault_kv2_get lookup plugin](community/hashi_vault/vault_kv2_get_lookup.md#ansible-collections-community-hashi-vault-vault-kv2-get-lookup),
...
:   See the documentations for the options where this environment variable is used.
    ...
    *Used by:*
    ...
    [amazon.aws.ssm_parameter lookup plugin](amazon/aws/ssm_parameter_lookup.md#ansible-collections-amazon-aws-ssm-parameter-lookup),
    [community.aws.aws_mq inventory plugin](community/aws/aws_mq_inventory.md#ansible-collections-community-aws-aws-mq-inventory),
    [community.aws.aws_ssm connection plugin](community/aws/aws_ssm_connection.md#ansible-collections-community-aws-aws-ssm-connection),
...
:   The BWS access token to use for this lookup.
    ...
    *Used by:*
    [community.general.bitwarden_secrets_manager lookup plugin](community/general/bitwarden_secrets_manager_lookup.md#ansible-collections-community-general-bitwarden-secrets-manager-lookup)
...
ETCDCTL_ENDPOINTS
:   Counterpart of [`ETCDCTL_ENDPOINTS`](environment_variables.md#envvar-ETCDCTL_ENDPOINTS) environment variable. Specify the etcd3 connection with and URL form, for example `https://hostname:2379`, or `<host>:<port>` form.
...
:   The token for the Hetzner API.
    ...
    If not provided, will be read from the environment variable [`HETZNER_DNS_TOKEN`](environment_variables.md#envvar-HETZNER_DNS_TOKEN).
...
:   The authentication protocol to use when connecting to the LDAP host.
    ...
    See [LDAP authentication](microsoft/ad/docsite/guide_ldap_connection.md#ansible-collections-microsoft-ad-docsite-guide-ldap-connection-authentication) for more information.
...
:   The certificate validation behaviour when using a TLS connection.
    ...
    See [Certificate validation](microsoft/ad/docsite/guide_ldap_connection.md#ansible-collections-microsoft-ad-docsite-guide-ldap-connection-cert-validation) for more information.
...
:   The domain controller/server to connect to.
    ...
    See [Server lookup](microsoft/ad/docsite/guide_ldap_connection.md#ansible-collections-microsoft-ad-docsite-guide-ldap-connection-server-lookup) for more information.
...
:   OpenManage Enterprise or OpenManage Enterprise Modular IP address or hostname.
    ...
    *Used by:*
    [dellemc.openmanage.ome_inventory inventory plugin](dellemc/openmanage/ome_inventory_inventory.md#ansible-collections-dellemc-openmanage-ome-inventory-inventory)
...
:   If both `api_username` or `api_password` are not set, then it will try authenticate with ONE auth file. Default path is `~/.one/one_auth`.
    ...
    Set environment variable [`ONE_AUTH`](environment_variables.md#envvar-ONE_AUTH) to override this path.
...
:   Password or a token of the user to login into OpenNebula RPC server.
    ...
    If not set, the value of the [`ONE_PASSWORD`](environment_variables.md#envvar-ONE_PASSWORD) environment variable is used.
...
:   URL of the OpenNebula RPC server.
    ...
    If not set then the value of the [`ONE_URL`](environment_variables.md#envvar-ONE_URL) environment variable is used.

    *Used by:*
    [community.general.opennebula inventory plugin](community/general/opennebula_inventory.md#ansible-collections-community-general-opennebula-inventory)

ONE_USERNAME
:   Name of the user to login into the OpenNebula RPC server. If not set then the value of the [`ONE_USERNAME`](environment_variables.md#envvar-ONE_USERNAME) environment variable is used.
...
:   Proxmox authentication password.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`PROXMOX_PASSWORD`](environment_variables.md#envvar-PROXMOX_PASSWORD) will be used instead.
...
:   Proxmox authentication token ID.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`PROXMOX_TOKEN_ID`](environment_variables.md#envvar-PROXMOX_TOKEN_ID) will be used instead.
...
:   Proxmox authentication token secret.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`PROXMOX_TOKEN_SECRET`](environment_variables.md#envvar-PROXMOX_TOKEN_SECRET) will be used instead.
...
:   URL to Proxmox cluster.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`PROXMOX_URL`](environment_variables.md#envvar-PROXMOX_URL) will be used instead.
...
:   Proxmox authentication user.
    ...
    If the value is not specified in the inventory configuration, the value of environment variable [`PROXMOX_USER`](environment_variables.md#envvar-PROXMOX_USER) will be used instead.
