...
collection: ansible
version: "8"
title: "kubernetes.core.k8s_taint module – Taint a node in a Kubernetes/OpenShift cluster"
source_url: https://docs.ansible.com/projects/ansible/8/collections/kubernetes/core/k8s_taint_module.html
fetched_at: 2026-07-28T02:40:17+00:00
---
...
> see [Requirements](k8s_taint_module.md#ansible-collections-kubernetes-core-k8s-taint-module-requirements) for details.
>
> To use it in a playbook, specify: `kubernetes.core.k8s_taint`.

New in kubernetes.core 2.3.0

- [Synopsis](k8s_taint_module.md#synopsis)
- [Requirements](k8s_taint_module.md#requirements)
- [Parameters](k8s_taint_module.md#parameters)
- [Notes](k8s_taint_module.md#notes)
- [Examples](k8s_taint_module.md#examples)
- [Return Values](k8s_taint_module.md#return-values)

## [Synopsis](k8s_taint_module.md#id1)
...
## [Requirements](k8s_taint_module.md#id2)
...
## [Parameters](k8s_taint_module.md#id3)
...
| **replace**  boolean | If `true`, allow taints to be replaced.  **Choices:**   - `false` ← (default) - `true` |
| **state**  string | Determines whether to add or remove taints.  **Choices:**   - `"present"` ← (default) - `"absent"` |
| **taints**  list / elements=dictionary / required | List containing the taints. |
| **effect**  string | The effect of the taint on Pods that do not tolerate the taint.  Required when *state=present*.  **Choices:**   - `"NoSchedule"` - `"NoExecute"` - `"PreferNoSchedule"` |
...
## [Notes](k8s_taint_module.md#id4)

> **Note:**
>
> - To avoid SSL certificate validation errors when `validate_certs` is *True*, the full certificate chain for the API server must be provided via `ca_cert` or in the kubeconfig file.

## [Examples](k8s_taint_module.md#id5)
...
## [Return Values](k8s_taint_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **result**  complex | The tainted Node object. Will be empty in the case of a deletion.  **Returned:** success |
