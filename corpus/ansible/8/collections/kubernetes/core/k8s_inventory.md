...
collection: ansible
version: "8"
title: "kubernetes.core.k8s inventory – Kubernetes (K8s) inventory source"
source_url: https://docs.ansible.com/projects/ansible/8/collections/kubernetes/core/k8s_inventory.html
...
> **Note:**
>
> This inventory plugin is part of the [kubernetes.core collection](https://galaxy.ansible.com/ui/repo/published/kubernetes/core/) (version 2.4.0).
>
...
> see [Requirements](k8s_inventory.md#ansible-collections-kubernetes-core-k8s-inventory-requirements) for details.
>
> To use it in a playbook, specify: `kubernetes.core.k8s`.

- [Synopsis](k8s_inventory.md#synopsis)
- [Requirements](k8s_inventory.md#requirements)
- [Parameters](k8s_inventory.md#parameters)
- [Examples](k8s_inventory.md#examples)

## [Synopsis](k8s_inventory.md#id1)
...
## [Parameters](k8s_inventory.md#id3)
...
| **plugin**  string / required | token that ensures this is a source file for the ‘k8s’ plugin.  **Choices:**   - `"kubernetes.core.k8s"` - `"k8s"` - `"community.kubernetes.k8s"` |

## [Examples](k8s_inventory.md#id4)
