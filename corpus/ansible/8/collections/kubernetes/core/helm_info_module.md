...
source_url: https://docs.ansible.com/projects/ansible/8/collections/kubernetes/core/helm_info_module.html
fetched_at: 2026-07-28T02:40:04+00:00
---
...
| **get_all_values**  boolean  *added in kubernetes.core 2.4.0* | Set to `True` if you want to get all (computed) values of the release.  When `False` (default), only user supplied values are returned.  **Choices:**   - `false` ← (default) - `true` |
...
| **hooks**  list / elements=dictionary  *added in kubernetes.core 2.4.0* | Hooks of the release  **Returned:** always |
| **manifest**  list / elements=dictionary  *added in kubernetes.core 2.4.0* | Manifest of the release  **Returned:** always |
| **name**  string | Name of the release  **Returned:** always |
| **namespace**  string | Namespace where the release is deployed  **Returned:** always |
| **notes**  string  *added in kubernetes.core 2.4.0* | Notes of the release  **Returned:** always |
