...
source_url: https://docs.ansible.com/projects/ansible/8/collections/kubernetes/core/index.html
...
- [helm_pull module](helm_pull_module.md#ansible-collections-kubernetes-core-helm-pull-module) – download a chart from a repository and (optionally) unpack it in local directory.
...
- [k8s_config_resource_name filter](k8s_config_resource_name_filter.md#ansible-collections-kubernetes-core-k8s-config-resource-name-filter) – Generate resource name for the given resource of type ConfigMap, Secret
