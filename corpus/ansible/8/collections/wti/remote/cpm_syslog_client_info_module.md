...
collection: ansible
version: "8"
title: "wti.remote.cpm_syslog_client_info module – Get network SYSLOG Client parameters from WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/wti/remote/cpm_syslog_client_info_module.html
fetched_at: 2026-07-28T02:59:47+00:00
---
# wti.remote.cpm_syslog_client_info module – Get network SYSLOG Client parameters from WTI OOB and PDU devices
...
- [Synopsis](cpm_syslog_client_info_module.md#synopsis)
- [Parameters](cpm_syslog_client_info_module.md#parameters)
- [Notes](cpm_syslog_client_info_module.md#notes)
- [Examples](cpm_syslog_client_info_module.md#examples)
- [Return Values](cpm_syslog_client_info_module.md#return-values)

## [Synopsis](cpm_syslog_client_info_module.md#id1)

- Get network SYSLOG Client parameters from WTI OOB and PDU devices

## [Parameters](cpm_syslog_client_info_module.md#id2)
...
## [Notes](cpm_syslog_client_info_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_syslog_client_info_module.md#id4)
...
## [Return Values](cpm_syslog_client_info_module.md#id5)
