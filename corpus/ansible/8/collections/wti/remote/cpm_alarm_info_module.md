...
collection: ansible
version: "8"
title: "wti.remote.cpm_alarm_info module – Get alarm information from WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/wti/remote/cpm_alarm_info_module.html
fetched_at: 2026-07-28T02:59:29+00:00
---
# wti.remote.cpm_alarm_info module – Get alarm information from WTI OOB and PDU devices
...
- [Synopsis](cpm_alarm_info_module.md#synopsis)
- [Parameters](cpm_alarm_info_module.md#parameters)
- [Notes](cpm_alarm_info_module.md#notes)
- [Examples](cpm_alarm_info_module.md#examples)
- [Return Values](cpm_alarm_info_module.md#return-values)

## [Synopsis](cpm_alarm_info_module.md#id1)

- Get temperature alarm from WTI OOB and PDU devices

## [Parameters](cpm_alarm_info_module.md#id2)
...
## [Notes](cpm_alarm_info_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.)

## [Examples](cpm_alarm_info_module.md#id4)
...
## [Return Values](cpm_alarm_info_module.md#id5)
