...
collection: ansible
version: "8"
title: "wti.remote.cpm_syslog_client_config module – Set network SYSLOG Client parameters in WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/wti/remote/cpm_syslog_client_config_module.html
fetched_at: 2026-07-28T02:59:46+00:00
---
...
- [Synopsis](cpm_syslog_client_config_module.md#synopsis)
- [Parameters](cpm_syslog_client_config_module.md#parameters)
- [Notes](cpm_syslog_client_config_module.md#notes)
- [Examples](cpm_syslog_client_config_module.md#examples)
- [Return Values](cpm_syslog_client_config_module.md#return-values)

## [Synopsis](cpm_syslog_client_config_module.md#id1)

- Set network SYSLOG Client parameters in WTI OOB and PDU devices

## [Parameters](cpm_syslog_client_config_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **address**  list / elements=string | Sets the IP Address of the SYSLOG server to contact. |
...
| **index**  list / elements=integer | Index of the IP block being modified. |
| **port**  list / elements=integer | Defines the port number used by the SYSLOG Client (1 - 65535). |
| **protocol**  integer | The protocol that the SYSLOG entry should be applied. 0 = ipv4, 1 = ipv6.  **Choices:**   - `0` - `1` |
| **secure**  list / elements=integer | Defines if a secure connection is used by the SYSLOG Client (TCP Transport required). |
| **transport**  list / elements=integer | Defines the transfer protocol type used by the SYSLOG Client. 0=UDP, 1=TCP; |
...
## [Notes](cpm_syslog_client_config_module.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.

## [Examples](cpm_syslog_client_config_module.md#id4)
...
## [Return Values](cpm_syslog_client_config_module.md#id5)
