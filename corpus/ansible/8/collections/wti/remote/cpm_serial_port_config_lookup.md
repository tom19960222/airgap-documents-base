...
collection: ansible
version: "8"
title: "wti.remote.cpm_serial_port_config lookup – Set Serial port parameters in WTI OOB and PDU devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/wti/remote/cpm_serial_port_config_lookup.html
...
- [Synopsis](cpm_serial_port_config_lookup.md#synopsis)
- [Keyword parameters](cpm_serial_port_config_lookup.md#keyword-parameters)
- [Notes](cpm_serial_port_config_lookup.md#notes)
- [Examples](cpm_serial_port_config_lookup.md#examples)
- [Return Value](cpm_serial_port_config_lookup.md#return-value)

## [Synopsis](cpm_serial_port_config_lookup.md#id1)

- Set Serial port parameters in WTI OOB and PDU devices

## [Keyword parameters](cpm_serial_port_config_lookup.md#id2)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('wti.remote.cpm_serial_port_config', key1=value1, key2=value2, ...)` and `query('wti.remote.cpm_serial_port_config', key1=value1, key2=value2, ...)`
...
## [Notes](cpm_serial_port_config_lookup.md#id3)

> **Note:**
>
> - Use `groups/cpm` in `module_defaults` to set common options used between CPM modules.

## [Examples](cpm_serial_port_config_lookup.md#id4)
...
## [Return Value](cpm_serial_port_config_lookup.md#id5)
