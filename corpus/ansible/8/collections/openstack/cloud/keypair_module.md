...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/keypair_module.html
fetched_at: 2026-07-28T02:48:03+00:00
---
...
| Key | Description |
| --- | --- |
| **keypair**  dictionary | Dictionary describing the keypair.  **Returned:** On success when *state* is ‘present’ |
| **created_at**  string | Date the keypair was created  **Returned:** success |
| **fingerprint**  string | The short fingerprint associated with the public_key for this keypair.  **Returned:** success |
| **id**  string | Unique UUID.  **Returned:** success |
| **is_deleted**  boolean | Whether the keypair is deleted or not  **Returned:** success |
...
| **type**  string | The type of keypair  **Returned:** success |
| **user_id**  string | The user id for a keypair  **Returned:** success |
