...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/networks_info_module.html
fetched_at: 2026-07-28T02:48:17+00:00
---
...
| Key | Description |
| --- | --- |
| **networks**  list / elements=dictionary | has all the openstack information about the networks  **Returned:** always, but can be empty list |
