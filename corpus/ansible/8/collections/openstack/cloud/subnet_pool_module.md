...
collection: ansible
version: "8"
title: "openstack.cloud.subnet_pool module – Create, update or delete a subnet pool from OpenStack"
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/subnet_pool_module.html
fetched_at: 2026-07-28T02:48:59+00:00
---
...
| **default_prefix_length**  integer | The prefix length to allocate when the cidr or prefixlen attributes are omitted when creating a subnet. |
...
| **extra_specs**  dictionary | Dictionary with extra key/value pairs passed to the API. |
| **interface**  aliases: endpoint_type  string | Endpoint URL type to fetch from the service catalog.  **Choices:**   - `"admin"` - `"internal"` - `"public"` ← (default) |
| **is_default**  boolean | Whether this subnet pool is the default.  **Choices:**   - `false` - `true` |
| **is_shared**  aliases: shared  boolean | Whether this subnet pool is shared or not.  This attribute cannot be updated.  **Choices:**   - `false` - `true` |
...
| **name**  string / required | Name to be give to the subnet pool.  This attribute cannot be updated. |
| **prefixes**  list / elements=string | Subnet pool prefixes in CIDR notation. |
| **project**  string | Name or ID of the project. |
| **region_name**  string | Name of the region. |
| **sdk_log_level**  string | Log level of the OpenStackSDK  **Choices:**   - `"INFO"` ← (default) - `"DEBUG"` |
| **sdk_log_path**  string | Path to the logfile of the OpenStackSDK. If empty no log is written |
| **state**  string | Whether the subnet pool should be `present` or `absent`.  **Choices:**   - `"present"` ← (default) - `"absent"` |
...
| Key | Description |
| --- | --- |
| **subnet_pool**  dictionary | Dictionary describing the subnet pool.  **Returned:** On success when *state* is `present`. |
...
| **tenant_id**  string | The ID of the project. Deprecated.  **Returned:** success  **Sample:** `"861174b82b43463c9edc5202aadc60ef"` |
