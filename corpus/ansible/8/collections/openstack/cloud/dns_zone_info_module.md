...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/dns_zone_info_module.html
fetched_at: 2026-07-28T02:47:39+00:00
---
...
| Key | Description |
| --- | --- |
| **zones**  list / elements=dictionary | Dictionary describing the DNS zones.  **Returned:** On success when *state* is `present`. |
