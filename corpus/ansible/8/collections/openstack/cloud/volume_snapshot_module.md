...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/volume_snapshot_module.html
...
| **description**  aliases: display_description  string | String describing the snapshot |
...
| **name**  aliases: display_name  string / required | Name of the snapshot |
| **region_name**  string | Name of the region. |
| **sdk_log_level**  string | Log level of the OpenStackSDK  **Choices:**   - `"INFO"` ← (default) - `"DEBUG"` |
| **sdk_log_path**  string | Path to the logfile of the OpenStackSDK. If empty no log is written |
| **state**  string | Should the snapshot be `present` or `absent`.  **Choices:**   - `"present"` ← (default) - `"absent"` |
...
| Key | Description |
| --- | --- |
| **snapshot**  dictionary | Same as `volume_snapshot`, kept for backward compatibility.  **Returned:** On success when `state=present` |
| **volume_snapshot**  dictionary | The snapshot instance  **Returned:** success |
