...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/floating_ip_info_module.html
fetched_at: 2026-07-28T02:47:47+00:00
---
...
| **project**  aliases: project_id  string | The name or ID of the project a floating IP is associated with. |
| **region_name**  string | Name of the region. |
| **router**  string | The name or id of an associated router. |
| **sdk_log_level**  string | Log level of the OpenStackSDK  **Choices:**   - `"INFO"` ← (default) - `"DEBUG"` |
| **sdk_log_path**  string | Path to the logfile of the OpenStackSDK. If empty no log is written |
| **status**  string | The status of a floating IP.  **Choices:**   - `"active"` - `"down"` |
...
| Key | Description |
| --- | --- |
| **floating_ips**  list / elements=dictionary | The floating ip objects list.  **Returned:** success |
