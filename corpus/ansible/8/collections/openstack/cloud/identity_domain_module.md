...
collection: ansible
version: "8"
title: "openstack.cloud.identity_domain module – Manage OpenStack identity (Keystone) domains"
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/identity_domain_module.html
fetched_at: 2026-07-28T02:47:51+00:00
---
# openstack.cloud.identity_domain module – Manage OpenStack identity (Keystone) domains
...
| **is_enabled**  aliases: enabled  boolean | Whether this domain is enabled or not.  **Choices:**   - `false` - `true` |
...
| Key | Description |
| --- | --- |
| **domain**  dictionary | Dictionary describing the domain.  **Returned:** On success when *state* is `present`. |
...
| **is_enabled**  boolean | Domain description.  **Returned:** success  **Sample:** `true` |
| **links**  list / elements=string | The links related to the domain resource  **Returned:** success |
