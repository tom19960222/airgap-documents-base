...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/stack_module.html
fetched_at: 2026-07-28T02:48:54+00:00
---
...
| **tags**  aliases: tag  string | One or more simple string tags to associate with the stack.  To associate multiple tags with a stack, separate the tags with commas. For example, `tag1,tag2`. |
...
| Key | Description |
| --- | --- |
| **stack**  dictionary | stack info  **Returned:** always |
