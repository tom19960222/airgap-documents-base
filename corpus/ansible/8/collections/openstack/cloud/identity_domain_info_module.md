...
collection: ansible
version: "8"
title: "openstack.cloud.identity_domain_info module – Fetch identity (Keystone) domains from OpenStack cloud"
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/identity_domain_info_module.html
fetched_at: 2026-07-28T02:47:52+00:00
---
# openstack.cloud.identity_domain_info module – Fetch identity (Keystone) domains from OpenStack cloud
...
| Key | Description |
| --- | --- |
| **domains**  list / elements=dictionary | List of dictionaries describing OpenStack domains  **Returned:** always |
| **description**  string | Description of the domain.  **Returned:** success |
| **id**  string | Unique UUID.  **Returned:** success |
| **is_enabled**  boolean | Flag to indicate if the domain is enabled.  **Returned:** success |
