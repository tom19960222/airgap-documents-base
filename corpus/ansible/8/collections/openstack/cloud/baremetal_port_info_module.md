...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/baremetal_port_info_module.html
fetched_at: 2026-07-28T02:47:28+00:00
---
...
| **name**  aliases: uuid  string | Name or ID of the Bare Metal port. |
...
| Key | Description |
| --- | --- |
| **ports**  list / elements=dictionary | Bare Metal port list.  **Returned:** always |
