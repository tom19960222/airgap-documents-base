...
source_url: https://docs.ansible.com/projects/ansible/8/collections/openstack/cloud/baremetal_node_info_module.html
fetched_at: 2026-07-28T02:47:26+00:00
---
...
| **name**  aliases: node  string | Name or ID of the baremetal node. |
...
| Key | Description |
| --- | --- |
| **baremetal_nodes**  list / elements=dictionary | Same as `nodes`, kept for backward compatibility.  **Returned:** always |
| **nodes**  list / elements=dictionary | Bare Metal node list. A subset of the dictionary keys listed below may be returned, depending on your cloud provider.  **Returned:** always |
