...
collection: ansible
version: "8"
title: "Setting list option values guide"
source_url: https://docs.ansible.com/projects/ansible/8/collections/microsoft/ad/docsite/guide_list_values.html
fetched_at: 2026-07-28T02:40:46+00:00
---
...
- [Add, remove, and set](guide_list_values.md#add-remove-and-set)
- [Examples](guide_list_values.md#examples)

## [Add, remove, and set](guide_list_values.md#id1)
...
## [Examples](guide_list_values.md#id2)

The `add`, `remove`, and `set` options are subkeys of the module option it controls. For example the [microsoft.ad.user](../user_module.md#ansible-collections-microsoft-ad-user-module) has an option called `groups` which control the list of groups the user is a member of. To add a group to the user, simply use the `add` key like so:
