...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_block_storage_info module – Get information about the Vultr block storage volumes available."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_block_storage_info_module.html
fetched_at: 2026-07-28T02:46:51+00:00
---
# ngine_io.vultr.vultr_block_storage_info module – Get information about the Vultr block storage volumes available.
...
> see [Requirements](vultr_block_storage_info_module.md#ansible-collections-ngine-io-vultr-vultr-block-storage-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_block_storage_info`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_block_storage_info_module.md#synopsis)
- [Requirements](vultr_block_storage_info_module.md#requirements)
- [Parameters](vultr_block_storage_info_module.md#parameters)
- [Notes](vultr_block_storage_info_module.md#notes)
- [Examples](vultr_block_storage_info_module.md#examples)
- [Return Values](vultr_block_storage_info_module.md#return-values)

## [Synopsis](vultr_block_storage_info_module.md#id1)

- Get infos about block storage volumes available in Vultr.

Aliases: vultr_block_storage_facts

## [Requirements](vultr_block_storage_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_block_storage_info_module.md#id3)
...
## [Notes](vultr_block_storage_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_block_storage_info_module.md#id5)
...
## [Return Values](vultr_block_storage_info_module.md#id6)
...
| **vultr_block_storage_info**  complex | Response from Vultr API as list  **Returned:** success |
| **attached_to_id**  string | Block storage is attached to this server ID.  **Returned:** success |
| **cost_per_month**  float | Cost per month of the block storage.  **Returned:** success  **Sample:** `1.0` |
| **date_created**  string | Date created of the block storage.  **Returned:** success  **Sample:** `"2018-07-24 12:59:59"` |
| **id**  integer | ID of the block storage.  **Returned:** success  **Sample:** `17332323` |
| **name**  string | Name of the block storage.  **Returned:** success  **Sample:** `"my volume"` |
| **region**  string | Region the block storage is located in.  **Returned:** success  **Sample:** `"New Jersey"` |
| **size**  integer | Size in GB of the block storage.  **Returned:** success  **Sample:** `10` |
| **status**  string | Status of the block storage.  **Returned:** success  **Sample:** `"active"` |
