...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_region_info module – Gather information about the Vultr regions available."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_region_info_module.html
fetched_at: 2026-07-28T02:47:08+00:00
---
# ngine_io.vultr.vultr_region_info module – Gather information about the Vultr regions available.
...
> see [Requirements](vultr_region_info_module.md#ansible-collections-ngine-io-vultr-vultr-region-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_region_info`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_region_info_module.md#synopsis)
- [Requirements](vultr_region_info_module.md#requirements)
- [Parameters](vultr_region_info_module.md#parameters)
- [Notes](vultr_region_info_module.md#notes)
- [Examples](vultr_region_info_module.md#examples)
- [Return Values](vultr_region_info_module.md#return-values)

## [Synopsis](vultr_region_info_module.md#id1)

- Gather information about regions available to boot servers.

Aliases: vultr_region_facts

## [Requirements](vultr_region_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_region_info_module.md#id3)
...
## [Notes](vultr_region_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_region_info_module.md#id5)
...
## [Return Values](vultr_region_info_module.md#id6)
