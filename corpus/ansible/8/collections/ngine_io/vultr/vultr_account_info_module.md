...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_account_info module – Get information about the Vultr account."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_account_info_module.html
fetched_at: 2026-07-28T02:46:49+00:00
---
...
> see [Requirements](vultr_account_info_module.md#ansible-collections-ngine-io-vultr-vultr-account-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_account_info`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_account_info_module.md#synopsis)
- [Requirements](vultr_account_info_module.md#requirements)
- [Parameters](vultr_account_info_module.md#parameters)
- [Notes](vultr_account_info_module.md#notes)
- [Examples](vultr_account_info_module.md#examples)
- [Return Values](vultr_account_info_module.md#return-values)

## [Synopsis](vultr_account_info_module.md#id1)

- Get infos about account balance, charges and payments.

Aliases: vr_account_facts, vultr_account_facts

## [Requirements](vultr_account_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_account_info_module.md#id3)
...
## [Notes](vultr_account_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_account_info_module.md#id5)
...
## [Return Values](vultr_account_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **vultr_account_info**  complex | Response from Vultr API  **Returned:** success |
...
| **last_payment_date**  string | Date of the last payment.  **Returned:** success  **Sample:** `"2017-08-26 12:47:48"` |
