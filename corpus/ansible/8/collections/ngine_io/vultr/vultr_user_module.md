...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_user module – Manages users on Vultr."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_user_module.html
fetched_at: 2026-07-28T02:47:17+00:00
---
...
> see [Requirements](vultr_user_module.md#ansible-collections-ngine-io-vultr-vultr-user-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_user`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_user_module.md#synopsis)
- [Requirements](vultr_user_module.md#requirements)
- [Parameters](vultr_user_module.md#parameters)
- [Notes](vultr_user_module.md#notes)
- [Examples](vultr_user_module.md#examples)
- [Return Values](vultr_user_module.md#return-values)

## [Synopsis](vultr_user_module.md#id1)

- Create, update and remove users.

Aliases: vr_user

## [Requirements](vultr_user_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_user_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **acls**  aliases: acl  list / elements=string | List of ACLs this users should have, see <https://www.vultr.com/api/#user_user_list>.  Required if `state=present`.  One or more of the choices list, some depend on each other.  **Choices:**   - `"manage_users"` - `"subscriptions"` - `"provisioning"` - `"billing"` - `"support"` - `"abuse"` - `"dns"` - `"upgrade"` |
...
## [Notes](vultr_user_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_user_module.md#id5)
...
## [Return Values](vultr_user_module.md#id6)
...
| **vultr_user**  complex | Response from Vultr API  **Returned:** success |
