...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_firewall_group_info module – Gather information about the Vultr firewall groups available."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_firewall_group_info_module.html
fetched_at: 2026-07-28T02:46:56+00:00
---
# ngine_io.vultr.vultr_firewall_group_info module – Gather information about the Vultr firewall groups available.
...
> see [Requirements](vultr_firewall_group_info_module.md#ansible-collections-ngine-io-vultr-vultr-firewall-group-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_firewall_group_info`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_firewall_group_info_module.md#synopsis)
- [Requirements](vultr_firewall_group_info_module.md#requirements)
- [Parameters](vultr_firewall_group_info_module.md#parameters)
- [Notes](vultr_firewall_group_info_module.md#notes)
- [Examples](vultr_firewall_group_info_module.md#examples)
- [Return Values](vultr_firewall_group_info_module.md#return-values)

## [Synopsis](vultr_firewall_group_info_module.md#id1)

- Gather information about firewall groups available in Vultr.

Aliases: vultr_firewall_group_facts

## [Requirements](vultr_firewall_group_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_firewall_group_info_module.md#id3)
...
## [Notes](vultr_firewall_group_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_firewall_group_info_module.md#id5)
...
## [Return Values](vultr_firewall_group_info_module.md#id6)
...
| **vultr_firewall_group_info**  complex | Response from Vultr API  **Returned:** success |
| **date_created**  string | Date the firewall group was created  **Returned:** success  **Sample:** `"2017-08-26 12:47:48"` |
| **date_modified**  string | Date the firewall group was modified  **Returned:** success  **Sample:** `"2017-08-26 12:47:48"` |
| **description**  string | Name of the firewall group  **Returned:** success  **Sample:** `"my firewall group"` |
| **id**  string | ID of the firewall group  **Returned:** success  **Sample:** `"1234abcd"` |
