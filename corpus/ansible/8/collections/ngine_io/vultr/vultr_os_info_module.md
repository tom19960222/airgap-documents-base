...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_os_info module – Get information about the Vultr OSes available."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_os_info_module.html
fetched_at: 2026-07-28T02:47:02+00:00
---
# ngine_io.vultr.vultr_os_info module – Get information about the Vultr OSes available.
...
> see [Requirements](vultr_os_info_module.md#ansible-collections-ngine-io-vultr-vultr-os-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_os_info`.

New in ngine_io.vultr 0.1.0

- [Synopsis](vultr_os_info_module.md#synopsis)
- [Requirements](vultr_os_info_module.md#requirements)
- [Parameters](vultr_os_info_module.md#parameters)
- [Notes](vultr_os_info_module.md#notes)
- [Examples](vultr_os_info_module.md#examples)
- [Return Values](vultr_os_info_module.md#return-values)

## [Synopsis](vultr_os_info_module.md#id1)

- Get infos about OSes available to boot servers.

Aliases: vultr_os_facts

## [Requirements](vultr_os_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_os_info_module.md#id3)
...
## [Notes](vultr_os_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_os_info_module.md#id5)
...
## [Return Values](vultr_os_info_module.md#id6)
...
| **vultr_os_info**  complex | Response from Vultr API as list  **Returned:** available |
