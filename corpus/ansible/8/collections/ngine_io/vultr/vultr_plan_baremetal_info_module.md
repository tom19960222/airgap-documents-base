...
collection: ansible
version: "8"
title: "ngine_io.vultr.vultr_plan_baremetal_info module – Gather information about the Vultr Bare Metal plans available."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/vultr/vultr_plan_baremetal_info_module.html
fetched_at: 2026-07-28T02:47:05+00:00
---
...
> see [Requirements](vultr_plan_baremetal_info_module.md#ansible-collections-ngine-io-vultr-vultr-plan-baremetal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.vultr.vultr_plan_baremetal_info`.

New in ngine_io.vultr 0.3.0

- [Synopsis](vultr_plan_baremetal_info_module.md#synopsis)
- [Requirements](vultr_plan_baremetal_info_module.md#requirements)
- [Parameters](vultr_plan_baremetal_info_module.md#parameters)
- [Notes](vultr_plan_baremetal_info_module.md#notes)
- [Examples](vultr_plan_baremetal_info_module.md#examples)
- [Return Values](vultr_plan_baremetal_info_module.md#return-values)

## [Synopsis](vultr_plan_baremetal_info_module.md#id1)

- Gather information about Bare Metal plans available to boot servers.

## [Requirements](vultr_plan_baremetal_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.6

## [Parameters](vultr_plan_baremetal_info_module.md#id3)
...
## [Notes](vultr_plan_baremetal_info_module.md#id4)

> **Note:**
>
> - Also see the API documentation on <https://www.vultr.com/api/>.

## [Examples](vultr_plan_baremetal_info_module.md#id5)
...
## [Return Values](vultr_plan_baremetal_info_module.md#id6)
...
| **vultr_plan_baremetal_info**  complex | Response from Vultr API  **Returned:** success |
| **plan**  list / elements=string | List of the Bare Metal plans available.  **Returned:** success  **Sample:** `[{"available_locations": [1], "bandwidth": 40.0, "bandwidth_gb": 40960, "disk": 110, "id": 118, "name": "32768 MB RAM,110 GB SSD,40.00 TB BW", "plan_type": "DEDICATED", "price_per_month": 240.0, "ram": 32768, "vcpu_count": 8, "windows": false}]` |
