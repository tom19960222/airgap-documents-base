...
collection: ansible
version: "8"
title: "ngine_io.cloudstack.cs_zone_info module – Gathering information about zones from Apache CloudStack based clouds."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/cloudstack/cs_zone_info_module.html
fetched_at: 2026-07-28T02:46:43+00:00
---
# ngine_io.cloudstack.cs_zone_info module – Gathering information about zones from Apache CloudStack based clouds.
...
> see [Requirements](cs_zone_info_module.md#ansible-collections-ngine-io-cloudstack-cs-zone-info-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.cloudstack.cs_zone_info`.

New in ngine_io.cloudstack 0.1.0

- [Synopsis](cs_zone_info_module.md#synopsis)
- [Requirements](cs_zone_info_module.md#requirements)
- [Parameters](cs_zone_info_module.md#parameters)
- [Notes](cs_zone_info_module.md#notes)
- [Examples](cs_zone_info_module.md#examples)
- [Return Values](cs_zone_info_module.md#return-values)

## [Synopsis](cs_zone_info_module.md#id1)

- Gathering information from the API of a zone.

Aliases: cs_zone_facts

## [Requirements](cs_zone_info_module.md#id2)
...
## [Parameters](cs_zone_info_module.md#id3)
...
| **zone**  aliases: name  string | Name of the zone.  If not specified information about all zones is gathered. |

## [Notes](cs_zone_info_module.md#id4)
...
## [Examples](cs_zone_info_module.md#id5)
...
## [Return Values](cs_zone_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **zones**  list / elements=string | A list of matching zones.  **Returned:** success |
