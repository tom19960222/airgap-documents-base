...
collection: ansible
version: "8"
title: "ngine_io.cloudstack.cs_vpn_gateway module – Manages site-to-site VPN gateways on Apache CloudStack based clouds."
source_url: https://docs.ansible.com/projects/ansible/8/collections/ngine_io/cloudstack/cs_vpn_gateway_module.html
fetched_at: 2026-07-28T02:46:42+00:00
---
# ngine_io.cloudstack.cs_vpn_gateway module – Manages site-to-site VPN gateways on Apache CloudStack based clouds.
...
> see [Requirements](cs_vpn_gateway_module.md#ansible-collections-ngine-io-cloudstack-cs-vpn-gateway-module-requirements) for details.
>
> To use it in a playbook, specify: `ngine_io.cloudstack.cs_vpn_gateway`.

New in ngine_io.cloudstack 0.1.0

- [Synopsis](cs_vpn_gateway_module.md#synopsis)
- [Requirements](cs_vpn_gateway_module.md#requirements)
- [Parameters](cs_vpn_gateway_module.md#parameters)
- [Notes](cs_vpn_gateway_module.md#notes)
- [Examples](cs_vpn_gateway_module.md#examples)
- [Return Values](cs_vpn_gateway_module.md#return-values)

## [Synopsis](cs_vpn_gateway_module.md#id1)

- Creates and removes VPN site-to-site gateways.

## [Requirements](cs_vpn_gateway_module.md#id2)
...
## [Parameters](cs_vpn_gateway_module.md#id3)
...
| **state**  string | State of the VPN gateway.  **Choices:**   - `"present"` ← (default) - `"absent"` |
| **vpc**  string / required | Name of the VPC. |
| **zone**  string / required | Name of the zone the VPC is related to. |

## [Notes](cs_vpn_gateway_module.md#id4)
...
## [Examples](cs_vpn_gateway_module.md#id5)
...
## [Return Values](cs_vpn_gateway_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **account**  string | Account the VPN site-to-site gateway is related to.  **Returned:** success  **Sample:** `"example account"` |
| **domain**  string | Domain the VPN site-to-site gateway is related to.  **Returned:** success  **Sample:** `"example domain"` |
| **id**  string | UUID of the VPN site-to-site gateway.  **Returned:** success  **Sample:** `"04589590-ac63-4ffc-93f5-b698b8ac38b6"` |
| **project**  string | Name of project the VPN site-to-site gateway is related to.  **Returned:** success  **Sample:** `"Production"` |
| **public_ip**  string | IP address of the VPN site-to-site gateway.  **Returned:** success  **Sample:** `"10.100.212.10"` |
| **vpc**  string | Name of the VPC.  **Returned:** success  **Sample:** `"My VPC"` |
