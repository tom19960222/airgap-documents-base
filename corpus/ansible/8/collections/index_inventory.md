...
source_url: https://docs.ansible.com/projects/ansible/8/collections/index_inventory.html
...
- [amazon.aws.aws_rds](amazon/aws/aws_rds_inventory.md#ansible-collections-amazon-aws-aws-rds-inventory) – RDS instance inventory source
...
- [community.aws.aws_mq](community/aws/aws_mq_inventory.md#ansible-collections-community-aws-aws-mq-inventory) – MQ broker inventory source
...
- [dellemc.openmanage.ome_inventory](dellemc/openmanage/ome_inventory_inventory.md#ansible-collections-dellemc-openmanage-ome-inventory-inventory) – Group inventory plugin on OpenManage Enterprise.
...
- [microsoft.ad.ldap](microsoft/ad/ldap_inventory.md#ansible-collections-microsoft-ad-ldap-inventory) – Inventory plugin for Active Directory
...
- [telekom_mms.icinga_director.icinga_director_inventory](telekom_mms/icinga_director/icinga_director_inventory_inventory.md#ansible-collections-telekom-mms-icinga-director-icinga-director-inventory-inventory) – Returns Ansible inventory from Icinga
...
- [vultr.cloud.vultr](vultr/cloud/vultr_inventory.md#ansible-collections-vultr-cloud-vultr-inventory) – Retrieves list of instances via Vultr v2 API
