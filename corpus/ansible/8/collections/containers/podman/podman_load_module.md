...
collection: ansible
version: "8"
title: "containers.podman.podman_load module – Load image from a tar file."
source_url: https://docs.ansible.com/projects/ansible/8/collections/containers/podman/podman_load_module.html
...
> see [Requirements](podman_load_module.md#ansible-collections-containers-podman-podman-load-module-requirements) for details.
>
> To use it in a playbook, specify: `containers.podman.podman_load`.

- [Synopsis](podman_load_module.md#synopsis)
- [Requirements](podman_load_module.md#requirements)
- [Parameters](podman_load_module.md#parameters)
- [Examples](podman_load_module.md#examples)
- [Return Values](podman_load_module.md#return-values)

## [Synopsis](podman_load_module.md#id1)
...
## [Requirements](podman_load_module.md#id2)

The below requirements are needed on the host that executes this module.

- Podman installed on host

## [Parameters](podman_load_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **executable**  string | Path to `podman` executable if it is not in the `$PATH` on the machine running `podman`  **Default:** `"podman"` |
| **input**  aliases: path  string / required | Path to image file to load. |

## [Examples](podman_load_module.md#id4)
...
## [Return Values](podman_load_module.md#id5)
