...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/nxos/nxos_l2_interfaces_module.html
fetched_at: 2026-07-28T01:38:47+00:00
---
...
| **mode**  string | Mode in which interface needs to be configured.  Access mode is not shown in interface facts, so idempotency will not be maintained for switchport mode access and every time the output will come as changed=True.  **Choices:**   - `"dot1q-tunnel"` - `"access"` - `"trunk"` - `"fex-fabric"` - `"fabricpath"` |
