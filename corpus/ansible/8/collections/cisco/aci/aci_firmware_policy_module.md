...
collection: ansible
version: "8"
title: "cisco.aci.aci_firmware_policy module – Manage firmware policies (firmware:FwP)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_firmware_policy_module.html
fetched_at: 2026-07-28T01:19:51+00:00
---
...
| **description**  aliases: descr  string | Description for the firmware policy. |
| **effective_on_reboot**  boolean | A property that indicates if the selected firmware version will be active after reboot.  The firmware must be effective on an unplanned reboot before the scheduled maintenance operation.  **Choices:**   - `false` - `true` |
...
| **ignore_compat**  aliases: ignoreCompat  boolean | Check if compatibility checks should be ignored  **Choices:**   - `false` - `true` |
