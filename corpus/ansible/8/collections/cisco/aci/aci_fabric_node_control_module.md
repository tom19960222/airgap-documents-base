...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_node_control module – Manage Fabric Node Controls (fabric:NodeControl)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_node_control_module.html
fetched_at: 2026-07-28T01:19:37+00:00
---
# cisco.aci.aci_fabric_node_control module – Manage Fabric Node Controls (fabric:NodeControl)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_node_control`.

- [Synopsis](aci_fabric_node_control_module.md#synopsis)
- [Parameters](aci_fabric_node_control_module.md#parameters)
- [See Also](aci_fabric_node_control_module.md#see-also)
- [Examples](aci_fabric_node_control_module.md#examples)
- [Return Values](aci_fabric_node_control_module.md#return-values)

## [Synopsis](aci_fabric_node_control_module.md#id1)

- Manage Fabric Node Controls on ACI fabrics.

## [Parameters](aci_fabric_node_control_module.md#id2)
...
| **enable_dom**  boolean | Whether to enable digital optical monitoring (DOM) for the fabric node control.  The APIC defaults to `false` when unset during creation.  **Choices:**   - `false` - `true` |
| **feature_selection**  aliases: feature  string | The feature selection for the Node Control.  The APIC defaults to `telemetry` when unset during creation.  **Choices:**   - `"analytics"` - `"netflow"` - `"telemetry"` |
...
| **name**  aliases: fabric_node_control  string | The name of the Fabric Node Control. |
...
## [See Also](aci_fabric_node_control_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabric:NodeControl**.
>
...
## [Examples](aci_fabric_node_control_module.md#id4)
...
## [Return Values](aci_fabric_node_control_module.md#id5)
