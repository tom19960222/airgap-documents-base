...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_community_term module – Manage Match Community Term (rtctrl:MatchCommTerm)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_community_term_module.html
fetched_at: 2026-07-28T01:20:31+00:00
---
# cisco.aci.aci_match_community_term module – Manage Match Community Term (rtctrl:MatchCommTerm)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_match_community_term`.

- [Synopsis](aci_match_community_term_module.md#synopsis)
- [Parameters](aci_match_community_term_module.md#parameters)
- [Notes](aci_match_community_term_module.md#notes)
- [See Also](aci_match_community_term_module.md#see-also)
- [Examples](aci_match_community_term_module.md#examples)
- [Return Values](aci_match_community_term_module.md#return-values)

## [Synopsis](aci_match_community_term_module.md#id1)

- Manage Match Term Based on Community for Match Rule Profiles on Cisco ACI fabrics.

## [Parameters](aci_match_community_term_module.md#id2)
...
| **description**  aliases: descr  string | The description for the Match Community Term. |
...
| **match_community_term**  aliases: name, match_community_term_name  string | the name of the Match Community Term. |
...
## [Notes](aci_match_community_term_module.md#id3)
...
## [See Also](aci_match_community_term_module.md#id4)
...
> :   More information about the internal APIC class **rtctrl:MatchCommTerm**.
>
...
## [Examples](aci_match_community_term_module.md#id5)
...
## [Return Values](aci_match_community_term_module.md#id6)
