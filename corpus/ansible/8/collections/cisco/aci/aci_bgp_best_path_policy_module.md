...
collection: ansible
version: "8"
title: "cisco.aci.aci_bgp_best_path_policy module – Manage BGP Best Path policy (bgp:BestPathCtrlPol)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_bgp_best_path_policy_module.html
fetched_at: 2026-07-28T01:18:57+00:00
---
# cisco.aci.aci_bgp_best_path_policy module – Manage BGP Best Path policy (bgp:BestPathCtrlPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_bgp_best_path_policy`.

- [Synopsis](aci_bgp_best_path_policy_module.md#synopsis)
- [Parameters](aci_bgp_best_path_policy_module.md#parameters)
- [Notes](aci_bgp_best_path_policy_module.md#notes)
- [See Also](aci_bgp_best_path_policy_module.md#see-also)
- [Examples](aci_bgp_best_path_policy_module.md#examples)
- [Return Values](aci_bgp_best_path_policy_module.md#return-values)

## [Synopsis](aci_bgp_best_path_policy_module.md#id1)

- Manage BGP Best Path policies for Tenants on Cisco ACI fabrics.

## [Parameters](aci_bgp_best_path_policy_module.md#id2)
...
| **best_path_control**  aliases: as_path_control  string | The option to enable/disable to relax AS-Path restriction when choosing multipaths.  When enabled, allow load sharing across providers with different AS paths.  The APIC defaults to `enable` when unset during creation.  **Choices:**   - `"enable"` - `"disable"` |
| **bgp_best_path_policy**  aliases: bgp_best_path_policy_name, name  string | The name of the best path policy. |
...
## [Notes](aci_bgp_best_path_policy_module.md#id3)
...
## [See Also](aci_bgp_best_path_policy_module.md#id4)
...
> :   More information about the internal APIC class **bgp:BestPathCtrlPol**.
>
...
## [Examples](aci_bgp_best_path_policy_module.md#id5)
...
## [Return Values](aci_bgp_best_path_policy_module.md#id6)
