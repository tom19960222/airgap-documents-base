...
collection: ansible
version: "8"
title: "cisco.aci.aci_access_span_filter_group_entry module – Manage Access SPAN filter group entries (span:FilterEntry)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_span_filter_group_entry_module.html
fetched_at: 2026-07-28T01:18:47+00:00
---
...
- [Synopsis](aci_access_span_filter_group_entry_module.md#synopsis)
- [Parameters](aci_access_span_filter_group_entry_module.md#parameters)
- [Notes](aci_access_span_filter_group_entry_module.md#notes)
- [See Also](aci_access_span_filter_group_entry_module.md#see-also)
- [Examples](aci_access_span_filter_group_entry_module.md#examples)
- [Return Values](aci_access_span_filter_group_entry_module.md#return-values)

## [Synopsis](aci_access_span_filter_group_entry_module.md#id1)

- Manage Access SPAN filter group entries on Cisco ACI fabrics.

## [Parameters](aci_access_span_filter_group_entry_module.md#id2)
...
| **ip_protocol**  string | The IP Protocol.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"eigrp"` - `"egp"` - `"icmp"` - `"icmpv6"` - `"igmp"` - `"igp"` - `"l2tp"` - `"ospfigp"` - `"pim"` - `"tcp"` - `"udp"` - `"unspecified"` |
...
## [Notes](aci_access_span_filter_group_entry_module.md#id3)

> **Note:**
>
> - The `filter_group` used must exist before using this module in your playbook. The [cisco.aci.aci_access_span_filter_group](aci_access_span_filter_group_module.md#ansible-collections-cisco-aci-aci-access-span-filter-group-module) module can be used for this.

## [See Also](aci_access_span_filter_group_entry_module.md#id4)
...
## [Examples](aci_access_span_filter_group_entry_module.md#id5)
...
## [Return Values](aci_access_span_filter_group_entry_module.md#id6)
