...
collection: ansible
version: "8"
title: "cisco.aci.aci_config_export_policy module – Manage Configuration Export Policy (config:ExportP)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_config_export_policy_module.html
fetched_at: 2026-07-28T01:19:11+00:00
---
# cisco.aci.aci_config_export_policy module – Manage Configuration Export Policy (config:ExportP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_config_export_policy`.

- [Synopsis](aci_config_export_policy_module.md#synopsis)
- [Parameters](aci_config_export_policy_module.md#parameters)
- [See Also](aci_config_export_policy_module.md#see-also)
- [Examples](aci_config_export_policy_module.md#examples)
- [Return Values](aci_config_export_policy_module.md#return-values)

## [Synopsis](aci_config_export_policy_module.md#id1)

- Manage Configuration Export Policies on Cisco ACI fabrics.

## [Parameters](aci_config_export_policy_module.md#id2)
...
| **format**  string | The format of the export file.  This defaults to json on the APIC when unset on creation.  **Choices:**   - `"json"` - `"xml"` |
...
| **snapshot**  boolean | Enables a snapshot of the configuration export policy.  This defaults to False on the APIC when unset on creation.  **Choices:**   - `false` - `true` |
| **start_now**  boolean | Specifies if the configuration export policy should be applied now or at another time.  This defaults to False on the APIC when unset on creation.  **Choices:**   - `false` - `true` |
...
## [See Also](aci_config_export_policy_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **config:ExportP**.
>
...
## [Examples](aci_config_export_policy_module.md#id4)
...
## [Return Values](aci_config_export_policy_module.md#id5)
