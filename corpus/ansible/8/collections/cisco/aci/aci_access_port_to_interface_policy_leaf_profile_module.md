...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_port_to_interface_policy_leaf_profile_module.html
fetched_at: 2026-07-28T01:18:45+00:00
---
...
| **fex_id**  integer | Id of the fex profile, a valid FEX ID is between 101 to 199. |
| **fex_profile**  aliases: fex_profile_name  string | The name of the Fex Profile. Value of the fex_profile is overridden by the policy_group. |
...
| **interface_type**  string | The type of interface for the static EPG deployment.  The interface_type fex_profile can not be configured with a profile of type fex.  **Choices:**   - `"breakout"` - `"fex"` - `"port_channel"` - `"switch_port"` ← (default) - `"vpc"` - `"fex_port_channel"` - `"fex_vpc"` - `"fex_profile"` |
...
| **type**  aliases: profile_type  string | The type of access port to be created under respective profile.  **Choices:**   - `"fex"` - `"leaf"` ← (default) |
