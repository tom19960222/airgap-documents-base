...
collection: ansible
version: "8"
title: "cisco.aci.aci_access_span_filter_group module – Manage Access SPAN filter groups (span:FilterGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_span_filter_group_module.html
fetched_at: 2026-07-28T01:18:46+00:00
---
# cisco.aci.aci_access_span_filter_group module – Manage Access SPAN filter groups (span:FilterGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_access_span_filter_group`.

- [Synopsis](aci_access_span_filter_group_module.md#synopsis)
- [Parameters](aci_access_span_filter_group_module.md#parameters)
- [See Also](aci_access_span_filter_group_module.md#see-also)
- [Examples](aci_access_span_filter_group_module.md#examples)
- [Return Values](aci_access_span_filter_group_module.md#return-values)

## [Synopsis](aci_access_span_filter_group_module.md#id1)

- Manage Access SPAN filter groups on Cisco ACI fabrics.

## [Parameters](aci_access_span_filter_group_module.md#id2)
...
| **filter_group**  aliases: name  string | The name of the Access SPAN filter group. |
...
## [See Also](aci_access_span_filter_group_module.md#id3)
...
## [Examples](aci_access_span_filter_group_module.md#id4)
...
## [Return Values](aci_access_span_filter_group_module.md#id5)
