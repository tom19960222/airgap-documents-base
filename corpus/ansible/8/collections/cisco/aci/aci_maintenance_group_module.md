...
collection: ansible
version: "8"
title: "cisco.aci.aci_maintenance_group module – This creates an ACI maintenance group (maint:MaintGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_maintenance_group_module.html
fetched_at: 2026-07-28T01:20:26+00:00
---
# cisco.aci.aci_maintenance_group module – This creates an ACI maintenance group (maint:MaintGrp)
...
| **description**  aliases: descr  string | Description of the maintenance group. |
| **firmware_nodes_type**  string | The firmware type of nodes in the maintenance group.  The APIC defaults to `switch` when unset during creation.  **Choices:**   - `"c_apic_patch"` - `"catalog"` - `"config"` - `"controller"` - `"controller_patch"` - `"plugin"` - `"plugin_package"` - `"switch"` - `"switch_patch"` - `"vpod"` |
...
| **policy**  aliases: maintenancepol  string | The name of the maintenance policy. |
...
| **type_group**  string | The type of the maintenance group.  The APIC defaults to `range` when unset during creation.  **Choices:**   - `"all"` - `"all_in_pod"` - `"range"` |
...
> **Note:**
>
> - The `policy` used must exist before using this module in your playbook.
> - The [cisco.aci.aci_maintenance_policy](aci_maintenance_policy_module.md#ansible-collections-cisco-aci-aci-maintenance-policy-module) module can be used for this.

## [See Also](aci_maintenance_group_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_maintenance_policy](aci_maintenance_policy_module.md#ansible-collections-cisco-aci-aci-maintenance-policy-module)
> :   Manage firmware maintenance policies (maint:MaintP).
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **maint:MaintGrp**.
>
