...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_config_snapshot_module.html
...
| **include_secure**  boolean | Determines if secure information should be included in the backup.  The APIC defaults to `true` when unset.  **Choices:**   - `false` - `true` |
