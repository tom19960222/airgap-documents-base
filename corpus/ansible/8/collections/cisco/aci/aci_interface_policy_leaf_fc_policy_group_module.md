...
collection: ansible
version: "8"
title: "cisco.aci.aci_interface_policy_leaf_fc_policy_group module – Manage Fibre Channel (FC) interface policy groups (infra:FcAccBndlGrp, infra:FcAccPortGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_leaf_fc_policy_group_module.html
fetched_at: 2026-07-28T01:19:59+00:00
---
...
- [Synopsis](aci_interface_policy_leaf_fc_policy_group_module.md#synopsis)
- [Parameters](aci_interface_policy_leaf_fc_policy_group_module.md#parameters)
- [Notes](aci_interface_policy_leaf_fc_policy_group_module.md#notes)
- [See Also](aci_interface_policy_leaf_fc_policy_group_module.md#see-also)
- [Examples](aci_interface_policy_leaf_fc_policy_group_module.md#examples)
- [Return Values](aci_interface_policy_leaf_fc_policy_group_module.md#return-values)

## [Synopsis](aci_interface_policy_leaf_fc_policy_group_module.md#id1)

- Manage Fibre Channel (FC) interface policy groups on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_leaf_fc_policy_group_module.md#id2)
...
| **attached_entity_profile**  aliases: aep_name, aep  string | The name of the attached entity profile (AEP) used by the Fibre Channel (FC) interface policy group. |
...
| **description**  aliases: descr  string | The description of the Fibre Channel (FC) interface policy group. |
| **fibre_channel_interface_policy**  aliases: fibre_channel_interface_policy_name  string | The name of the fibre channel interface policy used by the Fibre Channel (FC) interface policy group. |
...
| **lag_type**  aliases: lag_type_name  string / required | Selector for the type of Fibre Channel (FC) interface policy group.  `port` for Fiber Channel (FC)  `port_channel` for Fiber Channel Port Channel (FC PC)  **Choices:**   - `"port"` - `"port_channel"` |
...
| **policy_group**  aliases: name, policy_group_name  string | The name of the Fibre Channel (FC) interface policy groups. |
...
| **port_channel_policy**  aliases: port_channel_policy_name  string | The name of the port channel policy used by the Fibre Channel (FC) interface policy group. |
...
## [Notes](aci_interface_policy_leaf_fc_policy_group_module.md#id3)

> **Note:**
>
> - When using the module please select the appropriate link_aggregation_type (lag_type).
> - `port` for Fiber Channel(FC), `port_channel` for Fiber Channel Port Channel(VPC).

## [See Also](aci_interface_policy_leaf_fc_policy_group_module.md#id4)
...
## [Examples](aci_interface_policy_leaf_fc_policy_group_module.md#id5)
...
## [Return Values](aci_interface_policy_leaf_fc_policy_group_module.md#id6)
