...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_span_dst_group module – Manage Fabric SPAN destination groups (span:DestGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_span_dst_group_module.html
fetched_at: 2026-07-28T01:19:40+00:00
---
# cisco.aci.aci_fabric_span_dst_group module – Manage Fabric SPAN destination groups (span:DestGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_span_dst_group`.

- [Synopsis](aci_fabric_span_dst_group_module.md#synopsis)
- [Parameters](aci_fabric_span_dst_group_module.md#parameters)
- [See Also](aci_fabric_span_dst_group_module.md#see-also)
- [Examples](aci_fabric_span_dst_group_module.md#examples)
- [Return Values](aci_fabric_span_dst_group_module.md#return-values)

## [Synopsis](aci_fabric_span_dst_group_module.md#id1)

- Manage Fabric SPAN destination groups on Cisco ACI fabrics.

## [Parameters](aci_fabric_span_dst_group_module.md#id2)
...
| **description**  aliases: descr  string | The description of the Fabric SPAN destination group. |
...
| **destination_group**  aliases: name, dst_group  string | The name of the Fabric SPAN destination group. |
...
## [See Also](aci_fabric_span_dst_group_module.md#id3)
...
## [Examples](aci_fabric_span_dst_group_module.md#id4)
...
## [Return Values](aci_fabric_span_dst_group_module.md#id5)
