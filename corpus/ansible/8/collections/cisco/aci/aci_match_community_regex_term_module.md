...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_community_regex_term module – Manage Match Regular Expression Community Term (rtctrl:MatchCommRegexTerm)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_community_regex_term_module.html
fetched_at: 2026-07-28T01:20:30+00:00
---
# cisco.aci.aci_match_community_regex_term module – Manage Match Regular Expression Community Term (rtctrl:MatchCommRegexTerm)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_match_community_regex_term`.

- [Synopsis](aci_match_community_regex_term_module.md#synopsis)
- [Parameters](aci_match_community_regex_term_module.md#parameters)
- [Notes](aci_match_community_regex_term_module.md#notes)
- [See Also](aci_match_community_regex_term_module.md#see-also)
- [Examples](aci_match_community_regex_term_module.md#examples)
- [Return Values](aci_match_community_regex_term_module.md#return-values)

## [Synopsis](aci_match_community_regex_term_module.md#id1)

- Manage Match Terms Based on Route Regular Expression Community for Match Rule Profiles on Cisco ACI fabrics.

## [Parameters](aci_match_community_regex_term_module.md#id2)
...
| **community_type**  string | The community type.  **Choices:**   - `"extended"` - `"regular"` ← (default) |
| **description**  aliases: descr  string | The description for the match regex community term. |
...
| **match_community_regex_term**  aliases: name, match_community_regex_term_name  string | The name of the match regex community term. |
| **match_rule**  aliases: match_rule_name  string | The name of an exising math rule profile. |
...
## [Notes](aci_match_community_regex_term_module.md#id3)

> **Note:**
>
> - The `tenant` and the `match_rule` used must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module) and the [cisco.aci.aci_match_rule](aci_match_rule_module.md#ansible-collections-cisco-aci-aci-match-rule-module) modules can be used for this.
> - Only two match community regex terms can exist at the same time, one of each `community_type`.

## [See Also](aci_match_community_regex_term_module.md#id4)
...
> :   More information about the internal APIC class **rtctrl:MatchCommRegexTerm**.
>
...
## [Examples](aci_match_community_regex_term_module.md#id5)
...
## [Return Values](aci_match_community_regex_term_module.md#id6)
