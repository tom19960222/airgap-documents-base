...
collection: ansible
version: "8"
title: "cisco.aci.aci_route_control_profile module – Manage Route Control Profile (rtcrtl:Profile)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_route_control_profile_module.html
fetched_at: 2026-07-28T01:20:37+00:00
---
# cisco.aci.aci_route_control_profile module – Manage Route Control Profile (rtcrtl:Profile)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_route_control_profile`.

- [Synopsis](aci_route_control_profile_module.md#synopsis)
- [Parameters](aci_route_control_profile_module.md#parameters)
- [Notes](aci_route_control_profile_module.md#notes)
- [See Also](aci_route_control_profile_module.md#see-also)
- [Examples](aci_route_control_profile_module.md#examples)
- [Return Values](aci_route_control_profile_module.md#return-values)

## [Synopsis](aci_route_control_profile_module.md#id1)

- Manage Route Control Profiles on Cisco ACI fabrics.

## [Parameters](aci_route_control_profile_module.md#id2)
...
| **auto_continue**  string | The option to enable/disable auto-continue.  **Choices:**   - `"no"` ← (default) - `"yes"` |
...
| **description**  aliases: descr  string | The description for the route control profile. |
...
| **l3out**  aliases: l3out_name  string | The name of an existing L3Out.  This will link the created route control profile to the existing L3Out. |
...
| **policy_type**  string | Set the policy type to combinable or global.  **Choices:**   - `"combinable"` ← (default) - `"global"` |
...
| **route_control_profile**  aliases: name, route_control_profile_name  string | The name of the route control profile being created. |
...
## [Notes](aci_route_control_profile_module.md#id3)
...
## [See Also](aci_route_control_profile_module.md#id4)
...
> :   More information about the internal APIC class **rtctrl:Profile**.
>
...
## [Examples](aci_route_control_profile_module.md#id5)
...
## [Return Values](aci_route_control_profile_module.md#id6)
