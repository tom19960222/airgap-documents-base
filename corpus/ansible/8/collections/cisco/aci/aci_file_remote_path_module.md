...
collection: ansible
version: "8"
title: "cisco.aci.aci_file_remote_path module – Manage Import/Export File Remote Paths ( file:RemotePath )"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_file_remote_path_module.html
fetched_at: 2026-07-28T01:19:48+00:00
---
...
- [Synopsis](aci_file_remote_path_module.md#synopsis)
- [Parameters](aci_file_remote_path_module.md#parameters)
- [See Also](aci_file_remote_path_module.md#see-also)
- [Examples](aci_file_remote_path_module.md#examples)
- [Return Values](aci_file_remote_path_module.md#return-values)

## [Synopsis](aci_file_remote_path_module.md#id1)

- Manage Import/Export File Remote Paths on Cisco ACI fabrics.

## [Parameters](aci_file_remote_path_module.md#id2)
...
| **auth_type**  string | The authentication type for the remote host.  Cannot be set to ssh_key if protocol is ftp.  **Choices:**   - `"password"` - `"ssh_key"` |
...
| **remote_password**  string | The password to access the remote host.  Only used if auth_type is password. |
| **remote_path**  string | The path on which the data will reside on the remote host. |
| **remote_port**  integer | The port to access the remote host. |
| **remote_protocol**  string | The protocol to use to connect to the remote host.  **Choices:**   - `"ftp"` - `"scp"` - `"sftp"` |
| **remote_ssh_key**  aliases: remote_key  string | The private SSH key used to access the remote host.  Only used if auth_type is ssh_key. |
| **remote_ssh_passphrase**  aliases: passphrase  string | The Pass phrase used to decode private_key.  Only used if auth_type is ssh_key. |
...
## [See Also](aci_file_remote_path_module.md#id3)
...
## [Examples](aci_file_remote_path_module.md#id4)
...
## [Return Values](aci_file_remote_path_module.md#id5)
