...
collection: ansible
version: "8"
title: "cisco.aci.aci_l3out_bgp_protocol_profile module – Manage BGP Protocol Profile (bgp:ProtP)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_l3out_bgp_protocol_profile_module.html
fetched_at: 2026-07-28T01:20:15+00:00
---
# cisco.aci.aci_l3out_bgp_protocol_profile module – Manage BGP Protocol Profile (bgp:ProtP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_l3out_bgp_protocol_profile`.

- [Synopsis](aci_l3out_bgp_protocol_profile_module.md#synopsis)
- [Parameters](aci_l3out_bgp_protocol_profile_module.md#parameters)
- [Notes](aci_l3out_bgp_protocol_profile_module.md#notes)
- [See Also](aci_l3out_bgp_protocol_profile_module.md#see-also)
- [Examples](aci_l3out_bgp_protocol_profile_module.md#examples)
- [Return Values](aci_l3out_bgp_protocol_profile_module.md#return-values)

## [Synopsis](aci_l3out_bgp_protocol_profile_module.md#id1)

- Manage BGP Protocol Profile for The Logical Node Profiles on Cisco ACI fabrics.

## [Parameters](aci_l3out_bgp_protocol_profile_module.md#id2)
...
| **bgp_best_path_policy**  aliases: bgp_best_path_policy_name  string | The name of the bgp best path control policy. |
| **bgp_timers_policy**  aliases: bgp_timers_policy_name  string | The name of an existing bgp timers policy. |
...
| **l3out**  aliases: l3out_name  string | The name of an existing L3Out. |
| **name_alias**  string | The alias for the current object. This relates to the nameAlias field in ACI. |
| **node_profile**  aliases: node_profile_name, logical_node  string | The name of an existing logical node profile. |
...
## [Notes](aci_l3out_bgp_protocol_profile_module.md#id3)

> **Note:**
>
> - The `tenant`, `l3out` and `node_profile` used must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), [cisco.aci.aci_l3out](aci_l3out_module.md#ansible-collections-cisco-aci-aci-l3out-module) and [cisco.aci.aci_l3out_logical_node_profile](aci_l3out_logical_node_profile_module.md#ansible-collections-cisco-aci-aci-l3out-logical-node-profile-module) modules can be used for this.
> - If `bgp_timers_policy` and/or `bgp_best_path_policy` are used, they must exist before using this module in your playbook. The [cisco.aci.aci_bgp_timers_policy](aci_bgp_timers_policy_module.md#ansible-collections-cisco-aci-aci-bgp-timers-policy-module) and [cisco.aci.aci_bgp_best_path_policy](aci_bgp_best_path_policy_module.md#ansible-collections-cisco-aci-aci-bgp-best-path-policy-module) modules can be used for this.

## [See Also](aci_l3out_bgp_protocol_profile_module.md#id4)
...
>
> [cisco.aci.aci_l3out_logical_node_profile](aci_l3out_logical_node_profile_module.md#ansible-collections-cisco-aci-aci-l3out-logical-node-profile-module)
> :   Manage Layer 3 Outside (L3Out) logical node profiles (l3ext:LNodeP).
>
> [cisco.aci.aci_bgp_timers_policy](aci_bgp_timers_policy_module.md#ansible-collections-cisco-aci-aci-bgp-timers-policy-module)
> :   Manage BGP timers policy (bgp:CtxPol).
>
> [cisco.aci.aci_bgp_best_path_policy](aci_bgp_best_path_policy_module.md#ansible-collections-cisco-aci-aci-bgp-best-path-policy-module)
> :   Manage BGP Best Path policy (bgp:BestPathCtrlPol).
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **bgp:ProtP**.
>
...
## [Examples](aci_l3out_bgp_protocol_profile_module.md#id5)
...
## [Return Values](aci_l3out_bgp_protocol_profile_module.md#id6)
