...
collection: ansible
version: "8"
title: "cisco.aci.aci_vrf_leak_internal_subnet module – Manage VRF leaking of subnets (fv:leakInternalSubnet)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_vrf_leak_internal_subnet_module.html
fetched_at: 2026-07-28T01:21:04+00:00
---
# cisco.aci.aci_vrf_leak_internal_subnet module – Manage VRF leaking of subnets (fv:leakInternalSubnet)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_vrf_leak_internal_subnet`.

- [Synopsis](aci_vrf_leak_internal_subnet_module.md#synopsis)
- [Parameters](aci_vrf_leak_internal_subnet_module.md#parameters)
- [Notes](aci_vrf_leak_internal_subnet_module.md#notes)
- [See Also](aci_vrf_leak_internal_subnet_module.md#see-also)
- [Examples](aci_vrf_leak_internal_subnet_module.md#examples)
- [Return Values](aci_vrf_leak_internal_subnet_module.md#return-values)

## [Synopsis](aci_vrf_leak_internal_subnet_module.md#id1)

- Manage the leaking of internal subnets under the VRF.

## [Parameters](aci_vrf_leak_internal_subnet_module.md#id2)
...
| **description**  aliases: descr  string | The description for the VRF Leak Internal Subnet. |
...
| **leak_to**  list / elements=dictionary | The VRFs to leak the subnet routes into. |
...
| **scope**  string | Scope of the object.  **Choices:**   - `"public"` - `"private"` ← (default) - `"shared"` |
...
| **tenant**  aliases: tenant_name  string | The name of the Tenant the VRF belongs to. |
...
## [Notes](aci_vrf_leak_internal_subnet_module.md#id3)

> **Note:**
>
> - The `tenant` and `vrf` used must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module) and [cisco.aci.aci_vrf](aci_vrf_module.md#ansible-collections-cisco-aci-aci-vrf-module) modules can be used for this.

## [See Also](aci_vrf_leak_internal_subnet_module.md#id4)
...
> :   More information about the internal APIC class **leak:InternalSubnet**.
>
...
## [Examples](aci_vrf_leak_internal_subnet_module.md#id5)
...
## [Return Values](aci_vrf_leak_internal_subnet_module.md#id6)
