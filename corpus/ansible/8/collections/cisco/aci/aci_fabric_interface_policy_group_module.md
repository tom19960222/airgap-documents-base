...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_interface_policy_group module – Manage Fabric Interface Policy Groups (fabric:LePortPGrp, fabric:SpPortPGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_interface_policy_group_module.html
fetched_at: 2026-07-28T01:19:34+00:00
---
# cisco.aci.aci_fabric_interface_policy_group module – Manage Fabric Interface Policy Groups (fabric:LePortPGrp, fabric:SpPortPGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_interface_policy_group`.

- [Synopsis](aci_fabric_interface_policy_group_module.md#synopsis)
- [Parameters](aci_fabric_interface_policy_group_module.md#parameters)
- [See Also](aci_fabric_interface_policy_group_module.md#see-also)
- [Examples](aci_fabric_interface_policy_group_module.md#examples)
- [Return Values](aci_fabric_interface_policy_group_module.md#return-values)

## [Synopsis](aci_fabric_interface_policy_group_module.md#id1)

- Manage Fabric Interface Policy Groups on Cisco ACI fabrics.

## [Parameters](aci_fabric_interface_policy_group_module.md#id2)
...
| **description**  aliases: descr  string | The description of the Fabric Leaf or Spine Interface Policy Group. |
...
| **name**  aliases: policy_group  string | The name of the Fabric Leaf or Spine Interface Policy Group. |
...
| **type**  aliases: policy_group_type  string / required | The type of the Fabric Leaf or Spine Interface Policy Group.  Use `leaf` to create a Fabric Leaf Interface Policy Group.  Use `spine` to create a Fabric Spine Interface Policy Group.  **Choices:**   - `"leaf"` - `"spine"` |
...
## [See Also](aci_fabric_interface_policy_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabric:LePortPGrp, fabric:SpPortPGrp**.
>
...
## [Examples](aci_fabric_interface_policy_group_module.md#id4)
...
## [Return Values](aci_fabric_interface_policy_group_module.md#id5)
