...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_route_destination module – Manage Match action rule term based on the Route Destination. (rtctrl:MatchRtDest)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_route_destination_module.html
fetched_at: 2026-07-28T01:20:32+00:00
---
...
- [Synopsis](aci_match_route_destination_module.md#synopsis)
- [Parameters](aci_match_route_destination_module.md#parameters)
- [Notes](aci_match_route_destination_module.md#notes)
- [See Also](aci_match_route_destination_module.md#see-also)
- [Examples](aci_match_route_destination_module.md#examples)
- [Return Values](aci_match_route_destination_module.md#return-values)

## [Synopsis](aci_match_route_destination_module.md#id1)

- Match action rule terms based on the Route Destination for Subject Profiles on Cisco ACI fabrics.

## [Parameters](aci_match_route_destination_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **aggregate**  string | Option to enable/disable aggregated route.  **Choices:**   - `"no"` - `"yes"` |
...
| **description**  aliases: descr  string | The description for the match action rule term. |
| **from_prefix_length**  integer | The start of the prefix length.  It corresponds to the lesser Mask if the route is aggregated. |
...
| **to_prefix_length**  integer | The end of the prefix length.  It corresponds to greater Mask if the route is aggregated. |
...
## [Notes](aci_match_route_destination_module.md#id3)
...
## [See Also](aci_match_route_destination_module.md#id4)
...
## [Examples](aci_match_route_destination_module.md#id5)
...
## [Return Values](aci_match_route_destination_module.md#id6)
