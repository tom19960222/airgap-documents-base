...
collection: ansible
version: "8"
title: "cisco.aci.aci_tenant_span_src_group_src module – Manage SPAN source group sources (span:Src)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_tenant_span_src_group_src_module.html
fetched_at: 2026-07-28T01:20:56+00:00
---
# cisco.aci.aci_tenant_span_src_group_src module – Manage SPAN source group sources (span:Src)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_tenant_span_src_group_src`.

- [Synopsis](aci_tenant_span_src_group_src_module.md#synopsis)
- [Parameters](aci_tenant_span_src_group_src_module.md#parameters)
- [Notes](aci_tenant_span_src_group_src_module.md#notes)
- [See Also](aci_tenant_span_src_group_src_module.md#see-also)
- [Examples](aci_tenant_span_src_group_src_module.md#examples)
- [Return Values](aci_tenant_span_src_group_src_module.md#return-values)

## [Synopsis](aci_tenant_span_src_group_src_module.md#id1)

- Manage SPAN source group sources on Cisco ACI fabrics.

## [Parameters](aci_tenant_span_src_group_src_module.md#id2)
...
| **description**  aliases: descr  string | The description for Span source. |
| **direction**  string | The direction of the SPAN source.  **Choices:**   - `"incoming"` - `"outgoing"` - `"both"` |
...
| **src_ap**  aliases: ap  string | The name of the Span source ap. |
| **src_epg**  aliases: epg  string | The name of the Span source epg. |
...
## [Notes](aci_tenant_span_src_group_src_module.md#id3)
...
## [See Also](aci_tenant_span_src_group_src_module.md#id4)
...
## [Examples](aci_tenant_span_src_group_src_module.md#id5)
...
## [Return Values](aci_tenant_span_src_group_src_module.md#id6)
