...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_community_factor module – Manage Match Community Factor (rtctrl:MatchCommFactor)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_community_factor_module.html
fetched_at: 2026-07-28T01:20:29+00:00
---
# cisco.aci.aci_match_community_factor module – Manage Match Community Factor (rtctrl:MatchCommFactor)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_match_community_factor`.

- [Synopsis](aci_match_community_factor_module.md#synopsis)
- [Parameters](aci_match_community_factor_module.md#parameters)
- [Notes](aci_match_community_factor_module.md#notes)
- [See Also](aci_match_community_factor_module.md#see-also)
- [Examples](aci_match_community_factor_module.md#examples)
- [Return Values](aci_match_community_factor_module.md#return-values)

## [Synopsis](aci_match_community_factor_module.md#id1)

- Manage Match Community Factors for Match Terms Based on Community on Cisco ACI fabrics.

## [Parameters](aci_match_community_factor_module.md#id2)
...
| **description**  aliases: descr  string | The description for the match community factor. |
...
| **match_community_term**  aliases: match_community_term_name  string | The name of an existing match community term. |
| **match_rule**  aliases: match_rule_name  string | The name of an exising match rule profile. |
...
| **scope**  string | The item scope.  If the scope is transitive, this community may be passed between ASs.  If the scope is non-transitive, this community should be carried only within the local AS.  **Choices:**   - `"transitive"` - `"non-transitive"` |
...
## [Notes](aci_match_community_factor_module.md#id3)

> **Note:**
>
> - The `tenant`, the `match_rule` and the `match_community_term` used must exist before using this module in your playbook. The [cisco.aci.aci_tenant](aci_tenant_module.md#ansible-collections-cisco-aci-aci-tenant-module), the [cisco.aci.aci_match_rule](aci_match_rule_module.md#ansible-collections-cisco-aci-aci-match-rule-module) and [cisco.aci.aci_match_community_term](aci_match_community_term_module.md#ansible-collections-cisco-aci-aci-match-community-term-module) modules can be used for this.

## [See Also](aci_match_community_factor_module.md#id4)
...
>
> [cisco.aci.aci_match_community_term](aci_match_community_term_module.md#ansible-collections-cisco-aci-aci-match-community-term-module)
> :   Manage Match Community Term (rtctrl:MatchCommTerm).
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **rtctrl:MatchCommFactor**.
>
...
## [Examples](aci_match_community_factor_module.md#id5)
...
## [Return Values](aci_match_community_factor_module.md#id6)
