...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_span_src_group_src_node module – Manage Fabric SPAN source nodes (span:RsSrcToNode)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_span_src_group_src_node_module.html
fetched_at: 2026-07-28T01:19:42+00:00
---
# cisco.aci.aci_fabric_span_src_group_src_node module – Manage Fabric SPAN source nodes (span:RsSrcToNode)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_span_src_group_src_node`.

- [Synopsis](aci_fabric_span_src_group_src_node_module.md#synopsis)
- [Parameters](aci_fabric_span_src_group_src_node_module.md#parameters)
- [Notes](aci_fabric_span_src_group_src_node_module.md#notes)
- [See Also](aci_fabric_span_src_group_src_node_module.md#see-also)
- [Examples](aci_fabric_span_src_group_src_node_module.md#examples)
- [Return Values](aci_fabric_span_src_group_src_node_module.md#return-values)

## [Synopsis](aci_fabric_span_src_group_src_node_module.md#id1)

- Manage Fabric SPAN source nodes on Cisco ACI fabrics.
- Source nodes are only configurable when the *source_group* provided has *drop_packets* set to `true`.

## [Parameters](aci_fabric_span_src_group_src_node_module.md#id2)
...
| **node**  aliases: node_id  integer | The node id of the source access node. |
...
| **pod**  aliases: pod_id, pod_number  integer | The pod id of the source access node. |
...
## [Notes](aci_fabric_span_src_group_src_node_module.md#id3)
...
## [See Also](aci_fabric_span_src_group_src_node_module.md#id4)
...
> :   More information about the internal APIC class **span:RsSrcToNode**.
>
...
## [Examples](aci_fabric_span_src_group_src_node_module.md#id5)
...
## [Return Values](aci_fabric_span_src_group_src_node_module.md#id6)
