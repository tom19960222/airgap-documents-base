...
collection: ansible
version: "8"
title: "cisco.aci.aci_aaa_role module – Manage AAA roles (aaa:Role)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_aaa_role_module.html
...
- [Synopsis](aci_aaa_role_module.md#synopsis)
- [Parameters](aci_aaa_role_module.md#parameters)
- [See Also](aci_aaa_role_module.md#see-also)
- [Examples](aci_aaa_role_module.md#examples)
- [Return Values](aci_aaa_role_module.md#return-values)

## [Synopsis](aci_aaa_role_module.md#id1)

- Manage AAA roles on Cisco ACI fabrics.

## [Parameters](aci_aaa_role_module.md#id2)
...
| **description**  aliases: descr  string | Description of the aaa role. |
...
| **name**  aliases: aaa_role  string | The name of the aaa role. |
...
## [See Also](aci_aaa_role_module.md#id3)
...
>
> [Manage AAA domains (aaa:Domain)](https://developer.cisco.com/docs/apic-mim-ref/)
...
## [Examples](aci_aaa_role_module.md#id4)
...
## [Return Values](aci_aaa_role_module.md#id5)
