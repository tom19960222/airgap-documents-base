...
collection: ansible
version: "8"
title: "cisco.aci.aci_aaa_domain module – Manage AAA domains (aaa:Domain)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_aaa_domain_module.html
fetched_at: 2026-07-28T01:18:39+00:00
---
# cisco.aci.aci_aaa_domain module – Manage AAA domains (aaa:Domain)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_aaa_domain`.

- [Synopsis](aci_aaa_domain_module.md#synopsis)
- [Parameters](aci_aaa_domain_module.md#parameters)
- [See Also](aci_aaa_domain_module.md#see-also)
- [Examples](aci_aaa_domain_module.md#examples)
- [Return Values](aci_aaa_domain_module.md#return-values)

## [Synopsis](aci_aaa_domain_module.md#id1)

- Manage AAA domains on Cisco ACI fabrics.

## [Parameters](aci_aaa_domain_module.md#id2)
...
| **description**  aliases: descr  string | Description of the aaa domain. |
...
| **name**  aliases: aaa_domain  string | The name of the aaa domain. |
...
| **restricted_rbac_domain**  boolean | `True` to enable Restricted RBAC Domain on the aaa security domain.  **Choices:**   - `false` - `true` |
...
## [See Also](aci_aaa_domain_module.md#id3)

> **See also:**
>
> [cisco.aci.aci_aaa_role](aci_aaa_role_module.md#ansible-collections-cisco-aci-aci-aaa-role-module)
> :   Manage AAA roles (aaa:Role).
>
> [Manage AAA roles (aaa:Role)](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the AAA roles class **aaa:Role**.
>
...
## [Examples](aci_aaa_domain_module.md#id4)
...
## [Return Values](aci_aaa_domain_module.md#id5)
