...
collection: ansible
version: "8"
title: "cisco.aci.aci_aaa_user_domain module – Manage AAA user domains (aaa:UserDomain)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_aaa_user_domain_module.html
fetched_at: 2026-07-28T01:18:43+00:00
---
# cisco.aci.aci_aaa_user_domain module – Manage AAA user domains (aaa:UserDomain)
...
| Parameter | Comments |
| --- | --- |
| **aaa_user**  aliases: user_name  string | The name of an existing AAA user |
...
| **name**  aliases: domain_name, user_domain  string | The name of the user domain |
