...
collection: ansible
version: "8"
title: "cisco.aci.aci_system_global_aes_passphrase_encryption module – Manage Global AES Passphrase Encryption Settings (pki:ExportEncryptionKey)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_system_global_aes_passphrase_encryption_module.html
fetched_at: 2026-07-28T01:20:50+00:00
---
# cisco.aci.aci_system_global_aes_passphrase_encryption module – Manage Global AES Passphrase Encryption Settings (pki:ExportEncryptionKey)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_system_global_aes_passphrase_encryption`.

- [Synopsis](aci_system_global_aes_passphrase_encryption_module.md#synopsis)
- [Parameters](aci_system_global_aes_passphrase_encryption_module.md#parameters)
- [See Also](aci_system_global_aes_passphrase_encryption_module.md#see-also)
- [Examples](aci_system_global_aes_passphrase_encryption_module.md#examples)
- [Return Values](aci_system_global_aes_passphrase_encryption_module.md#return-values)

## [Synopsis](aci_system_global_aes_passphrase_encryption_module.md#id1)

- Manage Global AES Passphrase Encryption Settings on Cisco ACI fabrics.

## [Parameters](aci_system_global_aes_passphrase_encryption_module.md#id2)
...
| **enable**  boolean | Whether to enable strong encryption.  The APIC defaults to `false` when unset during creation.  Note that this will be set back to False when deleting an existing passphrase.  **Choices:**   - `false` - `true` |
...
| **state**  string | Use `present` to create a passphrase or to change the enable setting.  Use `absent` to delete the existing passphrase.  Use `query` for showing current configuration.  **Choices:**   - `"absent"` - `"present"` ← (default) - `"query"` |
...
## [See Also](aci_system_global_aes_passphrase_encryption_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **pki:ExportEncryptionKey**.
>
...
## [Examples](aci_system_global_aes_passphrase_encryption_module.md#id4)
...
## [Return Values](aci_system_global_aes_passphrase_encryption_module.md#id5)
