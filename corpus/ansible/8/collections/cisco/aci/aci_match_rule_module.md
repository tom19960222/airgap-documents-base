...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_rule module – Manage Match Rule (rtcrtl:SubjP)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_rule_module.html
fetched_at: 2026-07-28T01:20:33+00:00
---
# cisco.aci.aci_match_rule module – Manage Match Rule (rtcrtl:SubjP)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_match_rule`.

- [Synopsis](aci_match_rule_module.md#synopsis)
- [Parameters](aci_match_rule_module.md#parameters)
- [Notes](aci_match_rule_module.md#notes)
- [See Also](aci_match_rule_module.md#see-also)
- [Examples](aci_match_rule_module.md#examples)
- [Return Values](aci_match_rule_module.md#return-values)

## [Synopsis](aci_match_rule_module.md#id1)

- Manage Match Rule Profiles for the Tenants on Cisco ACI fabrics.

## [Parameters](aci_match_rule_module.md#id2)
...
| **description**  aliases: descr  string | The description for the match rule profile. |
...
| **match_rule**  aliases: name, match_rule_name  string | The name of the match rule profile being created. |
...
## [Notes](aci_match_rule_module.md#id3)
...
## [See Also](aci_match_rule_module.md#id4)
...
> :   More information about the internal APIC class **rtctrl:SubjP**.
>
...
## [Examples](aci_match_rule_module.md#id5)
...
## [Return Values](aci_match_rule_module.md#id6)
