...
collection: ansible
version: "8"
title: "cisco.aci.aci_maintenance_group_node module – Manage maintenance group nodes (fabric:NodeBlk)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_maintenance_group_node_module.html
fetched_at: 2026-07-28T01:20:27+00:00
---
# cisco.aci.aci_maintenance_group_node module – Manage maintenance group nodes (fabric:NodeBlk)
...
> **See also:**
>
> [cisco.aci.aci_maintenance_group](aci_maintenance_group_module.md#ansible-collections-cisco-aci-aci-maintenance-group-module)
> :   This creates an ACI maintenance group (maint:MaintGrp).
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabric:NodeBlk**.
>
