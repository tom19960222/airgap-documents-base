...
collection: ansible
version: "8"
title: "cisco.aci.aci_interface_policy_leaf_profile_fex_policy_group module – Manage leaf interface profiles fex policy group (infra:FexBndlGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_leaf_profile_fex_policy_group_module.html
fetched_at: 2026-07-28T01:20:01+00:00
---
# cisco.aci.aci_interface_policy_leaf_profile_fex_policy_group module – Manage leaf interface profiles fex policy group (infra:FexBndlGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_leaf_profile_fex_policy_group`.

- [Synopsis](aci_interface_policy_leaf_profile_fex_policy_group_module.md#synopsis)
- [Parameters](aci_interface_policy_leaf_profile_fex_policy_group_module.md#parameters)
- [See Also](aci_interface_policy_leaf_profile_fex_policy_group_module.md#see-also)
- [Examples](aci_interface_policy_leaf_profile_fex_policy_group_module.md#examples)
- [Return Values](aci_interface_policy_leaf_profile_fex_policy_group_module.md#return-values)

## [Synopsis](aci_interface_policy_leaf_profile_fex_policy_group_module.md#id1)

- Manage leaf interface profiles fex policy group on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_leaf_profile_fex_policy_group_module.md#id2)
...
| **name**  aliases: policy_group  string | The name of the Fex Profile Policy Group. |
...
## [See Also](aci_interface_policy_leaf_profile_fex_policy_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **infra:FexBndlGrp**.
>
...
## [Examples](aci_interface_policy_leaf_profile_fex_policy_group_module.md#id4)
...
## [Return Values](aci_interface_policy_leaf_profile_fex_policy_group_module.md#id5)
