...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_l2_module.html
fetched_at: 2026-07-28T01:19:58+00:00
---
...
| **vepa**  boolean | Determines if Virtual Ethernet Port Aggregator is disabled or enabled.  The APIC defaults to `false` when unset during creation.  **Choices:**   - `false` - `true` |
