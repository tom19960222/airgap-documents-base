...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_pod_policy_group module – Manage Fabric Pod Policy Groups (fabric:PodPGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_pod_policy_group_module.html
fetched_at: 2026-07-28T01:19:38+00:00
---
# cisco.aci.aci_fabric_pod_policy_group module – Manage Fabric Pod Policy Groups (fabric:PodPGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_pod_policy_group`.

- [Synopsis](aci_fabric_pod_policy_group_module.md#synopsis)
- [Parameters](aci_fabric_pod_policy_group_module.md#parameters)
- [See Also](aci_fabric_pod_policy_group_module.md#see-also)
- [Examples](aci_fabric_pod_policy_group_module.md#examples)
- [Return Values](aci_fabric_pod_policy_group_module.md#return-values)

## [Synopsis](aci_fabric_pod_policy_group_module.md#id1)

- Fabric Pod Policy Group (fabric:PodPGrp) configuration on Cisco ACI fabrics.

## [Parameters](aci_fabric_pod_policy_group_module.md#id2)
...
| **coop_group_policy**  aliases: coop_policy  string | COOP group policy to bind to the policy group |
| **date_time_policy**  aliases: ntp_policy  string | NTP policy to bind to the policy group |
...
| **management_access_policy**  aliases: management_policy, mgmt_policy  string | Management access policy to bind to the policy group |
| **name**  aliases: policy_group, policy_group_name, pod_policy_group  string | Name of the policy group |
...
## [See Also](aci_fabric_pod_policy_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **fabricPodPGrp**.
>
...
## [Examples](aci_fabric_pod_policy_group_module.md#id4)
...
## [Return Values](aci_fabric_pod_policy_group_module.md#id5)
