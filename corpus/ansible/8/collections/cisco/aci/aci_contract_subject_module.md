...
collection: ansible
version: "8"
title: "cisco.aci.aci_contract_subject module – Manage initial Contract Subjects (vz:Subj)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_contract_subject_module.html
fetched_at: 2026-07-28T01:19:15+00:00
---
# cisco.aci.aci_contract_subject module – Manage initial Contract Subjects (vz:Subj)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_contract_subject`.

- [Synopsis](aci_contract_subject_module.md#synopsis)
- [Parameters](aci_contract_subject_module.md#parameters)
- [Notes](aci_contract_subject_module.md#notes)
- [See Also](aci_contract_subject_module.md#see-also)
- [Examples](aci_contract_subject_module.md#examples)
- [Return Values](aci_contract_subject_module.md#return-values)

## [Synopsis](aci_contract_subject_module.md#id1)

- Manage initial Contract Subjects on Cisco ACI fabrics.

## [Parameters](aci_contract_subject_module.md#id2)
...
| **apply_both_direction**  string | The direction of traffic matching for the filter.  **Choices:**   - `"both"` ← (default) - `"one-way"` |
...
| **consumer_match**  string | The match criteria across consumers.  The APIC defaults to `at_least_one` when unset during creation.  **Choices:**   - `"all"` - `"at_least_one"` - `"at_most_one"` - `"none"` |
| **contract**  aliases: contract_name  string | The name of the Contract. |
| **description**  aliases: descr  string | Description for the contract subject. |
| **dscp**  aliases: target  string | The target DSCP.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"AF11"` - `"AF12"` - `"AF13"` - `"AF21"` - `"AF22"` - `"AF23"` - `"AF31"` - `"AF32"` - `"AF33"` - `"AF41"` - `"AF42"` - `"AF43"` - `"CS0"` - `"CS1"` - `"CS2"` - `"CS3"` - `"CS4"` - `"CS5"` - `"CS6"` - `"CS7"` - `"EF"` - `"VA"` - `"unspecified"` |
| **dscp_consumer_to_provider**  aliases: target_consumer_to_provider  string | The target DSCP of Filter Chain For Consumer to Provider.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"AF11"` - `"AF12"` - `"AF13"` - `"AF21"` - `"AF22"` - `"AF23"` - `"AF31"` - `"AF32"` - `"AF33"` - `"AF41"` - `"AF42"` - `"AF43"` - `"CS0"` - `"CS1"` - `"CS2"` - `"CS3"` - `"CS4"` - `"CS5"` - `"CS6"` - `"CS7"` - `"EF"` - `"VA"` - `"unspecified"` |
| **dscp_provider_to_consumer**  aliases: target_provider_to_consumer  string | The target DSCP of Filter Chain For Provider to Consumer.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"AF11"` - `"AF12"` - `"AF13"` - `"AF21"` - `"AF22"` - `"AF23"` - `"AF31"` - `"AF32"` - `"AF33"` - `"AF41"` - `"AF42"` - `"AF43"` - `"CS0"` - `"CS1"` - `"CS2"` - `"CS3"` - `"CS4"` - `"CS5"` - `"CS6"` - `"CS7"` - `"EF"` - `"VA"` - `"unspecified"` |
...
| **priority_consumer_to_provider**  string | The QoS class of Filter Chain For Consumer to Provider.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"level1"` - `"level2"` - `"level3"` - `"unspecified"` |
| **priority_provider_to_consumer**  string | The QoS class of Filter Chain For Provider to Consumer.  The APIC defaults to `unspecified` when unset during creation.  **Choices:**   - `"level1"` - `"level2"` - `"level3"` - `"unspecified"` |
...
| **provider_match**  string | The match criteria across providers.  The APIC defaults to `at_least_one` when unset during creation.  **Choices:**   - `"all"` - `"at_least_one"` - `"at_most_one"` - `"none"` |
| **reverse_filter**  boolean | Determines if the APIC should reverse the src and dst ports to allow the return traffic back, since ACI is stateless filter.  The APIC defaults to `true` when unset during creation.  **Choices:**   - `false` - `true` |
...
| **subject**  aliases: contract_subject, name, subject_name  string | The contract subject name. |
...
## [Examples](aci_contract_subject_module.md#id5)
...
## [Return Values](aci_contract_subject_module.md#id6)
