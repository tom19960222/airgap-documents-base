...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_syslog_source_module.html
fetched_at: 2026-07-28T01:20:47+00:00
---
...
| **include**  list / elements=string | List of message types to include  The APIC defaults to `faults` when unset during creation.  **Choices:**   - `"audit"` - `"events"` - `"faults"` - `"session"` |
