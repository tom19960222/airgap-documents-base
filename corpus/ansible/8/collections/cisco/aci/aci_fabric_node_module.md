...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_node_module.html
fetched_at: 2026-07-28T01:19:36+00:00
---
...
| **node_type**  string | Type for the new Fabric Node Member.  **Choices:**   - `"tier_2"` - `"remote"` - `"virtual"` - `"unspecified"` |
...
| **remote_leaf_pool_id**  aliases: pool_id  string | External Pool Id of the remote leaf.  *remote_leaf_pool_id* is incompatible with *node_type* other than `remote`.  *remote_leaf_pool_id* is required if *node_type* is `remote`. |
