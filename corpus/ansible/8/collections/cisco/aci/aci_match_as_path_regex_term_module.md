...
collection: ansible
version: "8"
title: "cisco.aci.aci_match_as_path_regex_term module – Manage Match Regular Expression AS-Path Term (rtctrl:MatchAsPathRegexTerm)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_match_as_path_regex_term_module.html
fetched_at: 2026-07-28T01:20:28+00:00
---
# cisco.aci.aci_match_as_path_regex_term module – Manage Match Regular Expression AS-Path Term (rtctrl:MatchAsPathRegexTerm)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_match_as_path_regex_term`.

- [Synopsis](aci_match_as_path_regex_term_module.md#synopsis)
- [Parameters](aci_match_as_path_regex_term_module.md#parameters)
- [Notes](aci_match_as_path_regex_term_module.md#notes)
- [See Also](aci_match_as_path_regex_term_module.md#see-also)
- [Examples](aci_match_as_path_regex_term_module.md#examples)
- [Return Values](aci_match_as_path_regex_term_module.md#return-values)

## [Synopsis](aci_match_as_path_regex_term_module.md#id1)

- Manage Match Term Based on Route Regular Expression AS-Path for Match Rule Profiles on Cisco ACI fabrics.

## [Parameters](aci_match_as_path_regex_term_module.md#id2)
...
| **description**  aliases: descr  string | The description for the match regex AS-Path term. |
...
| **match_as_path_regex_term**  aliases: name, match_as_path_regex_term_name  string | The name of the match regex AS-Path term. |
...
## [Notes](aci_match_as_path_regex_term_module.md#id3)
...
## [See Also](aci_match_as_path_regex_term_module.md#id4)
...
> :   More information about the internal APIC class **rtctrl:MatchAsPathRegexTerm**.
>
...
## [Examples](aci_match_as_path_regex_term_module.md#id5)
...
## [Return Values](aci_match_as_path_regex_term_module.md#id6)
