...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_dhcp_relay_provider_module.html
fetched_at: 2026-07-28T01:19:18+00:00
---
...
| **epg_type**  string | Type of EPG the DHCP server is in  **Choices:**   - `"epg"` - `"l2_external"` - `"l3_external"` - `"dn"` |
