...
collection: ansible
version: "8"
title: "cisco.aci.aci_firmware_group module – Manage firmware groups (firmware:FwGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_firmware_group_module.html
fetched_at: 2026-07-28T01:19:50+00:00
---
# cisco.aci.aci_firmware_group module – Manage firmware groups (firmware:FwGrp)
...
- [Notes](aci_firmware_group_module.md#notes)
...
| **description**  aliases: descr  string | Description of the firmware group. |
...
| **policy**  aliases: firmwarepol  string | Name of the firmware policy  It is important that you use the same name as the policy created with [cisco.aci.aci_firmware_policy](aci_firmware_policy_module.md#ansible-collections-cisco-aci-aci-firmware-policy-module). |
...
| **type_group**  string | Type of the firmware group.  The APIC defaults to `range` when unset during creation.  **Choices:**   - `"all"` - `"all_in_pod"` - `"range"` |
...
## [Notes](aci_firmware_group_module.md#id3)

> **Note:**
>
> - The `policy` must exist before using this module in your playbook.
> - The [cisco.aci.aci_firmware_policy](aci_firmware_policy_module.md#ansible-collections-cisco-aci-aci-firmware-policy-module) module can be used for this.

## [See Also](aci_firmware_group_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_firmware_policy](aci_firmware_policy_module.md#ansible-collections-cisco-aci-aci-firmware-policy-module)
> :   Manage firmware policies (firmware:FwP).
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **firmware:FwGrp**.
>
...
## [Examples](aci_firmware_group_module.md#id5)
...
## [Return Values](aci_firmware_group_module.md#id6)
