...
collection: ansible
version: "8"
title: "cisco.aci.aci_aaa_user_role module – Manage AAA user roles (aaa:UserRole)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_aaa_user_role_module.html
fetched_at: 2026-07-28T01:18:43+00:00
---
# cisco.aci.aci_aaa_user_role module – Manage AAA user roles (aaa:UserRole)
...
| Parameter | Comments |
| --- | --- |
| **aaa_user**  aliases: user_name  string | The name of the existing user to add roles and privileges |
...
| **domain_name**  aliases: user_domain  string | The name of the security domain |
...
| **name**  aliases: role_name, user_role  string | Name of the AAA role |
...
| **privilege_type**  aliases: priv_type  string | Privilege for the role  **Choices:**   - `"read"` - `"write"` |
