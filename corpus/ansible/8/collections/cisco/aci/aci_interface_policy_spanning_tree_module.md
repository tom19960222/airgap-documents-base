...
collection: ansible
version: "8"
title: "cisco.aci.aci_interface_policy_spanning_tree module – Manage spanning tree interface policies (stp:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_spanning_tree_module.html
fetched_at: 2026-07-28T01:20:07+00:00
---
# cisco.aci.aci_interface_policy_spanning_tree module – Manage spanning tree interface policies (stp:IfPol)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_spanning_tree`.

- [Synopsis](aci_interface_policy_spanning_tree_module.md#synopsis)
- [Parameters](aci_interface_policy_spanning_tree_module.md#parameters)
- [See Also](aci_interface_policy_spanning_tree_module.md#see-also)
- [Examples](aci_interface_policy_spanning_tree_module.md#examples)
- [Return Values](aci_interface_policy_spanning_tree_module.md#return-values)

## [Synopsis](aci_interface_policy_spanning_tree_module.md#id1)

- Manage spanning tree interface policies on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_spanning_tree_module.md#id2)
...
| **bpdu_filter**  boolean | The BPDU-Filter state.  **Choices:**   - `false` ← (default) - `true` |
| **bpdu_guard**  boolean | The BPDU-Guard state.  **Choices:**   - `false` ← (default) - `true` |
...
| **description**  aliases: descr  string | The description for the policy. |
...
| **stp_policy**  aliases: name  string | The name of the STP policy. |
...
## [See Also](aci_interface_policy_spanning_tree_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC class **stp:IfPol**.
>
...
## [Examples](aci_interface_policy_spanning_tree_module.md#id4)
...
## [Return Values](aci_interface_policy_spanning_tree_module.md#id5)
