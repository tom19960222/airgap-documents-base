...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_config_rollback_module.html
fetched_at: 2026-07-28T01:19:12+00:00
---
...
- [Notes](aci_config_rollback_module.md#notes)
...
| **fail_on_decrypt**  boolean | Determines if the APIC should fail the rollback if unable to decrypt secured data.  The APIC defaults to `true` when unset.  **Choices:**   - `false` - `true` |
...
## [Notes](aci_config_rollback_module.md#id3)
...
## [See Also](aci_config_rollback_module.md#id4)
...
## [Examples](aci_config_rollback_module.md#id5)
...
## [Return Values](aci_config_rollback_module.md#id6)
