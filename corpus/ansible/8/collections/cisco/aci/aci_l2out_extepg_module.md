...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_l2out_extepg_module.html
fetched_at: 2026-07-28T01:20:10+00:00
---
...
| **preferred_group**  boolean | This depicts whether this External EPG is part of the Preferred Group and can communicate without contracts.  This is convenient for migration scenarios, or when ACI is used for network automation but not for policy.  The APIC defaults to `false` when unset during creation.  **Choices:**   - `false` - `true` |
