...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_l3out_logical_interface_profile_module.html
fetched_at: 2026-07-28T01:20:20+00:00
---
...
| **description**  aliases: descr  string | The description for the logical interface profile. |
| **egress_dpp_policy**  string | Name of the egress data plane policing policy.  **Default:** `""` |
...
| **ingress_dpp_policy**  string | Name of the ingress data plane policing policy.  **Default:** `""` |
...
| **nd_policy**  string | Name of the neighbor discovery interface policy.  **Default:** `""` |
