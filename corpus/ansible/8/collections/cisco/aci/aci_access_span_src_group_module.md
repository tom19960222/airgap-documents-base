...
collection: ansible
version: "8"
title: "cisco.aci.aci_access_span_src_group module – Manage Access SPAN source groups (span:SrcGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_span_src_group_module.html
fetched_at: 2026-07-28T01:18:48+00:00
---
# cisco.aci.aci_access_span_src_group module – Manage Access SPAN source groups (span:SrcGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_access_span_src_group`.

- [Synopsis](aci_access_span_src_group_module.md#synopsis)
- [Parameters](aci_access_span_src_group_module.md#parameters)
- [Notes](aci_access_span_src_group_module.md#notes)
- [See Also](aci_access_span_src_group_module.md#see-also)
- [Examples](aci_access_span_src_group_module.md#examples)
- [Return Values](aci_access_span_src_group_module.md#return-values)

## [Synopsis](aci_access_span_src_group_module.md#id1)

- Manage SPAN source groups on Cisco ACI fabrics.

## [Parameters](aci_access_span_src_group_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Enable `true` or disable `false` the SPAN sources.  The APIC defaults to `true` when unset during creation.  **Choices:**   - `false` - `true` |
...
| **description**  aliases: descr  string | The description for Access SPAN source group. |
| **destination_group**  aliases: dst_group  string | The name of the Access SPAN destination group to associate with the source group. |
...
| **source_group**  aliases: name, src_group  string | The name of the Access SPAN source group. |
...
## [Notes](aci_access_span_src_group_module.md#id3)

> **Note:**
>
> - The *filter_group* and *destination_group* must exist before using this module in your playbook. The [cisco.aci.aci_access_span_filter_group](aci_access_span_filter_group_module.md#ansible-collections-cisco-aci-aci-access-span-filter-group-module) and [cisco.aci.aci_access_span_dst_group](aci_access_span_dst_group_module.md#ansible-collections-cisco-aci-aci-access-span-dst-group-module) modules can be used for this.

## [See Also](aci_access_span_src_group_module.md#id4)
...
>
> [cisco.aci.aci_access_span_dst_group](aci_access_span_dst_group_module.md#ansible-collections-cisco-aci-aci-access-span-dst-group-module)
> :   Manage Access SPAN destination groups (span:DestGrp).
>
...
## [Examples](aci_access_span_src_group_module.md#id5)
...
## [Return Values](aci_access_span_src_group_module.md#id6)
