...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_cdp_module.html
fetched_at: 2026-07-28T01:19:56+00:00
---
...
| Parameter | Comments |
| --- | --- |
| **admin_state**  boolean | Enable or Disable CDP state.  The APIC defaults to `true` when unset during creation.  **Choices:**   - `false` - `true` |
