...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_aep_module.html
fetched_at: 2026-07-28T01:18:51+00:00
---
...
| **infra_vlan**  aliases: infrastructure_vlan  boolean | Enable infrastructure VLAN.  The hypervisor functions of the AEP.  `false` will disable the infrastructure vlan if it is enabled.  **Choices:**   - `false` - `true` |
