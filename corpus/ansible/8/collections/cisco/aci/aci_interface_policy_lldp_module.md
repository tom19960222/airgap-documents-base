...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_lldp_module.html
fetched_at: 2026-07-28T01:20:03+00:00
---
...
| **description**  aliases: descr  string | The description of the LLDP interface policy name. |
...
| **receive_state**  boolean | Enable or disable Receive state.  The APIC defaults to `true` when unset during creation.  **Choices:**   - `false` - `true` |
...
| **transmit_state**  boolean | Enable or Disable Transmit state.  The APIC defaults to `true` when unset during creation.  **Choices:**   - `false` - `true` |
