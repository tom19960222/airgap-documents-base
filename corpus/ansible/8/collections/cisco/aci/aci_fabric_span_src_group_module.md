...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_span_src_group module – Manage Fabric SPAN source groups (span:SrcGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_span_src_group_module.html
fetched_at: 2026-07-28T01:19:41+00:00
---
# cisco.aci.aci_fabric_span_src_group module – Manage Fabric SPAN source groups (span:SrcGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_fabric_span_src_group`.

- [Synopsis](aci_fabric_span_src_group_module.md#synopsis)
- [Parameters](aci_fabric_span_src_group_module.md#parameters)
- [Notes](aci_fabric_span_src_group_module.md#notes)
- [See Also](aci_fabric_span_src_group_module.md#see-also)
- [Examples](aci_fabric_span_src_group_module.md#examples)
- [Return Values](aci_fabric_span_src_group_module.md#return-values)

## [Synopsis](aci_fabric_span_src_group_module.md#id1)

- Manage SPAN source groups on Cisco ACI fabrics.

## [Parameters](aci_fabric_span_src_group_module.md#id2)
...
| **description**  aliases: descr  string | The description for Fabric SPAN source group. |
| **destination_group**  aliases: dst_group  string | The name of the Fabric SPAN destination group to associate with the source group. |
...
| **source_group**  aliases: name, src_group  string | The name of the Fabric SPAN source group. |
...
## [Notes](aci_fabric_span_src_group_module.md#id3)

> **Note:**
>
> - The *destination_group* must exist before using this module in your playbook. The [cisco.aci.aci_fabric_span_dst_group](aci_fabric_span_dst_group_module.md#ansible-collections-cisco-aci-aci-fabric-span-dst-group-module) module can be used for this.

## [See Also](aci_fabric_span_src_group_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_fabric_span_dst_group](aci_fabric_span_dst_group_module.md#ansible-collections-cisco-aci-aci-fabric-span-dst-group-module)
> :   Manage Fabric SPAN destination groups (span:DestGrp).
>
...
## [Examples](aci_fabric_span_src_group_module.md#id5)
...
## [Return Values](aci_fabric_span_src_group_module.md#id6)
