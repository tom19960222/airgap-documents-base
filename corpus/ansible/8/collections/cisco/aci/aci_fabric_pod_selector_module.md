...
collection: ansible
version: "8"
title: "cisco.aci.aci_fabric_pod_selector module – Manage Fabric Pod Selectors (fabric:PodS)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_fabric_pod_selector_module.html
...
- [Synopsis](aci_fabric_pod_selector_module.md#synopsis)
- [Parameters](aci_fabric_pod_selector_module.md#parameters)
- [Notes](aci_fabric_pod_selector_module.md#notes)
- [See Also](aci_fabric_pod_selector_module.md#see-also)
- [Examples](aci_fabric_pod_selector_module.md#examples)
- [Return Values](aci_fabric_pod_selector_module.md#return-values)

## [Synopsis](aci_fabric_pod_selector_module.md#id1)

- Manage Fabric Pod Selectors on Cisco ACI fabrics.

## [Parameters](aci_fabric_pod_selector_module.md#id2)
...
| **blocks**  aliases: pod_id, pod_id_range  string | The pod id(s) associated with the Pod Selector.  Existing blocks will be removed when they are not matching provided blocks.  A comma-separated string of pod ids or ranges of pod ids. (ex. 1,3-4) |
...
| **description**  aliases: descr  string | The description for the Fabric Pod Selector. |
...
| **name**  aliases: selector, pod_selector  string | The name of the Pod Selector. |
...
| **type**  string | The type of the Pod Selector.  **Choices:**   - `"all"` - `"range"` |
...
## [Notes](aci_fabric_pod_selector_module.md#id3)

> **Note:**
>
> - The `pod_profile` must exist before using this module in your playbook.

## [See Also](aci_fabric_pod_selector_module.md#id4)
...
## [Examples](aci_fabric_pod_selector_module.md#id5)
...
## [Return Values](aci_fabric_pod_selector_module.md#id6)
