...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_bd_subnet_module.html
fetched_at: 2026-07-28T01:18:56+00:00
---
...
| **enable_vip**  boolean | Determines if the Subnet should be treated as a VIP; used when the BD is extended to multiple sites.  The APIC defaults to `false` when unset during creation.  **Choices:**   - `false` - `true` |
