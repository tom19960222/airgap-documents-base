...
collection: ansible
version: "8"
title: "cisco.aci.aci_access_span_src_group_src module – Manage Access SPAN sources (span:Src)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_span_src_group_src_module.html
fetched_at: 2026-07-28T01:18:49+00:00
---
# cisco.aci.aci_access_span_src_group_src module – Manage Access SPAN sources (span:Src)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_access_span_src_group_src`.

- [Synopsis](aci_access_span_src_group_src_module.md#synopsis)
- [Parameters](aci_access_span_src_group_src_module.md#parameters)
- [Notes](aci_access_span_src_group_src_module.md#notes)
- [See Also](aci_access_span_src_group_src_module.md#see-also)
- [Examples](aci_access_span_src_group_src_module.md#examples)
- [Return Values](aci_access_span_src_group_src_module.md#return-values)

## [Synopsis](aci_access_span_src_group_src_module.md#id1)

- Manage Access SPAN sources on Cisco ACI fabrics.

## [Parameters](aci_access_span_src_group_src_module.md#id2)
...
| **description**  aliases: descr  string | The description for Access SPAN source. |
...
| **epg**  dictionary | The SPAN source EPG details.  The *epg* and *routed_outside* cannot be configured simultaneously. |
| **ap**  aliases: ap_name, app_profile, app_profile_name  string / required | The name of the SPAN source AP. |
| **epg**  aliases: epg_name  string / required | The name of the SPAN source EPG. |
...
| **routed_outside**  dictionary | The Routed Outside details.  The *epg* and *routed_outside* cannot be configured simultaneously. |
| **encap**  aliases: vlan, vlan_id, encap_id  integer | The VLAN associated with this Routed Outside. |
| **l3out**  aliases: l3out_name  string | The name of the SPAN source L3Out. |
| **tenant**  aliases: tenant_name  string | The name of the SPAN source Tenant. |
| **source**  aliases: name, src  string | The name of the Access SPAN source. |
| **source_group**  aliases: src_group  string | The name of the Access SPAN source group. |
...
## [Notes](aci_access_span_src_group_src_module.md#id3)

> **Note:**
>
> - The *filter_group* and *source_group* must exist before using this module in your playbook. The [cisco.aci.aci_access_span_filter_group](aci_access_span_filter_group_module.md#ansible-collections-cisco-aci-aci-access-span-filter-group-module) and [cisco.aci.aci_access_span_src_group](aci_access_span_src_group_module.md#ansible-collections-cisco-aci-aci-access-span-src-group-module) modules can be used for this.

## [See Also](aci_access_span_src_group_src_module.md#id4)

> **See also:**
>
> [cisco.aci.aci_access_span_filter_group](aci_access_span_filter_group_module.md#ansible-collections-cisco-aci-aci-access-span-filter-group-module)
> :   Manage Access SPAN filter groups (span:FilterGrp).
>
> [cisco.aci.aci_access_span_src_group](aci_access_span_src_group_module.md#ansible-collections-cisco-aci-aci-access-span-src-group-module)
...
## [Examples](aci_access_span_src_group_src_module.md#id5)
...
## [Return Values](aci_access_span_src_group_src_module.md#id6)
