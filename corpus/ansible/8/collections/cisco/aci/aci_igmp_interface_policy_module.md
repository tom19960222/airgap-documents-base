...
collection: ansible
version: "8"
title: "cisco.aci.aci_igmp_interface_policy module – Manage IGMP Interface Policies (igmp:IfPol)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_igmp_interface_policy_module.html
fetched_at: 2026-07-28T01:19:53+00:00
---
...
- [Synopsis](aci_igmp_interface_policy_module.md#synopsis)
- [Parameters](aci_igmp_interface_policy_module.md#parameters)
- [See Also](aci_igmp_interface_policy_module.md#see-also)
- [Examples](aci_igmp_interface_policy_module.md#examples)
- [Return Values](aci_igmp_interface_policy_module.md#return-values)

## [Synopsis](aci_igmp_interface_policy_module.md#id1)

- Manage IGMP Interface Policies on Cisco ACI fabrics.

## [Parameters](aci_igmp_interface_policy_module.md#id2)

| Parameter | Comments |
| --- | --- |
| **allow_v3_asm**  boolean | Enable the Allow v3 ASM option.  The APIC defaults to False when unset during creation.  If this parameter is set, fast_leave and report_link_local_groups must also be set.  **Choices:**   - `false` - `true` |
...
| **fast_leave**  boolean | Enable the Fast Leave option.  The APIC defaults to False when unset during creation.  If this parameter is set, allow_v3_asm and report_link_local_groups must also be set.  **Choices:**   - `false` - `true` |
| **group_timeout**  integer | The IGMP group timeout in seconds.  The APIC defaults to 260 when unset during creation. |
...
| **igmp_version**  string | The IGMP version to run.  The APIC defaults to v2 when unset during creation.  **Choices:**   - `"v2"` - `"v3"` |
| **last_member_count**  integer | The last member query count.  The APIC defaults to 2 when unset during creation. |
| **last_member_response**  integer | The last member response time in seconds.  The APIC defaults to 1 when unset during creation. |
...
| **querier_timeout**  integer | The querier timeout in seconds.  The APIC defaults to 255 when unset during creation. |
| **query_interval**  integer | The IGMP query interval in seconds.  The APIC defaults to 125 when unset during creation. |
| **query_response_interval**  integer | The IGMP query response interval in seconds.  The APIC defaults to 10 when unset during creation. |
| **report_link_local_groups**  boolean | Enable the Report Link Local Groups option.  The APIC defaults to False when unset during creation.  If this parameter is set, allow_v3_asm and fast_leave must also be set.  **Choices:**   - `false` - `true` |
| **robustness_variable**  integer | The robustness factor.  The APIC defaults to 2 when unset during creation. |
| **startup_query_count**  integer | The Startup Query Count.  The APIC defaults to 2 when unset during creation. |
| **startup_query_interval**  integer | The startup query interval in seconds.  The APIC defaults to 31 when unset during creation. |
...
## [See Also](aci_igmp_interface_policy_module.md#id3)
...
## [Examples](aci_igmp_interface_policy_module.md#id4)
...
## [Return Values](aci_igmp_interface_policy_module.md#id5)
