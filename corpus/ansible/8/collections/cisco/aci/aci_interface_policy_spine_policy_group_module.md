...
collection: ansible
version: "8"
title: "cisco.aci.aci_interface_policy_spine_policy_group module – Manage spine access interface policy groups (infra:SpAccPortGrp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_interface_policy_spine_policy_group_module.html
fetched_at: 2026-07-28T01:20:08+00:00
---
# cisco.aci.aci_interface_policy_spine_policy_group module – Manage spine access interface policy groups (infra:SpAccPortGrp)
...
>
> To use it in a playbook, specify: `cisco.aci.aci_interface_policy_spine_policy_group`.

- [Synopsis](aci_interface_policy_spine_policy_group_module.md#synopsis)
- [Parameters](aci_interface_policy_spine_policy_group_module.md#parameters)
- [See Also](aci_interface_policy_spine_policy_group_module.md#see-also)
- [Examples](aci_interface_policy_spine_policy_group_module.md#examples)
- [Return Values](aci_interface_policy_spine_policy_group_module.md#return-values)

## [Synopsis](aci_interface_policy_spine_policy_group_module.md#id1)

- Manage spine access interface policy groups on Cisco ACI fabrics.

## [Parameters](aci_interface_policy_spine_policy_group_module.md#id2)
...
| **attached_entity_profile**  aliases: aep_name, aep  string | The name of the attached entity profile used by the spine access interface |
| **cdp_policy**  aliases: cdp_policy_name  string | The name of the cdp policy used by the spine access interface |
...
| **description**  aliases: descr  string | Description of the spine access interface |
...
| **link_flap_policy**  aliases: link_flap_policy_name  string | The name of the link flap policy used by the spine access interface |
| **link_level_policy**  aliases: link_level_policy_name  string | The name of the link level policy used by the spine access interface |
| **mac_sec_policy**  aliases: mac_sec_policy_name  string | The name of the mac sec policy used by the spine access interface |
...
| **policy_group**  aliases: name, policy_group_name, spine_policy_group_name  string | The name of the spine access interface policy group. |
...
## [See Also](aci_interface_policy_spine_policy_group_module.md#id3)

> **See also:**
>
> [APIC Management Information Model reference](https://developer.cisco.com/docs/apic-mim-ref/)
> :   More information about the internal APIC classes **infra:SpAccPortGrp**.
>
...
## [Examples](aci_interface_policy_spine_policy_group_module.md#id4)
...
## [Return Values](aci_interface_policy_spine_policy_group_module.md#id5)
