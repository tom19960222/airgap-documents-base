...
collection: ansible
version: "8"
title: "cisco.aci.aci_access_span_src_group_src_path module – Manage Access SPAN source paths (span:RsSrcToPathEp)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/aci/aci_access_span_src_group_src_path_module.html
...
- [Synopsis](aci_access_span_src_group_src_path_module.md#synopsis)
- [Parameters](aci_access_span_src_group_src_path_module.md#parameters)
- [Notes](aci_access_span_src_group_src_path_module.md#notes)
- [See Also](aci_access_span_src_group_src_path_module.md#see-also)
- [Examples](aci_access_span_src_group_src_path_module.md#examples)
- [Return Values](aci_access_span_src_group_src_path_module.md#return-values)

## [Synopsis](aci_access_span_src_group_src_path_module.md#id1)

- Manage Access SPAN source paths on Cisco ACI fabrics.

## [Parameters](aci_access_span_src_group_src_path_module.md#id2)
...
| **nodes**  aliases: node_ids  list / elements=integer | The node of the source access path.  Provide one node to the list for port, direct_port_channel or vpc_component_pc types.  Provide two nodes to the list for virtual_port_channel type. |
...
| **source**  aliases: src  string | The name of the Access SPAN source. |
...
## [Notes](aci_access_span_src_group_src_path_module.md#id3)

> **Note:**
>
> - The *source_group* and *source* must exist before using this module in your playbook. The [cisco.aci.aci_access_span_src_group](aci_access_span_src_group_module.md#ansible-collections-cisco-aci-aci-access-span-src-group-module) and [cisco.aci.aci_access_span_src_group_src](aci_access_span_src_group_src_module.md#ansible-collections-cisco-aci-aci-access-span-src-group-src-module) modules can be used for this.

## [See Also](aci_access_span_src_group_src_path_module.md#id4)
...
>
> [cisco.aci.aci_access_span_src_group_src](aci_access_span_src_group_src_module.md#ansible-collections-cisco-aci-aci-access-span-src-group-src-module)
...
## [Examples](aci_access_span_src_group_src_path_module.md#id5)
...
## [Return Values](aci_access_span_src_group_src_path_module.md#id6)
