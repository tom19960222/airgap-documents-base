...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/intersight/intersight_rest_api_module.html
fetched_at: 2026-07-28T01:25:59+00:00
---
...
| **list_body**  list / elements=string | The paylod for API requests used to modify resources.  Should be used instead of api_body if a list is required in the API payload. |
