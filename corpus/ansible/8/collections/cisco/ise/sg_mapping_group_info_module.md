...
collection: ansible
version: "8"
title: "cisco.ise.sg_mapping_group_info module – Information module for SG Mapping Group"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/sg_mapping_group_info_module.html
fetched_at: 2026-07-28T01:30:55+00:00
---
# cisco.ise.sg_mapping_group_info module – Information module for SG Mapping Group
...
> see [Requirements](sg_mapping_group_info_module.md#ansible-collections-cisco-ise-sg-mapping-group-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sg_mapping_group_info`.

New in cisco.ise 1.0.0

- [Synopsis](sg_mapping_group_info_module.md#synopsis)
- [Requirements](sg_mapping_group_info_module.md#requirements)
- [Parameters](sg_mapping_group_info_module.md#parameters)
- [Notes](sg_mapping_group_info_module.md#notes)
- [See Also](sg_mapping_group_info_module.md#see-also)
- [Examples](sg_mapping_group_info_module.md#examples)
- [Return Values](sg_mapping_group_info_module.md#return-values)

## [Synopsis](sg_mapping_group_info_module.md#id1)
...
## [Requirements](sg_mapping_group_info_module.md#id2)
...
## [Parameters](sg_mapping_group_info_module.md#id3)
...
## [Notes](sg_mapping_group_info_module.md#id4)

> **Note:**
>
> - SDK Method used are ip_to_sgt_mapping_group.IpToSgtMappingGroup.get_ip_to_sgt_mapping_group_by_id, ip_to_sgt_mapping_group.IpToSgtMappingGroup.get_ip_to_sgt_mapping_group_generator,
> - Paths used are get /ers/config/sgmappinggroup, get /ers/config/sgmappinggroup/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [See Also](sg_mapping_group_info_module.md#id5)
...
## [Examples](sg_mapping_group_info_module.md#id6)
...
## [Return Values](sg_mapping_group_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  **Returned:** always  **Sample:** `{"deployTo": "string", "deployType": "string", "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "sgt": "string"}` |
