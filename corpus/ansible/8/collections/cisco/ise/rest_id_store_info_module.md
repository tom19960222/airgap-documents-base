...
collection: ansible
version: "8"
title: "cisco.ise.rest_id_store_info module – Information module for REST Id Store"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/rest_id_store_info_module.html
fetched_at: 2026-07-28T01:30:39+00:00
---
# cisco.ise.rest_id_store_info module – Information module for REST Id Store
...
> see [Requirements](rest_id_store_info_module.md#ansible-collections-cisco-ise-rest-id-store-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.rest_id_store_info`.

New in cisco.ise 1.0.0

- [Synopsis](rest_id_store_info_module.md#synopsis)
- [Requirements](rest_id_store_info_module.md#requirements)
- [Parameters](rest_id_store_info_module.md#parameters)
- [Notes](rest_id_store_info_module.md#notes)
- [Examples](rest_id_store_info_module.md#examples)
- [Return Values](rest_id_store_info_module.md#return-values)

## [Synopsis](rest_id_store_info_module.md#id1)
...
## [Requirements](rest_id_store_info_module.md#id2)
...
## [Parameters](rest_id_store_info_module.md#id3)
...
## [Notes](rest_id_store_info_module.md#id4)

> **Note:**
>
> - SDK Method used are restid_store.RestidStore.get_rest_id_store_by_id, restid_store.RestidStore.get_rest_id_store_by_name, restid_store.RestidStore.get_rest_id_store_generator,
> - Paths used are get /ers/config/restidstore, get /ers/config/restidstore/name/{name}, get /ers/config/restidstore/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](rest_id_store_info_module.md#id5)
...
## [Return Values](rest_id_store_info_module.md#id6)
