...
collection: ansible
version: "8"
title: "cisco.ise.active_directory_add_groups module – Resource module for Active Directory Add Groups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/active_directory_add_groups_module.html
fetched_at: 2026-07-28T01:27:07+00:00
---
# cisco.ise.active_directory_add_groups module – Resource module for Active Directory Add Groups
...
> see [Requirements](active_directory_add_groups_module.md#ansible-collections-cisco-ise-active-directory-add-groups-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.active_directory_add_groups`.

New in cisco.ise 1.0.0

- [Synopsis](active_directory_add_groups_module.md#synopsis)
- [Requirements](active_directory_add_groups_module.md#requirements)
- [Parameters](active_directory_add_groups_module.md#parameters)
- [Notes](active_directory_add_groups_module.md#notes)
- [Examples](active_directory_add_groups_module.md#examples)
- [Return Values](active_directory_add_groups_module.md#return-values)

## [Synopsis](active_directory_add_groups_module.md#id1)
...
## [Requirements](active_directory_add_groups_module.md#id2)
...
## [Parameters](active_directory_add_groups_module.md#id3)
...
| **advancedSettings**  dictionary | Active Directory Add Groups’s advancedSettings. |
...
## [Notes](active_directory_add_groups_module.md#id4)

> **Note:**
>
> - SDK Method used are active_directory.ActiveDirectory.load_groups_from_domain,
> - Paths used are put /ers/config/activedirectory/{id}/addGroups,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](active_directory_add_groups_module.md#id5)
...
## [Return Values](active_directory_add_groups_module.md#id6)
