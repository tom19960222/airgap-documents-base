...
collection: ansible
version: "8"
title: "cisco.ise.hotspot_portal_info module – Information module for Hotspot Portal"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/hotspot_portal_info_module.html
fetched_at: 2026-07-28T01:28:45+00:00
---
# cisco.ise.hotspot_portal_info module – Information module for Hotspot Portal
...
> see [Requirements](hotspot_portal_info_module.md#ansible-collections-cisco-ise-hotspot-portal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.hotspot_portal_info`.

New in cisco.ise 1.0.0

- [Synopsis](hotspot_portal_info_module.md#synopsis)
- [Requirements](hotspot_portal_info_module.md#requirements)
- [Parameters](hotspot_portal_info_module.md#parameters)
- [Notes](hotspot_portal_info_module.md#notes)
- [Examples](hotspot_portal_info_module.md#examples)
- [Return Values](hotspot_portal_info_module.md#return-values)

## [Synopsis](hotspot_portal_info_module.md#id1)
...
## [Requirements](hotspot_portal_info_module.md#id2)
...
## [Parameters](hotspot_portal_info_module.md#id3)
...
## [Notes](hotspot_portal_info_module.md#id4)

> **Note:**
>
> - SDK Method used are hotspot_portal.HotspotPortal.get_hotspot_portal_by_id, hotspot_portal.HotspotPortal.get_hotspot_portal_generator,
> - Paths used are get /ers/config/hotspotportal, get /ers/config/hotspotportal/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](hotspot_portal_info_module.md#id5)
...
## [Return Values](hotspot_portal_info_module.md#id6)
