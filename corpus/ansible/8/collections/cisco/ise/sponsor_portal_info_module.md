...
collection: ansible
version: "8"
title: "cisco.ise.sponsor_portal_info module – Information module for Sponsor Portal"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/sponsor_portal_info_module.html
fetched_at: 2026-07-28T01:31:06+00:00
---
# cisco.ise.sponsor_portal_info module – Information module for Sponsor Portal
...
> see [Requirements](sponsor_portal_info_module.md#ansible-collections-cisco-ise-sponsor-portal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.sponsor_portal_info`.

New in cisco.ise 1.0.0

- [Synopsis](sponsor_portal_info_module.md#synopsis)
- [Requirements](sponsor_portal_info_module.md#requirements)
- [Parameters](sponsor_portal_info_module.md#parameters)
- [Notes](sponsor_portal_info_module.md#notes)
- [Examples](sponsor_portal_info_module.md#examples)
- [Return Values](sponsor_portal_info_module.md#return-values)

## [Synopsis](sponsor_portal_info_module.md#id1)
...
## [Requirements](sponsor_portal_info_module.md#id2)
...
## [Parameters](sponsor_portal_info_module.md#id3)
...
## [Notes](sponsor_portal_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sponsor_portal.SponsorPortal.get_sponsor_portal_by_id, sponsor_portal.SponsorPortal.get_sponsor_portal_generator,
> - Paths used are get /ers/config/sponsorportal, get /ers/config/sponsorportal/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](sponsor_portal_info_module.md#id5)
...
## [Return Values](sponsor_portal_info_module.md#id6)
