...
collection: ansible
version: "8"
title: "cisco.ise.portal_info module – Information module for Portal"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/portal_info_module.html
fetched_at: 2026-07-28T01:30:05+00:00
---
# cisco.ise.portal_info module – Information module for Portal
...
> see [Requirements](portal_info_module.md#ansible-collections-cisco-ise-portal-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.portal_info`.

New in cisco.ise 1.0.0

- [Synopsis](portal_info_module.md#synopsis)
- [Requirements](portal_info_module.md#requirements)
- [Parameters](portal_info_module.md#parameters)
- [Notes](portal_info_module.md#notes)
- [Examples](portal_info_module.md#examples)
- [Return Values](portal_info_module.md#return-values)

## [Synopsis](portal_info_module.md#id1)
...
## [Requirements](portal_info_module.md#id2)
...
## [Parameters](portal_info_module.md#id3)
...
## [Notes](portal_info_module.md#id4)

> **Note:**
>
> - SDK Method used are portal.Portal.get_portal_by_id, portal.Portal.get_portals_generator,
> - Paths used are get /ers/config/portal, get /ers/config/portal/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](portal_info_module.md#id5)
...
## [Return Values](portal_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **ise_response**  dictionary | A dictionary or list with the response returned by the Cisco ISE Python SDK  **Returned:** always  **Sample:** `{"description": "string", "id": "string", "link": {"href": "string", "rel": "string", "type": "string"}, "name": "string", "portalType": "string"}` |
