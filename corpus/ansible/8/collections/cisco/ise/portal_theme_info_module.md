...
collection: ansible
version: "8"
title: "cisco.ise.portal_theme_info module – Information module for Portal Theme"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/portal_theme_info_module.html
fetched_at: 2026-07-28T01:30:06+00:00
---
# cisco.ise.portal_theme_info module – Information module for Portal Theme
...
> see [Requirements](portal_theme_info_module.md#ansible-collections-cisco-ise-portal-theme-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.portal_theme_info`.

New in cisco.ise 1.0.0

- [Synopsis](portal_theme_info_module.md#synopsis)
- [Requirements](portal_theme_info_module.md#requirements)
- [Parameters](portal_theme_info_module.md#parameters)
- [Notes](portal_theme_info_module.md#notes)
- [Examples](portal_theme_info_module.md#examples)
- [Return Values](portal_theme_info_module.md#return-values)

## [Synopsis](portal_theme_info_module.md#id1)
...
## [Requirements](portal_theme_info_module.md#id2)
...
## [Parameters](portal_theme_info_module.md#id3)
...
## [Notes](portal_theme_info_module.md#id4)

> **Note:**
>
> - SDK Method used are portal_theme.PortalTheme.get_portal_theme_by_id, portal_theme.PortalTheme.get_portal_themes_generator,
> - Paths used are get /ers/config/portaltheme, get /ers/config/portaltheme/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](portal_theme_info_module.md#id5)
...
## [Return Values](portal_theme_info_module.md#id6)
