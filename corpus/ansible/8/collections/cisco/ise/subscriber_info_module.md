...
collection: ansible
version: "8"
title: "cisco.ise.subscriber_info module – Information module for Subscriber"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/subscriber_info_module.html
fetched_at: 2026-07-28T01:31:10+00:00
---
# cisco.ise.subscriber_info module – Information module for Subscriber
...
> see [Requirements](subscriber_info_module.md#ansible-collections-cisco-ise-subscriber-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.subscriber_info`.

New in cisco.ise 3.2_beta

- [Synopsis](subscriber_info_module.md#synopsis)
- [Requirements](subscriber_info_module.md#requirements)
- [Parameters](subscriber_info_module.md#parameters)
- [Notes](subscriber_info_module.md#notes)
- [Examples](subscriber_info_module.md#examples)
- [Return Values](subscriber_info_module.md#return-values)

## [Synopsis](subscriber_info_module.md#id1)
...
## [Requirements](subscriber_info_module.md#id2)
...
## [Notes](subscriber_info_module.md#id4)

> **Note:**
>
> - SDK Method used are subscriber.Subscriber.get_all_subscribers_generator, subscriber.Subscriber.get_subscriber_by_id,
> - Paths used are get /api/v1/fiveg/subscriber, get /api/v1/fiveg/subscriber/{subscriberId},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](subscriber_info_module.md#id5)
...
## [Return Values](subscriber_info_module.md#id6)
