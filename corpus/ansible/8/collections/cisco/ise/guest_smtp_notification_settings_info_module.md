...
collection: ansible
version: "8"
title: "cisco.ise.guest_smtp_notification_settings_info module – Information module for Guest SMTP Notification Settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/guest_smtp_notification_settings_info_module.html
fetched_at: 2026-07-28T01:28:29+00:00
---
# cisco.ise.guest_smtp_notification_settings_info module – Information module for Guest SMTP Notification Settings
...
> see [Requirements](guest_smtp_notification_settings_info_module.md#ansible-collections-cisco-ise-guest-smtp-notification-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.guest_smtp_notification_settings_info`.

New in cisco.ise 1.0.0

- [Synopsis](guest_smtp_notification_settings_info_module.md#synopsis)
- [Requirements](guest_smtp_notification_settings_info_module.md#requirements)
- [Parameters](guest_smtp_notification_settings_info_module.md#parameters)
- [Notes](guest_smtp_notification_settings_info_module.md#notes)
- [Examples](guest_smtp_notification_settings_info_module.md#examples)
- [Return Values](guest_smtp_notification_settings_info_module.md#return-values)

## [Synopsis](guest_smtp_notification_settings_info_module.md#id1)
...
## [Requirements](guest_smtp_notification_settings_info_module.md#id2)
...
## [Parameters](guest_smtp_notification_settings_info_module.md#id3)
...
## [Notes](guest_smtp_notification_settings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are guest_smtp_notification_configuration.GuestSmtpNotificationConfiguration.get_guest_smtp_notification_settings_by_id, guest_smtp_notification_configuration.GuestSmtpNotificationConfiguration.get_guest_smtp_notification_settings_generator,
> - Paths used are get /ers/config/guestsmtpnotificationsettings, get /ers/config/guestsmtpnotificationsettings/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](guest_smtp_notification_settings_info_module.md#id5)
...
## [Return Values](guest_smtp_notification_settings_info_module.md#id6)
