...
collection: ansible
version: "8"
title: "cisco.ise.guest_location_info module – Information module for Guest Location"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/guest_location_info_module.html
fetched_at: 2026-07-28T01:28:27+00:00
---
# cisco.ise.guest_location_info module – Information module for Guest Location
...
> see [Requirements](guest_location_info_module.md#ansible-collections-cisco-ise-guest-location-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.guest_location_info`.

New in cisco.ise 1.0.0

- [Synopsis](guest_location_info_module.md#synopsis)
- [Requirements](guest_location_info_module.md#requirements)
- [Parameters](guest_location_info_module.md#parameters)
- [Notes](guest_location_info_module.md#notes)
- [Examples](guest_location_info_module.md#examples)
- [Return Values](guest_location_info_module.md#return-values)

## [Synopsis](guest_location_info_module.md#id1)
...
## [Requirements](guest_location_info_module.md#id2)
...
## [Parameters](guest_location_info_module.md#id3)
...
## [Notes](guest_location_info_module.md#id4)

> **Note:**
>
> - SDK Method used are guest_location.GuestLocation.get_guest_location_by_id, guest_location.GuestLocation.get_guest_location_generator,
> - Paths used are get /ers/config/guestlocation, get /ers/config/guestlocation/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco ISE SDK
> - The parameters starting with ise_ are used by the Cisco ISE Python SDK to establish the connection

## [Examples](guest_location_info_module.md#id5)
...
## [Return Values](guest_location_info_module.md#id6)
