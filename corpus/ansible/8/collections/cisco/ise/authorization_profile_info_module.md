...
collection: ansible
version: "8"
title: "cisco.ise.authorization_profile_info module – Information module for Authorization Profile"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/ise/authorization_profile_info_module.html
fetched_at: 2026-07-28T01:27:24+00:00
---
# cisco.ise.authorization_profile_info module – Information module for Authorization Profile
...
> see [Requirements](authorization_profile_info_module.md#ansible-collections-cisco-ise-authorization-profile-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.ise.authorization_profile_info`.

New in cisco.ise 1.0.0

- [Synopsis](authorization_profile_info_module.md#synopsis)
- [Requirements](authorization_profile_info_module.md#requirements)
- [Parameters](authorization_profile_info_module.md#parameters)
- [Notes](authorization_profile_info_module.md#notes)
- [Examples](authorization_profile_info_module.md#examples)
- [Return Values](authorization_profile_info_module.md#return-values)

## [Synopsis](authorization_profile_info_module.md#id1)
...
## [Requirements](authorization_profile_info_module.md#id2)
...
## [Parameters](authorization_profile_info_module.md#id3)
...
## [Notes](authorization_profile_info_module.md#id4)
...
## [Examples](authorization_profile_info_module.md#id5)
...
## [Return Values](authorization_profile_info_module.md#id6)
