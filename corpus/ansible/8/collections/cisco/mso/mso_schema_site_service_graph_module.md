...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_site_service_graph module – Manage Service Graph in schema sites"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_site_service_graph_module.html
fetched_at: 2026-07-28T01:37:53+00:00
---
# cisco.mso.mso_schema_site_service_graph module – Manage Service Graph in schema sites
...
> see [Requirements](mso_schema_site_service_graph_module.md#ansible-collections-cisco-mso-mso-schema-site-service-graph-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_service_graph`.

- [Synopsis](mso_schema_site_service_graph_module.md#synopsis)
- [Requirements](mso_schema_site_service_graph_module.md#requirements)
- [Parameters](mso_schema_site_service_graph_module.md#parameters)
- [Notes](mso_schema_site_service_graph_module.md#notes)
- [Examples](mso_schema_site_service_graph_module.md#examples)

## [Synopsis](mso_schema_site_service_graph_module.md#id1)
...
## [Requirements](mso_schema_site_service_graph_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_service_graph_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **devices**  list / elements=dictionary | A list of devices to be associated with the Service Graph. |
...
## [Notes](mso_schema_site_service_graph_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_schema_site_service_graph_module.md#id5)
