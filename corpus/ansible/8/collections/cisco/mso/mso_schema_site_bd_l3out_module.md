...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_site_bd_l3out module – Manage site-local BD l3out’s in schema template"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_site_bd_l3out_module.html
fetched_at: 2026-07-28T01:37:49+00:00
---
# cisco.mso.mso_schema_site_bd_l3out module – Manage site-local BD l3out’s in schema template
...
> see [Requirements](mso_schema_site_bd_l3out_module.md#ansible-collections-cisco-mso-mso-schema-site-bd-l3out-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_bd_l3out`.

- [Synopsis](mso_schema_site_bd_l3out_module.md#synopsis)
- [Requirements](mso_schema_site_bd_l3out_module.md#requirements)
- [Parameters](mso_schema_site_bd_l3out_module.md#parameters)
- [Notes](mso_schema_site_bd_l3out_module.md#notes)
- [See Also](mso_schema_site_bd_l3out_module.md#see-also)
- [Examples](mso_schema_site_bd_l3out_module.md#examples)

## [Synopsis](mso_schema_site_bd_l3out_module.md#id1)

- Manage site-local BDs l3out’s in schema template on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_bd_l3out_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_bd_l3out_module.md#id3)
...
| **l3out**  dictionary | The l3out associated to this BD. |
...
| **template**  string | The template that defines the referenced l3out.  If this parameter is unspecified, it defaults to the current schema. |
...
## [Notes](mso_schema_site_bd_l3out_module.md#id4)
...
## [See Also](mso_schema_site_bd_l3out_module.md#id5)
...
## [Examples](mso_schema_site_bd_l3out_module.md#id6)
