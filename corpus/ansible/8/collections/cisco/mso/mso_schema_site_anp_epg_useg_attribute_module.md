...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_site_anp_epg_useg_attribute module – Manage EPG Site uSeg Attributes in schema sites"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_site_anp_epg_useg_attribute_module.html
fetched_at: 2026-07-28T01:37:48+00:00
---
# cisco.mso.mso_schema_site_anp_epg_useg_attribute module – Manage EPG Site uSeg Attributes in schema sites
...
> see [Requirements](mso_schema_site_anp_epg_useg_attribute_module.md#ansible-collections-cisco-mso-mso-schema-site-anp-epg-useg-attribute-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_site_anp_epg_useg_attribute`.

- [Synopsis](mso_schema_site_anp_epg_useg_attribute_module.md#synopsis)
- [Requirements](mso_schema_site_anp_epg_useg_attribute_module.md#requirements)
- [Parameters](mso_schema_site_anp_epg_useg_attribute_module.md#parameters)
- [Notes](mso_schema_site_anp_epg_useg_attribute_module.md#notes)
- [Examples](mso_schema_site_anp_epg_useg_attribute_module.md#examples)

## [Synopsis](mso_schema_site_anp_epg_useg_attribute_module.md#id1)

- Manage Site uSeg Attributes in the schema site EPGs on Cisco ACI Multi-Site.

## [Requirements](mso_schema_site_anp_epg_useg_attribute_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_site_anp_epg_useg_attribute_module.md#id3)
...
## [Notes](mso_schema_site_anp_epg_useg_attribute_module.md#id4)
...
## [Examples](mso_schema_site_anp_epg_useg_attribute_module.md#id5)
