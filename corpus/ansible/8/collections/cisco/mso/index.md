...
version: "8"
title: "Cisco.Mso"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/index.html
fetched_at: 2026-07-28T01:02:02+00:00
---
# Cisco.Mso
...
- [mso_schema_site_anp_epg_bulk_staticport module](mso_schema_site_anp_epg_bulk_staticport_module.md#ansible-collections-cisco-mso-mso-schema-site-anp-epg-bulk-staticport-module) – Manage site-local EPG static ports in bulk in schema template
...
- [mso_schema_site_anp_epg_useg_attribute module](mso_schema_site_anp_epg_useg_attribute_module.md#ansible-collections-cisco-mso-mso-schema-site-anp-epg-useg-attribute-module) – Manage EPG Site uSeg Attributes in schema sites
...
- [mso_schema_template_anp_epg_useg_attribute module](mso_schema_template_anp_epg_useg_attribute_module.md#ansible-collections-cisco-mso-mso-schema-template-anp-epg-useg-attribute-module) – Manage EPG uSeg Attributes in schema templates
...
- [ndo_schema_template_deploy module](ndo_schema_template_deploy_module.md#ansible-collections-cisco-mso-ndo-schema-template-deploy-module) – Deploy schema templates to sites for NDO v3.7 and higher
