...
collection: ansible
version: "8"
title: "cisco.mso.mso_version module – Get version of MSO"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_version_module.html
fetched_at: 2026-07-28T01:38:19+00:00
---
# cisco.mso.mso_version module – Get version of MSO
...
> see [Requirements](mso_version_module.md#ansible-collections-cisco-mso-mso-version-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_version`.

- [Synopsis](mso_version_module.md#synopsis)
- [Requirements](mso_version_module.md#requirements)
- [Parameters](mso_version_module.md#parameters)
- [Notes](mso_version_module.md#notes)
- [Examples](mso_version_module.md#examples)

## [Synopsis](mso_version_module.md#id1)

- Retrieve the code version of Cisco Multi-Site Orchestrator.

## [Requirements](mso_version_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_version_module.md#id3)
...
| **state**  string | Use `query` for retrieving the version object.  **Choices:**   - `"query"` ← (default) |
...
## [Notes](mso_version_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_version_module.md#id5)
