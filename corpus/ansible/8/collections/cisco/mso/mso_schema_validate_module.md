...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_validate module – Validate the schema before deploying it to site"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_validate_module.html
fetched_at: 2026-07-28T01:38:15+00:00
---
...
> see [Requirements](mso_schema_validate_module.md#ansible-collections-cisco-mso-mso-schema-validate-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_validate`.

New in cisco.mso 1.3.0

- [Synopsis](mso_schema_validate_module.md#synopsis)
- [Requirements](mso_schema_validate_module.md#requirements)
- [Parameters](mso_schema_validate_module.md#parameters)
- [Notes](mso_schema_validate_module.md#notes)
- [See Also](mso_schema_validate_module.md#see-also)
- [Examples](mso_schema_validate_module.md#examples)

## [Synopsis](mso_schema_validate_module.md#id1)
...
## [Requirements](mso_schema_validate_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_validate_module.md#id3)
...
| **state**  string | Use `query` to validate deploying the schema.  **Choices:**   - `"query"` ← (default) |
...
## [Notes](mso_schema_validate_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_validate_module.md#id5)
...
## [Examples](mso_schema_validate_module.md#id6)
