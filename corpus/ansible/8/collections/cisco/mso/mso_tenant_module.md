...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_tenant_module.html
fetched_at: 2026-07-28T01:38:17+00:00
---
...
| **orchestrator_only**  string | Orchestrator Only `no` is used to delete the tenant from the MSO and Sites/APIC.  `yes` is used to remove the tenant only from the MSO.  **Choices:**   - `"yes"` ← (default) - `"no"` |
