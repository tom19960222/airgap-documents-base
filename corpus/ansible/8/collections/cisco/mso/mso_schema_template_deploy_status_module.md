...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_template_deploy_status module – Check query of objects before deployment to site"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_template_deploy_status_module.html
fetched_at: 2026-07-28T01:38:07+00:00
---
# cisco.mso.mso_schema_template_deploy_status module – Check query of objects before deployment to site
...
> see [Requirements](mso_schema_template_deploy_status_module.md#ansible-collections-cisco-mso-mso-schema-template-deploy-status-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_deploy_status`.

- [Synopsis](mso_schema_template_deploy_status_module.md#synopsis)
- [Requirements](mso_schema_template_deploy_status_module.md#requirements)
- [Parameters](mso_schema_template_deploy_status_module.md#parameters)
- [Notes](mso_schema_template_deploy_status_module.md#notes)
- [Examples](mso_schema_template_deploy_status_module.md#examples)

## [Synopsis](mso_schema_template_deploy_status_module.md#id1)

- Check query of objects in a template of a schema

## [Requirements](mso_schema_template_deploy_status_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_deploy_status_module.md#id3)
...
| **state**  string | Use `query` for listing query of objects.  **Choices:**   - `"query"` ← (default) |
...
## [Notes](mso_schema_template_deploy_status_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_schema_template_deploy_status_module.md#id5)
