...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_template_l3out module – Manage l3outs in schema templates"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_template_l3out_module.html
fetched_at: 2026-07-28T01:38:11+00:00
---
...
> see [Requirements](mso_schema_template_l3out_module.md#ansible-collections-cisco-mso-mso-schema-template-l3out-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_l3out`.

- [Synopsis](mso_schema_template_l3out_module.md#synopsis)
- [Requirements](mso_schema_template_l3out_module.md#requirements)
- [Parameters](mso_schema_template_l3out_module.md#parameters)
- [Notes](mso_schema_template_l3out_module.md#notes)
- [Examples](mso_schema_template_l3out_module.md#examples)

## [Synopsis](mso_schema_template_l3out_module.md#id1)

- Manage l3outs in schema templates on Cisco ACI Multi-Site.

## [Requirements](mso_schema_template_l3out_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_l3out_module.md#id3)
...
## [Notes](mso_schema_template_l3out_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_schema_template_l3out_module.md#id5)
