...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_template_vrf_contract module – Manage vrf contracts in schema templates"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_template_vrf_contract_module.html
fetched_at: 2026-07-28T01:38:14+00:00
---
# cisco.mso.mso_schema_template_vrf_contract module – Manage vrf contracts in schema templates
...
> see [Requirements](mso_schema_template_vrf_contract_module.md#ansible-collections-cisco-mso-mso-schema-template-vrf-contract-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_vrf_contract`.

New in cisco.mso 0.0.8

- [Synopsis](mso_schema_template_vrf_contract_module.md#synopsis)
- [Requirements](mso_schema_template_vrf_contract_module.md#requirements)
- [Parameters](mso_schema_template_vrf_contract_module.md#parameters)
- [Notes](mso_schema_template_vrf_contract_module.md#notes)
- [See Also](mso_schema_template_vrf_contract_module.md#see-also)
- [Examples](mso_schema_template_vrf_contract_module.md#examples)

## [Synopsis](mso_schema_template_vrf_contract_module.md#id1)

- Manage vrf contracts in schema templates on Cisco ACI Multi-Site.

## [Requirements](mso_schema_template_vrf_contract_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_vrf_contract_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **contract**  dictionary | A contract associated to this VRF. |
| **name**  string / required | The name of the Contract to associate with. |
| **schema**  string | The schema that defines the referenced contract.  If this parameter is unspecified, it defaults to the current schema. |
| **template**  string | The template that defines the referenced contract. |
...
## [Notes](mso_schema_template_vrf_contract_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_template_vrf_contract_module.md#id5)
...
## [Examples](mso_schema_template_vrf_contract_module.md#id6)
