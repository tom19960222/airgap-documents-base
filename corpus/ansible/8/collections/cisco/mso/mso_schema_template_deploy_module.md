...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_template_deploy module – Deploy schema templates to sites"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_template_deploy_module.html
fetched_at: 2026-07-28T01:38:07+00:00
---
...
> see [Requirements](mso_schema_template_deploy_module.md#ansible-collections-cisco-mso-mso-schema-template-deploy-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_deploy`.

- [Synopsis](mso_schema_template_deploy_module.md#synopsis)
- [Requirements](mso_schema_template_deploy_module.md#requirements)
- [Parameters](mso_schema_template_deploy_module.md#parameters)
- [Notes](mso_schema_template_deploy_module.md#notes)
- [See Also](mso_schema_template_deploy_module.md#see-also)
- [Examples](mso_schema_template_deploy_module.md#examples)

## [Synopsis](mso_schema_template_deploy_module.md#id1)
...
- When schema validation fails, [cisco.mso.mso_schema_template_deploy](mso_schema_template_deploy_module.md#ansible-collections-cisco-mso-mso-schema-template-deploy-module) fails and deploy will not be executed.
- DEPRECATED for NDO v4.1 and later. Use [cisco.mso.ndo_schema_template_deploy](ndo_schema_template_deploy_module.md#ansible-collections-cisco-mso-ndo-schema-template-deploy-module) on NDO v4.1 and later.

## [Requirements](mso_schema_template_deploy_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_deploy_module.md#id3)
...
| **state**  string | Use `deploy` to deploy schema template.  Use `status` to get deployment status.  Use `undeploy` to deploy schema template from a site.  **Choices:**   - `"deploy"` ← (default) - `"status"` - `"undeploy"` |
| **template**  aliases: name  string / required | The name of the template. |
...
## [Notes](mso_schema_template_deploy_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [See Also](mso_schema_template_deploy_module.md#id5)
...
## [Examples](mso_schema_template_deploy_module.md#id6)
