...
collection: ansible
version: "8"
title: "cisco.mso.mso_dhcp_relay_policy module – Manage DHCP Relay policies."
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_dhcp_relay_policy_module.html
fetched_at: 2026-07-28T01:37:36+00:00
---
# cisco.mso.mso_dhcp_relay_policy module – Manage DHCP Relay policies.
...
> see [Requirements](mso_dhcp_relay_policy_module.md#ansible-collections-cisco-mso-mso-dhcp-relay-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_dhcp_relay_policy`.

- [Synopsis](mso_dhcp_relay_policy_module.md#synopsis)
- [Requirements](mso_dhcp_relay_policy_module.md#requirements)
- [Parameters](mso_dhcp_relay_policy_module.md#parameters)
- [Notes](mso_dhcp_relay_policy_module.md#notes)
- [Examples](mso_dhcp_relay_policy_module.md#examples)

## [Synopsis](mso_dhcp_relay_policy_module.md#id1)

- Manage DHCP Relay policies on Cisco Multi-Site Orchestrator.

## [Requirements](mso_dhcp_relay_policy_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_dhcp_relay_policy_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **description**  string | Description of the DHCP Relay Policy |
| **dhcp_relay_policy**  aliases: name  string | Name of the DHCP Relay Policy |
...
## [Notes](mso_dhcp_relay_policy_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_dhcp_relay_policy_module.md#id5)
