...
collection: ansible
version: "8"
title: "cisco.mso.mso_schema_template_vrf module – Manage VRFs in schema templates"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_schema_template_vrf_module.html
fetched_at: 2026-07-28T01:38:14+00:00
---
# cisco.mso.mso_schema_template_vrf module – Manage VRFs in schema templates
...
> see [Requirements](mso_schema_template_vrf_module.md#ansible-collections-cisco-mso-mso-schema-template-vrf-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_schema_template_vrf`.

- [Synopsis](mso_schema_template_vrf_module.md#synopsis)
- [Requirements](mso_schema_template_vrf_module.md#requirements)
- [Parameters](mso_schema_template_vrf_module.md#parameters)
- [Notes](mso_schema_template_vrf_module.md#notes)
- [Examples](mso_schema_template_vrf_module.md#examples)

## [Synopsis](mso_schema_template_vrf_module.md#id1)

- Manage VRFs in schema templates on Cisco ACI Multi-Site.

## [Requirements](mso_schema_template_vrf_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_schema_template_vrf_module.md#id3)
...
| **ip_data_plane_learning**  string | Whether IP data plane learning is enabled or disabled.  The APIC defaults to `enabled` when unset during creation.  **Choices:**   - `"disabled"` - `"enabled"` |
...
| **preferred_group**  boolean | Whether to enable preferred Endpoint Group.  The APIC defaults to `false` when unset during creation.  **Choices:**   - `false` - `true` |
...
| **vrf**  aliases: name  string | The name of the VRF to manage. |
| **vzany**  boolean | Whether to enable vzAny.  **Choices:**   - `false` - `true` |

## [Notes](mso_schema_template_vrf_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_schema_template_vrf_module.md#id5)
