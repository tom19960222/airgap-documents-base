...
collection: ansible
version: "8"
title: "cisco.mso.mso_backup_schedule module – Manages backup schedules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/mso/mso_backup_schedule_module.html
...
> see [Requirements](mso_backup_schedule_module.md#ansible-collections-cisco-mso-mso-backup-schedule-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.mso.mso_backup_schedule`.

- [Synopsis](mso_backup_schedule_module.md#synopsis)
- [Requirements](mso_backup_schedule_module.md#requirements)
- [Parameters](mso_backup_schedule_module.md#parameters)
- [Notes](mso_backup_schedule_module.md#notes)
- [Examples](mso_backup_schedule_module.md#examples)

## [Synopsis](mso_backup_schedule_module.md#id1)

- Manage backup schedules on Cisco ACI Multi-Site.

## [Requirements](mso_backup_schedule_module.md#id2)

The below requirements are needed on the host that executes this module.

- Multi Site Orchestrator v2.1 or newer

## [Parameters](mso_backup_schedule_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **frequency_length**  integer | Amount of hours or days for the schedule trigger frequency |
| **frequency_unit**  string | The interval unit type  **Choices:**   - `"hours"` - `"days"` |
...
## [Notes](mso_backup_schedule_module.md#id4)

> **Note:**
>
> - This module was written to support Multi Site Orchestrator v2.1 or newer. Some or all functionality may not work on earlier versions.

## [Examples](mso_backup_schedule_module.md#id5)
