...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/iosxr/iosxr_bgp_global_module.html
fetched_at: 2026-07-28T01:26:37+00:00
---
...
- [Return Values](iosxr_bgp_global_module.md#return-values)
...
| **set**  boolean | set fast-detect  **Choices:**   - `false` - `true` |
...
| **no_prepend**  dictionary | Do not prepend local AS to announcements from this neighbor. |
| **replace_as**  dictionary | Prepend only local AS to announcements to this neighbor. |
| **dual_as**  boolean | Dual-AS mode.  **Choices:**   - `false` - `true` |
| **set**  boolean | Prepend only local AS to announcements to this neighbor.  **Choices:**   - `false` - `true` |
| **set**  boolean | Do not prepend local AS to announcements from this neighbor.  **Choices:**   - `false` - `true` |
...
| **validation**  dictionary | BGP origin-AS validation knobs. |
| **disable**  boolean | Disable RPKI origin-AS validation.  **Choices:**   - `false` - `true` |
| **password**  dictionary | Set a password. |
| **encrypted**  string | Specifies an ENCRYPTED password will follow. |
| **inheritance_disable**  boolean | Prevent password from being inherited from parent.  **Choices:**   - `false` - `true` |
...
| **use**  dictionary | Use a neighbor-group and session-group template. |
| **neighbor_group**  string | Inherit configuration from a neighbor-group. |
| **session_group**  string | Inherit address-family independent config from a session-group |
...
## [Return Values](iosxr_bgp_global_module.md#id5)
...
| **commands**  list / elements=string | The set of commands pushed to the remote device.  **Returned:** always  **Sample:** `["router bgp 65536", "bgp cluster-id 5", "bgp router-id 192.0.2.10", "bgp bestpath med confed"]` |
...
| **rendered**  list / elements=string | The provided configuration in the task rendered in device-native format (offline).  **Returned:** when *state* is `rendered`  **Sample:** `["router bgp 1", "default-metric 4", "vrf vrf3"]` |
