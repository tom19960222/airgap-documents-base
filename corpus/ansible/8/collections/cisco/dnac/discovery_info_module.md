...
collection: ansible
version: "8"
title: "cisco.dnac.discovery_info module – Information module for Discovery"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/discovery_info_module.html
fetched_at: 2026-07-28T01:22:10+00:00
---
...
> see [Requirements](discovery_info_module.md#ansible-collections-cisco-dnac-discovery-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.discovery_info`.

New in cisco.dnac 3.1.0

- [Synopsis](discovery_info_module.md#synopsis)
- [Requirements](discovery_info_module.md#requirements)
- [Parameters](discovery_info_module.md#parameters)
- [Notes](discovery_info_module.md#notes)
- [See Also](discovery_info_module.md#see-also)
- [Examples](discovery_info_module.md#examples)
- [Return Values](discovery_info_module.md#return-values)

## [Synopsis](discovery_info_module.md#id1)
...
## [Requirements](discovery_info_module.md#id2)
...
## [Parameters](discovery_info_module.md#id3)
...
## [Notes](discovery_info_module.md#id4)

> **Note:**
>
> - SDK Method used are discovery.Discovery.get_discovery_by_id,
> - Paths used are get /dna/intent/api/v1/discovery/{id},
> - Supports `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](discovery_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Discovery GetDiscoveryById](https://developer.cisco.com/docs/dna-center/#!get-discovery-by-id)
> :   Complete reference of the GetDiscoveryById API.

## [Examples](discovery_info_module.md#id6)
...
## [Return Values](discovery_info_module.md#id7)
