...
collection: ansible
version: "8"
title: "cisco.dnac.reserve_ip_subpool_update module – Resource module for Reserve Ip Subpool Update"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/reserve_ip_subpool_update_module.html
...
> see [Requirements](reserve_ip_subpool_update_module.md#ansible-collections-cisco-dnac-reserve-ip-subpool-update-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.reserve_ip_subpool_update`.

New in cisco.dnac 4.0.0

- [Synopsis](reserve_ip_subpool_update_module.md#synopsis)
- [Requirements](reserve_ip_subpool_update_module.md#requirements)
- [Parameters](reserve_ip_subpool_update_module.md#parameters)
- [Notes](reserve_ip_subpool_update_module.md#notes)
- [See Also](reserve_ip_subpool_update_module.md#see-also)
- [Examples](reserve_ip_subpool_update_module.md#examples)
- [Return Values](reserve_ip_subpool_update_module.md#return-values)

## [Synopsis](reserve_ip_subpool_update_module.md#id1)
...
## [Requirements](reserve_ip_subpool_update_module.md#id2)
...
## [Parameters](reserve_ip_subpool_update_module.md#id3)
...
| **id**  string | Id query parameter. Id of subpool to be associated with the site. |
...
| **ipv4GateWay**  string | Ipv4 Gate Way. |
...
| **ipv6GlobalPool**  string | IP v6 Global pool address with cidr this is required when Ipv6AddressSpace value is true, example 2001 db8 85a3 /64. |
...
## [Notes](reserve_ip_subpool_update_module.md#id4)
...
## [See Also](reserve_ip_subpool_update_module.md#id5)
...
## [Examples](reserve_ip_subpool_update_module.md#id6)
...
## [Return Values](reserve_ip_subpool_update_module.md#id7)
