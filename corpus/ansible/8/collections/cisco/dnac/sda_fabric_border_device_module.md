...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/sda_fabric_border_device_module.html
fetched_at: 2026-07-28T01:24:29+00:00
---
...
| **borderPriority**  string | Border priority associated with a given device. Allowed range for Border Priority is 1-9. A lower value indicates higher priority. E.g., a priority of 1 takes precedence over 5. Default priority would be set to 10. |
...
| **virtualNetwork**  dictionary  *added in cisco.dnac 4.0.0* | Sda Fabric Border Device’s virtualNetwork. |
| **virtualNetworkName**  string  *added in cisco.dnac 4.0.0* | Virtual Network Name, that is associated to Fabric Site. |
