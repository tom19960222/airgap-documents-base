...
collection: ansible
version: "8"
title: "cisco.dnac.event_series_audit_logs_info module – Information module for Event Series Audit Logs"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/event_series_audit_logs_info_module.html
fetched_at: 2026-07-28T01:22:26+00:00
---
...
> see [Requirements](event_series_audit_logs_info_module.md#ansible-collections-cisco-dnac-event-series-audit-logs-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.event_series_audit_logs_info`.

New in cisco.dnac 3.1.0

- [Synopsis](event_series_audit_logs_info_module.md#synopsis)
- [Requirements](event_series_audit_logs_info_module.md#requirements)
- [Parameters](event_series_audit_logs_info_module.md#parameters)
- [Notes](event_series_audit_logs_info_module.md#notes)
- [See Also](event_series_audit_logs_info_module.md#see-also)
- [Examples](event_series_audit_logs_info_module.md#examples)
- [Return Values](event_series_audit_logs_info_module.md#return-values)

## [Synopsis](event_series_audit_logs_info_module.md#id1)
...
## [Requirements](event_series_audit_logs_info_module.md#id2)
...
## [Parameters](event_series_audit_logs_info_module.md#id3)
...
## [Notes](event_series_audit_logs_info_module.md#id4)
...
## [See Also](event_series_audit_logs_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Event Management GetAuditLogRecords](https://developer.cisco.com/docs/dna-center/#!get-audit-log-records)
> :   Complete reference of the GetAuditLogRecords API.

## [Examples](event_series_audit_logs_info_module.md#id6)
...
## [Return Values](event_series_audit_logs_info_module.md#id7)
