...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/swim_intent_module.html
fetched_at: 2026-07-28T01:25:13+00:00
---
...
| **imageName**  string | SWIM image’s name |
| **imageName**  string | SWIM Image name. |
| **importImageDetails**  dictionary | Details of image being imported |
| **localImageDetails**  dictionary | Details of the local path of the image to be imported. |
...
| **type**  string | The source of import, supports url import or local import. |
...
| **state**  string | The state of DNAC after module completion.  **Choices:**   - `"merged"` ← (default) |
