...
collection: ansible
version: "8"
title: "cisco.dnac.network_device_inventory_insight_link_mismatch_info module – Information module for Network Device Inventory Insight Link Mismatch"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/network_device_inventory_insight_link_mismatch_info_module.html
fetched_at: 2026-07-28T01:23:28+00:00
---
...
> see [Requirements](network_device_inventory_insight_link_mismatch_info_module.md#ansible-collections-cisco-dnac-network-device-inventory-insight-link-mismatch-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.network_device_inventory_insight_link_mismatch_info`.

New in cisco.dnac 3.1.0

- [Synopsis](network_device_inventory_insight_link_mismatch_info_module.md#synopsis)
- [Requirements](network_device_inventory_insight_link_mismatch_info_module.md#requirements)
- [Parameters](network_device_inventory_insight_link_mismatch_info_module.md#parameters)
- [Notes](network_device_inventory_insight_link_mismatch_info_module.md#notes)
- [See Also](network_device_inventory_insight_link_mismatch_info_module.md#see-also)
- [Examples](network_device_inventory_insight_link_mismatch_info_module.md#examples)
- [Return Values](network_device_inventory_insight_link_mismatch_info_module.md#return-values)

## [Synopsis](network_device_inventory_insight_link_mismatch_info_module.md#id1)
...
## [Requirements](network_device_inventory_insight_link_mismatch_info_module.md#id2)
...
## [Parameters](network_device_inventory_insight_link_mismatch_info_module.md#id3)
...
## [Notes](network_device_inventory_insight_link_mismatch_info_module.md#id4)
...
## [See Also](network_device_inventory_insight_link_mismatch_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Devices InventoryInsightDeviceLinkMismatchAPI](https://developer.cisco.com/docs/dna-center/#!inventory-insight-device-link-mismatch-api)
> :   Complete reference of the InventoryInsightDeviceLinkMismatchAPI API.

## [Examples](network_device_inventory_insight_link_mismatch_info_module.md#id6)
...
## [Return Values](network_device_inventory_insight_link_mismatch_info_module.md#id7)
