...
collection: ansible
version: "8"
title: "cisco.dnac.pnp_device_count_info module – Information module for Pnp Device Count"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/pnp_device_count_info_module.html
fetched_at: 2026-07-28T01:23:57+00:00
---
...
> see [Requirements](pnp_device_count_info_module.md#ansible-collections-cisco-dnac-pnp-device-count-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.pnp_device_count_info`.

New in cisco.dnac 3.1.0

- [Synopsis](pnp_device_count_info_module.md#synopsis)
- [Requirements](pnp_device_count_info_module.md#requirements)
- [Parameters](pnp_device_count_info_module.md#parameters)
- [Notes](pnp_device_count_info_module.md#notes)
- [See Also](pnp_device_count_info_module.md#see-also)
- [Examples](pnp_device_count_info_module.md#examples)
- [Return Values](pnp_device_count_info_module.md#return-values)

## [Synopsis](pnp_device_count_info_module.md#id1)
...
## [Requirements](pnp_device_count_info_module.md#id2)
...
## [Parameters](pnp_device_count_info_module.md#id3)
...
## [Notes](pnp_device_count_info_module.md#id4)
...
## [See Also](pnp_device_count_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Device Onboarding (PnP) GetDeviceCount](https://developer.cisco.com/docs/dna-center/#!get-device-count-2)
> :   Complete reference of the GetDeviceCount API.

## [Examples](pnp_device_count_info_module.md#id6)
...
## [Return Values](pnp_device_count_info_module.md#id7)
