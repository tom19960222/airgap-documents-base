...
collection: ansible
version: "8"
title: "cisco.dnac.configuration_template_project module – Resource module for Configuration Template Project"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/configuration_template_project_module.html
fetched_at: 2026-07-28T01:21:46+00:00
---
...
> see [Requirements](configuration_template_project_module.md#ansible-collections-cisco-dnac-configuration-template-project-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.configuration_template_project`.

New in cisco.dnac 3.1.0

- [Synopsis](configuration_template_project_module.md#synopsis)
- [Requirements](configuration_template_project_module.md#requirements)
- [Parameters](configuration_template_project_module.md#parameters)
- [Notes](configuration_template_project_module.md#notes)
- [See Also](configuration_template_project_module.md#see-also)
- [Examples](configuration_template_project_module.md#examples)
- [Return Values](configuration_template_project_module.md#return-values)

## [Synopsis](configuration_template_project_module.md#id1)
...
## [Requirements](configuration_template_project_module.md#id2)
...
## [Parameters](configuration_template_project_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **createTime**  integer | Create time of project. |
...
| **lastUpdateTime**  integer | Update time of project. |
| **name**  string | Name of project. |
| **projectId**  string | ProjectId path parameter. ProjectId(UUID) of project to be deleted. |
| **tags**  list / elements=dictionary | Configuration Template Project’s tags. |
| **id**  string | UUID of tag. |
| **name**  string | Name of tag. |
| **templates**  list / elements=dictionary | List of templates within the project. |
| **author**  string | Author of template. |
| **composite**  boolean | Is it composite template.  **Choices:**   - `false` - `true` |
| **containingTemplates**  list / elements=dictionary | Configuration Template Project’s containingTemplates. |
| **composite**  boolean | Is it composite template.  **Choices:**   - `false` - `true` |
| **description**  string | Description of template. |
| **deviceTypes**  list / elements=dictionary | Configuration Template Project’s deviceTypes. |
...
| **rollbackTemplateParams**  list / elements=dictionary | Configuration Template Project’s rollbackTemplateParams. |
...
| **range**  list / elements=dictionary | Configuration Template Project’s range. |
...
| **selection**  dictionary | Configuration Template Project’s selection. |
...
| **templateParams**  list / elements=dictionary | Configuration Template Project’s templateParams. |
| **binding**  string | Bind to source. |
| **customOrder**  integer | CustomOrder of template param. |
| **dataType**  string | Datatype of template param. |
| **defaultValue**  string | Default value of template param. |
...
| **selectionType**  string | Type of selection(SINGLE_SELECT or MULTI_SELECT). |
| **selectionValues**  dictionary | Selection values. |
| **validationErrors**  dictionary | Configuration Template Project’s validationErrors. |
...
## [Notes](configuration_template_project_module.md#id4)
...
## [See Also](configuration_template_project_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Configuration Templates CreateProject](https://developer.cisco.com/docs/dna-center/#!create-project)
> :   Complete reference of the CreateProject API.
>
> [Cisco DNA Center documentation for Configuration Templates DeletesTheProject](https://developer.cisco.com/docs/dna-center/#!deletes-the-project)
> :   Complete reference of the DeletesTheProject API.
>
> [Cisco DNA Center documentation for Configuration Templates UpdateProject](https://developer.cisco.com/docs/dna-center/#!update-project)
> :   Complete reference of the UpdateProject API.

## [Examples](configuration_template_project_module.md#id6)
...
## [Return Values](configuration_template_project_module.md#id7)
