...
collection: ansible
version: "8"
title: "cisco.dnac.client_detail_info module – Information module for Client Detail"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/dnac/client_detail_info_module.html
...
> see [Requirements](client_detail_info_module.md#ansible-collections-cisco-dnac-client-detail-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.dnac.client_detail_info`.

New in cisco.dnac 3.1.0

- [Synopsis](client_detail_info_module.md#synopsis)
- [Requirements](client_detail_info_module.md#requirements)
- [Parameters](client_detail_info_module.md#parameters)
- [Notes](client_detail_info_module.md#notes)
- [See Also](client_detail_info_module.md#see-also)
- [Examples](client_detail_info_module.md#examples)
- [Return Values](client_detail_info_module.md#return-values)

## [Synopsis](client_detail_info_module.md#id1)
...
## [Requirements](client_detail_info_module.md#id2)
...
## [Parameters](client_detail_info_module.md#id3)
...
## [Notes](client_detail_info_module.md#id4)
...
## [See Also](client_detail_info_module.md#id5)

> **See also:**
>
> [Cisco DNA Center documentation for Clients GetClientDetail](https://developer.cisco.com/docs/dna-center/#!get-client-detail)
> :   Complete reference of the GetClientDetail API.

## [Examples](client_detail_info_module.md#id6)
