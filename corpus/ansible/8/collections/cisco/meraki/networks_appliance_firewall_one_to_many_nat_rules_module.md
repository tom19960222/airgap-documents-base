...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_firewall_one_to_many_nat_rules module – Resource module for networks _appliance _firewall _onetomanynatrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_firewall_one_to_many_nat_rules_module.html
fetched_at: 2026-07-28T01:33:04+00:00
---
# cisco.meraki.networks_appliance_firewall_one_to_many_nat_rules module – Resource module for networks _appliance _firewall _onetomanynatrules
...
> see [Requirements](networks_appliance_firewall_one_to_many_nat_rules_module.md#ansible-collections-cisco-meraki-networks-appliance-firewall-one-to-many-nat-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_firewall_one_to_many_nat_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_firewall_one_to_many_nat_rules_module.md#synopsis)
- [Requirements](networks_appliance_firewall_one_to_many_nat_rules_module.md#requirements)
- [Parameters](networks_appliance_firewall_one_to_many_nat_rules_module.md#parameters)
- [Notes](networks_appliance_firewall_one_to_many_nat_rules_module.md#notes)
- [See Also](networks_appliance_firewall_one_to_many_nat_rules_module.md#see-also)
- [Examples](networks_appliance_firewall_one_to_many_nat_rules_module.md#examples)
- [Return Values](networks_appliance_firewall_one_to_many_nat_rules_module.md#return-values)

## [Synopsis](networks_appliance_firewall_one_to_many_nat_rules_module.md#id1)
...
## [Requirements](networks_appliance_firewall_one_to_many_nat_rules_module.md#id2)
...
## [Parameters](networks_appliance_firewall_one_to_many_nat_rules_module.md#id3)
...
| **rules**  list / elements=dictionary | An array of 1 Many nat rules. |
| **portRules**  list / elements=dictionary | An array of associated forwarding rules. |
| **allowedIps**  list / elements=string | Remote IP addresses or ranges that are permitted to access the internal resource via this port forwarding rule, or ‘any’. |
...
## [Notes](networks_appliance_firewall_one_to_many_nat_rules_module.md#id4)
...
## [See Also](networks_appliance_firewall_one_to_many_nat_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceFirewallOneToManyNatRules](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-firewall-one-to-many-nat-rules)
> :   Complete reference of the updateNetworkApplianceFirewallOneToManyNatRules API.

## [Examples](networks_appliance_firewall_one_to_many_nat_rules_module.md#id6)
...
## [Return Values](networks_appliance_firewall_one_to_many_nat_rules_module.md#id7)
