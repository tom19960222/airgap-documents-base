...
collection: ansible
version: "8"
title: "cisco.meraki.networks_webhooks_http_servers_info module – Information module for networks _webhooks _httpservers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_webhooks_http_servers_info_module.html
fetched_at: 2026-07-28T01:35:28+00:00
---
# cisco.meraki.networks_webhooks_http_servers_info module – Information module for networks _webhooks _httpservers
...
> see [Requirements](networks_webhooks_http_servers_info_module.md#ansible-collections-cisco-meraki-networks-webhooks-http-servers-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_webhooks_http_servers_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_webhooks_http_servers_info_module.md#synopsis)
- [Requirements](networks_webhooks_http_servers_info_module.md#requirements)
- [Parameters](networks_webhooks_http_servers_info_module.md#parameters)
- [Notes](networks_webhooks_http_servers_info_module.md#notes)
- [See Also](networks_webhooks_http_servers_info_module.md#see-also)
- [Examples](networks_webhooks_http_servers_info_module.md#examples)
- [Return Values](networks_webhooks_http_servers_info_module.md#return-values)

## [Synopsis](networks_webhooks_http_servers_info_module.md#id1)
...
## [Requirements](networks_webhooks_http_servers_info_module.md#id2)
...
## [Parameters](networks_webhooks_http_servers_info_module.md#id3)
...
## [Notes](networks_webhooks_http_servers_info_module.md#id4)
...
## [See Also](networks_webhooks_http_servers_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkWebhooksHttpServer](https://developer.cisco.com/meraki/api-v1/#!get-network-webhooks-http-server)
> :   Complete reference of the getNetworkWebhooksHttpServer API.
>
> [Cisco Meraki documentation for networks getNetworkWebhooksHttpServers](https://developer.cisco.com/meraki/api-v1/#!get-network-webhooks-http-servers)
> :   Complete reference of the getNetworkWebhooksHttpServers API.

## [Examples](networks_webhooks_http_servers_info_module.md#id6)
...
## [Return Values](networks_webhooks_http_servers_info_module.md#id7)
