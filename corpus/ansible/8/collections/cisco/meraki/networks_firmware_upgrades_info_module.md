...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_info module – Information module for networks _firmwareupgrades"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_info_module.html
fetched_at: 2026-07-28T01:33:57+00:00
---
# cisco.meraki.networks_firmware_upgrades_info module – Information module for networks _firmwareupgrades
...
> see [Requirements](networks_firmware_upgrades_info_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_info_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_info_module.md#requirements)
- [Parameters](networks_firmware_upgrades_info_module.md#parameters)
- [Notes](networks_firmware_upgrades_info_module.md#notes)
- [See Also](networks_firmware_upgrades_info_module.md#see-also)
- [Examples](networks_firmware_upgrades_info_module.md#examples)
- [Return Values](networks_firmware_upgrades_info_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_info_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_info_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_info_module.md#id3)
...
## [Notes](networks_firmware_upgrades_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_firmware_upgrades,
> - Paths used are get /networks/{networkId}/firmwareUpgrades,
> - Supports `check_mode`
...
## [See Also](networks_firmware_upgrades_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkFirmwareUpgrades](https://developer.cisco.com/meraki/api-v1/#!get-network-firmware-upgrades)
> :   Complete reference of the getNetworkFirmwareUpgrades API.

## [Examples](networks_firmware_upgrades_info_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_info_module.md#id7)
