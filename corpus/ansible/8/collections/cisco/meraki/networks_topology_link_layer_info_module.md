...
collection: ansible
version: "8"
title: "cisco.meraki.networks_topology_link_layer_info module – Information module for networks _topology _linklayer"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_topology_link_layer_info_module.html
fetched_at: 2026-07-28T01:35:22+00:00
---
# cisco.meraki.networks_topology_link_layer_info module – Information module for networks _topology _linklayer
...
> see [Requirements](networks_topology_link_layer_info_module.md#ansible-collections-cisco-meraki-networks-topology-link-layer-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_topology_link_layer_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_topology_link_layer_info_module.md#synopsis)
- [Requirements](networks_topology_link_layer_info_module.md#requirements)
- [Parameters](networks_topology_link_layer_info_module.md#parameters)
- [Notes](networks_topology_link_layer_info_module.md#notes)
- [See Also](networks_topology_link_layer_info_module.md#see-also)
- [Examples](networks_topology_link_layer_info_module.md#examples)
- [Return Values](networks_topology_link_layer_info_module.md#return-values)

## [Synopsis](networks_topology_link_layer_info_module.md#id1)
...
## [Requirements](networks_topology_link_layer_info_module.md#id2)
...
## [Parameters](networks_topology_link_layer_info_module.md#id3)
...
## [Notes](networks_topology_link_layer_info_module.md#id4)
...
## [See Also](networks_topology_link_layer_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkTopologyLinkLayer](https://developer.cisco.com/meraki/api-v1/#!get-network-topology-link-layer)
> :   Complete reference of the getNetworkTopologyLinkLayer API.

## [Examples](networks_topology_link_layer_info_module.md#id6)
...
## [Return Values](networks_topology_link_layer_info_module.md#id7)
