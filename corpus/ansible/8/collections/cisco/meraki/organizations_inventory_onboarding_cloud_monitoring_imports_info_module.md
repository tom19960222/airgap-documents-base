...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_imports_info module – Information module for organizations _inventory _onboarding _cloudmonitoring _imports"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_inventory_onboarding_cloud_monitoring_imports_info_module.html
fetched_at: 2026-07-28T01:36:58+00:00
---
# cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_imports_info module – Information module for organizations _inventory _onboarding _cloudmonitoring _imports
...
> see [Requirements](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#ansible-collections-cisco-meraki-organizations-inventory-onboarding-cloud-monitoring-imports-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_imports_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#synopsis)
- [Requirements](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#requirements)
- [Parameters](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#parameters)
- [Notes](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#notes)
- [See Also](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#see-also)
- [Examples](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#examples)
- [Return Values](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#return-values)

## [Synopsis](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id1)
...
## [Requirements](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id2)
...
## [Parameters](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **headers**  dictionary | Additional headers. |
| **importIds**  list / elements=string | ImportIds query parameter. Import ids from an imports. |
...
## [Notes](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id4)
...
## [See Also](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationInventoryOnboardingCloudMonitoringImports](https://developer.cisco.com/meraki/api-v1/#!get-organization-inventory-onboarding-cloud-monitoring-imports)
> :   Complete reference of the getOrganizationInventoryOnboardingCloudMonitoringImports API.

## [Examples](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id6)
...
## [Return Values](organizations_inventory_onboarding_cloud_monitoring_imports_info_module.md#id7)
