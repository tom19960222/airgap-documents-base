...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_custom_analytics module – Resource module for devices _camera _customanalytics"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_custom_analytics_module.html
fetched_at: 2026-07-28T01:31:45+00:00
---
# cisco.meraki.devices_camera_custom_analytics module – Resource module for devices _camera _customanalytics
...
> see [Requirements](devices_camera_custom_analytics_module.md#ansible-collections-cisco-meraki-devices-camera-custom-analytics-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_custom_analytics`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_custom_analytics_module.md#synopsis)
- [Requirements](devices_camera_custom_analytics_module.md#requirements)
- [Parameters](devices_camera_custom_analytics_module.md#parameters)
- [Notes](devices_camera_custom_analytics_module.md#notes)
- [See Also](devices_camera_custom_analytics_module.md#see-also)
- [Examples](devices_camera_custom_analytics_module.md#examples)
- [Return Values](devices_camera_custom_analytics_module.md#return-values)

## [Synopsis](devices_camera_custom_analytics_module.md#id1)
...
## [Requirements](devices_camera_custom_analytics_module.md#id2)
...
## [Parameters](devices_camera_custom_analytics_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **artifactId**  string | The ID of the custom analytics artifact. |
| **enabled**  boolean | Enable custom analytics.  **Choices:**   - `false` - `true` |
...
| **parameters**  list / elements=dictionary | Parameters for the custom analytics workload. |
| **name**  string | Name of the parameter. |
| **value**  string | Value of the parameter. |
| **serial**  string | Serial path parameter. |

## [Notes](devices_camera_custom_analytics_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.update_device_camera_custom_analytics,
> - Paths used are put /devices/{serial}/camera/customAnalytics,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_camera_custom_analytics_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceCameraCustomAnalytics](https://developer.cisco.com/meraki/api-v1/#!update-device-camera-custom-analytics)
> :   Complete reference of the updateDeviceCameraCustomAnalytics API.

## [Examples](devices_camera_custom_analytics_module.md#id6)
...
## [Return Values](devices_camera_custom_analytics_module.md#id7)
