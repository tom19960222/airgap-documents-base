...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_clients_overview_info module – Information module for organizations _clients _overview"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_clients_overview_info_module.html
fetched_at: 2026-07-28T01:36:34+00:00
---
# cisco.meraki.organizations_clients_overview_info module – Information module for organizations _clients _overview
...
> see [Requirements](organizations_clients_overview_info_module.md#ansible-collections-cisco-meraki-organizations-clients-overview-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_clients_overview_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_clients_overview_info_module.md#synopsis)
- [Requirements](organizations_clients_overview_info_module.md#requirements)
- [Parameters](organizations_clients_overview_info_module.md#parameters)
- [Notes](organizations_clients_overview_info_module.md#notes)
- [See Also](organizations_clients_overview_info_module.md#see-also)
- [Examples](organizations_clients_overview_info_module.md#examples)
- [Return Values](organizations_clients_overview_info_module.md#return-values)

## [Synopsis](organizations_clients_overview_info_module.md#id1)
...
## [Requirements](organizations_clients_overview_info_module.md#id2)
...
## [Parameters](organizations_clients_overview_info_module.md#id3)
...
## [Notes](organizations_clients_overview_info_module.md#id4)
...
## [See Also](organizations_clients_overview_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationClientsOverview](https://developer.cisco.com/meraki/api-v1/#!get-organization-clients-overview)
> :   Complete reference of the getOrganizationClientsOverview API.

## [Examples](organizations_clients_overview_info_module.md#id6)
...
## [Return Values](organizations_clients_overview_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"counts": {"total": 0}, "usage": {"average": 0, "overall": {"downstream": 0, "total": 0, "upstream": 0}}}` |
