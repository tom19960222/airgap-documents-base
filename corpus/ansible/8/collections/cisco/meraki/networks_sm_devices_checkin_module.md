...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_checkin module – Resource module for networks _sm _devices _checkin"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_checkin_module.html
fetched_at: 2026-07-28T01:34:28+00:00
---
# cisco.meraki.networks_sm_devices_checkin module – Resource module for networks _sm _devices _checkin
...
> see [Requirements](networks_sm_devices_checkin_module.md#ansible-collections-cisco-meraki-networks-sm-devices-checkin-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_checkin`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_checkin_module.md#synopsis)
- [Requirements](networks_sm_devices_checkin_module.md#requirements)
- [Parameters](networks_sm_devices_checkin_module.md#parameters)
- [Notes](networks_sm_devices_checkin_module.md#notes)
- [See Also](networks_sm_devices_checkin_module.md#see-also)
- [Examples](networks_sm_devices_checkin_module.md#examples)
- [Return Values](networks_sm_devices_checkin_module.md#return-values)

## [Synopsis](networks_sm_devices_checkin_module.md#id1)
...
## [Requirements](networks_sm_devices_checkin_module.md#id2)
...
## [Parameters](networks_sm_devices_checkin_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **ids**  list / elements=string | The ids of the devices to be checked-in. |
...
| **scope**  list / elements=string | The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be checked-in. |
| **serials**  list / elements=string | The serials of the devices to be checked-in. |
| **wifiMacs**  list / elements=string | The wifiMacs of the devices to be checked-in. |

## [Notes](networks_sm_devices_checkin_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.checkin_network_sm_devices,
> - Paths used are post /networks/{networkId}/sm/devices/checkin,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_sm_devices_checkin_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm checkinNetworkSmDevices](https://developer.cisco.com/meraki/api-v1/#!checkin-network-sm-devices)
> :   Complete reference of the checkinNetworkSmDevices API.

## [Examples](networks_sm_devices_checkin_module.md#id6)
...
## [Return Values](networks_sm_devices_checkin_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"ids": ["string"]}` |
