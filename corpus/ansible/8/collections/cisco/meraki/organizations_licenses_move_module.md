...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licenses_move module – Resource module for organizations _licenses _move"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licenses_move_module.html
fetched_at: 2026-07-28T01:37:03+00:00
---
# cisco.meraki.organizations_licenses_move module – Resource module for organizations _licenses _move
...
> see [Requirements](organizations_licenses_move_module.md#ansible-collections-cisco-meraki-organizations-licenses-move-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licenses_move`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licenses_move_module.md#synopsis)
- [Requirements](organizations_licenses_move_module.md#requirements)
- [Parameters](organizations_licenses_move_module.md#parameters)
- [Notes](organizations_licenses_move_module.md#notes)
- [See Also](organizations_licenses_move_module.md#see-also)
- [Examples](organizations_licenses_move_module.md#examples)
- [Return Values](organizations_licenses_move_module.md#return-values)

## [Synopsis](organizations_licenses_move_module.md#id1)
...
## [Requirements](organizations_licenses_move_module.md#id2)
...
## [Parameters](organizations_licenses_move_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **destOrganizationId**  string | The ID of the organization to move the licenses to. |
| **licenseIds**  list / elements=string | A list of IDs of licenses to move to the new organization. |
...
## [Notes](organizations_licenses_move_module.md#id4)
...
## [See Also](organizations_licenses_move_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations moveOrganizationLicenses](https://developer.cisco.com/meraki/api-v1/#!move-organization-licenses)
> :   Complete reference of the moveOrganizationLicenses API.

## [Examples](organizations_licenses_move_module.md#id6)
...
## [Return Values](organizations_licenses_move_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"destOrganizationId": "string", "licenseIds": ["string"]}` |
