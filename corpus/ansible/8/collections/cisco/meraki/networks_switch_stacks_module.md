...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stacks module – Resource module for networks _switch _stacks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stacks_module.html
fetched_at: 2026-07-28T01:35:11+00:00
---
# cisco.meraki.networks_switch_stacks module – Resource module for networks _switch _stacks
...
> see [Requirements](networks_switch_stacks_module.md#ansible-collections-cisco-meraki-networks-switch-stacks-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stacks`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stacks_module.md#synopsis)
- [Requirements](networks_switch_stacks_module.md#requirements)
- [Parameters](networks_switch_stacks_module.md#parameters)
- [Notes](networks_switch_stacks_module.md#notes)
- [See Also](networks_switch_stacks_module.md#see-also)
- [Examples](networks_switch_stacks_module.md#examples)
- [Return Values](networks_switch_stacks_module.md#return-values)

## [Synopsis](networks_switch_stacks_module.md#id1)
...
## [Requirements](networks_switch_stacks_module.md#id2)
...
## [Parameters](networks_switch_stacks_module.md#id3)
...
| **serials**  list / elements=string | An array of switch serials to be added into the new stack. |
| **switchStackId**  string | SwitchStackId path parameter. Switch stack ID. |

## [Notes](networks_switch_stacks_module.md#id4)
...
## [See Also](networks_switch_stacks_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch createNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/#!create-network-switch-stack)
> :   Complete reference of the createNetworkSwitchStack API.
>
> [Cisco Meraki documentation for switch deleteNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/#!delete-network-switch-stack)
> :   Complete reference of the deleteNetworkSwitchStack API.

## [Examples](networks_switch_stacks_module.md#id6)
...
## [Return Values](networks_switch_stacks_module.md#id7)
