...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_switch_devices_clone module – Resource module for organizations _switch _devices _clone"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_switch_devices_clone_module.html
fetched_at: 2026-07-28T01:37:27+00:00
---
# cisco.meraki.organizations_switch_devices_clone module – Resource module for organizations _switch _devices _clone
...
> see [Requirements](organizations_switch_devices_clone_module.md#ansible-collections-cisco-meraki-organizations-switch-devices-clone-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_switch_devices_clone`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_switch_devices_clone_module.md#synopsis)
- [Requirements](organizations_switch_devices_clone_module.md#requirements)
- [Parameters](organizations_switch_devices_clone_module.md#parameters)
- [Notes](organizations_switch_devices_clone_module.md#notes)
- [See Also](organizations_switch_devices_clone_module.md#see-also)
- [Examples](organizations_switch_devices_clone_module.md#examples)
- [Return Values](organizations_switch_devices_clone_module.md#return-values)

## [Synopsis](organizations_switch_devices_clone_module.md#id1)
...
## [Requirements](organizations_switch_devices_clone_module.md#id2)
...
## [Parameters](organizations_switch_devices_clone_module.md#id3)
...
| **targetSerials**  list / elements=string | Array of serial numbers of one or more target switches (must be on a network not bound to a template). |

## [Notes](organizations_switch_devices_clone_module.md#id4)
...
## [See Also](organizations_switch_devices_clone_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch cloneOrganizationSwitchDevices](https://developer.cisco.com/meraki/api-v1/#!clone-organization-switch-devices)
> :   Complete reference of the cloneOrganizationSwitchDevices API.

## [Examples](organizations_switch_devices_clone_module.md#id6)
...
## [Return Values](organizations_switch_devices_clone_module.md#id7)
