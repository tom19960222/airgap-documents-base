...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_export_events module – Resource module for organizations _inventory _onboarding _cloudmonitoring _exportevents"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_inventory_onboarding_cloud_monitoring_export_events_module.html
fetched_at: 2026-07-28T01:36:56+00:00
---
# cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_export_events module – Resource module for organizations _inventory _onboarding _cloudmonitoring _exportevents
...
> see [Requirements](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#ansible-collections-cisco-meraki-organizations-inventory-onboarding-cloud-monitoring-export-events-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_inventory_onboarding_cloud_monitoring_export_events`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#synopsis)
- [Requirements](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#requirements)
- [Parameters](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#parameters)
- [Notes](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#notes)
- [See Also](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#see-also)
- [Examples](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#examples)
- [Return Values](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#return-values)

## [Synopsis](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id1)
...
## [Requirements](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id2)
...
## [Parameters](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id3)
...
## [Notes](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id4)
...
## [See Also](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationInventoryOnboardingCloudMonitoringExportEvent](https://developer.cisco.com/meraki/api-v1/#!create-organization-inventory-onboarding-cloud-monitoring-export-event)
> :   Complete reference of the createOrganizationInventoryOnboardingCloudMonitoringExportEvent API.

## [Examples](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id6)
...
## [Return Values](organizations_inventory_onboarding_cloud_monitoring_export_events_module.md#id7)
