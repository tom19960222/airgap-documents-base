...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_stages_info module – Information module for networks _firmwareupgrades _staged _stages"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_stages_info_module.html
fetched_at: 2026-07-28T01:34:04+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_stages_info module – Information module for networks _firmwareupgrades _staged _stages
...
> see [Requirements](networks_firmware_upgrades_staged_stages_info_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-stages-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_stages_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_stages_info_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_stages_info_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_stages_info_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_stages_info_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_stages_info_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_stages_info_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_stages_info_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_stages_info_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_stages_info_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_stages_info_module.md#id3)
...
## [Notes](networks_firmware_upgrades_staged_stages_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_firmware_upgrades_staged_stages,
> - Paths used are get /networks/{networkId}/firmwareUpgrades/staged/stages,
> - Supports `check_mode`
...
## [See Also](networks_firmware_upgrades_staged_stages_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkFirmwareUpgradesStagedStages](https://developer.cisco.com/meraki/api-v1/#!get-network-firmware-upgrades-staged-stages)
> :   Complete reference of the getNetworkFirmwareUpgradesStagedStages API.

## [Examples](networks_firmware_upgrades_staged_stages_info_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_stages_info_module.md#id7)
