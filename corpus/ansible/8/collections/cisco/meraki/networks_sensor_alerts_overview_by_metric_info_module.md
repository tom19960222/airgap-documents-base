...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sensor_alerts_overview_by_metric_info module – Information module for networks _sensor _alerts _overview _bymetric"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sensor_alerts_overview_by_metric_info_module.html
fetched_at: 2026-07-28T01:34:19+00:00
---
# cisco.meraki.networks_sensor_alerts_overview_by_metric_info module – Information module for networks _sensor _alerts _overview _bymetric
...
> see [Requirements](networks_sensor_alerts_overview_by_metric_info_module.md#ansible-collections-cisco-meraki-networks-sensor-alerts-overview-by-metric-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sensor_alerts_overview_by_metric_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sensor_alerts_overview_by_metric_info_module.md#synopsis)
- [Requirements](networks_sensor_alerts_overview_by_metric_info_module.md#requirements)
- [Parameters](networks_sensor_alerts_overview_by_metric_info_module.md#parameters)
- [Notes](networks_sensor_alerts_overview_by_metric_info_module.md#notes)
- [See Also](networks_sensor_alerts_overview_by_metric_info_module.md#see-also)
- [Examples](networks_sensor_alerts_overview_by_metric_info_module.md#examples)
- [Return Values](networks_sensor_alerts_overview_by_metric_info_module.md#return-values)

## [Synopsis](networks_sensor_alerts_overview_by_metric_info_module.md#id1)
...
## [Requirements](networks_sensor_alerts_overview_by_metric_info_module.md#id2)
...
## [Parameters](networks_sensor_alerts_overview_by_metric_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **headers**  dictionary | Additional headers. |
| **interval**  integer | Interval query parameter. The time interval in seconds for returned data. The valid intervals are 86400, 604800. The default is 604800. |
...
## [Notes](networks_sensor_alerts_overview_by_metric_info_module.md#id4)
...
## [See Also](networks_sensor_alerts_overview_by_metric_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sensor getNetworkSensorAlertsOverviewByMetric](https://developer.cisco.com/meraki/api-v1/#!get-network-sensor-alerts-overview-by-metric)
> :   Complete reference of the getNetworkSensorAlertsOverviewByMetric API.

## [Examples](networks_sensor_alerts_overview_by_metric_info_module.md#id6)
...
## [Return Values](networks_sensor_alerts_overview_by_metric_info_module.md#id7)
