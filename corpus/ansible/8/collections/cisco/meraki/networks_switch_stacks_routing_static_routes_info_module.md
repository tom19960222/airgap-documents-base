...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stacks_routing_static_routes_info module – Information module for networks _switch _stacks _routing _staticroutes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stacks_routing_static_routes_info_module.html
fetched_at: 2026-07-28T01:35:17+00:00
---
# cisco.meraki.networks_switch_stacks_routing_static_routes_info module – Information module for networks _switch _stacks _routing _staticroutes
...
> see [Requirements](networks_switch_stacks_routing_static_routes_info_module.md#ansible-collections-cisco-meraki-networks-switch-stacks-routing-static-routes-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stacks_routing_static_routes_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stacks_routing_static_routes_info_module.md#synopsis)
- [Requirements](networks_switch_stacks_routing_static_routes_info_module.md#requirements)
- [Parameters](networks_switch_stacks_routing_static_routes_info_module.md#parameters)
- [Notes](networks_switch_stacks_routing_static_routes_info_module.md#notes)
- [See Also](networks_switch_stacks_routing_static_routes_info_module.md#see-also)
- [Examples](networks_switch_stacks_routing_static_routes_info_module.md#examples)
- [Return Values](networks_switch_stacks_routing_static_routes_info_module.md#return-values)

## [Synopsis](networks_switch_stacks_routing_static_routes_info_module.md#id1)
...
## [Requirements](networks_switch_stacks_routing_static_routes_info_module.md#id2)
...
## [Parameters](networks_switch_stacks_routing_static_routes_info_module.md#id3)
...
## [Notes](networks_switch_stacks_routing_static_routes_info_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.get_network_switch_stack_routing_static_route, switch.Switch.get_network_switch_stack_routing_static_routes,
> - Paths used are get /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes, get /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes/{staticRouteId},
> - Supports `check_mode`
...
## [See Also](networks_switch_stacks_routing_static_routes_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchStackRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-stack-routing-static-route)
> :   Complete reference of the getNetworkSwitchStackRoutingStaticRoute API.
>
> [Cisco Meraki documentation for switch getNetworkSwitchStackRoutingStaticRoutes](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-stack-routing-static-routes)
> :   Complete reference of the getNetworkSwitchStackRoutingStaticRoutes API.

## [Examples](networks_switch_stacks_routing_static_routes_info_module.md#id6)
...
## [Return Values](networks_switch_stacks_routing_static_routes_info_module.md#id7)
