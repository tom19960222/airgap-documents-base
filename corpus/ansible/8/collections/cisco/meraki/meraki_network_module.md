...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_network_module.html
fetched_at: 2026-07-28T01:32:45+00:00
---
...
- [DEPRECATED](meraki_network_module.md#deprecated)
...
- [Status](meraki_network_module.md#status)

## [DEPRECATED](meraki_network_module.md#id1)
...
## [Synopsis](meraki_network_module.md#id2)

- Allows for creation, management, and visibility into networks within Meraki.

## [Parameters](meraki_network_module.md#id3)
...
| **remote_status_page_enabled**  boolean | This no longer works and will likely be moved to a separate module.  Enables access to the device status page (<http://device%20LAN%20IP>).  Can only be set if `local_status_page_enabled:` is set to `yes`.  Only can be specified on its own or with `local_status_page_enabled`.  **Choices:**   - `false` - `true` |
...
## [Notes](meraki_network_module.md#id4)
...
## [Examples](meraki_network_module.md#id5)
...
## [Return Values](meraki_network_module.md#id6)
...
## [Status](meraki_network_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_network_module.md#deprecated).
