...
collection: ansible
version: "8"
title: "cisco.meraki.networks_health_alerts_info module – Information module for networks _health _alerts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_health_alerts_info_module.html
fetched_at: 2026-07-28T01:34:07+00:00
---
# cisco.meraki.networks_health_alerts_info module – Information module for networks _health _alerts
...
> see [Requirements](networks_health_alerts_info_module.md#ansible-collections-cisco-meraki-networks-health-alerts-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_health_alerts_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_health_alerts_info_module.md#synopsis)
- [Requirements](networks_health_alerts_info_module.md#requirements)
- [Parameters](networks_health_alerts_info_module.md#parameters)
- [Notes](networks_health_alerts_info_module.md#notes)
- [See Also](networks_health_alerts_info_module.md#see-also)
- [Examples](networks_health_alerts_info_module.md#examples)
- [Return Values](networks_health_alerts_info_module.md#return-values)

## [Synopsis](networks_health_alerts_info_module.md#id1)
...
## [Requirements](networks_health_alerts_info_module.md#id2)
...
## [Parameters](networks_health_alerts_info_module.md#id3)
...
## [Notes](networks_health_alerts_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_health_alerts,
> - Paths used are get /networks/{networkId}/health/alerts,
> - Supports `check_mode`
...
## [See Also](networks_health_alerts_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkHealthAlerts](https://developer.cisco.com/meraki/api-v1/#!get-network-health-alerts)
> :   Complete reference of the getNetworkHealthAlerts API.

## [Examples](networks_health_alerts_info_module.md#id6)
...
## [Return Values](networks_health_alerts_info_module.md#id7)
