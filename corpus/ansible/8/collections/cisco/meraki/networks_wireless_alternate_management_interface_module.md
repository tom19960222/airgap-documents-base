...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_alternate_management_interface module – Resource module for networks _wireless _alternatemanagementinterface"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_alternate_management_interface_module.html
fetched_at: 2026-07-28T01:35:32+00:00
---
# cisco.meraki.networks_wireless_alternate_management_interface module – Resource module for networks _wireless _alternatemanagementinterface
...
> see [Requirements](networks_wireless_alternate_management_interface_module.md#ansible-collections-cisco-meraki-networks-wireless-alternate-management-interface-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_alternate_management_interface`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_alternate_management_interface_module.md#synopsis)
- [Requirements](networks_wireless_alternate_management_interface_module.md#requirements)
- [Parameters](networks_wireless_alternate_management_interface_module.md#parameters)
- [Notes](networks_wireless_alternate_management_interface_module.md#notes)
- [See Also](networks_wireless_alternate_management_interface_module.md#see-also)
- [Examples](networks_wireless_alternate_management_interface_module.md#examples)
- [Return Values](networks_wireless_alternate_management_interface_module.md#return-values)

## [Synopsis](networks_wireless_alternate_management_interface_module.md#id1)
...
## [Requirements](networks_wireless_alternate_management_interface_module.md#id2)
...
| **enabled**  boolean | Boolean value to enable or disable alternate management interface.  **Choices:**   - `false` - `true` |
...
| **protocols**  list / elements=string | Can be one or more of the following values ‘radius’, ‘snmp’, ‘syslog’ or ‘ldap’. |
| **vlanId**  integer | Alternate management interface VLAN, must be between 1 and 4094. |

## [Notes](networks_wireless_alternate_management_interface_module.md#id4)
...
## [See Also](networks_wireless_alternate_management_interface_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessAlternateManagementInterface](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-alternate-management-interface)
> :   Complete reference of the updateNetworkWirelessAlternateManagementInterface API.

## [Examples](networks_wireless_alternate_management_interface_module.md#id6)
...
## [Return Values](networks_wireless_alternate_management_interface_module.md#id7)
