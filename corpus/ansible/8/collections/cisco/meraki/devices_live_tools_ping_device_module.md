...
collection: ansible
version: "8"
title: "cisco.meraki.devices_live_tools_ping_device module – Resource module for devices _livetools _pingdevice"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_live_tools_ping_device_module.html
fetched_at: 2026-07-28T01:31:59+00:00
---
# cisco.meraki.devices_live_tools_ping_device module – Resource module for devices _livetools _pingdevice
...
> see [Requirements](devices_live_tools_ping_device_module.md#ansible-collections-cisco-meraki-devices-live-tools-ping-device-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_live_tools_ping_device`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_live_tools_ping_device_module.md#synopsis)
- [Requirements](devices_live_tools_ping_device_module.md#requirements)
- [Parameters](devices_live_tools_ping_device_module.md#parameters)
- [Notes](devices_live_tools_ping_device_module.md#notes)
- [See Also](devices_live_tools_ping_device_module.md#see-also)
- [Examples](devices_live_tools_ping_device_module.md#examples)
- [Return Values](devices_live_tools_ping_device_module.md#return-values)

## [Synopsis](devices_live_tools_ping_device_module.md#id1)
...
## [Requirements](devices_live_tools_ping_device_module.md#id2)
...
## [Parameters](devices_live_tools_ping_device_module.md#id3)
...
## [Notes](devices_live_tools_ping_device_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.create_device_live_tools_ping_device,
> - Paths used are post /devices/{serial}/liveTools/pingDevice,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_live_tools_ping_device_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices createDeviceLiveToolsPingDevice](https://developer.cisco.com/meraki/api-v1/#!create-device-live-tools-ping-device)
> :   Complete reference of the createDeviceLiveToolsPingDevice API.

## [Examples](devices_live_tools_ping_device_module.md#id6)
...
## [Return Values](devices_live_tools_ping_device_module.md#id7)
