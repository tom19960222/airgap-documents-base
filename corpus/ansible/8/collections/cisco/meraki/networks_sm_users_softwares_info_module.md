...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_users_softwares_info module – Information module for networks _sm _users _softwares"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_users_softwares_info_module.html
fetched_at: 2026-07-28T01:34:45+00:00
---
# cisco.meraki.networks_sm_users_softwares_info module – Information module for networks _sm _users _softwares
...
> see [Requirements](networks_sm_users_softwares_info_module.md#ansible-collections-cisco-meraki-networks-sm-users-softwares-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_users_softwares_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_users_softwares_info_module.md#synopsis)
- [Requirements](networks_sm_users_softwares_info_module.md#requirements)
- [Parameters](networks_sm_users_softwares_info_module.md#parameters)
- [Notes](networks_sm_users_softwares_info_module.md#notes)
- [See Also](networks_sm_users_softwares_info_module.md#see-also)
- [Examples](networks_sm_users_softwares_info_module.md#examples)
- [Return Values](networks_sm_users_softwares_info_module.md#return-values)

## [Synopsis](networks_sm_users_softwares_info_module.md#id1)
...
## [Requirements](networks_sm_users_softwares_info_module.md#id2)
...
## [Parameters](networks_sm_users_softwares_info_module.md#id3)
...
## [Notes](networks_sm_users_softwares_info_module.md#id4)
...
## [See Also](networks_sm_users_softwares_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmUserSoftwares](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-user-softwares)
> :   Complete reference of the getNetworkSmUserSoftwares API.

## [Examples](networks_sm_users_softwares_info_module.md#id6)
...
## [Return Values](networks_sm_users_softwares_info_module.md#id7)
