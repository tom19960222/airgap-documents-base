...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_qos_rules_order module – Resource module for networks _switch _qosrules _order"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_qos_rules_order_module.html
fetched_at: 2026-07-28T01:35:03+00:00
---
# cisco.meraki.networks_switch_qos_rules_order module – Resource module for networks _switch _qosrules _order
...
> see [Requirements](networks_switch_qos_rules_order_module.md#ansible-collections-cisco-meraki-networks-switch-qos-rules-order-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_qos_rules_order`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_qos_rules_order_module.md#synopsis)
- [Requirements](networks_switch_qos_rules_order_module.md#requirements)
- [Parameters](networks_switch_qos_rules_order_module.md#parameters)
- [Notes](networks_switch_qos_rules_order_module.md#notes)
- [See Also](networks_switch_qos_rules_order_module.md#see-also)
- [Examples](networks_switch_qos_rules_order_module.md#examples)
- [Return Values](networks_switch_qos_rules_order_module.md#return-values)

## [Synopsis](networks_switch_qos_rules_order_module.md#id1)
...
## [Requirements](networks_switch_qos_rules_order_module.md#id2)
...
## [Parameters](networks_switch_qos_rules_order_module.md#id3)
...
## [Notes](networks_switch_qos_rules_order_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.create_network_switch_qos_rule, switch.Switch.delete_network_switch_qos_rule, switch.Switch.update_network_switch_qos_rule,
> - Paths used are post /networks/{networkId}/switch/qosRules, delete /networks/{networkId}/switch/qosRules/{qosRuleId}, put /networks/{networkId}/switch/qosRules/{qosRuleId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_qos_rules_order_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch createNetworkSwitchQosRule](https://developer.cisco.com/meraki/api-v1/#!create-network-switch-qos-rule)
> :   Complete reference of the createNetworkSwitchQosRule API.
>
> [Cisco Meraki documentation for switch deleteNetworkSwitchQosRule](https://developer.cisco.com/meraki/api-v1/#!delete-network-switch-qos-rule)
> :   Complete reference of the deleteNetworkSwitchQosRule API.
>
> [Cisco Meraki documentation for switch updateNetworkSwitchQosRule](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-qos-rule)
> :   Complete reference of the updateNetworkSwitchQosRule API.

## [Examples](networks_switch_qos_rules_order_module.md#id6)
...
## [Return Values](networks_switch_qos_rules_order_module.md#id7)
