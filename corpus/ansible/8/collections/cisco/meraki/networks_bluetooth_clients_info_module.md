...
collection: ansible
version: "8"
title: "cisco.meraki.networks_bluetooth_clients_info module – Information module for networks _bluetoothclients"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_bluetooth_clients_info_module.html
fetched_at: 2026-07-28T01:33:37+00:00
---
# cisco.meraki.networks_bluetooth_clients_info module – Information module for networks _bluetoothclients
...
> see [Requirements](networks_bluetooth_clients_info_module.md#ansible-collections-cisco-meraki-networks-bluetooth-clients-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_bluetooth_clients_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_bluetooth_clients_info_module.md#synopsis)
- [Requirements](networks_bluetooth_clients_info_module.md#requirements)
- [Parameters](networks_bluetooth_clients_info_module.md#parameters)
- [Notes](networks_bluetooth_clients_info_module.md#notes)
- [See Also](networks_bluetooth_clients_info_module.md#see-also)
- [Examples](networks_bluetooth_clients_info_module.md#examples)
- [Return Values](networks_bluetooth_clients_info_module.md#return-values)

## [Synopsis](networks_bluetooth_clients_info_module.md#id1)
...
## [Requirements](networks_bluetooth_clients_info_module.md#id2)
...
## [Parameters](networks_bluetooth_clients_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **bluetoothClientId**  string | BluetoothClientId path parameter. Bluetooth client ID. |
| **connectivityHistoryTimespan**  integer | ConnectivityHistoryTimespan query parameter. The timespan, in seconds, for the connectivityHistory data. By default 1 day, 86400, will be used. |
| **headers**  dictionary | Additional headers. |
| **includeConnectivityHistory**  boolean | IncludeConnectivityHistory query parameter. Include the connectivity history for this client.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_bluetooth_clients_info_module.md#id4)
...
## [See Also](networks_bluetooth_clients_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkBluetoothClient](https://developer.cisco.com/meraki/api-v1/#!get-network-bluetooth-client)
> :   Complete reference of the getNetworkBluetoothClient API.

## [Examples](networks_bluetooth_clients_info_module.md#id6)
...
## [Return Values](networks_bluetooth_clients_info_module.md#id7)
