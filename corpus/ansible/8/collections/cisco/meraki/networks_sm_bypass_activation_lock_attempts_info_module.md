...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_bypass_activation_lock_attempts_info module – Information module for networks _sm _bypassactivationlockattempts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_bypass_activation_lock_attempts_info_module.html
fetched_at: 2026-07-28T01:34:25+00:00
---
# cisco.meraki.networks_sm_bypass_activation_lock_attempts_info module – Information module for networks _sm _bypassactivationlockattempts
...
> see [Requirements](networks_sm_bypass_activation_lock_attempts_info_module.md#ansible-collections-cisco-meraki-networks-sm-bypass-activation-lock-attempts-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_bypass_activation_lock_attempts_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_bypass_activation_lock_attempts_info_module.md#synopsis)
- [Requirements](networks_sm_bypass_activation_lock_attempts_info_module.md#requirements)
- [Parameters](networks_sm_bypass_activation_lock_attempts_info_module.md#parameters)
- [Notes](networks_sm_bypass_activation_lock_attempts_info_module.md#notes)
- [See Also](networks_sm_bypass_activation_lock_attempts_info_module.md#see-also)
- [Examples](networks_sm_bypass_activation_lock_attempts_info_module.md#examples)
- [Return Values](networks_sm_bypass_activation_lock_attempts_info_module.md#return-values)

## [Synopsis](networks_sm_bypass_activation_lock_attempts_info_module.md#id1)
...
## [Requirements](networks_sm_bypass_activation_lock_attempts_info_module.md#id2)
...
## [Parameters](networks_sm_bypass_activation_lock_attempts_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **attemptId**  string | AttemptId path parameter. Attempt ID. |
...
## [Notes](networks_sm_bypass_activation_lock_attempts_info_module.md#id4)
...
## [See Also](networks_sm_bypass_activation_lock_attempts_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmBypassActivationLockAttempt](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-bypass-activation-lock-attempt)
> :   Complete reference of the getNetworkSmBypassActivationLockAttempt API.

## [Examples](networks_sm_bypass_activation_lock_attempts_info_module.md#id6)
...
## [Return Values](networks_sm_bypass_activation_lock_attempts_info_module.md#id7)
