...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_firewall_port_forwarding_rules module – Resource module for networks _appliance _firewall _portforwardingrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_firewall_port_forwarding_rules_module.html
fetched_at: 2026-07-28T01:33:07+00:00
---
# cisco.meraki.networks_appliance_firewall_port_forwarding_rules module – Resource module for networks _appliance _firewall _portforwardingrules
...
> see [Requirements](networks_appliance_firewall_port_forwarding_rules_module.md#ansible-collections-cisco-meraki-networks-appliance-firewall-port-forwarding-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_firewall_port_forwarding_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_firewall_port_forwarding_rules_module.md#synopsis)
- [Requirements](networks_appliance_firewall_port_forwarding_rules_module.md#requirements)
- [Parameters](networks_appliance_firewall_port_forwarding_rules_module.md#parameters)
- [Notes](networks_appliance_firewall_port_forwarding_rules_module.md#notes)
- [See Also](networks_appliance_firewall_port_forwarding_rules_module.md#see-also)
- [Examples](networks_appliance_firewall_port_forwarding_rules_module.md#examples)
- [Return Values](networks_appliance_firewall_port_forwarding_rules_module.md#return-values)

## [Synopsis](networks_appliance_firewall_port_forwarding_rules_module.md#id1)
...
## [Requirements](networks_appliance_firewall_port_forwarding_rules_module.md#id2)
...
## [Parameters](networks_appliance_firewall_port_forwarding_rules_module.md#id3)
...
| **rules**  list / elements=dictionary | An array of port forwarding params. |
...
## [Notes](networks_appliance_firewall_port_forwarding_rules_module.md#id4)
...
## [See Also](networks_appliance_firewall_port_forwarding_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceFirewallPortForwardingRules](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-firewall-port-forwarding-rules)
> :   Complete reference of the updateNetworkApplianceFirewallPortForwardingRules API.

## [Examples](networks_appliance_firewall_port_forwarding_rules_module.md#id6)
...
## [Return Values](networks_appliance_firewall_port_forwarding_rules_module.md#id7)
