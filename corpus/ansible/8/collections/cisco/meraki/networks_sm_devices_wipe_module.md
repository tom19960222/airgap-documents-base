...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_wipe module – Resource module for networks _sm _devices _wipe"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_wipe_module.html
fetched_at: 2026-07-28T01:34:38+00:00
---
# cisco.meraki.networks_sm_devices_wipe module – Resource module for networks _sm _devices _wipe
...
> see [Requirements](networks_sm_devices_wipe_module.md#ansible-collections-cisco-meraki-networks-sm-devices-wipe-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_wipe`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_wipe_module.md#synopsis)
- [Requirements](networks_sm_devices_wipe_module.md#requirements)
- [Parameters](networks_sm_devices_wipe_module.md#parameters)
- [Notes](networks_sm_devices_wipe_module.md#notes)
- [See Also](networks_sm_devices_wipe_module.md#see-also)
- [Examples](networks_sm_devices_wipe_module.md#examples)
- [Return Values](networks_sm_devices_wipe_module.md#return-values)

## [Synopsis](networks_sm_devices_wipe_module.md#id1)
...
## [Requirements](networks_sm_devices_wipe_module.md#id2)
...
## [Parameters](networks_sm_devices_wipe_module.md#id3)
...
## [Notes](networks_sm_devices_wipe_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.wipe_network_sm_devices,
> - Paths used are post /networks/{networkId}/sm/devices/wipe,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_sm_devices_wipe_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm wipeNetworkSmDevices](https://developer.cisco.com/meraki/api-v1/#!wipe-network-sm-devices)
> :   Complete reference of the wipeNetworkSmDevices API.

## [Examples](networks_sm_devices_wipe_module.md#id6)
...
## [Return Values](networks_sm_devices_wipe_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"id": "string"}` |
