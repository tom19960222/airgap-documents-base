...
collection: ansible
version: "8"
title: "cisco.meraki.networks_pii_sm_owners_for_key_info module – Information module for networks _pii _smownersforkey"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_pii_sm_owners_for_key_info_module.html
fetched_at: 2026-07-28T01:34:17+00:00
---
# cisco.meraki.networks_pii_sm_owners_for_key_info module – Information module for networks _pii _smownersforkey
...
> see [Requirements](networks_pii_sm_owners_for_key_info_module.md#ansible-collections-cisco-meraki-networks-pii-sm-owners-for-key-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_pii_sm_owners_for_key_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_pii_sm_owners_for_key_info_module.md#synopsis)
- [Requirements](networks_pii_sm_owners_for_key_info_module.md#requirements)
- [Parameters](networks_pii_sm_owners_for_key_info_module.md#parameters)
- [Notes](networks_pii_sm_owners_for_key_info_module.md#notes)
- [See Also](networks_pii_sm_owners_for_key_info_module.md#see-also)
- [Examples](networks_pii_sm_owners_for_key_info_module.md#examples)
- [Return Values](networks_pii_sm_owners_for_key_info_module.md#return-values)

## [Synopsis](networks_pii_sm_owners_for_key_info_module.md#id1)

- Get all networks _pii _smownersforkey.
- Given a piece of Personally Identifiable Information PII , return the Systems Manager owner IDs associated with that identifier. These owner IDs can be used with the Systems Manager API endpoints to retrieve owner details. Exactly one identifier will be accepted.

> **Note:**
>
> This module has a corresponding [action plugin](../../../plugins/action.md#action-plugins).

## [Requirements](networks_pii_sm_owners_for_key_info_module.md#id2)
...
## [Parameters](networks_pii_sm_owners_for_key_info_module.md#id3)
...
## [Notes](networks_pii_sm_owners_for_key_info_module.md#id4)
...
## [See Also](networks_pii_sm_owners_for_key_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkPiiSmOwnersForKey](https://developer.cisco.com/meraki/api-v1/#!get-network-pii-sm-owners-for-key)
> :   Complete reference of the getNetworkPiiSmOwnersForKey API.

## [Examples](networks_pii_sm_owners_for_key_info_module.md#id6)
...
## [Return Values](networks_pii_sm_owners_for_key_info_module.md#id7)
