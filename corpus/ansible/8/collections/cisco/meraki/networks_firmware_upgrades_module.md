...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades module – Resource module for networks _firmwareupgrades"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_module.html
fetched_at: 2026-07-28T01:33:56+00:00
---
...
> see [Requirements](networks_firmware_upgrades_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_module.md#requirements)
- [Parameters](networks_firmware_upgrades_module.md#parameters)
- [Notes](networks_firmware_upgrades_module.md#notes)
- [See Also](networks_firmware_upgrades_module.md#see-also)
- [Examples](networks_firmware_upgrades_module.md#examples)
- [Return Values](networks_firmware_upgrades_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_module.md#id3)
...
| **products**  dictionary | Contains information about the network to update. |
| **appliance**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
| **participateInNextBetaRelease**  boolean | Whether or not the network wants beta firmware.  **Choices:**   - `false` - `true` |
| **camera**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
| **participateInNextBetaRelease**  boolean | Whether or not the network wants beta firmware.  **Choices:**   - `false` - `true` |
| **cellularGateway**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
| **participateInNextBetaRelease**  boolean | Whether or not the network wants beta firmware.  **Choices:**   - `false` - `true` |
| **sensor**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
| **participateInNextBetaRelease**  boolean | Whether or not the network wants beta firmware.  **Choices:**   - `false` - `true` |
| **switch**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
| **participateInNextBetaRelease**  boolean | Whether or not the network wants beta firmware.  **Choices:**   - `false` - `true` |
| **wireless**  dictionary | The network device to be updated. |
| **nextUpgrade**  dictionary | The pending firmware upgrade if it exists. |
| **time**  string | The time of the last successful upgrade. |
| **toVersion**  dictionary | The version to be updated to. |
| **id**  string | The version ID. |
...
| **upgradeWindow**  dictionary | Upgrade window for devices in network. |
| **dayOfWeek**  string | Day of the week. |
| **hourOfDay**  string | Hour of the day. |

## [Notes](networks_firmware_upgrades_module.md#id4)
...
## [See Also](networks_firmware_upgrades_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkFirmwareUpgrades](https://developer.cisco.com/meraki/api-v1/#!update-network-firmware-upgrades)
> :   Complete reference of the updateNetworkFirmwareUpgrades API.

## [Examples](networks_firmware_upgrades_module.md#id6)
