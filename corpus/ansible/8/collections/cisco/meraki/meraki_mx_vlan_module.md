...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_mx_vlan_module.html
fetched_at: 2026-07-28T01:32:44+00:00
---
...
- [DEPRECATED](meraki_mx_vlan_module.md#deprecated)
...
- [Status](meraki_mx_vlan_module.md#status)

## [DEPRECATED](meraki_mx_vlan_module.md#id1)
...
## [Synopsis](meraki_mx_vlan_module.md#id2)

- Create, edit, query, or delete VLANs in a Meraki environment.

## [Parameters](meraki_mx_vlan_module.md#id3)
...
## [Notes](meraki_mx_vlan_module.md#id4)
...
## [Examples](meraki_mx_vlan_module.md#id5)
...
## [Return Values](meraki_mx_vlan_module.md#id6)
...
## [Status](meraki_mx_vlan_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_mx_vlan_module.md#deprecated).
