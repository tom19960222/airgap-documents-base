...
collection: ansible
version: "8"
title: "cisco.meraki.networks_floor_plans_info module – Information module for networks _floorplans"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_floor_plans_info_module.html
fetched_at: 2026-07-28T01:34:05+00:00
---
# cisco.meraki.networks_floor_plans_info module – Information module for networks _floorplans
...
> see [Requirements](networks_floor_plans_info_module.md#ansible-collections-cisco-meraki-networks-floor-plans-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_floor_plans_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_floor_plans_info_module.md#synopsis)
- [Requirements](networks_floor_plans_info_module.md#requirements)
- [Parameters](networks_floor_plans_info_module.md#parameters)
- [Notes](networks_floor_plans_info_module.md#notes)
- [See Also](networks_floor_plans_info_module.md#see-also)
- [Examples](networks_floor_plans_info_module.md#examples)
- [Return Values](networks_floor_plans_info_module.md#return-values)

## [Synopsis](networks_floor_plans_info_module.md#id1)
...
## [Requirements](networks_floor_plans_info_module.md#id2)
...
## [Parameters](networks_floor_plans_info_module.md#id3)
...
## [Notes](networks_floor_plans_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_floor_plan, networks.Networks.get_network_floor_plans,
> - Paths used are get /networks/{networkId}/floorPlans, get /networks/{networkId}/floorPlans/{floorPlanId},
> - Supports `check_mode`
...
## [See Also](networks_floor_plans_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkFloorPlan](https://developer.cisco.com/meraki/api-v1/#!get-network-floor-plan)
> :   Complete reference of the getNetworkFloorPlan API.
>
> [Cisco Meraki documentation for networks getNetworkFloorPlans](https://developer.cisco.com/meraki/api-v1/#!get-network-floor-plans)
> :   Complete reference of the getNetworkFloorPlans API.

## [Examples](networks_floor_plans_info_module.md#id6)
...
## [Return Values](networks_floor_plans_info_module.md#id7)
