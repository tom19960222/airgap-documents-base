...
collection: ansible
version: "8"
title: "cisco.meraki.networks_cellular_gateway_dhcp module – Resource module for networks _cellulargateway _dhcp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_cellular_gateway_dhcp_module.html
fetched_at: 2026-07-28T01:33:42+00:00
---
# cisco.meraki.networks_cellular_gateway_dhcp module – Resource module for networks _cellulargateway _dhcp
...
> see [Requirements](networks_cellular_gateway_dhcp_module.md#ansible-collections-cisco-meraki-networks-cellular-gateway-dhcp-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_cellular_gateway_dhcp`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_cellular_gateway_dhcp_module.md#synopsis)
- [Requirements](networks_cellular_gateway_dhcp_module.md#requirements)
- [Parameters](networks_cellular_gateway_dhcp_module.md#parameters)
- [Notes](networks_cellular_gateway_dhcp_module.md#notes)
- [See Also](networks_cellular_gateway_dhcp_module.md#see-also)
- [Examples](networks_cellular_gateway_dhcp_module.md#examples)
- [Return Values](networks_cellular_gateway_dhcp_module.md#return-values)

## [Synopsis](networks_cellular_gateway_dhcp_module.md#id1)
...
## [Requirements](networks_cellular_gateway_dhcp_module.md#id2)
...
## [Parameters](networks_cellular_gateway_dhcp_module.md#id3)
...
| **dnsCustomNameservers**  list / elements=string | List of fixed IPs representing the the DNS Name servers when the mode is ‘custom’. |
...
## [Notes](networks_cellular_gateway_dhcp_module.md#id4)
...
## [See Also](networks_cellular_gateway_dhcp_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway updateNetworkCellularGatewayDhcp](https://developer.cisco.com/meraki/api-v1/#!update-network-cellular-gateway-dhcp)
> :   Complete reference of the updateNetworkCellularGatewayDhcp API.

## [Examples](networks_cellular_gateway_dhcp_module.md#id6)
...
## [Return Values](networks_cellular_gateway_dhcp_module.md#id7)
