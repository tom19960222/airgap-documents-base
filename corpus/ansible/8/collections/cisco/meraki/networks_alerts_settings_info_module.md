...
collection: ansible
version: "8"
title: "cisco.meraki.networks_alerts_settings_info module – Information module for networks _alerts _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_alerts_settings_info_module.html
fetched_at: 2026-07-28T01:32:52+00:00
---
# cisco.meraki.networks_alerts_settings_info module – Information module for networks _alerts _settings
...
> see [Requirements](networks_alerts_settings_info_module.md#ansible-collections-cisco-meraki-networks-alerts-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_alerts_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_alerts_settings_info_module.md#synopsis)
- [Requirements](networks_alerts_settings_info_module.md#requirements)
- [Parameters](networks_alerts_settings_info_module.md#parameters)
- [Notes](networks_alerts_settings_info_module.md#notes)
- [See Also](networks_alerts_settings_info_module.md#see-also)
- [Examples](networks_alerts_settings_info_module.md#examples)
- [Return Values](networks_alerts_settings_info_module.md#return-values)

## [Synopsis](networks_alerts_settings_info_module.md#id1)
...
## [Requirements](networks_alerts_settings_info_module.md#id2)
...
## [Parameters](networks_alerts_settings_info_module.md#id3)
...
## [Notes](networks_alerts_settings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_alerts_settings,
> - Paths used are get /networks/{networkId}/alerts/settings,
> - Supports `check_mode`
...
## [See Also](networks_alerts_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkAlertsSettings](https://developer.cisco.com/meraki/api-v1/#!get-network-alerts-settings)
> :   Complete reference of the getNetworkAlertsSettings API.

## [Examples](networks_alerts_settings_info_module.md#id6)
...
## [Return Values](networks_alerts_settings_info_module.md#id7)
