...
collection: ansible
version: "8"
title: "cisco.meraki.devices_management_interface_info module – Information module for devices _managementinterface"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_management_interface_info_module.html
fetched_at: 2026-07-28T01:32:02+00:00
---
# cisco.meraki.devices_management_interface_info module – Information module for devices _managementinterface
...
> see [Requirements](devices_management_interface_info_module.md#ansible-collections-cisco-meraki-devices-management-interface-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_management_interface_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_management_interface_info_module.md#synopsis)
- [Requirements](devices_management_interface_info_module.md#requirements)
- [Parameters](devices_management_interface_info_module.md#parameters)
- [Notes](devices_management_interface_info_module.md#notes)
- [See Also](devices_management_interface_info_module.md#see-also)
- [Examples](devices_management_interface_info_module.md#examples)
- [Return Values](devices_management_interface_info_module.md#return-values)

## [Synopsis](devices_management_interface_info_module.md#id1)
...
## [Requirements](devices_management_interface_info_module.md#id2)
...
## [Parameters](devices_management_interface_info_module.md#id3)
...
## [Notes](devices_management_interface_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_management_interface,
> - Paths used are get /devices/{serial}/managementInterface,
> - Supports `check_mode`
...
## [See Also](devices_management_interface_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceManagementInterface](https://developer.cisco.com/meraki/api-v1/#!get-device-management-interface)
> :   Complete reference of the getDeviceManagementInterface API.

## [Examples](devices_management_interface_info_module.md#id6)
...
## [Return Values](devices_management_interface_info_module.md#id7)
