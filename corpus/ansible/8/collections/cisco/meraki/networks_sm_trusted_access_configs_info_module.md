...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_trusted_access_configs_info module – Information module for networks _sm _trustedaccessconfigs"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_trusted_access_configs_info_module.html
fetched_at: 2026-07-28T01:34:42+00:00
---
# cisco.meraki.networks_sm_trusted_access_configs_info module – Information module for networks _sm _trustedaccessconfigs
...
> see [Requirements](networks_sm_trusted_access_configs_info_module.md#ansible-collections-cisco-meraki-networks-sm-trusted-access-configs-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_trusted_access_configs_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_trusted_access_configs_info_module.md#synopsis)
- [Requirements](networks_sm_trusted_access_configs_info_module.md#requirements)
- [Parameters](networks_sm_trusted_access_configs_info_module.md#parameters)
- [Notes](networks_sm_trusted_access_configs_info_module.md#notes)
- [See Also](networks_sm_trusted_access_configs_info_module.md#see-also)
- [Examples](networks_sm_trusted_access_configs_info_module.md#examples)
- [Return Values](networks_sm_trusted_access_configs_info_module.md#return-values)

## [Synopsis](networks_sm_trusted_access_configs_info_module.md#id1)
...
## [Requirements](networks_sm_trusted_access_configs_info_module.md#id2)
...
## [Parameters](networks_sm_trusted_access_configs_info_module.md#id3)
...
## [Notes](networks_sm_trusted_access_configs_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.get_network_sm_trusted_access_configs,
> - Paths used are get /networks/{networkId}/sm/trustedAccessConfigs,
> - Supports `check_mode`
...
## [See Also](networks_sm_trusted_access_configs_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmTrustedAccessConfigs](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-trusted-access-configs)
> :   Complete reference of the getNetworkSmTrustedAccessConfigs API.

## [Examples](networks_sm_trusted_access_configs_info_module.md#id6)
...
## [Return Values](networks_sm_trusted_access_configs_info_module.md#id7)
