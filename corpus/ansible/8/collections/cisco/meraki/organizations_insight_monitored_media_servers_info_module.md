...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_insight_monitored_media_servers_info module – Information module for organizations _insight _monitoredmediaservers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_insight_monitored_media_servers_info_module.html
fetched_at: 2026-07-28T01:36:53+00:00
---
# cisco.meraki.organizations_insight_monitored_media_servers_info module – Information module for organizations _insight _monitoredmediaservers
...
> see [Requirements](organizations_insight_monitored_media_servers_info_module.md#ansible-collections-cisco-meraki-organizations-insight-monitored-media-servers-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_insight_monitored_media_servers_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_insight_monitored_media_servers_info_module.md#synopsis)
- [Requirements](organizations_insight_monitored_media_servers_info_module.md#requirements)
- [Parameters](organizations_insight_monitored_media_servers_info_module.md#parameters)
- [Notes](organizations_insight_monitored_media_servers_info_module.md#notes)
- [See Also](organizations_insight_monitored_media_servers_info_module.md#see-also)
- [Examples](organizations_insight_monitored_media_servers_info_module.md#examples)
- [Return Values](organizations_insight_monitored_media_servers_info_module.md#return-values)

## [Synopsis](organizations_insight_monitored_media_servers_info_module.md#id1)
...
## [Requirements](organizations_insight_monitored_media_servers_info_module.md#id2)
...
## [Parameters](organizations_insight_monitored_media_servers_info_module.md#id3)
...
## [Notes](organizations_insight_monitored_media_servers_info_module.md#id4)

> **Note:**
>
> - SDK Method used are insight.Insight.get_organization_insight_monitored_media_server, insight.Insight.get_organization_insight_monitored_media_servers,
> - Paths used are get /organizations/{organizationId}/insight/monitoredMediaServers, get /organizations/{organizationId}/insight/monitoredMediaServers/{monitoredMediaServerId},
> - Supports `check_mode`
...
## [See Also](organizations_insight_monitored_media_servers_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for insight getOrganizationInsightMonitoredMediaServer](https://developer.cisco.com/meraki/api-v1/#!get-organization-insight-monitored-media-server)
> :   Complete reference of the getOrganizationInsightMonitoredMediaServer API.
>
> [Cisco Meraki documentation for insight getOrganizationInsightMonitoredMediaServers](https://developer.cisco.com/meraki/api-v1/#!get-organization-insight-monitored-media-servers)
> :   Complete reference of the getOrganizationInsightMonitoredMediaServers API.

## [Examples](organizations_insight_monitored_media_servers_info_module.md#id6)
...
## [Return Values](organizations_insight_monitored_media_servers_info_module.md#id7)
