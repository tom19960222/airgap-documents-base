...
collection: ansible
version: "8"
title: "cisco.meraki.networks_meraki_auth_users_info module – Information module for networks _merakiauthusers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_meraki_auth_users_info_module.html
fetched_at: 2026-07-28T01:34:10+00:00
---
# cisco.meraki.networks_meraki_auth_users_info module – Information module for networks _merakiauthusers
...
> see [Requirements](networks_meraki_auth_users_info_module.md#ansible-collections-cisco-meraki-networks-meraki-auth-users-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_meraki_auth_users_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_meraki_auth_users_info_module.md#synopsis)
- [Requirements](networks_meraki_auth_users_info_module.md#requirements)
- [Parameters](networks_meraki_auth_users_info_module.md#parameters)
- [Notes](networks_meraki_auth_users_info_module.md#notes)
- [See Also](networks_meraki_auth_users_info_module.md#see-also)
- [Examples](networks_meraki_auth_users_info_module.md#examples)
- [Return Values](networks_meraki_auth_users_info_module.md#return-values)

## [Synopsis](networks_meraki_auth_users_info_module.md#id1)
...
## [Requirements](networks_meraki_auth_users_info_module.md#id2)
...
## [Parameters](networks_meraki_auth_users_info_module.md#id3)
...
## [Notes](networks_meraki_auth_users_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_meraki_auth_user, networks.Networks.get_network_meraki_auth_users,
> - Paths used are get /networks/{networkId}/merakiAuthUsers, get /networks/{networkId}/merakiAuthUsers/{merakiAuthUserId},
> - Supports `check_mode`
...
## [See Also](networks_meraki_auth_users_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkMerakiAuthUser](https://developer.cisco.com/meraki/api-v1/#!get-network-meraki-auth-user)
> :   Complete reference of the getNetworkMerakiAuthUser API.
>
> [Cisco Meraki documentation for networks getNetworkMerakiAuthUsers](https://developer.cisco.com/meraki/api-v1/#!get-network-meraki-auth-users)
> :   Complete reference of the getNetworkMerakiAuthUsers API.

## [Examples](networks_meraki_auth_users_info_module.md#id6)
...
## [Return Values](networks_meraki_auth_users_info_module.md#id7)
