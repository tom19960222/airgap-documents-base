...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_camera_custom_analytics_artifacts module – Resource module for organizations _camera _customanalytics _artifacts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_camera_custom_analytics_artifacts_module.html
fetched_at: 2026-07-28T01:36:29+00:00
---
# cisco.meraki.organizations_camera_custom_analytics_artifacts module – Resource module for organizations _camera _customanalytics _artifacts
...
> see [Requirements](organizations_camera_custom_analytics_artifacts_module.md#ansible-collections-cisco-meraki-organizations-camera-custom-analytics-artifacts-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_camera_custom_analytics_artifacts`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_camera_custom_analytics_artifacts_module.md#synopsis)
- [Requirements](organizations_camera_custom_analytics_artifacts_module.md#requirements)
- [Parameters](organizations_camera_custom_analytics_artifacts_module.md#parameters)
- [Notes](organizations_camera_custom_analytics_artifacts_module.md#notes)
- [See Also](organizations_camera_custom_analytics_artifacts_module.md#see-also)
- [Examples](organizations_camera_custom_analytics_artifacts_module.md#examples)
- [Return Values](organizations_camera_custom_analytics_artifacts_module.md#return-values)

## [Synopsis](organizations_camera_custom_analytics_artifacts_module.md#id1)
...
## [Requirements](organizations_camera_custom_analytics_artifacts_module.md#id2)
...
## [Parameters](organizations_camera_custom_analytics_artifacts_module.md#id3)
...
## [Notes](organizations_camera_custom_analytics_artifacts_module.md#id4)

> **Note:**
>
> - SDK Method used are camera.Camera.create_organization_camera_custom_analytics_artifact, camera.Camera.delete_organization_camera_custom_analytics_artifact,
> - Paths used are post /organizations/{organizationId}/camera/customAnalytics/artifacts, delete /organizations/{organizationId}/camera/customAnalytics/artifacts/{artifactId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_camera_custom_analytics_artifacts_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for camera createOrganizationCameraCustomAnalyticsArtifact](https://developer.cisco.com/meraki/api-v1/#!create-organization-camera-custom-analytics-artifact)
> :   Complete reference of the createOrganizationCameraCustomAnalyticsArtifact API.
>
> [Cisco Meraki documentation for camera deleteOrganizationCameraCustomAnalyticsArtifact](https://developer.cisco.com/meraki/api-v1/#!delete-organization-camera-custom-analytics-artifact)
> :   Complete reference of the deleteOrganizationCameraCustomAnalyticsArtifact API.

## [Examples](organizations_camera_custom_analytics_artifacts_module.md#id6)
...
## [Return Values](organizations_camera_custom_analytics_artifacts_module.md#id7)
