...
collection: ansible
version: "8"
title: "cisco.meraki.devices_info module – Information module for devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_info_module.html
fetched_at: 2026-07-28T01:31:57+00:00
---
...
> see [Requirements](devices_info_module.md#ansible-collections-cisco-meraki-devices-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_info_module.md#synopsis)
- [Requirements](devices_info_module.md#requirements)
- [Parameters](devices_info_module.md#parameters)
- [Notes](devices_info_module.md#notes)
- [See Also](devices_info_module.md#see-also)
- [Examples](devices_info_module.md#examples)
- [Return Values](devices_info_module.md#return-values)

## [Synopsis](devices_info_module.md#id1)
...
## [Requirements](devices_info_module.md#id2)
...
## [Parameters](devices_info_module.md#id3)
...
## [Notes](devices_info_module.md#id4)
...
## [See Also](devices_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDevice](https://developer.cisco.com/meraki/api-v1/#!get-device)
> :   Complete reference of the getDevice API.
>
> [Cisco Meraki documentation for devices getOrganizationDevices](https://developer.cisco.com/meraki/api-v1/#!get-organization-devices)
> :   Complete reference of the getOrganizationDevices API.

## [Examples](devices_info_module.md#id6)
...
## [Return Values](devices_info_module.md#id7)
