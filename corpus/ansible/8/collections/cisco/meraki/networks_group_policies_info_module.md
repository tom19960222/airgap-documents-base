...
collection: ansible
version: "8"
title: "cisco.meraki.networks_group_policies_info module – Information module for networks _grouppolicies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_group_policies_info_module.html
fetched_at: 2026-07-28T01:34:07+00:00
---
# cisco.meraki.networks_group_policies_info module – Information module for networks _grouppolicies
...
> see [Requirements](networks_group_policies_info_module.md#ansible-collections-cisco-meraki-networks-group-policies-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_group_policies_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_group_policies_info_module.md#synopsis)
- [Requirements](networks_group_policies_info_module.md#requirements)
- [Parameters](networks_group_policies_info_module.md#parameters)
- [Notes](networks_group_policies_info_module.md#notes)
- [See Also](networks_group_policies_info_module.md#see-also)
- [Examples](networks_group_policies_info_module.md#examples)
- [Return Values](networks_group_policies_info_module.md#return-values)

## [Synopsis](networks_group_policies_info_module.md#id1)
...
## [Requirements](networks_group_policies_info_module.md#id2)
...
## [Parameters](networks_group_policies_info_module.md#id3)
...
## [Notes](networks_group_policies_info_module.md#id4)
...
## [See Also](networks_group_policies_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkGroupPolicies](https://developer.cisco.com/meraki/api-v1/#!get-network-group-policies)
> :   Complete reference of the getNetworkGroupPolicies API.
>
> [Cisco Meraki documentation for networks getNetworkGroupPolicy](https://developer.cisco.com/meraki/api-v1/#!get-network-group-policy)
> :   Complete reference of the getNetworkGroupPolicy API.

## [Examples](networks_group_policies_info_module.md#id6)
...
## [Return Values](networks_group_policies_info_module.md#id7)
