...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_mr_ssid_module.html
fetched_at: 2026-07-28T01:32:27+00:00
---
...
- [DEPRECATED](meraki_mr_ssid_module.md#deprecated)
...
- [Status](meraki_mr_ssid_module.md#status)

## [DEPRECATED](meraki_mr_ssid_module.md#id1)
...
## [Synopsis](meraki_mr_ssid_module.md#id2)

- Allows for management of SSIDs in a Meraki wireless environment.

## [Parameters](meraki_mr_ssid_module.md#id3)
...
## [Notes](meraki_mr_ssid_module.md#id4)
...
## [Examples](meraki_mr_ssid_module.md#id5)
...
## [Return Values](meraki_mr_ssid_module.md#id6)
...
## [Status](meraki_mr_ssid_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_mr_ssid_module.md#deprecated).
