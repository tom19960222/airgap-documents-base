...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_devices_availabilities_info module – Information module for organizations _devices _availabilities"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_devices_availabilities_info_module.html
fetched_at: 2026-07-28T01:36:40+00:00
---
# cisco.meraki.organizations_devices_availabilities_info module – Information module for organizations _devices _availabilities
...
> see [Requirements](organizations_devices_availabilities_info_module.md#ansible-collections-cisco-meraki-organizations-devices-availabilities-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_devices_availabilities_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_devices_availabilities_info_module.md#synopsis)
- [Requirements](organizations_devices_availabilities_info_module.md#requirements)
- [Parameters](organizations_devices_availabilities_info_module.md#parameters)
- [Notes](organizations_devices_availabilities_info_module.md#notes)
- [See Also](organizations_devices_availabilities_info_module.md#see-also)
- [Examples](organizations_devices_availabilities_info_module.md#examples)
- [Return Values](organizations_devices_availabilities_info_module.md#return-values)

## [Synopsis](organizations_devices_availabilities_info_module.md#id1)
...
## [Requirements](organizations_devices_availabilities_info_module.md#id2)
...
## [Parameters](organizations_devices_availabilities_info_module.md#id3)
...
## [Notes](organizations_devices_availabilities_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_devices_availabilities,
> - Paths used are get /organizations/{organizationId}/devices/availabilities,
> - Supports `check_mode`
...
## [See Also](organizations_devices_availabilities_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationDevicesAvailabilities](https://developer.cisco.com/meraki/api-v1/#!get-organization-devices-availabilities)
> :   Complete reference of the getOrganizationDevicesAvailabilities API.

## [Examples](organizations_devices_availabilities_info_module.md#id6)
...
## [Return Values](organizations_devices_availabilities_info_module.md#id7)
