...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_data_rate_history_info module – Information module for networks _wireless _dataratehistory"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_data_rate_history_info_module.html
fetched_at: 2026-07-28T01:35:41+00:00
---
# cisco.meraki.networks_wireless_data_rate_history_info module – Information module for networks _wireless _dataratehistory
...
> see [Requirements](networks_wireless_data_rate_history_info_module.md#ansible-collections-cisco-meraki-networks-wireless-data-rate-history-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_data_rate_history_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_data_rate_history_info_module.md#synopsis)
- [Requirements](networks_wireless_data_rate_history_info_module.md#requirements)
- [Parameters](networks_wireless_data_rate_history_info_module.md#parameters)
- [Notes](networks_wireless_data_rate_history_info_module.md#notes)
- [See Also](networks_wireless_data_rate_history_info_module.md#see-also)
- [Examples](networks_wireless_data_rate_history_info_module.md#examples)
- [Return Values](networks_wireless_data_rate_history_info_module.md#return-values)

## [Synopsis](networks_wireless_data_rate_history_info_module.md#id1)
...
## [Requirements](networks_wireless_data_rate_history_info_module.md#id2)
...
## [Parameters](networks_wireless_data_rate_history_info_module.md#id3)
...
## [Notes](networks_wireless_data_rate_history_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_data_rate_history,
> - Paths used are get /networks/{networkId}/wireless/dataRateHistory,
> - Supports `check_mode`
...
## [See Also](networks_wireless_data_rate_history_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessDataRateHistory](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-data-rate-history)
> :   Complete reference of the getNetworkWirelessDataRateHistory API.

## [Examples](networks_wireless_data_rate_history_info_module.md#id6)
...
## [Return Values](networks_wireless_data_rate_history_info_module.md#id7)
