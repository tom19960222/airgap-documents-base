...
collection: ansible
version: "8"
title: "cisco.meraki.networks_cellular_gateway_uplink module – Resource module for networks _cellulargateway _uplink"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_cellular_gateway_uplink_module.html
fetched_at: 2026-07-28T01:33:45+00:00
---
# cisco.meraki.networks_cellular_gateway_uplink module – Resource module for networks _cellulargateway _uplink
...
> see [Requirements](networks_cellular_gateway_uplink_module.md#ansible-collections-cisco-meraki-networks-cellular-gateway-uplink-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_cellular_gateway_uplink`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_cellular_gateway_uplink_module.md#synopsis)
- [Requirements](networks_cellular_gateway_uplink_module.md#requirements)
- [Parameters](networks_cellular_gateway_uplink_module.md#parameters)
- [Notes](networks_cellular_gateway_uplink_module.md#notes)
- [See Also](networks_cellular_gateway_uplink_module.md#see-also)
- [Examples](networks_cellular_gateway_uplink_module.md#examples)
- [Return Values](networks_cellular_gateway_uplink_module.md#return-values)

## [Synopsis](networks_cellular_gateway_uplink_module.md#id1)
...
## [Requirements](networks_cellular_gateway_uplink_module.md#id2)
...
## [Parameters](networks_cellular_gateway_uplink_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **bandwidthLimits**  dictionary | The bandwidth settings for the ‘cellular’ uplink. |
...
## [Notes](networks_cellular_gateway_uplink_module.md#id4)

> **Note:**
>
> - SDK Method used are cellular_gateway.CellularGateway.update_network_cellular_gateway_uplink,
> - Paths used are put /networks/{networkId}/cellularGateway/uplink,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_cellular_gateway_uplink_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway updateNetworkCellularGatewayUplink](https://developer.cisco.com/meraki/api-v1/#!update-network-cellular-gateway-uplink)
> :   Complete reference of the updateNetworkCellularGatewayUplink API.

## [Examples](networks_cellular_gateway_uplink_module.md#id6)
...
## [Return Values](networks_cellular_gateway_uplink_module.md#id7)
