...
collection: ansible
version: "8"
title: "cisco.meraki.networks_client_info module – Information module for networks _client"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_client_info_module.html
fetched_at: 2026-07-28T01:33:46+00:00
---
# cisco.meraki.networks_client_info module – Information module for networks _client
...
> see [Requirements](networks_client_info_module.md#ansible-collections-cisco-meraki-networks-client-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_client_info`.

New in cisco.meraki 1.0.0

- [Synopsis](networks_client_info_module.md#synopsis)
- [Requirements](networks_client_info_module.md#requirements)
- [Parameters](networks_client_info_module.md#parameters)
- [Notes](networks_client_info_module.md#notes)
- [See Also](networks_client_info_module.md#see-also)
- [Examples](networks_client_info_module.md#examples)
- [Return Values](networks_client_info_module.md#return-values)

## [Synopsis](networks_client_info_module.md#id1)
...
## [Requirements](networks_client_info_module.md#id2)
...
## [Parameters](networks_client_info_module.md#id3)
...
## [Notes](networks_client_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_client,
> - Paths used are get /networks/{networkId}/clients/{clientId},
> - Supports `check_mode`
...
## [See Also](networks_client_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkClient](https://developer.cisco.com/meraki/api-v1/#!get-network-client)
> :   Complete reference of the getNetworkClient API.

## [Examples](networks_client_info_module.md#id6)
...
## [Return Values](networks_client_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"cdp": [["string"]], "clientVpnConnections": [{"connectedAt": 0, "disconnectedAt": 0, "remoteIp": "string"}], "description": "string", "firstSeen": 0, "id": "string", "ip": "string", "ip6": "string", "lastSeen": 0, "lldp": [["string"]], "mac": "string", "manufacturer": "string", "os": "string", "recentDeviceMac": "string", "smInstalled": true, "ssid": "string", "status": "string", "switchport": "string", "user": "string", "vlan": "string", "wirelessCapabilities": "string"}` |
