...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_analytics_live_info module – Information module for devices _camera _analytics _live"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_analytics_live_info_module.html
fetched_at: 2026-07-28T01:31:44+00:00
---
# cisco.meraki.devices_camera_analytics_live_info module – Information module for devices _camera _analytics _live
...
> see [Requirements](devices_camera_analytics_live_info_module.md#ansible-collections-cisco-meraki-devices-camera-analytics-live-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_analytics_live_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_analytics_live_info_module.md#synopsis)
- [Requirements](devices_camera_analytics_live_info_module.md#requirements)
- [Parameters](devices_camera_analytics_live_info_module.md#parameters)
- [Notes](devices_camera_analytics_live_info_module.md#notes)
- [See Also](devices_camera_analytics_live_info_module.md#see-also)
- [Examples](devices_camera_analytics_live_info_module.md#examples)
- [Return Values](devices_camera_analytics_live_info_module.md#return-values)

## [Synopsis](devices_camera_analytics_live_info_module.md#id1)
...
## [Requirements](devices_camera_analytics_live_info_module.md#id2)
...
## [Parameters](devices_camera_analytics_live_info_module.md#id3)
...
## [Notes](devices_camera_analytics_live_info_module.md#id4)
...
## [See Also](devices_camera_analytics_live_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for camera getDeviceCameraAnalyticsLive](https://developer.cisco.com/meraki/api-v1/#!get-device-camera-analytics-live)
> :   Complete reference of the getDeviceCameraAnalyticsLive API.

## [Examples](devices_camera_analytics_live_info_module.md#id6)
...
## [Return Values](devices_camera_analytics_live_info_module.md#id7)
