...
collection: ansible
version: "8"
title: "cisco.meraki.networks_syslog_servers module – Resource module for networks _syslogservers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_syslog_servers_module.html
fetched_at: 2026-07-28T01:35:21+00:00
---
# cisco.meraki.networks_syslog_servers module – Resource module for networks _syslogservers
...
> see [Requirements](networks_syslog_servers_module.md#ansible-collections-cisco-meraki-networks-syslog-servers-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_syslog_servers`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_syslog_servers_module.md#synopsis)
- [Requirements](networks_syslog_servers_module.md#requirements)
- [Parameters](networks_syslog_servers_module.md#parameters)
- [Notes](networks_syslog_servers_module.md#notes)
- [See Also](networks_syslog_servers_module.md#see-also)
- [Examples](networks_syslog_servers_module.md#examples)
- [Return Values](networks_syslog_servers_module.md#return-values)

## [Synopsis](networks_syslog_servers_module.md#id1)
...
## [Requirements](networks_syslog_servers_module.md#id2)
...
## [Parameters](networks_syslog_servers_module.md#id3)
...
| **servers**  list / elements=dictionary | A list of the syslog servers for this network. |
| **host**  string | The IP address of the syslog server. |
| **port**  integer | The port of the syslog server. |
| **roles**  list / elements=string | A list of roles for the syslog server. Options (case-insensitive) ‘Wireless event log’, ‘Appliance event log’, ‘Switch event log’, ‘Air Marshal events’, ‘Flows’, ‘URLs’, ‘IDS alerts’, ‘Security events’. |

## [Notes](networks_syslog_servers_module.md#id4)
...
## [See Also](networks_syslog_servers_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkSyslogServers](https://developer.cisco.com/meraki/api-v1/#!update-network-syslog-servers)
> :   Complete reference of the updateNetworkSyslogServers API.

## [Examples](networks_syslog_servers_module.md#id6)
...
## [Return Values](networks_syslog_servers_module.md#id7)
