...
collection: ansible
version: "8"
title: "cisco.meraki.networks_clients_info module – Information module for networks _clients"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_clients_info_module.html
fetched_at: 2026-07-28T01:33:47+00:00
---
...
> see [Requirements](networks_clients_info_module.md#ansible-collections-cisco-meraki-networks-clients-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_clients_info`.

New in cisco.meraki 1.0.0

- [Synopsis](networks_clients_info_module.md#synopsis)
- [Requirements](networks_clients_info_module.md#requirements)
- [Parameters](networks_clients_info_module.md#parameters)
- [Notes](networks_clients_info_module.md#notes)
- [See Also](networks_clients_info_module.md#see-also)
- [Examples](networks_clients_info_module.md#examples)
- [Return Values](networks_clients_info_module.md#return-values)

## [Synopsis](networks_clients_info_module.md#id1)
...
## [Requirements](networks_clients_info_module.md#id2)
...
## [Parameters](networks_clients_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **description**  string | Description query parameter. Filters clients based on a partial or full match for the description field. |
...
| **ip**  string | Ip query parameter. Filters clients based on a partial or full match for the ip address field. |
| **ip6**  string | Ip6 query parameter. Filters clients based on a partial or full match for the ip6 address field. |
| **ip6Local**  string | Ip6Local query parameter. Filters clients based on a partial or full match for the ip6Local address field. |
| **mac**  string | Mac query parameter. Filters clients based on a partial or full match for the mac address field. |
...
| **os**  string | Os query parameter. Filters clients based on a partial or full match for the os (operating system) field. |
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 3 - 1000. Default is 10. |
| **pskGroup**  string | PskGroup query parameter. Filters clients based on partial or full match for the iPSK name field. |
| **recentDeviceConnections**  list / elements=string | RecentDeviceConnections query parameter. Filters clients based on recent connection type. Can be one of ‘Wired’ or ‘Wireless’. |
| **startingAfter**  string | StartingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it. |
| **statuses**  list / elements=string | Statuses query parameter. Filters clients based on status. Can be one of ‘Online’ or ‘Offline’. |
...
| **timespan**  float | Timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 1 day. |
...
| **vlan**  string | Vlan query parameter. Filters clients based on the full match for the VLAN field. |

## [Notes](networks_clients_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_clients,
> - Paths used are get /networks/{networkId}/clients,
> - Supports `check_mode`
...
## [See Also](networks_clients_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkClients](https://developer.cisco.com/meraki/api-v1/#!get-network-clients)
> :   Complete reference of the getNetworkClients API.

## [Examples](networks_clients_info_module.md#id6)
...
## [Return Values](networks_clients_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"adaptivePolicyGroup": "string", "description": "string", "deviceTypePrediction": "string", "firstSeen": 0, "groupPolicy8021x": "string", "id": "string", "ip": "string", "ip6": "string", "ip6Local": "string", "lastSeen": 0, "mac": "string", "manufacturer": "string", "namedVlan": "string", "notes": "string", "os": "string", "pskGroup": "string", "recentDeviceConnection": "string", "recentDeviceMac": "string", "recentDeviceName": "string", "recentDeviceSerial": "string", "smInstalled": true, "ssid": "string", "status": "string", "switchport": "string", "usage": {"recv": 0, "sent": 0}, "user": "string", "vlan": "string", "wirelessCapabilities": "string"}` |
