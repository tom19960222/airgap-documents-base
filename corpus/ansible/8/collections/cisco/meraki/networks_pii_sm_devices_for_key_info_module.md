...
collection: ansible
version: "8"
title: "cisco.meraki.networks_pii_sm_devices_for_key_info module – Information module for networks _pii _smdevicesforkey"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_pii_sm_devices_for_key_info_module.html
fetched_at: 2026-07-28T01:34:15+00:00
---
# cisco.meraki.networks_pii_sm_devices_for_key_info module – Information module for networks _pii _smdevicesforkey
...
> see [Requirements](networks_pii_sm_devices_for_key_info_module.md#ansible-collections-cisco-meraki-networks-pii-sm-devices-for-key-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_pii_sm_devices_for_key_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_pii_sm_devices_for_key_info_module.md#synopsis)
- [Requirements](networks_pii_sm_devices_for_key_info_module.md#requirements)
- [Parameters](networks_pii_sm_devices_for_key_info_module.md#parameters)
- [Notes](networks_pii_sm_devices_for_key_info_module.md#notes)
- [See Also](networks_pii_sm_devices_for_key_info_module.md#see-also)
- [Examples](networks_pii_sm_devices_for_key_info_module.md#examples)
- [Return Values](networks_pii_sm_devices_for_key_info_module.md#return-values)

## [Synopsis](networks_pii_sm_devices_for_key_info_module.md#id1)

- Get all networks _pii _smdevicesforkey.
- Given a piece of Personally Identifiable Information PII , return the Systems Manager device IDs associated with that identifier. These device IDs can be used with the Systems Manager API endpoints to retrieve device details. Exactly one identifier will be accepted.

> **Note:**
>
> This module has a corresponding [action plugin](../../../plugins/action.md#action-plugins).

## [Requirements](networks_pii_sm_devices_for_key_info_module.md#id2)
...
## [Parameters](networks_pii_sm_devices_for_key_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **bluetoothMac**  string | BluetoothMac query parameter. The MAC of a Bluetooth client. |
...
## [Notes](networks_pii_sm_devices_for_key_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_pii_sm_devices_for_key,
> - Paths used are get /networks/{networkId}/pii/smDevicesForKey,
> - Supports `check_mode`
...
## [See Also](networks_pii_sm_devices_for_key_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkPiiSmDevicesForKey](https://developer.cisco.com/meraki/api-v1/#!get-network-pii-sm-devices-for-key)
> :   Complete reference of the getNetworkPiiSmDevicesForKey API.

## [Examples](networks_pii_sm_devices_for_key_info_module.md#id6)
...
## [Return Values](networks_pii_sm_devices_for_key_info_module.md#id7)
