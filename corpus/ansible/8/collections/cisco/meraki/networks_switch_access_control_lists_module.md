...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_access_control_lists module – Resource module for networks _switch _accesscontrollists"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_access_control_lists_module.html
fetched_at: 2026-07-28T01:34:48+00:00
---
# cisco.meraki.networks_switch_access_control_lists module – Resource module for networks _switch _accesscontrollists
...
> see [Requirements](networks_switch_access_control_lists_module.md#ansible-collections-cisco-meraki-networks-switch-access-control-lists-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_access_control_lists`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_access_control_lists_module.md#synopsis)
- [Requirements](networks_switch_access_control_lists_module.md#requirements)
- [Parameters](networks_switch_access_control_lists_module.md#parameters)
- [Notes](networks_switch_access_control_lists_module.md#notes)
- [See Also](networks_switch_access_control_lists_module.md#see-also)
- [Examples](networks_switch_access_control_lists_module.md#examples)
- [Return Values](networks_switch_access_control_lists_module.md#return-values)

## [Synopsis](networks_switch_access_control_lists_module.md#id1)
...
## [Requirements](networks_switch_access_control_lists_module.md#id2)
...
## [Parameters](networks_switch_access_control_lists_module.md#id3)
...
| **rules**  list / elements=dictionary | An ordered array of the access control list rules (not including the default rule). An empty array will clear the rules. |
...
| **ipVersion**  string | IP address version (must be ‘any’, ‘ipv4’ or ‘ipv6’). Applicable only if network supports IPv6. Default value is ‘ipv4’. |
...
## [Notes](networks_switch_access_control_lists_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.update_network_switch_access_control_lists,
> - Paths used are put /networks/{networkId}/switch/accessControlLists,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_access_control_lists_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchAccessControlLists](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-access-control-lists)
> :   Complete reference of the updateNetworkSwitchAccessControlLists API.

## [Examples](networks_switch_access_control_lists_module.md#id6)
...
## [Return Values](networks_switch_access_control_lists_module.md#id7)
