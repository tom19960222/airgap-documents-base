...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stp module – Resource module for networks _switch _stp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stp_module.html
fetched_at: 2026-07-28T01:35:20+00:00
---
# cisco.meraki.networks_switch_stp module – Resource module for networks _switch _stp
...
> see [Requirements](networks_switch_stp_module.md#ansible-collections-cisco-meraki-networks-switch-stp-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stp`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stp_module.md#synopsis)
- [Requirements](networks_switch_stp_module.md#requirements)
- [Parameters](networks_switch_stp_module.md#parameters)
- [Notes](networks_switch_stp_module.md#notes)
- [See Also](networks_switch_stp_module.md#see-also)
- [Examples](networks_switch_stp_module.md#examples)
- [Return Values](networks_switch_stp_module.md#return-values)

## [Synopsis](networks_switch_stp_module.md#id1)
...
## [Requirements](networks_switch_stp_module.md#id2)
...
## [Parameters](networks_switch_stp_module.md#id3)
...
| **rstpEnabled**  boolean | The spanning tree protocol status in network.  **Choices:**   - `false` - `true` |
| **stpBridgePriority**  list / elements=dictionary | STP bridge priority for switches/stacks or switch profiles. An empty array will clear the STP bridge priority settings. |
| **stacks**  list / elements=string | List of stack IDs. |
| **stpPriority**  integer | STP priority for switch, stacks, or switch profiles. |
| **switches**  list / elements=string | List of switch serial numbers. |
| **switchProfiles**  list / elements=string | List of switch profile IDs. |

## [Notes](networks_switch_stp_module.md#id4)
...
## [See Also](networks_switch_stp_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchStp](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-stp)
> :   Complete reference of the updateNetworkSwitchStp API.

## [Examples](networks_switch_stp_module.md#id6)
...
## [Return Values](networks_switch_stp_module.md#id7)
