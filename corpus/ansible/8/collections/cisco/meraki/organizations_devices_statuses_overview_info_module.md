...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_devices_statuses_overview_info module – Information module for organizations _devices _statuses _overview"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_devices_statuses_overview_info_module.html
fetched_at: 2026-07-28T01:36:44+00:00
---
# cisco.meraki.organizations_devices_statuses_overview_info module – Information module for organizations _devices _statuses _overview
...
> see [Requirements](organizations_devices_statuses_overview_info_module.md#ansible-collections-cisco-meraki-organizations-devices-statuses-overview-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_devices_statuses_overview_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_devices_statuses_overview_info_module.md#synopsis)
- [Requirements](organizations_devices_statuses_overview_info_module.md#requirements)
- [Parameters](organizations_devices_statuses_overview_info_module.md#parameters)
- [Notes](organizations_devices_statuses_overview_info_module.md#notes)
- [See Also](organizations_devices_statuses_overview_info_module.md#see-also)
- [Examples](organizations_devices_statuses_overview_info_module.md#examples)
- [Return Values](organizations_devices_statuses_overview_info_module.md#return-values)

## [Synopsis](organizations_devices_statuses_overview_info_module.md#id1)
...
## [Requirements](organizations_devices_statuses_overview_info_module.md#id2)
...
## [Parameters](organizations_devices_statuses_overview_info_module.md#id3)
...
| **networkIds**  list / elements=string | NetworkIds query parameter. An optional parameter to filter device statuses by network. |
...
## [Notes](organizations_devices_statuses_overview_info_module.md#id4)
...
## [See Also](organizations_devices_statuses_overview_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationDevicesStatusesOverview](https://developer.cisco.com/meraki/api-v1/#!get-organization-devices-statuses-overview)
> :   Complete reference of the getOrganizationDevicesStatusesOverview API.

## [Examples](organizations_devices_statuses_overview_info_module.md#id6)
...
## [Return Values](organizations_devices_statuses_overview_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"byStatus": {"alerting": 0, "dormant": 0, "offline": 0, "online": 0}}` |
