...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_refresh_details module – Resource module for networks _sm _devices _refreshdetails"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_refresh_details_module.html
fetched_at: 2026-07-28T01:34:36+00:00
---
# cisco.meraki.networks_sm_devices_refresh_details module – Resource module for networks _sm _devices _refreshdetails
...
> see [Requirements](networks_sm_devices_refresh_details_module.md#ansible-collections-cisco-meraki-networks-sm-devices-refresh-details-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_refresh_details`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_refresh_details_module.md#synopsis)
- [Requirements](networks_sm_devices_refresh_details_module.md#requirements)
- [Parameters](networks_sm_devices_refresh_details_module.md#parameters)
- [Notes](networks_sm_devices_refresh_details_module.md#notes)
- [See Also](networks_sm_devices_refresh_details_module.md#see-also)
- [Examples](networks_sm_devices_refresh_details_module.md#examples)
- [Return Values](networks_sm_devices_refresh_details_module.md#return-values)

## [Synopsis](networks_sm_devices_refresh_details_module.md#id1)
...
## [Requirements](networks_sm_devices_refresh_details_module.md#id2)
...
## [Parameters](networks_sm_devices_refresh_details_module.md#id3)
...
## [Notes](networks_sm_devices_refresh_details_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.refresh_network_sm_device_details,
> - Paths used are post /networks/{networkId}/sm/devices/{deviceId}/refreshDetails,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_sm_devices_refresh_details_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm refreshNetworkSmDeviceDetails](https://developer.cisco.com/meraki/api-v1/#!refresh-network-sm-device-details)
> :   Complete reference of the refreshNetworkSmDeviceDetails API.

## [Examples](networks_sm_devices_refresh_details_module.md#id6)
...
## [Return Values](networks_sm_devices_refresh_details_module.md#id7)
