...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_dscp_to_cos_mappings_info module – Information module for networks _switch _dscptocosmappings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_dscp_to_cos_mappings_info_module.html
fetched_at: 2026-07-28T01:34:58+00:00
---
# cisco.meraki.networks_switch_dscp_to_cos_mappings_info module – Information module for networks _switch _dscptocosmappings
...
> see [Requirements](networks_switch_dscp_to_cos_mappings_info_module.md#ansible-collections-cisco-meraki-networks-switch-dscp-to-cos-mappings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_dscp_to_cos_mappings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_dscp_to_cos_mappings_info_module.md#synopsis)
- [Requirements](networks_switch_dscp_to_cos_mappings_info_module.md#requirements)
- [Parameters](networks_switch_dscp_to_cos_mappings_info_module.md#parameters)
- [Notes](networks_switch_dscp_to_cos_mappings_info_module.md#notes)
- [See Also](networks_switch_dscp_to_cos_mappings_info_module.md#see-also)
- [Examples](networks_switch_dscp_to_cos_mappings_info_module.md#examples)
- [Return Values](networks_switch_dscp_to_cos_mappings_info_module.md#return-values)

## [Synopsis](networks_switch_dscp_to_cos_mappings_info_module.md#id1)
...
## [Requirements](networks_switch_dscp_to_cos_mappings_info_module.md#id2)
...
## [Parameters](networks_switch_dscp_to_cos_mappings_info_module.md#id3)
...
## [Notes](networks_switch_dscp_to_cos_mappings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.get_network_switch_dscp_to_cos_mappings,
> - Paths used are get /networks/{networkId}/switch/dscpToCosMappings,
> - Supports `check_mode`
...
## [See Also](networks_switch_dscp_to_cos_mappings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchDscpToCosMappings](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-dscp-to-cos-mappings)
> :   Complete reference of the getNetworkSwitchDscpToCosMappings API.

## [Examples](networks_switch_dscp_to_cos_mappings_info_module.md#id6)
...
## [Return Values](networks_switch_dscp_to_cos_mappings_info_module.md#id7)
