...
collection: ansible
version: "8"
title: "cisco.meraki.networks_mqtt_brokers module – Resource module for networks _mqttbrokers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_mqtt_brokers_module.html
fetched_at: 2026-07-28T01:34:11+00:00
---
# cisco.meraki.networks_mqtt_brokers module – Resource module for networks _mqttbrokers
...
> see [Requirements](networks_mqtt_brokers_module.md#ansible-collections-cisco-meraki-networks-mqtt-brokers-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_mqtt_brokers`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_mqtt_brokers_module.md#synopsis)
- [Requirements](networks_mqtt_brokers_module.md#requirements)
- [Parameters](networks_mqtt_brokers_module.md#parameters)
- [Notes](networks_mqtt_brokers_module.md#notes)
- [See Also](networks_mqtt_brokers_module.md#see-also)
- [Examples](networks_mqtt_brokers_module.md#examples)
- [Return Values](networks_mqtt_brokers_module.md#return-values)

## [Synopsis](networks_mqtt_brokers_module.md#id1)
...
## [Requirements](networks_mqtt_brokers_module.md#id2)
...
## [Parameters](networks_mqtt_brokers_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **authentication**  dictionary | Authentication settings of the MQTT broker. |
...
| **security**  dictionary | Security settings of the MQTT broker. |
| **mode**  string | Security protocol of the MQTT broker. |
| **security**  dictionary | TLS settings of the MQTT broker. |
| **caCertificate**  string | CA Certificate of the MQTT broker. |
| **verifyHostnames**  boolean | Whether the TLS hostname verification is enabled for the MQTT broker.  **Choices:**   - `false` - `true` |

## [Notes](networks_mqtt_brokers_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.create_network_mqtt_broker,
> - Paths used are post /networks/{networkId}/mqttBrokers,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_mqtt_brokers_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks createNetworkMqttBroker](https://developer.cisco.com/meraki/api-v1/#!create-network-mqtt-broker)
> :   Complete reference of the createNetworkMqttBroker API.

## [Examples](networks_mqtt_brokers_module.md#id6)
...
## [Return Values](networks_mqtt_brokers_module.md#id7)
