...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licensing_coterm_licenses_info module – Information module for organizations _licensing _coterm _licenses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licensing_coterm_licenses_info_module.html
fetched_at: 2026-07-28T01:37:06+00:00
---
# cisco.meraki.organizations_licensing_coterm_licenses_info module – Information module for organizations _licensing _coterm _licenses
...
> see [Requirements](organizations_licensing_coterm_licenses_info_module.md#ansible-collections-cisco-meraki-organizations-licensing-coterm-licenses-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licensing_coterm_licenses_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licensing_coterm_licenses_info_module.md#synopsis)
- [Requirements](organizations_licensing_coterm_licenses_info_module.md#requirements)
- [Parameters](organizations_licensing_coterm_licenses_info_module.md#parameters)
- [Notes](organizations_licensing_coterm_licenses_info_module.md#notes)
- [See Also](organizations_licensing_coterm_licenses_info_module.md#see-also)
- [Examples](organizations_licensing_coterm_licenses_info_module.md#examples)
- [Return Values](organizations_licensing_coterm_licenses_info_module.md#return-values)

## [Synopsis](organizations_licensing_coterm_licenses_info_module.md#id1)
...
## [Requirements](organizations_licensing_coterm_licenses_info_module.md#id2)
...
## [Parameters](organizations_licensing_coterm_licenses_info_module.md#id3)
...
| **expired**  boolean | Expired query parameter. Filter for licenses that are expired.  **Choices:**   - `false` - `true` |
| **headers**  dictionary | Additional headers. |
| **invalidated**  boolean | Invalidated query parameter. Filter for licenses that are invalidated.  **Choices:**   - `false` - `true` |
...
## [Notes](organizations_licensing_coterm_licenses_info_module.md#id4)

> **Note:**
>
> - SDK Method used are licensing.Licensing.get_organization_licensing_coterm_licenses,
> - Paths used are get /organizations/{organizationId}/licensing/coterm/licenses,
> - Supports `check_mode`
...
## [See Also](organizations_licensing_coterm_licenses_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for licensing getOrganizationLicensingCotermLicenses](https://developer.cisco.com/meraki/api-v1/#!get-organization-licensing-coterm-licenses)
> :   Complete reference of the getOrganizationLicensingCotermLicenses API.

## [Examples](organizations_licensing_coterm_licenses_info_module.md#id6)
...
## [Return Values](organizations_licensing_coterm_licenses_info_module.md#id7)
