...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_quality_and_retention_info module – Information module for devices _camera _qualityandretention"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_quality_and_retention_info_module.html
fetched_at: 2026-07-28T01:31:47+00:00
---
# cisco.meraki.devices_camera_quality_and_retention_info module – Information module for devices _camera _qualityandretention
...
> see [Requirements](devices_camera_quality_and_retention_info_module.md#ansible-collections-cisco-meraki-devices-camera-quality-and-retention-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_quality_and_retention_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_quality_and_retention_info_module.md#synopsis)
- [Requirements](devices_camera_quality_and_retention_info_module.md#requirements)
- [Parameters](devices_camera_quality_and_retention_info_module.md#parameters)
- [Notes](devices_camera_quality_and_retention_info_module.md#notes)
- [See Also](devices_camera_quality_and_retention_info_module.md#see-also)
- [Examples](devices_camera_quality_and_retention_info_module.md#examples)
- [Return Values](devices_camera_quality_and_retention_info_module.md#return-values)

## [Synopsis](devices_camera_quality_and_retention_info_module.md#id1)
...
## [Requirements](devices_camera_quality_and_retention_info_module.md#id2)
...
## [Parameters](devices_camera_quality_and_retention_info_module.md#id3)
...
## [Notes](devices_camera_quality_and_retention_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_camera_quality_and_retention,
> - Paths used are get /devices/{serial}/camera/qualityAndRetention,
> - Supports `check_mode`
...
## [See Also](devices_camera_quality_and_retention_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceCameraQualityAndRetention](https://developer.cisco.com/meraki/api-v1/#!get-device-camera-quality-and-retention)
> :   Complete reference of the getDeviceCameraQualityAndRetention API.

## [Examples](devices_camera_quality_and_retention_info_module.md#id6)
...
## [Return Values](devices_camera_quality_and_retention_info_module.md#id7)
