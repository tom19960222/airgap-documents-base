...
collection: ansible
version: "8"
title: "cisco.meraki.networks_cellular_gateway_dhcp_info module – Information module for networks _cellulargateway _dhcp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_cellular_gateway_dhcp_info_module.html
fetched_at: 2026-07-28T01:33:43+00:00
---
# cisco.meraki.networks_cellular_gateway_dhcp_info module – Information module for networks _cellulargateway _dhcp
...
> see [Requirements](networks_cellular_gateway_dhcp_info_module.md#ansible-collections-cisco-meraki-networks-cellular-gateway-dhcp-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_cellular_gateway_dhcp_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_cellular_gateway_dhcp_info_module.md#synopsis)
- [Requirements](networks_cellular_gateway_dhcp_info_module.md#requirements)
- [Parameters](networks_cellular_gateway_dhcp_info_module.md#parameters)
- [Notes](networks_cellular_gateway_dhcp_info_module.md#notes)
- [See Also](networks_cellular_gateway_dhcp_info_module.md#see-also)
- [Examples](networks_cellular_gateway_dhcp_info_module.md#examples)
- [Return Values](networks_cellular_gateway_dhcp_info_module.md#return-values)

## [Synopsis](networks_cellular_gateway_dhcp_info_module.md#id1)
...
## [Requirements](networks_cellular_gateway_dhcp_info_module.md#id2)
...
## [Parameters](networks_cellular_gateway_dhcp_info_module.md#id3)
...
## [Notes](networks_cellular_gateway_dhcp_info_module.md#id4)

> **Note:**
>
> - SDK Method used are cellular_gateway.CellularGateway.get_network_cellular_gateway_dhcp,
> - Paths used are get /networks/{networkId}/cellularGateway/dhcp,
> - Supports `check_mode`
...
## [See Also](networks_cellular_gateway_dhcp_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway getNetworkCellularGatewayDhcp](https://developer.cisco.com/meraki/api-v1/#!get-network-cellular-gateway-dhcp)
> :   Complete reference of the getNetworkCellularGatewayDhcp API.

## [Examples](networks_cellular_gateway_dhcp_info_module.md#id6)
...
## [Return Values](networks_cellular_gateway_dhcp_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"dhcpLeaseTime": "string", "dnsCustomNameservers": ["string"], "dnsNameservers": "string"}` |
