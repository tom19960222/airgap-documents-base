...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_config_templates_info module – Information module for organizations _configtemplates"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_config_templates_info_module.html
fetched_at: 2026-07-28T01:36:37+00:00
---
# cisco.meraki.organizations_config_templates_info module – Information module for organizations _configtemplates
...
> see [Requirements](organizations_config_templates_info_module.md#ansible-collections-cisco-meraki-organizations-config-templates-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_config_templates_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_config_templates_info_module.md#synopsis)
- [Requirements](organizations_config_templates_info_module.md#requirements)
- [Parameters](organizations_config_templates_info_module.md#parameters)
- [Notes](organizations_config_templates_info_module.md#notes)
- [See Also](organizations_config_templates_info_module.md#see-also)
- [Examples](organizations_config_templates_info_module.md#examples)
- [Return Values](organizations_config_templates_info_module.md#return-values)

## [Synopsis](organizations_config_templates_info_module.md#id1)
...
## [Requirements](organizations_config_templates_info_module.md#id2)
...
## [Parameters](organizations_config_templates_info_module.md#id3)
...
## [Notes](organizations_config_templates_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_config_template, organizations.Organizations.get_organization_config_templates,
...
## [See Also](organizations_config_templates_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationConfigTemplate](https://developer.cisco.com/meraki/api-v1/#!get-organization-config-template)
> :   Complete reference of the getOrganizationConfigTemplate API.
>
> [Cisco Meraki documentation for organizations getOrganizationConfigTemplates](https://developer.cisco.com/meraki/api-v1/#!get-organization-config-templates)
> :   Complete reference of the getOrganizationConfigTemplates API.

## [Examples](organizations_config_templates_info_module.md#id6)
...
## [Return Values](organizations_config_templates_info_module.md#id7)
