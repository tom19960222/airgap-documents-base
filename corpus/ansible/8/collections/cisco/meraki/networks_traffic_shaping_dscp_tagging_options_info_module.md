...
collection: ansible
version: "8"
title: "cisco.meraki.networks_traffic_shaping_dscp_tagging_options_info module – Information module for networks _trafficshaping _dscptaggingoptions"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_traffic_shaping_dscp_tagging_options_info_module.html
fetched_at: 2026-07-28T01:35:25+00:00
---
# cisco.meraki.networks_traffic_shaping_dscp_tagging_options_info module – Information module for networks _trafficshaping _dscptaggingoptions
...
> see [Requirements](networks_traffic_shaping_dscp_tagging_options_info_module.md#ansible-collections-cisco-meraki-networks-traffic-shaping-dscp-tagging-options-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_traffic_shaping_dscp_tagging_options_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_traffic_shaping_dscp_tagging_options_info_module.md#synopsis)
- [Requirements](networks_traffic_shaping_dscp_tagging_options_info_module.md#requirements)
- [Parameters](networks_traffic_shaping_dscp_tagging_options_info_module.md#parameters)
- [Notes](networks_traffic_shaping_dscp_tagging_options_info_module.md#notes)
- [See Also](networks_traffic_shaping_dscp_tagging_options_info_module.md#see-also)
- [Examples](networks_traffic_shaping_dscp_tagging_options_info_module.md#examples)
- [Return Values](networks_traffic_shaping_dscp_tagging_options_info_module.md#return-values)

## [Synopsis](networks_traffic_shaping_dscp_tagging_options_info_module.md#id1)
...
## [Requirements](networks_traffic_shaping_dscp_tagging_options_info_module.md#id2)
...
## [Parameters](networks_traffic_shaping_dscp_tagging_options_info_module.md#id3)
...
## [Notes](networks_traffic_shaping_dscp_tagging_options_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_traffic_shaping_dscp_tagging_options,
> - Paths used are get /networks/{networkId}/trafficShaping/dscpTaggingOptions,
> - Supports `check_mode`
...
## [See Also](networks_traffic_shaping_dscp_tagging_options_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkTrafficShapingDscpTaggingOptions](https://developer.cisco.com/meraki/api-v1/#!get-network-traffic-shaping-dscp-tagging-options)
> :   Complete reference of the getNetworkTrafficShapingDscpTaggingOptions API.

## [Examples](networks_traffic_shaping_dscp_tagging_options_info_module.md#id6)
...
## [Return Values](networks_traffic_shaping_dscp_tagging_options_info_module.md#id7)
