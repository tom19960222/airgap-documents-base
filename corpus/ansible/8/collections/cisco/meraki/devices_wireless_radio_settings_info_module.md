...
collection: ansible
version: "8"
title: "cisco.meraki.devices_wireless_radio_settings_info module – Information module for devices _wireless _radio _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_wireless_radio_settings_info_module.html
fetched_at: 2026-07-28T01:32:17+00:00
---
# cisco.meraki.devices_wireless_radio_settings_info module – Information module for devices _wireless _radio _settings
...
> see [Requirements](devices_wireless_radio_settings_info_module.md#ansible-collections-cisco-meraki-devices-wireless-radio-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_wireless_radio_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_wireless_radio_settings_info_module.md#synopsis)
- [Requirements](devices_wireless_radio_settings_info_module.md#requirements)
- [Parameters](devices_wireless_radio_settings_info_module.md#parameters)
- [Notes](devices_wireless_radio_settings_info_module.md#notes)
- [See Also](devices_wireless_radio_settings_info_module.md#see-also)
- [Examples](devices_wireless_radio_settings_info_module.md#examples)
- [Return Values](devices_wireless_radio_settings_info_module.md#return-values)

## [Synopsis](devices_wireless_radio_settings_info_module.md#id1)
...
## [Requirements](devices_wireless_radio_settings_info_module.md#id2)
...
## [Parameters](devices_wireless_radio_settings_info_module.md#id3)
...
## [Notes](devices_wireless_radio_settings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_wireless_radio_settings,
...
## [See Also](devices_wireless_radio_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceWirelessRadioSettings](https://developer.cisco.com/meraki/api-v1/#!get-device-wireless-radio-settings)
> :   Complete reference of the getDeviceWirelessRadioSettings API.

## [Examples](devices_wireless_radio_settings_info_module.md#id6)
...
## [Return Values](devices_wireless_radio_settings_info_module.md#id7)
