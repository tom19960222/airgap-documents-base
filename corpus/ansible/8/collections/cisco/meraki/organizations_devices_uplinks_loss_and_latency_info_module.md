...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_devices_uplinks_loss_and_latency_info module – Information module for organizations _devices _uplinkslossandlatency"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_devices_uplinks_loss_and_latency_info_module.html
fetched_at: 2026-07-28T01:36:46+00:00
---
# cisco.meraki.organizations_devices_uplinks_loss_and_latency_info module – Information module for organizations _devices _uplinkslossandlatency
...
> see [Requirements](organizations_devices_uplinks_loss_and_latency_info_module.md#ansible-collections-cisco-meraki-organizations-devices-uplinks-loss-and-latency-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_devices_uplinks_loss_and_latency_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_devices_uplinks_loss_and_latency_info_module.md#synopsis)
- [Requirements](organizations_devices_uplinks_loss_and_latency_info_module.md#requirements)
- [Parameters](organizations_devices_uplinks_loss_and_latency_info_module.md#parameters)
- [Notes](organizations_devices_uplinks_loss_and_latency_info_module.md#notes)
- [See Also](organizations_devices_uplinks_loss_and_latency_info_module.md#see-also)
- [Examples](organizations_devices_uplinks_loss_and_latency_info_module.md#examples)
- [Return Values](organizations_devices_uplinks_loss_and_latency_info_module.md#return-values)

## [Synopsis](organizations_devices_uplinks_loss_and_latency_info_module.md#id1)
...
## [Requirements](organizations_devices_uplinks_loss_and_latency_info_module.md#id2)
...
## [Parameters](organizations_devices_uplinks_loss_and_latency_info_module.md#id3)
...
| **timespan**  float | Timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 5 minutes. The default is 5 minutes. |
...
## [Notes](organizations_devices_uplinks_loss_and_latency_info_module.md#id4)
...
## [See Also](organizations_devices_uplinks_loss_and_latency_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationDevicesUplinksLossAndLatency](https://developer.cisco.com/meraki/api-v1/#!get-organization-devices-uplinks-loss-and-latency)
> :   Complete reference of the getOrganizationDevicesUplinksLossAndLatency API.

## [Examples](organizations_devices_uplinks_loss_and_latency_info_module.md#id6)
...
## [Return Values](organizations_devices_uplinks_loss_and_latency_info_module.md#id7)
