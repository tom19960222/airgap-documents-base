...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_sm_vpp_accounts_info module – Information module for organizations _sm _vppaccounts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_sm_vpp_accounts_info_module.html
fetched_at: 2026-07-28T01:37:20+00:00
---
# cisco.meraki.organizations_sm_vpp_accounts_info module – Information module for organizations _sm _vppaccounts
...
> see [Requirements](organizations_sm_vpp_accounts_info_module.md#ansible-collections-cisco-meraki-organizations-sm-vpp-accounts-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_sm_vpp_accounts_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_sm_vpp_accounts_info_module.md#synopsis)
- [Requirements](organizations_sm_vpp_accounts_info_module.md#requirements)
- [Parameters](organizations_sm_vpp_accounts_info_module.md#parameters)
- [Notes](organizations_sm_vpp_accounts_info_module.md#notes)
- [See Also](organizations_sm_vpp_accounts_info_module.md#see-also)
- [Examples](organizations_sm_vpp_accounts_info_module.md#examples)
- [Return Values](organizations_sm_vpp_accounts_info_module.md#return-values)

## [Synopsis](organizations_sm_vpp_accounts_info_module.md#id1)
...
## [Requirements](organizations_sm_vpp_accounts_info_module.md#id2)
...
## [Parameters](organizations_sm_vpp_accounts_info_module.md#id3)
...
| **vppAccountId**  string | VppAccountId path parameter. Vpp account ID. |

## [Notes](organizations_sm_vpp_accounts_info_module.md#id4)
...
## [See Also](organizations_sm_vpp_accounts_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getOrganizationSmVppAccount](https://developer.cisco.com/meraki/api-v1/#!get-organization-sm-vpp-account)
> :   Complete reference of the getOrganizationSmVppAccount API.
>
> [Cisco Meraki documentation for sm getOrganizationSmVppAccounts](https://developer.cisco.com/meraki/api-v1/#!get-organization-sm-vpp-accounts)
> :   Complete reference of the getOrganizationSmVppAccounts API.

## [Examples](organizations_sm_vpp_accounts_info_module.md#id6)
...
## [Return Values](organizations_sm_vpp_accounts_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"id": "string", "vppServiceToken": "string"}` |
