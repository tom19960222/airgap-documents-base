...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_clients_connection_stats_info module – Information module for networks _wireless _clients _connectionstats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_clients_connection_stats_info_module.html
fetched_at: 2026-07-28T01:35:38+00:00
---
# cisco.meraki.networks_wireless_clients_connection_stats_info module – Information module for networks _wireless _clients _connectionstats
...
> see [Requirements](networks_wireless_clients_connection_stats_info_module.md#ansible-collections-cisco-meraki-networks-wireless-clients-connection-stats-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_clients_connection_stats_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_clients_connection_stats_info_module.md#synopsis)
- [Requirements](networks_wireless_clients_connection_stats_info_module.md#requirements)
- [Parameters](networks_wireless_clients_connection_stats_info_module.md#parameters)
- [Notes](networks_wireless_clients_connection_stats_info_module.md#notes)
- [See Also](networks_wireless_clients_connection_stats_info_module.md#see-also)
- [Examples](networks_wireless_clients_connection_stats_info_module.md#examples)
- [Return Values](networks_wireless_clients_connection_stats_info_module.md#return-values)

## [Synopsis](networks_wireless_clients_connection_stats_info_module.md#id1)
...
## [Requirements](networks_wireless_clients_connection_stats_info_module.md#id2)
...
## [Parameters](networks_wireless_clients_connection_stats_info_module.md#id3)
...
## [Notes](networks_wireless_clients_connection_stats_info_module.md#id4)
...
## [See Also](networks_wireless_clients_connection_stats_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessClientConnectionStats](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-client-connection-stats)
> :   Complete reference of the getNetworkWirelessClientConnectionStats API.

## [Examples](networks_wireless_clients_connection_stats_info_module.md#id6)
...
## [Return Values](networks_wireless_clients_connection_stats_info_module.md#id7)
