...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_user_access_devices_delete module – Resource module for networks _sm _useraccessdevices _delete"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_user_access_devices_delete_module.html
fetched_at: 2026-07-28T01:34:42+00:00
---
# cisco.meraki.networks_sm_user_access_devices_delete module – Resource module for networks _sm _useraccessdevices _delete
...
> see [Requirements](networks_sm_user_access_devices_delete_module.md#ansible-collections-cisco-meraki-networks-sm-user-access-devices-delete-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_user_access_devices_delete`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_user_access_devices_delete_module.md#synopsis)
- [Requirements](networks_sm_user_access_devices_delete_module.md#requirements)
- [Parameters](networks_sm_user_access_devices_delete_module.md#parameters)
- [Notes](networks_sm_user_access_devices_delete_module.md#notes)
- [See Also](networks_sm_user_access_devices_delete_module.md#see-also)
- [Examples](networks_sm_user_access_devices_delete_module.md#examples)
- [Return Values](networks_sm_user_access_devices_delete_module.md#return-values)

## [Synopsis](networks_sm_user_access_devices_delete_module.md#id1)
...
## [Requirements](networks_sm_user_access_devices_delete_module.md#id2)
...
## [Parameters](networks_sm_user_access_devices_delete_module.md#id3)
...
## [Notes](networks_sm_user_access_devices_delete_module.md#id4)
...
## [See Also](networks_sm_user_access_devices_delete_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm deleteNetworkSmUserAccessDevice](https://developer.cisco.com/meraki/api-v1/#!delete-network-sm-user-access-device)
> :   Complete reference of the deleteNetworkSmUserAccessDevice API.

## [Examples](networks_sm_user_access_devices_delete_module.md#id6)
...
## [Return Values](networks_sm_user_access_devices_delete_module.md#id7)
