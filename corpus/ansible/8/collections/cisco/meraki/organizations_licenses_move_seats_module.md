...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licenses_move_seats module – Resource module for organizations _licenses _moveseats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licenses_move_seats_module.html
fetched_at: 2026-07-28T01:37:04+00:00
---
# cisco.meraki.organizations_licenses_move_seats module – Resource module for organizations _licenses _moveseats
...
> see [Requirements](organizations_licenses_move_seats_module.md#ansible-collections-cisco-meraki-organizations-licenses-move-seats-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licenses_move_seats`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licenses_move_seats_module.md#synopsis)
- [Requirements](organizations_licenses_move_seats_module.md#requirements)
- [Parameters](organizations_licenses_move_seats_module.md#parameters)
- [Notes](organizations_licenses_move_seats_module.md#notes)
- [See Also](organizations_licenses_move_seats_module.md#see-also)
- [Examples](organizations_licenses_move_seats_module.md#examples)
- [Return Values](organizations_licenses_move_seats_module.md#return-values)

## [Synopsis](organizations_licenses_move_seats_module.md#id1)
...
## [Requirements](organizations_licenses_move_seats_module.md#id2)
...
## [Parameters](organizations_licenses_move_seats_module.md#id3)
...
## [Notes](organizations_licenses_move_seats_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.move_organization_licenses_seats,
> - Paths used are post /organizations/{organizationId}/licenses/moveSeats,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_licenses_move_seats_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations moveOrganizationLicensesSeats](https://developer.cisco.com/meraki/api-v1/#!move-organization-licenses-seats)
> :   Complete reference of the moveOrganizationLicensesSeats API.

## [Examples](organizations_licenses_move_seats_module.md#id6)
...
## [Return Values](organizations_licenses_move_seats_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"destOrganizationId": "string", "licenseId": "string", "seatCount": 0}` |
