...
collection: ansible
version: "8"
title: "cisco.meraki.networks_clients_policy module – Resource module for networks _clients _policy"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_clients_policy_module.html
...
> see [Requirements](networks_clients_policy_module.md#ansible-collections-cisco-meraki-networks-clients-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_clients_policy`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_clients_policy_module.md#synopsis)
- [Requirements](networks_clients_policy_module.md#requirements)
- [Parameters](networks_clients_policy_module.md#parameters)
- [Notes](networks_clients_policy_module.md#notes)
- [See Also](networks_clients_policy_module.md#see-also)
- [Examples](networks_clients_policy_module.md#examples)
- [Return Values](networks_clients_policy_module.md#return-values)

## [Synopsis](networks_clients_policy_module.md#id1)
...
## [Requirements](networks_clients_policy_module.md#id2)
...
## [Parameters](networks_clients_policy_module.md#id3)
...
## [Notes](networks_clients_policy_module.md#id4)
...
## [See Also](networks_clients_policy_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkClientPolicy](https://developer.cisco.com/meraki/api-v1/#!update-network-client-policy)
> :   Complete reference of the updateNetworkClientPolicy API.

## [Examples](networks_clients_policy_module.md#id6)
...
## [Return Values](networks_clients_policy_module.md#id7)
