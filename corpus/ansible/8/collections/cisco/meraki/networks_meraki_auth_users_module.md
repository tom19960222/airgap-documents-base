...
collection: ansible
version: "8"
title: "cisco.meraki.networks_meraki_auth_users module – Resource module for networks _merakiauthusers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_meraki_auth_users_module.html
fetched_at: 2026-07-28T01:34:10+00:00
---
# cisco.meraki.networks_meraki_auth_users module – Resource module for networks _merakiauthusers
...
> see [Requirements](networks_meraki_auth_users_module.md#ansible-collections-cisco-meraki-networks-meraki-auth-users-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_meraki_auth_users`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_meraki_auth_users_module.md#synopsis)
- [Requirements](networks_meraki_auth_users_module.md#requirements)
- [Parameters](networks_meraki_auth_users_module.md#parameters)
- [Notes](networks_meraki_auth_users_module.md#notes)
- [See Also](networks_meraki_auth_users_module.md#see-also)
- [Examples](networks_meraki_auth_users_module.md#examples)
- [Return Values](networks_meraki_auth_users_module.md#return-values)

## [Synopsis](networks_meraki_auth_users_module.md#id1)
...
## [Requirements](networks_meraki_auth_users_module.md#id2)
...
## [Parameters](networks_meraki_auth_users_module.md#id3)
...
| **emailPasswordToUser**  boolean | Whether or not Meraki should email the password to user. Default is false.  **Choices:**   - `false` - `true` |
| **isAdmin**  boolean | Whether or not the user is a Dashboard administrator.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_meraki_auth_users_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.create_network_meraki_auth_user, networks.Networks.delete_network_meraki_auth_user, networks.Networks.update_network_meraki_auth_user,
> - Paths used are post /networks/{networkId}/merakiAuthUsers, delete /networks/{networkId}/merakiAuthUsers/{merakiAuthUserId}, put /networks/{networkId}/merakiAuthUsers/{merakiAuthUserId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_meraki_auth_users_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks createNetworkMerakiAuthUser](https://developer.cisco.com/meraki/api-v1/#!create-network-meraki-auth-user)
> :   Complete reference of the createNetworkMerakiAuthUser API.
>
> [Cisco Meraki documentation for networks deleteNetworkMerakiAuthUser](https://developer.cisco.com/meraki/api-v1/#!delete-network-meraki-auth-user)
> :   Complete reference of the deleteNetworkMerakiAuthUser API.
>
> [Cisco Meraki documentation for networks updateNetworkMerakiAuthUser](https://developer.cisco.com/meraki/api-v1/#!update-network-meraki-auth-user)
> :   Complete reference of the updateNetworkMerakiAuthUser API.

## [Examples](networks_meraki_auth_users_module.md#id6)
...
## [Return Values](networks_meraki_auth_users_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"accountType": "string", "authorizations": [{"authorizedByEmail": "string", "authorizedByName": "string", "authorizedZone": "string", "expiresAt": "string", "ssidNumber": 0}], "createdAt": "string", "email": "string", "id": "string", "isAdmin": true, "name": "string"}` |
