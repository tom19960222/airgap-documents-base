...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licenses module – Resource module for organizations _licenses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licenses_module.html
fetched_at: 2026-07-28T01:37:01+00:00
---
# cisco.meraki.organizations_licenses module – Resource module for organizations _licenses
...
> see [Requirements](organizations_licenses_module.md#ansible-collections-cisco-meraki-organizations-licenses-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licenses`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licenses_module.md#synopsis)
- [Requirements](organizations_licenses_module.md#requirements)
- [Parameters](organizations_licenses_module.md#parameters)
- [Notes](organizations_licenses_module.md#notes)
- [See Also](organizations_licenses_module.md#see-also)
- [Examples](organizations_licenses_module.md#examples)
- [Return Values](organizations_licenses_module.md#return-values)

## [Synopsis](organizations_licenses_module.md#id1)
...
## [Requirements](organizations_licenses_module.md#id2)
...
## [Parameters](organizations_licenses_module.md#id3)
...
## [Notes](organizations_licenses_module.md#id4)
...
## [See Also](organizations_licenses_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations updateOrganizationLicense](https://developer.cisco.com/meraki/api-v1/#!update-organization-license)
> :   Complete reference of the updateOrganizationLicense API.

## [Examples](organizations_licenses_module.md#id6)
...
## [Return Values](organizations_licenses_module.md#id7)
