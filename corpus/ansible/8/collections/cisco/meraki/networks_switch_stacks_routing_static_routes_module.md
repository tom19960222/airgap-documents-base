...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stacks_routing_static_routes module – Resource module for networks _switch _stacks _routing _staticroutes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stacks_routing_static_routes_module.html
fetched_at: 2026-07-28T01:35:17+00:00
---
# cisco.meraki.networks_switch_stacks_routing_static_routes module – Resource module for networks _switch _stacks _routing _staticroutes
...
> see [Requirements](networks_switch_stacks_routing_static_routes_module.md#ansible-collections-cisco-meraki-networks-switch-stacks-routing-static-routes-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stacks_routing_static_routes`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stacks_routing_static_routes_module.md#synopsis)
- [Requirements](networks_switch_stacks_routing_static_routes_module.md#requirements)
- [Parameters](networks_switch_stacks_routing_static_routes_module.md#parameters)
- [Notes](networks_switch_stacks_routing_static_routes_module.md#notes)
- [See Also](networks_switch_stacks_routing_static_routes_module.md#see-also)
- [Examples](networks_switch_stacks_routing_static_routes_module.md#examples)
- [Return Values](networks_switch_stacks_routing_static_routes_module.md#return-values)

## [Synopsis](networks_switch_stacks_routing_static_routes_module.md#id1)
...
## [Requirements](networks_switch_stacks_routing_static_routes_module.md#id2)
...
## [Parameters](networks_switch_stacks_routing_static_routes_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **advertiseViaOspfEnabled**  boolean | Option to advertise static route via OSPF.  **Choices:**   - `false` - `true` |
...
| **preferOverOspfRoutesEnabled**  boolean | Option to prefer static route over OSPF routes.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_switch_stacks_routing_static_routes_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.create_network_switch_stack_routing_static_route, switch.Switch.delete_network_switch_stack_routing_static_route, switch.Switch.update_network_switch_stack_routing_static_route,
> - Paths used are post /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes, delete /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes/{staticRouteId}, put /networks/{networkId}/switch/stacks/{switchStackId}/routing/staticRoutes/{staticRouteId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_stacks_routing_static_routes_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch createNetworkSwitchStackRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!create-network-switch-stack-routing-static-route)
> :   Complete reference of the createNetworkSwitchStackRoutingStaticRoute API.
>
> [Cisco Meraki documentation for switch deleteNetworkSwitchStackRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!delete-network-switch-stack-routing-static-route)
> :   Complete reference of the deleteNetworkSwitchStackRoutingStaticRoute API.
>
> [Cisco Meraki documentation for switch updateNetworkSwitchStackRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-stack-routing-static-route)
> :   Complete reference of the updateNetworkSwitchStackRoutingStaticRoute API.

## [Examples](networks_switch_stacks_routing_static_routes_module.md#id6)
...
## [Return Values](networks_switch_stacks_routing_static_routes_module.md#id7)
