...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_sensor_readings_latest_info module – Information module for organizations _sensor _readings _latest"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_sensor_readings_latest_info_module.html
fetched_at: 2026-07-28T01:37:19+00:00
---
# cisco.meraki.organizations_sensor_readings_latest_info module – Information module for organizations _sensor _readings _latest
...
> see [Requirements](organizations_sensor_readings_latest_info_module.md#ansible-collections-cisco-meraki-organizations-sensor-readings-latest-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_sensor_readings_latest_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_sensor_readings_latest_info_module.md#synopsis)
- [Requirements](organizations_sensor_readings_latest_info_module.md#requirements)
- [Parameters](organizations_sensor_readings_latest_info_module.md#parameters)
- [Notes](organizations_sensor_readings_latest_info_module.md#notes)
- [See Also](organizations_sensor_readings_latest_info_module.md#see-also)
- [Examples](organizations_sensor_readings_latest_info_module.md#examples)
- [Return Values](organizations_sensor_readings_latest_info_module.md#return-values)

## [Synopsis](organizations_sensor_readings_latest_info_module.md#id1)
...
## [Requirements](organizations_sensor_readings_latest_info_module.md#id2)
...
## [Parameters](organizations_sensor_readings_latest_info_module.md#id3)
...
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 3 - 100. Default is 100. |
...
## [Notes](organizations_sensor_readings_latest_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sensor.Sensor.get_organization_sensor_readings_latest,
> - Paths used are get /organizations/{organizationId}/sensor/readings/latest,
> - Supports `check_mode`
...
## [See Also](organizations_sensor_readings_latest_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sensor getOrganizationSensorReadingsLatest](https://developer.cisco.com/meraki/api-v1/#!get-organization-sensor-readings-latest)
> :   Complete reference of the getOrganizationSensorReadingsLatest API.

## [Examples](organizations_sensor_readings_latest_info_module.md#id6)
...
## [Return Values](organizations_sensor_readings_latest_info_module.md#id7)
