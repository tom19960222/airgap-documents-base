...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_sensor_readings_history_info module – Information module for organizations _sensor _readings _history"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_sensor_readings_history_info_module.html
fetched_at: 2026-07-28T01:37:18+00:00
---
# cisco.meraki.organizations_sensor_readings_history_info module – Information module for organizations _sensor _readings _history
...
> see [Requirements](organizations_sensor_readings_history_info_module.md#ansible-collections-cisco-meraki-organizations-sensor-readings-history-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_sensor_readings_history_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_sensor_readings_history_info_module.md#synopsis)
- [Requirements](organizations_sensor_readings_history_info_module.md#requirements)
- [Parameters](organizations_sensor_readings_history_info_module.md#parameters)
- [Notes](organizations_sensor_readings_history_info_module.md#notes)
- [See Also](organizations_sensor_readings_history_info_module.md#see-also)
- [Examples](organizations_sensor_readings_history_info_module.md#examples)
- [Return Values](organizations_sensor_readings_history_info_module.md#return-values)

## [Synopsis](organizations_sensor_readings_history_info_module.md#id1)
...
## [Requirements](organizations_sensor_readings_history_info_module.md#id2)
...
## [Parameters](organizations_sensor_readings_history_info_module.md#id3)
...
| **metrics**  list / elements=string | Metrics query parameter. Types of sensor readings to retrieve. If no metrics are supplied, all available types of readings will be retrieved. Allowed values are battery, button, door, humidity, indoorAirQuality, noise, pm25, temperature, tvoc, and water. |
| **networkIds**  list / elements=string | NetworkIds query parameter. Optional parameter to filter readings by network. |
...
| **serials**  list / elements=string | Serials query parameter. Optional parameter to filter readings by sensor. |
...
| **timespan**  float | Timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 7 days. The default is 2 hours. |
...
## [Notes](organizations_sensor_readings_history_info_module.md#id4)
...
## [See Also](organizations_sensor_readings_history_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sensor getOrganizationSensorReadingsHistory](https://developer.cisco.com/meraki/api-v1/#!get-organization-sensor-readings-history)
> :   Complete reference of the getOrganizationSensorReadingsHistory API.

## [Examples](organizations_sensor_readings_history_info_module.md#id6)
...
## [Return Values](organizations_sensor_readings_history_info_module.md#id7)
