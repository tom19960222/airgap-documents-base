...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sensor_alerts_current_overview_by_metric_info module – Information module for networks _sensor _alerts _current _overview _bymetric"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sensor_alerts_current_overview_by_metric_info_module.html
fetched_at: 2026-07-28T01:34:18+00:00
---
# cisco.meraki.networks_sensor_alerts_current_overview_by_metric_info module – Information module for networks _sensor _alerts _current _overview _bymetric
...
> see [Requirements](networks_sensor_alerts_current_overview_by_metric_info_module.md#ansible-collections-cisco-meraki-networks-sensor-alerts-current-overview-by-metric-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sensor_alerts_current_overview_by_metric_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sensor_alerts_current_overview_by_metric_info_module.md#synopsis)
- [Requirements](networks_sensor_alerts_current_overview_by_metric_info_module.md#requirements)
- [Parameters](networks_sensor_alerts_current_overview_by_metric_info_module.md#parameters)
- [Notes](networks_sensor_alerts_current_overview_by_metric_info_module.md#notes)
- [See Also](networks_sensor_alerts_current_overview_by_metric_info_module.md#see-also)
- [Examples](networks_sensor_alerts_current_overview_by_metric_info_module.md#examples)
- [Return Values](networks_sensor_alerts_current_overview_by_metric_info_module.md#return-values)

## [Synopsis](networks_sensor_alerts_current_overview_by_metric_info_module.md#id1)
...
## [Requirements](networks_sensor_alerts_current_overview_by_metric_info_module.md#id2)
...
## [Parameters](networks_sensor_alerts_current_overview_by_metric_info_module.md#id3)
...
## [Notes](networks_sensor_alerts_current_overview_by_metric_info_module.md#id4)
...
## [See Also](networks_sensor_alerts_current_overview_by_metric_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sensor getNetworkSensorAlertsCurrentOverviewByMetric](https://developer.cisco.com/meraki/api-v1/#!get-network-sensor-alerts-current-overview-by-metric)
> :   Complete reference of the getNetworkSensorAlertsCurrentOverviewByMetric API.

## [Examples](networks_sensor_alerts_current_overview_by_metric_info_module.md#id6)
...
## [Return Values](networks_sensor_alerts_current_overview_by_metric_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"counts": {"door": 0, "humidity": 0, "indoorAirQuality": 0, "noise": {"ambient": 0}, "pm25": 0, "temperature": 0, "tvoc": 0, "water": 0}, "supportedMetrics": ["string"]}` |
