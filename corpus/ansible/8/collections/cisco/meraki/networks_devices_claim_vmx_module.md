...
collection: ansible
version: "8"
title: "cisco.meraki.networks_devices_claim_vmx module – Resource module for networks _devices _claim _vmx"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_devices_claim_vmx_module.html
fetched_at: 2026-07-28T01:33:53+00:00
---
# cisco.meraki.networks_devices_claim_vmx module – Resource module for networks _devices _claim _vmx
...
> see [Requirements](networks_devices_claim_vmx_module.md#ansible-collections-cisco-meraki-networks-devices-claim-vmx-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_devices_claim_vmx`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_devices_claim_vmx_module.md#synopsis)
- [Requirements](networks_devices_claim_vmx_module.md#requirements)
- [Parameters](networks_devices_claim_vmx_module.md#parameters)
- [Notes](networks_devices_claim_vmx_module.md#notes)
- [See Also](networks_devices_claim_vmx_module.md#see-also)
- [Examples](networks_devices_claim_vmx_module.md#examples)
- [Return Values](networks_devices_claim_vmx_module.md#return-values)

## [Synopsis](networks_devices_claim_vmx_module.md#id1)
...
## [Requirements](networks_devices_claim_vmx_module.md#id2)
...
## [Parameters](networks_devices_claim_vmx_module.md#id3)
...
## [Notes](networks_devices_claim_vmx_module.md#id4)
...
## [See Also](networks_devices_claim_vmx_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks vmxNetworkDevicesClaim](https://developer.cisco.com/meraki/api-v1/#!vmx-network-devices-claim)
> :   Complete reference of the vmxNetworkDevicesClaim API.

## [Examples](networks_devices_claim_vmx_module.md#id6)
...
## [Return Values](networks_devices_claim_vmx_module.md#id7)
