...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_device_type_group_policies module – Resource module for networks _wireless _ssids _devicetypegrouppolicies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_device_type_group_policies_module.html
fetched_at: 2026-07-28T01:35:51+00:00
---
# cisco.meraki.networks_wireless_ssids_device_type_group_policies module – Resource module for networks _wireless _ssids _devicetypegrouppolicies
...
> see [Requirements](networks_wireless_ssids_device_type_group_policies_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-device-type-group-policies-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_device_type_group_policies`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_device_type_group_policies_module.md#synopsis)
- [Requirements](networks_wireless_ssids_device_type_group_policies_module.md#requirements)
- [Parameters](networks_wireless_ssids_device_type_group_policies_module.md#parameters)
- [Notes](networks_wireless_ssids_device_type_group_policies_module.md#notes)
- [See Also](networks_wireless_ssids_device_type_group_policies_module.md#see-also)
- [Examples](networks_wireless_ssids_device_type_group_policies_module.md#examples)
- [Return Values](networks_wireless_ssids_device_type_group_policies_module.md#return-values)

## [Synopsis](networks_wireless_ssids_device_type_group_policies_module.md#id1)
...
## [Requirements](networks_wireless_ssids_device_type_group_policies_module.md#id2)
...
## [Parameters](networks_wireless_ssids_device_type_group_policies_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **deviceTypePolicies**  list / elements=dictionary | List of device type policies. |
...
| **groupPolicyId**  integer | ID of the group policy object. |
| **enabled**  boolean | If true, the SSID device type group policies are enabled.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_wireless_ssids_device_type_group_policies_module.md#id4)
...
## [See Also](networks_wireless_ssids_device_type_group_policies_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidDeviceTypeGroupPolicies](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-device-type-group-policies)
> :   Complete reference of the updateNetworkWirelessSsidDeviceTypeGroupPolicies API.

## [Examples](networks_wireless_ssids_device_type_group_policies_module.md#id6)
...
## [Return Values](networks_wireless_ssids_device_type_group_policies_module.md#id7)
