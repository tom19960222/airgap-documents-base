...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_wireless_devices_ethernet_statuses_info module – Information module for organizations _wireless _devices _ethernet _statuses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_wireless_devices_ethernet_statuses_info_module.html
fetched_at: 2026-07-28T01:37:32+00:00
---
# cisco.meraki.organizations_wireless_devices_ethernet_statuses_info module – Information module for organizations _wireless _devices _ethernet _statuses
...
> see [Requirements](organizations_wireless_devices_ethernet_statuses_info_module.md#ansible-collections-cisco-meraki-organizations-wireless-devices-ethernet-statuses-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_wireless_devices_ethernet_statuses_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_wireless_devices_ethernet_statuses_info_module.md#synopsis)
- [Requirements](organizations_wireless_devices_ethernet_statuses_info_module.md#requirements)
- [Parameters](organizations_wireless_devices_ethernet_statuses_info_module.md#parameters)
- [Notes](organizations_wireless_devices_ethernet_statuses_info_module.md#notes)
- [See Also](organizations_wireless_devices_ethernet_statuses_info_module.md#see-also)
- [Examples](organizations_wireless_devices_ethernet_statuses_info_module.md#examples)
- [Return Values](organizations_wireless_devices_ethernet_statuses_info_module.md#return-values)

## [Synopsis](organizations_wireless_devices_ethernet_statuses_info_module.md#id1)
...
## [Requirements](organizations_wireless_devices_ethernet_statuses_info_module.md#id2)
...
## [Parameters](organizations_wireless_devices_ethernet_statuses_info_module.md#id3)
...
| **networkIds**  list / elements=string | NetworkIds query parameter. A list of Meraki network IDs to filter results to contain only specified networks. E.g. NetworkIds=N_12345678&networkIds=L_3456. |
| **organizationId**  string | OrganizationId path parameter. Organization ID. |
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 3 - 1000. Default is 100. |
...
## [Notes](organizations_wireless_devices_ethernet_statuses_info_module.md#id4)
...
## [See Also](organizations_wireless_devices_ethernet_statuses_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getOrganizationWirelessDevicesEthernetStatuses](https://developer.cisco.com/meraki/api-v1/#!get-organization-wireless-devices-ethernet-statuses)
> :   Complete reference of the getOrganizationWirelessDevicesEthernetStatuses API.

## [Examples](organizations_wireless_devices_ethernet_statuses_info_module.md#id6)
...
## [Return Values](organizations_wireless_devices_ethernet_statuses_info_module.md#id7)
