...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_config_templates_switch_profiles_info module – Information module for organizations _configtemplates _switch _profiles"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_config_templates_switch_profiles_info_module.html
fetched_at: 2026-07-28T01:36:38+00:00
---
# cisco.meraki.organizations_config_templates_switch_profiles_info module – Information module for organizations _configtemplates _switch _profiles
...
> see [Requirements](organizations_config_templates_switch_profiles_info_module.md#ansible-collections-cisco-meraki-organizations-config-templates-switch-profiles-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_config_templates_switch_profiles_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_config_templates_switch_profiles_info_module.md#synopsis)
- [Requirements](organizations_config_templates_switch_profiles_info_module.md#requirements)
- [Parameters](organizations_config_templates_switch_profiles_info_module.md#parameters)
- [Notes](organizations_config_templates_switch_profiles_info_module.md#notes)
- [See Also](organizations_config_templates_switch_profiles_info_module.md#see-also)
- [Examples](organizations_config_templates_switch_profiles_info_module.md#examples)
- [Return Values](organizations_config_templates_switch_profiles_info_module.md#return-values)

## [Synopsis](organizations_config_templates_switch_profiles_info_module.md#id1)
...
## [Requirements](organizations_config_templates_switch_profiles_info_module.md#id2)
...
## [Parameters](organizations_config_templates_switch_profiles_info_module.md#id3)
...
## [Notes](organizations_config_templates_switch_profiles_info_module.md#id4)
...
## [See Also](organizations_config_templates_switch_profiles_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getOrganizationConfigTemplateSwitchProfiles](https://developer.cisco.com/meraki/api-v1/#!get-organization-config-template-switch-profiles)
> :   Complete reference of the getOrganizationConfigTemplateSwitchProfiles API.

## [Examples](organizations_config_templates_switch_profiles_info_module.md#id6)
...
## [Return Values](organizations_config_templates_switch_profiles_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"model": "string", "name": "string", "switchProfileId": "string"}` |
