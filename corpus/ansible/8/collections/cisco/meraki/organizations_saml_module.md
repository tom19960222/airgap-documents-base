...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_saml module – Resource module for organizations _saml"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_saml_module.html
fetched_at: 2026-07-28T01:37:13+00:00
---
# cisco.meraki.organizations_saml module – Resource module for organizations _saml
...
> see [Requirements](organizations_saml_module.md#ansible-collections-cisco-meraki-organizations-saml-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_saml`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_saml_module.md#synopsis)
- [Requirements](organizations_saml_module.md#requirements)
- [Parameters](organizations_saml_module.md#parameters)
- [Notes](organizations_saml_module.md#notes)
- [See Also](organizations_saml_module.md#see-also)
- [Examples](organizations_saml_module.md#examples)
- [Return Values](organizations_saml_module.md#return-values)

## [Synopsis](organizations_saml_module.md#id1)
...
## [Requirements](organizations_saml_module.md#id2)
...
## [Parameters](organizations_saml_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | Boolean for updating SAML SSO enabled settings.  **Choices:**   - `false` - `true` |
...
## [Notes](organizations_saml_module.md#id4)
...
## [See Also](organizations_saml_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations updateOrganizationSaml](https://developer.cisco.com/meraki/api-v1/#!update-organization-saml)
> :   Complete reference of the updateOrganizationSaml API.

## [Examples](organizations_saml_module.md#id6)
...
## [Return Values](organizations_saml_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `"true\n"` |
