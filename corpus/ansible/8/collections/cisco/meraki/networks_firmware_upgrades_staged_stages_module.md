...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_stages module – Resource module for networks _firmwareupgrades _staged _stages"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_stages_module.html
fetched_at: 2026-07-28T01:34:03+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_stages module – Resource module for networks _firmwareupgrades _staged _stages
...
> see [Requirements](networks_firmware_upgrades_staged_stages_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-stages-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_stages`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_stages_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_stages_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_stages_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_stages_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_stages_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_stages_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_stages_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_stages_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_stages_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_stages_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **_json**  list / elements=dictionary | Array of Staged Upgrade Groups. |
| **group**  dictionary | The Staged Upgrade Group. |
...
## [Notes](networks_firmware_upgrades_staged_stages_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.update_network_firmware_upgrades_staged_stages,
> - Paths used are put /networks/{networkId}/firmwareUpgrades/staged/stages,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_firmware_upgrades_staged_stages_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkFirmwareUpgradesStagedStages](https://developer.cisco.com/meraki/api-v1/#!update-network-firmware-upgrades-staged-stages)
> :   Complete reference of the updateNetworkFirmwareUpgradesStagedStages API.

## [Examples](networks_firmware_upgrades_staged_stages_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_stages_module.md#id7)
