...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_users_info module – Information module for networks _sm _users"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_users_info_module.html
fetched_at: 2026-07-28T01:34:45+00:00
---
# cisco.meraki.networks_sm_users_info module – Information module for networks _sm _users
...
> see [Requirements](networks_sm_users_info_module.md#ansible-collections-cisco-meraki-networks-sm-users-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_users_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_users_info_module.md#synopsis)
- [Requirements](networks_sm_users_info_module.md#requirements)
- [Parameters](networks_sm_users_info_module.md#parameters)
- [Notes](networks_sm_users_info_module.md#notes)
- [See Also](networks_sm_users_info_module.md#see-also)
- [Examples](networks_sm_users_info_module.md#examples)
- [Return Values](networks_sm_users_info_module.md#return-values)

## [Synopsis](networks_sm_users_info_module.md#id1)
...
## [Requirements](networks_sm_users_info_module.md#id2)
...
## [Parameters](networks_sm_users_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **emails**  list / elements=string | Emails query parameter. Filter users by email(s). |
| **headers**  dictionary | Additional headers. |
| **ids**  list / elements=string | Ids query parameter. Filter users by id(s). |
...
| **scope**  list / elements=string | Scope query parameter. Specifiy a scope (one of all, none, withAny, withAll, withoutAny, withoutAll) and a set of tags. |
| **usernames**  list / elements=string | Usernames query parameter. Filter users by username(s). |

## [Notes](networks_sm_users_info_module.md#id4)
...
## [See Also](networks_sm_users_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmUsers](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-users)
> :   Complete reference of the getNetworkSmUsers API.

## [Examples](networks_sm_users_info_module.md#id6)
...
## [Return Values](networks_sm_users_info_module.md#id7)
