...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_clone module – Resource module for organizations _clone"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_clone_module.html
fetched_at: 2026-07-28T01:36:36+00:00
---
# cisco.meraki.organizations_clone module – Resource module for organizations _clone
...
> see [Requirements](organizations_clone_module.md#ansible-collections-cisco-meraki-organizations-clone-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_clone`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_clone_module.md#synopsis)
- [Requirements](organizations_clone_module.md#requirements)
- [Parameters](organizations_clone_module.md#parameters)
- [Notes](organizations_clone_module.md#notes)
- [See Also](organizations_clone_module.md#see-also)
- [Examples](organizations_clone_module.md#examples)
- [Return Values](organizations_clone_module.md#return-values)

## [Synopsis](organizations_clone_module.md#id1)
...
## [Requirements](organizations_clone_module.md#id2)
...
## [Parameters](organizations_clone_module.md#id3)
...
## [Notes](organizations_clone_module.md#id4)
...
## [See Also](organizations_clone_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations cloneOrganization](https://developer.cisco.com/meraki/api-v1/#!clone-organization)
> :   Complete reference of the cloneOrganization API.

## [Examples](organizations_clone_module.md#id6)
...
## [Return Values](organizations_clone_module.md#id7)
