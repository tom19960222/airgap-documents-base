...
collection: ansible
version: "8"
title: "cisco.meraki.networks_info module – Information module for networks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_info_module.html
fetched_at: 2026-07-28T01:34:08+00:00
---
# cisco.meraki.networks_info module – Information module for networks
...
> see [Requirements](networks_info_module.md#ansible-collections-cisco-meraki-networks-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_info`.
...
- [See Also](networks_info_module.md#see-also)
...
| Parameter | Comments |
| --- | --- |
| **configTemplateId**  string | ConfigTemplateId query parameter. An optional parameter that is the ID of a config template. Will return all networks bound to that template. |
...
| **isBoundToConfigTemplate**  boolean | IsBoundToConfigTemplate query parameter. An optional parameter to filter config template bound networks. If configTemplateId is set, this cannot be false.  **Choices:**   - `false` - `true` |
...
| **tags**  list / elements=string | Tags query parameter. An optional parameter to filter networks by tags. The filtering is case-sensitive. If tags are included, ‘tagsFilterType’ should also be included (see below). |
| **tagsFilterType**  string | TagsFilterType query parameter. An optional parameter of value ‘withAnyTags’ or ‘withAllTags’ to indicate whether to return networks which contain ANY or ALL of the included tags. If no type is included, ‘withAnyTags’ will be selected. |
...
> **Note:**
>
> - SDK Method used are organizationsnetworks.Organizationsnetworks.get_network, organizationsnetworks.Organizationsnetworks.get_organization_networks,
...
## [See Also](networks_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations,networks getNetwork](https://developer.cisco.com/meraki/api-v1/#!get-network)
> :   Complete reference of the getNetwork API.
>
> [Cisco Meraki documentation for organizations,networks getOrganizationNetworks](https://developer.cisco.com/meraki/api-v1/#!get-organization-networks)
> :   Complete reference of the getOrganizationNetworks API.

## [Examples](networks_info_module.md#id6)
...
## [Return Values](networks_info_module.md#id7)
