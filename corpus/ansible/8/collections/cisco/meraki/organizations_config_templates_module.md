...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_config_templates module – Resource module for organizations _configtemplates"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_config_templates_module.html
fetched_at: 2026-07-28T01:36:36+00:00
---
# cisco.meraki.organizations_config_templates module – Resource module for organizations _configtemplates
...
> see [Requirements](organizations_config_templates_module.md#ansible-collections-cisco-meraki-organizations-config-templates-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_config_templates`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_config_templates_module.md#synopsis)
- [Requirements](organizations_config_templates_module.md#requirements)
- [Parameters](organizations_config_templates_module.md#parameters)
- [Notes](organizations_config_templates_module.md#notes)
- [See Also](organizations_config_templates_module.md#see-also)
- [Examples](organizations_config_templates_module.md#examples)
- [Return Values](organizations_config_templates_module.md#return-values)

## [Synopsis](organizations_config_templates_module.md#id1)
...
## [Requirements](organizations_config_templates_module.md#id2)
...
## [Parameters](organizations_config_templates_module.md#id3)
...
## [Notes](organizations_config_templates_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization_config_template, organizations.Organizations.delete_organization_config_template, organizations.Organizations.update_organization_config_template,
> - Paths used are post /organizations/{organizationId}/configTemplates, delete /organizations/{organizationId}/configTemplates/{configTemplateId}, put /organizations/{organizationId}/configTemplates/{configTemplateId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_config_templates_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationConfigTemplate](https://developer.cisco.com/meraki/api-v1/#!create-organization-config-template)
> :   Complete reference of the createOrganizationConfigTemplate API.
>
> [Cisco Meraki documentation for organizations deleteOrganizationConfigTemplate](https://developer.cisco.com/meraki/api-v1/#!delete-organization-config-template)
> :   Complete reference of the deleteOrganizationConfigTemplate API.
>
> [Cisco Meraki documentation for organizations updateOrganizationConfigTemplate](https://developer.cisco.com/meraki/api-v1/#!update-organization-config-template)
> :   Complete reference of the updateOrganizationConfigTemplate API.

## [Examples](organizations_config_templates_module.md#id6)
...
## [Return Values](organizations_config_templates_module.md#id7)
