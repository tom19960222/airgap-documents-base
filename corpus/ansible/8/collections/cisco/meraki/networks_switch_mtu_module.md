...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_mtu module – Resource module for networks _switch _mtu"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_mtu_module.html
fetched_at: 2026-07-28T01:35:00+00:00
---
# cisco.meraki.networks_switch_mtu module – Resource module for networks _switch _mtu
...
> see [Requirements](networks_switch_mtu_module.md#ansible-collections-cisco-meraki-networks-switch-mtu-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_mtu`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_mtu_module.md#synopsis)
- [Requirements](networks_switch_mtu_module.md#requirements)
- [Parameters](networks_switch_mtu_module.md#parameters)
- [Notes](networks_switch_mtu_module.md#notes)
- [See Also](networks_switch_mtu_module.md#see-also)
- [Examples](networks_switch_mtu_module.md#examples)
- [Return Values](networks_switch_mtu_module.md#return-values)

## [Synopsis](networks_switch_mtu_module.md#id1)
...
## [Requirements](networks_switch_mtu_module.md#id2)
...
## [Parameters](networks_switch_mtu_module.md#id3)
...
| **overrides**  list / elements=dictionary | Override MTU size for individual switches or switch profiles. An empty array will clear overrides. |
| **mtuSize**  integer | MTU size for the switches or switch profiles. |
| **switches**  list / elements=string | List of switch serials. Applicable only for switch network. |
| **switchProfiles**  list / elements=string | List of switch profile IDs. Applicable only for template network. |

## [Notes](networks_switch_mtu_module.md#id4)
...
## [See Also](networks_switch_mtu_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchMtu](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-mtu)
> :   Complete reference of the updateNetworkSwitchMtu API.

## [Examples](networks_switch_mtu_module.md#id6)
...
## [Return Values](networks_switch_mtu_module.md#id7)
