...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_action_batches_info module – Information module for organizations _actionbatches"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_action_batches_info_module.html
fetched_at: 2026-07-28T01:36:09+00:00
---
# cisco.meraki.organizations_action_batches_info module – Information module for organizations _actionbatches
...
> see [Requirements](organizations_action_batches_info_module.md#ansible-collections-cisco-meraki-organizations-action-batches-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_action_batches_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_action_batches_info_module.md#synopsis)
- [Requirements](organizations_action_batches_info_module.md#requirements)
- [Parameters](organizations_action_batches_info_module.md#parameters)
- [Notes](organizations_action_batches_info_module.md#notes)
- [See Also](organizations_action_batches_info_module.md#see-also)
- [Examples](organizations_action_batches_info_module.md#examples)
- [Return Values](organizations_action_batches_info_module.md#return-values)

## [Synopsis](organizations_action_batches_info_module.md#id1)
...
## [Requirements](organizations_action_batches_info_module.md#id2)
...
## [Parameters](organizations_action_batches_info_module.md#id3)
...
## [Notes](organizations_action_batches_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_action_batch, organizations.Organizations.get_organization_action_batches,
...
## [See Also](organizations_action_batches_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationActionBatch](https://developer.cisco.com/meraki/api-v1/#!get-organization-action-batch)
> :   Complete reference of the getOrganizationActionBatch API.
>
> [Cisco Meraki documentation for organizations getOrganizationActionBatches](https://developer.cisco.com/meraki/api-v1/#!get-organization-action-batches)
> :   Complete reference of the getOrganizationActionBatches API.

## [Examples](organizations_action_batches_info_module.md#id6)
...
## [Return Values](organizations_action_batches_info_module.md#id7)
