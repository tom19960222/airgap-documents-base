...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_lock module – Resource module for networks _sm _devices _lock"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_lock_module.html
fetched_at: 2026-07-28T01:34:33+00:00
---
# cisco.meraki.networks_sm_devices_lock module – Resource module for networks _sm _devices _lock
...
> see [Requirements](networks_sm_devices_lock_module.md#ansible-collections-cisco-meraki-networks-sm-devices-lock-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_lock`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_lock_module.md#synopsis)
- [Requirements](networks_sm_devices_lock_module.md#requirements)
- [Parameters](networks_sm_devices_lock_module.md#parameters)
- [Notes](networks_sm_devices_lock_module.md#notes)
- [See Also](networks_sm_devices_lock_module.md#see-also)
- [Examples](networks_sm_devices_lock_module.md#examples)
- [Return Values](networks_sm_devices_lock_module.md#return-values)

## [Synopsis](networks_sm_devices_lock_module.md#id1)
...
## [Requirements](networks_sm_devices_lock_module.md#id2)
...
## [Parameters](networks_sm_devices_lock_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **ids**  list / elements=string | The ids of the devices to be locked. |
...
| **scope**  list / elements=string | The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be wiped. |
| **serials**  list / elements=string | The serials of the devices to be locked. |
| **wifiMacs**  list / elements=string | The wifiMacs of the devices to be locked. |

## [Notes](networks_sm_devices_lock_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.lock_network_sm_devices,
> - Paths used are post /networks/{networkId}/sm/devices/lock,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_sm_devices_lock_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm lockNetworkSmDevices](https://developer.cisco.com/meraki/api-v1/#!lock-network-sm-devices)
> :   Complete reference of the lockNetworkSmDevices API.

## [Examples](networks_sm_devices_lock_module.md#id6)
...
## [Return Values](networks_sm_devices_lock_module.md#id7)
