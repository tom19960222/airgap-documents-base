...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_generate_snapshot module – Resource module for devices _camera _generatesnapshot"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_generate_snapshot_module.html
fetched_at: 2026-07-28T01:31:46+00:00
---
# cisco.meraki.devices_camera_generate_snapshot module – Resource module for devices _camera _generatesnapshot
...
> see [Requirements](devices_camera_generate_snapshot_module.md#ansible-collections-cisco-meraki-devices-camera-generate-snapshot-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_generate_snapshot`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_generate_snapshot_module.md#synopsis)
- [Requirements](devices_camera_generate_snapshot_module.md#requirements)
- [Parameters](devices_camera_generate_snapshot_module.md#parameters)
- [Notes](devices_camera_generate_snapshot_module.md#notes)
- [See Also](devices_camera_generate_snapshot_module.md#see-also)
- [Examples](devices_camera_generate_snapshot_module.md#examples)
- [Return Values](devices_camera_generate_snapshot_module.md#return-values)

## [Synopsis](devices_camera_generate_snapshot_module.md#id1)
...
## [Requirements](devices_camera_generate_snapshot_module.md#id2)
...
## [Parameters](devices_camera_generate_snapshot_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **fullframe**  boolean | Optional If set to “true” the snapshot will be taken at full sensor resolution. This will error if used with timestamp.  **Choices:**   - `false` - `true` |
...
## [Notes](devices_camera_generate_snapshot_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.generate_device_camera_snapshot,
> - Paths used are post /devices/{serial}/camera/generateSnapshot,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_camera_generate_snapshot_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices generateDeviceCameraSnapshot](https://developer.cisco.com/meraki/api-v1/#!generate-device-camera-snapshot)
> :   Complete reference of the generateDeviceCameraSnapshot API.

## [Examples](devices_camera_generate_snapshot_module.md#id6)
...
## [Return Values](devices_camera_generate_snapshot_module.md#id7)
