...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licenses_assign_seats module – Resource module for organizations _licenses _assignseats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licenses_assign_seats_module.html
fetched_at: 2026-07-28T01:37:01+00:00
---
# cisco.meraki.organizations_licenses_assign_seats module – Resource module for organizations _licenses _assignseats
...
> see [Requirements](organizations_licenses_assign_seats_module.md#ansible-collections-cisco-meraki-organizations-licenses-assign-seats-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licenses_assign_seats`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licenses_assign_seats_module.md#synopsis)
- [Requirements](organizations_licenses_assign_seats_module.md#requirements)
- [Parameters](organizations_licenses_assign_seats_module.md#parameters)
- [Notes](organizations_licenses_assign_seats_module.md#notes)
- [See Also](organizations_licenses_assign_seats_module.md#see-also)
- [Examples](organizations_licenses_assign_seats_module.md#examples)
- [Return Values](organizations_licenses_assign_seats_module.md#return-values)

## [Synopsis](organizations_licenses_assign_seats_module.md#id1)
...
## [Requirements](organizations_licenses_assign_seats_module.md#id2)
...
## [Parameters](organizations_licenses_assign_seats_module.md#id3)
...
## [Notes](organizations_licenses_assign_seats_module.md#id4)
...
## [See Also](organizations_licenses_assign_seats_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations assignOrganizationLicensesSeats](https://developer.cisco.com/meraki/api-v1/#!assign-organization-licenses-seats)
> :   Complete reference of the assignOrganizationLicensesSeats API.

## [Examples](organizations_licenses_assign_seats_module.md#id6)
...
## [Return Values](organizations_licenses_assign_seats_module.md#id7)
