...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_static_routes_info module – Information module for networks _appliance _static _routes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_static_routes_info_module.html
fetched_at: 2026-07-28T01:33:21+00:00
---
# cisco.meraki.networks_appliance_static_routes_info module – Information module for networks _appliance _static _routes
...
> see [Requirements](networks_appliance_static_routes_info_module.md#ansible-collections-cisco-meraki-networks-appliance-static-routes-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_static_routes_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_static_routes_info_module.md#synopsis)
- [Requirements](networks_appliance_static_routes_info_module.md#requirements)
- [Parameters](networks_appliance_static_routes_info_module.md#parameters)
- [Notes](networks_appliance_static_routes_info_module.md#notes)
- [See Also](networks_appliance_static_routes_info_module.md#see-also)
- [Examples](networks_appliance_static_routes_info_module.md#examples)
- [Return Values](networks_appliance_static_routes_info_module.md#return-values)

## [Synopsis](networks_appliance_static_routes_info_module.md#id1)
...
## [Requirements](networks_appliance_static_routes_info_module.md#id2)
...
## [Parameters](networks_appliance_static_routes_info_module.md#id3)
...
## [Notes](networks_appliance_static_routes_info_module.md#id4)

> **Note:**
>
> - SDK Method used are appliance.Appliance.get_network_appliance_static_route, appliance.Appliance.get_network_appliance_static_routes,
> - Paths used are get /networks/{networkId}/appliance/staticRoutes, get /networks/{networkId}/appliance/staticRoutes/{staticRouteId},
> - Supports `check_mode`
...
## [See Also](networks_appliance_static_routes_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance getNetworkApplianceStaticRoute](https://developer.cisco.com/meraki/api-v1/#!get-network-appliance-static-route)
> :   Complete reference of the getNetworkApplianceStaticRoute API.
>
> [Cisco Meraki documentation for appliance getNetworkApplianceStaticRoutes](https://developer.cisco.com/meraki/api-v1/#!get-network-appliance-static-routes)
> :   Complete reference of the getNetworkApplianceStaticRoutes API.

## [Examples](networks_appliance_static_routes_info_module.md#id6)
...
## [Return Values](networks_appliance_static_routes_info_module.md#id7)
