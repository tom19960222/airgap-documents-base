...
collection: ansible
version: "8"
title: "cisco.meraki.devices_wireless_connection_stats_info module – Information module for devices _wireless _connectionstats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_wireless_connection_stats_info_module.html
fetched_at: 2026-07-28T01:32:15+00:00
---
# cisco.meraki.devices_wireless_connection_stats_info module – Information module for devices _wireless _connectionstats
...
> see [Requirements](devices_wireless_connection_stats_info_module.md#ansible-collections-cisco-meraki-devices-wireless-connection-stats-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_wireless_connection_stats_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_wireless_connection_stats_info_module.md#synopsis)
- [Requirements](devices_wireless_connection_stats_info_module.md#requirements)
- [Parameters](devices_wireless_connection_stats_info_module.md#parameters)
- [Notes](devices_wireless_connection_stats_info_module.md#notes)
- [See Also](devices_wireless_connection_stats_info_module.md#see-also)
- [Examples](devices_wireless_connection_stats_info_module.md#examples)
- [Return Values](devices_wireless_connection_stats_info_module.md#return-values)

## [Synopsis](devices_wireless_connection_stats_info_module.md#id1)
...
## [Requirements](devices_wireless_connection_stats_info_module.md#id2)
...
## [Parameters](devices_wireless_connection_stats_info_module.md#id3)
...
## [Notes](devices_wireless_connection_stats_info_module.md#id4)
...
## [See Also](devices_wireless_connection_stats_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getDeviceWirelessConnectionStats](https://developer.cisco.com/meraki/api-v1/#!get-device-wireless-connection-stats)
> :   Complete reference of the getDeviceWirelessConnectionStats API.

## [Examples](devices_wireless_connection_stats_info_module.md#id6)
...
## [Return Values](devices_wireless_connection_stats_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"connectionStats": {"assoc": 0, "auth": 0, "dhcp": 0, "dns": 0, "success": 0}, "serial": "string"}` |
