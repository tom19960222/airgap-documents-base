...
collection: ansible
version: "8"
title: "cisco.meraki.networks_cellular_gateway_connectivity_monitoring_destinations module – Resource module for networks _cellulargateway _connectivitymonitoringdestinations"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_cellular_gateway_connectivity_monitoring_destinations_module.html
fetched_at: 2026-07-28T01:33:41+00:00
---
# cisco.meraki.networks_cellular_gateway_connectivity_monitoring_destinations module – Resource module for networks _cellulargateway _connectivitymonitoringdestinations
...
> see [Requirements](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#ansible-collections-cisco-meraki-networks-cellular-gateway-connectivity-monitoring-destinations-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_cellular_gateway_connectivity_monitoring_destinations`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#synopsis)
- [Requirements](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#requirements)
- [Parameters](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#parameters)
- [Notes](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#notes)
- [See Also](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#see-also)
- [Examples](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#examples)
- [Return Values](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#return-values)

## [Synopsis](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id1)
...
## [Requirements](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id2)
...
## [Parameters](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **destinations**  list / elements=dictionary | The list of connectivity monitoring destinations. |
| **default**  boolean | Boolean indicating whether this is the default testing destination (true) or not (false). Defaults to false. Only one default is allowed.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id4)

> **Note:**
>
> - SDK Method used are cellular_gateway.CellularGateway.update_network_cellular_gateway_connectivity_monitoring_destinations,
...
## [See Also](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway updateNetworkCellularGatewayConnectivityMonitoringDestinations](https://developer.cisco.com/meraki/api-v1/#!update-network-cellular-gateway-connectivity-monitoring-destinations)
> :   Complete reference of the updateNetworkCellularGatewayConnectivityMonitoringDestinations API.

## [Examples](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id6)
...
## [Return Values](networks_cellular_gateway_connectivity_monitoring_destinations_module.md#id7)
