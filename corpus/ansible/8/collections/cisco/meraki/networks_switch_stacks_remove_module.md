...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stacks_remove module – Resource module for networks _switch _stacks _remove"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stacks_remove_module.html
fetched_at: 2026-07-28T01:35:13+00:00
---
# cisco.meraki.networks_switch_stacks_remove module – Resource module for networks _switch _stacks _remove
...
> see [Requirements](networks_switch_stacks_remove_module.md#ansible-collections-cisco-meraki-networks-switch-stacks-remove-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stacks_remove`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stacks_remove_module.md#synopsis)
- [Requirements](networks_switch_stacks_remove_module.md#requirements)
- [Parameters](networks_switch_stacks_remove_module.md#parameters)
- [Notes](networks_switch_stacks_remove_module.md#notes)
- [See Also](networks_switch_stacks_remove_module.md#see-also)
- [Examples](networks_switch_stacks_remove_module.md#examples)
- [Return Values](networks_switch_stacks_remove_module.md#return-values)

## [Synopsis](networks_switch_stacks_remove_module.md#id1)
...
## [Requirements](networks_switch_stacks_remove_module.md#id2)
...
## [Parameters](networks_switch_stacks_remove_module.md#id3)
...
## [Notes](networks_switch_stacks_remove_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.remove_network_switch_stack,
> - Paths used are post /networks/{networkId}/switch/stacks/{switchStackId}/remove,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_stacks_remove_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch removeNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/#!remove-network-switch-stack)
> :   Complete reference of the removeNetworkSwitchStack API.

## [Examples](networks_switch_stacks_remove_module.md#id6)
...
## [Return Values](networks_switch_stacks_remove_module.md#id7)
