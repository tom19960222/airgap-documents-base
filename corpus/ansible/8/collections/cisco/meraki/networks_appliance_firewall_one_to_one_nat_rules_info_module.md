...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules_info module – Information module for networks _appliance _firewall _onetoonenatrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_firewall_one_to_one_nat_rules_info_module.html
fetched_at: 2026-07-28T01:33:06+00:00
---
# cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules_info module – Information module for networks _appliance _firewall _onetoonenatrules
...
> see [Requirements](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#ansible-collections-cisco-meraki-networks-appliance-firewall-one-to-one-nat-rules-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#synopsis)
- [Requirements](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#requirements)
- [Parameters](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#parameters)
- [Notes](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#notes)
- [See Also](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#see-also)
- [Examples](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#examples)
- [Return Values](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#return-values)

## [Synopsis](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id1)
...
## [Requirements](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id2)
...
## [Parameters](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id3)
...
## [Notes](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id4)

> **Note:**
>
> - SDK Method used are appliance.Appliance.get_network_appliance_firewall_one_to_one_nat_rules,
> - Paths used are get /networks/{networkId}/appliance/firewall/oneToOneNatRules,
> - Supports `check_mode`
...
## [See Also](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance getNetworkApplianceFirewallOneToOneNatRules](https://developer.cisco.com/meraki/api-v1/#!get-network-appliance-firewall-one-to-one-nat-rules)
> :   Complete reference of the getNetworkApplianceFirewallOneToOneNatRules API.

## [Examples](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id6)
...
## [Return Values](networks_appliance_firewall_one_to_one_nat_rules_info_module.md#id7)
