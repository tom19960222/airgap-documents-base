...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_ms_link_aggregation_module.html
fetched_at: 2026-07-28T01:32:30+00:00
---
...
- [DEPRECATED](meraki_ms_link_aggregation_module.md#deprecated)
...
- [Status](meraki_ms_link_aggregation_module.md#status)

## [DEPRECATED](meraki_ms_link_aggregation_module.md#id1)
...
## [Synopsis](meraki_ms_link_aggregation_module.md#id2)

- Allows for management of MS switch link aggregations in a Meraki environment.

## [Parameters](meraki_ms_link_aggregation_module.md#id3)
...
## [Notes](meraki_ms_link_aggregation_module.md#id4)
...
## [Examples](meraki_ms_link_aggregation_module.md#id5)
...
## [Return Values](meraki_ms_link_aggregation_module.md#id6)
...
## [Status](meraki_ms_link_aggregation_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_ms_link_aggregation_module.md#deprecated).
