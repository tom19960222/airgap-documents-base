...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_firmware_upgrades_by_device_info module – Information module for organizations _firmware _upgrades _bydevice"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_firmware_upgrades_by_device_info_module.html
fetched_at: 2026-07-28T01:36:49+00:00
---
# cisco.meraki.organizations_firmware_upgrades_by_device_info module – Information module for organizations _firmware _upgrades _bydevice
...
> see [Requirements](organizations_firmware_upgrades_by_device_info_module.md#ansible-collections-cisco-meraki-organizations-firmware-upgrades-by-device-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_firmware_upgrades_by_device_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_firmware_upgrades_by_device_info_module.md#synopsis)
- [Requirements](organizations_firmware_upgrades_by_device_info_module.md#requirements)
- [Parameters](organizations_firmware_upgrades_by_device_info_module.md#parameters)
- [Notes](organizations_firmware_upgrades_by_device_info_module.md#notes)
- [See Also](organizations_firmware_upgrades_by_device_info_module.md#see-also)
- [Examples](organizations_firmware_upgrades_by_device_info_module.md#examples)
- [Return Values](organizations_firmware_upgrades_by_device_info_module.md#return-values)

## [Synopsis](organizations_firmware_upgrades_by_device_info_module.md#id1)
...
## [Requirements](organizations_firmware_upgrades_by_device_info_module.md#id2)
...
## [Parameters](organizations_firmware_upgrades_by_device_info_module.md#id3)
...
| **firmwareUpgradeBatchIds**  list / elements=string | FirmwareUpgradeBatchIds query parameter. Optional parameter to filter by firmware upgrade batch ids. |
| **firmwareUpgradeIds**  list / elements=string | FirmwareUpgradeIds query parameter. Optional parameter to filter by firmware upgrade ids. |
| **headers**  dictionary | Additional headers. |
| **macs**  list / elements=string | Macs query parameter. Optional parameter to filter by one or more MAC addresses belonging to devices. All devices returned belong to MAC addresses that are an exact match. |
...
| **networkIds**  list / elements=string | NetworkIds query parameter. Optional parameter to filter by network. |
...
| **serials**  list / elements=string | Serials query parameter. Optional parameter to filter by serial number. All returned devices will have a serial number that is an exact match. |
...
## [Notes](organizations_firmware_upgrades_by_device_info_module.md#id4)
...
## [See Also](organizations_firmware_upgrades_by_device_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationFirmwareUpgradesByDevice](https://developer.cisco.com/meraki/api-v1/#!get-organization-firmware-upgrades-by-device)
> :   Complete reference of the getOrganizationFirmwareUpgradesByDevice API.

## [Examples](organizations_firmware_upgrades_by_device_info_module.md#id6)
...
## [Return Values](organizations_firmware_upgrades_by_device_info_module.md#id7)
