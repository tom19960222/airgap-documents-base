...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_licenses_info module – Information module for organizations _licenses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_licenses_info_module.html
fetched_at: 2026-07-28T01:37:02+00:00
---
# cisco.meraki.organizations_licenses_info module – Information module for organizations _licenses
...
> see [Requirements](organizations_licenses_info_module.md#ansible-collections-cisco-meraki-organizations-licenses-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_licenses_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_licenses_info_module.md#synopsis)
- [Requirements](organizations_licenses_info_module.md#requirements)
- [Parameters](organizations_licenses_info_module.md#parameters)
- [Notes](organizations_licenses_info_module.md#notes)
- [See Also](organizations_licenses_info_module.md#see-also)
- [Examples](organizations_licenses_info_module.md#examples)
- [Return Values](organizations_licenses_info_module.md#return-values)

## [Synopsis](organizations_licenses_info_module.md#id1)
...
## [Requirements](organizations_licenses_info_module.md#id2)
...
## [Parameters](organizations_licenses_info_module.md#id3)
...
## [Notes](organizations_licenses_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_license,
> - Paths used are get /organizations/{organizationId}/licenses/{licenseId},
> - Supports `check_mode`
...
## [See Also](organizations_licenses_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationLicense](https://developer.cisco.com/meraki/api-v1/#!get-organization-license)
> :   Complete reference of the getOrganizationLicense API.

## [Examples](organizations_licenses_info_module.md#id6)
...
## [Return Values](organizations_licenses_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"activationDate": "string", "claimDate": "string", "deviceSerial": "string", "durationInDays": 0, "expirationDate": "string", "headLicenseId": "string", "id": "string", "licenseKey": "string", "licenseType": "string", "networkId": "string", "orderNumber": "string", "permanentlyQueuedLicenses": [{"durationInDays": 0, "id": "string", "licenseKey": "string", "licenseType": "string", "orderNumber": "string"}], "seatCount": 0, "state": "string", "totalDurationInDays": 0}` |
