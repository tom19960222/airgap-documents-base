...
collection: ansible
version: "8"
title: "cisco.meraki.networks_devices_claim module – Resource module for networks _devices _claim"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_devices_claim_module.html
fetched_at: 2026-07-28T01:33:52+00:00
---
# cisco.meraki.networks_devices_claim module – Resource module for networks _devices _claim
...
> see [Requirements](networks_devices_claim_module.md#ansible-collections-cisco-meraki-networks-devices-claim-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_devices_claim`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_devices_claim_module.md#synopsis)
- [Requirements](networks_devices_claim_module.md#requirements)
- [Parameters](networks_devices_claim_module.md#parameters)
- [Notes](networks_devices_claim_module.md#notes)
- [See Also](networks_devices_claim_module.md#see-also)
- [Examples](networks_devices_claim_module.md#examples)
- [Return Values](networks_devices_claim_module.md#return-values)

## [Synopsis](networks_devices_claim_module.md#id1)
...
## [Requirements](networks_devices_claim_module.md#id2)
...
## [Parameters](networks_devices_claim_module.md#id3)
...
| **serials**  list / elements=string | A list of serials of devices to claim. |

## [Notes](networks_devices_claim_module.md#id4)
...
## [See Also](networks_devices_claim_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks claimNetworkDevices](https://developer.cisco.com/meraki/api-v1/#!claim-network-devices)
> :   Complete reference of the claimNetworkDevices API.

## [Examples](networks_devices_claim_module.md#id6)
...
## [Return Values](networks_devices_claim_module.md#id7)
