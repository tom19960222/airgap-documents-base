...
collection: ansible
version: "8"
title: "cisco.meraki.networks_alerts_settings module – Resource module for networks _alerts _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_alerts_settings_module.html
fetched_at: 2026-07-28T01:32:51+00:00
---
...
> see [Requirements](networks_alerts_settings_module.md#ansible-collections-cisco-meraki-networks-alerts-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_alerts_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_alerts_settings_module.md#synopsis)
- [Requirements](networks_alerts_settings_module.md#requirements)
- [Parameters](networks_alerts_settings_module.md#parameters)
- [Notes](networks_alerts_settings_module.md#notes)
- [See Also](networks_alerts_settings_module.md#see-also)
- [Examples](networks_alerts_settings_module.md#examples)
- [Return Values](networks_alerts_settings_module.md#return-values)

## [Synopsis](networks_alerts_settings_module.md#id1)
...
## [Requirements](networks_alerts_settings_module.md#id2)
...
## [Parameters](networks_alerts_settings_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **alerts**  list / elements=dictionary | Alert-specific configuration for each type. Only alerts that pertain to the network can be updated. |
| **alertDestinations**  dictionary | A hash of destinations for this specific alert. |
| **allAdmins**  boolean | If true, then all network admins will receive emails for this alert.  **Choices:**   - `false` - `true` |
| **emails**  list / elements=string | A list of emails that will receive information about the alert. |
| **httpServerIds**  list / elements=string | A list of HTTP server IDs to send a Webhook to for this alert. |
| **snmp**  boolean | If true, then an SNMP trap will be sent for this alert if there is an SNMP trap server configured for this network.  **Choices:**   - `false` - `true` |
| **enabled**  boolean | A boolean depicting if the alert is turned on or off.  **Choices:**   - `false` - `true` |
| **filters**  dictionary | A hash of specific configuration data for the alert. Only filters specific to the alert will be updated. |
| **type**  string | The type of alert. |
| **defaultDestinations**  dictionary | The network-wide destinations for all alerts on the network. |
| **allAdmins**  boolean | If true, then all network admins will receive emails.  **Choices:**   - `false` - `true` |
| **emails**  list / elements=string | A list of emails that will recieve the alert(s). |
| **httpServerIds**  list / elements=string | A list of HTTP server IDs to send a Webhook to. |
...
## [Notes](networks_alerts_settings_module.md#id4)
...
## [See Also](networks_alerts_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkAlertsSettings](https://developer.cisco.com/meraki/api-v1/#!update-network-alerts-settings)
> :   Complete reference of the updateNetworkAlertsSettings API.

## [Examples](networks_alerts_settings_module.md#id6)
...
## [Return Values](networks_alerts_settings_module.md#id7)
