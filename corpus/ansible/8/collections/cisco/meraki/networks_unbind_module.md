...
collection: ansible
version: "8"
title: "cisco.meraki.networks_unbind module – Resource module for networks _unbind"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_unbind_module.html
fetched_at: 2026-07-28T01:35:26+00:00
---
# cisco.meraki.networks_unbind module – Resource module for networks _unbind
...
> see [Requirements](networks_unbind_module.md#ansible-collections-cisco-meraki-networks-unbind-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_unbind`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_unbind_module.md#synopsis)
- [Requirements](networks_unbind_module.md#requirements)
- [Parameters](networks_unbind_module.md#parameters)
- [Notes](networks_unbind_module.md#notes)
- [See Also](networks_unbind_module.md#see-also)
- [Examples](networks_unbind_module.md#examples)
- [Return Values](networks_unbind_module.md#return-values)

## [Synopsis](networks_unbind_module.md#id1)
...
## [Requirements](networks_unbind_module.md#id2)
...
## [Parameters](networks_unbind_module.md#id3)
...
| **retainConfigs**  boolean | Optional boolean to retain all the current configs given by the template.  **Choices:**   - `false` - `true` |

## [Notes](networks_unbind_module.md#id4)
...
## [See Also](networks_unbind_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks unbindNetwork](https://developer.cisco.com/meraki/api-v1/#!unbind-network)
> :   Complete reference of the unbindNetwork API.

## [Examples](networks_unbind_module.md#id6)
...
## [Return Values](networks_unbind_module.md#id7)
