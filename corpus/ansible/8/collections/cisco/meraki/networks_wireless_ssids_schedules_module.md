...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_schedules module – Resource module for networks _wireless _ssids _schedules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_schedules_module.html
fetched_at: 2026-07-28T01:36:01+00:00
---
# cisco.meraki.networks_wireless_ssids_schedules module – Resource module for networks _wireless _ssids _schedules
...
> see [Requirements](networks_wireless_ssids_schedules_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-schedules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_schedules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_schedules_module.md#synopsis)
- [Requirements](networks_wireless_ssids_schedules_module.md#requirements)
- [Parameters](networks_wireless_ssids_schedules_module.md#parameters)
- [Notes](networks_wireless_ssids_schedules_module.md#notes)
- [See Also](networks_wireless_ssids_schedules_module.md#see-also)
- [Examples](networks_wireless_ssids_schedules_module.md#examples)
- [Return Values](networks_wireless_ssids_schedules_module.md#return-values)

## [Synopsis](networks_wireless_ssids_schedules_module.md#id1)
...
## [Requirements](networks_wireless_ssids_schedules_module.md#id2)
...
## [Parameters](networks_wireless_ssids_schedules_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | If true, the SSID outage schedule is enabled.  **Choices:**   - `false` - `true` |
...
| **ranges**  list / elements=dictionary | List of outage ranges. Has a start date and time, and end date and time. If this parameter is passed in along with rangesInSeconds parameter, this will take precedence. |
...
| **rangesInSeconds**  list / elements=dictionary | List of outage ranges in seconds since Sunday at Midnight. Has a start and end. If this parameter is passed in along with the ranges parameter, ranges will take precedence. |
| **end**  integer | Seconds since Sunday at midnight when that outage range ends. |
| **start**  integer | Seconds since Sunday at midnight when the outage range starts. |

## [Notes](networks_wireless_ssids_schedules_module.md#id4)
...
## [See Also](networks_wireless_ssids_schedules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidSchedules](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-schedules)
> :   Complete reference of the updateNetworkWirelessSsidSchedules API.

## [Examples](networks_wireless_ssids_schedules_module.md#id6)
...
## [Return Values](networks_wireless_ssids_schedules_module.md#id7)
