...
collection: ansible
version: "8"
title: "cisco.meraki.networks_pii_pii_keys_info module – Information module for networks _pii _piikeys"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_pii_pii_keys_info_module.html
fetched_at: 2026-07-28T01:34:13+00:00
---
# cisco.meraki.networks_pii_pii_keys_info module – Information module for networks _pii _piikeys
...
> see [Requirements](networks_pii_pii_keys_info_module.md#ansible-collections-cisco-meraki-networks-pii-pii-keys-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_pii_pii_keys_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_pii_pii_keys_info_module.md#synopsis)
- [Requirements](networks_pii_pii_keys_info_module.md#requirements)
- [Parameters](networks_pii_pii_keys_info_module.md#parameters)
- [Notes](networks_pii_pii_keys_info_module.md#notes)
- [See Also](networks_pii_pii_keys_info_module.md#see-also)
- [Examples](networks_pii_pii_keys_info_module.md#examples)
- [Return Values](networks_pii_pii_keys_info_module.md#return-values)

## [Synopsis](networks_pii_pii_keys_info_module.md#id1)
...
## [Requirements](networks_pii_pii_keys_info_module.md#id2)
...
## [Parameters](networks_pii_pii_keys_info_module.md#id3)
...
## [Notes](networks_pii_pii_keys_info_module.md#id4)
...
## [See Also](networks_pii_pii_keys_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkPiiPiiKeys](https://developer.cisco.com/meraki/api-v1/#!get-network-pii-pii-keys)
> :   Complete reference of the getNetworkPiiPiiKeys API.

## [Examples](networks_pii_pii_keys_info_module.md#id6)
...
## [Return Values](networks_pii_pii_keys_info_module.md#id7)
