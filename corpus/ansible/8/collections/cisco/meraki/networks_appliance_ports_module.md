...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_ports module – Resource module for networks _appliance _ports"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_ports_module.html
fetched_at: 2026-07-28T01:33:10+00:00
---
...
> see [Requirements](networks_appliance_ports_module.md#ansible-collections-cisco-meraki-networks-appliance-ports-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_ports`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_ports_module.md#synopsis)
- [Requirements](networks_appliance_ports_module.md#requirements)
- [Parameters](networks_appliance_ports_module.md#parameters)
- [Notes](networks_appliance_ports_module.md#notes)
- [See Also](networks_appliance_ports_module.md#see-also)
- [Examples](networks_appliance_ports_module.md#examples)
- [Return Values](networks_appliance_ports_module.md#return-values)

## [Synopsis](networks_appliance_ports_module.md#id1)
...
## [Requirements](networks_appliance_ports_module.md#id2)
...
## [Parameters](networks_appliance_ports_module.md#id3)
...
| **dropUntaggedTraffic**  boolean | Trunk port can Drop all Untagged traffic. When true, no VLAN is required. Access ports cannot have dropUntaggedTraffic set to true.  **Choices:**   - `false` - `true` |
| **enabled**  boolean | The status of the port.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_appliance_ports_module.md#id4)
...
## [See Also](networks_appliance_ports_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkAppliancePort](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-port)
> :   Complete reference of the updateNetworkAppliancePort API.

## [Examples](networks_appliance_ports_module.md#id6)
...
## [Return Values](networks_appliance_ports_module.md#id7)
