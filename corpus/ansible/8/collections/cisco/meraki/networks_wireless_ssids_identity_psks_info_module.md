...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_identity_psks_info module – Information module for networks _wireless _ssids _identitypsks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_identity_psks_info_module.html
fetched_at: 2026-07-28T01:35:59+00:00
---
# cisco.meraki.networks_wireless_ssids_identity_psks_info module – Information module for networks _wireless _ssids _identitypsks
...
> see [Requirements](networks_wireless_ssids_identity_psks_info_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-identity-psks-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_identity_psks_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_identity_psks_info_module.md#synopsis)
- [Requirements](networks_wireless_ssids_identity_psks_info_module.md#requirements)
- [Parameters](networks_wireless_ssids_identity_psks_info_module.md#parameters)
- [Notes](networks_wireless_ssids_identity_psks_info_module.md#notes)
- [See Also](networks_wireless_ssids_identity_psks_info_module.md#see-also)
- [Examples](networks_wireless_ssids_identity_psks_info_module.md#examples)
- [Return Values](networks_wireless_ssids_identity_psks_info_module.md#return-values)

## [Synopsis](networks_wireless_ssids_identity_psks_info_module.md#id1)
...
## [Requirements](networks_wireless_ssids_identity_psks_info_module.md#id2)
...
## [Parameters](networks_wireless_ssids_identity_psks_info_module.md#id3)
...
## [Notes](networks_wireless_ssids_identity_psks_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_ssid_identity_psk, wireless.Wireless.get_network_wireless_ssid_identity_psks,
> - Paths used are get /networks/{networkId}/wireless/ssids/{number}/identityPsks, get /networks/{networkId}/wireless/ssids/{number}/identityPsks/{identityPskId},
> - Supports `check_mode`
...
## [See Also](networks_wireless_ssids_identity_psks_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessSsidIdentityPsk](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-ssid-identity-psk)
> :   Complete reference of the getNetworkWirelessSsidIdentityPsk API.
>
> [Cisco Meraki documentation for wireless getNetworkWirelessSsidIdentityPsks](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-ssid-identity-psks)
> :   Complete reference of the getNetworkWirelessSsidIdentityPsks API.

## [Examples](networks_wireless_ssids_identity_psks_info_module.md#id6)
...
## [Return Values](networks_wireless_ssids_identity_psks_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"email": "string", "expiresAt": "string", "groupPolicyId": "string", "id": "string", "name": "string", "passphrase": "string", "wifiPersonalNetworkId": "string"}` |
