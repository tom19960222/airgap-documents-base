...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_video_settings module – Resource module for devices _camera _video _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_video_settings_module.html
fetched_at: 2026-07-28T01:31:50+00:00
---
# cisco.meraki.devices_camera_video_settings module – Resource module for devices _camera _video _settings
...
> see [Requirements](devices_camera_video_settings_module.md#ansible-collections-cisco-meraki-devices-camera-video-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_video_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_video_settings_module.md#synopsis)
- [Requirements](devices_camera_video_settings_module.md#requirements)
- [Parameters](devices_camera_video_settings_module.md#parameters)
- [Notes](devices_camera_video_settings_module.md#notes)
- [See Also](devices_camera_video_settings_module.md#see-also)
- [Examples](devices_camera_video_settings_module.md#examples)
- [Return Values](devices_camera_video_settings_module.md#return-values)

## [Synopsis](devices_camera_video_settings_module.md#id1)
...
## [Requirements](devices_camera_video_settings_module.md#id2)
...
## [Parameters](devices_camera_video_settings_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **externalRtspEnabled**  boolean | Boolean indicating if external rtsp stream is exposed.  **Choices:**   - `false` - `true` |
...
## [Notes](devices_camera_video_settings_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.update_device_camera_video_settings,
> - Paths used are put /devices/{serial}/camera/video/settings,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_camera_video_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceCameraVideoSettings](https://developer.cisco.com/meraki/api-v1/#!update-device-camera-video-settings)
> :   Complete reference of the updateDeviceCameraVideoSettings API.

## [Examples](devices_camera_video_settings_module.md#id6)
...
## [Return Values](devices_camera_video_settings_module.md#id7)
