...
collection: ansible
version: "8"
title: "cisco.meraki.networks_netflow module – Resource module for networks _netflow"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_netflow_module.html
fetched_at: 2026-07-28T01:34:12+00:00
---
# cisco.meraki.networks_netflow module – Resource module for networks _netflow
...
> see [Requirements](networks_netflow_module.md#ansible-collections-cisco-meraki-networks-netflow-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_netflow`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_netflow_module.md#synopsis)
- [Requirements](networks_netflow_module.md#requirements)
- [Parameters](networks_netflow_module.md#parameters)
- [Notes](networks_netflow_module.md#notes)
- [See Also](networks_netflow_module.md#see-also)
- [Examples](networks_netflow_module.md#examples)
- [Return Values](networks_netflow_module.md#return-values)

## [Synopsis](networks_netflow_module.md#id1)
...
## [Requirements](networks_netflow_module.md#id2)
...
## [Parameters](networks_netflow_module.md#id3)
...
| **etaEnabled**  boolean | Boolean indicating whether Encrypted Traffic Analytics is enabled (true) or disabled (false).  **Choices:**   - `false` - `true` |
...
| **reportingEnabled**  boolean | Boolean indicating whether NetFlow traffic reporting is enabled (true) or disabled (false).  **Choices:**   - `false` - `true` |

## [Notes](networks_netflow_module.md#id4)
...
## [See Also](networks_netflow_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkNetflow](https://developer.cisco.com/meraki/api-v1/#!update-network-netflow)
> :   Complete reference of the updateNetworkNetflow API.

## [Examples](networks_netflow_module.md#id6)
...
## [Return Values](networks_netflow_module.md#id7)
