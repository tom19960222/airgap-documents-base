...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_settings module – Resource module for networks _appliance _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_settings_module.html
fetched_at: 2026-07-28T01:33:16+00:00
---
# cisco.meraki.networks_appliance_settings module – Resource module for networks _appliance _settings
...
> see [Requirements](networks_appliance_settings_module.md#ansible-collections-cisco-meraki-networks-appliance-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_settings_module.md#synopsis)
- [Requirements](networks_appliance_settings_module.md#requirements)
- [Parameters](networks_appliance_settings_module.md#parameters)
- [Notes](networks_appliance_settings_module.md#notes)
- [See Also](networks_appliance_settings_module.md#see-also)
- [Examples](networks_appliance_settings_module.md#examples)
- [Return Values](networks_appliance_settings_module.md#return-values)

## [Synopsis](networks_appliance_settings_module.md#id1)
...
## [Requirements](networks_appliance_settings_module.md#id2)
...
## [Parameters](networks_appliance_settings_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **clientTrackingMethod**  string | Client tracking method of a network. |
| **deploymentMode**  string | Deployment mode of a network. |
| **dynamicDns**  dictionary | Dynamic DNS settings for a network. |
| **enabled**  boolean | Dynamic DNS enabled.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_appliance_settings_module.md#id4)

> **Note:**
>
> - SDK Method used are appliance.Appliance.update_network_appliance_settings,
> - Paths used are put /networks/{networkId}/appliance/settings,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_appliance_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceSettings](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-settings)
> :   Complete reference of the updateNetworkApplianceSettings API.

## [Examples](networks_appliance_settings_module.md#id6)
...
## [Return Values](networks_appliance_settings_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"clientTrackingMethod": "string", "deploymentMode": "string", "dynamicDns": {"enabled": true, "prefix": "string", "url": "string"}}` |
