...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_cellular_gateway_uplink_statuses_info module – Information module for organizations _cellulargateway _uplink _statuses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_cellular_gateway_uplink_statuses_info_module.html
fetched_at: 2026-07-28T01:36:31+00:00
---
# cisco.meraki.organizations_cellular_gateway_uplink_statuses_info module – Information module for organizations _cellulargateway _uplink _statuses
...
> see [Requirements](organizations_cellular_gateway_uplink_statuses_info_module.md#ansible-collections-cisco-meraki-organizations-cellular-gateway-uplink-statuses-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_cellular_gateway_uplink_statuses_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_cellular_gateway_uplink_statuses_info_module.md#synopsis)
- [Requirements](organizations_cellular_gateway_uplink_statuses_info_module.md#requirements)
- [Parameters](organizations_cellular_gateway_uplink_statuses_info_module.md#parameters)
- [Notes](organizations_cellular_gateway_uplink_statuses_info_module.md#notes)
- [See Also](organizations_cellular_gateway_uplink_statuses_info_module.md#see-also)
- [Examples](organizations_cellular_gateway_uplink_statuses_info_module.md#examples)
- [Return Values](organizations_cellular_gateway_uplink_statuses_info_module.md#return-values)

## [Synopsis](organizations_cellular_gateway_uplink_statuses_info_module.md#id1)
...
## [Requirements](organizations_cellular_gateway_uplink_statuses_info_module.md#id2)
...
## [Parameters](organizations_cellular_gateway_uplink_statuses_info_module.md#id3)
...
| **iccids**  list / elements=string | Iccids query parameter. A list of ICCIDs. The returned devices will be filtered to only include these ICCIDs. |
...
| **networkIds**  list / elements=string | NetworkIds query parameter. A list of network IDs. The returned devices will be filtered to only include these networks. |
...
| **serials**  list / elements=string | Serials query parameter. A list of serial numbers. The returned devices will be filtered to only include these serials. |
...
## [Notes](organizations_cellular_gateway_uplink_statuses_info_module.md#id4)
...
## [See Also](organizations_cellular_gateway_uplink_statuses_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway getOrganizationCellularGatewayUplinkStatuses](https://developer.cisco.com/meraki/api-v1/#!get-organization-cellular-gateway-uplink-statuses)
> :   Complete reference of the getOrganizationCellularGatewayUplinkStatuses API.

## [Examples](organizations_cellular_gateway_uplink_statuses_info_module.md#id6)
...
## [Return Values](organizations_cellular_gateway_uplink_statuses_info_module.md#id7)
