...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_appliance_vpn_vpn_firewall_rules_info module – Information module for organizations _appliance _vpn _vpnfirewallrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_appliance_vpn_vpn_firewall_rules_info_module.html
fetched_at: 2026-07-28T01:36:25+00:00
---
# cisco.meraki.organizations_appliance_vpn_vpn_firewall_rules_info module – Information module for organizations _appliance _vpn _vpnfirewallrules
...
> see [Requirements](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#ansible-collections-cisco-meraki-organizations-appliance-vpn-vpn-firewall-rules-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_appliance_vpn_vpn_firewall_rules_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#synopsis)
- [Requirements](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#requirements)
- [Parameters](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#parameters)
- [Notes](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#notes)
- [See Also](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#see-also)
- [Examples](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#examples)
- [Return Values](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#return-values)

## [Synopsis](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id1)
...
## [Requirements](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id2)
...
## [Parameters](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id3)
...
## [Notes](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id4)
...
## [See Also](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance getOrganizationApplianceVpnVpnFirewallRules](https://developer.cisco.com/meraki/api-v1/#!get-organization-appliance-vpn-vpn-firewall-rules)
> :   Complete reference of the getOrganizationApplianceVpnVpnFirewallRules API.

## [Examples](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id6)
...
## [Return Values](organizations_appliance_vpn_vpn_firewall_rules_info_module.md#id7)
