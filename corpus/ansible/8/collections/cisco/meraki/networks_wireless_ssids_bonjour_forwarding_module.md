...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_bonjour_forwarding module – Resource module for networks _wireless _ssids _bonjourforwarding"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_bonjour_forwarding_module.html
fetched_at: 2026-07-28T01:35:49+00:00
---
# cisco.meraki.networks_wireless_ssids_bonjour_forwarding module – Resource module for networks _wireless _ssids _bonjourforwarding
...
> see [Requirements](networks_wireless_ssids_bonjour_forwarding_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-bonjour-forwarding-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_bonjour_forwarding`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_bonjour_forwarding_module.md#synopsis)
- [Requirements](networks_wireless_ssids_bonjour_forwarding_module.md#requirements)
- [Parameters](networks_wireless_ssids_bonjour_forwarding_module.md#parameters)
- [Notes](networks_wireless_ssids_bonjour_forwarding_module.md#notes)
- [See Also](networks_wireless_ssids_bonjour_forwarding_module.md#see-also)
- [Examples](networks_wireless_ssids_bonjour_forwarding_module.md#examples)
- [Return Values](networks_wireless_ssids_bonjour_forwarding_module.md#return-values)

## [Synopsis](networks_wireless_ssids_bonjour_forwarding_module.md#id1)
...
## [Requirements](networks_wireless_ssids_bonjour_forwarding_module.md#id2)
...
## [Parameters](networks_wireless_ssids_bonjour_forwarding_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | If true, Bonjour forwarding is enabled on this SSID.  **Choices:**   - `false` - `true` |
...
| **rules**  list / elements=dictionary | List of bonjour forwarding rules. |
...
## [Notes](networks_wireless_ssids_bonjour_forwarding_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.update_network_wireless_ssid_bonjour_forwarding,
> - Paths used are put /networks/{networkId}/wireless/ssids/{number}/bonjourForwarding,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_wireless_ssids_bonjour_forwarding_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidBonjourForwarding](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-bonjour-forwarding)
> :   Complete reference of the updateNetworkWirelessSsidBonjourForwarding API.

## [Examples](networks_wireless_ssids_bonjour_forwarding_module.md#id6)
...
## [Return Values](networks_wireless_ssids_bonjour_forwarding_module.md#id7)
