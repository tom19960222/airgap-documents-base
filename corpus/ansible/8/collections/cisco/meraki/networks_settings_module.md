...
collection: ansible
version: "8"
title: "cisco.meraki.networks_settings module – Resource module for networks _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_settings_module.html
fetched_at: 2026-07-28T01:34:23+00:00
---
# cisco.meraki.networks_settings module – Resource module for networks _settings
...
> see [Requirements](networks_settings_module.md#ansible-collections-cisco-meraki-networks-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_settings_module.md#synopsis)
- [Requirements](networks_settings_module.md#requirements)
- [Parameters](networks_settings_module.md#parameters)
- [Notes](networks_settings_module.md#notes)
- [See Also](networks_settings_module.md#see-also)
- [Examples](networks_settings_module.md#examples)
- [Return Values](networks_settings_module.md#return-values)

## [Synopsis](networks_settings_module.md#id1)
...
## [Requirements](networks_settings_module.md#id2)
...
## [Parameters](networks_settings_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **localStatusPage**  dictionary | A hash of Local Status page(s)’ authentication options applied to the Network. |
| **authentication**  dictionary | A hash of Local Status page(s)’ authentication options applied to the Network. |
| **enabled**  boolean | Enables / disables the authentication on Local Status page(s).  **Choices:**   - `false` - `true` |
| **password**  string | The password used for Local Status Page(s). Set this to null to clear the password. |
| **localStatusPageEnabled**  boolean | Enables / disables the local device status pages (<a target=’_blank’ href=’http //my.meraki.com/’>my.meraki.com, </a><a target=’_blank’ href=’http //ap.meraki.com/’>ap.meraki.com, </a><a target=’_blank’ href=’http //switch.meraki.com/’>switch.meraki.com, </a><a target=’_blank’ href=’http //wired.meraki.com/’>wired.meraki.com</a>). Optional (defaults to false).  **Choices:**   - `false` - `true` |
...
| **remoteStatusPageEnabled**  boolean | Enables / disables access to the device status page (<a target=’_blank’>http //device’s LAN IP)</a>. Optional. Can only be set if localStatusPageEnabled is set to true.  **Choices:**   - `false` - `true` |
| **securePort**  dictionary | A hash of SecureConnect options applied to the Network. |
| **enabled**  boolean | Enables / disables SecureConnect on the network. Optional.  **Choices:**   - `false` - `true` |

## [Notes](networks_settings_module.md#id4)
...
## [See Also](networks_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkSettings](https://developer.cisco.com/meraki/api-v1/#!update-network-settings)
> :   Complete reference of the updateNetworkSettings API.

## [Examples](networks_settings_module.md#id6)
...
## [Return Values](networks_settings_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"clientPrivacy": {"expireDataBefore": "string", "expireDataOlderThan": 0}, "fips": {"enabled": true}, "localStatusPage": {"authentication": {"enabled": true, "username": "string"}}, "localStatusPageEnabled": true, "namedVlans": {"enabled": true}, "remoteStatusPageEnabled": true, "securePort": {"enabled": true}}` |
