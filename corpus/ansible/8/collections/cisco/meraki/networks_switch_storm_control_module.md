...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_storm_control module – Resource module for networks _switch _stormcontrol"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_storm_control_module.html
fetched_at: 2026-07-28T01:35:18+00:00
---
# cisco.meraki.networks_switch_storm_control module – Resource module for networks _switch _stormcontrol
...
> see [Requirements](networks_switch_storm_control_module.md#ansible-collections-cisco-meraki-networks-switch-storm-control-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_storm_control`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_storm_control_module.md#synopsis)
- [Requirements](networks_switch_storm_control_module.md#requirements)
- [Parameters](networks_switch_storm_control_module.md#parameters)
- [Notes](networks_switch_storm_control_module.md#notes)
- [See Also](networks_switch_storm_control_module.md#see-also)
- [Examples](networks_switch_storm_control_module.md#examples)
- [Return Values](networks_switch_storm_control_module.md#return-values)

## [Synopsis](networks_switch_storm_control_module.md#id1)
...
## [Requirements](networks_switch_storm_control_module.md#id2)
...
## [Parameters](networks_switch_storm_control_module.md#id3)
...
## [Notes](networks_switch_storm_control_module.md#id4)
...
## [See Also](networks_switch_storm_control_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchStormControl](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-storm-control)
> :   Complete reference of the updateNetworkSwitchStormControl API.

## [Examples](networks_switch_storm_control_module.md#id6)
...
## [Return Values](networks_switch_storm_control_module.md#id7)
