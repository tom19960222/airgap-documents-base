...
collection: ansible
version: "8"
title: "cisco.meraki.networks_traffic_analysis_info module – Information module for networks _trafficanalysis"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_traffic_analysis_info_module.html
fetched_at: 2026-07-28T01:35:24+00:00
---
# cisco.meraki.networks_traffic_analysis_info module – Information module for networks _trafficanalysis
...
> see [Requirements](networks_traffic_analysis_info_module.md#ansible-collections-cisco-meraki-networks-traffic-analysis-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_traffic_analysis_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_traffic_analysis_info_module.md#synopsis)
- [Requirements](networks_traffic_analysis_info_module.md#requirements)
- [Parameters](networks_traffic_analysis_info_module.md#parameters)
- [Notes](networks_traffic_analysis_info_module.md#notes)
- [See Also](networks_traffic_analysis_info_module.md#see-also)
- [Examples](networks_traffic_analysis_info_module.md#examples)
- [Return Values](networks_traffic_analysis_info_module.md#return-values)

## [Synopsis](networks_traffic_analysis_info_module.md#id1)
...
## [Requirements](networks_traffic_analysis_info_module.md#id2)
...
## [Parameters](networks_traffic_analysis_info_module.md#id3)
...
## [Notes](networks_traffic_analysis_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_traffic_analysis,
> - Paths used are get /networks/{networkId}/trafficAnalysis,
> - Supports `check_mode`
...
## [See Also](networks_traffic_analysis_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkTrafficAnalysis](https://developer.cisco.com/meraki/api-v1/#!get-network-traffic-analysis)
> :   Complete reference of the getNetworkTrafficAnalysis API.

## [Examples](networks_traffic_analysis_info_module.md#id6)
...
## [Return Values](networks_traffic_analysis_info_module.md#id7)
