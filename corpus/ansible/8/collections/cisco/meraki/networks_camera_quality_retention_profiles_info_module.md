...
collection: ansible
version: "8"
title: "cisco.meraki.networks_camera_quality_retention_profiles_info module – Information module for networks _camera _qualityretentionprofiles"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_camera_quality_retention_profiles_info_module.html
fetched_at: 2026-07-28T01:33:38+00:00
---
# cisco.meraki.networks_camera_quality_retention_profiles_info module – Information module for networks _camera _qualityretentionprofiles
...
> see [Requirements](networks_camera_quality_retention_profiles_info_module.md#ansible-collections-cisco-meraki-networks-camera-quality-retention-profiles-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_camera_quality_retention_profiles_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_camera_quality_retention_profiles_info_module.md#synopsis)
- [Requirements](networks_camera_quality_retention_profiles_info_module.md#requirements)
- [Parameters](networks_camera_quality_retention_profiles_info_module.md#parameters)
- [Notes](networks_camera_quality_retention_profiles_info_module.md#notes)
- [See Also](networks_camera_quality_retention_profiles_info_module.md#see-also)
- [Examples](networks_camera_quality_retention_profiles_info_module.md#examples)
- [Return Values](networks_camera_quality_retention_profiles_info_module.md#return-values)

## [Synopsis](networks_camera_quality_retention_profiles_info_module.md#id1)
...
## [Requirements](networks_camera_quality_retention_profiles_info_module.md#id2)
...
## [Parameters](networks_camera_quality_retention_profiles_info_module.md#id3)
...
## [Notes](networks_camera_quality_retention_profiles_info_module.md#id4)

> **Note:**
>
> - SDK Method used are camera.Camera.get_network_camera_quality_retention_profile, camera.Camera.get_network_camera_quality_retention_profiles,
> - Paths used are get /networks/{networkId}/camera/qualityRetentionProfiles, get /networks/{networkId}/camera/qualityRetentionProfiles/{qualityRetentionProfileId},
> - Supports `check_mode`
...
## [See Also](networks_camera_quality_retention_profiles_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for camera getNetworkCameraQualityRetentionProfile](https://developer.cisco.com/meraki/api-v1/#!get-network-camera-quality-retention-profile)
> :   Complete reference of the getNetworkCameraQualityRetentionProfile API.
>
> [Cisco Meraki documentation for camera getNetworkCameraQualityRetentionProfiles](https://developer.cisco.com/meraki/api-v1/#!get-network-camera-quality-retention-profiles)
> :   Complete reference of the getNetworkCameraQualityRetentionProfiles API.

## [Examples](networks_camera_quality_retention_profiles_info_module.md#id6)
...
## [Return Values](networks_camera_quality_retention_profiles_info_module.md#id7)
