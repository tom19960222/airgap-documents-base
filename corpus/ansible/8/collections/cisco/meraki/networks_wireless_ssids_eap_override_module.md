...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_eap_override module – Resource module for networks _wireless _ssids _eapoverride"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_eap_override_module.html
fetched_at: 2026-07-28T01:35:52+00:00
---
# cisco.meraki.networks_wireless_ssids_eap_override module – Resource module for networks _wireless _ssids _eapoverride
...
> see [Requirements](networks_wireless_ssids_eap_override_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-eap-override-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_eap_override`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_eap_override_module.md#synopsis)
- [Requirements](networks_wireless_ssids_eap_override_module.md#requirements)
- [Parameters](networks_wireless_ssids_eap_override_module.md#parameters)
- [Notes](networks_wireless_ssids_eap_override_module.md#notes)
- [See Also](networks_wireless_ssids_eap_override_module.md#see-also)
- [Examples](networks_wireless_ssids_eap_override_module.md#examples)
- [Return Values](networks_wireless_ssids_eap_override_module.md#return-values)

## [Synopsis](networks_wireless_ssids_eap_override_module.md#id1)
...
## [Requirements](networks_wireless_ssids_eap_override_module.md#id2)
...
## [Parameters](networks_wireless_ssids_eap_override_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **eapolKey**  dictionary | EAPOL Key settings. |
| **retries**  integer | Maximum number of EAPOL key retries. |
| **timeoutInMs**  integer | EAPOL Key timeout in milliseconds. |
| **identity**  dictionary | EAP settings for identity requests. |
| **retries**  integer | Maximum number of EAP retries. |
| **timeout**  integer | EAP timeout in seconds. |
...
## [Notes](networks_wireless_ssids_eap_override_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.update_network_wireless_ssid_eap_override,
> - Paths used are put /networks/{networkId}/wireless/ssids/{number}/eapOverride,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_wireless_ssids_eap_override_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidEapOverride](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-eap-override)
> :   Complete reference of the updateNetworkWirelessSsidEapOverride API.

## [Examples](networks_wireless_ssids_eap_override_module.md#id6)
...
## [Return Values](networks_wireless_ssids_eap_override_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"eapolKey": {"retries": 0, "timeoutInMs": 0}, "identity": {"retries": 0, "timeout": 0}, "maxRetries": 0, "timeout": 0}` |
