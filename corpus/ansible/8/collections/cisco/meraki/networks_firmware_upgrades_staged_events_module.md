...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_events module – Resource module for networks _firmwareupgrades _staged _events"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_events_module.html
fetched_at: 2026-07-28T01:33:58+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_events module – Resource module for networks _firmwareupgrades _staged _events
...
> see [Requirements](networks_firmware_upgrades_staged_events_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-events-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_events`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_events_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_events_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_events_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_events_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_events_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_events_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_events_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_events_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_events_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_events_module.md#id3)
...
| **products**  dictionary | Contains firmware upgrade version information. |
| **switch**  dictionary | Version information for the switch network being upgraded. |
| **nextUpgrade**  dictionary | The next upgrade version for the switch network. |
| **toVersion**  dictionary | The version to be updated to for switch devices. |
| **id**  string | The version ID. |
| **stages**  list / elements=dictionary | All firmware upgrade stages in the network with their start time. |
...
## [Notes](networks_firmware_upgrades_staged_events_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.create_network_firmware_upgrades_staged_event, networks.Networks.update_network_firmware_upgrades_staged_events,
> - Paths used are post /networks/{networkId}/firmwareUpgrades/staged/events, put /networks/{networkId}/firmwareUpgrades/staged/events,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_firmware_upgrades_staged_events_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks createNetworkFirmwareUpgradesStagedEvent](https://developer.cisco.com/meraki/api-v1/#!create-network-firmware-upgrades-staged-event)
> :   Complete reference of the createNetworkFirmwareUpgradesStagedEvent API.
>
> [Cisco Meraki documentation for networks updateNetworkFirmwareUpgradesStagedEvents](https://developer.cisco.com/meraki/api-v1/#!update-network-firmware-upgrades-staged-events)
> :   Complete reference of the updateNetworkFirmwareUpgradesStagedEvents API.

## [Examples](networks_firmware_upgrades_staged_events_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_events_module.md#id7)
