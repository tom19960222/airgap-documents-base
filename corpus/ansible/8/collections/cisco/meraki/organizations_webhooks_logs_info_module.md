...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_webhooks_logs_info module – Information module for organizations _webhooks _logs"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_webhooks_logs_info_module.html
fetched_at: 2026-07-28T01:37:31+00:00
---
# cisco.meraki.organizations_webhooks_logs_info module – Information module for organizations _webhooks _logs
...
> see [Requirements](organizations_webhooks_logs_info_module.md#ansible-collections-cisco-meraki-organizations-webhooks-logs-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_webhooks_logs_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_webhooks_logs_info_module.md#synopsis)
- [Requirements](organizations_webhooks_logs_info_module.md#requirements)
- [Parameters](organizations_webhooks_logs_info_module.md#parameters)
- [Notes](organizations_webhooks_logs_info_module.md#notes)
- [See Also](organizations_webhooks_logs_info_module.md#see-also)
- [Examples](organizations_webhooks_logs_info_module.md#examples)
- [Return Values](organizations_webhooks_logs_info_module.md#return-values)

## [Synopsis](organizations_webhooks_logs_info_module.md#id1)
...
## [Requirements](organizations_webhooks_logs_info_module.md#id2)
...
## [Parameters](organizations_webhooks_logs_info_module.md#id3)
...
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 3 - 1000. Default is 50. |
...
## [Notes](organizations_webhooks_logs_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_webhooks_logs,
> - Paths used are get /organizations/{organizationId}/webhooks/logs,
> - Supports `check_mode`
...
## [See Also](organizations_webhooks_logs_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationWebhooksLogs](https://developer.cisco.com/meraki/api-v1/#!get-organization-webhooks-logs)
> :   Complete reference of the getOrganizationWebhooksLogs API.

## [Examples](organizations_webhooks_logs_info_module.md#id6)
...
## [Return Values](organizations_webhooks_logs_info_module.md#id7)
