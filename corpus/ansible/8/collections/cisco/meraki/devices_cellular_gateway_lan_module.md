...
collection: ansible
version: "8"
title: "cisco.meraki.devices_cellular_gateway_lan module – Resource module for devices _cellulargateway _lan"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_cellular_gateway_lan_module.html
fetched_at: 2026-07-28T01:31:53+00:00
---
# cisco.meraki.devices_cellular_gateway_lan module – Resource module for devices _cellulargateway _lan
...
> see [Requirements](devices_cellular_gateway_lan_module.md#ansible-collections-cisco-meraki-devices-cellular-gateway-lan-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_cellular_gateway_lan`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_cellular_gateway_lan_module.md#synopsis)
- [Requirements](devices_cellular_gateway_lan_module.md#requirements)
- [Parameters](devices_cellular_gateway_lan_module.md#parameters)
- [Notes](devices_cellular_gateway_lan_module.md#notes)
- [See Also](devices_cellular_gateway_lan_module.md#see-also)
- [Examples](devices_cellular_gateway_lan_module.md#examples)
- [Return Values](devices_cellular_gateway_lan_module.md#return-values)

## [Synopsis](devices_cellular_gateway_lan_module.md#id1)
...
## [Requirements](devices_cellular_gateway_lan_module.md#id2)
...
## [Parameters](devices_cellular_gateway_lan_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **fixedIpAssignments**  list / elements=dictionary | List of all fixed IP assignments for a single MG. |
...
| **reservedIpRanges**  list / elements=dictionary | List of all reserved IP ranges for a single MG. |
...
## [Notes](devices_cellular_gateway_lan_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.update_device_cellular_gateway_lan,
> - Paths used are put /devices/{serial}/cellularGateway/lan,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_cellular_gateway_lan_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceCellularGatewayLan](https://developer.cisco.com/meraki/api-v1/#!update-device-cellular-gateway-lan)
> :   Complete reference of the updateDeviceCellularGatewayLan API.

## [Examples](devices_cellular_gateway_lan_module.md#id6)
...
## [Return Values](devices_cellular_gateway_lan_module.md#id7)
