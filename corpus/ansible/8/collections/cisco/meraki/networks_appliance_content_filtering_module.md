...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_content_filtering module – Resource module for networks _appliance _contentfiltering"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_content_filtering_module.html
fetched_at: 2026-07-28T01:32:54+00:00
---
# cisco.meraki.networks_appliance_content_filtering module – Resource module for networks _appliance _contentfiltering
...
> see [Requirements](networks_appliance_content_filtering_module.md#ansible-collections-cisco-meraki-networks-appliance-content-filtering-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_content_filtering`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_content_filtering_module.md#synopsis)
- [Requirements](networks_appliance_content_filtering_module.md#requirements)
- [Parameters](networks_appliance_content_filtering_module.md#parameters)
- [Notes](networks_appliance_content_filtering_module.md#notes)
- [See Also](networks_appliance_content_filtering_module.md#see-also)
- [Examples](networks_appliance_content_filtering_module.md#examples)
- [Return Values](networks_appliance_content_filtering_module.md#return-values)

## [Synopsis](networks_appliance_content_filtering_module.md#id1)
...
## [Requirements](networks_appliance_content_filtering_module.md#id2)
...
## [Parameters](networks_appliance_content_filtering_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **allowedUrlPatterns**  list / elements=string | A list of URL patterns that are allowed. |
| **blockedUrlCategories**  list / elements=string | A list of URL categories to block. |
| **blockedUrlPatterns**  list / elements=string | A list of URL patterns that are blocked. |
...
## [Notes](networks_appliance_content_filtering_module.md#id4)
...
## [See Also](networks_appliance_content_filtering_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceContentFiltering](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-content-filtering)
> :   Complete reference of the updateNetworkApplianceContentFiltering API.

## [Examples](networks_appliance_content_filtering_module.md#id6)
...
## [Return Values](networks_appliance_content_filtering_module.md#id7)
