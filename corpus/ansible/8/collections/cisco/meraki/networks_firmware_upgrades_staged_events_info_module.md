...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_events_info module – Information module for networks _firmwareupgrades _staged _events"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_events_info_module.html
fetched_at: 2026-07-28T01:34:00+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_events_info module – Information module for networks _firmwareupgrades _staged _events
...
> see [Requirements](networks_firmware_upgrades_staged_events_info_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-events-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_events_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_events_info_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_events_info_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_events_info_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_events_info_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_events_info_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_events_info_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_events_info_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_events_info_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_events_info_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_events_info_module.md#id3)
...
## [Notes](networks_firmware_upgrades_staged_events_info_module.md#id4)
...
## [See Also](networks_firmware_upgrades_staged_events_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkFirmwareUpgradesStagedEvents](https://developer.cisco.com/meraki/api-v1/#!get-network-firmware-upgrades-staged-events)
> :   Complete reference of the getNetworkFirmwareUpgradesStagedEvents API.

## [Examples](networks_firmware_upgrades_staged_events_info_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_events_info_module.md#id7)
