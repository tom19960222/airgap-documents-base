...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_events_defer module – Resource module for networks _firmwareupgrades _staged _events _defer"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_events_defer_module.html
fetched_at: 2026-07-28T01:33:59+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_events_defer module – Resource module for networks _firmwareupgrades _staged _events _defer
...
> see [Requirements](networks_firmware_upgrades_staged_events_defer_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-events-defer-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_events_defer`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_events_defer_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_events_defer_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_events_defer_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_events_defer_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_events_defer_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_events_defer_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_events_defer_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_events_defer_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_events_defer_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_events_defer_module.md#id3)
...
## [Notes](networks_firmware_upgrades_staged_events_defer_module.md#id4)
...
## [See Also](networks_firmware_upgrades_staged_events_defer_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks deferNetworkFirmwareUpgradesStagedEvents](https://developer.cisco.com/meraki/api-v1/#!defer-network-firmware-upgrades-staged-events)
> :   Complete reference of the deferNetworkFirmwareUpgradesStagedEvents API.

## [Examples](networks_firmware_upgrades_staged_events_defer_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_events_defer_module.md#id7)
