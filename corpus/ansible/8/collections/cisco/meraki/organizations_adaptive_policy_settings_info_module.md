...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_adaptive_policy_settings_info module – Information module for organizations _adaptivepolicy _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_adaptive_policy_settings_info_module.html
fetched_at: 2026-07-28T01:36:16+00:00
---
# cisco.meraki.organizations_adaptive_policy_settings_info module – Information module for organizations _adaptivepolicy _settings
...
> see [Requirements](organizations_adaptive_policy_settings_info_module.md#ansible-collections-cisco-meraki-organizations-adaptive-policy-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_adaptive_policy_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_adaptive_policy_settings_info_module.md#synopsis)
- [Requirements](organizations_adaptive_policy_settings_info_module.md#requirements)
- [Parameters](organizations_adaptive_policy_settings_info_module.md#parameters)
- [Notes](organizations_adaptive_policy_settings_info_module.md#notes)
- [See Also](organizations_adaptive_policy_settings_info_module.md#see-also)
- [Examples](organizations_adaptive_policy_settings_info_module.md#examples)
- [Return Values](organizations_adaptive_policy_settings_info_module.md#return-values)

## [Synopsis](organizations_adaptive_policy_settings_info_module.md#id1)
...
## [Requirements](organizations_adaptive_policy_settings_info_module.md#id2)
...
## [Parameters](organizations_adaptive_policy_settings_info_module.md#id3)
...
## [Notes](organizations_adaptive_policy_settings_info_module.md#id4)
...
## [See Also](organizations_adaptive_policy_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationAdaptivePolicySettings](https://developer.cisco.com/meraki/api-v1/#!get-organization-adaptive-policy-settings)
> :   Complete reference of the getOrganizationAdaptivePolicySettings API.

## [Examples](organizations_adaptive_policy_settings_info_module.md#id6)
...
## [Return Values](organizations_adaptive_policy_settings_info_module.md#id7)
