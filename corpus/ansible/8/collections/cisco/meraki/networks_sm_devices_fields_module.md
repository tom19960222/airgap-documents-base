...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_fields module – Resource module for networks _sm _devices _fields"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_fields_module.html
fetched_at: 2026-07-28T01:34:31+00:00
---
# cisco.meraki.networks_sm_devices_fields module – Resource module for networks _sm _devices _fields
...
> see [Requirements](networks_sm_devices_fields_module.md#ansible-collections-cisco-meraki-networks-sm-devices-fields-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_fields`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_fields_module.md#synopsis)
- [Requirements](networks_sm_devices_fields_module.md#requirements)
- [Parameters](networks_sm_devices_fields_module.md#parameters)
- [Notes](networks_sm_devices_fields_module.md#notes)
- [See Also](networks_sm_devices_fields_module.md#see-also)
- [Examples](networks_sm_devices_fields_module.md#examples)
- [Return Values](networks_sm_devices_fields_module.md#return-values)

## [Synopsis](networks_sm_devices_fields_module.md#id1)
...
## [Requirements](networks_sm_devices_fields_module.md#id2)
...
## [Parameters](networks_sm_devices_fields_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **deviceFields**  dictionary | The new fields of the device. Each field of this object is optional. |
...
## [Notes](networks_sm_devices_fields_module.md#id4)
...
## [See Also](networks_sm_devices_fields_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm updateNetworkSmDevicesFields](https://developer.cisco.com/meraki/api-v1/#!update-network-sm-devices-fields)
> :   Complete reference of the updateNetworkSmDevicesFields API.

## [Examples](networks_sm_devices_fields_module.md#id6)
...
## [Return Values](networks_sm_devices_fields_module.md#id7)
