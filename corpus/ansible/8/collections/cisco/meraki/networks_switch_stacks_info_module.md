...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_stacks_info module – Information module for networks _switch _stacks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_stacks_info_module.html
fetched_at: 2026-07-28T01:35:12+00:00
---
# cisco.meraki.networks_switch_stacks_info module – Information module for networks _switch _stacks
...
> see [Requirements](networks_switch_stacks_info_module.md#ansible-collections-cisco-meraki-networks-switch-stacks-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_stacks_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_stacks_info_module.md#synopsis)
- [Requirements](networks_switch_stacks_info_module.md#requirements)
- [Parameters](networks_switch_stacks_info_module.md#parameters)
- [Notes](networks_switch_stacks_info_module.md#notes)
- [See Also](networks_switch_stacks_info_module.md#see-also)
- [Examples](networks_switch_stacks_info_module.md#examples)
- [Return Values](networks_switch_stacks_info_module.md#return-values)

## [Synopsis](networks_switch_stacks_info_module.md#id1)
...
## [Requirements](networks_switch_stacks_info_module.md#id2)
...
## [Parameters](networks_switch_stacks_info_module.md#id3)
...
## [Notes](networks_switch_stacks_info_module.md#id4)
...
## [See Also](networks_switch_stacks_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchStack](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-stack)
> :   Complete reference of the getNetworkSwitchStack API.
>
> [Cisco Meraki documentation for switch getNetworkSwitchStacks](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-stacks)
> :   Complete reference of the getNetworkSwitchStacks API.

## [Examples](networks_switch_stacks_info_module.md#id6)
...
## [Return Values](networks_switch_stacks_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"id": "string", "name": "string", "serials": ["string"]}` |
