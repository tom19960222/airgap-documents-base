...
collection: ansible
version: "8"
title: "cisco.meraki.devices_live_tools_ping_device_info module – Information module for devices _livetools _pingdevice"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_live_tools_ping_device_info_module.html
fetched_at: 2026-07-28T01:31:59+00:00
---
# cisco.meraki.devices_live_tools_ping_device_info module – Information module for devices _livetools _pingdevice
...
> see [Requirements](devices_live_tools_ping_device_info_module.md#ansible-collections-cisco-meraki-devices-live-tools-ping-device-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_live_tools_ping_device_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_live_tools_ping_device_info_module.md#synopsis)
- [Requirements](devices_live_tools_ping_device_info_module.md#requirements)
- [Parameters](devices_live_tools_ping_device_info_module.md#parameters)
- [Notes](devices_live_tools_ping_device_info_module.md#notes)
- [See Also](devices_live_tools_ping_device_info_module.md#see-also)
- [Examples](devices_live_tools_ping_device_info_module.md#examples)
- [Return Values](devices_live_tools_ping_device_info_module.md#return-values)

## [Synopsis](devices_live_tools_ping_device_info_module.md#id1)
...
## [Requirements](devices_live_tools_ping_device_info_module.md#id2)
...
## [Parameters](devices_live_tools_ping_device_info_module.md#id3)
...
## [Notes](devices_live_tools_ping_device_info_module.md#id4)
...
## [See Also](devices_live_tools_ping_device_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceLiveToolsPingDevice](https://developer.cisco.com/meraki/api-v1/#!get-device-live-tools-ping-device)
> :   Complete reference of the getDeviceLiveToolsPingDevice API.

## [Examples](devices_live_tools_ping_device_info_module.md#id6)
...
## [Return Values](devices_live_tools_ping_device_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"pingId": "string", "request": {"count": 0, "serial": "string", "target": "string"}, "results": {"latencies": {"average": 0, "maximum": 0, "minimum": 0}, "loss": {"percentage": 0}, "received": 0, "replies": [{"latency": 0, "sequenceId": 0, "size": 0}], "sent": 0}, "status": "string", "url": "string"}` |
