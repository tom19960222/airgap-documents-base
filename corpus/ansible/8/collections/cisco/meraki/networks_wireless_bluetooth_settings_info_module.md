...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_bluetooth_settings_info module – Information module for networks _wireless _bluetooth _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_bluetooth_settings_info_module.html
fetched_at: 2026-07-28T01:35:36+00:00
---
# cisco.meraki.networks_wireless_bluetooth_settings_info module – Information module for networks _wireless _bluetooth _settings
...
> see [Requirements](networks_wireless_bluetooth_settings_info_module.md#ansible-collections-cisco-meraki-networks-wireless-bluetooth-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_bluetooth_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_bluetooth_settings_info_module.md#synopsis)
- [Requirements](networks_wireless_bluetooth_settings_info_module.md#requirements)
- [Parameters](networks_wireless_bluetooth_settings_info_module.md#parameters)
- [Notes](networks_wireless_bluetooth_settings_info_module.md#notes)
- [See Also](networks_wireless_bluetooth_settings_info_module.md#see-also)
- [Examples](networks_wireless_bluetooth_settings_info_module.md#examples)
- [Return Values](networks_wireless_bluetooth_settings_info_module.md#return-values)

## [Synopsis](networks_wireless_bluetooth_settings_info_module.md#id1)
...
## [Requirements](networks_wireless_bluetooth_settings_info_module.md#id2)
...
## [Parameters](networks_wireless_bluetooth_settings_info_module.md#id3)
...
## [Notes](networks_wireless_bluetooth_settings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_bluetooth_settings,
> - Paths used are get /networks/{networkId}/wireless/bluetooth/settings,
> - Supports `check_mode`
...
## [See Also](networks_wireless_bluetooth_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessBluetoothSettings](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-bluetooth-settings)
> :   Complete reference of the getNetworkWirelessBluetoothSettings API.

## [Examples](networks_wireless_bluetooth_settings_info_module.md#id6)
...
## [Return Values](networks_wireless_bluetooth_settings_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"advertisingEnabled": true, "eslEnabled": true, "major": 0, "majorMinorAssignmentMode": "string", "minor": 0, "scanningEnabled": true, "uuid": "string"}` |
