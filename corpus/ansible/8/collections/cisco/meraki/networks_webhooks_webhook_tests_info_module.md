...
collection: ansible
version: "8"
title: "cisco.meraki.networks_webhooks_webhook_tests_info module – Information module for networks _webhooks _webhooktests"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_webhooks_webhook_tests_info_module.html
fetched_at: 2026-07-28T01:35:31+00:00
---
# cisco.meraki.networks_webhooks_webhook_tests_info module – Information module for networks _webhooks _webhooktests
...
> see [Requirements](networks_webhooks_webhook_tests_info_module.md#ansible-collections-cisco-meraki-networks-webhooks-webhook-tests-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_webhooks_webhook_tests_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_webhooks_webhook_tests_info_module.md#synopsis)
- [Requirements](networks_webhooks_webhook_tests_info_module.md#requirements)
- [Parameters](networks_webhooks_webhook_tests_info_module.md#parameters)
- [Notes](networks_webhooks_webhook_tests_info_module.md#notes)
- [See Also](networks_webhooks_webhook_tests_info_module.md#see-also)
- [Examples](networks_webhooks_webhook_tests_info_module.md#examples)
- [Return Values](networks_webhooks_webhook_tests_info_module.md#return-values)

## [Synopsis](networks_webhooks_webhook_tests_info_module.md#id1)
...
## [Requirements](networks_webhooks_webhook_tests_info_module.md#id2)
...
## [Parameters](networks_webhooks_webhook_tests_info_module.md#id3)
...
| **webhookTestId**  string | WebhookTestId path parameter. Webhook test ID. |

## [Notes](networks_webhooks_webhook_tests_info_module.md#id4)
...
## [See Also](networks_webhooks_webhook_tests_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkWebhooksWebhookTest](https://developer.cisco.com/meraki/api-v1/#!get-network-webhooks-webhook-test)
> :   Complete reference of the getNetworkWebhooksWebhookTest API.

## [Examples](networks_webhooks_webhook_tests_info_module.md#id6)
...
## [Return Values](networks_webhooks_webhook_tests_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"id": "string", "status": "string", "url": "string"}` |
