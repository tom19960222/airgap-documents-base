...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_hotspot20 module – Resource module for networks _wireless _ssids _hotspot20"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_hotspot20_module.html
fetched_at: 2026-07-28T01:35:57+00:00
---
...
> see [Requirements](networks_wireless_ssids_hotspot20_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-hotspot20-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_hotspot20`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_hotspot20_module.md#synopsis)
- [Requirements](networks_wireless_ssids_hotspot20_module.md#requirements)
- [Parameters](networks_wireless_ssids_hotspot20_module.md#parameters)
- [Notes](networks_wireless_ssids_hotspot20_module.md#notes)
- [See Also](networks_wireless_ssids_hotspot20_module.md#see-also)
- [Examples](networks_wireless_ssids_hotspot20_module.md#examples)
- [Return Values](networks_wireless_ssids_hotspot20_module.md#return-values)

## [Synopsis](networks_wireless_ssids_hotspot20_module.md#id1)
...
## [Requirements](networks_wireless_ssids_hotspot20_module.md#id2)
...
## [Parameters](networks_wireless_ssids_hotspot20_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **domains**  list / elements=string | An array of domain names. |
| **enabled**  boolean | Whether or not Hotspot 2.0 for this SSID is enabled.  **Choices:**   - `false` - `true` |
| **mccMncs**  list / elements=dictionary | An array of MCC/MNC pairs. |
...
| **naiRealms**  list / elements=dictionary | An array of NAI realms. |
| **format**  string | The format for the realm (‘1’ or ‘0’). |
| **methods**  list / elements=dictionary | An array of EAP methods for the realm. |
| **authenticationTypes**  dictionary | The authentication types for the method. These should be formatted as an object with the EAP method category in camelcase as the key and the list of types as the value (nonEapInnerAuthentication Reserved, PAP, CHAP, MSCHAP, MSCHAPV2; eapInnerAuthentication EAP-TLS, EAP-SIM, EAP-AKA, EAP-TTLS with MSCHAPv2; credentials SIM, USIM, NFC Secure Element, Hardware Token, Softoken, Certificate, username/password, none, Reserved, Vendor Specific; tunneledEapMethodCredentials SIM, USIM, NFC Secure Element, Hardware Token, Softoken, Certificate, username/password, Reserved, Anonymous, Vendor Specific). |
...
| **operator**  dictionary | Operator settings for this SSID. |
| **name**  string | Operator name. |
| **roamConsortOis**  list / elements=string | An array of roaming consortium OIs (hexadecimal number 3-5 octets in length). |
| **venue**  dictionary | Venue settings for this SSID. |
...
## [Notes](networks_wireless_ssids_hotspot20_module.md#id4)
...
## [See Also](networks_wireless_ssids_hotspot20_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidHotspot20](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-hotspot20)
> :   Complete reference of the updateNetworkWirelessSsidHotspot20 API.

## [Examples](networks_wireless_ssids_hotspot20_module.md#id6)
...
## [Return Values](networks_wireless_ssids_hotspot20_module.md#id7)
