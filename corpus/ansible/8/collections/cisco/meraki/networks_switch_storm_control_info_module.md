...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_storm_control_info module – Information module for networks _switch _stormcontrol"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_storm_control_info_module.html
fetched_at: 2026-07-28T01:35:19+00:00
---
# cisco.meraki.networks_switch_storm_control_info module – Information module for networks _switch _stormcontrol
...
> see [Requirements](networks_switch_storm_control_info_module.md#ansible-collections-cisco-meraki-networks-switch-storm-control-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_storm_control_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_storm_control_info_module.md#synopsis)
- [Requirements](networks_switch_storm_control_info_module.md#requirements)
- [Parameters](networks_switch_storm_control_info_module.md#parameters)
- [Notes](networks_switch_storm_control_info_module.md#notes)
- [See Also](networks_switch_storm_control_info_module.md#see-also)
- [Examples](networks_switch_storm_control_info_module.md#examples)
- [Return Values](networks_switch_storm_control_info_module.md#return-values)

## [Synopsis](networks_switch_storm_control_info_module.md#id1)
...
## [Requirements](networks_switch_storm_control_info_module.md#id2)
...
## [Parameters](networks_switch_storm_control_info_module.md#id3)
...
## [Notes](networks_switch_storm_control_info_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.get_network_switch_storm_control,
> - Paths used are get /networks/{networkId}/switch/stormControl,
> - Supports `check_mode`
...
## [See Also](networks_switch_storm_control_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchStormControl](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-storm-control)
> :   Complete reference of the getNetworkSwitchStormControl API.

## [Examples](networks_switch_storm_control_info_module.md#id6)
...
## [Return Values](networks_switch_storm_control_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"broadcastThreshold": 0, "multicastThreshold": 0, "unknownUnicastThreshold": 0}` |
