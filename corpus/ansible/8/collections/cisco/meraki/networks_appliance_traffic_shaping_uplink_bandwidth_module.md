...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_traffic_shaping_uplink_bandwidth module – Resource module for networks _appliance _trafficshaping _uplinkbandwidth"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_traffic_shaping_uplink_bandwidth_module.html
fetched_at: 2026-07-28T01:33:25+00:00
---
# cisco.meraki.networks_appliance_traffic_shaping_uplink_bandwidth module – Resource module for networks _appliance _trafficshaping _uplinkbandwidth
...
> see [Requirements](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#ansible-collections-cisco-meraki-networks-appliance-traffic-shaping-uplink-bandwidth-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_traffic_shaping_uplink_bandwidth`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#synopsis)
- [Requirements](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#requirements)
- [Parameters](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#parameters)
- [Notes](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#notes)
- [See Also](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#see-also)
- [Examples](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#examples)
- [Return Values](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#return-values)

## [Synopsis](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id1)
...
## [Requirements](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id2)
...
## [Parameters](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **bandwidthLimits**  dictionary | A mapping of uplinks to their bandwidth settings (be sure to check which uplinks are supported for your network). |
| **cellular**  dictionary | The bandwidth settings for the ‘cellular’ uplink. |
...
| **wan1**  dictionary | The bandwidth settings for the ‘wan1’ uplink. |
| **limitDown**  integer | The maximum download limit (integer, in Kbps). Null indicates no limit. |
| **limitUp**  integer | The maximum upload limit (integer, in Kbps). Null indicates no limit. |
| **wan2**  dictionary | The bandwidth settings for the ‘wan2’ uplink. |
| **limitDown**  integer | The maximum download limit (integer, in Kbps). Null indicates no limit. |
| **limitUp**  integer | The maximum upload limit (integer, in Kbps). Null indicates no limit. |
...
## [Notes](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id4)
...
## [See Also](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceTrafficShapingUplinkBandwidth](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-traffic-shaping-uplink-bandwidth)
> :   Complete reference of the updateNetworkApplianceTrafficShapingUplinkBandwidth API.

## [Examples](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id6)
...
## [Return Values](networks_appliance_traffic_shaping_uplink_bandwidth_module.md#id7)
