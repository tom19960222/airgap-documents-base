...
collection: ansible
version: "8"
title: "cisco.meraki.meraki_mx_site_to_site_firewall module – Manage MX appliance firewall rules for site-to-site VPNs"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_mx_site_to_site_firewall_module.html
...
- [DEPRECATED](meraki_mx_site_to_site_firewall_module.md#deprecated)
- [Synopsis](meraki_mx_site_to_site_firewall_module.md#synopsis)
- [Parameters](meraki_mx_site_to_site_firewall_module.md#parameters)
- [Notes](meraki_mx_site_to_site_firewall_module.md#notes)
- [Examples](meraki_mx_site_to_site_firewall_module.md#examples)
- [Return Values](meraki_mx_site_to_site_firewall_module.md#return-values)
- [Status](meraki_mx_site_to_site_firewall_module.md#status)

## [DEPRECATED](meraki_mx_site_to_site_firewall_module.md#id1)
...
## [Synopsis](meraki_mx_site_to_site_firewall_module.md#id2)
...
## [Parameters](meraki_mx_site_to_site_firewall_module.md#id3)
...
## [Notes](meraki_mx_site_to_site_firewall_module.md#id4)
...
## [Examples](meraki_mx_site_to_site_firewall_module.md#id5)
...
## [Return Values](meraki_mx_site_to_site_firewall_module.md#id6)
...
| **rules**  complex | List of firewall rules associated to network.  **Returned:** success |
...
## [Status](meraki_mx_site_to_site_firewall_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_mx_site_to_site_firewall_module.md#deprecated).
