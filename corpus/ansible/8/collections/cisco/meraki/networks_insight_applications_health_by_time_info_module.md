...
collection: ansible
version: "8"
title: "cisco.meraki.networks_insight_applications_health_by_time_info module – Information module for networks _insight _applications _healthbytime"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_insight_applications_health_by_time_info_module.html
fetched_at: 2026-07-28T01:34:09+00:00
---
# cisco.meraki.networks_insight_applications_health_by_time_info module – Information module for networks _insight _applications _healthbytime
...
> see [Requirements](networks_insight_applications_health_by_time_info_module.md#ansible-collections-cisco-meraki-networks-insight-applications-health-by-time-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_insight_applications_health_by_time_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_insight_applications_health_by_time_info_module.md#synopsis)
- [Requirements](networks_insight_applications_health_by_time_info_module.md#requirements)
- [Parameters](networks_insight_applications_health_by_time_info_module.md#parameters)
- [Notes](networks_insight_applications_health_by_time_info_module.md#notes)
- [See Also](networks_insight_applications_health_by_time_info_module.md#see-also)
- [Examples](networks_insight_applications_health_by_time_info_module.md#examples)
- [Return Values](networks_insight_applications_health_by_time_info_module.md#return-values)

## [Synopsis](networks_insight_applications_health_by_time_info_module.md#id1)
...
## [Requirements](networks_insight_applications_health_by_time_info_module.md#id2)
...
## [Parameters](networks_insight_applications_health_by_time_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **applicationId**  string | ApplicationId path parameter. Application ID. |
...
| **resolution**  integer | Resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are 60, 300, 3600, 86400. The default is 300. |
...
## [Notes](networks_insight_applications_health_by_time_info_module.md#id4)
...
## [See Also](networks_insight_applications_health_by_time_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for insight getNetworkInsightApplicationHealthByTime](https://developer.cisco.com/meraki/api-v1/#!get-network-insight-application-health-by-time)
> :   Complete reference of the getNetworkInsightApplicationHealthByTime API.

## [Examples](networks_insight_applications_health_by_time_info_module.md#id6)
...
## [Return Values](networks_insight_applications_health_by_time_info_module.md#id7)
