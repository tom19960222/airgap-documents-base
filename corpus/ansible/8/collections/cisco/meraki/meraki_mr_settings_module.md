...
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_mr_settings_module.html
...
- [DEPRECATED](meraki_mr_settings_module.md#deprecated)
...
- [Status](meraki_mr_settings_module.md#status)

## [DEPRECATED](meraki_mr_settings_module.md#id1)
...
## [Synopsis](meraki_mr_settings_module.md#id2)

- Allows for configuration of general settings in Meraki MR wireless networks.

## [Parameters](meraki_mr_settings_module.md#id3)
...
## [Notes](meraki_mr_settings_module.md#id4)
...
## [Examples](meraki_mr_settings_module.md#id5)
...
## [Return Values](meraki_mr_settings_module.md#id6)
...
## [Status](meraki_mr_settings_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_mr_settings_module.md#deprecated).
