...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_settings_info module – Information module for networks _appliance _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_settings_info_module.html
fetched_at: 2026-07-28T01:33:16+00:00
---
# cisco.meraki.networks_appliance_settings_info module – Information module for networks _appliance _settings
...
> see [Requirements](networks_appliance_settings_info_module.md#ansible-collections-cisco-meraki-networks-appliance-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_settings_info_module.md#synopsis)
- [Requirements](networks_appliance_settings_info_module.md#requirements)
- [Parameters](networks_appliance_settings_info_module.md#parameters)
- [Notes](networks_appliance_settings_info_module.md#notes)
- [See Also](networks_appliance_settings_info_module.md#see-also)
- [Examples](networks_appliance_settings_info_module.md#examples)
- [Return Values](networks_appliance_settings_info_module.md#return-values)

## [Synopsis](networks_appliance_settings_info_module.md#id1)
...
## [Requirements](networks_appliance_settings_info_module.md#id2)
...
## [Parameters](networks_appliance_settings_info_module.md#id3)
...
## [Notes](networks_appliance_settings_info_module.md#id4)
...
## [See Also](networks_appliance_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance getNetworkApplianceSettings](https://developer.cisco.com/meraki/api-v1/#!get-network-appliance-settings)
> :   Complete reference of the getNetworkApplianceSettings API.

## [Examples](networks_appliance_settings_info_module.md#id6)
...
## [Return Values](networks_appliance_settings_info_module.md#id7)
