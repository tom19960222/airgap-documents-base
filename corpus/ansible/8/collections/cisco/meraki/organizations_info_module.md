...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_info module – Information module for organizations"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_info_module.html
fetched_at: 2026-07-28T01:36:50+00:00
---
# cisco.meraki.organizations_info module – Information module for organizations
...
> see [Requirements](organizations_info_module.md#ansible-collections-cisco-meraki-organizations-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_info_module.md#synopsis)
- [Requirements](organizations_info_module.md#requirements)
- [Parameters](organizations_info_module.md#parameters)
- [Notes](organizations_info_module.md#notes)
- [See Also](organizations_info_module.md#see-also)
- [Examples](organizations_info_module.md#examples)
- [Return Values](organizations_info_module.md#return-values)

## [Synopsis](organizations_info_module.md#id1)
...
## [Requirements](organizations_info_module.md#id2)
...
## [Parameters](organizations_info_module.md#id3)
...
## [Notes](organizations_info_module.md#id4)
...
## [See Also](organizations_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganization](https://developer.cisco.com/meraki/api-v1/#!get-organization)
> :   Complete reference of the getOrganization API.
>
> [Cisco Meraki documentation for organizations getOrganizations](https://developer.cisco.com/meraki/api-v1/#!get-organizations)
> :   Complete reference of the getOrganizations API.

## [Examples](organizations_info_module.md#id6)
...
## [Return Values](organizations_info_module.md#id7)
