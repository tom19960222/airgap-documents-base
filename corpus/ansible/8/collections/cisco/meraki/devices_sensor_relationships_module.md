...
collection: ansible
version: "8"
title: "cisco.meraki.devices_sensor_relationships module – Resource module for devices _sensor _relationships"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_sensor_relationships_module.html
fetched_at: 2026-07-28T01:32:03+00:00
---
# cisco.meraki.devices_sensor_relationships module – Resource module for devices _sensor _relationships
...
> see [Requirements](devices_sensor_relationships_module.md#ansible-collections-cisco-meraki-devices-sensor-relationships-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_sensor_relationships`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_sensor_relationships_module.md#synopsis)
- [Requirements](devices_sensor_relationships_module.md#requirements)
- [Parameters](devices_sensor_relationships_module.md#parameters)
- [Notes](devices_sensor_relationships_module.md#notes)
- [See Also](devices_sensor_relationships_module.md#see-also)
- [Examples](devices_sensor_relationships_module.md#examples)
- [Return Values](devices_sensor_relationships_module.md#return-values)

## [Synopsis](devices_sensor_relationships_module.md#id1)
...
## [Requirements](devices_sensor_relationships_module.md#id2)
...
## [Parameters](devices_sensor_relationships_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **livestream**  dictionary | A role defined between an MT sensor and an MV camera that adds the camera’s livestream to the sensor’s details page. Snapshots from the camera will also appear in alert notifications that the sensor triggers. |
| **relatedDevices**  list / elements=dictionary | An array of the related devices for the role. |
...
## [Notes](devices_sensor_relationships_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.update_device_sensor_relationships,
> - Paths used are put /devices/{serial}/sensor/relationships,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_sensor_relationships_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceSensorRelationships](https://developer.cisco.com/meraki/api-v1/#!update-device-sensor-relationships)
> :   Complete reference of the updateDeviceSensorRelationships API.

## [Examples](devices_sensor_relationships_module.md#id6)
...
## [Return Values](devices_sensor_relationships_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"livestream": {"relatedDevices": [{"productType": "string", "serial": "string"}]}}` |
