...
collection: ansible
version: "8"
title: "cisco.meraki.meraki_mx_network_vlan_settings module – Manage VLAN settings for Meraki Networks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/meraki_mx_network_vlan_settings_module.html
fetched_at: 2026-07-28T01:32:40+00:00
---
...
- [DEPRECATED](meraki_mx_network_vlan_settings_module.md#deprecated)
- [Synopsis](meraki_mx_network_vlan_settings_module.md#synopsis)
- [Parameters](meraki_mx_network_vlan_settings_module.md#parameters)
- [Notes](meraki_mx_network_vlan_settings_module.md#notes)
- [Examples](meraki_mx_network_vlan_settings_module.md#examples)
- [Return Values](meraki_mx_network_vlan_settings_module.md#return-values)
- [Status](meraki_mx_network_vlan_settings_module.md#status)

## [DEPRECATED](meraki_mx_network_vlan_settings_module.md#id1)
...
## [Synopsis](meraki_mx_network_vlan_settings_module.md#id2)

- Edits VLAN enabled status on a network within Meraki.

## [Parameters](meraki_mx_network_vlan_settings_module.md#id3)
...
| **state**  string | Create or modify an alert.  **Choices:**   - `"present"` - `"query"` |
...
| **vlans_enabled**  boolean | Whether VLANs are enabled on the network.  **Choices:**   - `false` - `true` |

## [Notes](meraki_mx_network_vlan_settings_module.md#id4)
...
## [Examples](meraki_mx_network_vlan_settings_module.md#id5)
...
## [Return Values](meraki_mx_network_vlan_settings_module.md#id6)
...
| **vlans_enabled**  boolean | Whether VLANs are enabled for this network.  **Returned:** success |

## [Status](meraki_mx_network_vlan_settings_module.md#id7)

- This module will be removed in version 3.0.0.
  *[deprecated]*
- For more information see [DEPRECATED](meraki_mx_network_vlan_settings_module.md#deprecated).
