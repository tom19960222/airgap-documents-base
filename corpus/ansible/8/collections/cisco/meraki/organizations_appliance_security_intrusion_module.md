...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_appliance_security_intrusion module – Resource module for organizations _appliance _security _intrusion"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_appliance_security_intrusion_module.html
fetched_at: 2026-07-28T01:36:21+00:00
---
...
> see [Requirements](organizations_appliance_security_intrusion_module.md#ansible-collections-cisco-meraki-organizations-appliance-security-intrusion-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_appliance_security_intrusion`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_appliance_security_intrusion_module.md#synopsis)
- [Requirements](organizations_appliance_security_intrusion_module.md#requirements)
- [Parameters](organizations_appliance_security_intrusion_module.md#parameters)
- [Notes](organizations_appliance_security_intrusion_module.md#notes)
- [See Also](organizations_appliance_security_intrusion_module.md#see-also)
- [Examples](organizations_appliance_security_intrusion_module.md#examples)
- [Return Values](organizations_appliance_security_intrusion_module.md#return-values)

## [Synopsis](organizations_appliance_security_intrusion_module.md#id1)
...
## [Requirements](organizations_appliance_security_intrusion_module.md#id2)
...
## [Parameters](organizations_appliance_security_intrusion_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **allowedRules**  list / elements=dictionary | Sets a list of specific SNORT signatures to allow. |
...
## [Notes](organizations_appliance_security_intrusion_module.md#id4)
...
## [See Also](organizations_appliance_security_intrusion_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateOrganizationApplianceSecurityIntrusion](https://developer.cisco.com/meraki/api-v1/#!update-organization-appliance-security-intrusion)
> :   Complete reference of the updateOrganizationApplianceSecurityIntrusion API.

## [Examples](organizations_appliance_security_intrusion_module.md#id6)
...
## [Return Values](organizations_appliance_security_intrusion_module.md#id7)
