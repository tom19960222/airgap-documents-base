...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_rollbacks module – Resource module for networks _firmwareupgrades _rollbacks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_rollbacks_module.html
fetched_at: 2026-07-28T01:33:57+00:00
---
# cisco.meraki.networks_firmware_upgrades_rollbacks module – Resource module for networks _firmwareupgrades _rollbacks
...
> see [Requirements](networks_firmware_upgrades_rollbacks_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-rollbacks-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_rollbacks`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_rollbacks_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_rollbacks_module.md#requirements)
- [Parameters](networks_firmware_upgrades_rollbacks_module.md#parameters)
- [Notes](networks_firmware_upgrades_rollbacks_module.md#notes)
- [See Also](networks_firmware_upgrades_rollbacks_module.md#see-also)
- [Examples](networks_firmware_upgrades_rollbacks_module.md#examples)
- [Return Values](networks_firmware_upgrades_rollbacks_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_rollbacks_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_rollbacks_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_rollbacks_module.md#id3)
...
| **reasons**  list / elements=dictionary | Reasons for the rollback. |
...
| **toVersion**  dictionary | Version to downgrade to (if the network has firmware flexibility). |
| **id**  string | The version ID. |

## [Notes](networks_firmware_upgrades_rollbacks_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.create_network_firmware_upgrades_rollback,
> - Paths used are post /networks/{networkId}/firmwareUpgrades/rollbacks,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_firmware_upgrades_rollbacks_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks createNetworkFirmwareUpgradesRollback](https://developer.cisco.com/meraki/api-v1/#!create-network-firmware-upgrades-rollback)
> :   Complete reference of the createNetworkFirmwareUpgradesRollback API.

## [Examples](networks_firmware_upgrades_rollbacks_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_rollbacks_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"product": "string", "reasons": [{"category": "string", "comment": "string"}], "status": "string", "time": "string", "toVersion": {"firmware": "string", "id": "string", "releaseDate": "string", "releaseType": "string", "shortName": "string"}, "upgradeBatchId": "string"}` |
