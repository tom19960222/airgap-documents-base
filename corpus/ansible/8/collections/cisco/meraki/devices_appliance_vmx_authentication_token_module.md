...
collection: ansible
version: "8"
title: "cisco.meraki.devices_appliance_vmx_authentication_token module – Resource module for devices _appliance _vmx _authenticationtoken"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_appliance_vmx_authentication_token_module.html
fetched_at: 2026-07-28T01:31:42+00:00
---
# cisco.meraki.devices_appliance_vmx_authentication_token module – Resource module for devices _appliance _vmx _authenticationtoken
...
> see [Requirements](devices_appliance_vmx_authentication_token_module.md#ansible-collections-cisco-meraki-devices-appliance-vmx-authentication-token-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_appliance_vmx_authentication_token`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_appliance_vmx_authentication_token_module.md#synopsis)
- [Requirements](devices_appliance_vmx_authentication_token_module.md#requirements)
- [Parameters](devices_appliance_vmx_authentication_token_module.md#parameters)
- [Notes](devices_appliance_vmx_authentication_token_module.md#notes)
- [See Also](devices_appliance_vmx_authentication_token_module.md#see-also)
- [Examples](devices_appliance_vmx_authentication_token_module.md#examples)
- [Return Values](devices_appliance_vmx_authentication_token_module.md#return-values)

## [Synopsis](devices_appliance_vmx_authentication_token_module.md#id1)
...
## [Requirements](devices_appliance_vmx_authentication_token_module.md#id2)
...
## [Parameters](devices_appliance_vmx_authentication_token_module.md#id3)
...
## [Notes](devices_appliance_vmx_authentication_token_module.md#id4)
...
## [See Also](devices_appliance_vmx_authentication_token_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance createDeviceApplianceVmxAuthenticationToken](https://developer.cisco.com/meraki/api-v1/#!create-device-appliance-vmx-authentication-token)
> :   Complete reference of the createDeviceApplianceVmxAuthenticationToken API.

## [Examples](devices_appliance_vmx_authentication_token_module.md#id6)
...
## [Return Values](devices_appliance_vmx_authentication_token_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"expiresAt": "string", "token": "string"}` |
