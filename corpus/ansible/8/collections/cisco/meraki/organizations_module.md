...
collection: ansible
version: "8"
title: "cisco.meraki.organizations module – Resource module for organizations"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_module.html
fetched_at: 2026-07-28T01:36:07+00:00
---
# cisco.meraki.organizations module – Resource module for organizations
...
> see [Requirements](organizations_module.md#ansible-collections-cisco-meraki-organizations-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_module.md#synopsis)
- [Requirements](organizations_module.md#requirements)
- [Parameters](organizations_module.md#parameters)
- [Notes](organizations_module.md#notes)
- [See Also](organizations_module.md#see-also)
- [Examples](organizations_module.md#examples)
- [Return Values](organizations_module.md#return-values)

## [Synopsis](organizations_module.md#id1)
...
## [Requirements](organizations_module.md#id2)
...
## [Parameters](organizations_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **api**  dictionary | API-specific settings. |
| **enabled**  boolean | If true, enable the access to the Cisco Meraki Dashboard API.  **Choices:**   - `false` - `true` |
| **management**  dictionary | Information about the organization’s management system. |
| **details**  list / elements=dictionary | Details related to organization management, possibly empty. |
...
## [Notes](organizations_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization, organizations.Organizations.delete_organization, organizations.Organizations.update_organization,
> - Paths used are post /organizations, delete /organizations/{organizationId}, put /organizations/{organizationId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganization](https://developer.cisco.com/meraki/api-v1/#!create-organization)
> :   Complete reference of the createOrganization API.
>
> [Cisco Meraki documentation for organizations deleteOrganization](https://developer.cisco.com/meraki/api-v1/#!delete-organization)
> :   Complete reference of the deleteOrganization API.
>
> [Cisco Meraki documentation for organizations updateOrganization](https://developer.cisco.com/meraki/api-v1/#!update-organization)
> :   Complete reference of the updateOrganization API.

## [Examples](organizations_module.md#id6)
...
## [Return Values](organizations_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"api": {"enabled": true}, "cloud": {"region": {"name": "string"}}, "id": "string", "licensing": {"model": "string"}, "management": {"details": [{"name": "string", "value": "string"}]}, "name": "string", "url": "string"}` |
