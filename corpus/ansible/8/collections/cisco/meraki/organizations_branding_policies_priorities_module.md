...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_branding_policies_priorities module – Resource module for organizations _brandingpolicies _priorities"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_branding_policies_priorities_module.html
fetched_at: 2026-07-28T01:36:27+00:00
---
# cisco.meraki.organizations_branding_policies_priorities module – Resource module for organizations _brandingpolicies _priorities
...
> see [Requirements](organizations_branding_policies_priorities_module.md#ansible-collections-cisco-meraki-organizations-branding-policies-priorities-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_branding_policies_priorities`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_branding_policies_priorities_module.md#synopsis)
- [Requirements](organizations_branding_policies_priorities_module.md#requirements)
- [Parameters](organizations_branding_policies_priorities_module.md#parameters)
- [Notes](organizations_branding_policies_priorities_module.md#notes)
- [See Also](organizations_branding_policies_priorities_module.md#see-also)
- [Examples](organizations_branding_policies_priorities_module.md#examples)
- [Return Values](organizations_branding_policies_priorities_module.md#return-values)

## [Synopsis](organizations_branding_policies_priorities_module.md#id1)
...
## [Requirements](organizations_branding_policies_priorities_module.md#id2)
...
## [Parameters](organizations_branding_policies_priorities_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **brandingPolicyIds**  list / elements=string | An ordered list of branding policy IDs that determines the priority order of how to apply the policies. |
...
## [Notes](organizations_branding_policies_priorities_module.md#id4)
...
## [See Also](organizations_branding_policies_priorities_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations updateOrganizationBrandingPoliciesPriorities](https://developer.cisco.com/meraki/api-v1/#!update-organization-branding-policies-priorities)
> :   Complete reference of the updateOrganizationBrandingPoliciesPriorities API.

## [Examples](organizations_branding_policies_priorities_module.md#id6)
...
## [Return Values](organizations_branding_policies_priorities_module.md#id7)
