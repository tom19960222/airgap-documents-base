...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_policy_objects_info module – Information module for organizations _policyobjects"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_policy_objects_info_module.html
fetched_at: 2026-07-28T01:37:13+00:00
---
# cisco.meraki.organizations_policy_objects_info module – Information module for organizations _policyobjects
...
> see [Requirements](organizations_policy_objects_info_module.md#ansible-collections-cisco-meraki-organizations-policy-objects-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_policy_objects_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_policy_objects_info_module.md#synopsis)
- [Requirements](organizations_policy_objects_info_module.md#requirements)
- [Parameters](organizations_policy_objects_info_module.md#parameters)
- [Notes](organizations_policy_objects_info_module.md#notes)
- [See Also](organizations_policy_objects_info_module.md#see-also)
- [Examples](organizations_policy_objects_info_module.md#examples)
- [Return Values](organizations_policy_objects_info_module.md#return-values)

## [Synopsis](organizations_policy_objects_info_module.md#id1)
...
## [Requirements](organizations_policy_objects_info_module.md#id2)
...
## [Parameters](organizations_policy_objects_info_module.md#id3)
...
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 10 - 5000. Default is 5000. |
...
## [Notes](organizations_policy_objects_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_policy_object, organizations.Organizations.get_organization_policy_objects,
> - Paths used are get /organizations/{organizationId}/policyObjects, get /organizations/{organizationId}/policyObjects/{policyObjectId},
> - Supports `check_mode`
...
## [See Also](organizations_policy_objects_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationPolicyObject](https://developer.cisco.com/meraki/api-v1/#!get-organization-policy-object)
> :   Complete reference of the getOrganizationPolicyObject API.
>
> [Cisco Meraki documentation for organizations getOrganizationPolicyObjects](https://developer.cisco.com/meraki/api-v1/#!get-organization-policy-objects)
> :   Complete reference of the getOrganizationPolicyObjects API.

## [Examples](organizations_policy_objects_info_module.md#id6)
...
## [Return Values](organizations_policy_objects_info_module.md#id7)
