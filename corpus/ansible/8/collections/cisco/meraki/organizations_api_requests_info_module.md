...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_api_requests_info module – Information module for organizations _apirequests"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_api_requests_info_module.html
...
> see [Requirements](organizations_api_requests_info_module.md#ansible-collections-cisco-meraki-organizations-api-requests-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_api_requests_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_api_requests_info_module.md#synopsis)
- [Requirements](organizations_api_requests_info_module.md#requirements)
- [Parameters](organizations_api_requests_info_module.md#parameters)
- [Notes](organizations_api_requests_info_module.md#notes)
- [See Also](organizations_api_requests_info_module.md#see-also)
- [Examples](organizations_api_requests_info_module.md#examples)
- [Return Values](organizations_api_requests_info_module.md#return-values)

## [Synopsis](organizations_api_requests_info_module.md#id1)
...
## [Requirements](organizations_api_requests_info_module.md#id2)
...
## [Parameters](organizations_api_requests_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **adminId**  string | AdminId query parameter. Filter the results by the ID of the admin who made the API requests. |
...
| **operationIds**  list / elements=string | OperationIds query parameter. Filter the results by one or more operation IDs for the API request. |
...
| **responseCode**  integer | ResponseCode query parameter. Filter the results by the response code of the API requests. |
| **sourceIp**  string | SourceIp query parameter. Filter the results by the IP address of the originating API request. |
...
| **userAgent**  string | UserAgent query parameter. Filter the results by the user agent string of the API request. |
| **version**  integer | Version query parameter. Filter the results by the API version of the API request. |

## [Notes](organizations_api_requests_info_module.md#id4)
...
## [See Also](organizations_api_requests_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationApiRequests](https://developer.cisco.com/meraki/api-v1/#!get-organization-api-requests)
> :   Complete reference of the getOrganizationApiRequests API.

## [Examples](organizations_api_requests_info_module.md#id6)
...
## [Return Values](organizations_api_requests_info_module.md#id7)
