...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_devices_connection_stats_info module – Information module for networks _wireless _devices _connectionstats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_devices_connection_stats_info_module.html
fetched_at: 2026-07-28T01:35:41+00:00
---
# cisco.meraki.networks_wireless_devices_connection_stats_info module – Information module for networks _wireless _devices _connectionstats
...
> see [Requirements](networks_wireless_devices_connection_stats_info_module.md#ansible-collections-cisco-meraki-networks-wireless-devices-connection-stats-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_devices_connection_stats_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_devices_connection_stats_info_module.md#synopsis)
- [Requirements](networks_wireless_devices_connection_stats_info_module.md#requirements)
- [Parameters](networks_wireless_devices_connection_stats_info_module.md#parameters)
- [Notes](networks_wireless_devices_connection_stats_info_module.md#notes)
- [See Also](networks_wireless_devices_connection_stats_info_module.md#see-also)
- [Examples](networks_wireless_devices_connection_stats_info_module.md#examples)
- [Return Values](networks_wireless_devices_connection_stats_info_module.md#return-values)

## [Synopsis](networks_wireless_devices_connection_stats_info_module.md#id1)
...
## [Requirements](networks_wireless_devices_connection_stats_info_module.md#id2)
...
## [Parameters](networks_wireless_devices_connection_stats_info_module.md#id3)
...
| **ssid**  integer | Ssid query parameter. Filter results by SSID. |
...
| **timespan**  float | Timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 7 days. |
| **vlan**  integer | Vlan query parameter. Filter results by VLAN. |

## [Notes](networks_wireless_devices_connection_stats_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_devices_connection_stats,
> - Paths used are get /networks/{networkId}/wireless/devices/connectionStats,
> - Supports `check_mode`
...
## [See Also](networks_wireless_devices_connection_stats_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessDevicesConnectionStats](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-devices-connection-stats)
> :   Complete reference of the getNetworkWirelessDevicesConnectionStats API.

## [Examples](networks_wireless_devices_connection_stats_info_module.md#id6)
...
## [Return Values](networks_wireless_devices_connection_stats_info_module.md#id7)
