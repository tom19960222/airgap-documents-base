...
collection: ansible
version: "8"
title: "cisco.meraki.devices module – Resource module for devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_module.html
fetched_at: 2026-07-28T01:31:39+00:00
---
# cisco.meraki.devices module – Resource module for devices
...
> see [Requirements](devices_module.md#ansible-collections-cisco-meraki-devices-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_module.md#synopsis)
- [Requirements](devices_module.md#requirements)
- [Parameters](devices_module.md#parameters)
- [Notes](devices_module.md#notes)
- [See Also](devices_module.md#see-also)
- [Examples](devices_module.md#examples)
- [Return Values](devices_module.md#return-values)

## [Synopsis](devices_module.md#id1)
...
## [Requirements](devices_module.md#id2)
...
## [Parameters](devices_module.md#id3)
...
| **moveMapMarker**  boolean | Whether or not to set the latitude and longitude of a device based on the new address. Only applies when lat and lng are not specified.  **Choices:**   - `false` - `true` |
| **name**  string | The name of a device. |
| **notes**  string | The notes for the device. String. Limited to 255 characters. |
| **serial**  string | Devices’s serial. |
...
| **tags**  list / elements=string | The list of tags of a device. |

## [Notes](devices_module.md#id4)
...
## [See Also](devices_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDevice](https://developer.cisco.com/meraki/api-v1/#!update-device)
> :   Complete reference of the updateDevice API.

## [Examples](devices_module.md#id6)
...
## [Return Values](devices_module.md#id7)
