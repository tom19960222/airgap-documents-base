...
collection: ansible
version: "8"
title: "cisco.meraki.networks_syslog_servers_info module – Information module for networks _syslogservers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_syslog_servers_info_module.html
fetched_at: 2026-07-28T01:35:22+00:00
---
# cisco.meraki.networks_syslog_servers_info module – Information module for networks _syslogservers
...
> see [Requirements](networks_syslog_servers_info_module.md#ansible-collections-cisco-meraki-networks-syslog-servers-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_syslog_servers_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_syslog_servers_info_module.md#synopsis)
- [Requirements](networks_syslog_servers_info_module.md#requirements)
- [Parameters](networks_syslog_servers_info_module.md#parameters)
- [Notes](networks_syslog_servers_info_module.md#notes)
- [See Also](networks_syslog_servers_info_module.md#see-also)
- [Examples](networks_syslog_servers_info_module.md#examples)
- [Return Values](networks_syslog_servers_info_module.md#return-values)

## [Synopsis](networks_syslog_servers_info_module.md#id1)
...
## [Requirements](networks_syslog_servers_info_module.md#id2)
...
## [Parameters](networks_syslog_servers_info_module.md#id3)
...
## [Notes](networks_syslog_servers_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_syslog_servers,
> - Paths used are get /networks/{networkId}/syslogServers,
> - Supports `check_mode`
...
## [See Also](networks_syslog_servers_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkSyslogServers](https://developer.cisco.com/meraki/api-v1/#!get-network-syslog-servers)
> :   Complete reference of the getNetworkSyslogServers API.

## [Examples](networks_syslog_servers_info_module.md#id6)
...
## [Return Values](networks_syslog_servers_info_module.md#id7)
