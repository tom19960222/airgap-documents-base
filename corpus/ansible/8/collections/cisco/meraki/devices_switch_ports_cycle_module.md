...
collection: ansible
version: "8"
title: "cisco.meraki.devices_switch_ports_cycle module – Resource module for devices _switch _ports _cycle"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_switch_ports_cycle_module.html
fetched_at: 2026-07-28T01:32:05+00:00
---
# cisco.meraki.devices_switch_ports_cycle module – Resource module for devices _switch _ports _cycle
...
> see [Requirements](devices_switch_ports_cycle_module.md#ansible-collections-cisco-meraki-devices-switch-ports-cycle-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_switch_ports_cycle`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_switch_ports_cycle_module.md#synopsis)
- [Requirements](devices_switch_ports_cycle_module.md#requirements)
- [Parameters](devices_switch_ports_cycle_module.md#parameters)
- [Notes](devices_switch_ports_cycle_module.md#notes)
- [See Also](devices_switch_ports_cycle_module.md#see-also)
- [Examples](devices_switch_ports_cycle_module.md#examples)
- [Return Values](devices_switch_ports_cycle_module.md#return-values)

## [Synopsis](devices_switch_ports_cycle_module.md#id1)
...
## [Requirements](devices_switch_ports_cycle_module.md#id2)
...
## [Parameters](devices_switch_ports_cycle_module.md#id3)
...
| **ports**  list / elements=string | List of switch ports. |
| **serial**  string | Serial path parameter. |

## [Notes](devices_switch_ports_cycle_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.cycle_device_switch_ports,
> - Paths used are post /devices/{serial}/switch/ports/cycle,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_switch_ports_cycle_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices cycleDeviceSwitchPorts](https://developer.cisco.com/meraki/api-v1/#!cycle-device-switch-ports)
> :   Complete reference of the cycleDeviceSwitchPorts API.

## [Examples](devices_switch_ports_cycle_module.md#id6)
...
## [Return Values](devices_switch_ports_cycle_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"ports": ["string"]}` |
