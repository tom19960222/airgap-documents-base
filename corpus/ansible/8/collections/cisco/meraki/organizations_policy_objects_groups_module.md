...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_policy_objects_groups module – Resource module for organizations _policyobjects _groups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_policy_objects_groups_module.html
fetched_at: 2026-07-28T01:37:11+00:00
---
# cisco.meraki.organizations_policy_objects_groups module – Resource module for organizations _policyobjects _groups
...
> see [Requirements](organizations_policy_objects_groups_module.md#ansible-collections-cisco-meraki-organizations-policy-objects-groups-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_policy_objects_groups`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_policy_objects_groups_module.md#synopsis)
- [Requirements](organizations_policy_objects_groups_module.md#requirements)
- [Parameters](organizations_policy_objects_groups_module.md#parameters)
- [Notes](organizations_policy_objects_groups_module.md#notes)
- [See Also](organizations_policy_objects_groups_module.md#see-also)
- [Examples](organizations_policy_objects_groups_module.md#examples)
- [Return Values](organizations_policy_objects_groups_module.md#return-values)

## [Synopsis](organizations_policy_objects_groups_module.md#id1)
...
## [Requirements](organizations_policy_objects_groups_module.md#id2)
...
## [Parameters](organizations_policy_objects_groups_module.md#id3)
...
| **objectIds**  list / elements=integer | A list of Policy Object ID’s that this NetworkObjectGroup should be associated to (note these ID’s will replace the existing associated Policy Objects). |
...
## [Notes](organizations_policy_objects_groups_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization_policy_objects_group, organizations.Organizations.delete_organization_policy_objects_group, organizations.Organizations.update_organization_policy_objects_group,
> - Paths used are post /organizations/{organizationId}/policyObjects/groups, delete /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId}, put /organizations/{organizationId}/policyObjects/groups/{policyObjectGroupId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_policy_objects_groups_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationPolicyObjectsGroup](https://developer.cisco.com/meraki/api-v1/#!create-organization-policy-objects-group)
> :   Complete reference of the createOrganizationPolicyObjectsGroup API.
>
> [Cisco Meraki documentation for organizations deleteOrganizationPolicyObjectsGroup](https://developer.cisco.com/meraki/api-v1/#!delete-organization-policy-objects-group)
> :   Complete reference of the deleteOrganizationPolicyObjectsGroup API.
>
> [Cisco Meraki documentation for organizations updateOrganizationPolicyObjectsGroup](https://developer.cisco.com/meraki/api-v1/#!update-organization-policy-objects-group)
> :   Complete reference of the updateOrganizationPolicyObjectsGroup API.

## [Examples](organizations_policy_objects_groups_module.md#id6)
...
## [Return Values](organizations_policy_objects_groups_module.md#id7)
