...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_alternate_management_interface module – Resource module for networks _switch _alternatemanagementinterface"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_alternate_management_interface_module.html
fetched_at: 2026-07-28T01:34:51+00:00
---
# cisco.meraki.networks_switch_alternate_management_interface module – Resource module for networks _switch _alternatemanagementinterface
...
> see [Requirements](networks_switch_alternate_management_interface_module.md#ansible-collections-cisco-meraki-networks-switch-alternate-management-interface-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_alternate_management_interface`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_alternate_management_interface_module.md#synopsis)
- [Requirements](networks_switch_alternate_management_interface_module.md#requirements)
- [Parameters](networks_switch_alternate_management_interface_module.md#parameters)
- [Notes](networks_switch_alternate_management_interface_module.md#notes)
- [See Also](networks_switch_alternate_management_interface_module.md#see-also)
- [Examples](networks_switch_alternate_management_interface_module.md#examples)
- [Return Values](networks_switch_alternate_management_interface_module.md#return-values)

## [Synopsis](networks_switch_alternate_management_interface_module.md#id1)
...
## [Requirements](networks_switch_alternate_management_interface_module.md#id2)
...
## [Parameters](networks_switch_alternate_management_interface_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | Boolean value to enable or disable AMI configuration. If enabled, VLAN and protocols must be set.  **Choices:**   - `false` - `true` |
...
| **protocols**  list / elements=string | Can be one or more of the following values ‘radius’, ‘snmp’ or ‘syslog’. |
| **switches**  list / elements=dictionary | Array of switch serial number and IP assignment. If parameter is present, it cannot have empty body. Note switches parameter is not applicable for template networks, in other words, do not put ‘switches’ in the body when updating template networks. Also, an empty ‘switches’ array will remove all previous assignments. |
...
| **subnetMask**  string | Switch subnet mask must be in IP format. Only and must be specified for Polaris switches. |
| **vlanId**  integer | Alternate management VLAN, must be between 1 and 4094. |

## [Notes](networks_switch_alternate_management_interface_module.md#id4)
...
## [See Also](networks_switch_alternate_management_interface_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchAlternateManagementInterface](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-alternate-management-interface)
> :   Complete reference of the updateNetworkSwitchAlternateManagementInterface API.

## [Examples](networks_switch_alternate_management_interface_module.md#id6)
...
## [Return Values](networks_switch_alternate_management_interface_module.md#id7)
