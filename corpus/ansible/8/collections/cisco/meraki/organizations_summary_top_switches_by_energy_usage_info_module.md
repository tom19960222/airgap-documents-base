...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_summary_top_switches_by_energy_usage_info module – Information module for organizations _summary _top _switches _byenergyusage"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_summary_top_switches_by_energy_usage_info_module.html
fetched_at: 2026-07-28T01:37:27+00:00
---
# cisco.meraki.organizations_summary_top_switches_by_energy_usage_info module – Information module for organizations _summary _top _switches _byenergyusage
...
> see [Requirements](organizations_summary_top_switches_by_energy_usage_info_module.md#ansible-collections-cisco-meraki-organizations-summary-top-switches-by-energy-usage-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_summary_top_switches_by_energy_usage_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_summary_top_switches_by_energy_usage_info_module.md#synopsis)
- [Requirements](organizations_summary_top_switches_by_energy_usage_info_module.md#requirements)
- [Parameters](organizations_summary_top_switches_by_energy_usage_info_module.md#parameters)
- [Notes](organizations_summary_top_switches_by_energy_usage_info_module.md#notes)
- [See Also](organizations_summary_top_switches_by_energy_usage_info_module.md#see-also)
- [Examples](organizations_summary_top_switches_by_energy_usage_info_module.md#examples)
- [Return Values](organizations_summary_top_switches_by_energy_usage_info_module.md#return-values)

## [Synopsis](organizations_summary_top_switches_by_energy_usage_info_module.md#id1)
...
## [Requirements](organizations_summary_top_switches_by_energy_usage_info_module.md#id2)
...
## [Parameters](organizations_summary_top_switches_by_energy_usage_info_module.md#id3)
...
## [Notes](organizations_summary_top_switches_by_energy_usage_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_summary_top_switches_by_energy_usage,
> - Paths used are get /organizations/{organizationId}/summary/top/switches/byEnergyUsage,
> - Supports `check_mode`
...
## [See Also](organizations_summary_top_switches_by_energy_usage_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationSummaryTopSwitchesByEnergyUsage](https://developer.cisco.com/meraki/api-v1/#!get-organization-summary-top-switches-by-energy-usage)
> :   Complete reference of the getOrganizationSummaryTopSwitchesByEnergyUsage API.

## [Examples](organizations_summary_top_switches_by_energy_usage_info_module.md#id6)
...
## [Return Values](organizations_summary_top_switches_by_energy_usage_info_module.md#id7)
