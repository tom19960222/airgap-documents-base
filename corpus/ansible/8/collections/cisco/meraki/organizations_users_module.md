...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_users module – Resource module for organizations _users"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_users_module.html
fetched_at: 2026-07-28T01:37:30+00:00
---
# cisco.meraki.organizations_users module – Resource module for organizations _users
...
> see [Requirements](organizations_users_module.md#ansible-collections-cisco-meraki-organizations-users-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_users`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_users_module.md#synopsis)
- [Requirements](organizations_users_module.md#requirements)
- [Parameters](organizations_users_module.md#parameters)
- [Notes](organizations_users_module.md#notes)
- [See Also](organizations_users_module.md#see-also)
- [Examples](organizations_users_module.md#examples)
- [Return Values](organizations_users_module.md#return-values)

## [Synopsis](organizations_users_module.md#id1)
...
## [Requirements](organizations_users_module.md#id2)
...
## [Parameters](organizations_users_module.md#id3)
...
## [Notes](organizations_users_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.delete_organization_user,
> - Paths used are delete /organizations/{organizationId}/users/{userId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_users_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations deleteOrganizationUser](https://developer.cisco.com/meraki/api-v1/#!delete-organization-user)
> :   Complete reference of the deleteOrganizationUser API.

## [Examples](organizations_users_module.md#id6)
...
## [Return Values](organizations_users_module.md#id7)
