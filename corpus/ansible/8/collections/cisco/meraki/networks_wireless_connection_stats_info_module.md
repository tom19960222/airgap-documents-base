...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_connection_stats_info module – Information module for networks _wireless _connectionstats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_connection_stats_info_module.html
fetched_at: 2026-07-28T01:35:40+00:00
---
# cisco.meraki.networks_wireless_connection_stats_info module – Information module for networks _wireless _connectionstats
...
> see [Requirements](networks_wireless_connection_stats_info_module.md#ansible-collections-cisco-meraki-networks-wireless-connection-stats-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_connection_stats_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_connection_stats_info_module.md#synopsis)
- [Requirements](networks_wireless_connection_stats_info_module.md#requirements)
- [Parameters](networks_wireless_connection_stats_info_module.md#parameters)
- [Notes](networks_wireless_connection_stats_info_module.md#notes)
- [See Also](networks_wireless_connection_stats_info_module.md#see-also)
- [Examples](networks_wireless_connection_stats_info_module.md#examples)
- [Return Values](networks_wireless_connection_stats_info_module.md#return-values)

## [Synopsis](networks_wireless_connection_stats_info_module.md#id1)
...
## [Requirements](networks_wireless_connection_stats_info_module.md#id2)
...
## [Parameters](networks_wireless_connection_stats_info_module.md#id3)
...
## [Notes](networks_wireless_connection_stats_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_connection_stats,
> - Paths used are get /networks/{networkId}/wireless/connectionStats,
> - Supports `check_mode`
...
## [See Also](networks_wireless_connection_stats_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessConnectionStats](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-connection-stats)
> :   Complete reference of the getNetworkWirelessConnectionStats API.

## [Examples](networks_wireless_connection_stats_info_module.md#id6)
...
## [Return Values](networks_wireless_connection_stats_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"assoc": 0, "auth": 0, "dhcp": 0, "dns": 0, "success": 0}` |
