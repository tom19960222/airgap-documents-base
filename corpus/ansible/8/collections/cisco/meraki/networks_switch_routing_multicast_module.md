...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_routing_multicast module – Resource module for networks _switch _routing _multicast"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_routing_multicast_module.html
fetched_at: 2026-07-28T01:35:05+00:00
---
# cisco.meraki.networks_switch_routing_multicast module – Resource module for networks _switch _routing _multicast
...
> see [Requirements](networks_switch_routing_multicast_module.md#ansible-collections-cisco-meraki-networks-switch-routing-multicast-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_routing_multicast`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_routing_multicast_module.md#synopsis)
- [Requirements](networks_switch_routing_multicast_module.md#requirements)
- [Parameters](networks_switch_routing_multicast_module.md#parameters)
- [Notes](networks_switch_routing_multicast_module.md#notes)
- [See Also](networks_switch_routing_multicast_module.md#see-also)
- [Examples](networks_switch_routing_multicast_module.md#examples)
- [Return Values](networks_switch_routing_multicast_module.md#return-values)

## [Synopsis](networks_switch_routing_multicast_module.md#id1)
...
## [Requirements](networks_switch_routing_multicast_module.md#id2)
...
## [Parameters](networks_switch_routing_multicast_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **defaultSettings**  dictionary | Default multicast setting for entire network. IGMP snooping and Flood unknown multicast traffic settings are enabled by default. |
| **floodUnknownMulticastTrafficEnabled**  boolean | Flood unknown multicast traffic setting for entire network.  **Choices:**   - `false` - `true` |
| **igmpSnoopingEnabled**  boolean | IGMP snooping setting for entire network.  **Choices:**   - `false` - `true` |
...
| **overrides**  list / elements=dictionary | Array of paired switches/stacks/profiles and corresponding multicast settings. An empty array will clear the multicast settings. |
| **floodUnknownMulticastTrafficEnabled**  boolean | Flood unknown multicast traffic setting for switches, switch stacks or switch profiles.  **Choices:**   - `false` - `true` |
| **igmpSnoopingEnabled**  boolean | IGMP snooping setting for switches, switch stacks or switch profiles.  **Choices:**   - `false` - `true` |
| **stacks**  list / elements=string | List of switch stack ids for non-template network. |
| **switches**  list / elements=string | List of switch serials for non-template network. |
| **switchProfiles**  list / elements=string | List of switch profiles ids for template network. |

## [Notes](networks_switch_routing_multicast_module.md#id4)
...
## [See Also](networks_switch_routing_multicast_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchRoutingMulticast](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-routing-multicast)
> :   Complete reference of the updateNetworkSwitchRoutingMulticast API.

## [Examples](networks_switch_routing_multicast_module.md#id6)
...
## [Return Values](networks_switch_routing_multicast_module.md#id7)
