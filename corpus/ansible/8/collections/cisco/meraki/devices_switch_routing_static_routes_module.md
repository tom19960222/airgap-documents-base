...
collection: ansible
version: "8"
title: "cisco.meraki.devices_switch_routing_static_routes module – Resource module for devices _switch _routing _staticroutes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_switch_routing_static_routes_module.html
fetched_at: 2026-07-28T01:32:10+00:00
---
# cisco.meraki.devices_switch_routing_static_routes module – Resource module for devices _switch _routing _staticroutes
...
> see [Requirements](devices_switch_routing_static_routes_module.md#ansible-collections-cisco-meraki-devices-switch-routing-static-routes-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_switch_routing_static_routes`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_switch_routing_static_routes_module.md#synopsis)
- [Requirements](devices_switch_routing_static_routes_module.md#requirements)
- [Parameters](devices_switch_routing_static_routes_module.md#parameters)
- [Notes](devices_switch_routing_static_routes_module.md#notes)
- [See Also](devices_switch_routing_static_routes_module.md#see-also)
- [Examples](devices_switch_routing_static_routes_module.md#examples)
- [Return Values](devices_switch_routing_static_routes_module.md#return-values)

## [Synopsis](devices_switch_routing_static_routes_module.md#id1)
...
## [Requirements](devices_switch_routing_static_routes_module.md#id2)
...
## [Parameters](devices_switch_routing_static_routes_module.md#id3)
...
## [Notes](devices_switch_routing_static_routes_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.create_device_switch_routing_static_route, devices.Devices.delete_device_switch_routing_static_route, devices.Devices.update_device_switch_routing_static_route,
> - Paths used are post /devices/{serial}/switch/routing/staticRoutes, delete /devices/{serial}/switch/routing/staticRoutes/{staticRouteId}, put /devices/{serial}/switch/routing/staticRoutes/{staticRouteId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](devices_switch_routing_static_routes_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices createDeviceSwitchRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!create-device-switch-routing-static-route)
> :   Complete reference of the createDeviceSwitchRoutingStaticRoute API.
>
> [Cisco Meraki documentation for devices deleteDeviceSwitchRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!delete-device-switch-routing-static-route)
> :   Complete reference of the deleteDeviceSwitchRoutingStaticRoute API.
>
> [Cisco Meraki documentation for devices updateDeviceSwitchRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!update-device-switch-routing-static-route)
> :   Complete reference of the updateDeviceSwitchRoutingStaticRoute API.

## [Examples](devices_switch_routing_static_routes_module.md#id6)
...
## [Return Values](devices_switch_routing_static_routes_module.md#id7)
