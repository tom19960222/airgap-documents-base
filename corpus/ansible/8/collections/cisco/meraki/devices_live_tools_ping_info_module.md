...
collection: ansible
version: "8"
title: "cisco.meraki.devices_live_tools_ping_info module – Information module for devices _livetools _ping"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_live_tools_ping_info_module.html
fetched_at: 2026-07-28T01:32:00+00:00
---
# cisco.meraki.devices_live_tools_ping_info module – Information module for devices _livetools _ping
...
> see [Requirements](devices_live_tools_ping_info_module.md#ansible-collections-cisco-meraki-devices-live-tools-ping-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_live_tools_ping_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_live_tools_ping_info_module.md#synopsis)
- [Requirements](devices_live_tools_ping_info_module.md#requirements)
- [Parameters](devices_live_tools_ping_info_module.md#parameters)
- [Notes](devices_live_tools_ping_info_module.md#notes)
- [See Also](devices_live_tools_ping_info_module.md#see-also)
- [Examples](devices_live_tools_ping_info_module.md#examples)
- [Return Values](devices_live_tools_ping_info_module.md#return-values)

## [Synopsis](devices_live_tools_ping_info_module.md#id1)
...
## [Requirements](devices_live_tools_ping_info_module.md#id2)
...
## [Parameters](devices_live_tools_ping_info_module.md#id3)
...
## [Notes](devices_live_tools_ping_info_module.md#id4)
...
## [See Also](devices_live_tools_ping_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceLiveToolsPing](https://developer.cisco.com/meraki/api-v1/#!get-device-live-tools-ping)
> :   Complete reference of the getDeviceLiveToolsPing API.

## [Examples](devices_live_tools_ping_info_module.md#id6)
...
## [Return Values](devices_live_tools_ping_info_module.md#id7)
