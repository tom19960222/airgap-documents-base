...
collection: ansible
version: "8"
title: "cisco.meraki.networks_clients_overview_info module – Information module for networks _clients _overview"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_clients_overview_info_module.html
fetched_at: 2026-07-28T01:33:48+00:00
---
# cisco.meraki.networks_clients_overview_info module – Information module for networks _clients _overview
...
> see [Requirements](networks_clients_overview_info_module.md#ansible-collections-cisco-meraki-networks-clients-overview-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_clients_overview_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_clients_overview_info_module.md#synopsis)
- [Requirements](networks_clients_overview_info_module.md#requirements)
- [Parameters](networks_clients_overview_info_module.md#parameters)
- [Notes](networks_clients_overview_info_module.md#notes)
- [See Also](networks_clients_overview_info_module.md#see-also)
- [Examples](networks_clients_overview_info_module.md#examples)
- [Return Values](networks_clients_overview_info_module.md#return-values)

## [Synopsis](networks_clients_overview_info_module.md#id1)
...
## [Requirements](networks_clients_overview_info_module.md#id2)
...
## [Parameters](networks_clients_overview_info_module.md#id3)
...
| **resolution**  integer | Resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are 7200, 86400, 604800, 2592000. The default is 604800. |
...
## [Notes](networks_clients_overview_info_module.md#id4)
...
## [See Also](networks_clients_overview_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkClientsOverview](https://developer.cisco.com/meraki/api-v1/#!get-network-clients-overview)
> :   Complete reference of the getNetworkClientsOverview API.

## [Examples](networks_clients_overview_info_module.md#id6)
...
## [Return Values](networks_clients_overview_info_module.md#id7)
