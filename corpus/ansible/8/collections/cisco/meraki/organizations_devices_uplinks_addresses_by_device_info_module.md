...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_devices_uplinks_addresses_by_device_info module – Information module for organizations _devices _uplinks _addresses _bydevice"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_devices_uplinks_addresses_by_device_info_module.html
fetched_at: 2026-07-28T01:36:45+00:00
---
# cisco.meraki.organizations_devices_uplinks_addresses_by_device_info module – Information module for organizations _devices _uplinks _addresses _bydevice
...
> see [Requirements](organizations_devices_uplinks_addresses_by_device_info_module.md#ansible-collections-cisco-meraki-organizations-devices-uplinks-addresses-by-device-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_devices_uplinks_addresses_by_device_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_devices_uplinks_addresses_by_device_info_module.md#synopsis)
- [Requirements](organizations_devices_uplinks_addresses_by_device_info_module.md#requirements)
- [Parameters](organizations_devices_uplinks_addresses_by_device_info_module.md#parameters)
- [Notes](organizations_devices_uplinks_addresses_by_device_info_module.md#notes)
- [See Also](organizations_devices_uplinks_addresses_by_device_info_module.md#see-also)
- [Examples](organizations_devices_uplinks_addresses_by_device_info_module.md#examples)
- [Return Values](organizations_devices_uplinks_addresses_by_device_info_module.md#return-values)

## [Synopsis](organizations_devices_uplinks_addresses_by_device_info_module.md#id1)
...
## [Requirements](organizations_devices_uplinks_addresses_by_device_info_module.md#id2)
...
## [Parameters](organizations_devices_uplinks_addresses_by_device_info_module.md#id3)
...
| **networkIds**  list / elements=string | NetworkIds query parameter. Optional parameter to filter device uplinks by network ID. This filter uses multiple exact matches. |
...
| **productTypes**  list / elements=string | ProductTypes query parameter. Optional parameter to filter device uplinks by device product types. This filter uses multiple exact matches. |
...
## [Notes](organizations_devices_uplinks_addresses_by_device_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_devices_uplinks_addresses_by_device,
> - Paths used are get /organizations/{organizationId}/devices/uplinks/addresses/byDevice,
> - Supports `check_mode`
...
## [See Also](organizations_devices_uplinks_addresses_by_device_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationDevicesUplinksAddressesByDevice](https://developer.cisco.com/meraki/api-v1/#!get-organization-devices-uplinks-addresses-by-device)
> :   Complete reference of the getOrganizationDevicesUplinksAddressesByDevice API.

## [Examples](organizations_devices_uplinks_addresses_by_device_info_module.md#id6)
...
## [Return Values](organizations_devices_uplinks_addresses_by_device_info_module.md#id7)
