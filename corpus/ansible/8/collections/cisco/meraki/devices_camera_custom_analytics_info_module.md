...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_custom_analytics_info module – Information module for devices _camera _customanalytics"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_custom_analytics_info_module.html
fetched_at: 2026-07-28T01:31:45+00:00
---
# cisco.meraki.devices_camera_custom_analytics_info module – Information module for devices _camera _customanalytics
...
> see [Requirements](devices_camera_custom_analytics_info_module.md#ansible-collections-cisco-meraki-devices-camera-custom-analytics-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_custom_analytics_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_custom_analytics_info_module.md#synopsis)
- [Requirements](devices_camera_custom_analytics_info_module.md#requirements)
- [Parameters](devices_camera_custom_analytics_info_module.md#parameters)
- [Notes](devices_camera_custom_analytics_info_module.md#notes)
- [See Also](devices_camera_custom_analytics_info_module.md#see-also)
- [Examples](devices_camera_custom_analytics_info_module.md#examples)
- [Return Values](devices_camera_custom_analytics_info_module.md#return-values)

## [Synopsis](devices_camera_custom_analytics_info_module.md#id1)
...
## [Requirements](devices_camera_custom_analytics_info_module.md#id2)
...
## [Parameters](devices_camera_custom_analytics_info_module.md#id3)
...
## [Notes](devices_camera_custom_analytics_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_camera_custom_analytics,
...
## [See Also](devices_camera_custom_analytics_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceCameraCustomAnalytics](https://developer.cisco.com/meraki/api-v1/#!get-device-camera-custom-analytics)
> :   Complete reference of the getDeviceCameraCustomAnalytics API.

## [Examples](devices_camera_custom_analytics_info_module.md#id6)
...
## [Return Values](devices_camera_custom_analytics_info_module.md#id7)
