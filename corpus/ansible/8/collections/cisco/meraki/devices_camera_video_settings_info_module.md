...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_video_settings_info module – Information module for devices _camera _video _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_video_settings_info_module.html
fetched_at: 2026-07-28T01:31:51+00:00
---
# cisco.meraki.devices_camera_video_settings_info module – Information module for devices _camera _video _settings
...
> see [Requirements](devices_camera_video_settings_info_module.md#ansible-collections-cisco-meraki-devices-camera-video-settings-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_video_settings_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_video_settings_info_module.md#synopsis)
- [Requirements](devices_camera_video_settings_info_module.md#requirements)
- [Parameters](devices_camera_video_settings_info_module.md#parameters)
- [Notes](devices_camera_video_settings_info_module.md#notes)
- [See Also](devices_camera_video_settings_info_module.md#see-also)
- [Examples](devices_camera_video_settings_info_module.md#examples)
- [Return Values](devices_camera_video_settings_info_module.md#return-values)

## [Synopsis](devices_camera_video_settings_info_module.md#id1)
...
## [Requirements](devices_camera_video_settings_info_module.md#id2)
...
## [Parameters](devices_camera_video_settings_info_module.md#id3)
...
## [Notes](devices_camera_video_settings_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_camera_video_settings,
> - Paths used are get /devices/{serial}/camera/video/settings,
> - Supports `check_mode`
...
## [See Also](devices_camera_video_settings_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceCameraVideoSettings](https://developer.cisco.com/meraki/api-v1/#!get-device-camera-video-settings)
> :   Complete reference of the getDeviceCameraVideoSettings API.

## [Examples](devices_camera_video_settings_info_module.md#id6)
...
## [Return Values](devices_camera_video_settings_info_module.md#id7)
