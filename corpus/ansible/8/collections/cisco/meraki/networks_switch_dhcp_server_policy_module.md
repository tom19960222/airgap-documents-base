...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_dhcp_server_policy module – Resource module for networks _switch _dhcpserverpolicy"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_dhcp_server_policy_module.html
fetched_at: 2026-07-28T01:34:53+00:00
---
# cisco.meraki.networks_switch_dhcp_server_policy module – Resource module for networks _switch _dhcpserverpolicy
...
> see [Requirements](networks_switch_dhcp_server_policy_module.md#ansible-collections-cisco-meraki-networks-switch-dhcp-server-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_dhcp_server_policy`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_dhcp_server_policy_module.md#synopsis)
- [Requirements](networks_switch_dhcp_server_policy_module.md#requirements)
- [Parameters](networks_switch_dhcp_server_policy_module.md#parameters)
- [Notes](networks_switch_dhcp_server_policy_module.md#notes)
- [See Also](networks_switch_dhcp_server_policy_module.md#see-also)
- [Examples](networks_switch_dhcp_server_policy_module.md#examples)
- [Return Values](networks_switch_dhcp_server_policy_module.md#return-values)

## [Synopsis](networks_switch_dhcp_server_policy_module.md#id1)
...
## [Requirements](networks_switch_dhcp_server_policy_module.md#id2)
...
## [Parameters](networks_switch_dhcp_server_policy_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **alerts**  dictionary | Alert settings for DHCP servers. |
| **email**  dictionary | Email alert settings for DHCP servers. |
| **enabled**  boolean | When enabled, send an email if a new DHCP server is seen. Default value is false.  **Choices:**   - `false` - `true` |
...
| **enabled**  boolean | Enable or disable Dynamic ARP Inspection on the network. Default value is false.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_switch_dhcp_server_policy_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.update_network_switch_dhcp_server_policy,
> - Paths used are put /networks/{networkId}/switch/dhcpServerPolicy,
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_dhcp_server_policy_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchDhcpServerPolicy](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-dhcp-server-policy)
> :   Complete reference of the updateNetworkSwitchDhcpServerPolicy API.

## [Examples](networks_switch_dhcp_server_policy_module.md#id6)
...
## [Return Values](networks_switch_dhcp_server_policy_module.md#id7)
