...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_clients_search_info module – Information module for organizations _clients _search"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_clients_search_info_module.html
fetched_at: 2026-07-28T01:36:35+00:00
---
# cisco.meraki.organizations_clients_search_info module – Information module for organizations _clients _search
...
> see [Requirements](organizations_clients_search_info_module.md#ansible-collections-cisco-meraki-organizations-clients-search-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_clients_search_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_clients_search_info_module.md#synopsis)
- [Requirements](organizations_clients_search_info_module.md#requirements)
- [Parameters](organizations_clients_search_info_module.md#parameters)
- [Notes](organizations_clients_search_info_module.md#notes)
- [See Also](organizations_clients_search_info_module.md#see-also)
- [Examples](organizations_clients_search_info_module.md#examples)
- [Return Values](organizations_clients_search_info_module.md#return-values)

## [Synopsis](organizations_clients_search_info_module.md#id1)
...
## [Requirements](organizations_clients_search_info_module.md#id2)
...
## [Parameters](organizations_clients_search_info_module.md#id3)
...
| **perPage**  integer | PerPage query parameter. The number of entries per page returned. Acceptable range is 3 - 5. Default is 5. |
...
## [Notes](organizations_clients_search_info_module.md#id4)
...
## [See Also](organizations_clients_search_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationClientsSearch](https://developer.cisco.com/meraki/api-v1/#!get-organization-clients-search)
> :   Complete reference of the getOrganizationClientsSearch API.

## [Examples](organizations_clients_search_info_module.md#id6)
...
## [Return Values](organizations_clients_search_info_module.md#id7)
