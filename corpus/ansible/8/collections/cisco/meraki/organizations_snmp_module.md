...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_snmp module – Resource module for organizations _snmp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_snmp_module.html
fetched_at: 2026-07-28T01:37:21+00:00
---
# cisco.meraki.organizations_snmp module – Resource module for organizations _snmp
...
> see [Requirements](organizations_snmp_module.md#ansible-collections-cisco-meraki-organizations-snmp-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_snmp`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_snmp_module.md#synopsis)
- [Requirements](organizations_snmp_module.md#requirements)
- [Parameters](organizations_snmp_module.md#parameters)
- [Notes](organizations_snmp_module.md#notes)
- [See Also](organizations_snmp_module.md#see-also)
- [Examples](organizations_snmp_module.md#examples)
- [Return Values](organizations_snmp_module.md#return-values)

## [Synopsis](organizations_snmp_module.md#id1)
...
## [Requirements](organizations_snmp_module.md#id2)
...
## [Parameters](organizations_snmp_module.md#id3)
...
| **peerIps**  list / elements=string | The list of IPv4 addresses that are allowed to access the SNMP server. |
| **v2cEnabled**  boolean | Boolean indicating whether SNMP version 2c is enabled for the organization.  **Choices:**   - `false` - `true` |
...
| **v3Enabled**  boolean | Boolean indicating whether SNMP version 3 is enabled for the organization.  **Choices:**   - `false` - `true` |
...
## [Notes](organizations_snmp_module.md#id4)
...
## [See Also](organizations_snmp_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations updateOrganizationSnmp](https://developer.cisco.com/meraki/api-v1/#!update-organization-snmp)
> :   Complete reference of the updateOrganizationSnmp API.

## [Examples](organizations_snmp_module.md#id6)
...
## [Return Values](organizations_snmp_module.md#id7)
