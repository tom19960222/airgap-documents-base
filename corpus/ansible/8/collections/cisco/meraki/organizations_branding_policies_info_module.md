...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_branding_policies_info module – Information module for organizations _brandingpolicies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_branding_policies_info_module.html
fetched_at: 2026-07-28T01:36:26+00:00
---
# cisco.meraki.organizations_branding_policies_info module – Information module for organizations _brandingpolicies
...
> see [Requirements](organizations_branding_policies_info_module.md#ansible-collections-cisco-meraki-organizations-branding-policies-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_branding_policies_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_branding_policies_info_module.md#synopsis)
- [Requirements](organizations_branding_policies_info_module.md#requirements)
- [Parameters](organizations_branding_policies_info_module.md#parameters)
- [Notes](organizations_branding_policies_info_module.md#notes)
- [See Also](organizations_branding_policies_info_module.md#see-also)
- [Examples](organizations_branding_policies_info_module.md#examples)
- [Return Values](organizations_branding_policies_info_module.md#return-values)

## [Synopsis](organizations_branding_policies_info_module.md#id1)
...
## [Requirements](organizations_branding_policies_info_module.md#id2)
...
## [Parameters](organizations_branding_policies_info_module.md#id3)
...
## [Notes](organizations_branding_policies_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_branding_policies, organizations.Organizations.get_organization_branding_policy,
...
## [See Also](organizations_branding_policies_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationBrandingPolicies](https://developer.cisco.com/meraki/api-v1/#!get-organization-branding-policies)
> :   Complete reference of the getOrganizationBrandingPolicies API.
>
> [Cisco Meraki documentation for organizations getOrganizationBrandingPolicy](https://developer.cisco.com/meraki/api-v1/#!get-organization-branding-policy)
> :   Complete reference of the getOrganizationBrandingPolicy API.

## [Examples](organizations_branding_policies_info_module.md#id6)
...
## [Return Values](organizations_branding_policies_info_module.md#id7)
