...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_modify_tags module – Resource module for networks _sm _devices _modifytags"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_modify_tags_module.html
fetched_at: 2026-07-28T01:34:33+00:00
---
# cisco.meraki.networks_sm_devices_modify_tags module – Resource module for networks _sm _devices _modifytags
...
> see [Requirements](networks_sm_devices_modify_tags_module.md#ansible-collections-cisco-meraki-networks-sm-devices-modify-tags-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_modify_tags`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_modify_tags_module.md#synopsis)
- [Requirements](networks_sm_devices_modify_tags_module.md#requirements)
- [Parameters](networks_sm_devices_modify_tags_module.md#parameters)
- [Notes](networks_sm_devices_modify_tags_module.md#notes)
- [See Also](networks_sm_devices_modify_tags_module.md#see-also)
- [Examples](networks_sm_devices_modify_tags_module.md#examples)
- [Return Values](networks_sm_devices_modify_tags_module.md#return-values)

## [Synopsis](networks_sm_devices_modify_tags_module.md#id1)
...
## [Requirements](networks_sm_devices_modify_tags_module.md#id2)
...
## [Parameters](networks_sm_devices_modify_tags_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **ids**  list / elements=string | The ids of the devices to be modified. |
...
| **scope**  list / elements=string | The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be modified. |
| **serials**  list / elements=string | The serials of the devices to be modified. |
| **tags**  list / elements=string | The tags to be added, deleted, or updated. |
| **updateAction**  string | One of add, delete, or update. Only devices that have been modified will be returned. |
| **wifiMacs**  list / elements=string | The wifiMacs of the devices to be modified. |

## [Notes](networks_sm_devices_modify_tags_module.md#id4)
...
## [See Also](networks_sm_devices_modify_tags_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm modifyNetworkSmDevicesTags](https://developer.cisco.com/meraki/api-v1/#!modify-network-sm-devices-tags)
> :   Complete reference of the modifyNetworkSmDevicesTags API.

## [Examples](networks_sm_devices_modify_tags_module.md#id6)
...
## [Return Values](networks_sm_devices_modify_tags_module.md#id7)
