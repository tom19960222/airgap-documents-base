...
collection: ansible
version: "8"
title: "cisco.meraki.networks_traffic_analysis module – Resource module for networks _trafficanalysis"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_traffic_analysis_module.html
fetched_at: 2026-07-28T01:35:23+00:00
---
# cisco.meraki.networks_traffic_analysis module – Resource module for networks _trafficanalysis
...
> see [Requirements](networks_traffic_analysis_module.md#ansible-collections-cisco-meraki-networks-traffic-analysis-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_traffic_analysis`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_traffic_analysis_module.md#synopsis)
- [Requirements](networks_traffic_analysis_module.md#requirements)
- [Parameters](networks_traffic_analysis_module.md#parameters)
- [Notes](networks_traffic_analysis_module.md#notes)
- [See Also](networks_traffic_analysis_module.md#see-also)
- [Examples](networks_traffic_analysis_module.md#examples)
- [Return Values](networks_traffic_analysis_module.md#return-values)

## [Synopsis](networks_traffic_analysis_module.md#id1)
...
## [Requirements](networks_traffic_analysis_module.md#id2)
...
## [Parameters](networks_traffic_analysis_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **customPieChartItems**  list / elements=dictionary | The list of items that make up the custom pie chart for traffic reporting. |
...
## [Notes](networks_traffic_analysis_module.md#id4)
...
## [See Also](networks_traffic_analysis_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkTrafficAnalysis](https://developer.cisco.com/meraki/api-v1/#!update-network-traffic-analysis)
> :   Complete reference of the updateNetworkTrafficAnalysis API.

## [Examples](networks_traffic_analysis_module.md#id6)
...
## [Return Values](networks_traffic_analysis_module.md#id7)
