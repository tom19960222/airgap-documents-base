...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_device_type_group_policies_info module – Information module for networks _wireless _ssids _devicetypegrouppolicies"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_device_type_group_policies_info_module.html
fetched_at: 2026-07-28T01:35:52+00:00
---
# cisco.meraki.networks_wireless_ssids_device_type_group_policies_info module – Information module for networks _wireless _ssids _devicetypegrouppolicies
...
> see [Requirements](networks_wireless_ssids_device_type_group_policies_info_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-device-type-group-policies-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_device_type_group_policies_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_device_type_group_policies_info_module.md#synopsis)
- [Requirements](networks_wireless_ssids_device_type_group_policies_info_module.md#requirements)
- [Parameters](networks_wireless_ssids_device_type_group_policies_info_module.md#parameters)
- [Notes](networks_wireless_ssids_device_type_group_policies_info_module.md#notes)
- [See Also](networks_wireless_ssids_device_type_group_policies_info_module.md#see-also)
- [Examples](networks_wireless_ssids_device_type_group_policies_info_module.md#examples)
- [Return Values](networks_wireless_ssids_device_type_group_policies_info_module.md#return-values)

## [Synopsis](networks_wireless_ssids_device_type_group_policies_info_module.md#id1)
...
## [Requirements](networks_wireless_ssids_device_type_group_policies_info_module.md#id2)
...
## [Parameters](networks_wireless_ssids_device_type_group_policies_info_module.md#id3)
...
## [Notes](networks_wireless_ssids_device_type_group_policies_info_module.md#id4)
...
## [See Also](networks_wireless_ssids_device_type_group_policies_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessSsidDeviceTypeGroupPolicies](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-ssid-device-type-group-policies)
> :   Complete reference of the getNetworkWirelessSsidDeviceTypeGroupPolicies API.

## [Examples](networks_wireless_ssids_device_type_group_policies_info_module.md#id6)
...
## [Return Values](networks_wireless_ssids_device_type_group_policies_info_module.md#id7)
