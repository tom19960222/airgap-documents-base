...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_traffic_shaping module – Resource module for networks _appliance _trafficshaping"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_traffic_shaping_module.html
fetched_at: 2026-07-28T01:33:22+00:00
---
# cisco.meraki.networks_appliance_traffic_shaping module – Resource module for networks _appliance _trafficshaping
...
> see [Requirements](networks_appliance_traffic_shaping_module.md#ansible-collections-cisco-meraki-networks-appliance-traffic-shaping-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_traffic_shaping`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_traffic_shaping_module.md#synopsis)
- [Requirements](networks_appliance_traffic_shaping_module.md#requirements)
- [Parameters](networks_appliance_traffic_shaping_module.md#parameters)
- [Notes](networks_appliance_traffic_shaping_module.md#notes)
- [See Also](networks_appliance_traffic_shaping_module.md#see-also)
- [Examples](networks_appliance_traffic_shaping_module.md#examples)
- [Return Values](networks_appliance_traffic_shaping_module.md#return-values)

## [Synopsis](networks_appliance_traffic_shaping_module.md#id1)
...
## [Requirements](networks_appliance_traffic_shaping_module.md#id2)
...
## [Parameters](networks_appliance_traffic_shaping_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **globalBandwidthLimits**  dictionary | Global per-client bandwidth limit. |
...
## [Notes](networks_appliance_traffic_shaping_module.md#id4)
...
## [See Also](networks_appliance_traffic_shaping_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceTrafficShaping](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-traffic-shaping)
> :   Complete reference of the updateNetworkApplianceTrafficShaping API.

## [Examples](networks_appliance_traffic_shaping_module.md#id6)
...
## [Return Values](networks_appliance_traffic_shaping_module.md#id7)
