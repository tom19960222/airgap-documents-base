...
collection: ansible
version: "8"
title: "cisco.meraki.devices_cellular_sims module – Resource module for devices _cellular _sims"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_cellular_sims_module.html
fetched_at: 2026-07-28T01:31:56+00:00
---
...
> see [Requirements](devices_cellular_sims_module.md#ansible-collections-cisco-meraki-devices-cellular-sims-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_cellular_sims`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_cellular_sims_module.md#synopsis)
- [Requirements](devices_cellular_sims_module.md#requirements)
- [Parameters](devices_cellular_sims_module.md#parameters)
- [Notes](devices_cellular_sims_module.md#notes)
- [See Also](devices_cellular_sims_module.md#see-also)
- [Examples](devices_cellular_sims_module.md#examples)
- [Return Values](devices_cellular_sims_module.md#return-values)

## [Synopsis](devices_cellular_sims_module.md#id1)
...
## [Requirements](devices_cellular_sims_module.md#id2)
...
## [Parameters](devices_cellular_sims_module.md#id3)
...
| **simFailover**  dictionary | SIM Failover settings. |
| **enabled**  boolean | Failover to secondary SIM (optional).  **Choices:**   - `false` - `true` |
| **sims**  list / elements=dictionary | List of SIMs. If a SIM was previously configured and not specified in this request, it will remain unchanged. |
| **apns**  list / elements=dictionary | APN configurations. If empty, the default APN will be used. |
| **allowedIpTypes**  list / elements=string | IP versions to support (permitted values include ‘ipv4’, ‘ipv6’). |
| **authentication**  dictionary | APN authentication configurations. |
...
| **isPrimary**  boolean | If true, this SIM is used for boot. Must be true on single-sim devices.  **Choices:**   - `false` - `true` |
| **slot**  string | SIM slot being configured. Must be ‘sim1’ on single-sim devices. |

## [Notes](devices_cellular_sims_module.md#id4)
...
## [See Also](devices_cellular_sims_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceCellularSims](https://developer.cisco.com/meraki/api-v1/#!update-device-cellular-sims)
> :   Complete reference of the updateDeviceCellularSims API.

## [Examples](devices_cellular_sims_module.md#id6)
...
## [Return Values](devices_cellular_sims_module.md#id7)
