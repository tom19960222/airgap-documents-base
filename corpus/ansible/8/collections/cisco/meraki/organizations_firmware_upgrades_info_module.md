...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_firmware_upgrades_info module – Information module for organizations _firmware _upgrades"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_firmware_upgrades_info_module.html
fetched_at: 2026-07-28T01:36:50+00:00
---
# cisco.meraki.organizations_firmware_upgrades_info module – Information module for organizations _firmware _upgrades
...
> see [Requirements](organizations_firmware_upgrades_info_module.md#ansible-collections-cisco-meraki-organizations-firmware-upgrades-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_firmware_upgrades_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_firmware_upgrades_info_module.md#synopsis)
- [Requirements](organizations_firmware_upgrades_info_module.md#requirements)
- [Parameters](organizations_firmware_upgrades_info_module.md#parameters)
- [Notes](organizations_firmware_upgrades_info_module.md#notes)
- [See Also](organizations_firmware_upgrades_info_module.md#see-also)
- [Examples](organizations_firmware_upgrades_info_module.md#examples)
- [Return Values](organizations_firmware_upgrades_info_module.md#return-values)

## [Synopsis](organizations_firmware_upgrades_info_module.md#id1)
...
## [Requirements](organizations_firmware_upgrades_info_module.md#id2)
...
## [Parameters](organizations_firmware_upgrades_info_module.md#id3)
...
| **productType**  list / elements=string | ProductType query parameter. The product type in a given upgrade ID. |
| **status**  list / elements=string | Status query parameter. The status of an upgrade. |

## [Notes](organizations_firmware_upgrades_info_module.md#id4)
...
## [See Also](organizations_firmware_upgrades_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationFirmwareUpgrades](https://developer.cisco.com/meraki/api-v1/#!get-organization-firmware-upgrades)
> :   Complete reference of the getOrganizationFirmwareUpgrades API.

## [Examples](organizations_firmware_upgrades_info_module.md#id6)
...
## [Return Values](organizations_firmware_upgrades_info_module.md#id7)
