...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sensor_alerts_profiles_info module – Information module for networks _sensor _alerts _profiles"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sensor_alerts_profiles_info_module.html
fetched_at: 2026-07-28T01:34:20+00:00
---
# cisco.meraki.networks_sensor_alerts_profiles_info module – Information module for networks _sensor _alerts _profiles
...
> see [Requirements](networks_sensor_alerts_profiles_info_module.md#ansible-collections-cisco-meraki-networks-sensor-alerts-profiles-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sensor_alerts_profiles_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sensor_alerts_profiles_info_module.md#synopsis)
- [Requirements](networks_sensor_alerts_profiles_info_module.md#requirements)
- [Parameters](networks_sensor_alerts_profiles_info_module.md#parameters)
- [Notes](networks_sensor_alerts_profiles_info_module.md#notes)
- [See Also](networks_sensor_alerts_profiles_info_module.md#see-also)
- [Examples](networks_sensor_alerts_profiles_info_module.md#examples)
- [Return Values](networks_sensor_alerts_profiles_info_module.md#return-values)

## [Synopsis](networks_sensor_alerts_profiles_info_module.md#id1)
...
## [Requirements](networks_sensor_alerts_profiles_info_module.md#id2)
...
## [Parameters](networks_sensor_alerts_profiles_info_module.md#id3)
...
## [Notes](networks_sensor_alerts_profiles_info_module.md#id4)

> **Note:**
>
> - SDK Method used are sensor.Sensor.get_network_sensor_alerts_profile, sensor.Sensor.get_network_sensor_alerts_profiles,
> - Paths used are get /networks/{networkId}/sensor/alerts/profiles, get /networks/{networkId}/sensor/alerts/profiles/{id},
> - Supports `check_mode`
...
## [See Also](networks_sensor_alerts_profiles_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sensor getNetworkSensorAlertsProfile](https://developer.cisco.com/meraki/api-v1/#!get-network-sensor-alerts-profile)
> :   Complete reference of the getNetworkSensorAlertsProfile API.
>
> [Cisco Meraki documentation for sensor getNetworkSensorAlertsProfiles](https://developer.cisco.com/meraki/api-v1/#!get-network-sensor-alerts-profiles)
> :   Complete reference of the getNetworkSensorAlertsProfiles API.

## [Examples](networks_sensor_alerts_profiles_info_module.md#id6)
...
## [Return Values](networks_sensor_alerts_profiles_info_module.md#id7)
