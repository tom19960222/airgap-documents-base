...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_login_security_info module – Information module for organizations _loginsecurity"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_login_security_info_module.html
fetched_at: 2026-07-28T01:37:08+00:00
---
# cisco.meraki.organizations_login_security_info module – Information module for organizations _loginsecurity
...
> see [Requirements](organizations_login_security_info_module.md#ansible-collections-cisco-meraki-organizations-login-security-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_login_security_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_login_security_info_module.md#synopsis)
- [Requirements](organizations_login_security_info_module.md#requirements)
- [Parameters](organizations_login_security_info_module.md#parameters)
- [Notes](organizations_login_security_info_module.md#notes)
- [See Also](organizations_login_security_info_module.md#see-also)
- [Examples](organizations_login_security_info_module.md#examples)
- [Return Values](organizations_login_security_info_module.md#return-values)

## [Synopsis](organizations_login_security_info_module.md#id1)
...
## [Requirements](organizations_login_security_info_module.md#id2)
...
## [Parameters](organizations_login_security_info_module.md#id3)
...
## [Notes](organizations_login_security_info_module.md#id4)
...
## [See Also](organizations_login_security_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationLoginSecurity](https://developer.cisco.com/meraki/api-v1/#!get-organization-login-security)
> :   Complete reference of the getOrganizationLoginSecurity API.

## [Examples](organizations_login_security_info_module.md#id6)
...
## [Return Values](organizations_login_security_info_module.md#id7)
