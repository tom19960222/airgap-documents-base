...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_adaptive_policy_groups module – Resource module for organizations _adaptivepolicy _groups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_adaptive_policy_groups_module.html
fetched_at: 2026-07-28T01:36:11+00:00
---
# cisco.meraki.organizations_adaptive_policy_groups module – Resource module for organizations _adaptivepolicy _groups
...
> see [Requirements](organizations_adaptive_policy_groups_module.md#ansible-collections-cisco-meraki-organizations-adaptive-policy-groups-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_adaptive_policy_groups`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_adaptive_policy_groups_module.md#synopsis)
- [Requirements](organizations_adaptive_policy_groups_module.md#requirements)
- [Parameters](organizations_adaptive_policy_groups_module.md#parameters)
- [Notes](organizations_adaptive_policy_groups_module.md#notes)
- [See Also](organizations_adaptive_policy_groups_module.md#see-also)
- [Examples](organizations_adaptive_policy_groups_module.md#examples)
- [Return Values](organizations_adaptive_policy_groups_module.md#return-values)

## [Synopsis](organizations_adaptive_policy_groups_module.md#id1)
...
## [Requirements](organizations_adaptive_policy_groups_module.md#id2)
...
## [Parameters](organizations_adaptive_policy_groups_module.md#id3)
...
| **policyObjects**  list / elements=dictionary | The policy objects that belong to this group; traffic from addresses specified by these policy objects will be tagged with this group’s SGT value if no other tagging scheme is being used (each requires one unique attribute) (default ). |
| **id**  string | The ID of the policy object. |
| **name**  string | The name of the policy object. |
| **sgt**  integer | SGT value of the group. |

## [Notes](organizations_adaptive_policy_groups_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization_adaptive_policy_group, organizations.Organizations.delete_organization_adaptive_policy_group, organizations.Organizations.update_organization_adaptive_policy_group,
> - Paths used are post /organizations/{organizationId}/adaptivePolicy/groups, delete /organizations/{organizationId}/adaptivePolicy/groups/{id}, put /organizations/{organizationId}/adaptivePolicy/groups/{id},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_adaptive_policy_groups_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationAdaptivePolicyGroup](https://developer.cisco.com/meraki/api-v1/#!create-organization-adaptive-policy-group)
> :   Complete reference of the createOrganizationAdaptivePolicyGroup API.
>
> [Cisco Meraki documentation for organizations deleteOrganizationAdaptivePolicyGroup](https://developer.cisco.com/meraki/api-v1/#!delete-organization-adaptive-policy-group)
> :   Complete reference of the deleteOrganizationAdaptivePolicyGroup API.
>
> [Cisco Meraki documentation for organizations updateOrganizationAdaptivePolicyGroup](https://developer.cisco.com/meraki/api-v1/#!update-organization-adaptive-policy-group)
> :   Complete reference of the updateOrganizationAdaptivePolicyGroup API.

## [Examples](organizations_adaptive_policy_groups_module.md#id6)
...
## [Return Values](organizations_adaptive_policy_groups_module.md#id7)
