...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_client_count_history_info module – Information module for networks _wireless _clientcounthistory"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_client_count_history_info_module.html
fetched_at: 2026-07-28T01:35:38+00:00
---
# cisco.meraki.networks_wireless_client_count_history_info module – Information module for networks _wireless _clientcounthistory
...
> see [Requirements](networks_wireless_client_count_history_info_module.md#ansible-collections-cisco-meraki-networks-wireless-client-count-history-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_client_count_history_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_client_count_history_info_module.md#synopsis)
- [Requirements](networks_wireless_client_count_history_info_module.md#requirements)
- [Parameters](networks_wireless_client_count_history_info_module.md#parameters)
- [Notes](networks_wireless_client_count_history_info_module.md#notes)
- [See Also](networks_wireless_client_count_history_info_module.md#see-also)
- [Examples](networks_wireless_client_count_history_info_module.md#examples)
- [Return Values](networks_wireless_client_count_history_info_module.md#return-values)

## [Synopsis](networks_wireless_client_count_history_info_module.md#id1)
...
## [Requirements](networks_wireless_client_count_history_info_module.md#id2)
...
## [Parameters](networks_wireless_client_count_history_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **apTag**  string | ApTag query parameter. Filter results by AP tag. |
...
| **clientId**  string | ClientId query parameter. Filter results by network client to return per-device client counts over time inner joined by the queried client’s connection history. |
...
## [Notes](networks_wireless_client_count_history_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_client_count_history,
> - Paths used are get /networks/{networkId}/wireless/clientCountHistory,
> - Supports `check_mode`
...
## [See Also](networks_wireless_client_count_history_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessClientCountHistory](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-client-count-history)
> :   Complete reference of the getNetworkWirelessClientCountHistory API.

## [Examples](networks_wireless_client_count_history_info_module.md#id6)
...
## [Return Values](networks_wireless_client_count_history_info_module.md#id7)
