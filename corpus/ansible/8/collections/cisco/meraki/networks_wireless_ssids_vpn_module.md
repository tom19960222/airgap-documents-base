...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_vpn module – Resource module for networks _wireless _ssids _vpn"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_vpn_module.html
fetched_at: 2026-07-28T01:36:05+00:00
---
# cisco.meraki.networks_wireless_ssids_vpn module – Resource module for networks _wireless _ssids _vpn
...
> see [Requirements](networks_wireless_ssids_vpn_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-vpn-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_vpn`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_vpn_module.md#synopsis)
- [Requirements](networks_wireless_ssids_vpn_module.md#requirements)
- [Parameters](networks_wireless_ssids_vpn_module.md#parameters)
- [Notes](networks_wireless_ssids_vpn_module.md#notes)
- [See Also](networks_wireless_ssids_vpn_module.md#see-also)
- [Examples](networks_wireless_ssids_vpn_module.md#examples)
- [Return Values](networks_wireless_ssids_vpn_module.md#return-values)

## [Synopsis](networks_wireless_ssids_vpn_module.md#id1)
...
## [Requirements](networks_wireless_ssids_vpn_module.md#id2)
...
## [Parameters](networks_wireless_ssids_vpn_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **concentrator**  dictionary | The VPN concentrator settings for this SSID. |
| **networkId**  string | The NAT ID of the concentrator that should be set. |
| **vlanId**  integer | The VLAN that should be tagged for the concentrator. |
| **failover**  dictionary | Secondary VPN concentrator settings. This is only used when two VPN concentrators are configured on the SSID. |
| **heartbeatInterval**  integer | Idle timer interval in seconds. |
| **idleTimeout**  integer | Idle timer timeout in seconds. |
| **requestIp**  string | IP addressed reserved on DHCP server where SSID will terminate. |
...
| **splitTunnel**  dictionary | The VPN split tunnel settings for this SSID. |
| **enabled**  boolean | If true, VPN split tunnel is enabled.  **Choices:**   - `false` - `true` |
| **rules**  list / elements=dictionary | List of VPN split tunnel rules. |
...
| **destPort**  string | Destination port for this split tunnel rule, (integer in the range 1-65535), or ‘any’. |
...
## [Notes](networks_wireless_ssids_vpn_module.md#id4)
...
## [See Also](networks_wireless_ssids_vpn_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidVpn](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-vpn)
> :   Complete reference of the updateNetworkWirelessSsidVpn API.

## [Examples](networks_wireless_ssids_vpn_module.md#id6)
...
## [Return Values](networks_wireless_ssids_vpn_module.md#id7)
