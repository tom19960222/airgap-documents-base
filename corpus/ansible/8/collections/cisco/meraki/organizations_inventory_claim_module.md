...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_inventory_claim module – Resource module for organizations _inventory _claim"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_inventory_claim_module.html
fetched_at: 2026-07-28T01:36:54+00:00
---
# cisco.meraki.organizations_inventory_claim module – Resource module for organizations _inventory _claim
...
> see [Requirements](organizations_inventory_claim_module.md#ansible-collections-cisco-meraki-organizations-inventory-claim-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_inventory_claim`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_inventory_claim_module.md#synopsis)
- [Requirements](organizations_inventory_claim_module.md#requirements)
- [Parameters](organizations_inventory_claim_module.md#parameters)
- [Notes](organizations_inventory_claim_module.md#notes)
- [See Also](organizations_inventory_claim_module.md#see-also)
- [Examples](organizations_inventory_claim_module.md#examples)
- [Return Values](organizations_inventory_claim_module.md#return-values)

## [Synopsis](organizations_inventory_claim_module.md#id1)
...
## [Requirements](organizations_inventory_claim_module.md#id2)
...
## [Parameters](organizations_inventory_claim_module.md#id3)
...
## [Notes](organizations_inventory_claim_module.md#id4)
...
## [See Also](organizations_inventory_claim_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations claimIntoOrganizationInventory](https://developer.cisco.com/meraki/api-v1/#!claim-into-organization-inventory)
> :   Complete reference of the claimIntoOrganizationInventory API.

## [Examples](organizations_inventory_claim_module.md#id6)
...
## [Return Values](organizations_inventory_claim_module.md#id7)
