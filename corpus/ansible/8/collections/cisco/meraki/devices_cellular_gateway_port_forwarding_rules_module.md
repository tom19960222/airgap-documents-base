...
collection: ansible
version: "8"
title: "cisco.meraki.devices_cellular_gateway_port_forwarding_rules module – Resource module for devices _cellulargateway _portforwardingrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_cellular_gateway_port_forwarding_rules_module.html
fetched_at: 2026-07-28T01:31:54+00:00
---
# cisco.meraki.devices_cellular_gateway_port_forwarding_rules module – Resource module for devices _cellulargateway _portforwardingrules
...
> see [Requirements](devices_cellular_gateway_port_forwarding_rules_module.md#ansible-collections-cisco-meraki-devices-cellular-gateway-port-forwarding-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_cellular_gateway_port_forwarding_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_cellular_gateway_port_forwarding_rules_module.md#synopsis)
- [Requirements](devices_cellular_gateway_port_forwarding_rules_module.md#requirements)
- [Parameters](devices_cellular_gateway_port_forwarding_rules_module.md#parameters)
- [Notes](devices_cellular_gateway_port_forwarding_rules_module.md#notes)
- [See Also](devices_cellular_gateway_port_forwarding_rules_module.md#see-also)
- [Examples](devices_cellular_gateway_port_forwarding_rules_module.md#examples)
- [Return Values](devices_cellular_gateway_port_forwarding_rules_module.md#return-values)

## [Synopsis](devices_cellular_gateway_port_forwarding_rules_module.md#id1)
...
## [Requirements](devices_cellular_gateway_port_forwarding_rules_module.md#id2)
...
## [Parameters](devices_cellular_gateway_port_forwarding_rules_module.md#id3)
...
| **allowedIps**  list / elements=string | An array of ranges of WAN IP addresses that are allowed to make inbound connections on the specified ports or port ranges. |
...
## [Notes](devices_cellular_gateway_port_forwarding_rules_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.update_device_cellular_gateway_port_forwarding_rules,
...
## [See Also](devices_cellular_gateway_port_forwarding_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceCellularGatewayPortForwardingRules](https://developer.cisco.com/meraki/api-v1/#!update-device-cellular-gateway-port-forwarding-rules)
> :   Complete reference of the updateDeviceCellularGatewayPortForwardingRules API.

## [Examples](devices_cellular_gateway_port_forwarding_rules_module.md#id6)
...
## [Return Values](devices_cellular_gateway_port_forwarding_rules_module.md#id7)
