...
collection: ansible
version: "8"
title: "cisco.meraki.networks_firmware_upgrades_staged_groups_info module – Information module for networks _firmwareupgrades _staged _groups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_firmware_upgrades_staged_groups_info_module.html
fetched_at: 2026-07-28T01:34:02+00:00
---
# cisco.meraki.networks_firmware_upgrades_staged_groups_info module – Information module for networks _firmwareupgrades _staged _groups
...
> see [Requirements](networks_firmware_upgrades_staged_groups_info_module.md#ansible-collections-cisco-meraki-networks-firmware-upgrades-staged-groups-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_firmware_upgrades_staged_groups_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_firmware_upgrades_staged_groups_info_module.md#synopsis)
- [Requirements](networks_firmware_upgrades_staged_groups_info_module.md#requirements)
- [Parameters](networks_firmware_upgrades_staged_groups_info_module.md#parameters)
- [Notes](networks_firmware_upgrades_staged_groups_info_module.md#notes)
- [See Also](networks_firmware_upgrades_staged_groups_info_module.md#see-also)
- [Examples](networks_firmware_upgrades_staged_groups_info_module.md#examples)
- [Return Values](networks_firmware_upgrades_staged_groups_info_module.md#return-values)

## [Synopsis](networks_firmware_upgrades_staged_groups_info_module.md#id1)
...
## [Requirements](networks_firmware_upgrades_staged_groups_info_module.md#id2)
...
## [Parameters](networks_firmware_upgrades_staged_groups_info_module.md#id3)
...
## [Notes](networks_firmware_upgrades_staged_groups_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_firmware_upgrades_staged_group, networks.Networks.get_network_firmware_upgrades_staged_groups,
...
## [See Also](networks_firmware_upgrades_staged_groups_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkFirmwareUpgradesStagedGroup](https://developer.cisco.com/meraki/api-v1/#!get-network-firmware-upgrades-staged-group)
> :   Complete reference of the getNetworkFirmwareUpgradesStagedGroup API.
>
> [Cisco Meraki documentation for networks getNetworkFirmwareUpgradesStagedGroups](https://developer.cisco.com/meraki/api-v1/#!get-network-firmware-upgrades-staged-groups)
> :   Complete reference of the getNetworkFirmwareUpgradesStagedGroups API.

## [Examples](networks_firmware_upgrades_staged_groups_info_module.md#id6)
...
## [Return Values](networks_firmware_upgrades_staged_groups_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"assignedDevices": {"devices": [{"name": "string", "serial": "string"}], "switchStacks": [{"id": "string", "name": "string"}]}, "description": "string", "groupId": "string", "isDefault": true, "name": "string"}` |
