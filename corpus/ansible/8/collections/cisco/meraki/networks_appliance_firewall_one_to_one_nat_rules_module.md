...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules module – Resource module for networks _appliance _firewall _onetoonenatrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_firewall_one_to_one_nat_rules_module.html
fetched_at: 2026-07-28T01:33:06+00:00
---
# cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules module – Resource module for networks _appliance _firewall _onetoonenatrules
...
> see [Requirements](networks_appliance_firewall_one_to_one_nat_rules_module.md#ansible-collections-cisco-meraki-networks-appliance-firewall-one-to-one-nat-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_firewall_one_to_one_nat_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_firewall_one_to_one_nat_rules_module.md#synopsis)
- [Requirements](networks_appliance_firewall_one_to_one_nat_rules_module.md#requirements)
- [Parameters](networks_appliance_firewall_one_to_one_nat_rules_module.md#parameters)
- [Notes](networks_appliance_firewall_one_to_one_nat_rules_module.md#notes)
- [See Also](networks_appliance_firewall_one_to_one_nat_rules_module.md#see-also)
- [Examples](networks_appliance_firewall_one_to_one_nat_rules_module.md#examples)
- [Return Values](networks_appliance_firewall_one_to_one_nat_rules_module.md#return-values)

## [Synopsis](networks_appliance_firewall_one_to_one_nat_rules_module.md#id1)
...
## [Requirements](networks_appliance_firewall_one_to_one_nat_rules_module.md#id2)
...
## [Parameters](networks_appliance_firewall_one_to_one_nat_rules_module.md#id3)
...
| **rules**  list / elements=dictionary | An array of 1 1 nat rules. |
| **allowedInbound**  list / elements=dictionary | The ports this mapping will provide access on, and the remote IPs that will be allowed access to the resource. |
| **allowedIps**  list / elements=string | An array of ranges of WAN IP addresses that are allowed to make inbound connections on the specified ports or port ranges, or ‘any’. |
| **destinationPorts**  list / elements=string | An array of ports or port ranges that will be forwarded to the host on the LAN. |
...
## [Notes](networks_appliance_firewall_one_to_one_nat_rules_module.md#id4)
...
## [See Also](networks_appliance_firewall_one_to_one_nat_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceFirewallOneToOneNatRules](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-firewall-one-to-one-nat-rules)
> :   Complete reference of the updateNetworkApplianceFirewallOneToOneNatRules API.

## [Examples](networks_appliance_firewall_one_to_one_nat_rules_module.md#id6)
...
## [Return Values](networks_appliance_firewall_one_to_one_nat_rules_module.md#id7)
