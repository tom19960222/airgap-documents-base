...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_clients_latency_stats_info module – Information module for networks _wireless _clients _latencystats"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_clients_latency_stats_info_module.html
fetched_at: 2026-07-28T01:35:39+00:00
---
# cisco.meraki.networks_wireless_clients_latency_stats_info module – Information module for networks _wireless _clients _latencystats
...
> see [Requirements](networks_wireless_clients_latency_stats_info_module.md#ansible-collections-cisco-meraki-networks-wireless-clients-latency-stats-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_clients_latency_stats_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_clients_latency_stats_info_module.md#synopsis)
- [Requirements](networks_wireless_clients_latency_stats_info_module.md#requirements)
- [Parameters](networks_wireless_clients_latency_stats_info_module.md#parameters)
- [Notes](networks_wireless_clients_latency_stats_info_module.md#notes)
- [See Also](networks_wireless_clients_latency_stats_info_module.md#see-also)
- [Examples](networks_wireless_clients_latency_stats_info_module.md#examples)
- [Return Values](networks_wireless_clients_latency_stats_info_module.md#return-values)

## [Synopsis](networks_wireless_clients_latency_stats_info_module.md#id1)
...
## [Requirements](networks_wireless_clients_latency_stats_info_module.md#id2)
...
## [Parameters](networks_wireless_clients_latency_stats_info_module.md#id3)
...
## [Notes](networks_wireless_clients_latency_stats_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_client_latency_stats,
> - Paths used are get /networks/{networkId}/wireless/clients/{clientId}/latencyStats,
> - Supports `check_mode`
...
## [See Also](networks_wireless_clients_latency_stats_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessClientLatencyStats](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-client-latency-stats)
> :   Complete reference of the getNetworkWirelessClientLatencyStats API.

## [Examples](networks_wireless_clients_latency_stats_info_module.md#id6)
...
## [Return Values](networks_wireless_clients_latency_stats_info_module.md#id7)
