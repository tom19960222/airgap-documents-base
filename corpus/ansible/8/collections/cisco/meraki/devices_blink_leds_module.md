...
collection: ansible
version: "8"
title: "cisco.meraki.devices_blink_leds module – Resource module for devices _blinkleds"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_blink_leds_module.html
fetched_at: 2026-07-28T01:31:43+00:00
---
# cisco.meraki.devices_blink_leds module – Resource module for devices _blinkleds
...
> see [Requirements](devices_blink_leds_module.md#ansible-collections-cisco-meraki-devices-blink-leds-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_blink_leds`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_blink_leds_module.md#synopsis)
- [Requirements](devices_blink_leds_module.md#requirements)
- [Parameters](devices_blink_leds_module.md#parameters)
- [Notes](devices_blink_leds_module.md#notes)
- [See Also](devices_blink_leds_module.md#see-also)
- [Examples](devices_blink_leds_module.md#examples)
- [Return Values](devices_blink_leds_module.md#return-values)

## [Synopsis](devices_blink_leds_module.md#id1)
...
## [Requirements](devices_blink_leds_module.md#id2)
...
## [Parameters](devices_blink_leds_module.md#id3)
...
## [Notes](devices_blink_leds_module.md#id4)
...
## [See Also](devices_blink_leds_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices blinkDeviceLeds](https://developer.cisco.com/meraki/api-v1/#!blink-device-leds)
> :   Complete reference of the blinkDeviceLeds API.

## [Examples](devices_blink_leds_module.md#id6)
...
## [Return Values](devices_blink_leds_module.md#id7)
