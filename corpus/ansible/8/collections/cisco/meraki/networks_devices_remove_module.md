...
collection: ansible
version: "8"
title: "cisco.meraki.networks_devices_remove module – Resource module for networks _devices _remove"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_devices_remove_module.html
fetched_at: 2026-07-28T01:33:54+00:00
---
# cisco.meraki.networks_devices_remove module – Resource module for networks _devices _remove
...
> see [Requirements](networks_devices_remove_module.md#ansible-collections-cisco-meraki-networks-devices-remove-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_devices_remove`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_devices_remove_module.md#synopsis)
- [Requirements](networks_devices_remove_module.md#requirements)
- [Parameters](networks_devices_remove_module.md#parameters)
- [Notes](networks_devices_remove_module.md#notes)
- [See Also](networks_devices_remove_module.md#see-also)
- [Examples](networks_devices_remove_module.md#examples)
- [Return Values](networks_devices_remove_module.md#return-values)

## [Synopsis](networks_devices_remove_module.md#id1)
...
## [Requirements](networks_devices_remove_module.md#id2)
...
## [Parameters](networks_devices_remove_module.md#id3)
...
## [Notes](networks_devices_remove_module.md#id4)
...
## [See Also](networks_devices_remove_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks removeNetworkDevices](https://developer.cisco.com/meraki/api-v1/#!remove-network-devices)
> :   Complete reference of the removeNetworkDevices API.

## [Examples](networks_devices_remove_module.md#id6)
...
## [Return Values](networks_devices_remove_module.md#id7)
