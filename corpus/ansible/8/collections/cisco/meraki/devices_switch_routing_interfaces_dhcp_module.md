...
collection: ansible
version: "8"
title: "cisco.meraki.devices_switch_routing_interfaces_dhcp module – Resource module for devices _switch _routing _interfaces _dhcp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_switch_routing_interfaces_dhcp_module.html
fetched_at: 2026-07-28T01:32:08+00:00
---
...
> see [Requirements](devices_switch_routing_interfaces_dhcp_module.md#ansible-collections-cisco-meraki-devices-switch-routing-interfaces-dhcp-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_switch_routing_interfaces_dhcp`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_switch_routing_interfaces_dhcp_module.md#synopsis)
- [Requirements](devices_switch_routing_interfaces_dhcp_module.md#requirements)
- [Parameters](devices_switch_routing_interfaces_dhcp_module.md#parameters)
- [Notes](devices_switch_routing_interfaces_dhcp_module.md#notes)
- [See Also](devices_switch_routing_interfaces_dhcp_module.md#see-also)
- [Examples](devices_switch_routing_interfaces_dhcp_module.md#examples)
- [Return Values](devices_switch_routing_interfaces_dhcp_module.md#return-values)

## [Synopsis](devices_switch_routing_interfaces_dhcp_module.md#id1)
...
## [Requirements](devices_switch_routing_interfaces_dhcp_module.md#id2)
...
## [Parameters](devices_switch_routing_interfaces_dhcp_module.md#id3)
...
| **bootOptionsEnabled**  boolean | Enable DHCP boot options to provide PXE boot options configs for the dhcp server running on the switch interface.  **Choices:**   - `false` - `true` |
...
| **dhcpOptions**  list / elements=dictionary | Array of DHCP options consisting of code, type and value for the DHCP server running on the switch interface. |
...
| **dhcpRelayServerIps**  list / elements=string | The DHCP relay server IPs to which DHCP packets would get relayed for the switch interface. |
...
| **fixedIpAssignments**  list / elements=dictionary | Array of DHCP fixed IP assignments for the DHCP server running on the switch interface. |
...
| **reservedIpRanges**  list / elements=dictionary | Array of DHCP reserved IP assignments for the DHCP server running on the switch interface. |
...
## [Notes](devices_switch_routing_interfaces_dhcp_module.md#id4)
...
## [See Also](devices_switch_routing_interfaces_dhcp_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices updateDeviceSwitchRoutingInterfaceDhcp](https://developer.cisco.com/meraki/api-v1/#!update-device-switch-routing-interface-dhcp)
> :   Complete reference of the updateDeviceSwitchRoutingInterfaceDhcp API.

## [Examples](devices_switch_routing_interfaces_dhcp_module.md#id6)
...
## [Return Values](devices_switch_routing_interfaces_dhcp_module.md#id7)
