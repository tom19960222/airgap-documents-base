...
collection: ansible
version: "8"
title: "cisco.meraki.networks_traffic_shaping_application_categories_info module – Information module for networks _trafficshaping _applicationcategories"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_traffic_shaping_application_categories_info_module.html
fetched_at: 2026-07-28T01:35:25+00:00
---
# cisco.meraki.networks_traffic_shaping_application_categories_info module – Information module for networks _trafficshaping _applicationcategories
...
> see [Requirements](networks_traffic_shaping_application_categories_info_module.md#ansible-collections-cisco-meraki-networks-traffic-shaping-application-categories-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_traffic_shaping_application_categories_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_traffic_shaping_application_categories_info_module.md#synopsis)
- [Requirements](networks_traffic_shaping_application_categories_info_module.md#requirements)
- [Parameters](networks_traffic_shaping_application_categories_info_module.md#parameters)
- [Notes](networks_traffic_shaping_application_categories_info_module.md#notes)
- [See Also](networks_traffic_shaping_application_categories_info_module.md#see-also)
- [Examples](networks_traffic_shaping_application_categories_info_module.md#examples)
- [Return Values](networks_traffic_shaping_application_categories_info_module.md#return-values)

## [Synopsis](networks_traffic_shaping_application_categories_info_module.md#id1)
...
## [Requirements](networks_traffic_shaping_application_categories_info_module.md#id2)
...
## [Parameters](networks_traffic_shaping_application_categories_info_module.md#id3)
...
## [Notes](networks_traffic_shaping_application_categories_info_module.md#id4)
...
## [See Also](networks_traffic_shaping_application_categories_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkTrafficShapingApplicationCategories](https://developer.cisco.com/meraki/api-v1/#!get-network-traffic-shaping-application-categories)
> :   Complete reference of the getNetworkTrafficShapingApplicationCategories API.

## [Examples](networks_traffic_shaping_application_categories_info_module.md#id6)
...
## [Return Values](networks_traffic_shaping_application_categories_info_module.md#id7)
