...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_early_access_features_info module – Information module for organizations _earlyaccess _features"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_early_access_features_info_module.html
fetched_at: 2026-07-28T01:36:46+00:00
---
# cisco.meraki.organizations_early_access_features_info module – Information module for organizations _earlyaccess _features
...
> see [Requirements](organizations_early_access_features_info_module.md#ansible-collections-cisco-meraki-organizations-early-access-features-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_early_access_features_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_early_access_features_info_module.md#synopsis)
- [Requirements](organizations_early_access_features_info_module.md#requirements)
- [Parameters](organizations_early_access_features_info_module.md#parameters)
- [Notes](organizations_early_access_features_info_module.md#notes)
- [See Also](organizations_early_access_features_info_module.md#see-also)
- [Examples](organizations_early_access_features_info_module.md#examples)
- [Return Values](organizations_early_access_features_info_module.md#return-values)

## [Synopsis](organizations_early_access_features_info_module.md#id1)
...
## [Requirements](organizations_early_access_features_info_module.md#id2)
...
## [Parameters](organizations_early_access_features_info_module.md#id3)
...
## [Notes](organizations_early_access_features_info_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.get_organization_early_access_features,
> - Paths used are get /organizations/{organizationId}/earlyAccess/features,
> - Supports `check_mode`
...
## [See Also](organizations_early_access_features_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationEarlyAccessFeatures](https://developer.cisco.com/meraki/api-v1/#!get-organization-early-access-features)
> :   Complete reference of the getOrganizationEarlyAccessFeatures API.

## [Examples](organizations_early_access_features_info_module.md#id6)
...
## [Return Values](organizations_early_access_features_info_module.md#id7)
