...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_static_routes module – Resource module for networks _appliance _static _routes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_static_routes_module.html
fetched_at: 2026-07-28T01:33:20+00:00
---
# cisco.meraki.networks_appliance_static_routes module – Resource module for networks _appliance _static _routes
...
> see [Requirements](networks_appliance_static_routes_module.md#ansible-collections-cisco-meraki-networks-appliance-static-routes-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_static_routes`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_static_routes_module.md#synopsis)
- [Requirements](networks_appliance_static_routes_module.md#requirements)
- [Parameters](networks_appliance_static_routes_module.md#parameters)
- [Notes](networks_appliance_static_routes_module.md#notes)
- [See Also](networks_appliance_static_routes_module.md#see-also)
- [Examples](networks_appliance_static_routes_module.md#examples)
- [Return Values](networks_appliance_static_routes_module.md#return-values)

## [Synopsis](networks_appliance_static_routes_module.md#id1)
...
## [Requirements](networks_appliance_static_routes_module.md#id2)
...
## [Parameters](networks_appliance_static_routes_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | The enabled state of the static route.  **Choices:**   - `false` - `true` |
| **fixedIpAssignments**  dictionary | The DHCP fixed IP assignments on the static route. This should be an object that contains mappings from MAC addresses to objects that themselves each contain “ip” and “name” string fields. See the sample request/response for more details. |
...
| **reservedIpRanges**  list / elements=dictionary | The DHCP reserved IP ranges on the static route. |
...
## [Notes](networks_appliance_static_routes_module.md#id4)

> **Note:**
>
> - SDK Method used are appliance.Appliance.create_network_appliance_static_route, appliance.Appliance.delete_network_appliance_static_route, appliance.Appliance.update_network_appliance_static_route,
> - Paths used are post /networks/{networkId}/appliance/staticRoutes, delete /networks/{networkId}/appliance/staticRoutes/{staticRouteId}, put /networks/{networkId}/appliance/staticRoutes/{staticRouteId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_appliance_static_routes_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance createNetworkApplianceStaticRoute](https://developer.cisco.com/meraki/api-v1/#!create-network-appliance-static-route)
> :   Complete reference of the createNetworkApplianceStaticRoute API.
>
> [Cisco Meraki documentation for appliance deleteNetworkApplianceStaticRoute](https://developer.cisco.com/meraki/api-v1/#!delete-network-appliance-static-route)
> :   Complete reference of the deleteNetworkApplianceStaticRoute API.
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceStaticRoute](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-static-route)
> :   Complete reference of the updateNetworkApplianceStaticRoute API.

## [Examples](networks_appliance_static_routes_module.md#id6)
...
## [Return Values](networks_appliance_static_routes_module.md#id7)
