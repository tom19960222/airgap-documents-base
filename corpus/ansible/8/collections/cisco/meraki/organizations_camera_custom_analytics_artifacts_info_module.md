...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_camera_custom_analytics_artifacts_info module – Information module for organizations _camera _customanalytics _artifacts"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_camera_custom_analytics_artifacts_info_module.html
fetched_at: 2026-07-28T01:36:30+00:00
---
# cisco.meraki.organizations_camera_custom_analytics_artifacts_info module – Information module for organizations _camera _customanalytics _artifacts
...
> see [Requirements](organizations_camera_custom_analytics_artifacts_info_module.md#ansible-collections-cisco-meraki-organizations-camera-custom-analytics-artifacts-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_camera_custom_analytics_artifacts_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_camera_custom_analytics_artifacts_info_module.md#synopsis)
- [Requirements](organizations_camera_custom_analytics_artifacts_info_module.md#requirements)
- [Parameters](organizations_camera_custom_analytics_artifacts_info_module.md#parameters)
- [Notes](organizations_camera_custom_analytics_artifacts_info_module.md#notes)
- [See Also](organizations_camera_custom_analytics_artifacts_info_module.md#see-also)
- [Examples](organizations_camera_custom_analytics_artifacts_info_module.md#examples)
- [Return Values](organizations_camera_custom_analytics_artifacts_info_module.md#return-values)

## [Synopsis](organizations_camera_custom_analytics_artifacts_info_module.md#id1)
...
## [Requirements](organizations_camera_custom_analytics_artifacts_info_module.md#id2)
...
## [Parameters](organizations_camera_custom_analytics_artifacts_info_module.md#id3)
...
## [Notes](organizations_camera_custom_analytics_artifacts_info_module.md#id4)

> **Note:**
>
> - SDK Method used are camera.Camera.get_organization_camera_custom_analytics_artifact, camera.Camera.get_organization_camera_custom_analytics_artifacts,
> - Paths used are get /organizations/{organizationId}/camera/customAnalytics/artifacts, get /organizations/{organizationId}/camera/customAnalytics/artifacts/{artifactId},
> - Supports `check_mode`
...
## [See Also](organizations_camera_custom_analytics_artifacts_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for camera getOrganizationCameraCustomAnalyticsArtifact](https://developer.cisco.com/meraki/api-v1/#!get-organization-camera-custom-analytics-artifact)
> :   Complete reference of the getOrganizationCameraCustomAnalyticsArtifact API.
>
> [Cisco Meraki documentation for camera getOrganizationCameraCustomAnalyticsArtifacts](https://developer.cisco.com/meraki/api-v1/#!get-organization-camera-custom-analytics-artifacts)
> :   Complete reference of the getOrganizationCameraCustomAnalyticsArtifacts API.

## [Examples](organizations_camera_custom_analytics_artifacts_info_module.md#id6)
...
## [Return Values](organizations_camera_custom_analytics_artifacts_info_module.md#id7)
