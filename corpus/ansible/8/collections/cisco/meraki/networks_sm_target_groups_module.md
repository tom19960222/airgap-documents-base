...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_target_groups module – Resource module for networks _sm _targetgroups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_target_groups_module.html
fetched_at: 2026-07-28T01:34:40+00:00
---
# cisco.meraki.networks_sm_target_groups module – Resource module for networks _sm _targetgroups
...
> see [Requirements](networks_sm_target_groups_module.md#ansible-collections-cisco-meraki-networks-sm-target-groups-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_target_groups`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_target_groups_module.md#synopsis)
- [Requirements](networks_sm_target_groups_module.md#requirements)
- [Parameters](networks_sm_target_groups_module.md#parameters)
- [Notes](networks_sm_target_groups_module.md#notes)
- [See Also](networks_sm_target_groups_module.md#see-also)
- [Examples](networks_sm_target_groups_module.md#examples)
- [Return Values](networks_sm_target_groups_module.md#return-values)

## [Synopsis](networks_sm_target_groups_module.md#id1)
...
## [Requirements](networks_sm_target_groups_module.md#id2)
...
## [Parameters](networks_sm_target_groups_module.md#id3)
...
## [Notes](networks_sm_target_groups_module.md#id4)

> **Note:**
>
> - SDK Method used are sm.Sm.create_network_sm_target_group, sm.Sm.delete_network_sm_target_group, sm.Sm.update_network_sm_target_group,
> - Paths used are post /networks/{networkId}/sm/targetGroups, delete /networks/{networkId}/sm/targetGroups/{targetGroupId}, put /networks/{networkId}/sm/targetGroups/{targetGroupId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_sm_target_groups_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm createNetworkSmTargetGroup](https://developer.cisco.com/meraki/api-v1/#!create-network-sm-target-group)
> :   Complete reference of the createNetworkSmTargetGroup API.
>
> [Cisco Meraki documentation for sm deleteNetworkSmTargetGroup](https://developer.cisco.com/meraki/api-v1/#!delete-network-sm-target-group)
> :   Complete reference of the deleteNetworkSmTargetGroup API.
>
> [Cisco Meraki documentation for sm updateNetworkSmTargetGroup](https://developer.cisco.com/meraki/api-v1/#!update-network-sm-target-group)
> :   Complete reference of the updateNetworkSmTargetGroup API.

## [Examples](networks_sm_target_groups_module.md#id6)
...
## [Return Values](networks_sm_target_groups_module.md#id7)
