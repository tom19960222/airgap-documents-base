...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_devices_info module – Information module for networks _sm _devices"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_devices_info_module.html
fetched_at: 2026-07-28T01:34:32+00:00
---
# cisco.meraki.networks_sm_devices_info module – Information module for networks _sm _devices
...
> see [Requirements](networks_sm_devices_info_module.md#ansible-collections-cisco-meraki-networks-sm-devices-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_devices_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_devices_info_module.md#synopsis)
- [Requirements](networks_sm_devices_info_module.md#requirements)
- [Parameters](networks_sm_devices_info_module.md#parameters)
- [Notes](networks_sm_devices_info_module.md#notes)
- [See Also](networks_sm_devices_info_module.md#see-also)
- [Examples](networks_sm_devices_info_module.md#examples)
- [Return Values](networks_sm_devices_info_module.md#return-values)

## [Synopsis](networks_sm_devices_info_module.md#id1)
...
## [Requirements](networks_sm_devices_info_module.md#id2)
...
## [Parameters](networks_sm_devices_info_module.md#id3)
...
| **scope**  list / elements=string | Scope query parameter. Specify a scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags. |
| **serials**  list / elements=string | Serials query parameter. Filter devices by serial(s). |
...
| **wifiMacs**  list / elements=string | WifiMacs query parameter. Filter devices by wifi mac(s). |

## [Notes](networks_sm_devices_info_module.md#id4)
...
## [See Also](networks_sm_devices_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmDevices](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-devices)
> :   Complete reference of the getNetworkSmDevices API.

## [Examples](networks_sm_devices_info_module.md#id6)
...
## [Return Values](networks_sm_devices_info_module.md#id7)
