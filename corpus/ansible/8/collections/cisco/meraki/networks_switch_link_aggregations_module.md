...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_link_aggregations module – Resource module for networks _switch _linkaggregations"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_link_aggregations_module.html
fetched_at: 2026-07-28T01:34:58+00:00
---
# cisco.meraki.networks_switch_link_aggregations module – Resource module for networks _switch _linkaggregations
...
> see [Requirements](networks_switch_link_aggregations_module.md#ansible-collections-cisco-meraki-networks-switch-link-aggregations-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_link_aggregations`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_link_aggregations_module.md#synopsis)
- [Requirements](networks_switch_link_aggregations_module.md#requirements)
- [Parameters](networks_switch_link_aggregations_module.md#parameters)
- [Notes](networks_switch_link_aggregations_module.md#notes)
- [See Also](networks_switch_link_aggregations_module.md#see-also)
- [Examples](networks_switch_link_aggregations_module.md#examples)
- [Return Values](networks_switch_link_aggregations_module.md#return-values)

## [Synopsis](networks_switch_link_aggregations_module.md#id1)
...
## [Requirements](networks_switch_link_aggregations_module.md#id2)
...
## [Parameters](networks_switch_link_aggregations_module.md#id3)
...
| **switchPorts**  list / elements=dictionary | Array of switch or stack ports for creating aggregation group. Minimum 2 and maximum 8 ports are supported. |
...
| **switchProfilePorts**  list / elements=dictionary | Array of switch profile ports for creating aggregation group. Minimum 2 and maximum 8 ports are supported. |
| **portId**  string | Port identifier of switch port. For modules, the identifier is “SlotNumber_ModuleType_PortNumber” (Ex “1_8X10G_1”), otherwise it is just the port number (Ex “8”). |
| **profile**  string | Profile identifier. |

## [Notes](networks_switch_link_aggregations_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.create_network_switch_link_aggregation, switch.Switch.delete_network_switch_link_aggregation, switch.Switch.update_network_switch_link_aggregation,
> - Paths used are post /networks/{networkId}/switch/linkAggregations, delete /networks/{networkId}/switch/linkAggregations/{linkAggregationId}, put /networks/{networkId}/switch/linkAggregations/{linkAggregationId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_switch_link_aggregations_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch createNetworkSwitchLinkAggregation](https://developer.cisco.com/meraki/api-v1/#!create-network-switch-link-aggregation)
> :   Complete reference of the createNetworkSwitchLinkAggregation API.
>
> [Cisco Meraki documentation for switch deleteNetworkSwitchLinkAggregation](https://developer.cisco.com/meraki/api-v1/#!delete-network-switch-link-aggregation)
> :   Complete reference of the deleteNetworkSwitchLinkAggregation API.
>
> [Cisco Meraki documentation for switch updateNetworkSwitchLinkAggregation](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-link-aggregation)
> :   Complete reference of the updateNetworkSwitchLinkAggregation API.

## [Examples](networks_switch_link_aggregations_module.md#id6)
...
## [Return Values](networks_switch_link_aggregations_module.md#id7)
