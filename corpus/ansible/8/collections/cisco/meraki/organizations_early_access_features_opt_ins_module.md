...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_early_access_features_opt_ins module – Resource module for organizations _earlyaccess _features _optins"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_early_access_features_opt_ins_module.html
fetched_at: 2026-07-28T01:36:47+00:00
---
# cisco.meraki.organizations_early_access_features_opt_ins module – Resource module for organizations _earlyaccess _features _optins
...
> see [Requirements](organizations_early_access_features_opt_ins_module.md#ansible-collections-cisco-meraki-organizations-early-access-features-opt-ins-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_early_access_features_opt_ins`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_early_access_features_opt_ins_module.md#synopsis)
- [Requirements](organizations_early_access_features_opt_ins_module.md#requirements)
- [Parameters](organizations_early_access_features_opt_ins_module.md#parameters)
- [Notes](organizations_early_access_features_opt_ins_module.md#notes)
- [See Also](organizations_early_access_features_opt_ins_module.md#see-also)
- [Examples](organizations_early_access_features_opt_ins_module.md#examples)
- [Return Values](organizations_early_access_features_opt_ins_module.md#return-values)

## [Synopsis](organizations_early_access_features_opt_ins_module.md#id1)
...
## [Requirements](organizations_early_access_features_opt_ins_module.md#id2)
...
## [Parameters](organizations_early_access_features_opt_ins_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **limitScopeToNetworks**  list / elements=string | A list of network IDs to apply the opt-in to. |
...
## [Notes](organizations_early_access_features_opt_ins_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization_early_access_features_opt_in, organizations.Organizations.delete_organization_early_access_features_opt_in, organizations.Organizations.update_organization_early_access_features_opt_in,
> - Paths used are post /organizations/{organizationId}/earlyAccess/features/optIns, delete /organizations/{organizationId}/earlyAccess/features/optIns/{optInId}, put /organizations/{organizationId}/earlyAccess/features/optIns/{optInId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_early_access_features_opt_ins_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationEarlyAccessFeaturesOptIn](https://developer.cisco.com/meraki/api-v1/#!create-organization-early-access-features-opt-in)
> :   Complete reference of the createOrganizationEarlyAccessFeaturesOptIn API.
>
> [Cisco Meraki documentation for organizations deleteOrganizationEarlyAccessFeaturesOptIn](https://developer.cisco.com/meraki/api-v1/#!delete-organization-early-access-features-opt-in)
> :   Complete reference of the deleteOrganizationEarlyAccessFeaturesOptIn API.
>
> [Cisco Meraki documentation for organizations updateOrganizationEarlyAccessFeaturesOptIn](https://developer.cisco.com/meraki/api-v1/#!update-organization-early-access-features-opt-in)
> :   Complete reference of the updateOrganizationEarlyAccessFeaturesOptIn API.

## [Examples](organizations_early_access_features_opt_ins_module.md#id6)
...
## [Return Values](organizations_early_access_features_opt_ins_module.md#id7)
