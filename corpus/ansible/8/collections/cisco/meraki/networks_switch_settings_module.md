...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_settings module – Resource module for networks _switch _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_settings_module.html
fetched_at: 2026-07-28T01:35:09+00:00
---
# cisco.meraki.networks_switch_settings module – Resource module for networks _switch _settings
...
> see [Requirements](networks_switch_settings_module.md#ansible-collections-cisco-meraki-networks-switch-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_settings_module.md#synopsis)
- [Requirements](networks_switch_settings_module.md#requirements)
- [Parameters](networks_switch_settings_module.md#parameters)
- [Notes](networks_switch_settings_module.md#notes)
- [See Also](networks_switch_settings_module.md#see-also)
- [Examples](networks_switch_settings_module.md#examples)
- [Return Values](networks_switch_settings_module.md#return-values)

## [Synopsis](networks_switch_settings_module.md#id1)
...
## [Requirements](networks_switch_settings_module.md#id2)
...
## [Parameters](networks_switch_settings_module.md#id3)
...
| **powerExceptions**  list / elements=dictionary | Exceptions on a per switch basis to “useCombinedPower”. |
| **powerType**  string | Per switch exception (combined, redundant, useNetworkSetting). |
| **serial**  string | Serial number of the switch. |
| **useCombinedPower**  boolean | The use Combined Power as the default behavior of secondary power supplies on supported devices.  **Choices:**   - `false` - `true` |
| **vlan**  integer | Management VLAN. |

## [Notes](networks_switch_settings_module.md#id4)
...
## [See Also](networks_switch_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch updateNetworkSwitchSettings](https://developer.cisco.com/meraki/api-v1/#!update-network-switch-settings)
> :   Complete reference of the updateNetworkSwitchSettings API.

## [Examples](networks_switch_settings_module.md#id6)
...
## [Return Values](networks_switch_settings_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"powerExceptions": [{"powerType": "string", "serial": "string"}], "useCombinedPower": true, "vlan": 0}` |
