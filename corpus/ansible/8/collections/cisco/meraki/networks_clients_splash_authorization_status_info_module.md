...
collection: ansible
version: "8"
title: "cisco.meraki.networks_clients_splash_authorization_status_info module – Information module for networks _clients _splashauthorizationstatus"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_clients_splash_authorization_status_info_module.html
fetched_at: 2026-07-28T01:33:52+00:00
---
# cisco.meraki.networks_clients_splash_authorization_status_info module – Information module for networks _clients _splashauthorizationstatus
...
> see [Requirements](networks_clients_splash_authorization_status_info_module.md#ansible-collections-cisco-meraki-networks-clients-splash-authorization-status-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_clients_splash_authorization_status_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_clients_splash_authorization_status_info_module.md#synopsis)
- [Requirements](networks_clients_splash_authorization_status_info_module.md#requirements)
- [Parameters](networks_clients_splash_authorization_status_info_module.md#parameters)
- [Notes](networks_clients_splash_authorization_status_info_module.md#notes)
- [See Also](networks_clients_splash_authorization_status_info_module.md#see-also)
- [Examples](networks_clients_splash_authorization_status_info_module.md#examples)
- [Return Values](networks_clients_splash_authorization_status_info_module.md#return-values)

## [Synopsis](networks_clients_splash_authorization_status_info_module.md#id1)
...
## [Requirements](networks_clients_splash_authorization_status_info_module.md#id2)
...
## [Parameters](networks_clients_splash_authorization_status_info_module.md#id3)
...
## [Notes](networks_clients_splash_authorization_status_info_module.md#id4)

> **Note:**
>
> - SDK Method used are networks.Networks.get_network_client_splash_authorization_status,
> - Paths used are get /networks/{networkId}/clients/{clientId}/splashAuthorizationStatus,
> - Supports `check_mode`
...
## [See Also](networks_clients_splash_authorization_status_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks getNetworkClientSplashAuthorizationStatus](https://developer.cisco.com/meraki/api-v1/#!get-network-client-splash-authorization-status)
> :   Complete reference of the getNetworkClientSplashAuthorizationStatus API.

## [Examples](networks_clients_splash_authorization_status_info_module.md#id6)
...
## [Return Values](networks_clients_splash_authorization_status_info_module.md#id7)
