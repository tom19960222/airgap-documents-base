...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_firewall_l7_firewall_rules module – Resource module for networks _appliance _firewall l7firewallrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_firewall_l7_firewall_rules_module.html
fetched_at: 2026-07-28T01:33:02+00:00
---
# cisco.meraki.networks_appliance_firewall_l7_firewall_rules module – Resource module for networks _appliance _firewall l7firewallrules
...
> see [Requirements](networks_appliance_firewall_l7_firewall_rules_module.md#ansible-collections-cisco-meraki-networks-appliance-firewall-l7-firewall-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_firewall_l7_firewall_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_firewall_l7_firewall_rules_module.md#synopsis)
- [Requirements](networks_appliance_firewall_l7_firewall_rules_module.md#requirements)
- [Parameters](networks_appliance_firewall_l7_firewall_rules_module.md#parameters)
- [Notes](networks_appliance_firewall_l7_firewall_rules_module.md#notes)
- [See Also](networks_appliance_firewall_l7_firewall_rules_module.md#see-also)
- [Examples](networks_appliance_firewall_l7_firewall_rules_module.md#examples)
- [Return Values](networks_appliance_firewall_l7_firewall_rules_module.md#return-values)

## [Synopsis](networks_appliance_firewall_l7_firewall_rules_module.md#id1)
...
## [Requirements](networks_appliance_firewall_l7_firewall_rules_module.md#id2)
...
## [Parameters](networks_appliance_firewall_l7_firewall_rules_module.md#id3)
...
| **rules**  list / elements=dictionary | An ordered array of the MX L7 firewall rules. |
...
## [Notes](networks_appliance_firewall_l7_firewall_rules_module.md#id4)
...
## [See Also](networks_appliance_firewall_l7_firewall_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance updateNetworkApplianceFirewallL7FirewallRules](https://developer.cisco.com/meraki/api-v1/#!update-network-appliance-firewall-l7-firewall-rules)
> :   Complete reference of the updateNetworkApplianceFirewallL7FirewallRules API.

## [Examples](networks_appliance_firewall_l7_firewall_rules_module.md#id6)
...
## [Return Values](networks_appliance_firewall_l7_firewall_rules_module.md#id7)
