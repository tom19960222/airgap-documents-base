...
collection: ansible
version: "8"
title: "cisco.meraki.networks_split module – Resource module for networks _split"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_split_module.html
fetched_at: 2026-07-28T01:34:47+00:00
---
# cisco.meraki.networks_split module – Resource module for networks _split
...
> see [Requirements](networks_split_module.md#ansible-collections-cisco-meraki-networks-split-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_split`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_split_module.md#synopsis)
- [Requirements](networks_split_module.md#requirements)
- [Parameters](networks_split_module.md#parameters)
- [Notes](networks_split_module.md#notes)
- [See Also](networks_split_module.md#see-also)
- [Examples](networks_split_module.md#examples)
- [Return Values](networks_split_module.md#return-values)

## [Synopsis](networks_split_module.md#id1)
...
## [Requirements](networks_split_module.md#id2)
...
## [Parameters](networks_split_module.md#id3)
...
## [Notes](networks_split_module.md#id4)
...
## [See Also](networks_split_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks splitNetwork](https://developer.cisco.com/meraki/api-v1/#!split-network)
> :   Complete reference of the splitNetwork API.

## [Examples](networks_split_module.md#id6)
...
## [Return Values](networks_split_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"resultingNetworks": [{"enrollmentString": "string", "id": "string", "isBoundToConfigTemplate": true, "name": "string", "notes": "string", "organizationId": "string", "productTypes": ["string"], "tags": ["string"], "timeZone": "string", "url": "string"}]}` |
