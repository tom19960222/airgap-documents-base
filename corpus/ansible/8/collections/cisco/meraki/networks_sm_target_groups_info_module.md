...
collection: ansible
version: "8"
title: "cisco.meraki.networks_sm_target_groups_info module – Information module for networks _sm _targetgroups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_sm_target_groups_info_module.html
fetched_at: 2026-07-28T01:34:41+00:00
---
# cisco.meraki.networks_sm_target_groups_info module – Information module for networks _sm _targetgroups
...
> see [Requirements](networks_sm_target_groups_info_module.md#ansible-collections-cisco-meraki-networks-sm-target-groups-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_sm_target_groups_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_sm_target_groups_info_module.md#synopsis)
- [Requirements](networks_sm_target_groups_info_module.md#requirements)
- [Parameters](networks_sm_target_groups_info_module.md#parameters)
- [Notes](networks_sm_target_groups_info_module.md#notes)
- [See Also](networks_sm_target_groups_info_module.md#see-also)
- [Examples](networks_sm_target_groups_info_module.md#examples)
- [Return Values](networks_sm_target_groups_info_module.md#return-values)

## [Synopsis](networks_sm_target_groups_info_module.md#id1)
...
## [Requirements](networks_sm_target_groups_info_module.md#id2)
...
## [Parameters](networks_sm_target_groups_info_module.md#id3)
...
| **withDetails**  boolean | WithDetails query parameter. Boolean indicating if the the ids of the devices or users scoped by the target group should be included in the response.  **Choices:**   - `false` - `true` |

## [Notes](networks_sm_target_groups_info_module.md#id4)
...
## [See Also](networks_sm_target_groups_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for sm getNetworkSmTargetGroup](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-target-group)
> :   Complete reference of the getNetworkSmTargetGroup API.
>
> [Cisco Meraki documentation for sm getNetworkSmTargetGroups](https://developer.cisco.com/meraki/api-v1/#!get-network-sm-target-groups)
> :   Complete reference of the getNetworkSmTargetGroups API.

## [Examples](networks_sm_target_groups_info_module.md#id6)
...
## [Return Values](networks_sm_target_groups_info_module.md#id7)
