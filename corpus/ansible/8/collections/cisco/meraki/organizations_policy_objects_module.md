...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_policy_objects module – Resource module for organizations _policyobjects"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_policy_objects_module.html
fetched_at: 2026-07-28T01:37:10+00:00
---
# cisco.meraki.organizations_policy_objects module – Resource module for organizations _policyobjects
...
> see [Requirements](organizations_policy_objects_module.md#ansible-collections-cisco-meraki-organizations-policy-objects-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_policy_objects`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_policy_objects_module.md#synopsis)
- [Requirements](organizations_policy_objects_module.md#requirements)
- [Parameters](organizations_policy_objects_module.md#parameters)
- [Notes](organizations_policy_objects_module.md#notes)
- [See Also](organizations_policy_objects_module.md#see-also)
- [Examples](organizations_policy_objects_module.md#examples)
- [Return Values](organizations_policy_objects_module.md#return-values)

## [Synopsis](organizations_policy_objects_module.md#id1)
...
## [Requirements](organizations_policy_objects_module.md#id2)
...
## [Parameters](organizations_policy_objects_module.md#id3)
...
| **groupIds**  list / elements=integer | The IDs of policy object groups the policy object belongs to. |
...
## [Notes](organizations_policy_objects_module.md#id4)

> **Note:**
>
> - SDK Method used are organizations.Organizations.create_organization_policy_object, organizations.Organizations.delete_organization_policy_object, organizations.Organizations.update_organization_policy_object,
> - Paths used are post /organizations/{organizationId}/policyObjects, delete /organizations/{organizationId}/policyObjects/{policyObjectId}, put /organizations/{organizationId}/policyObjects/{policyObjectId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](organizations_policy_objects_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations createOrganizationPolicyObject](https://developer.cisco.com/meraki/api-v1/#!create-organization-policy-object)
> :   Complete reference of the createOrganizationPolicyObject API.
>
> [Cisco Meraki documentation for organizations deleteOrganizationPolicyObject](https://developer.cisco.com/meraki/api-v1/#!delete-organization-policy-object)
> :   Complete reference of the deleteOrganizationPolicyObject API.
>
> [Cisco Meraki documentation for organizations updateOrganizationPolicyObject](https://developer.cisco.com/meraki/api-v1/#!update-organization-policy-object)
> :   Complete reference of the updateOrganizationPolicyObject API.

## [Examples](organizations_policy_objects_module.md#id6)
...
## [Return Values](organizations_policy_objects_module.md#id7)
