...
collection: ansible
version: "8"
title: "cisco.meraki.devices_sensor_relationships_info module – Information module for devices _sensor _relationships"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_sensor_relationships_info_module.html
fetched_at: 2026-07-28T01:32:04+00:00
---
# cisco.meraki.devices_sensor_relationships_info module – Information module for devices _sensor _relationships
...
> see [Requirements](devices_sensor_relationships_info_module.md#ansible-collections-cisco-meraki-devices-sensor-relationships-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_sensor_relationships_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_sensor_relationships_info_module.md#synopsis)
- [Requirements](devices_sensor_relationships_info_module.md#requirements)
- [Parameters](devices_sensor_relationships_info_module.md#parameters)
- [Notes](devices_sensor_relationships_info_module.md#notes)
- [See Also](devices_sensor_relationships_info_module.md#see-also)
- [Examples](devices_sensor_relationships_info_module.md#examples)
- [Return Values](devices_sensor_relationships_info_module.md#return-values)

## [Synopsis](devices_sensor_relationships_info_module.md#id1)
...
## [Requirements](devices_sensor_relationships_info_module.md#id2)
...
## [Parameters](devices_sensor_relationships_info_module.md#id3)
...
## [Notes](devices_sensor_relationships_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_sensor_relationships,
...
## [See Also](devices_sensor_relationships_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceSensorRelationships](https://developer.cisco.com/meraki/api-v1/#!get-device-sensor-relationships)
> :   Complete reference of the getDeviceSensorRelationships API.

## [Examples](devices_sensor_relationships_info_module.md#id6)
...
## [Return Values](devices_sensor_relationships_info_module.md#id7)
