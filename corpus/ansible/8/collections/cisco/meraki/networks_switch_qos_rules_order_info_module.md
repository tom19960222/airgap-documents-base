...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_qos_rules_order_info module – Information module for networks _switch _qosrules _order"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_qos_rules_order_info_module.html
fetched_at: 2026-07-28T01:35:04+00:00
---
# cisco.meraki.networks_switch_qos_rules_order_info module – Information module for networks _switch _qosrules _order
...
> see [Requirements](networks_switch_qos_rules_order_info_module.md#ansible-collections-cisco-meraki-networks-switch-qos-rules-order-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_qos_rules_order_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_qos_rules_order_info_module.md#synopsis)
- [Requirements](networks_switch_qos_rules_order_info_module.md#requirements)
- [Parameters](networks_switch_qos_rules_order_info_module.md#parameters)
- [Notes](networks_switch_qos_rules_order_info_module.md#notes)
- [See Also](networks_switch_qos_rules_order_info_module.md#see-also)
- [Examples](networks_switch_qos_rules_order_info_module.md#examples)
- [Return Values](networks_switch_qos_rules_order_info_module.md#return-values)

## [Synopsis](networks_switch_qos_rules_order_info_module.md#id1)
...
## [Requirements](networks_switch_qos_rules_order_info_module.md#id2)
...
## [Parameters](networks_switch_qos_rules_order_info_module.md#id3)
...
## [Notes](networks_switch_qos_rules_order_info_module.md#id4)
...
## [See Also](networks_switch_qos_rules_order_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchQosRule](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-qos-rule)
> :   Complete reference of the getNetworkSwitchQosRule API.
>
> [Cisco Meraki documentation for switch getNetworkSwitchQosRules](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-qos-rules)
> :   Complete reference of the getNetworkSwitchQosRules API.

## [Examples](networks_switch_qos_rules_order_info_module.md#id6)
...
## [Return Values](networks_switch_qos_rules_order_info_module.md#id7)
