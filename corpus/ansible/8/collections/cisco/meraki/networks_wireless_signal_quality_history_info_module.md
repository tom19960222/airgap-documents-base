...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_signal_quality_history_info module – Information module for networks _wireless _signalqualityhistory"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_signal_quality_history_info_module.html
fetched_at: 2026-07-28T01:35:48+00:00
---
# cisco.meraki.networks_wireless_signal_quality_history_info module – Information module for networks _wireless _signalqualityhistory
...
> see [Requirements](networks_wireless_signal_quality_history_info_module.md#ansible-collections-cisco-meraki-networks-wireless-signal-quality-history-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_signal_quality_history_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_signal_quality_history_info_module.md#synopsis)
- [Requirements](networks_wireless_signal_quality_history_info_module.md#requirements)
- [Parameters](networks_wireless_signal_quality_history_info_module.md#parameters)
- [Notes](networks_wireless_signal_quality_history_info_module.md#notes)
- [See Also](networks_wireless_signal_quality_history_info_module.md#see-also)
- [Examples](networks_wireless_signal_quality_history_info_module.md#examples)
- [Return Values](networks_wireless_signal_quality_history_info_module.md#return-values)

## [Synopsis](networks_wireless_signal_quality_history_info_module.md#id1)
...
## [Requirements](networks_wireless_signal_quality_history_info_module.md#id2)
...
## [Parameters](networks_wireless_signal_quality_history_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **apTag**  string | ApTag query parameter. Filter results by AP tag; either clientId or deviceSerial must be jointly specified. |
...
| **clientId**  string | ClientId query parameter. Filter results by network client. |
| **deviceSerial**  string | DeviceSerial query parameter. Filter results by device. |
...
| **resolution**  integer | Resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are 300, 600, 1200, 3600, 14400, 86400. The default is 86400. |
| **ssid**  integer | Ssid query parameter. Filter results by SSID number. |
...
## [Notes](networks_wireless_signal_quality_history_info_module.md#id4)

> **Note:**
>
> - SDK Method used are wireless.Wireless.get_network_wireless_signal_quality_history,
> - Paths used are get /networks/{networkId}/wireless/signalQualityHistory,
> - Supports `check_mode`
...
## [See Also](networks_wireless_signal_quality_history_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessSignalQualityHistory](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-signal-quality-history)
> :   Complete reference of the getNetworkWirelessSignalQualityHistory API.

## [Examples](networks_wireless_signal_quality_history_info_module.md#id6)
...
## [Return Values](networks_wireless_signal_quality_history_info_module.md#id7)
