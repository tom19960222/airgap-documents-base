...
collection: ansible
version: "8"
title: "cisco.meraki.networks_switch_routing_multicast_rendezvous_points_info module – Information module for networks _switch _routing _multicast _rendezvouspoints"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_switch_routing_multicast_rendezvous_points_info_module.html
fetched_at: 2026-07-28T01:35:07+00:00
---
# cisco.meraki.networks_switch_routing_multicast_rendezvous_points_info module – Information module for networks _switch _routing _multicast _rendezvouspoints
...
> see [Requirements](networks_switch_routing_multicast_rendezvous_points_info_module.md#ansible-collections-cisco-meraki-networks-switch-routing-multicast-rendezvous-points-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_switch_routing_multicast_rendezvous_points_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_switch_routing_multicast_rendezvous_points_info_module.md#synopsis)
- [Requirements](networks_switch_routing_multicast_rendezvous_points_info_module.md#requirements)
- [Parameters](networks_switch_routing_multicast_rendezvous_points_info_module.md#parameters)
- [Notes](networks_switch_routing_multicast_rendezvous_points_info_module.md#notes)
- [See Also](networks_switch_routing_multicast_rendezvous_points_info_module.md#see-also)
- [Examples](networks_switch_routing_multicast_rendezvous_points_info_module.md#examples)
- [Return Values](networks_switch_routing_multicast_rendezvous_points_info_module.md#return-values)

## [Synopsis](networks_switch_routing_multicast_rendezvous_points_info_module.md#id1)
...
## [Requirements](networks_switch_routing_multicast_rendezvous_points_info_module.md#id2)
...
## [Parameters](networks_switch_routing_multicast_rendezvous_points_info_module.md#id3)
...
## [Notes](networks_switch_routing_multicast_rendezvous_points_info_module.md#id4)

> **Note:**
>
> - SDK Method used are switch.Switch.get_network_switch_routing_multicast_rendezvous_point, switch.Switch.get_network_switch_routing_multicast_rendezvous_points,
> - Paths used are get /networks/{networkId}/switch/routing/multicast/rendezvousPoints, get /networks/{networkId}/switch/routing/multicast/rendezvousPoints/{rendezvousPointId},
> - Supports `check_mode`
...
## [See Also](networks_switch_routing_multicast_rendezvous_points_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for switch getNetworkSwitchRoutingMulticastRendezvousPoint](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-routing-multicast-rendezvous-point)
> :   Complete reference of the getNetworkSwitchRoutingMulticastRendezvousPoint API.
>
> [Cisco Meraki documentation for switch getNetworkSwitchRoutingMulticastRendezvousPoints](https://developer.cisco.com/meraki/api-v1/#!get-network-switch-routing-multicast-rendezvous-points)
> :   Complete reference of the getNetworkSwitchRoutingMulticastRendezvousPoints API.

## [Examples](networks_switch_routing_multicast_rendezvous_points_info_module.md#id6)
...
## [Return Values](networks_switch_routing_multicast_rendezvous_points_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  list / elements=list | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `[["[\n  [\n    {}\n  ]\n]\n"]]` |
