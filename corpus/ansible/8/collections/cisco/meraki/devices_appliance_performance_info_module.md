...
collection: ansible
version: "8"
title: "cisco.meraki.devices_appliance_performance_info module – Information module for devices _appliance _performance"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_appliance_performance_info_module.html
fetched_at: 2026-07-28T01:31:40+00:00
---
# cisco.meraki.devices_appliance_performance_info module – Information module for devices _appliance _performance
...
> see [Requirements](devices_appliance_performance_info_module.md#ansible-collections-cisco-meraki-devices-appliance-performance-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_appliance_performance_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_appliance_performance_info_module.md#synopsis)
- [Requirements](devices_appliance_performance_info_module.md#requirements)
- [Parameters](devices_appliance_performance_info_module.md#parameters)
- [Notes](devices_appliance_performance_info_module.md#notes)
- [See Also](devices_appliance_performance_info_module.md#see-also)
- [Examples](devices_appliance_performance_info_module.md#examples)
- [Return Values](devices_appliance_performance_info_module.md#return-values)

## [Synopsis](devices_appliance_performance_info_module.md#id1)
...
## [Requirements](devices_appliance_performance_info_module.md#id2)
...
## [Parameters](devices_appliance_performance_info_module.md#id3)
...
## [Notes](devices_appliance_performance_info_module.md#id4)

> **Note:**
>
> - SDK Method used are appliance.Appliance.get_device_appliance_performance,
> - Paths used are get /devices/{serial}/appliance/performance,
> - Supports `check_mode`
...
## [See Also](devices_appliance_performance_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance getDeviceAppliancePerformance](https://developer.cisco.com/meraki/api-v1/#!get-device-appliance-performance)
> :   Complete reference of the getDeviceAppliancePerformance API.

## [Examples](devices_appliance_performance_info_module.md#id6)
...
## [Return Values](devices_appliance_performance_info_module.md#id7)
