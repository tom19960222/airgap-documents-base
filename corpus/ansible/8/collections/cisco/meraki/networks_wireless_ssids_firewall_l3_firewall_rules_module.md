...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_ssids_firewall_l3_firewall_rules module – Resource module for networks _wireless _ssids _firewall l3firewallrules"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_ssids_firewall_l3_firewall_rules_module.html
fetched_at: 2026-07-28T01:35:54+00:00
---
# cisco.meraki.networks_wireless_ssids_firewall_l3_firewall_rules module – Resource module for networks _wireless _ssids _firewall l3firewallrules
...
> see [Requirements](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#ansible-collections-cisco-meraki-networks-wireless-ssids-firewall-l3-firewall-rules-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_ssids_firewall_l3_firewall_rules`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#synopsis)
- [Requirements](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#requirements)
- [Parameters](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#parameters)
- [Notes](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#notes)
- [See Also](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#see-also)
- [Examples](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#examples)
- [Return Values](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#return-values)

## [Synopsis](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id1)
...
## [Requirements](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id2)
...
## [Parameters](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **allowLanAccess**  boolean | Allow wireless client access to local LAN (boolean value - true allows access and false denies access) (optional).  **Choices:**   - `false` - `true` |
...
| **rules**  list / elements=dictionary | An ordered array of the firewall rules for this SSID (not including the local LAN access rule or the default rule). |
...
## [Notes](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id4)
...
## [See Also](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessSsidFirewallL3FirewallRules](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-ssid-firewall-l3-firewall-rules)
> :   Complete reference of the updateNetworkWirelessSsidFirewallL3FirewallRules API.

## [Examples](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id6)
...
## [Return Values](networks_wireless_ssids_firewall_l3_firewall_rules_module.md#id7)
