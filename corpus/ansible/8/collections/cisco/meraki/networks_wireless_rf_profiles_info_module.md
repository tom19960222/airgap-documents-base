...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_rf_profiles_info module – Information module for networks _wireless _rfprofiles"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_rf_profiles_info_module.html
fetched_at: 2026-07-28T01:35:46+00:00
---
# cisco.meraki.networks_wireless_rf_profiles_info module – Information module for networks _wireless _rfprofiles
...
> see [Requirements](networks_wireless_rf_profiles_info_module.md#ansible-collections-cisco-meraki-networks-wireless-rf-profiles-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_rf_profiles_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_rf_profiles_info_module.md#synopsis)
- [Requirements](networks_wireless_rf_profiles_info_module.md#requirements)
- [Parameters](networks_wireless_rf_profiles_info_module.md#parameters)
- [Notes](networks_wireless_rf_profiles_info_module.md#notes)
- [See Also](networks_wireless_rf_profiles_info_module.md#see-also)
- [Examples](networks_wireless_rf_profiles_info_module.md#examples)
- [Return Values](networks_wireless_rf_profiles_info_module.md#return-values)

## [Synopsis](networks_wireless_rf_profiles_info_module.md#id1)
...
## [Requirements](networks_wireless_rf_profiles_info_module.md#id2)
...
## [Parameters](networks_wireless_rf_profiles_info_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **headers**  dictionary | Additional headers. |
| **includeTemplateProfiles**  boolean | IncludeTemplateProfiles query parameter. If the network is bound to a template, this parameter controls whether or not the non-basic RF profiles defined on the template should be included in the response alongside the non-basic profiles defined on the bound network. Defaults to false.  **Choices:**   - `false` - `true` |
...
## [Notes](networks_wireless_rf_profiles_info_module.md#id4)
...
## [See Also](networks_wireless_rf_profiles_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless getNetworkWirelessRfProfile](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-rf-profile)
> :   Complete reference of the getNetworkWirelessRfProfile API.
>
> [Cisco Meraki documentation for wireless getNetworkWirelessRfProfiles](https://developer.cisco.com/meraki/api-v1/#!get-network-wireless-rf-profiles)
> :   Complete reference of the getNetworkWirelessRfProfiles API.

## [Examples](networks_wireless_rf_profiles_info_module.md#id6)
...
## [Return Values](networks_wireless_rf_profiles_info_module.md#id7)
