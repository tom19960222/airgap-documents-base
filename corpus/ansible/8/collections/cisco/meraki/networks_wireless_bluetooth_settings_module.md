...
collection: ansible
version: "8"
title: "cisco.meraki.networks_wireless_bluetooth_settings module – Resource module for networks _wireless _bluetooth _settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_wireless_bluetooth_settings_module.html
fetched_at: 2026-07-28T01:35:35+00:00
---
...
> see [Requirements](networks_wireless_bluetooth_settings_module.md#ansible-collections-cisco-meraki-networks-wireless-bluetooth-settings-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_wireless_bluetooth_settings`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_wireless_bluetooth_settings_module.md#synopsis)
- [Requirements](networks_wireless_bluetooth_settings_module.md#requirements)
- [Parameters](networks_wireless_bluetooth_settings_module.md#parameters)
- [Notes](networks_wireless_bluetooth_settings_module.md#notes)
- [See Also](networks_wireless_bluetooth_settings_module.md#see-also)
- [Examples](networks_wireless_bluetooth_settings_module.md#examples)
- [Return Values](networks_wireless_bluetooth_settings_module.md#return-values)

## [Synopsis](networks_wireless_bluetooth_settings_module.md#id1)
...
## [Requirements](networks_wireless_bluetooth_settings_module.md#id2)
...
## [Parameters](networks_wireless_bluetooth_settings_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **advertisingEnabled**  boolean | Whether APs will advertise beacons.  **Choices:**   - `false` - `true` |
...
| **scanningEnabled**  boolean | Whether APs will scan for Bluetooth enabled clients.  **Choices:**   - `false` - `true` |
| **uuid**  string | The UUID to be used in the beacon identifier. |

## [Notes](networks_wireless_bluetooth_settings_module.md#id4)
...
## [See Also](networks_wireless_bluetooth_settings_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for wireless updateNetworkWirelessBluetoothSettings](https://developer.cisco.com/meraki/api-v1/#!update-network-wireless-bluetooth-settings)
> :   Complete reference of the updateNetworkWirelessBluetoothSettings API.

## [Examples](networks_wireless_bluetooth_settings_module.md#id6)
...
## [Return Values](networks_wireless_bluetooth_settings_module.md#id7)
