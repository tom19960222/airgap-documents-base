...
collection: ansible
version: "8"
title: "cisco.meraki.networks_snmp module – Resource module for networks _snmp"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_snmp_module.html
fetched_at: 2026-07-28T01:34:46+00:00
---
# cisco.meraki.networks_snmp module – Resource module for networks _snmp
...
> see [Requirements](networks_snmp_module.md#ansible-collections-cisco-meraki-networks-snmp-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_snmp`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_snmp_module.md#synopsis)
- [Requirements](networks_snmp_module.md#requirements)
- [Parameters](networks_snmp_module.md#parameters)
- [Notes](networks_snmp_module.md#notes)
- [See Also](networks_snmp_module.md#see-also)
- [Examples](networks_snmp_module.md#examples)
- [Return Values](networks_snmp_module.md#return-values)

## [Synopsis](networks_snmp_module.md#id1)
...
## [Requirements](networks_snmp_module.md#id2)
...
## [Parameters](networks_snmp_module.md#id3)
...
| **users**  list / elements=dictionary | The list of SNMP users. Only relevant if ‘access’ is set to ‘users’. |
| **passphrase**  string | The passphrase for the SNMP user. Required. |
| **username**  string | The username for the SNMP user. Required. |

## [Notes](networks_snmp_module.md#id4)
...
## [See Also](networks_snmp_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks updateNetworkSnmp](https://developer.cisco.com/meraki/api-v1/#!update-network-snmp)
> :   Complete reference of the updateNetworkSnmp API.

## [Examples](networks_snmp_module.md#id6)
...
## [Return Values](networks_snmp_module.md#id7)
