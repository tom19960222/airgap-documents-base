...
collection: ansible
version: "8"
title: "cisco.meraki.networks_cellular_gateway_uplink_info module – Information module for networks _cellulargateway _uplink"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_cellular_gateway_uplink_info_module.html
fetched_at: 2026-07-28T01:33:46+00:00
---
# cisco.meraki.networks_cellular_gateway_uplink_info module – Information module for networks _cellulargateway _uplink
...
> see [Requirements](networks_cellular_gateway_uplink_info_module.md#ansible-collections-cisco-meraki-networks-cellular-gateway-uplink-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_cellular_gateway_uplink_info`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_cellular_gateway_uplink_info_module.md#synopsis)
- [Requirements](networks_cellular_gateway_uplink_info_module.md#requirements)
- [Parameters](networks_cellular_gateway_uplink_info_module.md#parameters)
- [Notes](networks_cellular_gateway_uplink_info_module.md#notes)
- [See Also](networks_cellular_gateway_uplink_info_module.md#see-also)
- [Examples](networks_cellular_gateway_uplink_info_module.md#examples)
- [Return Values](networks_cellular_gateway_uplink_info_module.md#return-values)

## [Synopsis](networks_cellular_gateway_uplink_info_module.md#id1)
...
## [Requirements](networks_cellular_gateway_uplink_info_module.md#id2)
...
## [Parameters](networks_cellular_gateway_uplink_info_module.md#id3)
...
## [Notes](networks_cellular_gateway_uplink_info_module.md#id4)
...
## [See Also](networks_cellular_gateway_uplink_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for cellularGateway getNetworkCellularGatewayUplink](https://developer.cisco.com/meraki/api-v1/#!get-network-cellular-gateway-uplink)
> :   Complete reference of the getNetworkCellularGatewayUplink API.

## [Examples](networks_cellular_gateway_uplink_info_module.md#id6)
...
## [Return Values](networks_cellular_gateway_uplink_info_module.md#id7)
