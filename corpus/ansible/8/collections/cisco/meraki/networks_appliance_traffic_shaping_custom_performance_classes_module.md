...
collection: ansible
version: "8"
title: "cisco.meraki.networks_appliance_traffic_shaping_custom_performance_classes module – Resource module for networks _appliance _trafficshaping _customperformanceclasses"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_appliance_traffic_shaping_custom_performance_classes_module.html
fetched_at: 2026-07-28T01:33:22+00:00
---
# cisco.meraki.networks_appliance_traffic_shaping_custom_performance_classes module – Resource module for networks _appliance _trafficshaping _customperformanceclasses
...
> see [Requirements](networks_appliance_traffic_shaping_custom_performance_classes_module.md#ansible-collections-cisco-meraki-networks-appliance-traffic-shaping-custom-performance-classes-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_appliance_traffic_shaping_custom_performance_classes`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_appliance_traffic_shaping_custom_performance_classes_module.md#synopsis)
- [Requirements](networks_appliance_traffic_shaping_custom_performance_classes_module.md#requirements)
- [Parameters](networks_appliance_traffic_shaping_custom_performance_classes_module.md#parameters)
- [Notes](networks_appliance_traffic_shaping_custom_performance_classes_module.md#notes)
- [See Also](networks_appliance_traffic_shaping_custom_performance_classes_module.md#see-also)
- [Examples](networks_appliance_traffic_shaping_custom_performance_classes_module.md#examples)
- [Return Values](networks_appliance_traffic_shaping_custom_performance_classes_module.md#return-values)

## [Synopsis](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id1)
...
## [Requirements](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id2)
...
## [Parameters](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id3)
...
## [Notes](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id4)
...
## [See Also](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for appliance createNetworkApplianceTrafficShapingCustomPerformanceClass](https://developer.cisco.com/meraki/api-v1/#!create-network-appliance-traffic-shaping-custom-performance-class)
> :   Complete reference of the createNetworkApplianceTrafficShapingCustomPerformanceClass API.

## [Examples](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id6)
...
## [Return Values](networks_appliance_traffic_shaping_custom_performance_classes_module.md#id7)
