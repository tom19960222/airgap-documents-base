...
collection: ansible
version: "8"
title: "cisco.meraki.organizations_branding_policies_priorities_info module – Information module for organizations _brandingpolicies _priorities"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/organizations_branding_policies_priorities_info_module.html
fetched_at: 2026-07-28T01:36:28+00:00
---
# cisco.meraki.organizations_branding_policies_priorities_info module – Information module for organizations _brandingpolicies _priorities
...
> see [Requirements](organizations_branding_policies_priorities_info_module.md#ansible-collections-cisco-meraki-organizations-branding-policies-priorities-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.organizations_branding_policies_priorities_info`.

New in cisco.meraki 2.16.0

- [Synopsis](organizations_branding_policies_priorities_info_module.md#synopsis)
- [Requirements](organizations_branding_policies_priorities_info_module.md#requirements)
- [Parameters](organizations_branding_policies_priorities_info_module.md#parameters)
- [Notes](organizations_branding_policies_priorities_info_module.md#notes)
- [See Also](organizations_branding_policies_priorities_info_module.md#see-also)
- [Examples](organizations_branding_policies_priorities_info_module.md#examples)
- [Return Values](organizations_branding_policies_priorities_info_module.md#return-values)

## [Synopsis](organizations_branding_policies_priorities_info_module.md#id1)
...
## [Requirements](organizations_branding_policies_priorities_info_module.md#id2)
...
## [Parameters](organizations_branding_policies_priorities_info_module.md#id3)
...
## [Notes](organizations_branding_policies_priorities_info_module.md#id4)
...
## [See Also](organizations_branding_policies_priorities_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations getOrganizationBrandingPoliciesPriorities](https://developer.cisco.com/meraki/api-v1/#!get-organization-branding-policies-priorities)
> :   Complete reference of the getOrganizationBrandingPoliciesPriorities API.

## [Examples](organizations_branding_policies_priorities_info_module.md#id6)
...
## [Return Values](organizations_branding_policies_priorities_info_module.md#id7)
