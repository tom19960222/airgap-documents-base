...
collection: ansible
version: "8"
title: "cisco.meraki.networks_clients_provision module – Resource module for networks _clients _provision"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_clients_provision_module.html
fetched_at: 2026-07-28T01:33:50+00:00
---
...
> see [Requirements](networks_clients_provision_module.md#ansible-collections-cisco-meraki-networks-clients-provision-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks_clients_provision`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_clients_provision_module.md#synopsis)
- [Requirements](networks_clients_provision_module.md#requirements)
- [Parameters](networks_clients_provision_module.md#parameters)
- [Notes](networks_clients_provision_module.md#notes)
- [See Also](networks_clients_provision_module.md#see-also)
- [Examples](networks_clients_provision_module.md#examples)
- [Return Values](networks_clients_provision_module.md#return-values)

## [Synopsis](networks_clients_provision_module.md#id1)
...
## [Requirements](networks_clients_provision_module.md#id2)
...
## [Parameters](networks_clients_provision_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **clients**  list / elements=dictionary | The array of clients to provision. |
...
| **policiesBySecurityAppliance**  dictionary | An object, describing what the policy-connection association is for the security appliance. (Only relevant if the security appliance is actually within the network). |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’ or ‘Normal’. Required. |
| **policiesBySsid**  dictionary | An object, describing the policy-connection associations for each active SSID within the network. Keys should be the number of enabled SSIDs, mapping to an object describing the client’s policy. |
| **0**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **1**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **10**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **11**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **12**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **13**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **14**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **2**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **3**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **4**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **5**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **6**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **7**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **8**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |
| **9**  dictionary | The number for the SSID. |
| **devicePolicy**  string | The policy to apply to the specified client. Can be ‘Allowed’, ‘Blocked’, ‘Normal’ or ‘Group policy’. Required. |
| **groupPolicyId**  string | The ID of the desired group policy to apply to the client. Required if ‘devicePolicy’ is set to “Group policy”. Otherwise this is ignored. |

## [Notes](networks_clients_provision_module.md#id4)
...
## [See Also](networks_clients_provision_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for networks provisionNetworkClients](https://developer.cisco.com/meraki/api-v1/#!provision-network-clients)
> :   Complete reference of the provisionNetworkClients API.

## [Examples](networks_clients_provision_module.md#id6)
...
## [Return Values](networks_clients_provision_module.md#id7)
