...
collection: ansible
version: "8"
title: "cisco.meraki.networks module – Resource module for networks"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/networks_module.html
fetched_at: 2026-07-28T01:32:50+00:00
---
# cisco.meraki.networks module – Resource module for networks
...
> see [Requirements](networks_module.md#ansible-collections-cisco-meraki-networks-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.networks`.

New in cisco.meraki 2.16.0

- [Synopsis](networks_module.md#synopsis)
- [Requirements](networks_module.md#requirements)
- [Parameters](networks_module.md#parameters)
- [Notes](networks_module.md#notes)
- [See Also](networks_module.md#see-also)
- [Examples](networks_module.md#examples)
- [Return Values](networks_module.md#return-values)

## [Synopsis](networks_module.md#id1)
...
## [Requirements](networks_module.md#id2)
...
## [Parameters](networks_module.md#id3)
...
| **productTypes**  list / elements=string | The product type(s) of the new network. If more than one type is included, the network will be a combined network. |
| **tags**  list / elements=string | A list of tags to be applied to the network. |
...
## [Notes](networks_module.md#id4)

> **Note:**
>
> - SDK Method used are organizationsnetworks.Organizationsnetworks.create_organization_network, organizationsnetworks.Organizationsnetworks.delete_network, organizationsnetworks.Organizationsnetworks.update_network,
> - Paths used are post /organizations/{organizationId}/networks, delete /networks/{networkId}, put /networks/{networkId},
> - Does not support `check_mode`
> - The plugin runs on the control node and does not use any ansible connection plugins, but instead the embedded connection manager from Cisco DNAC SDK
> - The parameters starting with dnac_ are used by the Cisco DNAC Python SDK to establish the connection

## [See Also](networks_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for organizations,networks createOrganizationNetwork](https://developer.cisco.com/meraki/api-v1/#!create-organization-network)
> :   Complete reference of the createOrganizationNetwork API.
>
> [Cisco Meraki documentation for organizations,networks deleteNetwork](https://developer.cisco.com/meraki/api-v1/#!delete-network)
> :   Complete reference of the deleteNetwork API.
>
> [Cisco Meraki documentation for organizations,networks updateNetwork](https://developer.cisco.com/meraki/api-v1/#!update-network)
> :   Complete reference of the updateNetwork API.

## [Examples](networks_module.md#id6)
...
## [Return Values](networks_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"enrollmentString": "string", "id": "string", "isBoundToConfigTemplate": true, "name": "string", "notes": "string", "organizationId": "string", "productTypes": ["string"], "tags": ["string"], "timeZone": "string", "url": "string"}` |
