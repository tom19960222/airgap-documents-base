...
collection: ansible
version: "8"
title: "cisco.meraki.devices_switch_routing_static_routes_info module – Information module for devices _switch _routing _staticroutes"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_switch_routing_static_routes_info_module.html
fetched_at: 2026-07-28T01:32:11+00:00
---
# cisco.meraki.devices_switch_routing_static_routes_info module – Information module for devices _switch _routing _staticroutes
...
> see [Requirements](devices_switch_routing_static_routes_info_module.md#ansible-collections-cisco-meraki-devices-switch-routing-static-routes-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_switch_routing_static_routes_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_switch_routing_static_routes_info_module.md#synopsis)
- [Requirements](devices_switch_routing_static_routes_info_module.md#requirements)
- [Parameters](devices_switch_routing_static_routes_info_module.md#parameters)
- [Notes](devices_switch_routing_static_routes_info_module.md#notes)
- [See Also](devices_switch_routing_static_routes_info_module.md#see-also)
- [Examples](devices_switch_routing_static_routes_info_module.md#examples)
- [Return Values](devices_switch_routing_static_routes_info_module.md#return-values)

## [Synopsis](devices_switch_routing_static_routes_info_module.md#id1)
...
## [Requirements](devices_switch_routing_static_routes_info_module.md#id2)
...
## [Parameters](devices_switch_routing_static_routes_info_module.md#id3)
...
## [Notes](devices_switch_routing_static_routes_info_module.md#id4)

> **Note:**
>
> - SDK Method used are devices.Devices.get_device_switch_routing_static_route, devices.Devices.get_device_switch_routing_static_routes,
...
## [See Also](devices_switch_routing_static_routes_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for devices getDeviceSwitchRoutingStaticRoute](https://developer.cisco.com/meraki/api-v1/#!get-device-switch-routing-static-route)
> :   Complete reference of the getDeviceSwitchRoutingStaticRoute API.
>
> [Cisco Meraki documentation for devices getDeviceSwitchRoutingStaticRoutes](https://developer.cisco.com/meraki/api-v1/#!get-device-switch-routing-static-routes)
> :   Complete reference of the getDeviceSwitchRoutingStaticRoutes API.

## [Examples](devices_switch_routing_static_routes_info_module.md#id6)
...
## [Return Values](devices_switch_routing_static_routes_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **meraki_response**  dictionary | A dictionary or list with the response returned by the Cisco Meraki Python SDK  **Returned:** always  **Sample:** `{"advertiseViaOspfEnabled": true, "name": "string", "nextHopIp": "string", "preferOverOspfRoutesEnabled": true, "staticRouteId": "string", "subnet": "string"}` |
