...
collection: ansible
version: "8"
title: "cisco.meraki.devices_camera_video_link_info module – Information module for devices _camera _videolink"
source_url: https://docs.ansible.com/projects/ansible/8/collections/cisco/meraki/devices_camera_video_link_info_module.html
fetched_at: 2026-07-28T01:31:49+00:00
---
# cisco.meraki.devices_camera_video_link_info module – Information module for devices _camera _videolink
...
> see [Requirements](devices_camera_video_link_info_module.md#ansible-collections-cisco-meraki-devices-camera-video-link-info-module-requirements) for details.
>
> To use it in a playbook, specify: `cisco.meraki.devices_camera_video_link_info`.

New in cisco.meraki 2.16.0

- [Synopsis](devices_camera_video_link_info_module.md#synopsis)
- [Requirements](devices_camera_video_link_info_module.md#requirements)
- [Parameters](devices_camera_video_link_info_module.md#parameters)
- [Notes](devices_camera_video_link_info_module.md#notes)
- [See Also](devices_camera_video_link_info_module.md#see-also)
- [Examples](devices_camera_video_link_info_module.md#examples)
- [Return Values](devices_camera_video_link_info_module.md#return-values)

## [Synopsis](devices_camera_video_link_info_module.md#id1)
...
## [Requirements](devices_camera_video_link_info_module.md#id2)
...
## [Parameters](devices_camera_video_link_info_module.md#id3)
...
## [Notes](devices_camera_video_link_info_module.md#id4)
...
## [See Also](devices_camera_video_link_info_module.md#id5)

> **See also:**
>
> [Cisco Meraki documentation for camera getDeviceCameraVideoLink](https://developer.cisco.com/meraki/api-v1/#!get-device-camera-video-link)
> :   Complete reference of the getDeviceCameraVideoLink API.

## [Examples](devices_camera_video_link_info_module.md#id6)
...
## [Return Values](devices_camera_video_link_info_module.md#id7)
