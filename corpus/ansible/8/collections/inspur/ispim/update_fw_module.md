...
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/update_fw_module.html
fetched_at: 2026-07-28T02:37:40+00:00
---
...
| **mode**  string | active mode, Manual or Auto(default).  **Choices:**   - `"Auto"` ← (default) - `"Manual"` |
