...
collection: ansible
version: "8"
title: "inspur.ispim.edit_snmp_trap module – Set snmp trap"
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/edit_snmp_trap_module.html
fetched_at: 2026-07-28T02:36:58+00:00
---
# inspur.ispim.edit_snmp_trap module – Set snmp trap
...
> see [Requirements](edit_snmp_trap_module.md#ansible-collections-inspur-ispim-edit-snmp-trap-module-requirements) for details.
>
> To use it in a playbook, specify: `inspur.ispim.edit_snmp_trap`.

New in inspur.ispim 1.0.0

- [Synopsis](edit_snmp_trap_module.md#synopsis)
- [Requirements](edit_snmp_trap_module.md#requirements)
- [Parameters](edit_snmp_trap_module.md#parameters)
- [Notes](edit_snmp_trap_module.md#notes)
...
## [Requirements](edit_snmp_trap_module.md#id2)
...
## [Parameters](edit_snmp_trap_module.md#id3)
...
| **version**  integer | SNMP trap version,1 is v1,2 is v2c(v2),3 is v3,0 is disable snmp trap.  Only the M6 model supports `0` Settings.  **Choices:**   - `0` - `1` - `2` - `3` |

## [Notes](edit_snmp_trap_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`.

## [Examples](edit_snmp_trap_module.md#id5)
...
## [Return Values](edit_snmp_trap_module.md#id6)
