...
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/edit_ncsi_module.html
fetched_at: 2026-07-28T02:36:45+00:00
---
...
| **nic_type**  string | Nic type.  Only NF3280A6 and NF3180A6 model supports `Disable` Settings, but not support `PHY` Settings.  M6 model only support `OCP`,`OCP1`,`PCIE` settings.  **Choices:**   - `"PHY"` - `"OCP"` - `"OCP1"` - `"PCIE"` - `"auto"` - `"Disable"` |
