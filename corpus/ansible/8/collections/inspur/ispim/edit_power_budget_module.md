...
collection: ansible
version: "8"
title: "inspur.ispim.edit_power_budget module – Set power budget information"
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/edit_power_budget_module.html
fetched_at: 2026-07-28T02:36:49+00:00
---
...
> see [Requirements](edit_power_budget_module.md#ansible-collections-inspur-ispim-edit-power-budget-module-requirements) for details.
>
...
- [Requirements](edit_power_budget_module.md#requirements)
- [Parameters](edit_power_budget_module.md#parameters)
- [Notes](edit_power_budget_module.md#notes)
...
## [Requirements](edit_power_budget_module.md#id2)
...
## [Parameters](edit_power_budget_module.md#id3)
...
| **except_action**  integer | Except action, 0 is do nothing, 1 is send alert, 2 is shutdown system, 3 is shutdown system and send alert.  Only the M7 model supports this parameter.  **Choices:**   - `0` - `1` - `2` - `3` |
...
## [Notes](edit_power_budget_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`.

## [Examples](edit_power_budget_module.md#id5)
...
## [Return Values](edit_power_budget_module.md#id6)
