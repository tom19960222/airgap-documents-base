...
collection: ansible
version: "8"
title: "inspur.ispim.edit_network_bond module – Set network bond"
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/edit_network_bond_module.html
fetched_at: 2026-07-28T02:36:47+00:00
---
# inspur.ispim.edit_network_bond module – Set network bond
...
> see [Requirements](edit_network_bond_module.md#ansible-collections-inspur-ispim-edit-network-bond-module-requirements) for details.
>
> To use it in a playbook, specify: `inspur.ispim.edit_network_bond`.

New in inspur.ispim 1.0.0

- [Synopsis](edit_network_bond_module.md#synopsis)
- [Requirements](edit_network_bond_module.md#requirements)
- [Parameters](edit_network_bond_module.md#parameters)
- [Notes](edit_network_bond_module.md#notes)
...
## [Requirements](edit_network_bond_module.md#id2)
...
## [Parameters](edit_network_bond_module.md#id3)
...
## [Notes](edit_network_bond_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`.

## [Examples](edit_network_bond_module.md#id5)
...
## [Return Values](edit_network_bond_module.md#id6)
