...
collection: ansible
version: "8"
title: "inspur.ispim.edit_ntp module – Set NTP"
source_url: https://docs.ansible.com/projects/ansible/8/collections/inspur/ispim/edit_ntp_module.html
fetched_at: 2026-07-28T02:36:48+00:00
---
# inspur.ispim.edit_ntp module – Set NTP
...
> see [Requirements](edit_ntp_module.md#ansible-collections-inspur-ispim-edit-ntp-module-requirements) for details.
>
> To use it in a playbook, specify: `inspur.ispim.edit_ntp`.

New in inspur.ispim 1.0.0

- [Synopsis](edit_ntp_module.md#synopsis)
- [Requirements](edit_ntp_module.md#requirements)
- [Parameters](edit_ntp_module.md#parameters)
- [Notes](edit_ntp_module.md#notes)
...
## [Requirements](edit_ntp_module.md#id2)
...
## [Parameters](edit_ntp_module.md#id3)
...
## [Notes](edit_ntp_module.md#id4)

> **Note:**
>
> - Does not support `check_mode`.

## [Examples](edit_ntp_module.md#id5)
...
## [Return Values](edit_ntp_module.md#id6)
