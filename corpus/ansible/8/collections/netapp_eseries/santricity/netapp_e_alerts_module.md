...
collection: ansible
version: "8"
title: "netapp_eseries.santricity.netapp_e_alerts module – NetApp E-Series manage email notification settings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp_eseries/santricity/netapp_e_alerts_module.html
fetched_at: 2026-07-28T02:44:22+00:00
---
...
- [Synopsis](netapp_e_alerts_module.md#synopsis)
- [Parameters](netapp_e_alerts_module.md#parameters)
- [Notes](netapp_e_alerts_module.md#notes)
- [Examples](netapp_e_alerts_module.md#examples)
- [Return Values](netapp_e_alerts_module.md#return-values)

## [Synopsis](netapp_e_alerts_module.md#id1)
...
## [Parameters](netapp_e_alerts_module.md#id2)
...
| **server**  string | A fully qualified domain name, IPv4 address, or IPv6 address of a mail server.  To use a fully qualified domain name, you must configure a DNS server on both controllers using **ERROR while parsing**: While parsing “M(netapp_e_mgmt_interface)” at index 97: Module name “netapp_e_mgmt_interface” is not a FQCN. - Required when *state=enabled*. |
...
## [Notes](netapp_e_alerts_module.md#id3)
...
## [Examples](netapp_e_alerts_module.md#id4)
...
## [Return Values](netapp_e_alerts_module.md#id5)
