...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp_eseries/santricity/netapp_e_snapshot_volume_module.html
fetched_at: 2026-07-28T02:44:38+00:00
---
...
| **snapshot_image_id**  string / required | The identifier of the snapshot image used to create the new snapshot volume.  Note: You’ll likely want to use the **ERROR while parsing**: While parsing “M(netapp_e_facts)” at index 37: Module name “netapp_e_facts” is not a FQCN module to find the ID of the image you want. |
