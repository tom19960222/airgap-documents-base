...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp_eseries/santricity/na_santricity_alerts_module.html
...
| **server**  string | A fully qualified domain name, IPv4 address, or IPv6 address of a mail server.  To use a fully qualified domain name, you must configure a DNS server on both controllers using **ERROR while parsing**: While parsing “M(na_santricity_mgmt_interface)” at index 97: Module name “na_santricity_mgmt_interface” is not a FQCN. - Required when *state=enabled*. |
