...
collection: ansible
version: "8"
title: "sensu.sensu_go.cluster_role_binding module – Manage Sensu cluster role bindings"
source_url: https://docs.ansible.com/projects/ansible/8/collections/sensu/sensu_go/cluster_role_binding_module.html
fetched_at: 2026-07-28T02:53:00+00:00
---
...
> see [Requirements](cluster_role_binding_module.md#ansible-collections-sensu-sensu-go-cluster-role-binding-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.cluster_role_binding`.

New in sensu.sensu_go 1.0.0

- [Synopsis](cluster_role_binding_module.md#synopsis)
- [Requirements](cluster_role_binding_module.md#requirements)
- [Parameters](cluster_role_binding_module.md#parameters)
- [See Also](cluster_role_binding_module.md#see-also)
- [Examples](cluster_role_binding_module.md#examples)
- [Return Values](cluster_role_binding_module.md#return-values)

## [Synopsis](cluster_role_binding_module.md#id1)
...
## [Requirements](cluster_role_binding_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](cluster_role_binding_module.md#id3)
...
| **cluster_role**  string | Name of the cluster role.  Required if *state* is `present`. |
...
## [See Also](cluster_role_binding_module.md#id4)

> **See also:**
>
> [sensu.sensu_go.cluster_role_binding_info](cluster_role_binding_info_module.md#ansible-collections-sensu-sensu-go-cluster-role-binding-info-module)
...
>
> [sensu.sensu_go.role_binding](role_binding_module.md#ansible-collections-sensu-sensu-go-role-binding-module)
> :   Manage Sensu role bindings.

## [Examples](cluster_role_binding_module.md#id5)
...
## [Return Values](cluster_role_binding_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **object**  dictionary | Object representing Sensu cluster role binding.  **Returned:** success  **Sample:** `{"metadata": {"name": "cluster-admin"}, "role_ref": {"name": "cluster-admin", "type": "ClusterRole"}, "subjects": [{"name": "cluster-admins", "type": "Group"}]}` |
