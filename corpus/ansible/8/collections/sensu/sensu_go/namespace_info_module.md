...
collection: ansible
version: "8"
title: "sensu.sensu_go.namespace_info module – List Sensu namespaces"
source_url: https://docs.ansible.com/projects/ansible/8/collections/sensu/sensu_go/namespace_info_module.html
fetched_at: 2026-07-28T02:53:22+00:00
---
# sensu.sensu_go.namespace_info module – List Sensu namespaces
...
> see [Requirements](namespace_info_module.md#ansible-collections-sensu-sensu-go-namespace-info-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.namespace_info`.

New in sensu.sensu_go 1.0.0

- [Synopsis](namespace_info_module.md#synopsis)
- [Requirements](namespace_info_module.md#requirements)
- [Parameters](namespace_info_module.md#parameters)
- [Notes](namespace_info_module.md#notes)
- [See Also](namespace_info_module.md#see-also)
- [Examples](namespace_info_module.md#examples)
- [Return Values](namespace_info_module.md#return-values)

## [Synopsis](namespace_info_module.md#id1)
...
## [Requirements](namespace_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](namespace_info_module.md#id3)
...
## [Notes](namespace_info_module.md#id4)
...
## [See Also](namespace_info_module.md#id5)

> **See also:**
>
> [sensu.sensu_go.namespace](namespace_module.md#ansible-collections-sensu-sensu-go-namespace-module)
> :   Manage Sensu namespaces.

## [Examples](namespace_info_module.md#id6)
...
## [Return Values](namespace_info_module.md#id7)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **objects**  list / elements=dictionary | List of Sensu namespaces.  **Returned:** success  **Sample:** `[{"name": "default"}]` |
