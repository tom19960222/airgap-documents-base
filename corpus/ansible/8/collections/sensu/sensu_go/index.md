...
source_url: https://docs.ansible.com/projects/ansible/8/collections/sensu/sensu_go/index.html
...
- [pipeline module](pipeline_module.md#ansible-collections-sensu-sensu-go-pipeline-module) – Manage Sensu pipeline
- [pipeline_info module](pipeline_info_module.md#ansible-collections-sensu-sensu-go-pipeline-info-module) – List available Sensu pipelines.
...
- [backends filter](backends_filter.md#ansible-collections-sensu-sensu-go-backends-filter) – Format websocket connection for backends hosts from inventory.
- [package_name filter](package_name_filter.md#ansible-collections-sensu-sensu-go-package-name-filter) – Format package name
