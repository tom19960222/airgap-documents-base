...
collection: ansible
version: "8"
title: "sensu.sensu_go.secrets_provider_info module – List Sensu secrets providers"
source_url: https://docs.ansible.com/projects/ansible/8/collections/sensu/sensu_go/secrets_provider_info_module.html
fetched_at: 2026-07-28T02:53:34+00:00
---
# sensu.sensu_go.secrets_provider_info module – List Sensu secrets providers
...
> see [Requirements](secrets_provider_info_module.md#ansible-collections-sensu-sensu-go-secrets-provider-info-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.secrets_provider_info`.

New in sensu.sensu_go 1.6.0

- [Synopsis](secrets_provider_info_module.md#synopsis)
- [Requirements](secrets_provider_info_module.md#requirements)
- [Parameters](secrets_provider_info_module.md#parameters)
- [See Also](secrets_provider_info_module.md#see-also)
- [Examples](secrets_provider_info_module.md#examples)
- [Return Values](secrets_provider_info_module.md#return-values)

## [Synopsis](secrets_provider_info_module.md#id1)
...
## [Requirements](secrets_provider_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](secrets_provider_info_module.md#id3)
...
## [See Also](secrets_provider_info_module.md#id4)
...
## [Examples](secrets_provider_info_module.md#id5)
...
## [Return Values](secrets_provider_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **objects**  list / elements=dictionary | List of Sensu secrets providers.  **Returned:** success  **Sample:** `[{"client": {"address": "https://vaultserver.example.com:8200", "max_retries": 2, "rate_limiter": {"burst": 100, "limit": 10}, "timeout": "20s", "tls": {"ca_cert": "/etc/ssl/certs/vault_ca_cert.pem"}, "token": "VAULT_TOKEN", "version": "v1"}, "metadata": {"name": "vault"}}]` |
