...
collection: ansible
version: "8"
title: "sensu.sensu_go.namespace module – Manage Sensu namespaces"
source_url: https://docs.ansible.com/projects/ansible/8/collections/sensu/sensu_go/namespace_module.html
fetched_at: 2026-07-28T02:53:21+00:00
---
# sensu.sensu_go.namespace module – Manage Sensu namespaces
...
> see [Requirements](namespace_module.md#ansible-collections-sensu-sensu-go-namespace-module-requirements) for details.
>
> To use it in a playbook, specify: `sensu.sensu_go.namespace`.

New in sensu.sensu_go 1.0.0

- [Synopsis](namespace_module.md#synopsis)
- [Requirements](namespace_module.md#requirements)
- [Parameters](namespace_module.md#parameters)
- [See Also](namespace_module.md#see-also)
- [Examples](namespace_module.md#examples)
- [Return Values](namespace_module.md#return-values)

## [Synopsis](namespace_module.md#id1)
...
## [Requirements](namespace_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 2.7

## [Parameters](namespace_module.md#id3)
...
## [See Also](namespace_module.md#id4)

> **See also:**
>
> [sensu.sensu_go.namespace_info](namespace_info_module.md#ansible-collections-sensu-sensu-go-namespace-info-module)
> :   List Sensu namespaces.

## [Examples](namespace_module.md#id5)
...
## [Return Values](namespace_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **object**  dictionary | Object representing Sensu namespace.  **Returned:** success  **Sample:** `{"name": "default"}` |
