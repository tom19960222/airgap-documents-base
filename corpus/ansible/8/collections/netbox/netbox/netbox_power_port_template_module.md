...
collection: ansible
version: "8"
title: "netbox.netbox.netbox_power_port_template module – Create, update or delete power port templates within NetBox"
source_url: https://docs.ansible.com/projects/ansible/8/collections/netbox/netbox/netbox_power_port_template_module.html
...
> see [Requirements](netbox_power_port_template_module.md#ansible-collections-netbox-netbox-netbox-power-port-template-module-requirements) for details.
>
> To use it in a playbook, specify: `netbox.netbox.netbox_power_port_template`.

New in netbox.netbox 0.2.3

- [Synopsis](netbox_power_port_template_module.md#synopsis)
- [Requirements](netbox_power_port_template_module.md#requirements)
- [Parameters](netbox_power_port_template_module.md#parameters)
- [Notes](netbox_power_port_template_module.md#notes)
- [Examples](netbox_power_port_template_module.md#examples)
- [Return Values](netbox_power_port_template_module.md#return-values)

## [Synopsis](netbox_power_port_template_module.md#id1)

- Creates, updates or removes power port templates from NetBox

## [Requirements](netbox_power_port_template_module.md#id2)

The below requirements are needed on the host that executes this module.

- pynetbox

## [Parameters](netbox_power_port_template_module.md#id3)
...
| **device_type**  any / required | The device type the power port is attached to |
...
## [Notes](netbox_power_port_template_module.md#id4)
...
## [Examples](netbox_power_port_template_module.md#id5)
...
## [Return Values](netbox_power_port_template_module.md#id6)
...
| **power_port_template**  dictionary | Serialized object as created or already existent within NetBox  **Returned:** success (when *state=present*) |
