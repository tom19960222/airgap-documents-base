...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netbox/netbox/netbox_virtual_chassis_module.html
...
| **comments**  string  *added in netbox.netbox 3.10.0* | Comments that may include additional information in regards to the virtual chassis |
| **custom_fields**  dictionary | must exist in NetBox |
| **description**  string  *added in netbox.netbox 3.10.0* | Description of the virtual chassis |
