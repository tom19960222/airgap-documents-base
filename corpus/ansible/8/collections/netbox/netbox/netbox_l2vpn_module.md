...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netbox/netbox/netbox_l2vpn_module.html
...
| **comments**  string  *added in netbox.netbox 3.10.0* | Comments that may include additional information in regards to the L2VPN |
