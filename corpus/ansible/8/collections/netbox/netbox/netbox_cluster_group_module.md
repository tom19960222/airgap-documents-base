...
collection: ansible
version: "8"
title: "netbox.netbox.netbox_cluster_group module – Create, update or delete cluster groups within NetBox"
source_url: https://docs.ansible.com/projects/ansible/8/collections/netbox/netbox/netbox_cluster_group_module.html
fetched_at: 2026-07-28T02:44:50+00:00
---
...
> see [Requirements](netbox_cluster_group_module.md#ansible-collections-netbox-netbox-netbox-cluster-group-module-requirements) for details.
>
> To use it in a playbook, specify: `netbox.netbox.netbox_cluster_group`.

New in netbox.netbox 0.1.0

- [Synopsis](netbox_cluster_group_module.md#synopsis)
- [Requirements](netbox_cluster_group_module.md#requirements)
- [Parameters](netbox_cluster_group_module.md#parameters)
- [Notes](netbox_cluster_group_module.md#notes)
- [Examples](netbox_cluster_group_module.md#examples)
- [Return Values](netbox_cluster_group_module.md#return-values)

## [Synopsis](netbox_cluster_group_module.md#id1)

- Creates, updates or removes cluster groups from NetBox

## [Requirements](netbox_cluster_group_module.md#id2)

The below requirements are needed on the host that executes this module.

- pynetbox

## [Parameters](netbox_cluster_group_module.md#id3)
...
## [Notes](netbox_cluster_group_module.md#id4)
...
## [Examples](netbox_cluster_group_module.md#id5)
...
## [Return Values](netbox_cluster_group_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **cluster_group**  dictionary | Serialized object as created or already existent within NetBox  **Returned:** success (when *state=present*) |
