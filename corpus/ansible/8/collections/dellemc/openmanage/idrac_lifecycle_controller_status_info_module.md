...
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/idrac_lifecycle_controller_status_info_module.html
...
| **lc_status_info**  dictionary | Displays the status of the Lifecycle Controller on a Dell PowerEdge server.  **Returned:** success  **Sample:** `{"msg": {"LCReady": true, "LCStatus": "Ready"}}` |
