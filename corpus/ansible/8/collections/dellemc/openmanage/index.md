...
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/index.html
fetched_at: 2026-07-28T01:02:29+00:00
---
# Dellemc.Openmanage

Collection version 7.6.1
...
- Jagadeesh N V <[Jagadeesh.N.V@Dell.com](mailto:Jagadeesh.N.V%40Dell.com)>
- Felix Stephen <[Felix.S@Dell.com](mailto:Felix.S%40Dell.com)>
- Sachin Apagundi <[Sachin.Apagundi@Dell.com](mailto:Sachin.Apagundi%40Dell.com)>
- Husniya Hameed <[Husniya.Hameed@Dellteam.com](mailto:Husniya.Hameed%40Dellteam.com)>
- Abhishek Sinha <[Abhishek.Sinha10@Dell.com](mailto:Abhishek.Sinha10%40Dell.com)>
- Kritika Bhateja <[Kritika.Bhateja@Dell.com](mailto:Kritika.Bhateja%40Dell.com)>
- Shivam Sharma <[Shivam.Sharma3@Dell.com](mailto:Shivam.Sharma3%40Dell.com)>
...
- [idrac_attributes module](idrac_attributes_module.md#ansible-collections-dellemc-openmanage-idrac-attributes-module) – Configure the iDRAC attributes.
- [idrac_bios module](idrac_bios_module.md#ansible-collections-dellemc-openmanage-idrac-bios-module) – Modify and clear BIOS attributes, reset BIOS settings and configure boot sources
- [idrac_boot module](idrac_boot_module.md#ansible-collections-dellemc-openmanage-idrac-boot-module) – Configure the boot order settings.
...
- [idrac_user_info module](idrac_user_info_module.md#ansible-collections-dellemc-openmanage-idrac-user-info-module) – Retrieve details of all users or a specific user on iDRAC.
- [idrac_virtual_media module](idrac_virtual_media_module.md#ansible-collections-dellemc-openmanage-idrac-virtual-media-module) – Configure the Remote File Share settings.
- [ome_active_directory module](ome_active_directory_module.md#ansible-collections-dellemc-openmanage-ome-active-directory-module) – Configure Active Directory groups to be used with Directory Services
...
- [ome_device_group module](ome_device_group_module.md#ansible-collections-dellemc-openmanage-ome-device-group-module) – Add or remove device(s) from a static device group on OpenManage Enterprise
...
- [ome_devices module](ome_devices_module.md#ansible-collections-dellemc-openmanage-ome-devices-module) – Perform device-specific operations on target devices
...
- [ome_domain_user_groups module](ome_domain_user_groups_module.md#ansible-collections-dellemc-openmanage-ome-domain-user-groups-module) – Create, modify, or delete an Active Directory/LDAP user group on OpenManage Enterprise and OpenManage Enterprise Modular
...
- [ome_profile_info module](ome_profile_info_module.md#ansible-collections-dellemc-openmanage-ome-profile-info-module) – Retrieve profiles with attribute details
...
- [ome_smart_fabric_info module](ome_smart_fabric_info_module.md#ansible-collections-dellemc-openmanage-ome-smart-fabric-info-module) – Retrieves the information of smart fabrics inventoried by OpenManage Enterprise Modular
...
- [ome_smart_fabric_uplink_info module](ome_smart_fabric_uplink_info_module.md#ansible-collections-dellemc-openmanage-ome-smart-fabric-uplink-info-module) – Retrieve details of fabric uplink on OpenManage Enterprise Modular.
...
- [ome_template_network_vlan_info module](ome_template_network_vlan_info_module.md#ansible-collections-dellemc-openmanage-ome-template-network-vlan-info-module) – Retrieves network configuration of template.
...
- [ome_inventory inventory](ome_inventory_inventory.md#ansible-collections-dellemc-openmanage-ome-inventory-inventory) – Group inventory plugin on OpenManage Enterprise.

## [Role Index](index.md#id3)

These are the roles in the dellemc.openmanage collection:

- [idrac_attributes role](idrac_attributes_role.md#ansible-collections-dellemc-openmanage-idrac-attributes-role) – Role to configure the iDRAC attribute
- [idrac_bios role](idrac_bios_role.md#ansible-collections-dellemc-openmanage-idrac-bios-role) – Modify and clear BIOS attributes, and reset BIOS settings
- [idrac_certificate role](idrac_certificate_role.md#ansible-collections-dellemc-openmanage-idrac-certificate-role) – This role allows to generate certificate signing request, import, and export certificates on iDRAC
- [idrac_export_server_config_profile role](idrac_export_server_config_profile_role.md#ansible-collections-dellemc-openmanage-idrac-export-server-config-profile-role) –
- [idrac_firmware role](idrac_firmware_role.md#ansible-collections-dellemc-openmanage-idrac-firmware-role) – Firmware update from a repository on a network share (CIFS, NFS, HTTP, HTTPS, FTP)
- [idrac_gather_facts role](idrac_gather_facts_role.md#ansible-collections-dellemc-openmanage-idrac-gather-facts-role) – Role to get the facts from the iDRAC Server
- [idrac_import_server_config_profile role](idrac_import_server_config_profile_role.md#ansible-collections-dellemc-openmanage-idrac-import-server-config-profile-role) –
- [idrac_os_deployment role](idrac_os_deployment_role.md#ansible-collections-dellemc-openmanage-idrac-os-deployment-role) – Role to deploy specified operating system and version on the servers
- [idrac_reset role](idrac_reset_role.md#ansible-collections-dellemc-openmanage-idrac-reset-role) – Role to reset and restart iDRAC
- [idrac_server_powerstate role](idrac_server_powerstate_role.md#ansible-collections-dellemc-openmanage-idrac-server-powerstate-role) – Role to manage the different power states of the specified device
- [idrac_storage_controller role](idrac_storage_controller_role.md#ansible-collections-dellemc-openmanage-idrac-storage-controller-role) – Configures the physical disk, virtual disk, and storage controller settings
- [redfish_firmware role](redfish_firmware_role.md#ansible-collections-dellemc-openmanage-redfish-firmware-role) – Update a component firmware using the image file available on the local or remote system
- [redfish_storage_volume role](redfish_storage_volume_role.md#ansible-collections-dellemc-openmanage-redfish-storage-volume-role) – Role to manage the storage volume configuration
