...
collection: ansible
version: "8"
title: "dellemc.openmanage.ome_template_info module – Retrieves template details from OpenManage Enterprise"
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/ome_template_info_module.html
fetched_at: 2026-07-28T02:04:51+00:00
---
...
> see [Requirements](ome_template_info_module.md#ansible-collections-dellemc-openmanage-ome-template-info-module-requirements) for details.
>
> To use it in a playbook, specify: `dellemc.openmanage.ome_template_info`.

New in dellemc.openmanage 2.0.0

- [Synopsis](ome_template_info_module.md#synopsis)
- [Requirements](ome_template_info_module.md#requirements)
- [Parameters](ome_template_info_module.md#parameters)
- [Notes](ome_template_info_module.md#notes)
- [Examples](ome_template_info_module.md#examples)
- [Return Values](ome_template_info_module.md#return-values)

## [Synopsis](ome_template_info_module.md#id1)

- This module retrieves the list and details of all the templates on OpenManage Enterprise.

## [Requirements](ome_template_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 3.8.6

## [Parameters](ome_template_info_module.md#id3)
...
## [Notes](ome_template_info_module.md#id4)
...
## [Examples](ome_template_info_module.md#id5)
