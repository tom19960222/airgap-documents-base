...
collection: ansible
version: "8"
title: "dellemc.openmanage.ome_smart_fabric_info module – Retrieves the information of smart fabrics inventoried by OpenManage Enterprise Modular"
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/ome_smart_fabric_info_module.html
...
> see [Requirements](ome_smart_fabric_info_module.md#ansible-collections-dellemc-openmanage-ome-smart-fabric-info-module-requirements) for details.
>
> To use it in a playbook, specify: `dellemc.openmanage.ome_smart_fabric_info`.

New in dellemc.openmanage 7.1.0

- [Synopsis](ome_smart_fabric_info_module.md#synopsis)
- [Requirements](ome_smart_fabric_info_module.md#requirements)
- [Parameters](ome_smart_fabric_info_module.md#parameters)
- [Notes](ome_smart_fabric_info_module.md#notes)
- [Examples](ome_smart_fabric_info_module.md#examples)
- [Return Values](ome_smart_fabric_info_module.md#return-values)

## [Synopsis](ome_smart_fabric_info_module.md#id1)

- This module retrieves the list of smart fabrics in the inventory of OpenManage Enterprise Modular.

## [Requirements](ome_smart_fabric_info_module.md#id2)

The below requirements are needed on the host that executes this module.

- python >= 3.9.6

## [Parameters](ome_smart_fabric_info_module.md#id3)
...
## [Notes](ome_smart_fabric_info_module.md#id4)
...
## [Examples](ome_smart_fabric_info_module.md#id5)
...
## [Return Values](ome_smart_fabric_info_module.md#id6)
