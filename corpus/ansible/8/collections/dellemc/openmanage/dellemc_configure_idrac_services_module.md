...
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/dellemc_configure_idrac_services_module.html
fetched_at: 2026-07-28T02:03:57+00:00
---
...
- [DEPRECATED](dellemc_configure_idrac_services_module.md#deprecated)
...
- [Status](dellemc_configure_idrac_services_module.md#status)

## [DEPRECATED](dellemc_configure_idrac_services_module.md#id1)
...
## [Synopsis](dellemc_configure_idrac_services_module.md#id2)

- This module allows to configure the iDRAC services related attributes.

## [Requirements](dellemc_configure_idrac_services_module.md#id3)
...
## [Parameters](dellemc_configure_idrac_services_module.md#id4)
...
## [Notes](dellemc_configure_idrac_services_module.md#id5)
...
## [Examples](dellemc_configure_idrac_services_module.md#id6)
...
## [Return Values](dellemc_configure_idrac_services_module.md#id7)
...
## [Status](dellemc_configure_idrac_services_module.md#id8)

- This module will be removed in a major release after 2024-07-31.
  *[deprecated]*
- For more information see [DEPRECATED](dellemc_configure_idrac_services_module.md#deprecated).
