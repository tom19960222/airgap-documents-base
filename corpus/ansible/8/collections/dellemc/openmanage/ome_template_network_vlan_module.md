...
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/openmanage/ome_template_network_vlan_module.html
fetched_at: 2026-07-28T02:04:52+00:00
---
...
| **untagged_network_id**  integer | ID of the untagged VLAN  Enter 0 to clear the untagged VLAN from the port.  This option is mutually exclusive with *untagged_network_name*  To get the VLAN network ID use the API %20https://I(hostname/api/NetworkConfigurationService/Networks) |
