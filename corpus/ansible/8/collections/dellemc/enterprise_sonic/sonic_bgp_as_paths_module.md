...
source_url: https://docs.ansible.com/projects/ansible/8/collections/dellemc/enterprise_sonic/sonic_bgp_as_paths_module.html
fetched_at: 2026-07-28T02:03:29+00:00
---
...
| **permit**  boolean | Permits or denies this as-path.  Default value while adding a new as-path-list is `False`.  **Choices:**   - `false` - `true` |
