...
collection: ansible
version: "8"
title: "netapp.um_info.na_um_aggregates_info module – NetApp Unified Manager list aggregates."
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/um_info/na_um_aggregates_info_module.html
fetched_at: 2026-07-28T02:44:00+00:00
---
# netapp.um_info.na_um_aggregates_info module – NetApp Unified Manager list aggregates.
...
> see [Requirements](na_um_aggregates_info_module.md#ansible-collections-netapp-um-info-na-um-aggregates-info-module-requirements) for details.
>
> To use it in a playbook, specify: `netapp.um_info.na_um_aggregates_info`.

New in netapp.um_info 20.5.0

- [Synopsis](na_um_aggregates_info_module.md#synopsis)
- [Requirements](na_um_aggregates_info_module.md#requirements)
- [Parameters](na_um_aggregates_info_module.md#parameters)
- [Notes](na_um_aggregates_info_module.md#notes)
- [Examples](na_um_aggregates_info_module.md#examples)
- [Return Values](na_um_aggregates_info_module.md#return-values)

## [Synopsis](na_um_aggregates_info_module.md#id1)

- List Aggregates on AIQUM.

Aliases: na_um_list_aggregates

## [Requirements](na_um_aggregates_info_module.md#id2)
...
## [Parameters](na_um_aggregates_info_module.md#id3)
...
## [Notes](na_um_aggregates_info_module.md#id4)
...
## [Examples](na_um_aggregates_info_module.md#id5)
...
## [Return Values](na_um_aggregates_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **records**  list / elements=string | Returns list of Aggregates information  **Returned:** always  **Sample:** `[{"_links": {"self": {"href": "..."}}, "block_storage": {"hybrid_cache": {"enabled": "...", "size": "..."}, "mirror": {"state": "..."}, "primary": {"raid_size": "...", "raid_type": "..."}}, "cluster": {"_links": {"self": {"href": "..."}}, "key": "...", "name": "...", "uuid": "..."}, "create_time": "...", "data_encryption": {"software_encryption_enabled": "..."}, "key": "...", "name": "...", "node": {"_links": {"self": {"href": "..."}}, "key": "...", "name": "...", "uuid": "..."}, "snaplock_type": "...", "space": {"block_storage": {"available": "...", "size": "...", "used": "..."}, "efficiency": {"logical_used": "...", "savings": "..."}}, "state": "...", "type": "...", "uuid": "..."}]` |
