...
collection: ansible
version: "8"
title: "netapp.um_info.na_um_svms_info module – NetApp Unified Manager list svms."
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/um_info/na_um_svms_info_module.html
fetched_at: 2026-07-28T02:44:02+00:00
---
...
> see [Requirements](na_um_svms_info_module.md#ansible-collections-netapp-um-info-na-um-svms-info-module-requirements) for details.
>
> To use it in a playbook, specify: `netapp.um_info.na_um_svms_info`.

New in netapp.um_info 20.5.0

- [Synopsis](na_um_svms_info_module.md#synopsis)
- [Requirements](na_um_svms_info_module.md#requirements)
- [Parameters](na_um_svms_info_module.md#parameters)
- [Notes](na_um_svms_info_module.md#notes)
- [Examples](na_um_svms_info_module.md#examples)
- [Return Values](na_um_svms_info_module.md#return-values)

## [Synopsis](na_um_svms_info_module.md#id1)

- List SVMs on AIQUM.

Aliases: na_um_list_svms

## [Requirements](na_um_svms_info_module.md#id2)
...
## [Parameters](na_um_svms_info_module.md#id3)
...
## [Notes](na_um_svms_info_module.md#id4)
...
## [Examples](na_um_svms_info_module.md#id5)
...
## [Return Values](na_um_svms_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **records**  list / elements=string | Returns list of SVMs information  **Returned:** always  **Sample:** `[{"_links": {"self": {"href": "..."}}, "aggregates": [{"_links": {"self": {"href": "..."}}, "key": "...", "name": "...", "uuid": "..."}], "cifs": {"ad_domain": {"fqdn": "..."}, "enabled": "...", "name": "..."}, "cluster": {"_links": {"self": {"href": "..."}}, "key": "...", "name": "...", "uuid": "..."}, "dns": "...", "fcp": {"enabled": "..."}, "ipspace": {"_links": {}, "key": "...", "name": "...", "uuid": "..."}, "iscsi": {"enabled": "..."}, "key": "...", "language": "...", "ldap": {"enabled": "..."}, "name": "...", "nfs": {"enabled": "..."}, "nis": {"domain": "...", "enabled": "...", "servers": "..."}, "nvme": {"enabled": "..."}, "snapshot_policy": {"_links": {}, "key": "...", "name": "...", "uuid": "..."}, "state": "...", "subtype": "default", "uuid": "..."}]` |
