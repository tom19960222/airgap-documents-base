...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/ontap/na_ontap_qos_policy_group_module.html
fetched_at: 2026-07-28T02:43:01+00:00
---
...
| **block_size**  string  *added in netapp.ontap 22.6.0* | Specifies the block size.  Requires ONTAP 9.10.1 or later.  **Choices:**   - `"any"` - `"4k"` - `"8k"` - `"16k"` - `"32k"` - `"64k"` - `"128k"` |
...
| **expected_iops_allocation**  string  *added in netapp.ontap 22.8.0* | Specifies the size to be used to calculate expected IOPS per TB.  Supported only with REST; requires ONTAP 9.10.1 or later.  **Choices:**   - `"used_space"` - `"allocated_space"` |
...
| **peak_iops_allocation**  string  *added in netapp.ontap 22.8.0* | Specifies the size to be used to calculate peak IOPS per TB.  Supported only with REST; requires ONTAP 9.10.1 or later.  **Choices:**   - `"used_space"` - `"allocated_space"` |
