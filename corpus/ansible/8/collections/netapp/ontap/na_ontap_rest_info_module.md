...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/ontap/na_ontap_rest_info_module.html
fetched_at: 2026-07-28T02:43:05+00:00
---
...
| **hal_linking**  boolean | if false, HAL-encoded links are disabled in the REST calls.  **Choices:**   - `false` - `true` ← (default) |
