...
collection: ansible
version: "8"
title: "netapp.ontap.na_ontap_motd module – Setup motd"
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/ontap/na_ontap_motd_module.html
...
> see [Requirements](na_ontap_motd_module.md#ansible-collections-netapp-ontap-na-ontap-motd-module-requirements) for details.
>
> To use it in a playbook, specify: `netapp.ontap.na_ontap_motd`.

New in netapp.ontap 2.7.0

- [Synopsis](na_ontap_motd_module.md#synopsis)
- [Requirements](na_ontap_motd_module.md#requirements)
- [Parameters](na_ontap_motd_module.md#parameters)
- [Notes](na_ontap_motd_module.md#notes)
- [Examples](na_ontap_motd_module.md#examples)

## [Synopsis](na_ontap_motd_module.md#id1)
...
## [Requirements](na_ontap_motd_module.md#id2)
...
## [Parameters](na_ontap_motd_module.md#id3)
...
| **motd_message**  aliases: message  string | MOTD Text message.  message is deprecated and will be removed to avoid a conflict with an Ansible internal variable.  **Default:** `""` |
...
| **state**  string | If `state=present` sets MOTD given in *message* `state=absent` removes it.  **Choices:**   - `"present"` ← (default) - `"absent"` |
...
## [Notes](na_ontap_motd_module.md#id4)
...
## [Examples](na_ontap_motd_module.md#id5)
