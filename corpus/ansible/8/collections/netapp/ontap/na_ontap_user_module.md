...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/ontap/na_ontap_user_module.html
...
| **vserver**  aliases: svm  string | The name of the vserver to use.  Required with ZAPI.  With REST, ignore this option for creating cluster scoped interface. |
