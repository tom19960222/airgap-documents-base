...
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/ontap/na_ontap_snapshot_policy_module.html
fetched_at: 2026-07-28T02:43:20+00:00
---
...
| **prefix**  list / elements=string  *added in netapp.ontap 19.11.0* | Snapshot name prefix for the schedule.  Prefix name should be unique within the policy.  Cannot set a different prefix to a schedule that has already been assigned to a snapshot policy.  Prefix cannot be modifed after schedule has been added. |
