...
collection: ansible
version: "8"
title: "netapp.storagegrid.na_sg_org_identity_federation module – NetApp StorageGRID manage Tenant identity federation."
source_url: https://docs.ansible.com/projects/ansible/8/collections/netapp/storagegrid/na_sg_org_identity_federation_module.html
fetched_at: 2026-07-28T02:43:57+00:00
---
# netapp.storagegrid.na_sg_org_identity_federation module – NetApp StorageGRID manage Tenant identity federation.
...
>
> To use it in a playbook, specify: `netapp.storagegrid.na_sg_org_identity_federation`.

New in netapp.storagegrid 21.6.0

- [Synopsis](na_sg_org_identity_federation_module.md#synopsis)
- [Parameters](na_sg_org_identity_federation_module.md#parameters)
- [Notes](na_sg_org_identity_federation_module.md#notes)
- [Examples](na_sg_org_identity_federation_module.md#examples)
- [Return Values](na_sg_org_identity_federation_module.md#return-values)

## [Synopsis](na_sg_org_identity_federation_module.md#id1)
...
## [Parameters](na_sg_org_identity_federation_module.md#id2)
...
## [Notes](na_sg_org_identity_federation_module.md#id3)

> **Note:**
>
> - The modules prefixed with `na_sg` are built to manage NetApp StorageGRID.

## [Examples](na_sg_org_identity_federation_module.md#id4)
