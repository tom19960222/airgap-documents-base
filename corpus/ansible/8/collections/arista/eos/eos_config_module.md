...
source_url: https://docs.ansible.com/projects/ansible/8/collections/arista/eos/eos_config_module.html
...
| **backup_options**  dictionary | This is a dict object containing configurable options related to backup file path. The value of this option is read only when `backup` is set to *true*, if `backup` is set to *no* this option will be silently ignored. |
...
| Key | Description |
| --- | --- |
| **backup_path**  string | The full path to the backup file  **Returned:** when backup is true  **Sample:** `"/playbooks/ansible/backup/eos_config.2016-07-16@22:28:34"` |
...
| **filename**  string | The name of the backup file  **Returned:** when backup is true and filename is not specified in backup options  **Sample:** `"eos_config.2016-07-16@22:28:34"` |
| **shortname**  string | The full path to the backup file excluding the timestamp  **Returned:** when backup is true and filename is not specified in backup options  **Sample:** `"/playbooks/ansible/backup/eos_config"` |
