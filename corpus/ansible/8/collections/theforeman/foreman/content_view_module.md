...
source_url: https://docs.ansible.com/projects/ansible/8/collections/theforeman/foreman/content_view_module.html
...
- [Attributes](content_view_module.md#attributes)
...
| **import_only**  boolean  *added in theforeman.foreman 3.14.0* | Designate this Content View for importing from upstream servers only.  **Choices:**   - `false` - `true` |
...
## [Attributes](content_view_module.md#id4)
...
## [Examples](content_view_module.md#id5)
...
## [Return Values](content_view_module.md#id6)
