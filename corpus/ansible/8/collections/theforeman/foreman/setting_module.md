...
source_url: https://docs.ansible.com/projects/ansible/8/collections/theforeman/foreman/setting_module.html
fetched_at: 2026-07-28T02:56:37+00:00
---
...
- [Attributes](setting_module.md#attributes)
- [Notes](setting_module.md#notes)
...
## [Attributes](setting_module.md#id4)
...
## [Notes](setting_module.md#id5)

> **Note:**
>
> - To obtain a list of possible settings for your installation, use the [theforeman.foreman.setting_info](setting_info_module.md#ansible-collections-theforeman-foreman-setting-info-module) module or the `hammer settings list` command and look for the `name` attribute.
> - The web interface by default shows the `full_name` attribute, which can’t be used with this module.

## [Examples](setting_module.md#id6)
...
## [Return Values](setting_module.md#id7)
