...
source_url: https://docs.ansible.com/projects/ansible/8/collections/theforeman/foreman/content_export_repository_module.html
fetched_at: 2026-07-28T02:55:43+00:00
---
...
- [Attributes](content_export_repository_module.md#attributes)
...
| **format**  string  *added in theforeman.foreman 3.10.0* | Export format.  Choose `syncable` if the exported content needs to be in a yum format.  **Choices:**   - `"syncable"` - `"importable"` |
...
## [Attributes](content_export_repository_module.md#id4)
...
## [Examples](content_export_repository_module.md#id5)
