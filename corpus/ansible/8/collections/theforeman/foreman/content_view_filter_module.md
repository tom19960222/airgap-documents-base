...
source_url: https://docs.ansible.com/projects/ansible/8/collections/theforeman/foreman/content_view_filter_module.html
fetched_at: 2026-07-28T02:55:46+00:00
---
...
- [Attributes](content_view_filter_module.md#attributes)
...
| **filter_type**  string / required | Content view filter type  **Choices:**   - `"rpm"` - `"package_group"` - `"erratum"` - `"docker"` - `"modulemd"` - `"deb"` |
...
| **original_module_streams**  boolean  *added in theforeman.foreman 3.10.0* | Include all module streams with no errata  Only valid on *filter_type=modulemd*.  **Choices:**   - `false` - `true` |
...
## [Attributes](content_view_filter_module.md#id4)
...
## [Examples](content_view_filter_module.md#id5)
...
## [Return Values](content_view_filter_module.md#id6)
