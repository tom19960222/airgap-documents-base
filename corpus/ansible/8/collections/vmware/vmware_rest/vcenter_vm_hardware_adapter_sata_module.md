...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_hardware_adapter_sata module – Adds a virtual SATA adapter to the virtual machine."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_hardware_adapter_sata_module.html
fetched_at: 2026-07-28T02:58:06+00:00
---
...
> see [Requirements](vcenter_vm_hardware_adapter_sata_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-hardware-adapter-sata-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_hardware_adapter_sata`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_hardware_adapter_sata_module.md#synopsis)
- [Requirements](vcenter_vm_hardware_adapter_sata_module.md#requirements)
- [Parameters](vcenter_vm_hardware_adapter_sata_module.md#parameters)
- [Notes](vcenter_vm_hardware_adapter_sata_module.md#notes)
- [Examples](vcenter_vm_hardware_adapter_sata_module.md#examples)
- [Return Values](vcenter_vm_hardware_adapter_sata_module.md#return-values)

## [Synopsis](vcenter_vm_hardware_adapter_sata_module.md#id1)

- Adds a virtual SATA adapter to the virtual machine.

## [Requirements](vcenter_vm_hardware_adapter_sata_module.md#id2)
...
## [Parameters](vcenter_vm_hardware_adapter_sata_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **adapter**  string | Virtual SATA adapter identifier. Required with *state=[‘absent’]* |
| **bus**  integer | SATA bus number. |
| **label**  string | The name of the item |
| **pci_slot_number**  integer | Address of the SATA adapter on the PCI bus. |
...
| **type**  string | The `type` defines the valid emulation types for a virtual SATA adapter.  **Choices:**   - `"AHCI"` |
...
## [Notes](vcenter_vm_hardware_adapter_sata_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_hardware_adapter_sata_module.md#id5)
...
## [Return Values](vcenter_vm_hardware_adapter_sata_module.md#id6)
...
| **value**  dictionary | Create a SATA adapter at PCI slot 34  **Returned:** On success  **Sample:** `{"bus": 0, "label": "SATA controller 0", "pci_slot_number": 34, "type": "AHCI"}` |
