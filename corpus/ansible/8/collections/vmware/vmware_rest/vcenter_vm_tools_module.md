...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_tools module – Update the properties of VMware Tools."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_tools_module.html
fetched_at: 2026-07-28T02:58:35+00:00
---
...
> see [Requirements](vcenter_vm_tools_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-tools-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_tools`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_tools_module.md#synopsis)
- [Requirements](vcenter_vm_tools_module.md#requirements)
- [Parameters](vcenter_vm_tools_module.md#parameters)
- [Notes](vcenter_vm_tools_module.md#notes)
- [Examples](vcenter_vm_tools_module.md#examples)
- [Return Values](vcenter_vm_tools_module.md#return-values)

## [Synopsis](vcenter_vm_tools_module.md#id1)

- Update the properties of VMware Tools.

## [Requirements](vcenter_vm_tools_module.md#id2)
...
## [Parameters](vcenter_vm_tools_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **command_line_options**  string | Command line options passed to the installer to modify the installation procedure for Tools. |
...
| **upgrade_policy**  string | The `upgrade_policy` defines when Tools are auto-upgraded for a virtual machine.  **Choices:**   - `"MANUAL"` - `"UPGRADE_AT_POWER_CYCLE"` |
...
## [Notes](vcenter_vm_tools_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_tools_module.md#id5)
...
## [Return Values](vcenter_vm_tools_module.md#id6)
...
| **value**  dictionary | Retrive vm-tools information  **Returned:** On success  **Sample:** `{"auto_update_supported": 0, "install_attempt_count": 0, "install_type": "OPEN_VM_TOOLS", "run_state": "RUNNING", "upgrade_policy": "MANUAL", "version": "10346", "version_number": 10346, "version_status": "UNMANAGED"}` |
