...
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_update_info_module.html
...
| Key | Description |
| --- | --- |
| **value**  dictionary | Check if the system is up to date  **Returned:** On success  **Sample:** `{"state": "UP_TO_DATE", "version": "7.0.3.00800"}` |
