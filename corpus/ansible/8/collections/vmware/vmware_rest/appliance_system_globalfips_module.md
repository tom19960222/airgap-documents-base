...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_system_globalfips module – Enable/Disable Global FIPS mode for the appliance"
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_system_globalfips_module.html
fetched_at: 2026-07-28T02:57:32+00:00
---
# vmware.vmware_rest.appliance_system_globalfips module – Enable/Disable Global FIPS mode for the appliance
...
> see [Requirements](appliance_system_globalfips_module.md#ansible-collections-vmware-vmware-rest-appliance-system-globalfips-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_system_globalfips`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_system_globalfips_module.md#synopsis)
- [Requirements](appliance_system_globalfips_module.md#requirements)
- [Parameters](appliance_system_globalfips_module.md#parameters)
- [Notes](appliance_system_globalfips_module.md#notes)
- [Examples](appliance_system_globalfips_module.md#examples)

## [Synopsis](appliance_system_globalfips_module.md#id1)
...
## [Requirements](appliance_system_globalfips_module.md#id2)
...
## [Parameters](appliance_system_globalfips_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean | FIPS setting state.  **Choices:**   - `false` - `true` |
...
## [Notes](appliance_system_globalfips_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_system_globalfips_module.md#id5)
