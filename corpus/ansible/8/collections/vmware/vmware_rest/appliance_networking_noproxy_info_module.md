...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_networking_noproxy_info module – Returns servers for which no proxy configuration will be applied."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_networking_noproxy_info_module.html
fetched_at: 2026-07-28T02:57:25+00:00
---
# vmware.vmware_rest.appliance_networking_noproxy_info module – Returns servers for which no proxy configuration will be applied.
...
> see [Requirements](appliance_networking_noproxy_info_module.md#ansible-collections-vmware-vmware-rest-appliance-networking-noproxy-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_networking_noproxy_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_networking_noproxy_info_module.md#synopsis)
- [Requirements](appliance_networking_noproxy_info_module.md#requirements)
- [Parameters](appliance_networking_noproxy_info_module.md#parameters)
- [Notes](appliance_networking_noproxy_info_module.md#notes)
- [Examples](appliance_networking_noproxy_info_module.md#examples)
- [Return Values](appliance_networking_noproxy_info_module.md#return-values)

## [Synopsis](appliance_networking_noproxy_info_module.md#id1)

- Returns servers for which no proxy configuration will be applied.

## [Requirements](appliance_networking_noproxy_info_module.md#id2)
...
## [Parameters](appliance_networking_noproxy_info_module.md#id3)
...
## [Notes](appliance_networking_noproxy_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_networking_noproxy_info_module.md#id5)
...
## [Return Values](appliance_networking_noproxy_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  list / elements=string | Get HTTP noproxy configuration  **Returned:** On success  **Sample:** `["localhost", "127.0.0.1"]` |
