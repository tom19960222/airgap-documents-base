...
collection: ansible
version: "8"
title: "vmware.vmware_rest.datacenter_moid lookup – Look up MoID for vSphere datacenter objects using vCenter REST API"
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/datacenter_moid_lookup.html
fetched_at: 2026-07-28T02:58:40+00:00
---
# vmware.vmware_rest.datacenter_moid lookup – Look up MoID for vSphere datacenter objects using vCenter REST API
...
> see [Requirements](datacenter_moid_lookup.md#ansible-collections-vmware-vmware-rest-datacenter-moid-lookup-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.datacenter_moid`.

New in vmware.vmware_rest 2.1.0

- [Synopsis](datacenter_moid_lookup.md#synopsis)
- [Requirements](datacenter_moid_lookup.md#requirements)
- [Terms](datacenter_moid_lookup.md#terms)
- [Keyword parameters](datacenter_moid_lookup.md#keyword-parameters)
- [Notes](datacenter_moid_lookup.md#notes)
- [Examples](datacenter_moid_lookup.md#examples)
- [Return Value](datacenter_moid_lookup.md#return-value)

## [Synopsis](datacenter_moid_lookup.md#id1)

- Returns Managed Object Reference (MoID) of the vSphere datacenter object contained in the specified path.

## [Requirements](datacenter_moid_lookup.md#id2)
...
## [Terms](datacenter_moid_lookup.md#id3)

| Parameter | Comments |
| --- | --- |
| **Terms**  string / required | Path to query. |

## [Keyword parameters](datacenter_moid_lookup.md#id4)

This describes keyword parameters of the lookup. These are the values `key1=value1`, `key2=value2` and so on in the following
examples: `lookup('vmware.vmware_rest.datacenter_moid', key1=value1, key2=value2, ...)` and `query('vmware.vmware_rest.datacenter_moid', key1=value1, key2=value2, ...)`
...
## [Notes](datacenter_moid_lookup.md#id5)

> **Note:**
>
> - When keyword and positional parameters are used together, positional parameters must be listed before keyword parameters:
>   `lookup('vmware.vmware_rest.datacenter_moid', term1, term2, key1=value1, key2=value2)` and `query('vmware.vmware_rest.datacenter_moid', term1, term2, key1=value1, key2=value2)`

## [Examples](datacenter_moid_lookup.md#id6)
...
## [Return Value](datacenter_moid_lookup.md#id7)

| Key | Description |
| --- | --- |
| **Return value**  string | MoID of the vSphere datacenter object  **Returned:** success  **Sample:** `"datacenter-1001"` |
