...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_access_shell module – Set enabled state of BASH, that is, access to BASH from within the controlled CLI."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_access_shell_module.html
fetched_at: 2026-07-28T02:56:56+00:00
---
# vmware.vmware_rest.appliance_access_shell module – Set enabled state of BASH, that is, access to BASH from within the controlled CLI.
...
> see [Requirements](appliance_access_shell_module.md#ansible-collections-vmware-vmware-rest-appliance-access-shell-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_access_shell`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_access_shell_module.md#synopsis)
- [Requirements](appliance_access_shell_module.md#requirements)
- [Parameters](appliance_access_shell_module.md#parameters)
- [Notes](appliance_access_shell_module.md#notes)
- [Examples](appliance_access_shell_module.md#examples)
- [Return Values](appliance_access_shell_module.md#return-values)

## [Synopsis](appliance_access_shell_module.md#id1)

- Set enabled state of BASH, that is, access to BASH from within the controlled CLI.

## [Requirements](appliance_access_shell_module.md#id2)
...
## [Parameters](appliance_access_shell_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean / required | Enabled can be set to true or false This parameter is mandatory.  **Choices:**   - `false` - `true` |
...
| **timeout**  integer / required | The timeout (in seconds) specifies how long you enable the Shell access. The maximum timeout is 86400 seconds(1 day). This parameter is mandatory. |
...
## [Notes](appliance_access_shell_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_access_shell_module.md#id5)
...
## [Return Values](appliance_access_shell_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Disable the Shell  **Returned:** On success  **Sample:** `{"enabled": 0, "timeout": 0}` |
