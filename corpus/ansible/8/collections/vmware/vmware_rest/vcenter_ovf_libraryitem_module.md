...
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_ovf_libraryitem_module.html
...
| Key | Description |
| --- | --- |
| **value**  dictionary | Create a new VM from the OVF and specify the host and folder  **Returned:** On success  **Sample:** `{"error": {"errors": [], "information": [], "warnings": []}, "resource_id": {"id": "vm-1078", "type": "VirtualMachine"}, "succeeded": 1}` |
