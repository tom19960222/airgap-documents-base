...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_storage_policy module – Updates the storage policy configuration of a virtual machine and/or its associated virtual hard disks."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_storage_policy_module.html
fetched_at: 2026-07-28T02:58:29+00:00
---
...
> see [Requirements](vcenter_vm_storage_policy_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-storage-policy-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_storage_policy`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_storage_policy_module.md#synopsis)
- [Requirements](vcenter_vm_storage_policy_module.md#requirements)
- [Parameters](vcenter_vm_storage_policy_module.md#parameters)
- [Notes](vcenter_vm_storage_policy_module.md#notes)
- [Examples](vcenter_vm_storage_policy_module.md#examples)
- [Return Values](vcenter_vm_storage_policy_module.md#return-values)

## [Synopsis](vcenter_vm_storage_policy_module.md#id1)

- Updates the storage policy configuration of a virtual machine and/or its associated virtual hard disks.

## [Requirements](vcenter_vm_storage_policy_module.md#id2)
...
## [Parameters](vcenter_vm_storage_policy_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **disks**  dictionary | Storage policy or policies to be used when reconfiguring virtual machine diks. |
...
| **vm_home**  dictionary / required | Storage policy to be used when reconfiguring the virtual machine home. This parameter is mandatory.  Valid attributes are:  - `type` (str): The `policy_type` defines the choices for how to specify the policy to be associated with the virtual machine home’s directory. ([‘present’])  This key is required with [‘present’].    - Accepted values:      - USE_DEFAULT_POLICY     - USE_SPECIFIED_POLICY - `policy` (str): Storage Policy identification. ([‘present’]) |

## [Notes](vcenter_vm_storage_policy_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_storage_policy_module.md#id5)
...
## [Return Values](vcenter_vm_storage_policy_module.md#id6)
...
| **value**  dictionary | Adjust VM storage policy  **Returned:** On success  **Sample:** `{}` |
