...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_health_load_info module – Get load health."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_health_load_info_module.html
fetched_at: 2026-07-28T02:57:02+00:00
---
# vmware.vmware_rest.appliance_health_load_info module – Get load health.
...
> see [Requirements](appliance_health_load_info_module.md#ansible-collections-vmware-vmware-rest-appliance-health-load-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_health_load_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_health_load_info_module.md#synopsis)
- [Requirements](appliance_health_load_info_module.md#requirements)
- [Parameters](appliance_health_load_info_module.md#parameters)
- [Notes](appliance_health_load_info_module.md#notes)
- [Examples](appliance_health_load_info_module.md#examples)
- [Return Values](appliance_health_load_info_module.md#return-values)

## [Synopsis](appliance_health_load_info_module.md#id1)

- Get load health.

## [Requirements](appliance_health_load_info_module.md#id2)
...
## [Parameters](appliance_health_load_info_module.md#id3)
...
## [Notes](appliance_health_load_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_health_load_info_module.md#id5)
...
## [Return Values](appliance_health_load_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  string | Get the system load status  **Returned:** On success  **Sample:** `"green"` |
