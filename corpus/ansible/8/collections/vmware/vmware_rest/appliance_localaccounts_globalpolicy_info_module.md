...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_localaccounts_globalpolicy_info module – Get the global password policy."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_localaccounts_globalpolicy_info_module.html
fetched_at: 2026-07-28T02:57:08+00:00
---
# vmware.vmware_rest.appliance_localaccounts_globalpolicy_info module – Get the global password policy.
...
> see [Requirements](appliance_localaccounts_globalpolicy_info_module.md#ansible-collections-vmware-vmware-rest-appliance-localaccounts-globalpolicy-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_localaccounts_globalpolicy_info`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_localaccounts_globalpolicy_info_module.md#synopsis)
- [Requirements](appliance_localaccounts_globalpolicy_info_module.md#requirements)
- [Parameters](appliance_localaccounts_globalpolicy_info_module.md#parameters)
- [Notes](appliance_localaccounts_globalpolicy_info_module.md#notes)
- [Examples](appliance_localaccounts_globalpolicy_info_module.md#examples)
- [Return Values](appliance_localaccounts_globalpolicy_info_module.md#return-values)

## [Synopsis](appliance_localaccounts_globalpolicy_info_module.md#id1)

- Get the global password policy.

## [Requirements](appliance_localaccounts_globalpolicy_info_module.md#id2)
...
## [Parameters](appliance_localaccounts_globalpolicy_info_module.md#id3)
...
## [Notes](appliance_localaccounts_globalpolicy_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_localaccounts_globalpolicy_info_module.md#id5)
...
## [Return Values](appliance_localaccounts_globalpolicy_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Get the global policy of the local accounts  **Returned:** On success  **Sample:** `{"max_days": 90, "min_days": 1, "warn_days": 7}` |
