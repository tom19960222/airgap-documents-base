...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_networking module – Reset and restarts network configuration on all interfaces, also this will renew the DHCP lease for DHCP IP address."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_networking_module.html
fetched_at: 2026-07-28T02:57:11+00:00
---
...
> see [Requirements](appliance_networking_module.md#ansible-collections-vmware-vmware-rest-appliance-networking-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_networking`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_networking_module.md#synopsis)
- [Requirements](appliance_networking_module.md#requirements)
- [Parameters](appliance_networking_module.md#parameters)
- [Notes](appliance_networking_module.md#notes)
- [Examples](appliance_networking_module.md#examples)
- [Return Values](appliance_networking_module.md#return-values)

## [Synopsis](appliance_networking_module.md#id1)

- Reset and restarts network configuration on all interfaces, also this will renew the DHCP lease for DHCP IP address.

## [Requirements](appliance_networking_module.md#id2)
...
## [Parameters](appliance_networking_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **ipv6_enabled**  boolean | IPv6 Enabled or not  **Choices:**   - `false` - `true` |
...
| **state**  string | **Choices:**   - `"present"` ← (default) - `"reset"` |
...
## [Notes](appliance_networking_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_networking_module.md#id5)
...
## [Return Values](appliance_networking_module.md#id6)
...
| **value**  dictionary | Set network information  **Returned:** On success  **Sample:** `{}` |
