...
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_infraprofile_configs_info_module.html
...
| Key | Description |
| --- | --- |
| **value**  list / elements=string | List infraprofile configs  **Returned:** On success  **Sample:** `[{"info": "ApplianceManagement", "name": "ApplianceManagement"}, {"info": "ApplianceNetwork", "name": "ApplianceNetwork"}, {"info": "Authentication & Authorization Management", "name": "AuthManagement"}]` |
