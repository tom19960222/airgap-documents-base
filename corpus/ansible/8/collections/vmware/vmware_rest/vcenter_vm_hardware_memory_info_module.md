...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_hardware_memory_info module – Returns the memory-related settings of a virtual machine."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_hardware_memory_info_module.html
fetched_at: 2026-07-28T02:58:22+00:00
---
# vmware.vmware_rest.vcenter_vm_hardware_memory_info module – Returns the memory-related settings of a virtual machine.
...
> see [Requirements](vcenter_vm_hardware_memory_info_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-hardware-memory-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_hardware_memory_info`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_hardware_memory_info_module.md#synopsis)
- [Requirements](vcenter_vm_hardware_memory_info_module.md#requirements)
- [Parameters](vcenter_vm_hardware_memory_info_module.md#parameters)
- [Notes](vcenter_vm_hardware_memory_info_module.md#notes)
- [Examples](vcenter_vm_hardware_memory_info_module.md#examples)
- [Return Values](vcenter_vm_hardware_memory_info_module.md#return-values)

## [Synopsis](vcenter_vm_hardware_memory_info_module.md#id1)

- Returns the memory-related settings of a virtual machine.

## [Requirements](vcenter_vm_hardware_memory_info_module.md#id2)
...
## [Parameters](vcenter_vm_hardware_memory_info_module.md#id3)
...
## [Notes](vcenter_vm_hardware_memory_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_hardware_memory_info_module.md#id5)
...
## [Return Values](vcenter_vm_hardware_memory_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Retrieve the memory information from the VM  **Returned:** On success  **Sample:** `{"hot_add_enabled": 1, "size_MiB": 1024}` |
