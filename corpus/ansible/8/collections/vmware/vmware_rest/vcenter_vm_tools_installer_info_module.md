...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_tools_installer_info module – Get information about the VMware Tools installer."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_tools_installer_info_module.html
fetched_at: 2026-07-28T02:58:37+00:00
---
# vmware.vmware_rest.vcenter_vm_tools_installer_info module – Get information about the VMware Tools installer.
...
> see [Requirements](vcenter_vm_tools_installer_info_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-tools-installer-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_tools_installer_info`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_tools_installer_info_module.md#synopsis)
- [Requirements](vcenter_vm_tools_installer_info_module.md#requirements)
- [Parameters](vcenter_vm_tools_installer_info_module.md#parameters)
- [Notes](vcenter_vm_tools_installer_info_module.md#notes)
- [Examples](vcenter_vm_tools_installer_info_module.md#examples)
- [Return Values](vcenter_vm_tools_installer_info_module.md#return-values)

## [Synopsis](vcenter_vm_tools_installer_info_module.md#id1)

- Get information about the VMware Tools installer.

## [Requirements](vcenter_vm_tools_installer_info_module.md#id2)
...
## [Parameters](vcenter_vm_tools_installer_info_module.md#id3)
...
## [Notes](vcenter_vm_tools_installer_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_tools_installer_info_module.md#id5)
...
## [Return Values](vcenter_vm_tools_installer_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Get information about the vm-tools  **Returned:** On success  **Sample:** `{"is_connected": 0}` |
