...
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_ntp_info_module.html
fetched_at: 2026-07-28T02:57:28+00:00
---
...
| Key | Description |
| --- | --- |
| **value**  list / elements=string | Get the NTP configuration  **Returned:** On success  **Sample:** `["time.nist.gov"]` |
