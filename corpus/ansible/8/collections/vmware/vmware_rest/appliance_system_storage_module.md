...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_system_storage module – Resize all partitions to 100 percent of disk size."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_system_storage_module.html
fetched_at: 2026-07-28T02:57:34+00:00
---
# vmware.vmware_rest.appliance_system_storage module – Resize all partitions to 100 percent of disk size.
...
> see [Requirements](appliance_system_storage_module.md#ansible-collections-vmware-vmware-rest-appliance-system-storage-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_system_storage`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_system_storage_module.md#synopsis)
- [Requirements](appliance_system_storage_module.md#requirements)
- [Parameters](appliance_system_storage_module.md#parameters)
- [Notes](appliance_system_storage_module.md#notes)
- [Examples](appliance_system_storage_module.md#examples)
- [Return Values](appliance_system_storage_module.md#return-values)

## [Synopsis](appliance_system_storage_module.md#id1)

- Resize all partitions to 100 percent of disk size.

## [Requirements](appliance_system_storage_module.md#id2)
...
## [Parameters](appliance_system_storage_module.md#id3)
...
| **state**  string / required | **Choices:**   - `"resize"` - `"resize_ex"` |
...
## [Notes](appliance_system_storage_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_system_storage_module.md#id5)
...
## [Return Values](appliance_system_storage_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Resize the first partition and return the state of the partition before and after the operation  **Returned:** On success  **Sample:** `{"lv_root_0": {"new_size": 104312832, "old_size": 53985280}}` |
