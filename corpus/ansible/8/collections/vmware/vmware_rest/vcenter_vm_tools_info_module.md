...
collection: ansible
version: "8"
title: "vmware.vmware_rest.vcenter_vm_tools_info module – Get the properties of VMware Tools."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/vcenter_vm_tools_info_module.html
...
> see [Requirements](vcenter_vm_tools_info_module.md#ansible-collections-vmware-vmware-rest-vcenter-vm-tools-info-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.vcenter_vm_tools_info`.

New in vmware.vmware_rest 0.1.0

- [Synopsis](vcenter_vm_tools_info_module.md#synopsis)
- [Requirements](vcenter_vm_tools_info_module.md#requirements)
- [Parameters](vcenter_vm_tools_info_module.md#parameters)
- [Notes](vcenter_vm_tools_info_module.md#notes)
- [Examples](vcenter_vm_tools_info_module.md#examples)
- [Return Values](vcenter_vm_tools_info_module.md#return-values)

## [Synopsis](vcenter_vm_tools_info_module.md#id1)

- Get the properties of VMware Tools.

## [Requirements](vcenter_vm_tools_info_module.md#id2)
...
## [Parameters](vcenter_vm_tools_info_module.md#id3)
...
## [Notes](vcenter_vm_tools_info_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](vcenter_vm_tools_info_module.md#id5)
...
## [Return Values](vcenter_vm_tools_info_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Wait until my VM is ready  **Returned:** On success  **Sample:** `{"auto_update_supported": 0, "install_attempt_count": 0, "install_type": "OPEN_VM_TOOLS", "run_state": "RUNNING", "upgrade_policy": "MANUAL", "version": "10346", "version_number": 10346, "version_status": "UNMANAGED"}` |
