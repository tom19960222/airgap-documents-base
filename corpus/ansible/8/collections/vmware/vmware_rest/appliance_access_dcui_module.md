...
collection: ansible
version: "8"
title: "vmware.vmware_rest.appliance_access_dcui module – Set enabled state of Direct Console User Interface (DCUI TTY2)."
source_url: https://docs.ansible.com/projects/ansible/8/collections/vmware/vmware_rest/appliance_access_dcui_module.html
fetched_at: 2026-07-28T02:56:55+00:00
---
# vmware.vmware_rest.appliance_access_dcui module – Set enabled state of Direct Console User Interface (DCUI TTY2).
...
> see [Requirements](appliance_access_dcui_module.md#ansible-collections-vmware-vmware-rest-appliance-access-dcui-module-requirements) for details.
>
> To use it in a playbook, specify: `vmware.vmware_rest.appliance_access_dcui`.

New in vmware.vmware_rest 2.0.0

- [Synopsis](appliance_access_dcui_module.md#synopsis)
- [Requirements](appliance_access_dcui_module.md#requirements)
- [Parameters](appliance_access_dcui_module.md#parameters)
- [Notes](appliance_access_dcui_module.md#notes)
- [Examples](appliance_access_dcui_module.md#examples)
- [Return Values](appliance_access_dcui_module.md#return-values)

## [Synopsis](appliance_access_dcui_module.md#id1)

- Set enabled state of Direct Console User Interface (DCUI TTY2).

## [Requirements](appliance_access_dcui_module.md#id2)
...
## [Parameters](appliance_access_dcui_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **enabled**  boolean / required | DCUI is enabled. This parameter is mandatory.  **Choices:**   - `false` - `true` |
...
## [Notes](appliance_access_dcui_module.md#id4)

> **Note:**
>
> - Tested on vSphere 7.0.2

## [Examples](appliance_access_dcui_module.md#id5)
...
## [Return Values](appliance_access_dcui_module.md#id6)

Common return values are documented [here](../../../reference_appendices/common_return_values.md#common-return-values), the following are the fields unique to this module:

| Key | Description |
| --- | --- |
| **value**  dictionary | Disable the Direct Console User Interface  **Returned:** On success  **Sample:** `{}` |
