...
collection: ansible
version: "8"
title: "purestorage.fusion.fusion_region module – Manage Regions in Pure Storage Fusion"
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/fusion/fusion_region_module.html
fetched_at: 2026-07-28T02:52:42+00:00
---
# purestorage.fusion.fusion_region module – Manage Regions in Pure Storage Fusion
...
> see [Requirements](fusion_region_module.md#ansible-collections-purestorage-fusion-fusion-region-module-requirements) for details.
>
> To use it in a playbook, specify: `purestorage.fusion.fusion_region`.

New in purestorage.fusion 1.1.0

- [Synopsis](fusion_region_module.md#synopsis)
- [Requirements](fusion_region_module.md#requirements)
- [Parameters](fusion_region_module.md#parameters)
- [Notes](fusion_region_module.md#notes)
- [Examples](fusion_region_module.md#examples)

## [Synopsis](fusion_region_module.md#id1)

- Manage regions in Pure Storage Fusion.

## [Requirements](fusion_region_module.md#id2)
...
## [Parameters](fusion_region_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **access_token**  string | Access token for Fusion Service  Defaults to the set environment variable under FUSION_ACCESS_TOKEN |
| **display_name**  string | The human name of the Region.  If not provided, defaults to *name*. |
...
| **state**  string | Define whether the Region should exist or not.  **Choices:**   - `"present"` ← (default) - `"absent"` |

## [Notes](fusion_region_module.md#id4)
...
## [Examples](fusion_region_module.md#id5)
