...
collection: ansible
version: "8"
title: "purestorage.fusion.fusion_api_client module – Manage API clients in Pure Storage Fusion"
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/fusion/fusion_api_client_module.html
fetched_at: 2026-07-28T02:52:29+00:00
---
...
> see [Requirements](fusion_api_client_module.md#ansible-collections-purestorage-fusion-fusion-api-client-module-requirements) for details.
>
> To use it in a playbook, specify: `purestorage.fusion.fusion_api_client`.

New in purestorage.fusion 1.0.0

- [Synopsis](fusion_api_client_module.md#synopsis)
- [Requirements](fusion_api_client_module.md#requirements)
- [Parameters](fusion_api_client_module.md#parameters)
- [Notes](fusion_api_client_module.md#notes)
- [Examples](fusion_api_client_module.md#examples)

## [Synopsis](fusion_api_client_module.md#id1)

- Create or delete an API Client in Pure Storage Fusion.

## [Requirements](fusion_api_client_module.md#id2)
...
## [Parameters](fusion_api_client_module.md#id3)
...
| **public_key**  string / required | The API clients PEM formatted (Base64 encoded) RSA public key.  Include the `—–BEGIN PUBLIC KEY—–` and `—–END PUBLIC KEY—–` lines. |
| **state**  string | Define whether the client should exist or not.  **Choices:**   - `"present"` ← (default) - `"absent"` |

## [Notes](fusion_api_client_module.md#id4)
...
## [Examples](fusion_api_client_module.md#id5)
