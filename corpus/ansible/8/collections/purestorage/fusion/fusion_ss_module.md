...
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/fusion/fusion_ss_module.html
fetched_at: 2026-07-28T02:52:46+00:00
---
...
| **hardware_types**  list / elements=string | Hardware types to which the storage service applies.  **Choices:**   - `"flash-array-x"` - `"flash-array-c"` - `"flash-array-x-optane"` - `"flash-array-xl"` |
