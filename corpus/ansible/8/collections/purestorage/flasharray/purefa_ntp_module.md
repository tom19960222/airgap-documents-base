...
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/flasharray/purefa_ntp_module.html
fetched_at: 2026-07-28T02:51:09+00:00
---
...
| **ntp_key**  string  *added in purestorage.flasharray 1.22.0* | The NTP symmetric key to be used for NTP authentication.  If it is an ASCII string, it cannot contain the character “#” and cannot be longer than 20 characters.  If it is a hex-encoded string, it cannot be longer than 64 characters.  Setting this parameter is not idempotent. |
