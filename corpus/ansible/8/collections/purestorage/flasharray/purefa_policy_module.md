...
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/flasharray/purefa_policy_module.html
fetched_at: 2026-07-28T02:51:19+00:00
---
...
| **nfs_version**  list / elements=string  *added in purestorage.flasharray 1.22.0* | NFS protocol version allowed for the export  **Choices:**   - `"nfsv3"` ← (default) - `"nfsv4"`   **Default:** `["nfsv3"]` |
| **policy**  string / required | The type of policy to use  **Choices:**   - `"nfs"` - `"smb"` - `"snapshot"` - `"quota"` - `"autodir"` |
...
| **user_mapping**  boolean  *added in purestorage.flasharray 1.14.0* | Defines if user mapping is enabled  **Choices:**   - `false` - `true` ← (default) |
