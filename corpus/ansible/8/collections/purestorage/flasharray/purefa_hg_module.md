...
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/flasharray/purefa_hg_module.html
...
| **name**  aliases: hostgroup  string / required | The name of the hostgroup. |
