...
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/flasharray/purefa_eradication_module.html
fetched_at: 2026-07-28T02:50:54+00:00
---
...
| **disabled_delay**  integer  *added in purestorage.flasharray 1.22.0* | Configures the eradication delay for destroyed objects that *are* protected by SafeMode (objects for which eradication is disabled)  Allowed values are integers from 1 to 30. Default is 1  **Default:** `1` |
| **enabled_delay**  integer  *added in purestorage.flasharray 1.22.0* | Configures the eradication delay for destroyed objects that *are not* protected by SafeMode (objects for which eradication is disabled)  Allowed values are integers from 1 to 30. Default is 1  **Default:** `1` |
