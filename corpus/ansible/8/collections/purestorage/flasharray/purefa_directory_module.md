...
collection: ansible
version: "8"
title: "purestorage.flasharray.purefa_directory module – Manage FlashArray File System Directories"
source_url: https://docs.ansible.com/projects/ansible/8/collections/purestorage/flasharray/purefa_directory_module.html
fetched_at: 2026-07-28T02:50:46+00:00
---
# purestorage.flasharray.purefa_directory module – Manage FlashArray File System Directories
...
> see [Requirements](purefa_directory_module.md#ansible-collections-purestorage-flasharray-purefa-directory-module-requirements) for details.
>
> To use it in a playbook, specify: `purestorage.flasharray.purefa_directory`.

New in purestorage.flasharray 1.5.0

- [Synopsis](purefa_directory_module.md#synopsis)
- [Requirements](purefa_directory_module.md#requirements)
- [Parameters](purefa_directory_module.md#parameters)
- [Notes](purefa_directory_module.md#notes)
- [Examples](purefa_directory_module.md#examples)

## [Synopsis](purefa_directory_module.md#id1)

- Create/Delete FlashArray File Systems

## [Requirements](purefa_directory_module.md#id2)
...
## [Parameters](purefa_directory_module.md#id3)
...
| **state**  string | Define whether the directory should exist or not.  **Choices:**   - `"absent"` - `"present"` ← (default) |

## [Notes](purefa_directory_module.md#id4)
...
## [Examples](purefa_directory_module.md#id5)
