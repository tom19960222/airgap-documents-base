...
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/docsite/guide_aws.html
fetched_at: 2026-07-28T01:00:53+00:00
---
...
- [Authentication](guide_aws.md#authentication)
- [Provisioning](guide_aws.md#provisioning)
- [Security Groups](guide_aws.md#security-groups)
- [Host Inventory](guide_aws.md#host-inventory)
- [Tags And Groups And Variables](guide_aws.md#tags-and-groups-and-variables)
- [Autoscaling with Ansible Pull](guide_aws.md#autoscaling-with-ansible-pull)
- [Autoscaling with Ansible Automation Platform](guide_aws.md#autoscaling-with-ansible-automation-platform)
- [Ansible With (And Versus) CloudFormation](guide_aws.md#ansible-with-and-versus-cloudformation)
- [AWS Image Building With Ansible](guide_aws.md#aws-image-building-with-ansible)
- [Next Steps: Explore Modules](guide_aws.md#next-steps-explore-modules)
...
## [Authentication](guide_aws.md#id1)
...
Credentials can also be accessed from a [Credentials Profile](https://docs.aws.amazon.com/sdk-for-php/v3/developer-guide/guide_credentials_profiles.html).:
...
## [Security Groups](guide_aws.md#id3)
...
## [Host Inventory](guide_aws.md#id4)
...
in text files. Rather, the best way to handle this is to use the aws_ec2 inventory plugin. See [Working with dynamic inventory](../../../../inventory_guide/intro_dynamic_inventory.md#dynamic-inventory).

The plugin will also return instances that were created outside of Ansible and allow Ansible to manage them.

## [Tags And Groups And Variables](guide_aws.md#id5)
...
## [Autoscaling with Ansible Pull](guide_aws.md#id6)
...
Read [ansible-pull](../../../../cli/ansible-pull.md#ansible-pull) for more information on pull-mode playbooks.

## [Autoscaling with Ansible Automation Platform](guide_aws.md#id7)

[Ansible Automation Platform (AAP)](https://access.redhat.com/documentation/en-us/red_hat_ansible_automation_platform/)
...
## [Ansible With (And Versus) CloudFormation](guide_aws.md#id8)
...
## [AWS Image Building With Ansible](guide_aws.md#id9)
...
See the Packer documentation of the [Ansible local Packer provisioner](https://www.packer.io/docs/provisioners/ansible/ansible-local) and [Ansible remote Packer provisioner](https://www.packer.io/docs/provisioners/ansible/ansible).
...
## [Next Steps: Explore Modules](guide_aws.md#id10)
...
> **See also:**
>
> [Collection Index](../../../index.md#list-of-collections)
> :   Browse existing collections, modules, and plugins
>
> [Working with playbooks](../../../../playbook_guide/playbooks.md#working-with-playbooks)
> :   An introduction to playbooks
>
> [Controlling where tasks run: delegation and local actions](../../../../playbook_guide/playbooks_delegation.md#playbooks-delegation)
