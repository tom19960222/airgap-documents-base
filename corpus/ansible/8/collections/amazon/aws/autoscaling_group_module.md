...
collection: ansible
version: "8"
title: "amazon.aws.autoscaling_group module – Create or delete AWS AutoScaling Groups (ASGs)"
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/autoscaling_group_module.html
...
> see [Requirements](autoscaling_group_module.md#ansible-collections-amazon-aws-autoscaling-group-module-requirements) for details.
>
> To use it in a playbook, specify: `amazon.aws.autoscaling_group`.

New in amazon.aws 5.0.0

- [Synopsis](autoscaling_group_module.md#synopsis)
- [Requirements](autoscaling_group_module.md#requirements)
- [Parameters](autoscaling_group_module.md#parameters)
- [Notes](autoscaling_group_module.md#notes)
- [Examples](autoscaling_group_module.md#examples)
- [Return Values](autoscaling_group_module.md#return-values)

## [Synopsis](autoscaling_group_module.md#id1)

- Can create or delete AWS AutoScaling Groups.
- Can be used with the [community.aws.autoscaling_launch_config](../../community/aws/autoscaling_launch_config_module.md#ansible-collections-community-aws-autoscaling-launch-config-module) module to manage Launch Configurations.
...
## [Requirements](autoscaling_group_module.md#id2)
...
## [Parameters](autoscaling_group_module.md#id3)
...
| **detach_instances**  list / elements=string  *added in community.aws 3.2.0* | Removes one or more instances from the specified AutoScalingGroup.  If *decrement_desired_capacity* flag is not set, new instance(s) are launched to replace the detached instance(s).  If a Classic Load Balancer is attached to the AutoScalingGroup, the instances are also deregistered from the load balancer.  If there are target groups attached to the AutoScalingGroup, the instances are also deregistered from the target groups.  **Default:** `[]` |
...
| **launch_config_name**  string | Name of the Launch configuration to use for the group. See the community.aws.autoscaling_launch_config) module for managing these.  If unspecified then the current group value will be used. One of *launch_config_name* or *launch_template* must be provided. |
...
| **replace_instances**  list / elements=string | List of *instance_ids* belonging to the named AutoScalingGroup that you would like to terminate and be replaced with instances matching the current launch configuration.  **Default:** `[]` |
...
| **tags**  list / elements=dictionary | A list of tags to add to the Auto Scale Group.  Optional key is *propagate_at_launch*, which defaults to true.  When *propagate_at_launch* is true the tags will be propagated to the Instances created.  **Default:** `[]` |
...
## [Notes](autoscaling_group_module.md#id4)
...
## [Examples](autoscaling_group_module.md#id5)
...
## [Return Values](autoscaling_group_module.md#id6)
