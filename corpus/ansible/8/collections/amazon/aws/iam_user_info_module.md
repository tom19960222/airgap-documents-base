...
collection: ansible
version: "8"
title: "amazon.aws.iam_user_info module – Gather IAM user(s) facts in AWS"
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/iam_user_info_module.html
...
> see [Requirements](iam_user_info_module.md#ansible-collections-amazon-aws-iam-user-info-module-requirements) for details.
>
> To use it in a playbook, specify: `amazon.aws.iam_user_info`.
...
| **arn**  string | the ARN of the user  **Returned:** if user exists  **Sample:** `"arn:aws:iam::123456789012:user/dev/test_user"` |
