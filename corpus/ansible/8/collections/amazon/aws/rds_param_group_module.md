...
collection: ansible
version: "8"
title: "amazon.aws.rds_param_group module – manage RDS parameter groups"
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/rds_param_group_module.html
fetched_at: 2026-07-28T01:07:09+00:00
---
# amazon.aws.rds_param_group module – manage RDS parameter groups
...
> see [Requirements](rds_param_group_module.md#ansible-collections-amazon-aws-rds-param-group-module-requirements) for details.
>
> To use it in a playbook, specify: `amazon.aws.rds_param_group`.
...
| **engine**  string | The type of database for this group.  Please use following command to get list of all supported db engines and their respective versions.  # aws rds describe-db-engine-versions –query “DBEngineVersions[].DBParameterGroupFamily”  The DB parameter group family is immutable and can’t be changed when updating a DB parameter group. See <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbparametergroup.html>  Required for *state=present*. |
