...
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/ec2_vpc_net_info_module.html
...
| **filters**  dictionary | A dict of filters to apply. Each dict item consists of a filter key and a filter value. See <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeVpcs.html> for possible filters.  **Default:** `{}` |
...
| **vpc_ids**  list / elements=string | A list of VPC IDs that exist in your account.  **Default:** `[]` |
