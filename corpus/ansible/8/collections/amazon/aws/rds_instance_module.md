...
collection: ansible
version: "8"
title: "amazon.aws.rds_instance module – Manage RDS instances"
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/rds_instance_module.html
fetched_at: 2026-07-28T01:07:05+00:00
---
...
> see [Requirements](rds_instance_module.md#ansible-collections-amazon-aws-rds-instance-module-requirements) for details.
>
...
| **promotion_tier**  integer | An integer that specifies the order in which an Aurora Replica is promoted to the primary instance after a failure of the existing primary instance. |
...
| **ca_certificate_identifier**  string | The identifier of the CA certificate for the DB instance.  Requires minimum botocore version 1.29.44.  **Returned:** always  **Sample:** `"rds-ca-2015"` |
