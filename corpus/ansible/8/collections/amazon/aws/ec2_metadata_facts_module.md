...
source_url: https://docs.ansible.com/projects/ansible/8/collections/amazon/aws/ec2_metadata_facts_module.html
...
| **ansible_ec2_iam_info_instanceprofilearn**  string | The IAM instance profile ARN.  **Returned:** success  **Sample:** `"arn:aws:iam::123456789012:instance-profile/role_name"` |
...
| **ansible_ec2_instance_identity_document_accountid**  string | **Returned:** success  **Sample:** `"123456789012"` |
...
| **ansible_ec2_instance_tags_keys**  list / elements=string  *added in amazon.aws 5.5.0* | The list of tags keys of the instance.  Returns empty list if access to tags (InstanceMetadataTags) in instance metadata is not enabled.  **Returned:** success  **Sample:** `["tagKey1", "tag_key2"]` |
