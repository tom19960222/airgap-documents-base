...
collection: ansible
version: "8"
title: "ibm.storage_virtualize.ibm_sv_manage_replication_policy module – This module configures and manages replication policies on IBM Storage Virtualize family systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/storage_virtualize/ibm_sv_manage_replication_policy_module.html
...
| **topology**  string | Specifies the policy topology.  **Choices:**   - `"2-site-async-dr"` - `"2-site-ha"` |
