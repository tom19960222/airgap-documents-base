...
collection: ansible
version: "8"
title: "ibm.storage_virtualize.ibm_sv_manage_truststore_for_replication module – This module manages certificate trust stores for replication on IBM Storage Virtualize family systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/storage_virtualize/ibm_sv_manage_truststore_for_replication_module.html
fetched_at: 2026-07-28T02:35:22+00:00
---
...
- This module can be used to set up mutual TLS (mTLS) for policy-based replication inter-system communication using cluster endpoint certificates (usually system-signed which are exported by the [ibm.storage_virtualize.ibm_sv_manage_ssl_certificate](ibm_sv_manage_ssl_certificate_module.md#ansible-collections-ibm-storage-virtualize-ibm-sv-manage-ssl-certificate-module) module).
