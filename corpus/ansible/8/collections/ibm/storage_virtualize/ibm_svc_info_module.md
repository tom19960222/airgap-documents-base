...
collection: ansible
version: "8"
title: "ibm.storage_virtualize.ibm_svc_info module – This module gathers various information from the IBM Storage Virtualize family systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/storage_virtualize/ibm_svc_info_module.html
fetched_at: 2026-07-28T02:35:27+00:00
---
# ibm.storage_virtualize.ibm_svc_info module – This module gathers various information from the IBM Storage Virtualize family systems
...
| **DriveClass**  list / elements=dictionary | Data will be populated when *gather_subset=driveclass* or *gather_subset=all*  List all drive classes in the system  **Returned:** success  **Sample:** `[{"...": null}]` |
...
| **Security**  list / elements=dictionary | Data will be populated when *gather_subset=security* or *gather_subset=all*  Displays current security settings of the system  **Returned:** success  **Sample:** `[{"...": null}]` |
