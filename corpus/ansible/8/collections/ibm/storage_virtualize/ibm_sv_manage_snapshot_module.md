...
collection: ansible
version: "8"
title: "ibm.storage_virtualize.ibm_sv_manage_snapshot module – This module manages snapshots (PiT image of a volume) on IBM Storage Virtualize family systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/storage_virtualize/ibm_sv_manage_snapshot_module.html
fetched_at: 2026-07-28T02:35:18+00:00
---
...
| **retentiondays**  integer  *added in ibm.storage_virtualize 1.10.0* | Specifies the retention period in days.  *safeguarded* and *retentiondays* are required together.  Applies, when *state=present* to create a safeguarded snapshot. |
| **safeguarded**  boolean  *added in ibm.storage_virtualize 1.10.0* | Flag to create a safeguarded snapshot.  *safeguarded* and *retentiondays* are required together.  Supported in SV build 8.5.2.0 or later.  **Choices:**   - `false` - `true` |
...
> - This module automates the new Snapshot function, implemented by Storage Virtualize, which is using a simplified management model. Any user requiring the flexibility available with legacy FlashCopy can continue to use the existing module [ibm.storage_virtualize.ibm_svc_manage_flashcopy](ibm_svc_manage_flashcopy_module.md#ansible-collections-ibm-storage-virtualize-ibm-svc-manage-flashcopy-module).
> - Snapshots created by this Ansible module are not directly accessible from the hosts. To create a new group of host accessible volumes from a snapshot, use [ibm.storage_virtualize.ibm_svc_manage_volumegroup](ibm_svc_manage_volumegroup_module.md#ansible-collections-ibm-storage-virtualize-ibm-svc-manage-volumegroup-module) module.
