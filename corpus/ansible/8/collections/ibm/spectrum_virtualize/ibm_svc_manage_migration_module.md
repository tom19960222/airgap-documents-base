...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/spectrum_virtualize/ibm_svc_manage_migration_module.html
fetched_at: 2026-07-28T02:34:57+00:00
---
...
| **new_pool**  string  *added in ibm.spectrum_virtualize 1.11.0* | Specifies the pool on which the volume has to be migrated.  Valid only when *type_of_migration=across_pools*. |
...
| **type_of_migration**  string  *added in ibm.spectrum_virtualize 1.11.0* | Specifies the type of migration whether it is migration across pools or migration across clusters  **Choices:**   - `"across_pools"` - `"across_clusters"` ← (default) |
