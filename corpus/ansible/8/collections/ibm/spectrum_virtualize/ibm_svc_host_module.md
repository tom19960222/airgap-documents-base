...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/spectrum_virtualize/ibm_svc_host_module.html
fetched_at: 2026-07-28T02:34:49+00:00
---
...
| **nqn**  string  *added in ibm.spectrum_virtualize 1.12.0* | List of initiator NQNs to be added to the host. Each NQN is separated by a comma. The complete list of NQNs must be provided.  Required when *protocol=rdmanvme*, to create.  Valid when *state=present*, to create or modify a host. |
...
| **portset**  string  *added in ibm.spectrum_virtualize 1.12.0* | Specifies the portset to be associated with the host.  Valid when *state=present*, to create or modify a host. |
