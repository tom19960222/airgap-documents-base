...
collection: ansible
version: "8"
title: "ibm.spectrum_virtualize.ibm_svc_manage_flashcopy module – This module manages FlashCopy mappings on IBM Spectrum Virtualize family storage systems"
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/spectrum_virtualize/ibm_svc_manage_flashcopy_module.html
fetched_at: 2026-07-28T02:34:55+00:00
---
# ibm.spectrum_virtualize.ibm_svc_manage_flashcopy module – This module manages FlashCopy mappings on IBM Spectrum Virtualize family storage systems
...
>
> To use it in a playbook, specify: `ibm.spectrum_virtualize.ibm_svc_manage_flashcopy`.
...
| **copytype**  string | Specifies the copy type when creating the FlashCopy mapping.  Required when *state=present*, to create a FlashCopy mapping.  **Choices:**   - `"snapshot"` - `"clone"` |
