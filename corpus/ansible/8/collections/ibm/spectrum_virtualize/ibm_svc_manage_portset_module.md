...
source_url: https://docs.ansible.com/projects/ansible/8/collections/ibm/spectrum_virtualize/ibm_svc_manage_portset_module.html
fetched_at: 2026-07-28T02:35:00+00:00
---
...
| **old_name**  string  *added in ibm.spectrum_virtualize 1.12.0* | Specifies the old name of the portset while renaming.  Valid when *state=present*, to rename an existing host. |
...
| **porttype**  string  *added in ibm.spectrum_virtualize 1.12.0* | Specifies the type of port that can be mapped to the portset.  Applies when *state=present*.  If not specified, *porttype=ethernet* will be used to manage IP portset.  **Choices:**   - `"fc"` - `"ethernet"` |
