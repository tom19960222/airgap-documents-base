...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_a_record module – Configure Infoblox NIOS A records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_a_record_module.html
fetched_at: 2026-07-28T02:35:53+00:00
---
...
> see [Requirements](nios_a_record_module.md#ansible-collections-infoblox-nios-modules-nios-a-record-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_a_record`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_a_record_module.md#synopsis)
- [Requirements](nios_a_record_module.md#requirements)
- [Parameters](nios_a_record_module.md#parameters)
- [Notes](nios_a_record_module.md#notes)
- [Examples](nios_a_record_module.md#examples)

## [Synopsis](nios_a_record_module.md#id1)
...
## [Requirements](nios_a_record_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox-client

## [Parameters](nios_a_record_module.md#id3)
...
| **ipv4addr**  aliases: ipv4  string / required | Configures the IPv4 address for this A record. Users can dynamically allocate ipv4 address to A record by passing dictionary containing, *nios_next_ip* and *CIDR network range*. Also update ipv4 address statically to A record by passing dictionary containing, *old_ipv4addr* and *new_ipv4addr*. See example. |
...
## [Notes](nios_a_record_module.md#id4)
...
## [Examples](nios_a_record_module.md#id5)
