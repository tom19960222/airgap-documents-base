...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_cname_record module – Configure Infoblox NIOS CNAME records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_cname_record_module.html
fetched_at: 2026-07-28T02:35:54+00:00
---
# infoblox.nios_modules.nios_cname_record module – Configure Infoblox NIOS CNAME records
...
> see [Requirements](nios_cname_record_module.md#ansible-collections-infoblox-nios-modules-nios-cname-record-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_cname_record`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_cname_record_module.md#synopsis)
- [Requirements](nios_cname_record_module.md#requirements)
- [Parameters](nios_cname_record_module.md#parameters)
- [Notes](nios_cname_record_module.md#notes)
- [Examples](nios_cname_record_module.md#examples)

## [Synopsis](nios_cname_record_module.md#id1)

- Adds and/or removes instances of CNAME record objects from Infoblox NIOS servers. This module manages NIOS `record:cname` objects using the Infoblox WAPI interface over REST.

## [Requirements](nios_cname_record_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox-client

## [Parameters](nios_cname_record_module.md#id3)

| Parameter | Comments |
| --- | --- |
| **canonical**  aliases: cname  string / required | Configures the canonical name for this CNAME record. |
...
| **name**  string / required | Specifies the fully qualified hostname to add or remove from the system. User can also update the name as it is possible to pass a dict containing *new_name*, *old_name*. See examples |
...
| **ttl**  integer | Configures the TTL to be associated with this CNAME record. |
| **view**  aliases: dns_view  string | Sets the DNS view to associate this CNAME record with. The DNS view must already be configured on the system.  **Default:** `"default"` |

## [Notes](nios_cname_record_module.md#id4)
...
## [Examples](nios_cname_record_module.md#id5)
