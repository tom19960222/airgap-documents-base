...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_mx_record module – Configure Infoblox NIOS MX records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_mx_record_module.html
fetched_at: 2026-07-28T02:36:00+00:00
---
# infoblox.nios_modules.nios_mx_record module – Configure Infoblox NIOS MX records
...
> see [Requirements](nios_mx_record_module.md#ansible-collections-infoblox-nios-modules-nios-mx-record-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_mx_record`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_mx_record_module.md#synopsis)
- [Requirements](nios_mx_record_module.md#requirements)
- [Parameters](nios_mx_record_module.md#parameters)
- [Notes](nios_mx_record_module.md#notes)
- [Examples](nios_mx_record_module.md#examples)

## [Synopsis](nios_mx_record_module.md#id1)
...
## [Requirements](nios_mx_record_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox-client

## [Parameters](nios_mx_record_module.md#id3)
...
| **mail_exchanger**  aliases: mx  string / required | Configures the mail exchanger FQDN for this MX record. |
...
| **preference**  integer / required | Configures the preference (0-65535) for this MX record. |
...
## [Notes](nios_mx_record_module.md#id4)
...
## [Examples](nios_mx_record_module.md#id5)
