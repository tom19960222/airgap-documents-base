...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_dns_view module – Configure Infoblox NIOS DNS views"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_dns_view_module.html
fetched_at: 2026-07-28T02:35:55+00:00
---
# infoblox.nios_modules.nios_dns_view module – Configure Infoblox NIOS DNS views
...
> see [Requirements](nios_dns_view_module.md#ansible-collections-infoblox-nios-modules-nios-dns-view-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_dns_view`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_dns_view_module.md#synopsis)
- [Requirements](nios_dns_view_module.md#requirements)
- [Parameters](nios_dns_view_module.md#parameters)
- [Notes](nios_dns_view_module.md#notes)
- [Examples](nios_dns_view_module.md#examples)

## [Synopsis](nios_dns_view_module.md#id1)
...
## [Requirements](nios_dns_view_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox-client

## [Parameters](nios_dns_view_module.md#id3)
...
| **name**  aliases: view  string / required | Specifies the fully qualified hostname to add or remove from the system. User can also update the hostname as it is possible to pass a dict containing *new_name*, *old_name*. See examples. |
| **network_view**  string | Specifies the name of the network view to assign the configured DNS view to. The network view must already be configured on the target system.  **Default:** `"default"` |
...
## [Notes](nios_dns_view_module.md#id4)
...
## [Examples](nios_dns_view_module.md#id5)
