...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_aaaa_record module – Configure Infoblox NIOS AAAA records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_aaaa_record_module.html
...
> see [Requirements](nios_aaaa_record_module.md#ansible-collections-infoblox-nios-modules-nios-aaaa-record-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_aaaa_record`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_aaaa_record_module.md#synopsis)
- [Requirements](nios_aaaa_record_module.md#requirements)
- [Parameters](nios_aaaa_record_module.md#parameters)
- [Notes](nios_aaaa_record_module.md#notes)
- [Examples](nios_aaaa_record_module.md#examples)

## [Synopsis](nios_aaaa_record_module.md#id1)

- Adds and/or removes instances of AAAA record objects from Infoblox NIOS servers. This module manages NIOS `record:aaaa` objects using the Infoblox WAPI interface over REST.

## [Requirements](nios_aaaa_record_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox-client

## [Parameters](nios_aaaa_record_module.md#id3)
...
| **ipv6addr**  aliases: ipv6  string / required | Configures the IPv6 address for this AAAA record. |
...
| **ttl**  integer | Configures the TTL to be associated with this AAAA record. |
| **view**  aliases: dns_view  string | Sets the DNS view to associate this AAAA record with. The DNS view must already be configured on the system.  **Default:** `"default"` |

## [Notes](nios_aaaa_record_module.md#id4)
...
## [Examples](nios_aaaa_record_module.md#id5)
