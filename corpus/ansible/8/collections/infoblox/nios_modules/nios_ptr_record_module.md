...
collection: ansible
version: "8"
title: "infoblox.nios_modules.nios_ptr_record module – Configure Infoblox NIOS PTR records"
source_url: https://docs.ansible.com/projects/ansible/8/collections/infoblox/nios_modules/nios_ptr_record_module.html
fetched_at: 2026-07-28T02:36:05+00:00
---
# infoblox.nios_modules.nios_ptr_record module – Configure Infoblox NIOS PTR records
...
> see [Requirements](nios_ptr_record_module.md#ansible-collections-infoblox-nios-modules-nios-ptr-record-module-requirements) for details.
>
> To use it in a playbook, specify: `infoblox.nios_modules.nios_ptr_record`.

New in infoblox.nios_modules 1.0.0

- [Synopsis](nios_ptr_record_module.md#synopsis)
- [Requirements](nios_ptr_record_module.md#requirements)
- [Parameters](nios_ptr_record_module.md#parameters)
- [Notes](nios_ptr_record_module.md#notes)
- [Examples](nios_ptr_record_module.md#examples)

## [Synopsis](nios_ptr_record_module.md#id1)
...
## [Requirements](nios_ptr_record_module.md#id2)

The below requirements are needed on the host that executes this module.

- infoblox_client

## [Parameters](nios_ptr_record_module.md#id3)
...
| **ipv4addr**  aliases: ipv4  string | The IPv4 Address of the record. Mutually exclusive with the ipv6addr. |
| **ipv6addr**  aliases: ipv6  string | The IPv6 Address of the record. Mutually exclusive with the ipv4addr. |
...
| **ptrdname**  string / required | The domain name of the DNS PTR record in FQDN format. |
...
| **ttl**  integer | Time To Live (TTL) value for the record. A 32-bit unsigned integer that represents the duration, in seconds, that the record is valid (cached). Zero indicates that the record should not be cached. |
...
## [Notes](nios_ptr_record_module.md#id4)
...
## [Examples](nios_ptr_record_module.md#id5)
