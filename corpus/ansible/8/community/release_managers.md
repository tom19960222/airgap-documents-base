...
collection: ansible
version: "8"
title: "Release Manager Guidelines"
source_url: https://docs.ansible.com/projects/ansible/8/community/release_managers.html
fetched_at: 2026-07-28T00:59:03+00:00
---
# [Release Manager Guidelines](release_managers.md#id1)

Topics

- [Release Manager Guidelines](release_managers.md#release-manager-guidelines)

  - [Pre-releases: what and why](release_managers.md#pre-releases-what-and-why)

    - [Beta releases](release_managers.md#beta-releases)
    - [Release candidates](release_managers.md#release-candidates)
  - [Ansible release process](release_managers.md#ansible-release-process)

The release manager’s purpose is to ensure a smooth release. To achieve that goal, they need to
coordinate between:

- Developers with commit privileges on the [Ansible GitHub repository](https://github.com/ansible/ansible/)
- Contributors without commit privileges
- The community
- Ansible documentation team

## [Pre-releases: what and why](release_managers.md#id2)
...
### [Beta releases](release_managers.md#id3)
...
### [Release candidates](release_managers.md#id4)
...
>   the versions.
> - Tests and `docs/docsite/` can differ if really needed as they do not break runtime.
...
> **Note:**
>
> We want to specifically emphasize that code (in `bin/`, `lib/ansible/`, and
> `setup.py`) must be the same unless there are extraordinary extenuating circumstances. If
...
## [Ansible release process](release_managers.md#id5)

The release process is kept in a [separate document](https://docs.google.com/document/d/10EWLkMesi9s_CK_GmbZlE_ZLhuQr6TBrdMLKo5dnMAI/edit#heading=h.ooo3izcel3cz)
