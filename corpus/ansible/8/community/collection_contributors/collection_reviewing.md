...
collection: ansible
version: "8"
title: "Review checklist for collection PRs"
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_reviewing.html
...
- Violate the [Ansible development conventions](../../dev_guide/developing_modules_best_practices.md#module-conventions).
...
- If the pull request is not a documentation fix, it must include a [changelog fragment](../collection_development_process.md#collection-changelog-fragments). Check the format carefully as follows:
...
- If new files are added with the pull request, they follow the [Collection licensing requirements](collection_requirements.md#coll-licensing-req).
- The changes follow the [Ansible documentation standards](../../dev_guide/developing_modules_documenting.md#developing-modules-documenting) and the [Ansible documentation style guide](../../dev_guide/style_guide/index.md#style-guide).
- The changes follow the [Development conventions](../../dev_guide/developing_modules_best_practices.md#developing-modules-best-practices).
- If a new plugin is added, it is one of the [allowed plugin types](collection_requirements.md#coll-module-reqs).
- Documentation, examples, and return sections use FQCNs for the `M(..)` [format macros](../../dev_guide/developing_modules_documenting.md#module-documents-linking) when referring to modules.
...
- New features have corresponding examples in the [EXAMPLES block](../../dev_guide/developing_modules_documenting.md#examples-block).
- Return values are documented in the [RETURN block](../../dev_guide/developing_modules_documenting.md#return-block).
...
- Where applicable, the pull request has [Integration tests](../../dev_guide/testing_integration.md#testing-integration) and [Unit Tests](../../dev_guide/testing_units.md#testing-units).
