...
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_integration_running.html
fetched_at: 2026-07-28T01:05:21+00:00
---
# Running integration tests

In the following examples, we will use `Docker` to run integration tests locally. Ensure you [Prepare your environment](collection_test_pr_locally.md#collection-prepare-environment) first.
