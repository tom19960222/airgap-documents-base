...
collection: ansible
version: "8"
title: "Creating new integration tests"
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_integration_add.html
fetched_at: 2026-07-28T01:04:19+00:00
---
...
If the module already has tests, see [Adding to an existing integration test](collection_integration_updating.md#collection-updating-integration-tests).
...
We [checked](collection_integration_about.md#collection-integration-prepare) and determined that there are no integration tests at all.
...
7. [Run the tests](collection_integration_running.md#collection-run-integration-tests) with the `-vvv` argument.
...
8. If the test succeeds, write more tests. Refer to the [Recommendations on coverage](collection_integration_about.md#collection-integration-recommendations) section for details.
...
2. Fork the [collection repository](https://github.com/ansible-collections/community.postgresql) through the GitHub web interface.
