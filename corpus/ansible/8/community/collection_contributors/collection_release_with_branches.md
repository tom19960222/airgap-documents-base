...
collection: ansible
version: "8"
title: "Releasing collections with release branches"
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_release_with_branches.html
fetched_at: 2026-07-28T01:04:20+00:00
---
# Releasing collections with release branches

Collections MUST follow the [semantic versioning](https://semver.org/) rules. See [Releasing collections](collection_releasing.md#releasing-collections) for high-level details.

- [Release planning and announcement](collection_release_with_branches.md#release-planning-and-announcement)
- [Releasing major collection versions](collection_release_with_branches.md#releasing-major-collection-versions)

  - [Creating the release branch](collection_release_with_branches.md#creating-the-release-branch)
  - [Creating the changelogs](collection_release_with_branches.md#creating-the-changelogs)
  - [Publishing the collection](collection_release_with_branches.md#publishing-the-collection)
- [Releasing minor collection versions](collection_release_with_branches.md#releasing-minor-collection-versions)

  - [Creating the changelogs](collection_release_with_branches.md#id2)
  - [Publishing the collection](collection_release_with_branches.md#id3)
- [Releasing patch versions](collection_release_with_branches.md#releasing-patch-versions)

  - [Releasing when more minor versions are expected](collection_release_with_branches.md#releasing-when-more-minor-versions-are-expected)
  - [Releasing when no more minor versions are expected](collection_release_with_branches.md#releasing-when-no-more-minor-versions-are-expected)

## [Release planning and announcement](collection_release_with_branches.md#id15)

1. Announce your intention to release the collection in a corresponding pinned release issue/community pinboard of the collection and in the `#ansible-community` [Matrix/IRC channel](https://docs.ansible.com/ansible/devel/community/communication.html#real-time-chat). Repeat the announcement in any other dedicated channels if they exist.
2. Ensure all the other repository maintainers are informed about the time of the following release.

## [Releasing major collection versions](collection_release_with_branches.md#id16)
...
### [Creating the release branch](collection_release_with_branches.md#id17)
...
### [Creating the changelogs](collection_release_with_branches.md#id18)
...
### [Publishing the collection](collection_release_with_branches.md#id19)

1. In the `stable-X` branch, add an annotated tag to the last commit with the collection version `X.0.0`. Pushing this tag to the `upstream` repository will make Zuul publish the collection on [Ansible Galaxy](https://galaxy.ansible.com/).
...
2. If the collection uses [Zuul](https://github.com/ansible/zuul-config/blob/master/README.rst) for publishing its releases, wait until the new version is published on the collection’s [Ansible Galaxy](https://galaxy.ansible.com/) page. It will appear in a list of tarballs available to download.
...
5. Announce the release through the [Bullhorn Newsletter](https://github.com/ansible/community/wiki/News#the-bullhorn).
6. Announce the release in the pinned release issue/community pinboard of the collection and in the `#ansible-community` [Matrix/Libera.Chat IRC channel](https://docs.ansible.com/ansible/devel/community/communication.html#real-time-chat).
...
## [Releasing minor collection versions](collection_release_with_branches.md#id20)
...
### [Creating the changelogs](collection_release_with_branches.md#id21)
...
### [Publishing the collection](collection_release_with_branches.md#id22)

1. In the `stable-X` branch, add an annotated tag to the last commit with the collection version `X.Y.0`. Pushing this tag to the `upstream` repository will make Zuul publish the collection on [Ansible Galaxy](https://galaxy.ansible.com/).
...
2. Wait until the new version is published on the collection’s [Ansible Galaxy](https://galaxy.ansible.com/) page. The published version will appear in a list of tarballs available to download.
...
4. Announce the release through the [Bullhorn Newsletter](https://github.com/ansible/community/wiki/News#the-bullhorn).
5. Announce the release in the pinned release issue/community pinboard of the collection and in the `#ansible-community` [Matrix/IRC channel](https://docs.ansible.com/ansible/devel/community/communication.html#real-time-chat). Additionally, you can announce it using GitHub’s Releases system.
...
## [Releasing patch versions](collection_release_with_branches.md#id23)
...
### [Releasing when more minor versions are expected](collection_release_with_branches.md#id24)
...
1. Add an annotated tag to the last commit with the collection version `X.Y.Z`. Pushing this tag to the `upstream` repository will make Zuul publish the collection on [Ansible Galaxy](https://galaxy.ansible.com/).
...
### [Releasing when no more minor versions are expected](collection_release_with_branches.md#id25)
...
1. In the `stable-X` branch, add an annotated tag to the last commit with the collection version `X.Y.Z`. Pushing this tag to the `upstream` repository will make Zuul publish the collection on [Ansible Galaxy](https://galaxy.ansible.com/).
...
4. Announce the release through the [Bullhorn Newsletter](https://github.com/ansible/community/wiki/News#the-bullhorn).
5. Announce the release in the pinned issue/community pinboard of the collection and in the `#ansible-community` [Matrix/IRC channel](https://docs.ansible.com/ansible/devel/community/communication.html#real-time-chat).
