...
collection: ansible
version: "8"
title: "Releasing collections without release branches"
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_release_without_branches.html
fetched_at: 2026-07-28T01:05:21+00:00
---
...
- [Release planning and announcement](collection_release_without_branches.md#release-planning-and-announcement)
- [Creating the release branch](collection_release_without_branches.md#creating-the-release-branch)
- [Generating the changelog](collection_release_without_branches.md#generating-the-changelog)
- [Publish the collection](collection_release_without_branches.md#publish-the-collection)

## [Release planning and announcement](collection_release_without_branches.md#id2)

1. Examine the collection to determine if there are merged changes to release.
2. According to the changes made, choose an appropriate release version number. Keep in mind that the collections must follow the [semantic versioning](https://semver.org/) rules. See [Collection versioning and deprecation](collection_releasing.md#collection-versioning-and-deprecation) for details.
3. Announce your intention to release the collection in a corresponding pinned release issue or community pinboard of the collection and in the `community` [Matrix/IRC channel](../communication.md#communication-irc).

## [Creating the release branch](collection_release_without_branches.md#id3)
...
## [Generating the changelog](collection_release_without_branches.md#id4)
...
## [Publish the collection](collection_release_without_branches.md#id5)
...
5. Announce the release through the [Bullhorn Newsletter issue](https://github.com/ansible/community/wiki/News#the-bullhorn).
6. Announce the release in the pinned release issue/community pinboard of the collection mentioned in step 3 and in the `community` [Matrix/IRC channel](../communication.md#communication-irc).
