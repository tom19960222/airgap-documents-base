...
source_url: https://docs.ansible.com/projects/ansible/8/community/collection_contributors/collection_unit_tests.html
fetched_at: 2026-07-28T01:00:27+00:00
---
...
Inclusion in the Ansible package [requires integration and/or unit tests](collection_requirements.md#coll-ci-tests) You should have tests for your collection as well as for individual modules and plugins to make your code more reliable To learn how to get started with integration tests, see [Adding integration tests to a collection](collection_integration_tests.md#collection-integration-tests).
