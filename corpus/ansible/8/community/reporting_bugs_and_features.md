...
source_url: https://docs.ansible.com/projects/ansible/8/community/reporting_bugs_and_features.html
...
Before you request a feature, check what is [planned for future Ansible Releases](../roadmap/index.md#roadmaps). Check [existing pull requests tagged with feature](https://github.com/ansible/ansible/issues?q=is%3Aissue+is%3Aopen+label%3Afeature).
