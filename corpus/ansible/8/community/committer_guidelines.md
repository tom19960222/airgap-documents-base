...
collection: ansible
version: "8"
title: "Committers Guidelines"
source_url: https://docs.ansible.com/projects/ansible/8/community/committer_guidelines.html
fetched_at: 2026-07-28T00:59:02+00:00
---
...
Committers of [Ansible-core](https://github.com/ansible/ansible) are necessarily Red Hat employees acting as members of the Ansible Core team. Committers of [Ansible collections](https://github.com/ansible-collections/) are members of the community or Ansible Engineering. Please read the guidelines before you commit.
...
Collections maintainers define features, high-level design, and roadmap of the collections themselves and are responsible for merging new features to [Ansible collections](https://github.com/ansible-collections/) based on proposals discussed with their communities.
...
- [Module maintainers](maintainers.md#maintainers): Module maintainers own specific modules and have indirect commit access through the current module pull request mechanisms.
- [Collection maintainers](maintainers.md#maintainers): Collection maintainers own specific collections and have commit access to them. Each collection can set its own rules for contributions.
...
- Do NOT
  ...
  - Drag your community team members down. Discuss the technical merits of any pull requests you review. Avoid negativity and personal comments. For more guidance on being a good community member, read our [Community Code of Conduct](code_of_conduct.md#code-of-conduct).
