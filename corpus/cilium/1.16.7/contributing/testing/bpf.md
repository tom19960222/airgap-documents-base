...
collection: cilium
version: "1.16.7"
title: "BPF Unit and Integration Testing"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/contributing/testing/bpf.rst
...
type (for example ``xdp`` or ``tc``. See [the list of recognized types in the Go library](https://github.com/cilium/ebpf/blob/v0.13.2/elf_sections.go#L9)),
