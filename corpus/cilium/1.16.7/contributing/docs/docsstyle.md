...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/contributing/docs/docsstyle.rst
...
See also [the documentation for testing](docstest.md#testing-documentation) for
instructions on how to preview documentation changes.

## General considerations

Write in US English.
For example, use "prioritize" instead of ":spellingprioritise" and
"color" instead of ":spellingcolour".
...
Follow [the section on capitalization for API objects](https://kubernetes.io/docs/contribute/style/style-guide/#use-upper-camel-case-for-api-objects) from the Kubernetes
style guide for when to (not) capitalize API objects. In particular:
    ...
    [UpperCamelCase](https://en.wikipedia.org/wiki/Camel_case), also known as Pascal case.
...
- They contain [substitution references](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#substitution-references) (for example: ``|SCM_WEB|``). In that
...
- If the text is not a code snippet, but just some fragment that should be
  ...
  use the marker for [literal blocks](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#literal-blocks) (``::``).
...
- Avoid using [embedded URIs](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#embedded-uris-and-aliases) (```... <...>`__``), which make the document
  harder to read when looking at the source code of the documentation. Prefer
  to use [block-level hyperlink targets](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#hyperlink-targets) (where the URI is not written
...
- If using embedded URIs, use anonymous hyperlinks (```... <...>`__`` with two
  underscores, see the documentation for [embedded URIs](https://docutils.sourceforge.io/docs/ref/rst/restructuredtext.html#embedded-uris-and-aliases)) instead of named
...
default to the [Kubernetes style guide](https://kubernetes.io/docs/contribute/style/style-guide/), especially for [content best practices](https://kubernetes.io/docs/contribute/style/style-guide/#content-best-practices). The following subsections cover the most common feedback given for
