...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/contributing/docs/docsframework.rst
...
Cilium relies on [Sphinx](https://www.sphinx-doc.org) to generate its documentation.
...
quickly render the documentation, see [testing documentation](docstest.md#testing-documentation).

### Sphinx features

Here are some specific Sphinx features used in Cilium's documentation:

- [Tab groups](https://github.com/executablebooks/sphinx-tabs/)

- [OpenAPI](https://github.com/sphinx-contrib/openapi) documentation generation

- Mark-up languages: reStructuredText (rST) and Markdown ([MyST](https://myst-parser.readthedocs.io) flavor)
...
[section on requirements](docsframework.md#docs_requirements).
...
The build system relies on Sphinx's [spell-checker module](https://github.com/sphinx-contrib/spelling) (considered a
[builder](https://www.sphinx-doc.org/en/master/usage/builders) in Sphinx).
...
The documentation framework relies on [rstcheck](https://rstcheck.readthedocs.io) to validate the rST
...
not run in CI. See 27116 for details.
...
For more information on this topic, see [testing documentation](docstest.md#testing-documentation).
...
[extlinks](https://www.sphinx-doc.org/en/master/usage/extensions/extlinks.html) extension. They are all configured in ``Documentation/conf.py``.
...
- Warning banner on older branches, telling to check out the latest version
  ...
  future, see also 29969)

### Algolia search engine

- :spellingAlgolia provides a search engine for the documentation website. See also the
  repository for the [DocSearch scraper](https://github.com/cilium/docsearch-scraper-webhook).

## Build set up

<a id="docs_requirements"></a>
...
The online documentation uses a custom theme based on [the ReadTheDocs theme](https://github.com/readthedocs/sphinx_rtd_theme).
This theme is defined in its [dedicated sphinx_rtd_theme fork repository](docsframework.md#dedicated-sphinx_rtd_theme-fork-repository).

<a id="dedicated-sphinx_rtd_theme-fork-repository"></a>
