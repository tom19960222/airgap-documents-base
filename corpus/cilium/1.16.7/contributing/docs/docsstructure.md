...
collection: cilium
version: "1.16.7"
title: "Recommendations on documentation structure"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/contributing/docs/docsstructure.rst
...
<a id="docs_structure_recommendations"></a>
...
the site's [information architecture](https://www.usability.gov/what-and-why/information-architecture.html). Information architecture is what shapes
...
prevent their success, make sure to flag the change clearly in [upgrade notes](../../operations/upgrade.md#current_release_required_changes).
...
For an example of a concept page, see [Routing](../../network/concepts/routing.md#routing).
...
For an example of a task page, see [Migrating a Cluster to Cilium](../../installation/k8s-install-migration.md#cni_migration).
...
For an example of a tutorial page, see [Inspecting Network Flows with the CLI](../../observability/hubble/hubble-cli.md#hubble_cli).
...
to that page in the documentation. Ask on Cilium Slack <!-- unresolved-rst-link: kind=named target=Cilium Slack --> (``#sig-docs``) for
