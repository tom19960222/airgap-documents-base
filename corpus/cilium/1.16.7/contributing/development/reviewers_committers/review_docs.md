...
collection: cilium
version: "1.16.7"
title: "Reviewing for @cilium/docs-structure"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/contributing/development/reviewers_committers/review_docs.rst
...
Team [@cilium/docs-structure]([docs-structure_team](https://github.com/orgs/cilium/teams/docs-structure)) <!-- unresolved-source-link: target=[docs-structure_team](https://github.com/orgs/cilium/teams/docs-structure) --> is a GitHub team of
...
[listed here]([docs-structure_to_review](https://github.com/cilium/cilium/pulls?q=is%3Apr+is%3Aopen+draft%3Afalse+team-review-requested%3Acilium%2Fdocs-structure)) <!-- unresolved-source-link: target=[docs-structure_to_review](https://github.com/cilium/cilium/pulls?q=is%3Apr+is%3Aopen+draft%3Afalse+team-review-requested%3Acilium%2Fdocs-structure) -->.

To join the team, you must be a Cilium Reviewer. See [Cilium's Contributor Ladder](https://github.com/cilium/community/blob/main/CONTRIBUTOR-LADDER.md) for details on the requirements and the
application process.

## Reviewing Pull Requests

This section describes some of the process and expectations for reviewing PRs
on behalf of cilium/docs-structure. Note that [the generic PR review process for Committers](review_process.md#review_process) applies, even though it is not
...
See also [the recommendations on documentation structure for contributors](../../docs/docsstructure.md#docs_structure_recommendations).

### Specific items to look out for

#### Backport labels

See [the backport criteria for documentation changes](../../release/backports.md#backport_criteria_docs). Mark the PR for backports by setting the labels for
...
[Netlify](https://www.netlify.com/?attr=homepage-modal) builds a new preview for each PR touching the documentation. You are
...
Read [Cilium's documentation style guide](../../docs/docsstyle.md#docs_style_guide).
...
Keep an eye on [code-blocks](../../docs/docsstyle.md#docs_style_code_blocks): do they include RST
...
framework:
  ...
  - [Instructions for building the documentation locally](../../docs/docstest.md#testing-documentation)
  ...
  - The Sphinx theme we use is [our own fork]([cilium_rtd_theme](https://github.com/cilium/sphinx_rtd_theme)) <!-- unresolved-source-link: target=[cilium_rtd_theme](https://github.com/cilium/sphinx_rtd_theme) --> of Read the
    Docs's theme
