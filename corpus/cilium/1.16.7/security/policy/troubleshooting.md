...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/security/policy/troubleshooting.rst
...
1. After making a DNS request, the FQDN to IP mapping should be available via
...
1. If the traffic is allowed, then these IPs should have corresponding local identities via
...
different identities being allocated, as described in [identity-relevant-labels](../../operations/performance/scalability/identity-relevant-labels.md#identity-relevant-labels).
...
refer to [metrics](../../configuration/api-rate-limiting.md#metrics).
