...
collection: cilium
version: "1.16.7"
title: "Inspecting TLS Encrypted Connections with Cilium"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/security/tls-visibility.rst
...
<https://en.wikipedia.org/wiki/Transport_Layer_Security> <!-- unresolved-rst-link: kind=named target=<https://en.wikipedia.org/wiki/Transport_Layer_Security> --> .
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/security/images/cilium_tls_visibility_gsg.png)
...
and will have no access to any other external destinations either. Refer to [Network Policy](../network/clustermesh/policy.md#network-policy)
...
Refer to [l4_policy](policy/language.md#l4_policy) and [l7_policy](policy/language.md#l7_policy) to learn more about Cilium L4 and L7 network policies.
