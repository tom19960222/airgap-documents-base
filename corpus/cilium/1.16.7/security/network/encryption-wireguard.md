...
collection: cilium
version: "1.16.7"
title: "WireGuard Transparent Encryption"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/security/network/encryption-wireguard.rst
...
<a id="encryption_wg"></a>

# WireGuard Transparent Encryption

This guide explains how to configure Cilium with transparent encryption of
traffic between Cilium-managed endpoints using [WireGuard®](https://www.wireguard.com/).
...
.. tabs::
   ...
   .. group-tab:: Helm
      ...
      [k8s_install_helm](../../installation/k8s-install-helm.md#k8s_install_helm), pass the following options:
...
> **Note:**
> When running with the CNI chaining (e.g., [chaining_aws_cni](../../installation/cni-chaining-aws-cni.md#chaining_aws_cni)), set the
...
WireGuard enabled Cilium clusters can be connected via [Cluster Mesh](encryption-wireguard.md#cluster-mesh). The
...
| **Services** |  |  |  |
| Pod <br> | remote Pod via <br> ClusterIP Service | any <br> | default <br> |
| Pod <br> <br> <br> | remote Pod via <br> non ClusterIP <br> Service (e.g., <br> NodePort) | Socket LB <br> <br> <br> | default <br> <br> <br> |
| Pod <br> <br> | remote Pod via <br> non ClusterIP <br> Service | kube-proxy <br> <br> | node-to-node <br> <br> |
| Client outside <br> cluster <br> <br> | remote Pod via <br> Service <br> <br> | KPR, <br> overlay routing, <br> without DSR, <br> without XDP | default <br> <br> <br> |
| Client outside <br> cluster | remote Pod via <br> Service | native routing, <br> without XDP | node-to-node <br> |
| Client outside <br> cluster <br> | remote Pod or <br> remote Node via <br> Service | DSR in Geneve mode, <br> without XDP <br> | default <br> <br> |
| Pod <br> <br> | remote Pod via L7 <br> Proxy or L7 <br> Ingress Service | L7 Proxy / Ingress <br> <br> | default <br> <br> |
| **Egress Gateway** |  |  |  |
| Pod | Egress Gateway node | Egress Gateway | default |
| Egress Gateway <br> node | Pod <br> | Egress Gateway <br> without XDP | default <br> |
...
* Packets may be dropped when configuring the WireGuard device leading to
  ...
  ``sendmsg`` and ``sendto``. See 33159 for more details.
