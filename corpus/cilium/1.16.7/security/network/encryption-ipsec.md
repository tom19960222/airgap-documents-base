...
collection: cilium
version: "1.16.7"
title: "IPsec Transparent Encryption"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/security/network/encryption-ipsec.rst
...
information on Cilium's transparent encryption, see [ebpf_datapath](../../network/ebpf/index.md#ebpf_datapath).
 ...
 * ``XfrmInStateProtoError`` errors can happen for the following reasons:
   ...
   in [ipsec_key_rotation](encryption-ipsec.md#ipsec_key_rotation) instructions above). It can be fixed by
...
## Limitations
    ...
    * Transparent encryption is not currently supported when chaining Cilium on
      top of other CNI plugins. For more information, see 15596.
    * [HostPolicies](../policy/language.md#hostpolicies) are not currently supported with IPsec encryption.
