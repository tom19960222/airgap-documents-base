...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/reference-guides/bpf/index.rst
...
there are many use cases for BPF apart from networking. See [bpf_users](resources.md#bpf_users)
for a list of projects which use BPF.

Cilium uses BPF heavily in its data path, see [ebpf_datapath](../../network/ebpf/index.md#ebpf_datapath) for further
