...
collection: cilium
version: "1.16.7"
title: "BPF Architecture"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/reference-guides/bpf/architecture.rst
...
![](/images/bpf_tailcall_subprograms.png)
...
| 2 <br> | Unprivileged use of bpf syscall disabled <br> (default if ``BPF_UNPRIV_DEFAULT_OFF`` is enabled in kernel config) |
