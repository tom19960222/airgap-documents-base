...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/reference-guides/bpf/toolchain.rst
...
> anymore. See section [bpf_to_bpf_calls](architecture.md#bpf_to_bpf_calls) or the cover letter mail
...
> you may compile it by following the instruction in the [tooling_llvm](toolchain.md#tooling_llvm)
> section.
...
If you see any failures, please contact us on Cilium Slack <!-- unresolved-rst-link: kind=named target=Cilium Slack --> with the full
test output.
