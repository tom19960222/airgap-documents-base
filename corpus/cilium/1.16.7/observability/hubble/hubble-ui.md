...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/hubble-ui.rst
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/images/hubble_sw_service_map.png)

> **Note:**
> This guide assumes that Cilium and Hubble have been correctly installed in your
> Kubernetes cluster. Please see [k8s_quick_install](../../gettingstarted/k8s-install-default.md#k8s_quick_install) and [hubble_setup](setup.md#hubble_setup)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/images/hubble_service_map_namespace_selector.png)

In this example, we are deploying the Star Wars demo from the [gs_http](../../security/http.md#gs_http)
