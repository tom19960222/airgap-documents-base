...
collection: cilium
version: "1.16.7"
title: "Configuring Hubble exporter"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/configuration/export.rst
...
You can use ``hubble`` CLI to generated required filters (see [Specifying Raw Flow Filters](https://github.com/cilium/hubble#specifying-raw-flow-filters) for more examples).
...
names from the [flow proto](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/api/v1/flow/flow.proto) definition.
