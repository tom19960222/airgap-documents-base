...
collection: cilium
version: "1.16.7"
title: "Configure TLS with Hubble"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/configuration/tls.rst
...
Cilium [getting_started](../../../index.md#getting_started) guide.
...
* cilium's [certgen](https://github.com/cilium/certgen) (using a Kubernetes ``CronJob``)
* [cert-manager](https://cert-manager.io/)
* [Helm](https://helm.sh/docs/chart_template_guide/function_list/#gensignedcert)
...
.. tabs::
   ...
   .. group-tab:: cert-manager
       ...
       This method relies on [cert-manager](https://cert-manager.io/) to generate
       ...
       * Support for multiple issuers (e.g. a custom CA,
         ...
         [Google's Certificate Authority Service](https://cloud.google.com/certificate-authority-service),
       ...
       **Installation steps**:
       ...
       #. First, install [cert-manager](https://cert-manager.io/docs/installation/)
          and setup an [issuer](https://cert-manager.io/docs/configuration/).
   ...
   .. group-tab:: User Provided Certificates
       ...
       - ``hubble.metrics.tls.server.existingSecret`` only needs to be provided when ``hubble.metrics.tls.enabled`` (default ``false``).
         For more details on configuring the Hubble metrics API with TLS, see [hubble_configure_metrics_tls](tls.md#hubble_configure_metrics_tls).
   ...
   .. group-tab:: cert-manager
       ...
       .. tabs::
           ...
           .. tab:: Install CRDs first
               ...
               Install cert-manager CRDs before Cilium and cert-manager (see [cert-manager's documentation about installing CRDs with kubectl](https://cert-manager.io/docs/installation/helm/#option-1-installing-crds-with-kubectl)):
...
<a id="hubble_configure_metrics_tls"></a>
...
> **Note:**
> This section assumes that you have already enabled [Hubble metrics](../../metrics.md#hubble_metrics).
...
<a id="hubble_api_tls"></a>

## Access the Hubble API with TLS Enabled

The examples are adapted from [hubble_cli](../hubble-cli.md#hubble_cli).
