...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/hubble/setup.rst
...
> Kubernetes cluster. Please see [k8s_quick_install](../../gettingstarted/k8s-install-default.md#k8s_quick_install) for more
...
<a id="hubble_validate_api_access"></a>
...
cluster. For more information on this method, see [Use Port Forwarding to Access Application in a Cluster](https://kubernetes.io/docs/tasks/access-application-cluster/port-forward-access-application-cluster/).
...
> **Note:**
> If you have [enabled TLS](configuration/tls.md#hubble_enable_tls) then you will need to specify additional flags to [access the Hubble API](configuration/tls.md#hubble_api_tls).

## Next Steps

* [hubble_cli](hubble-cli.md#hubble_cli)
* [hubble_ui](hubble-ui.md#hubble_ui)
* [hubble_enable_tls](configuration/tls.md#hubble_enable_tls)
