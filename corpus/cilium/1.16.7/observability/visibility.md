...
collection: cilium
version: "1.16.7"
title: "Layer 7 Protocol Visibility"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/observability/visibility.rst
...
While [monitor](../operations/troubleshooting.md#monitor) provides introspection into datapath state, by default, it
will only provide visibility into L3/L4 packet events. If you want L7
protocol visibility, you can use L7 Cilium Network Policies (see [l7_policy](../security/policy/language.md#l7_policy)).
...
proxy (see [proxy_injection](../security/network/proxy/index.md#proxy_injection)) such that the output of ``cilium monitor`` or
...
> present in [Layer 7 Hubble Flows](https://github.com/cilium/cilium/tree/2ab5f8da5915992a1e548c290105dbc08f4be52d/api/v1/flow#flow-Layer7).
...
For more information on configuring Cilium, see [Cilium Configuration](../configuration/api-rate-limiting.md#configuration).
