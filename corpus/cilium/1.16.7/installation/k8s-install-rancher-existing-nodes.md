...
collection: cilium
version: "1.16.7"
title: "Installation using Rancher"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/k8s-install-rancher-existing-nodes.rst
...
<a id="rancher_managed_rke_clusters"></a>
...
over to the [installation guides for standalone RKE clusters](k8s-install-rke.md#rke_install).

Rancher comes with [official support for Cilium](https://ranchermanager.docs.rancher.com/faq/container-network-interface-providers).
For most Rancher users, that's the recommended way to use Cilium on Rancher-managed
clusters.

However, as Rancher is using a custom
``rke2-cilium`` [Helm chart](https://github.com/rancher/rke2-charts/tree/main-source/packages/rke2-cilium)
...
> [RKE 1 standalone guide](k8s-install-rke.md#rke1_cni_none), but there's no need to copy over
...
* Fully functioning [Rancher Version 2.x](https://ranchermanager.docs.rancher.com/) instance
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_add_cluster.png)

On the Cluster creation page select to create a new ``Custom`` cluster:

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_existing_nodes.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_edit_as_yaml.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_delete_network_plugin.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_network_plugin_none.png)
...
want to run [Cilium without Kube-Proxy](../network/kubernetes/kubeproxy-free.md#kubeproxy-free).
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_cluster_state_provisioning.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_add_nodes.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_node_not_ready.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_my_cluster_active.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_add_repository.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_add_repository_cluster.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_add_cilium_repository.png)

Once added, you should see the Cilium repository in the repositories list:

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_repositories_list_success.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_cluster_cilium_app.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_cluster_cilium_app_upgrade.png)

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/installation/images/rancher_cluster_cilium_app_upgrade_version.png)
