...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/community/community.rst
...
- Meeting notes: [Google Doc](https://docs.google.com/document/d/1Y_4chDk4rznD6UgXPlPvn3Dc7l-ZutGajUv1eF0VDwQ/edit#)
...
- Meeting notes: [Google Doc](https://docs.google.com/document/d/1egv4qLydr0geP-GjQexYKm4tz3_tHy-LCBjVQcXcT5M/edit#)

# Slack

Our [Cilium & eBPF Slack](Cilium [Slack](community.md#slack)) <!-- unresolved-source-link: target=Cilium [Slack](community.md#slack) --> is the main discussion space for the
Cilium community.
...
| ``#ebpf-go-dev`` | Development discussion for the [eBPF Go library](https://github.com/cilium/ebpf) |
...
| ``#ebpf-go`` | Questions on the [eBPF Go library](https://github.com/cilium/ebpf) |
| ``#ebpf-lsm`` | Questions on BPF Linux Security Modules (LSM) |
| ``#echo-news`` | Contributions to [eCHO News](https://cilium.io/newsletter/) |
...
1. Open a new [GitHub issue in the cilium/community repo](https://github.com/cilium/community/issues)
...
| Policy | [Second Tuesday](https://isogo.to/sig-policy) | ``#sig-policy`` | Network policy and enforcement. |
...
1. Open a new [GitHub issue in the cilium/cilium repo](https://github.com/cilium/cilium/issues)
