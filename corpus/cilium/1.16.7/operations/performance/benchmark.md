...
collection: cilium
version: "1.16.7"
title: "CNI Performance Benchmark"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/benchmark.rst
...
.. admonition:: Video
   ...
   in [eCHO episode 5: Network performance benchmarking](https://www.youtube.com/watch?v=2lGag_j4dIw&t=377s).

> **Tip:**
> To achieve these performance results, follow the [performance_tuning](tuning.md#performance_tuning).

For more information on the used system and configuration, see
[test_hardware](benchmark.md#test_hardware). For more details on all tested configurations, see
[test_configurations](benchmark.md#test_configurations).
...
For the various benchmarks [netperf](https://github.com/HewlettPackard/netperf) has been used to generate the workloads
and to collect the metrics. For spawning parallel netperf sessions,
[super_netperf](https://raw.githubusercontent.com/borkmann/netperf_scripts/master/super_netperf)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_stream_1_stream.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_stream_1_stream_cpu.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_stream_32_streams.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_stream_32_streams_cpu.png)

<a id="request_response"></a>
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_rr_1_process.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_rr_1_process_cpu.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_rr_32_processes.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_rr_32_processes_cpu.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_crr_1_process.png)

The following graph shows the total CPU consumption across the entire system
while running the benchmark:

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_crr_1_process_cpu.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_crr_32_processes.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_tcp_crr_32_processes_cpu.png)
...
please see [performance_wireguard_ipsec](benchmark.md#performance_wireguard_ipsec).
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_tcp_1_stream.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_tcp_1_stream_cpu.png)

### WireGuard Request/Response

The next benchmark measures the request/response rate while encrypting with
WireGuard. See [request_response](benchmark.md#request_response) for details on what this test actually
entails.

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_rr_1_process.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_rr_1_process_cpu.png)

<a id="performance_wireguard_ipsec"></a>
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_ipsec_tcp_stream_1_stream.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_ipsec_tcp_stream_1_stream_cpu.png)
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_ipsec_tcp_rr_1_process.png)

![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/performance/images/bench_wireguard_ipsec_tcp_rr_1_process_cpu.png)

## Test Environment

<a id="test_hardware"></a>
...
| Item | Description |
| --- | --- |
| CPU | [AMD Ryzen 9 3950x](https://www.amd.com/en/support/cpu/amd-ryzen-processors/amd-ryzen-9-desktop-processors/amd-ryzen-9-3950x), AM4 platform, 3.5GHz, |
| Mainboard | [x570 Aorus Master](https://www.gigabyte.com/us/Motherboard/X570-AORUS-MASTER-rev-11-12/sp#sp), PCIe 4.0 x16 support |
| Memory | [HyperX Fury DDR4-3200](https://www.hyperxgaming.com/us/memory/fury-ddr4) 128GB, XMP clocked to 3.2GHz |
| Network Card | [Intel E810-CQDA2](https://ark.intel.com/content/www/us/en/ark/products/192558/intel-ethernet-network-adapter-e810-cqda2.html), dual port, 100Gbit/s |
| Kernel | Linux 5.10 LTS, see also [performance_tuning](tuning.md#performance_tuning) |

<a id="test_configurations"></a>
...
be found in [cilium/cilium-perf-networking](https://github.com/cilium/cilium-perf-networking).
All scripts in this document refer to this repository. Specifically, we use
[Terraform](https://www.terraform.io/) and [Ansible](https://www.ansible.com/) to setup the environment and execute benchmarks.
We use [Packet](https://deploy.equinix.com/) bare metal servers as our hardware
...
To evaluate both [arch_overlay](../../network/concepts/routing.md#arch_overlay) and [native_routing](../../network/concepts/routing.md#native_routing), we configure
the Packet machines to use a ["Mixed/Hybrid"](https://deploy.equinix.com/developers/docs/metal/layer2-networking/overview/) network
...
for our evaluations (see [Packet documentation](https://deploy.equinix.com/developers/docs/metal/layer2-networking/overview/) and our
...
We use [kubenetbench](https://github.com/cilium/kubenetbench) to execute the
[netperf](https://github.com/HewlettPackard/netperf) benchmark in a Kubernetes environment. kubenetbench is a Kubernetes
...
<a id="tunneling_results"></a>

#### Tunneling

Configure Cilium in tunneling ([arch_overlay](../../network/concepts/routing.md#arch_overlay)) mode:
...
<a id="native_routing_results"></a>

#### Native Routing

We repeat the same operation as before, but configure Cilium to use
[native_routing](../../network/concepts/routing.md#native_routing) (``-e mode=directrouting``).
