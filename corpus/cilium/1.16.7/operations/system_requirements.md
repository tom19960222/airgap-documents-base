...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/operations/system_requirements.rst
...
- [Linux kernel](system_requirements.md#linux-kernel) >= 5.4 or equivalent (e.g., 4.18 on RHEL 8.6)
...
- [clang+LLVM](https://llvm.org) >= 10.0

When running Cilium without Kubernetes these additional requirements
must be met:

- [req_kvstore](system_requirements.md#req_kvstore) etcd >= 3.1.0

| Requirement | Minimum Version | In cilium container |
| --- | --- | --- |
| [Linux kernel](system_requirements.md#linux-kernel) | >= 5.4 or >= 4.18 on RHEL 8.6 | no |
...
| --- | --- |
| [Amazon Linux 2](https://docs.aws.amazon.com/AL2/latest/relnotes/relnotes-al2.html) | all |
| [Bottlerocket OS](https://github.com/bottlerocket-os/bottlerocket) | all |
| [CentOS](https://centos.org) | >= 8.6 |
| [Container-Optimized OS](https://cloud.google.com/container-optimized-os/docs) | >= 85 |
| [Debian](https://www.debian.org/releases/) | >= 10 Buster |
| [Fedora CoreOS](https://fedoraproject.org/coreos/release-notes) | >= 31.20200108.3.0 |
| [Flatcar](https://www.flatcar.org/releases) | all |
| [LinuxKit](https://github.com/linuxkit/linuxkit/tree/master/kernel) | all |
| [Opensuse](https://en.opensuse.org/openSUSE:Roadmap) | Tumbleweed, >=Leap 1 |
| [RedHat Enterprise Linux](https://www.redhat.com/en/technologies/linux-platforms/enterprise-linux) | >= 8.6 |
| [RedHat CoreOS](https://access.redhat.com/articles/6907891) | >= 4.12 |
| [Talos Linux](https://www.talos.dev/) | >= 1.5.0 |
| [Ubuntu](https://www.releases.ubuntu.com/) | >= 20.04 |
...
that require newer kernels, see [advanced_features](system_requirements.md#advanced_features).
...
<a id="features_kernel_matrix"></a>

### Requirements for IPsec

The [encryption_ipsec](../security/network/encryption-ipsec.md#encryption_ipsec) feature requires a lot of kernel configuration
...
The [bandwidth-manager](../network/kubernetes/bandwidth-manager.md#bandwidth-manager) requires the following kernel configuration option
...
The [netkit](performance/tuning.md#netkit) requires the following kernel configuration option
...
| --- | --- |
| [encryption_wg](../security/network/encryption-wireguard.md#encryption_wg) | >= 5.6 |
| Full support for [session-affinity](../network/kubernetes/kubeproxy-free.md#session-affinity) | >= 5.7 |
| BPF-based proxy redirection | >= 5.7 |
| Socket-level LB bypass in pod netns | >= 5.7 |
| L3 devices | >= 5.8 |
| BPF-based host routing | >= 5.10 |
| [enable_multicast](../network/multicast.md#enable_multicast) (AMD64) | >= 5.10 |
| IPv6 BIG TCP support | >= 5.19 |
| [enable_multicast](../network/multicast.md#enable_multicast) (AArch64) | >= 6.0 |
...
store backed identity management instead, see [k8s_quick_install](../gettingstarted/k8s-install-default.md#k8s_quick_install)
for more details.

See [install_kvstore](../cmdref/kvstore.md#install_kvstore) for details on how to configure the
...
[bpffs_systemd](../network/kubernetes/configuration.md#bpffs_systemd).

## Routing Tables

When running in [ipam_eni](../network/concepts/ipam/eni.md#ipam_eni) IPAM mode, Cilium will install per-ENI routing
