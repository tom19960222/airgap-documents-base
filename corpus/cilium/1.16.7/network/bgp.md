...
collection: cilium
version: "1.16.7"
title: "MetalLB BGP ControlPlane (deprecated)"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/bgp.rst
...
> to use the [BGP Control Plane](bgp-control-plane/bgp-control-plane.md#bgp_control_plane) feature instead whenever
> possible. More details are available at 22246.
...
It leverages [MetalLB's](https://metallb.universe.tf/) simple and effective
...
``ExternalTrafficPolicy``. See MetalLB's [documentation](https://metallb.universe.tf/usage/#bgp) on this specific topic.
