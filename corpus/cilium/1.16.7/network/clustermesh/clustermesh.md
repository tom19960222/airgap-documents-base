...
collection: cilium
version: "1.16.7"
title: "Setting up Cluster Mesh"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/clustermesh/clustermesh.rst
fetched_at: 2025-02-13T12:04:31Z
---
<a id="clustermesh"></a>
<a id="gs_clustermesh"></a>
...
.. admonition:: Video
   ...
   Clustermesh feature works, check out [eCHO Episode 41: Cilium Clustermesh](https://www.youtube.com/watch?v=VBOONHW65NU&t=342s).
...
* All clusters must be configured with the same datapath mode. Cilium install
  may default to [arch_overlay](../concepts/routing.md#arch_overlay) or [native_routing](../concepts/routing.md#native_routing) mode depending on
...
* The network between clusters must allow the inter-cluster communication. The
  exact ports are documented in the [firewall_requirements](../../operations/system_requirements.md#firewall_requirements) section.

> **Note:**
> For cloud-specific deployments, you can check out the [gs_clustermesh_aks_prep](aks-clustermesh-prep.md#gs_clustermesh_aks_prep)
> guide for Azure Kubernetes Service (AKS), the [gs_clustermesh_eks_prep](eks-clustermesh-prep.md#gs_clustermesh_eks_prep)
> guide for Amazon Elastic Kubernetes Service (EKS) or the [gs_clustermesh_gke_prep](gke-clustermesh-prep.md#gs_clustermesh_gke_prep)
...
> [security_identities](../../internals/security-identities.md#security_identities) are limited to 65535, regardless of whether Cluster Mesh is used or
> not.
...
Review [k8s_install_quick](../../gettingstarted/k8s-install-default.md#k8s_install_quick) for more details and use cases.
...
> You can opt out of [kvstoremesh](intro.md#kvstoremesh) when enabling the Cluster Mesh.
>
> ```shell-session
 ...
 * [gs_clustermesh_services](services.md#gs_clustermesh_services)
 * [gs_clustermesh_network_policy](policy.md#gs_clustermesh_network_policy)
...
[troubleshooting_clustermesh](../../operations/troubleshooting.md#troubleshooting_clustermesh) for a more detailed troubleshooting guide.
