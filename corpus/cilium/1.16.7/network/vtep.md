...
collection: cilium
version: "1.16.7"
title: "VXLAN Tunnel Endpoint (VTEP) Integration (beta)"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/vtep.rst
...
> from the VTEP as the world identity. See [reserved_labels](../gettingstarted/terminology.md#reserved_labels) for more details.
...
you have configured on the VTEPs. Follow the instructions to [enable_vtep](vtep.md#enable_vtep).
