...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/servicemesh/ingress-to-gateway/ingress-to-gateway.rst
...
For more information about the Gateway API, see [the Gateway API project page](https://gateway-api.sigs.k8s.io/).
...
- *automated*: creating rules using the [ingress2gateway tool](https://github.com/kubernetes-sigs/ingress2gateway).
...
As noted in [Benefits of the Gateway API](ingress-to-gateway.md#benefits-of-the-gateway-api), the Gateway API avoids implementation-specific annotations in order to provide a portable configuration.
