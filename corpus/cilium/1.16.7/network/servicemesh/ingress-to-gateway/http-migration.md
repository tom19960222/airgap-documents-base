...
collection: cilium
version: "1.16.7"
title: "HTTP Migration Example"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/servicemesh/ingress-to-gateway/http-migration.rst
...
<a id="gs_gateway_http_migration"></a>
...
The Cilium [gs_ingress_http](../http.md#gs_ingress_http) serves as the starting Ingress configuration.
...
For more information, consult the Gateway API [gs_gateway_http](../gateway-api/http.md#gs_gateway_http).
