...
collection: cilium
version: "1.16.7"
title: "Setting up Support for External Workloads (beta)"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/external-workloads.rst
...
<a id="external_workloads"></a>

<a id="gs_external_workloads"></a>
...
* External workloads must run a recent enough kernel (>= 4.19.57) for k8s
  ...
  [kubeproxy-free](kubernetes/kubeproxy-free.md#kubeproxy-free) for details.
...
* The network between the external workloads and your cluster must
  ...
  in the [firewall_requirements](../operations/system_requirements.md#firewall_requirements) section.
