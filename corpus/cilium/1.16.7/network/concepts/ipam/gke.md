...
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/ipam/gke.rst
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/ipam/gke_ipam_arch.png)
...
by the enabled address families (IPv4/IPv6). See [k8s_hostscope](kubernetes.md#k8s_hostscope) for
additional details of this IPAM mode.

The corresponding datapath is described in section [gke_datapath](../routing.md#gke_datapath).

See the getting started guide [k8s_install_quick](../../../gettingstarted/k8s-install-default.md#k8s_install_quick) to install Cilium Google
