...
collection: cilium
version: "1.16.7"
title: "Multi-Pool (Beta)"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/ipam/multi-pool.rst
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/ipam/multi-pool.png)
...
is enforced until 26966 is resolved.
...
> [gsg_ipam_crd_multi_pool](../../kubernetes/ipam-multi-pool.md#gsg_ipam_crd_multi_pool).
...
[bgp_control_plane](../../bgp-control-plane/bgp-control-plane.md#bgp_control_plane) ([bgp_control_plane_multipool_ipam](../../bgp-control-plane/bgp-control-plane-v1.md#bgp_control_plane_multipool_ipam)). Alternatively,
the ``autoDirectNodeRoutes`` Helm option can be used to enable automatic routing
between nodes on a L2 network.

<a id="ipam_crd_multi_pool_limitations"></a>
...
>   requires the use of per-endpoint routes (see [native_routing](../routing.md#native_routing)) instead.
> - iptables-based masquerading requires ``egressMasqueradeInterfaces`` to be set
>   (see masquerading [masq_modes](../masquerading.md#masq_modes) and 22273 for details).
...
>   CIDRs to be defined. See [concepts_masquerading](../masquerading.md#concepts_masquerading) for details on how to use the
