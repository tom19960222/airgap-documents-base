...
version: "1.16.7"
title: "Masquerading"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/masquerading.rst
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/concepts/masquerade.png)
...
Setting the masquerading interface
  See [masq_modes](masquerading.md#masq_modes) for configuring the masquerading interfaces.
...
The current implementation depends on [the BPF NodePort feature](../kubernetes/kubeproxy-free.md#kubeproxy-free).
The dependency will be removed in the future (13732).
...
[the BPF NodePort device detection mechanism](../kubernetes/kubeproxy-free.md#nodeport-devices).
...
To allow more fine-grained control, Cilium implements [ip-masq-agent](https://github.com/kubernetes-sigs/ip-masq-agent) in eBPF which can be
