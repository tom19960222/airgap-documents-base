...
collection: cilium
version: "1.16.7"
title: "BGP Control Plane Resources"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/bgp-control-plane/bgp-control-plane-v2.rst
...
![](https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/bgp-control-plane/bgpv2.png)
...
- [MD5 Password](bgp-control-plane-v2.md#bgp_peer_configuration_password)
- [Timers](bgp-control-plane-v2.md#bgp_peer_configuration_timers)
- [EBGP Multihop](bgp-control-plane-v2.md#bgp_ebgp_multihop)
- [Graceful Restart](bgp-control-plane-v2.md#bgp_peer_configuration_graceful_restart)
- [Transport](bgp-control-plane-v2.md#bgp_peer_configuration_transport)
- [Address Families](bgp-control-plane-v2.md#bgp_peer_configuration_afi)
...
<a id="bgp_peer_configuration_password"></a>

### MD5 Password

``AuthSecretRef`` in ``CiliumBGPPeerConfig`` can be used to configure an [RFC-2385](https://www.rfc-editor.org/rfc/rfc2385.html) TCP MD5 password
...
<a id="bgp_peer_configuration_timers"></a>

### Timers

BGP Control Plane supports modifying the following BGP timer parameters. For
more detailed description for each timer parameters, please refer to [RFC4271](https://datatracker.ietf.org/doc/html/rfc4271).
...
<a id="bgp_peer_configuration_graceful_restart"></a>
...
``RestartTime`` can be found in [RFC-4724](https://www.rfc-editor.org/rfc/rfc4724.html) and [RFC-8538](https://www.rfc-editor.org/rfc/rfc8538.html).

<a id="bgp_peer_configuration_transport"></a>
...
By default, when BGP is operating in [active mode](https://datatracker.ietf.org/doc/html/rfc4271#section-8.2.1)
...
<a id="bgp_peer_configuration_afi"></a>
...
Multiprotocol Extensions Capability ([RFC-4760](https://www.rfc-editor.org/rfc/rfc4760.html)) to the peer.

In each address family, you can control the route publication via the ``advertisements`` label selector.
Various advertisements types are defined [here](bgp-control-plane-v2.md#bgp-adverts).
...
[peer configuration](bgp-control-plane-v2.md#bgp_peer_configuration_afi) may match with one or more of the ``CiliumBGPAdvertisement``
resources.
...
The values can be of three types:
 ...
 - ``Standard``: represents a value of the "standard" 32-bit BGP Communities Attribute ([RFC-1997](https://www.rfc-editor.org/rfc/rfc1997.html))
   as a 4-byte decimal number or two 2-byte decimal numbers separated by a colon (for example: ``64512:100``).
 - ``WellKnown``: represents a value of the "standard" 32-bit BGP Communities Attribute ([RFC-1997](https://www.rfc-editor.org/rfc/rfc1997.html))
...
| ``no-peer`` | ``0xffffff04`` | ``65535:65284`` |
 ...
 - ``Large``: represents a value of the BGP Large Communities Attribute ([RFC-8092](https://www.rfc-editor.org/rfc/rfc8092.html)),
...
- [Pod CIDR ranges](bgp-control-plane-v2.md#bgp-adverts-podcidr)
- [Service Virtual IPs](bgp-control-plane-v2.md#bgp-adverts-service)

<a id="bgp-adverts-podcidr"></a>
...
When [Kubernetes](../concepts/ipam/kubernetes.md#k8s_hostscope) or [ClusterPool](../concepts/ipam/cluster-pool.md#ipam_crd_cluster_pool) IPAM is used, set advertisement type to ``PodCIDR``.
...
<a id="bgp-adverts-multipool"></a>

##### MultiPool IPAM

When [MultiPool IPAM](../concepts/ipam/multi-pool.md#ipam_crd_multi_pool) is used, specify the
...
For additional details regarding CiliumPodIPPools, see the [ipam_crd_multi_pool](../concepts/ipam/multi-pool.md#ipam_crd_multi_pool) section.
...
If you wish to use this together with ``kubeProxyReplacement`` feature  (see [kubeproxy-free](../kubernetes/kubeproxy-free.md#kubeproxy-free) docs),
...
See [External Access To ClusterIP Services](../kubernetes/kubeproxy-free.md#external_access_to_clusterip_services) section
...
IPs. Cilium supports assigning ingress IPs with the [Load Balancer IPAM](../lb-ipam.md#lb_ipam) feature.
...
Cilium supports the [loadBalancerClass](https://kubernetes.io/docs/concepts/services-networking/service/#load-balancer-class).
...
Please refer to container lab examples in Cilium repository under [contrib/containerlab/bgpv2](https://github.com/cilium/cilium/tree/2ab5f8da5915992a1e548c290105dbc08f4be52d/contrib/containerlab/bgpv2).
