...
collection: cilium
version: "1.16.7"
title: "Egress Gateway Advanced Troubleshooting"
source_url: https://github.com/cilium/cilium/blob/2ab5f8da5915992a1e548c290105dbc08f4be52d/Documentation/network/egress-gateway/egress-gateway-troubleshooting.rst
...
For alerting and observability on SNAT source port utilization please see the [NAT endpoint max connection](../../observability/metrics.md#nat_metrics) metric which tracks the top saturation (as a percentage of total the max available) of a Cilium Agent.
