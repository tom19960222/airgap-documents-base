...
collection: cephcsi
version: "3.15.1"
title: "CSI RBD Plugin"
source_url: https://github.com/ceph/ceph-csi/blob/f8b8b1416793ceaf6e01592b77f438e8b4c3b6b8/docs/rbd/deploy.md
fetched_at: 2025-11-17T13:16:27Z
---
# CSI RBD Plugin
...
running pods. Refer to [Creating CSI configuration](../examples/README.md#creating-csi-configuration) <!-- unresolved-source-link: target=../examples/README.md#creating-csi-configuration -->
...
Use the [rbd templates](../deploy/rbd/kubernetes) <!-- unresolved-source-link: target=../deploy/rbd/kubernetes -->
...
provisioning](../examples/README.md#creating-csi-configuration) <!-- unresolved-source-link: target=../examples/README.md#creating-csi-configuration -->
for more information.
...
please refer to [snap-clone.md](./snap-clone.md#prerequisite) <!-- unresolved-source-link: target=./snap-clone.md#prerequisite -->
...
[provisioner](../deploy/rbd/kubernetes/csi-rbdplugin-provisioner.yaml) <!-- unresolved-source-link: target=../deploy/rbd/kubernetes/csi-rbdplugin-provisioner.yaml -->
and [nodeplugin](../deploy/rbd/kubernetes/csi-rbdplugin.yaml) <!-- unresolved-source-link: target=../deploy/rbd/kubernetes/csi-rbdplugin.yaml --> YAMLs.
...
Check the release version [here.](../README.md#ceph-csi-container-images-and-release-compatibility) <!-- unresolved-source-link: target=../README.md#ceph-csi-container-images-and-release-compatibility -->
...
instructions [provided](../examples/README.md#deploying-the-storage-class) <!-- unresolved-source-link: target=../examples/README.md#deploying-the-storage-class --> to
...
[See the Helm chart readme for installation instructions.](../charts/ceph-csi-rbd/README.md) <!-- unresolved-source-link: target=../charts/ceph-csi-rbd/README.md -->
...
[examples](../examples/kms/vault/csi-kms-connection-details.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/csi-kms-connection-details.yaml -->.
...
[example](../examples/kms/vault/kms-config.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/kms-config.yaml --> and use same
`encryptionKMSID`.
...
example](../examples/kms/vault/tenant-token.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/tenant-token.yaml -->.
...
that also like in
[example](../examples/kms/vault/csi-vaulttokenreview-rbac.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/csi-vaulttokenreview-rbac.yaml --> to be able to
review jwt tokens.
...
[`kms-config.yaml`](../examples/kms/vault/kms-config.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/kms-config.yaml --> where the
...
[example](../examples/kms/vault/tenant-sa.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/tenant-sa.yaml --> is available.
...
this up](../examples/kms/vault/tenant-token.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/tenant-token.yaml --> for a single Tenant that uses
...
file](../examples/kms/vault/kms-config.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/kms-config.yaml -->:
...
The [Secret with credentials](../examples/kms/vault/aws-credentials.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/aws-credentials.yaml --> for
...
The [Secret with credentials](../examples/kms/vault/aws-sts-credentials.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/aws-sts-credentials.yaml --> for
the AWS KMS is expected to contain:
...
The [Secret with credentials](../examples/kms/vault/azure-credentials.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/azure-credentials.yaml --> for
...
The [Secret with credentials](../examples/kms/vault/kmip-credentials.yaml) <!-- unresolved-source-link: target=../examples/kms/vault/kmip-credentials.yaml --> for
...
In the [ceph-conf](../../deploy/ceph-conf.yaml) <!-- unresolved-source-link: target=../../deploy/ceph-conf.yaml --> configmap, uncomment the
