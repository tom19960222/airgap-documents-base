...
collection: cephcsi
version: "3.15.1"
title: "Encrypted Volumes with a ServiceAccount per Tenant"
source_url: https://github.com/ceph/ceph-csi/blob/f8b8b1416793ceaf6e01592b77f438e8b4c3b6b8/docs/design/proposals/encryption-with-vault-sa.md
...
[`csi-kms-connection-details.yaml`](../../../examples/kms/vault/csi-kms-connection-details.yaml) <!-- unresolved-source-link: target=../../../examples/kms/vault/csi-kms-connection-details.yaml -->
.
...
[`tenant-config.yaml`](../../../examples/kms/vault/tenant-config.yaml) <!-- unresolved-source-link: target=../../../examples/kms/vault/tenant-config.yaml --> and
[`tenant-token.yaml`](../../../examples/kms/vault/tenant-token.yaml) <!-- unresolved-source-link: target=../../../examples/kms/vault/tenant-token.yaml -->.

Implementation is in [`vault_tokens.go`](../../../internal/util/vault_tokens.go) <!-- unresolved-source-link: target=../../../internal/util/vault_tokens.go -->
.
...
Implementation is in [`vault.go`](../../../internal/util/vault.go) <!-- unresolved-source-link: target=../../../internal/util/vault.go -->.
