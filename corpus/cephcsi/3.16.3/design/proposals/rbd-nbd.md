...
collection: cephcsi
version: "3.16.3"
title: "RBD NBD Mounter"
source_url: https://github.com/ceph/ceph-csi/blob/6a6498b24a9c423c40a0116dc07688e8e6d76a6c/docs/design/proposals/rbd-nbd.md
...
- In case if you need a customized log path, you should do below:
   ...
   - Edit the DaemonSet templates to change the ceph log directory host-path
      ...
      - For standard templates edit [csi-rbdplugin.yaml](../deploy/rbd/kubernetes/csi-rbdplugin.yaml) <!-- unresolved-source-link: target=../deploy/rbd/kubernetes/csi-rbdplugin.yaml -->
