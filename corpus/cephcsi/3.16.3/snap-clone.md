...
collection: cephcsi
version: "3.16.3"
title: "Create snapshot and Clone Volume"
source_url: https://github.com/ceph/ceph-csi/blob/6a6498b24a9c423c40a0116dc07688e8e6d76a6c/docs/snap-clone.md
...
[snapshotclass.yaml](../examples/rbd/snapshotclass.yaml) <!-- unresolved-source-link: target=../examples/rbd/snapshotclass.yaml -->
and [snapshot.yaml](../examples/rbd/snapshot.yaml) <!-- unresolved-source-link: target=../examples/rbd/snapshot.yaml -->
...
[pvc-restore.yaml](../examples/rbd/pvc-restore.yaml) <!-- unresolved-source-link: target=../examples/rbd/pvc-restore.yaml -->
and a testing pod [pod-restore.yaml](../examples/rbd/pod-restore.yaml) <!-- unresolved-source-link: target=../examples/rbd/pod-restore.yaml -->
