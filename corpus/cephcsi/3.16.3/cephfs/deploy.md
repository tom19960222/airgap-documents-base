...
source_url: https://github.com/ceph/ceph-csi/blob/6a6498b24a9c423c40a0116dc07688e8e6d76a6c/docs/cephfs/deploy.md
...
Use the [cephfs templates](../deploy/cephfs/kubernetes) <!-- unresolved-source-link: target=../deploy/cephfs/kubernetes -->
...
details, refer to [Creating CSI configuration](../examples/README.md#creating-csi-configuration) <!-- unresolved-source-link: target=../examples/README.md#creating-csi-configuration -->
for more information.
...
[provisioner](../deploy/cephfs/kubernetes/csi-cephfsplugin-provisioner.yaml) <!-- unresolved-source-link: target=../deploy/cephfs/kubernetes/csi-cephfsplugin-provisioner.yaml -->
and [nodeplugin](../deploy/cephfs/kubernetes/csi-cephfsplugin.yaml) <!-- unresolved-source-link: target=../deploy/cephfs/kubernetes/csi-cephfsplugin.yaml --> YAMLs.
...
[See the Helm chart readme for installation instructions.](https://github.com/ceph/ceph-csi/blob/6a6498b24a9c423c40a0116dc07688e8e6d76a6c/charts/ceph-csi-cephfs/README.md)
...
Support](design/proposals/cephfs-fscrypt.md) <!-- unresolved-source-link: target=design/proposals/cephfs-fscrypt.md --> for details.
