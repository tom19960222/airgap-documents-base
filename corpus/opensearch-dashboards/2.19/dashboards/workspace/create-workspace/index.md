...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/workspace/create-workspace.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/workspace/create-workspace.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/workspace/create-workspace/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/workspace/create-workspace/"
canonical_route: "/dashboards/workspace/create-workspace/"
redirect_from: []
...
Before getting started with this tutorial, you must enable the workspace feature flag. See [Enabling the ACL feature](../workspace/index.md#enabling-the-workspace-feature) for more information.

When the saved objects permission is enabled, only users with admin status can create workspaces. See [Configuring the dashboard admin](../workspace-acl/index.md#configuring-dashboard-administrators) for more information.
...
3. Enter the required information in the **Workspace details** window.
  ...
  - **Use case and features** is required. Choose the use case that best fits your needs. If you are using Amazon OpenSearch Serverless and have enabled the [multiple data sources](../../management/data-sources/index.md) feature, **Essentials** is automatically assigned.
...
6. Save your workspace.
  - The **Create workspace** button becomes active once you enter the information for all required fields. You become the workspace owner automatically. The system redirects you to either the collaborators page if the saved objects permission is enabled or the overview page if the saved objects permission is disabled. See [Configuring dashboard admin](../workspace-acl/index.md#configuring-dashboard-administrators) for more information about permissions.

To set up permissions, see [Workspace access control lists](../workspace-acl/index.md) for more information.

## Associating data sources with a workspace

The **Associate data source** option is only visible when the multiple data sources feature is enabled. Before creating your workspace, you must connect it with at least one data source. If you have not set up your data sources, see [Data sources](../../management/data-sources/index.md). Once your sources are connected, you can link them to your new workspace.
{: .warning}
