...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/dashboards-assistant/alert-insight.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/dashboards-assistant/alert-insight.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/dashboards-assistant/alert-insight/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/dashboards-assistant/alert-insight/"
canonical_route: "/dashboards/dashboards-assistant/alert-insight/"
redirect_from: []
...
Before using alert insights, you must have the `alerting` and `alerting-dashboards` plugins installed on your cluster. By default, these plugins are installed as part of standard OpenSearch distributions. For more information, see [Installing plugins](https://docs.opensearch.org/latest/install-and-configure/plugins/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/install-and-configure/plugins/ -->.
...
To orchestrate alert insights, you'll need to create the necessary [agents](https://docs.opensearch.org/latest/ml-commons-plugin/agents-tools/index/#agents) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/agents-tools/ -->. Create a workflow template for creating all necessary agents by sending the following request:
...
Next, create [root agents](https://docs.opensearch.org/latest/automating-configurations/workflow-tutorial/#root_agent) <!-- unresolved-cross-corpus-link: collection=opensearch route=/automating-configurations/workflow-tutorial/ --> for agents created in the previous step.
...
This example demonstrates a system index. In security-enabled domains, only superadmins have permissions to execute this code. For information about making superadmin calls, see [System indexes](https://docs.opensearch.org/latest/security/configuration/system-indices/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/security/configuration/system-indices/ -->. For access permissions, contact your system administrator.
{: .warning}
...
Before viewing alert insights, you must configure alerts in OpenSearch Dashboards. For more information, see [Alerting](https://docs.opensearch.org/latest/observing-your-data/alerting/index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/observing-your-data/alerting/ -->.
...
1. Hover over the alerts for your desired monitor. If you configured alert insights, you will see a sparkle icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/sparkle-icon.png" class="inline-icon" alt="sparkle icon"/>) next to the alerts in the **Alerts** column, as shown in the following image.

    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/alert-insight-start.png" alt="Alerting page with sparkle icon">

1. Select the alerts label or the sparkle icon. You will see the generated summary, as shown in the following image.

    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/alert-insight-summary.png" alt="Alert summary">

1. Select the information icon (<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/info-icon.png" class="inline-icon" alt="info icon"/>) to view alert insights. You will see the generated alert insights, as shown in the following image.

    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/alert-insight-insight.png" alt="Alert insights">
