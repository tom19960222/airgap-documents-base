...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/dashboards-assistant/index.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/dashboards-assistant/index.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/dashboards-assistant/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/dashboards-assistant/index/"
canonical_route: "/dashboards/dashboards-assistant/"
redirect_from: ["/dashboards/dashboards-assistant/"]
...
For more information about configuring the root agent, see the [Build your own chatbot tutorial](https://docs.opensearch.org/latest/ml-commons-plugin/tutorials/build-chatbot/#step-5-configure-a-root-chatbot-agent-in-opensearch-dashboards) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/tutorials/build-chatbot/ -->.

This example shows a system index. In security-enabled domains, only super admins have permission to execute this code. For information about making super admin calls, see the [System indexes](https://docs.opensearch.org/latest/security/configuration/system-indices/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/security/configuration/system-indices/ --> guide. For access permission, contact your IT administrator.
{: .warning}
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-full-frame.png" alt="OpenSearch Assistant interface">
...
For information about configuring OpenSearch Assistant through the REST API, see [OpenSearch Assistant Toolkit](https://docs.opensearch.org/latest/ml-commons-plugin/opensearch-assistant/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/opensearch-assistant/ -->.

## Using OpenSearch Assistant in OpenSearch Dashboards

The following tutorials guide you through using OpenSearch Assistant in OpenSearch Dashboards. OpenSearch Assistant can be viewed in full frame or in the sidebar. The default view is in the right sidebar. To view the assistant in the left sidebar or in full frame, select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/frame-icon.png" class="inline-icon" alt="frame icon"/> icon in the toolbar and choose the preferred option.
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-QandA.png" alt="Prompt and response using OpenSearch Assistant in OpenSearch Dashboards">
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-regenerate.png" alt="Regenerated response">
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-suggestions.png" alt="Suggested prompts">
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-how-generated.png" alt="Response generation details">
...
<img width="400" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-conversation-history.png" alt="Conversation history">
...
<img width="300" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-edit-convo.png" alt="Editing a conversation name">
...
<img width="300" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-delete-convo.png" alt="Deleting a conversation">

### Share a conversation through Notebooks

You can use [Notebooks](https://docs.opensearch.org/latest/observing-your-data/notebooks/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/observing-your-data/notebooks/ --> to save your conversations. To use this option, select **Save to notebook** from the dropdown menu to the right of **OpenSearch Assistant**. Enter a name for the notebook, then select **Save**. A pop-up message in the lower-right corner confirms the conversation has been saved.
...
<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-notebooks.png" alt="Notebooks interface with saved OpenSearch Assistant conversations">

The following screenshot shows a saved conversation, along with actions you can take for the saved conversation.

<img width="700" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/opensearch-assistant-save-notebook.png" alt="Notebooks interface with saved OpenSearch Assistant conversations">
...
- [Generating alert insights](alert-insight/index.md)
- [Generating data summaries](data-summary/index.md)
- [Generating anomaly detector suggestions](suggest-anomaly-detector/index.md)
- [Generating visualizations from text](text-to-visualization/index.md)
...
- [OpenSearch Assistant configuration through the REST API](https://docs.opensearch.org/latest/ml-commons-plugin/opensearch-assistant/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/opensearch-assistant/ -->
- [Build your own chatbot](https://docs.opensearch.org/latest/ml-commons-plugin/tutorials/build-chatbot/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/tutorials/build-chatbot/ -->
