...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/dashboards-assistant/suggest-anomaly-detector.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/dashboards-assistant/suggest-anomaly-detector.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/dashboards-assistant/suggest-anomaly-detector/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/dashboards-assistant/suggest-anomaly-detector/"
canonical_route: "/dashboards/dashboards-assistant/suggest-anomaly-detector/"
redirect_from: []
...
To orchestrate anomaly detector suggestions, create an anomaly detector suggestion [agent](https://docs.opensearch.org/latest/ml-commons-plugin/agents-tools/index/#agents) <!-- unresolved-cross-corpus-link: collection=opensearch route=/ml-commons-plugin/agents-tools/ -->. To create an agent, send a `POST /_plugins/_flow_framework/workflow?provision=true` request and provide the agent template as a payload. For more information, see [Configuring OpenSearch Assistant](../index.md#configuring-opensearch-assistant).
...
1. Select the **AI assistant** dropdown list and then select **Suggest anomaly detector**, as shown in the following image.
    ...
    <img width="420px" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/suggestAD-button.png" alt="Click the Suggest anomaly detector action">
...
1. Wait for the LLM to populate the **Suggest anomaly detector** fields that will be used to create an anomaly detector for the index pattern. Then select the **Create detector** button to create an anomaly detector, as shown in the following image.
    ...
    <img width="800px" src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards-assistant/suggestAD-UI.png" alt="Suggested anomaly detector">
