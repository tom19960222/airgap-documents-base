...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/management/connect-prometheus.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/management/connect-prometheus.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/management/connect-prometheus/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/management/connect-prometheus/"
canonical_route: "/dashboards/management/connect-prometheus/"
redirect_from: []
...
Before connecting a data source, ensure you have met the [Prerequisites](../data-sources/index.md#prerequisites) and have the necessary [Permissions](../data-sources/index.md#permissions).
...
To delete the data source connection, select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/trash-can-icon.png" class="inline-icon" alt="delete icon"/> icon.

## Create an index pattern

After creating a data source connection, the next step is to create an index pattern for that data source. For more information and a tutorial on index patterns, refer to [Index patterns](../index-patterns/index.md).
