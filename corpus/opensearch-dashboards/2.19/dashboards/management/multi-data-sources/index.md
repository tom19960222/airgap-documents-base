...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/management/multi-data-sources.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/management/multi-data-sources.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/management/multi-data-sources/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/management/multi-data-sources/"
canonical_route: "/dashboards/management/multi-data-sources/"
redirect_from: ["/dashboards/discover/multi-data-sources/"]
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/data_sources_management.png" alt="Dashboards Management data sources main screen" width="700">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/data_sources_management.png" alt="Data sources in sidebar within Dashboards Management" width="700">
...
5. Delete the data source connection by selecting the check box to the left of the title and then choosing **Delete 1 connection**. Selecting multiple check boxes for multiple connections is supported. Alternatively, select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/trash-can-icon.png" class="inline-icon" alt="trash can icon"/> icon.

A data source connection interface is shown in the following image.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/data_source_connection.png" alt="Data source connection screen" width="700">

### Selecting multiple data sources through the Dev Tools console

Alternatively, you can select multiple data sources through the [Dev Tools](../../dev-tools/index-dev/index.md) console. This option allows you to work with a broader range of data and gaining a deeper understanding of your code and applications.

Watch the following 10-second video to see it in action.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/multidata-dev-tools.gif" alt="Multiple data sources in Dev Tools demo">{: .img-fluid}
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/import_saved_objects_with_file_upload.gif" alt="Multiple data sources in Saved object management">{: .img-fluid}
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/multidata-hide-show-auth.gif" alt="Multiple data sources hide and show authentication">{: .img-fluid}
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/multidata-hide-localcluster.gif" alt="Multiple data sources hide local cluster">{: .img-fluid}
...
2. Select **Indexes** from the sidebar menu and then select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon on the upper-right menu bar.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/ism_mds1.gif" alt="Multiple data sources in ISM list page"/>
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/ism_mds2.gif" alt="Multiple data sources in ISM create page"/>
...
3. Select a data source to view a list of associated detectors. If the selected data source does not have detectors, then the **Create detector** button appears under the upper-right menu bar. See [Creating anomaly detectors](https://docs.opensearch.org/latest/observing-your-data/ad/dashboards-anomaly-detection/#creating-anomaly-detectors) <!-- unresolved-cross-corpus-link: collection=opensearch route=/observing-your-data/ad/dashboards-anomaly-detection/ --> for instructions on creating detectors through the interface.

The following GIF illustrates these steps.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/ad_mds1.gif" alt="Multiple data sources in Anomaly Detection dashboard page"/>

You can edit the data source's associated detectors on the **Detectors** tab under the left side bar.

1. Select **Detectors** and then select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon on the upper-right menu bar.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/ad_mds2.gif" alt="Multiple data sources in Anomaly Detection detector page"/>
...
2. Select **Roles** from the left sidebar menu and then select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon on the upper-right menu bar.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/security_mds1.gif" alt="Multiple data sources in Security plugin"/>
...
4. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon on the upper-right menu bar to verify that the new data source is listed in the dropdown menu.

The following GIF illustrates these steps.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/maps_mds1.gif" alt="Multiple data sources in Maps plugin"/>
...
2. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon and choose a data source from the dropdown menu. A list of models associated with the selected data source is displayed.
3. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/inspect-icon.png" class="inline-icon" alt="inspect icon"/> icon to the right of a listed model to view the model's configuration details for the selected data source.

The following GIF illustrates these steps.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/ml_mds1.gif" alt="Multiple data sources in Machine Learning Plugin"/>
...
2. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon and choose a data source from the dropdown menu. A list of channels associated with the selected data source is displayed.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/notification_mds1.gif" alt="Multiple data sources in Notification plugin"/>
...
2. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon and choose a data source from the dropdown menu. A list of available data sources is displayed.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/searchrelevance_mds1.gif" alt="Multiple data sources in Search Relevance plugin"/>
...
2. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon and choose a data source from the dropdown menu.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/mds_sa_detection_rules_view.gif" alt="Multiple data sources in Security analytics list page"/>
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/mds_sa_detection_rules_create.gif" alt="Multiple data sources in Security analytics create page"/>
...
2. Select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/database-icon.png" class="inline-icon" alt="database icon"/> icon and choose a data source from the dropdown menu. A list of associated monitors is displayed.
3. Select a monitor to view its details.

The following GIF illustrates these steps.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/mds_monitor_view.gif" alt="Multiple data sources in Alerting list page"/>
...
2. From the dashboard, select the <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/ellipsis-icon.png" class="inline-icon" alt="ellipsis icon"/> icon to open the **Options** dropdown menu and then choose **Alerting**.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/mds_feature_anywhere_view_alerting.gif" alt="Multiple data sources with Feature anywhere associated monitor"/>
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/dashboards/mds_feature_anywhere_create_alerting.gif" alt="Multiple data sources with Feature anywhere add associated monitor"/>
...
- [Index patterns](../index-patterns/index.md)
- [Index Management](../../im-dashboards/index.md)
- [Connecting OpenSearch and Amazon S3 through OpenSearch Dashboards](../s3-data-source/index.md)
- [OpenSearch Integrations](https://docs.opensearch.org/latest/integrations/index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/integrations/ -->
