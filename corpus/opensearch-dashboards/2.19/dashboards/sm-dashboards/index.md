...
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/sm-dashboards.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/sm-dashboards.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/sm-dashboards/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/sm-dashboards/"
canonical_route: "/dashboards/sm-dashboards/"
redirect_from: ["/dashboards/admin-ui-index/sm-dashboards/"]
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/star-icon.png" class="inline-icon" alt="star icon"/> **Note:** If you need to automate snapshot creation, you can use a snapshot policy.
{: .note purple}
...
The **Delete** button [deletes](https://docs.opensearch.org/latest/api-reference/snapshots/delete-snapshot/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/snapshots/delete-snapshot/ --> a snapshot from a repository.
...
1. Select the checkbox next to the snapshot you want to restore. An example is shown in the following image:
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot-main.png" alt="Snapshots">{: .img-fluid}

    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/star-icon.png" class="inline-icon" alt="star icon"/> **Note:** You can only restore snapshots with the status of `Success` or `Partial`. The status of the snapshot is displayed in the **Snapshot status** column.
    {: .note purple}
1. In the **Restore snapshot** flyout, select the options for restoring the snapshot.
    ...
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot.png" alt="Restore Snapshot" width="450">

    For more information about the options in the **Restore snapshot** flyout, see [Restore snapshots](https://docs.opensearch.org/latest/opensearch/snapshots/snapshot-restore#restore-snapshots) <!-- unresolved-cross-corpus-link: collection=opensearch route=/opensearch/snapshots/snapshot-restore/ -->.
    ...
    **Custom index settings**
    ...
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot-custom.png" alt="Custom settings" width="450">

    For more information about index settings, see [Index settings](https://docs.opensearch.org/latest/im-plugin/index-settings/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/index-settings/ -->.

    For a list of settings that you cannot change or ignore, see [Restore snapshots](https://docs.opensearch.org/latest/opensearch/snapshots/snapshot-restore#restore-snapshots) <!-- unresolved-cross-corpus-link: collection=opensearch route=/opensearch/snapshots/snapshot-restore/ -->.
...
1. (Optional) To monitor the restore progress, select **View restore activities** in the confirmation dialog. You can also monitor the restore progress at any time by selecting the **Restore activities in progress** tab, as shown in the following image.
    ...
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot-activities.png" alt="Restore Activities">{: .img-fluid}
    ...
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/icons/star-icon.png" class="inline-icon" alt="star icon"/> **Note:** The **Restore activities in progress** panel is not persistent. It displays only the progress of the current restore operation. If multiple restore operations are running, the panel displays the most recent one.
    {: .note purple}
    ...
    <img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot-indices.png" alt="Restore Indices">{: .img-fluid}
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/restore-snapshot/restore-snapshot-indices-panel.png" alt="View Indices">{: .img-fluid}
