...
version: "2.19"
title: "Indexes"
source_url: "https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/_dashboards/im-dashboards/index-management.md"
fetched_at: "2026-09-10T18:32:31-04:00"
source_path: "_dashboards/im-dashboards/index-management.md"
source_commit: "cc01280fc1f773421cbcb409bdc8fd7beae2638e"
renderer: "jekyll/opensearch"
permalink: "/dashboards/im-dashboards/index-management/"
canonical_url: "https://docs.opensearch.org/latest/dashboards/im-dashboards/index-management/"
canonical_route: "/dashboards/im-dashboards/index-management/"
redirect_from: ["/dashboards/admin-ui-index/index-management/"]
...
In the **Index Management** section, you can perform the operations available in the [Index API](https://docs.opensearch.org/latest/api-reference/index-apis/index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/ -->.

## Index policies

[Policies](https://docs.opensearch.org/latest/im-plugin/ism/policies/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/policies/ --> are configurations that define the possible states of an index, the actions to perform when an index enters a given state, and the conditions that must be met to transition between states:

1. **States**: The possible states of an index, including the default state for new indexes. For example, you might name your states `hot`, `warm`, or `delete`. For more information, see [States](https://docs.opensearch.org/latest/im-plugin/ism/policies/#states) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/policies/ -->.
2. **Actions**: Any actions that you want the plugin to take when an index enters a given state, such as performing a rollover. For more information, see [Actions](https://docs.opensearch.org/latest/im-plugin/ism/policies/#actions) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/policies/ -->.
3. **Transitions**: The conditions that must be met for an index to move into a new state. For example, if an index is more than 8 weeks old, you might want to move it to the `delete` state. For more information, see [Transitions](https://docs.opensearch.org/latest/im-plugin/ism/policies/#transitions) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/policies/ -->.
...
5. (Optional): Specify a rollover alias if your policy includes a rollover operation. Make sure that the alias already exists. For more information about the rollover operation, see [rollover](https://docs.opensearch.org/latest/im-plugin/ism/policies#rollover) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/policies/ -->.
6. Choose the **Apply** button.

After you attach a policy to an index, Index State Management (ISM) creates a job that runs every 5 minutes by default to perform policy actions, check conditions, and transition the index into different states. To change the default time interval for this job, see [Settings](https://docs.opensearch.org/latest/im-plugin/ism/settings/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/settings/ -->.
...
While you can [create an index](https://docs.opensearch.org/latest/api-reference/index-apis/create-index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/create-index/ --> by using a document as a base, you can also create an empty index for later use.
...
[ISM](https://docs.opensearch.org/latest/im-plugin/ism/index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/ism/ --> is a plugin that lets you automate these periodic administrative operations by triggering them based on changes in the index age, index size, or number of documents. You can define policies that automatically handle index rollovers or deletions to fit your use case.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/apply-policy.PNG" alt="User interface showing apply policy prompt">

### Closing an index

The [close index](https://docs.opensearch.org/latest/api-reference/index-apis/close-index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/close-index/ --> operation closes an index. Once an index is closed, you cannot add data to it or search for any data within the index.
...
The [open index](https://docs.opensearch.org/latest/api-reference/index-apis/open-index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/open-index/ --> operation opens a closed index, letting you add data to it or search for data within the index.
...
The [reindex](https://docs.opensearch.org/latest/api-reference/document-apis/reindex/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/document-apis/reindex/ --> operation lets you copy all of your data or a subset of data from a source index into a destination index.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/reindex-expanded.png" alt="User interface showing reindex prompt">

### Shrinking an index

The [shrink](https://docs.opensearch.org/latest/api-reference/index-apis/shrink-index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/shrink-index/ --> index operation copies all of the data in an existing index into a new index with fewer primary shards.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/shrink.png" alt="User interface showing shrink prompt">

### Splitting an index

The [split index](https://docs.opensearch.org/latest/api-reference/index-apis/split/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/split/ --> operation splits an existing read-only index into a new index, splitting each primary shard into a number of primary shards in the new index.
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/split-expanded.png" alt="User interface showing split page">
...
The [clear cache operation](https://docs.opensearch.org/latest/api-reference/index-apis/clear-index-cache/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/clear-index-cache/ --> can be applied only to open indexes.
...
If you no longer need an index, you can use the [delete index](https://docs.opensearch.org/latest/api-reference/index-apis/delete-index/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/delete-index/ --> operation to delete it.
...
[Index templates](https://docs.opensearch.org/latest/opensearch/index-templates/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/opensearch/index-templates/ --> let you initialize new indexes with predefined mappings and settings. For example, if you continuously index log data, you can define an index template so that all of the indexes have the same number of shards and replicas as shown in the following image.

<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/templates.PNG" alt="User interface showing Templates page">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/create-template-expanded.png" alt="User interface showing Create Template page">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/aliases.PNG" alt="User interface showing Alias page">
...
<img src="https://github.com/opensearch-project/documentation-website/blob/cc01280fc1f773421cbcb409bdc8fd7beae2638e/images/admin-ui-index/create-alias.PNG" alt="User interface showing create Alias page">
...
The [clear cache operation](https://docs.opensearch.org/latest/api-reference/index-apis/clear-index-cache/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/api-reference/index-apis/clear-index-cache/ --> can be applied only to open indexes associated with the specified aliases.
...
You can create, start, stop, and complete operations with [transform](https://docs.opensearch.org/latest/im-plugin/index-transforms/transforms-apis/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/im-plugin/index-transforms/transforms-apis/ --> jobs.
...
## Security integration
  ...
  Permission control is managed with existing [permissions](https://docs.opensearch.org/latest/security-plugin/access-control/permissions/) <!-- unresolved-cross-corpus-link: collection=opensearch route=/security-plugin/access-control/permissions/ --> or action groups that are enforced at the API level. There is currently no UI-level permission control. Users with permission to access the ISM plugin are able to view new pages. They can also make changes if they have permission to run the related APIs.
