---
collection: oauth2-proxy-chart
version: "6.16.1"
title: "oauth2-proxy"
source_url: https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/README.md
fetched_at: 2023-07-15T23:10:59+02:00
---
# oauth2-proxy
...
`config.existingSecret` | existing Kubernetes secret to use for OAuth2 credentials. See [secret template](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/templates/secret.yaml) for the required values | `nil`
...
`config.existingConfig` | existing Kubernetes configmap to use for the configuration file. See [config template](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/templates/configmap.yaml) for the required values | `nil`
...
`alphaConfig.existingConfig` | existing Kubernetes configmap to use for the alpha configuration file. See [config template](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/templates/secret-alpha.yaml) for the required values | `nil`
`alphaConfig.existingSecret` | existing Kubernetes secret to use for the alpha configuration file. See [config template](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/templates/secret-alpha.yaml) for the required values | `nil`
...
`config.google.existingConfig` | existing Kubernetes configmap to use for the service account file. See [google secret template](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/templates/google-secret.yaml) for the required values | `nil`
...
> **Tip**: You can use the default [values.yaml](https://github.com/oauth2-proxy/manifests/blob/2befa05adf3fc42ee9337beb35074c4637745cf7/helm/oauth2-proxy/values.yaml)
