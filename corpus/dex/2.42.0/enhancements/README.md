...
collection: dex
version: "2.42.0"
title: "Dex Enhancement Proposal"
source_url: https://github.com/dexidp/dex/blob/7d1a7473c8a07e22ee97925cc10236c70e5ecf34/docs/enhancements/README.md
...
### Before starting
1. Search GitHub for previous [issues](https://github.com/dexidp/dex/issues), [discussions](https://github.com/dexidp/dex/discussions) and [DEPs](https://github.com/dexidp/dex/tree/7d1a7473c8a07e22ee97925cc10236c70e5ecf34/docs/enhancements).
...
1. Fork the repo.
2. Copy the [`docs/enhancements/_title-YYYY-MM-DD-#issue.md`](docs/enhancements/_title-YYYY-MM-DD-#issue.md) <!-- unresolved-source-link: target=docs/enhancements/_title-YYYY-MM-DD-#issue.md --> template with the appropriate
   name.
