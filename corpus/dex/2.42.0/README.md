...
source_url: https://github.com/dexidp/dex/blob/7d1a7473c8a07e22ee97925cc10236c70e5ecf34/README.md
fetched_at: 2025-02-19T14:08:42+01:00
---
...
![logo](https://github.com/dexidp/dex/blob/7d1a7473c8a07e22ee97925cc10236c70e5ecf34/docs/logos/dex-horizontal-color.png)
...
* You can find more about companies and projects which use dex, [here](./ADOPTERS.md) <!-- unresolved-source-link: target=./ADOPTERS.md -->.

## Connectors

When a user logs in through dex, the user's identity is usually stored in another user-management system: a LDAP directory, a GitHub org, etc. Dex acts as a shim between a client app and the upstream identity provider. The client only needs to understand OpenID Connect to query dex, while dex implements an array of protocols for querying other user-management systems.

![](https://github.com/dexidp/dex/blob/7d1a7473c8a07e22ee97925cc10236c70e5ecf34/docs/img/dex-flow.png)
...
Please see our [security policy](.github/SECURITY.md) <!-- unresolved-source-link: target=.github/SECURITY.md --> for details about reporting vulnerabilities.
...
The project is licensed under the [Apache License, Version 2.0](LICENSE) <!-- unresolved-source-link: target=LICENSE -->.
