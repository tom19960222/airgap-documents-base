...
source_url: https://github.com/prometheus-operator/prometheus-operator/blob/20beb0b00b0bb61840ec2461ace4f22e4037b474/Documentation/user-guides/getting-started.md
...
> **Note:** 👉 Prometheus Operator requires use of Kubernetes v1.16.x and up.
...
> Note: Check the [Alerting guide](alerting.md) for more information about the `Alertmanager` resource.

> Note: Check the [Design page](../design.md) for an overview of all resources introduced by the Prometheus Operator.
